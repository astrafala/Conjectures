...
Roster **13,000 → 13,253 papers over 13,226 entries**, and 157 → **159 arguments**.
253 results:
...
| 12 | Galebach coordination sequences — a new argument |
| 5 | a claim that names a degree and no coefficients — a second new argument |
| 2 | conjectured P-recursive recurrences, from an algebraic generating function |
