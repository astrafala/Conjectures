...
Roster **13,000 → 13,270 papers over 13,243 entries**, and 157 → **159 arguments**.
270 results:
...
| 16 | Galebach coordination sequences — a new argument |
| 5 | a claim that names a degree and no coefficients — a second new argument |
| 15 | conjectured P-recursive recurrences, from an algebraic generating function |
