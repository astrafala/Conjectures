...
PAIR = ('transfer18', 'transfer19', 'transfer24', 'transfer26', 'transfer27',
        ...
        'transfer44', 'transfer46')          # (adj, start, end, S)
DEN = ('transfer20', 'transfer21', 'transfer22', 'transfer25', 'transfer38',
       'transfer42', 'transfer45')   # (adj, start, end, S, den)
