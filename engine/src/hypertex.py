#!/usr/bin/env python3
"""Paper template for a conjecture settled directly from a posted closed form.

House style. The mathematics is the theory of hypergeometric terms: shift quotients are
rational, similar terms group, dissimilar ones are independent, so the recurrence becomes
a finite set of rational-function identities that are decided rather than searched for.
"""
