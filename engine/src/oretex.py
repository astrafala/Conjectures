#!/usr/bin/env python3
"""Paper template for a conjecture that factors through the entry's own stated
recurrence. House style; the mathematics is Ore division, so the middle is its own.
"""
...
recurrence annihilates the sequence. %(EXCPROOF)s
\end{proof}
