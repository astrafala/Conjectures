...
for h in sorted(hits,key=lambda x:x['anum']):
    a=h['anum']; src=f"build/t24{a}/p.pdf"
    ...
    eng[nxt]={'engine':'reciprocal-link','order':h['order'],'degree':h['S'],
...
d['reciprocal-link|PROOF']=("cells linked reciprocally to themselves or to a fixed number "
                            "of neighbours: degree-constrained subgraphs of a grid")
