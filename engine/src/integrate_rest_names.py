...
ENGNAME = {'transfer81': 'canonical-subblock', 'transfer82': 'subblock-condition',
           ...
           'ecarow': 'automaton-row', 'ecacount': 'automaton-cell-count', 'ecablock': 'automaton-block-count', 'ecarowb': 'automaton-block-row', 'ordrep': 'repeated-value-polynomial', 'necklace2': 'necklace-condition', 'ecacol': 'automaton-column', 'arrlex': 'lexicographic-array', 'permdisp': 'bounded-displacement',
