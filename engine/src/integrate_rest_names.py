...
ENGNAME = {'transfer81': 'canonical-subblock', 'transfer82': 'subblock-condition',
           ...
           'cuspdim': 'cusp-form-dimension', 'galcoord': 'tiling-coordination', 'ca2d': 'automaton-axis',
           'ecarow': 'automaton-row', 'ecacount': 'automaton-cell-count', 'ecablock': 'automaton-block-count', 'ecarowb': 'automaton-block-row', 'ordrep': 'repeated-value-polynomial', 'necklace2': 'necklace-condition', 'ecacol': 'automaton-column', 'arrlex': 'lexicographic-array', 'pairclique': 'pairwise-compatible-array', 'permset': 'displacement-set', 'arrline': 'line-order-array', 'conn': 'connected-regions', 'conn2': 'connected-ones', 'multizero': 'zero-sum-multiset', 'winimage': 'window-image', 'coverzero': 'covered-by-zero-block', 'shiftmult': 'shifted-multiplicity', 'modsum': 'modular-running-sum', 'lexsub': 'lex-source-subblock-image', 'edgemark': 'edge-maximum-image', 'boardwalk': 'fixed-step-board-walk', 'block2x2': 'subblock-median', 'binwin': 'binary-window-order', 'circdigit': 'circular-digit-trace', 'samefour': 'subblock-same-values', 'partsum': 'partial-sum-divisibility', 'modprev': 'modular-previous-sum', 'covwin': 'window-coverage-order', 'introord': 'introduction-order', 'seconddiff': 'second-difference-nonzero', 'rcintro': 'row-column-introduction-order', 'neighdiff': 'neighbour-obligation', 'triangsq': 'pell-triangular-square', 'transfer88': 'knight-distance-labelling', 'pellsq': 'pell-quadratic-square', 'permdisp': 'bounded-displacement',
