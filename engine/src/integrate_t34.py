...
for h in sorted(hits,key=lambda x:x['anum']):
    a=h['anum']; src=f"build/t34{a}/p.pdf"
    ...
    eng[nxt]={'engine':'matrix-subblock','order':h['order'],'degree':h['S'],
...
d['matrix-subblock|PROOF']=("the determinant, permanent or trace of every 2 X 2 subblock: singular, "
                            "all equal, differing from a neighbour, or monotone")
