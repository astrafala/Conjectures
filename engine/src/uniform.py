...
IMAGE = ('transfer95', 'transfer96', 'cuspdim', 'ecarow', 'ca2d', 'ca2dcount', 'permrow',
         'repval', 'window', 'ordpoly', 'necklace', 'multiset', 'permdisp', 'latpoly', 'ecacount', 'ecablock', 'ecarowb', 'ordrep', 'necklace2', 'ecacol', 'arrlex', 'pairclique')   # build returns a dict, terms are the engine's own
