...
IMAGE = ('transfer95', 'transfer96', 'cuspdim', 'ecarow', 'ca2d', 'ca2dcount', 'permrow',
         'repval', 'window', 'ordpoly', 'necklace', 'multiset', 'permdisp', 'latpoly', 'ecacount', 'ecablock', 'ecarowb', 'ordrep', 'necklace2', 'ecacol', 'arrlex', 'pairclique', 'permset', 'arrline', 'conn', 'conn2', 'multizero', 'winimage', 'coverzero')   # build returns a dict, terms are the engine's own
