...
for h in sorted(hits,key=lambda x:x['anum']):
    a=h['anum']; src=f"build/t46{a}/p.pdf"
    ...
    eng[nxt]={'engine':'monotone-statistic','order':h['order'],'degree':h['S'],
...
d['monotone-statistic|PROOF']=("a statistic of short runs of cells, whose derived array is "
                               "required to be monotone in a named direction")
