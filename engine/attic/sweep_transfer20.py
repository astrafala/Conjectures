...
import localentry as LE, transfer20 as T, ratrec, openness
...
HITS, DONE = 'transfer20_hits.json', 'transfer20_done.json'
    ...
    if thr is None:
        ...
        if bad:
            ...
            hits.append({'anum': a, 'name': nm, 'walk': p['walk'], 'fixed': p['fixed'],
                         ...
                         'offs': p['offs'], 'offs2': p['offs2'], 'K': p['K'],
                         'den': den, 'plain': p['plain'],
