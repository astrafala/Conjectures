...
for h in sorted(hits,key=lambda x:x['anum']):
    a=h['anum']; src=f"build/t59{a}/p.pdf"
    ...
    eng[nxt]={'engine':'value-neighbour','order':h['order'],'degree':h['S'],
...
d['value-neighbour|PROOF']=("every cell carrying one stated value required to have a "
                            "neighbour carrying another")
