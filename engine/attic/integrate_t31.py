...
for h in sorted(hits,key=lambda x:x['anum']):
    a=h['anum']; src=f"build/t31{a}/p.pdf"
    ...
    eng[nxt]={'engine':'monotone-subblock','order':h['order'],'degree':h['S'],
...
d['monotone-subblock|PROOF']=("a statistic of every 2 X 2 subblock monotone along named directions "
                              "of the subblock grid")
