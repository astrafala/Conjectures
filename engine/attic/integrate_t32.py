...
for h in sorted(hits,key=lambda x:x['anum']):
    a=h['anum']; src=f"build/t32{a}/p.pdf"
...
d['monotone-subblock|PROOF']=("a statistic of every 2 X 2 or 3 X 3 subblock monotone along named "
                              "directions of the subblock grid")
