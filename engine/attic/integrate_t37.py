...
for h in sorted(hits,key=lambda x:x['anum']):
    a=h['anum']; src=f"build/t37{a}/p.pdf"
    ...
    eng[nxt]={'engine':'perimeter-cycle','order':h['order'],'degree':h['S'],
...
d['perimeter-cycle|PROOF']=("the clockwise perimeter cycle of every 2 X 3 and 3 X 2 subblock: "
                            "how many of its six steps go up")
