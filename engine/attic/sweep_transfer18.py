"""Sweep the king-move (cell-centred 3 X 3) families."""
import json, re, os, sys, collections, signal
import localentry as LE, transfer18 as T, ratrec, openness
...
HITS, DONE = 'transfer18_hits.json', 'transfer18_done.json'
