...
for h in sorted(hits,key=lambda x:x['anum']):
    a=h['anum']; src=f"build/t36{a}/p.pdf"
    ...
    eng[nxt]={'engine':'edge-count','order':h['order'],'degree':h['S'],
...
d['edge-count|PROOF']=("the number of clockwise, counterclockwise or rightwards-and-downwards "
                       "edge increases in every 2 X 2 subblock")
