...
for h in sorted(hits,key=lambda x:x['anum']):
    a=h['anum']; src=f"build/t23{a}/p.pdf"
    ...
    eng[nxt]={'engine':'subblock-matrix','order':h['order'],'degree':h['S'],
...
d['subblock-matrix|PROOF']=("every K X K subblock of a matrix idempotent, or of equal "
                            "population or permanent")
