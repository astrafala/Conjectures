...
**13314 papers** settling conjectures across **13287 entries** of the
[On-Line Encyclopedia of Integer Sequences](https://oeis.org): **13308 proofs** and
**6 disproofs**, by **160 distinct arguments**. Every one was recorded on its OEIS entry
...
| **[papers/](papers/)** | All 13314 papers. One folder per band of 500, hardest first. |
