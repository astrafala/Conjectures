...
**12099 papers** settling conjectures across **12072 entries** of the
[On-Line Encyclopedia of Integer Sequences](https://oeis.org): **12093 proofs** and
**6 disproofs**, by **128 distinct arguments**. Every one was recorded on its OEIS entry
...
| **[papers/](papers/)** | All 12099 papers. One folder per band of 500, hardest first. |
