...
**13251 papers** settling conjectures across **13224 entries** of the
[On-Line Encyclopedia of Integer Sequences](https://oeis.org): **13245 proofs** and
**6 disproofs**, by **159 distinct arguments**. Every one was recorded on its OEIS entry
...
| **[papers/](papers/)** | All 13251 papers. One folder per band of 500, hardest first. |
