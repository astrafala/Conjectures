...
**12793 papers** settling conjectures across **12766 entries** of the
[On-Line Encyclopedia of Integer Sequences](https://oeis.org): **12787 proofs** and
**6 disproofs**, by **148 distinct arguments**. Every one was recorded on its OEIS entry
...
| **[papers/](papers/)** | All 12793 papers. One folder per band of 500, hardest first. |
