...
**10665 papers** settling conjectures across **10638 entries** of the
[On-Line Encyclopedia of Integer Sequences](https://oeis.org): **10659 proofs** and
**6 disproofs**, by **107 distinct arguments**. Every one was recorded on its OEIS entry
...
| **[papers/](papers/)** | All 10665 papers. One folder per band of 500, hardest first. |
