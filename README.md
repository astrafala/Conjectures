...
**9151 papers** settling conjectures across **9124 entries** of the
[On-Line Encyclopedia of Integer Sequences](https://oeis.org): **9145 proofs** and
**6 disproofs**, by **94 distinct arguments**. Every one was recorded on its OEIS entry
...
| **[papers/](papers/)** | All 9151 papers. One folder per band of 500, hardest first. |
