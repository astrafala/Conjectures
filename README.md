...
**11175 papers** settling conjectures across **11148 entries** of the
[On-Line Encyclopedia of Integer Sequences](https://oeis.org): **11169 proofs** and
**6 disproofs**, by **113 distinct arguments**. Every one was recorded on its OEIS entry
...
| **[papers/](papers/)** | All 11175 papers. One folder per band of 500, hardest first. |
