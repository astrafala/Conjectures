...
**12624 papers** settling conjectures across **12597 entries** of the
[On-Line Encyclopedia of Integer Sequences](https://oeis.org): **12618 proofs** and
**6 disproofs**, by **145 distinct arguments**. Every one was recorded on its OEIS entry
...
| **[papers/](papers/)** | All 12624 papers. One folder per band of 500, hardest first. |
