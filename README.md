...
**12172 papers** settling conjectures across **12145 entries** of the
[On-Line Encyclopedia of Integer Sequences](https://oeis.org): **12166 proofs** and
**6 disproofs**, by **130 distinct arguments**. Every one was recorded on its OEIS entry
...
| **[papers/](papers/)** | All 12172 papers. One folder per band of 500, hardest first. |
