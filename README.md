...
**9328 papers** settling conjectures across **9301 entries** of the
[On-Line Encyclopedia of Integer Sequences](https://oeis.org): **9322 proofs** and
**6 disproofs**, by **104 distinct arguments**. Every one was recorded on its OEIS entry
...
| **[papers/](papers/)** | All 9328 papers. One folder per band of 500, hardest first. |
