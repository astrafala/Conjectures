...
**12835 papers** settling conjectures across **12808 entries** of the
[On-Line Encyclopedia of Integer Sequences](https://oeis.org): **12829 proofs** and
**6 disproofs**, by **151 distinct arguments**. Every one was recorded on its OEIS entry
...
| **[papers/](papers/)** | All 12835 papers. One folder per band of 500, hardest first. |
