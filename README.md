...
**13010 papers** settling conjectures across **12983 entries** of the
[On-Line Encyclopedia of Integer Sequences](https://oeis.org): **13004 proofs** and
**6 disproofs**, by **157 distinct arguments**. Every one was recorded on its OEIS entry
...
| **[papers/](papers/)** | All 13010 papers. One folder per band of 500, hardest first. |
