...
**12847 papers** settling conjectures across **12820 entries** of the
[On-Line Encyclopedia of Integer Sequences](https://oeis.org): **12841 proofs** and
**6 disproofs**, by **153 distinct arguments**. Every one was recorded on its OEIS entry
...
| **[papers/](papers/)** | All 12847 papers. One folder per band of 500, hardest first. |
