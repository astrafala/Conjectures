...
**12197 papers** settling conjectures across **12170 entries** of the
[On-Line Encyclopedia of Integer Sequences](https://oeis.org): **12191 proofs** and
**6 disproofs**, by **134 distinct arguments**. Every one was recorded on its OEIS entry
...
| **[papers/](papers/)** | All 12197 papers. One folder per band of 500, hardest first. |
