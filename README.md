...
**9284 papers** settling conjectures across **9257 entries** of the
[On-Line Encyclopedia of Integer Sequences](https://oeis.org): **9278 proofs** and
**6 disproofs**, by **100 distinct arguments**. Every one was recorded on its OEIS entry
...
| **[papers/](papers/)** | All 9284 papers. One folder per band of 500, hardest first. |
