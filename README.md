...
**13326 papers** settling conjectures across **13299 entries** of the
[On-Line Encyclopedia of Integer Sequences](https://oeis.org): **13320 proofs** and
**6 disproofs**, by **162 distinct arguments**. Every one was recorded on its OEIS entry
...
| **[papers/](papers/)** | All 13326 papers. One folder per band of 500, hardest first. |
