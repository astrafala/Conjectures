...
**10659 papers** settling conjectures across **10632 entries** of the
[On-Line Encyclopedia of Integer Sequences](https://oeis.org): **10653 proofs** and
**6 disproofs**, by **108 distinct arguments**. Every one was recorded on its OEIS entry
...
| **[papers/](papers/)** | All 10659 papers. One folder per band of 500, hardest first. |
