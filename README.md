...
**11240 papers** settling conjectures across **11213 entries** of the
[On-Line Encyclopedia of Integer Sequences](https://oeis.org): **11234 proofs** and
**6 disproofs**, by **114 distinct arguments**. Every one was recorded on its OEIS entry
...
| **[papers/](papers/)** | All 11240 papers. One folder per band of 500, hardest first. |
