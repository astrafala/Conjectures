...
**11387 papers** settling conjectures across **11360 entries** of the
[On-Line Encyclopedia of Integer Sequences](https://oeis.org): **11381 proofs** and
**6 disproofs**, by **115 distinct arguments**. Every one was recorded on its OEIS entry
...
| **[papers/](papers/)** | All 11387 papers. One folder per band of 500, hardest first. |
