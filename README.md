...
**12214 papers** settling conjectures across **12187 entries** of the
[On-Line Encyclopedia of Integer Sequences](https://oeis.org): **12208 proofs** and
**6 disproofs**, by **135 distinct arguments**. Every one was recorded on its OEIS entry
...
| **[papers/](papers/)** | All 12214 papers. One folder per band of 500, hardest first. |
