...
**12866 papers** settling conjectures across **12839 entries** of the
[On-Line Encyclopedia of Integer Sequences](https://oeis.org): **12860 proofs** and
**6 disproofs**, by **154 distinct arguments**. Every one was recorded on its OEIS entry
...
| **[papers/](papers/)** | All 12866 papers. One folder per band of 500, hardest first. |
