...
**13718 papers** settling conjectures across **13315 entries** of the
[On-Line Encyclopedia of Integer Sequences](https://oeis.org): **13712 proofs** and
**6 disproofs**, by **163 distinct arguments**. Every one was recorded on its OEIS entry
...
| **[papers/](papers/)** | All 13718 papers. One folder per band of 500, hardest first. |
