...
**12247 papers** settling conjectures across **12220 entries** of the
[On-Line Encyclopedia of Integer Sequences](https://oeis.org): **12241 proofs** and
**6 disproofs**, by **138 distinct arguments**. Every one was recorded on its OEIS entry
...
| **[papers/](papers/)** | All 12247 papers. One folder per band of 500, hardest first. |
