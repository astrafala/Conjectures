...
**12814 papers** settling conjectures across **12787 entries** of the
[On-Line Encyclopedia of Integer Sequences](https://oeis.org): **12808 proofs** and
**6 disproofs**, by **149 distinct arguments**. Every one was recorded on its OEIS entry
...
| **[papers/](papers/)** | All 12814 papers. One folder per band of 500, hardest first. |
