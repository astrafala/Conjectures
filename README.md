...
**12190 papers** settling conjectures across **12163 entries** of the
[On-Line Encyclopedia of Integer Sequences](https://oeis.org): **12184 proofs** and
**6 disproofs**, by **132 distinct arguments**. Every one was recorded on its OEIS entry
...
| **[papers/](papers/)** | All 12190 papers. One folder per band of 500, hardest first. |
