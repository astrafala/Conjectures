...
**13729 papers** settling conjectures across **13325 entries** of the
[On-Line Encyclopedia of Integer Sequences](https://oeis.org): **13723 proofs** and
**6 disproofs**, by **164 distinct arguments**. Every one was recorded on its OEIS entry
...
| **[papers/](papers/)** | All 13729 papers. One folder per band of 500, hardest first. |
