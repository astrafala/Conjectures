...
**9296 papers** settling conjectures across **9269 entries** of the
[On-Line Encyclopedia of Integer Sequences](https://oeis.org): **9290 proofs** and
**6 disproofs**, by **101 distinct arguments**. Every one was recorded on its OEIS entry
...
| **[papers/](papers/)** | All 9296 papers. One folder per band of 500, hardest first. |
