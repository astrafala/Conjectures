...
**12754 papers** settling conjectures across **12727 entries** of the
[On-Line Encyclopedia of Integer Sequences](https://oeis.org): **12748 proofs** and
**6 disproofs**, by **146 distinct arguments**. Every one was recorded on its OEIS entry
...
| **[papers/](papers/)** | All 12754 papers. One folder per band of 500, hardest first. |
