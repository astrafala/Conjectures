...
**12958 papers** settling conjectures across **12931 entries** of the
[On-Line Encyclopedia of Integer Sequences](https://oeis.org): **12952 proofs** and
**6 disproofs**, by **156 distinct arguments**. Every one was recorded on its OEIS entry
...
| **[papers/](papers/)** | All 12958 papers. One folder per band of 500, hardest first. |
