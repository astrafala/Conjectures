...
**12185 papers** settling conjectures across **12158 entries** of the
[On-Line Encyclopedia of Integer Sequences](https://oeis.org): **12179 proofs** and
**6 disproofs**, by **131 distinct arguments**. Every one was recorded on its OEIS entry
...
| **[papers/](papers/)** | All 12185 papers. One folder per band of 500, hardest first. |
