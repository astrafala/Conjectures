...
**11471 papers** settling conjectures across **11444 entries** of the
[On-Line Encyclopedia of Integer Sequences](https://oeis.org): **11465 proofs** and
**6 disproofs**, by **116 distinct arguments**. Every one was recorded on its OEIS entry
...
| **[papers/](papers/)** | All 11471 papers. One folder per band of 500, hardest first. |
