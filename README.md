...
**9242 papers** settling conjectures across **9215 entries** of the
[On-Line Encyclopedia of Integer Sequences](https://oeis.org): **9236 proofs** and
**6 disproofs**, by **99 distinct arguments**. Every one was recorded on its OEIS entry
...
| **[papers/](papers/)** | All 9242 papers. One folder per band of 500, hardest first. |
