...
**12876 papers** settling conjectures across **12849 entries** of the
[On-Line Encyclopedia of Integer Sequences](https://oeis.org): **12870 proofs** and
**6 disproofs**, by **155 distinct arguments**. Every one was recorded on its OEIS entry
...
| **[papers/](papers/)** | All 12876 papers. One folder per band of 500, hardest first. |
