...
**12824 papers** settling conjectures across **12797 entries** of the
[On-Line Encyclopedia of Integer Sequences](https://oeis.org): **12818 proofs** and
**6 disproofs**, by **150 distinct arguments**. Every one was recorded on its OEIS entry
...
| **[papers/](papers/)** | All 12824 papers. One folder per band of 500, hardest first. |
