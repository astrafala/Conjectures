...
**12088 papers** settling conjectures across **12061 entries** of the
[On-Line Encyclopedia of Integer Sequences](https://oeis.org): **12082 proofs** and
**6 disproofs**, by **127 distinct arguments**. Every one was recorded on its OEIS entry
...
| **[papers/](papers/)** | All 12088 papers. One folder per band of 500, hardest first. |
