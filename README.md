...
**11901 papers** settling conjectures across **11874 entries** of the
[On-Line Encyclopedia of Integer Sequences](https://oeis.org): **11895 proofs** and
**6 disproofs**, by **120 distinct arguments**. Every one was recorded on its OEIS entry
...
| **[papers/](papers/)** | All 11901 papers. One folder per band of 500, hardest first. |
