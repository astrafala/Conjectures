...
**12379 papers** settling conjectures across **12352 entries** of the
[On-Line Encyclopedia of Integer Sequences](https://oeis.org): **12373 proofs** and
**6 disproofs**, by **142 distinct arguments**. Every one was recorded on its OEIS entry
...
| **[papers/](papers/)** | All 12379 papers. One folder per band of 500, hardest first. |
