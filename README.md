...
**12032 papers** settling conjectures across **12005 entries** of the
[On-Line Encyclopedia of Integer Sequences](https://oeis.org): **12026 proofs** and
**6 disproofs**, by **122 distinct arguments**. Every one was recorded on its OEIS entry
...
| **[papers/](papers/)** | All 12032 papers. One folder per band of 500, hardest first. |
