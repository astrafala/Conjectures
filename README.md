...
**9226 papers** settling conjectures across **9199 entries** of the
[On-Line Encyclopedia of Integer Sequences](https://oeis.org): **9220 proofs** and
**6 disproofs**, by **98 distinct arguments**. Every one was recorded on its OEIS entry
...
| **[papers/](papers/)** | All 9226 papers. One folder per band of 500, hardest first. |
