...
**12070 papers** settling conjectures across **12043 entries** of the
[On-Line Encyclopedia of Integer Sequences](https://oeis.org): **12064 proofs** and
**6 disproofs**, by **126 distinct arguments**. Every one was recorded on its OEIS entry
...
| **[papers/](papers/)** | All 12070 papers. One folder per band of 500, hardest first. |
