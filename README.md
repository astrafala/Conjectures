...
**13776 papers** settling conjectures across **13371 entries** of the
[On-Line Encyclopedia of Integer Sequences](https://oeis.org): **13770 proofs** and
**6 disproofs**, by **165 distinct arguments**. Every one was recorded on its OEIS entry
...
| **[papers/](papers/)** | All 13776 papers. One folder per band of 500, hardest first. |
