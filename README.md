...
**12226 papers** settling conjectures across **12199 entries** of the
[On-Line Encyclopedia of Integer Sequences](https://oeis.org): **12220 proofs** and
**6 disproofs**, by **136 distinct arguments**. Every one was recorded on its OEIS entry
...
| **[papers/](papers/)** | All 12226 papers. One folder per band of 500, hardest first. |
