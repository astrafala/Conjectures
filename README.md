...
**12195 papers** settling conjectures across **12168 entries** of the
[On-Line Encyclopedia of Integer Sequences](https://oeis.org): **12189 proofs** and
**6 disproofs**, by **133 distinct arguments**. Every one was recorded on its OEIS entry
...
| **[papers/](papers/)** | All 12195 papers. One folder per band of 500, hardest first. |
