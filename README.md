...
**12841 papers** settling conjectures across **12814 entries** of the
[On-Line Encyclopedia of Integer Sequences](https://oeis.org): **12835 proofs** and
**6 disproofs**, by **152 distinct arguments**. Every one was recorded on its OEIS entry
...
| **[papers/](papers/)** | All 12841 papers. One folder per band of 500, hardest first. |
