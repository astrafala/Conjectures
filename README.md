...
**9301 papers** settling conjectures across **9274 entries** of the
[On-Line Encyclopedia of Integer Sequences](https://oeis.org): **9295 proofs** and
**6 disproofs**, by **102 distinct arguments**. Every one was recorded on its OEIS entry
...
| **[papers/](papers/)** | All 9301 papers. One folder per band of 500, hardest first. |
