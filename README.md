...
**13230 papers** settling conjectures across **13203 entries** of the
[On-Line Encyclopedia of Integer Sequences](https://oeis.org): **13224 proofs** and
**6 disproofs**, by **158 distinct arguments**. Every one was recorded on its OEIS entry
...
| **[papers/](papers/)** | All 13230 papers. One folder per band of 500, hardest first. |
