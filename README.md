...
**12234 papers** settling conjectures across **12207 entries** of the
[On-Line Encyclopedia of Integer Sequences](https://oeis.org): **12228 proofs** and
**6 disproofs**, by **137 distinct arguments**. Every one was recorded on its OEIS entry
...
| **[papers/](papers/)** | All 12234 papers. One folder per band of 500, hardest first. |
