...
**13320 papers** settling conjectures across **13293 entries** of the
[On-Line Encyclopedia of Integer Sequences](https://oeis.org): **13314 proofs** and
**6 disproofs**, by **161 distinct arguments**. Every one was recorded on its OEIS entry
...
| **[papers/](papers/)** | All 13320 papers. One folder per band of 500, hardest first. |
