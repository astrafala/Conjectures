...
**12151 papers** settling conjectures across **12124 entries** of the
[On-Line Encyclopedia of Integer Sequences](https://oeis.org): **12145 proofs** and
**6 disproofs**, by **129 distinct arguments**. Every one was recorded on its OEIS entry
...
| **[papers/](papers/)** | All 12151 papers. One folder per band of 500, hardest first. |
