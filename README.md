...
**11775 papers** settling conjectures across **11748 entries** of the
[On-Line Encyclopedia of Integer Sequences](https://oeis.org): **11769 proofs** and
**6 disproofs**, by **119 distinct arguments**. Every one was recorded on its OEIS entry
...
| **[papers/](papers/)** | All 11775 papers. One folder per band of 500, hardest first. |
