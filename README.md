...
**11907 papers** settling conjectures across **11880 entries** of the
[On-Line Encyclopedia of Integer Sequences](https://oeis.org): **11901 proofs** and
**6 disproofs**, by **121 distinct arguments**. Every one was recorded on its OEIS entry
...
| **[papers/](papers/)** | All 11907 papers. One folder per band of 500, hardest first. |
