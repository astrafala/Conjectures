...
OEIS A097192 is ``Main diagonal of triangle A097190, in which the n-th row polynomial R\_n(y) is formed from the initial (n+1) terms of g.f. A097191(y)\^{}(n+1), where R\_n(1/3) = 9\^{}n for all n>=0''. It has offset $0$ and begins
\[
