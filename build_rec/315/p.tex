...
\title{A proof of the conjectured recurrence for OEIS A127275}
...
\begin{abstract}
OEIS A127275 carries a conjectured linear recurrence with polynomial coefficients, of
...
OEIS A127275 is ``Expansion of (sqrt(1-4x)-x)/(1-4x)''. It has offset $0$ and begins
\[
a(0),\dots,a(7)\;=\;1, 1, 2, 4, 6, -4, -100, -664,\ \dots
\]
The entry gives the generating function
\begin{equation}\label{eq:gf}
A(x)\;=\;\sum_{n\ge 0} a(n)\,x^{n}\;=\;\frac{x - \sqrt{1 - 4 x}}{4 x - 1} ,
\end{equation}
and it carries the following comment:
\begin{quote}\small
\textbf{Conjecture:} n*a(n) + 2*(-4*n+3)*a(n-1) + 8*(2*n-3)*a(n-2) = 0. - \emph{R. J. Mathar}, Nov 26 2012
\end{quote}
As of the ``Last modified'' line on the live entry (2023-01-16, revision 18) the
...
\section{The computation for A127275}
...
section of A127275, agreeing on all 13 terms compared.
...
\url{https://oeis.org}, 2026. Sequence A127275.
