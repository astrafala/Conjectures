...
closed form. Here it equals $2592 x^{3}$, a polynomial of degree $3$, which proves
...
\begin{quote}\small
\textbf{Conjecture:} 5*n*(n-1)*(n-2)*a(n) -(239*n-600)*(n-1)*(n-2)*a(n-1) +24*(n-2)*(158*n\^{}2-953*n+1445)*a(n-2) +16*(-1232*n\^{}3+13056*n\^{}2-45949*n+53730)*a(n-3) -128*(4*n-15)*(2*n-7)*(4*n-13)*a(n-4)=0. - \emph{R. J. Mathar}, Jul 28 2014
\end{quote}
