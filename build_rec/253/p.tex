...
\title{A proof of the conjectured recurrence for OEIS A025755}
...
\begin{abstract}
OEIS A025755 carries a conjectured linear recurrence with polynomial coefficients, of
...
closed form. Here it equals $11 x$, a polynomial of degree $1$, which proves
...
OEIS A025755 is ``10th-order Patalan numbers (generalization of Catalan numbers)''. It has offset $0$ and begins
\[
a(0),\dots,a(7)\;=\;1, 1, 45, 2850, 206625, 16116750, 1316201250, 110936962500,\ \dots
\]
The entry gives the generating function
\begin{equation}\label{eq:gf}
A(x)\;=\;\sum_{n\ge 0} a(n)\,x^{n}\;=\;\frac{11}{10} - \frac{\sqrt[10]{1 - 100 x}}{10} ,
\end{equation}
and it carries the following comment:
\begin{quote}\small
\textbf{Conjecture:} n*a(n) + 10*(-10*n+11)*a(n-1) = 0. - \emph{R. J. Mathar}, Jul 28 2014
\end{quote}
As of the ``Last modified'' line on the live entry (2025-11-05, revision 43) the
...
\[
p_{0}(n)=n,\qquad p_{1}(n)=- 10 \left(10 n - 11\right)
\]
...
\section{The computation for A025755}
...
\[
n\,a(n) -  10 \left(10 n - 11\right)\,a(n-1) \;=\;0
\]
holds for every $n>1$.
\end{theorem}
...
section of A025755, agreeing on all 13 terms compared.
...
cancellation in $K$, not by series truncation, so the identity $B=11 x$ is an
...
\url{https://oeis.org}, 2026. Sequence A025755.
