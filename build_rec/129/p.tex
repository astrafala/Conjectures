...
\title{A proof of the conjectured recurrence for OEIS A112700}
...
\begin{abstract}
OEIS A112700 carries a conjectured linear recurrence with polynomial coefficients, of
...
OEIS A112700 is ``Partial sum of Catalan numbers A000108 multiplied by powers of 6''. It has offset $0$ and begins
\[
a(0),\dots,a(7)\;=\;1, 7, 79, 1159, 19303, 345895, 6504487, 126597031,\ \dots
\]
The entry gives the generating function
\begin{equation}\label{eq:gf}
A(x)\;=\;\sum_{n\ge 0} a(n)\,x^{n}\;=\;\frac{\sqrt{1 - 24 x} - 1}{12 x \left(x - 1\right)} ,
\end{equation}
and it carries the following comment:
\begin{quote}\small
\textbf{Conjecture:} (n+1)*a(n) +(-25*n+11)*a(n-1) +12*(2*n-1)*a(n-2)=0. - \emph{R. J. Mathar}, Jun 08 2016, verified by \emph{Robert Israel}, Jun 28 2018
\end{quote}
As of the ``Last modified'' line on the live entry (2024-06-12, revision 14) the
...
\[
p_{0}(n)=n + 1,\qquad p_{1}(n)=11 - 25 n,\qquad p_{2}(n)=12 \left(2 n - 1\right)
\]
...
\section{The computation for A112700}
...
\[
(n + 1)\,a(n) + (11 - 25 n)\,a(n-1) + 12 \left(2 n - 1\right)\,a(n-2) \;=\;0
\]
holds for every $n>0$.
\end{theorem}
...
section of A112700, agreeing on all 13 terms compared.
...
\url{https://oeis.org}, 2026. Sequence A112700.
