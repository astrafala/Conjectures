...
closed form. Here it equals $24 x^{2}$, a polynomial of degree $2$, which proves
...
\begin{quote}\small
\textbf{Conjecture:} n*(n-1)*a(n) -(n-1)*(19*n-36)*a(n-1) +9*(11*n\^{}2-51*n+60)*a(n-2) -9*(3*n-7)*(3*n-8)*a(n-3) = 0. - \emph{R. J. Mathar}, Nov 14 2011
\end{quote}
