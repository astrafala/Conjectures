...
\title{A proof of the conjectured recurrence for OEIS A109263}
...
\begin{abstract}
OEIS A109263 carries a conjectured linear recurrence with polynomial coefficients, of
...
OEIS A109263 is ``A Catalan transform of F(n-1)-0\^{}n''. It has offset $0$ and begins
\[
a(0),\dots,a(7)\;=\;0, 0, 1, 3, 10, 34, 118, 416,\ \dots
\]
The entry gives the generating function
\begin{equation}\label{eq:gf}
A(x)\;=\;\sum_{n\ge 0} a(n)\,x^{n}\;=\;\frac{- x - \frac{\sqrt{1 - 4 x}}{2} + \frac{1}{2}}{x + \sqrt{1 - 4 x}} ,
\end{equation}
and it carries the following comment:
\begin{quote}\small
\textbf{Conjecture:} n*(n-3)*a(n) +2*(-4*n\^{}2+15*n-10)*a(n-1) +(15*n\^{}2-69*n+80)*a(n-2) +2*(n-2)*(2*n-5)*a(n-3)=0. - \emph{R. J. Mathar}, Nov 09 2012
\end{quote}
As of the ``Last modified'' line on the live entry (2013-05-26, revision 12) the
...
\section{The computation for A109263}
...
section of A109263, agreeing on all 13 terms compared.
...
\url{https://oeis.org}, 2026. Sequence A109263.
