...
\title{A proof of the conjectured recurrence for OEIS A064090}
...
\begin{abstract}
OEIS A064090 carries a conjectured linear recurrence with polynomial coefficients, of
...
closed form. Here it equals $91 x$, a polynomial of degree $1$, which proves
...
OEIS A064090 is ``Generalized Catalan numbers C(7; n)''. It has offset $0$ and begins
\[
a(0),\dots,a(7)\;=\;1, 1, 8, 113, 1982, 38886, 817062, 17981769,\ \dots
\]
The entry gives the generating function
\begin{equation}\label{eq:gf}
A(x)\;=\;\sum_{n\ge 0} a(n)\,x^{n}\;=\;\frac{14}{\sqrt{1 - 28 x} + 13} ,
\end{equation}
and it carries the following comment:
\begin{quote}\small
\textbf{Conjecture:} 6*n*a(n) +(-167*n+252)*a(n-1) +14*(-2*n+3)*a(n-2)=0. - \emph{R. J. Mathar}, Jun 07 2013
\end{quote}
...
\[
p_{0}(n)=6 n,\qquad p_{1}(n)=252 - 167 n,\qquad p_{2}(n)=- 14 \left(2 n - 3\right)
\]
...
\section{The computation for A064090}
...
\[
6 n\,a(n) + (252 - 167 n)\,a(n-1) -  14 \left(2 n - 3\right)\,a(n-2) \;=\;0
\]
holds for every $n>1$.
\end{theorem}
...
section of A064090, agreeing on all 13 terms compared.
...
cancellation in $K$, not by series truncation, so the identity $B=91 x$ is an
...
\url{https://oeis.org}, 2026. Sequence A064090.
