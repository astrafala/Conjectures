...
\title{A proof of the conjectured recurrence for OEIS A080243}
...
\begin{abstract}
OEIS A080243 carries a conjectured linear recurrence with polynomial coefficients, of
...
OEIS A080243 is ``Signed super-Catalan or little Schroeder numbers''. It has offset $0$ and begins
\[
a(0),\dots,a(7)\;=\;1, -1, 3, -11, 45, -197, 903, -4279,\ \dots
\]
The entry gives the generating function
\begin{equation}\label{eq:gf}
A(x)\;=\;\sum_{n\ge 0} a(n)\,x^{n}\;=\;\frac{x + \sqrt{x^{2} + 6 x + 1} - 1}{4 x} ,
\end{equation}
and it carries the following comment:
\begin{quote}\small
\textbf{Conjecture:} (n+1)*a(n) +3*(2*n-1)*a(n-1) +(n-2)*a(n-2)=0. - \emph{R. J. Mathar}, Nov 26 2012
\end{quote}
As of the ``Last modified'' line on the live entry (2020-06-30, revision 27) the
...
\[
p_{0}(n)=n + 1,\qquad p_{1}(n)=3 \left(2 n - 1\right),\qquad p_{2}(n)=n - 2
\]
...
\section{The computation for A080243}
...
\[
(n + 1)\,a(n) + 3 \left(2 n - 1\right)\,a(n-1) + (n - 2)\,a(n-2) \;=\;0
\]
holds for every $n>1$.
\end{theorem}
...
section of A080243, agreeing on all 13 terms compared.
...
vanish, for all 24 values of $n$ from $n=2$ upward. This is what
...
\url{https://oeis.org}, 2026. Sequence A080243.
