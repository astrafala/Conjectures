...
TIER = {"shared": 2, "stirling-phi": 2, "gauss-congruence": 2, "equate": 3, "disproof": 4, "section": 3, "funceq-mod": 3, "transfer-matrix": 6, "subblock-3x3": 6, "king-move": 6, "neighbour-set": 6, "reciprocal-link": 6, "pattern-neighbour": 5, "pattern-subblock": 5, "subblock-matrix": 5, "index-change": 4, "relabelling": 5, "circular-coloring": 5, "global-count": 5, "budget": 4, "order-flag": 5, "order-cond": 5, "common-sum": 5, "order-statistic": 6, "monotone-subblock": 6, "subblock-coloring": 6, "defective": 4, "image-count": 4, "table-column": 5, "walk-closed-form": 5, "telescoping-boundary": 5,
