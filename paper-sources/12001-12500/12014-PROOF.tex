...
\title{The empirical recurrence for OEIS A237242, proved by transfer matrix}
...
\begin{abstract}
OEIS A237242 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
OEIS A237242 is ``Number of (n+1) X (1+1) 0..2 arrays with the maximum plus the upper median minus the lower median minus the minimum of every 2 X 2 subblock differing from its horizontal and vertical neighbors by exactly one.''. It has offset $1$ and begins
\[
81, 344, 1488, 6496, 28176, 121088, 523776, 2286592,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 352*a(n-4) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 22 2018 01:37:56, revision 9) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237242.
