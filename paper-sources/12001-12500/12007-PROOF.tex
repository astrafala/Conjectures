...
\title{The empirical recurrence for OEIS A259508, proved by transfer matrix}
...
\begin{abstract}
OEIS A259508 counts arrays of width $2$ over $\{0,1\}$ subject to a condition read round the
...
count is a walk count on a finite digraph with $S=5$ vertices, and whether a linear
...
OEIS A259508 is ``Number of (n+1) X (1+1) 0..1 arrays with each 2 X 2 subblock having clockwise pattern 0000 0001 0101 0111.''. It has offset $1$ and begins
\[
11, 31, 87, 245, 689, 1939, 5455, 15349,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + 3*a(n-2) - 2*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 25 2018 08:30:25, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A259508.
