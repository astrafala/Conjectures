...
\title{The empirical recurrence for OEIS A239171, proved by transfer matrix}
...
\begin{abstract}
OEIS A239171 counts $(n+1)\times2$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A239171 is ``Number of (n+1) X (1+1) 0..2 arrays with no element greater than all horizontal neighbors or equal to all vertical neighbors.''. It has offset $1$ and begins
\[
6, 12, 36, 96, 264, 720, 1968, 5376,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + 2*a(n-2).
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 13 2025 08:19:27, revision 17) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A239171.
