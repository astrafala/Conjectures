...
\title{The empirical recurrence for OEIS A302803, proved by transfer matrix}
...
\begin{abstract}
OEIS A302803 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A302803 is ``Number of nX3 0..1 arrays with every element equal to 0, 1, 2, 3 or 5 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
4, 29, 169, 1010, 6084, 36456, 218640, 1312416,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 6*a(n-1) +24*a(n-3) -144*a(n-4) for n>6
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 13 2018 13:05:22, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302803.
