...
\title{The empirical recurrence for OEIS A204709, proved by transfer matrix}
...
\begin{abstract}
OEIS A204709 counts arrays over $\{0,\dots,1\}$ under a condition on the permanent of every
...
a bounded window of consecutive rows, so the count is a walk count on $S=14$ states and is
...
OEIS A204709 is ``Number of (n+1) X 5 0..1 arrays with the permanents of all 2 X 2 subblocks equal and nonzero.''. It has offset $1$ and begins
\[
49, 209, 833, 3473, 14145, 58449, 239425, 986129,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) +13*a(n-2) +3*a(n-3) -16*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 09 2018 06:49:34, revision 9) this is still
...
\]
on the $S=14$ states that survive. Rows carrying no edge at all are dropped: such a row could
...
first term is $49$, and the model reproduces it along with every later term; that is the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204709.
