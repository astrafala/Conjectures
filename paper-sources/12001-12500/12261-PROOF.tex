...
\title{The empirical recurrence for OEIS A206089, proved by transfer matrix}
...
\begin{abstract}
OEIS A206089 counts arrays over $\{0,\dots,2\}$ under a condition on the perimeter cycle of
...
a bounded window of consecutive rows, so the count is a walk count on $S=972$ states and is
...
OEIS A206089 is ``Number of (n+1) X 4 0..2 arrays with every 2 X 3 or 3 X 2 subblock having exactly two counterclockwise and two clockwise edge increases.''. It has offset $1$ and begins
\[
972, 2016, 4560, 13344, 33792, 86496, 240192, 608256,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 18*a(n-3) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 10 2015 01:54:40, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206089.
