...
\title{The empirical recurrence for OEIS A205984, proved by transfer matrix}
...
\begin{abstract}
OEIS A205984 counts arrays over $\{0,\dots,2\}$ under a condition on the perimeter cycle of
...
a bounded window of consecutive rows, so the count is a walk count on $S=315357$ states and is
...
OEIS A205984 is ``Number of (n+1)X7 0..2 arrays with every 2X3 or 3X2 subblock having exactly two clockwise edge increases.''. It has offset $1$ and begins
\[
315357, 591336, 1599096, 7793856, 50843904, 338009472, 2260666464, 15125213376,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 300*a(n-3) for n>11
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 12:22:30, revision 9) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A205984.
