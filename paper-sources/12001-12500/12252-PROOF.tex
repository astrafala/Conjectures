...
\title{The empirical recurrence for OEIS A207046, proved by transfer matrix}
...
\begin{abstract}
OEIS A207046 counts arrays over $\{0,\dots,2\}$ under a condition on the perimeter cycle of
...
a bounded window of consecutive rows, so the count is a walk count on $S=1416$ states and is
...
OEIS A207046 is ``Number of (n+1)X5 0..2 arrays with every 2X3 or 3X2 subblock having exactly one clockwise edge increases.''. It has offset $1$ and begins
\[
1416, 1182, 1272, 2244, 3408, 4836, 9144, 13950,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-3) for n>12
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 13:24:46, revision 9) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207046.
