...
\title{The empirical recurrence for OEIS A305035, proved by transfer matrix}
...
\begin{abstract}
OEIS A305035 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A305035 is ``Number of nX3 0..1 arrays with every element unequal to 0, 1, 2, 6 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
4, 3, 7, 7, 13, 23, 37, 63,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +2*a(n-3) for n>6
\end{quote}
As of the ``Last modified'' line on the live entry (May 24 2018 08:40:32, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A305035.
