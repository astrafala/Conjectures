...
\title{A proof of the conjectured recurrence for OEIS A092634}
...
\begin{abstract}
OEIS A092634 carries a conjectured linear recurrence with polynomial coefficients, of
...
OEIS A092634 is ``a(n) = 1 - Sum\_\{k=2..n\} k*k!''. It has offset $2$ and begins
\[
a(2),\dots,a(9)\;=\;-3, -21, -117, -717, -5037, -40317, -362877, -3628797,\ \dots
\]
The entry states, not as a conjecture,
\begin{quote}\small
a(n) = 3 - (n+1)!. - \emph{Michel Marcus}, Jun 07 2020
\end{quote}
that is,
\begin{equation}\label{eq:cf}
a(n)\;=\;3 - \left(n + 1\right)! .
\end{equation}
...
\begin{quote}\small
\textbf{Conjecture:} a(n) +(-n-3)*a(n-1) +(2*n+1)*a(n-2) +(-n+1)*a(n-3)=0. - \emph{R. J. Mathar}, Sep 27 2014
\end{quote}
As of the ``Last modified'' line on the live entry (2025-09-22, revision 17) the
...
1\,a(n) + (- n - 3)\,a(n-1) + (2 n + 1)\,a(n-2) + (1 - n)\,a(n-3)
\end{equation}
...
exact integer arithmetic at every index where it applies: $15$ instances beginning at
...
entry \href{https://oeis.org/A092634}{A092634}, 2025-09-22.
