...
\title{The empirical recurrence for OEIS A204699, proved by transfer matrix}
...
\begin{abstract}
OEIS A204699 counts arrays of width $2$ over $\{0,1,2\}$ containing no run of $3$ consecutive
...
the count is a walk count on $S=115$ states.
\end{abstract}
...
OEIS A204699 is ``Number of n X 2 0..2 arrays with no occurrence of three equal elements in a row horizontally, vertically or nw-to-se diagonally, and new values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
2, 14, 96, 726, 5400, 40344, 301056, 2247264,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 6*a(n-1) + 12*a(n-2) - 8*a(n-3) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 23 2018 09:51:35, revision 8) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=115,\quad\tau=\mathbf{1} .
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204699.
