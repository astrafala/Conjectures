...
\title{The empirical recurrence for OEIS A261106, proved by transfer matrix}
...
\begin{abstract}
OEIS A261106 counts $(n+2)\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A261106 is ``Number of (n+2) X (1+2) 0..1 arrays with each 3 X 3 subblock having clockwise perimeter pattern 00010001 00010101 or 01010101.''. It has offset $1$ and begins
\[
28, 33, 63, 97, 183, 289, 547, 865,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + 3*a(n-2) - 3*a(n-3) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 30 2018 06:35:15, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A261106.
