...
\title{The empirical recurrence for OEIS A245993, proved by transfer matrix}
...
\begin{abstract}
OEIS A245993 carries an empirical recurrence of order $4$ contributed by R.~H.~Hardin. It is
...
OEIS A245993 is ``Number of length n+2 0..6 arrays with no pair in any consecutive three terms totalling exactly 6.''. It has offset $1$ and begins
\[
216, 1116, 5766, 29790, 153906, 795144, 4108062, 21223992,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) + a(n-2) + 25*a(n-3) + 5*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 06 2018 04:12:40, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + a(n-2) + 25\,a(n-3) + 5\,a(n-4)
\]
for every $n>4$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A245993.
