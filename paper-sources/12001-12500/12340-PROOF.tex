...
\title{The empirical recurrence for OEIS A206341, proved by transfer matrix}
...
\begin{abstract}
OEIS A206341 counts the $(n+1)\times7$ arrays over $\{0,\dots,3\}$ in which
...
OEIS A206341 is ``Number of (n+1)X7 0..3 arrays with every 2X2 subblock having nonzero determinant and commuting with every horizontal or vertical neighbor.''. It has offset $1$ and begins
\[
880, 1589, 2030, 4711, 6090, 14181, 18258, 42351,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) +3*a(n-2) -3*a(n-3) for n>15
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 12:52:30, revision 9) this is still
...
\]
on the $S=880$ admissible $2$-tuples. In particular $a$ is $C$-finite.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206341.
