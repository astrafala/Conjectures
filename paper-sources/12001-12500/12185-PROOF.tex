...
\title{A condition on every subblock: the empirical recurrence for OEIS A181247}
...
\begin{abstract}
OEIS A181247 carries an empirical recurrence of order $4$ contributed by R.~H.~Hardin. It is
...
OEIS A181247 is ``Number of n X 4 binary matrices with no 2 X 2 block having four 1's.''. It has offset $1$ and begins
\[
16, 216, 3032, 42176, 587920, 8191392, 114142368, 1590466304,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 10*a(n-1) + 54*a(n-2) + 16*a(n-3) - 64*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 26 2018 14:16:59, revision 6) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{The count is a walk count}

The entry counts arrays with $4$ columns over the alphabet $\{0,1\}$, growing one row at a time, and the condition it imposes is that no $2\times2$ subblock may contain $4$ ones.
...
\begin{theorem}
\[
a(n)\;=\;10\,a(n-1) + 54\,a(n-2) + 16\,a(n-3) - 64\,a(n-4)
\]
for every $n>4$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A181247.
