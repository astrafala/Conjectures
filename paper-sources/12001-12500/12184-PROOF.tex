...
\title{The empirical recurrence for OEIS A317759, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A317759 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A317759 is ``Number of nX2 0..1 arrays with every element unequal to 0, 1 or 2 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
2, 6, 10, 20, 42, 89, 190, 407,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) +a(n-2) -a(n-3) -a(n-4) for n>6
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 06 2018 11:48:44, revision 4) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A317759.
