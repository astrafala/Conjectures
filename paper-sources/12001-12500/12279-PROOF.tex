...
\title{The empirical recurrence for OEIS A207048, proved by transfer matrix}
...
\begin{abstract}
OEIS A207048 counts arrays over $\{0,\dots,2\}$ under a condition on the perimeter cycle of
...
a bounded window of consecutive rows, so the count is a walk count on $S=13386$ states and is
...
OEIS A207048 is ``Number of (n+1) X 7 0..2 arrays with every 2 X 3 or 3 X 2 subblock having exactly one clockwise edge increases.''. It has offset $1$ and begins
\[
13386, 4722, 3408, 4836, 7584, 11712, 19200, 30528,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-3) n > 14.
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 13:24:53, revision 9) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207048.
