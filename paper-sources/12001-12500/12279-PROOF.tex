...
\begin{quote}\small
\textbf{Conjecture:} n*(n-1)*a(n) -4*(n-1)*(3*n-4)*a(n-1) +(53*n\^{}2-221*n+232)*a(n-2) +8*(-13*n\^{}2+85*n-134)*a(n-3) +(51*n\^{}2-563*n+1308)*a(n-4) +4*(29*n-93)*(n-4)*a(n-5) -105*(n-4)*(n-5)*a(n-6)=0. - \emph{R. J. Mathar}, Feb 20 2015
\end{quote}
...
\[
p_{0}(n)=n \left(n - 1\right),\qquad p_{1}(n)=- 4 \left(n - 1\right) \left(3 n - 4\right),\qquad p_{2}(n)=53 n^{2} - 221 n + 232,\qquad p_{3}(n)=- 8 \left(13 n^{2} - 85 n + 134\right),\qquad p_{4}(n)=51 n^{2} - 563 n + 1308,\qquad p_{5}(n)=4 \left(n - 4\right) \left(29 n - 93\right),\qquad p_{6}(n)=- 105 \left(n - 5\right) \left(n - 4\right)
\]
...
\[
D_{1} \;=\; \left(x - 1\right) \left(5 x - 1\right),\quad D_{2} \;=\; - \left(x + 1\right) \left(3 x - 1\right) .
\]
...
\[
n \left(n - 1\right)\,a(n) -  4 \left(n - 1\right) \left(3 n - 4\right)\,a(n-1) + (53 n^{2} - 221 n + 232)\,a(n-2) -  8 \left(13 n^{2} - 85 n + 134\right)\,a(n-3) + (51 n^{2} - 563 n + 1308)\,a(n-4) + 4 \left(n - 4\right) \left(29 n - 93\right)\,a(n-5) -  105 \left(n - 5\right) \left(n - 4\right)\,a(n-6) \;=\;0
\]
holds for every $n>-1$.
\end{theorem}
