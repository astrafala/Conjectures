...
\title{The empirical recurrence for OEIS A305243, recovered from its tail}
...
\begin{abstract}
OEIS A305243 records ``Empirical recurrence of order $98$'' and keeps the recurrence itself in
a linked file rather than in the entry, so the conjecture cannot be read off the entry at all.
It can still be settled. The entry counts arrays under a condition local to a bounded window of
lines, which makes the count a walk count on a finite digraph and forces a monic integer
recurrence of order at most the number $S'=327$ of states with distinct futures. Berlekamp--Massey on
enough exact terms therefore returns the minimal such recurrence, and on the tail beginning at $n=7$, so the recurrence is proved for every $n\ge105$.
Its last coefficient is $c_{98}=8\neq0$, so no further tail satisfies anything
...
OEIS A305243 is ``Number of nX6 0..1 arrays with every element unequal to 0, 1, 2, 4 or 8 king-move adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
32, 184, 158, 767, 3288, 12521, 55039, 238455,\ \dots
\]
The entry states:
\begin{quote}
Empirical recurrence of order 98 (see link above)
\end{quote}
As of the ``Last modified'' line on the live entry (May 28 2018 08:41:58, revision 4)
...
merging $S'=327$ states remain, and it is that bound every computation below uses.

\begin{lemma}\label{lem:cf}
$a$ satisfies a monic linear recurrence with integer coefficients of order at most $S'=327$.
\end{lemma}
...
Applied to $2S'=654$ exact terms from $n=7$ on, it returns order $98$ --- the
...
$c_{1}$ & $2$ & $c_{26}$ & $160488$ & $c_{51}$ & $2073671$ & $c_{76}$ & $-71835$ \\
$c_{2}$ & $8$ & $c_{27}$ & $181038$ & $c_{52}$ & $-1657804$ & $c_{77}$ & $-69990$ \\
$c_{3}$ & $17$ & $c_{28}$ & $-173754$ & $c_{53}$ & $1859915$ & $c_{78}$ & $-40854$ \\
$c_{4}$ & $23$ & $c_{29}$ & $346083$ & $c_{54}$ & $-3231111$ & $c_{79}$ & $-83879$ \\
$c_{5}$ & $-143$ & $c_{30}$ & $-688375$ & $c_{55}$ & $-1685589$ & $c_{80}$ & $-82766$ \\
$c_{6}$ & $-326$ & $c_{31}$ & $-273323$ & $c_{56}$ & $119366$ & $c_{81}$ & $-14891$ \\
$c_{7}$ & $-502$ & $c_{32}$ & $416519$ & $c_{57}$ & $-5292536$ & $c_{82}$ & $-31965$ \\
$c_{8}$ & $-57$ & $c_{33}$ & $-597217$ & $c_{58}$ & $1011893$ & $c_{83}$ & $-17236$ \\
$c_{9}$ & $2720$ & $c_{34}$ & $1161923$ & $c_{59}$ & $-1574949$ & $c_{84}$ & $8954$ \\
...
\begin{theorem}
The recurrence above holds for every $n\ge105$, and it is the recurrence OEIS A305243 records.
\end{theorem}
...
$-c_{98}=-8$, which is not zero, so $q_{\min}(0)\neq0$ and $q_{\min}$ has no
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A305243.
