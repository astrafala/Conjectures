...
\title{The empirical recurrence for OEIS A197469, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A197469 counts arrays over $\{0,\dots,4\}$ in which every cell is constrained by the
...
OEIS A197469 is ``Number of n X 2 0..4 arrays with each element x equal to the number its horizontal and vertical neighbors equal to 0,1,0,0,0 for x=0,1,2,3,4.''. It has offset $1$ and begins
\[
1, 2, 6, 12, 24, 50, 98, 194,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +4*a(n-3) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (May 12 2018 14:36:03, revision 8) the statement is
...
\#\{\text{neighbours with value }f(x_{t,u})\}=x_{t,u},\quad f=(0,1,0,0,0)
\end{equation}
for every cell $(t,u)$.
...
publishes, $n=32$, the arrays have $2\cdot32$ cells over
$5$ values, so there are about $10^{44}$ of them to sift. The
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A197469.
