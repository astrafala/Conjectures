...
\title{The empirical recurrence for OEIS A253494, proved by transfer matrix}
...
\begin{abstract}
OEIS A253494 counts the arrays over $\{0,\dots,2\}$ whose $2\times2$ subblocks carry a
...
so a pair of consecutive array rows is a state, the count is a walk count on $S=48293$ of them,
...
OEIS A253494 is ``Number of (n+1) X (7+1) 0..2 arrays with every 2 X 2 subblock diagonal minus antidiagonal sum nondecreasing horizontally, vertically and ne-to-sw antidiagonally.''. It has offset $1$ and begins
\[
48293, 51167, 60586, 82676, 127898, 220988, 415106, 827156,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 6*a(n-1) - 11*a(n-2) + 6*a(n-3) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 16 2018 06:44:38, revision 8) this is still
...
\]
on the $S=48293$ admissible pairs. In particular $a$ is $C$-finite. The alignment of the walk
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253494.
