...
\title{The empirical recurrence for OEIS A184765, proved by transfer matrix}
...
\begin{abstract}
OEIS A184765 counts arrays over $\{0,\dots,3\}$ under a condition on the determinant of every
...
OEIS A184765 is ``Number of (n+1) X 2 0..3 arrays with every 2 X 2 subblock singular.''. It has offset $1$ and begins
\[
64, 424, 2248, 13096, 73288, 417256, 2358280, 13370536,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 5*a(n-1) + 8*a(n-2) - 24*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 14 2018 13:11:16, revision 9) this is still
...
first term is $64$, and the model reproduces it along with every later term; that is the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A184765.
