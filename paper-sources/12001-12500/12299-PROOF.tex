...
\title{The empirical recurrence for OEIS A206339, proved by transfer matrix}
...
\begin{abstract}
OEIS A206339 counts the $(n+1)\times5$ arrays over $\{0,\dots,3\}$ in which
...
a state, the count is a walk count on $S=296$ of them, and the conjectured recurrence is then
...
OEIS A206339 is ``Number of (n+1) X 5 0..3 arrays with every 2 X 2 subblock having nonzero determinant and commuting with every horizontal or vertical neighbor.''. It has offset $1$ and begins
\[
296, 534, 682, 1581, 2034, 4711, 6078, 14101,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + 3*a(n-2) - 3*a(n-3) for n>13.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 15 2018 11:01:25, revision 9) this is still
...
$296$, which the model reproduces along with every later term.
...
\]
on the $S=296$ admissible $2$-tuples. In particular $a$ is $C$-finite.
...
size of the construction is therefore $4^{2\cdot5}$ before the condition prunes
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206339.
