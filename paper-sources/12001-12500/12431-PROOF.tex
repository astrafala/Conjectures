...
\title{The empirical recurrence for OEIS A183683, proved by transfer matrix}
...
\begin{abstract}
OEIS A183683 counts arrays over $\{0,\dots,1\}$ under a condition on the determinant of every
...
OEIS A183683 is ``Number of (n+1) X 5 binary arrays with every 2 X 2 subblock nonsingular.''. It has offset $1$ and begins
\[
48, 208, 832, 3472, 14144, 58448, 239424, 986128,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 13*a(n-2) + 16*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 04 2018 12:04:20, revision 9) this is still
...
first term is $48$, and the model reproduces it along with every later term; that is the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A183683.
