...
\title{The empirical recurrence for OEIS A245991, proved by transfer matrix}
...
\begin{abstract}
OEIS A245991 carries an empirical recurrence of order $4$ contributed by R.~H.~Hardin. It is
...
OEIS A245991 is ``Number of length n+2 0..4 arrays with no pair in any consecutive three terms totalling exactly 4.''. It has offset $1$ and begins
\[
64, 208, 676, 2196, 7132, 23168, 75260, 244464,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + a(n-2) + 9*a(n-3) + 3*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 05 2018 21:03:11, revision 10) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A245991.
