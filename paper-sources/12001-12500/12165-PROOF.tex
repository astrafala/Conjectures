...
\title{The empirical recurrence for OEIS A208778, proved by transfer matrix}
...
\begin{abstract}
OEIS A208778 counts arrays over $\{0,\dots,1\}$ of width $6$ that avoid the patterns
...
OEIS A208778 is ``Number of n X 6 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 1 1 and 1 1 1 vertically.''. It has offset
$1$ and begins
\[
26, 676, 156, 260, 416, 676, 1092,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) + a(n-2) for n>4.
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 06 2018 23:14:32, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208778.
