...
\title{The empirical recurrence for OEIS A304128, proved by transfer matrix}
...
\begin{abstract}
OEIS A304128 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A304128 is ``Number of nX3 0..1 arrays with every element unequal to 0, 1, 3 or 6 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
3, 7, 9, 19, 33, 53, 89, 155,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +2*a(n-3) for n>7
\end{quote}
As of the ``Last modified'' line on the live entry (May 07 2018 07:55:08, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A304128.
