...
\title{The empirical recurrence for OEIS A298385, recovered from its tail}
...
\begin{abstract}
OEIS A298385 records ``Empirical recurrence of order $69$'' and keeps the recurrence itself in
...
Its last coefficient is $c_{69}=512\neq0$, so no further tail satisfies anything
...
OEIS A298385 is ``Number of nX4 0..1 arrays with every element equal to 1, 2, 3, 5 or 6 king-move adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
2, 52, 223, 996, 5180, 26926, 135226, 690918,\ \dots
\]
The entry states:
\begin{quote}
Empirical recurrence of order 69 (see link above)
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 18 2018 07:43:47, revision 4)
...
$c_{1}$ & $8$ & $c_{19}$ & $-607801$ & $c_{37}$ & $-17580063$ & $c_{55}$ & $-72124894$ \\
$c_{2}$ & $-19$ & $c_{20}$ & $2767416$ & $c_{38}$ & $-1280788435$ & $c_{56}$ & $9660684$ \\
$c_{3}$ & $73$ & $c_{21}$ & $-1403562$ & $c_{39}$ & $1045369463$ & $c_{57}$ & $-5518612$ \\
$c_{4}$ & $-368$ & $c_{22}$ & $13463473$ & $c_{40}$ & $-52809941$ & $c_{58}$ & $9192985$ \\
$c_{5}$ & $681$ & $c_{23}$ & $-12506709$ & $c_{41}$ & $1474534867$ & $c_{59}$ & $-987374$ \\
$c_{6}$ & $-1729$ & $c_{24}$ & $22497936$ & $c_{42}$ & $268793160$ & $c_{60}$ & $-283982$ \\
$c_{7}$ & $6730$ & $c_{25}$ & $-58152710$ & $c_{43}$ & $-215820380$ & $c_{61}$ & $709704$ \\
$c_{8}$ & $-9935$ & $c_{26}$ & $47979240$ & $c_{44}$ & $-680182009$ & $c_{62}$ & $4118$ \\
$c_{9}$ & $21619$ & $c_{27}$ & $-109615678$ & $c_{45}$ & $-724309157$ & $c_{63}$ & $-8176$ \\
...
\begin{theorem}
The recurrence above holds for every $n\ge72$, and it is the recurrence OEIS A298385 records.
\end{theorem}
...
$-c_{69}=-512$, which is not zero, so $q_{\min}(0)\neq0$ and $q_{\min}$ has no
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A298385.
