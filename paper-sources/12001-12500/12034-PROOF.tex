...
\title{The empirical recurrence for OEIS A302681, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A302681 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A302681 is ``Number of 3Xn 0..1 arrays with every element equal to 0, 1, 4 or 6 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
4, 4, 8, 12, 18, 40, 94, 184,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +3*a(n-3) +3*a(n-4) for n>7
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 11 2018 12:29:13, revision 4) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302681.
