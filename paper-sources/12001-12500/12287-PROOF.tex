...
\title{The empirical recurrence for OEIS A203730, proved by transfer matrix}
...
\begin{abstract}
OEIS A203730 counts $(n+1)\times4$ arrays over $\{0,\dots,7\}$ subject to a condition imposed on
...
OEIS A203730 is ``Number of (n+1) X 4 0..7 arrays with every 2 X 2 subblock having equal diagonal elements or equal antidiagonal elements.''. It has offset $1$ and begins
\[
216000, 19071424, 1754118528, 161916229056, 14950234495680, 1380434809882752, 127463146627838400, 11769375979053945792,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 99*a(n-1) -609*a(n-2) -588*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 04 2018 14:44:48, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A203730.
