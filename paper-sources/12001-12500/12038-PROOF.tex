...
\title{The empirical recurrence for OEIS A251328, proved by transfer matrix}
...
\begin{abstract}
OEIS A251328 counts $2$-column arrays over $\{0,\dots,2\}$ in which every
...
OEIS A251328 is ``Number of (n+1) X (1+1) 0..2 arrays with every 2 X 2 subblock summing to 2 4 or 6.''. It has offset $1$
and begins
\[
39, 171, 753, 3333, 14823, 66219, 297057, 1337733,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 8*a(n-1) - 13*a(n-2) - 12*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 29 2018 03:00:54, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251328.
