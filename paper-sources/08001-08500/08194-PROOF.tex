...
\title{The empirical recurrence for OEIS A236646, proved by transfer matrix}
...
\begin{abstract}
OEIS A236646 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
statistics of every $2\times2$ subblock, and carries an empirical recurrence of order
$11$ contributed by R.~H.~Hardin. It is true, and it is decidable rather than empirical.
...
OEIS A236646 is ``Number of (n+1)X(1+1) 0..2 arrays colored with the maximum plus the upper median minus the lower median minus the minimum of every 2X2 subblock.''. It has offset $1$ and begins
\[
81, 484, 2932, 17824, 108272, 655100, 3970468, 24093844,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 09:24:38, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 4\,a(n-2) + 60\,a(n-3) + 500\,a(n-4) + 608\,a(n-5) + 1064\,a(n-6) + 512\,a(n-7) - 14672\,a(n-8) - 18640\,a(n-9) - 27776\,a(n-10) - 53248\,a(n-11)
\]
for every $n>11$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A236646.
