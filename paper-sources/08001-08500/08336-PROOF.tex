...
\title{The empirical recurrence for OEIS A203084, proved by transfer matrix}
...
\begin{abstract}
OEIS A203084 counts arrays of width $3$ over $\{0,1\}$ containing no occurrence of certain short
...
OEIS A203084 is ``Number of (n+2) X 3 binary arrays avoiding patterns 000 and 101 in rows and columns.''. It has offset $1$ and begins
\[
98, 253, 621, 1575, 4000, 10057, 25384, 64140,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + a(n-2) + 6*a(n-3) + 2*a(n-4) + 3*a(n-5) - a(n-6) - a(n-8) - a(n-9) - a(n-10).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 03 2018 05:35:26, revision 11) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + a(n-2) + 6\,a(n-3) + 2\,a(n-4) + 3\,a(n-5) - a(n-6) - a(n-8) - a(n-9) - a(n-10)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A203084.
