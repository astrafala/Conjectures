...
\title{The empirical recurrence for OEIS A202891, proved by transfer matrix}
...
\begin{abstract}
OEIS A202891 counts arrays of width $3$ over $\{0,1\}$ containing no occurrence of certain short
patterns, read along the rows, the columns or the diagonals. The entry carries an empirical
recurrence of order $19$ contributed by R.~H.~Hardin. It is true, and it is decidable
...
OEIS A202891 is ``Number of (n+2)X3 binary arrays avoiding patterns 001 and 010 in rows, columns and nw-to-se diagonals.''. It has offset $1$ and begins
\[
96, 258, 776, 2201, 6037, 16722, 46270, 127161,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 19 2023 10:19:28, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) - 3\,a(n-2) + 14\,a(n-3) - 20\,a(n-4) + 9\,a(n-5) - 47\,a(n-6) + 24\,a(n-7) + 14\,a(n-8) + 62\,a(n-9) + 24\,a(n-10) - 33\,a(n-11) - 52\,a(n-12) - 43\,a(n-13) + 4\,a(n-14) + 25\,a(n-15) + 20\,a(n-16) + 5\,a(n-17) - 2\,a(n-18) - 3\,a(n-19)
\]
for every $n>19$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A202891.
