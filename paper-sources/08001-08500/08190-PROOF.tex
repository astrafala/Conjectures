...
\title{The empirical recurrence for OEIS A318012, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A318012 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A318012 is ``Number of nX4 0..1 arrays with every element unequal to 0, 1, 2 or 3 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
8, 97, 508, 3062, 17703, 103633, 603215, 3512154,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2018 19:34:37, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) + 10\,a(n-2) - 30\,a(n-3) - 17\,a(n-4) + 84\,a(n-5) + 19\,a(n-6) + 24\,a(n-7) + 14\,a(n-8) - 490\,a(n-9) - 213\,a(n-10) + 715\,a(n-11) + 303\,a(n-12) - 544\,a(n-13) - 269\,a(n-14) - 82\,a(n-15) - 439\,a(n-16) + 318\,a(n-17) + 647\,a(n-18) + 21\,a(n-19) - 71\,a(n-20) - 24\,a(n-21) - 90\,a(n-22) - 21\,a(n-23) + 20\,a(n-24) + 4\,a(n-25) - a(n-26)
\end{equation}
for all $n>29$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A318012.
