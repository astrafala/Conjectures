...
\title{The empirical recurrence for OEIS A316204, proved by transfer matrix}
...
\begin{abstract}
OEIS A316204 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $different from$ itself lying in $\{0,1,2,3,5,8\}$, and it carries an empirical
...
OEIS A316204 is ``Number of nX3 0..1 arrays with every element unequal to 0, 1, 2, 3, 5 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
4, 23, 78, 271, 982, 3619, 13454, 50193,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 26 2018 17:39:39, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) + 2\,a(n-2) - 9\,a(n-3) - 10\,a(n-4) + 7\,a(n-5) + 8\,a(n-6) - 9\,a(n-7) - 3\,a(n-8) + 23\,a(n-9) + 18\,a(n-10) - 8\,a(n-11) - 4\,a(n-12) + 2\,a(n-13) - 2\,a(n-14) - 14\,a(n-15) - 8\,a(n-16)
\end{equation}
for all $n>16$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A316204.
