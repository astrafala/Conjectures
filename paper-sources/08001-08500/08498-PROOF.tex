...
\title{The empirical recurrence for OEIS A234262, proved by transfer matrix}
...
\begin{abstract}
OEIS A234262 counts $5$-column arrays over $\{0,\dots,2\}$ in which every
...
OEIS A234262 is ``Number of (n+1) X (4+1) 0..2 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 2 (constant-stress 1 X 1 tilings).''. It has offset
$1$ and begins
\[
244, 358, 560, 988, 1816, 3616, 7304,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) + 6*a(n-2) - 24*a(n-3) + 4*a(n-4) + 36*a(n-5) - 24*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 20 2022 21:33:37, revision 12) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234262.
