...
\title{The empirical recurrence for OEIS A188601, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A188601 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A188601 is ``Number of nX3 binary arrays without the pattern 1 1 0 diagonally, vertically, antidiagonally or horizontally.''. It has offset $1$ and begins
\[
7, 49, 211, 883, 3354, 12529, 45705, 165506,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 04:45:10, revision 12) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) - 3\,a(n-2) - 34\,a(n-3) + 34\,a(n-4) + 82\,a(n-5) - 71\,a(n-6) - 130\,a(n-7) + 42\,a(n-8) + 165\,a(n-9) + 24\,a(n-10) - 146\,a(n-11) - 44\,a(n-12) + 72\,a(n-13) + 25\,a(n-14) - 15\,a(n-15) - 6\,a(n-16)
\end{equation}
for all $n>17$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A188601.
