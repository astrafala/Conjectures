...
\title{The empirical recurrence for OEIS A252339, proved by transfer matrix}
...
\begin{abstract}
OEIS A252339 counts $(n+2)\times6$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A252339 is ``Number of (n+2)X(4+2) 0..2 arrays with every 3X3 subblock row, column, diagonal and antidiagonal sum not equal to 2 3 or 4.''. It has offset $1$ and begins
\[
538, 2242, 10154, 43708, 184434, 783852, 3338572, 14229718,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:06:48, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252339.
