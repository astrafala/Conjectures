...
\title{The empirical recurrence for OEIS A250686, proved by transfer matrix}
...
\begin{abstract}
OEIS A250686 counts arrays over $\{0,1,2,3\}$ in which a statistic taken over short runs
...
OEIS A250686 is ``Number of (n+1) X (3+1) 0..3 arrays with nondecreasing x(i,j)-x(i,j-1) in the i direction and nondecreasing absolute value of x(i,j)-x(i-1,j) in the j direction.''. It has offset $1$ and begins
\[
2541, 13906, 74631, 383440, 1848953, 8474002, 37322413, 159438246,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 01 2023 17:43:52, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250686.
