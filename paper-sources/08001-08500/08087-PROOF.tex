...
\title{The empirical recurrence for OEIS A259995, proved by transfer matrix}
...
\begin{abstract}
OEIS A259995 counts $(n+2)\times4$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A259995 is ``Number of (n+2)X(2+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000001 00000011 or 00000101.''. It has offset $1$ and begins
\[
99, 269, 805, 1819, 4383, 12412, 32525, 82616,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:57:44, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 2\,a(n-2) + 10\,a(n-3) + 5\,a(n-4) - 19\,a(n-5) - 33\,a(n-6) - 45\,a(n-7) - a(n-8) + 25\,a(n-9) + 13\,a(n-10) + 5\,a(n-11) + 3\,a(n-12) + 9\,a(n-13) + 8\,a(n-14)
\]
for every $n>14$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A259995.
