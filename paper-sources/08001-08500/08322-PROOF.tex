...
\title{The empirical recurrence for OEIS A299182, proved by transfer matrix}
...
\begin{abstract}
OEIS A299182 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $equal to$ itself lying in $\{0,1,2,4,6,7\}$, and it carries an empirical
...
OEIS A299182 is ``Number of nX3 0..1 arrays with every element equal to 0, 1, 2, 4, 6 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
4, 13, 20, 27, 47, 83, 137, 235,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 04 2018 13:13:00, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) - a(n-2) + 3\,a(n-3) - 14\,a(n-4) + a(n-5) + 4\,a(n-6) + 23\,a(n-7) + 3\,a(n-8) - 10\,a(n-9) - 21\,a(n-10) - 4\,a(n-11) + 3\,a(n-13) + a(n-14) + 6\,a(n-15) + 6\,a(n-16) + 4\,a(n-17)
\end{equation}
for all $n>19$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A299182.
