...
\title{The empirical recurrence for OEIS A197212, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A197212 counts arrays over $\{0,\dots,4\}$ in which every cell is constrained by the
...
OEIS A197212 is ``Number of n X 3 0..4 arrays with each element x equal to the number its horizontal and vertical neighbors equal to 4,3,2,1,0 for x=0,1,2,3,4.''. It has offset $1$ and begins
\[
1, 5, 14, 44, 149, 479, 1537, 4971,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) +8*a(n-3) +10*a(n-4) +16*a(n-5) +8*a(n-6) +6*a(n-7) -8*a(n-8) -12*a(n-9) -10*a(n-10) -4*a(n-11) -a(n-12).
\end{quote}
As of the ``Last modified'' line on the live entry (May 11 2018 10:43:29, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 8\,a(n-3) + 10\,a(n-4) + 16\,a(n-5) + 8\,a(n-6) + 6\,a(n-7) - 8\,a(n-8) - 12\,a(n-9) - 10\,a(n-10) - 4\,a(n-11) - a(n-12)
\end{equation}
for all $n>13$.
...
$5$ values, so there are about $10^{54}$ of them to sift. The
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A197212.
