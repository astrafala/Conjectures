...
\title{The empirical recurrence for OEIS A248460, proved by transfer matrix}
...
\begin{abstract}
OEIS A248460 carries an empirical recurrence of order $22$ contributed by R.~H.~Hardin. It is
...
OEIS A248460 is ``Number of length n+2 0..7 arrays with no three consecutive terms having the sum of any two elements equal to twice the third.''. It has offset $1$ and begins
\[
432, 2956, 20236, 138534, 948412, 6493036, 44452660, 304332258,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 11:43:53, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) + 9\,a(n-2) - 2\,a(n-3) - 109\,a(n-4) - 203\,a(n-5) - 4\,a(n-6) + 520\,a(n-7) + 1012\,a(n-8) + 696\,a(n-9) + 385\,a(n-10) + 373\,a(n-11) - 514\,a(n-12) - 2737\,a(n-13) - 4627\,a(n-14) - 3396\,a(n-15) - 2854\,a(n-16) - 3670\,a(n-17) - 2204\,a(n-18) - 634\,a(n-19) - 332\,a(n-20) - 162\,a(n-21) - 24\,a(n-22)
\]
for every $n>21$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A248460.
