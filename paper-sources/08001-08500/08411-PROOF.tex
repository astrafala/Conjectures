...
\title{The empirical recurrence for OEIS A204359, proved by transfer matrix}
...
\begin{abstract}
OEIS A204359 counts $(n+2)\times8$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A204359 is ``Number of (n+2)X8 0..1 arrays with every 3X3 subblock having three equal elements in a row horizontally, vertically, diagonally or antidiagonally exactly one way, and new values 0..1 introduced in row major order.''. It has offset $1$ and begins
\[
23912, 48226, 92286, 167480, 412860, 1006754, 2225410, 4825526,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 11:09:57, revision 9) this is still
...
$u_1,u_2,\dots$ over $\{0,\dots,1\}^{8}$, the condition
\[
...
\]
on $S=65536$ vertices in total, the exponent fixed by the entry's own shape and checked against
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) - 4\,a(n-2) + 5\,a(n-3) + 9\,a(n-4) - 31\,a(n-5) + 49\,a(n-6) - 59\,a(n-7) + 15\,a(n-8) + 54\,a(n-9) - 102\,a(n-10) + 110\,a(n-11) - 52\,a(n-12) - 25\,a(n-13) + 74\,a(n-14) - 77\,a(n-15) + 38\,a(n-16) + 2\,a(n-17) - 18\,a(n-18) + 17\,a(n-19) - 8\,a(n-20) + a(n-21)
\]
for every $n>31$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204359.
