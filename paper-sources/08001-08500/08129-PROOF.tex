...
\title{The empirical recurrence for OEIS A235217, proved by transfer matrix}
...
\begin{abstract}
OEIS A235217 counts arrays of width $3$ over $\{0,1,2\}$ subject to a condition read round the
...
count is a walk count on a finite digraph with $S=28$ vertices, and whether a linear
...
OEIS A235217 is ``Number of (n+1)X(2+1) 0..2 arrays with 2X2 edge jumps all no more than +1 in one of the clockwise or counterclockwise directions or both.''. It has offset $1$ and begins
\[
427, 8029, 145669, 2667851, 48751703, 891368897, 16295474229, 297913907755,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 16*a(n-1) +52*a(n-2) -188*a(n-3) -10*a(n-4) +188*a(n-5) -29*a(n-6) -40*a(n-7) +10*a(n-8)
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 08:29:23, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;16\,a(n-1) + 52\,a(n-2) - 188\,a(n-3) - 10\,a(n-4) + 188\,a(n-5) - 29\,a(n-6) - 40\,a(n-7) + 10\,a(n-8)
\]
for every $n>6$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A235217.
