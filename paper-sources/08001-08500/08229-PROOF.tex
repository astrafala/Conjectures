...
\title{The empirical recurrence for OEIS A245948, proved by transfer matrix}
...
\begin{abstract}
OEIS A245948 carries an empirical recurrence of order $16$ contributed by R.~H.~Hardin. It is
...
OEIS A245948 is ``Number of length n+3 0..6 arrays with some pair in every consecutive four terms totalling exactly 6.''. It has offset $1$ and begins
\[
1435, 7669, 39721, 199141, 1021225, 5208673, 26526337, 135336793,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 02 2025 21:54:44, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + 8\,a(n-2) + 2\,a(n-3) - 39\,a(n-4) - 139\,a(n-5) - 175\,a(n-6) - 179\,a(n-7) + 980\,a(n-8) + 1638\,a(n-9) - 1266\,a(n-10) - 210\,a(n-11) - 352\,a(n-12) + 123\,a(n-13) + 24\,a(n-14) + 19\,a(n-15) - 5\,a(n-16)
\]
for every $n>-2$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A245948.
