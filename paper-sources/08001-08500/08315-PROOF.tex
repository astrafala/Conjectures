...
\title{The empirical recurrence for OEIS A189060, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A189060 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A189060 is ``Number of nX5 binary arrays without the pattern 0 1 0 antidiagonally or horizontally.''. It has offset $1$ and begins
\[
21, 441, 6768, 99721, 1492864, 22289912, 333124565, 4978704008,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 05:00:12, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;21\,a(n-1) - 80\,a(n-2) - 240\,a(n-3) + 1115\,a(n-4) + 2917\,a(n-5) - 15840\,a(n-6) + 21676\,a(n-7) - 10784\,a(n-8) + 1216\,a(n-9)
\end{equation}
for all $n>10$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A189060.
