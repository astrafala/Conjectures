...
\title{The empirical recurrence for OEIS A203840, proved by transfer matrix}
...
\begin{abstract}
OEIS A203840 counts $n\times2$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A203840 is ``Number of n X 2 0..3 arrays with every nonzero element less than or equal to at least two horizontal and vertical neighbors.''. It has offset $1$ and begins
\[
1, 4, 16, 50, 184, 810, 3502, 14751,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 01 2024 19:25:32, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A203840.
