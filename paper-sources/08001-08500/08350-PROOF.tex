...
\title{The empirical recurrence for OEIS A208072, proved by transfer matrix}
...
\begin{abstract}
OEIS A208072 counts arrays over $\{0,\dots,1\}$ of width $7$ that avoid the patterns
...
OEIS A208072 is ``Number of 7Xn 0..1 arrays avoiding 0 0 0 and 1 1 1 horizontally and 0 0 1 and 0 1 1 vertically.''. It has offset
$1$ and begins
\[
20, 400, 432, 2688, 11424, 44064, 198000,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +4*a(n-2) +39*a(n-3) +20*a(n-4) +19*a(n-5) -191*a(n-6) -42*a(n-7) -36*a(n-8) +216*a(n-9) for n>11
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:37:16, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 4\,a(n-2) + 39\,a(n-3) + 20\,a(n-4) + 19\,a(n-5) - 191\,a(n-6) - 42\,a(n-7) - 36\,a(n-8) + 216\,a(n-9)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208072.
