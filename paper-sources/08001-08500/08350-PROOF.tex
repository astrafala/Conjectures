...
\title{The empirical recurrence for OEIS A253307, proved by transfer matrix}
...
\begin{abstract}
OEIS A253307 counts arrays of width $2$ over $\{0,1,2\}$ in which the largest entry on the main diagonal minus the largest on the antidiagonal of every $2\times2$ subblock differs from the same number at the neighbouring subblock. The entry carries an
empirical recurrence of order $10$ contributed by R.~H.~Hardin. It is true, and it is
...
OEIS A253307 is ``Number of (n+1)X(1+1) 0..2 arrays with every 2X2 subblock diagonal maximum minus antidiagonal maximum unequal to its neighbors horizontally, vertically, diagonally and antidiagonally.''. It has offset $1$ and begins
\[
81, 518, 3550, 23524, 157476, 1051870, 7027770, 46953514,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:56:08, revision 6) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The arrays have $2$ columns and a growing number of rows, with entries in $\{0,1,2\}$.
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + 14\,a(n-2) + 57\,a(n-3) + 79\,a(n-4) + 73\,a(n-5) + 99\,a(n-6) - 14\,a(n-7) + 48\,a(n-8) - 24\,a(n-9) + 32\,a(n-10)
\]
for every $n>11$.
\end{theorem}
...
array of width $2$ over $\{0,1,2\}$ with a few rows was written out cell by cell, every block of
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253307.
