...
\title{The empirical recurrence for OEIS A250795, proved by transfer matrix}
...
\begin{abstract}
OEIS A250795 counts arrays over $\{0,1\}$ in which a statistic taken over short runs
...
OEIS A250795 is ``Number of (n+1) X (6+1) 0..1 arrays with nondecreasing min(x(i,j), x(i,j-1)) in the i direction and nondecreasing absolute value of x(i,j)-x(i-1,j) in the j direction.''. It has offset $1$ and begins
\[
530, 1818, 6230, 21610, 76110, 270598, 968942, 3485538,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 22 2022 15:12:33, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;12\,a(n-1) - 49\,a(n-2) + 50\,a(n-3) + 165\,a(n-4) - 408\,a(n-5) + a(n-6) + 618\,a(n-7) - 224\,a(n-8) - 344\,a(n-9) + 108\,a(n-10) + 72\,a(n-11)
\]
for every $n>10$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250795.
