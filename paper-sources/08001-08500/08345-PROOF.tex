...
\title{The empirical recurrence for OEIS A253865, proved by transfer matrix}
...
\begin{abstract}
OEIS A253865 counts the arrays over $\{0,\dots,1\}$ whose $3\times3$ subblocks carry a
...
OEIS A253865 is ``Number of (n+2) X (2+2) 0..1 arrays with every 3 X 3 subblock diagonal maximum minus antidiagonal minimum nondecreasing horizontally, vertically and ne-to-sw antidiagonally.''. It has offset $1$ and begins
\[
3328, 31632, 296960, 2589968, 22729728, 195774608, 1689797632, 14500025360,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 23 2025 09:49:18, revision 10) this is still
...
\begin{theorem}
\[
a(n)\;=\;13\,a(n-1) - 38\,a(n-2) - 82\,a(n-3) + 1143\,a(n-4) - 3979\,a(n-5) + 2864\,a(n-6) - 15792\,a(n-7) + 88960\,a(n-8) - 33152\,a(n-9) - 191232\,a(n-10) + 233216\,a(n-11) - 294912\,a(n-12) + 1916928\,a(n-13) - 12189696\,a(n-14) + 14680064\,a(n-15) + 12582912\,a(n-16) - 16777216\,a(n-17)
\]
for every $n>17$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253865.
