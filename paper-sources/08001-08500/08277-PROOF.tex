...
\title{The empirical recurrence for OEIS A247921, proved by transfer matrix}
...
\begin{abstract}
OEIS A247921 carries an empirical recurrence of order $12$ contributed by R.~H.~Hardin. It is
...
OEIS A247921 is ``Number of length n+4 0..2 arrays with some disjoint pairs in every consecutive five terms having the same sum.''. It has offset $1$ and begins
\[
203, 529, 1387, 3649, 9611, 25265, 66443, 174817,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) -2*a(n-3) -a(n-4) +6*a(n-5) -14*a(n-6) -13*a(n-7) -2*a(n-8) +8*a(n-9) -4*a(n-10) +8*a(n-11) +8*a(n-12).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 15 2023 11:07:35, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) - 2\,a(n-3) - a(n-4) + 6\,a(n-5) - 14\,a(n-6) - 13\,a(n-7) - 2\,a(n-8) + 8\,a(n-9) - 4\,a(n-10) + 8\,a(n-11) + 8\,a(n-12)
\]
for every $n>10$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A247921.
