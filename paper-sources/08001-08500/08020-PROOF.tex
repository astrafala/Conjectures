...
\title{The empirical recurrence for OEIS A232400, proved by transfer matrix}
...
\begin{abstract}
OEIS A232400 counts arrays of width $3$ over $\{0,\dots,2\}$ under a condition on each cell
...
OEIS A232400 is ``Number of (n+1)X(2+1) 0..2 arrays with every element next to itself plus and minus one within the range 0..2 horizontally or vertically, with no adjacent elements equal.''. It has offset $1$ and begins
\[
4, 16, 20, 72, 124, 356, 664, 1808,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 5*a(n-2) +4*a(n-3) -3*a(n-4) -12*a(n-5) -3*a(n-6) +6*a(n-7) +6*a(n-8) +2*a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 07:24:23, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232400.
