...
\title{The empirical recurrence for OEIS A264651, proved by transfer matrix}
...
\begin{abstract}
OEIS A264651 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=5$ rows in which
...
OEIS A264651 is ``Number of (n+1)X(4+1) arrays of permutations of 0..n*5+4 with each element having directed index change 1,1 2,2 -1,0 or 0,-1.''. It has offset $1$ and begins
\[
0, 9, 22, 112, 716, 3100, 14871, 73900,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 20 2015 06:55:56, revision 4) this is still
...
\[
(i-h_i,\,j-h_j)\;\in\;\{(-1,0),\ (0,-1),\ (1,1),\ (2,2)\},
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264651.
