...
\title{The empirical recurrence for OEIS A302376, proved by transfer matrix}
...
\begin{abstract}
OEIS A302376 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A302376 is ``Number of nX3 0..1 arrays with every element equal to 1, 2, 3 or 4 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 15, 76, 475, 2771, 16451, 97160, 574671,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 4*a(n-1) +13*a(n-2) -5*a(n-3) -28*a(n-4) -11*a(n-5) +11*a(n-6) +4*a(n-7) +6*a(n-8) +24*a(n-9) +16*a(n-10) -32*a(n-11)
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 06 2018 12:38:11, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) + 13\,a(n-2) - 5\,a(n-3) - 28\,a(n-4) - 11\,a(n-5) + 11\,a(n-6) + 4\,a(n-7) + 6\,a(n-8) + 24\,a(n-9) + 16\,a(n-10) - 32\,a(n-11)
\end{equation}
for all $n>11$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302376.
