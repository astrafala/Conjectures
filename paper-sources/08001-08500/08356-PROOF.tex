...
\title{The empirical recurrence for OEIS A250685, proved by transfer matrix}
...
\begin{abstract}
OEIS A250685 counts arrays over $\{0,1,2,3\}$ in which a statistic taken over short runs
...
OEIS A250685 is ``Number of (n+1)X(2+1) 0..3 arrays with nondecreasing x(i,j)-x(i,j-1) in the i direction and nondecreasing absolute value of x(i,j)-x(i-1,j) in the j direction.''. It has offset $1$ and begins
\[
543, 2920, 15246, 76320, 362241, 1647460, 7249825, 31113316,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 12:41:30, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250685.
