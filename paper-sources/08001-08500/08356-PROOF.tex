...
\title{The empirical recurrence for OEIS A188870, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A188870 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A188870 is ``Number of n X 5 binary arrays without the pattern 0 0 0 antidiagonally or horizontally.''. It has offset $1$ and begins
\[
24, 576, 11332, 233756, 4805140, 98892196, 2035428944, 41894114820,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 17 2023 02:16:03, revision 7) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;24\,a(n-1) - 67\,a(n-2) - 48\,a(n-3) - 540\,a(n-4) + 2272\,a(n-5) + 1536\,a(n-6) - 6944\,a(n-7) + 2864\,a(n-8) + 1600\,a(n-9) - 768\,a(n-10)
\end{equation}
for all $n>12$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A188870.
