...
\title{The empirical recurrence for OEIS A261550, proved by transfer matrix}
...
\begin{abstract}
OEIS A261550 counts $(n+2)\times5$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
every $3\times3$ subblock, and it carries an empirical recurrence of order $23$
...
OEIS A261550 is ``Number of (n+2)X(3+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000001 00000101 or 00001011.''. It has offset $1$ and begins
\[
170, 269, 516, 754, 1210, 2187, 3436, 5368,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 24 2015 10:57:45, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;9\,a(n-6) + 4\,a(n-7) + 14\,a(n-9) + 12\,a(n-10) + 2\,a(n-11) + 9\,a(n-12) + 4\,a(n-13) + 12\,a(n-14) - 16\,a(n-16) + 24\,a(n-17) - 4\,a(n-18) - 24\,a(n-19) + 22\,a(n-20) - 16\,a(n-22) + 12\,a(n-23)
\]
for every $n>30$.
\end{theorem}
...
at once. By Lemma~\ref{lem:crit} the recurrence holds for every $n>30$. The bound is exact: at $n=30$ the recurrence fails on the entry's own published terms, so no larger range holds.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A261550.
