...
\title{The empirical recurrence for OEIS A260134, proved by transfer matrix}
...
\begin{abstract}
OEIS A260134 counts $(n+2)\times6$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A260134 is ``Number of (n+2)X(4+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00010101 01010101 or 01010111.''. It has offset $1$ and begins
\[
266, 730, 2966, 8292, 24696, 85048, 266156, 813540,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 12:01:18, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A260134.
