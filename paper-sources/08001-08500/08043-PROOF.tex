...
\title{The empirical recurrence for OEIS A207940, proved by transfer matrix}
...
\begin{abstract}
OEIS A207940 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
...
OEIS A207940 is ``Number of 4Xn 0..1 arrays avoiding 0 0 1 and 1 0 0 horizontally and 0 0 1 and 1 1 0 vertically.''. It has offset
$1$ and begins
\[
8, 64, 200, 643, 2422, 9430, 38207,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:29:55, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;7\,a(n-1) - 6\,a(n-2) - 42\,a(n-3) + 62\,a(n-4) + 91\,a(n-5) - 149\,a(n-6) - 91\,a(n-7) + 138\,a(n-8) + 42\,a(n-9) - 50\,a(n-10) - 7\,a(n-11) + 6\,a(n-12)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207940.
