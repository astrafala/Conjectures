...
\title{The empirical recurrence for OEIS A264672, proved by transfer matrix}
...
\begin{abstract}
OEIS A264672 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=5$ rows in which
...
OEIS A264672 is ``Number of (n+1) X (4+1) arrays of permutations of 0..n*5+4 with each element having directed index change -1,-1 1,0 -1,-2 -2,-2 or 0,1.''. It has offset $1$ and begins
\[
1, 29, 123, 890, 6851, 43131, 291315, 1980287,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 19 2023 07:38:56, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + 9\,a(n-2) + 106\,a(n-3) + 212\,a(n-5) - 1161\,a(n-6) + 560\,a(n-7) - 3942\,a(n-8) - 6220\,a(n-9) + 2684\,a(n-10) - 18488\,a(n-11) + 10184\,a(n-12) + 76448\,a(n-13) + 97808\,a(n-14) + 177984\,a(n-15) + 21920\,a(n-16) + 647104\,a(n-17) + 834688\,a(n-18) + 224000\,a(n-19) + 513280\,a(n-20) - 413184\,a(n-21) + 221952\,a(n-22) - 379392\,a(n-23) + 216576\,a(n-24) + 258048\,a(n-25) - 73728\,a(n-26)
\]
for every $n>27$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264672.
