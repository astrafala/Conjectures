...
\title{The empirical recurrence for OEIS A185553, proved by transfer matrix}
...
\begin{abstract}
OEIS A185553 counts $n\times3$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A185553 is ``1/3 the number of nX3 0..2 arrays with every element equal to exactly one or two of its horizontal and vertical neighbors.''. It has offset $1$ and begins
\[
1, 26, 224, 2530, 25496, 269496, 2792166, 29168100,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 03:06:14, revision 11) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A185553.
