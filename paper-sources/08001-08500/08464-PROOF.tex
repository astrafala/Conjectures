...
\title{The empirical recurrence for OEIS A250540, proved by transfer matrix}
...
\begin{abstract}
OEIS A250540 counts arrays over $\{0,1,2,3\}$ in which a statistic taken over short runs
...
OEIS A250540 is ``Number of (n+1) X (4+1) 0..3 arrays with nondecreasing x(i,j)-x(i,j-1) in the i direction and nondecreasing x(i,j)-x(i-1,j) in the j direction.''. It has offset $1$ and begins
\[
36552, 491650, 4169584, 27240292, 151170400, 752602024, 3475227442, 15210145612,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 26 2025 12:36:38, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250540.
