...
\title{The empirical recurrence for OEIS A254485, proved by transfer matrix}
...
\begin{abstract}
OEIS A254485 counts the arrays over $\{0,\dots,1\}$ whose $3\times3$ subblocks carry a
...
OEIS A254485 is ``Number of (n+2) X (2+2) 0..1 arrays with every 3 X 3 subblock diagonal maximum plus antidiagonal minimum nondecreasing horizontally, vertically and ne-to-sw antidiagonally.''. It has offset $1$ and begins
\[
3264, 29952, 281024, 2520832, 21641920, 186176000, 1607095232, 13791593728,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 08 2023 11:50:13, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;12\,a(n-1) - 21\,a(n-2) - 96\,a(n-3) + 453\,a(n-4) - 3068\,a(n-5) + 17137\,a(n-6) - 105968\,a(n-7) + 135840\,a(n-8) + 1507584\,a(n-9) - 4045824\,a(n-10) + 6166528\,a(n-11) - 32115200\,a(n-12) + 86695936\,a(n-13) - 128049152\,a(n-14) - 319291392\,a(n-15) + 1362362368\,a(n-16) - 1317797888\,a(n-17) + 8362983424\,a(n-18) - 27396145152\,a(n-19) + 35634806784\,a(n-20) - 6325010432\,a(n-21) - 97978941440\,a(n-22) + 161061273600\,a(n-23) - 622770257920\,a(n-24) + 2199023255552\,a(n-25) - 2748779069440\,a(n-26) + 1099511627776\,a(n-27)
\]
for every $n>27$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A254485.
