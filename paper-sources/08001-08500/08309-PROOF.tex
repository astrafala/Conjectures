...
\title{The empirical recurrence for OEIS A303011, proved by transfer matrix}
...
\begin{abstract}
OEIS A303011 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A303011 is ``Number of nX3 0..1 arrays with every element equal to 0, 1, 2, 4 or 6 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
4, 20, 68, 308, 1320, 5220, 22652, 95220,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) +4*a(n-2) +30*a(n-3) -88*a(n-4) -52*a(n-5) -84*a(n-6) -200*a(n-7) -80*a(n-8) -112*a(n-9) -96*a(n-10)
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 17 2018 13:08:14, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 4\,a(n-2) + 30\,a(n-3) - 88\,a(n-4) - 52\,a(n-5) - 84\,a(n-6) - 200\,a(n-7) - 80\,a(n-8) - 112\,a(n-9) - 96\,a(n-10)
\end{equation}
for all $n>10$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A303011.
