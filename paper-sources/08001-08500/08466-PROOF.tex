...
\title{The empirical recurrence for OEIS A302267, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A302267 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A302267 is ``Number of 3 X n 0..1 arrays with every element equal to 0, 1, 2 or 3 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
4, 32, 153, 772, 3818, 19191, 96004, 481261,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 05 2018 04:10:29, revision 7) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 14\,a(n-2) - 9\,a(n-3) - 54\,a(n-4) - 10\,a(n-5) + 65\,a(n-6) + 17\,a(n-7) - 8\,a(n-8) - 2\,a(n-9) - 31\,a(n-10) - 7\,a(n-11) + 9\,a(n-12)
\end{equation}
for all $n>13$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302267.
