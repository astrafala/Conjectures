...
\title{The empirical recurrence for OEIS A304539, proved by transfer matrix}
...
\begin{abstract}
OEIS A304539 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A304539 is ``Number of nX3 0..1 arrays with every element unequal to 0, 1, 3, 4 or 6 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
3, 7, 9, 19, 37, 65, 129, 275,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) -a(n-2) +2*a(n-3) -8*a(n-4) +2*a(n-5) -a(n-6) -a(n-7) -9*a(n-8) +3*a(n-9) +9*a(n-10) +8*a(n-11) +a(n-12) -3*a(n-13)
\end{quote}
As of the ``Last modified'' line on the live entry (May 14 2018 08:39:41, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) - a(n-2) + 2\,a(n-3) - 8\,a(n-4) + 2\,a(n-5) - a(n-6) - a(n-7) - 9\,a(n-8) + 3\,a(n-9) + 9\,a(n-10) + 8\,a(n-11) + a(n-12) - 3\,a(n-13)
\end{equation}
for all $n>13$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A304539.
