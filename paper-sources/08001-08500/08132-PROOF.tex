...
\title{The empirical recurrence for OEIS A304468, proved by transfer matrix}
...
\begin{abstract}
OEIS A304468 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $different from$ itself lying in $\{0,1,2,3,6\}$, and it carries an empirical
...
OEIS A304468 is ``Number of nX4 0..1 arrays with every element unequal to 0, 1, 2, 3 or 6 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
8, 49, 117, 322, 1100, 2957, 8254, 26698,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 13 2018 10:38:42, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;7\,a(n-1) - 17\,a(n-2) + 34\,a(n-3) - 113\,a(n-4) + 204\,a(n-5) - 132\,a(n-6) + 220\,a(n-7) - 539\,a(n-8) + 180\,a(n-9) + 308\,a(n-10) + 84\,a(n-11) - 56\,a(n-12) - 532\,a(n-13) + 370\,a(n-14) - 87\,a(n-15) + 214\,a(n-16) - 176\,a(n-17) + 38\,a(n-18) - 20\,a(n-19) + 18\,a(n-20) - 4\,a(n-21)
\end{equation}
for all $n>25$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A304468.
