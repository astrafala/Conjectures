...
\title{A condition on each element and its neighbours: OEIS A240770}
...
\begin{abstract}
OEIS A240770 carries an empirical recurrence of order $10$ contributed by R.~H.~Hardin. It is
...
walks in it. Hence $a(n)$ is a walk count on $S=12$ vertices and is $C$-finite, and whether the
...
OEIS A240770 is ``Number of nX2 0..3 arrays with no element equal to exactly one horizontal or vertical neighbor, with new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
1, 5, 28, 196, 1418, 10314, 75138, 547557,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 11:06:28, revision 7) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{The count is a walk count}

The entry counts arrays with $2$ columns over the alphabet $\{0,1,2,3\}$, growing one row at a time. Its condition is that no element may equal exactly $1$ of its horizontal and vertical neighbours.
...
Vertices with identical futures are merged, which leaves $S=12$. An admissible array is exactly a walk, so with $M$ the adjacency matrix and $\iota,\tau$ the vectors recording which states may begin and end an array,
\[
...
\begin{theorem}
\[
a(n)\;=\;12\,a(n-1) - 36\,a(n-2) + 4\,a(n-3) + 51\,a(n-4) + 74\,a(n-5) - 105\,a(n-6) - 60\,a(n-7) + 22\,a(n-8) + 66\,a(n-9) - 27\,a(n-10)
\]
for every $n>11$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A240770.
