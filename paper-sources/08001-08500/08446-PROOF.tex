...
\title{The empirical recurrence for OEIS A303318, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A303318 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A303318 is ``Number of 6Xn 0..1 arrays with every element equal to 0, 1, 4, 5 or 6 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
32, 14, 34, 165, 349, 1221, 7096, 30280,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 21 2018 12:51:20, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 3\,a(n-2) + 18\,a(n-3) + 87\,a(n-4) + 23\,a(n-5) - 149\,a(n-6) - 305\,a(n-7) - 678\,a(n-8) - 45\,a(n-9) + 981\,a(n-10) + 937\,a(n-11) + 1834\,a(n-12) + 317\,a(n-13) - 1968\,a(n-14) - 1457\,a(n-15) - 2157\,a(n-16) - 964\,a(n-17) + 830\,a(n-18) + 254\,a(n-19) + 161\,a(n-20) + 152\,a(n-21) - 15\,a(n-22) - 3\,a(n-23)
\end{equation}
for all $n>28$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A303318.
