...
\title{The empirical recurrence for OEIS A243726, proved by transfer matrix}
...
\begin{abstract}
OEIS A243726 carries an empirical recurrence of order $11$ contributed by R.~H.~Hardin. It is
...
OEIS A243726 is ``Number of length n+2 0..7 arrays with no three unequal elements in a row and no three equal elements in a row and new values 0..7 introduced in 0..7 order.''. It has offset $1$ and begins
\[
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 03 2018 08:39:48, revision 12) this is still
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-1) - 90\,a(n-3) + 105\,a(n-4) + 441\,a(n-5) - 652\,a(n-6) - 1070\,a(n-7) + 1491\,a(n-8) + 1387\,a(n-9) - 1198\,a(n-10) - 840\,a(n-11)
\]
for every $n>13$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A243726.
