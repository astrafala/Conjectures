...
\title{The empirical recurrence for OEIS A261286, proved by transfer matrix}
...
\begin{abstract}
OEIS A261286 counts $(n+2)\times4$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A261286 is ``Number of (n+2)X(2+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000001 00010101 or 01010101.''. It has offset $1$ and begins
\[
50, 77, 133, 233, 409, 743, 1361, 2469,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 14 2015 07:13:41, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 4\,a(n-3) - a(n-4) - 5\,a(n-6) + 2\,a(n-8) + a(n-9) - a(n-10) - 3\,a(n-11) + a(n-12) + a(n-13) + a(n-14) - 2\,a(n-15) - 2\,a(n-16)
\]
for every $n>17$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A261286.
