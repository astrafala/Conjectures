...
\title{A condition on every subblock: the empirical recurrence for OEIS A183829}
...
\begin{abstract}
OEIS A183829 carries an empirical recurrence of order $8$ contributed by R.~H.~Hardin. It is
...
OEIS A183829 is ``Number of (n+1) X 3 0..2 arrays with each element of every 2 X 2 subblock being the sum mod 3 of two others.''. It has offset $1$ and begins
\[
127, 823, 5323, 35755, 237671, 1598975, 10698847, 71897239,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 8*a(n-1) + 7*a(n-2) - 142*a(n-3) + 246*a(n-4) + 68*a(n-5) - 386*a(n-6) + 176*a(n-7) + 24*a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 05 2018 06:32:07, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{The count is a walk count}

The entry counts arrays with $3$ columns over the alphabet $\{0,1,2\}$, growing one row at a time, and the condition it imposes is that in every $2\times2$ subblock, each of the four entries must be congruent modulo $3$ to the sum of two of the other three.
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-1) + 7\,a(n-2) - 142\,a(n-3) + 246\,a(n-4) + 68\,a(n-5) - 386\,a(n-6) + 176\,a(n-7) + 24\,a(n-8)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A183829.
