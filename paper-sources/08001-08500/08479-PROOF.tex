...
\title{The empirical recurrence for OEIS A237380, proved by transfer matrix}
...
\begin{abstract}
OEIS A237380 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
The condition is local to two consecutive rows, so the count is a walk count on $S=6368$
...
OEIS A237380 is ``Number of (n+1)X(4+1) 0..2 arrays with the maximum plus the minimum minus the upper median minus the lower median of every 2X2 subblock differing from its horizontal and vertical neighbors by exactly one.''. It has offset $1$ and begins
\[
6368, 76188, 912912, 11767448, 141627680, 1709556016, 20834106592, 274803913264,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 68874*a(n-4) -1534369644*a(n-8) +10903411963960*a(n-12) -44879816417664*a(n-16) for n>20
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 10:07:59, revision 6) this is still
...
differ by $1$. The entry's first term $6368$ counts those, and the model was made to
...
\]
over the $S=6368$ pairs whose own subblock row already satisfies the condition along itself.
...
\begin{theorem}
\[
a(n)\;=\;68874\,a(n-4) - 1534369644\,a(n-8) + 10903411963960\,a(n-12) - 44879816417664\,a(n-16)
\]
for every $n>20$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237380.
