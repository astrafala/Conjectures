...
\title{The empirical recurrence for OEIS A232378, proved by transfer matrix}
...
\begin{abstract}
OEIS A232378 counts arrays of width $3$ over $\{0,1,2,3\}$ in which every cell carrying one stated
...
OEIS A232378 is ``Number of 3Xn 0..3 arrays with every 0 next to a 1, every 1 next to a 2 and every 2 next to a 3 horizontally, diagonally or antidiagonally, and no adjacent values equal.''. It has offset $1$ and begins
\[
1, 58, 586, 4404, 32722, 259458, 2046700, 16005328,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 07:22:36, revision 6) this is still
...
adjacency matrix,
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=469.
\]
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) + 4\,a(n-2) + 69\,a(n-3) + 48\,a(n-4) + 355\,a(n-5) + 241\,a(n-6) + 1332\,a(n-7) + 2318\,a(n-8) + 448\,a(n-9) - 1416\,a(n-10) - 784\,a(n-11) + 64\,a(n-12) + 48\,a(n-13)
\]
for every $n>14$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232378.
