...
\title{The empirical recurrence for OEIS A278276, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A278276 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A278276 is ``Number of nX4 0..1 arrays with every element both equal and not equal to some elements at offset (-1,-1) (-1,0) (-1,1) (0,-1) (0,1) or (1,0), with upper left element zero.''. It has offset $1$ and begins
\[
0, 13, 122, 1461, 16842, 196726, 2293193, 26748095,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 16 2016 12:07:02, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;10\,a(n-1) + 30\,a(n-2) - 106\,a(n-3) - 241\,a(n-4) + 350\,a(n-5) + 671\,a(n-6) - 325\,a(n-7) + 128\,a(n-8) - 1128\,a(n-9) - 1075\,a(n-10) + 524\,a(n-11) - 119\,a(n-12) + 331\,a(n-13) + 274\,a(n-14) - 179\,a(n-15) + 42\,a(n-16) - 6\,a(n-17)
\end{equation}
for all $n>19$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A278276.
