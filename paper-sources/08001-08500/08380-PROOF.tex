...
\title{The empirical recurrence for OEIS A254253, proved by transfer matrix}
...
\begin{abstract}
OEIS A254253 counts the arrays over $\{0,\dots,1\}$ whose $3\times3$ subblocks carry a
...
OEIS A254253 is ``Number of (n+2)X(1+2) 0..1 arrays with every 3X3 subblock sum of the two maximums of the diagonal and antidiagonal minus the sum of the minimums of the central row and column nondecreasing horizontally, vertically and ne-to-sw antidiagonally.''. It has offset $1$ and begins
\[
512, 2812, 12616, 54236, 236024, 1021428, 4351908, 18369164,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 14:34:58, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-1) - 13\,a(n-2) + 11\,a(n-3) - 13\,a(n-4) - 60\,a(n-5) - 32\,a(n-6) + 210\,a(n-7) + 501\,a(n-8) - 221\,a(n-9) + 109\,a(n-10) - 981\,a(n-11) - 1875\,a(n-12) + 1430\,a(n-13) + 856\,a(n-14) - 180\,a(n-15) + 468\,a(n-16) - 216\,a(n-17)
\]
for every $n>17$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A254253.
