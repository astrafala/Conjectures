...
\title{The empirical recurrence for OEIS A316805, proved by transfer matrix}
...
\begin{abstract}
OEIS A316805 counts $5$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $different from$ itself lying in $\{0,1,2,3,4,5,6\}$, and it carries an empirical
...
OEIS A316805 is ``Number of nX5 0..1 arrays with every element unequal to 0, 1, 2, 3, 4, 5 or 6 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
16, 512, 14711, 420345, 12075849, 347046960, 9972851339, 286582122564,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 14 2018 14:58:03, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;29\,a(n-1) - 20\,a(n-2) + 376\,a(n-3) - 465\,a(n-4) - 2367\,a(n-5) + 374\,a(n-6) - 6254\,a(n-7) + 28308\,a(n-8) - 10515\,a(n-9) - 124724\,a(n-10) + 128227\,a(n-11) + 52996\,a(n-12) - 74116\,a(n-13) + 242502\,a(n-14) - 97704\,a(n-15) - 118290\,a(n-16) + 76312\,a(n-17) - 62048\,a(n-18) - 18536\,a(n-19) + 38160\,a(n-20) + 2816\,a(n-21) - 4096\,a(n-22)
\end{equation}
for all $n>22$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A316805.
