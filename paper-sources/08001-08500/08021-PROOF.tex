...
\title{The empirical recurrence for OEIS A255039, proved by transfer matrix}
...
\begin{abstract}
OEIS A255039 counts the arrays over $\{0,\dots,1\}$ whose $3\times3$ subblocks carry a
...
OEIS A255039 is ``Number of (4+2)X(n+2) 0..1 arrays with every 3X3 subblock sum of the two sums of the central row and central column minus the two minimums of the diagonal and antidiagonal nondecreasing horizontally, vertically and ne-to-sw antidiagonally.''. It has offset $1$ and begins
\[
42890, 87907, 154706, 281112, 474308, 749830, 1231466, 1903222,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 15:06:33, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) - a(n-2) + a(n-3) + 5\,a(n-4) - 12\,a(n-5) + 5\,a(n-6) - 6\,a(n-7) - a(n-8) + 16\,a(n-9) - a(n-10) + 7\,a(n-11) - 13\,a(n-12) - 2\,a(n-13) - 13\,a(n-14) + 6\,a(n-15) + 2\,a(n-16) + 12\,a(n-17) + 2\,a(n-18) - 8\,a(n-19) + 8\,a(n-20) - 16\,a(n-21) + 8\,a(n-22)
\]
for every $n>38$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A255039.
