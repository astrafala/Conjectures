...
\title{The empirical recurrence for OEIS A253400, proved by transfer matrix}
...
\begin{abstract}
OEIS A253400 counts arrays of width $2$ over $\{0,1,2\}$ in which the largest entry on the main diagonal plus the smallest on the antidiagonal of every $2\times2$ subblock differs from the same number at the neighbouring subblock. The entry carries an
...
OEIS A253400 is ``Number of (n+1)X(1+1) 0..2 arrays with every 2X2 subblock diagonal maximum plus antidiagonal minimum unequal to its neighbors horizontally, vertically and ne+sw antidiagonally.''. It has offset $1$ and begins
\[
81, 480, 2890, 17560, 106540, 646240, 3920448, 23781448,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) +24*a(n-2) +7*a(n-3) -15*a(n-4) -84*a(n-6) -139*a(n-7) -28*a(n-8) -14*a(n-9) -24*a(n-10) for n>11
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 14:01:56, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 24\,a(n-2) + 7\,a(n-3) - 15\,a(n-4) - 84\,a(n-6) - 139\,a(n-7) - 28\,a(n-8) - 14\,a(n-9) - 24\,a(n-10)
\]
for every $n>11$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253400.
