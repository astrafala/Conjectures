...
\title{The empirical recurrence for OEIS A207112, proved by transfer matrix}
...
\begin{abstract}
OEIS A207112 counts arrays over $\{0,\dots,1\}$ of width $3$ that avoid the patterns
...
OEIS A207112 is ``Number of 3Xn 0..1 arrays avoiding 0 0 0 and 0 1 1 horizontally and 0 0 1 and 1 1 0 vertically.''. It has offset
$1$ and begins
\[
6, 36, 98, 271, 677, 1504, 3399,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 13:29:14, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 3\,a(n-2) - 2\,a(n-3) - 13\,a(n-4) + 3\,a(n-5) + 13\,a(n-6) + 9\,a(n-7) - 12\,a(n-8) - 2\,a(n-9) - 3\,a(n-10) - a(n-11) - 2\,a(n-12) + 8\,a(n-13) + a(n-14) - 2\,a(n-15) - 2\,a(n-16) + a(n-17)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207112.
