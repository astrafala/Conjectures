...
\title{The empirical recurrence for OEIS A209549, proved by transfer matrix}
...
\begin{abstract}
OEIS A209549 counts $(n+1)\times5$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A209549 is ``1/4 the number of (n+1)X5 0..3 arrays with every 2X2 subblock having exactly two distinct clockwise edge differences.''. It has offset $1$ and begins
\[
191, 3051, 46515, 723636, 11226644, 174401424, 2708892873, 42079740150,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 15:20:40, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;26\,a(n-1) - 177\,a(n-2) + 43\,a(n-3) + 3477\,a(n-4) - 10179\,a(n-5) - 6160\,a(n-6) + 62922\,a(n-7) - 59442\,a(n-8) - 82557\,a(n-9) + 141262\,a(n-10) + 24872\,a(n-11) - 112175\,a(n-12) + 5660\,a(n-13) + 41275\,a(n-14) - 1936\,a(n-15) - 7049\,a(n-16) - 319\,a(n-17) + 400\,a(n-18) + 56\,a(n-19) + 2\,a(n-20)
\end{equation}
for all $n>20$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209549.
