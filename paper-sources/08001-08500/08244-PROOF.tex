...
\title{The empirical recurrence for OEIS A302467, proved by transfer matrix}
...
\begin{abstract}
OEIS A302467 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the six horizontal, diagonal and antidiagonal neighbours, a number $equal to$ itself lying in $\{1,2,3,5\}$, and it carries an empirical
...
OEIS A302467 is ``Number of nX3 0..1 arrays with every element equal to 1, 2, 3 or 5 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 14, 49, 250, 1147, 5486, 25599, 121626,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 08 2018 10:13:03, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 9\,a(n-2) + 15\,a(n-3) - 68\,a(n-4) - 132\,a(n-5) + 96\,a(n-6) + 136\,a(n-7) - 34\,a(n-8) - 276\,a(n-9) + 188\,a(n-10) - 8\,a(n-11) + 32\,a(n-12) - 16\,a(n-13) + 64\,a(n-14)
\end{equation}
for all $n>14$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302467.
