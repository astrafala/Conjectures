...
\title{The empirical recurrence for OEIS A236665, proved by transfer matrix}
...
\begin{abstract}
OEIS A236665 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
OEIS A236665 is ``Number of (n+1)X(2+1) 0..2 arrays colored with the maximum plus the lower median minus the upper median minus the minimum of every 2X2 subblock.''. It has offset $1$ and begins
\[
452, 3720, 30352, 250708, 2079296, 17174856, 141244420, 1164128912,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 09:26:22, revision 6) this is still
...
\]
over the $S=452$ pairs whose own subblock row is properly coloured.
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-2) + 65\,a(n-3) + 2268\,a(n-4) + 9820\,a(n-5) + 28192\,a(n-6) + 67800\,a(n-7) - 62168\,a(n-8) - 623456\,a(n-9) - 512512\,a(n-10) + 1674752\,a(n-11) + 5791232\,a(n-12) + 13304832\,a(n-13) + 17710080\,a(n-14) + 8847360\,a(n-15)
\]
for every $n>15$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A236665.
