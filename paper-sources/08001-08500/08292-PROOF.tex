...
\title{The empirical recurrence for OEIS A207009, proved by transfer matrix}
...
\begin{abstract}
OEIS A207009 counts arrays of width $2$ over $\{0,1,2\}$ containing no occurrence of certain short
...
OEIS A207009 is ``Number of n X 2 0..2 arrays avoiding the patterns z z+1 z or z z-1 z in any row or column.''. It has offset $1$ and begins
\[
9, 81, 529, 3721, 25921, 180625, 1256641, 8743849,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 27 2023 12:18:01, revision 16) this is still
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-1) - 6\,a(n-2) + 22\,a(n-3) + 114\,a(n-4) + 104\,a(n-5) - 184\,a(n-6) - 352\,a(n-7) - 128\,a(n-8) - 64\,a(n-9) + 32\,a(n-10)
\]
for every $n>10$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207009.
