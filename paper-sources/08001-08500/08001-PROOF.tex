...
\title{The empirical recurrence for OEIS A202399, proved by transfer matrix}
...
\begin{abstract}
OEIS A202399 counts arrays of width $3$ over $\{0,1\}$ containing no occurrence of certain short
...
OEIS A202399 is ``Number of (n+2)X3 binary arrays avoiding patterns 000 and 010 in rows and columns.''. It has offset $1$ and begins
\[
126, 441, 1785, 7225, 27880, 107584, 422136, 1656369,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 09:33:53, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) - a(n-2) + 18\,a(n-3) + 44\,a(n-4) + 38\,a(n-5) + 80\,a(n-6) - 80\,a(n-8) - 38\,a(n-9) - 44\,a(n-10) - 18\,a(n-11) + a(n-12) - 2\,a(n-13) + a(n-14)
\]
for every $n>11$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A202399.
