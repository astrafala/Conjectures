...
\title{The empirical recurrence for OEIS A252196, proved by transfer matrix}
...
\begin{abstract}
OEIS A252196 counts $(n+2)\times5$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252196 is ``Number of (n+2)X(3+2) 0..3 arrays with every 3X3 subblock row, column, diagonal and antidiagonal sum not equal to 0 3 5 6 or 7.''. It has offset $1$ and begins
\[
970, 669, 1647, 5177, 17541, 60325, 206825, 711829,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 10:55:06, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) - a(n-2) + 13\,a(n-3) + 20\,a(n-4) + 23\,a(n-5) + 13\,a(n-6) - 57\,a(n-7) - 56\,a(n-8) + 10\,a(n-10) + 60\,a(n-11) + 29\,a(n-12) - 23\,a(n-13) - 28\,a(n-14) - 14\,a(n-15) + 6\,a(n-16) + 4\,a(n-18)
\]
for every $n>23$.
\end{theorem}
...
at once. By Lemma~\ref{lem:crit} the recurrence holds for every $n>23$.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252196.
