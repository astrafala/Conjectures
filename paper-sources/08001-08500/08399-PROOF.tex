...
\title{The empirical recurrence for OEIS A316920, proved by transfer matrix}
...
\begin{abstract}
OEIS A316920 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A316920 is ``Number of nX3 0..1 arrays with every element unequal to 0, 1, 3, 4, 5, 6 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
3, 9, 13, 31, 81, 184, 492, 1457,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 16 2018 12:50:14, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) - 6\,a(n-2) + 14\,a(n-3) - 52\,a(n-4) + 39\,a(n-5) - 20\,a(n-6) + 84\,a(n-7) - 17\,a(n-8) - 6\,a(n-9) - 7\,a(n-10) - 50\,a(n-11) - 16\,a(n-12) - 47\,a(n-13) + 144\,a(n-14) - 64\,a(n-15) - 12\,a(n-16) + 8\,a(n-17)
\end{equation}
for all $n>19$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A316920.
