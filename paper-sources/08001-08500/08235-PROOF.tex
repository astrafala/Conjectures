...
\title{The empirical recurrence for OEIS A237539, proved by transfer matrix}
...
\begin{abstract}
OEIS A237539 counts arrays over $\{0,\dots,3\}$ subject to a condition on the order
...
OEIS A237539 is ``Number of (n+1)X(1+1) 0..3 arrays with the maximum plus the lower median minus the upper median minus the minimum of every 2X2 subblock differing from its horizontal and vertical neighbors by exactly one.''. It has offset $1$ and begins
\[
256, 1888, 14208, 106496, 798208, 5985280, 44879872, 336408576,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3120*a(n-4) +121600*a(n-8) +4931584*a(n-12) -10485760*a(n-16) for n>17
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 10:15:53, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;3120\,a(n-4) + 121600\,a(n-8) + 4931584\,a(n-12) - 10485760\,a(n-16)
\]
for every $n>17$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237539.
