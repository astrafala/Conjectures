...
\title{The empirical recurrence for OEIS A237369, proved by transfer matrix}
...
\begin{abstract}
OEIS A237369 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
The condition is local to two consecutive rows, so the count is a walk count on $S=288$
...
OEIS A237369 is ``Number of (n+1)X(2+1) 0..2 arrays with the maximum plus the upper median plus the lower median plus the minimum of every 2X2 subblock differing from its horizontal and vertical neighbors by exactly one.''. It has offset $1$ and begins
\[
288, 1164, 4760, 20812, 90528, 393456, 1707488, 7460608,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 370*a(n-4) -3916*a(n-8) +6904*a(n-12) -1984*a(n-16) for n>18
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 10:06:56, revision 6) this is still
...
differ by $1$. The entry's first term $288$ counts those, and the model was made to
...
\]
over the $S=288$ pairs whose own subblock row already satisfies the condition along itself.
...
\begin{theorem}
\[
a(n)\;=\;370\,a(n-4) - 3916\,a(n-8) + 6904\,a(n-12) - 1984\,a(n-16)
\]
for every $n>18$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237369.
