...
\title{The empirical recurrence for OEIS A305247, proved by transfer matrix}
...
\begin{abstract}
OEIS A305247 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A305247 is ``Number of n X 3 0..1 arrays with every element unequal to 0, 1, 3, 4 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
3, 7, 10, 17, 34, 65, 121, 244,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) +a(n-2) +a(n-4) -4*a(n-5) -a(n-6) -10*a(n-7) -10*a(n-8) -3*a(n-9) +6*a(n-11) +2*a(n-12).
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 30 2023 16:37:31, revision
7) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + a(n-2) + a(n-4) - 4\,a(n-5) - a(n-6) - 10\,a(n-7) - 10\,a(n-8) - 3\,a(n-9) + 6\,a(n-11) + 2\,a(n-12)
\end{equation}
for all $n>12$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A305247.
