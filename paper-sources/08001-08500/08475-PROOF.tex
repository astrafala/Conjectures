...
\title{The empirical recurrence for OEIS A207443, proved by transfer matrix}
...
\begin{abstract}
OEIS A207443 counts arrays over $\{0,\dots,1\}$ of width $3$ that avoid the patterns
...
OEIS A207443 is ``Number of 3Xn 0..1 arrays avoiding 0 0 1 and 0 1 0 horizontally and 0 0 1 and 1 0 0 vertically.''. It has offset
$1$ and begins
\[
6, 36, 108, 323, 1058, 3223, 9515,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 13:55:06, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207443.
