...
\title{The empirical recurrence for OEIS A250693, proved by transfer matrix}
...
\begin{abstract}
OEIS A250693 counts arrays over $\{0,1,2,3\}$ in which a statistic taken over short runs
...
OEIS A250693 is ``Number of (2+1)X(n+1) 0..3 arrays with nondecreasing x(i,j)-x(i,j-1) in the i direction and nondecreasing absolute value of x(i,j)-x(i-1,j) in the j direction.''. It has offset $1$ and begins
\[
520, 2920, 13906, 60508, 249512, 995624, 3894542, 15061244,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 12:42:10, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;20\,a(n-1) - 175\,a(n-2) + 882\,a(n-3) - 2835\,a(n-4) + 6072\,a(n-5) - 8777\,a(n-6) + 8458\,a(n-7) - 5204\,a(n-8) + 1848\,a(n-9) - 288\,a(n-10)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250693.
