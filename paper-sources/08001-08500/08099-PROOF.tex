...
\title{The empirical recurrence for OEIS A236803, proved by transfer matrix}
...
\begin{abstract}
OEIS A236803 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
OEIS A236803 is ``Number of (n+1)X(2+1) 0..2 arrays with the maximum plus the lower median minus the upper median minus the minimum of every 2X2 subblock equal.''. It has offset $1$ and begins
\[
277, 1435, 8825, 60187, 410305, 2926867, 20377961, 147734251,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 09:34:09, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;12\,a(n-1) + 15\,a(n-2) - 672\,a(n-3) + 2434\,a(n-4) + 864\,a(n-5) - 17988\,a(n-6) + 24192\,a(n-7) + 14472\,a(n-8) - 46656\,a(n-9) + 23328\,a(n-10)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A236803.
