...
\title{The empirical recurrence for OEIS A232401, proved by transfer matrix}
...
\begin{abstract}
OEIS A232401 counts arrays of width $4$ over $\{0,\dots,2\}$ under a condition on each cell
...
OEIS A232401 is ``Number of (n+1)X(3+1) 0..2 arrays with every element next to itself plus and minus one within the range 0..2 horizontally or vertically, with no adjacent elements equal.''. It has offset $1$ and begins
\[
8, 20, 52, 176, 484, 1500, 4416, 13220,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) +4*a(n-2) +a(n-3) -10*a(n-4) -9*a(n-5) +16*a(n-7) +4*a(n-8) -a(n-9) -4*a(n-10) -a(n-11) -a(n-12)
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 07:24:30, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 4\,a(n-2) + a(n-3) - 10\,a(n-4) - 9\,a(n-5) + 16\,a(n-7) + 4\,a(n-8) - a(n-9) - 4\,a(n-10) - a(n-11) - a(n-12)
\]
for every $n>11$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232401.
