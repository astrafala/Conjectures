...
\title{The empirical recurrence for OEIS A188712, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A188712 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A188712 is ``Number of 8Xn binary arrays without the pattern 0 0 diagonally or vertically.''. It has offset $1$ and begins
\[
55, 1681, 54049, 1729531, 55337580, 1769780565, 56585607231, 1808994829500,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 04:47:55, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;55\,a(n-1) - 933\,a(n-2) + 7094\,a(n-3) - 27502\,a(n-4) + 57434\,a(n-5) - 65257\,a(n-6) + 38535\,a(n-7) - 10341\,a(n-8) + 900\,a(n-9)
\end{equation}
for all $n>11$.

\section{The condition, and why one column is not enough}

The arrays have $8$ rows and $L=n$ columns; write $x_{t,u}$ for the entry in
...
Let $V=\{0,\dots,1\}^{8}$ be the possible columns and take
...
and $8$ rows. In the walk, the cells of column $t$ for $2\le t\le L-1$ are tested
...
of the $(1+1)^{8}$ possible next columns, the condition was tested on every cell of
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A188712.
