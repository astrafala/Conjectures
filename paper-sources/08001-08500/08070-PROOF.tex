...
\title{The empirical recurrence for OEIS A204223, proved by transfer matrix}
...
\begin{abstract}
OEIS A204223 counts arrays over $\{0,\dots,2\}$ under a condition on the sum of every
...
OEIS A204223 is ``Number of (n+1)X2 0..2 arrays with the sums of 2X2 subblocks nondecreasing rightwards and downwards.''. It has offset $1$ and begins
\[
81, 450, 2500, 11100, 49284, 192474, 751689, 2707641,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 11:02:11, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;9\,a(n-1) - 2\,a(n-2) - 210\,a(n-3) + 498\,a(n-4) + 1782\,a(n-5) - 7500\,a(n-6) - 4716\,a(n-7) + 53007\,a(n-8) - 25623\,a(n-9) - 209346\,a(n-10) + 253710\,a(n-11) + 460144\,a(n-12) - 940824\,a(n-13) - 427120\,a(n-14) + 1906032\,a(n-15) - 338256\,a(n-16) - 2148336\,a(n-17) + 1287648\,a(n-18) + 1144800\,a(n-19) - 1233792\,a(n-20) - 62208\,a(n-21) + 414720\,a(n-22) - 124416\,a(n-23)
\]
for every $n>23$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204223.
