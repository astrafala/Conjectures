...
\title{The empirical recurrence for OEIS A299874, proved by transfer matrix}
...
\begin{abstract}
OEIS A299874 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $equal to$ itself lying in $\{0,1,2,4,5,7,8\}$, and it carries an empirical
...
OEIS A299874 is ``Number of n X 3 0..1 arrays with every element equal to 0, 1, 2, 4, 5, 7 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
4, 13, 20, 41, 102, 253, 632, 1563,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 25 2023 14:33:22, revision
6) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) - 7\,a(n-2) + 7\,a(n-3) - 24\,a(n-4) + 31\,a(n-5) - 21\,a(n-6) + 51\,a(n-7) - 50\,a(n-8) + 44\,a(n-9) - 78\,a(n-10) + 34\,a(n-11) - 37\,a(n-12) + 60\,a(n-13) - 10\,a(n-14) + 20\,a(n-15) - 24\,a(n-16)
\end{equation}
for all $n>17$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A299874.
