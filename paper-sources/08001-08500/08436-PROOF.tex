...
\title{The empirical recurrence for OEIS A208117, proved by transfer matrix}
...
\begin{abstract}
OEIS A208117 counts arrays over $\{0,\dots,1\}$ of width $7$ that avoid the patterns
...
OEIS A208117 is ``Number of nX7 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 0 1 and 0 1 1 vertically.''. It has offset
$1$ and begins
\[
40, 1600, 9240, 53361, 175560, 577600, 1432600,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:39:14, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208117.
