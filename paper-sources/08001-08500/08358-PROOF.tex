...
\title{The empirical recurrence for OEIS A250788, proved by transfer matrix}
...
\begin{abstract}
OEIS A250788 counts arrays over $\{0,1\}$ in which a statistic taken over short runs
...
OEIS A250788 is ``Number of (6+1) X (n+1) 0..1 arrays with nondecreasing x(i,j)+x(i,j-1) in the i direction and nondecreasing absolute value of x(i,j)-x(i-1,j) in the j direction.''. It has offset $1$ and begins
\[
288, 796, 2010, 5028, 12036, 27986, 63184, 139436,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 7*a(n-1) - 18*a(n-2) + 17*a(n-3) + 8*a(n-4) - 29*a(n-5) + 18*a(n-6) + 3*a(n-7) - 7*a(n-8) + 2*a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 20 2018 03:38:17, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-1) - 18\,a(n-2) + 17\,a(n-3) + 8\,a(n-4) - 29\,a(n-5) + 18\,a(n-6) + 3\,a(n-7) - 7\,a(n-8) + 2\,a(n-9)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250788.
