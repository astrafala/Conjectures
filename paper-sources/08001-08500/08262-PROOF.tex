...
\title{The empirical recurrence for OEIS A234763, proved by transfer matrix}
...
\begin{abstract}
OEIS A234763 counts arrays of width $3$ over $\{0,1,2,3\}$ subject to a condition read round the
...
OEIS A234763 is ``Number of (n+1)X(2+1) 0..3 arrays with 2X2 edge jumps all no more than +1 in one of the clockwise or counterclockwise directions but not both.''. It has offset $1$ and begins
\[
240, 1624, 9404, 64180, 398696, 2678704, 17095452, 113639852,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 08:24:52, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-1) + 21\,a(n-2) - 252\,a(n-3) + 125\,a(n-4) + 1818\,a(n-5) - 2050\,a(n-6) - 4364\,a(n-7) + 6237\,a(n-8) + 2860\,a(n-9) - 5787\,a(n-10) + 336\,a(n-11) + 1311\,a(n-12) - 262\,a(n-13)
\]
for every $n>13$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234763.
