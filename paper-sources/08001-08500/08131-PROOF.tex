...
\title{The empirical recurrence for OEIS A253700, proved by transfer matrix}
...
\begin{abstract}
OEIS A253700 counts arrays of width $4$ over $\{0,1\}$ in which two diagonal numbers of every $2\times2$ subblock each differ from the same number at a neighbouring subblock. The entry carries an
...
OEIS A253700 is ``Number of (3+1)X(n+1) 0..1 arrays with every 2X2 subblock ne-sw antidiagonal difference unequal to its neighbors horizontally and nw+se diagonal sum unequal to its neighbors vertically.''. It has offset $1$ and begins
\[
104, 146, 234, 356, 618, 968, 1608, 2558,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 14:10:22, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-2) + 2\,a(n-4) + 2\,a(n-5) - 3\,a(n-6) + a(n-7) - a(n-8) - 6\,a(n-9) + 2\,a(n-10) - 2\,a(n-12) - 3\,a(n-13) + a(n-14) + 6\,a(n-15) + a(n-16) + a(n-17) - a(n-18) - a(n-19)
\]
for every $n>21$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253700.
