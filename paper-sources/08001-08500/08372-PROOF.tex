...
\title{The empirical recurrence for OEIS A297509, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297509 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A297509 is ``Number of 4Xn 0..1 arrays with every 1 horizontally, diagonally or antidiagonally adjacent to 1 or 2 neighboring 1s.''. It has offset $1$ and begins
\[
1, 87, 531, 2281, 23348, 191192, 1247716, 9450219,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 31 2017 07:31:02, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) + a(n-2) + 122\,a(n-3) - 209\,a(n-4) - 1087\,a(n-5) - 354\,a(n-6) + 4059\,a(n-7) + 1206\,a(n-8) + 3818\,a(n-9) + 692\,a(n-10) - 11767\,a(n-11) - 6075\,a(n-12) - 2835\,a(n-13) - 949\,a(n-14) + 8451\,a(n-15) + 6295\,a(n-16) - 636\,a(n-17) + 2500\,a(n-18) - 3242\,a(n-19) - 1428\,a(n-20) + 742\,a(n-21) + 74\,a(n-22) - 24\,a(n-23) + 2\,a(n-24)
\end{equation}
for all $n>25$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297509.
