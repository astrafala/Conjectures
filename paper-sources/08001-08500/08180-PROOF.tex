...
\title{The empirical recurrence for OEIS A260289, proved by transfer matrix}
...
\begin{abstract}
OEIS A260289 counts $(n+2)\times5$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A260289 is ``Number of (n+2)X(3+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000001 00000011 or 00001001.''. It has offset $1$ and begins
\[
274, 544, 1336, 2966, 3764, 8660, 21028, 33108,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 12:05:14, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-3) + 7\,a(n-4) - 9\,a(n-6) - 6\,a(n-7) - 11\,a(n-8) + 4\,a(n-9) + 46\,a(n-10) - 48\,a(n-11) + 14\,a(n-12) - 32\,a(n-13) - 31\,a(n-14) + 37\,a(n-16) + 8\,a(n-17) - 48\,a(n-18) + 4\,a(n-19) - 54\,a(n-20) + 16\,a(n-21) - 12\,a(n-22) + 24\,a(n-23) + 20\,a(n-24)
\]
for every $n>28$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A260289.
