...
\title{The empirical recurrence for OEIS A301948, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A301948 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A301948 is ``Number of nX5 0..1 arrays with every element equal to 1, 2 or 3 horizontally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
3, 52, 680, 9084, 120815, 1608681, 21418808, 285190208,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 29 2018 12:43:48, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;16\,a(n-1) - 29\,a(n-2) - 114\,a(n-3) + 324\,a(n-4) + 8\,a(n-5) - 709\,a(n-6) + 690\,a(n-7) + 158\,a(n-8) - 448\,a(n-9) - 34\,a(n-10) + 116\,a(n-11) + 27\,a(n-12) - 4\,a(n-13)
\end{equation}
for all $n>15$.
...
The threshold below is exact rather than merely sufficient: at $n=15$ the conjectured
...
Every one of those integers vanishes from the index corresponding to $n=15+1$ onwards,
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A301948.
