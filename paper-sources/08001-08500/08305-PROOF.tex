...
\title{The empirical recurrence for OEIS A256814, proved by transfer matrix}
...
\begin{abstract}
OEIS A256814 carries an empirical recurrence of order $10$ contributed by R.~H.~Hardin. It is
...
OEIS A256814 is ``Number of length n+6 0..1 arrays with at most two downsteps in every 6 consecutive neighbor pairs.''. It has offset $1$ and begins
\[
120, 229, 442, 856, 1656, 3204, 6192, 11955,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) -a(n-2) +2*a(n-3) -a(n-4) +3*a(n-6) -2*a(n-7) -6*a(n-9) +4*a(n-10).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 24 2018 09:30:02, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) - a(n-2) + 2\,a(n-3) - a(n-4) + 3\,a(n-6) - 2\,a(n-7) - 6\,a(n-9) + 4\,a(n-10)
\]
for every $n>16$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A256814.
