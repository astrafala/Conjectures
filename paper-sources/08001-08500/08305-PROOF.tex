...
\title{The empirical recurrence for OEIS A209510, proved by transfer matrix}
...
\begin{abstract}
OEIS A209510 counts $(n+1)\times8$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A209510 is ``Half the number of (n+1)X8 0..2 arrays with every 2X2 subblock having two or four distinct clockwise edge differences.''. It has offset $1$ and begins
\[
6561, 242889, 9225765, 353991129, 13642432110, 526815563193, 20362314816594, 787378099628577,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 15:17:51, revision 9) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209510.
