...
\title{The empirical recurrence for OEIS A232282, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A232282 counts arrays over $\{0,\dots,2\}$ in which every cell is constrained by the
...
OEIS A232282 is ``Number of 2 X n 0..2 arrays with no element less than a strict majority of its horizontal, diagonal and antidiagonal neighbors.''. It has offset $1$ and begins
\[
9, 35, 199, 1066, 6019, 32301, 174400, 944500,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 9*a(n-1) -23*a(n-2) +20*a(n-3) +81*a(n-4) -511*a(n-5) +294*a(n-6) +150*a(n-7) -168*a(n-8) +1692*a(n-9) +432*a(n-10).
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 21 2024 22:45:26, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;9\,a(n-1) - 23\,a(n-2) + 20\,a(n-3) + 81\,a(n-4) - 511\,a(n-5) + 294\,a(n-6) + 150\,a(n-7) - 168\,a(n-8) + 1692\,a(n-9) + 432\,a(n-10)
\end{equation}
for all $n>11$.
...
the middle column. The vector $w$ was formed by $10$ applications of $G$ in exact integer
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232282.
