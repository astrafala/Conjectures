...
\title{The empirical recurrence for OEIS A253364, proved by transfer matrix}
...
\begin{abstract}
OEIS A253364 counts arrays of width $7$ over $\{0,1\}$ in which the largest entry on the main diagonal minus the smallest on the antidiagonal of every $2\times2$ and $3\times3$ subblock differs from the same number at the neighbouring subblock. The entry carries an
...
$4$ consecutive rows and the count is a walk count on $S=3385$ states.
\end{abstract}
...
OEIS A253364 is ``Number of (n+2)X(5+2) 0..1 arrays with every 2X2 and 3X3 subblock diagonal maximum minus antidiagonal minimum unequal to its neighbors horizontally and vertically.''. It has offset $1$ and begins
\[
1904, 3136, 13800, 23936, 76840, 175328, 438504, 1151296,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 12*a(n-2) -58*a(n-4) +152*a(n-6) -105*a(n-8) +248*a(n-10) -500*a(n-12) +236*a(n-14) -128*a(n-16) for n>19
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 14:00:00, revision 6) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The arrays have $7$ columns and a growing number of rows, with entries in $\{0,1\}$.
...
Thus
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=3385,
\]
...
\begin{theorem}
\[
a(n)\;=\;12\,a(n-2) - 58\,a(n-4) + 152\,a(n-6) - 105\,a(n-8) + 248\,a(n-10) - 500\,a(n-12) + 236\,a(n-14) - 128\,a(n-16)
\]
for every $n>19$.
\end{theorem}
...
array of width $7$ over $\{0,1\}$ with a few rows was written out cell by cell, every block of
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253364.
