...
\title{The empirical recurrence for OEIS A251038, proved by transfer matrix}
...
\begin{abstract}
OEIS A251038 counts arrays over $\{0,1,2,3\}$ in which a statistic taken over short runs
...
OEIS A251038 is ``Number of (1+1)X(n+1) 0..3 arrays with nondecreasing min(x(i,j),x(i,j-1)) in the i direction and nondecreasing absolute value of x(i,j)-x(i-1,j) in the j direction.''. It has offset $1$ and begins
\[
110, 711, 4050, 21720, 110852, 546600, 2624313, 12343573,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:01:54, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;10\,a(n-1) - 25\,a(n-2) - 30\,a(n-3) + 146\,a(n-4) + 31\,a(n-5) - 287\,a(n-6) - 50\,a(n-7) + 239\,a(n-8) + 59\,a(n-9) - 86\,a(n-10) - 27\,a(n-11) + 11\,a(n-12) + 4\,a(n-13)
\]
for every $n>12$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251038.
