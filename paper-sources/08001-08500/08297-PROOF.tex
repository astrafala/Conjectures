...
\title{The empirical recurrence for OEIS A257014, proved by transfer matrix}
...
\begin{abstract}
OEIS A257014 counts arrays of width $3$ over $\{0,1,2\}$ in which every $3\times3$ window has
...
OEIS A257014 is ``Number of (n+2)X(1+2) 0..2 arrays with no 3x3 subblock diagonal sum equal to the antidiagonal sum.''. It has offset $1$ and begins
\[
15066, 311364, 6508512, 136048896, 2834352000, 59049000000, 1231525944000, 25684705088064,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 9*a(n-1) +2592*a(n-3) +40824*a(n-4) +192456*a(n-5) +1679616*a(n-6) -90699264*a(n-8) -272097792*a(n-9)
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 15:16:45, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;9\,a(n-1) + 2592\,a(n-3) + 40824\,a(n-4) + 192456\,a(n-5) + 1679616\,a(n-6) - 90699264\,a(n-8) - 272097792\,a(n-9)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A257014.
