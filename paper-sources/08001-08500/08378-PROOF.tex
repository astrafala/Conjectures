...
\title{The empirical recurrence for OEIS A208396, proved by transfer matrix}
...
\begin{abstract}
OEIS A208396 counts $5\times n$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A208396 is ``Number of 5Xn 0..2 arrays with new values 0..2 introduced in row major order and no element equal to more than two of its immediate leftward or upward or right-upward antidiagonal neighbors.''. It has offset $1$ and begins
\[
41, 9842, 2056392, 438083928, 93120350760, 19798894881900, 4209452449879284, 894976200467603100,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:49:06, revision 9) this is still
...
$\{0,\dots,2\}^{5}$. The neighbourhood of a cell in column $u_i$ meets $u_{i-1}$,
...
\begin{theorem}
\[
a(n)\;=\;171\,a(n-1) + 8504\,a(n-2) + 77860\,a(n-3) - 1000900\,a(n-4) - 11005932\,a(n-5) + 78914544\,a(n-6) + 374284064\,a(n-7) - 3897108352\,a(n-8) + 9817487872\,a(n-9) - 6449426432\,a(n-10) - 6696632320\,a(n-11) + 7534936064\,a(n-12) + 1817837568\,a(n-13) - 2092433408\,a(n-14) - 484442112\,a(n-15)
\]
for every $n>18$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208396.
