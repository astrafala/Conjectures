...
\title{The empirical recurrence for OEIS A237843, proved by transfer matrix}
...
\begin{abstract}
OEIS A237843 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
The condition is local to two consecutive rows, so the count is a walk count on $S=26$
...
OEIS A237843 is ``Number of (n+1) X (1+1) 0..2 arrays with the maximum minus the lower median of every 2 X 2 subblock equal.''. It has offset $1$ and begins
\[
81, 369, 1697, 8451, 43061, 224559, 1184701, 6305583,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 13 2026 12:52:42, revision 8) this is still
...
array, which is not among the objects counted. There are $S=26$ states left.
...
\begin{theorem}
\[
a(n)\;=\;10\,a(n-1) - 10\,a(n-2) - 162\,a(n-3) + 377\,a(n-4) + 892\,a(n-5) - 2886\,a(n-6) - 1748\,a(n-7) + 9208\,a(n-8) - 336\,a(n-9) - 12832\,a(n-10) + 4416\,a(n-11) + 6144\,a(n-12) - 3072\,a(n-13)
\]
for every $n>12$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237843.
