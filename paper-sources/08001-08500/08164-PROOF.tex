...
\title{The empirical recurrence for OEIS A237678, proved by transfer matrix}
...
\begin{abstract}
OEIS A237678 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
statistics of every $2\times2$ subblock, and carries an empirical recurrence of order
$18$ contributed by R.~H.~Hardin. It is true, and it is decidable rather than empirical.
...
OEIS A237678 is ``Number of (n+1)X(1+1) 0..2 arrays colored with the upper median plus the lower median minus the minimum of every 2X2 subblock.''. It has offset $1$ and begins
\[
81, 474, 2741, 15948, 93093, 541880, 3152844, 18356756,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 10:20:44, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;72\,a(n-3) + 456\,a(n-4) + 1084\,a(n-5) + 3312\,a(n-6) + 712\,a(n-7) - 9384\,a(n-8) - 26848\,a(n-9) - 73104\,a(n-10) + 19232\,a(n-11) + 112256\,a(n-12) + 249216\,a(n-13) + 378368\,a(n-14) - 641536\,a(n-15) - 627712\,a(n-16) + 231424\,a(n-17) + 372736\,a(n-18)
\]
for every $n>18$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237678.
