...
\title{The empirical recurrence for OEIS A189690, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A189690 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A189690 is ``Number of nX3 binary arrays without the pattern 0 0 1 diagonally, vertically or antidiagonally.''. It has offset $1$ and begins
\[
8, 64, 292, 1298, 5172, 20316, 77752, 295720,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 05:23:39, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;7\,a(n-1) - 9\,a(n-2) - 31\,a(n-3) + 76\,a(n-4) + 22\,a(n-5) - 173\,a(n-6) + 69\,a(n-7) + 151\,a(n-8) - 111\,a(n-9) - 48\,a(n-10) + 52\,a(n-11) + 4\,a(n-12) - 8\,a(n-13)
\end{equation}
for all $n>14$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A189690.
