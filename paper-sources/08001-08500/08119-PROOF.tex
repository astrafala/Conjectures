...
\title{The empirical recurrence for OEIS A206506, proved by transfer matrix}
...
\begin{abstract}
OEIS A206506 counts arrays of width $3$ over $\{0,1,2\}$ subject to a condition read round the
...
OEIS A206506 is ``Number of (n+1)X3 0..2 arrays with the number of clockwise edge increases in 2X2 subblocks nondecreasing rightwards and downwards.''. It has offset $1$ and begins
\[
549, 7737, 93405, 1020756, 10505604, 103812645, 997160112, 9383642739,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 12:58:00, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;20\,a(n-1) - 108\,a(n-2) - 116\,a(n-3) + 2081\,a(n-4) - 2052\,a(n-5) - 9023\,a(n-6) + 14684\,a(n-7) + 4103\,a(n-8) - 20511\,a(n-9) + 25590\,a(n-10) - 24138\,a(n-11) - 683\,a(n-12) + 30616\,a(n-13) - 32567\,a(n-14) + 8765\,a(n-15) - 850\,a(n-16) + 4935\,a(n-17) + 9392\,a(n-18) - 14485\,a(n-19) + 4202\,a(n-20) + 738\,a(n-21) - 1528\,a(n-22) + 1448\,a(n-23) - 608\,a(n-24) + 96\,a(n-25)
\]
for every $n>24$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206506.
