...
\title{The empirical recurrence for OEIS A253813, proved by transfer matrix}
...
\begin{abstract}
OEIS A253813 counts the arrays over $\{0,\dots,1\}$ whose $3\times3$ subblocks carry a
...
OEIS A253813 is ``Number of (n+2)X(1+2) 0..1 arrays with every 3X3 subblock diagonal sum minus antidiagonal median nondecreasing horizontally and vertically.''. It has offset $1$ and begins
\[
512, 2700, 12680, 47816, 178752, 618856, 2201616, 7686444,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 14:15:31, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-1) - 13\,a(n-2) - 48\,a(n-3) + 189\,a(n-4) - 186\,a(n-5) - 159\,a(n-6) + 930\,a(n-7) - 2020\,a(n-8) + 1910\,a(n-9) + 440\,a(n-10) - 3300\,a(n-11) + 5625\,a(n-12) - 6150\,a(n-13) + 3525\,a(n-14) - 750\,a(n-15) - 625\,a(n-16) + 1250\,a(n-17) - 625\,a(n-18)
\]
for every $n>27$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253813.
