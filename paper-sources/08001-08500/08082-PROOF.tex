...
\title{The empirical recurrence for OEIS A252636, proved by transfer matrix}
...
\begin{abstract}
OEIS A252636 counts $(n+2)\times6$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
$a(n)$ is a walk count on $S=183717$ vertices. Such a sequence is $C$-finite, so whether a given
...
OEIS A252636 is ``Number of (n+2)X(4+2) 0..3 arrays with every 3X3 subblock row and diagonal sum equal to 0 3 4 6 or 7 and every 3X3 column and antidiagonal sum not equal to 0 3 4 6 or 7.''. It has offset $1$ and begins
\[
3162, 8253, 29463, 95904, 395940, 1504636, 5124134, 21431528,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:29:09, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;145\,a(n-3) - 7116\,a(n-6) + 136668\,a(n-9) - 902360\,a(n-12) + 4683424\,a(n-15) - 17197984\,a(n-18) + 26472832\,a(n-21) - 12749824\,a(n-24) + 720896\,a(n-27)
\]
for every $n>35$.
\end{theorem}
...
exactly. Those integers vanish from the index corresponding to $n=35+1$ onwards, and the
run was continued until the working vector was identically zero, which settles all larger $j$
at once. By Lemma~\ref{lem:crit} the recurrence holds for every $n>35$.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252636.
