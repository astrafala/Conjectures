...
\title{The empirical recurrence for OEIS A207593, proved by transfer matrix}
...
\begin{abstract}
OEIS A207593 counts arrays over $\{0,\dots,1\}$ of width $6$ that avoid the patterns
...
OEIS A207593 is ``Number of 6 X n 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 0 1 and 1 1 1 vertically.''. It has offset
$1$ and begins
\[
18, 324, 612, 2232, 7272, 25776, 85536,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = -a(n-1) + 16*a(n-2) + 18*a(n-3) - 61*a(n-4) - 61*a(n-5) + 66*a(n-6) + 58*a(n-7) - 8*a(n-8) - 8*a(n-9) for n>11.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 25 2018 03:51:37, revision
12) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;-a(n-1) + 16\,a(n-2) + 18\,a(n-3) - 61\,a(n-4) - 61\,a(n-5) + 66\,a(n-6) + 58\,a(n-7) - 8\,a(n-8) - 8\,a(n-9)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207593.
