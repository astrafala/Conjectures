...
\title{The empirical recurrence for OEIS A242470, proved by transfer matrix}
...
\begin{abstract}
OEIS A242470 carries an empirical recurrence of order $12$ contributed by R.~H.~Hardin. It is
...
OEIS A242470 is ``Number of length n+2 0..7 arrays with no three equal elements in a row and new values 0..7 introduced in 0..7 order.''. It has offset $1$ and begins
\[
4, 12, 41, 159, 685, 3233, 16533, 90817,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 11:16:37, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A242470.
