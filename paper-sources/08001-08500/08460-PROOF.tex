...
\title{The empirical recurrence for OEIS A234781, proved by transfer matrix}
...
\begin{abstract}
OEIS A234781 counts arrays of width $4$ over $\{0,1,2,3\}$ subject to a condition read round the
...
count is a walk count on a finite digraph with $S=109$ vertices, and whether a linear
...
OEIS A234781 is ``Number of (n+1)X(3+1) 0..3 arrays with no adjacent elements equal and with each 2X2 subblock having the number of clockwise edge increases equal to the number of counterclockwise edge increases.''. It has offset $1$ and begins
\[
3084, 91916, 2761748, 83120724, 2502596188, 75353928188, 2268967605156, 68320694237108,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 08:26:30, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;45\,a(n-1) - 528\,a(n-2) + 2592\,a(n-3) - 5997\,a(n-4) + 5689\,a(n-5) + 812\,a(n-6) - 4760\,a(n-7) + 1942\,a(n-8) + 278\,a(n-9) - 112\,a(n-10)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234781.
