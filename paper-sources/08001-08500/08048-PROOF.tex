...
\title{The empirical recurrence for OEIS A183347, proved by transfer matrix}
...
\begin{abstract}
OEIS A183347 counts arrays of width $5$ over $\{0,1\}$ under local conditions relating each cell
...
OEIS A183347 is ``Number of nX5 binary arrays with each 1 adjacent to exactly one 0 vertically and one 0 horizontally.''. It has offset $1$ and begins
\[
1, 33, 64, 163, 594, 1738, 5121, 15789,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n)=a(n-1)+a(n-2)+11*a(n-3)+12*a(n-4)+9*a(n-5)-6*a(n-6)-19*a(n-7)-a(n-8)+10*a(n-9)+4*a(n-10)-2*a(n-12)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 01:35:21, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + a(n-2) + 11\,a(n-3) + 12\,a(n-4) + 9\,a(n-5) - 6\,a(n-6) - 19\,a(n-7) - a(n-8) + 10\,a(n-9) + 4\,a(n-10) - 2\,a(n-12)
\]
for every $n>12$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A183347.
