...
\title{The empirical recurrence for OEIS A252081, proved by transfer matrix}
...
\begin{abstract}
OEIS A252081 counts $(n+2)\times3$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A252081 is ``Number of (n+2) X (1+2) 0..2 arrays with every 3 X 3 subblock row, column, diagonal and antidiagonal sum not equal to 1 3 or 4.''. It has offset $1$ and begins
\[
64, 130, 295, 687, 1591, 3650, 8389, 19412,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 17 2022 23:01:47, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252081.
