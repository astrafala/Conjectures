...
\title{The empirical recurrence for OEIS A241609, proved by transfer matrix}
...
\begin{abstract}
OEIS A241609 carries an empirical recurrence of order $10$ contributed by R.~H.~Hardin. It is
...
OEIS A241609 is ``Number of length n+2 0..3 arrays with no consecutive three elements summing to more than 3.''. It has offset $1$ and begins
\[
20, 50, 125, 295, 711, 1730, 4175, 10077,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + 4*a(n-3) - 3*a(n-4) - a(n-5) - 3*a(n-6) + 2*a(n-7) + a(n-9) - a(n-10).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 30 2018 10:33:38, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 4\,a(n-3) - 3\,a(n-4) - a(n-5) - 3\,a(n-6) + 2\,a(n-7) + a(n-9) - a(n-10)
\]
for every $n>12$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A241609.
