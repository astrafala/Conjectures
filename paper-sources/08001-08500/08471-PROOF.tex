...
\title{The empirical recurrence for OEIS A234676, proved by transfer matrix}
...
\begin{abstract}
OEIS A234676 counts $4$-column arrays over $\{0,\dots,5\}$ in which every
...
length $n$. Hence $a(n)=\mathbf{1}^{\!\top}M^{n}\mathbf{1}$ on $S=1296$ vertices, which
...
OEIS A234676 is ``Number of (n+1) X (3+1) 0..5 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 5 (constant-stress 1 X 1 tilings).''. It has offset
$1$ and begins
\[
1264, 2924, 6328, 17312, 43240, 129848, 354856,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 20 2022 18:42:02, revision 6) the statement is
...
Let $V$ consist of all of $\{0,\dots,5\}^{4}$, and put $S=|V|=1296$. For $r,s\in V$ declare $r\to s$ an edge
...
Third, the vanishing test of Lemma~\ref{lem:crit} was carried past $S=1296$ consecutive
zeros rather than to a sampled prefix, in exact integer arithmetic.

\begin{thebibliography}{9}
\bibitem{oeis} The OEIS Foundation, \emph{The On-Line Encyclopedia of Integer
Sequences}, \url{https://oeis.org}, 2026. Sequence A234676.
