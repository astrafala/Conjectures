...
\title{The empirical recurrence for OEIS A233491, proved by transfer matrix}
...
\begin{abstract}
OEIS A233491 counts arrays of width $4$ over $\{0,1,2\}$ containing no run of $3$ consecutive
...
OEIS A233491 is ``Number of (n+2)X(2+2) 0..2 arrays with no increasing sequence of length 3 horizontally or antidiagonally downwards.''. It has offset $1$ and begins
\[
388908, 26851581, 1853443458, 127934319483, 8830686982464, 609539583118581, 42073567268258250, 2904134713566546240,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 69*a(n-1) +18*a(n-2) -1125*a(n-3) +108*a(n-4) +4131*a(n-5) -3402*a(n-6) +729*a(n-7)
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 08:04:03, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;69\,a(n-1) + 18\,a(n-2) - 1125\,a(n-3) + 108\,a(n-4) + 4131\,a(n-5) - 3402\,a(n-6) + 729\,a(n-7)
\]
for every $n>4$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A233491.
