...
\title{The empirical recurrence for OEIS A184404, proved by transfer matrix}
...
\begin{abstract}
OEIS A184404 counts arrays of width $3$ over $\{0,1,2\}$ in which every $3\times3$ subblock
satisfies a condition on its nine entries. The entry carries an empirical recurrence of order
$15$ contributed by R.~H.~Hardin. It is true, and it is decidable rather than empirical: a
...
OEIS A184404 is ``1/6 the number of (n+2)X3 0..2 arrays with each 3X3 subblock containing two of one value, three of another, and four of the last.''. It has offset $1$ and begins
\[
1260, 16140, 201543, 2563542, 32546547, 414199395, 5273355420, 67176457326,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 02:35:45, revision 10) this is still
...
consecutive rows and three consecutive columns --- and asks that the numbers of times the values occur are $2,\,3,\,4$ in some order. The entry publishes $1/6$ of that count; the division is by a constant and changes nothing about the recurrence.
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + 87\,a(n-2) + 951\,a(n-3) - 378\,a(n-4) - 56196\,a(n-5) - 183789\,a(n-6) - 325296\,a(n-7) - 124173\,a(n-8) + 4381533\,a(n-9) + 8037954\,a(n-10) + 6954660\,a(n-11) - 19420560\,a(n-12) + 2834352\,a(n-13) + 9447840\,a(n-14) + 11337408\,a(n-15)
\]
for every $n>15$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A184404.
