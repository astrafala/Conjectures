...
\title{The empirical recurrence for OEIS A278172, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A278172 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A278172 is ``Number of nX3 0..1 arrays with every element both equal and not equal to some elements at offset (-1,0) (-1,1) (0,-1) (0,1) (1,-1) or (1,0), with upper left element zero.''. It has offset $1$ and begins
\[
0, 5, 18, 126, 737, 4551, 27692, 169131,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 13 2016 16:07:42, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) + 11\,a(n-2) - 22\,a(n-3) - 31\,a(n-4) + 32\,a(n-5) + 47\,a(n-6) + 22\,a(n-7) - 17\,a(n-8) - 77\,a(n-9) - 73\,a(n-10) - 52\,a(n-11) - 37\,a(n-12) - 8\,a(n-13) - a(n-14) + 2\,a(n-16)
\end{equation}
for all $n>18$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A278172.
