...
\title{The empirical recurrence for OEIS A250626, proved by transfer matrix}
...
\begin{abstract}
OEIS A250626 counts arrays over $\{0,1,2\}$ in which a statistic taken over short runs
...
OEIS A250626 is ``Number of (n+1)X(2+1) 0..2 arrays with nondecreasing x(i,j)+x(i,j-1) in the i direction and nondecreasing min(x(i,j),x(i-1,j)) in the j direction.''. It has offset $1$ and begins
\[
154, 654, 2347, 7342, 20743, 53847, 130848, 300960,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 12:36:55, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) - 10\,a(n-2) - 8\,a(n-3) + 40\,a(n-4) - 22\,a(n-5) - 47\,a(n-6) + 56\,a(n-7) + 15\,a(n-8) - 46\,a(n-9) + 8\,a(n-10) + 16\,a(n-11) - 6\,a(n-12) - 2\,a(n-13) + a(n-14)
\]
for every $n>13$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250626.
