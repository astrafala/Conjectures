...
\title{The empirical recurrence for OEIS A205022, proved by transfer matrix}
...
\begin{abstract}
OEIS A205022 counts arrays over $\{0,\dots,3\}$ under a condition on the determinant of every
...
a bounded window of consecutive rows, so the count is a walk count on $S=15040$ states and is
...
OEIS A205022 is ``Number of (n+1)X4 0..3 arrays with the determinants of 2X2 subblocks nondecreasing rightwards and downwards.''. It has offset $1$ and begins
\[
15040, 275853, 7148335, 198539736, 5296848762, 139786868632, 3650380799573, 95296479247095,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 11:40:37, revision 9) this is still
...
\]
on the $S=15040$ admissible pairs.
...
entry's first term is $15040$, and the model reproduces it along with every later term; that
...
\begin{theorem}
\[
a(n)\;=\;56\,a(n-1) - 742\,a(n-2) - 9488\,a(n-3) + 284911\,a(n-4) - 1227272\,a(n-5) - 17654568\,a(n-6) + 180271872\,a(n-7) - 212758272\,a(n-8) - 3603750912\,a(n-9) + 17151492096\,a(n-10) - 28116025344\,a(n-11) + 14619377664\,a(n-12)
\]
for every $n>27$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A205022.
