...
\title{The empirical recurrence for OEIS A183364, proved by transfer matrix}
...
\begin{abstract}
OEIS A183364 counts arrays of width $2$ over $\{0,\dots,1\}$ under a condition on each cell
...
OEIS A183364 is ``Number of n X 2 binary arrays with no element equal to the sum mod 3 of its horizontal and vertical neighbors.''. It has offset $1$ and begins
\[
2, 3, 5, 12, 21, 41, 84, 171,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + a(n-3) - 4*a(n-6) - 3*a(n-7) + a(n-10).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 28 2018 08:14:23, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + a(n-3) - 4\,a(n-6) - 3\,a(n-7) + a(n-10)
\]
for every $n>10$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A183364.
