...
\title{The empirical recurrence for OEIS A252188, proved by transfer matrix}
...
\begin{abstract}
OEIS A252188 counts $(n+2)\times6$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
$a(n)$ is a walk count on $S=400549$ vertices. Such a sequence is $C$-finite, so whether a given
...
OEIS A252188 is ``Number of (n+2) X (4+2) 0..3 arrays with every 3 X 3 subblock row and column sum equal to 0 1 3 6 or 7 and every 3X3 diagonal and antidiagonal sum not equal to 0, 1, 3, 6, or 7.''. It has offset $1$ and begins
\[
3341, 3996, 5460, 9233, 14130, 21417, 34532, 55336,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 7*a(n-3) -14*a(n-6) +8*a(n-9) for n>17.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 23 2025 12:31:33, revision 10) this is still
...
First, the transfer model reproduces all $30$ terms the entry publishes, exactly, in
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252188.
