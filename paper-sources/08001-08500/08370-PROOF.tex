...
\title{The empirical recurrence for OEIS A260099, proved by transfer matrix}
...
\begin{abstract}
OEIS A260099 counts $(n+2)\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A260099 is ``Number of (n+2) X (1+2) 0..1 arrays with each 3 X 3 subblock having clockwise perimeter pattern 00000001 00000101 or 00010101.''. It has offset $1$ and begins
\[
48, 85, 206, 472, 1116, 2575, 6068, 14096,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-2) + 2*a(n-3) + 11*a(n-4) + 6*a(n-5) + 2*a(n-6) + 6*a(n-7) - 8*a(n-8) + 2*a(n-9) for n>10.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 28 2018 09:06:22, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-2) + 2\,a(n-3) + 11\,a(n-4) + 6\,a(n-5) + 2\,a(n-6) + 6\,a(n-7) - 8\,a(n-8) + 2\,a(n-9)
\]
for every $n>10$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A260099.
