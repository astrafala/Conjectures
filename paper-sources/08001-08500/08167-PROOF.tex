...
\title{The empirical recurrence for OEIS A236821, proved by transfer matrix}
...
\begin{abstract}
OEIS A236821 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
The condition is local to two consecutive rows, so the count is a walk count on $S=25$
...
OEIS A236821 is ``Number of (n+1)X(1+1) 0..2 arrays with the maximum plus the minimum minus the lower median of every 2X2 subblock equal.''. It has offset $1$ and begins
\[
81, 327, 1386, 6093, 27079, 121590, 549173, 2495215,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 09:35:57, revision 6) this is still
...
array, which is not among the objects counted. There are $S=25$ states left.
...
\begin{theorem}
\[
a(n)\;=\;9\,a(n-1) - 2\,a(n-2) - 167\,a(n-3) + 265\,a(n-4) + 1110\,a(n-5) - 2280\,a(n-6) - 3350\,a(n-7) + 7924\,a(n-8) + 4700\,a(n-9) - 13072\,a(n-10) - 2560\,a(n-11) + 9856\,a(n-12) + 128\,a(n-13) - 2560\,a(n-14)
\]
for every $n>14$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A236821.
