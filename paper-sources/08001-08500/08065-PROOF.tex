...
\title{The empirical recurrence for OEIS A229375, proved by transfer matrix}
...
\begin{abstract}
OEIS A229375 carries an empirical recurrence of order $12$ contributed by R.~H.~Hardin. It is
...
OEIS A229375 is ``Number of nX3 0..2 arrays avoiding 11 horizontally, 22 vertically and 00 diagonally or antidiagonally.''. It has offset $1$ and begins
\[
22, 126, 956, 6730, 48490, 346598, 2486980, 17808604,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 04 2025 00:10:09, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + 50\,a(n-2) - 133\,a(n-3) - 653\,a(n-4) + 1214\,a(n-5) + 2281\,a(n-6) - 3420\,a(n-7) - 2248\,a(n-8) + 2704\,a(n-9) + 835\,a(n-10) - 481\,a(n-11) - 120\,a(n-12)
\]
for every $n>11$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A229375.
