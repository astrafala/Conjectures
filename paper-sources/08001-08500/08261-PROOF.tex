...
\title{The empirical recurrence for OEIS A236775, proved by transfer matrix}
...
\begin{abstract}
OEIS A236775 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
OEIS A236775 is ``Number of (n+1)X(1+1) 0..2 arrays colored with the maximum plus the upper median plus the minimum minus the lower median of every 2X2 subblock.''. It has offset $1$ and begins
\[
81, 474, 2797, 16360, 95961, 562284, 3296708, 19317952,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 09:31:48, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;40\,a(n-3) + 528\,a(n-4) + 1464\,a(n-5) + 4428\,a(n-6) + 8904\,a(n-7) - 696\,a(n-8) - 16096\,a(n-9) - 77216\,a(n-10) - 159008\,a(n-11) - 61184\,a(n-12) - 18816\,a(n-13) + 190976\,a(n-14) + 365056\,a(n-15) + 172032\,a(n-16) + 73728\,a(n-17)
\]
for every $n>17$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A236775.
