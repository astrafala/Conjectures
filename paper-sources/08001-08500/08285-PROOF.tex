...
\title{The empirical recurrence for OEIS A206746, proved by transfer matrix}
...
\begin{abstract}
OEIS A206746 counts arrays over $\{0,\dots,3\}$ under a condition on the perimeter cycle of
...
a bounded window of consecutive rows, so the count is a walk count on $S=1888$ states and is
...
OEIS A206746 is ``Number of (n+1) X 3 0..3 arrays with every 2 X 3 or 3 X 2 subblock having an equal number of clockwise and counterclockwise edge increases.''. It has offset $1$ and begins
\[
1888, 36384, 793152, 18037344, 415429504, 9604042208, 222273709440, 5145902199776,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 13 2015 21:25:46, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;40\,a(n-1) - 489\,a(n-2) + 2516\,a(n-3) - 5247\,a(n-4) + 276\,a(n-5) + 15809\,a(n-6) - 23256\,a(n-7) + 11000\,a(n-8) + 184\,a(n-9) - 832\,a(n-10)
\]
for every $n>10$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206746.
