...
\title{The empirical recurrence for OEIS A252634, proved by transfer matrix}
...
\begin{abstract}
OEIS A252634 counts $(n+2)\times4$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252634 is ``Number of (n+2)X(2+2) 0..3 arrays with every 3X3 subblock row and diagonal sum equal to 0 3 4 6 or 7 and every 3X3 column and antidiagonal sum not equal to 0 3 4 6 or 7.''. It has offset $1$ and begins
\[
1013, 1684, 4226, 10259, 28978, 80304, 205127, 598762,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:28:54, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;70\,a(n-3) - 1858\,a(n-6) + 23748\,a(n-9) - 154484\,a(n-12) + 505834\,a(n-15) - 868331\,a(n-18) + 1055614\,a(n-21) - 1024560\,a(n-24) + 324000\,a(n-27)
\]
for every $n>36$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252634.
