...
\title{The empirical recurrence for OEIS A300348, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A300348 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A300348 is ``Number of nX6 0..1 arrays with every element equal to 1 or 2 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
5, 90, 133, 325, 729, 1371, 3092, 6068,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 5*a(n-1) -8*a(n-2) +4*a(n-3) +a(n-7) -3*a(n-8) +4*a(n-9) -2*a(n-10) +a(n-11) -a(n-12) -a(n-16) +a(n-17) for n>22
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 03 2018 08:31:16, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) - 8\,a(n-2) + 4\,a(n-3) + a(n-7) - 3\,a(n-8) + 4\,a(n-9) - 2\,a(n-10) + a(n-11) - a(n-12) - a(n-16) + a(n-17)
\end{equation}
for all $n>22$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A300348.
