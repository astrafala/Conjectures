...
\title{The empirical recurrence for OEIS A302529, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A302529 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A302529 is ``Number of 3 X n 0..1 arrays with every element equal to 1, 2, 4 or 5 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
0, 10, 28, 42, 100, 290, 730, 1700,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 14 2026 20:07:59, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) - 4\,a(n-2) + 6\,a(n-3) - 10\,a(n-4) - 24\,a(n-5) + 37\,a(n-6) - 22\,a(n-7) + 72\,a(n-8) + 18\,a(n-9) - 108\,a(n-10) + 24\,a(n-11) - 24\,a(n-12) + 24\,a(n-13) + 8\,a(n-14) - 8\,a(n-15)
\end{equation}
for all $n>17$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302529.
