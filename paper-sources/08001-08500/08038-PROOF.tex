...
\title{The empirical recurrence for OEIS A185766, proved by transfer matrix}
...
\begin{abstract}
OEIS A185766 counts arrays over $\{0,\dots,1\}$ under a condition on the trace of every
...
a bounded window of consecutive rows, so the count is a walk count on $S=1736$ states and is
...
OEIS A185766 is ``Number of (n+1)X7 binary arrays with no 2X2 subblock trace equal to any horizontal or vertical neighbor 2X2 subblock trace.''. It has offset $1$ and begins
\[
1736, 10592, 75192, 562800, 4430912, 35108016, 278758936, 2212654240,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 03:09:45, revision 9) this is still
...
\]
on the $S=1736$ admissible pairs.
...
entry's first term is $1736$, and the model reproduces it along with every later term; that
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 54\,a(n-2) + 60\,a(n-3) - 400\,a(n-4) - 155\,a(n-5) + 924\,a(n-6) - 1220\,a(n-7) - 76\,a(n-8) + 1725\,a(n-9) - 642\,a(n-10) - 412\,a(n-11) - 88\,a(n-12) + 100\,a(n-13) + 40\,a(n-14)
\]
for every $n>18$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A185766.
