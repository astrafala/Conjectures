...
\title{The empirical recurrence for OEIS A237077, proved by transfer matrix}
...
\begin{abstract}
OEIS A237077 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
OEIS A237077 is ``Number of (n+1)X(1+1) 0..2 arrays colored with the maximum plus the minimum minus the upper median minus the lower median of every 2X2 subblock.''. It has offset $1$ and begins
\[
81, 484, 2928, 17644, 106528, 641736, 3871696, 23356112,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 76*a(n-3) +544*a(n-4) +1272*a(n-5) +3512*a(n-6) +3568*a(n-7) -2944*a(n-8) -4864*a(n-9) -6144*a(n-10)
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 09:48:49, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;76\,a(n-3) + 544\,a(n-4) + 1272\,a(n-5) + 3512\,a(n-6) + 3568\,a(n-7) - 2944\,a(n-8) - 4864\,a(n-9) - 6144\,a(n-10)
\]
for every $n>10$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237077.
