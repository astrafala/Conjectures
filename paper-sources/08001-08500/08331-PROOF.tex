...
\title{The empirical recurrence for OEIS A258521, proved by transfer matrix}
...
\begin{abstract}
OEIS A258521 counts the arrays over $\{0,\dots,1\}$ whose $3\times3$ subblocks carry a
...
so the count is a walk count on $S=4682$ states --- the last two array rows together with the
...
OEIS A258521 is ``Number of (n+2)X(3+2) 0..1 arrays with every 3X3 subblock sum of the two sums of the diagonal and antidiagonal minus the two sums of the central column and central row nondecreasing horizontally and vertically.''. It has offset $1$ and begins
\[
6516, 13616, 19920, 25076, 25532, 23907, 23398, 26321,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-4) +4*a(n-5) -4*a(n-9) -5*a(n-10) +5*a(n-14) +2*a(n-15) -2*a(n-19) for n>39
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 15:26:13, revision 6) this is still
...
\]
on the $S=4682$ reachable states. In particular $a$ is $C$-finite. The alignment of the walk
...
\begin{theorem}
\[
a(n)\;=\;a(n-4) + 4\,a(n-5) - 4\,a(n-9) - 5\,a(n-10) + 5\,a(n-14) + 2\,a(n-15) - 2\,a(n-19)
\]
for every $n>39$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A258521.
