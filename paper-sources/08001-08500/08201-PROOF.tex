...
\title{The empirical recurrence for OEIS A296551, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A296551 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A296551 is ``Number of n X 5 0..1 arrays with each 1 horizontally, vertically or antidiagonally adjacent to 3 or 6 neighboring 1s.''. It has offset $1$ and begins
\[
1, 1, 4, 7, 11, 18, 34, 59,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) + 3*a(n-4) + a(n-6) + 3*a(n-7) + a(n-10).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 23 2019 07:24:01, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A296551.
