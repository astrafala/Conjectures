...
\title{The empirical recurrence for OEIS A297981, proved by transfer matrix}
...
\begin{abstract}
OEIS A297981 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A297981 is ``Number of n X 3 0..1 arrays with every element equal to 0, 2, 3 or 6 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 6, 2, 5, 7, 14, 21, 41,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) + 2*a(n-2) + a(n-3) - a(n-4) - 4*a(n-6) - 8*a(n-7) - 2*a(n-8) + 4*a(n-9) + 6*a(n-10) + 2*a(n-11) for n>13.
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 22 2018 17:06:46, revision
8) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 2\,a(n-2) + a(n-3) - a(n-4) - 4\,a(n-6) - 8\,a(n-7) - 2\,a(n-8) + 4\,a(n-9) + 6\,a(n-10) + 2\,a(n-11)
\end{equation}
for all $n>13$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297981.
