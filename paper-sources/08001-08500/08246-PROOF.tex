...
\title{The empirical recurrence for OEIS A277940, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A277940 counts arrays over $\{0,\dots,2\}$ in which every cell is constrained by the
...
OEIS A277940 is ``Number of nX3 0..2 arrays with every element plus 1 mod 3 equal to some element at offset (-1,0) (-1,1) (0,-1) (0,1) or (1,0), with upper left element zero.''. It has offset $1$ and begins
\[
0, 14, 172, 2353, 31011, 410047, 5417792, 71585918,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 05 2016 11:35:35, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;17\,a(n-1) - 46\,a(n-2) - 74\,a(n-3) + 248\,a(n-4) + 365\,a(n-5) - 302\,a(n-6) - 2897\,a(n-7) + 586\,a(n-8) + 9050\,a(n-9) + 1379\,a(n-10) - 16481\,a(n-11) - 15496\,a(n-12) + 28568\,a(n-13) + 32667\,a(n-14) - 39070\,a(n-15) - 26031\,a(n-16) + 26346\,a(n-17) + 8108\,a(n-18) - 5448\,a(n-19) - 1536\,a(n-20)
\end{equation}
for all $n>21$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A277940.
