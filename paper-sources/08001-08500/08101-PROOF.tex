...
\title{The empirical recurrence for OEIS A258677, proved by transfer matrix}
...
\begin{abstract}
OEIS A258677 counts arrays of width $6$ over $\{0,1\}$ in which every $3\times3$ window has
...
OEIS A258677 is ``Number of (n+2)X(4+2) 0..1 arrays with no 3x3 subblock diagonal sum equal to the antidiagonal sum.''. It has offset $1$ and begins
\[
43264, 456976, 5973136, 78074896, 916151824, 10750371856, 133333061904, 1653682833936,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 15:30:11, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;17\,a(n-1) - 68\,a(n-2) + 132\,a(n-3) + 5848\,a(n-4) - 103512\,a(n-5) + 338752\,a(n-6) + 491712\,a(n-7) - 11065856\,a(n-8) + 134969856\,a(n-9) - 439611392\,a(n-10) - 456462336\,a(n-11) + 6754926592\,a(n-12) - 57485033472\,a(n-13) + 186243874816\,a(n-14) + 80580968448\,a(n-15) - 1515720802304\,a(n-16) + 8690463670272\,a(n-17) - 27366457868288\,a(n-18) + 6046240210944\,a(n-19) + 106652627894272\,a(n-20) - 448600744132608\,a(n-21) + 1337006139375616\,a(n-22) - 844424930131968\,a(n-23) - 2251799813685248\,a(n-24) + 6755399441055744\,a(n-25) - 18014398509481984\,a(n-26) + 18014398509481984\,a(n-27)
\]
for every $n>26$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A258677.
