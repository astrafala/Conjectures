...
\title{The empirical recurrence for OEIS A196332, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A196332 counts arrays over $\{0,\dots,4\}$ in which every cell is constrained by the
...
OEIS A196332 is ``Number of nX3 0..4 arrays with each element x equal to the number its horizontal and vertical neighbors equal to 4,0,3,1,2 for x=0,1,2,3,4.''. It has offset $1$ and begins
\[
4, 8, 7, 50, 111, 259, 744, 1840,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 06:30:14, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) - a(n-3) - 5\,a(n-4) + 6\,a(n-5) + 6\,a(n-6) - 22\,a(n-7) - 71\,a(n-8) + 6\,a(n-9) + 95\,a(n-10) + 3\,a(n-11) + 139\,a(n-12) - 20\,a(n-13) - 45\,a(n-14) + 44\,a(n-15) - 6\,a(n-16) - 14\,a(n-17)
\end{equation}
for all $n>18$.
...
\#\{\text{neighbours with value }f(x_{t,u})\}=x_{t,u},\quad f=(4,0,3,1,2)
\end{equation}
for every cell $(t,u)$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A196332.
