...
\title{The empirical recurrence for OEIS A297434, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297434 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A297434 is ``Number of 4 X n 0..1 arrays with every 1 horizontally, diagonally or antidiagonally adjacent to 2 neighboring 1s.''. It has offset $1$ and begins
\[
1, 4, 22, 42, 105, 349, 1057, 2834,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) + a(n-2) + a(n-4) - 33*a(n-5) - 7*a(n-6) + 21*a(n-7) + 3*a(n-8) + 2*a(n-9) + 3*a(n-10) + 5*a(n-11) - 2*a(n-12).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 28 2019 18:52:08, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + a(n-2) + a(n-4) - 33\,a(n-5) - 7\,a(n-6) + 21\,a(n-7) + 3\,a(n-8) + 2\,a(n-9) + 3\,a(n-10) + 5\,a(n-11) - 2\,a(n-12)
\end{equation}
for all $n>13$.
...
publishes, $n=26$, the arrays have $4\cdot26$ cells over
$2$ values, so there are about $10^{31}$ of them to sift. The
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297434.
