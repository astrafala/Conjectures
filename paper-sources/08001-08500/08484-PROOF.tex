...
\title{The empirical recurrence for OEIS A251869, proved by transfer matrix}
...
\begin{abstract}
OEIS A251869 counts arrays of width $3$ over $\{0,1,2,3\}$ in which every $3\times3$ window has
...
OEIS A251869 is ``Number of (n+2)X(1+2) 0..3 arrays with every 3X3 subblock row and column sum not 2 4 5 or 7 and every diagonal and antidiagonal sum 2 4 5 or 7.''. It has offset $1$ and begins
\[
1038, 2146, 3092, 5756, 11008, 18400, 32372, 60292,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 10:34:46, revision 6) this is still
...
\text{the main diagonal} & \text{must be 2 or 4 or 5 or 7} \\
\text{the antidiagonal} & \text{must be 2 or 4 or 5 or 7} \\
\end{array}
\]
...
\begin{theorem}
\[
a(n)\;=\;11\,a(n-3) + 6\,a(n-5) - 38\,a(n-6) - 58\,a(n-8) + 18\,a(n-9) + 208\,a(n-11) + 160\,a(n-12) - 328\,a(n-14) - 328\,a(n-15) + 192\,a(n-17) + 192\,a(n-18)
\]
for every $n>23$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251869.
