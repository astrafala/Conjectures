...
\title{The empirical recurrence for OEIS A209103, proved by transfer matrix}
...
\begin{abstract}
OEIS A209103 counts $4\times n$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A209103 is ``Number of 4 X n 0..2 arrays with new values 0..2 introduced in row major order and no element equal to more than one of its immediate leftward or upward or right-upward antidiagonal neighbors.''. It has offset $1$ and begins
\[
14, 612, 23248, 849548, 30836932, 1118366188, 40556341276, 1470727552508,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 17 2022 21:00:31, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209103.
