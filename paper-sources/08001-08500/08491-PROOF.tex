...
\title{The empirical recurrence for OEIS A255800, proved by transfer matrix}
...
\begin{abstract}
OEIS A255800 counts $(n+2)\times9$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A255800 is ``Number of (n+2) X (7+2) 0..1 arrays with no 3 x 3 subblock diagonal sum 1 and no antidiagonal sum 2 and no row sum 0 and no column sum 3.''. It has offset $1$ and begins
\[
2380, 600, 329, 384, 472, 270, 344, 452,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-6) - 2*a(n-12) for n>15.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 20 2018 10:18:33, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A255800.
