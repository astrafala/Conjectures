...
\title{The empirical recurrence for OEIS A252307, proved by transfer matrix}
...
\begin{abstract}
OEIS A252307 counts $4\times(n+2)$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252307 is ``Number of (2+2)X(n+2) 0..3 arrays with every 3X3 subblock row and diagonal sum equal to 0 1 3 6 or 7 and every 3X3 column and antidiagonal sum not equal to 0 1 3 6 or 7.''. It has offset $1$ and begins
\[
1048, 1031, 1370, 1992, 3171, 5056, 7625, 12412,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 11*a(n-3) -42*a(n-6) +64*a(n-9) -32*a(n-12) for n>21
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:03:17, revision 6) this is still
...
$\{0,\dots,3\}^{4}$. A $3\times3$ subblock occupies three consecutive columns and
...
\begin{theorem}
\[
a(n)\;=\;11\,a(n-3) - 42\,a(n-6) + 64\,a(n-9) - 32\,a(n-12)
\]
for every $n>21$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252307.
