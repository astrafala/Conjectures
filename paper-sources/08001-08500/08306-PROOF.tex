...
\title{The empirical recurrence for OEIS A237723, proved by transfer matrix}
...
\begin{abstract}
OEIS A237723 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
OEIS A237723 is ``Number of (n+1)X(1+1) 0..2 arrays with the maximum plus the upper median minus the lower median of every 2X2 subblock differing from its horizontal and vertical neighbors by exactly one.''. It has offset $1$ and begins
\[
81, 348, 1510, 6610, 28877, 125428, 545952, 2381432,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 272*a(n-4) +1668*a(n-6) +172*a(n-8) +16*a(n-10) for n>13
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 10:23:07, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;272\,a(n-4) + 1668\,a(n-6) + 172\,a(n-8) + 16\,a(n-10)
\]
for every $n>13$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237723.
