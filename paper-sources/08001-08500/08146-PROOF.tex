...
\title{The empirical recurrence for OEIS A228388, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A228388 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A228388 is ``Number of nX6 binary arrays with top left value 1 and no two ones adjacent horizontally or vertically.''. It has offset $1$ and begins
\[
8, 70, 963, 11449, 143072, 1755243, 21683149, 267157140,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 8*a(n-1) +62*a(n-2) -78*a(n-3) -375*a(n-4) +300*a(n-5) +486*a(n-6) -385*a(n-7) -30*a(n-8) +52*a(n-9) -2*a(n-10) -a(n-11)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 04 2025 00:03:04, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;8\,a(n-1) + 62\,a(n-2) - 78\,a(n-3) - 375\,a(n-4) + 300\,a(n-5) + 486\,a(n-6) - 385\,a(n-7) - 30\,a(n-8) + 52\,a(n-9) - 2\,a(n-10) - a(n-11)
\end{equation}
for all $n>11$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A228388.
