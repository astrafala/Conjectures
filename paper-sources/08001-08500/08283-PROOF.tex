...
\title{The empirical recurrence for OEIS A250449, proved by transfer matrix}
...
\begin{abstract}
OEIS A250449 counts arrays over $\{0,1,2\}$ in which a statistic taken over short runs
...
OEIS A250449 is ``Number of (n+1)X(3+1) 0..2 arrays with nondecreasing min(x(i,j),x(i,j-1)) in the i direction and nondecreasing min(x(i,j),x(i-1,j)) in the j direction.''. It has offset $1$ and begins
\[
1000, 17024, 258377, 3865967, 56575618, 822755006, 11894220206, 171683275444,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 12:25:45, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;15\,a(n-1) + 90\,a(n-2) - 1507\,a(n-3) - 1884\,a(n-4) + 46515\,a(n-5) + 26122\,a(n-6) - 672221\,a(n-7) - 348239\,a(n-8) + 5134194\,a(n-9) + 2711324\,a(n-10) - 22852812\,a(n-11) - 11566900\,a(n-12) + 63118584\,a(n-13) + 28521664\,a(n-14) - 111737504\,a(n-15) - 42111776\,a(n-16) + 127619328\,a(n-17) + 37466560\,a(n-18) - 92247040\,a(n-19) - 19578368\,a(n-20) + 40071168\,a(n-21) + 5544960\,a(n-22) - 9363456\,a(n-23) - 663552\,a(n-24) + 884736\,a(n-25)
\]
for every $n>24$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250449.
