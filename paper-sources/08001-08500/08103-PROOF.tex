...
\title{The empirical recurrence for OEIS A209946, proved by transfer matrix}
...
\begin{abstract}
OEIS A209946 counts $(n+1)\times4$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A209946 is ``Half the number of (n+1)X4 0..2 arrays with every 2X2 subblock having at most one duplicate clockwise edge difference.''. It has offset $1$ and begins
\[
1956, 95794, 4681176, 228881560, 11189540644, 547050257224, 26744766723116, 1307528820052772,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 15:36:04, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;33\,a(n-1) + 910\,a(n-2) - 4144\,a(n-3) - 120239\,a(n-4) + 146790\,a(n-5) + 3697440\,a(n-6) - 7775700\,a(n-7) - 10672444\,a(n-8) + 36750032\,a(n-9) - 27740400\,a(n-10) + 5919872\,a(n-11) + 335232\,a(n-12) - 55296\,a(n-13)
\end{equation}
for all $n>12$.
...
\[
a(n)-\sum_i c_i\,a(n-i)\;=\;\tfrac1{2}\mathbf{1}^{\!\top}M^{\,n+1-1-13}\,q(M)\,\mathbf{1} .
\]
...
=\tfrac1{2}\mathbf{1}^{\!\top}M^{\,m-13}\,q(M)\,\mathbf{1}
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209946.
