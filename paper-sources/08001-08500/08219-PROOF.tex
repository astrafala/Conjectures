...
\title{The empirical recurrence for OEIS A258891, proved by transfer matrix}
...
\begin{abstract}
OEIS A258891 counts arrays of width $7$ over $\{0,1\}$ in which every $3\times3$ window has
...
OEIS A258891 is ``Number of (n+2) X (5+2) 0..1 arrays with no 3 x 3 subblock diagonal sum less than the antidiagonal sum or central row sum less than the central column sum.''. It has offset $1$ and begins
\[
30870, 23409, 12804, 9604, 12544, 16384, 21320, 27556,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + 2*a(n-2) - 6*a(n-3) + 6*a(n-5) - 2*a(n-6) - 2*a(n-7) + a(n-8) for n>11.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 23 2018 07:26:30, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A258891.
