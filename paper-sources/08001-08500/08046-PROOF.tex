...
\title{The empirical recurrence for OEIS A250580, proved by transfer matrix}
...
\begin{abstract}
OEIS A250580 counts arrays over $\{0,1\}$ in which a statistic taken over short runs
...
OEIS A250580 is ``Number of (n+1)X(5+1) 0..1 arrays with nondecreasing max(x(i,j),x(i,j-1)) in the i direction and nondecreasing min(x(i,j),x(i-1,j)) in the j direction.''. It has offset $1$ and begins
\[
282, 758, 1779, 4013, 8914, 19806, 44104, 98902,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 12:33:36, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-1) - 15\,a(n-2) - 4\,a(n-3) + 64\,a(n-4) - 90\,a(n-5) + 9\,a(n-6) + 94\,a(n-7) - 96\,a(n-8) + 31\,a(n-9) + 6\,a(n-10) - 6\,a(n-11) + a(n-12)
\]
for every $n>14$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250580.
