...
\title{The empirical recurrence for OEIS A250796, proved by transfer matrix}
...
\begin{abstract}
OEIS A250796 counts arrays over $\{0,1\}$ in which a statistic taken over short runs
...
OEIS A250796 is ``Number of (n+1)X(7+1) 0..1 arrays with nondecreasing min(x(i,j),x(i,j-1)) in the i direction and nondecreasing absolute value of x(i,j)-x(i-1,j) in the j direction.''. It has offset $1$ and begins
\[
1102, 3868, 13598, 48600, 177142, 653880, 2437366, 9144752,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 12:46:03, revision 6) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The array has $8$ cells across and entries $x(i,j)\in\{0,1\}$.
...
So a single row is a state. Let $M$ be the matrix on the $2^{8}=256$ rows with
...
\begin{theorem}
\[
a(n)\;=\;14\,a(n-1) - 68\,a(n-2) + 88\,a(n-3) + 312\,a(n-4) - 1008\,a(n-5) + 62\,a(n-6) + 2576\,a(n-7) - 1535\,a(n-8) - 2790\,a(n-9) + 1886\,a(n-10) + 1456\,a(n-11) - 656\,a(n-12) - 336\,a(n-13)
\]
for every $n>12$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250796.
