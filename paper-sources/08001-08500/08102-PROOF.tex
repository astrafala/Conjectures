...
\title{The empirical recurrence for OEIS A257015, proved by transfer matrix}
...
\begin{abstract}
OEIS A257015 counts arrays of width $4$ over $\{0,1,2\}$ in which every $3\times3$ window has
...
OEIS A257015 is ``Number of (n+2)X(2+2) 0..2 arrays with no 3x3 subblock diagonal sum equal to the antidiagonal sum.''. It has offset $1$ and begins
\[
311364, 14776336, 717382656, 34828517376, 1679616000000, 81000000000000, 3914754624000000, 189201281063325696,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 15:16:51, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;57\,a(n-1) - 1368\,a(n-2) + 53928\,a(n-3) - 266760\,a(n-4) - 7303608\,a(n-5) + 214125120\,a(n-6) - 8896319424\,a(n-7) + 57672414720\,a(n-8) + 432546283008\,a(n-9) - 7633921904640\,a(n-10) + 215054243426304\,a(n-11) - 1510880432947200\,a(n-12) - 2386109465100288\,a(n-13) + 52716443900313600\,a(n-14) - 1103770884016963584\,a(n-15) + 8001130220255969280\,a(n-16) - 9600072345842614272\,a(n-17) - 23147623339744296960\,a(n-18) + 857994776901995986944\,a(n-19) - 6381793763148001443840\,a(n-20) + 6441531921466530988032\,a(n-21) + 18379960457618553569280\,a(n-22) - 154486328584550108626944\,a(n-23) + 996588276555235014475776\,a(n-24) - 654295038711035754184704\,a(n-25) - 5234360309688286033477632\,a(n-26) + 6979147079584381377970176\,a(n-27)
\]
for every $n>26$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A257015.
