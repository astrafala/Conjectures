...
\title{The empirical recurrence for OEIS A234327, proved by transfer matrix}
...
\begin{abstract}
OEIS A234327 counts $3$-column arrays over $\{0,\dots,3\}$ in which every
...
OEIS A234327 is ``Number of (n+1) X (2+1) 0..3 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 1 (constant-stress 1 X 1 tilings).''. It has offset
$1$ and begins
\[
432, 3296, 25728, 203008, 1603680, 12713312, 100679584,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 20 2022 21:32:49, revision 10) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;10\,a(n-1) + 59\,a(n-2) - 768\,a(n-3) + 608\,a(n-4) + 7580\,a(n-5) - 11628\,a(n-6) - 18088\,a(n-7) + 32880\,a(n-8) + 3232\,a(n-9) - 17600\,a(n-10) + 4224\,a(n-11)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234327.
