...
\title{The empirical recurrence for OEIS A207070, proved by transfer matrix}
...
\begin{abstract}
OEIS A207070 counts arrays over $\{0,\dots,1\}$ of width $3$ that avoid the patterns
...
OEIS A207070 is ``Number of 3Xn 0..1 arrays avoiding 0 0 1 and 0 1 0 horizontally and 0 0 1 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
6, 36, 102, 288, 896, 2499, 6634,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 13:26:15, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) - 9\,a(n-2) + 21\,a(n-3) - 56\,a(n-4) + 64\,a(n-5) - 89\,a(n-6) + 192\,a(n-7) - 119\,a(n-8) + 117\,a(n-9) - 305\,a(n-10) + 46\,a(n-11) - 64\,a(n-12) + 323\,a(n-13) + 39\,a(n-14) + 36\,a(n-15) - 228\,a(n-16) - 56\,a(n-17) - 4\,a(n-18) + 80\,a(n-19) + 24\,a(n-20) - 16\,a(n-22)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207070.
