...
\title{The empirical recurrence for OEIS A302512, proved by transfer matrix}
...
\begin{abstract}
OEIS A302512 counts $5$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A302512 is ``Number of nX5 0..1 arrays with every element equal to 0, 1, 4 or 5 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
8, 7, 21, 36, 90, 184, 376, 832,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +6*a(n-3) +2*a(n-5) -12*a(n-6) -4*a(n-7) +8*a(n-9) for n>11
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 09 2018 09:06:45, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 6\,a(n-3) + 2\,a(n-5) - 12\,a(n-6) - 4\,a(n-7) + 8\,a(n-9)
\end{equation}
for all $n>11$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302512.
