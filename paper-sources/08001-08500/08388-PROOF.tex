...
\title{The empirical recurrence for OEIS A202772, proved by transfer matrix}
...
\begin{abstract}
OEIS A202772 counts arrays of width $5$ over $\{0,1\}$ containing no occurrence of certain short
...
OEIS A202772 is ``Number of (n+2)X5 binary arrays avoiding patterns 000 and 011 in rows, columns and nw-to-se diagonals.''. It has offset $1$ and begins
\[
424, 1239, 2870, 6176, 12886, 25360, 48953, 92399,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 09:54:17, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 3\,a(n-2) - a(n-3) - 15\,a(n-4) - 5\,a(n-5) + 21\,a(n-6) + 34\,a(n-7) - 10\,a(n-8) - 50\,a(n-9) - 32\,a(n-10) + 29\,a(n-11) + 51\,a(n-12) + 14\,a(n-13) - 22\,a(n-14) - 28\,a(n-15) - 7\,a(n-16) + 4\,a(n-17) + 12\,a(n-18) + 6\,a(n-19) + a(n-20) - 5\,a(n-21) - 2\,a(n-22) + a(n-24)
\]
for every $n>21$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A202772.
