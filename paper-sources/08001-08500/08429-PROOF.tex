...
\title{The empirical recurrence for OEIS A185819, proved by transfer matrix}
...
\begin{abstract}
OEIS A185819 counts $n\times3$ arrays over $\{0,\dots,4\}$ subject to a condition imposed on
every CELL over a neighbour set the entry names, and it carries an empirical recurrence of
order $23$ contributed by R.~H.~Hardin. It is true, and it is decidable rather than
...
walk, and $a(n)$ is a walk count on $S=15750$ vertices, which is $C$-finite. Whether the
...
OEIS A185819 is ``1/5 the number of nX3 0..4 arrays with every element equal to exactly one or two of its horizontal and vertical neighbors.''. It has offset $1$ and begins
\[
1, 76, 1584, 49036, 1266624, 35446376, 956312244, 26231137608,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 03:12:35, revision 11) this is still
...
the condition
\[
\text{every cell equals exactly }\{1,2\}\text{ of its horizontal and vertical neighbours},
\]
...
$\{0,\dots,4\}^{3}$. The neighbourhood of a cell in row $u_i$ meets $u_{i-1}$,
$u_i$ and $u_{i+1}$ and nothing else. Take as vertices the pairs
$(r,s)\in(\{0,\dots,4\}^{3}\cup\{\varnothing\})\times\{0,\dots,4\}^{3}$,
...
$\tfrac1{5}\iota^{\!\top}M^{\,j}q(M)\tau$ for the corresponding walk index $j$, so the
...
\begin{theorem}
\[
a(n)\;=\;17\,a(n-1) + 327\,a(n-2) - 1020\,a(n-3) - 6773\,a(n-4) + 2794\,a(n-5) + 32525\,a(n-6) + 131655\,a(n-7) - 337771\,a(n-8) + 33788\,a(n-9) + 517885\,a(n-10) - 1145646\,a(n-11) - 5007180\,a(n-12) + 7715688\,a(n-13) + 39324336\,a(n-14) - 82942336\,a(n-15) - 35554304\,a(n-16) + 265939200\,a(n-17) + 170422272\,a(n-18) - 172261376\,a(n-19) - 774750208\,a(n-20) - 958660608\,a(n-21) - 1396703232\,a(n-22) - 1811939328\,a(n-23)
\]
for every $n>23$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A185819.
