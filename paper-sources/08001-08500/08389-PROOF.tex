...
\title{The empirical recurrence for OEIS A236604, proved by transfer matrix}
...
\begin{abstract}
OEIS A236604 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
OEIS A236604 is ``Number of (n+1) X (1+1) 0..2 arrays colored with the maximum plus the lower median minus the minimum of every 2 X 2 subblock.''. It has offset $1$ and begins
\[
81, 426, 2269, 12004, 63945, 339684, 1806104, 9590924,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 20 2024 16:19:27, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;28\,a(n-3) + 336\,a(n-4) + 744\,a(n-5) + 3360\,a(n-6) + 6176\,a(n-7) + 8308\,a(n-8) + 14576\,a(n-9) - 20528\,a(n-10) - 34304\,a(n-11) - 86784\,a(n-12) - 144128\,a(n-13) + 1536\,a(n-14) + 8192\,a(n-15) + 147456\,a(n-16) + 229376\,a(n-17)
\]
for every $n>17$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A236604.
