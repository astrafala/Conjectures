...
\title{A condition on every subblock: the empirical recurrence for OEIS A181249}
...
\begin{abstract}
OEIS A181249 carries an empirical recurrence of order $11$ contributed by R.~H.~Hardin. It is
...
OEIS A181249 is ``Number of nX6 binary matrices with no 2X2 block having four 1's.''. It has offset $1$ and begins
\[
64, 3105, 160697, 8191392, 419045269, 21418970801, 1095020802848, 55979092539545,\ \dots
\]
...
\begin{theorem}
\[
a(n)\;=\;33\,a(n-1) + 908\,a(n-2) + 1687\,a(n-3) - 37947\,a(n-4) - 16572\,a(n-5) + 513993\,a(n-6) - 663729\,a(n-7) - 486540\,a(n-8) + 617409\,a(n-9) + 191835\,a(n-10) - 49140\,a(n-11)
\]
for every $n>11$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A181249.
