...
\title{The empirical recurrence for OEIS A207810, proved by transfer matrix}
...
\begin{abstract}
OEIS A207810 counts arrays over $\{0,\dots,1\}$ of width $5$ that avoid the patterns
...
OEIS A207810 is ``Number of 5Xn 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 1 0 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
16, 256, 1232, 9168, 57184, 382288, 2485392,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) +27*a(n-2) -10*a(n-3) -103*a(n-4) +48*a(n-5) +81*a(n-6) -29*a(n-7) -19*a(n-8) +2*a(n-9) +a(n-10)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:20:21, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 27\,a(n-2) - 10\,a(n-3) - 103\,a(n-4) + 48\,a(n-5) + 81\,a(n-6) - 29\,a(n-7) - 19\,a(n-8) + 2\,a(n-9) + a(n-10)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207810.
