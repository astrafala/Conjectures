...
\title{A condition on the multiset of every subblock: OEIS A235851}
...
\begin{abstract}
OEIS A235851 carries an empirical recurrence of order $13$ contributed by R.~H.~Hardin. It is
...
OEIS A235851 is ``Number of (n+1) X (2+1) 0..3 arrays with the upper median equal to the lower median in every 2 X 2 subblock.''. It has offset $1$ and begins
\[
688, 9600, 121244, 1629216, 21301696, 283036828, 3731137160, 49409402632,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 26 2022 20:23:50, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;15\,a(n-1) + 63\,a(n-2) - 1386\,a(n-3) + 1099\,a(n-4) + 35227\,a(n-5) - 85405\,a(n-6) - 221384\,a(n-7) + 716768\,a(n-8) + 332972\,a(n-9) - 1748080\,a(n-10) + 329248\,a(n-11) + 1044480\,a(n-12) - 421888\,a(n-13)
\]
for every $n>12$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A235851.
