...
\title{The empirical recurrence for OEIS A236597, proved by transfer matrix}
...
\begin{abstract}
OEIS A236597 counts arrays over $\{0,\dots,3\}$ subject to a condition on the order
...
OEIS A236597 is ``Number of (n+1)X(1+1) 0..3 arrays colored with the maximum plus the upper median of every 2X2 subblock.''. It has offset $1$ and begins
\[
256, 2596, 25950, 256376, 2525698, 24922062, 246386369, 2433171504,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 09:20:58, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;224\,a(n-3) + 4264\,a(n-4) + 18336\,a(n-5) + 94100\,a(n-6) + 288576\,a(n-7) - 458324\,a(n-8) - 2955288\,a(n-9) - 9895792\,a(n-10) - 31179344\,a(n-11) - 22508592\,a(n-12) + 8785408\,a(n-13) + 23968768\,a(n-14) + 101248896\,a(n-15) + 87015168\,a(n-16) - 13844480\,a(n-17) - 14419968\,a(n-18) - 26182656\,a(n-19) - 23973888\,a(n-20)
\]
for every $n>22$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A236597.
