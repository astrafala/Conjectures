...
\title{The empirical recurrence for OEIS A210349, proved by transfer matrix}
...
\begin{abstract}
OEIS A210349 counts $(n+1)\times3$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A210349 is ``1/4 the number of (n+1)X3 0..3 arrays with every 2X2 subblock having one, two or three distinct clockwise edge differences.''. It has offset $1$ and begins
\[
431, 13566, 423694, 13288986, 416960476, 13085817650, 410707536246, 12890620403588,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 15:56:17, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;55\,a(n-1) - 890\,a(n-2) + 4374\,a(n-3) + 14813\,a(n-4) - 179200\,a(n-5) + 198626\,a(n-6) + 1718220\,a(n-7) - 3858631\,a(n-8) - 4143905\,a(n-9) + 14290154\,a(n-10) + 1274736\,a(n-11) - 19132266\,a(n-12) + 4460692\,a(n-13) + 9184880\,a(n-14) - 3036040\,a(n-15) - 1419448\,a(n-16) + 517280\,a(n-17) + 1792\,a(n-18) - 4096\,a(n-19) - 128\,a(n-20)
\end{equation}
for all $n>19$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A210349.
