...
\title{The empirical recurrence for OEIS A302066, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A302066 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A302066 is ``Number of nX5 0..1 arrays with every element equal to 0, 1, 2 or 4 horizontally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
16, 263, 3657, 54177, 807601, 12063625, 180330117, 2696254757,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 31 2018 15:42:56, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;32\,a(n-1) - 376\,a(n-2) + 2288\,a(n-3) - 8309\,a(n-4) + 19438\,a(n-5) - 30349\,a(n-6) + 31426\,a(n-7) - 20604\,a(n-8) + 7932\,a(n-9) - 1632\,a(n-10) + 144\,a(n-11)
\end{equation}
for all $n>13$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302066.
