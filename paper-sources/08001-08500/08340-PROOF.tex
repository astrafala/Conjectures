...
\title{The empirical recurrence for OEIS A260065, proved by transfer matrix}
...
\begin{abstract}
OEIS A260065 counts $(n+2)\times5$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A260065 is ``Number of (n+2)X(3+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000001 00000011 or 00000111.''. It has offset $1$ and begins
\[
256, 594, 1680, 3825, 6714, 16344, 42094, 84761,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:59:32, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-3) + 15\,a(n-4) - 8\,a(n-6) - 29\,a(n-7) - 36\,a(n-8) - 3\,a(n-9) - 10\,a(n-10) + 4\,a(n-11) + 26\,a(n-12) - 23\,a(n-13) - 12\,a(n-14) - 28\,a(n-15) - 8\,a(n-17)
\]
for every $n>21$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A260065.
