...
\title{The empirical recurrence for OEIS A220712, proved by transfer matrix}
...
\begin{abstract}
OEIS A220712 counts the ways of linking the cells of a grid $7$ cells wide, each cell either to
...
state, the count is a walk count on $S=1144$ of them, and the conjectured recurrence is then
...
OEIS A220712 is ``Number of ways to reciprocally link elements of an 7 X n array either to themselves or to exactly two horizontal and antidiagonal neighbors, without consecutive collinear links.''. It has offset $1$ and begins
\[
1, 1, 21, 129, 932, 6412, 44976, 311193,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 05 2026 15:14:04, revision 10) this is still
...
one configuration. With $M$ the adjacency matrix of the digraph on the $S=1144$ reachable
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 76\,a(n-2) - 4\,a(n-3) - 2156\,a(n-4) - 520\,a(n-5) + 32432\,a(n-6) + 9800\,a(n-7) - 296352\,a(n-8) - 80128\,a(n-9) + 1755472\,a(n-10) + 365536\,a(n-11) - 6970672\,a(n-12) - 1003248\,a(n-13) + 18839680\,a(n-14) + 1679040\,a(n-15) - 34716928\,a(n-16) - 1650048\,a(n-17) + 43135744\,a(n-18) + 820736\,a(n-19) - 35163136\,a(n-20) - 61440\,a(n-21) + 17813504\,a(n-22) - 116736\,a(n-23) - 5017600\,a(n-24) + 36864\,a(n-25) + 589824\,a(n-26)
\]
for every $n>32$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A220712.
