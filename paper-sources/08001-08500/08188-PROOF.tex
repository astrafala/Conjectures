...
\title{The empirical recurrence for OEIS A255619, proved by transfer matrix}
...
\begin{abstract}
OEIS A255619 carries an empirical recurrence of order $14$ contributed by R.~H.~Hardin. It is
...
OEIS A255619 is ``Number of length n+5 0..2 arrays with at most two downsteps in every 5 consecutive neighbor pairs.''. It has offset $1$ and begins
\[
651, 1803, 5088, 14381, 40659, 114546, 322078, 907110,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 15:08:15, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) - 3\,a(n-2) + 8\,a(n-3) - 9\,a(n-4) + 30\,a(n-5) - 35\,a(n-6) + 12\,a(n-7) - 45\,a(n-8) + 56\,a(n-9) - 147\,a(n-10) + 177\,a(n-11) - 63\,a(n-12) + 18\,a(n-13) + 3\,a(n-14)
\]
for every $n>19$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A255619.
