...
\title{The empirical recurrence for OEIS A237301, proved by transfer matrix}
...
\begin{abstract}
OEIS A237301 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
The condition is local to two consecutive rows, so the count is a walk count on $S=22$
...
OEIS A237301 is ``Number of (n+1)X(1+1) 0..2 arrays with the upper median of every 2X2 subblock equal.''. It has offset $1$ and begins
\[
81, 435, 2174, 11545, 61055, 326262, 1745153, 9357963,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 9*a(n-1) -143*a(n-3) +79*a(n-4) +796*a(n-5) -292*a(n-6) -1760*a(n-7) +256*a(n-8) +1280*a(n-9)
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 10:02:27, revision 6) this is still
...
array, which is not among the objects counted. There are $S=22$ states left.
...
\begin{theorem}
\[
a(n)\;=\;9\,a(n-1) - 143\,a(n-3) + 79\,a(n-4) + 796\,a(n-5) - 292\,a(n-6) - 1760\,a(n-7) + 256\,a(n-8) + 1280\,a(n-9)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237301.
