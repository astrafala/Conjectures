...
\title{The empirical recurrence for OEIS A228757, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A228757 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A228757 is ``Number of 5Xn binary arrays with top left element equal to 1 and no two ones adjacent horizontally or antidiagonally.''. It has offset $1$ and begins
\[
16, 55, 723, 4808, 43862, 342207, 2876170, 23326164,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 04 2025 00:07:12, revision 9) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A228757.
