...
\title{The empirical recurrence for OEIS A259947, proved by transfer matrix}
...
\begin{abstract}
OEIS A259947 counts $(n+2)\times5$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A259947 is ``Number of (n+2)X(3+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000000 00000001 or 00000101.''. It has offset $1$ and begins
\[
156, 549, 2438, 8699, 30351, 115410, 438353, 1615572,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:56:19, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 2\,a(n-2) + 12\,a(n-3) + 27\,a(n-4) - 31\,a(n-5) - 10\,a(n-6) - 62\,a(n-7) - 30\,a(n-8) + 42\,a(n-9) + 13\,a(n-10) + 47\,a(n-11) - 3\,a(n-12) - 14\,a(n-13) - 4\,a(n-15) + 2\,a(n-16)
\]
for every $n>17$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A259947.
