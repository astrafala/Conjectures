...
\title{The empirical recurrence for OEIS A207462, proved by transfer matrix}
...
\begin{abstract}
OEIS A207462 counts arrays over $\{0,\dots,1\}$ of width $3$ that avoid the patterns
...
OEIS A207462 is ``Number of n X 3 0..1 arrays avoiding 0 0 0 and 0 1 1 horizontally and 0 1 0 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
6, 36, 98, 358, 1152, 3910, 12994,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) +a(n-2) -4*a(n-3) +11*a(n-4) +15*a(n-5) +4*a(n-6) -23*a(n-7) -17*a(n-8) +4*a(n-9) -7*a(n-10) +a(n-11) +a(n-12).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 18 2022 17:27:19, revision
7) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + a(n-2) - 4\,a(n-3) + 11\,a(n-4) + 15\,a(n-5) + 4\,a(n-6) - 23\,a(n-7) - 17\,a(n-8) + 4\,a(n-9) - 7\,a(n-10) + a(n-11) + a(n-12)
\end{equation}
for all $n>12$. 
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207462.
