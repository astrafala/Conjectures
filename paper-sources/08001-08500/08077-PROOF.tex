...
\title{The empirical recurrence for OEIS A259719, proved by transfer matrix}
...
\begin{abstract}
OEIS A259719 counts $(n+2)\times6$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A259719 is ``Number of (n+2)X(4+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000001 or 00000011.''. It has offset $1$ and begins
\[
242, 392, 1064, 2059, 2218, 5458, 12198, 16269,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:54:09, revision 6) this is still
...
\[
\text{the clockwise perimeter word of }g\text{ is a rotation of one of }\{00000001,\ 00000011\}
\]
...
\begin{theorem}
\[
a(n)\;=\;a(n-2) + 7\,a(n-3) + 7\,a(n-4) - 6\,a(n-5) - 22\,a(n-6) - 26\,a(n-7) - 9\,a(n-8) + 33\,a(n-9) + 46\,a(n-10) + 28\,a(n-11) + 10\,a(n-12) - 29\,a(n-13) - 39\,a(n-14) - 16\,a(n-15) - 14\,a(n-16) + 4\,a(n-17) + 17\,a(n-18) + a(n-19) + 3\,a(n-20) + 2\,a(n-21) - 3\,a(n-22)
\]
for every $n>22$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A259719.
