...
\title{The empirical recurrence for OEIS A253873, proved by transfer matrix}
...
\begin{abstract}
OEIS A253873 counts the arrays over $\{0,\dots,1\}$ whose $3\times3$ subblocks carry a
...
OEIS A253873 is ``Number of (3+2)X(n+2) 0..1 arrays with every 3X3 subblock diagonal maximum minus antidiagonal minimum nondecreasing horizontally, vertically and ne-to-sw antidiagonally.''. It has offset $1$ and begins
\[
20480, 296960, 3939840, 52394496, 677982208, 8846579968, 114921882112, 1496191085824,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 14:19:53, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253873.
