...
\title{The empirical recurrence for OEIS A228687, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A228687 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A228687 is ``Number of 6Xn binary arrays with no two ones adjacent horizontally, diagonally or antidiagonally.''. It has offset $1$ and begins
\[
64, 239, 5215, 32928, 475809, 3837761, 46125216, 419022831,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 04 2025 00:05:51, revision 9) the statement is
...
publishes, $n=17$, the arrays have $6\cdot17$ cells over
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A228687.
