...
\title{The empirical recurrence for OEIS A236705, proved by transfer matrix}
...
\begin{abstract}
OEIS A236705 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
OEIS A236705 is ``Number of (n+1)X(1+1) 0..2 arrays colored with the maximum plus the upper median minus the lower median of every 2X2 subblock.''. It has offset $1$ and begins
\[
81, 442, 2464, 13720, 76404, 424600, 2361716, 13136192,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 09:27:45, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;34\,a(n-3) + 413\,a(n-4) + 974\,a(n-5) + 4004\,a(n-6) + 7592\,a(n-7) + 6608\,a(n-8) + 7352\,a(n-9) - 40208\,a(n-10) - 84960\,a(n-11) - 91776\,a(n-12) - 114528\,a(n-13) + 99776\,a(n-14) + 231424\,a(n-15) + 141312\,a(n-16) + 91136\,a(n-17) - 16384\,a(n-18) - 32768\,a(n-19)
\]
for every $n>19$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A236705.
