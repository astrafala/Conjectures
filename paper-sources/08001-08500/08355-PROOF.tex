...
\title{The empirical recurrence for OEIS A249701, proved by transfer matrix}
...
\begin{abstract}
OEIS A249701 carries an empirical recurrence of order $10$ contributed by R.~H.~Hardin. It is
...
OEIS A249701 is ``Number of length n+3 0..2 arrays with every four consecutive terms having the maximum of some two terms equal to the minimum of the remaining two terms.''. It has offset $1$ and begins
\[
39, 69, 125, 221, 377, 659, 1177, 2119,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) - 3*a(n-2) + 2*a(n-3) + 2*a(n-4) - 5*a(n-5) + a(n-6) -a(n-7) - 2*a(n-8) + 2*a(n-10).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 09 2018 14:21:15, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) - 3\,a(n-2) + 2\,a(n-3) + 2\,a(n-4) - 5\,a(n-5) + a(n-6) - a(n-7) - 2\,a(n-8) + 2\,a(n-10)
\]
for every $n>12$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A249701.
