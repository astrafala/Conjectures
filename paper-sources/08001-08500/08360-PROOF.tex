...
\title{The empirical recurrence for OEIS A188852, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A188852 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A188852 is ``Number of 3Xn binary arrays without the pattern 0 0 1 vertically, antidiagonally or horizontally.''. It has offset $1$ and begins
\[
7, 49, 219, 908, 3642, 14265, 54914, 209116,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 04:53:34, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) + a(n-2) - 53\,a(n-3) + 26\,a(n-4) + 199\,a(n-5) - 95\,a(n-6) - 408\,a(n-7) + 113\,a(n-8) + 470\,a(n-9) - 31\,a(n-10) - 286\,a(n-11) - 14\,a(n-12) + 92\,a(n-13) + 8\,a(n-14) - 15\,a(n-15) - a(n-16) + a(n-17)
\end{equation}
for all $n>18$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A188852.
