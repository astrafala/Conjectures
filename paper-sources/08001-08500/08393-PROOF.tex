...
\title{The empirical recurrence for OEIS A252534, proved by transfer matrix}
...
\begin{abstract}
OEIS A252534 counts $4\times(n+2)$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252534 is ``Number of (2+2) X (n+2) 0..3 arrays with every 3 X 3 subblock row and diagonal sum equal to 0 2 3 6 or 7 and every 3 X 3 column and antidiagonal sum not equal to 0 2 3 6 or 7.''. It has offset $1$ and begins
\[
595, 337, 341, 462, 706, 1000, 1468, 2420,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 6*a(n-3) - 8*a(n-6) for n>10.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 04 2018 11:04:21, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252534.
