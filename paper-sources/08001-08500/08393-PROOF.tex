...
\title{The empirical recurrence for OEIS A302012, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A302012 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A302012 is ``Number of 5Xn 0..1 arrays with every element equal to 0, 1, 2 or 3 horizontally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
16, 512, 13616, 368144, 9989376, 270990144, 7350348800, 199375282176,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 30 2018 12:54:25, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;24\,a(n-1) + 100\,a(n-2) - 348\,a(n-3) - 1856\,a(n-4) + 1536\,a(n-5) + 14848\,a(n-6) + 2048\,a(n-7) - 65024\,a(n-8) - 40960\,a(n-9) + 139264\,a(n-10) + 102400\,a(n-11) - 147456\,a(n-12)
\end{equation}
for all $n>15$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302012.
