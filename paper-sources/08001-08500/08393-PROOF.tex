...
\title{The empirical recurrence for OEIS A184499, proved by transfer matrix}
...
\begin{abstract}
OEIS A184499 counts arrays of width $3$ over $\{0,1,2\}$ in which every $3\times3$ subblock
satisfies a condition on its nine entries. The entry carries an empirical recurrence of order
$11$ contributed by R.~H.~Hardin. It is true, and it is decidable rather than empirical: a
...
OEIS A184499 is ``1/12 the number of (n+2)X3 0..2 arrays with each 3X3 subblock containing one of one value, three of another, and five of the last.''. It has offset $1$ and begins
\[
252, 1248, 6132, 30024, 149112, 736200, 3618864, 17994960,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 02:43:11, revision 9) this is still
...
consecutive rows and three consecutive columns --- and asks that the numbers of times the values occur are $1,\,3,\,5$ in some order. The entry publishes $1/12$ of that count; the division is by a constant and changes nothing about the recurrence.
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + 12\,a(n-2) + 132\,a(n-3) - 432\,a(n-4) - 1620\,a(n-5) - 2052\,a(n-6) + 10692\,a(n-7) + 29160\,a(n-8) + 7776\,a(n-9) - 69984\,a(n-10) - 139968\,a(n-11)
\]
for every $n>11$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A184499.
