...
\title{The empirical recurrence for OEIS A242581, proved by transfer matrix}
...
\begin{abstract}
OEIS A242581 carries an empirical recurrence of order $13$ contributed by R.~H.~Hardin. It is
...
OEIS A242581 is ``Number of length n+3 0..5 arrays with no four elements in a row with pattern aabb (with a!=b) and new values 0..5 introduced in 0..5 order.''. It has offset $1$ and begins
\[
14, 46, 175, 744, 3453, 17178, 90033, 489821,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 11:18:02, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;16\,a(n-1) - 106\,a(n-2) + 425\,a(n-3) - 1284\,a(n-4) + 3083\,a(n-5) - 5823\,a(n-6) + 9091\,a(n-7) - 11623\,a(n-8) + 11784\,a(n-9) - 9883\,a(n-10) + 6151\,a(n-11) - 2730\,a(n-12) + 900\,a(n-13)
\]
for every $n>15$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A242581.
