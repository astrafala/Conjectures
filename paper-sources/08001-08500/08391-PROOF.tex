...
\title{The empirical recurrence for OEIS A282880, proved by transfer matrix}
...
\begin{abstract}
OEIS A282880 counts $n\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
walk, and $a(n)$ is a walk count on $S=78$ vertices, which is $C$-finite. Whether the
...
OEIS A282880 is ``Number of nX3 0..1 arrays with no 1 equal to more than one of its horizontal, vertical and antidiagonal neighbors, with the exception of exactly one element.''. It has offset $1$ and begins
\[
1, 8, 74, 430, 2426, 13062, 67676, 342972,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 24 2017 07:44:54, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 17\,a(n-2) + 22\,a(n-3) - 75\,a(n-4) - 376\,a(n-5) - 834\,a(n-6) - 1206\,a(n-7) - 1229\,a(n-8) - 824\,a(n-9) - 187\,a(n-10) + 346\,a(n-11) + 511\,a(n-12) + 344\,a(n-13) + 91\,a(n-14) - 74\,a(n-15) - 106\,a(n-16) - 42\,a(n-17) + 2\,a(n-18) + 16\,a(n-19) + 4\,a(n-20) - a(n-22)
\]
for every $n>22$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A282880.
