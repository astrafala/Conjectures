...
\title{The empirical recurrence for OEIS A296969, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A296969 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A296969 is ``Number of nX3 0..1 arrays with each 1 adjacent to 2, 4 or 5 king-move neighboring 1s.''. It has offset $1$ and begins
\[
1, 11, 31, 78, 295, 959, 2958, 9835,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 22 2017 12:52:35, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) - 5\,a(n-2) + 11\,a(n-3) - 55\,a(n-4) + 27\,a(n-5) - 5\,a(n-6) + 152\,a(n-7) + 34\,a(n-8) - 124\,a(n-9) - 145\,a(n-10) - 142\,a(n-11) + 174\,a(n-12) + 36\,a(n-13) - 15\,a(n-14) + 25\,a(n-15) + 10\,a(n-16) - 2\,a(n-17)
\end{equation}
for all $n>18$.
...
x_{t,u}=1\ \Rightarrow\ \#\{\text{neighbours equal to }1\}\in\{2,4,5\}
\end{equation}
for every cell $(t,u)$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A296969.
