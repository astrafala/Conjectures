...
\title{The empirical recurrence for OEIS A205210, proved by transfer matrix}
...
\begin{abstract}
OEIS A205210 counts arrays over $\{0,\dots,2\}$ under a condition on the determinant of every
...
a bounded window of consecutive rows, so the count is a walk count on $S=1970$ states and is
...
OEIS A205210 is ``Number of (n+1)X4 0..2 arrays with the determinants of 2X2 subblocks nondecreasing rightwards and downwards.''. It has offset $1$ and begins
\[
1970, 23578, 357812, 5500266, 82656765, 1236875696, 18436719991, 274894006610,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 11:51:35, revision 9) this is still
...
\]
on the $S=1970$ admissible pairs.
...
entry's first term is $1970$, and the model reproduces it along with every later term; that
...
\begin{theorem}
\[
a(n)\;=\;33\,a(n-1) - 310\,a(n-2) - 394\,a(n-3) + 21463\,a(n-4) - 100223\,a(n-5) - 82352\,a(n-6) + 1802520\,a(n-7) - 4216752\,a(n-8) - 1467504\,a(n-9) + 18558720\,a(n-10) - 25132032\,a(n-11) + 10616832\,a(n-12)
\]
for every $n>19$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A205210.
