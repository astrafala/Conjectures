...
\title{The empirical recurrence for OEIS A304771, proved by transfer matrix}
...
\begin{abstract}
OEIS A304771 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A304771 is ``Number of nX4 0..1 arrays with every element unequal to 0, 1, 2, 3 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
8, 49, 67, 172, 443, 1094, 2710, 6861,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +a(n-2) +6*a(n-3) +3*a(n-4) +a(n-5) -3*a(n-6) -4*a(n-7) -4*a(n-8) -2*a(n-9) +2*a(n-10) for n>13
\end{quote}
As of the ``Last modified'' line on the live entry (May 18 2018 08:12:16, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + a(n-2) + 6\,a(n-3) + 3\,a(n-4) + a(n-5) - 3\,a(n-6) - 4\,a(n-7) - 4\,a(n-8) - 2\,a(n-9) + 2\,a(n-10)
\end{equation}
for all $n>13$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A304771.
