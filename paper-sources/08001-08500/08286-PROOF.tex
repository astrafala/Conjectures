...
\title{The empirical recurrence for OEIS A255040, proved by transfer matrix}
...
\begin{abstract}
OEIS A255040 counts the arrays over $\{0,\dots,1\}$ whose $3\times3$ subblocks carry a
...
so the count is a walk count on $S=46414$ states --- the last two array rows together with the
...
OEIS A255040 is ``Number of (5+2)X(n+2) 0..1 arrays with every 3X3 subblock sum of the two sums of the central row and central column minus the two minimums of the diagonal and antidiagonal nondecreasing horizontally, vertically and ne-to-sw antidiagonally.''. It has offset $1$ and begins
\[
154680, 196724, 256941, 340084, 509796, 679364, 1001108, 1527986,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 15:06:39, revision 6) this is still
...
\]
on the $S=46414$ reachable states. In particular $a$ is $C$-finite. The alignment of the walk
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) - 2\,a(n-3) + 7\,a(n-4) - 11\,a(n-5) - 2\,a(n-6) + 12\,a(n-7) - 12\,a(n-8) + 9\,a(n-9) + 12\,a(n-10) - 16\,a(n-11) - 4\,a(n-12) + 14\,a(n-13) - 16\,a(n-14) + 16\,a(n-16) - 8\,a(n-17)
\]
for every $n>33$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A255040.
