...
\title{The empirical recurrence for OEIS A202429, proved by transfer matrix}
...
\begin{abstract}
OEIS A202429 counts arrays of width $4$ over $\{0,1\}$ containing no occurrence of certain short
...
OEIS A202429 is ``Number of (n+2)X4 binary arrays avoiding patterns 000 and 001 in rows, columns and nw-to-se diagonals.''. It has offset $1$ and begins
\[
390, 2100, 10080, 50310, 247800, 1226040, 6056600, 29936040,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) +16*a(n-2) +21*a(n-3) -13*a(n-4) -31*a(n-5) +9*a(n-6) +20*a(n-7) -12*a(n-8) +a(n-10)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 09:35:26, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 16\,a(n-2) + 21\,a(n-3) - 13\,a(n-4) - 31\,a(n-5) + 9\,a(n-6) + 20\,a(n-7) - 12\,a(n-8) + a(n-10)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A202429.
