...
\title{The empirical recurrence for OEIS A235965, proved by transfer matrix}
...
\begin{abstract}
OEIS A235965 counts arrays over $\{0,\dots,3\}$ subject to a condition on the order
...
OEIS A235965 is ``Number of (n+1)X(1+1) 0..3 arrays colored with the upper median value of each 2X2 subblock.''. It has offset $1$ and begins
\[
256, 1964, 13194, 85476, 556486, 3614066, 23457361, 152354048,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 08:57:48, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;96\,a(n-3) + 752\,a(n-4) + 1456\,a(n-5) + 6180\,a(n-6) + 6848\,a(n-7) + 13712\,a(n-8) + 9408\,a(n-9) + 12288\,a(n-10)
\]
for every $n>13$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A235965.
