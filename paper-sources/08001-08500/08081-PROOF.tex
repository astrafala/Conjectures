...
\title{The empirical recurrence for OEIS A301967, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A301967 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A301967 is ``Number of 5Xn 0..1 arrays with every element equal to 0, 1 or 4 horizontally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
16, 89, 100, 169, 311, 749, 1803, 4257,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 29 2018 13:04:14, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) - 2\,a(n-2) + 5\,a(n-3) - 8\,a(n-4) + 2\,a(n-5) - 9\,a(n-6) + 7\,a(n-7) - a(n-8) + 8\,a(n-9) + a(n-10) - 4\,a(n-11) - 3\,a(n-13) + 2\,a(n-14)
\end{equation}
for all $n>17$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A301967.
