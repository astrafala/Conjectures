...
\title{The empirical recurrence for OEIS A251027, proved by transfer matrix}
...
\begin{abstract}
OEIS A251027 counts $(n+1)\times8$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A251027 is ``Number of (n+1)X(7+1) 0..3 arrays with no 2X2 subblock having the sum of its diagonal elements greater than the maximum of its antidiagonal elements.''. It has offset $1$ and begins
\[
126955, 334167, 608267, 1199576, 2203974, 4230166, 7948184, 15543033,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 8*a(n-1) -25*a(n-2) +35*a(n-3) -7*a(n-4) -49*a(n-5) +77*a(n-6) -55*a(n-7) +20*a(n-8) -3*a(n-9) for n>14
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:00:44, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251027.
