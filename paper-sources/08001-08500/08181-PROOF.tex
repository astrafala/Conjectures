...
\title{The empirical recurrence for OEIS A243637, proved by transfer matrix}
...
\begin{abstract}
OEIS A243637 carries an empirical recurrence of order $10$ contributed by R.~H.~Hardin. It is
...
OEIS A243637 is ``Number of length n+2 0..6 arrays with no three unequal elements in a row and new values 0..6 introduced in 0..6 order.''. It has offset $1$ and begins
\[
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 02 2018 10:34:25, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;11\,a(n-1) - 39\,a(n-2) + 21\,a(n-3) + 151\,a(n-4) - 217\,a(n-5) - 181\,a(n-6) + 339\,a(n-7) + 130\,a(n-8) - 154\,a(n-9) - 60\,a(n-10)
\]
for every $n>11$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A243637.
