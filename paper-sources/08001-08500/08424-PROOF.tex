...
\title{The empirical recurrence for OEIS A231525, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A231525 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A231525 is ``Number of 3Xn 0..1 arrays with no element less than a strict majority of its horizontal, diagonal and antidiagonal neighbors.''. It has offset $1$ and begins
\[
8, 21, 153, 865, 4665, 25556, 144847, 817539,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 06:33:54, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) - 8\,a(n-2) + 29\,a(n-3) + 56\,a(n-4) - 182\,a(n-5) - 17\,a(n-6) - 559\,a(n-7) - 759\,a(n-8) + 476\,a(n-9) + 377\,a(n-10) + 965\,a(n-11) + 1048\,a(n-12) - 43\,a(n-13) + 15\,a(n-14) - 384\,a(n-15) - 335\,a(n-16)
\end{equation}
for all $n>17$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231525.
