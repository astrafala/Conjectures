...
\title{The empirical recurrence for OEIS A251887, proved by transfer matrix}
...
\begin{abstract}
OEIS A251887 counts arrays of width $3$ over $\{0,1,2,3\}$ in which every $3\times3$ window has
...
OEIS A251887 is ``Number of (n+2)X(1+2) 0..3 arrays with every 3X3 subblock row and column sum not 2 3 6 or 7 and every diagonal and antidiagonal sum 2 3 6 or 7.''. It has offset $1$ and begins
\[
1280, 1664, 1280, 1280, 1534, 1752, 2146, 2838,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 5*a(n-3) +a(n-5) -8*a(n-6) -4*a(n-8) +4*a(n-9) +5*a(n-11) -2*a(n-14) for n>22
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 10:35:46, revision 6) this is still
...
\text{the main diagonal} & \text{must be 2 or 3 or 6 or 7} \\
\text{the antidiagonal} & \text{must be 2 or 3 or 6 or 7} \\
\end{array}
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251887.
