...
\title{The empirical recurrence for OEIS A251838, proved by transfer matrix}
...
\begin{abstract}
OEIS A251838 counts $(n+2)\times3$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A251838 is ``Number of (n+2)X(1+2) 0..3 arrays with every 3X3 subblock row and column sum nonprime and every diagonal and antidiagonal sum prime.''. It has offset $1$ and begins
\[
974, 981, 641, 872, 1443, 1951, 2784, 4949,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:29:54, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;13\,a(n-3) + a(n-5) - 62\,a(n-6) - 12\,a(n-8) + 140\,a(n-9) + 50\,a(n-11) - 175\,a(n-12) - 90\,a(n-14) + 127\,a(n-15) + 85\,a(n-17) - 50\,a(n-18) - 42\,a(n-20) + 8\,a(n-21) + 8\,a(n-23)
\]
for every $n>28$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251838.
