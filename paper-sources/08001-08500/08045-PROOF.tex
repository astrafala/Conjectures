...
\title{The empirical recurrence for OEIS A250670, proved by transfer matrix}
...
\begin{abstract}
OEIS A250670 counts arrays over $\{0,1,2,3\}$ in which a statistic taken over short runs
...
OEIS A250670 is ``Number of (n+1)X(2+1) 0..3 arrays with nondecreasing x(i,j)+x(i,j-1) in the i direction and nondecreasing absolute value of x(i,j)-x(i-1,j) in the j direction.''. It has offset $1$ and begins
\[
669, 5154, 34630, 210158, 1185860, 6325144, 32230991, 158164928,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 12:39:55, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;38\,a(n-1) - 678\,a(n-2) + 7552\,a(n-3) - 58895\,a(n-4) + 341814\,a(n-5) - 1531840\,a(n-6) + 5427992\,a(n-7) - 15445215\,a(n-8) + 35639986\,a(n-9) - 67056686\,a(n-10) + 103057344\,a(n-11) - 129153505\,a(n-12) + 131275346\,a(n-13) - 107173068\,a(n-14) + 69203560\,a(n-15) - 34519952\,a(n-16) + 12821856\,a(n-17) - 3336768\,a(n-18) + 542592\,a(n-19) - 41472\,a(n-20)
\]
for every $n>28$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250670.
