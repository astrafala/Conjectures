...
\title{The empirical recurrence for OEIS A203920, proved by transfer matrix}
...
\begin{abstract}
OEIS A203920 carries an empirical recurrence of order $25$ contributed by R.~H.~Hardin. It is
...
OEIS A203920 is ``Number of (n+2)X7 0..1 arrays with every 3X3 subblock having equal diagonal elements or equal antidiagonal elements, and new values 0..1 introduced in row major order.''. It has offset $1$ and begins
\[
17800, 77618, 267066, 916658, 3191760, 11082632, 38569884, 134316050,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 10:51:41, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + 2\,a(n-3) + 4\,a(n-4) + 24\,a(n-5) - 104\,a(n-6) + 366\,a(n-7) + 562\,a(n-8) - 1092\,a(n-9) + 892\,a(n-10) + 1032\,a(n-11) - 1064\,a(n-12) - 6270\,a(n-13) + 1420\,a(n-14) + 6282\,a(n-15) - 30476\,a(n-16) + 12300\,a(n-17) + 27280\,a(n-18) - 11250\,a(n-19) + 8350\,a(n-20) - 1500\,a(n-21) - 1000\,a(n-22) + 8125\,a(n-24) - 3125\,a(n-25)
\]
for every $n>26$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A203920.
