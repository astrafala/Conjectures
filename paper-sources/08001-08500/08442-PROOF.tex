...
\title{The empirical recurrence for OEIS A196984, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A196984 counts arrays over $\{0,\dots,4\}$ in which every cell is constrained by the
...
OEIS A196984 is ``Number of n X 3 0..4 arrays with each element x equal to the number its horizontal and vertical neighbors equal to 2,3,4,1,0 for x=0,1,2,3,4.''. It has offset $1$ and begins
\[
1, 3, 10, 25, 81, 242, 707, 2095,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +2*a(n-2) +6*a(n-3) +11*a(n-4) +14*a(n-5) +4*a(n-6) -4*a(n-7) -4*a(n-8) -a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (May 11 2018 09:55:48, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 2\,a(n-2) + 6\,a(n-3) + 11\,a(n-4) + 14\,a(n-5) + 4\,a(n-6) - 4\,a(n-7) - 4\,a(n-8) - a(n-9)
\end{equation}
for all $n>10$.
...
\#\{\text{neighbours with value }f(x_{t,u})\}=x_{t,u},\quad f=(2,3,4,1,0)
\end{equation}
for every cell $(t,u)$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A196984.
