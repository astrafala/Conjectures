...
\title{The empirical recurrence for OEIS A231645, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A231645 counts arrays over $\{0,\dots,2\}$ in which every cell is constrained by the
...
OEIS A231645 is ``Number of n X 2 0..2 arrays with no element less than a strict majority of its horizontal and vertical neighbors.''. It has offset $1$ and begins
\[
3, 35, 104, 341, 1189, 4040, 13560, 45803,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 18 2018 06:59:27, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) - 12\,a(n-2) + 19\,a(n-3) - 32\,a(n-4) + 15\,a(n-5) - 13\,a(n-6) + 13\,a(n-7) + 10\,a(n-8) + 7\,a(n-9) + 5\,a(n-10) + a(n-11)
\end{equation}
for all $n>12$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231645.
