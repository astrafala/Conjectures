...
\title{The empirical recurrence for OEIS A318541, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A318541 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A318541 is ``Number of nX4 0..1 arrays with every element unequal to 0, 1, 4 or 6 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
5, 5, 13, 31, 78, 207, 516, 1288,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +7*a(n-3) +3*a(n-4) +10*a(n-5) -a(n-6) +4*a(n-7) -6*a(n-8) -a(n-9) -a(n-10) -a(n-12) +a(n-13) for n>14
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 28 2018 11:04:18, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 7\,a(n-3) + 3\,a(n-4) + 10\,a(n-5) - a(n-6) + 4\,a(n-7) - 6\,a(n-8) - a(n-9) - a(n-10) - a(n-12) + a(n-13)
\end{equation}
for all $n>14$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A318541.
