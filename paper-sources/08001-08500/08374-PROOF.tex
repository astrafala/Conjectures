...
\title{The empirical recurrence for OEIS A228688, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A228688 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A228688 is ``Number of 7Xn binary arrays with no two ones adjacent horizontally, diagonally or antidiagonally.''. It has offset $1$ and begins
\[
128, 577, 21305, 176032, 4008817, 44171841, 806190208, 10258304689,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 04 2025 00:05:59, revision 9) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A228688.
