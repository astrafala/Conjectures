...
\title{The empirical recurrence for OEIS A207437, proved by transfer matrix}
...
\begin{abstract}
OEIS A207437 counts arrays over $\{0,\dots,1\}$ of width $3$ that avoid the patterns
...
OEIS A207437 is ``Number of n X 3 0..1 arrays avoiding 0 0 1 and 0 1 0 horizontally and 0 0 1 and 1 0 0 vertically.''. It has offset
$1$ and begins
\[
6, 36, 108, 333, 1144, 4048, 14743,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 6*a(n-1) - 5*a(n-2) - 22*a(n-3) + 32*a(n-4) + 16*a(n-5) - 35*a(n-6) + 2*a(n-7) + 9*a(n-8) - 2*a(n-9) for n>10.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 22 2018 15:10:08, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207437.
