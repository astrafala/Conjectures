...
\title{The empirical recurrence for OEIS A231704, proved by transfer matrix}
...
\begin{abstract}
OEIS A231704 counts $(n+1)\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
every CELL over a neighbour set the entry names, and it carries an empirical recurrence of
order $25$ contributed by R.~H.~Hardin. It is true, and it is decidable rather than
...
OEIS A231704 is ``Number of (n+1)X(2+1) 0..1 arrays with no element having a strict majority of its horizontal, vertical and antidiagonal neighbors equal to one.''. It has offset $1$ and begins
\[
17, 87, 387, 1903, 9352, 45126, 218976, 1063266,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 06:38:24, revision 6) this is still
...
the condition
\[
\text{no cell has a strict majority of its horizontal, vertical and antidiagonal neighbours equal to 1},
\]
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + a(n-2) + 21\,a(n-3) - 31\,a(n-4) + 30\,a(n-5) - 95\,a(n-6) + 100\,a(n-7) - 67\,a(n-8) + 158\,a(n-9) - 270\,a(n-10) - 70\,a(n-11) + 104\,a(n-12) + 306\,a(n-13) - 26\,a(n-14) - 498\,a(n-15) + 168\,a(n-16) + 208\,a(n-17) + 256\,a(n-18) - 248\,a(n-19) - 168\,a(n-20) + 112\,a(n-21) + 8\,a(n-22) + 8\,a(n-23) - 32\,a(n-24) + 16\,a(n-25)
\]
for every $n>25$.
\end{theorem}
...
integers vanish from the index corresponding to $n=25+1$ onwards, and the run was
continued until the working vector was identically zero, which settles all larger $j$ at once.
By Lemma~\ref{lem:crit} the recurrence holds for every $n>25$.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231704.
