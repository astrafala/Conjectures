...
\title{The empirical recurrence for OEIS A205937, proved by transfer matrix}
...
\begin{abstract}
OEIS A205937 counts arrays of width $2$ over $\{0,1,2,3\}$ subject to a condition read round the
...
count is a walk count on a finite digraph with $S=57$ vertices, and whether a linear
...
OEIS A205937 is ``Number of (n+1) X 2 0..3 arrays with no 2 X 2 subblock having the number of clockwise edge increases equal to the number of counterclockwise edge increases in its adjacent leftward or upward neighbors.''. It has offset $1$ and begins
\[
256, 1776, 12712, 91440, 656272, 4711264, 33827496, 242859696,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 10 2015 02:07:26, revision 7) this is still
...
\[
\mathrm{cw}(B)\;\ne\;\mathrm{ccw}(L),\qquad \mathrm{cw}(B)\;\ne\;\mathrm{ccw}(U)
\]
...
\begin{theorem}
\[
a(n)\;=\;16\,a(n-2) + 132\,a(n-3) + 626\,a(n-4) + 1504\,a(n-5) + 2204\,a(n-6) + 2140\,a(n-7) + 1011\,a(n-8) + 96\,a(n-9) + 80\,a(n-10)
\]
for every $n>10$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A205937.
