...
\title{An element and the cells around it: OEIS A180753}
...
\begin{abstract}
OEIS A180753 carries an empirical recurrence of order $14$ contributed by R.~H.~Hardin. It is
...
OEIS A180753 is ``Half the number of nX4 binary arrays with each element equal to at least two neighbors.''. It has offset $1$ and begins
\[
0, 2, 2, 9, 21, 70, 207, 658,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 01:08:26, revision 7) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{The count is a walk count}

The entry counts arrays with $4$ columns over the alphabet $\{0,1\}$, growing one row at a time, and asks that every element must equal at least $2$ of its horizontal and vertical neighbours.
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) - 6\,a(n-2) + a(n-3) + a(n-4) - 9\,a(n-5) + 4\,a(n-6) + a(n-7) + 28\,a(n-8) - 16\,a(n-9) - 3\,a(n-10) + 2\,a(n-11) - 6\,a(n-12) + 2\,a(n-13) - a(n-14)
\]
for every $n>14$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A180753.
