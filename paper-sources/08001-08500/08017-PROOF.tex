...
\title{The empirical recurrence for OEIS A255032, proved by transfer matrix}
...
\begin{abstract}
OEIS A255032 counts the arrays over $\{0,\dots,1\}$ whose $3\times3$ subblocks carry a
...
so the count is a walk count on $S=13125$ states --- the last two array rows together with the
...
OEIS A255032 is ``Number of (n+2)X(4+2) 0..1 arrays with every 3X3 subblock sum of the two sums of the central row and central column minus the two minimums of the diagonal and antidiagonal nondecreasing horizontally, vertically and ne-to-sw antidiagonally.''. It has offset $1$ and begins
\[
42890, 149676, 246173, 281112, 340084, 301745, 310872, 321641,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 15:05:44, revision 6) this is still
...
\]
on the $S=13125$ reachable states. In particular $a$ is $C$-finite. The alignment of the walk
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + a(n-2) - a(n-3) + 4\,a(n-4) - 3\,a(n-5) - 5\,a(n-6) + 3\,a(n-7) + a(n-8) - 4\,a(n-9) + 4\,a(n-10) + 4\,a(n-11) - 4\,a(n-12)
\]
for every $n>20$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A255032.
