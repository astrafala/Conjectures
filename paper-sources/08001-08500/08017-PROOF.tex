...
\title{The empirical recurrence for OEIS A231834, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A231834 counts arrays over $\{0,\dots,3\}$ in which every cell is constrained by the
...
OEIS A231834 is ``Number of nX3 0..3 arrays with no element less than a strict majority of its horizontal and antidiagonal neighbors.''. It has offset $1$ and begins
\[
16, 188, 4508, 111621, 2836554, 71178861, 1792092360, 45099279326,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 06:42:48, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;16\,a(n-1) + 206\,a(n-2) + 762\,a(n-3) - 3181\,a(n-4) - 9838\,a(n-5) + 4473\,a(n-6) + 18193\,a(n-7) + 2848\,a(n-8) - 6404\,a(n-9) - 1848\,a(n-10)
\end{equation}
for all $n>11$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231834.
