...
\title{The empirical recurrence for OEIS A234771, proved by transfer matrix}
...
\begin{abstract}
OEIS A234771 counts arrays of width $3$ over $\{0,1,2,3,4\}$ subject to a condition read round the
...
count is a walk count on a finite digraph with $S=126$ vertices, and whether a linear
...
OEIS A234771 is ``Number of (n+1)X(2+1) 0..4 arrays with 2X2 edge jumps all no more than +1 in one of the clockwise or counterclockwise directions but not both.''. It has offset $1$ and begins
\[
454, 3980, 28840, 247394, 1912554, 16146124, 127371542, 1063565190,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 08:25:35, revision 6) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The arrays have $3$ columns and a growing number of rows, with entries in $\{0,1,2,3,4\}$. A
...
\]
for the largest step taken going round the subblock in each of the two directions. The condition is that for every subblock $B$, exactly one of $J_{\mathrm{cw}}(B)\le 1$, $J_{\mathrm{ccw}}(B)\le 1$ holds.
...
\begin{theorem}
\[
a(n)\;=\;9\,a(n-1) + 60\,a(n-2) - 657\,a(n-3) - 510\,a(n-4) + 14451\,a(n-5) - 9878\,a(n-6) - 143349\,a(n-7) + 195967\,a(n-8) + 711924\,a(n-9) - 1328829\,a(n-10) - 1738223\,a(n-11) + 4362370\,a(n-12) + 1713737\,a(n-13) - 7406892\,a(n-14) + 154943\,a(n-15) + 6781020\,a(n-16) - 1542017\,a(n-17) - 3326149\,a(n-18) + 1109694\,a(n-19) + 807890\,a(n-20) - 310656\,a(n-21) - 75048\,a(n-22) + 30144\,a(n-23)
\]
for every $n>23$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234771.
