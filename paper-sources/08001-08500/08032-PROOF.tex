...
\title{The empirical recurrence for OEIS A232572, proved by transfer matrix}
...
\begin{abstract}
OEIS A232572 counts arrays of width $2$ over $\{0,\dots,2\}$ under a condition on each cell
and its neighbours, and carries an empirical recurrence of order $11$ contributed by
...
OEIS A232572 is ``Number of (n+1)X(1+1) 0..2 arrays with every element next to itself plus and minus one within the range 0..2 horizontally, vertically or antidiagonally.''. It has offset $1$ and begins
\[
16, 72, 516, 3048, 18944, 115892, 713488, 4389504,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 07:29:33, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 19\,a(n-2) + 26\,a(n-3) + 52\,a(n-4) + 218\,a(n-5) + 11\,a(n-6) - 258\,a(n-7) + 15\,a(n-8) + 108\,a(n-9) - 64\,a(n-10) + 16\,a(n-11)
\]
for every $n>10$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232572.
