...
\title{A condition on the multiset of every subblock: OEIS A235844}
...
\begin{abstract}
OEIS A235844 carries an empirical recurrence of order $15$ contributed by R.~H.~Hardin. It is
...
on $S=18$ vertices and is $C$-finite, and whether the conjectured recurrence annihilates it
...
OEIS A235844 is ``Number of (n+1)X(2+1) 0..3 arrays with the upper median unequal to the lower median in every 2X2 subblock.''. It has offset $1$ and begins
\[
1584, 42080, 1133608, 30740652, 835207356, 22709045764, 617598961676, 16797812334528,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 08:53:02, revision 6) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{The count is a walk count}

The entry counts arrays with $3$ columns over the alphabet $\{0,1,2,3\}$, growing one row at a time, and asks that in every $2\times2$ subblock the two middle order statistics are different: writing the $4$ entries of the block in nondecreasing order $v_1\le\cdots\le v_{4}$, the lower median is $v_{2}$ and the upper median $v_{3}$, and these must be unequal.
...
Merging vertices with identical futures leaves $S=18$. An admissible array is exactly a walk, so with $M$ the adjacency matrix and $\iota,\tau$ the vectors recording which states may begin and end an array,
\[
a(n)\;=\;\iota^{\!\top}M^{\,n}\tau ,
\]
...
\begin{theorem}
\[
a(n)\;=\;43\,a(n-1) - 412\,a(n-2) - 1616\,a(n-3) + 33358\,a(n-4) - 51724\,a(n-5) - 518856\,a(n-6) + 1084075\,a(n-7) + 3131555\,a(n-8) - 5725376\,a(n-9) - 8197786\,a(n-10) + 8859758\,a(n-11) + 7608230\,a(n-12) - 2263560\,a(n-13) - 1233600\,a(n-14) + 36864\,a(n-15)
\]
for every $n>14$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A235844.
