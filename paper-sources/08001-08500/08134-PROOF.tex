...
\title{The empirical recurrence for OEIS A184450, proved by transfer matrix}
...
\begin{abstract}
OEIS A184450 counts arrays of width $4$ over $\{0,1,2\}$ in which every $3\times3$ subblock
...
OEIS A184450 is ``1/36 the number of (n+2)X4 0..2 arrays with each 3X3 subblock containing two of one value, two of another, and five of the last.''. It has offset $1$ and begins
\[
234, 600, 1591, 4517, 16029, 58413, 216477, 930657,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 02:38:09, revision 9) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A184450.
