...
\title{The empirical recurrence for OEIS A302151, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A302151 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A302151 is ``Number of 3Xn 0..1 arrays with every element equal to 0, 2, 3 or 4 horizontally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
4, 1, 4, 5, 11, 34, 88, 271,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 02 2018 14:29:02, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) - 4\,a(n-2) + 6\,a(n-3) - 10\,a(n-4) + 11\,a(n-5) - 24\,a(n-6) + 11\,a(n-7) - 45\,a(n-8) + 22\,a(n-9) - 38\,a(n-10) + 39\,a(n-11) - 21\,a(n-12) + 68\,a(n-13) + 28\,a(n-14) + 73\,a(n-15) - 25\,a(n-16) - 16\,a(n-17) - 37\,a(n-18) - 11\,a(n-19) - 11\,a(n-20) - 16\,a(n-21) - 7\,a(n-22) + 3\,a(n-24) + a(n-25)
\end{equation}
for all $n>27$.
...
the middle column. The vector $w$ was formed by $25$ applications of $G$ in exact integer
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302151.
