...
\title{The empirical recurrence for OEIS A250954, proved by transfer matrix}
...
\begin{abstract}
OEIS A250954 counts $(n+1)\times7$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A250954 is ``Number of (n+1)X(6+1) 0..1 arrays with no 2X2 subblock having its maximum diagonal element less than its minimum antidiagonal element.''. It has offset $1$ and begins
\[
10864, 941192, 81431944, 7045780240, 609622239024, 52746349035592, 4563772381621072, 394871276236514256,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 12:53:59, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;103\,a(n-1) - 1452\,a(n-2) + 1999\,a(n-3) + 25412\,a(n-4) - 90159\,a(n-5) + 84285\,a(n-6) + 261\,a(n-7) - 20412\,a(n-8) + 4212\,a(n-9)
\end{equation}
for all $n>8$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250954.
