...
\title{The empirical recurrence for OEIS A300806, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A300806 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A300806 is ``Number of nX3 0..1 arrays with every element equal to 0, 1, 2, 3 or 5 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
4, 29, 170, 1004, 5908, 34836, 205369, 1210811,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 5*a(n-1) +7*a(n-2) -10*a(n-3) -a(n-4) +4*a(n-5) -17*a(n-6) +2*a(n-7) +5*a(n-8) -6*a(n-9) +5*a(n-10) -2*a(n-12) +a(n-13)
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 13 2018 07:51:28, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) + 7\,a(n-2) - 10\,a(n-3) - a(n-4) + 4\,a(n-5) - 17\,a(n-6) + 2\,a(n-7) + 5\,a(n-8) - 6\,a(n-9) + 5\,a(n-10) - 2\,a(n-12) + a(n-13)
\end{equation}
for all $n>14$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A300806.
