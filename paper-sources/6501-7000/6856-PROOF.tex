...
\title{The empirical recurrence for OEIS A259637, proved by transfer matrix}
...
\begin{abstract}
OEIS A259637 counts $(n+2)\times5$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A259637 is ``Number of (n+2) X (3+2) 0..1 arrays with each 3 X 3 subblock having clockwise perimeter pattern 00000000 or 00000001.''. It has offset $1$ and begins
\[
69, 171, 581, 1483, 3849, 11261, 30957, 82977,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + a(n-2) + 10*a(n-3) + 4*a(n-4) - 2*a(n-5) - 12*a(n-6) - 5*a(n-7) - 4*a(n-8) + 4*a(n-9) for n>10.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 26 2018 09:00:29, revision 11) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A259637.
