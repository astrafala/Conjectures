...
\title{The empirical recurrence for OEIS A299663, proved by transfer matrix}
...
\begin{abstract}
OEIS A299663 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A299663 is ``Number of nX3 0..1 arrays with every element equal to 0, 1, 2, 3, 4, 6 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
4, 31, 179, 1080, 6585, 40023, 243312, 1479656,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 15 2018 14:52:43, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) + 6\,a(n-2) + 10\,a(n-3) - 29\,a(n-4) - 59\,a(n-5) - 27\,a(n-6) - 46\,a(n-7) + 21\,a(n-8) - 8\,a(n-9) + 52\,a(n-10) - 16\,a(n-11)
\end{equation}
for all $n>12$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A299663.
