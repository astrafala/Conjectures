...
\title{The empirical recurrence for OEIS A197524, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A197524 counts arrays over $\{0,\dots,4\}$ in which every cell is constrained by the
...
OEIS A197524 is ``Number of n X 3 0..4 arrays with each element x equal to the number its horizontal and vertical neighbors equal to 4,4,1,0,1 for x=0,1,2,3,4.''. It has offset $1$ and begins
\[
1, 3, 32, 69, 308, 1444, 5048, 20265,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) +2*a(n-2) +19*a(n-3) +10*a(n-4) +21*a(n-5) +31*a(n-6) -99*a(n-7) -9*a(n-8) +16*a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (May 13 2018 06:04:58, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 2\,a(n-2) + 19\,a(n-3) + 10\,a(n-4) + 21\,a(n-5) + 31\,a(n-6) - 99\,a(n-7) - 9\,a(n-8) + 16\,a(n-9)
\end{equation}
for all $n>10$.
...
\#\{\text{neighbours with value }f(x_{t,u})\}=x_{t,u},\quad f=(4,4,1,0,1)
\end{equation}
for every cell $(t,u)$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A197524.
