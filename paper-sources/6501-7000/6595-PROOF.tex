...
\title{The empirical recurrence for OEIS A233839, proved by transfer matrix}
...
\begin{abstract}
OEIS A233839 counts arrays of width $4$ over $\{0,1,2,3\}$ containing no run of $3$ consecutive
...
OEIS A233839 is ``Number of (n+2)X(2+2) 0..3 arrays with no increasing sequence of length 3 horizontally or antidiagonally downwards.''. It has offset $1$ and begins
\[
9828513, 1909001345, 370375897185, 71859538054209, 13941925875538977, 2704962047095586817, 524806929418457507809, 101821137847262670246849,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 08:12:15, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;194\,a(n-1) + 391\,a(n-2) - 76048\,a(n-3) + 118072\,a(n-4) + 7556256\,a(n-5) - 39208720\,a(n-6) + 56369152\,a(n-7) - 6830080\,a(n-8) - 8534016\,a(n-9) - 7110656\,a(n-10) + 3670016\,a(n-11) - 65536\,a(n-12)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A233839.
