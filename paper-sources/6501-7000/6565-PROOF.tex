...
\title{The empirical recurrence for OEIS A255752, proved by transfer matrix}
...
\begin{abstract}
OEIS A255752 counts the arrays over $\{0,\dots,1\}$ whose $3\times3$ subblocks carry a
...
OEIS A255752 is ``Number of (n+2)X(4+2) 0..1 arrays with every 3X3 subblock sum of the medians of the diagonal and antidiagonal minus the two sums of the central row and column nondecreasing horizontally, vertically and ne-to-sw antidiagonally.''. It has offset $1$ and begins
\[
30182, 72884, 111064, 118925, 124928, 177281, 306248, 517386,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 15:11:31, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) - a(n-2) + 21\,a(n-4) - 42\,a(n-5) + 21\,a(n-6) - 84\,a(n-8) + 168\,a(n-9) - 84\,a(n-10) + 64\,a(n-12) - 128\,a(n-13) + 64\,a(n-14)
\]
for every $n>26$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A255752.
