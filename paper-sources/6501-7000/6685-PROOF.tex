...
\title{The empirical recurrence for OEIS A252525, proved by transfer matrix}
...
\begin{abstract}
OEIS A252525 counts $(n+2)\times3$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252525 is ``Number of (n+2)X(1+2) 0..3 arrays with every 3X3 subblock row and diagonal sum equal to 0 2 3 6 or 7 and every 3X3 column and antidiagonal sum not equal to 0 2 3 6 or 7.''. It has offset $1$ and begins
\[
750, 595, 460, 535, 546, 649, 823, 1036,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-3) -3*a(n-6) -4*a(n-9) +4*a(n-12) for n>23
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:20:00, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-3) - 3\,a(n-6) - 4\,a(n-9) + 4\,a(n-12)
\]
for every $n>23$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252525.
