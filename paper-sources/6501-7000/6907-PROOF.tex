...
\title{The empirical recurrence for OEIS A259737, proved by transfer matrix}
...
\begin{abstract}
OEIS A259737 counts $(n+2)\times5$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A259737 is ``Number of (n+2) X (3+2) 0..1 arrays with each 3 X 3 subblock having clockwise perimeter pattern 00010101 or 01010101.''. It has offset $1$ and begins
\[
42, 74, 190, 374, 792, 1514, 3480, 6542,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-2) + 9*a(n-4) + 4*a(n-6) - 6*a(n-8) + 4*a(n-10) for n>11.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 26 2018 11:52:12, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A259737.
