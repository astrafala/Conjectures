...
\title{The empirical recurrence for OEIS A296572, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A296572 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A296572 is ``Number of n X 2 0..1 arrays with each 1 horizontally, vertically or antidiagonally adjacent to 0, 1 or 3 neighboring 1s.''. It has offset $1$ and begins
\[
4, 11, 31, 90, 254, 728, 2078, 5931,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) + 4*a(n-2) + 3*a(n-3) + a(n-4) + 4*a(n-5) - a(n-6) - 6*a(n-7) - a(n-8) + a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 23 2019 07:02:51, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 4\,a(n-2) + 3\,a(n-3) + a(n-4) + 4\,a(n-5) - a(n-6) - 6\,a(n-7) - a(n-8) + a(n-9)
\end{equation}
for all $n>10$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A296572.
