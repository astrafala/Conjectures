...
\title{The empirical recurrence for OEIS A236730, proved by transfer matrix}
...
\begin{abstract}
OEIS A236730 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
OEIS A236730 is ``Number of (n+1)X(1+1) 0..2 arrays with the upper median minus the lower median of every 2X2 subblock equal.''. It has offset $1$ and begins
\[
81, 345, 1497, 6663, 29617, 132471, 592001, 2651151,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 09:30:06, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;9\,a(n-1) - 9\,a(n-2) - 109\,a(n-3) + 254\,a(n-4) + 260\,a(n-5) - 1156\,a(n-6) + 576\,a(n-7) + 944\,a(n-8) - 1024\,a(n-9) + 256\,a(n-10)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A236730.
