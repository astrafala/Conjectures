...
\title{The empirical recurrence for OEIS A203793, proved by transfer matrix}
...
\begin{abstract}
OEIS A203793 counts $(n+1)\times6$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A203793 is ``Number of (n+1)X6 0..3 arrays with every 2X2 subblock having equal diagonal elements or equal antidiagonal elements.''. It has offset $1$ and begins
\[
268912, 25708528, 2700695728, 292394880208, 31960919852416, 3504288958063120, 384592800378103840, 42221697503213865232,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 10:44:02, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;148\,a(n-1) - 3999\,a(n-2) - 35082\,a(n-3) + 1582335\,a(n-4) - 9332901\,a(n-5) - 26191026\,a(n-6) + 302396490\,a(n-7) - 400942710\,a(n-8) - 868046544\,a(n-9) + 1153030140\,a(n-10) + 438143580\,a(n-11) - 442158912\,a(n-12)
\end{equation}
for all $n>11$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A203793.
