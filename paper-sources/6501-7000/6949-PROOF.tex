...
\title{The empirical recurrence for OEIS A283125, proved by transfer matrix}
...
\begin{abstract}
OEIS A283125 counts $n\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
walk, and $a(n)$ is a walk count on $S=65$ vertices, which is $C$-finite. Whether the
...
OEIS A283125 is ``Number of nX3 0..1 arrays with no 1 equal to more than two of its horizontal and vertical neighbors.''. It has offset $1$ and begins
\[
8, 57, 378, 2521, 16818, 112276, 749447, 5002276,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 5*a(n-1) +7*a(n-2) +25*a(n-3) +18*a(n-4) +12*a(n-5) -20*a(n-6) -15*a(n-7) +3*a(n-8) +2*a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 02 2017 12:24:56, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) + 7\,a(n-2) + 25\,a(n-3) + 18\,a(n-4) + 12\,a(n-5) - 20\,a(n-6) - 15\,a(n-7) + 3\,a(n-8) + 2\,a(n-9)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A283125.
