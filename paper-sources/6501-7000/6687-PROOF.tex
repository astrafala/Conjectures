...
\title{The empirical recurrence for OEIS A220706, proved by transfer matrix}
...
\begin{abstract}
OEIS A220706 counts the ways of linking the cells of a grid $6$ cells wide, each cell either to
...
state, the count is a walk count on $S=10$ of them, and the conjectured recurrence is then
...
OEIS A220706 is ``Number of ways to reciprocally link elements of an n X 6 array either to themselves or to exactly two horizontal and antidiagonal neighbors, without consecutive collinear links.''. It has offset $1$ and begins
\[
1, 8, 24, 105, 405, 1617, 6412, 25449,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) + 5*a(n-2) - 3*a(n-3) - 6*a(n-4) - a(n-5) - a(n-6) + 4*a(n-7) + a(n-8) - a(n-9) - a(n-10).
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 02 2018 06:42:39, revision 7) this is still
...
one configuration. With $M$ the adjacency matrix of the digraph on the $S=10$ reachable
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + 5\,a(n-2) - 3\,a(n-3) - 6\,a(n-4) - a(n-5) - a(n-6) + 4\,a(n-7) + a(n-8) - a(n-9) - a(n-10)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A220706.
