...
\title{The empirical recurrence for OEIS A188989, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A188989 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A188989 is ``Number of nX6 binary arrays without the pattern 0 0 1 antidiagonally or horizontally.''. It has offset $1$ and begins
\[
33, 1089, 21952, 423606, 7844188, 144733702, 2668260348, 49183191266,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 04:59:01, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;22\,a(n-1) - 47\,a(n-2) - 420\,a(n-3) + 1353\,a(n-4) + 490\,a(n-5) - 5593\,a(n-6) + 15840\,a(n-7) - 27360\,a(n-8) + 19496\,a(n-9) - 1828\,a(n-10) - 1376\,a(n-11) - 576\,a(n-12)
\end{equation}
for all $n>14$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A188989.
