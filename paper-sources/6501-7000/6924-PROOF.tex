...
\title{The empirical recurrence for OEIS A259946, proved by transfer matrix}
...
\begin{abstract}
OEIS A259946 counts $(n+2)\times4$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A259946 is ``Number of (n+2) X (2+2) 0..1 arrays with each 3 X 3 subblock having clockwise perimeter pattern 00000000 00000001 or 00000101.''. It has offset $1$ and begins
\[
60, 170, 549, 1507, 4128, 11933, 34337, 97374,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + 2*a(n-2) + a(n-3) + 6*a(n-4) - 14*a(n-5) - 4*a(n-6) + 2*a(n-7) - 4*a(n-8) + 4*a(n-9) for n>10.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 27 2018 11:54:00, revision 10) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 2\,a(n-2) + a(n-3) + 6\,a(n-4) - 14\,a(n-5) - 4\,a(n-6) + 2\,a(n-7) - 4\,a(n-8) + 4\,a(n-9)
\]
for every $n>10$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A259946.
