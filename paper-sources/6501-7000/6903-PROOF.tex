...
\title{The empirical recurrence for OEIS A237952, proved by transfer matrix}
...
\begin{abstract}
OEIS A237952 counts arrays over $\{0,\dots,3\}$ subject to a condition on the order
...
OEIS A237952 is ``Number of (n+1)X(1+1) 0..3 arrays with the maximum plus the upper median plus the lower median plus the minimum of every 2X2 subblock differing from its horizontal and vertical neighbors by exactly one.''. It has offset $1$ and begins
\[
256, 1280, 6400, 34560, 186624, 1022976, 5607424, 30916608,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 976*a(n-4) -46848*a(n-8) +110592*a(n-12)
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 10:38:15, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;976\,a(n-4) - 46848\,a(n-8) + 110592\,a(n-12)
\]
for every $n>12$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237952.
