...
\title{The empirical recurrence for OEIS A316422, proved by transfer matrix}
...
\begin{abstract}
OEIS A316422 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A316422 is ``Number of n X 3 0..1 arrays with every element unequal to 0, 1, 3, 5, 6 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
3, 9, 14, 32, 75, 148, 311, 687,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +5*a(n-3) +2*a(n-5) -2*a(n-6) -a(n-7) -2*a(n-8) -3*a(n-9) -2*a(n-11) -a(n-12).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 16 2025 11:34:34, revision
6) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 5\,a(n-3) + 2\,a(n-5) - 2\,a(n-6) - a(n-7) - 2\,a(n-8) - 3\,a(n-9) - 2\,a(n-11) - a(n-12)
\end{equation}
for all $n>12$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A316422.
