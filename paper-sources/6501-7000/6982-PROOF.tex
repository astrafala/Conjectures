...
\title{The empirical recurrence for OEIS A235064, proved by transfer matrix}
...
\begin{abstract}
OEIS A235064 counts $2$-column arrays over $\{0,\dots,6\}$ in which every
...
OEIS A235064 is ``Number of (n+1) X (1+1) 0..6 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 3, with no adjacent elements equal (constant-stress tilted 1 X 1 tilings).''. It has offset
$1$ and begins
\[
168, 848, 4352, 22576, 117232, 609412, 3167392,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 35*a(n-2) -235*a(n-4) +543*a(n-6) -458*a(n-8) +96*a(n-10).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 19 2022 23:53:04, revision 7) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;35\,a(n-2) - 235\,a(n-4) + 543\,a(n-6) - 458\,a(n-8) + 96\,a(n-10)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A235064.
