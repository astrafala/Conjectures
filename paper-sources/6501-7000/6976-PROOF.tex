...
\title{The empirical recurrence for OEIS A298570, proved by transfer matrix}
...
\begin{abstract}
OEIS A298570 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A298570 is ``Number of n X 3 0..1 arrays with every element equal to 0, 2, 4, 5 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 4, 1, 2, 14, 10, 12, 72,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 7*a(n-3) +2*a(n-4) +a(n-5) -10*a(n-6) -2*a(n-7) -2*a(n-8) +2*a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 01 2024 19:22:43, revision
6) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;7\,a(n-3) + 2\,a(n-4) + a(n-5) - 10\,a(n-6) - 2\,a(n-7) - 2\,a(n-8) + 2\,a(n-9)
\end{equation}
for all $n>9$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A298570.
