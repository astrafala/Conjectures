...
\title{The empirical recurrence for OEIS A185771, proved by transfer matrix}
...
\begin{abstract}
OEIS A185771 counts arrays over $\{0,\dots,2\}$ under a condition on the sum of every
...
OEIS A185771 is ``Number of (n+1) X 2 0..2 arrays with no 2 X 2 subblock sum equal to any horizontal or vertical neighbor 2 X 2 subblock sum.''. It has offset $1$ and begins
\[
81, 558, 3844, 26784, 186624, 1296000, 9000000, 62568000,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n)= 3*a(n-1) +96*a(n-3) +504*a(n-4) +792*a(n-5) +2304*a(n-6) -13824*a(n-8) -13824*a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 03:10:21, revision 12) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + 96\,a(n-3) + 504\,a(n-4) + 792\,a(n-5) + 2304\,a(n-6) - 13824\,a(n-8) - 13824\,a(n-9)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A185771.
