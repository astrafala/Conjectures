...
\title{The empirical recurrence for OEIS A305525, proved by transfer matrix}
...
\begin{abstract}
OEIS A305525 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A305525 is ``Number of nX3 0..1 arrays with every element unequal to 0, 1, 2, 3, 4 or 6 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
4, 30, 161, 880, 4779, 26000, 141474, 769617,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 5*a(n-1) +2*a(n-2) +10*a(n-3) -44*a(n-4) +4*a(n-5) +18*a(n-6) +2*a(n-7) -26*a(n-8) -27*a(n-9) -12*a(n-10) -3*a(n-11)
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 04 2018 12:01:58, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) + 2\,a(n-2) + 10\,a(n-3) - 44\,a(n-4) + 4\,a(n-5) + 18\,a(n-6) + 2\,a(n-7) - 26\,a(n-8) - 27\,a(n-9) - 12\,a(n-10) - 3\,a(n-11)
\end{equation}
for all $n>11$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A305525.
