...
\title{The empirical recurrence for OEIS A250448, proved by transfer matrix}
...
\begin{abstract}
OEIS A250448 counts arrays over $\{0,1,2\}$ in which a statistic taken over short runs
...
OEIS A250448 is ``Number of (n+1)X(2+1) 0..2 arrays with nondecreasing min(x(i,j),x(i,j-1)) in the i direction and nondecreasing min(x(i,j),x(i-1,j)) in the j direction.''. It has offset $1$ and begins
\[
217, 2029, 17024, 141857, 1155519, 9376751, 75647740, 609534839,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 12:25:38, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;10\,a(n-1) + 6\,a(n-2) - 210\,a(n-3) + 173\,a(n-4) + 976\,a(n-5) - 674\,a(n-6) - 1632\,a(n-7) + 800\,a(n-8) + 1128\,a(n-9) - 288\,a(n-10) - 288\,a(n-11)
\]
for every $n>10$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250448.
