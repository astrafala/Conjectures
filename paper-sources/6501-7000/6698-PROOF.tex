...
\title{The empirical recurrence for OEIS A252545, proved by transfer matrix}
...
\begin{abstract}
OEIS A252545 counts $3\times(n+2)$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252545 is ``Number of (1+2)X(n+2) 0..3 arrays with every 3X3 subblock row and diagonal sum equal to 1 3 4 6 or 7 and every 3X3 column and antidiagonal sum not equal to 1 3 4 6 or 7.''. It has offset $1$ and begins
\[
478, 1048, 2532, 5608, 14824, 38780, 89048, 237360,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 34*a(n-3) +2*a(n-5) -320*a(n-6) -36*a(n-8) +512*a(n-9) +64*a(n-11) for n>15
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:20:34, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;34\,a(n-3) + 2\,a(n-5) - 320\,a(n-6) - 36\,a(n-8) + 512\,a(n-9) + 64\,a(n-11)
\]
for every $n>15$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252545.
