...
\title{The empirical recurrence for OEIS A298496, proved by transfer matrix}
...
\begin{abstract}
OEIS A298496 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A298496 is ``Number of nX3 0..1 arrays with every element equal to 0, 1, 3, 4 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
3, 3, 1, 4, 5, 6, 20, 35,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 20 2018 08:09:07, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 2\,a(n-2) + 6\,a(n-3) - 4\,a(n-4) - 10\,a(n-5) - 11\,a(n-6) + 5\,a(n-7) + 12\,a(n-8) + 6\,a(n-9) - 5\,a(n-10) - a(n-11) + 7\,a(n-12) + 3\,a(n-13) - 3\,a(n-14) - 3\,a(n-15)
\end{equation}
for all $n>16$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A298496.
