...
\title{The empirical recurrence for OEIS A203185, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A203185 counts arrays over $\{0,\dots,4\}$ in which every cell is constrained by the
...
OEIS A203185 is ``Number of n X 2 0..4 arrays with every nonzero element less than or equal to some horizontal or vertical neighbor.''. It has offset $1$ and begins
\[
5, 165, 3209, 53233, 904175, 15703631, 271942421, 4694586685,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 15*a(n-1) -15*a(n-2) +821*a(n-3) +1430*a(n-4) +9500*a(n-5) +11557*a(n-6) +27197*a(n-7) +15316*a(n-8) +14400*a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 15 2022 23:07:20, revision 7) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;15\,a(n-1) - 15\,a(n-2) + 821\,a(n-3) + 1430\,a(n-4) + 9500\,a(n-5) + 11557\,a(n-6) + 27197\,a(n-7) + 15316\,a(n-8) + 14400\,a(n-9)
\end{equation}
for all $n>10$.
...
$5$ values, so there are about $10^{22}$ of them to sift. The
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A203185.
