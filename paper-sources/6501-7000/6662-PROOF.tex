...
\title{The empirical recurrence for OEIS A208422, proved by transfer matrix}
...
\begin{abstract}
OEIS A208422 counts arrays over $\{0,\dots,1\}$ of width $5$ that avoid the patterns
...
OEIS A208422 is ``Number of 5Xn 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 0 0 and 0 1 1 vertically.''. It has offset
$1$ and begins
\[
13, 169, 611, 3835, 18395, 100113, 512525,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +23*a(n-2) +11*a(n-3) -83*a(n-4) -21*a(n-5) +96*a(n-6) +12*a(n-7) -42*a(n-8) -2*a(n-9) +6*a(n-10)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:50:51, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 23\,a(n-2) + 11\,a(n-3) - 83\,a(n-4) - 21\,a(n-5) + 96\,a(n-6) + 12\,a(n-7) - 42\,a(n-8) - 2\,a(n-9) + 6\,a(n-10)
\end{equation}
...
$(0,0,0), (0,1,1)$ as $3$ consecutive entries. There are $13$ admissible columns; that condition
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208422.
