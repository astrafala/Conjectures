...
\title{The empirical recurrence for OEIS A302815, proved by transfer matrix}
...
\begin{abstract}
OEIS A302815 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A302815 is ``Number of n X 3 0..1 arrays with every element equal to 0, 1, 2, 4 or 5 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
4, 20, 75, 389, 1852, 8485, 41247, 196946,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 26 2024 01:34:17, revision
6) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 5\,a(n-2) + 36\,a(n-3) - 62\,a(n-4) - 116\,a(n-5) - 142\,a(n-6) - 78\,a(n-7) + 150\,a(n-8) - 100\,a(n-9) + 176\,a(n-10) + 272\,a(n-11) + 320\,a(n-12) - 256\,a(n-14)
\end{equation}
for all $n>14$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302815.
