...
\title{The empirical recurrence for OEIS A297884, proved by transfer matrix}
...
\begin{abstract}
OEIS A297884 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A297884 is ``Number of nX3 0..1 arrays with every element equal to 0, 1, 2 or 4 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
4, 13, 20, 26, 41, 67, 99, 156,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) -2*a(n-2) +2*a(n-3) -6*a(n-4) +2*a(n-5) +5*a(n-7) -a(n-8) -2*a(n-10) for n>11
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 07 2018 16:28:31, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) - 2\,a(n-2) + 2\,a(n-3) - 6\,a(n-4) + 2\,a(n-5) + 5\,a(n-7) - a(n-8) - 2\,a(n-10)
\end{equation}
for all $n>11$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297884.
