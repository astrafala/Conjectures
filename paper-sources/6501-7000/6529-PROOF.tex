...
\title{The empirical recurrence for OEIS A252025, proved by transfer matrix}
...
\begin{abstract}
OEIS A252025 counts $(n+2)\times3$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A252025 is ``Number of (n+2)X(1+2) 0..2 arrays with every 3X3 subblock row, column, diagonal and antidiagonal sum not equal to 0 2 or 4.''. It has offset $1$ and begins
\[
213, 227, 357, 809, 1805, 4259, 10251, 24331,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) -a(n-2) +5*a(n-3) -2*a(n-4) +3*a(n-5) -2*a(n-6) -2*a(n-7) -2*a(n-8) -2*a(n-9) +2*a(n-11) for n>14
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 10:42:37, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252025.
