...
\title{The empirical recurrence for OEIS A297222, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297222 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A297222 is ``Number of nX6 0..1 arrays with every 1 horizontally or antidiagonally adjacent to 1 neighboring 1s.''. It has offset $1$ and begins
\[
9, 69, 535, 4210, 33158, 261939, 2063378, 16277793,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 27 2017 15:36:34, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 34\,a(n-2) + 146\,a(n-3) + 141\,a(n-4) - 184\,a(n-5) - 461\,a(n-6) + 413\,a(n-7) - 498\,a(n-8) - 119\,a(n-9) + 408\,a(n-10) + 144\,a(n-11)
\end{equation}
for all $n>13$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297222.
