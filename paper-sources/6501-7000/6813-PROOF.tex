...
\title{The empirical recurrence for OEIS A231765, proved by transfer matrix}
...
\begin{abstract}
OEIS A231765 counts $2\times(n+1)$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A231765 is ``Number of (1+1) X (n+1) 0..1 arrays with no element having a strict majority of its horizontal, diagonal and antidiagonal neighbors equal to one.''. It has offset $1$ and begins
\[
9, 33, 100, 315, 961, 3024, 9409, 29319,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) + a(n-3) + 7*a(n-4) - 20*a(n-5) - 2*a(n-6) - 4*a(n-8) + 8*a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 01 2018 06:28:07, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + a(n-3) + 7\,a(n-4) - 20\,a(n-5) - 2\,a(n-6) - 4\,a(n-8) + 8\,a(n-9)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231765.
