...
\title{The empirical recurrence for OEIS A300345, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A300345 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A300345 is ``Number of nX3 0..1 arrays with every element equal to 1 or 2 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
1, 6, 9, 26, 57, 133, 306, 709,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) +a(n-2) -2*a(n-5) -2*a(n-6) -2*a(n-7) -a(n-8) for n>10
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 03 2018 08:29:14, revision 4) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A300345.
