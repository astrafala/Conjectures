...
\title{The empirical recurrence for OEIS A283545, proved by transfer matrix}
...
\begin{abstract}
OEIS A283545 counts $4\times n$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A283545 is ``Number of 4 X n 0..1 arrays with no 1 equal to more than one of its horizontal, diagonal and antidiagonal neighbors.''. It has offset $1$ and begins
\[
16, 98, 573, 4089, 25532, 167920, 1094959, 7101809,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + 19*a(n-2) + 62*a(n-3) + 24*a(n-4) + 82*a(n-5) - 75*a(n-6) + 50*a(n-7) - 145*a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 21 2019 09:13:50, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 19\,a(n-2) + 62\,a(n-3) + 24\,a(n-4) + 82\,a(n-5) - 75\,a(n-6) + 50\,a(n-7) - 145\,a(n-8)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A283545.
