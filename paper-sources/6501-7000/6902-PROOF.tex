...
\title{The empirical recurrence for OEIS A183346, proved by transfer matrix}
...
\begin{abstract}
OEIS A183346 counts arrays of width $4$ over $\{0,1\}$ under local conditions relating each cell
...
OEIS A183346 is ``Number of n X 4 binary arrays with each 1 adjacent to exactly one 0 vertically and one 0 horizontally.''. It has offset $1$ and begins
\[
1, 17, 25, 63, 163, 387, 943, 2289,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + a(n-2) + 4*a(n-3) + 4*a(n-4) + 3*a(n-5) - a(n-6) - 2*a(n-7) - a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 28 2018 08:14:06, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + a(n-2) + 4\,a(n-3) + 4\,a(n-4) + 3\,a(n-5) - a(n-6) - 2\,a(n-7) - a(n-8)
\]
for every $n>7$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A183346.
