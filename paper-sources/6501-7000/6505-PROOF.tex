...
\title{The empirical recurrence for OEIS A284076, proved by transfer matrix}
...
\begin{abstract}
OEIS A284076 counts $2\times n$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
walk, and $a(n)$ is a walk count on $S=52$ vertices, which is $C$-finite. Whether the
...
OEIS A284076 is ``Number of 2Xn 0..1 arrays with no 1 equal to more than three of its horizontal, diagonal and antidiagonal neighbors, with the exception of exactly two elements.''. It has offset $1$ and begins
\[
0, 0, 1, 6, 33, 176, 858, 4000,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 21 2017 23:11:45, revision 6) this is still
...
$\{0,\dots,1\}^{2}$. The neighbourhood of a cell in column $u_i$ meets $u_{i-1}$,
...
$2$ cells, given $r$ above and $t$ below. An array with $L$ columns is then a walk of length
...
\begin{theorem}
\[
a(n)\;=\;9\,a(n-1) - 24\,a(n-2) + 30\,a(n-3) - 84\,a(n-4) + 48\,a(n-5) + 106\,a(n-6) + 318\,a(n-7) + 813\,a(n-8) + 919\,a(n-9) + 990\,a(n-10) + 756\,a(n-11) + 216\,a(n-12)
\]
for every $n>12$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A284076.
