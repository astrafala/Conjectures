...
\title{The empirical recurrence for OEIS A188875, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A188875 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A188875 is ``Number of 3Xn binary arrays without the pattern 0 0 0 antidiagonally or horizontally.''. It has offset $1$ and begins
\[
8, 64, 316, 1901, 11332, 65656, 385700, 2262261,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 04:54:57, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 10\,a(n-2) + 41\,a(n-3) - 3\,a(n-4) - 10\,a(n-5) - 124\,a(n-6) + 96\,a(n-7) - 50\,a(n-8) + 71\,a(n-9) - 43\,a(n-10) + 14\,a(n-11) - 5\,a(n-12) + a(n-13)
\end{equation}
for all $n>14$.
...
\text{no }0,0,0\text{ occurs consecutively along any direction in }\mathcal N
\end{equation}
for every cell $(t,u)$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A188875.
