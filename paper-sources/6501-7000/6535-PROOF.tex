...
\title{The empirical recurrence for OEIS A206132, proved by transfer matrix}
...
\begin{abstract}
OEIS A206132 counts arrays over $\{0,\dots,3\}$ under a condition on the perimeter cycle of
every $2\times3$ and $3\times2$ subblock, and carries an empirical recurrence of order $11$ contributed by
R.~H.~Hardin. It is true, and it is decidable rather than empirical. The condition is local to
a bounded window of consecutive rows, so the count is a walk count on $S=3092$ states and is
...
OEIS A206132 is ``Number of (n+1) X 4 0..3 arrays with every 2 X 3 or 3 X 2 subblock having exactly three counterclockwise and three clockwise edge increases.''. It has offset $1$ and begins
\[
3092, 91924, 2761756, 83120732, 2502596196, 75353928196, 2268967605164, 68320694237116,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 11 2015 11:49:00, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;46\,a(n-1) - 573\,a(n-2) + 3120\,a(n-3) - 8589\,a(n-4) + 11686\,a(n-5) - 4877\,a(n-6) - 5572\,a(n-7) + 6702\,a(n-8) - 1664\,a(n-9) - 390\,a(n-10) + 112\,a(n-11)
\]
for every $n>11$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206132.
