...
\title{The empirical recurrence for OEIS A183399, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A183399 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A183399 is ``Half the number of n X 3 binary arrays with no element equal to a strict majority of its diagonal and antidiagonal neighbors.''. It has offset $1$ and begins
\[
4, 2, 6, 32, 110, 450, 1680, 6498,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 5*a(n-1) - 23*a(n-3) + 15*a(n-4) + 40*a(n-5) - 46*a(n-6) + 20*a(n-8) - 8*a(n-9) for n>10.
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 28 2018 09:50:44, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) - 23\,a(n-3) + 15\,a(n-4) + 40\,a(n-5) - 46\,a(n-6) + 20\,a(n-8) - 8\,a(n-9)
\end{equation}
for all $n>10$.
...
\[
a(n_0+j)-\sum_i c_i\,a(n_0+j-i)\;=\;\tfrac1{2}\,\mathbf{v}^{\!\top}G^{\,j-9}w,
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A183399.
