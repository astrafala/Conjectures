...
\title{The empirical recurrence for OEIS A231377, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A231377 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A231377 is ``Number of n X 3 0..1 arrays with no element less than a strict majority of its horizontal and vertical neighbors.''. It has offset $1$ and begins
\[
4, 21, 93, 378, 1519, 6126, 24747, 99964,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 6*a(n-1) - 11*a(n-2) + 16*a(n-3) - 14*a(n-4) - 3*a(n-5) + 8*a(n-6) - 9*a(n-7) - 2*a(n-8) + 6*a(n-9) + 2*a(n-10) for n>11.
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 28 2018 15:19:15, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231377.
