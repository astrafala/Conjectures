...
\title{The empirical recurrence for OEIS A231999, proved by transfer matrix}
...
\begin{abstract}
OEIS A231999 counts $3\times(n+1)$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A231999 is ``Number of (2+1)X(n+1) 0..1 arrays with no element having a strict majority of its horizontal and antidiagonal neighbors equal to one.''. It has offset $1$ and begins
\[
9, 32, 121, 406, 1225, 3916, 12769, 41180,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 06:47:11, revision 6) this is still
...
the condition
\[
\text{no cell has a strict majority of its horizontal and antidiagonal neighbours equal to 1},
\]
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) - 3\,a(n-2) + 11\,a(n-3) + 5\,a(n-4) - 7\,a(n-5) + 11\,a(n-6) - 35\,a(n-7) - 11\,a(n-8) + 9\,a(n-9) - 5\,a(n-10) + 13\,a(n-11) + 3\,a(n-12) - a(n-13) + a(n-14) - a(n-15)
\]
for every $n>14$.
\end{theorem}
...
By Lemma~\ref{lem:crit} the recurrence holds for every $n>14$.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231999.
