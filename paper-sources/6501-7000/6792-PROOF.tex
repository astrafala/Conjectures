...
\title{The empirical recurrence for OEIS A235081, proved by transfer matrix}
...
\begin{abstract}
OEIS A235081 counts $3$-column arrays over $\{0,\dots,4\}$ in which every
...
OEIS A235081 is ``Number of (n+1) X (2+1) 0..4 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 4, with no adjacent elements equal (constant-stress tilted 1 X 1 tilings).''. It has offset
$1$ and begins
\[
90, 198, 418, 930, 2002, 4514, 9838,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) + 10*a(n-2) - 33*a(n-3) - 28*a(n-4) + 111*a(n-5) + 20*a(n-6) - 111*a(n-7) - 27*a(n-8) + 30*a(n-9) + 10*a(n-10).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 19 2022 01:31:36, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 10\,a(n-2) - 33\,a(n-3) - 28\,a(n-4) + 111\,a(n-5) + 20\,a(n-6) - 111\,a(n-7) - 27\,a(n-8) + 30\,a(n-9) + 10\,a(n-10)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A235081.
