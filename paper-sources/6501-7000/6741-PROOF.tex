...
\title{The empirical recurrence for OEIS A297453, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297453 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A297453 is ``Number of nX4 0..1 arrays with every 1 horizontally, diagonally or antidiagonally adjacent to 0 or 2 neighboring 1s.''. It has offset $1$ and begins
\[
8, 57, 285, 1677, 9774, 55713, 321030, 1848151,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 6*a(n-1) -2*a(n-2) +14*a(n-3) -69*a(n-4) +45*a(n-5) -13*a(n-6) +23*a(n-7) +3*a(n-8) +3*a(n-9) +2*a(n-10) -4*a(n-11)
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 30 2017 11:05:18, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) - 2\,a(n-2) + 14\,a(n-3) - 69\,a(n-4) + 45\,a(n-5) - 13\,a(n-6) + 23\,a(n-7) + 3\,a(n-8) + 3\,a(n-9) + 2\,a(n-10) - 4\,a(n-11)
\end{equation}
for all $n>12$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297453.
