...
\title{The empirical recurrence for OEIS A299650, proved by transfer matrix}
...
\begin{abstract}
OEIS A299650 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A299650 is ``Number of nX4 0..1 arrays with every element equal to 0, 1, 2, 3, 4, 5 or 6 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
8, 128, 1924, 29408, 448993, 6856789, 104711327, 1599074414,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 15 2018 14:39:20, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;13\,a(n-1) + 31\,a(n-2) + 61\,a(n-3) - 43\,a(n-4) - 428\,a(n-5) - 273\,a(n-6) + 69\,a(n-7) + 545\,a(n-8) + 212\,a(n-9) - 84\,a(n-10) - 204\,a(n-11) - 32\,a(n-12) + 16\,a(n-13) + 24\,a(n-14)
\end{equation}
for all $n>14$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A299650.
