...
\title{The empirical recurrence for OEIS A256746, proved by transfer matrix}
...
\begin{abstract}
OEIS A256746 counts $(n+2)\times8$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A256746 is ``Number of (n+2)X(6+2) 0..1 arrays with no 3x3 subblock diagonal sum 3 and no antidiagonal sum 3 and no row sum 0 and no column sum 0.''. It has offset $1$ and begins
\[
12914, 12280, 16560, 18688, 47440, 72192, 155792, 255488,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:45:03, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;-2\,a(n-1) + 4\,a(n-2) + 24\,a(n-3) + 27\,a(n-4) - 70\,a(n-5) - 198\,a(n-6) - 88\,a(n-7) + 408\,a(n-8) + 648\,a(n-9) - 48\,a(n-10) - 896\,a(n-11) - 704\,a(n-12) + 384\,a(n-13) + 512\,a(n-14)
\]
for every $n>18$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A256746.
