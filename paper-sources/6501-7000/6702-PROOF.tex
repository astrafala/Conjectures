...
\title{The empirical recurrence for OEIS A275146, proved by counting patterns}
...
\begin{abstract}
OEIS A275146 counts arrays in which no entry may repeat a value found at any of three stated
...
cutting $535538$ pairs to $S=90623$ states. The entry's empirical recurrence of order $13$,
...
OEIS A275146 is ``Number of 6Xn 0..2 arrays with no element equal to any value at offset (-2,-2) (-1,-2) or (0,-1) and new values introduced in order 0..2.''. It has offset $1$ and begins
\[
122, 7776, 10000, 25344, 41360, 165568, 663904, 2695808,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 17 2016 16:29:38, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;13\,a(n-1) - 77\,a(n-2) + 286\,a(n-3) - 736\,a(n-4) + 1351\,a(n-5) - 1787\,a(n-6) + 1716\,a(n-7) - 1217\,a(n-8) + 652\,a(n-9) - 265\,a(n-10) + 78\,a(n-11) - 14\,a(n-12) + a(n-13)
\end{equation}
for all $n>18$.
...
$o=1n_0+0-2$, we have for $j\ge13$
\[
3!\Bigl(a(n_0+j)-\sum_i c_i\,a(n_0+j-i)\Bigr)
=\mathbf{v}^{\!\top}G^{\,j-13}w,\qquad
w=h_{13}-\sum_i c_i h_{13-i} .
\]
...
the survivors by the pattern of the new pair. The vector $w$ was formed by $13$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A275146.
