...
\title{The empirical recurrence for OEIS A299576, proved by transfer matrix}
...
\begin{abstract}
OEIS A299576 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A299576 is ``Number of nX3 0..1 arrays with every element equal to 0, 3, 4, 5, 7 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 1, 10, 10, 27, 63, 115, 267,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) +a(n-2) +a(n-3) -4*a(n-4) -2*a(n-5) -2*a(n-6) +a(n-9) for n>13
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 13 2018 11:22:23, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + a(n-2) + a(n-3) - 4\,a(n-4) - 2\,a(n-5) - 2\,a(n-6) + a(n-9)
\end{equation}
for all $n>13$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A299576.
