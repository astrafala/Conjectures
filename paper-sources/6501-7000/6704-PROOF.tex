...
\title{The empirical recurrence for OEIS A250820, proved by transfer matrix}
...
\begin{abstract}
OEIS A250820 counts arrays over $\{0,1\}$ in which a statistic taken over short runs
...
OEIS A250820 is ``Number of (n+2) X (1+2) 0..1 arrays with nondecreasing maximum minus minimum of every three consecutive values in every row and column.''. It has offset $1$ and begins
\[
512, 2744, 13824, 64000, 287496, 1259712, 5451776, 23393656,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 7*a(n-1) -8*a(n-2) -27*a(n-3) +45*a(n-4) +24*a(n-5) -51*a(n-6) -3*a(n-7) +16*a(n-8) -a(n-9) -a(n-10).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 14 2023 11:10:10, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250820.
