...
\title{The empirical recurrence for OEIS A301952, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A301952 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A301952 is ``Number of 3Xn 0..1 arrays with every element equal to 1, 2 or 3 horizontally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
0, 5, 20, 123, 680, 4070, 23565, 138014,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 4*a(n-1) +12*a(n-2) -5*a(n-3) -14*a(n-4) +14*a(n-6) +4*a(n-7) -3*a(n-8) -5*a(n-9) +a(n-10) for n>12
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 29 2018 12:46:46, revision 4) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A301952.
