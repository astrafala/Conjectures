...
\title{The empirical recurrence for OEIS A261260, proved by transfer matrix}
...
\begin{abstract}
OEIS A261260 counts $(n+2)\times5$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A261260 is ``Number of (n+2) X (3+2) 0..1 arrays with each 3 X 3 subblock having clockwise perimeter pattern 00010101 00100101 or 01010101.''. It has offset $1$ and begins
\[
91, 110, 288, 690, 1483, 2948, 6795, 14292,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-2) + 10*a(n-4) + a(n-5) + 9*a(n-6) + a(n-7) + 6*a(n-8) + 2*a(n-10) - 4*a(n-11) + 4*a(n-12) for n>13.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 30 2018 09:11:47, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-2) + 10\,a(n-4) + a(n-5) + 9\,a(n-6) + a(n-7) + 6\,a(n-8) + 2\,a(n-10) - 4\,a(n-11) + 4\,a(n-12)
\]
for every $n>13$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A261260.
