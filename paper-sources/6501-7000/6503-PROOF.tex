...
\title{The empirical recurrence for OEIS A207118, proved by transfer matrix}
...
\begin{abstract}
OEIS A207118 counts arrays over $\{0,\dots,1\}$ of width $3$ that avoid the patterns
...
OEIS A207118 is ``Number of n X 3 0..1 arrays avoiding 0 0 1 and 0 1 0 horizontally and 0 0 1 and 0 1 1 vertically.''. It has offset
$1$ and begins
\[
6, 36, 102, 289, 612, 1296, 2340,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) +4*a(n-2) -10*a(n-3) -5*a(n-4) +20*a(n-5) -20*a(n-7) +5*a(n-8) +10*a(n-9) -4*a(n-10) -2*a(n-11) +a(n-12).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 20 2018 12:12:16, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207118.
