...
\title{The empirical recurrence for OEIS A259766, proved by transfer matrix}
...
\begin{abstract}
OEIS A259766 counts $(n+2)\times4$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A259766 is ``Number of (n+2) X (2+2) 0..1 arrays with each 3 X 3 subblock having clockwise perimeter pattern 00000001 or 00000101.''. It has offset $1$ and begins
\[
49, 87, 167, 299, 564, 1086, 2045, 3870,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 27 2018 06:20:13, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + a(n-2) + a(n-3) + 2\,a(n-4) - 2\,a(n-5) + 2\,a(n-6) - 4\,a(n-7) - 3\,a(n-8) + 2\,a(n-9) - 4\,a(n-10) + 2\,a(n-11)
\]
for every $n>12$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A259766.
