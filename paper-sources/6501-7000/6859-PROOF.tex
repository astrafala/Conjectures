...
\title{The empirical recurrence for OEIS A320397, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A320397 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A320397 is ``Number of nX3 0..1 arrays with every element unequal to 0, 1, 2, 3 or 5 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
4, 28, 142, 732, 3694, 18754, 94842, 480321,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 12 2018 12:26:56, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 11\,a(n-2) - a(n-3) - 8\,a(n-4) - a(n-5) - 26\,a(n-6) - 5\,a(n-7) + 18\,a(n-8) + 5\,a(n-9) - 5\,a(n-10) - 4\,a(n-11) - a(n-12)
\end{equation}
for all $n>14$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A320397.
