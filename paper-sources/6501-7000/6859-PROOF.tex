...
\title{The empirical recurrence for OEIS A184378, proved by transfer matrix}
...
\begin{abstract}
OEIS A184378 counts arrays of width $3$ over $\{0,1,2\}$ in which every $3\times3$ subblock
satisfies a condition on its nine entries. The entry carries an empirical recurrence of order
$9$ contributed by R.~H.~Hardin. It is true, and it is decidable rather than empirical: a
...
OEIS A184378 is ``1/12 the number of (n+2) X 3 0..2 arrays with each 3 X 3 subblock containing three of each value.''. It has offset $1$ and begins
\[
140, 545, 2174, 9113, 43295, 212747, 1096781, 6045233,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 27 2023 14:54:48, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;10\,a(n-1) - 27\,a(n-2) + 81\,a(n-3) - 630\,a(n-4) + 1701\,a(n-5) - 1620\,a(n-6) + 4860\,a(n-7) - 13122\,a(n-8) + 8748\,a(n-9)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A184378.
