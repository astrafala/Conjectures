...
\title{The empirical recurrence for OEIS A207730, proved by transfer matrix}
...
\begin{abstract}
OEIS A207730 counts arrays over $\{0,\dots,1\}$ of width $3$ that avoid the patterns
$(0,1,1), (1,0,1)$ along one axis and $(0,0,0), (0,1,0)$ along the other, and carries an empirical recurrence of
...
OEIS A207730 is ``Number of 3 X n 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 1 1 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
6, 36, 78, 169, 611, 2209, 6016,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) + 5*a(n-3) + 22*a(n-4) - 24*a(n-5) - 15*a(n-6) - 36*a(n-8) + 27*a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 05 2018 14:47:40, revision
8) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 5\,a(n-3) + 22\,a(n-4) - 24\,a(n-5) - 15\,a(n-6) - 36\,a(n-8) + 27\,a(n-9)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207730.
