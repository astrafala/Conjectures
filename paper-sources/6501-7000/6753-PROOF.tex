...
\title{The empirical recurrence for OEIS A301610, proved by transfer matrix}
...
\begin{abstract}
OEIS A301610 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A301610 is ``Number of nX3 0..1 arrays with every element equal to 1, 2 or 3 horizontally or vertically adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 11, 62, 367, 2131, 12467, 72758, 425003,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 4*a(n-1) +12*a(n-2) -5*a(n-3) -14*a(n-4) +14*a(n-6) +4*a(n-7) -3*a(n-8) -5*a(n-9) +a(n-10)
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 24 2018 11:38:56, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) + 12\,a(n-2) - 5\,a(n-3) - 14\,a(n-4) + 14\,a(n-6) + 4\,a(n-7) - 3\,a(n-8) - 5\,a(n-9) + a(n-10)
\end{equation}
for all $n>10$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A301610.
