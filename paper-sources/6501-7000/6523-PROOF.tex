...
\title{The empirical recurrence for OEIS A237333, proved by transfer matrix}
...
\begin{abstract}
OEIS A237333 counts arrays over $\{0,\dots,3\}$ subject to a condition on the order
...
OEIS A237333 is ``Number of (n+1) X (1+1) 0..3 arrays with the maximum minus the minimum of every 2 X 2 subblock equal.''. It has offset $1$ and begins
\[
256, 1980, 15082, 120808, 972356, 7935194, 65088736, 536949612,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 15 2026 15:45:09, revision 9) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237333.
