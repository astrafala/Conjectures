...
\title{The empirical recurrence for OEIS A189105, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A189105 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A189105 is ``Number of n X 3 binary arrays without the pattern 1 1 0 diagonally or antidiagonally.''. It has offset $1$ and begins
\[
8, 64, 400, 2500, 15200, 92416, 560576, 3400336,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 7*a(n-1) -40*a(n-3) +22*a(n-4) +86*a(n-5) -80*a(n-6) +24*a(n-8) -8*a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (May 01 2018 13:05:54, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;7\,a(n-1) - 40\,a(n-3) + 22\,a(n-4) + 86\,a(n-5) - 80\,a(n-6) + 24\,a(n-8) - 8\,a(n-9)
\end{equation}
for all $n>10$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A189105.
