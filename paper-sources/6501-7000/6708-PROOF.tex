...
\title{The empirical recurrence for OEIS A236349, proved by transfer matrix}
...
\begin{abstract}
OEIS A236349 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
OEIS A236349 is ``Number of (n+1)X(1+1) 0..2 arrays colored with the sum of the upper and lower median values of each 2X2 subblock.''. It has offset $1$ and begins
\[
81, 462, 2588, 14952, 86800, 498976, 2868608, 16528896,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 9*a(n-2) +64*a(n-3) +304*a(n-4) +596*a(n-5) +912*a(n-6) +176*a(n-7) -2528*a(n-8) -3648*a(n-9) -2048*a(n-10)
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 09:14:32, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;9\,a(n-2) + 64\,a(n-3) + 304\,a(n-4) + 596\,a(n-5) + 912\,a(n-6) + 176\,a(n-7) - 2528\,a(n-8) - 3648\,a(n-9) - 2048\,a(n-10)
\]
for every $n>10$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A236349.
