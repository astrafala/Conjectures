...
\title{The empirical recurrence for OEIS A237069, proved by transfer matrix}
...
\begin{abstract}
OEIS A237069 counts arrays over $\{0,\dots,3\}$ subject to a condition on the order
...
OEIS A237069 is ``Number of (n+1)X(1+1) 0..3 arrays with the upper median of every 2X2 subblock equal.''. It has offset $1$ and begins
\[
256, 2132, 15882, 128988, 1042300, 8613338, 71747464, 604396964,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 09:47:54, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;20\,a(n-1) - 80\,a(n-2) - 614\,a(n-3) + 3996\,a(n-4) + 6360\,a(n-5) - 60341\,a(n-6) - 25592\,a(n-7) + 404984\,a(n-8) + 30176\,a(n-9) - 1229712\,a(n-10) + 1327104\,a(n-12)
\]
for every $n>11$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237069.
