...
\title{The empirical recurrence for OEIS A255031, proved by transfer matrix}
...
\begin{abstract}
OEIS A255031 counts the arrays over $\{0,\dots,1\}$ whose $3\times3$ subblocks carry a
...
OEIS A255031 is ``Number of (n+2)X(3+2) 0..1 arrays with every 3X3 subblock sum of the two sums of the central row and central column minus the two minimums of the diagonal and antidiagonal nondecreasing horizontally, vertically and ne-to-sw antidiagonally.''. It has offset $1$ and begins
\[
10732, 39935, 100001, 154706, 256941, 346115, 425667, 483327,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 15:05:36, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A255031.
