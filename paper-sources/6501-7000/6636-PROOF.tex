...
\title{The empirical recurrence for OEIS A264186, proved by transfer matrix}
...
\begin{abstract}
OEIS A264186 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=5$ rows in which
...
partly used. Carrying those as bitmasks makes the count a walk on $S=1048576$ vertices, so it is
...
OEIS A264186 is ``Number of (n+1)X(4+1) arrays of permutations of 0..n*5+4 with each element having index change +-(.,.) 0,0 1,-1 or 2,2.''. It has offset $1$ and begins
\[
16, 375, 7056, 147968, 2944656, 57950000, 1150295056, 22732293168,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 10 2015 11:08:25, revision 6) this is still
...
\[
(i-h_i,\,j-h_j)\;\in\;\{(-2,-2),\ (-1,1),\ (0,0),\ (1,-1),\ (2,2)\},
\]
...
Hence $a$ is a walk count on $S=1048576$ vertices,
\[
...
\begin{theorem}
\[
a(n)\;=\;15\,a(n-1) + 76\,a(n-2) + 304\,a(n-3) - 4816\,a(n-4) + 95344\,a(n-5) + 477888\,a(n-6) + 1911552\,a(n-7) + 9190400\,a(n-8) + 7421952\,a(n-9) + 4980736\,a(n-10) + 19922944\,a(n-11) + 96468992\,a(n-12) + 67108864\,a(n-13)
\]
for every $n>13$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264186.
