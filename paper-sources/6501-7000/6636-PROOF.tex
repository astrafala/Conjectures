...
\title{The empirical recurrence for OEIS A250944, proved by transfer matrix}
...
\begin{abstract}
OEIS A250944 counts arrays over $\{0,1,2\}$ in which a statistic taken over short runs
...
window of consecutive rows, so the count is a walk count on $S=27$ states, and the
...
OEIS A250944 is ``Number of (2+1)X(n+1) 0..2 arrays with nondecreasing x(i,j)+x(i,j-1) in the i direction and nondecreasing absolute value of x(i,j)-x(i-1,j) in the j direction.''. It has offset $1$ and begins
\[
125, 699, 3355, 15431, 67595, 287045, 1188599, 4827913,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 12:53:18, revision 6) this is still
...
So a single row is a state. Let $M$ be the matrix on the $3^{3}=27$ rows with
...
\begin{theorem}
\[
a(n)\;=\;10\,a(n-1) - 29\,a(n-2) - 6\,a(n-3) + 136\,a(n-4) - 90\,a(n-5) - 217\,a(n-6) + 186\,a(n-7) + 143\,a(n-8) - 124\,a(n-9) - 32\,a(n-10) + 24\,a(n-11)
\]
for every $n>10$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250944.
