...
\title{The empirical recurrence for OEIS A238511, proved by transfer matrix}
...
\begin{abstract}
OEIS A238511 counts $(n+1)\times3$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A238511 is ``Number of (n+1)X(2+1) 0..3 arrays with no element equal to all horizontal neighbors or equal to all vertical neighbors, and new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
25, 401, 14407, 430504, 13398587, 413256106, 12771744135, 394537124897,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 10:52:24, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;22\,a(n-1) + 277\,a(n-2) + 42\,a(n-3) - 3413\,a(n-4) - 576\,a(n-5) + 1877\,a(n-6) + 38722\,a(n-7) - 43921\,a(n-8) - 27402\,a(n-9) + 38409\,a(n-10) - 4968\,a(n-11) - 9432\,a(n-12) + 8640\,a(n-13) + 3456\,a(n-14)
\]
for every $n>14$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A238511.
