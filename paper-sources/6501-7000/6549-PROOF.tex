...
\title{The empirical recurrence for OEIS A251231, proved by transfer matrix}
...
\begin{abstract}
OEIS A251231 counts $4$-column arrays over $\{0,\dots,3\}$ in which every
...
OEIS A251231 is ``Number of (n+1) X (3+1) 0..3 arrays with every 2 X 2 subblock summing to 6 and no 2 X 2 subblock having exactly two nonzero entries.''. It has offset $1$
and begins
\[
322, 694, 1592, 3886, 9914, 26224, 71322, 198318,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 11 2015 09:18:18, revision 10) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251231.
