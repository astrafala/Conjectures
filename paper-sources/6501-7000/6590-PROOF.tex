...
\title{The empirical recurrence for OEIS A234559, proved by transfer matrix}
...
\begin{abstract}
OEIS A234559 counts $4$-column arrays over $\{0,\dots,4\}$ in which every
...
OEIS A234559 is ``Number of (n+1) X (3+1) 0..4 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 4 (constant-stress 1 X 1 tilings).''. It has offset
$1$ and begins
\[
618, 1240, 2390, 5710, 12750, 33946, 83438,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 20 2022 19:28:51, revision 6) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234559.
