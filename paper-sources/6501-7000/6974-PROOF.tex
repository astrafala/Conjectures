...
\title{The empirical recurrence for OEIS A281467, proved by transfer matrix}
...
\begin{abstract}
OEIS A281467 counts $n\times6$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A281467 is ``Number of nX6 0..1 arrays with no element equal to more than two of its horizontal, diagonal or antidiagonal neighbors and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
32, 169, 87, 176, 358, 706, 1422, 2858,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) +3*a(n-3) -4*a(n-4) -4*a(n-5) +a(n-6) -a(n-7) +2*a(n-8) +5*a(n-9) -3*a(n-11) for n>17
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 22 2017 07:24:41, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 3\,a(n-3) - 4\,a(n-4) - 4\,a(n-5) + a(n-6) - a(n-7) + 2\,a(n-8) + 5\,a(n-9) - 3\,a(n-11)
\]
for every $n>17$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A281467.
