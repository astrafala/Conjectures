...
\title{The empirical recurrence for OEIS A296124, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A296124 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A296124 is ``Number of n X 4 0..1 arrays with each 1 adjacent to 2 or 5 king-move neighboring 1s.''. It has offset $1$ and begins
\[
1, 13, 30, 74, 287, 841, 2463, 7953,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) + a(n-2) + 5*a(n-3) - 18*a(n-4) - 14*a(n-5) + 3*a(n-6) + a(n-7) + a(n-8) - a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 22 2019 15:52:06, revision 10) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + a(n-2) + 5\,a(n-3) - 18\,a(n-4) - 14\,a(n-5) + 3\,a(n-6) + a(n-7) + a(n-8) - a(n-9)
\end{equation}
for all $n>10$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A296124.
