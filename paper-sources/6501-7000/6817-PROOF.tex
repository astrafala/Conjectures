...
\title{The empirical recurrence for OEIS A207174, proved by transfer matrix}
...
\begin{abstract}
OEIS A207174 counts arrays over $\{0,\dots,1\}$ of width $6$ that avoid the patterns
$(0,0,1), (1,0,1)$ along one axis and $(0,0,0), (1,0,1)$ along the other, and carries an empirical recurrence of
...
OEIS A207174 is ``Number of 6 X n 0..1 arrays avoiding 0 0 0 and 1 0 1 horizontally and 0 0 1 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
12, 144, 396, 1989, 6513, 15789, 54208,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) + 21*a(n-3) + 5*a(n-4) + 5*a(n-5) - 75*a(n-6) - 50*a(n-7) + 125*a(n-9) for n>11.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 21 2018 05:26:43, revision
8) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 21\,a(n-3) + 5\,a(n-4) + 5\,a(n-5) - 75\,a(n-6) - 50\,a(n-7) + 125\,a(n-9)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207174.
