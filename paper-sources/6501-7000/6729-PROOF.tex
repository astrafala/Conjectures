...
\title{The empirical recurrence for OEIS A234905, proved by transfer matrix}
...
\begin{abstract}
OEIS A234905 counts $2$-column arrays over $\{0,\dots,7\}$ in which every
...
OEIS A234905 is ``Number of (n+1) X (1+1) 0..7 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 1, with no adjacent elements equal (constant-stress tilted 1 X 1 tilings).''. It has offset
$1$ and begins
\[
280, 1720, 10344, 65048, 395992, 2497560, 15235088,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 55*a(n-2) -725*a(n-4) +3663*a(n-6) -7525*a(n-8) +6335*a(n-10) -1805*a(n-12).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 20 2022 17:33:39, revision 7) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234905.
