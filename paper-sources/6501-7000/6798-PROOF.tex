...
\title{The empirical recurrence for OEIS A299888, proved by transfer matrix}
...
\begin{abstract}
OEIS A299888 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A299888 is ``Number of n X 3 0..1 arrays with every element equal to 0, 2, 3, 4, 5, 7 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 13, 31, 156, 614, 2800, 13379, 63697,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 22 2023 21:35:30, revision
6) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) + 2\,a(n-2) - 33\,a(n-3) - 40\,a(n-4) + 152\,a(n-5) + 18\,a(n-6) - 368\,a(n-7) + 310\,a(n-8) + 492\,a(n-9) - 362\,a(n-10) - 290\,a(n-11) - 8\,a(n-12) - 12\,a(n-13)
\end{equation}
for all $n>15$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A299888.
