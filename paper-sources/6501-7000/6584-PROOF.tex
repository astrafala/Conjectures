...
\title{The empirical recurrence for OEIS A251013, proved by transfer matrix}
...
\begin{abstract}
OEIS A251013 counts $(n+1)\times3$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A251013 is ``Number of (n+1)X(2+1) 0..2 arrays with no 2X2 subblock having the sum of its diagonal elements less than the maximum of its antidiagonal elements.''. It has offset $1$ and begins
\[
423, 6653, 105897, 1691169, 27018053, 431623476, 6895174650, 110149711356,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 12:59:13, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;27\,a(n-1) - 234\,a(n-2) + 1104\,a(n-3) - 3214\,a(n-4) + 5993\,a(n-5) - 7505\,a(n-6) + 6551\,a(n-7) - 3996\,a(n-8) + 1649\,a(n-9) - 385\,a(n-10) - 18\,a(n-11) + 47\,a(n-12) - 14\,a(n-13) + a(n-14)
\end{equation}
for all $n>13$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251013.
