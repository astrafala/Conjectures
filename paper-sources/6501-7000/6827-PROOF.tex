...
\title{The empirical recurrence for OEIS A281468, proved by transfer matrix}
...
\begin{abstract}
OEIS A281468 counts $n\times7$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A281468 is ``Number of nX7 0..1 arrays with no element equal to more than two of its horizontal, diagonal or antidiagonal neighbors and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
64, 361, 145, 260, 472, 924, 1887, 3681,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) +3*a(n-3) -4*a(n-4) -4*a(n-5) +a(n-7) +2*a(n-8) -a(n-9) +5*a(n-10) -3*a(n-12) for n>19
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 22 2017 07:25:40, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 3\,a(n-3) - 4\,a(n-4) - 4\,a(n-5) + a(n-7) + 2\,a(n-8) - a(n-9) + 5\,a(n-10) - 3\,a(n-12)
\]
for every $n>19$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A281468.
