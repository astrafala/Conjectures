...
\title{The empirical recurrence for OEIS A259510, proved by transfer matrix}
...
\begin{abstract}
OEIS A259510 counts arrays of width $4$ over $\{0,1\}$ subject to a condition read round the
...
count is a walk count on a finite digraph with $S=17$ vertices, and whether a linear
...
OEIS A259510 is ``Number of (n+1)X(3+1) 0..1 arrays with each 2X2 subblock having clockwise pattern 0000 0001 0101 0111.''. It has offset $1$ and begins
\[
87, 533, 3270, 20293, 126045, 784130, 4879059, 30366347,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:51:49, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) + 20\,a(n-2) - 68\,a(n-3) - 97\,a(n-4) + 234\,a(n-5) + 159\,a(n-6) - 238\,a(n-7) - 94\,a(n-8) + 56\,a(n-9) + 8\,a(n-10)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A259510.
