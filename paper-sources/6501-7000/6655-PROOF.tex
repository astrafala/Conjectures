...
\title{The empirical recurrence for OEIS A282857, proved by transfer matrix}
...
\begin{abstract}
OEIS A282857 counts $n\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A282857 is ``Number of nX3 0..1 arrays with no 1 equal to more than one of its horizontal, vertical and antidiagonal neighbors.''. It has offset $1$ and begins
\[
7, 31, 131, 583, 2562, 11250, 49471, 217459,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) +9*a(n-2) +20*a(n-3) +23*a(n-4) +15*a(n-5) +5*a(n-6) -3*a(n-7) -8*a(n-8) -2*a(n-9) +a(n-11)
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 23 2017 08:05:24, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 9\,a(n-2) + 20\,a(n-3) + 23\,a(n-4) + 15\,a(n-5) + 5\,a(n-6) - 3\,a(n-7) - 8\,a(n-8) - 2\,a(n-9) + a(n-11)
\]
for every $n>11$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A282857.
