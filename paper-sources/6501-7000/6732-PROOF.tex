...
\title{The empirical recurrence for OEIS A185462, proved by transfer matrix}
...
\begin{abstract}
OEIS A185462 counts arrays over $\{0,\dots,1\}$ under a condition on the determinant of every
...
a bounded window of consecutive rows, so the count is a walk count on $S=218$ states and is
...
OEIS A185462 is ``Number of (n+1)X5 binary arrays with no 2X2 subblock determinant equal to any horizontal or vertical neighbor 2X2 subblock determinant.''. It has offset $1$ and begins
\[
218, 672, 2766, 13977, 49670, 231636, 798330, 3709535,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n)=14*a(n-2)+27*a(n-4)+75*a(n-6)+77*a(n-8)+32*a(n-10)+a(n-12)-a(n-14) for n>20
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 02:59:30, revision 9) this is still
...
entry's first term is $218$, and the model reproduces it along with every later term; that
...
\begin{theorem}
\[
a(n)\;=\;14\,a(n-2) + 27\,a(n-4) + 75\,a(n-6) + 77\,a(n-8) + 32\,a(n-10) + a(n-12) - a(n-14)
\]
for every $n>20$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A185462.
