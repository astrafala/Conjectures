...
\title{The empirical recurrence for OEIS A303423, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A303423 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A303423 is ``Number of 4Xn 0..1 arrays with every element equal to 0, 1, 2, 3, 4 or 5 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
8, 128, 1988, 30897, 480953, 7486281, 116517744, 1813509273,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 14*a(n-1) +12*a(n-2) +175*a(n-3) +283*a(n-4) -235*a(n-5) -144*a(n-6) +67*a(n-7) -135*a(n-8) +50*a(n-9)
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 23 2018 10:56:33, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;14\,a(n-1) + 12\,a(n-2) + 175\,a(n-3) + 283\,a(n-4) - 235\,a(n-5) - 144\,a(n-6) + 67\,a(n-7) - 135\,a(n-8) + 50\,a(n-9)
\end{equation}
for all $n>10$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A303423.
