...
\title{The empirical recurrence for OEIS A188828, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A188828 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A188828 is ``Number of 6 X n binary arrays without the pattern 0 1 diagonally or antidiagonally.''. It has offset $1$ and begins
\[
64, 49, 169, 576, 2025, 7056, 24964, 87616,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 4*a(n-1) +9*a(n-2) -45*a(n-3) +108*a(n-5) -42*a(n-6) -57*a(n-7) +18*a(n-8) +7*a(n-9) -a(n-10) for n>11.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 30 2018 14:10:52, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) + 9\,a(n-2) - 45\,a(n-3) + 108\,a(n-5) - 42\,a(n-6) - 57\,a(n-7) + 18\,a(n-8) + 7\,a(n-9) - a(n-10)
\end{equation}
for all $n>11$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A188828.
