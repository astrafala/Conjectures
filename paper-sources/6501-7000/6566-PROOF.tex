...
\title{The empirical recurrence for OEIS A231941, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A231941 counts arrays over $\{0,\dots,3\}$ in which every cell is constrained by the
...
OEIS A231941 is ``Number of 2 X n 0..3 arrays with no element less than a strict majority of its horizontal, diagonal and antidiagonal neighbors.''. It has offset $1$ and begins
\[
16, 84, 668, 5070, 42104, 326010, 2511252, 19430715,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 26 2023 23:44:51, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;16\,a(n-1) - 86\,a(n-2) + 190\,a(n-3) + 319\,a(n-4) - 4988\,a(n-5) + 10423\,a(n-6) + 3869\,a(n-7) - 14328\,a(n-8) + 132748\,a(n-9) - 44748\,a(n-10) - 130980\,a(n-11) - 63336\,a(n-12) - 493560\,a(n-13) - 373248\,a(n-14) - 51840\,a(n-15)
\end{equation}
for all $n>16$.
...
$4$ values, so there are about $10^{22}$ of them to sift. The
...
the middle column. The vector $w$ was formed by $15$ applications of $G$ in exact integer
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231941.
