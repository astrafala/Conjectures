...
\title{The empirical recurrence for OEIS A296720, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A296720 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A296720 is ``Number of n X 3 0..1 arrays with each 1 adjacent to 0, 2 or 4 king-move neighboring 1s.''. It has offset $1$ and begins
\[
5, 21, 69, 258, 963, 3493, 12860, 47305,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) + 3*a(n-2) + 4*a(n-3) - 19*a(n-4) - 14*a(n-5) + 9*a(n-6) + 14*a(n-7) + 6*a(n-8) - 3*a(n-9) - 2*a(n-10).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 24 2019 11:03:54, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 3\,a(n-2) + 4\,a(n-3) - 19\,a(n-4) - 14\,a(n-5) + 9\,a(n-6) + 14\,a(n-7) + 6\,a(n-8) - 3\,a(n-9) - 2\,a(n-10)
\end{equation}
for all $n>11$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A296720.
