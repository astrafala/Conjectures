...
\title{The empirical recurrence for OEIS A231538, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A231538 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A231538 is ``Number of n X 2 0..1 arrays with no element less than a strict majority of its horizontal, vertical and antidiagonal neighbors.''. It has offset $1$ and begins
\[
2, 6, 20, 57, 164, 485, 1424, 4169,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 4*a(n-1) - 4*a(n-2) + 5*a(n-3) - 8*a(n-4) + 3*a(n-5) - 2*a(n-6) + a(n-7) - a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 30 2018 02:44:49, revision 11) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) - 4\,a(n-2) + 5\,a(n-3) - 8\,a(n-4) + 3\,a(n-5) - 2\,a(n-6) + a(n-7) - a(n-8)
\end{equation}
for all $n>9$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231538.
