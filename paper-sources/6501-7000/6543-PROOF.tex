...
\title{The empirical recurrence for OEIS A250988, proved by transfer matrix}
...
\begin{abstract}
OEIS A250988 counts arrays over $\{0,1,2\}$ in which a statistic taken over short runs
...
OEIS A250988 is ``Number of (n+1)X(2+1) 0..2 arrays with nondecreasing min(x(i,j),x(i,j-1)) in the i direction and nondecreasing absolute value of x(i,j)-x(i-1,j) in the j direction.''. It has offset $1$ and begins
\[
169, 872, 4111, 18387, 80133, 344135, 1466191, 6219851,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 12:56:54, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;14\,a(n-1) - 73\,a(n-2) + 156\,a(n-3) - 13\,a(n-4) - 480\,a(n-5) + 581\,a(n-6) + 212\,a(n-7) - 654\,a(n-8) + 78\,a(n-9) + 264\,a(n-10) - 44\,a(n-11) - 40\,a(n-12)
\]
for every $n>11$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250988.
