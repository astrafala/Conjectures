...
\title{The empirical recurrence for OEIS A203348, proved by transfer matrix}
...
\begin{abstract}
OEIS A203348 counts arrays of width $3$ over $\{0,1\}$ containing no occurrence of certain short
...
OEIS A203348 is ``Number of (n+2)X3 binary arrays avoiding patterns 010 and 101 in rows, columns and nw-to-se diagonals.''. It has offset $1$ and begins
\[
80, 244, 702, 2062, 6032, 17614, 51482, 150462,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) +a(n-2) -3*a(n-3) -a(n-4) -2*a(n-5) -a(n-6) +2*a(n-7) +a(n-8) +a(n-9) -2*a(n-11) -a(n-12)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 10:21:41, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + a(n-2) - 3\,a(n-3) - a(n-4) - 2\,a(n-5) - a(n-6) + 2\,a(n-7) + a(n-8) + a(n-9) - 2\,a(n-11) - a(n-12)
\]
for every $n>12$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A203348.
