...
\title{The empirical recurrence for OEIS A260974, proved by transfer matrix}
...
\begin{abstract}
OEIS A260974 counts $(n+2)\times4$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A260974 is ``Number of (n+2)X(2+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000001 00001001 or 00100101.''. It has offset $1$ and begins
\[
91, 133, 239, 481, 925, 1873, 3683, 7321,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-2) +2*a(n-3) +a(n-4) +2*a(n-5) +6*a(n-6) +5*a(n-7) -3*a(n-8) -9*a(n-9) -8*a(n-10) -5*a(n-11) for n>14
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 12:13:08, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-2) + 2\,a(n-3) + a(n-4) + 2\,a(n-5) + 6\,a(n-6) + 5\,a(n-7) - 3\,a(n-8) - 9\,a(n-9) - 8\,a(n-10) - 5\,a(n-11)
\]
for every $n>14$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A260974.
