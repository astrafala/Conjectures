...
\title{The empirical recurrence for OEIS A283686, proved by transfer matrix}
...
\begin{abstract}
OEIS A283686 counts $n\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
walk, and $a(n)$ is a walk count on $S=57$ vertices, which is $C$-finite. Whether the
...
OEIS A283686 is ``Number of nX3 0..1 arrays with no 1 equal to more than two of its horizontal, diagonal and antidiagonal neighbors.''. It has offset $1$ and begins
\[
8, 49, 264, 1525, 8732, 49924, 285770, 1635402,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 5*a(n-1) +2*a(n-2) +14*a(n-3) -9*a(n-4) +2*a(n-5) -45*a(n-6) -20*a(n-7) -6*a(n-8) +24*a(n-9) +40*a(n-10)
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 14 2017 16:12:12, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) + 2\,a(n-2) + 14\,a(n-3) - 9\,a(n-4) + 2\,a(n-5) - 45\,a(n-6) - 20\,a(n-7) - 6\,a(n-8) + 24\,a(n-9) + 40\,a(n-10)
\]
for every $n>10$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A283686.
