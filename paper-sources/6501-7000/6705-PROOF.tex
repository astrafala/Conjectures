...
\title{The empirical recurrence for OEIS A295980, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A295980 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A295980 is ``Number of n X 3 0..1 arrays with each 1 adjacent to 2 or 3 king-move neighboring 1s.''. It has offset $1$ and begins
\[
1, 15, 44, 110, 581, 2354, 8452, 35474,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 4*a(n-1) - 2*a(n-2) + 21*a(n-3) - 44*a(n-4) - 12*a(n-5) - 34*a(n-6) + 33*a(n-7) + 4*a(n-8) + 14*a(n-9) + a(n-10).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 22 2019 11:22:45, revision 7) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) - 2\,a(n-2) + 21\,a(n-3) - 44\,a(n-4) - 12\,a(n-5) - 34\,a(n-6) + 33\,a(n-7) + 4\,a(n-8) + 14\,a(n-9) + a(n-10)
\end{equation}
for all $n>11$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A295980.
