...
\title{The empirical recurrence for OEIS A318063, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A318063 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A318063 is ``Number of nX3 0..1 arrays with every element unequal to 1, 2, 3 or 4 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
1, 18, 98, 649, 4003, 25106, 156846, 980960,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 5*a(n-1) +9*a(n-2) -7*a(n-3) -3*a(n-4) +8*a(n-5) -2*a(n-6) -9*a(n-7) -2*a(n-8) -a(n-9) +2*a(n-11) for n>12
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 15 2018 13:09:50, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) + 9\,a(n-2) - 7\,a(n-3) - 3\,a(n-4) + 8\,a(n-5) - 2\,a(n-6) - 9\,a(n-7) - 2\,a(n-8) - a(n-9) + 2\,a(n-11)
\end{equation}
for all $n>12$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A318063.
