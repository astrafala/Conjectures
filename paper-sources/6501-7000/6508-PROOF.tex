...
\title{The empirical recurrence for OEIS A252546, proved by transfer matrix}
...
\begin{abstract}
OEIS A252546 counts $4\times(n+2)$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252546 is ``Number of (2+2)X(n+2) 0..3 arrays with every 3X3 subblock row and diagonal sum equal to 1 3 4 6 or 7 and every 3X3 column and antidiagonal sum not equal to 1 3 4 6 or 7.''. It has offset $1$ and begins
\[
850, 3880, 15480, 43848, 213120, 881848, 2568432, 12681664,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 118*a(n-3) -4264*a(n-6) +55168*a(n-9) -225280*a(n-12) +262144*a(n-15) for n>16
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:20:41, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252546.
