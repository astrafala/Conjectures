...
\title{The empirical recurrence for OEIS A297811, proved by transfer matrix}
...
\begin{abstract}
OEIS A297811 counts $5$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A297811 is ``Number of nX5 0..1 arrays with every element equal to 2 or 3 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
0, 8, 0, 13, 24, 41, 39, 109,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) +a(n-2) -2*a(n-3) +4*a(n-4) -4*a(n-5) -8*a(n-6) -a(n-7) +5*a(n-8) +a(n-9) +4*a(n-10) +a(n-11) -3*a(n-12) for n>21
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 06 2018 10:27:48, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + a(n-2) - 2\,a(n-3) + 4\,a(n-4) - 4\,a(n-5) - 8\,a(n-6) - a(n-7) + 5\,a(n-8) + a(n-9) + 4\,a(n-10) + a(n-11) - 3\,a(n-12)
\end{equation}
for all $n>21$.
...
compared against the entry's DATA at every one of the $33$ published indices; they
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297811.
