...
\title{The empirical recurrence for OEIS A300346, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A300346 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A300346 is ``Number of nX4 0..1 arrays with every element equal to 1 or 2 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
2, 15, 26, 58, 152, 325, 729, 1609,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 5*a(n-1) -8*a(n-2) +4*a(n-3) +a(n-5) -3*a(n-6) +4*a(n-7) -2*a(n-8) +a(n-9) -a(n-10) -a(n-12) +a(n-13) for n>16
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 03 2018 08:29:56, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) - 8\,a(n-2) + 4\,a(n-3) + a(n-5) - 3\,a(n-6) + 4\,a(n-7) - 2\,a(n-8) + a(n-9) - a(n-10) - a(n-12) + a(n-13)
\end{equation}
for all $n>16$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A300346.
