...
\title{The empirical recurrence for OEIS A297689, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297689 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A297689 is ``Number of nX3 0..1 arrays with every 1 horizontally, diagonally or antidiagonally adjacent to 0, 2 or 4 neighboring 1s.''. It has offset $1$ and begins
\[
5, 26, 95, 415, 1801, 7526, 32173, 137242,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 5*a(n-1) -2*a(n-2) +6*a(n-3) -52*a(n-4) +23*a(n-5) -3*a(n-6) +21*a(n-7) -9*a(n-8)
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 03 2018 12:23:27, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) - 2\,a(n-2) + 6\,a(n-3) - 52\,a(n-4) + 23\,a(n-5) - 3\,a(n-6) + 21\,a(n-7) - 9\,a(n-8)
\end{equation}
for all $n>9$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297689.
