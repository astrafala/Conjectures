...
\title{The empirical recurrence for OEIS A185765, proved by transfer matrix}
...
\begin{abstract}
OEIS A185765 counts arrays over $\{0,\dots,1\}$ under a condition on the trace of every
...
a bounded window of consecutive rows, so the count is a walk count on $S=680$ states and is
...
OEIS A185765 is ``Number of (n+1)X6 binary arrays with no 2X2 subblock trace equal to any horizontal or vertical neighbor 2X2 subblock trace.''. It has offset $1$ and begins
\[
680, 3456, 19992, 118248, 725352, 4430912, 27172072, 166155112,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n)=a(n-1)+30*a(n-2)+24*a(n-3)-95*a(n-4)-15*a(n-5)+64*a(n-6)-116*a(n-7)+16*a(n-8)+16*a(n-9) for n>12
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 03:09:39, revision 9) this is still
...
entry's first term is $680$, and the model reproduces it along with every later term; that
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 30\,a(n-2) + 24\,a(n-3) - 95\,a(n-4) - 15\,a(n-5) + 64\,a(n-6) - 116\,a(n-7) + 16\,a(n-8) + 16\,a(n-9)
\]
for every $n>12$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A185765.
