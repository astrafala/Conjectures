...
\title{The empirical recurrence for OEIS A302410, proved by transfer matrix}
...
\begin{abstract}
OEIS A302410 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A302410 is ``Number of nX3 0..1 arrays with every element equal to 0, 1, 2 or 5 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
4, 17, 30, 120, 441, 1431, 4754, 16423,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 07 2018 16:57:37, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 2\,a(n-2) + 11\,a(n-3) + a(n-4) - 18\,a(n-5) - 14\,a(n-6) - 24\,a(n-7) + 52\,a(n-8) - 4\,a(n-9) + 8\,a(n-10) - 24\,a(n-11) + 24\,a(n-12) - 32\,a(n-13)
\end{equation}
for all $n>13$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302410.
