...
\title{The empirical recurrence for OEIS A300641, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A300641 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A300641 is ``Number of nX3 0..1 arrays with every element equal to 2, 3, 4 or 5 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
0, 2, 2, 10, 30, 104, 340, 1144,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 10 2018 10:36:56, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 4\,a(n-2) - a(n-3) + 7\,a(n-4) + 6\,a(n-5) - 2\,a(n-6) - 7\,a(n-7) - 11\,a(n-8) - 12\,a(n-9) - 8\,a(n-10) - 9\,a(n-11) - 3\,a(n-12) - 2\,a(n-14) + a(n-15)
\end{equation}
for all $n>16$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A300641.
