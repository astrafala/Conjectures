...
\title{The empirical recurrence for OEIS A304297, proved by transfer matrix}
...
\begin{abstract}
OEIS A304297 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A304297 is ``Number of nX3 0..1 arrays with every element unequal to 1, 2, 5 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 2, 3, 5, 6, 14, 22, 33,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-2) +3*a(n-3) +2*a(n-4) -4*a(n-6) -2*a(n-7) -a(n-8) -2*a(n-9)
\end{quote}
As of the ``Last modified'' line on the live entry (May 10 2018 08:59:27, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-2) + 3\,a(n-3) + 2\,a(n-4) - 4\,a(n-6) - 2\,a(n-7) - a(n-8) - 2\,a(n-9)
\end{equation}
for all $n>9$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A304297.
