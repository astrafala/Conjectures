...
\title{The empirical recurrence for OEIS A223444, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A223444 counts arrays over $\{0,\dots,14\}$ in which every cell is constrained by the
values of its neighbours, and carries an empirical recurrence of order $10$ contributed
...
\{x_{t,u},x_{t+d_1,u+d_2}\}\in E\ \text{ for every offset in }\mathcal N,\quad E=\{\{0,1\},\{0,2\},\{1,3\},\{1,4\},\{2,9\},\{2,10\},\{3,5\},\{3,6\},\{4,7\},\{4,8\},\{9,11\},\{9,12\},\{10,13\},\{10,14\}\}
\end{equation}
for every cell $(t,u)$.
...
$15$ values, so there are about $10^{67}$ of them to sift. The
...
\begin{proof}
Substitute Lemma~\ref{lem:walk} and factor $G^{j-10}$ out of
...
the middle row. The vector $w$ was formed by $10$ applications of $G$ in exact integer
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223444.
