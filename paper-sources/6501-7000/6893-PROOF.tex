...
\title{The empirical recurrence for OEIS A283635, proved by transfer matrix}
...
\begin{abstract}
OEIS A283635 counts $2\times n$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
walk, and $a(n)$ is a walk count on $S=45$ vertices, which is $C$-finite. Whether the
...
OEIS A283635 is ``Number of 2 X n 0..1 arrays with no 1 equal to more than one of its horizontal, diagonal and antidiagonal neighbors, with the exception of exactly two elements.''. It has offset $1$ and begins
\[
0, 0, 0, 36, 88, 516, 2076, 7372,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) + 6*a(n-2) - 5*a(n-3) - 42*a(n-4) - 33*a(n-5) + 51*a(n-6) + 156*a(n-7) + 144*a(n-8) + 64*a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 21 2019 09:49:15, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A283635.
