...
\title{A proof of the conjectured recurrence for OEIS A103821}
...
\begin{abstract}
OEIS A103821 carries a conjectured linear recurrence with polynomial coefficients, of
...
OEIS A103821 is ``A Whitney transform of the central binomial coefficients A000984''. It has offset $0$ and begins
\[
a(0),\dots,a(7)\;=\;1, 3, 11, 43, 179, 771, 3395, 15171,\ \dots
\]
The entry gives the generating function
\begin{equation}\label{eq:gf}
A(x)\;=\;\sum_{n\ge 0} a(n)\,x^{n}\;=\;- \frac{1}{\left(x - 1\right) \sqrt{- 4 x^{2} - 4 x + 1}} ,
\end{equation}
and it carries the following comment:
\begin{quote}\small
\textbf{Conjecture:} n*a(n) + (2-5*n)*a(n-1) + 2*a(n-2) + 4*(n-1)*a(n-3) = 0. - \emph{R. J. Mathar}, Dec 14 2011
\end{quote}
As of the ``Last modified'' line on the live entry (2025-10-03, revision 15) the
...
\[
p_{0}(n)=n,\qquad p_{1}(n)=2 - 5 n,\qquad p_{2}(n)=2,\qquad p_{3}(n)=4 \left(n - 1\right)
\]
...
\section{The computation for A103821}
...
\[
n\,a(n) + (2 - 5 n)\,a(n-1) + 2\,a(n-2) + 4 \left(n - 1\right)\,a(n-3) \;=\;0
\]
holds for every $n>-1$.
\end{theorem}
...
section of A103821, agreeing on all 13 terms compared.
...
\url{https://oeis.org}, 2026. Sequence A103821.
