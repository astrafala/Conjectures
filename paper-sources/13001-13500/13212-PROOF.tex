...
\title{A proof of the conjectured recurrence for OEIS A081670}
...
\begin{abstract}
OEIS A081670 carries a conjectured linear recurrence with polynomial coefficients, of
...
OEIS A081670 is ``a(n) = 3\textasciicircum{}n-1+C(2n,n)''. It has offset $0$ and begins
\[
a(0),\dots,a(7)\;=\;1, 4, 14, 46, 150, 494, 1652, 5618,\ \dots
\]
The name is itself the definition of the sequence:
\begin{quote}\small
a(n) = 3\textasciicircum{}n-1+C(2n,n).
\end{quote}
that is,
\begin{equation}\label{eq:cf}
a(n)\;=\;3^{n} + {\binom{2 n}{n}} - 1 .
\end{equation}
...
\begin{quote}\small
\textbf{Conjecture:} n*(3*n\textasciicircum{}2-17*n+26)*a(n) +2*(-12*n\textasciicircum{}3+71*n\textasciicircum{}2-131*n+60)*a(n-1) +(57*n\textasciicircum{}3-347*n\textasciicircum{}2+710*n-480)*a(n-2) -6*(2*n-5)*(3*n\textasciicircum{}2-11*n+12)*a(n-3) = 0. - \emph{R. J. Mathar}, Nov 12 2012
\end{quote}
As of the ``Last modified'' line on the live entry (2025-02-20, revision 10) the
...
n \left(3 n^{2} - 17 n + 26\right)\,a(n) -  2 \left(12 n^{3} - 71 n^{2} + 131 n - 60\right)\,a(n-1) + (57 n^{3} - 347 n^{2} + 710 n - 480)\,a(n-2) -  6 \left(2 n - 5\right) \left(3 n^{2} - 11 n + 12\right)\,a(n-3)
\end{equation}
...
entry \href{https://oeis.org/A081670}{A081670}, 2025-02-20.
