...
\title{A proof of the conjectured recurrence for OEIS A052204}
...
\begin{abstract}
OEIS A052204 carries a conjectured linear recurrence with polynomial coefficients, of
...
OEIS A052204 is ``a(n) = (5n+1)*C(4n,n)/(3n+1)''. It has offset $0$ and begins
\[
a(0),\dots,a(7)\;=\;1, 6, 44, 352, 2940, 25194, 219604, 1937520,\ \dots
\]
...
a(n)\;=\;\frac{\left(5 n + 1\right) {\binom{4 n}{n}}}{3 n + 1} .
\end{equation}
...
\begin{quote}\small
\textbf{Conjecture:} 6*n*(3*n-1)*(3*n+1)*a(n) + (-809*n\textasciicircum{}3 + 1444*n\textasciicircum{}2 - 1505*n + 582)*a(n-1) + 88*(4*n-5)*(4*n-7)*(2*n-3)*a(n-2) = 0. - \emph{R. J. Mathar}, Sep 29 2012
\end{quote}
As of the ``Last modified'' line on the live entry (2025-07-02, revision 21) the
...
6 n \left(3 n - 1\right) \left(3 n + 1\right)\,a(n) + (- 809 n^{3} + 1444 n^{2} - 1505 n + 582)\,a(n-1) + 88 \left(2 n - 3\right) \left(4 n - 7\right) \left(4 n - 5\right)\,a(n-2)
\end{equation}
...
entry \href{https://oeis.org/A052204}{A052204}, 2025-07-02.
