...
\title{The empirical recurrence for OEIS A302167, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A302167 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
values of its neighbours, and carries an empirical recurrence of order $36$ contributed
...
OEIS A302167 is ``Number of 5Xn 0..1 arrays with every element equal to 0, 1 or 3 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
16, 21, 31, 73, 140, 296, 603, 1288,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 02 2018 14:52:14, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 2\,a(n-2) - a(n-3) + 14\,a(n-4) - 10\,a(n-5) - 23\,a(n-6) + 5\,a(n-7) - 71\,a(n-8) + 44\,a(n-9) + 102\,a(n-10) - 14\,a(n-11) + 176\,a(n-12) - 115\,a(n-13) - 236\,a(n-14) + 43\,a(n-15) - 217\,a(n-16) + 199\,a(n-17) + 322\,a(n-18) - 95\,a(n-19) + 74\,a(n-20) - 223\,a(n-21) - 283\,a(n-22) + 111\,a(n-23) + 131\,a(n-24) + 140\,a(n-25) + 177\,a(n-26) - 75\,a(n-27) - 164\,a(n-28) - 39\,a(n-29) - 78\,a(n-30) + 40\,a(n-31) + 64\,a(n-32) + 6\,a(n-33) + 16\,a(n-34) - 12\,a(n-35) - 8\,a(n-36)
\end{equation}
for all $n>40$.
...
\#\{\text{neighbours with a value }equal to\ x_{t,u}\}\in\{0,1,3\}
\end{equation}
...
publishes, $n=29$, the arrays have $5\cdot29$ cells over
$2$ values, so there are about $10^{43}$ of them to sift. The
...
$o=1n_0+0-2$. Then for $j\ge36$,
\[
a(n_0+j)-\sum_i c_i\,a(n_0+j-i)\;=\;\,\mathbf{v}^{\!\top}G^{\,j-36}w,
\qquad w=h_{36}-\sum_i c_i\,h_{36-i} .
\]
...
\begin{proof}
Substitute Lemma~\ref{lem:walk} and factor $G^{j-36}$ out of
...
the middle column. The vector $w$ was formed by $36$ applications of $G$ in exact integer
arithmetic and $\mathbf{v}^{\!\top}G^{m}w$ evaluated for $m=0,1,\dots$, again exactly.
Every one of those integers vanishes from the index corresponding to $n=40+1$ onwards,
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302167.
