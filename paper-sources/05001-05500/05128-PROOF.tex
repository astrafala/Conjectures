...
\title{The empirical recurrence for OEIS A252416, proved by transfer matrix}
...
\begin{abstract}
OEIS A252416 counts $(n+2)\times3$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252416 is ``Number of (n+2)X(1+2) 0..3 arrays with every 3X3 subblock row and column sum not equal to 0 2 5 6 or 7 and every 3X3 diagonal and antidiagonal sum equal to 0 2 5 6 or 7.''. It has offset $1$ and begins
\[
830, 1006, 1099, 1536, 2380, 3719, 5725, 9410,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:12:27, revision 6) this is still
...
\[
\text{every row, column sum} \notin \{0,2,5,6,7\}\ \text{ and }\ \text{every diagonal, antidiagonal sum} \in \{0,2,5,6,7\}
\]
...
\begin{theorem}
\[
a(n)\;=\;-a(n-1) - a(n-2) + 15\,a(n-3) + 15\,a(n-4) + 15\,a(n-5) - 87\,a(n-6) - 86\,a(n-7) - 83\,a(n-8) + 256\,a(n-9) + 243\,a(n-10) + 212\,a(n-11) - 455\,a(n-12) - 388\,a(n-13) - 273\,a(n-14) + 622\,a(n-15) + 437\,a(n-16) + 231\,a(n-17) - 769\,a(n-18) - 437\,a(n-19) - 200\,a(n-20) + 840\,a(n-21) + 360\,a(n-22) + 93\,a(n-23) - 826\,a(n-24) - 210\,a(n-25) + 81\,a(n-26) + 707\,a(n-27) + 74\,a(n-28) - 162\,a(n-29) - 496\,a(n-30) + 3\,a(n-31) + 162\,a(n-32) + 314\,a(n-33) - 27\,a(n-34) - 134\,a(n-35) - 166\,a(n-36) + 35\,a(n-37) + 92\,a(n-38) + 54\,a(n-39) - 22\,a(n-40) - 39\,a(n-41) - 8\,a(n-42) + 4\,a(n-43) + 6\,a(n-44)
\]
for every $n>49$.
\end{theorem}
...
exactly. Those integers vanish from the index corresponding to $n=49+1$ onwards, and the
run was continued until the working vector was identically zero, which settles all larger $j$
at once. By Lemma~\ref{lem:crit} the recurrence holds for every $n>49$.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252416.
