...
\title{The empirical recurrence for OEIS A238293, proved by transfer matrix}
...
\begin{abstract}
OEIS A238293 counts arrays over $\{0,\dots,3\}$ subject to a condition on the order
...
OEIS A238293 is ``Number of (n+1) X (1+1) 0..3 arrays with the maximum plus the upper median minus the lower median of every 2 X 2 subblock differing from its horizontal and vertical neighbors by exactly one.''. It has offset $1$ and begins
\[
256, 1836, 13405, 99036, 730412, 5365422, 39447709, 290457856,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 01 2021 18:03:20, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;2164\,a(n-4) + 42300\,a(n-6) + 6272\,a(n-8) - 2398088\,a(n-10) - 2032176\,a(n-12) + 45261648\,a(n-14) + 13403744\,a(n-16) - 307030624\,a(n-18) + 71723392\,a(n-20) + 530758336\,a(n-22) - 23717632\,a(n-24) + 45493248\,a(n-26) + 5124096\,a(n-28) - 18071552\,a(n-30) + 458752\,a(n-32)
\]
for every $n>33$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A238293.
