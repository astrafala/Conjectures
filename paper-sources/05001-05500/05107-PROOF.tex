...
\title{The empirical recurrence for OEIS A233253, proved by transfer matrix}
...
\begin{abstract}
OEIS A233253 counts arrays over $\{0,\dots,5\}$ in which no two entries that are neighbours in
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A233253.
