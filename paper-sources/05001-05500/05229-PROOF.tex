...
\title{The empirical recurrence for OEIS A275267, proved by transfer matrix}
...
\begin{abstract}
OEIS A275267 counts arrays in which no entry may equal the entries at a short list of fixed offsets
...
$1$ consecutive columns, $S=39$ states in all.
\end{abstract}
...
OEIS A275267 is ``Number of 3 X n 0..2 arrays with no element equal to any value at offset (-2,-1) (-2,1) or (-1,-1) and new values introduced in order 0..2.''. It has offset $1$ and begins
\[
5, 24, 128, 688, 3728, 20224, 109760, 595744,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 6*a(n-1) - 2*a(n-2) - 6*a(n-3) for n>4.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 02 2019 11:40:50, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A275267.
