...
\title{The empirical recurrence for OEIS A280411, proved from an exact model}
...
\begin{abstract}
OEIS A280411 carries an empirical recurrence of order $4$ contributed by Colin Barker. It is true, and it is
...
OEIS A280411 is ``Binary representation of the x-axis, from the origin to the right edge, of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 261", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 1, 100, 111, 10000, 11111, 1000000, 1111111,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 03 2017: (Start) a(n) = 101*a(n-2) - 100*a(n-4) for n>3.
\end{quote}
...
neighbourhood to a live cell flips the ENTIRE plane, and rule 261 is read
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A280411.
