...
\title{A condition on each element and its neighbours: OEIS A296324}
...
\begin{abstract}
OEIS A296324 carries an empirical recurrence of order $40$ contributed by R.~H.~Hardin. It is
...
OEIS A296324 is ``Number of n X 5 0..1 arrays with each 1 horizontally, vertically or antidiagonally adjacent to 2 neighboring 1's.''. It has offset $1$ and begins
\[
1, 15, 54, 185, 853, 3569, 14691, 62193,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 05 2022 20:23:32, revision 6) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{The count is a walk count}

The entry counts arrays with $5$ columns over the alphabet $\{0,1\}$, growing one row at a time. Its condition is that every entry equal to $1$ must have exactly $2$ of its horizontal and vertical and antidiagonal neighbours equal to $1$.
...
Vertices with identical futures are merged, which leaves $S=56$. An admissible array is exactly a walk, so with $M$ the adjacency matrix and $\iota,\tau$ the vectors recording which states may begin and end an array,
\[
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) - 15\,a(n-2) + 51\,a(n-3) - 121\,a(n-4) + 266\,a(n-5) - 598\,a(n-6) + 1026\,a(n-7) - 1958\,a(n-8) + 2883\,a(n-9) - 4421\,a(n-10) + 5480\,a(n-11) - 5762\,a(n-12) + 4485\,a(n-13) - 1246\,a(n-14) - 1423\,a(n-15) + 3587\,a(n-16) - 2563\,a(n-17) + 1429\,a(n-18) + 788\,a(n-19) - 1333\,a(n-20) + 2661\,a(n-21) - 3283\,a(n-22) + 2331\,a(n-23) + 1215\,a(n-24) - 4008\,a(n-25) + 2878\,a(n-26) + 724\,a(n-27) - 2739\,a(n-28) + 1555\,a(n-29) + 468\,a(n-30) - 1080\,a(n-31) + 418\,a(n-32) + 204\,a(n-33) - 249\,a(n-34) + 54\,a(n-35) + 44\,a(n-36) - 29\,a(n-37) + a(n-38) + 4\,a(n-39) - a(n-40)
\]
for every $n>40$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A296324.
