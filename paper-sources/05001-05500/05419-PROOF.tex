...
\title{The empirical column recurrences for the table OEIS A259515}
...
\begin{abstract}
OEIS A259515 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A259515 is ``T(n,k)=Number of (n+1)X(k+1) 0..1 arrays with each 2X2 subblock having clockwise pattern 0000 0001 0101 0111.''. It has offset $1$, is
read by antidiagonals, and begins
\[
11, 31, 31, 87, 129, 87, 245, 533,\ \dots
\]
...
k=6: [order 56]\\
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:52:24, revision 6) these are still
...
The sequence is ``Number of (n+1)X2 0..1 arrays with each 2X2 subblock having clockwise pattern 0000 0001 0101 0111.''. Its rows are the vertices of a digraph on
...
The sequence is ``Number of (n+1)X3 0..1 arrays with each 2X2 subblock having clockwise pattern 0000 0001 0101 0111.''. Its rows are the vertices of a digraph on
...
model reproduces $17$ published values, $63$ decimal digits in all, every one of
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A259515.
