...
\title{The empirical closed form for OEIS A224135, proved}
...
\begin{abstract}
OEIS A224135 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A224135 is ``Number of 4 X n 0..1 arrays with rows nondecreasing and antidiagonals unimodal.''. It has offset $1$ and begins
\[
16, 81, 208, 419, 760, 1279, 2032, 3083,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (1/3)*n\^{}4 + 2*n\^{}3 + (26/3)*n\^{}2 + 18*n - 5 for n>2.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 27 2018 06:19:26, revision 9) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{n^{4}}{3} + 2 n^{3} + \frac{26 n^{2}}{3} + 18 n - 5.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224135.
