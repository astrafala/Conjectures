...
\title{The empirical recurrence for OEIS A209550, proved by transfer matrix}
...
\begin{abstract}
OEIS A209550 counts $(n+1)\times6$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A209550 is ``1/4 the number of (n+1)X6 0..3 arrays with every 2X2 subblock having exactly two distinct clockwise edge differences.''. It has offset $1$ and begins
\[
603, 16582, 425803, 11226644, 294738262, 7751834609, 203828058161, 5360172454106,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 15:20:47, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;52\,a(n-1) - 856\,a(n-2) + 4014\,a(n-3) + 34244\,a(n-4) - 455004\,a(n-5) + 1232892\,a(n-6) + 6401520\,a(n-7) - 47507560\,a(n-8) + 64609279\,a(n-9) + 283015278\,a(n-10) - 991731422\,a(n-11) - 25138511\,a(n-12) + 4334710815\,a(n-13) - 4388934859\,a(n-14) - 8391654500\,a(n-15) + 15874524375\,a(n-16) + 6183586137\,a(n-17) - 26768058473\,a(n-18) + 3068141187\,a(n-19) + 25533122171\,a(n-20) - 9123208293\,a(n-21) - 14680808558\,a(n-22) + 7130958556\,a(n-23) + 5229264986\,a(n-24) - 2809641978\,a(n-25) - 1165852380\,a(n-26) + 598144917\,a(n-27) + 161163696\,a(n-28) - 66836588\,a(n-29) - 13174080\,a(n-30) + 3588829\,a(n-31) + 586993\,a(n-32) - 75654\,a(n-33) - 11622\,a(n-34) + 320\,a(n-35) + 76\,a(n-36) + 2\,a(n-37)
\end{equation}
for all $n>37$.
...
\[
a(n)-\sum_i c_i\,a(n-i)\;=\;\tfrac1{4}\mathbf{1}^{\!\top}M^{\,n+1-1-37}\,q(M)\,\mathbf{1} .
\]
...
=\tfrac1{4}\mathbf{1}^{\!\top}M^{\,m-37}\,q(M)\,\mathbf{1}
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209550.
