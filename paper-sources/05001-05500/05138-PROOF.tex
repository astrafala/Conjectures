...
\title{The empirical column recurrences for the table OEIS A264490}
...
\begin{abstract}
OEIS A264490 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A264490 is ``T(n,k)=Number of (n+1)X(k+1) arrays of permutations of 0..(n+1)*(k+1)-1 with each element having directed index change 2,-1 1,0 2,1 0,-1 -2,-2 or -1,0.''. It has offset $1$, is
read by antidiagonals, and begins
\[
1, 1, 3, 1, 1, 4, 1, 10,\ \dots
\]
...
k=2: [order 36]\\
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 14 2015 16:51:10, revision 6) these are still
...
\subsection*{Row $n$$=1$}
The sequence is ``Number of (2)X(n+1) arrays of permutations of 0..(2)*(n+1)-1 with each element having directed index change 2,-1 1,0 2,1 0,-1 -2,-2 or -1,0.''. Its rows are the vertices of a digraph on
...
model reproduces $10$ published values, $10$ decimal digits in all, every one of
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264490.
