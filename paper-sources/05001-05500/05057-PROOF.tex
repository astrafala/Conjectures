...
\title{The empirical recurrence for OEIS A253931, proved by transfer matrix}
...
\begin{abstract}
OEIS A253931 counts the arrays over $\{0,\dots,1\}$ whose $3\times3$ subblocks carry a
...
OEIS A253931 is ``Number of (n+2)X(4+2) 0..1 arrays with every 3X3 subblock diagonal sum plus antidiagonal sum nondecreasing horizontally and vertically.''. It has offset $1$ and begins
\[
28540, 109666, 451721, 1664470, 3152822, 6795110, 13179071, 20815359,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 14:20:40, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253931.
