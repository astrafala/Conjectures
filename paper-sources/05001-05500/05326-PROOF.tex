...
\title{The empirical recurrence for OEIS A259000, proved by transfer matrix}
...
\begin{abstract}
OEIS A259000 counts the arrays over $\{0,\dots,1\}$ whose $3\times3$ subblocks carry a
...
OEIS A259000 is ``Number of (n+2)X(2+2) 0..1 arrays with every 3X3 subblock sum of the two medians of the central row and column plus the two sums of the diagonal and antidiagonal nondecreasing horizontally, vertically and ne-to-sw antidiagonally.''. It has offset $1$ and begins
\[
2444, 6271, 21073, 59549, 130296, 263417, 459014, 746902,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 15:33:47, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A259000.
