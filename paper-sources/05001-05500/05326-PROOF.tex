...
\title{The empirical recurrence for OEIS A189179, proved by transfer matrix}
...
\begin{abstract}
OEIS A189179 counts the permutations of the cells of an $n\times2$ array in which every cell
...
OEIS A189179 is ``Number of n X 2 array permutations with each element making a single king move.''. It has offset $1$ and begins
\[
1, 9, 33, 185, 913, 4777, 24577, 127385,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 5*a(n-1) + 4*a(n-2) - 16*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 01 2018 05:35:08, revision 11) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A189179.
