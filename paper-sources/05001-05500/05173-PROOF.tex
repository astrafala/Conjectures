...
\title{The empirical recurrence for OEIS A251945, proved by transfer matrix}
...
\begin{abstract}
OEIS A251945 counts $(n+2)\times5$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A251945 is ``Number of (n+2)X(3+2) 0..3 arrays with every 3X3 subblock row and column sum prime and every diagonal and antidiagonal sum nonprime.''. It has offset $1$ and begins
\[
1933, 1251, 2272, 3572, 8756, 21326, 47034, 116348,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:34:09, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;26\,a(n-3) - 181\,a(n-6) + 246\,a(n-9) - 854\,a(n-12) + 1447\,a(n-15) - 1905\,a(n-18) + 2336\,a(n-21) - 2643\,a(n-24) + 1561\,a(n-27) - 32\,a(n-30)
\]
for every $n>33$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251945.
