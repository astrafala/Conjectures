...
\title{The empirical recurrence for OEIS A254355, proved by transfer matrix}
...
\begin{abstract}
OEIS A254355 counts the arrays over $\{0,\dots,1\}$ whose $3\times3$ subblocks carry a
...
OEIS A254355 is ``Number of (n+2)X(2+2) 0..1 arrays with every 3X3 subblock sum of the two medians of the central row and the central column and the two maximums of the diagonal and antidiagonal nondecreasing horizontally and vertically.''. It has offset $1$ and begins
\[
2868, 21530, 155358, 998646, 5989018, 34611365, 194880155, 1079370642,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 14:37:16, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A254355.
