...
\title{The empirical recurrence for OEIS A198482, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A198482 counts arrays in which every cell is constrained by its neighbours on \emph{both}
...
OEIS A198482 is ``Number of 2n X 2 0..3 arrays with values 0..3 introduced in row major order and each element equal to an even number of horizontal and vertical neighbors.''. It has offset $1$ and begins
\[
5, 193, 10072, 528283, 27711478, 1453628917, 76251331828, 3999827976463,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 55*a(n-1) -135*a(n-2) +81*a(n-3) for n>4.
\end{quote}
As of the ``Last modified'' line on the live entry (May 14 2018 10:39:38, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;55\,a(n-1) - 135\,a(n-2) + 81\,a(n-3)
\end{equation}
for all $n>4$.
...
index corresponding to $n=4+1$ onwards, and the run was continued until $S+1$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A198482.
