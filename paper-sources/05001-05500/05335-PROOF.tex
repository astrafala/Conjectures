...
\title{The empirical recurrence for OEIS A210397, proved by counting patterns}
...
\begin{abstract}
OEIS A210397 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A210397 is ``Number of (n+1) X 2 0..3 arrays with every 2 X 2 subblock having one or three distinct values, and new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
7, 59, 549, 5167, 48689, 458859, 4324477, 40755719,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 10*a(n-1) - 5*a(n-2) - 4*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 15 2018 12:03:22, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;10\,a(n-1) - 5\,a(n-2) - 4\,a(n-3)
\end{equation}
for all $n>3$.
...
\eqref{eq:walk}, divided by $4!$, was evaluated at every one of the $18$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A210397.
