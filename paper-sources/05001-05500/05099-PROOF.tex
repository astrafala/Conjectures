...
\title{The empirical recurrence for OEIS A301396, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A301396 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A301396 is ``Number of nX4 0..1 arrays with every element equal to 2, 3, 4, 5 or 6 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
0, 4, 13, 78, 446, 2619, 15538, 92338,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 20 2018 10:59:41, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;7\,a(n-1) - a(n-2) - 34\,a(n-3) + 14\,a(n-4) + 34\,a(n-5) - 129\,a(n-6) + 186\,a(n-7) - 52\,a(n-8) - 1057\,a(n-9) + 1244\,a(n-10) + 2133\,a(n-11) + 561\,a(n-12) + 8661\,a(n-13) + 4793\,a(n-14) - 4904\,a(n-15) + 3451\,a(n-16) - 22982\,a(n-17) - 52529\,a(n-18) - 23037\,a(n-19) - 99878\,a(n-20) - 14585\,a(n-21) - 33823\,a(n-22) - 37658\,a(n-23) + 44514\,a(n-24) - 47595\,a(n-25) + 17462\,a(n-26) + 9809\,a(n-27) - 27359\,a(n-28) + 26878\,a(n-29) - 14305\,a(n-30) + 6310\,a(n-31) - 2584\,a(n-32) + 2798\,a(n-33) - 2854\,a(n-34) + 2226\,a(n-35) - 690\,a(n-36) - 164\,a(n-37) + 348\,a(n-38) - 188\,a(n-39) - 77\,a(n-40) + 167\,a(n-41) - 139\,a(n-42) + 73\,a(n-43) - 24\,a(n-44) + 4\,a(n-45)
\end{equation}
for all $n>46$.
...
\#\{\text{neighbours with a value }equal to\ x_{t,u}\}\in\{2,3,4,5,6\}
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A301396.
