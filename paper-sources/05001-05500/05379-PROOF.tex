...
\title{The empirical recurrence for OEIS A233021, proved by transfer matrix}
...
\begin{abstract}
OEIS A233021 counts arrays over $\{0,\dots,3\}$ in which no two entries that are neighbours in
...
OEIS A233021 is ``Number of n X 3 0..3 arrays with no element x(i,j) adjacent to value 3-x(i,j) horizontally, vertically, diagonally or antidiagonally, and top left element zero.''. It has offset $1$ and begins
\[
9, 81, 849, 8835, 92067, 959385, 9997413, 104179551,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 11*a(n-1) - 5*a(n-2) - 11*a(n-3) + 2*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 07 2018 08:36:50, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The array is $3$ cells across with entries $x(i,j)\in\{0,1,2,3\}$. Call two values $u,v$ CLASHING
...
\begin{theorem}
\[
a(n)\;=\;11\,a(n-1) - 5\,a(n-2) - 11\,a(n-3) + 2\,a(n-4)
\]
for every $n>4$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A233021.
