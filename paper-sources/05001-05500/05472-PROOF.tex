...
\title{The empirical recurrence for OEIS A235233, proved by transfer matrix}
...
\begin{abstract}
OEIS A235233 counts $3$-column arrays over $\{0,\dots,6\}$ in which every
...
OEIS A235233 is ``Number of (n+1) X (2+1) 0..6 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 6, with no adjacent elements equal (constant-stress tilted 1 X 1 tilings).''. It has offset
$1$ and begins
\[
420, 1288, 3688, 11728, 34916, 113940, 348876,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 19 2022 00:04:35, revision 7) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) + 47\,a(n-2) - 331\,a(n-3) - 846\,a(n-4) + 7735\,a(n-5) + 6531\,a(n-6) - 99876\,a(n-7) - 4062\,a(n-8) + 780931\,a(n-9) - 294777\,a(n-10) - 3829232\,a(n-11) + 2187642\,a(n-12) + 11922251\,a(n-13) - 7106223\,a(n-14) - 23840076\,a(n-15) + 11482195\,a(n-16) + 31200479\,a(n-17) - 9197246\,a(n-18) - 26295345\,a(n-19) + 2967600\,a(n-20) + 13895070\,a(n-21) + 468804\,a(n-22) - 4403844\,a(n-23) - 634896\,a(n-24) + 759672\,a(n-25) + 171504\,a(n-26) - 54432\,a(n-27) - 15552\,a(n-28)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A235233.
