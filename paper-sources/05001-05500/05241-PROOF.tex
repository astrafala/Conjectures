...
\title{The empirical recurrence for OEIS A261112, proved by transfer matrix}
...
\begin{abstract}
OEIS A261112 counts $(n+2)\times9$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A261112 is ``Number of (n+2)X(7+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00010001 00010101 or 01010101.''. It has offset $1$ and begins
\[
547, 1546, 7284, 27030, 121313, 449132, 2037285, 7510472,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 12:14:20, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;9\,a(n-2) + 117\,a(n-4) + 232\,a(n-6) - 453\,a(n-8) - 2222\,a(n-10) + 4157\,a(n-12) - 4373\,a(n-14) + 31514\,a(n-16) - 108786\,a(n-18) + 199500\,a(n-20) - 228491\,a(n-22) + 167917\,a(n-24) - 76526\,a(n-26) + 21086\,a(n-28) - 3000\,a(n-30) + 634\,a(n-32) + 1184\,a(n-34) - 1009\,a(n-36) - 616\,a(n-38) + 123\,a(n-40) + 125\,a(n-42) + 43\,a(n-44) + 9\,a(n-46) + a(n-48)
\]
for every $n>49$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A261112.
