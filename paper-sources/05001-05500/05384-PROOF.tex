...
\title{The empirical recurrence for OEIS A231646, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A231646 counts arrays over $\{0,\dots,2\}$ in which every cell is constrained by the
...
OEIS A231646 is ``Number of nX3 0..2 arrays with no element less than a strict majority of its horizontal and vertical neighbors.''. It has offset $1$ and begins
\[
9, 104, 920, 7682, 61574, 490760, 3929027, 31501117,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 06:35:54, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;18\,a(n-1) - 133\,a(n-2) + 640\,a(n-3) - 2309\,a(n-4) + 5762\,a(n-5) - 9918\,a(n-6) + 8864\,a(n-7) + 2970\,a(n-8) - 18151\,a(n-9) + 23183\,a(n-10) + 21799\,a(n-11) - 75109\,a(n-12) + 56329\,a(n-13) - 9892\,a(n-14) - 115814\,a(n-15) + 105665\,a(n-16) + 64162\,a(n-17) - 38348\,a(n-18) + 8767\,a(n-19) + 54790\,a(n-20) - 95246\,a(n-21) - 139155\,a(n-22) + 81259\,a(n-23) + 104482\,a(n-24) + 18968\,a(n-25) - 2909\,a(n-26) - 41630\,a(n-27) - 37578\,a(n-28) + 6670\,a(n-29) + 17693\,a(n-30) + 5629\,a(n-31) - 713\,a(n-32) - 928\,a(n-33) - 300\,a(n-34) - 52\,a(n-35) - 4\,a(n-36)
\end{equation}
for all $n>37$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231646.
