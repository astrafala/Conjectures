...
\title{The empirical recurrence for OEIS A063168, proved from an exact model}
...
\begin{abstract}
OEIS A063168 carries an empirical recurrence of order $2$. It is true, and it is
...
OEIS A063168 is ``Dimension of the space of weight 2n cusp forms for Gamma\_0( 100 ).''. It has offset $1$ and begins
\[
7, 36, 66, 96, 126, 156, 186, 216,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
a(n) = 2*a(n-1) - a(n-2) for n > 3 (conjectured).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 17 2025 00:38:37, revision 22)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A063168.
