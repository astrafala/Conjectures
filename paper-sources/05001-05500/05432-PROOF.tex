...
\title{The empirical recurrence for OEIS A209094, proved by counting patterns}
...
\begin{abstract}
OEIS A209094 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A209094 is ``Number of n X 2 0..2 arrays with new values 0..2 introduced in row major order and no element equal to more than one of its immediate leftward or upward or right-upward antidiagonal neighbors.''. It has offset $1$ and begins
\[
2, 11, 82, 612, 4568, 34096, 254496, 1899584,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 8*a(n-1) - 4*a(n-2) for n>3.
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 07 2018 16:50:19, revision 9) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209094.
