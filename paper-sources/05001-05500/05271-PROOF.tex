...
The entry gives only the order for this line: ``k=4: [order 8]''. Its model is a walk on
...
$c_{1}$ & $19$ & $c_{3}$ & $-304$ & $c_{5}$ & $4864$ & $c_{7}$ & $-77824$ \\
$c_{2}$ & $16$ & $c_{4}$ & $5776$ & $c_{6}$ & $4096$ & $c_{8}$ & $-65536$ \\
