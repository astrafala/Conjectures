...
\title{The empirical recurrence for OEIS A206235, proved by transfer matrix}
...
\begin{abstract}
OEIS A206235 counts, up to renaming the letters, the arrays of width $6$ over at most $4$
letters in which every $2\times3$ and $3\times2$ subblock has exactly $2$ equal edges, an edge of such a window being one of the six steps of its perimeter cycle and an equal edge one whose two cells agree. It carries an empirical recurrence of order $4$ contributed by
...
OEIS A206235 is ``Number of (n+1)X6 0..3 arrays with every 2X3 or 3X2 subblock having exactly two equal edges, and new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
8910, 31652, 133392, 1236432, 10915392, 118573968, 1122086640, 10022726928,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) +921*a(n-3) -921*a(n-4) for n>9
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 12:49:11, revision 9) this is still
...
$w_i$ cleared of denominators and $S=226018$ states in all. The walk index $j$ and the entry's own
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206235.
