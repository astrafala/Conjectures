...
\title{The empirical column recurrences for the table OEIS A235660}
...
\begin{abstract}
OEIS A235660 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A235660 is ``T(n,k)=Number of (n+1)X(k+1) 0..1 arrays with the difference of the upper median and minimum value of each 2X2 subblock in lexicographically nondecreasing order rowwise and columnwise.''. It has offset $1$, is
read by antidiagonals, and begins
\[
16, 52, 52, 160, 276, 160, 476, 1368,\ \dots
\]
...
k=3: [order 69]\\
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 08:42:49, revision 6) these are still
...
The sequence is ``Number of (n+1)X2 0..1 arrays with the difference of the upper median and minimum value of each 2X2 subblock in lexicographically nondecreasing order rowwise and columnwise.''. Its rows are the vertices of a digraph on
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A235660.
