...
\title{The empirical column recurrences for the table OEIS A236523}
...
\begin{abstract}
OEIS A236523 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A236523 is ``T(n,k)=Number of (n+1)X(k+1) 0..1 arrays with the difference of the upper median and minimum value of each 2X2 subblock in lexicographically nondecreasing order columnwise and nonincreasing rowwise.''. It has offset $1$, is
read by antidiagonals, and begins
\[
16, 52, 52, 160, 264, 160, 476, 1256,\ \dots
\]
...
k=4: [order 82]\\
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 09:19:40, revision 6) these are still
...
The sequence is ``Number of (n+1)X2 0..1 arrays with the difference of the upper median and minimum value of each 2X2 subblock in lexicographically nondecreasing order columnwise and nonincreasing rowwise.''. Its rows are the vertices of a digraph on
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A236523.
