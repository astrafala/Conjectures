...
\title{The empirical recurrence for OEIS A254692, proved by transfer matrix}
...
\begin{abstract}
OEIS A254692 carries an empirical recurrence of order $49$ contributed by R.~H.~Hardin. It is
...
OEIS A254692 is ``Number of length n+4 0..2 arrays with every five consecutive terms having the maximum of some two terms equal to the minimum of the remaining three terms.''. It has offset $1$ and begins
\[
133, 267, 552, 1140, 2310, 4542, 9106, 18498,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 14:52:22, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A254692.
