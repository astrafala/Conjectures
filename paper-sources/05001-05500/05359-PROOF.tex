...
\title{The empirical recurrence for OEIS A252402, proved by transfer matrix}
...
\begin{abstract}
OEIS A252402 counts $(n+2)\times5$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252402 is ``Number of (n+2)X(3+2) 0..3 arrays with every 3X3 subblock row and diagonal sum equal to 2 3 4 6 or 7 and every 3X3 column and antidiagonal sum not equal to 2 3 4 6 or 7.''. It has offset $1$ and begins
\[
983, 774, 1515, 3302, 8346, 20998, 50675, 133296,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:10:47, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;32\,a(n-3) - 310\,a(n-6) + 1291\,a(n-9) - 4641\,a(n-12) + 11713\,a(n-15) - 20535\,a(n-18) + 26754\,a(n-21) - 23045\,a(n-24) + 8109\,a(n-27) + 1127\,a(n-30) - 638\,a(n-33) + 162\,a(n-36) - 12\,a(n-39) - 7\,a(n-42) + a(n-45)
\]
for every $n>48$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252402.
