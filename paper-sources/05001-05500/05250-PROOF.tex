...
\title{The empirical recurrence for OEIS A303193, proved by transfer matrix}
...
\begin{abstract}
OEIS A303193 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the six horizontal, diagonal and antidiagonal neighbours, a number $equal to$ itself lying in $\{0,1,3,5,6\}$, and it carries an empirical
recurrence of order $42$ contributed by R.~H.~Hardin. It is true. The neighbourhood
...
OEIS A303193 is ``Number of nX4 0..1 arrays with every element equal to 0, 1, 3, 5 or 6 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
5, 17, 23, 46, 185, 497, 1357, 4207,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 19 2018 13:33:59, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 2\,a(n-2) + 12\,a(n-3) - 16\,a(n-4) - 31\,a(n-5) - 40\,a(n-6) + 26\,a(n-7) + 53\,a(n-8) + 50\,a(n-9) + 35\,a(n-10) + 7\,a(n-11) + a(n-12) - 66\,a(n-13) + 111\,a(n-14) + 160\,a(n-15) - 144\,a(n-16) - 293\,a(n-17) - 37\,a(n-18) + 236\,a(n-19) - 90\,a(n-20) - 395\,a(n-21) - 6\,a(n-22) + 127\,a(n-23) - 242\,a(n-24) - 440\,a(n-25) - 17\,a(n-26) + 448\,a(n-27) + 310\,a(n-28) + 44\,a(n-29) + 97\,a(n-30) + 113\,a(n-31) - 8\,a(n-32) - 125\,a(n-33) - 100\,a(n-34) - 26\,a(n-35) - a(n-36) + 15\,a(n-37) + 10\,a(n-38) + 9\,a(n-39) - a(n-41) - a(n-42)
\end{equation}
for all $n>43$.
...
has score in $\{0,1,3,5,6\}$. The entry also fixes the top-left entry to be $0$; that is a condition on the first row alone, so it restricts the start vector and nothing else.
...
\begin{itemize}
\item $\mathbf{s}(r,s)=1$ when every cell of $r$ has score in $\{0,1,3,5,6\}$ \emph{with no row
above $r$} and $r_1=0$, and $0$ otherwise;
\item an edge $(r,s)\to(s,t)$ when every cell of $s$ has score in $\{0,1,3,5,6\}$ computed from
$r$, $s$ and $t$;
\item $\mathbf{e}(r,s)=1$ when every cell of $s$ has score in $\{0,1,3,5,6\}$ \emph{with no row
...
exactly when every one of its $n$ rows has all scores in $\{0,1,3,5,6\}$. Read the sequence as the
...
$a(n)-\sum_i c_i a(n-i)=u_{\,n-2-42}$ whenever $n-42\ge2$. So \eqref{eq:conj}
holds for every $n>t$ exactly when $u_j=0$ for all $j>t-2-42$. Moreover $(u_j)$
...
\begin{proof}
Substituting Lemma~\ref{lem:walk} and factoring $P^{\,n-2-42}$ out of
...
\begin{proof}
The vector $q(P)\mathbf{e}\in\mathbb{Z}^{S}$ was formed by $42$ matrix--vector
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A303193.
