...
\title{The empirical recurrence for OEIS A297872, proved by transfer matrix}
...
\begin{abstract}
OEIS A297872 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $equal to$ itself lying in $\{2,3,5\}$, and it carries an empirical
...
OEIS A297872 is ``Number of nX4 0..1 arrays with every element equal to 2, 3 or 5 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 07 2018 11:29:26, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) - 5\,a(n-2) - 2\,a(n-3) - 5\,a(n-4) + 3\,a(n-5) + 36\,a(n-7) - 57\,a(n-8) + 81\,a(n-9) + 32\,a(n-10) - 6\,a(n-11) - 102\,a(n-12) - 12\,a(n-13) - 182\,a(n-14) - 286\,a(n-15) + 443\,a(n-16) - 410\,a(n-17) + 222\,a(n-18) - 755\,a(n-19) + 2597\,a(n-20) - 997\,a(n-21) + 788\,a(n-22) - 95\,a(n-23) + 2600\,a(n-24) - 2288\,a(n-25) - 2866\,a(n-26) - 1124\,a(n-27) + 2189\,a(n-28) - 1950\,a(n-29) - 3437\,a(n-30) + 2422\,a(n-31) + 115\,a(n-32) + 1748\,a(n-33) + 1283\,a(n-34) + 1645\,a(n-35) + 38\,a(n-36) + 415\,a(n-37) - 862\,a(n-38) + 338\,a(n-39) - 437\,a(n-40) - 1030\,a(n-41) - 286\,a(n-42) - 150\,a(n-43) + 337\,a(n-44) - 83\,a(n-45) + 41\,a(n-46) - 33\,a(n-47) + 71\,a(n-48) + 14\,a(n-49) + 8\,a(n-50) - 6\,a(n-51) - 4\,a(n-52)
\end{equation}
for all $n>53$.
...
has score in $\{2,3,5\}$. The entry also fixes the top-left entry to be $0$; that is a condition on the first row alone, so it restricts the start vector and nothing else.
...
\begin{itemize}
\item $\mathbf{s}(r,s)=1$ when every cell of $r$ has score in $\{2,3,5\}$ \emph{with no row
above $r$} and $r_1=0$, and $0$ otherwise;
\item an edge $(r,s)\to(s,t)$ when every cell of $s$ has score in $\{2,3,5\}$ computed from
$r$, $s$ and $t$;
\item $\mathbf{e}(r,s)=1$ when every cell of $s$ has score in $\{2,3,5\}$ \emph{with no row
...
exactly when every one of its $n$ rows has all scores in $\{2,3,5\}$. Read the sequence as the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297872.
