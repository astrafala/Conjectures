...
\title{The empirical recurrence for OEIS A295093, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A295093 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A295093 is ``Number of nX4 0..1 arrays with each 1 horizontally or vertically adjacent to 1 or 3 1s.''. It has offset $1$ and begins
\[
4, 24, 114, 578, 2859, 14187, 70982, 353880,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 14 2017 11:14:45, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) + 2\,a(n-2) + 12\,a(n-3) + 24\,a(n-4) - 12\,a(n-5) - 192\,a(n-6) - 183\,a(n-7) + 99\,a(n-8) + 13\,a(n-9) + 377\,a(n-10) + 690\,a(n-11) - 19\,a(n-12) + 305\,a(n-13) + 358\,a(n-14) - 841\,a(n-15) + 269\,a(n-16) - 2630\,a(n-17) - 190\,a(n-18) - 818\,a(n-19) - 1094\,a(n-20) + 2834\,a(n-21) - 1033\,a(n-22) + 1681\,a(n-23) + 597\,a(n-24) + 96\,a(n-25) + 1650\,a(n-26) - 332\,a(n-27) + 101\,a(n-28) + 59\,a(n-29) - 804\,a(n-30) - 338\,a(n-31) - 291\,a(n-32) - 285\,a(n-33) + 50\,a(n-34) + 18\,a(n-35) + 29\,a(n-36) + 26\,a(n-37) - 30\,a(n-38) - 20\,a(n-39) - 10\,a(n-40) - 5\,a(n-41) + 9\,a(n-42) + 7\,a(n-43) - a(n-44) - a(n-45)
\end{equation}
for all $n>46$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A295093.
