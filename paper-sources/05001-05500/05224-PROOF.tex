...
\title{The empirical recurrence for OEIS A252553, proved by transfer matrix}
...
\begin{abstract}
OEIS A252553 counts $(n+2)\times5$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252553 is ``Number of (n+2)X(3+2) 0..3 arrays with every 3X3 subblock row and diagonal sum equal to 1 2 4 6 or 7 and every 3X3 column and antidiagonal sum not equal to 1 2 4 6 or 7.''. It has offset $1$ and begins
\[
1510, 1752, 4006, 10585, 33635, 93997, 270672, 884446,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:21:31, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;57\,a(n-3) - 1068\,a(n-6) + 8828\,a(n-9) - 37486\,a(n-12) + 91215\,a(n-15) - 139676\,a(n-18) + 143042\,a(n-21) - 98725\,a(n-24) + 44005\,a(n-27) - 11816\,a(n-30) + 1746\,a(n-33) - 124\,a(n-36) + 3\,a(n-39)
\]
for every $n>45$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252553.
