...
\title{The empirical recurrence for OEIS A252682, proved by transfer matrix}
...
\begin{abstract}
OEIS A252682 counts $5\times(n+2)$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252682 is ``Number of (3+2)X(n+2) 0..3 arrays with every 3X3 subblock row and diagonal sum equal to 0 2 5 6 or 7 and every 3X3 column and antidiagonal sum not equal to 0 2 5 6 or 7.''. It has offset $1$ and begins
\[
808, 991, 2106, 3424, 9794, 24666, 42376, 125832,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:31:32, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;32\,a(n-3) - 343\,a(n-6) + 1404\,a(n-9) - 1602\,a(n-12) - 3076\,a(n-15) + 8151\,a(n-18) - 2122\,a(n-21) - 7989\,a(n-24) + 5794\,a(n-27) + 1592\,a(n-30) - 2032\,a(n-33) + 192\,a(n-36)
\]
for every $n>39$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252682.
