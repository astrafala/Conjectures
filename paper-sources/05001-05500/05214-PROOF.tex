...
\title{The empirical column recurrences for the table OEIS A296327}
...
\begin{abstract}
OEIS A296327 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A296327 is ``T(n,k) = Number of n X k 0..1 arrays with each 1 horizontally, vertically or antidiagonally adjacent to 2 neighboring 1's.''. It has offset $1$, is
read by antidiagonals, and begins
\[
1, 1, 1, 1, 3, 1, 1, 5,\ \dots
\]
...
k=6: [order 83].\\
\end{quote}
As of the ``Last modified'' line on the live entry (May 24 2024 15:57:11, revision 6) these are still
...
The sequence is ``Number of n X 2 0..1 arrays with each 1 horizontally, vertically or antidiagonally adjacent to 2 neighboring 1's.''. Its rows are the vertices of a digraph on
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A296327.
