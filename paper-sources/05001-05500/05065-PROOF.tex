...
\title{The empirical recurrence for OEIS A231337, proved by transfer matrix}
...
\begin{abstract}
OEIS A231337 counts $(n+1)\times2$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A231337 is ``Number of (n+1) X (1+1) 0..3 arrays with no element unequal to a strict majority of its horizontal and vertical neighbors, with values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
3, 4, 7, 12, 24, 48, 103, 222,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) + a(n-2) - 7*a(n-3) + a(n-4) + 3*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 24 2018 09:25:27, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231337.
