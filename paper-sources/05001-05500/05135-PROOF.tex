...
\title{The empirical recurrence for OEIS A232131, proved by transfer matrix}
...
\begin{abstract}
OEIS A232131 counts $(n+1)\times3$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A232131 is ``Number of (n+1) X (2+1) 0..2 arrays with no element equal to a strict majority of its horizontal and antidiagonal neighbors, with values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
36, 728, 14752, 298912, 6056640, 122721280, 2486611712, 50384397824,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 22*a(n-1) - 36*a(n-2) + 16*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2018 08:41:36, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232131.
