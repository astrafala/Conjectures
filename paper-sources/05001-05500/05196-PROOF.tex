...
\title{The empirical recurrence for OEIS A209222, proved by transfer matrix}
...
\begin{abstract}
OEIS A209222 counts arrays over $\{0,\dots,1\}$ of width $6$ that avoid the patterns
$(0,0,0), (0,1,0)$ along one axis and $(0,1,0), (1,1,1)$ along the other, and carries an empirical recurrence of
...
OEIS A209222 is ``Number of nX6 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 1 0 and 1 1 1 vertically.''. It has offset
$1$ and begins
\[
25, 625, 576, 1296, 2500, 5476, 11664,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 15:11:52, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-2) + 15\,a(n-3) + 2\,a(n-4) - 6\,a(n-5) - 107\,a(n-6) + 34\,a(n-7) - 6\,a(n-8) + 419\,a(n-9) - 280\,a(n-10) + 147\,a(n-11) - 1405\,a(n-12) + 721\,a(n-13) - 1078\,a(n-14) + 3560\,a(n-15) - 277\,a(n-16) + 1992\,a(n-17) - 5500\,a(n-18) - 1545\,a(n-19) - 2468\,a(n-20) + 4823\,a(n-21) + 4816\,a(n-22) + 4269\,a(n-23) - 2796\,a(n-24) - 4899\,a(n-25) - 4644\,a(n-26) + 2679\,a(n-27) + 2205\,a(n-28) + 2127\,a(n-29) - 2887\,a(n-30) - 262\,a(n-31) - 556\,a(n-32) + 1789\,a(n-33) - 451\,a(n-34) + 245\,a(n-35) - 528\,a(n-36) + 226\,a(n-37) - 18\,a(n-38) + 82\,a(n-39) - 33\,a(n-40) - 6\,a(n-41) - 16\,a(n-42) - a(n-43) + a(n-44) + a(n-45)
\end{equation}
for all $n>47$. 
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209222.
