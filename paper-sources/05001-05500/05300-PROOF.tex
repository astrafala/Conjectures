...
\title{The empirical recurrence for OEIS A193642, proved by transfer matrix}
...
\begin{abstract}
OEIS A193642 carries an empirical recurrence of order $3$ contributed by R. H. Hardin. It is
...
OEIS A193642 is ``Number of arrays of -2..2 integers x(1..n) with every x(i) in a subsequence of length 1 or 2 with sum zero.''. It has offset $1$ and begins
\[
1, 5, 13, 37, 105, 297, 841, 2381,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) +2*a(n-2) +a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 05:59:48, revision 13) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A193642.
