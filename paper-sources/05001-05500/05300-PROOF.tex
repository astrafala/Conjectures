...
\title{The empirical recurrence for OEIS A208402, proved by counting patterns}
...
\begin{abstract}
OEIS A208402 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
state space down from $30$ to $S=7$. The entry's empirical recurrence of order
...
OEIS A208402 is ``Number of n X 2 0..3 arrays with new values 0..3 introduced in row major order and no element equal to more than two of its immediate leftward or upward or right-upward antidiagonal neighbors.''. It has offset $1$ and begins
\[
2, 15, 187, 2795, 43947, 700075, 11188907, 178973355,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 21*a(n-1) - 84*a(n-2) + 64*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 02 2018 10:16:09, revision 9) the statement is
...
Assembling the $4$ lumped chains into one block-diagonal matrix $N$ of size $S=7$ and
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208402.
