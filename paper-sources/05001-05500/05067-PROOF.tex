...
\title{The empirical recurrence for OEIS A268900, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A268900 counts arrays over $\{0,\dots,2\}$ subject to a condition on the array as a
...
OEIS A268900 is ``Number of n X 4 0..2 arrays with some element plus some horizontally or antidiagonally adjacent neighbor totalling two exactly once.''. It has offset $1$ and begins
\[
36, 696, 9720, 118584, 1347192, 14644152, 154472184, 1594323000,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 18*a(n-1) - 81*a(n-2) for n>3.
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 16 2019 09:23:37, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268900.
