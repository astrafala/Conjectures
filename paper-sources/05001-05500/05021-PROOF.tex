...
\title{The empirical recurrence for OEIS A252642, proved by transfer matrix}
...
\begin{abstract}
OEIS A252642 counts $4\times(n+2)$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252642 is ``Number of (2+2)X(n+2) 0..3 arrays with every 3X3 subblock row and diagonal sum equal to 0 3 4 6 or 7 and every 3X3 column and antidiagonal sum not equal to 0 3 4 6 or 7.''. It has offset $1$ and begins
\[
687, 1684, 4026, 8253, 22701, 56953, 121016, 345360,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:29:43, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;86\,a(n-3) - 3182\,a(n-6) + 66973\,a(n-9) - 895271\,a(n-12) + 8064140\,a(n-15) - 50867891\,a(n-18) + 231279187\,a(n-21) - 776462668\,a(n-24) + 1968180875\,a(n-27) - 3848275417\,a(n-30) + 5915127032\,a(n-33) - 7240426796\,a(n-36) + 7089509055\,a(n-39) - 5534672806\,a(n-42) + 3401054768\,a(n-45) - 1598881704\,a(n-48) + 548907804\,a(n-51) - 124335864\,a(n-54) + 15500160\,a(n-57) - 777600\,a(n-60)
\]
for every $n>63$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252642.
