...
\title{The empirical recurrence for OEIS A207503, proved by transfer matrix}
...
\begin{abstract}
OEIS A207503 counts arrays over $\{0,\dots,1\}$ of width $6$ that avoid the patterns
...
OEIS A207503 is ``Number of 6Xn 0..1 arrays avoiding 0 0 0 and 0 1 1 horizontally and 0 0 1 and 1 0 0 vertically.''. It has offset
$1$ and begins
\[
22, 484, 2974, 15495, 68745, 237576, 804887,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:00:04, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207503.
