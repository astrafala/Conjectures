...
\title{The empirical recurrence for OEIS A252275, proved by transfer matrix}
...
\begin{abstract}
OEIS A252275 counts $(n+2)\times7$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
$a(n)$ is a walk count on $S=709957$ vertices. Such a sequence is $C$-finite, so whether a given
...
OEIS A252275 is ``Number of (n+2)X(5+2) 0..3 arrays with every 3X3 subblock row and column sum not equal to 2 3 4 6 or 7 and every 3X3 diagonal and antidiagonal sum equal to 2 3 4 6 or 7.''. It has offset $1$ and begins
\[
535, 2154, 7803, 15739, 67509, 257064, 518498, 2242108,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:00:30, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252275.
