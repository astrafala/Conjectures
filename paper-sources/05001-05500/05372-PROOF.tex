...
\begin{abstract}
OEIS A277560 carries an empirical recurrence of order $4$ contributed by Colin Barker. It is true, and it is
...
\begin{quote}
Conjectures from \_Colin Barker\_, Nov 06 2016: (Start) a(n) = 101*a(n-2) - 100*a(n-4) for n>4.
\end{quote}
