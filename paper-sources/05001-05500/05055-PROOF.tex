...
\title{The empirical recurrence for OEIS A252567, proved by transfer matrix}
...
\begin{abstract}
OEIS A252567 counts $(n+2)\times3$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252567 is ``Number of (n+2)X(1+2) 0..3 arrays with every 3X3 subblock row and diagonal sum equal to 1 2 5 6 or 7 and every 3X3 column and antidiagonal sum not equal to 1 2 5 6 or 7.''. It has offset $1$ and begins
\[
702, 742, 890, 1469, 2637, 4583, 8279, 15476,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:23:03, revision 6) this is still
...
\[
\text{every row, diagonal sum} \in \{1,2,5,6,7\}\ \text{ and }\ \text{every column, antidiagonal sum} \notin \{1,2,5,6,7\}
\]
...
\begin{theorem}
\[
a(n)\;=\;26\,a(n-3) - 280\,a(n-6) + 1644\,a(n-9) + a(n-11) - 5901\,a(n-12) - 23\,a(n-14) + 13891\,a(n-15) + 9\,a(n-16) + 218\,a(n-17) - 22285\,a(n-18) - 87\,a(n-19) - 1114\,a(n-20) + 24618\,a(n-21) + 235\,a(n-22) + 3398\,a(n-23) - 18372\,a(n-24) - 174\,a(n-25) - 6506\,a(n-26) + 8700\,a(n-27) - 229\,a(n-28) + 7928\,a(n-29) - 2284\,a(n-30) + 496\,a(n-31) - 5968\,a(n-32) + 600\,a(n-33) - 313\,a(n-34) + 2449\,a(n-35) - 1063\,a(n-36) + 38\,a(n-37) - 263\,a(n-38) + 1219\,a(n-39) + 40\,a(n-40) - 170\,a(n-41) - 603\,a(n-42) - 17\,a(n-43) + 50\,a(n-44) + 26\,a(n-45) + 2\,a(n-46) + 97\,a(n-48) - 36\,a(n-51) + 4\,a(n-54)
\]
for every $n>60$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252567.
