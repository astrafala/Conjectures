...
\title{The empirical recurrence for OEIS A252411, proved by transfer matrix}
...
\begin{abstract}
OEIS A252411 counts $6\times(n+2)$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
every $3\times3$ subblock, and it carries an empirical recurrence of order $39$
...
$a(n)$ is a walk count on $S=159249$ vertices. Such a sequence is $C$-finite, so whether a given
...
OEIS A252411 is ``Number of (4+2)X(n+2) 0..3 arrays with every 3X3 subblock row and diagonal sum equal to 2 3 4 6 or 7 and every 3X3 column and antidiagonal sum not equal to 2 3 4 6 or 7.''. It has offset $1$ and begins
\[
426, 1224, 3302, 6231, 21819, 63428, 122653, 433272,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:11:52, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;41\,a(n-3) - 427\,a(n-6) - 92\,a(n-9) + 4948\,a(n-12) - 4734\,a(n-15) - 16460\,a(n-18) + 22444\,a(n-21) + 22257\,a(n-24) - 37919\,a(n-27) - 8433\,a(n-30) + 18472\,a(n-33) + 420\,a(n-36) - 516\,a(n-39)
\]
for every $n>41$.
\end{theorem}

\begin{proof}
The vector $w=q(M)\mathbf{1}$ was formed by $39$ matrix--vector products in exact
integer arithmetic and $\mathbf{1}^{\!\top}M^{j}w$ evaluated for $j=0,1,\dots$, again
exactly. Those integers vanish from the index corresponding to $n=41+1$ onwards, and the
run was continued until the working vector was identically zero, which settles all larger $j$
at once. By Lemma~\ref{lem:crit} the recurrence holds for every $n>41$.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252411.
