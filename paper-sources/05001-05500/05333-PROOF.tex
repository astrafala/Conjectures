...
\title{The empirical recurrence for OEIS A277800, proved from an exact model}
...
\begin{abstract}
OEIS A277800 carries an empirical recurrence of order $4$ contributed by Colin Barker. It is true, and it is
...
OEIS A277800 is ``Decimal representation of the x-axis, from the origin to the right edge, of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 1", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 0, 4, 3, 16, 15, 64, 63,\ \dots
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A277800.
