...
\title{The empirical recurrence for OEIS A214108, proved by transfer matrix}
...
\begin{abstract}
OEIS A214108 counts the proper colourings of a grid $n\times5$, wrapped in the direction of width $5$, with at most $4$ colours and
...
down to $S=270$ and makes the exact residual test affordable.
\end{abstract}
...
OEIS A214108 is ``Number of 0..3 colorings on an nX5 array circular in the 5 direction with new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
10, 670, 44900, 3008980, 201647240, 13513419640, 905603817680, 60689173906000,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 68*a(n-1) -66*a(n-2).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 16:51:43, revision 10) this is still
...
\]
There are $(i-1)^{5}+(-1)^{5}(i-1)$ such colourings, which at $i=4$ is already more
...
state count is $S=270$ rather than the number of colourings.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A214108.
