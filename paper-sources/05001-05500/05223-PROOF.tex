...
\title{The conjectured generating function for OEIS A266668, proved}
...
\begin{abstract}
OEIS A266668 counts arrays of a fixed width under a local condition, and carries a conjectured
...
OEIS A266668 is ``Decimal representation of the n-th iteration of the "Rule 51" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 5, 4, 119, 16, 2015,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 16 2025 08:33:28, revision 24) this is still
...
\begin{proof}
Write the conjecture as $N_2/D_2$ with $\deg N_2=4$ and $\deg D_2=5$; its expansion as a
...
numerator. Its coefficients are the integers $c_1,\dots,c_{5}$ read off $D_2$, the first few being $-2,\ 17,\ 34,\ -16,\ -32$. The entry records no recurrence, so this is not a restatement of anything
already there.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A266668.
