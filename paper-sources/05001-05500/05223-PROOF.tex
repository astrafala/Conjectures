...
\title{The empirical recurrence for OEIS A252083, proved by transfer matrix}
...
\begin{abstract}
OEIS A252083 counts $(n+2)\times5$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A252083 is ``Number of (n+2)X(3+2) 0..2 arrays with every 3X3 subblock row, column, diagonal and antidiagonal sum not equal to 1 3 or 4.''. It has offset $1$ and begins
\[
295, 943, 3326, 11186, 38374, 132875, 457442, 1580135,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 10:46:23, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252083.
