...
\title{The empirical recurrence for OEIS A239851, proved by transfer matrix}
...
\begin{abstract}
OEIS A239851 counts arrays over $\{0,1,2,3\}$ in which no entry may equal, modulo $4$, a given
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A239851.
