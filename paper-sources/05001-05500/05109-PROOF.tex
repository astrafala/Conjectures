...
\title{The empirical recurrence for OEIS A316516, proved by transfer matrix}
...
\begin{abstract}
OEIS A316516 counts $6$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $different from$ itself lying in $\{0,1,2,3,7,8\}$, and it carries an empirical
recurrence of order $44$ contributed by R.~H.~Hardin. It is true. The neighbourhood
...
OEIS A316516 is ``Number of nX6 0..1 arrays with every element unequal to 0, 1, 2, 3, 7 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
32, 293, 414, 1710, 11977, 73031, 432088, 2685906,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 05 2018 07:15:42, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;7\,a(n-1) - 5\,a(n-2) + 15\,a(n-3) - 134\,a(n-4) + 191\,a(n-5) - 141\,a(n-6) + 430\,a(n-7) + 579\,a(n-8) - 3240\,a(n-9) + 292\,a(n-10) + 2930\,a(n-11) + 5065\,a(n-12) - 247\,a(n-13) - 15428\,a(n-14) + 643\,a(n-15) + 8666\,a(n-16) + 11550\,a(n-17) + 2491\,a(n-18) - 19726\,a(n-19) - 5047\,a(n-20) - 379\,a(n-21) + 13161\,a(n-22) + 15847\,a(n-23) - 11738\,a(n-24) - 14543\,a(n-25) - 3102\,a(n-26) + 10826\,a(n-27) + 13364\,a(n-28) - 6963\,a(n-29) - 12553\,a(n-30) + 4495\,a(n-31) + 3122\,a(n-32) + 946\,a(n-33) + 56\,a(n-34) - 2673\,a(n-35) + 1326\,a(n-36) + 128\,a(n-37) - 299\,a(n-38) + 207\,a(n-39) - 222\,a(n-40) + 80\,a(n-41) + 12\,a(n-42) + 4\,a(n-43) + 8\,a(n-44)
\end{equation}
for all $n>49$.
...
$a(n)-\sum_i c_i a(n-i)=u_{\,n-2-44}$ whenever $n-44\ge2$. So \eqref{eq:conj}
holds for every $n>t$ exactly when $u_j=0$ for all $j>t-2-44$. Moreover $(u_j)$
...
\begin{proof}
Substituting Lemma~\ref{lem:walk} and factoring $P^{\,n-2-44}$ out of
...
\begin{proof}
The vector $q(P)\mathbf{e}\in\mathbb{Z}^{S}$ was formed by $44$ matrix--vector
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A316516.
