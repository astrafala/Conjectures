...
\title{The empirical column recurrences for the table OEIS A256735}
...
\begin{abstract}
OEIS A256735 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A256735 is ``T(n,k)=Number of (n+2)X(k+2) 0..1 arrays with no 3x3 subblock diagonal sum zero and no antidiagonal sum three.''. It has offset $1$, is
read by antidiagonals, and begins
\[
384, 2304, 2304, 13056, 21904, 13056, 73984, 186624,\ \dots
\]
The entry carries the following block:
\begin{quote}\small
Empirical for column k:\\
k=1: a(n) = 7*a(n-1) -56*a(n-3) +64*a(n-4)\\
k=2: [order 15]\\
k=3: [order 16]\\
k=4: [order 78] for n>80\\
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 15:13:46, revision 6) these are still
...
The sequence is ``Number of (n+2)X3 0..1 arrays with no 3x3 subblock diagonal sum zero and no antidiagonal sum three.''. Its rows are the vertices of a digraph on
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A256735.
