...
\title{The empirical recurrence for OEIS A223329, proved by transfer matrix}
...
\begin{abstract}
OEIS A223329 counts the ways of writing the vertices of a fixed graph $G$ into an array of width
$6$ so that any two cells adjacent in one of the named directions carry vertices joined by an
edge of $G$; here $G$ is cube graph $Q_3$. The entry carries an empirical recurrence of order $3$
...
single slice is a state and the count is a walk count on a finite digraph with $S=973$ vertices.
\end{abstract}
...
OEIS A223329 is ``Rolling cube footprints: number of n X 6 0..7 arrays starting with 0 where 0..7 label vertices of a cube and every array movement to a horizontal or antidiagonal neighbor moves along a corresponding cube edge.''. It has offset $1$ and begins
\[
243, 64827, 17324685, 4630596579, 1237689159021, 330815891296611, 88422165323034669, 23633929115222765283,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 282*a(n-1) - 3969*a(n-2) + 9604*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 19 2018 09:36:57, revision 8) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=973.
\]
...
\begin{theorem}
\[
a(n)\;=\;282\,a(n-1) - 3969\,a(n-2) + 9604\,a(n-3)
\]
for every $n>3$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223329.
