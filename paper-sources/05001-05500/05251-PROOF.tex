...
\title{The empirical closed form for OEIS A203819, proved}
...
\begin{abstract}
OEIS A203819 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A203819 is ``Number of (n+1)X2 0..3 arrays with no 2X2 subblock having equal diagonal elements or equal antidiagonal elements.''. It has offset $1$ and begins
\[
144, 1296, 11664, 104976, 944784, 8503056, 76527504, 688747536,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 16*9\^{}n
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 10:44:24, revision 9) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A203819.
