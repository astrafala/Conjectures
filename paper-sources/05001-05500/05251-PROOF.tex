...
\begin{abstract}
OEIS A283590 carries an empirical recurrence of order $2$ contributed by Colin Barker. It is true, and it is
...
\begin{quote}
Conjectures from \_Colin Barker\_, Mar 13 2017: (Start) a(n) = 11*a(n-1) - 10*a(n-2) for n>4.
\end{quote}
