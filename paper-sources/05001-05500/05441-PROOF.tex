...
\title{The empirical recurrence for OEIS A297547, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297547 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A297547 is ``Number of 4Xn 0..1 arrays with every 1 horizontally, diagonally or antidiagonally adjacent to 2 or 3 neighboring 1s.''. It has offset $1$ and begins
\[
1, 7, 88, 275, 1233, 10234, 65363, 355573,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 31 2017 15:06:21, revision 4) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297547.
