...
\title{The empirical recurrence for OEIS A261289, proved by transfer matrix}
...
\begin{abstract}
OEIS A261289 counts $(n+2)\times7$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A261289 is ``Number of (n+2)X(5+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000001 00010101 or 01010101.''. It has offset $1$ and begins
\[
307, 409, 1086, 2586, 6996, 17094, 48435, 115722,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 14 2015 07:15:53, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-2) + 24\,a(n-4) + 17\,a(n-6) - 51\,a(n-8) + 22\,a(n-10) - 9\,a(n-12) - 7\,a(n-14) + 132\,a(n-16) - 142\,a(n-18) + 19\,a(n-20) + 91\,a(n-22) - 46\,a(n-24) - 157\,a(n-26) + 278\,a(n-28) - 211\,a(n-30) + 50\,a(n-32) - 8\,a(n-34) + 12\,a(n-36)
\]
for every $n>41$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A261289.
