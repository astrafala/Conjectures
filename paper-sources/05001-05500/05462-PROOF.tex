...
\title{The empirical closed form for OEIS A195253, proved}
...
\begin{abstract}
OEIS A195253 counts the lower triangles of a $7\times7$ array over $\{0,\dots,n\}$ in which
...
OEIS A195253 is ``Number of lower triangles of a 7X7 0..n array with each element differing from all of its diagonal, vertical, antidiagonal and horizontal neighbors by two or less.''. It has offset $1$ and begins
\[
268435456, 22876792454961, 254948725307650, 786909681200387, 1479091549959182, 2226347741716207,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 06:14:47, revision 9) these are still
...
Every $y\in\mathcal P$ has $\mathrm{sp}(y)\le 2\cdot6=12$, where $6$ is the
...
entry differ by at most $2\cdot6$.
\end{proof}
...
\[
a(n)\;=\;764465228592699\,n-2364216638005277\qquad\text{for every }n\ge11,
\]
and $\mathcal P$ has exactly $764465228592699$ elements.
\end{theorem}
...
$a(12+1)$ were computed exactly, giving slope $764465228592699$ and the stated intercept; the slope
...
First, the count reproduces all $12$ terms the entry publishes, exactly, in integer
arithmetic.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A195253.
