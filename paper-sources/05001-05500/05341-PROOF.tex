...
\title{The empirical recurrence for OEIS A280368, proved from an exact model}
...
\begin{abstract}
OEIS A280368 carries an empirical recurrence of order $4$ contributed by Colin Barker. It is true, and it is
...
OEIS A280368 is ``Binary representation of the x-axis, from the origin to the right edge, of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 259", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 10, 110, 1, 11000, 111, 1100000, 11111,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 01 2017: (Start) a(n) = 101*a(n-2) - 100*a(n-4) for n>5.
\end{quote}
...
neighbourhood to a live cell flips the ENTIRE plane, and rule 259 is read
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A280368.
