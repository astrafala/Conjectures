...
\title{The empirical closed form for OEIS A224134, proved}
...
\begin{abstract}
OEIS A224134 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A224134 is ``Number of 3 X n 0..1 arrays with rows nondecreasing and antidiagonals unimodal.''. It has offset $1$ and begins
\[
8, 27, 58, 106, 175, 269, 392, 548,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (2/3)*n\^{}3 + (5/2)*n\^{}2 + (35/6)*n for n>1.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 27 2018 06:04:42, revision 9) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{2 n^{3}}{3} + \frac{5 n^{2}}{2} + \frac{35 n}{6}.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224134.
