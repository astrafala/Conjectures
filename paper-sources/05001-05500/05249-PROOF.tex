...
\begin{abstract}
OEIS A280412 carries an empirical recurrence of order $4$ contributed by Ilya Gutkovskiy. It is true, and it is
...
\begin{quote}
Conjectures from \_Ilya Gutkovskiy\_, Jan 02 2017: (Start) a(n) = 5*a(n-2) - 4*a(n-4).
\end{quote}
