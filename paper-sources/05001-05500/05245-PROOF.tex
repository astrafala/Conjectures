...
\title{The empirical recurrence for OEIS A198205, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A198205 counts arrays in which every cell is constrained by its neighbours on \emph{both}
...
OEIS A198205 is ``Number of 2nX2 0..3 arrays with values 0..3 introduced in row major order and each element unequal to exactly two horizontal and vertical neighbors.''. It has offset $1$ and begins
\[
4, 43, 658, 11029, 189376, 3272959, 56665678, 981535273,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 23*a(n-1) -103*a(n-2) +81*a(n-3)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 07:49:26, revision 10) the statement is
...
\eqref{eq:walk2}, divided by $4!$, was evaluated at every one of the $16$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A198205.
