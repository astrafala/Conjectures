...
\title{The conjectured generating function for OEIS A250882, proved}
...
\begin{abstract}
OEIS A250882 counts arrays of a fixed width under a local condition, and carries a conjectured
...
OEIS A250882 is ``Number of (5+1) X (n+1) 0..3 arrays with nondecreasing x(i,j)-x(i,j-1) in the i direction and nondecreasing x(i,j)+x(i-1,j) in the j direction.''. It has offset $1$ and begins
\[
37130, 131068, 317878, 629528, 1097986, 1755220,\ \dots
\]
The entry states, as a conjecture contributed by a reader and never marked settled:
\begin{quote}
G.f.: 2*x*(18565 - 8726*x + 8193*x\^{}2 - 2048*x\^{}3) / (1 - x)\^{}4.
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 22 2018 14:28:45, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250882.
