...
\title{The empirical recurrence for OEIS A228217, proved by transfer matrix}
...
\begin{abstract}
OEIS A228217 carries an empirical recurrence of order $2$ contributed by R. H. Hardin. It is
...
arrays counted are exactly the walks in it; hence $a(n)$ is a walk count on $S=431$ vertices
...
OEIS A228217 is ``Number of second differences of arrays of length n+2 of numbers in 0..7.''. It has offset $1$ and begins
\[
29, 519, 7309, 88215, 951049, 9399615, 86929081, 766106895,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 15*a(n-1) -56*a(n-2) for n>15
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 26 2025 10:32:54, revision 12) this is still
...
An admissible array is then exactly a walk, and $\iota,\tau$ are the vectors recording which windows may begin and end an array, so with $M$ the adjacency matrix on $S=431$ vertices,
\[
a(n)\;=\;\iota^{\!\top}M^{\,n}\tau ,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A228217.
