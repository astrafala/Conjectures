...
\title{The empirical recurrence for OEIS A254554, proved by transfer matrix}
...
\begin{abstract}
OEIS A254554 counts the arrays over $\{0,\dots,1\}$ whose $3\times3$ subblocks carry a
...
OEIS A254554 is ``Number of (2+2)X(n+2) 0..1 arrays with every 3X3 subblock diagonal sum minus antidiagonal minimum nondecreasing horizontally, vertically and ne-to-sw antidiagonally.''. It has offset $1$ and begins
\[
2696, 9292, 34780, 111443, 375458, 1206693, 3894656, 12325300,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 14:48:41, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A254554.
