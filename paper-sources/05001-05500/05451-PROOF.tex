...
\title{The empirical recurrence for OEIS A241371, proved by transfer matrix}
...
\begin{abstract}
OEIS A241371 counts $2\times n$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A241371 is ``Number of 2 X n 0..2 arrays with no element equal to fewer vertical neighbors than horizontal neighbors, with new values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
2, 7, 28, 121, 523, 2261, 9775, 42261,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 5*a(n-1) - 2*a(n-2) - 4*a(n-3) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 30 2018 09:39:02, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A241371.
