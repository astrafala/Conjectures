...
\title{The conjectured generating function for OEIS A223211, proved}
...
\begin{abstract}
OEIS A223211 counts arrays of a fixed width under a local condition, and carries a conjectured
...
numerator. Its coefficients are the integers $c_1,\dots,c_{2}$ read off $D_2$, the first few being $2,\ 4$. The entry records no recurrence, so this is not a restatement of anything
already there.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223211.
