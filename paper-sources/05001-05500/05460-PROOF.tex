...
\title{The empirical closed form for OEIS A221684, proved}
...
\begin{abstract}
OEIS A221684 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A221684 is ``Number of 0..n arrays of length 5 with each element differing from at least one neighbor by 1 or less, starting with 0.''. It has offset $1$ and begins
\[
16, 40, 68, 100, 133, 166, 199, 232,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 33*n - 32 for n>3
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 19:52:23, revision 8) this is still
...
First, the walk model reproduces every one of the $49$ terms the entry publishes,
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221684.
