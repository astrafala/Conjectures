...
\title{The empirical recurrence for OEIS A277798, proved from an exact model}
...
\begin{abstract}
OEIS A277798 carries an empirical recurrence of order $4$ contributed by Colin Barker. It is true, and it is
...
\[
1, 0, 100, 11, 10000, 1111, 1000000, 111111,\ \dots
\]
