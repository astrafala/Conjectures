...
\title{The empirical recurrence for OEIS A298837, proved by transfer matrix}
...
\begin{abstract}
OEIS A298837 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $equal to$ itself lying in $\{2,3,4,5,8\}$, and it carries an empirical
...
OEIS A298837 is ``Number of nX4 0..1 arrays with every element equal to 2, 3, 4, 5 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
0, 6, 21, 110, 1045, 7322, 60497, 482261,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 27 2018 07:47:02, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;9\,a(n-1) + 17\,a(n-2) - 195\,a(n-3) - 301\,a(n-4) + 2160\,a(n-5) + 2724\,a(n-6) - 12908\,a(n-7) - 15160\,a(n-8) + 47906\,a(n-9) + 54649\,a(n-10) - 121788\,a(n-11) - 119168\,a(n-12) + 219680\,a(n-13) + 109795\,a(n-14) - 358602\,a(n-15) + 332162\,a(n-16) + 436116\,a(n-17) - 1047261\,a(n-18) - 907623\,a(n-19) + 1904805\,a(n-20) + 943907\,a(n-21) - 401499\,a(n-22) - 3080376\,a(n-23) + 756838\,a(n-24) + 2344863\,a(n-25) - 422428\,a(n-26) - 154363\,a(n-27) - 1739231\,a(n-28) + 1061307\,a(n-29) + 880883\,a(n-30) - 496873\,a(n-31) - 39576\,a(n-32) - 190649\,a(n-33) + 102350\,a(n-34) - 69812\,a(n-35) - 105271\,a(n-36) + 28788\,a(n-37) + 64379\,a(n-38) + 25435\,a(n-39) - 45832\,a(n-40) - 6076\,a(n-41) + 16110\,a(n-42) + 1038\,a(n-43) - 3416\,a(n-44) + 408\,a(n-45)
\end{equation}
for all $n>48$.
...
has score in $\{2,3,4,5,8\}$. The entry also fixes the top-left entry to be $0$; that is a condition on the first row alone, so it restricts the start vector and nothing else.
...
\begin{itemize}
\item $\mathbf{s}(r,s)=1$ when every cell of $r$ has score in $\{2,3,4,5,8\}$ \emph{with no row
above $r$} and $r_1=0$, and $0$ otherwise;
\item an edge $(r,s)\to(s,t)$ when every cell of $s$ has score in $\{2,3,4,5,8\}$ computed from
$r$, $s$ and $t$;
\item $\mathbf{e}(r,s)=1$ when every cell of $s$ has score in $\{2,3,4,5,8\}$ \emph{with no row
...
exactly when every one of its $n$ rows has all scores in $\{2,3,4,5,8\}$. Read the sequence as the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A298837.
