...
\title{The empirical recurrence for OEIS A185793, proved by transfer matrix}
...
\begin{abstract}
OEIS A185793 counts arrays over $\{0,\dots,1\}$ under a condition on the sum of every
$2\times2$ subblock, and carries an empirical recurrence of order $44$ contributed by
R.~H.~Hardin. It is true, and it is decidable rather than empirical. The condition is local to
a bounded window of consecutive rows, so the count is a walk count on $S=260$ states and is
...
OEIS A185793 is ``Number of (n+1)X5 binary arrays with no 2X2 subblock sum equal to any horizontal or vertical neighbor 2X2 subblock sum.''. It has offset $1$ and begins
\[
260, 576, 1336, 3756, 9368, 24392, 59944, 164576,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 03:11:25, revision 9) this is still
...
entry's first term is $260$, and the model reproduces it along with every later term; that
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-2) + a(n-3) + 88\,a(n-4) - 4\,a(n-5) - 302\,a(n-6) - 56\,a(n-7) - 3011\,a(n-8) + 230\,a(n-9) + 8945\,a(n-10) + 1175\,a(n-11) + 50431\,a(n-12) - 4786\,a(n-13) - 132374\,a(n-14) - 11295\,a(n-15) - 423460\,a(n-16) + 43810\,a(n-17) + 1037899\,a(n-18) + 43580\,a(n-19) + 1627709\,a(n-20) - 167180\,a(n-21) - 4270500\,a(n-22) + 13370\,a(n-23) - 2421933\,a(n-24) + 185580\,a(n-25) + 8757664\,a(n-26) - 114436\,a(n-27) + 689723\,a(n-28) - 14276\,a(n-29) - 9492848\,a(n-30) + 67928\,a(n-31) + 1771248\,a(n-32) - 70176\,a(n-33) + 5431680\,a(n-34) + 19712\,a(n-35) - 1877632\,a(n-36) + 8192\,a(n-37) - 1478592\,a(n-38) - 2048\,a(n-39) + 659456\,a(n-40) + 131072\,a(n-42) - 65536\,a(n-44)
\]
for every $n>45$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A185793.
