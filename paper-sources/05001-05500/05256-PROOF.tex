...
\title{The empirical closed form for OEIS A187304, proved}
...
\begin{abstract}
OEIS A187304 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
$S=20$ vertices. Any function of the form $\sum_j p_j(n)\lambda_j^{\,n}$ satisfies the
...
OEIS A187304 is ``Number of 9-step one space leftwards or up, two space rightwards or down asymmetric rook's tours on an n X n board summed over all starting positions.''. It has offset $1$ and begins
\[
0, 0, 54, 2968, 25716, 87432, 209700, 399524,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 35254*n\^{}2 - 316744*n + 644876 for n>15
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 03:53:52, revision 11) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;35254 n^{2} - 316744 n + 644876.
\]
...
walk, so with $M$ the adjacency matrix of that digraph on $S=20$ vertices, and $u,w$ the
...
$n=19,\dots,21$ and agree at each. A monic recurrence of order $3$
determines $a(m)$ from $a(m-1),\dots,a(m-3)$, and for every $m\ge22$ both
$m>18$ and $m-3\ge19$ hold, so induction on $m$ gives $a(m)=f(m)$ for every
$m\ge19$.
Below $n=19$ the recurrence argument gives nothing, since \eqref{eq:rec} is only
established for $a$ from $n=19$ on. The remaining indices $n=16,\dots,18$ were
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A187304.
