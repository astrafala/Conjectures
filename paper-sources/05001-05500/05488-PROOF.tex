...
\title{The empirical recurrence for OEIS A204303, proved by transfer matrix}
...
\begin{abstract}
OEIS A204303 counts arrays over $\{0,\dots,3\}$ under a condition on the sum of every
...
OEIS A204303 is ``Number of (n+1)X2 0..3 arrays with the sums of 2X2 subblocks nondecreasing rightwards and downwards.''. It has offset $1$ and begins
\[
256, 2400, 22500, 162000, 1166400, 7157160, 43917129, 242230104,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 11:05:10, revision 9) this is still
...
Over the alphabet $\{0,\dots,3\}$ the sum of a $2\times2$ subblock takes values in
$[0,12]$, so the colouring of the grid it induces has at most $13$ values.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204303.
