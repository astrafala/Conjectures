...
\title{The empirical recurrence for OEIS A260978, proved by transfer matrix}
...
\begin{abstract}
OEIS A260978 counts $(n+2)\times8$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
every $3\times3$ subblock, and it carries an empirical recurrence of order $45$
...
OEIS A260978 is ``Number of (n+2)X(6+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000001 00001001 or 00100101.''. It has offset $1$ and begins
\[
2755, 1873, 2576, 5506, 9144, 18706, 30418, 62878,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 12:13:37, revision 6) this is still
...
\[
\text{the clockwise perimeter word of }g\text{ is a rotation of one of }\{00000001,\ 00001001,\ 00100101\}
\]
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-2) + 4\,a(n-4) + 5\,a(n-5) - 24\,a(n-6) - 16\,a(n-7) - 5\,a(n-8) - 19\,a(n-9) + 45\,a(n-10) + 52\,a(n-11) + 93\,a(n-12) + 99\,a(n-13) - 146\,a(n-14) - 41\,a(n-15) - 248\,a(n-16) - 361\,a(n-17) - 18\,a(n-18) + 74\,a(n-19) + 403\,a(n-20) + 114\,a(n-21) + 370\,a(n-22) + 526\,a(n-23) - 274\,a(n-24) - 928\,a(n-25) - 347\,a(n-26) + 126\,a(n-27) - 792\,a(n-28) - 714\,a(n-29) + 668\,a(n-30) + 1443\,a(n-31) - 752\,a(n-32) + 268\,a(n-33) + 1848\,a(n-34) - 636\,a(n-35) - 1068\,a(n-36) + 1048\,a(n-37) + 576\,a(n-38) - 1660\,a(n-39) - 320\,a(n-40) + 808\,a(n-41) - 32\,a(n-42) - 380\,a(n-43) + 16\,a(n-44) + 192\,a(n-45)
\]
for every $n>51$.
\end{theorem}

\begin{proof}
The vector $w=q(M)\mathbf{1}$ was formed by $45$ matrix--vector products in exact
integer arithmetic and $\mathbf{1}^{\!\top}M^{j}w$ evaluated for $j=0,1,\dots$, again
exactly. Those integers vanish from the index corresponding to $n=51+1$ onwards, and the
run was continued until the working vector was identically zero, which settles all larger $j$
at once. By Lemma~\ref{lem:crit} the recurrence holds for every $n>51$.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A260978.
