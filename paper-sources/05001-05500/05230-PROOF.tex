...
\title{The empirical recurrence for OEIS A196333, proved by transfer matrix}
...
\begin{abstract}
OEIS A196333 counts $n\times4$ arrays over $\{0,\dots,4\}$ subject to a condition imposed on
...
walk, and $a(n)$ is a walk count on $S=1864$ vertices, which is $C$-finite. Whether the
...
OEIS A196333 is ``Number of nX4 0..4 arrays with each element x equal to the number its horizontal and vertical neighbors equal to 4,0,3,1,2 for x=0,1,2,3,4.''. It has offset $1$ and begins
\[
5, 17, 50, 335, 894, 3246, 14973, 64423,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 06:30:21, revision 9) this is still
...
settled by the terminal weight, which evaluates it with $\varnothing$ below. Most of those pairs are indistinguishable, and exactly so. Every offset named above has $|dj|\le 1$, so whether the cell at column $j$ of the middle row is satisfied depends on the three rows only through their windows at $j-1,j,j+1$. Collect for each $j$ the indicator over the window of the row below, and call that tuple $P(r,s)$: the number of cells any $t$ violates is read off $P$, so is the number violated at the bottom edge, and the successor $(s,t)$ carries $P(s,t)$, which does not mention $r$. Hence two pairs $(r,s)$ and $(r',s)$ with the same $P$ have the same outgoing rows and the same successors, and the vertex is $(s,P)$. That leaves $S=1864$ vertices in place of $390625$. Hence,
with $M$ the adjacency matrix on $S=1864$ vertices, $\iota$ the starting vector and $\tau$ the
terminal weight,
\[
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) - 4\,a(n-2) + 26\,a(n-4) + 56\,a(n-5) - 358\,a(n-6) - 748\,a(n-7) - 896\,a(n-8) + 909\,a(n-9) + 187\,a(n-10) - 12078\,a(n-11) + 42445\,a(n-12) + 97050\,a(n-13) + 246286\,a(n-14) + 522734\,a(n-15) + 662122\,a(n-16) - 574583\,a(n-17) - 2576076\,a(n-18) - 7793975\,a(n-19) - 18081736\,a(n-20) - 11777431\,a(n-21) - 37101001\,a(n-22) - 40924777\,a(n-23) + 19988497\,a(n-24) + 20268565\,a(n-25) + 59783847\,a(n-26) + 29293979\,a(n-27) + 59333365\,a(n-28) - 2116548\,a(n-29) - 34111094\,a(n-30) - 18558798\,a(n-31) - 28606287\,a(n-32) - 8559806\,a(n-33) - 18722495\,a(n-34) + 1768049\,a(n-35) + 8214636\,a(n-36) + 12355852\,a(n-37) + 15376\,a(n-38) + 6620070\,a(n-39) + 393935\,a(n-40) + 4096014\,a(n-41) - 2372022\,a(n-42) + 503938\,a(n-43) - 494622\,a(n-44) - 65073\,a(n-45) - 85243\,a(n-46) - 185276\,a(n-47) + 85167\,a(n-48) - 25581\,a(n-49) + 7530\,a(n-50) + 4334\,a(n-51) - 193\,a(n-52) + 967\,a(n-53) - 255\,a(n-54)
\]
for every $n>54$.
\end{theorem}
...
integers vanish from the index corresponding to $n=54+1$ onwards, and the run was
continued until the working vector was identically zero, which settles all larger $j$ at once.
By Lemma~\ref{lem:crit} the recurrence holds for every $n>54$.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A196333.
