...
\title{The empirical recurrence for OEIS A280367, proved from an exact model}
...
\begin{abstract}
OEIS A280367 carries an empirical recurrence of order $4$ contributed by Colin Barker. It is true, and it is
...
\[
1, 1, 11, 1000, 11, 111000, 11, 11111000,\ \dots
\]
