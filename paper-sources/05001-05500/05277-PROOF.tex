...
\title{The empirical recurrence for OEIS A252452, proved by transfer matrix}
...
\begin{abstract}
OEIS A252452 counts $(n+2)\times5$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252452 is ``Number of (n+2)X(3+2) 0..3 arrays with every 3X3 subblock row, column, diagonal and antidiagonal sum not equal to 0 2 4 6 or 7.''. It has offset $1$ and begins
\[
323, 959, 3366, 11334, 38966, 134907, 464384, 1603397,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:15:57, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) - 8\,a(n-2) + 31\,a(n-3) - 46\,a(n-4) - 30\,a(n-5) - 238\,a(n-6) - 338\,a(n-7) + 318\,a(n-8) + 1332\,a(n-9) + 3970\,a(n-10) + 3841\,a(n-11) - 2401\,a(n-12) - 15360\,a(n-13) - 24500\,a(n-14) - 6584\,a(n-15) + 32113\,a(n-16) + 50465\,a(n-17) + 6658\,a(n-18) - 54545\,a(n-19) - 40309\,a(n-20) + 34108\,a(n-21) + 92882\,a(n-22) + 54935\,a(n-23) - 66171\,a(n-24) - 137823\,a(n-25) - 87689\,a(n-26) + 35941\,a(n-27) + 110894\,a(n-28) + 83622\,a(n-29) + 8828\,a(n-30) - 42389\,a(n-31) - 45791\,a(n-32) - 24569\,a(n-33) - 3451\,a(n-34) + 9236\,a(n-35) + 12522\,a(n-36) + 9282\,a(n-37) + 3964\,a(n-38) + 40\,a(n-39) - 1136\,a(n-40) - 1008\,a(n-41) - 440\,a(n-42) - 144\,a(n-43) - 16\,a(n-44)
\]
for every $n>47$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252452.
