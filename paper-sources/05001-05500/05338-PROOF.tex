...
\title{The empirical recurrence for OEIS A188705, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A188705 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A188705 is ``Number of nX8 binary arrays without the pattern 0 0 diagonally or vertically.''. It has offset $1$ and begins
\[
256, 2584, 132633, 2696784, 89796720, 2275402541, 66743533552, 1808994829500,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 04:47:34, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 696\,a(n-2) + 4936\,a(n-3) - 82950\,a(n-4) - 616098\,a(n-5) + 5387228\,a(n-6) + 30950144\,a(n-7) - 229883974\,a(n-8) - 753348830\,a(n-9) + 6337764840\,a(n-10) + 7619008432\,a(n-11) - 107663412194\,a(n-12) + 25195400302\,a(n-13) + 1086657210156\,a(n-14) - 1356643892644\,a(n-15) - 6236063377412\,a(n-16) + 13454440595448\,a(n-17) + 18589078406560\,a(n-18) - 66554017839856\,a(n-19) - 19614260318346\,a(n-20) + 196396672572042\,a(n-21) - 43999810291559\,a(n-22) - 380210157189901\,a(n-23) + 198533185518402\,a(n-24) + 515556399680338\,a(n-25) - 364326844069866\,a(n-26) - 515553663974322\,a(n-27) + 415693332649386\,a(n-28) + 396870539972130\,a(n-29) - 324787601926242\,a(n-30) - 242615012285186\,a(n-31) + 179162945610905\,a(n-32) + 119013925477951\,a(n-33) - 69667408704698\,a(n-34) - 46122573377086\,a(n-35) + 18502629566324\,a(n-36) + 13618614146836\,a(n-37) - 3081687698592\,a(n-38) - 2923738668068\,a(n-39) + 237468606708\,a(n-40) + 432970226764\,a(n-41) + 13927267090\,a(n-42) - 41496410974\,a(n-43) - 5091537704\,a(n-44) + 2338817568\,a(n-45) + 488006390\,a(n-46) - 62776202\,a(n-47) - 21992324\,a(n-48) + 146568\,a(n-49) + 460978\,a(n-50) + 22438\,a(n-51) - 3972\,a(n-52) - 300\,a(n-53) + 11\,a(n-54) + a(n-55)
\end{equation}
for all $n>55$.

\section{The condition, and why one row is not enough}

The arrays have $8$ columns and $L=n$ rows; write $x_{t,u}$ for the entry in
...
Let $V=\{0,\dots,1\}^{8}$ be the possible rows and take
...
and $8$ columns. In the walk, the cells of row $t$ for $2\le t\le L-1$ are tested
...
publishes, $n=15$, the arrays have $8\cdot15$ cells over
...
of the $(1+1)^{8}$ possible next rows, the condition was tested on every cell of
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A188705.
