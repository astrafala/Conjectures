...
The model reproduces all $33$ terms the entry publishes, exactly, in integer arithmetic:
...
$A(x)=\sum_{n\ge0}a(n)x^n=N_1(x)/D_1(x)$ where $D_1(x)$ has degree at most $S=10$ and
