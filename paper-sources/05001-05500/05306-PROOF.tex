...
\title{The empirical recurrence for OEIS A305018, proved by transfer matrix}
...
\begin{abstract}
OEIS A305018 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $different from$ itself lying in $\{2,3,4,5,7\}$, and it carries an empirical
...
OEIS A305018 is ``Number of nX4 0..1 arrays with every element unequal to 2, 3, 4, 5 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
0, 18, 73, 769, 6742, 62314, 570806, 5242925,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 23 2018 16:13:22, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) + 43\,a(n-2) - 25\,a(n-3) - 866\,a(n-4) - 1292\,a(n-5) + 4913\,a(n-6) + 15127\,a(n-7) + 1776\,a(n-8) - 44842\,a(n-9) - 61696\,a(n-10) + 682\,a(n-11) + 106420\,a(n-12) + 166737\,a(n-13) + 28886\,a(n-14) - 320077\,a(n-15) - 426550\,a(n-16) + 113876\,a(n-17) + 780489\,a(n-18) + 700471\,a(n-19) - 246971\,a(n-20) - 1167585\,a(n-21) - 904392\,a(n-22) + 425268\,a(n-23) + 1326480\,a(n-24) + 800991\,a(n-25) - 487720\,a(n-26) - 1090901\,a(n-27) - 568273\,a(n-28) + 242052\,a(n-29) + 520866\,a(n-30) + 217197\,a(n-31) - 96704\,a(n-32) - 120858\,a(n-33) - 17124\,a(n-34) + 32415\,a(n-35) + 11892\,a(n-36) - 2872\,a(n-37) - 2134\,a(n-38) - 726\,a(n-39) + 146\,a(n-40) + 116\,a(n-41) - 6\,a(n-42)
\end{equation}
for all $n>44$.
...
has score in $\{2,3,4,5,7\}$. The entry also fixes the top-left entry to be $0$; that is a condition on the first row alone, so it restricts the start vector and nothing else.
...
\begin{itemize}
\item $\mathbf{s}(r,s)=1$ when every cell of $r$ has score in $\{2,3,4,5,7\}$ \emph{with no row
above $r$} and $r_1=0$, and $0$ otherwise;
\item an edge $(r,s)\to(s,t)$ when every cell of $s$ has score in $\{2,3,4,5,7\}$ computed from
$r$, $s$ and $t$;
\item $\mathbf{e}(r,s)=1$ when every cell of $s$ has score in $\{2,3,4,5,7\}$ \emph{with no row
...
exactly when every one of its $n$ rows has all scores in $\{2,3,4,5,7\}$. Read the sequence as the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A305018.
