...
\title{The empirical column recurrences for the table OEIS A250973}
...
\begin{abstract}
OEIS A250973 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A250973 is ``T(n,k)=Number of (n+1)X(k+1) 0..1 arrays with no 2X2 subblock having the sum of its diagonal elements less than the absolute difference of its antidiagonal elements.''. It has offset $1$, is
read by antidiagonals, and begins
\[
14, 49, 49, 172, 308, 172, 604, 1945,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 12:55:51, revision 6) these are still
...
The sequence is ``Number of (n+1)X(2) 0..1 arrays with no 2X2 subblock having the sum of its diagonal elements less than the absolute difference of its antidiagonal elements.''. Its rows are the vertices of a digraph on
...
The sequence is ``Number of (n+1)X(3) 0..1 arrays with no 2X2 subblock having the sum of its diagonal elements less than the absolute difference of its antidiagonal elements.''. Its rows are the vertices of a digraph on
$S=8$ vertices, edges being the admissible consecutive pairs, and the count is
$\mathbf{1}^{\!\top}M^{n}\mathbf{1}$ up to the constant factor in the entry's name.
The conjectured recurrence
\[
a(n)\;=\;8\,a(n-1) - 13\,a(n-2) + 17\,a(n-3) - 14\,a(n-4) + 3\,a(n-5)
\]
...
$c_{1}$ & $16$ & $c_{4}$ & $-492$ & $c_{7}$ & $389$ &  &  \\
$c_{2}$ & $-68$ & $c_{5}$ & $705$ & $c_{8}$ & $-120$ &  &  \\
$c_{3}$ & $210$ & $c_{6}$ & $-675$ & $c_{9}$ & $20$ &  &  \\
...
\begin{center}\small\begin{tabular}{cccccccc}
$c_{1}$ & $32$ & $c_{6}$ & $-142463$ & $c_{11}$ & $223620$ & $c_{16}$ & $-712$ \\
$c_{2}$ & $-322$ & $c_{7}$ & $321616$ & $c_{12}$ & $-61118$ & $c_{17}$ & $60$ \\
$c_{3}$ & $2227$ & $c_{8}$ & $-516143$ & $c_{13}$ & $2048$ &  &  \\
$c_{4}$ & $-12086$ & $c_{9}$ & $570208$ & $c_{14}$ & $-581$ &  &  \\
$c_{5}$ & $47762$ & $c_{10}$ & $-437734$ & $c_{15}$ & $2307$ &  &  \\
\end{tabular}\end{center}
...
\[
(c_1,\dots,c_{31})=(64,\ -1446,\ 21783,\ -257090,\ 2364533,\ -17301630,\ 102437299,\ -484439145,\ 1808535109,\ -5311996643,\ 12229385847,\ -21849236431,\ 29285048520,\ -26153502129,\ 7239648236,\ 20967448076,\ -41791947829,\ 41249669536,\ -19653544893,\ -9216125179,\ 29489025257,\ -33624035531,\ 25340528985,\ -13860558578,\ 5642370770,\ -1727464741,\ 397748431,\ -68146076,\ 8635216,\ -707328,\ 35280).
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250973.
