...
\title{The empirical recurrence for OEIS A252437, proved by transfer matrix}
...
\begin{abstract}
OEIS A252437 counts $6\times(n+2)$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
$a(n)$ is a walk count on $S=202215$ vertices. Such a sequence is $C$-finite, so whether a given
...
OEIS A252437 is ``Number of (4+2)X(n+2) 0..3 arrays with every 3X3 subblock row and diagonal sum equal to 0 2 4 6 or 7 and every 3X3 column and antidiagonal sum not equal to 0 2 4 6 or 7.''. It has offset $1$ and begins
\[
878, 1801, 3954, 7575, 26396, 74892, 151863, 530739,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:14:18, revision 6) this is still
...
\[
\text{every row, diagonal sum} \in \{0,2,4,6,7\}\ \text{ and }\ \text{every column, antidiagonal sum} \notin \{0,2,4,6,7\}
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252437.
