...
\title{The empirical recurrence for OEIS A298457, proved by transfer matrix}
...
\begin{abstract}
OEIS A298457 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $equal to$ itself lying in $\{2,3,4,5,6\}$, and it carries an empirical
...
OEIS A298457 is ``Number of nX4 0..1 arrays with every element equal to 2, 3, 4, 5 or 6 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
0, 6, 30, 219, 2013, 17443, 158594, 1441287,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 19 2018 08:51:37, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;7\,a(n-1) + 40\,a(n-2) - 123\,a(n-3) - 680\,a(n-4) + 347\,a(n-5) + 4732\,a(n-6) + 2213\,a(n-7) - 12148\,a(n-8) - 9856\,a(n-9) + 13303\,a(n-10) + 9511\,a(n-11) - 16969\,a(n-12) - 15182\,a(n-13) + 4983\,a(n-14) - 83456\,a(n-15) + 656\,a(n-16) + 68\,a(n-17) + 84770\,a(n-18) - 229109\,a(n-19) + 383194\,a(n-20) - 225637\,a(n-21) - 22337\,a(n-22) + 333076\,a(n-23) - 535303\,a(n-24) + 416644\,a(n-25) - 342719\,a(n-26) + 207071\,a(n-27) - 34879\,a(n-28) - 18892\,a(n-29) + 22620\,a(n-30) - 25205\,a(n-31) + 25909\,a(n-32) - 15562\,a(n-33) + 8687\,a(n-34) - 6879\,a(n-35) + 3110\,a(n-36) - 492\,a(n-37)
\end{equation}
for all $n>38$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A298457.
