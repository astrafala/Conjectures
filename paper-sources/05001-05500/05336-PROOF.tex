...
\title{The empirical recurrence for OEIS A250637, proved by transfer matrix}
...
\begin{abstract}
OEIS A250637 counts arrays over $\{0,1,2\}$ in which a statistic taken over short runs
...
OEIS A250637 is ``Number of (5+1)X(n+1) 0..2 arrays with nondecreasing x(i,j)+x(i,j-1) in the i direction and nondecreasing min(x(i,j),x(i-1,j)) in the j direction.''. It has offset $1$ and begins
\[
2856, 20743, 134878, 747039, 3719562, 17202711, 75537881, 319253573,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 12:38:03, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250637.
