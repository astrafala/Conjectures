...
\title{The empirical recurrence for OEIS A253744, proved by transfer matrix}
...
\begin{abstract}
OEIS A253744 counts the arrays over $\{0,\dots,2\}$ whose $2\times2$ subblocks carry a
...
so a pair of consecutive array rows is a state, the count is a walk count on $S=1998$ of them,
...
OEIS A253744 is ``Number of (n+1)X(3+1) 0..2 arrays with every 2X2 subblock ne-sw antidiagonal difference nondecreasing horizontally and nw+se diagonal sum nondecreasing vertically.''. It has offset $1$ and begins
\[
1998, 10182, 77414, 382973, 1636717, 5648005, 17980643, 52078415,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 14:12:18, revision 6) this is still
...
\]
on the $S=1998$ admissible pairs. In particular $a$ is $C$-finite. The alignment of the walk
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-1) - 19\,a(n-2) + 24\,a(n-3) - 6\,a(n-4) - 41\,a(n-5) + 105\,a(n-6) - 121\,a(n-7) + 34\,a(n-8) + 108\,a(n-9) - 232\,a(n-10) + 235\,a(n-11) - 48\,a(n-12) - 163\,a(n-13) + 253\,a(n-14) - 209\,a(n-15) + 10\,a(n-16) + 148\,a(n-17) - 130\,a(n-18) + 67\,a(n-19) + 26\,a(n-20) - 79\,a(n-21) + 19\,a(n-22) + 13\,a(n-23) - 14\,a(n-24) + 24\,a(n-25) - 7\,a(n-27) - 4\,a(n-28) - 5\,a(n-29) + 7\,a(n-30) - 3\,a(n-31) + 3\,a(n-32) + a(n-33) - 3\,a(n-34) + a(n-35)
\]
for every $n>45$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253744.
