...
\title{Arrays counted up to renaming: the empirical recurrence for OEIS A205620}
...
\begin{abstract}
OEIS A205620 carries an empirical recurrence of order $4$ contributed by R.~H.~Hardin. It is
...
OEIS A205620 is ``Number of (n+1) X 3 0..2 arrays with every 2 X 2 subblock in a row having an equal number of equal diagonal or equal antidiagonal elements, adjacent rows differing in this number, and new values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
50, 306, 2052, 13800, 92934, 625512, 4211904, 28351440,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 12 2018 09:49:34, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;40\,a(n-2) + 40\,a(n-3) - 28\,a(n-4)
\]
for every $n>5$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A205620.
