...
\title{The empirical recurrence for OEIS A230271, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A230271 counts arrays over $\{0,\dots,2\}$ in which every cell is constrained by the
...
OEIS A230271 is ``Number of nX4 0..2 arrays x(i,j) with each element horizontally or vertically next to at least one element with value (x(i,j)+1) mod 3, and upper left element zero.''. It has offset $1$ and begins
\[
0, 8, 258, 5734, 115630, 2348840, 47524048, 960953664,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 05:49:25, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;32\,a(n-1) - 253\,a(n-2) - 23\,a(n-3) + 7788\,a(n-4) - 23108\,a(n-5) - 68995\,a(n-6) + 486597\,a(n-7) - 945385\,a(n-8) + 1878820\,a(n-9) - 4005328\,a(n-10) - 30758253\,a(n-11) + 205234979\,a(n-12) - 495083591\,a(n-13) + 715035720\,a(n-14) - 1028797009\,a(n-15) + 1669240904\,a(n-16) - 2143236961\,a(n-17) + 1938990337\,a(n-18) - 964345338\,a(n-19) - 398834793\,a(n-20) + 634628137\,a(n-21) + 100251914\,a(n-22) + 609976551\,a(n-23) - 900597318\,a(n-24) - 118049796\,a(n-25) - 55188026\,a(n-26) + 299145317\,a(n-27) + 64433942\,a(n-28) - 112668037\,a(n-29) + 85226423\,a(n-30) - 117488386\,a(n-31) + 20732900\,a(n-32) + 39375976\,a(n-33) - 14555736\,a(n-34)
\end{equation}
for all $n>35$.
...
$3$ values, so there are about $10^{32}$ of them to sift. The
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A230271.
