...
\title{The empirical recurrence for OEIS A280955, proved by transfer matrix}
...
\begin{abstract}
OEIS A280955 counts $n\times2$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A280955 is ``Number of n X 2 0..2 arrays with no element equal to more than one of its horizontal, vertical and antidiagonal neighbors and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
2, 9, 42, 205, 997, 4850, 23593, 114769,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) + 4*a(n-2) + a(n-3) for n>4.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 15 2019 04:29:38, revision 9) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A280955.
