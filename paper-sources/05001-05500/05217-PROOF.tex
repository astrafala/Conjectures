...
\title{The empirical recurrence for OEIS A222892, proved by transfer matrix}
...
\begin{abstract}
OEIS A222892 counts arrays in which no entry may equal the entries at a short list of fixed offsets
...
$2$ consecutive rows, $S=176708$ states in all.
\end{abstract}
...
OEIS A222892 is ``Number of n X 3 0..7 arrays with no element equal to another at a city block distance of exactly two, and new values 0..7 introduced in row major order.''. It has offset $1$ and begins
\[
3, 34, 991, 84521, 11047723, 1639681049, 251412693667, 38863548783281,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 211*a(n-1) - 9385*a(n-2) + 110913*a(n-3) - 253890*a(n-4) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 16 2018 13:23:06, revision 8) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=176708.
\]
...
\begin{theorem}
\[
a(n)\;=\;211\,a(n-1) - 9385\,a(n-2) + 110913\,a(n-3) - 253890\,a(n-4)
\]
for every $n>6$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A222892.
