...
\title{The empirical recurrence for OEIS A283504, proved from an exact model}
...
\begin{abstract}
OEIS A283504 carries an empirical recurrence of order $3$ contributed by Colin Barker. It is true, and it is
...
\[
1, 0, 101, 1100, 11101, 111100, 1111101, 11111100,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Mar 10 2017: (Start) a(n) = 10*a(n-1) + a(n-2) - 10*a(n-3) for n>3.
\end{quote}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A283504.
