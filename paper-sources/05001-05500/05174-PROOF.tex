...
\title{The empirical column recurrences for the table OEIS A259524}
...
\begin{abstract}
OEIS A259524 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A259524 is ``T(n,k)=Number of (n+1)X(k+1) 0..1 arrays with each 2X2 subblock having clockwise pattern 0000 0001 0011 0101 or 1111.''. It has offset $1$, is
read by antidiagonals, and begins
\[
12, 38, 38, 120, 208, 120, 380, 1122,\ \dots
\]
...
k=6: [order 71]\\
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:52:59, revision 6) these are still
...
The sequence is ``Number of (n+1)X2 0..1 arrays with each 2X2 subblock having clockwise pattern 0000 0001 0011 0101 or 1111.''. Its rows are the vertices of a digraph on
...
The sequence is ``Number of (n+1)X3 0..1 arrays with each 2X2 subblock having clockwise pattern 0000 0001 0011 0101 or 1111.''. Its rows are the vertices of a digraph on
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A259524.
