...
\title{The empirical recurrence for OEIS A269091, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A269091 counts arrays over $\{0,\dots,3\}$ subject to a condition on the array as a
...
OEIS A269091 is ``Number of n X 2 0..3 arrays with some element plus some horizontally or vertically adjacent neighbor totalling three exactly once.''. It has offset $1$ and begins
\[
4, 96, 1152, 11424, 103488, 889056, 7375872, 59698464,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 14*a(n-1) -49*a(n-2) for n>3.
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 21 2018 11:53:10, revision 7) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269091.
