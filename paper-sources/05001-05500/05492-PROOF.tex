...
\title{The empirical recurrence for OEIS A210158, proved by counting patterns}
...
\begin{abstract}
OEIS A210158 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A210158 is ``Number of (n+1) X 2 0..3 arrays with every 2 X 2 subblock having two or three distinct values, and new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
13, 148, 1977, 27720, 393649, 5608216, 79963353, 1140367704,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 16*a(n-1) - 19*a(n-2) - 80*a(n-3) - 36*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 14 2018 15:35:19, revision 10) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;16\,a(n-1) - 19\,a(n-2) - 80\,a(n-3) - 36\,a(n-4)
\end{equation}
for all $n>4$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A210158.
