...
\title{The white squares of a board: OEIS A230651}
...
\begin{abstract}
OEIS A230651 carries an empirical recurrence of order $46$ contributed by R.~H.~Hardin. It is
...
walks in it. Hence $a(n)$ is a walk count on $S=82$ vertices and is $C$-finite, and whether the
...
OEIS A230651 is ``Number of nX7 0..2 white square subarrays x(i,j) with each element diagonally or antidiagonally next to at least one element with value 2-x(i,j).''. It has offset $1$ and begins
\[
0, 63, 231, 11745, 90393, 3951657, 31908483, 1374288243,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 08:44:06, revision 6) this is still
...
Merging vertices with identical futures leaves $S=82$. An admissible board is exactly a walk, so with $M$ the adjacency matrix and $\iota,\tau$ the vectors recording which states may begin and end a board,
\[
...
\begin{theorem}
\[
a(n)\;=\;390\,a(n-2) - 14687\,a(n-4) + 146138\,a(n-6) - 823339\,a(n-8) - 2774563\,a(n-10) + 26807114\,a(n-12) - 60400888\,a(n-14) + 106367378\,a(n-16) - 35490451\,a(n-18) - 7548040169\,a(n-20) + 1542760687\,a(n-22) + 7961883650\,a(n-24) + 3473400076\,a(n-26) + 61902164677\,a(n-28) + 25546220017\,a(n-30) + 84369583536\,a(n-32) + 75320917456\,a(n-34) + 42723111397\,a(n-36) - 5387877662\,a(n-38) + 926204972\,a(n-40) - 121037200\,a(n-42) + 10124352\,a(n-44) + 414720\,a(n-46)
\]
for every $n>47$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A230651.
