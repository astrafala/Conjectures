...
\title{The empirical recurrence for OEIS A223477, proved by transfer matrix}
...
\begin{abstract}
OEIS A223477 counts the ways of writing the vertices of a fixed graph $G$ into an array of width
...
OEIS A223477 is ``Rolling icosahedron face footprints: number of n X 5 0..19 arrays starting with 0 where 0..19 label faces of an icosahedron and every array movement to a horizontal or antidiagonal neighbor moves across an icosahedral edge.''. It has offset $1$ and begins
\[
81, 3375, 147825, 6526575, 288507825, 12755926575, 563999907825, 24937217326575,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 51*a(n-1) - 300*a(n-2).
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 20 2018 13:30:45, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223477.
