...
\title{The empirical recurrence for OEIS A235194, proved by transfer matrix}
...
\begin{abstract}
OEIS A235194 counts $5$-column arrays over $\{0,\dots,6\}$ in which every
...
OEIS A235194 is ``Number of (n+1) X (4+1) 0..6 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 5, with no adjacent elements equal (constant-stress tilted 1 X 1 tilings).''. It has offset
$1$ and begins
\[
7072, 15604, 35868, 96848, 261760, 774140, 2263256,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 19 2022 03:33:56, revision 10) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A235194.
