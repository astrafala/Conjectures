...
\title{The empirical recurrence for OEIS A193643, proved by transfer matrix}
...
\begin{abstract}
OEIS A193643 carries an empirical recurrence of order $3$ contributed by R. H. Hardin. It is
...
OEIS A193643 is ``Number of arrays of -3..3 integers x(1..n) with every x(i) in a subsequence of length 1 or 2 with sum zero.''. It has offset $1$ and begins
\[
1, 7, 19, 67, 217, 721, 2377, 7855,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) +4*a(n-2) +a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 05:59:55, revision 15) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A193643.
