...
\title{The empirical recurrence for OEIS A269761, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A269761 counts arrays over $\{0,\dots,5\}$ subject to a condition on the array as a
...
OEIS A269761 is ``Number of n X 2 0..5 arrays with some element plus some horizontally or vertically adjacent neighbor totalling five exactly once.''. It has offset $1$ and begins
\[
6, 480, 17520, 524160, 14288400, 368958240, 9195061680, 223482006720,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 42*a(n-1) - 441*a(n-2) for n>3.
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 28 2019 11:17:20, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;42\,a(n-1) - 441\,a(n-2)
\end{equation}
for all $n>3$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269761.
