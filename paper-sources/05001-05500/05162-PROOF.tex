...
\title{The empirical recurrence for OEIS A239594, proved by transfer matrix}
...
\begin{abstract}
OEIS A239594 counts arrays over $\{0,1,2,3\}$ in which no entry may equal, modulo $4$, a given
...
count is then a walk count on $S=10$ states.
\end{abstract}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A239594.
