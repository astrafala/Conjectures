...
\title{A condition on each element and its neighbours: OEIS A241346}
...
\begin{abstract}
OEIS A241346 carries an empirical recurrence of order $46$ contributed by R.~H.~Hardin. It is
...
OEIS A241346 is ``Number of nX3 0..3 arrays with no element equal to the same number of vertical neighbors as horizontal neighbors, with new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
1, 5, 36, 415, 4671, 56166, 670557, 8072717,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 11:13:09, revision 6) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{The count is a walk count}

The entry counts arrays with $3$ columns over the alphabet $\{0,1,2,3\}$, growing one row at a time. Its condition is that every element must equal a different number of its vertical neighbours than it does of its horizontal neighbours.
...
Vertices with identical futures are merged, which leaves $S=47$. An admissible array is exactly a walk, so with $M$ the adjacency matrix and $\iota,\tau$ the vectors recording which states may begin and end an array,
\[
...
\begin{theorem}
\[
a(n)\;=\;14\,a(n-1) + 2\,a(n-2) - 304\,a(n-3) - 109\,a(n-4) - 120\,a(n-5) + 11665\,a(n-6) + 16834\,a(n-7) - 110416\,a(n-8) + 63506\,a(n-9) - 74013\,a(n-10) + 40580\,a(n-11) - 136787\,a(n-12) - 1488012\,a(n-13) + 9916298\,a(n-14) - 7619862\,a(n-15) - 2854623\,a(n-16) + 3890412\,a(n-17) - 49074293\,a(n-18) + 58902968\,a(n-19) + 35481948\,a(n-20) - 32206512\,a(n-21) - 20827271\,a(n-22) + 37759024\,a(n-23) + 63418073\,a(n-24) - 317101342\,a(n-25) - 37632842\,a(n-26) + 275998336\,a(n-27) + 155422933\,a(n-28) - 148426616\,a(n-29) - 445805769\,a(n-30) - 69698722\,a(n-31) + 227493784\,a(n-32) + 602975134\,a(n-33) + 162334197\,a(n-34) - 397623252\,a(n-35) + 185512491\,a(n-36) + 854472780\,a(n-37) + 675012366\,a(n-38) - 242801226\,a(n-39) - 302098329\,a(n-40) + 152941284\,a(n-41) + 99707517\,a(n-42) - 219662280\,a(n-43) - 390431988\,a(n-44) - 229582512\,a(n-45) - 43046721\,a(n-46)
\]
for every $n>47$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A241346.
