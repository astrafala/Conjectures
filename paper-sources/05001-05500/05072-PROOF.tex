...
\title{The empirical recurrence for OEIS A261291, proved by transfer matrix}
...
\begin{abstract}
OEIS A261291 counts $(n+2)\times9$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A261291 is ``Number of (n+2)X(7+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000001 00010101 or 01010101.''. It has offset $1$ and begins
\[
1015, 1361, 4715, 14106, 48435, 153144, 561724, 1703644,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 14 2015 07:17:23, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-2) + 72\,a(n-4) + 126\,a(n-6) - 504\,a(n-8) - 183\,a(n-10) + 2017\,a(n-12) - 433\,a(n-14) - 4301\,a(n-16) + 4487\,a(n-18) - 20226\,a(n-20) + 67671\,a(n-22) - 85069\,a(n-24) + 15742\,a(n-26) + 113631\,a(n-28) - 145965\,a(n-30) - 77933\,a(n-32) + 581282\,a(n-34) - 888710\,a(n-36) + 370130\,a(n-38) + 202679\,a(n-40) - 271169\,a(n-42) + 90087\,a(n-44) + 41519\,a(n-46) - 19825\,a(n-48) + 1820\,a(n-50) + 70\,a(n-52) - 892\,a(n-54) - 416\,a(n-56) - 64\,a(n-58)
\]
for every $n>69$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A261291.
