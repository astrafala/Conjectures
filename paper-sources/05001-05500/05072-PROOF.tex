...
\title{The empirical closed form for OEIS A224000, proved}
...
\begin{abstract}
OEIS A224000 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A224000 is ``Number of 2 X n 0..2 arrays with antidiagonals unimodal and rows and diagonals nondecreasing.''. It has offset $1$ and begins
\[
9, 31, 76, 155, 281, 469, 736, 1101,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (1/12)*n\^{}4 + 1*n\^{}3 + (41/12)*n\^{}2 + (7/2)*n + 1.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 25 2018 16:15:40, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{n^{4}}{12} + n^{3} + \frac{41 n^{2}}{12} + \frac{7 n}{2} + 1.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224000.
