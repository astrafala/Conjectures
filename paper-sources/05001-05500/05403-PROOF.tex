...
\title{The empirical recurrence for OEIS A295915, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A295915 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A295915 is ``Number of nX5 0..1 arrays with each 1 adjacent to 0 or 3 king-move neighboring 1s.''. It has offset $1$ and begins
\[
13, 60, 337, 1880, 10290, 56955, 314044, 1732883,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 29 2017 18:14:57, revision 4) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A295915.
