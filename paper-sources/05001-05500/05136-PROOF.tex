...
\title{The empirical recurrence for OEIS A252674, proved by transfer matrix}
...
\begin{abstract}
OEIS A252674 counts $(n+2)\times5$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
every $3\times3$ subblock, and it carries an empirical recurrence of order $51$
...
OEIS A252674 is ``Number of (n+2)X(3+2) 0..3 arrays with every 3X3 subblock row and diagonal sum equal to 0 2 5 6 or 7 and every 3X3 column and antidiagonal sum not equal to 0 2 5 6 or 7.''. It has offset $1$ and begins
\[
901, 1005, 2106, 4298, 11543, 28363, 64640, 181608,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:30:37, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;38\,a(n-3) - 510\,a(n-6) + 3407\,a(n-9) - 14867\,a(n-12) + 49887\,a(n-15) - 127941\,a(n-18) + 243668\,a(n-21) - 347849\,a(n-24) + 360411\,a(n-27) - 231887\,a(n-30) + 57472\,a(n-33) + 13006\,a(n-36) - 6088\,a(n-39) + 1361\,a(n-42) - 53\,a(n-45) - 62\,a(n-48) + 8\,a(n-51)
\]
for every $n>53$.
\end{theorem}

\begin{proof}
The vector $w=q(M)\mathbf{1}$ was formed by $51$ matrix--vector products in exact
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252674.
