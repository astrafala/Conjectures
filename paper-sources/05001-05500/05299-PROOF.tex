...
\title{The empirical recurrence for OEIS A302885, proved by transfer matrix}
...
\begin{abstract}
OEIS A302885 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A302885 is ``Number of n X 4 0..1 arrays with every element equal to 0, 2, 3, 4 or 5 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 20, 53, 238, 1102, 5570, 28594, 149206,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 06 2026 21:24:49, revision
6) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;7\,a(n-1) - 6\,a(n-2) - 5\,a(n-3) - 32\,a(n-4) - 130\,a(n-5) + 86\,a(n-6) + 185\,a(n-7) + 394\,a(n-8) + 1235\,a(n-9) - 26\,a(n-10) - 384\,a(n-11) - 751\,a(n-12) - 6365\,a(n-13) - 1429\,a(n-14) - 3066\,a(n-15) - 469\,a(n-16) + 4458\,a(n-17) + 2506\,a(n-18) + 1808\,a(n-19) + 2590\,a(n-20) + 761\,a(n-21) - 73\,a(n-22) + 453\,a(n-23) - 497\,a(n-24) - 885\,a(n-25) - 107\,a(n-26) + 36\,a(n-27) - 329\,a(n-28) - 40\,a(n-29) + 74\,a(n-30) - 28\,a(n-31) - 22\,a(n-32) + 28\,a(n-33) + 20\,a(n-34) + 4\,a(n-35)
\end{equation}
for all $n>37$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302885.
