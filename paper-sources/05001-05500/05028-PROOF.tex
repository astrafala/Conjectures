...
\title{The empirical recurrence for OEIS A193645, proved by transfer matrix}
...
\begin{abstract}
OEIS A193645 carries an empirical recurrence of order $3$ contributed by R. H. Hardin. It is
...
OEIS A193645 is ``Number of arrays of -5..5 integers x(1..n) with every x(i) in a subsequence of length 1 or 2 with sum zero.''. It has offset $1$ and begins
\[
1, 11, 31, 151, 561, 2361, 9361, 38171,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) +8*a(n-2) +a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (May 04 2018 22:41:15, revision 11) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A193645.
