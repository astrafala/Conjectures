...
\title{The empirical recurrence for OEIS A237540, proved by transfer matrix}
...
\begin{abstract}
OEIS A237540 counts arrays over $\{0,\dots,3\}$ subject to a condition on the order
...
The condition is local to two consecutive rows, so the count is a walk count on $S=1888$
...
OEIS A237540 is ``Number of (n+1)X(2+1) 0..3 arrays with the maximum plus the lower median minus the upper median minus the minimum of every 2X2 subblock differing from its horizontal and vertical neighbors by exactly one.''. It has offset $1$ and begins
\[
1888, 25280, 344128, 4672896, 63456608, 862467040, 11715351424, 159023453952,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 10:16:00, revision 6) this is still
...
differ by $1$. The entry's first term $1888$ counts those, and the model was made to
...
\]
over the $S=1888$ pairs whose own subblock row already satisfies the condition along itself.
...
\begin{theorem}
\[
a(n)\;=\;33284\,a(n-4) + 25223312\,a(n-8) + 9872851088\,a(n-12) + 1714176739904\,a(n-16) + 117040615631104\,a(n-20) - 15333075217254400\,a(n-24) + 298524650406981632\,a(n-28) - 1514873805416611840\,a(n-32) - 6055029689993396224\,a(n-36) + 62325077822438113280\,a(n-40) - 94646495250940428288\,a(n-44) + 39539525251177119744\,a(n-48)
\]
for every $n>50$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237540.
