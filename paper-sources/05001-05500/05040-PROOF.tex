...
\title{The empirical recurrence for OEIS A204625, proved by counting patterns}
...
\begin{abstract}
OEIS A204625 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A204625 is ``Number of (n+1) X 4 0..2 arrays with every 2 X 2 subblock having unequal diagonal elements or unequal antidiagonal elements, and new values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
768, 43734, 2490558, 141832254, 8077061502, 459972403614, 26194503047262, 1491724252385406,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 60*a(n-1) - 175*a(n-2) + 68*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 07 2018 14:24:15, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;60\,a(n-1) - 175\,a(n-2) + 68\,a(n-3)
\end{equation}
for all $n>3$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204625.
