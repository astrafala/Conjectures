...
\title{The empirical closed form for OEIS A187030, proved}
...
\begin{abstract}
OEIS A187030 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A187030 is ``Number of 5-step one or two collinear space at a time queen's tours on an n X n board summed over all starting positions.''. It has offset $1$ and begins
\[
0, 0, 5120, 45152, 161256, 376248, 696992, 1121176,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 50272*n\^{}2 - 328792*n + 534104 for n>7
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 03:51:19, revision 10) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;50272 n^{2} - 328792 n + 534104.
\]
...
$n=11,\dots,13$ and agree at each. A monic recurrence of order $3$
determines $a(m)$ from $a(m-1),\dots,a(m-3)$, and for every $m\ge14$ both
$m>10$ and $m-3\ge11$ hold, so induction on $m$ gives $a(m)=f(m)$ for every
$m\ge11$.
Below $n=11$ the recurrence argument gives nothing, since \eqref{eq:rec} is only
established for $a$ from $n=11$ on. The remaining indices $n=8,\dots,10$ were
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A187030.
