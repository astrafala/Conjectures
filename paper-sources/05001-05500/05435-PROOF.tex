...
\title{The empirical recurrence for OEIS A183723, proved by transfer matrix}
...
\begin{abstract}
OEIS A183723 counts arrays of width $4$ over $\{0,1,\dots,5\}$ subject to a condition read round the
perimeter of every $2\times2$ subblock: every subblock turns strictly one way with a single decrease, and some two adjacent subblocks turn the same way. The entry carries an empirical recurrence of
...
count is a walk count on a finite digraph with $S=2017$ vertices, and whether a linear
...
OEIS A183723 is ``1/12 the number of (n+1) X 4 0..5 arrays with every 2 X 2 subblock strictly increasing clockwise or counterclockwise with one decrease, and at least two adjacent blocks having the same increasing direction.''. It has offset $1$ and begins
\[
12, 29, 124, 1790, 30939, 525895, 8439116, 130610844,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 06 2015 22:03:13, revision 7) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The arrays have $4$ columns and a growing number of rows, with entries in $\{0,1,\dots,5\}$. A
...
The entry asks in addition that at least two adjacent subblocks ---adjacent meaning one step right or one step down in the grid of subblocks---have the same increasing direction. That is a condition on the array as a whole, not on any one subblock. The entry publishes $1/12$ of that count; the division is by the constant 12 and changes nothing about the recurrence.
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=2017,
\]
...
\begin{theorem}
\[
a(n)\;=\;22\,a(n-1) - 8\,a(n-2) - 2038\,a(n-3) + 4849\,a(n-4) + 60267\,a(n-5) - 204061\,a(n-6) - 712337\,a(n-7) + 3325947\,a(n-8) + 3154325\,a(n-9) - 27076488\,a(n-10) + 4020761\,a(n-11) + 122413547\,a(n-12) - 93348742\,a(n-13) - 325835425\,a(n-14) + 402806197\,a(n-15) + 514609889\,a(n-16) - 925150963\,a(n-17) - 439511369\,a(n-18) + 1310144478\,a(n-19) + 86470889\,a(n-20) - 1199641648\,a(n-21) + 219926386\,a(n-22) + 717789749\,a(n-23) - 257447414\,a(n-24) - 276848427\,a(n-25) + 139910715\,a(n-26) + 66195171\,a(n-27) - 44059046\,a(n-28) - 8998172\,a(n-29) + 8348721\,a(n-30) + 522019\,a(n-31) - 936761\,a(n-32) + 15437\,a(n-33) + 58686\,a(n-34) - 3505\,a(n-35) - 1816\,a(n-36) + 147\,a(n-37) + 21\,a(n-38) - 2\,a(n-39)
\]
for every $n>39$.
\end{theorem}
...
array of the stated width and a few rows was written out cell by cell over $\{0,1,\dots,5\}$, each of
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A183723.
