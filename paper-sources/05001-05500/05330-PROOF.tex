...
\title{The empirical closed form for OEIS A187509, proved}
...
\begin{abstract}
OEIS A187509 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A187509 is ``Number of 4-step S, E, and NW-moving king's tours on an n X n board summed over all starting positions.''. It has offset $1$ and begins
\[
0, 2, 36, 115, 236, 399, 604, 851,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 21*n\^{}2 - 68*n + 51 for n>2.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 23 2025 00:02:18, revision 16) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A187509.
