...
\title{The empirical recurrence for OEIS A277797, proved from an exact model}
...
\begin{abstract}
OEIS A277797 carries an empirical recurrence of order $4$ contributed by Colin Barker. It is true, and it is
...
OEIS A277797 is ``Binary representation of the x-axis, from the left edge to the origin, of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 1", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 0, 1, 1100, 1, 111100, 1, 11111100,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Nov 01 2016: (Start) a(n) = 101*a(n-2) - 100*a(n-4) for n>3.
\end{quote}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A277797.
