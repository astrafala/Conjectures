...
\title{The empirical closed form and generating function for OEIS A195003, proved}
...
\begin{abstract}
OEIS A195003 counts the lower triangles of a $7\times7$ array over $\{0,\dots,n\}$ in which
...
OEIS A195003 is ``Number of lower triangles of a 7 X 7 0..n array with each element differing from all of its horizontal and vertical neighbors by one.''. It has offset $1$ and begins
\[
2, 69632, 641376, 2059822, 3816148, 5740166,\ \dots
\]
...
Empirical g.f.: 2*x*(1 + 34814*x + 251057*x\^{}2 + 423351*x\^{}3 + 168940*x\^{}4 + 83846*x\^{}5 + 11198*x\^{}6 + 5063*x\^{}7 + 284*x\^{}8 + 139*x\^{}9 + 2*x\^{}10 + x\^{}11) / (1 - x)\^{}2. - \_Colin Barker\_, May 06 2018
\end{quote}
As of the ``Last modified'' line on the live entry (May 06 2018 10:12:56, revision 9) these are still
...
\[
a(n)\;=\;1957392\,n-6016308\qquad\text{for every }n\ge11,
\]
and $\mathcal P$ has exactly $1957392$ elements.
\end{theorem}
...
$a(12+1)$ were computed exactly, giving slope $1957392$ and the stated intercept; the slope
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A195003.
