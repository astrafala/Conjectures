...
\title{The empirical recurrence for OEIS A224007, proved by transfer matrix}
...
\begin{abstract}
OEIS A224007 counts arrays over $\{0,\dots,2\}$ whose rows, columns, diagonals or
...
OEIS A224007 is ``Number of n X 3 0..2 arrays with rows nondecreasing and antidiagonals unimodal.''. It has offset $1$ and begins
\[
10, 100, 868, 7378, 62764, 534352, 4549684, 38737252,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 10*a(n-1) - 16*a(n-2) + 30*a(n-3) - 14*a(n-4) + 12*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 26 2018 05:46:02, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224007.
