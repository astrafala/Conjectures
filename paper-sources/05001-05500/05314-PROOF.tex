...
\title{The empirical recurrence for OEIS A210127, proved by counting patterns}
...
\begin{abstract}
OEIS A210127 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A210127 is ``Number of (n+1) X 2 0..3 arrays with every 2 X 2 subblock having one, three or four distinct values, and new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
8, 81, 897, 10019, 111993, 1251951, 13995437, 156453699,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 12*a(n-1) - 9*a(n-2) - 2*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 15 2018 04:28:00, revision 13) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;12\,a(n-1) - 9\,a(n-2) - 2\,a(n-3)
\end{equation}
for all $n>3$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A210127.
