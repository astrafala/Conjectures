...
\title{The empirical recurrence for OEIS A286771, proved from an exact model}
...
\begin{abstract}
OEIS A286771 carries an empirical recurrence of order $4$ contributed by Colin Barker. It is true, and it is
...
\[
1, 1, 0, 111, 10000, 11111, 1000000, 1111111,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, May 14 2017: (Start) a(n) = 101*a(n-2) - 100*a(n-4) for n>4.
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 05 2025 15:22:39, revision 15)
...
neighbourhood to a live cell flips the ENTIRE plane, and rule 221 is read
