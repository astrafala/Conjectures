...
\title{The empirical recurrence for OEIS A258532, proved by transfer matrix}
...
\begin{abstract}
OEIS A258532 counts the arrays over $\{0,\dots,1\}$ whose $3\times3$ subblocks carry a
...
OEIS A258532 is ``Number of (3+2)X(n+2) 0..1 arrays with every 3X3 subblock sum of the two maximums of the central row and central column plus the two minimums of the diagonal and antidiagonal nondecreasing horizontally, vertically and ne-to-sw antidiagonally.''. It has offset $1$ and begins
\[
14184, 85259, 523716, 3133384, 18460629, 106485657, 606576800, 3416159956,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 15:27:21, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A258532.
