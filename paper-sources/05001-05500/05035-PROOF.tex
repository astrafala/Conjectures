...
\title{The empirical recurrence for OEIS A189445, proved by transfer matrix}
...
\begin{abstract}
OEIS A189445 counts the permutations of the cells of an $n\times5$ array in which every cell
...
That makes $a$ a walk count on $S=165$ states, hence $C$-finite, and whether the published
...
OEIS A189445 is ``Number of n X 5 array permutations with each element moving zero or one space horizontally or diagonally.''. It has offset $1$ and begins
\[
8, 225, 5080, 118128, 2735828, 63367633, 1467726607, 33995627281,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 24*a(n-1) -19*a(n-2) -11*a(n-3) +36*a(n-4) +3*a(n-5) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (May 02 2018 09:00:03, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A189445.
