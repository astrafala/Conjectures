...
\title{The empirical recurrence for OEIS A252520, proved by transfer matrix}
...
\begin{abstract}
OEIS A252520 counts $(n+2)\times7$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
$a(n)$ is a walk count on $S=1617886$ vertices. Such a sequence is $C$-finite, so whether a given
...
OEIS A252520 is ``Number of (n+2)X(5+2) 0..3 arrays with every 3X3 subblock row and column sum not equal to 0 2 4 6 or 7 and every 3X3 diagonal and antidiagonal sum equal to 0 2 4 6 or 7.''. It has offset $1$ and begins
\[
1093, 2492, 8354, 17804, 74181, 268555, 581529, 2449868,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:19:33, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;64\,a(n-3) - 1282\,a(n-6) + 10153\,a(n-9) - 38844\,a(n-12) + 79176\,a(n-15) - 91088\,a(n-18) + 63696\,a(n-21) - 29380\,a(n-24) + 8949\,a(n-27) - 1580\,a(n-30) + 142\,a(n-33) - 5\,a(n-36)
\]
for every $n>39$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252520.
