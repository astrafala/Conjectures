...
\title{The empirical recurrence for OEIS A208195, proved by counting patterns}
...
\begin{abstract}
OEIS A208195 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A208195 is ``Number of n X 2 0..3 arrays with new values 0..3 introduced in row major order and no element equal to more than two of its immediate leftward or upward or left-upward diagonal neighbors.''. It has offset $1$ and begins
\[
2, 14, 178, 2653, 41272, 648569, 10215440, 160984657,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 18*a(n-1) - 31*a(n-2) - 66*a(n-3) - 24*a(n-4) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 29 2018 06:02:52, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208195.
