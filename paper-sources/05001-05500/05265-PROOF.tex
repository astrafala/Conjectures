...
\title{The empirical recurrence for OEIS A063081, proved from an exact model}
...
\begin{abstract}
OEIS A063081 carries an empirical recurrence of order $5$. It is true, and it is
...
OEIS A063081 is ``Dimension of the space of weight 2n cusp forms for Gamma\_0( 13 ).''. It has offset $1$ and begins
\[
0, 3, 5, 7, 9, 13, 13, 17,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectured: a(n) = a(n-2) + a(n-3) - a(n-5) for n > 6.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 22 2025 22:57:00, revision 17)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A063081.
