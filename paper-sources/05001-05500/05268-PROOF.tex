...
\title{The empirical column recurrences for the table OEIS A299514}
...
\begin{abstract}
OEIS A299514 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A299514 is ``T(n,k) = Number of n X k 0..1 arrays with every element equal to 1, 2, 4, 5, 6 or 8 king-move adjacent elements, with upper left element zero.''. It has offset $1$, is
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 11 2023 12:50:33, revision 6) these are still
...
The sequence is ``Number of n X 1 0..1 arrays with every element equal to 1, 2, 4, 5, 6 or 8 king-move adjacent elements, with upper left element zero.''. Its rows are the vertices of a digraph on
...
The sequence is ``Number of n X 2 0..1 arrays with every element equal to 1, 2, 4, 5, 6 or 8 king-move adjacent elements, with upper left element zero.''. Its rows are the vertices of a digraph on
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A299514.
