...
\title{Arrays counted up to renaming: the empirical recurrence for OEIS A205627}
...
\begin{abstract}
OEIS A205627 carries an empirical recurrence of order $5$ contributed by R.~H.~Hardin. It is
...
OEIS A205627 is ``Number of 3 X (n+1) 0..2 arrays with every 2 X 2 subblock in a row having an equal number of equal diagonal or equal antidiagonal elements, adjacent rows differing in this number, and new values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
72, 306, 1512, 8004, 43248, 235464, 1284960, 7018128,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 12 2018 11:12:37, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) + 2\,a(n-2) - 28\,a(n-3) + 32\,a(n-5)
\]
for every $n>5$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A205627.
