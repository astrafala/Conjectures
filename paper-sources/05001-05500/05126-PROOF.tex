...
\title{The empirical recurrence for OEIS A222778, proved by transfer matrix}
...
\begin{abstract}
OEIS A222778 counts arrays in which no entry may equal the entries at a short list of fixed offsets
...
$2$ consecutive rows, $S=63363$ states in all.
\end{abstract}
...
OEIS A222778 is ``Number of n X 3 0..6 arrays with no element equal to another at a city block distance of exactly two, and new values 0..6 introduced in row major order.''. It has offset $1$ and begins
\[
3, 34, 969, 64752, 5227536, 436214328, 36601614264, 3073970725512,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 101*a(n-1) - 1470*a(n-2) + 3528*a(n-3) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 16 2018 08:59:02, revision 8) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=63363.
\]
...
\begin{theorem}
\[
a(n)\;=\;101\,a(n-1) - 1470\,a(n-2) + 3528\,a(n-3)
\]
for every $n>5$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A222778.
