...
\title{The empirical recurrence for OEIS A277799, proved from an exact model}
...
\begin{abstract}
OEIS A277799 carries an empirical recurrence of order $4$ contributed by Colin Barker. It is true, and it is
...
OEIS A277799 is ``Decimal representation of the x-axis, from the left edge to the origin, of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 1", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 0, 1, 12, 1, 60, 1, 252,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Nov 01 2016: (Start) a(n) = 5*a(n-2) - 4*a(n-4) for n>3.
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 05 2025 15:22:35, revision 19)
...
neighbourhood to a live cell flips the ENTIRE plane, and rule 1 is read
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A277799.
