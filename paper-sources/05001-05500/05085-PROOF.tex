...
\title{The empirical recurrence for OEIS A193644, proved by transfer matrix}
...
\begin{abstract}
OEIS A193644 carries an empirical recurrence of order $3$ contributed by R. H. Hardin. It is
...
OEIS A193644 is ``Number of arrays of -4..4 integers x(1..n) with every x(i) in a subsequence of length 1 or 2 with sum zero.''. It has offset $1$ and begins
\[
1, 9, 25, 105, 369, 1393, 5105, 18937,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) +6*a(n-2) +a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (May 04 2018 22:41:07, revision 12) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A193644.
