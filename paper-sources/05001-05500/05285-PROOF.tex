...
\title{The empirical recurrence for OEIS A183327, proved by transfer matrix}
...
\begin{abstract}
OEIS A183327 counts arrays of width $6$ over $\{0,1\}$ under local conditions relating each cell
...
OEIS A183327 is ``Number of n X 6 binary arrays with each 1 adjacent to exactly two other 1's.''. It has offset $1$ and begins
\[
1, 9, 37, 179, 996, 4740, 21259, 96524,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 03 2023 21:14:45, revision 7) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The array has $6$ cells across, with entries in $\{0,1\}$. The NEIGHBOURS of a cell are the
cells immediately to its left, to its right, above it and below it, those that lie inside the
array. The entry asks that
\begin{itemize}
\item every cell carrying $1$ has exactly $2$ of its four neighbours carrying $1$;
\end{itemize}
and nothing else.
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=947.
\]
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-1) - 18\,a(n-2) + 38\,a(n-3) - 48\,a(n-4) + 110\,a(n-5) - 30\,a(n-6) + 13\,a(n-7) + 12\,a(n-8) - 168\,a(n-9) + 12\,a(n-10) + 396\,a(n-11) + 2076\,a(n-12) - 2107\,a(n-13) - 11936\,a(n-14) - 23630\,a(n-15) - 11374\,a(n-16) + 33929\,a(n-17) + 86596\,a(n-18) + 85928\,a(n-19) - 5767\,a(n-20) - 137160\,a(n-21) - 186375\,a(n-22) - 82400\,a(n-23) + 98660\,a(n-24) + 206026\,a(n-25) + 154539\,a(n-26) + 271\,a(n-27) - 129682\,a(n-28) - 144333\,a(n-29) - 59907\,a(n-30) + 31467\,a(n-31) + 61883\,a(n-32) + 37532\,a(n-33) + 5039\,a(n-34) - 7723\,a(n-35) - 5583\,a(n-36) - 944\,a(n-37) + 520\,a(n-38) + 332\,a(n-39) + 24\,a(n-40) - 32\,a(n-41)
\]
for every $n>40$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A183327.
