...
\title{The empirical recurrence for OEIS A279960, proved from an exact model}
...
\begin{abstract}
OEIS A279960 carries an empirical recurrence of order $4$ contributed by Colin Barker. It is true, and it is
...
OEIS A279960 is ``Binary representation of the x-axis, from the origin to the right edge, of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 221", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 1, 10, 11, 11100, 1111, 1110000, 111111,\ \dots
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A279960.
