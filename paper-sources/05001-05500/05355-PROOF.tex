...
\title{The empirical recurrence for OEIS A203980, proved by counting patterns}
...
\begin{abstract}
OEIS A203980 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A203980 is ``Number of (n+1) X 5 0..2 arrays with no 2 X 2 subblock having equal diagonal elements or equal antidiagonal elements, and new values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
384, 5184, 69984, 956448, 13071456, 178855776, 2447270496, 33489653472,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 15*a(n-1) - 270*a(n-3) + 324*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 06 2018 05:41:26, revision 9) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A203980.
