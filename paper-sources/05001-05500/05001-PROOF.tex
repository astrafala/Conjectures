...
\title{The empirical recurrence for OEIS A252161, proved by transfer matrix}
...
\begin{abstract}
OEIS A252161 counts $(n+2)\times4$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
every $3\times3$ subblock, and it carries an empirical recurrence of order $35$
...
OEIS A252161 is ``Number of (n+2)X(2+2) 0..3 arrays with every 3X3 subblock row and column sum equal to 2 3 4 6 or 7 and every 3X3 diagonal and antidiagonal sum not equal to 2 3 4 6 or 7.''. It has offset $1$ and begins
\[
3712, 1930, 1574, 2075, 3749, 6883, 12842, 26127,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 10:53:14, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) - a(n-2) + 24\,a(n-3) - 43\,a(n-4) + 19\,a(n-5) - 204\,a(n-6) + 296\,a(n-7) - 98\,a(n-8) + 790\,a(n-9) - 738\,a(n-10) + 74\,a(n-11) - 1631\,a(n-12) + 634\,a(n-13) + 163\,a(n-14) + 1958\,a(n-15) + 201\,a(n-16) - 173\,a(n-17) - 1451\,a(n-18) - 698\,a(n-19) - 11\,a(n-20) + 672\,a(n-21) + 583\,a(n-22) + 41\,a(n-23) - 60\,a(n-24) - 416\,a(n-25) - 22\,a(n-26) - 310\,a(n-27) + 162\,a(n-28) + 94\,a(n-29) + 323\,a(n-30) + 182\,a(n-31) - 31\,a(n-32) - 110\,a(n-33) - 165\,a(n-34) - 55\,a(n-35)
\]
for every $n>42$.
\end{theorem}

\begin{proof}
The vector $w=q(M)\mathbf{1}$ was formed by $35$ matrix--vector products in exact
integer arithmetic and $\mathbf{1}^{\!\top}M^{j}w$ evaluated for $j=0,1,\dots$, again
exactly. Those integers vanish from the index corresponding to $n=42+1$ onwards, and the
run was continued until the working vector was identically zero, which settles all larger $j$
at once. By Lemma~\ref{lem:crit} the recurrence holds for every $n>42$.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252161.
