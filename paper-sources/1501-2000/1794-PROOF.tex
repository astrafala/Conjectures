...
\title{The empirical recurrence for OEIS A240413, proved by transfer matrix}
...
\begin{abstract}
OEIS A240413 counts arrays over $\{0,1,2,3\}$ in which no entry may equal, modulo $4$, a given
...
OEIS A240413 is ``Number of 2Xn 0..3 arrays with no element equal to zero plus the sum of elements to its left or one plus the sum of the elements above it or zero plus the sum of the elements diagonally to its northwest, modulo 4.''. It has offset $1$ and begins
\[
5, 10, 32, 80, 162, 493, 1109, 2656,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 09:56:02, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A240413.
