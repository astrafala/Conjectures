...
\title{The empirical recurrence for OEIS A252958, proved by transfer matrix}
...
\begin{abstract}
OEIS A252958 counts arrays of width $7$ over an alphabet of $5$ letters in which every three
...
brings the state count down to $S=123783$.
\end{abstract}
...
OEIS A252958 is ``Number of (n+2) X (5+2) 0..4 arrays with every consecutive three elements in every row and diagonal having exactly two distinct values, and in every column and antidiagonal not having exactly two distinct values, and new values 0 upwards introduced in row major order.''. It has offset $1$ and begins
\[
1251, 385, 605, 1027, 1747, 3315, 6091, 11027,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 06 2022 10:41:11, revision 6) this is still
...
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,
\]
with $S=123783$ states in all. The walk index $j$ and the entry's own $n$ differ by a constant,
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) - 2\,a(n-2) + 3\,a(n-3) - 37\,a(n-4) + 20\,a(n-5) + 87\,a(n-6) - 23\,a(n-7) - 8\,a(n-8) - 423\,a(n-9) + 617\,a(n-10) - 244\,a(n-11) + 70\,a(n-12) - 105\,a(n-13) + 42\,a(n-14)
\]
for every $n>16$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252958.
