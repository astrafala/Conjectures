...
\title{The empirical recurrence for OEIS A240514, proved by transfer matrix}
...
\begin{abstract}
OEIS A240514 counts arrays of width $3$ over $\{0,\dots,1\}$ under a condition on each cell
...
OEIS A240514 is ``Number of nX3 0..1 arrays with no element equal to exactly two horizontal and vertical neighbors, with new values 0..1 introduced in row major order.''. It has offset $1$ and begins
\[
3, 6, 10, 28, 73, 196, 515, 1376,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 11:02:01, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) - 3\,a(n-2) - 2\,a(n-3) + 2\,a(n-4) + 2\,a(n-5) - 7\,a(n-6) - 8\,a(n-7) + 15\,a(n-8) + 4\,a(n-9) - 8\,a(n-10) - 4\,a(n-11) + 15\,a(n-12) + 8\,a(n-13) - 7\,a(n-14) - 2\,a(n-15) + 2\,a(n-16) + 2\,a(n-17) - 3\,a(n-18) - 4\,a(n-19) - a(n-20)
\]
for every $n>20$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A240514.
