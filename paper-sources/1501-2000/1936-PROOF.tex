...
\title{The empirical recurrence for OEIS A223945, proved by transfer matrix}
...
\begin{abstract}
OEIS A223945 counts arrays over $\{0,\dots,1\}$ whose rows, columns, diagonals or
...
is a walk count on $S=1280$ vertices and the recurrence follows from a finite exact
computation.
\end{abstract}
...
OEIS A223945 is ``Number of n X 4 0..1 arrays with diagonals and antidiagonals unimodal and rows nondecreasing.''. It has offset $1$ and begins
\[
5, 25, 96, 321, 1062, 3645, 12856, 45626,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 5*a(n-1) - 5*a(n-2) - 2*a(n-3) + 7*a(n-4) - 2*a(n-5) - 4*a(n-6) - 61*a(n-7) + 29*a(n-8) + 8*a(n-9) + 8*a(n-10).
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 24 2018 08:52:37, revision 7) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) - 5\,a(n-2) - 2\,a(n-3) + 7\,a(n-4) - 2\,a(n-5) - 4\,a(n-6) - 61\,a(n-7) + 29\,a(n-8) + 8\,a(n-9) + 8\,a(n-10)
\end{equation}
for all $n>10$.
...
bit vector), $|\mathcal V|=S=1280$; let $(r,f)\to(s,f')$ be an edge when placing $s$ after $r$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223945.
