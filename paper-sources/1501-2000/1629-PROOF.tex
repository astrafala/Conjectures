...
\title{The empirical recurrence for OEIS A184691, proved by transfer matrix}
...
\begin{abstract}
OEIS A184691 counts arrays of width $6$ over $\{0,1,2\}$ in which no cell equals both the cell above it and the cell to its left. The entry carries an
...
$2$ consecutive rows and the count is a walk count on $S=730$ states.
\end{abstract}
...
OEIS A184691 is ``1/3 the number of nX6 0..2 arrays with no element equal both to the element above and to the element to its left.''. It has offset $1$ and begins
\[
243, 98304, 39133824, 15564399648, 6189975781728, 2461751303097216, 979037502950237760, 389362817519503469280,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 02:50:53, revision 11) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A184691.
