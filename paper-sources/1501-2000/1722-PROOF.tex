...
\title{The empirical recurrence for OEIS A203544, proved by transfer matrix}
...
\begin{abstract}
OEIS A203544 counts arrays of width $2$ over $\{0,1,2,3,4\}$ in which every nonzero cell has a neighbour at least as large as itself. The entry carries an
...
OEIS A203544 is ``Number of nX2 0..4 arrays with every nonzero element less than or equal to some NW, E or S neighbor.''. It has offset $1$ and begins
\[
1, 25, 430, 4773, 48046, 504464, 5448482, 58647145,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 10:33:05, revision 9) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The arrays have $2$ columns and a growing number of rows, with entries in $\{0,1,2,3,4\}$. Fix the
...
Thus
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=501,
\]
...
\begin{theorem}
\[
a(n)\;=\;25\,a(n-1) - 260\,a(n-2) + 1700\,a(n-3) - 7878\,a(n-4) + 25276\,a(n-5) - 56108\,a(n-6) + 90339\,a(n-7) - 109634\,a(n-8) + 103867\,a(n-9) - 84017\,a(n-10) + 52577\,a(n-11) - 21631\,a(n-12) + 6561\,a(n-13)
\]
for every $n>12$.
\end{theorem}
...
array of width $2$ over $\{0,1,2,3,4\}$ with a few rows was written out cell by cell and each cell
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A203544.
