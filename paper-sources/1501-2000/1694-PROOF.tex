...
\title{The empirical recurrence for OEIS A269190, proved by transfer matrix}
...
\begin{abstract}
OEIS A269190 counts arrays of width $4$ over $\{0,1,2,3\}$ in which the number of adjacent PAIRS of
...
OEIS A269190 is ``Number of nX4 0..3 arrays with some element plus some horizontally, diagonally, antidiagonally or vertically adjacent neighbor totalling three no more than once.''. It has offset $1$ and begins
\[
216, 4476, 115452, 2817548, 67134380, 1567933676, 36068275268, 819789099172,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 20 2016 09:42:59, revision 4) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269190.
