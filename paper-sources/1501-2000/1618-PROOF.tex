...
\title{The empirical recurrence for OEIS A262335, proved by transfer matrix}
...
\begin{abstract}
OEIS A262335 counts arrays of width $6$ over $\{0,1\}$ whose rows, read as base-$2$
...
OEIS A262335 is ``Number of (n+3)X(3+3) 0..1 arrays with each row and column divisible by 9, read as a binary number with top and left being the most significant bits.''. It has offset $1$ and begins
\[
8, 64, 512, 3375, 24389, 185193, 1481544, 11852352,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 18 2015 07:57:26, revision 4) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A262335.
