...
\title{The empirical recurrence for OEIS A204488, proved by transfer matrix}
...
\begin{abstract}
OEIS A204488 counts $(n+2)\times6$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A204488 is ``Number of (n+2)X6 0..1 arrays with every 3X3 subblock having three equal elements in a row horizontally, vertically or nw-to-se diagonally exactly one way, and new values 0..1 introduced in row major order.''. It has offset $1$ and begins
\[
1690, 2627, 5407, 11137, 22341, 44712, 90942, 187020,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 11:15:27, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + a(n-2) + 9\,a(n-3) - 5\,a(n-4) - 10\,a(n-5) - 7\,a(n-6) - 26\,a(n-7) + 18\,a(n-8) - 13\,a(n-9) + 58\,a(n-10) - 4\,a(n-11) + 22\,a(n-12) - 26\,a(n-13) - 11\,a(n-14) - 16\,a(n-15) + a(n-16) + 6\,a(n-17) + 6\,a(n-18) - 3\,a(n-19)
\]
for every $n>28$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204488.
