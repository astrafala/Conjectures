...
\title{The empirical recurrence for OEIS A240407, proved by transfer matrix}
...
\begin{abstract}
OEIS A240407 counts arrays over $\{0,1,2,3\}$ in which no entry may equal, modulo $4$, a given
constant plus the SUM of all the entries lying before it along one of several rays. The entry
carries an empirical recurrence of order $14$ contributed by R.~H.~Hardin. It is true, and
...
count is then a walk count on $S=37$ states.
\end{abstract}
...
OEIS A240407 is ``Number of nX2 0..3 arrays with no element equal to zero plus the sum of elements to its left or one plus the sum of elements above it or zero plus the sum of the elements diagonally to its northwest, modulo 4.''. It has offset $1$ and begins
\[
2, 10, 33, 139, 529, 2105, 8258, 32480,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 09:55:20, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 11\,a(n-2) - a(n-3) - 39\,a(n-4) - 40\,a(n-5) + 3\,a(n-6) + 13\,a(n-7) + 64\,a(n-8) + 162\,a(n-9) - 220\,a(n-10) + 122\,a(n-11) - 38\,a(n-12) - 82\,a(n-13) + 60\,a(n-14)
\]
for every $n>14$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A240407.
