...
\title{The empirical recurrence for OEIS A235426, proved by transfer matrix}
...
\begin{abstract}
OEIS A235426 counts arrays of width $2$ over $\{0,1,2,3\}$ by reducing every $2\times2$ subblock to a
...
about it is one bit per adjacent pair of columns, so the count is a walk count on $S=61$
states.
\end{abstract}
...
OEIS A235426 is ``Number of (n+1)X(1+1) 0..3 arrays with the difference between each 2X2 subblock maximum and minimum lexicographically nondecreasing rowwise and columnwise.''. It has offset $1$ and begins
\[
256, 3038, 33610, 344668, 3402366, 32542312, 304784986, 2807381170,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 08:32:52, revision 7) this is still
...
f(B)\;=\;v_4-v_1,
\]
the largest entry minus the smallest. An array with $R$ rows and $2$ columns has $(R-1)\times1$ subblocks, and they
...
\begin{theorem}
\[
a(n)\;=\;15\,a(n-1) - 17\,a(n-2) - 518\,a(n-3) + 1159\,a(n-4) + 5713\,a(n-5) - 11569\,a(n-6) - 22194\,a(n-7) + 35356\,a(n-8) + 29720\,a(n-9) - 34208\,a(n-10) - 11136\,a(n-11) + 7680\,a(n-12)
\]
for every $n>10$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A235426.
