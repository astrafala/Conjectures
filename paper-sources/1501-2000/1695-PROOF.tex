...
\title{The empirical recurrence for OEIS A210160, proved by counting patterns}
...
\begin{abstract}
OEIS A210160 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A210160 is ``Number of (n+1)X4 0..3 arrays with every 2X2 subblock having two or three distinct values, and new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
1977, 351482, 63734680, 11572169594, 2101304030788, 381562168006676, 69285421396766192, 12581094577437564692,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 15:47:35, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;172\,a(n-1) + 2086\,a(n-2) - 61767\,a(n-3) - 221678\,a(n-4) + 6709264\,a(n-5) - 21628195\,a(n-6) - 28904236\,a(n-7) + 171575402\,a(n-8) + 51603\,a(n-9) - 460002202\,a(n-10) + 137911776\,a(n-11) + 512783040\,a(n-12) - 179902696\,a(n-13) - 200966160\,a(n-14) + 54584192\,a(n-15) - 885504\,a(n-16)
\end{equation}
for all $n>16$.
...
For every $n$ with $m=n+1-1\ge16$,
\[
4!\Bigl(a(n)-\sum_i c_i\,a(n-i)\Bigr)\;=\;\mathbf{v}^{\!\top}N^{\,m-16}q(N)\mathbf{1} .
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A210160.
