...
\title{The empirical recurrence for OEIS A239531, proved by transfer matrix}
...
\begin{abstract}
OEIS A239531 counts arrays of width $3$ over $\{0,\dots,2\}$ under a condition on each cell
...
OEIS A239531 is ``Number of (n+1) X (2+1) 0..2 arrays with no element equal to all horizontal neighbors or unequal to all vertical neighbors, and new values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
2, 2, 24, 68, 406, 1584, 7790, 33630,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + 13*a(n-2) - a(n-3) - 23*a(n-4) - 28*a(n-5) + 11*a(n-6) + 40*a(n-7) - 9*a(n-8) - 5*a(n-9) + 5*a(n-10).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 26 2018 09:14:49, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 13\,a(n-2) - a(n-3) - 23\,a(n-4) - 28\,a(n-5) + 11\,a(n-6) + 40\,a(n-7) - 9\,a(n-8) - 5\,a(n-9) + 5\,a(n-10)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A239531.
