...
\title{The empirical recurrence for OEIS A240779, proved by transfer matrix}
...
\begin{abstract}
OEIS A240779 counts $n\times4$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
every CELL over a neighbour set the entry names, and counted UP TO RELABELLING of the
alphabet; it carries an empirical recurrence of order $22$ contributed by
...
OEIS A240779 is ``Number of nX4 0..1 arrays with no element equal to fewer vertical neighbors than horizontal neighbors, with new values 0..1 introduced in row major order.''. It has offset $1$ and begins
\[
1, 6, 46, 305, 2167, 15332, 108509, 767834,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 11:06:56, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-1) + 2\,a(n-2) - 7\,a(n-3) - 25\,a(n-4) - 6\,a(n-5) + 150\,a(n-6) + 12\,a(n-7) - 456\,a(n-8) - 134\,a(n-9) + 408\,a(n-10) + 116\,a(n-11) - 171\,a(n-12) + 73\,a(n-13) + 388\,a(n-14) + 87\,a(n-15) - 127\,a(n-16) - 168\,a(n-17) - 62\,a(n-18) - 12\,a(n-19) + 16\,a(n-20) + 8\,a(n-21) + 2\,a(n-22)
\]
for every $n>22$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A240779.
