...
\title{The empirical recurrence for OEIS A269008, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A269008 counts arrays over $\{0,\dots,1\}$ subject to a condition on the array as a
...
OEIS A269008 is ``Number of n X 5 binary arrays with some element plus some horizontally, diagonally or antidiagonally adjacent neighbor totalling two exactly once.''. It has offset $1$ and begins
\[
10, 88, 1078, 10976, 109058, 1053432, 10002542, 93733440,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 17 2022 22:25:24, revision 6) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269008.
