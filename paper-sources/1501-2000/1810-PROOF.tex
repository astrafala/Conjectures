...
\title{The empirical recurrence for OEIS A204073, proved by counting patterns}
...
\begin{abstract}
OEIS A204073 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A204073 is ``Number of (n+1)X6 0..2 arrays with every 2X2 subblock having equal diagonal elements or equal antidiagonal elements, and new values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
4688, 221726, 11081828, 563880962, 28864215128, 1480470688070, 75985220860460, 3900809853901802,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 10:58:34, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;78\,a(n-1) - 1521\,a(n-2) + 7304\,a(n-3) + 32884\,a(n-4) - 338760\,a(n-5) + 639312\,a(n-6) + 947424\,a(n-7) - 3942080\,a(n-8) + 2598528\,a(n-9) + 1739776\,a(n-10) - 1832448\,a(n-11) - 14336\,a(n-12) + 163840\,a(n-13)
\end{equation}
for all $n>12$.
...
\[
3!\Bigl(a(n)-\sum_i c_i\,a(n-i)\Bigr)\;=\;\mathbf{v}^{\!\top}N^{\,m-13}q(N)\mathbf{1} .
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204073.
