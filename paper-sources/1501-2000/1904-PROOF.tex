...
\title{The empirical recurrence for OEIS A209739, proved by counting patterns}
...
\begin{abstract}
OEIS A209739 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
state space down from $441$ to $S=25$. The entry's empirical recurrence of order
...
OEIS A209739 is ``Number of n X 3 0..5 arrays with every 2 X 2 subblock containing exactly one value repeat, and new values 0..5 introduced in row major order.''. It has offset $1$ and begins
\[
5, 57, 2025, 103373, 6262064, 404495219, 26715084257, 1777603386801,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 15:27:43, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;100\,a(n-1) - 2365\,a(n-2) + 6020\,a(n-3) + 291532\,a(n-4) - 2681320\,a(n-5) + 4701820\,a(n-6) + 23602304\,a(n-7) - 82586672\,a(n-8) + 27026368\,a(n-9) + 113762816\,a(n-10) - 78159872\,a(n-11) + 7864320\,a(n-12)
\end{equation}
for all $n>13$.
...
Assembling the $6$ lumped chains into one block-diagonal matrix $N$ of size $S=25$ and
...
\end{equation}
The unlumped alphabet had $441$ rows in all; the lumped chain has $S=25$ states.
...
\[
6!\Bigl(a(n)-\sum_i c_i\,a(n-i)\Bigr)\;=\;\mathbf{v}^{\!\top}N^{\,m-12}q(N)\mathbf{1} .
\]
...
\eqref{eq:walk}, divided by $6!$, was evaluated at every one of the $14$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209739.
