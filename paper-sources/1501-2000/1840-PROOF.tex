...
\title{The empirical recurrence for OEIS A252720, proved by transfer matrix}
...
\begin{abstract}
OEIS A252720 counts arrays of width $3$ over an alphabet of $4$ letters in which every three
...
OEIS A252720 is ``Number of (1+2) X (n+2) 0..3 arrays with every consecutive three elements in every row and diagonal having exactly two distinct values, and in every column and antidiagonal not having exactly two distinct values, and new values 0 upwards introduced in row major order.''. It has offset $1$ and begins
\[
39, 52, 70, 96, 129, 175, 237, 319,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 05 2018 11:07:46, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-2) + 6\,a(n-3) - a(n-4) - 11\,a(n-5) - 12\,a(n-6) + 5\,a(n-7) + 20\,a(n-8) + 8\,a(n-9) - 8\,a(n-10) - 12\,a(n-11) + 4\,a(n-13)
\]
for every $n>14$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252720.
