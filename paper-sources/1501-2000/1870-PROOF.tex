...
\title{The empirical recurrence for OEIS A202798, proved by transfer matrix}
...
\begin{abstract}
OEIS A202798 counts arrays of width $4$ over $\{0,1\}$ in which every cell of a named value has a neighbour of that same value. The entry carries an
...
OEIS A202798 is ``Number of nX4 binary arrays with every one adjacent to another one horizontally or vertically.''. It has offset $1$ and begins
\[
7, 126, 1718, 22946, 311144, 4217066, 57127796, 773948962,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 09:55:31, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;13\,a(n-1) - 7\,a(n-2) + 181\,a(n-3) + 123\,a(n-4) + 940\,a(n-5) + 545\,a(n-6) - 2084\,a(n-7) - 1964\,a(n-8) + 1512\,a(n-9) + 1984\,a(n-10) - 512\,a(n-11) - 1024\,a(n-12)
\]
for every $n>11$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A202798.
