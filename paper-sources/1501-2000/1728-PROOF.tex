...
\title{The empirical recurrence for OEIS A235838, proved by transfer matrix}
...
\begin{abstract}
OEIS A235838 counts arrays of width $2$ over $\{0,1,2\}$ by reducing every $2\times2$ subblock to a
...
about it is one bit per adjacent pair of columns, so the count is a walk count on $S=41$
states.
\end{abstract}
...
OEIS A235838 is ``Number of (n+1)X(1+1) 0..2 arrays with the sum of each 2X2 subblock two extreme terms minus its two median terms lexicographically nondecreasing rowwise and columnwise.''. It has offset $1$ and begins
\[
81, 487, 2581, 12373, 55929, 241933, 1015889, 4174941,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 08:52:26, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;9\,a(n-1) - 204\,a(n-3) + 368\,a(n-4) + 1728\,a(n-5) - 4720\,a(n-6) - 6672\,a(n-7) + 25984\,a(n-8) + 10560\,a(n-9) - 74880\,a(n-10) + 1920\,a(n-11) + 116160\,a(n-12) - 24000\,a(n-13) - 89600\,a(n-14) + 19200\,a(n-15) + 25600\,a(n-16)
\]
for every $n>16$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A235838.
