...
\title{The empirical recurrence for OEIS A266062, proved by transfer matrix}
...
\begin{abstract}
OEIS A266062 counts arrays of width $2$ in which every entry is equal to the NUMBER of its own
...
OEIS A266062 is ``Number of nX2 integer arrays with each element equal to the number of horizontal, vertical, diagonal and antidiagonal neighbors exactly one smaller than itself.''. It has offset $1$ and begins
\[
3, 17, 35, 89, 323, 1057, 3027, 9257,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 20 2015 11:19:16, revision 5) this is still
...
that are exactly one smaller than it: writing $v=x(i,j)$,
\[
v\;=\;\#\{\text{neighbours } y \text{ of } (i,j)\ :\ y=v-1\} .
\]
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=837.
\]
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 2\,a(n-2) + 20\,a(n-3) + 30\,a(n-4) - 50\,a(n-5) - 160\,a(n-6) - 512\,a(n-7) - 404\,a(n-8) + 948\,a(n-9) + 1880\,a(n-10) + 4248\,a(n-11) + 1088\,a(n-12) - 3776\,a(n-13) - 7488\,a(n-14) - 5376\,a(n-15) + 4352\,a(n-16) + 4608\,a(n-17) + 8192\,a(n-18)
\]
for every $n>17$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A266062.
