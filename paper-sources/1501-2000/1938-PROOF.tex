...
\title{The empirical recurrence for OEIS A275561, proved by counting patterns}
...
\begin{abstract}
OEIS A275561 counts arrays in which no entry may repeat a value found at any of three stated
...
cutting $6818$ pairs to $S=1223$ states. The entry's empirical recurrence of order $10$,
...
OEIS A275561 is ``Number of n X 4 0..2 arrays with no element equal to any value at offset (-2,0) (-1,2) or (0,-2) and new values introduced in order 0..2.''. It has offset $1$ and begins
\[
6, 96, 294, 1176, 4056, 15000, 54150, 196566,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) + 5*a(n-2) - 8*a(n-3) - 11*a(n-4) + 17*a(n-5) - 4*a(n-6) - 6*a(n-7) + 3*a(n-8) + 2*a(n-9) - a(n-10) for n>11.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 04 2019 14:24:38, revision 7) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 5\,a(n-2) - 8\,a(n-3) - 11\,a(n-4) + 17\,a(n-5) - 4\,a(n-6) - 6\,a(n-7) + 3\,a(n-8) + 2\,a(n-9) - a(n-10)
\end{equation}
for all $n>11$.
...
$o=1n_0+0-2$, we have for $j\ge10$
\[
3!\Bigl(a(n_0+j)-\sum_i c_i\,a(n_0+j-i)\Bigr)
=\mathbf{v}^{\!\top}G^{\,j-10}w,\qquad
w=h_{10}-\sum_i c_i h_{10-i} .
\]
...
the survivors by the pattern of the new pair. The vector $w$ was formed by $10$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A275561.
