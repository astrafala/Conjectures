...
\title{The empirical recurrence for OEIS A240418, proved by transfer matrix}
...
\begin{abstract}
OEIS A240418 counts arrays over $\{0,1,2,3\}$ in which no entry may equal, modulo $4$, a given
...
OEIS A240418 is ``Number of nX2 0..3 arrays with no element equal to two plus the sum of elements to its left or two plus the sum of elements above it or two plus the sum of the elements diagonally to its northwest, modulo 4.''. It has offset $1$ and begins
\[
7, 35, 147, 553, 2045, 7439, 27099, 98193,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 09:56:37, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) + 4\,a(n-2) - 46\,a(n-3) + 28\,a(n-4) + 101\,a(n-5) - 71\,a(n-6) - 93\,a(n-7) - 4\,a(n-8) + 94\,a(n-9) + 65\,a(n-10) - 115\,a(n-11) - 13\,a(n-12) + 70\,a(n-13) - 8\,a(n-14) - 16\,a(n-15)
\]
for every $n>15$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A240418.
