...
\title{The empirical recurrence for OEIS A266132, proved by transfer matrix}
...
\begin{abstract}
OEIS A266132 counts arrays of width $2$ in which every entry is equal to the NUMBER of its own
...
OEIS A266132 is ``Number of 2Xn integer arrays with each element equal to the number of horizontal, diagonal and antidiagonal neighbors exactly one smaller than itself.''. It has offset $1$ and begins
\[
1, 9, 25, 49, 149, 625, 2141, 5433,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 21 2015 12:29:49, revision 4) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=481.
\]
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 8\,a(n-3) + 80\,a(n-4) - 40\,a(n-5) - 52\,a(n-6) - 112\,a(n-7) - 1204\,a(n-8) + 292\,a(n-9) + 64\,a(n-10) - 880\,a(n-11) + 4016\,a(n-12) - 2112\,a(n-13) - 1152\,a(n-14) + 1024\,a(n-15) - 4608\,a(n-16) + 4608\,a(n-17)
\]
for every $n>16$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A266132.
