...
\title{The empirical recurrence for OEIS A235654, proved by transfer matrix}
...
\begin{abstract}
OEIS A235654 counts arrays of width $3$ over $\{0,1\}$ by reducing every $2\times2$ subblock to a
...
OEIS A235654 is ``Number of (n+1)X(2+1) 0..1 arrays with the difference of the upper median and minimum value of each 2X2 subblock in lexicographically nondecreasing order rowwise and columnwise.''. It has offset $1$ and begins
\[
52, 276, 1368, 6378, 28823, 126926, 550175, 2355552,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 08:42:08, revision 6) this is still
...
f(B)\;=\;v_3-v_1,
\]
the upper median minus the smallest entry. An array with $R$ rows and $3$ columns has $(R-1)\times2$ subblocks, and they
...
\begin{theorem}
\[
a(n)\;=\;10\,a(n-1) - 20\,a(n-2) - 97\,a(n-3) + 393\,a(n-4) + 130\,a(n-5) - 2190\,a(n-6) + 1313\,a(n-7) + 5707\,a(n-8) - 6006\,a(n-9) - 7785\,a(n-10) + 10983\,a(n-11) + 5679\,a(n-12) - 10491\,a(n-13) - 2203\,a(n-14) + 5639\,a(n-15) + 424\,a(n-16) - 1701\,a(n-17) - 32\,a(n-18) + 264\,a(n-19) - 16\,a(n-21)
\]
for every $n>20$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A235654.
