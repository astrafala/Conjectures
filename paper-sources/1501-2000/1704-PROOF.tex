...
\title{The empirical recurrence for OEIS A206595, proved by transfer matrix}
...
\begin{abstract}
OEIS A206595 counts, up to renaming the letters, the arrays of width $3$ over at most $4$
letters in which every $2\times3$ and $3\times2$ subblock has at most $3$ equal edges, an edge of such a window being one of the six steps of its perimeter cycle and an equal edge one whose two cells agree. It carries an empirical recurrence of order $16$ contributed by
...
OEIS A206595 is ``Number of (n+1)X3 0..3 arrays with every 2X3 or 3X2 subblock having no more than three equal edges, and new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
171, 9449, 551631, 32258200, 1886206112, 110294918412, 6449441361133, 377127604356885,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 13:00:50, revision 9) this is still
...
$w_i$ cleared of denominators and $S=4580$ states in all. The walk index $j$ and the entry's own
...
\begin{theorem}
\[
a(n)\;=\;51\,a(n-1) + 353\,a(n-2) + 4958\,a(n-3) - 2678\,a(n-4) + 14656\,a(n-5) - 160635\,a(n-6) + 19303\,a(n-7) - 859799\,a(n-8) + 242534\,a(n-9) + 14671\,a(n-10) + 3134369\,a(n-11) + 2183000\,a(n-12) + 2077689\,a(n-13) - 573423\,a(n-14) - 682544\,a(n-15) - 455304\,a(n-16)
\]
for every $n>16$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206595.
