...
\title{The empirical recurrence for OEIS A183519, proved by transfer matrix}
...
\begin{abstract}
OEIS A183519 counts arrays of width $2$ over $\{0,1,2\}$ in which every cell is the sum of one of two groups of its neighbours. The entry carries an
...
OEIS A183519 is ``Number of nX2 0..2 arrays with each element equal to either the sum mod 3 of its horizontal and vertical neighbors or the sum mod 3 of its diagonal and antidiagonal neighbors.''. It has offset $1$ and begins
\[
3, 9, 31, 95, 309, 911, 2803, 8673,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 01:51:19, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + 6\,a(n-3) - 16\,a(n-4) + 7\,a(n-6) - 25\,a(n-7) - 44\,a(n-9) + 102\,a(n-10) - 184\,a(n-12) + 520\,a(n-13) + 320\,a(n-15) - 720\,a(n-16) + 640\,a(n-18) - 1600\,a(n-19)
\]
for every $n>18$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A183519.
