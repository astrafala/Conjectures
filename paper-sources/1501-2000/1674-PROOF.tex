...
\title{The empirical recurrence for OEIS A210178, proved by transfer matrix}
...
\begin{abstract}
OEIS A210178 counts arrays of width $4$ whose every $2\times2$ subblock holds a
prescribed number of DISTINCT values, which use ALL of the $4$ available letters, and which
are counted up to renaming. The entry carries an empirical recurrence of order $16$
...
OEIS A210178 is ``Number of (n+1)X4 0..3 arrays containing all values 0..3 with every 2X2 subblock having three or four distinct values, and new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
744, 79017, 7363642, 677791782, 62264517380, 5718695139568, 525217898009080, 48237037195753208,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 15:49:26, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;93\,a(n-1) + 199\,a(n-2) - 28711\,a(n-3) + 35176\,a(n-4) + 2453690\,a(n-5) - 5602318\,a(n-6) - 51561340\,a(n-7) + 96505796\,a(n-8) + 378763976\,a(n-9) - 653899024\,a(n-10) - 988302720\,a(n-11) + 1830649984\,a(n-12) + 381532160\,a(n-13) - 1548998656\,a(n-14) + 621346816\,a(n-15) - 44040192\,a(n-16)
\]
for every $n>16$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A210178.
