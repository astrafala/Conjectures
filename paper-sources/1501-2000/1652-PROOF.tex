...
\title{The empirical recurrence for OEIS A204485, proved by transfer matrix}
...
\begin{abstract}
OEIS A204485 counts $(n+2)\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A204485 is ``Number of (n+2) X 3 0..1 arrays with every 3 X 3 subblock having three equal elements in a row horizontally, vertically or nw-to-se diagonally exactly one way, and new values 0..1 introduced in row major order.''. It has offset $1$ and begins
\[
72, 214, 610, 1690, 4664, 12809, 35172, 96615,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 01 2023 14:26:13, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) - a(n-2) + 4\,a(n-3) - 10\,a(n-4) + 18\,a(n-6) - 23\,a(n-7) - 3\,a(n-9) + 43\,a(n-10) - 86\,a(n-11) + 114\,a(n-12) - 85\,a(n-13) + 46\,a(n-14) - 16\,a(n-15) - 3\,a(n-16) - 4\,a(n-17) + 4\,a(n-18)
\]
for every $n>19$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204485.
