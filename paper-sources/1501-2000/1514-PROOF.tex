...
\title{The empirical recurrence for OEIS A269198, proved by transfer matrix}
...
\begin{abstract}
OEIS A269198 counts arrays of width $5$ over $\{0,1,2,3\}$ in which the number of adjacent PAIRS of
...
OEIS A269198 is ``Number of n X 5 0..3 arrays with some element plus some horizontally, diagonally or antidiagonally adjacent neighbor totalling three no more than once.''. It has offset $1$ and begins
\[
756, 68052, 5877228, 463790340, 34838403756, 2532677348772, 179867149105740, 12551707872624132,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 16 2024 09:42:03, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269198.
