...
\title{The empirical recurrence for OEIS A235737, proved by transfer matrix}
...
\begin{abstract}
OEIS A235737 counts arrays of width $2$ over $\{0,1,2\}$ by reducing every $2\times2$ subblock to a
...
about it is one bit per adjacent pair of columns, so the count is a walk count on $S=29$
states.
\end{abstract}
...
OEIS A235737 is ``Number of (n+1)X(1+1) 0..2 arrays with the sum of each 2X2 subblock maximum and minimum lexicographically nondecreasing columnwise and nonincreasing rowwise.''. It has offset $1$ and begins
\[
81, 576, 3992, 26088, 167892, 1060410, 6648825, 41411637,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 08:45:20, revision 7) this is still
...
f(B)\;=\;v_4+v_1,
\]
the largest entry plus the smallest. An array with $R$ rows and $2$ columns has $(R-1)\times1$ subblocks, and they
...
\begin{theorem}
\[
a(n)\;=\;9\,a(n-1) - 144\,a(n-3) + 122\,a(n-4) + 726\,a(n-5) - 372\,a(n-6) - 1500\,a(n-7) + 239\,a(n-8) + 1353\,a(n-9) + 156\,a(n-10) - 444\,a(n-11) - 144\,a(n-12)
\]
for every $n>10$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A235737.
