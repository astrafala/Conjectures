...
\title{The empirical recurrence for OEIS A269933, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A269933 counts arrays over $\{0,\dots,6\}$ subject to a condition on the array as a
...
which is what keeps the digraph sparse. That makes $a(n)$ a walk count on $S=686$ vertices,
...
OEIS A269933 is ``Number of nX3 0..6 arrays with some element plus some horizontally, diagonally, antidiagonally or vertically adjacent neighbor totalling six exactly once.''. It has offset $1$ and begins
\[
84, 36312, 5695536, 755009274, 91506078732, 10536802638018, 1172354654705496, 127313882431172946,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 08 2016 07:37:33, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;144\,a(n-1) - 244\,a(n-2) - 431040\,a(n-3) - 653070\,a(n-4) + 185824500\,a(n-5) - 1565542220\,a(n-6) - 2246788724\,a(n-7) + 49596662711\,a(n-8) - 28656277332\,a(n-9) - 578014144012\,a(n-10) + 498466153668\,a(n-11) + 3129025277000\,a(n-12) - 1799356594080\,a(n-13) - 8214266955364\,a(n-14) + 1238204980096\,a(n-15) + 7873681484512\,a(n-16) - 756824714624\,a(n-17) - 2602301179968\,a(n-18) + 547351490048\,a(n-19) - 28883682304\,a(n-20)
\end{equation}
for all $n>21$.
...
\[
\mathcal V=\bigl\{(r,c):\ r\in\{0,\dots,6\}^{3},\ c\in\{0,1\}\bigr\},
\qquad |\mathcal V|=S=686,
\]
...
the digraph dense, with $(6+1)^{2\cdot3}$ edges instead of the sparse set used here.
\end{remark}
...
those integers vanishes from the index corresponding to $n=21+1$ onwards, and the run
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269933.
