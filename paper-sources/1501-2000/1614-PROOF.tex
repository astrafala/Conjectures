...
\title{The empirical recurrence for OEIS A224373, proved by transfer matrix}
...
\begin{abstract}
OEIS A224373 counts arrays over $\{0,\dots,2\}$ whose rows, columns, diagonals or
...
is a walk count on $S=239$ vertices and the recurrence follows from a finite exact
computation.
\end{abstract}
...
OEIS A224373 is ``Number of nX7 0..2 arrays with rows unimodal and antidiagonals nondecreasing.''. It has offset $1$ and begins
\[
239, 10511, 227112, 3518302, 48166179, 644368221, 8684742989, 118171436342,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 23:24:37, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;36\,a(n-1) - 505\,a(n-2) + 3667\,a(n-3) - 15271\,a(n-4) + 38113\,a(n-5) - 59621\,a(n-6) + 53813\,a(n-7) - 125335\,a(n-8) + 657330\,a(n-9) - 1326014\,a(n-10) + 2644047\,a(n-11) + 3529521\,a(n-12) + 7803900\,a(n-13) + 959690\,a(n-14) + 28175350\,a(n-15) + 27269532\,a(n-16) + 18725976\,a(n-17) + 1826832\,a(n-18) + 1263744\,a(n-19)
\end{equation}
for all $n>24$.
...
bit vector), $|\mathcal V|=S=239$; let $(r,f)\to(s,f')$ be an edge when placing $s$ after $r$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224373.
