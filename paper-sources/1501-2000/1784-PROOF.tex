...
\title{The empirical closed form for OEIS A224150, proved}
...
\begin{abstract}
OEIS A224150 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
$S=28672$ vertices. Any function of the form $\sum_j p_j(n)\lambda_j^{\,n}$ satisfies the
...
OEIS A224150 is ``Number of 6 X n 0..1 arrays with rows and antidiagonals unimodal and columns nondecreasing.''. It has offset $1$ and begins
\[
7, 49, 242, 930, 2985, 8375, 21183, 49365,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 28 2018 09:45:56, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{n^{12}}{479001600} + \frac{n^{11}}{26611200} + \frac{43 n^{10}}{43545600} + \frac{29 n^{9}}{1451520} + \frac{5671 n^{8}}{14515200} + \frac{2219 n^{7}}{345600} + \frac{2174569 n^{6}}{43545600} + \frac{116341 n^{5}}{483840} + \frac{8531549 n^{4}}{10886400} + \frac{2862857 n^{3}}{1814400} + \frac{3602461 n^{2}}{1663200} + \frac{2327 n}{1980} + 1.
\]
...
walk, so with $M$ the adjacency matrix of that digraph on $S=28672$ vertices, and $u,w$ the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224150.
