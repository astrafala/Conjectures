...
\title{The empirical recurrence for OEIS A204736, proved by transfer matrix}
...
\begin{abstract}
OEIS A204736 counts arrays of width $5$ over $\{0,1\}$ by reducing every $2\times2$ subblock to a
...
about it is one bit per adjacent pair of columns, so the count is a walk count on $S=143$
states.
\end{abstract}
...
OEIS A204736 is ``Number of (n+1)X5 0..1 arrays with rows and columns of permanents of all 2X2 subblocks lexicographically nondecreasing, and all 2X2 permanents nonzero.''. It has offset $1$ and begins
\[
63, 304, 1389, 6176, 26680, 113694, 476919, 1988919,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 11:27:32, revision 9) this is still
...
\]
the permanent. An array with $R$ rows and $5$ columns has $(R-1)\times4$ subblocks, and they
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 30\,a(n-2) - 14\,a(n-3) - 363\,a(n-4) + 75\,a(n-5) + 2444\,a(n-6) - 156\,a(n-7) - 10383\,a(n-8) - 177\,a(n-9) + 29550\,a(n-10) + 1794\,a(n-11) - 57869\,a(n-12) - 4627\,a(n-13) + 78312\,a(n-14) + 6440\,a(n-15) - 71976\,a(n-16) - 5208\,a(n-17) + 42880\,a(n-18) + 2304\,a(n-19) - 14928\,a(n-20) - 432\,a(n-21) + 2304\,a(n-22)
\]
for every $n>22$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204736.
