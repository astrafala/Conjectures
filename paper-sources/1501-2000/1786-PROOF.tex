...
\title{The empirical recurrence for OEIS A269106, proved by transfer matrix}
...
\begin{abstract}
OEIS A269106 counts arrays of width $5$ over $\{0,1,2,3\}$ in which the number of adjacent PAIRS of
...
OEIS A269106 is ``Number of n X 5 0..3 arrays with some element plus some horizontally or vertically adjacent neighbor totalling three no more than once.''. It has offset $1$ and begins
\[
756, 132300, 17593092, 2085484068, 232068730044, 24808345933548, 2579398703502996, 262780733311913580,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 25 2024 21:15:23, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269106.
