...
\title{The empirical recurrence for OEIS A266051, proved by transfer matrix}
...
\begin{abstract}
OEIS A266051 counts arrays of width $4$ in which every entry is equal to the NUMBER of its own
...
OEIS A266051 is ``Number of nX4 integer arrays with each element equal to the number of horizontal and antidiagonal neighbors less than or equal to itself.''. It has offset $1$ and begins
\[
7, 58, 302, 4203, 41919, 406412, 3922630, 37847050,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 20 2015 10:22:47, revision 4) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=23306.
\]
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-1) + 19\,a(n-2) + 54\,a(n-3) + 52\,a(n-4) + 580\,a(n-5) + 223\,a(n-6) - 275\,a(n-7) - 60\,a(n-8) + 44\,a(n-9) - 4\,a(n-10)
\]
for every $n>12$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A266051.
