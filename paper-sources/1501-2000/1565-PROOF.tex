...
\title{The empirical recurrence for OEIS A223677, proved by transfer matrix}
...
\begin{abstract}
OEIS A223677 counts arrays over $\{0,\dots,1\}$ whose rows, columns, diagonals or
...
OEIS A223677 is ``Number of nX5 0..1 arrays with rows and antidiagonals unimodal.''. It has offset $1$ and begins
\[
16, 256, 3177, 35509, 384009, 4106403, 43632367, 462307835,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 22:06:39, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;16\,a(n-1) - 65\,a(n-2) + 116\,a(n-3) - 387\,a(n-4) - 316\,a(n-5) + 5502\,a(n-6) - 6052\,a(n-7) - 5304\,a(n-8) + 10256\,a(n-9) - 13182\,a(n-10) + 1596\,a(n-11) + 36430\,a(n-12) - 48912\,a(n-13) + 27205\,a(n-14) - 2186\,a(n-15) - 10400\,a(n-16) + 7800\,a(n-17) - 2128\,a(n-18) + 192\,a(n-19)
\end{equation}
for all $n>19$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223677.
