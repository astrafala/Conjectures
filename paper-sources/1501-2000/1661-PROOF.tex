...
\title{The empirical recurrence for OEIS A203876, proved by counting patterns}
...
\begin{abstract}
OEIS A203876 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A203876 is ``Number of (n+1)X7 0..3 arrays with no 2X2 subblock having equal diagonal elements or equal antidiagonal elements, and new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
354295, 220541455, 137282971015, 85671438703075, 53482170255256135, 33391264599507183643, 20848169781599252276647, 13016855297041203353448907,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 10:48:20, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;679\,a(n-1) - 678\,a(n-2) - 22734242\,a(n-3) + 933140579\,a(n-4) + 155787014907\,a(n-5) - 8051016327620\,a(n-6) - 290807316124696\,a(n-7) + 19393915590207480\,a(n-8) - 42256736666853016\,a(n-9) - 8847432014178030560\,a(n-10) + 83507954113124940672\,a(n-11) + 1074868787162173623984\,a(n-12) - 16105881486499812890064\,a(n-13) + 14956375338761404032576\,a(n-14) + 524896293102578305429248\,a(n-15) - 2119130239859527520231424\,a(n-16) + 1594233946756949214802176\,a(n-17)
\end{equation}
for all $n>17$.
...
For every $n$ with $m=n+1-1\ge17$,
\[
4!\Bigl(a(n)-\sum_i c_i\,a(n-i)\Bigr)\;=\;\mathbf{v}^{\!\top}N^{\,m-17}q(N)\mathbf{1} .
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A203876.
