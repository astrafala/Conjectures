...
\title{The empirical recurrence for OEIS A235567, proved by transfer matrix}
...
\begin{abstract}
OEIS A235567 counts arrays of width $3$ over $\{0,1\}$ by reducing every $2\times2$ subblock to a
...
about it is one bit per adjacent pair of columns, so the count is a walk count on $S=49$
states.
\end{abstract}
...
OEIS A235567 is ``Number of (n+1)X(2+1) 0..1 arrays with the difference of the upper and lower median value of each 2X2 subblock in lexicographically nondecreasing order rowwise and columnwise.''. It has offset $1$ and begins
\[
50, 250, 1120, 4670, 18606, 71710, 270016, 998834,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 08:39:29, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;9\,a(n-1) - 19\,a(n-2) - 47\,a(n-3) + 211\,a(n-4) - 45\,a(n-5) - 665\,a(n-6) + 643\,a(n-7) + 714\,a(n-8) - 1200\,a(n-9) + 16\,a(n-10) + 640\,a(n-11) - 256\,a(n-12)
\]
for every $n>11$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A235567.
