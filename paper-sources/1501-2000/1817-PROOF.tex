...
\title{The empirical recurrence for OEIS A189275, proved by transfer matrix}
...
\begin{abstract}
OEIS A189275 counts the permutations of the cells of an $n\times4$ array in which every cell
...
That makes $a$ a walk count on $S=60$ states, hence $C$-finite, and whether the published
...
OEIS A189275 is ``Number of nX4 array permutations with each element not moved or moved diagonally or antidiagonally by one.''. It has offset $1$ and begins
\[
1, 25, 225, 2704, 29241, 323761, 3553225, 39100009,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 05:08:27, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;12\,a(n-1) - 7\,a(n-2) - 78\,a(n-3) + 365\,a(n-4) + 67\,a(n-5) + 269\,a(n-6) - 269\,a(n-7) - 67\,a(n-8) - 365\,a(n-9) + 78\,a(n-10) + 7\,a(n-11) - 12\,a(n-12) + a(n-13)
\]
for every $n>12$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A189275.
