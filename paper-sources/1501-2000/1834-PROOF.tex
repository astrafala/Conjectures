...
\title{The empirical recurrence for OEIS A231109, proved by transfer matrix}
...
\begin{abstract}
OEIS A231109 counts arrays of width $3$ over $\{0,1,2,3\}$ in which every cell must see, among its
...
the count is a walk count on $S=749$ states.
\end{abstract}
...
OEIS A231109 is ``Number of 3Xn 0..3 arrays x(i,j) with each element horizontally or antidiagonally next to at least one element with value (x(i,j)+1) mod 4, no adjacent elements equal, and upper left element zero.''. It has offset $1$ and begins
\[
0, 0, 8, 48, 286, 1748, 10734, 65934,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 06:15:17, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;10\,a(n-1) - 26\,a(n-2) + 6\,a(n-3) + 60\,a(n-4) - 56\,a(n-5) - 38\,a(n-6) + 54\,a(n-7) - 9\,a(n-8) + 18\,a(n-9) - 20\,a(n-10) + 2\,a(n-12)
\]
for every $n>16$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231109.
