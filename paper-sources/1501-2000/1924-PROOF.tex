...
\title{The empirical recurrence for OEIS A262329, proved by transfer matrix}
...
\begin{abstract}
OEIS A262329 counts arrays of width $6$ over $\{0,1\}$ whose rows, read as base-$2$
...
OEIS A262329 is ``Number of (n+1)X(5+1) 0..1 arrays with each row and column divisible by 3, read as a binary number with top and left being the most significant bits.''. It has offset $1$ and begins
\[
22, 99, 2106, 26131, 570922, 10789339, 237172426, 5028462531,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 18 2015 07:34:56, revision 4) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A262329.
