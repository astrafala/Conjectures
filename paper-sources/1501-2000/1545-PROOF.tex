...
\title{The empirical recurrence for OEIS A231398, proved by transfer matrix}
...
\begin{abstract}
OEIS A231398 counts $3\times(n+1)$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A231398 is ``Number of (2+1)X(n+1) 0..2 arrays with no element unequal to a strict majority of its horizontal, diagonal and antidiagonal neighbors, with values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
4, 8, 38, 90, 363, 1163, 3985, 14650,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 06:27:39, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + 12\,a(n-2) - 43\,a(n-3) - 103\,a(n-4) + 278\,a(n-5) + 418\,a(n-6) - 1103\,a(n-7) - 883\,a(n-8) + 2549\,a(n-9) + 1514\,a(n-10) - 4171\,a(n-11) - 1969\,a(n-12) + 4818\,a(n-13) + 1876\,a(n-14) - 3992\,a(n-15) - 1124\,a(n-16) + 2288\,a(n-17) + 288\,a(n-18) - 752\,a(n-19) + 96\,a(n-21)
\]
for every $n>21$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231398.
