...
\title{The empirical recurrence for OEIS A241109, proved by transfer matrix}
...
\begin{abstract}
OEIS A241109 counts arrays of width $3$ over $\{0,\dots,2\}$ under a condition on each cell
and its neighbours, and carries an empirical recurrence of order $12$ contributed by
...
OEIS A241109 is ``Number of nX3 0..2 arrays with no element equal to exactly three horizontal or vertical neighbors, with new values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
5, 113, 2612, 60340, 1394492, 32228144, 744822776, 17213554688,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 11:09:43, revision 7) this is still
...
$5$, which the model reproduces along with every later term. That is the cheapest check
...
\begin{theorem}
\[
a(n)\;=\;21\,a(n-1) + 48\,a(n-2) + 18\,a(n-3) + 16\,a(n-4) - 256\,a(n-5) - 636\,a(n-6) - 104\,a(n-7) + 560\,a(n-8) + 416\,a(n-9) + 64\,a(n-10) - 96\,a(n-11) - 64\,a(n-12)
\]
for every $n>13$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A241109.
