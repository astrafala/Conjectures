...
\title{The empirical recurrence for OEIS A252689, proved by transfer matrix}
...
\begin{abstract}
OEIS A252689 counts arrays of width $4$ over an alphabet of $4$ letters in which every three
...
OEIS A252689 is ``Number of (n+2) X (2+2) 0..3 arrays with every consecutive three elements in every row and column having exactly two distinct values, and in every diagonal and antidiagonal not having exactly two distinct values, and new values 0 upwards introduced in row major order.''. It has offset $1$ and begins
\[
96, 142, 204, 519, 1047, 2719, 6483, 16887,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 05 2018 06:14:00, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252689.
