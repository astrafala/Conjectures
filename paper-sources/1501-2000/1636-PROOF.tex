...
\title{The empirical recurrence for OEIS A280675, proved by transfer matrix}
...
\begin{abstract}
OEIS A280675 counts $3\times n$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A280675 is ``Number of 3Xn 0..2 arrays with no element equal to more than one of its horizontal and antidiagonal neighbors and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
5, 82, 858, 10205, 119440, 1401470, 16438612, 192831783,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 07 2017 08:09:37, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;11\,a(n-1) + 23\,a(n-2) - 160\,a(n-3) - 172\,a(n-4) + 690\,a(n-5) + 601\,a(n-6) - 513\,a(n-7) - 1314\,a(n-8) - 1903\,a(n-9) + 1720\,a(n-10) + 2445\,a(n-11) - 549\,a(n-12) - 998\,a(n-13) + 40\,a(n-14) + 136\,a(n-15) + 96\,a(n-16) - 32\,a(n-17) - 64\,a(n-18)
\]
for every $n>20$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A280675.
