...
\title{The empirical recurrence for OEIS A252964, proved by transfer matrix}
...
\begin{abstract}
OEIS A252964 counts arrays of width $5$ over an alphabet of $5$ letters in which every three
...
brings the state count down to $S=2918$.
\end{abstract}
...
OEIS A252964 is ``Number of (3+2) X (n+2) 0..4 arrays with every consecutive three elements in every row and diagonal having exactly two distinct values, and in every column and antidiagonal not having exactly two distinct values, and new values 0 upwards introduced in row major order.''. It has offset $1$ and begins
\[
297, 185, 259, 369, 605, 985, 1429, 2421,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 07 2018 11:52:49, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The array has width $5$ and entries in $\{0,1,\dots,4\}$. Four families of triples
...
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,
\]
with $S=2918$ states in all. The walk index $j$ and the entry's own $n$ differ by a constant,
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 6\,a(n-2) - a(n-3) - 15\,a(n-4) - 20\,a(n-5) + 27\,a(n-6) + 53\,a(n-7) - 14\,a(n-8) - 51\,a(n-9) - 45\,a(n-10) + 60\,a(n-11) + 18\,a(n-12) - 18\,a(n-13)
\]
for every $n>15$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252964.
