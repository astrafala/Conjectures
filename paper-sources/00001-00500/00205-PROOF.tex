...
\title{The empirical recurrence for OEIS A266849, proved from an exact model}
...
\begin{abstract}
OEIS A266849 carries an empirical recurrence of order $6$ contributed by Colin Barker. It is true, and it is
...
OEIS A266849 is ``Binary representation of the n-th iteration of the "Rule 71" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 110, 100, 1111011, 10000, 11111101111, 1000000, 111111110111111,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 05 2016 and Apr 18 2019: (Start) a(n) = 10101*a(n-2)-1010100*a(n-4)+1000000*a(n-6) for n>5.
\end{quote}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A266849.
