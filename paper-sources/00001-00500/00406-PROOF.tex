...
\title{The empirical recurrence for OEIS A267689, proved from an exact model}
...
\begin{abstract}
OEIS A267689 carries an empirical recurrence of order $4$ contributed by Colin Barker. It is true, and it is
...
OEIS A267689 is ``Decimal representation of the n-th iteration of the "Rule 199" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 6, 28, 122, 500, 2026, 8148, 32682,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 19 2016 and Apr 20 2019: (Start) a(n) = 6*a(n-1) - 7*a(n-2) - 6*a(n-3) + 8*a(n-4) for n > 4.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 16 2025 08:33:29, revision 27)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267689.
