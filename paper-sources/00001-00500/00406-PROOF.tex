...
\title{The empirical recurrence for OEIS A266660, proved from an exact model}
...
\begin{abstract}
OEIS A266660 carries an empirical recurrence of order $4$ contributed by Colin Barker. It is true, and it is
...
OEIS A266660 is ``Binary representation of the n-th iteration of the "Rule 47" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 110, 11, 1111100, 11, 11111111100, 11, 111111111111100,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 03 2016 and Apr 18 2019: (Start) a(n) = 10001*a(n-2)-10000*a(n-4) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 08 2025 12:21:40, revision 37)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A266660.
