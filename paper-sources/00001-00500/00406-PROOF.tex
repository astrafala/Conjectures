...
\title{The empirical recurrence for OEIS A267457, proved from an exact model}
...
\begin{abstract}
OEIS A267457 carries an empirical recurrence of order $4$ contributed by Colin Barker. It is true, and it is
...
OEIS A267457 is ``Decimal representation of the n-th iteration of the "Rule 133" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 2, 4, 8, 84, 168, 1364, 2728,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 15 2016 and Apr 19 2019: (Start) a(n) = 17*a(n-2)-16*a(n-4) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 28 2025 04:55:11, revision 31)
...
gives the monic annihilator of order $S=8$ used below.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267457.
