...
\title{The empirical recurrence for OEIS A266252, proved from an exact model}
...
\begin{abstract}
OEIS A266252 carries an empirical recurrence of order $5$ contributed by Colin Barker. It is true, and it is
...
OEIS A266252 is ``Total number of OFF (white) cells after n iterations of the "Rule 9" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
0, 3, 6, 11, 16, 22, 31, 37,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Dec 28 2015 and Apr 14 2019: (Start) a(n) = a(n-1)+2*a(n-2)-2*a(n-3)-a(n-4)+a(n-5) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 16 2025 08:33:28, revision 15)
...
For this entry the automaton is rule 9, the period is $p=2$ and the pre-period is $n_0=4$.
The certificate is
\begin{gather*}
r=0:\quad w(n+p) = \texttt{0000} \cdot w(n) \cdot \varepsilon \\
r=1:\quad w(n+p) = \texttt{1111} \cdot w(n) \cdot \varepsilon
\end{gather*}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A266252.
