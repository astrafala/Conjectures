...
\title{The empirical recurrence for OEIS A267888, proved from an exact model}
...
\begin{abstract}
OEIS A267888 carries an empirical recurrence of order $2$. It is true, and it is
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 24 2025 12:31:05, revision 23)
