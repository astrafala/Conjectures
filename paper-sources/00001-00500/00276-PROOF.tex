...
\title{The empirical recurrence for OEIS A266259, proved from an exact model}
...
\begin{abstract}
OEIS A266259 carries an empirical recurrence of order $5$ contributed by Colin Barker. It is true, and it is
...
OEIS A266259 is ``Total number of OFF (white) cells after n iterations of the "Rule 11" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
0, 2, 5, 7, 14, 16, 27, 29,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Dec 27 2015 and Apr 14 2019: (Start) a(n) = a(n-1)+2*a(n-2)-2*a(n-3)-a(n-4)+a(n-5) for n>4.
\end{quote}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A266259.
