...
\title{The empirical recurrence for OEIS A279879, proved from an exact model}
...
\begin{abstract}
OEIS A279879 carries an empirical recurrence of order $6$ contributed by Colin Barker. It is true, and it is
...
OEIS A279879 is ``Decimal representation of the x-axis, from the left edge to the origin, of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 213", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 2, 2, 12, 7, 56, 15, 240,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Dec 22 2016: (Start) a(n) = 7*a(n-2)-14*a(n-4)+8*a(n-6) for n>6.
\end{quote}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A279879.
