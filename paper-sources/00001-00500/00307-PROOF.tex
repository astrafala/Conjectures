...
\title{The empirical recurrence for OEIS A267354, proved from an exact model}
...
\begin{abstract}
OEIS A267354 carries an empirical recurrence of order $4$. It is true, and it is
...
OEIS A267354 is ``Number of OFF (white) cells in the n-th iteration of the "Rule 123" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
0, 1, 2, 1, 6, 1, 10, 1,\ \dots
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267354.
