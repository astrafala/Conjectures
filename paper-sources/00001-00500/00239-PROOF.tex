...
\title{The empirical recurrence for OEIS A283641, proved from an exact model}
...
\begin{abstract}
OEIS A283641 carries an empirical recurrence of order $3$. It is true, and it is
...
OEIS A283641 is ``Binary representation of the x-axis, from the left edge to the origin, of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 678", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 11, 101, 1101, 10101, 110101, 1010101, 11010101,\ \dots
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A283641.
