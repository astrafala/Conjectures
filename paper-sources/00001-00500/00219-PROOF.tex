...
\title{The empirical recurrence for OEIS A266610, proved from an exact model}
...
\begin{abstract}
OEIS A266610 carries an empirical recurrence of order $6$ contributed by Colin Barker. It is true, and it is
...
OEIS A266610 is ``Decimal representation of the n-th iteration of the "Rule 41" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 0, 5, 100, 1, 2040, 5, 32740,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 02 2016 and Apr 18 2019: (Start) a(n) = 16*a(n-2)+a(n-4)-16*a(n-6) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 16 2025 08:33:28, revision 26)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A266610.
