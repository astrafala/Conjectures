...
\title{The empirical recurrence for OEIS A287190, proved from an exact model}
...
\begin{abstract}
OEIS A287190 carries an empirical recurrence of order $4$ contributed by Colin Barker. It is true, and it is
...
OEIS A287190 is ``Binary representation of the diagonal from the corner to the origin of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 253", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 10, 0, 1110, 11, 111110, 11, 11111110,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, May 22 2017: (Start) a(n) = 101*a(n-2) - 100*a(n-4) for n>4.
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 05 2025 15:22:39, revision 11)
...
neighbourhood to a live cell flips the ENTIRE plane, and rule 253 is read
...
vanish from $n=6+1$ onwards, and the run exceeds $S+4$, which by
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A287190.
