...
\title{The empirical recurrence for OEIS A267459, proved from an exact model}
...
\begin{abstract}
OEIS A267459 carries an empirical recurrence of order $4$ contributed by Colin Barker. It is true, and it is
...
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 16 2016 and Apr 17 2019: (Start) a(n) = 2*a(n-1) - 2*a(n-3) + a(n-4) for n > 4.
\end{quote}
