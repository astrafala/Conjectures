...
\title{The empirical recurrence for OEIS A266596, proved from an exact model}
...
\begin{abstract}
OEIS A266596 carries an empirical recurrence of order $5$ contributed by Colin Barker. It is true, and it is
