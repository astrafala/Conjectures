...
\title{The empirical recurrence for OEIS A265722, proved from an exact model}
...
\begin{abstract}
OEIS A265722 carries an empirical recurrence of order $4$ contributed by Colin Barker. It is true, and it is
...
\begin{quote}
Conjectures from \_Colin Barker\_, Dec 14 2015 and Apr 16 2019: (Start) a(n) = 2*a(n-2) - a(n-4) for n>3.
\end{quote}
