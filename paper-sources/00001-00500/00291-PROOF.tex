...
\title{The empirical recurrence for OEIS A288662, proved from an exact model}
...
\begin{abstract}
OEIS A288662 carries an empirical recurrence of order $6$ contributed by Colin Barker. It is true, and it is
...
\[
1, 1, 100, 11, 11000, 111, 1110000, 1111,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Jun 13 2017: (Start) a(n) = 111*a(n-2) - 1110*a(n-4) + 1000*a(n-6) for n>6.
\end{quote}
