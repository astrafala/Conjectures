...
\title{The empirical recurrence for OEIS A267526, proved from an exact model}
...
\begin{abstract}
OEIS A267526 carries an empirical recurrence of order $4$ contributed by Colin Barker. It is true, and it is
...
OEIS A267526 is ``Binary representation of the n-th iteration of the "Rule 141" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 10, 101, 1011, 1010111, 10101111, 10101011111, 101010111111,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 16 2016: (Start) a(n) = 11*a(n-1) + 9990*a(n-2) - 110000*a(n-3) + 100000*a(n-4) for n > 5.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 16 2025 08:33:29, revision 44)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267526.
