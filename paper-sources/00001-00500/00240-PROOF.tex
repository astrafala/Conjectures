...
\title{The empirical recurrence for OEIS A267002, proved from an exact model}
...
\begin{abstract}
OEIS A267002 carries an empirical recurrence of order $6$ contributed by Colin Barker. It is true, and it is
...
OEIS A267002 is ``Binary representation of the n-th iteration of the "Rule 83" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 101, 1000, 1101111, 1000000, 11101111111, 1000000000, 111101111111111,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 08 2016 and Apr 19 2019: (Start) a(n) = 11001*a(n-2)-10011000*a(n-4)+10000000*a(n-6) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 16 2025 08:33:29, revision 31)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267002.
