...
\title{The empirical recurrence for OEIS A312981, proved from an exact model}
...
\begin{abstract}
OEIS A312981 carries an empirical recurrence of order $10$ contributed by Chai Wah Wu. It is true, and it is
...
OEIS A312981 is ``Coordination sequence Gal.5.146.4 where Gal.u.t.v denotes the coordination sequence for a vertex of type v in tiling number t in the Galebach list of u-uniform tilings.''. It has offset $0$ and begins
\[
1, 4, 9, 13, 20, 22, 28, 31,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Chai Wah Wu\_, Jan 04 2020: (Start) a(n) = 2*a(n-5) - a(n-10) for n > 10.
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 21 2023 15:10:46, revision 7)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A312981.
