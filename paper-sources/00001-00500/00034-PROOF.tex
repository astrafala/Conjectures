...
\title{The empirical recurrence for OEIS A315942, proved from an exact model}
...
\begin{abstract}
OEIS A315942 carries an empirical recurrence of order $12$ contributed by Chai Wah Wu. It is true, and it is
...
OEIS A315942 is ``Coordination sequence Gal.6.507.5 where Gal.u.t.v denotes the coordination sequence for a vertex of type v in tiling number t in the Galebach list of u-uniform tilings.''. It has offset $0$ and begins
\[
1, 6, 8, 18, 18, 22, 36, 34,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Chai Wah Wu\_, Jan 09 2020: (Start) a(n) = 2*a(n-6) - a(n-12) for n > 12.
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 21 2023 15:11:11, revision 6)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A315942.
