...
\title{The empirical recurrence for OEIS A315405, proved from an exact model}
...
\begin{abstract}
OEIS A315405 carries an empirical recurrence of order $4$ contributed by Chai Wah Wu. It is true, and it is
...
OEIS A315405 is ``Coordination sequence Gal.3.15.3 where Gal.u.t.v denotes the coordination sequence for a vertex of type v in tiling number t in the Galebach list of u-uniform tilings.''. It has offset $0$ and begins
\[
1, 6, 11, 15, 19, 24, 30, 36,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Chai Wah Wu\_, Sep 02 2025: (Start) a(n) = 3*a(n-1) - 4*a(n-2) + 3*a(n-3) - a(n-4) for n > 4.
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 03 2025 04:20:56, revision 7)
...
the same direction set.) The vertices fall into $6$ orbits under $L$, and a vertex is
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) - 4\,a(n-2) + 3\,a(n-3) - a(n-4)
\]
for every $n>4$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A315405.
