...
\title{The empirical recurrence for OEIS A063161, proved from an exact model}
...
\begin{abstract}
OEIS A063161 carries an empirical recurrence of order $4$ contributed by Colin Barker. It is true, and it is
...
OEIS A063161 is ``Dimension of the space of weight 2n cusp forms for Gamma\_0( 93 ).''. It has offset $1$ and begins
\[
9, 30, 52, 72, 94, 116, 136, 158,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjecture: a(n) = a(n-1)+a(n-3)-a(n-4) for n>5. G.f.: x*(1+x)*(9+12*x+10*x\^{}2+x\^{}3)/((1-x)\^{}2*(1+x+x\^{}2)). [\_Colin Barker\_, Sep 26 2012]
\end{quote}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A063161.
