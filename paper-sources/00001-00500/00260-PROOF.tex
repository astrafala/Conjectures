...
\title{The empirical recurrence for OEIS A266725, proved from an exact model}
...
\begin{abstract}
OEIS A266725 carries an empirical recurrence of order $5$. It is true, and it is
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 11 2025 05:28:11, revision 27)
