...
\title{The empirical recurrence for OEIS A211257, proved by a one-dimensional reduction}
...
\begin{abstract}
OEIS A211257 counts symmetric $(n+1)\times(n+1)$ matrices over
$\{-6,\dots,6\}$ in which every $2\times2$ subblock sums to zero and has one, two or three distinct
...
on $S=586$ states, and the empirical recurrence of order $24$ contributed by R.~H.~Hardin
follows.
\end{abstract}
...
OEIS A211257 is ``Number of (n+1)X(n+1) -6..6 symmetric matrices with every 2X2 subblock having sum zero and one, two or three distinct values.''. It has offset $1$ and begins
\[
85, 231, 547, 1283, 2901, 6595, 14775, 33409,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 16:09:05, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{The sum-zero condition solved}

Let $x$ be an $N\times N$ symmetric matrix with entries in $\{-6,\dots,6\}$ such that
\[
...
\qquad u_0,\dots,u_{N-1}\in\{-6,\dots,6\}\ \text{all of the same parity},
\]
...
the same parity; and $|x(i,j)|=|u_i+u_j|/2\le6$ for all $i,j$ is equivalent to $|u_i|\le6$
...
$\{-6,\dots,6\}$ with all entries of one parity. What remains is to say, in terms of $u$,
...
the compatibility graph on the $\le 169$ pairs.
\end{corollary}
...
$S=586$. The two parity classes never mix, so the walk starts by choosing a parity and a first
value, and every state may end a sequence:
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad \tau=\mathbf{1},\qquad S=586.
\]
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) + 6\,a(n-2) - 97\,a(n-3) + 62\,a(n-4) + 668\,a(n-5) - 852\,a(n-6) - 2556\,a(n-7) + 4359\,a(n-8) + 5935\,a(n-9) - 12593\,a(n-10) - 8545\,a(n-11) + 22727\,a(n-12) + 7400\,a(n-13) - 26431\,a(n-14) - 3396\,a(n-15) + 19783\,a(n-16) + 389\,a(n-17) - 9298\,a(n-18) + 302\,a(n-19) + 2606\,a(n-20) - 118\,a(n-21) - 392\,a(n-22) + 12\,a(n-23) + 24\,a(n-24)
\]
for every $n>24$.
\end{theorem}
...
symmetric matrices were written out entry by entry over $\{-6,\dots,6\}$ and each
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A211257.
