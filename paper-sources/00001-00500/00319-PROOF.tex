...
\begin{abstract}
OEIS A266794 carries an empirical recurrence of order $4$ contributed by Colin Barker. It is true, and it is
...
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 04 2016 and Apr 17 2019: (Start) a(n) = 2*a(n-2)-a(n-4) for n>7.
\end{quote}
