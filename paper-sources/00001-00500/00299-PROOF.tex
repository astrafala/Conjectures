...
\title{The empirical recurrence for OEIS A266981, proved from an exact model}
...
\begin{abstract}
OEIS A266981 carries an empirical recurrence of order $4$ contributed by Colin Barker. It is true, and it is
...
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 08 2016 and Apr 19 2019: (Start) a(n) = 2*a(n-2)-a(n-4) for n>3.
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 12 2025 08:08:48, revision 33)
...
For this entry the automaton is rule 79, the period is $p=2$ and the pre-period is $n_0=0$.
The certificate is
\begin{gather*}
