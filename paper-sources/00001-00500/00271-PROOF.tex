...
\title{The empirical recurrence for OEIS A267846, proved from an exact model}
...
\begin{abstract}
OEIS A267846 carries an empirical recurrence of order $2$. It is true, and it is
...
OEIS A267846 is ``Binary representation of the n-th iteration of the "Rule 227" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 100, 11010, 1111010, 111111010, 11111111010, 1111111111010, 111111111111010,\ \dots
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267846.
