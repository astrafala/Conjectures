...
\title{The empirical recurrence for OEIS A282917, proved from an exact model}
...
\begin{abstract}
OEIS A282917 carries an empirical recurrence of order $6$ contributed by Colin Barker. It is true, and it is
...
\[
1, 0, 1, 0, 7, 1, 28, 1,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Feb 25 2017: (Start) a(n) = a(n-2) + 16*a(n-4) - 16*a(n-6) for n>6.
\end{quote}
