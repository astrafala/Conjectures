...
\title{The empirical recurrence for OEIS A266594, proved from an exact model}
...
\begin{abstract}
OEIS A266594 carries an empirical recurrence of order $5$ contributed by Colin Barker. It is true, and it is
...
OEIS A266594 is ``Total number of ON (black) cells after n iterations of the "Rule 37" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 2, 5, 7, 10, 16, 19, 29,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 02 2016 and Apr 18 2019: (Start) a(n) = a(n-1)+2*a(n-2)-2*a(n-3)-a(n-4)+a(n-5) for n>5.
\end{quote}
...
For this entry the automaton is rule 37, the period is $p=2$ and the pre-period is $n_0=2$.
The certificate is
\begin{gather*}
...
vanish from $n=5+1$ onwards, and the run exceeds $S+5$, which by
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A266594.
