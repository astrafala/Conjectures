...
\title{The empirical recurrence for OEIS A211711, proved by a one-dimensional reduction}
...
\begin{abstract}
OEIS A211711 counts symmetric $(n+1)\times(n+1)$ matrices over
$\{-11,\dots,11\}$ in which every $2\times2$ subblock sums to zero and has three distinct
...
on $S=1030$ states, and the empirical recurrence of order $21$ contributed by R.~H.~Hardin
follows.
\end{abstract}
...
OEIS A211711 is ``Number of (n+1)X(n+1) -11..11 symmetric matrices with every 2X2 subblock having sum zero and three distinct values.''. It has offset $1$ and begins
\[
230, 516, 1030, 1908, 3528, 6312, 11390, 20316,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 16:17:59, revision 8) this is still
...
$S=1030$. The two parity classes never mix, so the walk starts by choosing a parity and a first
value, and every state may end a sequence:
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad \tau=\mathbf{1},\qquad S=1030.
\]
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) + 3\,a(n-2) - 83\,a(n-3) + 92\,a(n-4) + 443\,a(n-5) - 868\,a(n-6) - 1073\,a(n-7) + 3394\,a(n-8) + 748\,a(n-9) - 7085\,a(n-10) + 1842\,a(n-11) + 8231\,a(n-12) - 4528\,a(n-13) - 5075\,a(n-14) + 3936\,a(n-15) + 1424\,a(n-16) - 1511\,a(n-17) - 121\,a(n-18) + 244\,a(n-19) - 6\,a(n-20) - 12\,a(n-21)
\]
for every $n>21$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A211711.
