...
\title{The empirical recurrence for OEIS A211443, proved by a one-dimensional reduction}
...
\begin{abstract}
OEIS A211443 counts symmetric $(n+1)\times(n+1)$ matrices over
$\{-7,\dots,7\}$ in which every $2\times2$ subblock sums to zero and has one or three distinct
...
on $S=329$ states, and the empirical recurrence of order $14$ contributed by R.~H.~Hardin
follows.
\end{abstract}
...
OEIS A211443 is ``Number of (n+1)X(n+1) -7..7 symmetric matrices with every 2X2 subblock having sum zero and one or three distinct values.''. It has offset $1$ and begins
\[
91, 201, 397, 765, 1459, 2751, 5215, 9855,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 16:10:13, revision 8) this is still
...
$S=329$. The two parity classes never mix, so the walk starts by choosing a parity and a first
value, and every state may end a sequence:
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad \tau=\mathbf{1},\qquad S=329.
\]
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + 9\,a(n-2) - 31\,a(n-3) - 30\,a(n-4) + 125\,a(n-5) + 48\,a(n-6) - 251\,a(n-7) - 46\,a(n-8) + 264\,a(n-9) + 40\,a(n-10) - 138\,a(n-11) - 28\,a(n-12) + 28\,a(n-13) + 8\,a(n-14)
\]
for every $n>14$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A211443.
