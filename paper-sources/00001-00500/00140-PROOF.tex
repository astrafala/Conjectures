...
\title{The empirical recurrence for OEIS A211551, proved by a one-dimensional reduction}
...
\begin{abstract}
OEIS A211551 counts symmetric $(n+1)\times(n+1)$ matrices over
$\{-9,\dots,9\}$ in which every $2\times2$ subblock sums to zero and has one or three distinct
...
on $S=651$ states, and the empirical recurrence of order $18$ contributed by R.~H.~Hardin
follows.
\end{abstract}
...
OEIS A211551 is ``Number of (n+1)X(n+1) -9..9 symmetric matrices with every 2X2 subblock having sum zero and one or three distinct values.''. It has offset $1$ and begins
\[
151, 347, 697, 1351, 2573, 4843, 9101, 17119,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 16:13:05, revision 8) this is still
...
$S=651$. The two parity classes never mix, so the walk starts by choosing a parity and a first
value, and every state may end a sequence:
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad \tau=\mathbf{1},\qquad S=651.
\]
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + 11\,a(n-2) - 60\,a(n-3) - 34\,a(n-4) + 375\,a(n-5) - 53\,a(n-6) - 1270\,a(n-7) + 601\,a(n-8) + 2541\,a(n-9) - 1636\,a(n-10) - 3075\,a(n-11) + 2204\,a(n-12) + 2210\,a(n-13) - 1562\,a(n-14) - 875\,a(n-15) + 530\,a(n-16) + 150\,a(n-17) - 60\,a(n-18)
\]
for every $n>18$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A211551.
