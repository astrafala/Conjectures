...
\title{The empirical recurrence for OEIS A211467, proved by a one-dimensional reduction}
...
\begin{abstract}
OEIS A211467 counts symmetric $(n+1)\times(n+1)$ matrices over
$\{-8,\dots,8\}$ in which every $2\times2$ subblock sums to zero and has three distinct
...
on $S=476$ states, and the empirical recurrence of order $15$ contributed by R.~H.~Hardin
follows.
\end{abstract}
...
OEIS A211467 is ``Number of (n+1)X(n+1) -8..8 symmetric matrices with every 2X2 subblock having sum zero and three distinct values.''. It has offset $1$ and begins
\[
120, 260, 508, 940, 1734, 3126, 5690, 10276,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 16:11:12, revision 8) this is still
...
that every $2\times2$ subblock has three distinct entries.
...
Call two consecutive pairs COMPATIBLE when that number lies in $\{3\}$. The condition on the
...
$S=476$. The two parity classes never mix, so the walk starts by choosing a parity and a first
value, and every state may end a sequence:
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad \tau=\mathbf{1},\qquad S=476.
\]
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + 9\,a(n-2) - 52\,a(n-3) - 16\,a(n-4) + 271\,a(n-5) - 86\,a(n-6) - 724\,a(n-7) + 435\,a(n-8) + 1052\,a(n-9) - 760\,a(n-10) - 817\,a(n-11) + 575\,a(n-12) + 320\,a(n-13) - 150\,a(n-14) - 60\,a(n-15)
\]
for every $n>15$.
\end{theorem}
...
$2\times2$ subblock tested for summing to zero and for having three distinct entries. The
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A211467.
