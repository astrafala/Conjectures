...
\title{The empirical recurrence for OEIS A267154, proved from an exact model}
...
\begin{abstract}
OEIS A267154 carries an empirical recurrence of order $6$. It is true, and it is
...
OEIS A267154 is ``Decimal representation of the n-th iteration of the "Rule 107" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 4, 11, 110, 119, 1978, 475, 32510,\ \dots
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267154.
