...
\title{The empirical recurrence for OEIS A313965, proved from an exact model}
...
\begin{abstract}
OEIS A313965 carries an empirical recurrence of order $14$ contributed by Chai Wah Wu. It is true, and it is
...
which $a$ provably satisfies a MONIC linear recurrence of order $S=60$, derived below and not
...
OEIS A313965 is ``Coordination sequence Gal.5.284.3 where Gal.u.t.v denotes the coordination sequence for a vertex of type v in tiling number t in the Galebach list of u-uniform tilings.''. It has offset $0$ and begins
\[
1, 5, 10, 17, 21, 27, 32, 36,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Chai Wah Wu\_, May 07 2024: (Start) a(n) = - a(n-1) - a(n-3) - a(n-4) + 2*a(n-5) + 2*a(n-6) + 2*a(n-8) + 2*a(n-9) - a(n-10) - a(n-11) - a(n-13) - a(n-14) for n > 14.
\end{quote}
As of the ``Last modified'' line on the live entry (May 07 2024 11:03:11, revision 7)
...
\begin{theorem}
\[
a(n)\;=\;-a(n-1) - a(n-3) - a(n-4) + 2\,a(n-5) + 2\,a(n-6) + 2\,a(n-8) + 2\,a(n-9) - a(n-10) - a(n-11) - a(n-13) - a(n-14)
\]
for every $n>14$.
\end{theorem}
...
vanish from $n=14+1$ onwards, and the run exceeds $S+14$, which by
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A313965.
