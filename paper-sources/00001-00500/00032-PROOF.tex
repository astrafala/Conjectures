...
\title{The empirical recurrence for OEIS A315047, proved from an exact model}
...
\begin{abstract}
OEIS A315047 carries an empirical recurrence of order $12$ contributed by Chai Wah Wu. It is true, and it is
...
OEIS A315047 is ``Coordination sequence Gal.5.204.4 where Gal.u.t.v denotes the coordination sequence for a vertex of type v in tiling number t in the Galebach list of u-uniform tilings.''. It has offset $0$ and begins
\[
1, 5, 9, 15, 20, 24, 28, 35,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Chai Wah Wu\_, Sep 20 2025: (Start) a(n) = - a(n-1) - a(n-2) + 2*a(n-5) + 2*a(n-6) + 2*a(n-7) - a(n-10) - a(n-11) - a(n-12) for n > 12.
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 20 2025 13:23:46, revision 7)
...
the same direction set.) The vertices fall into $14$ orbits under $L$, and a vertex is
...
\begin{theorem}
\[
a(n)\;=\;-a(n-1) - a(n-2) + 2\,a(n-5) + 2\,a(n-6) + 2\,a(n-7) - a(n-10) - a(n-11) - a(n-12)
\]
for every $n>12$.
\end{theorem}
...
vanish from $n=12+1$ onwards, and the run exceeds $S+12$, which by
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A315047.
