...
\title{The empirical recurrence for OEIS A267046, proved from an exact model}
...
\begin{abstract}
OEIS A267046 carries an empirical recurrence of order $4$. It is true, and it is
...
OEIS A267046 is ``Number of ON (black) cells in the n-th iteration of the "Rule 91" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 2, 2, 4, 5, 8, 5, 12,\ \dots
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267046.
