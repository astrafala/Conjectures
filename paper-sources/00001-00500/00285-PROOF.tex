...
\title{The empirical recurrence for OEIS A266723, proved from an exact model}
...
\begin{abstract}
OEIS A266723 carries an empirical recurrence of order $5$ contributed by Colin Barker. It is true, and it is
...
OEIS A266723 is ``Total number of ON (black) cells after n iterations of the "Rule 59" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 3, 5, 11, 13, 23, 25, 39,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 05 2016 and Apr 18 2019: (Start) a(n) = a(n-1)+2*a(n-2)-2*a(n-3)-a(n-4)+a(n-5) for n>4.
\end{quote}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A266723.
