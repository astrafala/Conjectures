...
\title{The empirical recurrence for OEIS A267595, proved from an exact model}
...
\begin{abstract}
OEIS A267595 carries an empirical recurrence of order $2$. It is true, and it is
...
OEIS A267595 is ``Binary representation of the n-th iteration of the "Rule 173" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 10, 1111, 111111, 11111111, 1111111111, 111111111111, 11111111111111,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
(the empirical recurrence quoted in the entry)
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 07 2025 06:51:49, revision 33)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267595.
