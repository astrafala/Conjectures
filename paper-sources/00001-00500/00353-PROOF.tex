...
\title{The empirical recurrence for OEIS A267036, proved from an exact model}
...
\begin{abstract}
OEIS A267036 carries an empirical recurrence of order $3$. It is true, and it is
...
OEIS A267036 is ``Decimal representation of the n-th iteration of the "Rule 85" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 3, 16, 63, 256, 1023, 4096, 16383,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
(the empirical recurrence quoted in the entry)
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 16 2025 08:33:29, revision 28)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267036.
