...
\title{The empirical recurrence for OEIS A267453, proved from an exact model}
...
\begin{abstract}
OEIS A267453 carries an empirical recurrence of order $7$ contributed by Colin Barker. It is true, and it is
