...
\title{The empirical recurrence for OEIS A283400, proved from an exact model}
...
\begin{abstract}
OEIS A283400 carries an empirical recurrence of order $3$. It is true, and it is
...
OEIS A283400 is ``Binary representation of the x-axis, from the left edge to the origin, of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 633", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 0, 11, 1, 1110, 110, 111110, 11100,\ \dots
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A283400.
