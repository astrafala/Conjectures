...
\title{Recovering the unwritten recurrences of the table OEIS A235248}
...
\begin{abstract}
OEIS A235248 is a two-dimensional table $T(n,k)$ whose empirical recurrences are, for several of
...
OEIS A235248 is ``T(n,k) is the number of (n+1) X (k+1) 0..7 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 6, with no adjacent elements equal (constant-stress tilted 1 X 1 tilings).''. It is read by antidiagonals and begins
\[
210, 906, 906, 3746, 3146, 3746, 16150, 10866,\ \dots
\]
The entry carries, among its empirical claims:
\begin{quote}\small
k=2: [order 35].
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 18 2022 23:51:36, revision 7) these are still
...
\[
(c_1,\dots,c_{35})=(10,\ 74,\ -1028,\ -1552,\ 46036,\ -24442,\ -1177460,\ 1943623,\ 18929582,\ -46678364,\ -197883208,\ 641672504,\ 1336005112,\ -5669843140,\ -5468829608,\ 33406180141,\ 10415153798,\ -132321704558,\ 11352730700,\ 350059155896,\ -111967629644,\ -608429901490,\ 262134791548,\ 679376121053,\ -292943901086,\ -478176518752,\ 156339289216,\ 209957565216,\ -34929735168,\ -53104170864,\ 1188145056,\ 6857059248,\ 568465632,\ -342553536,\ -52700544).
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A235248.
