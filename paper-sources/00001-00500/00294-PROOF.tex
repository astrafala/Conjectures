...
\title{The empirical recurrence for OEIS A188789, proved from an exact model}
...
\begin{abstract}
OEIS A188789 carries an empirical recurrence of order $5$. It is true, and it is
...
OEIS A188789 is ``Number of 6-step self-avoiding walks on an n X n X n X n 4-cube summed over all starting positions.''. It has offset $1$ and begins
\[
0, 4224, 174720, 1141248, 3974784, 10183872, 21725776, 41004288,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 18584*n\^{}4 - 82552*n\^{}3 + 119616*n\^{}2 - 64320*n + 9984 for n>4. a(n) = 5*a(n-1) - 10*a(n-2) + 10*a(n-3) - 5*a(n-4) + a(n-5) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 30 2018 11:19:10, revision 9)
...
SHAPE when one is a translate of the other. There are exactly $18584$ shapes: self-avoiding
sequences of $6$ distinct cells in $\mathbf{Z}^{4}$ with each consecutive difference in
...
Write $w^\ast$ for the largest bounding-box side over all $18584$ shapes. Once $n\ge w^\ast$
...
$z^{6}(z-1)^{5}$, monic of order $S=11$. Both numbers are read off the enumerated
...
vanish from $n=9+1$ onwards, and the run exceeds $S+5$, which by
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A188789.
