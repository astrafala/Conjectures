...
\title{The empirical recurrence for OEIS A285835, proved by transfer matrix}
...
\begin{abstract}
OEIS A285835 carries an empirical recurrence of order $6$ contributed by R.~H.~Hardin. It is
...
OEIS A285835 is ``Decimal representation of the diagonal from the origin to the corner of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 107", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 3, 6, 15, 12, 63, 24, 255,\ \dots
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A285835.
