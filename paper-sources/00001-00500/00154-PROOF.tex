...
\title{The empirical recurrence for OEIS A283586, proved from an exact model}
...
\begin{abstract}
OEIS A283586 carries an empirical recurrence of order $9$. It is true, and it is
...
OEIS A283586 is ``Binary representation of the x-axis, from the origin to the right edge, of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 654", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 11, 111, 1011, 10111, 101011, 1000111, 11011011,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
(the empirical recurrence quoted in the entry)
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 05 2025 15:22:37, revision 13)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A283586.
