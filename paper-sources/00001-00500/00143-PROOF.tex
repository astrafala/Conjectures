...
\begin{abstract}
OEIS A283581 carries an empirical recurrence of order $10$ contributed by Colin Barker. It is true, and it is
...
\begin{quote}
Conjectures from \_Colin Barker\_, Mar 12 2017: (Start) a(n) = a(n-2) + 100000000*a(n-8) - 100000000*a(n-10) for n>11.
\end{quote}
