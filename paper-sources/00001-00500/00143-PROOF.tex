...
\title{The empirical recurrence for OEIS A282829, proved from an exact model}
...
\begin{abstract}
OEIS A282829 carries an empirical recurrence of order $10$. It is true, and it is
...
pre-period to raise the numerator's degree gives a monic annihilator of order $S=36$. The
...
vanish from $n=17+1$ onwards, and the run exceeds $S+10$, which by
