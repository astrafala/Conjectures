...
\title{The empirical recurrence for OEIS A211254, proved by a one-dimensional reduction}
...
\begin{abstract}
OEIS A211254 counts symmetric $(n+1)\times(n+1)$ matrices over
$\{-6,\dots,6\}$ in which every $2\times2$ subblock sums to zero and has three distinct
...
on $S=205$ states, and the empirical recurrence of order $13$ contributed by R.~H.~Hardin
follows.
\end{abstract}
...
OEIS A211254 is ``Number of (n+1) X (n+1) -6..6 symmetric matrices with every 2 X 2 subblock having sum zero and three distinct values.''. It has offset $1$ and begins
\[
64, 130, 246, 456, 840, 1538, 2830, 5214,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 16 2018 05:22:38, revision 8) this is still
...
$S=205$. The two parity classes never mix, so the walk starts by choosing a parity and a first
value, and every state may end a sequence:
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad \tau=\mathbf{1},\qquad S=205.
\]
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) - 36\,a(n-3) + 41\,a(n-4) + 82\,a(n-5) - 151\,a(n-6) - 54\,a(n-7) + 204\,a(n-8) - 28\,a(n-9) - 110\,a(n-10) + 36\,a(n-11) + 20\,a(n-12) - 8\,a(n-13)
\]
for every $n>13$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A211254.
