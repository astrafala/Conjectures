...
\title{The empirical recurrence for OEIS A284246, proved from an exact model}
...
\begin{abstract}
OEIS A284246 carries an empirical recurrence of order $6$ contributed by Chai Wah Wu. It is true, and it is
...
\[
1, 0, 6, 14, 30, 46, 46, 190,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Chai Wah Wu\_, May 06 2024: (Start) a(n) = 4*a(n-2) + a(n-4) - 4*a(n-6) for n > 16.
\end{quote}
