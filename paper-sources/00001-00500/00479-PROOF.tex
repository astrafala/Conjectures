...
\title{The empirical recurrence for OEIS A222445, proved by transfer matrix}
...
\begin{abstract}
OEIS A222445 counts the distinct indicator arrays obtained from the $n\times2$ arrays over
...
indicator row by row turns it into one, on $S=192$ states, after which the conjectured
...
OEIS A222445 is ``Sum of neighbor maps: number of nX2 binary arrays indicating the locations of corresponding elements equal to the sum mod 4 of their horizontal, vertical and antidiagonal neighbors in a random 0..3 nX2 array.''. It has offset $1$ and begins
\[
2, 14, 64, 210, 1024, 4000, 16288, 65536,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 20:25:15, revision 9) this is still
...
\]
There are $S=192$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite. Note
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + 60\,a(n-5) - 240\,a(n-6) - 1456\,a(n-10) + 5824\,a(n-11) + 18496\,a(n-15) - 73984\,a(n-16) - 133120\,a(n-20) + 532480\,a(n-21) + 544768\,a(n-25) - 2179072\,a(n-26) - 1179648\,a(n-30) + 4718592\,a(n-31) + 1048576\,a(n-35) - 4194304\,a(n-36)
\]
for every $n>36$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A222445.
