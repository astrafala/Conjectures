...
\title{The empirical recurrence for OEIS A282123, proved from an exact model}
...
\begin{abstract}
OEIS A282123 carries an empirical recurrence of order $4$ contributed by Colin Barker. It is true, and it is
...
OEIS A282123 is ``Decimal representation of the x-axis, from the left edge to the origin, of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 430", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 3, 6, 15, 26, 63, 106, 255,\ \dots
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A282123.
