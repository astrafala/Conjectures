...
\title{The empirical recurrence for OEIS A221663, proved by transfer matrix}
...
\begin{abstract}
OEIS A221663 counts the distinct indicator arrays obtained from the $n\times2$ arrays over
$\{0,\dots,2\}$ by marking the cells whose value is congruent modulo 3 to the sum of their neighbours, and carries an
...
indicator row by row turns it into one, on $S=132$ states, after which the conjectured
...
OEIS A221663 is ``Sum of neighbor maps: number of nX2 binary arrays indicating the locations of corresponding elements equal to the sum mod 3 of their horizontal, diagonal and antidiagonal neighbors in a random 0..2 nX2 array.''. It has offset $1$ and begins
\[
2, 12, 48, 256, 856, 4096, 15872, 65344,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 19:51:33, revision 9) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

Let $R=\{0,\dots,2\}^{2}$ be the set of rows and let the neighbours of a cell be the
...
is congruent modulo 3 to the sum of its neighbours. The entry counts
\[
...
\]
There are $S=132$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite. Note
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + 8\,a(n-2) - 32\,a(n-3) - 16\,a(n-4) + 64\,a(n-5) + 52\,a(n-6) - 208\,a(n-7) - 416\,a(n-8) + 1664\,a(n-9) + 832\,a(n-10) - 3328\,a(n-11) - 1056\,a(n-12) + 4224\,a(n-13) + 8448\,a(n-14) - 33792\,a(n-15) - 16896\,a(n-16) + 67584\,a(n-17) + 10880\,a(n-18) - 43520\,a(n-19) - 87040\,a(n-20) + 348160\,a(n-21) + 174080\,a(n-22) - 696320\,a(n-23) - 62720\,a(n-24) + 250880\,a(n-25) + 501760\,a(n-26) - 2007040\,a(n-27) - 1003520\,a(n-28) + 4014080\,a(n-29) + 205824\,a(n-30) - 823296\,a(n-31) - 1646592\,a(n-32) + 6586368\,a(n-33) + 3293184\,a(n-34) - 13172736\,a(n-35) - 360448\,a(n-36) + 1441792\,a(n-37) + 2883584\,a(n-38) - 11534336\,a(n-39) - 5767168\,a(n-40) + 23068672\,a(n-41) + 262144\,a(n-42) - 1048576\,a(n-43) - 2097152\,a(n-44) + 8388608\,a(n-45) + 4194304\,a(n-46) - 16777216\,a(n-47)
\]
for every $n>47$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221663.
