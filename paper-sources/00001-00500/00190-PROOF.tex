...
\title{The empirical recurrence for OEIS A267452, proved from an exact model}
...
\begin{abstract}
OEIS A267452 carries an empirical recurrence of order $8$ contributed by Colin Barker. It is true, and it is
...
OEIS A267452 is ``Total number of ON (black) cells after n iterations of the "Rule 131" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 2, 4, 6, 10, 13, 19, 24,\ \dots
\]
...
First, the model reproduces all $55$ terms the entry publishes, exactly, in integer
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267452.
