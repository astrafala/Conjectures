...
\title{The empirical recurrence for OEIS A288762, proved from an exact model}
...
\begin{abstract}
OEIS A288762 carries an empirical recurrence of order $4$. It is true, and it is
...
OEIS A288762 is ``Decimal representation of the diagonal from the corner to the origin of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 501", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 2, 1, 14, 3, 62, 3, 252,\ \dots
\]
...
vanish from $n=9+1$ onwards, and the run exceeds $S+4$, which by
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A288762.
