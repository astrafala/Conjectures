...
\title{The empirical recurrence for OEIS A290194, proved from an exact model}
...
\begin{abstract}
OEIS A290194 carries an empirical recurrence of order $3$ contributed by David A. Corneth. It is true, and it is
...
OEIS A290194 is ``Decimal representation of the diagonal from the corner to the origin of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 705", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 2, 5, 13, 28, 61, 124, 253,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjecture: a(n) = Fibonacci(2*n+1) if n <= 3, for n > 3, a(n) = 2*a(n-1) + 2 if n is even, a(n) = 2*a(n-1) + 5 if n is odd. It would follow that a(n) = 2\^{}(n+1) - 4 + (n mod 2) for n >= 3. - \_David A. Corneth\_, Jul 23 2017
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 05 2025 15:22:40, revision 16)
...
pre-period to raise the numerator's degree gives a monic annihilator of order $S=9$. The
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A290194.
