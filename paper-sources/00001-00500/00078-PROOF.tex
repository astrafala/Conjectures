...
\title{The empirical recurrence for OEIS A063110, proved from an exact model}
...
\begin{abstract}
OEIS A063110 carries an empirical recurrence of order $2$ contributed by Colin Barker. It is true, and it is
...
OEIS A063110 is ``Dimension of the space of weight 2n cusp forms for Gamma\_0(42).''. It has offset $1$ and begins
\[
5, 20, 36, 52, 68, 84, 100, 116,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjecture: a(n) = 16*n-12 for n>1. a(n) = 2*a(n-1)-a(n-2) for n>3. G.f.: x*(5+10*x+x\^{}2)/(1-x)\^{}2. - \_Colin Barker\_, Sep 23 2012
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 26 2026 10:39:27, revision 22)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A063110.
