...
\title{The empirical recurrence for OEIS A266590, proved from an exact model}
...
\begin{abstract}
OEIS A266590 carries an empirical recurrence of order $6$ contributed by Colin Barker. It is true, and it is
...
OEIS A266590 is ``Decimal representation of the n-th iteration of the "Rule 37" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 2, 14, 65, 56, 1799, 224, 31775,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 02 2016 and Apr 18 2019: (Start) a(n) = 21*a(n-2)-84*a(n-4)+64*a(n-6) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 16 2025 08:33:28, revision 31)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A266590.
