...
\title{The empirical recurrence for OEIS A266460, proved from an exact model}
...
\begin{abstract}
OEIS A266460 carries an empirical recurrence of order $6$ contributed by Colin Barker. It is true, and it is
...
OEIS A266460 is ``Binary representation of the n-th iteration of the "Rule 27" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 101, 10, 1111011, 100, 11111110111, 1000, 111111111101111,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Dec 31 2015 and Apr 16 2019: (Start) a(n) = 10011*a(n-2)-110010*a(n-4)+100000*a(n-6) for n>5.
\end{quote}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A266460.
