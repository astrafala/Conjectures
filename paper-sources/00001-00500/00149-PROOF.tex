...
\title{The empirical recurrence for OEIS A284347, proved from an exact model}
...
\begin{abstract}
OEIS A284347 carries an empirical recurrence of order $9$. It is true, and it is
...
OEIS A284347 is ``Binary representation of the x-axis, from the left edge to the origin, of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 873", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 0, 11, 101, 1010, 11101, 111010, 1011111,\ \dots
\]
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 100000000\,a(n-8) - 100000000\,a(n-9)
\]
for every $n>23$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A284347.
