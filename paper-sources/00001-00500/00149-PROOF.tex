...
\title{The empirical recurrence for OEIS A211445, proved by a one-dimensional reduction}
...
\begin{abstract}
OEIS A211445 counts symmetric $(n+1)\times(n+1)$ matrices over
$\{-7,\dots,7\}$ in which every $2\times2$ subblock sums to zero and has one, two or three distinct
...
on $S=772$ states, and the empirical recurrence of order $27$ contributed by R.~H.~Hardin
follows.
\end{abstract}
...
OEIS A211445 is ``Number of (n+1)X(n+1) -7..7 symmetric matrices with every 2X2 subblock having sum zero and one, two or three distinct values.''. It has offset $1$ and begins
\[
113, 307, 723, 1659, 3681, 8171, 17905, 39605,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 16:10:27, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{The sum-zero condition solved}

Let $x$ be an $N\times N$ symmetric matrix with entries in $\{-7,\dots,7\}$ such that
\[
...
\qquad u_0,\dots,u_{N-1}\in\{-7,\dots,7\}\ \text{all of the same parity},
\]
...
the same parity; and $|x(i,j)|=|u_i+u_j|/2\le7$ for all $i,j$ is equivalent to $|u_i|\le7$
...
$\{-7,\dots,7\}$ with all entries of one parity. What remains is to say, in terms of $u$,
...
the compatibility graph on the $\le 225$ pairs.
\end{corollary}
...
$S=772$. The two parity classes never mix, so the walk starts by choosing a parity and a first
value, and every state may end a sequence:
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad \tau=\mathbf{1},\qquad S=772.
\]
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) + 9\,a(n-2) - 114\,a(n-3) + 38\,a(n-4) + 953\,a(n-5) - 941\,a(n-6) - 4622\,a(n-7) + 6247\,a(n-8) + 14455\,a(n-9) - 23114\,a(n-10) - 30709\,a(n-11) + 54571\,a(n-12) + 45628\,a(n-13) - 86067\,a(n-14) - 48323\,a(n-15) + 91676\,a(n-16) + 37008\,a(n-17) - 65251\,a(n-18) - 20648\,a(n-19) + 30111\,a(n-20) + 8274\,a(n-21) - 8512\,a(n-22) - 2240\,a(n-23) + 1318\,a(n-24) + 356\,a(n-25) - 84\,a(n-26) - 24\,a(n-27)
\]
for every $n>27$.
\end{theorem}
...
symmetric matrices were written out entry by entry over $\{-7,\dots,7\}$ and each
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A211445.
