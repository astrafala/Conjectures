...
\title{The empirical recurrence for OEIS A266872, proved from an exact model}
...
\begin{abstract}
OEIS A266872 carries an empirical recurrence of order $4$ contributed by Colin Barker. It is true, and it is
...
OEIS A266872 is ``Binary representation of the n-th iteration of the "Rule 77" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 10, 10101, 101010, 101010101, 1010101010, 1010101010101, 10101010101010,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 05 2016 and Apr 18 2019: (Start) a(n) = 10001*a(n-2) - 10000*a(n-4) for n>3.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 16 2025 08:33:29, revision 32)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A266872.
