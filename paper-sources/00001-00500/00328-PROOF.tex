...
\title{The empirical recurrence for OEIS A267678, proved from an exact model}
...
\begin{abstract}
OEIS A267678 carries an empirical recurrence of order $4$ contributed by Colin Barker. It is true, and it is
...
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 19 2016: (Start) a(n) = 6*a(n-1)-7*a(n-2)-6*a(n-3)+8*a(n-4) for n>5.
\end{quote}
