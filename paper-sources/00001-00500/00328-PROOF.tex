...
\title{The empirical recurrence for OEIS A187170, proved from an exact model}
...
\begin{abstract}
OEIS A187170 carries an empirical recurrence of order $4$. It is true, and it is
...
OEIS A187170 is ``Number of 9-step self-avoiding walks on an n X n X n cube summed over all starting positions.''. It has offset $1$ and begins
\[
0, 0, 167016, 2013360, 8227752, 21274896, 43422072, 76964016,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 387966*n\^{}3 - 2452704*n\^{}2 + 4766544*n - 2833872 for n>7. a(n) = 4*a(n-1) - 6*a(n-2) + 4*a(n-3) - a(n-4) for n>11.
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 05 2022 22:12:08, revision 14)
...
SHAPE when one is a translate of the other. There are exactly $387966$ shapes: self-avoiding
sequences of $9$ distinct cells in $\mathbf{Z}^{3}$ with each consecutive difference in
...
Write $w^\ast$ for the largest bounding-box side over all $387966$ shapes. Once $n\ge w^\ast$
...
$z^{9}(z-1)^{4}$, monic of order $S=13$. Both numbers are read off the enumerated
...
vanish from $n=11+1$ onwards, and the run exceeds $S+4$, which by
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A187170.
