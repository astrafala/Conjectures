...
\title{The empirical recurrence for OEIS A266609, proved from an exact model}
...
\begin{abstract}
OEIS A266609 carries an empirical recurrence of order $6$ contributed by Karl V. Keller, Jr.. It is true, and it is
...
OEIS A266609 is ``Binary representation of the n-th iteration of the "Rule 41" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 0, 101, 1100100, 1, 11111111000, 101, 111111111100100,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 16 2025 08:33:28, revision 29)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A266609.
