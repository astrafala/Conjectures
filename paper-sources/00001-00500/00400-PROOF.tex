...
\begin{abstract}
OEIS A266222 carries an empirical recurrence of order $4$ contributed by Colin Barker. It is true, and it is
...
\begin{quote}
Conjectures from \_Colin Barker\_, Dec 26 2015 and Apr 13 2019: (Start) a(n) = 2*a(n-2) - a(n-4) for n>5.
\end{quote}
