...
\title{The empirical recurrence for OEIS A311344, proved from an exact model}
...
\begin{abstract}
OEIS A311344 carries an empirical recurrence of order $10$ contributed by Chai Wah Wu. It is true, and it is
...
OEIS A311344 is ``Coordination sequence Gal.5.95.1 where Gal.u.t.v denotes the coordination sequence for a vertex of type v in tiling number t in the Galebach list of u-uniform tilings.''. It has offset $0$ and begins
\[
1, 4, 8, 12, 16, 22, 26, 30,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Chai Wah Wu\_, Apr 15 2025: (Start) a(n) = a(n-1) + a(n-9) - a(n-10) for n > 10.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 16 2025 07:31:12, revision 7)
...
the same direction set.) The vertices fall into $9$ orbits under $L$, and a vertex is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A311344.
