...
\title{The empirical recurrence for OEIS A063165, proved by transfer matrix}
...
\begin{abstract}
OEIS A063165 carries an empirical recurrence of order $5$ contributed by R.~H.~Hardin. It is
...
OEIS A063165 is ``Dimension of the space of weight 2n cusp forms for Gamma\_0( 97 ).''. It has offset $1$ and begins
\[
7, 24, 40, 56, 72, 90, 104, 122,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjecture: a(n) = a(n-2)+a(n-3)-a(n-5) for n>6. x*(7 +24*x +33*x\^{}2 +25*x\^{}3 +8*x\^{}4 +x\^{}5)/((1 -x)\^{}2*(1 +x)*(1 +x +x\^{}2)). [\_Colin Barker\_, Sep 27 2012]
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 22 2019 12:18:12, revision 9) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A063165.
