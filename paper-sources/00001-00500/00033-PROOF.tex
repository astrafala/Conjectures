...
\title{The empirical recurrence for OEIS A310704, proved from an exact model}
...
\begin{abstract}
OEIS A310704 carries an empirical recurrence of order $7$ contributed by Chai Wah Wu. It is true, and it is
...
which $a$ provably satisfies a MONIC linear recurrence of order $S=40$, derived below and not
...
OEIS A310704 is ``Coordination sequence Gal.3.2.2 where Gal.u.t.v denotes the coordination sequence for a vertex of type v in tiling number t in the Galebach list of u-uniform tilings.''. It has offset $0$ and begins
\[
1, 4, 7, 10, 15, 19, 21, 24,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Chai Wah Wu\_, Dec 24 2019: (Start) a(n) = a(n-1) - a(n-2) + a(n-3) + a(n-4) - a(n-5) + a(n-6) - a(n-7) for n > 7.
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 21 2023 15:10:34, revision 6)
...
the same direction set.) The vertices fall into $5$ orbits under $L$, and a vertex is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A310704.
