...
\title{The empirical recurrence for OEIS A063165, proved from an exact model}
...
\begin{abstract}
OEIS A063165 carries an empirical recurrence of order $5$ contributed by Colin Barker. It is true, and it is
