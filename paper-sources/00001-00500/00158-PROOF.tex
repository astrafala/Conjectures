...
\title{The empirical recurrence for OEIS A267159, proved from an exact model}
...
\begin{abstract}
OEIS A267159 carries an empirical recurrence of order $7$ contributed by Colin Barker. It is true, and it is
...
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 11 2016 and Apr 19 2019: (Start) a(n) = a(n-1)+a(n-2)-a(n-3)+a(n-4)-a(n-5)-a(n-6)+a(n-7) for n>12.
\end{quote}
