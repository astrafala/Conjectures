...
\title{The empirical recurrence for OEIS A211255, proved by a one-dimensional reduction}
...
\begin{abstract}
OEIS A211255 counts symmetric $(n+1)\times(n+1)$ matrices over
$\{-6,\dots,6\}$ in which every $2\times2$ subblock sums to zero and has one or three distinct
...
on $S=229$ states, and the empirical recurrence of order $14$ contributed by R.~H.~Hardin
follows.
\end{abstract}
...
OEIS A211255 is ``Number of (n+1)X(n+1) -6..6 symmetric matrices with every 2X2 subblock having sum zero and one or three distinct values.''. It has offset $1$ and begins
\[
65, 143, 287, 567, 1109, 2145, 4163, 8041,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 16:08:49, revision 8) this is still
...
$S=229$. The two parity classes never mix, so the walk starts by choosing a parity and a first
value, and every state may end a sequence:
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad \tau=\mathbf{1},\qquad S=229.
\]
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + 5\,a(n-2) - 36\,a(n-3) + 5\,a(n-4) + 123\,a(n-5) - 69\,a(n-6) - 205\,a(n-7) + 150\,a(n-8) + 176\,a(n-9) - 138\,a(n-10) - 74\,a(n-11) + 56\,a(n-12) + 12\,a(n-13) - 8\,a(n-14)
\]
for every $n>14$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A211255.
