...
\title{The empirical recurrence for OEIS A267138, proved from an exact model}
...
\begin{abstract}
OEIS A267138 carries an empirical recurrence of order $6$. It is true, and it is
...
OEIS A267138 is ``Binary representation of the n-th iteration of the "Rule 103" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 110, 110, 1110101, 111100, 11110001011, 101111000, 111111100010111,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
(the empirical recurrence quoted in the entry)
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 16 2025 08:33:29, revision 34)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267138.
