...
\title{The empirical recurrence for OEIS A267041, proved from an exact model}
...
\begin{abstract}
OEIS A267041 carries an empirical recurrence of order $6$ contributed by Colin Barker. It is true, and it is
...
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 10 2016: (Start) a(n) = 10101*a(n-2)-1010100*a(n-4)+1000000*a(n-6) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 16 2025 08:33:29, revision 29)
...
vanish from $n=8+1$ onwards, and the run exceeds $S+6$, which by
