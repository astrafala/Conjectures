...
\title{The empirical recurrence for OEIS A290527, proved from an exact model}
...
\begin{abstract}
OEIS A290527 carries an empirical recurrence of order $5$. It is true, and it is
...
OEIS A290527 is ``Decimal representation of the diagonal from the corner to the origin of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 833", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 2, 5, 15, 24, 63, 112, 255,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
(the empirical recurrence quoted in the entry)
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 05 2025 15:22:40, revision 13)
...
pre-period to raise the numerator's degree gives a monic annihilator of order $S=11$. The
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A290527.
