...
\title{The empirical recurrence for OEIS A211336, proved by a one-dimensional reduction}
...
\begin{abstract}
OEIS A211336 counts symmetric $(n+1)\times(n+1)$ matrices over
$\{-5,\dots,5\}$ in which every $2\times2$ subblock sums to zero and has two, three or four distinct
...
on $S=208$ states, and the empirical recurrence of order $12$ contributed by R.~H.~Hardin
follows.
\end{abstract}
...
OEIS A211336 is ``Number of (n+1)X(n+1) -5..5 symmetric matrices with every 2X2 subblock having sum zero and two, three or four distinct values.''. It has offset $1$ and begins
\[
60, 332, 1846, 10332, 58164, 329130, 1870664, 10670876,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 16:10:05, revision 8) this is still
...
$S=208$. The two parity classes never mix, so the walk starts by choosing a parity and a first
value, and every state may end a sequence:
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad \tau=\mathbf{1},\qquad S=208.
\]
...
\begin{theorem}
\[
a(n)\;=\;32\,a(n-1) - 429\,a(n-2) + 3078\,a(n-3) - 12340\,a(n-4) + 24890\,a(n-5) - 10895\,a(n-6) - 35870\,a(n-7) + 19131\,a(n-8) + 40338\,a(n-9) + 18694\,a(n-10) + 3532\,a(n-11) + 240\,a(n-12)
\]
for every $n>11$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A211336.
