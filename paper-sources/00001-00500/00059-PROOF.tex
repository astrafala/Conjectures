...
\title{The empirical recurrence for OEIS A063133, proved from an exact model}
...
\begin{abstract}
OEIS A063133 carries an empirical recurrence of order $3$ contributed by Colin Barker. It is true, and it is
...
OEIS A063133 is ``Dimension of the space of weight 2n cusp forms for Gamma\_0( 65 ).''. It has offset $1$ and begins
\[
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 22 2019 12:18:12, revision 10)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A063133.
