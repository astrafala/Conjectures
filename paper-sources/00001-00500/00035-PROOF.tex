...
\title{The empirical recurrence for OEIS A312722, proved from an exact model}
...
\begin{abstract}
OEIS A312722 carries an empirical recurrence of order $10$ contributed by Chai Wah Wu. It is true, and it is
...
OEIS A312722 is ``Coordination sequence Gal.5.146.3 where Gal.u.t.v denotes the coordination sequence for a vertex of type v in tiling number t in the Galebach list of u-uniform tilings.''. It has offset $0$ and begins
\[
1, 4, 8, 15, 18, 24, 26, 31,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Chai Wah Wu\_, Jun 06 2024: (Start) a(n) = 2*a(n-5) - a(n-10) for n > 10.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 07 2024 02:04:50, revision 7)
...
the same direction set.) The vertices fall into $19$ orbits under $L$, and a vertex is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A312722.
