...
\title{The empirical recurrence for OEIS A259661, proved from an exact model}
...
\begin{abstract}
OEIS A259661 carries an empirical recurrence of order $4$ contributed by Colin Barker. It is true, and it is
...
OEIS A259661 is ``Binary representation of the middle column of the "Rule 54" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 11, 110, 1100, 11001, 110011, 1100110, 11001100,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Dec 08 2015 and Apr 17 2019: (Start) a(n) = 11*a(n-1) - 11*a(n-2) + 11*a(n-3) - 10*a(n-4) for n>3.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 16 2025 08:33:26, revision 55)
...
For this entry the column is periodic with period $q=4$ from $n=0$: the period above is a
...
\begin{theorem}
\[
a(n)\;=\;11\,a(n-1) - 11\,a(n-2) + 11\,a(n-3) - 10\,a(n-4)
\]
for every $n>0$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A259661.
