...
\title{The empirical recurrence for OEIS A267359, proved from an exact model}
...
\begin{abstract}
OEIS A267359 carries an empirical recurrence of order $4$ contributed by Colin Barker. It is true, and it is
...
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 14 2016 and Apr 19 2019: (Start) a(n) = 10001*a(n-2) - 10000*a(n-4) for n > 8.
\end{quote}
