...
\title{The empirical recurrence for OEIS A285612, proved by transfer matrix}
...
\begin{abstract}
OEIS A285612 carries an empirical recurrence of order $3$ contributed by R.~H.~Hardin. It is
...
OEIS A285612 is ``Binary representation of the diagonal from the corner to the origin of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 62", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 1, 10, 10, 110, 110, 1110, 1110,\ \dots
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A285612.
