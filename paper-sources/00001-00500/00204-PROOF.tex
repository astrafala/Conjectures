...
\title{The empirical recurrence for OEIS A282004, proved from an exact model}
...
\begin{abstract}
OEIS A282004 carries an empirical recurrence of order $4$. It is true, and it is
...
OEIS A282004 is ``Decimal representation of the x-axis, from the left edge to the origin, of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 413", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 2, 3, 14, 3, 62, 3, 254,\ \dots
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A282004.
