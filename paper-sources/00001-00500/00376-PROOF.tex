...
\title{The empirical recurrence for OEIS A266256, proved from an exact model}
...
\begin{abstract}
OEIS A266256 carries an empirical recurrence of order $4$ contributed by Colin Barker. It is true, and it is
...
OEIS A266256 is ``Number of ON (black) cells in the n-th iteration of the "Rule 11" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 1, 2, 5, 2, 9, 2, 13,\ \dots
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A266256.
