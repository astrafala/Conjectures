...
\title{The empirical recurrence for OEIS A211473, proved by a one-dimensional reduction}
...
\begin{abstract}
OEIS A211473 counts symmetric $(n+1)\times(n+1)$ matrices over
$\{-8,\dots,8\}$ in which every $2\times2$ subblock sums to zero and has two, three or four distinct
...
on $S=1378$ states, and the empirical recurrence of order $18$ contributed by R.~H.~Hardin
follows.
\end{abstract}
...
OEIS A211473 is ``Number of (n+1)X(n+1) -8..8 symmetric matrices with every 2X2 subblock having sum zero and two, three or four distinct values.''. It has offset $1$ and begins
\[
144, 1224, 10416, 88776, 757784, 6478064, 55460120, 475479800,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 16:11:58, revision 8) this is still
...
$S=1378$. The two parity classes never mix, so the walk starts by choosing a parity and a first
value, and every state may end a sequence:
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad \tau=\mathbf{1},\qquad S=1378.
\]
...
\begin{theorem}
\[
a(n)\;=\;75\,a(n-1) - 2510\,a(n-2) + 49200\,a(n-3) - 622175\,a(n-4) + 5253075\,a(n-5) - 29416155\,a(n-6) + 102987225\,a(n-7) - 184111448\,a(n-8) - 476940\,a(n-9) + 472118829\,a(n-10) - 56520825\,a(n-11) - 794496080\,a(n-12) - 750911850\,a(n-13) - 339742508\,a(n-14) - 86830200\,a(n-15) - 12751696\,a(n-16) - 999360\,a(n-17) - 32256\,a(n-18)
\]
for every $n>17$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A211473.
