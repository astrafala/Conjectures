...
\title{The empirical recurrence for OEIS A267680, proved from an exact model}
...
\begin{abstract}
OEIS A267680 carries an empirical recurrence of order $4$ contributed by Colin Barker. It is true, and it is
...
OEIS A267680 is ``Binary representation of the n-th iteration of the "Rule 201" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 0, 10101, 1100011, 111010111, 11110001111, 1111101011111, 111111000111111,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 19 2016 and Apr 20 2019: (Start) a(n) = 101*a(n-1)-10100*a(n-3)+10000*a(n-4) for n>4.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 16 2025 08:33:29, revision 21)
...
pre-period to raise the numerator's degree gives a monic annihilator of order $S=5$. The
...
\begin{theorem}
\[
a(n)\;=\;101\,a(n-1) - 10100\,a(n-3) + 10000\,a(n-4)
\]
for every $n>4$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267680.
