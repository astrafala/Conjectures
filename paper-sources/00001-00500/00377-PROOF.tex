...
\title{The empirical recurrence for OEIS A267873, proved from an exact model}
...
\begin{abstract}
OEIS A267873 carries an empirical recurrence of order $2$. It is true, and it is
...
OEIS A267873 is ``Number of ON (black) cells in the n-th iteration of the "Rule 235" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 1, 4, 7, 9, 11, 13, 15,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
(the empirical recurrence quoted in the entry)
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 16 2025 08:33:30, revision 16)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267873.
