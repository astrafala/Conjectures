...
\title{The empirical recurrence for OEIS A211553, proved by a one-dimensional reduction}
...
\begin{abstract}
OEIS A211553 counts symmetric $(n+1)\times(n+1)$ matrices over
$\{-9,\dots,9\}$ in which every $2\times2$ subblock sums to zero and has one, two or three distinct
...
on $S=1496$ states, and the empirical recurrence of order $37$ contributed by R.~H.~Hardin
follows.
\end{abstract}
...
OEIS A211553 is ``Number of (n+1)X(n+1) -9..9 symmetric matrices with every 2X2 subblock having sum zero and one, two or three distinct values.''. It has offset $1$ and begins
\[
181, 521, 1239, 2865, 6321, 14009, 30379, 66865,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 16:13:20, revision 8) this is still
...
$S=1496$. The two parity classes never mix, so the walk starts by choosing a parity and a first
value, and every state may end a sequence:
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad \tau=\mathbf{1},\qquad S=1496.
\]
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-1) + 14\,a(n-2) - 200\,a(n-3) + 78\,a(n-4) + 2555\,a(n-5) - 3384\,a(n-6) - 19202\,a(n-7) + 37730\,a(n-8) + 93668\,a(n-9) - 243670\,a(n-10) - 306260\,a(n-11) + 1060307\,a(n-12) + 654137\,a(n-13) - 3306120\,a(n-14) - 762798\,a(n-15) + 7617393\,a(n-16) - 164785\,a(n-17) - 13171236\,a(n-18) + 2551794\,a(n-19) + 17194836\,a(n-20) - 5381852\,a(n-21) - 16929450\,a(n-22) + 6682460\,a(n-23) + 12476338\,a(n-24) - 5590892\,a(n-25) - 6783218\,a(n-26) + 3249146\,a(n-27) + 2657689\,a(n-28) - 1305530\,a(n-29) - 723096\,a(n-30) + 352500\,a(n-31) + 128470\,a(n-32) - 60348\,a(n-33) - 13280\,a(n-34) + 5840\,a(n-35) + 600\,a(n-36) - 240\,a(n-37)
\]
for every $n>37$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A211553.
