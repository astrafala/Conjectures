...
\title{The empirical recurrence for OEIS A188152, proved from an exact model}
...
\begin{abstract}
OEIS A188152 carries an empirical recurrence of order $3$. It is true, and it is
...
OEIS A188152 is ``Number of 7-step self-avoiding walks on an n X n square summed over all starting positions.''. It has offset $1$ and begins
\[
0, 0, 112, 1248, 4152, 8752, 14932, 22672,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 780*n\^{}2 - 3960*n + 4432 for n>5. a(n) = 3*a(n-1) - 3*a(n-2) + a(n-3) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 27 2018 09:22:39, revision 14)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A188152.
