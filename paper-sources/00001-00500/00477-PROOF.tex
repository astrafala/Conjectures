...
\title{The empirical recurrence for OEIS A187383, proved from an exact model}
...
\begin{abstract}
OEIS A187383 carries an empirical recurrence of order $3$. It is true, and it is
...
OEIS A187383 is ``Number of 9-step S, NW and NE-moving king's tours on an n X n board summed over all starting positions.''. It has offset $1$ and begins
\[
0, 0, 0, 340, 3060, 10320, 24892, 46412,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3385*n\^{}2 - 28390*n + 56892 for n>7. a(n) = 3*a(n-1) - 3*a(n-2) + a(n-3) for n>10.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 24 2018 08:07:34, revision 10)
...
SHAPE when one is a translate of the other. There are exactly $3385$ shapes: self-avoiding
...
Write $w^\ast$ for the largest bounding-box side over all $3385$ shapes. Once $n\ge w^\ast$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A187383.
