...
\title{The empirical recurrence for OEIS A264334, proved by transfer matrix}
...
\begin{abstract}
OEIS A264334 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=7$ rows in which
...
OEIS A264334 is ``Number of (n+1)X(6+1) arrays of permutations of 0..n*7+6 with each element having directed index change -1,1 1,0 1,-1 or 0,-1.''. It has offset $1$ and begins
\[
3, 32, 464, 8976, 144289, 2464988, 40119900, 640302232,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 11 2015 13:16:22, revision 4) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264334.
