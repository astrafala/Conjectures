...
\title{The empirical recurrence for OEIS A265723, proved from an exact model}
...
\begin{abstract}
OEIS A265723 carries an empirical recurrence of order $4$ contributed by Colin Barker. It is true, and it is
...
OEIS A265723 is ``Number of OFF (white) cells in the n-th iteration of the "Rule 1" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
0, 3, 4, 3, 8, 3, 12, 3,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Dec 15 2015 and Apr 16 2019: (Start) a(n) = 2*a(n-2) - a(n-4) for n>3.
\end{quote}
...
For this entry the automaton is rule 1, the period is $p=2$ and the pre-period is $n_0=0$.
The certificate is
\begin{gather*}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A265723.
