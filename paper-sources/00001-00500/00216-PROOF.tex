...
\title{The empirical recurrence for OEIS A283402, proved from an exact model}
...
\begin{abstract}
OEIS A283402 carries an empirical recurrence of order $3$. It is true, and it is
...
OEIS A283402 is ``Decimal representation of the x-axis, from the left edge to the origin, of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 633", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 0, 3, 1, 14, 6, 62, 28,\ \dots
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A283402.
