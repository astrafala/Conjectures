...
\title{The empirical recurrence for OEIS A267353, proved from an exact model}
...
\begin{abstract}
OEIS A267353 carries an empirical recurrence of order $5$ contributed by Colin Barker. It is true, and it is
...
OEIS A267353 is ``Total number of ON (black) cells after n iterations of the "Rule 123" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 3, 6, 12, 15, 25, 28, 42,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 14 2016: (Start) a(n) = a(n-1)+2*a(n-2)-2*a(n-3)-a(n-4)+a(n-5) for n>4.
\end{quote}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267353.
