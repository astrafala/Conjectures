...
\title{The empirical recurrence for OEIS A266724, proved from an exact model}
...
\begin{abstract}
OEIS A266724 carries an empirical recurrence of order $4$ contributed by Colin Barker. It is true, and it is
...
OEIS A266724 is ``Number of OFF (white) cells in the n-th iteration of the "Rule 59" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
0, 1, 3, 1, 7, 1, 11, 1,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 05 2016 and Apr 18 2019: (Start) a(n) = 2*a(n-2)-a(n-4) for n>4.
\end{quote}
...
For this entry the automaton is rule 59, the period is $p=2$ and the pre-period is $n_0=1$.
The certificate is
\begin{gather*}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A266724.
