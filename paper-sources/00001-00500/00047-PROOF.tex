...
\title{The empirical recurrence for OEIS A063109, proved from an exact model}
...
\begin{abstract}
OEIS A063109 carries an empirical recurrence of order $3$ contributed by Colin Barker. It is true, and it is
...
OEIS A063109 is ``Dimension of the space of weight 2n cusp forms for Gamma\_0( 41 ).''. It has offset $1$ and begins
\[
3, 10, 16, 24, 30, 38, 44, 52,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Jun 09 2019: (Start) a(n) = a(n-1) + a(n-2) - a(n-3) for n>4.
\end{quote}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A063109.
