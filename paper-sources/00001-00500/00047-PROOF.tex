...
\title{The empirical recurrence for OEIS A310518, proved from an exact model}
...
\begin{abstract}
OEIS A310518 carries an empirical recurrence of order $6$ contributed by Chai Wah Wu. It is true, and it is
...
OEIS A310518 is ``Coordination sequence Gal.3.21.1 where Gal.u.t.v denotes the coordination sequence for a vertex of type v in tiling number t in the Galebach list of u-uniform tilings.''. It has offset $0$ and begins
\[
1, 4, 10, 16, 22, 26, 30, 36,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Chai Wah Wu\_, Jan 24 2020: (Start) a(n) = a(n-1) + a(n-5) - a(n-6) for n > 6.
\end{quote}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A310518.
