...
\title{The empirical recurrence for OEIS A286770, proved by transfer matrix}
...
\begin{abstract}
OEIS A286770 carries an empirical recurrence of order $4$ contributed by R.~H.~Hardin. It is
...
OEIS A286770 is ``Binary representation of the diagonal from the corner to the origin of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 221", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 10, 0, 1110, 1, 111110, 1, 11111110,\ \dots
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A286770.
