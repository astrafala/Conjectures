...
\begin{abstract}
OEIS A266609 carries an empirical recurrence of order $6$ contributed by Colin Barker. It is true, and it is
...
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 02 2016 and Apr 18 2019: (Start) a(n) = 10000*a(n-2)+a(n-4)-10000*a(n-6) for n>5.
\end{quote}
