...
\title{The empirical recurrence for OEIS A211260, proved by a one-dimensional reduction}
...
\begin{abstract}
OEIS A211260 counts symmetric $(n+1)\times(n+1)$ matrices over
$\{-6,\dots,6\}$ in which every $2\times2$ subblock sums to zero and has two, three or four distinct
...
on $S=352$ states, and the empirical recurrence of order $14$ contributed by R.~H.~Hardin
follows.
\end{abstract}
...
OEIS A211260 is ``Number of (n+1)X(n+1) -6..6 symmetric matrices with every 2X2 subblock having sum zero and two, three or four distinct values.''. It has offset $1$ and begins
\[
84, 546, 3552, 23154, 151218, 989484, 6486618, 42598386,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 16:09:28, revision 8) this is still
...
$S=352$. The two parity classes never mix, so the walk starts by choosing a parity and a first
value, and every state may end a sequence:
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad \tau=\mathbf{1},\qquad S=352.
\]
...
\begin{theorem}
\[
a(n)\;=\;44\,a(n-1) - 834\,a(n-2) + 8822\,a(n-3) - 56045\,a(n-4) + 210804\,a(n-5) - 405935\,a(n-6) + 122980\,a(n-7) + 727296\,a(n-8) - 286484\,a(n-9) - 957331\,a(n-10) - 589182\,a(n-11) - 162870\,a(n-12) - 21384\,a(n-13) - 1080\,a(n-14)
\]
for every $n>13$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A211260.
