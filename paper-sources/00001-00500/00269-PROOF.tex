...
\title{The empirical recurrence for OEIS A282915, proved from an exact model}
...
\begin{abstract}
OEIS A282915 carries an empirical recurrence of order $6$ contributed by Colin Barker. It is true, and it is
...
OEIS A282915 is ``Binary representation of the x-axis, from the left edge to the origin, of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 529", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 0, 1, 0, 111, 1, 11100, 1,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Feb 25 2017: (Start) a(n) = a(n-2) + 10000*a(n-4) - 10000*a(n-6) for n>6.
\end{quote}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A282915.
