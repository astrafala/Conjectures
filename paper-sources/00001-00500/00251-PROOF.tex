...
\title{The empirical recurrence for OEIS A266665, proved from an exact model}
...
\begin{abstract}
OEIS A266665 carries an empirical recurrence of order $5$. It is true, and it is
...
OEIS A266665 is ``Total number of OFF (white) cells after n iterations of the "Rule 47" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
0, 1, 4, 6, 13, 15, 26, 28,\ \dots
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A266665.
