...
\title{The empirical recurrence for OEIS A281735, proved from an exact model}
...
\begin{abstract}
OEIS A281735 carries an empirical recurrence of order $2$. It is true, and it is
...
OEIS A281735 is ``Binary representation of the x-axis, from the left edge to the origin, of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 390", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 11, 100, 1110, 10001, 111001, 1000001, 11100011,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
(the empirical recurrence quoted in the entry)
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 05 2025 15:22:36, revision 16)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A281735.
