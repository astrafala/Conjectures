...
\title{The empirical recurrence for OEIS A284243, proved from an exact model}
...
\begin{abstract}
OEIS A284243 carries an empirical recurrence of order $6$ contributed by Chai Wah Wu. It is true, and it is
...
\[
1, 0, 11, 111, 1111, 11101, 111010, 1111101,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Chai Wah Wu\_, May 06 2024: (Start) a(n) = a(n-2) + 10000*a(n-4) - 10000*a(n-6) for n > 16.
\end{quote}
