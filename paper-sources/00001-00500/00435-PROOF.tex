...
\title{The empirical recurrence for OEIS A290828, proved from an exact model}
...
\begin{abstract}
OEIS A290828 carries an empirical recurrence of order $3$ contributed by Colin Barker. It is true, and it is
...
OEIS A290828 is ``Decimal representation of the diagonal from the corner to the origin of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 961", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 2, 5, 15, 28, 63, 124, 255,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Aug 12 2017: (Start) a(n) = 2*a(n-1) + a(n-2) - 2*a(n-3) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 05 2025 15:22:40, revision 12)
...
\[
C(n+2)\;=\;C(n)\qquad\text{as configurations of the whole plane, for every } n\ge 3.
\]
...
neighbourhood to a live cell flips the ENTIRE plane, and rule 961 is read
...
pre-period to raise the numerator's degree gives a monic annihilator of order $S=9$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A290828.
