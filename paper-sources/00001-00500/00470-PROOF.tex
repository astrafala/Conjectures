...
\title{The empirical recurrence for OEIS A187299, proved from an exact model}
...
\begin{abstract}
OEIS A187299 carries an empirical recurrence of order $3$. It is true, and it is
...
OEIS A187299 is ``Number of 4-step one space leftwards or up, two space rightwards or down asymmetric rook's tours on an n X n board summed over all starting positions.''. It has offset $1$ and begins
\[
0, 0, 54, 196, 480, 876, 1398, 2036,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 58*n\^{}2 - 232*n + 180 for n>5. a(n) = 3*a(n-1) - 3*a(n-2) + a(n-3) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 23 2018 08:34:12, revision 11)
...
SHAPE when one is a translate of the other. There are exactly $58$ shapes: self-avoiding
...
Write $w^\ast$ for the largest bounding-box side over all $58$ shapes. Once $n\ge w^\ast$
...
First, the model reproduces all $40$ terms the entry publishes, exactly, in integer
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A187299.
