...
\title{The empirical recurrence for OEIS A063130, proved from an exact model}
...
\begin{abstract}
OEIS A063130 carries an empirical recurrence of order $2$ contributed by Colin Barker. It is true, and it is
...
OEIS A063130 is ``Dimension of the space of weight 2n cusp forms for Gamma\_0( 62 ).''. It has offset $1$ and begins
\[
7, 22, 38, 54, 70, 86, 102, 118,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Jun 13 2016: (Start) a(n) = 2*a(n-1)-a(n-2) for n>3.
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 03 2025 13:12:56, revision 17)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A063130.
