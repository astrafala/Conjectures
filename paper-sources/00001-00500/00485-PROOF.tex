...
\title{The empirical recurrence for OEIS A187050, proved from an exact model}
...
\begin{abstract}
OEIS A187050 carries an empirical recurrence of order $3$. It is true, and it is
...
OEIS A187050 is ``Number of 6-step one or two space at a time bishop's tours on an n X n board summed over all starting positions.''. It has offset $1$ and begins
\[
0, 0, 0, 584, 6952, 29500, 79088, 162320,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 16752*n\^{}2 - 163720*n + 397436 for n>9. a(n) = 3*a(n-1) - 3*a(n-2) + a(n-3) for n>12.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 20 2018 10:05:16, revision 11)
...
SHAPE when one is a translate of the other. There are exactly $16752$ shapes: self-avoiding
...
Write $w^\ast$ for the largest bounding-box side over all $16752$ shapes. Once $n\ge w^\ast$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A187050.
