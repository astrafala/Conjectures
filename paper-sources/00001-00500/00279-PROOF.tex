...
\title{The empirical recurrence for OEIS A267937, proved from an exact model}
...
\begin{abstract}
OEIS A267937 carries an empirical recurrence of order $2$. It is true, and it is
...
OEIS A267937 is ``Binary representation of the n-th iteration of the "Rule 251" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 101, 11111, 1111111, 111111111, 11111111111, 1111111111111, 111111111111111,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
(the empirical recurrence quoted in the entry)
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 24 2025 12:15:28, revision 18)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267937.
