...
\title{The empirical recurrence for OEIS A267454, proved from an exact model}
...
\begin{abstract}
OEIS A267454 carries an empirical recurrence of order $8$ contributed by Colin Barker. It is true, and it is
...
OEIS A267454 is ``Total number of OFF (white) cells after n iterations of the "Rule 131" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
0, 2, 5, 10, 15, 23, 30, 40,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 15 2016 and Apr 19 2019: (Start) a(n) = a(n-1)+a(n-3)-a(n-5)-a(n-7)+a(n-8) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 16 2025 08:33:29, revision 14)
...
For this entry the automaton is rule 131, the period is $p=12$ and the pre-period is $n_0=1$.
The certificate is
\begin{gather*}
r=0:\quad \texttt{100100100100}^{\,j} \cdot \texttt{1} \cdot \texttt{001010011100}^{\,j} \cdot \texttt{00} \\
r=1:\quad \texttt{100100100100}^{\,j} \cdot \texttt{100} \cdot \texttt{100001010011}^{\,j} \cdot \texttt{10} \\
r=2:\quad \texttt{100100100100}^{\,j} \cdot \texttt{10} \cdot \texttt{010011100001}^{\,j} \cdot \texttt{01000} \\
r=3:\quad \texttt{100100100100}^{\,j} \cdot \texttt{1001} \cdot \texttt{001010011100}^{\,j} \cdot \texttt{00110}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267454.
