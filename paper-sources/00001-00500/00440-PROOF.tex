...
\title{The empirical recurrence for OEIS A281248, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A281248 imposes three things at once: a condition on each cell that reaches one row up and
...
numbers. The empirical recurrence of order $35$ contributed by R.~H.~Hardin then follows
...
OEIS A281248 is ``Number of nX3 0..2 arrays with no element equal to more than one of its horizontal, vertical and antidiagonal neighbors, with the exception of exactly two elements, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
0, 12, 443, 8489, 105368, 1113148, 10598099, 94350141,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 18 2017 08:43:24, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;14\,a(n-1) - 37\,a(n-2) - 137\,a(n-3) + 133\,a(n-4) + 1003\,a(n-5) + 3804\,a(n-6) + 5187\,a(n-7) - 2352\,a(n-8) - 9604\,a(n-9) - 8788\,a(n-10) + 20660\,a(n-11) + 73716\,a(n-12) + 13836\,a(n-13) - 107898\,a(n-14) - 90512\,a(n-15) + 29977\,a(n-16) + 283636\,a(n-17) + 190689\,a(n-18) - 510519\,a(n-19) - 322065\,a(n-20) + 553505\,a(n-21) + 160238\,a(n-22) - 387019\,a(n-23) + 48576\,a(n-24) + 108354\,a(n-25) - 163512\,a(n-26) - 22652\,a(n-27) + 75376\,a(n-28) + 6952\,a(n-29) + 12160\,a(n-30) + 24352\,a(n-31) + 7936\,a(n-32) + 2432\,a(n-33) + 2048\,a(n-34) + 512\,a(n-35)
\end{equation}
for all $n>45$.
...
$h_j=G^{j}N^{o}\mathbf{u}$, we have for $j\ge35$
\[
3!\Bigl(a(n_0+j)-\sum_i c_i\,a(n_0+j-i)\Bigr)=\mathbf{v}^{\!\top}G^{\,j-35}w,
\qquad w=h_{35}-\sum_i c_i h_{35-i} .
\]
...
$35$ applications of $G$ in exact integer arithmetic and $\mathbf{v}^{\!\top}G^{m}w$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A281248.
