...
\title{The empirical recurrence for OEIS A284181, proved from an exact model}
...
\begin{abstract}
OEIS A284181 carries an empirical recurrence of order $5$ contributed by Colin Barker. It is true, and it is
...
OEIS A284181 is ``Decimal representation of the x-axis, from the left edge to the origin, of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 813", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 2, 5, 10, 23, 47, 87, 171,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Mar 22 2017: (Start) a(n) = a(n-1) + 16*a(n-4) - 16*a(n-5) for n>10.
\end{quote}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A284181.
