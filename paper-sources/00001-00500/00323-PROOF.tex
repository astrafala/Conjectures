...
\title{The empirical recurrence for OEIS A266257, proved from an exact model}
...
\begin{abstract}
OEIS A266257 carries an empirical recurrence of order $5$ contributed by Colin Barker. It is true, and it is
...
OEIS A266257 is ``Total number of ON (black) cells after n iterations of the "Rule 11" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 2, 4, 9, 11, 20, 22, 35,\ \dots
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A266257.
