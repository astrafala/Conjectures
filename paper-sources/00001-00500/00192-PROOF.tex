...
\title{The empirical recurrence for OEIS A285645, proved from an exact model}
...
\begin{abstract}
OEIS A285645 carries an empirical recurrence of order $4$. It is true, and it is
...
OEIS A285645 is ``Decimal representation of the diagonal from the corner to the origin of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 65", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 2, 1, 12, 1, 60, 3, 252,\ \dots
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A285645.
