...
\title{The empirical recurrence for OEIS A289404, proved by transfer matrix}
...
\begin{abstract}
OEIS A289404 carries an empirical recurrence of order $3$ contributed by R.~H.~Hardin. It is
...
OEIS A289404 is ``Binary representation of the diagonal from the corner to the origin of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 566", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 1, 11, 11, 111, 111, 1111, 1111,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
(the empirical recurrence quoted in the entry)
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 05 2025 15:22:40, revision 32) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A289404.
