...
\title{The empirical recurrence for OEIS A267350, proved from an exact model}
...
\begin{abstract}
OEIS A267350 carries an empirical recurrence of order $6$ contributed by Colin Barker. It is true, and it is
...
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 14 2016: (Start) a(n) = 10101*a(n-2) - 1010100*a(n-4) + 1000000*a(n-6) for n > 6.
\end{quote}
