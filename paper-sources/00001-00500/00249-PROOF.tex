...
\title{The empirical recurrence for OEIS A266616, proved from an exact model}
...
\begin{abstract}
OEIS A266616 carries an empirical recurrence of order $6$ contributed by Colin Barker. It is true, and it is
...
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 02 2016 and Apr 18 2019: (Start) a(n) = a(n-2)+a(n-4)-a(n-6) for n>5.
\end{quote}
