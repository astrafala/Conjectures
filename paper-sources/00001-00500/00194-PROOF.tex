...
\title{The empirical recurrence for OEIS A266841, proved from an exact model}
...
\begin{abstract}
OEIS A266841 carries an empirical recurrence of order $6$ contributed by Karl V. Keller, Jr.. It is true, and it is
...
OEIS A266841 is ``Binary representation of the n-th iteration of the "Rule 69" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 10, 10100, 101011, 101010000, 1010101111, 1010101000000, 10101010111111,\ \dots
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A266841.
