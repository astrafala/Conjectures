...
\title{The empirical recurrence for OEIS A266839, proved from an exact model}
...
\begin{abstract}
OEIS A266839 carries an empirical recurrence of order $6$ contributed by Karl V. Keller, Jr.. It is true, and it is
