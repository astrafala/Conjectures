...
\title{The empirical recurrence for OEIS A222016, proved by transfer matrix}
...
\begin{abstract}
OEIS A222016 counts the distinct OCCUPANCY arrays obtained when every cell of an $n\times3$ grid
...
an empirical recurrence of order $37$ contributed by R.~H.~Hardin. It is true, and it is
...
one, on $S=1645$ states, after which the conjectured recurrence is settled by a finite exact
computation.
\end{abstract}
...
OEIS A222016 is ``Number of nX3 arrays of occupancy after each element stays put or moves to some horizontal or vertical neighbor, without move-in move-out straight through or left turns.''. It has offset $1$ and begins
\[
6, 188, 3875, 86088, 1892859, 41636522, 916164266, 20156123913,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 20:08:29, revision 8) this is still
...
$S=1645$ reachable sets. In particular $a$ is $C$-finite.
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) + 286\,a(n-2) + 1731\,a(n-3) - 3366\,a(n-4) - 58755\,a(n-5) - 73158\,a(n-6) + 744580\,a(n-7) + 1606773\,a(n-8) - 5847271\,a(n-9) - 13299665\,a(n-10) + 35585397\,a(n-11) + 56858689\,a(n-12) - 168213873\,a(n-13) - 99886051\,a(n-14) + 532060381\,a(n-15) - 127805646\,a(n-16) - 951724652\,a(n-17) + 874261131\,a(n-18) + 729065885\,a(n-19) - 1511277493\,a(n-20) + 275583551\,a(n-21) + 992093720\,a(n-22) - 708567632\,a(n-23) - 119679569\,a(n-24) + 310913349\,a(n-25) - 92576435\,a(n-26) - 25624476\,a(n-27) + 17876348\,a(n-28) - 1254086\,a(n-29) - 1085212\,a(n-30) + 391330\,a(n-31) - 46391\,a(n-32) - 25190\,a(n-33) + 7306\,a(n-34) + 873\,a(n-35) - 236\,a(n-36) - 12\,a(n-37)
\]
for every $n>37$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A222016.
