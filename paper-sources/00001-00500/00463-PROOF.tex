...
\title{The empirical recurrence for OEIS A187382, proved from an exact model}
...
\begin{abstract}
OEIS A187382 carries an empirical recurrence of order $3$. It is true, and it is
...
\begin{quote}
Empirical: a(n) = 1297*n\^{}2 - 9679*n + 17420 for n>6. a(n) = 3*a(n-1) - 3*a(n-2) + a(n-3) for n>9.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 24 2018 08:50:51, revision 12)
...
SHAPE when one is a translate of the other. There are exactly $1297$ shapes: self-avoiding
...
Write $w^\ast$ for the largest bounding-box side over all $1297$ shapes. Once $n\ge w^\ast$
