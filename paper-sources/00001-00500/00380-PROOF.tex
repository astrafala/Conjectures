...
\title{The empirical recurrence for OEIS A279872, proved from an exact model}
...
\begin{abstract}
OEIS A279872 carries an empirical recurrence of order $4$ contributed by Chai Wah Wu. It is true, and it is
...
\[
1, 0, 7, 0, 31, 0, 127, 0,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Chai Wah Wu\_, Aug 02 2021: (Start) a(n) = 5*a(n-2) - 4*a(n-4) for n > 3.
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 05 2025 15:22:36, revision 21)
