...
\title{The empirical recurrence for OEIS A187051, proved from an exact model}
...
\begin{abstract}
OEIS A187051 carries an empirical recurrence of order $3$. It is true, and it is
...
\begin{quote}
Empirical: a(n) = 109360*n\^{}2 - 1219576*n + 3362248 for n>11. a(n) = 3*a(n-1) - 3*a(n-2) + a(n-3) for n>14.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 20 2018 08:12:49, revision 10)
