...
\begin{abstract}
OEIS A279030 carries an empirical recurrence of order $4$ contributed by Colin Barker. It is true, and it is
...
\begin{quote}
Conjectures from \_Colin Barker\_, Dec 04 2016: (Start) a(n) = 5*a(n-2) - 4*a(n-4) for n>3.
\end{quote}
