...
\title{The empirical recurrence for OEIS A267924, proved from an exact model}
...
\begin{abstract}
OEIS A267924 carries an empirical recurrence of order $2$ contributed by Colin Barker. It is true, and it is
...
OEIS A267924 is ``Decimal representation of the n-th iteration of the "Rule 245" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 3, 27, 123, 507, 2043, 8187, 32763,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical a(n) = 2\^{}(2*n+1) - 5 for n>0. - \_Colin Barker\_, Nov 26 2016 and Apr 20 2019
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 16 2025 08:33:30, revision 20)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267924.
