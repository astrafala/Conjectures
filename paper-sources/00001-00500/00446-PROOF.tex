...
\title{The empirical recurrence for OEIS A267045, proved from an exact model}
...
\begin{abstract}
OEIS A267045 carries an empirical recurrence of order $3$ contributed by Colin Barker. It is true, and it is
...
OEIS A267045 is ``Decimal representation of the middle column of the "Rule 91" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 2, 4, 8, 17, 34, 69, 138,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 10 2016 and Apr 17 2019: (Start) a(n) = 2*a(n-1)+a(n-2)-2*a(n-3) for n>4. [Typo corrected by \_Karl V. Keller, Jr.\_, Mar 16 2022]
\end{quote}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267045.
