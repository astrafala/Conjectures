...
\begin{abstract}
OEIS A277953 carries an empirical recurrence of order $3$ contributed by Colin Barker. It is true, and it is
...
\begin{quote}
Conjectures from \_Colin Barker\_, Nov 06 2016: (Start) a(n) = 10*a(n-1)+a(n-2)-10*a(n-3) for n>2.
\end{quote}
