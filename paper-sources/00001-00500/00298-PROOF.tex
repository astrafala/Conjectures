...
\begin{abstract}
OEIS A285833 carries an empirical recurrence of order $6$ contributed by Colin Barker. It is true, and it is
...
\begin{quote}
Conjectures from \_Colin Barker\_, Apr 28 2017: (Start) a(n) = 111*a(n-2) - 1110*a(n-4) + 1000*a(n-6) for n>6.
\end{quote}
