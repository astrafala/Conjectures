...
\begin{abstract}
OEIS A278753 carries an empirical recurrence of order $6$ contributed by Chai Wah Wu. It is true, and it is
...
\begin{quote}
Conjectures from \_Chai Wah Wu\_, Jun 15 2020: (Start) a(n) = 111*a(n-2) - 1110*a(n-4) + 1000*a(n-6) for n > 5.
\end{quote}
