...
\title{The empirical recurrence for OEIS A266873, proved from an exact model}
...
\begin{abstract}
OEIS A266873 carries an empirical recurrence of order $4$ contributed by Colin Barker. It is true, and it is
...
OEIS A266873 is ``Decimal representation of the n-th iteration of the "Rule 77" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 2, 21, 42, 341, 682, 5461, 10922,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 05 2016 and Apr 18 2019: (Start) a(n) = 17*a(n-2) - 16*a(n-4) for n>3.
\end{quote}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A266873.
