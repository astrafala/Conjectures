...
\title{The empirical recurrence for OEIS A285834, proved by transfer matrix}
...
\begin{abstract}
OEIS A285834 carries an empirical recurrence of order $6$ contributed by R.~H.~Hardin. It is
...
OEIS A285834 is ``Decimal representation of the diagonal from the corner to the origin of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 107", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 3, 3, 15, 6, 63, 12, 255,\ \dots
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A285834.
