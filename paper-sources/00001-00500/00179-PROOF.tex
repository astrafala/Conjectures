...
\title{The empirical recurrence for OEIS A267139, proved from an exact model}
...
\begin{abstract}
OEIS A267139 carries an empirical recurrence of order $6$ contributed by Colin Barker. It is true, and it is
...
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 11 2016 and Apr 19 2019: (Start) a(n) = 19*a(n-2) - 50*a(n-4) + 32*a(n-6) for n > 10.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 16 2025 08:33:29, revision 35)
