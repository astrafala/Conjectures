...
\title{The empirical recurrence for OEIS A267458, proved from an exact model}
...
\begin{abstract}
OEIS A267458 carries an empirical recurrence of order $3$ contributed by Colin Barker. It is true, and it is
...
OEIS A267458 is ``Number of ON (black) cells in the n-th iteration of the "Rule 133" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 1, 1, 1, 3, 3, 5, 5,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 15 2016 and Apr 19 2019: (Start) a(n) = a(n-1)+a(n-2)-a(n-3) for n>4.
\end{quote}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267458.
