...
\title{The empirical recurrence for OEIS A211814, proved by a one-dimensional reduction}
...
\begin{abstract}
OEIS A211814 counts symmetric $(n+1)\times(n+1)$ matrices over
$\{-10,\dots,10\}$ in which every $2\times2$ subblock sums to zero and has three distinct
...
on $S=800$ states, and the empirical recurrence of order $20$ contributed by R.~H.~Hardin
follows.
\end{abstract}
...
OEIS A211814 is ``Number of (n+1)X(n+1) -10..10 symmetric matrices with every 2X2 subblock having sum zero and three distinct values.''. It has offset $1$ and begins
\[
188, 414, 812, 1510, 2778, 5014, 9064, 16350,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 16:22:44, revision 8) this is still
...
$S=800$. The two parity classes never mix, so the walk starts by choosing a parity and a first
value, and every state may end a sequence:
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad \tau=\mathbf{1},\qquad S=800.
\]
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) + 2\,a(n-2) - 77\,a(n-3) + 93\,a(n-4) + 372\,a(n-5) - 775\,a(n-6) - 766\,a(n-7) + 2711\,a(n-8) + 230\,a(n-9) - 4967\,a(n-10) + 1748\,a(n-11) + 4882\,a(n-12) - 3055\,a(n-13) - 2382\,a(n-14) + 2083\,a(n-15) + 433\,a(n-16) - 619\,a(n-17) + 28\,a(n-18) + 66\,a(n-19) - 12\,a(n-20)
\]
for every $n>20$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A211814.
