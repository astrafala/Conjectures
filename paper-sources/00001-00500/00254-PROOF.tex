...
\title{The empirical recurrence for OEIS A281738, proved from an exact model}
...
\begin{abstract}
OEIS A281738 carries an empirical recurrence of order $2$. It is true, and it is
...
OEIS A281738 is ``Decimal representation of the x-axis, from the origin to the right edge, of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 390", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 3, 1, 7, 17, 39, 65, 199,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
(the empirical recurrence quoted in the entry)
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 05 2025 15:22:36, revision 13)
...
vanish from $n=25+1$ onwards, and the run exceeds $S+2$, which by
...
First, the model reproduces all $62$ terms the entry publishes, exactly, in integer
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A281738.
