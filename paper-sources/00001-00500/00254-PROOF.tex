...
\title{The empirical recurrence for OEIS A282418, proved from an exact model}
...
\begin{abstract}
OEIS A282418 carries an empirical recurrence of order $6$ contributed by Colin Barker. It is true, and it is
...
\[
1, 1, 6, 3, 28, 7, 120, 15,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Feb 15 2017: (Start) a(n) = 7*a(n-2) - 14*a(n-4) + 8*a(n-6) for n>5.
\end{quote}
