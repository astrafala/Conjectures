...
\title{The empirical recurrence for OEIS A265225, proved from an exact model}
...
\begin{abstract}
OEIS A265225 carries an empirical recurrence of order $5$ contributed by Wesley Ivan Hurt. It is true, and it is
...
OEIS A265225 is ``Total number of ON (black) cells after n iterations of the "Rule 54" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 4, 6, 12, 15, 24, 28, 40,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
a(n) = n + 1 + (n+1) * floor((n+1)/2), conjectured. - \_Wesley Ivan Hurt\_, Dec 25 2016
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 16 2025 08:33:27, revision 48)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A265225.
