...
\title{A proof of the conjectured closed form for OEIS A208545}
...
\begin{abstract}
OEIS A208545 carries a conjectured closed form. We prove it. The entry states, as fact,
...
\begin{quote}\small
3*x\textasciicircum{}3*(3 + 28*x + 58*x\textasciicircum{}2 + 28*x\textasciicircum{}3 + 3*x\textasciicircum{}4) / (1 - x)\textasciicircum{}8
\end{quote}
and separately carries the comment
\begin{quote}\small
a(n) = (1/14)*n\textasciicircum{}7 - (1/2)*n\textasciicircum{}6 + (3/2)*n\textasciicircum{}5 - (5/2)*n\textasciicircum{}4 + (5/2)*n\textasciicircum{}3 - (3/2)*n\textasciicircum{}2 + (3/7)*n.
\end{quote}
As of the ``Last modified'' line on the live entry (2017-11-11, revision 10) the second
...
\left(9 n + 9\right)\,a(n) + \left(75 n + 306\right)\,a(n+1) + \left(90 n + 1206\right)\,a(n+2) + \left(936 - 90 n\right)\,a(n+3) + \left(81 - 75 n\right)\,a(n+4) + \left(- 9 n - 18\right)\,a(n+5) \;=\; 0
\end{equation}

The leading coefficient of \eqref{eq:rec} is $- 9 \left(n + 2\right)$. Its only integer zeros are $n\in\{-2\}$, all below the range claimed here.
...
For all $n\ge 6$,
\[
a(n) \;=\; \frac{n^{7}}{14} - \frac{n^{6}}{2} + \frac{3 n^{5}}{2} - \frac{5 n^{4}}{2} + \frac{5 n^{3}}{2} - \frac{3 n^{2}}{2} + \frac{3 n}{7}
\]
\end{theorem}
...
$n=6$, which was checked against the entry's DATA in exact integer arithmetic.
The leading coefficient has no zero at any integer $n\ge6$, so
...
\url{https://oeis.org}, 2026. Sequence A208545.
