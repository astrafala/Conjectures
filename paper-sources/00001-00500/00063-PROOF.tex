...
\title{The empirical recurrence for OEIS A063098, proved from an exact model}
...
\begin{abstract}
OEIS A063098 carries an empirical recurrence of order $2$ contributed by Colin Barker. It is true, and it is
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 25 2022 21:43:15, revision 13)
