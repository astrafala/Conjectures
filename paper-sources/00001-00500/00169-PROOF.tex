...
\title{The empirical recurrence for OEIS A265427, proved from an exact model}
...
\begin{abstract}
OEIS A265427 carries an empirical recurrence of order $6$ contributed by Colin Barker. It is true, and it is
...
\begin{quote}
Conjectures from \_Colin Barker\_, Dec 09 2015 and Apr 18 2019: (Start) a(n) = a(n-2) + 10000*a(n-4) - 10000*a(n-6) for n>5.
\end{quote}
