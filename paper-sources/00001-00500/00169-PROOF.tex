...
\title{The empirical recurrence for OEIS A283215, proved from an exact model}
...
\begin{abstract}
OEIS A283215 carries an empirical recurrence of order $6$. It is true, and it is
...
OEIS A283215 is ``Binary representation of the x-axis, from the origin to the right edge, of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 597", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 1, 1, 1101, 10001, 11101, 10001, 11011101,\ \dots
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A283215.
