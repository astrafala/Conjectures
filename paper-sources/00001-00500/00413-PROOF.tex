...
\title{The empirical recurrence for OEIS A265283, proved from an exact model}
...
\begin{abstract}
OEIS A265283 carries an empirical recurrence of order $3$ contributed by Colin Barker. It is true, and it is
...
OEIS A265283 is ``Number of ON (black) cells in the n-th iteration of the "Rule 94" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 3, 4, 6, 6, 8, 8, 10,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Dec 07 2015 and Apr 16 2019: (Start) a(n) = a(n-1) + a(n-2) - a(n-3) for n>2.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 16 2025 08:33:27, revision 29)
...
For this entry the automaton is rule 94, the period is $p=2$ and the pre-period is $n_0=2$.
The certificate is
\begin{gather*}
r=0:\quad \texttt{1} \cdot \texttt{1010}^{\,j} \cdot \texttt{1011} \\
r=1:\quad \texttt{11} \cdot \texttt{1010}^{\,j} \cdot \texttt{10111}
\end{gather*}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A265283.
