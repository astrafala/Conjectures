...
\title{The empirical recurrence for OEIS A288020, proved from an exact model}
...
\begin{abstract}
OEIS A288020 carries an empirical recurrence of order $4$. It is true, and it is
...
OEIS A288020 is ``Binary representation of the diagonal from the corner to the origin of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 501", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 10, 1, 1110, 11, 111110, 11, 11111100,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
(the empirical recurrence quoted in the entry)
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 05 2025 15:22:39, revision 25)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A288020.
