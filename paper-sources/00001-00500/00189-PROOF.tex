...
\title{The empirical recurrence for OEIS A267058, proved from an exact model}
...
\begin{abstract}
OEIS A267058 carries an empirical recurrence of order $6$ contributed by Karl V. Keller, Jr.. It is true, and it is
...
OEIS A267058 is ``Decimal representation of the n-th iteration of the "Rule 97" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 0, 20, 19, 256, 255, 5120, 5119,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 16 2025 08:33:29, revision 23)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267058.
