...
\title{The empirical recurrence for OEIS A262779, proved from an exact model}
...
\begin{abstract}
OEIS A262779 carries an empirical recurrence of order $2$ contributed by Colin Barker. It is true, and it is
...
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 20 2016 and Apr 17 2019: (Start) a(n) = 101*a(n-1)-100*a(n-2) for n>2.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 16 2025 08:33:27, revision 58)
