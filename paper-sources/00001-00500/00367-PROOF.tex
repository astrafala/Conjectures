...
\title{The empirical recurrence for OEIS A266258, proved from an exact model}
...
\begin{abstract}
OEIS A266258 carries an empirical recurrence of order $4$ contributed by Colin Barker. It is true, and it is
...
OEIS A266258 is ``Number of OFF (white) cells in the n-th iteration of the "Rule 11" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
0, 2, 3, 2, 7, 2, 11, 2,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Dec 27 2015 and Apr 14 2019: (Start) a(n) = 2*a(n-2)-a(n-4) for n>4.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 16 2025 08:33:28, revision 14)
...
For this entry the automaton is rule 11, the period is $p=2$ and the pre-period is $n_0=1$.
The certificate is
\begin{gather*}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A266258.
