...
\title{The empirical recurrence for OEIS A264571, proved by transfer matrix}
...
\begin{abstract}
OEIS A264571 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=4$ columns in which
...
OEIS A264571 is ``Number of (3+1)X(n+1) arrays of permutations of 0..n*4+3 with each element having directed index change 1,0 1,1 0,-1 or -1,1.''. It has offset $1$ and begins
\[
1, 4, 10, 44, 143, 633, 2172, 8409,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 17 2015 19:14:08, revision 4) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264571.
