...
\title{The empirical recurrence for OEIS A187610, proved from an exact model}
...
\begin{abstract}
OEIS A187610 carries an empirical recurrence of order $3$. It is true, and it is
...
OEIS A187610 is ``Number of 6-step one space for components leftwards or up, two space for components rightwards or down asymmetric quasi-bishop's tours (antidiagonal moves become knight moves) on an n X n board summed over all starting positions.''. It has offset $1$ and begins
\[
0, 0, 0, 0, 96, 711, 2083, 4758,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 680*n\^{}2 - 7188*n + 18314 for n>9. a(n) = 3*a(n-1) - 3*a(n-2) + a(n-3) for n>12.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 25 2018 11:48:59, revision 11)
...
SHAPE when one is a translate of the other. There are exactly $680$ shapes: self-avoiding
...
Write $w^\ast$ for the largest bounding-box side over all $680$ shapes. Once $n\ge w^\ast$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A187610.
