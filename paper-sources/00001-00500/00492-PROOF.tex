...
\title{The empirical recurrence for OEIS A188155, proved from an exact model}
...
\begin{abstract}
OEIS A188155 carries an empirical recurrence of order $3$. It is true, and it is
...
\begin{quote}
Empirical: a(n) = 16268*n\^{}2 - 115548*n + 186528 for n>8. a(n) = 3*a(n-1) - 3*a(n-2) + a(n-3) for n>11.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 27 2018 09:22:51, revision 11)
...
SHAPE when one is a translate of the other. There are exactly $16268$ shapes: self-avoiding
...
Write $w^\ast$ for the largest bounding-box side over all $16268$ shapes. Once $n\ge w^\ast$
