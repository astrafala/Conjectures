...
\title{The empirical recurrence for OEIS A211491, proved by a one-dimensional reduction}
...
\begin{abstract}
OEIS A211491 counts symmetric $(n+1)\times(n+1)$ matrices over
$\{-4,\dots,4\}$ in which every $2\times2$ subblock sums to zero and has three distinct
...
on $S=84$ states, and the empirical recurrence of order $8$ contributed by R.~H.~Hardin
follows.
\end{abstract}
...
OEIS A211491 is ``Number of (n+1) X (n+1) -4..4 symmetric matrices with every 2 X 2 subblock having sum zero and three distinct values.''. It has offset $1$ and begins
\[
28, 56, 110, 206, 392, 728, 1372, 2562,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) + a(n-2) - 21*a(n-3) + 16*a(n-4) + 29*a(n-5) - 34*a(n-6) - 6*a(n-7) + 12*a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 18 2018 08:22:34, revision 7) this is still
...
$S=84$. The two parity classes never mix, so the walk starts by choosing a parity and a first
value, and every state may end a sequence:
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad \tau=\mathbf{1},\qquad S=84.
\]
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + a(n-2) - 21\,a(n-3) + 16\,a(n-4) + 29\,a(n-5) - 34\,a(n-6) - 6\,a(n-7) + 12\,a(n-8)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A211491.
