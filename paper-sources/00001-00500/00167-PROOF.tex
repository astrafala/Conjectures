...
\title{The empirical recurrence for OEIS A267153, proved from an exact model}
...
\begin{abstract}
OEIS A267153 carries an empirical recurrence of order $6$. It is true, and it is
...
OEIS A267153 is ``Binary representation of the n-th iteration of the "Rule 107" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 100, 1011, 1101110, 1110111, 11110111010, 111011011, 111111011111110,\ \dots
\]
...
pre-period to raise the numerator's degree gives a monic annihilator of order $S=19$. The
...
\begin{theorem}
\[
a(n)\;=\;10000\,a(n-2) + a(n-4) - 10000\,a(n-6)
\]
for every $n>12$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267153.
