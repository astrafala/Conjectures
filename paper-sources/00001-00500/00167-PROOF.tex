...
\title{The empirical recurrence for OEIS A288661, proved from an exact model}
...
\begin{abstract}
OEIS A288661 carries an empirical recurrence of order $6$. It is true, and it is
...
OEIS A288661 is ``Binary representation of the diagonal from the corner to the origin of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 493", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 10, 1, 1100, 11, 111000, 111, 11110000,\ \dots
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A288661.
