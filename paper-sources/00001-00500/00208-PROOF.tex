...
\title{The empirical recurrence for OEIS A266980, proved from an exact model}
...
\begin{abstract}
OEIS A266980 carries an empirical recurrence of order $6$ contributed by Colin Barker. It is true, and it is
...
OEIS A266980 is ``Decimal representation of the n-th iteration of the "Rule 79" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 6, 5, 122, 21, 2026, 85, 32682,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 08 2016 and Apr 18 2019: (Start) a(n) = 21*a(n-2)-84*a(n-4)+64*a(n-6) for n>5.
\end{quote}
...
pre-period to raise the numerator's degree gives a monic annihilator of order $S=8$. The
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A266980.
