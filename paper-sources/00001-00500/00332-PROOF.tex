...
\title{The empirical recurrence for OEIS A267461, proved from an exact model}
...
\begin{abstract}
OEIS A267461 carries an empirical recurrence of order $4$ contributed by Colin Barker. It is true, and it is
...
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 16 2016: (Start) a(n) = 2*a(n-1) - 2*a(n-3) + a(n-4) for n>4.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 16 2025 08:33:29, revision 19)
