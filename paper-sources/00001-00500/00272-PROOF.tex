...
\title{The empirical recurrence for OEIS A267262, proved from an exact model}
...
\begin{abstract}
OEIS A267262 carries an empirical recurrence of order $5$ contributed by Colin Barker. It is true, and it is
...
OEIS A267262 is ``Total number of OFF (white) cells after n iterations of the "Rule 111" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
0, 1, 3, 5, 9, 13, 20, 24,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 14 2016: (Start) a(n) = a(n-1)+2*a(n-2)-2*a(n-3)-a(n-4)+a(n-5) for n>8.
\end{quote}
...
For this entry the automaton is rule 111, the period is $p=2$ and the pre-period is $n_0=5$.
The certificate is
\begin{gather*}
...
annihilator of order $S=11$ used below.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267262.
