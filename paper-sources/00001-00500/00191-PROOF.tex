...
\title{The empirical recurrence for OEIS A266615, proved from an exact model}
...
\begin{abstract}
OEIS A266615 carries an empirical recurrence of order $7$ contributed by Colin Barker. It is true, and it is
...
OEIS A266615 is ``Total number of ON (black) cells after n iterations of the "Rule 41" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 1, 3, 6, 7, 15, 17, 28,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 02 2016 and Apr 18 2019: (Start) a(n) = a(n-1)+a(n-2)-a(n-3)+a(n-4)-a(n-5)-a(n-6)+a(n-7) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 16 2025 08:33:28, revision 20)
...
For this entry the automaton is rule 41, the period is $p=4$ and the pre-period is $n_0=0$.
The certificate is
\begin{gather*}
...
annihilator of order $S=8$ used below.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A266615.
