...
\title{The empirical recurrence for OEIS A267055, proved from an exact model}
...
\begin{abstract}
OEIS A267055 carries an empirical recurrence of order $6$ contributed by Colin Barker. It is true, and it is
...
OEIS A267055 is ``Decimal representation of the n-th iteration of the "Rule 93" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 3, 20, 47, 336, 703, 5440, 11007,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 10 2016 and Apr 19 2019: (Start) a(n) = 21*a(n-2)-84*a(n-4)+64*a(n-6) for n>5.
\end{quote}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267055.
