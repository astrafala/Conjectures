...
\title{The empirical recurrence for OEIS A267780, proved from an exact model}
...
\begin{abstract}
OEIS A267780 carries an empirical recurrence of order $3$. It is true, and it is
...
OEIS A267780 is ``Decimal representation of the n-th iteration of the "Rule 211" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 5, 25, 125, 505, 2045, 8185, 32765,\ \dots
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267780.
