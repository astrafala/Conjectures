...
\title{The empirical recurrence for OEIS A267003, proved from an exact model}
...
\begin{abstract}
OEIS A267003 carries an empirical recurrence of order $6$ contributed by Colin Barker. It is true, and it is
...
OEIS A267003 is ``Decimal representation of the n-th iteration of the "Rule 83" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 5, 8, 111, 64, 1919, 512, 31743,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 08 2016 and Apr 19 2019: (Start) a(n) = 25*a(n-2)-152*a(n-4)+128*a(n-6) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 19 2025 10:02:57, revision 36)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267003.
