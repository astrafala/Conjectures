...
\begin{abstract}
OEIS A279501 carries an empirical recurrence of order $6$ contributed by Colin Barker. It is true, and it is
...
\begin{quote}
Conjectures from \_Colin Barker\_, Dec 14 2016: (Start) a(n) = 4*a(n-2) + a(n-4) - 4*a(n-6) for n>6.
\end{quote}
