...
\title{The empirical recurrence for OEIS A265430, proved from an exact model}
...
\begin{abstract}
OEIS A265430 carries an empirical recurrence of order $5$. It is true, and it is
...
OEIS A265430 is ``Number of OFF (white) cells in the n-th iteration of the "Rule 188" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
0, 1, 3, 3, 5, 6, 8, 8,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
(the empirical recurrence quoted in the entry)
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 16 2025 08:33:27, revision 20)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A265430.
