...
\title{The empirical recurrence for OEIS A063116, proved from an exact model}
...
\begin{abstract}
OEIS A063116 carries an empirical recurrence of order $2$ contributed by David James Sycamore. It is true, and it is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A063116.
