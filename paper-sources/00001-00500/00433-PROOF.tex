...
\begin{abstract}
OEIS A267779 carries an empirical recurrence of order $3$ contributed by Colin Barker. It is true, and it is
...
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 20 2016 and Apr 20 2019: (Start) a(n) = 100*a(n-1) + a(n-2) - 100*a(n-3) for n > 3.
\end{quote}
