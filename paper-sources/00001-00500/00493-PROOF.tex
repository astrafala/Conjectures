...
\title{The empirical recurrence for OEIS A267044, proved from an exact model}
...
\begin{abstract}
OEIS A267044 carries an empirical recurrence of order $3$ contributed by Colin Barker. It is true, and it is
...
OEIS A267044 is ``Binary representation of the middle column of the "Rule 91" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 10, 100, 1000, 10001, 100010, 1000101, 10001010,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 10 2016: (Start) a(n) = 10*a(n-1)+a(n-2)-10*a(n-3) for n>4. [Typo corrected by \_Karl V. Keller, Jr.\_, Mar 16 2022]
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 16 2025 08:33:29, revision 25)
...
For this entry the column is periodic with period $q=2$ from $n=3$: the period above is a
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267044.
