...
\title{The empirical recurrence for OEIS A285647, proved from an exact model}
...
\begin{abstract}
OEIS A285647 carries an empirical recurrence of order $4$ contributed by Colin Barker. It is true, and it is
...
OEIS A285647 is ``Binary representation of the diagonal from the corner to the origin of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 73", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 10, 1, 1100, 0, 111111, 0, 11111111,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Apr 24 2017: (Start) a(n) = 101*a(n-2) - 100*a(n-4) for n>7.
\end{quote}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A285647.
