...
\title{The empirical recurrence for OEIS A283648, proved from an exact model}
...
\begin{abstract}
OEIS A283648 carries an empirical recurrence of order $3$ contributed by Colin Barker. It is true, and it is
...
OEIS A283648 is ``Binary representation of the x-axis, from the left edge to the origin, of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 705", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 0, 111, 1101, 11100, 111101, 1111100, 11111101,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Mar 14 2017: (Start) a(n) = 10*a(n-1) + a(n-2) - 10*a(n-3) for n>5.
\end{quote}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A283648.
