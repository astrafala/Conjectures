...
\title{The empirical recurrence for OEIS A211329, proved by a one-dimensional reduction}
...
\begin{abstract}
OEIS A211329 counts symmetric $(n+1)\times(n+1)$ matrices over
$\{-5,\dots,5\}$ in which every $2\times2$ subblock sums to zero and has one or two distinct
...
on $S=22$ states, and the empirical recurrence of order $3$ contributed by R.~H.~Hardin
follows.
\end{abstract}
...
OEIS A211329 is ``Number of (n+1) X (n+1) -5..5 symmetric matrices with every 2 X 2 subblock having sum zero and one or two distinct values.''. It has offset $1$ and begins
\[
15, 19, 25, 35, 51, 77, 119, 187,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) - a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 17 2018 08:37:53, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A211329.
