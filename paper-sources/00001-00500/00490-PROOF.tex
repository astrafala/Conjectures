...
\title{The empirical recurrence for OEIS A187290, proved from an exact model}
...
\begin{abstract}
OEIS A187290 carries an empirical recurrence of order $3$. It is true, and it is
...
OEIS A187290 is ``Number of 5-step one or two space at a time rook's tours on an n X n board summed over all starting positions.''. It has offset $1$ and begins
\[
0, 0, 720, 4576, 13640, 28224, 48232, 73408,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2540*n\^{}2 - 12896*n + 14016 for n>7. a(n) = 3*a(n-1) - 3*a(n-2) + a(n-3) for n>10.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 23 2018 02:58:50, revision 15)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A187290.
