...
\title{The empirical recurrence for OEIS A290813, proved from an exact model}
...
\begin{abstract}
OEIS A290813 carries an empirical recurrence of order $3$ contributed by Colin Barker. It is true, and it is
...
OEIS A290813 is ``Binary representation of the diagonal from the corner to the origin of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 961", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 10, 101, 1111, 11100, 111111, 1111100, 11111111,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Aug 12 2017: (Start) a(n) = 10*a(n-1) + a(n-2) - 10*a(n-3) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 05 2025 15:22:40, revision 36)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A290813.
