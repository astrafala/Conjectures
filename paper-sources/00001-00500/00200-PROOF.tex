...
\title{The empirical recurrence for OEIS A287192, proved by transfer matrix}
...
\begin{abstract}
OEIS A287192 carries an empirical recurrence of order $4$ contributed by R.~H.~Hardin. It is
...
OEIS A287192 is ``Decimal representation of the diagonal from the corner to the origin of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 253", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 2, 0, 14, 3, 62, 3, 254,\ \dots
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A287192.
