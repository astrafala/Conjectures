...
\title{The empirical recurrence for OEIS A279498, proved from an exact model}
...
\begin{abstract}
OEIS A279498 carries an empirical recurrence of order $6$ contributed by Colin Barker. It is true, and it is
...
\[
1, 0, 101, 0, 10111, 0, 1011101, 0,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Dec 14 2016: (Start) a(n) = a(n-2) + 10000*a(n-4) - 10000*a(n-6) for n>6.
\end{quote}
