...
\title{The empirical recurrence for OEIS A266589, proved from an exact model}
...
\begin{abstract}
OEIS A266589 carries an empirical recurrence of order $6$ contributed by Colin Barker. It is true, and it is
decidable rather than empirical. The entry's sequence is given exactly by a certified growth pattern of the automaton's row word, from
...
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 01 2016 and Apr 18 2019: (Start) a(n) = 10101*a(n-2)-1010100*a(n-4)+1000000*a(n-6) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 16 2025 08:33:28, revision 27)
...
pre-period to raise the numerator's degree gives a monic annihilator of order $S=10$. The
...
vanish from $n=7+1$ onwards, and the run exceeds $S+6$, which by
