...
\title{The empirical recurrence for OEIS A284540, proved from an exact model}
...
\begin{abstract}
OEIS A284540 carries an empirical recurrence of order $5$ contributed by Colin Barker. It is true, and it is
...
OEIS A284540 is ``Binary representation of the x-axis, from the left edge to the origin, of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 974", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 11, 111, 1101, 11101, 110101, 1110001, 11011011,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Mar 29 2017: (Start) a(n) = a(n-1) + 10000*a(n-4) - 10000*a(n-5) for n>8.
\end{quote}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A284540.
