...
\title{The empirical recurrence for OEIS A063164, proved from an exact model}
...
\begin{abstract}
OEIS A063164 carries an empirical recurrence of order $2$ contributed by Colin Barker. It is true, and it is
...
\begin{quote}
Conjectures from \_Colin Barker\_, Jun 08 2019: (Start) a(n) = 2*a(n-1) - a(n-2) for n > 3.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 22 2019 12:18:12, revision 19)
