...
\title{The empirical recurrence for OEIS A267529, proved from an exact model}
...
\begin{abstract}
OEIS A267529 carries an empirical recurrence of order $4$ contributed by Colin Barker. It is true, and it is
...
OEIS A267529 is ``Total number of ON (black) cells after n iterations of the "Rule 141" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 2, 4, 7, 12, 18, 26, 35,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 16 2016 and Apr 20 2019: (Start) a(n) = 2*a(n-1)-2*a(n-3)+a(n-4) for n>4.
\end{quote}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267529.
