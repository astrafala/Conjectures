...
\title{The empirical recurrence for OEIS A285649, proved from an exact model}
...
\begin{abstract}
OEIS A285649 carries an empirical recurrence of order $4$ contributed by Colin Barker. It is true, and it is
...
OEIS A285649 is ``Decimal representation of the diagonal from the corner to the origin of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 73", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 2, 1, 12, 0, 63, 0, 255,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Apr 24 2017: (Start) a(n) = 5*a(n-2) - 4*a(n-4) for n>7.
\end{quote}
...
\[
C(n+2)\;=\;C(n)\qquad\text{as configurations of the whole plane, for every } n\ge 4.
\]
...
neighbourhood to a live cell flips the ENTIRE plane, and rule 73 is read
...
pre-period to raise the numerator's degree gives a monic annihilator of order $S=10$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A285649.
