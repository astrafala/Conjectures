...
\title{The empirical recurrence for OEIS A187861, proved from an exact model}
...
\begin{abstract}
OEIS A187861 carries an empirical recurrence of order $3$. It is true, and it is
...
OEIS A187861 is ``Number of 6-step one space for components leftwards or up, two space for components rightwards or down asymmetric quasi-queen's tours (antidiagonal moves become knight moves) on an n X n board summed over all starting positions.''. It has offset $1$ and begins
\[
0, 0, 846, 9932, 47962, 126397, 262409, 452766,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 28294*n\^{}2 - 224508*n + 433614 for n>9. a(n) = 3*a(n-1) - 3*a(n-2) + a(n-3) for n>12.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 26 2018 09:18:51, revision 10)
...
that grows. So the walks themselves do not depend on $n$ at all. Let $M$ be the $8$
vectors the piece may move by, read from the entry's own words, and call two walks the same
SHAPE when one is a translate of the other. There are exactly $28294$ shapes: self-avoiding
...
Write $w^\ast$ for the largest bounding-box side over all $28294$ shapes. Once $n\ge w^\ast$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A187861.
