...
\title{The empirical recurrence for OEIS A188154, proved from an exact model}
...
\begin{abstract}
OEIS A188154 carries an empirical recurrence of order $3$. It is true, and it is
...
OEIS A188154 is ``Number of 9-step self-avoiding walks on an n X n square summed over all starting positions.''. It has offset $1$ and begins
\[
0, 0, 40, 2640, 14520, 39792, 78168, 128688,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 5916*n\^{}2 - 38192*n + 55600 for n>7. a(n) = 3*a(n-1) - 3*a(n-2) + a(n-3) for n>10.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 27 2018 08:31:37, revision 10)
...
SHAPE when one is a translate of the other. There are exactly $5916$ shapes: self-avoiding
...
Write $w^\ast$ for the largest bounding-box side over all $5916$ shapes. Once $n\ge w^\ast$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A188154.
