...
\title{The empirical recurrence for OEIS A267157, proved from an exact model}
...
\begin{abstract}
OEIS A267157 carries an empirical recurrence of order $3$ contributed by Colin Barker. It is true, and it is
...
OEIS A267157 is ``Decimal representation of the middle column of the "Rule 107" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 2, 4, 9, 19, 39, 79, 159,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 11 2016 and Apr 19 2019: (Start) a(n) = 2*a(n-1)+a(n-2)-2*a(n-3) for n>4.
\end{quote}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267157.
