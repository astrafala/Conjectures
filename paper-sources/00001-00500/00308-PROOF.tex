...
\begin{abstract}
OEIS A290528 carries an empirical recurrence of order $5$ contributed by Colin Barker. It is true, and it is
...
\begin{quote}
Conjectures from \_Colin Barker\_, Aug 05 2017: (Start) a(n) = a(n-1) + 6*a(n-2) - 6*a(n-3) - 8*a(n-4) + 8*a(n-5) for n>4.
\end{quote}
