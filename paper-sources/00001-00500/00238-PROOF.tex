...
\title{The empirical recurrence for OEIS A277952, proved from an exact model}
...
\begin{abstract}
OEIS A277952 carries an empirical recurrence of order $3$. It is true, and it is
...
OEIS A277952 is ``Binary representation of the x-axis, from the left edge to the origin, of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 14", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 11, 110, 1110, 11010, 111010, 1101010, 11101010,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
(the empirical recurrence quoted in the entry)
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 05 2025 15:22:35, revision 16)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A277952.
