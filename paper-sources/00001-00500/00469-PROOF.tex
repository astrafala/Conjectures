...
\title{The empirical recurrence for OEIS A187384, proved from an exact model}
...
\begin{abstract}
OEIS A187384 carries an empirical recurrence of order $3$. It is true, and it is
...
OEIS A187384 is ``Number of 10-step S, NW and NE-moving king's tours on an n X n board summed over all starting positions.''. It has offset $1$ and begins
\[
0, 0, 0, 280, 3792, 17052, 44464, 92628,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 8911*n\^{}2 - 82691*n + 181756 for n>8. a(n) = 3*a(n-1) - 3*a(n-2) + a(n-3) for n>11.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 24 2018 08:47:02, revision 10)
...
SHAPE when one is a translate of the other. There are exactly $8911$ shapes: self-avoiding
...
Write $w^\ast$ for the largest bounding-box side over all $8911$ shapes. Once $n\ge w^\ast$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A187384.
