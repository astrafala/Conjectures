...
\title{The empirical recurrence for OEIS A187381, proved from an exact model}
...
\begin{abstract}
OEIS A187381 carries an empirical recurrence of order $3$. It is true, and it is
...
OEIS A187381 is ``Number of 7-step S, NW and NE-moving king's tours on an n X n board summed over all starting positions.''. It has offset $1$ and begins
\[
0, 0, 18, 324, 1418, 3448, 6581, 10688,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 487*n\^{}2 - 3198*n + 5104 for n>5. a(n) = 3*a(n-1) - 3*a(n-2) + a(n-3) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 24 2018 06:43:32, revision 10)
...
SHAPE when one is a translate of the other. There are exactly $487$ shapes: self-avoiding
...
Write $w^\ast$ for the largest bounding-box side over all $487$ shapes. Once $n\ge w^\ast$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A187381.
