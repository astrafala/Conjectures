...
\title{The empirical recurrence for OEIS A187291, proved from an exact model}
...
\begin{abstract}
OEIS A187291 carries an empirical recurrence of order $3$. It is true, and it is
...
OEIS A187291 is ``Number of 6-step one or two space at a time rook's tours on an n X n board summed over all starting positions.''. It has offset $1$ and begins
\[
0, 0, 1440, 15424, 57288, 134408, 248208, 397152,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 16752*n\^{}2 - 101420*n + 136160 for n>9. a(n) = 3*a(n-1) - 3*a(n-2) + a(n-3) for n>12.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 22 2018 17:46:22, revision 12)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A187291.
