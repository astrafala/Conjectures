...
\title{The empirical recurrence for OEIS A211332, proved by a one-dimensional reduction}
...
\begin{abstract}
OEIS A211332 counts symmetric $(n+1)\times(n+1)$ matrices over
$\{-5,\dots,5\}$ in which every $2\times2$ subblock sums to zero and has two or three distinct
...
on $S=311$ states, and the empirical recurrence of order $21$ contributed by R.~H.~Hardin
follows.
\end{abstract}
...
OEIS A211332 is ``Number of (n+1)X(n+1) -5..5 symmetric matrices with every 2X2 subblock having sum zero and two or three distinct values.''. It has offset $1$ and begins
\[
60, 144, 312, 630, 1266, 2474, 4864, 9466,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 16:09:36, revision 8) this is still
...
$S=311$. The two parity classes never mix, so the walk starts by choosing a parity and a first
value, and every state may end a sequence:
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad \tau=\mathbf{1},\qquad S=311.
\]
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) + 8\,a(n-2) - 75\,a(n-3) + 16\,a(n-4) + 467\,a(n-5) - 412\,a(n-6) - 1551\,a(n-7) + 2039\,a(n-8) + 2909\,a(n-9) - 5118\,a(n-10) - 2897\,a(n-11) + 7385\,a(n-12) + 976\,a(n-13) - 6197\,a(n-14) + 720\,a(n-15) + 2888\,a(n-16) - 760\,a(n-17) - 674\,a(n-18) + 236\,a(n-19) + 60\,a(n-20) - 24\,a(n-21)
\]
for every $n>21$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A211332.
