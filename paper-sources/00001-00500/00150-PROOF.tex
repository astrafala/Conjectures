...
\title{The empirical recurrence for OEIS A211495, proved by a one-dimensional reduction}
...
\begin{abstract}
OEIS A211495 counts symmetric $(n+1)\times(n+1)$ matrices over
$\{-4,\dots,4\}$ in which every $2\times2$ subblock sums to zero and has three or four distinct
...
on $S=20$ states, and the empirical recurrence of order $9$ contributed by R.~H.~Hardin
follows.
\end{abstract}
...
OEIS A211495 is ``Number of (n+1) X (n+1) -4..4 symmetric matrices with every 2 X 2 subblock having sum zero and three or four distinct values.''. It has offset $1$ and begins
\[
28, 96, 336, 1208, 4360, 15792, 57128, 206424,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 7*a(n-1) - a(n-2) - 75*a(n-3) + 78*a(n-4) + 268*a(n-5) - 296*a(n-6) - 316*a(n-7) + 272*a(n-8) - 48*a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 18 2018 08:22:45, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-1) - a(n-2) - 75\,a(n-3) + 78\,a(n-4) + 268\,a(n-5) - 296\,a(n-6) - 316\,a(n-7) + 272\,a(n-8) - 48\,a(n-9)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A211495.
