...
\title{The empirical recurrence for OEIS A063126, proved from an exact model}
...
\begin{abstract}
OEIS A063126 carries an empirical recurrence of order $3$ contributed by Colin Barker. It is true, and it is
...
OEIS A063126 is ``Dimension of the space of weight 2n cusp forms for Gamma\_0( 58 ).''. It has offset $1$ and begins
\[
6, 21, 35, 51, 65, 81, 95, 111,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjecture: a(n) = (-19+(-1)\^{}n+30*n)/2 for n>1. a(n) = a(n-1)+a(n-2)-a(n-3) for n>4. g.f.: x*(x+2)*(x\^{}2+6*x+3) / ((x-1)\^{}2*(x+1)). [\_Colin Barker\_, Feb 07 2013]
\end{quote}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A063126.
