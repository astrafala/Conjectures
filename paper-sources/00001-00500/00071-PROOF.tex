...
\title{The empirical recurrence for OEIS A063153, proved from an exact model}
...
\begin{abstract}
OEIS A063153 carries an empirical recurrence of order $3$ contributed by Colin Barker. It is true, and it is
...
OEIS A063153 is ``Dimension of the space of weight 2n cusp forms for Gamma\_0( 85 ).''. It has offset $1$ and begins
\[
7, 26, 42, 62, 78, 98, 114, 134,\ \dots
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A063153.
