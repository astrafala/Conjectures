...
\title{The empirical recurrence for OEIS A063140, proved from an exact model}
...
\begin{abstract}
OEIS A063140 carries an empirical recurrence of order $2$ contributed by Colin Barker. It is true, and it is
...
\begin{quote}
Conjectures from \_Colin Barker\_, Sep 23 2012: (Start) a(n) = 2*a(n-1)-a(n-2) for n>3.
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 02 2025 10:03:21, revision 14)
