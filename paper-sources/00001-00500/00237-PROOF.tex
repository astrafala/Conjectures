...
\title{The empirical recurrence for OEIS A267926, proved from an exact model}
...
\begin{abstract}
OEIS A267926 carries an empirical recurrence of order $3$ contributed by Colin Barker. It is true, and it is
...
\begin{quote}
Empirical a(n) = (25*4\^{}n-3*(-4)\^{}n-7)/15. - \_Colin Barker\_, Nov 25 2016 and Apr 20 2019
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 16 2025 08:33:30, revision 22)
