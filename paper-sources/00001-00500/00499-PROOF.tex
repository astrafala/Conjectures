...
\title{The empirical recurrence for OEIS A187854, proved from an exact model}
...
\begin{abstract}
OEIS A187854 carries an empirical recurrence of order $3$. It is true, and it is
...
OEIS A187854 is ``Number of 6-step king-knight's tours (piece capable of both kinds of moves) on an n X n board summed over all starting positions.''. It has offset $1$ and begins
\[
0, 0, 16032, 292776, 1400168, 3807828, 7700944, 13082348,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 706880*n\^{}2 - 5180252*n + 9274644 for n>9. a(n) = 3*a(n-1) - 3*a(n-2) + a(n-3) for n>12.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 26 2018 08:38:50, revision 10)
...
that grows. So the walks themselves do not depend on $n$ at all. Let $M$ be the $16$
vectors the piece may move by, read from the entry's own words, and call two walks the same
SHAPE when one is a translate of the other. There are exactly $706880$ shapes: self-avoiding
...
Write $w^\ast$ for the largest bounding-box side over all $706880$ shapes. Once $n\ge w^\ast$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A187854.
