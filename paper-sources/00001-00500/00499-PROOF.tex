...
\title{The empirical recurrence for OEIS A187160, proved from an exact model}
...
\begin{abstract}
OEIS A187160 carries an empirical recurrence of order $3$. It is true, and it is
...
OEIS A187160 is ``Number of 7-step one space at a time bishop's tours on an n X n board summed over all starting positions.''. It has offset $1$ and begins
\[
0, 0, 0, 16, 544, 2328, 6172, 11576,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 780*n\^{}2 - 6296*n + 12024 for n>5. a(n) = 3*a(n-1) - 3*a(n-2) + a(n-3) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 20 2018 10:05:22, revision 10)
...
SHAPE when one is a translate of the other. There are exactly $780$ shapes: self-avoiding
...
Write $w^\ast$ for the largest bounding-box side over all $780$ shapes. Once $n\ge w^\ast$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A187160.
