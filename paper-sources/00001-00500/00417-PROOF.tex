...
\title{The empirical recurrence for OEIS A266975, proved from an exact model}
...
\begin{abstract}
OEIS A266975 carries an empirical recurrence of order $3$ contributed by Colin Barker. It is true, and it is
...
OEIS A266975 is ``Binary representation of the n-th iteration of the "Rule 78" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 110, 11100, 1101000, 111010000, 11010100000, 1110101000000, 110101010000000,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 08 2016 and Apr 18 2019: (Start) a(n) = 10*a(n-1)+10000*a(n-2)-100000*a(n-3) for n>3.
\end{quote}
...
For this entry the automaton is rule 78, the period is $p=2$ and the pre-period is $n_0=1$.
The certificate is
\begin{gather*}
r=0:\quad \texttt{1} \cdot \texttt{10}^{\,j} \cdot \texttt{1} \cdot \texttt{00}^{\,j} \cdot \texttt{0} \\
r=1:\quad \texttt{11} \cdot \texttt{10}^{\,j} \cdot \texttt{1} \cdot \texttt{00}^{\,j} \cdot \texttt{00}
\end{gather*}
...
\begin{theorem}
\[
a(n)\;=\;10\,a(n-1) + 10000\,a(n-2) - 100000\,a(n-3)
\]
for every $n>3$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A266975.
