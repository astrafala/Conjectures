...
\title{The empirical recurrence for OEIS A285644, proved from an exact model}
...
\begin{abstract}
OEIS A285644 carries an empirical recurrence of order $4$ contributed by Colin Barker. It is true, and it is
...
OEIS A285644 is ``Binary representation of the diagonal from the origin to the corner of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 65", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 1, 100, 11, 10000, 1111, 1100000, 111111,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Apr 24 2017: (Start) a(n) = 101*a(n-2) - 100*a(n-4) for n>3.
\end{quote}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A285644.
