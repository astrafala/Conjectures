...
\title{The empirical recurrence for OEIS A187168, proved from an exact model}
...
\begin{abstract}
OEIS A187168 carries an empirical recurrence of order $4$. It is true, and it is
...
OEIS A187168 is ``Number of 7-step self-avoiding walks on an n X n X n cube summed over all starting positions.''. It has offset $1$ and begins
\[
0, 192, 25344, 177120, 568248, 1298016, 2466510, 4175136,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 16926*n\^{}3 - 85380*n\^{}2 + 128832*n - 57312 for n>5. a(n) = 4*a(n-1) - 6*a(n-2) + 4*a(n-3) - a(n-4) for n>9.
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 05 2022 22:11:52, revision 14)
...
SHAPE when one is a translate of the other. There are exactly $16926$ shapes: self-avoiding
sequences of $7$ distinct cells in $\mathbf{Z}^{3}$ with each consecutive difference in
...
Write $w^\ast$ for the largest bounding-box side over all $16926$ shapes. Once $n\ge w^\ast$
...
$z^{7}(z-1)^{4}$, monic of order $S=11$. Both numbers are read off the enumerated
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A187168.
