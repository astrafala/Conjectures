...
\title{The empirical recurrence for OEIS A286772, proved from an exact model}
...
\begin{abstract}
OEIS A286772 carries an empirical recurrence of order $4$. It is true, and it is
...
OEIS A286772 is ``Decimal representation of the diagonal from the corner to the origin of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 221", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 2, 0, 14, 1, 62, 1, 254,\ \dots
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A286772.
