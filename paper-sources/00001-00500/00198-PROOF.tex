...
\title{The empirical recurrence for OEIS A266516, proved from an exact model}
...
\begin{abstract}
OEIS A266516 carries an empirical recurrence of order $6$ contributed by Vincenzo Librandi. It is true, and it is
...
OEIS A266516 is ``Decimal representation of the n-th iteration of the "Rule 29" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 3, 4, 111, 16, 1983, 64, 32511,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical a(n) = 21*a(n-2) - 84*a(n-4) + 64*a(n-6) for n>5. - \_Vincenzo Librandi\_, Dec 31 2015 and Apr 16 2019
\end{quote}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A266516.
