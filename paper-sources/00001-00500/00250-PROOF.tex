...
\title{The empirical recurrence for OEIS A283217, proved from an exact model}
...
\begin{abstract}
OEIS A283217 carries an empirical recurrence of order $6$ contributed by Colin Barker. It is true, and it is
...
OEIS A283217 is ``Decimal representation of the x-axis, from the origin to the right edge, of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 597", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 1, 1, 13, 17, 29, 17, 221,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Mar 04 2017: (Start) a(n) = a(n-2) + 16*a(n-4) - 16*a(n-6) for n>5.
\end{quote}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A283217.
