...
\title{The empirical recurrence for OEIS A266663, proved from an exact model}
...
\begin{abstract}
OEIS A266663 carries an empirical recurrence of order $5$. It is true, and it is
...
OEIS A266663 is ``Total number of ON (black) cells after n iterations of the "Rule 47" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 3, 5, 10, 12, 21, 23, 36,\ \dots
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A266663.
