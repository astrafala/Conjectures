...
\title{The empirical recurrence for OEIS A277954, proved from an exact model}
...
\begin{abstract}
OEIS A277954 carries an empirical recurrence of order $3$ contributed by Colin Barker. It is true, and it is
...
\[
1, 3, 6, 14, 26, 58, 106, 234,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Nov 06 2016: (Start) a(n) = a(n-1)+4*a(n-2)-4*a(n-3) for n>2.
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 05 2025 15:22:35, revision 14)
