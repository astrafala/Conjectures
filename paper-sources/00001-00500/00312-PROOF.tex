...
\begin{abstract}
OEIS A266286 carries an empirical recurrence of order $4$ contributed by Andres Cicuttin. It is true, and it is
...
\begin{quote}
Conjecture: a(n) = (n\^{}2)mod(2n-3) for n>6. - \_Andres Cicuttin\_, Aug 29 2019
\end{quote}
