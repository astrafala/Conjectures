...
\title{The empirical recurrence for OEIS A188788, proved from an exact model}
...
\begin{abstract}
OEIS A188788 carries an empirical recurrence of order $5$. It is true, and it is
...
OEIS A188788 is ``Number of 5-step self-avoiding walks on an n X n X n X n 4-cube summed over all starting positions.''. It has offset $1$ and begins
\[
0, 1536, 39408, 217728, 702904, 1726080, 3583320, 6635392,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2696*n\^{}4 - 9968*n\^{}3 + 11424*n\^{}2 - 4416*n + 384 for n>3. a(n) = 5*a(n-1) - 10*a(n-2) + 10*a(n-3) - 5*a(n-4) + a(n-5) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 29 2018 08:46:42, revision 9)
...
SHAPE when one is a translate of the other. There are exactly $2696$ shapes: self-avoiding
sequences of $5$ distinct cells in $\mathbf{Z}^{4}$ with each consecutive difference in
...
Write $w^\ast$ for the largest bounding-box side over all $2696$ shapes. Once $n\ge w^\ast$
...
$z^{5}(z-1)^{5}$, monic of order $S=10$. Both numbers are read off the enumerated
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A188788.
