...
\title{The empirical recurrence for OEIS A266984, proved from an exact model}
...
\begin{abstract}
OEIS A266984 carries an empirical recurrence of order $4$ contributed by Colin Barker. It is true, and it is
...
OEIS A266984 is ``Decimal representation of the n-th iteration of the "Rule 81" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 1, 24, 31, 384, 511, 6144, 8191,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 08 2016 and Apr 17 2019: (Start) a(n) = 17*a(n-2)-16*a(n-4) for n>4.
\end{quote}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A266984.
