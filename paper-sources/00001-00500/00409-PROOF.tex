...
\title{The empirical recurrence for OEIS A229315, proved by transfer matrix}
...
\begin{abstract}
OEIS A229315 counts the distinct arrays obtained by applying a fixed local operation to every cell
of an array over a bounded alphabet, and carries an empirical recurrence of order $65$
...
$S=209$ states, after which the conjectured recurrence is settled by a finite exact
computation.
\end{abstract}
...
OEIS A229315 is ``Number of nX2 0..3 arrays of the median of the corresponding element, the element to the east and the element to the south in a larger (n+1)X3 0..3 array without adjacent equal elements in the latter.''. It has offset $1$ and begins
\[
14, 154, 1494, 13968, 129766, 1203222, 11146054, 103236194,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 04 2025 00:08:22, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

Let $R$ be the set of rows of length $3$ over $\{0,\dots,3\}$ and no two adjacent entries of the larger array are equal.
...
\]
There are $S=209$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite.
...
\begin{theorem}
\[
a(n)\;=\;12\,a(n-1) - 12\,a(n-2) - 170\,a(n-3) + 413\,a(n-4) + 360\,a(n-5) - 2500\,a(n-6) + 4761\,a(n-7) - 7424\,a(n-8) + 8095\,a(n-9) + 1067\,a(n-10) - 10948\,a(n-11) + 5811\,a(n-12) - 5685\,a(n-13) - 5667\,a(n-14) + 43767\,a(n-15) - 42200\,a(n-16) + 63250\,a(n-17) - 114786\,a(n-18) + 139663\,a(n-19) - 210040\,a(n-20) + 242074\,a(n-21) + 11485\,a(n-22) - 229841\,a(n-23) + 246874\,a(n-24) - 495364\,a(n-25) + 424756\,a(n-26) - 414970\,a(n-27) + 601244\,a(n-28) - 811641\,a(n-29) + 1009456\,a(n-30) - 1380235\,a(n-31) + 1228145\,a(n-32) - 674904\,a(n-33) + 313339\,a(n-34) + 511282\,a(n-35) - 710123\,a(n-36) + 664496\,a(n-37) - 457843\,a(n-38) + 191690\,a(n-39) + 55758\,a(n-40) - 66502\,a(n-41) + 150610\,a(n-42) + 1481\,a(n-43) + 19304\,a(n-44) - 48928\,a(n-45) + 40006\,a(n-46) - 47878\,a(n-47) - 42105\,a(n-48) - 11482\,a(n-49) - 12568\,a(n-50) + 16105\,a(n-51) + 103\,a(n-52) + 5809\,a(n-53) - 2122\,a(n-54) + 4423\,a(n-55) + 601\,a(n-56) - 1525\,a(n-57) - 384\,a(n-58) - 1331\,a(n-59) - 98\,a(n-60) + 157\,a(n-61) + 5\,a(n-62) + 86\,a(n-63) + 11\,a(n-64) - 2\,a(n-65)
\]
for every $n>65$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A229315.
