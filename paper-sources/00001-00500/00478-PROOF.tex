...
\title{The empirical recurrence for OEIS A264282, proved by transfer matrix}
...
\begin{abstract}
OEIS A264282 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=6$ rows in which
...
OEIS A264282 is ``Number of (n+1)X(5+1) arrays of permutations of 0..n*6+5 with each element having directed index change 0,0 0,1 1,0 or -1,-2.''. It has offset $1$ and begins
\[
33, 360, 4189, 47492, 537057, 6080234, 68815948, 778858184,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 10 2015 14:54:10, revision 4) this is still
...
\[
(i-h_i,\,j-h_j)\;\in\;\{(-1,-2),\ (0,0),\ (0,1),\ (1,0)\},
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264282.
