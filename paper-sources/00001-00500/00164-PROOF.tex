...
\title{The empirical recurrence for OEIS A289764, proved from an exact model}
...
\begin{abstract}
OEIS A289764 carries an empirical recurrence of order $6$. It is true, and it is
...
OEIS A289764 is ``Decimal representation of the diagonal from the corner to the origin of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 597", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 2, 6, 13, 29, 58, 122, 245,\ \dots
\]
...
pre-period to raise the numerator's degree gives a monic annihilator of order $S=16$. The
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) - a(n-2) - 3\,a(n-3) + 4\,a(n-4) - 6\,a(n-5) + 4\,a(n-6)
\]
for every $n>0$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A289764.
