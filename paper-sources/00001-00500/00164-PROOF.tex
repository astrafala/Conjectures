...
\title{The empirical recurrence for OEIS A267293, proved from an exact model}
...
\begin{abstract}
OEIS A267293 carries an empirical recurrence of order $6$ contributed by Colin Barker. It is true, and it is
...
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 15 2016 and Apr 19 2019: (Start) a(n) = a(n-2)+100000000*a(n-4)-100000000*a(n-6) for n>12.
\end{quote}
