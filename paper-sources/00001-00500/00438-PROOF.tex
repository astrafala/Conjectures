...
\title{The empirical recurrence for OEIS A282413, proved from an exact model}
...
\begin{abstract}
OEIS A282413 carries an empirical recurrence of order $4$ contributed by Colin Barker. It is true, and it is
...
\[
1, 1, 7, 0, 31, 0, 127, 0,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Feb 15 2017: (Start) a(n) = 5*a(n-2) - 4*a(n-4) for n>3.
\end{quote}
