...
\title{The empirical recurrence for OEIS A282797, proved from an exact model}
...
\begin{abstract}
OEIS A282797 carries an empirical recurrence of order $4$ contributed by Colin Barker. It is true, and it is
...
\[
1, 0, 111, 10, 11111, 1010, 1111111, 101010,\ \dots
\]
