...
\begin{abstract}
OEIS A267681 carries an empirical recurrence of order $4$ contributed by Colin Barker. It is true, and it is
...
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 19 2016: (Start) a(n) = 5*a(n-1)-20*a(n-3)+16*a(n-4) for n>4.
\end{quote}
