...
\title{The empirical recurrence for OEIS A266303, proved from an exact model}
...
\begin{abstract}
OEIS A266303 carries an empirical recurrence of order $4$ contributed by Colin Barker. It is true, and it is
...
OEIS A266303 is ``Number of ON (black) cells in the n-th iteration of the "Rule 15" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 2, 1, 6, 1, 10, 1, 14,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Dec 28 2015 and Apr 15 2019: (Start) a(n) = 2*a(n-2)-a(n-4) for n>3.
\end{quote}
...
For this entry the automaton is rule 15, the period is $p=2$ and the pre-period is $n_0=0$.
The certificate is
\begin{gather*}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A266303.
