...
\title{The empirical recurrence for OEIS A211552, proved by a one-dimensional reduction}
...
\begin{abstract}
OEIS A211552 counts symmetric $(n+1)\times(n+1)$ matrices over
$\{-9,\dots,9\}$ in which every $2\times2$ subblock sums to zero and has two or three distinct
...
on $S=1384$ states, and the empirical recurrence of order $34$ contributed by R.~H.~Hardin
follows.
\end{abstract}
...
OEIS A211552 is ``Number of (n+1)X(n+1) -9..9 symmetric matrices with every 2X2 subblock having sum zero and two or three distinct values.''. It has offset $1$ and begins
\[
180, 504, 1148, 2508, 5202, 10762, 21622, 43984,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 16:13:13, revision 8) this is still
...
$S=1384$. The two parity classes never mix, so the walk starts by choosing a parity and a first
value, and every state may end a sequence:
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad \tau=\mathbf{1},\qquad S=1384.
\]
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) + 17\,a(n-2) - 166\,a(n-3) - 31\,a(n-4) + 2043\,a(n-5) - 1600\,a(n-6) - 14704\,a(n-7) + 20269\,a(n-8) + 68225\,a(n-9) - 129342\,a(n-10) - 210658\,a(n-11) + 529848\,a(n-12) + 422669\,a(n-13) - 1504565\,a(n-14) - 469508\,a(n-15) + 3056859\,a(n-16) - 21015\,a(n-17) - 4491182\,a(n-18) + 1054426\,a(n-19) + 4754701\,a(n-20) - 1955055\,a(n-21) - 3565976\,a(n-22) + 2006020\,a(n-23) + 1829375\,a(n-24) - 1309433\,a(n-25) - 598506\,a(n-26) + 551716\,a(n-27) + 104454\,a(n-28) - 144434\,a(n-29) - 2452\,a(n-30) + 21200\,a(n-31) - 2120\,a(n-32) - 1320\,a(n-33) + 240\,a(n-34)
\]
for every $n>34$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A211552.
