...
\begin{abstract}
OEIS A266788 carries an empirical recurrence of order $6$ contributed by Colin Barker. It is true, and it is
...
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 03 2016 and Apr 18 2019: (Start) a(n) = 25*a(n-2)-152*a(n-4)+128*a(n-6) for n>10.
\end{quote}
