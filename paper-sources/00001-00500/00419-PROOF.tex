...
\title{The empirical recurrence for OEIS A285778, proved from an exact model}
...
\begin{abstract}
OEIS A285778 carries an empirical recurrence of order $4$ contributed by Colin Barker. It is true, and it is
...
OEIS A285778 is ``Decimal representation of the diagonal from the origin to the corner of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 89", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 1, 4, 7, 0, 63, 0, 255,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Apr 26 2017: (Start) a(n) = 5*a(n-2) - 4*a(n-4) for n>7.
\end{quote}
...
neighbourhood to a live cell flips the ENTIRE plane, and rule 89 is read
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A285778.
