...
\title{The empirical recurrence for OEIS A280482, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A280482 imposes three things at once: a condition on each cell that reaches one column up and
...
numbers. The empirical recurrence of order $26$ contributed by R.~H.~Hardin then follows
...
OEIS A280482 is ``Number of 3Xn 0..2 arrays with no element unequal to a strict majority of its horizontal and antidiagonal neighbors, with the exception of exactly two elements, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
0, 30, 208, 997, 4070, 15441, 55149, 189470,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 04 2017 06:31:02, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;11\,a(n-1) - 43\,a(n-2) + 45\,a(n-3) + 162\,a(n-4) - 534\,a(n-5) + 298\,a(n-6) + 1054\,a(n-7) - 1829\,a(n-8) + 47\,a(n-9) + 1985\,a(n-10) - 895\,a(n-11) - 308\,a(n-12) - 1748\,a(n-13) + 1696\,a(n-14) + 2932\,a(n-15) - 3512\,a(n-16) - 896\,a(n-17) + 720\,a(n-18) + 1776\,a(n-19) + 960\,a(n-20) - 2752\,a(n-21) - 256\,a(n-22) + 704\,a(n-23) + 640\,a(n-24) + 256\,a(n-25) - 512\,a(n-26)
\end{equation}
for all $n>32$.
...
$h_j=G^{j}N^{o}\mathbf{u}$, we have for $j\ge26$
\[
3!\Bigl(a(n_0+j)-\sum_i c_i\,a(n_0+j-i)\Bigr)=\mathbf{v}^{\!\top}G^{\,j-26}w,
...
$26$ applications of $G$ in exact integer arithmetic and $\mathbf{v}^{\!\top}G^{m}w$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A280482.
