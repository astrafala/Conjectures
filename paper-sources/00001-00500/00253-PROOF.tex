...
\title{The empirical recurrence for OEIS A281736, proved from an exact model}
...
\begin{abstract}
OEIS A281736 carries an empirical recurrence of order $2$. It is true, and it is
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 05 2025 15:22:36, revision 17)
