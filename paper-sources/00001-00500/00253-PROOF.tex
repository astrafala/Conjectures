...
\title{The empirical recurrence for OEIS A266850, proved from an exact model}
...
\begin{abstract}
OEIS A266850 carries an empirical recurrence of order $6$ contributed by Colin Barker. It is true, and it is
...
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 05 2016 and Apr 18 2019: (Start) a(n) = 21*a(n-2)-84*a(n-4)+64*a(n-6) for n>5.
\end{quote}
