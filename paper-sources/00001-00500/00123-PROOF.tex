...
\title{The empirical recurrence for OEIS A211714, proved by a one-dimensional reduction}
...
\begin{abstract}
OEIS A211714 counts symmetric $(n+1)\times(n+1)$ matrices over
$\{-11,\dots,11\}$ in which every $2\times2$ subblock sums to zero and has one, two or three distinct
...
on $S=2275$ states, and the empirical recurrence of order $37$ contributed by R.~H.~Hardin
follows.
\end{abstract}
...
OEIS A211714 is ``Number of (n+1)X(n+1) -11..11 symmetric matrices with every 2X2 subblock having sum zero and one, two or three distinct values.''. It has offset $1$ and begins
\[
265, 747, 1781, 4001, 8773, 18947, 40653, 87497,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 16:18:22, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{The sum-zero condition solved}

Let $x$ be an $N\times N$ symmetric matrix with entries in $\{-11,\dots,11\}$ such that
\[
...
\qquad u_0,\dots,u_{N-1}\in\{-11,\dots,11\}\ \text{all of the same parity},
\]
...
the same parity; and $|x(i,j)|=|u_i+u_j|/2\le11$ for all $i,j$ is equivalent to $|u_i|\le11$
...
$\{-11,\dots,11\}$ with all entries of one parity. What remains is to say, in terms of $u$,
that every $2\times2$ subblock has one, two or three distinct entries.
...
Call two consecutive pairs COMPATIBLE when that number lies in $\{1,2,3\}$. The condition on the
...
the compatibility graph on the $\le 529$ pairs.
\end{corollary}
...
$S=2275$. The two parity classes never mix, so the walk starts by choosing a parity and a first
value, and every state may end a sequence:
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad \tau=\mathbf{1},\qquad S=2275.
\]
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-1) + 6\,a(n-2) - 206\,a(n-3) + 285\,a(n-4) + 2263\,a(n-5) - 5657\,a(n-6) - 13373\,a(n-7) + 50982\,a(n-8) + 40840\,a(n-9) - 281579\,a(n-10) - 13385\,a(n-11) + 1048034\,a(n-12) - 436693\,a(n-13) - 2737159\,a(n-14) + 2073869\,a(n-15) + 5090373\,a(n-16) - 5371714\,a(n-17) - 6715078\,a(n-18) + 9215866\,a(n-19) + 6127230\,a(n-20) - 11048104\,a(n-21) - 3615358\,a(n-22) + 9411386\,a(n-23) + 1097124\,a(n-24) - 5704954\,a(n-25) + 102275\,a(n-26) + 2442605\,a(n-27) - 246701\,a(n-28) - 727226\,a(n-29) + 105622\,a(n-30) + 146470\,a(n-31) - 22910\,a(n-32) - 18988\,a(n-33) + 2584\,a(n-34) + 1432\,a(n-35) - 120\,a(n-36) - 48\,a(n-37)
\]
for every $n>37$.
\end{theorem}
...
symmetric matrices were written out entry by entry over $\{-11,\dots,11\}$ and each
$2\times2$ subblock tested for summing to zero and for having one, two or three distinct entries. The
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A211714.
