...
\title{The empirical recurrence for OEIS A187300, proved from an exact model}
...
\begin{abstract}
OEIS A187300 carries an empirical recurrence of order $3$. It is true, and it is
...
\begin{quote}
Empirical: a(n) = 214*n\^{}2 - 1080*n + 1152 for n>7. a(n) = 3*a(n-1) - 3*a(n-2) + a(n-3) for n>10.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 23 2018 08:39:09, revision 10)
...
SHAPE when one is a translate of the other. There are exactly $214$ shapes: self-avoiding
...
Write $w^\ast$ for the largest bounding-box side over all $214$ shapes. Once $n\ge w^\ast$
