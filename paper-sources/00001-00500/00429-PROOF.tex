...
\title{The empirical recurrence for OEIS A187303, proved from an exact model}
...
\begin{abstract}
OEIS A187303 carries an empirical recurrence of order $3$. It is true, and it is
...
\begin{quote}
Empirical: a(n) = 9878*n\^{}2 - 79388*n + 143388 for n>13. a(n) = 3*a(n-1) - 3*a(n-2) + a(n-3) for n>16.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 23 2018 14:27:04, revision 10)
...
SHAPE when one is a translate of the other. There are exactly $9878$ shapes: self-avoiding
...
Write $w^\ast$ for the largest bounding-box side over all $9878$ shapes. Once $n\ge w^\ast$
