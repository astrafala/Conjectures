...
\title{The empirical recurrence for OEIS A211713, proved by a one-dimensional reduction}
...
\begin{abstract}
OEIS A211713 counts symmetric $(n+1)\times(n+1)$ matrices over
$\{-11,\dots,11\}$ in which every $2\times2$ subblock sums to zero and has two or three distinct
...
on $S=2138$ states, and the empirical recurrence of order $36$ contributed by R.~H.~Hardin
follows.
\end{abstract}
...
OEIS A211713 is ``Number of (n+1)X(n+1) -11..11 symmetric matrices with every 2X2 subblock having sum zero and two or three distinct values.''. It has offset $1$ and begins
\[
264, 726, 1670, 3574, 7448, 15136, 30436, 60938,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 16:18:14, revision 8) this is still
...
$S=2138$. The two parity classes never mix, so the walk starts by choosing a parity and a first
value, and every state may end a sequence:
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad \tau=\mathbf{1},\qquad S=2138.
\]
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) + 23\,a(n-2) - 149\,a(n-3) - 196\,a(n-4) + 2007\,a(n-5) + 424\,a(n-6) - 16175\,a(n-7) + 5683\,a(n-8) + 87013\,a(n-9) - 61030\,a(n-10) - 330011\,a(n-11) + 313597\,a(n-12) + 908524\,a(n-13) - 1043207\,a(n-14) - 1841180\,a(n-15) + 2438675\,a(n-16) + 2754829\,a(n-17) - 4138459\,a(n-18) - 3021301\,a(n-19) + 5162035\,a(n-20) + 2381895\,a(n-21) - 4737637\,a(n-22) - 1297351\,a(n-23) + 3176171\,a(n-24) + 447161\,a(n-25) - 1532186\,a(n-26) - 72331\,a(n-27) + 519056\,a(n-28) - 8146\,a(n-29) - 118840\,a(n-30) + 6266\,a(n-31) + 17252\,a(n-32) - 1128\,a(n-33) - 1408\,a(n-34) + 72\,a(n-35) + 48\,a(n-36)
\]
for every $n>36$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A211713.
