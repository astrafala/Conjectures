...
\title{The empirical recurrence for OEIS A266613, proved from an exact model}
...
\begin{abstract}
OEIS A266613 carries an empirical recurrence of order $3$ contributed by Colin Barker. It is true, and it is
...
OEIS A266613 is ``Decimal representation of the middle column of the "Rule 41" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 2, 5, 10, 20, 41, 82, 165,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 02 2016 and Apr 16 2019: (Start) a(n) = 2*a(n-1)+a(n-2)-2*a(n-3) for n>5. - [corrected by \_Karl V. Keller, Jr.\_, Oct 07 2021]
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 16 2025 08:33:28, revision 63)
...
For this entry the column is periodic with period $q=2$ from $n=4$: the period above is a
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A266613.
