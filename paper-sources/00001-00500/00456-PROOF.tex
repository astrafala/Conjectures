...
\title{The empirical recurrence for OEIS A279974, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A279974 imposes three things at once: a condition on each cell that reaches one row up and
...
numbers. The empirical recurrence of order $38$ contributed by R.~H.~Hardin then follows
from a finite exact computation on $S=3075$ states.
\end{abstract}
...
OEIS A279974 is ``Number of nX5 0..1 arrays with no element equal to a strict majority of its horizontal and antidiagonal neighbors, with the exception of exactly two elements, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
3, 62, 822, 10491, 124030, 1393359, 15071233, 158391708,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 24 2016 08:32:15, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;53\,a(n-1) - 1291\,a(n-2) + 19418\,a(n-3) - 204835\,a(n-4) + 1632329\,a(n-5) - 10324115\,a(n-6) + 53654890\,a(n-7) - 234937934\,a(n-8) + 882771616\,a(n-9) - 2885212091\,a(n-10) + 8285140483\,a(n-11) - 21058509124\,a(n-12) + 47630930849\,a(n-13) - 96230469370\,a(n-14) + 174085724937\,a(n-15) - 282388861308\,a(n-16) + 410961960219\,a(n-17) - 536498538568\,a(n-18) + 627876381653\,a(n-19) - 658110830698\,a(n-20) + 617080503289\,a(n-21) - 516968320637\,a(n-22) + 386461849324\,a(n-23) - 257438979196\,a(n-24) + 152574757688\,a(n-25) - 80292463252\,a(n-26) + 37420429652\,a(n-27) - 15389322205\,a(n-28) + 5557085609\,a(n-29) - 1749901992\,a(n-30) + 476005587\,a(n-31) - 110393019\,a(n-32) + 21427460\,a(n-33) - 3388972\,a(n-34) + 419408\,a(n-35) - 38032\,a(n-36) + 2240\,a(n-37) - 64\,a(n-38)
\end{equation}
for all $n>39$.
...
Assembling the $2$ chains block-diagonally into $N$ of size $S=3075$ with the weights of
...
$h_j=G^{j}N^{o}\mathbf{u}$, we have for $j\ge38$
\[
2!\Bigl(a(n_0+j)-\sum_i c_i\,a(n_0+j-i)\Bigr)=\mathbf{v}^{\!\top}G^{\,j-38}w,
...
$38$ applications of $G$ in exact integer arithmetic and $\mathbf{v}^{\!\top}G^{m}w$
evaluated for $m=0,1,\dots$, again exactly. Every one of those integers vanishes from the
index corresponding to $n=39+1$ onwards, and the run continued until $S+1$ consecutive
zeros had been seen.
\end{proof}
...
one of the $17$ published indices and agrees with the entry's DATA exactly, the quotient
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A279974.
