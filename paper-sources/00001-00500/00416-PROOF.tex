...
\begin{abstract}
OEIS A282453 carries an empirical recurrence of order $4$ contributed by Chai Wah Wu. It is true, and it is
...
\begin{quote}
Conjectures from \_Chai Wah Wu\_, Apr 18 2024: (Start) a(n) = 5*a(n-2) - 4*a(n-4) for n > 3.
\end{quote}
