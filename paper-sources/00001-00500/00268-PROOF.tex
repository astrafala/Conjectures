...
\title{The empirical recurrence for OEIS A267614, proved from an exact model}
...
\begin{abstract}
OEIS A267614 carries an empirical recurrence of order $2$ contributed by Colin Barker. It is true, and it is
...
OEIS A267614 is ``Decimal representation of the n-th iteration of the "Rule 185" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 1, 11, 47, 191, 767, 3071, 12287,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical a(n) = 3*4\^{}(n-1)-1 = A198693(n-1) for n>1. - \_Colin Barker\_, Nov 25 2016 and Apr 20 2019
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 30 2025 13:06:15, revision 36)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267614.
