...
\title{The empirical recurrence for OEIS A266842, proved from an exact model}
...
\begin{abstract}
OEIS A266842 carries an empirical recurrence of order $6$. It is true, and it is
...
OEIS A266842 is ``Decimal representation of the n-th iteration of the "Rule 69" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 2, 20, 43, 336, 687, 5440, 10943,\ \dots
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A266842.
