...
\title{The empirical recurrence for OEIS A063121, proved from an exact model}
...
\begin{abstract}
OEIS A063121 carries an empirical recurrence of order $3$. It is true, and it is
...
OEIS A063121 is ``Dimension of the space of weight 2n cusp forms for Gamma\_0( 53 ).''. It has offset $1$ and begins
\[
4, 13, 21, 31, 39, 49, 57, 67,\ \dots
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A063121.
