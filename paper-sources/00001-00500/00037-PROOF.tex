...
\title{The empirical recurrence for OEIS A315559, proved from an exact model}
...
\begin{abstract}
OEIS A315559 carries an empirical recurrence of order $10$ contributed by Chai Wah Wu. It is true, and it is
...
OEIS A315559 is ``Coordination sequence Gal.4.149.2 where Gal.u.t.v denotes the coordination sequence for a vertex of type v in tiling number t in the Galebach list of u-uniform tilings.''. It has offset $0$ and begins
\[
1, 6, 11, 18, 22, 30, 34, 40,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Chai Wah Wu\_, Jun 09 2020: (Start) a(n) = 2*a(n-5) - a(n-10) for n > 10.
\end{quote}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A315559.
