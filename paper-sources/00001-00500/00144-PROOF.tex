...
\title{The empirical recurrence for OEIS A283645, proved from an exact model}
...
\begin{abstract}
OEIS A283645 carries an empirical recurrence of order $10$. It is true, and it is
...
OEIS A283645 is ``Binary representation of the x-axis, from the origin to the right edge, of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 694", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 11, 101, 1011, 10101, 101011, 1011101, 10110011,\ \dots
\]
...
\begin{theorem}
\[
a(n)\;=\;100\,a(n-2) + a(n-8) - 100\,a(n-10)
\]
for every $n>15$.
\end{theorem}
...
vanish from $n=15+1$ onwards, and the run exceeds $S+10$, which by
Lemma~\ref{lem:crit} settles every larger index at once. The bound is exact: at $n=15$ the recurrence fails on the entry's own published terms, so no larger range holds.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A283645.
