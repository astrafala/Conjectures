...
\title{The empirical recurrence for OEIS A283582, proved from an exact model}
...
\begin{abstract}
OEIS A283582 carries an empirical recurrence of order $10$ contributed by Colin Barker. It is true, and it is
...
OEIS A283582 is ``Binary representation of the x-axis, from the origin to the right edge, of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 646", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 11, 101, 1011, 10101, 101011, 1000101, 11011011,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Mar 12 2017: (Start) a(n) = 100*a(n-2) + a(n-8) - 100*a(n-10) for n>11.
\end{quote}
...
pre-period to raise the numerator's degree gives a monic annihilator of order $S=11$.
...
vanish from $n=11+1$ onwards, and the run exceeds $S+10$, which by
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A283582.
