...
\title{The empirical recurrence for OEIS A211444, proved by a one-dimensional reduction}
...
\begin{abstract}
OEIS A211444 counts symmetric $(n+1)\times(n+1)$ matrices over
$\{-7,\dots,7\}$ in which every $2\times2$ subblock sums to zero and has two or three distinct
...
on $S=681$ states, and the empirical recurrence of order $24$ contributed by R.~H.~Hardin
follows.
\end{abstract}
...
OEIS A211444 is ``Number of (n+1)X(n+1) -7..7 symmetric matrices with every 2X2 subblock having sum zero and two or three distinct values.''. It has offset $1$ and begins
\[
112, 294, 656, 1404, 2890, 5896, 11792, 23678,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 16:10:20, revision 8) this is still
...
$S=681$. The two parity classes never mix, so the walk starts by choosing a parity and a first
value, and every state may end a sequence:
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad \tau=\mathbf{1},\qquad S=681.
\]
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) + 11\,a(n-2) - 89\,a(n-3) - 13\,a(n-4) + 684\,a(n-5) - 385\,a(n-6) - 2968\,a(n-7) + 2808\,a(n-8) + 7974\,a(n-9) - 9684\,a(n-10) - 13663\,a(n-11) + 19830\,a(n-12) + 14785\,a(n-13) - 25455\,a(n-14) - 9593\,a(n-15) + 20503\,a(n-16) + 3277\,a(n-17) - 10058\,a(n-18) - 372\,a(n-19) + 2842\,a(n-20) - 58\,a(n-21) - 416\,a(n-22) + 12\,a(n-23) + 24\,a(n-24)
\]
for every $n>24$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A211444.
