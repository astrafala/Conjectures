...
\title{The empirical recurrence for OEIS A063148, proved from an exact model}
...
\begin{abstract}
OEIS A063148 carries an empirical recurrence of order $2$ contributed by R. J. Mathar. It is true, and it is
...
\begin{quote}
Conjecture: a(n) = A063128(n). - \_R. J. Mathar\_, Jul 21 2015
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 22 2019 12:18:12, revision 14)
