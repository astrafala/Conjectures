...
\title{The empirical recurrence for OEIS A315907, proved from an exact model}
...
\begin{abstract}
OEIS A315907 carries an empirical recurrence of order $4$ contributed by R. J. Mathar. It is true, and it is
...
OEIS A315907 is ``Coordination sequence Gal.3.40.3 where Gal.u.t.v denotes the coordination sequence for a vertex of type v in tiling number t in the Galebach list of u-uniform tilings.''. It has offset $0$ and begins
\[
1, 6, 8, 14, 20, 22, 28, 34,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_R. J. Mathar\_, May 02 2023: (Start) a(n) = a(n-1) + a(n-3) - a(n-4) for n > 4.
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 16 2024 15:54:57, revision 11)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A315907.
