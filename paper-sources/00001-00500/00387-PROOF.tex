...
\title{The empirical recurrence for OEIS A267805, proved from an exact model}
...
\begin{abstract}
OEIS A267805 carries an empirical recurrence of order $4$ contributed by Colin Barker. It is true, and it is
...
OEIS A267805 is ``Decimal representation of the n-th iteration of the "Rule 214" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 7, 23, 103, 375, 1639, 6007, 26215,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 22 2016 and Apr 20 2019: (Start) a(n) = 17*a(n-2)-16*a(n-4) for n>3.
\end{quote}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267805.
