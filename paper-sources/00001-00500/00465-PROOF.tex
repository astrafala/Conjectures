...
\title{The empirical recurrence for OEIS A187292, proved from an exact model}
...
\begin{abstract}
OEIS A187292 carries an empirical recurrence of order $3$. It is true, and it is
...
\begin{quote}
Empirical: a(n) = 109360*n\^{}2 - 763776*n + 1206864 for n>11. a(n) = 3*a(n-1) - 3*a(n-2) + a(n-3) for n>14.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 23 2018 08:37:52, revision 11)
...
SHAPE when one is a translate of the other. There are exactly $109360$ shapes: self-avoiding
...
Write $w^\ast$ for the largest bounding-box side over all $109360$ shapes. Once $n\ge w^\ast$
