...
\title{The empirical recurrence for OEIS A263806, proved from an exact model}
...
\begin{abstract}
OEIS A263806 carries an empirical recurrence of order $4$ contributed by Colin Barker. It is true, and it is
...
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 20 2016 and Apr 17 2019: (Start) a(n) = 3*a(n-1)+14*a(n-2)-48*a(n-3)+32*a(n-4) for n>4.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 16 2025 08:33:27, revision 33)
