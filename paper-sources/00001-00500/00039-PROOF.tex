...
\title{The empirical recurrence for OEIS A063141, proved from an exact model}
...
\begin{abstract}
OEIS A063141 carries an empirical recurrence of order $5$ contributed by Colin Barker. It is true, and it is
...
\begin{quote}
Conjectures from \_Colin Barker\_, Jun 10 2019: (Start) a(n) = a(n-2) + a(n-3) - a(n-5) for n>6.
\end{quote}
