...
\title{The empirical recurrence for OEIS A266461, proved from an exact model}
...
\begin{abstract}
OEIS A266461 carries an empirical recurrence of order $6$ contributed by Colin Barker. It is true, and it is
...
\begin{quote}
Conjectures from \_Colin Barker\_, Dec 31 2015 and Apr 16 2019: (Start) a(n) = 19*a(n-2)-50*a(n-4)+32*a(n-6) for n>5.
\end{quote}
