...
\title{The empirical recurrence for OEIS A211820, proved by a one-dimensional reduction}
...
\begin{abstract}
OEIS A211820 counts symmetric $(n+1)\times(n+1)$ matrices over
$\{-10,\dots,10\}$ in which every $2\times2$ subblock sums to zero and has two, three or four distinct
...
on $S=5104$ states, and the empirical recurrence of order $22$ contributed by R.~H.~Hardin
follows.
\end{abstract}
...
OEIS A211820 is ``Number of (n+1)X(n+1) -10..10 symmetric matrices with every 2X2 subblock having sum zero and two, three or four distinct values.''. It has offset $1$ and begins
\[
220, 2310, 24280, 255510, 2692030, 28396180, 299874470, 3170351150,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 16:23:29, revision 8) this is still
...
$S=5104$. The two parity classes never mix, so the walk starts by choosing a parity and a first
value, and every state may end a sequence:
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad \tau=\mathbf{1},\qquad S=5104.
\]
...
\begin{theorem}
\[
a(n)\;=\;114\,a(n-1) - 5925\,a(n-2) + 185345\,a(n-3) - 3877235\,a(n-4) + 56925919\,a(n-5) - 597748066\,a(n-6) + 4472218575\,a(n-7) - 23123238043\,a(n-8) + 76099390938\,a(n-9) - 122330317169\,a(n-10) - 56591154105\,a(n-11) + 427598872995\,a(n-12) + 95124362391\,a(n-13) - 844404272684\,a(n-14) - 1140261335975\,a(n-15) - 728986025396\,a(n-16) - 278757941362\,a(n-17) - 67965466156\,a(n-18) - 10635078240\,a(n-19) - 1030171920\,a(n-20) - 55951200\,a(n-21) - 1296000\,a(n-22)
\]
for every $n>21$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A211820.
