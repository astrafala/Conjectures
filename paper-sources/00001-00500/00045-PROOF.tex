...
\title{The empirical recurrence for OEIS A063087, proved from an exact model}
...
\begin{abstract}
OEIS A063087 carries an empirical recurrence of order $4$ contributed by Wesley Ivan Hurt. It is true, and it is
...
OEIS A063087 is ``Dimension of the space of weight 2n cusp forms for Gamma\_0( 19 ).''. It has offset $1$ and begins
\[
1, 4, 8, 10, 14, 18, 20, 24,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjecture: a(n) = 4*(n-1)-2*floor((n-1)/3) for n > 1. - \_Wesley Ivan Hurt\_, Dec 27 2016 a(n) = a(n-1) + a(n-3) - a(n-4) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 23 2025 00:28:44, revision 22)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A063087.
