...
\title{The empirical recurrence for OEIS A063136, proved from an exact model}
...
\begin{abstract}
OEIS A063136 carries an empirical recurrence of order $2$. It is true, and it is
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 22 2019 12:18:12, revision 17)
