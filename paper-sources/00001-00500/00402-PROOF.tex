...
\title{The empirical recurrence for OEIS A266439, proved from an exact model}
...
\begin{abstract}
OEIS A266439 carries an empirical recurrence of order $4$ contributed by Colin Barker. It is true, and it is
...
OEIS A266439 is ``Number of OFF (white) cells in the n-th iteration of the "Rule 23" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
0, 0, 5, 0, 9, 0, 13, 0,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Dec 30 2015 and Apr 15 2019: (Start) a(n) = 2*a(n-2)-a(n-4) for n>4.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 16 2025 08:33:28, revision 24)
...
For this entry the automaton is rule 23, the period is $p=2$ and the pre-period is $n_0=1$.
The certificate is
\begin{gather*}
r=0:\quad w(n+p) = \varepsilon \cdot w(n) \cdot \texttt{0000} \\
r=1:\quad w(n+p) = \varepsilon \cdot w(n) \cdot \texttt{1111}
\end{gather*}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A266439.
