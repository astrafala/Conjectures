...
\title{The empirical recurrence for OEIS A266976, proved from an exact model}
...
\begin{abstract}
OEIS A266976 carries an empirical recurrence of order $3$ contributed by Colin Barker. It is true, and it is
...
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 08 2016 and Apr 18 2019: (Start) a(n) = 2*a(n-1) + 16*a(n-2) - 32*a(n-3) for n>3.
\end{quote}
