...
\title{The empirical recurrence for OEIS A315950, proved from an exact model}
...
\begin{abstract}
OEIS A315950 carries an empirical recurrence of order $8$ contributed by Chai Wah Wu. It is true, and it is
...
OEIS A315950 is ``Coordination sequence Gal.3.47.3 where Gal.u.t.v denotes the coordination sequence for a vertex of type v in tiling number t in the Galebach list of u-uniform tilings.''. It has offset $0$ and begins
\[
1, 6, 9, 11, 14, 19, 26, 31,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Chai Wah Wu\_, Aug 03 2020: (Start) a(n) = 3*a(n-1) - 5*a(n-2) + 6*a(n-3) - 6*a(n-4) + 6*a(n-5) - 5*a(n-6) + 3*a(n-7) - a(n-8) for n > 8.
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 21 2023 15:11:11, revision 7)
...
the same direction set.) The vertices fall into $24$ orbits under $L$, and a vertex is
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) - 5\,a(n-2) + 6\,a(n-3) - 6\,a(n-4) + 6\,a(n-5) - 5\,a(n-6) + 3\,a(n-7) - a(n-8)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A315950.
