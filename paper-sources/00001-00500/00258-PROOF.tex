...
\title{The empirical recurrence for OEIS A266440, proved from an exact model}
...
\begin{abstract}
OEIS A266440 carries an empirical recurrence of order $5$. It is true, and it is
...
OEIS A266440 is ``Total number of OFF (white) cells after n iterations of the "Rule 23" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
0, 0, 5, 5, 14, 14, 27, 27,\ \dots
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A266440.
