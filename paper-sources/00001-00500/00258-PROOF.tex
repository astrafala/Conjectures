...
\begin{abstract}
OEIS A278756 carries an empirical recurrence of order $6$ contributed by Chai Wah Wu. It is true, and it is
...
\begin{quote}
Conjectures from \_Chai Wah Wu\_, Jun 15 2020: (Start) a(n) = 7*a(n-2) - 14*a(n-4) + 8*a(n-6) for n > 5.
\end{quote}
