...
\title{The empirical recurrence for OEIS A290680, proved from an exact model}
...
\begin{abstract}
OEIS A290680 carries an empirical recurrence of order $2$. It is true, and it is
...
OEIS A290680 is ``Binary representation of the diagonal from the corner to the origin of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 929", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 10, 111, 1110, 11111, 111111, 1111111, 11111111,\ \dots
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A290680.
