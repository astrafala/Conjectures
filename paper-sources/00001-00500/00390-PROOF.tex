...
\title{The empirical recurrence for OEIS A266251, proved from an exact model}
...
\begin{abstract}
OEIS A266251 carries an empirical recurrence of order $4$ contributed by Colin Barker. It is true, and it is
