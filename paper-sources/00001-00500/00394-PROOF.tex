...
\title{The empirical recurrence for OEIS A267677, proved from an exact model}
...
\begin{abstract}
OEIS A267677 carries an empirical recurrence of order $4$ contributed by Colin Barker. It is true, and it is
...
OEIS A267677 is ``Binary representation of the n-th iteration of the "Rule 197" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 10, 10100, 1101000, 111010100, 11110101000, 1111101010100, 111111010101000,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 19 2016 and Apr 20 2019: (Start) a(n) = 110*a(n-1)-999*a(n-2)-110*a(n-3)+1000*a(n-4) for n>5.
\end{quote}
...
For this entry the automaton is rule 197, the period is $p=2$ and the pre-period is $n_0=2$.
The certificate is
\begin{gather*}
r=0:\quad \texttt{11}^{\,j} \cdot \texttt{1} \cdot \texttt{01}^{\,j} \cdot \texttt{0100} \\
r=1:\quad \texttt{11}^{\,j} \cdot \texttt{1} \cdot \texttt{10}^{\,j} \cdot \texttt{101000}
\end{gather*}
...
gives the monic annihilator of order $S=10$ used below.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267677.
