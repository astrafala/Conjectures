...
\title{The empirical recurrence for OEIS A266286, proved from an exact model}
...
\begin{abstract}
OEIS A266286 carries an empirical recurrence of order $4$ contributed by Colin Barker. It is true, and it is
...
OEIS A266286 is ``Number of OFF (white) cells in the n-th iteration of the "Rule 13" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
0, 2, 3, 3, 6, 4, 9, 5,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Dec 28 2015 and Apr 14 2019: (Start) a(n) = 2*a(n-2)-a(n-4) for n>3.
\end{quote}
...
For this entry the automaton is rule 13, the period is $p=2$ and the pre-period is $n_0=0$.
The certificate is
\begin{gather*}
r=0:\quad w(n+p) = \texttt{00} \cdot w(n) \cdot \texttt{01} \\
r=1:\quad w(n+p) = \texttt{11} \cdot w(n) \cdot \texttt{10}
\end{gather*}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A266286.
