...
\title{The empirical recurrence for OEIS A266593, proved from an exact model}
...
\begin{abstract}
OEIS A266593 carries an empirical recurrence of order $4$ contributed by Colin Barker. It is true, and it is
...
OEIS A266593 is ``Number of ON (black) cells in the n-th iteration of the "Rule 37" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 1, 3, 2, 3, 6, 3, 10,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 02 2016 and Apr 18 2019: (Start) a(n) = 2*a(n-2)-a(n-4) for n>5.
\end{quote}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A266593.
