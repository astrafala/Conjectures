...
\title{The empirical recurrence for OEIS A266664, proved from an exact model}
...
\begin{abstract}
OEIS A266664 carries an empirical recurrence of order $4$ contributed by Colin Barker. It is true, and it is
...
OEIS A266664 is ``Number of OFF (white) cells in the n-th iteration of the "Rule 47" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
0, 1, 3, 2, 7, 2, 11, 2,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 03 2016 and Apr 18 2019: (Start) a(n) = 2*a(n-2)-a(n-4) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 16 2025 08:33:28, revision 21)
...
For this entry the automaton is rule 47, the period is $p=2$ and the pre-period is $n_0=2$.
The certificate is
\begin{gather*}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A266664.
