...
\title{The empirical recurrence for OEIS A266661, proved from an exact model}
...
\begin{abstract}
OEIS A266661 carries an empirical recurrence of order $4$ contributed by Colin Barker. It is true, and it is
...
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 03 2016 and Apr 18 2019: (Start) a(n) = 17*a(n-2)-16*a(n-4) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 16 2025 08:33:28, revision 33)
