...
\title{The empirical recurrence for OEIS A267779, proved from an exact model}
...
\begin{abstract}
OEIS A267779 carries an empirical recurrence of order $3$. It is true, and it is
...
OEIS A267779 is ``Binary representation of the n-th iteration of the "Rule 211" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 101, 11001, 1111101, 111111001, 11111111101, 1111111111001, 111111111111101,\ \dots
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267779.
