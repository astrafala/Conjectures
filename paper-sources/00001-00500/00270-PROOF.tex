...
\title{The empirical recurrence for OEIS A282484, proved from an exact model}
...
\begin{abstract}
OEIS A282484 carries an empirical recurrence of order $6$ contributed by Colin Barker. It is true, and it is
...
\[
1, 3, 6, 15, 24, 62, 99, 254,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Feb 18 2017: (Start) a(n) = a(n-2) + 16*a(n-4) - 16*a(n-6) for n>6.
\end{quote}
