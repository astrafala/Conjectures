...
\title{The empirical recurrence for OEIS A211253, proved by a one-dimensional reduction}
...
\begin{abstract}
OEIS A211253 counts symmetric $(n+1)\times(n+1)$ matrices over
$\{-6,\dots,6\}$ in which every $2\times2$ subblock sums to zero and has one or two distinct
...
on $S=35$ states, and the empirical recurrence of order $3$ contributed by R.~H.~Hardin
follows.
\end{abstract}
...
OEIS A211253 is ``Number of (n+1) X (n+1) -6..6 symmetric matrices with every 2 X 2 subblock having sum zero and one or two distinct values.''. It has offset $1$ and begins
\[
21, 29, 41, 61, 93, 145, 229, 365,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) - a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 16 2018 05:22:48, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A211253.
