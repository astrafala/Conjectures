...
\title{The empirical recurrence for OEIS A063157, proved from an exact model}
...
\begin{abstract}
OEIS A063157 carries an empirical recurrence of order $3$ contributed by Colin Barker. It is true, and it is
...
OEIS A063157 is ``Dimension of the space of weight 2n cusp forms for Gamma\_0( 89 ).''. It has offset $1$ and begins
\[
7, 22, 36, 52, 66, 82, 96, 112,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjecture: a(n) = ((-1)\^{}n+30*n-17)/2 for n>1. a(n) = a(n-1)+a(n-2)-a(n-3) for n>4. G.f.: x*(7+15*x+7*x\^{}2+x\^{}3)/((1-x)\^{}2*(1+x)). [\_Colin Barker\_, Sep 26 2012]
\end{quote}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A063157.
