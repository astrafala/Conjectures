...
\title{The empirical recurrence for OEIS A211712, proved by a one-dimensional reduction}
...
\begin{abstract}
OEIS A211712 counts symmetric $(n+1)\times(n+1)$ matrices over
$\{-11,\dots,11\}$ in which every $2\times2$ subblock sums to zero and has one or three distinct
...
on $S=1070$ states, and the empirical recurrence of order $22$ contributed by R.~H.~Hardin
follows.
\end{abstract}
...
OEIS A211712 is ``Number of (n+1)X(n+1) -11..11 symmetric matrices with every 2X2 subblock having sum zero and one or three distinct values.''. It has offset $1$ and begins
\[
231, 537, 1099, 2099, 3997, 7379, 13747, 25335,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 16:18:07, revision 8) this is still
...
that every $2\times2$ subblock has one or three distinct entries.
...
Call two consecutive pairs COMPATIBLE when that number lies in $\{1,3\}$. The condition on the
...
$S=1070$. The two parity classes never mix, so the walk starts by choosing a parity and a first
value, and every state may end a sequence:
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad \tau=\mathbf{1},\qquad S=1070.
\]
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) + 9\,a(n-2) - 80\,a(n-3) + 9\,a(n-4) + 535\,a(n-5) - 425\,a(n-6) - 1941\,a(n-7) + 2321\,a(n-8) + 4142\,a(n-9) - 6337\,a(n-10) - 5243\,a(n-11) + 10073\,a(n-12) + 3703\,a(n-13) - 9603\,a(n-14) - 1139\,a(n-15) + 5360\,a(n-16) - 87\,a(n-17) - 1632\,a(n-18) + 123\,a(n-19) + 238\,a(n-20) - 18\,a(n-21) - 12\,a(n-22)
\]
for every $n>22$.
\end{theorem}
...
$2\times2$ subblock tested for summing to zero and for having one or three distinct entries. The
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A211712.
