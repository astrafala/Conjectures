...
\title{The empirical recurrence for OEIS A063105, proved from an exact model}
...
\begin{abstract}
OEIS A063105 carries an empirical recurrence of order $5$ contributed by Colin Barker. It is true, and it is
...
OEIS A063105 is ``Dimension of the space of weight 2n cusp forms for Gamma\_0( 37 ).''. It has offset $1$ and begins
\[
2, 9, 15, 21, 27, 35, 39, 47,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjecture: a(n) = a(n-2)+a(n-3)-a(n-5) for n>6. G.f.: x*(2 +9*x +13*x\^{}2 +10*x\^{}3 +3*x\^{}4 +x\^{}5)/((1 -x)\^{}2*(1 +x)*(1 +x +x\^{}2)). [\_Colin Barker\_, Sep 27 2012]
\end{quote}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A063105.
