...
\title{The empirical recurrence for OEIS A315187, proved from an exact model}
...
\begin{abstract}
OEIS A315187 carries an empirical recurrence of order $6$ contributed by Chai Wah Wu. It is true, and it is
...
OEIS A315187 is ``Coordination sequence Gal.3.14.3 where Gal.u.t.v denotes the coordination sequence for a vertex of type v in tiling number t in the Galebach list of u-uniform tilings.''. It has offset $0$ and begins
\[
1, 6, 10, 14, 18, 24, 30, 34,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Chai Wah Wu\_, Jul 28 2023: (Start) a(n) = a(n-1) + a(n-5) - a(n-6) for n > 6.
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 21 2023 15:11:07, revision 7)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A315187.
