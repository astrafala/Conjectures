...
\title{The empirical recurrence for OEIS A211331, proved by a one-dimensional reduction}
...
\begin{abstract}
OEIS A211331 counts symmetric $(n+1)\times(n+1)$ matrices over
$\{-5,\dots,5\}$ in which every $2\times2$ subblock sums to zero and has one or three distinct
...
on $S=178$ states, and the empirical recurrence of order $12$ contributed by R.~H.~Hardin
follows.
\end{abstract}
...
OEIS A211331 is ``Number of (n+1) X (n+1) -5..5 symmetric matrices with every 2 X 2 subblock having sum zero and one or three distinct values.''. It has offset $1$ and begins
\[
47, 99, 201, 397, 789, 1531, 2999, 5801,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 17 2018 08:43:13, revision 7) this is still
...
$S=178$. The two parity classes never mix, so the walk starts by choosing a parity and a first
value, and every state may end a sequence:
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad \tau=\mathbf{1},\qquad S=178.
\]
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + 4\,a(n-2) - 32\,a(n-3) + 8\,a(n-4) + 95\,a(n-5) - 60\,a(n-6) - 130\,a(n-7) + 101\,a(n-8) + 81\,a(n-9) - 64\,a(n-10) - 18\,a(n-11) + 12\,a(n-12)
\]
for every $n>12$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A211331.
