...
\title{The empirical recurrence for OEIS A211448, proved by a one-dimensional reduction}
...
\begin{abstract}
OEIS A211448 counts symmetric $(n+1)\times(n+1)$ matrices over
$\{-7,\dots,7\}$ in which every $2\times2$ subblock sums to zero and has two, three or four distinct
...
on $S=838$ states, and the empirical recurrence of order $16$ contributed by R.~H.~Hardin
follows.
\end{abstract}
...
OEIS A211448 is ``Number of (n+1)X(n+1) -7..7 symmetric matrices with every 2X2 subblock having sum zero and two, three or four distinct values.''. It has offset $1$ and begins
\[
112, 842, 6350, 48066, 365098, 2782326, 21268302, 163031330,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 16:10:50, revision 8) this is still
...
$S=838$. The two parity classes never mix, so the walk starts by choosing a parity and a first
value, and every state may end a sequence:
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad \tau=\mathbf{1},\qquad S=838.
\]
...
\begin{theorem}
\[
a(n)\;=\;59\,a(n-1) - 1530\,a(n-2) + 22776\,a(n-3) - 212619\,a(n-4) + 1268503\,a(n-5) - 4641183\,a(n-6) + 8770309\,a(n-7) - 1702416\,a(n-8) - 18846228\,a(n-9) + 5437041\,a(n-10) + 28831259\,a(n-11) + 22145188\,a(n-12) + 8024466\,a(n-13) + 1548672\,a(n-14) + 152856\,a(n-15) + 6048\,a(n-16)
\]
for every $n>15$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A211448.
