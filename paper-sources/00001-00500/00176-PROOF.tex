...
\title{The empirical recurrence for OEIS A267158, proved from an exact model}
...
\begin{abstract}
OEIS A267158 carries an empirical recurrence of order $6$. It is true, and it is
...
pre-period to raise the numerator's degree gives a monic annihilator of order $S=15$. The
