...
\title{The empirical recurrence for OEIS A267352, proved from an exact model}
...
\begin{abstract}
OEIS A267352 carries an empirical recurrence of order $4$ contributed by Colin Barker. It is true, and it is
...
OEIS A267352 is ``Number of ON (black) cells in the n-th iteration of the "Rule 123" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 2, 3, 6, 3, 10, 3, 14,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 14 2016: (Start) a(n) = 2*a(n-2)-a(n-4) for n>4.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 16 2025 08:33:29, revision 17)
...
For this entry the automaton is rule 123, the period is $p=2$ and the pre-period is $n_0=1$.
The certificate is
\begin{gather*}
...
First, the model reproduces all $71$ terms the entry publishes, exactly, in integer
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267352.
