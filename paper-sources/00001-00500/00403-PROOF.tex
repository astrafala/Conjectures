...
\title{The empirical recurrence for OEIS A266437, proved from an exact model}
...
\begin{abstract}
OEIS A266437 carries an empirical recurrence of order $4$ contributed by Michael De Vlieger. It is true, and it is
...
\[
1, 3, 0, 7, 0, 11, 0, 15,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical g.f.: (1 + 3*x - 2*x\^{}2 + x\^{}3 + x\^{}4)/(-1 + x\^{}2)\^{}2. - \_Michael De Vlieger\_, Dec 29 2015 a(n) = 2*a(n-2)-a(n-4) for n>4.
\end{quote}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A266437.
