...
\title{The empirical recurrence for OEIS A280371, proved from an exact model}
...
\begin{abstract}
OEIS A280371 carries an empirical recurrence of order $4$ contributed by Colin Barker. It is true, and it is
...
\[
1, 10, 101, 1000, 10000, 101000, 1010100, 10000010,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 02 2017: (Start) a(n) = 10000*a(n-4) for n>3.
\end{quote}
