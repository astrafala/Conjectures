...
\title{The empirical recurrence for OEIS A266795, proved from an exact model}
...
\begin{abstract}
OEIS A266795 carries an empirical recurrence of order $5$ contributed by Colin Barker. It is true, and it is
...
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 04 2016 and Apr 17 2019: (Start) a(n) = a(n-1)+2*a(n-2)-2*a(n-3)-a(n-4)+a(n-5) for n>8.
\end{quote}
