...
\title{The empirical recurrence for OEIS A211256, proved by a one-dimensional reduction}
...
\begin{abstract}
OEIS A211256 counts symmetric $(n+1)\times(n+1)$ matrices over
$\{-6,\dots,6\}$ in which every $2\times2$ subblock sums to zero and has two or three distinct
...
on $S=497$ states, and the empirical recurrence of order $18$ contributed by R.~H.~Hardin
follows.
\end{abstract}
...
OEIS A211256 is ``Number of (n+1)X(n+1) -6..6 symmetric matrices with every 2X2 subblock having sum zero and two or three distinct values.''. It has offset $1$ and begins
\[
84, 218, 482, 1036, 2134, 4382, 8810, 17818,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 16:08:57, revision 8) this is still
...
$S=497$. The two parity classes never mix, so the walk starts by choosing a parity and a first
value, and every state may end a sequence:
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad \tau=\mathbf{1},\qquad S=497.
\]
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + 10\,a(n-2) - 56\,a(n-3) - 24\,a(n-4) + 321\,a(n-5) - 83\,a(n-6) - 968\,a(n-7) + 584\,a(n-8) + 1640\,a(n-9) - 1342\,a(n-10) - 1543\,a(n-11) + 1518\,a(n-12) + 750\,a(n-13) - 868\,a(n-14) - 166\,a(n-15) + 236\,a(n-16) + 12\,a(n-17) - 24\,a(n-18)
\]
for every $n>18$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A211256.
