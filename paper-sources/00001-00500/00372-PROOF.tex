...
\title{The empirical recurrence for OEIS A267274, proved from an exact model}
...
\begin{abstract}
OEIS A267274 carries an empirical recurrence of order $4$ contributed by Colin Barker. It is true, and it is
...
OEIS A267274 is ``Decimal representation of the n-th iteration of the "Rule 117" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 3, 24, 31, 384, 511, 6144, 8191,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 14 2016 and Apr 19 2019: (Start) a(n) = 17*a(n-2)-16*a(n-4) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 13 2025 14:43:36, revision 29)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267274.
