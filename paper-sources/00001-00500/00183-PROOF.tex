...
\begin{abstract}
OEIS A267042 carries an empirical recurrence of order $6$ contributed by Colin Barker. It is true, and it is
...
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 10 2016: (Start) a(n) = 21*a(n-2)-84*a(n-4)+64*a(n-6) for n>8.
\end{quote}
