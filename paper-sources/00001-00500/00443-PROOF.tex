...
\title{The empirical recurrence for OEIS A187302, proved from an exact model}
...
\begin{abstract}
OEIS A187302 carries an empirical recurrence of order $3$. It is true, and it is
...
\begin{quote}
Empirical: a(n) = 2776*n\^{}2 - 19580*n + 30728 for n>11. a(n) = 3*a(n-1) - 3*a(n-2) + a(n-3) for n>14.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 23 2018 14:27:36, revision 10)
...
SHAPE when one is a translate of the other. There are exactly $2776$ shapes: self-avoiding
...
Write $w^\ast$ for the largest bounding-box side over all $2776$ shapes. Once $n\ge w^\ast$
