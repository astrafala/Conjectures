...
\title{The empirical recurrence for OEIS A266612, proved from an exact model}
...
\begin{abstract}
OEIS A266612 carries an empirical recurrence of order $3$ contributed by Colin Barker. It is true, and it is
...
OEIS A266612 is ``Binary representation of the middle column of the "Rule 41" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 10, 101, 1010, 10100, 101001, 1010010, 10100101,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 02 2016 and Apr 17 2019: (Start) a(n) = 10*a(n-1)+a(n-2)-10*a(n-3) for n>2.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 16 2025 08:33:28, revision 35)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A266612.
