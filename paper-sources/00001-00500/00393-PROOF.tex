...
\title{The empirical recurrence for OEIS A263805, proved from an exact model}
...
\begin{abstract}
OEIS A263805 carries an empirical recurrence of order $4$ contributed by Colin Barker. It is true, and it is
...
OEIS A263805 is ``Binary representation of the n-th iteration of the "Rule 157" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 11, 111, 101111, 1011111, 1010111111, 10101111111, 10101011111111,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 20 2016 and Apr 17 2019: (Start) a(n) = 11*a(n-1)+9990*a(n-2)-110000*a(n-3)+100000*a(n-4) for n>4.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 16 2025 08:33:27, revision 30)
...
For this entry the automaton is rule 157, the period is $p=2$ and the pre-period is $n_0=1$.
The certificate is
\begin{gather*}
r=0:\quad \texttt{01}^{\,j} \cdot \texttt{0} \cdot \texttt{11}^{\,j} \cdot \texttt{11} \\
r=1:\quad \texttt{0} \cdot \texttt{01}^{\,j} \cdot \texttt{0} \cdot \texttt{11}^{\,j} \cdot \texttt{111}
\end{gather*}
...
\begin{theorem}
\[
a(n)\;=\;11\,a(n-1) + 9990\,a(n-2) - 110000\,a(n-3) + 100000\,a(n-4)
\]
for every $n>4$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A263805.
