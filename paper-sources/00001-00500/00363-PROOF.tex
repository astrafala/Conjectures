...
\begin{abstract}
OEIS A280373 carries an empirical recurrence of order $4$ contributed by Colin Barker. It is true, and it is
...
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 02 2017: (Start) a(n) = 16*a(n-4) for n>3.
\end{quote}
