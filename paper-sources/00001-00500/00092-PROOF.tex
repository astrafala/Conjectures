...
\title{The empirical recurrence for OEIS A063160, proved from an exact model}
...
\begin{abstract}
OEIS A063160 carries an empirical recurrence of order $2$ contributed by Colin Barker. It is true, and it is
...
\begin{quote}
Conjectures from \_Colin Barker\_, Jun 11 2019: (Start) a(n) = 2*a(n-1) - a(n-2) for n>3.
\end{quote}
...
First, the model reproduces all $48$ terms the entry publishes, exactly, in integer
