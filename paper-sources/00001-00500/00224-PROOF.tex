...
\title{The empirical recurrence for OEIS A289098, proved from an exact model}
...
\begin{abstract}
OEIS A289098 carries an empirical recurrence of order $3$. It is true, and it is
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 05 2025 15:22:40, revision 21)
