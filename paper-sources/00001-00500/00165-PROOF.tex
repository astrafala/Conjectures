...
\title{The empirical recurrence for OEIS A211496, proved by a one-dimensional reduction}
...
\begin{abstract}
OEIS A211496 counts symmetric $(n+1)\times(n+1)$ matrices over
$\{-4,\dots,4\}$ in which every $2\times2$ subblock sums to zero and has one, three or four distinct
...
on $S=35$ states, and the empirical recurrence of order $13$ contributed by R.~H.~Hardin
follows.
\end{abstract}
...
OEIS A211496 is ``Number of (n+1)X(n+1) -4..4 symmetric matrices with every 2X2 subblock having sum zero and one, three or four distinct values.''. It has offset $1$ and begins
\[
29, 105, 385, 1437, 5353, 19901, 73617, 271149,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 16:12:20, revision 8) this is still
...
$S=35$. The two parity classes never mix, so the walk starts by choosing a parity and a first
value, and every state may end a sequence:
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad \tau=\mathbf{1},\qquad S=35.
\]
...
\begin{theorem}
\[
a(n)\;=\;12\,a(n-1) - 36\,a(n-2) - 86\,a(n-3) + 557\,a(n-4) - 82\,a(n-5) - 2844\,a(n-6) + 1812\,a(n-7) + 6764\,a(n-8) - 4000\,a(n-9) - 7184\,a(n-10) + 1824\,a(n-11) + 1408\,a(n-12) - 384\,a(n-13)
\]
for every $n>12$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A211496.
