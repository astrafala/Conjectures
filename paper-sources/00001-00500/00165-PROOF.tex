...
\title{The empirical recurrence for OEIS A284940, proved from an exact model}
...
\begin{abstract}
OEIS A284940 carries an empirical recurrence of order $6$. It is true, and it is
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 05 2025 15:22:38, revision 23)
