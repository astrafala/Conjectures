...
\title{The empirical recurrence for OEIS A187591, proved from an exact model}
...
\begin{abstract}
OEIS A187591 carries an empirical recurrence of order $3$. It is true, and it is
...
OEIS A187591 is ``Number of 8-step E, S, NW and NE-moving king's tours on an n X n board summed over all starting positions.''. It has offset $1$ and begins
\[
0, 0, 34, 2309, 15056, 45718, 95776, 164135,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 8819*n\^{}2 - 63926*n + 111127 for n>6. a(n) = 3*a(n-1) - 3*a(n-2) + a(n-3) for n>9.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 24 2018 23:15:31, revision 11)
...
SHAPE when one is a translate of the other. There are exactly $8819$ shapes: self-avoiding
...
Write $w^\ast$ for the largest bounding-box side over all $8819$ shapes. Once $n\ge w^\ast$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A187591.
