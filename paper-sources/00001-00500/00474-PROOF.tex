...
\title{The empirical recurrence for OEIS A187049, proved from an exact model}
...
\begin{abstract}
OEIS A187049 carries an empirical recurrence of order $3$. It is true, and it is
...
OEIS A187049 is ``Number of 5-step one or two space at a time bishop's tours on an n X n board summed over all starting positions.''. It has offset $1$ and begins
\[
0, 0, 8, 456, 2896, 9216, 20648, 37472,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2540*n\^{}2 - 21128*n + 43936 for n>7. a(n) = 3*a(n-1) - 3*a(n-2) + a(n-3) for n>10.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 20 2018 10:05:11, revision 11)
...
SHAPE when one is a translate of the other. There are exactly $2540$ shapes: self-avoiding
...
Write $w^\ast$ for the largest bounding-box side over all $2540$ shapes. Once $n\ge w^\ast$
...
annihilates $a$ from $n=8$ onwards, and the annihilator in force on the whole sequence is
$z^{9}(z-1)^{3}$, monic of order $S=12$. Both numbers are read off the enumerated
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A187049.
