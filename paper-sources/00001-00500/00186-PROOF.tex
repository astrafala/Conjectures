...
\title{The empirical recurrence for OEIS A266838, proved from an exact model}
...
\begin{abstract}
OEIS A266838 carries an empirical recurrence of order $6$ contributed by Karl V. Keller, Jr.. It is true, and it is
...
OEIS A266838 is ``Binary representation of the n-th iteration of the "Rule 67" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 100, 1010, 1100001, 1011100, 11100001011, 1011100000, 111100001011111,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 16 2025 08:33:28, revision 25)
...
pre-period to raise the numerator's degree gives a monic annihilator of order $S=12$. The
...
\begin{theorem}
\[
a(n)\;=\;11001\,a(n-2) - 10011000\,a(n-4) + 10000000\,a(n-6)
\]
for every $n>9$.
\end{theorem}
...
vanish from $n=9+1$ onwards, and the run exceeds $S+6$, which by
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A266838.
