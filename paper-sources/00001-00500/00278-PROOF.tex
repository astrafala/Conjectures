...
\title{The empirical recurrence for OEIS A282415, proved from an exact model}
...
\begin{abstract}
OEIS A282415 carries an empirical recurrence of order $6$ contributed by Colin Barker. It is true, and it is
...
\[
1, 10, 11, 1100, 111, 111000, 1111, 11110000,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Feb 15 2017: (Start) a(n) = 111*a(n-2) - 1110*a(n-4) + 1000*a(n-6) for n>5.
\end{quote}
