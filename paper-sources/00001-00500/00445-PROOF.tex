...
\title{The empirical recurrence for OEIS A229101, proved by transfer matrix}
...
\begin{abstract}
OEIS A229101 counts the distinct arrays obtained by applying a fixed local operation to every cell
...
$S=81$ states, after which the conjectured recurrence is settled by a finite exact
computation.
\end{abstract}
...
OEIS A229101 is ``Number of nX2 0..3 arrays of the median of the corresponding element, the element to the east and the element to the south in a larger (n+1)X3 0..3 array.''. It has offset $1$ and begins
\[
16, 256, 4096, 63248, 974864, 14988504, 230263568, 3535340280,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 13 2013 19:58:44, revision 10) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

Let $R$ be the set of rows of length $3$ over $\{0,\dots,3\}$.
...
\]
There are $S=81$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite.
...
\begin{theorem}
\[
a(n)\;=\;24\,a(n-1) - 102\,a(n-2) - 630\,a(n-3) + 2225\,a(n-4) + 3688\,a(n-5) - 15447\,a(n-6) + 8430\,a(n-7) + 6782\,a(n-8) - 50498\,a(n-9) + 142526\,a(n-10) - 83300\,a(n-11) + 100982\,a(n-12) + 17088\,a(n-13) - 191175\,a(n-14) + 227608\,a(n-15) - 319996\,a(n-16) + 234150\,a(n-17) - 159273\,a(n-18) + 89270\,a(n-19) - 31661\,a(n-20) + 14112\,a(n-21) - 2156\,a(n-22) + 784\,a(n-23)
\]
for every $n>23$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A229101.
