...
\title{The empirical recurrence for OEIS A290682, proved from an exact model}
...
\begin{abstract}
OEIS A290682 carries an empirical recurrence of order $2$ contributed by Colin Barker. It is true, and it is
...
OEIS A290682 is ``Decimal representation of the diagonal from the corner to the origin of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 929", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 2, 7, 14, 31, 63, 127, 255,\ \dots
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A290682.
