...
\begin{abstract}
OEIS A284482 carries an empirical recurrence of order $5$ contributed by Colin Barker. It is true, and it is
...
\begin{quote}
Conjectures from \_Colin Barker\_, Mar 28 2017: (Start) a(n) = 2*a(n-1) + a(n-4) - 2*a(n-5) for n>5.
\end{quote}
