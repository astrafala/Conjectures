...
\begin{abstract}
OEIS A267138 carries an empirical recurrence of order $6$ contributed by Colin Barker. It is true, and it is
...
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 11 2016 and Apr 19 2019: (Start) a(n) = 10011*a(n-2) - 110010*a(n-4) + 100000*a(n-6) for n > 10.
\end{quote}
