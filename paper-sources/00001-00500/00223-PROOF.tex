...
\begin{abstract}
OEIS A281214 carries an empirical recurrence of order $6$ contributed by Colin Barker. It is true, and it is
...
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 18 2017: (Start) a(n) = 100*a(n-2) + a(n-4) - 100*a(n-6) for n>5.
\end{quote}
