...
\title{The empirical recurrence for OEIS A283646, proved from an exact model}
...
\begin{abstract}
OEIS A283646 carries an empirical recurrence of order $10$. It is true, and it is
...
OEIS A283646 is ``Decimal representation of the x-axis, from the left edge to the origin, of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 694", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 3, 5, 13, 21, 53, 93, 205,\ \dots
\]
...
\begin{theorem}
\[
a(n)\;=\;a(n-2) + 256\,a(n-8) - 256\,a(n-10)
\]
for every $n>15$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A283646.
