...
\begin{abstract}
OEIS A283584 carries an empirical recurrence of order $10$ contributed by Colin Barker. It is true, and it is
...
\begin{quote}
Conjectures from \_Colin Barker\_, Mar 12 2017: (Start) a(n) = 4*a(n-2) + a(n-8) - 4*a(n-10) for n>11.
\end{quote}
