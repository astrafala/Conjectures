...
\begin{abstract}
OEIS A267058 carries an empirical recurrence of order $6$ contributed by Colin Barker. It is true, and it is
...
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 10 2016 and Apr 19 2019: (Start) a(n) = a(n-2)+256*a(n-4)-256*a(n-6) for n>5.
\end{quote}
