...
\title{The empirical recurrence for OEIS A229641, proved by counting defective colourings}
...
\begin{abstract}
OEIS A229641 counts the colourings of an array with $K=3$ colours that are proper except at
...
numbers. What is left is a walk count on $S=828$ vertices, and the empirical recurrence of
order $30$ contributed by R.~H.~Hardin follows from a finite exact computation.
\end{abstract}
...
OEIS A229641 is ``Number of defective 3-colorings of a 5 X n 0..2 array connected horizontally, diagonally and antidiagonally with exactly two mistakes, and colors introduced in row-major 0..2 order.''. It has offset $1$ and begins
\[
0, 925, 8800, 89331, 960325, 9722206, 98015235, 960209886,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 28 2021 01:22:57, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;18\,a(n-1) - 15\,a(n-2) - 1191\,a(n-3) + 3468\,a(n-4) + 31983\,a(n-5) - 108707\,a(n-6) - 424479\,a(n-7) + 1614489\,a(n-8) + 2851598\,a(n-9) - 13478352\,a(n-10) - 7797810\,a(n-11) + 66347438\,a(n-12) - 12632640\,a(n-13) - 190067859\,a(n-14) + 147888798\,a(n-15) + 287096430\,a(n-16) - 412178619\,a(n-17) - 138135927\,a(n-18) + 522690894\,a(n-19) - 168525432\,a(n-20) - 273411640\,a(n-21) + 227616084\,a(n-22) + 9610272\,a(n-23) - 73617984\,a(n-24) + 21460464\,a(n-25) + 7359984\,a(n-26) - 4611168\,a(n-27) + 186624\,a(n-28) + 279936\,a(n-29) - 46656\,a(n-30)
\end{equation}
for all $n>33$.
...
Assembling the $3$ chains block-diagonally into $N$ of size $S=828$ with the weights of
...
\qquad w=h_{30}-\sum_i c_ih_{30-i} .
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A229641.
