...
\title{The empirical recurrence for OEIS A267855, proved from an exact model}
...
\begin{abstract}
OEIS A267855 carries an empirical recurrence of order $6$ contributed by Colin Barker. It is true, and it is
...
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 21 2016 and Apr 17 2019: (Start) a(n) = 16*a(n-2)+16*a(n-4)-256*a(n-6) for n>5.
\end{quote}
