...
\title{The empirical recurrence for OEIS A266718, proved from an exact model}
...
\begin{abstract}
OEIS A266718 carries an empirical recurrence of order $6$ contributed by Colin Barker. It is true, and it is
...
OEIS A266718 is ``Decimal representation of the n-th iteration of the "Rule 59" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 5, 6, 123, 12, 2039, 24, 32751,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 04 2016 and Apr 18 2019: (Start) a(n) = 19*a(n-2)-50*a(n-4)+32*a(n-6) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 16 2025 08:33:28, revision 32)
...
\begin{theorem}
\[
a(n)\;=\;19\,a(n-2) - 50\,a(n-4) + 32\,a(n-6)
\]
for every $n>6$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A266718.
