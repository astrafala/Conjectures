...
\title{The empirical recurrence for OEIS A267775, proved from an exact model}
...
\begin{abstract}
OEIS A267775 carries an empirical recurrence of order $3$. It is true, and it is
...
OEIS A267775 is ``Binary representation of the n-th iteration of the "Rule 207" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 110, 11101, 1111011, 111110111, 11111101111, 1111111011111, 111111110111111,\ \dots
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267775.
