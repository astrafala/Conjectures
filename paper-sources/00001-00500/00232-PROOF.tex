...
\title{The empirical recurrence for OEIS A282653, proved from an exact model}
...
\begin{abstract}
OEIS A282653 carries an empirical recurrence of order $6$ contributed by Colin Barker. It is true, and it is
...
\[
1, 10, 111, 10, 11111, 10, 1111111, 100010,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Feb 20 2017: (Start) a(n) = 100*a(n-2) + a(n-4) - 100*a(n-6) for n>5.
\end{quote}
