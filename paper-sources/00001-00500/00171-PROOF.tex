...
\title{The empirical recurrence for OEIS A267160, proved from an exact model}
...
\begin{abstract}
OEIS A267160 carries an empirical recurrence of order $6$ contributed by Colin Barker. It is true, and it is
...
OEIS A267160 is ``Number of OFF (white) cells in the n-th iteration of the "Rule 107" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
0, 2, 2, 2, 3, 3, 6, 2,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 11 2016 and Apr 19 2019: (Start) a(n) = a(n-2)+a(n-4)-a(n-6) for n>11.
\end{quote}
...
vanish from $n=12+1$ onwards, and the run exceeds $S+6$, which by
...
First, the model reproduces all $72$ terms the entry publishes, exactly, in integer
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267160.
