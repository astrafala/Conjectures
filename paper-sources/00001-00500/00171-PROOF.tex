...
\title{The empirical recurrence for OEIS A279878, proved from an exact model}
...
\begin{abstract}
OEIS A279878 carries an empirical recurrence of order $6$. It is true, and it is
...
OEIS A279878 is ``Binary representation of the x-axis, from the origin to the right edge, of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 213", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 1, 10, 11, 11100, 111, 1111000, 1111,\ \dots
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A279878.
