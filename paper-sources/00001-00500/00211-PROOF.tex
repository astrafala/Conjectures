...
\title{The empirical recurrence for OEIS A266614, proved from an exact model}
...
\begin{abstract}
OEIS A266614 carries an empirical recurrence of order $6$. It is true, and it is
...
OEIS A266614 is ``Number of ON (black) cells in the n-th iteration of the "Rule 41" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 0, 2, 3, 1, 8, 2, 11,\ \dots
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A266614.
