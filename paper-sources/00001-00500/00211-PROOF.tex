...
\title{The empirical recurrence for OEIS A267211, proved from an exact model}
...
\begin{abstract}
OEIS A267211 carries an empirical recurrence of order $7$ contributed by Colin Barker. It is true, and it is
...
OEIS A267211 is ``Number of ON (black) cells in the n-th iteration of the "Rule 109" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 1, 5, 2, 7, 7, 10, 5,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 13 2016: (Start) a(n) = a(n-3)+a(n-4)-a(n-7) for n>7.
\end{quote}
...
vanish from $n=7+1$ onwards, and the run exceeds $S+7$, which by
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267211.
