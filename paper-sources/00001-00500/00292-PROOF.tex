...
\title{The empirical recurrence for OEIS A267613, proved from an exact model}
...
\begin{abstract}
OEIS A267613 carries an empirical recurrence of order $2$. It is true, and it is
...
OEIS A267613 is ``Binary representation of the n-th iteration of the "Rule 185" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 1, 1011, 101111, 10111111, 1011111111, 101111111111, 10111111111111,\ \dots
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267613.
