...
\title{The empirical recurrence for OEIS A266222, proved from an exact model}
...
\begin{abstract}
OEIS A266222 carries an empirical recurrence of order $4$. It is true, and it is
...
OEIS A266222 is ``Number of OFF (white) cells in the n-th iteration of the "Rule 7" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
0, 1, 5, 0, 9, 0, 13, 0,\ \dots
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A266222.
