...
\title{The empirical recurrence for OEIS A283587, proved by transfer matrix}
...
\begin{abstract}
OEIS A283587 carries an empirical recurrence of order $9$ contributed by R.~H.~Hardin. It is
...
OEIS A283587 is ``Decimal representation of the x-axis, from the left edge to the origin, of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 654", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A283587.
