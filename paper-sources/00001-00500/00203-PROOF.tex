...
\title{The empirical recurrence for OEIS A267854, proved from an exact model}
...
\begin{abstract}
OEIS A267854 carries an empirical recurrence of order $6$ contributed by Colin Barker. It is true, and it is
...
OEIS A267854 is ``Binary representation of the n-th iteration of the "Rule 230" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 110, 10100, 1111000, 101110000, 11101100000, 1011101000000, 111011110000000,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 21 2016 and Apr 20 2019: (Start) a(n) = 10000*a(n-2)+10000*a(n-4)-100000000*a(n-6) for n>5.
\end{quote}
...
pre-period to raise the numerator's degree gives a monic annihilator of order $S=18$. The
...
\begin{theorem}
\[
a(n)\;=\;10000\,a(n-2) + 10000\,a(n-4) - 100000000\,a(n-6)
\]
for every $n>0$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267854.
