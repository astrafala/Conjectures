...
\title{The empirical recurrence for OEIS A266787, proved from an exact model}
...
\begin{abstract}
OEIS A266787 carries an empirical recurrence of order $6$ contributed by Colin Barker. It is true, and it is
...
OEIS A266787 is ``Binary representation of the n-th iteration of the "Rule 61" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 11, 1100, 1010111, 1111000, 11010001111, 1111010000, 111010001111111,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 03 2016 and Apr 18 2019: (Start) a(n) = 11001*a(n-2)-10011000*a(n-4)+10000000*a(n-6) for n>10.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 16 2025 08:33:28, revision 34)
...
pre-period to raise the numerator's degree gives a monic annihilator of order $S=13$. The
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A266787.
