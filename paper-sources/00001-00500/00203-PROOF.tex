...
\title{The empirical recurrence for OEIS A266670, proved from an exact model}
...
\begin{abstract}
OEIS A266670 carries an empirical recurrence of order $6$ contributed by Colin Barker. It is true, and it is
...
OEIS A266670 is ``Binary representation of the n-th iteration of the "Rule 53" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 11, 1000, 1011111, 1000000, 11011111111, 1000000000, 111011111111111,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 03 2016 and Apr 16 2019: (Start) a(n) = 11001*a(n-2) - 10011000*a(n-4) + 10000000*a(n-6) for n>5.
\end{quote}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A266670.
