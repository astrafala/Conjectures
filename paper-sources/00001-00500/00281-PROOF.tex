...
\title{The empirical recurrence for OEIS A267456, proved from an exact model}
...
\begin{abstract}
OEIS A267456 carries an empirical recurrence of order $4$ contributed by Colin Barker. It is true, and it is
...
\[
1, 10, 100, 1000, 1010100, 10101000, 10101010100, 101010101000,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 15 2016 and Apr 19 2019: (Start) a(n) = 10001*a(n-2) - 10000*a(n-4) for n > 5.
\end{quote}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267456.
