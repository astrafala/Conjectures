...
\title{The empirical recurrence for OEIS A063128, proved from an exact model}
...
\begin{abstract}
OEIS A063128 carries an empirical recurrence of order $2$ contributed by Colin Barker. It is true, and it is
