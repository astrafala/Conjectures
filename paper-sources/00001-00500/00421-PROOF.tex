...
\title{The empirical recurrence for OEIS A266073, proved from an exact model}
...
\begin{abstract}
OEIS A266073 carries an empirical recurrence of order $4$ contributed by Michael De Vlieger. It is true, and it is
...
OEIS A266073 is ``Number of OFF (white) cells in the n-th iteration of the "Rule 3" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
0, 2, 4, 2, 8, 2, 12, 2,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical g.f.: (-2*(-x - 2*x\^{}2 + x\^{}3))/(-1 + x\^{}2)\^{}2. - \_Michael De Vlieger\_, Dec 21 2015 a(n) = 2*a(n-2) - a(n-4) for n>3.
\end{quote}
...
For this entry the automaton is rule 3, the period is $p=2$ and the pre-period is $n_0=0$.
The certificate is
\begin{gather*}
...
annihilator of order $S=6$ used below.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A266073.
