...
\title{The empirical recurrence for OEIS A267884, proved from an exact model}
...
\begin{abstract}
OEIS A267884 carries an empirical recurrence of order $1$. It is true, and it is
...
OEIS A267884 is ``Total number of OFF (white) cells after n iterations of the "Rule 233" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
0, 3, 5, 6, 6, 6, 6, 6,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
(the empirical recurrence quoted in the entry)
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 24 2025 12:30:54, revision 22)
...
$q(z)=z^{1}-\sum_ic_iz^{1-i}$ the characteristic polynomial of the conjectured
...
vanish from $n=3+1$ onwards, and the run exceeds $S+1$, which by
...
First, the model reproduces all $86$ terms the entry publishes, exactly, in integer
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267884.
