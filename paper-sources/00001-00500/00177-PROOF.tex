...
\title{The empirical recurrence for OEIS A283583, proved from an exact model}
...
\begin{abstract}
OEIS A283583 carries an empirical recurrence of order $10$ contributed by Colin Barker. It is true, and it is
...
\[
1, 3, 5, 13, 21, 53, 81, 219,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Mar 12 2017: (Start) a(n) = a(n-2) + 256*a(n-8) - 256*a(n-10) for n>11.
\end{quote}
