...
\title{The empirical recurrence for OEIS A063125, proved from an exact model}
...
\begin{abstract}
OEIS A063125 carries an empirical recurrence of order $4$ contributed by Colin Barker. It is true, and it is
...
\begin{quote}
Conjectures from \_Colin Barker\_, Jun 10 2019: (Start) a(n) = a(n-1) + a(n-3) - a(n-4) for n>5.
\end{quote}
