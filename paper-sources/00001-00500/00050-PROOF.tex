...
\title{The empirical recurrence for OEIS A063142, proved from an exact model}
...
\begin{abstract}
OEIS A063142 carries an empirical recurrence of order $3$. It is true, and it is
...
OEIS A063142 is ``Dimension of the space of weight 2n cusp forms for Gamma\_0( 74 ).''. It has offset $1$ and begins
\[
8, 27, 45, 65, 83, 103, 121, 141,\ \dots
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A063142.
