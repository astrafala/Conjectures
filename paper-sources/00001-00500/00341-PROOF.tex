...
\title{The empirical recurrence for OEIS A267774, proved from an exact model}
...
\begin{abstract}
OEIS A267774 carries an empirical recurrence of order $3$ contributed by Colin Barker. It is true, and it is
...
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 20 2016 and Apr 20 2019: (Start) a(n) = 7*a(n-1)-14*a(n-2)+8*a(n-3) for n>3.
\end{quote}
