...
\title{The empirical recurrence for OEIS A265724, proved from an exact model}
...
\begin{abstract}
OEIS A265724 carries an empirical recurrence of order $5$ contributed by Colin Barker. It is true, and it is
...
\begin{quote}
Conjectures from \_Colin Barker\_, Dec 16 2015 and Apr 16 2019: (Start) a(n) = a(n-1) + 2*a(n-2) - 2*a(n-3) - a(n-4) + a(n-5) for n>4.
\end{quote}
