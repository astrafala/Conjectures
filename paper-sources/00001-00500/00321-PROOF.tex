...
\title{The empirical recurrence for OEIS A290413, proved from an exact model}
...
\begin{abstract}
OEIS A290413 carries an empirical recurrence of order $5$ contributed by Colin Barker. It is true, and it is
...
\[
1, 1, 101, 111, 10011, 111111, 111, 11111111,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Jul 31 2017: (Start) a(n) = a(n-1) + 110*a(n-2) - 110*a(n-3) - 1000*a(n-4) + 1000*a(n-5) for n>6.
\end{quote}
