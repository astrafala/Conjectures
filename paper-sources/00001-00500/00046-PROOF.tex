...
\title{The empirical recurrence for OEIS A063102, proved from an exact model}
...
\begin{abstract}
OEIS A063102 carries an empirical recurrence of order $3$. It is true, and it is
...
OEIS A063102 is ``Dimension of the space of weight 2n cusp forms for Gamma\_0( 34 ).''. It has offset $1$ and begins
\[
3, 12, 20, 30, 38, 48, 56, 66,\ \dots
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A063102.
