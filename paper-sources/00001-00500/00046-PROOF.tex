...
\title{The empirical recurrence for OEIS A315418, proved from an exact model}
...
\begin{abstract}
OEIS A315418 carries an empirical recurrence of order $6$ contributed by Chai Wah Wu. It is true, and it is
...
OEIS A315418 is ``Coordination sequence Gal.3.21.3 where Gal.u.t.v denotes the coordination sequence for a vertex of type v in tiling number t in the Galebach list of u-uniform tilings.''. It has offset $0$ and begins
\[
1, 6, 11, 15, 20, 26, 32, 37,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Chai Wah Wu\_, Jul 10 2025: (Start) a(n) = a(n-1) + a(n-5) - a(n-6) for n > 6.
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 11 2025 08:49:12, revision 10)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A315418.
