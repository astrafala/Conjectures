...
\title{The empirical recurrence for OEIS A187853, proved from an exact model}
...
\begin{abstract}
OEIS A187853 carries an empirical recurrence of order $3$. It is true, and it is
...
OEIS A187853 is ``Number of 5-step king-knight's tours (piece capable of both kinds of moves) on an n X n board summed over all starting positions.''. It has offset $1$ and begins
\[
0, 0, 5328, 49776, 177040, 408048, 744696, 1183632,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 50128*n\^{}2 - 312688*n + 476944 for n>7. a(n) = 3*a(n-1) - 3*a(n-2) + a(n-3) for n>10.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 26 2018 08:38:32, revision 10)
...
SHAPE when one is a translate of the other. There are exactly $50128$ shapes: self-avoiding
...
Write $w^\ast$ for the largest bounding-box side over all $50128$ shapes. Once $n\ge w^\ast$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A187853.
