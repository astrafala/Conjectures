...
\title{The empirical recurrence for OEIS A063099, proved from an exact model}
...
\begin{abstract}
OEIS A063099 carries an empirical recurrence of order $4$ contributed by Colin Barker. It is true, and it is
...
OEIS A063099 is ``Dimension of the space of weight 2n cusp forms for Gamma\_0( 31 ).''. It has offset $1$ and begins
\[
2, 7, 13, 17, 23, 29, 33, 39,\ \dots
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A063099.
