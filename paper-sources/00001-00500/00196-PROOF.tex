...
\title{The empirical recurrence for OEIS A266717, proved from an exact model}
...
\begin{abstract}
OEIS A266717 carries an empirical recurrence of order $6$. It is true, and it is
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 16 2025 08:33:28, revision 36)
