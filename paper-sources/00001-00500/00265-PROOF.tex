...
\title{The empirical recurrence for OEIS A267535, proved from an exact model}
...
\begin{abstract}
OEIS A267535 carries an empirical recurrence of order $2$. It is true, and it is
...
OEIS A267535 is ``Binary representation of the n-th iteration of the "Rule 143" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 110, 11001, 1100111, 110011111, 11001111111, 1100111111111, 110011111111111,\ \dots
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267535.
