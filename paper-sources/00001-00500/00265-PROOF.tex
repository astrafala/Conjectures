...
\title{The empirical recurrence for OEIS A267047, proved from an exact model}
...
\begin{abstract}
OEIS A267047 carries an empirical recurrence of order $5$ contributed by Colin Barker. It is true, and it is
...
OEIS A267047 is ``Total number of ON (black) cells after n iterations of the "Rule 91" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 3, 5, 9, 14, 22, 27, 39,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 10 2016 and Apr 19 2019: (Start) a(n) = a(n-1)+2*a(n-2)-2*a(n-3)-a(n-4)+a(n-5) for n>6.
\end{quote}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267047.
