...
\begin{abstract}
OEIS A279874 carries an empirical recurrence of order $6$ contributed by Colin Barker. It is true, and it is
...
\begin{quote}
Conjectures from \_Colin Barker\_, Dec 22 2016: (Start) a(n) = 100*a(n-2) + a(n-4) - 100*a(n-6) for n>10.
\end{quote}
