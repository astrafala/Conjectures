...
\title{The empirical recurrence for OEIS A266438, proved from an exact model}
...
\begin{abstract}
OEIS A266438 carries an empirical recurrence of order $5$. It is true, and it is
...
OEIS A266438 is ``Total number of ON (black) cells after n iterations of the "Rule 23" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 4, 4, 11, 11, 22, 22, 37,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
(the empirical recurrence quoted in the entry)
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 16 2025 08:33:28, revision 22)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A266438.
