...
\title{The empirical recurrence for OEIS A267876, proved from an exact model}
...
\begin{abstract}
OEIS A267876 carries an empirical recurrence of order $2$. It is true, and it is
...
OEIS A267876 is ``Binary representation of the n-th iteration of the "Rule 233" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 0, 10101, 1110111, 111111111, 11111111111, 1111111111111, 111111111111111,\ \dots
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267876.
