...
\title{The empirical recurrence for OEIS A290836, proved by transfer matrix}
...
\begin{abstract}
OEIS A290836 carries an empirical recurrence of order $2$ contributed by R.~H.~Hardin. It is
...
OEIS A290836 is ``Decimal representation of the diagonal from the corner to the origin of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 969", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 2, 5, 15, 28, 63, 127, 255,\ \dots
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A290836.
