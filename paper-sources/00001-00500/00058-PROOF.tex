...
\title{The empirical recurrence for OEIS A063094, proved from an exact model}
...
\begin{abstract}
OEIS A063094 carries an empirical recurrence of order $3$ contributed by Colin Barker. It is true, and it is
