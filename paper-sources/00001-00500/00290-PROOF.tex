...
\begin{abstract}
OEIS A284244 carries an empirical recurrence of order $6$ contributed by Chai Wah Wu. It is true, and it is
...
\begin{quote}
Conjectures from \_Chai Wah Wu\_, May 06 2024: (Start) a(n) = 100*a(n-2) + a(n-4) - 100*a(n-6) for n > 16.
\end{quote}
