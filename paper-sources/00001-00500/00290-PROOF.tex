...
\begin{abstract}
OEIS A282911 carries an empirical recurrence of order $5$ contributed by Colin Barker. It is true, and it is
...
\begin{quote}
Conjectures from \_Colin Barker\_, Feb 25 2017: (Start) a(n) = a(n-1) + 10000*a(n-4) - 10000*a(n-5) for n>5.
\end{quote}
