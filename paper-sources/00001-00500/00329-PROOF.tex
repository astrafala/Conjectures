...
\title{The empirical recurrence for OEIS A187169, proved from an exact model}
...
\begin{abstract}
OEIS A187169 carries an empirical recurrence of order $4$. It is true, and it is
...
OEIS A187169 is ``Number of 8-step self-avoiding walks on an n X n X n cube summed over all starting positions.''. It has offset $1$ and begins
\[
0, 144, 67824, 608928, 2188608, 5299056, 10416624, 18026640,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 81390*n\^{}3 - 463074*n\^{}2 + 801216*n - 418032 for n>6. a(n) = 4*a(n-1) - 6*a(n-2) + 4*a(n-3) - a(n-4) for n>10.
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 05 2022 22:12:00, revision 15)
...
SHAPE when one is a translate of the other. There are exactly $81390$ shapes: self-avoiding
sequences of $8$ distinct cells in $\mathbf{Z}^{3}$ with each consecutive difference in
...
Write $w^\ast$ for the largest bounding-box side over all $81390$ shapes. Once $n\ge w^\ast$
...
$z^{8}(z-1)^{4}$, monic of order $S=12$. Both numbers are read off the enumerated
...
vanish from $n=10+1$ onwards, and the run exceeds $S+4$, which by
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A187169.
