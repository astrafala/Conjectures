...
\begin{abstract}
OEIS A284541 carries an empirical recurrence of order $5$ contributed by Colin Barker. It is true, and it is
...
\begin{quote}
Conjectures from \_Colin Barker\_, Mar 29 2017: (Start) a(n) = 10*a(n-1) + a(n-4) - 10*a(n-5) for n>8.
\end{quote}
