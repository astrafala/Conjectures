...
\title{The empirical recurrence for OEIS A211550, proved by a one-dimensional reduction}
...
\begin{abstract}
OEIS A211550 counts symmetric $(n+1)\times(n+1)$ matrices over
$\{-9,\dots,9\}$ in which every $2\times2$ subblock sums to zero and has three distinct
...
on $S=614$ states, and the empirical recurrence of order $17$ contributed by R.~H.~Hardin
follows.
\end{abstract}
...
OEIS A211550 is ``Number of (n+1)X(n+1) -9..9 symmetric matrices with every 2X2 subblock having sum zero and three distinct values.''. It has offset $1$ and begins
\[
150, 330, 640, 1190, 2172, 3922, 7052, 12734,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 16:12:58, revision 8) this is still
...
$S=614$. The two parity classes never mix, so the walk starts by choosing a parity and a first
value, and every state may end a sequence:
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad \tau=\mathbf{1},\qquad S=614.
\]
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) + 6\,a(n-2) - 66\,a(n-3) + 32\,a(n-4) + 343\,a(n-5) - 396\,a(n-6) - 874\,a(n-7) + 1475\,a(n-8) + 1066\,a(n-9) - 2702\,a(n-10) - 373\,a(n-11) + 2577\,a(n-12) - 367\,a(n-13) - 1195\,a(n-14) + 320\,a(n-15) + 210\,a(n-16) - 60\,a(n-17)
\]
for every $n>17$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A211550.
