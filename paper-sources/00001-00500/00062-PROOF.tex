...
\title{The empirical recurrence for OEIS A063150, proved from an exact model}
...
\begin{abstract}
OEIS A063150 carries an empirical recurrence of order $3$ contributed by Colin Barker. It is true, and it is
...
\begin{quote}
Conjectures from \_Colin Barker\_, Jun 10 2019: (Start) a(n) = a(n-1) + a(n-2) - a(n-3) for n>4.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 22 2019 12:18:12, revision 9)
