...
\title{The empirical recurrence for OEIS A315538, proved from an exact model}
...
\begin{abstract}
OEIS A315538 carries an empirical recurrence of order $4$ contributed by Chai Wah Wu. It is true, and it is
...
OEIS A315538 is ``Coordination sequence Gal.3.50.2 where Gal.u.t.v denotes the coordination sequence for a vertex of type v in tiling number t in the Galebach list of u-uniform tilings.''. It has offset $0$ and begins
\[
1, 6, 11, 17, 23, 28, 34, 40,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Chai Wah Wu\_, Jun 11 2020: (Start) a(n) = a(n-1) + a(n-3) - a(n-4) for n > 4.
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 21 2023 15:11:10, revision 6)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A315538.
