...
\title{The empirical recurrence for OEIS A265380, proved from an exact model}
...
\begin{abstract}
OEIS A265380 carries an empirical recurrence of order $5$ contributed by Colin Barker. It is true, and it is
...
\begin{quote}
Conjectures from \_Colin Barker\_, Dec 14 2015 and Apr 18 2019: (Start) a(n) = 10*a(n-1) + a(n-4) - 10*a(n-5) for n>4.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 16 2025 08:33:27, revision 40)
