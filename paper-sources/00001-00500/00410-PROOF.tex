...
\title{The empirical recurrence for OEIS A282124, proved from an exact model}
...
\begin{abstract}
OEIS A282124 carries an empirical recurrence of order $4$ contributed by Colin Barker. It is true, and it is
...
\[
1, 3, 3, 15, 11, 63, 43, 255,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Feb 07 2017: (Start) a(n) = 5*a(n-2) - 4*a(n-4) for n>3.
\end{quote}
