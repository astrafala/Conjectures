...
\title{The empirical recurrence for OEIS A310525, proved from an exact model}
...
\begin{abstract}
OEIS A310525 carries an empirical recurrence of order $6$ contributed by Chai Wah Wu. It is true, and it is
...
OEIS A310525 is ``Coordination sequence Gal.4.74.1 where Gal.u.t.v denotes the coordination sequence for a vertex of type v in tiling number t in the Galebach list of u-uniform tilings.''. It has offset $0$ and begins
\[
1, 4, 10, 16, 22, 28, 32, 36,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Chai Wah Wu\_, Jan 24 2020: (Start) a(n) = 2*a(n-1) - 2*a(n-2) + 2*a(n-3) - 2*a(n-4) + 2*a(n-5) - a(n-6) for n > 6.
\end{quote}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A310525.
