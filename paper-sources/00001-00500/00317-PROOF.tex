...
\title{The empirical recurrence for OEIS A267531, proved from an exact model}
...
\begin{abstract}
OEIS A267531 carries an empirical recurrence of order $4$ contributed by Colin Barker. It is true, and it is
...
OEIS A267531 is ``Total number of OFF (white) cells after n iterations of the "Rule 141" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
0, 2, 5, 9, 13, 18, 23, 29,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 17 2016: (Start) a(n) = 2*a(n-1) - 2*a(n-3) + a(n-4) for n > 4.
\end{quote}
...
First, the model reproduces all $56$ terms the entry publishes, exactly, in integer
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267531.
