...
\title{The empirical recurrence for OEIS A266249, proved from an exact model}
...
\begin{abstract}
OEIS A266249 carries an empirical recurrence of order $4$ contributed by Colin Barker. It is true, and it is
...
OEIS A266249 is ``Number of ON (black) cells in the n-th iteration of the "Rule 9" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 0, 2, 2, 4, 5, 4, 9,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Dec 28 2015 and Apr 14 2019: (Start) a(n) = 2*a(n-2)-a(n-4) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 16 2025 08:33:28, revision 16)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A266249.
