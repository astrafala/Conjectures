...
\title{The empirical recurrence for OEIS A266449, proved from an exact model}
...
\begin{abstract}
OEIS A266449 carries an empirical recurrence of order $4$ contributed by Colin Barker. It is true, and it is
...
OEIS A266449 is ``Number of OFF (white) cells in the n-th iteration of the "Rule 25" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
0, 2, 3, 4, 5, 5, 9, 5,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Dec 30 2015 and Apr 16 2019: (Start) a(n) = 2*a(n-2)-a(n-4) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 16 2025 08:33:28, revision 17)
...
For this entry the automaton is rule 25, the period is $p=2$ and the pre-period is $n_0=4$.
The certificate is
\begin{gather*}
r=0:\quad w(n+p) = \texttt{000} \cdot w(n) \cdot \texttt{0} \\
r=1:\quad w(n+p) = \texttt{111} \cdot w(n) \cdot \texttt{1}
\end{gather*}
...
annihilator of order $S=10$ used below.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A266449.
