...
\title{The empirical recurrence for OEIS A211497, proved by a one-dimensional reduction}
...
\begin{abstract}
OEIS A211497 counts symmetric $(n+1)\times(n+1)$ matrices over
$\{-4,\dots,4\}$ in which every $2\times2$ subblock sums to zero and has two, three or four distinct
...
on $S=82$ states, and the empirical recurrence of order $10$ contributed by R.~H.~Hardin
follows.
\end{abstract}
...
OEIS A211497 is ``Number of (n+1)X(n+1) -4..4 symmetric matrices with every 2X2 subblock having sum zero and two, three or four distinct values.''. It has offset $1$ and begins
\[
40, 180, 808, 3636, 16396, 74104, 335660, 1523420,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 16:12:29, revision 8) this is still
...
$S=82$. The two parity classes never mix, so the walk starts by choosing a parity and a first
value, and every state may end a sequence:
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad \tau=\mathbf{1},\qquad S=82.
\]
...
\begin{theorem}
\[
a(n)\;=\;21\,a(n-1) - 177\,a(n-2) + 742\,a(n-3) - 1477\,a(n-4) + 665\,a(n-5) + 1725\,a(n-6) - 952\,a(n-7) - 1462\,a(n-8) - 476\,a(n-9) - 48\,a(n-10)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A211497.
