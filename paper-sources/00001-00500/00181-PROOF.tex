...
\title{The empirical recurrence for OEIS A290525, proved from an exact model}
...
\begin{abstract}
OEIS A290525 carries an empirical recurrence of order $5$. It is true, and it is
...
OEIS A290525 is ``Binary representation of the diagonal from the corner to the origin of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 833", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 10, 101, 1111, 11000, 111111, 1110000, 11111111,\ \dots
\]
...
\begin{theorem}
\[
a(n)\;=\;10\,a(n-1) + 11\,a(n-2) - 110\,a(n-3) - 10\,a(n-4) + 100\,a(n-5)
\]
for every $n>7$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A290525.
