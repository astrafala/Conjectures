...
\title{The empirical recurrence for OEIS A279163, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A279163 imposes three things at once: a condition on each cell that reaches one row up and
...
OEIS A279163 is ``Number of nX3 0..1 arrays with no element equal to a strict majority of its king-move neighbors, with the exception of exactly two elements, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
0, 0, 16, 117, 483, 2001, 7709, 28139,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 07 2016 08:09:47, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;12\,a(n-1) - 60\,a(n-2) + 178\,a(n-3) - 423\,a(n-4) + 945\,a(n-5) - 1762\,a(n-6) + 2718\,a(n-7) - 4107\,a(n-8) + 5541\,a(n-9) - 6003\,a(n-10) + 6900\,a(n-11) - 7369\,a(n-12) + 5673\,a(n-13) - 6435\,a(n-14) + 6357\,a(n-15) - 3486\,a(n-16) + 5577\,a(n-17) - 3953\,a(n-18) + 453\,a(n-19) - 3432\,a(n-20) + 780\,a(n-21) + 357\,a(n-22) + 2541\,a(n-23) + 430\,a(n-24) - 354\,a(n-25) - 888\,a(n-26) - 583\,a(n-27) - 84\,a(n-28) + 354\,a(n-29) + 224\,a(n-30) - 36\,a(n-31) - 48\,a(n-32) - 8\,a(n-33)
\end{equation}
for all $n>36$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A279163.
