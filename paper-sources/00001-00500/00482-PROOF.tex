...
\title{The empirical recurrence for OEIS A187512, proved from an exact model}
...
\begin{abstract}
OEIS A187512 carries an empirical recurrence of order $3$. It is true, and it is
...
OEIS A187512 is ``Number of 7-step S, E, and NW-moving king's tours on an n X n board summed over all starting positions.''. It has offset $1$ and begins
\[
0, 0, 20, 330, 1224, 2726, 4807, 7458,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 285*n\^{}2 - 1624*n + 2210 for n>5. a(n) = 3*a(n-1) - 3*a(n-2) + a(n-3) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 24 2018 09:19:57, revision 10)
...
SHAPE when one is a translate of the other. There are exactly $285$ shapes: self-avoiding
...
Write $w^\ast$ for the largest bounding-box side over all $285$ shapes. Once $n\ge w^\ast$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A187512.
