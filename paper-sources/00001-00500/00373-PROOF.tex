...
\begin{abstract}
OEIS A267048 carries an empirical recurrence of order $4$ contributed by Colin Barker. It is true, and it is
...
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 11 2016 and Apr 19 2019: (Start) a(n) = 2*a(n-2)-a(n-4) for n>6.
\end{quote}
