...
\title{The empirical recurrence for OEIS A283605, proved from an exact model}
...
\begin{abstract}
OEIS A283605 carries an empirical recurrence of order $3$. It is true, and it is
...
OEIS A283605 is ``Binary representation of the x-axis, from the origin to the right edge, of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 670", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 11, 111, 1111, 10111, 111111, 1110111, 11111111,\ \dots
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A283605.
