...
\title{The empirical recurrence for OEIS A189645, proved by transfer matrix}
...
\begin{abstract}
OEIS A189645 counts the permutations of the cells of an $n\times4$ array in which every cell
...
OEIS A189645 is ``Number of n X 4 array permutations with each element moving zero or one space horizontally, diagonally or antidiagonally.''. It has offset $1$ and begins
\[
5, 185, 4277, 107080, 2631821, 64890337, 1598901325, 39401919001,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 05 2014 00:42:26, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;30\,a(n-1) - 126\,a(n-2) - 298\,a(n-3) + 4076\,a(n-4) - 9643\,a(n-5) - 26\,a(n-6) + 67624\,a(n-7) - 249088\,a(n-8) + 187462\,a(n-9) + 574310\,a(n-10) - 970738\,a(n-11) + 67260\,a(n-12) + 489180\,a(n-13) + 209922\,a(n-14) - 640310\,a(n-15) + 258090\,a(n-16) + 58776\,a(n-17) - 37696\,a(n-18) - 25814\,a(n-19) + 20091\,a(n-20) - 3196\,a(n-21) - 638\,a(n-22) + 270\,a(n-23) - 30\,a(n-24) + a(n-25)
\]
for every $n>24$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A189645.
