...
\title{The empirical recurrence for OEIS A199706, proved from an exact model}
...
\begin{abstract}
OEIS A199706 carries an empirical recurrence of order $6$. It is true, and it is
...
OEIS A199706 is ``Number of -n..n arrays x(0..3) of 4 elements with zero sum and no two neighbors equal.''. It has offset $1$ and begins
\[
8, 52, 168, 380, 724, 1236, 1940, 2872,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1)-3*a(n-2)+2*a(n-3)-3*a(n-4)+3*a(n-5)-a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (May 16 2018 11:20:02, revision 15)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A199706.
