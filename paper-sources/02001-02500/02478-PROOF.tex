...
\title{A further conjecture on OEIS A208138,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A208138 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $9, 81, 324, 900, 2025, 3969, 7056, 11664,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = 9*(n\^{}2*(1+n)\^{}2) / 4.\end{quote}
