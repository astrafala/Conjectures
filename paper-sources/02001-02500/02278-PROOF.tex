...
\title{The empirical recurrence for OEIS A235958, proved by transfer matrix}
...
\begin{abstract}
OEIS A235958 counts arrays of width $5$ over $\{0,1\}$ by reducing every $2\times2$ subblock to a
...
about it is one bit per adjacent pair of columns, so the count is a walk count on $S=545$
states.
\end{abstract}
...
OEIS A235958 is ``Number of (n+1)X(4+1) 0..1 arrays with the difference of the upper and lower median value of each 2X2 subblock in lexicographically nondecreasing order columnwise and nonincreasing rowwise.''. It has offset $1$ and begins
\[
398, 3574, 27296, 195428, 1340034, 8974124, 59037352, 383935642,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 08:57:06, revision 6) this is still
...
f(B)\;=\;v_3-v_2,
\]
the upper median minus the lower median. An array with $R$ rows and $5$ columns has $(R-1)\times4$ subblocks, and they
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=545.
\]
...
\begin{theorem}
\[
a(n)\;=\;14\,a(n-1) - 12\,a(n-2) - 630\,a(n-3) + 2185\,a(n-4) + 11081\,a(n-5) - 61187\,a(n-6) - 84848\,a(n-7) + 866058\,a(n-8) - 9451\,a(n-9) - 7440523\,a(n-10) + 5961993\,a(n-11) + 41377284\,a(n-12) - 57568138\,a(n-13) - 151118526\,a(n-14) + 300002541\,a(n-15) + 350238262\,a(n-16) - 1000944598\,a(n-17) - 437426084\,a(n-18) + 2240808356\,a(n-19) - 633296\,a(n-20) - 3391604096\,a(n-21) + 992970752\,a(n-22) + 3413976256\,a(n-23) - 1734009344\,a(n-24) - 2192656896\,a(n-25) + 1503995904\,a(n-26) + 829825024\,a(n-27) - 716570624\,a(n-28) - 158203904\,a(n-29) + 174587904\,a(n-30) + 10485760\,a(n-31) - 16777216\,a(n-32)
\]
for every $n>31$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A235958.
