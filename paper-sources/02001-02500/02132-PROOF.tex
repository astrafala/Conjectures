...
\title{The empirical closed form for OEIS A223840, proved}
...
\begin{abstract}
OEIS A223840 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
$S=20480$ vertices. Any function of the form $\sum_j p_j(n)\lambda_j^{\,n}$ satisfies the
...
OEIS A223840 is ``Number of 4 X n 0..1 arrays with rows, diagonals and antidiagonals unimodal and columns nondecreasing.''. It has offset $1$ and begins
\[
5, 25, 89, 249, 596, 1286, 2578, 4886,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 20 2025 14:53:31, revision 14) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{n^{8}}{40320} - \frac{n^{7}}{10080} + \frac{19 n^{6}}{2880} + \frac{7 n^{5}}{180} + \frac{527 n^{4}}{5760} + \frac{3683 n^{3}}{1440} + \frac{4051 n^{2}}{10080} - \frac{1707 n}{280} + 13.
\]
...
walk, so with $M$ the adjacency matrix of that digraph on $S=20480$ vertices, and $u,w$ the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223840.
