...
\title{The empirical recurrence for OEIS A208791, proved by transfer matrix}
...
\begin{abstract}
OEIS A208791 counts arrays of width $3$ over $\{0,1,2\}$ in which no cell is the average of its neighbours. The entry carries an
...
OEIS A208791 is ``Number of nX3 0..2 arrays with no element equal the average of immediate neighbors vertically above, diagonally above and left, and horizontally left of it.''. It has offset $1$ and begins
\[
12, 160, 2284, 32446, 461280, 6557958, 93227592, 1325375622,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) +123*a(n-2) +332*a(n-3) -170*a(n-4) -796*a(n-5) +124*a(n-6) +464*a(n-7) -88*a(n-8) -16*a(n-9)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 15:01:16, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + 123\,a(n-2) + 332\,a(n-3) - 170\,a(n-4) - 796\,a(n-5) + 124\,a(n-6) + 464\,a(n-7) - 88\,a(n-8) - 16\,a(n-9)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208791.
