...
\title{A further conjecture on OEIS A187177,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A187177 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $0, 0, 0, 0, 0, 16, 368, 1600,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = 780*n\^{}2 - 9880*n + 29384 for n>11.\end{quote}
...
indices, and $a$ and $f$ were checked to agree at $n=15,\dots,17$,
