...
\title{The empirical recurrence for OEIS A276249, proved by transfer matrix}
...
\begin{abstract}
OEIS A276249 counts arrays in which no entry may equal the entries at a short list of fixed offsets
...
$2$ consecutive columns, $S=263$ states in all.
\end{abstract}
...
OEIS A276249 is ``Number of 3 X n 0..2 arrays with no element equal to any value at offset (-2,-1) (-1,1) or (0,-2) and new values introduced in order 0..2.''. It has offset $1$ and begins
\[
5, 36, 85, 279, 900, 2837, 9148, 29570,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 07 2021 13:37:11, revision 6) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=263.
\]
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 3\,a(n-2) + 8\,a(n-3) - 10\,a(n-4) - 21\,a(n-5) + 17\,a(n-7) + 12\,a(n-8) - 17\,a(n-9) + 2\,a(n-10) + 3\,a(n-11) + 3\,a(n-12) - a(n-14)
\]
for every $n>15$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A276249.
