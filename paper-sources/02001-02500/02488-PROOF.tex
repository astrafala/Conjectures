...
\title{A further conjecture on OEIS A228256,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A228256 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $33, 565, 6419, 53315, 315601, 1688101, 8717049, 44633821,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = 5\^{}(3+n) - 4\^{}(3+n) for n>6.\end{quote}
...
indices, and $a$ and $f$ were checked to agree at $n=9,\dots,10$,
