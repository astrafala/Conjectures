...
\title{The empirical recurrence for OEIS A199900, proved from an exact model}
...
\begin{abstract}
OEIS A199900 carries an empirical recurrence of order $5$. It is true, and it is
...
OEIS A199900 is ``Number of -n..n arrays x(0..4) of 5 elements with zero sum, and adjacent elements not both strictly positive and not both strictly negative.''. It has offset $1$ and begins
\[
33, 159, 461, 1043, 2031, 3573, 5839, 9021,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (11/12)*n\^{}4 + (49/6)*n\^{}3 + (193/12)*n\^{}2 + (41/6)*n + 1. a(n) = 5*a(n-1) - 10*a(n-2) + 10*a(n-3) - 5*a(n-4) + a(n-5) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (May 16 2018 16:33:12, revision 9)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A199900.
