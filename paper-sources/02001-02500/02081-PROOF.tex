...
\title{The empirical recurrence for OEIS A232841, proved by transfer matrix}
...
\begin{abstract}
OEIS A232841 counts arrays of width $3$ over $\{0,1,2\}$ in which every cell sees its own value plus and minus one among its neighbours. The entry carries an
...
OEIS A232841 is ``Number of (2+1)X(n+1) 0..2 arrays with every element next to itself plus and minus one within the range 0..2 horizontally, diagonally or antidiagonally.''. It has offset $1$ and begins
\[
16, 312, 6664, 67718, 1051216, 17686598, 265341016, 3829830598,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 07:38:55, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232841.
