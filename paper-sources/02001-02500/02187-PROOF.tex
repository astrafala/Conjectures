...
\title{The empirical recurrence for OEIS A217268, proved by transfer matrix}
...
\begin{abstract}
OEIS A217268 counts the distinct OCCUPANCY arrays obtained when every cell of an $n\times3$ grid
...
determinising the machine that emits the occupancy row by row turns it into one, on $S=697$
...
OEIS A217268 is ``Number of n X 3 arrays of occupancy after each element moves to some horizontal or vertical neighbor.''. It has offset $1$ and begins
\[
2, 64, 1472, 33856, 772800, 17640000, 402494400, 9183772224,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 24*a(n-1) - 648*a(n-3) + 729*a(n-4) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2018 08:43:57, revision 7) this is still
...
\]
There are $S=697$ reachable sets. In particular $a$ is $C$-finite.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A217268.
