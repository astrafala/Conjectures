...
\title{The empirical recurrence for OEIS A208869, proved by counting patterns}
...
\begin{abstract}
OEIS A208869 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A208869 is ``Number of nX5 0..3 arrays with new values 0..3 introduced in row major order and no element equal to more than one of its immediate leftward or upward or right-upward antidiagonal neighbors.''. It has offset $1$ and begins
\[
51, 24472, 14493405, 8624977114, 5134914951163, 3057224057476808, 1820216057105650386, 1083724145919960847502,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 15:03:33, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;698\,a(n-1) - 64930\,a(n-2) + 2349972\,a(n-3) - 40985428\,a(n-4) + 382137700\,a(n-5) - 2071312484\,a(n-6) + 7427716824\,a(n-7) - 22247002672\,a(n-8) + 65755191408\,a(n-9) - 163887803568\,a(n-10) + 277785052512\,a(n-11) - 285817496832\,a(n-12) + 164238606720\,a(n-13) - 46819296000\,a(n-14) + 4897760256\,a(n-15)
\end{equation}
for all $n>16$.
...
For every $n$ with $m=n+0-1\ge15$,
\[
4!\Bigl(a(n)-\sum_i c_i\,a(n-i)\Bigr)\;=\;\mathbf{v}^{\!\top}N^{\,m-15}q(N)\mathbf{1} .
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208869.
