...
\title{The empirical recurrence for OEIS A230801, proved by transfer matrix}
...
\begin{abstract}
OEIS A230801 counts arrays of width $3$ over $\{0,1,2,3\}$ in which every cell must see, among its
...
the count is a walk count on $S=2065$ states.
\end{abstract}
...
OEIS A230801 is ``Number of n X 3 0..3 arrays x(i,j) with each element horizontally or vertically next to at least one element with value (x(i,j)+1) mod 4 and at least one element with value (x(i,j)-1) mod 4, and upper left element zero.''. It has offset $1$ and begins
\[
0, 2, 14, 40, 298, 1546, 8704, 50450,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 11 2025 08:22:50, revision 11) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=2065.
\]
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-1) - 7\,a(n-2) - 40\,a(n-3) + 3\,a(n-4) + 221\,a(n-5) - 237\,a(n-6) - 55\,a(n-7) + 182\,a(n-8) - 270\,a(n-9) + 324\,a(n-10) - 172\,a(n-11) + 112\,a(n-12) - 64\,a(n-13)
\]
for every $n>13$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A230801.
