...
\title{The empirical recurrence for OEIS A223956, proved by transfer matrix}
...
\begin{abstract}
OEIS A223956 counts arrays over $\{0,\dots,3\}$ whose rows, columns, diagonals or
...
is a walk count on $S=160$ vertices and the recurrence follows from a finite exact
computation.
\end{abstract}
...
OEIS A223956 is ``Number of nX3 0..3 arrays with antidiagonals unimodal and rows and diagonals nondecreasing.''. It has offset $1$ and begins
\[
20, 295, 3471, 41006, 485714, 5777663, 68892600, 822141033,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 23:01:34, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;20\,a(n-1) - 105\,a(n-2) + 51\,a(n-3) + 589\,a(n-4) + 1340\,a(n-5) - 8833\,a(n-6) - 2855\,a(n-7) + 30423\,a(n-8) + 57774\,a(n-9) - 140760\,a(n-10) - 176184\,a(n-11) + 106272\,a(n-12) + 544320\,a(n-13)
\end{equation}
for all $n>13$.
...
bit vector), $|\mathcal V|=S=160$; let $(r,f)\to(s,f')$ be an edge when placing $s$ after $r$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223956.
