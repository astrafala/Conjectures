...
\title{The empirical closed form for OEIS A219621, proved}
...
\begin{abstract}
OEIS A219621 states an explicit closed form for $a(n)$ and records it as empirical. It is true, and
...
OEIS A219621 is ``Number of n X 2 arrays of the minimum value of corresponding elements and their horizontal or antidiagonal neighbors in a random, but sorted with lexicographically nondecreasing rows and columns, 0..2 n X 2 array.''. It has offset $1$ and begins
\[
3, 11, 27, 56, 105, 183, 301, 472,\ \dots
\]
and states:
\begin{quote}
Empirical: a(n) = (1/12)*n\^{}4 + (23/12)*n\^{}2 + n.
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 26 2018 11:54:53, revision 7)
...
\begin{theorem}
The closed form OEIS A219621 records is correct for all $n>0$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A219621.
