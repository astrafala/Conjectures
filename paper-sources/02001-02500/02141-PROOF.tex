...
\title{The empirical recurrence for OEIS A268785, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A268785 counts arrays over $\{0,\dots,1\}$ subject to a condition on the array as a
...
OEIS A268785 is ``Number of nX4 binary arrays with some element plus some horizontally, vertically or antidiagonally adjacent neighbor totalling two exactly once.''. It has offset $1$ and begins
\[
5, 48, 302, 1714, 9085, 46195, 228384, 1105510,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 13 2016 12:23:18, revision 4) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268785.
