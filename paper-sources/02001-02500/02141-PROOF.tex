...
\title{The empirical recurrence for OEIS A200786, proved from an exact model}
...
\begin{abstract}
OEIS A200786 carries an empirical recurrence of order $5$. It is true, and it is
...
OEIS A200786 is ``Number of 0..n arrays x(0..3) of 4 elements without any two consecutive increases.''. It has offset $1$ and begins
\[
16, 75, 225, 530, 1071, 1946, 3270, 5175,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (17/24)*n\^{}4 + (43/12)*n\^{}3 + (151/24)*n\^{}2 + (53/12)*n + 1. a(n) = 5*a(n-1) - 10*a(n-2) + 10*a(n-3) - 5*a(n-4) + a(n-5) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 05 2026 14:52:26, revision 19)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A200786.
