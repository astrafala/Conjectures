...
\title{A further conjecture on OEIS A183629,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A183629 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $2445, 2967, 4029, 6207, 10725, 20247, 40749, 86127,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = 3*(644 + 21*2\^{}(2+n) + 3\^{}n).\end{quote}
