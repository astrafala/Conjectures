...
\title{The empirical recurrence for OEIS A202963, proved from an exact model}
...
\begin{abstract}
OEIS A202963 carries an empirical recurrence of order $4$. It is true, and it is
...
OEIS A202963 is ``Number of arrays of 3 integers in -n..n with sum zero and adjacent elements differing in absolute value.''. It has offset $1$ and begins
\[
2, 6, 20, 36, 62, 90, 128, 168,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) -2*a(n-3) +a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 22 2025 07:19:58, revision 25)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A202963.
