...
\title{The empirical recurrence for OEIS A252693, proved by transfer matrix}
...
\begin{abstract}
OEIS A252693 counts arrays of width $8$ over an alphabet of $4$ letters in which every three
...
brings the state count down to $S=289260$.
\end{abstract}
...
OEIS A252693 is ``Number of (n+2) X (6+2) 0..3 arrays with every consecutive three elements in every row and column having exactly two distinct values, and in every diagonal and antidiagonal not having exactly two distinct values, and new values 0 upwards introduced in row major order.''. It has offset $1$ and begins
\[
1982, 2719, 881, 6246, 4138, 18940, 25382, 82842,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 05 2018 08:01:33, revision 7) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The array has width $8$ and entries in $\{0,1,\dots,3\}$. Four families of triples
...
\text{a diagonal (nw--se)} & $(i,j),\ (i+1,j+1),\ (i+2,j+2)$ & $1, 3$ \\
...
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,
\]
with $S=289260$ states in all. The walk index $j$ and the entry's own $n$ differ by a constant,
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) - 4\,a(n-2) - 11\,a(n-3) + 9\,a(n-4) + 12\,a(n-5) + 12\,a(n-6) - 34\,a(n-7) - 8\,a(n-8) + 28\,a(n-9) - 8\,a(n-10)
\]
for every $n>11$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252693.
