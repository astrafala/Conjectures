...
\title{A further conjecture on OEIS A166757,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A166757 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $0, 24, 504, 3672, 16272, 53784, 146184, 345240,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (4/15)*(n-1)*(8*n\^{}5 -28*n\^{}4 + 97*n\^{}3 - 218*n\^{}2 + 234*n -90).\end{quote}
