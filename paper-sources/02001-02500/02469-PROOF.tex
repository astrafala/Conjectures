...
\title{A further conjecture on OEIS A200887,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A200887 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $12, 51, 144, 325, 636, 1127, 1856, 2889,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = (1+n)\^{}2 * (3+5*n+n\^{}2) / 3.\end{quote}
