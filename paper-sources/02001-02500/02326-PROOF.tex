...
\title{The empirical recurrence for OEIS A268883, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A268883 counts arrays over $\{0,\dots,1\}$ subject to a condition on the array as a
...
OEIS A268883 is ``Number of nX5 binary arrays with some element plus some horizontally or antidiagonally adjacent neighbor totalling two exactly once.''. It has offset $1$ and begins
\[
10, 158, 2190, 27130, 317966, 3596174, 39670270, 429588382,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 26*a(n-1) -241*a(n-2) +994*a(n-3) -2060*a(n-4) +2218*a(n-5) -1201*a(n-6) +290*a(n-7) -25*a(n-8) for n>9
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 15 2016 11:31:39, revision 4) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268883.
