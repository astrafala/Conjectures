...
\title{The empirical recurrence for OEIS A209345, proved from an exact model}
...
\begin{abstract}
OEIS A209345 carries an empirical recurrence of order $6$. It is true, and it is
...
OEIS A209345 is ``Number of 4-bead necklaces labeled with numbers -n..n allowing reversal, with sum zero with no three beads in a row equal.''. It has offset $1$ and begins
\[
4, 15, 35, 72, 128, 205, 311, 448,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) - 3*a(n-2) + 2*a(n-3) - 3*a(n-4) + 3*a(n-5) - a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 22 2025 21:41:42, revision 14)
...
condition on consecutive beads, the beads identified under the dihedral group of rotations and reflections, written $G$. Nothing is a
...
$S=13$, which includes the pre-period $n_0=0$ the conditions with an offset need. The
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209345.
