...
\title{A further conjecture on OEIS A187513,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A187513 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $0, 0, 12, 390, 1910, 4880, 9250, 14969,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = 669*n\^{}2 - 4316*n + 6681 for n>6.\end{quote}
