...
\title{The empirical recurrence for OEIS A198475, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A198475 counts arrays in which every cell is constrained by its neighbours on \emph{both}
...
order $27$, contributed by R.~H.~Hardin, then follows from a finite exact computation.
\end{abstract}
...
OEIS A198475 is ``Number of 2nX4 0..2 arrays with values 0..2 introduced in row major order and each element equal to an odd number of horizontal and vertical neighbors.''. It has offset $1$ and begins
\[
12, 252, 6104, 153222, 3935188, 101884208, 2646874462, 68861880812,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 07:53:04, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;45\,a(n-1) - 520\,a(n-2) - 74\,a(n-3) + 16486\,a(n-4) + 129736\,a(n-5) - 1095201\,a(n-6) - 2191939\,a(n-7) + 10377776\,a(n-8) + 9527308\,a(n-9) + 306527440\,a(n-10) + 393254288\,a(n-11) - 3528330816\,a(n-12) - 16775802368\,a(n-13) - 71215672320\,a(n-14) + 113359953920\,a(n-15) + 1277760061440\,a(n-16) + 1211880046592\,a(n-17) + 3312362192896\,a(n-18) - 7949471711232\,a(n-19) - 128862239326208\,a(n-20) - 76892799500288\,a(n-21) - 597198022639616\,a(n-22) + 1365043685883904\,a(n-23) + 15832967439974400\,a(n-24) - 12508044277579776\,a(n-25) - 66428094503714816\,a(n-26) + 72057594037927936\,a(n-27)
\end{equation}
for all $n>27$.
...
equal to x_{t,u}\bigr\}\ \ \text{is odd}
\end{equation}
for every cell $(t,u)$.
...
index,
\[
3!\Bigl(a(n)-\sum_i c_i\,a(n-i)\Bigr)\;=\;\mathbf{v}^{\!\top}G^{\,j-27}\,
\Bigl(h_{27}-\sum_i c_i h_{27-i}\Bigr)
\]
...
$w=h_{27}-\sum_i c_ih_{27-i}$; and it is enough to check $m=0,1,\dots,S-1$.
\end{lemma}
...
$27$ applications of $G$ in exact integer arithmetic and $\mathbf{v}^{\!\top}G^{m}w$
evaluated for $m=0,1,\dots$, again exactly. Every one of those integers vanishes from the
index corresponding to $n=27+1$ onwards, and the run was continued until $S+1$
...
\eqref{eq:walk2}, divided by $3!$, was evaluated at every one of the $15$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A198475.
