...
\title{The empirical recurrence for OEIS A221801, proved by transfer matrix}
...
\begin{abstract}
OEIS A221801 counts the distinct OCCUPANCY arrays obtained when every cell of an $n\times2$ grid
...
one, on $S=88$ states, after which the conjectured recurrence is settled by a finite exact
computation.
\end{abstract}
...
OEIS A221801 is ``Number of n X 2 arrays of occupancy after each element moves to some king-move neighbor, without 2-loops or left turns.''. It has offset $1$ and begins
\[
0, 9, 56, 378, 2475, 16256, 106629, 699390,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 8*a(n-1) - 8*a(n-2) - 10*a(n-3) + 4*a(n-4) - 7*a(n-5) + 4*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 11 2018 07:13:48, revision 9) this is still
...
$S=88$ reachable sets. In particular $a$ is $C$-finite.
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-1) - 8\,a(n-2) - 10\,a(n-3) + 4\,a(n-4) - 7\,a(n-5) + 4\,a(n-6)
\]
for every $n>6$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221801.
