...
\title{The empirical recurrence for OEIS A232415, proved by transfer matrix}
...
\begin{abstract}
OEIS A232415 counts arrays of width $2$ over $\{0,1,2\}$ in which every cell has a neighbour at least as large and one at most as large. The entry carries an
...
OEIS A232415 is ``Number of (1+1)X(n+1) 0..2 arrays with every element both >= and <= some horizontal, diagonal or antidiagonal neighbor.''. It has offset $1$ and begins
\[
15, 159, 973, 6477, 46713, 334521, 2375879, 16872055,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 6*a(n-1) +2*a(n-2) +32*a(n-3) +69*a(n-4) +2*a(n-5) +24*a(n-6) -56*a(n-7) -160*a(n-8) +32*a(n-9) +64*a(n-10)
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 07:25:32, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) + 2\,a(n-2) + 32\,a(n-3) + 69\,a(n-4) + 2\,a(n-5) + 24\,a(n-6) - 56\,a(n-7) - 160\,a(n-8) + 32\,a(n-9) + 64\,a(n-10)
\]
for every $n>10$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232415.
