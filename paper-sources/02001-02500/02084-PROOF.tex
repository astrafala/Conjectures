...
\title{The empirical recurrence for OEIS A264167, proved by transfer matrix}
...
\begin{abstract}
OEIS A264167 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=3$ rows in which
...
OEIS A264167 is ``Number of (n+1) X (2+1) arrays of permutations of 0..n*3+2 with each element having directed index change 0,0 0,1 1,0 -2,-1 or -1,-2.''. It has offset $1$ and begins
\[
4, 25, 98, 418, 1862, 8007, 34539, 149808,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + 7*a(n-2) + 23*a(n-3) + 35*a(n-4) + 18*a(n-5) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 05 2019 06:46:53, revision 11) this is still
...
\[
(i-h_i,\,j-h_j)\;\in\;\{(-2,-1),\ (-1,-2),\ (0,0),\ (0,1),\ (1,0)\},
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264167.
