...
\title{The empirical recurrence for OEIS A223184, proved by transfer matrix}
...
\begin{abstract}
OEIS A223184 counts the ways of writing the vertices of a fixed graph $G$ into an array of width
$6$ so that any two cells adjacent in one of the named directions carry vertices joined by an
edge of $G$; here $G$ is icosahedron graph. The entry carries an empirical recurrence of order $34$
...
single slice is a state and the count is a walk count on a finite digraph with $S=12146$ vertices.
\end{abstract}
...
OEIS A223184 is ``Rolling icosahedron footprints: number of nX6 0..11 arrays starting with 0 where 0..11 label vertices of an icosahedron and every array movement to a horizontal, vertical or antidiagonal neighbor moves along an icosahedral edge.''. It has offset $1$ and begins
\[
3125, 5120, 56960, 738720, 10117600, 141047120, 1978496760, 27809548920,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 21:19:05, revision 8) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=12146.
\]
...
\begin{theorem}
\[
a(n)\;=\;34\,a(n-1) - 485\,a(n-2) + 4346\,a(n-3) - 28802\,a(n-4) + 150848\,a(n-5) - 636337\,a(n-6) + 2159092\,a(n-7) - 5838756\,a(n-8) + 12438350\,a(n-9) - 20709448\,a(n-10) + 27153588\,a(n-11) - 29621182\,a(n-12) + 31551558\,a(n-13) - 39983024\,a(n-14) + 57518400\,a(n-15) - 77018236\,a(n-16) + 86977128\,a(n-17) - 80388139\,a(n-18) + 58849554\,a(n-19) - 31645539\,a(n-20) + 11534636\,a(n-21) - 3954177\,a(n-22) + 4130000\,a(n-23) - 5090133\,a(n-24) + 4343740\,a(n-25) - 2741059\,a(n-26) + 1290058\,a(n-27) - 452154\,a(n-28) + 127180\,a(n-29) - 31889\,a(n-30) + 7256\,a(n-31) - 1428\,a(n-32) + 212\,a(n-33) - 16\,a(n-34)
\]
for every $n>37$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223184.
