...
\title{The empirical closed form for OEIS A207066, proved}
...
\begin{abstract}
OEIS A207066 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
$S=441$ vertices. Any function of the form $\sum_j p_j(n)\lambda_j^{\,n}$ satisfies the
...
OEIS A207066 is ``Number of n X 6 0..1 arrays avoiding 0 0 1 and 0 1 0 horizontally and 0 0 1 and 1 0 1 vertically.''. It has offset $1$ and begins
\[
21, 441, 2499, 8799, 23856, 54684, 111426, 208026,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (7/120)*n\^{}6 + (147/40)*n\^{}5 + (49/3)*n\^{}4 + (91/8)*n\^{}3 - (707/120)*n\^{}2 - (91/20)*n.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 18 2018 14:17:51, revision 9) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{7 n^{6}}{120} + \frac{147 n^{5}}{40} + \frac{49 n^{4}}{3} + \frac{91 n^{3}}{8} - \frac{707 n^{2}}{120} - \frac{91 n}{20}.
\]
...
walk, so with $M$ the adjacency matrix of that digraph on $S=441$ vertices, and $u,w$ the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207066.
