...
\title{The empirical recurrence for OEIS A238770, proved by transfer matrix}
...
\begin{abstract}
OEIS A238770 counts arrays over $\{0,1,2,3\}$ in which no entry may equal, modulo $4$, a given
...
count is then a walk count on $S=64$ states.
\end{abstract}
...
OEIS A238770 is ``Number of nX3 0..3 arrays with no element equal to the sum modulo 4 of elements to its left or elements above it.''. It has offset $1$ and begins
\[
14, 156, 1888, 22242, 258720, 3044922, 35640158, 417759376,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 10:54:58, revision 6) this is still
...
zero, and a ray the entry names without a constant carries the constant $0$.
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 103\,a(n-2) + 305\,a(n-3) - 1576\,a(n-4) - 7517\,a(n-5) + 13822\,a(n-6) + 84263\,a(n-7) - 193487\,a(n-8) - 386588\,a(n-9) + 2125542\,a(n-10) - 2240531\,a(n-11) - 6903934\,a(n-12) + 24598571\,a(n-13) - 24037070\,a(n-14) - 20933507\,a(n-15) + 84761410\,a(n-16) - 76409880\,a(n-17) - 58972949\,a(n-18) + 191904430\,a(n-19) - 103074732\,a(n-20) - 119505780\,a(n-21) + 301528072\,a(n-22) - 71474328\,a(n-23) - 220257104\,a(n-24) + 158665984\,a(n-25) - 141276800\,a(n-26) - 317537024\,a(n-27) - 19131392\,a(n-28) - 71272448\,a(n-29) - 128999424\,a(n-30) - 20832256\,a(n-31) - 5177344\,a(n-32) - 4849664\,a(n-33) + 1048576\,a(n-34) + 524288\,a(n-35)
\]
for every $n>34$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A238770.
