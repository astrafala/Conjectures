...
\title{The empirical recurrence for OEIS A280601, proved by transfer matrix}
...
\begin{abstract}
OEIS A280601 counts $n\times5$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A280601 is ``Number of nX5 0..1 arrays with no element equal to more than two of its horizontal, vertical and antidiagonal neighbors and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
16, 138, 293, 726, 1648, 3647, 8031, 17745,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 06 2017 11:26:46, revision 4) this is still
...
the condition
\[
\text{no cell is equal to more than 2 of its horizontal, vertical and antidiagonal neighbours},
\]
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) - 8\,a(n-2) + 4\,a(n-3) + 2\,a(n-6) - 2\,a(n-7) - 3\,a(n-8) + 5\,a(n-9) - a(n-10) - a(n-11) - a(n-12) + a(n-13)
\]
for every $n>15$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A280601.
