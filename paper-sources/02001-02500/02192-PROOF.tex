...
\title{The empirical recurrence for OEIS A235407, proved by transfer matrix}
...
\begin{abstract}
OEIS A235407 counts arrays of width $3$ over $\{0,1\}$ by reducing every $2\times2$ subblock to a
...
about it is one bit per adjacent pair of columns, so the count is a walk count on $S=81$
states.
\end{abstract}
...
OEIS A235407 is ``Number of (n+1)X(2+1) 0..1 arrays with 2X2 subblock sums lexicographically nondecreasing rowwise and nonincreasing columnwise.''. It has offset $1$ and begins
\[
44, 172, 704, 2302, 7617, 21707, 62070, 160219,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 08:30:54, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + 15\,a(n-2) - 78\,a(n-3) - 84\,a(n-4) + 696\,a(n-5) + 112\,a(n-6) - 3760\,a(n-7) + 1218\,a(n-8) + 13704\,a(n-9) - 8862\,a(n-10) - 35508\,a(n-11) + 32060\,a(n-12) + 67024\,a(n-13) - 76668\,a(n-14) - 92568\,a(n-15) + 131079\,a(n-16) + 91860\,a(n-17) - 164969\,a(n-18) - 61582\,a(n-19) + 153888\,a(n-20) + 22296\,a(n-21) - 105420\,a(n-22) + 2424\,a(n-23) + 51632\,a(n-24) - 7808\,a(n-25) - 17136\,a(n-26) + 4320\,a(n-27) + 3456\,a(n-28) - 1152\,a(n-29) - 320\,a(n-30) + 128\,a(n-31)
\]
for every $n>30$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A235407.
