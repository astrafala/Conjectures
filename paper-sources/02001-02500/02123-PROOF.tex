...
\title{The empirical recurrence for OEIS A200058, proved from an exact model}
...
\begin{abstract}
OEIS A200058 carries an empirical recurrence of order $6$. It is true, and it is
...
OEIS A200058 is ``Number of -n..n arrays x(0..3) of 4 elements with zero sum and elements alternately strictly increasing and strictly decreasing.''. It has offset $1$ and begins
\[
4, 26, 78, 172, 324, 546, 850, 1252,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) -3*a(n-2) +2*a(n-3) -3*a(n-4) +3*a(n-5) -a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (May 17 2018 10:59:55, revision 8)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A200058.
