...
\title{The empirical recurrence for OEIS A198523, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A198523 counts arrays in which every cell is constrained by its neighbours on \emph{both}
...
OEIS A198523 is ``Number of nX3 0..4 arrays with values 0..4 introduced in row major order and each element equal to no more than two horizontal and vertical neighbors.''. It has offset $1$ and begins
\[
5, 193, 16714, 1877316, 222590953, 26670041125, 3201911378187, 384557171168810,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 07:54:10, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;140\,a(n-1) - 2296\,a(n-2) - 11502\,a(n-3) + 41183\,a(n-4) + 408760\,a(n-5) + 595837\,a(n-6) - 3718654\,a(n-7) - 13795951\,a(n-8) - 11064332\,a(n-9) + 29075688\,a(n-10) + 108107068\,a(n-11) + 134930012\,a(n-12) - 37607560\,a(n-13) - 266631136\,a(n-14) - 319325600\,a(n-15) - 322970496\,a(n-16) - 229207424\,a(n-17) + 130810368\,a(n-18) + 389159424\,a(n-19) + 272935936\,a(n-20) + 65761280\,a(n-21) - 8192000\,a(n-22) - 6356992\,a(n-23) - 786432\,a(n-24)
\end{equation}
for all $n>25$.
...
index,
\[
5!\Bigl(a(n)-\sum_i c_i\,a(n-i)\Bigr)\;=\;\mathbf{v}^{\!\top}G^{\,j-24}\,
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A198523.
