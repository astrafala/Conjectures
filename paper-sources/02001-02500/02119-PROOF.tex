...
\title{The empirical recurrence for OEIS A231067, proved by transfer matrix}
...
\begin{abstract}
OEIS A231067 counts the black-square subarrays of arrays of width $3$ over $\{0,1\}$ in which
...
OEIS A231067 is ``Number of black square subarrays of (n+1) X (2+1) binary arrays with no element equal to a strict majority of its diagonal and antidiagonal neighbors, with upper left element zero.''. It has offset $1$ and begins
\[
1, 3, 4, 11, 15, 42, 57, 161,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 5*a(n-2) - 5*a(n-4) + 2*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 26 2018 06:20:40, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231067.
