...
\title{The empirical recurrence for OEIS A221397, proved by transfer matrix}
...
\begin{abstract}
OEIS A221397 counts the distinct OCCUPANCY arrays obtained when every cell of an $n\times3$ grid
...
OEIS A221397 is ``Number of n X 3 arrays of occupancy after each element moves to some horizontal, diagonal or antidiagonal neighbor, with no 2-loops and with no occupancy greater than 2.''. It has offset $1$ and begins
\[
0, 6, 30, 144, 672, 3108, 14328, 65976,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 6*a(n-1) - 6*a(n-2)  -2*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 05 2018 08:21:13, revision 9) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221397.
