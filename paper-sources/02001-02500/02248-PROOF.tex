...
\title{The empirical recurrence for OEIS A211690, proved by transfer matrix}
...
\begin{abstract}
OEIS A211690 carries an empirical recurrence of order $28$ contributed by R. H. Hardin. It is
...
arrays counted are exactly the walks in it; hence $a(n)$ is a walk count on $S=138$ vertices
...
OEIS A211690 is ``Number of -4..4 arrays x(i) of n+1 elements i=1..n+1 with x(i)+x(j), x(i+1)+x(j+1), -(x(i)+x(j+1)), and -(x(i+1)+x(j)) having one, two or three distinct values for every i<=n and j<=n.''. It has offset $1$ and begins
\[
81, 233, 579, 1373, 3147, 7161, 16061, 36193,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 16:17:05, revision 8) this is still
...
admissible array is then exactly a walk, so with $M$ the adjacency matrix on $S=138$ vertices
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) + 11\,a(n-2) - 127\,a(n-3) + 27\,a(n-4) + 1183\,a(n-5) - 1132\,a(n-6) - 6381\,a(n-7) + 8929\,a(n-8) + 22055\,a(n-9) - 38648\,a(n-10) - 51000\,a(n-11) + 107487\,a(n-12) + 79800\,a(n-13) - 203031\,a(n-14) - 83121\,a(n-15) + 265573\,a(n-16) + 54369\,a(n-17) - 240368\,a(n-18) - 18623\,a(n-19) + 148011\,a(n-20) + 317\,a(n-21) - 59912\,a(n-22) + 2112\,a(n-23) + 15014\,a(n-24) - 650\,a(n-25) - 2080\,a(n-26) + 60\,a(n-27) + 120\,a(n-28)
\]
for every $n>28$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A211690.
