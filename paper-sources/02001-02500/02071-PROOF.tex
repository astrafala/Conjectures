...
\title{The empirical recurrence for OEIS A253024, proved by transfer matrix}
...
\begin{abstract}
OEIS A253024 counts arrays of width $9$ over an alphabet of $4$ letters in which every three
...
OEIS A253024 is ``Number of (n+2)X(7+2) 0..3 arrays with every consecutive three elements in every row and column not having exactly two distinct values, and in every diagonal and antidiagonal having exactly two distinct values, and new values 0 upwards introduced in row major order.''. It has offset $1$ and begins
\[
189, 243, 302, 369, 554, 720, 920, 1312,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-3) -a(n-6) -a(n-9) -a(n-12) -a(n-15) for n>20
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:52:02, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-3) - a(n-6) - a(n-9) - a(n-12) - a(n-15)
\]
for every $n>20$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253024.
