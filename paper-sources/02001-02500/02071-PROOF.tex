...
\title{The empirical recurrence for OEIS A203724, proved by transfer matrix}
...
\begin{abstract}
OEIS A203724 counts arrays of width $5$ over $\{0,1,2\}$ through two derived arrays of PAIR SUMS ---
...
OEIS A203724 is ``Number of (n+1)X5 0..2 arrays with column and row pair sums b(i,j)=a(i,j)+a(i,j-1) and c(i,j)=a(i,j)+a(i-1,j) nondecreasing in column and row directions, respectively.''. It has offset $1$ and begins
\[
888, 4737, 20290, 72777, 230014, 656441, 1728140, 4246268,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 10:40:40, revision 9) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A203724.
