...
\title{The empirical recurrence for OEIS A240256, proved by transfer matrix}
...
\begin{abstract}
OEIS A240256 counts arrays over $\{0,1,2,3\}$ in which no entry may equal, modulo $4$, a given
...
count is then a walk count on $S=53$ states.
\end{abstract}
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 09:43:54, revision 7) this is still
...
\text{northeast} & (i-1,j+1),(i-2,j+2),\dots & 1 \\
\end{array}
\]
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-1) - 20\,a(n-2) + 16\,a(n-3) + 4\,a(n-4) - 25\,a(n-5) + 53\,a(n-6) - 68\,a(n-7) + 100\,a(n-8) - 62\,a(n-9) - 41\,a(n-10) + 34\,a(n-11) - 117\,a(n-12) + 108\,a(n-13) - 54\,a(n-14) + 93\,a(n-15) + 41\,a(n-16) + 20\,a(n-17) + 8\,a(n-18) - 41\,a(n-19) - 26\,a(n-20) - 41\,a(n-21) + 9\,a(n-22) + 5\,a(n-23) + 2\,a(n-24) + 4\,a(n-25) - 13\,a(n-26) + 4\,a(n-27) - 3\,a(n-28) - 2\,a(n-29) + 4\,a(n-30) + a(n-31)
\]
for every $n>30$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A240256.
