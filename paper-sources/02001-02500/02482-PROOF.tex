...
\title{A further conjecture on OEIS A208639,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A208639 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $8, 34, 95, 225, 494, 1042, 2149, 4375,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = (-42 + 35*2\^{}n - 13*n - n\^{}2) / 2 for n>1.\end{quote}
