...
\title{A further conjecture on OEIS A187047,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A187047 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $0, 0, 28, 136, 360, 696, 1144, 1704,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = 56*n\^{}2 - 280*n + 360 for n>3\end{quote}
