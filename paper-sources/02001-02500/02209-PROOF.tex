...
\title{The empirical recurrence for OEIS A229574, proved by counting defective colourings}
...
\begin{abstract}
OEIS A229574 counts the colourings of an array with $K=4$ colours that are proper except at
...
OEIS A229574 is ``Number of defective 4-colorings of an n X 4 0..3 array connected horizontally, vertically, diagonally and antidiagonally with exactly one mistake, and colors introduced in row-major 0..3 order.''. It has offset $1$ and begins
\[
6, 80, 171, 312, 568, 1064, 2064, 4120,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 6*a(n-1) - 13*a(n-2) + 12*a(n-3) - 4*a(n-4) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 19 2018 06:13:45, revision 7) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A229574.
