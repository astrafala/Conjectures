...
\title{The empirical recurrence for OEIS A189606, proved by transfer matrix}
...
\begin{abstract}
OEIS A189606 counts the permutations of the cells of an $n\times5$ array in which every cell
...
That makes $a$ a walk count on $S=434$ states, hence $C$-finite, and whether the published
...
OEIS A189606 is ``Number of nX5 array permutations with each element not moving, or moving one space E, S or NW.''. It has offset $1$ and begins
\[
1, 28, 256, 2853, 30283, 321815, 3414588, 36212912,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 05:20:57, revision 9) this is still
...
$k+-6,\dots,k+5$ are taken --- a subset of a set of size $12$, and nothing else.
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=434,
\]
...
\begin{theorem}
\[
a(n)\;=\;13\,a(n-1) - 13\,a(n-2) - 128\,a(n-3) - 146\,a(n-4) + 1071\,a(n-5) + 769\,a(n-6) - 749\,a(n-7) - 2673\,a(n-8) + 3566\,a(n-9) - 13757\,a(n-10) + 7250\,a(n-11) - 4937\,a(n-12) - 1246\,a(n-13) + 3164\,a(n-14) + 189\,a(n-15) - 984\,a(n-16) + 566\,a(n-17) + 329\,a(n-18) - 189\,a(n-19) + 54\,a(n-20) + 27\,a(n-21)
\]
for every $n>22$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A189606.
