...
\title{The empirical recurrence for OEIS A239420, proved by transfer matrix}
...
\begin{abstract}
OEIS A239420 counts arrays over $\{0,1,2,3\}$ in which no entry may equal, modulo $4$, a given
...
OEIS A239420 is ``Number of nX2 0..3 arrays with no element equal to the sum of elements to its left or the sum of elements above it or the sum of the elements diagonally to its northwest, modulo 4.''. It has offset $1$ and begins
\[
6, 18, 80, 320, 1244, 4990, 19560, 77220,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 09:28:22, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A239420.
