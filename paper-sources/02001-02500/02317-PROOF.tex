...
\title{The empirical recurrence for OEIS A221088, proved by transfer matrix}
...
\begin{abstract}
OEIS A221088 counts the distinct OCCUPANCY arrays obtained when every cell of an $n\times2$ grid
...
determinising the machine that emits the occupancy row by row turns it into one, on $S=50$
...
OEIS A221088 is ``Number of 2 X n arrays of occupancy after each element moves to some horizontal or antidiagonal neighbor.''. It has offset $1$ and begins
\[
0, 4, 24, 169, 1155, 7921, 54288, 372100,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 7*a(n-1) - 7*a(n-3) + a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 03 2018 08:22:28, revision 8) this is still
...
\]
There are $S=50$ reachable sets. In particular $a$ is $C$-finite.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221088.
