...
\title{The empirical recurrence for OEIS A198909, proved by counting patterns}
...
\begin{abstract}
OEIS A198909 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
$11$, contributed by R.~H.~Hardin, then follows from a finite exact computation.
\end{abstract}
...
OEIS A198909 is ``Number of nX3 0..7 arrays with values 0..7 introduced in row major order and no element equal to any horizontal or vertical neighbor.''. It has offset $1$ and begins
\[
2, 34, 2051, 269940, 54381563, 13088156547, 3352514013159, 876632051686733,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 08:02:01, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;431\,a(n-1) - 53038\,a(n-2) + 2570412\,a(n-3) - 55789402\,a(n-4) + 610919758\,a(n-5) - 3707175288\,a(n-6) + 13010264300\,a(n-7) - 26380804149\,a(n-8) + 29517406483\,a(n-9) - 16243626186\,a(n-10) + 3246286680\,a(n-11)
\end{equation}
for all $n>11$.
...
For every $n$ with $m=n+0-1\ge11$,
\[
8!\Bigl(a(n)-\sum_i c_i\,a(n-i)\Bigr)\;=\;\mathbf{v}^{\!\top}N^{\,m-11}q(N)\mathbf{1} .
\]
...
\begin{proof}
Substitute \eqref{eq:walk} into the left side and factor $N^{m-11}$ out of
...
column. The vector $w=q(N)\mathbf{1}$ was then formed by $11$ matrix--vector products
...
corresponding to $n=11+1$ onwards, and the run continued until $w$ was the zero vector,
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A198909.
