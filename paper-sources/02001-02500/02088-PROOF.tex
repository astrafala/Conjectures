...
\title{The empirical recurrence for OEIS A198663, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A198663 counts arrays in which every cell is constrained by its neighbours on \emph{both}
...
order $14$, contributed by R.~H.~Hardin, then follows from a finite exact computation.
\end{abstract}
...
OEIS A198663 is ``Number of nX2 0..4 arrays with values 0..4 introduced in row major order and each element equal to one or two horizontal and vertical neighbors.''. It has offset $1$ and begins
\[
1, 3, 13, 65, 401, 2798, 21243, 170477,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 07:58:57, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;12\,a(n-1) - 18\,a(n-2) - 96\,a(n-3) - 43\,a(n-4) + 384\,a(n-5) + 1030\,a(n-6) + 276\,a(n-7) - 1609\,a(n-8) - 3144\,a(n-9) - 1688\,a(n-10) + 1080\,a(n-11) + 1536\,a(n-12) + 768\,a(n-13) - 512\,a(n-14)
\end{equation}
for all $n>16$.
...
index,
\[
5!\Bigl(a(n)-\sum_i c_i\,a(n-i)\Bigr)\;=\;\mathbf{v}^{\!\top}G^{\,j-14}\,
\Bigl(h_{14}-\sum_i c_i h_{14-i}\Bigr)
\]
...
$w=h_{14}-\sum_i c_ih_{14-i}$; and it is enough to check $m=0,1,\dots,S-1$.
\end{lemma}
...
index corresponding to $n=16+1$ onwards, and the run was continued until $S+1$
...
\eqref{eq:walk2}, divided by $5!$, was evaluated at every one of the $21$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A198663.
