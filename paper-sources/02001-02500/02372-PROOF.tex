...
\title{The empirical recurrence for OEIS A199899, proved from an exact model}
...
\begin{abstract}
OEIS A199899 carries an empirical recurrence of order $4$. It is true, and it is
...
OEIS A199899 is ``Number of -n..n arrays x(0..3) of 4 elements with zero sum, and adjacent elements not both strictly positive and not both strictly negative.''. It has offset $1$ and begins
\[
15, 49, 111, 209, 351, 545, 799, 1121,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (4/3)*n\^{}3 + 6*n\^{}2 + (20/3)*n + 1. a(n) = 4*a(n-1) - 6*a(n-2) + 4*a(n-3) - a(n-4) for n>4.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 23 2018 07:28:24, revision 8)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A199899.
