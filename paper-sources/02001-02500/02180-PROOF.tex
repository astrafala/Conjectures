...
\title{The empirical recurrence for OEIS A210409, proved by counting patterns}
...
\begin{abstract}
OEIS A210409 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
$31$, contributed by R.~H.~Hardin, then follows from a finite exact computation.
\end{abstract}
...
OEIS A210409 is ``Number of (n+1)X5 0..3 arrays with every 2X2 subblock having three or four distinct values, and new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
9576, 2574592, 677993552, 178971208720, 47230418649056, 12464482425454304, 3289463792785895520, 868112796901730209328,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 15:59:12, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;276\,a(n-1) - 844\,a(n-2) - 647137\,a(n-3) + 5856940\,a(n-4) + 402216721\,a(n-5) - 5862695617\,a(n-6) - 54643074114\,a(n-7) + 1382343039112\,a(n-8) - 3102790608576\,a(n-9) - 89911455972644\,a(n-10) + 660007977690996\,a(n-11) + 263588914646272\,a(n-12) - 18055429128783448\,a(n-13) + 51374341139205968\,a(n-14) + 113931146918069408\,a(n-15) - 752286799961769696\,a(n-16) + 423125539061919552\,a(n-17) + 3650072001026978048\,a(n-18) - 6040761986311450112\,a(n-19) - 5385080244386082816\,a(n-20) + 17461611564608397312\,a(n-21) - 2457130524259205120\,a(n-22) - 16604319853477298176\,a(n-23) + 6207057768744222720\,a(n-24) + 6168586199070932992\,a(n-25) - 2183260302370406400\,a(n-26) - 667625816443584512\,a(n-27) + 191550881093648384\,a(n-28) + 17950332629811200\,a(n-29) - 3348386568732672\,a(n-30) + 49529562857472\,a(n-31)
\end{equation}
for all $n>31$.
...
For every $n$ with $m=n+1-1\ge31$,
\[
4!\Bigl(a(n)-\sum_i c_i\,a(n-i)\Bigr)\;=\;\mathbf{v}^{\!\top}N^{\,m-31}q(N)\mathbf{1} .
\]
...
\begin{proof}
Substitute \eqref{eq:walk} into the left side and factor $N^{m-31}$ out of
...
column. The vector $w=q(N)\mathbf{1}$ was then formed by $31$ matrix--vector products
...
corresponding to $n=31+1$ onwards, and the run continued until $w$ was the zero vector,
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A210409.
