...
\title{The empirical recurrence for OEIS A252899, proved by transfer matrix}
...
\begin{abstract}
OEIS A252899 counts arrays of width $3$ over an alphabet of $4$ letters in which every three
...
brings the state count down to $S=135$.
\end{abstract}
...
OEIS A252899 is ``Number of (n+2)X(1+2) 0..3 arrays with every consecutive three elements in every row and column having exactly two distinct values, and new values 0 upwards introduced in row major order.''. It has offset $1$ and begins
\[
384, 2793, 19320, 139968, 997740, 7214139, 51847038, 374336607,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:44:11, revision 7) this is still
...
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,
\]
with $S=135$ states in all. The walk index $j$ and the entry's own $n$ differ by a constant,
...
\begin{theorem}
\[
a(n)\;=\;11\,a(n-1) - 7\,a(n-2) - 209\,a(n-3) + 345\,a(n-4) + 556\,a(n-5) + 2595\,a(n-6) - 5153\,a(n-7) - 22977\,a(n-8) + 2730\,a(n-9) + 70674\,a(n-10) + 123435\,a(n-11) - 145260\,a(n-12) - 314385\,a(n-13) + 142857\,a(n-14) + 214776\,a(n-15) - 26298\,a(n-16) - 31806\,a(n-17) + 2187\,a(n-18)
\]
for every $n>17$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252899.
