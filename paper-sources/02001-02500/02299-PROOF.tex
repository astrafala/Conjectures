...
\title{The empirical closed form for OEIS A223617, proved}
...
\begin{abstract}
OEIS A223617 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A223617 is ``Number of n X 5 0..1 arrays with rows and columns unimodal.''. It has offset $1$ and begins
\[
16, 256, 2582, 17594, 89630, 367216, 1271969, 3857481,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 21:52:39, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{359 n^{10}}{453600} + \frac{251 n^{9}}{30240} + \frac{3817 n^{8}}{60480} + \frac{73 n^{7}}{280} + \frac{1127 n^{6}}{1350} + \frac{485 n^{5}}{288} + \frac{532219 n^{4}}{181440} + \frac{25699 n^{3}}{7560} + \frac{30811 n^{2}}{8400} + \frac{451 n}{210} + 1.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223617.
