...
\title{The empirical closed form for OEIS A224392, proved}
...
\begin{abstract}
OEIS A224392 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A224392 is ``Number of 3 X n 0..3 arrays with diagonals and antidiagonals unimodal and rows nondecreasing.''. It has offset $1$ and begins
\[
64, 1000, 6094, 27790, 102232, 319769, 881519, 2196522,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 30 2018 06:07:29, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{353 n^{9}}{181440} + \frac{17 n^{8}}{560} + \frac{9731 n^{7}}{30240} + \frac{1283 n^{6}}{720} + \frac{52457 n^{5}}{8640} + \frac{776 n^{4}}{45} + \frac{294499 n^{3}}{11340} + \frac{28837 n^{2}}{2520} + \frac{8207 n}{126} - 18.
\]
...
$n=12,\dots,21$ and agree at each. A monic recurrence of order $10$
determines $a(m)$ from $a(m-1),\dots,a(m-10)$, and for every $m\ge22$ both
$m>11$ and $m-10\ge12$ hold, so induction on $m$ gives $a(m)=f(m)$ for every
$m\ge12$.
Below $n=12$ the recurrence argument gives nothing, since \eqref{eq:rec} is only
established for $a$ from $n=12$ on. The remaining indices $n=2,\dots,11$ were
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224392.
