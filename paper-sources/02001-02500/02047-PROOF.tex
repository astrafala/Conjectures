...
\title{Arrays counted up to renaming: the empirical recurrence for OEIS A204964}
...
\begin{abstract}
OEIS A204964 carries an empirical recurrence of order $15$ contributed by R.~H.~Hardin. It is
...
both in the state the arrays are exactly the walks in a digraph on $S=16$ vertices, so $a(n)$
...
OEIS A204964 is ``Number of (n+2)X3 0..1 arrays with every 3X3 subblock having three equal elements in a row horizontally, vertically, diagonally or antidiagonally at least two different ways, and new values 0..1 introduced in row major order.''. It has offset $1$ and begins
\[
166, 1001, 6086, 36522, 219755, 1323027, 7962992, 47928592,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 11:38:34, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) + 6\,a(n-3) - 28\,a(n-4) - 25\,a(n-5) + 4\,a(n-6) + 2\,a(n-7) + 85\,a(n-8) - 46\,a(n-9) + 68\,a(n-10) + 46\,a(n-11) - 20\,a(n-12) + 12\,a(n-13) - 48\,a(n-14) + 16\,a(n-15)
\]
for every $n>13$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204964.
