...
\title{The empirical recurrence for OEIS A231249, proved by transfer matrix}
...
\begin{abstract}
OEIS A231249 counts arrays of width $4$ over $\{0,1,2,3\}$ in which every cell must see, among its
...
carries an empirical recurrence of order $22$ contributed by R.~H.~Hardin. It is true, and
it is decidable rather than empirical: a cell's neighbours lie in three consecutive rows, so
the count is a walk count on $S=2217$ states.
\end{abstract}
...
OEIS A231249 is ``Number of 4Xn 0..3 arrays x(i,j) with each element horizontally, diagonally or antidiagonally next to at least one element with value (x(i,j)+1) mod 4, no adjacent elements equal, and upper left element zero.''. It has offset $1$ and begins
\[
0, 20, 552, 5992, 76264, 1081934, 15270416, 213355654,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 06:20:20, revision 6) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=2217.
\]
...
\begin{theorem}
\[
a(n)\;=\;15\,a(n-1) - 25\,a(n-2) + 148\,a(n-3) + 122\,a(n-4) - 1205\,a(n-5) - 2750\,a(n-6) - 2119\,a(n-7) + 1020\,a(n-8) + 18937\,a(n-9) + 50454\,a(n-10) + 61769\,a(n-11) - 6359\,a(n-12) - 151941\,a(n-13) - 166619\,a(n-14) + 30896\,a(n-15) + 129574\,a(n-16) + 38876\,a(n-17) - 30440\,a(n-18) - 29584\,a(n-19) - 9952\,a(n-20) + 1728\,a(n-21) + 1280\,a(n-22)
\]
for every $n>23$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231249.
