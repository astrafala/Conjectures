...
\title{The empirical closed form for OEIS A219699, proved}
...
\begin{abstract}
OEIS A219699 states an explicit closed form for $a(n)$ and records it as empirical. It is true, and
...
OEIS A219699 is ``Number of n X 3 arrays of the minimum value of corresponding elements and their horizontal, vertical or antidiagonal neighbors in a random, but sorted with lexicographically nondecreasing rows and columns, 0..1 n X 3 array.''. It has offset $1$ and begins
\[
3, 5, 13, 25, 45, 78, 130, 208,\ \dots
\]
and states:
\begin{quote}
Empirical: a(n) = (1/24)*n\^{}4 + (1/12)*n\^{}3 - (25/24)*n\^{}2 + (107/12)*n - 10 for n>1.
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 27 2018 06:11:48, revision 8)
...
\begin{theorem}
The closed form OEIS A219699 records is correct for all $n>1$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A219699.
