...
\title{The empirical recurrence for OEIS A268908, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A268908 counts arrays over $\{0,\dots,2\}$ subject to a condition on the array as a
...
OEIS A268908 is ``Number of 5 X n 0..2 arrays with some element plus some horizontally or antidiagonally adjacent neighbor totalling two exactly once.''. It has offset $1$ and begins
\[
0, 6912, 98496, 1347192, 17194680, 214142760, 2611960344, 31382176824,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 10 2022 14:24:19, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;32\,a(n-1) - 384\,a(n-2) + 2200\,a(n-3) - 6494\,a(n-4) + 9016\,a(n-5) - 816\,a(n-6) - 14888\,a(n-7) + 18879\,a(n-8) - 5464\,a(n-9) - 7472\,a(n-10) + 8336\,a(n-11) - 3648\,a(n-12) + 768\,a(n-13) - 64\,a(n-14)
\end{equation}
for all $n>18$.
...
those integers vanishes from the index corresponding to $n=18+1$ onwards, and the run
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268908.
