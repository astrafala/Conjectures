...
\title{A further conjecture on OEIS A207936,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A207936 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $22, 484, 2706, 9430, 25490, 58602, 120276, 226850,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = (720 - 1584*n - 6206*n\^{}2 + 7335*n\^{}3 + 6505*n\^{}4 + 1089*n\^{}5 + 61*n\^{}6) / 360.\end{quote}
