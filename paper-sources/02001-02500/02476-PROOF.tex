...
\title{A further conjecture on OEIS A184545,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A184545 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $415, 1114, 2413, 4774, 8989, 16345, 28844, 49489,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (1/40320)*n\^{}8 + (13/10080)*n\^{}7 + (83/2880)*n\^{}6 + (13/36)*n\^{}5 + (15967/5760)*n\^{}4 + (19201/1440)*n\^{}3 + (121183/1120)*n\^{}2 + (12673/56)*n + 64.\end{quote}
...
indices, and $a$ and $f$ were checked to agree at $n=10,\dots,18$,
