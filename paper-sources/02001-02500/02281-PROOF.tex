...
\title{A value repeated at its own distance: OEIS A209469}
...
\begin{abstract}
OEIS A209469 carries an empirical recurrence of order $11$ contributed by R.~H.~Hardin. It is
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) - 2\,a(n-2) - a(n-4) + 4\,a(n-5) - 3\,a(n-6) + 3\,a(n-7) + a(n-8) - 2\,a(n-9) + a(n-10) - a(n-11)
\]
for every $n>11$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209469.
