...
\title{A further conjecture on OEIS A223443,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A223443 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $28, 104, 408, 1616, 6432, 25664, 102528, 409856,\dots$, with offset $1$. The sequence satisfies
\[
  a(n)=6\,a(n-1) - 8\,a(n-2) ,
\]
...
\begin{quote}\raggedright a(n) = 2\^{}(n-2) * (4+25*2\^{}n) for n>1.\end{quote}
