...
\title{A further conjecture on OEIS A187174,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A187174 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $0, 0, 0, 8, 48, 176, 384, 664,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = 36*n\^{}2 - 260*n + 440 for n>5.\end{quote}
