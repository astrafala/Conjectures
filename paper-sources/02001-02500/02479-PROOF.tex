...
\title{A further conjecture on OEIS A185469,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A185469 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $1169, 4594, 13659, 34779, 79743, 169052, 336690, 636698,\dots$, with offset $1$. The sequence satisfies
\[
  a(n)=10\,a(n-1) - 45\,a(n-2) + 120\,a(n-3) - 210\,a(n-4) + 252\,a(n-5) - 210\,a(n-6) + 120\,a(n-7) - 45\,a(n-8) + 10\,a(n-9) - 1\,a(n-10) ,
\]
a linear recurrence of order $10$ with characteristic polynomial
\[
  q(x)=x^{10} - 10 x^{9} + 45 x^{8} - 120 x^{7} + 210 x^{6} - 252 x^{5} + 210 x^{4} - 120 x^{3} + 45 x^{2} - 10 x + 1 .
\]
...
\begin{quote}\raggedright Empirical: a(n) = (1/362880)*n\^{}9 + (1/1008)*n\^{}8 + (431/12096)*n\^{}7 + (373/720)*n\^{}6 + (82453/17280)*n\^{}5 + (637/18)*n\^{}4 + (2819461/18144)*n\^{}3 + (119729/315)*n\^{}2 + (605807/1260)*n + 112\end{quote}
