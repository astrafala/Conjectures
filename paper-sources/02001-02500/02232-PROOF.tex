...
\title{The empirical recurrence for OEIS A202799, proved by transfer matrix}
...
\begin{abstract}
OEIS A202799 counts arrays of width $5$ over $\{0,1\}$ in which every cell of a named value has a neighbour of that same value. The entry carries an
...
OEIS A202799 is ``Number of nX5 binary arrays with every one adjacent to another one horizontally or vertically.''. It has offset $1$ and begins
\[
12, 454, 11988, 311144, 8222576, 217145076, 5730640104, 151245101550,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 09:55:37, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;27\,a(n-1) - 82\,a(n-2) + 1720\,a(n-3) - 876\,a(n-4) + 36142\,a(n-5) + 36267\,a(n-6) + 228084\,a(n-7) + 1329202\,a(n-8) - 3356034\,a(n-9) - 15601554\,a(n-10) + 6682402\,a(n-11) + 62222338\,a(n-12) + 8454105\,a(n-13) - 144765880\,a(n-14) - 62367040\,a(n-15) + 251331688\,a(n-16) + 212121408\,a(n-17) - 212078096\,a(n-18) - 315914880\,a(n-19) - 123060608\,a(n-20) - 12403456\,a(n-21) + 277981952\,a(n-22) + 391540736\,a(n-23) + 190742528\,a(n-24) + 156106752\,a(n-25) + 22544384\,a(n-26) + 16777216\,a(n-27)
\]
for every $n>26$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A202799.
