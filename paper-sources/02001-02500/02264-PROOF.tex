...
\title{The empirical recurrence for OEIS A281051, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A281051 imposes three things at once: a condition on each cell that reaches one row up and
...
OEIS A281051 is ``Number of n X 3 0..1 arrays with no element equal to more than one of its horizontal and antidiagonal neighbors, with the exception of exactly two elements, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
0, 6, 68, 376, 1492, 4988, 15028, 42252,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 5*a(n-1) - 6*a(n-2) - 4*a(n-3) + 8*a(n-4) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 15 2019 04:40:42, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A281051.
