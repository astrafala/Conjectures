...
\title{The empirical recurrence for OEIS A198655, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A198655 counts arrays in which every cell is constrained by its neighbours on \emph{both}
...
lumpable, cutting $204$ pairs down to $S=15$ states. The entry's empirical recurrence of
...
OEIS A198655 is ``Number of n X 1 0..7 arrays with values 0..7 introduced in row major order and each element equal to at least one horizontal or vertical neighbor.''. It has offset $1$ and begins
\[
0, 1, 1, 2, 3, 6, 11, 23,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 02 2018 06:27:22, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;7\,a(n-1) + a(n-2) - 97\,a(n-3) + 105\,a(n-4) + 531\,a(n-5) - 757\,a(n-6) - 1511\,a(n-7) + 2143\,a(n-8) + 2457\,a(n-9) - 2689\,a(n-10) - 2227\,a(n-11) + 1198\,a(n-12) + 840\,a(n-13)
\end{equation}
for all $n>14$.
...
Fix $i$ and let $V_i=\{0,\dots,i-1\}^{1}$. Because \eqref{eq:loc} at a cell of row
...
partitions of the $2\cdot1$ cells of a pair into at most $i$ classes.
\end{lemma}
...
Assembling the $8$ lumped chains block-diagonally into $N$ of size $S=15$, with the
...
index,
\[
8!\Bigl(a(n)-\sum_i c_i\,a(n-i)\Bigr)\;=\;\mathbf{v}^{\!\top}G^{\,j-13}\,
...
index corresponding to $n=14+1$ onwards, and the run was continued until $S+1$
...
\eqref{eq:walk2}, divided by $8!$, was evaluated at every one of the $32$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A198655.
