...
\title{The empirical recurrence for OEIS A275354, proved by transfer matrix}
...
\begin{abstract}
OEIS A275354 counts arrays in which no entry may equal the entries at a short list of fixed offsets
from it, the arrays being counted up to renaming the letters. The entry carries an empirical
recurrence of order $41$ contributed by R.~H.~Hardin. It is true, and it is decidable
...
$2$ consecutive columns, $S=1413$ states in all.
\end{abstract}
...
OEIS A275354 is ``Number of 4Xn 0..2 arrays with no element equal to any value at offset (-2,-1) (-2,1) or (-1,-2) and new values introduced in order 0..2.''. It has offset $1$ and begins
\[
14, 216, 1024, 6156, 38256, 239112, 1530060, 9861340,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 24 2016 10:06:32, revision 4) this is still
...
\[
x(i,j)\ \ne\ x(i+d_1,\,j+d_2)\qquad\text{for each offset }(d_1,d_2)\in\{(-2,-1), (-2,1), (-1,-2)\}
\]
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=1413.
\]
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-1) - 7\,a(n-2) - 21\,a(n-3) + 109\,a(n-4) - 222\,a(n-5) - 1637\,a(n-6) - 1753\,a(n-7) + 4997\,a(n-8) - 35222\,a(n-9) + 99987\,a(n-10) - 192426\,a(n-11) + 427454\,a(n-12) - 488826\,a(n-13) + 530306\,a(n-14) - 497569\,a(n-15) + 15083932\,a(n-16) + 7508480\,a(n-17) - 6448250\,a(n-18) - 31426160\,a(n-19) - 127501000\,a(n-20) - 100384864\,a(n-21) - 411105760\,a(n-22) + 98743024\,a(n-23) + 328054264\,a(n-24) + 1816349760\,a(n-25) - 2229093184\,a(n-26) - 48225424\,a(n-27) - 546260224\,a(n-28) + 3769886144\,a(n-29) - 3333766656\,a(n-30) + 9405700992\,a(n-31) + 655658496\,a(n-32) + 3745889280\,a(n-33) - 7061796864\,a(n-34) + 1526999040\,a(n-35) - 1038127104\,a(n-36) + 6676660224\,a(n-37) - 4144545792\,a(n-38) - 3583180800\,a(n-39) + 6019743744\,a(n-40) - 10319560704\,a(n-41)
\]
for every $n>43$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A275354.
