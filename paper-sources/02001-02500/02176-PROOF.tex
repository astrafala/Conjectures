...
\title{The empirical recurrence for OEIS A267783, proved by transfer matrix}
...
\begin{abstract}
OEIS A267783 counts arrays in which the REPEATED VALUES of each row, and of each column, stand in a
...
OEIS A267783 is ``Number of n X 3 0..1 arrays with every repeated value in every row greater than or equal to, and in every column greater than, the previous repeated value.''. It has offset $1$ and begins
\[
8, 64, 216, 729, 1728, 4096, 8000, 15625,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 11 2019 11:48:03, revision 11) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267783.
