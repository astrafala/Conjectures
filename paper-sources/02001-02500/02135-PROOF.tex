...
\title{The empirical recurrence for OEIS A209893, proved by counting patterns}
...
\begin{abstract}
OEIS A209893 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
$23$, contributed by R.~H.~Hardin, then follows from a finite exact computation.
\end{abstract}
...
OEIS A209893 is ``Number of (n+1)X5 0..2 arrays with every 2X2 subblock having two distinct values, and new values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
792, 19008, 470736, 11857440, 299879808, 7597233712, 192567994720, 4881998439024,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 15:34:12, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;37\,a(n-1) - 224\,a(n-2) - 2979\,a(n-3) + 29449\,a(n-4) + 46557\,a(n-5) - 1073860\,a(n-6) + 1135122\,a(n-7) + 15431403\,a(n-8) - 33807620\,a(n-9) - 96498020\,a(n-10) + 305903160\,a(n-11) + 230102448\,a(n-12) - 1252267328\,a(n-13) + 63674496\,a(n-14) + 2499686528\,a(n-15) - 1105423872\,a(n-16) - 2340302336\,a(n-17) + 1583680512\,a(n-18) + 822790144\,a(n-19) - 753893376\,a(n-20) - 7176192\,a(n-21) + 78643200\,a(n-22) - 10485760\,a(n-23)
\end{equation}
for all $n>23$.
...
For every $n$ with $m=n+1-1\ge23$,
\[
3!\Bigl(a(n)-\sum_i c_i\,a(n-i)\Bigr)\;=\;\mathbf{v}^{\!\top}N^{\,m-23}q(N)\mathbf{1} .
\]
...
\begin{proof}
Substitute \eqref{eq:walk} into the left side and factor $N^{m-23}$ out of
...
column. The vector $w=q(N)\mathbf{1}$ was then formed by $23$ matrix--vector products
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209893.
