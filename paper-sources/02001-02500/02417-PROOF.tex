...
\title{The empirical recurrence for OEIS A281606, proved by transfer matrix}
...
\begin{abstract}
OEIS A281606 counts $3\times n$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A281606 is ``Number of 3Xn 0..2 arrays with no element equal to more than one of its horizontal, diagonal or antidiagonal neighbors and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
5, 50, 209, 1283, 8180, 49572, 302304, 1849212,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 25 2017 10:41:35, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) - 4\,a(n-2) + 29\,a(n-3) - 15\,a(n-4) + 73\,a(n-5) + 11\,a(n-6) - 32\,a(n-7) + 6\,a(n-8) + a(n-9) - 30\,a(n-10) - 26\,a(n-11) + 10\,a(n-12) + 8\,a(n-13)
\]
for every $n>15$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A281606.
