...
\title{The empirical recurrence for OEIS A268088, proved by transfer matrix}
...
\begin{abstract}
OEIS A268088 counts arrays in which the REPEATED VALUES of each row, and of each column, stand in a
...
OEIS A268088 is ``Number of nX3 0..2 arrays with every repeated value in every row not one larger and in every column one larger mod 3 than the previous repeated value, and upper left element zero.''. It has offset $1$ and begins
\[
9, 243, 4608, 83349, 1339893, 20699712, 303284403, 4320438183,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 26 2016 07:02:11, revision 5) this is still
...
\begin{theorem}
\[
a(n)\;=\;27\,a(n-1) - 88\,a(n-2) - 2949\,a(n-3) + 19763\,a(n-4) + 105684\,a(n-5) - 917208\,a(n-6) - 1283256\,a(n-7) + 14673312\,a(n-8) + 279936\,a(n-9) - 60466176\,a(n-10)
\]
for every $n>10$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268088.
