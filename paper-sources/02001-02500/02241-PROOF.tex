...
\title{The empirical recurrence for OEIS A189327, proved from an exact model}
...
\begin{abstract}
OEIS A189327 carries an empirical recurrence of order $4$. It is true, and it is
...
OEIS A189327 is ``Number of nondecreasing arrangements of 4 numbers in 0..n with the last equal to n and each after the second equal to the sum of one or two of the preceding four.''. It has offset $1$ and begins
\[
2, 6, 7, 12, 12, 18, 17, 24,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-2) -a(n-4)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 05:10:22, revision 9)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A189327.
