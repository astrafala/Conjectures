...
\title{A further conjecture on OEIS A187508,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A187508 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $0, 6, 31, 74, 135, 214, 311, 426,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = 9*n\^{}2 - 20*n + 10 for n>1.\end{quote}
