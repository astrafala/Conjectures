...
\title{A further conjecture on OEIS A229572,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A229572 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $1, 6, 26, 80, 216, 544, 1312, 3072,\dots$, with offset $1$. The sequence satisfies
\[
  a(n)=4\,a(n-1) - 4\,a(n-2) ,
\]
...
\begin{quote}\raggedright a(n) = 2\^{}(n-2) * (7*n-8) for n>1. (End)\end{quote}
