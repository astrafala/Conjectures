...
\title{The empirical recurrence for OEIS A252855, proved by transfer matrix}
...
\begin{abstract}
OEIS A252855 counts arrays of width $4$ over an alphabet of $3$ letters in which every three
...
OEIS A252855 is ``Number of (n+2) X (2+2) 0..2 arrays with every consecutive three elements in every row, column, diagonal and antidiagonal having exactly two distinct values, and new values 0 upwards introduced in row major order.''. It has offset $1$ and begins
\[
279, 432, 738, 1296, 2502, 4986, 9936, 20052,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + a(n-2) + 3*a(n-3) + a(n-4) - 3*a(n-5) - 4*a(n-6) - 2*a(n-7) + 2*a(n-8) + 2*a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 07 2018 11:50:01, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + a(n-2) + 3\,a(n-3) + a(n-4) - 3\,a(n-5) - 4\,a(n-6) - 2\,a(n-7) + 2\,a(n-8) + 2\,a(n-9)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252855.
