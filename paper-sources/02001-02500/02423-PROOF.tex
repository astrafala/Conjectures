...
\title{The empirical recurrence for OEIS A266077, proved by transfer matrix}
...
\begin{abstract}
OEIS A266077 counts arrays of width $4$ in which every entry is equal to the NUMBER of its own
...
OEIS A266077 is ``Number of nX4 integer arrays with each element equal to the number of horizontal and vertical neighbors differing from itself by exactly one.''. It has offset $1$ and begins
\[
1, 1, 6, 5, 7, 26, 23, 35,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 20 2015 17:28:20, revision 4) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=10079.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A266077.
