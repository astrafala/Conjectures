...
\title{The empirical recurrence for OEIS A249708, proved from an exact model}
...
\begin{abstract}
OEIS A249708 carries an empirical recurrence of order $5$. It is true, and it is
...
\begin{quote}
Empirical: a(n) = (1/2)*n\^{}4 + 4*n\^{}3 + (11/2)*n\^{}2 + 3*n + 1. a(n) = 5*a(n-1) - 10*a(n-2) + 10*a(n-3) - 5*a(n-4) + a(n-5) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 09 2018 14:20:29, revision 8)
