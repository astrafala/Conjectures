...
\title{The empirical recurrence for OEIS A183907, proved from an exact model}
...
\begin{abstract}
OEIS A183907 carries an empirical recurrence of order $5$. It is true, and it is
...
\begin{quote}
Empirical: a(n) = (1/24)*n\^{}4 + (3/4)*n\^{}3 + (119/24)*n\^{}2 - (95/4)*n + 23 for n>1. a(n) = 5*a(n-1) - 10*a(n-2) + 10*a(n-3) - 5*a(n-4) + a(n-5) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 05 2018 18:22:00, revision 8)
