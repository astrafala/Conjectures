...
\title{The empirical recurrence for OEIS A202983, proved by transfer matrix}
...
\begin{abstract}
OEIS A202983 counts arrays of width $3$ over $\{0,1,2\}$ in which every nonzero cell has a neighbour at least as large as itself. The entry carries an
...
OEIS A202983 is ``Number of nX3 0..2 arrays with every nonzero element less than or equal to some NW, E or S neighbor.''. It has offset $1$ and begins
\[
1, 63, 1233, 16854, 239196, 3557168, 52328419, 764541713,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 10:01:10, revision 9) this is still
...
Thus
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=622,
\]
...
\begin{theorem}
\[
a(n)\;=\;27\,a(n-1) - 271\,a(n-2) + 1899\,a(n-3) - 11048\,a(n-4) + 44346\,a(n-5) - 113218\,a(n-6) + 201165\,a(n-7) - 291398\,a(n-8) + 360023\,a(n-9) - 334000\,a(n-10) + 199528\,a(n-11) - 66264\,a(n-12) + 9212\,a(n-13)
\]
for every $n>13$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A202983.
