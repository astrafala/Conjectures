...
\title{The empirical recurrence for OEIS A205610, proved by transfer matrix}
...
\begin{abstract}
OEIS A205610 counts, up to renaming the letters, the arrays of width $3$ over at most $4$
letters in which horizontally neighbouring $2\times2$ subblocks have the same number of equal edges and vertically neighbouring ones have different numbers. It carries an empirical recurrence of order $14$ contributed by
...
OEIS A205610 is ``Number of 3 X (n+1) 0..3 arrays with every 2 X 2 subblock having the same number of equal edges as its horizontal neighbors and a different number from its vertical neighbors, and new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
110, 1030, 9688, 95564, 946066, 9502090, 96151010, 982430426,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 20 2022 23:39:17, revision 7) this is still
...
$w_i$ cleared of denominators and $S=2964$ states in all. The walk index $j$ and the entry's own
...
\begin{theorem}
\[
a(n)\;=\;17\,a(n-1) + 31\,a(n-2) - 1380\,a(n-3) + 24\,a(n-4) + 37716\,a(n-5) + 28069\,a(n-6) - 327857\,a(n-7) - 359875\,a(n-8) + 1111408\,a(n-9) + 1460528\,a(n-10) - 1281648\,a(n-11) - 2003792\,a(n-12) + 11264\,a(n-13) + 365568\,a(n-14)
\]
for every $n>14$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A205610.
