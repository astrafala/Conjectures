...
\title{A further conjecture on OEIS A165373,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A165373 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $37, 305, 1409, 4569, 11449, 24225, 45585, 78729,\dots$, with offset $2$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = (1107 - 1060*n + 716*n\^{}2 - 320*n\^{}3 + 64*n\^{}4) / 3 for n>2.\end{quote}
