...
\title{A further conjecture on OEIS A063133,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A063133 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $5, 20, 32, 48, 60, 76, 88, 104,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = (-1)\^{}n + 14*n - 9 for n>1.\end{quote}
