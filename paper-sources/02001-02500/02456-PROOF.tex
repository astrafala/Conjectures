...
\title{A further conjecture on OEIS A063146,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A063146 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $11, 38, 66, 94, 122, 150, 178, 206,\dots$, with offset $1$. The sequence satisfies
\[
  a(n)=2\,a(n-1) - 1\,a(n-2) ,
\]
...
\begin{quote}\raggedright a(n) = 28*n - 18 for n>1.\end{quote}
