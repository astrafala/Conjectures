...
\title{A further conjecture on OEIS A183624,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A183624 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $19, 45, 115, 309, 859, 2445, 7075, 20709,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = 2 + 2\^{}(2+n) + 3\^{}(1+n).\end{quote}
