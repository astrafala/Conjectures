...
\title{The empirical recurrence for OEIS A189430, proved by transfer matrix}
...
\begin{abstract}
OEIS A189430 counts the permutations of the cells of an $n\times4$ array in which every cell
...
carried is which images inside a window of $10$ consecutive positions are already taken.
That makes $a$ a walk count on $S=70$ states, hence $C$-finite, and whether the published
...
OEIS A189430 is ``Number of nX4 array permutations with each element not moving, or moving one space N, SW or SE.''. It has offset $1$ and begins
\[
1, 5, 29, 140, 841, 4653, 26589, 151081,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 05:12:57, revision 9) this is still
...
\section{A window of 10 positions}

Number the cells in row-major order, $k=i\cdot4+j$. An offset $(\delta_1,\delta_2)$ moves a
cell by $\delta_14+\delta_2$ places in that order, so every image lies between $lo=-4$ and
...
taken yet. What has to be remembered is therefore exactly which of the $10$ positions
$k+-4,\dots,k+5$ are taken --- a subset of a set of size $10$, and nothing else.
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + 6\,a(n-2) + 15\,a(n-3) + 32\,a(n-4) + 31\,a(n-5) - 139\,a(n-6) - 38\,a(n-7) - 687\,a(n-8) - 1137\,a(n-9) - 2150\,a(n-10) - 2761\,a(n-11) - 2277\,a(n-12) - 6462\,a(n-13) - 713\,a(n-14) - 1533\,a(n-15) + 1533\,a(n-17) + 713\,a(n-18) + 6462\,a(n-19) + 2277\,a(n-20) + 2761\,a(n-21) + 2150\,a(n-22) + 1137\,a(n-23) + 687\,a(n-24) + 38\,a(n-25) + 139\,a(n-26) - 31\,a(n-27) - 32\,a(n-28) - 15\,a(n-29) - 6\,a(n-30) - 4\,a(n-31) + a(n-32)
\]
for every $n>31$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A189430.
