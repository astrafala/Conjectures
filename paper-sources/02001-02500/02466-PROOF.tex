...
\title{The empirical recurrence for OEIS A211579, proved by transfer matrix}
...
\begin{abstract}
OEIS A211579 carries an empirical recurrence of order $23$ contributed by R. H. Hardin. It is
...
OEIS A211579 is ``Number of -2..2 arrays x(i) of n+1 elements i=1..n+1 with set{t,u,v in 0,1}((x[i+t]+x[j+u]+x[k+v])*(-1)\^{}(t+u+v)) having one, three, four, five or six distinct values for every i,j,k<=n.''. It has offset $1$ and begins
\[
17, 61, 185, 505, 1301, 3279, 8057, 19877,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 16:14:36, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-1) + 5\,a(n-2) - 135\,a(n-3) + 146\,a(n-4) + 1064\,a(n-5) - 1994\,a(n-6) - 4450\,a(n-7) + 11503\,a(n-8) + 10456\,a(n-9) - 38079\,a(n-10) - 12441\,a(n-11) + 78724\,a(n-12) + 1556\,a(n-13) - 103670\,a(n-14) + 15762\,a(n-15) + 85188\,a(n-16) - 20943\,a(n-17) - 40966\,a(n-18) + 11896\,a(n-19) + 10080\,a(n-20) - 3060\,a(n-21) - 936\,a(n-22) + 288\,a(n-23)
\]
for every $n>23$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A211579.
