...
\title{A further conjecture on OEIS A063154,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A063154 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $10, 31, 53, 75, 97, 119, 141, 163,\dots$, with offset $1$. The sequence satisfies
\[
  a(n)=2\,a(n-1) - 1\,a(n-2) ,
\]
...
\begin{quote}\raggedright a(n) = 22*n-13 for n>1.\end{quote}
