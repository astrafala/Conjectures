...
\title{A further conjecture on OEIS A200786,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A200786 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $16, 75, 225, 530, 1071, 1946, 3270, 5175,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = (24 + 106*n + 151*n\^{}2 + 86*n\^{}3 + 17*n\^{}4) / 24.\end{quote}
