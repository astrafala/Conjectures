...
\title{A further conjecture on OEIS A063152,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A063152 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $11, 42, 74, 106, 138, 170, 202, 234,\dots$, with offset $1$. The sequence satisfies
\[
  a(n)=2\,a(n-1) - 1\,a(n-2) ,
\]
...
\begin{quote}\raggedright a(n) = 32*n - 22 for n>1.\end{quote}
