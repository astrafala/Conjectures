...
\title{The empirical recurrence for OEIS A197051, proved by transfer matrix}
...
\begin{abstract}
OEIS A197051 counts arrays of width $5$ in which every entry is equal to the NUMBER of its own
...
OEIS A197051 is ``Number of nX5 0..4 arrays with each element equal to the number its horizontal and vertical zero neighbors.''. It has offset $1$ and begins
\[
4, 10, 38, 108, 358, 1132, 3580, 11382,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 24 2024 03:13:53, revision 13) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The array has $5$ cells across. The NEIGHBOURS of a cell are the cells reached from it by the
offsets
\[
(-1,0), (0,-1), (0,1), (1,0),
\]
those that lie inside the array. The condition is that every entry counts its own neighbours
that are zero: writing $v=x(i,j)$,
\[
v\;=\;\#\{\text{neighbours } y \text{ of } (i,j)\ :\ y=0\} .
\]
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=71947.
\]
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 4\,a(n-2) + 10\,a(n-3) + 4\,a(n-4) - 20\,a(n-5) + a(n-6) - 2\,a(n-7) + 2\,a(n-8) - 16\,a(n-9) + 4\,a(n-10) + a(n-13)
\]
for every $n>14$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A197051.
