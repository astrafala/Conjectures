...
\title{The empirical recurrence for OEIS A203500, proved by transfer matrix}
...
\begin{abstract}
OEIS A203500 counts arrays of width $2$ over $\{0,1,\dots,6\}$ in which every nonzero cell has a neighbour at least as large as itself. The entry carries an
...
OEIS A203500 is ``Number of nX2 0..6 arrays with every nonzero element less than or equal to some NW, E or S neighbor.''. It has offset $1$ and begins
\[
1, 49, 1554, 29701, 481122, 7959529, 138035591, 2413093119,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 10:31:23, revision 9) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The arrays have $2$ columns and a growing number of rows, with entries in $\{0,1,\dots,6\}$. Fix the
...
Thus
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=1814,
\]
...
\begin{theorem}
\[
a(n)\;=\;49\,a(n-1) - 1064\,a(n-2) + 14504\,a(n-3) - 139300\,a(n-4) + 974216\,a(n-5) - 5049458\,a(n-6) + 19784160\,a(n-7) - 59856834\,a(n-8) + 143372114\,a(n-9) - 282160674\,a(n-10) + 474196544\,a(n-11) - 679931029\,a(n-12) + 791307252\,a(n-13) - 707690496\,a(n-14) + 480221913\,a(n-15) - 265555686\,a(n-16) + 125326699\,a(n-17) - 42652674\,a(n-18) + 8555625\,a(n-19)
\]
for every $n>18$.
\end{theorem}
...
array of width $2$ over $\{0,1,\dots,6\}$ with a few rows was written out cell by cell and each cell
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A203500.
