...
\title{The empirical recurrence for OEIS A275032, proved by counting patterns}
...
\begin{abstract}
OEIS A275032 counts arrays in which no entry may repeat a value found at any of three stated
...
cutting $794$ pairs to $S=155$ states. The entry's empirical recurrence of order $16$,
...
OEIS A275032 is ``Number of nX3 0..2 arrays with no element equal to any value at offset (0,-1) (-1,-2) or (-2,0) and new values introduced in order 0..2.''. It has offset $1$ and begins
\[
2, 16, 46, 146, 450, 1428, 4463, 14086,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 14 2016 09:49:18, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 6\,a(n-2) - 20\,a(n-3) - 2\,a(n-4) + 46\,a(n-5) - 42\,a(n-6) - 31\,a(n-7) + 70\,a(n-8) - 5\,a(n-9) - 30\,a(n-10) - 2\,a(n-11) + 8\,a(n-12) + 5\,a(n-13) - 3\,a(n-14) - 2\,a(n-15) + a(n-16)
\end{equation}
for all $n>17$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A275032.
