...
\title{The empirical recurrence for OEIS A189276, proved by transfer matrix}
...
\begin{abstract}
OEIS A189276 counts the permutations of the cells of an $n\times5$ array in which every cell
...
That makes $a$ a walk count on $S=190$ states, hence $C$-finite, and whether the published
...
OEIS A189276 is ``Number of nX5 array permutations with each element not moved or moved diagonally or antidiagonally by one.''. It has offset $1$ and begins
\[
1, 64, 1125, 29241, 670480, 15594601, 361199937, 8366395024,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 05:08:36, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;25\,a(n-1) - 1067\,a(n-3) + 1111\,a(n-4) + 19248\,a(n-5) - 37086\,a(n-6) + 40374\,a(n-7) - 18000\,a(n-8) - 44874\,a(n-9) + 111258\,a(n-10) - 91872\,a(n-11) + 9999\,a(n-12) - 13743\,a(n-13) - 891\,a(n-15) - 81\,a(n-16)
\]
for every $n>15$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A189276.
