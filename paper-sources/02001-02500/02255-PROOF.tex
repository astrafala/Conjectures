...
\title{The empirical recurrence for OEIS A221604, proved by transfer matrix}
...
\begin{abstract}
OEIS A221604 counts the distinct OCCUPANCY arrays obtained when every cell of an $n\times3$ grid
...
one, on $S=49$ states, after which the conjectured recurrence is settled by a finite exact
computation.
\end{abstract}
...
OEIS A221604 is ``Number of n X 3 arrays of occupancy after each element moves to some horizontal or antidiagonal neighbor, without move-in move-out left turns.''. It has offset $1$ and begins
\[
2, 10, 54, 287, 1522, 8072, 42810, 227042,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 6*a(n-1) - 4*a(n-2) + 2*a(n-3) - 2*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 09 2018 15:11:11, revision 8) this is still
...
$S=49$ reachable sets. In particular $a$ is $C$-finite.
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) - 4\,a(n-2) + 2\,a(n-3) - 2\,a(n-4)
\]
for every $n>4$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221604.
