...
\title{A further conjecture on OEIS A229600,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A229600 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $0, 6, 39, 202, 925, 3924, 15795, 61182,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = 3\^{}(n-5) * (31*n+32*n\^{}2-30) for n>2.\end{quote}
