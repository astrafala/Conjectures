...
\title{A further conjecture on OEIS A187510,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A187510 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $0, 0, 40, 184, 435, 788, 1243, 1800,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = 51*n\^{}2 - 208*n + 200 for n>3.\end{quote}
