...
\title{The empirical recurrence for OEIS A205266, proved by transfer matrix}
...
\begin{abstract}
OEIS A205266 counts $(n+2)\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A205266 is ``Number of (n+2)X3 0..1 arrays with every 3X3 subblock having three equal elements in a row horizontally, vertically or nw-to-se diagonally, and new values 0..1 introduced in row major order.''. It has offset $1$ and begins
\[
223, 1606, 11553, 82991, 596414, 4285989, 30799890, 221334561,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 11:56:36, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) + 5\,a(n-2) + 26\,a(n-3) - 6\,a(n-4) + 14\,a(n-5) - 44\,a(n-6) + 23\,a(n-7) + 10\,a(n-8) - 15\,a(n-9) - 12\,a(n-10) - 12\,a(n-11)
\]
for every $n>10$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A205266.
