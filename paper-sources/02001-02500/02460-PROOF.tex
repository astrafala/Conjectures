...
\title{A further conjecture on OEIS A183630,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A183630 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $7075, 8109, 10195, 14421, 23035, 40749, 77635, 155781,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = 6050 + 127*2\^{}(2+n) + 3\^{}(1+n).\end{quote}
