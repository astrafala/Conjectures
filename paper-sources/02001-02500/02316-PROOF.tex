...
\title{The empirical recurrence for OEIS A200431, proved from an exact model}
...
\begin{abstract}
OEIS A200431 carries an empirical recurrence of order $4$. It is true, and it is
...
OEIS A200431 is ``Number of -n..n arrays x(0..3) of 4 elements with zero sum and no two or three adjacent elements summing to zero.''. It has offset $1$ and begins
\[
0, 20, 92, 248, 520, 940, 1540, 2352,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (16/3)*n\^{}3 - 6*n\^{}2 + (2/3)*n. a(n) = 4*a(n-1) - 6*a(n-2) + 4*a(n-3) - a(n-4) for n>4.
\end{quote}
As of the ``Last modified'' line on the live entry (May 20 2018 14:18:17, revision 8)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A200431.
