...
\title{The empirical recurrence for OEIS A204392, proved by transfer matrix}
...
\begin{abstract}
OEIS A204392 counts $(n+2)\times4$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A204392 is ``Number of (n+2) X 4 0..1 arrays with no 3 X 3 subblock having three equal diagonal elements or three equal antidiagonal elements, and new values 0..1 introduced in row major order.''. It has offset $1$ and begins
\[
648, 4050, 27378, 175232, 1131008, 7311488, 47258642, 305390898,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 04 2022 22:37:36, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 15\,a(n-2) + 89\,a(n-3) + 211\,a(n-4) + 375\,a(n-5) + 149\,a(n-6) - 29\,a(n-7) - 195\,a(n-8) - 61\,a(n-9) + 61\,a(n-10) + 195\,a(n-11) + 29\,a(n-12) - 149\,a(n-13) - 375\,a(n-14) - 211\,a(n-15) - 89\,a(n-16) - 15\,a(n-17) - a(n-18) + a(n-19)
\]
for every $n>18$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204392.
