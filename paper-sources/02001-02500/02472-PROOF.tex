...
\title{A further conjecture on OEIS A207700,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A207700 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $15, 225, 1071, 3321, 8151, 17225, 32775, 57681,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = (3 - 10*n - 15*n\^{}2 + 44*n\^{}3 + 21*n\^{}4 + 2*n\^{}5) / 3.\end{quote}
