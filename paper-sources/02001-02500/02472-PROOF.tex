...
\title{A further conjecture on OEIS A184541,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A184541 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $89, 193, 340, 537, 792, 1114, 1513, 2000,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (1/24)*n\^{}4 + (3/4)*n\^{}3 + (383/24)*n\^{}2 + (201/4)*n + 22.\end{quote}
