...
\title{The empirical recurrence for OEIS A219411, proved by transfer matrix}
...
\begin{abstract}
OEIS A219411 counts the distinct indicator arrays obtained from the $n\times2$ arrays over
...
OEIS A219411 is ``Unmatched value maps: number of 2 X n binary arrays indicating the locations of corresponding elements not equal to any horizontal or antidiagonal neighbor in a random 0..2 2 X n array.''. It has offset $1$ and begins
\[
1, 7, 28, 98, 351, 1261, 4523, 16233,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) - 3*a(n-2) + 6*a(n-3) - 3*a(n-4) + 4*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 26 2018 05:16:59, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) - 3\,a(n-2) + 6\,a(n-3) - 3\,a(n-4) + 4\,a(n-5)
\]
for every $n>5$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A219411.
