...
\title{The empirical recurrence for OEIS A203725, proved by transfer matrix}
...
\begin{abstract}
OEIS A203725 counts arrays of width $6$ over $\{0,1,2\}$ through two derived arrays of PAIR SUMS ---
...
OEIS A203725 is ``Number of (n+1)X6 0..2 arrays with column and row pair sums b(i,j)=a(i,j)+a(i,j-1) and c(i,j)=a(i,j)+a(i-1,j) nondecreasing in column and row directions, respectively.''. It has offset $1$ and begins
\[
2278, 12470, 58048, 230014, 808455, 2572189, 7508980, 20395251,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 10:40:48, revision 9) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The array $a$ has $6$ cells across, with entries in $\{0,1,2\}$. Two derived arrays are formed,
\[
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-1) - 21\,a(n-2) + 105\,a(n-4) - 168\,a(n-5) - 91\,a(n-6) + 512\,a(n-7) - 330\,a(n-8) - 560\,a(n-9) + 910\,a(n-10) - 910\,a(n-12) + 560\,a(n-13) + 330\,a(n-14) - 512\,a(n-15) + 91\,a(n-16) + 168\,a(n-17) - 105\,a(n-18) + 21\,a(n-20) - 8\,a(n-21) + a(n-22)
\]
for every $n>30$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A203725.
