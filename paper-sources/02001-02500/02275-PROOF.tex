...
\title{The empirical recurrence for OEIS A241126, proved by transfer matrix}
...
\begin{abstract}
OEIS A241126 counts arrays of width $3$ over $\{0,\dots,2\}$ under a condition on each cell
...
a walk count on $S=830$ of them, and the conjectured recurrence is then settled by a finite
exact computation.
\end{abstract}
...
OEIS A241126 is ``Number of nX3 0..2 arrays with no element equal to exactly two horizontal and vertical neighbors, with new values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
4, 54, 723, 9773, 132369, 1792237, 24269723, 328645291,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 11:10:53, revision 6) this is still
...
\]
a triangular system with unit diagonal, so the entry's count $N_1+\dots+N_{3}$ is a
...
$2-v$'' and ``equal to the sum modulo $k$'' all compare or combine letters arithmetically.
...
terms. There are $S=830$ states, and $a$ is $C$-finite.
...
first term. There are $3^{3}=27$ possible rows over the entry's own alphabet.
...
\begin{theorem}
\[
a(n)\;=\;14\,a(n-1) - 7\,a(n-2) + 27\,a(n-3) - 170\,a(n-4) - 631\,a(n-5) - 1135\,a(n-6) + 5278\,a(n-7) - 3113\,a(n-8) + 5125\,a(n-9) + 13678\,a(n-10) - 10325\,a(n-11) + 15744\,a(n-12) - 52520\,a(n-13) - 13756\,a(n-14) - 110176\,a(n-15) + 64424\,a(n-16) - 53672\,a(n-17) - 13552\,a(n-18) + 87456\,a(n-19) - 198528\,a(n-20) + 71552\,a(n-21) - 44288\,a(n-22) - 116224\,a(n-23) - 4096\,a(n-24) - 122880\,a(n-25) - 65536\,a(n-26)
\]
for every $n>26$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A241126.
