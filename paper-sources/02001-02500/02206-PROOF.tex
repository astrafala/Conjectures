...
\title{The empirical recurrence for OEIS A269584, proved from an exact model}
...
\begin{abstract}
OEIS A269584 carries an empirical recurrence of order $5$. It is true, and it is
...
OEIS A269584 is ``Number of length-4 0..n arrays with no repeated value differing from the previous repeated value by more than one.''. It has offset $1$ and begins
\[
16, 79, 250, 613, 1276, 2371, 4054, 6505,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = n\^{}4 + 4*n\^{}3 + 5*n\^{}2 + 5*n + 1. a(n) = 5*a(n-1) - 10*a(n-2) + 10*a(n-3) - 5*a(n-4) + a(n-5) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 24 2019 11:44:34, revision 7)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269584.
