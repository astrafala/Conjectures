...
\title{The empirical recurrence for OEIS A229589, proved by counting defective colourings}
...
\begin{abstract}
OEIS A229589 counts the colourings of an array with $K=3$ colours that are proper except at
...
OEIS A229589 is ``Number of defective 3-colorings of a 4 X n 0..2 array connected horizontally and antidiagonally with exactly one mistake, and colors introduced in row-major 0..2 order.''. It has offset $1$ and begins
\[
0, 224, 2160, 19764, 167364, 1375152, 11035044, 87040260,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 18*a(n-1) - 111*a(n-2) + 282*a(n-3) - 333*a(n-4) + 180*a(n-5) - 36*a(n-6) for n > 12.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 27 2021 21:21:26, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A229589.
