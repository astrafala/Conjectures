...
\title{The empirical recurrence for OEIS A223997, proved by transfer matrix}
...
\begin{abstract}
OEIS A223997 counts arrays over $\{0,\dots,2\}$ whose rows, columns, diagonals or
antidiagonals are required to be monotone or unimodal, and carries an empirical recurrence of
order $39$ contributed by R.~H.~Hardin. A monotone condition is local, but a unimodal one
...
OEIS A223997 is ``Number of nX6 0..2 arrays with antidiagonals unimodal and rows and diagonals nondecreasing.''. It has offset $1$ and begins
\[
28, 469, 4614, 36845, 281271, 2160036, 16795265, 131782267,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 23:09:55, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;28\,a(n-1) - 300\,a(n-2) + 1417\,a(n-3) - 1482\,a(n-4) - 11436\,a(n-5) + 31851\,a(n-6) + 52359\,a(n-7) - 290782\,a(n-8) + 153075\,a(n-9) + 602260\,a(n-10) - 176604\,a(n-11) - 1863678\,a(n-12) + 536713\,a(n-13) + 8514601\,a(n-14) - 7251292\,a(n-15) - 64571700\,a(n-16) + 163992784\,a(n-17) - 63488599\,a(n-18) + 75157211\,a(n-19) - 574679221\,a(n-20) + 1117201234\,a(n-21) - 1103109981\,a(n-22) + 247796355\,a(n-23) - 1415805562\,a(n-24) + 12828520548\,a(n-25) - 5049431870\,a(n-26) + 5717879992\,a(n-27) + 7921013636\,a(n-28) + 14497424532\,a(n-29) - 1161322200\,a(n-30) + 7782865280\,a(n-31) + 2703305984\,a(n-32) + 21857003968\,a(n-33) + 1446146688\,a(n-34) + 6372675072\,a(n-35) - 1634756608\,a(n-36) + 2474711040\,a(n-37) - 114278400\,a(n-38) + 967065600\,a(n-39)
\end{equation}
for all $n>44$.
...
$h_j=G^{j}N^{o}\mathbf{1}$, we have for $j\ge39$
\[
a(n_0+j)-\sum_i c_i\,a(n_0+j-i)=\,\mathbf{v}^{\!\top}G^{\,j-39}w,
\qquad w=h_{39}-\sum_i c_ih_{39-i} .
\]
...
index corresponding to $n=44+1$ onwards, and the run continued until $S+1$ consecutive
zeros had been seen.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223997.
