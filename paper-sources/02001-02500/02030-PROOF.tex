...
\title{The empirical recurrence for OEIS A262315, proved by transfer matrix}
...
\begin{abstract}
OEIS A262315 counts arrays of width $5$ over $\{0,1\}$ whose rows, read as base-$2$
...
OEIS A262315 is ``Number of (n+2)X(3+2) 0..1 arrays with each row and column divisible by 7, read as a binary number with top and left being the most significant bits.''. It has offset $1$ and begins
\[
5, 9, 17, 133, 361, 1009, 8357, 33993,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 17 2015 22:20:56, revision 4) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A262315.
