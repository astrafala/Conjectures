...
\title{The empirical recurrence for OEIS A214190, proved by transfer matrix}
...
\begin{abstract}
OEIS A214190 counts the proper colourings of a grid $3\times(n+1)$, wrapped in the growing direction, with at most $7$ colours and
...
down to $S=281$ and makes the exact residual test affordable.
\end{abstract}
...
OEIS A214190 is ``Number of 0..6 colorings of a 3X(n+1) array circular in the n+1 direction with new values 0..6 introduced in row major order.''. It has offset $1$ and begins
\[
34, 1046, 147943, 21418431, 3375824210, 537471327779, 85978533129243, 13765597336821245,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 16:56:09, revision 8) this is still
...
state count is $S=281$ rather than the number of colourings.
...
\begin{theorem}
\[
a(n)\;=\;139\,a(n-1) + 5515\,a(n-2) - 286157\,a(n-3) - 9529273\,a(n-4) + 113179647\,a(n-5) + 4029123791\,a(n-6) - 21482035001\,a(n-7) - 665136918315\,a(n-8) + 3470737828565\,a(n-9) + 52035528093885\,a(n-10) - 353663596245035\,a(n-11) - 1772488823978235\,a(n-12) + 18597082646494445\,a(n-13) + 6436724051209165\,a(n-14) - 461676350902794315\,a(n-15) + 989689896962549920\,a(n-16) + 4490761773386882420\,a(n-17) - 20885571816583158340\,a(n-18) + 2406786493445125820\,a(n-19) + 135386533520490778816\,a(n-20) - 242458279252260285504\,a(n-21) - 117064394722434074400\,a(n-22) + 741048574341017155392\,a(n-23) - 533060382247946111232\,a(n-24) - 464734745166440627712\,a(n-25) + 719025841858074960384\,a(n-26) - 101164868845572040704\,a(n-27) - 184396432098202951680\,a(n-28) + 60855200138907648000\,a(n-29)
\]
for every $n>28$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A214190.
