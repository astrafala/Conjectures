...
\title{The empirical recurrence for OEIS A198288, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A198288 counts arrays in which every cell is constrained by its neighbours on \emph{both}
...
order $23$, contributed by R.~H.~Hardin, then follows from a finite exact computation.
\end{abstract}
...
OEIS A198288 is ``Number of 2nX4 0..3 arrays with values 0..3 introduced in row major order and each element equal to exactly one horizontal and vertical neighbor.''. It has offset $1$ and begins
\[
17, 2452, 413375, 72559212, 12940532183, 2322145946560, 417688220022251, 75197892524349728,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 07:51:41, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;341\,a(n-1) - 38970\,a(n-2) + 2135218\,a(n-3) - 67448667\,a(n-4) + 1375490159\,a(n-5) - 19754442612\,a(n-6) + 216233988876\,a(n-7) - 1930500555319\,a(n-8) + 14641614117891\,a(n-9) - 95232147538058\,a(n-10) + 525211971434290\,a(n-11) - 2391181584630749\,a(n-12) + 8566626104248057\,a(n-13) - 21804187934100424\,a(n-14) + 26325592371676176\,a(n-15) + 62458261081740144\,a(n-16) - 409636534740954048\,a(n-17) + 948362811460747776\,a(n-18) - 580420633538230272\,a(n-19) - 2477378037254639616\,a(n-20) + 6262481237853487104\,a(n-21) - 5586587527536967680\,a(n-22) + 1769580684990480384\,a(n-23)
\end{equation}
for all $n>23$.
...
index,
\[
4!\Bigl(a(n)-\sum_i c_i\,a(n-i)\Bigr)\;=\;\mathbf{v}^{\!\top}G^{\,j-23}\,
\Bigl(h_{23}-\sum_i c_i h_{23-i}\Bigr)
\]
...
$w=h_{23}-\sum_i c_ih_{23-i}$; and it is enough to check $m=0,1,\dots,S-1$.
\end{lemma}
...
index corresponding to $n=23+1$ onwards, and the run was continued until $S+1$
...
\eqref{eq:walk2}, divided by $4!$, was evaluated at every one of the $12$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A198288.
