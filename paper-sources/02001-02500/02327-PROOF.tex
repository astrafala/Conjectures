...
\title{The empirical recurrence for OEIS A221414, proved by transfer matrix}
...
\begin{abstract}
OEIS A221414 counts the distinct OCCUPANCY arrays obtained when every cell of an $n\times3$ grid
...
determinising the machine that emits the occupancy row by row turns it into one, on $S=37$
...
OEIS A221414 is ``Number of nX3 arrays of occupancy after each element stays put or moves to some horizontal or antidiagonal neighbor, with every occupancy equal to zero or two.''. It has offset $1$ and begins
\[
0, 10, 0, 150, 0, 2250, 0, 33750,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 15*a(n-2)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 19:38:01, revision 9) this is still
...
\]
There are $S=37$ reachable sets. In particular $a$ is $C$-finite.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221414.
