...
\title{The empirical recurrence for OEIS A223665, proved by transfer matrix}
...
\begin{abstract}
OEIS A223665 counts arrays over $\{0,\dots,1\}$ whose rows, columns, diagonals or
antidiagonals are required to be monotone or unimodal, and carries an empirical recurrence of
order $23$ contributed by R.~H.~Hardin. A monotone condition is local, but a unimodal one
...
is a walk count on $S=2816$ vertices and the recurrence follows from a finite exact
computation.
\end{abstract}
...
OEIS A223665 is ``Number of nX4 0..1 arrays with rows, diagonals and antidiagonals unimodal.''. It has offset $1$ and begins
\[
11, 121, 948, 6454, 44693, 321163, 2343189, 17087771,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 22:02:54, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;9\,a(n-1) - 8\,a(n-2) - 63\,a(n-3) + 250\,a(n-4) - 152\,a(n-5) - 522\,a(n-6) - 2735\,a(n-7) + 4120\,a(n-8) + 9651\,a(n-9) + 1347\,a(n-10) - 13682\,a(n-11) - 24899\,a(n-12) + 6443\,a(n-13) + 11258\,a(n-14) + 8578\,a(n-15) - 11567\,a(n-16) + 8480\,a(n-17) + 22660\,a(n-18) - 17587\,a(n-19) + 2236\,a(n-20) + 4536\,a(n-21) - 2700\,a(n-22) - 864\,a(n-23)
\end{equation}
for all $n>23$.
...
bit vector), $|\mathcal V|=S=2816$; let $(r,f)\to(s,f')$ be an edge when placing $s$ after $r$
...
$h_j=G^{j}N^{o}\mathbf{1}$, we have for $j\ge23$
\[
a(n_0+j)-\sum_i c_i\,a(n_0+j-i)=\,\mathbf{v}^{\!\top}G^{\,j-23}w,
\qquad w=h_{23}-\sum_i c_ih_{23-i} .
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223665.
