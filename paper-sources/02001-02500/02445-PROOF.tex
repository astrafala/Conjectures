...
\title{A further conjecture on OEIS A063130,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A063130 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $7, 22, 38, 54, 70, 86, 102, 118,\dots$, with offset $1$. The sequence satisfies
\[
  a(n)=2\,a(n-1) - 1\,a(n-2) ,
\]
...
\begin{quote}\raggedright a(n) = 2*(8*n-5) for n>1.\end{quote}
