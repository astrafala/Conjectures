...
\title{The empirical recurrence for OEIS A275135, proved by transfer matrix}
...
\begin{abstract}
OEIS A275135 counts arrays in which no entry may equal the entries at a short list of fixed offsets
...
$2$ consecutive columns, $S=2047$ states in all.
\end{abstract}
...
OEIS A275135 is ``Number of 6Xn 0..2 arrays with no element equal to any value at offset (-2,-2) (-1,0) or (-1,1) and new values introduced in order 0..2.''. It has offset $1$ and begins
\[
16, 324, 1083, 8321, 62378, 473185, 3586068, 27224209,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 17 2016 11:04:51, revision 4) this is still
...
\[
x(i,j)\ \ne\ x(i+d_1,\,j+d_2)\qquad\text{for each offset }(d_1,d_2)\in\{(-2,-2), (-1,0), (-1,1)\}
\]
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=2047.
\]
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 32\,a(n-2) + 117\,a(n-3) + 301\,a(n-4) - 196\,a(n-5) - 6255\,a(n-6) - 3361\,a(n-7) - 3603\,a(n-8) - 22745\,a(n-9) + 165021\,a(n-10) + 8504\,a(n-11) - 100758\,a(n-12) + 692296\,a(n-13) - 1045155\,a(n-14) - 356088\,a(n-15) + 1094300\,a(n-16) - 3137949\,a(n-17) + 2346676\,a(n-18) + 3048039\,a(n-19) - 3364817\,a(n-20) + 4783757\,a(n-21) + 1001864\,a(n-22) - 4054644\,a(n-23) + 818224\,a(n-24) - 774400\,a(n-26)
\]
for every $n>28$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A275135.
