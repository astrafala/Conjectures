...
\title{The empirical recurrence for OEIS A221597, proved from an exact model}
...
\begin{abstract}
OEIS A221597 carries an empirical recurrence of order $3$. It is true, and it is
...
OEIS A221597 is ``Number of 0..n arrays of length 5 with each element differing from at least one neighbor by 1 or less.''. It has offset $1$ and begins
\[
32, 139, 342, 651, 1068, 1593, 2226, 2967,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 54*n\^{}2 - 69*n + 63 for n>2. a(n) = 3*a(n-1) - 3*a(n-2) + a(n-3) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 09 2018 08:56:27, revision 8)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221597.
