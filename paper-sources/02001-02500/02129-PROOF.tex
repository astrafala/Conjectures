...
\title{The empirical recurrence for OEIS A274725, proved by counting patterns}
...
\begin{abstract}
OEIS A274725 counts arrays in which no entry may repeat a value found at any of three stated
...
cutting $60074$ pairs to $S=10355$ states. The entry's empirical recurrence of order $15$,
...
OEIS A274725 is ``Number of nX5 0..2 arrays with no element equal to any value at offset (-1,-2) (-2,-1) or (-1,0) and new values introduced in order 0..2.''. It has offset $1$ and begins
\[
41, 384, 1300, 10368, 84948, 687248, 5634776, 45990340,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 03 2016 20:00:36, revision 4) the statement is
...
$o=1n_0+0-2$, we have for $j\ge15$
\[
3!\Bigl(a(n_0+j)-\sum_i c_i\,a(n_0+j-i)\Bigr)
=\mathbf{v}^{\!\top}G^{\,j-15}w,\qquad
w=h_{15}-\sum_i c_i h_{15-i} .
\]
...
the survivors by the pattern of the new pair. The vector $w$ was formed by $15$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A274725.
