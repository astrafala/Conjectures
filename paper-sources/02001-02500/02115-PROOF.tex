...
\title{The empirical recurrence for OEIS A200433, proved from an exact model}
...
\begin{abstract}
OEIS A200433 carries an empirical recurrence of order $6$. It is true, and it is
...
\begin{quote}
Empirical: a(n) = (88/5)*n\^{}5 - (109/3)*n\^{}4 + 44*n\^{}3 - (107/3)*n\^{}2 + (52/5)*n. a(n) = 6*a(n-1) - 15*a(n-2) + 20*a(n-3) - 15*a(n-4) + 6*a(n-5) - a(n-6) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (May 21 2018 08:48:21, revision 9)
