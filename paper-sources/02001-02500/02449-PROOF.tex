...
\title{The empirical recurrence for OEIS A209894, proved by counting patterns}
...
\begin{abstract}
OEIS A209894 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
state space down from $794$ to $S=155$. The entry's empirical recurrence of order
$67$, contributed by R.~H.~Hardin, then follows from a finite exact computation.
\end{abstract}
...
OEIS A209894 is ``Number of (n+1)X6 0..2 arrays with every 2X2 subblock having two distinct values, and new values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
3824, 156800, 6762544, 299879808, 13410113952, 602072007808, 27070584920080, 1217939572945968,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 15:34:20, revision 10) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;59\,a(n-1) + 104\,a(n-2) - 42972\,a(n-3) + 225150\,a(n-4) + 13058670\,a(n-5) - 99533244\,a(n-6) - 2197387878\,a(n-7) + 19875267460\,a(n-8) + 229851257770\,a(n-9) - 2366141610633\,a(n-10) - 15894063929471\,a(n-11) + 186716781277733\,a(n-12) + 749911518956427\,a(n-13) - 10357596907410544\,a(n-14) - 24242602552629694\,a(n-15) + 419545423349562323\,a(n-16) + 513419955614790263\,a(n-17) - 12743636649243029327\,a(n-18) - 5588724654850929951\,a(n-19) + 295948232414959255193\,a(n-20) - 41030128867263773257\,a(n-21) - 5330465080579574799097\,a(n-22) + 3096535616962170688023\,a(n-23) + 75245900033979090263854\,a(n-24) - 70343205102961136452140\,a(n-25) - 838515904703767168682000\,a(n-26) + 1033530787470818142569456\,a(n-27) + 7408191483521721497325888\,a(n-28) - 11102771711988258151207232\,a(n-29) - 51956877639237774786347264\,a(n-30) + 91197930041539107221974784\,a(n-31) + 288637005364861044268135424\,a(n-32) - 584918449332204408531975168\,a(n-33) - 1261391919782270562967646208\,a(n-34) + 2960105091371020869876793344\,a(n-35) + 4274172957537436605506322432\,a(n-36) - 11873183283623499865326174208\,a(n-37) - 10900689087152926975005589504\,a(n-38) + 37756515336414977978883178496\,a(n-39) + 19498582274969148853931212800\,a(n-40) - 94868879756767967625610788864\,a(n-41) - 18957098993963844384982564864\,a(n-42) + 187014088298245520981590278144\,a(n-43) - 10916938203208559688348073984\,a(n-44) - 285860793239614379638877323264\,a(n-45) + 79644827524571502161338302464\,a(n-46) + 332665796495918740601567182848\,a(n-47) - 159698020481282454813413474304\,a(n-48) - 286182176633624129437528227840\,a(n-49) + 196804266468189564590637449216\,a(n-50) + 172676696186043581657438486528\,a(n-51) - 164414144679340498216040792064\,a(n-52) - 64875360508321568620864864256\,a(n-53) + 93966732830765490489645858816\,a(n-54) + 8984417088496218246521815040\,a(n-55) - 35640178748572809806303199232\,a(n-56) + 4005503615190852715862294528\,a(n-57) + 8337517133060640365135003648\,a(n-58) - 2350211162187270322185568256\,a(n-59) - 1012217318863117434857979904\,a(n-60) + 494800755740146443961237504\,a(n-61) + 26276649640154457035505664\,a(n-62) - 44578672501261648598663168\,a(n-63) + 5284342715267323252441088\,a(n-64) + 1083745547797691306606592\,a(n-65) - 284446307629606977404928\,a(n-66) + 17414014635957968437248\,a(n-67)
\end{equation}
for all $n>67$.
...
Assembling the $3$ lumped chains into one block-diagonal matrix $N$ of size $S=155$ and
...
3!\;a(n)\;=\;\mathbf{v}^{\!\top}N^{\,n}\mathbf{1} .
\end{equation}
...
For every $n$ with $m=n+1-1\ge67$,
\[
3!\Bigl(a(n)-\sum_i c_i\,a(n-i)\Bigr)\;=\;\mathbf{v}^{\!\top}N^{\,m-67}q(N)\mathbf{1} .
\]
...
\begin{proof}
Substitute \eqref{eq:walk} into the left side and factor $N^{m-67}$ out of
...
column. The vector $w=q(N)\mathbf{1}$ was then formed by $67$ matrix--vector products
...
corresponding to $n=67+1$ onwards, and the run continued until $w$ was the zero vector,
...
\eqref{eq:walk}, divided by $3!$, was evaluated at every one of the $13$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209894.
