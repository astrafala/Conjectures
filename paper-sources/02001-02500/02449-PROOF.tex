...
\title{A further conjecture on OEIS A063160,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A063160 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $10, 33, 57, 81, 105, 129, 153, 177,\dots$, with offset $1$. The sequence satisfies
\[
  a(n)=2\,a(n-1) - 1\,a(n-2) ,
\]
...
\begin{quote}\raggedright a(n) = 3*(8*n-5) for n>1.\end{quote}
