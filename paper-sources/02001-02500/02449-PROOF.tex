...
\title{A further conjecture on OEIS A063120,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A063120 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $5, 18, 32, 46, 60, 74, 88, 102,\dots$, with offset $1$. The sequence satisfies
\[
  a(n)=2\,a(n-1) - 1\,a(n-2) ,
\]
...
\begin{quote}\raggedright a(n) = 2*(7*n-5) for n>1.\end{quote}
