...
\title{The empirical recurrence for OEIS A245871, proved from an exact model}
...
\begin{abstract}
OEIS A245871 carries an empirical recurrence of order $5$. It is true, and it is
...
OEIS A245871 is ``Number of length 2+2 0..n arrays with some pair in every consecutive three terms totalling exactly n.''. It has offset $1$ and begins
\[
10, 45, 100, 193, 318, 493, 712, 993,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) - 2*a(n-2) - 2*a(n-3) + 3*a(n-4) - a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 04 2018 08:02:19, revision 8)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A245871.
