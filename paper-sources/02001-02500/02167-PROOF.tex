...
\title{The empirical recurrence for OEIS A267234, proved from an exact model}
...
\begin{abstract}
OEIS A267234 carries an empirical recurrence of order $6$. It is true, and it is
...
\begin{quote}
Empirical: a(n) = n\^{}5 + (37/12)*n\^{}4 + (5/2)*n\^{}3 + (5/12)*n\^{}2. a(n) = 6*a(n-1) - 15*a(n-2) + 20*a(n-3) - 15*a(n-4) + 6*a(n-5) - a(n-6) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 10 2019 15:22:16, revision 8)
