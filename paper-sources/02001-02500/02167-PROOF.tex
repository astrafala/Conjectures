...
\title{The empirical recurrence for OEIS A248462, proved from an exact model}
...
\begin{abstract}
OEIS A248462 carries an empirical recurrence of order $5$. It is true, and it is
...
OEIS A248462 is ``Number of length 1+2 0..n arrays with no three consecutive terms having the sum of any two elements equal to twice the third.''. It has offset $1$ and begins
\[
6, 18, 48, 96, 174, 282, 432, 624,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) -2*a(n-2) -2*a(n-3) +3*a(n-4) -a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 08 2018 19:08:58, revision 8)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A248462.
