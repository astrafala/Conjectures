...
\title{The empirical closed form for OEIS A188559, proved}
...
\begin{abstract}
OEIS A188559 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A188559 is ``Number of 8 X n binary arrays without the pattern 0 1 diagonally, vertically, antidiagonally or horizontally.''. It has offset $1$ and begins
\[
9, 17, 32, 60, 112, 208, 384, 704,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 28 2018 07:43:49, revision 9) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{n^{8}}{40320} - \frac{n^{7}}{2016} + \frac{19 n^{6}}{2880} - \frac{7 n^{5}}{180} + \frac{1247 n^{4}}{5760} - \frac{85 n^{3}}{288} + \frac{17911 n^{2}}{10080} + \frac{1961 n}{840} + 5.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A188559.
