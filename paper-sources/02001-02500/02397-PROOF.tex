...
\title{The empirical recurrence for OEIS A268888, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A268888 counts arrays over $\{0,\dots,1\}$ subject to a condition on the array as a
...
OEIS A268888 is ``Number of 3 X n binary arrays with some element plus some horizontally or antidiagonally adjacent neighbor totalling two exactly once.''. It has offset $1$ and begins
\[
0, 20, 84, 501, 2190, 9996, 42362, 178400,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) + 12*a(n-2) - 16*a(n-3) - 62*a(n-4) - 34*a(n-5) + 16*a(n-6) + 12*a(n-7) - a(n-8) - a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 15 2019 14:19:06, revision 7) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268888.
