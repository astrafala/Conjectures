...
\title{The empirical recurrence for OEIS A229391, proved by transfer matrix}
...
\begin{abstract}
OEIS A229391 carries an empirical recurrence of order $6$ contributed by R. H. Hardin. It is
true, and it is decidable rather than empirical. The entry's condition is local to a bounded window of consecutive lines, so
the admissible configurations of such a window are the vertices of a finite digraph and the
arrays counted are exactly the walks in it; hence $a(n)$ is a walk count on $S=8028$ vertices
...
OEIS A229391 is ``Number of nX7 0..3 arrays of the sum of the corresponding element, the element to the east and the element to the south in a larger (n+1)X8 0..1 array.''. It has offset $1$ and begins
\[
6528, 4346752, 1353901580, 358453456908, 93250181644300, 24062262212427788, 6184286713271025676, 1586293889549249544204,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 385*a(n-1) -33152*a(n-2) +33024*a(n-3) -98560*a(n-4) +8486912*a(n-5) -8388608*a(n-6) for n>9
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 04 2025 00:11:22, revision 8) this is still
...
An admissible array is then exactly a walk, and $\iota,\tau$ are the vectors recording which windows may begin and end an array, so with $M$ the adjacency matrix on $S=8028$ vertices,
\[
a(n)\;=\;\iota^{\!\top}M^{\,n}\tau ,
\]
...
\begin{theorem}
\[
a(n)\;=\;385\,a(n-1) - 33152\,a(n-2) + 33024\,a(n-3) - 98560\,a(n-4) + 8486912\,a(n-5) - 8388608\,a(n-6)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A229391.
