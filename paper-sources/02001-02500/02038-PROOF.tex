...
\title{The empirical recurrence for OEIS A183908, proved from an exact model}
...
\begin{abstract}
OEIS A183908 carries an empirical recurrence of order $6$. It is true, and it is
...
\begin{quote}
Empirical: a(n) = (1/120)*n\^{}5 + (5/24)*n\^{}4 + (49/24)*n\^{}3 - (29/24)*n\^{}2 - (461/20)*n + 43 for n>2. a(n) = 6*a(n-1) - 15*a(n-2) + 20*a(n-3) - 15*a(n-4) + 6*a(n-5) - a(n-6) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 06 2018 06:21:20, revision 8)
