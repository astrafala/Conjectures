...
\title{The empirical recurrence for OEIS A224741, proved by transfer matrix}
...
\begin{abstract}
OEIS A224741 counts the $(n+1)\times5$ matrices over $\{0,\dots,1\}$ all of whose
...
makes $a(n)$ a walk count on $S=46$ vertices, hence $C$-finite, and whether the conjectured
...
OEIS A224741 is ``Number of (n+1)X5 0..1 matrices with each 2X2 permanent equal.''. It has offset $1$ and begins
\[
218, 2326, 18257, 180546, 1644874, 15845297, 149592266, 1430571502,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 23:36:05, revision 8) this is still
...
\]
with $M$ the adjacency matrix on $S=46$ states. In particular $a$ is $C$-finite. The
...
\begin{theorem}
\[
a(n)\;=\;13\,a(n-1) + a(n-2) - 436\,a(n-3) + 747\,a(n-4) + 3955\,a(n-5) - 7874\,a(n-6) - 12461\,a(n-7) + 25451\,a(n-8) + 13120\,a(n-9) - 30315\,a(n-10) - 175\,a(n-11) + 9975\,a(n-12) - 2000\,a(n-13)
\]
for every $n>12$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224741.
