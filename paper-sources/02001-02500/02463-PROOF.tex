...
\title{A further conjecture on OEIS A063148,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A063148 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $7, 30, 54, 78, 102, 126, 150, 174,\dots$, with offset $1$. The sequence satisfies
\[
  a(n)=2\,a(n-1) - 1\,a(n-2) ,
\]
...
\begin{quote}\raggedright a(n) = 6*(4*n-3) for n>1.\end{quote}
