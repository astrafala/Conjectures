...
\title{The empirical recurrence for OEIS A189349, proved by transfer matrix}
...
\begin{abstract}
OEIS A189349 counts the permutations of the cells of an $n\times3$ array in which every cell
...
OEIS A189349 is ``Number of nX3 array permutations with each element moving one space diagonally, horizontally or vertically.''. It has offset $1$ and begins
\[
0, 13, 48, 557, 3632, 30769, 229248, 1815601,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) +41*a(n-2) +44*a(n-3) -118*a(n-4) +118*a(n-6) -44*a(n-7) -41*a(n-8) -2*a(n-9) +a(n-10)
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 16 2026 12:35:03, revision 11) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 41\,a(n-2) + 44\,a(n-3) - 118\,a(n-4) + 118\,a(n-6) - 44\,a(n-7) - 41\,a(n-8) - 2\,a(n-9) + a(n-10)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A189349.
