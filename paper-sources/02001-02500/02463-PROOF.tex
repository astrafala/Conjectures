...
\title{A further conjecture on OEIS A063164,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A063164 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $9, 40, 72, 104, 136, 168, 200, 232,\dots$, with offset $1$. The sequence satisfies
\[
  a(n)=2\,a(n-1) - 1\,a(n-2) ,
\]
...
\begin{quote}\raggedright a(n) = 8*(4*n-3) for n > 1.\end{quote}
