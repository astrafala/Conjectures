...
\title{A further conjecture on OEIS A198900,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A198900 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $1, 4, 33, 380, 4801, 62004, 804833, 10459180,\dots$, with offset $1$. The sequence satisfies
\[
  a(n)=17\,a(n-1) - 55\,a(n-2) + 39\,a(n-3) ,
\]
a linear recurrence of order $3$ with characteristic polynomial
\[
  q(x)=x^{3} - 17 x^{2} + 55 x - 39 .
\]
...
\begin{quote}\raggedright a(n) = (26 + 13*3\^{}n + 13\^{}n) / 78.\end{quote}
