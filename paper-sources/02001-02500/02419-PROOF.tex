...
\title{The empirical recurrence for OEIS A219003, proved by transfer matrix}
...
\begin{abstract}
OEIS A219003 counts the distinct indicator arrays obtained from the $n\times2$ arrays over
...
OEIS A219003 is ``Unmatched value maps: number of 2 X n binary arrays indicating the locations of corresponding elements not equal to any horizontal, diagonal or antidiagonal neighbor in a random 0..2 2 X n array.''. It has offset $1$ and begins
\[
1, 10, 46, 163, 604, 2341, 9019, 34489,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) - 3*a(n-2) + 9*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 25 2018 03:46:50, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A219003.
