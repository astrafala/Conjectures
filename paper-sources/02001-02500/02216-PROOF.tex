...
\title{The empirical recurrence for OEIS A229588, proved by counting defective colourings}
...
\begin{abstract}
OEIS A229588 counts the colourings of an array with $K=3$ colours that are proper except at
...
OEIS A229588 is ``Number of defective 3-colorings of a 3 X n 0..2 array connected horizontally and antidiagonally with exactly one mistake, and colors introduced in row-major 0..2 order.''. It has offset $1$ and begins
\[
0, 40, 264, 1620, 9156, 49848, 264300, 1374048,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 10*a(n-1) - 29*a(n-2) + 20*a(n-3) - 4*a(n-4) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 19 2018 15:14:17, revision 7) the statement is
...
The arrays have $3$ rows and $L=n$ columns, entries in $\{0,\dots,3-1\}$.
...
Fix $i$ and take as vertices the pairs $(r,c)$ with $r\in\{0,\dots,i-1\}^{3}$ a column
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A229588.
