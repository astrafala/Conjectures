...
\title{The empirical recurrence for OEIS A214240, proved by transfer matrix}
...
\begin{abstract}
OEIS A214240 counts the proper colourings of a grid $2\times(n+1)$, wrapped in the growing direction, with at most $8$ colours and
counted up to renaming the colours, and carries an empirical recurrence of order $12$
...
down to $S=168$ and makes the exact residual test affordable.
\end{abstract}
...
OEIS A214240 is ``Number of 0..7 colorings of a 2X(n+1) array circular in the n+1 direction with new values 0..7 introduced in row major order.''. It has offset $1$ and begins
\[
4, 18, 354, 7749, 231799, 8178855, 318511707, 13046748480,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 16:57:24, revision 8) this is still
...
state count is $S=168$ rather than the number of colourings.
...
\begin{theorem}
\[
a(n)\;=\;66\,a(n-1) - 867\,a(n-2) - 8354\,a(n-3) + 120414\,a(n-4) + 672756\,a(n-5) - 3902534\,a(n-6) - 24478884\,a(n-7) + 5777547\,a(n-8) + 189931178\,a(n-9) + 205081401\,a(n-10) - 166116762\,a(n-11) - 207075960\,a(n-12)
\]
for every $n>11$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A214240.
