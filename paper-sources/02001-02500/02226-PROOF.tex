...
\title{The empirical recurrence for OEIS A189446, proved by transfer matrix}
...
\begin{abstract}
OEIS A189446 counts the permutations of the cells of an $n\times6$ array in which every cell
...
That makes $a$ a walk count on $S=615$ states, hence $C$-finite, and whether the published
...
OEIS A189446 is ``Number of nX6 array permutations with each element moving zero or one space horizontally or diagonally.''. It has offset $1$ and begins
\[
13, 841, 40106, 2008890, 100047288, 4982424404, 248187289625, 12362821462925,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 05:14:04, revision 9) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=615,
\]
...
\begin{theorem}
\[
a(n)\;=\;55\,a(n-1) - 257\,a(n-2) - 66\,a(n-3) - 558\,a(n-4) + 20414\,a(n-5) - 105459\,a(n-6) + 187369\,a(n-7) - 105459\,a(n-8) + 20414\,a(n-9) - 558\,a(n-10) - 66\,a(n-11) - 257\,a(n-12) + 55\,a(n-13) - a(n-14)
\]
for every $n>15$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A189446.
