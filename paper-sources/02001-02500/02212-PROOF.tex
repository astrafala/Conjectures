...
\title{The empirical recurrence for OEIS A206218, proved by transfer matrix}
...
\begin{abstract}
OEIS A206218 counts arrays of width $4$ over $\{0,1,2\}$ by reducing every $2\times2$ subblock to a
...
empirical recurrence of order $14$ contributed by R.~H.~Hardin. It is true, and it is
...
about it is one bit per adjacent pair of columns, so the count is a walk count on $S=3382$
states.
\end{abstract}
...
OEIS A206218 is ``Number of (n+1) X 4 0..2 arrays with rows and columns of determinants of all 2 X 2 subblocks lexicographically nondecreasing.''. It has offset $1$ and begins
\[
1970, 73133, 1782191, 35625711, 600064928, 9098547899, 131428029860, 1883474084204,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 12:48:20, revision 9) this is still
...
f(B)\;=\;\det B=ps-qr,
\]
the determinant. An array with $R$ rows and $4$ columns has $(R-1)\times3$ subblocks, and they
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=3382.
\]
...
\begin{theorem}
\[
a(n)\;=\;42\,a(n-1) - 625\,a(n-2) + 2990\,a(n-3) + 19429\,a(n-4) - 300482\,a(n-5) + 1205989\,a(n-6) + 739674\,a(n-7) - 21921768\,a(n-8) + 68928624\,a(n-9) - 44135280\,a(n-10) - 218575584\,a(n-11) + 570862080\,a(n-12) - 547928064\,a(n-13) + 191102976\,a(n-14)
\]
for every $n>30$.
\end{theorem}
...
array of width $4$ over $\{0,1,2\}$ with two and with three rows was written out cell by cell,
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206218.
