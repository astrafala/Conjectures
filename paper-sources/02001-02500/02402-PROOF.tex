...
\title{The empirical recurrence for OEIS A223273, proved by transfer matrix}
...
\begin{abstract}
OEIS A223273 counts the ways of writing the vertices of a fixed graph $G$ into an array of width
$5$ so that any two cells adjacent in one of the named directions carry vertices joined by an
edge of $G$; here $G$ is octahedron graph. The entry carries an empirical recurrence of order $10$
...
single slice is a state and the count is a walk count on a finite digraph with $S=4577$ vertices.
\end{abstract}
...
OEIS A223273 is ``Rolling cube footprints: number of 5Xn 0..5 arrays starting with 0 where 0..5 label faces of a cube and every array movement to a horizontal, diagonal or antidiagonal neighbor moves across a corresponding cube edge.''. It has offset $1$ and begins
\[
1296, 82944, 27951104, 6467616768, 1771674009600, 450204914417664, 118579442837618688, 30710179999458000896,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 21:26:58, revision 8) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=4577.
\]
...
\begin{theorem}
\[
a(n)\;=\;192\,a(n-1) + 31744\,a(n-2) - 3178496\,a(n-3) - 170917888\,a(n-4) + 13992198144\,a(n-5) + 99857989632\,a(n-6) - 17660905521152\,a(n-7) + 211106232532992\,a(n-8) + 2533274790395904\,a(n-9) - 40532396646334464\,a(n-10)
\]
for every $n>11$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223273.
