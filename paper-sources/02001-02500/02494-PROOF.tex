...
\title{A further conjecture on OEIS A187379,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A187379 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $0, 0, 40, 188, 487, 924, 1499, 2212,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = 69*n\^{}2 - 322*n + 372 for n>3.\end{quote}
