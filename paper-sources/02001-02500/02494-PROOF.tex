...
\title{A further conjecture on OEIS A229506,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A229506 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $0, 288, 4032, 50112, 575424, 6298560, 66764736, 691581888,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = 64*3\^{}(2*n-5)*(8*n - 3) for n>2.\end{quote}
