...
\title{The empirical recurrence for OEIS A235527, proved by transfer matrix}
...
\begin{abstract}
OEIS A235527 counts arrays of width $2$ over $\{0,1,2\}$ by reducing every $2\times2$ subblock to a
...
OEIS A235527 is ``Number of (n+1)X(1+1) 0..2 arrays with the sum of each 2X2 subblock two median terms lexicographically nondecreasing rowwise and columnwise.''. It has offset $1$ and begins
\[
81, 498, 2996, 15782, 80584, 388008, 1819537, 8271237,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 08:36:27, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;10\,a(n-1) - 10\,a(n-2) - 182\,a(n-3) + 432\,a(n-4) + 1446\,a(n-5) - 4430\,a(n-6) - 6826\,a(n-7) + 23217\,a(n-8) + 22320\,a(n-9) - 70888\,a(n-10) - 54080\,a(n-11) + 126752\,a(n-12) + 91840\,a(n-13) - 121152\,a(n-14) - 91392\,a(n-15) + 46080\,a(n-16) + 36864\,a(n-17)
\]
for every $n>15$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A235527.
