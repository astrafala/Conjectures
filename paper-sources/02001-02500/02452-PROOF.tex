...
\title{A further conjecture on OEIS A165372,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A165372 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $9, 40, 104, 168, 232, 296, 360, 424,\dots$, with offset $2$. The sequence satisfies
\[
  a(n)=2\,a(n-1) - 1\,a(n-2) ,
\]
...
\begin{quote}\raggedright a(n) = 8*(8*n-19) for n>2.\end{quote}
