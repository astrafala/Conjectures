...
\title{The empirical recurrence for OEIS A240401, proved by transfer matrix}
...
\begin{abstract}
OEIS A240401 counts arrays over $\{0,1,2,3\}$ in which no entry may equal, modulo $4$, a given
...
count is then a walk count on $S=24$ states.
\end{abstract}
...
OEIS A240401 is ``Number of nX2 0..3 arrays with no element equal to one plus the sum of elements to its left or three plus the sum of elements above it or zero plus the sum of the elements diagonally to its northwest, modulo 4.''. It has offset $1$ and begins
\[
2, 5, 14, 24, 77, 182, 397, 1164,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 09:54:39, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-2) + 10\,a(n-3) - 3\,a(n-4) - 6\,a(n-5) - 3\,a(n-6) + 8\,a(n-7) - 7\,a(n-8) - 9\,a(n-9) - 4\,a(n-10) + 13\,a(n-11) - 14\,a(n-12) + 17\,a(n-13) - a(n-15)
\]
for every $n>15$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A240401.
