...
\title{The empirical recurrence for OEIS A198903, proved by counting patterns}
...
\begin{abstract}
OEIS A198903 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A198903 is ``Number of n X 5 0..4 arrays with values 0..4 introduced in row major order and no element equal to any horizontal or vertical neighbor.''. It has offset $1$ and begins
\[
15, 4801, 2125425, 948656912, 423503301834, 189062985604305, 84402688527136201, 37679579867128064832,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 08:01:31, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;559\,a(n-1) - 54943\,a(n-2) + 2182857\,a(n-3) - 41132051\,a(n-4) + 348302393\,a(n-5) - 519526889\,a(n-6) - 11351340633\,a(n-7) + 79466721924\,a(n-8) - 227367989480\,a(n-9) + 329414183656\,a(n-10) - 247117199296\,a(n-11) + 89130224384\,a(n-12) - 11964372480\,a(n-13)
\end{equation}
for all $n>13$.
...
\[
5!\Bigl(a(n)-\sum_i c_i\,a(n-i)\Bigr)\;=\;\mathbf{v}^{\!\top}N^{\,m-13}q(N)\mathbf{1} .
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A198903.
