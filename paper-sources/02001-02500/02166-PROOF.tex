...
\title{The empirical recurrence for OEIS A223996, proved by transfer matrix}
...
\begin{abstract}
OEIS A223996 counts arrays over $\{0,\dots,2\}$ whose rows, columns, diagonals or
...
is a walk count on $S=672$ vertices and the recurrence follows from a finite exact
computation.
\end{abstract}
...
OEIS A223996 is ``Number of nX5 0..2 arrays with antidiagonals unimodal and rows and diagonals nondecreasing.''. It has offset $1$ and begins
\[
21, 281, 2403, 17929, 132119, 984595, 7400832, 55978489,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 23:09:48, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;21\,a(n-1) - 155\,a(n-2) + 405\,a(n-3) + 365\,a(n-4) - 2996\,a(n-5) - 664\,a(n-6) + 18276\,a(n-7) - 22433\,a(n-8) - 2304\,a(n-9) - 9369\,a(n-10) - 7644\,a(n-11) + 222262\,a(n-12) + 167540\,a(n-13) - 1508772\,a(n-14) + 2046821\,a(n-15) - 1097976\,a(n-16) + 4265706\,a(n-17) - 2582500\,a(n-18) - 941886\,a(n-19) - 2423080\,a(n-20) + 19902336\,a(n-21) + 2548764\,a(n-22) + 9439760\,a(n-23) + 1688032\,a(n-24) + 1035840\,a(n-25) - 957120\,a(n-26) + 1996416\,a(n-27) - 115200\,a(n-28)
\end{equation}
for all $n>31$.
...
bit vector), $|\mathcal V|=S=672$; let $(r,f)\to(s,f')$ be an edge when placing $s$ after $r$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223996.
