...
\title{The empirical recurrence for OEIS A205194, proved by transfer matrix}
...
\begin{abstract}
OEIS A205194 counts arrays of width $2$ over $\{0,1,2,3\}$ by reducing every $2\times2$ subblock to a
...
about it is one bit per adjacent pair of columns, so the count is a walk count on $S=121$
states.
\end{abstract}
...
OEIS A205194 is ``Number of (n+1)X2 0..3 arrays with rows and columns of permanents of all 2X2 subblocks lexicographically nondecreasing, and all 2X2 permanents nonzero.''. It has offset $1$ and begins
\[
207, 1720, 13366, 83720, 496848, 2629706, 13334897, 63159947,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 11:49:50, revision 10) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A205194.
