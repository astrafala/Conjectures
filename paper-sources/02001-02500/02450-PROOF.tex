...
\title{A further conjecture on OEIS A063162,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A063162 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $11, 34, 58, 82, 106, 130, 154, 178,\dots$, with offset $1$. The sequence satisfies
\[
  a(n)=2\,a(n-1) - 1\,a(n-2) ,
\]
...
\begin{quote}\raggedright a(n) = 24*n-14 for n>1.\end{quote}
