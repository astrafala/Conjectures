...
\title{The empirical recurrence for OEIS A221478, proved by transfer matrix}
...
\begin{abstract}
OEIS A221478 counts the distinct OCCUPANCY arrays obtained when every cell of an $n\times3$ grid
...
one, on $S=64$ states, after which the conjectured recurrence is settled by a finite exact
computation.
\end{abstract}
...
OEIS A221478 is ``Number of n X 3 arrays of occupancy after each element moves to some horizontal or antidiagonal neighbor, without consecutive moves in the same direction.''. It has offset $1$ and begins
\[
0, 8, 50, 313, 1980, 12494, 78880, 497940,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 8*a(n-1) - 7*a(n-2) - 24*a(n-3) + 6*a(n-4) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 05 2018 15:06:12, revision 8) this is still
...
$S=64$ reachable sets. In particular $a$ is $C$-finite.
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-1) - 7\,a(n-2) - 24\,a(n-3) + 6\,a(n-4)
\]
for every $n>6$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221478.
