...
\title{The empirical recurrence for OEIS A235768, proved by transfer matrix}
...
\begin{abstract}
OEIS A235768 counts arrays of width $4$ over $\{0,1\}$ by reducing every $2\times2$ subblock to a
...
about it is one bit per adjacent pair of columns, so the count is a walk count on $S=288$
states.
\end{abstract}
...
OEIS A235768 is ``Number of (n+1)X(3+1) 0..1 arrays with the sum of each 2X2 subblock two extreme terms minus its two median terms lexicographically nondecreasing columnwise and nonincreasing rowwise.''. It has offset $1$ and begins
\[
120, 628, 2994, 12417, 47501, 166904, 552444, 1724793,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 08:48:20, revision 6) this is still
...
f(B)\;=\;(v_1+v_4)-(v_2+v_3),
\]
the two extreme entries minus the two middle ones. An array with $R$ rows and $4$ columns has $(R-1)\times3$ subblocks, and they
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=288.
\]
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + 22\,a(n-2) - 106\,a(n-3) - 206\,a(n-4) + 1310\,a(n-5) + 970\,a(n-6) - 10018\,a(n-7) - 1220\,a(n-8) + 53030\,a(n-9) - 14210\,a(n-10) - 205870\,a(n-11) + 113050\,a(n-12) + 605570\,a(n-13) - 469970\,a(n-14) - 1374070\,a(n-15) + 1346965\,a(n-16) + 2422430\,a(n-17) - 2874380\,a(n-18) - 3308560\,a(n-19) + 4711492\,a(n-20) + 3445592\,a(n-21) - 6005504\,a(n-22) - 2628928\,a(n-23) + 5959072\,a(n-24) + 1319360\,a(n-25) - 4565120\,a(n-26) - 254464\,a(n-27) + 2650240\,a(n-28) - 198400\,a(n-29) - 1127936\,a(n-30) + 203264\,a(n-31) + 332032\,a(n-32) - 88576\,a(n-33) - 60416\,a(n-34) + 20480\,a(n-35) + 5120\,a(n-36) - 2048\,a(n-37)
\]
for every $n>37$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A235768.
