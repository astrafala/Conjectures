...
\title{The empirical recurrence for OEIS A201044, proved from an exact model}
...
\begin{abstract}
OEIS A201044 carries an empirical recurrence of order $6$. It is true, and it is
...
OEIS A201044 is ``Number of -n..n arrays of 5 elements with adjacent element differences also in -n..n.''. It has offset $1$ and begins
\[
99, 1161, 6083, 21141, 57343, 131781, 268983, 502265,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (169/15)*n\^{}5 + (169/6)*n\^{}4 + 32*n\^{}3 + (119/6)*n\^{}2 + (101/15)*n + 1. a(n) = 6*a(n-1) - 15*a(n-2) + 20*a(n-3) - 15*a(n-4) + 6*a(n-5) - a(n-6) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (May 22 2018 03:34:04, revision 8)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A201044.
