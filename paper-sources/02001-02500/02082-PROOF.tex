...
\title{The empirical recurrence for OEIS A229665, proved by counting defective colourings}
...
\begin{abstract}
OEIS A229665 counts the colourings of an array with $K=4$ colours that are proper except at
...
numbers. What is left is a walk count on $S=30$ vertices, and the empirical recurrence of
...
OEIS A229665 is ``Number of defective 4-colorings of an n X 1 0..3 array connected horizontally, antidiagonally and vertically with exactly two mistakes, and colors introduced in row-major 0..3 order.''. It has offset $1$ and begins
\[
0, 0, 1, 3, 12, 50, 210, 861,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 12*a(n-1) -57*a(n-2) +136*a(n-3) -171*a(n-4) +108*a(n-5) -27*a(n-6) for n>9.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 17 2025 16:01:24, revision 10) the statement is
...
The arrays have $1$ columns and $L=n$ rows, entries in $\{0,\dots,4-1\}$.
...
Fix $i$ and take as vertices the pairs $(r,c)$ with $r\in\{0,\dots,i-1\}^{1}$ a row
...
Assembling the $4$ chains block-diagonally into $N$ of size $S=30$ with the weights of
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A229665.
