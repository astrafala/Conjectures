...
\title{The empirical recurrence for OEIS A240756, proved by transfer matrix}
...
\begin{abstract}
OEIS A240756 counts arrays over $\{0,1,2,3\}$ in which no entry may equal, modulo $4$, a given
...
count is then a walk count on $S=38$ states.
\end{abstract}
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-3) + a(n-5) - 2\,a(n-8) - 4\,a(n-9) - a(n-11) + 2\,a(n-14)
\]
for every $n>17$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A240756.
