...
\title{The empirical recurrence for OEIS A203271, proved by transfer matrix}
...
\begin{abstract}
OEIS A203271 counts arrays of width $2$ over $\{0,1,\dots,5\}$ in which every nonzero cell has a neighbour at least as large as itself. The entry carries an
...
OEIS A203271 is ``Number of nX2 0..5 arrays with every nonzero element less than or equal to some NW, E or S neighbor.''. It has offset $1$ and begins
\[
1, 36, 861, 12783, 165993, 2229009, 31121459, 435195718,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 10:16:27, revision 9) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The arrays have $2$ columns and a growing number of rows, with entries in $\{0,1,\dots,5\}$. Fix the
...
Thus
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=1003,
\]
...
\begin{theorem}
\[
a(n)\;=\;36\,a(n-1) - 560\,a(n-2) + 5460\,a(n-3) - 37492\,a(n-4) + 184080\,a(n-5) - 652174\,a(n-6) + 1708101\,a(n-7) - 3402070\,a(n-8) + 5328827\,a(n-9) - 6942268\,a(n-10) + 7733863\,a(n-11) - 6899211\,a(n-12) + 4600369\,a(n-13) - 2220772\,a(n-14) + 777436\,a(n-15) - 202500\,a(n-16)
\]
for every $n>15$.
\end{theorem}
...
array of width $2$ over $\{0,1,\dots,5\}$ with a few rows was written out cell by cell and each cell
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A203271.
