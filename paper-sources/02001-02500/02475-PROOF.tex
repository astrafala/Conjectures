...
\title{A further conjecture on OEIS A184544,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A184544 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $309, 792, 1627, 3024, 5313, 8989, 14767, 23648,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (1/5040)*n\^{}7 + (1/120)*n\^{}6 + (53/360)*n\^{}5 + (17/12)*n\^{}4 + (5767/720)*n\^{}3 + (3063/40)*n\^{}2 + (11959/70)*n + 52.\end{quote}
