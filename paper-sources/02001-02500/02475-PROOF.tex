...
\title{A further conjecture on OEIS A207935,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A207935 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $14, 196, 844, 2422, 5594, 11256, 20568, 34986,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = (30 - 149*n + 10*n\^{}2 + 250*n\^{}3 + 65*n\^{}4 + 4*n\^{}5) / 15.\end{quote}
