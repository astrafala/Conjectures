...
\title{A further conjecture on OEIS A187028,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A187028 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $0, 24, 296, 1008, 2232, 3936, 6120, 8784,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = 240*n\^{}2 - 936*n + 912 for n>3\end{quote}
