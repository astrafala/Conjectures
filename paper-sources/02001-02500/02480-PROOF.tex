...
\title{The empirical recurrence for OEIS A232258, proved by transfer matrix}
...
\begin{abstract}
OEIS A232258 counts arrays of width $2$ over $\{0,1,2\}$ in which every cell has a neighbour at least as large and one at most as large. The entry carries an
...
OEIS A232258 is ``Number of (1+1)X(n+1) 0..2 arrays with every element both >= and <= some horizontal or antidiagonal neighbor.''. It has offset $1$ and begins
\[
9, 37, 215, 1287, 7673, 45709, 272417, 1623601,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 06:58:22, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) - 3\,a(n-2) + 19\,a(n-3) - 16\,a(n-4) + 13\,a(n-5) - 45\,a(n-6) - 10\,a(n-7) - 26\,a(n-8) - 11\,a(n-9) + 26\,a(n-10) + 4\,a(n-11) - 4\,a(n-12)
\]
for every $n>13$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232258.
