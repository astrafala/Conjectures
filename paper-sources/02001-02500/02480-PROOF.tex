...
\title{A further conjecture on OEIS A208403,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A208403 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $5, 182, 10682, 667478, 42012698, 2646531062, 166729574522, 10503950018198,\dots$, with offset $1$. The sequence satisfies
\[
  a(n)=70\,a(n-1) - 441\,a(n-2) ,
\]
...
\begin{quote}\raggedright a(n) = (2/27)*7\^{}(-1+n) * (27+4*9\^{}n) for n>1.\end{quote}
