...
\title{The empirical recurrence for OEIS A186211, proved by transfer matrix}
...
\begin{abstract}
OEIS A186211 counts arrays over $\{0,\dots,2\}$ under a condition comparing a statistic of
...
OEIS A186211 is ``Number of (n+1)X2 0..2 arrays with every 2X2 subblock determinant equal to some horizontal or vertical neighbor 2X2 subblock determinant.''. It has offset $1$ and begins
\[
0, 175, 609, 3593, 15055, 76263, 353985, 1729733,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 03:29:28, revision 10) this is still
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) + a(n-2) - 48\,a(n-3) + 77\,a(n-4) + 28\,a(n-5) - 238\,a(n-6) + 230\,a(n-7) - 67\,a(n-8) + 170\,a(n-9) + 100\,a(n-10) - 432\,a(n-11) + 256\,a(n-12) - 532\,a(n-13) + 296\,a(n-14) + 144\,a(n-15) - 320\,a(n-16) + 512\,a(n-17)
\]
for every $n>18$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A186211.
