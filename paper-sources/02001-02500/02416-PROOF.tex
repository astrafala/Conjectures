...
\title{The empirical recurrence for OEIS A268793, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A268793 counts arrays over $\{0,\dots,2\}$ subject to a condition on the array as a
...
OEIS A268793 is ``Number of nX3 0..2 arrays with some element plus some horizontally, vertically or antidiagonally adjacent neighbor totalling two exactly once.''. It has offset $1$ and begins
\[
12, 78, 248, 950, 3384, 11948, 41248, 140698,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) +9*a(n-2) -2*a(n-3) -33*a(n-4) -42*a(n-5) -14*a(n-6) +10*a(n-7) +8*a(n-8) -a(n-10) for n>12
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 13 2016 13:41:53, revision 4) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268793.
