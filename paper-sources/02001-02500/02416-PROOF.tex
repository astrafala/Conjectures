...
\title{The empirical recurrence for OEIS A229580, proved by counting defective colourings}
...
\begin{abstract}
OEIS A229580 counts the colourings of an array with $K=3$ colours that are proper except at
...
OEIS A229580 is ``Number of defective 3-colorings of an n X 2 0..2 array connected horizontally and antidiagonally with exactly one mistake, and colors introduced in row-major 0..2 order.''. It has offset $1$ and begins
\[
1, 6, 40, 224, 1152, 5632, 26624, 122880,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 8*a(n-1) - 16*a(n-2) for n>3.
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 06 2024 04:46:49, revision 51) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A229580.
