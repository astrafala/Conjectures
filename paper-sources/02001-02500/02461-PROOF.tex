...
\title{The empirical recurrence for OEIS A280956, proved by transfer matrix}
...
\begin{abstract}
OEIS A280956 counts $n\times3$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A280956 is ``Number of nX3 0..2 arrays with no element equal to more than one of its horizontal, vertical and antidiagonal neighbors and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
4, 42, 241, 1554, 9899, 63085, 402077, 2562733,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 11 2017 15:13:44, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) + 8\,a(n-2) + 5\,a(n-3) + 4\,a(n-4) - 35\,a(n-5) + 2\,a(n-6) + 71\,a(n-7) - 11\,a(n-8) - 38\,a(n-9) + 6\,a(n-10) - 8\,a(n-11) - 8\,a(n-12)
\]
for every $n>16$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A280956.
