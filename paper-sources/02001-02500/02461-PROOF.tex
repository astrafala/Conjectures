...
\title{A further conjecture on OEIS A183631,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A183631 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $20709, 22767, 26901, 35223, 52029, 86127, 155781, 299463,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = 3*(6220 + 85*2\^{}(2+n) + 3\^{}n).\end{quote}
