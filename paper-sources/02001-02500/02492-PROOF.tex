...
\title{A further conjecture on OEIS A187305,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A187305 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $0, 0, 0, 3096, 44824, 187924, 505878, 1044900,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = 124248*n\^{}2 - 1238146*n + 2807812 for n>17\end{quote}
...
indices, and $a$ and $f$ were checked to agree at $n=21,\dots,23$,
