...
\title{A further conjecture on OEIS A184138,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A184138 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $4, 14, 45, 130, 336, 785, 1682, 3351,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = (5040 + 7860*n + 4494*n\^{}2 + 2044*n\^{}3 + 525*n\^{}4 + 175*n\^{}5 + 21*n\^{}6 + n\^{}7) / 5040.\end{quote}
