...
\title{A further conjecture on OEIS A229473,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A229473 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $1, 6, 42, 248, 1312, 6528, 31232, 145408,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = 2\^{}(2*n-5) * (10*n-9) for n>2.\end{quote}
