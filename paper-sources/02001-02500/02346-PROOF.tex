...
\title{The empirical recurrence for OEIS A211689, proved by transfer matrix}
...
\begin{abstract}
OEIS A211689 carries an empirical recurrence of order $23$ contributed by R. H. Hardin. It is
...
arrays counted are exactly the walks in it; hence $a(n)$ is a walk count on $S=111$ vertices
...
OEIS A211689 is ``Number of -4..4 arrays x(i) of n+1 elements i=1..n+1 with x(i)+x(j), x(i+1)+x(j+1), -(x(i)+x(j+1)), and -(x(i+1)+x(j)) having two or three distinct values for every i<=n and j<=n.''. It has offset $1$ and begins
\[
80, 216, 498, 1064, 2200, 4448, 8844, 17552,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 16:16:58, revision 8) this is still
...
admissible array is then exactly a walk, so with $M$ the adjacency matrix on $S=111$ vertices
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + 16\,a(n-2) - 80\,a(n-3) - 93\,a(n-4) + 694\,a(n-5) + 149\,a(n-6) - 3418\,a(n-7) + 910\,a(n-8) + 10491\,a(n-9) - 5972\,a(n-10) - 20678\,a(n-11) + 16520\,a(n-12) + 25848\,a(n-13) - 26344\,a(n-14) - 19141\,a(n-15) + 25313\,a(n-16) + 6692\,a(n-17) - 14094\,a(n-18) + 234\,a(n-19) + 4010\,a(n-20) - 760\,a(n-21) - 420\,a(n-22) + 120\,a(n-23)
\]
for every $n>23$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A211689.
