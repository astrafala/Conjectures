...
\title{The empirical recurrence for OEIS A245872, proved from an exact model}
...
\begin{abstract}
OEIS A245872 carries an empirical recurrence of order $6$. It is true, and it is
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 05 2018 03:05:12, revision 11)
