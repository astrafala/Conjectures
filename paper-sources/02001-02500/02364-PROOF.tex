...
\title{A value repeated at its own distance: OEIS A209367}
...
\begin{abstract}
OEIS A209367 carries an empirical recurrence of order $12$ contributed by R.~H.~Hardin. It is
...
\begin{theorem}
\[
a(n)\;=\;a(n-2) + 4\,a(n-4) + 4\,a(n-5) + 5\,a(n-6) - a(n-7) - 5\,a(n-8) - 5\,a(n-9) - 5\,a(n-10) + a(n-11) + 2\,a(n-12)
\]
for every $n>14$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209367.
