...
\title{The empirical recurrence for OEIS A204147, proved by transfer matrix}
...
\begin{abstract}
OEIS A204147 counts $(n+2)\times4$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A204147 is ``Number of (n+2) X 4 0..2 arrays with every 3 X 3 subblock having equal diagonal elements or equal antidiagonal elements, and new values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
3902, 28982, 156494, 891662, 5117114, 29610374, 169527242, 970408838,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 31 2023 19:26:33, revision 7) this is still
...
$u_1,u_2,\dots$ over $\{0,\dots,2\}^{4}$, the condition
\[
...
\]
on $S=6562$ vertices in total, the exponent fixed by the entry's own shape and checked against
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + 9\,a(n-2) - 16\,a(n-3) + 162\,a(n-4) - 70\,a(n-5) - 704\,a(n-6) - 1224\,a(n-7) - 576\,a(n-8) + 4240\,a(n-9) + 11456\,a(n-10) - 6560\,a(n-11) - 14144\,a(n-12) + 5376\,a(n-13) - 7168\,a(n-14) + 13312\,a(n-15) - 4096\,a(n-16)
\]
for every $n>17$.
\end{theorem}
...
By Lemma~\ref{lem:crit} the recurrence holds for every $n>17$. The bound is exact: at $n=17$ the recurrence fails on the entry's own published terms, so no larger range holds.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204147.
