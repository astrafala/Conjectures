...
\title{The empirical recurrence for OEIS A264202, proved by transfer matrix}
...
\begin{abstract}
OEIS A264202 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=3$ rows in which
...
OEIS A264202 is ``Number of (n+1) X (2+1) arrays of permutations of 0..n*3+2 with each element having index change +-(.,.) 0,0 0,2 or 1,0.''. It has offset $1$ and begins
\[
18, 96, 605, 3600, 21853, 131712, 795906, 4804910,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) + 18*a(n-2) + 5*a(n-3) - 18*a(n-4) + 3*a(n-5) + a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 05 2019 06:59:35, revision 11) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264202.
