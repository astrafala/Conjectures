...
\title{A further conjecture on OEIS A183625,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A183625 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $45, 87, 189, 447, 1125, 2967, 8109, 22767,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = 3*(4 + 2\^{}(2+n) + 3\^{}n).\end{quote}
