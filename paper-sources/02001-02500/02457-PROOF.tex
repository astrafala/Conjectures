...
\title{A further conjecture on OEIS A063098,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A063098 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $3, 14, 26, 38, 50, 62, 74, 86,\dots$, with offset $1$. The sequence satisfies
\[
  a(n)=2\,a(n-1) - 1\,a(n-2) ,
\]
...
\begin{quote}\raggedright a(n) = 2*(6*n-5) for n>1.\end{quote}
