...
\title{The empirical recurrence for OEIS A188212, proved from an exact model}
...
\begin{abstract}
OEIS A188212 carries an empirical recurrence of order $6$. It is true, and it is
...
OEIS A188212 is ``Number of nondecreasing arrangements of 4 numbers in -(n+2)..(n+2) with sum zero.''. It has offset $1$ and begins
\[
18, 33, 55, 86, 126, 177, 241, 318,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) - 3*a(n-2) + 2*a(n-3) - 3*a(n-4) + 3*a(n-5) - a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 27 2018 06:28:46, revision 9)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A188212.
