...
\title{The empirical recurrence for OEIS A229505, proved by counting defective colourings}
...
\begin{abstract}
OEIS A229505 counts the colourings of an array with $K=3$ colours that are proper except at
...
OEIS A229505 is ``Number of defective 3-colorings of an n X 3 0..2 array connected diagonally and antidiagonally with exactly one mistake, and colors introduced in row-major 0..2 order.''. It has offset $1$ and begins
\[
0, 48, 480, 4032, 31104, 228096, 1617408, 11197440,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 12*a(n-1) - 36*a(n-2) for n>3.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 16 2017 05:26:18, revision 9) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A229505.
