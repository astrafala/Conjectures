...
\title{The empirical closed form for OEIS A238808, proved}
...
\begin{abstract}
OEIS A238808 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A238808 is ``Number of n X 4 0..2 arrays with no element equal to one plus the sum of elements to its left or one plus the sum of the sum of elements above it, modulo 3.''. It has offset $1$ and begins
\[
5, 25, 118, 468, 1501, 4167, 10423, 24115,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 01 2021 16:45:41, revision 6) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{n^{10}}{302400} - \frac{13 n^{9}}{90720} + \frac{37 n^{8}}{6720} - \frac{451 n^{7}}{3780} + \frac{29063 n^{6}}{14400} - \frac{100891 n^{5}}{4320} + \frac{11871787 n^{4}}{60480} - \frac{25402589 n^{3}}{22680} + \frac{35075741 n^{2}}{8400} - \frac{2861612 n}{315} + 8719.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A238808.
