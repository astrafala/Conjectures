...
\title{The empirical recurrence for OEIS A208598, proved from an exact model}
...
\begin{abstract}
OEIS A208598 carries an empirical recurrence of order $4$. It is true, and it is
...
\begin{quote}
Empirical: a(n) = (4/3)*n\^{}3 + 2*n\^{}2 + (5/3)*n + 1. a(n) = 4*a(n-1) - 6*a(n-2) + 4*a(n-3) - a(n-4) for n>4.
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 18 2018 15:18:12, revision 12)
