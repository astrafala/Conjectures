...
\title{The empirical recurrence for OEIS A224349, proved by transfer matrix}
...
\begin{abstract}
OEIS A224349 counts arrays over $\{0,\dots,2\}$ whose rows, columns, diagonals or
antidiagonals are required to be monotone or unimodal, and carries an empirical recurrence of
order $26$ contributed by R.~H.~Hardin. A monotone condition is local, but a unimodal one
...
is a walk count on $S=3840$ vertices and the recurrence follows from a finite exact
computation.
\end{abstract}
...
OEIS A224349 is ``Number of n X 4 0..2 arrays with diagonals and antidiagonals unimodal and rows nondecreasing.''. It has offset $1$ and begins
\[
15, 225, 2321, 19608, 160362, 1351748, 11704964, 102319662,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 04 2022 08:11:06, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;15\,a(n-1) - 58\,a(n-2) - 13\,a(n-3) + 543\,a(n-4) - 1609\,a(n-5) + 1864\,a(n-6) - 17378\,a(n-7) + 62814\,a(n-8) + 73709\,a(n-9) - 307108\,a(n-10) + 721338\,a(n-11) - 862742\,a(n-12) + 4668915\,a(n-13) - 12478479\,a(n-14) - 3206649\,a(n-15) + 1858428\,a(n-16) + 5104796\,a(n-17) + 28929803\,a(n-18) + 21290844\,a(n-19) + 12857067\,a(n-20) - 28005842\,a(n-21) - 37205324\,a(n-22) - 26318800\,a(n-23) - 9161072\,a(n-24) - 1481856\,a(n-25) - 6336\,a(n-26)
\end{equation}
for all $n>26$.
...
bit vector), $|\mathcal V|=S=3840$; let $(r,f)\to(s,f')$ be an edge when placing $s$ after $r$
...
$h_j=G^{j}N^{o}\mathbf{1}$, we have for $j\ge26$
\[
a(n_0+j)-\sum_i c_i\,a(n_0+j-i)=\,\mathbf{v}^{\!\top}G^{\,j-26}w,
\qquad w=h_{26}-\sum_i c_ih_{26-i} .
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224349.
