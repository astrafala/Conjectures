...
\title{The empirical recurrence for OEIS A203726, proved by transfer matrix}
...
\begin{abstract}
OEIS A203726 counts arrays of width $7$ over $\{0,1,2\}$ through two derived arrays of PAIR SUMS ---
...
OEIS A203726 is ``Number of (n+1)X7 0..2 arrays with column and row pair sums b(i,j)=a(i,j)+a(i,j-1) and c(i,j)=a(i,j)+a(i-1,j) nondecreasing in column and row directions, respectively.''. It has offset $1$ and begins
\[
5653, 30335, 151649, 656441, 2572189, 9149941, 29840078, 90169885,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 10:40:55, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;9\,a(n-1) - 28\,a(n-2) + 12\,a(n-3) + 134\,a(n-4) - 294\,a(n-5) - 28\,a(n-6) + 876\,a(n-7) - 919\,a(n-8) - 833\,a(n-9) + 2312\,a(n-10) - 680\,a(n-11) - 2380\,a(n-12) + 2380\,a(n-13) + 680\,a(n-14) - 2312\,a(n-15) + 833\,a(n-16) + 919\,a(n-17) - 876\,a(n-18) + 28\,a(n-19) + 294\,a(n-20) - 134\,a(n-21) - 12\,a(n-22) + 28\,a(n-23) - 9\,a(n-24) + a(n-25)
\]
for every $n>36$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A203726.
