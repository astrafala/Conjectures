...
\title{The empirical recurrence for OEIS A274891, proved by counting patterns}
...
\begin{abstract}
OEIS A274891 counts arrays in which no entry may repeat a value found at any of three stated
...
OEIS A274891 is ``Number of nX4 0..2 arrays with no element equal to any value at offset (0,-1) (-1,-1) or (-2,0) and new values introduced in order 0..2.''. It has offset $1$ and begins
\[
4, 36, 37, 104, 275, 753, 2049, 5602,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 10 2016 20:05:36, revision 6) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A274891.
