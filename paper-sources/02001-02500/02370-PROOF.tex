...
\title{The empirical recurrence for OEIS A269204, proved by transfer matrix}
...
\begin{abstract}
OEIS A269204 counts arrays of width $4$ over $\{0,1,2,3\}$ in which the number of adjacent PAIRS of
...
result is a walk count on $S=769$ states.
\end{abstract}
...
OEIS A269204 is ``Number of 4Xn 0..3 arrays with some element plus some horizontally, diagonally or antidiagonally adjacent neighbor totalling three no more than once.''. It has offset $1$ and begins
\[
256, 15540, 471492, 15289548, 463790340, 13753913556, 399104835612, 11402099212308,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 20 2016 10:31:35, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;48\,a(n-1) - 424\,a(n-2) - 5664\,a(n-3) + 40624\,a(n-4) + 218356\,a(n-5) - 1300662\,a(n-6) - 2980700\,a(n-7) + 17916384\,a(n-8) + 2629424\,a(n-9) - 96328452\,a(n-10) + 132185980\,a(n-11) - 10936481\,a(n-12) - 91456900\,a(n-13) + 51588388\,a(n-14) + 9975760\,a(n-15) - 14279120\,a(n-16) + 2348160\,a(n-17) + 465152\,a(n-18) - 79872\,a(n-19) - 9216\,a(n-20)
\]
for every $n>20$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269204.
