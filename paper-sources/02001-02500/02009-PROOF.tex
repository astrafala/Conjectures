...
\title{The empirical recurrence for OEIS A204074, proved by counting patterns}
...
\begin{abstract}
OEIS A204074 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
$29$, contributed by R.~H.~Hardin, then follows from a finite exact computation.
\end{abstract}
...
OEIS A204074 is ``Number of (n+1)X7 0..2 arrays with every 2X2 subblock having equal diagonal elements or equal antidiagonal elements, and new values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
23438, 1944977, 173848010, 15960507749, 1480470688070, 137884925726873, 12862680257580962, 1200667125506097389,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 10:58:42, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;118\,a(n-1) - 731\,a(n-2) - 192994\,a(n-3) + 4365504\,a(n-4) + 7243432\,a(n-5) - 853595552\,a(n-6) + 4227025728\,a(n-7) + 47143688896\,a(n-8) - 407296962944\,a(n-9) - 429798333440\,a(n-10) + 11467618407936\,a(n-11) - 17466577684480\,a(n-12) - 111724579282944\,a(n-13) + 316040356208640\,a(n-14) + 361767531462656\,a(n-15) - 1868808138063872\,a(n-16) + 221838313259008\,a(n-17) + 4652179449380864\,a(n-18) - 2844522127687680\,a(n-19) - 5181635339747328\,a(n-20) + 4553597538271232\,a(n-21) + 2457666202894336\,a(n-22) - 2755619987652608\,a(n-23) - 413275992883200\,a(n-24) + 684703879266304\,a(n-25) - 18283340234752\,a(n-26) - 55383771054080\,a(n-27) + 8506451165184\,a(n-28) - 260919263232\,a(n-29)
\end{equation}
for all $n>28$.
...
For every $n$ with $m=n+1-1\ge29$,
\[
3!\Bigl(a(n)-\sum_i c_i\,a(n-i)\Bigr)\;=\;\mathbf{v}^{\!\top}N^{\,m-29}q(N)\mathbf{1} .
\]
...
\begin{proof}
Substitute \eqref{eq:walk} into the left side and factor $N^{m-29}$ out of
...
column. The vector $w=q(N)\mathbf{1}$ was then formed by $29$ matrix--vector products
...
corresponding to $n=28+1$ onwards, and the run continued until $w$ was the zero vector,
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204074.
