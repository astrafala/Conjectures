...
\title{A further conjecture on OEIS A165381,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A165381 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $37, 285, 1012, 2467, 4708, 7748, 11588, 16228,\dots$, with offset $2$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = 4*(817 - 540*n + 100*n\^{}2) for n>5.\end{quote}
