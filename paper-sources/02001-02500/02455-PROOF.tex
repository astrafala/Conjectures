...
\title{A further conjecture on OEIS A063136,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A063136 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $7, 24, 42, 60, 78, 96, 114, 132,\dots$, with offset $1$. The sequence satisfies
\[
  a(n)=2\,a(n-1) - 1\,a(n-2) ,
\]
...
\begin{quote}\raggedright a(n) = 6*(3*n-2) for n>1.\end{quote}
