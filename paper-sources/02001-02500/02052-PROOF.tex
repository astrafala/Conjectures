...
\title{The empirical recurrence for OEIS A269884, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A269884 counts arrays over $\{0,\dots,5\}$ subject to a condition on the array as a
...
which is what keeps the digraph sparse. That makes $a(n)$ a walk count on $S=2592$ vertices,
and the empirical recurrence of order $28$ contributed by R.~H.~Hardin then follows from
...
OEIS A269884 is ``Number of nX4 0..5 arrays with some element plus some horizontally, diagonally, antidiagonally or vertically adjacent neighbor totalling five exactly once.''. It has offset $1$ and begins
\[
450, 250992, 68182800, 16086672048, 3515869538472, 733651366146384, 148379658813705408, 29341273207567527696,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 06 2016 20:04:26, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;368\,a(n-1) - 37288\,a(n-2) + 513442\,a(n-3) + 19092162\,a(n-4) - 254746126\,a(n-5) - 4066323311\,a(n-6) + 31942950742\,a(n-7) + 306047150257\,a(n-8) - 1927227291934\,a(n-9) - 7298557273657\,a(n-10) + 52839733207460\,a(n-11) - 28821368827523\,a(n-12) - 241886001630920\,a(n-13) + 270713507877698\,a(n-14) + 478033822869814\,a(n-15) - 657675252228668\,a(n-16) - 495253464276818\,a(n-17) + 742330071209191\,a(n-18) + 285148670602762\,a(n-19) - 417256965071135\,a(n-20) - 91541370898138\,a(n-21) + 107835765439291\,a(n-22) + 15600180936884\,a(n-23) - 10267371310148\,a(n-24) - 1125910701408\,a(n-25) + 20603204284\,a(n-26) + 2599341920\,a(n-27) - 58369600\,a(n-28)
\end{equation}
for all $n>29$.
...
\[
\mathcal V=\bigl\{(r,c):\ r\in\{0,\dots,5\}^{4},\ c\in\{0,1\}\bigr\},
\qquad |\mathcal V|=S=2592,
\]
...
the digraph dense, with $(5+1)^{2\cdot4}$ edges instead of the sparse set used here.
\end{remark}
...
\]
for $j\ge28$. Hence \eqref{eq:conj} holds from that point on if and only if
...
formed by $28$ applications of $G$ in exact integer arithmetic and
$\mathbf{v}^{\!\top}G^{m}w$ evaluated for $m=0,1,\dots$, again exactly. Every one of
those integers vanishes from the index corresponding to $n=29+1$ onwards, and the run
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269884.
