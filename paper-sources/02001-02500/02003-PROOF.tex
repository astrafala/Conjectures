...
\title{The empirical recurrence for OEIS A185610, proved by transfer matrix}
...
\begin{abstract}
OEIS A185610 counts arrays over $\{0,\dots,2\}$ under a condition comparing a statistic of
...
empirical. The count is a walk count on $S=162$ states and is $C$-finite; whether the
...
OEIS A185610 is ``Number of (n+1)X2 0..2 arrays with every 2X2 subblock sum equal to some horizontal or vertical neighbor 2X2 subblock sum.''. It has offset $1$ and begins
\[
0, 171, 361, 3645, 13365, 94905, 424845, 2682129,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 03:07:48, revision 10) this is still
...
$S=162$ states in all. Getting the two vectors right is the whole of the argument: with
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) + 18\,a(n-2) - 159\,a(n-3) + 338\,a(n-4) - 48\,a(n-5) - 3888\,a(n-6) + 11346\,a(n-7) - 26856\,a(n-8) + 39504\,a(n-9) + 24264\,a(n-10) - 101520\,a(n-11) + 746208\,a(n-12) - 1142208\,a(n-13) + 3229632\,a(n-14) - 3297024\,a(n-15) + 5474304\,a(n-16) - 2985984\,a(n-17) + 2985984\,a(n-18)
\]
for every $n>18$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A185610.
