...
\title{The empirical recurrence for OEIS A268764, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A268764 counts arrays over $\{0,\dots,1\}$ subject to a condition on the array as a
...
OEIS A268764 is ``Number of n X 6 binary arrays with some element plus some horizontally, vertically, diagonally or antidiagonally adjacent neighbor totalling two exactly once.''. It has offset $1$ and begins
\[
20, 258, 2607, 23156, 193573, 1552272, 12111209, 92571436,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 07 2026 20:52:16, revision 6) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268764.
