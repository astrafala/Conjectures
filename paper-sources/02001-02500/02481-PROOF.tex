...
\title{A further conjecture on OEIS A208638,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A208638 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $4, 13, 32, 71, 150, 309, 628, 1267,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = 5*2\^{}n - n - 5.\end{quote}
