...
\title{The empirical recurrence for OEIS A183898, proved from an exact model}
...
\begin{abstract}
OEIS A183898 carries an empirical recurrence of order $4$. It is true, and it is
...
OEIS A183898 is ``Number of nondecreasing arrangements of n+3 numbers in 0..3 with each number being the sum mod 4 of three others.''. It has offset $1$ and begins
\[
5, 14, 38, 70, 111, 162, 224, 298,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (1/6)*n\^{}3 + (5/2)*n\^{}2 + (25/3)*n - 14 for n>1. a(n) = 4*a(n-1) - 6*a(n-2) + 4*a(n-3) - a(n-4) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 05 2018 10:27:29, revision 8)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A183898.
