...
\title{The empirical recurrence for OEIS A217450, proved by transfer matrix}
...
\begin{abstract}
OEIS A217450 counts the distinct arrays obtained by applying a fixed local operation to every cell
...
$S=12$ states, after which the conjectured recurrence is settled by a finite exact
computation.
\end{abstract}
...
OEIS A217450 is ``Number of n X 1 arrays of the minimum value of corresponding elements and their horizontal and vertical neighbors in a random 0..2 n X 1 array.''. It has offset $1$ and begins
\[
3, 3, 9, 17, 37, 77, 163, 343,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 19 2018 08:54:07, revision 9) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

Let $R=\{0,\dots,2\}^{1}$ be the set of rows and let the neighbours of
...
\]
There are $S=12$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A217450.
