...
\title{A further conjecture on OEIS A187048,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A187048 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $0, 0, 24, 272, 1084, 2660, 5032, 8164,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = 380*n\^{}2 - 2568*n + 4388 for n>5\end{quote}
