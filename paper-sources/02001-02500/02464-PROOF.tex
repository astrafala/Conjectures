...
\title{A further conjecture on OEIS A063134,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A063134 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $9, 32, 56, 80, 104, 128, 152, 176,\dots$, with offset $1$. The sequence satisfies
\[
  a(n)=2\,a(n-1) - 1\,a(n-2) ,
\]
...
\begin{quote}\raggedright a(n) = 8*(3*n-2) for n>1.\end{quote}
