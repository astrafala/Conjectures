...
\title{A further conjecture on OEIS A063150,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A063150 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $9, 30, 50, 72, 92, 114, 134, 156,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = ((-1)\^{}n + 42*n - 25) / 2 for n>1.\end{quote}
