...
\title{The empirical recurrence for OEIS A221083, proved by transfer matrix}
...
\begin{abstract}
OEIS A221083 counts the distinct OCCUPANCY arrays obtained when every cell of an $n\times4$ grid
...
determinising the machine that emits the occupancy row by row turns it into one, on $S=761$
...
OEIS A221083 is ``Number of n X 4 arrays of occupancy after each element moves to some horizontal or antidiagonal neighbor.''. It has offset $1$ and begins
\[
4, 169, 6889, 279841, 11363641, 461433361, 18736955689, 760832274049,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 45*a(n-1) - 180*a(n-2) + 64*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 03 2018 08:13:09, revision 7) this is still
...
\]
There are $S=761$ reachable sets. In particular $a$ is $C$-finite.
...
\begin{theorem}
\[
a(n)\;=\;45\,a(n-1) - 180\,a(n-2) + 64\,a(n-3)
\]
for every $n>3$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221083.
