...
\title{The empirical recurrence for OEIS A247534, proved from an exact model}
...
\begin{abstract}
OEIS A247534 carries an empirical recurrence of order $6$. It is true, and it is
...
OEIS A247534 is ``Number of length 2+3 0..n arrays with some disjoint pairs in every consecutive four terms having the same sum.''. It has offset $1$ and begins
\[
8, 45, 136, 317, 600, 1033, 1616, 2409,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + a(n-2) - 4*a(n-3) + a(n-4) + 2*a(n-5) - a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 07 2018 11:29:31, revision 8)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A247534.
