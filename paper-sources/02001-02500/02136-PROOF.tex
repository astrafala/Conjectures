...
\title{The empirical recurrence for OEIS A281833, proved by transfer matrix}
...
\begin{abstract}
OEIS A281833 counts $n\times4$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A281833 is ``Number of nX4 0..1 arrays with no element equal to more than four of its king-move neighbors and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
8, 121, 926, 8240, 74240, 663300, 5954670, 53530609,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 31 2017 11:14:25, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;9\,a(n-1) + 32\,a(n-3) - 252\,a(n-4) - 362\,a(n-5) - 318\,a(n-6) + 727\,a(n-7) + 2017\,a(n-8) + 937\,a(n-9) - 426\,a(n-10) - 3029\,a(n-11) + 1089\,a(n-12) + 9\,a(n-13) + 232\,a(n-14) - 2190\,a(n-15) + 162\,a(n-16) - 149\,a(n-17) + 512\,a(n-18) + 243\,a(n-19) + 198\,a(n-20) - 184\,a(n-21) - 34\,a(n-22) + 48\,a(n-23)
\]
for every $n>24$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A281833.
