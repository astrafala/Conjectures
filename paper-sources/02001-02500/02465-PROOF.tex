...
\title{A further conjecture on OEIS A063305,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A063305 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $-1, 13, 31, 49, 67, 85, 103, 121,\dots$, with offset $2$. The sequence satisfies
\[
  a(n)=2\,a(n-1) - 1\,a(n-2) ,
\]
...
\[
  q(x)=x^{2} - 2 x + 1 .
\]
This recurrence is stated by the entry as a fact; it is the premise of everything below and nothing else is assumed.
...
\begin{quote}\raggedright Conjecture: a(n) = 18*n - 41 for n > 2. - \_Peter Luschny\_, Mar 04 2012\end{quote}
...
indices, and $a$ and $f$ were checked to agree at $n=5,\dots,6$,
