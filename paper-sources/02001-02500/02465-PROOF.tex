...
\title{The empirical recurrence for OEIS A187956, proved by transfer matrix}
...
\begin{abstract}
OEIS A187956 counts arrays over $\{0,\dots,1\}$ under a condition comparing a statistic of
...
OEIS A187956 is ``Half the number of (n+2) X 3 binary arrays with no 3 X 3 subblock having a sum equal to any horizontal or vertical neighbor 3 X 3 subblock sum.''. It has offset $1$ and begins
\[
256, 1408, 7744, 42592, 240064, 1353088, 7626496, 42683776,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) + 9*a(n-2) - 36*a(n-3) + 144*a(n-4) + 324*a(n-5) + 729*a(n-6) - 2916*a(n-7) - 6561*a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 26 2018 09:34:42, revision 9) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

Write $\sigma$ for the sum of all its entries, taken on a $3\times3$ subblock. The contiguous $3\times3$
subblocks of an $(n+2)\times3$ array over $\{0,\dots,1\}$ form a grid of $n$ rows
...
3}=512$ tuples of $3$ rows, $S=512$ survive the condition inside a single subblock row;
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + 9\,a(n-2) - 36\,a(n-3) + 144\,a(n-4) + 324\,a(n-5) + 729\,a(n-6) - 2916\,a(n-7) - 6561\,a(n-8)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A187956.
