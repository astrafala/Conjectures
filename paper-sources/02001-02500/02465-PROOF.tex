...
\title{A further conjecture on OEIS A063151,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A063151 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $7, 20, 34, 48, 62, 76, 90, 104,\dots$, with offset $1$. The sequence satisfies
\[
  a(n)=2\,a(n-1) - 1\,a(n-2) ,
\]
...
\begin{quote}\raggedright a(n) = 14*n-8 for n>1.\end{quote}
