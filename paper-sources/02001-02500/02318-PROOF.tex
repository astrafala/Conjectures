...
\title{The empirical recurrence for OEIS A208441, proved by transfer matrix}
...
\begin{abstract}
OEIS A208441 counts arrays of width $4$ over $\{0,1,2\}$ in which no cell is the average of its neighbours. The entry carries an
...
OEIS A208441 is ``Number of nX4 0..2 arrays with no element equal the average of immediate neighbors vertically above and horizontally left of it.''. It has offset $1$ and begins
\[
24, 646, 17992, 505000, 14204032, 399447742, 11236338658, 316042155314,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:52:20, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;22\,a(n-1) + 232\,a(n-2) - 2274\,a(n-3) + 21340\,a(n-4) - 147601\,a(n-5) + 623877\,a(n-6) - 2478495\,a(n-7) + 7316863\,a(n-8) - 20304345\,a(n-9) + 44585841\,a(n-10) - 86967147\,a(n-11) + 136172607\,a(n-12) - 169769685\,a(n-13) + 156927435\,a(n-14) - 104021019\,a(n-15) + 37315604\,a(n-16) - 12243416\,a(n-17) - 91497206\,a(n-18) + 127102756\,a(n-19) - 195503192\,a(n-20) + 105015024\,a(n-21) - 69805280\,a(n-22) + 74556992\,a(n-23) - 23342720\,a(n-24) + 26862336\,a(n-25) - 18183168\,a(n-26) + 5672960\,a(n-27) - 2228224\,a(n-28) + 786432\,a(n-29) - 262144\,a(n-30)
\]
for every $n>30$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208441.
