...
\title{The empirical recurrence for OEIS A265874, proved by transfer matrix}
...
\begin{abstract}
OEIS A265874 counts arrays of width $2$ in which every entry is equal to the NUMBER of its own
...
OEIS A265874 is ``Number of nX2 integer arrays with each element equal to the number of horizontal, vertical and antidiagonal neighbors less than itself.''. It has offset $1$ and begins
\[
3, 25, 137, 2084, 14854, 136969, 1288011, 10892624,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 17 2015 10:05:36, revision 5) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A265874.
