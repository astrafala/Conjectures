...
\title{The empirical recurrence for OEIS A268903, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A268903 counts arrays over $\{0,\dots,2\}$ subject to a condition on the array as a
...
OEIS A268903 is ``Number of nX7 0..2 arrays with some element plus some horizontally or antidiagonally adjacent neighbor totalling two exactly once.''. It has offset $1$ and begins
\[
576, 34344, 1585800, 66210264, 2611960344, 99308573208, 3679171151832, 133712637011640,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 84*a(n-1) -2466*a(n-2) +31428*a(n-3) -206469*a(n-4) +750384*a(n-5) -1513404*a(n-6) +1574640*a(n-7) -656100*a(n-8)
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 15 2016 14:57:46, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;84\,a(n-1) - 2466\,a(n-2) + 31428\,a(n-3) - 206469\,a(n-4) + 750384\,a(n-5) - 1513404\,a(n-6) + 1574640\,a(n-7) - 656100\,a(n-8)
\end{equation}
for all $n>8$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268903.
