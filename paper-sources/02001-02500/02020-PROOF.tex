...
\title{The empirical recurrence for OEIS A269621, proved from an exact model}
...
\begin{abstract}
OEIS A269621 carries an empirical recurrence of order $6$. It is true, and it is
...
which $a$ provably satisfies a MONIC linear recurrence of order $S=27$, derived below and not
...
OEIS A269621 is ``Number of length-5 0..n arrays with no repeated value differing from the previous repeated value by other than plus two, zero or minus 1.''. It has offset $1$ and begins
\[
28, 222, 954, 2956, 7440, 16218, 31822, 57624,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = n\^{}5 + 5*n\^{}4 + 7*n\^{}3 + 12*n\^{}2 + 3*n. a(n) = 6*a(n-1) - 15*a(n-2) + 20*a(n-3) - 15*a(n-4) + 6*a(n-5) - a(n-6) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 25 2019 08:28:03, revision 8)
...
everywhere, a monic recurrence of order $S=27$. The annihilator was then asked for terms the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269621.
