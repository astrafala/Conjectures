...
\title{The empirical recurrence for OEIS A250141, proved from an exact model}
...
\begin{abstract}
OEIS A250141 carries an empirical recurrence of order $5$. It is true, and it is
...
OEIS A250141 is ``Number of length 2+2 0..n arrays with the medians of every three consecutive terms nondecreasing.''. It has offset $1$ and begins
\[
14, 67, 204, 485, 986, 1799, 3032, 4809,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (2/3)*n\^{}4 + (10/3)*n\^{}3 + (16/3)*n\^{}2 + (11/3)*n + 1. a(n) = 5*a(n-1) - 10*a(n-2) + 10*a(n-3) - 5*a(n-4) + a(n-5) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 12 2018 03:00:45, revision 11)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250141.
