...
\title{The empirical recurrence for OEIS A229504, proved by counting defective colourings}
...
\begin{abstract}
OEIS A229504 counts the colourings of an array with $K=3$ colours that are proper except at
...
OEIS A229504 is ``Number of defective 3-colorings of an n X 2 0..2 array connected diagonally and antidiagonally with exactly one mistake, and colors introduced in row-major 0..2 order.''. It has offset $1$ and begins
\[
0, 6, 48, 288, 1536, 7680, 36864, 172032,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 8*a(n-1) -16*a(n-2).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 16 2017 07:54:44, revision 28) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A229504.
