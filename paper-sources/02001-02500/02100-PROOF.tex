...
\title{The empirical recurrence for OEIS A224276, proved by transfer matrix}
...
\begin{abstract}
OEIS A224276 counts arrays over $\{0,\dots,3\}$ whose rows, columns, diagonals or
...
is a walk count on $S=400$ vertices and the recurrence follows from a finite exact
computation.
\end{abstract}
...
OEIS A224276 is ``Number of nX3 0..3 arrays with diagonals and rows unimodal and antidiagonals nondecreasing.''. It has offset $1$ and begins
\[
50, 984, 13683, 186516, 2596992, 37128051, 537465766, 7804602744,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 23:20:09, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;20\,a(n-1) - 70\,a(n-2) - 211\,a(n-3) + 192\,a(n-4) + 15174\,a(n-5) - 36608\,a(n-6) - 83340\,a(n-7) + 59774\,a(n-8) + 2310958\,a(n-9) - 3620776\,a(n-10) - 5846720\,a(n-11) + 390652\,a(n-12) + 87932540\,a(n-13) - 70516876\,a(n-14) + 46329332\,a(n-15) + 7472696\,a(n-16) - 557612816\,a(n-17) + 319521288\,a(n-18) - 63018416\,a(n-19) + 17463360\,a(n-20) + 1046997696\,a(n-21) - 323677440\,a(n-22) - 14515200\,a(n-23) - 56540160\,a(n-24) - 635904000\,a(n-25)
\end{equation}
for all $n>26$.
...
bit vector), $|\mathcal V|=S=400$; let $(r,f)\to(s,f')$ be an edge when placing $s$ after $r$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224276.
