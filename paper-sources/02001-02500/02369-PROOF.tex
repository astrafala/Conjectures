...
\title{The empirical recurrence for OEIS A210091, proved by transfer matrix}
...
\begin{abstract}
OEIS A210091 counts arrays of width $5$ whose every $2\times2$ subblock holds a
prescribed number of DISTINCT values, which use ALL of the $3$ available letters, and which
are counted up to renaming. The entry carries an empirical recurrence of order $22$
...
OEIS A210091 is ``Number of (n+1)X5 0..2 arrays containing all values 0..2 with every 2X2 subblock having one or two distinct values, and new values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
657, 29650, 1318221, 57786977, 2488428258, 105669469816, 4440075543303, 185097842285157,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 15:42:49, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;92\,a(n-1) - 2759\,a(n-2) + 28247\,a(n-3) - 12894\,a(n-4) - 1142474\,a(n-5) + 3601421\,a(n-6) + 11970542\,a(n-7) - 56246539\,a(n-8) - 20466947\,a(n-9) + 259395248\,a(n-10) - 85275847\,a(n-11) - 451433420\,a(n-12) + 270874469\,a(n-13) + 310376692\,a(n-14) - 241516822\,a(n-15) - 72716144\,a(n-16) + 82685288\,a(n-17) - 2658056\,a(n-18) - 9212400\,a(n-19) + 1726736\,a(n-20) + 40928\,a(n-21) - 15360\,a(n-22)
\]
for every $n>21$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A210091.
