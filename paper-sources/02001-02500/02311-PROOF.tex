...
\title{Arrays counted up to renaming: the empirical recurrence for OEIS A205330}
...
\begin{abstract}
OEIS A205330 carries an empirical recurrence of order $13$ contributed by R.~H.~Hardin. It is
...
OEIS A205330 is ``Number of (n+1)X4 0..2 arrays with the number of equal 2X2 subblock diagonal pairs and equal antidiagonal pairs differing from each horizontal or vertical neighbor, and new values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
396, 4860, 63270, 827904, 10839696, 141909312, 1857980448, 24321964032,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 12:00:52, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;192\,a(n-2) - 3844\,a(n-4) + 2656\,a(n-5) + 20720\,a(n-6) - 30528\,a(n-7) + 42944\,a(n-8) - 17408\,a(n-9) - 103424\,a(n-10) + 77824\,a(n-11) - 114688\,a(n-12) + 65536\,a(n-13)
\]
for every $n>13$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A205330.
