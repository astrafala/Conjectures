...
\title{The empirical recurrence for OEIS A262467, proved by transfer matrix}
...
\begin{abstract}
OEIS A262467 counts arrays of width $4$ over $\{0,1\}$ whose rows, read as base-$2$
numbers, are divisible by $3$ and whose columns, read the same way, are divisible by
$5$. The entry carries an empirical recurrence of order $15$ contributed by
...
OEIS A262467 is ``Number of (n+1)X(3+1) 0..1 arrays with each row divisible by 3 and each column divisible by 5, read as a binary number with top and left being the most significant bits.''. It has offset $1$ and begins
\[
1, 6, 36, 115, 469, 2622, 15732, 85723,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 23 2015 18:48:15, revision 4) this is still
...
$3$ and every $\gamma_j$ be divisible by $5$.
...
\begin{theorem}
\[
a(n)\;=\;11\,a(n-1) - 49\,a(n-2) + 179\,a(n-3) - 382\,a(n-4) - 478\,a(n-5) + 4682\,a(n-6) - 20542\,a(n-7) + 61367\,a(n-8) - 104077\,a(n-9) + 152183\,a(n-10) - 136453\,a(n-11) - 60984\,a(n-12) + 104544\,a(n-13) - 156816\,a(n-14) + 156816\,a(n-15)
\]
for every $n>13$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A262467.
