...
\title{The empirical recurrence for OEIS A232139, proved by transfer matrix}
...
\begin{abstract}
OEIS A232139 counts $3\times(n+1)$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A232139 is ``Number of (2+1)X(n+1) 0..2 arrays with no element equal to a strict majority of its horizontal and antidiagonal neighbors, with values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
44, 728, 10956, 169692, 2616952, 40399768, 623543776, 9624373808,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 06:54:19, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;15\,a(n-1) + 16\,a(n-2) - 163\,a(n-3) + 305\,a(n-4) + 116\,a(n-5) - 2324\,a(n-6) + 1718\,a(n-7) - 5922\,a(n-8) + 14296\,a(n-9) + 18892\,a(n-10) - 15292\,a(n-11) - 21000\,a(n-12) - 12320\,a(n-13) - 17184\,a(n-14) + 11072\,a(n-15) + 5120\,a(n-17)
\]
for every $n>17$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232139.
