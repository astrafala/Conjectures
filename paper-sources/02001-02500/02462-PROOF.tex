...
\title{A further conjecture on OEIS A063140,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A063140 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $5, 28, 52, 76, 100, 124, 148, 172,\dots$, with offset $1$. The sequence satisfies
\[
  a(n)=2\,a(n-1) - 1\,a(n-2) ,
\]
...
\begin{quote}\raggedright a(n) = 24*n-20 for n>1.\end{quote}
