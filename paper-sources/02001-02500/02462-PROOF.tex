...
\title{A further conjecture on OEIS A063142,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A063142 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $8, 27, 45, 65, 83, 103, 121, 141,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = ((-1)\^{}n + 38*n -23) / 2 for n>1.\end{quote}
