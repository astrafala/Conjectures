...
\title{The empirical recurrence for OEIS A280400, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A280400 imposes three things at once: a condition on each cell that reaches one column up and
...
OEIS A280400 is ``Number of 2Xn 0..2 arrays with no element unequal to a strict majority of its horizontal and antidiagonal neighbors, with the exception of exactly one element, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
0, 2, 6, 16, 34, 76, 158, 336,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) +a(n-2) -7*a(n-3) +4*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 04 2017 13:28:34, revision 6) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A280400.
