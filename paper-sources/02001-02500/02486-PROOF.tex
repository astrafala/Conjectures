...
\title{A further conjecture on OEIS A228254,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A228254 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $17, 143, 621, 2059, 6305, 19171, 58025, 175099,\dots$, with offset $1$. The sequence satisfies
\[
  a(n)=5\,a(n-1) - 6\,a(n-2) ,
\]
...
\begin{quote}\raggedright a(n) = 3\^{}(3+n) - 2\^{}(3+n) for n>3.\end{quote}
