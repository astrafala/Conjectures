...
\title{A further conjecture on OEIS A187175,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A187175 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $0, 0, 0, 0, 16, 136, 456, 1024,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = 100*n\^{}2 - 920*n + 1984 for n>7.\end{quote}
