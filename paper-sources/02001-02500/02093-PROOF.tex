...
\title{The empirical recurrence for OEIS A281930, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A281930 imposes three things at once: a condition on each cell that reaches one row up and
...
OEIS A281930 is ``Number of n X 2 0..1 arrays with no element equal to more than four of its king-move neighbors, with the exception of exactly two elements, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
0, 0, 1, 6, 33, 166, 792, 3654,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 6*a(n-1) - 3*a(n-2) - 14*a(n-3) - 21*a(n-4) - 12*a(n-5) - 4*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 20 2019 09:45:35, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A281930.
