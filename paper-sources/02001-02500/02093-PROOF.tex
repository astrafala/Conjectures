...
\title{The empirical recurrence for OEIS A203537, proved by transfer matrix}
...
\begin{abstract}
OEIS A203537 counts arrays of width $3$ over $\{0,1,2\}$ in which every cell has neighbours equal to each of two named values. The entry carries an
...
OEIS A203537 is ``Number of nX3 0..2 arrays with every element neighboring horizontally or vertically both a 0 and a 1.''. It has offset $1$ and begins
\[
0, 4, 72, 144, 1840, 10404, 69920, 490000,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 10:32:21, revision 9) this is still
...
Thus
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=600,
\]
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-1) - 8\,a(n-3) - 38\,a(n-4) + 218\,a(n-5) + 400\,a(n-6) - 2936\,a(n-7) + 609\,a(n-8) - 2791\,a(n-9) + 4072\,a(n-10) + 248\,a(n-11) - 588\,a(n-12) + 4916\,a(n-13) - 1912\,a(n-14) + 8920\,a(n-15) - 7799\,a(n-16) + 3393\,a(n-17) - 5960\,a(n-18) - 464\,a(n-19) - 238\,a(n-20) + 18\,a(n-21) - 56\,a(n-22) - 9\,a(n-24) - a(n-25)
\]
for every $n>25$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A203537.
