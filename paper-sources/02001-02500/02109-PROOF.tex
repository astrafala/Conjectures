...
\title{The empirical closed form for OEIS A224263, proved}
...
\begin{abstract}
OEIS A224263 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
$S=5120$ vertices. Any function of the form $\sum_j p_j(n)\lambda_j^{\,n}$ satisfies the
...
OEIS A224263 is ``Number of 3 X n 0..2 arrays with rows, diagonals and antidiagonals unimodal and columns nondecreasing.''. It has offset $1$ and begins
\[
10, 100, 648, 3096, 12032, 40182, 119367, 322885,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 18 2025 22:32:43, revision 10) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{n^{12}}{19160064} + \frac{n^{11}}{1064448} + \frac{181 n^{10}}{6220800} + \frac{557 n^{9}}{1451520} + \frac{13571 n^{8}}{2903040} + \frac{3197 n^{7}}{96768} + \frac{8451841 n^{6}}{43545600} + \frac{316789 n^{5}}{483840} + \frac{535159 n^{4}}{311040} + \frac{151169 n^{3}}{72576} + \frac{9281749 n^{2}}{1663200} - \frac{73057 n}{13860} + 5.
\]
...
walk, so with $M$ the adjacency matrix of that digraph on $S=5120$ vertices, and $u,w$ the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224263.
