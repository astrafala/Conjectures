...
\title{The empirical recurrence for OEIS A197103, proved by transfer matrix}
...
\begin{abstract}
OEIS A197103 counts arrays of width $2$ over $\{0,1,2,3\}$ in which no cell is the average of its neighbours. The entry carries an
...
OEIS A197103 is ``Half the number of nX2 0..3 arrays with no element equal to the average of its horizontal and vertical neighbors.''. It has offset $1$ and begins
\[
6, 78, 1015, 13526, 181032, 2421376, 32393085, 433365018,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 06:59:19, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;13\,a(n-1) + 5\,a(n-2) + 30\,a(n-3) - 377\,a(n-4) - 258\,a(n-5) + 874\,a(n-6) + 1758\,a(n-7) + 685\,a(n-8) - 2995\,a(n-9) - 3798\,a(n-10) - 1113\,a(n-11) + 2557\,a(n-12) + 3786\,a(n-13) + 1955\,a(n-14) - 639\,a(n-15) - 1523\,a(n-16) - 683\,a(n-17) + 14\,a(n-18) + 254\,a(n-19) + 36\,a(n-20)
\]
for every $n>20$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A197103.
