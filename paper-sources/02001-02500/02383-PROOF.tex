...
\title{The empirical recurrence for OEIS A209843, proved by counting patterns}
...
\begin{abstract}
OEIS A209843 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A209843 is ``Number of (n+1)X4 0..3 arrays with every 2X2 subblock having one or two distinct values, and new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
227, 5083, 115435, 2713195, 64857323, 1569132907, 38265187051, 938086148459,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 15:32:12, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;43\,a(n-1) - 459\,a(n-2) - 321\,a(n-3) + 13084\,a(n-4) - 11850\,a(n-5) - 84560\,a(n-6) + 143072\,a(n-7) + 6528\,a(n-8) - 98304\,a(n-9) + 32768\,a(n-10)
\end{equation}
for all $n>9$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209843.
