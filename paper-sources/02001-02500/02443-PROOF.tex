...
\title{A further conjecture on OEIS A049486,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A049486 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $1, 4, 10, 21, 34, 53, 74, 101,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Conjecture: a(n) = (9 + (-1)\^{}n - 8*n + 4*n\^{}2)/2 for n > 2.\end{quote}
