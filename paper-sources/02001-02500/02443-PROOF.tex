...
\title{A further conjecture on OEIS A063116,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A063116 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $3, 18, 34, 50, 66, 82, 98, 114,\dots$, with offset $1$. The sequence satisfies
\[
  a(n)=2\,a(n-1) - 1\,a(n-2) ,
\]
...
\begin{quote}\raggedright a(n) = 2*(8*n-7) for n>1.\end{quote}
