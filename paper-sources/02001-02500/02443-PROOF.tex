...
\title{The empirical recurrence for OEIS A198529, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A198529 counts arrays in which every cell is constrained by its neighbours on \emph{both}
...
OEIS A198529 is ``Number of 2nX4 0..2 arrays with values 0..2 introduced in row major order and each element equal to exactly one horizontal or vertical neighbor.''. It has offset $1$ and begins
\[
12, 206, 3838, 74582, 1481214, 29737425, 600187403, 12144602583,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 07:54:47, revision 10) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;42\,a(n-1) - 599\,a(n-2) + 3637\,a(n-3) - 8567\,a(n-4) - 1138\,a(n-5) + 28475\,a(n-6) - 23674\,a(n-7) - 2916\,a(n-8) + 112776\,a(n-9) - 163480\,a(n-10) - 147783\,a(n-11) - 101412\,a(n-12) - 148912\,a(n-13) + 747248\,a(n-14) + 967680\,a(n-15) - 1452032\,a(n-16) - 4042752\,a(n-17) - 7405568\,a(n-18) - 7340032\,a(n-19) - 4194304\,a(n-20)
\end{equation}
for all $n>20$.
...
index,
\[
3!\Bigl(a(n)-\sum_i c_i\,a(n-i)\Bigr)\;=\;\mathbf{v}^{\!\top}G^{\,j-20}\,
...
index corresponding to $n=20+1$ onwards, and the run was continued until $S+1$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A198529.
