...
\title{The empirical recurrence for OEIS A223796, proved by transfer matrix}
...
\begin{abstract}
OEIS A223796 counts arrays over $\{0,\dots,3\}$ whose rows, columns, diagonals or
...
OEIS A223796 is ``Number of nX3 0..3 arrays with rows and antidiagonals unimodal.''. It has offset $1$ and begins
\[
50, 2500, 110116, 4816168, 210163664, 9169032476, 400006582368, 17450517286804,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 22:30:14, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;50\,a(n-1) - 253\,a(n-2) - 1283\,a(n-3) + 8456\,a(n-4) - 10020\,a(n-5) - 12064\,a(n-6) + 27360\,a(n-7) - 6656\,a(n-8) - 9728\,a(n-9) + 4096\,a(n-10)
\end{equation}
for all $n>10$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223796.
