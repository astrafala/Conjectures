...
\title{The empirical recurrence for OEIS A231058, proved by transfer matrix}
...
\begin{abstract}
OEIS A231058 counts arrays of width $3$ over $\{0,1,2,3\}$ in which every cell must see, among its
...
carries an empirical recurrence of order $10$ contributed by R.~H.~Hardin. It is true, and
it is decidable rather than empirical: a cell's neighbours lie in three consecutive rows, so
the count is a walk count on $S=861$ states.
\end{abstract}
...
OEIS A231058 is ``Number of n X 3 0..3 arrays x(i,j) with each element horizontally or vertically next to at least one element with value (x(i,j)+1) mod 4, no adjacent elements equal, and upper left element zero.''. It has offset $1$ and begins
\[
0, 6, 34, 208, 1272, 7818, 47998, 294832,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 8*a(n-1) -9*a(n-2) -20*a(n-3) +29*a(n-4) +22*a(n-5) -23*a(n-6) -14*a(n-7) -14*a(n-8) +4*a(n-9) +2*a(n-10).
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 21 2021 14:27:08, revision 6) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=861.
\]
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-1) - 9\,a(n-2) - 20\,a(n-3) + 29\,a(n-4) + 22\,a(n-5) - 23\,a(n-6) - 14\,a(n-7) - 14\,a(n-8) + 4\,a(n-9) + 2\,a(n-10)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231058.
