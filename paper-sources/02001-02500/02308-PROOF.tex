...
\title{The empirical recurrence for OEIS A281465, proved by transfer matrix}
...
\begin{abstract}
OEIS A281465 counts $n\times4$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A281465 is ``Number of n X 4 0..1 arrays with no element equal to more than two of its horizontal, diagonal or antidiagonal neighbors and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
8, 37, 39, 96, 207, 405, 897, 1975,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + a(n-2) + 4*a(n-3) + a(n-4) - 4*a(n-5) - 5*a(n-6) + 3*a(n-8) for n>10.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 19 2019 11:32:25, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + a(n-2) + 4\,a(n-3) + a(n-4) - 4\,a(n-5) - 5\,a(n-6) + 3\,a(n-8)
\]
for every $n>10$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A281465.
