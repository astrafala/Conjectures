...
\title{The empirical recurrence for OEIS A266029, proved by transfer matrix}
...
\begin{abstract}
OEIS A266029 counts arrays of width $4$ in which every entry is equal to the NUMBER of its own
...
OEIS A266029 is ``Number of nX4 integer arrays with each element equal to the number of horizontal and antidiagonal neighbors less than itself.''. It has offset $1$ and begins
\[
11, 315, 5594, 118489, 2482216, 52086421, 1092258910, 22909266015,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 20 2015 07:41:05, revision 4) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=34931.
\]
...
\begin{theorem}
\[
a(n)\;=\;11\,a(n-1) + 231\,a(n-2) - 100\,a(n-3) - 7612\,a(n-4) - 1116\,a(n-5) + 74582\,a(n-6) - 64354\,a(n-7) - 370540\,a(n-8) + 661109\,a(n-9) + 1260417\,a(n-10) + 252581\,a(n-11) - 15283\,a(n-12) + 86793\,a(n-13) - 32631\,a(n-14) + 2989\,a(n-15) - 36\,a(n-16)
\]
for every $n>17$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A266029.
