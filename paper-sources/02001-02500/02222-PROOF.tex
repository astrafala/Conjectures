...
\title{The empirical recurrence for OEIS A269883, proved by transfer matrix}
...
\begin{abstract}
OEIS A269883 counts arrays of width $3$ over $\{0,1,\dots,5\}$ in which the number of adjacent PAIRS of
cells whose entries add up to $5$ is exactly one. The entry carries an empirical recurrence of
...
result is a walk count on $S=577$ states.
\end{abstract}
...
OEIS A269883 is ``Number of n X 3 0..5 arrays with some element plus some horizontally, diagonally, antidiagonally or vertically adjacent neighbor totaling five exactly once.''. It has offset $1$ and begins
\[
60, 11280, 943488, 68182800, 4546948272, 288987039048, 17784013336560, 1069390341717552,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 17 2023 15:28:22, revision 6) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The array has $3$ cells across, with entries in $\{0,1,\dots,5\}$. An ADJACENT PAIR is a pair of cells
\[
\begin{array}{l}
$(i,j)\text{ and }(i,j{+}1)$ \\
$(i,j)\text{ and }(i{+}1,j)$ \\
...
each end. Writing $k$ for the number of adjacent pairs whose two entries add up to $5$, the
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=577.
\]
...
\begin{theorem}
\[
a(n)\;=\;108\,a(n-1) - 3084\,a(n-2) + 8184\,a(n-3) + 42266\,a(n-4) - 148704\,a(n-5) - 74928\,a(n-6) + 597192\,a(n-7) - 527833\,a(n-8) + 90420\,a(n-9) - 4356\,a(n-10)
\]
for every $n>11$.
\end{theorem}
...
adjacent pairs summing to $5$ by running over the array once for each kind of pair, and keep
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269883.
