...
\title{The empirical recurrence for OEIS A252966, proved by transfer matrix}
...
\begin{abstract}
OEIS A252966 counts arrays of width $7$ over an alphabet of $5$ letters in which every three
...
OEIS A252966 is ``Number of (5+2)X(n+2) 0..4 arrays with every consecutive three elements in every row and diagonal having exactly two distinct values, and in every column and antidiagonal not having exactly two distinct values, and new values 0 upwards introduced in row major order.''. It has offset $1$ and begins
\[
1543, 596, 871, 1242, 1747, 2822, 4019, 6133,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:48:49, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 6\,a(n-2) - a(n-3) - 15\,a(n-4) - 20\,a(n-5) + 26\,a(n-6) + 54\,a(n-7) - 12\,a(n-8) - 48\,a(n-9) - 47\,a(n-10) + 47\,a(n-11) + 22\,a(n-12) - 27\,a(n-13) + 27\,a(n-14) - 12\,a(n-15) + 18\,a(n-16) - 18\,a(n-17)
\]
for every $n>19$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252966.
