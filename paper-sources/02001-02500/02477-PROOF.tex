...
\title{A further conjecture on OEIS A207937,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A207937 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $35, 1225, 8977, 38207, 121313, 319439, 737575, 1544037,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = (1260 + 4974*n - 32165*n\^{}2 - 6041*n\^{}3 + 51940*n\^{}4 + 21091*n\^{}5 + 2905*n\^{}6 + 136*n\^{}7) / 1260.\end{quote}
