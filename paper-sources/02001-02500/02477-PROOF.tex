...
\title{A further conjecture on OEIS A184546,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A184546 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $539, 1513, 3461, 7307, 14767, 28844, 54543, 99872,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (1/362880)*n\^{}9 + (1/5760)*n\^{}8 + (289/60480)*n\^{}7 + (217/2880)*n\^{}6 + (12949/17280)*n\^{}5 + (28049/5760)*n\^{}4 + (468401/22680)*n\^{}3 + (210319/1440)*n\^{}2 + (145955/504)*n + 77.\end{quote}
