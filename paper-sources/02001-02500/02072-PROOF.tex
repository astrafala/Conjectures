...
\title{The empirical recurrence for OEIS A221525, proved from an exact model}
...
\begin{abstract}
OEIS A221525 carries an empirical recurrence of order $6$. It is true, and it is
...
OEIS A221525 is ``Number of 0..n arrays of length 5 with each element differing from at least one neighbor by 2 or more.''. It has offset $1$ and begins
\[
0, 6, 94, 536, 1940, 5368, 12458, 25544,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 1*n\^{}5 - 1*n\^{}4 - 10*n\^{}3 + 38*n\^{}2 - 60*n + 40 for n>2. a(n) = 6*a(n-1) - 15*a(n-2) + 20*a(n-3) - 15*a(n-4) + 6*a(n-5) - a(n-6) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 06 2018 07:25:17, revision 8)
...
\]
annihilates $a$, and $S=\deg A=16$. A congruence condition modulo $m$ is counted one residue
...
exactly $\deg A$. The bound in force is therefore $zA(z)$, of order $S=16$, and
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221525.
