...
\title{The empirical recurrence for OEIS A221598, proved from an exact model}
...
\begin{abstract}
OEIS A221598 carries an empirical recurrence of order $4$. It is true, and it is
...
\begin{quote}
Empirical: a(n) = 27*n\^{}3 + 108*n\^{}2 - 252*n + 267 for n>3. a(n) = 4*a(n-1) - 6*a(n-2) + 4*a(n-3) - a(n-4) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 09 2018 08:56:49, revision 7)
