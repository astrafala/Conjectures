...
\title{The empirical recurrence for OEIS A204363, proved by transfer matrix}
...
\begin{abstract}
OEIS A204363 counts $(n+2)\times3$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A204363 is ``Number of (n+2)X3 0..2 arrays with every 3X3 subblock having three equal elements in a row horizontally, vertically or nw-to-se diagonally exactly three ways, and new values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
74, 212, 555, 891, 2419, 6121, 13693, 38041,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 11:10:28, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) - 7\,a(n-2) + 3\,a(n-3) - 6\,a(n-4) + 12\,a(n-5) + 14\,a(n-6) - 84\,a(n-7) + 164\,a(n-8) - 292\,a(n-9) + 392\,a(n-10) - 392\,a(n-11) + 640\,a(n-12) - 896\,a(n-13) + 64\,a(n-14) + 2176\,a(n-15) - 3584\,a(n-16) + 2304\,a(n-17) - 512\,a(n-18)
\]
for every $n>18$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204363.
