...
\title{A further conjecture on OEIS A200789,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A200789 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $128, 1791, 11704, 50775, 169884, 474566, 1160616, 2562633,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = (5040 + 40704*n + 127582*n\^{}2 + 199213*n\^{}3 + 169960*n\^{}4 + 80626*n\^{}5 + 19978*n\^{}6 + 2017*n\^{}7) / 5040.\end{quote}
