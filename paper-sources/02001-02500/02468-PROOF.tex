...
\title{A further conjecture on OEIS A063144,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A063144 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $8, 27, 47, 67, 87, 107, 127, 147,\dots$, with offset $1$. The sequence satisfies
\[
  a(n)=2\,a(n-1) - 1\,a(n-2) ,
\]
...
\begin{quote}\raggedright a(n) = 20*n-13 for n>1.\end{quote}
