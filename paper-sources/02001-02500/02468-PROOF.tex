...
\title{A further conjecture on OEIS A166756,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A166756 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $0, 24, 174, 642, 1716, 3780, 7314, 12894,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = 4*n\^{}4 - 8*n\^{}3 + 11*n\^{}2 - 13*n + 6.\end{quote}
