...
\title{The empirical recurrence for OEIS A204295, proved by transfer matrix}
...
\begin{abstract}
OEIS A204295 counts arrays of width $2$ over $\{0,1,2,3\}$ in which every cell has neighbours equal to each of two named values. The entry carries an
...
OEIS A204295 is ``Number of n X 2 0..3 arrays with every element neighboring horizontally or vertically both a 0 and a 1, and 2 introduced before 3 in row major order.''. It has offset $1$ and begins
\[
0, 4, 4, 16, 68, 212, 776, 3076,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) +2*a(n-2) +4*a(n-3) -42*a(n-4) -30*a(n-5) +13*a(n-6) +38*a(n-7) +28*a(n-8) -16*a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 07 2018 06:18:47, revision 12) this is still
...
Thus
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=171,
\]
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + 2\,a(n-2) + 4\,a(n-3) - 42\,a(n-4) - 30\,a(n-5) + 13\,a(n-6) + 38\,a(n-7) + 28\,a(n-8) - 16\,a(n-9)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204295.
