...
\title{A further conjecture on OEIS A063121,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A063121 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $4, 13, 21, 31, 39, 49, 57, 67,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = ((-1)\^{}n + 18*n - 11) / 2 for n>1.\end{quote}
