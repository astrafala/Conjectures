...
\title{The empirical recurrence for OEIS A188237, proved from an exact model}
...
\begin{abstract}
OEIS A188237 carries an empirical recurrence of order $6$. It is true, and it is
...
OEIS A188237 is ``Number of nondecreasing arrangements of 4 numbers in -(n+2)..(n+2) with sum zero and not more than two numbers equal.''. It has offset $1$ and begins
\[
15, 30, 52, 81, 121, 172, 234, 311,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) - 3*a(n-2) + 2*a(n-3) - 3*a(n-4) + 3*a(n-5) - a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 27 2018 08:31:54, revision 8)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A188237.
