...
\title{The empirical recurrence for OEIS A275500, proved by counting patterns}
...
\begin{abstract}
OEIS A275500 counts arrays in which no entry may repeat a value found at any of three stated
...
cutting $6818$ pairs to $S=1223$ states. The entry's empirical recurrence of order $16$,
...
OEIS A275500 is ``Number of nX4 0..2 arrays with no element equal to any value at offset (-2,-1) (-2,0) or (-1,-1) and new values introduced in order 0..2.''. It has offset $1$ and begins
\[
14, 324, 400, 656, 988, 2628, 7140, 19368,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 30 2016 19:55:19, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 8\,a(n-2) - 28\,a(n-4) - 9\,a(n-5) + 55\,a(n-6) + 16\,a(n-7) - 70\,a(n-8) - 9\,a(n-9) + 56\,a(n-10) - 28\,a(n-12) + a(n-13) + 8\,a(n-14) - a(n-16)
\end{equation}
for all $n>20$.
...
$o=1n_0+0-2$, we have for $j\ge16$
\[
3!\Bigl(a(n_0+j)-\sum_i c_i\,a(n_0+j-i)\Bigr)
=\mathbf{v}^{\!\top}G^{\,j-16}w,\qquad
w=h_{16}-\sum_i c_i h_{16-i} .
\]
...
the survivors by the pattern of the new pair. The vector $w$ was formed by $16$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A275500.
