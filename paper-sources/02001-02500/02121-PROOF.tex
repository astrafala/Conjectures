...
\title{The empirical recurrence for OEIS A264339, proved by transfer matrix}
...
\begin{abstract}
OEIS A264339 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=7$ rows in which
...
OEIS A264339 is ``Number of (n+1)X(6+1) arrays of permutations of 0..n*7+6 with each element having index change +-(.,.) 0,0 0,1 or 1,2.''. It has offset $1$ and begins
\[
2521, 223356, 20386617, 1855980772, 168990466353, 15386771913704, 1400983500645217, 127561175981852920,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 87*a(n-1) +374*a(n-2) -470*a(n-3) +207*a(n-4) +3*a(n-5)
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 11 2015 19:41:56, revision 4) this is still
...
Second, the transfer model reproduces all $11$ terms this entry publishes, exactly, in
integer arithmetic.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264339.
