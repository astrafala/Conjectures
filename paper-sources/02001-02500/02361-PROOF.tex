...
\title{The empirical recurrence for OEIS A200455, proved from an exact model}
...
\begin{abstract}
OEIS A200455 carries an empirical recurrence of order $4$. It is true, and it is
...
OEIS A200455 is ``Number of -n..n arrays x(0..2) of 3 elements with zero sum and nonzero first and second differences.''. It has offset $1$ and begins
\[
4, 10, 26, 44, 72, 102, 142, 184,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) -2*a(n-3) +a(n-4)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 08:38:02, revision 8)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A200455.
