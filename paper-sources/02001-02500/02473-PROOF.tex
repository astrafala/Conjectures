...
\title{A further conjecture on OEIS A207701,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A207701 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $25, 625, 3969, 15129, 43681, 105625, 225625, 439569,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = (-3 + n + 15*n\^{}2 + 2*n\^{}3)\^{}2 / 9.\end{quote}
