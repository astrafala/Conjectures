...
\title{A further conjecture on OEIS A184542,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A184542 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $147, 340, 631, 1048, 1627, 2413, 3461, 4837,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (1/120)*n\^{}5 + (5/24)*n\^{}4 + (49/24)*n\^{}3 + (739/24)*n\^{}2 + (1659/20)*n + 31.\end{quote}
