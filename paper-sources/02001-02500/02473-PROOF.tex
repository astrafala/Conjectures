...
\title{The empirical recurrence for OEIS A232197, proved by transfer matrix}
...
\begin{abstract}
OEIS A232197 counts arrays of width $2$ over $\{0,1,2\}$ in which every cell has a neighbour at least as large and one at most as large. The entry carries an
...
OEIS A232197 is ``Number of (n+1)X(1+1) 0..2 arrays with every element both >= and <= some horizontal, vertical or antidiagonal neighbor.''. It has offset $1$ and begins
\[
15, 109, 685, 4483, 29469, 193531, 1270657, 8343063,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 06:56:41, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-1) - 5\,a(n-2) + 16\,a(n-3) - 12\,a(n-4) - a(n-5) - 7\,a(n-6) - 9\,a(n-7) + 2\,a(n-8) - 2\,a(n-9) + 3\,a(n-10) + 2\,a(n-11) - a(n-12)
\]
for every $n>12$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232197.
