...
\title{The empirical recurrence for OEIS A200166, proved from an exact model}
...
\begin{abstract}
OEIS A200166 carries an empirical recurrence of order $5$. It is true, and it is
...
OEIS A200166 is ``Number of -n..n arrays x(0..2) of 3 elements with nonzero sum and with zero through 2 differences all nonzero.''. It has offset $1$ and begins
\[
2, 34, 128, 348, 726, 1326, 2180, 3352,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) -2*a(n-2) -2*a(n-3) +3*a(n-4) -a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 19 2021 09:58:21, revision 17)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A200166.
