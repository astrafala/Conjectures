...
\title{The empirical recurrence for OEIS A229576, proved by counting defective colourings}
...
\begin{abstract}
OEIS A229576 counts the colourings of an array with $K=4$ colours that are proper except at
...
numbers. What is left is a walk count on $S=9780$ vertices, and the empirical recurrence of
...
OEIS A229576 is ``Number of defective 4-colorings of an n X 6 0..3 array connected horizontally, vertically, diagonally and antidiagonally with exactly one mistake, and colors introduced in row-major 0..3 order.''. It has offset $1$ and begins
\[
70, 544, 757, 1064, 1576, 2440, 4048, 7224,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 6*a(n-1) - 13*a(n-2) + 12*a(n-3) - 4*a(n-4) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 19 2018 08:51:15, revision 7) the statement is
...
Assembling the $4$ chains block-diagonally into $N$ of size $S=9780$ with the weights of
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A229576.
