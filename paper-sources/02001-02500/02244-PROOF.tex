...
\title{The empirical recurrence for OEIS A268890, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A268890 counts arrays over $\{0,\dots,1\}$ subject to a condition on the array as a
...
and the empirical recurrence of order $26$ contributed by R.~H.~Hardin then follows from
...
OEIS A268890 is ``Number of 5Xn binary arrays with some element plus some horizontally or antidiagonally adjacent neighbor totalling two exactly once.''. It has offset $1$ and begins
\[
0, 235, 2418, 31956, 317966, 3283890, 31427480, 299524050,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 15 2016 11:37:09, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 97\,a(n-2) + 116\,a(n-3) - 2923\,a(n-4) - 10986\,a(n-5) + 4951\,a(n-6) + 72992\,a(n-7) + 36740\,a(n-8) - 223968\,a(n-9) - 159382\,a(n-10) + 423052\,a(n-11) + 256370\,a(n-12) - 539504\,a(n-13) - 176570\,a(n-14) + 450908\,a(n-15) + 6166\,a(n-16) - 217920\,a(n-17) + 57416\,a(n-18) + 45120\,a(n-19) - 25021\,a(n-20) + 562\,a(n-21) + 2089\,a(n-22) - 388\,a(n-23) - 31\,a(n-24) + 14\,a(n-25) - a(n-26)
\end{equation}
for all $n>26$.
...
Let $q(t)=t^{26}-\sum_i c_i\,t^{26-i}$ be the characteristic polynomial of
...
$o=1n_0+0-1$,
\[
a(n_0+j)-\sum_i c_i\,a(n_0+j-i)\;=\;\,\mathbf{v}^{\!\top}G^{\,j-26}w,
\qquad w=h_{26}-\sum_i c_i h_{26-i},
\]
for $j\ge26$. Hence \eqref{eq:conj} holds from that point on if and only if
...
formed by $26$ applications of $G$ in exact integer arithmetic and
$\mathbf{v}^{\!\top}G^{m}w$ evaluated for $m=0,1,\dots$, again exactly. Every one of
those integers vanishes from the index corresponding to $n=26+1$ onwards, and the run
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268890.
