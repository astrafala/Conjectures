...
\title{The empirical recurrence for OEIS A264366, proved by transfer matrix}
...
\begin{abstract}
OEIS A264366 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=3$ columns in which
...
OEIS A264366 is ``Number of (2+1) X (n+1) arrays of permutations of 0..n*3+2 with each element having directed index change 0,0 0,2 1,0 or -1,-2.''. It has offset $1$ and begins
\[
1, 6, 36, 120, 400, 1440, 5184, 18432,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) + 6*a(n-3) + 4*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 07 2019 12:39:56, revision 8) this is still
...
\[
(i-h_i,\,j-h_j)\;\in\;\{(-2,-1),\ (0,0),\ (0,1),\ (2,0)\},
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264366.
