...
\title{The empirical recurrence for OEIS A264359, proved by transfer matrix}
...
\begin{abstract}
OEIS A264359 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=4$ rows in which
...
OEIS A264359 is ``Number of (n+1)X(3+1) arrays of permutations of 0..n*4+3 with each element having directed index change 0,0 0,2 1,0 or -1,-2.''. It has offset $1$ and begins
\[
9, 36, 169, 784, 3600, 16641, 76729, 354025,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) +7*a(n-2) +3*a(n-3) -5*a(n-4) +3*a(n-5) -a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 09 2015 06:30:21, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264359.
