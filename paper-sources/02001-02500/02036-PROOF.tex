...
\title{The empirical recurrence for OEIS A231026, proved by transfer matrix}
...
\begin{abstract}
OEIS A231026 counts arrays of width $3$ over $\{0,1,2\}$ in which every cell must see, among its
...
the count is a walk count on $S=712$ states.
\end{abstract}
...
OEIS A231026 is ``Number of nX3 0..2 arrays x(i,j) with each element horizontally, vertically or antidiagonally next to at least one element with value (x(i,j)+1) mod 3 and at least one element with value (x(i,j)-1) mod 3, and upper left element zero.''. It has offset $1$ and begins
\[
0, 12, 60, 1074, 12400, 162288, 2049324, 26149710,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 06:11:25, revision 6) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=712.
\]
...
\begin{theorem}
\[
a(n)\;=\;12\,a(n-1) + 24\,a(n-2) - 198\,a(n-3) + 143\,a(n-4) - 39\,a(n-5) - 1072\,a(n-6) + 15046\,a(n-7) - 50039\,a(n-8) - 76233\,a(n-9) + 310401\,a(n-10) - 79074\,a(n-11) - 282050\,a(n-12) + 99013\,a(n-13) + 127303\,a(n-14) - 86657\,a(n-15) + 1974\,a(n-16) + 55618\,a(n-17) - 23205\,a(n-18) - 15363\,a(n-19) + 9601\,a(n-20) - 2560\,a(n-21) - 2599\,a(n-22) + 1807\,a(n-23) + 98\,a(n-24) - 123\,a(n-25) + 124\,a(n-26) - a(n-27) - 14\,a(n-28)
\]
for every $n>28$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231026.
