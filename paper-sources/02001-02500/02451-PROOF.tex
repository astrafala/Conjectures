...
\title{A further conjecture on OEIS A164760,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A164760 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $8, 104, 670, 3096, 11786, 39564, 121678, 350992,\dots$, with offset $2$. The sequence satisfies
\[
...
\[
  q(x)=x^{7} - 10 x^{6} + 42 x^{5} - 96 x^{4} + 129 x^{3} - 102 x^{2} + 44 x - 8 .
\]
...
\begin{quote}\raggedright a(n) = (-4236 + 4281*2\^{}n - 4*(421+339*2\^{}n)*n + 6*(-32+25*2\^{}n)*n\^{}2 - 32*n\^{}3) / 6.\end{quote}
...
\[
  p(x)=x^{7} - 10 x^{6} + 42 x^{5} - 96 x^{4} + 129 x^{3} - 102 x^{2} + 44 x - 8 ,
\]
