...
\title{The empirical recurrence for OEIS A281760, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A281760 imposes three things at once: a condition on each cell that reaches one row up and
...
OEIS A281760 is ``Number of n X 3 0..1 arrays with no element unequal to a strict majority of its horizontal, diagonal and antidiagonal neighbors, with the exception of exactly one element, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
2, 14, 47, 90, 201, 374, 672, 1172,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 4*a(n-1) - 4*a(n-2) - 2*a(n-3) + 4*a(n-4) - a(n-6) for n>11.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 20 2019 06:09:22, revision 9) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A281760.
