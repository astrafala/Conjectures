...
\title{The empirical recurrence for OEIS A263960, proved by transfer matrix}
...
\begin{abstract}
OEIS A263960 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=3$ rows in which
...
OEIS A263960 is ``Number of (n+1) X (2+1) arrays of permutations of 0..n*3+2 with each element having index change (+-,+-) 0,0 1,1 or 1,2.''. It has offset $1$ and begins
\[
20, 141, 1685, 16856, 183229, 1926873, 20563180, 218090365,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 8*a(n-1) + 40*a(n-2) - 119*a(n-3) - 124*a(n-4) + 240*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 03 2019 10:38:23, revision 13) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A263960.
