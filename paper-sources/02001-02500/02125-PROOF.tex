...
\title{The empirical recurrence for OEIS A204356, proved by transfer matrix}
...
\begin{abstract}
OEIS A204356 counts $(n+2)\times5$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A204356 is ``Number of (n+2)X5 0..1 arrays with every 3X3 subblock having three equal elements in a row horizontally, vertically, diagonally or antidiagonally exactly one way, and new values 0..1 introduced in row major order.''. It has offset $1$ and begins
\[
764, 2063, 5516, 13721, 35690, 92286, 236382, 607036,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 11:09:34, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + a(n-2) + 2\,a(n-3) + 17\,a(n-4) - a(n-5) - a(n-6) - 5\,a(n-7) - 58\,a(n-8) + 28\,a(n-9) - 9\,a(n-10) - 11\,a(n-11) + 84\,a(n-12) - 82\,a(n-13) + 49\,a(n-14) + a(n-15) - 50\,a(n-16) + 66\,a(n-17) - 52\,a(n-18) + 33\,a(n-19) - 12\,a(n-20) + 4\,a(n-21) - 4\,a(n-23)
\]
for every $n>29$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204356.
