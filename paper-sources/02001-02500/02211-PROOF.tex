...
\title{The empirical recurrence for OEIS A268778, proved by transfer matrix}
...
\begin{abstract}
OEIS A268778 counts arrays of width $5$ over $\{0,1\}$ in which the number of adjacent PAIRS of
...
OEIS A268778 is ``Number of nX5 binary arrays with some element plus some horizontally, vertically, diagonally or antidiagonally adjacent neighbor totalling two no more than once.''. It has offset $1$ and begins
\[
23, 148, 1031, 6383, 38483, 224960, 1288693, 7271509,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 13 2016 09:46:39, revision 4) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268778.
