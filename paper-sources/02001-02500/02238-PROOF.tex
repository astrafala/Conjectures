...
\title{The empirical recurrence for OEIS A221543, proved from an exact model}
...
\begin{abstract}
OEIS A221543 carries an empirical recurrence of order $5$. It is true, and it is
...
OEIS A221543 is ``Number of 0..n arrays of length 5 with each element differing from at least one neighbor by something other than 1, starting with 0.''. It has offset $1$ and begins
\[
3, 22, 103, 303, 716, 1455, 2658, 4487,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 1*n\^{}4 + 1*n\^{}3 - 3*n\^{}2 + 10*n - 9 for n>3. a(n) = 5*a(n-1) - 10*a(n-2) + 10*a(n-3) - 5*a(n-4) + a(n-5) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 08 2018 07:55:51, revision 8)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221543.
