...
\title{The empirical recurrence for OEIS A221689, proved by transfer matrix}
...
\begin{abstract}
OEIS A221689 counts the distinct OCCUPANCY arrays obtained when every cell of an $n\times3$ grid
...
one, on $S=260$ states, after which the conjectured recurrence is settled by a finite exact
computation.
\end{abstract}
...
OEIS A221689 is ``Number of n X 3 arrays of occupancy after each element stays put or moves to some horizontal or antidiagonal neighbor, without consecutive moves in the same direction.''. It has offset $1$ and begins
\[
6, 152, 3112, 63676, 1302720, 26650988, 545221260, 11154026300,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 24*a(n-1) - 69*a(n-2) - 71*a(n-3) + 2*a(n-4) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2018 17:33:28, revision 9) this is still
...
$S=260$ reachable sets. In particular $a$ is $C$-finite.
...
\begin{theorem}
\[
a(n)\;=\;24\,a(n-1) - 69\,a(n-2) - 71\,a(n-3) + 2\,a(n-4)
\]
for every $n>5$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221689.
