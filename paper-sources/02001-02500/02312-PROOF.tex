...
\title{The empirical recurrence for OEIS A275134, proved by transfer matrix}
...
\begin{abstract}
OEIS A275134 counts arrays in which no entry may equal the entries at a short list of fixed offsets
...
$2$ consecutive columns, $S=703$ states in all.
\end{abstract}
...
OEIS A275134 is ``Number of 5Xn 0..2 arrays with no element equal to any value at offset (-2,-2) (-1,0) or (-1,1) and new values introduced in order 0..2.''. It has offset $1$ and begins
\[
8, 108, 373, 2178, 12423, 71576, 412306, 2381629,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 17 2016 11:04:05, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 16\,a(n-2) + 49\,a(n-3) + 109\,a(n-4) + 31\,a(n-5) - 508\,a(n-6) + 75\,a(n-7) + 324\,a(n-8) - 972\,a(n-9) + 260\,a(n-10)
\]
for every $n>14$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A275134.
