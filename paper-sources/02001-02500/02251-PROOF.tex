...
\title{The empirical recurrence for OEIS A199705, proved from an exact model}
...
\begin{abstract}
OEIS A199705 carries an empirical recurrence of order $4$. It is true, and it is
...
OEIS A199705 is ``Number of -n..n arrays x(0..2) of 3 elements with zero sum and no two neighbors equal.''. It has offset $1$ and begins
\[
6, 14, 32, 52, 82, 114, 156, 200,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) - 2*a(n-3) + a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (May 16 2018 06:43:15, revision 17)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A199705.
