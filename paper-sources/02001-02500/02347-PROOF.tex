...
\title{The empirical recurrence for OEIS A231051, proved by transfer matrix}
...
\begin{abstract}
OEIS A231051 counts arrays of width $3$ over $\{0,1,2,3\}$ in which every cell must see, among its
...
the count is a walk count on $S=253$ states.
\end{abstract}
...
OEIS A231051 is ``Number of 3Xn 0..3 arrays x(i,j) with each element horizontally, diagonally or antidiagonally next to at least one element with value (x(i,j)+1) mod 4 and at least one element with value (x(i,j)-1) mod 4, no adjacent elements equal, and upper left element zero.''. It has offset $1$ and begins
\[
0, 2, 50, 128, 644, 5100, 33696, 211032,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 6*a(n-1) +18*a(n-3) +17*a(n-4) -98*a(n-5) -32*a(n-6) +6*a(n-7) -16*a(n-8) +36*a(n-9) -8*a(n-10) for n>11
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 06:13:20, revision 6) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=253.
\]
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) + 18\,a(n-3) + 17\,a(n-4) - 98\,a(n-5) - 32\,a(n-6) + 6\,a(n-7) - 16\,a(n-8) + 36\,a(n-9) - 8\,a(n-10)
\]
for every $n>11$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231051.
