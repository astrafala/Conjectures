...
\title{A further conjecture on OEIS A184543,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A184543 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $220, 537, 1048, 1837, 3024, 4774, 7307, 10909,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (1/720)*n\^{}6 + (11/240)*n\^{}5 + (89/144)*n\^{}4 + (209/48)*n\^{}3 + (18317/360)*n\^{}2 + (1231/10)*n + 41.\end{quote}
