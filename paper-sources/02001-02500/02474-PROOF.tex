...
\title{A further conjecture on OEIS A063166,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A063166 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $7, 34, 62, 90, 118, 146, 174, 202,\dots$, with offset $1$. The sequence satisfies
\[
  a(n)=2\,a(n-1) - 1\,a(n-2) ,
\]
...
\begin{quote}\raggedright a(n) = 28*n-22 for n>1.\end{quote}
