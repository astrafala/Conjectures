...
\title{A further conjecture on OEIS A207702,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A207702 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $40, 1600, 13230, 61254, 206910, 571350, 1369900, 2956980,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = (n*(162 - 327*n - 881*n\^{}2 + 1296*n\^{}3 + 997*n\^{}4 + 183*n\^{}5 + 10*n\^{}6)) / 36.\end{quote}
