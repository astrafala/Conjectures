...
\title{The empirical recurrence for OEIS A209460, proved by counting patterns}
...
\begin{abstract}
OEIS A209460 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
state space down from $784$ to $S=30$. The entry's empirical recurrence of order
...
OEIS A209460 is ``Number of nX3 0..6 arrays with every 2X2 subblock containing exactly one value repeat, and new values 0..6 introduced in row major order.''. It has offset $1$ and begins
\[
5, 57, 2027, 107472, 7487423, 613535578, 54657856108, 5063931781244,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 15:15:02, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;172\,a(n-1) - 8737\,a(n-2) + 125848\,a(n-3) + 1640003\,a(n-4) - 58941308\,a(n-5) + 441046249\,a(n-6) + 799433456\,a(n-7) - 23572369886\,a(n-8) + 84702514904\,a(n-9) + 67645214404\,a(n-10) - 904101250144\,a(n-11) + 1363565491464\,a(n-12) + 425476260576\,a(n-13) - 2084864162400\,a(n-14) + 1100743344000\,a(n-15) - 104976000000\,a(n-16)
\end{equation}
for all $n>17$.
...
Assembling the $7$ lumped chains into one block-diagonal matrix $N$ of size $S=30$ and
...
\end{equation}
The unlumped alphabet had $784$ rows in all; the lumped chain has $S=30$ states.
...
\[
7!\Bigl(a(n)-\sum_i c_i\,a(n-i)\Bigr)\;=\;\mathbf{v}^{\!\top}N^{\,m-16}q(N)\mathbf{1} .
\]
...
corresponding to $n=17+1$ onwards, and the run continued until $w$ was the zero vector,
...
\eqref{eq:walk}, divided by $7!$, was evaluated at every one of the $14$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209460.
