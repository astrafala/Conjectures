...
\title{The empirical recurrence for OEIS A264579, proved by transfer matrix}
...
\begin{abstract}
OEIS A264579 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=5$ rows in which
...
OEIS A264579 is ``Number of (n+1) X (4+1) arrays of permutations of 0..n*5+4 with each element having directed index change 1,0 0,-1 1,2 or -1,1.''. It has offset $1$ and begins
\[
1, 10, 28, 104, 505, 2144, 8185, 33056,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) +36*a(n-3) +9*a(n-4) -243*a(n-6) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 08 2019 19:00:27, revision 8) this is still
...
until the working vector was identically zero, settling every larger $j$ at once. The bound is exact: at $n=7$ the recurrence fails on the entry's own published terms, so no larger range holds.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264579.
