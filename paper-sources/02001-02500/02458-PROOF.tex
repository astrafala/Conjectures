...
\title{A further conjecture on OEIS A183626,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A183626 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $115, 189, 355, 741, 1675, 4029, 10195, 26901,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = 50 + 7*2\^{}(2+n) + 3\^{}(1+n).\end{quote}
