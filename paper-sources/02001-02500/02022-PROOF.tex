...
\title{The empirical recurrence for OEIS A205316, proved by transfer matrix}
...
\begin{abstract}
OEIS A205316 counts, up to renaming the letters, the arrays of width $7$ over at most $2$
letters in which all the $2\times2$ subblocks of one array have the SAME number of equal edges, an equal edge being one of the four perimeter edges whose two cells agree; the common value is not named, so the count splits by it. It carries an empirical recurrence of order $14$ contributed by
...
OEIS A205316 is ``Number of (n+1)X7 0..1 arrays with every 2X2 subblock having the same number of equal edges, and new values 0..1 introduced in row major order.''. It has offset $1$ and begins
\[
1460, 35500, 882182, 22091516, 554916092, 13956665238, 351210375464, 8839958693704,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 12:00:22, revision 9) this is still
...
$w_i$ cleared of denominators and $S=133$ states in all. The walk index $j$ and the entry's own
...
\begin{theorem}
\[
a(n)\;=\;56\,a(n-1) - 1164\,a(n-2) + 12439\,a(n-3) - 78536\,a(n-4) + 314610\,a(n-5) - 829844\,a(n-6) + 1464316\,a(n-7) - 1728640\,a(n-8) + 1345964\,a(n-9) - 671600\,a(n-10) + 205552\,a(n-11) - 36416\,a(n-12) + 3392\,a(n-13) - 128\,a(n-14)
\]
for every $n>13$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A205316.
