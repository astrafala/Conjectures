...
\title{The empirical recurrence for OEIS A229600, proved by counting defective colourings}
...
\begin{abstract}
OEIS A229600 counts the colourings of an array with $K=3$ colours that are proper except at
...
numbers. What is left is a walk count on $S=42$ vertices, and the empirical recurrence of
...
OEIS A229600 is ``Number of defective 3-colorings of an n X 2 0..2 array connected horizontally and vertically with exactly two mistakes, and colors introduced in row-major 0..2 order.''. It has offset $1$ and begins
\[
0, 6, 39, 202, 925, 3924, 15795, 61182,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 9*a(n-1) - 27*a(n-2) + 27*a(n-3) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 17 2018 05:45:38, revision 10) the statement is
...
The arrays have $2$ columns and $L=n$ rows, entries in $\{0,\dots,3-1\}$.
...
Fix $i$ and take as vertices the pairs $(r,c)$ with $r\in\{0,\dots,i-1\}^{2}$ a row
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A229600.
