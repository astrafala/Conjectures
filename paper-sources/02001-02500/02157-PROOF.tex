...
\title{The empirical recurrence for OEIS A269411, proved from an exact model}
...
\begin{abstract}
OEIS A269411 carries an empirical recurrence of order $6$. It is true, and it is
...
OEIS A269411 is ``Number of length-5 0..n arrays with no repeated value greater than or equal to the previous repeated value.''. It has offset $1$ and begins
\[
12, 159, 804, 2670, 6960, 15477, 30744, 56124,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = n\^{}5 + 5*n\^{}4 + (11/2)*n\^{}3 + n\^{}2 - (1/2)*n. a(n) = 6*a(n-1) - 15*a(n-2) + 20*a(n-3) - 15*a(n-4) + 6*a(n-5) - a(n-6) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 21 2019 10:06:44, revision 7)
...
$a$ and $S=6$. Nothing is fitted and no threshold is guessed: the $N_m$ are counted, not
estimated.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269411.
