...
\title{The empirical recurrence for OEIS A212837, proved from an exact model}
...
\begin{abstract}
OEIS A212837 carries an empirical recurrence of order $5$. It is true, and it is
...
OEIS A212837 is ``Number of 0..n arrays of length 4 with 0 never adjacent to n.''. It has offset $1$ and begins
\[
2, 41, 178, 497, 1106, 2137, 3746, 6113,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = n\^{}4 + 4*n\^{}3 - 4*n + 1. a(n) = 5*a(n-1) - 10*a(n-2) + 10*a(n-3) - 5*a(n-4) + a(n-5) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 21 2018 10:07:16, revision 10)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A212837.
