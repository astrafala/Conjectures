...
\title{A further conjecture on OEIS A165378,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A165378 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $33, 94, 158, 243, 346, 467, 606, 763,\dots$, with offset $2$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = 9*n\^{}2 + 4*n - 2 for n>3.\end{quote}
