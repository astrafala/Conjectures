...
\title{The empirical recurrence for OEIS A275180, proved by counting patterns}
...
\begin{abstract}
OEIS A275180 counts arrays in which no entry may repeat a value found at any of three stated
...
OEIS A275180 is ``Number of n X 5 0..2 arrays with no element equal to any value at offset (-2,-1) (-1,0) or (-1,1) and new values introduced in order 0..2.''. It has offset $1$ and begins
\[
41, 256, 317, 482, 1465, 4603, 14643, 46799,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 10 2021 12:18:06, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;16\,a(n-1) - 120\,a(n-2) + 561\,a(n-3) - 1820\,a(n-4) + 4313\,a(n-5) - 7688\,a(n-6) + 10549\,a(n-7) - 11473\,a(n-8) + 10333\,a(n-9) - 8076\,a(n-10) + 5538\,a(n-11) - 3198\,a(n-12) + 1466\,a(n-13) - 508\,a(n-14) + 120\,a(n-15) - 12\,a(n-16)
\end{equation}
for all $n>21$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A275180.
