...
\title{The empirical recurrence for OEIS A229455, proved by counting defective colourings}
...
\begin{abstract}
OEIS A229455 counts the colourings of an array with $K=3$ colours that are proper except at
...
OEIS A229455 is ``Number of defective 3-colorings of an n X 4 0..2 array connected horizontally and vertically with exactly one mistake and colors introduced in row-major 0..2 order.''. It has offset $1$ and begins
\[
6, 84, 863, 7940, 68790, 573342, 4651079, 36985536,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 18*a(n-1) - 111*a(n-2) + 282*a(n-3) - 333*a(n-4) + 180*a(n-5) - 36*a(n-6) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 17 2018 08:32:26, revision 7) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A229455.
