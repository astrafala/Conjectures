...
\title{The empirical recurrence for OEIS A224036, proved by transfer matrix}
...
\begin{abstract}
OEIS A224036 counts arrays over $\{0,\dots,1\}$ whose rows, columns, diagonals or
...
is a walk count on $S=448$ vertices and the recurrence follows from a finite exact
computation.
\end{abstract}
...
OEIS A224036 is ``Number of nX6 0..1 arrays with antidiagonals unimodal and rows and diagonals nondecreasing.''. It has offset $1$ and begins
\[
7, 34, 119, 363, 1064, 3107, 9125, 26928,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 23:12:17, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;7\,a(n-1) - 15\,a(n-2) + 6\,a(n-3) + 11\,a(n-4) - 4\,a(n-5) - 7\,a(n-6) + 6\,a(n-7) - 6\,a(n-8) + 8\,a(n-9) - 8\,a(n-10) + 16\,a(n-11)
\end{equation}
for all $n>13$.
...
bit vector), $|\mathcal V|=S=448$; let $(r,f)\to(s,f')$ be an edge when placing $s$ after $r$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224036.
