...
\title{The empirical recurrence for OEIS A225021, proved by transfer matrix}
...
\begin{abstract}
OEIS A225021 counts the $(n+1)\times3$ matrices over $\{0,\dots,2\}$ all of whose
...
makes $a(n)$ a walk count on $S=85$ vertices, hence $C$-finite, and whether the conjectured
...
OEIS A225021 is ``Number of (n+1)X3 0..2 matrices with each 2X2 permanent equal.''. It has offset $1$ and begins
\[
253, 1935, 12641, 113261, 979821, 9045373, 82894903, 768456167,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 23:38:18, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{The count is a walk count}

Call a $2\times2$ matrix over $\{0,\dots,2\}$ a \emph{window} when it is of equal permanent, and
call a $2\times3$ matrix a \emph{band} when every one of its $2$ contiguous
$2\times2$ subblocks is a window. What the entry counts is the matrices of $3$ columns
whose every $2$ consecutive rows form a band.

Take as states the $1\times3$ strips that occur as the top $1$ rows of a band,
...
\]
with $M$ the adjacency matrix on $S=85$ states. In particular $a$ is $C$-finite. The
alignment was checked against the entry's published terms rather than assumed.

There are $(2 + 1)^{3}$ strips of $1$ rows and $3$ columns, far too
many to test one by one, and they are not tested one by one. Two consecutive windows of a band
overlap in $2\times1$ entries, so a band is exactly a walk of $2$ windows in
...
\begin{theorem}
\[
a(n)\;=\;18\,a(n-1) - 50\,a(n-2) - 745\,a(n-3) + 4314\,a(n-4) + 9186\,a(n-5) - 105283\,a(n-6) + 25054\,a(n-7) + 1280251\,a(n-8) - 1742965\,a(n-9) - 8687898\,a(n-10) + 19526759\,a(n-11) + 32128538\,a(n-12) - 112791204\,a(n-13) - 46192053\,a(n-14) + 383508114\,a(n-15) - 96539514\,a(n-16) - 782622789\,a(n-17) + 556582824\,a(n-18) + 907171190\,a(n-19) - 1065928104\,a(n-20) - 465301022\,a(n-21) + 1019495948\,a(n-22) - 75774692\,a(n-23) - 460095348\,a(n-24) + 170353464\,a(n-25) + 64111672\,a(n-26) - 41996720\,a(n-27) + 2265472\,a(n-28) + 1450752\,a(n-29) - 135168\,a(n-30)
\]
for every $n>30$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A225021.
