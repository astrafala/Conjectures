...
\title{Arrays counted up to renaming: the empirical recurrence for OEIS A204860}
...
\begin{abstract}
OEIS A204860 carries an empirical recurrence of order $19$ contributed by R.~H.~Hardin. It is
...
both in the state the arrays are exactly the walks in a digraph on $S=23$ vertices, so $a(n)$
...
OEIS A204860 is ``Number of (n+2) X 3 0..1 arrays with every 3 X 3 subblock having three equal elements in a row horizontally, vertically, diagonally or antidiagonally exactly two different ways, and new values 0..1 introduced in row major order.''. It has offset $1$ and begins
\[
102, 382, 1437, 5352, 20113, 75595, 283877, 1066520,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 22 2025 18:23:14, revision 13) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 7\,a(n-2) - 8\,a(n-4) + 22\,a(n-6) + 41\,a(n-7) + 22\,a(n-8) + 13\,a(n-9) - 270\,a(n-10) + 64\,a(n-11) + 392\,a(n-12) - 424\,a(n-13) + 24\,a(n-14) - 228\,a(n-15) + 304\,a(n-16) + 200\,a(n-17) - 192\,a(n-18) + 32\,a(n-19)
\]
for every $n>19$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204860.
