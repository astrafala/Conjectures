...
\title{The empirical recurrence for OEIS A269280, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A269280 counts arrays over $\{0,\dots,3\}$ subject to a condition on the array as a
...
OEIS A269280 is ``Number of 5Xn 0..3 arrays with some element plus some horizontally or antidiagonally adjacent neighbor totalling three exactly once.''. It has offset $1$ and begins
\[
0, 236196, 36673560, 4684312584, 542973139128, 59587625651904, 6310088238337128, 651615466055490216,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 21 2016 09:00:45, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;262\,a(n-1) - 25913\,a(n-2) + 1271424\,a(n-3) - 36373480\,a(n-4) + 662028380\,a(n-5) - 8018113210\,a(n-6) + 65608158980\,a(n-7) - 356568260410\,a(n-8) + 1185405035940\,a(n-9) - 1609856308508\,a(n-10) - 4162483461884\,a(n-11) + 23709461283851\,a(n-12) - 40474763971218\,a(n-13) + 272846513475\,a(n-14) + 106799477038956\,a(n-15) - 171480164894532\,a(n-16) + 115612142099328\,a(n-17) - 29562621871104\,a(n-18)
\end{equation}
for all $n>23$.
...
every one of the $11$ published indices, with no shift fitted: the number of columns is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269280.
