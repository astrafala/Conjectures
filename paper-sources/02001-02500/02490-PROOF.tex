...
\title{A further conjecture on OEIS A187287,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A187287 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $0, 8, 36, 80, 140, 216, 308, 416,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = 8*n\^{}2 - 12*n for n>1.\end{quote}
