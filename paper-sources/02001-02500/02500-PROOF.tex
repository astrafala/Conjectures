...
\title{A further conjecture on OEIS A233077,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A233077 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $5, 95, 1985, 41675, 875165, 18378455, 385947545, 8104898435,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = (7 + 3\^{}(1+n)*7\^{}n) / 14.\end{quote}
