...
\title{The empirical recurrence for OEIS A264107, proved by transfer matrix}
...
\begin{abstract}
OEIS A264107 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=5$ rows in which
...
OEIS A264107 is ``Number of (n+1) X (4+1) arrays of permutations of 0..n*5+4 with each element having index change +-(.,.) 0,0 0,2 or 1,1.''. It has offset $1$ and begins
\[
144, 2745, 54756, 1086300, 21511044, 426058380, 8439361956, 167165327340,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 19*a(n-1) + 304*a(n-3) + 256*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 04 2019 12:16:48, revision 10) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264107.
