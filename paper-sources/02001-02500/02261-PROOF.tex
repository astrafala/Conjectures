...
\title{The empirical recurrence for OEIS A197058, proved by transfer matrix}
...
\begin{abstract}
OEIS A197058 counts arrays of width $5$ in which every entry is equal to the NUMBER of its own
...
OEIS A197058 is ``Number of n X 5 0..4 arrays with each element equal to the number its horizontal and vertical neighbors equal to 2.''. It has offset $1$ and begins
\[
1, 5, 14, 28, 48, 90, 200, 447,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 11 2018 09:54:38, revision 9) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=34368.
\]
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) - a(n-2) + a(n-3) + 2\,a(n-4) + 3\,a(n-5) - a(n-6) - 2\,a(n-7) - 2\,a(n-8) + 2\,a(n-9) - 2\,a(n-10) - a(n-11) - 3\,a(n-12) - a(n-13)
\]
for every $n>12$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A197058.
