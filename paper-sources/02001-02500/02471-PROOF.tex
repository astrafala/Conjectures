...
\title{A further conjecture on OEIS A184540,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A184540 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $45, 89, 147, 220, 309, 415, 539, 682,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (84 + 149*n + 36*n\^{}2 + n\^{}3) / 6. Corrected by \_Colin Barker\_, Apr 12 2018\end{quote}
