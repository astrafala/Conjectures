...
\title{A further conjecture on OEIS A205163,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A205163 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $13, 159, 2277, 33831, 506493, 7594479, 113908437, 1708600311,\dots$, with offset $1$. The sequence satisfies
\[
  a(n)=18\,a(n-1) - 45\,a(n-2) ,
\]
...
\begin{quote}\raggedright a(n) = 3\^{}(n-1)*(2*5\^{}n+3).\end{quote}
