...
\title{The empirical recurrence for OEIS A210137, proved by transfer matrix}
...
\begin{abstract}
OEIS A210137 counts arrays of width $3$ whose every $2\times2$ subblock holds a
...
OEIS A210137 is ``Number of (n+1)X3 0..3 arrays containing all values 0..3 with every 2X2 subblock having one, two or four distinct values, and new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
10, 221, 4349, 78063, 1321270, 21511540, 341220491, 5317431003,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 15:45:37, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;40\,a(n-1) - 590\,a(n-2) + 3962\,a(n-3) - 11899\,a(n-4) + 12350\,a(n-5) + 3806\,a(n-6) - 12980\,a(n-7) + 4512\,a(n-8) + 1056\,a(n-9) - 256\,a(n-10)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A210137.
