...
\title{A further conjecture on OEIS A187176,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A187176 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $0, 0, 0, 0, 0, 88, 496, 1440,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = 284*n\^{}2 - 3100*n + 7944 for n>9.\end{quote}
...
indices, and $a$ and $f$ were checked to agree at $n=13,\dots,15$,
