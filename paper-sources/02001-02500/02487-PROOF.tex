...
\title{A further conjecture on OEIS A228255,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A228255 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $25, 319, 2511, 13933, 58911, 242461, 989527, 4017157,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = 4\^{}(3+n) - 3\^{}(3+n) for n>5.\end{quote}
...
indices, and $a$ and $f$ were checked to agree at $n=8,\dots,9$,
