...
\title{A further conjecture on OEIS A184130,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A184130 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $6, 29, 112, 356, 972, 2359, 5217, 10704,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = (40320 + 79344*n + 64140*n\^{}2 + 37884*n\^{}3 + 16009*n\^{}4 + 3696*n\^{}5 + 490*n\^{}6 + 36*n\^{}7 + n\^{}8) / 40320.\end{quote}
