...
\title{The empirical recurrence for OEIS A262314, proved by transfer matrix}
...
\begin{abstract}
OEIS A262314 counts arrays of width $4$ over $\{0,1\}$ whose rows, read as base-$2$
...
OEIS A262314 is ``Number of (n+2)X(2+2) 0..1 arrays with each row and column divisible by 7, read as a binary number with top and left being the most significant bits.''. It has offset $1$ and begins
\[
3, 5, 9, 27, 61, 145, 435, 1253,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 17 2015 22:20:03, revision 5) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A262314.
