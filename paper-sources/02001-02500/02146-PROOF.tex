...
\title{The empirical recurrence for OEIS A276295, proved by counting patterns}
...
\begin{abstract}
OEIS A276295 counts arrays in which no entry may repeat a value found at any of three stated
...
cutting $6818$ pairs to $S=1223$ states. The entry's empirical recurrence of order $11$,
...
OEIS A276295 is ``Number of nX4 0..2 arrays with no element equal to any value at offset (-2,-1) (-1,1) or (0,-1) and new values introduced in order 0..2.''. It has offset $1$ and begins
\[
4, 36, 173, 1017, 5965, 34865, 203933, 1192701,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 28 2016 08:23:48, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;9\,a(n-1) - 20\,a(n-2) + 17\,a(n-3) - 65\,a(n-4) + 116\,a(n-5) - 40\,a(n-6) + 124\,a(n-7) - 172\,a(n-8) + 16\,a(n-9) - 48\,a(n-10) + 64\,a(n-11)
\end{equation}
for all $n>13$.
...
$o=1n_0+0-2$, we have for $j\ge11$
\[
3!\Bigl(a(n_0+j)-\sum_i c_i\,a(n_0+j-i)\Bigr)
=\mathbf{v}^{\!\top}G^{\,j-11}w,\qquad
w=h_{11}-\sum_i c_i h_{11-i} .
\]
...
the survivors by the pattern of the new pair. The vector $w$ was formed by $11$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A276295.
