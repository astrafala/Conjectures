...
\title{The empirical recurrence for OEIS A249710, proved from an exact model}
...
\begin{abstract}
OEIS A249710 carries an empirical recurrence of order $6$. It is true, and it is
...
\begin{quote}
Empirical: a(n) = (7/15)*n\^{}5 + 5*n\^{}4 + 11*n\^{}3 + 8*n\^{}2 + (38/15)*n + 1. a(n) = 6*a(n-1) - 15*a(n-2) + 20*a(n-3) - 15*a(n-4) + 6*a(n-5) - a(n-6) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 10 2018 04:40:21, revision 8)
