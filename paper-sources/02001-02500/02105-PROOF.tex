...
\title{The empirical recurrence for OEIS A208319, proved by counting patterns}
...
\begin{abstract}
OEIS A208319 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A208319 is ``Number of nX5 0..2 arrays with new values 0..2 introduced in row major order and no element equal to more than two of its immediate leftward or upward or left-upward diagonal neighbors.''. It has offset $1$ and begins
\[
41, 8534, 1815496, 385979024, 82063614224, 17447625342768, 3709557427849168, 788692779445041968,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:45:42, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;197\,a(n-1) + 3456\,a(n-2) - 27886\,a(n-3) - 272376\,a(n-4) + 2523280\,a(n-5) - 5952064\,a(n-6) + 3277568\,a(n-7) + 2841600\,a(n-8) - 1871872\,a(n-9) - 540672\,a(n-10)
\end{equation}
for all $n>11$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208319.
