...
\title{The empirical recurrence for OEIS A268748, proved by transfer matrix}
...
\begin{abstract}
OEIS A268748 counts arrays of width $6$ over $\{0,1\}$ in which the number of adjacent PAIRS of
...
OEIS A268748 is ``Number of nX6 binary arrays with some element plus some horizontally or vertically adjacent neighbor totalling two no more than once.''. It has offset $1$ and begins
\[
41, 659, 10830, 165019, 2425799, 34732937, 487682438, 6746117783,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 12 2016 12:32:43, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;16\,a(n-1) + 60\,a(n-2) - 1148\,a(n-3) - 3346\,a(n-4) + 16272\,a(n-5) + 36588\,a(n-6) - 104246\,a(n-7) - 147989\,a(n-8) + 349140\,a(n-9) + 217324\,a(n-10) - 591448\,a(n-11) - 19320\,a(n-12) + 431032\,a(n-13) - 151921\,a(n-14) - 73194\,a(n-15) + 41684\,a(n-16) + 2552\,a(n-17) - 3594\,a(n-18) + 148\,a(n-19) + 100\,a(n-20) - 4\,a(n-21) - a(n-22)
\]
for every $n>21$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268748.
