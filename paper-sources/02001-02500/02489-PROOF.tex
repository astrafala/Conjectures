...
\title{A further conjecture on OEIS A187178,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A187178 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $0, 0, 0, 0, 0, 0, 280, 1784,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = 2172*n\^{}2 - 30972*n + 103944 for n>13.\end{quote}
...
indices, and $a$ and $f$ were checked to agree at $n=17,\dots,19$,
