...
\title{The empirical recurrence for OEIS A268970, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A268970 counts arrays over $\{0,\dots,2\}$ subject to a condition on the array as a
...
OEIS A268970 is ``Number of nX7 0..2 arrays with some element plus some horizontally or antidiagonally adjacent neighbor totalling two not more than once.''. It has offset $1$ and begins
\[
768, 40176, 1770048, 72081792, 2799406656, 105294777120, 3870355944960, 139818682627488,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 84*a(n-1) -2466*a(n-2) +31428*a(n-3) -206469*a(n-4) +750384*a(n-5) -1513404*a(n-6) +1574640*a(n-7) -656100*a(n-8)
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 16 2016 13:46:17, revision 4) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268970.
