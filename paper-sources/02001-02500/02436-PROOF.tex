...
\title{The empirical recurrence for OEIS A230990, proved by transfer matrix}
...
\begin{abstract}
OEIS A230990 counts arrays of width $2$ over $\{0,1,2,3\}$ in which every cell must see, among its
...
the count is a walk count on $S=229$ states.
\end{abstract}
...
OEIS A230990 is ``Number of n X 2 0..3 arrays x(i,j) with each element horizontally, vertically or antidiagonally next to at least one element with value (x(i,j)+1) mod 4 and at least one element with value (x(i,j)-1) mod 4, and upper left element zero.''. It has offset $1$ and begins
\[
0, 2, 2, 16, 66, 396, 2172, 12094,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 7*a(n-1) - 5*a(n-2) - 25*a(n-3) + 47*a(n-4) - 4*a(n-5) - 100*a(n-6) + 104*a(n-7) - 36*a(n-8) + 4*a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 25 2018 20:52:47, revision 9) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=229.
\]
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-1) - 5\,a(n-2) - 25\,a(n-3) + 47\,a(n-4) - 4\,a(n-5) - 100\,a(n-6) + 104\,a(n-7) - 36\,a(n-8) + 4\,a(n-9)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A230990.
