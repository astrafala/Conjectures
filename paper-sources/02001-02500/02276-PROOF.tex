...
\title{The empirical recurrence for OEIS A189181, proved by transfer matrix}
...
\begin{abstract}
OEIS A189181 counts the permutations of the cells of an $n\times4$ array in which every cell
...
OEIS A189181 is ``Number of nX4 array permutations with each element making a single king move.''. It has offset $1$ and begins
\[
1, 185, 4081, 251720, 10599449, 524539713, 24377674329, 1162453545201,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 05:04:14, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;50\,a(n-1) + 189\,a(n-2) - 17418\,a(n-3) + 111208\,a(n-4) + 452547\,a(n-5) - 4449430\,a(n-6) + 190937\,a(n-7) + 29532742\,a(n-8) - 4370254\,a(n-9) + 186074662\,a(n-10) - 567421032\,a(n-11) - 487743654\,a(n-12) - 150818946\,a(n-13) - 265001610\,a(n-14) + 6374532886\,a(n-15) - 3311165152\,a(n-16) - 3325788742\,a(n-17) + 2609479826\,a(n-18) - 1073359914\,a(n-19) + 294380347\,a(n-20) + 4801462\,a(n-21) - 20168455\,a(n-22) + 4712116\,a(n-23) - 541926\,a(n-24) - 30393\,a(n-25) + 13302\,a(n-26) - 675\,a(n-27)
\]
for every $n>26$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A189181.
