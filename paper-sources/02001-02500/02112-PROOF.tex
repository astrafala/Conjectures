...
\title{The empirical recurrence for OEIS A201812, proved from an exact model}
...
\begin{abstract}
OEIS A201812 carries an empirical recurrence of order $4$. It is true, and it is
...
\begin{quote}
Empirical: a(n) = 4*n\^{}3 + 14*n + 1. a(n) = 4*a(n-1) - 6*a(n-2) + 4*a(n-3) - a(n-4) for n>4.
\end{quote}
As of the ``Last modified'' line on the live entry (May 25 2018 08:56:37, revision 10)
