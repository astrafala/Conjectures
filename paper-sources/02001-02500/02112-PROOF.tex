...
\title{The empirical recurrence for OEIS A275261, proved by counting patterns}
...
\begin{abstract}
OEIS A275261 counts arrays in which no entry may repeat a value found at any of three stated
...
cutting $794$ pairs to $S=155$ states. The entry's empirical recurrence of order $14$,
...
OEIS A275261 is ``Number of nX3 0..2 arrays with no element equal to any value at offset (-2,-1) (-2,1) or (-1,-1) and new values introduced in order 0..2.''. It has offset $1$ and begins
\[
5, 54, 128, 396, 1440, 5676, 22844, 93968,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 21 2016 11:31:02, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) - 4\,a(n-2) - 20\,a(n-3) + 28\,a(n-4) - 40\,a(n-5) + 8\,a(n-6) + 194\,a(n-7) - 180\,a(n-8) + 36\,a(n-9) + 56\,a(n-10) - 356\,a(n-11) + 201\,a(n-12) + 180\,a(n-13) - 108\,a(n-14)
\end{equation}
for all $n>17$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A275261.
