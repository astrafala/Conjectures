...
\title{The empirical recurrence for OEIS A203256, proved by transfer matrix}
...
\begin{abstract}
OEIS A203256 counts arrays of width $2$ over $\{0,1,\dots,7\}$ in which every nonzero cell has a neighbour at least as large as itself. The entry carries an
...
OEIS A203256 is ``Number of nX2 0..7 arrays with every nonzero element less than or equal to some NW, E or S neighbor.''. It has offset $1$ and begins
\[
1, 64, 2598, 62098, 1224456, 24301646, 508333573, 10796311201,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 10:15:35, revision 9) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The arrays have $2$ columns and a growing number of rows, with entries in $\{0,1,\dots,7\}$. Fix the
...
Thus
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=3041,
\]
...
\begin{theorem}
\[
a(n)\;=\;64\,a(n-1) - 1848\,a(n-2) + 33600\,a(n-3) - 431592\,a(n-4) + 4086840\,a(n-5) - 29206462\,a(n-6) + 160678294\,a(n-7) - 693264590\,a(n-8) + 2392550992\,a(n-9) - 6777430404\,a(n-10) + 16251895568\,a(n-11) - 33600669981\,a(n-12) + 59027125766\,a(n-13) - 84488023983\,a(n-14) + 94715868410\,a(n-15) - 83342440797\,a(n-16) + 62202372085\,a(n-17) - 42529439142\,a(n-18) + 24388393885\,a(n-19) - 9901259764\,a(n-20) + 2690832600\,a(n-21) - 486202500\,a(n-22)
\]
for every $n>21$.
\end{theorem}
...
array of width $2$ over $\{0,1,\dots,7\}$ with a few rows was written out cell by cell and each cell
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A203256.
