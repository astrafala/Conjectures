...
\title{The empirical recurrence for OEIS A247727, proved from an exact model}
...
\begin{abstract}
OEIS A247727 carries an empirical recurrence of order $5$. It is true, and it is
...
\begin{quote}
Empirical: a(n) = n\^{}4 + 2*n\^{}3 + 3*n\^{}2 + 2*n. a(n) = 5*a(n-1) - 10*a(n-2) + 10*a(n-3) - 5*a(n-4) + a(n-5) for n>5. (End)
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 14 2025 04:35:25, revision 41)
