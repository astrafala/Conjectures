...
\title{The empirical recurrence for OEIS A199848, proved from an exact model}
...
\begin{abstract}
OEIS A199848 carries an empirical recurrence of order $6$. It is true, and it is
...
OEIS A199848 is ``Number of -n..n arrays x(0..3) of 4 elements with zero sum and no element more than one greater than the previous.''. It has offset $1$ and begins
\[
11, 23, 42, 68, 103, 149, 206, 276,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) -3*a(n-2) +2*a(n-3) -3*a(n-4) +3*a(n-5) -a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (May 17 2018 17:02:06, revision 9)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A199848.
