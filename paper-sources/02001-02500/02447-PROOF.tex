...
\title{A further conjecture on OEIS A063109,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A063109 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $3, 10, 16, 24, 30, 38, 44, 52,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = ((-1)\^{}n + 14*n - 9) / 2 for n>1.\end{quote}
