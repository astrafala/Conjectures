...
\title{The empirical recurrence for OEIS A211502, proved by transfer matrix}
...
\begin{abstract}
OEIS A211502 carries an empirical recurrence of order $24$ contributed by R. H. Hardin. It is
...
OEIS A211502 is ``Number of -3..3 arrays x(i) of n+1 elements i=1..n+1 with x(i)+x(j), x(i+1)+x(j+1), -(x(i)+x(j+1)), and -(x(i+1)+x(j)) having three or four distinct values for every i<=n and j<=n.''. It has offset $1$ and begins
\[
38, 208, 1104, 5816, 30248, 155984, 798008, 4055448,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 16:12:44, revision 8) this is still
...
admissible array is then exactly a walk, so with $M$ the adjacency matrix on $S=27$ vertices
...
\begin{theorem}
\[
a(n)\;=\;10\,a(n-1) + 37\,a(n-2) - 550\,a(n-3) - 649\,a(n-4) + 13442\,a(n-5) + 11131\,a(n-6) - 183874\,a(n-7) - 197258\,a(n-8) + 1418860\,a(n-9) + 2192568\,a(n-10) - 5278112\,a(n-11) - 11467160\,a(n-12) + 5231288\,a(n-13) + 19433444\,a(n-14) - 4017688\,a(n-15) - 17551936\,a(n-16) + 5387696\,a(n-17) + 8469936\,a(n-18) - 4963520\,a(n-19) - 969600\,a(n-20) + 1662208\,a(n-21) - 604416\,a(n-22) + 97792\,a(n-23) - 6144\,a(n-24)
\]
for every $n>0$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A211502.
