...
\title{The empirical recurrence for OEIS A204277, proved by transfer matrix}
...
\begin{abstract}
OEIS A204277 counts $(n+2)\times3$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A204277 is ``Number of (n+2)X3 0..2 arrays with every 3X3 subblock having three equal elements in a row horizontally, vertically, diagonally or antidiagonally exactly three ways, and new values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
108, 274, 783, 1758, 5263, 14141, 29731, 93809,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 11:03:19, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) - 3\,a(n-2) + 10\,a(n-3) - 44\,a(n-4) + 60\,a(n-5) - 30\,a(n-6) - 172\,a(n-7) - 152\,a(n-8) + 1224\,a(n-9) - 448\,a(n-10) - 656\,a(n-11) + 880\,a(n-12) - 2592\,a(n-13) + 2688\,a(n-14) - 768\,a(n-15)
\]
for every $n>16$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204277.
