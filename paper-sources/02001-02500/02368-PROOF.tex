...
\title{The empirical closed form for OEIS A223672, proved}
...
\begin{abstract}
OEIS A223672 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
$S=1048576$ vertices. Any function of the form $\sum_j p_j(n)\lambda_j^{\,n}$ satisfies the
...
OEIS A223672 is ``Number of 5 X n 0..1 arrays with rows, diagonals and antidiagonals unimodal.''. It has offset $1$ and begins
\[
32, 1024, 10327, 44693, 136289, 364959, 920106, 2218590,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 10 2022 14:13:59, revision 6) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{359 n^{10}}{453600} - \frac{391 n^{9}}{18144} + \frac{5825 n^{8}}{12096} - \frac{13241 n^{7}}{3780} - \frac{41189 n^{6}}{675} + \frac{10637083 n^{5}}{4320} - \frac{1341019765 n^{4}}{36288} + \frac{7101447161 n^{3}}{22680} - \frac{37771550507 n^{2}}{25200} + \frac{2233774483 n}{630} - 2534086.
\]
...
walk, so with $M$ the adjacency matrix of that digraph on $S=1048576$ vertices, and $u,w$ the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223672.
