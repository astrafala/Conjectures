...
\title{The empirical recurrence for OEIS A209810, proved by counting patterns}
...
\begin{abstract}
OEIS A209810 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
$33$, contributed by R.~H.~Hardin, then follows from a finite exact computation.
\end{abstract}
...
OEIS A209810 is ``Number of (n+1)X5 0..3 arrays with every 2X2 subblock having two distinct values, and new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
930, 25505, 712829, 20873080, 617966001, 18479672376, 555404234236, 16753667272666,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 15:30:34, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;66\,a(n-1) - 1211\,a(n-2) - 3327\,a(n-3) + 287711\,a(n-4) - 1650227\,a(n-5) - 18911756\,a(n-6) + 200787144\,a(n-7) + 249811709\,a(n-8) - 8470618231\,a(n-9) + 12934099929\,a(n-10) + 169407260904\,a(n-11) - 526263544629\,a(n-12) - 1680919496686\,a(n-13) + 8328865779706\,a(n-14) + 6270909877563\,a(n-15) - 70313845544213\,a(n-16) + 27029214503869\,a(n-17) + 333056045453117\,a(n-18) - 377395472742367\,a(n-19) - 825772616226370\,a(n-20) + 1585680300164445\,a(n-21) + 703085339056680\,a(n-22) - 3069417122224407\,a(n-23) + 900452612086569\,a(n-24) + 2425264270015320\,a(n-25) - 1808654163691437\,a(n-26) - 347830308417366\,a(n-27) + 652709084826024\,a(n-28) - 96050625683220\,a(n-29) - 59518267835508\,a(n-30) + 14239281350520\,a(n-31) + 1128398046480\,a(n-32) - 309936391200\,a(n-33)
\end{equation}
for all $n>33$.
...
For every $n$ with $m=n+1-1\ge33$,
\[
4!\Bigl(a(n)-\sum_i c_i\,a(n-i)\Bigr)\;=\;\mathbf{v}^{\!\top}N^{\,m-33}q(N)\mathbf{1} .
\]
...
\begin{proof}
Substitute \eqref{eq:walk} into the left side and factor $N^{m-33}$ out of
...
column. The vector $w=q(N)\mathbf{1}$ was then formed by $33$ matrix--vector products
...
corresponding to $n=33+1$ onwards, and the run continued until $w$ was the zero vector,
...
\eqref{eq:walk}, divided by $4!$, was evaluated at every one of the $14$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209810.
