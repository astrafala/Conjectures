...
\title{A further conjecture on OEIS A202048,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A202048 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $636, 1968, 4980, 11016, 22092, 41088, 71964, 120000,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (1/30)*n\^{}6 + (9/10)*n\^{}5 + (59/6)*n\^{}4 + (111/2)*n\^{}3 + (2552/15)*n\^{}2 + (1278/5)*n + 144.\end{quote}
