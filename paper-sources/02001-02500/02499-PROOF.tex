...
\title{A further conjecture on OEIS A229681,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A229681 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $0, 360, 10896, 186576, 2700432, 35485776, 437924880, 5169543120,\dots$, with offset $1$. The sequence satisfies
\[
  a(n)=27\,a(n-1) - 243\,a(n-2) + 729\,a(n-3) ,
\]
a linear recurrence of order $3$ with characteristic polynomial
\[
  q(x)=x^{3} - 27 x^{2} + 243 x - 729 .
\]
...
\begin{quote}\raggedright a(n) = 16*3\^{}(2*n-7)*(-449 + 60*n + 256*n\^{}2) for n > 3.\end{quote}
