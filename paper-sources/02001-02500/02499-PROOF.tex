...
\title{A further conjecture on OEIS A187587,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A187587 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $0, 5, 84, 286, 604, 1038, 1588, 2254,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = 58*n\^{}2 - 204*n + 174 for n>2.\end{quote}
