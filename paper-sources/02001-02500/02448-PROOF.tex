...
\title{A further conjecture on OEIS A063158,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A063158 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $11, 46, 82, 118, 154, 190, 226, 262,\dots$, with offset $1$. The sequence satisfies
\[
  a(n)=2\,a(n-1) - 1\,a(n-2) ,
\]
...
\begin{quote}\raggedright a(n) = 36*n-26 for n>1.\end{quote}
