...
\title{The empirical closed form for OEIS A224147, proved}
...
\begin{abstract}
OEIS A224147 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A224147 is ``Number of 3 X n 0..1 arrays with rows and antidiagonals unimodal and columns nondecreasing.''. It has offset $1$ and begins
\[
4, 16, 49, 124, 275, 554, 1037, 1831,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (1/720)*n\^{}6 + (1/80)*n\^{}5 + (23/144)*n\^{}4 + (29/48)*n\^{}3 + (241/180)*n\^{}2 + (53/60)*n + 1.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 28 2018 06:07:49, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{n^{6}}{720} + \frac{n^{5}}{80} + \frac{23 n^{4}}{144} + \frac{29 n^{3}}{48} + \frac{241 n^{2}}{180} + \frac{53 n}{60} + 1.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224147.
