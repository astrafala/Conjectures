...
\title{The empirical recurrence for OEIS A214144, proved by transfer matrix}
...
\begin{abstract}
OEIS A214144 counts the proper colourings of a grid $3\times(n+1)$, wrapped in the growing direction, with at most $5$ colours and
...
down to $S=258$ and makes the exact residual test affordable.
\end{abstract}
...
OEIS A214144 is ``Number of 0..4 colorings of a 3X(n+1) array circular in the n+1 direction with new values 0..4 introduced in row major order.''. It has offset $1$ and begins
\[
33, 514, 28278, 1101051, 47730973, 2000093424, 84746307320, 3577656763765,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 16:53:48, revision 8) this is still
...
state count is $S=258$ rather than the number of colourings.
...
\begin{theorem}
\[
a(n)\;=\;29\,a(n-1) + 667\,a(n-2) - 3517\,a(n-3) - 48855\,a(n-4) + 260073\,a(n-5) + 877261\,a(n-6) - 6916959\,a(n-7) + 3304148\,a(n-8) + 50505862\,a(n-9) - 103934388\,a(n-10) + 3498864\,a(n-11) + 137456208\,a(n-12) - 66186464\,a(n-13) - 37655040\,a(n-14) + 18842112\,a(n-15)
\]
for every $n>13$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A214144.
