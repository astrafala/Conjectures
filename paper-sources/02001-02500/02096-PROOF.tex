...
\title{The empirical recurrence for OEIS A229638, proved by counting defective colourings}
...
\begin{abstract}
OEIS A229638 counts the colourings of an array with $K=3$ colours that are proper except at
...
OEIS A229638 is ``Number of defective 3-colorings of a 2 X n 0..2 array connected horizontally, diagonally and antidiagonally with exactly two mistakes, and colors introduced in row-major 0..2 order.''. It has offset $1$ and begins
\[
0, 6, 40, 122, 488, 1608, 5392, 17368,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 6*a(n-1) - 6*a(n-2) - 16*a(n-3) + 12*a(n-4) + 24*a(n-5) + 8*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 20 2018 09:19:19, revision 7) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A229638.
