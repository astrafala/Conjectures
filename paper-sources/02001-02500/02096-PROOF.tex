...
\title{The empirical recurrence for OEIS A199533, proved from an exact model}
...
\begin{abstract}
OEIS A199533 carries an empirical recurrence of order $6$. It is true, and it is
...
OEIS A199533 is ``Number of -n..n arrays x(0..5) of 6 elements with zero sum and no two consecutive zero elements.''. It has offset $1$ and begins
\[
80, 1414, 8342, 30484, 84852, 197962, 407946, 766664,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (88/5)*n\^{}5 + 44*n\^{}4 + (58/3)*n\^{}3 - 3*n\^{}2 + (31/15)*n. a(n) = 6*a(n-1) - 15*a(n-2) + 20*a(n-3) - 15*a(n-4) + 6*a(n-5) - a(n-6) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (May 15 2018 20:43:48, revision 8)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A199533.
