...
\title{The empirical recurrence for OEIS A281466, proved by transfer matrix}
...
\begin{abstract}
OEIS A281466 counts $n\times5$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A281466 is ``Number of nX5 0..1 arrays with no element equal to more than two of its horizontal, diagonal or antidiagonal neighbors and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
16, 78, 57, 130, 278, 534, 1106, 2362,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) +3*a(n-3) -4*a(n-4) -3*a(n-5) -a(n-6) -a(n-7) +8*a(n-8) -3*a(n-10) for n>15
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 22 2017 07:23:53, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 3\,a(n-3) - 4\,a(n-4) - 3\,a(n-5) - a(n-6) - a(n-7) + 8\,a(n-8) - 3\,a(n-10)
\]
for every $n>15$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A281466.
