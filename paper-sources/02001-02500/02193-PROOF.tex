...
\title{The empirical recurrence for OEIS A206688, proved by transfer matrix}
...
\begin{abstract}
OEIS A206688 counts arrays in which no entry may equal the entries at a short list of fixed offsets
...
$2$ consecutive rows, $S=934$ states in all.
\end{abstract}
...
OEIS A206688 is ``Number of nX4 0..3 arrays with no element equal to another within two positions in the same row or column, and new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
2, 36, 176, 916, 4704, 24492, 127008, 660888,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 13:05:10, revision 9) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=934.
\]
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-1) - 8\,a(n-2) - 48\,a(n-3) + 48\,a(n-4) + 140\,a(n-5) + 67\,a(n-6) - 968\,a(n-7) + 1564\,a(n-8) - 586\,a(n-9) - 1008\,a(n-10) - 32\,a(n-11) + 1304\,a(n-12) + 80\,a(n-13) - 512\,a(n-14)
\]
for every $n>15$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206688.
