...
\title{A further conjecture on OEIS A187509,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A187509 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $0, 2, 36, 115, 236, 399, 604, 851,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = 21*n\^{}2 - 68*n + 51 for n>2.\end{quote}
