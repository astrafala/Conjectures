...
\title{A further conjecture on OEIS A229582,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A229582 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $6, 116, 1620, 19764, 224532, 2440692, 25745364, 265720500,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = 4 * 9\^{}(n - 2) * (16*n - 3) for n>1.\end{quote}
