...
\title{The empirical recurrence for OEIS A200432, proved from an exact model}
...
\begin{abstract}
OEIS A200432 carries an empirical recurrence of order $5$. It is true, and it is
...
OEIS A200432 is ``Number of -n..n arrays x(0..4) of 5 elements with zero sum and no two or three adjacent elements summing to zero.''. It has offset $1$ and begins
\[
0, 80, 520, 1830, 4750, 10250, 19530, 34020,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (115/12)*n\^{}4 - (65/6)*n\^{}3 + (65/12)*n\^{}2 - (25/6)*n. a(n) = 5*a(n-1) - 10*a(n-2) + 10*a(n-3) - 5*a(n-4) + a(n-5) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (May 20 2018 15:05:53, revision 8)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A200432.
