...
\title{The empirical recurrence for OEIS A202253, proved from an exact model}
...
\begin{abstract}
OEIS A202253 carries an empirical recurrence of order $5$. It is true, and it is
...
OEIS A202253 is ``Number of zero-sum -n..n arrays of 3 elements with adjacent element differences also in -n..n.''. It has offset $1$ and begins
\[
3, 9, 17, 27, 41, 57, 75, 97,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) - a(n-2) + a(n-3) - 2*a(n-4) + a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 03 2018 05:35:55, revision 19)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A202253.
