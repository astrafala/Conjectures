...
\title{The empirical recurrence for OEIS A224010, proved by transfer matrix}
...
\begin{abstract}
OEIS A224010 counts arrays over $\{0,\dots,2\}$ whose rows, columns, diagonals or
...
OEIS A224010 is ``Number of n X 6 0..2 arrays with rows nondecreasing and antidiagonals unimodal.''. It has offset $1$ and begins
\[
28, 784, 15340, 245055, 3516324, 47735665, 630339756, 8213689391,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 18 2025 04:36:25, revision 10) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224010.
