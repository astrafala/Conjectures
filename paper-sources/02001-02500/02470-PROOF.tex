...
\title{A further conjecture on OEIS A183902,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A183902 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $5, 22, 243, 1160, 3347, 7416, 14376, 25584,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (1/5040)*n\^{}7 + (7/720)*n\^{}6 + (29/144)*n\^{}5 + (329/144)*n\^{}4 + (1259/90)*n\^{}3 + (5167/180)*n\^{}2 - (6955/21)*n + 312 for n>4\end{quote}
