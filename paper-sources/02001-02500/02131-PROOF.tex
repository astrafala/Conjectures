...
\title{The empirical recurrence for OEIS A208600, proved from an exact model}
...
\begin{abstract}
OEIS A208600 carries an empirical recurrence of order $6$. It is true, and it is
decidable rather than empirical. The entry's sequence is given exactly by a Burnside sum over the necklace group, from
which $a$ provably satisfies a MONIC linear recurrence of order $S=43$, derived below and not
...
OEIS A208600 is ``Number of 6-bead necklaces labeled with numbers -n..n not allowing reversal, with sum zero.''. It has offset $1$ and begins
\[
26, 297, 1564, 5457, 14838, 34153, 69784, 130401,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (44/15)*n\^{}5 + (22/3)*n\^{}4 + (23/3)*n\^{}3 + (14/3)*n\^{}2 + (12/5)*n + 1. a(n) = 6*a(n-1) - 15*a(n-2) + 20*a(n-3) - 15*a(n-4) + 6*a(n-5) - a(n-6) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 18 2018 17:54:04, revision 13)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208600.
