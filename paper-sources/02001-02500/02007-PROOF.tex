...
\title{The empirical recurrence for OEIS A224372, proved by transfer matrix}
...
\begin{abstract}
OEIS A224372 counts arrays over $\{0,\dots,2\}$ whose rows, columns, diagonals or
antidiagonals are required to be monotone or unimodal, and carries an empirical recurrence of
order $14$ contributed by R.~H.~Hardin. A monotone condition is local, but a unimodal one
...
is a walk count on $S=148$ vertices and the recurrence follows from a finite exact
computation.
\end{abstract}
...
OEIS A224372 is ``Number of nX6 0..2 arrays with rows unimodal and antidiagonals nondecreasing.''. It has offset $1$ and begins
\[
148, 4690, 80819, 1092281, 13831334, 174854516, 2231009824, 28645726612,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 23:24:29, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;28\,a(n-1) - 283\,a(n-2) + 1386\,a(n-3) - 3562\,a(n-4) + 4940\,a(n-5) - 3840\,a(n-6) - 14256\,a(n-7) + 50007\,a(n-8) - 26386\,a(n-9) + 141154\,a(n-10) + 250789\,a(n-11) + 41356\,a(n-12) + 274344\,a(n-13) + 134400\,a(n-14)
\end{equation}
for all $n>18$.
...
bit vector), $|\mathcal V|=S=148$; let $(r,f)\to(s,f')$ be an edge when placing $s$ after $r$
...
$h_j=G^{j}N^{o}\mathbf{1}$, we have for $j\ge14$
\[
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224372.
