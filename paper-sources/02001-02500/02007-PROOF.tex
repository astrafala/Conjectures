...
\title{The empirical recurrence for OEIS A224371, proved by transfer matrix}
...
\begin{abstract}
OEIS A224371 counts arrays over $\{0,\dots,2\}$ whose rows, columns, diagonals or
antidiagonals are required to be monotone or unimodal, and carries an empirical recurrence of
order $11$ contributed by R.~H.~Hardin. A monotone condition is local, but a unimodal one
...
is a walk count on $S=86$ vertices and the recurrence follows from a finite exact
computation.
\end{abstract}
...
OEIS A224371 is ``Number of nX5 0..2 arrays with rows unimodal and antidiagonals nondecreasing.''. It has offset $1$ and begins
\[
86, 1915, 26314, 311367, 3607078, 42132769, 495660330, 5848449149,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 23:24:22, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;21\,a(n-1) - 141\,a(n-2) + 427\,a(n-3) - 546\,a(n-4) + 526\,a(n-5) - 2124\,a(n-6) + 3302\,a(n-7) + 2396\,a(n-8) + 7504\,a(n-9) + 580\,a(n-10) + 1632\,a(n-11)
\end{equation}
for all $n>13$.
...
bit vector), $|\mathcal V|=S=86$; let $(r,f)\to(s,f')$ be an edge when placing $s$ after $r$
...
$h_j=G^{j}N^{o}\mathbf{1}$, we have for $j\ge11$
\[
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224371.
