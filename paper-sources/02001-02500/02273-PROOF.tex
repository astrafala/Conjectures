...
\title{The empirical recurrence for OEIS A221574, proved from an exact model}
...
\begin{abstract}
OEIS A221574 carries an empirical recurrence of order $4$. It is true, and it is
...
\begin{quote}
Empirical: a(n) = 1*n\^{}3 - 1*n\^{}2 + 3*n - 1. a(n) = 4*a(n-1) - 6*a(n-2) + 4*a(n-3) - a(n-4) for n>3.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 08 2018 15:19:04, revision 8)
