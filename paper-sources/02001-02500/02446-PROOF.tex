...
\title{A further conjecture on OEIS A063143,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A063143 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $5, 24, 44, 64, 84, 104, 124, 144,\dots$, with offset $1$. The sequence satisfies
\[
  a(n)=2\,a(n-1) - 1\,a(n-2) ,
\]
...
\begin{quote}\raggedright a(n) = 4*(5*n-4) for n>1.\end{quote}
