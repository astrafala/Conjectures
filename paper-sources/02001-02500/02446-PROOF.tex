...
\title{A further conjecture on OEIS A063094,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A063094 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $2, 9, 15, 23, 29, 37, 43, 51,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = ((-1)\^{}n + 14*n - 11) / 2 for n>1.\end{quote}
