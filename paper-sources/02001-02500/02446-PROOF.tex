...
\title{A further conjecture on OEIS A063102,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A063102 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $3, 12, 20, 30, 38, 48, 56, 66,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = ((-1)\^{}n + 18*n - 13)/2 for n>1.\end{quote}
