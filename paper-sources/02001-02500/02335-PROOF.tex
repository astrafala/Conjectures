...
\title{The empirical recurrence for OEIS A221266, proved by transfer matrix}
...
\begin{abstract}
OEIS A221266 counts the distinct OCCUPANCY arrays obtained when every cell of an $n\times2$ grid
...
determinising the machine that emits the occupancy row by row turns it into one, on $S=176$
...
OEIS A221266 is ``Number of n X 2 arrays of occupancy after each element stays put or moves to some king-move neighbor, with no occupancy greater than 2.''. It has offset $1$ and begins
\[
3, 19, 141, 1073, 8203, 62771, 480437, 3677345,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 10*a(n-1) - 19*a(n-2) + 8*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 04 2018 14:33:03, revision 10) this is still
...
\]
There are $S=176$ reachable sets. In particular $a$ is $C$-finite.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221266.
