...
\title{The empirical recurrence for OEIS A124698, proved from an exact model}
...
\begin{abstract}
OEIS A124698 carries an empirical recurrence of order $4$. It is true, and it is
...
OEIS A124698 is ``Number of base 5 circular n-digit numbers with adjacent digits differing by 1 or less.''. It has offset $0$ and begins
\[
1, 5, 13, 29, 73, 185, 481, 1265,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
[Empirical] a(base,n)=a(base-1,n)+A002426(n+1) for base>=1.int(n/2)+1. a(n) = 5*a(n-1) - 6*a(n-2) - 2*a(n-3) + 4*a(n-4) for n>4.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 18:59:17, revision 20)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A124698.
