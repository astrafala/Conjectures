...
\title{The empirical recurrence for OEIS A221737, proved by transfer matrix}
...
\begin{abstract}
OEIS A221737 counts the distinct OCCUPANCY arrays obtained when every cell of an $n\times2$ grid
...
an empirical recurrence of order $5$ contributed by R.~H.~Hardin. It is true, and it is
...
one, on $S=161$ states, after which the conjectured recurrence is settled by a finite exact
computation.
\end{abstract}
...
OEIS A221737 is ``Number of 2 X n arrays of occupancy after each element stays put or moves to some horizontal or antidiagonal neighbor, without move-in move-out left turns.''. It has offset $1$ and begins
\[
1, 17, 152, 1347, 11917, 105408, 932331, 8246429,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 15*a(n-1) - 67*a(n-2) + 120*a(n-3) - 80*a(n-4) + 10*a(n-5) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2018 17:33:47, revision 8) this is still
...
$S=161$ reachable sets. In particular $a$ is $C$-finite.
...
\begin{theorem}
\[
a(n)\;=\;15\,a(n-1) - 67\,a(n-2) + 120\,a(n-3) - 80\,a(n-4) + 10\,a(n-5)
\]
for every $n>6$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221737.
