...
\title{The empirical recurrence for OEIS A204486, proved by transfer matrix}
...
\begin{abstract}
OEIS A204486 counts $(n+2)\times4$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A204486 is ``Number of (n+2) X 4 0..1 arrays with every 3 X 3 subblock having three equal elements in a row horizontally, vertically or nw-to-se diagonally exactly one way, and new values 0..1 introduced in row major order.''. It has offset $1$ and begins
\[
214, 511, 1189, 2627, 5804, 12861, 28743, 64707,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 26 2025 12:18:06, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + a(n-2) + 10\,a(n-3) - 6\,a(n-4) - 10\,a(n-5) - 17\,a(n-6) - 3\,a(n-7) + 23\,a(n-8) - 3\,a(n-9) + 37\,a(n-10) - 19\,a(n-11) + 26\,a(n-12) - 48\,a(n-13) + 4\,a(n-14) - 19\,a(n-15) + 21\,a(n-16) + a(n-17) + 4\,a(n-18) - 2\,a(n-19)
\]
for every $n>29$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204486.
