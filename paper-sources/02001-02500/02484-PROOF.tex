...
\title{A further conjecture on OEIS A187173,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A187173 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $0, 0, 0, 16, 60, 128, 220, 336,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = 12*n\^{}2 - 64*n + 80 for n>3.\end{quote}
