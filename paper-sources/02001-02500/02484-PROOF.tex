...
\title{A further conjecture on OEIS A223240,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A223240 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $7, 18, 60, 168, 528, 1536, 4704, 13920,\dots$, with offset $1$. The sequence satisfies
\[
  a(n)=1\,a(n-1) + 6\,a(n-2) ,
\]
...
\begin{quote}\raggedright a(n) = (64*3\^{}n - 9*(-2)\^{}n) / 30.\end{quote}
