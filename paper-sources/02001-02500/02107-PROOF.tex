...
\title{The empirical recurrence for OEIS A208946, proved from an exact model}
...
\begin{abstract}
OEIS A208946 carries an empirical recurrence of order $6$. It is true, and it is
...
OEIS A208946 is ``Number of 4-bead necklaces labeled with numbers -n..n not allowing reversal, with sum zero with no three beads in a row equal.''. It has offset $1$ and begins
\[
5, 22, 57, 122, 223, 366, 563, 820,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) - 3*a(n-2) + 2*a(n-3) - 3*a(n-4) + 3*a(n-5) - a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 12 2025 14:10:32, revision 15)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208946.
