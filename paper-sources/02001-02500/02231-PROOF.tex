...
\title{The empirical recurrence for OEIS A269641, proved from an exact model}
...
\begin{abstract}
OEIS A269641 carries an empirical recurrence of order $5$. It is true, and it is
...
OEIS A269641 is ``Number of length-4 0..n arrays with no repeated value differing from the previous repeated value by other than plus two or minus 1.''. It has offset $1$ and begins
\[
9, 63, 221, 567, 1209, 2279, 3933, 6351,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = n\^{}4 + 4*n\^{}3 + 3*n\^{}2 + 2*n - 1. a(n) = 5*a(n-1) - 10*a(n-2) + 10*a(n-3) - 5*a(n-4) + a(n-5) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 25 2019 09:28:47, revision 7)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269641.
