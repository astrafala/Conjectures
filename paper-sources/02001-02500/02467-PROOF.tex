...
\title{The empirical recurrence for OEIS A230905, proved by transfer matrix}
...
\begin{abstract}
OEIS A230905 counts arrays of width $3$ over $\{0,1,2,3\}$ in which every cell must see, among its
...
OEIS A230905 is ``Number of n X 3 0..3 arrays x(i,j) with each element horizontally, vertically or antidiagonally next to at least one element with value (x(i,j)+1) mod 4, no adjacent elements equal, and upper left element zero.''. It has offset $1$ and begins
\[
0, 8, 38, 152, 634, 2676, 11324, 47954,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 10*a(n-1) - 37*a(n-2) + 65*a(n-3) - 51*a(n-4) + 2*a(n-5) + 20*a(n-6) - 10*a(n-7) + 4*a(n-8) for n>11.
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 24 2018 02:47:40, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;10\,a(n-1) - 37\,a(n-2) + 65\,a(n-3) - 51\,a(n-4) + 2\,a(n-5) + 20\,a(n-6) - 10\,a(n-7) + 4\,a(n-8)
\]
for every $n>11$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A230905.
