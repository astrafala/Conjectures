...
\title{The empirical recurrence for OEIS A221323, proved by transfer matrix}
...
\begin{abstract}
OEIS A221323 counts the distinct OCCUPANCY arrays obtained when every cell of an $n\times3$ grid
...
determinising the machine that emits the occupancy row by row turns it into one, on $S=178$
...
OEIS A221323 is ``Number of n X 3 arrays of occupancy after each element stays put or moves to some horizontal or antidiagonal neighbor, with no occupancy greater than 2.''. It has offset $1$ and begins
\[
7, 119, 2008, 33873, 571358, 9637322, 162555929, 2741882383,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 23*a(n-1) - 110*a(n-2) + 111*a(n-3) - 6*a(n-4) - 8*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 05 2018 08:21:51, revision 8) this is still
...
\]
There are $S=178$ reachable sets. In particular $a$ is $C$-finite.
...
\begin{theorem}
\[
a(n)\;=\;23\,a(n-1) - 110\,a(n-2) + 111\,a(n-3) - 6\,a(n-4) - 8\,a(n-5)
\]
for every $n>5$.
\end{theorem}
...
arithmetic. The entry's first term is $7$, and it is a sharp test of the boundary: a
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221323.
