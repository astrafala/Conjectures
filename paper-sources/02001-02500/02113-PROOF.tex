...
\title{The empirical recurrence for OEIS A201814, proved from an exact model}
...
\begin{abstract}
OEIS A201814 carries an empirical recurrence of order $6$. It is true, and it is
...
\begin{quote}
Empirical: a(n) = 11*n\^{}5 + 65*n\^{}3 + 64*n + 1. a(n) = 6*a(n-1) - 15*a(n-2) + 20*a(n-3) - 15*a(n-4) + 6*a(n-5) - a(n-6) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (May 25 2018 10:33:27, revision 9)
