...
\title{The empirical recurrence for OEIS A201815, proved from an exact model}
...
\begin{abstract}
OEIS A201815 carries an empirical recurrence of order $6$. It is true, and it is
...
OEIS A201815 is ``Number of arrays of 7 integers in -n..n with sum zero and equal numbers of elements greater than zero and less than zero.''. It has offset $1$ and begins
\[
393, 4145, 23857, 90609, 263201, 637393, 1355145, 2613857,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 77*n\^{}5 + 175*n\^{}3 + 140*n + 1. a(n) = 6*a(n-1) - 15*a(n-2) + 20*a(n-3) - 15*a(n-4) + 6*a(n-5) - a(n-6) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (May 25 2018 11:13:36, revision 9)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A201815.
