...
\title{The empirical recurrence for OEIS A223260, proved by transfer matrix}
...
\begin{abstract}
OEIS A223260 counts the ways of writing the vertices of a fixed graph $G$ into an array of width
$5$ so that any two cells adjacent in one of the named directions carry vertices joined by an
edge of $G$; here $G$ is icosahedron graph. The entry carries an empirical recurrence of order $20$
...
single slice is a state and the count is a walk count on a finite digraph with $S=7501$ vertices.
\end{abstract}
...
OEIS A223260 is ``Rolling icosahedron footprints: number of nX5 0..11 arrays starting with 0 where 0..11 label vertices of an icosahedron and every array movement to a horizontal or vertical neighbor moves along an icosahedral edge.''. It has offset $1$ and begins
\[
625, 142805, 33841585, 8093320565, 1940359745365, 465517850602985, 111705181963446505, 26806081975380034085,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 21:25:49, revision 8) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=7501.
\]
...
of length $5$ over $12$ vertices is one of $12^{5}$ words, but only $S-1$ of them are
...
\begin{theorem}
\[
a(n)\;=\;370\,a(n-1) - 36788\,a(n-2) + 1437857\,a(n-3) - 23645436\,a(n-4) + 44066638\,a(n-5) + 4152418604\,a(n-6) - 63940525346\,a(n-7) + 398765153937\,a(n-8) - 664612370820\,a(n-9) - 5099885524914\,a(n-10) + 28863389079161\,a(n-11) - 33790027717185\,a(n-12) - 116946512376714\,a(n-13) + 358006866555853\,a(n-14) - 172436681167814\,a(n-15) - 370765534337711\,a(n-16) + 342597755828578\,a(n-17) + 68864786255753\,a(n-18) - 118288709865366\,a(n-19) + 21489625020240\,a(n-20)
\]
for every $n>20$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223260.
