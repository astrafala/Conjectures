...
\title{The empirical recurrence for OEIS A200787, proved from an exact model}
...
\begin{abstract}
OEIS A200787 carries an empirical recurrence of order $6$. It is true, and it is
...
\begin{quote}
Empirical: a(n) = (7/12)*n\^{}5 + (47/12)*n\^{}4 + (39/4)*n\^{}3 + (133/12)*n\^{}2 + (17/3)*n + 1. a(n) = 6*a(n-1) - 15*a(n-2) + 20*a(n-3) - 15*a(n-4) + 6*a(n-5) - a(n-6) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 15 2017 20:26:43, revision 13)
