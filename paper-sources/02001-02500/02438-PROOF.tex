...
\title{The empirical recurrence for OEIS A189605, proved by transfer matrix}
...
\begin{abstract}
OEIS A189605 counts the permutations of the cells of an $n\times4$ array in which every cell
...
That makes $a$ a walk count on $S=120$ states, hence $C$-finite, and whether the published
...
OEIS A189605 is ``Number of nX4 array permutations with each element not moving, or moving one space E, S or NW.''. It has offset $1$ and begins
\[
1, 13, 72, 464, 2853, 17617, 108785, 671452,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 05:20:50, revision 9) this is still
...
$k+-5,\dots,k+4$ are taken --- a subset of a set of size $10$, and nothing else.
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=120,
\]
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-1) - 3\,a(n-2) - 12\,a(n-3) - 11\,a(n-4) + 34\,a(n-5) - 27\,a(n-6) + 9\,a(n-7) + 7\,a(n-8) + 49\,a(n-9) - 82\,a(n-10) + 84\,a(n-11) - 54\,a(n-12) + 21\,a(n-13) - 6\,a(n-14) + a(n-15)
\]
for every $n>14$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A189605.
