...
\title{A further conjecture on OEIS A229505,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A229505 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $0, 48, 480, 4032, 31104, 228096, 1617408, 11197440,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = 2\^{}(2+n)*3\^{}(n-2)*(2*n - 1) for n>1.\end{quote}
