...
\title{A further conjecture on OEIS A187378,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A187378 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $0, 4, 40, 132, 278, 478, 732, 1040,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = 27*n\^{}2 - 97*n + 88 for n>2.\end{quote}
