...
\title{The empirical recurrence for OEIS A263812, proved by transfer matrix}
...
\begin{abstract}
OEIS A263812 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=3$ rows in which
...
OEIS A263812 is ``Number of (n+1) X (2+1) arrays of permutations of 0..n*3+2 with each element having index change (+-,+-) 0,0 0,1 0,2 or 1,0.''. It has offset $1$ and begins
\[
82, 948, 11305, 134028, 1590733, 18875976, 223995034, 2658056430,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 10*a(n-1) + 23*a(n-2) - 10*a(n-3) -a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 03 2019 05:41:07, revision 10) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A263812.
