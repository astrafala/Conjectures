...
\title{The conjectured generating function for OEIS A282799, proved}
...
\begin{abstract}
OEIS A282799 counts arrays of a fixed width under a local condition, and carries a conjectured
...
\begin{quote}
G.f.: (1 + 2*x\^{}2 + 2*x\^{}3) / ((1 - x)*(1 + x)*(1 - 2*x)*(1 + 2*x)).
\end{quote}
