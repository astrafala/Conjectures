...
\title{The empirical recurrence for OEIS A252412, proved by transfer matrix}
...
\begin{abstract}
OEIS A252412 counts $7\times(n+2)$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
$a(n)$ is a walk count on $S=1371889$ vertices. Such a sequence is $C$-finite, so whether a given
...
OEIS A252412 is ``Number of (5+2)X(n+2) 0..3 arrays with every 3X3 subblock row and diagonal sum equal to 2 3 4 6 or 7 and every 3X3 column and antidiagonal sum not equal to 2 3 4 6 or 7.''. It has offset $1$ and begins
\[
631, 2414, 8346, 16906, 73925, 267113, 551827, 2435059,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:11:59, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;70\,a(n-3) - 1310\,a(n-6) + 2636\,a(n-9) + 32077\,a(n-12) - 114560\,a(n-15) - 249921\,a(n-18) + 1417321\,a(n-21) + 345748\,a(n-24) - 7837703\,a(n-27) + 5163709\,a(n-30) + 17041697\,a(n-33) - 25415804\,a(n-36) + 9724087\,a(n-39) + 1068754\,a(n-42) - 1474782\,a(n-45) + 323236\,a(n-48) - 26094\,a(n-51) + 840\,a(n-54)
\]
for every $n>55$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252412.
