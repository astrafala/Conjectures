...
\title{The empirical recurrence for OEIS A210089, proved by transfer matrix}
...
\begin{abstract}
OEIS A210089 counts arrays of width $3$ whose every $2\times2$ subblock holds a
...
OEIS A210089 is ``Number of (n+1) X 3 0..2 arrays containing all values 0..2 with every 2 X 2 subblock having one or two distinct values, and new values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
9, 169, 2370, 29650, 348621, 3950131, 43701168, 475700584,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 20*a(n-1) - 112*a(n-2) + 122*a(n-3) + 61*a(n-4) - 106*a(n-5) + 16*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 14 2018 05:56:22, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;20\,a(n-1) - 112\,a(n-2) + 122\,a(n-3) + 61\,a(n-4) - 106\,a(n-5) + 16\,a(n-6)
\]
for every $n>5$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A210089.
