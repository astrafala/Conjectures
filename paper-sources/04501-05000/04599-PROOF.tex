...
\title{The empirical recurrence for OEIS A224019, proved by transfer matrix}
...
\begin{abstract}
OEIS A224019 counts arrays over $\{0,\dots,3\}$ whose rows, columns, diagonals or
...
OEIS A224019 is ``Number of n X 3 0..3 arrays with rows nondecreasing and antidiagonals unimodal.''. It has offset $1$ and begins
\[
20, 400, 6796, 112436, 1859020, 30756756, 508916456, 8420768936,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 20*a(n-1) - 70*a(n-2) + 228*a(n-3) - 276*a(n-4) + 392*a(n-5) - 196*a(n-6) + 144*a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 26 2018 09:50:56, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224019.
