...
\title{The empirical recurrence for OEIS A208867, proved by counting patterns}
...
\begin{abstract}
OEIS A208867 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A208867 is ``Number of n X 3 0..3 arrays with new values 0..3 introduced in row major order and no element equal to more than one of its immediate leftward or upward or right-upward antidiagonal neighbors.''. It has offset $1$ and begins
\[
5, 136, 6520, 324682, 16205218, 808928836, 40380275500, 2015711853262,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 55*a(n-1) -261*a(n-2) +369*a(n-3) -162*a(n-4) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 07 2018 08:51:31, revision 9) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208867.
