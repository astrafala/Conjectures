...
\title{The empirical column recurrences for the table OEIS A229460}
...
\begin{abstract}
OEIS A229460 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A229460 is ``T(n,k) = number of defective 3-colorings of an n X k 0..2 array connected horizontally and vertically with exactly one mistake and colors introduced in row-major 0..2 order.''. It has offset $1$, is
read by antidiagonals, and begins
\[
0, 1, 1, 2, 4, 2, 6, 20,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 27 2021 20:53:06, revision 8) these are still
...
The sequence is ``Number of defective 3-colorings of an n X 1 0..2 array connected horizontally and vertically with exactly one mistake and colors introduced in row-major 0..2 order.''. Its rows are the vertices of a digraph on
...
The sequence is ``Number of defective 3-colorings of an n X 2 0..2 array connected horizontally and vertically with exactly one mistake and colors introduced in row-major 0..2 order.''. Its rows are the vertices of a digraph on
...
The sequence is ``Number of defective 3-colorings of an n X 3 0..2 array connected horizontally and vertically with exactly one mistake and colors introduced in row-major 0..2 order.''. Its rows are the vertices of a digraph on
...
model reproduces $27$ published values, $77$ decimal digits in all, every one of
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A229460.
