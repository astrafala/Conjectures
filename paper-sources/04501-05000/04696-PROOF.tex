...
\title{The empirical recurrence for OEIS A268768, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A268768 counts arrays over $\{0,\dots,2\}$ subject to a condition on the array as a
...
OEIS A268768 is ``Number of n X 2 0..2 arrays with some element plus some horizontally, vertically, diagonally or antidiagonally adjacent neighbor totalling two exactly once.''. It has offset $1$ and begins
\[
3, 12, 32, 100, 248, 620, 1456, 3380,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) + 3*a(n-2) - 4*a(n-3) - 4*a(n-4) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 14 2019 09:04:39, revision 7) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268768.
