...
\title{The empirical recurrence for OEIS A269031, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A269031 counts arrays over $\{0,\dots,2\}$ subject to a condition on the array as a
...
OEIS A269031 is ``Number of n X 4 0..2 arrays with some element plus some horizontally, diagonally or antidiagonally adjacent neighbor totalling two exactly once.''. It has offset $1$ and begins
\[
36, 216, 2166, 18384, 146064, 1114848, 8277072, 60218112,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 14*a(n-1) - 57*a(n-2) + 56*a(n-3) - 16*a(n-4) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 18 2019 09:58:05, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269031.
