...
\title{The empirical recurrence for OEIS A235673, proved by transfer matrix}
...
\begin{abstract}
OEIS A235673 counts arrays of width $3$ over $\{0,1\}$ by reducing every $2\times2$ subblock to a
...
about it is one bit per adjacent pair of columns, so the count is a walk count on $S=25$
states.
\end{abstract}
...
OEIS A235673 is ``Number of (n+1) X (2+1) 0..1 arrays with the difference between each 2 X 2 subblock maximum and minimum lexicographically nondecreasing columnwise and nonincreasing rowwise.''. It has offset $1$ and begins
\[
58, 380, 2456, 15790, 101398, 650928, 4178316, 26820102,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 8*a(n-1) - 9*a(n-2) - 9*a(n-3) + 10*a(n-4) + 3*a(n-5) - 2*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 19 2018 08:08:40, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A235673.
