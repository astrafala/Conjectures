...
\title{The empirical recurrence for OEIS A252619, proved by transfer matrix}
...
\begin{abstract}
OEIS A252619 counts $6\times(n+2)$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
$a(n)$ is a walk count on $S=176665$ vertices. Such a sequence is $C$-finite, so whether a given
...
OEIS A252619 is ``Number of (4+2)X(n+2) 0..3 arrays with every 3X3 subblock row and diagonal sum equal to 0 3 5 6 or 8 and every 3X3 column and antidiagonal sum not equal to 0 3 5 6 or 8.''. It has offset $1$ and begins
\[
1635, 5304, 15119, 43595, 147592, 433665, 1358948, 4510703,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:27:33, revision 6) this is still
...
$\{0,\dots,3\}^{6}$. A $3\times3$ subblock occupies three consecutive columns and
...
\[
\text{every row, diagonal sum} \in \{0,3,5,6,8\}\ \text{ and }\ \text{every column, antidiagonal sum} \notin \{0,3,5,6,8\}
\]
...
$(3+1)^{2\cdot6}=16777216$, and put an edge $(r,s)\to(s,t)$ exactly when the condition
...
\begin{theorem}
\[
a(n)\;=\;87\,a(n-3) - 2807\,a(n-6) + 43901\,a(n-9) - 398524\,a(n-12) + 2360470\,a(n-15) - 9915211\,a(n-18) + 31252617\,a(n-21) - 75900949\,a(n-24) + 141692395\,a(n-27) - 198619746\,a(n-30) + 202498624\,a(n-33) - 145833984\,a(n-36) + 72479094\,a(n-39) - 24333174\,a(n-42) + 5351052\,a(n-45) - 726164\,a(n-48) + 53920\,a(n-51) - 1600\,a(n-54)
\]
for every $n>58$.
\end{theorem}
...
exactly. Those integers vanish from the index corresponding to $n=58+1$ onwards, and the
run was continued until the working vector was identically zero, which settles all larger $j$
at once. By Lemma~\ref{lem:crit} the recurrence holds for every $n>58$.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252619.
