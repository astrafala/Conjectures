...
\title{The empirical closed form for OEIS A224136, proved}
...
\begin{abstract}
OEIS A224136 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A224136 is ``Number of 5 X n 0..1 arrays with rows nondecreasing and antidiagonals unimodal.''. It has offset $1$ and begins
\[
32, 243, 748, 1635, 3149, 5648, 9577, 15505,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (2/15)*n\^{}5 + (7/6)*n\^{}4 + (47/6)*n\^{}3 + (173/6)*n\^{}2 + (1981/30)*n - 27 for n>3.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 27 2018 08:14:25, revision 9) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{2 n^{5}}{15} + \frac{7 n^{4}}{6} + \frac{47 n^{3}}{6} + \frac{173 n^{2}}{6} + \frac{1981 n}{30} - 27.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224136.
