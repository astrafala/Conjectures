...
\begin{abstract}
OEIS A283506 carries an empirical recurrence of order $3$ contributed by Colin Barker. It is true, and it is
...
\begin{quote}
Conjectures from \_Colin Barker\_, Mar 10 2017: (Start) a(n) = 2*a(n-1) + a(n-2) - 2*a(n-3) for n>3.
\end{quote}
