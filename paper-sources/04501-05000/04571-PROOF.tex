...
\title{The empirical recurrence for OEIS A286773, proved from an exact model}
...
\begin{abstract}
OEIS A286773 carries an empirical recurrence of order $3$ contributed by Colin Barker. It is true, and it is
...
OEIS A286773 is ``Decimal representation of the diagonal from the origin to the corner of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 221", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 1, 0, 7, 16, 31, 64, 127,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, May 15 2017: (Start) a(n) = 2*a(n-1) + a(n-2) - 2*a(n-3) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 05 2025 15:22:39, revision 12)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A286773.
