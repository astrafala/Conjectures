...
\title{The empirical recurrence for OEIS A284485, proved from an exact model}
...
\begin{abstract}
OEIS A284485 carries an empirical recurrence of order $3$ contributed by Colin Barker. It is true, and it is
...
OEIS A284485 is ``Decimal representation of the x-axis, from the origin to the right edge, of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 961", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 0, 7, 11, 15, 47, 63, 191,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Mar 28 2017: (Start) a(n) = a(n-1) + 4*a(n-2) - 4*a(n-3) for n>5.
\end{quote}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A284485.
