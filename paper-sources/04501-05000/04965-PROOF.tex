...
\title{The empirical recurrence for OEIS A188518, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A188518 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A188518 is ``Number of nX4 binary arrays without the pattern 1 1 0 diagonally, vertically or horizontally.''. It has offset $1$ and begins
\[
12, 144, 1016, 6760, 40230, 231400, 1286120, 7034258,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 04:29:30, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;9\,a(n-1) + 7\,a(n-2) - 232\,a(n-3) + 152\,a(n-4) + 2702\,a(n-5) - 2562\,a(n-6) - 18864\,a(n-7) + 17263\,a(n-8) + 87842\,a(n-9) - 66612\,a(n-10) - 286363\,a(n-11) + 164607\,a(n-12) + 667732\,a(n-13) - 277177\,a(n-14) - 1122752\,a(n-15) + 334441\,a(n-16) + 1363415\,a(n-17) - 302523\,a(n-18) - 1192472\,a(n-19) + 209490\,a(n-20) + 745650\,a(n-21) - 106632\,a(n-22) - 328873\,a(n-23) + 33984\,a(n-24) + 100190\,a(n-25) - 2647\,a(n-26) - 20521\,a(n-27) - 2920\,a(n-28) + 2784\,a(n-29) + 1384\,a(n-30) - 267\,a(n-31) - 280\,a(n-32) + 21\,a(n-33) + 27\,a(n-34) - a(n-35) - a(n-36)
\end{equation}
for all $n>37$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A188518.
