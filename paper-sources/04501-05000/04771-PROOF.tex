...
\title{The empirical recurrence for OEIS A208638, proved by transfer matrix}
...
\begin{abstract}
OEIS A208638 counts $3\times n$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A208638 is ``Number of 3 X n 0..1 arrays with new values 0..1 introduced in row major order and no element equal to more than one of its immediate leftward or upward or right-upward antidiagonal neighbors.''. It has offset $1$ and begins
\[
4, 13, 32, 71, 150, 309, 628, 1267,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) - 5*a(n-2) + 2*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 26 2021 14:10:47, revision 40) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208638.
