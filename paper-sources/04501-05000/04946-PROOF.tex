...
\title{The empirical recurrence for OEIS A196649, proved by transfer matrix}
...
\begin{abstract}
OEIS A196649 counts $n\times4$ arrays over $\{0,\dots,4\}$ subject to a condition imposed on
...
walk, and $a(n)$ is a walk count on $S=1552$ vertices, which is $C$-finite. Whether the
...
OEIS A196649 is ``Number of nX4 0..4 arrays with each element x equal to the number its horizontal and vertical neighbors equal to 3,4,0,2,1 for x=0,1,2,3,4.''. It has offset $1$ and begins
\[
3, 23, 76, 391, 1895, 8118, 37661, 172339,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 06:39:59, revision 9) this is still
...
settled by the terminal weight, which evaluates it with $\varnothing$ below. Most of those pairs are indistinguishable, and exactly so. Every offset named above has $|dj|\le 1$, so whether the cell at column $j$ of the middle row is satisfied depends on the three rows only through their windows at $j-1,j,j+1$. Collect for each $j$ the indicator over the window of the row below, and call that tuple $P(r,s)$: the number of cells any $t$ violates is read off $P$, so is the number violated at the bottom edge, and the successor $(s,t)$ carries $P(s,t)$, which does not mention $r$. Hence two pairs $(r,s)$ and $(r',s)$ with the same $P$ have the same outgoing rows and the same successors, and the vertex is $(s,P)$. That leaves $S=1552$ vertices in place of $390625$. Hence,
with $M$ the adjacency matrix on $S=1552$ vertices, $\iota$ the starting vector and $\tau$ the
terminal weight,
\[
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 4\,a(n-2) + 15\,a(n-3) + 49\,a(n-4) + 153\,a(n-5) + 219\,a(n-6) + 248\,a(n-7) + 189\,a(n-8) - 221\,a(n-9) - 683\,a(n-10) - 1258\,a(n-11) - 1587\,a(n-12) - 1789\,a(n-13) - 1966\,a(n-14) - 1966\,a(n-15) - 2193\,a(n-16) - 2166\,a(n-17) - 1860\,a(n-18) - 1625\,a(n-19) - 1338\,a(n-20) - 926\,a(n-21) - 354\,a(n-22) + 109\,a(n-23) + 327\,a(n-24) + 485\,a(n-25) + 372\,a(n-26) + 164\,a(n-27) + 17\,a(n-28) + 11\,a(n-29) + 21\,a(n-30) - 7\,a(n-31) - 12\,a(n-32) - 3\,a(n-33) + 2\,a(n-34)
\]
for every $n>34$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A196649.
