...
\title{The empirical recurrence for OEIS A206391, proved by transfer matrix}
...
\begin{abstract}
OEIS A206391 counts arrays in which no entry may equal the entries at a short list of fixed offsets
...
$2$ consecutive rows, $S=3120$ states in all.
\end{abstract}
...
OEIS A206391 is ``Number of n X 3 0..5 arrays with no element equal to another within a city block distance of two, and new values 0..5 introduced in row major order.''. It has offset $1$ and begins
\[
1, 4, 26, 206, 1592, 12428, 96632, 752552,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 6*a(n-1) + 18*a(n-2) - 32*a(n-3) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 16 2018 13:44:28, revision 12) this is still
...
\[
x(i,j)\ \ne\ x(i+d_1,\,j+d_2)\qquad\text{for each offset }(d_1,d_2)\in\{(-2,0), (-1,-1), (-1,0), (-1,1), (0,-2), (0,-1), (0,1), (0,2), (1,-1), (1,0), (1,1), (2,0)\}
\]
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=3120.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206391.
