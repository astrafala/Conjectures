...
\title{The empirical recurrence for OEIS A189444, proved by transfer matrix}
...
\begin{abstract}
OEIS A189444 counts the permutations of the cells of an $n\times4$ array in which every cell
...
That makes $a$ a walk count on $S=45$ states, hence $C$-finite, and whether the published
...
OEIS A189444 is ``Number of n X 4 array permutations with each element moving zero or one space horizontally or diagonally.''. It has offset $1$ and begins
\[
5, 61, 666, 7300, 80282, 883049, 9712873, 106834338,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 12*a(n-1) -12*a(n-2) +12*a(n-3) -12*a(n-4) +a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (May 02 2018 08:49:16, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;12\,a(n-1) - 12\,a(n-2) + 12\,a(n-3) - 12\,a(n-4) + a(n-5)
\]
for every $n>5$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A189444.
