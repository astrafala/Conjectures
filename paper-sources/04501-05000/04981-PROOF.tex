...
\end{equation}
for all $n>71$. The entry's array has a fixed number of rows and a growing number of
...
index corresponding to $n=71+1$ onwards, and the run was continued past $S$ consecutive
