...
\title{The empirical recurrence for OEIS A269030, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A269030 counts arrays over $\{0,\dots,2\}$ subject to a condition on the array as a
...
OEIS A269030 is ``Number of n X 3 0..2 arrays with some element plus some horizontally, diagonally or antidiagonally adjacent neighbor totalling two exactly once.''. It has offset $1$ and begins
\[
12, 48, 348, 2136, 12228, 67104, 357756, 1867560,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 10*a(n-1) - 29*a(n-2) + 20*a(n-3) - 4*a(n-4) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 18 2019 09:58:15, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269030.
