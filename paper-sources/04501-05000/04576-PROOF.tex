...
\title{The empirical column recurrences for the table OEIS A251491}
...
\begin{abstract}
OEIS A251491 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A251491 is ``T(n,k)=Number of (n+1)X(k+1) 0..3 arrays with no 2X2 subblock having the sum of its diagonal elements less than the minimum of its antidiagonal elements.''. It has offset $1$, is
read by antidiagonals, and begins
\[
236, 3456, 3456, 50576, 186304, 50576, 740096, 10046784,\ \dots
\]
The entry carries the following block:
\begin{quote}\small
Empirical for column k:\\
k=1: a(n) = 16*a(n-1) -20*a(n-2)\\
k=2: [order 7]\\
k=3: [order 16]\\
k=4: [order 48]\\
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:26:02, revision 6) these are still
...
The sequence is ``Number of (n+1)X(2) 0..3 arrays with no 2X2 subblock having the sum of its diagonal elements less than the minimum of its antidiagonal elements.''. Its rows are the vertices of a digraph on
...
$c_{1}$ & $64$ & $c_{3}$ & $704$ & $c_{5}$ & $-3968$ & $c_{7}$ & $1152$ \\
$c_{2}$ & $-556$ & $c_{4}$ & $-356$ & $c_{6}$ & $36$ &  &  \\
...
\begin{center}\small\begin{tabular}{cccccccc}
$c_{1}$ & $256$ & $c_{5}$ & $-999872$ & $c_{9}$ & $5238219360$ & $c_{13}$ & $34500091392$ \\
$c_{2}$ & $-12199$ & $c_{6}$ & $26782853$ & $c_{10}$ & $12853712360$ & $c_{14}$ & $70834593600$ \\
$c_{3}$ & $163792$ & $c_{7}$ & $-398145776$ & $c_{11}$ & $-27723613504$ & $c_{15}$ & $-41937979392$ \\
$c_{4}$ & $-450614$ & $c_{8}$ & $-1637661603$ & $c_{12}$ & $-38172377104$ & $c_{16}$ & $11349974016$ \\
\end{tabular}\end{center}
...
model reproduces $7$ published values, $45$ decimal digits in all, every one of
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251491.
