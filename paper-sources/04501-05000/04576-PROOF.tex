...
\title{The empirical recurrence for OEIS A277936, proved from an exact model}
...
\begin{abstract}
OEIS A277936 carries an empirical recurrence of order $4$ contributed by Colin Barker. It is true, and it is
...
\[
1, 3, 0, 15, 0, 63, 0, 255,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Nov 06 2016: (Start) a(n) = 5*a(n-2)-4*a(n-4) for n>4.
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 05 2025 15:22:35, revision 34)
...
\[
C(n+2)\;=\;C(n)\qquad\text{as configurations of the whole plane, for every } n\ge 1.
\]
...
neighbourhood to a live cell flips the ENTIRE plane, and rule 7 is read
