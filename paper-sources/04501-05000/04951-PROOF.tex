...
$S=162$ vertices, so it satisfies a monic recurrence of order at most $S$;
Berlekamp--Massey on $2S=324$ exact terms returns the minimal one, of order
$10$ --- the stated order --- with integer coefficients
\begin{center}\small\begin{tabular}{cccccccc}
$c_{1}$ & $6$ & $c_{4}$ & $-51$ & $c_{7}$ & $37$ & $c_{10}$ & $4$ \\
$c_{2}$ & $32$ & $c_{5}$ & $-43$ & $c_{8}$ & $-5$ &  &  \\
$c_{3}$ & $8$ & $c_{6}$ & $-5$ & $c_{9}$ & $-2$ &  &  \\
