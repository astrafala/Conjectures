...
\title{The empirical recurrence for OEIS A268966, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A268966 counts arrays over $\{0,\dots,2\}$ subject to a condition on the array as a
...
OEIS A268966 is ``Number of n X 3 0..2 arrays with some element plus some horizontally or antidiagonally adjacent neighbor totalling two not more than once.''. It has offset $1$ and begins
\[
24, 240, 2016, 15552, 114048, 808704, 5598720, 38071296,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 12*a(n-1) - 36*a(n-2).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 17 2019 09:20:23, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268966.
