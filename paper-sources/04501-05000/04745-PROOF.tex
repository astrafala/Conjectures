...
\title{The empirical recurrence for OEIS A184606, proved by transfer matrix}
...
\begin{abstract}
OEIS A184606 counts arrays over $\{0,\dots,1\}$ under a condition comparing a statistic of
...
OEIS A184606 is ``Half the number of (n+1) X 2 binary arrays with no 2 X 2 subblock sum differing from a horizontal or vertical neighbor subblock sum by more than one.''. It has offset $1$ and begins
\[
8, 28, 98, 350, 1250, 4450, 15842, 56426,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) + 6*a(n-3) + 4*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 14 2018 07:33:45, revision 11) this is still
...
$8$, which the model reproduces along with every later term, and that is the cheapest
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A184606.
