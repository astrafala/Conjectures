...
\title{The empirical recurrence for OEIS A268776, proved by transfer matrix}
...
\begin{abstract}
OEIS A268776 counts arrays of width $3$ over $\{0,1\}$ in which the number of adjacent PAIRS of
...
result is a walk count on $S=21$ states.
\end{abstract}
...
OEIS A268776 is ``Number of n X 3 binary arrays with some element plus some horizontally, vertically, diagonally or antidiagonally adjacent neighbor totalling two no more than once.''. It has offset $1$ and begins
\[
7, 26, 91, 316, 1031, 3354, 10615, 33344,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) + 2*a(n-2) - 16*a(n-3) - a(n-4) + 12*a(n-5) - 4*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 15 2019 09:10:26, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The array has $3$ cells across, with entries in $\{0,1\}$. An ADJACENT PAIR is a pair of cells
\[
\begin{array}{l}
$(i,j)\text{ and }(i,j{+}1)$ \\
$(i,j)\text{ and }(i{+}1,j)$ \\
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268776.
