...
\title{The empirical recurrence for OEIS A278757, proved from an exact model}
...
\begin{abstract}
OEIS A278757 carries an empirical recurrence of order $4$ contributed by Chai Wah Wu. It is true, and it is
...
OEIS A278757 is ``Binary representation of the x-axis, from the left edge to the origin, of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 73", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 0, 11, 1010, 0, 111111, 0, 11111111,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Chai Wah Wu\_, Jun 14 2020: (Start) a(n) = 101*a(n-2) - 100*a(n-4) for n > 7.
\end{quote}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A278757.
