...
\title{The empirical recurrence for OEIS A283649, proved from an exact model}
...
\begin{abstract}
OEIS A283649 carries an empirical recurrence of order $3$ contributed by Colin Barker. It is true, and it is
...
OEIS A283649 is ``Binary representation of the x-axis, from the origin to the right edge, of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 705", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 0, 111, 1011, 111, 101111, 11111, 10111111,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Mar 14 2017: (Start) a(n) = a(n-1) + 100*a(n-2) - 100*a(n-3) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 05 2025 15:22:38, revision 11)
...
neighbourhood to a live cell flips the ENTIRE plane, and rule 705 is read
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A283649.
