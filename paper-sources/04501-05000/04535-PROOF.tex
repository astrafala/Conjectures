...
\title{The empirical recurrence for OEIS A232251, proved by transfer matrix}
...
\begin{abstract}
OEIS A232251 counts arrays of width $3$ over $\{0,1,2\}$ in which every cell has a neighbour at least as large and one at most as large. The entry carries an
...
OEIS A232251 is ``Number of (n+1) X (2+1) 0..2 arrays with every element both >= and <= some horizontal or antidiagonal neighbor.''. It has offset $1$ and begins
\[
37, 421, 4711, 52779, 591181, 6622029, 74175439, 830862931,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 10*a(n-1) + 14*a(n-2) - 6*a(n-3) - a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2018 13:57:45, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232251.
