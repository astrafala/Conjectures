...
\title{The empirical recurrence for OEIS A290837, proved from an exact model}
...
\begin{abstract}
OEIS A290837 carries an empirical recurrence of order $2$ contributed by Colin Barker. It is true, and it is
...
OEIS A290837 is ``Decimal representation of the diagonal from the origin to the corner of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 969", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 1, 5, 15, 7, 63, 127, 255,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Aug 12 2017: (Start) a(n) = 3*a(n-1) - 2*a(n-2) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 05 2025 15:22:41, revision 12)
...
\[
C(n+1)\;=\;C(n)\qquad\text{as configurations of the whole plane, for every } n\ge 5.
\]
...
neighbourhood to a live cell flips the ENTIRE plane, and rule 969 is read
...
vanish from $n=6+1$ onwards, and the run exceeds $S+2$, which by
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A290837.
