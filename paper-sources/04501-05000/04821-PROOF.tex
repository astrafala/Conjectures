...
\title{The empirical recurrence for OEIS A269286, proved by transfer matrix}
...
\begin{abstract}
OEIS A269286 counts arrays of width $5$ over $\{0,1,2,3\}$ in which the number of adjacent PAIRS of
...
OEIS A269286 is ``Number of n X 5 0..3 arrays with some element plus some horizontally or antidiagonally adjacent neighbor totalling three no more than once.''. It has offset $1$ and begins
\[
756, 164556, 27788292, 4204943820, 598478857956, 81907569617580, 10908770041709316, 1424067311317705740,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 234*a(n-1) - 14277*a(n-2) + 68796*a(n-3) - 86436*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 21 2019 10:07:04, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269286.
