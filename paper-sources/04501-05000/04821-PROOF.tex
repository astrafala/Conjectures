...
\title{The empirical recurrence for OEIS A268990, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A268990 counts arrays over $\{0,\dots,1\}$ subject to a condition on the array as a
...
OEIS A268990 is ``Number of n X 3 binary arrays with some element plus some horizontally or antidiagonally adjacent neighbor totalling two not more than once.''. It has offset $1$ and begins
\[
7, 35, 174, 849, 4083, 19416, 91491, 427863,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 10*a(n-1) - 31*a(n-2) + 30*a(n-3) - 9*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 17 2019 17:20:44, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268990.
