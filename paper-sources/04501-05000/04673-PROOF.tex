...
\title{The empirical recurrence for OEIS A260926, proved by transfer matrix}
...
\begin{abstract}
OEIS A260926 counts $(n+2)\times9$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A260926 is ``Number of (n+2) X (7+2) 0..1 arrays with each 3 X 3 subblock having clockwise perimeter pattern 00010101 00101011 or 01010101.''. It has offset $1$ and begins
\[
883, 1528, 7680, 25690, 82766, 253264, 971381, 2901724,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 03 2022 20:57:48, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-2) + 91\,a(n-4) + 334\,a(n-6) - 779\,a(n-8) - 3685\,a(n-10) + 7226\,a(n-12) + 20922\,a(n-14) - 62627\,a(n-16) - 27148\,a(n-18) + 249596\,a(n-20) - 142965\,a(n-22) - 601602\,a(n-24) + 1185157\,a(n-26) - 586527\,a(n-28) - 552103\,a(n-30) + 736485\,a(n-32) - 49406\,a(n-34) - 272061\,a(n-36) + 63499\,a(n-38) + 50155\,a(n-40) - 1001\,a(n-42) - 4198\,a(n-44) - 4416\,a(n-46) - 1042\,a(n-48) - 51\,a(n-50) - 100\,a(n-52) - 10\,a(n-54)
\]
for every $n>59$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A260926.
