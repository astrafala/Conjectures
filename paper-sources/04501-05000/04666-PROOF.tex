...
\title{The empirical column recurrences for the table OEIS A234665}
...
\begin{abstract}
OEIS A234665 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A234665 is ``T(n,k) is the number of (n+1) X (k+1) 0..6 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 4 (constant-stress 1 X 1 tilings).''. It has offset $1$, is
read by antidiagonals, and begins
\[
298, 1820, 1820, 11112, 9774, 11112, 68086, 52646,\ \dots
\]
The entry carries the following block:
\begin{quote}\small
Empirical for column k:\\
k=1: a(n) = 11*a(n-1) +17*a(n-2) -492*a(n-3) +1050*a(n-4) +1260*a(n-5).\\
k=2: [order 16].\\
k=3: [order 39].\\
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 20 2022 20:55:23, revision 6) these are still
...
The sequence is ``Number of (n+1) X (2) 0..6 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 4 (constant-stress 1 X 1 tilings).''. Its rows are the vertices of a digraph on
...
$c_{1}$ & $24$ & $c_{5}$ & $-7512$ & $c_{9}$ & $-40315144$ & $c_{13}$ & $-263116800$ \\
$c_{2}$ & $-116$ & $c_{6}$ & $-599532$ & $c_{10}$ & $38576320$ & $c_{14}$ & $8496000$ \\
$c_{3}$ & $-1573$ & $c_{7}$ & $2201681$ & $c_{11}$ & $130316460$ & $c_{15}$ & $134568000$ \\
$c_{4}$ & $17655$ & $c_{8}$ & $4899218$ & $c_{12}$ & $-132305400$ & $c_{16}$ & $45360000$ \\
...
model reproduces $8$ published values, $46$ decimal digits in all, every one of
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234665.
