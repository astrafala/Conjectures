...
\title{The conjectured generating function for OEIS A250773, proved}
...
\begin{abstract}
OEIS A250773 counts arrays of a fixed width under a local condition, and carries a conjectured
...
OEIS A250773 is ``Number of (5+1) X (n+1) 0..1 arrays with nondecreasing x(i,j)-x(i,j-1) in the i direction and nondecreasing absolute value of x(i,j)-x(i-1,j) in the j direction.''. It has offset $1$ and begins
\[
144, 258, 418, 648, 996, 1558,\ \dots
\]
The entry states, as a conjecture contributed by a reader and never marked settled:
\begin{quote}
Empirical g.f.: 2*x*(72 - 231*x + 212*x\^{}2 - 64*x\^{}3) / ((1 - x)\^{}3*(1 - 2*x)). - \_Colin Barker\_, Nov 19 2018
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 19 2018 07:19:07, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250773.
