...
\title{The empirical recurrence for OEIS A290681, proved from an exact model}
...
\begin{abstract}
OEIS A290681 carries an empirical recurrence of order $2$ contributed by Colin Barker. It is true, and it is
...
\[
1, 1, 111, 111, 11111, 111111, 1111111, 11111111,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Aug 09 2017: (Start) a(n) = 11*a(n-1) - 10*a(n-2) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 05 2025 15:22:40, revision 11)
