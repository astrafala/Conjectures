...
\title{The empirical recurrence for OEIS A208170, proved by counting patterns}
...
\begin{abstract}
OEIS A208170 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A208170 is ``Number of n X 3 0..3 arrays with new values 0..3 introduced in row major order and no element equal to more than one of its immediate leftward or upward neighbors.''. It has offset $1$ and begins
\[
5, 159, 8469, 473928, 26625693, 1496307201, 84091222866, 4725865313907,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 62*a(n-1) - 333*a(n-2) + 396*a(n-3) - 135*a(n-4) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 29 2018 06:03:00, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208170.
