...
\title{The empirical recurrence for OEIS A268996, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A268996 counts arrays over $\{0,\dots,1\}$ subject to a condition on the array as a
...
OEIS A268996 is ``Number of 2 X n binary arrays with some element plus some horizontally or antidiagonally adjacent neighbor totalling two not more than once.''. It has offset $1$ and begins
\[
4, 13, 35, 103, 278, 763, 2037, 5421,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) + 5*a(n-2) - 4*a(n-3) - 11*a(n-4) - 6*a(n-5) - a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 18 2019 06:33:02, revision 7) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 5\,a(n-2) - 4\,a(n-3) - 11\,a(n-4) - 6\,a(n-5) - a(n-6)
\end{equation}
for all $n>6$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268996.
