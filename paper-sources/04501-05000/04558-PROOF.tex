...
\title{The conjectured generating function for OEIS A280412, proved}
...
\begin{abstract}
OEIS A280412 counts arrays of a fixed width under a local condition, and carries a conjectured
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 05 2025 15:22:36, revision 14) this is still
