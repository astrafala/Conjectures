...
\title{The empirical recurrence for OEIS A284351, proved from an exact model}
...
\begin{abstract}
OEIS A284351 carries an empirical recurrence of order $3$ contributed by Colin Barker. It is true, and it is
...
OEIS A284351 is ``Binary representation of the x-axis, from the left edge to the origin, of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 899", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 1, 111, 1101, 11111, 111101, 1111111, 11111101,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Mar 26 2017: (Start) a(n) = 10*a(n-1) + a(n-2) - 10*a(n-3) for n>2.
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 05 2025 15:22:38, revision 13)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A284351.
