...
\title{The empirical recurrence for OEIS A222867, proved by transfer matrix}
...
\begin{abstract}
OEIS A222867 counts arrays in which no entry may equal the entries at a short list of fixed offsets
...
$2$ consecutive rows, $S=118$ states in all.
\end{abstract}
...
OEIS A222867 is ``Number of n X 1 0..5 arrays with no element equal to another at a city block distance of exactly two, and new values 0..5 introduced in row major order.''. It has offset $1$ and begins
\[
1, 2, 3, 7, 20, 67, 254, 1057,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 11*a(n-1) - 41*a(n-2) + 61*a(n-3) - 30*a(n-4) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 16 2018 08:59:21, revision 9) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=118.
\]
...
\begin{theorem}
\[
a(n)\;=\;11\,a(n-1) - 41\,a(n-2) + 61\,a(n-3) - 30\,a(n-4)
\]
for every $n>6$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A222867.
