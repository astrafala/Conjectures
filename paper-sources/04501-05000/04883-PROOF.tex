...
\title{The empirical recurrence for OEIS A228257, proved by transfer matrix}
...
\begin{abstract}
OEIS A228257 carries an empirical recurrence of order $2$ contributed by R. H. Hardin. It is
...
arrays counted are exactly the walks in it; hence $a(n)$ is a walk count on $S=967$ vertices
...
OEIS A228257 is ``Number of third differences of arrays of length n+3 of numbers in 0..5.''. It has offset $1$ and begins
\[
41, 881, 12947, 141989, 1161855, 8003363, 50554951, 313882531,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 11*a(n-1) -30*a(n-2) for n>10
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 04 2025 00:01:19, revision 8) this is still
...
An admissible array is then exactly a walk, and $\iota,\tau$ are the vectors recording which windows may begin and end an array, so with $M$ the adjacency matrix on $S=967$ vertices,
\[
a(n)\;=\;\iota^{\!\top}M^{\,n}\tau ,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A228257.
