...
\title{The empirical column recurrences for the table OEIS A316740}
...
\begin{abstract}
OEIS A316740 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A316740 is ``T(n,k) = Number of n X k 0..1 arrays with every element unequal to 1, 2, 3, 6, 7 or 8 king-move adjacent elements, with upper left element zero.''. It has offset $1$, is
read by antidiagonals, and begins
\[
0, 1, 1, 1, 7, 1, 2, 14,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 21 2021 13:43:15, revision 6) these are still
...
The sequence is ``Number of n X 2 0..1 arrays with every element unequal to 1, 2, 3, 6, 7 or 8 king-move adjacent elements, with upper left element zero.''. Its rows are the vertices of a digraph on
...
model reproduces $10$ published values, $25$ decimal digits in all, every one of
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A316740.
