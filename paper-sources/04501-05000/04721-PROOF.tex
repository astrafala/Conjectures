...
\title{The empirical column recurrences for the table OEIS A326165}
...
\begin{abstract}
OEIS A326165 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A326165 is ``T(n,k) = Number of n X k 0..1 arrays with every element unequal to 0, 1, 3, 4 or 5 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$, is
read by antidiagonals, and begins
\[
1, 2, 2, 3, 3, 3, 5, 6,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 19 2022 18:34:25, revision 6) these are still
...
The sequence is ``Number of n X 1 0..1 arrays with every element unequal to 0, 1, 3, 4 or 5 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. Its rows are the vertices of a digraph on
...
The sequence is ``Number of n X 2 0..1 arrays with every element unequal to 0, 1, 3, 4 or 5 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. Its rows are the vertices of a digraph on
...
model reproduces $21$ published values, $38$ decimal digits in all, every one of
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A326165.
