...
\title{The empirical recurrence for OEIS A252568, proved by transfer matrix}
...
\begin{abstract}
OEIS A252568 counts $(n+2)\times4$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252568 is ``Number of (n+2)X(2+2) 0..3 arrays with every 3X3 subblock row and diagonal sum equal to 1 2 5 6 or 7 and every 3X3 column and antidiagonal sum not equal to 1 2 5 6 or 7.''. It has offset $1$ and begins
\[
843, 868, 1558, 3286, 7610, 17261, 39419, 94224,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:23:10, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252568.
