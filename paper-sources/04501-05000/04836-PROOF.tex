...
\title{The empirical recurrence for OEIS A269897, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A269897 counts arrays over $\{0,\dots,6\}$ subject to a condition on the array as a
...
OEIS A269897 is ``Number of n X 3 0..6 arrays with some element plus some horizontally or vertically adjacent neighbor totalling six exactly once.''. It has offset $1$ and begins
\[
84, 45360, 12377400, 2801265390, 579818225700, 113873466835170, 21603218450171400, 3998999827651729950,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 330*a(n-1) - 28773*a(n-2) + 255420*a(n-3) - 599076*a(n-4) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 29 2019 15:06:58, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269897.
