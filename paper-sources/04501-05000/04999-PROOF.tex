...
\title{The empirical recurrence for OEIS A274896, proved by counting patterns}
...
\begin{abstract}
OEIS A274896 counts arrays in which no entry may repeat a value found at any of three stated
...
OEIS A274896 is ``Number of 4 X n 0..2 arrays with no element equal to any value at offset (0,-1) (-1,-1) or (-2,0) and new values introduced in order 0..2.''. It has offset $1$ and begins
\[
6, 14, 38, 104, 290, 815, 2291, 6434,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 5*a(n-1) - 9*a(n-2) + 10*a(n-3) - 6*a(n-4) + a(n-5) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 31 2019 09:22:07, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A274896.
