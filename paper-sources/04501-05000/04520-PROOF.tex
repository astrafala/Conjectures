...
\title{The empirical recurrence for OEIS A269083, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A269083 counts arrays over $\{0,\dots,1\}$ subject to a condition on the array as a
...
OEIS A269083 is ``Number of n X 2 binary arrays with some element plus some horizontally, vertically or antidiagonally adjacent neighbor totalling two not more than once.''. It has offset $1$ and begins
\[
4, 11, 30, 76, 191, 467, 1127, 2686,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) + 3*a(n-2) - 2*a(n-3) - 6*a(n-4) - 4*a(n-5) - a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 19 2019 03:15:05, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269083.
