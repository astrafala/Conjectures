...
\title{The empirical recurrence for OEIS A269007, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A269007 counts arrays over $\{0,\dots,1\}$ subject to a condition on the array as a
...
OEIS A269007 is ``Number of n X 4 binary arrays with some element plus some horizontally, diagonally or antidiagonally adjacent neighbor totalling two exactly once.''. It has offset $1$ and begins
\[
5, 36, 305, 2136, 14240, 91048, 566656, 3456320,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 12*a(n-1) - 40*a(n-2) + 8*a(n-3) + 92*a(n-4) - 32*a(n-5) - 64*a(n-6) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 18 2019 06:33:16, revision 7) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;12\,a(n-1) - 40\,a(n-2) + 8\,a(n-3) + 92\,a(n-4) - 32\,a(n-5) - 64\,a(n-6)
\end{equation}
for all $n>7$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269007.
