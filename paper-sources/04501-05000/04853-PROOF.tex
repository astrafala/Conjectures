...
\title{The empirical recurrence for OEIS A274750, proved by counting patterns}
...
\begin{abstract}
OEIS A274750 counts arrays in which no entry may repeat a value found at any of three stated
...
cutting $794$ pairs to $S=155$ states. The entry's empirical recurrence of order $4$,
...
OEIS A274750 is ``Number of 3 X n 0..2 arrays with no element equal to any value at offset (-1,-2) (0,-1) or (-1,0) and new values introduced in order 0..2.''. It has offset $1$ and begins
\[
2, 9, 34, 133, 518, 2017, 7858, 30605,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) + 7*a(n-2) + 2*a(n-3) - 2*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 31 2019 02:12:33, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 7\,a(n-2) + 2\,a(n-3) - 2\,a(n-4)
\end{equation}
for all $n>5$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A274750.
