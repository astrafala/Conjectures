...
\title{The empirical recurrence for OEIS A268989, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A268989 counts arrays over $\{0,\dots,1\}$ subject to a condition on the array as a
...
OEIS A268989 is ``Number of n X 2 binary arrays with some element plus some horizontally or antidiagonally adjacent neighbor totalling two not more than once.''. It has offset $1$ and begins
\[
4, 13, 41, 126, 379, 1121, 3272, 9449,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 6*a(n-1) - 11*a(n-2) + 6*a(n-3) - a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 17 2019 17:20:39, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268989.
