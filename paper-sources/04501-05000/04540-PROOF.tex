...
\title{The empirical recurrence for OEIS A228216, proved by transfer matrix}
...
\begin{abstract}
OEIS A228216 carries an empirical recurrence of order $2$ contributed by R. H. Hardin. It is
...
arrays counted are exactly the walks in it; hence $a(n)$ is a walk count on $S=223$ vertices
...
OEIS A228216 is ``Number of second differences of arrays of length n+2 of numbers in 0..6.''. It has offset $1$ and begins
\[
25, 385, 4651, 47953, 439927, 3693505, 29066311, 219071473,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 13*a(n-1) - 42*a(n-2) for n>13.
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 26 2025 03:56:21, revision 13) this is still
...
admissible array is then exactly a walk, so with $M$ the adjacency matrix on $S=223$ vertices
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A228216.
