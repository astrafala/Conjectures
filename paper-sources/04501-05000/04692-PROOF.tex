...
\title{The empirical recurrence for OEIS A280410, proved from an exact model}
...
\begin{abstract}
OEIS A280410 carries an empirical recurrence of order $4$ contributed by Colin Barker. It is true, and it is
...
\[
1, 10, 1, 1110, 1, 111110, 1, 11111110,\ \dots
\]
