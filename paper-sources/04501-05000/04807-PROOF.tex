...
\title{The empirical column recurrences for the table OEIS A298133}
...
\begin{abstract}
OEIS A298133 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A298133 is ``T(n,k) is the number of n X k 0..1 arrays with every element equal to 2, 3, 4 or 7 king-move adjacent elements, with upper left element zero.''. It has offset $1$, is
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 31 2026 07:58:54, revision 6) these are still
...
The sequence is ``Number of n X 1 0..1 arrays with every element equal to 2, 3, 4 or 7 king-move adjacent elements, with upper left element zero.''. Its rows are the vertices of a digraph on
...
The sequence is ``Number of n X 2 0..1 arrays with every element equal to 2, 3, 4 or 7 king-move adjacent elements, with upper left element zero.''. Its rows are the vertices of a digraph on
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A298133.
