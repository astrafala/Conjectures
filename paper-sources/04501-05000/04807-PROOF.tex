...
\title{The empirical recurrence for OEIS A268744, proved by transfer matrix}
...
\begin{abstract}
OEIS A268744 counts arrays of width $2$ over $\{0,1\}$ in which the number of adjacent PAIRS of
...
OEIS A268744 is ``Number of n X 2 binary arrays with some element plus some horizontally or vertically adjacent neighbor totalling two no more than once.''. It has offset $1$ and begins
\[
4, 11, 32, 89, 244, 659, 1760, 4657,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) - 2*a(n-2) - 4*a(n-3) - a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 21 2018 11:38:43, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268744.
