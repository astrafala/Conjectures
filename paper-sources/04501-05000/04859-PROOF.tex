...
\title{The empirical recurrence for OEIS A303884, proved by transfer matrix}
...
\begin{abstract}
OEIS A303884 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $different from$ itself lying in $\{0,2,3,4\}$, and it carries an empirical
...
OEIS A303884 is ``Number of nX4 0..1 arrays with every element unequal to 0, 2, 3 or 4 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 24, 36, 166, 487, 2130, 7433, 30191,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 02 2018 07:53:18, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) + 9\,a(n-2) - 64\,a(n-3) - 24\,a(n-4) + 324\,a(n-5) + 29\,a(n-6) - 908\,a(n-7) - 26\,a(n-8) + 1535\,a(n-9) - 63\,a(n-10) - 1059\,a(n-11) - 101\,a(n-12) - 1818\,a(n-13) + 615\,a(n-14) + 8168\,a(n-15) + 1142\,a(n-16) - 16297\,a(n-17) - 9152\,a(n-18) + 17515\,a(n-19) + 18762\,a(n-20) - 6862\,a(n-21) - 11642\,a(n-22) - 8527\,a(n-23) - 8707\,a(n-24) + 6607\,a(n-25) + 24394\,a(n-26) + 7559\,a(n-27) - 25005\,a(n-28) - 7899\,a(n-29) + 7951\,a(n-30) + 8174\,a(n-31) - 4288\,a(n-32) - 1081\,a(n-33) + 1247\,a(n-34) - 846\,a(n-35) + 256\,a(n-36) + 138\,a(n-37) - 60\,a(n-38)
\end{equation}
for all $n>41$.
...
has score in $\{0,2,3,4\}$. The entry also fixes the top-left entry to be $0$; that is a condition on the first row alone, so it restricts the start vector and nothing else.
...
\begin{itemize}
\item $\mathbf{s}(r,s)=1$ when every cell of $r$ has score in $\{0,2,3,4\}$ \emph{with no row
above $r$} and $r_1=0$, and $0$ otherwise;
\item an edge $(r,s)\to(s,t)$ when every cell of $s$ has score in $\{0,2,3,4\}$ computed from
$r$, $s$ and $t$;
\item $\mathbf{e}(r,s)=1$ when every cell of $s$ has score in $\{0,2,3,4\}$ \emph{with no row
...
exactly when every one of its $n$ rows has all scores in $\{0,2,3,4\}$. Read the sequence as the
...
They vanish from the index corresponding to $n=41+1$ onwards, and the run was continued
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A303884.
