...
\title{The empirical recurrence for OEIS A214098, proved by transfer matrix}
...
\begin{abstract}
OEIS A214098 counts the proper colourings of a grid $n\times6$, wrapped in the direction of width $6$, with at most $3$ colours and
counted up to renaming the colours, and carries an empirical recurrence of order $4$
...
down to $S=68$ and makes the exact residual test affordable.
\end{abstract}
...
OEIS A214098 is ``Number of 0..2 colorings on an n X 6 array circular in the 6 direction with new values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
11, 143, 2041, 29540, 428383, 6214031, 90142852, 1307649965,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 19*a(n-1) - 71*a(n-2) + 86*a(n-3) - 24*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 22 2018 06:42:27, revision 9) this is still
...
\]
There are $(i-1)^{6}+(-1)^{6}(i-1)$ such colourings, which at $i=3$ is already more
...
state count is $S=68$ rather than the number of colourings.
...
\begin{theorem}
\[
a(n)\;=\;19\,a(n-1) - 71\,a(n-2) + 86\,a(n-3) - 24\,a(n-4)
\]
for every $n>4$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A214098.
