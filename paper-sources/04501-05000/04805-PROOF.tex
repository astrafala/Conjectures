...
\title{The conjectured generating function for OEIS A250881, proved}
...
\begin{abstract}
OEIS A250881 counts arrays of a fixed width under a local condition, and carries a conjectured
...
OEIS A250881 is ``Number of (4+1) X (n+1) 0..3 arrays with nondecreasing x(i,j)-x(i,j-1) in the i direction and nondecreasing x(i,j)+x(i-1,j) in the j direction.''. It has offset $1$ and begins
\[
8736, 30360, 73122, 144248, 250964, 400496,\ \dots
\]
The entry states, as a conjecture contributed by a reader and never marked settled:
\begin{quote}
G.f.: 2*x*(4368 - 2292*x + 2049*x\^{}2 - 512*x\^{}3) / (1 - x)\^{}4.
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 22 2018 11:33:48, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250881.
