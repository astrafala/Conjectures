...
\title{The empirical recurrence for OEIS A223944, proved by transfer matrix}
...
\begin{abstract}
OEIS A223944 counts arrays over $\{0,\dots,1\}$ whose rows, columns, diagonals or
...
is a walk count on $S=256$ vertices and the recurrence follows from a finite exact
computation.
\end{abstract}
...
OEIS A223944 is ``Number of n X 3 0..1 arrays with diagonals and antidiagonals unimodal and rows nondecreasing.''. It has offset $1$ and begins
\[
4, 16, 54, 177, 596, 2024, 6869, 23285,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 4*a(n-1) - 2*a(n-2) - a(n-3) + 5*a(n-4) - 8*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 24 2018 08:52:15, revision 8) the statement is
...
bit vector), $|\mathcal V|=S=256$; let $(r,f)\to(s,f')$ be an edge when placing $s$ after $r$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223944.
