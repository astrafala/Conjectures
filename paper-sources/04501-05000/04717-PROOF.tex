...
\title{The empirical recurrence for OEIS A224406, proved by transfer matrix}
...
\begin{abstract}
OEIS A224406 counts arrays over $\{0,\dots,1\}$ whose rows, columns, diagonals or
...
is a walk count on $S=16$ vertices and the recurrence follows from a finite exact
computation.
\end{abstract}
...
OEIS A224406 is ``Number of n X 5 0..1 arrays with rows unimodal and antidiagonals nondecreasing.''. It has offset $1$ and begins
\[
16, 101, 465, 1928, 7812, 31710, 129402, 529846,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 6*a(n-1) - 9*a(n-2) + 4*a(n-3) + 2*a(n-4) + 8*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 30 2018 06:07:47, revision 8) the statement is
...
bit vector), $|\mathcal V|=S=16$; let $(r,f)\to(s,f')$ be an edge when placing $s$ after $r$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224406.
