...
\title{The empirical recurrence for OEIS A268803, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A268803 counts arrays over $\{0,\dots,2\}$ subject to a condition on the array as a
...
OEIS A268803 is ``Number of n X 2 0..2 arrays with some element plus some horizontally, vertically or antidiagonally adjacent neighbor totalling two not more than once.''. It has offset $1$ and begins
\[
9, 34, 104, 290, 772, 1972, 4914, 12010,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) + 3*a(n-2) - 2*a(n-3) - 6*a(n-4) - 4*a(n-5) - a(n-6) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 15 2019 09:23:24, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268803.
