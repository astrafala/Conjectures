...
\title{The empirical recurrence for OEIS A269898, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A269898 counts arrays over $\{0,\dots,6\}$ subject to a condition on the array as a
...
which is what keeps the digraph sparse. That makes $a(n)$ a walk count on $S=4802$ vertices,
...
OEIS A269898 is ``Number of nX4 0..6 arrays with some element plus some horizontally or vertically adjacent neighbor totalling six exactly once.''. It has offset $1$ and begins
\[
756, 2005080, 2801265390, 3263186052840, 3482459146452300, 3529041005211929340, 3455975332370347120110, 3303146124421034482402560,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 07 2016 08:53:04, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;1746\,a(n-1) - 838311\,a(n-2) + 67282834\,a(n-3) - 2128326885\,a(n-4) + 29556635268\,a(n-5) - 150523824676\,a(n-6)
\end{equation}
for all $n>7$.
...
\[
\mathcal V=\bigl\{(r,c):\ r\in\{0,\dots,6\}^{4},\ c\in\{0,1\}\bigr\},
\qquad |\mathcal V|=S=4802,
\]
...
the digraph dense, with $(6+1)^{2\cdot4}$ edges instead of the sparse set used here.
\end{remark}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269898.
