...
\title{The empirical recurrence for OEIS A269012, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A269012 counts arrays over $\{0,\dots,1\}$ subject to a condition on the array as a
...
OEIS A269012 is ``Number of 2 X n binary arrays with some element plus some horizontally, diagonally or antidiagonally adjacent neighbor totalling two exactly once.''. It has offset $1$ and begins
\[
0, 4, 8, 36, 88, 272, 696, 1900,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) + 5*a(n-2) - 6*a(n-3) - 9*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 18 2019 06:33:10, revision 7) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269012.
