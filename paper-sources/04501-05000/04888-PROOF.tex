...
\title{The empirical recurrence for OEIS A208389, proved by counting patterns}
...
\begin{abstract}
OEIS A208389 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
state space down from $276$ to $S=58$. The entry's empirical recurrence of order
...
OEIS A208389 is ``Number of n X 5 0..2 arrays with new values 0..2 introduced in row major order and no element equal to more than two of its immediate leftward or upward or right-upward antidiagonal neighbors.''. It has offset $1$ and begins
\[
41, 8838, 1937736, 424785708, 93120350760, 20413586117376, 4475009970818208, 980999326809336384,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 222*a(n-1) - 612*a(n-2) + 432*a(n-3) for n>4.
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 02 2018 09:17:50, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;222\,a(n-1) - 612\,a(n-2) + 432\,a(n-3)
\end{equation}
for all $n>4$.
...
Assembling the $3$ lumped chains into one block-diagonal matrix $N$ of size $S=58$ and
...
\end{equation}
The unlumped alphabet had $276$ rows in all; the lumped chain has $S=58$ states.
...
\eqref{eq:walk}, divided by $3!$, was evaluated at every one of the $12$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208389.
