...
\title{The empirical recurrence for OEIS A269070, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A269070 counts arrays over $\{0,\dots,1\}$ subject to a condition on the array as a
...
OEIS A269070 is ``Number of n X 3 binary arrays with some element plus some horizontally, diagonally or antidiagonally adjacent neighbor totalling two not more than once.''. It has offset $1$ and begins
\[
7, 27, 123, 537, 2343, 10167, 43959, 189465,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 10*a(n-1) - 31*a(n-2) + 24*a(n-3) + 21*a(n-4) - 18*a(n-5) - 9*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 18 2019 15:00:33, revision 7) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269070.
