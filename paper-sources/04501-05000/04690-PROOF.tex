...
\title{The empirical recurrence for OEIS A263637, proved by transfer matrix}
...
\begin{abstract}
OEIS A263637 carries an empirical recurrence of order $5$ contributed by R.~H.~Hardin. It is
...
OEIS A263637 is ``Number of length n arrays of permutations of 0..n-1 with each element moved by -2 to 2 places and with no two consecutive increases.''. It has offset $1$ and begins
\[
1, 2, 5, 9, 11, 19, 27, 44,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-2) + a(n-3) - a(n-5) for n>9.
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 02 2019 11:26:42, revision 9) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A263637.
