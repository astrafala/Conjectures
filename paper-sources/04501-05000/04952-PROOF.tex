...
\title{The empirical recurrence for OEIS A211477, proved by transfer matrix}
...
\begin{abstract}
OEIS A211477 carries an empirical recurrence of order $6$ contributed by R. H. Hardin. It is
...
OEIS A211477 is ``Number of -1..1 arrays x(i) of n+1 elements i=1..n+1 with x(i)+x(j), x(i+1)+x(j+1), -(x(i)+x(j+1)), and -(x(i+1)+x(j)) having two or three distinct values for every i<=n and j<=n.''. It has offset $1$ and begins
\[
8, 18, 40, 82, 168, 332, 658, 1282,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) + 2*a(n-2) - 11*a(n-3) + 2*a(n-4) + 10*a(n-5) - 4*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 18 2018 06:42:58, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + 2\,a(n-2) - 11\,a(n-3) + 2\,a(n-4) + 10\,a(n-5) - 4\,a(n-6)
\]
for every $n>0$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A211477.
