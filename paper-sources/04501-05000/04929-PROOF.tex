...
\title{The empirical recurrence for OEIS A211573, proved by transfer matrix}
...
\begin{abstract}
OEIS A211573 carries an empirical recurrence of order $6$ contributed by R. H. Hardin. It is
...
OEIS A211573 is ``Number of -2..2 arrays x(i) of n+1 elements i=1..n+1 with set{t,u,v in 0,1}((x[i+t]+x[j+u]+x[k+v])*(-1)\^{}(t+u+v)) having four or six distinct values for every i,j,k<=n.''. It has offset $1$ and begins
\[
16, 44, 108, 260, 604, 1436, 3324, 7964,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) + 6*a(n-2) - 24*a(n-3) + 4*a(n-4) + 36*a(n-5) - 24*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 19 2018 09:50:01, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A211573.
