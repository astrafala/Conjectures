...
\title{The empirical recurrence for OEIS A232138, proved by transfer matrix}
...
\begin{abstract}
OEIS A232138 counts $2\times(n+1)$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A232138 is ``Number of (1+1) X (n+1) 0..2 arrays with no element equal to a strict majority of its horizontal and antidiagonal neighbors, with values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
6, 36, 200, 1140, 6468, 36752, 208772, 1186044,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 6*a(n-1) - 11*a(n-3) + 4*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2018 08:53:46, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232138.
