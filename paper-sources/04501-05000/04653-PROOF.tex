...
\title{The empirical recurrence for OEIS A228256, proved by transfer matrix}
...
\begin{abstract}
OEIS A228256 carries an empirical recurrence of order $2$ contributed by R. H. Hardin. It is
...
arrays counted are exactly the walks in it; hence $a(n)$ is a walk count on $S=269$ vertices
...
OEIS A228256 is ``Number of third differences of arrays of length n+3 of numbers in 0..4.''. It has offset $1$ and begins
\[
33, 565, 6419, 53315, 315601, 1688101, 8717049, 44633821,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 9*a(n-1) - 20*a(n-2) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 10 2018 09:53:23, revision 8) this is still
...
An admissible array is then exactly a walk, and $\iota,\tau$ are the vectors recording which windows may begin and end an array, so with $M$ the adjacency matrix on $S=269$ vertices,
\[
a(n)\;=\;\iota^{\!\top}M^{\,n}\tau ,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A228256.
