...
\title{The empirical recurrence for OEIS A268991, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A268991 counts arrays over $\{0,\dots,1\}$ subject to a condition on the array as a
...
OEIS A268991 is ``Number of n X 4 binary arrays with some element plus some horizontally or antidiagonally adjacent neighbor totalling two not more than once.''. It has offset $1$ and begins
\[
13, 103, 805, 6009, 43512, 308112, 2144780, 14730784,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 16*a(n-1) - 88*a(n-2) + 200*a(n-3) - 208*a(n-4) + 96*a(n-5) - 16*a(n-6) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 17 2019 17:20:50, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;16\,a(n-1) - 88\,a(n-2) + 200\,a(n-3) - 208\,a(n-4) + 96\,a(n-5) - 16\,a(n-6)
\end{equation}
for all $n>7$.
...
\[
\mathcal V=\bigl\{(r,c):\ r\in\{0,\dots,1\}^{4},\ c\in\{0,1\}\bigr\},
...
the digraph dense, with $(1+1)^{2\cdot4}$ edges instead of the sparse set used here.
\end{remark}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268991.
