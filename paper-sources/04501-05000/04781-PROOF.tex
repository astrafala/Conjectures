...
\title{The empirical recurrence for OEIS A189305, proved by transfer matrix}
...
\begin{abstract}
OEIS A189305 counts the permutations of the cells of an $n\times2$ array in which every cell
...
OEIS A189305 is ``Number of n X 2 array permutations with each element moving zero or one space diagonally, horizontally or vertically.''. It has offset $1$ and begins
\[
2, 14, 73, 400, 2177, 11854, 64554, 351521,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) +8*a(n-2) -4*a(n-4) +a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (May 01 2018 14:29:12, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + 8\,a(n-2) - 4\,a(n-4) + a(n-5)
\]
for every $n>4$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A189305.
