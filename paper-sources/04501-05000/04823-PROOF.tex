...
\title{The empirical column recurrences for the table OEIS A235856}
...
\begin{abstract}
OEIS A235856 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A235856 is ``T(n,k)=Number of (n+1)X(k+1) 0..3 arrays with the upper median equal to the lower median in every 2X2 subblock.''. It has offset $1$, is
read by antidiagonals, and begins
\[
100, 688, 688, 4524, 9600, 4524, 30624, 121244,\ \dots
\]
The entry carries the following block:
\begin{quote}\small
Empirical for column k:\\
k=1: a(n) = 2*a(n-1) +37*a(n-2) -10*a(n-3) -200*a(n-4) +128*a(n-5)\\
k=2: [order 13]\\
k=3: [order 43]\\
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 08:54:12, revision 6) these are still
...
The sequence is ``Number of (n+1)X(2) 0..3 arrays with the upper median equal to the lower median in every 2X2 subblock.''. Its rows are the vertices of a digraph on
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A235856.
