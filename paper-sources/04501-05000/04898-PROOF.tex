...
\title{The empirical recurrence for OEIS A269196, proved by transfer matrix}
...
\begin{abstract}
OEIS A269196 counts arrays of width $3$ over $\{0,1,2,3\}$ in which the number of adjacent PAIRS of
...
result is a walk count on $S=161$ states.
\end{abstract}
...
OEIS A269196 is ``Number of n X 3 0..3 arrays with some element plus some horizontally, diagonally or antidiagonally adjacent neighbor totalling three no more than once.''. It has offset $1$ and begins
\[
60, 1284, 25572, 471492, 8314020, 142233732, 2380537188, 39186271044,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 30*a(n-1) -237*a(n-2) +180*a(n-3) -36*a(n-4) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 20 2019 06:25:58, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The array has $3$ cells across, with entries in $\{0,1,2,3\}$. An ADJACENT PAIR is a pair of cells
\[
\begin{array}{l}
$(i,j)\text{ and }(i,j{+}1)$ \\
$(i,j)\text{ and }(i{+}1,j{+}1)$ \\
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=161.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269196.
