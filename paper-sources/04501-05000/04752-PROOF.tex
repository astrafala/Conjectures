...
\title{The empirical recurrence for OEIS A252554, proved by transfer matrix}
...
\begin{abstract}
OEIS A252554 counts $(n+2)\times6$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
$a(n)$ is a walk count on $S=408573$ vertices. Such a sequence is $C$-finite, so whether a given
...
OEIS A252554 is ``Number of (n+2)X(4+2) 0..3 arrays with every 3X3 subblock row and diagonal sum equal to 1 2 4 6 or 7 and every 3X3 column and antidiagonal sum not equal to 1 2 4 6 or 7.''. It has offset $1$ and begins
\[
2443, 3178, 8329, 24336, 80820, 242136, 748814, 2418811,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:21:38, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;82\,a(n-3) - 2429\,a(n-6) + 33486\,a(n-9) - 261118\,a(n-12) + 1295078\,a(n-15) - 4396152\,a(n-18) + 10604184\,a(n-21) - 18276440\,a(n-24) + 22254797\,a(n-27) - 19021565\,a(n-30) + 11461650\,a(n-33) - 4926134\,a(n-36) + 1526628\,a(n-39) - 338818\,a(n-42) + 51264\,a(n-45) - 4731\,a(n-48) + 223\,a(n-51) - 4\,a(n-54)
\]
for every $n>60$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252554.
