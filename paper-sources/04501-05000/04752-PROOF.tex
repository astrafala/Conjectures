...
\title{The empirical recurrence for OEIS A302891, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A302891 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A302891 is ``Number of 4Xn 0..1 arrays with every element equal to 0, 2, 3, 4 or 5 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
8, 3, 141, 238, 2278, 12782, 98458, 714934,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 15 2018 10:51:47, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;13\,a(n-1) - 12\,a(n-2) - 356\,a(n-3) + 616\,a(n-4) + 5083\,a(n-5) - 8496\,a(n-6) - 45548\,a(n-7) + 56196\,a(n-8) + 312181\,a(n-9) - 273657\,a(n-10) - 1619340\,a(n-11) + 1141670\,a(n-12) + 6721822\,a(n-13) - 4280936\,a(n-14) - 23586213\,a(n-15) + 14143180\,a(n-16) + 70972322\,a(n-17) - 42559939\,a(n-18) - 179915012\,a(n-19) + 118698279\,a(n-20) + 379886532\,a(n-21) - 289705583\,a(n-22) - 669242363\,a(n-23) + 574942292\,a(n-24) + 1024958274\,a(n-25) - 945572342\,a(n-26) - 1418419501\,a(n-27) + 1353749786\,a(n-28) + 1760748357\,a(n-29) - 1743439270\,a(n-30) - 1875647765\,a(n-31) + 2042011697\,a(n-32) + 1638648467\,a(n-33) - 2153570928\,a(n-34) - 1137848157\,a(n-35) + 1988432432\,a(n-36) + 621772336\,a(n-37) - 1503116866\,a(n-38) - 287645124\,a(n-39) + 872723132\,a(n-40) + 133853876\,a(n-41) - 374946624\,a(n-42) - 75375840\,a(n-43) + 109068696\,a(n-44) + 36225824\,a(n-45) - 18718304\,a(n-46) - 12108800\,a(n-47) + 83968\,a(n-48) + 1946624\,a(n-49) + 634880\,a(n-50) + 65536\,a(n-51)
\end{equation}
for all $n>54$.
...
\#\{\text{neighbours with a value }equal to\ x_{t,u}\}\in\{0,2,3,4,5\}
\end{equation}
...
publishes, $n=20$, the arrays have $4\cdot20$ cells over
...
\begin{theorem}
The recurrence \eqref{eq:conj} holds for every $n>54$, which is the statement of
Section~1.
\end{theorem}
...
Every one of those integers vanishes from the index corresponding to $n=54+1$ onwards,
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302891.
