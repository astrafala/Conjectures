...
\title{The empirical recurrence for OEIS A252552, proved by transfer matrix}
...
\begin{abstract}
OEIS A252552 counts $(n+2)\times4$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252552 is ``Number of (n+2)X(2+2) 0..3 arrays with every 3X3 subblock row and diagonal sum equal to 1 2 4 6 or 7 and every 3X3 column and antidiagonal sum not equal to 1 2 4 6 or 7.''. It has offset $1$ and begins
\[
1107, 889, 1477, 3084, 7144, 16327, 37430, 88797,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:21:24, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;41\,a(n-3) - 642\,a(n-6) + 4961\,a(n-9) - 21249\,a(n-12) + 55203\,a(n-15) - 94450\,a(n-18) + 115159\,a(n-21) - 104947\,a(n-24) + 71287\,a(n-27) - 34926\,a(n-30) + 11911\,a(n-33) - 2699\,a(n-36) + 381\,a(n-39) - 30\,a(n-42) + a(n-45)
\]
for every $n>50$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252552.
