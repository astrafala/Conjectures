...
\title{The empirical recurrence for OEIS A250705, proved by transfer matrix}
...
\begin{abstract}
OEIS A250705 counts arrays over $\{0,1,2,3\}$ in which a statistic taken over short runs
...
window of consecutive rows, so the count is a walk count on $S=16384$ states, and the
...
OEIS A250705 is ``Number of (n+1) X (6+1) 0..3 arrays with nondecreasing x(i,j) + x(i,j-1) in the i direction and nondecreasing min(x(i,j),x(i-1,j)) in the j direction.''. It has offset $1$ and begins
\[
521684, 9240474, 122690762, 1307242006, 11455263558, 85271480338, 550734848033, 3145868632088,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 02 2026 05:14:37, revision 11) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The array has $7$ cells across and entries $x(i,j)\in\{0,1,2,3\}$.
...
So a single row is a state. Let $M$ be the matrix on the $4^{7}=16384$ rows with
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=16384.
\]
...
\begin{theorem}
\[
a(n)\;=\;14\,a(n-1) - 74\,a(n-2) + 126\,a(n-3) + 410\,a(n-4) - 2282\,a(n-5) + 2318\,a(n-6) + 9382\,a(n-7) - 28588\,a(n-8) + 1730\,a(n-9) + 111930\,a(n-10) - 148590\,a(n-11) - 181090\,a(n-12) + 617930\,a(n-13) - 152270\,a(n-14) - 1299718\,a(n-15) + 1460827\,a(n-16) + 1319948\,a(n-17) - 3623652\,a(n-18) + 516460\,a(n-19) + 5073956\,a(n-20) - 4095844\,a(n-21) - 3851316\,a(n-22) + 7152444\,a(n-23) - 7152444\,a(n-25) + 3851316\,a(n-26) + 4095844\,a(n-27) - 5073956\,a(n-28) - 516460\,a(n-29) + 3623652\,a(n-30) - 1319948\,a(n-31) - 1460827\,a(n-32) + 1299718\,a(n-33) + 152270\,a(n-34) - 617930\,a(n-35) + 181090\,a(n-36) + 148590\,a(n-37) - 111930\,a(n-38) - 1730\,a(n-39) + 28588\,a(n-40) - 9382\,a(n-41) - 2318\,a(n-42) + 2282\,a(n-43) - 410\,a(n-44) - 126\,a(n-45) + 74\,a(n-46) - 14\,a(n-47) + a(n-48)
\]
for every $n>65$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250705.
