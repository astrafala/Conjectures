...
\title{The conjectured generating function for OEIS A250873, proved}
...
\begin{abstract}
OEIS A250873 counts arrays of a fixed width under a local condition, and carries a conjectured
...
OEIS A250873 is ``Number of (n+1) X (4+1) 0..3 arrays with nondecreasing x(i,j)-x(i,j-1) in the i direction and nondecreasing x(i,j)+x(i-1,j) in the j direction.''. It has offset $1$ and begins
\[
1328, 6728, 31928, 144248, 629528, 2681528,\ \dots
\]
The entry states, as a conjecture contributed by a reader and never marked settled:
\begin{quote}
Empirical g.f.: 8*x*(166 - 819*x + 1391*x\^{}2 - 744*x\^{}3) / ((1 - x)*(1 - 2*x)*(1 - 3*x)*(1 - 4*x)). - \_Colin Barker\_, Nov 22 2018
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 22 2018 08:23:19, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250873.
