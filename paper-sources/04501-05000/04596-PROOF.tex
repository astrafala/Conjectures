...
\title{The empirical column recurrences for the table OEIS A251283}
...
\begin{abstract}
OEIS A251283 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A251283 is ``T(n,k)=Number of (n+1)X(k+1) 0..3 arrays with no 2X2 subblock having its maximum diagonal element less than its minimum antidiagonal element.''. It has offset $1$, is
read by antidiagonals, and begins
\[
230, 3264, 3264, 46244, 164800, 46244, 655040, 8320896,\ \dots
\]
...
k=4: [order 23]\\
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:14:11, revision 6) these are still
...
The sequence is ``Number of (n+1)X(2) 0..3 arrays with no 2X2 subblock having its maximum diagonal element less than its minimum antidiagonal element.''. Its rows are the vertices of a digraph on
...
$c_{1}$ & $230$ & $c_{4}$ & $-428619$ & $c_{7}$ & $-44328410$ &  &  \\
$c_{2}$ & $-9371$ & $c_{5}$ & $-3386398$ & $c_{8}$ & $-221985864$ &  &  \\
$c_{3}$ & $68562$ & $c_{6}$ & $50923111$ & $c_{9}$ & $-608157648$ &  &  \\
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251283.
