...
\title{The empirical closed form for OEIS A166757, proved}
...
\begin{abstract}
OEIS A166757 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
$S=80$ vertices. Any function of the form $\sum_j p_j(n)\lambda_j^{\,n}$ satisfies the
...
OEIS A166757 is ``Number of nX2 1..4 arrays containing at least one of each value, and all equal values connected.''. It has offset $1$ and begins
\[
0, 24, 504, 3672, 16272, 53784, 146184, 345240,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (4/15)*(n-1)*(8*n\^{}5 -28*n\^{}4 + 97*n\^{}3 - 218*n\^{}2 + 234*n -90).
\end{quote}
As of the ``Last modified'' line on the live entry (May 27 2016 03:00:43, revision 13) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\left(\frac{4 n}{15} - \frac{4}{15}\right) \left(8 n^{5} - 28 n^{4} + 97 n^{3} - 218 n^{2} + 234 n - 90\right).
\]
...
walk, so with $M$ the adjacency matrix of that digraph on $S=80$ vertices, and $u,w$ the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A166757.
