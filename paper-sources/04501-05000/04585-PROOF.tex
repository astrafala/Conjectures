...
\title{The empirical recurrence for OEIS A233108, proved by transfer matrix}
...
\begin{abstract}
OEIS A233108 counts arrays over $\{0,\dots,5\}$ in which no two entries that are neighbours in
...
OEIS A233108 is ``Number of n X 3 0..5 arrays with no element x(i,j) adjacent to value 5-x(i,j) horizontally or vertically, top left element zero, and 1 appearing before 2 3 and 4, and 2 appearing before 3 in row major order.''. It has offset $1$ and begins
\[
6, 313, 24912, 2154065, 189286871, 16683923848, 1471365099497, 129774107522700,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 111*a(n-1) - 2128*a(n-2) + 10532*a(n-3) - 17559*a(n-4) + 9045*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 07 2018 14:35:07, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;111\,a(n-1) - 2128\,a(n-2) + 10532\,a(n-3) - 17559\,a(n-4) + 9045\,a(n-5)
\]
for every $n>5$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A233108.
