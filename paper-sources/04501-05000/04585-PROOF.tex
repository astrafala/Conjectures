...
\title{The empirical closed form for OEIS A207598, proved}
...
\begin{abstract}
OEIS A207598 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
$S=1600$ vertices. Any function of the form $\sum_j p_j(n)\lambda_j^{\,n}$ satisfies the
...
OEIS A207598 is ``Number of n X 7 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 0 1 and 1 0 1 vertically.''. It has offset $1$ and begins
\[
40, 1600, 9240, 30400, 75400, 157440, 292600, 499840,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 120*n\^{}4 + 40*n\^{}3 - 200*n\^{}2 + 80*n.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 25 2018 06:08:21, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;120 n^{4} + 40 n^{3} - 200 n^{2} + 80 n.
\]
...
walk, so with $M$ the adjacency matrix of that digraph on $S=1600$ vertices, and $u,w$ the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207598.
