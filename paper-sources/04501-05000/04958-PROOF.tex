...
\title{The empirical recurrence for OEIS A252675, proved by transfer matrix}
...
\begin{abstract}
OEIS A252675 counts $(n+2)\times6$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
$a(n)$ is a walk count on $S=320066$ vertices. Such a sequence is $C$-finite, so whether a given
...
OEIS A252675 is ``Number of (n+2)X(4+2) 0..3 arrays with every 3X3 subblock row and diagonal sum equal to 0 2 5 6 or 7 and every 3X3 column and antidiagonal sum not equal to 0 2 5 6 or 7.''. It has offset $1$ and begins
\[
1246, 1525, 3424, 7747, 22203, 56318, 136414, 396057,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:30:43, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;47\,a(n-3) - 779\,a(n-6) + 6299\,a(n-9) - 38390\,a(n-12) + 178663\,a(n-15) - 636822\,a(n-18) + 1830492\,a(n-21) - 3935340\,a(n-24) + 6441162\,a(n-27) - 6562062\,a(n-30) + 1199657\,a(n-33) + 3668572\,a(n-36) - 908634\,a(n-39) - 1197825\,a(n-42) - 547466\,a(n-45) + 241006\,a(n-48) + 225365\,a(n-51) + 27734\,a(n-54) + 6620\,a(n-57) + 2119\,a(n-60) - 326\,a(n-63) - 87\,a(n-66) - 4\,a(n-69)
\]
for every $n>71$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252675.
