...
\title{The empirical recurrence for OEIS A269137, proved by transfer matrix}
...
\begin{abstract}
OEIS A269137 counts arrays of width $2$ over $\{0,1,2,3\}$ in which the number of adjacent PAIRS of
...
OEIS A269137 is ``Number of n X 2 0..3 arrays with some element plus some horizontally, antidiagonally or vertically adjacent neighbor totalling three no more than once.''. It has offset $1$ and begins
\[
16, 148, 1164, 8532, 59916, 408596, 2727564, 17914580,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 12*a(n-1) - 38*a(n-2) + 12*a(n-3) - a(n-4) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 19 2019 08:44:39, revision 10) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269137.
