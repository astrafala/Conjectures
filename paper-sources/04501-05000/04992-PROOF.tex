...
\title{The empirical recurrence for OEIS A214113, proved by transfer matrix}
...
\begin{abstract}
OEIS A214113 counts the proper colourings of a grid $2\times(n+1)$, wrapped in the growing direction, with at most $4$ colours and
...
OEIS A214113 is ``Number of 0..3 colorings of a 2X(n+1) array circular in the n+1 direction with new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
4, 11, 111, 670, 4994, 34041, 241021, 1678940,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) +22*a(n-2) -4*a(n-3) -21*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 16:52:12, revision 10) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + 22\,a(n-2) - 4\,a(n-3) - 21\,a(n-4)
\]
for every $n>2$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A214113.
