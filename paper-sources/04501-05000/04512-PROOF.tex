...
\title{The empirical recurrence for OEIS A223328, proved by transfer matrix}
...
\begin{abstract}
OEIS A223328 counts the ways of writing the vertices of a fixed graph $G$ into an array of width
$5$ so that any two cells adjacent in one of the named directions carry vertices joined by an
edge of $G$; here $G$ is cube graph $Q_3$. The entry carries an empirical recurrence of order $2$
...
single slice is a state and the count is a walk count on a finite digraph with $S=325$ vertices.
\end{abstract}
...
OEIS A223328 is ``Rolling cube footprints: number of n X 5 0..7 arrays starting with 0 where 0..7 label vertices of a cube and every array movement to a horizontal or antidiagonal neighbor moves along a corresponding cube edge.''. It has offset $1$ and begins
\[
81, 9261, 1059723, 121264857, 13876429707, 1587890407761, 181703507374179, 20792470582897209,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 117*a(n-1) - 294*a(n-2).
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 19 2018 09:36:49, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223328.
