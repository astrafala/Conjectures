...
\title{The empirical recurrence for OEIS A252028, proved by transfer matrix}
...
\begin{abstract}
OEIS A252028 counts $(n+2)\times6$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A252028 is ``Number of (n+2)X(4+2) 0..2 arrays with every 3X3 subblock row, column, diagonal and antidiagonal sum not equal to 0 2 or 4.''. It has offset $1$ and begins
\[
809, 1929, 7182, 29781, 126920, 541544, 2306234, 9836361,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 10:42:50, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252028.
