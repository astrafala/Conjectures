...
\title{The empirical recurrence for OEIS A207274, proved by transfer matrix}
...
\begin{abstract}
OEIS A207274 counts arrays over $\{0,\dots,1\}$ of width $7$ that avoid the patterns
...
OEIS A207274 is ``Number of 7Xn 0..1 arrays avoiding 0 0 0 and 0 1 1 horizontally and 0 1 1 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
31, 961, 2305, 13067, 52240, 135686, 467686,\ \dots
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207274.
