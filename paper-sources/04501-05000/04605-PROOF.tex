...
\title{The empirical recurrence for OEIS A208710, proved by transfer matrix}
...
\begin{abstract}
OEIS A208710 counts $3\times n$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A208710 is ``Number of 3 X n 0..1 arrays with new values 0..1 introduced in row major order and no element equal to more than two of its immediate leftward or upward or right-upward antidiagonal neighbors.''. It has offset $1$ and begins
\[
4, 32, 196, 1268, 8128, 52184, 334948, 2149988,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 5*a(n-1) + 9*a(n-2) + a(n-3) - 2*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 07 2018 01:38:31, revision 12) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208710.
