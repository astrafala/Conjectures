...
\title{The empirical recurrence for OEIS A231390, proved by transfer matrix}
...
\begin{abstract}
OEIS A231390 counts $(n+1)\times3$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A231390 is ``Number of (n+1) X (2+1) 0..2 arrays with no element unequal to a strict majority of its horizontal, diagonal and antidiagonal neighbors, with values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
7, 8, 15, 20, 31, 52, 95, 180,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + a(n-2) - 2*a(n-3) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 28 2018 15:19:22, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231390.
