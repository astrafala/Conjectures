...
\title{The empirical recurrence for OEIS A208041, proved by transfer matrix}
...
\begin{abstract}
OEIS A208041 counts arrays over $\{0,\dots,1\}$ of width $5$ that avoid the patterns
...
OEIS A208041 is ``Number of 5Xn 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 0 0 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
13, 169, 741, 3249, 21147, 137641, 766115,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:36:09, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208041.
