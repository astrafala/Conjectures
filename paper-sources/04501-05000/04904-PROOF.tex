...
\title{The empirical recurrence for OEIS A252101, proved by transfer matrix}
...
\begin{abstract}
OEIS A252101 counts $(n+2)\times6$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
$a(n)$ is a walk count on $S=967020$ vertices. Such a sequence is $C$-finite, so whether a given
...
OEIS A252101 is ``Number of (n+2)X(4+2) 0..3 arrays with every 3X3 subblock row and column sum equal to 0 3 4 6 or 7 and every 3X3 diagonal and antidiagonal sum not equal to 0 3 4 6 or 7.''. It has offset $1$ and begins
\[
10605, 8941, 26996, 86575, 329544, 1129324, 3681127, 14793289,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 10:47:33, revision 6) this is still
...
$\{0,\dots,3\}^{6}$. A $3\times3$ subblock occupies three consecutive rows and
...
\begin{theorem}
\[
a(n)\;=\;143\,a(n-3) - 7633\,a(n-6) + 194779\,a(n-9) - 2621021\,a(n-12) + 21584927\,a(n-15) - 126117260\,a(n-18) + 569693148\,a(n-21) - 1970217723\,a(n-24) + 5012332433\,a(n-27) - 9046774747\,a(n-30) + 9490076649\,a(n-33) + 2869475853\,a(n-36) - 28633928995\,a(n-39) + 46976334404\,a(n-42) - 43041766972\,a(n-45) + 27216813760\,a(n-48) - 12579947264\,a(n-51) + 4180881408\,a(n-54) - 1019708416\,a(n-57) + 177668096\,a(n-60) - 16252928\,a(n-63) + 524288\,a(n-66)
\]
for every $n>71$.
\end{theorem}
...
exactly. Those integers vanish from the index corresponding to $n=71+1$ onwards, and the
run was continued until the working vector was identically zero, which settles all larger $j$
at once. By Lemma~\ref{lem:crit} the recurrence holds for every $n>71$.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252101.
