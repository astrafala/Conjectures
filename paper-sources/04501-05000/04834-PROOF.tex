...
\title{The empirical recurrence for OEIS A188759, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A188759 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
values of its neighbours, and carries an empirical recurrence of order $56$ contributed
...
OEIS A188759 is ``Number of nX5 binary arrays without the pattern 0 0 1 vertically or horizontally.''. It has offset $1$ and begins
\[
20, 400, 4792, 53024, 532168, 5163989, 48759352, 454436200,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 04:49:34, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;22\,a(n-1) - 70\,a(n-2) - 1618\,a(n-3) + 11120\,a(n-4) + 47034\,a(n-5) - 534943\,a(n-6) - 551606\,a(n-7) + 14611160\,a(n-8) - 4049936\,a(n-9) - 266817312\,a(n-10) + 259639964\,a(n-11) + 3519324886\,a(n-12) - 4881340196\,a(n-13) - 35064158164\,a(n-14) + 57583231084\,a(n-15) + 271485508912\,a(n-16) - 487721768504\,a(n-17) - 1664034384882\,a(n-18) + 3133033950064\,a(n-19) + 8171464584048\,a(n-20) - 15720808480096\,a(n-21) - 32379778576548\,a(n-22) + 62745993612268\,a(n-23) + 103895248459539\,a(n-24) - 201586268638518\,a(n-25) - 270041179910698\,a(n-26) + 525373435370358\,a(n-27) + 567083704042044\,a(n-28) - 1115803214123978\,a(n-29) - 956367753428867\,a(n-30) + 1934485140455318\,a(n-31) + 1281302981943948\,a(n-32) - 2734844302826768\,a(n-33) - 1338142536953580\,a(n-34) + 3140097542985056\,a(n-35) + 1051323597729608\,a(n-36) - 2907013865099900\,a(n-37) - 573175913588364\,a(n-38) + 2146307393175232\,a(n-39) + 161617141575284\,a(n-40) - 1244574676854520\,a(n-41) + 39510568416836\,a(n-42) + 555156722092736\,a(n-43) - 69421320742292\,a(n-44) - 185262425270480\,a(n-45) + 38165505566368\,a(n-46) + 44548004587224\,a(n-47) - 12320660907616\,a(n-48) - 7326913408080\,a(n-49) + 2488275738000\,a(n-50) + 763096644864\,a(n-51) - 304908505920\,a(n-52) - 44179793280\,a(n-53) + 20485799424\,a(n-54) + 1056416256\,a(n-55) - 574801920\,a(n-56)
\end{equation}
for all $n>57$.
...
publishes, $n=17$, the arrays have $5\cdot17$ cells over
...
$o=1n_0+0-2$. Then for $j\ge56$,
\[
a(n_0+j)-\sum_i c_i\,a(n_0+j-i)\;=\;\,\mathbf{v}^{\!\top}G^{\,j-56}w,
\qquad w=h_{56}-\sum_i c_i\,h_{56-i} .
\]
...
\begin{proof}
Substitute Lemma~\ref{lem:walk} and factor $G^{j-56}$ out of
...
the middle row. The vector $w$ was formed by $56$ applications of $G$ in exact integer
arithmetic and $\mathbf{v}^{\!\top}G^{m}w$ evaluated for $m=0,1,\dots$, again exactly.
Every one of those integers vanishes from the index corresponding to $n=57+1$ onwards,
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A188759.
