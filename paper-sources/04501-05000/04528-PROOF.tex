...
\title{The empirical recurrence for OEIS A239852, proved by transfer matrix}
...
\begin{abstract}
OEIS A239852 counts arrays over $\{0,1,2,3\}$ in which no entry may equal, modulo $4$, a given
constant plus the SUM of all the entries lying before it along one of several rays. The entry
carries an empirical recurrence of order $5$ contributed by R.~H.~Hardin. It is true, and
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A239852.
