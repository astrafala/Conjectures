...
\title{The empirical recurrence for OEIS A260014, proved by transfer matrix}
...
\begin{abstract}
OEIS A260014 counts $(n+2)\times9$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
every $3\times3$ subblock, and it carries an empirical recurrence of order $56$
...
OEIS A260014 is ``Number of (n+2)X(7+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000101 00010101 or 01010101.''. It has offset $1$ and begins
\[
1744, 6262, 56137, 292422, 1231648, 5674360, 33390411, 166527544,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:59:09, revision 6) this is still
...
\[
\text{the clockwise perimeter word of }g\text{ is a rotation of one of }\{00000101,\ 00010101,\ 01010101\}
\]
...
\begin{theorem}
\[
a(n)\;=\;10\,a(n-2) + 517\,a(n-4) - 854\,a(n-6) - 56990\,a(n-8) + 56302\,a(n-10) + 2411527\,a(n-12) - 1764472\,a(n-14) - 48498069\,a(n-16) + 26093894\,a(n-18) + 497994124\,a(n-20) - 222182908\,a(n-22) - 2758508017\,a(n-24) + 1071537624\,a(n-26) + 8550609072\,a(n-28) - 2818367318\,a(n-30) - 15204425329\,a(n-32) + 4059654344\,a(n-34) + 15566932977\,a(n-36) - 3209525858\,a(n-38) - 8958017542\,a(n-40) + 1356965078\,a(n-42) + 2746526451\,a(n-44) - 272931138\,a(n-46) - 410312169\,a(n-48) + 21549240\,a(n-50) + 26177904\,a(n-52) - 653184\,a(n-54) - 559872\,a(n-56)
\]
for every $n>57$.
\end{theorem}

\begin{proof}
The vector $w=q(M)\mathbf{1}$ was formed by $56$ matrix--vector products in exact
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A260014.
