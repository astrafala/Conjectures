...
\title{The empirical recurrence for OEIS A284483, proved from an exact model}
...
\begin{abstract}
OEIS A284483 carries an empirical recurrence of order $3$ contributed by Colin Barker. It is true, and it is
...
\[
1, 0, 111, 1101, 11110, 111101, 1111110, 11111101,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Mar 28 2017: (Start) a(n) = 10*a(n-1) + a(n-2) - 10*a(n-3) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 05 2025 15:22:38, revision 15)
