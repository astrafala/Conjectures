...
\title{The empirical column recurrences for the table OEIS A235107}
...
\begin{abstract}
OEIS A235107 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A235107 is ``T(n,k) is the number of (n+1) X (k+1) 0..6 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 4, with no adjacent elements equal (constant-stress tilted 1 X 1 tilings).''. It has offset $1$, is
read by antidiagonals, and begins
\[
154, 670, 670, 2900, 2498, 2900, 12578, 9328,\ \dots
\]
...
k=3: [order 62].\\
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 20 2022 21:08:17, revision 6) these are still
...
The sequence is ``Number of (n+1) X (2) 0..6 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 4, with no adjacent elements equal (constant-stress tilted 1 X 1 tilings).''. Its rows are the vertices of a digraph on
...
\[
a(n)\;=\;7\,a(n-1) - 2\,a(n-2) - 47\,a(n-3) + 3\,a(n-4) + 84\,a(n-5) + 36\,a(n-6)
\]
...
$S=252$ vertices, so it satisfies a monic recurrence of order at most $S$;
Berlekamp--Massey on $2S=504$ exact terms returns the minimal one, of order
$19$ --- the stated order --- with integer coefficients
\begin{center}\small\begin{tabular}{cccccccc}
$c_{1}$ & $12$ & $c_{6}$ & $-12901$ & $c_{11}$ & $-412538$ & $c_{16}$ & $-247248$ \\
$c_{2}$ & $-14$ & $c_{7}$ & $-21740$ & $c_{12}$ & $641088$ & $c_{17}$ & $584736$ \\
$c_{3}$ & $-322$ & $c_{8}$ & $86236$ & $c_{13}$ & $1018740$ & $c_{18}$ & $372096$ \\
$c_{4}$ & $949$ & $c_{9}$ & $107744$ & $c_{14}$ & $-478292$ & $c_{19}$ & $65664$ \\
$c_{5}$ & $3384$ & $c_{10}$ & $-322761$ & $c_{15}$ & $-1306432$ &  &  \\
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A235107.
