...
\title{The empirical recurrence for OEIS A224033, proved by transfer matrix}
...
\begin{abstract}
OEIS A224033 counts arrays over $\{0,\dots,1\}$ whose rows, columns, diagonals or
...
OEIS A224033 is ``Number of n X 3 0..1 arrays with antidiagonals unimodal and rows and diagonals nondecreasing.''. It has offset $1$ and begins
\[
4, 13, 37, 105, 298, 848, 2419, 6908,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 4*a(n-1) - 3*a(n-2) - a(n-3) + 2*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 26 2018 09:50:40, revision 8) the statement is
...
every one of the $26$ published indices, with no shift fitted. The values agree exactly.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224033.
