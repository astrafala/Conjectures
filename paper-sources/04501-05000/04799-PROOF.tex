...
\title{The empirical recurrence for OEIS A260067, proved by transfer matrix}
...
\begin{abstract}
OEIS A260067 counts $(n+2)\times7$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A260067 is ``Number of (n+2)X(5+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000001 00000011 or 00000111.''. It has offset $1$ and begins
\[
956, 2367, 6714, 12664, 25444, 77061, 185370, 361576,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:59:47, revision 6) this is still
...
\[
\text{the clockwise perimeter word of }g\text{ is a rotation of one of }\{00000001,\ 00000011,\ 00000111\}
\]
...
\begin{theorem}
\[
a(n)\;=\;9\,a(n-3) + 49\,a(n-4) - 26\,a(n-6) - 312\,a(n-7) - 842\,a(n-8) + 38\,a(n-9) + 686\,a(n-10) + 3449\,a(n-11) + 7088\,a(n-12) - 830\,a(n-13) - 4844\,a(n-14) - 18040\,a(n-15) - 33155\,a(n-16) + 4232\,a(n-17) + 15646\,a(n-18) + 52245\,a(n-19) + 87752\,a(n-20) - 11520\,a(n-21) - 29970\,a(n-22) - 84645\,a(n-23) - 128641\,a(n-24) + 19022\,a(n-25) + 46762\,a(n-26) + 79957\,a(n-27) + 90454\,a(n-28) - 16484\,a(n-29) - 46682\,a(n-30) - 50717\,a(n-31) - 18348\,a(n-32) + 6652\,a(n-33) + 19384\,a(n-34) + 15200\,a(n-35) + 3168\,a(n-36) - 192\,a(n-37) - 1280\,a(n-38) - 2816\,a(n-39)
\]
for every $n>43$.
\end{theorem}
...
exactly. Those integers vanish from the index corresponding to $n=43+1$ onwards, and the
run was continued until the working vector was identically zero, which settles all larger $j$
at once. By Lemma~\ref{lem:crit} the recurrence holds for every $n>43$.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A260067.
