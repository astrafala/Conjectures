...
\title{The empirical recurrence for OEIS A296036, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A296036 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A296036 is ``Number of nX5 0..1 arrays with each 1 adjacent to 2 or 4 king-move neighboring 1s.''. It has offset $1$ and begins
\[
1, 55, 251, 997, 8472, 51941, 285366, 1853852,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 03 2017 07:11:16, revision 4) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A296036.
