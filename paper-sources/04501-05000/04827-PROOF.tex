...
\title{The empirical recurrence for OEIS A223355, proved by transfer matrix}
...
\begin{abstract}
OEIS A223355 counts the ways of writing the vertices of a fixed graph $G$ into an array of width
...
OEIS A223355 is ``Rolling cube footprints: number of n X 6 0..5 arrays starting with 0 where 0..5 label faces of a cube and every array movement to a horizontal or antidiagonal neighbor moves across a corresponding cube edge.''. It has offset $1$ and begins
\[
1024, 1327104, 1764753408, 2356125106176, 3147420753985536, 4204783428144463872, 5617417467128419713024, 7504647859211051911348224,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 1600*a(n-1) - 368640*a(n-2) + 21233664*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 19 2018 18:12:59, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;1600\,a(n-1) - 368640\,a(n-2) + 21233664\,a(n-3)
\]
for every $n>3$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223355.
