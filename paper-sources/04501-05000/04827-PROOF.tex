...
\title{The empirical recurrence for OEIS A209891, proved by counting patterns}
...
\begin{abstract}
OEIS A209891 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A209891 is ``Number of (n+1) X 3 0..2 arrays with every 2X2 subblock having two distinct values, and new values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
34, 280, 2304, 19008, 156800, 1293568, 10671616, 88038400,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 8*a(n-1) +4*a(n-2) -16*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 23 2025 17:23:33, revision 16) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;8\,a(n-1) + 4\,a(n-2) - 16\,a(n-3)
\end{equation}
for all $n>3$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209891.
