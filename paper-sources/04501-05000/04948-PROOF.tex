...
\title{The empirical column recurrences for the table OEIS A253456}
...
\begin{abstract}
OEIS A253456 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A253456 is ``T(n,k)=Number of (n+1)X(k+1) 0..2 arrays with every 2X2 subblock diagonal minus antidiagonal sum nondecreasing horizontally and vertically.''. It has offset $1$, is
read by antidiagonals, and begins
\[
81, 414, 414, 1388, 1975, 1388, 3639, 4782,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 14:03:04, revision 6) these are still
...
The sequence is ``Number of (n+1)X(2) 0..2 arrays with every 2X2 subblock diagonal minus antidiagonal sum nondecreasing horizontally and vertically.''. Its rows are the vertices of a digraph on
...
model reproduces $9$ published values, $39$ decimal digits in all, every one of
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253456.
