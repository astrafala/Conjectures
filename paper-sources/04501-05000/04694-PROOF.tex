...
\title{The empirical recurrence for OEIS A241364, proved by transfer matrix}
...
\begin{abstract}
OEIS A241364 counts $n\times2$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A241364 is ``Number of n X 2 0..2 arrays with no element equal to fewer vertical neighbors than horizontal neighbors, with new values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
1, 7, 47, 326, 2284, 16026, 112458, 789166,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 7*a(n-1) + 2*a(n-3) - 8*a(n-4) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 30 2018 05:20:18, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A241364.
