...
\title{The empirical recurrence for OEIS A252714, proved by transfer matrix}
...
\begin{abstract}
OEIS A252714 counts arrays of width $5$ over an alphabet of $4$ letters in which every three
...
OEIS A252714 is ``Number of (n+2) X (3+2) 0..3 arrays with every consecutive three elements in every row and diagonal having exactly two distinct values, and in every column and antidiagonal not having exactly two distinct values, and new values 0 upwards introduced in row major order.''. It has offset $1$ and begins
\[
70, 50, 62, 80, 119, 170, 224, 341,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + 3*a(n-3) - 3*a(n-4) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 05 2018 09:37:30, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252714.
