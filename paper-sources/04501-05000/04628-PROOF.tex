...
\title{The empirical recurrence for OEIS A197303, proved by transfer matrix}
...
\begin{abstract}
OEIS A197303 counts $n\times4$ arrays over $\{0,\dots,4\}$ subject to a condition imposed on
...
walk, and $a(n)$ is a walk count on $S=1740$ vertices, which is $C$-finite. Whether the
...
OEIS A197303 is ``Number of nX4 0..4 arrays with each element x equal to the number its horizontal and vertical neighbors equal to 4,4,0,2,1 for x=0,1,2,3,4.''. It has offset $1$ and begins
\[
3, 23, 98, 639, 3181, 15930, 85087, 450159,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 07:06:20, revision 9) this is still
...
settled by the terminal weight, which evaluates it with $\varnothing$ below. Most of those pairs are indistinguishable, and exactly so. Every offset named above has $|dj|\le 1$, so whether the cell at column $j$ of the middle row is satisfied depends on the three rows only through their windows at $j-1,j,j+1$. Collect for each $j$ the indicator over the window of the row below, and call that tuple $P(r,s)$: the number of cells any $t$ violates is read off $P$, so is the number violated at the bottom edge, and the successor $(s,t)$ carries $P(s,t)$, which does not mention $r$. Hence two pairs $(r,s)$ and $(r',s)$ with the same $P$ have the same outgoing rows and the same successors, and the vertex is $(s,P)$. That leaves $S=1740$ vertices in place of $390625$. Hence,
with $M$ the adjacency matrix on $S=1740$ vertices, $\iota$ the starting vector and $\tau$ the
terminal weight,
\[
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 9\,a(n-2) + 26\,a(n-3) + 73\,a(n-4) + 149\,a(n-5) - 32\,a(n-6) - 914\,a(n-7) - 2357\,a(n-8) - 3867\,a(n-9) - 3819\,a(n-10) + 699\,a(n-11) + 8094\,a(n-12) + 10668\,a(n-13) + 6022\,a(n-14) - 1522\,a(n-15) - 6309\,a(n-16) - 4188\,a(n-17) - 412\,a(n-18) + 690\,a(n-19) - 403\,a(n-20) - 3191\,a(n-21) + 3126\,a(n-22) + 15294\,a(n-23) + 4693\,a(n-24) - 16594\,a(n-25) - 14860\,a(n-26) - 931\,a(n-27) + 7147\,a(n-28) + 4489\,a(n-29) - 1321\,a(n-30) + 97\,a(n-31) + 1737\,a(n-32) - 41\,a(n-33) - 663\,a(n-34) - 92\,a(n-35) + 78\,a(n-36) + 13\,a(n-37) - 11\,a(n-38) - 3\,a(n-39) + a(n-40)
\]
for every $n>40$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A197303.
