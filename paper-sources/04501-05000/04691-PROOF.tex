...
\title{The empirical recurrence for OEIS A251315, proved by transfer matrix}
...
\begin{abstract}
OEIS A251315 counts $(n+1)\times7$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
every $2\times2$ subblock, and carries an empirical recurrence of order $42$ contributed
...
OEIS A251315 is ``Number of (n+1)X(6+1) 0..1 arrays with no 2X2 subblock having the maximum of its diagonal elements greater than the absolute difference of its antidiagonal elements.''. It has offset $1$ and begins
\[
894, 6717, 48980, 361845, 2688099, 20080487, 149982413, 1118147932,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:16:11, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;34\,a(n-1) - 560\,a(n-2) + 6078\,a(n-3) - 48943\,a(n-4) + 308559\,a(n-5) - 1566445\,a(n-6) + 6511537\,a(n-7) - 22375703\,a(n-8) + 63785808\,a(n-9) - 150461053\,a(n-10) + 290535552\,a(n-11) - 447421686\,a(n-12) + 514662450\,a(n-13) - 349575947\,a(n-14) - 110030485\,a(n-15) + 721140799\,a(n-16) - 1154390677\,a(n-17) + 1115896183\,a(n-18) - 601911588\,a(n-19) - 77410187\,a(n-20) + 549773049\,a(n-21) - 654771081\,a(n-22) + 494568920\,a(n-23) - 274584584\,a(n-24) + 121966579\,a(n-25) - 43228651\,a(n-26) + 4188852\,a(n-27) + 11167249\,a(n-28) - 10337396\,a(n-29) + 4829526\,a(n-30) - 1488803\,a(n-31) + 239091\,a(n-32) + 47360\,a(n-33) - 39329\,a(n-34) + 20491\,a(n-35) - 7917\,a(n-36) + 2263\,a(n-37) - 466\,a(n-38) + 31\,a(n-39) - 9\,a(n-40) + 2\,a(n-41) + 2\,a(n-42)
\end{equation}
for all $n>44$.
...
\text{not }\bigl(\max(\alpha,\delta)>|\beta-\gamma|\bigr),
\end{equation}
...
For every $n$ with $n+1-1\ge42$,
\[
a(n)-\sum_i c_i\,a(n-i)\;=\;\mathbf{1}^{\!\top}M^{\,n+1-1-42}\,q(M)\,\mathbf{1} .
\]
...
=\mathbf{1}^{\!\top}M^{\,m-42}\,q(M)\,\mathbf{1}
\]
with $m=n+1-1$, which is the stated identity; the equivalence follows by letting
$m-42=j$ run over $\ge0$. For the last clause put $w=q(M)\mathbf{1}$. By the
...
$S^2$ pairs. The vector $w=q(M)\mathbf{1}\in\mathbb{Z}^{S}$ was then formed by $42$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251315.
