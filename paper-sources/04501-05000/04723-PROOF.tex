...
\title{The empirical recurrence for OEIS A197453, proved by transfer matrix}
...
\begin{abstract}
OEIS A197453 counts $n\times4$ arrays over $\{0,\dots,4\}$ subject to a condition imposed on
...
walk, and $a(n)$ is a walk count on $S=1664$ vertices, which is $C$-finite. Whether the
...
OEIS A197453 is ``Number of nX4 0..4 arrays with each element x equal to the number its horizontal and vertical neighbors equal to 3,3,0,2,2 for x=0,1,2,3,4.''. It has offset $1$ and begins
\[
3, 23, 84, 583, 2233, 10758, 53337, 252125,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 07:14:57, revision 9) this is still
...
settled by the terminal weight, which evaluates it with $\varnothing$ below. Most of those pairs are indistinguishable, and exactly so. Every offset named above has $|dj|\le 1$, so whether the cell at column $j$ of the middle row is satisfied depends on the three rows only through their windows at $j-1,j,j+1$. Collect for each $j$ the indicator over the window of the row below, and call that tuple $P(r,s)$: the number of cells any $t$ violates is read off $P$, so is the number violated at the bottom edge, and the successor $(s,t)$ carries $P(s,t)$, which does not mention $r$. Hence two pairs $(r,s)$ and $(r',s)$ with the same $P$ have the same outgoing rows and the same successors, and the vertex is $(s,P)$. That leaves $S=1664$ vertices in place of $390625$. Hence,
with $M$ the adjacency matrix on $S=1664$ vertices, $\iota$ the starting vector and $\tau$ the
terminal weight,
\[
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 6\,a(n-2) + 15\,a(n-3) + 50\,a(n-4) + 153\,a(n-5) + 182\,a(n-6) + 379\,a(n-7) + 965\,a(n-8) + 359\,a(n-9) - 1167\,a(n-10) - 2472\,a(n-11) - 4778\,a(n-12) - 5592\,a(n-13) - 2203\,a(n-14) - 350\,a(n-15) - 2414\,a(n-16) + 488\,a(n-17) + 7327\,a(n-18) + 5913\,a(n-19) + 7477\,a(n-20) + 9964\,a(n-21) + 7136\,a(n-22) + 12438\,a(n-23) + 7558\,a(n-24) - 81\,a(n-25) - 813\,a(n-26) + 2186\,a(n-27) + 2986\,a(n-28) + 284\,a(n-29) - 1001\,a(n-30) + 460\,a(n-31) - 837\,a(n-32) - 1033\,a(n-33) + 93\,a(n-34) + 254\,a(n-35) + 6\,a(n-36) - 33\,a(n-37) - 8\,a(n-38)
\]
for every $n>38$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A197453.
