...
\title{The empirical recurrence for OEIS A231850, proved by transfer matrix}
...
\begin{abstract}
OEIS A231850 counts arrays of width $3$ over $\{0,1,2\}$ in which no cell is beaten by a strict majority of its neighbours. The entry carries an
...
$3$ consecutive rows and the count is a walk count on $S=631$ states.
\end{abstract}
...
OEIS A231850 is ``Number of n X 3 0..2 arrays with no element having a strict majority of its horizontal and antidiagonal neighbors equal to itself plus one mod 3, with upper left element zero (rock paper and scissors drawn positions).''. It has offset $1$ and begins
\[
3, 34, 656, 12404, 234336, 4426924, 83630516, 1579892344,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 21*a(n-1) - 41*a(n-2) + 22*a(n-3) for n>4.
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 01 2018 09:35:23, revision 8) this is still
...
Thus
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=631,
\]
...
\begin{theorem}
\[
a(n)\;=\;21\,a(n-1) - 41\,a(n-2) + 22\,a(n-3)
\]
for every $n>4$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231850.
