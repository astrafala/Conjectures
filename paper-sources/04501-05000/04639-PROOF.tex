...
\title{The empirical recurrence for OEIS A193703, proved by transfer matrix}
...
\begin{abstract}
OEIS A193703 carries an empirical recurrence of order $7$ contributed by R. H. Hardin. It is
...
OEIS A193703 is ``Number of arrays of -1..1 integers x(1..n) with every x(i) in a subsequence of length 1, 2, 3 or 4 with sum zero.''. It has offset $1$ and begins
\[
1, 3, 9, 27, 73, 195, 515, 1357,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) +a(n-2) +2*a(n-3) -a(n-4) +3*a(n-6) +4*a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (May 04 2018 22:41:22, revision 13) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + a(n-2) + 2\,a(n-3) - a(n-4) + 3\,a(n-6) + 4\,a(n-7)
\]
for every $n>0$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A193703.
