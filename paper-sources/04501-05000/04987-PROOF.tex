...
\title{The empirical recurrence for OEIS A275402, proved by transfer matrix}
...
\begin{abstract}
OEIS A275402 counts arrays in which no entry may equal the entries at a short list of fixed offsets
...
$1$ consecutive columns, $S=25$ states in all.
\end{abstract}
...
OEIS A275402 is ``Number of 3 X n 0..2 arrays with no element equal to any value at offset (-2,-1) (-2,0) or (-1,1) and new values introduced in order 0..2.''. It has offset $1$ and begins
\[
3, 16, 84, 444, 2344, 12376, 65344, 345008,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) + 6*a(n-2) + 4*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 04 2019 09:08:31, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A275402.
