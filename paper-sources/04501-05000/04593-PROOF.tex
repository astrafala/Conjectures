...
\title{The empirical recurrence for OEIS A209102, proved by transfer matrix}
...
\begin{abstract}
OEIS A209102 counts $3\times n$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A209102 is ``Number of 3 X n 0..2 arrays with new values 0..2 introduced in row major order and no element equal to more than one of its immediate leftward or upward or right-upward antidiagonal neighbors.''. It has offset $1$ and begins
\[
5, 82, 1326, 20928, 329064, 5171088, 81254376, 1276752432,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 22*a(n-1) - 110*a(n-2) + 180*a(n-3) - 60*a(n-4) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 08 2018 10:48:11, revision 9) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209102.
