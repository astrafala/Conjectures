...
\title{The empirical recurrence for OEIS A250366, proved by transfer matrix}
...
\begin{abstract}
OEIS A250366 carries an empirical recurrence of order $56$ contributed by R.~H.~Hardin. It is
...
OEIS A250366 is ``Number of length n+6 0..1 arrays with every seven consecutive terms having the maximum of some three terms equal to the minimum of the remaining four terms.''. It has offset $1$ and begins
\[
93, 151, 252, 424, 714, 1198, 1996, 3292,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 12:21:00, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) - a(n-2) + a(n-3) + 6\,a(n-7) - 7\,a(n-8) - 2\,a(n-9) - 7\,a(n-10) - 5\,a(n-11) - 6\,a(n-12) + a(n-13) - 22\,a(n-14) + 6\,a(n-15) + 11\,a(n-16) + 20\,a(n-17) + 22\,a(n-18) + 33\,a(n-19) + 3\,a(n-20) + 47\,a(n-21) + 11\,a(n-22) - 15\,a(n-23) - 27\,a(n-24) - 38\,a(n-25) - 60\,a(n-26) - 11\,a(n-27) - 62\,a(n-28) - 28\,a(n-29) + 11\,a(n-30) + 21\,a(n-31) + 36\,a(n-32) + 55\,a(n-33) + 10\,a(n-34) + 51\,a(n-35) + 23\,a(n-36) - 11\,a(n-37) - 10\,a(n-38) - 21\,a(n-39) - 29\,a(n-40) - 4\,a(n-41) - 27\,a(n-42) - 8\,a(n-43) + 6\,a(n-44) + 2\,a(n-45) + 7\,a(n-46) + 8\,a(n-47) + a(n-48) + 8\,a(n-49) + a(n-50) - a(n-51) - a(n-53) - a(n-54) - a(n-56)
\]
for every $n>61$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250366.
