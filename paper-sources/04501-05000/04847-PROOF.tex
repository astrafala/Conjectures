...
\title{The empirical recurrence for OEIS A237931, proved by transfer matrix}
...
\begin{abstract}
OEIS A237931 counts arrays over $\{0,\dots,3\}$ subject to a condition on the order
...
OEIS A237931 is ``Number of (n+1)X(1+1) 0..3 arrays with the upper median plus the lower median minus the minimum of every 2X2 subblock differing from its horizontal and vertical neighbors by exactly one.''. It has offset $1$ and begins
\[
256, 1718, 11701, 81402, 563166, 3880918, 26804881, 185489824,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 10:36:09, revision 7) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The $2\times2$ subblocks of an $(n+1)\times2$ array form an
$n\times1$ grid, and each carries the value $\sigma=-a+b+c$, where $a\le b\le c\le d$ are its four entries sorted --- its minimum, lower median, upper median and maximum. The entry asks that the values of
...
\begin{theorem}
\[
a(n)\;=\;1888\,a(n-4) + 26908\,a(n-6) - 301104\,a(n-8) - 4523964\,a(n-10) + 9356144\,a(n-12) + 158092496\,a(n-14) + 15024960\,a(n-16) - 2150807552\,a(n-18) - 1973442560\,a(n-20) + 11283515392\,a(n-22) + 13873016832\,a(n-24) - 19456245760\,a(n-26) - 21131821056\,a(n-28) + 10415243264\,a(n-30) + 385875968\,a(n-32) - 96468992\,a(n-34) - 16777216\,a(n-36)
\]
for every $n>36$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237931.
