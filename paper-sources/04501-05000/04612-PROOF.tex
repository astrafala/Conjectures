...
\title{The empirical recurrence for OEIS A211465, proved by transfer matrix}
...
\begin{abstract}
OEIS A211465 carries an empirical recurrence of order $5$ contributed by R. H. Hardin. It is
...
OEIS A211465 is ``Number of -2..2 arrays x(i) of n+1 elements i=1..n+1 with x(i)+x(j), x(i+1)+x(j+1), -(x(i)+x(j+1)), and -(x(i+1)+x(j)) having two, three or four distinct values for every i<=n and j<=n.''. It has offset $1$ and begins
\[
24, 116, 556, 2652, 12588, 59484, 279932, 1312364,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 12*a(n-1) - 45*a(n-2) + 40*a(n-3) + 46*a(n-4) + 8*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 18 2018 05:25:22, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;12\,a(n-1) - 45\,a(n-2) + 40\,a(n-3) + 46\,a(n-4) + 8\,a(n-5)
\]
for every $n>0$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A211465.
