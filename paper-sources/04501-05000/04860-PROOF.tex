...
\title{The empirical recurrence for OEIS A261379, proved by transfer matrix}
...
\begin{abstract}
OEIS A261379 counts $(n+2)\times9$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A261379 is ``Number of (n+2)X(7+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00001011 00010101 or 01010101.''. It has offset $1$ and begins
\[
392, 864, 3778, 12500, 39494, 128998, 461576, 1468008,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 17 2015 08:32:24, revision 4) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A261379.
