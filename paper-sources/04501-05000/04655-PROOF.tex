...
\title{The empirical recurrence for OEIS A260472, proved by transfer matrix}
...
\begin{abstract}
OEIS A260472 counts $(n+2)\times7$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A260472 is ``Number of (n+2) X (5+2) 0..1 arrays with each 3 X 3 subblock having clockwise perimeter pattern 00000000 00000001 or 00010101.''. It has offset $1$ and begins
\[
414, 1085, 4607, 15502, 57524, 228287, 839073, 3095233,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 21 2026 20:24:30, revision 8) this is still
...
\[
\text{the clockwise perimeter word of }g\text{ is a rotation of one of }\{00000000,\ 00000001,\ 00010101\}
\]
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 2\,a(n-2) + 33\,a(n-3) + 20\,a(n-4) - 18\,a(n-5) - 257\,a(n-6) - 260\,a(n-7) - 42\,a(n-8) + 912\,a(n-9) + 794\,a(n-10) + 181\,a(n-11) - 1126\,a(n-12) - 774\,a(n-13) + 140\,a(n-14) + 1295\,a(n-15) + 182\,a(n-16) - 2115\,a(n-17) - 2863\,a(n-18) - 1164\,a(n-19) + 2571\,a(n-20) + 3736\,a(n-21) + 1547\,a(n-22) - 1848\,a(n-23) - 2648\,a(n-24) + 734\,a(n-25) + 4007\,a(n-26) + 4392\,a(n-27) - 255\,a(n-28) - 4650\,a(n-29) - 4693\,a(n-30) - 1324\,a(n-31) + 1748\,a(n-32) + 1791\,a(n-33) + 136\,a(n-34) - 632\,a(n-35) - 677\,a(n-36) + 143\,a(n-37) + 278\,a(n-38) + 264\,a(n-39) + 10\,a(n-40) - 12\,a(n-41) - 24\,a(n-42)
\]
for every $n>47$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A260472.
