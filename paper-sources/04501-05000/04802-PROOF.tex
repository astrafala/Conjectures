...
\title{The empirical recurrence for OEIS A269146, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A269146 counts arrays over $\{0,\dots,3\}$ subject to a condition on the array as a
...
OEIS A269146 is ``Number of n X 2 0..3 arrays with some element plus some horizontally, antidiagonally or vertically adjacent neighbor totalling three exactly once.''. It has offset $1$ and begins
\[
4, 80, 768, 6224, 46464, 330192, 2270592, 15251152,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 12*a(n-1) - 38*a(n-2) + 12*a(n-3) - a(n-4) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 19 2019 12:08:35, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;12\,a(n-1) - 38\,a(n-2) + 12\,a(n-3) - a(n-4)
\end{equation}
for all $n>5$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269146.
