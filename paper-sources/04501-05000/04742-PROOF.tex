...
\title{The empirical recurrence for OEIS A269093, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A269093 counts arrays over $\{0,\dots,3\}$ subject to a condition on the array as a
...
OEIS A269093 is ``Number of nX4 0..3 arrays with some element plus some horizontally or vertically adjacent neighbor totalling three exactly once.''. It has offset $1$ and begins
\[
108, 11424, 715320, 37963968, 1856325000, 86415197088, 3892946216856, 171307237216320,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 90*a(n-1) -2559*a(n-2) +24556*a(n-3) -94959*a(n-4) +140442*a(n-5) -69169*a(n-6) for n>7
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 19 2016 09:48:05, revision 4) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269093.
