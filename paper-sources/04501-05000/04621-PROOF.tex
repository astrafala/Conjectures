...
\title{Arrays counted up to renaming: the empirical recurrence for OEIS A205328}
...
\begin{abstract}
OEIS A205328 carries an empirical recurrence of order $2$ contributed by R.~H.~Hardin. It is
...
both in the state the arrays are exactly the walks in a digraph on $S=5$ vertices, so $a(n)$
...
OEIS A205328 is ``Number of (n+1) X 2 0..2 arrays with the number of equal 2 X 2 subblock diagonal pairs and equal antidiagonal pairs differing from each horizontal or vertical neighbor, and new values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
14, 72, 396, 2160, 11808, 64512, 352512, 1926144,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 03 2018 13:57:26, revision 12) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A205328.
