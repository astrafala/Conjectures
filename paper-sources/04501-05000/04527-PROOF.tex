...
\title{The empirical recurrence for OEIS A209842, proved by counting patterns}
...
\begin{abstract}
OEIS A209842 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A209842 is ``Number of (n+1) X 3 0..3 arrays with every 2 X 2 subblock having one or two distinct values, and new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
41, 451, 5083, 59563, 715307, 8743851, 108170155, 1348830635,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 22*a(n-1) - 127*a(n-2) + 90*a(n-3) + 288*a(n-4) - 400*a(n-5) + 128*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 13 2018 08:18:32, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;22\,a(n-1) - 127\,a(n-2) + 90\,a(n-3) + 288\,a(n-4) - 400\,a(n-5) + 128\,a(n-6)
\end{equation}
for all $n>5$.
...
For every $n$ with $m=n+1-1\ge6$,
\[
4!\Bigl(a(n)-\sum_i c_i\,a(n-i)\Bigr)\;=\;\mathbf{v}^{\!\top}N^{\,m-6}q(N)\mathbf{1} .
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209842.
