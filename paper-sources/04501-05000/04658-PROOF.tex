...
\title{The empirical recurrence for OEIS A277926, proved from an exact model}
...
\begin{abstract}
OEIS A277926 carries an empirical recurrence of order $4$ contributed by Colin Barker. It is true, and it is
...
\[
1, 10, 0, 1111, 0, 111111, 0, 11111111,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Nov 04 2016: (Start) a(n) = 101*a(n-2)-100*a(n-4) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 05 2025 15:22:35, revision 11)
...
neighbourhood to a live cell flips the ENTIRE plane, and rule 5 is read
