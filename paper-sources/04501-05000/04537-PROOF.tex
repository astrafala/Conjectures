...
\title{The conjectured generating function for OEIS A283351, proved}
...
\begin{abstract}
OEIS A283351 counts arrays of a fixed width under a local condition, and carries a conjectured
