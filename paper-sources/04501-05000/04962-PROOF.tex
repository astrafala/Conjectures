...
\title{The empirical recurrence for OEIS A203916, proved by transfer matrix}
...
\begin{abstract}
OEIS A203916 counts $(n+2)\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A203916 is ``Number of (n+2) X 3 0..1 arrays with every 3 X 3 subblock having equal diagonal elements or equal antidiagonal elements, and new values 0..1 introduced in row major order.''. It has offset $1$ and begins
\[
112, 392, 1400, 5000, 17800, 63368, 225704, 803912,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) +6*a(n-3) +4*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 05 2018 14:35:37, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A203916.
