...
\title{The empirical recurrence for OEIS A210176, proved by transfer matrix}
...
\begin{abstract}
OEIS A210176 counts arrays of width $2$ whose every $2\times2$ subblock holds a
...
OEIS A210176 is ``Number of (n+1) X 2 0..3 arrays containing all values 0..3 with every 2 X 2 subblock having three or four distinct values, and new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
1, 51, 744, 9042, 103752, 1165620, 12988416, 144259560,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 14*a(n-1) - 26*a(n-2) - 68*a(n-3) - 24*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 15 2018 06:53:23, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;14\,a(n-1) - 26\,a(n-2) - 68\,a(n-3) - 24\,a(n-4)
\]
for every $n>4$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A210176.
