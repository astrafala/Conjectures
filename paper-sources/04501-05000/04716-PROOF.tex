...
\title{The empirical closed form for OEIS A166756, proved}
...
\begin{abstract}
OEIS A166756 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A166756 is ``Number of nX2 1..3 arrays containing at least one of each value, and all equal values connected.''. It has offset $1$ and begins
\[
0, 24, 174, 642, 1716, 3780, 7314, 12894,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*n\^{}4 - 8*n\^{}3 + 11*n\^{}2 - 13*n + 6.
\end{quote}
As of the ``Last modified'' line on the live entry (May 26 2016 11:28:32, revision 10) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;4 n^{4} - 8 n^{3} + 11 n^{2} - 13 n + 6.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A166756.
