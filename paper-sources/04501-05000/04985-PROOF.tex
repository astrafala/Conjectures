...
\title{The empirical closed form for OEIS A223834, proved}
...
\begin{abstract}
OEIS A223834 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
$S=2816$ vertices. Any function of the form $\sum_j p_j(n)\lambda_j^{\,n}$ satisfies the
...
OEIS A223834 is ``Number of n X 4 0..1 arrays with rows, diagonals and antidiagonals unimodal and columns nondecreasing.''. It has offset $1$ and begins
\[
11, 46, 118, 249, 471, 824, 1356, 2123,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (1/3)*n\^{}4 + (2/3)*n\^{}3 + (31/6)*n\^{}2 + (71/6)*n - 9 for n>1.
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 18 2025 17:07:42, revision 10) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{n^{4}}{3} + \frac{2 n^{3}}{3} + \frac{31 n^{2}}{6} + \frac{71 n}{6} - 9.
\]
...
walk, so with $M$ the adjacency matrix of that digraph on $S=2816$ vertices, and $u,w$ the
...
established for $a$ from $n=7$ on. The remaining indices $n=2,\dots,6$ were
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223834.
