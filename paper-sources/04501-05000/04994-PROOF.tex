...
\title{The empirical column recurrences for the table OEIS A234217}
...
\begin{abstract}
OEIS A234217 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A234217 is ``T(n,k)=Number of (n+1)X(k+1) 0..4 arrays with every 2X2 subblock having the sum of the squares of all six edge and diagonal differences equal to 11 (11 maximizes T(1,1)).''. It has offset $1$, is
read by antidiagonals, and begins
\[
72, 308, 308, 1248, 1540, 1248, 5344, 7348,\ \dots
\]
...
k=3: [order 56]\\
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 09:16:47, revision 6) these are still
...
The sequence is ``Number of (n+1)X2 0..4 arrays with every 2X2 subblock having the sum of the squares of all six edge and diagonal differences equal to 11.''. Its rows are the vertices of a digraph on
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234217.
