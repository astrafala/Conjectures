...
\title{The empirical recurrence for OEIS A253369, proved by transfer matrix}
...
\begin{abstract}
OEIS A253369 counts the arrays over $\{0,\dots,2\}$ whose $2\times2$ subblocks carry a
...
OEIS A253369 is ``Number of (n+1)X(2+1) 0..2 arrays with every 2X2 subblock sum nondecreasing horizontally, vertically and antidiagonally ne-to-sw.''. It has offset $1$ and begins
\[
450, 3111, 22631, 103572, 521009, 1977416, 8184420, 28090376,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 14:00:27, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253369.
