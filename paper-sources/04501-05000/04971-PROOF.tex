...
\title{The empirical closed form for OEIS A207452, proved}
...
\begin{abstract}
OEIS A207452 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A207452 is ``Number of n X 7 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 0 1 and 1 0 1 vertically.''. It has offset $1$ and begins
\[
42, 1764, 10710, 36456, 92610, 196812, 370734, 640080,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 168*n\^{}4 - 84*n\^{}3 - 84*n\^{}2 + 42*n.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 23 2018 05:49:28, revision 11) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;168 n^{4} - 84 n^{3} - 84 n^{2} + 42 n.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207452.
