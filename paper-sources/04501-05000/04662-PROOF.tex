...
\title{The empirical recurrence for OEIS A279959, proved from an exact model}
...
\begin{abstract}
OEIS A279959 carries an empirical recurrence of order $4$ contributed by Colin Barker. It is true, and it is
...
OEIS A279959 is ``Binary representation of the x-axis, from the left edge to the origin, of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 221", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 10, 10, 1100, 111, 111100, 111, 11111100,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Dec 24 2016: (Start) a(n) = 101*a(n-2) - 100*a(n-4) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 05 2025 15:22:36, revision 11)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A279959.
