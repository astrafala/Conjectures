...
\title{The empirical recurrence for OEIS A231257, proved by transfer matrix}
...
\begin{abstract}
OEIS A231257 counts $(n+1)\times3$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A231257 is ``Number of (n+1) X (2+1) 0..2 arrays with no element unequal to a strict majority of its horizontal and antidiagonal neighbors, with values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
3, 15, 89, 547, 3381, 20911, 129329, 799835,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 10*a(n-1) -29*a(n-2) +36*a(n-3) -16*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 16 2018 09:36:13, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;10\,a(n-1) - 29\,a(n-2) + 36\,a(n-3) - 16\,a(n-4)
\]
for every $n>3$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231257.
