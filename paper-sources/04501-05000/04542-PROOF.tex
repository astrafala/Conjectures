...
\title{The empirical recurrence for OEIS A208409, proved by transfer matrix}
...
\begin{abstract}
OEIS A208409 counts $2\times n$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A208409 is ``Number of 2 X n 0..3 arrays with new values 0..3 introduced in row major order and no element equal to more than two of its immediate leftward or upward or right-upward antidiagonal neighbors.''. It has offset $1$ and begins
\[
2, 15, 182, 2698, 41914, 658450, 10370330, 163422914,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 18*a(n-1) - 31*a(n-2) - 66*a(n-3) - 24*a(n-4) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 02 2018 14:13:10, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;18\,a(n-1) - 31\,a(n-2) - 66\,a(n-3) - 24\,a(n-4)
\]
for every $n>6$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208409.
