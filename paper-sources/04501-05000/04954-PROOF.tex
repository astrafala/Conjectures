...
\title{The empirical recurrence for OEIS A202789, proved by transfer matrix}
...
\begin{abstract}
OEIS A202789 counts arrays of width $2$ over $\{0,1\}$ in which every cell of a named value has a neighbour of that same value. The entry carries an
...
OEIS A202789 is ``Number of n X 2 binary arrays with every one adjacent to another one horizontally, diagonally, antidiagonally or vertically.''. It has offset $1$ and begins
\[
2, 12, 50, 188, 724, 2820, 10960, 42544,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) - 2*a(n-2) + 6*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 03 2018 05:35:40, revision 11) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A202789.
