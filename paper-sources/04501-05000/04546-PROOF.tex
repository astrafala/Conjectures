...
\title{The empirical recurrence for OEIS A231759, proved by transfer matrix}
...
\begin{abstract}
OEIS A231759 counts $(n+1)\times4$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A231759 is ``Number of (n+1)X(3+1) 0..1 arrays with no element having a strict majority of its horizontal, diagonal and antidiagonal neighbors equal to one.''. It has offset $1$ and begins
\[
100, 625, 5041, 40000, 303601, 2353156, 18318400, 141681409,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 06:40:43, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + 12\,a(n-2) + 149\,a(n-3) + 34\,a(n-4) - 745\,a(n-5) - 4377\,a(n-6) - 1298\,a(n-7) + 13107\,a(n-8) + 52121\,a(n-9) + 8083\,a(n-10) - 86996\,a(n-11) - 321488\,a(n-12) - 28134\,a(n-13) + 269200\,a(n-14) + 1028451\,a(n-15) + 72948\,a(n-16) - 507872\,a(n-17) - 2031587\,a(n-18) - 253166\,a(n-19) + 609639\,a(n-20) + 2548479\,a(n-21) + 414970\,a(n-22) - 482501\,a(n-23) - 2033465\,a(n-24) - 288069\,a(n-25) + 243904\,a(n-26) + 1017882\,a(n-27) + 103832\,a(n-28) - 88438\,a(n-29) - 327567\,a(n-30) - 19692\,a(n-31) + 23162\,a(n-32) + 69365\,a(n-33) + 1980\,a(n-34) - 4140\,a(n-35) - 9617\,a(n-36) - 152\,a(n-37) + 478\,a(n-38) + 849\,a(n-39) + 16\,a(n-40) - 33\,a(n-41) - 44\,a(n-42) - a(n-43) + a(n-44) + a(n-45)
\]
for every $n>45$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231759.
