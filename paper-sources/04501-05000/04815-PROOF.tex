...
\title{The empirical recurrence for OEIS A264552, proved by transfer matrix}
...
\begin{abstract}
OEIS A264552 carries an empirical recurrence of order $70$ contributed by R.~H.~Hardin. It is
...
OEIS A264552 is ``Number of (3+1)X(n+1) arrays of permutations of 0..n*4+3 with each element having directed index change -1,1 -1,2 1,0 or 0,-1.''. It has offset $1$ and begins
\[
0, 5, 16, 36, 172, 764, 2728, 9880,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 17 2015 15:38:55, revision 4) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264552.
