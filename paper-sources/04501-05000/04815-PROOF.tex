...
\title{The empirical recurrence for OEIS A295527, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A295527 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A295527 is ``Number of nX4 0..1 arrays with each 1 horizontally or vertically adjacent to 1, 2 or 4 1s.''. It has offset $1$ and begins
\[
7, 87, 774, 7071, 64189, 588529, 5400933, 49414072,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 23 2017 09:24:31, revision 4) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A295527.
