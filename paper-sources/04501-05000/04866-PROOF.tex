...
\title{The empirical closed form for OEIS A208138, proved}
...
\begin{abstract}
OEIS A208138 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A208138 is ``Number of n X 4 0..1 arrays avoiding 0 0 1 and 0 1 1 horizontally and 0 0 1 and 1 0 1 vertically.''. It has offset $1$ and begins
\[
9, 81, 324, 900, 2025, 3969, 7056, 11664,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (9/4)*n\^{}4 + (9/2)*n\^{}3 + (9/4)*n\^{}2.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 28 2018 09:37:39, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{9 n^{4}}{4} + \frac{9 n^{3}}{2} + \frac{9 n^{2}}{4}.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208138.
