...
\title{The empirical recurrence for OEIS A223265, proved by transfer matrix}
...
\begin{abstract}
OEIS A223265 counts the ways of writing the vertices of a fixed graph $G$ into an array of width
...
OEIS A223265 is ``Rolling cube footprints: number of n X 4 0..5 arrays starting with 0 where 0..5 label faces of a cube and every array movement to a horizontal, diagonal or antidiagonal neighbor moves across a corresponding cube edge.''. It has offset $1$ and begins
\[
64, 6144, 622592, 63438848, 6467616768, 659411697664, 67231270567936, 6854664725200896,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 112*a(n-1) - 1024*a(n-2).
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 18 2018 08:43:04, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223265.
