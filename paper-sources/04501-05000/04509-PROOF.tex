...
\title{The conjectured generating function for OEIS A277800, proved}
...
\begin{abstract}
OEIS A277800 counts arrays of a fixed width under a local condition, and carries a conjectured
