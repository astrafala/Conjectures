...
\title{The empirical column recurrences for the table OEIS A235772}
...
\begin{abstract}
OEIS A235772 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A235772 is ``T(n,k)=Number of (n+1)X(k+1) 0..1 arrays with the sum of each 2X2 subblock two extreme terms minus its two median terms lexicographically nondecreasing columnwise and nonincreasing rowwise.''. It has offset $1$, is
read by antidiagonals, and begins
\[
16, 46, 46, 120, 178, 120, 288, 628,\ \dots
\]
...
k=4: [order 88]\\
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 08:48:43, revision 6) these are still
...
The sequence is ``Number of (n+1)X2 0..1 arrays with the sum of each 2X2 subblock two extreme terms minus its two median terms lexicographically nondecreasing columnwise and nonincreasing rowwise.''. Its rows are the vertices of a digraph on
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A235772.
