...
\title{The empirical closed form for OEIS A227259, proved}
...
\begin{abstract}
OEIS A227259 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A227259 is ``Number of n X 2 0,1 arrays indicating 2 X 2 subblocks of some larger (n+1) X 3 binary array having a sum of two or less, with rows and columns of the latter in lexicographically nondecreasing order.''. It has offset $1$ and begins
\[
3, 9, 23, 50, 96, 168, 274, 423,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (1/24)*n\^{}4 + (5/12)*n\^{}3 + (11/24)*n\^{}2 + (13/12)*n + 1.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 26 2023 15:08:57, revision 21) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{n^{4}}{24} + \frac{5 n^{3}}{12} + \frac{11 n^{2}}{24} + \frac{13 n}{12} + 1.
\]
...
$n=1,\dots,5$ and agree at each. A monic recurrence of order $5$
determines $a(m)$ from $a(m-1),\dots,a(m-5)$, and for every $m\ge6$ both
$m>0$ and $m-5\ge1$ hold, so induction on $m$ gives $a(m)=f(m)$ for every
$m\ge1$.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A227259.
