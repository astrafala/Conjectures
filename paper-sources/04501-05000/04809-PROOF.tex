...
\title{The empirical recurrence for OEIS A185742, proved by transfer matrix}
...
\begin{abstract}
OEIS A185742 counts arrays over $\{0,\dots,1\}$ under a condition comparing a statistic of
...
OEIS A185742 is ``Number of (n+1) X 2 binary arrays with every 2 X 2 subblock trace equal to some horizontal or vertical neighbor 2 X 2 subblock trace.''. It has offset $1$ and begins
\[
0, 24, 40, 144, 344, 1000, 2688, 7528,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) - a(n-2) - 2*a(n-3) + 8*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 28 2018 06:51:51, revision 9) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A185742.
