...
\title{The empirical column recurrences for the table OEIS A251499}
...
\begin{abstract}
OEIS A251499 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A251499 is ``T(n,k)=Number of (n+1)X(k+1) 0..3 arrays with every 2X2 subblock summing to 4 5 6 7 or 8.''. It has offset $1$, is
read by antidiagonals, and begins
\[
186, 2270, 2270, 27844, 86946, 27844, 341718, 3361296,\ \dots
\]
The entry carries the following block:
\begin{quote}\small
Empirical for column k:\\
k=1: a(n) = 13*a(n-1) -5*a(n-2) -52*a(n-3) +48*a(n-4)\\
k=2: [order 12]\\
k=3: [order 52]\\
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 10:26:07, revision 6) these are still
...
The sequence is ``Number of (n+1)X(2) 0..3 arrays with every 2X2 subblock summing to 4 5 6 7 or 8.''. Its rows are the vertices of a digraph on
...
\[
a(n)\;=\;13\,a(n-1) - 5\,a(n-2) - 52\,a(n-3) + 48\,a(n-4)
\]
...
$c_{1}$ & $46$ & $c_{4}$ & $12368$ & $c_{7}$ & $67165$ & $c_{10}$ & $15648$ \\
$c_{2}$ & $-243$ & $c_{5}$ & $-4170$ & $c_{8}$ & $32054$ & $c_{11}$ & $13056$ \\
$c_{3}$ & $-1796$ & $c_{6}$ & $-57120$ & $c_{9}$ & $-72328$ & $c_{12}$ & $-4608$ \\
\end{tabular}\end{center}
Repeating with the first $12+4$ terms removed gives order $12$ again.

\subsection*{Column $k=3$, recovered}
The entry gives only the order for this line: ``k=3: [order 52]''. Its model is a walk on
...
\[
(c_1,\dots,c_{52})=(161,\ -4146,\ -99086,\ 4025719,\ 3352718,\ -1143269351,\ 6323065419,\ 111830788127,\ -946832349806,\ -4245862352721,\ 53521620702661,\ 46473371138334,\ -1558596393101887,\ 1253332953080641,\ 26095778872493510,\ -48654625714125195,\ -260176131205401648,\ 730743832771969293,\ 1502063360489568965,\ -6225510155500329353,\ -4116086371165437899,\ 32877090960710570170,\ -3198116216306014279,\ -110881563115778371997,\ 64601914740248236032,\ 240410371748256608994,\ -229430903046705402626,\ -332055505305503208018,\ 440325723529501943704,\ 281414846009547740281,\ -525294895032204161992,\ -127685608591143631767,\ 408889884173453304811,\ 7499369422803642169,\ -211643864068737289778,\ 25656578512266508379,\ 72974520805344924476,\ -15672822621732300540,\ -16539948067063790336,\ 4693633112265588864,\ 2388614774963306912,\ -819992811228000512,\ -207210908122530176,\ 85006088372128768,\ 9613681651137536,\ -5031422209775616,\ -174843999412224,\ 156119569661952,\ -677293719552,\ -2193692295168,\ 31255953408,\ 10192158720).
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251499.
