...
\title{The empirical recurrence for OEIS A269882, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A269882 counts arrays over $\{0,\dots,5\}$ subject to a condition on the array as a
...
which is what keeps the digraph sparse. That makes $a(n)$ a walk count on $S=72$ vertices,
...
OEIS A269882 is ``Number of n X 2 0..5 arrays with some element plus some horizontally, diagonally, antidiagonally or vertically adjacent neighbor totalling five exactly once.''. It has offset $1$ and begins
\[
6, 432, 11280, 250992, 5125008, 99482544, 1867222224, 34216907760,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 30*a(n-1) - 197*a(n-2) - 420*a(n-3) - 196*a(n-4) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 29 2019 15:43:26, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;30\,a(n-1) - 197\,a(n-2) - 420\,a(n-3) - 196\,a(n-4)
\end{equation}
for all $n>5$.
...
\[
\mathcal V=\bigl\{(r,c):\ r\in\{0,\dots,5\}^{2},\ c\in\{0,1\}\bigr\},
\qquad |\mathcal V|=S=72,
\]
...
the digraph dense, with $(5+1)^{2\cdot2}$ edges instead of the sparse set used here.
\end{remark}
...
those integers vanishes from the index corresponding to $n=5+1$ onwards, and the run
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269882.
