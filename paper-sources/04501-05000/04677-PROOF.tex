...
\title{The empirical recurrence for OEIS A268623, proved by transfer matrix}
...
\begin{abstract}
OEIS A268623 counts arrays of width $3$ over $\{0,1,2\}$ in which the number of adjacent PAIRS of
...
result is a walk count on $S=64$ states.
\end{abstract}
...
OEIS A268623 is ``Number of n X 3 0..2 arrays with some element plus some horizontally or vertically adjacent neighbor totalling two no more than once.''. It has offset $1$ and begins
\[
24, 174, 1086, 6300, 34890, 187224, 982086, 5063964,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 10*a(n-1) - 29*a(n-2) + 20*a(n-3) - 4*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 14 2019 09:01:28, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The array has $3$ cells across, with entries in $\{0,1,2\}$. An ADJACENT PAIR is a pair of cells
\[
\begin{array}{l}
$(i,j)\text{ and }(i,j{+}1)$ \\
$(i,j)\text{ and }(i{+}1,j)$ \\
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268623.
