...
\title{The empirical recurrence for OEIS A211504, proved by transfer matrix}
...
\begin{abstract}
OEIS A211504 carries an empirical recurrence of order $7$ contributed by R. H. Hardin. It is
...
OEIS A211504 is ``Number of -3..3 arrays x(i) of n+1 elements i=1..n+1 with x(i)+x(j), x(i+1)+x(j+1), -(x(i)+x(j+1)), and -(x(i+1)+x(j)) having two, three or four distinct values for every i<=n and j<=n.''. It has offset $1$ and begins
\[
48, 330, 2262, 15474, 105642, 719838, 4895886, 33239874,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 24*a(n-1) - 210*a(n-2) + 756*a(n-3) - 659*a(n-4) - 1164*a(n-5) - 390*a(n-6) - 36*a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 18 2018 09:56:00, revision 8) this is still
...
admissible array is then exactly a walk, so with $M$ the adjacency matrix on $S=10$ vertices
...
\begin{theorem}
\[
a(n)\;=\;24\,a(n-1) - 210\,a(n-2) + 756\,a(n-3) - 659\,a(n-4) - 1164\,a(n-5) - 390\,a(n-6) - 36\,a(n-7)
\]
for every $n>0$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A211504.
