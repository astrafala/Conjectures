...
\title{The empirical closed form for OEIS A207064, proved}
...
\begin{abstract}
OEIS A207064 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
$S=81$ vertices. Any function of the form $\sum_j p_j(n)\lambda_j^{\,n}$ satisfies the
...
OEIS A207064 is ``Number of n X 4 0..1 arrays avoiding 0 0 1 and 0 1 0 horizontally and 0 0 1 and 1 0 1 vertically.''. It has offset $1$ and begins
\[
9, 81, 288, 720, 1485, 2709, 4536, 7128,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (3/4)*n\^{}4 + (15/2)*n\^{}3 + (15/4)*n\^{}2 - 3*n.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 18 2018 12:29:08, revision 10) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{3 n^{4}}{4} + \frac{15 n^{3}}{2} + \frac{15 n^{2}}{4} - 3 n.
\]
...
walk, so with $M$ the adjacency matrix of that digraph on $S=81$ vertices, and $u,w$ the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207064.
