...
\title{The empirical recurrence for OEIS A284403, proved from an exact model}
...
\begin{abstract}
OEIS A284403 carries an empirical recurrence of order $2$ contributed by Colin Barker. It is true, and it is
...
OEIS A284403 is ``Binary representation of the x-axis, from the left edge to the origin, of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 913", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 0, 101, 1110, 11111, 111111, 1111111, 11111111,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Mar 26 2017: (Start) a(n) = 11*a(n-1) - 10*a(n-2) for n>5.
\end{quote}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A284403.
