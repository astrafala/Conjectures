...
\title{The empirical recurrence for OEIS A274745, proved by counting patterns}
...
\begin{abstract}
OEIS A274745 counts arrays in which no entry may repeat a value found at any of three stated
...
cutting $6818$ pairs to $S=1223$ states. The entry's empirical recurrence of order $3$,
...
OEIS A274745 is ``Number of n X 4 0..2 arrays with no element equal to any value at offset (-1,-2) (0,-1) or (-1,0) and new values introduced in order 0..2.''. It has offset $1$ and begins
\[
4, 22, 133, 813, 4967, 30349, 185435, 1133025,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 6*a(n-1) + a(n-2) - 2*a(n-3) for n>4.
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 30 2019 11:16:50, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A274745.
