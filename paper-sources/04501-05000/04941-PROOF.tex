...
\title{The empirical recurrence for OEIS A198711, proved by counting patterns}
...
\begin{abstract}
OEIS A198711 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A198711 is ``Number of n X 4 0..3 arrays with values 0..3 introduced in row major order and no element equal to any horizontal or vertical neighbor.''. It has offset $1$ and begins
\[
5, 172, 6548, 250031, 9548295, 364637102, 13925032958, 531779578441,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 46*a(n-1) - 312*a(n-2) + 530*a(n-3) - 263*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 02 2018 10:00:15, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A198711.
