...
\title{The empirical recurrence for OEIS A232118, proved by transfer matrix}
...
\begin{abstract}
OEIS A232118 counts arrays of width $3$ over $\{0,1,2\}$ in which every cell has a neighbour at least as large and one at most as large. The entry carries an
...
OEIS A232118 is ``Number of (n+1)X(2+1) 0..2 arrays with every element both >= and <= some horizontal or vertical neighbor.''. It has offset $1$ and begins
\[
109, 1667, 26029, 411015, 6462505, 101738935, 1601238913, 25202545399,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 06:53:01, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;14\,a(n-1) + 18\,a(n-2) + 134\,a(n-3) + 232\,a(n-4) + 22\,a(n-5) - 4664\,a(n-6) - 1670\,a(n-7) - 31429\,a(n-8) + 20772\,a(n-9) + 42003\,a(n-10) + 145199\,a(n-11) + 179692\,a(n-12) - 283953\,a(n-13) - 254162\,a(n-14) + 25191\,a(n-15) - 329068\,a(n-16) - 114068\,a(n-17) + 322177\,a(n-18) + 10967\,a(n-19) - 35917\,a(n-20) + 142213\,a(n-21) + 4789\,a(n-22) - 24226\,a(n-23) + 34292\,a(n-24) + 5017\,a(n-25) - 7373\,a(n-26) - 5490\,a(n-27) - 5910\,a(n-28) - 1491\,a(n-29) - 1034\,a(n-30) + 239\,a(n-31) - 33\,a(n-32) + 82\,a(n-33) + 4\,a(n-35)
\]
for every $n>34$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232118.
