...
\title{The empirical recurrence for OEIS A265961, proved by transfer matrix}
...
\begin{abstract}
OEIS A265961 counts arrays of width $2$ in which every entry is equal to the NUMBER of its own
...
OEIS A265961 is ``Number of nX2 integer arrays with each element equal to the number of horizontal, vertical and antidiagonal neighbors less than or equal to itself.''. It has offset $1$ and begins
\[
3, 8, 50, 1491, 7741, 82424, 763505, 6210500,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 19 2015 09:15:27, revision 5) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The array has $2$ cells across. The NEIGHBOURS of a cell are the cells reached from it by the
offsets
\[
(-1,0), (-1,1), (0,-1), (0,1), (1,-1), (1,0),
\]
those that lie inside the array. The condition is that every entry counts its own neighbours
that are smaller than or equal to it: writing $v=x(i,j)$,
\[
v\;=\;\#\{\text{neighbours } y \text{ of } (i,j)\ :\ y\le v\} .
\]
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=798.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A265961.
