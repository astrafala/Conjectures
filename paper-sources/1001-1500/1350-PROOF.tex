...
\title{The empirical recurrence for OEIS A269010, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A269010 counts arrays over $\{0,\dots,1\}$ subject to a condition on the array as a
...
OEIS A269010 is ``Number of nX7 binary arrays with some element plus some horizontally, diagonally or antidiagonally adjacent neighbor totalling two exactly once.''. It has offset $1$ and begins
\[
38, 696, 18210, 390064, 8134304, 164351184, 3258530608, 63679868768,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 17 2016 12:04:03, revision 4) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269010.
