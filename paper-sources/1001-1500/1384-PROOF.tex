...
\title{The empirical recurrence for OEIS A268773, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A268773 counts arrays over $\{0,\dots,2\}$ subject to a condition on the array as a
...
OEIS A268773 is ``Number of nX7 0..2 arrays with some element plus some horizontally, vertically, diagonally or antidiagonally adjacent neighbor totalling two exactly once.''. It has offset $1$ and begins
\[
576, 1456, 17000, 198114, 2258084, 24222418, 255353744, 2624246370,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 13 2016 08:27:33, revision 4) the statement is
...
those integers vanishes from the index corresponding to $n=30+1$ onwards, and the run
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268773.
