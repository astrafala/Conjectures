...
\title{The empirical recurrence for OEIS A231193, proved by transfer matrix}
...
\begin{abstract}
OEIS A231193 counts $(n+1)\times3$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
every CELL over a neighbour set the entry names, and counted UP TO RELABELLING of the
alphabet; it carries an empirical recurrence of order $18$ contributed by
...
OEIS A231193 is ``Number of (n+1)X(2+1) 0..2 arrays with no element equal to a strict majority of its horizontal, vertical and antidiagonal neighbors, with values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
67, 1413, 31665, 704428, 15698874, 349736292, 7791727354, 173590087438,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 06:17:28, revision 6) this is still
...
$\{0,\dots,2\}^{3}$. The neighbourhood of a cell in row $u_i$ meets $u_{i-1}$,
...
\begin{theorem}
\[
a(n)\;=\;22\,a(n-1) + 7\,a(n-2) - 24\,a(n-3) + 218\,a(n-4) - 1474\,a(n-5) - 4420\,a(n-6) + 892\,a(n-7) + 1572\,a(n-8) + 5428\,a(n-9) + 124572\,a(n-10) + 179816\,a(n-11) - 55176\,a(n-12) - 492608\,a(n-13) - 667584\,a(n-14) - 56192\,a(n-15) + 368640\,a(n-16) + 246784\,a(n-17) - 61440\,a(n-18)
\]
for every $n>17$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231193.
