...
\title{The empirical recurrence for OEIS A210048, proved by transfer matrix}
...
\begin{abstract}
OEIS A210048 counts arrays of width $5$ whose every $2\times2$ subblock holds a
prescribed number of DISTINCT values, which use ALL of the $3$ available letters, and which
are counted up to renaming. The entry carries an empirical recurrence of order $32$
...
nothing else. Each fixed-alphabet count is a walk count on $S=276$ states in all.
\end{abstract}
...
OEIS A210048 is ``Number of (n+1)X5 0..2 arrays containing all values 0..2 with every 2X2 subblock having two distinct values, and new values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
475, 12377, 332891, 8989701, 240224641, 6356262535, 166752843125, 4344981788295,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 15:39:11, revision 9) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The array has $5$ cells across and entries in $\{0,1,\dots,2\}$. In every
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=276.
\]
...
\begin{theorem}
\[
a(n)\;=\;58\,a(n-1) - 992\,a(n-2) + 1114\,a(n-3) + 104383\,a(n-4) - 609244\,a(n-5) - 3158300\,a(n-6) + 31872941\,a(n-7) + 14255768\,a(n-8) - 695247797\,a(n-9) + 851352494\,a(n-10) + 7722215712\,a(n-11) - 17461446135\,a(n-12) - 44607174085\,a(n-13) + 153341052250\,a(n-14) + 107386696583\,a(n-15) - 724717887559\,a(n-16) + 133505885446\,a(n-17) + 1890011566228\,a(n-18) - 1409205824752\,a(n-19) - 2511295843328\,a(n-20) + 3234462976416\,a(n-21) + 1147782485632\,a(n-22) - 3211415530368\,a(n-23) + 620083812608\,a(n-24) + 1267243773440\,a(n-25) - 658602110976\,a(n-26) - 85186113536\,a(n-27) + 120800202752\,a(n-28) - 16266002432\,a(n-29) - 5194055680\,a(n-30) + 1509949440\,a(n-31) - 104857600\,a(n-32)
\]
for every $n>32$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A210048.
