...
\title{The empirical recurrence for OEIS A208564, proved by counting patterns}
...
\begin{abstract}
OEIS A208564 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
$26$, contributed by R.~H.~Hardin, then follows from a finite exact computation.
\end{abstract}
...
OEIS A208564 is ``Number of nX5 0..2 arrays with new values 0..2 introduced in row major order and no element equal to more than one of its immediate leftward or upward or left-upward diagonal neighbors.''. It has offset $1$ and begins
\[
41, 3168, 260856, 21758476, 1820627588, 152454784170, 12768454002596, 1069433026366756,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:55:40, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;171\,a(n-1) - 10470\,a(n-2) + 325569\,a(n-3) - 5715687\,a(n-4) + 56148167\,a(n-5) - 245912801\,a(n-6) - 484495146\,a(n-7) + 10078833115\,a(n-8) - 31788474833\,a(n-9) - 62614662381\,a(n-10) + 560437441681\,a(n-11) - 642115987254\,a(n-12) - 2499011458897\,a(n-13) + 6268700558495\,a(n-14) + 963700261876\,a(n-15) - 12620524925764\,a(n-16) + 6372190291752\,a(n-17) + 1053712106560\,a(n-18) - 1060563638688\,a(n-19) + 11585781964416\,a(n-20) + 5647581956608\,a(n-21) - 36276070293504\,a(n-22) + 23488582508544\,a(n-23) + 1781937340416\,a(n-24) - 5735198490624\,a(n-25) + 1426902220800\,a(n-26)
\end{equation}
for all $n>27$.
...
For every $n$ with $m=n+0-1\ge26$,
\[
3!\Bigl(a(n)-\sum_i c_i\,a(n-i)\Bigr)\;=\;\mathbf{v}^{\!\top}N^{\,m-26}q(N)\mathbf{1} .
\]
...
\begin{proof}
Substitute \eqref{eq:walk} into the left side and factor $N^{m-26}$ out of
...
column. The vector $w=q(N)\mathbf{1}$ was then formed by $26$ matrix--vector products
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208564.
