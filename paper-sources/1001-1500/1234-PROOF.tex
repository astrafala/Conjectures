...
\title{The empirical recurrence for OEIS A199144, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A199144 counts arrays in which every cell is constrained by its neighbours on \emph{both}
...
lumpable, cutting $4890$ pairs down to $S=342$ states. The entry's empirical recurrence of
order $37$, contributed by R.~H.~Hardin, then follows from a finite exact computation.
\end{abstract}
...
OEIS A199144 is ``Number of nX3 0..3 arrays with values 0..3 introduced in row major order and each element equal to one or two horizontal and vertical neighbors.''. It has offset $1$ and begins
\[
1, 13, 132, 2453, 42420, 794416, 14511531, 268456338,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 08:06:48, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;14\,a(n-1) + 120\,a(n-2) - 646\,a(n-3) - 1320\,a(n-4) + 3562\,a(n-5) + 12682\,a(n-6) + 1896\,a(n-7) - 76623\,a(n-8) + 36670\,a(n-9) + 19724\,a(n-10) - 245388\,a(n-11) + 53233\,a(n-12) + 2738818\,a(n-13) - 138967\,a(n-14) - 11411168\,a(n-15) + 3626519\,a(n-16) + 17979294\,a(n-17) - 10633666\,a(n-18) - 27553810\,a(n-19) + 19090457\,a(n-20) + 20077526\,a(n-21) - 32139160\,a(n-22) + 46609580\,a(n-23) + 115127457\,a(n-24) + 146403730\,a(n-25) + 50426678\,a(n-26) - 122760336\,a(n-27) - 143444310\,a(n-28) - 587979162\,a(n-29) - 679787397\,a(n-30) - 166474764\,a(n-31) - 212565465\,a(n-32) + 6372918\,a(n-33) + 256248603\,a(n-34) + 47278566\,a(n-35) - 708588\,a(n-36) - 12754584\,a(n-37)
\end{equation}
for all $n>38$.
...
Assembling the $4$ lumped chains block-diagonally into $N$ of size $S=342$, with the
...
index,
\[
4!\Bigl(a(n)-\sum_i c_i\,a(n-i)\Bigr)\;=\;\mathbf{v}^{\!\top}G^{\,j-37}\,
\Bigl(h_{37}-\sum_i c_i h_{37-i}\Bigr)
\]
...
$w=h_{37}-\sum_i c_ih_{37-i}$; and it is enough to check $m=0,1,\dots,S-1$.
\end{lemma}
...
index corresponding to $n=38+1$ onwards, and the run was continued until $S+1$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A199144.
