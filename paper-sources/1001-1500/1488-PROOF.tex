...
\title{The empirical recurrence for OEIS A231780, proved by transfer matrix}
...
\begin{abstract}
OEIS A231780 counts arrays of width $3$ over $\{0,1,2\}$ in which no cell is beaten by a strict majority of its neighbours. The entry carries an
...
$3$ consecutive rows and the count is a walk count on $S=559$ states.
\end{abstract}
...
OEIS A231780 is ``Number of nX3 0..2 arrays with no element having a strict majority of its horizontal and vertical neighbors equal to itself plus one mod 3, with upper left element zero (rock paper and scissors drawn positions).''. It has offset $1$ and begins
\[
3, 74, 854, 9892, 115110, 1339532, 15587828, 181392458,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 08:46:29, revision 6) this is still
...
Thus
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=559,
\]
...
\begin{theorem}
\[
a(n)\;=\;14\,a(n-1) - 22\,a(n-2) - 76\,a(n-3) + 119\,a(n-4) + 271\,a(n-5) - 326\,a(n-6) - 446\,a(n-7) + 265\,a(n-8) + 184\,a(n-9) + 336\,a(n-10) - 2\,a(n-11) + 184\,a(n-12) - 359\,a(n-13) + 287\,a(n-14) - 299\,a(n-15) - 38\,a(n-16) - 45\,a(n-17) + 26\,a(n-18) - 8\,a(n-19) - 6\,a(n-20) - 2\,a(n-21)
\]
for every $n>22$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231780.
