...
\title{The empirical recurrence for OEIS A269086, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A269086 counts arrays over $\{0,\dots,1\}$ subject to a condition on the array as a
...
OEIS A269086 is ``Number of nX5 binary arrays with some element plus some horizontally, vertically or antidiagonally adjacent neighbor totalling two not more than once.''. It has offset $1$ and begins
\[
23, 191, 1531, 11314, 80422, 555789, 3761534, 25063389,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 19 2016 09:21:45, revision 4) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269086.
