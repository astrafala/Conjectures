...
\title{The empirical recurrence for OEIS A275262, proved by counting patterns}
...
\begin{abstract}
OEIS A275262 counts arrays in which no entry may repeat a value found at any of three stated
...
cutting $6818$ pairs to $S=1223$ states. The entry's empirical recurrence of order $43$,
...
OEIS A275262 is ``Number of nX4 0..2 arrays with no element equal to any value at offset (-2,-1) (-2,1) or (-1,-1) and new values introduced in order 0..2.''. It has offset $1$ and begins
\[
14, 324, 688, 2564, 13156, 73012, 409728, 2315520,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 21 2016 11:31:49, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;9\,a(n-1) - 8\,a(n-2) - 91\,a(n-3) + 200\,a(n-4) - 365\,a(n-5) + 232\,a(n-6) + 6547\,a(n-7) - 12399\,a(n-8) - 3096\,a(n-9) + 20040\,a(n-10) - 163736\,a(n-11) + 284668\,a(n-12) + 287340\,a(n-13) - 842028\,a(n-14) + 1933364\,a(n-15) - 2630928\,a(n-16) - 4625380\,a(n-17) + 11081600\,a(n-18) - 11258432\,a(n-19) + 7949632\,a(n-20) + 34727136\,a(n-21) - 65185920\,a(n-22) + 24698432\,a(n-23) + 19096576\,a(n-24) - 124436288\,a(n-25) + 173188864\,a(n-26) + 14216192\,a(n-27) - 143664128\,a(n-28) + 195146752\,a(n-29) - 191841280\,a(n-30) - 91961344\,a(n-31) + 251741184\,a(n-32) - 138330112\,a(n-33) + 51499008\,a(n-34) + 91783168\,a(n-35) - 160559104\,a(n-36) + 42188800\,a(n-37) + 27852800\,a(n-38) - 34209792\,a(n-39) + 33554432\,a(n-40) - 4194304\,a(n-41) - 11534336\,a(n-42) + 4194304\,a(n-43)
\end{equation}
for all $n>47$.
...
Fix $i$, let $V_i=\{0,\dots,i-1\}^{4}$ and take $\mathcal V=V_i\times V_i$ as vertices.
...
$o=1n_0+0-2$, we have for $j\ge43$
\[
3!\Bigl(a(n_0+j)-\sum_i c_i\,a(n_0+j-i)\Bigr)
=\mathbf{v}^{\!\top}G^{\,j-43}w,\qquad
w=h_{43}-\sum_i c_i h_{43-i} .
\]
...
the survivors by the pattern of the new pair. The vector $w$ was formed by $43$
...
index corresponding to $n=47+1$ onwards, and the run continued until $S+1$ consecutive
zeros had been seen.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A275262.
