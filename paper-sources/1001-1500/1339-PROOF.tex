...
\title{The empirical recurrence for OEIS A262796, proved by transfer matrix}
...
\begin{abstract}
OEIS A262796 counts arrays of width $3$ over $\{0,1\}$ whose rows, read as base-$2$
...
OEIS A262796 is ``Number of (1+2)X(n+2) 0..1 arrays with each row divisible by 5 and column not divisible by 5, read as a binary number with top and left being the most significant bits.''. It has offset $1$ and begins
\[
0, 36, 76, 344, 2178, 15556, 82386, 479148,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 02 2015 08:14:44, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A262796.
