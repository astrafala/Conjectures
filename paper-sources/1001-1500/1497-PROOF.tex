...
\title{The empirical recurrence for OEIS A230690, proved by transfer matrix}
...
\begin{abstract}
OEIS A230690 counts arrays of width $3$ over $\{0,1,2\}$ in which every cell must see, among its
...
the count is a walk count on $S=547$ states.
\end{abstract}
...
OEIS A230690 is ``Number of (n+2)X(1+2) 0..2 arrays x(i,j) with each element horizontally, vertically, diagonally or antidiagonally next to at least two elements with value (x(i,j)+1) mod 3, and upper left element zero.''. It has offset $1$ and begins
\[
2, 4, 21, 139, 913, 6276, 43544, 301609,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 05:56:56, revision 7) this is still
...
its neighbours there be at least $2$ carrying $v+1 \bmod 3$. The top left
cell is fixed at $0$.
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=547.
\]
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-1) - 2\,a(n-2) + 26\,a(n-3) - 115\,a(n-4) + 96\,a(n-5) - 242\,a(n-6) + 559\,a(n-7) - 460\,a(n-8) + 731\,a(n-9) - 1062\,a(n-10) + 238\,a(n-11) - 1160\,a(n-12) + 1284\,a(n-13) + 261\,a(n-14) + 936\,a(n-15) - 830\,a(n-16) + 1008\,a(n-17) - 453\,a(n-19) + 128\,a(n-20) - 5\,a(n-21) - a(n-22)
\]
for every $n>21$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A230690.
