...
\title{The empirical recurrence for OEIS A231910, proved by transfer matrix}
...
\begin{abstract}
OEIS A231910 counts arrays of width $3$ over $\{0,1,2\}$ in which no cell is beaten by a strict majority of its neighbours. The entry carries an
...
$3$ consecutive rows and the count is a walk count on $S=739$ states.
\end{abstract}
...
OEIS A231910 is ``Number of 3Xn 0..2 arrays with no element having a strict majority of its horizontal, diagonal and antidiagonal neighbors equal to itself plus one mod 3, with upper left element zero (rock paper and scissors drawn positions).''. It has offset $1$ and begins
\[
9, 74, 1740, 31167, 614818, 11900005, 232002949, 4514456816,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 08:49:39, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;25\,a(n-1) - 74\,a(n-2) - 852\,a(n-3) + 4181\,a(n-4) - 7225\,a(n-5) + 7538\,a(n-6) + 128074\,a(n-7) - 575187\,a(n-8) + 474991\,a(n-9) + 1290498\,a(n-10) - 5643395\,a(n-11) + 11235081\,a(n-12) - 6876205\,a(n-13) - 13812844\,a(n-14) + 44285324\,a(n-15) - 61998106\,a(n-16) + 30746044\,a(n-17) + 32934284\,a(n-18) - 85982375\,a(n-19) + 89888553\,a(n-20) + 25323577\,a(n-21) - 123867238\,a(n-22) + 3745228\,a(n-23) + 100101799\,a(n-24) - 19008471\,a(n-25) - 4298843\,a(n-26) - 46455630\,a(n-27) + 34645416\,a(n-28) - 8451931\,a(n-29) + 2428296\,a(n-30) + 1766396\,a(n-31) - 1604198\,a(n-32) + 204663\,a(n-33) - 25395\,a(n-34) + 7366\,a(n-35) + 1736\,a(n-36) + 144\,a(n-37)
\]
for every $n>38$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231910.
