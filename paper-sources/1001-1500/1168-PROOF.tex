...
\title{The empirical recurrence for OEIS A204526, proved by transfer matrix}
...
\begin{abstract}
OEIS A204526 counts $(n+2)\times3$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A204526 is ``Number of (n+2)X3 0..3 arrays with every 3X3 subblock having three equal elements in a row horizontally, vertically or nw-to-se diagonally, and new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
4110, 145760, 5541588, 179863061, 6251895139, 219672303729, 7527325628251, 260515164220350,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 11:18:16, revision 10) this is still
...
\[
\text{at least one}\text{ of the horizontally, vertically or nw-to-se diagonally lines of }g\text{ \text{is constant}}
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204526.
