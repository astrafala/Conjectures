...
\title{The empirical recurrence for OEIS A240632, proved by transfer matrix}
...
\begin{abstract}
OEIS A240632 counts arrays of width $4$ over $\{0,\dots,1\}$ under a condition on each cell
and its neighbours, and carries an empirical recurrence of order $32$ contributed by
...
a walk count on $S=274$ of them, and the conjectured recurrence is then settled by a finite
exact computation.
\end{abstract}
...
OEIS A240632 is ``Number of nX4 0..1 arrays with no element equal to exactly three horizontal or vertical neighbors, with new values 0..1 introduced in row major order.''. It has offset $1$ and begins
\[
8, 81, 637, 4989, 38634, 299329, 2319211, 17971509,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 11:03:15, revision 6) this is still
...
(-1,0), (0,-1), (0,1), (1,0),
\]
those falling outside the array being absent. The entry requires that no cell equals exactly $3$ of its neighbours.
...
\]
a triangular system with unit diagonal, so the entry's count $N_1+\dots+N_{2}$ is a
...
$1-v$'' and ``equal to the sum modulo $k$'' all compare or combine letters arithmetically.
...
terms. There are $S=274$ states, and $a$ is $C$-finite.

At $n=1$ the array has one row, and
the condition is tested there with nothing above or below it; the entry's first term is
$8$, which the model reproduces along with every later term. That is the cheapest check
...
first term. There are $2^{4}=16$ possible rows over the entry's own alphabet.
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-1) + 7\,a(n-2) - 9\,a(n-3) - 3\,a(n-4) + 6\,a(n-5) + 11\,a(n-6) + 56\,a(n-7) - 211\,a(n-8) - 553\,a(n-9) - 266\,a(n-10) + 569\,a(n-11) + 514\,a(n-12) + 241\,a(n-13) + 672\,a(n-14) + 985\,a(n-15) + 518\,a(n-16) + 71\,a(n-17) - 161\,a(n-18) - 845\,a(n-19) - 670\,a(n-20) - 783\,a(n-21) - 620\,a(n-22) - 263\,a(n-23) + 134\,a(n-24) + 196\,a(n-25) + 238\,a(n-26) + 159\,a(n-27) + 70\,a(n-28) + 5\,a(n-29) - 14\,a(n-30) - 18\,a(n-31) - 8\,a(n-32)
\]
for every $n>32$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A240632.
