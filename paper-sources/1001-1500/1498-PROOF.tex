...
\title{The empirical recurrence for OEIS A275406, proved by transfer matrix}
...
\begin{abstract}
OEIS A275406 counts arrays in which no entry may equal the entries at a short list of fixed offsets
...
$1$ consecutive columns, $S=295$ states in all.
\end{abstract}
...
OEIS A275406 is ``Number of 7Xn 0..2 arrays with no element equal to any value at offset (-2,-1) (-2,0) or (-1,1) and new values introduced in order 0..2.''. It has offset $1$ and begins
\[
48, 260, 2645, 27373, 283169, 2940064, 30551417, 317215507,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 26 2016 14:58:01, revision 4) this is still
...
\[
x(i,j)\ \ne\ x(i+d_1,\,j+d_2)\qquad\text{for each offset }(d_1,d_2)\in\{(-2,-1), (-2,0), (-1,1)\}
\]
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=295.
\]
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 51\,a(n-2) + 337\,a(n-3) + 695\,a(n-4) - 1387\,a(n-5) - 17115\,a(n-6) - 7374\,a(n-7) - 6423\,a(n-8) + 162272\,a(n-9) - 77464\,a(n-10) + 195500\,a(n-11) - 502027\,a(n-12) + 476993\,a(n-13) - 89619\,a(n-14) + 690641\,a(n-15) - 729684\,a(n-16) + 108400\,a(n-17) - 61140\,a(n-18) + 17920\,a(n-19) + 2032\,a(n-20) + 1088\,a(n-21)
\]
for every $n>22$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A275406.
