...
\title{The empirical recurrence for OEIS A223797, proved by transfer matrix}
...
\begin{abstract}
OEIS A223797 counts arrays over $\{0,\dots,3\}$ whose rows, columns, diagonals or
antidiagonals are required to be monotone or unimodal, and carries an empirical recurrence of
order $27$ contributed by R.~H.~Hardin. A monotone condition is local, but a unimodal one
...
is a walk count on $S=2080$ vertices and the recurrence follows from a finite exact
computation.
\end{abstract}
...
OEIS A223797 is ``Number of nX4 0..3 arrays with rows and antidiagonals unimodal.''. It has offset $1$ and begins
\[
130, 16900, 1658703, 151310069, 13602542576, 1216562667529, 108631485025292, 9695922803812530,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 22:30:33, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;130\,a(n-1) - 4151\,a(n-2) + 55367\,a(n-3) - 1103289\,a(n-4) + 25676564\,a(n-5) - 311713584\,a(n-6) + 2153547070\,a(n-7) - 14084700670\,a(n-8) + 111538734736\,a(n-9) - 678666743150\,a(n-10) + 3151156493032\,a(n-11) - 15705615808280\,a(n-12) + 74227237529348\,a(n-13) - 265525650225285\,a(n-14) + 858145104057893\,a(n-15) - 2835818034237058\,a(n-16) + 7784228337705693\,a(n-17) - 17375928755819704\,a(n-18) + 37062908059029592\,a(n-19) - 69764230981154356\,a(n-20) + 99762651233668576\,a(n-21) - 119132184363098064\,a(n-22) + 127177566453563712\,a(n-23) - 90807087696380928\,a(n-24) + 28396177139635200\,a(n-25) - 1473691515457536\,a(n-26) + 18962192793600\,a(n-27)
\end{equation}
for all $n>27$.
...
bit vector), $|\mathcal V|=S=2080$; let $(r,f)\to(s,f')$ be an edge when placing $s$ after $r$
...
$h_j=G^{j}N^{o}\mathbf{1}$, we have for $j\ge27$
\[
...
every one of the $12$ published indices, with no shift fitted. The values agree exactly.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223797.
