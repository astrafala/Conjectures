...
\title{The empirical recurrence for OEIS A275224, proved by counting patterns}
...
\begin{abstract}
OEIS A275224 counts arrays in which no entry may repeat a value found at any of three stated
...
cutting $6818$ pairs to $S=1223$ states. The entry's empirical recurrence of order $31$,
...
OEIS A275224 is ``Number of nX4 0..2 arrays with no element equal to any value at offset (-2,-1) (-2,1) or (-1,0) and new values introduced in order 0..2.''. It has offset $1$ and begins
\[
14, 216, 339, 1302, 6448, 32388, 164645, 844176,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 20 2016 18:25:24, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) - 4\,a(n-2) + 18\,a(n-4) - 213\,a(n-5) + 254\,a(n-6) - 43\,a(n-7) + 348\,a(n-8) + 571\,a(n-9) - 1746\,a(n-10) - 33\,a(n-11) + 741\,a(n-12) - 1412\,a(n-13) + 2606\,a(n-14) - 243\,a(n-15) - 667\,a(n-16) + 1424\,a(n-17) - 2763\,a(n-18) + 1382\,a(n-19) - 742\,a(n-20) + 329\,a(n-21) + 281\,a(n-22) - 97\,a(n-23) + 88\,a(n-24) - 62\,a(n-25) - 27\,a(n-26) - 3\,a(n-27) + 7\,a(n-28) - a(n-29) + 3\,a(n-30) - a(n-31)
\end{equation}
for all $n>35$.
...
$o=1n_0+0-2$, we have for $j\ge31$
\[
3!\Bigl(a(n_0+j)-\sum_i c_i\,a(n_0+j-i)\Bigr)
=\mathbf{v}^{\!\top}G^{\,j-31}w,\qquad
w=h_{31}-\sum_i c_i h_{31-i} .
\]
...
the survivors by the pattern of the new pair. The vector $w$ was formed by $31$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A275224.
