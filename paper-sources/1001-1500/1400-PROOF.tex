...
\title{The empirical recurrence for OEIS A266056, proved by transfer matrix}
...
\begin{abstract}
OEIS A266056 counts arrays of width $2$ in which every entry is equal to the NUMBER of its own
...
OEIS A266056 is ``Number of 2Xn integer arrays with each element equal to the number of horizontal and antidiagonal neighbors less than or equal to itself.''. It has offset $1$ and begins
\[
1, 7, 12, 58, 598, 4427, 26350, 164148,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 20 2015 10:27:07, revision 4) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=289.
\]
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + 11\,a(n-2) + 51\,a(n-3) + 156\,a(n-4) + 141\,a(n-5) - 429\,a(n-6) - 2785\,a(n-7) - 5505\,a(n-8) - 4470\,a(n-9) + 6355\,a(n-10) + 33613\,a(n-11) + 32025\,a(n-12) - 21483\,a(n-13) - 43190\,a(n-14) - 23519\,a(n-15) - 2201\,a(n-16) + 16965\,a(n-17) + 9808\,a(n-18) - 2953\,a(n-19) - 715\,a(n-20) + 1191\,a(n-21) - 528\,a(n-22) - 3\,a(n-23) + 143\,a(n-24) - 39\,a(n-25) + 15\,a(n-26)
\]
for every $n>26$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A266056.
