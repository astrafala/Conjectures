...
\title{The empirical recurrence for OEIS A281712, proved by transfer matrix}
...
\begin{abstract}
OEIS A281712 counts $n\times5$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A281712 is ``Number of nX5 0..1 arrays with no element unequal to a strict majority of its horizontal, diagonal and antidiagonal neighbors and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
3, 29, 90, 294, 937, 3166, 10738, 37285,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 28 2017 13:43:18, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) - 2\,a(n-2) - 9\,a(n-3) - 17\,a(n-4) + 18\,a(n-5) + 45\,a(n-6) + 5\,a(n-7) - 46\,a(n-8) - 14\,a(n-9) + 102\,a(n-10) - 101\,a(n-11) + 167\,a(n-12) - 132\,a(n-13) - 151\,a(n-14) + 2\,a(n-15) - 214\,a(n-16) + 40\,a(n-17) - 115\,a(n-18) - 55\,a(n-19) - 37\,a(n-20) - 17\,a(n-21) - 2\,a(n-22) - 15\,a(n-23) + 4\,a(n-24)
\]
for every $n>28$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A281712.
