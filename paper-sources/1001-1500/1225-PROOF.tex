...
\title{The empirical recurrence for OEIS A210161, proved by counting patterns}
...
\begin{abstract}
OEIS A210161 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A210161 is ``Number of (n+1)X5 0..3 arrays with every 2X2 subblock having two or three distinct values, and new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
27720, 17864271, 11572169594, 7497695247894, 4857832789667601, 3147440073860364317, 2039258946769923053510, 1321256944854221652586980,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 15:47:43, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;651\,a(n-1) + 2491\,a(n-2) - 3033274\,a(n-3) + 75213828\,a(n-4) + 2871779009\,a(n-5) - 168547329017\,a(n-6) + 3025868330721\,a(n-7) - 14913244152146\,a(n-8) - 227860409342090\,a(n-9) + 3284704577622354\,a(n-10) - 4647468768394855\,a(n-11) - 151912308978989829\,a(n-12) + 746051218249104195\,a(n-13) + 2759862594209092375\,a(n-14) - 24875375814765882871\,a(n-15) - 12826708391148092367\,a(n-16) + 412811120432989292070\,a(n-17) - 271333439668914274397\,a(n-18) - 3949195606845988432506\,a(n-19) + 4878572324314521633479\,a(n-20) + 22621015632021698182303\,a(n-21) - 35706585467435371532954\,a(n-22) - 76058853813329983983298\,a(n-23) + 141387729457080507256936\,a(n-24) + 137247708151497848656089\,a(n-25) - 312567964628714713985554\,a(n-26) - 99662573283231077847331\,a(n-27) + 367361272953844857693772\,a(n-28) - 21661696257415105631489\,a(n-29) - 209997903963825729024970\,a(n-30) + 56676111775642707907746\,a(n-31) + 53600108892623612777764\,a(n-32) - 22156986755762524106826\,a(n-33) - 5080148629481596023904\,a(n-34) + 3198197489711999573012\,a(n-35) + 14089783129953149268\,a(n-36) - 171981655847047928312\,a(n-37) + 15964369340316597080\,a(n-38) + 1991492927343812928\,a(n-39) - 247274191930612320\,a(n-40)
\end{equation}
for all $n>40$.
...
For every $n$ with $m=n+1-1\ge40$,
\[
4!\Bigl(a(n)-\sum_i c_i\,a(n-i)\Bigr)\;=\;\mathbf{v}^{\!\top}N^{\,m-40}q(N)\mathbf{1} .
\]
...
corresponding to $n=40+1$ onwards, and the run continued until $w$ was the zero vector,
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A210161.
