...
\title{The empirical recurrence for OEIS A240041, proved by transfer matrix}
...
\begin{abstract}
OEIS A240041 counts arrays over $\{0,1,2,3\}$ in which no entry may equal, modulo $4$, a given
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 09:38:48, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A240041.
