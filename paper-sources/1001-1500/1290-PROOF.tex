...
\title{The empirical recurrence for OEIS A239644, proved by transfer matrix}
...
OEIS A239644 is ``Number of nX3 0..3 arrays with no element equal to zero plus the sum of elements to its left or two plus the sum of elements above it, modulo 4.''. It has offset $1$ and begins
\[
8, 92, 1182, 13476, 158728, 1864886, 21813374, 255830770,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 09:30:26, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A239644.
