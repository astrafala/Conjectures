...
\title{The empirical recurrence for OEIS A228794, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A228794 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A228794 is ``Number of n X 6 binary arrays with top left element equal to 1 and no two ones adjacent horizontally or nw-se.''. It has offset $1$ and begins
\[
8, 98, 1394, 19474, 272952, 3835792, 53992646, 760460212,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 21*a(n-1) - 112*a(n-2) + 217*a(n-3) - 157*a(n-4) + 36*a(n-5) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 13 2018 06:07:41, revision 13) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;21\,a(n-1) - 112\,a(n-2) + 217\,a(n-3) - 157\,a(n-4) + 36\,a(n-5)
\end{equation}
for all $n>7$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A228794.
