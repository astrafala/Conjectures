...
\title{The empirical recurrence for OEIS A235019, proved by transfer matrix}
...
\begin{abstract}
OEIS A235019 counts $2$-column arrays over $\{0,\dots,5\}$ in which every
...
OEIS A235019 is ``Number of (n+1) X (1+1) 0..5 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 3, with no adjacent elements equal (constant-stress tilted 1 X 1 tilings).''. It has offset
$1$ and begins
\[
88, 332, 1248, 4704, 17728, 66848, 252032,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 18*a(n-2) - 56*a(n-4) + 32*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 19 2022 01:29:29, revision 9) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A235019.
