...
\title{The empirical recurrence for OEIS A236802, proved by transfer matrix}
...
\begin{abstract}
OEIS A236802 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
OEIS A236802 is ``Number of (n+1) X (1+1) 0..2 arrays with the maximum plus the lower median minus the upper median minus the minimum of every 2 X 2 subblock equal.''. It has offset $1$ and begins
\[
81, 277, 1033, 4183, 17481, 75907, 330433, 1468723,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 5*a(n-1) + 20*a(n-2) - 130*a(n-3) + 36*a(n-4) + 600*a(n-5) - 720*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 25 2018 08:41:48, revision 13) this is still
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) + 20\,a(n-2) - 130\,a(n-3) + 36\,a(n-4) + 600\,a(n-5) - 720\,a(n-6)
\]
for every $n>5$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A236802.
