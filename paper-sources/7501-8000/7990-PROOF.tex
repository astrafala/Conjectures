...
\title{The empirical recurrence for OEIS A222337, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A222337 counts arrays over $\{0,\dots,6\}$ in which every cell is constrained by the
...
OEIS A222337 is ``Number of n X 4 0..6 arrays with no entry increasing mod 7 by 6 rightwards or downwards, starting with upper left zero.''. It has offset $1$ and begins
\[
216, 178746, 147918906, 122408393436, 101297497221786, 83827445649884946, 69370328359709445996, 57406526220963704077986,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 873*a(n-1) - 38091*a(n-2) + 387974*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 15 2018 06:42:33, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;873\,a(n-1) - 38091\,a(n-2) + 387974\,a(n-3)
\end{equation}
for all $n>3$.
...
Let $V=\{0,\dots,6\}^{4}$ be the possible rows and take
...
of the $(6+1)^{4}$ possible next rows, the condition was tested on every cell of
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A222337.
