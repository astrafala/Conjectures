...
\title{The empirical recurrence for OEIS A186456, proved by transfer matrix}
...
\begin{abstract}
OEIS A186456 counts the $(n+1)\times4$ arrays over $\{0,\dots,1\}$ in which
...
a state, the count is a walk count on $S=42$ of them, and the conjectured recurrence is then
...
OEIS A186456 is ``Number of (n+1) X 4 binary arrays with every 2 X 2 subblock commuting with each of its horizontal and vertical 2 X 2 subblock neighbors.''. It has offset $1$ and begins
\[
42, 51, 111, 162, 270, 362, 590, 846,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) - 2*a(n-3) + 2*a(n-4) - a(n-5) for n>9.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 17 2018 14:09:45, revision 8) this is still
...
$42$, which the model reproduces along with every later term.
...
\]
on the $S=42$ admissible $2$-tuples. In particular $a$ is $C$-finite.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A186456.
