...
\title{The empirical recurrence for OEIS A231524, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A231524 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A231524 is ``Number of 2 X n 0..1 arrays with no element less than a strict majority of its horizontal, diagonal and antidiagonal neighbors.''. It has offset $1$ and begins
\[
4, 10, 34, 107, 342, 1069, 3381, 10689,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 4*a(n-1) - 3*a(n-2) + a(n-3) + 6*a(n-4) - 18*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 30 2018 02:44:44, revision 11) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231524.
