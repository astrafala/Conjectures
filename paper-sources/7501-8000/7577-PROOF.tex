...
\title{The empirical recurrence for OEIS A283852, proved by transfer matrix}
...
\begin{abstract}
OEIS A283852 counts $n\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A283852 is ``Number of n X 3 0..1 arrays with no 1 equal to more than three of its horizontal, diagonal and antidiagonal neighbors.''. It has offset $1$ and begins
\[
8, 61, 409, 2837, 19776, 137459, 955680, 6645662,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 7*a(n-1) - 2*a(n-2) + 19*a(n-3) - 50*a(n-4) - 2*a(n-5) - 48*a(n-6) + 88*a(n-7) - 32*a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 22 2019 05:49:59, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-1) - 2\,a(n-2) + 19\,a(n-3) - 50\,a(n-4) - 2\,a(n-5) - 48\,a(n-6) + 88\,a(n-7) - 32\,a(n-8)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A283852.
