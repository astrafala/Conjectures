...
\title{A condition on each element and its neighbours: OEIS A183437}
...
\begin{abstract}
OEIS A183437 carries an empirical recurrence of order $9$ contributed by R.~H.~Hardin. It is
...
OEIS A183437 is ``Number of n X 4 binary arrays with every 1 having exactly one king-move neighbor equal to 1.''. It has offset $1$ and begins
\[
4, 28, 89, 361, 1620, 6392, 26243, 109483,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + 6*a(n-2) + 26*a(n-3) + 15*a(n-4) - 12*a(n-5) - 52*a(n-6) - 28*a(n-7) - 18*a(n-8) + 7*a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 29 2018 06:28:57, revision 9) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{The count is a walk count}

The entry counts arrays with $4$ columns over the alphabet $\{0,1\}$, growing one row at a time. Its condition is that every entry equal to $1$ must have exactly $1$ of its eight king-move neighbours equal to $1$.
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 6\,a(n-2) + 26\,a(n-3) + 15\,a(n-4) - 12\,a(n-5) - 52\,a(n-6) - 28\,a(n-7) - 18\,a(n-8) + 7\,a(n-9)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A183437.
