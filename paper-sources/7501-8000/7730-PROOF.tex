...
\title{The empirical recurrence for OEIS A237244, proved by transfer matrix}
...
\begin{abstract}
OEIS A237244 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
The condition is local to two consecutive rows, so the count is a walk count on $S=1488$
...
OEIS A237244 is ``Number of (n+1)X(3+1) 0..2 arrays with the maximum plus the upper median minus the lower median minus the minimum of every 2X2 subblock differing from its horizontal and vertical neighbors by exactly one.''. It has offset $1$ and begins
\[
1488, 12600, 108652, 974864, 8433384, 72877504, 629104640, 5642567936,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 11576*a(n-4) -33493888*a(n-8) for n>11
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 10:01:06, revision 6) this is still
...
differ by $1$. The entry's first term $1488$ counts those, and the model was made to
...
\]
over the $S=1488$ pairs whose own subblock row already satisfies the condition along itself.
...
\begin{theorem}
\[
a(n)\;=\;11576\,a(n-4) - 33493888\,a(n-8)
\]
for every $n>11$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237244.
