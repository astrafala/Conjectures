...
\title{The empirical recurrence for OEIS A298057, proved by transfer matrix}
...
\begin{abstract}
OEIS A298057 counts $2$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A298057 is ``Number of n X 2 0..1 arrays with every element equal to 1, 3, 4 or 6 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 4, 3, 13, 32, 53, 125, 386,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) + a(n-2) + 8*a(n-3) - 16*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 22 2018 17:07:52, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A298057.
