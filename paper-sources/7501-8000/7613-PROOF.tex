...
\title{The empirical recurrence for OEIS A220739, proved by transfer matrix}
...
\begin{abstract}
OEIS A220739 counts the ways of linking the cells of a grid $2$ cells wide, each cell either to
...
OEIS A220739 is ``Number of ways to reciprocally link elements of an 2 X n array either to themselves or to exactly two horizontal, diagonal and antidiagonal neighbors, without consecutive collinear links.''. It has offset $1$ and begins
\[
1, 2, 5, 13, 32, 85, 221, 578,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + 2*a(n-2) - 2*a(n-4) - 2*a(n-5) + a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 03 2018 05:09:08, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 2\,a(n-2) - 2\,a(n-4) - 2\,a(n-5) + a(n-6)
\]
for every $n>5$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A220739.
