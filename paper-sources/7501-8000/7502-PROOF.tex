...
\title{The empirical recurrence for OEIS A185764, proved by transfer matrix}
...
\begin{abstract}
OEIS A185764 counts arrays over $\{0,\dots,1\}$ under a condition on the trace of every
...
OEIS A185764 is ``Number of (n+1) X 5 binary arrays with no 2 X 2 subblock trace equal to any horizontal or vertical neighbor 2 X 2 subblock trace.''. It has offset $1$ and begins
\[
264, 1128, 5272, 24832, 118248, 562800, 2680000, 12760448,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + 17*a(n-2) + 9*a(n-3) - 22*a(n-4) - a(n-5) + a(n-6) - 6*a(n-7) for n>9.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 16 2018 18:03:08, revision 10) this is still
...
entry's first term is $264$, and the model reproduces it along with every later term; that
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 17\,a(n-2) + 9\,a(n-3) - 22\,a(n-4) - a(n-5) + a(n-6) - 6\,a(n-7)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A185764.
