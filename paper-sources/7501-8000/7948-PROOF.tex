...
\title{The empirical recurrence for OEIS A303192, proved by transfer matrix}
...
\begin{abstract}
OEIS A303192 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A303192 is ``Number of nX3 0..1 arrays with every element equal to 0, 1, 3, 5 or 6 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
3, 9, 12, 23, 62, 122, 305, 793,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) -a(n-2) +11*a(n-3) -15*a(n-4) +6*a(n-5) -10*a(n-6) +6*a(n-7) for n>11
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 19 2018 13:33:20, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) - a(n-2) + 11\,a(n-3) - 15\,a(n-4) + 6\,a(n-5) - 10\,a(n-6) + 6\,a(n-7)
\end{equation}
for all $n>11$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A303192.
