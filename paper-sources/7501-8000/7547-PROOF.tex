...
\title{The empirical recurrence for OEIS A202529, proved by transfer matrix}
...
\begin{abstract}
OEIS A202529 counts arrays of width $7$ over $\{0,1\}$ containing no occurrence of certain short
...
OEIS A202529 is ``Number of (n+2) X 7 binary arrays avoiding patterns 000 and 101 in rows, columns and nw-to-se diagonals.''. It has offset $1$ and begins
\[
1940, 4901, 10240, 21297, 46621, 100550, 214388, 460948,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) +2*a(n-3) -2*a(n-4) -2*a(n-5) +a(n-7) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 01 2018 09:36:33, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A202529.
