...
\title{The empirical recurrence for OEIS A204716, proved by transfer matrix}
...
\begin{abstract}
OEIS A204716 counts arrays over $\{0,\dots,1\}$ under a condition on the permanent of every
...
OEIS A204716 is ``Number of (n+1) X 2 0..1 arrays with the permanents of 2 X 2 subblocks nondecreasing rightwards and downwards.''. It has offset $1$ and begins
\[
16, 51, 156, 450, 1267, 3490, 9490, 25545,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) - a(n-2) - 9*a(n-3) + 4*a(n-4) + 5*a(n-5) - 2*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 03 2018 05:36:16, revision 11) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) - a(n-2) - 9\,a(n-3) + 4\,a(n-4) + 5\,a(n-5) - 2\,a(n-6)
\]
for every $n>6$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204716.
