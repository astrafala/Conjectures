...
\title{The empirical recurrence for OEIS A296968, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A296968 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A296968 is ``Number of n X 2 0..1 arrays with each 1 adjacent to 2, 4 or 5 king-move neighboring 1s.''. It has offset $1$ and begins
\[
1, 5, 11, 21, 59, 145, 323, 793,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) - a(n-2) + 6*a(n-3) - 4*a(n-4) + 2*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 25 2019 14:11:00, revision 7) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) - a(n-2) + 6\,a(n-3) - 4\,a(n-4) + 2\,a(n-5)
\end{equation}
for all $n>6$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A296968.
