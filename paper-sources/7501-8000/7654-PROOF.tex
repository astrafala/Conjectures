...
\title{The empirical recurrence for OEIS A252259, proved by transfer matrix}
...
\begin{abstract}
OEIS A252259 counts $(n+2)\times5$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252259 is ``Number of (n+2) X (3+2) 0..3 arrays with every 3 X 3 subblock row and column sum not equal to 0 2 3 6 or 7 and every 3 X 3 diagonal and antidiagonal sum equal to 0 2 3 6 or 7.''. It has offset $1$ and begins
\[
965, 562, 596, 778, 1260, 1636, 2478, 3940,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + 6*a(n-3) - 6*a(n-4) - 8*a(n-6) + 8*a(n-7) for n>12.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 03 2018 06:25:40, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252259.
