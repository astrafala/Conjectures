...
\title{The empirical recurrence for OEIS A251144, proved by transfer matrix}
...
\begin{abstract}
OEIS A251144 counts $4$-column arrays over $\{0,\dots,2\}$ in which every
...
OEIS A251144 is ``Number of (n+1) X (3+1) 0..2 arrays with every 2 X 2 subblock summing to 4 and no 2 X 2 subblock having exactly two nonzero entries.''. It has offset $1$
and begins
\[
53, 87, 143, 247, 433, 777, 1413, 2607,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) - 5*a(n-3) + a(n-4) + 2*a(n-5)..
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 26 2018 11:23:52, revision 16) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251144.
