...
\title{The empirical recurrence for OEIS A230670, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A230670 counts arrays over $\{0,\dots,2\}$ in which every cell is constrained by the
...
OEIS A230670 is ``Number of n X 3 0..2 arrays x(i,j) with each element horizontally, diagonally or antidiagonally next to at least one element with value 2-x(i,j).''. It has offset $1$ and begins
\[
3, 87, 1173, 17271, 251595, 3669765, 53519163, 780527655,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 14*a(n-1) +9*a(n-2) -9*a(n-3) +30*a(n-4) -19*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 09 2018 11:08:35, revision 11) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;14\,a(n-1) + 9\,a(n-2) - 9\,a(n-3) + 30\,a(n-4) - 19\,a(n-5)
\end{equation}
for all $n>6$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A230670.
