...
\title{The empirical recurrence for OEIS A259956, proved by transfer matrix}
...
\begin{abstract}
OEIS A259956 counts $(n+2)\times4$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A259956 is ``Number of (n+2) X (2+2) 0..1 arrays with each 3 X 3 subblock having clockwise perimeter pattern 00000000 00000001 or 00001001.''. It has offset $1$ and begins
\[
67, 146, 439, 1187, 3227, 8964, 24719, 67952,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + 2*a(n-2) + 6*a(n-3) + 5*a(n-4) + a(n-5) - 2*a(n-6) - 2*a(n-7) - a(n-8) for n>9.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 27 2018 11:58:25, revision 8) this is still
...
\[
\text{the clockwise perimeter word of }g\text{ is a rotation of one of }\{00000000,\ 00000001,\ 00001001\}
\]
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 2\,a(n-2) + 6\,a(n-3) + 5\,a(n-4) + a(n-5) - 2\,a(n-6) - 2\,a(n-7) - a(n-8)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A259956.
