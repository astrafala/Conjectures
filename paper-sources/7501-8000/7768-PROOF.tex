...
\title{The empirical recurrence for OEIS A228685, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A228685 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A228685 is ``Number of 4 X n binary arrays with no two ones adjacent horizontally, diagonally or antidiagonally.''. It has offset $1$ and begins
\[
16, 41, 313, 1152, 6737, 28977, 152048, 699833,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) + 16*a(n-2) - 7*a(n-3) - 18*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 12 2018 12:04:02, revision 10) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A228685.
