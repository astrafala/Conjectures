...
\title{The empirical recurrence for OEIS A205928, proved by transfer matrix}
...
\begin{abstract}
OEIS A205928 counts arrays of width $2$ over $\{0,1,2,3\}$ subject to a condition read round the
...
OEIS A205928 is ``Number of (n+1)X2 0..3 arrays with the number of clockwise edge increases in 2X2 subblocks nondecreasing rightwards and downwards.''. It has offset $1$ and begins
\[
256, 3036, 32208, 319784, 3048544, 28259556, 256692580, 2295975140,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 16*a(n-1) -63*a(n-2) -27*a(n-3) +182*a(n-4) -217*a(n-5) +114*a(n-6) -4*a(n-7) -4*a(n-8) +4*a(n-9)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 12:21:18, revision 9) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A205928.
