...
\title{The empirical recurrence for OEIS A302416, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A302416 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A302416 is ``Number of 3Xn 0..1 arrays with every element equal to 0, 1, 2 or 5 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
4, 25, 30, 66, 142, 289, 599, 1268,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) -3*a(n-2) +4*a(n-3) -4*a(n-4) +a(n-5) for n>9
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 07 2018 17:04:14, revision 4) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302416.
