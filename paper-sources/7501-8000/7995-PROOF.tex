...
\title{The empirical recurrence for OEIS A250577, proved by transfer matrix}
...
\begin{abstract}
OEIS A250577 counts arrays over $\{0,1\}$ in which a statistic taken over short runs
...
OEIS A250577 is ``Number of (n+1) X (2+1) 0..1 arrays with nondecreasing max(x(i,j),x(i,j-1)) in the i direction and nondecreasing min(x(i,j),x(i-1,j)) in the j direction.''. It has offset $1$ and begins
\[
24, 60, 142, 329, 758, 1743, 4009, 9223,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) - 3*a(n-2) - 5*a(n-3) + 8*a(n-4) - 3*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 15 2018 08:37:55, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250577.
