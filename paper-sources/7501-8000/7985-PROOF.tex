...
\title{The empirical recurrence for OEIS A301795, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A301795 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 07 2021 13:24:11, revision 6) the statement is
...
every one of the $34$ published indices, with no shift fitted: the number of columns is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A301795.
