...
\title{The empirical recurrence for OEIS A185763, proved by transfer matrix}
...
\begin{abstract}
OEIS A185763 counts arrays over $\{0,\dots,1\}$ under a condition on the trace of every
$2\times2$ subblock, and carries an empirical recurrence of order $5$ contributed by
...
OEIS A185763 is ``Number of (n+1) X 4 binary arrays with no 2 X 2 subblock trace equal to any horizontal or vertical neighbor 2 X 2 subblock trace.''. It has offset $1$ and begins
\[
104, 368, 1408, 5272, 19992, 75192, 284256, 1071200,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + 10*a(n-2) + 3*a(n-3) - 5*a(n-4) + a(n-5) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 16 2018 22:09:01, revision 9) this is still
...
entry's first term is $104$, and the model reproduces it along with every later term; that
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 10\,a(n-2) + 3\,a(n-3) - 5\,a(n-4) + a(n-5)
\]
for every $n>6$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A185763.
