...
\title{The empirical recurrence for OEIS A186475, proved by transfer matrix}
...
\begin{abstract}
OEIS A186475 counts the $(n+1)\times3$ arrays over $\{0,\dots,3\}$ in which
...
a state, the count is a walk count on $S=205$ of them, and the conjectured recurrence is then
...
OEIS A186475 is ``Number of (n+1) X 3 0..3 arrays with every 2 X 2 subblock commuting with each of its horizontal and vertical 2 X 2 subblock neighbors.''. It has offset $1$ and begins
\[
205, 362, 701, 2049, 3442, 8223, 14492, 35081,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + 2*a(n-2) - 6*a(n-3) + 6*a(n-4) - 3*a(n-5) for n>13.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 18 2018 10:35:14, revision 8) this is still
...
$205$, which the model reproduces along with every later term.
...
\]
on the $S=205$ admissible $2$-tuples. In particular $a$ is $C$-finite.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A186475.
