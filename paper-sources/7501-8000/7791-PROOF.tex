...
\title{The empirical recurrence for OEIS A186467, proved by transfer matrix}
...
\begin{abstract}
OEIS A186467 counts the $(n+1)\times5$ arrays over $\{0,\dots,2\}$ in which
...
a state, the count is a walk count on $S=367$ of them, and the conjectured recurrence is then
...
OEIS A186467 is ``Number of (n+1) X 5 0..2 arrays with every 2 X 2 subblock commuting with each of its horizontal and vertical 2 X 2 subblock neighbors.''. It has offset $1$ and begins
\[
367, 562, 1203, 3186, 4875, 9834, 14883, 31866,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + a(n-2) - 4*a(n-3) + 4*a(n-4) - 2*a(n-5) for n>13.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 18 2018 10:28:04, revision 8) this is still
...
$367$, which the model reproduces along with every later term.
...
\]
on the $S=367$ admissible $2$-tuples. In particular $a$ is $C$-finite.
...
size of the construction is therefore $3^{2\cdot5}$ before the condition prunes
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A186467.
