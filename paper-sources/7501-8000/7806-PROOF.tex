...
\title{The empirical recurrence for OEIS A253537, proved by transfer matrix}
...
\begin{abstract}
OEIS A253537 counts the arrays over $\{0,\dots,1\}$ whose $3\times3$ subblocks carry a
...
so the count is a walk count on $S=96$ states --- the last two array rows together with the
...
OEIS A253537 is ``Number of (n+2) X (1+2) 0..1 arrays with every 3 X 3 subblock diagonal maximum minus antidiagonal minimum nonincreasing horizontally and nondecreasing vertically.''. It has offset $1$ and begins
\[
512, 3328, 20480, 119040, 679936, 3825920, 21426176, 119525632,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 8*a(n-1) - 7*a(n-2) - 56*a(n-3) + 120*a(n-4) - 64*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 20 2018 11:18:32, revision 8) this is still
...
\]
on the $S=96$ reachable states. In particular $a$ is $C$-finite. The alignment of the walk
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-1) - 7\,a(n-2) - 56\,a(n-3) + 120\,a(n-4) - 64\,a(n-5)
\]
for every $n>5$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253537.
