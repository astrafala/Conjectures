...
\title{The empirical recurrence for OEIS A188829, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A188829 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A188829 is ``Number of 7 X n binary arrays without the pattern 0 1 diagonally or antidiagonally.''. It has offset $1$ and begins
\[
128, 64, 224, 784, 2800, 10000, 36000, 129600,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 5*a(n-1) - 25*a(n-3) + 25*a(n-4) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 30 2018 12:24:02, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) - 25\,a(n-3) + 25\,a(n-4)
\end{equation}
for all $n>5$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A188829.
