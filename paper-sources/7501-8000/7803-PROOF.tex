...
\title{The empirical recurrence for OEIS A234139, proved by transfer matrix}
...
\begin{abstract}
OEIS A234139 counts $(n+1)\times8$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A234139 is ``Number of (n+1) X (7+1) 0..3 arrays with every 2 X 2 subblock having the sum of the absolute values of all six edge and diagonal differences equal to 9.''. It has offset $1$ and begins
\[
9216, 9992, 11336, 14120, 19368, 30632, 53288, 104744,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) + 8*a(n-2) - 30*a(n-3) + 4*a(n-4) + 48*a(n-5) - 32*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 13 2018 09:22:54, revision 10) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234139.
