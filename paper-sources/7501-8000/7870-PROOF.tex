...
\title{The empirical recurrence for OEIS A251384, proved by transfer matrix}
...
\begin{abstract}
OEIS A251384 counts $3$-column arrays over $\{0,\dots,2\}$ in which every
...
OEIS A251384 is ``Number of (n+1) X (2+1) 0..2 arrays with every 2 X 2 subblock summing to 2 3 4 5 or 6.''. It has offset $1$
and begins
\[
571, 12457, 271393, 5914339, 128887759, 2808783981, 61210372853, 1333925956743,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 23*a(n-1) - 21*a(n-2) - 119*a(n-3) + 66*a(n-4) + 72*a(n-5) - 32*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 29 2018 10:37:28, revision 10) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;23\,a(n-1) - 21\,a(n-2) - 119\,a(n-3) + 66\,a(n-4) + 72\,a(n-5) - 32\,a(n-6)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251384.
