...
\title{The empirical recurrence for OEIS A183345, proved by transfer matrix}
...
\begin{abstract}
OEIS A183345 counts arrays of width $3$ over $\{0,1\}$ under local conditions relating each cell
...
OEIS A183345 is ``Number of n X 3 binary arrays with each 1 adjacent to exactly one 0 vertically and one 0 horizontally.''. It has offset $1$ and begins
\[
1, 9, 16, 25, 64, 144, 289, 625,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + a(n-2) + 3*a(n-3) + a(n-4) - a(n-5) - a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 28 2018 08:14:01, revision 9) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A183345.
