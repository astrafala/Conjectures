...
\title{The empirical recurrence for OEIS A251136, proved by transfer matrix}
...
\begin{abstract}
OEIS A251136 counts $(n+1)\times8$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A251136 is ``Number of (n+1) X (7+1) 0..2 arrays with no 2 X 2 subblock having the sum of its diagonal elements greater than the maximum of its antidiagonal elements.''. It has offset $1$ and begins
\[
10033, 19548, 30770, 51679, 82431, 135959, 223663, 380641,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 6*a(n-1) - 13*a(n-2) + 10*a(n-3) + 5*a(n-4) - 14*a(n-5) + 9*a(n-6) - 2*a(n-7) for n>10.
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 27 2018 04:21:19, revision 10) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251136.
