...
\title{The empirical recurrence for OEIS A188986, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A188986 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A188986 is ``Number of n X 3 binary arrays without the pattern 0 0 1 antidiagonally or horizontally.''. It has offset $1$ and begins
\[
7, 49, 295, 1793, 10871, 65937, 399911, 2425505,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 6*a(n-1) +a(n-2) -4*a(n-3) +2*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (May 01 2018 09:37:47, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A188986.
