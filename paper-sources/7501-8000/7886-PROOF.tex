...
\title{The empirical recurrence for OEIS A236120, proved by transfer matrix}
...
\begin{abstract}
OEIS A236120 counts arrays over $\{0,\dots,3\}$ subject to a condition on the order
...
OEIS A236120 is ``Number of (n+1) X (1+1) 0..3 arrays colored with the sets of distinct values in every 2 X 2 subblock.''. It has offset $1$ and begins
\[
256, 3096, 37584, 455808, 5529360, 67071552, 813596592, 9869111712,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 6*a(n-1) + 59*a(n-2) + 164*a(n-3) + 264*a(n-4) + 96*a(n-5) - 144*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 20 2018 11:02:32, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A236120.
