...
\title{The empirical recurrence for OEIS A223251, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A223251 counts arrays over $\{0,\dots,4\}$ in which every cell is constrained by the
...
OEIS A223251 is ``Two-loop graph coloring a rectangular array: number of n X 4 0..4 arrays where 0..4 label nodes of a graph with edges 0,1 1,2 2,0 0,3 3,4 4,0 and every array movement to a horizontal or vertical neighbor moves along an edge of this graph.''. It has offset $1$ and begins
\[
80, 1076, 17828, 307144, 5359892, 93770308, 1641741608, 28748561780,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 20*a(n-1) - 28*a(n-2) - 299*a(n-3) + 436*a(n-4) + 476*a(n-5) - 460*a(n-6) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 18 2018 08:43:19, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;20\,a(n-1) - 28\,a(n-2) - 299\,a(n-3) + 436\,a(n-4) + 476\,a(n-5) - 460\,a(n-6)
\end{equation}
for all $n>7$.
...
\{x_{t,u},x_{t+d_1,u+d_2}\}\in E\ \text{ for every offset in }\mathcal N,\quad E=\{\{0,1\},\{0,2\},\{0,3\},\{0,4\},\{1,2\},\{3,4\}\}
\end{equation}
for every cell $(t,u)$.
...
Let $V=\{0,\dots,4\}^{4}$ be the possible rows and take
...
of the $(4+1)^{4}$ possible next rows, the condition was tested on every cell of
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223251.
