...
\title{The empirical recurrence for OEIS A295091, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A295091 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A295091 is ``Number of n X 2 0..1 arrays with each 1 horizontally or vertically adjacent to 1 or 3 1s.''. It has offset $1$ and begins
\[
2, 5, 11, 24, 55, 123, 276, 621,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) + 2*a(n-2) + 2*a(n-3) - a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 21 2018 14:39:26, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A295091.
