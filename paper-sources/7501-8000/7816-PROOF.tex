...
\title{The empirical recurrence for OEIS A188868, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A188868 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A188868 is ``Number of nX3 binary arrays without the pattern 0 0 0 antidiagonally or horizontally.''. It has offset $1$ and begins
\[
7, 49, 316, 2032, 13045, 83737, 537496, 3450100,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 7*a(n-1) -3*a(n-2) -5*a(n-3) +2*a(n-4)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 04:54:22, revision 9) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A188868.
