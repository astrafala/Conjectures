...
\title{The empirical recurrence for OEIS A230470, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A230470 counts arrays over $\{0,\dots,2\}$ in which every cell is constrained by the
...
OEIS A230470 is ``Number of 2 X n 0..2 arrays x(i,j) with each element horizontally, diagonally or antidiagonally next to at least one element with value (x(i,j)+1) mod 3, and upper left element zero.''. It has offset $1$ and begins
\[
0, 0, 0, 36, 216, 1260, 6912, 38340,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 6*a(n-1) - a(n-2) - 12*a(n-3) + 20*a(n-4) + 24*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 21 2018 14:57:27, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) - a(n-2) - 12\,a(n-3) + 20\,a(n-4) + 24\,a(n-5)
\end{equation}
for all $n>6$.
...
publishes, $n=22$, the arrays have $2\cdot22$ cells over
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A230470.
