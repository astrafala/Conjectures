...
\title{The empirical recurrence for OEIS A234484, proved by transfer matrix}
...
\begin{abstract}
OEIS A234484 counts $3$-column arrays over $\{0,\dots,3\}$ in which every
...
OEIS A234484 is ``Number of (n+1) X (2+1) 0..3 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 2 (constant-stress 1 X 1 tilings).''. It has offset
$1$ and begins
\[
242, 926, 3540, 13554, 51950, 199340, 765738,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 10*a(n-1) - 28*a(n-2) + a(n-3) + 54*a(n-4) + 24*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 20 2022 21:32:09, revision 11) the statement is
...
$j=0,1,\dots$. They vanish from $j=4-5+1$ onwards, and the run was continued past
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234484.
