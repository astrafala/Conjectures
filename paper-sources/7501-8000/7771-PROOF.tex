...
\title{The empirical recurrence for OEIS A298959, proved by transfer matrix}
...
\begin{abstract}
OEIS A298959 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A298959 is ``Number of nX4 0..1 arrays with every element equal to 3, 5, 6, 7 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
0, 2, 2, 7, 14, 34, 75, 174,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) +a(n-3) +2*a(n-4) -2*a(n-5)
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 30 2018 13:11:44, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A298959.
