...
\title{The empirical recurrence for OEIS A206857, proved by transfer matrix}
...
\begin{abstract}
OEIS A206857 counts arrays of width $2$ over $\{0,1,2\}$ containing no occurrence of certain short
...
OEIS A206857 is ``Number of n X 2 0..2 arrays avoiding the pattern z z+1 z in any row, column, diagonal or antidiagonal.''. It has offset $1$ and begins
\[
9, 81, 625, 4761, 36481, 279841, 2146225, 16459249,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 8*a(n-1) -5*a(n-2) +18*a(n-3) +7*a(n-4) -2*a(n-5) -a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 20 2018 14:37:41, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-1) - 5\,a(n-2) + 18\,a(n-3) + 7\,a(n-4) - 2\,a(n-5) - a(n-6)
\]
for every $n>5$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206857.
