...
\title{The empirical recurrence for OEIS A305226, proved by transfer matrix}
...
\begin{abstract}
OEIS A305226 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A305226 is ``Number of nX4 0..1 arrays with every element unequal to 0, 1, 2, 3 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
8, 49, 54, 116, 253, 541, 1248, 2831,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +3*a(n-2) +a(n-3) -a(n-4) -3*a(n-5) -2*a(n-6) +2*a(n-7) for n>9
\end{quote}
As of the ``Last modified'' line on the live entry (May 27 2018 17:42:53, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 3\,a(n-2) + a(n-3) - a(n-4) - 3\,a(n-5) - 2\,a(n-6) + 2\,a(n-7)
\end{equation}
for all $n>9$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A305226.
