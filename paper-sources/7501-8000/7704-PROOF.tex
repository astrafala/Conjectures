...
\title{The empirical recurrence for OEIS A235011, proved by transfer matrix}
...
\begin{abstract}
OEIS A235011 counts $3$-column arrays over $\{0,\dots,4\}$ in which every
...
OEIS A235011 is ``Number of (n+1) X (2+1) 0..4 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 3, with no adjacent elements equal (constant-stress tilted 1 X 1 tilings).''. It has offset
$1$ and begins
\[
104, 224, 488, 1112, 2568, 6088, 14600,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) + 4*a(n-2) - 14*a(n-3) - 4*a(n-4) + 16*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 19 2022 01:24:32, revision 9) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A235011.
