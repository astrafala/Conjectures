...
\title{The empirical recurrence for OEIS A251145, proved by transfer matrix}
...
\begin{abstract}
OEIS A251145 counts $5$-column arrays over $\{0,\dots,2\}$ in which every
...
OEIS A251145 is ``Number of (n+1) X (4+1) 0..2 arrays with every 2 X 2 subblock summing to 4 and no 2 X 2 subblock having exactly two nonzero entries.''. It has offset $1$
and begins
\[
107, 161, 247, 401, 667, 1141, 1987, 3521,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) - 5*a(n-3) + a(n-4) + 2*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 26 2018 11:23:38, revision 16) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251145.
