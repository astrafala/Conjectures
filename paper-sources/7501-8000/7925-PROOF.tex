...
\title{The empirical recurrence for OEIS A297860, proved by transfer matrix}
...
\begin{abstract}
OEIS A297860 counts $2$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A297860 is ``Number of n X 2 0..1 arrays with every element equal to 2, 3 or 4 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
0, 1, 2, 5, 10, 25, 54, 125,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-2) + 4*a(n-3) + 2*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 21 2018 14:29:21, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297860.
