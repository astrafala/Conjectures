...
\title{The empirical recurrence for OEIS A228793, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A228793 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A228793 is ``Number of n X 5 binary arrays with top left element equal to 1 and no two ones adjacent horizontally or nw-se.''. It has offset $1$ and begins
\[
5, 42, 411, 3957, 37944, 362511, 3459357, 33001836,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 13*a(n-1) - 36*a(n-2) + 29*a(n-3) - 5*a(n-4) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 13 2018 06:12:16, revision 12) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A228793.
