...
\title{The empirical recurrence for OEIS A316804, proved by transfer matrix}
...
\begin{abstract}
OEIS A316804 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A316804 is ``Number of nX4 0..1 arrays with every element unequal to 0, 1, 2, 3, 4, 5 or 6 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
8, 128, 1905, 28248, 420345, 6256258, 93109949, 1385723098,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 15*a(n-1) -5*a(n-2) +50*a(n-3) -18*a(n-4) -81*a(n-5) +4*a(n-6) +20*a(n-7)
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 14 2018 14:57:22, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;15\,a(n-1) - 5\,a(n-2) + 50\,a(n-3) - 18\,a(n-4) - 81\,a(n-5) + 4\,a(n-6) + 20\,a(n-7)
\end{equation}
for all $n>7$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A316804.
