...
\title{The empirical recurrence for OEIS A231509, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A231509 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A231509 is ``Number of n X 2 0..1 arrays with no element less than a strict majority of its horizontal, vertical, diagonal and antidiagonal neighbors.''. It has offset $1$ and begins
\[
2, 6, 14, 35, 90, 225, 569, 1441,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) + a(n-2) + 3*a(n-3) - 4*a(n-4) - 2*a(n-5) - 4*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 29 2018 08:45:53, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + a(n-2) + 3\,a(n-3) - 4\,a(n-4) - 2\,a(n-5) - 4\,a(n-6)
\end{equation}
for all $n>7$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231509.
