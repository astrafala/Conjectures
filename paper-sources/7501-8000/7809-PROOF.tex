...
\title{The empirical recurrence for OEIS A207792, proved by transfer matrix}
...
\begin{abstract}
OEIS A207792 counts arrays over $\{0,\dots,3\}$ under a condition on the perimeter cycle of
...
OEIS A207792 is ``Number of (n+1) X 2 0..3 arrays with every 2 X 3 or 3 X 2 subblock having an unequal number of clockwise and counterclockwise edge increases.''. It has offset $1$ and begins
\[
256, 2208, 20800, 184416, 1714176, 15376544, 141647296, 1279043040,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + 61*a(n-2) + 83*a(n-3) + 272*a(n-4) + 336*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 25 2018 15:54:56, revision 10) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 61\,a(n-2) + 83\,a(n-3) + 272\,a(n-4) + 336\,a(n-5)
\]
for every $n>5$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207792.
