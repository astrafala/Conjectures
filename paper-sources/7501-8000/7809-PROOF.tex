...
\title{The empirical recurrence for OEIS A316415, proved by transfer matrix}
...
\begin{abstract}
OEIS A316415 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A316415 is ``Number of nX3 0..1 arrays with every element unequal to 0, 1, 2, 5, 6 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
4, 5, 14, 27, 66, 180, 484, 1261,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +3*a(n-2) +4*a(n-3) +2*a(n-4) -3*a(n-5) -9*a(n-6) -6*a(n-7) for n>10
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 02 2018 09:03:40, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 3\,a(n-2) + 4\,a(n-3) + 2\,a(n-4) - 3\,a(n-5) - 9\,a(n-6) - 6\,a(n-7)
\end{equation}
for all $n>10$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A316415.
