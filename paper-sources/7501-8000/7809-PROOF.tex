...
\title{The empirical recurrence for OEIS A233612, proved by transfer matrix}
...
\begin{abstract}
OEIS A233612 counts arrays of width $4$ over $\{0,1,2\}$ containing no run of $3$ consecutive
...
OEIS A233612 is ``Number of (n+2)X(2+2) 0..2 arrays with no increasing sequence of length 3 horizontally or diagonally downwards.''. It has offset $1$ and begins
\[
395955, 27826929, 1955165211, 137370562281, 9651696380883, 678130944334209, 47645673900633963, 3347598657948373881,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 75*a(n-1) -279*a(n-2) -4023*a(n-3) +15264*a(n-4) +56196*a(n-5) -228096*a(n-6) +186624*a(n-7)
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 08:06:56, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;75\,a(n-1) - 279\,a(n-2) - 4023\,a(n-3) + 15264\,a(n-4) + 56196\,a(n-5) - 228096\,a(n-6) + 186624\,a(n-7)
\]
for every $n>4$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A233612.
