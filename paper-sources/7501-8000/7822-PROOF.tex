...
\title{The empirical recurrence for OEIS A230676, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A230676 counts arrays over $\{0,\dots,2\}$ in which every cell is constrained by the
...
OEIS A230676 is ``Number of 2 X n 0..2 arrays x(i,j) with each element horizontally, diagonally or antidiagonally next to at least one element with value 2-x(i,j).''. It has offset $1$ and begins
\[
0, 15, 87, 513, 3387, 21933, 141411, 913245,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 5*a(n-1) + 6*a(n-2) + 20*a(n-3) + 12*a(n-4) + 8*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 22 2018 10:53:25, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A230676.
