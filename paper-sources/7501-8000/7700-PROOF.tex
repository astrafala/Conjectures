...
\title{The empirical recurrence for OEIS A205979, proved by transfer matrix}
...
\begin{abstract}
OEIS A205979 counts arrays over $\{0,\dots,2\}$ under a condition on the perimeter cycle of
...
OEIS A205979 is ``Number of (n+1) X 2 0..2 arrays with every 2 X 3 or 3 X 2 subblock having exactly two clockwise edge increases.''. It has offset $1$ and begins
\[
81, 423, 2232, 11568, 60432, 315357, 1643538, 8574615,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + 10*a(n-2) + 35*a(n-3) + a(n-4) + 3*a(n-5) + a(n-6) + 2*a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 13 2018 05:43:15, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 10\,a(n-2) + 35\,a(n-3) + a(n-4) + 3\,a(n-5) + a(n-6) + 2\,a(n-7)
\]
for every $n>7$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A205979.
