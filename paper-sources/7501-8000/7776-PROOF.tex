...
\title{The empirical recurrence for OEIS A207939, proved by transfer matrix}
...
\begin{abstract}
OEIS A207939 counts arrays over $\{0,\dots,1\}$ of width $3$ that avoid the patterns
...
OEIS A207939 is ``Number of 3 X n 0..1 arrays avoiding 0 0 1 and 1 0 0 horizontally and 0 0 1 and 1 1 0 vertically.''. It has offset
$1$ and begins
\[
6, 36, 98, 271, 844, 2706, 8977,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 5*a(n-1) - a(n-2) - 20*a(n-3) + 10*a(n-4) + 28*a(n-5) - 9*a(n-6) - 15*a(n-7) + a(n-8) + 2*a(n-9) for n>10.
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 06 2018 08:54:39, revision
8) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) - a(n-2) - 20\,a(n-3) + 10\,a(n-4) + 28\,a(n-5) - 9\,a(n-6) - 15\,a(n-7) + a(n-8) + 2\,a(n-9)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207939.
