...
\title{The empirical recurrence for OEIS A260241, proved by transfer matrix}
...
\begin{abstract}
OEIS A260241 counts $(n+2)\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A260241 is ``Number of (n+2) X (1+2) 0..1 arrays with each 3 X 3 subblock having clockwise perimeter pattern 00000001 00000101 or 00001001.''. It has offset $1$ and begins
\[
48, 99, 256, 635, 1598, 4027, 10110, 25421,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) - 2*a(n-2) + 9*a(n-3) - 4*a(n-4) + 9*a(n-5) - 9*a(n-6) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 28 2018 14:00:29, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) - 2\,a(n-2) + 9\,a(n-3) - 4\,a(n-4) + 9\,a(n-5) - 9\,a(n-6)
\]
for every $n>7$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A260241.
