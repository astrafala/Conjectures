...
\title{The empirical recurrence for OEIS A223250, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A223250 counts arrays over $\{0,\dots,4\}$ in which every cell is constrained by the
...
OEIS A223250 is ``Two-loop graph coloring a rectangular array: number of n X 3 0..4 arrays where 0..4 label nodes of a graph with edges 0,1 1,2 2,0 0,3 3,4 4,0 and every array movement to a horizontal or vertical neighbor moves along an edge of this graph.''. It has offset $1$ and begins
\[
32, 236, 2172, 17828, 166892, 1382228, 12894316, 107283636,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) +75*a(n-2) -126*a(n-3) -70*a(n-4) +48*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (May 03 2014 13:24:08, revision 10) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 75\,a(n-2) - 126\,a(n-3) - 70\,a(n-4) + 48\,a(n-5)
\end{equation}
for all $n>6$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223250.
