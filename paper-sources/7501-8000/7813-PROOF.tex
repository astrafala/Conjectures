...
\title{The empirical recurrence for OEIS A206678, proved by transfer matrix}
...
\begin{abstract}
OEIS A206678 counts arrays over $\{0,\dots,2\}$ under a condition on the perimeter cycle of
...
OEIS A206678 is ``Number of (n+1) X 2 0..2 arrays with every 2 X 3 or 3 X 2 subblock having an unequal number of clockwise and counterclockwise edge increases.''. It has offset $1$ and begins
\[
81, 306, 1404, 5352, 24336, 93696, 422016, 1639296,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 16*a(n-2) + 4*a(n-3) + 8*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 17 2018 08:08:48, revision 10) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206678.
