...
\title{The empirical recurrence for OEIS A304217, proved by transfer matrix}
...
\begin{abstract}
OEIS A304217 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A304217 is ``Number of nX4 0..1 arrays with every element unequal to 0, 1, 3 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
5, 17, 17, 32, 62, 108, 190, 348,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +2*a(n-3) +a(n-4) +a(n-5) -2*a(n-7) for n>9
\end{quote}
As of the ``Last modified'' line on the live entry (May 08 2018 10:52:01, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 2\,a(n-3) + a(n-4) + a(n-5) - 2\,a(n-7)
\end{equation}
for all $n>9$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A304217.
