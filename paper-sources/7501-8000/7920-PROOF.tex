...
\title{The empirical recurrence for OEIS A184680, proved by transfer matrix}
...
\begin{abstract}
OEIS A184680 counts arrays over $\{0,\dots,1\}$ under a condition on the determinant of every
...
OEIS A184680 is ``Number of (n+1) X 4 binary arrays with every 2 X 2 subblock singular.''. It has offset $1$ and begins
\[
76, 544, 3360, 21968, 140816, 909520, 5858896, 37779664,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 7*a(n-1) + 2*a(n-2) - 40*a(n-3) + 24*a(n-4) + 16*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 22 2025 09:40:59, revision 11) this is still
...
$2\times4$ arrays over $\{0,\dots,1\}$ all of whose subblocks pass. The entry's
first term is $76$, and the model reproduces it along with every later term; that is the
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-1) + 2\,a(n-2) - 40\,a(n-3) + 24\,a(n-4) + 16\,a(n-5)
\]
for every $n>4$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A184680.
