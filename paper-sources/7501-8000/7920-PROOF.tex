...
\title{The empirical recurrence for OEIS A207457, proved by transfer matrix}
...
\begin{abstract}
OEIS A207457 counts arrays over $\{0,\dots,1\}$ of width $6$ that avoid the patterns
...
OEIS A207457 is ``Number of 6 X n 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 0 1 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
12, 144, 396, 2460, 9216, 46956, 196812,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) + 16*a(n-2) + 5*a(n-3) - 25*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 23 2018 07:21:31, revision
11) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 16\,a(n-2) + 5\,a(n-3) - 25\,a(n-4)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207457.
