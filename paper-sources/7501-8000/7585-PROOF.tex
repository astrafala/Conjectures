...
\title{The empirical recurrence for OEIS A223418, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A223418 counts arrays over $\{0,\dots,6\}$ in which every cell is constrained by the
...
OEIS A223418 is ``3-level binary fanout graph coloring a rectangular array: number of n X 3 0..6 arrays where 0..6 label nodes of a graph with edges 0,1 1,3 1,4 0,2 2,5 2,6 and every array movement to a horizontal or vertical neighbor moves along an edge of this graph.''. It has offset $1$ and begins
\[
26, 136, 868, 4720, 29912, 163168, 1033328, 5638336,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 38*a(n-2) - 120*a(n-4) + 32*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 20 2018 08:49:37, revision 7) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;38\,a(n-2) - 120\,a(n-4) + 32\,a(n-6)
\end{equation}
for all $n>6$.
...
$7$ values, so there are about $10^{48}$ of them to sift. The
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223418.
