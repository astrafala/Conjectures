...
\title{The empirical recurrence for OEIS A305687, proved by transfer matrix}
...
\begin{abstract}
OEIS A305687 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A305687 is ``Number of nX3 0..1 arrays with every element unequal to 1, 2, 3, 4, 5 or 6 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 25, 152, 1151, 8415, 61796, 453553, 3329201,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 6*a(n-1) +8*a(n-2) +12*a(n-3) +11*a(n-4) -a(n-5) +a(n-6) +a(n-7) -a(n-8)
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 08 2018 08:15:34, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) + 8\,a(n-2) + 12\,a(n-3) + 11\,a(n-4) - a(n-5) + a(n-6) + a(n-7) - a(n-8)
\end{equation}
for all $n>8$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A305687.
