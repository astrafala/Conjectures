...
\title{The empirical recurrence for OEIS A303422, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A303422 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A303422 is ``Number of 3Xn 0..1 arrays with every element equal to 0, 1, 2, 3, 4 or 5 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
4, 32, 252, 1985, 15647, 123337, 972168, 7662841,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 7*a(n-1) +4*a(n-2) +21*a(n-3) +18*a(n-4)
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 23 2018 10:55:54, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;7\,a(n-1) + 4\,a(n-2) + 21\,a(n-3) + 18\,a(n-4)
\end{equation}
for all $n>5$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A303422.
