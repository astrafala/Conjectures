...
\title{The empirical recurrence for OEIS A297638, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297638 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A297638 is ``Number of 2Xn 0..1 arrays with every 1 horizontally, diagonally or antidiagonally adjacent to 0, 2 or 3 neighboring 1s.''. It has offset $1$ and begins
\[
4, 8, 29, 69, 200, 552, 1641, 4685,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) +a(n-2) -a(n-3) +6*a(n-4) -28*a(n-5) -24*a(n-6)
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 02 2018 12:00:49, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + a(n-2) - a(n-3) + 6\,a(n-4) - 28\,a(n-5) - 24\,a(n-6)
\end{equation}
for all $n>7$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297638.
