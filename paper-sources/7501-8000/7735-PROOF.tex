...
\title{The empirical recurrence for OEIS A304599, proved by transfer matrix}
...
\begin{abstract}
OEIS A304599 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A304599 is ``Number of nX3 0..1 arrays with every element unequal to 0, 1, 2, 5 or 6 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
4, 5, 13, 23, 53, 131, 330, 793,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +2*a(n-2) +4*a(n-3) +2*a(n-4) -2*a(n-5) -7*a(n-6) -6*a(n-7) for n>10
\end{quote}
As of the ``Last modified'' line on the live entry (May 15 2018 13:28:10, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A304599.
