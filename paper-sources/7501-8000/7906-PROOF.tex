...
\title{The empirical recurrence for OEIS A278000, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A278000 counts arrays over $\{0,\dots,2\}$ in which every cell is constrained by the
...
OEIS A278000 is ``Number of n X 2 0..2 arrays with every element plus 1 mod 3 equal to some element at offset (-1,-1) (-1,0) (-1,1) (0,-1) (0,1) (1,-1) or (1,0), with upper left element zero.''. It has offset $1$ and begins
\[
0, 9, 52, 364, 2523, 17424, 120462, 832701,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 6*a(n-1) + 6*a(n-2) + 3*a(n-3) - 6*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 06 2019 06:05:54, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) + 6\,a(n-2) + 3\,a(n-3) - 6\,a(n-4)
\end{equation}
for all $n>5$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A278000.
