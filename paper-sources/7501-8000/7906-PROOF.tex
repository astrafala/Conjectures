...
\title{The empirical recurrence for OEIS A252258, proved by transfer matrix}
...
\begin{abstract}
OEIS A252258 counts $(n+2)\times4$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252258 is ``Number of (n+2) X (2+2) 0..3 arrays with every 3 X 3 subblock row and column sum not equal to 0 2 3 6 or 7 and every 3 X 3 diagonal and antidiagonal sum equal to 0 2 3 6 or 7.''. It has offset $1$ and begins
\[
1331, 1016, 562, 512, 570, 782, 1178, 1670,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + 6*a(n-3) - 6*a(n-4) - 8*a(n-6) + 8*a(n-7) for n>12.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 03 2018 06:25:46, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252258.
