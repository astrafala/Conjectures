...
\title{The empirical recurrence for OEIS A234651, proved by transfer matrix}
...
\begin{abstract}
OEIS A234651 counts $2$-column arrays over $\{0,\dots,5\}$ in which every
...
OEIS A234651 is ``Number of (n+1) X (1+1) 0..5 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 4 (constant-stress 1 X 1 tilings).''. It has offset
$1$ and begins
\[
160, 728, 3264, 15008, 67840, 315008, 1434624,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 4*a(n-1) + 44*a(n-2) - 176*a(n-3) - 480*a(n-4) + 1920*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 20 2022 21:31:17, revision 11) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234651.
