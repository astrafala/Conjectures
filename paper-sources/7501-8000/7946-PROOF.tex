...
\title{The empirical recurrence for OEIS A318010, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A318010 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A318010 is ``Number of nX2 0..1 arrays with every element unequal to 0, 1, 2 or 3 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
2, 8, 28, 97, 338, 1178, 4105, 14305,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 4*a(n-1) -2*a(n-2) +a(n-3) -a(n-4)
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2018 19:33:17, revision 4) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A318010.
