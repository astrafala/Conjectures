...
\title{The empirical recurrence for OEIS A278281, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A278281 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A278281 is ``Number of 2 X n 0..1 arrays with every element both equal and not equal to some elements at offset (-1,-1) (-1,0) (-1,1) (0,-1) (0,1) or (1,0), with upper left element zero.''. It has offset $1$ and begins
\[
0, 2, 4, 13, 36, 109, 317, 938,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) + 3*a(n-2) - a(n-3) + a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 09 2019 08:49:40, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A278281.
