...
\title{The empirical recurrence for OEIS A235905, proved by transfer matrix}
...
\begin{abstract}
OEIS A235905 counts arrays of width $3$ over $\{0,1,2\}$ in which the smallest and largest of the
...
OEIS A235905 is ``Number of (n+1) X (2+1) 0..2 arrays with the minimum plus the maximum unequal to the lower median plus the upper median in every 2 X 2 subblock.''. It has offset $1$ and begins
\[
260, 2618, 26408, 267548, 2707568, 27447272, 278028320, 2818432496,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 8*a(n-1) + 58*a(n-2) - 368*a(n-3) - 24*a(n-4) + 192*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 20 2018 06:04:56, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A235905.
