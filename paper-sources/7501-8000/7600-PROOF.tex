...
\title{The empirical recurrence for OEIS A237630, proved by transfer matrix}
...
\begin{abstract}
OEIS A237630 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
OEIS A237630 is ``Number of (n+1) X (1+1) 0..2 arrays with the upper median of every 2 X 2 subblock differing from its horizontal and vertical neighbors by exactly one.''. It has offset $1$ and begins
\[
81, 260, 702, 1786, 4621, 11936, 30656, 77576,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 36*a(n-4) + 48*a(n-6) for n>9.
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 23 2018 12:10:19, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237630.
