...
\title{The empirical recurrence for OEIS A302619, proved by transfer matrix}
...
\begin{abstract}
OEIS A302619 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A302619 is ``Number of nX4 0..1 arrays with every element equal to 0, 1, 2 or 6 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
8, 37, 45, 130, 367, 917, 2533, 6871,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +3*a(n-2) +6*a(n-3) -a(n-4) -8*a(n-5) -7*a(n-6) +2*a(n-7) +5*a(n-8) for n>10
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 10 2018 19:07:35, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 3\,a(n-2) + 6\,a(n-3) - a(n-4) - 8\,a(n-5) - 7\,a(n-6) + 2\,a(n-7) + 5\,a(n-8)
\end{equation}
for all $n>10$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302619.
