...
\title{The empirical recurrence for OEIS A223396, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A223396 counts arrays over $\{0,\dots,15\}$ in which every cell is constrained by the
...
OEIS A223396 is ``4 X 4 square grid graph coloring a rectangular array: number of n X 2 0..15 arrays where 0..15 label nodes of the square grid graph and every array movement to a horizontal or vertical neighbor moves along an edge of this graph.''. It has offset $1$ and begins
\[
48, 328, 2360, 17280, 127464, 943016, 6985008, 51763176,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 10*a(n-1) - 18*a(n-2) - 9*a(n-3) + 2*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 20 2018 08:37:46, revision 7) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;10\,a(n-1) - 18\,a(n-2) - 9\,a(n-3) + 2\,a(n-4)
\end{equation}
for all $n>4$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223396.
