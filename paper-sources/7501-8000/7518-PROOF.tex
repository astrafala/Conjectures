...
\title{The empirical recurrence for OEIS A326100, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A326100 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A326100 is ``Number of nX3 0..1 arrays with every element equal to 0, 1, 2, 3 or 6 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
4, 29, 161, 929, 5383, 31236, 181227, 1051456,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 5*a(n-1) +5*a(n-2) -2*a(n-3) -3*a(n-6) -2*a(n-7) -a(n-8) -a(n-9)
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 06 2019 07:52:12, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) + 5\,a(n-2) - 2\,a(n-3) - 3\,a(n-6) - 2\,a(n-7) - a(n-8) - a(n-9)
\end{equation}
for all $n>10$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A326100.
