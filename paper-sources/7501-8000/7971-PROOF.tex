...
\title{The empirical recurrence for OEIS A282990, proved by transfer matrix}
...
\begin{abstract}
OEIS A282990 counts $n\times2$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A282990 is ``Number of nX2 0..1 arrays with no 1 equal to more than one of its horizontal and vertical neighbors.''. It has offset $1$ and begins
\[
4, 11, 33, 98, 291, 865, 2570, 7637,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) +3*a(n-2) -a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 20 2023 15:06:48, revision 9) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A282990.
