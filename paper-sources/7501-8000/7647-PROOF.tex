...
\title{The empirical recurrence for OEIS A232043, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A232043 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A232043 is ``Number of n X 4 0..1 arrays with no element less than a strict majority of its horizontal and antidiagonal neighbors.''. It has offset $1$ and begins
\[
7, 34, 318, 3082, 29974, 290672, 2821630, 27382537,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 7*a(n-1) + 29*a(n-2) - 15*a(n-3) - 116*a(n-4) + 17*a(n-5) + 99*a(n-6) + 12*a(n-7) - 16*a(n-8) for n>9.
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 02 2018 06:32:31, revision 7) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;7\,a(n-1) + 29\,a(n-2) - 15\,a(n-3) - 116\,a(n-4) + 17\,a(n-5) + 99\,a(n-6) + 12\,a(n-7) - 16\,a(n-8)
\end{equation}
for all $n>9$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232043.
