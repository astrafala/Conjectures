...
\title{The empirical recurrence for OEIS A301820, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A301820 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A301820 is ``Number of nX5 0..1 arrays with every element equal to 1 or 2 horizontally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
3, 18, 74, 299, 1197, 4785, 19130, 76499,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 8*a(n-1) -22*a(n-2) +28*a(n-3) -17*a(n-4) +4*a(n-5) for n>7
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 27 2018 10:11:39, revision 4) the statement is
...
the middle row. The vector $w$ was formed by $5$ applications of $G$ in exact integer
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A301820.
