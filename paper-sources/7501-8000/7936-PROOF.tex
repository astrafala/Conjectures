...
\title{The empirical recurrence for OEIS A295247, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A295247 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A295247 is ``Number of n X 2 0..1 arrays with each 1 horizontally or vertically adjacent to 0, 1 or 3 1s.''. It has offset $1$ and begins
\[
4, 11, 35, 106, 327, 1003, 3082, 9465,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) + 3*a(n-2) + a(n-3) - a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 26 2018 10:17:32, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A295247.
