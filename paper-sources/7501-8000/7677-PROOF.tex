...
\title{The empirical recurrence for OEIS A250793, proved by transfer matrix}
...
\begin{abstract}
OEIS A250793 counts arrays over $\{0,1\}$ in which a statistic taken over short runs
...
OEIS A250793 is ``Number of (n+1) X (4+1) 0..1 arrays with nondecreasing min(x(i,j),x(i,j-1)) in the i direction and nondecreasing absolute value of x(i,j)-x(i-1,j) in the j direction.''. It has offset $1$ and begins
\[
118, 376, 1190, 3776, 12062, 38676, 124366, 400616,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 8*a(n-1) - 20*a(n-2) + 8*a(n-3) + 33*a(n-4) - 36*a(n-5) + 8*a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 20 2018 09:54:52, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-1) - 20\,a(n-2) + 8\,a(n-3) + 33\,a(n-4) - 36\,a(n-5) + 8\,a(n-7)
\]
for every $n>6$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250793.
