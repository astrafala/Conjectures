...
\title{The empirical recurrence for OEIS A186466, proved by transfer matrix}
...
\begin{abstract}
OEIS A186466 counts the $(n+1)\times4$ arrays over $\{0,\dots,2\}$ in which
...
a state, the count is a walk count on $S=277$ of them, and the conjectured recurrence is then
...
OEIS A186466 is ``Number of (n+1) X 4 0..2 arrays with every 2 X 2 subblock commuting with each of its horizontal and vertical 2 X 2 subblock neighbors.''. It has offset $1$ and begins
\[
277, 243, 942, 1203, 3190, 4023, 9982, 13985,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + a(n-2) - 4*a(n-3) + 4*a(n-4) - 2*a(n-5) for n>12.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 18 2018 06:25:47, revision 8) this is still
...
$277$, which the model reproduces along with every later term.
...
\]
on the $S=277$ admissible $2$-tuples. In particular $a$ is $C$-finite.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A186466.
