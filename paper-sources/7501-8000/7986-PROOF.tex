...
\title{The empirical recurrence for OEIS A234170, proved by transfer matrix}
...
\begin{abstract}
OEIS A234170 counts $2$-column arrays over $\{0,\dots,6\}$ in which every
...
OEIS A234170 is ``Number of (n+1) X (1+1) 0..6 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 1 (constant-stress 1 X 1 tilings).''. It has offset
$1$ and begins
\[
448, 4536, 47936, 517104, 5630848, 61624416, 675750656,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 154*a(n-2) - 4144*a(n-4) + 16176*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 20 2022 21:34:46, revision 14) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234170.
