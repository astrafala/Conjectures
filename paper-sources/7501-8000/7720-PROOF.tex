...
\title{The empirical recurrence for OEIS A297728, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297728 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A297728 is ``Number of nX3 0..1 arrays with every 1 horizontally, diagonally or antidiagonally adjacent to 2 or 4 neighboring 1s.''. It has offset $1$ and begins
\[
1, 8, 17, 39, 151, 385, 1026, 3272,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +a(n-2) +13*a(n-3) -2*a(n-4) +4*a(n-5) -11*a(n-6) -3*a(n-7) -a(n-8)
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 04 2018 22:14:19, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + a(n-2) + 13\,a(n-3) - 2\,a(n-4) + 4\,a(n-5) - 11\,a(n-6) - 3\,a(n-7) - a(n-8)
\end{equation}
for all $n>9$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297728.
