...
\title{The empirical recurrence for OEIS A234762, proved by transfer matrix}
...
\begin{abstract}
OEIS A234762 counts arrays of width $2$ over $\{0,1,2,3\}$ subject to a condition read round the
...
OEIS A234762 is ``Number of (n+1) X (1+1) 0..3 arrays with 2 X 2 edge jumps all no more than +1 in one of the clockwise or counterclockwise directions but not both.''. It has offset $1$ and begins
\[
56, 240, 916, 3800, 14828, 60552, 239044, 967784,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + 14*a(n-2) - a(n-3) - 25*a(n-4) - 10*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 16 2018 05:41:50, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234762.
