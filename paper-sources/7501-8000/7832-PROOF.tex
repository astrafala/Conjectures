...
\title{The empirical recurrence for OEIS A261258, proved by transfer matrix}
...
\begin{abstract}
OEIS A261258 counts $(n+2)\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A261258 is ``Number of (n+2) X (1+2) 0..1 arrays with each 3 X 3 subblock having clockwise perimeter pattern 00010101 00100101 or 01010101.''. It has offset $1$ and begins
\[
36, 41, 91, 166, 321, 586, 1123, 2082,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + a(n-2) + 2*a(n-4) + a(n-6) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 30 2018 09:10:31, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A261258.
