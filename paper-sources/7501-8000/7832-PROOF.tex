...
\title{The empirical recurrence for OEIS A302678, proved by transfer matrix}
...
\begin{abstract}
OEIS A302678 counts $6$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A302678 is ``Number of nX6 0..1 arrays with every element equal to 0, 1, 4 or 6 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
13, 13, 40, 76, 187, 453, 1125, 2782,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +2*a(n-2) +4*a(n-3) +a(n-4) -2*a(n-5) -a(n-6) for n>12
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 11 2018 12:27:01, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302678.
