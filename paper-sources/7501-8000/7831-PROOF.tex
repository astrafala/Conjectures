...
\title{The empirical recurrence for OEIS A264092, proved by transfer matrix}
...
\begin{abstract}
OEIS A264092 carries an empirical recurrence of order $8$ contributed by R.~H.~Hardin. It is
...
OEIS A264092 is ``Number of (3+1)X(n+1) arrays of permutations of 0..n*4+3 with each element having index change +-(.,.) 0,0 0,1 or 2,-2.''. It has offset $1$ and begins
\[
16, 169, 2401, 32761, 456976, 6355441, 88529281, 1232922769,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 14*a(n-1) +14*a(n-2) -210*a(n-3) +210*a(n-5) -14*a(n-6) -14*a(n-7) +a(n-8)
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 10 2015 11:22:50, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264092.
