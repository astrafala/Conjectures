...
\title{The empirical recurrence for OEIS A196537, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A196537 counts arrays over $\{0,\dots,4\}$ in which every cell is constrained by the
...
OEIS A196537 is ``Number of nX1 0..4 arrays with each element equal to the number its horizontal and vertical neighbors less than or equal to itself.''. It has offset $1$ and begins
\[
1, 3, 2, 7, 19, 35, 77, 176,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +a(n-2) +3*a(n-3) +a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 06:35:26, revision 11) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A196537.
