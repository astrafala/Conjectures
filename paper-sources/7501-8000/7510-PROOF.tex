...
\title{The empirical recurrence for OEIS A206320, proved by transfer matrix}
...
\begin{abstract}
OEIS A206320 counts arrays over $\{0,\dots,3\}$ under a condition on the perimeter cycle of
...
OEIS A206320 is ``Number of (n+1) X 2 0..3 arrays with every 2 X 3 or 3 X 2 subblock having exactly three clockwise edge increases.''. It has offset $1$ and begins
\[
256, 1344, 10504, 83088, 673124, 5432884, 43848120, 353716772,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 9*a(n-1) - 5*a(n-2) - 26*a(n-3) + 42*a(n-4) + 19*a(n-5) + 42*a(n-6) + 14*a(n-7) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 15 2018 09:56:09, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;9\,a(n-1) - 5\,a(n-2) - 26\,a(n-3) + 42\,a(n-4) + 19\,a(n-5) + 42\,a(n-6) + 14\,a(n-7)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206320.
