...
\title{The empirical recurrence for OEIS A206250, proved by transfer matrix}
...
\begin{abstract}
OEIS A206250 counts $(n+1)\times4$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A206250 is ``Number of (n+1) X 4 0..3 arrays with every 2 X 2 subblock having zero permanent.''. It has offset $1$ and begins
\[
1600, 99856, 1364224, 49336576, 944701696, 27285753856, 603269103616, 15860529270784,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 28*a(n-1) +192*a(n-2) -8352*a(n-3) +25920*a(n-4) +373248*a(n-5) -1679616*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 14 2018 11:35:30, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;28\,a(n-1) + 192\,a(n-2) - 8352\,a(n-3) + 25920\,a(n-4) + 373248\,a(n-5) - 1679616\,a(n-6)
\end{equation}
for all $n>5$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206250.
