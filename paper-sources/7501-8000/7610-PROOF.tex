...
\title{The empirical recurrence for OEIS A236942, proved by transfer matrix}
...
\begin{abstract}
OEIS A236942 counts arrays over $\{0,\dots,3\}$ subject to a condition on the order
...
The condition is local to two consecutive rows, so the count is a walk count on $S=30$
...
OEIS A236942 is ``Number of (n+1) X (1+1) 0..3 arrays with the maximum of every 2 X 2 subblock equal.''. It has offset $1$ and begins
\[
256, 2796, 30698, 357316, 4195956, 50119046, 601976968, 7271574636,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 16*a(n-1) - 650*a(n-3) + 596*a(n-4) + 5184*a(n-5) - 1365*a(n-6) - 3780*a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 21 2018 13:05:01, revision 8) this is still
...
array, which is not among the objects counted. There are $S=30$ states left.
...
\begin{theorem}
\[
a(n)\;=\;16\,a(n-1) - 650\,a(n-3) + 596\,a(n-4) + 5184\,a(n-5) - 1365\,a(n-6) - 3780\,a(n-7)
\]
for every $n>6$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A236942.
