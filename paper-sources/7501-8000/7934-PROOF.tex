...
\title{The empirical recurrence for OEIS A302158, proved by transfer matrix}
...
\begin{abstract}
OEIS A302158 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A302158 is ``Number of nX3 0..1 arrays with every element equal to 0, 1 or 3 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
3, 9, 7, 17, 31, 57, 111, 265,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +8*a(n-3) -6*a(n-4) -4*a(n-6) +4*a(n-7) for n>11
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 02 2018 14:45:57, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 8\,a(n-3) - 6\,a(n-4) - 4\,a(n-6) + 4\,a(n-7)
\end{equation}
for all $n>11$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302158.
