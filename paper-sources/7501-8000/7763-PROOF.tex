...
\title{The empirical recurrence for OEIS A207089, proved by transfer matrix}
...
\begin{abstract}
OEIS A207089 counts arrays over $\{0,\dots,1\}$ of width $3$ that avoid the patterns
...
OEIS A207089 is ``Number of 3 X n 0..1 arrays avoiding 0 0 0 horizontally and 0 0 1 vertically.''. It has offset
$1$ and begins
\[
7, 49, 241, 1393, 7915, 44065, 248525,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) + 11*a(n-2) + 48*a(n-3) + 29*a(n-4) + 6*a(n-5) - 111*a(n-6) - 8*a(n-7) - 32*a(n-8) + 64*a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 04 2018 17:45:00, revision
8) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 11\,a(n-2) + 48\,a(n-3) + 29\,a(n-4) + 6\,a(n-5) - 111\,a(n-6) - 8\,a(n-7) - 32\,a(n-8) + 64\,a(n-9)
\end{equation}
...
$(0,0,1)$ as $3$ consecutive entries. There are $7$ admissible columns; that condition
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207089.
