...
\title{The empirical recurrence for OEIS A297608, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297608 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A297608 is ``Number of 2Xn 0..1 arrays with every 1 horizontally, diagonally or antidiagonally adjacent to 0, 1 or 3 neighboring 1s.''. It has offset $1$ and begins
\[
4, 11, 35, 96, 281, 829, 2428, 7059,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +3*a(n-2) +4*a(n-3) +12*a(n-4) -12*a(n-6)
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 01 2018 14:54:10, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 3\,a(n-2) + 4\,a(n-3) + 12\,a(n-4) - 12\,a(n-6)
\end{equation}
for all $n>7$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297608.
