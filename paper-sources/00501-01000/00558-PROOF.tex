...
\begin{abstract}
OEIS A289099 carries an empirical recurrence of order $3$ contributed by Chai Wah Wu. It is true, and it is
...
\begin{quote}
Conjectures from \_Chai Wah Wu\_, Jun 13 2025: (Start) a(n) = a(n-1) + 4*a(n-2) - 4*a(n-3) for n > 5.
\end{quote}
