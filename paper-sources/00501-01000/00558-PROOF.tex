...
\title{The empirical recurrence for OEIS A188150, proved from an exact model}
...
\begin{abstract}
OEIS A188150 carries an empirical recurrence of order $3$. It is true, and it is
...
\begin{quote}
Empirical: a(n) = 100*n\^{}2 - 360*n + 272 for n>3. a(n) = 3*a(n-1) - 3*a(n-2) + a(n-3) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 27 2018 09:22:26, revision 14)
