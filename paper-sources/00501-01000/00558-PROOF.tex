...
\title{The empirical recurrence for OEIS A267879, proved from an exact model}
...
\begin{abstract}
OEIS A267879 carries an empirical recurrence of order $2$ contributed by Colin Barker. It is true, and it is
...
\[
1, 10, 101, 1010, 10101, 101011, 1010111, 10101111,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 22 2016 and Apr 20 2019: (Start) a(n) = 11*a(n-1)-10*a(n-2) for n>4.
\end{quote}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267879.
