...
\title{The cross-base identity for OEIS A125430, proved}
...
\begin{abstract}
OEIS A125430 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125430 is ``Number of base 18 circular n-digit numbers with adjacent digits differing by 7 or less.''. It has offset $0$ and begins
\[
1, 18, 214, 2202, 25862, 310258, 3787948, 46645456,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:36:06, revision 12)
...
the base is $18$ and the permitted difference is $d=7$, so the claim is that
\[
a_{18}(n)-a_{17}(n)\;=\;F_{7}(n)
\qquad\text{for every } n \text{ with } 7\lfloor n/2\rfloor+1\le18,
\]
...
at base $18$ reproduces all $17$ terms A125430 publishes, and at base $17$ all the
...
polynomial. In particular $a_{18}(n)-a_{17}(n)=F_{7}(n)$ for $1\le n\le5$, which
...
First, the model reproduces all $17$ terms A125430 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{7}(18,n)$ & $T_{7}(17,n)$ & $F_{7}(n)$ \\ \hline
1 & 18 & 17 & 1 \\
2 & 214 & 199 & 15 \\
3 & 2202 & 2033 & 169 \\
4 & 25862 & 23607 & 2255 \\
5 & 310258 & 279877 & 30381 \\
\end{tabular}
\end{center}
