...
\title{The empirical recurrence for OEIS A264332, proved by transfer matrix}
...
\begin{abstract}
OEIS A264332 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=5$ rows in which
...
OEIS A264332 is ``Number of (n+1) X (4+1) arrays of permutations of 0..n*5+4 with each element having directed index change -1,1 1,0 1,-1 or 0,-1.''. It has offset $1$ and begins
\[
1, 8, 40, 240, 1528, 8976, 51904, 302328,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 6*a(n-1) - 5*a(n-2) + 36*a(n-3) - 72*a(n-4) - 243*a(n-6) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 07 2019 11:17:15, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264332.
