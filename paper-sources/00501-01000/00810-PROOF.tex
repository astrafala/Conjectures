...
\title{The cross-base identity for OEIS A125466, proved}
...
\begin{abstract}
OEIS A125466 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125466 is ``Number of base 31 circular n-digit numbers with adjacent digits differing by 8 or less.''. It has offset $0$ and begins
\[
1, 31, 455, 5503, 77399, 1110451, 16305215, 242704675,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:39:48, revision 12)
...
the base is $31$ and the permitted difference is $d=8$, so the claim is that
\[
a_{31}(n)-a_{30}(n)\;=\;F_{8}(n)
\qquad\text{for every } n \text{ with } 8\lfloor n/2\rfloor+1\le31,
\]
...
at base $31$ reproduces all $17$ terms A125466 publishes, and at base $30$ all the
...
polynomial. In particular $a_{31}(n)-a_{30}(n)=F_{8}(n)$ for $1\le n\le7$, which
...
First, the model reproduces all $17$ terms A125466 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{8}(31,n)$ & $T_{8}(30,n)$ & $F_{8}(n)$ \\ \hline
1 & 31 & 30 & 1 \\
2 & 455 & 438 & 17 \\
3 & 5503 & 5286 & 217 \\
4 & 77399 & 74118 & 3281 \\
5 & 1110451 & 1060350 & 50101 \\
6 & 16305215 & 15523062 & 782153 \\
7 & 242704675 & 230350206 & 12354469 \\
\end{tabular}
\end{center}
