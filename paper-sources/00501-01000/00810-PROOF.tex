...
\title{The empirical recurrence for OEIS A264546, proved by transfer matrix}
...
\begin{abstract}
OEIS A264546 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=5$ rows in which
...
OEIS A264546 is ``Number of (n+1) X (4+1) arrays of permutations of 0..n*5+4 with each element having directed index change -1,1 -1,2 1,0 or 0,-1.''. It has offset $1$ and begins
\[
1, 16, 36, 216, 1160, 4640, 23140, 110592,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 08 2019 19:00:39, revision 8) this is still
...
\[
(i-h_i,\,j-h_j)\;\in\;\{(-1,1),\ (-1,2),\ (0,-1),\ (1,0)\},
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264546.
