...
\title{The cross-base identity for OEIS A125477, proved}
...
\begin{abstract}
OEIS A125477 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125477 is ``Number of base 20 circular n-digit numbers with adjacent digits differing by 9 or less.''. It has offset $0$ and begins
\[
1, 20, 290, 3710, 53630, 790670, 11804384, 177140396,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:40:50, revision 12)
...
the base is $20$ and the permitted difference is $d=9$, so the claim is that
\[
a_{20}(n)-a_{19}(n)\;=\;F_{9}(n)
\qquad\text{for every } n \text{ with } 9\lfloor n/2\rfloor+1\le20,
\]
...
at base $20$ reproduces all $17$ terms A125477 publishes, and at base $19$ all the
...
polynomial. In particular $a_{20}(n)-a_{19}(n)=F_{9}(n)$ for $1\le n\le5$, which
...
First, the model reproduces all $17$ terms A125477 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{9}(20,n)$ & $T_{9}(19,n)$ & $F_{9}(n)$ \\ \hline
1 & 20 & 19 & 1 \\
2 & 290 & 271 & 19 \\
3 & 3710 & 3439 & 271 \\
4 & 53630 & 49051 & 4579 \\
5 & 790670 & 712519 & 78151 \\
\end{tabular}
\end{center}
