...
\title{The empirical recurrence for OEIS A281798, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A281798 imposes three things at once: a condition on each cell that reaches one row up and
...
numbers. The empirical recurrence of order $44$ contributed by R.~H.~Hardin then follows
...
OEIS A281798 is ``Number of nX4 0..1 arrays with no element unequal to a strict majority of its horizontal, diagonal and antidiagonal neighbors, with the exception of exactly two elements, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
3, 38, 372, 1916, 8354, 32524, 117401, 404594,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 30 2017 10:35:38, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;11\,a(n-1) - 43\,a(n-2) + 57\,a(n-3) + 39\,a(n-4) - 102\,a(n-5) - 89\,a(n-6) - 2\,a(n-7) + 400\,a(n-8) + 345\,a(n-9) - 801\,a(n-10) - 1371\,a(n-11) + 1684\,a(n-12) + 2038\,a(n-13) - 1700\,a(n-14) - 3196\,a(n-15) - 691\,a(n-16) + 6737\,a(n-17) + 5067\,a(n-18) - 10614\,a(n-19) - 10149\,a(n-20) + 14785\,a(n-21) + 11944\,a(n-22) - 14624\,a(n-23) - 14589\,a(n-24) + 4290\,a(n-25) + 23532\,a(n-26) + 6761\,a(n-27) - 34960\,a(n-28) - 8032\,a(n-29) + 45464\,a(n-30) - 550\,a(n-31) - 43699\,a(n-32) + 12453\,a(n-33) + 25491\,a(n-34) - 16122\,a(n-35) - 7485\,a(n-36) + 9435\,a(n-37) - 84\,a(n-38) - 2737\,a(n-39) + 866\,a(n-40) + 422\,a(n-41) - 207\,a(n-42) + 27\,a(n-44)
\end{equation}
for all $n>51$.
...
$h_j=G^{j}N^{o}\mathbf{u}$, we have for $j\ge44$
\[
2!\Bigl(a(n_0+j)-\sum_i c_i\,a(n_0+j-i)\Bigr)=\mathbf{v}^{\!\top}G^{\,j-44}w,
...
$44$ applications of $G$ in exact integer arithmetic and $\mathbf{v}^{\!\top}G^{m}w$
evaluated for $m=0,1,\dots$, again exactly. Every one of those integers vanishes from the
index corresponding to $n=51+1$ onwards, and the run continued until $S+1$ consecutive
zeros had been seen.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A281798.
