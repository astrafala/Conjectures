...
\title{The cross-base identity for OEIS A125481, proved}
...
\begin{abstract}
OEIS A125481 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125481 is ``Number of base 24 circular n-digit numbers with adjacent digits differing by 9 or less.''. It has offset $0$ and begins
\[
1, 24, 366, 4794, 71946, 1103274, 17241126, 272084382,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:41:13, revision 12)
...
the base is $24$ and the permitted difference is $d=9$, so the claim is that
\[
a_{24}(n)-a_{23}(n)\;=\;F_{9}(n)
\qquad\text{for every } n \text{ with } 9\lfloor n/2\rfloor+1\le24,
\]
...
at base $24$ reproduces all $17$ terms A125481 publishes, and at base $23$ all the
...
polynomial. In particular $a_{24}(n)-a_{23}(n)=F_{9}(n)$ for $1\le n\le5$, which
...
First, the model reproduces all $17$ terms A125481 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{9}(24,n)$ & $T_{9}(23,n)$ & $F_{9}(n)$ \\ \hline
1 & 24 & 23 & 1 \\
2 & 366 & 347 & 19 \\
3 & 4794 & 4523 & 271 \\
4 & 71946 & 67367 & 4579 \\
5 & 1103274 & 1025123 & 78151 \\
\end{tabular}
\end{center}
