...
\title{The cross-base identity for OEIS A125328, proved}
...
\begin{abstract}
OEIS A125328 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125328 is ``Number of base 18 circular n-digit numbers with adjacent digits differing by 3 or less.''. It has offset $0$ and begins
\[
1, 18, 114, 582, 3466, 20938, 129642, 813586,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:02:48, revision 13)
...
the base is $18$ and the permitted difference is $d=3$, so the claim is that
\[
a_{18}(n)-a_{17}(n)\;=\;F_{3}(n)
\qquad\text{for every } n \text{ with } 3\lfloor n/2\rfloor+1\le18,
\]
...
at base $18$ reproduces all $20$ terms A125328 publishes, and at base $17$ all the
...
polynomial. In particular $a_{18}(n)-a_{17}(n)=F_{3}(n)$ for $1\le n\le11$, which
...
First, the model reproduces all $20$ terms A125328 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{3}(18,n)$ & $T_{3}(17,n)$ & $F_{3}(n)$ \\ \hline
1 & 18 & 17 & 1 \\
2 & 114 & 107 & 7 \\
3 & 582 & 545 & 37 \\
4 & 3466 & 3235 & 231 \\
5 & 20938 & 19487 & 1451 \\
6 & 129642 & 120311 & 9331 \\
7 & 813586 & 752895 & 60691 \\
8 & 5161418 & 4762851 & 398567 \\
\end{tabular}
\end{center}
