...
\title{The empirical recurrence for OEIS A221552, proved by transfer matrix}
...
\begin{abstract}
OEIS A221552 counts the distinct OCCUPANCY arrays obtained when every cell of an $n\times2$ grid
...
one, on $S=168$ states, after which the conjectured recurrence is settled by a finite exact
computation.
\end{abstract}
...
OEIS A221552 is ``Number of 2Xn arrays of occupancy after each element moves to some horizontal, vertical or antidiagonal neighbor, without move-in move-out left turns.''. It has offset $1$ and begins
\[
1, 10, 72, 503, 3517, 24546, 171268, 1194876,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 19:46:11, revision 8) this is still
...
$S=168$ reachable sets. In particular $a$ is $C$-finite.
...
\begin{theorem}
\[
a(n)\;=\;11\,a(n-1) - 25\,a(n-2) - 46\,a(n-3) + 164\,a(n-4) + 129\,a(n-5) - 513\,a(n-6) - 301\,a(n-7) + 913\,a(n-8) + 562\,a(n-9) - 943\,a(n-10) - 675\,a(n-11) + 513\,a(n-12) + 436\,a(n-13) - 128\,a(n-14) - 111\,a(n-15) + 17\,a(n-16) + 6\,a(n-17)
\]
for every $n>17$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221552.
