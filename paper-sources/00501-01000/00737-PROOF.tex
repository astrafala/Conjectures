...
\title{The cross-base identity for OEIS A125335, proved}
...
\begin{abstract}
OEIS A125335 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125335 is ``Number of base 25 circular n-digit numbers with adjacent digits differing by 3 or less.''. It has offset $0$ and begins
\[
1, 25, 163, 841, 5083, 31095, 194959, 1238423,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:23:58, revision 11)
...
the base is $25$ and the permitted difference is $d=3$, so the claim is that
\[
a_{25}(n)-a_{24}(n)\;=\;F_{3}(n)
\qquad\text{for every } n \text{ with } 3\lfloor n/2\rfloor+1\le25,
\]
...
at base $25$ reproduces all $20$ terms A125335 publishes, and at base $24$ all the
...
polynomial. In particular $a_{25}(n)-a_{24}(n)=F_{3}(n)$ for $1\le n\le17$, which
...
First, the model reproduces all $20$ terms A125335 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{3}(25,n)$ & $T_{3}(24,n)$ & $F_{3}(n)$ \\ \hline
1 & 25 & 24 & 1 \\
2 & 163 & 156 & 7 \\
3 & 841 & 804 & 37 \\
4 & 5083 & 4852 & 231 \\
5 & 31095 & 29644 & 1451 \\
6 & 194959 & 185628 & 9331 \\
7 & 1238423 & 1177732 & 60691 \\
8 & 7951387 & 7552820 & 398567 \\
\end{tabular}
\end{center}
