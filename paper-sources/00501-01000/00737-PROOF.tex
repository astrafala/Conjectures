...
\title{The cross-base identity for OEIS A125405, proved}
...
\begin{abstract}
OEIS A125405 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125405 is ``Number of base 17 circular n-digit numbers with adjacent digits differing by 6 or less.''. It has offset $0$ and begins
\[
1, 17, 179, 1613, 16671, 175997, 1895225, 20625195,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:06:12, revision 14)
...
the base is $17$ and the permitted difference is $d=6$, so the claim is that
\[
a_{17}(n)-a_{16}(n)\;=\;F_{6}(n)
\qquad\text{for every } n \text{ with } 6\lfloor n/2\rfloor+1\le17,
\]
...
at base $17$ reproduces all $18$ terms A125405 publishes, and at base $16$ all the
...
polynomial. In particular $a_{17}(n)-a_{16}(n)=F_{6}(n)$ for $1\le n\le5$, which
...
First, the model reproduces all $18$ terms A125405 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{6}(17,n)$ & $T_{6}(16,n)$ & $F_{6}(n)$ \\ \hline
1 & 17 & 16 & 1 \\
2 & 179 & 166 & 13 \\
3 & 1613 & 1486 & 127 \\
4 & 16671 & 15202 & 1469 \\
5 & 175997 & 158846 & 17151 \\
\end{tabular}
\end{center}
