...
\title{The cross-base identity for OEIS A126489, proved}
...
\begin{abstract}
OEIS A126489 carries an empirical identity, in two clauses, relating its counts to those of the
...
OEIS A126489 is ``Number of base 21 n-digit numbers with adjacent digits differing by three or less.''. It has offset $0$ and begins
\[
1, 21, 135, 889, 5903, 39389, 263647, 1768457,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:13:59, revision 13)
this is still recorded as empirical, and nothing on the entry records it as proved.

For this entry the base is $21$ and the permitted difference is $d=3$, so the first clause
claims $a_{21}(n)-a_{20}(n)=7^{\,n-1}$ whenever $3(n-1)+1\le21$, that is for
$1\le n\le7$, and the second claims $a_{21}(n)-a_{20}(n)=7^{\,n-1}-2$ at the single
$n$ with $3(n-1)=21$.
...
arithmetic, $L_{3}$ at base $21$ reproduces all $20$ terms A126489 publishes.
...
First, the model reproduces all $20$ terms A126489 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $L_{3}(21,n)$ & $L_{3}(20,n)$ & $7^{\,n-1}$ \\ \hline
1 & 21 & 20 & 1 \\
2 & 135 & 128 & 7 \\
3 & 889 & 840 & 49 \\
4 & 5903 & 5560 & 343 \\
5 & 39389 & 36988 & 2401 \\
6 & 263647 & 246840 & 16807 \\
7 & 1768457 & 1650808 & 117649 \\
\end{tabular}
\end{center}
...
Third, the second clause was evaluated at its own index. For this entry the second clause bites at $n=8$, where $b=21=3(n-1)$: there $L_{3}(21,8)-L_{3}(20,8)=823541$ and $7^{7}-2=823541$.

\section*{References}
\begin{enumerate}
\item The OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences},
\url{https://oeis.org/A126489}.
\end{enumerate}
