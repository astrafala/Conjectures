...
\title{The empirical recurrence for OEIS A281160, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A281160 imposes three things at once: a condition on each cell that reaches one row up and
...
numbers. The empirical recurrence of order $27$ contributed by R.~H.~Hardin then follows
...
OEIS A281160 is ``Number of nX3 0..1 arrays with no element equal to more than three of its king-move neighbors, with the exception of exactly two elements, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
0, 5, 40, 477, 3237, 17806, 84443, 363824,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 16 2017 08:55:59, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;9\,a(n-1) - 30\,a(n-2) + 42\,a(n-3) + 9\,a(n-4) - 153\,a(n-5) + 269\,a(n-6) - 141\,a(n-7) - 213\,a(n-8) + 587\,a(n-9) - 435\,a(n-10) + 129\,a(n-11) + 508\,a(n-12) - 438\,a(n-13) + 579\,a(n-14) + 83\,a(n-15) - 54\,a(n-16) + 504\,a(n-17) - 76\,a(n-18) + 198\,a(n-19) + 156\,a(n-20) - 4\,a(n-21) + 132\,a(n-22) + 12\,a(n-23) + 24\,a(n-24) + 24\,a(n-25) + 8\,a(n-27)
\end{equation}
for all $n>32$.
...
$h_j=G^{j}N^{o}\mathbf{u}$, we have for $j\ge27$
\[
2!\Bigl(a(n_0+j)-\sum_i c_i\,a(n_0+j-i)\Bigr)=\mathbf{v}^{\!\top}G^{\,j-27}w,
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A281160.
