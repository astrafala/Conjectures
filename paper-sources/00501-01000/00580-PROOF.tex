...
\title{The empirical recurrence for OEIS A267880, proved from an exact model}
...
\begin{abstract}
OEIS A267880 carries an empirical recurrence of order $2$ contributed by Colin Barker. It is true, and it is
...
OEIS A267880 is ``Decimal representation of the middle column of the "Rule 233" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 2, 5, 10, 21, 43, 87, 175,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 22 2016 and Apr 20 2019: (Start) a(n) = 3*a(n-1)-2*a(n-2) for n>4.
\end{quote}
...
For this entry the column is periodic with period $q=1$ from $n=4$: the period above is a
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267880.
