...
\title{The empirical recurrence for OEIS A281567, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A281567 imposes three things at once: a condition on each cell that reaches one column up and
...
OEIS A281567 is ``Number of 5Xn 0..1 arrays with no element equal to more than two of its horizontal, diagonal or antidiagonal neighbors, with the exception of exactly two elements, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
0, 57, 4172, 15508, 50510, 119319, 243040, 458646,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 24 2017 08:40:07, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) - 15\,a(n-2) + 23\,a(n-3) - 30\,a(n-4) + 39\,a(n-5) - 49\,a(n-6) + 57\,a(n-7) - 57\,a(n-8) + 52\,a(n-9) - 48\,a(n-10) + 42\,a(n-11) - 34\,a(n-12) + 24\,a(n-13) - 15\,a(n-14) + 10\,a(n-15) - 6\,a(n-16) + 3\,a(n-17) - a(n-18)
\end{equation}
for all $n>28$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A281567.
