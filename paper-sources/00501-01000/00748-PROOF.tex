...
\title{The cross-base identity for OEIS A125356, proved}
...
\begin{abstract}
OEIS A125356 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125356 is ``Number of base 19 circular n-digit numbers with adjacent digits differing by 4 or less.''. It has offset $0$ and begins
\[
1, 19, 151, 979, 7391, 56769, 446635, 3562417,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:26:37, revision 11)
...
the base is $19$ and the permitted difference is $d=4$, so the claim is that
\[
a_{19}(n)-a_{18}(n)\;=\;F_{4}(n)
\qquad\text{for every } n \text{ with } 4\lfloor n/2\rfloor+1\le19,
\]
...
at base $19$ reproduces all $20$ terms A125356 publishes, and at base $18$ all the
...
polynomial. In particular $a_{19}(n)-a_{18}(n)=F_{4}(n)$ for $1\le n\le9$, which
...
First, the model reproduces all $20$ terms A125356 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{4}(19,n)$ & $T_{4}(18,n)$ & $F_{4}(n)$ \\ \hline
1 & 19 & 18 & 1 \\
2 & 151 & 142 & 9 \\
3 & 979 & 918 & 61 \\
4 & 7391 & 6902 & 489 \\
5 & 56769 & 52818 & 3951 \\
6 & 446635 & 413974 & 32661 \\
7 & 3562417 & 3289290 & 273127 \\
8 & 28719839 & 26413814 & 2306025 \\
\end{tabular}
\end{center}
