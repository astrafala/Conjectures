...
\title{The cross-base identity for OEIS A125416, proved}
...
\begin{abstract}
OEIS A125416 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125416 is ``Number of base 28 circular n-digit numbers with adjacent digits differing by 6 or less.''. It has offset $0$ and begins
\[
1, 28, 322, 3010, 32830, 364658, 4147612, 47830608,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:34:43, revision 12)
...
the base is $28$ and the permitted difference is $d=6$, so the claim is that
\[
a_{28}(n)-a_{27}(n)\;=\;F_{6}(n)
\qquad\text{for every } n \text{ with } 6\lfloor n/2\rfloor+1\le28,
\]
...
at base $28$ reproduces all $17$ terms A125416 publishes, and at base $27$ all the
...
polynomial. In particular $a_{28}(n)-a_{27}(n)=F_{6}(n)$ for $1\le n\le9$, which
...
First, the model reproduces all $17$ terms A125416 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{6}(28,n)$ & $T_{6}(27,n)$ & $F_{6}(n)$ \\ \hline
1 & 28 & 27 & 1 \\
2 & 322 & 309 & 13 \\
3 & 3010 & 2883 & 127 \\
4 & 32830 & 31361 & 1469 \\
5 & 364658 & 347507 & 17151 \\
6 & 4147612 & 3942849 & 204763 \\
7 & 47830608 & 45357283 & 2473325 \\
8 & 557530518 & 527368217 & 30162301 \\
\end{tabular}
\end{center}
