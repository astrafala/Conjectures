...
\title{The cross-base identity for OEIS A124948, proved}
...
\begin{abstract}
OEIS A124948 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A124948 is ``Number of base 20 circular n-digit numbers with adjacent digits differing by 2 or less.''. It has offset $0$ and begins
\[
1, 20, 94, 350, 1522, 6670, 29992, 136548,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:16:58, revision 16)
...
the base is $20$ and the permitted difference is $d=2$, so the claim is that
\[
a_{20}(n)-a_{19}(n)\;=\;F_{2}(n)
\qquad\text{for every } n \text{ with } 2\lfloor n/2\rfloor+1\le20,
\]
...
at base $20$ reproduces all $22$ terms A124948 publishes, and at base $19$ all the
...
polynomial. In particular $a_{20}(n)-a_{19}(n)=F_{2}(n)$ for $1\le n\le19$, which
...
First, the model reproduces all $22$ terms A124948 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{2}(20,n)$ & $T_{2}(19,n)$ & $F_{2}(n)$ \\ \hline
1 & 20 & 19 & 1 \\
2 & 94 & 89 & 5 \\
3 & 350 & 331 & 19 \\
4 & 1522 & 1437 & 85 \\
5 & 6670 & 6289 & 381 \\
6 & 29992 & 28241 & 1751 \\
7 & 136548 & 128413 & 8135 \\
8 & 628362 & 590197 & 38165 \\
\end{tabular}
\end{center}
