...
\title{A cross-alphabet identity for bounded-difference square arrays: OEIS A125530}
...
\begin{abstract}
OEIS A125530 carries an empirical identity relating its counts to those of the same problem over an
...
OEIS A125530 is ``Number of n X n arrays with entries in 1..3 in which adjacent entries differ by 1 or less (adjacent means in x or y directions).''. It has offset $0$ and begins
\[
1, 3, 35, 2021, 536453, 661407975, 3780952160847, 100240477650720585,\ \dots
\]
...
most $d$. The entry is $T(3,1,n)$, and the conjecture is
\[
...
First, the count $T(3,1,n)$ was computed by an independent row-pair dynamic program and
reproduces the $6$ published terms of A125530 that the computation reaches,
...
\[
\begin{array}{rrrr}
n & T(3+1,1,n) & T(3,1,n) & F(n,1) \\ \hline
1 & 4 & 3 & 1 \\
2 & 54 & 35 & 19 \\
\end{array}
\]
...
\url{https://oeis.org}, 2026. Sequence A125530: \url{https://oeis.org/A125530}.
\end{thebibliography}
