...
\title{The empirical recurrence for OEIS A221036, proved by transfer matrix}
...
\begin{abstract}
OEIS A221036 counts the distinct indicator arrays obtained from the $n\times2$ arrays over
...
indicator row by row turns it into one, on $S=34$ states, after which the conjectured
...
OEIS A221036 is ``Majority value maps: number of 2 X n binary arrays indicating the locations of corresponding elements equal to at least half of their horizontal and antidiagonal neighbors in a random 0..2 2 X n array.''. It has offset $1$ and begins
\[
1, 7, 33, 119, 457, 1710, 6466, 24433,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 09 2022 00:35:44, revision 6) this is still
...
\]
There are $S=34$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite. Note
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + a(n-2) - 4\,a(n-3) - 12\,a(n-4) - 2\,a(n-5) + 22\,a(n-6) - 20\,a(n-7) + 16\,a(n-8) + 8\,a(n-9) - 6\,a(n-10) - 10\,a(n-11) + a(n-12) + 2\,a(n-13) - 2\,a(n-14) + 2\,a(n-15)
\]
for every $n>19$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221036.
