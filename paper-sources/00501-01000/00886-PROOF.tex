...
\title{The empirical recurrence for OEIS A219305, proved by transfer matrix}
...
\begin{abstract}
OEIS A219305 counts the distinct indicator arrays obtained from the $n\times3$ arrays over
...
OEIS A219305 is ``Unchanging value maps: number of nX3 binary arrays indicating the locations of corresponding elements unequal to no horizontal or vertical neighbor in a random 0..2 nX3 array.''. It has offset $1$ and begins
\[
4, 18, 90, 423, 1958, 9233, 43725, 206269,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 17:58:37, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + a(n-2) + 7\,a(n-3) + 35\,a(n-4) - 60\,a(n-5) - 68\,a(n-6) + 93\,a(n-7) - 72\,a(n-8) - 111\,a(n-9) + 101\,a(n-10) - 21\,a(n-11) - 28\,a(n-12) + 32\,a(n-13) + 2\,a(n-14) + 6\,a(n-15) + 8\,a(n-16)
\]
for every $n>16$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A219305.
