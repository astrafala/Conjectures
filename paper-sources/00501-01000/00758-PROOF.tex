...
\title{The empirical recurrence for OEIS A264535, proved by transfer matrix}
...
\begin{abstract}
OEIS A264535 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=3$ columns in which
...
OEIS A264535 is ``Number of (2+1) X (n+1) arrays of permutations of 0..n*3+2 with each element having directed index change -2,-2 -1,0 0,1 or 1,0.''. It has offset $1$ and begins
\[
0, 4, 2, 1, 16, 16, 16, 68,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-3) + 2*a(n-4) + 2*a(n-5) - 2*a(n-9) - a(n-10).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 08 2019 08:38:18, revision 7) this is still
...
\[
(i-h_i,\,j-h_j)\;\in\;\{(-2,-2),\ (0,-1),\ (0,1),\ (1,0)\},
\]
...
Second, the transfer model reproduces all $36$ terms this entry publishes, exactly, in
integer arithmetic.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264535.
