...
\title{The cross-base identity for OEIS A125378, proved}
...
\begin{abstract}
OEIS A125378 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125378 is ``Number of base 15 circular n-digit numbers with adjacent digits differing by 5 or less.''. It has offset $0$ and begins
\[
1, 15, 135, 1035, 9115, 81965, 752499, 6987149,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:04:54, revision 14)
...
the base is $15$ and the permitted difference is $d=5$, so the claim is that
\[
a_{15}(n)-a_{14}(n)\;=\;F_{5}(n)
\qquad\text{for every } n \text{ with } 5\lfloor n/2\rfloor+1\le15,
\]
...
at base $15$ reproduces all $19$ terms A125378 publishes, and at base $14$ all the
...
polynomial. In particular $a_{15}(n)-a_{14}(n)=F_{5}(n)$ for $1\le n\le5$, which
...
First, the model reproduces all $19$ terms A125378 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{5}(15,n)$ & $T_{5}(14,n)$ & $F_{5}(n)$ \\ \hline
1 & 15 & 14 & 1 \\
2 & 135 & 124 & 11 \\
3 & 1035 & 944 & 91 \\
4 & 9115 & 8224 & 891 \\
