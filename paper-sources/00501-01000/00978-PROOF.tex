...
\title{The cross-base identity for OEIS A126552, proved}
...
\begin{abstract}
OEIS A126552 carries an empirical identity, in two clauses, relating its counts to those of the
...
OEIS A126552 is ``Number of base 31 n-digit numbers with adjacent digits differing by five or less.''. It has offset $0$ and begins
\[
1, 31, 311, 3201, 33241, 346973, 3633345, 38128475,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:54:50, revision 9)
this is still recorded as empirical, and nothing on the entry records it as proved.

For this entry the base is $31$ and the permitted difference is $d=5$, so the first clause
claims $a_{31}(n)-a_{30}(n)=11^{\,n-1}$ whenever $5(n-1)+1\le31$, that is for
$1\le n\le7$, and the second claims $a_{31}(n)-a_{30}(n)=11^{\,n-1}-2$ at the single
$n$ with $5(n-1)=31$.
...
arithmetic, $L_{5}$ at base $31$ reproduces all $18$ terms A126552 publishes.
...
First, the model reproduces all $18$ terms A126552 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $L_{5}(31,n)$ & $L_{5}(30,n)$ & $11^{\,n-1}$ \\ \hline
1 & 31 & 30 & 1 \\
2 & 311 & 300 & 11 \\
3 & 3201 & 3080 & 121 \\
4 & 33241 & 31910 & 1331 \\
5 & 346973 & 332332 & 14641 \\
6 & 3633345 & 3472294 & 161051 \\
7 & 38128475 & 36356914 & 1771561 \\
\end{tabular}
\end{center}
