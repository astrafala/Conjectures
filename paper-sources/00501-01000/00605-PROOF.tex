...
\title{The empirical recurrence for OEIS A279979, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A279979 imposes three things at once: a condition on each cell that reaches one column up and
...
OEIS A279979 is ``Number of 3 X n 0..1 arrays with no element equal to a strict majority of its horizontal and antidiagonal neighbors, with the exception of exactly two elements, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
0, 9, 50, 221, 822, 2669, 8068, 23169,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 20 2023 19:19:37, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;9\,a(n-1) - 33\,a(n-2) + 60\,a(n-3) - 36\,a(n-4) - 78\,a(n-5) + 199\,a(n-6) - 165\,a(n-7) - 33\,a(n-8) + 200\,a(n-9) - 180\,a(n-10) + 66\,a(n-11) + 22\,a(n-12) - 78\,a(n-13) + 84\,a(n-14) - 40\,a(n-15) - 21\,a(n-16) + 15\,a(n-17) - 3\,a(n-18) + 18\,a(n-19) + 6\,a(n-20) - 4\,a(n-21) - 3\,a(n-22) - 3\,a(n-23) - a(n-24)
\end{equation}
for all $n>30$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A279979.
