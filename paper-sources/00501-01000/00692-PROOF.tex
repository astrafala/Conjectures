...
\title{The cross-base identity for OEIS A124994, proved}
...
\begin{abstract}
OEIS A124994 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A124994 is ``Number of base 31 circular n-digit numbers with adjacent digits differing by 2 or less.''. It has offset $0$ and begins
\[
1, 31, 149, 559, 2457, 10861, 49253, 226033,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:18:51, revision 16)
...
the base is $31$ and the permitted difference is $d=2$, so the claim is that
\[
a_{31}(n)-a_{30}(n)\;=\;F_{2}(n)
\qquad\text{for every } n \text{ with } 2\lfloor n/2\rfloor+1\le31,
\]
that is, for $1\le n\le31$.
...
at base $31$ reproduces all $21$ terms A124994 publishes, and at base $30$ all the
...
polynomial. In particular $a_{31}(n)-a_{30}(n)=F_{2}(n)$ for $1\le n\le31$, which
...
First, the model reproduces all $21$ terms A124994 publishes, exactly, in integer
...
$1\le n\le31$, with both sides computed from the definition and not from the theorem:

\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{2}(31,n)$ & $T_{2}(30,n)$ & $F_{2}(n)$ \\ \hline
1 & 31 & 30 & 1 \\
2 & 149 & 144 & 5 \\
3 & 559 & 540 & 19 \\
4 & 2457 & 2372 & 85 \\
5 & 10861 & 10480 & 381 \\
6 & 49253 & 47502 & 1751 \\
7 & 226033 & 217898 & 8135 \\
8 & 1048177 & 1010012 & 38165 \\
\end{tabular}
\end{center}
