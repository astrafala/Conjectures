...
\title{The cross-base identity for OEIS A125357, proved}
...
\begin{abstract}
OEIS A125357 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125357 is ``Number of base 20 circular n-digit numbers with adjacent digits differing by 4 or less.''. It has offset $0$ and begins
\[
1, 20, 160, 1040, 7880, 60720, 479296, 3835544,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:26:44, revision 11)
...
the base is $20$ and the permitted difference is $d=4$, so the claim is that
\[
a_{20}(n)-a_{19}(n)\;=\;F_{4}(n)
\qquad\text{for every } n \text{ with } 4\lfloor n/2\rfloor+1\le20,
\]
...
at base $20$ reproduces all $20$ terms A125357 publishes, and at base $19$ all the
...
polynomial. In particular $a_{20}(n)-a_{19}(n)=F_{4}(n)$ for $1\le n\le9$, which
...
First, the model reproduces all $20$ terms A125357 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{4}(20,n)$ & $T_{4}(19,n)$ & $F_{4}(n)$ \\ \hline
1 & 20 & 19 & 1 \\
2 & 160 & 151 & 9 \\
3 & 1040 & 979 & 61 \\
4 & 7880 & 7391 & 489 \\
5 & 60720 & 56769 & 3951 \\
6 & 479296 & 446635 & 32661 \\
7 & 3835544 & 3562417 & 273127 \\
8 & 31025864 & 28719839 & 2306025 \\
\end{tabular}
\end{center}
