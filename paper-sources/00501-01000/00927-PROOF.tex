...
\title{The cross-base identity for OEIS A126417, proved}
...
\begin{abstract}
OEIS A126417 carries an empirical identity, in two clauses, relating its counts to those of the
...
OEIS A126417 is ``Number of base 30 n-digit numbers with adjacent digits differing by two or less.''. It has offset $0$ and begins
\[
1, 30, 144, 700, 3418, 16736, 82098, 403274,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:12:37, revision 9)
this is still recorded as empirical, and nothing on the entry records it as proved.

For this entry the base is $30$ and the permitted difference is $d=2$, so the first clause
claims $a_{30}(n)-a_{29}(n)=5^{\,n-1}$ whenever $2(n-1)+1\le30$, that is for
$1\le n\le15$, and the second claims $a_{30}(n)-a_{29}(n)=5^{\,n-1}-2$ at the single
$n$ with $2(n-1)=30$.
...
arithmetic, $L_{2}$ at base $30$ reproduces all $21$ terms A126417 publishes.
...
First, the model reproduces all $21$ terms A126417 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $L_{2}(30,n)$ & $L_{2}(29,n)$ & $5^{\,n-1}$ \\ \hline
1 & 30 & 29 & 1 \\
2 & 144 & 139 & 5 \\
3 & 700 & 675 & 25 \\
4 & 3418 & 3293 & 125 \\
5 & 16736 & 16111 & 625 \\
6 & 82098 & 78973 & 3125 \\
7 & 403274 & 387649 & 15625 \\
8 & 1982980 & 1904855 & 78125 \\
\end{tabular}
\end{center}
...
Third, the second clause was evaluated at its own index. For this entry the second clause bites at $n=16$, where $b=30=2(n-1)$: there $L_{2}(30,16)-L_{2}(29,16)=30517578123$ and $5^{15}-2=30517578123$.

\section*{References}
\begin{enumerate}
\item The OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences},
\url{https://oeis.org/A126417}.
\end{enumerate}
