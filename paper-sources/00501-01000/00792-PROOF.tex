...
\title{The cross-base identity for OEIS A125392, proved}
...
\begin{abstract}
OEIS A125392 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125392 is ``Number of base 29 circular n-digit numbers with adjacent digits differing by 5 or less.''. It has offset $0$ and begins
\[
1, 29, 289, 2309, 21589, 205179, 1997281, 19709719,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:32:16, revision 12)
...
the base is $29$ and the permitted difference is $d=5$, so the claim is that
\[
a_{29}(n)-a_{28}(n)\;=\;F_{5}(n)
\qquad\text{for every } n \text{ with } 5\lfloor n/2\rfloor+1\le29,
\]
...
at base $29$ reproduces all $18$ terms A125392 publishes, and at base $28$ all the
...
polynomial. In particular $a_{29}(n)-a_{28}(n)=F_{5}(n)$ for $1\le n\le11$, which
...
First, the model reproduces all $18$ terms A125392 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{5}(29,n)$ & $T_{5}(28,n)$ & $F_{5}(n)$ \\ \hline
1 & 29 & 28 & 1 \\
2 & 289 & 278 & 11 \\
3 & 2309 & 2218 & 91 \\
4 & 21589 & 20698 & 891 \\
5 & 205179 & 196378 & 8801 \\
6 & 1997281 & 1908368 & 88913 \\
7 & 19709719 & 18800964 & 908755 \\
8 & 196617709 & 187240242 & 9377467 \\
\end{tabular}
\end{center}
