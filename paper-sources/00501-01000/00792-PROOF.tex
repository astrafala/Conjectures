...
\title{The cross-base identity for OEIS A125462, proved}
...
\begin{abstract}
OEIS A125462 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125462 is ``Number of base 27 circular n-digit numbers with adjacent digits differing by 8 or less.''. It has offset $0$ and begins
\[
1, 27, 387, 4635, 64275, 910047, 13176603, 193286799,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:39:23, revision 12)
...
the base is $27$ and the permitted difference is $d=8$, so the claim is that
\[
a_{27}(n)-a_{26}(n)\;=\;F_{8}(n)
\qquad\text{for every } n \text{ with } 8\lfloor n/2\rfloor+1\le27,
\]
...
at base $27$ reproduces all $17$ terms A125462 publishes, and at base $26$ all the
...
polynomial. In particular $a_{27}(n)-a_{26}(n)=F_{8}(n)$ for $1\le n\le7$, which
...
First, the model reproduces all $17$ terms A125462 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{8}(27,n)$ & $T_{8}(26,n)$ & $F_{8}(n)$ \\ \hline
1 & 27 & 26 & 1 \\
2 & 387 & 370 & 17 \\
3 & 4635 & 4418 & 217 \\
4 & 64275 & 60994 & 3281 \\
5 & 910047 & 859946 & 50101 \\
6 & 13176603 & 12394450 & 782153 \\
7 & 193286799 & 180932330 & 12354469 \\
\end{tabular}
\end{center}
