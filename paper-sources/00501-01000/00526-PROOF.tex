...
\title{The empirical recurrence for OEIS A229603, proved by counting defective colourings}
...
\begin{abstract}
OEIS A229603 counts the colourings of an array with $K=3$ colours that are proper except at
...
order $16$ contributed by R.~H.~Hardin follows from a finite exact computation.
\end{abstract}
...
OEIS A229603 is ``Number of defective 3-colorings of an n X 5 0..2 array connected horizontally and vertically with exactly two mistakes, and colors introduced in row-major 0..2 order.''. It has offset $1$ and begins
\[
12, 925, 20714, 362100, 5655616, 82613904, 1153135492, 15568071652,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 27 2021 21:27:42, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;47\,a(n-1) - 915\,a(n-2) + 9649\,a(n-3) - 60959\,a(n-4) + 242397\,a(n-5) - 616481\,a(n-6) + 977203\,a(n-7) - 836412\,a(n-8) + 41816\,a(n-9) + 793688\,a(n-10) - 1000320\,a(n-11) + 656832\,a(n-12) - 262080\,a(n-13) + 63744\,a(n-14) - 8704\,a(n-15) + 512\,a(n-16)
\end{equation}
for all $n>17$.
...
\[
3!\Bigl(a(n_0+j)-\sum_i c_i\,a(n_0+j-i)\Bigr)=\mathbf{v}^{\!\top}G^{\,j-16}w,
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A229603.
