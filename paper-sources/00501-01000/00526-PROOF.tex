...
\title{The empirical recurrence for OEIS A266219, proved from an exact model}
...
\begin{abstract}
OEIS A266219 carries an empirical recurrence of order $3$ contributed by Colin Barker. It is true, and it is
...
\begin{quote}
Conjectures from \_Colin Barker\_, Dec 25 2015 and Apr 13 2019: (Start) a(n) = 10*a(n-1) + a(n-2) - 10*a(n-3) for n>2.
\end{quote}
...
For this entry the column is periodic with period $q=2$ from $n=1$: the period above is a
