...
\title{The empirical recurrence for OEIS A281931, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A281931 imposes three things at once: a condition on each cell that reaches one row up and
...
numbers. The empirical recurrence of order $21$ contributed by R.~H.~Hardin then follows
...
OEIS A281931 is ``Number of nX3 0..1 arrays with no element equal to more than four of its king-move neighbors, with the exception of exactly two elements, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
0, 1, 20, 312, 3573, 31410, 252630, 1925590,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 02 2017 08:19:36, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;15\,a(n-1) - 63\,a(n-2) + 23\,a(n-3) + 3\,a(n-4) + 1161\,a(n-5) + 208\,a(n-6) - 2013\,a(n-7) - 8424\,a(n-8) - 6999\,a(n-9) + 7797\,a(n-10) + 25689\,a(n-11) + 44356\,a(n-12) + 27282\,a(n-13) - 498\,a(n-14) - 60721\,a(n-15) - 115722\,a(n-16) - 113223\,a(n-17) - 120471\,a(n-18) - 77700\,a(n-19) - 35280\,a(n-20) - 21952\,a(n-21)
\end{equation}
for all $n>26$.
...
\[
2!\Bigl(a(n_0+j)-\sum_i c_i\,a(n_0+j-i)\Bigr)=\mathbf{v}^{\!\top}G^{\,j-21}w,
\qquad w=h_{21}-\sum_i c_i h_{21-i} .
\]
...
$21$ applications of $G$ in exact integer arithmetic and $\mathbf{v}^{\!\top}G^{m}w$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A281931.
