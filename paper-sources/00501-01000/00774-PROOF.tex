...
\title{The cross-base identity for OEIS A125443, proved}
...
\begin{abstract}
OEIS A125443 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125443 is ``Number of base 31 circular n-digit numbers with adjacent digits differing by 7 or less.''. It has offset $0$ and begins
\[
1, 31, 409, 4399, 55177, 705211, 9228145, 122435659,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:37:23, revision 12)
...
the base is $31$ and the permitted difference is $d=7$, so the claim is that
\[
a_{31}(n)-a_{30}(n)\;=\;F_{7}(n)
\qquad\text{for every } n \text{ with } 7\lfloor n/2\rfloor+1\le31,
\]
...
at base $31$ reproduces all $17$ terms A125443 publishes, and at base $30$ all the
...
polynomial. In particular $a_{31}(n)-a_{30}(n)=F_{7}(n)$ for $1\le n\le9$, which
...
First, the model reproduces all $17$ terms A125443 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{7}(31,n)$ & $T_{7}(30,n)$ & $F_{7}(n)$ \\ \hline
1 & 31 & 30 & 1 \\
2 & 409 & 394 & 15 \\
3 & 4399 & 4230 & 169 \\
4 & 55177 & 52922 & 2255 \\
5 & 705211 & 674830 & 30381 \\
6 & 9228145 & 8809642 & 418503 \\
7 & 122435659 & 116602894 & 5832765 \\
8 & 1641825097 & 1559751802 & 82073295 \\
\end{tabular}
\end{center}
