...
\title{The empirical recurrence for OEIS A267801, proved from an exact model}
...
\begin{abstract}
OEIS A267801 carries an empirical recurrence of order $2$ contributed by Colin Barker. It is true, and it is
...
OEIS A267801 is ``Binary representation of the n-th iteration of the "Rule 213" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 11, 10011, 1110011, 111110011, 11111110011, 1111111110011, 111111111110011,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 21 2016 and Apr 20 2019: (Start) a(n) = 101*a(n-1)-100*a(n-2) for n>3.
\end{quote}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267801.
