...
\title{The empirical recurrence for OEIS A263244, proved from an exact model}
...
\begin{abstract}
OEIS A263244 carries an empirical recurrence of order $3$ contributed by Colin Barker. It is true, and it is
...
OEIS A263244 is ``Binary representation of the n-th iteration of the "Rule 155" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 101, 10011, 1011111, 100111111, 10111111111, 1001111111111, 101111111111111,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 20 2016 and Apr 17 2019: (Start) a(n) = a(n-1)+10000*a(n-2)-10000*a(n-3) for n>3.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 16 2025 08:33:27, revision 32)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A263244.
