...
\title{The empirical recurrence for OEIS A187608, proved from an exact model}
...
\begin{abstract}
OEIS A187608 carries an empirical recurrence of order $3$. It is true, and it is
...
\begin{quote}
Empirical: a(n) = 55*n\^{}2 - 380*n + 640 for n>5. a(n) = 3*a(n-1) - 3*a(n-2) + a(n-3) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 25 2018 11:48:52, revision 11)
...
SHAPE when one is a translate of the other. There are exactly $55$ shapes: self-avoiding
...
Write $w^\ast$ for the largest bounding-box side over all $55$ shapes. Once $n\ge w^\ast$
