...
\title{The cross-base identity for OEIS A125332, proved}
...
\begin{abstract}
OEIS A125332 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125332 is ``Number of base 22 circular n-digit numbers with adjacent digits differing by 3 or less.''. It has offset $0$ and begins
\[
1, 22, 142, 730, 4390, 26742, 166966, 1056350,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:23:41, revision 11)
...
the base is $22$ and the permitted difference is $d=3$, so the claim is that
\[
a_{22}(n)-a_{21}(n)\;=\;F_{3}(n)
\qquad\text{for every } n \text{ with } 3\lfloor n/2\rfloor+1\le22,
\]
...
at base $22$ reproduces all $20$ terms A125332 publishes, and at base $21$ all the
...
polynomial. In particular $a_{22}(n)-a_{21}(n)=F_{3}(n)$ for $1\le n\le15$, which
...
First, the model reproduces all $20$ terms A125332 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{3}(22,n)$ & $T_{3}(21,n)$ & $F_{3}(n)$ \\ \hline
1 & 22 & 21 & 1 \\
2 & 142 & 135 & 7 \\
3 & 730 & 693 & 37 \\
4 & 4390 & 4159 & 231 \\
5 & 26742 & 25291 & 1451 \\
6 & 166966 & 157635 & 9331 \\
7 & 1056350 & 995659 & 60691 \\
8 & 6755686 & 6357119 & 398567 \\
\end{tabular}
\end{center}
