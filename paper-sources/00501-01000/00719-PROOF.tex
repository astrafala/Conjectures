...
\title{The cross-base identity for OEIS A125354, proved}
...
\begin{abstract}
OEIS A125354 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125354 is ``Number of base 17 circular n-digit numbers with adjacent digits differing by 4 or less.''. It has offset $0$ and begins
\[
1, 17, 133, 857, 6413, 48867, 381313, 3016163,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:04:10, revision 13)
...
the base is $17$ and the permitted difference is $d=4$, so the claim is that
\[
a_{17}(n)-a_{16}(n)\;=\;F_{4}(n)
\qquad\text{for every } n \text{ with } 4\lfloor n/2\rfloor+1\le17,
\]
that is, for $1\le n\le9$.
...
at base $17$ reproduces all $20$ terms A125354 publishes, and at base $16$ all the
...
polynomial. In particular $a_{17}(n)-a_{16}(n)=F_{4}(n)$ for $1\le n\le9$, which
...
First, the model reproduces all $20$ terms A125354 publishes, exactly, in integer
...
$1\le n\le9$, with both sides computed from the definition and not from the theorem:

\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{4}(17,n)$ & $T_{4}(16,n)$ & $F_{4}(n)$ \\ \hline
1 & 17 & 16 & 1 \\
2 & 133 & 124 & 9 \\
3 & 857 & 796 & 61 \\
4 & 6413 & 5924 & 489 \\
5 & 48867 & 44916 & 3951 \\
6 & 381313 & 348652 & 32661 \\
7 & 3016163 & 2743036 & 273127 \\
8 & 24107789 & 21801764 & 2306025 \\
\end{tabular}
\end{center}

\noindent and the difference of the second and third columns is the fourth at every row shown
and at every row up to $n=9$.
