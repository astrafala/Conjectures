...
\title{The cross-base identity for OEIS A125386, proved}
...
\begin{abstract}
OEIS A125386 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125386 is ``Number of base 23 circular n-digit numbers with adjacent digits differing by 5 or less.''. It has offset $0$ and begins
\[
1, 23, 223, 1763, 16243, 152373, 1463803, 14257189,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:31:31, revision 12)
...
the base is $23$ and the permitted difference is $d=5$, so the claim is that
\[
a_{23}(n)-a_{22}(n)\;=\;F_{5}(n)
\qquad\text{for every } n \text{ with } 5\lfloor n/2\rfloor+1\le23,
\]
...
at base $23$ reproduces all $18$ terms A125386 publishes, and at base $22$ all the
...
polynomial. In particular $a_{23}(n)-a_{22}(n)=F_{5}(n)$ for $1\le n\le9$, which
...
First, the model reproduces all $18$ terms A125386 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{5}(23,n)$ & $T_{5}(22,n)$ & $F_{5}(n)$ \\ \hline
1 & 23 & 22 & 1 \\
2 & 223 & 212 & 11 \\
3 & 1763 & 1672 & 91 \\
4 & 16243 & 15352 & 891 \\
5 & 152373 & 143572 & 8801 \\
6 & 1463803 & 1374890 & 88913 \\
7 & 14257189 & 13348434 & 908755 \\
8 & 140352907 & 130975440 & 9377467 \\
\end{tabular}
\end{center}
