...
\title{The empirical recurrence for OEIS A264331, proved by transfer matrix}
...
\begin{abstract}
OEIS A264331 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=4$ rows in which
...
OEIS A264331 is ``Number of (n+1)X(3+1) arrays of permutations of 0..n*4+3 with each element having directed index change -1,1 1,0 1,-1 or 0,-1.''. It has offset $1$ and begins
\[
1, 4, 11, 40, 133, 464, 1573, 5373,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 11 2015 13:13:51, revision 4) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264331.
