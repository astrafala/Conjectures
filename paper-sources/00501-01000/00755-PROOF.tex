...
\title{The cross-base identity for OEIS A125383, proved}
...
\begin{abstract}
OEIS A125383 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125383 is ``Number of base 20 circular n-digit numbers with adjacent digits differing by 5 or less.''. It has offset $0$ and begins
\[
1, 20, 190, 1490, 13570, 125970, 1197064, 11530924,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:31:15, revision 12)
...
the base is $20$ and the permitted difference is $d=5$, so the claim is that
\[
a_{20}(n)-a_{19}(n)\;=\;F_{5}(n)
\qquad\text{for every } n \text{ with } 5\lfloor n/2\rfloor+1\le20,
\]
...
at base $20$ reproduces all $18$ terms A125383 publishes, and at base $19$ all the
...
polynomial. In particular $a_{20}(n)-a_{19}(n)=F_{5}(n)$ for $1\le n\le7$, which
...
First, the model reproduces all $18$ terms A125383 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{5}(20,n)$ & $T_{5}(19,n)$ & $F_{5}(n)$ \\ \hline
1 & 20 & 19 & 1 \\
2 & 190 & 179 & 11 \\
3 & 1490 & 1399 & 91 \\
4 & 13570 & 12679 & 891 \\
5 & 125970 & 117169 & 8801 \\
6 & 1197064 & 1108151 & 88913 \\
7 & 11530924 & 10622169 & 908755 \\
\end{tabular}
\end{center}
