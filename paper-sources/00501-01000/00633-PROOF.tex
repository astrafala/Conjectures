...
\title{The empirical recurrence for OEIS A267938, proved from an exact model}
...
\begin{abstract}
OEIS A267938 carries an empirical recurrence of order $2$ contributed by Colin Barker. It is true, and it is
...
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 23 2016 and Apr 16 2019: (Start) a(n) = 5*a(n-1)-4*a(n-2) for n>3.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 24 2025 12:23:25, revision 23)
