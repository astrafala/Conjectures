...
\title{The empirical recurrence for OEIS A231068, proved by transfer matrix}
...
\begin{abstract}
OEIS A231068 counts the black-square subarrays of arrays of width $5$ over $\{0,1\}$ in which
...
OEIS A231068 is ``Number of black square subarrays of (n+1)X(4+1) binary arrays with no element equal to a strict majority of its diagonal and antidiagonal neighbors, with upper left element zero.''. It has offset $1$ and begins
\[
3, 11, 24, 89, 191, 748, 1573, 6259,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 14*a(n-2) -61*a(n-4) +148*a(n-6) -289*a(n-8) +325*a(n-10) -227*a(n-12) +95*a(n-14) -28*a(n-16) +4*a(n-18)
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 06:14:35, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231068.
