...
\title{The empirical recurrence for OEIS A187029, proved from an exact model}
...
\begin{abstract}
OEIS A187029 carries an empirical recurrence of order $3$. It is true, and it is
...
OEIS A187029 is ``Number of 4-step one or two collinear space at a time queen's tours on an n X n board summed over all starting positions.''. It has offset $1$ and begins
\[
0, 24, 1344, 7056, 19568, 39348, 66360, 100380,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3504*n\^{}2 - 18540*n + 24444 for n>5. a(n) = 3*a(n-1) - 3*a(n-2) + a(n-3) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 20 2018 06:08:47, revision 10)
...
SHAPE when one is a translate of the other. There are exactly $3504$ shapes: self-avoiding
...
Write $w^\ast$ for the largest bounding-box side over all $3504$ shapes. Once $n\ge w^\ast$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A187029.
