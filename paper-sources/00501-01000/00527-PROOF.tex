...
\title{The empirical recurrence for OEIS A267877, proved from an exact model}
...
\begin{abstract}
OEIS A267877 carries an empirical recurrence of order $2$ contributed by Colin Barker. It is true, and it is
...
which $a$ provably satisfies a MONIC linear recurrence of order $S=3$, derived below and not
...
OEIS A267877 is ``Decimal representation of the n-th iteration of the "Rule 233" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 0, 21, 119, 511, 2047, 8191, 32767,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 22 2016 and Apr 20 2019: (Start) a(n) = 5*a(n-1)-4*a(n-2) for n>3.
\end{quote}
...
pre-period to raise the numerator's degree gives a monic annihilator of order $S=3$. The
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267877.
