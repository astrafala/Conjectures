...
\title{The empirical recurrence for OEIS A218191, proved by transfer matrix}
...
\begin{abstract}
OEIS A218191 counts the distinct indicator arrays obtained from the $n\times3$ arrays over
...
indicator row by row turns it into one, on $S=289$ states, after which the conjectured
...
OEIS A218191 is ``Hilltop maps: number of nX3 binary arrays indicating the locations of corresponding elements not exceeded by any horizontal or vertical neighbor in a random 0..3 nX3 array.''. It has offset $1$ and begins
\[
7, 63, 507, 4067, 32529, 260205, 2081511, 16651157,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 17:35:31, revision 8) this is still
...
\]
There are $S=289$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite. Note
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-1) + 7\,a(n-2) + 7\,a(n-3) + 6\,a(n-4) + 12\,a(n-5) + 10\,a(n-6) + 48\,a(n-7) + 9\,a(n-8) + 9\,a(n-9) + 9\,a(n-10) + 5\,a(n-11) + 13\,a(n-12) + 11\,a(n-13) - 52\,a(n-14) - 64\,a(n-15) - 63\,a(n-16) - 59\,a(n-17) - 48\,a(n-18) - 38\,a(n-19) + 13\,a(n-20) + 41\,a(n-21) + 48\,a(n-22) + 46\,a(n-23) + 33\,a(n-24) + 15\,a(n-25) + 5\,a(n-26) - 5\,a(n-27) - 7\,a(n-28) - 7\,a(n-29) - 6\,a(n-30) - 2\,a(n-31) + 2\,a(n-32) - a(n-34) - a(n-35) - a(n-36) - a(n-37)
\]
for every $n>37$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A218191.
