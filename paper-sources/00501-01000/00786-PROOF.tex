...
\title{The cross-base identity for OEIS A125456, proved}
...
\begin{abstract}
OEIS A125456 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125456 is ``Number of base 21 circular n-digit numbers with adjacent digits differing by 8 or less.''. It has offset $0$ and begins
\[
1, 21, 285, 3333, 44589, 609441, 8484027, 119207781,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:38:42, revision 12)
...
the base is $21$ and the permitted difference is $d=8$, so the claim is that
\[
a_{21}(n)-a_{20}(n)\;=\;F_{8}(n)
\qquad\text{for every } n \text{ with } 8\lfloor n/2\rfloor+1\le21,
\]
...
at base $21$ reproduces all $17$ terms A125456 publishes, and at base $20$ all the
...
polynomial. In particular $a_{21}(n)-a_{20}(n)=F_{8}(n)$ for $1\le n\le5$, which
...
First, the model reproduces all $17$ terms A125456 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{8}(21,n)$ & $T_{8}(20,n)$ & $F_{8}(n)$ \\ \hline
1 & 21 & 20 & 1 \\
2 & 285 & 268 & 17 \\
3 & 3333 & 3116 & 217 \\
4 & 44589 & 41308 & 3281 \\
5 & 609441 & 559340 & 50101 \\
\end{tabular}
\end{center}
