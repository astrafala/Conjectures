...
\title{The empirical recurrence for OEIS A267941, proved from an exact model}
...
\begin{abstract}
OEIS A267941 carries an empirical recurrence of order $2$ contributed by Colin Barker. It is true, and it is
