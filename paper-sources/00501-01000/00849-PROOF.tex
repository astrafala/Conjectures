...
\title{The cross-base identity for OEIS A125452, proved}
...
\begin{abstract}
OEIS A125452 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125452 is ``Number of base 17 circular n-digit numbers with adjacent digits differing by 8 or less.''. It has offset $0$ and begins
\[
1, 17, 217, 2465, 31465, 409037, 5372965, 70853093,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:38:19, revision 12)
...
the base is $17$ and the permitted difference is $d=8$, so the claim is that
\[
a_{17}(n)-a_{16}(n)\;=\;F_{8}(n)
\qquad\text{for every } n \text{ with } 8\lfloor n/2\rfloor+1\le17,
\]
...
at base $17$ reproduces all $17$ terms A125452 publishes, and at base $16$ all the
...
polynomial. In particular $a_{17}(n)-a_{16}(n)=F_{8}(n)$ for $1\le n\le5$, which
...
First, the model reproduces all $17$ terms A125452 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{8}(17,n)$ & $T_{8}(16,n)$ & $F_{8}(n)$ \\ \hline
1 & 17 & 16 & 1 \\
2 & 217 & 200 & 17 \\
3 & 2465 & 2248 & 217 \\
4 & 31465 & 28184 & 3281 \\
5 & 409037 & 358936 & 50101 \\
\end{tabular}
\end{center}
