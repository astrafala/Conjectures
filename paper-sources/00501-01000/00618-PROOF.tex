...
\title{The empirical recurrence for OEIS A267802, proved from an exact model}
...
\begin{abstract}
OEIS A267802 carries an empirical recurrence of order $2$ contributed by Colin Barker. It is true, and it is
...
\[
1, 3, 19, 115, 499, 2035, 8179, 32755,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 21 2016: (Start) a(n) = 5*a(n-1)-4*a(n-2) for n>3.
\end{quote}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267802.
