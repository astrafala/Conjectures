...
\title{The empirical recurrence for OEIS A267851, proved from an exact model}
...
\begin{abstract}
OEIS A267851 carries an empirical recurrence of order $2$ contributed by Colin Barker. It is true, and it is
...
OEIS A267851 is ``Decimal representation of the n-th iteration of the "Rule 229" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 2, 30, 126, 510, 2046, 8190, 32766,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 21 2016: (Start) a(n) = 5*a(n-1)-4*a(n-2) for n>3.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 24 2025 12:37:59, revision 23)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267851.
