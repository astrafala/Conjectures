...
\title{The empirical recurrence for OEIS A267539, proved from an exact model}
...
\begin{abstract}
OEIS A267539 carries an empirical recurrence of order $2$ contributed by Colin Barker. It is true, and it is
...
OEIS A267539 is ``Decimal representation of the middle column of the "Rule 143" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 3, 6, 12, 25, 51, 103, 207,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 17 2016 and Apr 20 2019: (Start) a(n) = 3*a(n-1)-2*a(n-2) for n > 4. [n range correction by \_Karl V. Keller, Jr.\_, Apr 14 2022]
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 16 2025 08:33:29, revision 45)
...
light cone; the entry lists the first $n+1$ of them concatenated and read as a binary numeral. Nothing is being counted, so there is no digraph, and that
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267539.
