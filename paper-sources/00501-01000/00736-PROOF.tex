...
\title{The cross-base identity for OEIS A125334, proved}
...
\begin{abstract}
OEIS A125334 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125334 is ``Number of base 24 circular n-digit numbers with adjacent digits differing by 3 or less.''. It has offset $0$ and begins
\[
1, 24, 156, 804, 4852, 29644, 185628, 1177732,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:23:52, revision 11)
...
the base is $24$ and the permitted difference is $d=3$, so the claim is that
\[
a_{24}(n)-a_{23}(n)\;=\;F_{3}(n)
\qquad\text{for every } n \text{ with } 3\lfloor n/2\rfloor+1\le24,
\]
...
at base $24$ reproduces all $20$ terms A125334 publishes, and at base $23$ all the
...
polynomial. In particular $a_{24}(n)-a_{23}(n)=F_{3}(n)$ for $1\le n\le15$, which
...
First, the model reproduces all $20$ terms A125334 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{3}(24,n)$ & $T_{3}(23,n)$ & $F_{3}(n)$ \\ \hline
1 & 24 & 23 & 1 \\
2 & 156 & 149 & 7 \\
3 & 804 & 767 & 37 \\
4 & 4852 & 4621 & 231 \\
5 & 29644 & 28193 & 1451 \\
6 & 185628 & 176297 & 9331 \\
7 & 1177732 & 1117041 & 60691 \\
8 & 7552820 & 7154253 & 398567 \\
\end{tabular}
\end{center}
