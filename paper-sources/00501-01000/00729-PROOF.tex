...
\title{The cross-base identity for OEIS A125382, proved}
...
\begin{abstract}
OEIS A125382 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125382 is ``Number of base 19 circular n-digit numbers with adjacent digits differing by 5 or less.''. It has offset $0$ and begins
\[
1, 19, 179, 1399, 12679, 117169, 1108151, 10622169,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:05:16, revision 14)
...
the base is $19$ and the permitted difference is $d=5$, so the claim is that
\[
a_{19}(n)-a_{18}(n)\;=\;F_{5}(n)
\qquad\text{for every } n \text{ with } 5\lfloor n/2\rfloor+1\le19,
\]
...
at base $19$ reproduces all $19$ terms A125382 publishes, and at base $18$ all the
...
polynomial. In particular $a_{19}(n)-a_{18}(n)=F_{5}(n)$ for $1\le n\le7$, which
...
First, the model reproduces all $19$ terms A125382 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{5}(19,n)$ & $T_{5}(18,n)$ & $F_{5}(n)$ \\ \hline
1 & 19 & 18 & 1 \\
2 & 179 & 168 & 11 \\
3 & 1399 & 1308 & 91 \\
4 & 12679 & 11788 & 891 \\
5 & 117169 & 108368 & 8801 \\
6 & 1108151 & 1019238 & 88913 \\
7 & 10622169 & 9713414 & 908755 \\
\end{tabular}
\end{center}
