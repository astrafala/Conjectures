...
\title{The cross-base identity for OEIS A125364, proved}
...
\begin{abstract}
OEIS A125364 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125364 is ``Number of base 27 circular n-digit numbers with adjacent digits differing by 4 or less.''. It has offset $0$ and begins
\[
1, 27, 223, 1467, 11303, 88377, 707923, 5747433,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:27:50, revision 11)
...
the base is $27$ and the permitted difference is $d=4$, so the claim is that
\[
a_{27}(n)-a_{26}(n)\;=\;F_{4}(n)
\qquad\text{for every } n \text{ with } 4\lfloor n/2\rfloor+1\le27,
\]
...
at base $27$ reproduces all $19$ terms A125364 publishes, and at base $26$ all the
...
polynomial. In particular $a_{27}(n)-a_{26}(n)=F_{4}(n)$ for $1\le n\le13$, which
...
First, the model reproduces all $19$ terms A125364 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{4}(27,n)$ & $T_{4}(26,n)$ & $F_{4}(n)$ \\ \hline
1 & 27 & 26 & 1 \\
2 & 223 & 214 & 9 \\
3 & 1467 & 1406 & 61 \\
4 & 11303 & 10814 & 489 \\
5 & 88377 & 84426 & 3951 \\
6 & 707923 & 675262 & 32661 \\
7 & 5747433 & 5474306 & 273127 \\
8 & 47168039 & 44862014 & 2306025 \\
\end{tabular}
\end{center}
