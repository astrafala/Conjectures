...
\title{The cross-base identity for OEIS A125414, proved}
...
\begin{abstract}
OEIS A125414 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125414 is ``Number of base 26 circular n-digit numbers with adjacent digits differing by 6 or less.''. It has offset $0$ and begins
\[
1, 26, 296, 2756, 29892, 330356, 3738086, 42883958,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:34:33, revision 12)
...
the base is $26$ and the permitted difference is $d=6$, so the claim is that
\[
a_{26}(n)-a_{25}(n)\;=\;F_{6}(n)
\qquad\text{for every } n \text{ with } 6\lfloor n/2\rfloor+1\le26,
\]
...
at base $26$ reproduces all $17$ terms A125414 publishes, and at base $25$ all the
...
polynomial. In particular $a_{26}(n)-a_{25}(n)=F_{6}(n)$ for $1\le n\le9$, which
...
First, the model reproduces all $17$ terms A125414 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{6}(26,n)$ & $T_{6}(25,n)$ & $F_{6}(n)$ \\ \hline
1 & 26 & 25 & 1 \\
2 & 296 & 283 & 13 \\
3 & 2756 & 2629 & 127 \\
4 & 29892 & 28423 & 1469 \\
5 & 330356 & 313205 & 17151 \\
6 & 3738086 & 3533323 & 204763 \\
7 & 42883958 & 40410633 & 2473325 \\
8 & 497205916 & 467043615 & 30162301 \\
\end{tabular}
\end{center}
