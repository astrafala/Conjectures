...
\title{The empirical recurrence for OEIS A279053, proved from an exact model}
...
\begin{abstract}
OEIS A279053 carries an empirical recurrence of order $3$ contributed by Colin Barker. It is true, and it is
...
\[
1, 1, 101, 101, 10101, 10101, 1010101, 1010101,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Dec 05 2016: (Start) a(n) = a(n-1) + 100*a(n-2) - 100*a(n-3) for n>2.
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 05 2025 15:22:35, revision 10)
