...
\title{The cross-base identity for OEIS A126487, proved}
...
\begin{abstract}
OEIS A126487 carries an empirical identity, in two clauses, relating its counts to those of the
...
OEIS A126487 is ``Number of base 19 n-digit numbers with adjacent digits differing by three or less.''. It has offset $0$ and begins
\[
1, 19, 121, 791, 5217, 34587, 230033, 1533159,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:13:48, revision 13)
this is still recorded as empirical, and nothing on the entry records it as proved.

For this entry the base is $19$ and the permitted difference is $d=3$, so the first clause
claims $a_{19}(n)-a_{18}(n)=7^{\,n-1}$ whenever $3(n-1)+1\le19$, that is for
$1\le n\le7$, and the second claims $a_{19}(n)-a_{18}(n)=7^{\,n-1}-2$ at the single
$n$ with $3(n-1)=19$.
...
arithmetic, $L_{3}$ at base $19$ reproduces all $20$ terms A126487 publishes.
...
First, the model reproduces all $20$ terms A126487 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $L_{3}(19,n)$ & $L_{3}(18,n)$ & $7^{\,n-1}$ \\ \hline
1 & 19 & 18 & 1 \\
2 & 121 & 114 & 7 \\
3 & 791 & 742 & 49 \\
4 & 5217 & 4874 & 343 \\
5 & 34587 & 32186 & 2401 \\
6 & 230033 & 213226 & 16807 \\
7 & 1533159 & 1415510 & 117649 \\
\end{tabular}
\end{center}
