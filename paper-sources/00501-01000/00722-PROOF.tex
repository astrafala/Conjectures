...
\title{The cross-base identity for OEIS A125338, proved}
...
\begin{abstract}
OEIS A125338 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125338 is ``Number of base 28 circular n-digit numbers with adjacent digits differing by 3 or less.''. It has offset $0$ and begins
\[
1, 28, 184, 952, 5776, 35448, 222952, 1420496,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:24:20, revision 11)
...
the base is $28$ and the permitted difference is $d=3$, so the claim is that
\[
a_{28}(n)-a_{27}(n)\;=\;F_{3}(n)
\qquad\text{for every } n \text{ with } 3\lfloor n/2\rfloor+1\le28,
\]
...
at base $28$ reproduces all $20$ terms A125338 publishes, and at base $27$ all the
...
polynomial. In particular $a_{28}(n)-a_{27}(n)=F_{3}(n)$ for $1\le n\le19$, which
...
First, the model reproduces all $20$ terms A125338 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{3}(28,n)$ & $T_{3}(27,n)$ & $F_{3}(n)$ \\ \hline
1 & 28 & 27 & 1 \\
2 & 184 & 177 & 7 \\
3 & 952 & 915 & 37 \\
4 & 5776 & 5545 & 231 \\
5 & 35448 & 33997 & 1451 \\
6 & 222952 & 213621 & 9331 \\
7 & 1420496 & 1359805 & 60691 \\
8 & 9147088 & 8748521 & 398567 \\
\end{tabular}
\end{center}
