...
\title{The cross-base identity for OEIS A125389, proved}
...
\begin{abstract}
OEIS A125389 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125389 is ``Number of base 26 circular n-digit numbers with adjacent digits differing by 5 or less.''. It has offset $0$ and begins
\[
1, 26, 256, 2036, 18916, 178776, 1730542, 16983454,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:31:51, revision 12)
...
the base is $26$ and the permitted difference is $d=5$, so the claim is that
\[
a_{26}(n)-a_{25}(n)\;=\;F_{5}(n)
\qquad\text{for every } n \text{ with } 5\lfloor n/2\rfloor+1\le26,
\]
...
at base $26$ reproduces all $18$ terms A125389 publishes, and at base $25$ all the
...
polynomial. In particular $a_{26}(n)-a_{25}(n)=F_{5}(n)$ for $1\le n\le11$, which
...
First, the model reproduces all $18$ terms A125389 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{5}(26,n)$ & $T_{5}(25,n)$ & $F_{5}(n)$ \\ \hline
1 & 26 & 25 & 1 \\
2 & 256 & 245 & 11 \\
3 & 2036 & 1945 & 91 \\
4 & 18916 & 18025 & 891 \\
5 & 178776 & 169975 & 8801 \\
6 & 1730542 & 1641629 & 88913 \\
7 & 16983454 & 16074699 & 908755 \\
8 & 168485308 & 159107841 & 9377467 \\
\end{tabular}
\end{center}
