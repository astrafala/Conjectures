...
\title{The cross-base identity for OEIS A125420, proved}
...
\begin{abstract}
OEIS A125420 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125420 is ``Number of base 32 circular n-digit numbers with adjacent digits differing by 6 or less.''. It has offset $0$ and begins
\[
1, 32, 374, 3518, 38706, 433262, 4966664, 57723908,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:35:05, revision 12)
...
the base is $32$ and the permitted difference is $d=6$, so the claim is that
\[
a_{32}(n)-a_{31}(n)\;=\;F_{6}(n)
\qquad\text{for every } n \text{ with } 6\lfloor n/2\rfloor+1\le32,
\]
...
at base $32$ reproduces all $17$ terms A125420 publishes, and at base $31$ all the
...
polynomial. In particular $a_{32}(n)-a_{31}(n)=F_{6}(n)$ for $1\le n\le11$, which
...
First, the model reproduces all $17$ terms A125420 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{6}(32,n)$ & $T_{6}(31,n)$ & $F_{6}(n)$ \\ \hline
1 & 32 & 31 & 1 \\
2 & 374 & 361 & 13 \\
3 & 3518 & 3391 & 127 \\
4 & 38706 & 37237 & 1469 \\
5 & 433262 & 416111 & 17151 \\
6 & 4966664 & 4761901 & 204763 \\
7 & 57723908 & 55250583 & 2473325 \\
8 & 678179722 & 648017421 & 30162301 \\
\end{tabular}
\end{center}
