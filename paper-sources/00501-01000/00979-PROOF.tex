...
\title{The cross-base identity for OEIS A126498, proved}
...
\begin{abstract}
OEIS A126498 carries an empirical identity, in two clauses, relating its counts to those of the
...
OEIS A126498 is ``Number of base 30 n-digit numbers with adjacent digits differing by three or less.''. It has offset $0$ and begins
\[
1, 30, 198, 1330, 8990, 60998, 414910, 2827298,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:14:47, revision 9)
this is still recorded as empirical, and nothing on the entry records it as proved.

For this entry the base is $30$ and the permitted difference is $d=3$, so the first clause
claims $a_{30}(n)-a_{29}(n)=7^{\,n-1}$ whenever $3(n-1)+1\le30$, that is for
$1\le n\le10$, and the second claims $a_{30}(n)-a_{29}(n)=7^{\,n-1}-2$ at the single
$n$ with $3(n-1)=30$.
...
arithmetic, $L_{3}$ at base $30$ reproduces all $20$ terms A126498 publishes.
...
First, the model reproduces all $20$ terms A126498 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $L_{3}(30,n)$ & $L_{3}(29,n)$ & $7^{\,n-1}$ \\ \hline
1 & 30 & 29 & 1 \\
2 & 198 & 191 & 7 \\
3 & 1330 & 1281 & 49 \\
4 & 8990 & 8647 & 343 \\
5 & 60998 & 58597 & 2401 \\
6 & 414910 & 398103 & 16807 \\
7 & 2827298 & 2709649 & 117649 \\
8 & 19292018 & 18468475 & 823543 \\
\end{tabular}
\end{center}
...
Third, the second clause was evaluated at its own index. For this entry the second clause bites at $n=11$, where $b=30=3(n-1)$: there $L_{3}(30,11)-L_{3}(29,11)=282475247$ and $7^{10}-2=282475247$.

\section*{References}
\begin{enumerate}
\item The OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences},
\url{https://oeis.org/A126498}.
\end{enumerate}
