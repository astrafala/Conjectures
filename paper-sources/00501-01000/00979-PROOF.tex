...
\title{The cross-base identity for OEIS A126527, proved}
...
\begin{abstract}
OEIS A126527 carries an empirical identity, in two clauses, relating its counts to those of the
...
OEIS A126527 is ``Number of base 32 n-digit numbers with adjacent digits differing by four or less.''. It has offset $0$ and begins
\[
1, 32, 268, 2292, 19748, 170904, 1483284, 12899556,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:52:36, revision 9)
this is still recorded as empirical, and nothing on the entry records it as proved.

For this entry the base is $32$ and the permitted difference is $d=4$, so the first clause
claims $a_{32}(n)-a_{31}(n)=9^{\,n-1}$ whenever $4(n-1)+1\le32$, that is for
$1\le n\le8$, and the second claims $a_{32}(n)-a_{31}(n)=9^{\,n-1}-2$ at the single
$n$ with $4(n-1)=32$.
...
arithmetic, $L_{4}$ at base $32$ reproduces all $19$ terms A126527 publishes.
...
First, the model reproduces all $19$ terms A126527 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $L_{4}(32,n)$ & $L_{4}(31,n)$ & $9^{\,n-1}$ \\ \hline
1 & 32 & 31 & 1 \\
2 & 268 & 259 & 9 \\
3 & 2292 & 2211 & 81 \\
4 & 19748 & 19019 & 729 \\
5 & 170904 & 164343 & 6561 \\
6 & 1483284 & 1424235 & 59049 \\
7 & 12899556 & 12368115 & 531441 \\
8 & 112350184 & 107567215 & 4782969 \\
\end{tabular}
\end{center}
...
Third, the second clause was evaluated at its own index. For this entry the second clause bites at $n=9$, where $b=32=4(n-1)$: there $L_{4}(32,9)-L_{4}(31,9)=43046719$ and $9^{8}-2=43046719$.

\section*{References}
\begin{enumerate}
\item The OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences},
\url{https://oeis.org/A126527}.
\end{enumerate}
