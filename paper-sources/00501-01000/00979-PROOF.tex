...
\title{The cross-base identity for OEIS A126534, proved}
...
\begin{abstract}
OEIS A126534 carries an empirical identity, in two clauses, relating its counts to those of the
...
OEIS A126534 is ``Number of base 13 n-digit numbers with adjacent digits differing by five or less.''. It has offset $0$ and begins
\[
1, 13, 113, 1023, 9293, 84455, 767555, 6975829,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:53:13, revision 16)
this is still recorded as empirical, and nothing on the entry records it as proved.

For this entry the base is $13$ and the permitted difference is $d=5$, so the first clause
claims $a_{13}(n)-a_{12}(n)=11^{\,n-1}$ whenever $5(n-1)+1\le13$, that is for
$1\le n\le3$, and the second claims $a_{13}(n)-a_{12}(n)=11^{\,n-1}-2$ at the single
$n$ with $5(n-1)=13$.
...
arithmetic, $L_{5}$ at base $13$ reproduces all $19$ terms A126534 publishes.
...
First, the model reproduces all $19$ terms A126534 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $L_{5}(13,n)$ & $L_{5}(12,n)$ & $11^{\,n-1}$ \\ \hline
1 & 13 & 12 & 1 \\
2 & 113 & 102 & 11 \\
3 & 1023 & 902 & 121 \\
\end{tabular}
