...
\title{The empirical recurrence for OEIS A187860, proved from an exact model}
...
\begin{abstract}
OEIS A187860 carries an empirical recurrence of order $3$. It is true, and it is
...
\begin{quote}
Empirical: a(n) = 3763*n\^{}2 - 25044*n + 40644 for n>7. a(n) = 3*a(n-1) - 3*a(n-2) + a(n-3) for n>10.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 26 2018 08:59:52, revision 10)
...
SHAPE when one is a translate of the other. There are exactly $3763$ shapes: self-avoiding
...
Write $w^\ast$ for the largest bounding-box side over all $3763$ shapes. Once $n\ge w^\ast$
