...
\title{The cross-base identity for OEIS A126542, proved}
...
\begin{abstract}
OEIS A126542 carries an empirical identity, in two clauses, relating its counts to those of the
...
OEIS A126542 is ``Number of base 21 n-digit numbers with adjacent digits differing by five or less.''. It has offset $0$ and begins
\[
1, 21, 201, 1991, 19931, 200563, 2023003, 20427271,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:18:11, revision 11)
this is still recorded as empirical, and nothing on the entry records it as proved.

For this entry the base is $21$ and the permitted difference is $d=5$, so the first clause
claims $a_{21}(n)-a_{20}(n)=11^{\,n-1}$ whenever $5(n-1)+1\le21$, that is for
$1\le n\le5$, and the second claims $a_{21}(n)-a_{20}(n)=11^{\,n-1}-2$ at the single
$n$ with $5(n-1)=21$.
...
arithmetic, $L_{5}$ at base $21$ reproduces all $18$ terms A126542 publishes.
...
First, the model reproduces all $18$ terms A126542 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $L_{5}(21,n)$ & $L_{5}(20,n)$ & $11^{\,n-1}$ \\ \hline
1 & 21 & 20 & 1 \\
2 & 201 & 190 & 11 \\
3 & 1991 & 1870 & 121 \\
4 & 19931 & 18600 & 1331 \\
5 & 200563 & 185922 & 14641 \\
\end{tabular}
\end{center}
