...
\title{The cross-base identity for OEIS A126513, proved}
...
\begin{abstract}
OEIS A126513 carries an empirical identity, in two clauses, relating its counts to those of the
...
OEIS A126513 is ``Number of base 18 n-digit numbers with adjacent digits differing by four or less.''. It has offset $0$ and begins
\[
1, 18, 142, 1158, 9542, 79050, 656612, 5461074,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:15:53, revision 11)
this is still recorded as empirical, and nothing on the entry records it as proved.

For this entry the base is $18$ and the permitted difference is $d=4$, so the first clause
claims $a_{18}(n)-a_{17}(n)=9^{\,n-1}$ whenever $4(n-1)+1\le18$, that is for
$1\le n\le5$, and the second claims $a_{18}(n)-a_{17}(n)=9^{\,n-1}-2$ at the single
$n$ with $4(n-1)=18$.
...
arithmetic, $L_{4}$ at base $18$ reproduces all $19$ terms A126513 publishes.
...
First, the model reproduces all $19$ terms A126513 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $L_{4}(18,n)$ & $L_{4}(17,n)$ & $9^{\,n-1}$ \\ \hline
1 & 18 & 17 & 1 \\
2 & 142 & 133 & 9 \\
3 & 1158 & 1077 & 81 \\
4 & 9542 & 8813 & 729 \\
