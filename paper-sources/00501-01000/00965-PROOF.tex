...
\title{The empirical recurrence for OEIS A264212, proved by transfer matrix}
...
\begin{abstract}
OEIS A264212 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=4$ rows in which
...
OEIS A264212 is ``Number of (n+1)X(3+1) arrays of permutations of 0..n*4+3 with each element having directed index change 0,0 0,1 1,0 -1,0 or 0,-2.''. It has offset $1$ and begins
\[
56, 623, 7949, 97520, 1210573, 14973263, 185410184, 2295059475,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 10 2015 11:39:45, revision 6) this is still
...
\[
(i-h_i,\,j-h_j)\;\in\;\{(-1,0),\ (0,-2),\ (0,0),\ (0,1),\ (1,0)\},
\]
...
\begin{theorem}
\[
a(n)\;=\;17\,a(n-1) - 43\,a(n-2) - 285\,a(n-3) + 1433\,a(n-4) - 479\,a(n-5) - 7539\,a(n-6) + 12721\,a(n-7) + 3719\,a(n-8) - 22631\,a(n-9) - 5279\,a(n-10) + 61275\,a(n-11) - 61275\,a(n-12) + 5279\,a(n-13) + 22631\,a(n-14) - 3719\,a(n-15) - 12721\,a(n-16) + 7539\,a(n-17) + 479\,a(n-18) - 1433\,a(n-19) + 285\,a(n-20) + 43\,a(n-21) - 17\,a(n-22) + a(n-23)
\]
for every $n>21$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264212.
