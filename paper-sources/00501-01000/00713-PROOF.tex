...
\title{The cross-base identity for OEIS A125365, proved}
...
\begin{abstract}
OEIS A125365 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125365 is ``Number of base 28 circular n-digit numbers with adjacent digits differing by 4 or less.''. It has offset $0$ and begins
\[
1, 28, 232, 1528, 11792, 92328, 740584, 6020560,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:27:55, revision 11)
...
the base is $28$ and the permitted difference is $d=4$, so the claim is that
\[
a_{28}(n)-a_{27}(n)\;=\;F_{4}(n)
\qquad\text{for every } n \text{ with } 4\lfloor n/2\rfloor+1\le28,
\]
...
at base $28$ reproduces all $19$ terms A125365 publishes, and at base $27$ all the
...
polynomial. In particular $a_{28}(n)-a_{27}(n)=F_{4}(n)$ for $1\le n\le13$, which
...
First, the model reproduces all $19$ terms A125365 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{4}(28,n)$ & $T_{4}(27,n)$ & $F_{4}(n)$ \\ \hline
1 & 28 & 27 & 1 \\
2 & 232 & 223 & 9 \\
3 & 1528 & 1467 & 61 \\
4 & 11792 & 11303 & 489 \\
5 & 92328 & 88377 & 3951 \\
6 & 740584 & 707923 & 32661 \\
7 & 6020560 & 5747433 & 273127 \\
8 & 49474064 & 47168039 & 2306025 \\
\end{tabular}
\end{center}
