...
\title{The cross-base identity for OEIS A125380, proved}
...
\begin{abstract}
OEIS A125380 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125380 is ``Number of base 17 circular n-digit numbers with adjacent digits differing by 5 or less.''. It has offset $0$ and begins
\[
1, 17, 157, 1217, 10897, 99567, 930325, 8804659,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:05:05, revision 14)
...
the base is $17$ and the permitted difference is $d=5$, so the claim is that
\[
a_{17}(n)-a_{16}(n)\;=\;F_{5}(n)
\qquad\text{for every } n \text{ with } 5\lfloor n/2\rfloor+1\le17,
\]
...
at base $17$ reproduces all $19$ terms A125380 publishes, and at base $16$ all the
...
polynomial. In particular $a_{17}(n)-a_{16}(n)=F_{5}(n)$ for $1\le n\le7$, which
...
First, the model reproduces all $19$ terms A125380 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{5}(17,n)$ & $T_{5}(16,n)$ & $F_{5}(n)$ \\ \hline
1 & 17 & 16 & 1 \\
2 & 157 & 146 & 11 \\
3 & 1217 & 1126 & 91 \\
4 & 10897 & 10006 & 891 \\
5 & 99567 & 90766 & 8801 \\
6 & 930325 & 841412 & 88913 \\
7 & 8804659 & 7895904 & 908755 \\
\end{tabular}
\end{center}
