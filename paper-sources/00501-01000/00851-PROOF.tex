...
\title{The cross-base identity for OEIS A125454, proved}
...
\begin{abstract}
OEIS A125454 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125454 is ``Number of base 19 circular n-digit numbers with adjacent digits differing by 8 or less.''. It has offset $0$ and begins
\[
1, 19, 251, 2899, 38027, 509239, 6922823, 94744711,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:38:30, revision 12)
...
the base is $19$ and the permitted difference is $d=8$, so the claim is that
\[
a_{19}(n)-a_{18}(n)\;=\;F_{8}(n)
\qquad\text{for every } n \text{ with } 8\lfloor n/2\rfloor+1\le19,
\]
...
at base $19$ reproduces all $17$ terms A125454 publishes, and at base $18$ all the
...
polynomial. In particular $a_{19}(n)-a_{18}(n)=F_{8}(n)$ for $1\le n\le5$, which
...
First, the model reproduces all $17$ terms A125454 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{8}(19,n)$ & $T_{8}(18,n)$ & $F_{8}(n)$ \\ \hline
1 & 19 & 18 & 1 \\
2 & 251 & 234 & 17 \\
3 & 2899 & 2682 & 217 \\
4 & 38027 & 34746 & 3281 \\
5 & 509239 & 459138 & 50101 \\
\end{tabular}
\end{center}
