...
\title{The cross-base identity for OEIS A126400, proved}
...
\begin{abstract}
OEIS A126400 carries an empirical identity, in two clauses, relating its counts to those of the
...
OEIS A126400 is ``Number of base 13 n-digit numbers with adjacent digits differing by two or less.''. It has offset $0$ and begins
\[
1, 13, 59, 275, 1293, 6111, 28973, 137649,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:11:03, revision 15)
this is still recorded as empirical, and nothing on the entry records it as proved.

For this entry the base is $13$ and the permitted difference is $d=2$, so the first clause
claims $a_{13}(n)-a_{12}(n)=5^{\,n-1}$ whenever $2(n-1)+1\le13$, that is for
$1\le n\le7$, and the second claims $a_{13}(n)-a_{12}(n)=5^{\,n-1}-2$ at the single
$n$ with $2(n-1)=13$.
...
arithmetic, $L_{2}$ at base $13$ reproduces all $22$ terms A126400 publishes.
...
First, the model reproduces all $22$ terms A126400 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $L_{2}(13,n)$ & $L_{2}(12,n)$ & $5^{\,n-1}$ \\ \hline
1 & 13 & 12 & 1 \\
2 & 59 & 54 & 5 \\
3 & 275 & 250 & 25 \\
4 & 1293 & 1168 & 125 \\
