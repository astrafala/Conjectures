...
\title{The cross-base identity for OEIS A125463, proved}
...
\begin{abstract}
OEIS A125463 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125463 is ``Number of base 28 circular n-digit numbers with adjacent digits differing by 8 or less.''. It has offset $0$ and begins
\[
1, 28, 404, 4852, 67556, 960148, 13958756, 205641268,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:39:31, revision 12)
...
the base is $28$ and the permitted difference is $d=8$, so the claim is that
\[
a_{28}(n)-a_{27}(n)\;=\;F_{8}(n)
\qquad\text{for every } n \text{ with } 8\lfloor n/2\rfloor+1\le28,
\]
...
at base $28$ reproduces all $17$ terms A125463 publishes, and at base $27$ all the
...
polynomial. In particular $a_{28}(n)-a_{27}(n)=F_{8}(n)$ for $1\le n\le7$, which
...
First, the model reproduces all $17$ terms A125463 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{8}(28,n)$ & $T_{8}(27,n)$ & $F_{8}(n)$ \\ \hline
1 & 28 & 27 & 1 \\
2 & 404 & 387 & 17 \\
3 & 4852 & 4635 & 217 \\
4 & 67556 & 64275 & 3281 \\
5 & 960148 & 910047 & 50101 \\
6 & 13958756 & 13176603 & 782153 \\
7 & 205641268 & 193286799 & 12354469 \\
\end{tabular}
\end{center}
