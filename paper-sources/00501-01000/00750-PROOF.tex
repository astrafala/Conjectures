...
\title{Recovering the unwritten recurrences of the table OEIS A237557}
...
\begin{abstract}
OEIS A237557 is a two-dimensional table $T(n,k)$ whose empirical recurrences are, for several of
...
OEIS A237557 is ``T(n,k)=Number of (n+1)X(k+1) 0..2 arrays with the maximum minus the upper median of every 2X2 subblock differing from its horizontal and vertical neighbors by exactly one.''. It is read by antidiagonals and begins
\[
81, 312, 312, 1240, 1668, 1240, 4752, 8764,\ \dots
\]
The entry carries, among its empirical claims:
\begin{quote}\small
k=2: [order 14]
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 10:17:43, revision 6) these are still
...
count, a walk on $S=312$ vertices. Berlekamp--Massey on $2S=624$ exact terms
returns a minimal recurrence of order $14$ --- the order the entry states --- with
integer coefficients
\begin{center}\small\begin{tabular}{cccccccc}
$c_{1}$ & $0$ & $c_{5}$ & $382$ & $c_{9}$ & $-1004$ & $c_{13}$ & $792$ \\
$c_{2}$ & $0$ & $c_{6}$ & $716$ & $c_{10}$ & $-1124$ & $c_{14}$ & $-3360$ \\
$c_{3}$ & $26$ & $c_{7}$ & $1304$ & $c_{11}$ & $-466$ &  &  \\
$c_{4}$ & $473$ & $c_{8}$ & $-5953$ & $c_{12}$ & $9039$ &  &  \\
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237557.
