...
\title{The cross-base identity for OEIS A125363, proved}
...
\begin{abstract}
OEIS A125363 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125363 is ``Number of base 26 circular n-digit numbers with adjacent digits differing by 4 or less.''. It has offset $0$ and begins
\[
1, 26, 214, 1406, 10814, 84426, 675262, 5474306,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:27:34, revision 11)
...
the base is $26$ and the permitted difference is $d=4$, so the claim is that
\[
a_{26}(n)-a_{25}(n)\;=\;F_{4}(n)
\qquad\text{for every } n \text{ with } 4\lfloor n/2\rfloor+1\le26,
\]
...
at base $26$ reproduces all $19$ terms A125363 publishes, and at base $25$ all the
...
polynomial. In particular $a_{26}(n)-a_{25}(n)=F_{4}(n)$ for $1\le n\le13$, which
...
First, the model reproduces all $19$ terms A125363 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{4}(26,n)$ & $T_{4}(25,n)$ & $F_{4}(n)$ \\ \hline
1 & 26 & 25 & 1 \\
2 & 214 & 205 & 9 \\
3 & 1406 & 1345 & 61 \\
4 & 10814 & 10325 & 489 \\
5 & 84426 & 80475 & 3951 \\
6 & 675262 & 642601 & 32661 \\
7 & 5474306 & 5201179 & 273127 \\
8 & 44862014 & 42555989 & 2306025 \\
\end{tabular}
\end{center}
