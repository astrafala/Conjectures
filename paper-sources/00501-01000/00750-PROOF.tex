...
\title{The cross-base identity for OEIS A125418, proved}
...
\begin{abstract}
OEIS A125418 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125418 is ``Number of base 30 circular n-digit numbers with adjacent digits differing by 6 or less.''. It has offset $0$ and begins
\[
1, 30, 348, 3264, 35768, 398960, 4557138, 52777258,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:34:54, revision 12)
...
the base is $30$ and the permitted difference is $d=6$, so the claim is that
\[
a_{30}(n)-a_{29}(n)\;=\;F_{6}(n)
\qquad\text{for every } n \text{ with } 6\lfloor n/2\rfloor+1\le30,
\]
...
at base $30$ reproduces all $17$ terms A125418 publishes, and at base $29$ all the
...
polynomial. In particular $a_{30}(n)-a_{29}(n)=F_{6}(n)$ for $1\le n\le9$, which
...
First, the model reproduces all $17$ terms A125418 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{6}(30,n)$ & $T_{6}(29,n)$ & $F_{6}(n)$ \\ \hline
1 & 30 & 29 & 1 \\
2 & 348 & 335 & 13 \\
3 & 3264 & 3137 & 127 \\
4 & 35768 & 34299 & 1469 \\
5 & 398960 & 381809 & 17151 \\
6 & 4557138 & 4352375 & 204763 \\
7 & 52777258 & 50303933 & 2473325 \\
8 & 617855120 & 587692819 & 30162301 \\
\end{tabular}
\end{center}
