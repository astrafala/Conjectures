...
\title{The empirical recurrence for OEIS A281649, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A281649 imposes three things at once: a condition on each cell that reaches one row up and
...
OEIS A281649 is ``Number of nX3 0..2 arrays with no element equal to more than one of its horizontal, diagonal or antidiagonal neighbors, with the exception of exactly one element, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
1, 70, 985, 10572, 104815, 982206, 8921869, 79152992,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 26 2017 07:16:41, revision 5) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;14\,a(n-1) - 29\,a(n-2) - 192\,a(n-3) + 136\,a(n-4) + 1336\,a(n-5) + 1164\,a(n-6) - 2528\,a(n-7) - 6176\,a(n-8) - 5120\,a(n-9) - 1600\,a(n-10)
\end{equation}
for all $n>13$.
...
\[
3!\Bigl(a(n_0+j)-\sum_i c_i\,a(n_0+j-i)\Bigr)=\mathbf{v}^{\!\top}G^{\,j-10}w,
...
index corresponding to $n=13+1$ onwards, and the run continued until $S+1$ consecutive
zeros had been seen.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A281649.
