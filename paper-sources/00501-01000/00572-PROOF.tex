...
\begin{abstract}
OEIS A283358 carries an empirical recurrence of order $3$ contributed by Colin Barker. It is true, and it is
...
\begin{quote}
Conjectures from \_Colin Barker\_, Mar 07 2017: (Start) a(n) = 2*a(n-1) + a(n-2) - 2*a(n-3) for n>5.
\end{quote}
