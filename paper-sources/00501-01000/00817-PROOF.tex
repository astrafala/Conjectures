...
\title{The cross-base identity for OEIS A125444, proved}
...
\begin{abstract}
OEIS A125444 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125444 is ``Number of base 32 circular n-digit numbers with adjacent digits differing by 7 or less.''. It has offset $0$ and begins
\[
1, 32, 424, 4568, 57432, 735592, 9646648, 128268424,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:37:28, revision 12)
...
the base is $32$ and the permitted difference is $d=7$, so the claim is that
\[
a_{32}(n)-a_{31}(n)\;=\;F_{7}(n)
\qquad\text{for every } n \text{ with } 7\lfloor n/2\rfloor+1\le32,
\]
...
at base $32$ reproduces all $17$ terms A125444 publishes, and at base $31$ all the
...
polynomial. In particular $a_{32}(n)-a_{31}(n)=F_{7}(n)$ for $1\le n\le9$, which
...
First, the model reproduces all $17$ terms A125444 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{7}(32,n)$ & $T_{7}(31,n)$ & $F_{7}(n)$ \\ \hline
1 & 32 & 31 & 1 \\
2 & 424 & 409 & 15 \\
3 & 4568 & 4399 & 169 \\
4 & 57432 & 55177 & 2255 \\
5 & 735592 & 705211 & 30381 \\
6 & 9646648 & 9228145 & 418503 \\
7 & 128268424 & 122435659 & 5832765 \\
8 & 1723898392 & 1641825097 & 82073295 \\
\end{tabular}
\end{center}
