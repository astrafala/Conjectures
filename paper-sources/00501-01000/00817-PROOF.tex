...
\title{The cross-base identity for OEIS A125488, proved}
...
\begin{abstract}
OEIS A125488 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125488 is ``Number of base 31 circular n-digit numbers with adjacent digits differing by 9 or less.''. It has offset $0$ and begins
\[
1, 31, 499, 6691, 103999, 1650331, 26785795, 440527111,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:41:50, revision 12)
...
the base is $31$ and the permitted difference is $d=9$, so the claim is that
\[
a_{31}(n)-a_{30}(n)\;=\;F_{9}(n)
\qquad\text{for every } n \text{ with } 9\lfloor n/2\rfloor+1\le31,
\]
...
at base $31$ reproduces all $16$ terms A125488 publishes, and at base $30$ all the
...
polynomial. In particular $a_{31}(n)-a_{30}(n)=F_{9}(n)$ for $1\le n\le7$, which
...
First, the model reproduces all $16$ terms A125488 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{9}(31,n)$ & $T_{9}(30,n)$ & $F_{9}(n)$ \\ \hline
1 & 31 & 30 & 1 \\
2 & 499 & 480 & 19 \\
3 & 6691 & 6420 & 271 \\
4 & 103999 & 99420 & 4579 \\
5 & 1650331 & 1572180 & 78151 \\
6 & 26785795 & 25422222 & 1363573 \\
7 & 440527111 & 416454978 & 24072133 \\
\end{tabular}
\end{center}
