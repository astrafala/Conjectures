...
\title{The empirical recurrence for OEIS A290073, proved from an exact model}
...
\begin{abstract}
OEIS A290073 carries an empirical recurrence of order $3$ contributed by Colin Barker. It is true, and it is
...
OEIS A290073 is ``Decimal representation of the diagonal from the corner to the origin of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 641", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 2, 5, 12, 29, 60, 125, 252,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Jul 20 2017: (Start) a(n) = 2*a(n-1) + a(n-2) - 2*a(n-3) for n>4.
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 05 2025 15:22:40, revision 15)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A290073.
