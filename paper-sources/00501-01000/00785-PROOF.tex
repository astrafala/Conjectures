...
\title{The cross-base identity for OEIS A125404, proved}
...
\begin{abstract}
OEIS A125404 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125404 is ``Number of base 16 circular n-digit numbers with adjacent digits differing by 6 or less.''. It has offset $0$ and begins
\[
1, 16, 166, 1486, 15202, 158846, 1690522, 18157862,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:06:06, revision 14)
...
the base is $16$ and the permitted difference is $d=6$, so the claim is that
\[
a_{16}(n)-a_{15}(n)\;=\;F_{6}(n)
\qquad\text{for every } n \text{ with } 6\lfloor n/2\rfloor+1\le16,
\]
...
at base $16$ reproduces all $18$ terms A125404 publishes, and at base $15$ all the
...
polynomial. In particular $a_{16}(n)-a_{15}(n)=F_{6}(n)$ for $1\le n\le5$, which
...
First, the model reproduces all $18$ terms A125404 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{6}(16,n)$ & $T_{6}(15,n)$ & $F_{6}(n)$ \\ \hline
1 & 16 & 15 & 1 \\
2 & 166 & 153 & 13 \\
3 & 1486 & 1359 & 127 \\
4 & 15202 & 13733 & 1469 \\
5 & 158846 & 141695 & 17151 \\
\end{tabular}
\end{center}
