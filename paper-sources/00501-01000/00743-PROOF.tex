...
\title{The cross-base identity for OEIS A125411, proved}
...
\begin{abstract}
OEIS A125411 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125411 is ``Number of base 23 circular n-digit numbers with adjacent digits differing by 6 or less.''. It has offset $0$ and begins
\[
1, 23, 257, 2375, 25485, 278903, 3123797, 35463983,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:34:16, revision 12)
...
the base is $23$ and the permitted difference is $d=6$, so the claim is that
\[
a_{23}(n)-a_{22}(n)\;=\;F_{6}(n)
\qquad\text{for every } n \text{ with } 6\lfloor n/2\rfloor+1\le23,
\]
...
at base $23$ reproduces all $17$ terms A125411 publishes, and at base $22$ all the
...
polynomial. In particular $a_{23}(n)-a_{22}(n)=F_{6}(n)$ for $1\le n\le7$, which
...
First, the model reproduces all $17$ terms A125411 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{6}(23,n)$ & $T_{6}(22,n)$ & $F_{6}(n)$ \\ \hline
1 & 23 & 22 & 1 \\
2 & 257 & 244 & 13 \\
3 & 2375 & 2248 & 127 \\
4 & 25485 & 24016 & 1469 \\
5 & 278903 & 261752 & 17151 \\
6 & 3123797 & 2919034 & 204763 \\
7 & 35463983 & 32990658 & 2473325 \\
\end{tabular}
\end{center}
