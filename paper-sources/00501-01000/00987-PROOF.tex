...
\title{The cross-base identity for OEIS A126521, proved}
...
\begin{abstract}
OEIS A126521 carries an empirical identity, in two clauses, relating its counts to those of the
...
OEIS A126521 is ``Number of base 26 n-digit numbers with adjacent digits differing by four or less.''. It has offset $0$ and begins
\[
1, 26, 214, 1806, 15374, 131538, 1128990, 9710910,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:16:36, revision 11)
this is still recorded as empirical, and nothing on the entry records it as proved.

For this entry the base is $26$ and the permitted difference is $d=4$, so the first clause
claims $a_{26}(n)-a_{25}(n)=9^{\,n-1}$ whenever $4(n-1)+1\le26$, that is for
$1\le n\le7$, and the second claims $a_{26}(n)-a_{25}(n)=9^{\,n-1}-2$ at the single
$n$ with $4(n-1)=26$.
...
arithmetic, $L_{4}$ at base $26$ reproduces all $19$ terms A126521 publishes.
...
First, the model reproduces all $19$ terms A126521 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $L_{4}(26,n)$ & $L_{4}(25,n)$ & $9^{\,n-1}$ \\ \hline
1 & 26 & 25 & 1 \\
2 & 214 & 205 & 9 \\
3 & 1806 & 1725 & 81 \\
4 & 15374 & 14645 & 729 \\
5 & 131538 & 124977 & 6561 \\
6 & 1128990 & 1069941 & 59049 \\
7 & 9710910 & 9179469 & 531441 \\
\end{tabular}
\end{center}
