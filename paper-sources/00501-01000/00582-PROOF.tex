...
\begin{abstract}
OEIS A283352 carries an empirical recurrence of order $3$ contributed by Colin Barker. It is true, and it is
...
\begin{quote}
Conjectures from \_Colin Barker\_, Mar 06 2017: (Start) a(n) = 10*a(n-1) + a(n-2) - 10*a(n-3) for n>3.
\end{quote}
