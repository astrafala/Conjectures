...
\title{The empirical recurrence for OEIS A267777, proved from an exact model}
...
\begin{abstract}
OEIS A267777 carries an empirical recurrence of order $2$ contributed by Colin Barker. It is true, and it is
...
OEIS A267777 is ``Binary representation of the n-th iteration of the "Rule 209" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 1, 11001, 1111001, 111111001, 11111111001, 1111111111001, 111111111111001,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 20 2016 and Apr 20 2019: (Start) a(n) = 101*a(n-1)-100*a(n-2) for n>2.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 16 2025 08:33:29, revision 26)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267777.
