...
\title{A cross-alphabet identity for bounded-difference square arrays: OEIS A125541}
...
\begin{abstract}
OEIS A125541 carries an empirical identity relating its counts to those of the same problem over an
...
OEIS A125541 is ``Number of n X n arrays with entries in 1..9 in which adjacent entries differ by 6 or less (adjacent means in x or y directions).''. It has offset $0$ and begins
\[
1, 9, 4999, 183051647, 432993880473035, 66327998573151304476953, 657786158098403835519781868703261, 422337116619421509499034109697459735541947069,\ \dots
\]
...
most $d$. The entry is $T(9,6,n)$, and the conjecture is
\[
...
First, the count $T(9,6,n)$ was computed by an independent row-pair dynamic program and
reproduces the $4$ published terms of A125541 that the computation reaches,
...
\[
\begin{array}{rrrr}
n & T(9+1,6,n) & T(9,6,n) & F(n,6) \\ \hline
1 & 10 & 9 & 1 \\
2 & 6412 & 4999 & 1469 \\
\end{array}
\]
...
\url{https://oeis.org}, 2026. Sequence A125541: \url{https://oeis.org/A125541}.
\end{thebibliography}
