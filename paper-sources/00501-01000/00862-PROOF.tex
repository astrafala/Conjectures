...
\title{The cross-base identity for OEIS A125486, proved}
...
\begin{abstract}
OEIS A125486 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125486 is ``Number of base 29 circular n-digit numbers with adjacent digits differing by 9 or less.''. It has offset $0$ and begins
\[
1, 29, 461, 6149, 94841, 1494029, 24058649, 392382845,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:41:39, revision 12)
...
the base is $29$ and the permitted difference is $d=9$, so the claim is that
\[
a_{29}(n)-a_{28}(n)\;=\;F_{9}(n)
\qquad\text{for every } n \text{ with } 9\lfloor n/2\rfloor+1\le29,
\]
...
at base $29$ reproduces all $16$ terms A125486 publishes, and at base $28$ all the
...
polynomial. In particular $a_{29}(n)-a_{28}(n)=F_{9}(n)$ for $1\le n\le7$, which
...
First, the model reproduces all $16$ terms A125486 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{9}(29,n)$ & $T_{9}(28,n)$ & $F_{9}(n)$ \\ \hline
1 & 29 & 28 & 1 \\
2 & 461 & 442 & 19 \\
3 & 6149 & 5878 & 271 \\
4 & 94841 & 90262 & 4579 \\
5 & 1494029 & 1415878 & 78151 \\
6 & 24058649 & 22695076 & 1363573 \\
7 & 392382845 & 368310712 & 24072133 \\
\end{tabular}
\end{center}
