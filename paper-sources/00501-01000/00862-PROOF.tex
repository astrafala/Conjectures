...
\title{The cross-base identity for OEIS A126412, proved}
...
\begin{abstract}
OEIS A126412 carries an empirical identity, in two clauses, relating its counts to those of the
...
OEIS A126412 is ``Number of base 25 n-digit numbers with adjacent digits differing by two or less.''. It has offset $0$ and begins
\[
1, 25, 119, 575, 2793, 13611, 66473, 325149,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:12:09, revision 9)
this is still recorded as empirical, and nothing on the entry records it as proved.

For this entry the base is $25$ and the permitted difference is $d=2$, so the first clause
claims $a_{25}(n)-a_{24}(n)=5^{\,n-1}$ whenever $2(n-1)+1\le25$, that is for
$1\le n\le13$, and the second claims $a_{25}(n)-a_{24}(n)=5^{\,n-1}-2$ at the single
$n$ with $2(n-1)=25$.
...
arithmetic, $L_{2}$ at base $25$ reproduces all $21$ terms A126412 publishes.
...
First, the model reproduces all $21$ terms A126412 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $L_{2}(25,n)$ & $L_{2}(24,n)$ & $5^{\,n-1}$ \\ \hline
1 & 25 & 24 & 1 \\
2 & 119 & 114 & 5 \\
3 & 575 & 550 & 25 \\
4 & 2793 & 2668 & 125 \\
5 & 13611 & 12986 & 625 \\
6 & 66473 & 63348 & 3125 \\
7 & 325149 & 309524 & 15625 \\
8 & 1592355 & 1514230 & 78125 \\
\end{tabular}
\end{center}
