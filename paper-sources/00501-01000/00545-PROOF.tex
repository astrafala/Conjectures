...
\title{The empirical recurrence for OEIS A281655, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A281655 imposes three things at once: a condition on each cell that reaches one column up and
...
OEIS A281655 is ``Number of 3Xn 0..2 arrays with no element equal to more than one of its horizontal, diagonal or antidiagonal neighbors, with the exception of exactly one element, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
0, 46, 985, 7986, 67884, 519656, 3804074, 27188104,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 26 2017 07:22:40, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;12\,a(n-1) - 44\,a(n-2) + 106\,a(n-3) - 394\,a(n-4) + 558\,a(n-5) - 1815\,a(n-6) + 1258\,a(n-7) - 3975\,a(n-8) + 1226\,a(n-9) - 3167\,a(n-10) - 2598\,a(n-11) + 4765\,a(n-12) + 1286\,a(n-13) - 710\,a(n-14) + 3446\,a(n-15) + 4320\,a(n-16) - 2580\,a(n-17) - 2693\,a(n-18) + 836\,a(n-19) - 456\,a(n-20) - 1676\,a(n-21) - 92\,a(n-22) + 1000\,a(n-23) + 316\,a(n-24) - 160\,a(n-25) - 64\,a(n-26)
\end{equation}
for all $n>29$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A281655.
