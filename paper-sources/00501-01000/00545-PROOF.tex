...
\title{The empirical recurrence for OEIS A267705, proved from an exact model}
...
\begin{abstract}
OEIS A267705 carries an empirical recurrence of order $3$ contributed by Colin Barker. It is true, and it is
...
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 20 2016 and Apr 20 2019: (Start) a(n) = 111*a(n-1)-1110*a(n-2)+1000*a(n-3) for n>3.
\end{quote}
