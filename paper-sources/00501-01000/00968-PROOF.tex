...
\title{The cross-base identity for OEIS A126500, proved}
...
\begin{abstract}
OEIS A126500 carries an empirical identity, in two clauses, relating its counts to those of the
...
OEIS A126500 is ``Number of base 32 n-digit numbers with adjacent digits differing by three or less.''. It has offset $0$ and begins
\[
1, 32, 212, 1428, 9676, 65800, 448524, 3062596,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:50:15, revision 7)
this is still recorded as empirical, and nothing on the entry records it as proved.

For this entry the base is $32$ and the permitted difference is $d=3$, so the first clause
claims $a_{32}(n)-a_{31}(n)=7^{\,n-1}$ whenever $3(n-1)+1\le32$, that is for
$1\le n\le11$, and the second claims $a_{32}(n)-a_{31}(n)=7^{\,n-1}-2$ at the single
$n$ with $3(n-1)=32$.
...
arithmetic, $L_{3}$ at base $32$ reproduces all $20$ terms A126500 publishes.
...
First, the model reproduces all $20$ terms A126500 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $L_{3}(32,n)$ & $L_{3}(31,n)$ & $7^{\,n-1}$ \\ \hline
1 & 32 & 31 & 1 \\
2 & 212 & 205 & 7 \\
3 & 1428 & 1379 & 49 \\
4 & 9676 & 9333 & 343 \\
5 & 65800 & 63399 & 2401 \\
6 & 448524 & 431717 & 16807 \\
7 & 3062596 & 2944947 & 117649 \\
8 & 20939104 & 20115561 & 823543 \\
\end{tabular}
\end{center}
