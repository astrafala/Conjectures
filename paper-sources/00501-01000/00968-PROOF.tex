...
\title{The cross-base identity for OEIS A126516, proved}
...
\begin{abstract}
OEIS A126516 carries an empirical identity, in two clauses, relating its counts to those of the
...
OEIS A126516 is ``Number of base 21 n-digit numbers with adjacent digits differing by four or less.''. It has offset $0$ and begins
\[
1, 21, 169, 1401, 11729, 98733, 833745, 7053777,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:16:10, revision 11)
this is still recorded as empirical, and nothing on the entry records it as proved.

For this entry the base is $21$ and the permitted difference is $d=4$, so the first clause
claims $a_{21}(n)-a_{20}(n)=9^{\,n-1}$ whenever $4(n-1)+1\le21$, that is for
$1\le n\le6$, and the second claims $a_{21}(n)-a_{20}(n)=9^{\,n-1}-2$ at the single
$n$ with $4(n-1)=21$.
...
arithmetic, $L_{4}$ at base $21$ reproduces all $19$ terms A126516 publishes.
...
First, the model reproduces all $19$ terms A126516 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $L_{4}(21,n)$ & $L_{4}(20,n)$ & $9^{\,n-1}$ \\ \hline
1 & 21 & 20 & 1 \\
2 & 169 & 160 & 9 \\
3 & 1401 & 1320 & 81 \\
4 & 11729 & 11000 & 729 \\
5 & 98733 & 92172 & 6561 \\
6 & 833745 & 774696 & 59049 \\
\end{tabular}
\end{center}
