...
\title{The empirical recurrence for OEIS A218893, proved by transfer matrix}
...
\begin{abstract}
OEIS A218893 counts the distinct arrays obtained by applying a fixed local operation to every cell
...
OEIS A218893 is ``Number of n X 4 arrays of the minimum value of corresponding elements and their horizontal, diagonal or antidiagonal neighbors in a random 0..1 n X 4 array.''. It has offset $1$ and begins
\[
6, 34, 212, 1096, 6422, 35812, 202662, 1143320,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 29 2023 10:04:41, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) + 3\,a(n-2) - 25\,a(n-3) - 29\,a(n-4) + 53\,a(n-5) + 33\,a(n-6) + 12\,a(n-7) - 38\,a(n-8) - 18\,a(n-10) + 12\,a(n-11) - 15\,a(n-12) + 7\,a(n-13) + 4\,a(n-14)
\]
for every $n>14$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A218893.
