...
\title{The cross-base identity for OEIS A125435, proved}
...
\begin{abstract}
OEIS A125435 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125435 is ``Number of base 23 circular n-digit numbers with adjacent digits differing by 7 or less.''. It has offset $0$ and begins
\[
1, 23, 289, 3047, 37137, 462163, 5880121, 75773539,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:36:39, revision 12)
...
the base is $23$ and the permitted difference is $d=7$, so the claim is that
\[
a_{23}(n)-a_{22}(n)\;=\;F_{7}(n)
\qquad\text{for every } n \text{ with } 7\lfloor n/2\rfloor+1\le23,
\]
...
at base $23$ reproduces all $17$ terms A125435 publishes, and at base $22$ all the
...
polynomial. In particular $a_{23}(n)-a_{22}(n)=F_{7}(n)$ for $1\le n\le7$, which
...
First, the model reproduces all $17$ terms A125435 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{7}(23,n)$ & $T_{7}(22,n)$ & $F_{7}(n)$ \\ \hline
1 & 23 & 22 & 1 \\
2 & 289 & 274 & 15 \\
3 & 3047 & 2878 & 169 \\
4 & 37137 & 34882 & 2255 \\
5 & 462163 & 431782 & 30381 \\
6 & 5880121 & 5461618 & 418503 \\
7 & 75773539 & 69940774 & 5832765 \\
\end{tabular}
\end{center}
