...
\title{The cross-base identity for OEIS A125339, proved}
...
\begin{abstract}
OEIS A125339 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125339 is ``Number of base 29 circular n-digit numbers with adjacent digits differing by 3 or less.''. It has offset $0$ and begins
\[
1, 29, 191, 989, 6007, 36899, 232283, 1481187,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:24:26, revision 11)
...
the base is $29$ and the permitted difference is $d=3$, so the claim is that
\[
a_{29}(n)-a_{28}(n)\;=\;F_{3}(n)
\qquad\text{for every } n \text{ with } 3\lfloor n/2\rfloor+1\le29,
\]
...
at base $29$ reproduces all $20$ terms A125339 publishes, and at base $28$ all the
...
polynomial. In particular $a_{29}(n)-a_{28}(n)=F_{3}(n)$ for $1\le n\le19$, which
...
First, the model reproduces all $20$ terms A125339 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{3}(29,n)$ & $T_{3}(28,n)$ & $F_{3}(n)$ \\ \hline
1 & 29 & 28 & 1 \\
2 & 191 & 184 & 7 \\
3 & 989 & 952 & 37 \\
4 & 6007 & 5776 & 231 \\
5 & 36899 & 35448 & 1451 \\
6 & 232283 & 222952 & 9331 \\
7 & 1481187 & 1420496 & 60691 \\
8 & 9545655 & 9147088 & 398567 \\
\end{tabular}
\end{center}
