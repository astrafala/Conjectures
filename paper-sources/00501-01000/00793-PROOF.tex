...
\title{The cross-base identity for OEIS A125393, proved}
...
\begin{abstract}
OEIS A125393 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125393 is ``Number of base 30 circular n-digit numbers with adjacent digits differing by 5 or less.''. It has offset $0$ and begins
\[
1, 30, 300, 2400, 22480, 213980, 2086194, 20618474,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:32:22, revision 12)
...
the base is $30$ and the permitted difference is $d=5$, so the claim is that
\[
a_{30}(n)-a_{29}(n)\;=\;F_{5}(n)
\qquad\text{for every } n \text{ with } 5\lfloor n/2\rfloor+1\le30,
\]
...
at base $30$ reproduces all $18$ terms A125393 publishes, and at base $29$ all the
...
polynomial. In particular $a_{30}(n)-a_{29}(n)=F_{5}(n)$ for $1\le n\le11$, which
...
First, the model reproduces all $18$ terms A125393 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{5}(30,n)$ & $T_{5}(29,n)$ & $F_{5}(n)$ \\ \hline
1 & 30 & 29 & 1 \\
2 & 300 & 289 & 11 \\
3 & 2400 & 2309 & 91 \\
4 & 22480 & 21589 & 891 \\
5 & 213980 & 205179 & 8801 \\
6 & 2086194 & 1997281 & 88913 \\
7 & 20618474 & 19709719 & 908755 \\
8 & 205995176 & 196617709 & 9377467 \\
\end{tabular}
\end{center}
