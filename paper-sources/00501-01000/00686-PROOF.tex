...
\title{The cross-base identity for OEIS A124949, proved}
...
\begin{abstract}
OEIS A124949 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A124949 is ``Number of base 21 circular n-digit numbers with adjacent digits differing by 2 or less.''. It has offset $0$ and begins
\[
1, 21, 99, 369, 1607, 7051, 31743, 144683,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:17:06, revision 16)
...
the base is $21$ and the permitted difference is $d=2$, so the claim is that
\[
a_{21}(n)-a_{20}(n)\;=\;F_{2}(n)
\qquad\text{for every } n \text{ with } 2\lfloor n/2\rfloor+1\le21,
\]
...
at base $21$ reproduces all $22$ terms A124949 publishes, and at base $20$ all the
...
polynomial. In particular $a_{21}(n)-a_{20}(n)=F_{2}(n)$ for $1\le n\le21$, which
...
First, the model reproduces all $22$ terms A124949 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{2}(21,n)$ & $T_{2}(20,n)$ & $F_{2}(n)$ \\ \hline
1 & 21 & 20 & 1 \\
2 & 99 & 94 & 5 \\
3 & 369 & 350 & 19 \\
4 & 1607 & 1522 & 85 \\
5 & 7051 & 6670 & 381 \\
6 & 31743 & 29992 & 1751 \\
7 & 144683 & 136548 & 8135 \\
8 & 666527 & 628362 & 38165 \\
\end{tabular}
\end{center}
