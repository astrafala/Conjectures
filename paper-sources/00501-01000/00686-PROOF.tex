...
\title{The cross-base identity for OEIS A124958, proved}
...
\begin{abstract}
OEIS A124958 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A124958 is ``Number of base 30 circular n-digit numbers with adjacent digits differing by 2 or less.''. It has offset $0$ and begins
\[
1, 30, 144, 540, 2372, 10480, 47502, 217898,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:18:41, revision 16)
...
the base is $30$ and the permitted difference is $d=2$, so the claim is that
\[
a_{30}(n)-a_{29}(n)\;=\;F_{2}(n)
\qquad\text{for every } n \text{ with } 2\lfloor n/2\rfloor+1\le30,
\]
...
at base $30$ reproduces all $21$ terms A124958 publishes, and at base $29$ all the
...
polynomial. In particular $a_{30}(n)-a_{29}(n)=F_{2}(n)$ for $1\le n\le29$, which
...
First, the model reproduces all $21$ terms A124958 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{2}(30,n)$ & $T_{2}(29,n)$ & $F_{2}(n)$ \\ \hline
1 & 30 & 29 & 1 \\
2 & 144 & 139 & 5 \\
3 & 540 & 521 & 19 \\
4 & 2372 & 2287 & 85 \\
5 & 10480 & 10099 & 381 \\
6 & 47502 & 45751 & 1751 \\
7 & 217898 & 209763 & 8135 \\
8 & 1010012 & 971847 & 38165 \\
\end{tabular}
\end{center}
