...
\title{The cross-base identity for OEIS A126497, proved}
...
\begin{abstract}
OEIS A126497 carries an empirical identity, in two clauses, relating its counts to those of the
...
OEIS A126497 is ``Number of base 29 n-digit numbers with adjacent digits differing by three or less.''. It has offset $0$ and begins
\[
1, 29, 191, 1281, 8647, 58597, 398103, 2709649,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:14:42, revision 9)
this is still recorded as empirical, and nothing on the entry records it as proved.

For this entry the base is $29$ and the permitted difference is $d=3$, so the first clause
claims $a_{29}(n)-a_{28}(n)=7^{\,n-1}$ whenever $3(n-1)+1\le29$, that is for
$1\le n\le10$, and the second claims $a_{29}(n)-a_{28}(n)=7^{\,n-1}-2$ at the single
$n$ with $3(n-1)=29$.
...
arithmetic, $L_{3}$ at base $29$ reproduces all $20$ terms A126497 publishes.
...
First, the model reproduces all $20$ terms A126497 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $L_{3}(29,n)$ & $L_{3}(28,n)$ & $7^{\,n-1}$ \\ \hline
1 & 29 & 28 & 1 \\
2 & 191 & 184 & 7 \\
3 & 1281 & 1232 & 49 \\
4 & 8647 & 8304 & 343 \\
5 & 58597 & 56196 & 2401 \\
6 & 398103 & 381296 & 16807 \\
7 & 2709649 & 2592000 & 117649 \\
8 & 18468475 & 17644932 & 823543 \\
\end{tabular}
\end{center}
