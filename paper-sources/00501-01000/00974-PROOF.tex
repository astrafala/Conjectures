...
\title{The empirical recurrence for OEIS A221781, proved by transfer matrix}
...
\begin{abstract}
OEIS A221781 counts the distinct OCCUPANCY arrays obtained when every cell of an $n\times2$ grid
...
one, on $S=433$ states, after which the conjectured recurrence is settled by a finite exact
computation.
\end{abstract}
...
OEIS A221781 is ``Number of 2Xn arrays of occupancy after each element stays put or moves to some horizontal, diagonal or antidiagonal neighbor, without move-in move-out left turns.''. It has offset $1$ and begins
\[
1, 25, 258, 2631, 26861, 273816, 2792384, 28476902,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 19:58:15, revision 8) this is still
...
$S=433$ reachable sets. In particular $a$ is $C$-finite.
...
\begin{theorem}
\[
a(n)\;=\;19\,a(n-1) - 119\,a(n-2) + 340\,a(n-3) - 447\,a(n-4) + 231\,a(n-5) - 367\,a(n-6) + 1636\,a(n-7) - 2994\,a(n-8) + 3520\,a(n-9) - 4119\,a(n-10) + 2955\,a(n-11) + 294\,a(n-12) - 1044\,a(n-13) + 55\,a(n-14) + 59\,a(n-15) + 2\,a(n-16)
\]
for every $n>16$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221781.
