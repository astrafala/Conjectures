...
\title{The cross-base identity for OEIS A126522, proved}
...
\begin{abstract}
OEIS A126522 carries an empirical identity, in two clauses, relating its counts to those of the
...
OEIS A126522 is ``Number of base 27 n-digit numbers with adjacent digits differing by four or less.''. It has offset $0$ and begins
\[
1, 27, 223, 1887, 16103, 138099, 1188039, 10242351,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:16:43, revision 11)
this is still recorded as empirical, and nothing on the entry records it as proved.

For this entry the base is $27$ and the permitted difference is $d=4$, so the first clause
claims $a_{27}(n)-a_{26}(n)=9^{\,n-1}$ whenever $4(n-1)+1\le27$, that is for
$1\le n\le7$, and the second claims $a_{27}(n)-a_{26}(n)=9^{\,n-1}-2$ at the single
$n$ with $4(n-1)=27$.
...
arithmetic, $L_{4}$ at base $27$ reproduces all $19$ terms A126522 publishes.
...
First, the model reproduces all $19$ terms A126522 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $L_{4}(27,n)$ & $L_{4}(26,n)$ & $9^{\,n-1}$ \\ \hline
1 & 27 & 26 & 1 \\
2 & 223 & 214 & 9 \\
3 & 1887 & 1806 & 81 \\
4 & 16103 & 15374 & 729 \\
5 & 138099 & 131538 & 6561 \\
6 & 1188039 & 1128990 & 59049 \\
7 & 10242351 & 9710910 & 531441 \\
\end{tabular}
\end{center}
