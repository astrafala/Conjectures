...
\title{The empirical recurrence for OEIS A229632, proved by counting defective colourings}
...
\begin{abstract}
OEIS A229632 counts the colourings of an array with $K=3$ colours that are proper except at
...
OEIS A229632 is ``Number of defective 3-colorings of an nX3 0..2 array connected horizontally, diagonally and antidiagonally with exactly two mistakes, and colors introduced in row-major 0..2 order.''. It has offset $1$ and begins
\[
1, 40, 244, 1496, 8800, 50084, 277996, 1513104,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 15*a(n-1) -81*a(n-2) +185*a(n-3) -162*a(n-4) +60*a(n-5) -8*a(n-6) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 05:45:52, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A229632.
