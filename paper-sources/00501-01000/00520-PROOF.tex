...
\title{The empirical recurrence for OEIS A187852, proved from an exact model}
...
\begin{abstract}
OEIS A187852 carries an empirical recurrence of order $3$. It is true, and it is
...
OEIS A187852 is ``Number of 4-step king-knight's tours (piece capable of both kinds of moves) on an n X n board summed over all starting positions.''. It has offset $1$ and begins
\[
0, 24, 1400, 7620, 20952, 41652, 69456, 104268,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3504*n\^{}2 - 17748*n + 21996 for n>5. a(n) = 3*a(n-1) - 3*a(n-2) + a(n-3) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 26 2018 08:38:44, revision 10)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A187852.
