...
\title{The empirical recurrence for OEIS A267051, proved from an exact model}
...
\begin{abstract}
OEIS A267051 carries an empirical recurrence of order $3$ contributed by Colin Barker. It is true, and it is
...
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 10 2016 and Apr 17 2019: (Start) a(n) = 10*a(n-1)+a(n-2)-10*a(n-3) for n>3.
\end{quote}
