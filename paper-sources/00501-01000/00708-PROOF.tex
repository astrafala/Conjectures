...
\title{The cross-base identity for OEIS A125360, proved}
...
\begin{abstract}
OEIS A125360 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125360 is ``Number of base 23 circular n-digit numbers with adjacent digits differing by 4 or less.''. It has offset $0$ and begins
\[
1, 23, 187, 1223, 9347, 72573, 577279, 4654925,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:27:09, revision 11)
...
the base is $23$ and the permitted difference is $d=4$, so the claim is that
\[
a_{23}(n)-a_{22}(n)\;=\;F_{4}(n)
\qquad\text{for every } n \text{ with } 4\lfloor n/2\rfloor+1\le23,
\]
...
at base $23$ reproduces all $20$ terms A125360 publishes, and at base $22$ all the
...
polynomial. In particular $a_{23}(n)-a_{22}(n)=F_{4}(n)$ for $1\le n\le11$, which
...
First, the model reproduces all $20$ terms A125360 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{4}(23,n)$ & $T_{4}(22,n)$ & $F_{4}(n)$ \\ \hline
1 & 23 & 22 & 1 \\
2 & 187 & 178 & 9 \\
3 & 1223 & 1162 & 61 \\
4 & 9347 & 8858 & 489 \\
5 & 72573 & 68622 & 3951 \\
6 & 577279 & 544618 & 32661 \\
7 & 4654925 & 4381798 & 273127 \\
8 & 37943939 & 35637914 & 2306025 \\
\end{tabular}
\end{center}
