...
\title{Every term of OEIS A395833 after the second is divisible by $3$}
...
\begin{abstract}
OEIS A395833 is defined by the vanishing condition
...
OEIS A395833 is ``G.f. A(x) satisfies [x\^{}n] A( x/A(x)\^{}(2*n-1) ) = 0 for n > 1.''. It has offset $0$ and begins
\[
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 09 2026 00:29:02, revision 7) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A395833.
