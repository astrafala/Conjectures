...
\title{The cross-base identity for OEIS A125479, proved}
...
\begin{abstract}
OEIS A125479 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125479 is ``Number of base 22 circular n-digit numbers with adjacent digits differing by 9 or less.''. It has offset $0$ and begins
\[
1, 22, 328, 4252, 62788, 946972, 14517082, 224253702,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:41:01, revision 12)
...
the base is $22$ and the permitted difference is $d=9$, so the claim is that
\[
a_{22}(n)-a_{21}(n)\;=\;F_{9}(n)
\qquad\text{for every } n \text{ with } 9\lfloor n/2\rfloor+1\le22,
\]
...
at base $22$ reproduces all $17$ terms A125479 publishes, and at base $21$ all the
...
polynomial. In particular $a_{22}(n)-a_{21}(n)=F_{9}(n)$ for $1\le n\le5$, which
...
First, the model reproduces all $17$ terms A125479 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{9}(22,n)$ & $T_{9}(21,n)$ & $F_{9}(n)$ \\ \hline
1 & 22 & 21 & 1 \\
2 & 328 & 309 & 19 \\
3 & 4252 & 3981 & 271 \\
4 & 62788 & 58209 & 4579 \\
5 & 946972 & 868821 & 78151 \\
\end{tabular}
\end{center}
