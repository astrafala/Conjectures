...
\title{The cross-base identity for OEIS A126517, proved}
...
\begin{abstract}
OEIS A126517 carries an empirical identity, in two clauses, relating its counts to those of the
...
OEIS A126517 is ``Number of base 22 n-digit numbers with adjacent digits differing by four or less.''. It has offset $0$ and begins
\[
1, 22, 178, 1482, 12458, 105294, 892794, 7585162,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:16:15, revision 11)
this is still recorded as empirical, and nothing on the entry records it as proved.

For this entry the base is $22$ and the permitted difference is $d=4$, so the first clause
claims $a_{22}(n)-a_{21}(n)=9^{\,n-1}$ whenever $4(n-1)+1\le22$, that is for
$1\le n\le6$, and the second claims $a_{22}(n)-a_{21}(n)=9^{\,n-1}-2$ at the single
$n$ with $4(n-1)=22$.
...
arithmetic, $L_{4}$ at base $22$ reproduces all $19$ terms A126517 publishes.
...
First, the model reproduces all $19$ terms A126517 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $L_{4}(22,n)$ & $L_{4}(21,n)$ & $9^{\,n-1}$ \\ \hline
1 & 22 & 21 & 1 \\
2 & 178 & 169 & 9 \\
3 & 1482 & 1401 & 81 \\
4 & 12458 & 11729 & 729 \\
5 & 105294 & 98733 & 6561 \\
6 & 892794 & 833745 & 59049 \\
\end{tabular}
\end{center}
