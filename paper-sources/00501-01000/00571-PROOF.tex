...
\title{The empirical recurrence for OEIS A267847, proved from an exact model}
...
\begin{abstract}
OEIS A267847 carries an empirical recurrence of order $2$ contributed by Colin Barker. It is true, and it is
...
\[
1, 4, 26, 122, 506, 2042, 8186, 32762,\ \dots
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267847.
