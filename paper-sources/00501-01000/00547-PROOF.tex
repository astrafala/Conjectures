...
\title{The empirical recurrence for OEIS A267052, proved from an exact model}
...
\begin{abstract}
OEIS A267052 carries an empirical recurrence of order $3$ contributed by Colin Barker. It is true, and it is
...
OEIS A267052 is ``Decimal representation of the n-th iteration of the "Rule 92" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 3, 7, 11, 23, 43, 87, 171,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 10 2016 and Apr 17 2019: (Start) a(n) = 2*a(n-1)+a(n-2)-2*a(n-3) for n>3.
\end{quote}
...
For this entry the automaton is rule 92, the period is $p=2$ and the pre-period is $n_0=1$.
The certificate is
\begin{gather*}
r=0:\quad \texttt{00}^{\,j} \cdot \texttt{0} \cdot \texttt{10}^{\,j} \cdot \texttt{11} \\
r=1:\quad \texttt{00}^{\,j} \cdot \texttt{0} \cdot \texttt{01}^{\,j} \cdot \texttt{0111}
\end{gather*}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267052.
