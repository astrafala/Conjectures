...
\title{The cross-base identity for OEIS A126493, proved}
...
\begin{abstract}
OEIS A126493 carries an empirical identity, in two clauses, relating its counts to those of the
...
OEIS A126493 is ``Number of base 25 n-digit numbers with adjacent digits differing by three or less.''. It has offset $0$ and begins
\[
1, 25, 163, 1085, 7275, 48993, 330875, 2239053,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:14:20, revision 9)
this is still recorded as empirical, and nothing on the entry records it as proved.

For this entry the base is $25$ and the permitted difference is $d=3$, so the first clause
claims $a_{25}(n)-a_{24}(n)=7^{\,n-1}$ whenever $3(n-1)+1\le25$, that is for
$1\le n\le9$, and the second claims $a_{25}(n)-a_{24}(n)=7^{\,n-1}-2$ at the single
$n$ with $3(n-1)=25$.
...
arithmetic, $L_{3}$ at base $25$ reproduces all $20$ terms A126493 publishes.
...
First, the model reproduces all $20$ terms A126493 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $L_{3}(25,n)$ & $L_{3}(24,n)$ & $7^{\,n-1}$ \\ \hline
1 & 25 & 24 & 1 \\
2 & 163 & 156 & 7 \\
3 & 1085 & 1036 & 49 \\
4 & 7275 & 6932 & 343 \\
5 & 48993 & 46592 & 2401 \\
6 & 330875 & 314068 & 16807 \\
7 & 2239053 & 2121404 & 117649 \\
8 & 15174303 & 14350760 & 823543 \\
\end{tabular}
\end{center}
