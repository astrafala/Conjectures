...
\title{The empirical recurrence for OEIS A187511, proved from an exact model}
...
\begin{abstract}
OEIS A187511 carries an empirical recurrence of order $3$. It is true, and it is
...
OEIS A187511 is ``Number of 6-step S, E, and NW-moving king's tours on an n X n board summed over all starting positions.''. It has offset $1$ and begins
\[
0, 0, 36, 272, 772, 1525, 2524, 3769,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 123*n\^{}2 - 600*n + 697 for n>4. a(n) = 3*a(n-1) - 3*a(n-2) + a(n-3) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 24 2018 09:20:12, revision 11)
...
SHAPE when one is a translate of the other. There are exactly $123$ shapes: self-avoiding
...
Write $w^\ast$ for the largest bounding-box side over all $123$ shapes. Once $n\ge w^\ast$
...
First, the model reproduces all $37$ terms the entry publishes, exactly, in integer
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A187511.
