...
\begin{abstract}
OEIS A267873 carries an empirical recurrence of order $2$ contributed by Colin Barker. It is true, and it is
...
For this entry the automaton is rule 235, the period is $p=1$ and the pre-period is $n_0=3$.
The certificate is
\begin{gather*}
