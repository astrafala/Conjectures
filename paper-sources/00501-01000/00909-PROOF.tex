...
\title{The empirical recurrence for OEIS A208828, proved from an exact model}
...
\begin{abstract}
OEIS A208828 carries an empirical recurrence of order $10$. It is true, and it is
decidable rather than empirical. The entry's sequence is given exactly by a Burnside sum over the necklace group, from
which $a$ provably satisfies a MONIC linear recurrence of order $S=64$, derived below and not
...
OEIS A208828 is ``Number of 7-bead necklaces labeled with numbers -n..n allowing reversal, with sum zero.''. It has offset $1$ and begins
\[
32, 609, 4390, 19657, 65134, 177097, 417204, 883409,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) - 3*a(n-2) - 8*a(n-3) + 14*a(n-4) - 14*a(n-6) + 8*a(n-7) + 3*a(n-8) - 4*a(n-9) + a(n-10).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 07 2018 06:16:18, revision 13)
...
over the group's elements annihilates $a$: $S=64$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208828.
