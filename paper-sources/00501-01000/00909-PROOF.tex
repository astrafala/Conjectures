...
\title{The cross-base identity for OEIS A126499, proved}
...
\begin{abstract}
OEIS A126499 carries an empirical identity, in two clauses, relating its counts to those of the
...
OEIS A126499 is ``Number of base 31 n-digit numbers with adjacent digits differing by three or less.''. It has offset $0$ and begins
\[
1, 31, 205, 1379, 9333, 63399, 431717, 2944947,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:50:09, revision 7)
this is still recorded as empirical, and nothing on the entry records it as proved.

For this entry the base is $31$ and the permitted difference is $d=3$, so the first clause
claims $a_{31}(n)-a_{30}(n)=7^{\,n-1}$ whenever $3(n-1)+1\le31$, that is for
$1\le n\le11$, and the second claims $a_{31}(n)-a_{30}(n)=7^{\,n-1}-2$ at the single
$n$ with $3(n-1)=31$.
...
arithmetic, $L_{3}$ at base $31$ reproduces all $20$ terms A126499 publishes.
...
First, the model reproduces all $20$ terms A126499 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $L_{3}(31,n)$ & $L_{3}(30,n)$ & $7^{\,n-1}$ \\ \hline
1 & 31 & 30 & 1 \\
2 & 205 & 198 & 7 \\
3 & 1379 & 1330 & 49 \\
4 & 9333 & 8990 & 343 \\
5 & 63399 & 60998 & 2401 \\
6 & 431717 & 414910 & 16807 \\
7 & 2944947 & 2827298 & 117649 \\
8 & 20115561 & 19292018 & 823543 \\
\end{tabular}
\end{center}
