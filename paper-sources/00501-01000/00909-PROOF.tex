...
\title{The cross-base identity for OEIS A126510, proved}
...
\begin{abstract}
OEIS A126510 carries an empirical identity, in two clauses, relating its counts to those of the
...
OEIS A126510 is ``Number of base 15 n-digit numbers with adjacent digits differing by four or less.''. It has offset $0$ and begins
\[
1, 15, 115, 915, 7355, 59369, 479887, 3880945,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:15:36, revision 14)
this is still recorded as empirical, and nothing on the entry records it as proved.

For this entry the base is $15$ and the permitted difference is $d=4$, so the first clause
claims $a_{15}(n)-a_{14}(n)=9^{\,n-1}$ whenever $4(n-1)+1\le15$, that is for
$1\le n\le4$, and the second claims $a_{15}(n)-a_{14}(n)=9^{\,n-1}-2$ at the single
$n$ with $4(n-1)=15$.
...
arithmetic, $L_{4}$ at base $15$ reproduces all $20$ terms A126510 publishes.
...
First, the model reproduces all $20$ terms A126510 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $L_{4}(15,n)$ & $L_{4}(14,n)$ & $9^{\,n-1}$ \\ \hline
1 & 15 & 14 & 1 \\
2 & 115 & 106 & 9 \\
3 & 915 & 834 & 81 \\
4 & 7355 & 6626 & 729 \\
