...
\title{The cross-base identity for OEIS A124893, proved}
...
\begin{abstract}
OEIS A124893 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A124893 is ``Number of base 15 circular n-digit numbers with adjacent digits differing by 2 or less.''. It has offset $0$ and begins
\[
1, 15, 69, 255, 1097, 4765, 21237, 95873,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:16:15, revision 16)
...
the base is $15$ and the permitted difference is $d=2$, so the claim is that
\[
a_{15}(n)-a_{14}(n)\;=\;F_{2}(n)
\qquad\text{for every } n \text{ with } 2\lfloor n/2\rfloor+1\le15,
\]
...
at base $15$ reproduces all $22$ terms A124893 publishes, and at base $14$ all the
...
polynomial. In particular $a_{15}(n)-a_{14}(n)=F_{2}(n)$ for $1\le n\le15$, which
...
First, the model reproduces all $22$ terms A124893 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{2}(15,n)$ & $T_{2}(14,n)$ & $F_{2}(n)$ \\ \hline
1 & 15 & 14 & 1 \\
2 & 69 & 64 & 5 \\
3 & 255 & 236 & 19 \\
4 & 1097 & 1012 & 85 \\
