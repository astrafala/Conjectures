...
\title{The cross-base identity for OEIS A125366, proved}
...
\begin{abstract}
OEIS A125366 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125366 is ``Number of base 29 circular n-digit numbers with adjacent digits differing by 4 or less.''. It has offset $0$ and begins
\[
1, 29, 241, 1589, 12281, 96279, 773245, 6293687,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:28:04, revision 11)
...
the base is $29$ and the permitted difference is $d=4$, so the claim is that
\[
a_{29}(n)-a_{28}(n)\;=\;F_{4}(n)
\qquad\text{for every } n \text{ with } 4\lfloor n/2\rfloor+1\le29,
\]
...
at base $29$ reproduces all $19$ terms A125366 publishes, and at base $28$ all the
...
polynomial. In particular $a_{29}(n)-a_{28}(n)=F_{4}(n)$ for $1\le n\le15$, which
...
First, the model reproduces all $19$ terms A125366 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{4}(29,n)$ & $T_{4}(28,n)$ & $F_{4}(n)$ \\ \hline
1 & 29 & 28 & 1 \\
2 & 241 & 232 & 9 \\
3 & 1589 & 1528 & 61 \\
4 & 12281 & 11792 & 489 \\
5 & 96279 & 92328 & 3951 \\
6 & 773245 & 740584 & 32661 \\
7 & 6293687 & 6020560 & 273127 \\
8 & 51780089 & 49474064 & 2306025 \\
\end{tabular}
\end{center}
