...
\title{The cross-base identity for OEIS A125353, proved}
...
\begin{abstract}
OEIS A125353 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125353 is ``Number of base 16 circular n-digit numbers with adjacent digits differing by 4 or less.''. It has offset $0$ and begins
\[
1, 16, 124, 796, 5924, 44916, 348652, 2743036,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:04:04, revision 13)
...
the base is $16$ and the permitted difference is $d=4$, so the claim is that
\[
a_{16}(n)-a_{15}(n)\;=\;F_{4}(n)
\qquad\text{for every } n \text{ with } 4\lfloor n/2\rfloor+1\le16,
\]
...
at base $16$ reproduces all $20$ terms A125353 publishes, and at base $15$ all the
...
polynomial. In particular $a_{16}(n)-a_{15}(n)=F_{4}(n)$ for $1\le n\le7$, which
...
First, the model reproduces all $20$ terms A125353 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{4}(16,n)$ & $T_{4}(15,n)$ & $F_{4}(n)$ \\ \hline
1 & 16 & 15 & 1 \\
2 & 124 & 115 & 9 \\
3 & 796 & 735 & 61 \\
4 & 5924 & 5435 & 489 \\
5 & 44916 & 40965 & 3951 \\
6 & 348652 & 315991 & 32661 \\
7 & 2743036 & 2469909 & 273127 \\
\end{tabular}
\end{center}
