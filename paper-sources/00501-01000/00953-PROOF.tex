...
\title{The cross-base identity for OEIS A126508, proved}
...
\begin{abstract}
OEIS A126508 carries an empirical identity, in two clauses, relating its counts to those of the
...
OEIS A126508 is ``Number of base 13 n-digit numbers with adjacent digits differing by four or less.''. It has offset $0$ and begins
\[
1, 13, 97, 753, 5897, 46287, 363509, 2855151,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:15:26, revision 14)
this is still recorded as empirical, and nothing on the entry records it as proved.

For this entry the base is $13$ and the permitted difference is $d=4$, so the first clause
claims $a_{13}(n)-a_{12}(n)=9^{\,n-1}$ whenever $4(n-1)+1\le13$, that is for
$1\le n\le4$, and the second claims $a_{13}(n)-a_{12}(n)=9^{\,n-1}-2$ at the single
$n$ with $4(n-1)=13$.
...
arithmetic, $L_{4}$ at base $13$ reproduces all $20$ terms A126508 publishes.
...
First, the model reproduces all $20$ terms A126508 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $L_{4}(13,n)$ & $L_{4}(12,n)$ & $9^{\,n-1}$ \\ \hline
1 & 13 & 12 & 1 \\
2 & 97 & 88 & 9 \\
3 & 753 & 672 & 81 \\
4 & 5897 & 5168 & 729 \\
