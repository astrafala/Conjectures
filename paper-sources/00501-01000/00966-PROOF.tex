...
\title{The empirical recurrence for OEIS A280401, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A280401 imposes three things at once: a condition on each cell that reaches one column up and
...
numbers. The empirical recurrence of order $17$ contributed by R.~H.~Hardin then follows
...
OEIS A280401 is ``Number of 3Xn 0..2 arrays with no element unequal to a strict majority of its horizontal and antidiagonal neighbors, with the exception of exactly one element, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
0, 14, 66, 238, 769, 2432, 7440, 22494,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 02 2017 10:53:38, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;7\,a(n-1) - 13\,a(n-2) - 13\,a(n-3) + 69\,a(n-4) - 51\,a(n-5) - 79\,a(n-6) + 121\,a(n-7) + 8\,a(n-8) - 24\,a(n-9) - 80\,a(n-10) - 24\,a(n-11) + 176\,a(n-12) - 32\,a(n-13) - 80\,a(n-14) - 48\,a(n-15) + 64\,a(n-17)
\end{equation}
for all $n>19$.
...
$h_j=G^{j}N^{o}\mathbf{u}$, we have for $j\ge17$
\[
3!\Bigl(a(n_0+j)-\sum_i c_i\,a(n_0+j-i)\Bigr)=\mathbf{v}^{\!\top}G^{\,j-17}w,
\qquad w=h_{17}-\sum_i c_i h_{17-i} .
\]
...
$17$ applications of $G$ in exact integer arithmetic and $\mathbf{v}^{\!\top}G^{m}w$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A280401.
