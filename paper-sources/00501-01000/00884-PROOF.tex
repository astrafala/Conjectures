...
\title{The cross-base identity for OEIS A126488, proved}
...
\begin{abstract}
OEIS A126488 carries an empirical identity, in two clauses, relating its counts to those of the
...
OEIS A126488 is ``Number of base 20 n-digit numbers with adjacent digits differing by three or less.''. It has offset $0$ and begins
\[
1, 20, 128, 840, 5560, 36988, 246840, 1650808,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:13:53, revision 12)
this is still recorded as empirical, and nothing on the entry records it as proved.

For this entry the base is $20$ and the permitted difference is $d=3$, so the first clause
claims $a_{20}(n)-a_{19}(n)=7^{\,n-1}$ whenever $3(n-1)+1\le20$, that is for
$1\le n\le7$, and the second claims $a_{20}(n)-a_{19}(n)=7^{\,n-1}-2$ at the single
$n$ with $3(n-1)=20$.
...
arithmetic, $L_{3}$ at base $20$ reproduces all $20$ terms A126488 publishes.
...
First, the model reproduces all $20$ terms A126488 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $L_{3}(20,n)$ & $L_{3}(19,n)$ & $7^{\,n-1}$ \\ \hline
1 & 20 & 19 & 1 \\
2 & 128 & 121 & 7 \\
3 & 840 & 791 & 49 \\
4 & 5560 & 5217 & 343 \\
5 & 36988 & 34587 & 2401 \\
6 & 246840 & 230033 & 16807 \\
7 & 1650808 & 1533159 & 117649 \\
\end{tabular}
\end{center}
