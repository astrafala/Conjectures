...
\title{The empirical recurrence for OEIS A223201, proved by transfer matrix}
...
\begin{abstract}
OEIS A223201 counts the ways of writing the vertices of a fixed graph $G$ into an array of width
$7$ so that any two cells adjacent in one of the named directions carry vertices joined by an
edge of $G$; here $G$ is octahedron graph. The entry carries an empirical recurrence of order $13$
...
OEIS A223201 is ``Rolling cube footprints: number of nX7 0..5 arrays starting with 0 where 0..5 label faces of a cube and every array movement to a horizontal or vertical neighbor moves across a corresponding cube edge.''. It has offset $1$ and begins
\[
4096, 11943936, 37222350848, 118404195287040, 379529320596504576, 1220273386789986631680, 3928452022261522225954816, 12653687328474521535529353216,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 21:20:40, revision 8) this is still
...
$\widehat{M}^{j+13}-\sum_ic_i\widehat{M}^{j+13-i}$. For the bound,
...
\begin{theorem}
\[
a(n)\;=\;7040\,a(n-1) - 18169856\,a(n-2) + 23760732160\,a(n-3) - 18040473255936\,a(n-4) + 8500736711196672\,a(n-5) - 2561598209927413760\,a(n-6) + 496452053123372941312\,a(n-7) - 61015776557932010799104\,a(n-8) + 4604307320797904083353600\,a(n-9) - 203533995411681708710297600\,a(n-10) + 5009788596483023299982393344\,a(n-11) - 63134942003554394019855335424\,a(n-12) + 316912650057057350374175801344\,a(n-13)
\]
for every $n>13$.
\end{theorem}

\begin{proof}
The vector $w=q(\widehat{M})\mathbf{1}$ was formed by $13$ matrix--vector products in
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223201.
