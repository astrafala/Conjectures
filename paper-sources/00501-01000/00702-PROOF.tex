...
\title{The cross-base identity for OEIS A124894, proved}
...
\begin{abstract}
OEIS A124894 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A124894 is ``Number of base 16 circular n-digit numbers with adjacent digits differing by 2 or less.''. It has offset $0$ and begins
\[
1, 16, 74, 274, 1182, 5146, 22988, 104008,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:16:23, revision 16)
...
the base is $16$ and the permitted difference is $d=2$, so the claim is that
\[
a_{16}(n)-a_{15}(n)\;=\;F_{2}(n)
\qquad\text{for every } n \text{ with } 2\lfloor n/2\rfloor+1\le16,
\]
...
at base $16$ reproduces all $22$ terms A124894 publishes, and at base $15$ all the
...
polynomial. In particular $a_{16}(n)-a_{15}(n)=F_{2}(n)$ for $1\le n\le15$, which
...
First, the model reproduces all $22$ terms A124894 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{2}(16,n)$ & $T_{2}(15,n)$ & $F_{2}(n)$ \\ \hline
1 & 16 & 15 & 1 \\
2 & 74 & 69 & 5 \\
3 & 274 & 255 & 19 \\
4 & 1182 & 1097 & 85 \\
