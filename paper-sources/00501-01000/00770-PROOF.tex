...
\title{The cross-base identity for OEIS A125384, proved}
...
\begin{abstract}
OEIS A125384 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125384 is ``Number of base 21 circular n-digit numbers with adjacent digits differing by 5 or less.''. It has offset $0$ and begins
\[
1, 21, 201, 1581, 14461, 134771, 1285977, 12439679,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:31:20, revision 12)
...
the base is $21$ and the permitted difference is $d=5$, so the claim is that
\[
a_{21}(n)-a_{20}(n)\;=\;F_{5}(n)
\qquad\text{for every } n \text{ with } 5\lfloor n/2\rfloor+1\le21,
\]
...
at base $21$ reproduces all $18$ terms A125384 publishes, and at base $20$ all the
...
polynomial. In particular $a_{21}(n)-a_{20}(n)=F_{5}(n)$ for $1\le n\le9$, which
...
First, the model reproduces all $18$ terms A125384 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{5}(21,n)$ & $T_{5}(20,n)$ & $F_{5}(n)$ \\ \hline
1 & 21 & 20 & 1 \\
2 & 201 & 190 & 11 \\
3 & 1581 & 1490 & 91 \\
4 & 14461 & 13570 & 891 \\
5 & 134771 & 125970 & 8801 \\
6 & 1285977 & 1197064 & 88913 \\
7 & 12439679 & 11530924 & 908755 \\
8 & 121597973 & 112220506 & 9377467 \\
\end{tabular}
\end{center}
