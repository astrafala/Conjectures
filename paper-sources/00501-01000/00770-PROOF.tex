...
\title{The cross-base identity for OEIS A125439, proved}
...
\begin{abstract}
OEIS A125439 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125439 is ``Number of base 27 circular n-digit numbers with adjacent digits differing by 7 or less.''. It has offset $0$ and begins
\[
1, 27, 349, 3723, 46157, 583687, 7554133, 99104599,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:37:01, revision 12)
...
the base is $27$ and the permitted difference is $d=7$, so the claim is that
\[
a_{27}(n)-a_{26}(n)\;=\;F_{7}(n)
\qquad\text{for every } n \text{ with } 7\lfloor n/2\rfloor+1\le27,
\]
...
at base $27$ reproduces all $17$ terms A125439 publishes, and at base $26$ all the
...
polynomial. In particular $a_{27}(n)-a_{26}(n)=F_{7}(n)$ for $1\le n\le7$, which
...
First, the model reproduces all $17$ terms A125439 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{7}(27,n)$ & $T_{7}(26,n)$ & $F_{7}(n)$ \\ \hline
1 & 27 & 26 & 1 \\
2 & 349 & 334 & 15 \\
3 & 3723 & 3554 & 169 \\
4 & 46157 & 43902 & 2255 \\
5 & 583687 & 553306 & 30381 \\
6 & 7554133 & 7135630 & 418503 \\
7 & 99104599 & 93271834 & 5832765 \\
\end{tabular}
\end{center}
