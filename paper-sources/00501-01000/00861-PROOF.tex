...
\title{The cross-base identity for OEIS A125480, proved}
...
\begin{abstract}
OEIS A125480 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125480 is ``Number of base 23 circular n-digit numbers with adjacent digits differing by 9 or less.''. It has offset $0$ and begins
\[
1, 23, 347, 4523, 67367, 1025123, 15878429, 248116017,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:41:06, revision 12)
...
the base is $23$ and the permitted difference is $d=9$, so the claim is that
\[
a_{23}(n)-a_{22}(n)\;=\;F_{9}(n)
\qquad\text{for every } n \text{ with } 9\lfloor n/2\rfloor+1\le23,
\]
...
at base $23$ reproduces all $17$ terms A125480 publishes, and at base $22$ all the
...
polynomial. In particular $a_{23}(n)-a_{22}(n)=F_{9}(n)$ for $1\le n\le5$, which
...
First, the model reproduces all $17$ terms A125480 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{9}(23,n)$ & $T_{9}(22,n)$ & $F_{9}(n)$ \\ \hline
1 & 23 & 22 & 1 \\
2 & 347 & 328 & 19 \\
3 & 4523 & 4252 & 271 \\
4 & 67367 & 62788 & 4579 \\
5 & 1025123 & 946972 & 78151 \\
\end{tabular}
\end{center}
