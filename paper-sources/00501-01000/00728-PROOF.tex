...
\title{The cross-base identity for OEIS A125395, proved}
...
\begin{abstract}
OEIS A125395 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125395 is ``Number of base 32 circular n-digit numbers with adjacent digits differing by 5 or less.''. It has offset $0$ and begins
\[
1, 32, 322, 2582, 24262, 231582, 2264020, 22435984,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:32:41, revision 12)
...
the base is $32$ and the permitted difference is $d=5$, so the claim is that
\[
a_{32}(n)-a_{31}(n)\;=\;F_{5}(n)
\qquad\text{for every } n \text{ with } 5\lfloor n/2\rfloor+1\le32,
\]
...
at base $32$ reproduces all $18$ terms A125395 publishes, and at base $31$ all the
...
polynomial. In particular $a_{32}(n)-a_{31}(n)=F_{5}(n)$ for $1\le n\le13$, which
...
First, the model reproduces all $18$ terms A125395 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{5}(32,n)$ & $T_{5}(31,n)$ & $F_{5}(n)$ \\ \hline
1 & 32 & 31 & 1 \\
2 & 322 & 311 & 11 \\
3 & 2582 & 2491 & 91 \\
4 & 24262 & 23371 & 891 \\
5 & 231582 & 222781 & 8801 \\
6 & 2264020 & 2175107 & 88913 \\
7 & 22435984 & 21527229 & 908755 \\
8 & 224750110 & 215372643 & 9377467 \\
\end{tabular}
\end{center}
