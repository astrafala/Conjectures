...
\title{The empirical recurrence for OEIS A220762, proved by transfer matrix}
...
\begin{abstract}
OEIS A220762 counts the distinct arrays obtained by applying a fixed local operation to every cell
...
OEIS A220762 is ``Number of 2Xn arrays of the minimum value of corresponding elements and their horizontal, diagonal or antidiagonal neighbors in a random 0..3 2Xn array.''. It has offset $1$ and begins
\[
16, 28, 268, 708, 4766, 15724, 88434, 331024,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 19:03:02, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 13\,a(n-2) - 10\,a(n-3) + 12\,a(n-4) - 41\,a(n-5) + 6\,a(n-6) - 16\,a(n-7) - 40\,a(n-8) + 4\,a(n-9) + 64\,a(n-11) + 32\,a(n-12)
\]
for every $n>12$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A220762.
