...
\title{The cross-base identity for OEIS A125487, proved}
...
\begin{abstract}
OEIS A125487 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125487 is ``Number of base 30 circular n-digit numbers with adjacent digits differing by 9 or less.''. It has offset $0$ and begins
\[
1, 30, 480, 6420, 99420, 1572180, 25422222, 416454978,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:41:45, revision 12)
...
the base is $30$ and the permitted difference is $d=9$, so the claim is that
\[
a_{30}(n)-a_{29}(n)\;=\;F_{9}(n)
\qquad\text{for every } n \text{ with } 9\lfloor n/2\rfloor+1\le30,
\]
...
at base $30$ reproduces all $16$ terms A125487 publishes, and at base $29$ all the
...
polynomial. In particular $a_{30}(n)-a_{29}(n)=F_{9}(n)$ for $1\le n\le7$, which
...
First, the model reproduces all $16$ terms A125487 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{9}(30,n)$ & $T_{9}(29,n)$ & $F_{9}(n)$ \\ \hline
1 & 30 & 29 & 1 \\
2 & 480 & 461 & 19 \\
3 & 6420 & 6149 & 271 \\
4 & 99420 & 94841 & 4579 \\
5 & 1572180 & 1494029 & 78151 \\
6 & 25422222 & 24058649 & 1363573 \\
7 & 416454978 & 392382845 & 24072133 \\
\end{tabular}
\end{center}
