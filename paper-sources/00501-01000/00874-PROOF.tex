...
\title{The cross-base identity for OEIS A126410, proved}
...
\begin{abstract}
OEIS A126410 carries an empirical identity, in two clauses, relating its counts to those of the
...
OEIS A126410 is ``Number of base 23 n-digit numbers with adjacent digits differing by two or less.''. It has offset $0$ and begins
\[
1, 23, 109, 525, 2543, 12361, 60223, 293899,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:11:57, revision 9)
this is still recorded as empirical, and nothing on the entry records it as proved.

For this entry the base is $23$ and the permitted difference is $d=2$, so the first clause
claims $a_{23}(n)-a_{22}(n)=5^{\,n-1}$ whenever $2(n-1)+1\le23$, that is for
$1\le n\le12$, and the second claims $a_{23}(n)-a_{22}(n)=5^{\,n-1}-2$ at the single
$n$ with $2(n-1)=23$.
...
arithmetic, $L_{2}$ at base $23$ reproduces all $21$ terms A126410 publishes.
...
First, the model reproduces all $21$ terms A126410 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $L_{2}(23,n)$ & $L_{2}(22,n)$ & $5^{\,n-1}$ \\ \hline
1 & 23 & 22 & 1 \\
2 & 109 & 104 & 5 \\
3 & 525 & 500 & 25 \\
4 & 2543 & 2418 & 125 \\
5 & 12361 & 11736 & 625 \\
6 & 60223 & 57098 & 3125 \\
7 & 293899 & 278274 & 15625 \\
8 & 1436105 & 1357980 & 78125 \\
\end{tabular}
\end{center}
