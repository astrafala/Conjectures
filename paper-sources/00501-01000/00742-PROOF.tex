...
\title{The cross-base identity for OEIS A125410, proved}
...
\begin{abstract}
OEIS A125410 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125410 is ``Number of base 22 circular n-digit numbers with adjacent digits differing by 6 or less.''. It has offset $0$ and begins
\[
1, 22, 244, 2248, 24016, 261752, 2919034, 32990658,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:34:11, revision 12)
...
the base is $22$ and the permitted difference is $d=6$, so the claim is that
\[
a_{22}(n)-a_{21}(n)\;=\;F_{6}(n)
\qquad\text{for every } n \text{ with } 6\lfloor n/2\rfloor+1\le22,
\]
...
at base $22$ reproduces all $18$ terms A125410 publishes, and at base $21$ all the
...
polynomial. In particular $a_{22}(n)-a_{21}(n)=F_{6}(n)$ for $1\le n\le7$, which
...
First, the model reproduces all $18$ terms A125410 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{6}(22,n)$ & $T_{6}(21,n)$ & $F_{6}(n)$ \\ \hline
1 & 22 & 21 & 1 \\
2 & 244 & 231 & 13 \\
3 & 2248 & 2121 & 127 \\
4 & 24016 & 22547 & 1469 \\
5 & 261752 & 244601 & 17151 \\
6 & 2919034 & 2714271 & 204763 \\
7 & 32990658 & 30517333 & 2473325 \\
\end{tabular}
\end{center}
