...
\title{The cross-base identity for OEIS A125406, proved}
...
\begin{abstract}
OEIS A125406 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125406 is ``Number of base 18 circular n-digit numbers with adjacent digits differing by 6 or less.''. It has offset $0$ and begins
\[
1, 18, 192, 1740, 18140, 193148, 2099982, 23097358,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:06:17, revision 14)
...
the base is $18$ and the permitted difference is $d=6$, so the claim is that
\[
a_{18}(n)-a_{17}(n)\;=\;F_{6}(n)
\qquad\text{for every } n \text{ with } 6\lfloor n/2\rfloor+1\le18,
\]
...
at base $18$ reproduces all $18$ terms A125406 publishes, and at base $17$ all the
...
polynomial. In particular $a_{18}(n)-a_{17}(n)=F_{6}(n)$ for $1\le n\le5$, which
...
First, the model reproduces all $18$ terms A125406 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{6}(18,n)$ & $T_{6}(17,n)$ & $F_{6}(n)$ \\ \hline
1 & 18 & 17 & 1 \\
2 & 192 & 179 & 13 \\
3 & 1740 & 1613 & 127 \\
4 & 18140 & 16671 & 1469 \\
5 & 193148 & 175997 & 17151 \\
\end{tabular}
\end{center}
