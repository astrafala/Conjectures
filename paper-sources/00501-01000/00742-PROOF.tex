...
\title{The cross-base identity for OEIS A125361, proved}
...
\begin{abstract}
OEIS A125361 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125361 is ``Number of base 24 circular n-digit numbers with adjacent digits differing by 4 or less.''. It has offset $0$ and begins
\[
1, 24, 196, 1284, 9836, 76524, 609940, 4928052,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:27:16, revision 11)
...
the base is $24$ and the permitted difference is $d=4$, so the claim is that
\[
a_{24}(n)-a_{23}(n)\;=\;F_{4}(n)
\qquad\text{for every } n \text{ with } 4\lfloor n/2\rfloor+1\le24,
\]
that is, for $1\le n\le11$.
...
at base $24$ reproduces all $20$ terms A125361 publishes, and at base $23$ all the
...
polynomial. In particular $a_{24}(n)-a_{23}(n)=F_{4}(n)$ for $1\le n\le11$, which
...
First, the model reproduces all $20$ terms A125361 publishes, exactly, in integer
...
$1\le n\le11$, with both sides computed from the definition and not from the theorem:

\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{4}(24,n)$ & $T_{4}(23,n)$ & $F_{4}(n)$ \\ \hline
1 & 24 & 23 & 1 \\
2 & 196 & 187 & 9 \\
3 & 1284 & 1223 & 61 \\
4 & 9836 & 9347 & 489 \\
5 & 76524 & 72573 & 3951 \\
6 & 609940 & 577279 & 32661 \\
7 & 4928052 & 4654925 & 273127 \\
8 & 40249964 & 37943939 & 2306025 \\
\end{tabular}
\end{center}
