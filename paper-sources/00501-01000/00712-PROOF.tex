...
\title{The cross-base identity for OEIS A124998, proved}
...
\begin{abstract}
OEIS A124998 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A124998 is ``Number of base 32 circular n-digit numbers with adjacent digits differing by 2 or less.''. It has offset $0$ and begins
\[
1, 32, 154, 578, 2542, 11242, 51004, 234168,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:19:00, revision 16)
...
the base is $32$ and the permitted difference is $d=2$, so the claim is that
\[
a_{32}(n)-a_{31}(n)\;=\;F_{2}(n)
\qquad\text{for every } n \text{ with } 2\lfloor n/2\rfloor+1\le32,
\]
...
at base $32$ reproduces all $21$ terms A124998 publishes, and at base $31$ all the
...
polynomial. In particular $a_{32}(n)-a_{31}(n)=F_{2}(n)$ for $1\le n\le31$, which
...
First, the model reproduces all $21$ terms A124998 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{2}(32,n)$ & $T_{2}(31,n)$ & $F_{2}(n)$ \\ \hline
1 & 32 & 31 & 1 \\
2 & 154 & 149 & 5 \\
3 & 578 & 559 & 19 \\
4 & 2542 & 2457 & 85 \\
5 & 11242 & 10861 & 381 \\
6 & 51004 & 49253 & 1751 \\
7 & 234168 & 226033 & 8135 \\
8 & 1086342 & 1048177 & 38165 \\
\end{tabular}
\end{center}
