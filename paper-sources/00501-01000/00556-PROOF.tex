...
\title{The empirical recurrence for OEIS A187157, proved from an exact model}
...
\begin{abstract}
OEIS A187157 carries an empirical recurrence of order $3$. It is true, and it is
...
OEIS A187157 is ``Number of 4-step one space at a time bishop's tours on an n X n board summed over all starting positions.''. It has offset $1$ and begins
\[
0, 0, 8, 92, 248, 476, 776, 1148,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 36*n\^{}2 - 168*n + 188 for n>2. a(n) = 3*a(n-1) - 3*a(n-2) + a(n-3) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 20 2018 09:28:07, revision 10)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A187157.
