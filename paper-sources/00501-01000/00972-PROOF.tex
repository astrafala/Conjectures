...
\title{The empirical recurrence for OEIS A281694, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A281694 imposes three things at once: a condition on each cell that reaches one column up and
...
OEIS A281694 is ``Number of 2Xn 0..2 arrays with no element equal to more than one of its horizontal, diagonal or antidiagonal neighbors, with the exception of exactly two elements, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
0, 0, 6, 272, 2516, 19168, 120824, 692320,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 27 2017 12:40:01, revision 4) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A281694.
