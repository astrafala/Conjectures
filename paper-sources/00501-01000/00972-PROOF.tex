...
\title{The empirical recurrence for OEIS A281404, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A281404 imposes three things at once: a condition on each cell that reaches one column up and
...
OEIS A281404 is ``Number of 5 X n 0..1 arrays with no element equal to more than two of its horizontal, diagonal or antidiagonal neighbors, with the exception of exactly one element, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
0, 160, 1413, 2886, 5892, 10130, 16241, 25680,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 25 2022 09:08:05, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) - 6\,a(n-2) + 6\,a(n-3) - 7\,a(n-4) + 8\,a(n-5) - 9\,a(n-6) + 8\,a(n-7) - 5\,a(n-8) + 4\,a(n-9) - 3\,a(n-10) + 2\,a(n-11) - a(n-12)
\end{equation}
for all $n>19$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A281404.
