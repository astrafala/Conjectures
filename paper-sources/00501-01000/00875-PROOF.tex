...
\title{The cross-base identity for OEIS A126411, proved}
...
\begin{abstract}
OEIS A126411 carries an empirical identity, in two clauses, relating its counts to those of the
...
OEIS A126411 is ``Number of base 24 n-digit numbers with adjacent digits differing by two or less.''. It has offset $0$ and begins
\[
1, 24, 114, 550, 2668, 12986, 63348, 309524,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:12:03, revision 14)
this is still recorded as empirical, and nothing on the entry records it as proved.

For this entry the base is $24$ and the permitted difference is $d=2$, so the first clause
claims $a_{24}(n)-a_{23}(n)=5^{\,n-1}$ whenever $2(n-1)+1\le24$, that is for
$1\le n\le12$, and the second claims $a_{24}(n)-a_{23}(n)=5^{\,n-1}-2$ at the single
$n$ with $2(n-1)=24$.
...
arithmetic, $L_{2}$ at base $24$ reproduces all $21$ terms A126411 publishes.
...
First, the model reproduces all $21$ terms A126411 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $L_{2}(24,n)$ & $L_{2}(23,n)$ & $5^{\,n-1}$ \\ \hline
1 & 24 & 23 & 1 \\
2 & 114 & 109 & 5 \\
3 & 550 & 525 & 25 \\
4 & 2668 & 2543 & 125 \\
5 & 12986 & 12361 & 625 \\
6 & 63348 & 60223 & 3125 \\
7 & 309524 & 293899 & 15625 \\
8 & 1514230 & 1436105 & 78125 \\
\end{tabular}
\end{center}
...
Third, the second clause was evaluated at its own index. For this entry the second clause bites at $n=13$, where $b=24=2(n-1)$: there $L_{2}(24,13)-L_{2}(23,13)=244140623$ and $5^{12}-2=244140623$.

\section*{References}
\begin{enumerate}
\item The OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences},
\url{https://oeis.org/A126411}.
\end{enumerate}
