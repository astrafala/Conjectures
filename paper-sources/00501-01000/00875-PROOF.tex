...
\title{The empirical recurrence for OEIS A264286, proved by transfer matrix}
...
\begin{abstract}
OEIS A264286 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=3$ columns in which
...
OEIS A264286 is ``Number of (2+1) X (n+1) arrays of permutations of 0..n*3+2 with each element having directed index change 0,0 0,1 1,0 or -1,-2.''. It has offset $1$ and begins
\[
1, 10, 32, 102, 360, 1228, 4156, 14148,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) +4*a(n-2) +10*a(n-3) +12*a(n-4) +8*a(n-5) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 24 2026 10:44:12, revision 10) this is still
...
\[
(i-h_i,\,j-h_j)\;\in\;\{(-2,-1),\ (0,0),\ (0,1),\ (1,0)\},
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264286.
