...
\title{A cross-alphabet identity for bounded-difference square arrays: OEIS A125540}
...
\begin{abstract}
OEIS A125540 carries an empirical identity relating its counts to those of the same problem over an
...
OEIS A125540 is ``Number of n X n arrays with entries in 1..8 in which adjacent entries differ by 6 or less (adjacent means in x or y directions).''. It has offset $0$ and begins
\[
1, 8, 3650, 97167566, 149893105802018, 13409953777346510733710, 69569862634707662759990393452322, 20929881875746750076174309956907291103359630,\ \dots
\]
...
most $d$. The entry is $T(8,6,n)$, and the conjecture is
\[
...
First, the count $T(8,6,n)$ was computed by an independent row-pair dynamic program and
reproduces the $4$ published terms of A125540 that the computation reaches,
...
\[
\begin{array}{rrrr}
n & T(8+1,6,n) & T(8,6,n) & F(n,6) \\ \hline
1 & 9 & 8 & 1 \\
2 & 4999 & 3650 & 1469 \\
\end{array}
\]
...
\url{https://oeis.org}, 2026. Sequence A125540: \url{https://oeis.org/A125540}.
\end{thebibliography}
