...
\title{The cross-base identity for OEIS A125368, proved}
...
\begin{abstract}
OEIS A125368 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125368 is ``Number of base 31 circular n-digit numbers with adjacent digits differing by 4 or less.''. It has offset $0$ and begins
\[
1, 31, 259, 1711, 13259, 104181, 838567, 6839941,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:28:37, revision 11)
...
the base is $31$ and the permitted difference is $d=4$, so the claim is that
\[
a_{31}(n)-a_{30}(n)\;=\;F_{4}(n)
\qquad\text{for every } n \text{ with } 4\lfloor n/2\rfloor+1\le31,
\]
that is, for $1\le n\le15$.
...
at base $31$ reproduces all $19$ terms A125368 publishes, and at base $30$ all the
...
polynomial. In particular $a_{31}(n)-a_{30}(n)=F_{4}(n)$ for $1\le n\le15$, which
...
First, the model reproduces all $19$ terms A125368 publishes, exactly, in integer
...
$1\le n\le15$, with both sides computed from the definition and not from the theorem:

\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{4}(31,n)$ & $T_{4}(30,n)$ & $F_{4}(n)$ \\ \hline
1 & 31 & 30 & 1 \\
2 & 259 & 250 & 9 \\
3 & 1711 & 1650 & 61 \\
4 & 13259 & 12770 & 489 \\
5 & 104181 & 100230 & 3951 \\
6 & 838567 & 805906 & 32661 \\
7 & 6839941 & 6566814 & 273127 \\
8 & 56392139 & 54086114 & 2306025 \\
\end{tabular}
\end{center}
