...
\title{The cross-base identity for OEIS A125460, proved}
...
\begin{abstract}
OEIS A125460 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125460 is ``Number of base 25 circular n-digit numbers with adjacent digits differing by 8 or less.''. It has offset $0$ and begins
\[
1, 25, 353, 4201, 57713, 809845, 11612297, 168577861,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:39:08, revision 12)
...
the base is $25$ and the permitted difference is $d=8$, so the claim is that
\[
a_{25}(n)-a_{24}(n)\;=\;F_{8}(n)
\qquad\text{for every } n \text{ with } 8\lfloor n/2\rfloor+1\le25,
\]
...
at base $25$ reproduces all $17$ terms A125460 publishes, and at base $24$ all the
...
polynomial. In particular $a_{25}(n)-a_{24}(n)=F_{8}(n)$ for $1\le n\le7$, which
...
First, the model reproduces all $17$ terms A125460 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{8}(25,n)$ & $T_{8}(24,n)$ & $F_{8}(n)$ \\ \hline
1 & 25 & 24 & 1 \\
2 & 353 & 336 & 17 \\
3 & 4201 & 3984 & 217 \\
4 & 57713 & 54432 & 3281 \\
5 & 809845 & 759744 & 50101 \\
6 & 11612297 & 10830144 & 782153 \\
7 & 168577861 & 156223392 & 12354469 \\
\end{tabular}
\end{center}
