...
\title{The cross-base identity for OEIS A125482, proved}
...
\begin{abstract}
OEIS A125482 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125482 is ``Number of base 25 circular n-digit numbers with adjacent digits differing by 9 or less.''. It has offset $0$ and begins
\[
1, 25, 385, 5065, 76525, 1181425, 18604423, 296112247,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:41:18, revision 12)
...
the base is $25$ and the permitted difference is $d=9$, so the claim is that
\[
a_{25}(n)-a_{24}(n)\;=\;F_{9}(n)
\qquad\text{for every } n \text{ with } 9\lfloor n/2\rfloor+1\le25,
\]
...
at base $25$ reproduces all $17$ terms A125482 publishes, and at base $24$ all the
...
polynomial. In particular $a_{25}(n)-a_{24}(n)=F_{9}(n)$ for $1\le n\le5$, which
...
First, the model reproduces all $17$ terms A125482 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{9}(25,n)$ & $T_{9}(24,n)$ & $F_{9}(n)$ \\ \hline
1 & 25 & 24 & 1 \\
2 & 385 & 366 & 19 \\
3 & 5065 & 4794 & 271 \\
4 & 76525 & 71946 & 4579 \\
5 & 1181425 & 1103274 & 78151 \\
\end{tabular}
\end{center}
