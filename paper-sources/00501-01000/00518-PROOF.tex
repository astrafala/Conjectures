...
\title{The empirical recurrence for OEIS A230987, proved by transfer matrix}
...
\begin{abstract}
OEIS A230987 counts the white-square subarrays of arrays of width $7$ over $\{0,1\}$ in which
...
OEIS A230987 is ``Number of white square subarrays of (n+1)X(6+1) binary arrays with no element equal to a strict majority of its diagonal and antidiagonal neighbors, with upper left element zero.''. It has offset $1$ and begins
\[
8, 20, 139, 396, 2379, 7357, 43004, 135154,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 06:09:55, revision 6) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=265.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A230987.
