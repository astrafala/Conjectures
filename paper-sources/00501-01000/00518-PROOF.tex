...
\title{The empirical recurrence for OEIS A266592, proved from an exact model}
...
\begin{abstract}
OEIS A266592 carries an empirical recurrence of order $3$ contributed by Colin Barker. It is true, and it is
...
OEIS A266592 is ``Binary representation of the middle column of the "Rule 37" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 11, 111, 1110, 11101, 111010, 1110101, 11101010,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 02 2016 and Apr 18 2019: (Start) a(n) = 10*a(n-1)+a(n-2)-10*a(n-3) for n>3.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 16 2025 08:33:28, revision 19)
...
For this entry the column is periodic with period $q=2$ from $n=2$: the period above is a
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A266592.
