...
\title{The empirical recurrence for OEIS A267921, proved from an exact model}
...
\begin{abstract}
OEIS A267921 carries an empirical recurrence of order $2$ contributed by Colin Barker. It is true, and it is
...
OEIS A267921 is ``Decimal representation of the n-th iteration of the "Rule 243" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 5, 29, 125, 509, 2045, 8189, 32765,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 22 2016 and Apr 16 2019: (Start) a(n) = 5*a(n-1)-4*a(n-2) for n>2.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 16 2025 08:33:30, revision 18)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267921.
