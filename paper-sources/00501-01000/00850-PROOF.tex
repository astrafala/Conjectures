...
\title{The empirical recurrence for OEIS A249851, proved from an exact model}
...
\begin{abstract}
OEIS A249851 carries an empirical recurrence of order $12$. It is true, and it is
...
OEIS A249851 is ``Number of length 7+4 0..n arrays with no five consecutive terms having the maximum of any two terms equal to the minimum of the remaining three terms.''. It has offset $1$ and begins
\[
10, 3966, 223505, 4527441, 49270055, 354521087, 1901506446, 8194431990,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 18 2017 18:11:20, revision 8)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A249851.
