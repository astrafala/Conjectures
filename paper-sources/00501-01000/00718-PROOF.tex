...
\title{The empirical recurrence for OEIS A221726, proved by transfer matrix}
...
\begin{abstract}
OEIS A221726 counts the distinct OCCUPANCY arrays obtained when every cell of an $n\times3$ grid
...
determinising the machine that emits the occupancy row by row turns it into one, on $S=235$
...
OEIS A221726 is ``Number of nX3 arrays of occupancy after each element stays put or moves to some horizontal, diagonal or antidiagonal neighbor, with every occupancy equal to zero or two.''. It has offset $1$ and begins
\[
0, 16, 0, 464, 0, 13948, 0, 420736,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 44*a(n-2) -462*a(n-4) +1400*a(n-6) -1417*a(n-8) -448*a(n-10) -280*a(n-12) +100*a(n-14)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 19:53:41, revision 11) this is still
...
\]
There are $S=235$ reachable sets. In particular $a$ is $C$-finite.
...
\begin{theorem}
\[
a(n)\;=\;44\,a(n-2) - 462\,a(n-4) + 1400\,a(n-6) - 1417\,a(n-8) - 448\,a(n-10) - 280\,a(n-12) + 100\,a(n-14)
\]
for every $n>14$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221726.
