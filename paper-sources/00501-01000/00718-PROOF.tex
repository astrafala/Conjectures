...
\title{The cross-base identity for OEIS A125325, proved}
...
\begin{abstract}
OEIS A125325 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125325 is ``Number of base 15 circular n-digit numbers with adjacent digits differing by 3 or less.''. It has offset $0$ and begins
\[
1, 15, 93, 471, 2773, 16585, 101649, 631513,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:02:37, revision 13)
...
the base is $15$ and the permitted difference is $d=3$, so the claim is that
\[
a_{15}(n)-a_{14}(n)\;=\;F_{3}(n)
\qquad\text{for every } n \text{ with } 3\lfloor n/2\rfloor+1\le15,
\]
...
at base $15$ reproduces all $20$ terms A125325 publishes, and at base $14$ all the
...
polynomial. In particular $a_{15}(n)-a_{14}(n)=F_{3}(n)$ for $1\le n\le9$, which
...
First, the model reproduces all $20$ terms A125325 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{3}(15,n)$ & $T_{3}(14,n)$ & $F_{3}(n)$ \\ \hline
1 & 15 & 14 & 1 \\
2 & 93 & 86 & 7 \\
3 & 471 & 434 & 37 \\
4 & 2773 & 2542 & 231 \\
5 & 16585 & 15134 & 1451 \\
6 & 101649 & 92318 & 9331 \\
7 & 631513 & 570822 & 60691 \\
8 & 3965717 & 3567150 & 398567 \\
\end{tabular}
\end{center}
