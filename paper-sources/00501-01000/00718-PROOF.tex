...
\title{The cross-base identity for OEIS A125330, proved}
...
\begin{abstract}
OEIS A125330 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125330 is ``Number of base 20 circular n-digit numbers with adjacent digits differing by 3 or less.''. It has offset $0$ and begins
\[
1, 20, 128, 656, 3928, 23840, 148304, 934968,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:02:59, revision 13)
...
the base is $20$ and the permitted difference is $d=3$, so the claim is that
\[
a_{20}(n)-a_{19}(n)\;=\;F_{3}(n)
\qquad\text{for every } n \text{ with } 3\lfloor n/2\rfloor+1\le20,
\]
...
at base $20$ reproduces all $20$ terms A125330 publishes, and at base $19$ all the
...
polynomial. In particular $a_{20}(n)-a_{19}(n)=F_{3}(n)$ for $1\le n\le13$, which
...
First, the model reproduces all $20$ terms A125330 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{3}(20,n)$ & $T_{3}(19,n)$ & $F_{3}(n)$ \\ \hline
1 & 20 & 19 & 1 \\
2 & 128 & 121 & 7 \\
3 & 656 & 619 & 37 \\
4 & 3928 & 3697 & 231 \\
5 & 23840 & 22389 & 1451 \\
6 & 148304 & 138973 & 9331 \\
7 & 934968 & 874277 & 60691 \\
8 & 5958552 & 5559985 & 398567 \\
\end{tabular}
\end{center}
