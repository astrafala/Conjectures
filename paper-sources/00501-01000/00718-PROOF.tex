...
\title{The cross-base identity for OEIS A125385, proved}
...
\begin{abstract}
OEIS A125385 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125385 is ``Number of base 22 circular n-digit numbers with adjacent digits differing by 5 or less.''. It has offset $0$ and begins
\[
1, 22, 212, 1672, 15352, 143572, 1374890, 13348434,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:31:25, revision 12)
...
the base is $22$ and the permitted difference is $d=5$, so the claim is that
\[
a_{22}(n)-a_{21}(n)\;=\;F_{5}(n)
\qquad\text{for every } n \text{ with } 5\lfloor n/2\rfloor+1\le22,
\]
...
at base $22$ reproduces all $18$ terms A125385 publishes, and at base $21$ all the
...
polynomial. In particular $a_{22}(n)-a_{21}(n)=F_{5}(n)$ for $1\le n\le9$, which
...
First, the model reproduces all $18$ terms A125385 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{5}(22,n)$ & $T_{5}(21,n)$ & $F_{5}(n)$ \\ \hline
1 & 22 & 21 & 1 \\
2 & 212 & 201 & 11 \\
3 & 1672 & 1581 & 91 \\
4 & 15352 & 14461 & 891 \\
5 & 143572 & 134771 & 8801 \\
6 & 1374890 & 1285977 & 88913 \\
7 & 13348434 & 12439679 & 908755 \\
8 & 130975440 & 121597973 & 9377467 \\
\end{tabular}
\end{center}
