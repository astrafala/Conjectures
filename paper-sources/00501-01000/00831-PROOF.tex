...
\title{The empirical recurrence for OEIS A221870, proved by transfer matrix}
...
\begin{abstract}
OEIS A221870 counts the distinct OCCUPANCY arrays obtained when every cell of an $n\times2$ grid
...
one, on $S=255$ states, after which the conjectured recurrence is settled by a finite exact
computation.
\end{abstract}
...
OEIS A221870 is ``Number of nX2 arrays of occupancy after each element moves to some horizontal, vertical or antidiagonal neighbor, without consecutive moves in the same direction.''. It has offset $1$ and begins
\[
1, 20, 162, 1442, 12688, 110720, 970828, 8489090,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 20:03:04, revision 9) this is still
...
$S=255$ reachable sets. In particular $a$ is $C$-finite.
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-1) + 27\,a(n-2) - 77\,a(n-3) - 247\,a(n-4) + 195\,a(n-5) + 277\,a(n-6) - 51\,a(n-7) - 32\,a(n-8) + 103\,a(n-9) - 78\,a(n-10) + 25\,a(n-11) - 4\,a(n-12)
\]
for every $n>12$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221870.
