...
\title{The empirical recurrence for OEIS A219004, proved by transfer matrix}
...
\begin{abstract}
OEIS A219004 counts the distinct indicator arrays obtained from the $n\times3$ arrays over
...
indicator row by row turns it into one, on $S=121$ states, after which the conjectured
...
OEIS A219004 is ``Unmatched value maps: number of 3 X n binary arrays indicating the locations of corresponding elements not equal to any horizontal, diagonal or antidiagonal neighbor in a random 0..2 3 X n array.''. It has offset $1$ and begins
\[
1, 36, 328, 2265, 16648, 127401, 966981, 7298225,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 7*a(n-1) - 3*a(n-2) + 49*a(n-3) + 45*a(n-4) - 17*a(n-5) - 15*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 25 2018 05:20:30, revision 8) this is still
...
\]
There are $S=121$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite. Note
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A219004.
