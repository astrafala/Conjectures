...
\title{The cross-base identity for OEIS A124864, proved}
...
\begin{abstract}
OEIS A124864 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A124864 is ``Number of base 13 circular n-digit numbers with adjacent digits differing by 2 or less.''. It has offset $0$ and begins
\[
1, 13, 59, 217, 927, 4003, 17735, 79603,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:15:57, revision 16)
...
the base is $13$ and the permitted difference is $d=2$, so the claim is that
\[
a_{13}(n)-a_{12}(n)\;=\;F_{2}(n)
\qquad\text{for every } n \text{ with } 2\lfloor n/2\rfloor+1\le13,
\]
...
at base $13$ reproduces all $22$ terms A124864 publishes, and at base $12$ all the
...
polynomial. In particular $a_{13}(n)-a_{12}(n)=F_{2}(n)$ for $1\le n\le13$, which
...
First, the model reproduces all $22$ terms A124864 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{2}(13,n)$ & $T_{2}(12,n)$ & $F_{2}(n)$ \\ \hline
1 & 13 & 12 & 1 \\
2 & 59 & 54 & 5 \\
3 & 217 & 198 & 19 \\
4 & 927 & 842 & 85 \\
