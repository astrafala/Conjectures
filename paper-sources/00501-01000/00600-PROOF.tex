...
\title{The empirical recurrence for OEIS A267599, proved from an exact model}
...
\begin{abstract}
OEIS A267599 carries an empirical recurrence of order $2$ contributed by Colin Barker. It is true, and it is
...
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 18 2016 and Apr 20 2019: (Start) a(n) = 101*a(n-1)-100*a(n-2) for n>2.
\end{quote}
