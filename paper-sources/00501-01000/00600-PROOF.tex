...
\title{The empirical recurrence for OEIS A267812, proved from an exact model}
...
\begin{abstract}
OEIS A267812 carries an empirical recurrence of order $3$ contributed by Colin Barker. It is true, and it is
...
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 22 2016: (Start) a(n) = 7*a(n-1)-14*a(n-2)+8*a(n-3) for n>4.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 16 2025 08:33:29, revision 20)
