...
\title{The cross-base identity for OEIS A125331, proved}
...
\begin{abstract}
OEIS A125331 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125331 is ``Number of base 21 circular n-digit numbers with adjacent digits differing by 3 or less.''. It has offset $0$ and begins
\[
1, 21, 135, 693, 4159, 25291, 157635, 995659,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:03:04, revision 13)
...
the base is $21$ and the permitted difference is $d=3$, so the claim is that
\[
a_{21}(n)-a_{20}(n)\;=\;F_{3}(n)
\qquad\text{for every } n \text{ with } 3\lfloor n/2\rfloor+1\le21,
\]
...
at base $21$ reproduces all $20$ terms A125331 publishes, and at base $20$ all the
...
polynomial. In particular $a_{21}(n)-a_{20}(n)=F_{3}(n)$ for $1\le n\le13$, which
...
First, the model reproduces all $20$ terms A125331 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{3}(21,n)$ & $T_{3}(20,n)$ & $F_{3}(n)$ \\ \hline
1 & 21 & 20 & 1 \\
2 & 135 & 128 & 7 \\
3 & 693 & 656 & 37 \\
4 & 4159 & 3928 & 231 \\
5 & 25291 & 23840 & 1451 \\
6 & 157635 & 148304 & 9331 \\
7 & 995659 & 934968 & 60691 \\
8 & 6357119 & 5958552 & 398567 \\
\end{tabular}
\end{center}
