...
\title{Recovering the unwritten recurrences of the table OEIS A237182}
...
\begin{abstract}
OEIS A237182 is a two-dimensional table $T(n,k)$ whose empirical recurrences are, for several of
...
OEIS A237182 is ``T(n,k)=Number of (n+1)X(k+1) 0..2 arrays colored with the maximum plus the minimum minus the lower median of every 2X2 subblock.''. It is read by antidiagonals and begins
\[
81, 402, 402, 2061, 2700, 2061, 10488, 18062,\ \dots
\]
The entry carries, among its empirical claims:
\begin{quote}\small
k=2: [order 40]
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 09:57:02, revision 6) these are still
...
count, a walk on $S=402$ vertices. Berlekamp--Massey on $2S=804$ exact terms
returns a minimal recurrence of order $40$ --- the order the entry states --- with
integer coefficients
\[
(c_1,\dots,c_{40})=(0,\ 0,\ 92,\ 882,\ 2709,\ 9218,\ 14959,\ -31445,\ -146986,\ -482868,\ -943838,\ 336994,\ 3543506,\ 7186094,\ 9446548,\ -6491849,\ -31924590,\ -28642956,\ -15283695,\ 28491559,\ 84665284,\ 23411816,\ -43724842,\ -23336351,\ -1820626,\ 19596591,\ -12757942,\ -45558441,\ -16827881,\ 14050962,\ 8840398,\ -8247379,\ -1547726,\ 2428485,\ -15020,\ 347656,\ 182740,\ -117680,\ -21136,\ -2176).
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237182.
