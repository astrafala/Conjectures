...
\title{The empirical recurrence for OEIS A187592, proved from an exact model}
...
\begin{abstract}
OEIS A187592 carries an empirical recurrence of order $3$. It is true, and it is
...
\begin{quote}
Empirical: a(n) = 30966*n\^{}2 - 251630*n + 489234 for n>7. a(n) = 3*a(n-1) - 3*a(n-2) + a(n-3) for n>10.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 24 2018 14:31:07, revision 10)
...
SHAPE when one is a translate of the other. There are exactly $30966$ shapes: self-avoiding
...
Write $w^\ast$ for the largest bounding-box side over all $30966$ shapes. Once $n\ge w^\ast$
