...
\title{The empirical recurrence for OEIS A270512, proved by an exact quasi-polynomial}
...
\begin{abstract}
OEIS A270512 counts triangular arrays of a FIXED shape over the alphabet $0..n$, and carries an
...
OEIS A270512 is ``Number of 4X4X4 triangular 0..n arrays with some element plus some adjacent element totalling n+1 exactly once.''. It has offset $1$ and begins
\[
126, 5406, 132474, 1522068, 12034134, 65046258,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 18 2016 08:08:08, revision 4) this is still
...
Write $E$ for the set of adjacent pairs, $t=n+1$ for the target, and for $S\subseteq E$ let
...
A(n)=18n^{9} - 162n^{8} + \tfrac{1917}{2}n^{7} - 3615n^{6} + 9846n^{5} - 18969n^{4} + 25683n^{3} - 22851n^{2} + 11829n - \tfrac{5181}{2},
\]
\[
C(n)=- \tfrac{27}{2}n^{7} + 153n^{6} - 870n^{5} + 2985n^{4} - 6672n^{3} + 9372n^{2} - 7524n + \tfrac{5181}{2}.
\]
\end{theorem}
...
\[
a(n)=\begin{cases}
18n^{9} - 162n^{8} + 945n^{7} - 3462n^{6} + 8976n^{5} - 15984n^{4} + 19011n^{3} - 13479n^{2} + 4305n, & n\ \text{even},\\[2pt]
18n^{9} - 162n^{8} + 972n^{7} - 3768n^{6} + 10716n^{5} - 21954n^{4} + 32355n^{3} - 32223n^{2} + 19353n - 5181, & n\ \text{odd},
\end{cases}
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A270512.
