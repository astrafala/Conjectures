...
\title{The cross-base identity for OEIS A125390, proved}
...
\begin{abstract}
OEIS A125390 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125390 is ``Number of base 27 circular n-digit numbers with adjacent digits differing by 5 or less.''. It has offset $0$ and begins
\[
1, 27, 267, 2127, 19807, 187577, 1819455, 17892209,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:31:59, revision 14)
...
the base is $27$ and the permitted difference is $d=5$, so the claim is that
\[
a_{27}(n)-a_{26}(n)\;=\;F_{5}(n)
\qquad\text{for every } n \text{ with } 5\lfloor n/2\rfloor+1\le27,
\]
...
at base $27$ reproduces all $18$ terms A125390 publishes, and at base $26$ all the
...
polynomial. In particular $a_{27}(n)-a_{26}(n)=F_{5}(n)$ for $1\le n\le11$, which
...
First, the model reproduces all $18$ terms A125390 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{5}(27,n)$ & $T_{5}(26,n)$ & $F_{5}(n)$ \\ \hline
1 & 27 & 26 & 1 \\
2 & 267 & 256 & 11 \\
3 & 2127 & 2036 & 91 \\
4 & 19807 & 18916 & 891 \\
5 & 187577 & 178776 & 8801 \\
6 & 1819455 & 1730542 & 88913 \\
7 & 17892209 & 16983454 & 908755 \\
8 & 177862775 & 168485308 & 9377467 \\
\end{tabular}
\end{center}
