...
\title{The empirical recurrence for OEIS A267889, proved from an exact model}
...
\begin{abstract}
OEIS A267889 carries an empirical recurrence of order $2$ contributed by Colin Barker. It is true, and it is
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 24 2025 12:53:49, revision 18)
