...
\title{The cross-base identity for OEIS A125425, proved}
...
\begin{abstract}
OEIS A125425 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125425 is ``Number of base 13 circular n-digit numbers with adjacent digits differing by 7 or less.''. It has offset $0$ and begins
\[
1, 13, 139, 1357, 14591, 158703, 1735537, 19008065,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:07:00, revision 14)
...
the base is $13$ and the permitted difference is $d=7$, so the claim is that
\[
a_{13}(n)-a_{12}(n)\;=\;F_{7}(n)
\qquad\text{for every } n \text{ with } 7\lfloor n/2\rfloor+1\le13,
\]
...
at base $13$ reproduces all $18$ terms A125425 publishes, and at base $12$ all the
...
polynomial. In particular $a_{13}(n)-a_{12}(n)=F_{7}(n)$ for $1\le n\le3$, which
...
First, the model reproduces all $18$ terms A125425 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{7}(13,n)$ & $T_{7}(12,n)$ & $F_{7}(n)$ \\ \hline
1 & 13 & 12 & 1 \\
2 & 139 & 124 & 15 \\
3 & 1357 & 1188 & 169 \\
\end{tabular}
