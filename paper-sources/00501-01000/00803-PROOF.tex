...
\title{The cross-base identity for OEIS A125419, proved}
...
\begin{abstract}
OEIS A125419 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125419 is ``Number of base 31 circular n-digit numbers with adjacent digits differing by 6 or less.''. It has offset $0$ and begins
\[
1, 31, 361, 3391, 37237, 416111, 4761901, 55250583,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:34:59, revision 12)
...
the base is $31$ and the permitted difference is $d=6$, so the claim is that
\[
a_{31}(n)-a_{30}(n)\;=\;F_{6}(n)
\qquad\text{for every } n \text{ with } 6\lfloor n/2\rfloor+1\le31,
\]
...
at base $31$ reproduces all $17$ terms A125419 publishes, and at base $30$ all the
...
polynomial. In particular $a_{31}(n)-a_{30}(n)=F_{6}(n)$ for $1\le n\le11$, which
...
First, the model reproduces all $17$ terms A125419 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{6}(31,n)$ & $T_{6}(30,n)$ & $F_{6}(n)$ \\ \hline
1 & 31 & 30 & 1 \\
2 & 361 & 348 & 13 \\
3 & 3391 & 3264 & 127 \\
4 & 37237 & 35768 & 1469 \\
5 & 416111 & 398960 & 17151 \\
6 & 4761901 & 4557138 & 204763 \\
7 & 55250583 & 52777258 & 2473325 \\
8 & 648017421 & 617855120 & 30162301 \\
\end{tabular}
\end{center}
