...
\title{The cross-base identity for OEIS A125437, proved}
...
\begin{abstract}
OEIS A125437 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125437 is ``Number of base 25 circular n-digit numbers with adjacent digits differing by 7 or less.''. It has offset $0$ and begins
\[
1, 25, 319, 3385, 41647, 522925, 6717127, 87439069,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:36:50, revision 12)
...
the base is $25$ and the permitted difference is $d=7$, so the claim is that
\[
a_{25}(n)-a_{24}(n)\;=\;F_{7}(n)
\qquad\text{for every } n \text{ with } 7\lfloor n/2\rfloor+1\le25,
\]
...
at base $25$ reproduces all $17$ terms A125437 publishes, and at base $24$ all the
...
polynomial. In particular $a_{25}(n)-a_{24}(n)=F_{7}(n)$ for $1\le n\le7$, which
...
First, the model reproduces all $17$ terms A125437 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{7}(25,n)$ & $T_{7}(24,n)$ & $F_{7}(n)$ \\ \hline
1 & 25 & 24 & 1 \\
2 & 319 & 304 & 15 \\
3 & 3385 & 3216 & 169 \\
4 & 41647 & 39392 & 2255 \\
5 & 522925 & 492544 & 30381 \\
6 & 6717127 & 6298624 & 418503 \\
7 & 87439069 & 81606304 & 5832765 \\
\end{tabular}
\end{center}
