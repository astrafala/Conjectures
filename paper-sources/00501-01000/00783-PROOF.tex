...
\title{The cross-base identity for OEIS A125453, proved}
...
\begin{abstract}
OEIS A125453 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125453 is ``Number of base 18 circular n-digit numbers with adjacent digits differing by 8 or less.''. It has offset $0$ and begins
\[
1, 18, 234, 2682, 34746, 459138, 6145542, 82693062,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:38:25, revision 12)
...
the base is $18$ and the permitted difference is $d=8$, so the claim is that
\[
a_{18}(n)-a_{17}(n)\;=\;F_{8}(n)
\qquad\text{for every } n \text{ with } 8\lfloor n/2\rfloor+1\le18,
\]
...
at base $18$ reproduces all $17$ terms A125453 publishes, and at base $17$ all the
...
polynomial. In particular $a_{18}(n)-a_{17}(n)=F_{8}(n)$ for $1\le n\le5$, which
...
First, the model reproduces all $17$ terms A125453 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{8}(18,n)$ & $T_{8}(17,n)$ & $F_{8}(n)$ \\ \hline
1 & 18 & 17 & 1 \\
2 & 234 & 217 & 17 \\
3 & 2682 & 2465 & 217 \\
4 & 34746 & 31465 & 3281 \\
5 & 459138 & 409037 & 50101 \\
\end{tabular}
\end{center}
