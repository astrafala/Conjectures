...
\title{The empirical recurrence for OEIS A187380, proved from an exact model}
...
\begin{abstract}
OEIS A187380 carries an empirical recurrence of order $3$. It is true, and it is
...
OEIS A187380 is ``Number of 6-step S, NW and NE-moving king's tours on an n X n board summed over all starting positions.''. It has offset $1$ and begins
\[
0, 0, 24, 264, 832, 1810, 3154, 4864,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 183*n\^{}2 - 1035*n + 1432 for n>4. a(n) = 3*a(n-1) - 3*a(n-2) + a(n-3) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 24 2018 06:43:40, revision 12)
...
that grows. So the walks themselves do not depend on $n$ at all. Let $M$ be the $3$
vectors the piece may move by, read from the entry's own words, and call two walks the same
SHAPE when one is a translate of the other. There are exactly $183$ shapes: self-avoiding
...
Write $w^\ast$ for the largest bounding-box side over all $183$ shapes. Once $n\ge w^\ast$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A187380.
