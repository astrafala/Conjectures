...
\title{The empirical recurrence for OEIS A264485, proved by transfer matrix}
...
\begin{abstract}
OEIS A264485 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=3$ rows in which
...
OEIS A264485 is ``Number of (n+1)X(2+1) arrays of permutations of 0..n*3+2 with each element having directed index change 2,-1 1,0 2,1 0,-1 -2,-2 or -1,0.''. It has offset $1$ and begins
\[
1, 1, 12, 16, 214, 324, 2960, 6442,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 14 2015 16:53:23, revision 6) this is still
...
\[
(i-h_i,\,j-h_j)\;\in\;\{(-2,-2),\ (-1,0),\ (0,-1),\ (1,0),\ (2,-1),\ (2,1)\},
\]
...
\begin{theorem}
\[
a(n)\;=\;20\,a(n-2) + 8\,a(n-3) - 102\,a(n-4) - 38\,a(n-5) + 337\,a(n-6) + 39\,a(n-7) - 2538\,a(n-8) - 1048\,a(n-9) + 9220\,a(n-10) + 3898\,a(n-11) - 10078\,a(n-12) + 719\,a(n-13) + 55039\,a(n-14) + 28538\,a(n-15) - 139480\,a(n-16) - 52428\,a(n-17) - 19106\,a(n-18) - 17134\,a(n-19) - 99749\,a(n-20) - 71330\,a(n-21) + 298006\,a(n-22) + 77280\,a(n-23) + 114868\,a(n-24) + 14464\,a(n-25) + 78816\,a(n-26) + 80368\,a(n-27) - 280704\,a(n-28) - 11136\,a(n-29) - 107712\,a(n-30) - 5568\,a(n-31) - 33408\,a(n-32) - 31104\,a(n-33) + 93312\,a(n-34) - 13824\,a(n-35) + 41472\,a(n-36)
\]
for every $n>35$.
\end{theorem}
...
Second, the transfer model reproduces all $24$ terms this entry publishes, exactly, in
integer arithmetic.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264485.
