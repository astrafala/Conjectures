...
\title{The cross-base identity for OEIS A125461, proved}
...
\begin{abstract}
OEIS A125461 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125461 is ``Number of base 26 circular n-digit numbers with adjacent digits differing by 8 or less.''. It has offset $0$ and begins
\[
1, 26, 370, 4418, 60994, 859946, 12394450, 180932330,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:39:16, revision 12)
...
the base is $26$ and the permitted difference is $d=8$, so the claim is that
\[
a_{26}(n)-a_{25}(n)\;=\;F_{8}(n)
\qquad\text{for every } n \text{ with } 8\lfloor n/2\rfloor+1\le26,
\]
...
at base $26$ reproduces all $17$ terms A125461 publishes, and at base $25$ all the
...
polynomial. In particular $a_{26}(n)-a_{25}(n)=F_{8}(n)$ for $1\le n\le7$, which
...
First, the model reproduces all $17$ terms A125461 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{8}(26,n)$ & $T_{8}(25,n)$ & $F_{8}(n)$ \\ \hline
1 & 26 & 25 & 1 \\
2 & 370 & 353 & 17 \\
3 & 4418 & 4201 & 217 \\
4 & 60994 & 57713 & 3281 \\
5 & 859946 & 809845 & 50101 \\
6 & 12394450 & 11612297 & 782153 \\
7 & 180932330 & 168577861 & 12354469 \\
\end{tabular}
\end{center}
