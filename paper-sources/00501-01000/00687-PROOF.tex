...
\title{The cross-base identity for OEIS A124950, proved}
...
\begin{abstract}
OEIS A124950 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A124950 is ``Number of base 22 circular n-digit numbers with adjacent digits differing by 2 or less.''. It has offset $0$ and begins
\[
1, 22, 104, 388, 1692, 7432, 33494, 152818,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:17:16, revision 16)
...
the base is $22$ and the permitted difference is $d=2$, so the claim is that
\[
a_{22}(n)-a_{21}(n)\;=\;F_{2}(n)
\qquad\text{for every } n \text{ with } 2\lfloor n/2\rfloor+1\le22,
\]
...
at base $22$ reproduces all $22$ terms A124950 publishes, and at base $21$ all the
...
polynomial. In particular $a_{22}(n)-a_{21}(n)=F_{2}(n)$ for $1\le n\le21$, which
...
First, the model reproduces all $22$ terms A124950 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{2}(22,n)$ & $T_{2}(21,n)$ & $F_{2}(n)$ \\ \hline
1 & 22 & 21 & 1 \\
2 & 104 & 99 & 5 \\
3 & 388 & 369 & 19 \\
4 & 1692 & 1607 & 85 \\
5 & 7432 & 7051 & 381 \\
6 & 33494 & 31743 & 1751 \\
7 & 152818 & 144683 & 8135 \\
8 & 704692 & 666527 & 38165 \\
\end{tabular}
\end{center}
