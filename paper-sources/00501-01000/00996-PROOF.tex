...
\title{The empirical closed form for OEIS A219367, proved}
...
\begin{abstract}
OEIS A219367 states an explicit closed form for $a(n)$ and records it as empirical. It is true, and
...
OEIS A219367 is ``Number of n X 2 arrays of the minimum value of corresponding elements and their horizontal or vertical neighbors in a random, but sorted with lexicographically nondecreasing rows and columns, 0..3 n X 2 array.''. It has offset $1$ and begins
\[
4, 13, 60, 193, 514, 1231, 2748, 5802,\ \dots
\]
and states:
\begin{quote}
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 11 2018 11:22:07, revision 8)
...
\begin{theorem}
The closed form OEIS A219367 records is correct for all $n>1$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A219367.
