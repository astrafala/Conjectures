...
\title{The empirical recurrence for OEIS A264280, proved by transfer matrix}
...
\begin{abstract}
OEIS A264280 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=4$ rows in which
...
OEIS A264280 is ``Number of (n+1) X (3+1) arrays of permutations of 0..n*4+3 with each element having directed index change 0,0 0,1 1,0 or -1,-2.''. It has offset $1$ and begins
\[
8, 32, 132, 556, 2324, 9724, 40692, 170268,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) +4*a(n-2) +4*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 07 2019 06:24:07, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264280.
