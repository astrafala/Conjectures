...
\title{The cross-base identity for OEIS A125467, proved}
...
\begin{abstract}
OEIS A125467 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125467 is ``Number of base 32 circular n-digit numbers with adjacent digits differing by 8 or less.''. It has offset $0$ and begins
\[
1, 32, 472, 5720, 80680, 1160552, 17087368, 255059144,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:39:53, revision 12)
...
the base is $32$ and the permitted difference is $d=8$, so the claim is that
\[
a_{32}(n)-a_{31}(n)\;=\;F_{8}(n)
\qquad\text{for every } n \text{ with } 8\lfloor n/2\rfloor+1\le32,
\]
...
at base $32$ reproduces all $17$ terms A125467 publishes, and at base $31$ all the
...
polynomial. In particular $a_{32}(n)-a_{31}(n)=F_{8}(n)$ for $1\le n\le7$, which
...
First, the model reproduces all $17$ terms A125467 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{8}(32,n)$ & $T_{8}(31,n)$ & $F_{8}(n)$ \\ \hline
1 & 32 & 31 & 1 \\
2 & 472 & 455 & 17 \\
3 & 5720 & 5503 & 217 \\
4 & 80680 & 77399 & 3281 \\
5 & 1160552 & 1110451 & 50101 \\
6 & 17087368 & 16305215 & 782153 \\
7 & 255059144 & 242704675 & 12354469 \\
\end{tabular}
\end{center}
