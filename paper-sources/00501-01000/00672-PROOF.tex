...
\title{The cross-base identity for OEIS A125333, proved}
...
\begin{abstract}
OEIS A125333 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125333 is ``Number of base 23 circular n-digit numbers with adjacent digits differing by 3 or less.''. It has offset $0$ and begins
\[
1, 23, 149, 767, 4621, 28193, 176297, 1117041,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:23:47, revision 11)
...
the base is $23$ and the permitted difference is $d=3$, so the claim is that
\[
a_{23}(n)-a_{22}(n)\;=\;F_{3}(n)
\qquad\text{for every } n \text{ with } 3\lfloor n/2\rfloor+1\le23,
\]
...
at base $23$ reproduces all $20$ terms A125333 publishes, and at base $22$ all the
...
polynomial. In particular $a_{23}(n)-a_{22}(n)=F_{3}(n)$ for $1\le n\le15$, which
...
First, the model reproduces all $20$ terms A125333 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{3}(23,n)$ & $T_{3}(22,n)$ & $F_{3}(n)$ \\ \hline
1 & 23 & 22 & 1 \\
2 & 149 & 142 & 7 \\
3 & 767 & 730 & 37 \\
4 & 4621 & 4390 & 231 \\
5 & 28193 & 26742 & 1451 \\
6 & 176297 & 166966 & 9331 \\
7 & 1117041 & 1056350 & 60691 \\
8 & 7154253 & 6755686 & 398567 \\
\end{tabular}
\end{center}
