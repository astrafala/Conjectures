...
\title{The cross-base identity for OEIS A124892, proved}
...
\begin{abstract}
OEIS A124892 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A124892 is ``Number of base 14 circular n-digit numbers with adjacent digits differing by 2 or less.''. It has offset $0$ and begins
\[
1, 14, 64, 236, 1012, 4384, 19486, 87738,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:16:08, revision 16)
...
the base is $14$ and the permitted difference is $d=2$, so the claim is that
\[
a_{14}(n)-a_{13}(n)\;=\;F_{2}(n)
\qquad\text{for every } n \text{ with } 2\lfloor n/2\rfloor+1\le14,
\]
...
at base $14$ reproduces all $22$ terms A124892 publishes, and at base $13$ all the
...
polynomial. In particular $a_{14}(n)-a_{13}(n)=F_{2}(n)$ for $1\le n\le13$, which
...
First, the model reproduces all $22$ terms A124892 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{2}(14,n)$ & $T_{2}(13,n)$ & $F_{2}(n)$ \\ \hline
1 & 14 & 13 & 1 \\
2 & 64 & 59 & 5 \\
3 & 236 & 217 & 19 \\
4 & 1012 & 927 & 85 \\
