...
\title{The cross-base identity for OEIS A125323, proved}
...
\begin{abstract}
OEIS A125323 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125323 is ``Number of base 13 circular n-digit numbers with adjacent digits differing by 3 or less.''. It has offset $0$ and begins
\[
1, 13, 79, 397, 2311, 13683, 82987, 510131,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:02:26, revision 13)
...
the base is $13$ and the permitted difference is $d=3$, so the claim is that
\[
a_{13}(n)-a_{12}(n)\;=\;F_{3}(n)
\qquad\text{for every } n \text{ with } 3\lfloor n/2\rfloor+1\le13,
\]
...
at base $13$ reproduces all $20$ terms A125323 publishes, and at base $12$ all the
...
polynomial. In particular $a_{13}(n)-a_{12}(n)=F_{3}(n)$ for $1\le n\le9$, which
...
First, the model reproduces all $20$ terms A125323 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{3}(13,n)$ & $T_{3}(12,n)$ & $F_{3}(n)$ \\ \hline
1 & 13 & 12 & 1 \\
2 & 79 & 72 & 7 \\
3 & 397 & 360 & 37 \\
4 & 2311 & 2080 & 231 \\
5 & 13683 & 12232 & 1451 \\
6 & 82987 & 73656 & 9331 \\
7 & 510131 & 449440 & 60691 \\
8 & 3168583 & 2770016 & 398567 \\
\end{tabular}
\end{center}
