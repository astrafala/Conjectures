...
\title{Recovering the unwritten recurrences of the table OEIS A255149}
...
\begin{abstract}
OEIS A255149 is a two-dimensional table $T(n,k)$ whose empirical recurrences are, for several of
...
OEIS A255149 is ``T(n,k)=Number of (n+2)X(k+2) 0..1 arrays with no 3x3 subblock diagonal sum 0 and no antidiagonal sum 0 and no row sum 1 and no column sum 1.''. It is read by antidiagonals and begins
\[
47, 115, 115, 302, 371, 302, 784, 1310,\ \dots
\]
...
k=3: [order 42]
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:39:24, revision 6) these are still
...
$c_{1}$ & $3$ & $c_{7}$ & $32$ & $c_{13}$ & $-15$ & $c_{19}$ & $-18$ \\
$c_{2}$ & $1$ & $c_{8}$ & $181$ & $c_{14}$ & $250$ & $c_{20}$ & $18$ \\
$c_{3}$ & $14$ & $c_{9}$ & $161$ & $c_{15}$ & $170$ & $c_{21}$ & $0$ \\
$c_{4}$ & $-20$ & $c_{10}$ & $-27$ & $c_{16}$ & $33$ & $c_{22}$ & $4$ \\
$c_{5}$ & $-38$ & $c_{11}$ & $-301$ & $c_{17}$ & $-94$ &  &  \\
$c_{6}$ & $-57$ & $c_{12}$ & $-250$ & $c_{18}$ & $-50$ &  &  \\
...
Substituting the fixed index into the entry's wording gives an ordinary one-parameter array
count, a walk on $S=1024$ vertices. Berlekamp--Massey on $2S=2048$ exact terms
returns a minimal recurrence of order $42$ --- the order the entry states --- with
integer coefficients
\[
(c_1,\dots,c_{42})=(4,\ 0,\ 41,\ -48,\ -135,\ -522,\ -219,\ 1891,\ 4924,\ 4392,\ -9079,\ -29282,\ -30044,\ 21997,\ 94358,\ 115236,\ -5139,\ -175638,\ -251694,\ -98634,\ 162269,\ 320330,\ 226426,\ -21417,\ -213676,\ -227052,\ -84522,\ 50380,\ 109778,\ 67360,\ 15470,\ -23714,\ -20239,\ -10944,\ 866,\ 2287,\ 2134,\ 245,\ 67,\ -166,\ -6,\ -12).
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A255149.
