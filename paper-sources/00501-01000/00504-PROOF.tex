...
\title{The empirical recurrence for OEIS A266753, proved from an exact model}
...
\begin{abstract}
OEIS A266753 carries an empirical recurrence of order $2$ contributed by Colin Barker. It is true, and it is
...
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 20 2016 and Apr 20 2019: (Start) a(n) = 5*a(n-1)-4*a(n-2) for n>2.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 16 2025 08:33:28, revision 49)
