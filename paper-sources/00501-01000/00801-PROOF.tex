...
\title{The cross-base identity for OEIS A125431, proved}
...
\begin{abstract}
OEIS A125431 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125431 is ``Number of base 19 circular n-digit numbers with adjacent digits differing by 7 or less.''. It has offset $0$ and begins
\[
1, 19, 229, 2371, 28117, 340639, 4206175, 52452531,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:36:12, revision 12)
...
the base is $19$ and the permitted difference is $d=7$, so the claim is that
\[
a_{19}(n)-a_{18}(n)\;=\;F_{7}(n)
\qquad\text{for every } n \text{ with } 7\lfloor n/2\rfloor+1\le19,
\]
...
at base $19$ reproduces all $17$ terms A125431 publishes, and at base $18$ all the
...
polynomial. In particular $a_{19}(n)-a_{18}(n)=F_{7}(n)$ for $1\le n\le5$, which
...
First, the model reproduces all $17$ terms A125431 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{7}(19,n)$ & $T_{7}(18,n)$ & $F_{7}(n)$ \\ \hline
1 & 19 & 18 & 1 \\
2 & 229 & 214 & 15 \\
3 & 2371 & 2202 & 169 \\
4 & 28117 & 25862 & 2255 \\
5 & 340639 & 310258 & 30381 \\
\end{tabular}
\end{center}
