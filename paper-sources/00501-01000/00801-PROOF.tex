...
\title{The cross-base identity for OEIS A125472, proved}
...
\begin{abstract}
OEIS A125472 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125472 is ``Number of base 15 circular n-digit numbers with adjacent digits differing by 9 or less.''. It has offset $0$ and begins
\[
1, 15, 195, 2355, 30815, 406085, 5368137, 71010283,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:08:21, revision 14)
...
the base is $15$ and the permitted difference is $d=9$, so the claim is that
\[
a_{15}(n)-a_{14}(n)\;=\;F_{9}(n)
\qquad\text{for every } n \text{ with } 9\lfloor n/2\rfloor+1\le15,
\]
...
at base $15$ reproduces all $17$ terms A125472 publishes, and at base $14$ all the
...
polynomial. In particular $a_{15}(n)-a_{14}(n)=F_{9}(n)$ for $1\le n\le3$, which
...
First, the model reproduces all $17$ terms A125472 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{9}(15,n)$ & $T_{9}(14,n)$ & $F_{9}(n)$ \\ \hline
1 & 15 & 14 & 1 \\
2 & 195 & 176 & 19 \\
3 & 2355 & 2084 & 271 \\
\end{tabular}
