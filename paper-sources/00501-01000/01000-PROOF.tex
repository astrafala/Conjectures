...
\title{The cross-base identity for OEIS A126548, proved}
...
\begin{abstract}
OEIS A126548 carries an empirical identity, in two clauses, relating its counts to those of the
...
OEIS A126548 is ``Number of base 27 n-digit numbers with adjacent digits differing by five or less.''. It has offset $0$ and begins
\[
1, 27, 267, 2717, 27917, 288409, 2989141, 31042303,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:18:44, revision 11)
this is still recorded as empirical, and nothing on the entry records it as proved.

For this entry the base is $27$ and the permitted difference is $d=5$, so the first clause
claims $a_{27}(n)-a_{26}(n)=11^{\,n-1}$ whenever $5(n-1)+1\le27$, that is for
$1\le n\le6$, and the second claims $a_{27}(n)-a_{26}(n)=11^{\,n-1}-2$ at the single
$n$ with $5(n-1)=27$.
...
arithmetic, $L_{5}$ at base $27$ reproduces all $18$ terms A126548 publishes.
...
First, the model reproduces all $18$ terms A126548 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $L_{5}(27,n)$ & $L_{5}(26,n)$ & $11^{\,n-1}$ \\ \hline
1 & 27 & 26 & 1 \\
2 & 267 & 256 & 11 \\
3 & 2717 & 2596 & 121 \\
4 & 27917 & 26586 & 1331 \\
5 & 288409 & 273768 & 14641 \\
6 & 2989141 & 2828090 & 161051 \\
\end{tabular}
\end{center}
