...
\title{The empirical recurrence for OEIS A280897, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A280897 imposes three things at once: a condition on each cell that reaches one row up and
...
OEIS A280897 is ``Number of n X 3 0..2 arrays with no element equal to more than one of its horizontal and antidiagonal neighbors, with the exception of exactly two elements, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
0, 10, 646, 22632, 610448, 14262832, 304584096, 6117000704,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 42*a(n-1) - 564*a(n-2) + 2072*a(n-3) + 4512*a(n-4) + 2688*a(n-5) + 512*a(n-6) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 14 2019 12:42:42, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A280897.
