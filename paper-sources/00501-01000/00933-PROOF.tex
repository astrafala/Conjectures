...
\title{The cross-base identity for OEIS A126524, proved}
...
\begin{abstract}
OEIS A126524 carries an empirical identity, in two clauses, relating its counts to those of the
...
OEIS A126524 is ``Number of base 29 n-digit numbers with adjacent digits differing by four or less.''. It has offset $0$ and begins
\[
1, 29, 241, 2049, 17561, 151221, 1306137, 11305233,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:16:53, revision 11)
this is still recorded as empirical, and nothing on the entry records it as proved.

For this entry the base is $29$ and the permitted difference is $d=4$, so the first clause
claims $a_{29}(n)-a_{28}(n)=9^{\,n-1}$ whenever $4(n-1)+1\le29$, that is for
$1\le n\le8$, and the second claims $a_{29}(n)-a_{28}(n)=9^{\,n-1}-2$ at the single
$n$ with $4(n-1)=29$.
...
arithmetic, $L_{4}$ at base $29$ reproduces all $19$ terms A126524 publishes.
...
First, the model reproduces all $19$ terms A126524 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $L_{4}(29,n)$ & $L_{4}(28,n)$ & $9^{\,n-1}$ \\ \hline
1 & 29 & 28 & 1 \\
2 & 241 & 232 & 9 \\
3 & 2049 & 1968 & 81 \\
4 & 17561 & 16832 & 729 \\
5 & 151221 & 144660 & 6561 \\
6 & 1306137 & 1247088 & 59049 \\
7 & 11305233 & 10773792 & 531441 \\
8 & 98001277 & 93218308 & 4782969 \\
\end{tabular}
\end{center}
