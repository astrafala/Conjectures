...
\title{The cross-base identity for OEIS A125358, proved}
...
\begin{abstract}
OEIS A125358 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125358 is ``Number of base 21 circular n-digit numbers with adjacent digits differing by 4 or less.''. It has offset $0$ and begins
\[
1, 21, 169, 1101, 8369, 64671, 511957, 4108671,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:26:51, revision 11)
...
the base is $21$ and the permitted difference is $d=4$, so the claim is that
\[
a_{21}(n)-a_{20}(n)\;=\;F_{4}(n)
\qquad\text{for every } n \text{ with } 4\lfloor n/2\rfloor+1\le21,
\]
...
at base $21$ reproduces all $20$ terms A125358 publishes, and at base $20$ all the
...
polynomial. In particular $a_{21}(n)-a_{20}(n)=F_{4}(n)$ for $1\le n\le11$, which
...
First, the model reproduces all $20$ terms A125358 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{4}(21,n)$ & $T_{4}(20,n)$ & $F_{4}(n)$ \\ \hline
1 & 21 & 20 & 1 \\
2 & 169 & 160 & 9 \\
3 & 1101 & 1040 & 61 \\
4 & 8369 & 7880 & 489 \\
5 & 64671 & 60720 & 3951 \\
6 & 511957 & 479296 & 32661 \\
7 & 4108671 & 3835544 & 273127 \\
8 & 33331889 & 31025864 & 2306025 \\
\end{tabular}
\end{center}
