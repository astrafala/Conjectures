...
\title{A cross-alphabet identity for bounded-difference square arrays: OEIS A125544}
...
\begin{abstract}
OEIS A125544 carries an empirical identity relating its counts to those of the same problem over an
...
OEIS A125544 is ``Number of n X n arrays with entries in 1..10 in which adjacent entries differ by 8 or less (adjacent means in x or y directions).''. It has offset $0$ and begins
\[
1, 10, 9282, 809972882, 6620278776930050, 5070242688355834000238994, 363841631496359667433584638167920450, 2446405761143101128307819275435459905126486602002,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 26 2017 17:43:43, revision 9)
...
most $d$. The entry is $T(10,8,n)$, and the conjecture is
\[
...
First, the count $T(10,8,n)$ was computed by an independent row-pair dynamic program and
reproduces the $4$ published terms of A125544 that the computation reaches,
...
\[
\begin{array}{rrrr}
n & T(10+1,8,n) & T(10,8,n) & F(n,8) \\ \hline
1 & 11 & 10 & 1 \\
2 & 12199 & 9282 & 3281 \\
\end{array}
\]
...
\url{https://oeis.org}, 2026. Sequence A125544: \url{https://oeis.org/A125544}.
\end{thebibliography}
