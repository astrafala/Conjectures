...
\title{The cross-base identity for OEIS A126490, proved}
...
\begin{abstract}
OEIS A126490 carries an empirical identity, in two clauses, relating its counts to those of the
...
OEIS A126490 is ``Number of base 22 n-digit numbers with adjacent digits differing by three or less.''. It has offset $0$ and begins
\[
1, 22, 142, 938, 6246, 41790, 280454, 1886106,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:14:04, revision 9)
this is still recorded as empirical, and nothing on the entry records it as proved.

For this entry the base is $22$ and the permitted difference is $d=3$, so the first clause
claims $a_{22}(n)-a_{21}(n)=7^{\,n-1}$ whenever $3(n-1)+1\le22$, that is for
$1\le n\le8$, and the second claims $a_{22}(n)-a_{21}(n)=7^{\,n-1}-2$ at the single
$n$ with $3(n-1)=22$.
...
arithmetic, $L_{3}$ at base $22$ reproduces all $20$ terms A126490 publishes.
...
First, the model reproduces all $20$ terms A126490 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $L_{3}(22,n)$ & $L_{3}(21,n)$ & $7^{\,n-1}$ \\ \hline
1 & 22 & 21 & 1 \\
2 & 142 & 135 & 7 \\
3 & 938 & 889 & 49 \\
4 & 6246 & 5903 & 343 \\
5 & 41790 & 39389 & 2401 \\
6 & 280454 & 263647 & 16807 \\
7 & 1886106 & 1768457 & 117649 \\
8 & 12703674 & 11880131 & 823543 \\
\end{tabular}
\end{center}
