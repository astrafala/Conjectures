...
\title{The empirical recurrence for OEIS A221257, proved by transfer matrix}
...
\begin{abstract}
OEIS A221257 counts the distinct OCCUPANCY arrays obtained when every cell of an $n\times3$ grid
...
determinising the machine that emits the occupancy row by row turns it into one, on $S=901$
...
OEIS A221257 is ``Number of 3Xn arrays of occupancy after each element moves to some horizontal or antidiagonal neighbor, with no occupancy greater than 2.''. It has offset $1$ and begins
\[
0, 16, 30, 2116, 22268, 488601, 7356420, 132273001,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 19:26:10, revision 8) this is still
...
\]
There are $S=901$ reachable sets. In particular $a$ is $C$-finite.
...
\begin{theorem}
\[
a(n)\;=\;21\,a(n-1) + 21\,a(n-2) - 1891\,a(n-3) + 4713\,a(n-4) + 31527\,a(n-5) - 98973\,a(n-6) - 92217\,a(n-7) + 299577\,a(n-8) - 27117\,a(n-9) + 103383\,a(n-10) - 393\,a(n-11) + 6211\,a(n-12) + 69\,a(n-13) + 69\,a(n-14) + a(n-15)
\]
for every $n>18$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221257.
