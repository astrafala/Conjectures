...
\title{The cross-base identity for OEIS A124947, proved}
...
\begin{abstract}
OEIS A124947 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A124947 is ``Number of base 19 circular n-digit numbers with adjacent digits differing by 2 or less.''. It has offset $0$ and begins
\[
1, 19, 89, 331, 1437, 6289, 28241, 128413,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:16:49, revision 16)
...
the base is $19$ and the permitted difference is $d=2$, so the claim is that
\[
a_{19}(n)-a_{18}(n)\;=\;F_{2}(n)
\qquad\text{for every } n \text{ with } 2\lfloor n/2\rfloor+1\le19,
\]
...
at base $19$ reproduces all $22$ terms A124947 publishes, and at base $18$ all the
...
polynomial. In particular $a_{19}(n)-a_{18}(n)=F_{2}(n)$ for $1\le n\le19$, which
...
First, the model reproduces all $22$ terms A124947 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{2}(19,n)$ & $T_{2}(18,n)$ & $F_{2}(n)$ \\ \hline
1 & 19 & 18 & 1 \\
2 & 89 & 84 & 5 \\
3 & 331 & 312 & 19 \\
4 & 1437 & 1352 & 85 \\
5 & 6289 & 5908 & 381 \\
6 & 28241 & 26490 & 1751 \\
7 & 128413 & 120278 & 8135 \\
8 & 590197 & 552032 & 38165 \\
\end{tabular}
\end{center}
