...
\title{The empirical recurrence for OEIS A264477, proved by transfer matrix}
...
\begin{abstract}
OEIS A264477 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=4$ columns in which
...
OEIS A264477 is ``Number of (3+1)X(n+1) arrays of permutations of 0..n*4+3 with each element having directed index change 0,1 1,0 2,1 or -1,-1.''. It has offset $1$ and begins
\[
0, 4, 6, 16, 57, 160, 484, 1449,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 14 2015 15:38:15, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 10\,a(n-3) - 4\,a(n-4) + 8\,a(n-5) - 25\,a(n-6) - 4\,a(n-8) + 33\,a(n-9) + 4\,a(n-10) - 4\,a(n-11) - 10\,a(n-12) - 2\,a(n-13) + a(n-15)
\]
for every $n>13$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264477.
