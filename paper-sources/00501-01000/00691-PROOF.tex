...
\title{The empirical recurrence for OEIS A281059, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A281059 imposes three things at once: a condition on each cell that reaches one column up and
...
OEIS A281059 is ``Number of 4Xn 0..1 arrays with no element equal to more than one of its horizontal and antidiagonal neighbors, with the exception of exactly two elements, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
0, 29, 376, 1022, 2452, 5400, 10570, 19892,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 6*a(n-1) -12*a(n-2) +5*a(n-3) +12*a(n-4) -12*a(n-5) -3*a(n-6) +6*a(n-7) -a(n-9) for n>17
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 13 2017 17:01:10, revision 4) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A281059.
