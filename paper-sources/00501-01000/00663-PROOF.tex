...
\title{The empirical recurrence for OEIS A264108, proved by transfer matrix}
...
\begin{abstract}
OEIS A264108 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=6$ rows in which
...
OEIS A264108 is ``Number of (n+1)X(5+1) arrays of permutations of 0..n*6+5 with each element having index change +-(.,.) 0,0 0,2 or 1,1.''. It has offset $1$ and begins
\[
512, 21025, 911754, 39087504, 1680100825, 72203451849, 3103083479700, 133360207252561,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 10 2015 11:25:44, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;43\,a(n-1) - a(n-2) + 1848\,a(n-4) - 79464\,a(n-5) + 1848\,a(n-6) - 1848\,a(n-8) + 79464\,a(n-9) - 1848\,a(n-10) + a(n-12) - 43\,a(n-13) + a(n-14)
\]
for every $n>13$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264108.
