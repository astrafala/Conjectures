...
\title{The empirical recurrence for OEIS A281566, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A281566 imposes three things at once: a condition on each cell that reaches one column up and
...
OEIS A281566 is ``Number of 4Xn 0..1 arrays with no element equal to more than two of its horizontal, diagonal or antidiagonal neighbors, with the exception of exactly two elements, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
0, 6, 815, 3374, 12133, 31300, 67834, 136056,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 24 2017 08:39:08, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) - 15\,a(n-2) + 23\,a(n-3) - 27\,a(n-4) + 21\,a(n-5) - 4\,a(n-6) - 9\,a(n-7) + 15\,a(n-8) - 14\,a(n-9) + 3\,a(n-10) + 3\,a(n-11) - 3\,a(n-12) + 3\,a(n-13) - a(n-15)
\end{equation}
for all $n>24$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A281566.
