...
\title{The empirical recurrence for OEIS A184706, proved from an exact model}
...
\begin{abstract}
OEIS A184706 carries an empirical recurrence of order $17$. It is true, and it is
...
OEIS A184706 is ``Number of strings of numbers x(i=1..6) in 0..n with sum i*x(i) equal to n*6.''. It has offset $1$ and begins
\[
4, 21, 74, 207, 476, 985, 1842, 3226,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 02:52:10, revision 9)
...
$q(z)=z^{17}-\sum_ic_iz^{17-i}$ the characteristic polynomial of the conjectured
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-2) + 2\,a(n-3) - 3\,a(n-4) - 5\,a(n-5) + 3\,a(n-7) + a(n-8) + a(n-9) + 3\,a(n-10) - 5\,a(n-12) - 3\,a(n-13) + 2\,a(n-14) + 3\,a(n-15) - a(n-17)
\]
for every $n>0$.
\end{theorem}
...
vanish from $n=0+1$ onwards, and the run exceeds $S+17$, which by
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A184706.
