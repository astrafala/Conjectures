...
\title{The cross-base identity for OEIS A126537, proved}
...
\begin{abstract}
OEIS A126537 carries an empirical identity, in two clauses, relating its counts to those of the
...
OEIS A126537 is ``Number of base 16 n-digit numbers with adjacent digits differing by five or less.''. It has offset $0$ and begins
\[
1, 16, 146, 1386, 13276, 127470, 1224594, 11766272,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:17:44, revision 14)
this is still recorded as empirical, and nothing on the entry records it as proved.

For this entry the base is $16$ and the permitted difference is $d=5$, so the first clause
claims $a_{16}(n)-a_{15}(n)=11^{\,n-1}$ whenever $5(n-1)+1\le16$, that is for
$1\le n\le4$, and the second claims $a_{16}(n)-a_{15}(n)=11^{\,n-1}-2$ at the single
$n$ with $5(n-1)=16$.
...
arithmetic, $L_{5}$ at base $16$ reproduces all $19$ terms A126537 publishes.
...
First, the model reproduces all $19$ terms A126537 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $L_{5}(16,n)$ & $L_{5}(15,n)$ & $11^{\,n-1}$ \\ \hline
1 & 16 & 15 & 1 \\
2 & 146 & 135 & 11 \\
3 & 1386 & 1265 & 121 \\
4 & 13276 & 11945 & 1331 \\
