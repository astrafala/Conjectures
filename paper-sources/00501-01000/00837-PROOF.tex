...
\title{The empirical recurrence for OEIS A279263, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A279263 imposes three things at once: a condition on each cell that reaches one row up and
...
OEIS A279263 is ``Number of n X 3 0..1 arrays with no element equal to a strict majority of its horizontal and vertical neighbors, with the exception of exactly one element, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
2, 10, 29, 86, 240, 626, 1603, 4030,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 4*a(n-1) - 4*a(n-2) + 2*a(n-3) - 4*a(n-4) - a(n-6) for n>9.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 10 2019 12:38:49, revision 7) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A279263.
