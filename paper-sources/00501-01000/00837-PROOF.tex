...
\title{The empirical recurrence for OEIS A221746, proved by transfer matrix}
...
\begin{abstract}
OEIS A221746 counts the distinct OCCUPANCY arrays obtained when every cell of an $n\times2$ grid
...
one, on $S=342$ states, after which the conjectured recurrence is settled by a finite exact
computation.
\end{abstract}
...
OEIS A221746 is ``Number of nX2 arrays of occupancy after each element moves to some king-move neighbor, without move-in move-out straight through or left turns.''. It has offset $1$ and begins
\[
1, 19, 98, 817, 5567, 41067, 293058, 2119375,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 19:54:53, revision 9) this is still
...
$S=342$ reachable sets. In particular $a$ is $C$-finite.
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + 33\,a(n-2) + 7\,a(n-3) - 165\,a(n-4) - 152\,a(n-5) - 189\,a(n-6) - 572\,a(n-7) - 280\,a(n-8) - 223\,a(n-9) - 745\,a(n-10) - 574\,a(n-11) - 882\,a(n-12) - 773\,a(n-13) - 298\,a(n-14) - 128\,a(n-15) + 4\,a(n-16) + 19\,a(n-17) + 3\,a(n-18)
\]
for every $n>18$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221746.
