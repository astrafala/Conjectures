...
\title{The empirical recurrence for OEIS A266680, proved from an exact model}
...
\begin{abstract}
OEIS A266680 carries an empirical recurrence of order $2$ contributed by Colin Barker. It is true, and it is
...
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 19 2016 and Apr 18 2019: (Start) a(n) = 11*a(n-1) - 10*a(n-2) for n > 3.
\end{quote}
