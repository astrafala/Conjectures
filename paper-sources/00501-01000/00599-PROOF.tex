...
\title{The empirical recurrence for OEIS A281135, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A281135 imposes three things at once: a condition on each cell that reaches one row up and
...
from a finite exact computation on $S=13636$ states.
\end{abstract}
...
OEIS A281135 is ``Number of nX4 0..2 arrays with no element equal to more than one of its king-move neighbors, with the exception of exactly one element, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
2, 112, 1046, 2368, 5368, 12064, 27218, 61508,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 15 2017 09:28:49, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + a(n-2) + a(n-4) - 19\,a(n-6) - 8\,a(n-7) + 4\,a(n-8) + 2\,a(n-9) + 5\,a(n-10) + 44\,a(n-11) + 14\,a(n-12) - 20\,a(n-13) + 3\,a(n-14) + 20\,a(n-15) - 40\,a(n-16) - 36\,a(n-17) + 16\,a(n-18) + 12\,a(n-19) - 16\,a(n-20) + 16\,a(n-22) - 4\,a(n-24)
\end{equation}
for all $n>33$.
...
Assembling the $3$ chains block-diagonally into $N$ of size $S=13636$ with the weights of
...
\[
3!\Bigl(a(n_0+j)-\sum_i c_i\,a(n_0+j-i)\Bigr)=\mathbf{v}^{\!\top}G^{\,j-24}w,
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A281135.
