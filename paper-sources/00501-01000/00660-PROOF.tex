...
\title{The cross-base identity for OEIS A125324, proved}
...
\begin{abstract}
OEIS A125324 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125324 is ``Number of base 14 circular n-digit numbers with adjacent digits differing by 3 or less.''. It has offset $0$ and begins
\[
1, 14, 86, 434, 2542, 15134, 92318, 570822,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:02:32, revision 13)
...
the base is $14$ and the permitted difference is $d=3$, so the claim is that
\[
a_{14}(n)-a_{13}(n)\;=\;F_{3}(n)
\qquad\text{for every } n \text{ with } 3\lfloor n/2\rfloor+1\le14,
\]
...
at base $14$ reproduces all $20$ terms A125324 publishes, and at base $13$ all the
...
polynomial. In particular $a_{14}(n)-a_{13}(n)=F_{3}(n)$ for $1\le n\le9$, which
...
First, the model reproduces all $20$ terms A125324 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{3}(14,n)$ & $T_{3}(13,n)$ & $F_{3}(n)$ \\ \hline
1 & 14 & 13 & 1 \\
2 & 86 & 79 & 7 \\
3 & 434 & 397 & 37 \\
4 & 2542 & 2311 & 231 \\
5 & 15134 & 13683 & 1451 \\
6 & 92318 & 82987 & 9331 \\
7 & 570822 & 510131 & 60691 \\
8 & 3567150 & 3168583 & 398567 \\
\end{tabular}
\end{center}
