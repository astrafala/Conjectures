...
\title{The empirical recurrence for OEIS A283348, proved from an exact model}
...
\begin{abstract}
OEIS A283348 carries an empirical recurrence of order $3$ contributed by Colin Barker. It is true, and it is
...
OEIS A283348 is ``Binary representation of the x-axis, from the origin to the right edge, of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 617", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 0, 110, 1000, 1110, 11000, 111110, 1111000,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Mar 06 2017: (Start) a(n) = 10*a(n-1) + a(n-2) - 10*a(n-3) for n>4.
\end{quote}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A283348.
