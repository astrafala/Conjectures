...
\title{The empirical recurrence for OEIS A267604, proved from an exact model}
...
\begin{abstract}
OEIS A267604 carries an empirical recurrence of order $2$ contributed by Colin Barker. It is true, and it is
...
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 18 2016 and Apr 20 2019: (Start) a(n) = 3*a(n-1)-2*a(n-2) for n>3.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 16 2025 08:33:29, revision 58)
