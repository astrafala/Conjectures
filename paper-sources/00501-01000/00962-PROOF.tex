...
\title{The cross-base identity for OEIS A126496, proved}
...
\begin{abstract}
OEIS A126496 carries an empirical identity, in two clauses, relating its counts to those of the
...
OEIS A126496 is ``Number of base 28 n-digit numbers with adjacent digits differing by three or less.''. It has offset $0$ and begins
\[
1, 28, 184, 1232, 8304, 56196, 381296, 2592000,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:14:36, revision 9)
this is still recorded as empirical, and nothing on the entry records it as proved.

For this entry the base is $28$ and the permitted difference is $d=3$, so the first clause
claims $a_{28}(n)-a_{27}(n)=7^{\,n-1}$ whenever $3(n-1)+1\le28$, that is for
$1\le n\le10$, and the second claims $a_{28}(n)-a_{27}(n)=7^{\,n-1}-2$ at the single
$n$ with $3(n-1)=28$.
...
arithmetic, $L_{3}$ at base $28$ reproduces all $20$ terms A126496 publishes.
...
First, the model reproduces all $20$ terms A126496 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $L_{3}(28,n)$ & $L_{3}(27,n)$ & $7^{\,n-1}$ \\ \hline
1 & 28 & 27 & 1 \\
2 & 184 & 177 & 7 \\
3 & 1232 & 1183 & 49 \\
4 & 8304 & 7961 & 343 \\
5 & 56196 & 53795 & 2401 \\
6 & 381296 & 364489 & 16807 \\
7 & 2592000 & 2474351 & 117649 \\
8 & 17644932 & 16821389 & 823543 \\
\end{tabular}
\end{center}
