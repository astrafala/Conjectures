...
\begin{abstract}
OEIS A267925 carries an empirical recurrence of order $3$ contributed by Colin Barker. It is true, and it is
...
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 23 2016 and Apr 20 2019: (Start) a(n) = a(n-1)+10000*a(n-2)-10000*a(n-3) for n>2.
\end{quote}
