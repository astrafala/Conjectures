...
\title{A cross-alphabet identity for bounded-difference square arrays: OEIS A125539}
...
\begin{abstract}
OEIS A125539 carries an empirical identity relating its counts to those of the same problem over an
...
OEIS A125539 is ``Number of n X n arrays with entries in 1..8 in which adjacent entries differ by 5 or less (adjacent means in x or y directions).''. It has offset $0$ and begins
\[
1, 8, 2902, 52127130, 45120225704486, 1888405717902201691046, 3819825084723229625771326323002, 373453238394596300163358238712837771590526,\ \dots
\]
...
most $d$. The entry is $T(8,5,n)$, and the conjecture is
\[
...
First, the count $T(8,5,n)$ was computed by an independent row-pair dynamic program and
reproduces the $4$ published terms of A125539 that the computation reaches,
...
\[
\begin{array}{rrrr}
n & T(8+1,5,n) & T(8,5,n) & F(n,5) \\ \hline
1 & 9 & 8 & 1 \\
2 & 3773 & 2902 & 891 \\
\end{array}
\]
...
\url{https://oeis.org}, 2026. Sequence A125539: \url{https://oeis.org/A125539}.
\end{thebibliography}
