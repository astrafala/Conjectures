...
\title{The cross-base identity for OEIS A126402, proved}
...
\begin{abstract}
OEIS A126402 carries an empirical identity, in two clauses, relating its counts to those of the
...
OEIS A126402 is ``Number of base 15 n-digit numbers with adjacent digits differing by two or less.''. It has offset $0$ and begins
\[
1, 15, 69, 325, 1543, 7361, 35223, 168899,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:11:13, revision 12)
this is still recorded as empirical, and nothing on the entry records it as proved.

For this entry the base is $15$ and the permitted difference is $d=2$, so the first clause
claims $a_{15}(n)-a_{14}(n)=5^{\,n-1}$ whenever $2(n-1)+1\le15$, that is for
$1\le n\le8$, and the second claims $a_{15}(n)-a_{14}(n)=5^{\,n-1}-2$ at the single
$n$ with $2(n-1)=15$.
...
arithmetic, $L_{2}$ at base $15$ reproduces all $21$ terms A126402 publishes.
...
First, the model reproduces all $21$ terms A126402 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $L_{2}(15,n)$ & $L_{2}(14,n)$ & $5^{\,n-1}$ \\ \hline
1 & 15 & 14 & 1 \\
2 & 69 & 64 & 5 \\
3 & 325 & 300 & 25 \\
4 & 1543 & 1418 & 125 \\
5 & 7361 & 6736 & 625 \\
6 & 35223 & 32098 & 3125 \\
7 & 168899 & 153274 & 15625 \\
8 & 811105 & 732980 & 78125 \\
\end{tabular}
\end{center}
