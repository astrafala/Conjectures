...
\title{The cross-base identity for OEIS A125412, proved}
...
\begin{abstract}
OEIS A125412 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125412 is ``Number of base 24 circular n-digit numbers with adjacent digits differing by 6 or less.''. It has offset $0$ and begins
\[
1, 24, 270, 2502, 26954, 296054, 3328560, 37937308,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:34:22, revision 12)
...
the base is $24$ and the permitted difference is $d=6$, so the claim is that
\[
a_{24}(n)-a_{23}(n)\;=\;F_{6}(n)
\qquad\text{for every } n \text{ with } 6\lfloor n/2\rfloor+1\le24,
\]
...
at base $24$ reproduces all $17$ terms A125412 publishes, and at base $23$ all the
...
polynomial. In particular $a_{24}(n)-a_{23}(n)=F_{6}(n)$ for $1\le n\le7$, which
...
First, the model reproduces all $17$ terms A125412 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{6}(24,n)$ & $T_{6}(23,n)$ & $F_{6}(n)$ \\ \hline
1 & 24 & 23 & 1 \\
2 & 270 & 257 & 13 \\
3 & 2502 & 2375 & 127 \\
4 & 26954 & 25485 & 1469 \\
5 & 296054 & 278903 & 17151 \\
6 & 3328560 & 3123797 & 204763 \\
7 & 37937308 & 35463983 & 2473325 \\
\end{tabular}
\end{center}
