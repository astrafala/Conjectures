...
\title{The cross-base identity for OEIS A125327, proved}
...
\begin{abstract}
OEIS A125327 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125327 is ``Number of base 17 circular n-digit numbers with adjacent digits differing by 3 or less.''. It has offset $0$ and begins
\[
1, 17, 107, 545, 3235, 19487, 120311, 752895,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 06 2026 20:13:11, revision 33)
...
the base is $17$ and the permitted difference is $d=3$, so the claim is that
\[
a_{17}(n)-a_{16}(n)\;=\;F_{3}(n)
\qquad\text{for every } n \text{ with } 3\lfloor n/2\rfloor+1\le17,
\]
...
at base $17$ reproduces all $23$ terms A125327 publishes, and at base $16$ all the
...
polynomial. In particular $a_{17}(n)-a_{16}(n)=F_{3}(n)$ for $1\le n\le11$, which
...
First, the model reproduces all $23$ terms A125327 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{3}(17,n)$ & $T_{3}(16,n)$ & $F_{3}(n)$ \\ \hline
1 & 17 & 16 & 1 \\
2 & 107 & 100 & 7 \\
3 & 545 & 508 & 37 \\
4 & 3235 & 3004 & 231 \\
5 & 19487 & 18036 & 1451 \\
6 & 120311 & 110980 & 9331 \\
7 & 752895 & 692204 & 60691 \\
8 & 4762851 & 4364284 & 398567 \\
\end{tabular}
\end{center}
