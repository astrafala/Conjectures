...
\title{The empirical recurrence for OEIS A264218, proved by transfer matrix}
...
\begin{abstract}
OEIS A264218 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=2$ columns in which
...
OEIS A264218 is ``Number of (1+1) X (n+1) arrays of permutations of 0..n*2+1 with each element having directed index change 0,0 0,1 1,0 -1,0 or 0,-2.''. It has offset $1$ and begins
\[
4, 17, 56, 172, 561, 1826, 5880, 18993,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + 2*a(n-2) + 6*a(n-3) + 2*a(n-4) - 2*a(n-5) - a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 06 2019 07:56:48, revision 10) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264218.
