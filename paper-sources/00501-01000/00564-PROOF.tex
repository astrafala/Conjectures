...
\begin{abstract}
OEIS A281146 carries an empirical recurrence of order $3$ contributed by Colin Barker. It is true, and it is
...
\begin{quote}
Conjectures from \_Colin Barker\_, Feb 22 2017: (Start) a(n) = 10*a(n-1) + a(n-2) - 10*a(n-3) for n>2.
\end{quote}
