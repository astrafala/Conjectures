...
\title{The empirical recurrence for OEIS A221774, proved by transfer matrix}
...
\begin{abstract}
OEIS A221774 counts the distinct OCCUPANCY arrays obtained when every cell of an $n\times2$ grid
...
one, on $S=377$ states, after which the conjectured recurrence is settled by a finite exact
computation.
\end{abstract}
...
OEIS A221774 is ``Number of nX2 arrays of occupancy after each element stays put or moves to some king-move neighbor, without move-in move-out left turns.''. It has offset $1$ and begins
\[
3, 35, 372, 3943, 41745, 441877, 4677106, 49504700,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 19*a(n-1) -117*a(n-2) +338*a(n-3) -469*a(n-4) +191*a(n-5) +237*a(n-6) -183*a(n-7) -64*a(n-8) +14*a(n-9)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 19:57:31, revision 9) this is still
...
$S=377$ reachable sets. In particular $a$ is $C$-finite.
...
\begin{theorem}
\[
a(n)\;=\;19\,a(n-1) - 117\,a(n-2) + 338\,a(n-3) - 469\,a(n-4) + 191\,a(n-5) + 237\,a(n-6) - 183\,a(n-7) - 64\,a(n-8) + 14\,a(n-9)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221774.
