...
\title{The cross-base identity for OEIS A126540, proved}
...
\begin{abstract}
OEIS A126540 carries an empirical identity, in two clauses, relating its counts to those of the
...
OEIS A126540 is ``Number of base 19 n-digit numbers with adjacent digits differing by five or less.''. It has offset $0$ and begins
\[
1, 19, 179, 1749, 17269, 171283, 1701677, 16916769,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:18:01, revision 11)
this is still recorded as empirical, and nothing on the entry records it as proved.

For this entry the base is $19$ and the permitted difference is $d=5$, so the first clause
claims $a_{19}(n)-a_{18}(n)=11^{\,n-1}$ whenever $5(n-1)+1\le19$, that is for
$1\le n\le4$, and the second claims $a_{19}(n)-a_{18}(n)=11^{\,n-1}-2$ at the single
$n$ with $5(n-1)=19$.
...
arithmetic, $L_{5}$ at base $19$ reproduces all $18$ terms A126540 publishes.
...
First, the model reproduces all $18$ terms A126540 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $L_{5}(19,n)$ & $L_{5}(18,n)$ & $11^{\,n-1}$ \\ \hline
1 & 19 & 18 & 1 \\
2 & 179 & 168 & 11 \\
3 & 1749 & 1628 & 121 \\
4 & 17269 & 15938 & 1331 \\
