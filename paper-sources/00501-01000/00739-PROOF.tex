...
\title{The cross-base identity for OEIS A125407, proved}
...
\begin{abstract}
OEIS A125407 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125407 is ``Number of base 19 circular n-digit numbers with adjacent digits differing by 6 or less.''. It has offset $0$ and begins
\[
1, 19, 205, 1867, 19609, 210299, 2304745, 25570683,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:06:22, revision 14)
...
the base is $19$ and the permitted difference is $d=6$, so the claim is that
\[
a_{19}(n)-a_{18}(n)\;=\;F_{6}(n)
\qquad\text{for every } n \text{ with } 6\lfloor n/2\rfloor+1\le19,
\]
...
at base $19$ reproduces all $18$ terms A125407 publishes, and at base $18$ all the
...
polynomial. In particular $a_{19}(n)-a_{18}(n)=F_{6}(n)$ for $1\le n\le7$, which
...
First, the model reproduces all $18$ terms A125407 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{6}(19,n)$ & $T_{6}(18,n)$ & $F_{6}(n)$ \\ \hline
1 & 19 & 18 & 1 \\
2 & 205 & 192 & 13 \\
3 & 1867 & 1740 & 127 \\
4 & 19609 & 18140 & 1469 \\
5 & 210299 & 193148 & 17151 \\
6 & 2304745 & 2099982 & 204763 \\
7 & 25570683 & 23097358 & 2473325 \\
\end{tabular}
\end{center}
