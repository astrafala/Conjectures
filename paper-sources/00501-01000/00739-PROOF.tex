...
\title{The cross-base identity for OEIS A125336, proved}
...
\begin{abstract}
OEIS A125336 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125336 is ``Number of base 26 circular n-digit numbers with adjacent digits differing by 3 or less.''. It has offset $0$ and begins
\[
1, 26, 170, 878, 5314, 32546, 204290, 1299114,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:24:09, revision 11)
...
the base is $26$ and the permitted difference is $d=3$, so the claim is that
\[
a_{26}(n)-a_{25}(n)\;=\;F_{3}(n)
\qquad\text{for every } n \text{ with } 3\lfloor n/2\rfloor+1\le26,
\]
...
at base $26$ reproduces all $20$ terms A125336 publishes, and at base $25$ all the
...
polynomial. In particular $a_{26}(n)-a_{25}(n)=F_{3}(n)$ for $1\le n\le17$, which
...
First, the model reproduces all $20$ terms A125336 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{3}(26,n)$ & $T_{3}(25,n)$ & $F_{3}(n)$ \\ \hline
1 & 26 & 25 & 1 \\
2 & 170 & 163 & 7 \\
3 & 878 & 841 & 37 \\
4 & 5314 & 5083 & 231 \\
5 & 32546 & 31095 & 1451 \\
6 & 204290 & 194959 & 9331 \\
7 & 1299114 & 1238423 & 60691 \\
8 & 8349954 & 7951387 & 398567 \\
\end{tabular}
\end{center}
