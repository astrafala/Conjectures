...
\title{The empirical recurrence for OEIS A279743, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A279743 imposes three things at once: a condition on each cell that reaches one column up and
...
OEIS A279743 is ``Number of 3Xn 0..1 arrays with no element equal to a strict majority of its horizontal and antidiagonal neighbors, with the exception of exactly one element, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
0, 8, 35, 106, 286, 746, 1887, 4700,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 18 2016 07:46:22, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) - 13\,a(n-2) + 10\,a(n-3) + 10\,a(n-4) - 30\,a(n-5) + 21\,a(n-6) + 2\,a(n-7) - 14\,a(n-8) + 10\,a(n-9) - 7\,a(n-10) + 6\,a(n-11) + 6\,a(n-12) - 2\,a(n-13) - a(n-14) - 2\,a(n-15) - a(n-16)
\end{equation}
for all $n>18$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A279743.
