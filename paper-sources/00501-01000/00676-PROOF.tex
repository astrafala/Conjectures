...
\title{The cross-base identity for OEIS A124954, proved}
...
\begin{abstract}
OEIS A124954 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A124954 is ``Number of base 26 circular n-digit numbers with adjacent digits differing by 2 or less.''. It has offset $0$ and begins
\[
1, 26, 124, 464, 2032, 8956, 40498, 185358,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:17:59, revision 16)
...
the base is $26$ and the permitted difference is $d=2$, so the claim is that
\[
a_{26}(n)-a_{25}(n)\;=\;F_{2}(n)
\qquad\text{for every } n \text{ with } 2\lfloor n/2\rfloor+1\le26,
\]
...
at base $26$ reproduces all $21$ terms A124954 publishes, and at base $25$ all the
...
polynomial. In particular $a_{26}(n)-a_{25}(n)=F_{2}(n)$ for $1\le n\le25$, which
...
First, the model reproduces all $21$ terms A124954 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{2}(26,n)$ & $T_{2}(25,n)$ & $F_{2}(n)$ \\ \hline
1 & 26 & 25 & 1 \\
2 & 124 & 119 & 5 \\
3 & 464 & 445 & 19 \\
4 & 2032 & 1947 & 85 \\
5 & 8956 & 8575 & 381 \\
6 & 40498 & 38747 & 1751 \\
7 & 185358 & 177223 & 8135 \\
8 & 857352 & 819187 & 38165 \\
\end{tabular}
\end{center}
