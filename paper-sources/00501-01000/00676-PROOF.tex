...
\title{The cross-base identity for OEIS A124935, proved}
...
\begin{abstract}
OEIS A124935 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A124935 is ``Number of base 18 circular n-digit numbers with adjacent digits differing by 2 or less.''. It has offset $0$ and begins
\[
1, 18, 84, 312, 1352, 5908, 26490, 120278,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:16:41, revision 16)
...
the base is $18$ and the permitted difference is $d=2$, so the claim is that
\[
a_{18}(n)-a_{17}(n)\;=\;F_{2}(n)
\qquad\text{for every } n \text{ with } 2\lfloor n/2\rfloor+1\le18,
\]
...
at base $18$ reproduces all $22$ terms A124935 publishes, and at base $17$ all the
...
polynomial. In particular $a_{18}(n)-a_{17}(n)=F_{2}(n)$ for $1\le n\le17$, which
...
First, the model reproduces all $22$ terms A124935 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{2}(18,n)$ & $T_{2}(17,n)$ & $F_{2}(n)$ \\ \hline
1 & 18 & 17 & 1 \\
2 & 84 & 79 & 5 \\
3 & 312 & 293 & 19 \\
4 & 1352 & 1267 & 85 \\
5 & 5908 & 5527 & 381 \\
6 & 26490 & 24739 & 1751 \\
7 & 120278 & 112143 & 8135 \\
8 & 552032 & 513867 & 38165 \\
\end{tabular}
\end{center}
