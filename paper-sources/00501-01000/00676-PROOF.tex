...
\title{The empirical recurrence for OEIS A223268, proved by transfer matrix}
...
\begin{abstract}
OEIS A223268 counts the ways of writing the vertices of a fixed graph $G$ into an array of width
$7$ so that any two cells adjacent in one of the named directions carry vertices joined by an
edge of $G$; here $G$ is octahedron graph. The entry carries an empirical recurrence of order $19$
...
OEIS A223268 is ``Rolling cube footprints: number of nX7 0..5 arrays starting with 0 where 0..5 label faces of a cube and every array movement to a horizontal, diagonal or antidiagonal neighbor moves across a corresponding cube edge.''. It has offset $1$ and begins
\[
4096, 8060928, 19084083200, 47175115472896, 118579442837618688, 300099634959879241728, 761838097494483172065280, 1936846409617575899985608704,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 21:26:35, revision 8) this is still
...
$\widehat{M}^{j+19}-\sum_ic_i\widehat{M}^{j+19-i}$. For the bound,
...
\begin{theorem}
\[
a(n)\;=\;5248\,a(n-1) - 8994816\,a(n-2) + 5490343936\,a(n-3) + 187904819200\,a(n-4) - 1264610170634240\,a(n-5) + 256551247132229632\,a(n-6) + 70752113095943913472\,a(n-7) - 23366404249055043518464\,a(n-8) - 533913337097412407197696\,a(n-9) + 674953674297109781457928192\,a(n-10) - 40751378221934631192876810240\,a(n-11) - 5757910579286783501424165650432\,a(n-12) + 721053031162241165678293693759488\,a(n-13) - 13066308561852474555927268289413120\,a(n-14) - 1348009507077897319716382214971195392\,a(n-15) + 58039494284702303231713887968022233088\,a(n-16) - 3987683987354747618711421180841033728\,a(n-17) - 29604565922121646321313590846563834396672\,a(n-18) + 348449143727040986586495598010130648530944\,a(n-19)
\]
for every $n>19$.
\end{theorem}

\begin{proof}
The vector $w=q(\widehat{M})\mathbf{1}$ was formed by $19$ matrix--vector products in
...
$n=19+1$ onwards and the run continued until the working vector was identically zero, which
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223268.
