...
\title{The cross-base identity for OEIS A125434, proved}
...
\begin{abstract}
OEIS A125434 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125434 is ``Number of base 22 circular n-digit numbers with adjacent digits differing by 7 or less.''. It has offset $0$ and begins
\[
1, 22, 274, 2878, 34882, 431782, 5461618, 69940774,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:36:33, revision 12)
...
the base is $22$ and the permitted difference is $d=7$, so the claim is that
\[
a_{22}(n)-a_{21}(n)\;=\;F_{7}(n)
\qquad\text{for every } n \text{ with } 7\lfloor n/2\rfloor+1\le22,
\]
...
at base $22$ reproduces all $17$ terms A125434 publishes, and at base $21$ all the
...
polynomial. In particular $a_{22}(n)-a_{21}(n)=F_{7}(n)$ for $1\le n\le7$, which
...
First, the model reproduces all $17$ terms A125434 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{7}(22,n)$ & $T_{7}(21,n)$ & $F_{7}(n)$ \\ \hline
1 & 22 & 21 & 1 \\
2 & 274 & 259 & 15 \\
3 & 2878 & 2709 & 169 \\
4 & 34882 & 32627 & 2255 \\
5 & 431782 & 401401 & 30381 \\
6 & 5461618 & 5043115 & 418503 \\
7 & 69940774 & 64108009 & 5832765 \\
\end{tabular}
\end{center}
