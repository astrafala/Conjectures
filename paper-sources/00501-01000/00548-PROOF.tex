...
\title{The empirical recurrence for OEIS A267816, proved from an exact model}
...
\begin{abstract}
OEIS A267816 carries an empirical recurrence of order $3$ contributed by Colin Barker. It is true, and it is
...
OEIS A267816 is ``Decimal representation of the n-th iteration of the "Rule 221" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 3, 23, 111, 479, 1983, 8063, 32511,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 22 2016 and Apr 16 2019: (Start) a(n) = 7*a(n-1)-14*a(n-2)+8*a(n-3) for n>3.
\end{quote}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267816.
