...
\title{The empirical recurrence for OEIS A281052, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A281052 imposes three things at once: a condition on each cell that reaches one row up and
...
OEIS A281052 is ``Number of nX4 0..1 arrays with no element equal to more than one of its horizontal and antidiagonal neighbors, with the exception of exactly two elements, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
1, 34, 239, 1022, 3416, 10112, 27635, 71419,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 13 2017 16:55:53, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 3\,a(n-2) - 11\,a(n-3) - 9\,a(n-4) + 18\,a(n-5) + 17\,a(n-6) - 12\,a(n-7) - 15\,a(n-8) + 3\,a(n-9) + 6\,a(n-10) - a(n-12)
\end{equation}
for all $n>14$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A281052.
