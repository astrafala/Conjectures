...
\title{The empirical recurrence for OEIS A221825, proved by transfer matrix}
...
\begin{abstract}
OEIS A221825 counts the distinct OCCUPANCY arrays obtained when every cell of an $n\times3$ grid
...
one, on $S=761$ states, after which the conjectured recurrence is settled by a finite exact
computation.
\end{abstract}
...
OEIS A221825 is ``Number of nX3 arrays of occupancy after each element moves to some horizontal, vertical or antidiagonal neighbor, without 2-loops or left turns.''. It has offset $1$ and begins
\[
0, 16, 202, 2930, 41618, 592601, 8434490, 120053263,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 20:01:58, revision 9) this is still
...
$S=761$ reachable sets. In particular $a$ is $C$-finite.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221825.
