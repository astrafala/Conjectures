...
\title{The empirical recurrence for OEIS A221379, proved by transfer matrix}
...
\begin{abstract}
OEIS A221379 counts the distinct OCCUPANCY arrays obtained when every cell of an $n\times5$ grid
...
determinising the machine that emits the occupancy row by row turns it into one, on $S=239$
...
OEIS A221379 is ``Number of nX5 arrays of occupancy after each element moves to some horizontal or antidiagonal neighbor, with every occupancy equal to zero or two.''. It has offset $1$ and begins
\[
0, 8, 0, 189, 0, 5040, 0, 134521,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 19:35:14, revision 11) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

Every cell of an $n\times5$ grid holds one token. Each token moves by one of the offsets
\[
(-1,1), (0,-1), (0,1), (1,-1),
\]
...
\]
There are $S=239$ reachable sets. In particular $a$ is $C$-finite.
...
\begin{theorem}
\[
a(n)\;=\;42\,a(n-2) - 497\,a(n-4) + 2546\,a(n-6) - 6335\,a(n-8) + 7910\,a(n-10) - 5003\,a(n-12) + 1526\,a(n-14) - 196\,a(n-16) + 8\,a(n-18)
\]
for every $n>18$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221379.
