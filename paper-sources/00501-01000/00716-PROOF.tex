...
\title{The cross-base identity for OEIS A124956, proved}
...
\begin{abstract}
OEIS A124956 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A124956 is ``Number of base 28 circular n-digit numbers with adjacent digits differing by 2 or less.''. It has offset $0$ and begins
\[
1, 28, 134, 502, 2202, 9718, 44000, 201628,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:18:13, revision 16)
...
the base is $28$ and the permitted difference is $d=2$, so the claim is that
\[
a_{28}(n)-a_{27}(n)\;=\;F_{2}(n)
\qquad\text{for every } n \text{ with } 2\lfloor n/2\rfloor+1\le28,
\]
...
at base $28$ reproduces all $21$ terms A124956 publishes, and at base $27$ all the
...
polynomial. In particular $a_{28}(n)-a_{27}(n)=F_{2}(n)$ for $1\le n\le27$, which
...
First, the model reproduces all $21$ terms A124956 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{2}(28,n)$ & $T_{2}(27,n)$ & $F_{2}(n)$ \\ \hline
1 & 28 & 27 & 1 \\
2 & 134 & 129 & 5 \\
3 & 502 & 483 & 19 \\
4 & 2202 & 2117 & 85 \\
5 & 9718 & 9337 & 381 \\
6 & 44000 & 42249 & 1751 \\
7 & 201628 & 193493 & 8135 \\
8 & 933682 & 895517 & 38165 \\
\end{tabular}
\end{center}
