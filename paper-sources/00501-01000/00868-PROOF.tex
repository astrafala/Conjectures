...
\title{Recovering the unwritten recurrences of the table OEIS A251515}
...
\begin{abstract}
OEIS A251515 is a two-dimensional table $T(n,k)$ whose empirical recurrences are, for several of
...
OEIS A251515 is ``T(n,k)=Number of (n+1)X(k+1) 0..4 arrays with every 2X2 subblock summing to a prime.''. It is read by antidiagonals and begins
\[
234, 2264, 2264, 21862, 45470, 21862, 211680, 915152,\ \dots
\]
The entry carries, among its empirical claims:
\begin{quote}\small
k=2: [order 35]
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:27:00, revision 6) these are still
...
\[
(c_1,\dots,c_{35})=(25,\ 462,\ -14590,\ -42265,\ 2910978,\ -3478794,\ -294784210,\ 909692634,\ 17416731052,\ -74831549442,\ -635489544134,\ 3398784783033,\ 14502751788871,\ -96063953129051,\ -200128268354324,\ 1770329159309660,\ 1413696179854848,\ -21688578534719868,\ 474179661910776,\ 176953098557122256,\ -102811657229884128,\ -946447289145188000,\ 936421248879236608,\ 3191547698036515584,\ -4219264554048107008,\ -6271068576793766400,\ 10431637502838784000,\ 6027014589240266752,\ -13554429422684160000,\ -1359558313948348416,\ 8097473146466598912,\ -1175451099051589632,\ -1511875462953959424,\ 283461546053468160,\ 12892020796293120).
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251515.
