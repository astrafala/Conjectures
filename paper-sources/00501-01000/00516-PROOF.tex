...
\title{The empirical recurrence for OEIS A187590, proved from an exact model}
...
\begin{abstract}
OEIS A187590 carries an empirical recurrence of order $3$. It is true, and it is
...
OEIS A187590 is ``Number of 7-step E, S, NW and NE-moving king's tours on an n X n board summed over all starting positions.''. It has offset $1$ and begins
\[
0, 0, 78, 1708, 7666, 19104, 35832, 57592,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2516*n\^{}2 - 15980*n + 24408 for n>5. a(n) = 3*a(n-1) - 3*a(n-2) + a(n-3) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 24 2018 15:42:14, revision 11)
...
SHAPE when one is a translate of the other. There are exactly $2516$ shapes: self-avoiding
...
Write $w^\ast$ for the largest bounding-box side over all $2516$ shapes. Once $n\ge w^\ast$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A187590.
