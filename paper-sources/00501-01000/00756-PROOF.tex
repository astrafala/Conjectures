...
\title{The cross-base identity for OEIS A125409, proved}
...
\begin{abstract}
OEIS A125409 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125409 is ``Number of base 21 circular n-digit numbers with adjacent digits differing by 6 or less.''. It has offset $0$ and begins
\[
1, 21, 231, 2121, 22547, 244601, 2714271, 30517333,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:06:33, revision 14)
...
the base is $21$ and the permitted difference is $d=6$, so the claim is that
\[
a_{21}(n)-a_{20}(n)\;=\;F_{6}(n)
\qquad\text{for every } n \text{ with } 6\lfloor n/2\rfloor+1\le21,
\]
...
at base $21$ reproduces all $18$ terms A125409 publishes, and at base $20$ all the
...
polynomial. In particular $a_{21}(n)-a_{20}(n)=F_{6}(n)$ for $1\le n\le7$, which
...
First, the model reproduces all $18$ terms A125409 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{6}(21,n)$ & $T_{6}(20,n)$ & $F_{6}(n)$ \\ \hline
1 & 21 & 20 & 1 \\
2 & 231 & 218 & 13 \\
3 & 2121 & 1994 & 127 \\
4 & 22547 & 21078 & 1469 \\
5 & 244601 & 227450 & 17151 \\
6 & 2714271 & 2509508 & 204763 \\
7 & 30517333 & 28044008 & 2473325 \\
\end{tabular}
\end{center}
