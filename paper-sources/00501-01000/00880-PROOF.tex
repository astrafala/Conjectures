...
\title{The cross-base identity for OEIS A126484, proved}
...
\begin{abstract}
OEIS A126484 carries an empirical identity, in two clauses, relating its counts to those of the
...
OEIS A126484 is ``Number of base 16 n-digit numbers with adjacent digits differing by three or less.''. It has offset $0$ and begins
\[
1, 16, 100, 644, 4188, 27384, 179612, 1180228,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:13:31, revision 12)
this is still recorded as empirical, and nothing on the entry records it as proved.

For this entry the base is $16$ and the permitted difference is $d=3$, so the first clause
claims $a_{16}(n)-a_{15}(n)=7^{\,n-1}$ whenever $3(n-1)+1\le16$, that is for
$1\le n\le6$, and the second claims $a_{16}(n)-a_{15}(n)=7^{\,n-1}-2$ at the single
$n$ with $3(n-1)=16$.
...
arithmetic, $L_{3}$ at base $16$ reproduces all $20$ terms A126484 publishes.
...
First, the model reproduces all $20$ terms A126484 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $L_{3}(16,n)$ & $L_{3}(15,n)$ & $7^{\,n-1}$ \\ \hline
1 & 16 & 15 & 1 \\
2 & 100 & 93 & 7 \\
3 & 644 & 595 & 49 \\
4 & 4188 & 3845 & 343 \\
5 & 27384 & 24983 & 2401 \\
6 & 179612 & 162805 & 16807 \\
\end{tabular}
\end{center}
