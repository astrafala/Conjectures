...
\title{The cross-base identity for OEIS A126479, proved}
...
\begin{abstract}
OEIS A126479 carries an empirical identity, in two clauses, relating its counts to those of the
...
OEIS A126479 is ``Number of base 11 n-digit numbers with adjacent digits differing by three or less.''. It has offset $0$ and begins
\[
1, 11, 65, 399, 2473, 15381, 95757, 596341,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:13:09, revision 15)
this is still recorded as empirical, and nothing on the entry records it as proved.

For this entry the base is $11$ and the permitted difference is $d=3$, so the first clause
claims $a_{11}(n)-a_{10}(n)=7^{\,n-1}$ whenever $3(n-1)+1\le11$, that is for
$1\le n\le4$, and the second claims $a_{11}(n)-a_{10}(n)=7^{\,n-1}-2$ at the single
$n$ with $3(n-1)=11$.
...
arithmetic, $L_{3}$ at base $11$ reproduces all $20$ terms A126479 publishes.
...
First, the model reproduces all $20$ terms A126479 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $L_{3}(11,n)$ & $L_{3}(10,n)$ & $7^{\,n-1}$ \\ \hline
1 & 11 & 10 & 1 \\
2 & 65 & 58 & 7 \\
3 & 399 & 350 & 49 \\
4 & 2473 & 2130 & 343 \\
