...
\title{The empirical recurrence for OEIS A221067, proved by transfer matrix}
...
\begin{abstract}
OEIS A221067 counts the distinct indicator arrays obtained from the $n\times3$ arrays over
...
indicator row by row turns it into one, on $S=509$ states, after which the conjectured
...
OEIS A221067 is ``Sum of neighbor maps: number of nX3 binary arrays indicating the locations of corresponding elements equal to the sum mod 4 of their king-move neighbors in a random 0..3 nX3 array.''. It has offset $1$ and begins
\[
8, 20, 512, 4096, 26976, 262144, 2097152, 16401664,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 19:17:19, revision 8) this is still
...
\]
There are $S=509$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite. Note
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-1) + 160\,a(n-3) - 1280\,a(n-4) - 11200\,a(n-6) + 89600\,a(n-7) + 453632\,a(n-9) - 3629056\,a(n-10) - 11841536\,a(n-12) + 94732288\,a(n-13) + 209715200\,a(n-15) - 1677721600\,a(n-16) - 2577661952\,a(n-18) + 20621295616\,a(n-19) + 22041067520\,a(n-21) - 176328540160\,a(n-22) - 128781910016\,a(n-24) + 1030255280128\,a(n-25) + 490700013568\,a(n-27) - 3925600108544\,a(n-28) - 1099511627776\,a(n-30) + 8796093022208\,a(n-31) + 1099511627776\,a(n-33) - 8796093022208\,a(n-34)
\]
for every $n>34$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221067.
