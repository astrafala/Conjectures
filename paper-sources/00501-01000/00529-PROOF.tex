...
\title{The empirical recurrence for OEIS A187298, proved from an exact model}
...
\begin{abstract}
OEIS A187298 carries an empirical recurrence of order $3$. It is true, and it is
...
OEIS A187298 is ``Number of 3-step one space leftwards or up, two space rightwards or down asymmetric rook's tours on an n X n board summed over all starting positions.''. It has offset $1$ and begins
\[
0, 2, 36, 98, 198, 330, 494, 690,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 16*n\^{}2 - 44*n + 18 for n>3. a(n) = 3*a(n-1) - 3*a(n-2) + a(n-3) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 23 2018 08:37:43, revision 11)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A187298.
