...
\title{The empirical recurrence for OEIS A187289, proved from an exact model}
...
\begin{abstract}
OEIS A187289 carries an empirical recurrence of order $3$. It is true, and it is
...
OEIS A187289 is ``Number of 4-step one or two space at a time rook's tours on an n X n board summed over all starting positions.''. It has offset $1$ and begins
\[
0, 8, 288, 1256, 3084, 5712, 9120, 13288,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 380*n\^{}2 - 1532*n + 1224 for n>5. a(n) = 3*a(n-1) - 3*a(n-2) + a(n-3) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 22 2018 17:48:27, revision 10)
...
SHAPE when one is a translate of the other. There are exactly $380$ shapes: self-avoiding
...
Write $w^\ast$ for the largest bounding-box side over all $380$ shapes. Once $n\ge w^\ast$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A187289.
