...
\title{The empirical recurrence for OEIS A279581, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A279581 imposes three things at once: a condition on each cell that reaches one column up and
...
OEIS A279581 is ``Number of 2 X n 0..2 arrays with no element equal to a strict majority of its horizontal and antidiagonal neighbors, with the exception of exactly one element, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
0, 4, 36, 304, 2212, 15428, 103648, 680052,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 12*a(n-1) - 36*a(n-2) - 22*a(n-3) + 140*a(n-4) - 48*a(n-5) - 121*a(n-6) + 88*a(n-7) - 16*a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 11 2019 05:36:20, revision 7) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A279581.
