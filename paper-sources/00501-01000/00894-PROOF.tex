...
\title{A cross-alphabet identity for bounded-difference square arrays: OEIS A125538}
...
\begin{abstract}
OEIS A125538 carries an empirical identity relating its counts to those of the same problem over an
...
OEIS A125538 is ``Number of n X n arrays with entries in 1..7 in which adjacent entries differ by 5 or less (adjacent means in x or y directions).''. It has offset $0$ and begins
\[
1, 7, 2067, 26587217, 14749946711237, 353372896021348132827, 365544303118982657966348922687, 16327402400665015344535793527620336180117,\ \dots
\]
...
most $d$. The entry is $T(7,5,n)$, and the conjecture is
\[
...
First, the count $T(7,5,n)$ was computed by an independent row-pair dynamic program and
reproduces the $4$ published terms of A125538 that the computation reaches,
...
\[
\begin{array}{rrrr}
n & T(7+1,5,n) & T(7,5,n) & F(n,5) \\ \hline
1 & 8 & 7 & 1 \\
2 & 2902 & 2067 & 891 \\
\end{array}
\]
...
\url{https://oeis.org}, 2026. Sequence A125538: \url{https://oeis.org/A125538}.
\end{thebibliography}
