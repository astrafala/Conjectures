...
\title{The empirical recurrence for OEIS A229604, proved by counting defective colourings}
...
\begin{abstract}
OEIS A229604 counts the colourings of an array with $K=3$ colours that are proper except at
...
order $21$ contributed by R.~H.~Hardin follows from a finite exact computation.
\end{abstract}
...
OEIS A229604 is ``Number of defective 3-colorings of an n X 6 0..2 array connected horizontally and vertically with exactly two mistakes, and colors introduced in row-major 0..2 order.''. It has offset $1$ and begins
\[
40, 3924, 131345, 3476928, 82613904, 1840258874, 39229935270, 809714005005,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 27 2021 21:28:21, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;90\,a(n-1) - 3573\,a(n-2) + 83214\,a(n-3) - 1278486\,a(n-4) + 13836015\,a(n-5) - 110021385\,a(n-6) + 661896144\,a(n-7) - 3076398702\,a(n-8) + 11214272853\,a(n-9) - 32398609896\,a(n-10) + 74677395474\,a(n-11) - 137758028106\,a(n-12) + 203308881255\,a(n-13) - 239066083215\,a(n-14) + 222060410955\,a(n-15) - 160604595216\,a(n-16) + 88409012652\,a(n-17) - 35729023024\,a(n-18) + 9979813584\,a(n-19) - 1718948736\,a(n-20) + 137388096\,a(n-21)
\end{equation}
for all $n>23$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A229604.
