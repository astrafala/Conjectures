...
\title{The cross-base identity for OEIS A125369, proved}
...
\begin{abstract}
OEIS A125369 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125369 is ``Number of base 32 circular n-digit numbers with adjacent digits differing by 4 or less.''. It has offset $0$ and begins
\[
1, 32, 268, 1772, 13748, 108132, 871228, 7113068,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:28:58, revision 11)
...
the base is $32$ and the permitted difference is $d=4$, so the claim is that
\[
a_{32}(n)-a_{31}(n)\;=\;F_{4}(n)
\qquad\text{for every } n \text{ with } 4\lfloor n/2\rfloor+1\le32,
\]
...
at base $32$ reproduces all $19$ terms A125369 publishes, and at base $31$ all the
...
polynomial. In particular $a_{32}(n)-a_{31}(n)=F_{4}(n)$ for $1\le n\le15$, which
...
First, the model reproduces all $19$ terms A125369 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{4}(32,n)$ & $T_{4}(31,n)$ & $F_{4}(n)$ \\ \hline
1 & 32 & 31 & 1 \\
2 & 268 & 259 & 9 \\
3 & 1772 & 1711 & 61 \\
4 & 13748 & 13259 & 489 \\
5 & 108132 & 104181 & 3951 \\
6 & 871228 & 838567 & 32661 \\
7 & 7113068 & 6839941 & 273127 \\
8 & 58698164 & 56392139 & 2306025 \\
\end{tabular}
\end{center}
