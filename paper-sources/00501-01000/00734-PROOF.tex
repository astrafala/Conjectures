...
\title{The cross-base identity for OEIS A125348, proved}
...
\begin{abstract}
OEIS A125348 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125348 is ``Number of base 11 circular n-digit numbers with adjacent digits differing by 4 or less.''. It has offset $0$ and begins
\[
1, 11, 79, 491, 3479, 25161, 185353, 1377877,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:03:36, revision 13)
...
the base is $11$ and the permitted difference is $d=4$, so the claim is that
\[
a_{11}(n)-a_{10}(n)\;=\;F_{4}(n)
\qquad\text{for every } n \text{ with } 4\lfloor n/2\rfloor+1\le11,
\]
...
at base $11$ reproduces all $20$ terms A125348 publishes, and at base $10$ all the
...
polynomial. In particular $a_{11}(n)-a_{10}(n)=F_{4}(n)$ for $1\le n\le5$, which
...
First, the model reproduces all $20$ terms A125348 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{4}(11,n)$ & $T_{4}(10,n)$ & $F_{4}(n)$ \\ \hline
1 & 11 & 10 & 1 \\
2 & 79 & 70 & 9 \\
3 & 491 & 430 & 61 \\
4 & 3479 & 2990 & 489 \\
