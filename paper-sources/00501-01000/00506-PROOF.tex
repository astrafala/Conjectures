...
\title{The empirical recurrence for OEIS A187851, proved from an exact model}
...
\begin{abstract}
OEIS A187851 carries an empirical recurrence of order $3$. It is true, and it is
...
OEIS A187851 is ``Number of 3-step king-knight's tours (piece capable of both kinds of moves) on an n X n board summed over all starting positions.''. It has offset $1$ and begins
\[
0, 24, 304, 1056, 2312, 4048, 6264, 8960,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 240*n\^{}2 - 904*n + 832 for n>3. a(n) = 3*a(n-1) - 3*a(n-2) + a(n-3) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 26 2018 08:38:59, revision 12)
...
SHAPE when one is a translate of the other. There are exactly $240$ shapes: self-avoiding
...
Write $w^\ast$ for the largest bounding-box side over all $240$ shapes. Once $n\ge w^\ast$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A187851.
