...
\title{The cross-base identity for OEIS A124857, proved}
...
\begin{abstract}
OEIS A124857 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A124857 is ``Number of base 11 circular n-digit numbers with adjacent digits differing by 2 or less.''. It has offset $0$ and begins
\[
1, 11, 49, 179, 757, 3241, 14233, 63333,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:15:42, revision 16)
...
the base is $11$ and the permitted difference is $d=2$, so the claim is that
\[
a_{11}(n)-a_{10}(n)\;=\;F_{2}(n)
\qquad\text{for every } n \text{ with } 2\lfloor n/2\rfloor+1\le11,
\]
...
at base $11$ reproduces all $22$ terms A124857 publishes, and at base $10$ all the
...
polynomial. In particular $a_{11}(n)-a_{10}(n)=F_{2}(n)$ for $1\le n\le11$, which
...
First, the model reproduces all $22$ terms A124857 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{2}(11,n)$ & $T_{2}(10,n)$ & $F_{2}(n)$ \\ \hline
1 & 11 & 10 & 1 \\
2 & 49 & 44 & 5 \\
3 & 179 & 160 & 19 \\
4 & 757 & 672 & 85 \\
