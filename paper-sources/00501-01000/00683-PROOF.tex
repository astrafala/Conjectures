...
\title{Recovering the unwritten recurrences of the table OEIS A234208}
...
\begin{abstract}
OEIS A234208 is a two-dimensional table $T(n,k)$ whose empirical recurrences are, for several of
...
OEIS A234208 is ``T(n,k)=Number of (n+1)X(k+1) 0..5 arrays with every 2X2 subblock having the sum of the absolute values of all six edge and diagonal differences equal to 15.''. It is read by antidiagonals and begins
\[
104, 440, 440, 1792, 1732, 1792, 7584, 6644,\ \dots
\]
The entry carries, among its empirical claims:
\begin{quote}\small
k=2: [order 35]
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 09:15:58, revision 6) these are still
...
\[
(c_1,\dots,c_{35})=(10,\ 35,\ -651,\ 419,\ 16705,\ -37770,\ -216562,\ 772034,\ 1449450,\ -8226531,\ -3432396,\ 53203704,\ -19299470,\ -221565837,\ 197415839,\ 605551158,\ -820429189,\ -1065993213,\ 2055641766,\ 1094316298,\ -3372056546,\ -351098112,\ 3691267180,\ -636122040,\ -2662114168,\ 998183888,\ 1207919856,\ -667852864,\ -308559296,\ 239536384,\ 30592768,\ -43737088,\ 2252800,\ 3080192,\ -458752).
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234208.
