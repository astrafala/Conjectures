...
\title{The empirical recurrence for OEIS A279582, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A279582 imposes three things at once: a condition on each cell that reaches one column up and
one column down; a global budget allowing exactly one cell to
...
OEIS A279582 is ``Number of 3Xn 0..2 arrays with no element equal to a strict majority of its horizontal and antidiagonal neighbors, with the exception of exactly one element, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
0, 40, 944, 20776, 406200, 7630156, 138602548, 2461556084,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 15 2016 11:08:15, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;30\,a(n-1) - 193\,a(n-2) - 806\,a(n-3) + 5244\,a(n-4) - 3702\,a(n-5) - 44457\,a(n-6) + 168874\,a(n-7) - 44225\,a(n-8) - 677108\,a(n-9) + 1762660\,a(n-10) - 3494200\,a(n-11) + 2285580\,a(n-12) + 7892104\,a(n-13) - 49295732\,a(n-14) + 85826880\,a(n-15) + 16178028\,a(n-16) + 39772848\,a(n-17) - 8887104\,a(n-18) - 709316944\,a(n-19) - 206842096\,a(n-20) + 1139690528\,a(n-21) + 669113648\,a(n-22) + 469494336\,a(n-23) - 502677568\,a(n-24) - 1400698624\,a(n-25) - 681275392\,a(n-26) - 151843840\,a(n-27) + 134114304\,a(n-28) + 595562496\,a(n-29) + 3567616\,a(n-30) + 175964160\,a(n-31) - 113377280\,a(n-32) - 26214400\,a(n-34)
\end{equation}
for all $n>35$.
...
consecutive columns together with a running count $v\in\{0,1,\dots,1\}$, and a count that
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A279582.
