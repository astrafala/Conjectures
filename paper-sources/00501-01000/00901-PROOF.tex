...
\title{The cross-base identity for OEIS A126419, proved}
...
\begin{abstract}
OEIS A126419 carries an empirical identity, in two clauses, relating its counts to those of the
...
OEIS A126419 is ``Number of base 32 n-digit numbers with adjacent digits differing by two or less.''. It has offset $0$ and begins
\[
1, 32, 154, 750, 3668, 17986, 88348, 434524,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:47:46, revision 7)
this is still recorded as empirical, and nothing on the entry records it as proved.

For this entry the base is $32$ and the permitted difference is $d=2$, so the first clause
claims $a_{32}(n)-a_{31}(n)=5^{\,n-1}$ whenever $2(n-1)+1\le32$, that is for
$1\le n\le16$, and the second claims $a_{32}(n)-a_{31}(n)=5^{\,n-1}-2$ at the single
$n$ with $2(n-1)=32$.
...
arithmetic, $L_{2}$ at base $32$ reproduces all $21$ terms A126419 publishes.
...
First, the model reproduces all $21$ terms A126419 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $L_{2}(32,n)$ & $L_{2}(31,n)$ & $5^{\,n-1}$ \\ \hline
1 & 32 & 31 & 1 \\
2 & 154 & 149 & 5 \\
3 & 750 & 725 & 25 \\
4 & 3668 & 3543 & 125 \\
5 & 17986 & 17361 & 625 \\
6 & 88348 & 85223 & 3125 \\
7 & 434524 & 418899 & 15625 \\
8 & 2139230 & 2061105 & 78125 \\
\end{tabular}
\end{center}
...
Third, the second clause was evaluated at its own index. For this entry the second clause bites at $n=17$, where $b=32=2(n-1)$: there $L_{2}(32,17)-L_{2}(31,17)=152587890623$ and $5^{16}-2=152587890623$.

\section*{References}
\begin{enumerate}
\item The OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences},
\url{https://oeis.org/A126419}.
\end{enumerate}
