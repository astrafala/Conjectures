...
\title{The cross-base identity for OEIS A126491, proved}
...
\begin{abstract}
OEIS A126491 carries an empirical identity, in two clauses, relating its counts to those of the
...
OEIS A126491 is ``Number of base 23 n-digit numbers with adjacent digits differing by three or less.''. It has offset $0$ and begins
\[
1, 23, 149, 987, 6589, 44191, 297261, 2003755,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:14:10, revision 9)
this is still recorded as empirical, and nothing on the entry records it as proved.

For this entry the base is $23$ and the permitted difference is $d=3$, so the first clause
claims $a_{23}(n)-a_{22}(n)=7^{\,n-1}$ whenever $3(n-1)+1\le23$, that is for
$1\le n\le8$, and the second claims $a_{23}(n)-a_{22}(n)=7^{\,n-1}-2$ at the single
$n$ with $3(n-1)=23$.
...
arithmetic, $L_{3}$ at base $23$ reproduces all $20$ terms A126491 publishes.
...
First, the model reproduces all $20$ terms A126491 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $L_{3}(23,n)$ & $L_{3}(22,n)$ & $7^{\,n-1}$ \\ \hline
1 & 23 & 22 & 1 \\
2 & 149 & 142 & 7 \\
3 & 987 & 938 & 49 \\
4 & 6589 & 6246 & 343 \\
5 & 44191 & 41790 & 2401 \\
6 & 297261 & 280454 & 16807 \\
7 & 2003755 & 1886106 & 117649 \\
8 & 13527217 & 12703674 & 823543 \\
\end{tabular}
\end{center}
