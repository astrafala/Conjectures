...
\title{The empirical recurrence for OEIS A229682, proved by counting defective colourings}
...
\begin{abstract}
OEIS A229682 counts the colourings of an array with $K=3$ colours that are proper except at
...
OEIS A229682 is ``Number of defective 3-colorings of an n X 5 0..2 array connected diagonally and antidiagonally with exactly two mistakes, and colors introduced in row-major 0..2 order.''. It has offset $1$ and begins
\[
0, 2688, 108000, 2700432, 58038768, 1138164048, 21063718224, 373936700880,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 28 2021 01:22:34, revision 12) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;45\,a(n-1) - 675\,a(n-2) + 2565\,a(n-3) + 25272\,a(n-4) - 211410\,a(n-5) + 3805380\,a(n-7) - 8188128\,a(n-8) - 14959080\,a(n-9) + 70858800\,a(n-10) - 85030560\,a(n-11) + 34012224\,a(n-12)
\end{equation}
for all $n>13$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A229682.
