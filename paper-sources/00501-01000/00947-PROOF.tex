...
\title{The empirical recurrence for OEIS A222094, proved by transfer matrix}
...
\begin{abstract}
OEIS A222094 counts the distinct OCCUPANCY arrays obtained when every cell of an $n\times2$ grid
...
one, on $S=190$ states, after which the conjectured recurrence is settled by a finite exact
computation.
\end{abstract}
...
OEIS A222094 is ``Number of 2 X n arrays of occupancy after each element stays put or moves to some horizontal, vertical or antidiagonal neighbor, without move-in move-out left turns.''. It has offset $1$ and begins
\[
3, 31, 306, 3014, 29671, 292017, 2873693, 28278630,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 17*a(n-1) - 90*a(n-2) + 217*a(n-3) - 258*a(n-4) + 156*a(n-5) - 44*a(n-6) + 4*a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 15 2018 12:37:46, revision 8) this is still
...
$S=190$ reachable sets. In particular $a$ is $C$-finite.
...
\begin{theorem}
\[
a(n)\;=\;17\,a(n-1) - 90\,a(n-2) + 217\,a(n-3) - 258\,a(n-4) + 156\,a(n-5) - 44\,a(n-6) + 4\,a(n-7)
\]
for every $n>7$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A222094.
