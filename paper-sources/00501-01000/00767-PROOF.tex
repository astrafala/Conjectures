...
\title{The cross-base identity for OEIS A125436, proved}
...
\begin{abstract}
OEIS A125436 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125436 is ``Number of base 24 circular n-digit numbers with adjacent digits differing by 7 or less.''. It has offset $0$ and begins
\[
1, 24, 304, 3216, 39392, 492544, 6298624, 81606304,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:36:44, revision 12)
...
the base is $24$ and the permitted difference is $d=7$, so the claim is that
\[
a_{24}(n)-a_{23}(n)\;=\;F_{7}(n)
\qquad\text{for every } n \text{ with } 7\lfloor n/2\rfloor+1\le24,
\]
...
at base $24$ reproduces all $17$ terms A125436 publishes, and at base $23$ all the
...
polynomial. In particular $a_{24}(n)-a_{23}(n)=F_{7}(n)$ for $1\le n\le7$, which
...
First, the model reproduces all $17$ terms A125436 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{7}(24,n)$ & $T_{7}(23,n)$ & $F_{7}(n)$ \\ \hline
1 & 24 & 23 & 1 \\
2 & 304 & 289 & 15 \\
3 & 3216 & 3047 & 169 \\
4 & 39392 & 37137 & 2255 \\
5 & 492544 & 462163 & 30381 \\
6 & 6298624 & 5880121 & 418503 \\
7 & 81606304 & 75773539 & 5832765 \\
\end{tabular}
\end{center}
