...
\title{The empirical recurrence for OEIS A220939, proved by transfer matrix}
...
\begin{abstract}
OEIS A220939 counts the distinct OCCUPANCY arrays obtained when every cell of an $n\times2$ grid
...
determinising the machine that emits the occupancy row by row turns it into one, on $S=189$
...
OEIS A220939 is ``Number of n X 2 arrays of occupancy after each element moves to some horizontal, vertical or antidiagonal neighbor.''. It has offset $1$ and begins
\[
1, 20, 208, 2056, 20483, 203905, 2029453, 20199560,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 13*a(n-1) - 32*a(n-2) + 22*a(n-3) - 62*a(n-4) + 92*a(n-5) - 33*a(n-6) + a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 03 2018 08:12:06, revision 9) this is still
...
\]
There are $S=189$ reachable sets. In particular $a$ is $C$-finite.
...
\begin{theorem}
\[
a(n)\;=\;13\,a(n-1) - 32\,a(n-2) + 22\,a(n-3) - 62\,a(n-4) + 92\,a(n-5) - 33\,a(n-6) + a(n-7)
\]
for every $n>7$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A220939.
