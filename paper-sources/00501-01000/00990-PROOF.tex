...
\title{The cross-base identity for OEIS A126538, proved}
...
\begin{abstract}
OEIS A126538 carries an empirical identity, in two clauses, relating its counts to those of the
...
OEIS A126538 is ``Number of base 17 n-digit numbers with adjacent digits differing by five or less.''. It has offset $0$ and begins
\[
1, 17, 157, 1507, 14607, 142041, 1382455, 13458785,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:17:50, revision 15)
this is still recorded as empirical, and nothing on the entry records it as proved.

For this entry the base is $17$ and the permitted difference is $d=5$, so the first clause
claims $a_{17}(n)-a_{16}(n)=11^{\,n-1}$ whenever $5(n-1)+1\le17$, that is for
$1\le n\le4$, and the second claims $a_{17}(n)-a_{16}(n)=11^{\,n-1}-2$ at the single
$n$ with $5(n-1)=17$.
...
arithmetic, $L_{5}$ at base $17$ reproduces all $18$ terms A126538 publishes.
...
First, the model reproduces all $18$ terms A126538 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $L_{5}(17,n)$ & $L_{5}(16,n)$ & $11^{\,n-1}$ \\ \hline
1 & 17 & 16 & 1 \\
2 & 157 & 146 & 11 \\
3 & 1507 & 1386 & 121 \\
4 & 14607 & 13276 & 1331 \\
