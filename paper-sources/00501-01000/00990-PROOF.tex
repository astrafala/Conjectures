...
\title{The empirical recurrence for OEIS A264295, proved by transfer matrix}
...
\begin{abstract}
OEIS A264295 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=4$ rows in which
...
\[
5, 8, 89, 192, 1413, 4352, 24781, 90112,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 11 2015 07:36:36, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) + 2\,a(n-2) - 34\,a(n-3) + 79\,a(n-4) - 103\,a(n-5) + 60\,a(n-6) - 220\,a(n-7) + 610\,a(n-8) - 142\,a(n-9) - 1276\,a(n-10) + 1276\,a(n-11) + 142\,a(n-12) - 610\,a(n-13) + 220\,a(n-14) - 60\,a(n-15) + 103\,a(n-16) - 79\,a(n-17) + 34\,a(n-18) - 2\,a(n-19) - 5\,a(n-20) + a(n-21)
\]
for every $n>19$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264295.
