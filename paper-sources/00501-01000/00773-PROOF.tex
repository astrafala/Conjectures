...
\title{The cross-base identity for OEIS A125442, proved}
...
\begin{abstract}
OEIS A125442 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125442 is ``Number of base 30 circular n-digit numbers with adjacent digits differing by 7 or less.''. It has offset $0$ and begins
\[
1, 30, 394, 4230, 52922, 674830, 8809642, 116602894,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:37:18, revision 12)
...
the base is $30$ and the permitted difference is $d=7$, so the claim is that
\[
a_{30}(n)-a_{29}(n)\;=\;F_{7}(n)
\qquad\text{for every } n \text{ with } 7\lfloor n/2\rfloor+1\le30,
\]
...
at base $30$ reproduces all $17$ terms A125442 publishes, and at base $29$ all the
...
polynomial. In particular $a_{30}(n)-a_{29}(n)=F_{7}(n)$ for $1\le n\le9$, which
...
First, the model reproduces all $17$ terms A125442 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{7}(30,n)$ & $T_{7}(29,n)$ & $F_{7}(n)$ \\ \hline
1 & 30 & 29 & 1 \\
2 & 394 & 379 & 15 \\
3 & 4230 & 4061 & 169 \\
4 & 52922 & 50667 & 2255 \\
5 & 674830 & 644449 & 30381 \\
6 & 8809642 & 8391139 & 418503 \\
7 & 116602894 & 110770129 & 5832765 \\
8 & 1559751802 & 1477678507 & 82073295 \\
\end{tabular}
\end{center}
