...
\title{A cross-alphabet identity for bounded-difference square arrays: OEIS A125535}
...
\begin{abstract}
OEIS A125535 carries an empirical identity relating its counts to those of the same problem over an
...
OEIS A125535 is ``Number of n X n arrays with entries in 1..6 in which adjacent entries differ by 3 or less (adjacent means in x or y directions).''. It has offset $0$ and begins
\[
1, 6, 694, 1842302, 106627685414, 135334709216482502, 3763490062900640355493914, 2293235289704399729849626764238522,\ \dots
\]
...
this is still recorded as empirical.
...
most $d$. The entry is $T(6,3,n)$, and the conjecture is
\[
...
First, the count $T(6,3,n)$ was computed by an independent row-pair dynamic program and
reproduces the $4$ published terms of A125535 that the computation reaches,
...
\[
\begin{array}{rrrr}
n & T(6+1,3,n) & T(6,3,n) & F(n,3) \\ \hline
1 & 7 & 6 & 1 \\
2 & 925 & 694 & 231 \\
\end{array}
\]
...
\url{https://oeis.org}, 2026. Sequence A125535: \url{https://oeis.org/A125535}.
\end{thebibliography}
