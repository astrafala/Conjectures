...
\title{The cross-base identity for OEIS A125401, proved}
...
\begin{abstract}
OEIS A125401 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125401 is ``Number of base 13 circular n-digit numbers with adjacent digits differing by 6 or less.''. It has offset $0$ and begins
\[
1, 13, 127, 1105, 10795, 107393, 1079611, 10895625,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:05:49, revision 14)
...
the base is $13$ and the permitted difference is $d=6$, so the claim is that
\[
a_{13}(n)-a_{12}(n)\;=\;F_{6}(n)
\qquad\text{for every } n \text{ with } 6\lfloor n/2\rfloor+1\le13,
\]
...
at base $13$ reproduces all $18$ terms A125401 publishes, and at base $12$ all the
...
polynomial. In particular $a_{13}(n)-a_{12}(n)=F_{6}(n)$ for $1\le n\le5$, which
...
First, the model reproduces all $18$ terms A125401 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{6}(13,n)$ & $T_{6}(12,n)$ & $F_{6}(n)$ \\ \hline
1 & 13 & 12 & 1 \\
2 & 127 & 114 & 13 \\
3 & 1105 & 978 & 127 \\
4 & 10795 & 9326 & 1469 \\
5 & 107393 & 90242 & 17151 \\
\end{tabular}
\end{center}
