...
\title{The cross-base identity for OEIS A126514, proved}
...
\begin{abstract}
OEIS A126514 carries an empirical identity, in two clauses, relating its counts to those of the
...
OEIS A126514 is ``Number of base 19 n-digit numbers with adjacent digits differing by four or less.''. It has offset $0$ and begins
\[
1, 19, 151, 1239, 10271, 85611, 715649, 5991499,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:15:58, revision 11)
this is still recorded as empirical, and nothing on the entry records it as proved.

For this entry the base is $19$ and the permitted difference is $d=4$, so the first clause
claims $a_{19}(n)-a_{18}(n)=9^{\,n-1}$ whenever $4(n-1)+1\le19$, that is for
$1\le n\le5$, and the second claims $a_{19}(n)-a_{18}(n)=9^{\,n-1}-2$ at the single
$n$ with $4(n-1)=19$.
...
arithmetic, $L_{4}$ at base $19$ reproduces all $19$ terms A126514 publishes.
...
First, the model reproduces all $19$ terms A126514 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $L_{4}(19,n)$ & $L_{4}(18,n)$ & $9^{\,n-1}$ \\ \hline
1 & 19 & 18 & 1 \\
2 & 151 & 142 & 9 \\
3 & 1239 & 1158 & 81 \\
4 & 10271 & 9542 & 729 \\
