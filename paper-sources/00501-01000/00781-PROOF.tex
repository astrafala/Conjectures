...
\title{The empirical recurrence for OEIS A281327, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A281327 imposes three things at once: a condition on each cell that reaches one column up and
...
OEIS A281327 is ``Number of 2Xn 0..2 arrays with no element equal to more than one of its horizontal and antidiagonal neighbors, with the exception of exactly one element, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
0, 2, 46, 394, 3102, 22342, 153982, 1028164,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 20 2017 09:47:24, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;10\,a(n-1) - 13\,a(n-2) - 82\,a(n-3) + 60\,a(n-4) + 210\,a(n-5) - 77\,a(n-6) - 202\,a(n-7) + 39\,a(n-8) + 56\,a(n-9) - 16\,a(n-10)
\end{equation}
for all $n>11$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A281327.
