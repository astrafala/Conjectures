...
\title{A cross-alphabet identity for bounded-difference square arrays: OEIS A125545}
...
\begin{abstract}
OEIS A125545 carries an empirical identity relating its counts to those of the same problem over an
...
OEIS A125545 is ``Number of n X n arrays with entries in 1..11 in which adjacent entries differ by 8 or less (adjacent means in x or y directions).''. It has offset $0$ and begins
\[
1, 11, 12199, 1419562557, 17124710891367659, 21446024690051517579350807, 2787767647614213119983106320870299629, 37614839219636718408474282959362229237375107365087,\ \dots
\]
...
most $d$. The entry is $T(11,8,n)$, and the conjecture is
\[
...
First, the count $T(11,8,n)$ was computed by an independent row-pair dynamic program and
reproduces the $3$ published terms of A125545 that the computation reaches,
...
\[
\begin{array}{rrrr}
n & T(11+1,8,n) & T(11,8,n) & F(n,8) \\ \hline
1 & 12 & 11 & 1 \\
2 & 15260 & 12199 & 3281 \\
\end{array}
\]
...
\url{https://oeis.org}, 2026. Sequence A125545: \url{https://oeis.org/A125545}.
\end{thebibliography}
