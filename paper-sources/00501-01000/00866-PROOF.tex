...
\title{A cross-alphabet identity for bounded-difference square arrays: OEIS A125542}
...
\begin{abstract}
OEIS A125542 carries an empirical identity relating its counts to those of the same problem over an
...
OEIS A125542 is ``Number of n X n arrays with entries in 1..9 in which adjacent entries differ by 7 or less (adjacent means in x or y directions).''. It has offset $0$ and begins
\[
1, 9, 5987, 299369303, 1119629504911493, 313365607149624564094821, 6563186624029432821357130152132207, 10286477666057808275996577778629802367615683611,\ \dots
\]
...
most $d$. The entry is $T(9,7,n)$, and the conjecture is
\[
...
First, the count $T(9,7,n)$ was computed by an independent row-pair dynamic program and
reproduces the $4$ published terms of A125542 that the computation reaches,
...
\[
\begin{array}{rrrr}
n & T(9+1,7,n) & T(9,7,n) & F(n,7) \\ \hline
1 & 10 & 9 & 1 \\
2 & 8022 & 5987 & 2255 \\
\end{array}
\]
...
\url{https://oeis.org}, 2026. Sequence A125542: \url{https://oeis.org/A125542}.
\end{thebibliography}
