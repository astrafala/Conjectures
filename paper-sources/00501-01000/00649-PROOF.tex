...
\title{The empirical recurrence for OEIS A267596, proved from an exact model}
...
\begin{abstract}
OEIS A267596 carries an empirical recurrence of order $2$ contributed by Colin Barker. It is true, and it is
...
OEIS A267596 is ``Decimal representation of the n-th iteration of the "Rule 173" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 2, 15, 63, 255, 1023, 4095, 16383,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 18 2016 and Apr 20 2019: (Start) a(n) = 5*a(n-1)-4*a(n-2) for n>3.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 30 2025 13:08:05, revision 32)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267596.
