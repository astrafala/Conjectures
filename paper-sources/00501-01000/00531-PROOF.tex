...
\title{The empirical recurrence for OEIS A187288, proved from an exact model}
...
\begin{abstract}
OEIS A187288 carries an empirical recurrence of order $3$. It is true, and it is
...
OEIS A187288 is ``Number of 3-step one or two space at a time rook's tours on an n X n board summed over all starting positions.''. It has offset $1$ and begins
\[
0, 8, 108, 328, 672, 1128, 1696, 2376,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 56*n\^{}2 - 160*n + 72 for n>3. a(n) = 3*a(n-1) - 3*a(n-2) + a(n-3) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 22 2018 17:48:17, revision 10)
...
SHAPE when one is a translate of the other. There are exactly $56$ shapes: self-avoiding
...
Write $w^\ast$ for the largest bounding-box side over all $56$ shapes. Once $n\ge w^\ast$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A187288.
