...
\title{The empirical recurrence for OEIS A188151, proved from an exact model}
...
\begin{abstract}
OEIS A188151 carries an empirical recurrence of order $3$. It is true, and it is
...
OEIS A188151 is ``Number of 6-step self-avoiding walks on an n X n square summed over all starting positions.''. It has offset $1$ and begins
\[
0, 0, 128, 800, 2112, 4008, 6472, 9504,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 284*n\^{}2 - 1228*n + 1152 for n>4. a(n) = 3*a(n-1) - 3*a(n-2) + a(n-3) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 27 2018 09:22:33, revision 14)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A188151.
