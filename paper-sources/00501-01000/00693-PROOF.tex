...
\title{The empirical recurrence for OEIS A279531, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A279531 imposes three things at once: a condition on each cell that reaches one row up and
...
OEIS A279531 is ``Number of nX3 0..2 arrays with no element equal to a strict majority of its horizontal and vertical neighbors, with the exception of exactly two elements, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
0, 15, 668, 21430, 539596, 12335295, 263171408, 5359546513,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 14 2016 10:23:29, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;42\,a(n-1) - 504\,a(n-2) + 143\,a(n-3) + 20808\,a(n-4) + 4770\,a(n-5) - 203441\,a(n-6) - 320304\,a(n-7) - 13560\,a(n-8) + 3177121\,a(n-9) + 8046300\,a(n-10) - 4016730\,a(n-11) - 29077826\,a(n-12) - 68511462\,a(n-13) - 18383220\,a(n-14) + 206345988\,a(n-15) + 347749728\,a(n-16) + 153996300\,a(n-17) - 501890344\,a(n-18) - 1207478544\,a(n-19) - 573584184\,a(n-20) + 839039912\,a(n-21) + 1261018752\,a(n-22) + 1034607360\,a(n-23) + 298977216\,a(n-24) - 743195904\,a(n-25) - 670680576\,a(n-26) - 239702528\,a(n-27) - 60456960\,a(n-28) + 205455360\,a(n-29) + 138137600\,a(n-30) - 15974400\,a(n-31) + 24576000\,a(n-32) - 32768000\,a(n-33)
\end{equation}
for all $n>35$.
...
\[
3!\Bigl(a(n_0+j)-\sum_i c_i\,a(n_0+j-i)\Bigr)=\mathbf{v}^{\!\top}G^{\,j-33}w,
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A279531.
