...
\title{The empirical recurrence for OEIS A282156, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A282156 imposes three things at once: a condition on each cell that reaches one row up and
...
numbers. The empirical recurrence of order $45$ contributed by R.~H.~Hardin then follows
...
OEIS A282156 is ``Number of nX3 0..2 arrays with no element unequal to more than four of its king-move neighbors, with the exception of exactly two elements, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
0, 1, 884, 37560, 449234, 4930949, 45129433, 390165523,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 07 2017 08:13:16, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;9\,a(n-1) + 27\,a(n-2) - 276\,a(n-3) - 681\,a(n-4) + 2517\,a(n-5) + 10848\,a(n-6) + 8973\,a(n-7) - 30915\,a(n-8) - 113468\,a(n-9) - 246519\,a(n-10) - 508905\,a(n-11) - 365015\,a(n-12) + 2045778\,a(n-13) + 8208600\,a(n-14) + 16009592\,a(n-15) + 18148296\,a(n-16) + 3749892\,a(n-17) - 53257624\,a(n-18) - 190970592\,a(n-19) - 385072032\,a(n-20) - 489093664\,a(n-21) - 262640208\,a(n-22) + 427101792\,a(n-23) + 1482338048\,a(n-24) + 2604740544\,a(n-25) + 2876222208\,a(n-26) + 1038910656\,a(n-27) - 3432260736\,a(n-28) - 8318151936\,a(n-29) - 8221305088\,a(n-30) - 1081149696\,a(n-31) + 8601944064\,a(n-32) + 12265071616\,a(n-33) + 5392852992\,a(n-34) - 4092251136\,a(n-35) - 8009582592\,a(n-36) - 4627083264\,a(n-37) + 1100685312\,a(n-38) + 2357014528\,a(n-39) + 1361313792\,a(n-40) + 58245120\,a(n-41) - 230031360\,a(n-42) - 157483008\,a(n-43) - 42467328\,a(n-44) - 7077888\,a(n-45)
\end{equation}
for all $n>49$.
...
$h_j=G^{j}N^{o}\mathbf{u}$, we have for $j\ge45$
\[
3!\Bigl(a(n_0+j)-\sum_i c_i\,a(n_0+j-i)\Bigr)=\mathbf{v}^{\!\top}G^{\,j-45}w,
...
$45$ applications of $G$ in exact integer arithmetic and $\mathbf{v}^{\!\top}G^{m}w$
evaluated for $m=0,1,\dots$, again exactly. Every one of those integers vanishes from the
index corresponding to $n=49+1$ onwards, and the run continued until $S+1$ consecutive
zeros had been seen.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A282156.
