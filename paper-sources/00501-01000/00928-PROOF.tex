...
\title{The cross-base identity for OEIS A126482, proved}
...
\begin{abstract}
OEIS A126482 carries an empirical identity, in two clauses, relating its counts to those of the
...
OEIS A126482 is ``Number of base 14 n-digit numbers with adjacent digits differing by three or less.''. It has offset $0$ and begins
\[
1, 14, 86, 546, 3502, 22582, 146000, 945166,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:13:20, revision 12)
this is still recorded as empirical, and nothing on the entry records it as proved.

For this entry the base is $14$ and the permitted difference is $d=3$, so the first clause
claims $a_{14}(n)-a_{13}(n)=7^{\,n-1}$ whenever $3(n-1)+1\le14$, that is for
$1\le n\le5$, and the second claims $a_{14}(n)-a_{13}(n)=7^{\,n-1}-2$ at the single
$n$ with $3(n-1)=14$.
...
arithmetic, $L_{3}$ at base $14$ reproduces all $20$ terms A126482 publishes.
...
First, the model reproduces all $20$ terms A126482 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $L_{3}(14,n)$ & $L_{3}(13,n)$ & $7^{\,n-1}$ \\ \hline
1 & 14 & 13 & 1 \\
2 & 86 & 79 & 7 \\
3 & 546 & 497 & 49 \\
4 & 3502 & 3159 & 343 \\
