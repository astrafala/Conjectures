...
\title{The cross-base identity for OEIS A125478, proved}
...
\begin{abstract}
OEIS A125478 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125478 is ``Number of base 21 circular n-digit numbers with adjacent digits differing by 9 or less.''. It has offset $0$ and begins
\[
1, 21, 309, 3981, 58209, 868821, 13158381, 200564553,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:40:56, revision 12)
...
the base is $21$ and the permitted difference is $d=9$, so the claim is that
\[
a_{21}(n)-a_{20}(n)\;=\;F_{9}(n)
\qquad\text{for every } n \text{ with } 9\lfloor n/2\rfloor+1\le21,
\]
...
at base $21$ reproduces all $17$ terms A125478 publishes, and at base $20$ all the
...
polynomial. In particular $a_{21}(n)-a_{20}(n)=F_{9}(n)$ for $1\le n\le5$, which
...
First, the model reproduces all $17$ terms A125478 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{9}(21,n)$ & $T_{9}(20,n)$ & $F_{9}(n)$ \\ \hline
1 & 21 & 20 & 1 \\
2 & 309 & 290 & 19 \\
3 & 3981 & 3710 & 271 \\
4 & 58209 & 53630 & 4579 \\
5 & 868821 & 790670 & 78151 \\
\end{tabular}
\end{center}
