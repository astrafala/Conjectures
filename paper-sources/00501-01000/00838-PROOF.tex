...
\title{The cross-base identity for OEIS A125455, proved}
...
\begin{abstract}
OEIS A125455 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125455 is ``Number of base 20 circular n-digit numbers with adjacent digits differing by 8 or less.''. It has offset $0$ and begins
\[
1, 20, 268, 3116, 41308, 559340, 7702750, 106934246,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:38:36, revision 12)
...
the base is $20$ and the permitted difference is $d=8$, so the claim is that
\[
a_{20}(n)-a_{19}(n)\;=\;F_{8}(n)
\qquad\text{for every } n \text{ with } 8\lfloor n/2\rfloor+1\le20,
\]
...
at base $20$ reproduces all $17$ terms A125455 publishes, and at base $19$ all the
...
polynomial. In particular $a_{20}(n)-a_{19}(n)=F_{8}(n)$ for $1\le n\le5$, which
...
First, the model reproduces all $17$ terms A125455 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{8}(20,n)$ & $T_{8}(19,n)$ & $F_{8}(n)$ \\ \hline
1 & 20 & 19 & 1 \\
2 & 268 & 251 & 17 \\
3 & 3116 & 2899 & 217 \\
4 & 41308 & 38027 & 3281 \\
5 & 559340 & 509239 & 50101 \\
\end{tabular}
\end{center}
