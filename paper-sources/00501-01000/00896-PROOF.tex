...
\title{The cross-base identity for OEIS A126486, proved}
...
\begin{abstract}
OEIS A126486 carries an empirical identity, in two clauses, relating its counts to those of the
...
OEIS A126486 is ``Number of base 18 n-digit numbers with adjacent digits differing by three or less.''. It has offset $0$ and begins
\[
1, 18, 114, 742, 4874, 32186, 213226, 1415510,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:13:42, revision 13)
this is still recorded as empirical, and nothing on the entry records it as proved.

For this entry the base is $18$ and the permitted difference is $d=3$, so the first clause
claims $a_{18}(n)-a_{17}(n)=7^{\,n-1}$ whenever $3(n-1)+1\le18$, that is for
$1\le n\le6$, and the second claims $a_{18}(n)-a_{17}(n)=7^{\,n-1}-2$ at the single
$n$ with $3(n-1)=18$.
...
arithmetic, $L_{3}$ at base $18$ reproduces all $20$ terms A126486 publishes.
...
First, the model reproduces all $20$ terms A126486 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $L_{3}(18,n)$ & $L_{3}(17,n)$ & $7^{\,n-1}$ \\ \hline
1 & 18 & 17 & 1 \\
2 & 114 & 107 & 7 \\
3 & 742 & 693 & 49 \\
4 & 4874 & 4531 & 343 \\
5 & 32186 & 29785 & 2401 \\
6 & 213226 & 196419 & 16807 \\
\end{tabular}
\end{center}
...
Third, the second clause was evaluated at its own index. For this entry the second clause bites at $n=7$, where $b=18=3(n-1)$: there $L_{3}(18,7)-L_{3}(17,7)=117647$ and $7^{6}-2=117647$.

\section*{References}
\begin{enumerate}
\item The OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences},
\url{https://oeis.org/A126486}.
\end{enumerate}
