...
\title{The empirical recurrence for OEIS A281057, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A281057 imposes three things at once: a condition on each cell that reaches one column up and
...
OEIS A281057 is ``Number of 2 X n 0..1 arrays with no element equal to more than one of its horizontal and antidiagonal neighbors, with the exception of exactly two elements, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
0, 1, 6, 34, 104, 251, 535, 1076,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 5*a(n-1) - 7*a(n-2) - 2*a(n-3) + 10*a(n-4) - 2*a(n-5) - 5*a(n-6) + a(n-7) + a(n-8) for n>14.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 15 2019 08:11:02, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A281057.
