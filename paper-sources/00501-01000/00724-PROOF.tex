...
\title{The cross-base identity for OEIS A125340, proved}
...
\begin{abstract}
OEIS A125340 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125340 is ``Number of base 30 circular n-digit numbers with adjacent digits differing by 3 or less.''. It has offset $0$ and begins
\[
1, 30, 198, 1026, 6238, 38350, 241614, 1541878,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:24:33, revision 11)
...
the base is $30$ and the permitted difference is $d=3$, so the claim is that
\[
a_{30}(n)-a_{29}(n)\;=\;F_{3}(n)
\qquad\text{for every } n \text{ with } 3\lfloor n/2\rfloor+1\le30,
\]
that is, for $1\le n\le19$.
...
at base $30$ reproduces all $20$ terms A125340 publishes, and at base $29$ all the
...
polynomial. In particular $a_{30}(n)-a_{29}(n)=F_{3}(n)$ for $1\le n\le19$, which
...
First, the model reproduces all $20$ terms A125340 publishes, exactly, in integer
...
$1\le n\le19$, with both sides computed from the definition and not from the theorem:

\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{3}(30,n)$ & $T_{3}(29,n)$ & $F_{3}(n)$ \\ \hline
1 & 30 & 29 & 1 \\
2 & 198 & 191 & 7 \\
3 & 1026 & 989 & 37 \\
4 & 6238 & 6007 & 231 \\
5 & 38350 & 36899 & 1451 \\
6 & 241614 & 232283 & 9331 \\
7 & 1541878 & 1481187 & 60691 \\
8 & 9944222 & 9545655 & 398567 \\
\end{tabular}
\end{center}

\noindent and the difference of the second and third columns is the fourth at every row shown
and at every row up to $n=19$.
