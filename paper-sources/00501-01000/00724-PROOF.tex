...
\title{The cross-base identity for OEIS A125391, proved}
...
\begin{abstract}
OEIS A125391 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125391 is ``Number of base 28 circular n-digit numbers with adjacent digits differing by 5 or less.''. It has offset $0$ and begins
\[
1, 28, 278, 2218, 20698, 196378, 1908368, 18800964,\ \dots
\]
The entry states, as an empirical claim and never marked settled:
\begin{quote}
[Empirical] a(base,n)=a(base-1,n)+F(5) for base>=5.int(n/2)+1 and F(d) is the largest coefficient in (1+x+...+x\textasciicircum{}(2d))\textasciicircum{}n
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:32:08, revision 12)
...
the base is $28$ and the permitted difference is $d=5$, so the claim is that
\[
a_{28}(n)-a_{27}(n)\;=\;F_{5}(n)
\qquad\text{for every } n \text{ with } 5\lfloor n/2\rfloor+1\le28,
\]
...
together with a choice of where it starts. Evaluated exactly in integer arithmetic, $T_{5}$
at base $28$ reproduces all $18$ terms A125391 publishes, and at base $27$ all the
...
polynomial. In particular $a_{28}(n)-a_{27}(n)=F_{5}(n)$ for $1\le n\le11$, which
...
First, the model reproduces all $18$ terms A125391 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{5}(28,n)$ & $T_{5}(27,n)$ & $F_{5}(n)$ \\ \hline
1 & 28 & 27 & 1 \\
2 & 278 & 267 & 11 \\
3 & 2218 & 2127 & 91 \\
4 & 20698 & 19807 & 891 \\
5 & 196378 & 187577 & 8801 \\
6 & 1908368 & 1819455 & 88913 \\
7 & 18800964 & 17892209 & 908755 \\
8 & 187240242 & 177862775 & 9377467 \\
\end{tabular}
\end{center}
