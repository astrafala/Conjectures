...
\title{The cross-base identity for OEIS A125381, proved}
...
\begin{abstract}
OEIS A125381 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125381 is ``Number of base 18 circular n-digit numbers with adjacent digits differing by 5 or less.''. It has offset $0$ and begins
\[
1, 18, 168, 1308, 11788, 108368, 1019238, 9713414,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:05:11, revision 14)
...
the base is $18$ and the permitted difference is $d=5$, so the claim is that
\[
a_{18}(n)-a_{17}(n)\;=\;F_{5}(n)
\qquad\text{for every } n \text{ with } 5\lfloor n/2\rfloor+1\le18,
\]
...
at base $18$ reproduces all $19$ terms A125381 publishes, and at base $17$ all the
...
polynomial. In particular $a_{18}(n)-a_{17}(n)=F_{5}(n)$ for $1\le n\le7$, which
...
First, the model reproduces all $19$ terms A125381 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{5}(18,n)$ & $T_{5}(17,n)$ & $F_{5}(n)$ \\ \hline
1 & 18 & 17 & 1 \\
2 & 168 & 157 & 11 \\
3 & 1308 & 1217 & 91 \\
4 & 11788 & 10897 & 891 \\
5 & 108368 & 99567 & 8801 \\
6 & 1019238 & 930325 & 88913 \\
7 & 9713414 & 8804659 & 908755 \\
\end{tabular}
\end{center}
