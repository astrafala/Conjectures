...
\title{The cross-base identity for OEIS A125352, proved}
...
\begin{abstract}
OEIS A125352 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125352 is ``Number of base 15 circular n-digit numbers with adjacent digits differing by 4 or less.''. It has offset $0$ and begins
\[
1, 15, 115, 735, 5435, 40965, 315991, 2469909,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:03:58, revision 13)
...
the base is $15$ and the permitted difference is $d=4$, so the claim is that
\[
a_{15}(n)-a_{14}(n)\;=\;F_{4}(n)
\qquad\text{for every } n \text{ with } 4\lfloor n/2\rfloor+1\le15,
\]
...
at base $15$ reproduces all $20$ terms A125352 publishes, and at base $14$ all the
...
polynomial. In particular $a_{15}(n)-a_{14}(n)=F_{4}(n)$ for $1\le n\le7$, which
...
First, the model reproduces all $20$ terms A125352 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{4}(15,n)$ & $T_{4}(14,n)$ & $F_{4}(n)$ \\ \hline
1 & 15 & 14 & 1 \\
2 & 115 & 106 & 9 \\
3 & 735 & 674 & 61 \\
4 & 5435 & 4946 & 489 \\
5 & 40965 & 37014 & 3951 \\
6 & 315991 & 283330 & 32661 \\
7 & 2469909 & 2196782 & 273127 \\
\end{tabular}
\end{center}
