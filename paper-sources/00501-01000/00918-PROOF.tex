...
\title{The cross-base identity for OEIS A126523, proved}
...
\begin{abstract}
OEIS A126523 carries an empirical identity, in two clauses, relating its counts to those of the
...
OEIS A126523 is ``Number of base 28 n-digit numbers with adjacent digits differing by four or less.''. It has offset $0$ and begins
\[
1, 28, 232, 1968, 16832, 144660, 1247088, 10773792,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:16:48, revision 11)
this is still recorded as empirical, and nothing on the entry records it as proved.

For this entry the base is $28$ and the permitted difference is $d=4$, so the first clause
claims $a_{28}(n)-a_{27}(n)=9^{\,n-1}$ whenever $4(n-1)+1\le28$, that is for
$1\le n\le7$, and the second claims $a_{28}(n)-a_{27}(n)=9^{\,n-1}-2$ at the single
$n$ with $4(n-1)=28$.
...
arithmetic, $L_{4}$ at base $28$ reproduces all $19$ terms A126523 publishes.
...
First, the model reproduces all $19$ terms A126523 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $L_{4}(28,n)$ & $L_{4}(27,n)$ & $9^{\,n-1}$ \\ \hline
1 & 28 & 27 & 1 \\
2 & 232 & 223 & 9 \\
3 & 1968 & 1887 & 81 \\
4 & 16832 & 16103 & 729 \\
5 & 144660 & 138099 & 6561 \\
6 & 1247088 & 1188039 & 59049 \\
7 & 10773792 & 10242351 & 531441 \\
\end{tabular}
\end{center}
...
Third, the second clause was evaluated at its own index. For this entry the second clause bites at $n=8$, where $b=28=4(n-1)$: there $L_{4}(28,8)-L_{4}(27,8)=4782967$ and $9^{7}-2=4782967$.

\section*{References}
\begin{enumerate}
\item The OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences},
\url{https://oeis.org/A126523}.
\end{enumerate}
