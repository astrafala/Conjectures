...
\title{The empirical recurrence for OEIS A222381, proved by transfer matrix}
...
\begin{abstract}
OEIS A222381 counts the distinct indicator arrays obtained from the $n\times2$ arrays over
...
OEIS A222381 is ``Sum of neighbor maps: number of n X 2 binary arrays indicating the locations of corresponding elements equal to the sum mod 3 of their horizontal and antidiagonal neighbors in a random 0..2 n X 2 array.''. It has offset $1$ and begins
\[
2, 16, 64, 232, 1024, 4096, 16224, 65536,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) + 8*a(n-3) - 32*a(n-4) - 16*a(n-6) + 64*a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 15 2018 06:46:16, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + 8\,a(n-3) - 32\,a(n-4) - 16\,a(n-6) + 64\,a(n-7)
\]
for every $n>7$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A222381.
