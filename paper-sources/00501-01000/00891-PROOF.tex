...
\title{The cross-base identity for OEIS A126481, proved}
...
\begin{abstract}
OEIS A126481 carries an empirical identity, in two clauses, relating its counts to those of the
...
OEIS A126481 is ``Number of base 13 n-digit numbers with adjacent digits differing by three or less.''. It has offset $0$ and begins
\[
1, 13, 79, 497, 3159, 20181, 129205, 828005,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:13:14, revision 13)
this is still recorded as empirical, and nothing on the entry records it as proved.

For this entry the base is $13$ and the permitted difference is $d=3$, so the first clause
claims $a_{13}(n)-a_{12}(n)=7^{\,n-1}$ whenever $3(n-1)+1\le13$, that is for
$1\le n\le5$, and the second claims $a_{13}(n)-a_{12}(n)=7^{\,n-1}-2$ at the single
$n$ with $3(n-1)=13$.
...
arithmetic, $L_{3}$ at base $13$ reproduces all $20$ terms A126481 publishes.
...
First, the model reproduces all $20$ terms A126481 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $L_{3}(13,n)$ & $L_{3}(12,n)$ & $7^{\,n-1}$ \\ \hline
1 & 13 & 12 & 1 \\
2 & 79 & 72 & 7 \\
3 & 497 & 448 & 49 \\
4 & 3159 & 2816 & 343 \\
