...
\title{A cross-alphabet identity for bounded-difference square arrays: OEIS A125534}
...
\begin{abstract}
OEIS A125534 carries an empirical identity relating its counts to those of the same problem over an
...
OEIS A125534 is ``Number of n X n arrays with entries in 1..5 in which adjacent entries differ by 3 or less (adjacent means in x or y directions).''. It has offset $0$ and begins
\[
1, 5, 467, 877547, 32392165445, 23566800979324529, 337794127866926817026015, 95393532181581177183563991168527,\ \dots
\]
...
most $d$. The entry is $T(5,3,n)$, and the conjecture is
\[
...
First, the count $T(5,3,n)$ was computed by an independent row-pair dynamic program and
reproduces the $5$ published terms of A125534 that the computation reaches,
...
\[
\begin{array}{rrrr}
n & T(5+1,3,n) & T(5,3,n) & F(n,3) \\ \hline
1 & 6 & 5 & 1 \\
2 & 694 & 467 & 231 \\
\end{array}
\]
...
\url{https://oeis.org}, 2026. Sequence A125534: \url{https://oeis.org/A125534}.
\end{thebibliography}
