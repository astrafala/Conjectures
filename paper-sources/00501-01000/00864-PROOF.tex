...
\title{A cross-alphabet identity for bounded-difference square arrays: OEIS A125533}
...
\begin{abstract}
OEIS A125533 carries an empirical identity relating its counts to those of the same problem over an
...
OEIS A125533 is ``Number of n X n arrays with entries in 1..5 in which adjacent entries differ by 2 or less (adjacent means in x or y directions).''. It has offset $0$ and begins
\[
1, 5, 247, 156579, 1191861707, 109495018399901, 121266251495154433997, 1619036215215662119089701145,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 31 2023 15:42:11, revision 8)
...
most $d$. The entry is $T(5,2,n)$, and the conjecture is
\[
...
First, the count $T(5,2,n)$ was computed by an independent row-pair dynamic program and
reproduces the $5$ published terms of A125533 that the computation reaches,
...
\[
\begin{array}{rrrr}
n & T(5+1,2,n) & T(5,2,n) & F(n,2) \\ \hline
1 & 6 & 5 & 1 \\
2 & 332 & 247 & 85 \\
\end{array}
\]
...
\url{https://oeis.org}, 2026. Sequence A125533: \url{https://oeis.org/A125533}.
\end{thebibliography}
