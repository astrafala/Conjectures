...
\title{The empirical recurrence for OEIS A267882, proved from an exact model}
...
\begin{abstract}
OEIS A267882 carries an empirical recurrence of order $3$ contributed by Colin Barker. It is true, and it is
...
OEIS A267882 is ``Total number of ON (black) cells after n iterations of the "Rule 233" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 1, 4, 10, 19, 30, 43, 58,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 22 2016 and Apr 20 2019: (Start) a(n) = 3*a(n-1)-3*a(n-2)+a(n-3) for n>2.
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 08 2025 09:54:46, revision 21)
...
For this entry the automaton is rule 233, the period is $p=1$ and the pre-period is $n_0=4$.
The certificate is
\begin{gather*}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267882.
