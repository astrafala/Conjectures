...
\title{The empirical recurrence for OEIS A187589, proved from an exact model}
...
\begin{abstract}
OEIS A187589 carries an empirical recurrence of order $3$. It is true, and it is
...
OEIS A187589 is ``Number of 6-step E, S, NW and NE-moving king's tours on an n X n board summed over all starting positions.''. It has offset $1$ and begins
\[
0, 0, 104, 1069, 3514, 7480, 12874, 19696,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 714*n\^{}2 - 3888*n + 5104 for n>4. a(n) = 3*a(n-1) - 3*a(n-2) + a(n-3) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 24 2018 15:28:33, revision 10)
...
SHAPE when one is a translate of the other. There are exactly $714$ shapes: self-avoiding
...
Write $w^\ast$ for the largest bounding-box side over all $714$ shapes. Once $n\ge w^\ast$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A187589.
