...
\title{The cross-base identity for OEIS A126551, proved}
...
\begin{abstract}
OEIS A126551 carries an empirical identity, in two clauses, relating its counts to those of the
...
OEIS A126551 is ``Number of base 30 n-digit numbers with adjacent digits differing by five or less.''. It has offset $0$ and begins
\[
1, 30, 300, 3080, 31910, 332332, 3472294, 36356914,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:19:00, revision 11)
this is still recorded as empirical, and nothing on the entry records it as proved.

For this entry the base is $30$ and the permitted difference is $d=5$, so the first clause
claims $a_{30}(n)-a_{29}(n)=11^{\,n-1}$ whenever $5(n-1)+1\le30$, that is for
$1\le n\le6$, and the second claims $a_{30}(n)-a_{29}(n)=11^{\,n-1}-2$ at the single
$n$ with $5(n-1)=30$.
...
arithmetic, $L_{5}$ at base $30$ reproduces all $18$ terms A126551 publishes.
...
First, the model reproduces all $18$ terms A126551 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $L_{5}(30,n)$ & $L_{5}(29,n)$ & $11^{\,n-1}$ \\ \hline
1 & 30 & 29 & 1 \\
2 & 300 & 289 & 11 \\
3 & 3080 & 2959 & 121 \\
4 & 31910 & 30579 & 1331 \\
5 & 332332 & 317691 & 14641 \\
6 & 3472294 & 3311243 & 161051 \\
\end{tabular}
\end{center}
...
Third, the second clause was evaluated at its own index. For this entry the second clause bites at $n=7$, where $b=30=5(n-1)$: there $L_{5}(30,7)-L_{5}(29,7)=1771559$ and $11^{6}-2=1771559$.

\section*{References}
\begin{enumerate}
\item The OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences},
\url{https://oeis.org/A126551}.
\end{enumerate}
