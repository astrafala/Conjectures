...
\title{The empirical recurrence for OEIS A200156, proved from an exact model}
...
\begin{abstract}
OEIS A200156 carries an empirical recurrence of order $14$. It is true, and it is
...
OEIS A200156 is ``Number of 0..n arrays x(0..4) of 5 elements with zero 4th difference.''. It has offset $1$ and begins
\[
2, 15, 40, 103, 202, 381, 636, 1033,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) +a(n-2) +a(n-4) -3*a(n-5) -a(n-6) +a(n-8) +3*a(n-9) -a(n-10) -a(n-12) -a(n-13) +a(n-14).
\end{quote}
As of the ``Last modified'' line on the live entry (May 17 2018 17:02:14, revision 8)
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + a(n-2) + a(n-4) - 3\,a(n-5) - a(n-6) + a(n-8) + 3\,a(n-9) - a(n-10) - a(n-12) - a(n-13) + a(n-14)
\]
for every $n>0$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A200156.
