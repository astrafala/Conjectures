...
\title{The cross-base identity for OEIS A126520, proved}
...
\begin{abstract}
OEIS A126520 carries an empirical identity, in two clauses, relating its counts to those of the
...
OEIS A126520 is ``Number of base 25 n-digit numbers with adjacent digits differing by four or less.''. It has offset $0$ and begins
\[
1, 25, 205, 1725, 14645, 124977, 1069941, 9179469,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:16:31, revision 11)
this is still recorded as empirical, and nothing on the entry records it as proved.

For this entry the base is $25$ and the permitted difference is $d=4$, so the first clause
claims $a_{25}(n)-a_{24}(n)=9^{\,n-1}$ whenever $4(n-1)+1\le25$, that is for
$1\le n\le7$, and the second claims $a_{25}(n)-a_{24}(n)=9^{\,n-1}-2$ at the single
$n$ with $4(n-1)=25$.
...
arithmetic, $L_{4}$ at base $25$ reproduces all $19$ terms A126520 publishes.
...
First, the model reproduces all $19$ terms A126520 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $L_{4}(25,n)$ & $L_{4}(24,n)$ & $9^{\,n-1}$ \\ \hline
1 & 25 & 24 & 1 \\
2 & 205 & 196 & 9 \\
3 & 1725 & 1644 & 81 \\
4 & 14645 & 13916 & 729 \\
5 & 124977 & 118416 & 6561 \\
6 & 1069941 & 1010892 & 59049 \\
7 & 9179469 & 8648028 & 531441 \\
\end{tabular}
\end{center}
