...
\title{The cross-base identity for OEIS A125374, proved}
...
\begin{abstract}
OEIS A125374 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125374 is ``Number of base 11 circular n-digit numbers with adjacent digits differing by 5 or less.''. It has offset $0$ and begins
\[
1, 11, 91, 671, 5551, 46761, 398065, 3401871,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:04:32, revision 14)
...
the base is $11$ and the permitted difference is $d=5$, so the claim is that
\[
a_{11}(n)-a_{10}(n)\;=\;F_{5}(n)
\qquad\text{for every } n \text{ with } 5\lfloor n/2\rfloor+1\le11,
\]
...
at base $11$ reproduces all $20$ terms A125374 publishes, and at base $10$ all the
...
polynomial. In particular $a_{11}(n)-a_{10}(n)=F_{5}(n)$ for $1\le n\le5$, which
...
First, the model reproduces all $20$ terms A125374 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{5}(11,n)$ & $T_{5}(10,n)$ & $F_{5}(n)$ \\ \hline
1 & 11 & 10 & 1 \\
2 & 91 & 80 & 11 \\
3 & 671 & 580 & 91 \\
4 & 5551 & 4660 & 891 \\
