...
\title{The empirical recurrence for OEIS A281766, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A281766 imposes three things at once: a condition on each cell that reaches one column up and
...
OEIS A281766 is ``Number of 2 X n 0..1 arrays with no element unequal to a strict majority of its horizontal, diagonal and antidiagonal neighbors, with the exception of exactly one element, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
0, 4, 14, 40, 110, 280, 698, 1696,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 4*a(n-1) + a(n-2) - 16*a(n-3) - a(n-4) + 30*a(n-5) + 4*a(n-6) - 24*a(n-7) - 4*a(n-8) + 8*a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 14 2026 20:34:28, revision 11) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A281766.
