...
\title{The empirical recurrence for OEIS A281560, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A281560 imposes three things at once: a condition on each cell that reaches one row up and
...
OEIS A281560 is ``Number of nX5 0..1 arrays with no element equal to more than two of its horizontal, diagonal or antidiagonal neighbors, with the exception of exactly two elements, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
0, 141, 2426, 12133, 50510, 154722, 430995, 1166392,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 24 2017 08:33:27, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) - 7\,a(n-2) + 10\,a(n-3) - 38\,a(n-4) + 37\,a(n-5) - 5\,a(n-6) + 94\,a(n-7) - 20\,a(n-8) - 167\,a(n-9) - 113\,a(n-10) - 134\,a(n-11) + 498\,a(n-12) + 330\,a(n-13) + 105\,a(n-14) - 507\,a(n-15) - 927\,a(n-16) + 72\,a(n-17) + 503\,a(n-18) + 953\,a(n-19) + 224\,a(n-20) - 809\,a(n-21) - 464\,a(n-22) - 161\,a(n-23) + 378\,a(n-24) + 441\,a(n-25) - 162\,a(n-26) - 189\,a(n-27) + 27\,a(n-28) + 27\,a(n-29)
\end{equation}
for all $n>46$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A281560.
