...
\title{The cross-base identity for OEIS A125337, proved}
...
\begin{abstract}
OEIS A125337 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125337 is ``Number of base 27 circular n-digit numbers with adjacent digits differing by 3 or less.''. It has offset $0$ and begins
\[
1, 27, 177, 915, 5545, 33997, 213621, 1359805,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:24:14, revision 11)
...
the base is $27$ and the permitted difference is $d=3$, so the claim is that
\[
a_{27}(n)-a_{26}(n)\;=\;F_{3}(n)
\qquad\text{for every } n \text{ with } 3\lfloor n/2\rfloor+1\le27,
\]
that is, for $1\le n\le17$.
...
at base $27$ reproduces all $20$ terms A125337 publishes, and at base $26$ all the
...
polynomial. In particular $a_{27}(n)-a_{26}(n)=F_{3}(n)$ for $1\le n\le17$, which
...
First, the model reproduces all $20$ terms A125337 publishes, exactly, in integer
...
$1\le n\le17$, with both sides computed from the definition and not from the theorem:

\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{3}(27,n)$ & $T_{3}(26,n)$ & $F_{3}(n)$ \\ \hline
1 & 27 & 26 & 1 \\
2 & 177 & 170 & 7 \\
3 & 915 & 878 & 37 \\
4 & 5545 & 5314 & 231 \\
5 & 33997 & 32546 & 1451 \\
6 & 213621 & 204290 & 9331 \\
7 & 1359805 & 1299114 & 60691 \\
8 & 8748521 & 8349954 & 398567 \\
\end{tabular}
\end{center}

\noindent and the difference of the second and third columns is the fourth at every row shown
and at every row up to $n=17$.
