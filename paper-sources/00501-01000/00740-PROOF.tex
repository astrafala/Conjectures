...
\title{The cross-base identity for OEIS A125408, proved}
...
\begin{abstract}
OEIS A125408 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125408 is ``Number of base 20 circular n-digit numbers with adjacent digits differing by 6 or less.''. It has offset $0$ and begins
\[
1, 20, 218, 1994, 21078, 227450, 2509508, 28044008,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:06:27, revision 14)
...
the base is $20$ and the permitted difference is $d=6$, so the claim is that
\[
a_{20}(n)-a_{19}(n)\;=\;F_{6}(n)
\qquad\text{for every } n \text{ with } 6\lfloor n/2\rfloor+1\le20,
\]
...
at base $20$ reproduces all $18$ terms A125408 publishes, and at base $19$ all the
...
polynomial. In particular $a_{20}(n)-a_{19}(n)=F_{6}(n)$ for $1\le n\le7$, which
...
First, the model reproduces all $18$ terms A125408 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{6}(20,n)$ & $T_{6}(19,n)$ & $F_{6}(n)$ \\ \hline
1 & 20 & 19 & 1 \\
2 & 218 & 205 & 13 \\
3 & 1994 & 1867 & 127 \\
4 & 21078 & 19609 & 1469 \\
5 & 227450 & 210299 & 17151 \\
6 & 2509508 & 2304745 & 204763 \\
7 & 28044008 & 25570683 & 2473325 \\
\end{tabular}
\end{center}
