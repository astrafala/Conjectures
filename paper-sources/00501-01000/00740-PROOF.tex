...
\title{The cross-base identity for OEIS A125376, proved}
...
\begin{abstract}
OEIS A125376 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125376 is ``Number of base 13 circular n-digit numbers with adjacent digits differing by 5 or less.''. It has offset $0$ and begins
\[
1, 13, 113, 853, 7333, 64363, 574739, 5174497,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:04:43, revision 16)
...
the base is $13$ and the permitted difference is $d=5$, so the claim is that
\[
a_{13}(n)-a_{12}(n)\;=\;F_{5}(n)
\qquad\text{for every } n \text{ with } 5\lfloor n/2\rfloor+1\le13,
\]
...
at base $13$ reproduces all $19$ terms A125376 publishes, and at base $12$ all the
...
polynomial. In particular $a_{13}(n)-a_{12}(n)=F_{5}(n)$ for $1\le n\le5$, which
...
First, the model reproduces all $19$ terms A125376 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{5}(13,n)$ & $T_{5}(12,n)$ & $F_{5}(n)$ \\ \hline
1 & 13 & 12 & 1 \\
2 & 113 & 102 & 11 \\
3 & 853 & 762 & 91 \\
4 & 7333 & 6442 & 891 \\
