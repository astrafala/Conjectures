...
\title{The empirical recurrence for OEIS A280553, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A280553 imposes three things at once: a condition on each cell that reaches one row up and
...
OEIS A280553 is ``Number of n X 7 0..1 arrays with no element equal to more than one of its horizontal and vertical neighbors, with the exception of exactly two elements, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
13, 400, 1316, 3182, 6386, 11697, 20334, 34360,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 6*a(n-1) - 12*a(n-2) + 5*a(n-3) + 12*a(n-4) - 12*a(n-5) - 3*a(n-6) + 6*a(n-7) - a(n-9) for n>12.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 13 2019 16:56:27, revision 9) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A280553.
