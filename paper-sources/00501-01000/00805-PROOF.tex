...
\title{The cross-base identity for OEIS A125476, proved}
...
\begin{abstract}
OEIS A125476 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125476 is ``Number of base 19 circular n-digit numbers with adjacent digits differing by 9 or less.''. It has offset $0$ and begins
\[
1, 19, 271, 3439, 49051, 712519, 10458163, 154101799,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:40:45, revision 12)
...
the base is $19$ and the permitted difference is $d=9$, so the claim is that
\[
a_{19}(n)-a_{18}(n)\;=\;F_{9}(n)
\qquad\text{for every } n \text{ with } 9\lfloor n/2\rfloor+1\le19,
\]
...
at base $19$ reproduces all $17$ terms A125476 publishes, and at base $18$ all the
...
polynomial. In particular $a_{19}(n)-a_{18}(n)=F_{9}(n)$ for $1\le n\le5$, which
...
First, the model reproduces all $17$ terms A125476 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{9}(19,n)$ & $T_{9}(18,n)$ & $F_{9}(n)$ \\ \hline
1 & 19 & 18 & 1 \\
2 & 271 & 252 & 19 \\
3 & 3439 & 3168 & 271 \\
4 & 49051 & 44472 & 4579 \\
5 & 712519 & 634368 & 78151 \\
\end{tabular}
\end{center}
