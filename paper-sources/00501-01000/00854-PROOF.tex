...
\title{The cross-base identity for OEIS A125457, proved}
...
\begin{abstract}
OEIS A125457 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125457 is ``Number of base 22 circular n-digit numbers with adjacent digits differing by 8 or less.''. It has offset $0$ and begins
\[
1, 22, 302, 3550, 47870, 659542, 9265904, 131528076,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:38:47, revision 12)
...
the base is $22$ and the permitted difference is $d=8$, so the claim is that
\[
a_{22}(n)-a_{21}(n)\;=\;F_{8}(n)
\qquad\text{for every } n \text{ with } 8\lfloor n/2\rfloor+1\le22,
\]
...
at base $22$ reproduces all $17$ terms A125457 publishes, and at base $21$ all the
...
polynomial. In particular $a_{22}(n)-a_{21}(n)=F_{8}(n)$ for $1\le n\le5$, which
...
First, the model reproduces all $17$ terms A125457 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{8}(22,n)$ & $T_{8}(21,n)$ & $F_{8}(n)$ \\ \hline
1 & 22 & 21 & 1 \\
2 & 302 & 285 & 17 \\
3 & 3550 & 3333 & 217 \\
4 & 47870 & 44589 & 3281 \\
5 & 659542 & 609441 & 50101 \\
\end{tabular}
\end{center}
