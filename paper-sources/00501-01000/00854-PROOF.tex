...
\title{The empirical recurrence for OEIS A218200, proved by transfer matrix}
...
\begin{abstract}
OEIS A218200 counts the distinct indicator arrays obtained from the $n\times2$ arrays over
...
OEIS A218200 is ``Hilltop maps: number of n X 2 binary arrays indicating the locations of corresponding elements not exceeded by any horizontal or vertical neighbor in a random 0..2 n X 2 array.''. It has offset $1$ and begins
\[
3, 15, 59, 233, 929, 3697, 14719, 58599,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) + 3*a(n-2) + 3*a(n-3) + 2*a(n-4) + 2*a(n-5) - a(n-6) - a(n-7) - a(n-8) - a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 09 2018 19:33:57, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + 3\,a(n-2) + 3\,a(n-3) + 2\,a(n-4) + 2\,a(n-5) - a(n-6) - a(n-7) - a(n-8) - a(n-9)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A218200.
