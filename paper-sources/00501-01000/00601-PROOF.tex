...
\title{The empirical recurrence for OEIS A264310, proved by transfer matrix}
...
\begin{abstract}
OEIS A264310 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=6$ rows in which
...
OEIS A264310 is ``Number of (n+1) X (5+1) arrays of permutations of 0..n*6+5 with each element having directed index change 0,0 0,1 1,0 -1,-2 or 0,2.''. It has offset $1$ and begins
\[
140, 4103, 130041, 3932500, 119041793, 3604351803, 109088196333, 3301600532164,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 26 2021 19:34:45, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;33\,a(n-1) - 69\,a(n-2) - 199\,a(n-3) - 6792\,a(n-4) + 4447\,a(n-5) + 41319\,a(n-6) + 303267\,a(n-7) - 443549\,a(n-8) - 398428\,a(n-9) - 1783130\,a(n-10) + 1042134\,a(n-11) + 2217570\,a(n-12) - 6237046\,a(n-13) + 27889860\,a(n-14) - 37432490\,a(n-15) + 94710958\,a(n-16) - 104315290\,a(n-17) + 19585230\,a(n-18) + 58406924\,a(n-19) - 162069021\,a(n-20) + 32870497\,a(n-21) + 2643595\,a(n-22) - 42259315\,a(n-23) + 29248500\,a(n-24) - 8540181\,a(n-25) - 8486829\,a(n-26) + 1722303\,a(n-27) + 617463\,a(n-28)
\]
for every $n>27$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264310.
