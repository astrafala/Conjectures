...
\title{The cross-base identity for OEIS A125440, proved}
...
\begin{abstract}
OEIS A125440 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125440 is ``Number of base 28 circular n-digit numbers with adjacent digits differing by 7 or less.''. It has offset $0$ and begins
\[
1, 28, 364, 3892, 48412, 614068, 7972636, 104937364,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:37:07, revision 12)
...
the base is $28$ and the permitted difference is $d=7$, so the claim is that
\[
a_{28}(n)-a_{27}(n)\;=\;F_{7}(n)
\qquad\text{for every } n \text{ with } 7\lfloor n/2\rfloor+1\le28,
\]
...
at base $28$ reproduces all $17$ terms A125440 publishes, and at base $27$ all the
...
polynomial. In particular $a_{28}(n)-a_{27}(n)=F_{7}(n)$ for $1\le n\le7$, which
...
First, the model reproduces all $17$ terms A125440 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{7}(28,n)$ & $T_{7}(27,n)$ & $F_{7}(n)$ \\ \hline
1 & 28 & 27 & 1 \\
2 & 364 & 349 & 15 \\
3 & 3892 & 3723 & 169 \\
4 & 48412 & 46157 & 2255 \\
5 & 614068 & 583687 & 30381 \\
6 & 7972636 & 7554133 & 418503 \\
7 & 104937364 & 99104599 & 5832765 \\
\end{tabular}
\end{center}
