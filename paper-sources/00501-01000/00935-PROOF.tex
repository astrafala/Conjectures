...
\title{The cross-base identity for OEIS A126415, proved}
...
\begin{abstract}
OEIS A126415 carries an empirical identity, in two clauses, relating its counts to those of the
...
OEIS A126415 is ``Number of base 28 n-digit numbers with adjacent digits differing by two or less.''. It has offset $0$ and begins
\[
1, 28, 134, 650, 3168, 15486, 75848, 372024,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:12:26, revision 9)
this is still recorded as empirical, and nothing on the entry records it as proved.

For this entry the base is $28$ and the permitted difference is $d=2$, so the first clause
claims $a_{28}(n)-a_{27}(n)=5^{\,n-1}$ whenever $2(n-1)+1\le28$, that is for
$1\le n\le14$, and the second claims $a_{28}(n)-a_{27}(n)=5^{\,n-1}-2$ at the single
$n$ with $2(n-1)=28$.
...
arithmetic, $L_{2}$ at base $28$ reproduces all $21$ terms A126415 publishes.
...
First, the model reproduces all $21$ terms A126415 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $L_{2}(28,n)$ & $L_{2}(27,n)$ & $5^{\,n-1}$ \\ \hline
1 & 28 & 27 & 1 \\
2 & 134 & 129 & 5 \\
3 & 650 & 625 & 25 \\
4 & 3168 & 3043 & 125 \\
5 & 15486 & 14861 & 625 \\
6 & 75848 & 72723 & 3125 \\
7 & 372024 & 356399 & 15625 \\
8 & 1826730 & 1748605 & 78125 \\
\end{tabular}
\end{center}
...
Third, the second clause was evaluated at its own index. For this entry the second clause bites at $n=15$, where $b=28=2(n-1)$: there $L_{2}(28,15)-L_{2}(27,15)=6103515623$ and $5^{14}-2=6103515623$.

\section*{References}
\begin{enumerate}
\item The OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences},
\url{https://oeis.org/A126415}.
\end{enumerate}
