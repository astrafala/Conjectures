...
\title{The empirical recurrence for OEIS A267890, proved from an exact model}
...
\begin{abstract}
OEIS A267890 carries an empirical recurrence of order $2$ contributed by Colin Barker. It is true, and it is
...
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 22 2016 and Apr 17 2019: (Start) a(n) = 5*a(n-1)-4*a(n-2) for n>3.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 24 2025 12:24:59, revision 21)
