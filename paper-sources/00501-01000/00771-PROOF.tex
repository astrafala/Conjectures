...
\title{The empirical recurrence for OEIS A217633, proved by transfer matrix}
...
\begin{abstract}
OEIS A217633 counts the distinct arrays obtained by applying a fixed local operation to every cell
...
$S=154$ states, after which the conjectured recurrence is settled by a finite exact
computation.
\end{abstract}
...
OEIS A217633 is ``Number of n X 4 arrays of the minimum value of corresponding elements and their horizontal and vertical neighbors in a random 0..1 n X 4 array.''. It has offset $1$ and begins
\[
6, 38, 244, 1418, 8706, 52120, 315378, 1900838,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 28 2023 11:32:26, revision 10) this is still
...
\]
There are $S=154$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite.
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + 20\,a(n-2) - 29\,a(n-3) - 124\,a(n-4) + 55\,a(n-5) + 330\,a(n-6) - 57\,a(n-7) - 498\,a(n-8) - 291\,a(n-9) + 965\,a(n-10) + 676\,a(n-11) - 991\,a(n-12) - 659\,a(n-13) + 771\,a(n-14) + 610\,a(n-15) - 581\,a(n-16) - 78\,a(n-17) - 36\,a(n-18) + 32\,a(n-19) - 94\,a(n-20) + 32\,a(n-21) + 68\,a(n-22) - 16\,a(n-23)
\]
for every $n>23$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A217633.
