...
\title{The cross-base identity for OEIS A125402, proved}
...
\begin{abstract}
OEIS A125402 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125402 is ``Number of base 14 circular n-digit numbers with adjacent digits differing by 6 or less.''. It has offset $0$ and begins
\[
1, 14, 140, 1232, 12264, 124544, 1282148, 13275164,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:05:55, revision 14)
...
the base is $14$ and the permitted difference is $d=6$, so the claim is that
\[
a_{14}(n)-a_{13}(n)\;=\;F_{6}(n)
\qquad\text{for every } n \text{ with } 6\lfloor n/2\rfloor+1\le14,
\]
...
at base $14$ reproduces all $18$ terms A125402 publishes, and at base $13$ all the
...
polynomial. In particular $a_{14}(n)-a_{13}(n)=F_{6}(n)$ for $1\le n\le5$, which
...
First, the model reproduces all $18$ terms A125402 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{6}(14,n)$ & $T_{6}(13,n)$ & $F_{6}(n)$ \\ \hline
1 & 14 & 13 & 1 \\
2 & 140 & 127 & 13 \\
3 & 1232 & 1105 & 127 \\
4 & 12264 & 10795 & 1469 \\
5 & 124544 & 107393 & 17151 \\
\end{tabular}
\end{center}
