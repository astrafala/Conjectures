...
\title{The empirical recurrence for OEIS A283356, proved from an exact model}
...
\begin{abstract}
OEIS A283356 carries an empirical recurrence of order $3$ contributed by Colin Barker. It is true, and it is
...
OEIS A283356 is ``Binary representation of the x-axis, from the origin to the right edge, of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 621", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 1, 1, 1101, 10001, 11101, 110001, 1111101,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Mar 06 2017: (Start) a(n) = 10*a(n-1) + a(n-2) - 10*a(n-3) for n>5.
\end{quote}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A283356.
