...
\title{The empirical recurrence for OEIS A267935, proved from an exact model}
...
\begin{abstract}
OEIS A267935 carries an empirical recurrence of order $2$ contributed by Colin Barker. It is true, and it is
...
OEIS A267935 is ``Decimal representation of the n-th iteration of the "Rule 249" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 1, 27, 127, 511, 2047, 8191, 32767,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 23 2016 and Apr 20 2019: (Start) a(n) = 5*a(n-1)-4*a(n-2) for n>4.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 24 2025 12:17:47, revision 22)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267935.
