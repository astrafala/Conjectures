...
\title{A cross-alphabet identity for bounded-difference square arrays: OEIS A125537}
...
\begin{abstract}
OEIS A125537 carries an empirical identity relating its counts to those of the same problem over an
...
OEIS A125537 is ``Number of n X n arrays with entries in 1..7 in which adjacent entries differ by 4 or less (adjacent means in x or y directions).''. It has offset $0$ and begins
\[
1, 7, 1527, 11721313, 3050388738539, 27037458180935427547, 8157016618633297682357104957, 83768469285967811192253950787571671419,\ \dots
\]
...
most $d$. The entry is $T(7,4,n)$, and the conjecture is
\[
...
First, the count $T(7,4,n)$ was computed by an independent row-pair dynamic program and
reproduces the $4$ published terms of A125537 that the computation reaches,
...
\[
\begin{array}{rrrr}
n & T(7+1,4,n) & T(7,4,n) & F(n,4) \\ \hline
1 & 8 & 7 & 1 \\
2 & 2012 & 1527 & 489 \\
\end{array}
\]
...
\url{https://oeis.org}, 2026. Sequence A125537: \url{https://oeis.org/A125537}.
\end{thebibliography}
