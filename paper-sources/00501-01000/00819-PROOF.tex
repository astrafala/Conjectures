...
\title{The empirical recurrence for OEIS A229639, proved by counting defective colourings}
...
\begin{abstract}
OEIS A229639 counts the colourings of an array with $K=3$ colours that are proper except at
...
numbers. What is left is a walk count on $S=108$ vertices, and the empirical recurrence of
order $9$ contributed by R.~H.~Hardin follows from a finite exact computation.
\end{abstract}
...
OEIS A229639 is ``Number of defective 3-colorings of a 3 X n 0..2 array connected horizontally, diagonally and antidiagonally with exactly two mistakes, and colors introduced in row-major 0..2 order.''. It has offset $1$ and begins
\[
0, 39, 244, 1109, 6031, 28448, 136778, 633328,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 9*a(n-1) - 15*a(n-2) - 51*a(n-3) + 96*a(n-4) + 138*a(n-5) - 92*a(n-6) - 60*a(n-7) +4 8*a(n-8) - 8*a(n-9) for n > 12.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 27 2021 22:21:02, revision 7) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;9\,a(n-1) - 15\,a(n-2) - 51\,a(n-3) + 96\,a(n-4) + 138\,a(n-5) - 92\,a(n-6) - 60\,a(n-7) + 48\,a(n-8) - 8\,a(n-9)
\end{equation}
for all $n>12$.
...
Assembling the $3$ chains block-diagonally into $N$ of size $S=108$ with the weights of
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A229639.
