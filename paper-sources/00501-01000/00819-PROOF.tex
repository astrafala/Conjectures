...
\title{The cross-base identity for OEIS A125458, proved}
...
\begin{abstract}
OEIS A125458 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125458 is ``Number of base 23 circular n-digit numbers with adjacent digits differing by 8 or less.''. It has offset $0$ and begins
\[
1, 23, 319, 3767, 51151, 709643, 10047997, 143871219,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:38:53, revision 12)
...
the base is $23$ and the permitted difference is $d=8$, so the claim is that
\[
a_{23}(n)-a_{22}(n)\;=\;F_{8}(n)
\qquad\text{for every } n \text{ with } 8\lfloor n/2\rfloor+1\le23,
\]
...
at base $23$ reproduces all $17$ terms A125458 publishes, and at base $22$ all the
...
polynomial. In particular $a_{23}(n)-a_{22}(n)=F_{8}(n)$ for $1\le n\le5$, which
...
First, the model reproduces all $17$ terms A125458 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{8}(23,n)$ & $T_{8}(22,n)$ & $F_{8}(n)$ \\ \hline
1 & 23 & 22 & 1 \\
2 & 319 & 302 & 17 \\
3 & 3767 & 3550 & 217 \\
4 & 51151 & 47870 & 3281 \\
5 & 709643 & 659542 & 50101 \\
\end{tabular}
\end{center}
