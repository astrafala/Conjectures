...
\title{The cross-base identity for OEIS A125459, proved}
...
\begin{abstract}
OEIS A125459 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125459 is ``Number of base 24 circular n-digit numbers with adjacent digits differing by 8 or less.''. It has offset $0$ and begins
\[
1, 24, 336, 3984, 54432, 759744, 10830144, 156223392,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:39:00, revision 12)
...
the base is $24$ and the permitted difference is $d=8$, so the claim is that
\[
a_{24}(n)-a_{23}(n)\;=\;F_{8}(n)
\qquad\text{for every } n \text{ with } 8\lfloor n/2\rfloor+1\le24,
\]
...
at base $24$ reproduces all $17$ terms A125459 publishes, and at base $23$ all the
...
polynomial. In particular $a_{24}(n)-a_{23}(n)=F_{8}(n)$ for $1\le n\le5$, which
...
First, the model reproduces all $17$ terms A125459 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{8}(24,n)$ & $T_{8}(23,n)$ & $F_{8}(n)$ \\ \hline
1 & 24 & 23 & 1 \\
2 & 336 & 319 & 17 \\
3 & 3984 & 3767 & 217 \\
4 & 54432 & 51151 & 3281 \\
5 & 759744 & 709643 & 50101 \\
\end{tabular}
\end{center}
