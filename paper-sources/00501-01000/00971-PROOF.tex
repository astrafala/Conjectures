...
\title{The cross-base identity for OEIS A126544, proved}
...
\begin{abstract}
OEIS A126544 carries an empirical identity, in two clauses, relating its counts to those of the
...
OEIS A126544 is ``Number of base 23 n-digit numbers with adjacent digits differing by five or less.''. It has offset $0$ and begins
\[
1, 23, 223, 2233, 22593, 229845, 2344951, 23959555,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:18:22, revision 17)
this is still recorded as empirical, and nothing on the entry records it as proved.

For this entry the base is $23$ and the permitted difference is $d=5$, so the first clause
claims $a_{23}(n)-a_{22}(n)=11^{\,n-1}$ whenever $5(n-1)+1\le23$, that is for
$1\le n\le5$, and the second claims $a_{23}(n)-a_{22}(n)=11^{\,n-1}-2$ at the single
$n$ with $5(n-1)=23$.
...
arithmetic, $L_{5}$ at base $23$ reproduces all $18$ terms A126544 publishes.
...
First, the model reproduces all $18$ terms A126544 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $L_{5}(23,n)$ & $L_{5}(22,n)$ & $11^{\,n-1}$ \\ \hline
1 & 23 & 22 & 1 \\
2 & 223 & 212 & 11 \\
3 & 2233 & 2112 & 121 \\
4 & 22593 & 21262 & 1331 \\
5 & 229845 & 215204 & 14641 \\
\end{tabular}
\end{center}
