...
\title{The cross-base identity for OEIS A126408, proved}
...
\begin{abstract}
OEIS A126408 carries an empirical identity, in two clauses, relating its counts to those of the
...
OEIS A126408 is ``Number of base 21 n-digit numbers with adjacent digits differing by two or less.''. It has offset $0$ and begins
\[
1, 21, 99, 475, 2293, 11111, 53973, 262649,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:11:46, revision 9)
this is still recorded as empirical, and nothing on the entry records it as proved.

For this entry the base is $21$ and the permitted difference is $d=2$, so the first clause
claims $a_{21}(n)-a_{20}(n)=5^{\,n-1}$ whenever $2(n-1)+1\le21$, that is for
$1\le n\le11$, and the second claims $a_{21}(n)-a_{20}(n)=5^{\,n-1}-2$ at the single
$n$ with $2(n-1)=21$.
...
arithmetic, $L_{2}$ at base $21$ reproduces all $21$ terms A126408 publishes.
...
First, the model reproduces all $21$ terms A126408 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $L_{2}(21,n)$ & $L_{2}(20,n)$ & $5^{\,n-1}$ \\ \hline
1 & 21 & 20 & 1 \\
2 & 99 & 94 & 5 \\
3 & 475 & 450 & 25 \\
4 & 2293 & 2168 & 125 \\
5 & 11111 & 10486 & 625 \\
6 & 53973 & 50848 & 3125 \\
7 & 262649 & 247024 & 15625 \\
8 & 1279855 & 1201730 & 78125 \\
\end{tabular}
\end{center}
