...
\title{The cross-base identity for OEIS A124951, proved}
...
\begin{abstract}
OEIS A124951 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A124951 is ``Number of base 23 circular n-digit numbers with adjacent digits differing by 2 or less.''. It has offset $0$ and begins
\[
1, 23, 109, 407, 1777, 7813, 35245, 160953,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:17:30, revision 16)
...
the base is $23$ and the permitted difference is $d=2$, so the claim is that
\[
a_{23}(n)-a_{22}(n)\;=\;F_{2}(n)
\qquad\text{for every } n \text{ with } 2\lfloor n/2\rfloor+1\le23,
\]
...
at base $23$ reproduces all $22$ terms A124951 publishes, and at base $22$ all the
...
polynomial. In particular $a_{23}(n)-a_{22}(n)=F_{2}(n)$ for $1\le n\le23$, which
...
First, the model reproduces all $22$ terms A124951 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{2}(23,n)$ & $T_{2}(22,n)$ & $F_{2}(n)$ \\ \hline
1 & 23 & 22 & 1 \\
2 & 109 & 104 & 5 \\
3 & 407 & 388 & 19 \\
4 & 1777 & 1692 & 85 \\
5 & 7813 & 7432 & 381 \\
6 & 35245 & 33494 & 1751 \\
7 & 160953 & 152818 & 8135 \\
8 & 742857 & 704692 & 38165 \\
\end{tabular}
\end{center}
