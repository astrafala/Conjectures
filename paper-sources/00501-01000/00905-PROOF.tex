...
\title{A cross-alphabet identity for bounded-difference square arrays: OEIS A125547}
...
\begin{abstract}
OEIS A125547 carries an empirical identity relating its counts to those of the same problem over an
...
OEIS A125547 is ``Number of n X n arrays with entries in 1..12 in which adjacent entries differ by 9 or less (adjacent means in x or y directions).''. It has offset $0$ and begins
\[
1, 12, 17782, 3359860178, 80173083905265254, 241867388512389264991124102, 92239510661284205765199147022065188442, 4446848187806762069273466271591426934850445380022534,\ \dots
\]
...
most $d$. The entry is $T(12,9,n)$, and the conjecture is
\[
...
First, the count $T(12,9,n)$ was computed by an independent row-pair dynamic program and
reproduces the $3$ published terms of A125547 that the computation reaches,
...
\[
\begin{array}{rrrr}
n & T(12+1,9,n) & T(12,9,n) & F(n,9) \\ \hline
1 & 13 & 12 & 1 \\
2 & 21997 & 17782 & 4579 \\
\end{array}
\]
...
\url{https://oeis.org}, 2026. Sequence A125547: \url{https://oeis.org/A125547}.
\end{thebibliography}
