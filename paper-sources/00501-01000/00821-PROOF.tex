...
\title{The empirical recurrence for OEIS A279651, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A279651 imposes three things at once: a condition on each cell that reaches one row up and
...
OEIS A279651 is ``Number of n X 2 0..2 arrays with no element equal to a strict majority of its horizontal and antidiagonal neighbors, with the exception of exactly two elements, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
1, 3, 24, 232, 2232, 20880, 190656, 1707264,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 24*a(n-1) - 204*a(n-2) + 704*a(n-3) - 816*a(n-4) + 384*a(n-5) - 64*a(n-6) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 11 2019 06:59:34, revision 9) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A279651.
