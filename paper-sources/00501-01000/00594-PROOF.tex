...
\title{The empirical recurrence for OEIS A267524, proved from an exact model}
...
\begin{abstract}
OEIS A267524 carries an empirical recurrence of order $2$ contributed by Colin Barker. It is true, and it is
...
OEIS A267524 is ``Binary representation of the middle column of the "Rule 139" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 10, 100, 1001, 10011, 100111, 1001111, 10011111,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 16 2016 and Apr 19 2019: (Start) a(n) = 11*a(n-1) - 10*a(n-2) for n > 3. [n range correction - \_Karl V. Keller, Jr.\_, Apr 08 2022]
\end{quote}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267524.
