...
\title{The cross-base identity for OEIS A125394, proved}
...
\begin{abstract}
OEIS A125394 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125394 is ``Number of base 31 circular n-digit numbers with adjacent digits differing by 5 or less.''. It has offset $0$ and begins
\[
1, 31, 311, 2491, 23371, 222781, 2175107, 21527229,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:32:33, revision 12)
...
the base is $31$ and the permitted difference is $d=5$, so the claim is that
\[
a_{31}(n)-a_{30}(n)\;=\;F_{5}(n)
\qquad\text{for every } n \text{ with } 5\lfloor n/2\rfloor+1\le31,
\]
...
at base $31$ reproduces all $18$ terms A125394 publishes, and at base $30$ all the
...
polynomial. In particular $a_{31}(n)-a_{30}(n)=F_{5}(n)$ for $1\le n\le13$, which
...
First, the model reproduces all $18$ terms A125394 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{5}(31,n)$ & $T_{5}(30,n)$ & $F_{5}(n)$ \\ \hline
1 & 31 & 30 & 1 \\
2 & 311 & 300 & 11 \\
3 & 2491 & 2400 & 91 \\
4 & 23371 & 22480 & 891 \\
5 & 222781 & 213980 & 8801 \\
6 & 2175107 & 2086194 & 88913 \\
7 & 21527229 & 20618474 & 908755 \\
8 & 215372643 & 205995176 & 9377467 \\
\end{tabular}
\end{center}
