...
\title{The cross-base identity for OEIS A125471, proved}
...
\begin{abstract}
OEIS A125471 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125471 is ``Number of base 14 circular n-digit numbers with adjacent digits differing by 9 or less.''. It has offset $0$ and begins
\[
1, 14, 176, 2084, 26356, 334784, 4260722, 54242594,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:08:16, revision 14)
...
the base is $14$ and the permitted difference is $d=9$, so the claim is that
\[
a_{14}(n)-a_{13}(n)\;=\;F_{9}(n)
\qquad\text{for every } n \text{ with } 9\lfloor n/2\rfloor+1\le14,
\]
...
at base $14$ reproduces all $17$ terms A125471 publishes, and at base $13$ all the
...
polynomial. In particular $a_{14}(n)-a_{13}(n)=F_{9}(n)$ for $1\le n\le3$, which
...
First, the model reproduces all $17$ terms A125471 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{9}(14,n)$ & $T_{9}(13,n)$ & $F_{9}(n)$ \\ \hline
1 & 14 & 13 & 1 \\
2 & 176 & 157 & 19 \\
3 & 2084 & 1813 & 271 \\
\end{tabular}
