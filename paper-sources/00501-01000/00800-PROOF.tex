...
\title{The empirical recurrence for OEIS A281210, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A281210 imposes three things at once: a condition on each cell that reaches one column up and
...
OEIS A281210 is ``Number of 6 X n 0..1 arrays with no element equal to more than one of its horizontal and antidiagonal neighbors, with the exception of exactly one element, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
0, 420, 1120, 1588, 2602, 4248, 6838, 11010,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 4*a(n-1) - 4*a(n-2) - 2*a(n-3) + 4*a(n-4) - a(n-6) for n>12.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 18 2019 08:57:16, revision 7) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A281210.
