...
\title{The cross-base identity for OEIS A125427, proved}
...
\begin{abstract}
OEIS A125427 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125427 is ``Number of base 15 circular n-digit numbers with adjacent digits differing by 7 or less.''. It has offset $0$ and begins
\[
1, 15, 169, 1695, 19097, 219115, 2540413, 29568547,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:07:11, revision 14)
...
the base is $15$ and the permitted difference is $d=7$, so the claim is that
\[
a_{15}(n)-a_{14}(n)\;=\;F_{7}(n)
\qquad\text{for every } n \text{ with } 7\lfloor n/2\rfloor+1\le15,
\]
...
at base $15$ reproduces all $18$ terms A125427 publishes, and at base $14$ all the
...
polynomial. In particular $a_{15}(n)-a_{14}(n)=F_{7}(n)$ for $1\le n\le5$, which
...
First, the model reproduces all $18$ terms A125427 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{7}(15,n)$ & $T_{7}(14,n)$ & $F_{7}(n)$ \\ \hline
1 & 15 & 14 & 1 \\
2 & 169 & 154 & 15 \\
3 & 1695 & 1526 & 169 \\
4 & 19097 & 16842 & 2255 \\
5 & 219115 & 188734 & 30381 \\
\end{tabular}
\end{center}
