...
\title{The cross-base identity for OEIS A125326, proved}
...
\begin{abstract}
OEIS A125326 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125326 is ``Number of base 16 circular n-digit numbers with adjacent digits differing by 3 or less.''. It has offset $0$ and begins
\[
1, 16, 100, 508, 3004, 18036, 110980, 692204,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:02:43, revision 13)
...
the base is $16$ and the permitted difference is $d=3$, so the claim is that
\[
a_{16}(n)-a_{15}(n)\;=\;F_{3}(n)
\qquad\text{for every } n \text{ with } 3\lfloor n/2\rfloor+1\le16,
\]
...
at base $16$ reproduces all $20$ terms A125326 publishes, and at base $15$ all the
...
polynomial. In particular $a_{16}(n)-a_{15}(n)=F_{3}(n)$ for $1\le n\le11$, which
...
First, the model reproduces all $20$ terms A125326 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{3}(16,n)$ & $T_{3}(15,n)$ & $F_{3}(n)$ \\ \hline
1 & 16 & 15 & 1 \\
2 & 100 & 93 & 7 \\
3 & 508 & 471 & 37 \\
4 & 3004 & 2773 & 231 \\
5 & 18036 & 16585 & 1451 \\
6 & 110980 & 101649 & 9331 \\
7 & 692204 & 631513 & 60691 \\
8 & 4364284 & 3965717 & 398567 \\
\end{tabular}
\end{center}
