...
\title{The cross-base identity for OEIS A126495, proved}
...
\begin{abstract}
OEIS A126495 carries an empirical identity, in two clauses, relating its counts to those of the
...
OEIS A126495 is ``Number of base 27 n-digit numbers with adjacent digits differing by three or less.''. It has offset $0$ and begins
\[
1, 27, 177, 1183, 7961, 53795, 364489, 2474351,\ \dots
\]
The entry states, as an empirical claim and never marked settled:
\begin{quote}
[Empirical] a(base,n)=a(base-1,n)+7\textasciicircum{}(n-1) for base>=3n-2; a(base,n)=a(base-1,n)+7\textasciicircum{}(n-1)-2 when base=3n-3
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:14:31, revision 9)
this is still recorded as empirical, and nothing on the entry records it as proved.

For this entry the base is $27$ and the permitted difference is $d=3$, so the first clause
claims $a_{27}(n)-a_{26}(n)=7^{\,n-1}$ whenever $3(n-1)+1\le27$, that is for
$1\le n\le9$, and the second claims $a_{27}(n)-a_{26}(n)=7^{\,n-1}-2$ at the single
$n$ with $3(n-1)=27$.
...
arithmetic, $L_{3}$ at base $27$ reproduces all $20$ terms A126495 publishes.
...
First, the model reproduces all $20$ terms A126495 publishes, exactly, in integer
...
$1\le n\le9$, both sides computed from the definition and not from the theorem:

\begin{center}
\begin{tabular}{rrrr}
$n$ & $L_{3}(27,n)$ & $L_{3}(26,n)$ & $7^{\,n-1}$ \\ \hline
1 & 27 & 26 & 1 \\
2 & 177 & 170 & 7 \\
3 & 1183 & 1134 & 49 \\
4 & 7961 & 7618 & 343 \\
5 & 53795 & 51394 & 2401 \\
6 & 364489 & 347682 & 16807 \\
7 & 2474351 & 2356702 & 117649 \\
8 & 16821389 & 15997846 & 823543 \\
\end{tabular}
\end{center}
...
Third, the second clause was evaluated at its own index. For this entry the second clause bites at $n=10$, where $b=27=3(n-1)$: there $L_{3}(27,10)-L_{3}(26,10)=40353605$ and $7^{9}-2=40353605$.

\section*{References}
\begin{enumerate}
\item The OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences},
\url{https://oeis.org/A126495}.
\end{enumerate}
