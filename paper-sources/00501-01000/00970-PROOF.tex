...
\title{The cross-base identity for OEIS A126518, proved}
...
\begin{abstract}
OEIS A126518 carries an empirical identity, in two clauses, relating its counts to those of the
...
OEIS A126518 is ``Number of base 23 n-digit numbers with adjacent digits differing by four or less.''. It has offset $0$ and begins
\[
1, 23, 187, 1563, 13187, 111855, 951843, 8116589,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:16:21, revision 11)
this is still recorded as empirical, and nothing on the entry records it as proved.

For this entry the base is $23$ and the permitted difference is $d=4$, so the first clause
claims $a_{23}(n)-a_{22}(n)=9^{\,n-1}$ whenever $4(n-1)+1\le23$, that is for
$1\le n\le6$, and the second claims $a_{23}(n)-a_{22}(n)=9^{\,n-1}-2$ at the single
$n$ with $4(n-1)=23$.
...
arithmetic, $L_{4}$ at base $23$ reproduces all $19$ terms A126518 publishes.
...
First, the model reproduces all $19$ terms A126518 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $L_{4}(23,n)$ & $L_{4}(22,n)$ & $9^{\,n-1}$ \\ \hline
1 & 23 & 22 & 1 \\
2 & 187 & 178 & 9 \\
3 & 1563 & 1482 & 81 \\
4 & 13187 & 12458 & 729 \\
5 & 111855 & 105294 & 6561 \\
6 & 951843 & 892794 & 59049 \\
\end{tabular}
\end{center}
