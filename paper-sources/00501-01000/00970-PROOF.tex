...
\title{The empirical recurrence for OEIS A220191, proved by transfer matrix}
...
\begin{abstract}
OEIS A220191 counts the distinct indicator arrays obtained from the $n\times2$ arrays over
...
OEIS A220191 is ``Majority value maps: number of n X 2 binary arrays indicating the locations of corresponding elements equal to at least half of their king-move neighbors in a random 0..2 n X 2 array.''. It has offset $1$ and begins
\[
2, 6, 25, 88, 297, 1009, 3464, 11908,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + 2*a(n-2) + 8*a(n-3) + 2*a(n-4) + 16*a(n-5) + 2*a(n-6) + 6*a(n-7) for n>10.
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 13 2018 11:13:18, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 2\,a(n-2) + 8\,a(n-3) + 2\,a(n-4) + 16\,a(n-5) + 2\,a(n-6) + 6\,a(n-7)
\]
for every $n>10$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A220191.
