...
\title{The empirical recurrence for OEIS A281403, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A281403 imposes three things at once: a condition on each cell that reaches one column up and
...
OEIS A281403 is ``Number of 4Xn 0..1 arrays with no element equal to more than two of its horizontal, diagonal or antidiagonal neighbors, with the exception of exactly one element, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
0, 36, 438, 1020, 2146, 3736, 6276, 10740,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 4*a(n-1) -6*a(n-2) +6*a(n-3) -5*a(n-4) +3*a(n-6) -2*a(n-7) +2*a(n-8) -a(n-10) for n>16
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 21 2017 08:04:24, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) - 6\,a(n-2) + 6\,a(n-3) - 5\,a(n-4) + 3\,a(n-6) - 2\,a(n-7) + 2\,a(n-8) - a(n-10)
\end{equation}
for all $n>16$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A281403.
