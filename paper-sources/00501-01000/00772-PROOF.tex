...
\title{The cross-base identity for OEIS A125441, proved}
...
\begin{abstract}
OEIS A125441 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125441 is ``Number of base 29 circular n-digit numbers with adjacent digits differing by 7 or less.''. It has offset $0$ and begins
\[
1, 29, 379, 4061, 50667, 644449, 8391139, 110770129,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:37:12, revision 12)
...
the base is $29$ and the permitted difference is $d=7$, so the claim is that
\[
a_{29}(n)-a_{28}(n)\;=\;F_{7}(n)
\qquad\text{for every } n \text{ with } 7\lfloor n/2\rfloor+1\le29,
\]
...
at base $29$ reproduces all $17$ terms A125441 publishes, and at base $28$ all the
...
polynomial. In particular $a_{29}(n)-a_{28}(n)=F_{7}(n)$ for $1\le n\le9$, which
...
First, the model reproduces all $17$ terms A125441 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{7}(29,n)$ & $T_{7}(28,n)$ & $F_{7}(n)$ \\ \hline
1 & 29 & 28 & 1 \\
2 & 379 & 364 & 15 \\
3 & 4061 & 3892 & 169 \\
4 & 50667 & 48412 & 2255 \\
5 & 644449 & 614068 & 30381 \\
6 & 8391139 & 7972636 & 418503 \\
7 & 110770129 & 104937364 & 5832765 \\
8 & 1477678507 & 1395605212 & 82073295 \\
\end{tabular}
\end{center}
