...
\title{The cross-base identity for OEIS A126492, proved}
...
\begin{abstract}
OEIS A126492 carries an empirical identity, in two clauses, relating its counts to those of the
...
OEIS A126492 is ``Number of base 24 n-digit numbers with adjacent digits differing by three or less.''. It has offset $0$ and begins
\[
1, 24, 156, 1036, 6932, 46592, 314068, 2121404,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:14:15, revision 12)
this is still recorded as empirical, and nothing on the entry records it as proved.

For this entry the base is $24$ and the permitted difference is $d=3$, so the first clause
claims $a_{24}(n)-a_{23}(n)=7^{\,n-1}$ whenever $3(n-1)+1\le24$, that is for
$1\le n\le8$, and the second claims $a_{24}(n)-a_{23}(n)=7^{\,n-1}-2$ at the single
$n$ with $3(n-1)=24$.
...
arithmetic, $L_{3}$ at base $24$ reproduces all $20$ terms A126492 publishes.
...
First, the model reproduces all $20$ terms A126492 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $L_{3}(24,n)$ & $L_{3}(23,n)$ & $7^{\,n-1}$ \\ \hline
1 & 24 & 23 & 1 \\
2 & 156 & 149 & 7 \\
3 & 1036 & 987 & 49 \\
4 & 6932 & 6589 & 343 \\
5 & 46592 & 44191 & 2401 \\
6 & 314068 & 297261 & 16807 \\
7 & 2121404 & 2003755 & 117649 \\
8 & 14350760 & 13527217 & 823543 \\
\end{tabular}
\end{center}
...
Third, the second clause was evaluated at its own index. For this entry the second clause bites at $n=9$, where $b=24=3(n-1)$: there $L_{3}(24,9)-L_{3}(23,9)=5764799$ and $7^{8}-2=5764799$.

\section*{References}
\begin{enumerate}
\item The OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences},
\url{https://oeis.org/A126492}.
\end{enumerate}
