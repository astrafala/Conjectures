...
\title{The cross-base identity for OEIS A126550, proved}
...
\begin{abstract}
OEIS A126550 carries an empirical identity, in two clauses, relating its counts to those of the
...
OEIS A126550 is ``Number of base 29 n-digit numbers with adjacent digits differing by five or less.''. It has offset $0$ and begins
\[
1, 29, 289, 2959, 30579, 317691, 3311243, 34585355,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:18:55, revision 11)
this is still recorded as empirical, and nothing on the entry records it as proved.

For this entry the base is $29$ and the permitted difference is $d=5$, so the first clause
claims $a_{29}(n)-a_{28}(n)=11^{\,n-1}$ whenever $5(n-1)+1\le29$, that is for
$1\le n\le6$, and the second claims $a_{29}(n)-a_{28}(n)=11^{\,n-1}-2$ at the single
$n$ with $5(n-1)=29$.
...
arithmetic, $L_{5}$ at base $29$ reproduces all $18$ terms A126550 publishes.
...
First, the model reproduces all $18$ terms A126550 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $L_{5}(29,n)$ & $L_{5}(28,n)$ & $11^{\,n-1}$ \\ \hline
1 & 29 & 28 & 1 \\
2 & 289 & 278 & 11 \\
3 & 2959 & 2838 & 121 \\
4 & 30579 & 29248 & 1331 \\
5 & 317691 & 303050 & 14641 \\
6 & 3311243 & 3150192 & 161051 \\
\end{tabular}
\end{center}
