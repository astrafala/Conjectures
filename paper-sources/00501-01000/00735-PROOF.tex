...
\title{The cross-base identity for OEIS A125355, proved}
...
\begin{abstract}
OEIS A125355 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125355 is ``Number of base 18 circular n-digit numbers with adjacent digits differing by 4 or less.''. It has offset $0$ and begins
\[
1, 18, 142, 918, 6902, 52818, 413974, 3289290,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:04:15, revision 13)
...
the base is $18$ and the permitted difference is $d=4$, so the claim is that
\[
a_{18}(n)-a_{17}(n)\;=\;F_{4}(n)
\qquad\text{for every } n \text{ with } 4\lfloor n/2\rfloor+1\le18,
\]
...
at base $18$ reproduces all $20$ terms A125355 publishes, and at base $17$ all the
...
polynomial. In particular $a_{18}(n)-a_{17}(n)=F_{4}(n)$ for $1\le n\le9$, which
...
First, the model reproduces all $20$ terms A125355 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{4}(18,n)$ & $T_{4}(17,n)$ & $F_{4}(n)$ \\ \hline
1 & 18 & 17 & 1 \\
2 & 142 & 133 & 9 \\
3 & 918 & 857 & 61 \\
4 & 6902 & 6413 & 489 \\
5 & 52818 & 48867 & 3951 \\
6 & 413974 & 381313 & 32661 \\
7 & 3289290 & 3016163 & 273127 \\
8 & 26413814 & 24107789 & 2306025 \\
\end{tabular}
\end{center}
