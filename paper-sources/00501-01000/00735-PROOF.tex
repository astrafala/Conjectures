...
\title{The cross-base identity for OEIS A125388, proved}
...
\begin{abstract}
OEIS A125388 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125388 is ``Number of base 25 circular n-digit numbers with adjacent digits differing by 5 or less.''. It has offset $0$ and begins
\[
1, 25, 245, 1945, 18025, 169975, 1641629, 16074699,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:31:43, revision 12)
...
the base is $25$ and the permitted difference is $d=5$, so the claim is that
\[
a_{25}(n)-a_{24}(n)\;=\;F_{5}(n)
\qquad\text{for every } n \text{ with } 5\lfloor n/2\rfloor+1\le25,
\]
...
at base $25$ reproduces all $18$ terms A125388 publishes, and at base $24$ all the
...
polynomial. In particular $a_{25}(n)-a_{24}(n)=F_{5}(n)$ for $1\le n\le9$, which
...
First, the model reproduces all $18$ terms A125388 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{5}(25,n)$ & $T_{5}(24,n)$ & $F_{5}(n)$ \\ \hline
1 & 25 & 24 & 1 \\
2 & 245 & 234 & 11 \\
3 & 1945 & 1854 & 91 \\
4 & 18025 & 17134 & 891 \\
5 & 169975 & 161174 & 8801 \\
6 & 1641629 & 1552716 & 88913 \\
7 & 16074699 & 15165944 & 908755 \\
8 & 159107841 & 149730374 & 9377467 \\
\end{tabular}
\end{center}
