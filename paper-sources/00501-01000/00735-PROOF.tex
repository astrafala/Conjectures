...
\title{The cross-base identity for OEIS A125403, proved}
...
\begin{abstract}
OEIS A125403 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125403 is ``Number of base 15 circular n-digit numbers with adjacent digits differing by 6 or less.''. It has offset $0$ and begins
\[
1, 15, 153, 1359, 13733, 141695, 1486035, 15703213,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:06:01, revision 14)
...
the base is $15$ and the permitted difference is $d=6$, so the claim is that
\[
a_{15}(n)-a_{14}(n)\;=\;F_{6}(n)
\qquad\text{for every } n \text{ with } 6\lfloor n/2\rfloor+1\le15,
\]
...
at base $15$ reproduces all $18$ terms A125403 publishes, and at base $14$ all the
...
polynomial. In particular $a_{15}(n)-a_{14}(n)=F_{6}(n)$ for $1\le n\le5$, which
...
First, the model reproduces all $18$ terms A125403 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{6}(15,n)$ & $T_{6}(14,n)$ & $F_{6}(n)$ \\ \hline
1 & 15 & 14 & 1 \\
2 & 153 & 140 & 13 \\
3 & 1359 & 1232 & 127 \\
4 & 13733 & 12264 & 1469 \\
5 & 141695 & 124544 & 17151 \\
\end{tabular}
\end{center}
