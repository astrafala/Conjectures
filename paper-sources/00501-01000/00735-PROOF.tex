...
\title{The cross-base identity for OEIS A125342, proved}
...
\begin{abstract}
OEIS A125342 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125342 is ``Number of base 32 circular n-digit numbers with adjacent digits differing by 3 or less.''. It has offset $0$ and begins
\[
1, 32, 212, 1100, 6700, 41252, 260276, 1663260,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:24:46, revision 11)
...
the base is $32$ and the permitted difference is $d=3$, so the claim is that
\[
a_{32}(n)-a_{31}(n)\;=\;F_{3}(n)
\qquad\text{for every } n \text{ with } 3\lfloor n/2\rfloor+1\le32,
\]
...
at base $32$ reproduces all $20$ terms A125342 publishes, and at base $31$ all the
...
polynomial. In particular $a_{32}(n)-a_{31}(n)=F_{3}(n)$ for $1\le n\le21$, which
...
First, the model reproduces all $20$ terms A125342 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{3}(32,n)$ & $T_{3}(31,n)$ & $F_{3}(n)$ \\ \hline
1 & 32 & 31 & 1 \\
2 & 212 & 205 & 7 \\
3 & 1100 & 1063 & 37 \\
4 & 6700 & 6469 & 231 \\
5 & 41252 & 39801 & 1451 \\
6 & 260276 & 250945 & 9331 \\
7 & 1663260 & 1602569 & 60691 \\
8 & 10741356 & 10342789 & 398567 \\
\end{tabular}
\end{center}
