...
\title{The empirical recurrence for OEIS A267850, proved from an exact model}
...
\begin{abstract}
OEIS A267850 carries an empirical recurrence of order $2$ contributed by Colin Barker. It is true, and it is
...
OEIS A267850 is ``Binary representation of the n-th iteration of the "Rule 229" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 10, 11110, 1111110, 111111110, 11111111110, 1111111111110, 111111111111110,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 21 2016: (Start) a(n) = 101*a(n-1)-100*a(n-2) for n>3.
\end{quote}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267850.
