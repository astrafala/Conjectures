...
\title{The cross-base identity for OEIS A124898, proved}
...
\begin{abstract}
OEIS A124898 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A124898 is ``Number of base 17 circular n-digit numbers with adjacent digits differing by 2 or less.''. It has offset $0$ and begins
\[
1, 17, 79, 293, 1267, 5527, 24739, 112143,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:16:33, revision 16)
...
the base is $17$ and the permitted difference is $d=2$, so the claim is that
\[
a_{17}(n)-a_{16}(n)\;=\;F_{2}(n)
\qquad\text{for every } n \text{ with } 2\lfloor n/2\rfloor+1\le17,
\]
...
at base $17$ reproduces all $22$ terms A124898 publishes, and at base $16$ all the
...
polynomial. In particular $a_{17}(n)-a_{16}(n)=F_{2}(n)$ for $1\le n\le17$, which
...
First, the model reproduces all $22$ terms A124898 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{2}(17,n)$ & $T_{2}(16,n)$ & $F_{2}(n)$ \\ \hline
1 & 17 & 16 & 1 \\
2 & 79 & 74 & 5 \\
3 & 293 & 274 & 19 \\
4 & 1267 & 1182 & 85 \\
5 & 5527 & 5146 & 381 \\
6 & 24739 & 22988 & 1751 \\
7 & 112143 & 104008 & 8135 \\
8 & 513867 & 475702 & 38165 \\
\end{tabular}
\end{center}
