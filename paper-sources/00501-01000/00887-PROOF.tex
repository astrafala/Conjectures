...
\title{The cross-base identity for OEIS A126406, proved}
...
\begin{abstract}
OEIS A126406 carries an empirical identity, in two clauses, relating its counts to those of the
...
OEIS A126406 is ``Number of base 19 n-digit numbers with adjacent digits differing by two or less.''. It has offset $0$ and begins
\[
1, 19, 89, 425, 2043, 9861, 47723, 231399,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:11:35, revision 9)
this is still recorded as empirical, and nothing on the entry records it as proved.

For this entry the base is $19$ and the permitted difference is $d=2$, so the first clause
claims $a_{19}(n)-a_{18}(n)=5^{\,n-1}$ whenever $2(n-1)+1\le19$, that is for
$1\le n\le10$, and the second claims $a_{19}(n)-a_{18}(n)=5^{\,n-1}-2$ at the single
$n$ with $2(n-1)=19$.
...
arithmetic, $L_{2}$ at base $19$ reproduces all $21$ terms A126406 publishes.
...
First, the model reproduces all $21$ terms A126406 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $L_{2}(19,n)$ & $L_{2}(18,n)$ & $5^{\,n-1}$ \\ \hline
1 & 19 & 18 & 1 \\
2 & 89 & 84 & 5 \\
3 & 425 & 400 & 25 \\
4 & 2043 & 1918 & 125 \\
5 & 9861 & 9236 & 625 \\
6 & 47723 & 44598 & 3125 \\
7 & 231399 & 215774 & 15625 \\
8 & 1123605 & 1045480 & 78125 \\
\end{tabular}
\end{center}
