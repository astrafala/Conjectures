...
\title{The cross-base identity for OEIS A125350, proved}
...
\begin{abstract}
OEIS A125350 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125350 is ``Number of base 13 circular n-digit numbers with adjacent digits differing by 4 or less.''. It has offset $0$ and begins
\[
1, 13, 97, 613, 4457, 33063, 250669, 1923655,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:03:47, revision 13)
...
the base is $13$ and the permitted difference is $d=4$, so the claim is that
\[
a_{13}(n)-a_{12}(n)\;=\;F_{4}(n)
\qquad\text{for every } n \text{ with } 4\lfloor n/2\rfloor+1\le13,
\]
...
at base $13$ reproduces all $20$ terms A125350 publishes, and at base $12$ all the
...
polynomial. In particular $a_{13}(n)-a_{12}(n)=F_{4}(n)$ for $1\le n\le7$, which
...
First, the model reproduces all $20$ terms A125350 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{4}(13,n)$ & $T_{4}(12,n)$ & $F_{4}(n)$ \\ \hline
1 & 13 & 12 & 1 \\
2 & 97 & 88 & 9 \\
3 & 613 & 552 & 61 \\
4 & 4457 & 3968 & 489 \\
5 & 33063 & 29112 & 3951 \\
6 & 250669 & 218008 & 32661 \\
7 & 1923655 & 1650528 & 273127 \\
\end{tabular}
\end{center}
