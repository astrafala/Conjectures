...
\title{The empirical recurrence for OEIS A264670, proved by transfer matrix}
...
\begin{abstract}
OEIS A264670 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=3$ rows in which
...
OEIS A264670 is ``Number of (n+1) X (2+1) arrays of permutations of 0..n*3+2 with each element having directed index change -1,-1 1,0 -1,-2 -2,-2 or 0,1.''. It has offset $1$ and begins
\[
1, 2, 9, 19, 44, 108, 264, 649,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + a(n-3) + 3*a(n-4) + 2*a(n-5) - a(n-6) + 4*a(n-7) - a(n-8) - a(n-10).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 08 2019 15:18:59, revision 7) this is still
...
\[
(i-h_i,\,j-h_j)\;\in\;\{(-2,-2),\ (-1,-2),\ (-1,-1),\ (0,1),\ (1,0)\},
\]
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + a(n-3) + 3\,a(n-4) + 2\,a(n-5) - a(n-6) + 4\,a(n-7) - a(n-8) - a(n-10)
\]
for every $n>8$.
\end{theorem}
...
Second, the transfer model reproduces all $29$ terms this entry publishes, exactly, in
integer arithmetic.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264670.
