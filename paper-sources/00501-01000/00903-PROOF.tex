...
\title{The empirical recurrence for OEIS A264423, proved by transfer matrix}
...
\begin{abstract}
OEIS A264423 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=3$ columns in which
...
OEIS A264423 is ``Number of (2+1) X (n+1) arrays of permutations of 0..n*3+2 with each element having directed index change 0,1 2,2 1,0 -1,2 -2,-1 or -1,-1.''. It has offset $1$ and begins
\[
1, 3, 12, 37, 119, 385, 1252, 4061,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) + a(n-3) + 5*a(n-4) + a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 18 2021 17:50:35, revision 13) this is still
...
\[
(i-h_i,\,j-h_j)\;\in\;\{(-1,-2),\ (-1,-1),\ (0,1),\ (1,0),\ (2,-1),\ (2,2)\},
\]
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + a(n-3) + 5\,a(n-4) + a(n-7)
\]
for every $n>5$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264423.
