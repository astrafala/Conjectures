...
\title{The empirical recurrence for OEIS A281797, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A281797 imposes three things at once: a condition on each cell that reaches one row up and
...
OEIS A281797 is ``Number of nX3 0..1 arrays with no element unequal to a strict majority of its horizontal, diagonal and antidiagonal neighbors, with the exception of exactly two elements, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
0, 6, 75, 324, 865, 2272, 5191, 11141,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 6*a(n-1) -12*a(n-2) +5*a(n-3) +12*a(n-4) -12*a(n-5) -3*a(n-6) +6*a(n-7) -a(n-9) for n>16
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 30 2017 10:34:16, revision 5) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A281797.
