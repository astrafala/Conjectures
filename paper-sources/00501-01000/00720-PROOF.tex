...
\title{The cross-base identity for OEIS A125387, proved}
...
\begin{abstract}
OEIS A125387 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125387 is ``Number of base 24 circular n-digit numbers with adjacent digits differing by 5 or less.''. It has offset $0$ and begins
\[
1, 24, 234, 1854, 17134, 161174, 1552716, 15165944,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:31:36, revision 14)
...
the base is $24$ and the permitted difference is $d=5$, so the claim is that
\[
a_{24}(n)-a_{23}(n)\;=\;F_{5}(n)
\qquad\text{for every } n \text{ with } 5\lfloor n/2\rfloor+1\le24,
\]
...
at base $24$ reproduces all $18$ terms A125387 publishes, and at base $23$ all the
...
polynomial. In particular $a_{24}(n)-a_{23}(n)=F_{5}(n)$ for $1\le n\le9$, which
...
First, the model reproduces all $18$ terms A125387 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{5}(24,n)$ & $T_{5}(23,n)$ & $F_{5}(n)$ \\ \hline
1 & 24 & 23 & 1 \\
2 & 234 & 223 & 11 \\
3 & 1854 & 1763 & 91 \\
4 & 17134 & 16243 & 891 \\
5 & 161174 & 152373 & 8801 \\
6 & 1552716 & 1463803 & 88913 \\
7 & 15165944 & 14257189 & 908755 \\
8 & 149730374 & 140352907 & 9377467 \\
\end{tabular}
\end{center}
