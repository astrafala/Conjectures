...
\title{The cross-base identity for OEIS A126407, proved}
...
\begin{abstract}
OEIS A126407 carries an empirical identity, in two clauses, relating its counts to those of the
...
OEIS A126407 is ``Number of base 20 n-digit numbers with adjacent digits differing by two or less.''. It has offset $0$ and begins
\[
1, 20, 94, 450, 2168, 10486, 50848, 247024,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:11:40, revision 9)
this is still recorded as empirical, and nothing on the entry records it as proved.

For this entry the base is $20$ and the permitted difference is $d=2$, so the first clause
claims $a_{20}(n)-a_{19}(n)=5^{\,n-1}$ whenever $2(n-1)+1\le20$, that is for
$1\le n\le10$, and the second claims $a_{20}(n)-a_{19}(n)=5^{\,n-1}-2$ at the single
$n$ with $2(n-1)=20$.
...
arithmetic, $L_{2}$ at base $20$ reproduces all $21$ terms A126407 publishes.
...
First, the model reproduces all $21$ terms A126407 publishes, exactly, in integer
...
$1\le n\le10$, both sides computed from the definition and not from the theorem:

\begin{center}
\begin{tabular}{rrrr}
$n$ & $L_{2}(20,n)$ & $L_{2}(19,n)$ & $5^{\,n-1}$ \\ \hline
1 & 20 & 19 & 1 \\
2 & 94 & 89 & 5 \\
3 & 450 & 425 & 25 \\
4 & 2168 & 2043 & 125 \\
5 & 10486 & 9861 & 625 \\
6 & 50848 & 47723 & 3125 \\
7 & 247024 & 231399 & 15625 \\
8 & 1201730 & 1123605 & 78125 \\
\end{tabular}
\end{center}

\noindent and the difference of the second and third columns is the fourth at every row shown
and at every row up to $n=10$.

Third, the second clause was evaluated at its own index. For this entry the second clause bites at $n=11$, where $b=20=2(n-1)$: there $L_{2}(20,11)-L_{2}(19,11)=9765623$ and $5^{10}-2=9765623$.

\section*{References}
\begin{enumerate}
\item The OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences},
\url{https://oeis.org/A126407}.
\end{enumerate}
