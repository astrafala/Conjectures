...
\title{The cross-base identity for OEIS A126403, proved}
...
\begin{abstract}
OEIS A126403 carries an empirical identity, in two clauses, relating its counts to those of the
...
OEIS A126403 is ``Number of base 16 n-digit numbers with adjacent digits differing by two or less.''. It has offset $0$ and begins
\[
1, 16, 74, 350, 1668, 7986, 38348, 184524,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:11:18, revision 12)
this is still recorded as empirical, and nothing on the entry records it as proved.

For this entry the base is $16$ and the permitted difference is $d=2$, so the first clause
claims $a_{16}(n)-a_{15}(n)=5^{\,n-1}$ whenever $2(n-1)+1\le16$, that is for
$1\le n\le8$, and the second claims $a_{16}(n)-a_{15}(n)=5^{\,n-1}-2$ at the single
$n$ with $2(n-1)=16$.
...
arithmetic, $L_{2}$ at base $16$ reproduces all $21$ terms A126403 publishes.
...
First, the model reproduces all $21$ terms A126403 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $L_{2}(16,n)$ & $L_{2}(15,n)$ & $5^{\,n-1}$ \\ \hline
1 & 16 & 15 & 1 \\
2 & 74 & 69 & 5 \\
3 & 350 & 325 & 25 \\
4 & 1668 & 1543 & 125 \\
5 & 7986 & 7361 & 625 \\
6 & 38348 & 35223 & 3125 \\
7 & 184524 & 168899 & 15625 \\
8 & 889230 & 811105 & 78125 \\
\end{tabular}
\end{center}
...
Third, the second clause was evaluated at its own index. For this entry the second clause bites at $n=9$, where $b=16=2(n-1)$: there $L_{2}(16,9)-L_{2}(15,9)=390623$ and $5^{8}-2=390623$.

\section*{References}
\begin{enumerate}
\item The OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences},
\url{https://oeis.org/A126403}.
\end{enumerate}
