...
\title{The cross-base identity for OEIS A126413, proved}
...
\begin{abstract}
OEIS A126413 carries an empirical identity, in two clauses, relating its counts to those of the
...
OEIS A126413 is ``Number of base 26 n-digit numbers with adjacent digits differing by two or less.''. It has offset $0$ and begins
\[
1, 26, 124, 600, 2918, 14236, 69598, 340774,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:12:14, revision 9)
this is still recorded as empirical, and nothing on the entry records it as proved.

For this entry the base is $26$ and the permitted difference is $d=2$, so the first clause
claims $a_{26}(n)-a_{25}(n)=5^{\,n-1}$ whenever $2(n-1)+1\le26$, that is for
$1\le n\le13$, and the second claims $a_{26}(n)-a_{25}(n)=5^{\,n-1}-2$ at the single
$n$ with $2(n-1)=26$.
...
arithmetic, $L_{2}$ at base $26$ reproduces all $21$ terms A126413 publishes.
...
First, the model reproduces all $21$ terms A126413 publishes, exactly, in integer
...
$1\le n\le13$, both sides computed from the definition and not from the theorem:

\begin{center}
\begin{tabular}{rrrr}
$n$ & $L_{2}(26,n)$ & $L_{2}(25,n)$ & $5^{\,n-1}$ \\ \hline
1 & 26 & 25 & 1 \\
2 & 124 & 119 & 5 \\
3 & 600 & 575 & 25 \\
4 & 2918 & 2793 & 125 \\
5 & 14236 & 13611 & 625 \\
6 & 69598 & 66473 & 3125 \\
7 & 340774 & 325149 & 15625 \\
8 & 1670480 & 1592355 & 78125 \\
\end{tabular}
\end{center}
...
Third, the second clause was evaluated at its own index. For this entry the second clause bites at $n=14$, where $b=26=2(n-1)$: there $L_{2}(26,14)-L_{2}(25,14)=1220703123$ and $5^{13}-2=1220703123$.

\section*{References}
\begin{enumerate}
\item The OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences},
\url{https://oeis.org/A126413}.
\end{enumerate}
