...
\title{The empirical recurrence for OEIS A267881, proved from an exact model}
...
\begin{abstract}
OEIS A267881 carries an empirical recurrence of order $2$ contributed by Colin Barker. It is true, and it is
...
OEIS A267881 is ``Number of ON (black) cells in the n-th iteration of the "Rule 233" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 0, 3, 6, 9, 11, 13, 15,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 22 2016 and Apr 20 2019: (Start) a(n) = 2*a(n-1)-a(n-2) for n>2.
\end{quote}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267881.
