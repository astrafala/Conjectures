...
\title{The cross-base identity for OEIS A126494, proved}
...
\begin{abstract}
OEIS A126494 carries an empirical identity, in two clauses, relating its counts to those of the
...
OEIS A126494 is ``Number of base 26 n-digit numbers with adjacent digits differing by three or less.''. It has offset $0$ and begins
\[
1, 26, 170, 1134, 7618, 51394, 347682, 2356702,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:14:26, revision 9)
this is still recorded as empirical, and nothing on the entry records it as proved.

For this entry the base is $26$ and the permitted difference is $d=3$, so the first clause
claims $a_{26}(n)-a_{25}(n)=7^{\,n-1}$ whenever $3(n-1)+1\le26$, that is for
$1\le n\le9$, and the second claims $a_{26}(n)-a_{25}(n)=7^{\,n-1}-2$ at the single
$n$ with $3(n-1)=26$.
...
arithmetic, $L_{3}$ at base $26$ reproduces all $20$ terms A126494 publishes.
...
First, the model reproduces all $20$ terms A126494 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $L_{3}(26,n)$ & $L_{3}(25,n)$ & $7^{\,n-1}$ \\ \hline
1 & 26 & 25 & 1 \\
2 & 170 & 163 & 7 \\
3 & 1134 & 1085 & 49 \\
4 & 7618 & 7275 & 343 \\
5 & 51394 & 48993 & 2401 \\
6 & 347682 & 330875 & 16807 \\
7 & 2356702 & 2239053 & 117649 \\
8 & 15997846 & 15174303 & 823543 \\
\end{tabular}
\end{center}
