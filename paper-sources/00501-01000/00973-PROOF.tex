...
\title{The cross-base identity for OEIS A126525, proved}
...
\begin{abstract}
OEIS A126525 carries an empirical identity, in two clauses, relating its counts to those of the
...
OEIS A126525 is ``Number of base 30 n-digit numbers with adjacent digits differing by four or less.''. It has offset $0$ and begins
\[
1, 30, 250, 2130, 18290, 157782, 1365186, 11836674,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:16:59, revision 11)
this is still recorded as empirical, and nothing on the entry records it as proved.

For this entry the base is $30$ and the permitted difference is $d=4$, so the first clause
claims $a_{30}(n)-a_{29}(n)=9^{\,n-1}$ whenever $4(n-1)+1\le30$, that is for
$1\le n\le8$, and the second claims $a_{30}(n)-a_{29}(n)=9^{\,n-1}-2$ at the single
$n$ with $4(n-1)=30$.
...
arithmetic, $L_{4}$ at base $30$ reproduces all $19$ terms A126525 publishes.
...
First, the model reproduces all $19$ terms A126525 publishes, exactly, in integer
...
$1\le n\le8$, both sides computed from the definition and not from the theorem:

\begin{center}
\begin{tabular}{rrrr}
$n$ & $L_{4}(30,n)$ & $L_{4}(29,n)$ & $9^{\,n-1}$ \\ \hline
1 & 30 & 29 & 1 \\
2 & 250 & 241 & 9 \\
3 & 2130 & 2049 & 81 \\
4 & 18290 & 17561 & 729 \\
5 & 157782 & 151221 & 6561 \\
6 & 1365186 & 1306137 & 59049 \\
7 & 11836674 & 11305233 & 531441 \\
8 & 102784246 & 98001277 & 4782969 \\
\end{tabular}
\end{center}

\noindent and the difference of the second and third columns is the fourth at every row shown
and at every row up to $n=8$.
