...
\title{The cross-base identity for OEIS A125367, proved}
...
\begin{abstract}
OEIS A125367 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125367 is ``Number of base 30 circular n-digit numbers with adjacent digits differing by 4 or less.''. It has offset $0$ and begins
\[
1, 30, 250, 1650, 12770, 100230, 805906, 6566814,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:28:15, revision 11)
...
the base is $30$ and the permitted difference is $d=4$, so the claim is that
\[
a_{30}(n)-a_{29}(n)\;=\;F_{4}(n)
\qquad\text{for every } n \text{ with } 4\lfloor n/2\rfloor+1\le30,
\]
...
at base $30$ reproduces all $19$ terms A125367 publishes, and at base $29$ all the
...
polynomial. In particular $a_{30}(n)-a_{29}(n)=F_{4}(n)$ for $1\le n\le15$, which
...
First, the model reproduces all $19$ terms A125367 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{4}(30,n)$ & $T_{4}(29,n)$ & $F_{4}(n)$ \\ \hline
1 & 30 & 29 & 1 \\
2 & 250 & 241 & 9 \\
3 & 1650 & 1589 & 61 \\
4 & 12770 & 12281 & 489 \\
5 & 100230 & 96279 & 3951 \\
6 & 805906 & 773245 & 32661 \\
7 & 6566814 & 6293687 & 273127 \\
8 & 54086114 & 51780089 & 2306025 \\
\end{tabular}
\end{center}
