...
\title{The cross-base identity for OEIS A125359, proved}
...
\begin{abstract}
OEIS A125359 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125359 is ``Number of base 22 circular n-digit numbers with adjacent digits differing by 4 or less.''. It has offset $0$ and begins
\[
1, 22, 178, 1162, 8858, 68622, 544618, 4381798,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:26:58, revision 11)
...
the base is $22$ and the permitted difference is $d=4$, so the claim is that
\[
a_{22}(n)-a_{21}(n)\;=\;F_{4}(n)
\qquad\text{for every } n \text{ with } 4\lfloor n/2\rfloor+1\le22,
\]
...
at base $22$ reproduces all $20$ terms A125359 publishes, and at base $21$ all the
...
polynomial. In particular $a_{22}(n)-a_{21}(n)=F_{4}(n)$ for $1\le n\le11$, which
...
First, the model reproduces all $20$ terms A125359 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{4}(22,n)$ & $T_{4}(21,n)$ & $F_{4}(n)$ \\ \hline
1 & 22 & 21 & 1 \\
2 & 178 & 169 & 9 \\
3 & 1162 & 1101 & 61 \\
4 & 8858 & 8369 & 489 \\
5 & 68622 & 64671 & 3951 \\
6 & 544618 & 511957 & 32661 \\
7 & 4381798 & 4108671 & 273127 \\
8 & 35637914 & 33331889 & 2306025 \\
\end{tabular}
\end{center}
