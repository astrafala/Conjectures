...
\title{The empirical recurrence for OEIS A279972, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A279972 imposes three things at once: a condition on each cell that reaches one row up and
...
OEIS A279972 is ``Number of n X 3 0..1 arrays with no element equal to a strict majority of its horizontal and antidiagonal neighbors, with the exception of exactly two elements, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
0, 9, 50, 296, 1650, 8666, 43543, 211650,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 15*a(n-1) - 90*a(n-2) + 281*a(n-3) - 510*a(n-4) + 585*a(n-5) - 437*a(n-6) + 210*a(n-7) - 60*a(n-8) + 8*a(n-9) for n>10.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 12 2019 12:02:57, revision 7) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;15\,a(n-1) - 90\,a(n-2) + 281\,a(n-3) - 510\,a(n-4) + 585\,a(n-5) - 437\,a(n-6) + 210\,a(n-7) - 60\,a(n-8) + 8\,a(n-9)
\end{equation}
for all $n>10$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A279972.
