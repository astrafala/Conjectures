...
\title{The empirical recurrence for OEIS A187158, proved from an exact model}
...
\begin{abstract}
OEIS A187158 carries an empirical recurrence of order $3$. It is true, and it is
...
\begin{quote}
Empirical: a(n) = 100*n\^{}2 - 584*n + 808 for n>3. a(n) = 3*a(n-1) - 3*a(n-2) + a(n-3) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 20 2018 09:27:59, revision 10)
...
SHAPE when one is a translate of the other. There are exactly $100$ shapes: self-avoiding
...
Write $w^\ast$ for the largest bounding-box side over all $100$ shapes. Once $n\ge w^\ast$
