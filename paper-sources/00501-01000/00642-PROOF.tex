...
\title{The empirical recurrence for OEIS A280310, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A280310 imposes three things at once: a condition on each cell that reaches one row up and
...
OEIS A280310 is ``Number of nX3 0..2 arrays with no element equal to more than one of its horizontal and vertical neighbors, with the exception of exactly two elements, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
0, 15, 788, 20274, 415198, 7506237, 125467047, 1986983748,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 31 2016 09:05:05, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;30\,a(n-1) - 222\,a(n-2) - 734\,a(n-3) + 8955\,a(n-4) + 17679\,a(n-5) - 93547\,a(n-6) - 212481\,a(n-7) + 239184\,a(n-8) + 1034132\,a(n-9) + 1156653\,a(n-10) - 1089108\,a(n-11) - 5976636\,a(n-12) - 5117229\,a(n-13) + 2977569\,a(n-14) + 11073336\,a(n-15) + 13515996\,a(n-16) - 4312494\,a(n-17) - 13983961\,a(n-18) - 6912540\,a(n-19) - 1327035\,a(n-20) + 13168450\,a(n-21) - 1804992\,a(n-22) - 4913097\,a(n-23) + 761601\,a(n-24) - 310968\,a(n-25) + 2250468\,a(n-26) - 46384\,a(n-27) - 448224\,a(n-28) + 213120\,a(n-29) - 8640\,a(n-30) + 157440\,a(n-31) + 4608\,a(n-32) - 12288\,a(n-33) + 9216\,a(n-34) + 4096\,a(n-36)
\end{equation}
for all $n>38$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A280310.
