...
\title{The empirical recurrence for OEIS A263813, proved by transfer matrix}
...
\begin{abstract}
OEIS A263813 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=4$ rows in which
...
OEIS A263813 is ``Number of (n+1)X(3+1) arrays of permutations of 0..n*4+3 with each element having index change (+-,+-) 0,0 0,1 0,2 or 1,0.''. It has offset $1$ and begins
\[
572, 18776, 643905, 21876416, 744805993, 25345430544, 862592912860, 29356226845638,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 12:14:34, revision 8) this is still
...
\[
(i-h_i,\,j-h_j)\;\in\;\{(-1,0),\ (0,-2),\ (0,-1),\ (0,0),\ (0,1),\ (0,2),\ (1,0)\},
\]
...
\begin{theorem}
\[
a(n)\;=\;30\,a(n-1) + 196\,a(n-2) - 1915\,a(n-3) - 3770\,a(n-4) + 30778\,a(n-5) - 14022\,a(n-6) - 75638\,a(n-7) + 75638\,a(n-8) + 14022\,a(n-9) - 30778\,a(n-10) + 3770\,a(n-11) + 1915\,a(n-12) - 196\,a(n-13) - 30\,a(n-14) + a(n-15)
\]
for every $n>13$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A263813.
