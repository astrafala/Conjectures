...
\title{The cross-base identity for OEIS A125377, proved}
...
\begin{abstract}
OEIS A125377 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125377 is ``Number of base 14 circular n-digit numbers with adjacent digits differing by 5 or less.''. It has offset $0$ and begins
\[
1, 14, 124, 944, 8224, 73164, 663592, 6079164,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:04:49, revision 14)
...
the base is $14$ and the permitted difference is $d=5$, so the claim is that
\[
a_{14}(n)-a_{13}(n)\;=\;F_{5}(n)
\qquad\text{for every } n \text{ with } 5\lfloor n/2\rfloor+1\le14,
\]
...
at base $14$ reproduces all $19$ terms A125377 publishes, and at base $13$ all the
...
polynomial. In particular $a_{14}(n)-a_{13}(n)=F_{5}(n)$ for $1\le n\le5$, which
...
First, the model reproduces all $19$ terms A125377 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{5}(14,n)$ & $T_{5}(13,n)$ & $F_{5}(n)$ \\ \hline
1 & 14 & 13 & 1 \\
2 & 124 & 113 & 11 \\
3 & 944 & 853 & 91 \\
4 & 8224 & 7333 & 891 \\
