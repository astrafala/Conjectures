...
\title{The empirical recurrence for OEIS A290829, proved from an exact model}
...
\begin{abstract}
OEIS A290829 carries an empirical recurrence of order $3$ contributed by Colin Barker. It is true, and it is
...
\begin{quote}
Conjectures from \_Colin Barker\_, Aug 12 2017: (Start) a(n) = a(n-1) + 4*a(n-2) - 4*a(n-3) for n>5.
\end{quote}
