...
\title{The empirical recurrence for OEIS A217640, proved by transfer matrix}
...
\begin{abstract}
OEIS A217640 counts the distinct arrays obtained by applying a fixed local operation to every cell
of an array over a bounded alphabet, and carries an empirical recurrence of order $14$
...
$S=119$ states, after which the conjectured recurrence is settled by a finite exact
computation.
\end{abstract}
...
OEIS A217640 is ``Number of nX3 arrays of the minimum value of corresponding elements and their horizontal, vertical or antidiagonal neighbors in a random 0..2 nX3 array.''. It has offset $1$ and begins
\[
9, 27, 163, 877, 5119, 29101, 166193, 949883,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 17:27:08, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

Let $R=\{0,\dots,2\}^{3}$ be the set of rows and let the neighbours of
...
\]
There are $S=119$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite.
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) + 3\,a(n-2) + 9\,a(n-3) - 10\,a(n-4) - 7\,a(n-5) - 166\,a(n-6) - 3\,a(n-7) - 122\,a(n-8) - 71\,a(n-9) + 165\,a(n-10) + 43\,a(n-11) - 43\,a(n-12) - 7\,a(n-13) + 3\,a(n-14)
\]
for every $n>15$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A217640.
