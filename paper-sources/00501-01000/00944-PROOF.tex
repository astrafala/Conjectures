...
\title{The cross-base identity for OEIS A126535, proved}
...
\begin{abstract}
OEIS A126535 carries an empirical identity, in two clauses, relating its counts to those of the
...
OEIS A126535 is ``Number of base 14 n-digit numbers with adjacent digits differing by five or less.''. It has offset $0$ and begins
\[
1, 14, 124, 1144, 10616, 98600, 915904, 8508084,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:17:33, revision 14)
this is still recorded as empirical, and nothing on the entry records it as proved.

For this entry the base is $14$ and the permitted difference is $d=5$, so the first clause
claims $a_{14}(n)-a_{13}(n)=11^{\,n-1}$ whenever $5(n-1)+1\le14$, that is for
$1\le n\le3$, and the second claims $a_{14}(n)-a_{13}(n)=11^{\,n-1}-2$ at the single
$n$ with $5(n-1)=14$.
...
arithmetic, $L_{5}$ at base $14$ reproduces all $19$ terms A126535 publishes.
...
First, the model reproduces all $19$ terms A126535 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $L_{5}(14,n)$ & $L_{5}(13,n)$ & $11^{\,n-1}$ \\ \hline
1 & 14 & 13 & 1 \\
2 & 124 & 113 & 11 \\
3 & 1144 & 1023 & 121 \\
\end{tabular}
