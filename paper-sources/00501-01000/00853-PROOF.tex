...
\title{A cross-alphabet identity for bounded-difference square arrays: OEIS A125532}
...
\begin{abstract}
OEIS A125532 carries an empirical identity relating its counts to those of the same problem over an
...
OEIS A125532 is ``Number of n X n arrays with entries in 1..4 in which adjacent entries differ by 2 or less (adjacent means in x or y directions).''. It has offset $0$ and begins
\[
1, 4, 162, 75398, 386994338, 22039625597766, 13914188992963436802, 97391265572623379728784646,\ \dots
\]
...
most $d$. The entry is $T(4,2,n)$, and the conjecture is
\[
...
First, the count $T(4,2,n)$ was computed by an independent row-pair dynamic program and
reproduces the $5$ published terms of A125532 that the computation reaches,
...
\[
\begin{array}{rrrr}
n & T(4+1,2,n) & T(4,2,n) & F(n,2) \\ \hline
1 & 5 & 4 & 1 \\
2 & 247 & 162 & 85 \\
\end{array}
\]
...
\url{https://oeis.org}, 2026. Sequence A125532: \url{https://oeis.org/A125532}.
\end{thebibliography}
