...
\begin{abstract}
OEIS A267884 carries an empirical recurrence of order $1$ contributed by Colin Barker. It is true, and it is
...
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 24 2016 and Apr 20 2019: (Start) a(n) = a(n-1) for n>3.
\end{quote}
