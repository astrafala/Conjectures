...
\title{The empirical recurrence for OEIS A266327, proved from an exact model}
...
\begin{abstract}
OEIS A266327 carries an empirical recurrence of order $2$ contributed by Colin Barker. It is true, and it is
...
\begin{quote}
Conjectures from \_Colin Barker\_, Dec 28 2015 and Apr 18 2019: (Start) a(n) = a(n-2) for n>1.
\end{quote}
...
vanish from $n=0+1$ onwards, and the run exceeds $S+2$, which by
...
First, the model reproduces all $74$ terms the entry publishes, exactly, in integer
