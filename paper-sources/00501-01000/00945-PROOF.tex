...
\title{The cross-base identity for OEIS A126519, proved}
...
\begin{abstract}
OEIS A126519 carries an empirical identity, in two clauses, relating its counts to those of the
...
OEIS A126519 is ``Number of base 24 n-digit numbers with adjacent digits differing by four or less.''. It has offset $0$ and begins
\[
1, 24, 196, 1644, 13916, 118416, 1010892, 8648028,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:16:26, revision 11)
this is still recorded as empirical, and nothing on the entry records it as proved.

For this entry the base is $24$ and the permitted difference is $d=4$, so the first clause
claims $a_{24}(n)-a_{23}(n)=9^{\,n-1}$ whenever $4(n-1)+1\le24$, that is for
$1\le n\le6$, and the second claims $a_{24}(n)-a_{23}(n)=9^{\,n-1}-2$ at the single
$n$ with $4(n-1)=24$.
...
arithmetic, $L_{4}$ at base $24$ reproduces all $19$ terms A126519 publishes.
...
First, the model reproduces all $19$ terms A126519 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $L_{4}(24,n)$ & $L_{4}(23,n)$ & $9^{\,n-1}$ \\ \hline
1 & 24 & 23 & 1 \\
2 & 196 & 187 & 9 \\
3 & 1644 & 1563 & 81 \\
4 & 13916 & 13187 & 729 \\
5 & 118416 & 111855 & 6561 \\
6 & 1010892 & 951843 & 59049 \\
\end{tabular}
\end{center}
...
Third, the second clause was evaluated at its own index. For this entry the second clause bites at $n=7$, where $b=24=4(n-1)$: there $L_{4}(24,7)-L_{4}(23,7)=531439$ and $9^{6}-2=531439$.

\section*{References}
\begin{enumerate}
\item The OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences},
\url{https://oeis.org/A126519}.
\end{enumerate}
