...
\title{The cross-base identity for OEIS A126549, proved}
...
\begin{abstract}
OEIS A126549 carries an empirical identity, in two clauses, relating its counts to those of the
...
OEIS A126549 is ``Number of base 28 n-digit numbers with adjacent digits differing by five or less.''. It has offset $0$ and begins
\[
1, 28, 278, 2838, 29248, 303050, 3150192, 32813808,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:18:49, revision 11)
this is still recorded as empirical, and nothing on the entry records it as proved.

For this entry the base is $28$ and the permitted difference is $d=5$, so the first clause
claims $a_{28}(n)-a_{27}(n)=11^{\,n-1}$ whenever $5(n-1)+1\le28$, that is for
$1\le n\le6$, and the second claims $a_{28}(n)-a_{27}(n)=11^{\,n-1}-2$ at the single
$n$ with $5(n-1)=28$.
...
arithmetic, $L_{5}$ at base $28$ reproduces all $18$ terms A126549 publishes.
...
First, the model reproduces all $18$ terms A126549 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $L_{5}(28,n)$ & $L_{5}(27,n)$ & $11^{\,n-1}$ \\ \hline
1 & 28 & 27 & 1 \\
2 & 278 & 267 & 11 \\
3 & 2838 & 2717 & 121 \\
4 & 29248 & 27917 & 1331 \\
5 & 303050 & 288409 & 14641 \\
6 & 3150192 & 2989141 & 161051 \\
\end{tabular}
\end{center}
