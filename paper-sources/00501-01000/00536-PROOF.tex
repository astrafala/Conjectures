...
\title{The empirical recurrence for OEIS A284235, proved from an exact model}
...
\begin{abstract}
OEIS A284235 carries an empirical recurrence of order $3$ contributed by Chai Wah Wu. It is true, and it is
...
OEIS A284235 is ``Binary representation of the x-axis, from the left edge to the origin, of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 833", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 0, 11, 101, 1010, 10101, 101010, 1010101,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Chai Wah Wu\_, May 04 2024: (Start) a(n) = 10*a(n-1) + a(n-2) - 10*a(n-3) for n > 5.
\end{quote}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A284235.
