...
\title{The empirical recurrence for OEIS A267623, proved from an exact model}
...
\begin{abstract}
OEIS A267623 carries an empirical recurrence of order $2$ contributed by Colin Barker. It is true, and it is
...
OEIS A267623 is ``Binary representation of the middle column of the "Rule 187" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 10, 101, 1011, 10111, 101111, 1011111, 10111111,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 19 2016 and Apr 16 2019: (Start) a(n) = 11*a(n-1)-10*a(n-2) for n>2.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 16 2025 08:33:29, revision 49)
...
For this entry the column is periodic with period $q=1$ from $n=2$: the period above is a
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267623.
