...
\title{The cross-base identity for OEIS A125351, proved}
...
\begin{abstract}
OEIS A125351 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125351 is ``Number of base 14 circular n-digit numbers with adjacent digits differing by 4 or less.''. It has offset $0$ and begins
\[
1, 14, 106, 674, 4946, 37014, 283330, 2196782,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:03:53, revision 13)
...
the base is $14$ and the permitted difference is $d=4$, so the claim is that
\[
a_{14}(n)-a_{13}(n)\;=\;F_{4}(n)
\qquad\text{for every } n \text{ with } 4\lfloor n/2\rfloor+1\le14,
\]
that is, for $1\le n\le7$.
...
at base $14$ reproduces all $20$ terms A125351 publishes, and at base $13$ all the
...
polynomial. In particular $a_{14}(n)-a_{13}(n)=F_{4}(n)$ for $1\le n\le7$, which
...
First, the model reproduces all $20$ terms A125351 publishes, exactly, in integer
...
$1\le n\le7$, with both sides computed from the definition and not from the theorem:

\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{4}(14,n)$ & $T_{4}(13,n)$ & $F_{4}(n)$ \\ \hline
1 & 14 & 13 & 1 \\
2 & 106 & 97 & 9 \\
3 & 674 & 613 & 61 \\
4 & 4946 & 4457 & 489 \\
5 & 37014 & 33063 & 3951 \\
6 & 283330 & 250669 & 32661 \\
7 & 2196782 & 1923655 & 273127 \\
\end{tabular}
\end{center}
