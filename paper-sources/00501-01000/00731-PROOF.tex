...
\title{The cross-base identity for OEIS A125329, proved}
...
\begin{abstract}
OEIS A125329 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125329 is ``Number of base 19 circular n-digit numbers with adjacent digits differing by 3 or less.''. It has offset $0$ and begins
\[
1, 19, 121, 619, 3697, 22389, 138973, 874277,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:02:53, revision 13)
...
the base is $19$ and the permitted difference is $d=3$, so the claim is that
\[
a_{19}(n)-a_{18}(n)\;=\;F_{3}(n)
\qquad\text{for every } n \text{ with } 3\lfloor n/2\rfloor+1\le19,
\]
...
at base $19$ reproduces all $20$ terms A125329 publishes, and at base $18$ all the
...
polynomial. In particular $a_{19}(n)-a_{18}(n)=F_{3}(n)$ for $1\le n\le13$, which
...
First, the model reproduces all $20$ terms A125329 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{3}(19,n)$ & $T_{3}(18,n)$ & $F_{3}(n)$ \\ \hline
1 & 19 & 18 & 1 \\
2 & 121 & 114 & 7 \\
3 & 619 & 582 & 37 \\
4 & 3697 & 3466 & 231 \\
5 & 22389 & 20938 & 1451 \\
6 & 138973 & 129642 & 9331 \\
7 & 874277 & 813586 & 60691 \\
8 & 5559985 & 5161418 & 398567 \\
\end{tabular}
\end{center}
