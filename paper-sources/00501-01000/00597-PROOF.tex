...
\begin{abstract}
OEIS A267535 carries an empirical recurrence of order $2$ contributed by Colin Barker. It is true, and it is
...
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 17 2016 and Apr 19 2019: (Start) a(n) = 101*a(n-1)-100*a(n-2) for n>3.
\end{quote}
