...
\title{The empirical recurrence for OEIS A267538, proved from an exact model}
...
\begin{abstract}
OEIS A267538 carries an empirical recurrence of order $2$ contributed by Colin Barker. It is true, and it is
...
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 17 2016 and Apr 20 2019: (Start) a(n) = 11*a(n-1)-10*a(n-2) for n > 4. [n range correction by \_Karl V. Keller, Jr.\_, Apr 23 2022]
\end{quote}
