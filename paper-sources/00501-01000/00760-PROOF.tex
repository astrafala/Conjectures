...
\title{The cross-base identity for OEIS A125429, proved}
...
\begin{abstract}
OEIS A125429 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125429 is ``Number of base 17 circular n-digit numbers with adjacent digits differing by 7 or less.''. It has offset $0$ and begins
\[
1, 17, 199, 2033, 23607, 279877, 3370321, 40874221,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:36:00, revision 12)
...
the base is $17$ and the permitted difference is $d=7$, so the claim is that
\[
a_{17}(n)-a_{16}(n)\;=\;F_{7}(n)
\qquad\text{for every } n \text{ with } 7\lfloor n/2\rfloor+1\le17,
\]
...
at base $17$ reproduces all $17$ terms A125429 publishes, and at base $16$ all the
...
polynomial. In particular $a_{17}(n)-a_{16}(n)=F_{7}(n)$ for $1\le n\le5$, which
...
First, the model reproduces all $17$ terms A125429 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{7}(17,n)$ & $T_{7}(16,n)$ & $F_{7}(n)$ \\ \hline
1 & 17 & 16 & 1 \\
2 & 199 & 184 & 15 \\
3 & 2033 & 1864 & 169 \\
4 & 23607 & 21352 & 2255 \\
5 & 279877 & 249496 & 30381 \\
\end{tabular}
\end{center}
