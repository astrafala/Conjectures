...
\title{The cross-base identity for OEIS A125375, proved}
...
\begin{abstract}
OEIS A125375 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125375 is ``Number of base 12 circular n-digit numbers with adjacent digits differing by 5 or less.''. It has offset $0$ and begins
\[
1, 12, 102, 762, 6442, 55562, 486102, 4278734,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:04:38, revision 16)
...
the base is $12$ and the permitted difference is $d=5$, so the claim is that
\[
a_{12}(n)-a_{11}(n)\;=\;F_{5}(n)
\qquad\text{for every } n \text{ with } 5\lfloor n/2\rfloor+1\le12,
\]
...
at base $12$ reproduces all $19$ terms A125375 publishes, and at base $11$ all the
...
polynomial. In particular $a_{12}(n)-a_{11}(n)=F_{5}(n)$ for $1\le n\le5$, which
...
First, the model reproduces all $19$ terms A125375 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{5}(12,n)$ & $T_{5}(11,n)$ & $F_{5}(n)$ \\ \hline
1 & 12 & 11 & 1 \\
2 & 102 & 91 & 11 \\
3 & 762 & 671 & 91 \\
4 & 6442 & 5551 & 891 \\
