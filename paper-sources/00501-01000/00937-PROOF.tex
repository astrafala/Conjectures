...
\title{The empirical recurrence for OEIS A229583, proved by counting defective colourings}
...
\begin{abstract}
OEIS A229583 counts the colourings of an array with $K=3$ colours that are proper except at
...
OEIS A229583 is ``Number of defective 3-colorings of an n X 5 0..2 array connected horizontally and antidiagonally with exactly one mistake, and colors introduced in row-major 0..2 order.''. It has offset $1$ and begins
\[
16, 444, 9156, 167364, 2865780, 47091780, 752194836, 11768185764,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 30*a(n-1) - 261*a(n-2) + 540*a(n-3) - 324*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 19 2018 15:14:55, revision 9) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A229583.
