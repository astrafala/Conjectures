...
\title{The empirical recurrence for OEIS A280806, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A280806 imposes three things at once: a condition on each cell that reaches one row up and
...
OEIS A280806 is ``Number of nX4 0..1 arrays with no element equal to more than two of its horizontal, vertical and antidiagonal neighbors, with the exception of exactly two elements, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
0, 18, 332, 2146, 9715, 37644, 133067, 440282,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 08 2017 09:43:58, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;10\,a(n-1) - 39\,a(n-2) + 72\,a(n-3) - 57\,a(n-4) + 12\,a(n-5) - 31\,a(n-6) + 61\,a(n-7) + 39\,a(n-8) - 148\,a(n-9) + 58\,a(n-10) + 72\,a(n-11) + 2\,a(n-12) - 92\,a(n-13) - 33\,a(n-14) + 142\,a(n-15) - 25\,a(n-16) - 90\,a(n-17) + 22\,a(n-18) + 50\,a(n-19) + 3\,a(n-20) - 47\,a(n-21) + 5\,a(n-22) + 30\,a(n-23) - 12\,a(n-24) - 9\,a(n-25) + 6\,a(n-26) + a(n-27) - a(n-28)
\end{equation}
for all $n>36$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A280806.
