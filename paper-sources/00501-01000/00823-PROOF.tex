...
\title{The empirical recurrence for OEIS A221430, proved by transfer matrix}
...
\begin{abstract}
OEIS A221430 counts the distinct OCCUPANCY arrays obtained when every cell of an $n\times2$ grid
...
one, on $S=596$ states, after which the conjectured recurrence is settled by a finite exact
computation.
\end{abstract}
...
OEIS A221430 is ``Number of nX2 arrays of occupancy after each element moves to some king-move neighbor, without consecutive moves in the same direction.''. It has offset $1$ and begins
\[
1, 31, 286, 3295, 34477, 371116, 3952193, 42233189,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 19:39:22, revision 9) this is still
...
$S=596$ reachable sets. In particular $a$ is $C$-finite.
...
\begin{theorem}
\[
a(n)\;=\;13\,a(n-1) - 13\,a(n-2) - 151\,a(n-3) + 286\,a(n-4) - 287\,a(n-5) + 833\,a(n-6) - 966\,a(n-7) + 488\,a(n-8) + 39\,a(n-9) - 63\,a(n-10) + 26\,a(n-11) - 2\,a(n-12)
\]
for every $n>12$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221430.
