...
\title{The empirical recurrence for OEIS A187514, proved from an exact model}
...
\begin{abstract}
OEIS A187514 carries an empirical recurrence of order $3$. It is true, and it is
...
OEIS A187514 is ``Number of 9-step S, E, and NW-moving king's tours on an n X n board summed over all starting positions.''. It has offset $1$ and begins
\[
0, 0, 6, 450, 2872, 8522, 17564, 29834,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 1569*n\^{}2 - 11252*n + 19434 for n>7. a(n) = 3*a(n-1) - 3*a(n-2) + a(n-3) for n>10.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 24 2018 11:08:46, revision 10)
...
The number of steps is fixed at $9$ cells, hence $8$ moves, and it is the BOARD
...
SHAPE when one is a translate of the other. There are exactly $1569$ shapes: self-avoiding
sequences of $9$ distinct cells in $\mathbf{Z}^{2}$ with each consecutive difference in
...
Write $w^\ast$ for the largest bounding-box side over all $1569$ shapes. Once $n\ge w^\ast$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A187514.
