...
\title{The cross-base identity for OEIS A126546, proved}
...
\begin{abstract}
OEIS A126546 carries an empirical identity, in two clauses, relating its counts to those of the
...
OEIS A126546 is ``Number of base 25 n-digit numbers with adjacent digits differing by five or less.''. It has offset $0$ and begins
\[
1, 25, 245, 2475, 25255, 259127, 2667039, 27499769,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:18:33, revision 11)
this is still recorded as empirical, and nothing on the entry records it as proved.

For this entry the base is $25$ and the permitted difference is $d=5$, so the first clause
claims $a_{25}(n)-a_{24}(n)=11^{\,n-1}$ whenever $5(n-1)+1\le25$, that is for
$1\le n\le5$, and the second claims $a_{25}(n)-a_{24}(n)=11^{\,n-1}-2$ at the single
$n$ with $5(n-1)=25$.
...
arithmetic, $L_{5}$ at base $25$ reproduces all $18$ terms A126546 publishes.
...
First, the model reproduces all $18$ terms A126546 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $L_{5}(25,n)$ & $L_{5}(24,n)$ & $11^{\,n-1}$ \\ \hline
1 & 25 & 24 & 1 \\
2 & 245 & 234 & 11 \\
3 & 2475 & 2354 & 121 \\
4 & 25255 & 23924 & 1331 \\
5 & 259127 & 244486 & 14641 \\
\end{tabular}
\end{center}
...
Third, the second clause was evaluated at its own index. For this entry the second clause bites at $n=6$, where $b=25=5(n-1)$: there $L_{5}(25,6)-L_{5}(24,6)=161049$ and $11^{5}-2=161049$.

\section*{References}
\begin{enumerate}
\item The OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences},
\url{https://oeis.org/A126546}.
\end{enumerate}
