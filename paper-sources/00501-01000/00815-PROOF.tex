...
\title{The empirical recurrence for OEIS A230937, proved by transfer matrix}
...
\begin{abstract}
OEIS A230937 counts the white-square subarrays of arrays of width $5$ over $\{0,1,2,3\}$ in which
...
OEIS A230937 is ``Number of white-square subarrays of (n+2) X (3+2) 0..3 arrays x(i,j) with each element diagonally or antidiagonally next to at least one element with value (x(i,j)+1) mod 4, no adjacent elements equal, and upper left element zero.''. It has offset $1$ and begins
\[
2, 16, 34, 232, 522, 3768, 8450, 60824,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 16*a(n-2) +3*a(n-4) -10*a(n-6) +24*a(n-8) -16*a(n-10).
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 24 2018 02:48:02, revision 8) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=473.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A230937.
