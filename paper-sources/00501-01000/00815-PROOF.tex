...
\title{The cross-base identity for OEIS A125415, proved}
...
\begin{abstract}
OEIS A125415 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125415 is ``Number of base 27 circular n-digit numbers with adjacent digits differing by 6 or less.''. It has offset $0$ and begins
\[
1, 27, 309, 2883, 31361, 347507, 3942849, 45357283,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:34:38, revision 12)
...
the base is $27$ and the permitted difference is $d=6$, so the claim is that
\[
a_{27}(n)-a_{26}(n)\;=\;F_{6}(n)
\qquad\text{for every } n \text{ with } 6\lfloor n/2\rfloor+1\le27,
\]
...
at base $27$ reproduces all $17$ terms A125415 publishes, and at base $26$ all the
...
polynomial. In particular $a_{27}(n)-a_{26}(n)=F_{6}(n)$ for $1\le n\le9$, which
...
First, the model reproduces all $17$ terms A125415 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{6}(27,n)$ & $T_{6}(26,n)$ & $F_{6}(n)$ \\ \hline
1 & 27 & 26 & 1 \\
2 & 309 & 296 & 13 \\
3 & 2883 & 2756 & 127 \\
4 & 31361 & 29892 & 1469 \\
5 & 347507 & 330356 & 17151 \\
6 & 3942849 & 3738086 & 204763 \\
7 & 45357283 & 42883958 & 2473325 \\
8 & 527368217 & 497205916 & 30162301 \\
\end{tabular}
\end{center}
