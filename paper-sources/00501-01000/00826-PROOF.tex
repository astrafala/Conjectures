...
\title{The cross-base identity for OEIS A125465, proved}
...
\begin{abstract}
OEIS A125465 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125465 is ``Number of base 30 circular n-digit numbers with adjacent digits differing by 8 or less.''. It has offset $0$ and begins
\[
1, 30, 438, 5286, 74118, 1060350, 15523062, 230350206,\ \dots
\]
The entry states, as an empirical claim and never marked settled:
\begin{quote}
[Empirical] a(base,n)=a(base-1,n)+F(8) for base>=8.int(n/2)+1 and F(d) is the largest coefficient in (1+x+...+x\textasciicircum{}(2d))\textasciicircum{}n
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:39:42, revision 12)
...
the base is $30$ and the permitted difference is $d=8$, so the claim is that
\[
a_{30}(n)-a_{29}(n)\;=\;F_{8}(n)
\qquad\text{for every } n \text{ with } 8\lfloor n/2\rfloor+1\le30,
\]
...
together with a choice of where it starts. Evaluated exactly in integer arithmetic, $T_{8}$
at base $30$ reproduces all $17$ terms A125465 publishes, and at base $29$ all the
...
polynomial. In particular $a_{30}(n)-a_{29}(n)=F_{8}(n)$ for $1\le n\le7$, which
...
First, the model reproduces all $17$ terms A125465 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{8}(30,n)$ & $T_{8}(29,n)$ & $F_{8}(n)$ \\ \hline
1 & 30 & 29 & 1 \\
2 & 438 & 421 & 17 \\
3 & 5286 & 5069 & 217 \\
4 & 74118 & 70837 & 3281 \\
5 & 1060350 & 1010249 & 50101 \\
6 & 15523062 & 14740909 & 782153 \\
7 & 230350206 & 217995737 & 12354469 \\
\end{tabular}
\end{center}
