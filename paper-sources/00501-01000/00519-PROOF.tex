...
\title{The empirical recurrence for OEIS A188153, proved from an exact model}
...
\begin{abstract}
OEIS A188153 carries an empirical recurrence of order $3$. It is true, and it is
...
OEIS A188153 is ``Number of 8-step self-avoiding walks on an n X n square summed over all starting positions.''. It has offset $1$ and begins
\[
0, 0, 112, 1976, 8160, 19312, 35024, 55104,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2172*n\^{}2 - 12500*n + 16096 for n>6. a(n) = 3*a(n-1) - 3*a(n-2) + a(n-3) for n>9.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 27 2018 09:22:45, revision 13)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A188153.
