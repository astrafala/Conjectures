...
\title{The cross-base identity for OEIS A125379, proved}
...
\begin{abstract}
OEIS A125379 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125379 is ``Number of base 16 circular n-digit numbers with adjacent digits differing by 5 or less.''. It has offset $0$ and begins
\[
1, 16, 146, 1126, 10006, 90766, 841412, 7895904,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:05:00, revision 14)
...
the base is $16$ and the permitted difference is $d=5$, so the claim is that
\[
a_{16}(n)-a_{15}(n)\;=\;F_{5}(n)
\qquad\text{for every } n \text{ with } 5\lfloor n/2\rfloor+1\le16,
\]
...
at base $16$ reproduces all $19$ terms A125379 publishes, and at base $15$ all the
...
polynomial. In particular $a_{16}(n)-a_{15}(n)=F_{5}(n)$ for $1\le n\le7$, which
...
First, the model reproduces all $19$ terms A125379 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{5}(16,n)$ & $T_{5}(15,n)$ & $F_{5}(n)$ \\ \hline
1 & 16 & 15 & 1 \\
2 & 146 & 135 & 11 \\
3 & 1126 & 1035 & 91 \\
4 & 10006 & 9115 & 891 \\
5 & 90766 & 81965 & 8801 \\
6 & 841412 & 752499 & 88913 \\
7 & 7895904 & 6987149 & 908755 \\
\end{tabular}
\end{center}
