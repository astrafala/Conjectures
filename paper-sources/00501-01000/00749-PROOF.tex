...
\title{The cross-base identity for OEIS A125417, proved}
...
\begin{abstract}
OEIS A125417 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125417 is ``Number of base 29 circular n-digit numbers with adjacent digits differing by 6 or less.''. It has offset $0$ and begins
\[
1, 29, 335, 3137, 34299, 381809, 4352375, 50303933,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:34:49, revision 12)
...
the base is $29$ and the permitted difference is $d=6$, so the claim is that
\[
a_{29}(n)-a_{28}(n)\;=\;F_{6}(n)
\qquad\text{for every } n \text{ with } 6\lfloor n/2\rfloor+1\le29,
\]
...
at base $29$ reproduces all $17$ terms A125417 publishes, and at base $28$ all the
...
polynomial. In particular $a_{29}(n)-a_{28}(n)=F_{6}(n)$ for $1\le n\le9$, which
...
First, the model reproduces all $17$ terms A125417 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{6}(29,n)$ & $T_{6}(28,n)$ & $F_{6}(n)$ \\ \hline
1 & 29 & 28 & 1 \\
2 & 335 & 322 & 13 \\
3 & 3137 & 3010 & 127 \\
4 & 34299 & 32830 & 1469 \\
5 & 381809 & 364658 & 17151 \\
6 & 4352375 & 4147612 & 204763 \\
7 & 50303933 & 47830608 & 2473325 \\
8 & 587692819 & 557530518 & 30162301 \\
\end{tabular}
\end{center}
