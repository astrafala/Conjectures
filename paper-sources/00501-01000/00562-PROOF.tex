...
\title{The empirical recurrence for OEIS A283351, proved from an exact model}
...
\begin{abstract}
OEIS A283351 carries an empirical recurrence of order $3$ contributed by Colin Barker. It is true, and it is
...
OEIS A283351 is ``Binary representation of the x-axis, from the left edge to the origin, of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 619", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 1, 1, 111, 111, 11111, 11111, 1111111,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Mar 06 2017: (Start) a(n) = a(n-1) + 100*a(n-2) - 100*a(n-3) for n>3.
\end{quote}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A283351.
