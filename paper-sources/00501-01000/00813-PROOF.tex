...
\title{The cross-base identity for OEIS A125428, proved}
...
\begin{abstract}
OEIS A125428 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125428 is ``Number of base 16 circular n-digit numbers with adjacent digits differing by 7 or less.''. It has offset $0$ and begins
\[
1, 16, 184, 1864, 21352, 249496, 2954044, 35167876,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:35:55, revision 12)
...
the base is $16$ and the permitted difference is $d=7$, so the claim is that
\[
a_{16}(n)-a_{15}(n)\;=\;F_{7}(n)
\qquad\text{for every } n \text{ with } 7\lfloor n/2\rfloor+1\le16,
\]
...
at base $16$ reproduces all $17$ terms A125428 publishes, and at base $15$ all the
...
polynomial. In particular $a_{16}(n)-a_{15}(n)=F_{7}(n)$ for $1\le n\le5$, which
...
First, the model reproduces all $17$ terms A125428 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{7}(16,n)$ & $T_{7}(15,n)$ & $F_{7}(n)$ \\ \hline
1 & 16 & 15 & 1 \\
2 & 184 & 169 & 15 \\
3 & 1864 & 1695 & 169 \\
4 & 21352 & 19097 & 2255 \\
5 & 249496 & 219115 & 30381 \\
\end{tabular}
\end{center}
