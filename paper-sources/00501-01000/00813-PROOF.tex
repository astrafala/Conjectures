...
\title{The cross-base identity for OEIS A125484, proved}
...
\begin{abstract}
OEIS A125484 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125484 is ``Number of base 27 circular n-digit numbers with adjacent digits differing by 9 or less.''. It has offset $0$ and begins
\[
1, 27, 423, 5607, 85683, 1337727, 21331503, 344238579,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:41:29, revision 12)
...
the base is $27$ and the permitted difference is $d=9$, so the claim is that
\[
a_{27}(n)-a_{26}(n)\;=\;F_{9}(n)
\qquad\text{for every } n \text{ with } 9\lfloor n/2\rfloor+1\le27,
\]
...
at base $27$ reproduces all $17$ terms A125484 publishes, and at base $26$ all the
...
polynomial. In particular $a_{27}(n)-a_{26}(n)=F_{9}(n)$ for $1\le n\le5$, which
...
First, the model reproduces all $17$ terms A125484 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{9}(27,n)$ & $T_{9}(26,n)$ & $F_{9}(n)$ \\ \hline
1 & 27 & 26 & 1 \\
2 & 423 & 404 & 19 \\
3 & 5607 & 5336 & 271 \\
4 & 85683 & 81104 & 4579 \\
5 & 1337727 & 1259576 & 78151 \\
\end{tabular}
\end{center}
