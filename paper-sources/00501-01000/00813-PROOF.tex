...
\title{The empirical recurrence for OEIS A279652, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A279652 imposes three things at once: a condition on each cell that reaches one row up and
...
OEIS A279652 is ``Number of nX3 0..2 arrays with no element equal to a strict majority of its horizontal and antidiagonal neighbors, with the exception of exactly two elements, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
0, 27, 734, 20448, 549608, 14309072, 362942080, 9010004672,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 16 2016 11:41:24, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;66\,a(n-1) - 1560\,a(n-2) + 15448\,a(n-3) - 58272\,a(n-4) + 112224\,a(n-5) - 123456\,a(n-6) + 79104\,a(n-7) - 27648\,a(n-8) + 4096\,a(n-9)
\end{equation}
for all $n>10$.
...
\[
3!\Bigl(a(n_0+j)-\sum_i c_i\,a(n_0+j-i)\Bigr)=\mathbf{v}^{\!\top}G^{\,j-9}w,
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A279652.
