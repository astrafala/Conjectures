...
\title{The cross-base identity for OEIS A125433, proved}
...
\begin{abstract}
OEIS A125433 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125433 is ``Number of base 21 circular n-digit numbers with adjacent digits differing by 7 or less.''. It has offset $0$ and begins
\[
1, 21, 259, 2709, 32627, 401401, 5043115, 64108009,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:07:17, revision 14)
...
the base is $21$ and the permitted difference is $d=7$, so the claim is that
\[
a_{21}(n)-a_{20}(n)\;=\;F_{7}(n)
\qquad\text{for every } n \text{ with } 7\lfloor n/2\rfloor+1\le21,
\]
...
at base $21$ reproduces all $17$ terms A125433 publishes, and at base $20$ all the
...
polynomial. In particular $a_{21}(n)-a_{20}(n)=F_{7}(n)$ for $1\le n\le5$, which
...
First, the model reproduces all $17$ terms A125433 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{7}(21,n)$ & $T_{7}(20,n)$ & $F_{7}(n)$ \\ \hline
1 & 21 & 20 & 1 \\
2 & 259 & 244 & 15 \\
3 & 2709 & 2540 & 169 \\
4 & 32627 & 30372 & 2255 \\
5 & 401401 & 371020 & 30381 \\
\end{tabular}
\end{center}
