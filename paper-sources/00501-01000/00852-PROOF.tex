...
\title{The cross-base identity for OEIS A125464, proved}
...
\begin{abstract}
OEIS A125464 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125464 is ``Number of base 29 circular n-digit numbers with adjacent digits differing by 8 or less.''. It has offset $0$ and begins
\[
1, 29, 421, 5069, 70837, 1010249, 14740909, 217995737,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:39:37, revision 12)
...
the base is $29$ and the permitted difference is $d=8$, so the claim is that
\[
a_{29}(n)-a_{28}(n)\;=\;F_{8}(n)
\qquad\text{for every } n \text{ with } 8\lfloor n/2\rfloor+1\le29,
\]
...
at base $29$ reproduces all $17$ terms A125464 publishes, and at base $28$ all the
...
polynomial. In particular $a_{29}(n)-a_{28}(n)=F_{8}(n)$ for $1\le n\le7$, which
...
First, the model reproduces all $17$ terms A125464 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{8}(29,n)$ & $T_{8}(28,n)$ & $F_{8}(n)$ \\ \hline
1 & 29 & 28 & 1 \\
2 & 421 & 404 & 17 \\
3 & 5069 & 4852 & 217 \\
4 & 70837 & 67556 & 3281 \\
5 & 1010249 & 960148 & 50101 \\
6 & 14740909 & 13958756 & 782153 \\
7 & 217995737 & 205641268 & 12354469 \\
\end{tabular}
\end{center}
