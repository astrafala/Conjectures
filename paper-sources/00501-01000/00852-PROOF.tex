...
\title{A cross-alphabet identity for bounded-difference square arrays: OEIS A125531}
...
\begin{abstract}
OEIS A125531 carries an empirical identity relating its counts to those of the same problem over an
...
OEIS A125531 is ``Number of n X n arrays with entries in 1..4 in which adjacent entries differ by 1 or less (adjacent means in x or y directions).''. It has offset $0$ and begins
\[
1, 4, 54, 3682, 1209830, 1909172038, 14441437270426, 523308354987531254,\ \dots
\]
...
most $d$. The entry is $T(4,1,n)$, and the conjecture is
\[
...
First, the count $T(4,1,n)$ was computed by an independent row-pair dynamic program and
reproduces the $6$ published terms of A125531 that the computation reaches,
...
\[
\begin{array}{rrrr}
n & T(4+1,1,n) & T(4,1,n) & F(n,1) \\ \hline
1 & 5 & 4 & 1 \\
2 & 73 & 54 & 19 \\
3 & 5347 & 3682 & 1665 \\
\end{array}
...
\url{https://oeis.org}, 2026. Sequence A125531: \url{https://oeis.org/A125531}.
\end{thebibliography}
