...
\title{The cross-base identity for OEIS A126405, proved}
...
\begin{abstract}
OEIS A126405 carries an empirical identity, in two clauses, relating its counts to those of the
...
OEIS A126405 is ``Number of base 18 n-digit numbers with adjacent digits differing by two or less.''. It has offset $0$ and begins
\[
1, 18, 84, 400, 1918, 9236, 44598, 215774,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:11:30, revision 13)
this is still recorded as empirical, and nothing on the entry records it as proved.

For this entry the base is $18$ and the permitted difference is $d=2$, so the first clause
claims $a_{18}(n)-a_{17}(n)=5^{\,n-1}$ whenever $2(n-1)+1\le18$, that is for
$1\le n\le9$, and the second claims $a_{18}(n)-a_{17}(n)=5^{\,n-1}-2$ at the single
$n$ with $2(n-1)=18$.
...
arithmetic, $L_{2}$ at base $18$ reproduces all $21$ terms A126405 publishes.
...
First, the model reproduces all $21$ terms A126405 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $L_{2}(18,n)$ & $L_{2}(17,n)$ & $5^{\,n-1}$ \\ \hline
1 & 18 & 17 & 1 \\
2 & 84 & 79 & 5 \\
3 & 400 & 375 & 25 \\
4 & 1918 & 1793 & 125 \\
5 & 9236 & 8611 & 625 \\
6 & 44598 & 41473 & 3125 \\
7 & 215774 & 200149 & 15625 \\
8 & 1045480 & 967355 & 78125 \\
\end{tabular}
\end{center}
...
Third, the second clause was evaluated at its own index. For this entry the second clause bites at $n=10$, where $b=18=2(n-1)$: there $L_{2}(18,10)-L_{2}(17,10)=1953123$ and $5^{9}-2=1953123$.

\section*{References}
\begin{enumerate}
\item The OEIS Foundation Inc., \emph{The On-Line Encyclopedia of Integer Sequences},
\url{https://oeis.org/A126405}.
\end{enumerate}
