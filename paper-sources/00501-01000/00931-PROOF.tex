...
\title{The empirical recurrence for OEIS A264365, proved by transfer matrix}
...
\begin{abstract}
OEIS A264365 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=2$ columns in which
...
OEIS A264365 is ``Number of (1+1) X (n+1) arrays of permutations of 0..n*2+1 with each element having directed index change 0,0 0,2 1,0 or -1,-2.''. It has offset $1$ and begins
\[
1, 3, 9, 18, 36, 78, 169, 364,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + 3*a(n-3) + 3*a(n-4) + 3*a(n-5) + 3*a(n-6) - 2*a(n-8) - a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 07 2019 12:40:43, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 3\,a(n-3) + 3\,a(n-4) + 3\,a(n-5) + 3\,a(n-6) - 2\,a(n-8) - a(n-9)
\]
for every $n>7$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264365.
