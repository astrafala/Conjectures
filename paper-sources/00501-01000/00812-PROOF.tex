...
\title{The cross-base identity for OEIS A125483, proved}
...
\begin{abstract}
OEIS A125483 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125483 is ``Number of base 26 circular n-digit numbers with adjacent digits differing by 9 or less.''. It has offset $0$ and begins
\[
1, 26, 404, 5336, 81104, 1259576, 19967936, 320169512,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:41:23, revision 14)
...
the base is $26$ and the permitted difference is $d=9$, so the claim is that
\[
a_{26}(n)-a_{25}(n)\;=\;F_{9}(n)
\qquad\text{for every } n \text{ with } 9\lfloor n/2\rfloor+1\le26,
\]
...
at base $26$ reproduces all $17$ terms A125483 publishes, and at base $25$ all the
...
polynomial. In particular $a_{26}(n)-a_{25}(n)=F_{9}(n)$ for $1\le n\le5$, which
...
First, the model reproduces all $17$ terms A125483 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{9}(26,n)$ & $T_{9}(25,n)$ & $F_{9}(n)$ \\ \hline
1 & 26 & 25 & 1 \\
2 & 404 & 385 & 19 \\
3 & 5336 & 5065 & 271 \\
4 & 81104 & 76525 & 4579 \\
5 & 1259576 & 1181425 & 78151 \\
\end{tabular}
\end{center}
