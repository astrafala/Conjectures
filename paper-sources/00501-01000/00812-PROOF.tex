...
\title{The cross-base identity for OEIS A125432, proved}
...
\begin{abstract}
OEIS A125432 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125432 is ``Number of base 20 circular n-digit numbers with adjacent digits differing by 7 or less.''. It has offset $0$ and begins
\[
1, 20, 244, 2540, 30372, 371020, 4624618, 58276910,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:36:17, revision 12)
...
the base is $20$ and the permitted difference is $d=7$, so the claim is that
\[
a_{20}(n)-a_{19}(n)\;=\;F_{7}(n)
\qquad\text{for every } n \text{ with } 7\lfloor n/2\rfloor+1\le20,
\]
...
at base $20$ reproduces all $17$ terms A125432 publishes, and at base $19$ all the
...
polynomial. In particular $a_{20}(n)-a_{19}(n)=F_{7}(n)$ for $1\le n\le5$, which
...
First, the model reproduces all $17$ terms A125432 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{7}(20,n)$ & $T_{7}(19,n)$ & $F_{7}(n)$ \\ \hline
1 & 20 & 19 & 1 \\
2 & 244 & 229 & 15 \\
3 & 2540 & 2371 & 169 \\
4 & 30372 & 28117 & 2255 \\
5 & 371020 & 340639 & 30381 \\
\end{tabular}
\end{center}
