...
\title{The cross-base identity for OEIS A125413, proved}
...
\begin{abstract}
OEIS A125413 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125413 is ``Number of base 25 circular n-digit numbers with adjacent digits differing by 6 or less.''. It has offset $0$ and begins
\[
1, 25, 283, 2629, 28423, 313205, 3533323, 40410633,\ \dots
\]
The entry states, as an empirical claim and never marked settled:
\begin{quote}
[Empirical] a(base,n)=a(base-1,n)+F(6) for base>=6.int(n/2)+1 and F(d) is the largest coefficient in (1+x+...+x\textasciicircum{}(2d))\textasciicircum{}n
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:34:27, revision 12)
...
the base is $25$ and the permitted difference is $d=6$, so the claim is that
\[
a_{25}(n)-a_{24}(n)\;=\;F_{6}(n)
\qquad\text{for every } n \text{ with } 6\lfloor n/2\rfloor+1\le25,
\]
...
together with a choice of where it starts. Evaluated exactly in integer arithmetic, $T_{6}$
at base $25$ reproduces all $17$ terms A125413 publishes, and at base $24$ all the
...
polynomial. In particular $a_{25}(n)-a_{24}(n)=F_{6}(n)$ for $1\le n\le9$, which
...
First, the model reproduces all $17$ terms A125413 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{6}(25,n)$ & $T_{6}(24,n)$ & $F_{6}(n)$ \\ \hline
1 & 25 & 24 & 1 \\
2 & 283 & 270 & 13 \\
3 & 2629 & 2502 & 127 \\
4 & 28423 & 26954 & 1469 \\
5 & 313205 & 296054 & 17151 \\
6 & 3533323 & 3328560 & 204763 \\
7 & 40410633 & 37937308 & 2473325 \\
8 & 467043615 & 436881314 & 30162301 \\
\end{tabular}
\end{center}
