...
\title{The empirical recurrence for OEIS A221134, proved by transfer matrix}
...
\begin{abstract}
OEIS A221134 counts the distinct OCCUPANCY arrays obtained when every cell of an $n\times3$ grid
holds one token and each token moves to a neighbouring cell, and carries an empirical
recurrence of order $9$ contributed by R.~H.~Hardin. It is true, and it is decidable
...
determinising the machine that emits the occupancy row by row turns it into one, on $S=581$
...
OEIS A221134 is ``Number of nX3 arrays of occupancy after each element moves to some horizontal or vertical neighbor, with no occupancy greater than 2.''. It has offset $1$ and begins
\[
2, 49, 656, 12544, 200072, 3485689, 58132316, 990486784,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 21*a(n-1) -1450*a(n-3) +4782*a(n-4) -372*a(n-5) +1450*a(n-6) +69*a(n-8) +a(n-9)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 19:21:13, revision 8) this is still
...
\]
There are $S=581$ reachable sets. In particular $a$ is $C$-finite.
...
\begin{theorem}
\[
a(n)\;=\;21\,a(n-1) - 1450\,a(n-3) + 4782\,a(n-4) - 372\,a(n-5) + 1450\,a(n-6) + 69\,a(n-8) + a(n-9)
\]
for every $n>9$.
\end{theorem}
...
arithmetic. The entry's first term is $2$, and it is a sharp test of the boundary: a
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221134.
