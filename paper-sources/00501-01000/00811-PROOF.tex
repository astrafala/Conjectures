...
\title{The cross-base identity for OEIS A125438, proved}
...
\begin{abstract}
OEIS A125438 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125438 is ``Number of base 26 circular n-digit numbers with adjacent digits differing by 7 or less.''. It has offset $0$ and begins
\[
1, 26, 334, 3554, 43902, 553306, 7135630, 93271834,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:36:56, revision 12)
...
the base is $26$ and the permitted difference is $d=7$, so the claim is that
\[
a_{26}(n)-a_{25}(n)\;=\;F_{7}(n)
\qquad\text{for every } n \text{ with } 7\lfloor n/2\rfloor+1\le26,
\]
...
at base $26$ reproduces all $17$ terms A125438 publishes, and at base $25$ all the
...
polynomial. In particular $a_{26}(n)-a_{25}(n)=F_{7}(n)$ for $1\le n\le7$, which
...
First, the model reproduces all $17$ terms A125438 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{7}(26,n)$ & $T_{7}(25,n)$ & $F_{7}(n)$ \\ \hline
1 & 26 & 25 & 1 \\
2 & 334 & 319 & 15 \\
3 & 3554 & 3385 & 169 \\
4 & 43902 & 41647 & 2255 \\
5 & 553306 & 522925 & 30381 \\
6 & 7135630 & 6717127 & 418503 \\
7 & 93271834 & 87439069 & 5832765 \\
\end{tabular}
\end{center}
