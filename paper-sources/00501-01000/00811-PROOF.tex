...
\title{The empirical recurrence for OEIS A229634, proved by counting defective colourings}
...
\begin{abstract}
OEIS A229634 counts the colourings of an array with $K=3$ colours that are proper except at
...
OEIS A229634 is ``Number of defective 3-colorings of an n X 5 0..2 array connected horizontally, diagonally and antidiagonally with exactly two mistakes, and colors introduced in row-major 0..2 order.''. It has offset $1$ and begins
\[
12, 488, 6031, 77620, 960325, 11485716, 133784624, 1525870912,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 27 2021 21:33:00, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;42\,a(n-1) - 723\,a(n-2) + 6569\,a(n-3) - 33687\,a(n-4) + 94839\,a(n-5) - 116010\,a(n-6) - 55215\,a(n-7) + 305043\,a(n-8) - 230994\,a(n-9) - 118011\,a(n-10) + 243513\,a(n-11) - 84933\,a(n-12) - 40719\,a(n-13) + 42804\,a(n-14) - 14887\,a(n-15) + 2598\,a(n-16) - 228\,a(n-17) + 8\,a(n-18)
\end{equation}
for all $n>20$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A229634.
