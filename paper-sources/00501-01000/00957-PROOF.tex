...
\title{The cross-base identity for OEIS A126512, proved}
...
\begin{abstract}
OEIS A126512 carries an empirical identity, in two clauses, relating its counts to those of the
...
OEIS A126512 is ``Number of base 17 n-digit numbers with adjacent digits differing by four or less.''. It has offset $0$ and begins
\[
1, 17, 133, 1077, 8813, 72489, 597605, 4931789,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:15:47, revision 14)
this is still recorded as empirical, and nothing on the entry records it as proved.

For this entry the base is $17$ and the permitted difference is $d=4$, so the first clause
claims $a_{17}(n)-a_{16}(n)=9^{\,n-1}$ whenever $4(n-1)+1\le17$, that is for
$1\le n\le5$, and the second claims $a_{17}(n)-a_{16}(n)=9^{\,n-1}-2$ at the single
$n$ with $4(n-1)=17$.
...
arithmetic, $L_{4}$ at base $17$ reproduces all $20$ terms A126512 publishes.
...
First, the model reproduces all $20$ terms A126512 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $L_{4}(17,n)$ & $L_{4}(16,n)$ & $9^{\,n-1}$ \\ \hline
1 & 17 & 16 & 1 \\
2 & 133 & 124 & 9 \\
3 & 1077 & 996 & 81 \\
4 & 8813 & 8084 & 729 \\
