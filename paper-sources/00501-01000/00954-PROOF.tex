...
\title{The cross-base identity for OEIS A126509, proved}
...
\begin{abstract}
OEIS A126509 carries an empirical identity, in two clauses, relating its counts to those of the
...
OEIS A126509 is ``Number of base 14 n-digit numbers with adjacent digits differing by four or less.''. It has offset $0$ and begins
\[
1, 14, 106, 834, 6626, 52818, 421418, 3363330,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:15:31, revision 14)
this is still recorded as empirical, and nothing on the entry records it as proved.

For this entry the base is $14$ and the permitted difference is $d=4$, so the first clause
claims $a_{14}(n)-a_{13}(n)=9^{\,n-1}$ whenever $4(n-1)+1\le14$, that is for
$1\le n\le4$, and the second claims $a_{14}(n)-a_{13}(n)=9^{\,n-1}-2$ at the single
$n$ with $4(n-1)=14$.
...
arithmetic, $L_{4}$ at base $14$ reproduces all $20$ terms A126509 publishes.
...
First, the model reproduces all $20$ terms A126509 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $L_{4}(14,n)$ & $L_{4}(13,n)$ & $9^{\,n-1}$ \\ \hline
1 & 14 & 13 & 1 \\
2 & 106 & 97 & 9 \\
3 & 834 & 753 & 81 \\
4 & 6626 & 5897 & 729 \\
