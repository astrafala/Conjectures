...
\title{The cross-base identity for OEIS A126545, proved}
...
\begin{abstract}
OEIS A126545 carries an empirical identity, in two clauses, relating its counts to those of the
...
OEIS A126545 is ``Number of base 24 n-digit numbers with adjacent digits differing by five or less.''. It has offset $0$ and begins
\[
1, 24, 234, 2354, 23924, 244486, 2505990, 25729152,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:18:27, revision 11)
this is still recorded as empirical, and nothing on the entry records it as proved.

For this entry the base is $24$ and the permitted difference is $d=5$, so the first clause
claims $a_{24}(n)-a_{23}(n)=11^{\,n-1}$ whenever $5(n-1)+1\le24$, that is for
$1\le n\le5$, and the second claims $a_{24}(n)-a_{23}(n)=11^{\,n-1}-2$ at the single
$n$ with $5(n-1)=24$.
...
arithmetic, $L_{5}$ at base $24$ reproduces all $18$ terms A126545 publishes.
...
First, the model reproduces all $18$ terms A126545 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $L_{5}(24,n)$ & $L_{5}(23,n)$ & $11^{\,n-1}$ \\ \hline
1 & 24 & 23 & 1 \\
2 & 234 & 223 & 11 \\
3 & 2354 & 2233 & 121 \\
4 & 23924 & 22593 & 1331 \\
5 & 244486 & 229845 & 14641 \\
\end{tabular}
\end{center}
