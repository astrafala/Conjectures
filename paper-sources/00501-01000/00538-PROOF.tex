...
\begin{abstract}
OEIS A284237 carries an empirical recurrence of order $3$ contributed by Chai Wah Wu. It is true, and it is
...
\begin{quote}
Conjectures from \_Chai Wah Wu\_, May 04 2024: (Start) a(n) = 2*a(n-1) + a(n-2) - 2*a(n-3) for n > 5.
\end{quote}
