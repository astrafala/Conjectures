...
\title{The empirical recurrence for OEIS A217980, proved by transfer matrix}
...
\begin{abstract}
OEIS A217980 counts the distinct arrays obtained by applying a fixed local operation to every cell
...
$S=235$ states, after which the conjectured recurrence is settled by a finite exact
computation.
\end{abstract}
...
OEIS A217980 is ``Number of nX6 arrays of the minimum value of corresponding elements and their horizontal, vertical, diagonal or antidiagonal neighbors in a random 0..1 nX6 array.''. It has offset $1$ and begins
\[
16, 16, 256, 1180, 8872, 54504, 363728, 2347480,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 17:30:48, revision 8) this is still
...
\]
There are $S=235$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite.
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) + 20\,a(n-2) - 26\,a(n-3) - 243\,a(n-4) - 402\,a(n-5) + 1359\,a(n-6) + 3862\,a(n-7) + 575\,a(n-8) - 14159\,a(n-9) - 23730\,a(n-10) + 21635\,a(n-11) + 49428\,a(n-12) + 39959\,a(n-13) - 70045\,a(n-14) - 163116\,a(n-15) + 162408\,a(n-16) + 246212\,a(n-17) - 242465\,a(n-18) - 333744\,a(n-19) + 159949\,a(n-20) + 337852\,a(n-21) - 38088\,a(n-22) - 156828\,a(n-23) - 5419\,a(n-24) + 49017\,a(n-25) + 4621\,a(n-26) - 24626\,a(n-27) - 9053\,a(n-28) + 3845\,a(n-29) + 4770\,a(n-30) + 619\,a(n-31) - 302\,a(n-32) - 153\,a(n-33) - 20\,a(n-34) + 12\,a(n-35)
\]
for every $n>35$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A217980.
