...
\title{The empirical recurrence for OEIS A281535, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A281535 imposes three things at once: a condition on each cell that reaches one row up and
...
OEIS A281535 is ``Number of nX3 0..2 arrays with no element equal to more than one of its king-move neighbors, with the exception of exactly two elements, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
0, 4, 290, 2919, 14561, 63840, 245037, 871492,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 23 2017 12:51:09, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) - 6\,a(n-2) + 8\,a(n-3) - 31\,a(n-4) + 9\,a(n-5) + 6\,a(n-6) + 36\,a(n-7) + 87\,a(n-8) - 5\,a(n-9) + 106\,a(n-10) - 12\,a(n-11) - 13\,a(n-12) + 11\,a(n-13) - 102\,a(n-14) + 60\,a(n-15) - 42\,a(n-16) - 36\,a(n-17) + 68\,a(n-18) - 28\,a(n-19) + 16\,a(n-21) - 8\,a(n-22)
\end{equation}
for all $n>30$.
...
\[
3!\Bigl(a(n_0+j)-\sum_i c_i\,a(n_0+j-i)\Bigr)=\mathbf{v}^{\!\top}G^{\,j-22}w,
...
index corresponding to $n=30+1$ onwards, and the run continued until $S+1$ consecutive
zeros had been seen.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A281535.
