...
\title{The cross-base identity for OEIS A125485, proved}
...
\begin{abstract}
OEIS A125485 carries an empirical identity relating its counts to those of the entry one base
...
OEIS A125485 is ``Number of base 28 circular n-digit numbers with adjacent digits differing by 9 or less.''. It has offset $0$ and begins
\[
1, 28, 442, 5878, 90262, 1415878, 22695076, 368310712,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:41:34, revision 12)
...
the base is $28$ and the permitted difference is $d=9$, so the claim is that
\[
a_{28}(n)-a_{27}(n)\;=\;F_{9}(n)
\qquad\text{for every } n \text{ with } 9\lfloor n/2\rfloor+1\le28,
\]
...
at base $28$ reproduces all $17$ terms A125485 publishes, and at base $27$ all the
...
polynomial. In particular $a_{28}(n)-a_{27}(n)=F_{9}(n)$ for $1\le n\le7$, which
...
First, the model reproduces all $17$ terms A125485 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $T_{9}(28,n)$ & $T_{9}(27,n)$ & $F_{9}(n)$ \\ \hline
1 & 28 & 27 & 1 \\
2 & 442 & 423 & 19 \\
3 & 5878 & 5607 & 271 \\
4 & 90262 & 85683 & 4579 \\
5 & 1415878 & 1337727 & 78151 \\
6 & 22695076 & 21331503 & 1363573 \\
7 & 368310712 & 344238579 & 24072133 \\
\end{tabular}
\end{center}
