...
\title{A cross-alphabet identity for bounded-difference square arrays: OEIS A125543}
...
\begin{abstract}
OEIS A125543 carries an empirical identity relating its counts to those of the same problem over an
...
OEIS A125543 is ``Number of n X n arrays with entries in 1..10 in which adjacent entries differ by 7 or less (adjacent means in x or y directions).''. It has offset $0$ and begins
\[
1, 10, 8022, 543128374, 3055705944761702, 1431275227278696138328486, 55801019314977359729825524189282042, 181083160867536477536139285619272596798948123330,\ \dots
\]
...
most $d$. The entry is $T(10,7,n)$, and the conjecture is
\[
...
First, the count $T(10,7,n)$ was computed by an independent row-pair dynamic program and
reproduces the $4$ published terms of A125543 that the computation reaches,
...
\[
\begin{array}{rrrr}
n & T(10+1,7,n) & T(10,7,n) & F(n,7) \\ \hline
1 & 11 & 10 & 1 \\
2 & 10157 & 8022 & 2255 \\
\end{array}
\]
...
\url{https://oeis.org}, 2026. Sequence A125543: \url{https://oeis.org/A125543}.
\end{thebibliography}
