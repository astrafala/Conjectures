...
\title{A cross-alphabet identity for bounded-difference square arrays: OEIS A125546}
...
\begin{abstract}
OEIS A125546 carries an empirical identity relating its counts to those of the same problem over an
...
OEIS A125546 is ``Number of n X n arrays with entries in 1..11 in which adjacent entries differ by 9 or less (adjacent means in x or y directions).''. It has offset $0$ and begins
\[
1, 11, 13763, 1978210109, 32571675386972165, 61452459671072911580420687, 13284933102293631737361621573688797935, 329079799821925392118398338649907446164698978078433,\ \dots
\]
...
most $d$. The entry is $T(11,9,n)$, and the conjecture is
\[
...
First, the count $T(11,9,n)$ was computed by an independent row-pair dynamic program and
reproduces the $3$ published terms of A125546 that the computation reaches,
...
\[
\begin{array}{rrrr}
n & T(11+1,9,n) & T(11,9,n) & F(n,9) \\ \hline
1 & 12 & 11 & 1 \\
2 & 17782 & 13763 & 4579 \\
\end{array}
\]
...
\url{https://oeis.org}, 2026. Sequence A125546: \url{https://oeis.org/A125546}.
\end{thebibliography}
