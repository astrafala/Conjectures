...
\title{The empirical recurrence for OEIS A236995, proved by transfer matrix}
...
\begin{abstract}
OEIS A236995 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
The condition is local to two consecutive rows, so the count is a walk count on $S=144000$
...
OEIS A236995 is ``Number of (n+1)X(6+1) 0..2 arrays with the maximum plus the lower median minus the upper median minus the minimum of every 2X2 subblock differing from its horizontal and vertical neighbors by exactly one.''. It has offset $1$ and begins
\[
144000, 4618944, 145732608, 5454273024, 192222720000, 6552043167744, 219711187058688, 8794294803431424,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 09:44:12, revision 6) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The $2\times2$ subblocks of an $(n+1)\times7$ array form an
$n\times6$ grid, and each carries the value $\sigma=-a+b-c+d$, where $a\le b\le c\le d$ are its four entries sorted --- its minimum, lower median, upper median and maximum. The entry asks that the values of
...
differ by $1$. The entry's first term $144000$ counts those, and the model was made to
...
\]
over the $S=144000$ pairs whose own subblock row already satisfies the condition along itself.
...
\begin{theorem}
\[
a(n)\;=\;24\,a(n-1) + 6977664\,a(n-4) - 167463936\,a(n-5) - 16797664935936\,a(n-8) + 403143958462464\,a(n-9) + 16582288439072784384\,a(n-12) - 397974922537746825216\,a(n-13) - 5610108723948059923316736\,a(n-16) + 134642609374753438159601664\,a(n-17)
\]
for every $n>17$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A236995.
