...
\title{The empirical recurrence for OEIS A295272, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A295272 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A295272 is ``Number of nX5 0..1 arrays with each 1 horizontally or vertically adjacent to 0, 1 or 4 1s.''. It has offset $1$ and begins
\[
24, 291, 4035, 54773, 748740, 10203847, 139221499, 1898916677,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 19 2017 08:16:05, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) + 84\,a(n-2) + 421\,a(n-3) + 716\,a(n-4) - 1544\,a(n-5) - 7895\,a(n-6) - 11069\,a(n-7) + 23659\,a(n-8) + 46894\,a(n-9) - 28597\,a(n-10) - 25649\,a(n-11) - 112201\,a(n-12) + 282924\,a(n-13) - 604659\,a(n-14) + 1353567\,a(n-15) - 2132282\,a(n-16) + 2688487\,a(n-17) - 2990791\,a(n-18) + 2796525\,a(n-19) - 2113112\,a(n-20) + 1443409\,a(n-21) - 944144\,a(n-22) + 464982\,a(n-23) - 217099\,a(n-24) + 125161\,a(n-25) - 1805\,a(n-26) - 32202\,a(n-27) + 26125\,a(n-28) - 18772\,a(n-29) - 1914\,a(n-30) - 838\,a(n-31) + 1685\,a(n-32) + 2105\,a(n-33) - 329\,a(n-34) - 147\,a(n-35) - 176\,a(n-36) + 64\,a(n-37) + 7\,a(n-38) + a(n-39) - a(n-40)
\end{equation}
for all $n>41$.
...
x_{t,u}=1\ \Rightarrow\ \#\{\text{neighbours equal to }1\}\in\{0,1,4\}
\end{equation}
for every cell $(t,u)$.
...
the middle row. The vector $w$ was formed by $40$ applications of $G$ in exact integer
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A295272.
