...
\title{The empirical recurrence for OEIS A252273, proved by transfer matrix}
...
\begin{abstract}
OEIS A252273 counts $(n+2)\times5$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252273 is ``Number of (n+2)X(3+2) 0..3 arrays with every 3X3 subblock row and column sum not equal to 2 3 4 6 or 7 and every 3X3 diagonal and antidiagonal sum equal to 2 3 4 6 or 7.''. It has offset $1$ and begins
\[
232, 588, 1407, 2513, 7803, 20430, 37160, 121782,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:00:15, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;32\,a(n-3) - 310\,a(n-6) + 1093\,a(n-9) - 1724\,a(n-12) + 1309\,a(n-15) - 476\,a(n-18) + 82\,a(n-21) - 5\,a(n-24)
\]
for every $n>27$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252273.
