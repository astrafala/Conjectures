...
\title{The empirical recurrence for OEIS A317218, proved by transfer matrix}
...
\begin{abstract}
OEIS A317218 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $different from$ itself lying in $\{1,2,3,4,5,7,8\}$, and it carries an empirical
...
OEIS A317218 is ``Number of nX4 0..1 arrays with every element unequal to 1, 2, 3, 4, 5, 7 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
2, 98, 929, 11378, 133874, 1580822, 18667993, 220464927,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2018 19:47:38, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;8\,a(n-1) + 55\,a(n-2) - 7\,a(n-3) - 1058\,a(n-4) - 2985\,a(n-5) - 1279\,a(n-6) + 9793\,a(n-7) + 17520\,a(n-8) + 5330\,a(n-9) - 19566\,a(n-10) - 25908\,a(n-11) - 7185\,a(n-12) - 564\,a(n-13) - 9536\,a(n-14) - 19332\,a(n-15) + 6487\,a(n-16) + 21190\,a(n-17) + 30134\,a(n-18) + 16147\,a(n-19) + 12181\,a(n-20) + 12100\,a(n-21) + 16204\,a(n-22) + 6817\,a(n-23) - 6982\,a(n-24) - 3114\,a(n-25) - 1986\,a(n-26) + 275\,a(n-27) + 44\,a(n-28)
\end{equation}
for all $n>29$.
...
They vanish from the index corresponding to $n=29+1$ onwards, and the run was continued
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A317218.
