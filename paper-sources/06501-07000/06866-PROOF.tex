...
\title{The empirical recurrence for OEIS A207850, proved by transfer matrix}
...
\begin{abstract}
OEIS A207850 counts arrays over $\{0,\dots,1\}$ of width $7$ that avoid the patterns
$(0,0,0), (1,1,1)$ along one axis and $(0,0,0), (0,0,1)$ along the other, and carries an empirical recurrence of
order $20$ contributed by R.~H.~Hardin. It is true. The patterns have length $3$, so
...
$\mathbf{1}^{\!\top}P^{\,n-2-20}q(P)\mathbf{1}$, which vanishes identically
...
OEIS A207850 is ``Number of 7Xn 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 0 0 and 1 1 1 vertically.''. It has offset
$1$ and begins
\[
42, 1764, 6216, 35952, 185136, 1006572, 5346600,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:21:26, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 40\,a(n-2) - 50\,a(n-3) - 511\,a(n-4) + 376\,a(n-5) + 2736\,a(n-6) - 1247\,a(n-7) - 7118\,a(n-8) + 2183\,a(n-9) + 9712\,a(n-10) - 2183\,a(n-11) - 7118\,a(n-12) + 1247\,a(n-13) + 2736\,a(n-14) - 376\,a(n-15) - 511\,a(n-16) + 50\,a(n-17) + 40\,a(n-18) - 2\,a(n-19) - a(n-20)
\end{equation}
for all $n>21$. The entry's array has a fixed number of rows and a growing number of
...
$(0,0,0), (1,1,1)$ as $3$ consecutive entries. There are $42$ admissible columns; that condition
...
columns, so $S=1764$, and declare $w\to w'$ an edge when $w'$ is $w$ with its first entry
...
$a(n)-\sum_i c_i a(n-i)=u_{\,n-2-20}$ whenever $n-20\ge2$. Hence
\eqref{eq:conj} holds for every $n>t$ exactly when $u_j=0$ for every
$j>t-2-20$. Moreover $(u_j)$ satisfies the monic linear recurrence whose
...
$P^{\,n-2-20}$ gives the identity. The equivalence follows by letting the exponent
...
\begin{proof}
The vector $q(P)\mathbf{1}\in\mathbb{Z}^{S}$ was formed by $20$ matrix--vector
products in exact integer arithmetic and the $u_j$ evaluated in turn. They vanish from the
index corresponding to $n=21+1$ onwards, and the run was continued past $S$ consecutive
...
values agree exactly, including the initial count of $42$ admissible columns. That is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207850.
