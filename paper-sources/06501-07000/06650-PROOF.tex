...
\title{The empirical recurrence for OEIS A254086, proved by transfer matrix}
...
\begin{abstract}
OEIS A254086 counts the arrays over $\{0,\dots,1\}$ whose $3\times3$ subblocks carry a
...
OEIS A254086 is ``Number of (n+2)X(2+2) 0..1 arrays with every 3X3 subblock diagonal maximum minus antidiagonal maximum nondecreasing horizontally, vertically and ne-to-sw antidiagonally.''. It has offset $1$ and begins
\[
3436, 37961, 438463, 5146916, 60605766, 710699434, 8345076092, 97946001730,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 14:27:14, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A254086.
