...
\title{The empirical recurrence for OEIS A189191, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A189191 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A189191 is ``Number of nX4 binary arrays without the pattern 0 0 1 vertically or antidiagonally.''. It has offset $1$ and begins
\[
16, 256, 2032, 15326, 101628, 657028, 4109278, 25421672,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 05:05:03, revision 9) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A189191.
