...
\title{The empirical recurrence for OEIS A232338, proved by transfer matrix}
...
\begin{abstract}
OEIS A232338 counts arrays of width $4$ over $\{0,1,2\}$ in which every cell carrying one stated
...
OEIS A232338 is ``Number of 4Xn 0..2 arrays with every 0 next to a 1 and every 1 next to a 2 horizontally or antidiagonally, with no adjacent elements equal.''. It has offset $1$ and begins
\[
1, 42, 308, 734, 4906, 13170, 82526, 239992,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 07:19:29, revision 6) this is still
...
adjacency matrix,
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=394.
\]
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 15\,a(n-2) - 7\,a(n-3) + 8\,a(n-4) - 40\,a(n-5) + 8\,a(n-6) - 14\,a(n-7) + 38\,a(n-8) + 12\,a(n-9) + 3\,a(n-10) - 11\,a(n-11) - 27\,a(n-12) + 7\,a(n-13) - 6\,a(n-14) + 20\,a(n-15) - 5\,a(n-16) + 5\,a(n-17) - 7\,a(n-18) + a(n-19) - a(n-20) + a(n-21)
\]
for every $n>24$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232338.
