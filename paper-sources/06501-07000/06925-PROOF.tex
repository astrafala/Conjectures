...
\title{The empirical recurrence for OEIS A279653, proved by transfer matrix}
...
\begin{abstract}
OEIS A279653 counts $n\times4$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A279653 is ``Number of n X 4 0..2 arrays with no element equal to a strict majority of its horizontal and antidiagonal neighbors, with the exception of exactly two elements, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
3, 254, 19986, 1546164, 113887852, 8077041000, 556408163556, 37457887289336,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 26 2021 14:17:34, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;195\,a(n-1) - 14439\,a(n-2) + 510857\,a(n-3) - 9404160\,a(n-4) + 106784040\,a(n-5) - 833918604\,a(n-6) + 4796401344\,a(n-7) - 21251872752\,a(n-8) + 74762385456\,a(n-9) - 213091249728\,a(n-10) + 498565926912\,a(n-11) - 964790488640\,a(n-12) + 1548742980096\,a(n-13) - 2059877167104\,a(n-14) + 2258077614080\,a(n-15) - 2020948979712\,a(n-16) + 1456042672128\,a(n-17) - 828450537472\,a(n-18) + 363079925760\,a(n-19) - 118689103872\,a(n-20) + 27709669376\,a(n-21) - 4328521728\,a(n-22) + 402653184\,a(n-23) - 16777216\,a(n-24)
\]
for every $n>25$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A279653.
