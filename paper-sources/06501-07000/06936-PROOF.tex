...
\title{The empirical recurrence for OEIS A235305, proved by transfer matrix}
...
\begin{abstract}
OEIS A235305 counts $4$-column arrays over $\{0,\dots,5\}$ in which every
...
OEIS A235305 is ``Number of (n+1) X (3+1) 0..5 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 6 (constant-stress 1 X 1 tilings).''. It has offset
$1$ and begins
\[
518, 1106, 2118, 5042, 10790, 27602, 64326,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 18 2022 23:19:50, revision 7) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A235305.
