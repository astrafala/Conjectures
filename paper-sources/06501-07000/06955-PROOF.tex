...
\title{The empirical recurrence for OEIS A297697, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297697 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
values of its neighbours, and carries an empirical recurrence of order $24$ contributed
...
OEIS A297697 is ``Number of 4Xn 0..1 arrays with every 1 horizontally, diagonally or antidiagonally adjacent to 0, 2 or 4 neighboring 1s.''. It has offset $1$ and begins
\[
16, 48, 415, 1774, 12214, 60904, 378611, 2026447,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 03 2018 12:30:32, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) + 25\,a(n-2) - 166\,a(n-3) - 163\,a(n-4) + 1490\,a(n-5) + 278\,a(n-6) - 5665\,a(n-7) - 251\,a(n-8) + 9559\,a(n-9) + 2285\,a(n-10) - 4496\,a(n-11) - 5180\,a(n-12) - 5803\,a(n-13) + 491\,a(n-14) + 5580\,a(n-15) + 4942\,a(n-16) + 1233\,a(n-17) - 1413\,a(n-18) - 1469\,a(n-19) - 650\,a(n-20) - 78\,a(n-21) + 13\,a(n-22) + 31\,a(n-23) + 14\,a(n-24)
\end{equation}
for all $n>25$.
...
x_{t,u}=1\ \Rightarrow\ \#\{\text{neighbours equal to }1\}\in\{0,2,4\}
\end{equation}
for every cell $(t,u)$.
...
\begin{proof}
Substitute Lemma~\ref{lem:walk} and factor $G^{j-24}$ out of
...
the middle column. The vector $w$ was formed by $24$ applications of $G$ in exact integer
arithmetic and $\mathbf{v}^{\!\top}G^{m}w$ evaluated for $m=0,1,\dots$, again exactly.
Every one of those integers vanishes from the index corresponding to $n=25+1$ onwards,
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297697.
