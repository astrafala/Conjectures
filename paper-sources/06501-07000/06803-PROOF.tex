...
\title{The empirical recurrence for OEIS A237031, proved by transfer matrix}
...
\begin{abstract}
OEIS A237031 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
The condition is local to two consecutive rows, so the count is a walk count on $S=276$
...
OEIS A237031 is ``Number of (n+1)X(4+1) 0..2 arrays with the maximum of every 2X2 subblock equal.''. It has offset $1$ and begins
\[
30045, 4552617, 638436002, 93104881597, 13403891066319, 1939706609440732, 280172591227575985, 40497311726696094149,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 09:46:33, revision 6) this is still
...
array, which is not among the objects counted. There are $S=276$ states left.
...
\begin{theorem}
\[
a(n)\;=\;120\,a(n-1) + 6153\,a(n-2) - 363748\,a(n-3) - 3957016\,a(n-4) + 306155172\,a(n-5) - 1955225983\,a(n-6) - 32438472776\,a(n-7) + 200128530735\,a(n-8) + 1410935167008\,a(n-9) - 3399280459696\,a(n-10) - 9790743035136\,a(n-11) + 31593008567296\,a(n-12) - 23604586610688\,a(n-13) - 806694420480\,a(n-14) + 4431324119040\,a(n-15)
\]
for every $n>14$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237031.
