...
\title{The empirical recurrence for OEIS A220619, proved by transfer matrix}
...
\begin{abstract}
OEIS A220619 counts the ways of linking the cells of a grid $6$ cells wide, each cell either to
...
state, the count is a walk count on $S=169$ of them, and the conjectured recurrence is then
...
OEIS A220619 is ``Number of ways to reciprocally link elements of an nX6 array either to themselves or to exactly one horizontal, diagonal and antidiagonal neighbor.''. It has offset $1$ and begins
\[
13, 1215, 76955, 5280827, 356768525, 24177895648, 1637496710797, 110916199227139,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 18:54:40, revision 8) this is still
...
one configuration. With $M$ the adjacency matrix of the digraph on the $S=169$ reachable
...
\begin{theorem}
\[
a(n)\;=\;75\,a(n-1) - 234\,a(n-2) - 18880\,a(n-3) + 81906\,a(n-4) + 899610\,a(n-5) - 3495200\,a(n-6) - 14871391\,a(n-7) + 57262153\,a(n-8) + 94978240\,a(n-9) - 425367914\,a(n-10) - 207014564\,a(n-11) + 1449829450\,a(n-12) + 111910344\,a(n-13) - 2364082704\,a(n-14) - 29030256\,a(n-15) + 1700883948\,a(n-16) + 349734858\,a(n-17) - 215936884\,a(n-18) - 545425394\,a(n-19) - 380424104\,a(n-20) + 341201464\,a(n-21) + 219237544\,a(n-22) - 120388312\,a(n-23) - 52194454\,a(n-24) + 28101292\,a(n-25) + 7351846\,a(n-26) - 4063344\,a(n-27) - 843527\,a(n-28) + 300917\,a(n-29) + 79254\,a(n-30) - 10858\,a(n-31) - 4326\,a(n-32) + 168\,a(n-33) + 112\,a(n-34) - a(n-35) - a(n-36)
\]
for every $n>35$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A220619.
