...
\title{The empirical recurrence for OEIS A206271, proved by transfer matrix}
...
\begin{abstract}
OEIS A206271 counts arrays of width $3$ over $\{0,1,2\}$ subject to a condition read round the
...
count is a walk count on a finite digraph with $S=121$ vertices, and whether a linear
...
OEIS A206271 is ``Number of (n+1) X 3 0..2 arrays with no 2 X 2 subblock having the number of clockwise edge increases equal to the number of counterclockwise edge increases in its adjacent leftward or upward neighbors.''. It has offset $1$ and begins
\[
306, 972, 3168, 11205, 35922, 123357, 408198, 1376754,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 11 2015 21:25:36, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-2) + 28\,a(n-4) + 36\,a(n-5) - 18\,a(n-6) + 78\,a(n-7) - 490\,a(n-8) + 298\,a(n-9) + 86\,a(n-10) - 854\,a(n-11) + 1669\,a(n-12) - 524\,a(n-13) - 872\,a(n-14) + 648\,a(n-15) + 140\,a(n-16) - 302\,a(n-17) + 10\,a(n-18) + 76\,a(n-19) + 8\,a(n-20) - 16\,a(n-21) + 8\,a(n-22)
\]
for every $n>24$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206271.
