...
\title{The empirical recurrence for OEIS A253372, proved by transfer matrix}
...
\begin{abstract}
OEIS A253372 counts the arrays over $\{0,\dots,2\}$ whose $2\times2$ subblocks carry a
...
so a pair of consecutive array rows is a state, the count is a walk count on $S=49284$ of them,
...
OEIS A253372 is ``Number of (n+1)X(5+1) 0..2 arrays with every 2X2 subblock sum nondecreasing horizontally, vertically and antidiagonally ne-to-sw.''. It has offset $1$ and begins
\[
49284, 945748, 17316309, 105139503, 811079978, 3064820088, 15266963762, 46594669823,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 14:00:48, revision 6) this is still
...
\]
on the $S=49284$ admissible pairs. In particular $a$ is $C$-finite. The alignment of the walk
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253372.
