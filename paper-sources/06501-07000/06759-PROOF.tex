...
\title{The empirical recurrence for OEIS A300883, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A300883 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A300883 is ``Number of nX3 0..1 arrays with every element equal to 0, 1, 3, 4 or 5 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
3, 2, 4, 8, 17, 57, 148, 356,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 14 2018 07:25:53, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-2) + 7\,a(n-3) + 6\,a(n-4) - 15\,a(n-5) - 47\,a(n-6) - 47\,a(n-7) + 5\,a(n-8) + 102\,a(n-9) + 86\,a(n-10) + 23\,a(n-12) + 28\,a(n-13) - 51\,a(n-14) - 119\,a(n-15) - 24\,a(n-16) + 111\,a(n-17) + 69\,a(n-18) - 21\,a(n-19) - 27\,a(n-20) - 6\,a(n-21)
\end{equation}
for all $n>25$.
...
publishes, $n=30$, the arrays have $3\cdot30$ cells over
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A300883.
