...
\title{The empirical recurrence for OEIS A281562, proved by transfer matrix}
...
\begin{abstract}
OEIS A281562 counts $n\times7$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
every CELL over a neighbour set the entry names, and counted UP TO RELABELLING of the
alphabet; it carries an empirical recurrence of order $35$ contributed by
...
OEIS A281562 is ``Number of nX7 0..1 arrays with no element equal to more than two of its horizontal, diagonal or antidiagonal neighbors, with the exception of exactly two elements, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
0, 2180, 16656, 67834, 243040, 692421, 1818257, 4578736,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 24 2017 08:35:23, revision 4) this is still
...
the condition
\[
\text{no cell is equal to more than 2 of its horizontal, diagonal or antidiagonal neighbours},
\]
...
$(r,s)\in(\{0,\dots,1\}^{7}\cup\{\varnothing\})\times\{0,\dots,1\}^{7}$ \times \{0,\dots,2\},
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) - 7\,a(n-2) + 10\,a(n-3) - 38\,a(n-4) + 34\,a(n-5) + 7\,a(n-6) + 88\,a(n-7) - 38\,a(n-8) - 170\,a(n-9) - 101\,a(n-10) - 17\,a(n-11) + 372\,a(n-12) + 141\,a(n-13) + 120\,a(n-14) - 163\,a(n-15) - 310\,a(n-16) - 331\,a(n-17) - 391\,a(n-18) + 389\,a(n-19) + 548\,a(n-20) + 414\,a(n-21) - 66\,a(n-22) - 180\,a(n-23) - 106\,a(n-24) - 499\,a(n-25) - 184\,a(n-26) + 235\,a(n-27) + 274\,a(n-28) + 37\,a(n-29) - 27\,a(n-30) + 90\,a(n-31) - 81\,a(n-32) - 108\,a(n-33) + 27\,a(n-34) + 27\,a(n-35)
\]
for every $n>58$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A281562.
