...
\title{The empirical recurrence for OEIS A231994, proved by transfer matrix}
...
\begin{abstract}
OEIS A231994 counts $(n+1)\times6$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A231994 is ``Number of (n+1)X(5+1) 0..1 arrays with no element having a strict majority of its horizontal and antidiagonal neighbors equal to one.''. It has offset $1$ and begins
\[
81, 1225, 28900, 674041, 15594601, 362293156, 8404672329, 195072388900,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 06:46:43, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;20\,a(n-1) + 179\,a(n-2) - 2319\,a(n-3) - 6465\,a(n-4) + 94400\,a(n-5) + 4135\,a(n-6) - 1470735\,a(n-7) + 1313306\,a(n-8) + 11370092\,a(n-9) - 15268354\,a(n-10) - 49210967\,a(n-11) + 80813004\,a(n-12) + 124534656\,a(n-13) - 241975664\,a(n-14) - 181214096\,a(n-15) + 440235929\,a(n-16) + 133638297\,a(n-17) - 500004759\,a(n-18) - 15377732\,a(n-19) + 357539404\,a(n-20) - 51988544\,a(n-21) - 160824989\,a(n-22) + 43049434\,a(n-23) + 44820649\,a(n-24) - 16338828\,a(n-25) - 7424574\,a(n-26) + 3443248\,a(n-27) + 659756\,a(n-28) - 412295\,a(n-29) - 21425\,a(n-30) + 26930\,a(n-31) - 745\,a(n-32) - 861\,a(n-33) + 64\,a(n-34) + 10\,a(n-35) - a(n-36)
\]
for every $n>36$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231994.
