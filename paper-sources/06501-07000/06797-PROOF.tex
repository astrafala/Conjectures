...
\title{The empirical recurrence for OEIS A297392, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297392 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A297392 is ``Number of nX5 0..1 arrays with every 1 horizontally, diagonally or antidiagonally adjacent to 1 neighboring 1.''. It has offset $1$ and begins
\[
6, 33, 127, 700, 3175, 15541, 74736, 358341,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 29 2017 10:54:05, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 8\,a(n-2) + 27\,a(n-3) + 77\,a(n-4) + 164\,a(n-5) - 4\,a(n-6) - 124\,a(n-7) - 71\,a(n-8) - 231\,a(n-9) - 293\,a(n-10) - 114\,a(n-11) - 16\,a(n-12) + 2\,a(n-13) + 40\,a(n-14) + 98\,a(n-15) + 32\,a(n-16) + 16\,a(n-17) + 5\,a(n-18) + a(n-19) - a(n-20)
\end{equation}
for all $n>21$.
...
publishes, $n=21$, the arrays have $5\cdot21$ cells over
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297392.
