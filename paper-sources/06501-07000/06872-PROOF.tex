...
\title{The empirical recurrence for OEIS A281136, proved by transfer matrix}
...
\begin{abstract}
OEIS A281136 counts $n\times5$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A281136 is ``Number of nX5 0..2 arrays with no element equal to more than one of its king-move neighbors, with the exception of exactly one element, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
8, 504, 3460, 5368, 9484, 17592, 33199, 63976,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 15 2017 09:29:36, revision 4) this is still
...
the condition
\[
\text{no cell is equal to more than 1 of its king-move neighbours},
\]
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + a(n-2) - 4\,a(n-3) + 5\,a(n-4) - 4\,a(n-5) + 5\,a(n-6) - 4\,a(n-7) - 14\,a(n-8) + 12\,a(n-9) - 13\,a(n-10) + 14\,a(n-11) - 24\,a(n-12) + 20\,a(n-13) + 9\,a(n-14) + 8\,a(n-15) + 7\,a(n-16) - 10\,a(n-17) + 20\,a(n-18) - 6\,a(n-19) - 6\,a(n-20) - 12\,a(n-21) - 9\,a(n-24)
\]
for every $n>33$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A281136.
