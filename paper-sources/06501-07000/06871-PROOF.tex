...
\title{The empirical recurrence for OEIS A302213, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A302213 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A302213 is ``Number of 3Xn 0..1 arrays with every element equal to 0, 2 or 3 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
4, 2, 16, 5, 32, 22, 72, 101,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 03 2018 12:02:36, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) + 4\,a(n-2) - 29\,a(n-3) - 3\,a(n-4) + 96\,a(n-5) - 14\,a(n-6) - 187\,a(n-7) + 39\,a(n-8) + 246\,a(n-9) - 52\,a(n-10) - 230\,a(n-11) + 48\,a(n-12) + 146\,a(n-13) - 29\,a(n-14) - 57\,a(n-15) + 9\,a(n-16) + 12\,a(n-17) - a(n-18) - a(n-19)
\end{equation}
for all $n>20$.
...
publishes, $n=31$, the arrays have $3\cdot31$ cells over
$2$ values, so there are about $10^{27}$ of them to sift. The
walk count replaces that by $64$ states and one matrix--vector product per column.

The threshold below is exact rather than merely sufficient: at $n=20$ the conjectured
...
every one of the $31$ published indices, with no shift fitted: the number of columns is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302213.
