...
\title{The empirical recurrence for OEIS A250959, proved by transfer matrix}
...
\begin{abstract}
OEIS A250959 counts $(n+1)\times3$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A250959 is ``Number of (n+1)X(2+1) 0..3 arrays with no 2X2 subblock having its minimum diagonal element less than its minimum antidiagonal element.''. It has offset $1$ and begins
\[
1592, 34988, 768855, 17233753, 390286993, 8862302446, 201262465235, 4569607131470,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 12:54:20, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;64\,a(n-1) - 1748\,a(n-2) + 28346\,a(n-3) - 310754\,a(n-4) + 2462920\,a(n-5) - 14717932\,a(n-6) + 68296776\,a(n-7) - 251551335\,a(n-8) + 747834819\,a(n-9) - 1817725856\,a(n-10) + 3647857862\,a(n-11) - 6087841866\,a(n-12) + 8491206253\,a(n-13) - 9927412988\,a(n-14) + 9738203645\,a(n-15) - 8005861493\,a(n-16) + 5496893372\,a(n-17) - 3132361554\,a(n-18) + 1466713771\,a(n-19) - 555901930\,a(n-20) + 166711184\,a(n-21) - 38185312\,a(n-22) + 6298320\,a(n-23) - 669024\,a(n-24) + 34560\,a(n-25)
\end{equation}
for all $n>24$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250959.
