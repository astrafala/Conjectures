...
\title{The empirical recurrence for OEIS A252060, proved by transfer matrix}
...
\begin{abstract}
OEIS A252060 counts $(n+2)\times5$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A252060 is ``Number of (n+2)X(3+2) 0..2 arrays with every 3X3 subblock row, column, diagonal and antidiagonal sum not equal to 1 2 or 4.''. It has offset $1$ and begins
\[
383, 817, 2349, 7463, 25220, 86642, 299027, 1035506,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 10:44:30, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) - 5\,a(n-2) + 22\,a(n-3) - 33\,a(n-4) + 15\,a(n-5) - 139\,a(n-6) + 2\,a(n-7) + 137\,a(n-8) + 528\,a(n-9) + 456\,a(n-10) - 850\,a(n-11) - 1169\,a(n-12) - 1091\,a(n-13) + 1754\,a(n-14) + 1358\,a(n-15) + 224\,a(n-16) - 2415\,a(n-17) - 932\,a(n-18) + 2998\,a(n-19) + 3877\,a(n-20) + 1738\,a(n-21) - 5090\,a(n-22) - 5435\,a(n-23) - 3690\,a(n-24) + 2739\,a(n-25) + 3715\,a(n-26) + 3257\,a(n-27) + 769\,a(n-28) - 176\,a(n-29) - 355\,a(n-30) - 1047\,a(n-31) - 928\,a(n-32) - 796\,a(n-33) + 60\,a(n-34) + 275\,a(n-35) + 230\,a(n-36) + 22\,a(n-37) - 40\,a(n-38) - 4\,a(n-39) + 8\,a(n-40) + 8\,a(n-41)
\]
for every $n>46$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252060.
