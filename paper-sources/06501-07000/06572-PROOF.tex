...
\title{The empirical recurrence for OEIS A296800, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A296800 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
values of its neighbours, and carries an empirical recurrence of order $39$ contributed
...
OEIS A296800 is ``Number of nX4 0..1 arrays with each 1 adjacent to 1, 3 or 4 king-move neighboring 1s.''. It has offset $1$ and begins
\[
4, 41, 164, 1011, 6747, 40956, 261107, 1679397,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 20 2017 21:57:26, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 14\,a(n-2) + 119\,a(n-3) + 8\,a(n-4) - 566\,a(n-5) - 3745\,a(n-6) - 2593\,a(n-7) + 5616\,a(n-8) + 34507\,a(n-9) + 12343\,a(n-10) - 54483\,a(n-11) - 111152\,a(n-12) + 30151\,a(n-13) + 177792\,a(n-14) + 13492\,a(n-15) - 93310\,a(n-16) + 186872\,a(n-17) - 209506\,a(n-18) - 175284\,a(n-19) + 168477\,a(n-20) - 345124\,a(n-21) + 900252\,a(n-22) - 589173\,a(n-23) - 316162\,a(n-24) + 578438\,a(n-25) - 399327\,a(n-26) - 205921\,a(n-27) + 257040\,a(n-28) + 114278\,a(n-29) - 87202\,a(n-30) - 64367\,a(n-31) + 15839\,a(n-32) + 16548\,a(n-33) + 1320\,a(n-34) - 2188\,a(n-35) + 131\,a(n-36) + 230\,a(n-37) + 40\,a(n-38) - 32\,a(n-39)
\end{equation}
for all $n>40$.
...
$o=1n_0+0-2$. Then for $j\ge39$,
\[
a(n_0+j)-\sum_i c_i\,a(n_0+j-i)\;=\;\,\mathbf{v}^{\!\top}G^{\,j-39}w,
\qquad w=h_{39}-\sum_i c_i\,h_{39-i} .
\]
...
\begin{proof}
Substitute Lemma~\ref{lem:walk} and factor $G^{j-39}$ out of
...
the middle row. The vector $w$ was formed by $39$ applications of $G$ in exact integer
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A296800.
