...
\title{The empirical recurrence for OEIS A255143, proved by transfer matrix}
...
\begin{abstract}
OEIS A255143 counts $(n+2)\times4$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
every $3\times3$ subblock, and it carries an empirical recurrence of order $22$
...
OEIS A255143 is ``Number of (n+2)X(2+2) 0..1 arrays with no 3x3 subblock diagonal sum 0 and no antidiagonal sum 0 and no row sum 1 and no column sum 1.''. It has offset $1$ and begins
\[
115, 371, 1310, 4576, 16386, 59681, 217262, 791181,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:38:40, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + a(n-2) + 14\,a(n-3) - 20\,a(n-4) - 38\,a(n-5) - 57\,a(n-6) + 32\,a(n-7) + 181\,a(n-8) + 161\,a(n-9) - 27\,a(n-10) - 301\,a(n-11) - 250\,a(n-12) - 15\,a(n-13) + 250\,a(n-14) + 170\,a(n-15) + 33\,a(n-16) - 94\,a(n-17) - 50\,a(n-18) - 18\,a(n-19) + 18\,a(n-20) + 4\,a(n-22)
\]
for every $n>22$.
\end{theorem}

\begin{proof}
The vector $w=q(M)\mathbf{1}$ was formed by $22$ matrix--vector products in exact
integer arithmetic and $\mathbf{1}^{\!\top}M^{j}w$ evaluated for $j=0,1,\dots$, again
exactly. Those integers vanish from the index corresponding to $n=22+1$ onwards, and the
run was continued until the working vector was identically zero, which settles all larger $j$
at once. By Lemma~\ref{lem:crit} the recurrence holds for every $n>22$.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A255143.
