...
\title{The empirical recurrence for OEIS A253837, proved by transfer matrix}
...
\begin{abstract}
OEIS A253837 counts the arrays over $\{0,\dots,1\}$ whose $3\times3$ subblocks carry a
...
OEIS A253837 is ``Number of (n+2)X(4+2) 0..1 arrays with every 3X3 subblock diagonal sum plus antidiagonal sum nondecreasing horizontally, vertically and ne-to-sw antidiagonally.''. It has offset $1$ and begins
\[
28540, 50462, 135011, 284109, 167413, 204420, 196053, 121909,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 14:16:54, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) - a(n-2) + 2\,a(n-6) - 4\,a(n-7) + 3\,a(n-8) - 2\,a(n-9) + a(n-10) - a(n-12) + 2\,a(n-13) - 3\,a(n-14) + 4\,a(n-15) - 2\,a(n-16) + a(n-20) - 2\,a(n-21) + a(n-22)
\]
for every $n>34$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253837.
