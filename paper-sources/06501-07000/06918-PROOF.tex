...
\title{The empirical recurrence for OEIS A259739, proved by transfer matrix}
...
\begin{abstract}
OEIS A259739 counts $(n+2)\times7$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A259739 is ``Number of (n+2) X (5+2) 0..1 arrays with each 3 X 3 subblock having clockwise perimeter pattern 00010101 or 01010101.''. It has offset $1$ and begins
\[
101, 230, 792, 1882, 4904, 12086, 35036, 82492,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-2) +24*a(n-4) +17*a(n-6) -53*a(n-8) +26*a(n-10) +9*a(n-12) -13*a(n-14) +a(n-16) +a(n-18) for n>19.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 08 2023 14:09:05, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-2) + 24\,a(n-4) + 17\,a(n-6) - 53\,a(n-8) + 26\,a(n-10) + 9\,a(n-12) - 13\,a(n-14) + a(n-16) + a(n-18)
\]
for every $n>19$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A259739.
