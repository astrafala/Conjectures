...
\title{The empirical recurrence for OEIS A300205, proved by transfer matrix}
...
\begin{abstract}
OEIS A300205 counts $5$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $equal to$ itself lying in $\{0,1,2,3,4,5,6,8\}$, and it carries an empirical
...
OEIS A300205 is ``Number of n X 5 0..1 arrays with every element equal to 0, 1, 2, 3, 4, 5, 6 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
16, 512, 15070, 451996, 13548425, 406228452, 12180207076, 365209429387,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 24 2023 10:02:06, revision
6) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;30\,a(n-1) - 8\,a(n-2) + 343\,a(n-3) - 3214\,a(n-4) - 9170\,a(n-5) - 6989\,a(n-6) - 9332\,a(n-7) + 482996\,a(n-8) + 36160\,a(n-9) + 495066\,a(n-10) - 4606283\,a(n-11) - 2769327\,a(n-12) + 1332664\,a(n-13) + 25229638\,a(n-14) + 18945541\,a(n-15) - 24172763\,a(n-16) - 111255521\,a(n-17) - 63862029\,a(n-18) + 129871861\,a(n-19) + 300380879\,a(n-20) + 152885144\,a(n-21) - 339369704\,a(n-22) - 486006309\,a(n-23) - 128959877\,a(n-24) + 341481538\,a(n-25) + 413606386\,a(n-26) + 91315190\,a(n-27) - 187554462\,a(n-28) - 184211455\,a(n-29) - 33354181\,a(n-30) + 50022664\,a(n-31) + 38893772\,a(n-32) + 6506118\,a(n-33) - 4777876\,a(n-34) - 3960944\,a(n-35) - 936320\,a(n-36) + 381696\,a(n-37) + 156672\,a(n-38)
\end{equation}
for all $n>38$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A300205.
