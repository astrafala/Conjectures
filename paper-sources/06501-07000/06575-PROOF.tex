...
\title{The empirical recurrence for OEIS A252058, proved by transfer matrix}
...
\begin{abstract}
OEIS A252058 counts $(n+2)\times3$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A252058 is ``Number of (n+2)X(1+2) 0..2 arrays with every 3X3 subblock row, column, diagonal and antidiagonal sum not equal to 1 2 or 4.''. It has offset $1$ and begins
\[
125, 200, 383, 843, 1948, 4569, 10836, 25739,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 10:44:15, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) - a(n-2) + 9\,a(n-3) - 10\,a(n-4) + 7\,a(n-5) - 24\,a(n-6) + 12\,a(n-7) - 18\,a(n-8) + 23\,a(n-9) + 7\,a(n-10) + 26\,a(n-11) - 2\,a(n-12) - 21\,a(n-13) - 21\,a(n-14) - 12\,a(n-15) + 13\,a(n-16) + 5\,a(n-17) + 7\,a(n-18) - a(n-19) + 4\,a(n-20) - 2\,a(n-21) - 2\,a(n-23)
\]
for every $n>24$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252058.
