...
\title{The empirical recurrence for OEIS A317739, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A317739 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A317739 is ``Number of nX6 0..1 arrays with every element unequal to 2 or 3 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
0, 9, 4, 23, 38, 22, 36, 140,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 05 2018 15:59:13, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-2) + 13\,a(n-3) - 2\,a(n-4) - 38\,a(n-5) - 72\,a(n-6) + 24\,a(n-7) + 141\,a(n-8) + 183\,a(n-9) - 123\,a(n-10) - 228\,a(n-11) - 227\,a(n-12) + 266\,a(n-13) - 162\,a(n-14) + 273\,a(n-15) - 65\,a(n-16) + 2154\,a(n-17) - 411\,a(n-18) + 1075\,a(n-19) - 5504\,a(n-20) + 1745\,a(n-21) - 7708\,a(n-22) + 5966\,a(n-23) - 10880\,a(n-24) + 15631\,a(n-25) - 7395\,a(n-26) + 25649\,a(n-27) - 17569\,a(n-28) + 18793\,a(n-29) - 29769\,a(n-30) + 18327\,a(n-31) - 32563\,a(n-32) + 20822\,a(n-33) - 20922\,a(n-34) + 34936\,a(n-35) - 10939\,a(n-36) + 20583\,a(n-37) - 25081\,a(n-38) + 6260\,a(n-39) - 15245\,a(n-40) + 12332\,a(n-41) - 4808\,a(n-42) + 7884\,a(n-43) - 4354\,a(n-44) + 3120\,a(n-45) - 2603\,a(n-46) + 1249\,a(n-47) - 1135\,a(n-48) + 491\,a(n-49) - 281\,a(n-50) + 187\,a(n-51) - 45\,a(n-52) + 32\,a(n-53) - 10\,a(n-54) + a(n-55) - a(n-56)
\end{equation}
for all $n>63$.
...
publishes, $n=33$, the arrays have $6\cdot33$ cells over
$2$ values, so there are about $10^{59}$ of them to sift. The
...
\begin{theorem}
The recurrence \eqref{eq:conj} holds for every $n>63$, which is the statement of
Section~1.
\end{theorem}
...
Every one of those integers vanishes from the index corresponding to $n=63+1$ onwards,
...
every one of the $33$ published indices, with no shift fitted: the number of rows is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A317739.
