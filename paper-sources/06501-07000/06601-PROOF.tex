...
\title{The empirical recurrence for OEIS A207244, proved by transfer matrix}
...
\begin{abstract}
OEIS A207244 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
...
OEIS A207244 is ``Number of 4Xn 0..1 arrays avoiding 0 0 0 and 0 1 1 horizontally and 0 0 1 and 0 1 0 vertically.''. It has offset
$1$ and begins
\[
9, 81, 287, 987, 2884, 7165, 17929,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 13:40:26, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) - 4\,a(n-2) - 12\,a(n-3) + 3\,a(n-4) + 47\,a(n-5) - 17\,a(n-6) - 66\,a(n-7) - 9\,a(n-8) + 90\,a(n-9) + 2\,a(n-10) - 33\,a(n-11) + a(n-12) - 5\,a(n-13) - 44\,a(n-14) + 19\,a(n-15) + 52\,a(n-16) - 16\,a(n-17) - 7\,a(n-18) - 3\,a(n-19) + a(n-20) - 18\,a(n-21) + 17\,a(n-22) - 2\,a(n-23) + 2\,a(n-24) - 3\,a(n-25) + 3\,a(n-26) - 3\,a(n-27) + a(n-28)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207244.
