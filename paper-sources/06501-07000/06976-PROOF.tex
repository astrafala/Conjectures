...
\title{The empirical recurrence for OEIS A281650, proved by transfer matrix}
...
\begin{abstract}
OEIS A281650 counts $n\times4$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A281650 is ``Number of nX4 0..2 arrays with no element equal to more than one of its horizontal, diagonal or antidiagonal neighbors, with the exception of exactly one element, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
2, 400, 7986, 135444, 2159590, 32771472, 483655876, 6987992320,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 26 2017 07:17:38, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;26\,a(n-1) - 163\,a(n-2) - 252\,a(n-3) + 2003\,a(n-4) + 3540\,a(n-5) - 3665\,a(n-6) - 21804\,a(n-7) - 50091\,a(n-8) - 16676\,a(n-9) + 102064\,a(n-10) + 103800\,a(n-11) + 42777\,a(n-12) - 28852\,a(n-13) - 138546\,a(n-14) + 272762\,a(n-15) - 25872\,a(n-16) - 879144\,a(n-17) + 249945\,a(n-18) + 514090\,a(n-19) - 431504\,a(n-20) + 81404\,a(n-21) + 293927\,a(n-22) + 131582\,a(n-23) + 143\,a(n-24) - 73224\,a(n-25) - 55435\,a(n-26) - 40960\,a(n-27) - 21076\,a(n-28) - 7894\,a(n-29) - 2713\,a(n-30) - 598\,a(n-31) - 169\,a(n-32)
\]
for every $n>37$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A281650.
