...
\title{The empirical recurrence for OEIS A230471, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A230471 counts arrays over $\{0,\dots,2\}$ in which every cell is constrained by the
...
OEIS A230471 is ``Number of 3Xn 0..2 arrays x(i,j) with each element horizontally, diagonally or antidiagonally next to at least one element with value (x(i,j)+1) mod 3, and upper left element zero.''. It has offset $1$ and begins
\[
0, 2, 114, 2398, 35052, 552720, 8724560, 138661614,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 05:51:40, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;14\,a(n-1) + 28\,a(n-2) - 48\,a(n-3) + 1092\,a(n-4) + 977\,a(n-5) + 713\,a(n-6) - 890\,a(n-7) - 1936\,a(n-8) - 2762\,a(n-9) - 712\,a(n-10) - 1021\,a(n-11) - 128\,a(n-12) - 438\,a(n-13) - 24\,a(n-15) + 16\,a(n-16)
\end{equation}
for all $n>17$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A230471.
