...
\title{The empirical recurrence for OEIS A303452, proved by transfer matrix}
...
\begin{abstract}
OEIS A303452 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the six horizontal, diagonal and antidiagonal neighbours, a number $equal to$ itself lying in $\{0,1,2,3,4,6\}$, and it carries an empirical
...
OEIS A303452 is ``Number of nX4 0..1 arrays with every element equal to 0, 1, 2, 3, 4 or 6 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
8, 128, 1690, 22756, 306767, 4136339, 55781418, 752277525,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 24 2018 10:19:13, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;14\,a(n-1) - 60\,a(n-3) - 434\,a(n-4) - 284\,a(n-5) + 588\,a(n-6) + 2516\,a(n-7) + 2538\,a(n-8) + 909\,a(n-9) - 2033\,a(n-10) - 2841\,a(n-11) - 1886\,a(n-12) - 1370\,a(n-13) - 740\,a(n-14) - 208\,a(n-15)
\end{equation}
for all $n>15$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A303452.
