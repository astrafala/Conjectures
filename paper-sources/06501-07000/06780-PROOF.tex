...
\title{The empirical recurrence for OEIS A253754, proved by transfer matrix}
...
\begin{abstract}
OEIS A253754 counts the arrays over $\{0,\dots,2\}$ whose $2\times2$ subblocks carry a
...
so a pair of consecutive array rows is a state, the count is a walk count on $S=95940$ of them,
...
OEIS A253754 is ``Number of (6+1) X (n+1) 0..2 arrays with every 2 X 2 subblock ne-sw antidiagonal difference nondecreasing horizontally and nw+se diagonal sum nondecreasing vertically.''. It has offset $1$ and begins
\[
95940, 1087364, 5648005, 17656505, 36766701, 64166071, 106040628, 163826702,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 26 2022 20:07:17, revision 8) this is still
...
\]
on the $S=95940$ admissible pairs. In particular $a$ is $C$-finite. The alignment of the walk
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253754.
