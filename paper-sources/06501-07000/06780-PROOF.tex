...
\title{The empirical recurrence for OEIS A253746, proved by transfer matrix}
...
\begin{abstract}
OEIS A253746 counts the arrays over $\{0,\dots,2\}$ whose $2\times2$ subblocks carry a
...
OEIS A253746 is ``Number of (n+1)X(5+1) 0..2 arrays with every 2X2 subblock ne-sw antidiagonal difference nondecreasing horizontally and nw+se diagonal sum nondecreasing vertically.''. It has offset $1$ and begins
\[
28107, 70590, 583698, 2351928, 10966149, 36766701, 112645903, 295452432,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 14:12:32, revision 10) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253746.
