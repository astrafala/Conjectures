...
\title{The empirical recurrence for OEIS A252681, proved by transfer matrix}
...
\begin{abstract}
OEIS A252681 counts $4\times(n+2)$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252681 is ``Number of (2+2)X(n+2) 0..3 arrays with every 3X3 subblock row and diagonal sum equal to 0 2 5 6 or 7 and every 3X3 column and antidiagonal sum not equal to 0 2 5 6 or 7.''. It has offset $1$ and begins
\[
750, 630, 1005, 1525, 3185, 6645, 10933, 24685,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:31:25, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;24\,a(n-3) - 203\,a(n-6) + 722\,a(n-9) - 959\,a(n-12) - 64\,a(n-15) + 1043\,a(n-18) - 682\,a(n-21) + 120\,a(n-24)
\]
for every $n>33$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252681.
