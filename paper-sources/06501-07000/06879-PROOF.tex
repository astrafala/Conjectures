...
\title{The empirical recurrence for OEIS A236016, proved by transfer matrix}
...
\begin{abstract}
OEIS A236016 carries an empirical recurrence of order $34$ contributed by R.~H.~Hardin. It is
true, and it is decidable rather than empirical. The entry's condition is local to a bounded window of consecutive lines, so
the admissible configurations of such a window are the vertices of a finite digraph and the
arrays counted are exactly the walks in it; hence $a(n)$ is a walk count on $S=70688$ vertices
...
OEIS A236016 is ``Number of (n+1) X (6+1) 0..2 arrays colored with the sum of the maximum and minimum values of each 2 X 2 subblock.''. It has offset $1$ and begins
\[
70688, 140716, 313060, 771564, 2004428, 5805712, 15065380, 40075220,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 11 2023 13:08:24, revision 6) this is still
...
admissible array is then exactly a walk, so with $M$ the adjacency matrix on $S=70688$ vertices
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A236016.
