...
\title{The empirical recurrence for OEIS A183348, proved by transfer matrix}
...
\begin{abstract}
OEIS A183348 counts arrays of width $6$ over $\{0,1\}$ under local conditions relating each cell
...
OEIS A183348 is ``Number of nX6 binary arrays with each 1 adjacent to exactly one 0 vertically and one 0 horizontally.''. It has offset $1$ and begins
\[
1, 59, 144, 387, 1738, 6388, 21613, 80265,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 01:35:28, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 3\,a(n-2) + 22\,a(n-3) + 20\,a(n-4) - 19\,a(n-5) - 93\,a(n-6) - 123\,a(n-7) + 61\,a(n-8) + 266\,a(n-9) + 98\,a(n-10) - 170\,a(n-11) - 107\,a(n-12) + 6\,a(n-13) + 6\,a(n-14) + 2\,a(n-15) + 17\,a(n-16) - 4\,a(n-17) + 10\,a(n-18) + a(n-20)
\]
for every $n>20$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A183348.
