...
\title{The empirical recurrence for OEIS A234884, proved by transfer matrix}
...
\begin{abstract}
OEIS A234884 counts $3$-column arrays over $\{0,\dots,5\}$ in which every
...
OEIS A234884 is ``Number of (n+1) X (2+1) 0..5 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 1, with no adjacent elements equal (constant-stress tilted 1 X 1 tilings).''. It has offset
$1$ and begins
\[
272, 980, 3164, 11984, 40856, 159004, 551048,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 20 2022 18:33:42, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 46\,a(n-2) - 91\,a(n-3) - 852\,a(n-4) + 1670\,a(n-5) + 8364\,a(n-6) - 16318\,a(n-7) - 48531\,a(n-8) + 94856\,a(n-9) + 177211\,a(n-10) - 349287\,a(n-11) - 422181\,a(n-12) + 844527\,a(n-13) + 666796\,a(n-14) - 1362305\,a(n-15) - 697540\,a(n-16) + 1464198\,a(n-17) + 475379\,a(n-18) - 1029412\,a(n-19) - 204338\,a(n-20) + 455683\,a(n-21) + 52461\,a(n-22) - 118912\,a(n-23) - 7142\,a(n-24) + 16187\,a(n-25) + 376\,a(n-26) - 846\,a(n-27)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234884.
