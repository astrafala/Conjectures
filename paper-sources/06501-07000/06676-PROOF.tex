...
\title{The empirical recurrence for OEIS A253794, proved by transfer matrix}
...
\begin{abstract}
OEIS A253794 counts the arrays over $\{0,\dots,1\}$ whose $3\times3$ subblocks carry a
...
OEIS A253794 is ``Number of (n+2)X(1+2) 0..1 arrays with every 3X3 subblock diagonal maximum plus antidiagonal median nondecreasing horizontally and vertically.''. It has offset $1$ and begins
\[
512, 2908, 14096, 66144, 299472, 1303600, 5525648, 23034276,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 14:14:36, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-1) - 19\,a(n-2) + 13\,a(n-3) - 8\,a(n-4) + 27\,a(n-5) - 79\,a(n-6) + 156\,a(n-7) - 217\,a(n-8) - 235\,a(n-9) + 964\,a(n-10) - 1201\,a(n-11) + 1488\,a(n-12) - 256\,a(n-13) - 1064\,a(n-14) + 994\,a(n-15) - 1048\,a(n-16) + 254\,a(n-17) - 132\,a(n-18) + 400\,a(n-19) - 204\,a(n-20) - 56\,a(n-21) + 256\,a(n-22) - 40\,a(n-23) + 16\,a(n-24) - 16\,a(n-26)
\]
for every $n>26$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253794.
