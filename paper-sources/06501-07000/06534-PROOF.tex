...
\title{The empirical recurrence for OEIS A188872, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A188872 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A188872 is ``Number of nX7 binary arrays without the pattern 0 0 0 antidiagonally or horizontally.''. It has offset $1$ and begins
\[
81, 6561, 385700, 24609576, 1558668181, 98523889293, 6231989402196, 394199392835388,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 04:54:36, revision 9) the statement is
...
publishes, $n=13$, the arrays have $7\cdot13$ cells over
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A188872.
