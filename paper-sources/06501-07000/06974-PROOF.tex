...
\title{The empirical recurrence for OEIS A249705, proved by transfer matrix}
...
\begin{abstract}
OEIS A249705 carries an empirical recurrence of order $37$ contributed by R.~H.~Hardin. It is
...
OEIS A249705 is ``Number of length n+3 0..6 arrays with every four consecutive terms having the maximum of some two terms equal to the minimum of the remaining two terms.''. It has offset $1$ and begins
\[
595, 1729, 4893, 12789, 29673, 75495, 200489, 528755,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 12:06:18, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A249705.
