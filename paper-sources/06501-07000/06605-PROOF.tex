...
\title{The empirical recurrence for OEIS A251031, proved by transfer matrix}
...
\begin{abstract}
OEIS A251031 counts arrays over $\{0,1,2,3\}$ in which a statistic taken over short runs
...
OEIS A251031 is ``Number of (n+1)X(2+1) 0..3 arrays with nondecreasing min(x(i,j),x(i,j-1)) in the i direction and nondecreasing absolute value of x(i,j)-x(i-1,j) in the j direction.''. It has offset $1$ and begins
\[
711, 6089, 45150, 304421, 1946207, 12029009, 72779934, 434254685,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:01:04, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;38\,a(n-1) - 640\,a(n-2) + 6224\,a(n-3) - 37777\,a(n-4) + 140106\,a(n-5) - 246243\,a(n-6) - 311318\,a(n-7) + 2866723\,a(n-8) - 6221140\,a(n-9) + 1267287\,a(n-10) + 20418382\,a(n-11) - 36000935\,a(n-12) - 3163420\,a(n-13) + 76544079\,a(n-14) - 62345650\,a(n-15) - 62658186\,a(n-16) + 109336358\,a(n-17) + 10886761\,a(n-18) - 92320878\,a(n-19) + 17077256\,a(n-20) + 47426642\,a(n-21) - 13020476\,a(n-22) - 16187272\,a(n-23) + 3593112\,a(n-24) + 3641608\,a(n-25) - 208432\,a(n-26) - 421728\,a(n-27) - 60480\,a(n-28)
\]
for every $n>28$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251031.
