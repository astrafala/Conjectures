...
\title{The empirical recurrence for OEIS A238058, proved by transfer matrix}
...
\begin{abstract}
OEIS A238058 counts arrays over $\{0,\dots,3\}$ subject to a condition on the order
...
OEIS A238058 is ``Number of (n+1)X(1+1) 0..3 arrays with the maximum plus the lower median minus the upper median of every 2X2 subblock differing from its horizontal and vertical neighbors by exactly one.''. It has offset $1$ and begins
\[
256, 1910, 14429, 109386, 828750, 6261150, 47346273, 358316792,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 10:44:01, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;2348\,a(n-4) + 50196\,a(n-6) + 164236\,a(n-8) - 42860\,a(n-10) + 2752240\,a(n-12) - 2760128\,a(n-14) + 10991872\,a(n-16) - 60822016\,a(n-18) - 31266816\,a(n-20) + 26937344\,a(n-22) + 27664384\,a(n-24) + 6701056\,a(n-26)
\]
for every $n>26$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A238058.
