...
\title{The empirical recurrence for OEIS A252684, proved by transfer matrix}
...
\begin{abstract}
OEIS A252684 counts $7\times(n+2)$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
$a(n)$ is a walk count on $S=16851$ vertices. Such a sequence is $C$-finite, so whether a given
...
OEIS A252684 is ``Number of (5+2)X(n+2) 0..3 arrays with every 3X3 subblock row and diagonal sum equal to 0 2 5 6 or 7 and every 3X3 column and antidiagonal sum not equal to 0 2 5 6 or 7.''. It has offset $1$ and begins
\[
1648, 3573, 11543, 22203, 96174, 362380, 722737, 3155586,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:31:45, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;82\,a(n-3) - 2182\,a(n-6) + 20596\,a(n-9) - 41475\,a(n-12) - 415132\,a(n-15) + 2151263\,a(n-18) + 750453\,a(n-21) - 24659576\,a(n-24) + 33367593\,a(n-27) + 110280081\,a(n-30) - 295729307\,a(n-33) - 64677480\,a(n-36) + 860048039\,a(n-39) - 928926018\,a(n-42) + 296870954\,a(n-45) + 52220748\,a(n-48) - 51097950\,a(n-51) + 10657520\,a(n-54) - 845088\,a(n-57) + 26880\,a(n-60)
\]
for every $n>66$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252684.
