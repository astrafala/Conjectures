...
\title{The empirical recurrence for OEIS A251773, proved by transfer matrix}
...
\begin{abstract}
OEIS A251773 counts arrays of width $4$ over $\{0,1,2,3\}$ in which every $3\times3$ window has
...
OEIS A251773 is ``Number of (n+2) X (2+2) 0..3 arrays with every 3 X 3 subblock row and column sum 3 or 6 and every diagonal and antidiagonal sum not 3 or 6.''. It has offset $1$ and begins
\[
1142, 4182, 12242, 34934, 132886, 430730, 1317638, 5134774,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 20 2024 18:16:11, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 82\,a(n-3) - 82\,a(n-4) - 2074\,a(n-6) + 2074\,a(n-7) + 19954\,a(n-9) - 19954\,a(n-10) - 70907\,a(n-12) + 70907\,a(n-13) - 8204\,a(n-15) + 8204\,a(n-16) + 575830\,a(n-18) - 575830\,a(n-19) - 914592\,a(n-21) + 914592\,a(n-22) - 424248\,a(n-24) + 424248\,a(n-25) + 1366560\,a(n-27) - 1366560\,a(n-28) - 172800\,a(n-30) + 172800\,a(n-31)
\]
for every $n>31$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251773.
