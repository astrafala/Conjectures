...
\title{The empirical recurrence for OEIS A252451, proved by transfer matrix}
...
\begin{abstract}
OEIS A252451 counts $(n+2)\times4$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252451 is ``Number of (n+2)X(2+2) 0..3 arrays with every 3X3 subblock row, column, diagonal and antidiagonal sum not equal to 0 2 4 6 or 7.''. It has offset $1$ and begins
\[
228, 334, 959, 2643, 7223, 20242, 56643, 157904,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:15:50, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) - 2\,a(n-2) + 7\,a(n-3) - 29\,a(n-4) - 11\,a(n-5) - 10\,a(n-6) + 60\,a(n-7) + 72\,a(n-8) + 39\,a(n-9) - 48\,a(n-10) - 69\,a(n-11) - 75\,a(n-12) - 36\,a(n-13) - 9\,a(n-14) + 30\,a(n-15) + 49\,a(n-16) + 44\,a(n-17) + 14\,a(n-18) - 7\,a(n-19) - 13\,a(n-20) - 7\,a(n-21) - 2\,a(n-22)
\]
for every $n>25$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252451.
