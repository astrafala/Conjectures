...
\title{The empirical recurrence for OEIS A295036, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A295036 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A295036 is ``Number of nX4 0..1 arrays with each 1 horizontally or vertically adjacent to 1 or 2 1s.''. It has offset $1$ and begins
\[
7, 87, 741, 6686, 59126, 528282, 4738235, 42321441,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 12 2017 20:02:18, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) + 11\,a(n-2) + 110\,a(n-3) + 218\,a(n-4) + 381\,a(n-5) - 1782\,a(n-6) - 2295\,a(n-7) + 4944\,a(n-8) + 5724\,a(n-9) - 6097\,a(n-10) - 7938\,a(n-11) - 1252\,a(n-12) + 14108\,a(n-13) + 11254\,a(n-14) - 22229\,a(n-15) - 16840\,a(n-16) + 27235\,a(n-17) - 25020\,a(n-18) + 11308\,a(n-19) + 6762\,a(n-20) - 1639\,a(n-21) + 2585\,a(n-22) + 642\,a(n-23) - 2303\,a(n-24) - 429\,a(n-25) + 661\,a(n-26) - 215\,a(n-27) + 117\,a(n-28) - 14\,a(n-29) - 36\,a(n-30) + 7\,a(n-31) + 4\,a(n-32) + 2\,a(n-33) - a(n-34)
\end{equation}
for all $n>35$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A295036.
