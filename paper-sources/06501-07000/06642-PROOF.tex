...
\title{The empirical recurrence for OEIS A260205, proved by transfer matrix}
...
\begin{abstract}
OEIS A260205 counts $(n+2)\times8$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A260205 is ``Number of (n+2)X(6+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000000 00000001 or 00010001.''. It has offset $1$ and begins
\[
1044, 2864, 15715, 71846, 359112, 1819901, 8929505, 44267361,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 12:03:07, revision 6) this is still
...
\[
\text{the clockwise perimeter word of }g\text{ is a rotation of one of }\{00000000,\ 00000001,\ 00010001\}
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A260205.
