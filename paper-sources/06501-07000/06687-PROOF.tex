...
\title{The empirical recurrence for OEIS A238148, proved by transfer matrix}
...
\begin{abstract}
OEIS A238148 counts arrays over $\{0,\dots,3\}$ subject to a condition on the order
...
OEIS A238148 is ``Number of (n+1)X(1+1) 0..3 arrays with the maximum plus the upper median of every 2X2 subblock differing from its horizontal and vertical neighbors by exactly one.''. It has offset $1$ and begins
\[
256, 1608, 10664, 72584, 499560, 3342416, 22488016, 152285824,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 10:47:09, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;1728\,a(n-4) + 17152\,a(n-6) - 2064\,a(n-8) - 513920\,a(n-10) - 1449280\,a(n-12) - 772864\,a(n-14) + 601600\,a(n-16) + 334848\,a(n-18) - 331776\,a(n-20)
\]
for every $n>21$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A238148.
