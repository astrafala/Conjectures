...
\title{The empirical recurrence for OEIS A304954, proved by transfer matrix}
...
\begin{abstract}
OEIS A304954 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A304954 is ``Number of nX3 0..1 arrays with every element unequal to 1, 2, 3, 5 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 16, 42, 118, 371, 1203, 3917, 12919,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 22 2018 11:23:12, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 4\,a(n-2) + 8\,a(n-3) - 12\,a(n-4) - 42\,a(n-5) + 3\,a(n-6) + a(n-7) + 30\,a(n-8) + 58\,a(n-9) + 60\,a(n-10) + 18\,a(n-11) - 90\,a(n-12) - 70\,a(n-13) - 48\,a(n-14) + 30\,a(n-15) + 39\,a(n-16) + 2\,a(n-17) + 4\,a(n-18) - 4\,a(n-19) - 4\,a(n-20)
\end{equation}
for all $n>21$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A304954.
