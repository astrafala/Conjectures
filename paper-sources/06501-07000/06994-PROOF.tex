...
\title{The empirical recurrence for OEIS A317866, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A317866 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A317866 is ``Number of nX3 0..1 arrays with every element unequal to 2, 3 or 5 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
0, 1, 1, 6, 4, 5, 10, 36,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 09 2018 09:52:31, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;-a(n-1) - a(n-2) + 2\,a(n-3) + 9\,a(n-4) + 9\,a(n-5) + 6\,a(n-6) - 9\,a(n-7) - 15\,a(n-8) - 14\,a(n-9) + 2\,a(n-10) + 10\,a(n-11) + 3\,a(n-12) - 3\,a(n-13) - 6\,a(n-14) + a(n-15) + a(n-17) - a(n-18)
\end{equation}
for all $n>19$.
...
\#\{\text{neighbours with a value }different from\ x_{t,u}\}\in\{2,3,5\}
\end{equation}
...
publishes, $n=38$, the arrays have $3\cdot38$ cells over
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A317866.
