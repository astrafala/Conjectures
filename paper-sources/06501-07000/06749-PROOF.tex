...
\title{The empirical recurrence for OEIS A203096, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A203096 counts arrays over $\{0,\dots,3\}$ in which every cell is constrained by the
...
OEIS A203096 is ``Number of nX3 0..3 arrays with every nonzero element less than or equal to some horizontal or vertical neighbor.''. It has offset $1$ and begins
\[
16, 1080, 48552, 2029744, 87531478, 3790420430, 163621176194, 7062389921398,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 10:07:44, revision 9) the statement is
...
publishes, $n=14$, the arrays have $3\cdot14$ cells over
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A203096.
