...
\title{The empirical recurrence for OEIS A297081, proved by transfer matrix}
...
\begin{abstract}
OEIS A297081 counts $n\times4$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A297081 is ``Number of nX4 0..1 arrays with no 1 adjacent to 2 king-move neighboring 1s.''. It has offset $1$ and begins
\[
13, 96, 687, 6784, 64819, 654120, 6743851, 69857453,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 25 2017 08:36:54, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;9\,a(n-1) + 23\,a(n-2) + 28\,a(n-3) - 945\,a(n-4) - 2029\,a(n-5) - 3142\,a(n-6) + 21335\,a(n-7) + 54146\,a(n-8) + 108209\,a(n-9) - 59763\,a(n-10) - 294467\,a(n-11) - 532677\,a(n-12) - 529823\,a(n-13) + 342371\,a(n-14) + 564802\,a(n-15) + 462057\,a(n-16) - 397473\,a(n-17) + 1756534\,a(n-18) + 2833349\,a(n-19) + 926785\,a(n-20) + 1852731\,a(n-21) - 2464854\,a(n-22) - 2170724\,a(n-23) + 1406946\,a(n-24) + 1119580\,a(n-25) + 1245446\,a(n-26) + 1089190\,a(n-27) + 612177\,a(n-28) + 266312\,a(n-29) + 72636\,a(n-30) + 29514\,a(n-31) + 6508\,a(n-32) - 1104\,a(n-33) - 288\,a(n-34)
\]
for every $n>34$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297081.
