...
\title{The empirical recurrence for OEIS A253836, proved by transfer matrix}
...
\begin{abstract}
OEIS A253836 counts the arrays over $\{0,\dots,1\}$ whose $3\times3$ subblocks carry a
...
OEIS A253836 is ``Number of (n+2)X(3+2) 0..1 arrays with every 3X3 subblock diagonal sum plus antidiagonal sum nondecreasing horizontally, vertically and ne-to-sw antidiagonally.''. It has offset $1$ and begins
\[
8392, 17491, 52014, 127483, 135280, 201331, 233370, 230890,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 14:16:47, revision 11) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253836.
