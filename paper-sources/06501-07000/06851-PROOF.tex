...
\title{The empirical recurrence for OEIS A251677, proved by transfer matrix}
...
\begin{abstract}
OEIS A251677 counts arrays of width $5$ over $\{0,1,2\}$ in which every $3\times3$ window has
...
OEIS A251677 is ``Number of (n+2)X(3+2) 0..2 arrays with no row, column, diagonal or antidiagonal in any 3X3 subblock summing to 2 or 4.''. It has offset $1$ and begins
\[
953, 2089, 5527, 16467, 54523, 184139, 632811, 2196747,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 10:29:21, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) - 5\,a(n-2) + 24\,a(n-3) - 40\,a(n-4) + 22\,a(n-5) - 166\,a(n-6) + 21\,a(n-7) + 156\,a(n-8) + 642\,a(n-9) + 622\,a(n-10) - 1123\,a(n-11) - 1546\,a(n-12) - 1437\,a(n-13) + 1903\,a(n-14) + 1798\,a(n-15) + 496\,a(n-16) - 1679\,a(n-17) - 1252\,a(n-18) + 2364\,a(n-19) + 3587\,a(n-20) + 2284\,a(n-21) - 2954\,a(n-22) - 4508\,a(n-23) - 3564\,a(n-24) + 52\,a(n-25) + 1420\,a(n-26) + 1536\,a(n-27) + 640\,a(n-28) + 352\,a(n-29) + 192\,a(n-30) + 128\,a(n-31) + 32\,a(n-32)
\]
for every $n>37$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251677.
