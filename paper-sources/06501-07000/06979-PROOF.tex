...
\title{The empirical recurrence for OEIS A318542, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A318542 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
values of its neighbours, and carries an empirical recurrence of order $23$ contributed
...
OEIS A318542 is ``Number of n X 5 0..1 arrays with every element unequal to 0, 1, 4 or 6 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
8, 8, 26, 78, 247, 784, 2349, 7191,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 25 2024 22:44:01, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 14\,a(n-3) + 7\,a(n-4) + 33\,a(n-5) - 6\,a(n-6) + 20\,a(n-7) - 48\,a(n-8) - 4\,a(n-9) - 32\,a(n-10) + 30\,a(n-12) + 14\,a(n-13) - 8\,a(n-14) - 10\,a(n-15) + 9\,a(n-16) - 3\,a(n-17) - 13\,a(n-18) + 9\,a(n-19) + 7\,a(n-20) - 5\,a(n-21) - a(n-22) + a(n-23)
\end{equation}
for all $n>24$.
...
The threshold below is exact rather than merely sufficient: at $n=24$ the conjectured
...
$o=1n_0+0-2$. Then for $j\ge23$,
\[
a(n_0+j)-\sum_i c_i\,a(n_0+j-i)\;=\;\,\mathbf{v}^{\!\top}G^{\,j-23}w,
...
\begin{proof}
Substitute Lemma~\ref{lem:walk} and factor $G^{j-23}$ out of
...
the middle row. The vector $w$ was formed by $23$ applications of $G$ in exact integer
arithmetic and $\mathbf{v}^{\!\top}G^{m}w$ evaluated for $m=0,1,\dots$, again exactly.
Every one of those integers vanishes from the index corresponding to $n=24+1$ onwards,
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A318542.
