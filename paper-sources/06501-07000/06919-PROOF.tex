...
\title{The empirical recurrence for OEIS A237915, proved by transfer matrix}
...
\begin{abstract}
OEIS A237915 counts arrays over $\{0,\dots,3\}$ subject to a condition on the order
...
OEIS A237915 is ``Number of (n+1)X(1+1) 0..3 arrays with the upper median plus the lower median of every 2X2 subblock differing from its horizontal and vertical neighbors by exactly one.''. It has offset $1$ and begins
\[
256, 1584, 9892, 63476, 406468, 2591160, 16574240, 105734776,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 10:34:50, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;9\,a(n-2) + 1028\,a(n-4) + 10373\,a(n-6) + 27367\,a(n-8) - 32996\,a(n-10) - 169776\,a(n-12) - 127168\,a(n-14) + 64512\,a(n-16) + 589824\,a(n-18)
\]
for every $n>18$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237915.
