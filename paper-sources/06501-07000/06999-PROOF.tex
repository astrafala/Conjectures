...
\title{The empirical recurrence for OEIS A283853, proved by transfer matrix}
...
\begin{abstract}
OEIS A283853 counts $n\times4$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
walk, and $a(n)$ is a walk count on $S=249$ vertices, which is $C$-finite. Whether the
...
OEIS A283853 is ``Number of nX4 0..1 arrays with no 1 equal to more than three of its horizontal, diagonal and antidiagonal neighbors.''. It has offset $1$ and begins
\[
16, 233, 2776, 35373, 448490, 5676420, 71903903, 910712188,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 17 2017 11:57:54, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;11\,a(n-1) + 21\,a(n-2) + 29\,a(n-3) - 328\,a(n-4) - 309\,a(n-5) + 4\,a(n-6) + 1138\,a(n-7) + 404\,a(n-8) - 1281\,a(n-9) + 253\,a(n-10) + 24\,a(n-11) + 904\,a(n-12) - 475\,a(n-13) + 164\,a(n-14) - 138\,a(n-15) + 24\,a(n-16) - 2\,a(n-17)
\]
for every $n>17$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A283853.
