...
\title{The empirical recurrence for OEIS A252435, proved by transfer matrix}
...
\begin{abstract}
OEIS A252435 counts $4\times(n+2)$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252435 is ``Number of (2+2)X(n+2) 0..3 arrays with every 3X3 subblock row and diagonal sum equal to 0 2 4 6 or 7 and every 3X3 column and antidiagonal sum not equal to 0 2 4 6 or 7.''. It has offset $1$ and begins
\[
602, 688, 1033, 1488, 3057, 6178, 10309, 24196,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:14:04, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;25\,a(n-3) - 210\,a(n-6) + 606\,a(n-9) + 32\,a(n-12) - 1188\,a(n-15) + 594\,a(n-18) + 482\,a(n-21) - 415\,a(n-24) + 75\,a(n-27)
\]
for every $n>34$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252435.
