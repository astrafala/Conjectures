...
\title{The empirical recurrence for OEIS A250945, proved by transfer matrix}
...
\begin{abstract}
OEIS A250945 counts arrays over $\{0,1,2\}$ in which a statistic taken over short runs
...
OEIS A250945 is ``Number of (3+1) X (n+1) 0..2 arrays with nondecreasing x(i,j)+x(i,j-1) in the i direction and nondecreasing absolute value of x(i,j)-x(i-1,j) in the j direction.''. It has offset $1$ and begins
\[
413, 2812, 16208, 87529, 442409, 2130148, 9865706, 44282475,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 26 2025 11:41:59, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;12\,a(n-1) - 38\,a(n-2) - 76\,a(n-3) + 619\,a(n-4) - 500\,a(n-5) - 2802\,a(n-6) + 4652\,a(n-7) + 5756\,a(n-8) - 14556\,a(n-9) - 5630\,a(n-10) + 24440\,a(n-11) + 1511\,a(n-12) - 24616\,a(n-13) + 1882\,a(n-14) + 15280\,a(n-15) - 1829\,a(n-16) - 5700\,a(n-17) + 596\,a(n-18) + 1160\,a(n-19) - 64\,a(n-20) - 96\,a(n-21)
\]
for every $n>20$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250945.
