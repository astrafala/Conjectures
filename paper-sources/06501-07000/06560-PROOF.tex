...
\title{The empirical recurrence for OEIS A260605, proved by transfer matrix}
...
\begin{abstract}
OEIS A260605 counts $(n+2)\times6$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A260605 is ``Number of (n+2)X(4+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000101 00010001 or 00010101.''. It has offset $1$ and begins
\[
241, 532, 1334, 3388, 8736, 22944, 59758, 156228,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 12:09:45, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-3) + 21\,a(n-4) + 27\,a(n-5) + 29\,a(n-6) - 3\,a(n-7) - 99\,a(n-8) - 39\,a(n-9) + 194\,a(n-10) + 217\,a(n-11) + 274\,a(n-12) + 128\,a(n-13) - 364\,a(n-14) - 186\,a(n-15) - 21\,a(n-16) - 414\,a(n-17) + 418\,a(n-18) + 666\,a(n-19) - 73\,a(n-20) - 2\,a(n-21) - 272\,a(n-22) - 183\,a(n-23) + 66\,a(n-24) - 47\,a(n-25) + 280\,a(n-26) + 294\,a(n-27) + 147\,a(n-28) + 291\,a(n-29) + 70\,a(n-30) - 35\,a(n-32) - 39\,a(n-33) - 33\,a(n-34) - 34\,a(n-35) - 18\,a(n-36) - 4\,a(n-37)
\]
for every $n>40$.
\end{theorem}
...
exactly. Those integers vanish from the index corresponding to $n=40+1$ onwards, and the
run was continued until the working vector was identically zero, which settles all larger $j$
at once. By Lemma~\ref{lem:crit} the recurrence holds for every $n>40$.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A260605.
