...
\title{The empirical recurrence for OEIS A281536, proved by transfer matrix}
...
\begin{abstract}
OEIS A281536 counts $n\times4$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A281536 is ``Number of nX4 0..2 arrays with no element equal to more than one of its king-move neighbors, with the exception of exactly two elements, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
1, 104, 2919, 15624, 52529, 146956, 385284, 979866,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 23 2017 12:51:52, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) - 2\,a(n-3) - 3\,a(n-5) - 32\,a(n-6) + 12\,a(n-7) + 39\,a(n-8) + 25\,a(n-9) + 45\,a(n-10) + 117\,a(n-11) - 91\,a(n-12) - 192\,a(n-13) - 57\,a(n-14) - 60\,a(n-15) - 255\,a(n-16) + 138\,a(n-17) + 368\,a(n-18) + 9\,a(n-19) - 24\,a(n-20) + 441\,a(n-21) + 42\,a(n-22) - 504\,a(n-23) - 84\,a(n-24) + 252\,a(n-25) - 222\,a(n-26) - 276\,a(n-27) + 216\,a(n-28) + 180\,a(n-29) - 112\,a(n-30) - 36\,a(n-31) + 96\,a(n-32) - 48\,a(n-34) + 8\,a(n-36)
\]
for every $n>50$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A281536.
