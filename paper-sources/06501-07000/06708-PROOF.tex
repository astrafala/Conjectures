...
\title{The empirical recurrence for OEIS A303321, proved by transfer matrix}
...
\begin{abstract}
OEIS A303321 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the six horizontal, diagonal and antidiagonal neighbours, a number $equal to$ itself lying in $\{0,2,4,5,6\}$, and it carries an empirical
...
OEIS A303321 is ``Number of nX4 0..1 arrays with every element equal to 0, 2, 4, 5 or 6 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 8, 1, 2, 4, 3, 3, 10,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 21 2018 13:10:27, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-2) + 4\,a(n-3) + 2\,a(n-4) - 3\,a(n-5) - 6\,a(n-6) - 10\,a(n-7) - 16\,a(n-8) - 9\,a(n-9) + 11\,a(n-10) + 35\,a(n-11) + 39\,a(n-12) + 30\,a(n-13) + 13\,a(n-14) - 6\,a(n-15) - 38\,a(n-16) - 66\,a(n-17) - 80\,a(n-18) - 55\,a(n-19) - 14\,a(n-20) + 25\,a(n-21) + 49\,a(n-22) + 76\,a(n-23) + 90\,a(n-24) + 67\,a(n-25) + 16\,a(n-26) - 30\,a(n-27) - 46\,a(n-28) - 37\,a(n-29) - 49\,a(n-30) - 51\,a(n-31) - 12\,a(n-32) + 47\,a(n-33) + 62\,a(n-34) + 14\,a(n-35) - 16\,a(n-36) - 7\,a(n-37) - 8\,a(n-38) - 35\,a(n-39) - 48\,a(n-40) - 18\,a(n-41) + 19\,a(n-42) + 33\,a(n-43) + 23\,a(n-44) + 16\,a(n-45) + 12\,a(n-46) + a(n-47) - 6\,a(n-48) - 11\,a(n-49) - 8\,a(n-50) - 3\,a(n-51) - a(n-52) + 2\,a(n-53) + a(n-54) + a(n-55)
\end{equation}
for all $n>57$.
...
has score in $\{0,2,4,5,6\}$. The entry also fixes the top-left entry to be $0$; that is a condition on the first row alone, so it restricts the start vector and nothing else.
...
\begin{itemize}
\item $\mathbf{s}(r,s)=1$ when every cell of $r$ has score in $\{0,2,4,5,6\}$ \emph{with no row
above $r$} and $r_1=0$, and $0$ otherwise;
\item an edge $(r,s)\to(s,t)$ when every cell of $s$ has score in $\{0,2,4,5,6\}$ computed from
$r$, $s$ and $t$;
\item $\mathbf{e}(r,s)=1$ when every cell of $s$ has score in $\{0,2,4,5,6\}$ \emph{with no row
...
exactly when every one of its $n$ rows has all scores in $\{0,2,4,5,6\}$. Read the sequence as the
...
compared against the entry's DATA at every one of the $42$ published indices; they
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A303321.
