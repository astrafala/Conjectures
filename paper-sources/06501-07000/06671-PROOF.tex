...
\title{The empirical recurrence for OEIS A230677, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A230677 counts arrays over $\{0,\dots,2\}$ in which every cell is constrained by the
...
OEIS A230677 is ``Number of 3Xn 0..2 arrays x(i,j) with each element horizontally, diagonally or antidiagonally next to at least one element with value 2-x(i,j).''. It has offset $1$ and begins
\[
0, 81, 1173, 18915, 340563, 6081561, 108108231, 1923264723,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 08:45:25, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;13\,a(n-1) + 65\,a(n-2) + 312\,a(n-3) + 829\,a(n-4) + 559\,a(n-5) - 458\,a(n-6) - 2767\,a(n-7) - 2801\,a(n-8) - 1031\,a(n-9) - 485\,a(n-10) - 743\,a(n-11) - 272\,a(n-12) + 332\,a(n-13) + 172\,a(n-14) - 24\,a(n-15)
\end{equation}
for all $n>16$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A230677.
