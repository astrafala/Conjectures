...
\title{The empirical recurrence for OEIS A252428, proved by transfer matrix}
...
\begin{abstract}
OEIS A252428 counts $(n+2)\times5$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252428 is ``Number of (n+2)X(3+2) 0..3 arrays with every 3X3 subblock row and diagonal sum equal to 0 2 4 6 or 7 and every 3X3 column and antidiagonal sum not equal to 0 2 4 6 or 7.''. It has offset $1$ and begins
\[
1142, 1033, 1810, 3954, 9643, 24024, 59977, 153283,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:13:22, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;32\,a(n-3) - 310\,a(n-6) + 1303\,a(n-9) - 4922\,a(n-12) + 13079\,a(n-15) - 25229\,a(n-18) + 39325\,a(n-21) - 43233\,a(n-24) + 23521\,a(n-27) - 1301\,a(n-30) - 2920\,a(n-33) + 769\,a(n-36) - 101\,a(n-39) - 22\,a(n-42) + 11\,a(n-45) - a(n-48)
\]
for every $n>51$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252428.
