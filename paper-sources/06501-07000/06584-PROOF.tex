...
\title{The empirical recurrence for OEIS A235192, proved by transfer matrix}
...
\begin{abstract}
OEIS A235192 counts $3$-column arrays over $\{0,\dots,6\}$ in which every
...
OEIS A235192 is ``Number of (n+1) X (2+1) 0..6 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 5, with no adjacent elements equal (constant-stress tilted 1 X 1 tilings).''. It has offset
$1$ and begins
\[
512, 1544, 4724, 15604, 51144, 176104, 597712,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 19 2022 02:19:00, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) + 52\,a(n-2) - 367\,a(n-3) - 995\,a(n-4) + 9350\,a(n-5) + 7034\,a(n-6) - 128869\,a(n-7) + 26637\,a(n-8) + 1045428\,a(n-9) - 801048\,a(n-10) - 5098437\,a(n-11) + 5754163\,a(n-12) + 14714982\,a(n-13) - 20381230\,a(n-14) - 23985995\,a(n-15) + 38063780\,a(n-16) + 20215810\,a(n-17) - 35199080\,a(n-18) - 8246780\,a(n-19) + 13170048\,a(n-20) + 2801112\,a(n-21) - 1572480\,a(n-22) - 393120\,a(n-23)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A235192.
