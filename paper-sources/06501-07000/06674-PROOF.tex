...
\title{The empirical recurrence for OEIS A254354, proved by transfer matrix}
...
\begin{abstract}
OEIS A254354 counts the arrays over $\{0,\dots,1\}$ whose $3\times3$ subblocks carry a
...
OEIS A254354 is ``Number of (n+2)X(1+2) 0..1 arrays with every 3X3 subblock sum of the two medians of the central row and the central column and the two maximums of the diagonal and antidiagonal nondecreasing horizontally and vertically.''. It has offset $1$ and begins
\[
512, 2868, 15051, 72939, 332330, 1451174, 6117882, 25078442,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 14:37:09, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-1) - 16\,a(n-2) - 10\,a(n-3) + 49\,a(n-4) - 134\,a(n-5) + 511\,a(n-6) - 823\,a(n-7) + 1122\,a(n-8) - 1482\,a(n-9) + 467\,a(n-10) + 329\,a(n-11) - 2184\,a(n-12) + 2463\,a(n-13) - 1910\,a(n-14) + 2072\,a(n-15) + 52\,a(n-16) + 877\,a(n-17) - 2244\,a(n-18) + 480\,a(n-19) + 3226\,a(n-20) - 3604\,a(n-21) - 568\,a(n-22) + 944\,a(n-23) + 1272\,a(n-24) - 1120\,a(n-25) + 224\,a(n-26)
\]
for every $n>27$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A254354.
