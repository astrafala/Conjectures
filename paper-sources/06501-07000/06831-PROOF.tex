...
\title{The empirical recurrence for OEIS A301486, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A301486 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A301486 is ``Number of nX3 0..1 arrays with every element equal to 0, 1, 2, 4, 5 or 6 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
4, 18, 52, 148, 441, 1372, 4326, 13641,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 22 2018 11:45:58, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;8\,a(n-1) - 22\,a(n-2) + 15\,a(n-3) + 44\,a(n-4) - 86\,a(n-5) + a(n-6) + 87\,a(n-7) - 13\,a(n-8) - 39\,a(n-9) + 19\,a(n-10) - 56\,a(n-11) - 26\,a(n-12) + 38\,a(n-13) + 90\,a(n-14) + 118\,a(n-15) - 46\,a(n-16) - 18\,a(n-17) - 120\,a(n-18) - 6\,a(n-19) - 15\,a(n-20) + 26\,a(n-21) + 3\,a(n-23) - a(n-24)
\end{equation}
for all $n>25$.
...
\#\{\text{neighbours with a value }equal to\ x_{t,u}\}\in\{0,1,2,4,5,6\}
\end{equation}
...
publishes, $n=25$, the arrays have $3\cdot25$ cells over
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A301486.
