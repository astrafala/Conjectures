...
\title{The empirical recurrence for OEIS A202431, proved by transfer matrix}
...
\begin{abstract}
OEIS A202431 counts arrays of width $6$ over $\{0,1\}$ containing no occurrence of certain short
patterns, read along the rows, the columns or the diagonals. The entry carries an empirical
recurrence of order $26$ contributed by R.~H.~Hardin. It is true, and it is decidable
...
OEIS A202431 is ``Number of (n+2)X6 binary arrays avoiding patterns 000 and 001 in rows, columns and nw-to-se diagonals.''. It has offset $1$ and begins
\[
4680, 50310, 463632, 4502836, 42948906, 412198592, 3947786700, 37835503602,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 09:35:34, revision 9) this is still
...
\text{along a row, left to right} & \mathtt{000},\quad \mathtt{001} \\
\text{down a column} & \mathtt{000},\quad \mathtt{001} \\
\text{down a diagonal, nw to se} & \mathtt{000},\quad \mathtt{001} \\
\end{array}
\]
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 64\,a(n-2) + 213\,a(n-3) - 199\,a(n-4) - 1711\,a(n-5) + 255\,a(n-6) + 8022\,a(n-7) - 2711\,a(n-8) - 25993\,a(n-9) + 26163\,a(n-10) + 41611\,a(n-11) - 104189\,a(n-12) + 72169\,a(n-13) + 11753\,a(n-14) - 44090\,a(n-15) + 15201\,a(n-16) + 10399\,a(n-17) - 6613\,a(n-18) - 2087\,a(n-19) + 1405\,a(n-20) + 609\,a(n-21) - 113\,a(n-22) - 132\,a(n-23) - 28\,a(n-24) + 2\,a(n-25) + a(n-26)
\]
for every $n>24$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A202431.
