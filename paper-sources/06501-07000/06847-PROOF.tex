...
\title{A local condition on an array: OEIS A202465}
...
\begin{abstract}
OEIS A202465 carries an empirical recurrence of order $21$ contributed by R.~H.~Hardin. It is
...
walks in it. Hence $a(n)$ is a walk count on $S=22$ vertices and is $C$-finite, and whether the
...
OEIS A202465 is ``Number of (n+2)X4 binary arrays with no more than two of any consecutive three bits set in any row or column.''. It has offset $1$ and begins
\[
1573, 16561, 172197, 1774281, 18374521, 190112777, 1966463785, 20345296193,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 09:36:41, revision 9) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{The count is a walk count}

The entry counts arrays with $4$ columns over the alphabet $\{0,1\}$, growing one row at a time, and asks that no $3$ consecutive entries, taken along a row or down a column, may contain more than $2$ ones.
...
Merging vertices with identical futures leaves $S=22$. An admissible array is exactly a walk, so with $M$ the adjacency matrix and $\iota,\tau$ the vectors recording which states may begin and end an array,
\[
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + 36\,a(n-2) + 272\,a(n-3) + 350\,a(n-4) + 392\,a(n-5) - 3016\,a(n-6) - 164\,a(n-7) - 5522\,a(n-8) + 11427\,a(n-9) - 4608\,a(n-10) + 10140\,a(n-11) - 11817\,a(n-12) + 4108\,a(n-13) - 2432\,a(n-14) + 1176\,a(n-15) - 166\,a(n-16) + 124\,a(n-17) - 50\,a(n-18) + 4\,a(n-19) - 2\,a(n-20) + a(n-21)
\]
for every $n>19$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A202465.
