...
\title{The empirical recurrence for OEIS A251947, proved by transfer matrix}
...
\begin{abstract}
OEIS A251947 counts $(n+2)\times7$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
$a(n)$ is a walk count on $S=17733$ vertices. Such a sequence is $C$-finite, so whether a given
...
OEIS A251947 is ``Number of (n+2)X(5+2) 0..3 arrays with every 3X3 subblock row and column sum prime and every diagonal and antidiagonal sum nonprime.''. It has offset $1$ and begins
\[
4346, 3609, 8756, 25231, 87011, 285399, 875435, 3103838,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:34:23, revision 6) this is still
...
\[
\text{every row, column sum is prime}\ \text{ and }\ \text{every diagonal, antidiagonal sum is nonprime}
\]
...
\begin{theorem}
\[
a(n)\;=\;69\,a(n-3) - 1170\,a(n-6) + 2238\,a(n-9) - 57909\,a(n-12) + 222992\,a(n-15) - 1407264\,a(n-18) + 4017948\,a(n-21) - 19586465\,a(n-24) + 37664446\,a(n-27) - 93459214\,a(n-30) + 89190666\,a(n-33) - 1008083\,a(n-36) - 13979004\,a(n-39) - 3987484\,a(n-42) + 2116364\,a(n-45) + 401146\,a(n-48) - 128423\,a(n-51) - 852\,a(n-54)
\]
for every $n>57$.
\end{theorem}
...
exactly. Those integers vanish from the index corresponding to $n=57+1$ onwards, and the
run was continued until the working vector was identically zero, which settles all larger $j$
at once. By Lemma~\ref{lem:crit} the recurrence holds for every $n>57$.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251947.
