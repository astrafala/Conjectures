...
\title{The empirical recurrence for OEIS A250437, proved by transfer matrix}
...
\begin{abstract}
OEIS A250437 counts arrays over $\{0,1,2\}$ in which a statistic taken over short runs
...
window of consecutive rows, so the count is a walk count on $S=324$ states, and the
...
OEIS A250437 is ``Number of (n+1)X(2+1) 0..2 arrays with nondecreasing sum of every two consecutive values in every row and column.''. It has offset $1$ and begins
\[
324, 2160, 14400, 60000, 250000, 787500, 2480625, 6482700,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 12:24:41, revision 6) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=324,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250437.
