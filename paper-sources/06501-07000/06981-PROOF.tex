...
\title{The empirical recurrence for OEIS A236037, proved by transfer matrix}
...
\begin{abstract}
OEIS A236037 counts arrays over $\{0,\dots,3\}$ subject to a condition on the order
...
OEIS A236037 is ``Number of (n+1)X(1+1) 0..3 arrays colored with the difference of the upper median and the lower median in each 2X2 subblock.''. It has offset $1$ and begins
\[
256, 2404, 22994, 218568, 2089160, 19942272, 190367530, 1816294128,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 09:01:46, revision 7) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The $2\times2$ subblocks of an $(n+1)\times2$ array form an
$n\times1$ grid. Colour each of them by $\sigma=-b+c$, where $a\le b\le c\le d$ are its four entries sorted --- its minimum, lower median, upper median and maximum. ``Coloured with'' is the entry's way of
...
\begin{theorem}
\[
a(n)\;=\;28\,a(n-2) + 174\,a(n-3) + 2550\,a(n-4) + 8646\,a(n-5) + 41209\,a(n-6) + 132326\,a(n-7) + 160996\,a(n-8) + 471512\,a(n-9) - 257088\,a(n-10) - 2520320\,a(n-11) - 1767936\,a(n-12) - 8040704\,a(n-13) - 14097408\,a(n-14) - 5087232\,a(n-15) - 10715136\,a(n-16) - 11796480\,a(n-17)
\]
for every $n>17$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A236037.
