...
\title{The empirical recurrence for OEIS A237135, proved by transfer matrix}
...
\begin{abstract}
OEIS A237135 counts arrays over $\{0,\dots,3\}$ subject to a condition on the order
...
OEIS A237135 is ``Number of (n+1)X(1+1) 0..3 arrays with the maximum plus the upper median of every 2X2 subblock equal.''. It has offset $1$ and begins
\[
256, 1500, 8414, 52484, 328768, 2145192, 14152560, 95414944,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 09:52:11, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;16\,a(n-1) - 1186\,a(n-3) + 4300\,a(n-4) + 29836\,a(n-5) - 178043\,a(n-6) - 268628\,a(n-7) + 3127196\,a(n-8) - 779130\,a(n-9) - 28579040\,a(n-10) + 32590712\,a(n-11) + 142648608\,a(n-12) - 254087072\,a(n-13) - 375342992\,a(n-14) + 955527424\,a(n-15) + 408264640\,a(n-16) - 1902301152\,a(n-17) + 178371840\,a(n-18) + 1899365760\,a(n-19) - 742376448\,a(n-20) - 734054400\,a(n-21) + 418037760\,a(n-22)
\]
for every $n>22$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237135.
