...
\title{The empirical recurrence for OEIS A259512, proved by transfer matrix}
...
\begin{abstract}
OEIS A259512 counts arrays of width $6$ over $\{0,1\}$ subject to a condition read round the
...
OEIS A259512 is ``Number of (n+1)X(5+1) 0..1 arrays with each 2X2 subblock having clockwise pattern 0000 0001 0101 0111.''. It has offset $1$ and begins
\[
689, 9227, 126045, 1769635, 25009044, 355119489, 5050441910, 71892362811,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:52:04, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A259512.
