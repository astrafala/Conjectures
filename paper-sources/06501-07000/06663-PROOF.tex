...
\title{The empirical recurrence for OEIS A237161, proved by transfer matrix}
...
\begin{abstract}
OEIS A237161 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
OEIS A237161 is ``Number of (n+1)X(2+1) 0..2 arrays with the maximum plus the minimum minus the upper median minus the lower median of every 2X2 subblock equal.''. It has offset $1$ and begins
\[
245, 997, 4365, 20669, 102265, 525809, 2783881, 15103101,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 09:54:47, revision 6) this is still
...
array, which is not among the objects counted. There are $S=81$ states left.
...
\begin{theorem}
\[
a(n)\;=\;15\,a(n-1) - 49\,a(n-2) - 250\,a(n-3) + 1567\,a(n-4) + 391\,a(n-5) - 13821\,a(n-6) + 7384\,a(n-7) + 58596\,a(n-8) - 39520\,a(n-9) - 137336\,a(n-10) + 78264\,a(n-11) + 179256\,a(n-12) - 67104\,a(n-13) - 119232\,a(n-14) + 20736\,a(n-15) + 31104\,a(n-16)
\]
for every $n>16$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237161.
