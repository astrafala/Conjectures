...
\title{The empirical recurrence for OEIS A237093, proved by transfer matrix}
...
\begin{abstract}
OEIS A237093 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
OEIS A237093 is ``Number of (n+1)X(2+1) 0..2 arrays with the maximum plus the lower median minus the upper median of every 2X2 subblock equal.''. It has offset $1$ and begins
\[
303, 1735, 10466, 66831, 428497, 2832722, 18682733, 125843583,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 09:50:17, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;17\,a(n-1) - 33\,a(n-2) - 942\,a(n-3) + 5519\,a(n-4) + 9822\,a(n-5) - 147568\,a(n-6) + 170826\,a(n-7) + 1482255\,a(n-8) - 3807734\,a(n-9) - 6026381\,a(n-10) + 27536576\,a(n-11) + 4621373\,a(n-12) - 101103639\,a(n-13) + 39805818\,a(n-14) + 215531556\,a(n-15) - 144788130\,a(n-16) - 282774890\,a(n-17) + 228947844\,a(n-18) + 232233520\,a(n-19) - 197348088\,a(n-20) - 116570680\,a(n-21) + 94032480\,a(n-22) + 32544624\,a(n-23) - 22765248\,a(n-24) - 3769056\,a(n-25) + 2180160\,a(n-26)
\]
for every $n>26$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237093.
