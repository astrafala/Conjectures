...
\title{The empirical recurrence for OEIS A255155, proved by transfer matrix}
...
\begin{abstract}
OEIS A255155 counts $(n+2)\times6$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
every $3\times3$ subblock, and it carries an empirical recurrence of order $29$
...
OEIS A255155 is ``Number of (n+2)X(4+2) 0..1 arrays with no 3x3 subblock diagonal sum 1 and no antidiagonal sum 1 and no row sum 0 or 1 and no column sum 0 or 1.''. It has offset $1$ and begins
\[
331, 1285, 5615, 24076, 102481, 437238, 1863728, 7949259,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:39:45, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 6\,a(n-2) + 21\,a(n-3) + 53\,a(n-4) + 33\,a(n-5) - 49\,a(n-6) - 255\,a(n-7) - 298\,a(n-8) + 550\,a(n-9) + 1137\,a(n-10) - 8\,a(n-11) - 2536\,a(n-12) - 2445\,a(n-13) + 3641\,a(n-14) + 3226\,a(n-15) - 5655\,a(n-16) - 2727\,a(n-17) + 4934\,a(n-18) + 670\,a(n-19) - 3942\,a(n-20) - 1351\,a(n-21) + 794\,a(n-22) - 44\,a(n-23) + 94\,a(n-24) + 519\,a(n-25) - 35\,a(n-26) + 72\,a(n-27) + 117\,a(n-28) - 36\,a(n-29)
\]
for every $n>31$.
\end{theorem}

\begin{proof}
The vector $w=q(M)\mathbf{1}$ was formed by $29$ matrix--vector products in exact
integer arithmetic and $\mathbf{1}^{\!\top}M^{j}w$ evaluated for $j=0,1,\dots$, again
exactly. Those integers vanish from the index corresponding to $n=31+1$ onwards, and the
run was continued until the working vector was identically zero, which settles all larger $j$
at once. By Lemma~\ref{lem:crit} the recurrence holds for every $n>31$.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A255155.
