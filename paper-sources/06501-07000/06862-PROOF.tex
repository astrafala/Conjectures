...
\title{The empirical recurrence for OEIS A252347, proved by transfer matrix}
...
\begin{abstract}
OEIS A252347 counts $(n+2)\times5$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252347 is ``Number of (n+2)X(3+2) 0..3 arrays with every 3X3 subblock row and column sum not equal to 0 3 5 6 or 8 and every 3X3 diagonal and antidiagonal sum equal to 0 3 5 6 or 8.''. It has offset $1$ and begins
\[
1331, 2864, 6986, 15208, 42345, 111519, 294801, 852023,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:07:46, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 4\,a(n-2) + 47\,a(n-3) - 51\,a(n-4) - 204\,a(n-5) - 568\,a(n-6) + 772\,a(n-7) + 3088\,a(n-8) - 559\,a(n-9) - 2529\,a(n-10) - 10116\,a(n-11) + 27893\,a(n-12) - 17777\,a(n-13) - 71108\,a(n-14) - 50056\,a(n-15) + 121164\,a(n-16) + 484656\,a(n-17) - 377388\,a(n-18) - 107268\,a(n-19) - 429072\,a(n-20) + 1113936\,a(n-21) - 684864\,a(n-22) - 2739456\,a(n-23) + 944928\,a(n-24) + 1794528\,a(n-25) + 7178112\,a(n-26) - 5705856\,a(n-27) - 1472256\,a(n-28) - 5889024\,a(n-29) + 5515776\,a(n-30) + 373248\,a(n-31) + 1492992\,a(n-32) - 1492992\,a(n-33)
\]
for every $n>38$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252347.
