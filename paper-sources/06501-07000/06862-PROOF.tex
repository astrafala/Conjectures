...
\title{The empirical recurrence for OEIS A259958, proved by transfer matrix}
...
\begin{abstract}
OEIS A259958 counts $(n+2)\times6$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A259958 is ``Number of (n+2) X (4+2) 0..1 arrays with each 3 X 3 subblock having clockwise perimeter pattern 00000000 00000001 or 00001001.''. It has offset $1$ and begins
\[
353, 1187, 5449, 22622, 95505, 410928, 1749180, 7428045,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 03 2022 20:50:39, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A259958.
