...
\title{The empirical recurrence for OEIS A209907, proved by transfer matrix}
...
\begin{abstract}
OEIS A209907 counts $(n+1)\times3$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A209907 is ``Half the number of (n+1)X3 0..3 arrays with every 2X2 subblock having two or four distinct clockwise edge differences.''. It has offset $1$ and begins
\[
562, 13098, 295448, 6711168, 152153160, 3452051294, 78298719958, 1776153151954,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 15:35:05, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;16\,a(n-1) + 227\,a(n-2) - 1440\,a(n-3) - 8244\,a(n-4) + 46409\,a(n-5) + 53926\,a(n-6) - 406100\,a(n-7) - 117231\,a(n-8) + 1484559\,a(n-9) + 166049\,a(n-10) - 2587430\,a(n-11) - 386782\,a(n-12) + 2096907\,a(n-13) + 472125\,a(n-14) - 660956\,a(n-15) - 166954\,a(n-16) + 44616\,a(n-17) + 4488\,a(n-18) - 192\,a(n-19)
\end{equation}
for all $n>18$.
...
\[
a(n)-\sum_i c_i\,a(n-i)\;=\;\tfrac1{2}\mathbf{1}^{\!\top}M^{\,n+1-1-19}\,q(M)\,\mathbf{1} .
\]
...
=\tfrac1{2}\mathbf{1}^{\!\top}M^{\,m-19}\,q(M)\,\mathbf{1}
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209907.
