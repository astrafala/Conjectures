...
\title{The empirical recurrence for OEIS A253365, proved by transfer matrix}
...
\begin{abstract}
OEIS A253365 counts arrays of width $8$ over $\{0,1\}$ in which the largest entry on the main diagonal minus the smallest on the antidiagonal of every $2\times2$ and $3\times3$ subblock differs from the same number at the neighbouring subblock. The entry carries an
...
$4$ consecutive rows and the count is a walk count on $S=7034$ states.
\end{abstract}
...
OEIS A253365 is ``Number of (n+2)X(6+2) 0..1 arrays with every 2X2 and 3X3 subblock diagonal maximum minus antidiagonal minimum unequal to its neighbors horizontally and vertically.''. It has offset $1$ and begins
\[
3472, 5664, 27072, 53128, 175328, 520888, 1255456, 4289736,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 14:00:06, revision 6) this is still
...
Thus
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=7034,
\]
...
\begin{theorem}
\[
a(n)\;=\;16\,a(n-2) - 110\,a(n-4) + 432\,a(n-6) - 809\,a(n-8) + 2032\,a(n-10) - 4696\,a(n-12) + 4432\,a(n-14) - 2272\,a(n-16) - 1952\,a(n-18) - 224\,a(n-20) + 320\,a(n-22)
\]
for every $n>26$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253365.
