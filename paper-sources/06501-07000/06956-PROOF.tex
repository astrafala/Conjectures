...
\title{The empirical recurrence for OEIS A233498, proved by transfer matrix}
...
\begin{abstract}
OEIS A233498 counts arrays of width $3$ over $\{0,1,2\}$ containing no run of $3$ consecutive
cells, taken along a named direction of the grid, whose entries are strictly increasing. The entry carries
an empirical recurrence of order $22$ contributed by R.~H.~Hardin. It is true, and it is
...
OEIS A233498 is ``Number of (1+2)X(n+2) 0..2 arrays with no increasing sequence of length 3 horizontally or antidiagonally downwards.''. It has offset $1$ and begins
\[
16928, 388908, 8946936, 205862149, 4735554885, 108935413524, 2505862495421, 57642807090627,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 08:04:31, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A233498.
