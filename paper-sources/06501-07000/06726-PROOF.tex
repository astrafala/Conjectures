...
\title{The empirical recurrence for OEIS A185919, proved by transfer matrix}
...
\begin{abstract}
OEIS A185919 counts arrays over $\{0,\dots,3\}$ under a condition on the determinant of every
$2\times2$ subblock, and carries an empirical recurrence of order $27$ contributed by
...
OEIS A185919 is ``Number of (n+1)X2 0..3 arrays with no 2X2 subblock determinant equal to any horizontal or vertical neighbor 2X2 subblock determinant.''. It has offset $1$ and begins
\[
256, 3516, 49342, 687900, 9599032, 133932498, 1868731400, 26074015256,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 03:18:22, revision 10) this is still
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) + 66\,a(n-2) + 461\,a(n-3) + 1836\,a(n-4) + 5728\,a(n-5) + 12892\,a(n-6) + 21504\,a(n-7) + 23266\,a(n-8) + 7230\,a(n-9) - 27944\,a(n-10) - 63965\,a(n-11) - 75166\,a(n-12) - 58649\,a(n-13) - 25842\,a(n-14) + 2124\,a(n-15) + 27222\,a(n-16) + 67271\,a(n-17) + 71840\,a(n-18) + 10072\,a(n-19) - 39844\,a(n-20) - 8317\,a(n-21) + 7710\,a(n-22) + 7968\,a(n-23) + 3189\,a(n-24) - 30\,a(n-25) - 562\,a(n-26) - 1092\,a(n-27)
\]
for every $n>28$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A185919.
