...
\title{The empirical recurrence for OEIS A239172, proved by transfer matrix}
...
\begin{abstract}
OEIS A239172 counts $(n+1)\times3$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A239172 is ``Number of (n+1)X(2+1) 0..2 arrays with no element greater than all horizontal neighbors or equal to all vertical neighbors.''. It has offset $1$ and begins
\[
26, 82, 676, 4338, 29380, 196698, 1321986, 8867938,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 10:58:27, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;15\,a(n-2) + 149\,a(n-3) + 319\,a(n-4) + 372\,a(n-5) - 742\,a(n-6) - 1302\,a(n-7) + 296\,a(n-8) + 279\,a(n-9) + 1010\,a(n-10) - 921\,a(n-11) + 278\,a(n-12) + 747\,a(n-13) - 508\,a(n-14) + 361\,a(n-15) - 662\,a(n-16) + 626\,a(n-17) - 360\,a(n-18) + 80\,a(n-19)
\]
for every $n>19$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A239172.
