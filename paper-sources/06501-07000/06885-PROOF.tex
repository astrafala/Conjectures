...
\title{The empirical recurrence for OEIS A264284, proved by transfer matrix}
...
\begin{abstract}
OEIS A264284 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=8$ rows in which
...
OEIS A264284 is ``Number of (n+1)X(7+1) arrays of permutations of 0..n*8+7 with each element having directed index change 0,0 0,1 1,0 or -1,-2.''. It has offset $1$ and begins
\[
145, 4156, 134432, 4227024, 131452948, 4076914388, 126311779972, 3911932445892,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 10 2015 14:55:35, revision 4) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{The object is a matching}

The grid has $W=8$ rows across and holds each of $0,1,\dots,LW-1$ exactly once. The value
...
\begin{theorem}
\[
a(n)\;=\;37\,a(n-1) - 148\,a(n-2) - 648\,a(n-3) - 18812\,a(n-4) + 33720\,a(n-5) + 341320\,a(n-6) + 3490528\,a(n-7) + 2721200\,a(n-8) - 13811392\,a(n-9) - 95460256\,a(n-10) - 173488256\,a(n-11) - 318028224\,a(n-12) - 1470212608\,a(n-13) + 840492032\,a(n-14) + 14620982784\,a(n-15) + 49650196480\,a(n-16) + 50819317760\,a(n-17) + 88642775040\,a(n-18) + 235467870208\,a(n-19) - 222393663488\,a(n-20) - 1393025925120\,a(n-21) - 2983768571904\,a(n-22) - 30476926976\,a(n-23) + 5734697598976\,a(n-24) + 5710659846144\,a(n-25) - 2268499279872\,a(n-26) - 7922359730176\,a(n-27) - 3287065559040\,a(n-28) + 6731216191488\,a(n-29) + 5292339232768\,a(n-30) - 5224022409216\,a(n-31) - 6274678784000\,a(n-32) - 950261514240\,a(n-33) + 676457349120\,a(n-34)
\]
for every $n>34$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264284.
