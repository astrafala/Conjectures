...
\title{The empirical recurrence for OEIS A299446, proved by transfer matrix}
...
\begin{abstract}
OEIS A299446 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A299446 is ``Number of n X 3 0..1 arrays with every element equal to 0, 1, 3, 5, 6 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
3, 4, 1, 4, 10, 6, 11, 41,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 11 2022 12:11:00, revision
6) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 5\,a(n-3) - 5\,a(n-4) + a(n-5) - 2\,a(n-6) + 2\,a(n-7) - 2\,a(n-8) - 8\,a(n-9) + 5\,a(n-10) - 10\,a(n-11) + 10\,a(n-12) + a(n-13) + 2\,a(n-14) + 7\,a(n-15) + a(n-17) + a(n-18)
\end{equation}
for all $n>19$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A299446.
