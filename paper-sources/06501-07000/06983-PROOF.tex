...
\title{The empirical recurrence for OEIS A197800, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A197800 counts arrays over $\{0,\dots,4\}$ in which every cell is constrained by the
...
OEIS A197800 is ``Number of n X 3 0..4 arrays with each element x equal to the number its horizontal and vertical neighbors equal to 4,2,1,0,1 for x=0,1,2,3,4.''. It has offset $1$ and begins
\[
2, 16, 102, 596, 3713, 22742, 139212, 853186,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 10 2014 03:54:48, revision 9) the statement is
...
\#\{\text{neighbours with value }f(x_{t,u})\}=x_{t,u},\quad f=(4,2,1,0,1)
\end{equation}
for every cell $(t,u)$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A197800.
