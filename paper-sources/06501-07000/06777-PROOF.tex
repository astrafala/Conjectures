...
\title{The empirical recurrence for OEIS A253747, proved by transfer matrix}
...
\begin{abstract}
OEIS A253747 counts the arrays over $\{0,\dots,2\}$ whose $2\times2$ subblocks carry a
...
OEIS A253747 is ``Number of (n+1)X(6+1) 0..2 arrays with every 2X2 subblock ne-sw antidiagonal difference nondecreasing horizontally and nw+se diagonal sum nondecreasing vertically.''. It has offset $1$ and begins
\[
95940, 148134, 1204422, 4249381, 19685575, 64166071, 199063466, 515093745,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 14:12:39, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253747.
