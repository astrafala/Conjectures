...
\title{The empirical recurrence for OEIS A253932, proved by transfer matrix}
...
\begin{abstract}
OEIS A253932 counts the arrays over $\{0,\dots,1\}$ whose $3\times3$ subblocks carry a
...
OEIS A253932 is ``Number of (n+2)X(5+2) 0..1 arrays with every 3X3 subblock diagonal sum plus antidiagonal sum nondecreasing horizontally and vertically.''. It has offset $1$ and begins
\[
91296, 299727, 992616, 3152822, 3515548, 6348659, 9470400, 11628396,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 14:20:47, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253932.
