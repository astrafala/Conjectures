...
\title{The empirical recurrence for OEIS A207898, proved by transfer matrix}
...
\begin{abstract}
OEIS A207898 counts arrays over $\{0,\dots,1\}$ of width $5$ that avoid the patterns
$(0,0,0), (1,1,1)$ along one axis and $(0,0,0), (1,0,1)$ along the other, and carries an empirical recurrence of
order $47$ contributed by R.~H.~Hardin. It is true. The patterns have length $3$, so
...
$\mathbf{1}^{\!\top}P^{\,n-2-47}q(P)\mathbf{1}$, which vanishes identically
...
OEIS A207898 is ``Number of 5Xn 0..1 arrays avoiding 0 0 0 and 1 0 1 horizontally and 0 0 0 and 1 1 1 vertically.''. It has offset
$1$ and begins
\[
16, 256, 912, 3358, 11196, 38160, 135714,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:25:30, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-2) + 22\,a(n-3) + 75\,a(n-4) + 17\,a(n-5) - 117\,a(n-6) - 458\,a(n-7) - 725\,a(n-8) + 381\,a(n-9) + 1016\,a(n-10) + 1368\,a(n-11) + 3547\,a(n-12) - 1145\,a(n-13) - 4283\,a(n-14) - 771\,a(n-15) - 4195\,a(n-16) + 1201\,a(n-17) + 5941\,a(n-18) - 6675\,a(n-19) - 135\,a(n-20) - 10857\,a(n-21) - 5880\,a(n-22) + 2907\,a(n-23) + 6297\,a(n-24) + 14561\,a(n-25) + 16988\,a(n-26) + 3747\,a(n-27) + 11377\,a(n-28) - 12490\,a(n-29) + 4260\,a(n-30) - 14383\,a(n-31) + 4618\,a(n-32) - 6234\,a(n-33) + 3070\,a(n-34) - 362\,a(n-35) - 509\,a(n-36) + 225\,a(n-37) - 668\,a(n-38) - 20\,a(n-39) - 29\,a(n-40) + 141\,a(n-41) + 20\,a(n-42) + 30\,a(n-43) + 3\,a(n-44) - 13\,a(n-45) + 15\,a(n-46) + a(n-47)
\end{equation}
for all $n>50$. The entry's array has a fixed number of rows and a growing number of
...
$(0,0,0), (1,1,1)$ as $3$ consecutive entries. There are $16$ admissible columns; that condition
...
$a(n)-\sum_i c_i a(n-i)=u_{\,n-2-47}$ whenever $n-47\ge2$. Hence
\eqref{eq:conj} holds for every $n>t$ exactly when $u_j=0$ for every
$j>t-2-47$. Moreover $(u_j)$ satisfies the monic linear recurrence whose
...
$P^{\,n-2-47}$ gives the identity. The equivalence follows by letting the exponent
...
\begin{proof}
The vector $q(P)\mathbf{1}\in\mathbb{Z}^{S}$ was formed by $47$ matrix--vector
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207898.
