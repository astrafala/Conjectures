...
\title{The empirical recurrence for OEIS A252247, proved by transfer matrix}
...
\begin{abstract}
OEIS A252247 counts $(n+2)\times3$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252247 is ``Number of (n+2)X(1+2) 0..3 arrays with every 3X3 subblock row and column sum not equal to 0 3 5 6 or 7 and every 3X3 diagonal and antidiagonal sum equal to 0 3 5 6 or 7.''. It has offset $1$ and begins
\[
318, 260, 278, 352, 463, 616, 847, 1160,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 10:58:45, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-2) + 7\,a(n-3) - a(n-4) - 11\,a(n-5) - 19\,a(n-6) + 4\,a(n-7) + 21\,a(n-8) + 26\,a(n-9) - 4\,a(n-10) - 18\,a(n-11) - 19\,a(n-12) + a(n-13) + 7\,a(n-14) + 7\,a(n-15) - a(n-17) - a(n-18)
\]
for every $n>25$.
\end{theorem}
...
at once. By Lemma~\ref{lem:crit} the recurrence holds for every $n>25$. The bound is exact: at $n=25$ the recurrence fails on the entry's own published terms, so no larger range holds.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252247.
