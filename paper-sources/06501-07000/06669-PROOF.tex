...
\title{The empirical recurrence for OEIS A305681, proved by transfer matrix}
...
\begin{abstract}
OEIS A305681 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $different from$ itself lying in $\{0,2,3,4,5,6\}$, and it carries an empirical
...
OEIS A305681 is ``Number of nX4 0..1 arrays with every element unequal to 0, 2, 3, 4, 5 or 6 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 24, 139, 1595, 17947, 207116, 2403703, 27979008,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 08 2018 08:06:49, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;13\,a(n-1) - 8\,a(n-2) - 31\,a(n-3) - 662\,a(n-4) - 349\,a(n-5) + 1502\,a(n-6) + 8784\,a(n-7) + 13283\,a(n-8) - 11362\,a(n-9) - 58698\,a(n-10) - 93170\,a(n-11) + 22530\,a(n-12) + 212222\,a(n-13) + 239055\,a(n-14) - 97186\,a(n-15) - 516629\,a(n-16) - 362074\,a(n-17) + 344826\,a(n-18) + 796028\,a(n-19) + 348333\,a(n-20) - 439739\,a(n-21) - 544731\,a(n-22) - 38218\,a(n-23) + 322198\,a(n-24) + 234374\,a(n-25) - 15275\,a(n-26) - 89120\,a(n-27) - 53909\,a(n-28) - 61978\,a(n-29) - 66424\,a(n-30) - 7834\,a(n-31) + 8874\,a(n-32) + 1234\,a(n-33) + 1640\,a(n-34) - 636\,a(n-35) + 240\,a(n-36) + 208\,a(n-37) - 192\,a(n-38)
\end{equation}
for all $n>40$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A305681.
