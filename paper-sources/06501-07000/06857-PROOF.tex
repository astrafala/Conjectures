...
\title{The empirical recurrence for OEIS A207405, proved by transfer matrix}
...
\begin{abstract}
OEIS A207405 counts arrays over $\{0,\dots,1\}$ of width $5$ that avoid the patterns
...
OEIS A207405 is ``Number of 5Xn 0..1 arrays avoiding 0 0 1 and 0 1 1 horizontally and 0 0 1 and 1 1 0 vertically.''. It has offset
$1$ and begins
\[
10, 100, 390, 1521, 4212, 11664, 26676,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 13:51:38, revision
...
$(0,0,1), (1,1,0)$ as $3$ consecutive entries. There are $10$ admissible columns; that condition
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207405.
