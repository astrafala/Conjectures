...
\title{The empirical recurrence for OEIS A252672, proved by transfer matrix}
...
\begin{abstract}
OEIS A252672 counts $(n+2)\times3$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252672 is ``Number of (n+2)X(1+2) 0..3 arrays with every 3X3 subblock row and diagonal sum equal to 0 2 5 6 or 7 and every 3X3 column and antidiagonal sum not equal to 0 2 5 6 or 7.''. It has offset $1$ and begins
\[
656, 750, 808, 1010, 1648, 2554, 4038, 7108,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:30:29, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;22\,a(n-3) - 203\,a(n-6) + 1029\,a(n-9) - 3177\,a(n-12) + 6346\,a(n-15) - 8664\,a(n-18) + 8513\,a(n-21) - 5980\,a(n-24) + 2593\,a(n-27) - 305\,a(n-30) - 595\,a(n-33) + 664\,a(n-36) - 372\,a(n-39) + 162\,a(n-42) - 40\,a(n-45) + 8\,a(n-48)
\]
for every $n>57$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252672.
