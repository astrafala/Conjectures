...
\title{The empirical recurrence for OEIS A220711, proved by transfer matrix}
...
\begin{abstract}
OEIS A220711 counts the ways of linking the cells of a grid $6$ cells wide, each cell either to
...
state, the count is a walk count on $S=317$ of them, and the conjectured recurrence is then
...
OEIS A220711 is ``Number of ways to reciprocally link elements of an 6Xn array either to themselves or to exactly two horizontal and antidiagonal neighbors, without consecutive collinear links.''. It has offset $1$ and begins
\[
1, 1, 13, 60, 317, 1617, 8338, 42873,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 18:59:12, revision 8) this is still
...
one configuration. With $M$ the adjacency matrix of the digraph on the $S=317$ reachable
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 33\,a(n-2) - a(n-3) - 351\,a(n-4) - 75\,a(n-5) + 1760\,a(n-6) + 436\,a(n-7) - 4708\,a(n-8) - 997\,a(n-9) + 6997\,a(n-10) + 1085\,a(n-11) - 5748\,a(n-12) - 564\,a(n-13) + 2512\,a(n-14) + 131\,a(n-15) - 543\,a(n-16) - 7\,a(n-17) + 49\,a(n-18) - a(n-19) - a(n-20)
\]
for every $n>24$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A220711.
