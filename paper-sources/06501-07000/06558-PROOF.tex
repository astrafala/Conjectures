...
\title{The empirical recurrence for OEIS A236139, proved by transfer matrix}
...
\begin{abstract}
OEIS A236139 counts arrays over $\{0,\dots,3\}$ subject to a condition on the order
...
OEIS A236139 is ``Number of (n+1)X(1+1) 0..3 arrays colored with the maximum plus the upper median plus the minimum minus the lower median of every 2X2 subblock.''. It has offset $1$ and begins
\[
256, 2976, 34734, 405132, 4726586, 55128306, 643062117, 7501428048,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 09:08:36, revision 7) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The $2\times2$ subblocks of an $(n+1)\times2$ array form an
$n\times1$ grid. Colour each of them by $\sigma=a-b+c+d$, where $a\le b\le c\le d$ are its four entries sorted --- its minimum, lower median, upper median and maximum. ``Coloured with'' is the entry's way of
...
\begin{theorem}
\[
a(n)\;=\;476\,a(n-3) + 6828\,a(n-4) + 42328\,a(n-5) + 261628\,a(n-6) + 939596\,a(n-7) + 1141424\,a(n-8) - 5531408\,a(n-9) - 77255920\,a(n-10) - 353396376\,a(n-11) - 894119952\,a(n-12) - 1389075520\,a(n-13) + 5482024400\,a(n-14) + 35751673856\,a(n-15) + 90044584192\,a(n-16) + 154625904768\,a(n-17) - 247634417920\,a(n-18) - 1941041280512\,a(n-19) - 3666475576320\,a(n-20) - 3881308749824\,a(n-21) + 10379052684288\,a(n-22) + 55618412687360\,a(n-23) + 57311677382656\,a(n-24) - 29077267808256\,a(n-25) - 220194357346304\,a(n-26) - 620840327184384\,a(n-27) - 114135561601024\,a(n-28) + 1580499698188288\,a(n-29) + 1200720990175232\,a(n-30) - 655072073613312\,a(n-31) - 1208870658637824\,a(n-32) - 1743801332793344\,a(n-33) - 259325561929728\,a(n-34) + 1825629737582592\,a(n-35) + 753137564516352\,a(n-36) - 225950646140928\,a(n-37) - 218161118969856\,a(n-38) - 176903260471296\,a(n-39)
\]
for every $n>39$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A236139.
