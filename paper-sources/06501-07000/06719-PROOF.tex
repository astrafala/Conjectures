...
\title{The empirical recurrence for OEIS A260976, proved by transfer matrix}
...
\begin{abstract}
OEIS A260976 counts $(n+2)\times6$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A260976 is ``Number of (n+2)X(4+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000001 00001001 or 00100101.''. It has offset $1$ and begins
\[
483, 481, 732, 1513, 2714, 5506, 9728, 18578,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 12:13:23, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-2) + 4\,a(n-4) + 5\,a(n-5) - 5\,a(n-7) - 2\,a(n-8) - 12\,a(n-9) + 7\,a(n-10) + 11\,a(n-11) + 2\,a(n-12) + a(n-13) - 4\,a(n-15) - 11\,a(n-16) - 8\,a(n-17) - a(n-18) - 4\,a(n-19)
\]
for every $n>26$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A260976.
