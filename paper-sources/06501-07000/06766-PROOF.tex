...
\title{The empirical recurrence for OEIS A206990, proved by transfer matrix}
...
\begin{abstract}
OEIS A206990 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
...
OEIS A206990 is ``Number of nX4 0..1 arrays avoiding 0 0 0 horizontally and 1 1 1 vertically.''. It has offset
$1$ and begins
\[
13, 169, 840, 6510, 46878, 329952, 2371090,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 13:21:03, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 17\,a(n-2) + 135\,a(n-3) + 74\,a(n-4) - 7\,a(n-5) - 1496\,a(n-6) + 492\,a(n-7) - 890\,a(n-8) + 4192\,a(n-9) - 1374\,a(n-10) + 1082\,a(n-11) - 3316\,a(n-12) + 622\,a(n-13) + 112\,a(n-14) + 684\,a(n-15) - 125\,a(n-16) - 42\,a(n-17) - 43\,a(n-18) + 7\,a(n-19) + 2\,a(n-20) + a(n-21)
\end{equation}
for all $n>23$. 
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206990.
