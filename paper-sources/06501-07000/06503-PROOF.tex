...
\title{The empirical recurrence for OEIS A204033, proved by transfer matrix}
...
\begin{abstract}
OEIS A204033 counts arrays over $\{0,\dots,1\}$ under a condition on the sum of every
$2\times2$ subblock, and carries an empirical recurrence of order $21$ contributed by
...
OEIS A204033 is ``Number of (n+1)X3 0..1 arrays with the sums of 2X2 subblocks nondecreasing rightwards and downwards.''. It has offset $1$ and begins
\[
44, 164, 603, 1758, 5130, 13040, 33223, 77574,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 10:56:20, revision 9) this is still
...
entry's first term is $44$, and the model reproduces it along with every later term; that
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204033.
