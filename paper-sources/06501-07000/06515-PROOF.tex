...
\title{The empirical recurrence for OEIS A204194, proved by transfer matrix}
...
\begin{abstract}
OEIS A204194 counts arrays of width $5$ over $\{0,1\}$ containing no run of $3$ consecutive
...
the count is a walk count on $S=273$ states.
\end{abstract}
...
OEIS A204194 is ``Number of nX5 0..1 arrays with no occurrence of three equal elements in a row horizontally, vertically or nw-to-se diagonally, and new values 0..1 introduced in row major order.''. It has offset $1$ and begins
\[
8, 128, 231, 883, 3716, 15780, 67169, 286470,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 11:01:26, revision 10) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=273,\quad\tau=\mathbf{1} .
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204194.
