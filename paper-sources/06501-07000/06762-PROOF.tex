...
\title{The empirical recurrence for OEIS A207738, proved by transfer matrix}
...
\begin{abstract}
OEIS A207738 counts arrays over $\{0,\dots,1\}$ of width $5$ that avoid the patterns
...
OEIS A207738 is ``Number of nX5 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 0 1 and 1 0 0 vertically.''. It has offset
$1$ and begins
\[
15, 225, 1425, 10535, 86355, 733363, 6349893,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:14:14, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;12\,a(n-1) - 2\,a(n-2) - 307\,a(n-3) + 431\,a(n-4) + 2588\,a(n-5) - 3497\,a(n-6) - 10961\,a(n-7) + 10555\,a(n-8) + 24977\,a(n-9) - 14239\,a(n-10) - 30241\,a(n-11) + 8813\,a(n-12) + 19175\,a(n-13) - 2139\,a(n-14) - 6107\,a(n-15) + 82\,a(n-16) + 903\,a(n-17) + 13\,a(n-18) - 56\,a(n-19) + a(n-21)
\end{equation}
for all $n>22$. 
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207738.
