...
\title{The empirical recurrence for OEIS A197674, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A197674 counts arrays over $\{0,\dots,4\}$ in which every cell is constrained by the
...
OEIS A197674 is ``Number of nX3 0..4 arrays with each element x equal to the number its horizontal and vertical neighbors equal to 2,0,1,0,1 for x=0,1,2,3,4.''. It has offset $1$ and begins
\[
4, 16, 57, 202, 721, 2557, 8930, 31326,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 07:25:08, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) + a(n-2) - 6\,a(n-3) - 14\,a(n-4) + 29\,a(n-6) - 18\,a(n-7) - 29\,a(n-8) - 46\,a(n-9) + 79\,a(n-10) + 199\,a(n-11) + 62\,a(n-12) - 91\,a(n-13) - 228\,a(n-14) - 70\,a(n-15) + 92\,a(n-16) + 71\,a(n-17) + 30\,a(n-18) - 35\,a(n-19) - 3\,a(n-20) - 3\,a(n-21) - 18\,a(n-22) + 4\,a(n-23) + a(n-24) - a(n-25) + a(n-26)
\end{equation}
for all $n>27$.
...
\#\{\text{neighbours with value }f(x_{t,u})\}=x_{t,u},\quad f=(2,0,1,0,1)
\end{equation}
for every cell $(t,u)$.
...
$5$ values, so there are about $10^{50}$ of them to sift. The
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A197674.
