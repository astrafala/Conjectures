...
\title{The empirical recurrence for OEIS A253857, proved by transfer matrix}
...
\begin{abstract}
OEIS A253857 counts the arrays over $\{0,\dots,1\}$ whose $3\times3$ subblocks carry a
...
OEIS A253857 is ``Number of (n+2) X (2+2) 0..1 arrays with every 3 X 3 subblock diagonal maximum plus antidiagonal minimum nondecreasing horizontally and vertically.''. It has offset $1$ and begins
\[
3264, 30848, 291392, 2654464, 22951616, 196953728, 1698464064, 14584992256,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 16 2023 15:37:53, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253857.
