...
\title{The empirical recurrence for OEIS A260837, proved by transfer matrix}
...
\begin{abstract}
OEIS A260837 counts $(n+2)\times6$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A260837 is ``Number of (n+2)X(4+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000001 00000011 or 00010101.''. It has offset $1$ and begins
\[
364, 496, 1224, 2235, 2590, 6232, 13170, 17731,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 12:11:42, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + a(n-2) + 6\,a(n-3) - a(n-4) - 12\,a(n-5) - 15\,a(n-6) + 2\,a(n-7) + 18\,a(n-8) + 28\,a(n-9) - 3\,a(n-10) - 28\,a(n-11) - a(n-12) + 9\,a(n-13) + 12\,a(n-14) + 10\,a(n-15) - 19\,a(n-16) - 36\,a(n-17) + 4\,a(n-18) + 10\,a(n-19) - 4\,a(n-20) + 23\,a(n-21) + a(n-22) - 20\,a(n-23) + 9\,a(n-24) + 10\,a(n-25) - 4\,a(n-26) + 6\,a(n-27) + 8\,a(n-28) - 14\,a(n-29) + 2\,a(n-31) - 5\,a(n-32) + 3\,a(n-33)
\]
for every $n>34$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A260837.
