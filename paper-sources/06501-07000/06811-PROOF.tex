...
\title{The empirical recurrence for OEIS A253929, proved by transfer matrix}
...
\begin{abstract}
OEIS A253929 counts the arrays over $\{0,\dots,1\}$ whose $3\times3$ subblocks carry a
...
OEIS A253929 is ``Number of (n+2)X(2+2) 0..1 arrays with every 3X3 subblock diagonal sum plus antidiagonal sum nondecreasing horizontally and vertically.''. It has offset $1$ and begins
\[
2440, 8384, 30184, 109666, 299727, 756553, 1786831, 3803056,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 14:20:27, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253929.
