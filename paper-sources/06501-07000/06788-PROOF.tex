...
\title{The empirical recurrence for OEIS A300918, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A300918 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A300918 is ``Number of nX3 0..1 arrays with every element equal to 0, 2, 3, 4 or 5 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
1, 5, 20, 76, 290, 1245, 5160, 21819,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 15 2018 18:48:33, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 11\,a(n-2) + a(n-3) - 17\,a(n-4) - 46\,a(n-5) - 68\,a(n-6) - 42\,a(n-7) + 4\,a(n-8) + 43\,a(n-9) + 28\,a(n-10) - 34\,a(n-11) - 12\,a(n-12) + 8\,a(n-13) + 46\,a(n-14) + 22\,a(n-15) + 15\,a(n-16) - 2\,a(n-17) - 2\,a(n-18) - 3\,a(n-19) - a(n-21)
\end{equation}
for all $n>22$.
...
The threshold below is exact rather than merely sufficient: at $n=22$ the conjectured
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A300918.
