...
\title{The empirical recurrence for OEIS A260100, proved by transfer matrix}
...
\begin{abstract}
OEIS A260100 counts $(n+2)\times4$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A260100 is ``Number of (n+2)X(2+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000001 00000101 or 00010101.''. It has offset $1$ and begins
\[
85, 201, 477, 1151, 2794, 6804, 16453, 39854,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 12:00:22, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 2\,a(n-2) + 12\,a(n-4) - a(n-5) - 8\,a(n-6) + 2\,a(n-7) - 51\,a(n-8) - 22\,a(n-9) - 12\,a(n-10) - 46\,a(n-11) + 31\,a(n-12) + 12\,a(n-13) - 21\,a(n-14) + 18\,a(n-15) - 6\,a(n-16) - 18\,a(n-17)
\]
for every $n>18$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A260100.
