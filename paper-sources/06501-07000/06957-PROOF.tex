...
\title{The empirical recurrence for OEIS A230333, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A230333 counts arrays over $\{0,\dots,2\}$ in which every cell is constrained by the
...
OEIS A230333 is ``Number of nX4 0..2 arrays x(i,j) with each element horizontally, vertically or antidiagonally next to at least one element with value (x(i,j)+1) mod 3, and upper left element zero.''. It has offset $1$ and begins
\[
0, 218, 9162, 438284, 20948996, 1000237228, 47762574418, 2280709396620,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 05:50:04, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;48\,a(n-1) + 28\,a(n-2) - 1810\,a(n-3) - 5084\,a(n-4) + 24565\,a(n-5) + 85859\,a(n-6) + 346698\,a(n-7) - 99352\,a(n-8) - 17542863\,a(n-9) - 18713044\,a(n-10) + 418955644\,a(n-11) + 248749776\,a(n-12) - 7264990096\,a(n-13) - 1407152832\,a(n-14) + 90735516736\,a(n-15) + 40012649216\,a(n-16) - 630054322176\,a(n-17) - 106033475584\,a(n-18) + 2287216246784\,a(n-19) - 645639110656\,a(n-20) - 188203139072\,a(n-21) + 27446476800\,a(n-22) - 14344519680\,a(n-23) - 4294967296\,a(n-24)
\end{equation}
for all $n>26$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A230333.
