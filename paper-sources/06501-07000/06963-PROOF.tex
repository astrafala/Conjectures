...
\title{The empirical recurrence for OEIS A253694, proved by transfer matrix}
...
\begin{abstract}
OEIS A253694 counts arrays of width $5$ over $\{0,1\}$ in which two diagonal numbers of every $2\times2$ subblock each differ from the same number at a neighbouring subblock. The entry carries an
...
OEIS A253694 is ``Number of (n+1)X(4+1) 0..1 arrays with every 2X2 subblock ne-sw antidiagonal difference unequal to its neighbors horizontally and nw+se diagonal sum unequal to its neighbors vertically.''. It has offset $1$ and begins
\[
264, 282, 356, 700, 1120, 1638, 3136, 4782,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 14:09:42, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-2) + 2\,a(n-3) - a(n-4) - a(n-6) - 13\,a(n-7) - 8\,a(n-8) + 9\,a(n-9) + a(n-10) + 13\,a(n-11) + 31\,a(n-12) - 11\,a(n-13) - 26\,a(n-14) + 7\,a(n-15) - 5\,a(n-16) - 15\,a(n-17) + 7\,a(n-18) + 6\,a(n-19) - 2\,a(n-20) + 2\,a(n-21) + 2\,a(n-22)
\]
for every $n>24$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253694.
