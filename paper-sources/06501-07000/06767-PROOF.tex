...
\title{The empirical recurrence for OEIS A255029, proved by transfer matrix}
...
\begin{abstract}
OEIS A255029 counts the arrays over $\{0,\dots,1\}$ whose $3\times3$ subblocks carry a
...
OEIS A255029 is ``Number of (n+2)X(1+2) 0..1 arrays with every 3X3 subblock sum of the two sums of the central row and central column minus the two minimums of the diagonal and antidiagonal nondecreasing horizontally, vertically and ne-to-sw antidiagonally.''. It has offset $1$ and begins
\[
512, 2554, 10732, 42890, 154680, 516998, 1640073, 5004712,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 15:05:30, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-1) - 16\,a(n-2) + 12\,a(n-3) - 4\,a(n-4) + 6\,a(n-5) + 24\,a(n-6) - 54\,a(n-7) + 65\,a(n-8) - 47\,a(n-9) - 98\,a(n-10) - 34\,a(n-11) + 268\,a(n-12) - 174\,a(n-13) + 526\,a(n-14) - 228\,a(n-15) - 928\,a(n-16) + 176\,a(n-17) + 1052\,a(n-18) - 384\,a(n-19) - 312\,a(n-20) + 144\,a(n-21)
\]
for every $n>27$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A255029.
