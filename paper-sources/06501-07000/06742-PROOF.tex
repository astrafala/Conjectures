...
\title{The empirical recurrence for OEIS A206984, proved by transfer matrix}
...
\begin{abstract}
OEIS A206984 counts arrays of width $5$ over $\{0,1\}$ containing no occurrence of certain short
...
OEIS A206984 is ``Number of nX5 0..1 arrays avoiding the patterns 0 1 0 or 1 0 1 in any row, column, diagonal or antidiagonal.''. It has offset $1$ and begins
\[
16, 256, 420, 1866, 7500, 27762, 106110, 413526,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 13:20:27, revision 10) this is still
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) - 7\,a(n-2) + 17\,a(n-3) - 27\,a(n-4) + 2\,a(n-5) + 47\,a(n-6) - 201\,a(n-7) - 179\,a(n-8) + 23\,a(n-9) + 255\,a(n-10) - 331\,a(n-11) - 206\,a(n-12) + 691\,a(n-13) + 704\,a(n-14) - 353\,a(n-15) - 775\,a(n-16) + 88\,a(n-17) - 15\,a(n-18) + 86\,a(n-19) - 192\,a(n-20) + 15\,a(n-21) + 64\,a(n-22) + 40\,a(n-23) + 8\,a(n-24) - 10\,a(n-25)
\]
for every $n>27$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206984.
