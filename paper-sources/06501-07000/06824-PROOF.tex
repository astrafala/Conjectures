...
\title{The empirical recurrence for OEIS A183332, proved by transfer matrix}
...
\begin{abstract}
OEIS A183332 counts arrays of width $4$ over $\{0,1\}$ under local conditions relating each cell
...
OEIS A183332 is ``Number of n X 4 binary arrays with each 1 adjacent to exactly two 0's.''. It has offset $1$ and begins
\[
3, 23, 66, 247, 899, 3254, 11883, 43207,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 01:34:39, revision 9) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=170.
\]
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 2\,a(n-2) + 9\,a(n-3) + 14\,a(n-4) + 20\,a(n-5) + 9\,a(n-6) - 4\,a(n-7) - 24\,a(n-8) - 46\,a(n-9) - 43\,a(n-10) - 35\,a(n-11) - 16\,a(n-12) + 6\,a(n-13) + 11\,a(n-14) + 8\,a(n-15) + 7\,a(n-16) + 2\,a(n-17) + a(n-18) + 2\,a(n-19)
\]
for every $n>19$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A183332.
