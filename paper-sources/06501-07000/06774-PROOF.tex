...
\title{The empirical recurrence for OEIS A254582, proved by transfer matrix}
...
\begin{abstract}
OEIS A254582 counts the arrays over $\{0,\dots,1\}$ whose $3\times3$ subblocks carry a
...
so the count is a walk count on $S=9997$ states --- the last two array rows together with the
...
OEIS A254582 is ``Number of (n+2)X(4+2) 0..1 arrays with every 3X3 subblock sum of the two medians of the central row and the central column and the two maximums of the diagonal and antidiagonal nondecreasing horizontally, vertically and ne-to-sw antidiagonally.''. It has offset $1$ and begins
\[
72939, 545360, 5909527, 58920922, 548753241, 5184793937, 49094787979, 464109388554,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 14:51:00, revision 6) this is still
...
\]
on the $S=9997$ reachable states. In particular $a$ is $C$-finite. The alignment of the walk
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-1) + 26\,a(n-2) + 22\,a(n-3) - 92\,a(n-4) - 3346\,a(n-5) - 3353\,a(n-6) + 15621\,a(n-7) + 56452\,a(n-8) + 115856\,a(n-9) - 415048\,a(n-10) - 1140576\,a(n-11) + 1731632\,a(n-12) + 3696912\,a(n-13) - 4777936\,a(n-14) - 5098384\,a(n-15) + 9168832\,a(n-16) + 297280\,a(n-17) - 9782784\,a(n-18) + 5598208\,a(n-19) + 3727360\,a(n-20) - 3596288\,a(n-21) + 819200\,a(n-22) - 147456\,a(n-23) - 524288\,a(n-24) + 262144\,a(n-25)
\]
for every $n>32$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A254582.
