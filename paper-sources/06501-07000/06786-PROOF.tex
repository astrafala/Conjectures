...
\title{The empirical recurrence for OEIS A305241, proved by transfer matrix}
...
\begin{abstract}
OEIS A305241 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A305241 is ``Number of n X 4 0..1 arrays with every element unequal to 0, 1, 2, 4 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
8, 24, 32, 94, 273, 767, 2128, 6150,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 28 2025 00:40:17, revision
8) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 5\,a(n-2) + 4\,a(n-3) + a(n-4) - 20\,a(n-5) - 26\,a(n-6) - 9\,a(n-7) - a(n-8) + 39\,a(n-9) + 53\,a(n-10) + 39\,a(n-11) + 15\,a(n-12) - 6\,a(n-13) - 31\,a(n-14) - 54\,a(n-15) - 53\,a(n-16) - 26\,a(n-17) + 28\,a(n-18) + 18\,a(n-19) + 10\,a(n-20) - a(n-21) - 54\,a(n-22) - 24\,a(n-23) + 13\,a(n-24) - 5\,a(n-25) - 4\,a(n-26) + 5\,a(n-27) + 2\,a(n-28)
\end{equation}
for all $n>32$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A305241.
