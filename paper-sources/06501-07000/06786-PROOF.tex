...
\title{A condition on every subblock: the empirical recurrence for OEIS A181257}
...
\begin{abstract}
OEIS A181257 carries an empirical recurrence of order $20$ contributed by R.~H.~Hardin. It is
...
OEIS A181257 is ``Number of (n+2)X5 binary matrices with every 3X3 block having exactly four 1's.''. It has offset $1$ and begins
\[
906, 1684, 3190, 6360, 14974, 36244, 91122, 247372,\ \dots
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A181257.
