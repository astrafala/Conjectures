...
\title{The empirical recurrence for OEIS A202771, proved by transfer matrix}
...
\begin{abstract}
OEIS A202771 counts arrays of width $4$ over $\{0,1\}$ containing no occurrence of certain short
patterns, read along the rows, the columns or the diagonals. The entry carries an empirical
recurrence of order $20$ contributed by R.~H.~Hardin. It is true, and it is decidable
...
OEIS A202771 is ``Number of (n+2) X 4 binary arrays avoiding patterns 000 and 011 in rows, columns and nw-to-se diagonals.''. It has offset $1$ and begins
\[
201, 550, 1239, 2600, 5330, 10322, 19712, 36877,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 16 2024 09:38:12, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) - 2\,a(n-3) - 11\,a(n-4) + 9\,a(n-5) + 10\,a(n-6) + 11\,a(n-7) - 23\,a(n-8) - 8\,a(n-9) - 3\,a(n-10) + 20\,a(n-11) + 3\,a(n-13) - 8\,a(n-14) - 4\,a(n-16) + 3\,a(n-17) + a(n-18) + a(n-19) - a(n-20)
\]
for every $n>17$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A202771.
