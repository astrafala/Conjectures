...
\title{The empirical recurrence for OEIS A183715, proved by transfer matrix}
...
\begin{abstract}
OEIS A183715 counts arrays of width $6$ over $\{0,1,2,3,4\}$ subject to a condition read round the
...
count is a walk count on a finite digraph with $S=15626$ vertices, and whether a linear
...
OEIS A183715 is ``1/20 of the number of (n+1) X 6 0..4 arrays with every 2X2 subblock strictly increasing clockwise or counterclockwise with one decrease.''. It has offset $1$ and begins
\[
70, 559, 4012, 30113, 224640, 1683197, 12606120, 94463507,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 06 2015 21:58:56, revision 7) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The arrays have $6$ columns and a growing number of rows, with entries in $\{0,1,2,3,4\}$. A
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=15626,
\]
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 54\,a(n-2) - 2\,a(n-3) - 738\,a(n-4) - 312\,a(n-5) + 4078\,a(n-6) + 2098\,a(n-7) - 10802\,a(n-8) - 4874\,a(n-9) + 14854\,a(n-10) + 4874\,a(n-11) - 10802\,a(n-12) - 2098\,a(n-13) + 4078\,a(n-14) + 312\,a(n-15) - 738\,a(n-16) + 2\,a(n-17) + 54\,a(n-18) - 2\,a(n-19) - a(n-20)
\]
for every $n>20$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A183715.
