...
\title{The empirical recurrence for OEIS A250439, proved by transfer matrix}
...
\begin{abstract}
OEIS A250439 counts arrays over $\{0,1,2\}$ in which a statistic taken over short runs
...
window of consecutive rows, so the count is a walk count on $S=3600$ states, and the
...
OEIS A250439 is ``Number of (n+1)X(4+1) 0..2 arrays with nondecreasing sum of every two consecutive values in every row and column.''. It has offset $1$ and begins
\[
3600, 60000, 1000000, 8750000, 76562500, 450187500, 2647102500, 11859019200,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 12:24:55, revision 6) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=3600,
\]
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 18\,a(n-2) - 38\,a(n-3) - 152\,a(n-4) + 342\,a(n-5) + 798\,a(n-6) - 1938\,a(n-7) - 2907\,a(n-8) + 7752\,a(n-9) + 7752\,a(n-10) - 23256\,a(n-11) - 15504\,a(n-12) + 54264\,a(n-13) + 23256\,a(n-14) - 100776\,a(n-15) - 25194\,a(n-16) + 151164\,a(n-17) + 16796\,a(n-18) - 184756\,a(n-19) + 184756\,a(n-21) - 16796\,a(n-22) - 151164\,a(n-23) + 25194\,a(n-24) + 100776\,a(n-25) - 23256\,a(n-26) - 54264\,a(n-27) + 15504\,a(n-28) + 23256\,a(n-29) - 7752\,a(n-30) - 7752\,a(n-31) + 2907\,a(n-32) + 1938\,a(n-33) - 798\,a(n-34) - 342\,a(n-35) + 152\,a(n-36) + 38\,a(n-37) - 18\,a(n-38) - 2\,a(n-39) + a(n-40)
\]
for every $n>40$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250439.
