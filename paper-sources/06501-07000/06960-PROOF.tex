...
\title{The empirical recurrence for OEIS A186789, proved by transfer matrix}
...
\begin{abstract}
OEIS A186789 counts arrays of width $4$ over $\{0,1\}$ in which every $3\times3$ subblock
satisfies a condition on its nine entries. The entry carries an empirical recurrence of order
$14$ contributed by R.~H.~Hardin. It is true, and it is decidable rather than empirical: a
...
OEIS A186789 is ``Half the number of (n+2)X4 binary arrays with each 3X3 subblock having a sum in 2..7.''. It has offset $1$ and begins
\[
1910, 29020, 440505, 6687805, 101532811, 1541462868, 23402344941, 355292192013,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 03:41:22, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;13\,a(n-1) + 27\,a(n-2) + 97\,a(n-3) - 13\,a(n-4) - 696\,a(n-5) - 487\,a(n-6) + 531\,a(n-7) + 1379\,a(n-8) + 420\,a(n-9) - 720\,a(n-10) - 888\,a(n-11) - 72\,a(n-12) + 216\,a(n-13) + 216\,a(n-14)
\]
for every $n>12$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A186789.
