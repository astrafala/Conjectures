...
\title{The empirical recurrence for OEIS A283576, proved by transfer matrix}
...
\begin{abstract}
OEIS A283576 counts $5\times n$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
walk, and $a(n)$ is a walk count on $S=870$ vertices, which is $C$-finite. Whether the
...
OEIS A283576 is ``Number of 5Xn 0..1 arrays with no 1 equal to more than one of its horizontal, diagonal and antidiagonal neighbors, with the exception of exactly one element.''. It has offset $1$ and begins
\[
0, 256, 6453, 60802, 945100, 10919674, 129527524, 1518039552,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 11 2017 08:21:01, revision 4) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A283576.
