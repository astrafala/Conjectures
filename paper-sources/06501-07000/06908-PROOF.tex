...
\title{The empirical recurrence for OEIS A250997, proved by transfer matrix}
...
\begin{abstract}
OEIS A250997 counts arrays over $\{0,1,2\}$ in which a statistic taken over short runs
...
OEIS A250997 is ``Number of (3+1)X(n+1) 0..2 arrays with nondecreasing min(x(i,j),x(i,j-1)) in the i direction and nondecreasing absolute value of x(i,j)-x(i-1,j) in the j direction.''. It has offset $1$ and begins
\[
612, 4111, 21955, 104674, 456514, 1869400, 7290819, 27384143,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 12:57:49, revision 6) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The array has $4$ cells across and entries $x(i,j)\in\{0,1,2\}$.
...
So a single row is a state. Let $M$ be the matrix on the $3^{4}=81$ rows with
...
\begin{theorem}
\[
a(n)\;=\;10\,a(n-1) - 26\,a(n-2) - 49\,a(n-3) + 313\,a(n-4) - 148\,a(n-5) - 1278\,a(n-6) + 1613\,a(n-7) + 2503\,a(n-8) - 5004\,a(n-9) - 2294\,a(n-10) + 8211\,a(n-11) + 238\,a(n-12) - 8046\,a(n-13) + 1466\,a(n-14) + 4882\,a(n-15) - 1384\,a(n-16) - 1838\,a(n-17) + 564\,a(n-18) + 420\,a(n-19) - 109\,a(n-20) - 54\,a(n-21) + 8\,a(n-22) + 3\,a(n-23)
\]
for every $n>22$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250997.
