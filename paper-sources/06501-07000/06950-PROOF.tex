...
\title{The empirical recurrence for OEIS A297302, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297302 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A297302 is ``Number of 5Xn 0..1 arrays with every 1 horizontally or antidiagonally adjacent to 2 neighboring 1s.''. It has offset $1$ and begins
\[
1, 1, 8, 19, 49, 157, 600, 2161,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 27 2017 21:16:54, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;7\,a(n-1) - 21\,a(n-2) + 42\,a(n-3) - 56\,a(n-4) + 67\,a(n-5) - 40\,a(n-6) - 48\,a(n-7) + 185\,a(n-8) - 212\,a(n-9) + 185\,a(n-10) - 144\,a(n-11) - 37\,a(n-12) + 221\,a(n-13) - 238\,a(n-14) - 59\,a(n-15) + a(n-16) + 399\,a(n-17) - 152\,a(n-18) - 295\,a(n-19) + 284\,a(n-20) + 163\,a(n-21) - 349\,a(n-22) - 328\,a(n-23) + 203\,a(n-24) + 273\,a(n-25) + 58\,a(n-26) - 102\,a(n-27) - 59\,a(n-28) + 8\,a(n-29) + 11\,a(n-30) + 4\,a(n-31) - 2\,a(n-32)
\end{equation}
for all $n>37$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297302.
