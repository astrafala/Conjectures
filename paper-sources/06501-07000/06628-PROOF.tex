...
\title{The empirical recurrence for OEIS A300926, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A300926 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A300926 is ``Number of nX4 0..1 arrays with every element equal to 1, 2, 3, 4 or 5 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
2, 37, 508, 6638, 87561, 1155263, 15238332, 200997959,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 15 2018 18:58:10, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;13\,a(n-1) + 10\,a(n-2) - 87\,a(n-3) - 170\,a(n-4) + 127\,a(n-5) + 799\,a(n-6) + 686\,a(n-7) - 1452\,a(n-8) - 2477\,a(n-9) + 72\,a(n-10) + 3081\,a(n-11) + 2340\,a(n-12) - 1976\,a(n-13) - 3131\,a(n-14) + 247\,a(n-15) + 1710\,a(n-16) + 847\,a(n-17) + 207\,a(n-18) - 84\,a(n-19) - 182\,a(n-20) - 46\,a(n-21) + 45\,a(n-22) + 32\,a(n-23) + 2\,a(n-24) + a(n-25) - a(n-26)
\end{equation}
for all $n>27$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A300926.
