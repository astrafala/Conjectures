...
\title{The empirical recurrence for OEIS A188758, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A188758 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A188758 is ``Number of nX4 binary arrays without the pattern 0 0 1 vertically or horizontally.''. It has offset $1$ and begins
\[
12, 144, 1112, 8024, 53024, 339927, 2125134, 13128024,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 04:49:27, revision 9) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A188758.
