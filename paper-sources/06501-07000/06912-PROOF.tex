...
\title{The empirical recurrence for OEIS A259997, proved by transfer matrix}
...
\begin{abstract}
OEIS A259997 counts $(n+2)\times6$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A259997 is ``Number of (n+2)X(4+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000001 00000011 or 00000101.''. It has offset $1$ and begins
\[
641, 1819, 6157, 12620, 23680, 74850, 197804, 383548,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:57:58, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-2) + 10\,a(n-3) + 25\,a(n-4) - 27\,a(n-5) - 99\,a(n-6) - 107\,a(n-7) - 136\,a(n-8) + 291\,a(n-9) + 668\,a(n-10) + 342\,a(n-11) + 145\,a(n-12) - 1029\,a(n-13) - 1042\,a(n-14) + 184\,a(n-15) + 1132\,a(n-16) - 216\,a(n-17) - 2049\,a(n-18) - 141\,a(n-19) + 321\,a(n-20) + 457\,a(n-21) - 4\,a(n-22) + 44\,a(n-24) - 352\,a(n-25) + 279\,a(n-26)
\]
for every $n>30$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A259997.
