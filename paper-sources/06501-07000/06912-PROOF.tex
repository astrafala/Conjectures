...
\title{The empirical recurrence for OEIS A207742, proved by transfer matrix}
...
\begin{abstract}
OEIS A207742 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
$(0,0,1), (1,0,0)$ along one axis and $(0,0,0), (0,1,0)$ along the other, and carries an empirical recurrence of
...
OEIS A207742 is ``Number of 4Xn 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 0 1 and 1 0 0 vertically.''. It has offset
$1$ and begins
\[
9, 81, 387, 1849, 10535, 60025, 327075,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:14:44, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) + 32\,a(n-3) + 132\,a(n-4) - 238\,a(n-5) - 136\,a(n-6) - 1068\,a(n-7) - 3958\,a(n-8) + 5414\,a(n-9) + 7248\,a(n-10) + 3912\,a(n-11) + 23868\,a(n-12) - 23346\,a(n-13) - 29268\,a(n-14) - 4140\,a(n-15) - 61497\,a(n-16) + 37350\,a(n-17) + 24948\,a(n-18) - 5400\,a(n-19) + 52920\,a(n-20) - 33264\,a(n-21) - 2592\,a(n-22) - 11664\,a(n-24) + 7776\,a(n-25)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207742.
