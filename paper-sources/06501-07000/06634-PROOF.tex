...
\title{The empirical recurrence for OEIS A252266, proved by transfer matrix}
...
\begin{abstract}
OEIS A252266 counts $(n+2)\times7$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
$a(n)$ is a walk count on $S=139189$ vertices. Such a sequence is $C$-finite, so whether a given
...
OEIS A252266 is ``Number of (n+2)X(5+2) 0..3 arrays with every 3X3 subblock row, column, diagonal and antidiagonal sum not equal to 2 3 4 6 or 7.''. It has offset $1$ and begins
\[
1342, 6164, 35486, 188690, 984416, 5217924, 27565694, 145417138,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 10:59:42, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252266.
