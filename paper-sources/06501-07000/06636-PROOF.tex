...
\title{The empirical recurrence for OEIS A260471, proved by transfer matrix}
...
\begin{abstract}
OEIS A260471 counts $(n+2)\times6$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A260471 is ``Number of (n+2)X(4+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000000 00000001 or 00010101.''. It has offset $1$ and begins
\[
205, 471, 1723, 5034, 15502, 51552, 161176, 500384,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 12:07:07, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 2\,a(n-2) + 16\,a(n-3) + 7\,a(n-4) - 14\,a(n-5) - 45\,a(n-6) - 14\,a(n-7) + 7\,a(n-8) + 42\,a(n-9) + 10\,a(n-10) - 37\,a(n-11) - 82\,a(n-12) - 25\,a(n-13) + 110\,a(n-14) + 169\,a(n-15) + 20\,a(n-16) - 71\,a(n-17) - 88\,a(n-18) - 20\,a(n-19) + 58\,a(n-20) + 83\,a(n-21) + 72\,a(n-22) - 60\,a(n-23) - 79\,a(n-24) - 63\,a(n-25) + 4\,a(n-26) + 16\,a(n-27) + 10\,a(n-28)
\]
for every $n>32$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A260471.
