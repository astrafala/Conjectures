...
\title{The empirical recurrence for OEIS A260539, proved by transfer matrix}
...
\begin{abstract}
OEIS A260539 counts $(n+2)\times5$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A260539 is ``Number of (n+2) X (3+2) 0..1 arrays with each 3 X 3 subblock having clockwise perimeter pattern 00000001 00000011 or 00010001.''. It has offset $1$ and begins
\[
193, 310, 774, 1411, 2226, 5592, 11370, 18899,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 02 2024 19:04:03, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-3) + 6\,a(n-4) + a(n-5) - 5\,a(n-6) - 9\,a(n-7) - 13\,a(n-8) + 7\,a(n-9) + 10\,a(n-10) - 3\,a(n-11) + 3\,a(n-12) - 10\,a(n-13) - 16\,a(n-14) - 14\,a(n-15) - 3\,a(n-16) - 2\,a(n-17) - a(n-18) + 4\,a(n-19)
\]
for every $n>22$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A260539.
