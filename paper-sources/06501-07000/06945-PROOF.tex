...
\title{The empirical recurrence for OEIS A255038, proved by transfer matrix}
...
\begin{abstract}
OEIS A255038 counts the arrays over $\{0,\dots,1\}$ whose $3\times3$ subblocks carry a
...
so the count is a walk count on $S=3370$ states --- the last two array rows together with the
...
OEIS A255038 is ``Number of (3+2)X(n+2) 0..1 arrays with every 3X3 subblock sum of the two sums of the central row and central column minus the two minimums of the diagonal and antidiagonal nondecreasing horizontally, vertically and ne-to-sw antidiagonally.''. It has offset $1$ and begins
\[
10732, 33778, 100001, 246173, 566341, 1217347, 2396285, 4226143,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 15:06:25, revision 6) this is still
...
\]
on the $S=3370$ reachable states. In particular $a$ is $C$-finite. The alignment of the walk
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) - 7\,a(n-2) + 11\,a(n-3) - 12\,a(n-4) - 2\,a(n-5) + 18\,a(n-6) - 41\,a(n-7) + 82\,a(n-8) - 88\,a(n-9) + 80\,a(n-10) - 63\,a(n-11) - 30\,a(n-12) + 92\,a(n-13) - 124\,a(n-14) + 185\,a(n-15) - 157\,a(n-16) + 144\,a(n-17) - 165\,a(n-18) + 104\,a(n-19) - 82\,a(n-20) + 46\,a(n-21) + 46\,a(n-22) - 84\,a(n-23) + 136\,a(n-24) - 180\,a(n-25) + 152\,a(n-26) - 112\,a(n-27) + 64\,a(n-28) - 16\,a(n-29)
\]
for every $n>47$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A255038.
