...
\title{The empirical recurrence for OEIS A237010, proved by transfer matrix}
...
\begin{abstract}
OEIS A237010 counts arrays over $\{0,\dots,3\}$ subject to a condition on the order
...
The condition is local to two consecutive rows, so the count is a walk count on $S=1152$
...
OEIS A237010 is ``Number of (n+1)X(3+1) 0..3 arrays with the sum of all four elements of every 2X2 subblock equal.''. It has offset $1$ and begins
\[
1936, 3928, 8416, 20776, 53200, 149608, 431584, 1327432,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 09:45:38, revision 6) this is still
...
array, which is not among the objects counted. There are $S=1152$ states left.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237010.
