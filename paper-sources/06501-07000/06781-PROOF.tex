...
\title{The empirical recurrence for OEIS A237102, proved by transfer matrix}
...
\begin{abstract}
OEIS A237102 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
The condition is local to two consecutive rows, so the count is a walk count on $S=54$
...
OEIS A237102 is ``Number of (n+1)X(2+1) 0..2 arrays with the maximum minus the upper median of every 2X2 subblock equal.''. It has offset $1$ and begins
\[
385, 3787, 39235, 435113, 4975145, 58074637, 685334343, 8138935643,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 09:51:14, revision 6) this is still
...
array, which is not among the objects counted. There are $S=54$ states left.
...
\begin{theorem}
\[
a(n)\;=\;27\,a(n-1) - 199\,a(n-2) - 477\,a(n-3) + 11775\,a(n-4) - 34928\,a(n-5) - 115926\,a(n-6) + 725374\,a(n-7) - 204577\,a(n-8) - 4749380\,a(n-9) + 6666884\,a(n-10) + 11629260\,a(n-11) - 27768844\,a(n-12) - 8069720\,a(n-13) + 48967980\,a(n-14) - 8687056\,a(n-15) - 41849680\,a(n-16) + 14177792\,a(n-17) + 17748896\,a(n-18) - 5169888\,a(n-19) - 4051136\,a(n-20) + 354688\,a(n-21) + 378816\,a(n-22) + 40320\,a(n-23)
\]
for every $n>22$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237102.
