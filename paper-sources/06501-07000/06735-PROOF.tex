...
\title{The empirical recurrence for OEIS A251114, proved by transfer matrix}
...
\begin{abstract}
OEIS A251114 counts arrays over $\{0,1,2,3\}$ in which a statistic taken over short runs
...
OEIS A251114 is ``Number of (n+1) X (1+1) 0..3 arrays with nondecreasing maximum of every two consecutive values in every row and column.''. It has offset $1$ and begins
\[
256, 2500, 22500, 173056, 1252161, 8444836, 54700816, 341067024,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 26 2023 10:12:06, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251114.
