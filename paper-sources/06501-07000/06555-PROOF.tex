...
\title{The empirical recurrence for OEIS A255758, proved by transfer matrix}
...
\begin{abstract}
OEIS A255758 counts the arrays over $\{0,\dots,1\}$ whose $3\times3$ subblocks carry a
...
so the count is a walk count on $S=3564$ states --- the last two array rows together with the
...
OEIS A255758 is ``Number of (3+2)X(n+2) 0..1 arrays with every 3X3 subblock sum of the medians of the diagonal and antidiagonal minus the two sums of the central row and column nondecreasing horizontally, vertically and ne-to-sw antidiagonally.''. It has offset $1$ and begins
\[
8776, 20730, 51064, 111064, 197284, 341801, 551068, 880000,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 15:12:12, revision 6) this is still
...
\]
on the $S=3564$ reachable states. In particular $a$ is $C$-finite. The alignment of the walk
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) - 5\,a(n-2) + a(n-3) + 11\,a(n-4) - 36\,a(n-5) + 40\,a(n-6) - 2\,a(n-7) - 42\,a(n-8) + 89\,a(n-9) - 70\,a(n-10) - 39\,a(n-11) + 62\,a(n-12) - 2\,a(n-13) - 80\,a(n-14) + 148\,a(n-15) - 13\,a(n-16) - 159\,a(n-17) + 155\,a(n-18) - 76\,a(n-19) - 57\,a(n-20) + 88\,a(n-21) + 40\,a(n-22) - 96\,a(n-23) + 56\,a(n-24) + 16\,a(n-25) - 80\,a(n-26) + 64\,a(n-27) - 16\,a(n-28)
\]
for every $n>47$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A255758.
