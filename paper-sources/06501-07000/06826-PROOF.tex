...
\title{The empirical recurrence for OEIS A207888, proved by transfer matrix}
...
\begin{abstract}
OEIS A207888 counts arrays over $\{0,\dots,1\}$ of width $6$ that avoid the patterns
...
OEIS A207888 is ``Number of 6Xn 0..1 arrays avoiding 0 0 0 and 1 0 1 horizontally and 0 1 1 and 1 1 0 vertically.''. It has offset
$1$ and begins
\[
22, 484, 942, 4881, 14225, 33631, 138552,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:24:31, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + a(n-2) + 36\,a(n-3) - 14\,a(n-4) - 26\,a(n-5) - 435\,a(n-6) + 97\,a(n-7) + 135\,a(n-8) + 2888\,a(n-9) - 540\,a(n-10) + 131\,a(n-11) - 12541\,a(n-12) + 2158\,a(n-13) - 4031\,a(n-14) + 39053\,a(n-15) - 5366\,a(n-16) + 19889\,a(n-17) - 90907\,a(n-18) + 7414\,a(n-19) - 56374\,a(n-20) + 161200\,a(n-21) - 3221\,a(n-22) + 107356\,a(n-23) - 221425\,a(n-24) - 6646\,a(n-25) - 144964\,a(n-26) + 240706\,a(n-27) + 12411\,a(n-28) + 142562\,a(n-29) - 211220\,a(n-30) - 7937\,a(n-31) - 102645\,a(n-32) + 150000\,a(n-33) - 664\,a(n-34) + 52557\,a(n-35) - 84163\,a(n-36) + 4604\,a(n-37) - 17655\,a(n-38) + 35671\,a(n-39) - 3158\,a(n-40) + 3161\,a(n-41) - 10877\,a(n-42) + 982\,a(n-43) + 14\,a(n-44) + 2284\,a(n-45) - 119\,a(n-46) - 134\,a(n-47) - 306\,a(n-48) - a(n-49) + 19\,a(n-50) + 19\,a(n-51)
\end{equation}
for all $n>53$. The entry's array has a fixed number of rows and a growing number of
...
index corresponding to $n=53+1$ onwards, and the run was continued past $S$ consecutive
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207888.
