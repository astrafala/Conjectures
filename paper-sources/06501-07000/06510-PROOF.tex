...
\title{The empirical recurrence for OEIS A259890, proved by transfer matrix}
...
\begin{abstract}
OEIS A259890 counts $(n+2)\times6$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A259890 is ``Number of (n+2)X(4+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000000 00000001 or 00000011.''. It has offset $1$ and begins
\[
499, 1853, 13373, 58800, 202632, 954624, 4585294, 18966448,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:55:37, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 5\,a(n-2) + 34\,a(n-3) + 80\,a(n-4) - 71\,a(n-5) - 356\,a(n-6) - 455\,a(n-7) - 587\,a(n-8) + 739\,a(n-9) + 2387\,a(n-10) + 1309\,a(n-11) + 297\,a(n-12) - 613\,a(n-13) - 1780\,a(n-14) - 1644\,a(n-15) - 1034\,a(n-16) - 291\,a(n-17) + 137\,a(n-18) + 53\,a(n-19) + 18\,a(n-20) + 12\,a(n-21) - 6\,a(n-22)
\]
for every $n>22$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A259890.
