...
\title{The empirical recurrence for OEIS A302079, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A302079 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A302079 is ``Number of n X 6 0..1 arrays with every element equal to 0, 1, 3 or 4 horizontally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
13, 74, 433, 2838, 18492, 124046, 829709, 5574946,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 26 2022 04:39:36, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 72\,a(n-2) - 13\,a(n-3) - 1869\,a(n-4) - 227\,a(n-5) + 24406\,a(n-6) + 6089\,a(n-7) - 183074\,a(n-8) - 51341\,a(n-9) + 843604\,a(n-10) + 203171\,a(n-11) - 2493360\,a(n-12) - 379486\,a(n-13) + 4846450\,a(n-14) + 288330\,a(n-15) - 6222905\,a(n-16) + 32522\,a(n-17) + 5347282\,a(n-18) - 289982\,a(n-19) - 3397328\,a(n-20) + 144099\,a(n-21) + 1440692\,a(n-22) - 38125\,a(n-23) - 412290\,a(n-24) + 3241\,a(n-25) + 67830\,a(n-26) + 125\,a(n-27) - 5261\,a(n-28) - 13\,a(n-29) + 136\,a(n-30) + a(n-31) - a(n-32)
\end{equation}
for all $n>33$.
...
publishes, $n=19$, the arrays have $6\cdot19$ cells over
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302079.
