...
\title{The empirical recurrence for OEIS A251385, proved by transfer matrix}
...
\begin{abstract}
OEIS A251385 counts $4$-column arrays over $\{0,\dots,2\}$ in which every
...
\mathbf{1}$ for the adjacency matrix $M$ of that digraph, on $S=81$ vertices. Writing
...
OEIS A251385 is ``Number of (n+1)X(3+1) 0..2 arrays with every 2X2 subblock summing to 2 3 4 5 or 6.''. It has offset $1$
and begins
\[
4585, 271393, 16036923, 948010753, 56040713651, 3312804237391, 195833921630923, 11576574968972023,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 10:25:07, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;63\,a(n-1) - 155\,a(n-2) - 4658\,a(n-3) + 12612\,a(n-4) + 104334\,a(n-5) - 242452\,a(n-6) - 787537\,a(n-7) + 1342994\,a(n-8) + 1584245\,a(n-9) - 2822088\,a(n-10) - 447621\,a(n-11) + 1812174\,a(n-12) - 339424\,a(n-13) - 296064\,a(n-14) + 90240\,a(n-15)
\end{equation}
...
Let $V=\{0,1,\dots,2\}^{4}$, the set of possible rows, so $|V|=S=81$. For
...
the $12$ published indices; the values agree exactly. That is what ties the digraph to
...
bound $j<S=81$ rather than to a sampled prefix, in exact integer arithmetic, and returned
zero throughout.

\begin{thebibliography}{9}
\bibitem{oeis} The OEIS Foundation, \emph{The On-Line Encyclopedia of Integer
Sequences}, \url{https://oeis.org}, 2026. Sequence A251385.
