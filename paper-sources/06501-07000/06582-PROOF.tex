...
\title{The empirical recurrence for OEIS A185792, proved by transfer matrix}
...
\begin{abstract}
OEIS A185792 counts arrays over $\{0,\dots,1\}$ under a condition on the sum of every
$2\times2$ subblock, and carries an empirical recurrence of order $20$ contributed by
R.~H.~Hardin. It is true, and it is decidable rather than empirical. The condition is local to
a bounded window of consecutive rows, so the count is a walk count on $S=100$ states and is
...
OEIS A185792 is ``Number of (n+1)X4 binary arrays with no 2X2 subblock sum equal to any horizontal or vertical neighbor 2X2 subblock sum.''. It has offset $1$ and begins
\[
100, 224, 510, 1336, 3196, 7888, 18616, 47776,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 03:11:17, revision 9) this is still
...
entry's first term is $100$, and the model reproduces it along with every later term; that
...
\begin{theorem}
\[
a(n)\;=\;a(n-3) + 64\,a(n-4) + 2\,a(n-5) - 40\,a(n-7) - 1262\,a(n-8) - 16\,a(n-9) + 4\,a(n-10) + 512\,a(n-11) + 8528\,a(n-12) - 128\,a(n-13) - 2048\,a(n-15) - 10240\,a(n-16) + 4096\,a(n-20)
\]
for every $n>21$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A185792.
