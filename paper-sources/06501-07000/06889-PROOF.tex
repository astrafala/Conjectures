...
\end{equation}
for all $n>28$. The entry's array has a fixed number of rows and a growing number of
...
index corresponding to $n=28+1$ onwards, and the run was continued past $S$ consecutive
