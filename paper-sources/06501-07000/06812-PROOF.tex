...
\title{The empirical recurrence for OEIS A316541, proved by transfer matrix}
...
\begin{abstract}
OEIS A316541 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $different from$ itself lying in $\{0,1,2,4,7,8\}$, and it carries an empirical
...
OEIS A316541 is ``Number of nX4 0..1 arrays with every element unequal to 0, 1, 2, 4, 7 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
8, 24, 53, 136, 568, 1874, 5966, 20721,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 06 2018 12:24:47, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 6\,a(n-2) + 8\,a(n-3) - 22\,a(n-4) - 78\,a(n-5) - 37\,a(n-6) + 165\,a(n-7) + 272\,a(n-8) + 4\,a(n-9) - 272\,a(n-10) - 162\,a(n-11) - 198\,a(n-12) - 557\,a(n-13) + 150\,a(n-14) + 1097\,a(n-15) + 302\,a(n-16) - 192\,a(n-17) + 80\,a(n-18) - 71\,a(n-19) - 217\,a(n-20) - 961\,a(n-21) - 322\,a(n-22) + 1046\,a(n-23) - 296\,a(n-24) + 409\,a(n-25) + 939\,a(n-26) - 1258\,a(n-27) - 418\,a(n-28) + 724\,a(n-29) - 278\,a(n-30) - 106\,a(n-31) + 314\,a(n-32) - 72\,a(n-34)
\end{equation}
for all $n>38$.
...
has score in $\{0,1,2,4,7,8\}$. The entry also fixes the top-left entry to be $0$; that is a condition on the first row alone, so it restricts the start vector and nothing else.
...
\begin{itemize}
\item $\mathbf{s}(r,s)=1$ when every cell of $r$ has score in $\{0,1,2,4,7,8\}$ \emph{with no row
above $r$} and $r_1=0$, and $0$ otherwise;
\item an edge $(r,s)\to(s,t)$ when every cell of $s$ has score in $\{0,1,2,4,7,8\}$ computed from
$r$, $s$ and $t$;
\item $\mathbf{e}(r,s)=1$ when every cell of $s$ has score in $\{0,1,2,4,7,8\}$ \emph{with no row
...
exactly when every one of its $n$ rows has all scores in $\{0,1,2,4,7,8\}$. Read the sequence as the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A316541.
