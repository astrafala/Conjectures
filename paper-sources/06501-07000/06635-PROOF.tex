...
\title{The empirical recurrence for OEIS A251944, proved by transfer matrix}
...
\begin{abstract}
OEIS A251944 counts $(n+2)\times4$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A251944 is ``Number of (n+2)X(2+2) 0..3 arrays with every 3X3 subblock row and column sum prime and every diagonal and antidiagonal sum nonprime.''. It has offset $1$ and begins
\[
2255, 1182, 1251, 2053, 3609, 7348, 14434, 29212,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 20*a(n-3) -120*a(n-6) +231*a(n-9) -249*a(n-12) +198*a(n-15) -134*a(n-18) +55*a(n-21) for n>27
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:34:03, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;20\,a(n-3) - 120\,a(n-6) + 231\,a(n-9) - 249\,a(n-12) + 198\,a(n-15) - 134\,a(n-18) + 55\,a(n-21)
\]
for every $n>27$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251944.
