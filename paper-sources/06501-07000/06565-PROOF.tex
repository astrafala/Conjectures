...
\title{The empirical recurrence for OEIS A253845, proved by transfer matrix}
...
\begin{abstract}
OEIS A253845 counts the arrays over $\{0,\dots,1\}$ whose $3\times3$ subblocks carry a
...
so the count is a walk count on $S=73624$ states --- the last two array rows together with the
...
OEIS A253845 is ``Number of (5+2)X(n+2) 0..1 arrays with every 3X3 subblock diagonal sum plus antidiagonal sum nondecreasing horizontally, vertically and ne-to-sw antidiagonally.''. It has offset $1$ and begins
\[
91296, 129378, 135280, 167413, 156876, 237202, 350208, 545216,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 14:17:51, revision 6) this is still
...
\]
on the $S=73624$ reachable states. In particular $a$ is $C$-finite. The alignment of the walk
...
\begin{theorem}
\[
a(n)\;=\;10\,a(n-1) - 47\,a(n-2) + 140\,a(n-3) - 298\,a(n-4) + 472\,a(n-5) - 532\,a(n-6) + 304\,a(n-7) + 320\,a(n-8) - 1264\,a(n-9) + 2226\,a(n-10) - 2756\,a(n-11) + 2441\,a(n-12) - 1110\,a(n-13) - 1041\,a(n-14) + 3456\,a(n-15) - 5366\,a(n-16) + 6044\,a(n-17) - 5090\,a(n-18) + 2616\,a(n-19) + 768\,a(n-20) - 4152\,a(n-21) + 6620\,a(n-22) - 7520\,a(n-23) + 6620\,a(n-24) - 4152\,a(n-25) + 768\,a(n-26) + 2616\,a(n-27) - 5090\,a(n-28) + 6044\,a(n-29) - 5366\,a(n-30) + 3456\,a(n-31) - 1041\,a(n-32) - 1110\,a(n-33) + 2441\,a(n-34) - 2756\,a(n-35) + 2226\,a(n-36) - 1264\,a(n-37) + 320\,a(n-38) + 304\,a(n-39) - 532\,a(n-40) + 472\,a(n-41) - 298\,a(n-42) + 140\,a(n-43) - 47\,a(n-44) + 10\,a(n-45) - a(n-46)
\]
for every $n>67$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253845.
