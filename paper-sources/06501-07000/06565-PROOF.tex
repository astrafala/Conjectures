...
\title{The empirical recurrence for OEIS A252205, proved by transfer matrix}
...
\begin{abstract}
OEIS A252205 counts $(n+2)\times5$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252205 is ``Number of (n+2)X(3+2) 0..3 arrays with every 3X3 subblock row and column sum equal to 1 3 4 6 or 7 and every 3X3 diagonal and antidiagonal sum not equal to 1 3 4 6 or 7.''. It has offset $1$ and begins
\[
9312, 17276, 110128, 332462, 2908856, 22430534, 65275092, 634915114,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 10:56:01, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;454\,a(n-3) - 60039\,a(n-6) + 2444346\,a(n-9) - 12981624\,a(n-12) + 14332416\,a(n-15) + 13041664\,a(n-18) - 16777216\,a(n-21)
\]
for every $n>24$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252205.
