...
\title{The empirical recurrence for OEIS A252150, proved by transfer matrix}
...
\begin{abstract}
OEIS A252150 counts $(n+2)\times3$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252150 is ``Number of (n+2)X(1+2) 0..3 arrays with every 3X3 subblock row and column sum not equal to 0 1 3 6 or 7 and every 3X3 diagonal and antidiagonal sum equal to 0 1 3 6 or 7.''. It has offset $1$ and begins
\[
1254, 1945, 2591, 3583, 5577, 8309, 13146, 20950,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 10:52:04, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;-a(n-1) + 3\,a(n-2) + 20\,a(n-3) + 21\,a(n-4) - 43\,a(n-5) - 183\,a(n-6) - 208\,a(n-7) + 228\,a(n-8) + 1000\,a(n-9) + 1261\,a(n-10) - 415\,a(n-11) - 3512\,a(n-12) - 5043\,a(n-13) - 1010\,a(n-14) + 7890\,a(n-15) + 13542\,a(n-16) + 7317\,a(n-17) - 10576\,a(n-18) - 24299\,a(n-19) - 18319\,a(n-20) + 6938\,a(n-21) + 28756\,a(n-22) + 24462\,a(n-23) - 2073\,a(n-24) - 23377\,a(n-25) - 15656\,a(n-26) + 9200\,a(n-27) + 19112\,a(n-28) - 1021\,a(n-29) - 27441\,a(n-30) - 24855\,a(n-31) + 8844\,a(n-32) + 37880\,a(n-33) + 29336\,a(n-34) - 7180\,a(n-35) - 30749\,a(n-36) - 19351\,a(n-37) + 7896\,a(n-38) + 17119\,a(n-39) + 2274\,a(n-40) - 12971\,a(n-41) - 9260\,a(n-42) + 7017\,a(n-43) + 14389\,a(n-44) + 6195\,a(n-45) - 6149\,a(n-46) - 8849\,a(n-47) - 2681\,a(n-48) + 2643\,a(n-49) + 2309\,a(n-50) - 618\,a(n-51) - 1335\,a(n-52) + 104\,a(n-53) + 1366\,a(n-54) + 1020\,a(n-55) - 64\,a(n-56) - 598\,a(n-57) - 412\,a(n-58) - 24\,a(n-59) + 84\,a(n-60) + 48\,a(n-61)
\]
for every $n>82$.
\end{theorem}
...
exactly. Those integers vanish from the index corresponding to $n=82+1$ onwards, and the
run was continued until the working vector was identically zero, which settles all larger $j$
at once. By Lemma~\ref{lem:crit} the recurrence holds for every $n>82$.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252150.
