...
\title{The empirical recurrence for OEIS A250440, proved by transfer matrix}
...
\begin{abstract}
OEIS A250440 counts arrays over $\{0,1,2\}$ in which a statistic taken over short runs
...
window of consecutive rows, so the count is a walk count on $S=10000$ states, and the
...
OEIS A250440 is ``Number of (n+1)X(5+1) 0..2 arrays with nondecreasing sum of every two consecutive values in every row and column.''. It has offset $1$ and begins
\[
10000, 250000, 6250000, 76562500, 937890625, 7353062500, 57648010000, 332052537600,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 12:25:02, revision 6) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=10000,
\]
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 22\,a(n-2) - 46\,a(n-3) - 230\,a(n-4) + 506\,a(n-5) + 1518\,a(n-6) - 3542\,a(n-7) - 7084\,a(n-8) + 17710\,a(n-9) + 24794\,a(n-10) - 67298\,a(n-11) - 67298\,a(n-12) + 201894\,a(n-13) + 144210\,a(n-14) - 490314\,a(n-15) - 245157\,a(n-16) + 980628\,a(n-17) + 326876\,a(n-18) - 1634380\,a(n-19) - 326876\,a(n-20) + 2288132\,a(n-21) + 208012\,a(n-22) - 2704156\,a(n-23) + 2704156\,a(n-25) - 208012\,a(n-26) - 2288132\,a(n-27) + 326876\,a(n-28) + 1634380\,a(n-29) - 326876\,a(n-30) - 980628\,a(n-31) + 245157\,a(n-32) + 490314\,a(n-33) - 144210\,a(n-34) - 201894\,a(n-35) + 67298\,a(n-36) + 67298\,a(n-37) - 24794\,a(n-38) - 17710\,a(n-39) + 7084\,a(n-40) + 3542\,a(n-41) - 1518\,a(n-42) - 506\,a(n-43) + 230\,a(n-44) + 46\,a(n-45) - 22\,a(n-46) - 2\,a(n-47) + a(n-48)
\]
for every $n>48$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250440.
