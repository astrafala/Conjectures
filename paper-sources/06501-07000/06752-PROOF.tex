...
\title{The empirical recurrence for OEIS A241331, proved by transfer matrix}
...
\begin{abstract}
OEIS A241331 counts $4\times n$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A241331 is ``Number of 4Xn 0..3 arrays with no element equal to fewer vertical neighbors than horizontal neighbors, with new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
15, 1030, 95144, 8949808, 842185933, 79254376889, 7458275852500, 701865426977495,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 11:12:49, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;122\,a(n-1) - 2812\,a(n-2) + 16208\,a(n-3) + 159379\,a(n-4) - 2909948\,a(n-5) + 19694228\,a(n-6) - 62373244\,a(n-7) - 58088806\,a(n-8) + 1439148868\,a(n-9) - 5096351523\,a(n-10) - 3055067884\,a(n-11) + 59968811184\,a(n-12) - 73039493422\,a(n-13) - 301989142269\,a(n-14) + 945040962120\,a(n-15) - 745735386949\,a(n-16) - 844626880720\,a(n-17) + 2521153036681\,a(n-18) - 1929013979294\,a(n-19) - 1045472186222\,a(n-20) + 1583296164696\,a(n-21) + 1956836924036\,a(n-22) - 2355373350354\,a(n-23) - 3690081020076\,a(n-24) + 7567309408680\,a(n-25) - 2089000784295\,a(n-26) - 4919238685854\,a(n-27) + 4312880045136\,a(n-28) - 566304913242\,a(n-29) - 920941508979\,a(n-30) + 911638855890\,a(n-31) - 424728198324\,a(n-32) - 322761834\,a(n-33) + 96291263349\,a(n-34) - 53052692148\,a(n-35) + 11321287623\,a(n-36)
\]
for every $n>38$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A241331.
