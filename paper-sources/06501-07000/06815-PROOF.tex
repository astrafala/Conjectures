...
\title{The empirical recurrence for OEIS A261287, proved by transfer matrix}
...
\begin{abstract}
OEIS A261287 counts $(n+2)\times5$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A261287 is ``Number of (n+2)X(3+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000001 00010101 or 01010101.''. It has offset $1$ and begins
\[
96, 133, 271, 504, 1086, 2104, 4715, 9080,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 14 2015 07:14:25, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-2) + 9\,a(n-4) + 4\,a(n-6) - 4\,a(n-8) + 6\,a(n-10) - 8\,a(n-12) - a(n-16) + 3\,a(n-18) + 4\,a(n-20) - 4\,a(n-22)
\]
for every $n>26$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A261287.
