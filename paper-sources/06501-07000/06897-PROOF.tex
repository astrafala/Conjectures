...
\title{The empirical recurrence for OEIS A197245, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A197245 counts arrays over $\{0,\dots,4\}$ in which every cell is constrained by the
...
OEIS A197245 is ``Number of nX3 0..4 arrays with each element x equal to the number its horizontal and vertical neighbors equal to 0,0,1,1,1 for x=0,1,2,3,4.''. It has offset $1$ and begins
\[
1, 8, 3, 53, 110, 227, 1035, 2004,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 07:04:49, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-2) + 9\,a(n-3) + 26\,a(n-4) + 58\,a(n-5) - 25\,a(n-6) - 148\,a(n-7) - 104\,a(n-8) - 114\,a(n-9) + 55\,a(n-10) - 149\,a(n-11) + 186\,a(n-12) - 9\,a(n-13) + 39\,a(n-14) - 55\,a(n-15) + 21\,a(n-16) + a(n-17) + 2\,a(n-18) - a(n-19)
\end{equation}
for all $n>20$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A197245.
