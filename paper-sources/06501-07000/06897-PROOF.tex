...
\title{The empirical recurrence for OEIS A261707, proved by transfer matrix}
...
\begin{abstract}
OEIS A261707 counts $(n+2)\times6$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A261707 is ``Number of (n+2) X (4+2) 0..1 arrays with each 3 X 3 subblock having clockwise perimeter pattern 00000001 00000101 or 00000111.''. It has offset $1$ and begins
\[
338, 462, 662, 675, 734, 1443, 1416, 1486,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-7) +5*a(n-10) +a(n-13) -a(n-14) -a(n-17) -2*a(n-21) for n>27.
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 16 2021 21:30:27, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A261707.
