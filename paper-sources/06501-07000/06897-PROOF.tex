...
\title{The empirical recurrence for OEIS A253530, proved by transfer matrix}
...
\begin{abstract}
OEIS A253530 counts the arrays over $\{0,\dots,2\}$ whose $2\times2$ subblocks carry a
...
so a pair of consecutive array rows is a state, the count is a walk count on $S=25165$ of them,
...
OEIS A253530 is ``Number of (n+1)X(5+1) 0..2 arrays with every 2X2 subblock antidiagonal maximum minus diagonal minimum nondecreasing horizontally and diagonal maximum minus antidiagonal minimum nondecreasing vertically.''. It has offset $1$ and begins
\[
25165, 71333, 142679, 398710, 745281, 1744459, 3362641, 7208222,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 14:06:23, revision 6) this is still
...
\]
on the $S=25165$ admissible pairs. In particular $a$ is $C$-finite. The alignment of the walk
...
\begin{theorem}
\[
a(n)\;=\;12\,a(n-1) - 58\,a(n-2) + 126\,a(n-3) - 15\,a(n-4) - 558\,a(n-5) + 1166\,a(n-6) - 324\,a(n-7) - 2362\,a(n-8) + 3760\,a(n-9) - 420\,a(n-10) - 4940\,a(n-11) + 5330\,a(n-12) + 300\,a(n-13) - 4900\,a(n-14) + 3568\,a(n-15) + 459\,a(n-16) - 2156\,a(n-17) + 1182\,a(n-18) + 30\,a(n-19) - 339\,a(n-20) + 178\,a(n-21) - 42\,a(n-22) + 4\,a(n-23)
\]
for every $n>40$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253530.
