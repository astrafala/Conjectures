...
\title{The empirical recurrence for OEIS A237724, proved by transfer matrix}
...
\begin{abstract}
OEIS A237724 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
OEIS A237724 is ``Number of (n+1)X(2+1) 0..2 arrays with the maximum plus the upper median minus the lower median of every 2X2 subblock differing from its horizontal and vertical neighbors by exactly one.''. It has offset $1$ and begins
\[
348, 2152, 13496, 86010, 542946, 3412698, 21521906, 136316506,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 10:23:14, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;66\,a(n-3) + 903\,a(n-4) + 1628\,a(n-5) + 4020\,a(n-6) - 3173\,a(n-7) - 98477\,a(n-8) - 153617\,a(n-9) + 15724\,a(n-10) + 83098\,a(n-11) + 20571\,a(n-12) + 3764\,a(n-13) + 88351\,a(n-14) + 8583\,a(n-15) - 32804\,a(n-16) + 10471\,a(n-17) - 15241\,a(n-18) - 3432\,a(n-19) + 809\,a(n-20) - 2856\,a(n-21) + 1062\,a(n-22)
\]
for every $n>24$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237724.
