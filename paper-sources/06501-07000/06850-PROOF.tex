...
\title{The empirical recurrence for OEIS A252071, proved by transfer matrix}
...
\begin{abstract}
OEIS A252071 counts $(n+2)\times6$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A252071 is ``Number of (n+2) X (4+2) 0..2 arrays with every 3X3 subblock row, column, diagonal and antidiagonal sum not equal to 0 3 or 4.''. It has offset $1$ and begins
\[
375, 1135, 5085, 21862, 92225, 391934, 1669294, 7114867,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 14 2025 07:47:37, revision 11) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252071.
