...
\title{The empirical recurrence for OEIS A220592, proved by transfer matrix}
...
\begin{abstract}
OEIS A220592 counts the ways of linking the cells of a grid $4$ cells wide, each cell either to
...
OEIS A220592 is ``Number of ways to reciprocally link elements of an n X 4 array either to themselves or to exactly two king-move neighbors.''. It has offset $1$ and begins
\[
1, 155, 6156, 308246, 14637699, 702811381, 33667621356, 1613595307718,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 13 2026 12:03:16, revision 10) this is still
...
\begin{theorem}
\[
a(n)\;=\;40\,a(n-1) + 395\,a(n-2) - 769\,a(n-3) + 2095\,a(n-4) - 16049\,a(n-5) - 71697\,a(n-6) - 119950\,a(n-7) + 1037497\,a(n-8) - 139363\,a(n-9) - 1979661\,a(n-10) + 1507756\,a(n-11) + 1041993\,a(n-12) - 2247051\,a(n-13) + 1215317\,a(n-14) - 16637\,a(n-15) - 311055\,a(n-16) + 67983\,a(n-17) + 54951\,a(n-18) - 4355\,a(n-19) - 9884\,a(n-20) + 766\,a(n-21) + 683\,a(n-22) - 103\,a(n-23) - 9\,a(n-24) + 2\,a(n-25)
\]
for every $n>24$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A220592.
