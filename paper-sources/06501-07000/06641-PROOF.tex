...
\title{The empirical recurrence for OEIS A252576, proved by transfer matrix}
...
\begin{abstract}
OEIS A252576 counts $4\times(n+2)$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252576 is ``Number of (2+2)X(n+2) 0..3 arrays with every 3X3 subblock row and diagonal sum equal to 1 2 5 6 or 7 and every 3X3 column and antidiagonal sum not equal to 1 2 5 6 or 7.''. It has offset $1$ and begins
\[
742, 868, 1795, 3441, 8980, 23007, 47737, 133142,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:24:05, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;42\,a(n-3) - 595\,a(n-6) + 3251\,a(n-9) - 5703\,a(n-12) + 8191\,a(n-15) - 8486\,a(n-18) + 5741\,a(n-21) - 3340\,a(n-24) + 900\,a(n-27)
\]
for every $n>34$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252576.
