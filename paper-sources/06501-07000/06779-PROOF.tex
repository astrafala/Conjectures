...
\title{The empirical recurrence for OEIS A234791, proved by transfer matrix}
...
\begin{abstract}
OEIS A234791 counts arrays of width $4$ over $\{0,1,2,3\}$ subject to a condition read round the
...
count is a walk count on a finite digraph with $S=257$ vertices, and whether a linear
...
OEIS A234791 is ``Number of (n+1)X(3+1) 0..3 arrays with each 2X2 subblock having the number of clockwise edge increases less than or equal to the number of counterclockwise edge increases.''. It has offset $1$ and begins
\[
30536, 3015344, 280996212, 25695321008, 2334950105532, 211733037460400, 19186434495264308, 1738191883121101472,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 08:27:11, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;174\,a(n-1) - 10322\,a(n-2) + 299192\,a(n-3) - 4916088\,a(n-4) + 49495654\,a(n-5) - 320524051\,a(n-6) + 1381581872\,a(n-7) - 4047000461\,a(n-8) + 7991340866\,a(n-9) - 9739200284\,a(n-10) + 4224246488\,a(n-11) + 8026590994\,a(n-12) - 17876492846\,a(n-13) + 17714584733\,a(n-14) - 10616721904\,a(n-15) + 4045200724\,a(n-16) - 893202136\,a(n-17) + 59914260\,a(n-18) - 25923040\,a(n-19) + 42766000\,a(n-20) - 12448000\,a(n-21)
\]
for every $n>19$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234791.
