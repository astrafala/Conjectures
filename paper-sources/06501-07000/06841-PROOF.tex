...
\title{The empirical recurrence for OEIS A220734, proved by transfer matrix}
...
\begin{abstract}
OEIS A220734 counts the ways of linking the cells of a grid $4$ cells wide, each cell either to
...
OEIS A220734 is ``Number of ways to reciprocally link elements of an nX4 array either to themselves or to exactly two horizontal, diagonal and antidiagonal neighbors, without consecutive collinear links.''. It has offset $1$ and begins
\[
1, 13, 103, 712, 5760, 45421, 355883, 2807273,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 19:01:14, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;9\,a(n-1) - 4\,a(n-2) - 23\,a(n-3) - 153\,a(n-4) + 204\,a(n-5) + 564\,a(n-6) - 700\,a(n-7) + 95\,a(n-8) + 2061\,a(n-9) - 3000\,a(n-10) - 4459\,a(n-11) + 2151\,a(n-12) + 5800\,a(n-13) + 320\,a(n-14) - 1276\,a(n-15) - 925\,a(n-16) + 233\,a(n-17) + 48\,a(n-18) + 13\,a(n-19) - a(n-20)
\]
for every $n>19$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A220734.
