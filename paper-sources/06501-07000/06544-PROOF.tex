...
\title{The empirical recurrence for OEIS A254583, proved by transfer matrix}
...
\begin{abstract}
OEIS A254583 counts the arrays over $\{0,\dots,1\}$ whose $3\times3$ subblocks carry a
...
so the count is a walk count on $S=36047$ states --- the last two array rows together with the
...
OEIS A254583 is ``Number of (n+2)X(5+2) 0..1 arrays with every 3X3 subblock sum of the two medians of the central row and the central column and the two maximums of the diagonal and antidiagonal nondecreasing horizontally, vertically and ne-to-sw antidiagonally.''. It has offset $1$ and begins
\[
332330, 3083065, 45867931, 613720640, 7610621332, 96984109170, 1242236438386, 15846867693636,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 14:51:07, revision 6) this is still
...
\]
on the $S=36047$ reachable states. In particular $a$ is $C$-finite. The alignment of the walk
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) + 36\,a(n-2) + 586\,a(n-3) + 1870\,a(n-4) - 7096\,a(n-5) - 68287\,a(n-6) - 422500\,a(n-7) - 100964\,a(n-8) + 7219900\,a(n-9) + 25866956\,a(n-10) + 19857152\,a(n-11) - 353526399\,a(n-12) - 1191439170\,a(n-13) + 1727044172\,a(n-14) + 10143478250\,a(n-15) - 399198586\,a(n-16) - 34745727656\,a(n-17) - 22239862209\,a(n-18) + 23155580224\,a(n-19) + 42379877972\,a(n-20) + 153063587856\,a(n-21) + 105846149632\,a(n-22) - 351123642944\,a(n-23) - 276225752576\,a(n-24) + 144721758976\,a(n-25) - 244435668992\,a(n-26) + 142563325952\,a(n-27) + 515080914944\,a(n-28) - 63535329280\,a(n-29) + 590207082496\,a(n-30) + 168482045952\,a(n-31) - 387089498112\,a(n-32) - 29854138368\,a(n-33) - 319326519296\,a(n-34) - 127765839872\,a(n-35) - 15464398848\,a(n-36) - 33940307968\,a(n-37) + 10267656192\,a(n-38)
\]
for every $n>46$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A254583.
