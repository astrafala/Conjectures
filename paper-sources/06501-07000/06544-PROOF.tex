...
\title{The empirical recurrence for OEIS A249081, proved by transfer matrix}
...
\begin{abstract}
OEIS A249081 carries an empirical recurrence of order $40$ contributed by R.~H.~Hardin. It is
...
OEIS A249081 is ``Number of length n+5 0..4 arrays with every six consecutive terms having two times the sum of some two elements equal to the sum of the remaining four.''. It has offset $1$ and begins
\[
5005, 8805, 15493, 27213, 47645, 83045, 143925, 263405,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 11:50:38, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) - a(n-4) + a(n-5) + 61\,a(n-6) - 122\,a(n-7) - 2\,a(n-8) + 62\,a(n-10) - 60\,a(n-11) - 1181\,a(n-12) + 2361\,a(n-13) + 120\,a(n-14) + a(n-15) - 1241\,a(n-16) + 1120\,a(n-17) + 8860\,a(n-18) - 17660\,a(n-19) - 2240\,a(n-20) - 60\,a(n-21) + 9980\,a(n-22) - 7680\,a(n-23) - 25184\,a(n-24) + 49248\,a(n-25) + 15360\,a(n-26) + 1120\,a(n-27) - 32864\,a(n-28) + 16384\,a(n-29) + 24064\,a(n-30) - 40448\,a(n-31) - 32768\,a(n-32) - 7680\,a(n-33) + 40448\,a(n-34) - 16384\,a(n-36) + 16384\,a(n-37) + 16384\,a(n-39) - 16384\,a(n-40)
\]
for every $n>45$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A249081.
