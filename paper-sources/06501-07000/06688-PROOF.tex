...
\title{The empirical recurrence for OEIS A304423, proved by transfer matrix}
...
\begin{abstract}
OEIS A304423 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $different from$ itself lying in $\{1,2,3,4,5\}$, and it carries an empirical
...
OEIS A304423 is ``Number of nX4 0..1 arrays with every element unequal to 1, 2, 3, 4 or 5 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
2, 98, 836, 9304, 98190, 1043316, 11085965, 117776344,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 12 2018 09:36:10, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;7\,a(n-1) + 48\,a(n-2) - 12\,a(n-3) - 721\,a(n-4) - 2134\,a(n-5) - 2589\,a(n-6) + 1722\,a(n-7) + 7674\,a(n-8) + 10350\,a(n-9) + 4698\,a(n-10) - 1865\,a(n-11) - 5462\,a(n-12) - 2001\,a(n-13) - 4274\,a(n-14) - 7320\,a(n-15) - 6688\,a(n-16) - 1106\,a(n-17) + 2603\,a(n-18) + 631\,a(n-19) + 1682\,a(n-20) + 357\,a(n-21) + 1545\,a(n-22) - 138\,a(n-23) - 106\,a(n-24) - 73\,a(n-25) + 61\,a(n-26) + 20\,a(n-27)
\end{equation}
for all $n>28$.
...
has score in $\{1,2,3,4,5\}$. The entry also fixes the top-left entry to be $0$; that is a condition on the first row alone, so it restricts the start vector and nothing else.
...
\begin{itemize}
\item $\mathbf{s}(r,s)=1$ when every cell of $r$ has score in $\{1,2,3,4,5\}$ \emph{with no row
above $r$} and $r_1=0$, and $0$ otherwise;
\item an edge $(r,s)\to(s,t)$ when every cell of $s$ has score in $\{1,2,3,4,5\}$ computed from
$r$, $s$ and $t$;
\item $\mathbf{e}(r,s)=1$ when every cell of $s$ has score in $\{1,2,3,4,5\}$ \emph{with no row
...
exactly when every one of its $n$ rows has all scores in $\{1,2,3,4,5\}$. Read the sequence as the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A304423.
