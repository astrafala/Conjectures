...
\title{The empirical recurrence for OEIS A254972, proved by transfer matrix}
...
\begin{abstract}
OEIS A254972 counts $(n+2)\times4$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A254972 is ``Number of (n+2)X(2+2) 0..1 arrays with no 3x3 subblock diagonal sum 0 or 1 and no antidiagonal sum 0 or 1 and no row sum 0 and no column sum 0.''. It has offset $1$ and begins
\[
310, 1282, 6915, 27211, 116534, 518534, 2243657, 9685030,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:35:05, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 10\,a(n-2) + 16\,a(n-3) - 29\,a(n-4) - 158\,a(n-5) - 102\,a(n-6) + 260\,a(n-7) + 509\,a(n-8) + 114\,a(n-9) - 417\,a(n-10) - 430\,a(n-11) - 123\,a(n-12) + 59\,a(n-13) + 142\,a(n-14) + 131\,a(n-15) - 21\,a(n-16) - 10\,a(n-17) + 6\,a(n-18) - 2\,a(n-20)
\]
for every $n>22$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A254972.
