...
\title{The empirical recurrence for OEIS A235901, proved by transfer matrix}
...
\begin{abstract}
OEIS A235901 counts arrays of width $8$ over $\{0,1,2\}$ in which the smallest and largest of the
...
wider, so the count is a walk count on $S=6561$ states.
\end{abstract}
...
OEIS A235901 is ``Number of (n+1)X(7+1) 0..2 arrays with the minimum plus the maximum equal to the lower median plus the upper median in every 2X2 subblock.''. It has offset $1$ and begins
\[
100457, 2633969, 51386977, 1221438401, 26681279873, 632701301249, 14843231431681, 363748742848769,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 08:55:07, revision 6) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The arrays have $8$ columns and a growing number of rows, with entries in $\{0,1,2\}$. Take any
...
of the $8-1$ blocks spanning the two rows satisfies the condition.
...
$\mathbf{1}$, and the states are all $3^{8}=6561$ rows. Thus
\[
...
\begin{theorem}
\[
a(n)\;=\;105\,a(n-1) - 2912\,a(n-2) - 48360\,a(n-3) + 3284176\,a(n-4) - 9849840\,a(n-5) - 1413681152\,a(n-6) + 11064890880\,a(n-7) + 342354927616\,a(n-8) - 2914586849280\,a(n-9) - 53197229588480\,a(n-10) + 326026026024960\,a(n-11) + 5257932711133184\,a(n-12) - 9378006313205760\,a(n-13) - 253932398608121856\,a(n-14) - 671129571038330880\,a(n-15)
\]
for every $n>14$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A235901.
