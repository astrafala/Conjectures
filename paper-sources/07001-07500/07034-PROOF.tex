...
\title{The empirical recurrence for OEIS A236713, proved by transfer matrix}
...
\begin{abstract}
OEIS A236713 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
The condition is local to two consecutive rows, so the count is a walk count on $S=398$
...
OEIS A236713 is ``Number of (n+1)X(2+1) 0..2 arrays colored with the maximum plus the lower median of every 2X2 subblock.''. It has offset $1$ and begins
\[
398, 2262, 12276, 68906, 391672, 2259386, 12874198, 73197080,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 09:28:33, revision 6) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The $2\times2$ subblocks of an $(n+1)\times3$ array form an
$n\times2$ grid. Colour each of them by $\sigma=b+d$, where $a\le b\le c\le d$ are its four entries sorted --- its minimum, lower median, upper median and maximum. ``Coloured with'' is the entry's way of
...
\]
over the $S=398$ pairs whose own subblock row is properly coloured.
...
\begin{theorem}
\[
a(n)\;=\;75\,a(n-3) + 429\,a(n-4) + 897\,a(n-5) + 2057\,a(n-6) - 888\,a(n-7) - 8682\,a(n-8) - 14634\,a(n-9) - 20920\,a(n-10) + 12981\,a(n-11) + 9538\,a(n-12) - 11151\,a(n-13) + 92172\,a(n-14) + 24265\,a(n-15) + 109712\,a(n-16) + 362941\,a(n-17) - 258335\,a(n-18) - 1201467\,a(n-19) - 103220\,a(n-20) + 1386852\,a(n-21) + 424193\,a(n-22) - 333799\,a(n-23) - 68373\,a(n-24) + 164001\,a(n-25) + 390188\,a(n-26) - 504798\,a(n-27) - 533076\,a(n-28) + 591269\,a(n-29) + 238719\,a(n-30) - 346836\,a(n-31) - 97052\,a(n-32) + 11666\,a(n-33) - 23198\,a(n-34) - 4960\,a(n-35) - 260\,a(n-36)
\]
for every $n>38$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A236713.
