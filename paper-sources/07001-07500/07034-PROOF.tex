...
\title{The empirical recurrence for OEIS A197396, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A197396 counts arrays over $\{0,\dots,4\}$ in which every cell is constrained by the
...
OEIS A197396 is ``Number of nX3 0..4 arrays with each element x equal to the number its horizontal and vertical neighbors equal to 3,3,1,1,1 for x=0,1,2,3,4.''. It has offset $1$ and begins
\[
1, 9, 17, 81, 257, 1003, 3417, 12673,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 07:10:43, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 2\,a(n-2) + 8\,a(n-3) + 50\,a(n-4) + 65\,a(n-5) + 125\,a(n-6) - 4\,a(n-7) - 330\,a(n-8) - 596\,a(n-9) - 2336\,a(n-10) - 1872\,a(n-11) + 712\,a(n-12) + 520\,a(n-13) + 4176\,a(n-14) + 4400\,a(n-15) - 1728\,a(n-16) - 384\,a(n-17)
\end{equation}
for all $n>18$.
...
\#\{\text{neighbours with value }f(x_{t,u})\}=x_{t,u},\quad f=(3,3,1,1,1)
\end{equation}
for every cell $(t,u)$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A197396.
