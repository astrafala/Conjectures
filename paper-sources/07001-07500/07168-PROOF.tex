...
\title{The empirical recurrence for OEIS A281323, proved by transfer matrix}
...
\begin{abstract}
OEIS A281323 counts $n\times5$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A281323 is ``Number of n X 5 0..2 arrays with no element equal to more than one of its horizontal and antidiagonal neighbors, with the exception of exactly one element, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
8, 3102, 350818, 31906806, 2628860468, 204635003232, 15351923549506, 1122266386967854,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 09 2023 21:30:34, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;118\,a(n-1) - 2945\,a(n-2) - 33362\,a(n-3) + 26056\,a(n-4) + 748350\,a(n-5) + 34803\,a(n-6) - 5091278\,a(n-7) + 5510971\,a(n-8) + 3636892\,a(n-9) - 50799348\,a(n-10) + 55421328\,a(n-11) - 83423360\,a(n-12) + 24617536\,a(n-13) - 57226304\,a(n-14) - 611072\,a(n-15) - 12054784\,a(n-16)
\]
for every $n>18$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A281323.
