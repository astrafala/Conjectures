...
\title{The empirical recurrence for OEIS A204495, proved by transfer matrix}
...
\begin{abstract}
OEIS A204495 counts $(n+2)\times4$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A204495 is ``Number of (n+2)X4 0..2 arrays with every 3X3 subblock having three strictly increasing elements in a row horizontally or vertically.''. It has offset $1$ and begins
\[
46458, 339311, 3418839, 42736635, 493398441, 5506995671, 66134172894, 768258278406,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 11:16:19, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;9\,a(n-2) + 1405\,a(n-3) + 2925\,a(n-4) + 6676\,a(n-5) - 315819\,a(n-6) - 582759\,a(n-7) - 2320546\,a(n-8) - 613964\,a(n-9) + 16534602\,a(n-10) - 12987012\,a(n-11) + 15797781\,a(n-12) - 25549283\,a(n-13) + 5663538\,a(n-14) + 193388303\,a(n-15) - 477536947\,a(n-16) - 1077296979\,a(n-17) - 963971811\,a(n-18) + 1280340738\,a(n-19) + 4051514280\,a(n-20) + 5191083054\,a(n-21) + 4483557189\,a(n-22) - 1878151860\,a(n-23) + 13962072870\,a(n-24) + 10044741798\,a(n-25) + 25543012554\,a(n-26) + 1081615842\,a(n-27) + 23527011168\,a(n-28) + 2023727328\,a(n-29)
\]
for every $n>32$.
\end{theorem}
...
exactly. Those integers vanish from the index corresponding to $n=32+1$ onwards, and the
run was continued until the working vector was identically zero, which settles all larger $j$
at once. By Lemma~\ref{lem:crit} the recurrence holds for every $n>32$.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204495.
