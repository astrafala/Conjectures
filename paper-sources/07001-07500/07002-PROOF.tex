...
\title{The empirical recurrence for OEIS A196783, proved by transfer matrix}
...
\begin{abstract}
OEIS A196783 counts $n\times5$ arrays over $\{0,\dots,4\}$ subject to a condition imposed on
...
walk, and $a(n)$ is a walk count on $S=5915$ vertices, which is $C$-finite. Whether the
...
OEIS A196783 is ``Number of nX5 0..4 arrays with each element x equal to the number its horizontal and vertical neighbors equal to 2,4,3,0,1 for x=0,1,2,3,4.''. It has offset $1$ and begins
\[
1, 17, 135, 797, 6137, 40749, 289761, 2025511,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 06:44:38, revision 9) this is still
...
settled by the terminal weight, which evaluates it with $\varnothing$ below. Most of those pairs are indistinguishable, and exactly so. Every offset named above has $|dj|\le 1$, so whether the cell at column $j$ of the middle row is satisfied depends on the three rows only through their windows at $j-1,j,j+1$. Collect for each $j$ the indicator over the window of the row below, and call that tuple $P(r,s)$: the number of cells any $t$ violates is read off $P$, so is the number violated at the bottom edge, and the successor $(s,t)$ carries $P(s,t)$, which does not mention $r$. Hence two pairs $(r,s)$ and $(r',s)$ with the same $P$ have the same outgoing rows and the same successors, and the vertex is $(s,P)$. That leaves $S=5915$ vertices in place of $9765625$. Hence,
with $M$ the adjacency matrix on $S=5915$ vertices, $\iota$ the starting vector and $\tau$ the
terminal weight,
\[
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 18\,a(n-2) + 75\,a(n-3) + 214\,a(n-4) + 573\,a(n-5) + 1067\,a(n-6) + 496\,a(n-7) - 6999\,a(n-8) - 22187\,a(n-9) - 27738\,a(n-10) - 36490\,a(n-11) + 38397\,a(n-12) + 191499\,a(n-13) + 139688\,a(n-14) + 174635\,a(n-15) + 145499\,a(n-16) - 220926\,a(n-17) - 251717\,a(n-18) - 362124\,a(n-19) - 163792\,a(n-20) + 83311\,a(n-21) - 300598\,a(n-22) + 162970\,a(n-23) - 92220\,a(n-24) + 10134\,a(n-25) - 10370\,a(n-26) - 8340\,a(n-27) + 8044\,a(n-28) - 432\,a(n-29) + 448\,a(n-30) - 128\,a(n-31)
\]
for every $n>31$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A196783.
