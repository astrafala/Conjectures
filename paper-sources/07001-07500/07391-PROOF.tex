...
\title{The empirical recurrence for OEIS A279853, proved by transfer matrix}
...
\begin{abstract}
OEIS A279853 counts $n\times4$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A279853 is ``Number of nX4 0..2 arrays with no element unequal to a strict majority of its horizontal and vertical neighbors, with the exception of exactly one element, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
2, 24, 168, 972, 5200, 26632, 134898, 668668,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 20 2016 10:53:06, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;16\,a(n-1) - 96\,a(n-2) + 234\,a(n-3) + 74\,a(n-4) - 1878\,a(n-5) + 5053\,a(n-6) - 6092\,a(n-7) - 1433\,a(n-8) + 20562\,a(n-9) - 43095\,a(n-10) + 59066\,a(n-11) - 74667\,a(n-12) + 116460\,a(n-13) - 201487\,a(n-14) + 270314\,a(n-15) - 234247\,a(n-16) + 69548\,a(n-17) + 147085\,a(n-18) - 260796\,a(n-19) + 309393\,a(n-20) - 437158\,a(n-21) + 682254\,a(n-22) - 940810\,a(n-23) + 842002\,a(n-24) - 383734\,a(n-25) - 172142\,a(n-26) + 689424\,a(n-27) - 853200\,a(n-28) + 709896\,a(n-29) - 491572\,a(n-30) + 247956\,a(n-31) - 95569\,a(n-32) + 32832\,a(n-33) - 3312\,a(n-34) - 624\,a(n-35) + 192\,a(n-36) - 384\,a(n-37) - 64\,a(n-38)
\]
for every $n>41$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A279853.
