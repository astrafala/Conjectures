...
\title{The empirical recurrence for OEIS A249702, proved by transfer matrix}
...
\begin{abstract}
OEIS A249702 carries an empirical recurrence of order $17$ contributed by R.~H.~Hardin. It is
...
OEIS A249702 is ``Number of length n+3 0..3 arrays with every four consecutive terms having the maximum of some two terms equal to the minimum of the remaining two terms.''. It has offset $1$ and begins
\[
100, 208, 440, 896, 1724, 3440, 7056, 14544,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 12:05:57, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) - a(n-2) + 12\,a(n-4) - 10\,a(n-5) - 41\,a(n-8) - 6\,a(n-9) - 2\,a(n-10) + 2\,a(n-11) + 44\,a(n-12) + 36\,a(n-13) + 16\,a(n-14) - 24\,a(n-16) - 24\,a(n-17)
\]
for every $n>19$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A249702.
