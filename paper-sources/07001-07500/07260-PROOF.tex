...
\title{The empirical recurrence for OEIS A236635, proved by transfer matrix}
...
\begin{abstract}
OEIS A236635 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
The condition is local to two consecutive rows, so the count is a walk count on $S=81$
...
OEIS A236635 is ``Number of (n+1)X(1+1) 0..2 arrays colored with the maximum plus the upper median plus the minimum of every 2X2 subblock.''. It has offset $1$ and begins
\[
81, 474, 2796, 16588, 98368, 582304, 3448740, 20433016,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 09:23:27, revision 7) this is still
...
\]
over the $S=81$ pairs whose own subblock row is properly coloured.
...
\begin{theorem}
\[
a(n)\;=\;50\,a(n-3) + 505\,a(n-4) + 1446\,a(n-5) + 4968\,a(n-6) + 9904\,a(n-7) + 2968\,a(n-8) - 14344\,a(n-9) - 107140\,a(n-10) - 262208\,a(n-11) - 282860\,a(n-12) - 257912\,a(n-13) + 344240\,a(n-14) + 1446208\,a(n-15) + 1594752\,a(n-16) + 1353472\,a(n-17) + 397312\,a(n-18) - 1295360\,a(n-19) - 1280000\,a(n-20) - 319488\,a(n-21)
\]
for every $n>21$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A236635.
