...
\title{The empirical recurrence for OEIS A207695, proved by transfer matrix}
...
\begin{abstract}
OEIS A207695 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
$(0,0,1), (1,1,1)$ along one axis and $(0,0,0), (0,1,0)$ along the other, and carries an empirical recurrence of
order $36$ contributed by R.~H.~Hardin. It is true. The patterns have length $3$, so
...
$\mathbf{1}^{\!\top}P^{\,n-2-36}q(P)\mathbf{1}$, which vanishes identically
...
OEIS A207695 is ``Number of 4Xn 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 0 1 and 1 1 1 vertically.''. It has offset
$1$ and begins
\[
9, 81, 144, 256, 768, 2304, 5856,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:10:37, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-3) + 64\,a(n-4) + 16\,a(n-5) + 4\,a(n-6) - 20\,a(n-7) - 1112\,a(n-8) - 324\,a(n-9) + 40\,a(n-10) - 136\,a(n-11) + 7516\,a(n-12) + 2032\,a(n-13) - 192\,a(n-14) + 1936\,a(n-15) - 23584\,a(n-16) - 4720\,a(n-17) - 5888\,a(n-19) + 37360\,a(n-20) + 3968\,a(n-21) + 480\,a(n-22) + 6464\,a(n-23) - 29872\,a(n-24) - 704\,a(n-25) - 256\,a(n-26) - 2592\,a(n-27) + 11072\,a(n-28) - 256\,a(n-29) - 64\,a(n-30) + 320\,a(n-31) - 1600\,a(n-32) + 64\,a(n-33) + 64\,a(n-36)
\end{equation}
for all $n>39$. The entry's array has a fixed number of rows and a growing number of
...
$(0,0,1), (1,1,1)$ as $3$ consecutive entries. There are $9$ admissible columns; that condition
...
$a(n)-\sum_i c_i a(n-i)=u_{\,n-2-36}$ whenever $n-36\ge2$. Hence
\eqref{eq:conj} holds for every $n>t$ exactly when $u_j=0$ for every
$j>t-2-36$. Moreover $(u_j)$ satisfies the monic linear recurrence whose
...
$P^{\,n-2-36}$ gives the identity. The equivalence follows by letting the exponent
...
\begin{proof}
The vector $q(P)\mathbf{1}\in\mathbb{Z}^{S}$ was formed by $36$ matrix--vector
products in exact integer arithmetic and the $u_j$ evaluated in turn. They vanish from the
index corresponding to $n=39+1$ onwards, and the run was continued past $S$ consecutive
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207695.
