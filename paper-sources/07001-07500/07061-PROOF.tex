...
\title{The empirical recurrence for OEIS A196433, proved by transfer matrix}
...
\begin{abstract}
OEIS A196433 counts $n\times5$ arrays over $\{0,\dots,4\}$ subject to a condition imposed on
...
walk, and $a(n)$ is a walk count on $S=5664$ vertices, which is $C$-finite. Whether the
...
OEIS A196433 is ``Number of nX5 0..4 arrays with each element x equal to the number its horizontal and vertical neighbors equal to 2,1,0,3,4 for x=0,1,2,3,4.''. It has offset $1$ and begins
\[
6, 41, 213, 1283, 7358, 42604, 246463, 1427278,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 06:32:22, revision 9) this is still
...
settled by the terminal weight, which evaluates it with $\varnothing$ below. Most of those pairs are indistinguishable, and exactly so. Every offset named above has $|dj|\le 1$, so whether the cell at column $j$ of the middle row is satisfied depends on the three rows only through their windows at $j-1,j,j+1$. Collect for each $j$ the indicator over the window of the row below, and call that tuple $P(r,s)$: the number of cells any $t$ violates is read off $P$, so is the number violated at the bottom edge, and the successor $(s,t)$ carries $P(s,t)$, which does not mention $r$. Hence two pairs $(r,s)$ and $(r',s)$ with the same $P$ have the same outgoing rows and the same successors, and the vertex is $(s,P)$. That leaves $S=5664$ vertices in place of $9765625$. Hence,
with $M$ the adjacency matrix on $S=5664$ vertices, $\iota$ the starting vector and $\tau$ the
terminal weight,
\[
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 10\,a(n-2) + 53\,a(n-3) + 82\,a(n-4) + 111\,a(n-5) - 129\,a(n-6) - 827\,a(n-7) - 1254\,a(n-8) + 2309\,a(n-9) + 2065\,a(n-10) - 3149\,a(n-11) - 3500\,a(n-12) + 4105\,a(n-13) + 5856\,a(n-14) - 8008\,a(n-15) + 1008\,a(n-16) + 5189\,a(n-17) - 1830\,a(n-18) - 2683\,a(n-19) + 2403\,a(n-20) + 8398\,a(n-21) - 10099\,a(n-22) + 2582\,a(n-23) - 6932\,a(n-24) + 4579\,a(n-25) - 1024\,a(n-26) + 641\,a(n-27) - 588\,a(n-28) + 234\,a(n-29) - 402\,a(n-30) + 159\,a(n-31) - 79\,a(n-32) + 60\,a(n-33) - 5\,a(n-34) + 3\,a(n-35) - a(n-36)
\]
for every $n>36$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A196433.
