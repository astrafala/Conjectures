...
\title{The empirical recurrence for OEIS A250938, proved by transfer matrix}
...
\begin{abstract}
OEIS A250938 counts arrays over $\{0,1,2\}$ in which a statistic taken over short runs
...
OEIS A250938 is ``Number of (n+1)X(4+1) 0..2 arrays with nondecreasing x(i,j)+x(i,j-1) in the i direction and nondecreasing absolute value of x(i,j)-x(i-1,j) in the j direction.''. It has offset $1$ and begins
\[
2247, 15431, 87529, 444421, 2067987, 8976385, 36809498, 144007880,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 12:52:43, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;32\,a(n-1) - 484\,a(n-2) + 4602\,a(n-3) - 30861\,a(n-4) + 155214\,a(n-5) - 607776\,a(n-6) + 1898436\,a(n-7) - 4807563\,a(n-8) + 9976284\,a(n-9) - 17075340\,a(n-10) + 24182082\,a(n-11) - 28338375\,a(n-12) + 27397590\,a(n-13) - 21713520\,a(n-14) + 13959072\,a(n-15) - 7163424\,a(n-16) + 2864448\,a(n-17) - 859904\,a(n-18) + 182272\,a(n-19) - 24320\,a(n-20) + 1536\,a(n-21)
\]
for every $n>29$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250938.
