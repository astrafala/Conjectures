...
\title{The empirical recurrence for OEIS A252608, proved by transfer matrix}
...
\begin{abstract}
OEIS A252608 counts $(n+2)\times3$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
every $3\times3$ subblock, and it carries an empirical recurrence of order $25$
...
OEIS A252608 is ``Number of (n+2)X(1+2) 0..3 arrays with every 3X3 subblock row and diagonal sum equal to 0 3 5 6 or 8 and every 3X3 column and antidiagonal sum not equal to 0 3 5 6 or 8.''. It has offset $1$ and begins
\[
614, 725, 1042, 1635, 3022, 5503, 9927, 19165,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:26:24, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;21\,a(n-3) + a(n-4) - 166\,a(n-6) - 19\,a(n-7) + 635\,a(n-9) + 128\,a(n-10) - 1321\,a(n-12) - 379\,a(n-13) + 1640\,a(n-15) + 563\,a(n-16) - 1416\,a(n-18) - 514\,a(n-19) + 944\,a(n-21) + 388\,a(n-22) - 336\,a(n-24) - 168\,a(n-25)
\]
for every $n>31$.
\end{theorem}

\begin{proof}
The vector $w=q(M)\mathbf{1}$ was formed by $25$ matrix--vector products in exact
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252608.
