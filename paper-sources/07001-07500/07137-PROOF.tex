...
\title{The empirical recurrence for OEIS A302621, proved by transfer matrix}
...
\begin{abstract}
OEIS A302621 counts $6$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A302621 is ``Number of nX6 0..1 arrays with every element equal to 0, 1, 2 or 6 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
32, 169, 146, 497, 2229, 9015, 36510, 150072,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 10 2018 19:11:46, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 5\,a(n-2) + 6\,a(n-3) - 34\,a(n-4) - 11\,a(n-5) + 18\,a(n-6) + 19\,a(n-7) + 14\,a(n-8) + 7\,a(n-9) - 40\,a(n-10) + 24\,a(n-11) - 4\,a(n-12) - 13\,a(n-13) + 78\,a(n-14) - 65\,a(n-15) - 58\,a(n-16) + 47\,a(n-17) - 3\,a(n-18) + 8\,a(n-19) + 6\,a(n-20) - 6\,a(n-21)
\end{equation}
for all $n>27$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302621.
