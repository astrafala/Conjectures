...
\title{The empirical recurrence for OEIS A252418, proved by transfer matrix}
...
\begin{abstract}
OEIS A252418 counts $(n+2)\times5$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252418 is ``Number of (n+2) X (3+2) 0..3 arrays with every 3 X 3 subblock row and column sum not equal to 0 2 5 6 or 7 and every 3 X 3 diagonal and antidiagonal sum equal to 0 2 5 6 or 7.''. It has offset $1$ and begins
\[
1099, 1098, 2348, 3796, 11409, 30724, 53782, 173544,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 27 2023 22:45:30, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;38\,a(n-3) - 510\,a(n-6) + 3209\,a(n-9) - 10762\,a(n-12) + 20397\,a(n-15) - 22122\,a(n-18) + 13410\,a(n-21) - 4305\,a(n-24) + 686\,a(n-27) - 40\,a(n-30)
\]
for every $n>37$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252418.
