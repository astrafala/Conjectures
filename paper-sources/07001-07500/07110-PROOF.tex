...
\title{The empirical recurrence for OEIS A252470, proved by transfer matrix}
...
\begin{abstract}
OEIS A252470 counts $(n+2)\times7$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
$a(n)$ is a walk count on $S=18551$ vertices. Such a sequence is $C$-finite, so whether a given
...
OEIS A252470 is ``Number of (n+2)X(5+2) 0..3 arrays with every 3X3 subblock row, column, diagonal and antidiagonal sum not equal to 0 3 5 6 or 8.''. It has offset $1$ and begins
\[
4507, 3497, 18175, 96543, 504030, 2670237, 14105131, 74389293,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:17:14, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252470.
