...
\title{The empirical recurrence for OEIS A303805, proved by transfer matrix}
...
\begin{abstract}
OEIS A303805 counts $5$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A303805 is ``Number of nX5 0..1 arrays with every element unequal to 0, 1, 3 or 4 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
8, 35, 27, 55, 100, 174, 291, 588,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 30 2018 17:20:37, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) - 7\,a(n-2) - a(n-3) + 21\,a(n-4) - 51\,a(n-5) + 35\,a(n-6) + 10\,a(n-7) - 16\,a(n-8) + 59\,a(n-9) + 22\,a(n-10) - 63\,a(n-11) - 75\,a(n-12) + 218\,a(n-13) - 298\,a(n-14) + 2\,a(n-15) - 294\,a(n-16) - 277\,a(n-17) + 523\,a(n-18) + 265\,a(n-19) + 445\,a(n-20) + 109\,a(n-21) - 627\,a(n-22) + 233\,a(n-23) + 267\,a(n-24) - 189\,a(n-25) - 45\,a(n-26) - 202\,a(n-27) + 339\,a(n-28) + 275\,a(n-29) - 448\,a(n-30) - 292\,a(n-31) - 146\,a(n-32) + 56\,a(n-33) + 172\,a(n-34) + 48\,a(n-35) + 46\,a(n-36) + 4\,a(n-37) - 14\,a(n-39) - 12\,a(n-40) + 3\,a(n-41) + a(n-42)
\end{equation}
for all $n>46$.
...
They vanish from the index corresponding to $n=46+1$ onwards, and the run was continued
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A303805.
