...
\title{The empirical recurrence for OEIS A236496, proved by transfer matrix}
...
\begin{abstract}
OEIS A236496 counts arrays over $\{0,\dots,3\}$ subject to a condition on the order
statistics of every $2\times2$ subblock, and carries an empirical recurrence of order
$43$ contributed by R.~H.~Hardin. It is true, and it is decidable rather than empirical.
The condition is local to two consecutive rows, so the count is a walk count on $S=2228$
...
OEIS A236496 is ``Number of (n+1)X(2+1) 0..3 arrays colored with the sum of the maximum and minimum values of each 2X2 subblock.''. It has offset $1$ and begins
\[
2228, 30916, 404844, 5217808, 67922876, 889064156, 11593920636, 150933818096,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 09:17:41, revision 6) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The $2\times2$ subblocks of an $(n+1)\times3$ array form an
$n\times2$ grid. Colour each of them by $\sigma=a+d$, where $a\le b\le c\le d$ are its four entries sorted --- its minimum, lower median, upper median and maximum. ``Coloured with'' is the entry's way of
...
\]
over the $S=2228$ pairs whose own subblock row is properly coloured.
...
\begin{theorem}
\[
a(n)\;=\;62\,a(n-2) + 725\,a(n-3) + 7415\,a(n-4) + 25938\,a(n-5) - 43654\,a(n-6) - 497122\,a(n-7) - 870235\,a(n-8) + 1383538\,a(n-9) + 6711678\,a(n-10) + 7323747\,a(n-11) - 4082728\,a(n-12) - 31886496\,a(n-13) - 47300006\,a(n-14) - 12535262\,a(n-15) + 22727505\,a(n-16) + 103868945\,a(n-17) + 241224605\,a(n-18) - 129769422\,a(n-19) - 357137862\,a(n-20) + 318197576\,a(n-21) + 757875482\,a(n-22) + 1291333264\,a(n-23) + 422581272\,a(n-24) - 2833137215\,a(n-25) - 4398569896\,a(n-26) - 2785178278\,a(n-27) + 32869089\,a(n-28) + 2214404517\,a(n-29) + 1044738288\,a(n-30) - 2794241155\,a(n-31) - 5865396108\,a(n-32) - 5446738798\,a(n-33) - 2850201776\,a(n-34) - 687819008\,a(n-35) - 18405064\,a(n-36) - 19215173\,a(n-37) - 16345608\,a(n-38) + 621997\,a(n-39) + 1385329\,a(n-40) - 452750\,a(n-41) + 65418\,a(n-42) - 2720\,a(n-43)
\]
for every $n>46$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A236496.
