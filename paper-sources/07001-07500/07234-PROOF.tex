...
\title{The empirical recurrence for OEIS A296331, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A296331 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A296331 is ``Number of nX4 0..1 arrays with each 1 horizontally, vertically or antidiagonally adjacent to 0 or 2 neighboring 1s.''. It has offset $1$ and begins
\[
8, 47, 230, 1235, 6504, 34224, 180404, 950451,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 10 2017 12:07:02, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) + 4\,a(n-2) + 16\,a(n-3) - 4\,a(n-4) - 14\,a(n-5) - 72\,a(n-6) - 54\,a(n-7) - 102\,a(n-8) + 15\,a(n-9) - 113\,a(n-10) + 86\,a(n-11) - 184\,a(n-12) + 203\,a(n-13) - 255\,a(n-14) + 221\,a(n-15) - 177\,a(n-16) + 106\,a(n-17) - 55\,a(n-18) + 21\,a(n-19) - 6\,a(n-20) + a(n-21)
\end{equation}
for all $n>22$.
...
the middle row. The vector $w$ was formed by $21$ applications of $G$ in exact integer
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A296331.
