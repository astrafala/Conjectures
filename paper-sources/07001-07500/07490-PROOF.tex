...
\title{The empirical recurrence for OEIS A208036, proved by transfer matrix}
...
\begin{abstract}
OEIS A208036 counts arrays over $\{0,\dots,1\}$ of width $5$ that avoid the patterns
...
OEIS A208036 is ``Number of nX5 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 0 0 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
15, 225, 1071, 4743, 21147, 94605, 422477,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:35:39, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 4\,a(n-2) + 33\,a(n-3) + 62\,a(n-4) + 114\,a(n-5) - 28\,a(n-6) - 241\,a(n-7) - 432\,a(n-8) + 51\,a(n-9) + 421\,a(n-10) + 289\,a(n-11) - 471\,a(n-12) - 277\,a(n-13) - 13\,a(n-14) + 275\,a(n-15) + 54\,a(n-16) + 40\,a(n-17) - 101\,a(n-18) + 18\,a(n-19) - 19\,a(n-20) + 15\,a(n-21) - 3\,a(n-22) + 2\,a(n-23) - a(n-24)
\end{equation}
for all $n>25$. 
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208036.
