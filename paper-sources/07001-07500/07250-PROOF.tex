...
\title{The empirical recurrence for OEIS A283945, proved by transfer matrix}
...
\begin{abstract}
OEIS A283945 counts $n\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
every CELL over a neighbour set the entry names, and it carries an empirical recurrence of
order $16$ contributed by R.~H.~Hardin. It is true, and it is decidable rather than
...
walk, and $a(n)$ is a walk count on $S=132$ vertices, which is $C$-finite. Whether the
...
OEIS A283945 is ``Number of nX3 0..1 arrays with no 1 equal to more than three of its horizontal, diagonal and antidiagonal neighbors, with the exception of exactly one element.''. It has offset $1$ and begins
\[
0, 2, 87, 900, 8184, 71486, 597042, 4841992,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 18 2017 12:19:49, revision 5) this is still
...
\begin{theorem}
\[
a(n)\;=\;14\,a(n-1) - 53\,a(n-2) + 66\,a(n-3) - 370\,a(n-4) + 772\,a(n-5) - 629\,a(n-6) + 2740\,a(n-7) - 3912\,a(n-8) + 2424\,a(n-9) - 8276\,a(n-10) + 9824\,a(n-11) - 5152\,a(n-12) + 8320\,a(n-13) - 10816\,a(n-14) + 5632\,a(n-15) - 1024\,a(n-16)
\]
for every $n>16$.
\end{theorem}
...
integers vanish from the index corresponding to $n=16+1$ onwards, and the run was
continued until the working vector was identically zero, which settles all larger $j$ at once.
By Lemma~\ref{lem:crit} the recurrence holds for every $n>16$.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A283945.
