...
\title{The empirical recurrence for OEIS A250464, proved by transfer matrix}
...
\begin{abstract}
OEIS A250464 counts arrays over $\{0,1\}$ in which a statistic taken over short runs
...
OEIS A250464 is ``Number of (n+1) X (4+1) 0..1 arrays with nondecreasing min(x(i,j),x(i,j-1)) in the i direction and nondecreasing min(x(i,j),x(i-1,j)) in the j direction.''. It has offset $1$ and begins
\[
233, 2322, 21753, 204721, 1920345, 18018051, 169000988, 1585251989,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 05 2022 23:16:42, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) + 46\,a(n-2) - 95\,a(n-3) - 445\,a(n-4) + 586\,a(n-5) + 1578\,a(n-6) - 1665\,a(n-7) - 2478\,a(n-8) + 2288\,a(n-9) + 1812\,a(n-10) - 1488\,a(n-11) - 576\,a(n-12) + 400\,a(n-13) + 64\,a(n-14) - 32\,a(n-15)
\]
for every $n>14$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250464.
