...
\title{The empirical recurrence for OEIS A253703, proved by transfer matrix}
...
\begin{abstract}
OEIS A253703 counts arrays of width $7$ over $\{0,1\}$ in which two diagonal numbers of every $2\times2$ subblock each differ from the same number at a neighbouring subblock. The entry carries an
...
OEIS A253703 is ``Number of (6+1) X (n+1) 0..1 arrays with every 2 X 2 subblock ne-sw antidiagonal difference unequal to its neighbors horizontally and nw+se diagonal sum unequal to its neighbors vertically.''. It has offset $1$ and begins
\[
1736, 1182, 1472, 1638, 2386, 3042, 4010, 5178,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 27 2023 15:04:21, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-2) + a(n-5) - a(n-6) + 2\,a(n-7) + a(n-8) - 8\,a(n-9) - a(n-10) + 2\,a(n-11) + 5\,a(n-13) - 11\,a(n-15) + 6\,a(n-17) + 7\,a(n-19) - 4\,a(n-21)
\]
for every $n>31$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253703.
