...
\title{The empirical recurrence for OEIS A298617, proved by transfer matrix}
...
\begin{abstract}
OEIS A298617 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A298617 is ``Number of nX3 0..1 arrays with every element equal to 1, 3, 4, 5 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
0, 4, 0, 7, 7, 25, 88, 187,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 23 2018 12:09:21, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 4\,a(n-2) + 8\,a(n-3) - 10\,a(n-4) - 26\,a(n-5) - 6\,a(n-6) + 23\,a(n-7) + 19\,a(n-8) - 33\,a(n-9) + 42\,a(n-10) + 54\,a(n-11) - 56\,a(n-12) - 61\,a(n-13) + 24\,a(n-14) + 29\,a(n-15) - 4\,a(n-16) + a(n-17) - a(n-18) - a(n-19)
\end{equation}
for all $n>20$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A298617.
