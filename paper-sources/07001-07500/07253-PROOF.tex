...
\title{The empirical recurrence for OEIS A252364, proved by transfer matrix}
...
\begin{abstract}
OEIS A252364 counts $(n+2)\times5$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252364 is ``Number of (n+2)X(3+2) 0..3 arrays with every 3X3 subblock row, column, diagonal and antidiagonal sum not equal to 1 3 4 6 or 7.''. It has offset $1$ and begins
\[
282, 834, 3054, 10450, 36078, 124538, 427362, 1470006,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:08:33, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252364.
