...
\title{The empirical recurrence for OEIS A283567, proved by transfer matrix}
...
\begin{abstract}
OEIS A283567 counts $n\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
walk, and $a(n)$ is a walk count on $S=88$ vertices, which is $C$-finite. Whether the
...
OEIS A283567 is ``Number of nX3 0..1 arrays with no 1 equal to more than one of its horizontal, diagonal and antidiagonal neighbors, with the exception of exactly one element.''. It has offset $1$ and begins
\[
1, 26, 169, 1108, 6453, 36038, 194173, 1021432,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 11 2017 08:13:02, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;10\,a(n-1) - 27\,a(n-2) - 4\,a(n-3) + 89\,a(n-4) - 106\,a(n-5) - 85\,a(n-6) + 228\,a(n-7) - 60\,a(n-8) - 192\,a(n-9) + 144\,a(n-10) + 64\,a(n-11) - 64\,a(n-12)
\]
for every $n>12$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A283567.
