...
\title{The empirical recurrence for OEIS A264275, proved by transfer matrix}
...
\begin{abstract}
OEIS A264275 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=5$ columns in which
...
OEIS A264275 is ``Number of (4+1) X (n+1) arrays of permutations of 0..n*5+4 with each element having index change +-(.,.) 0,0 1,0 or 1,2.''. It has offset $1$ and begins
\[
64, 1800, 50625, 1143000, 25806400, 600090240, 13954224384, 323177889984,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 27 2025 16:40:12, revision 11) this is still
...
\begin{theorem}
\[
a(n)\;=\;24\,a(n-1) - 467\,a(n-3) + 625\,a(n-4) - 5260\,a(n-5) - 15671\,a(n-6) + 466107\,a(n-7) - 420812\,a(n-8) + 879839\,a(n-9) - 157761\,a(n-10) - 732744\,a(n-11) + 1973397\,a(n-12) - 2238123\,a(n-13) + 1652184\,a(n-14) - 1326213\,a(n-15) - 1823409\,a(n-16) + 641268\,a(n-17) - 3529953\,a(n-18) - 222939\,a(n-19) - 250668\,a(n-20) - 21735\,a(n-21) + 9153\,a(n-22) + 2916\,a(n-24) + 243\,a(n-25)
\]
for every $n>27$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264275.
