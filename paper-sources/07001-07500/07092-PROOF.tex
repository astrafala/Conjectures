...
\title{The empirical recurrence for OEIS A252468, proved by transfer matrix}
...
\begin{abstract}
OEIS A252468 counts $(n+2)\times5$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252468 is ``Number of (n+2)X(3+2) 0..3 arrays with every 3X3 subblock row, column, diagonal and antidiagonal sum not equal to 0 3 5 6 or 8.''. It has offset $1$ and begins
\[
1299, 813, 1741, 5367, 18175, 62391, 213791, 735125,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:17:00, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + a(n-2) + 12\,a(n-3) + 33\,a(n-4) + 43\,a(n-5) + 36\,a(n-6) - 44\,a(n-7) - 113\,a(n-8) - 56\,a(n-9) + 10\,a(n-10) + 70\,a(n-11) + 89\,a(n-12) + 6\,a(n-13) - 51\,a(n-14) - 42\,a(n-15) - 8\,a(n-16) + 6\,a(n-17) + 4\,a(n-18) + 4\,a(n-19)
\]
for every $n>24$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252468.
