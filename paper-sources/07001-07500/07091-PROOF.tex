...
\title{The empirical recurrence for OEIS A239180, proved by transfer matrix}
...
\begin{abstract}
OEIS A239180 counts $3\times(n+1)$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
walk, and $a(n)$ is a walk count on $S=756$ vertices, which is $C$-finite. Whether the
...
OEIS A239180 is ``Number of (2+1)X(n+1) 0..2 arrays with no element greater than all horizontal neighbors or equal to all vertical neighbors.''. It has offset $1$ and begins
\[
12, 82, 514, 3358, 22396, 148820, 990458, 6592268,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 10:59:08, revision 6) this is still
...
the set is $\{(-1,0), (1,0)\}$, written as offsets (row, column) from the cell. Every cell carries
the condition
\[
...
$\{0,\dots,2\}^{3}$. The neighbourhood of a cell in column $u_i$ meets $u_{i-1}$,
$u_i$ and $u_{i+1}$ and nothing else. Take as vertices the pairs
$(r,s)\in(\{0,\dots,2\}^{3}\cup\{\varnothing\})\times\{0,\dots,2\}^{3}$,
...
\begin{theorem}
\[
a(n)\;=\;9\,a(n-1) - 30\,a(n-2) + 86\,a(n-3) + 25\,a(n-4) + 182\,a(n-5) + 437\,a(n-6) + 536\,a(n-7) + 1051\,a(n-8) - 5283\,a(n-9) - 3524\,a(n-10) - 4115\,a(n-11) - 8861\,a(n-12) + 28896\,a(n-13) + 22724\,a(n-14) - 27014\,a(n-15) - 3080\,a(n-16) - 931\,a(n-17) - 15313\,a(n-18) + 16851\,a(n-19) + 3650\,a(n-20) - 10094\,a(n-21) + 3499\,a(n-22) + 1512\,a(n-23) - 867\,a(n-24) + 322\,a(n-25) - 565\,a(n-26) - 199\,a(n-27) + 54\,a(n-28) - 40\,a(n-29) + 15\,a(n-30) - 2\,a(n-31)
\]
for every $n>31$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A239180.
