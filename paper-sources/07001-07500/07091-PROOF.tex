...
\title{The empirical recurrence for OEIS A206996, proved by transfer matrix}
...
\begin{abstract}
OEIS A206996 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
$(0,1,0)$ along one axis and $(0,1,1)$ along the other, and carries an empirical recurrence of
order $17$ contributed by R.~H.~Hardin. It is true. The patterns have length $3$, so
...
$\mathbf{1}^{\!\top}P^{\,n-2-17}q(P)\mathbf{1}$, which vanishes identically
...
OEIS A206996 is ``Number of nX4 0..1 arrays avoiding 0 1 0 horizontally and 0 1 1 vertically.''. It has offset
$1$ and begins
\[
12, 144, 1011, 6612, 38144, 211471, 1124120,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 13:21:47, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;10\,a(n-1) - 18\,a(n-2) - 96\,a(n-3) + 314\,a(n-4) + 205\,a(n-5) - 1435\,a(n-6) + 363\,a(n-7) + 2647\,a(n-8) - 1601\,a(n-9) - 2021\,a(n-10) + 1517\,a(n-11) + 728\,a(n-12) - 593\,a(n-13) - 121\,a(n-14) + 101\,a(n-15) + 7\,a(n-16) - 6\,a(n-17)
\end{equation}
for all $n>17$. 
...
$a(n)-\sum_i c_i a(n-i)=u_{\,n-2-17}$ whenever $n-17\ge2$. Hence
\eqref{eq:conj} holds for every $n>t$ exactly when $u_j=0$ for every
$j>t-2-17$. Moreover $(u_j)$ satisfies the monic linear recurrence whose
...
$P^{\,n-2-17}$ gives the identity. The equivalence follows by letting the exponent
...
\begin{proof}
The vector $q(P)\mathbf{1}\in\mathbb{Z}^{S}$ was formed by $17$ matrix--vector
products in exact integer arithmetic and the $u_j$ evaluated in turn. They vanish from the
index corresponding to $n=17+1$ onwards, and the run was continued past $S$ consecutive
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206996.
