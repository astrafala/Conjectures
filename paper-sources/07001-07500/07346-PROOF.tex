...
\title{The empirical recurrence for OEIS A236721, proved by transfer matrix}
...
\begin{abstract}
OEIS A236721 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
The condition is local to two consecutive rows, so the count is a walk count on $S=37$
...
OEIS A236721 is ``Number of (n+1)X(1+1) 0..2 arrays with the maximum plus the upper median plus the lower median minus the minimum of every 2X2 subblock equal.''. It has offset $1$ and begins
\[
81, 211, 550, 1517, 4227, 12072, 34817, 101881,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 09:29:13, revision 6) this is still
...
array, which is not among the objects counted. There are $S=37$ states left.
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-1) + 12\,a(n-2) - 177\,a(n-3) + 89\,a(n-4) + 1806\,a(n-5) - 2318\,a(n-6) - 9698\,a(n-7) + 16880\,a(n-8) + 30048\,a(n-9) - 63832\,a(n-10) - 54640\,a(n-11) + 140752\,a(n-12) + 54864\,a(n-13) - 184064\,a(n-14) - 22784\,a(n-15) + 135936\,a(n-16) - 4480\,a(n-17) - 48640\,a(n-18) + 5120\,a(n-19) + 5120\,a(n-20)
\]
for every $n>20$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A236721.
