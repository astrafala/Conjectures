...
\title{The empirical recurrence for OEIS A229407, proved by transfer matrix}
...
\begin{abstract}
OEIS A229407 carries an empirical recurrence of order $13$ contributed by R.~H.~Hardin. It is
...
OEIS A229407 is ``Number of nX3 0..3 arrays avoiding 11 horizontally, 22 vertically, 33 antidiagonally and 00 diagonally.''. It has offset $1$ and begins
\[
57, 1756, 53538, 1629298, 49788258, 1519840402, 46408035676, 1416912709750,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 04 2025 00:11:58, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;18\,a(n-1) + 376\,a(n-2) + 224\,a(n-3) - 1664\,a(n-4) + 36983\,a(n-5) - 181958\,a(n-6) + 100599\,a(n-7) + 484260\,a(n-8) - 503501\,a(n-9) - 354823\,a(n-10) + 399643\,a(n-11) + 243696\,a(n-12) + 20412\,a(n-13)
\]
for every $n>12$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A229407.
