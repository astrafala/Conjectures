...
\title{The empirical recurrence for OEIS A252123, proved by transfer matrix}
...
\begin{abstract}
OEIS A252123 counts $(n+2)\times3$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252123 is ``Number of (n+2)X(1+2) 0..3 arrays with every 3X3 subblock row and column sum not equal to 0 3 4 6 or 7 and every 3X3 diagonal and antidiagonal sum equal to 0 3 4 6 or 7.''. It has offset $1$ and begins
\[
380, 634, 1214, 2149, 4671, 9640, 17053, 37562,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 25*a(n-3) -221*a(n-6) +784*a(n-9) -755*a(n-12) -683*a(n-15) +977*a(n-18) -126*a(n-21) for n>26
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 10:49:07, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;25\,a(n-3) - 221\,a(n-6) + 784\,a(n-9) - 755\,a(n-12) - 683\,a(n-15) + 977\,a(n-18) - 126\,a(n-21)
\]
for every $n>26$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252123.
