...
\title{The empirical recurrence for OEIS A251330, proved by transfer matrix}
...
\begin{abstract}
OEIS A251330 counts $4$-column arrays over $\{0,\dots,2\}$ in which every
...
OEIS A251330 is ``Number of (n+1)X(3+1) 0..2 arrays with every 2X2 subblock summing to 2 4 or 6.''. It has offset $1$
and begins
\[
753, 7393, 75391, 801579, 8863633, 101497397, 1196729319, 14442382927,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 10:21:32, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;49\,a(n-1) - 940\,a(n-2) + 8509\,a(n-3) - 30084\,a(n-4) - 47347\,a(n-5) + 500152\,a(n-6) + 81043\,a(n-7) - 3272883\,a(n-8) - 3063686\,a(n-9) + 3924236\,a(n-10) + 5794584\,a(n-11) + 519392\,a(n-12) - 1443456\,a(n-13) - 207360\,a(n-14) + 110592\,a(n-15)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251330.
