...
\title{The empirical recurrence for OEIS A304220, proved by transfer matrix}
...
\begin{abstract}
OEIS A304220 counts $7$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A304220 is ``Number of nX7 0..1 arrays with every element unequal to 0, 1, 3 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
21, 103, 93, 190, 509, 1628, 4263, 11307,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 08 2018 10:54:10, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + a(n-2) + 10\,a(n-3) + 5\,a(n-4) - 2\,a(n-5) - 13\,a(n-6) - 16\,a(n-7) - 8\,a(n-8) + 10\,a(n-9) + 22\,a(n-10) + 9\,a(n-11) - 20\,a(n-12) - 22\,a(n-13) - 4\,a(n-14) + 14\,a(n-15) + 12\,a(n-16) + 6\,a(n-17) - 6\,a(n-18)
\end{equation}
for all $n>24$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A304220.
