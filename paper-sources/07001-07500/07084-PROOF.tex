...
\title{The empirical recurrence for OEIS A220684, proved by transfer matrix}
...
\begin{abstract}
OEIS A220684 counts the ways of linking the cells of a grid $4$ cells wide, each cell either to
...
state, the count is a walk count on $S=64$ of them, and the conjectured recurrence is then
...
OEIS A220684 is ``Number of ways to reciprocally link elements of an nX4 array either to themselves or to exactly two horizontal, vertical or antidiagonal neighbors.''. It has offset $1$ and begins
\[
1, 37, 745, 15452, 312603, 6349886, 128995678, 2620320833,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 18:58:17, revision 8) this is still
...
one configuration. With $M$ the adjacency matrix of the digraph on the $S=64$ reachable
...
\begin{theorem}
\[
a(n)\;=\;15\,a(n-1) + 89\,a(n-2) + 365\,a(n-3) + 522\,a(n-4) - 1997\,a(n-5) - 10213\,a(n-6) - 23837\,a(n-7) - 26018\,a(n-8) + 7514\,a(n-9) + 19116\,a(n-10) - 3306\,a(n-11) - 5327\,a(n-12) + 2212\,a(n-13) + 316\,a(n-14) - 285\,a(n-15) + 12\,a(n-17) - a(n-18)
\]
for every $n>18$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A220684.
