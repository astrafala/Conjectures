...
\title{The empirical recurrence for OEIS A235196, proved by transfer matrix}
...
\begin{abstract}
OEIS A235196 carries an empirical recurrence of order $39$ contributed by R. H. Hardin. It is
...
OEIS A235196 is ``Number of (n+1) X (6+1) 0..6 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 5, with no adjacent elements equal (constant-stress tilted 1 X 1 tilings).''. It has offset $1$ and begins
\[
98080, 176104, 333340, 774140, 1816160, 4812096, 12604104, 35505020,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 19 2022 03:33:22, revision 10) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A235196.
