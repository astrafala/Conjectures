...
\title{The empirical recurrence for OEIS A256951, proved by transfer matrix}
...
\begin{abstract}
OEIS A256951 counts the arrays over $\{0,\dots,1\}$ whose $3\times3$ subblocks carry a
...
OEIS A256951 is ``Number of (n+2)X(5+2) 0..1 arrays with every 3X3 subblock sum of the two sums of the central row and central column minus the two minimums of the diagonal and antidiagonal nondecreasing horizontally and vertically.''. It has offset $1$ and begins
\[
154680, 844499, 2663867, 6304044, 11818550, 18296498, 26587024, 37470100,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 15:16:19, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A256951.
