...
\title{The empirical recurrence for OEIS A296721, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A296721 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A296721 is ``Number of nX4 0..1 arrays with each 1 adjacent to 0, 2 or 4 king-move neighboring 1s.''. It has offset $1$ and begins
\[
8, 57, 258, 1463, 8315, 44668, 246923, 1364492,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 19 2017 13:14:53, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) + 7\,a(n-2) + 31\,a(n-3) - 103\,a(n-4) - 134\,a(n-5) - 197\,a(n-6) + 354\,a(n-7) + 31\,a(n-8) - 17\,a(n-9) - 3\,a(n-10) + 404\,a(n-11) + 53\,a(n-12) - 162\,a(n-13) + 194\,a(n-14) + 92\,a(n-15) - 37\,a(n-16) - 24\,a(n-17) - 4\,a(n-18)
\end{equation}
for all $n>19$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A296721.
