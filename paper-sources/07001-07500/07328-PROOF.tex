...
\title{The empirical recurrence for OEIS A188608, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A188608 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A188608 is ``Number of 3Xn binary arrays without the pattern 1 1 0 diagonally, vertically, antidiagonally or horizontally.''. It has offset $1$ and begins
\[
7, 49, 211, 847, 3282, 12405, 45860, 167525,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 04:45:51, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) + a(n-2) - 56\,a(n-3) + 38\,a(n-4) + 201\,a(n-5) - 139\,a(n-6) - 386\,a(n-7) + 109\,a(n-8) + 450\,a(n-9) + 195\,a(n-10) - 288\,a(n-11) - 391\,a(n-12) + 11\,a(n-13) + 219\,a(n-14) + 110\,a(n-15) - 13\,a(n-16) - 53\,a(n-17) - 21\,a(n-18) + 5\,a(n-19) + 3\,a(n-20)
\end{equation}
for all $n>21$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A188608.
