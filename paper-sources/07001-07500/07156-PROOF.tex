...
\title{The empirical recurrence for OEIS A184780, proved by transfer matrix}
...
\begin{abstract}
OEIS A184780 counts $(n+2)\times3$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A184780 is ``Number of (n+2)X3 0..2 arrays with each 3X3 subblock nonsingular.''. It has offset $1$ and begins
\[
12792, 260268, 5299212, 107810856, 2193592920, 44633574216, 908160565032, 18478374229416,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 02:55:15, revision 10) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + 123\,a(n-2) + 2670\,a(n-3) + 22675\,a(n-4) + 159996\,a(n-5) + 683337\,a(n-6) + 2159142\,a(n-7) + 2203254\,a(n-8) - 10791668\,a(n-9) - 60946844\,a(n-10) - 139654560\,a(n-11) + 113218448\,a(n-12) + 853157504\,a(n-13) + 1692141376\,a(n-14) - 914983808\,a(n-15) - 12472539648\,a(n-16) + 666559488\,a(n-17) + 33631735808\,a(n-18) - 11806212096\,a(n-19) - 31261982720\,a(n-20) + 19818086400\,a(n-21)
\]
for every $n>21$.
\end{theorem}
...
at once. By Lemma~\ref{lem:crit} the recurrence holds for every $n>21$.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A184780.
