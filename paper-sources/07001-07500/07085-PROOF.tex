...
\title{The empirical recurrence for OEIS A233613, proved by transfer matrix}
...
\begin{abstract}
OEIS A233613 counts arrays of width $5$ over $\{0,1,2\}$ containing no run of $3$ consecutive
...
the count is a walk count on $S=46873$ states.
\end{abstract}
...
OEIS A233613 is ``Number of (n+2)X(3+2) 0..2 arrays with no increasing sequence of length 3 horizontally or diagonally downwards.''. It has offset $1$ and begins
\[
9120456, 1777375908, 345855899520, 67296801927960, 13094412982589016, 2547870958491036012, 495756869782694668272, 96462841432650917213520,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 08:07:03, revision 6) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=46873,\quad\tau=\mathbf{1} .
\]
...
\begin{theorem}
\[
a(n)\;=\;216\,a(n-1) - 3582\,a(n-2) - 127224\,a(n-3) + 2457495\,a(n-4) + 21025008\,a(n-5) - 505022364\,a(n-6) - 258645312\,a(n-7) + 37921168656\,a(n-8) - 199403171712\,a(n-9) + 265276451520\,a(n-10) + 271825694208\,a(n-11) - 396718580736\,a(n-12)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A233613.
