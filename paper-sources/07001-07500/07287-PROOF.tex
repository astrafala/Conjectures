...
\title{The empirical recurrence for OEIS A283278, proved by transfer matrix}
...
\begin{abstract}
OEIS A283278 counts $n\times4$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A283278 is ``Number of nX4 0..1 arrays with no 1 equal to more than two of its horizontal, vertical and antidiagonal neighbors.''. It has offset $1$ and begins
\[
16, 176, 1725, 18320, 191025, 1994338, 20834848, 217606715,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 04 2017 11:52:00, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-1) + 22\,a(n-2) + 46\,a(n-3) - 91\,a(n-4) - 37\,a(n-5) - 135\,a(n-6) + 1263\,a(n-7) - 1913\,a(n-8) + 3501\,a(n-9) - 10568\,a(n-10) + 23356\,a(n-11) - 42719\,a(n-12) + 63699\,a(n-13) - 67853\,a(n-14) + 43395\,a(n-15) - 21088\,a(n-16) + 15354\,a(n-17) - 8233\,a(n-18) + 1521\,a(n-19)
\]
for every $n>19$.
\end{theorem}
...
By Lemma~\ref{lem:crit} the recurrence holds for every $n>19$.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A283278.
