...
\title{The empirical recurrence for OEIS A258887, proved by transfer matrix}
...
\begin{abstract}
OEIS A258887 counts arrays of width $3$ over $\{0,1\}$ in which every $3\times3$ window has
...
OEIS A258887 is ``Number of (n+2)X(1+2) 0..1 arrays with no 3x3 subblock diagonal sum less than the antidiagonal sum or central row sum less than the central column sum.''. It has offset $1$ and begins
\[
242, 900, 3036, 10201, 30870, 94249, 271350, 786769,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 15:31:46, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) + a(n-2) - 38\,a(n-3) + 50\,a(n-4) + 12\,a(n-5) - 106\,a(n-6) + 374\,a(n-7) - 453\,a(n-8) - 237\,a(n-9) + 765\,a(n-10) - 1424\,a(n-11) + 1802\,a(n-12) + 486\,a(n-13) - 1738\,a(n-14) + 2108\,a(n-15) - 2944\,a(n-16) - 604\,a(n-17) + 2008\,a(n-18) - 1348\,a(n-19) + 2158\,a(n-20) + 534\,a(n-21) - 1310\,a(n-22) + 328\,a(n-23) - 657\,a(n-24) - 219\,a(n-25) + 417\,a(n-26) + 2\,a(n-27) + 46\,a(n-28) + 24\,a(n-29) - 38\,a(n-30) - 2\,a(n-31) - a(n-32) - a(n-33) + a(n-34)
\]
for every $n>33$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A258887.
