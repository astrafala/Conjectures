...
\title{The empirical recurrence for OEIS A252419, proved by transfer matrix}
...
\begin{abstract}
OEIS A252419 counts $(n+2)\times6$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
$a(n)$ is a walk count on $S=367227$ vertices. Such a sequence is $C$-finite, so whether a given
...
OEIS A252419 is ``Number of (n+2)X(4+2) 0..3 arrays with every 3X3 subblock row and column sum not equal to 0 2 5 6 or 7 and every 3X3 diagonal and antidiagonal sum equal to 0 2 5 6 or 7.''. It has offset $1$ and begins
\[
1536, 1704, 3796, 6834, 22038, 62288, 113324, 380113,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 25*a(n-3) -146*a(n-6) +295*a(n-9) -193*a(n-12) +20*a(n-15) for n>21
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:12:41, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;25\,a(n-3) - 146\,a(n-6) + 295\,a(n-9) - 193\,a(n-12) + 20\,a(n-15)
\]
for every $n>21$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252419.
