...
\title{The empirical recurrence for OEIS A203177, proved by transfer matrix}
...
\begin{abstract}
OEIS A203177 counts arrays of width $4$ over $\{0,1,2\}$ under local conditions relating each cell
...
OEIS A203177 is ``Number of nX4 0..2 arrays with every 1 immediately preceded by 0 to the left or above, no 0 immediately preceded by a 0, and every 2 immediately preceded by 0 1 to the left or above.''. It has offset $1$ and begins
\[
2, 4, 17, 59, 205, 724, 2466, 8948,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 10:10:30, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-2) + 34\,a(n-3) + 13\,a(n-4) - 38\,a(n-5) - 419\,a(n-6) - 124\,a(n-7) + 145\,a(n-8) + 2520\,a(n-9) + 37\,a(n-10) - 584\,a(n-11) - 6715\,a(n-12) + 1170\,a(n-13) + 55\,a(n-14) + 6304\,a(n-15) + 476\,a(n-16) - 78\,a(n-17) - 480\,a(n-19)
\]
for every $n>19$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A203177.
