...
\title{The empirical recurrence for OEIS A202485, proved by transfer matrix}
...
\begin{abstract}
OEIS A202485 counts arrays of width $3$ over $\{0,1\}$ containing no occurrence of certain short
...
OEIS A202485 is ``Number of (n+2) X 3 binary arrays avoiding patterns 000 and 010 in rows, columns and nw-to-se diagonals.''. It has offset $1$ and begins
\[
108, 324, 1170, 4225, 14560, 50176, 174720, 608400,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 27 2026 09:15:33, revision 11) this is still
...
\text{down a diagonal, nw to se} & \mathtt{000},\quad \mathtt{010} \\
\end{array}
\]
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) - 2\,a(n-2) + 15\,a(n-3) + 40\,a(n-4) + 74\,a(n-5) + 164\,a(n-6) + 96\,a(n-7) - 36\,a(n-8) - 255\,a(n-9) - 789\,a(n-10) - 474\,a(n-11) + 720\,a(n-12) + 975\,a(n-13) + 672\,a(n-14) + 474\,a(n-15) - 159\,a(n-16) - 564\,a(n-17) - 522\,a(n-18) - 627\,a(n-19) - 354\,a(n-20) - 183\,a(n-21) - 162\,a(n-22) + 24\,a(n-23) - 47\,a(n-24) + 35\,a(n-25) - 10\,a(n-26) + 6\,a(n-27) - a(n-28) - 2\,a(n-29) + a(n-30)
\]
for every $n>27$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A202485.
