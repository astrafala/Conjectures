...
\title{The empirical recurrence for OEIS A252248, proved by transfer matrix}
...
\begin{abstract}
OEIS A252248 counts $(n+2)\times4$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252248 is ``Number of (n+2) X (2+2) 0..3 arrays with every 3 X 3 subblock row and column sum not equal to 0 3 5 6 or 7 and every 3 X 3 diagonal and antidiagonal sum equal to 0 3 5 6 or 7.''. It has offset $1$ and begins
\[
260, 239, 242, 268, 302, 359, 437, 549,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + 5*a(n-3) - 4*a(n-4) - 8*a(n-6) + 4*a(n-7) + 5*a(n-9) - a(n-10) -a(n-12) for n>16.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 02 2018 10:22:53, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 5\,a(n-3) - 4\,a(n-4) - 8\,a(n-6) + 4\,a(n-7) + 5\,a(n-9) - a(n-10) - a(n-12)
\]
for every $n>16$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252248.
