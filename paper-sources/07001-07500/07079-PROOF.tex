...
\title{The empirical recurrence for OEIS A259948, proved by transfer matrix}
...
\begin{abstract}
OEIS A259948 counts $(n+2)\times6$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A259948 is ``Number of (n+2)X(4+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000000 00000001 or 00000101.''. It has offset $1$ and begins
\[
365, 1507, 8699, 35765, 141619, 642779, 2922457, 12595119,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:56:26, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 6\,a(n-2) + 11\,a(n-3) + 70\,a(n-4) - 95\,a(n-5) - 212\,a(n-6) + 99\,a(n-7) - 450\,a(n-8) + 207\,a(n-9) + 1325\,a(n-10) - 637\,a(n-11) + 440\,a(n-12) + 561\,a(n-13) - 1601\,a(n-14) + 264\,a(n-15) + 325\,a(n-16) - 48\,a(n-17) + 103\,a(n-18) - 226\,a(n-19) + 17\,a(n-20) - 46\,a(n-21) + 20\,a(n-22) - 8\,a(n-23) + 2\,a(n-24)
\]
for every $n>27$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A259948.
