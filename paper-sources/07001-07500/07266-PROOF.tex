...
\title{The empirical recurrence for OEIS A189612, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A189612 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A189612 is ``Number of n X 4 binary arrays without the pattern 0 1 0 diagonally, antidiagonally or horizontally.''. It has offset $1$ and begins
\[
12, 144, 1164, 8496, 65160, 515560, 4075336, 32031600,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 28 2023 13:57:23, revision 7) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;12\,a(n-1) - 29\,a(n-2) - 69\,a(n-3) + 512\,a(n-4) - 1626\,a(n-5) + 60\,a(n-6) + 9924\,a(n-7) - 9708\,a(n-8) + 1120\,a(n-9) + 1064\,a(n-10) - 73360\,a(n-11) + 46560\,a(n-12) + 40960\,a(n-13) + 31616\,a(n-14) + 147456\,a(n-15) - 64000\,a(n-16) - 110592\,a(n-17) - 16384\,a(n-18) - 32768\,a(n-19)
\end{equation}
for all $n>20$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A189612.
