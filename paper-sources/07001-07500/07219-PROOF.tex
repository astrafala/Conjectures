...
\title{A condition on each element and its neighbours: OEIS A241074}
...
\begin{abstract}
OEIS A241074 carries an empirical recurrence of order $20$ contributed by R.~H.~Hardin. It is
...
OEIS A241074 is ``Number of nX3 0..2 arrays with no element equal to exactly one horizontal or vertical neighbor, with new values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
2, 12, 67, 386, 2333, 14438, 90729, 576616,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 11:08:32, revision 6) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{The count is a walk count}

The entry counts arrays with $3$ columns over the alphabet $\{0,1,2\}$, growing one row at a time. Its condition is that no element may equal exactly $1$ of its horizontal and vertical neighbours.
...
Vertices with identical futures are merged, which leaves $S=21$. An admissible array is exactly a walk, so with $M$ the adjacency matrix and $\iota,\tau$ the vectors recording which states may begin and end an array,
\[
...
\begin{theorem}
\[
a(n)\;=\;13\,a(n-1) - 53\,a(n-2) + 90\,a(n-3) - 196\,a(n-4) + 404\,a(n-5) + 124\,a(n-6) + 242\,a(n-7) - 955\,a(n-8) - 3141\,a(n-9) - 2695\,a(n-10) + 1876\,a(n-11) + 9112\,a(n-12) + 7732\,a(n-13) + 8168\,a(n-14) - 12592\,a(n-15) - 17664\,a(n-16) - 3904\,a(n-17) + 11648\,a(n-18) + 4864\,a(n-19) - 3072\,a(n-20)
\]
for every $n>21$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A241074.
