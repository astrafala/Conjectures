...
\title{The empirical recurrence for OEIS A183446, proved by transfer matrix}
...
\begin{abstract}
OEIS A183446 counts $n\times5$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A183446 is ``Number of nX5 binary arrays with every 1 having exactly two king-move neighbors equal to 1.''. It has offset $1$ and begins
\[
1, 33, 107, 283, 2054, 9208, 34867, 176949,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 01:44:04, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) - 4\,a(n-2) + 26\,a(n-3) - 181\,a(n-4) - 17\,a(n-5) + 101\,a(n-6) + 1148\,a(n-7) - 826\,a(n-8) + 575\,a(n-9) - 429\,a(n-10) - 160\,a(n-11) - 83\,a(n-12) - 913\,a(n-13) - 799\,a(n-14) + 405\,a(n-15) + 185\,a(n-16) + 74\,a(n-17) - 8\,a(n-18) - 33\,a(n-19) + 6\,a(n-20)
\]
for every $n>20$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A183446.
