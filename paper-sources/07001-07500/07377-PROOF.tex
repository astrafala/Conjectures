...
\title{The empirical recurrence for OEIS A188749, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A188749 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A188749 is ``Number of 4 X n binary arrays without the pattern 1 1 1 diagonally, vertically or antidiagonally.''. It has offset $1$ and begins
\[
13, 169, 1651, 17286, 184411, 1944586, 20544154, 217243096,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 29 2023 10:47:33, revision 7) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;11\,a(n-1) + 2\,a(n-2) - 27\,a(n-3) - 420\,a(n-4) - 568\,a(n-5) + 3095\,a(n-6) + 2148\,a(n-7) - 2947\,a(n-8) - 4914\,a(n-9) - 3147\,a(n-10) + 1801\,a(n-11) + 4012\,a(n-12) + 2286\,a(n-13) - 228\,a(n-14) - 396\,a(n-15) - 656\,a(n-16) - 288\,a(n-17) + 192\,a(n-18)
\end{equation}
for all $n>19$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A188749.
