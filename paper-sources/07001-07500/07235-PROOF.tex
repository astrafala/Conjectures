...
\title{The empirical recurrence for OEIS A255786, proved by transfer matrix}
...
\begin{abstract}
OEIS A255786 counts $(n+2)\times4$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A255786 is ``Number of (n+2)X(2+2) 0..1 arrays with no 3x3 subblock diagonal sum 2 and no antidiagonal sum 2 and no row sum 0 and no column sum 0.''. It has offset $1$ and begins
\[
177, 270, 491, 884, 1696, 3376, 6668, 13654,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:42:26, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 2\,a(n-2) + 6\,a(n-3) - 4\,a(n-4) - 10\,a(n-5) - 8\,a(n-6) - 2\,a(n-7) + 3\,a(n-8) - 17\,a(n-9) + 14\,a(n-10) + 39\,a(n-11) + 49\,a(n-12) + 4\,a(n-13) - 26\,a(n-14) + 7\,a(n-15) - 20\,a(n-16) - 60\,a(n-17) - 96\,a(n-18) - 3\,a(n-19) + 70\,a(n-20) + 52\,a(n-21) + 15\,a(n-22) + 9\,a(n-23) + 44\,a(n-24) - 2\,a(n-25) - 45\,a(n-26) - 46\,a(n-27) - 2\,a(n-28) + 19\,a(n-29) + 2\,a(n-30) - 2\,a(n-31) + 4\,a(n-32) + 9\,a(n-33) + a(n-34) - 4\,a(n-35) - 3\,a(n-36) + a(n-38)
\]
for every $n>41$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A255786.
