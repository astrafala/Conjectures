...
\title{The empirical recurrence for OEIS A300211, proved by transfer matrix}
...
\begin{abstract}
OEIS A300211 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $equal to$ itself lying in $\{0,1,2,3,4,5,7,8\}$, and it carries an empirical
...
OEIS A300211 is ``Number of nX4 0..1 arrays with every element equal to 0, 1, 2, 3, 4, 5, 7 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
8, 128, 1651, 22194, 298600, 4023881, 54246856, 731384148,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 28 2018 14:19:47, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;15\,a(n-1) - 14\,a(n-2) - 59\,a(n-3) - 415\,a(n-4) + 440\,a(n-5) + 841\,a(n-6) + 857\,a(n-7) - 1520\,a(n-8) + 9609\,a(n-9) + 25294\,a(n-10) - 4843\,a(n-11) - 72412\,a(n-12) - 117953\,a(n-13) - 55535\,a(n-14) + 52555\,a(n-15) + 118040\,a(n-16) + 49470\,a(n-17) - 44450\,a(n-18) - 41445\,a(n-19) - 945\,a(n-20) + 4777\,a(n-21) + 1797\,a(n-22) + 1189\,a(n-23) + 156\,a(n-24)
\end{equation}
for all $n>24$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A300211.
