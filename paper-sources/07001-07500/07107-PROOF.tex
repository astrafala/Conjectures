...
\title{The empirical recurrence for OEIS A234486, proved by transfer matrix}
...
\begin{abstract}
OEIS A234486 counts $5$-column arrays over $\{0,\dots,3\}$ in which every
...
length $n$. Hence $a(n)=\mathbf{1}^{\!\top}M^{n}\mathbf{1}$ on $S=1024$ vertices, which
...
OEIS A234486 is ``Number of (n+1) X (4+1) 0..3 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 2 (constant-stress 1 X 1 tilings).''. It has offset
$1$ and begins
\[
3686, 13554, 49784, 183422, 677138, 2505400, 9288710,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 20 2022 19:11:46, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;16\,a(n-1) - 69\,a(n-2) - 186\,a(n-3) + 2233\,a(n-4) - 3610\,a(n-5) - 15789\,a(n-6) + 56088\,a(n-7) + 1729\,a(n-8) - 189898\,a(n-9) + 95019\,a(n-10) + 304674\,a(n-11) - 145486\,a(n-12) - 269396\,a(n-13) + 58980\,a(n-14) + 118584\,a(n-15) + 6480\,a(n-16) - 16992\,a(n-17) - 3456\,a(n-18)
\end{equation}
...
Let $V$ consist of all of $\{0,\dots,3\}^{5}$, and put $S=|V|=1024$. For $r,s\in V$ declare $r\to s$ an edge
...
$j=0,1,\dots$. They vanish from $j=17-18+1$ onwards, and the run was continued past
$S$ consecutive zeros, which by Lemma~\ref{lem:crit} settles every larger $j$. Hence the
recurrence holds for every $n>17$.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234486.
