...
\title{The empirical recurrence for OEIS A250630, proved by transfer matrix}
...
\begin{abstract}
OEIS A250630 counts arrays over $\{0,1,2\}$ in which a statistic taken over short runs
...
OEIS A250630 is ``Number of (n+1)X(6+1) 0..2 arrays with nondecreasing x(i,j)+x(i,j-1) in the i direction and nondecreasing min(x(i,j),x(i-1,j)) in the j direction.''. It has offset $1$ and begins
\[
28456, 190213, 994030, 4416061, 17202711, 60472234, 195029867, 584383121,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 12:37:23, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250630.
