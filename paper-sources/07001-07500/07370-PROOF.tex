...
\title{The empirical recurrence for OEIS A305336, proved by transfer matrix}
...
\begin{abstract}
OEIS A305336 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A305336 is ``Number of nX4 0..1 arrays with every element unequal to 0, 1, 2, 5 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
8, 9, 26, 81, 267, 938, 3186, 10840,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 30 2018 16:56:20, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 5\,a(n-2) + a(n-3) - 11\,a(n-5) - 24\,a(n-6) + 5\,a(n-7) + 17\,a(n-8) - 5\,a(n-9) + 6\,a(n-10) + 14\,a(n-11) - 5\,a(n-12) - 10\,a(n-13) + 2\,a(n-14) + 4\,a(n-15)
\end{equation}
for all $n>19$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A305336.
