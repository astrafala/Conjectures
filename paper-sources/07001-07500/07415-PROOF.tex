...
\title{The empirical recurrence for OEIS A235242, proved by transfer matrix}
...
\begin{abstract}
OEIS A235242 counts $3$-column arrays over $\{0,\dots,7\}$ in which every
...
OEIS A235242 is ``Number of (n+1) X (2+1) 0..7 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 6, with no adjacent elements equal (constant-stress tilted 1 X 1 tilings).''. It has offset
$1$ and begins
\[
906, 3146, 10866, 41246, 152178, 599342, 2282514,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 18 2022 23:55:27, revision 7) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;10\,a(n-1) + 74\,a(n-2) - 1028\,a(n-3) - 1552\,a(n-4) + 46036\,a(n-5) - 24442\,a(n-6) - 1177460\,a(n-7) + 1943623\,a(n-8) + 18929582\,a(n-9) - 46678364\,a(n-10) - 197883208\,a(n-11) + 641672504\,a(n-12) + 1336005112\,a(n-13) - 5669843140\,a(n-14) - 5468829608\,a(n-15) + 33406180141\,a(n-16) + 10415153798\,a(n-17) - 132321704558\,a(n-18) + 11352730700\,a(n-19) + 350059155896\,a(n-20) - 111967629644\,a(n-21) - 608429901490\,a(n-22) + 262134791548\,a(n-23) + 679376121053\,a(n-24) - 292943901086\,a(n-25) - 478176518752\,a(n-26) + 156339289216\,a(n-27) + 209957565216\,a(n-28) - 34929735168\,a(n-29) - 53104170864\,a(n-30) + 1188145056\,a(n-31) + 6857059248\,a(n-32) + 568465632\,a(n-33) - 342553536\,a(n-34) - 52700544\,a(n-35)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A235242.
