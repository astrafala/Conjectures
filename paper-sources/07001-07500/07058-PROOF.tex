...
\title{The empirical recurrence for OEIS A234732, proved by transfer matrix}
...
\begin{abstract}
OEIS A234732 counts $3$-column arrays over $\{0,\dots,7\}$ in which every
...
OEIS A234732 is ``Number of (n+1) X (2+1) 0..7 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 8 (constant-stress 1 X 1 tilings).''. It has offset
$1$ and begins
\[
672, 2184, 6048, 21048, 64320, 233016, 760608,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 20 2022 18:54:48, revision 6) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234732.
