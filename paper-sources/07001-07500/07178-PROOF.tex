...
\title{The empirical recurrence for OEIS A209852, proved by transfer matrix}
...
\begin{abstract}
OEIS A209852 counts $(n+1)\times3$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A209852 is ``1/4 the number of (n+1)X3 0..3 arrays with every 2X2 subblock having one or four distinct clockwise edge differences.''. It has offset $1$ and begins
\[
182, 2829, 43091, 661963, 10137464, 155490654, 2383064182, 36538359367,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 15:33:04, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;11\,a(n-1) + 139\,a(n-2) - 972\,a(n-3) - 4071\,a(n-4) + 28751\,a(n-5) + 27819\,a(n-6) - 332527\,a(n-7) + 170449\,a(n-8) + 1380897\,a(n-9) - 1533070\,a(n-10) - 2378942\,a(n-11) + 3871609\,a(n-12) + 1392648\,a(n-13) - 4192842\,a(n-14) + 445370\,a(n-15) + 1893206\,a(n-16) - 633950\,a(n-17) - 236300\,a(n-18) + 99664\,a(n-19) + 2096\,a(n-20)
\end{equation}
for all $n>19$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209852.
