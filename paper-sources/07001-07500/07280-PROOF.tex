...
\title{The empirical recurrence for OEIS A232079, proved by transfer matrix}
...
\begin{abstract}
OEIS A232079 counts arrays of width $4$ over $\{0,\dots,1\}$ under a condition on each cell
...
exact computation. The entry writes the array with the width fixed and $n$ counting
...
OEIS A232079 is ``Number of (3+1)X(n+1) 0..1 arrays with every element equal to some horizontal, diagonal or antidiagonal neighbor, with top left element zero.''. It has offset $1$ and begins
\[
34, 602, 6624, 91636, 1313477, 18480458, 259478100, 3648082844,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 06:52:21, revision 6) this is still
...
$34$, which the model reproduces along with every later term. That is the cheapest check
...
\begin{theorem}
\[
a(n)\;=\;9\,a(n-1) + 51\,a(n-2) + 222\,a(n-3) + 815\,a(n-4) + 770\,a(n-5) - 1668\,a(n-6) - 4457\,a(n-7) - 7039\,a(n-8) - 6459\,a(n-9) + 2910\,a(n-10) + 4218\,a(n-11) + 4541\,a(n-12) + 9610\,a(n-13) - 285\,a(n-14) - 4890\,a(n-15) - 152\,a(n-16) - 224\,a(n-17) + 432\,a(n-18) + 512\,a(n-19) - 256\,a(n-20)
\]
for every $n>20$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232079.
