...
\title{The empirical recurrence for OEIS A234382, proved by transfer matrix}
...
\begin{abstract}
OEIS A234382 counts arrays of width $4$ over $\{0,1,2\}$ containing no run of $3$ consecutive
...
OEIS A234382 is ``Number of (2+2) X (n+2) 0..2 arrays with no increasing sequence of length 3 vertically, diagonally downwards or antidiagonally downwards.''. It has offset $1$ and begins
\[
372690, 24485940, 1622352843, 107611542837, 7134211462374, 472916732993424, 31349931916914819, 2078226021454554393,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 20 2025 13:53:13, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;75\,a(n-1) - 428\,a(n-2) - 12080\,a(n-3) + 258675\,a(n-4) - 7798857\,a(n-5) + 2365290\,a(n-6) + 914935626\,a(n-7) - 1993096944\,a(n-8) - 10795294656\,a(n-9) + 17418530520\,a(n-10) - 1096243801776\,a(n-11) + 2225035316448\,a(n-12) + 21748340420928\,a(n-13) - 10024441535232\,a(n-14) + 287526368342016\,a(n-15) - 771748427870208\,a(n-16) - 7161694184521728\,a(n-17) + 2017438966628352\,a(n-18) - 237809116643328\,a(n-19) + 37432575963168768\,a(n-20) + 333658310974636032\,a(n-21) - 77998046721343488\,a(n-22) - 623984373770747904\,a(n-23)
\]
for every $n>20$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234382.
