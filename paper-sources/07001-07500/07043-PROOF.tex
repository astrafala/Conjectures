...
\title{The empirical recurrence for OEIS A185464, proved by transfer matrix}
...
\begin{abstract}
OEIS A185464 counts arrays over $\{0,\dots,1\}$ under a condition on the determinant of every
$2\times2$ subblock, and carries an empirical recurrence of order $30$ contributed by
R.~H.~Hardin. It is true, and it is decidable rather than empirical. The condition is local to
a bounded window of consecutive rows, so the count is a walk count on $S=1320$ states and is
...
OEIS A185464 is ``Number of (n+1)X7 binary arrays with no 2X2 subblock determinant equal to any horizontal or vertical neighbor 2X2 subblock determinant.''. It has offset $1$ and begins
\[
1320, 4452, 27102, 231636, 1388736, 11083678, 63886624, 505270226,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 02:59:37, revision 9) this is still
...
\]
on the $S=1320$ admissible pairs.
...
entry's first term is $1320$, and the model reproduces it along with every later term; that
...
\begin{theorem}
\[
a(n)\;=\;38\,a(n-2) + 285\,a(n-4) + 2258\,a(n-6) + 6967\,a(n-8) + 24960\,a(n-10) - 27398\,a(n-12) + 34950\,a(n-14) + 8534\,a(n-16) + 1567\,a(n-18) - 849\,a(n-20) - 665\,a(n-22) - 470\,a(n-24) + 862\,a(n-26) + 264\,a(n-28) + 24\,a(n-30)
\]
for every $n>36$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A185464.
