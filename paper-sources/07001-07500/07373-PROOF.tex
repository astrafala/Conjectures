...
\title{The empirical recurrence for OEIS A208487, proved by transfer matrix}
...
\begin{abstract}
OEIS A208487 counts arrays of width $4$ over $\{0,1,2,3\}$ subject to a condition read round the
...
OEIS A208487 is ``Number of (n+1) X 4 0..3 arrays with the number of clockwise edge increases in every 2 X 2 subblock equal to the number of counterclockwise edge increases.''. It has offset $1$ and begins
\[
13800, 773288, 43689232, 2473041560, 140051200968, 7932164084608, 449271828443912, 25446613122575176,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 06 2015 21:43:39, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;107\,a(n-1) - 3877\,a(n-2) + 69003\,a(n-3) - 688480\,a(n-4) + 4042126\,a(n-5) - 13877475\,a(n-6) + 25524339\,a(n-7) - 15376881\,a(n-8) - 25497923\,a(n-9) + 51893722\,a(n-10) - 31287236\,a(n-11) + 2987776\,a(n-12) + 2213392\,a(n-13)
\]
for every $n>12$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208487.
