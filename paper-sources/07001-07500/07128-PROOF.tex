...
\title{The empirical recurrence for OEIS A298377, proved by transfer matrix}
...
\begin{abstract}
OEIS A298377 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $equal to$ itself lying in $\{0,2,3,5,6\}$, and it carries an empirical
...
OEIS A298377 is ``Number of n X 3 0..1 arrays with every element equal to 0, 2, 3, 5 or 6 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 7, 6, 18, 30, 87, 200, 522,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 25 2023 13:06:43, revision
6) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 3\,a(n-2) - 6\,a(n-3) - 16\,a(n-4) + 6\,a(n-5) + 23\,a(n-6) + 16\,a(n-7) - 13\,a(n-8) - 40\,a(n-9) - 50\,a(n-10) + 14\,a(n-11) + 106\,a(n-12) + 53\,a(n-13) - 18\,a(n-14) - 38\,a(n-15) - 34\,a(n-16) - 8\,a(n-17)
\end{equation}
for all $n>18$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A298377.
