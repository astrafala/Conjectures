...
\title{The empirical recurrence for OEIS A202311, proved by transfer matrix}
...
\begin{abstract}
OEIS A202311 counts arrays of width $4$ over $\{0,1\}$ containing no occurrence of certain short
...
OEIS A202311 is ``Number of (n+2)X4 binary arrays avoiding patterns 001 and 100 in rows and columns.''. It has offset $1$ and begins
\[
333, 1530, 7835, 41657, 226004, 1235783, 6782829, 37288278,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 09:31:32, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;10\,a(n-1) - 24\,a(n-2) - 30\,a(n-3) + 163\,a(n-4) - 70\,a(n-5) - 283\,a(n-6) + 252\,a(n-7) + 150\,a(n-8) - 210\,a(n-9) + 7\,a(n-10) + 48\,a(n-11) - 12\,a(n-12)
\]
for every $n>11$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A202311.
