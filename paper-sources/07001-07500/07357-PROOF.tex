...
\title{The empirical recurrence for OEIS A302311, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A302311 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A302311 is ``Number of 3 X n 0..1 arrays with every element equal to 0, 1, 3 or 4 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
4, 6, 13, 26, 48, 121, 275, 600,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 03 2022 21:42:28, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 3\,a(n-2) - a(n-3) + 8\,a(n-4) - 7\,a(n-5) - 22\,a(n-6) + 9\,a(n-7) - 14\,a(n-8) + 10\,a(n-9) + 39\,a(n-10) - 19\,a(n-11) + 6\,a(n-12) - 18\,a(n-14) + 9\,a(n-15)
\end{equation}
for all $n>16$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302311.
