...
\title{The empirical recurrence for OEIS A231657, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A231657 counts arrays over $\{0,\dots,2\}$ in which every cell is constrained by the
...
OEIS A231657 is ``Number of nX2 0..2 arrays with no element less than a strict majority of its horizontal, vertical and antidiagonal neighbors.''. It has offset $1$ and begins
\[
3, 15, 93, 458, 2163, 10789, 53813, 265397,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 06:36:42, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;9\,a(n-1) - 28\,a(n-2) + 65\,a(n-3) - 167\,a(n-4) + 235\,a(n-5) - 237\,a(n-6) + 327\,a(n-7) - 345\,a(n-8) + 267\,a(n-9) - 198\,a(n-10) + 193\,a(n-11) - 88\,a(n-12) + 52\,a(n-13) - 20\,a(n-14) + 16\,a(n-15)
\end{equation}
for all $n>16$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231657.
