...
\title{The empirical recurrence for OEIS A232000, proved by transfer matrix}
...
\begin{abstract}
OEIS A232000 counts $4\times(n+1)$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A232000 is ``Number of (3+1)X(n+1) 0..1 arrays with no element having a strict majority of its horizontal and antidiagonal neighbors equal to one.''. It has offset $1$ and begins
\[
25, 156, 1024, 5778, 28900, 155496, 863041, 4712418,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 06:47:17, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232000.
