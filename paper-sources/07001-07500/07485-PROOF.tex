...
\title{The empirical recurrence for OEIS A297223, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297223 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A297223 is ``Number of nX7 0..1 arrays with every 1 horizontally or antidiagonally adjacent to 1 neighboring 1s.''. It has offset $1$ and begins
\[
13, 145, 1513, 16658, 178469, 1918732, 20599895, 221333623,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 27 2017 15:37:16, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 60\,a(n-2) + 410\,a(n-3) + 804\,a(n-4) - 206\,a(n-5) - 4210\,a(n-6) - 136\,a(n-7) - 4099\,a(n-8) - 6059\,a(n-9) + 20146\,a(n-10) + 14506\,a(n-11) - 16052\,a(n-12) + 4656\,a(n-13) - 228\,a(n-14) - 100\,a(n-15) + 12\,a(n-16)
\end{equation}
for all $n>21$.
...
publishes, $n=17$, the arrays have $7\cdot17$ cells over
$2$ values, so there are about $10^{35}$ of them to sift. The
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297223.
