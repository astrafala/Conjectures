...
\title{The empirical recurrence for OEIS A302809, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A302809 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A302809 is ``Number of 3Xn 0..1 arrays with every element equal to 0, 1, 2, 3 or 5 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
4, 32, 169, 934, 5117, 28128, 154494, 848519,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 13 2018 13:09:58, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 14\,a(n-2) + 2\,a(n-3) - 22\,a(n-4) + 3\,a(n-5) + 37\,a(n-6) - 19\,a(n-7) - 4\,a(n-8) + 24\,a(n-9) - 4\,a(n-10) + 11\,a(n-11) + 8\,a(n-12) + 2\,a(n-13)
\end{equation}
for all $n>15$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302809.
