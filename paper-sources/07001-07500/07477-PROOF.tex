...
\title{The empirical recurrence for OEIS A236980, proved by transfer matrix}
...
\begin{abstract}
OEIS A236980 counts arrays over $\{0,\dots,3\}$ subject to a condition on the order
...
The condition is local to two consecutive rows, so the count is a walk count on $S=98$
...
OEIS A236980 is ``Number of (n+1)X(1+1) 0..3 arrays with the maximum plus the upper median plus the lower median of every 2X2 subblock equal.''. It has offset $1$ and begins
\[
256, 888, 3000, 11388, 43096, 171036, 680872, 2770540,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 09:42:47, revision 7) this is still
...
array, which is not among the objects counted. There are $S=98$ states left.
...
\begin{theorem}
\[
a(n)\;=\;18\,a(n-1) - 49\,a(n-2) - 974\,a(n-3) + 6544\,a(n-4) + 15552\,a(n-5) - 239242\,a(n-6) + 153500\,a(n-7) + 4593459\,a(n-8) - 10260182\,a(n-9) - 52330353\,a(n-10) + 196342530\,a(n-11) + 342078502\,a(n-12) - 2201198668\,a(n-13) - 754500084\,a(n-14) + 16383893648\,a(n-15) - 7843044456\,a(n-16) - 84185730992\,a(n-17) + 91336550688\,a(n-18) + 299169566880\,a(n-19) - 494453981312\,a(n-20) - 710291341312\,a(n-21) + 1690514443008\,a(n-22) + 1001466854912\,a(n-23) - 3875588317184\,a(n-24) - 416161998848\,a(n-25) + 5974812073984\,a(n-26) - 1228457795584\,a(n-27) - 6020740644864\,a(n-28) + 2548308574208\,a(n-29) + 3735935254528\,a(n-30) - 2188695306240\,a(n-31) - 1288941600768\,a(n-32) + 933983944704\,a(n-33) + 210685132800\,a(n-34) - 187026112512\,a(n-35) - 11324620800\,a(n-36) + 13589544960\,a(n-37)
\]
for every $n>36$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A236980.
