...
\title{The empirical recurrence for OEIS A253872, proved by transfer matrix}
...
\begin{abstract}
OEIS A253872 counts the arrays over $\{0,\dots,1\}$ whose $3\times3$ subblocks carry a
...
so the count is a walk count on $S=448$ states --- the last two array rows together with the
...
OEIS A253872 is ``Number of (2+2) X (n+2) 0..1 arrays with every 3 X 3 subblock diagonal maximum minus antidiagonal minimum nondecreasing horizontally, vertically and ne-to-sw antidiagonally.''. It has offset $1$ and begins
\[
3328, 31632, 288000, 2546432, 22201600, 192159408, 1655991552, 14230568608,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 23 2025 09:49:07, revision 10) this is still
...
\]
on the $S=448$ reachable states. In particular $a$ is $C$-finite. The alignment of the walk
...
\begin{theorem}
\[
a(n)\;=\;13\,a(n-1) - 37\,a(n-2) - 95\,a(n-3) + 1181\,a(n-4) - 3897\,a(n-5) + 1721\,a(n-6) - 11813\,a(n-7) + 86096\,a(n-8) - 17360\,a(n-9) - 280192\,a(n-10) + 266368\,a(n-11) - 103680\,a(n-12) + 1683712\,a(n-13) - 11894784\,a(n-14) + 12763136\,a(n-15) + 24772608\,a(n-16) - 31457280\,a(n-17) - 12582912\,a(n-18) + 16777216\,a(n-19)
\]
for every $n>19$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253872.
