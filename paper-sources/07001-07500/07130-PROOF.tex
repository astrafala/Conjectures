...
\title{The empirical recurrence for OEIS A237802, proved by transfer matrix}
...
\begin{abstract}
OEIS A237802 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
OEIS A237802 is ``Number of (n+1) X (1+1) 0..2 arrays with the maximum plus the upper median minus the minimum of every 2 X 2 subblock equal.''. It has offset $1$ and begins
\[
81, 295, 1085, 4251, 16837, 67947, 276369, 1134515,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 26 2025 15:50:46, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-1) + 15\,a(n-2) - 179\,a(n-3) - a(n-4) + 1813\,a(n-5) - 1183\,a(n-6) - 9345\,a(n-7) + 9082\,a(n-8) + 26172\,a(n-9) - 31096\,a(n-10) - 38996\,a(n-11) + 54928\,a(n-12) + 26992\,a(n-13) - 49024\,a(n-14) - 4160\,a(n-15) + 18816\,a(n-16) - 2304\,a(n-17) - 1536\,a(n-18)
\]
for every $n>17$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237802.
