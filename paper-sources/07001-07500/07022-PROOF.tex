...
\title{The empirical recurrence for OEIS A281568, proved by transfer matrix}
...
\begin{abstract}
OEIS A281568 counts $6\times n$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A281568 is ``Number of 6Xn 0..1 arrays with no element equal to more than two of its horizontal, diagonal or antidiagonal neighbors, with the exception of exactly two elements, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
0, 310, 18020, 53568, 154722, 347316, 692421, 1275888,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 24 2017 08:41:04, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) - 15\,a(n-2) + 23\,a(n-3) - 30\,a(n-4) + 36\,a(n-5) - 31\,a(n-6) + 12\,a(n-7) + 9\,a(n-8) - 23\,a(n-9) + 33\,a(n-10) - 36\,a(n-11) + 23\,a(n-12) - 3\,a(n-13) - 9\,a(n-14) + 12\,a(n-15) - 12\,a(n-16) + 9\,a(n-17) - 2\,a(n-18) - 3\,a(n-19) + 3\,a(n-20) - a(n-21)
\]
for every $n>37$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A281568.
