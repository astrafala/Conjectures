...
\title{The empirical recurrence for OEIS A250700, proved by transfer matrix}
...
\begin{abstract}
OEIS A250700 counts arrays over $\{0,1,2,3\}$ in which a statistic taken over short runs
...
OEIS A250700 is ``Number of (n+1)X(1+1) 0..3 arrays with nondecreasing x(i,j)+x(i,j-1) in the i direction and nondecreasing min(x(i,j),x(i-1,j)) in the j direction.''. It has offset $1$ and begins
\[
100, 536, 2435, 10050, 38431, 138957, 480846, 1607723,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 12:42:58, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250700.
