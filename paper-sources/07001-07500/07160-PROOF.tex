...
\title{The empirical recurrence for OEIS A253835, proved by transfer matrix}
...
\begin{abstract}
OEIS A253835 counts the arrays over $\{0,\dots,1\}$ whose $3\times3$ subblocks carry a
...
so the count is a walk count on $S=1364$ states --- the last two array rows together with the
...
OEIS A253835 is ``Number of (n+2)X(2+2) 0..1 arrays with every 3X3 subblock diagonal sum plus antidiagonal sum nondecreasing horizontally, vertically and ne-to-sw antidiagonally.''. It has offset $1$ and begins
\[
2440, 6339, 19970, 60741, 129378, 265117, 517697, 920743,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 14:16:40, revision 6) this is still
...
\]
on the $S=1364$ reachable states. In particular $a$ is $C$-finite. The alignment of the walk
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) - a(n-2) + 6\,a(n-4) - 12\,a(n-5) + 8\,a(n-6) - 4\,a(n-7) - 7\,a(n-8) + 18\,a(n-9) - 21\,a(n-10) + 24\,a(n-11) - 9\,a(n-12) - 6\,a(n-13) + 21\,a(n-14) - 36\,a(n-15) + 24\,a(n-16) - 12\,a(n-17) - 2\,a(n-18) + 16\,a(n-19) - 17\,a(n-20) + 18\,a(n-21) - 9\,a(n-22) + 4\,a(n-24) - 8\,a(n-25) + 4\,a(n-26)
\]
for every $n>30$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253835.
