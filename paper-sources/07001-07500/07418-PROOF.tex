...
\title{The empirical recurrence for OEIS A301321, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A301321 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A301321 is ``Number of nX6 0..1 arrays with every element equal to 0, 1, 2, 5 or 6 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
32, 383, 735, 1709, 3649, 7600, 15802, 33150,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 5*a(n-1) -8*a(n-2) +4*a(n-3) +2*a(n-7) -2*a(n-8) -3*a(n-9) +5*a(n-10) -a(n-11) -a(n-12) -a(n-14) +a(n-15) for n>19
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 18 2018 08:31:14, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) - 8\,a(n-2) + 4\,a(n-3) + 2\,a(n-7) - 2\,a(n-8) - 3\,a(n-9) + 5\,a(n-10) - a(n-11) - a(n-12) - a(n-14) + a(n-15)
\end{equation}
for all $n>19$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A301321.
