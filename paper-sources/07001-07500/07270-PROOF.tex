...
\title{The empirical recurrence for OEIS A254736, proved by transfer matrix}
...
\begin{abstract}
OEIS A254736 counts the arrays over $\{0,\dots,1\}$ whose $3\times3$ subblocks carry a
...
so the count is a walk count on $S=128$ states --- the last two array rows together with the
...
OEIS A254736 is ``Number of (n+2) X (1+2) 0..1 arrays with every 3 X 3 subblock sum of the two medians of the central row and column minus the sum of the minimums of the diagonal and antidiagonal nondecreasing horizontally and vertically.''. It has offset $1$ and begins
\[
512, 2848, 13504, 62579, 281213, 1223367, 5203324, 21804750,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 01 2026 15:47:51, revision 8) this is still
...
\]
on the $S=128$ reachable states. In particular $a$ is $C$-finite. The alignment of the walk
...
\begin{theorem}
\[
a(n)\;=\;9\,a(n-1) - 28\,a(n-2) + 46\,a(n-3) - 59\,a(n-4) - 81\,a(n-5) + 576\,a(n-6) - 1373\,a(n-7) + 2977\,a(n-8) - 4744\,a(n-9) + 6620\,a(n-10) - 10881\,a(n-11) + 14299\,a(n-12) - 20512\,a(n-13) + 28752\,a(n-14) - 21216\,a(n-15) + 5616\,a(n-16)
\]
for every $n>20$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A254736.
