...
\title{The empirical recurrence for OEIS A252680, proved by transfer matrix}
...
\begin{abstract}
OEIS A252680 counts $3\times(n+2)$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252680 is ``Number of (1+2)X(n+2) 0..3 arrays with every 3X3 subblock row and diagonal sum equal to 0 2 5 6 or 7 and every 3X3 column and antidiagonal sum not equal to 0 2 5 6 or 7.''. It has offset $1$ and begins
\[
656, 775, 901, 1246, 1802, 2564, 3654, 6075,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:31:18, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;18\,a(n-3) + a(n-4) - 130\,a(n-6) - 15\,a(n-7) + 490\,a(n-9) + 80\,a(n-10) - a(n-11) - 1052\,a(n-12) - 161\,a(n-13) + 15\,a(n-14) + 1290\,a(n-15) - 53\,a(n-16) - 89\,a(n-17) - 794\,a(n-18) + 766\,a(n-19) + 268\,a(n-20) + 55\,a(n-21) - 1310\,a(n-22) - 426\,a(n-23) + 220\,a(n-24) + 935\,a(n-25) + 310\,a(n-26) - 101\,a(n-27) - 138\,a(n-28) + 9\,a(n-30) - 209\,a(n-31) - 141\,a(n-32) - 24\,a(n-33) + 124\,a(n-34) + 84\,a(n-35) + 20\,a(n-36) - 20\,a(n-37) - 20\,a(n-38)
\]
for every $n>48$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252680.
