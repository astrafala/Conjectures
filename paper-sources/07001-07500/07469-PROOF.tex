...
\title{The empirical recurrence for OEIS A252134, proved by transfer matrix}
...
\begin{abstract}
OEIS A252134 counts $(n+2)\times5$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252134 is ``Number of (n+2)X(3+2) 0..3 arrays with every 3X3 subblock row, column, diagonal and antidiagonal sum not equal to 0 3 4 6 or 7.''. It has offset $1$ and begins
\[
209, 431, 1535, 5233, 18047, 62277, 213689, 735011,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 10:50:11, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 11\,a(n-3) + 20\,a(n-4) + 12\,a(n-5) - 7\,a(n-6) - 69\,a(n-7) - 49\,a(n-8) + 69\,a(n-9) + 59\,a(n-10) - 9\,a(n-11) - 30\,a(n-12) - 14\,a(n-13) + 2\,a(n-14) + 4\,a(n-16)
\]
for every $n>17$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252134.
