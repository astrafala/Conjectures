...
\title{The empirical recurrence for OEIS A234725, proved by transfer matrix}
...
\begin{abstract}
OEIS A234725 carries an empirical recurrence of order $30$ contributed by R. H. Hardin. It is
...
OEIS A234725 is ``Number of (n+1) X (5+1) 0..7 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 7 (constant-stress 1 X 1 tilings).''. It has offset $1$ and begins
\[
74496, 168928, 360760, 1000264, 2557656, 8002936, 23194936, 78550072,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 20 2022 18:57:18, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234725.
