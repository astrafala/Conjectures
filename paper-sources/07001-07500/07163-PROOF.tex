...
\title{The empirical recurrence for OEIS A295092, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A295092 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A295092 is ``Number of nX3 0..1 arrays with each 1 horizontally or vertically adjacent to 1 or 3 1s.''. It has offset $1$ and begins
\[
3, 11, 33, 114, 377, 1249, 4151, 13765,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) +3*a(n-3) -a(n-4) +11*a(n-5) -5*a(n-6) -14*a(n-8) -4*a(n-9) -9*a(n-10) -a(n-11) +a(n-12) +4*a(n-14) +a(n-16)
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 14 2017 11:14:00, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 3\,a(n-3) - a(n-4) + 11\,a(n-5) - 5\,a(n-6) - 14\,a(n-8) - 4\,a(n-9) - 9\,a(n-10) - a(n-11) + a(n-12) + 4\,a(n-14) + a(n-16)
\end{equation}
for all $n>17$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A295092.
