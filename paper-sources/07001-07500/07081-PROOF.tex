...
\title{The empirical recurrence for OEIS A254842, proved by transfer matrix}
...
\begin{abstract}
OEIS A254842 counts the arrays over $\{0,\dots,1\}$ whose $3\times3$ subblocks carry a
...
OEIS A254842 is ``Number of (n+2)X(5+2) 0..1 arrays with every 3X3 subblock sum of the medians of the diagonal and antidiagonal minus the two sums of the central row and column nondecreasing horizontally and vertically.''. It has offset $1$ and begins
\[
99200, 298165, 638688, 1308339, 2423232, 4446577, 7695684, 12905204,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 14:59:16, revision 10) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A254842.
