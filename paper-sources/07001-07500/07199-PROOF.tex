...
\title{The empirical recurrence for OEIS A236083, proved by transfer matrix}
...
\begin{abstract}
OEIS A236083 counts arrays over $\{0,\dots,3\}$ subject to a condition on the order
...
OEIS A236083 is ``Number of (n+1)X(1+1) 0..3 arrays colored with the difference of the upper median and the minimum in each 2X2 subblock.''. It has offset $1$ and begins
\[
256, 2400, 22506, 211560, 1998580, 18841712, 177646290, 1674513256,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 09:04:44, revision 7) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The $2\times2$ subblocks of an $(n+1)\times2$ array form an
$n\times1$ grid. Colour each of them by $\sigma=-a+c$, where $a\le b\le c\le d$ are its four entries sorted --- its minimum, lower median, upper median and maximum. ``Coloured with'' is the entry's way of
...
\begin{theorem}
\[
a(n)\;=\;224\,a(n-3) + 2810\,a(n-4) + 13856\,a(n-5) + 90672\,a(n-6) + 291072\,a(n-7) + 952484\,a(n-8) + 1912080\,a(n-9) - 1157526\,a(n-10) - 12079672\,a(n-11) - 80765163\,a(n-12) - 186815512\,a(n-13) - 311515244\,a(n-14) - 242959664\,a(n-15) + 1413551712\,a(n-16) + 3132342592\,a(n-17) + 6646937984\,a(n-18) + 3604272384\,a(n-19) - 10896930560\,a(n-20) - 17680504832\,a(n-21) - 26707124224\,a(n-22) + 5417844736\,a(n-23) + 14742724608\,a(n-24) + 16130326528\,a(n-25) + 19947962368\,a(n-26) - 13724549120\,a(n-27) + 9831972864\,a(n-28) - 12022972416\,a(n-29)
\]
for every $n>29$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A236083.
