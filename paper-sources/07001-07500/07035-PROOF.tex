...
\title{The empirical recurrence for OEIS A252618, proved by transfer matrix}
...
\begin{abstract}
OEIS A252618 counts $5\times(n+2)$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252618 is ``Number of (3+2)X(n+2) 0..3 arrays with every 3X3 subblock row and diagonal sum equal to 0 3 5 6 or 8 and every 3X3 column and antidiagonal sum not equal to 0 3 5 6 or 8.''. It has offset $1$ and begins
\[
1042, 2817, 7031, 17762, 58239, 156499, 437805, 1506801,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:27:25, revision 6) this is still
...
$\{0,\dots,3\}^{5}$. A $3\times3$ subblock occupies three consecutive columns and
...
\begin{theorem}
\[
a(n)\;=\;64\,a(n-3) - 1475\,a(n-6) + 16806\,a(n-9) - 109891\,a(n-12) + 449148\,a(n-15) - 1217688\,a(n-18) + 2303890\,a(n-21) - 3171129\,a(n-24) + 3207942\,a(n-27) - 2291813\,a(n-30) + 1076912\,a(n-33) - 308227\,a(n-36) + 49142\,a(n-39) - 3776\,a(n-42) + 96\,a(n-45)
\]
for every $n>48$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252618.
