...
\title{The empirical recurrence for OEIS A261376, proved by transfer matrix}
...
\begin{abstract}
OEIS A261376 counts $(n+2)\times6$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A261376 is ``Number of (n+2)X(4+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00001011 00010101 or 01010101.''. It has offset $1$ and begins
\[
97, 157, 424, 1040, 2282, 5254, 12500, 28885,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 17 2015 08:30:12, revision 4) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A261376.
