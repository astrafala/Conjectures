...
\title{The empirical recurrence for OEIS A260977, proved by transfer matrix}
...
\begin{abstract}
OEIS A260977 counts $(n+2)\times7$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A260977 is ``Number of (n+2)X(5+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000001 00001001 or 00100101.''. It has offset $1$ and begins
\[
1146, 925, 1288, 2714, 4592, 9144, 14672, 29768,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 12:13:30, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;12\,a(n-4) + 4\,a(n-5) + 4\,a(n-7) - 15\,a(n-8) - 32\,a(n-9) - 3\,a(n-10) - 34\,a(n-11) + a(n-12) + 16\,a(n-13) + 8\,a(n-14) + 28\,a(n-15) - 51\,a(n-16) + 40\,a(n-17) + 16\,a(n-18) - 36\,a(n-19) + 33\,a(n-20) + 224\,a(n-21) - 4\,a(n-23) + 64\,a(n-24) + 128\,a(n-25) - 24\,a(n-27) + 64\,a(n-28)
\]
for every $n>34$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A260977.
