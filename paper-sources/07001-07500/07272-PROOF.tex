...
\title{The empirical recurrence for OEIS A302417, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A302417 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A302417 is ``Number of 4Xn 0..1 arrays with every element equal to 0, 1, 2 or 5 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
8, 81, 120, 259, 698, 1650, 3655, 8544,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 07 2018 17:04:54, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) - 3\,a(n-2) + 6\,a(n-3) - 6\,a(n-4) + 3\,a(n-5) - 6\,a(n-6) + a(n-7) - 14\,a(n-8) + 9\,a(n-9) + 4\,a(n-10) + 2\,a(n-11) - 4\,a(n-12) + 2\,a(n-13) + 8\,a(n-15) - 4\,a(n-16)
\end{equation}
for all $n>21$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302417.
