...
\title{The empirical recurrence for OEIS A259740, proved by transfer matrix}
...
\begin{abstract}
OEIS A259740 counts $(n+2)\times8$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
every $3\times3$ subblock, and it carries an empirical recurrence of order $20$
...
OEIS A259740 is ``Number of (n+2) X (6+2) 0..1 arrays with each 3 X 3 subblock having clockwise perimeter pattern 00010101 or 01010101.''. It has offset $1$ and begins
\[
152, 414, 1514, 4456, 12086, 36522, 110886, 321402,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 11 2023 08:05:45, revision 6) this is still
...
\[
\text{the clockwise perimeter word of }g\text{ is a rotation of one of }\{00010101,\ 01010101\}
\]
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 9\,a(n-3) + 18\,a(n-4) + 14\,a(n-5) + 19\,a(n-6) - 13\,a(n-7) - 67\,a(n-8) - 38\,a(n-9) + 19\,a(n-10) + 49\,a(n-11) + 50\,a(n-12) - 16\,a(n-13) - 41\,a(n-14) - 5\,a(n-15) - a(n-16) - 7\,a(n-17) + 3\,a(n-18) + 2\,a(n-19) + a(n-20)
\]
for every $n>22$.
\end{theorem}
...
at once. By Lemma~\ref{lem:crit} the recurrence holds for every $n>22$. The bound is exact: at $n=22$ the recurrence fails on the entry's own published terms, so no larger range holds.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A259740.
