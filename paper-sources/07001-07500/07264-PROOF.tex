...
\title{The empirical recurrence for OEIS A207266, proved by transfer matrix}
...
\begin{abstract}
OEIS A207266 counts arrays over $\{0,\dots,1\}$ of width $5$ that avoid the patterns
...
OEIS A207266 is ``Number of nX5 0..1 arrays avoiding 0 0 0 and 0 1 1 horizontally and 0 1 1 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
13, 169, 499, 1602, 5904, 18055, 52240,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 13:41:57, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;8\,a(n-1) - 27\,a(n-2) + 82\,a(n-3) - 276\,a(n-4) + 660\,a(n-5) - 1362\,a(n-6) + 3271\,a(n-7) - 6143\,a(n-8) + 9753\,a(n-9) - 19244\,a(n-10) + 29834\,a(n-11) - 37603\,a(n-12) + 66818\,a(n-13) - 88111\,a(n-14) + 87735\,a(n-15) - 154593\,a(n-16) + 176242\,a(n-17) - 132824\,a(n-18) + 260799\,a(n-19) - 257210\,a(n-20) + 131101\,a(n-21) - 335989\,a(n-22) + 283983\,a(n-23) - 71632\,a(n-24) + 332714\,a(n-25) - 241037\,a(n-26) - 2610\,a(n-27) - 250116\,a(n-28) + 160089\,a(n-29) + 38528\,a(n-30) + 138104\,a(n-31) - 83144\,a(n-32) - 32003\,a(n-33) - 51828\,a(n-34) + 31992\,a(n-35) + 13212\,a(n-36) + 11628\,a(n-37) - 8424\,a(n-38) - 2376\,a(n-39) - 1296\,a(n-40) + 1296\,a(n-41)
\end{equation}
for all $n>44$. 
...
index corresponding to $n=44+1$ onwards, and the run was continued past $S$ consecutive
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207266.
