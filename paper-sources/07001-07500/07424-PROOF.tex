...
\title{The empirical recurrence for OEIS A295347, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A295347 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A295347 is ``Number of nX3 0..1 arrays with each 1 horizontally or vertically adjacent to 0, 2 or 3 1s.''. It has offset $1$ and begins
\[
5, 20, 76, 299, 1198, 4775, 19214, 77650,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 20 2017 12:18:49, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) - 4\,a(n-2) - 13\,a(n-3) - 8\,a(n-4) - 17\,a(n-5) + 35\,a(n-6) - 14\,a(n-7) + 43\,a(n-8) + 48\,a(n-9) - 41\,a(n-10) + 43\,a(n-11) - 25\,a(n-12) - 5\,a(n-13) - 18\,a(n-14) - a(n-15) + 2\,a(n-16) + a(n-17) + a(n-18)
\end{equation}
for all $n>19$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A295347.
