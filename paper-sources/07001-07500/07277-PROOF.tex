...
\title{The empirical recurrence for OEIS A207897, proved by transfer matrix}
...
\begin{abstract}
OEIS A207897 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
...
OEIS A207897 is ``Number of 4Xn 0..1 arrays avoiding 0 0 0 and 1 0 1 horizontally and 0 0 0 and 1 1 1 vertically.''. It has offset
$1$ and begins
\[
10, 100, 292, 870, 2446, 6952, 20168,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:25:23, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-2) + 10\,a(n-3) + 18\,a(n-4) - 2\,a(n-5) - 22\,a(n-6) - 7\,a(n-7) - 12\,a(n-9) - 8\,a(n-10) - 6\,a(n-11) - 6\,a(n-12) - 3\,a(n-13) - a(n-14) + 3\,a(n-15) + a(n-16) - a(n-17)
\end{equation}
...
$(0,0,0), (1,1,1)$ as $3$ consecutive entries. There are $10$ admissible columns; that condition
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207897.
