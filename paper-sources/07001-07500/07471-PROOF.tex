...
\title{The empirical recurrence for OEIS A184451, proved by transfer matrix}
...
\begin{abstract}
OEIS A184451 counts arrays of width $5$ over $\{0,1,2\}$ in which every $3\times3$ subblock
satisfies a condition on its nine entries. The entry carries an empirical recurrence of order
$24$ contributed by R.~H.~Hardin. It is true, and it is decidable rather than empirical: a
...
OEIS A184451 is ``1/36 the number of (n+2)X5 0..2 arrays with each 3X3 subblock containing two of one value, two of another, and five of the last.''. It has offset $1$ and begins
\[
864, 1591, 3125, 6880, 20706, 67180, 232326, 967138,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 02:38:17, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) - 11\,a(n-2) + 195\,a(n-3) - 1134\,a(n-4) + 2079\,a(n-5) - 11600\,a(n-6) + 62796\,a(n-7) - 115126\,a(n-8) + 263520\,a(n-9) - 1204344\,a(n-10) + 2207964\,a(n-11) - 2907648\,a(n-12) + 10219824\,a(n-13) - 18736344\,a(n-14) + 17243280\,a(n-15) - 42140736\,a(n-16) + 77258016\,a(n-17) - 55857600\,a(n-18) + 82301184\,a(n-19) - 150885504\,a(n-20) + 92378880\,a(n-21) - 60466176\,a(n-22) + 110854656\,a(n-23) - 60466176\,a(n-24)
\]
for every $n>24$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A184451.
