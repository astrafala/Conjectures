...
\title{The empirical recurrence for OEIS A250438, proved by transfer matrix}
...
\begin{abstract}
OEIS A250438 counts arrays over $\{0,1,2\}$ in which a statistic taken over short runs
...
window of consecutive rows, so the count is a walk count on $S=1296$ states, and the
...
OEIS A250438 is ``Number of (n+1)X(3+1) 0..2 arrays with nondecreasing sum of every two consecutive values in every row and column.''. It has offset $1$ and begins
\[
1296, 14400, 160000, 1000000, 6250000, 27562500, 121550625, 423536400,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 12:24:48, revision 6) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=1296,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250438.
