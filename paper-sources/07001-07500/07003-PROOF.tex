...
\title{The empirical recurrence for OEIS A301603, proved by transfer matrix}
...
\begin{abstract}
OEIS A301603 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A301603 is ``Number of nX3 0..1 arrays with every element equal to 0, 2 or 3 horizontally or vertically adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 2, 2, 8, 13, 26, 55, 154,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 24 2018 11:30:18, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 3\,a(n-2) + 4\,a(n-3) + 2\,a(n-4) - 8\,a(n-5) - 17\,a(n-6) - 19\,a(n-7) - 9\,a(n-8) + 6\,a(n-9) + 21\,a(n-10) + 15\,a(n-11) + 11\,a(n-12) - 2\,a(n-13) - 2\,a(n-14) - 4\,a(n-15) - a(n-16) - a(n-17) + a(n-18)
\end{equation}
for all $n>18$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A301603.
