...
\title{The empirical recurrence for OEIS A237532, proved by transfer matrix}
...
\begin{abstract}
OEIS A237532 counts arrays over $\{0,\dots,3\}$ subject to a condition on the order
...
The condition is local to two consecutive rows, so the count is a walk count on $S=50$
...
OEIS A237532 is ``Number of (n+1) X (1+1) 0..3 arrays with the upper median minus the lower median of every 2 X 2 subblock equal.''. It has offset $1$ and begins
\[
256, 1692, 11602, 83104, 598364, 4364082, 31944336, 235256268,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 27 2026 09:59:20, revision 9) this is still
...
array, which is not among the objects counted. There are $S=50$ states left.
...
\begin{theorem}
\[
a(n)\;=\;18\,a(n-1) - 64\,a(n-2) - 539\,a(n-3) + 3795\,a(n-4) + 1414\,a(n-5) - 58056\,a(n-6) + 84851\,a(n-7) + 309622\,a(n-8) - 875960\,a(n-9) - 155176\,a(n-10) + 2621808\,a(n-11) - 2284736\,a(n-12) - 1589504\,a(n-13) + 3589120\,a(n-14) - 2039808\,a(n-15) + 393216\,a(n-16)
\]
for every $n>15$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237532.
