...
\title{The empirical recurrence for OEIS A300634, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A300634 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A300634 is ``Number of nX3 0..1 arrays with every element equal to 1, 2, 4 or 5 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
1, 6, 13, 34, 91, 253, 705, 1978,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 10 2018 10:23:19, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;7\,a(n-1) - 19\,a(n-2) + 28\,a(n-3) - 32\,a(n-4) + 42\,a(n-5) - 43\,a(n-6) + 23\,a(n-7) - 29\,a(n-8) + 16\,a(n-9) + 12\,a(n-10) + 64\,a(n-11) + 58\,a(n-12) - 110\,a(n-13) - 198\,a(n-14) - 136\,a(n-15) + 100\,a(n-16) + 236\,a(n-17) + 198\,a(n-18) + 90\,a(n-19) + 30\,a(n-20) - 16\,a(n-21) - 76\,a(n-22) - 64\,a(n-23) + 7\,a(n-24) + 23\,a(n-25) - 7\,a(n-26) - 20\,a(n-27) - 4\,a(n-28) + 10\,a(n-29) + 5\,a(n-30) - a(n-31) - a(n-32)
\end{equation}
for all $n>33$.
...
\#\{\text{neighbours with a value }equal to\ x_{t,u}\}\in\{1,2,4,5\}
\end{equation}
...
publishes, $n=27$, the arrays have $3\cdot27$ cells over
$2$ values, so there are about $10^{24}$ of them to sift. The
walk count replaces that by $64$ states and one matrix--vector product per row.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A300634.
