...
\title{The empirical recurrence for OEIS A261261, proved by transfer matrix}
...
\begin{abstract}
OEIS A261261 counts $(n+2)\times6$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A261261 is ``Number of (n+2)X(4+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00010101 00100101 or 01010101.''. It has offset $1$ and begins
\[
166, 232, 690, 1918, 4350, 10382, 26072, 63964,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 13 2015 06:37:01, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 5\,a(n-3) + 4\,a(n-4) + 8\,a(n-5) + 7\,a(n-6) + 7\,a(n-7) + 5\,a(n-8) - 5\,a(n-9) - 8\,a(n-10) - 7\,a(n-11) - 5\,a(n-12) - a(n-13) + a(n-14) + a(n-15) + a(n-16)
\]
for every $n>17$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A261261.
