...
\title{The empirical recurrence for OEIS A303508, proved by transfer matrix}
...
\begin{abstract}
OEIS A303508 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A303508 is ``Number of nX3 0..1 arrays with every element equal to 0, 1, 2, 4, 5 or 6 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
4, 20, 78, 420, 2088, 9916, 49740, 245904,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 25 2018 12:25:21, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 6\,a(n-2) + 36\,a(n-3) - 58\,a(n-4) - 116\,a(n-5) - 196\,a(n-6) - 160\,a(n-7) - 36\,a(n-8) - 240\,a(n-9) - 64\,a(n-10) + 232\,a(n-11) + 184\,a(n-12) - 64\,a(n-14)
\end{equation}
for all $n>14$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A303508.
