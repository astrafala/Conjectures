...
\title{The empirical recurrence for OEIS A264671, proved by transfer matrix}
...
\begin{abstract}
OEIS A264671 carries an empirical recurrence of order $15$ contributed by R.~H.~Hardin. It is
...
OEIS A264671 is ``Number of (n+1)X(3+1) arrays of permutations of 0..n*4+3 with each element having directed index change -1,-1 1,0 -1,-2 -2,-2 or 0,1.''. It has offset $1$ and begins
\[
1, 10, 34, 145, 603, 2417, 9976, 40825,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 20 2015 19:48:23, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 6\,a(n-2) + 10\,a(n-3) + 6\,a(n-5) + 11\,a(n-6) + 4\,a(n-7) + 22\,a(n-8) + 21\,a(n-9) - 4\,a(n-10) - 10\,a(n-11) - 10\,a(n-12) - 2\,a(n-13) + a(n-15)
\]
for every $n>15$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264671.
