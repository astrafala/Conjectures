...
\title{The empirical recurrence for OEIS A231297, proved by transfer matrix}
...
\begin{abstract}
OEIS A231297 counts $(n+1)\times4$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A231297 is ``Number of (n+1)X(3+1) 0..2 arrays with no element unequal to a strict majority of its horizontal, vertical and antidiagonal neighbors, with values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
4, 16, 69, 301, 1414, 6850, 33316, 162796,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 06:23:04, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + 17\,a(n-2) - 23\,a(n-3) - 78\,a(n-4) - 11\,a(n-5) + 143\,a(n-6) + 431\,a(n-7) - 362\,a(n-8) - 763\,a(n-9) + 176\,a(n-10) - 60\,a(n-11) + 336\,a(n-12) + 448\,a(n-13) - 256\,a(n-14)
\]
for every $n>16$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231297.
