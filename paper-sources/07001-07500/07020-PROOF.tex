...
\title{The empirical recurrence for OEIS A264623, proved by transfer matrix}
...
\begin{abstract}
OEIS A264623 carries an empirical recurrence of order $45$ contributed by R.~H.~Hardin. It is
...
OEIS A264623 is ``Number of (n+1)X(3+1) arrays of permutations of 0..n*4+3 with each element having directed index change -2,0 -1,0 0,-1 or 1,1.''. It has offset $1$ and begins
\[
0, 4, 13, 22, 61, 280, 832, 2373,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 19 2015 06:51:33, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-2) + 10\,a(n-3) + 33\,a(n-4) - 5\,a(n-5) - 175\,a(n-6) - 235\,a(n-7) - 281\,a(n-8) + 137\,a(n-9) + 1360\,a(n-10) + 1709\,a(n-11) + 923\,a(n-12) - 602\,a(n-13) - 3180\,a(n-14) - 4831\,a(n-15) - 3269\,a(n-16) + 499\,a(n-17) + 3130\,a(n-18) + 4030\,a(n-19) + 4286\,a(n-20) + 2250\,a(n-21) - 653\,a(n-22) - 816\,a(n-23) - 617\,a(n-24) - 1339\,a(n-25) - 1262\,a(n-26) - 109\,a(n-27) + 234\,a(n-28) - 419\,a(n-29) - 307\,a(n-30) + 265\,a(n-31) + 234\,a(n-32) + 80\,a(n-33) - 114\,a(n-34) + 69\,a(n-35) + 143\,a(n-36) - 99\,a(n-37) - 22\,a(n-38) + 28\,a(n-39) + 11\,a(n-40) - 9\,a(n-41) - 14\,a(n-42) + 15\,a(n-43) - 6\,a(n-44) + a(n-45)
\]
for every $n>43$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264623.
