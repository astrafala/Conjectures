...
\title{The empirical recurrence for OEIS A236807, proved by transfer matrix}
...
\begin{abstract}
OEIS A236807 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
The condition is local to two consecutive rows, so the count is a walk count on $S=5535$
...
OEIS A236807 is ``Number of (n+1)X(6+1) 0..2 arrays with the maximum plus the lower median minus the upper median minus the minimum of every 2X2 subblock equal.''. It has offset $1$ and begins
\[
75907, 2926867, 107087939, 5140896385, 203606804707, 11092792124317, 457619414560859, 27133853757874765,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 09:34:34, revision 6) this is still
...
$6$ subblocks they form. So a row is a state, an $(n+1)$-row array is a walk of $n$
...
array, which is not among the objects counted. There are $S=5535$ states left.
...
\begin{theorem}
\[
a(n)\;=\;66\,a(n-1) + 6693\,a(n-2) - 517398\,a(n-3) - 12402284\,a(n-4) + 1417737384\,a(n-5) - 1644793764\,a(n-6) - 1564727002056\,a(n-7) + 21216496783968\,a(n-8) + 527850835201152\,a(n-9) - 12351354216581376\,a(n-10) + 54620084393888256\,a(n-11) - 1596475030394880\,a(n-12) - 411721665197137920\,a(n-13) + 648256268849283072\,a(n-14) + 287629499666792448\,a(n-15) - 1191655214366588928\,a(n-16) + 626271353535725568\,a(n-17)
\]
for every $n>16$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A236807.
