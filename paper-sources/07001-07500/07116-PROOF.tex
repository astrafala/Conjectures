...
\title{The empirical recurrence for OEIS A252386, proved by transfer matrix}
...
\begin{abstract}
OEIS A252386 counts $4\times(n+2)$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252386 is ``Number of (2+2)X(n+2) 0..3 arrays with every 3X3 subblock row and diagonal sum equal to 0 3 5 6 or 7 and every 3X3 column and antidiagonal sum not equal to 0 3 5 6 or 7.''. It has offset $1$ and begins
\[
540, 555, 647, 771, 1067, 1496, 1928, 2662,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 9*a(n-3) -32*a(n-6) +58*a(n-9) -58*a(n-12) +32*a(n-15) -9*a(n-18) +a(n-21) for n>30
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:09:43, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;9\,a(n-3) - 32\,a(n-6) + 58\,a(n-9) - 58\,a(n-12) + 32\,a(n-15) - 9\,a(n-18) + a(n-21)
\]
for every $n>30$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252386.
