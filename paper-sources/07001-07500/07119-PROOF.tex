...
\title{The empirical recurrence for OEIS A207732, proved by transfer matrix}
...
\begin{abstract}
OEIS A207732 counts arrays over $\{0,\dots,1\}$ of width $5$ that avoid the patterns
...
OEIS A207732 is ``Number of 5Xn 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 1 1 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
14, 196, 490, 1225, 8575, 60025, 211680,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:13:45, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 21\,a(n-3) + 285\,a(n-4) + 40\,a(n-5) + 116\,a(n-6) - 1248\,a(n-7) - 17520\,a(n-8) - 5440\,a(n-9) + 3712\,a(n-10) + 13824\,a(n-11) + 291840\,a(n-12) + 102400\,a(n-13) + 131072\,a(n-15) - 1048576\,a(n-16)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207732.
