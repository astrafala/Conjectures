...
\title{The empirical recurrence for OEIS A252409, proved by transfer matrix}
...
\begin{abstract}
OEIS A252409 counts $4\times(n+2)$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252409 is ``Number of (2+2)X(n+2) 0..3 arrays with every 3X3 subblock row and diagonal sum equal to 2 3 4 6 or 7 and every 3X3 column and antidiagonal sum not equal to 2 3 4 6 or 7.''. It has offset $1$ and begins
\[
293, 442, 774, 1157, 2489, 5060, 8307, 19629,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 20*a(n-3) -124*a(n-6) +249*a(n-9) -145*a(n-12) -58*a(n-15) +74*a(n-18) -15*a(n-21) for n>26
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:11:38, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;20\,a(n-3) - 124\,a(n-6) + 249\,a(n-9) - 145\,a(n-12) - 58\,a(n-15) + 74\,a(n-18) - 15\,a(n-21)
\]
for every $n>26$.
\end{theorem}
...
at once. By Lemma~\ref{lem:crit} the recurrence holds for every $n>26$. The bound is exact: at $n=26$ the recurrence fails on the entry's own published terms, so no larger range holds.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252409.
