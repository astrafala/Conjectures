...
\title{The empirical recurrence for OEIS A260101, proved by transfer matrix}
...
\begin{abstract}
OEIS A260101 counts $(n+2)\times5$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A260101 is ``Number of (n+2)X(3+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000001 00000101 or 00010101.''. It has offset $1$ and begins
\[
206, 477, 1136, 2768, 6878, 17125, 42372, 104772,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 12:00:30, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-2) + 3\,a(n-3) + 13\,a(n-4) + 9\,a(n-5) - a(n-6) - 15\,a(n-7) - 85\,a(n-8) - 97\,a(n-9) - 130\,a(n-10) - 106\,a(n-11) + 6\,a(n-12) + 115\,a(n-13) + 537\,a(n-14) + 649\,a(n-15) + 592\,a(n-16) + 680\,a(n-17) - 2\,a(n-18) - 661\,a(n-19) - 954\,a(n-20) - 1415\,a(n-21) - 1370\,a(n-22) - 746\,a(n-23) + 52\,a(n-24) + 491\,a(n-25) + 557\,a(n-26) + 394\,a(n-27) - 41\,a(n-28) - 119\,a(n-29) + 32\,a(n-30) + 38\,a(n-31) - 2\,a(n-32) + 6\,a(n-34)
\]
for every $n>35$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A260101.
