...
\title{The empirical recurrence for OEIS A251842, proved by transfer matrix}
...
\begin{abstract}
OEIS A251842 counts $(n+2)\times7$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
$a(n)$ is a walk count on $S=16767$ vertices. Such a sequence is $C$-finite, so whether a given
...
OEIS A251842 is ``Number of (n+2) X (5+2) 0..3 arrays with every 3 X 3 subblock row and column sum nonprime and every diagonal and antidiagonal sum prime.''. It has offset $1$ and begins
\[
1443, 2672, 8582, 18708, 79817, 277125, 616922, 2656032,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 22 2022 01:49:29, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;64\,a(n-3) - 1282\,a(n-6) + 10366\,a(n-9) - 44576\,a(n-12) + 120485\,a(n-15) - 214956\,a(n-18) + 245225\,a(n-21) - 170457\,a(n-24) + 68626\,a(n-27) - 15983\,a(n-30) + 2674\,a(n-33) - 185\,a(n-36)
\]
for every $n>43$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251842.
