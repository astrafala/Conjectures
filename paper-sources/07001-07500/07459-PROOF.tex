...
\title{The empirical recurrence for OEIS A232019, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A232019 counts arrays over $\{0,\dots,2\}$ in which every cell is constrained by the
...
OEIS A232019 is ``Number of nX4 0..2 arrays with no element less than a strict majority of its horizontal and antidiagonal neighbors.''. It has offset $1$ and begins
\[
22, 212, 6443, 196196, 6129361, 189686855, 5882557816, 182394008292,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 06:47:51, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;22\,a(n-1) + 291\,a(n-2) + 205\,a(n-3) - 17170\,a(n-4) - 23642\,a(n-5) + 202540\,a(n-6) + 388609\,a(n-7) - 834295\,a(n-8) - 1784905\,a(n-9) + 1651195\,a(n-10) + 3413016\,a(n-11) - 1620542\,a(n-12) - 2409175\,a(n-13) + 65386\,a(n-14) + 316887\,a(n-15) - 2491\,a(n-16) - 751\,a(n-17) - 64\,a(n-18)
\end{equation}
for all $n>19$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232019.
