...
\title{The empirical recurrence for OEIS A302280, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A302280 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A302280 is ``Number of 3 X n 0..1 arrays with every element equal to 1, 2 or 4 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
0, 10, 22, 29, 74, 162, 363, 782,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 05 2018 04:09:09, revision 7) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) - 4\,a(n-2) + 4\,a(n-3) - 7\,a(n-4) - 17\,a(n-5) + 29\,a(n-6) - 5\,a(n-7) + 24\,a(n-8) + 6\,a(n-9) - 75\,a(n-10) + 27\,a(n-11) + 16\,a(n-12) + 7\,a(n-13) - 8\,a(n-14) - 6\,a(n-15) + 6\,a(n-16)
\end{equation}
for all $n>18$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302280.
