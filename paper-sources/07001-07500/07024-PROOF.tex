...
\title{The empirical recurrence for OEIS A250428, proved by transfer matrix}
...
\begin{abstract}
OEIS A250428 counts arrays over $\{0,1\}$ in which a statistic taken over short runs
...
window of consecutive rows, so the count is a walk count on $S=144$ states, and the
...
OEIS A250428 is ``Number of (n+1)X(4+1) 0..1 arrays with nondecreasing sum of every two consecutive values in every row and column.''. It has offset $1$ and begins
\[
144, 720, 3600, 12000, 40000, 105000, 275625, 617400,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 12:23:58, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250428.
