...
\title{The empirical recurrence for OEIS A259957, proved by transfer matrix}
...
\begin{abstract}
OEIS A259957 counts $(n+2)\times5$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A259957 is ``Number of (n+2) X (3+2) 0..1 arrays with each 3 X 3 subblock having clockwise perimeter pattern 00000000 00000001 or 00001001.''. It has offset $1$ and begins
\[
155, 439, 1603, 5449, 18681, 64891, 222813, 764865,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 16 2023 15:48:44, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A259957.
