...
\title{The empirical recurrence for OEIS A281055, proved by transfer matrix}
...
\begin{abstract}
OEIS A281055 counts $n\times7$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A281055 is ``Number of nX7 0..1 arrays with no element equal to more than one of its horizontal and antidiagonal neighbors, with the exception of exactly two elements, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
13, 535, 2828, 10570, 32370, 87995, 221212, 526340,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 13 2017 16:58:08, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) - 6\,a(n-2) - 4\,a(n-3) + 5\,a(n-4) + 9\,a(n-5) - 3\,a(n-6) - 3\,a(n-7) - 3\,a(n-8) - 9\,a(n-9) + 6\,a(n-11) + 8\,a(n-12) + 2\,a(n-13) + 3\,a(n-14) - 3\,a(n-15) - 3\,a(n-16) - 3\,a(n-17) - a(n-18) - a(n-19)
\]
for every $n>23$.
\end{theorem}
...
By Lemma~\ref{lem:crit} the recurrence holds for every $n>23$. The bound is exact: at $n=23$ the recurrence fails on the entry's own published terms, so no larger range holds.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A281055.
