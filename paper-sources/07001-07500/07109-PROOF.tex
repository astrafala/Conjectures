...
\title{The empirical recurrence for OEIS A296670, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A296670 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A296670 is ``Number of nX4 0..1 arrays with each 1 adjacent to 0, 2 or 3 king-move neighboring 1s.''. It has offset $1$ and begins
\[
8, 68, 334, 2295, 16541, 110036, 775010, 5466936,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 18 2017 11:02:53, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;7\,a(n-1) + 7\,a(n-2) + 5\,a(n-3) - 357\,a(n-4) - 256\,a(n-5) + 1029\,a(n-6) + 2658\,a(n-7) + 3925\,a(n-8) - 1538\,a(n-9) - 9402\,a(n-10) - 16653\,a(n-11) - 1906\,a(n-12) + 11571\,a(n-13) + 44254\,a(n-14) + 42564\,a(n-15) - 8544\,a(n-16) - 40891\,a(n-17) - 36046\,a(n-18) - 5947\,a(n-19) + 19697\,a(n-20) - 21657\,a(n-21) + 3238\,a(n-22) - 1153\,a(n-23) + 1222\,a(n-24) - 974\,a(n-25) + 264\,a(n-26) - 32\,a(n-27)
\end{equation}
for all $n>28$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A296670.
