...
\title{The empirical recurrence for OEIS A246733, proved by transfer matrix}
...
\begin{abstract}
OEIS A246733 carries an empirical recurrence of order $16$ contributed by R.~H.~Hardin. It is
...
OEIS A246733 is ``Number of length n+4 0..4 arrays with no pair in any consecutive five terms totalling exactly 4.''. It has offset $1$ and begins
\[
424, 1096, 2884, 7612, 19992, 52112, 135776, 354428,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) +a(n-4) +24*a(n-5) +2*a(n-6) +5*a(n-7) +11*a(n-8) -8*a(n-10) -2*a(n-11) +3*a(n-12) +a(n-15) +a(n-16)
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 10:13:57, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + a(n-4) + 24\,a(n-5) + 2\,a(n-6) + 5\,a(n-7) + 11\,a(n-8) - 8\,a(n-10) - 2\,a(n-11) + 3\,a(n-12) + a(n-15) + a(n-16)
\]
for every $n>16$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A246733.
