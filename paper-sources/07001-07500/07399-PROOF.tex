...
\title{The empirical recurrence for OEIS A252215, proved by transfer matrix}
...
\begin{abstract}
OEIS A252215 counts $(n+2)\times6$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
every $3\times3$ subblock, and it carries an empirical recurrence of order $26$
...
$a(n)$ is a walk count on $S=437292$ vertices. Such a sequence is $C$-finite, so whether a given
...
OEIS A252215 is ``Number of (n+2)X(4+2) 0..3 arrays with every 3X3 subblock row, column, diagonal and antidiagonal sum not equal to 0 2 5 6 or 7.''. It has offset $1$ and begins
\[
3147, 2836, 10486, 44776, 188866, 801122, 3410786, 14539238,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 10:57:15, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 6\,a(n-2) + 21\,a(n-3) + 53\,a(n-4) + 32\,a(n-5) - 61\,a(n-6) - 245\,a(n-7) - 323\,a(n-8) + 337\,a(n-9) + 944\,a(n-10) + 125\,a(n-11) - 1087\,a(n-12) - 852\,a(n-13) + 494\,a(n-14) + 889\,a(n-15) + 81\,a(n-16) - 280\,a(n-17) - 101\,a(n-18) - 17\,a(n-19) - 51\,a(n-20) - 9\,a(n-21) + 28\,a(n-22) + a(n-23) + 12\,a(n-24) + 7\,a(n-25) - 4\,a(n-26)
\]
for every $n>29$.
\end{theorem}

\begin{proof}
The vector $w=q(M)\mathbf{1}$ was formed by $26$ matrix--vector products in exact
integer arithmetic and $\mathbf{1}^{\!\top}M^{j}w$ evaluated for $j=0,1,\dots$, again
exactly. Those integers vanish from the index corresponding to $n=29+1$ onwards, and the
run was continued until the working vector was identically zero, which settles all larger $j$
at once. By Lemma~\ref{lem:crit} the recurrence holds for every $n>29$.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252215.
