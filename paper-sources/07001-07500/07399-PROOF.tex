...
\title{The empirical recurrence for OEIS A297803, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297803 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A297803 is ``Number of 3Xn 0..1 arrays with every 1 horizontally, diagonally or antidiagonally adjacent to 2, 3 or 5 neighboring 1s.''. It has offset $1$ and begins
\[
1, 4, 37, 100, 293, 1320, 6215, 24879,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 06 2018 09:33:31, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) - 4\,a(n-2) + 19\,a(n-3) + 32\,a(n-4) - 91\,a(n-5) - 260\,a(n-7) - 403\,a(n-8) + 590\,a(n-9) + 467\,a(n-10) + 69\,a(n-11) - 380\,a(n-12) - 48\,a(n-13) - 115\,a(n-14) + 216\,a(n-15) + 359\,a(n-16) + 36\,a(n-17) - 221\,a(n-18) - 89\,a(n-19) - 5\,a(n-20) + 12\,a(n-21)
\end{equation}
for all $n>22$.
...
publishes, $n=23$, the arrays have $3\cdot23$ cells over
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297803.
