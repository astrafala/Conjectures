...
\title{The empirical recurrence for OEIS A264650, proved by transfer matrix}
...
\begin{abstract}
OEIS A264650 carries an empirical recurrence of order $15$ contributed by R.~H.~Hardin. It is
...
OEIS A264650 is ``Number of (n+1)X(3+1) arrays of permutations of 0..n*4+3 with each element having directed index change 1,1 2,2 -1,0 or 0,-1.''. It has offset $1$ and begins
\[
0, 4, 4, 22, 65, 193, 628, 1905,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 20 2015 06:55:14, revision 4) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264650.
