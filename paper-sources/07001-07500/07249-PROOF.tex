...
\title{The empirical recurrence for OEIS A207252, proved by transfer matrix}
...
\begin{abstract}
OEIS A207252 counts arrays over $\{0,\dots,1\}$ of width $6$ that avoid the patterns
$(0,0,1), (1,0,1)$ along one axis and $(0,1,0), (1,0,1)$ along the other, and carries an empirical recurrence of
...
OEIS A207252 is ``Number of nX6 0..1 arrays avoiding 0 0 1 and 1 0 1 horizontally and 0 1 0 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
12, 144, 636, 3560, 18688, 101036, 541380,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 13:41:11, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 9\,a(n-2) + 4\,a(n-3) + 58\,a(n-4) + 117\,a(n-5) + 100\,a(n-6) + 160\,a(n-7) + 169\,a(n-8) + 74\,a(n-9) - 12\,a(n-10) - 67\,a(n-11) - 26\,a(n-12) + 6\,a(n-13) + 3\,a(n-14) + 3\,a(n-15) - a(n-16)
\end{equation}
for all $n>16$. 
...
$(0,0,1), (1,0,1)$ as $3$ consecutive entries. There are $12$ admissible rows; that condition
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207252.
