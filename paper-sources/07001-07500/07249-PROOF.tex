...
\title{The empirical recurrence for OEIS A237012, proved by transfer matrix}
...
\begin{abstract}
OEIS A237012 counts arrays over $\{0,\dots,3\}$ subject to a condition on the order
...
The condition is local to two consecutive rows, so the count is a walk count on $S=13312$
...
OEIS A237012 is ``Number of (n+1)X(5+1) 0..3 arrays with the sum of all four elements of every 2X2 subblock equal.''. It has offset $1$ and begins
\[
18496, 30248, 53200, 108824, 235456, 566936, 1419088, 3823352,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 09:45:52, revision 6) this is still
...
array, which is not among the objects counted. There are $S=13312$ states left.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237012.
