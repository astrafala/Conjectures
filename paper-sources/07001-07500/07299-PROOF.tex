...
\title{The empirical recurrence for OEIS A208146, proved by transfer matrix}
...
\begin{abstract}
OEIS A208146 counts arrays over $\{0,\dots,1\}$ of width $7$ that avoid the patterns
$(0,0,1), (1,0,1)$ along one axis and $(0,0,1), (0,1,1)$ along the other, and carries an empirical recurrence of
order $28$ contributed by R.~H.~Hardin. It is true. The patterns have length $3$, so
...
$\mathbf{1}^{\!\top}P^{\,n-2-28}q(P)\mathbf{1}$, which vanishes identically
...
OEIS A208146 is ``Number of 7Xn 0..1 arrays avoiding 0 0 1 and 0 1 1 horizontally and 0 0 1 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
14, 196, 1176, 7056, 28224, 112896, 352800,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:40:21, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 12\,a(n-2) - 26\,a(n-3) - 65\,a(n-4) + 156\,a(n-5) + 208\,a(n-6) - 572\,a(n-7) - 429\,a(n-8) + 1430\,a(n-9) + 572\,a(n-10) - 2574\,a(n-11) - 429\,a(n-12) + 3432\,a(n-13) - 3432\,a(n-15) + 429\,a(n-16) + 2574\,a(n-17) - 572\,a(n-18) - 1430\,a(n-19) + 429\,a(n-20) + 572\,a(n-21) - 208\,a(n-22) - 156\,a(n-23) + 65\,a(n-24) + 26\,a(n-25) - 12\,a(n-26) - 2\,a(n-27) + a(n-28)
\end{equation}
...
$a(n)-\sum_i c_i a(n-i)=u_{\,n-2-28}$ whenever $n-28\ge2$. Hence
\eqref{eq:conj} holds for every $n>t$ exactly when $u_j=0$ for every
$j>t-2-28$. Moreover $(u_j)$ satisfies the monic linear recurrence whose
...
$P^{\,n-2-28}$ gives the identity. The equivalence follows by letting the exponent
...
\begin{proof}
The vector $q(P)\mathbf{1}\in\mathbb{Z}^{S}$ was formed by $28$ matrix--vector
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208146.
