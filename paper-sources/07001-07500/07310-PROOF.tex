...
\title{The empirical recurrence for OEIS A250697, proved by transfer matrix}
...
\begin{abstract}
OEIS A250697 counts arrays over $\{0,1,2,3\}$ in which a statistic taken over short runs
...
OEIS A250697 is ``Number of (6+1)X(n+1) 0..3 arrays with nondecreasing x(i,j)-x(i,j-1) in the i direction and nondecreasing absolute value of x(i,j)-x(i-1,j) in the j direction.''. It has offset $1$ and begins
\[
233300, 1647460, 8474002, 36673634, 143136866, 523260542, 1832718604, 6241479780,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 12:42:38, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250697.
