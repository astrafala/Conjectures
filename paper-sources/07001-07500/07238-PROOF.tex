...
\title{The empirical recurrence for OEIS A189107, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A189107 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A189107 is ``Number of nX5 binary arrays without the pattern 1 1 0 diagonally or antidiagonally.''. It has offset $1$ and begins
\[
32, 1024, 16100, 244000, 3179520, 40933920, 517260800, 6517280000,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 05:01:37, revision 9) the statement is
...
the middle row. The vector $w$ was formed by $32$ applications of $G$ in exact integer
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A189107.
