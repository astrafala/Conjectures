...
\title{The empirical recurrence for OEIS A188853, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A188853 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A188853 is ``Number of 4Xn binary arrays without the pattern 0 0 1 vertically, antidiagonally or horizontally.''. It has offset $1$ and begins
\[
12, 144, 958, 5711, 33037, 185351, 1020454, 5541360,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 04:53:40, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;8\,a(n-1) + 15\,a(n-2) - 217\,a(n-3) - 65\,a(n-4) + 2637\,a(n-5) + 75\,a(n-6) - 18789\,a(n-7) - 1526\,a(n-8) + 86316\,a(n-9) + 19704\,a(n-10) - 266659\,a(n-11) - 102052\,a(n-12) + 565680\,a(n-13) + 288503\,a(n-14) - 834249\,a(n-15) - 499808\,a(n-16) + 863607\,a(n-17) + 561084\,a(n-18) - 631388\,a(n-19) - 421898\,a(n-20) + 323752\,a(n-21) + 217120\,a(n-22) - 111753\,a(n-23) - 77769\,a(n-24) + 22421\,a(n-25) + 19774\,a(n-26) - 747\,a(n-27) - 3667\,a(n-28) - 883\,a(n-29) + 501\,a(n-30) + 234\,a(n-31) - 46\,a(n-32) - 25\,a(n-33) + 2\,a(n-34) + a(n-35)
\end{equation}
for all $n>38$.
...
the middle column. The vector $w$ was formed by $35$ applications of $G$ in exact integer
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A188853.
