...
\title{The empirical recurrence for OEIS A252151, proved by transfer matrix}
...
\begin{abstract}
OEIS A252151 counts $(n+2)\times4$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252151 is ``Number of (n+2)X(2+2) 0..3 arrays with every 3X3 subblock row and column sum not equal to 0 1 3 6 or 7 and every 3X3 diagonal and antidiagonal sum equal to 0 1 3 6 or 7.''. It has offset $1$ and begins
\[
1945, 1874, 1898, 2702, 4732, 8769, 16786, 32653,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 10:52:11, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) - 2\,a(n-2) + 7\,a(n-3) - 18\,a(n-4) + 5\,a(n-5) - 8\,a(n-6) + 21\,a(n-7) + 34\,a(n-8) - 31\,a(n-9) + 16\,a(n-10) - 103\,a(n-11) + 63\,a(n-12) - 10\,a(n-13) + 58\,a(n-14) - 6\,a(n-15) - 28\,a(n-16) + 8\,a(n-17) - 24\,a(n-18) + 16\,a(n-19)
\]
for every $n>27$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252151.
