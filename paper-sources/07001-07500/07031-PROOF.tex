...
\title{The empirical recurrence for OEIS A185768, proved by transfer matrix}
...
\begin{abstract}
OEIS A185768 counts arrays over $\{0,\dots,1\}$ under a condition on the trace of every
...
a bounded window of consecutive rows, so the count is a walk count on $S=11400$ states and is
...
OEIS A185768 is ``Number of (n+1)X9 binary arrays with no 2X2 subblock trace equal to any horizontal or vertical neighbor 2X2 subblock trace.''. It has offset $1$ and begins
\[
11400, 99464, 1071200, 12760448, 166155112, 2212654240, 29857704328, 404009799752,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 03:09:59, revision 9) this is still
...
\]
on the $S=11400$ admissible pairs.

At $n=1$ the array has two rows, so the grid is a single row of $8$
subblocks with no vertical neighbours, so only the horizontal comparisons apply. The
entry's first term is $11400$, and the model reproduces it along with every later term; that
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 179\,a(n-2) + 341\,a(n-3) - 6316\,a(n-4) - 6138\,a(n-5) + 92272\,a(n-6) - 87872\,a(n-7) - 479803\,a(n-8) + 1815915\,a(n-9) - 852208\,a(n-10) - 6873004\,a(n-11) + 8175787\,a(n-12) + 6036792\,a(n-13) - 5492010\,a(n-14) - 12389568\,a(n-15) + 3504328\,a(n-16) + 38808492\,a(n-17) - 4735254\,a(n-18) - 36745560\,a(n-19) - 36433267\,a(n-20) + 12744011\,a(n-21) + 28480781\,a(n-22) + 9986028\,a(n-23) - 2174189\,a(n-24) - 3904760\,a(n-25) - 845298\,a(n-26) - 118044\,a(n-27) - 60864\,a(n-28) - 3296\,a(n-29) - 32\,a(n-30)
\]
for every $n>36$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A185768.
