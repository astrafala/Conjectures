...
\title{The empirical recurrence for OEIS A261551, proved by transfer matrix}
...
\begin{abstract}
OEIS A261551 counts $(n+2)\times6$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A261551 is ``Number of (n+2)X(4+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000001 00000101 or 00001011.''. It has offset $1$ and begins
\[
336, 484, 754, 769, 816, 1286, 1510, 1615,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 24 2015 11:00:06, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-7) + 4\,a(n-10) + 2\,a(n-13) - 3\,a(n-14) - 2\,a(n-17) + a(n-20) - 4\,a(n-21) - 4\,a(n-23) - 8\,a(n-24) - a(n-26) - 6\,a(n-27) + 3\,a(n-28) + 3\,a(n-34) + 2\,a(n-35) + 2\,a(n-38)
\]
for every $n>44$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A261551.
