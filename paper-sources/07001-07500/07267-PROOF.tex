...
\title{The empirical recurrence for OEIS A252338, proved by transfer matrix}
...
\begin{abstract}
OEIS A252338 counts $(n+2)\times5$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A252338 is ``Number of (n+2)X(3+2) 0..2 arrays with every 3X3 subblock row, column, diagonal and antidiagonal sum not equal to 2 3 or 4.''. It has offset $1$ and begins
\[
234, 810, 2978, 10154, 34894, 120474, 413478, 1423482,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:06:41, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252338.
