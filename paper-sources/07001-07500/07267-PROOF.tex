...
\title{The empirical recurrence for OEIS A269618, proved by transfer matrix}
...
\begin{abstract}
OEIS A269618 carries an empirical recurrence of order $17$ contributed by R.~H.~Hardin. It is
...
OEIS A269618 is ``Number of length-n 0..7 arrays with no repeated value differing from the previous repeated value by other than plus two, zero or minus 1.''. It has offset $1$ and begins
\[
8, 64, 512, 4053, 31822, 248143, 1923796, 14840928,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 01 2016 14:56:27, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;63\,a(n-1) - 1756\,a(n-2) + 28364\,a(n-3) - 291578\,a(n-4) + 1965390\,a(n-5) - 8566706\,a(n-6) + 22451548\,a(n-7) - 27837343\,a(n-8) - 2892449\,a(n-9) + 25243250\,a(n-10) + 17146752\,a(n-11) + 6127748\,a(n-12) + 1523522\,a(n-13) + 264748\,a(n-14) + 31542\,a(n-15) + 2437\,a(n-16) + 91\,a(n-17)
\]
for every $n>1$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269618.
