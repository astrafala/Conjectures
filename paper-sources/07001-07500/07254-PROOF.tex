...
\title{The empirical recurrence for OEIS A204193, proved by transfer matrix}
...
\begin{abstract}
OEIS A204193 counts arrays of width $4$ over $\{0,1\}$ containing no run of $3$ consecutive
cells, taken along a named direction of the grid, whose entries are all equal. The entry carries
an empirical recurrence of order $16$ contributed by R.~H.~Hardin. It is true, and it is
decidable rather than empirical: every such run lies inside $3$ consecutive array rows, so
the count is a walk count on $S=111$ states.
\end{abstract}
...
OEIS A204193 is ``Number of nX4 0..1 arrays with no occurrence of three equal elements in a row horizontally, vertically or nw-to-se diagonally, and new values 0..1 introduced in row major order.''. It has offset $1$ and begins
\[
5, 50, 86, 265, 883, 2974, 9940, 33462,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 11:01:18, revision 10) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=111,\quad\tau=\mathbf{1} .
\]
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 7\,a(n-2) + a(n-3) - 28\,a(n-4) - 30\,a(n-5) + 56\,a(n-6) + 71\,a(n-7) - 64\,a(n-8) - 74\,a(n-9) + 42\,a(n-10) + 39\,a(n-11) - 18\,a(n-12) - 9\,a(n-13) + 6\,a(n-14) + a(n-15) - a(n-16)
\]
for every $n>19$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204193.
