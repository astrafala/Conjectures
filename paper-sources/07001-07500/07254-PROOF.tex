...
\title{The empirical recurrence for OEIS A254721, proved by transfer matrix}
...
\begin{abstract}
OEIS A254721 counts the arrays over $\{0,\dots,1\}$ whose $3\times3$ subblocks carry a
...
so the count is a walk count on $S=144$ states --- the last two array rows together with the
...
OEIS A254721 is ``Number of (n+2)X(1+2) 0..1 arrays with every 3X3 subblock sum of the two maximums of the central row and the central column and the two medians of the diagonal and antidiagonal nondecreasing horizontally and vertically.''. It has offset $1$ and begins
\[
512, 2630, 11677, 48168, 185287, 689386, 2473062, 8658471,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 14:53:17, revision 6) this is still
...
\]
on the $S=144$ reachable states. In particular $a$ is $C$-finite. The alignment of the walk
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-1) - 23\,a(n-2) + 39\,a(n-3) - 74\,a(n-4) + 97\,a(n-5) - 70\,a(n-6) + 157\,a(n-7) - 7\,a(n-8) - 240\,a(n-9) + 137\,a(n-10) - 1240\,a(n-11) + 1243\,a(n-12) - 1518\,a(n-13) + 3483\,a(n-14) - 1570\,a(n-15) + 2216\,a(n-16) - 460\,a(n-17) - 3884\,a(n-18) + 5769\,a(n-19) - 8541\,a(n-20) + 9805\,a(n-21) - 10573\,a(n-22) + 4169\,a(n-23) - 2404\,a(n-24) - 3292\,a(n-25) + 11130\,a(n-26) - 11804\,a(n-27) + 14016\,a(n-28) - 9264\,a(n-29) + 6456\,a(n-30) - 256\,a(n-31) - 3824\,a(n-32) + 3584\,a(n-33) - 6400\,a(n-34) + 4736\,a(n-35) - 2624\,a(n-36) + 1280\,a(n-37) - 256\,a(n-38)
\]
for every $n>42$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A254721.
