...
\title{The empirical recurrence for OEIS A300317, proved by transfer matrix}
...
\begin{abstract}
OEIS A300317 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $equal to$ itself lying in $\{0,1,3,4,5,6,7,8\}$, and it carries an empirical
recurrence of order $40$ contributed by R.~H.~Hardin. It is true. The neighbourhood
...
OEIS A300317 is ``Number of nX4 0..1 arrays with every element equal to 0, 1, 3, 4, 5, 6, 7 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
5, 16, 61, 735, 3486, 25797, 203113, 1378779,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 02 2018 18:04:03, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) + 17\,a(n-2) + 58\,a(n-3) - 723\,a(n-4) - 1474\,a(n-5) + 2196\,a(n-6) + 22381\,a(n-7) + 33196\,a(n-8) - 74444\,a(n-9) - 304846\,a(n-10) - 304618\,a(n-11) + 729107\,a(n-12) + 2155348\,a(n-13) + 1029883\,a(n-14) - 3952392\,a(n-15) - 7637046\,a(n-16) + 715694\,a(n-17) + 13481890\,a(n-18) + 8555164\,a(n-19) - 11449768\,a(n-20) - 17902612\,a(n-21) + 4961008\,a(n-22) + 20105667\,a(n-23) + 3790762\,a(n-24) - 14046982\,a(n-25) - 12943012\,a(n-26) + 3898385\,a(n-27) + 15098585\,a(n-28) + 6519939\,a(n-29) - 6343052\,a(n-30) - 9682129\,a(n-31) - 1312670\,a(n-32) + 5033072\,a(n-33) + 1370029\,a(n-34) - 1279682\,a(n-35) - 258338\,a(n-36) + 223424\,a(n-37) - 7704\,a(n-38) - 21248\,a(n-39) + 9856\,a(n-40)
\end{equation}
for all $n>43$.
...
has score in $\{0,1,3,4,5,6,7,8\}$. The entry also fixes the top-left entry to be $0$; that is a condition on the first row alone, so it restricts the start vector and nothing else.
...
\begin{itemize}
\item $\mathbf{s}(r,s)=1$ when every cell of $r$ has score in $\{0,1,3,4,5,6,7,8\}$ \emph{with no row
above $r$} and $r_1=0$, and $0$ otherwise;
\item an edge $(r,s)\to(s,t)$ when every cell of $s$ has score in $\{0,1,3,4,5,6,7,8\}$ computed from
$r$, $s$ and $t$;
\item $\mathbf{e}(r,s)=1$ when every cell of $s$ has score in $\{0,1,3,4,5,6,7,8\}$ \emph{with no row
...
exactly when every one of its $n$ rows has all scores in $\{0,1,3,4,5,6,7,8\}$. Read the sequence as the
...
$a(n)-\sum_i c_i a(n-i)=u_{\,n-2-40}$ whenever $n-40\ge2$. So \eqref{eq:conj}
holds for every $n>t$ exactly when $u_j=0$ for all $j>t-2-40$. Moreover $(u_j)$
...
\begin{proof}
Substituting Lemma~\ref{lem:walk} and factoring $P^{\,n-2-40}$ out of
...
\begin{proof}
The vector $q(P)\mathbf{e}\in\mathbb{Z}^{S}$ was formed by $40$ matrix--vector
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A300317.
