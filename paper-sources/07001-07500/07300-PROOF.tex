...
\title{The empirical recurrence for OEIS A234438, proved by transfer matrix}
...
\begin{abstract}
OEIS A234438 counts $4$-column arrays over $\{0,\dots,2\}$ in which every
...
OEIS A234438 is ``Number of (n+1) X (3+1) 0..2 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 1 (constant-stress 1 X 1 tilings).''. It has offset
$1$ and begins
\[
448, 2804, 17200, 108404, 666880, 4221580, 26023136,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 119*a(n-2) -4884*a(n-4) +76112*a(n-6) -295366*a(n-8) +424128*a(n-10) -242512*a(n-12) +58736*a(n-14) -4992*a(n-16).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 20 2022 18:19:44, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;119\,a(n-2) - 4884\,a(n-4) + 76112\,a(n-6) - 295366\,a(n-8) + 424128\,a(n-10) - 242512\,a(n-12) + 58736\,a(n-14) - 4992\,a(n-16)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234438.
