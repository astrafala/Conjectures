...
\title{The empirical recurrence for OEIS A201085, proved by transfer matrix}
...
\begin{abstract}
OEIS A201085 carries an empirical recurrence of order $34$ contributed by R.~H.~Hardin. It is
...
OEIS A201085 is ``Number of -5..5 arrays of n elements with first and second differences also in -5..5.''. It has offset $1$ and begins
\[
11, 91, 587, 3899, 25935, 172767, 1150785, 7664735,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 08:57:33, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-1) - 6\,a(n-2) + 23\,a(n-3) + 13\,a(n-4) - a(n-5) + 2\,a(n-6) - 59\,a(n-7) - 102\,a(n-8) - 8\,a(n-9) + 92\,a(n-10) + 95\,a(n-11) - 18\,a(n-12) - 41\,a(n-13) + 36\,a(n-14) + 33\,a(n-15) - 49\,a(n-16) - 124\,a(n-17) - 69\,a(n-18) + 14\,a(n-19) + 88\,a(n-20) + 53\,a(n-21) - 18\,a(n-22) - 11\,a(n-23) - 2\,a(n-24) - 2\,a(n-25) + 8\,a(n-26) + 2\,a(n-27) - 10\,a(n-28) - 4\,a(n-29) + 8\,a(n-30) + 3\,a(n-31) + 2\,a(n-32) + 3\,a(n-33) - a(n-34)
\]
for every $n>1$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A201085.
