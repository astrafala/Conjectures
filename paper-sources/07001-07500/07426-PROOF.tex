...
\title{The empirical recurrence for OEIS A261705, proved by transfer matrix}
...
\begin{abstract}
OEIS A261705 counts $(n+2)\times4$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A261705 is ``Number of (n+2)X(2+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000001 00000101 or 00000111.''. It has offset $1$ and begins
\[
76, 134, 270, 462, 892, 1751, 3299, 6324,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 28 2015 20:10:49, revision 4) this is still
...
\[
\text{the clockwise perimeter word of }g\text{ is a rotation of one of }\{00000001,\ 00000101,\ 00000111\}
\]
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + a(n-2) - a(n-3) - 6\,a(n-5) + 4\,a(n-6) - 5\,a(n-7) + 2\,a(n-8) + 11\,a(n-9) - 3\,a(n-10) - 2\,a(n-12) - 6\,a(n-14) + 4\,a(n-15)
\]
for every $n>17$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A261705.
