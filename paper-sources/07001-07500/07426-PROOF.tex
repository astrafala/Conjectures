...
\title{The empirical recurrence for OEIS A303514, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A303514 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A303514 is ``Number of 3Xn 0..1 arrays with every element equal to 0, 1, 2, 4, 5 or 6 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
4, 25, 78, 230, 801, 2764, 9367, 31703,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 25 2018 12:29:26, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) - 7\,a(n-2) - 9\,a(n-3) + 6\,a(n-4) - 3\,a(n-5) + 48\,a(n-6) + 22\,a(n-7) - 35\,a(n-8) - 104\,a(n-9) - 47\,a(n-10) + 77\,a(n-11) + 110\,a(n-12) - 13\,a(n-13) - 56\,a(n-14) + 12\,a(n-15)
\end{equation}
for all $n>16$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A303514.
