...
\title{The empirical recurrence for OEIS A196806, proved by transfer matrix}
...
\begin{abstract}
OEIS A196806 counts $n\times5$ arrays over $\{0,\dots,4\}$ subject to a condition imposed on
...
walk, and $a(n)$ is a walk count on $S=5391$ vertices, which is $C$-finite. Whether the
...
OEIS A196806 is ``Number of nX5 0..4 arrays with each element x equal to the number its horizontal and vertical neighbors equal to 4,2,3,0,1 for x=0,1,2,3,4.''. It has offset $1$ and begins
\[
1, 17, 120, 1515, 19449, 166682, 1730105, 18344433,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 06:45:41, revision 9) this is still
...
settled by the terminal weight, which evaluates it with $\varnothing$ below. Most of those pairs are indistinguishable, and exactly so. Every offset named above has $|dj|\le 1$, so whether the cell at column $j$ of the middle row is satisfied depends on the three rows only through their windows at $j-1,j,j+1$. Collect for each $j$ the indicator over the window of the row below, and call that tuple $P(r,s)$: the number of cells any $t$ violates is read off $P$, so is the number violated at the bottom edge, and the successor $(s,t)$ carries $P(s,t)$, which does not mention $r$. Hence two pairs $(r,s)$ and $(r',s)$ with the same $P$ have the same outgoing rows and the same successors, and the vertex is $(s,P)$. That leaves $S=5391$ vertices in place of $9765625$. Hence,
with $M$ the adjacency matrix on $S=5391$ vertices, $\iota$ the starting vector and $\tau$ the
terminal weight,
\[
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 46\,a(n-2) + 251\,a(n-3) + 912\,a(n-4) + 3106\,a(n-5) + 33732\,a(n-6) + 134128\,a(n-7) - 20034\,a(n-8) - 567014\,a(n-9) - 375318\,a(n-10) - 6015368\,a(n-11) - 16173299\,a(n-12) - 1856398\,a(n-13) - 6077492\,a(n-14) + 115957\,a(n-15) + 86716000\,a(n-16) + 121879353\,a(n-17) + 143953434\,a(n-18) + 89210978\,a(n-19) - 338982089\,a(n-20) + 596943388\,a(n-21) - 937879207\,a(n-22) - 29192016\,a(n-23) + 898444015\,a(n-24) - 968379863\,a(n-25) + 1255345857\,a(n-26) - 1174344242\,a(n-27) + 285800984\,a(n-28) + 142375346\,a(n-29) - 191125798\,a(n-30) + 133032528\,a(n-31) - 51445208\,a(n-32) + 22658488\,a(n-33) + 6236280\,a(n-34) - 4351872\,a(n-35) + 1586080\,a(n-36) - 1187040\,a(n-37) + 225696\,a(n-38) + 24640\,a(n-39) + 37248\,a(n-40) + 13824\,a(n-41)
\]
for every $n>41$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A196806.
