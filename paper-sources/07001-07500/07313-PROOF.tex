...
\title{The empirical recurrence for OEIS A305949, proved by transfer matrix}
...
\begin{abstract}
OEIS A305949 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A305949 is ``Number of nX3 0..1 arrays with every element unequal to 0, 2, 3, 4, 5 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 8, 23, 107, 537, 2800, 14652, 77128,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 15 2018 06:05:50, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) + 7\,a(n-2) - 13\,a(n-3) - 88\,a(n-4) - 25\,a(n-5) + 177\,a(n-6) + 214\,a(n-7) + 73\,a(n-8) - 188\,a(n-9) - 194\,a(n-10) - 92\,a(n-11) - 26\,a(n-12) - 26\,a(n-13) - 18\,a(n-14) + 16\,a(n-15) + 8\,a(n-16)
\end{equation}
for all $n>17$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A305949.
