...
\title{The empirical recurrence for OEIS A258527, proved by transfer matrix}
...
\begin{abstract}
OEIS A258527 counts the arrays over $\{0,\dots,1\}$ whose $3\times3$ subblocks carry a
...
so the count is a walk count on $S=22704$ states --- the last two array rows together with the
...
OEIS A258527 is ``Number of (n+2)X(5+2) 0..1 arrays with every 3X3 subblock sum of the two maximums of the central row and central column plus the two minimums of the diagonal and antidiagonal nondecreasing horizontally, vertically and ne-to-sw antidiagonally.''. It has offset $1$ and begins
\[
294960, 2927601, 18460629, 27337100, 65947572, 159909048, 376000912, 1197367724,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 15:26:52, revision 6) this is still
...
\]
on the $S=22704$ reachable states. In particular $a$ is $C$-finite. The alignment of the walk
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 7\,a(n-2) + 8\,a(n-3) - 24\,a(n-4) - 72\,a(n-5) + 144\,a(n-6) - 1472\,a(n-7) - 1280\,a(n-8) + 3712\,a(n-9) + 28672\,a(n-10) + 9216\,a(n-11) - 88064\,a(n-12) - 98304\,a(n-13) + 16384\,a(n-14) + 393216\,a(n-15) - 262144\,a(n-16)
\]
for every $n>25$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A258527.
