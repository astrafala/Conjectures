...
\title{The empirical recurrence for OEIS A231741, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A231741 counts arrays over $\{0,\dots,3\}$ in which every cell is constrained by the
...
OEIS A231741 is ``Number of nX2 0..3 arrays with no element less than a strict majority of its horizontal and vertical neighbors.''. It has offset $1$ and begins
\[
4, 84, 318, 1328, 6064, 26918, 116909, 511264,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 06:39:11, revision 7) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;10\,a(n-1) - 39\,a(n-2) + 104\,a(n-3) - 251\,a(n-4) + 391\,a(n-5) - 483\,a(n-6) + 687\,a(n-7) - 378\,a(n-8) + 503\,a(n-9) - 247\,a(n-10) - 66\,a(n-11) - 292\,a(n-12) - 300\,a(n-13) - 217\,a(n-14) - 153\,a(n-15) - 70\,a(n-16) - 27\,a(n-17) - 8\,a(n-18) - a(n-19)
\end{equation}
for all $n>20$.
...
the middle row. The vector $w$ was formed by $19$ applications of $G$ in exact integer
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231741.
