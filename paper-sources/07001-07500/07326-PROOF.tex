...
\title{The empirical recurrence for OEIS A254161, proved by transfer matrix}
...
\begin{abstract}
OEIS A254161 counts the arrays over $\{0,\dots,1\}$ whose $3\times3$ subblocks carry a
...
so the count is a walk count on $S=112$ states --- the last two array rows together with the
...
OEIS A254161 is ``Number of (n+2)X(1+2) 0..1 arrays with every 3X3 subblock diagonal maximum minus antidiagonal median nondecreasing horizontally, vertically and ne-to-sw antidiagonally.''. It has offset $1$ and begins
\[
512, 3036, 16240, 76832, 348032, 1511152, 6440848, 27128324,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 14:28:44, revision 6) this is still
...
\]
on the $S=112$ reachable states. In particular $a$ is $C$-finite. The alignment of the walk
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-1) - 15\,a(n-2) - 25\,a(n-3) + 102\,a(n-4) - 5\,a(n-5) - 350\,a(n-6) + 624\,a(n-7) - 426\,a(n-8) - 760\,a(n-9) + 2636\,a(n-10) - 2924\,a(n-11) + 443\,a(n-12) + 3356\,a(n-13) - 5991\,a(n-14) + 4955\,a(n-15) - 658\,a(n-16) - 3981\,a(n-17) + 5832\,a(n-18) - 4144\,a(n-19) + 1408\,a(n-20) + 1110\,a(n-21) - 2260\,a(n-22) + 1682\,a(n-23) - 1044\,a(n-24) + 360\,a(n-25) + 132\,a(n-26) - 168\,a(n-27) + 192\,a(n-28) - 88\,a(n-29) + 16\,a(n-30) - 16\,a(n-32)
\]
for every $n>32$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A254161.
