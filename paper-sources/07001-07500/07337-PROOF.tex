...
\title{The empirical recurrence for OEIS A256730, proved by transfer matrix}
...
\begin{abstract}
OEIS A256730 counts arrays of width $5$ over $\{0,1\}$ in which every $3\times3$ window has
...
OEIS A256730 is ``Number of (n+2)X(3+2) 0..1 arrays with no 3x3 subblock diagonal sum zero and no antidiagonal sum three.''. It has offset $1$ and begins
\[
13056, 186624, 2267136, 30294016, 388595712, 5101387776, 65927512064, 859759181824,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 15:13:19, revision 6) this is still
...
\text{the main diagonal} & \text{must NOT be 0} \\
\text{the antidiagonal} & \text{must NOT be 3} \\
\end{array}
\]
...
\begin{theorem}
\[
a(n)\;=\;16\,a(n-1) - 608\,a(n-3) + 2560\,a(n-4) - 20480\,a(n-5) + 41984\,a(n-6) + 190464\,a(n-7) - 286720\,a(n-8) + 1212416\,a(n-9) - 2686976\,a(n-10) - 11141120\,a(n-11) + 10485760\,a(n-12) + 8388608\,a(n-13) + 25165824\,a(n-15) - 16777216\,a(n-16)
\]
for every $n>15$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A256730.
