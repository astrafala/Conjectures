...
\title{A condition on the multiset of every subblock: OEIS A184202}
...
\begin{abstract}
OEIS A184202 carries an empirical recurrence of order $19$ contributed by R.~H.~Hardin. It is
...
on $S=19$ vertices and is $C$-finite, and whether the conjectured recurrence annihilates it
...
OEIS A184202 is ``Number of (n+1)X5 binary arrays with no 2X2 subblock containing fewer than two 1s.''. It has offset $1$ and begins
\[
337, 5529, 80812, 1232795, 18588589, 281420718, 4255603649, 64377477751,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 02:24:09, revision 9) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{The count is a walk count}

The entry counts arrays with $5$ columns over the alphabet $\{0,1\}$, growing one row at a time, and asks that every $2\times2$ subblock holds at least $2$ entries equal to $1$.
...
Merging vertices with identical futures leaves $S=19$. An admissible array is exactly a walk, so with $M$ the adjacency matrix and $\iota,\tau$ the vectors recording which states may begin and end an array,
\[
a(n)\;=\;\iota^{\!\top}M^{\,n}\tau ,
\]
...
\begin{theorem}
\[
a(n)\;=\;14\,a(n-1) + 49\,a(n-2) - 472\,a(n-3) - 488\,a(n-4) + 4808\,a(n-5) + 278\,a(n-6) - 15914\,a(n-7) + 2888\,a(n-8) + 23043\,a(n-9) - 5467\,a(n-10) - 16111\,a(n-11) + 3566\,a(n-12) + 5580\,a(n-13) - 915\,a(n-14) - 951\,a(n-15) + 91\,a(n-16) + 73\,a(n-17) - 3\,a(n-18) - 2\,a(n-19)
\]
for every $n>18$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A184202.
