...
\title{The empirical recurrence for OEIS A252410, proved by transfer matrix}
...
\begin{abstract}
OEIS A252410 counts $5\times(n+2)$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252410 is ``Number of (3+2)X(n+2) 0..3 arrays with every 3X3 subblock row and diagonal sum equal to 2 3 4 6 or 7 and every 3X3 column and antidiagonal sum not equal to 2 3 4 6 or 7.''. It has offset $1$ and begins
\[
319, 688, 1515, 2555, 7425, 18377, 32710, 97923,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:11:45, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;26\,a(n-3) - 179\,a(n-6) + 122\,a(n-9) + 562\,a(n-12) - 680\,a(n-15) - 425\,a(n-18) + 768\,a(n-21) + 19\,a(n-24) - 236\,a(n-27) + 24\,a(n-30)
\]
for every $n>37$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252410.
