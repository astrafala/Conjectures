...
\title{The empirical recurrence for OEIS A296583, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A296583 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A296583 is ``Number of nX3 0..1 arrays with each 1 horizontally, vertically or antidiagonally adjacent to 0, 2 or 3 neighboring 1s.''. It has offset $1$ and begins
\[
5, 22, 83, 346, 1465, 6241, 26895, 116541,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 16 2017 07:04:00, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) + a(n-2) - 12\,a(n-3) - 16\,a(n-4) - 3\,a(n-5) - 12\,a(n-6) - 52\,a(n-7) - 173\,a(n-8) - 97\,a(n-9) - 25\,a(n-10) - 112\,a(n-11) - 31\,a(n-12) - 244\,a(n-13) + 12\,a(n-14) + 73\,a(n-15) - 121\,a(n-16) + 73\,a(n-17) + 26\,a(n-18) - 3\,a(n-19) + 12\,a(n-20) + 4\,a(n-21)
\end{equation}
for all $n>22$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A296583.
