...
\title{The empirical recurrence for OEIS A206322, proved by transfer matrix}
...
\begin{abstract}
OEIS A206322 counts arrays over $\{0,\dots,3\}$ under a condition on the perimeter cycle of
every $2\times3$ and $3\times2$ subblock, and carries an empirical recurrence of order $20$ contributed by
R.~H.~Hardin. It is true, and it is decidable rather than empirical. The condition is local to
a bounded window of consecutive rows, so the count is a walk count on $S=10504$ states and is
...
OEIS A206322 is ``Number of (n+1)X4 0..3 arrays with every 2X3 or 3X2 subblock having exactly three clockwise edge increases.''. It has offset $1$ and begins
\[
10504, 282996, 10258408, 376249940, 13817572060, 507368863264, 18627016493468, 683798061454964,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 12:51:39, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;69\,a(n-1) - 1559\,a(n-2) + 15847\,a(n-3) - 85177\,a(n-4) + 268167\,a(n-5) - 545306\,a(n-6) + 718090\,a(n-7) - 456168\,a(n-8) - 215639\,a(n-9) + 632189\,a(n-10) - 402870\,a(n-11) + 99964\,a(n-12) - 248171\,a(n-13) + 364298\,a(n-14) - 135801\,a(n-15) - 12132\,a(n-16) - 208\,a(n-17) + 3772\,a(n-18) + 516\,a(n-19) + 120\,a(n-20)
\]
for every $n>23$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206322.
