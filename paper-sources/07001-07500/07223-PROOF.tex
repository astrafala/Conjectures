...
\title{The empirical recurrence for OEIS A236446, proved by transfer matrix}
...
\begin{abstract}
OEIS A236446 counts arrays over $\{0,\dots,3\}$ subject to a condition on the order
...
The condition is local to two consecutive rows, so the count is a walk count on $S=2116$
...
OEIS A236446 is ``Number of (n+1)X(2+1) 0..3 arrays colored with the difference of the maximum and minimum in each 2X2 subblock.''. It has offset $1$ and begins
\[
2116, 25172, 280436, 3081484, 33804644, 372302304, 4107125100, 45253160716,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 09:15:56, revision 6) this is still
...
\]
over the $S=2116$ pairs whose own subblock row is properly coloured.
...
\begin{theorem}
\[
a(n)\;=\;36\,a(n-2) + 356\,a(n-3) + 4344\,a(n-4) + 20686\,a(n-5) + 29714\,a(n-6) - 31380\,a(n-7) - 97187\,a(n-8) - 8638\,a(n-9) - 75077\,a(n-10) - 613287\,a(n-11) - 385421\,a(n-12) + 493270\,a(n-13) + 214944\,a(n-14) + 4921728\,a(n-15) + 12218501\,a(n-16) + 5327294\,a(n-17) - 8969592\,a(n-18) - 18816047\,a(n-19) - 32373495\,a(n-20) - 51099082\,a(n-21) - 9749467\,a(n-22) + 62349330\,a(n-23) + 27150861\,a(n-24) + 15857513\,a(n-25) + 34953995\,a(n-26) - 21410588\,a(n-27) - 9398131\,a(n-28) + 10813876\,a(n-29) - 1372244\,a(n-30) - 440320\,a(n-31) + 788640\,a(n-32) - 207360\,a(n-33) + 8704\,a(n-34)
\]
for every $n>37$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A236446.
