...
\title{The empirical recurrence for OEIS A237302, proved by transfer matrix}
...
\begin{abstract}
OEIS A237302 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
The condition is local to two consecutive rows, so the count is a walk count on $S=60$
...
OEIS A237302 is ``Number of (n+1)X(2+1) 0..2 arrays with the upper median of every 2X2 subblock equal.''. It has offset $1$ and begins
\[
435, 5433, 60958, 731603, 8680769, 103860036, 1241171131, 14853266129,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 10:02:35, revision 6) this is still
...
array, which is not among the objects counted. There are $S=60$ states left.
...
\begin{theorem}
\[
a(n)\;=\;22\,a(n-1) - 45\,a(n-2) - 1470\,a(n-3) + 5102\,a(n-4) + 32822\,a(n-5) - 127087\,a(n-6) - 302816\,a(n-7) + 1328815\,a(n-8) + 1050894\,a(n-9) - 6431720\,a(n-10) - 59412\,a(n-11) + 14013728\,a(n-12) - 5375984\,a(n-13) - 12300032\,a(n-14) + 7063680\,a(n-15) + 3032064\,a(n-16) - 1935360\,a(n-17)
\]
for every $n>16$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237302.
