...
\title{The empirical recurrence for OEIS A208416, proved by transfer matrix}
...
\begin{abstract}
OEIS A208416 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
...
OEIS A208416 is ``Number of n X 4 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 0 0 and 0 1 1 vertically.''. It has offset
$1$ and begins
\[
10, 100, 378, 1269, 3835, 10098, 26375,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 09 2023 22:42:46, revision
7) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) - 10\,a(n-3) - 15\,a(n-4) + 40\,a(n-5) + 19\,a(n-6) - 25\,a(n-7) - 60\,a(n-8) + 32\,a(n-9) - 10\,a(n-10) + 29\,a(n-11) + 28\,a(n-12) + 43\,a(n-13) - 83\,a(n-14) - 24\,a(n-15) + 4\,a(n-16) + 30\,a(n-17) - 13\,a(n-18) + 20\,a(n-19) + a(n-20) - 3\,a(n-21) - 8\,a(n-22) + 4\,a(n-23) - 2\,a(n-24) - a(n-25) + a(n-27)
\end{equation}
for all $n>27$. 
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208416.
