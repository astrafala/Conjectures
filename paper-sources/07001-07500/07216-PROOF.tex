...
\title{The empirical recurrence for OEIS A207734, proved by transfer matrix}
...
\begin{abstract}
OEIS A207734 counts arrays over $\{0,\dots,1\}$ of width $7$ that avoid the patterns
...
OEIS A207734 is ``Number of 7Xn 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 1 1 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
31, 961, 2449, 6241, 88243, 1247689, 4799749,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:13:59, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 48\,a(n-3) + 1512\,a(n-4) + 180\,a(n-5) + 612\,a(n-6) - 15840\,a(n-7) - 496179\,a(n-8) - 159489\,a(n-9) + 110160\,a(n-10) + 986580\,a(n-11) + 48988800\,a(n-12) + 17204400\,a(n-13) + 52488000\,a(n-15) - 1049760000\,a(n-16)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207734.
