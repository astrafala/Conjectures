...
\title{The empirical recurrence for OEIS A302804, proved by transfer matrix}
...
\begin{abstract}
OEIS A302804 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the six horizontal, diagonal and antidiagonal neighbours, a number $equal to$ itself lying in $\{0,1,2,3,5\}$, and it carries an empirical
recurrence of order $18$ contributed by R.~H.~Hardin. It is true. The neighbourhood
...
OEIS A302804 is ``Number of nX4 0..1 arrays with every element equal to 0, 1, 2, 3 or 5 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
8, 105, 934, 8718, 82367, 773520, 7267160, 68346451,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 13 2018 13:06:05, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;10\,a(n-1) + a(n-2) + 25\,a(n-3) - 853\,a(n-4) - 99\,a(n-5) + 2046\,a(n-6) + 16917\,a(n-7) - 2302\,a(n-8) - 31502\,a(n-9) - 89718\,a(n-10) + 14428\,a(n-11) + 54836\,a(n-12) - 37484\,a(n-13) + 150384\,a(n-14) - 43524\,a(n-15) + 14472\,a(n-16) - 33696\,a(n-17) + 5832\,a(n-18)
\end{equation}
for all $n>20$.
...
$a(n)-\sum_i c_i a(n-i)=u_{\,n-2-18}$ whenever $n-18\ge2$. So \eqref{eq:conj}
holds for every $n>t$ exactly when $u_j=0$ for all $j>t-2-18$. Moreover $(u_j)$
...
\begin{proof}
Substituting Lemma~\ref{lem:walk} and factoring $P^{\,n-2-18}$ out of
...
\begin{proof}
The vector $q(P)\mathbf{e}\in\mathbb{Z}^{S}$ was formed by $18$ matrix--vector
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302804.
