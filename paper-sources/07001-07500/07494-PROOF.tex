...
\title{The empirical recurrence for OEIS A234224, proved by transfer matrix}
...
\begin{abstract}
OEIS A234224 counts $6$-column arrays over $\{0,\dots,4\}$ in which every
...
length $n$. Hence $a(n)=\mathbf{1}^{\!\top}M^{n}\mathbf{1}$ on $S=15625$ vertices, which
...
OEIS A234224 is ``Number of (n+1) X (5+1) 0..4 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 3 (constant-stress 1 X 1 tilings).''. It has offset
$1$ and begins
\[
32384, 76972, 188040, 503272, 1379816, 4055128, 12178344,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 19 2022 02:03:45, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;10\,a(n-1) + 16\,a(n-2) - 460\,a(n-3) + 789\,a(n-4) + 7170\,a(n-5) - 23944\,a(n-6) - 39920\,a(n-7) + 246076\,a(n-8) - 38440\,a(n-9) - 1115136\,a(n-10) + 1151040\,a(n-11) + 2005056\,a(n-12) - 3657600\,a(n-13) - 331776\,a(n-14) + 3456000\,a(n-15) - 1658880\,a(n-16)
\end{equation}
...
Let $V$ consist of all of $\{0,\dots,4\}^{6}$, and put $S=|V|=15625$. For $r,s\in V$ declare $r\to s$ an edge
when $\bigl|r_j+s_{j+1}-r_{j+1}-s_j\bigr|=3$ for every $j$ with
$1\le j\le6-1$. Let $M\in\{0,1\}^{S\times S}$ be the adjacency matrix and $\mathbf{1}$
the all-ones vector.
...
Third, the vanishing test of Lemma~\ref{lem:crit} was carried past $S=15625$ consecutive
zeros rather than to a sampled prefix, in exact integer arithmetic.

\begin{thebibliography}{9}
\bibitem{oeis} The OEIS Foundation, \emph{The On-Line Encyclopedia of Integer
Sequences}, \url{https://oeis.org}, 2026. Sequence A234224.
