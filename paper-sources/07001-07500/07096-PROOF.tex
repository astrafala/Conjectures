...
\title{A condition on each element and its neighbours: OEIS A295047}
...
\begin{abstract}
OEIS A295047 carries an empirical recurrence of order $18$ contributed by R.~H.~Hardin. It is
...
OEIS A295047 is ``Number of n X 4 0..1 arrays with each 1 horizontally or vertically adjacent to 0 or 2 1's.''. It has offset $1$ and begins
\[
8, 48, 270, 1569, 9045, 52199, 301306, 1739181,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 24 2026 09:56:34, revision 6) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{The count is a walk count}

The entry counts arrays with $4$ columns over the alphabet $\{0,1\}$, growing one row at a time. Its condition is that every entry equal to $1$ must have exactly $0$ or $2$ of its horizontal and vertical neighbours equal to $1$.
...
Vertices with identical futures are merged, which leaves $S=20$. An admissible array is exactly a walk, so with $M$ the adjacency matrix and $\iota,\tau$ the vectors recording which states may begin and end an array,
\[
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) + 6\,a(n-2) - 4\,a(n-3) - 25\,a(n-4) - 13\,a(n-5) - 31\,a(n-6) - 19\,a(n-7) - 56\,a(n-8) + 83\,a(n-9) + 39\,a(n-10) + 23\,a(n-11) + 53\,a(n-12) + 14\,a(n-13) + 15\,a(n-14) + 2\,a(n-15) - 4\,a(n-16) - a(n-17) - a(n-18)
\]
for every $n>18$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A295047.
