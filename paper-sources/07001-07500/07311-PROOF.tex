...
\title{The empirical recurrence for OEIS A251830, proved by transfer matrix}
...
\begin{abstract}
OEIS A251830 counts arrays of width $3$ over $\{0,1,2,3\}$ in which every $3\times3$ window has
...
OEIS A251830 is ``Number of (n+2) X (1+2) 0..3 arrays with no row, column, diagonal or antidiagonal in any 3 X 3 subblock summing to 3 4 5 or 6.''. It has offset $1$ and begins
\[
678, 3354, 18124, 97316, 518514, 2764828, 14778068, 79010324,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 03 2021 14:54:08, revision 7) this is still
...
\text{each row} & \text{must NOT be 3 or 4 or 5 or 6} \\
\text{each column} & \text{must NOT be 3 or 4 or 5 or 6} \\
\text{the main diagonal} & \text{must NOT be 3 or 4 or 5 or 6} \\
\text{the antidiagonal} & \text{must NOT be 3 or 4 or 5 or 6} \\
\end{array}
\]
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 8\,a(n-2) + 41\,a(n-3) + 68\,a(n-4) + 33\,a(n-5) - 207\,a(n-6) - 543\,a(n-7) - 471\,a(n-8) - 30\,a(n-9) + 202\,a(n-10) - 352\,a(n-11) - 548\,a(n-12) + 37\,a(n-13) + 640\,a(n-14) + 670\,a(n-15) + 347\,a(n-16) + 235\,a(n-17) - 124\,a(n-18) - 97\,a(n-19) - 106\,a(n-20) - 51\,a(n-21) - 56\,a(n-22) + 8\,a(n-23) + 4\,a(n-24) + 8\,a(n-25) + 4\,a(n-27)
\]
for every $n>29$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251830.
