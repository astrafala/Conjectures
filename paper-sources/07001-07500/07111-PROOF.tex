...
\title{The empirical recurrence for OEIS A297502, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297502 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A297502 is ``Number of nX4 0..1 arrays with every 1 horizontally, diagonally or antidiagonally adjacent to 1 or 2 neighboring 1s.''. It has offset $1$ and begins
\[
7, 68, 314, 2281, 14201, 88808, 573119, 3613793,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 31 2017 07:25:28, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 19\,a(n-2) + 58\,a(n-3) - 7\,a(n-4) - 41\,a(n-5) - 196\,a(n-6) - 202\,a(n-7) - 78\,a(n-8) + 196\,a(n-9) + 176\,a(n-10) + 122\,a(n-11) + 19\,a(n-12) + 37\,a(n-13) + 22\,a(n-14) + 21\,a(n-15) + 10\,a(n-16) - a(n-17) - a(n-18)
\end{equation}
for all $n>19$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297502.
