...
\title{The empirical recurrence for OEIS A258727, proved by transfer matrix}
...
\begin{abstract}
OEIS A258727 carries an empirical recurrence of order $16$ contributed by R.~H.~Hardin. It is
...
OEIS A258727 is ``Number of length n+5 0..3 arrays with at most one downstep in every 5 consecutive neighbor pairs.''. It has offset $1$ and begins
\[
1212, 2936, 7834, 21860, 59188, 149960, 370510, 941024,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 15:31:14, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) - 6\,a(n-2) + 4\,a(n-3) - a(n-4) + 52\,a(n-5) - 128\,a(n-6) + 108\,a(n-7) - 31\,a(n-8) - 68\,a(n-10) + 92\,a(n-11) - 31\,a(n-12) + 4\,a(n-15) - a(n-16)
\]
for every $n>21$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A258727.
