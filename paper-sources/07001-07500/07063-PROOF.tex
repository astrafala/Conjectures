...
\title{The empirical recurrence for OEIS A236350, proved by transfer matrix}
...
\begin{abstract}
OEIS A236350 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
The condition is local to two consecutive rows, so the count is a walk count on $S=462$
...
OEIS A236350 is ``Number of (n+1)X(2+1) 0..2 arrays colored with the sum of the upper and lower median values of each 2X2 subblock.''. It has offset $1$ and begins
\[
462, 3684, 27836, 220560, 1773948, 14076412, 111309712, 884028160,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 09:14:39, revision 6) this is still
...
\]
over the $S=462$ pairs whose own subblock row is properly coloured.
...
\begin{theorem}
\[
a(n)\;=\;24\,a(n-2) + 174\,a(n-3) + 967\,a(n-4) + 1500\,a(n-5) - 1888\,a(n-6) - 18876\,a(n-7) - 51836\,a(n-8) + 27597\,a(n-9) + 257456\,a(n-10) + 78401\,a(n-11) - 251174\,a(n-12) + 340704\,a(n-13) - 895615\,a(n-14) - 3093453\,a(n-15) + 2940769\,a(n-16) + 6734039\,a(n-17) - 3709367\,a(n-18) - 4102971\,a(n-19) - 657304\,a(n-20) - 5725285\,a(n-21) + 9970384\,a(n-22) + 9347337\,a(n-23) - 11796132\,a(n-24) - 18284\,a(n-25) + 2908512\,a(n-26) - 4975360\,a(n-27) + 1382528\,a(n-28) - 988800\,a(n-29) + 166400\,a(n-30) + 157696\,a(n-31)
\]
for every $n>32$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A236350.
