...
\title{The empirical recurrence for OEIS A303797, proved by transfer matrix}
...
\begin{abstract}
OEIS A303797 counts $5$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A303797 is ``Number of nX5 0..1 arrays with every element unequal to 0, 1, 2 or 4 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
16, 64, 70, 231, 562, 1406, 2829, 7014,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 30 2018 17:12:08, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 3\,a(n-2) + a(n-3) + 6\,a(n-4) - 11\,a(n-5) - 18\,a(n-6) + 7\,a(n-7) - 4\,a(n-8) + 2\,a(n-9) + 24\,a(n-10) - 4\,a(n-11) + 3\,a(n-12) + 5\,a(n-13) - 10\,a(n-14) + a(n-15) - 4\,a(n-16) - a(n-17) + a(n-18)
\end{equation}
for all $n>24$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A303797.
