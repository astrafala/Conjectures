...
\title{The empirical recurrence for OEIS A184682, proved by transfer matrix}
...
\begin{abstract}
OEIS A184682 counts arrays over $\{0,\dots,1\}$ under a condition on the determinant of every
...
OEIS A184682 is ``Number of (n+1)X6 binary arrays with every 2X2 subblock singular.''. It has offset $1$ and begins
\[
568, 10384, 140816, 2171152, 31817360, 476660624, 7079094288, 105530924944,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 02:50:04, revision 9) this is still
...
first term is $568$, and the model reproduces it along with every later term; that is the
...
\begin{theorem}
\[
a(n)\;=\;25\,a(n-1) - 131\,a(n-2) - 771\,a(n-3) + 8180\,a(n-4) - 11482\,a(n-5) - 71100\,a(n-6) + 202352\,a(n-7) + 125888\,a(n-8) - 816032\,a(n-9) + 304768\,a(n-10) + 951040\,a(n-11) - 590848\,a(n-12) - 217088\,a(n-13) + 98304\,a(n-14)
\]
for every $n>13$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A184682.
