...
\title{The empirical recurrence for OEIS A236782, proved by transfer matrix}
...
\begin{abstract}
OEIS A236782 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
OEIS A236782 is ``Number of (n+1)X(1+1) 0..2 arrays with the upper median plus the lower median minus the minimum of every 2X2 subblock equal.''. It has offset $1$ and begins
\[
81, 255, 770, 2475, 7967, 26320, 87685, 296341,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 09:32:26, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;9\,a(n-1) - 201\,a(n-3) + 319\,a(n-4) + 1872\,a(n-5) - 4022\,a(n-6) - 9892\,a(n-7) + 22860\,a(n-8) + 34480\,a(n-9) - 71032\,a(n-10) - 84736\,a(n-11) + 121824\,a(n-12) + 140864\,a(n-13) - 100416\,a(n-14) - 135936\,a(n-15) + 17408\,a(n-16) + 54784\,a(n-17) + 14336\,a(n-18)
\]
for every $n>18$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A236782.
