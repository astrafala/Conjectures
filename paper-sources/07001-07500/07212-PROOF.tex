...
\title{The empirical recurrence for OEIS A243640, proved by transfer matrix}
...
\begin{abstract}
OEIS A243640 carries an empirical recurrence of order $16$ contributed by R.~H.~Hardin. It is
...
OEIS A243640 is ``Number of length n+2 0..9 arrays with no three unequal elements in a row and new values 0..9 introduced in 0..9 order.''. It has offset $1$ and begins
\[
4, 9, 21, 51, 127, 324, 844, 2243,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 11:21:30, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;17\,a(n-1) - 99\,a(n-2) + 125\,a(n-3) + 931\,a(n-4) - 3185\,a(n-5) - 1785\,a(n-6) + 19063\,a(n-7) - 6754\,a(n-8) - 56936\,a(n-9) + 32132\,a(n-10) + 99764\,a(n-11) - 41096\,a(n-12) - 100896\,a(n-13) + 5152\,a(n-14) + 42048\,a(n-15) + 11520\,a(n-16)
\]
for every $n>17$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A243640.
