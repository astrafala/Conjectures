...
\title{The empirical recurrence for OEIS A297983, proved by transfer matrix}
...
\begin{abstract}
OEIS A297983 counts $5$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A297983 is ``Number of nX5 0..1 arrays with every element equal to 0, 2, 3 or 6 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 24, 7, 23, 34, 61, 105, 222,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 10 2018 07:20:47, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + a(n-2) - a(n-3) + 6\,a(n-4) - 9\,a(n-5) - 15\,a(n-6) + 2\,a(n-7) - 9\,a(n-8) + 6\,a(n-9) + 34\,a(n-10) + 45\,a(n-11) + 6\,a(n-12) - 21\,a(n-13) - 39\,a(n-14) + 2\,a(n-15) - 8\,a(n-16) - 38\,a(n-17) - 7\,a(n-18) + 26\,a(n-19) - 24\,a(n-20) - 48\,a(n-21) + 28\,a(n-22) + 23\,a(n-23) - 37\,a(n-24) - 4\,a(n-25) + 88\,a(n-26) + 34\,a(n-27) - 14\,a(n-28) + 7\,a(n-29) + 24\,a(n-30) - 2\,a(n-31) - 23\,a(n-32) - 6\,a(n-33) - 4\,a(n-34) - 3\,a(n-35) - 2\,a(n-36) - 2\,a(n-37)
\end{equation}
for all $n>43$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297983.
