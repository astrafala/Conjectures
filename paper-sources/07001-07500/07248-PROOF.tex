...
\title{The empirical recurrence for OEIS A280857, proved by transfer matrix}
...
\begin{abstract}
OEIS A280857 counts $n\times6$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A280857 is ``Number of nX6 0..2 arrays with no element equal to more than one of its king-move neighbors and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
82, 1708, 678, 462, 491, 712, 1202, 2268,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 09 2017 09:36:38, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + a(n-2) - a(n-3) + a(n-4) + 6\,a(n-7) - 5\,a(n-8) + 3\,a(n-9) - 3\,a(n-10) - 3\,a(n-11) + 2\,a(n-12) - 4\,a(n-13) + a(n-14) - 2\,a(n-15) - 2\,a(n-16)
\]
for every $n>22$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A280857.
