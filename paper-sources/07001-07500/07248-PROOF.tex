...
\title{The empirical recurrence for OEIS A301904, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A301904 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A301904 is ``Number of nX6 0..1 arrays with every element equal to 0, 2 or 3 horizontally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
1, 6, 7, 40, 92, 532, 1999, 10150,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 28 2018 16:07:50, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 22\,a(n-2) - 23\,a(n-3) - 132\,a(n-4) - 102\,a(n-5) - 188\,a(n-6) + 202\,a(n-7) + 1241\,a(n-8) + 242\,a(n-9) - 1952\,a(n-10) - 662\,a(n-11) + 1583\,a(n-12) + 498\,a(n-13) - 772\,a(n-14) - 182\,a(n-15) + 220\,a(n-16) + 31\,a(n-17) - 22\,a(n-18) - 7\,a(n-19) + a(n-20)
\end{equation}
for all $n>21$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A301904.
