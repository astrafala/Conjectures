...
\title{The empirical recurrence for OEIS A253751, proved by transfer matrix}
...
\begin{abstract}
OEIS A253751 counts the arrays over $\{0,\dots,2\}$ whose $2\times2$ subblocks carry a
...
OEIS A253751 is ``Number of (3+1)X(n+1) 0..2 arrays with every 2X2 subblock ne-sw antidiagonal difference nondecreasing horizontally and nw+se diagonal sum nondecreasing vertically.''. It has offset $1$ and begins
\[
1998, 16625, 77414, 247252, 583698, 1204422, 2363797, 4404701,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 14:13:07, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) - 10\,a(n-2) + 12\,a(n-3) - 8\,a(n-4) - 10\,a(n-5) + 35\,a(n-6) - 47\,a(n-7) + 42\,a(n-8) - 10\,a(n-9) - 40\,a(n-10) + 68\,a(n-11) - 68\,a(n-12) + 40\,a(n-13) + 10\,a(n-14) - 42\,a(n-15) + 47\,a(n-16) - 35\,a(n-17) + 10\,a(n-18) + 8\,a(n-19) - 12\,a(n-20) + 10\,a(n-21) - 5\,a(n-22) + a(n-23)
\]
for every $n>30$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253751.
