...
\title{The empirical recurrence for OEIS A299003, proved by transfer matrix}
...
\begin{abstract}
OEIS A299003 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $equal to$ itself lying in $\{0,1,2,3,5,6\}$, and it carries an empirical
...
OEIS A299003 is ``Number of nX3 0..1 arrays with every element equal to 0, 1, 2, 3, 5 or 6 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
4, 26, 94, 372, 1510, 6105, 24546, 98995,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 31 2018 09:23:09, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) - 4\,a(n-2) + 5\,a(n-3) - 16\,a(n-4) - 19\,a(n-5) + 35\,a(n-6) - 5\,a(n-7) + 54\,a(n-8) - 94\,a(n-9) + 3\,a(n-11) + 74\,a(n-12) + 33\,a(n-13) - 21\,a(n-14) - 17\,a(n-15) - 8\,a(n-16) - 11\,a(n-17) - 4\,a(n-18)
\end{equation}
for all $n>19$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A299003.
