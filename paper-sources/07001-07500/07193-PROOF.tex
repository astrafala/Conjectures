...
\title{The empirical recurrence for OEIS A252420, proved by transfer matrix}
...
\begin{abstract}
OEIS A252420 counts $(n+2)\times7$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
$a(n)$ is a walk count on $S=17210$ vertices. Such a sequence is $C$-finite, so whether a given
...
OEIS A252420 is ``Number of (n+2)X(5+2) 0..3 arrays with every 3X3 subblock row and column sum not equal to 0 2 5 6 or 7 and every 3X3 diagonal and antidiagonal sum equal to 0 2 5 6 or 7.''. It has offset $1$ and begins
\[
2380, 3472, 11409, 22038, 96549, 365974, 715123, 3213732,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:12:47, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;76\,a(n-3) - 2082\,a(n-6) + 27585\,a(n-9) - 201704\,a(n-12) + 870200\,a(n-15) - 2284208\,a(n-18) + 3690384\,a(n-21) - 3708548\,a(n-24) + 2399781\,a(n-27) - 1049128\,a(n-30) + 305470\,a(n-33) - 52269\,a(n-36) + 4604\,a(n-39) - 160\,a(n-42)
\]
for every $n>47$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252420.
