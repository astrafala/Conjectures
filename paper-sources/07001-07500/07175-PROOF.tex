...
\title{The empirical recurrence for OEIS A232363, proved by transfer matrix}
...
\begin{abstract}
OEIS A232363 counts arrays of width $3$ over $\{0,1,2\}$ in which every cell carrying one stated
...
OEIS A232363 is ``Number of n X 3 0..2 arrays with every 0 next to a 1 and every 1 next to a 2 horizontally or vertically.''. It has offset $1$ and begins
\[
7, 145, 2411, 39321, 647287, 10652849, 175284259, 2884208601,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 02 2021 10:25:38, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;15\,a(n-1) + 13\,a(n-2) + 171\,a(n-3) + 144\,a(n-4) + 128\,a(n-5) - 1072\,a(n-6) - 5144\,a(n-7) - 6575\,a(n-8) - 1670\,a(n-9) + 29979\,a(n-10) + 28328\,a(n-11) - 17313\,a(n-12) - 16033\,a(n-13) - 7412\,a(n-14) - 6950\,a(n-15) + 6052\,a(n-16) + 6881\,a(n-17) + 4681\,a(n-18) + 3057\,a(n-19) + 575\,a(n-20) + 420\,a(n-21)
\]
for every $n>20$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232363.
