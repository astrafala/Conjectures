...
\title{The empirical recurrence for OEIS A237385, proved by transfer matrix}
...
\begin{abstract}
OEIS A237385 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
OEIS A237385 is ``Number of (n+1)X(1+1) 0..2 arrays colored with the maximum plus the upper median minus the minimum of every 2X2 subblock.''. It has offset $1$ and begins
\[
81, 434, 2336, 12624, 68064, 366568, 1976940, 10657560,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 10:08:33, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;30\,a(n-3) + 349\,a(n-4) + 818\,a(n-5) + 3504\,a(n-6) + 7320\,a(n-7) + 9876\,a(n-8) + 18056\,a(n-9) - 14960\,a(n-10) - 63872\,a(n-11) - 133008\,a(n-12) - 307168\,a(n-13) - 194624\,a(n-14) + 71296\,a(n-15) + 344832\,a(n-16) + 1077248\,a(n-17) + 985088\,a(n-18) - 16384\,a(n-19) - 212992\,a(n-20)
\]
for every $n>20$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237385.
