...
\title{The empirical recurrence for OEIS A261290, proved by transfer matrix}
...
\begin{abstract}
OEIS A261290 counts $(n+2)\times8$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
every $3\times3$ subblock, and it carries an empirical recurrence of order $41$
...
OEIS A261290 is ``Number of (n+2)X(6+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000001 00010101 or 01010101.''. It has offset $1$ and begins
\[
540, 743, 2104, 6034, 17094, 51268, 153144, 446786,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 14 2015 07:16:36, revision 4) this is still
...
\[
\text{the clockwise perimeter word of }g\text{ is a rotation of one of }\{00000001,\ 00010101,\ 01010101\}
\]
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 9\,a(n-3) + 18\,a(n-4) + 14\,a(n-5) + 19\,a(n-6) - 13\,a(n-7) - 65\,a(n-8) - 40\,a(n-9) + 21\,a(n-10) + 45\,a(n-11) + 11\,a(n-12) - 36\,a(n-13) - 113\,a(n-14) - 28\,a(n-15) + 189\,a(n-16) - 151\,a(n-17) - 300\,a(n-18) + 306\,a(n-19) + 333\,a(n-20) - 73\,a(n-21) + 112\,a(n-22) - 90\,a(n-23) - 484\,a(n-24) - 221\,a(n-25) - 485\,a(n-26) - 39\,a(n-27) + 1517\,a(n-28) + 362\,a(n-29) - 1282\,a(n-30) + 71\,a(n-31) + 500\,a(n-32) - 205\,a(n-33) + 106\,a(n-34) + 105\,a(n-35) - 45\,a(n-36) - 15\,a(n-37) - 140\,a(n-38) - 42\,a(n-39) - 28\,a(n-40) - 16\,a(n-41)
\]
for every $n>48$.
\end{theorem}

\begin{proof}
The vector $w=q(M)\mathbf{1}$ was formed by $41$ matrix--vector products in exact
integer arithmetic and $\mathbf{1}^{\!\top}M^{j}w$ evaluated for $j=0,1,\dots$, again
exactly. Those integers vanish from the index corresponding to $n=48+1$ onwards, and the
run was continued until the working vector was identically zero, which settles all larger $j$
at once. By Lemma~\ref{lem:crit} the recurrence holds for every $n>48$.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A261290.
