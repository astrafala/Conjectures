...
\title{The empirical recurrence for OEIS A254391, proved by transfer matrix}
...
\begin{abstract}
OEIS A254391 counts the arrays over $\{0,\dots,1\}$ whose $3\times3$ subblocks carry a
...
so the count is a walk count on $S=436$ states --- the last two array rows together with the
...
OEIS A254391 is ``Number of (2+2)X(n+2) 0..1 arrays with every 3X3 subblock diagonal maximum plus antidiagonal maximum nondecreasing horizontally, vertically and ne-to-sw antidiagonally.''. It has offset $1$ and begins
\[
3372, 35529, 406548, 4711324, 54122833, 623732385, 7193711039, 82923118414,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 14:38:52, revision 6) this is still
...
\]
on the $S=436$ reachable states. In particular $a$ is $C$-finite. The alignment of the walk
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A254391.
