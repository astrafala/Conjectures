...
\title{The empirical recurrence for OEIS A196797, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A196797 counts arrays over $\{0,\dots,4\}$ in which every cell is constrained by the
...
OEIS A196797 is ``Number of nX3 0..4 arrays with each element x equal to the number its horizontal and vertical neighbors equal to 3,2,0,4,1 for x=0,1,2,3,4.''. It has offset $1$ and begins
\[
2, 20, 120, 698, 4078, 23920, 140348, 821284,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 06:44:58, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 6\,a(n-2) + 39\,a(n-3) + 95\,a(n-4) + 300\,a(n-5) - 178\,a(n-6) + 28\,a(n-7) - 400\,a(n-8) - 156\,a(n-9) - 1924\,a(n-10) - 2663\,a(n-11) + 756\,a(n-12) - 155\,a(n-13) - 1379\,a(n-14) + 1596\,a(n-15) + 963\,a(n-16) - 3105\,a(n-17) - 1112\,a(n-18) + 2019\,a(n-19) + 974\,a(n-20) - 123\,a(n-21) - 136\,a(n-22) - 60\,a(n-23) - 7\,a(n-24) + 5\,a(n-25) + a(n-26)
\end{equation}
for all $n>27$.
...
\#\{\text{neighbours with value }f(x_{t,u})\}=x_{t,u},\quad f=(3,2,0,4,1)
\end{equation}
for every cell $(t,u)$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A196797.
