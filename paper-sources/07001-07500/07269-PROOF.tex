...
\title{The empirical recurrence for OEIS A237405, proved by transfer matrix}
...
\begin{abstract}
OEIS A237405 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
OEIS A237405 is ``Number of (n+1) X (1+1) 0..2 arrays with the maximum plus the upper median plus the minimum of every 2 X 2 subblock differing from its horizontal and vertical neighbors by exactly one.''. It has offset $1$ and begins
\[
81, 322, 1278, 5228, 21456, 87164, 354008, 1441060,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 200*a(n-4) +1216*a(n-6) +604*a(n-8) -4556*a(n-10) -2656*a(n-12) +1808*a(n-14) +1024*a(n-16).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 07 2014 19:21:33, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;200\,a(n-4) + 1216\,a(n-6) + 604\,a(n-8) - 4556\,a(n-10) - 2656\,a(n-12) + 1808\,a(n-14) + 1024\,a(n-16)
\]
for every $n>16$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237405.
