...
\title{The empirical recurrence for OEIS A236199, proved by transfer matrix}
...
\begin{abstract}
OEIS A236199 counts arrays over $\{0,\dots,3\}$ subject to a condition on the order
statistics of every $2\times2$ subblock, and carries an empirical recurrence of order
$28$ contributed by R.~H.~Hardin. It is true, and it is decidable rather than empirical.
...
OEIS A236199 is ``Number of (n+1)X(1+1) 0..3 arrays colored with the maximum plus the upper median minus the lower median minus the minimum of every 2X2 subblock.''. It has offset $1$ and begins
\[
256, 3020, 35874, 427680, 5098640, 60725856, 723344402, 8617376624,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 09:10:58, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 19\,a(n-2) + 483\,a(n-3) + 6515\,a(n-4) + 30487\,a(n-5) + 130534\,a(n-6) + 268052\,a(n-7) - 1853784\,a(n-8) - 10798260\,a(n-9) - 40876008\,a(n-10) - 100945632\,a(n-11) + 217780976\,a(n-12) + 1450894176\,a(n-13) + 3234709632\,a(n-14) + 5425161856\,a(n-15) - 12402266368\,a(n-16) - 67991835648\,a(n-17) - 74628667392\,a(n-18) - 3822813184\,a(n-19) + 259752861696\,a(n-20) + 812620038144\,a(n-21) + 144847536128\,a(n-22) - 1801215803392\,a(n-23) - 1109966979072\,a(n-24) + 1391295725568\,a(n-25) + 1079802593280\,a(n-26) - 338379669504\,a(n-27) - 293534171136\,a(n-28)
\]
for every $n>28$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A236199.
