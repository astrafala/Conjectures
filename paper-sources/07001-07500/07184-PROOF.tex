...
\title{The empirical recurrence for OEIS A297716, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297716 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A297716 is ``Number of nX4 0..1 arrays with every 1 horizontally, diagonally or antidiagonally adjacent to 1, 2 or 4 neighboring 1s.''. It has offset $1$ and begins
\[
7, 83, 523, 4212, 34319, 268630, 2139403, 17031173,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 04 2018 21:55:56, revision 4) the statement is
...
the middle row. The vector $w$ was formed by $42$ applications of $G$ in exact integer
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297716.
