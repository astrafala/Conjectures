...
\title{The empirical recurrence for OEIS A305010, proved by transfer matrix}
...
\begin{abstract}
OEIS A305010 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $different from$ itself lying in $\{1,2,4,5,7\}$, and it carries an empirical
...
OEIS A305010 is ``Number of nX3 0..1 arrays with every element unequal to 1, 2, 4, 5 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 11, 14, 31, 99, 206, 455, 1321,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 23 2018 16:00:45, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 3\,a(n-2) + 13\,a(n-3) - 9\,a(n-4) - 37\,a(n-5) - 59\,a(n-6) + 27\,a(n-7) + 130\,a(n-8) + 92\,a(n-9) - 35\,a(n-10) - 129\,a(n-11) - 8\,a(n-12) + 78\,a(n-13) + 45\,a(n-14) - 53\,a(n-15) - 34\,a(n-16) - 24\,a(n-17)
\end{equation}
for all $n>18$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A305010.
