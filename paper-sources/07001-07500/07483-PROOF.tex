...
\title{The empirical recurrence for OEIS A208037, proved by transfer matrix}
...
\begin{abstract}
OEIS A208037 counts arrays over $\{0,\dots,1\}$ of width $6$ that avoid the patterns
...
OEIS A208037 is ``Number of nX6 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 0 0 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
25, 625, 3969, 23409, 137641, 811801, 4791721,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:35:46, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 10\,a(n-2) + 53\,a(n-3) + 144\,a(n-4) + 139\,a(n-5) - 542\,a(n-6) - 1870\,a(n-7) - 1005\,a(n-8) + 2821\,a(n-9) + 3667\,a(n-10) - 1118\,a(n-11) - 2098\,a(n-12) + 864\,a(n-13) + 3529\,a(n-14) + 6316\,a(n-15) + 3326\,a(n-16) + 1343\,a(n-17) - 3558\,a(n-18) + 1437\,a(n-19) - 5034\,a(n-20) + 2804\,a(n-21) - 5891\,a(n-22) + 3521\,a(n-23) - 3008\,a(n-24) + 3398\,a(n-25) - 1498\,a(n-26) + 1049\,a(n-27) - 755\,a(n-28) + 265\,a(n-29) - 192\,a(n-30) + 81\,a(n-31) - 16\,a(n-32) + 12\,a(n-33) - 5\,a(n-34) + 3\,a(n-35) - a(n-36)
\end{equation}
for all $n>37$. 
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208037.
