...
\title{The empirical recurrence for OEIS A278016, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A278016 counts arrays over $\{0,\dots,2\}$ in which every cell is constrained by the
...
OEIS A278016 is ``Number of 3Xn 0..2 arrays with every element plus 1 mod 3 equal to some element at offset (-1,-1) (-1,0) (-1,1) (0,-1) (0,1) or (1,0), with upper left element zero.''. It has offset $1$ and begins
\[
0, 30, 410, 6372, 98410, 1516632, 23376048, 360279838,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 08 2016 12:32:06, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;18\,a(n-1) - 32\,a(n-2) - 102\,a(n-3) - 406\,a(n-4) + 1452\,a(n-5) + 2596\,a(n-6) + 2458\,a(n-7) - 22648\,a(n-8) - 18454\,a(n-9) + 18879\,a(n-10) + 122984\,a(n-11) - 5236\,a(n-12) - 144156\,a(n-13) - 72858\,a(n-14) + 40286\,a(n-15) + 58052\,a(n-16) + 2232\,a(n-17) - 1856\,a(n-18) - 4224\,a(n-19)
\end{equation}
for all $n>20$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A278016.
