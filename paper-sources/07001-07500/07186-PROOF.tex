...
\title{The empirical recurrence for OEIS A260011, proved by transfer matrix}
...
\begin{abstract}
OEIS A260011 counts $(n+2)\times6$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A260011 is ``Number of (n+2)X(4+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000101 00010101 or 01010101.''. It has offset $1$ and begins
\[
209, 578, 2492, 8450, 25600, 84050, 292422, 985608,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:58:48, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 9\,a(n-3) + 27\,a(n-4) - 13\,a(n-5) - a(n-6) - 54\,a(n-7) - 129\,a(n-8) + 13\,a(n-9) - 2\,a(n-10) + 48\,a(n-11) + 108\,a(n-12) - 4\,a(n-13) - 8\,a(n-15) - 16\,a(n-16)
\]
for every $n>17$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A260011.
