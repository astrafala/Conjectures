...
\title{The empirical recurrence for OEIS A280394, proved by transfer matrix}
...
\begin{abstract}
OEIS A280394 counts $n\times4$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A280394 is ``Number of nX4 0..2 arrays with no element unequal to a strict majority of its horizontal and antidiagonal neighbors, with the exception of exactly one element, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
2, 16, 238, 3002, 35676, 410670, 4627308, 51310794,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 02 2017 10:41:19, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;34\,a(n-1) - 481\,a(n-2) + 3880\,a(n-3) - 20944\,a(n-4) + 82088\,a(n-5) - 243952\,a(n-6) + 563264\,a(n-7) - 1021840\,a(n-8) + 1458048\,a(n-9) - 1621632\,a(n-10) + 1371136\,a(n-11) - 839936\,a(n-12) + 335872\,a(n-13) - 65536\,a(n-14)
\]
for every $n>15$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A280394.
