...
\title{The empirical recurrence for OEIS A252082, proved by transfer matrix}
...
\begin{abstract}
OEIS A252082 counts $(n+2)\times4$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A252082 is ``Number of (n+2)X(2+2) 0..2 arrays with every 3X3 subblock row, column, diagonal and antidiagonal sum not equal to 1 3 or 4.''. It has offset $1$ and begins
\[
130, 322, 943, 2595, 7089, 19910, 55703, 155266,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 10:46:16, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252082.
