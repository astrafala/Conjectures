...
\title{The empirical recurrence for OEIS A256745, proved by transfer matrix}
...
\begin{abstract}
OEIS A256745 counts $(n+2)\times7$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A256745 is ``Number of (n+2)X(5+2) 0..1 arrays with no 3x3 subblock diagonal sum 3 and no antidiagonal sum 3 and no row sum 0 and no column sum 0.''. It has offset $1$ and begins
\[
5255, 6352, 9112, 10360, 22080, 47440, 96576, 160704,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:44:56, revision 6) this is still
...
\[
\text{every diagonal sum} \notin \{3\}\ \text{ and }\ \text{every antidiagonal sum} \notin \{3\}\ \text{ and }\ \text{every row sum} \notin \{0\}\ \text{ and }\ \text{every column sum} \notin \{0\}
\]
...
\begin{theorem}
\[
a(n)\;=\;-2\,a(n-1) + 2\,a(n-2) + 16\,a(n-3) + 25\,a(n-4) - 14\,a(n-5) - 50\,a(n-6) - 64\,a(n-7) - 120\,a(n-8) - 296\,a(n-9) - 112\,a(n-10) + 1088\,a(n-11) + 1728\,a(n-12) + 384\,a(n-13) - 2048\,a(n-14) - 2048\,a(n-15)
\]
for every $n>18$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A256745.
