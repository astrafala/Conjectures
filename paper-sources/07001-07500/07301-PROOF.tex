...
\title{The empirical recurrence for OEIS A299123, proved by transfer matrix}
...
\begin{abstract}
OEIS A299123 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $equal to$ itself lying in $\{0,1,3,4,5,7\}$, and it carries an empirical
...
OEIS A299123 is ``Number of n X 3 0..1 arrays with every element equal to 0, 1, 3, 4, 5 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
3, 4, 9, 23, 31, 184, 427, 1115,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 11 2023 14:36:19, revision
6) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 4\,a(n-2) + 16\,a(n-3) - 13\,a(n-4) - 35\,a(n-5) - 62\,a(n-6) + 28\,a(n-7) + 65\,a(n-8) + 36\,a(n-9) + 61\,a(n-10) + 59\,a(n-11) - 34\,a(n-12) - 64\,a(n-13) - 36\,a(n-14) - 40\,a(n-15) + 3\,a(n-16) + 18\,a(n-17) + 2\,a(n-18)
\end{equation}
for all $n>19$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A299123.
