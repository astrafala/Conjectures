...
\title{The empirical recurrence for OEIS A197093, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A197093 counts arrays over $\{0,\dots,4\}$ in which every cell is constrained by the
...
OEIS A197093 is ``Number of nX3 0..4 arrays with each element x equal to the number its horizontal and vertical neighbors equal to 4,4,0,0,1 for x=0,1,2,3,4.''. It has offset $1$ and begins
\[
2, 18, 74, 384, 1880, 9274, 45843, 226260,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 06:58:28, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 5\,a(n-2) + 16\,a(n-3) + 26\,a(n-4) + 32\,a(n-5) - 2\,a(n-6) + 2\,a(n-7) - 30\,a(n-8) + 7\,a(n-9) - 3\,a(n-10) + a(n-11) + a(n-12) - a(n-13)
\end{equation}
for all $n>14$.
...
\#\{\text{neighbours with value }f(x_{t,u})\}=x_{t,u},\quad f=(4,4,0,0,1)
\end{equation}
for every cell $(t,u)$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A197093.
