...
\title{The empirical recurrence for OEIS A236052, proved by transfer matrix}
...
\begin{abstract}
OEIS A236052 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
The condition is local to two consecutive rows, so the count is a walk count on $S=13716$
...
OEIS A236052 is ``Number of (n+1)X(5+1) 0..2 arrays colored with the difference of the maximum and minimum in each 2X2 subblock.''. It has offset $1$ and begins
\[
13716, 38700, 103986, 258432, 773442, 1937236, 5670054, 14489552,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 09:02:51, revision 6) this is still
...
\]
over the $S=13716$ pairs whose own subblock row is properly coloured.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A236052.
