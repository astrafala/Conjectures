...
\title{The empirical recurrence for OEIS A252560, proved by transfer matrix}
...
\begin{abstract}
OEIS A252560 counts $4\times(n+2)$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252560 is ``Number of (2+2) X (n+2) 0..3 arrays with every 3 X 3 subblock row and diagonal sum equal to 1, 2, 4, 6 or 7 and every 3 X 3 column and antidiagonal sum not equal to 1, 2, 4, 6 or 7.''. It has offset $1$ and begins
\[
747, 889, 1752, 3178, 8508, 21797, 42359, 123304,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 20 2021 11:43:27, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252560.
