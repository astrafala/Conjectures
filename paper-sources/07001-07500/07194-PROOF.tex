...
\title{The empirical recurrence for OEIS A251843, proved by transfer matrix}
...
\begin{abstract}
OEIS A251843 counts $(n+2)\times8$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
$a(n)$ is a walk count on $S=66006$ vertices. Such a sequence is $C$-finite, so whether a given
...
OEIS A251843 is ``Number of (n+2)X(6+2) 0..3 arrays with every 3X3 subblock row and column sum nonprime and every diagonal and antidiagonal sum prime.''. It has offset $1$ and begins
\[
1951, 5438, 21748, 48692, 277125, 1226031, 2726048, 16168331,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:30:13, revision 6) this is still
...
\[
\text{every row, column sum is nonprime}\ \text{ and }\ \text{every diagonal, antidiagonal sum is prime}
\]
...
\begin{theorem}
\[
a(n)\;=\;123\,a(n-3) - 4692\,a(n-6) + 69631\,a(n-9) - 514311\,a(n-12) + 2250027\,a(n-15) - 6529710\,a(n-18) + 13126892\,a(n-21) - 18315243\,a(n-24) + 17438687\,a(n-27) - 11035045\,a(n-30) + 4492984\,a(n-33) - 1153262\,a(n-36) + 193456\,a(n-39) - 19536\,a(n-42)
\]
for every $n>50$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251843.
