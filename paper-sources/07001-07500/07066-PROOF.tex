...
\title{The empirical recurrence for OEIS A235236, proved by transfer matrix}
...
\begin{abstract}
OEIS A235236 carries an empirical recurrence of order $41$ contributed by R. H. Hardin. It is
...
OEIS A235236 is ``Number of (n+1) X (5+1) 0..6 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 6, with no adjacent elements equal (constant-stress tilted 1 X 1 tilings).''. It has offset $1$ and begins
\[
14944, 34916, 78824, 201676, 496520, 1355796, 3548456, 10155532,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 19 2022 00:00:35, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A235236.
