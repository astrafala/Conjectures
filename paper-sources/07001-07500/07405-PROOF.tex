...
\title{The empirical recurrence for OEIS A283636, proved by transfer matrix}
...
\begin{abstract}
OEIS A283636 counts $3\times n$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A283636 is ``Number of 3Xn 0..1 arrays with no 1 equal to more than one of its horizontal, diagonal and antidiagonal neighbors, with the exception of exactly two elements.''. It has offset $1$ and begins
\[
0, 6, 37, 639, 2875, 21963, 127635, 693783,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 12 2017 14:36:57, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) + 9\,a(n-2) - 43\,a(n-3) - 213\,a(n-4) + 69\,a(n-5) + 946\,a(n-6) + 1929\,a(n-7) + 1017\,a(n-8) + 2204\,a(n-9) + 1875\,a(n-10) + 2487\,a(n-11) - 2529\,a(n-12) + 5073\,a(n-13) - 3762\,a(n-14) + 2255\,a(n-15) - 798\,a(n-16) + 132\,a(n-17) - 8\,a(n-18)
\]
for every $n>18$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A283636.
