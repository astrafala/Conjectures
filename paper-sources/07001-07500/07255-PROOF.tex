...
\title{The empirical recurrence for OEIS A207905, proved by transfer matrix}
...
\begin{abstract}
OEIS A207905 counts arrays over $\{0,\dots,1\}$ of width $5$ that avoid the patterns
...
OEIS A207905 is ``Number of nX5 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 0 0 and 0 1 1 vertically.''. It has offset
$1$ and begins
\[
15, 225, 1071, 4089, 13865, 39831, 110775,\ \dots
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207905.
