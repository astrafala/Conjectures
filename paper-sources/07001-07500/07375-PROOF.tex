...
\title{The empirical recurrence for OEIS A278002, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A278002 counts arrays over $\{0,\dots,2\}$ in which every cell is constrained by the
values of its neighbours, and carries an empirical recurrence of order $38$ contributed
...
OEIS A278002 is ``Number of nX4 0..2 arrays with every element plus 1 mod 3 equal to some element at offset (-1,-1) (-1,0) (-1,1) (0,-1) (0,1) (1,-1) or (1,0), with upper left element zero.''. It has offset $1$ and begins
\[
0, 364, 16583, 912870, 49996267, 2732579072, 149393609720, 8167589147618,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 08 2016 08:35:09, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;54\,a(n-1) + 54\,a(n-2) - 35\,a(n-3) - 50267\,a(n-4) + 7689\,a(n-5) + 722984\,a(n-6) + 16611930\,a(n-7) - 38867650\,a(n-8) - 203665870\,a(n-9) - 2178159552\,a(n-10) + 10904189241\,a(n-11) + 9521500912\,a(n-12) + 96247621374\,a(n-13) - 832529921736\,a(n-14) + 783846391578\,a(n-15) - 638308123090\,a(n-16) + 4207165387192\,a(n-17) + 15167623043434\,a(n-18) - 3239085455407\,a(n-19) - 216159459266853\,a(n-20) + 456210881272341\,a(n-21) - 489766379354346\,a(n-22) + 846280537764428\,a(n-23) - 1750328153951862\,a(n-24) + 3241846743632086\,a(n-25) - 4497705996178152\,a(n-26) + 3727531103245940\,a(n-27) - 2373760416573904\,a(n-28) + 1902940444911280\,a(n-29) - 947424490114208\,a(n-30) - 71651096569408\,a(n-31) - 46956457506944\,a(n-32) + 303088835011584\,a(n-33) + 18719597554176\,a(n-34) - 43380542306304\,a(n-35) - 49931254480896\,a(n-36) + 10781387587584\,a(n-37) + 10151390085120\,a(n-38)
\end{equation}
for all $n>39$.
...
$3$ values, so there are about $10^{26}$ of them to sift. The
...
\begin{proof}
Substitute Lemma~\ref{lem:walk} and factor $G^{j-38}$ out of
...
the middle row. The vector $w$ was formed by $38$ applications of $G$ in exact integer
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A278002.
