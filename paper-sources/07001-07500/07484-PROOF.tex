...
\title{The empirical recurrence for OEIS A259520, proved by transfer matrix}
...
\begin{abstract}
OEIS A259520 counts arrays of width $5$ over $\{0,1\}$ subject to a condition read round the
...
count is a walk count on a finite digraph with $S=33$ vertices, and whether a linear
...
OEIS A259520 is ``Number of (n+1)X(4+1) 0..1 arrays with each 2X2 subblock having clockwise pattern 0000 0001 0011 0101 or 1111.''. It has offset $1$ and begins
\[
380, 6100, 93028, 1447270, 22453286, 348802846, 5417785744, 84159480298,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:52:44, revision 6) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The arrays have $5$ columns and a growing number of rows, with entries in $\{0,1\}$. A
...
\begin{theorem}
\[
a(n)\;=\;25\,a(n-1) - 152\,a(n-2) - 109\,a(n-3) + 3368\,a(n-4) - 6811\,a(n-5) - 12971\,a(n-6) + 49951\,a(n-7) - 9491\,a(n-8) - 92048\,a(n-9) + 49214\,a(n-10) + 74086\,a(n-11) - 38089\,a(n-12) - 32429\,a(n-13) + 8846\,a(n-14) + 6910\,a(n-15) - 139\,a(n-16) - 458\,a(n-17) - 58\,a(n-18) - 2\,a(n-19)
\]
for every $n>17$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A259520.
