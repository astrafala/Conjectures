...
\title{The empirical recurrence for OEIS A283412, proved by transfer matrix}
...
\begin{abstract}
OEIS A283412 counts $n\times5$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
walk, and $a(n)$ is a walk count on $S=944$ vertices, which is $C$-finite. Whether the
...
OEIS A283412 is ``Number of n X 5 0..1 arrays with no 1 equal to more than three of its horizontal, vertical and antidiagonal neighbors.''. It has offset $1$ and begins
\[
32, 912, 20744, 519252, 12806920, 315717408, 7790355688, 192182078748,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 31 2025 13:15:48, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;13\,a(n-1) + 228\,a(n-2) + 1321\,a(n-3) + 3587\,a(n-4) + 6648\,a(n-5) + 4808\,a(n-6) + 23696\,a(n-7) + 47315\,a(n-8) + 419628\,a(n-9) - 870309\,a(n-10) + 1567905\,a(n-11) - 601094\,a(n-12) - 2760190\,a(n-13) + 11844999\,a(n-14) - 23437302\,a(n-15) + 31055256\,a(n-16) - 40298061\,a(n-17) + 41215657\,a(n-18) - 37139862\,a(n-19) + 39606164\,a(n-20) - 38463655\,a(n-21) + 27093646\,a(n-22) - 14888649\,a(n-23) + 11716400\,a(n-24) - 10771719\,a(n-25) + 5771122\,a(n-26) - 1073393\,a(n-27) - 535654\,a(n-28) + 423321\,a(n-29) - 155939\,a(n-30) + 68452\,a(n-31) - 31796\,a(n-32) + 11014\,a(n-33) - 2628\,a(n-34) + 576\,a(n-35) - 225\,a(n-36) + 81\,a(n-37)
\]
for every $n>39$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A283412.
