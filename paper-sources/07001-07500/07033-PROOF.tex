...
\title{The empirical recurrence for OEIS A261263, proved by transfer matrix}
...
\begin{abstract}
OEIS A261263 counts $(n+2)\times8$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
every $3\times3$ subblock, and it carries an empirical recurrence of order $31$
...
OEIS A261263 is ``Number of (n+2)X(6+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00010101 00100101 or 01010101.''. It has offset $1$ and begins
\[
586, 758, 2948, 10382, 28540, 85506, 274100, 842884,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 13 2015 06:38:33, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 10\,a(n-3) + 17\,a(n-4) + 24\,a(n-5) + 32\,a(n-6) + 27\,a(n-7) + 9\,a(n-8) - 25\,a(n-9) - 42\,a(n-10) + 24\,a(n-11) + 115\,a(n-12) + 42\,a(n-13) - 51\,a(n-14) - 85\,a(n-15) - 105\,a(n-16) + 63\,a(n-17) + 187\,a(n-18) - 47\,a(n-19) - 169\,a(n-20) + 53\,a(n-21) + 83\,a(n-22) - 31\,a(n-23) - 7\,a(n-24) + 15\,a(n-25) - 19\,a(n-26) + 8\,a(n-28) - 5\,a(n-29) + 3\,a(n-30) - a(n-31)
\]
for every $n>36$.
\end{theorem}

\begin{proof}
The vector $w=q(M)\mathbf{1}$ was formed by $31$ matrix--vector products in exact
integer arithmetic and $\mathbf{1}^{\!\top}M^{j}w$ evaluated for $j=0,1,\dots$, again
exactly. Those integers vanish from the index corresponding to $n=36+1$ onwards, and the
run was continued until the working vector was identically zero, which settles all larger $j$
at once. By Lemma~\ref{lem:crit} the recurrence holds for every $n>36$.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A261263.
