...
\title{The empirical recurrence for OEIS A202642, proved by transfer matrix}
...
\begin{abstract}
OEIS A202642 counts arrays of width $5$ over $\{0,1\}$ containing no occurrence of certain short
...
OEIS A202642 is ``Number of (n+2)X5 binary arrays avoiding patterns 000 and 111 in rows, columns and nw-to-se diagonals.''. It has offset $1$ and begins
\[
462, 1766, 7432, 31560, 134338, 572940, 2443538, 10435120,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 09:46:21, revision 9) this is still
...
\text{along a row, left to right} & \mathtt{000},\quad \mathtt{111} \\
\text{down a column} & \mathtt{000},\quad \mathtt{111} \\
\text{down a diagonal, nw to se} & \mathtt{000},\quad \mathtt{111} \\
\end{array}
\]
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 15\,a(n-2) + 9\,a(n-3) - 118\,a(n-4) - 238\,a(n-5) + 472\,a(n-6) + 1447\,a(n-7) - 1075\,a(n-8) - 4741\,a(n-9) + 1560\,a(n-10) + 9731\,a(n-11) - 1462\,a(n-12) - 13452\,a(n-13) + 1230\,a(n-14) + 12863\,a(n-15) - 1868\,a(n-16) - 8177\,a(n-17) + 3206\,a(n-18) + 2964\,a(n-19) - 3943\,a(n-20) - 99\,a(n-21) + 3247\,a(n-22) - 480\,a(n-23) - 1779\,a(n-24) + 260\,a(n-25) + 634\,a(n-26) - 75\,a(n-27) - 141\,a(n-28) + 13\,a(n-29) + 18\,a(n-30) - a(n-31) - a(n-32)
\]
for every $n>33$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A202642.
