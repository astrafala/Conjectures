...
\title{The empirical recurrence for OEIS A304219, proved by transfer matrix}
...
\begin{abstract}
OEIS A304219 counts $6$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A304219 is ``Number of n X 6 0..1 arrays with every element unequal to 0, 1, 3 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
13, 49, 56, 108, 279, 740, 1628, 3759,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 04 2025 14:54:07, revision
6) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + a(n-2) + 5\,a(n-3) + 2\,a(n-4) - 3\,a(n-5) - 4\,a(n-6) - 3\,a(n-7) - 2\,a(n-8) + 3\,a(n-9) + 3\,a(n-10) - 3\,a(n-11) - a(n-12) + a(n-13) + a(n-14)
\end{equation}
for all $n>19$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A304219.
