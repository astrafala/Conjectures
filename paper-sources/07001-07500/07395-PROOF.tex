...
\title{The empirical recurrence for OEIS A237293, proved by transfer matrix}
...
\begin{abstract}
OEIS A237293 counts arrays over $\{0,\dots,3\}$ subject to a condition on the order
...
The condition is local to two consecutive rows, so the count is a walk count on $S=72$
...
OEIS A237293 is ``Number of (n+1)X(1+1) 0..3 arrays with the maximum plus the minimum minus the upper median minus the lower median of every 2X2 subblock equal.''. It has offset $1$ and begins
\[
256, 1128, 5360, 27376, 145488, 802992, 4552384, 26458368,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 10:01:40, revision 7) this is still
...
array, which is not among the objects counted. There are $S=72$ states left.
...
\begin{theorem}
\[
a(n)\;=\;18\,a(n-1) - 80\,a(n-2) - 356\,a(n-3) + 3712\,a(n-4) - 3672\,a(n-5) - 46200\,a(n-6) + 121376\,a(n-7) + 223024\,a(n-8) - 1056416\,a(n-9) - 188480\,a(n-10) + 4472000\,a(n-11) - 2103552\,a(n-12) - 10322304\,a(n-13) + 8097920\,a(n-14) + 13459968\,a(n-15) - 12348928\,a(n-16) - 9893888\,a(n-17) + 8663040\,a(n-18) + 3891200\,a(n-19) - 2293760\,a(n-20) - 655360\,a(n-21)
\]
for every $n>21$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237293.
