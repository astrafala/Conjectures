...
\title{The empirical recurrence for OEIS A251839, proved by transfer matrix}
...
\begin{abstract}
OEIS A251839 counts $(n+2)\times4$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A251839 is ``Number of (n+2) X (2+2) 0..3 arrays with every 3 X 3 subblock row and column sum nonprime and every diagonal and antidiagonal sum prime.''. It has offset $1$ and begins
\[
981, 508, 828, 1229, 2672, 5438, 9647, 22610,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 17*a(n-3) -90*a(n-6) +191*a(n-9) -205*a(n-12) +128*a(n-15) -48*a(n-18) +8*a(n-21) for n > 26.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 21 2021 14:23:53, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;17\,a(n-3) - 90\,a(n-6) + 191\,a(n-9) - 205\,a(n-12) + 128\,a(n-15) - 48\,a(n-18) + 8\,a(n-21)
\]
for every $n>26$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251839.
