...
\title{The empirical recurrence for OEIS A250635, proved by transfer matrix}
...
\begin{abstract}
OEIS A250635 counts arrays over $\{0,1,2\}$ in which a statistic taken over short runs
...
OEIS A250635 is ``Number of (3+1)X(n+1) 0..2 arrays with nondecreasing x(i,j)+x(i,j-1) in the i direction and nondecreasing min(x(i,j),x(i-1,j)) in the j direction.''. It has offset $1$ and begins
\[
380, 2347, 12151, 56232, 241742, 994030, 3951204, 15376595,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 12:37:49, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;13\,a(n-1) - 54\,a(n-2) - 4\,a(n-3) + 674\,a(n-4) - 1673\,a(n-5) - 904\,a(n-6) + 9791\,a(n-7) - 10723\,a(n-8) - 16532\,a(n-9) + 44343\,a(n-10) - 9985\,a(n-11) - 62272\,a(n-12) + 59755\,a(n-13) + 25323\,a(n-14) - 65551\,a(n-15) + 16714\,a(n-16) + 28793\,a(n-17) - 19289\,a(n-18) - 3357\,a(n-19) + 6590\,a(n-20) - 1131\,a(n-21) - 848\,a(n-22) + 336\,a(n-23) + 12\,a(n-24) - 23\,a(n-25) + 3\,a(n-26)
\]
for every $n>29$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250635.
