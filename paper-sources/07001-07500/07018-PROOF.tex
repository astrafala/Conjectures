...
\title{The empirical recurrence for OEIS A206571, proved by transfer matrix}
...
\begin{abstract}
OEIS A206571 counts arrays of width $2$ over $\{0,1,2,3\}$ containing no occurrence of certain short
patterns, read along the rows, the columns or the diagonals. The entry carries an empirical
recurrence of order $28$ contributed by R.~H.~Hardin. It is true, and it is decidable
...
OEIS A206571 is ``Number of nX2 0..3 arrays avoiding the pattern z-1 z-1 z in any row, column or nw-to-se diagonal.''. It has offset $1$ and begins
\[
16, 256, 3721, 53824, 777924, 11242609, 162486009, 2348371600,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 12:59:44, revision 9) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The array has $2$ cells across, with entries in $\{0,1,2,3\}$. An OCCURRENCE of a pattern in a
...
\begin{theorem}
\[
a(n)\;=\;16\,a(n-1) - 12\,a(n-2) - 166\,a(n-3) + 134\,a(n-4) + 1595\,a(n-5) - 1291\,a(n-6) - 11538\,a(n-7) + 9401\,a(n-8) + 344\,a(n-9) - 2098\,a(n-10) + 2832\,a(n-11) - 1207\,a(n-12) - 846\,a(n-13) + 548\,a(n-14) + 637\,a(n-15) - 488\,a(n-16) + 102\,a(n-17) - 13\,a(n-18) - 161\,a(n-19) + 85\,a(n-20) + 20\,a(n-21) - 14\,a(n-22) - 4\,a(n-23) + 6\,a(n-24) - 4\,a(n-25) + a(n-26) + 2\,a(n-27) - a(n-28)
\]
for every $n>27$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206571.
