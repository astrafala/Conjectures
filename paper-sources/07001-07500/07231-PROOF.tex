...
\title{The empirical recurrence for OEIS A253753, proved by transfer matrix}
...
\begin{abstract}
OEIS A253753 counts the arrays over $\{0,\dots,2\}$ whose $2\times2$ subblocks carry a
...
so a pair of consecutive array rows is a state, the count is a walk count on $S=28107$ of them,
...
OEIS A253753 is ``Number of (5+1)X(n+1) 0..2 arrays with every 2X2 subblock ne-sw antidiagonal difference nondecreasing horizontally and nw+se diagonal sum nondecreasing vertically.''. It has offset $1$ and begins
\[
28107, 305707, 1636717, 5195288, 10966149, 19685575, 33767784, 53908650,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 14:13:14, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The $2\times2$ subblocks of an $(n+1)\times6$ array over $\{0,\dots,2\}$ form a grid
...
\]
on the $S=28107$ admissible pairs. In particular $a$ is $C$-finite. The alignment of the walk
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) - 3\,a(n-2) + a(n-3) + 4\,a(n-4) - 12\,a(n-5) + 12\,a(n-6) - 4\,a(n-7) - 6\,a(n-8) + 18\,a(n-9) - 18\,a(n-10) + 6\,a(n-11) + 4\,a(n-12) - 12\,a(n-13) + 12\,a(n-14) - 4\,a(n-15) - a(n-16) + 3\,a(n-17) - 3\,a(n-18) + a(n-19)
\]
for every $n>28$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253753.
