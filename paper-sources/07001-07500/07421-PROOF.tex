...
\title{The empirical recurrence for OEIS A283575, proved by transfer matrix}
...
\begin{abstract}
OEIS A283575 counts $4\times n$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
walk, and $a(n)$ is a walk count on $S=280$ vertices, which is $C$-finite. Whether the
...
OEIS A283575 is ``Number of 4Xn 0..1 arrays with no 1 equal to more than one of its horizontal, diagonal and antidiagonal neighbors, with the exception of exactly one element.''. It has offset $1$ and begins
\[
0, 68, 1108, 6812, 67892, 509952, 3890056, 29428836,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 11 2017 08:20:14, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + 34\,a(n-2) + 48\,a(n-3) - 561\,a(n-4) - 2288\,a(n-5) - 5234\,a(n-6) - 5692\,a(n-7) - 8384\,a(n-8) + 4044\,a(n-9) - 3814\,a(n-10) + 27880\,a(n-11) - 6865\,a(n-12) + 31280\,a(n-13) - 24250\,a(n-14) + 14500\,a(n-15) - 21025\,a(n-16)
\]
for every $n>16$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A283575.
