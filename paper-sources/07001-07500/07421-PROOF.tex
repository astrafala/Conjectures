...
\title{The empirical recurrence for OEIS A317515, proved by transfer matrix}
...
\begin{abstract}
OEIS A317515 counts $6$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $different from$ itself lying in $\{0,1,2,3,4,5,6,7\}$, and it carries an empirical
recurrence of order $15$ contributed by R.~H.~Hardin. It is true. The neighbourhood
...
OEIS A317515 is ``Number of nX6 0..1 arrays with every element unequal to 0, 1, 2, 3, 4, 5, 6 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
32, 2048, 129042, 8130048, 512358002, 32289056648, 2034862700902, 128237436273216,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 30 2018 11:29:51, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;62\,a(n-1) - 37\,a(n-2) + 6238\,a(n-3) + 7205\,a(n-4) + 120122\,a(n-5) + 246565\,a(n-6) - 851302\,a(n-7) - 1660644\,a(n-8) + 1369696\,a(n-9) + 3047908\,a(n-10) - 212352\,a(n-11) - 1803988\,a(n-12) - 379248\,a(n-13) + 287184\,a(n-14) + 90720\,a(n-15)
\end{equation}
for all $n>15$.
...
$a(n)-\sum_i c_i a(n-i)=u_{\,n-2-15}$ whenever $n-15\ge2$. So \eqref{eq:conj}
holds for every $n>t$ exactly when $u_j=0$ for all $j>t-2-15$. Moreover $(u_j)$
...
\begin{proof}
Substituting Lemma~\ref{lem:walk} and factoring $P^{\,n-2-15}$ out of
...
\begin{theorem}
The recurrence \eqref{eq:conj} holds for every $n>15$. This is the statement of
Section~1.
\end{theorem}

\begin{proof}
The vector $q(P)\mathbf{e}\in\mathbb{Z}^{S}$ was formed by $15$ matrix--vector
products in exact integer arithmetic and the $u_j$ evaluated against $\mathbf{s}$ in turn.
They vanish from the index corresponding to $n=15+1$ onwards, and the run was continued
...
compared against the entry's DATA at every one of the $13$ published indices; they
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A317515.
