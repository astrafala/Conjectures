...
\title{The empirical recurrence for OEIS A255096, proved by transfer matrix}
...
\begin{abstract}
OEIS A255096 counts $(n+2)\times5$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A255096 is ``Number of (n+2)X(3+2) 0..1 arrays with no 3x3 subblock diagonal sum 1 and no antidiagonal sum 1 and no row sum 1 and no column sum 1.''. It has offset $1$ and begins
\[
179, 539, 1838, 6110, 20928, 72639, 250704, 868395,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:37:52, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) - 5\,a(n-2) + 18\,a(n-3) - 17\,a(n-4) - 5\,a(n-5) - 65\,a(n-6) - 76\,a(n-7) + 133\,a(n-8) + 215\,a(n-9) + 211\,a(n-10) - 318\,a(n-11) - 191\,a(n-12) - 34\,a(n-13) + 174\,a(n-14) + 288\,a(n-15) - 356\,a(n-16) - 568\,a(n-17) - 431\,a(n-18) + 165\,a(n-19) + 589\,a(n-20) + 542\,a(n-21) + 244\,a(n-22) + 7\,a(n-23) - 137\,a(n-24) - 138\,a(n-25) - 140\,a(n-26) - 72\,a(n-27) - 32\,a(n-28) - 4\,a(n-29)
\]
for every $n>31$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A255096.
