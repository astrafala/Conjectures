...
\title{The empirical recurrence for OEIS A250629, proved by transfer matrix}
...
\begin{abstract}
OEIS A250629 counts arrays over $\{0,1,2\}$ in which a statistic taken over short runs
...
OEIS A250629 is ``Number of (n+1)X(5+1) 0..2 arrays with nondecreasing x(i,j)+x(i,j-1) in the i direction and nondecreasing min(x(i,j),x(i-1,j)) in the j direction.''. It has offset $1$ and begins
\[
7924, 49310, 241742, 1014946, 3719562, 12291286, 37072806, 103697021,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 12:37:16, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250629.
