...
\title{The empirical recurrence for OEIS A237152, proved by transfer matrix}
...
\begin{abstract}
OEIS A237152 counts arrays over $\{0,\dots,3\}$ subject to a condition on the order
...
The condition is local to two consecutive rows, so the count is a walk count on $S=136$
...
OEIS A237152 is ``Number of (n+1)X(2+1) 0..3 arrays with the maximum plus the minimum of every 2X2 subblock equal.''. It has offset $1$ and begins
\[
1868, 37652, 762508, 16547988, 367558796, 8327731884, 190715003652, 4398267676604,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 09:53:58, revision 6) this is still
...
array, which is not among the objects counted. There are $S=136$ states left.
...
\begin{theorem}
\[
a(n)\;=\;55\,a(n-1) - 1035\,a(n-2) + 6857\,a(n-3) + 16166\,a(n-4) - 418194\,a(n-5) + 1564374\,a(n-6) + 1495550\,a(n-7) - 20565065\,a(n-8) + 35087663\,a(n-9) + 12182197\,a(n-10) - 64353607\,a(n-11) + 12508772\,a(n-12) + 36204908\,a(n-13) - 9872064\,a(n-14) - 5608640\,a(n-15) + 1752064\,a(n-16)
\]
for every $n>15$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237152.
