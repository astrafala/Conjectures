...
\title{The empirical recurrence for OEIS A184470, proved by transfer matrix}
...
\begin{abstract}
OEIS A184470 counts arrays of width $4$ over $\{0,1,2\}$ in which every $3\times3$ subblock
satisfies a condition on its nine entries. The entry carries an empirical recurrence of order
$26$ contributed by R.~H.~Hardin. It is true, and it is decidable rather than empirical: a
...
OEIS A184470 is ``1/6 the number of (n+2)X4 0..2 arrays with each 3X3 subblock containing one of one value, four of another, and four of the last.''. It has offset $1$ and begins
\[
1095, 2755, 7085, 19119, 62213, 200215, 645837, 2386807,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 02:40:27, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) - 6\,a(n-2) + 123\,a(n-3) - 615\,a(n-4) + 738\,a(n-5) - 5552\,a(n-6) + 27760\,a(n-7) - 33312\,a(n-8) + 122328\,a(n-9) - 611640\,a(n-10) + 733968\,a(n-11) - 1443600\,a(n-12) + 7218000\,a(n-13) - 8661600\,a(n-14) + 9366192\,a(n-15) - 46830960\,a(n-16) + 56197152\,a(n-17) - 32980608\,a(n-18) + 164903040\,a(n-19) - 197883648\,a(n-20) + 58413312\,a(n-21) - 292066560\,a(n-22) + 350479872\,a(n-23) - 40310784\,a(n-24) + 201553920\,a(n-25) - 241864704\,a(n-26)
\]
for every $n>26$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A184470.
