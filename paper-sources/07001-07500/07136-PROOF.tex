...
\title{The empirical recurrence for OEIS A298065, proved by transfer matrix}
...
\begin{abstract}
OEIS A298065 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $equal to$ itself lying in $\{2,3,4,6\}$, and it carries an empirical
...
OEIS A298065 is ``Number of nX3 0..1 arrays with every element equal to 2, 3, 4 or 6 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
0, 2, 4, 13, 63, 253, 953, 3802,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 11 2018 08:20:11, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) + a(n-3) - 2\,a(n-4) - 9\,a(n-5) - 43\,a(n-6) + 8\,a(n-7) + 97\,a(n-8) + 27\,a(n-9) - 91\,a(n-10) - 37\,a(n-11) + 15\,a(n-12) - 14\,a(n-13) + 18\,a(n-14) + 10\,a(n-15) - a(n-16) + 2\,a(n-17)
\end{equation}
for all $n>17$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A298065.
