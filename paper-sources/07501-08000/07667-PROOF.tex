...
\title{The empirical recurrence for OEIS A242471, proved by transfer matrix}
...
\begin{abstract}
OEIS A242471 carries an empirical recurrence of order $14$ contributed by R.~H.~Hardin. It is
...
OEIS A242471 is ``Number of length n+2 0..8 arrays with no three equal elements in a row and new values 0..8 introduced in 0..8 order.''. It has offset $1$ and begins
\[
4, 12, 41, 159, 685, 3233, 16534, 90862,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 11:16:46, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;29\,a(n-1) - 314\,a(n-2) + 1449\,a(n-3) - 1442\,a(n-4) - 8855\,a(n-5) + 16059\,a(n-6) + 34312\,a(n-7) - 42104\,a(n-8) - 101900\,a(n-9) - 6124\,a(n-10) + 112608\,a(n-11) + 106128\,a(n-12) + 40320\,a(n-13) + 5760\,a(n-14)
\]
for every $n>16$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A242471.
