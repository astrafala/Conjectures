...
\title{The empirical recurrence for OEIS A260136, proved by transfer matrix}
...
\begin{abstract}
OEIS A260136 counts $(n+2)\times8$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A260136 is ``Number of (n+2)X(6+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00010101 01010101 or 01010111.''. It has offset $1$ and begins
\[
944, 3928, 22522, 85048, 365308, 1799114, 7839850, 33893514,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 12:01:32, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A260136.
