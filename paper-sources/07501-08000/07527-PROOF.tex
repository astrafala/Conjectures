...
\title{The empirical recurrence for OEIS A252561, proved by transfer matrix}
...
\begin{abstract}
OEIS A252561 counts $5\times(n+2)$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252561 is ``Number of (3+2)X(n+2) 0..3 arrays with every 3X3 subblock row and diagonal sum equal to 1 2 4 6 or 7 and every 3X3 column and antidiagonal sum not equal to 1 2 4 6 or 7.''. It has offset $1$ and begins
\[
832, 1477, 4006, 8329, 29158, 88899, 189777, 680323,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:22:20, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;46\,a(n-3) - 572\,a(n-6) + 1298\,a(n-9) - 3089\,a(n-12) + 4222\,a(n-15) - 3472\,a(n-18) + 3104\,a(n-21) - 1536\,a(n-24)
\]
for every $n>31$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252561.
