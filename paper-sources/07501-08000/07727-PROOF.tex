...
\title{The empirical recurrence for OEIS A274898, proved by counting patterns}
...
\begin{abstract}
OEIS A274898 counts arrays in which no entry may repeat a value found at any of three stated
...
OEIS A274898 is ``Number of 6Xn 0..2 arrays with no element equal to any value at offset (0,-1) (-1,-1) or (-2,0) and new values introduced in order 0..2.''. It has offset $1$ and begins
\[
24, 50, 192, 753, 3017, 12217, 49697, 202749,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 10 2016 20:03:32, revision 4) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A274898.
