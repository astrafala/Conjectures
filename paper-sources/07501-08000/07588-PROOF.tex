...
\title{The empirical recurrence for OEIS A299736, proved by transfer matrix}
...
\begin{abstract}
OEIS A299736 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A299736 is ``Number of nX4 0..1 arrays with every element equal to 0, 1, 2, 3, 4, 5 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
8, 128, 1578, 21111, 280642, 3742524, 49914496, 665759775,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 18 2018 10:12:54, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;15\,a(n-1) - 16\,a(n-2) - 74\,a(n-3) - 143\,a(n-4) + 359\,a(n-5) + 1265\,a(n-6) - 1482\,a(n-7) - 3403\,a(n-8) + 1254\,a(n-9) + 9324\,a(n-10) + 1300\,a(n-11) - 12152\,a(n-12) - 9082\,a(n-13) + 5339\,a(n-14) + 10470\,a(n-15) + 1214\,a(n-16) - 3095\,a(n-17) - 2072\,a(n-18) + 764\,a(n-19) - 3\,a(n-20) - 161\,a(n-21) - 154\,a(n-22) + 112\,a(n-23) + 48\,a(n-24)
\end{equation}
for all $n>24$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A299736.
