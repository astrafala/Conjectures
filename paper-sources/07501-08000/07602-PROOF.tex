...
\title{The empirical recurrence for OEIS A269434, proved by transfer matrix}
...
\begin{abstract}
OEIS A269434 carries an empirical recurrence of order $16$ contributed by R.~H.~Hardin. It is
...
OEIS A269434 is ``Number of length-n 0..7 arrays with no repeated value greater than the previous repeated value.''. It has offset $1$ and begins
\[
8, 64, 512, 4068, 32152, 252932, 1981512, 15465934,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 27 2026 09:38:42, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;56\,a(n-1) - 1364\,a(n-2) + 18816\,a(n-3) - 159866\,a(n-4) + 846328\,a(n-5) - 2642416\,a(n-6) + 3954888\,a(n-7) - 157507\,a(n-8) - 3954888\,a(n-9) - 2642416\,a(n-10) - 846328\,a(n-11) - 159866\,a(n-12) - 18816\,a(n-13) - 1364\,a(n-14) - 56\,a(n-15) - a(n-16)
\]
for every $n>1$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269434.
