...
\title{The empirical recurrence for OEIS A197608, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A197608 counts arrays over $\{0,\dots,4\}$ in which every cell is constrained by the
...
OEIS A197608 is ``Number of nX3 0..4 arrays with each element x equal to the number its horizontal and vertical neighbors equal to 4,2,1,1,1 for x=0,1,2,3,4.''. It has offset $1$ and begins
\[
2, 14, 67, 366, 1840, 9361, 47610, 242254,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 07:20:27, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 6\,a(n-2) + 26\,a(n-3) + 53\,a(n-4) + 232\,a(n-5) + 501\,a(n-6) + 551\,a(n-7) - 245\,a(n-8) - 2023\,a(n-9) - 3810\,a(n-10) - 8322\,a(n-11) - 13685\,a(n-12) - 22140\,a(n-13) - 25568\,a(n-14) - 31943\,a(n-15) - 6603\,a(n-16) + 38551\,a(n-17) + 60843\,a(n-18) + 53444\,a(n-19) + 38044\,a(n-20) + 14221\,a(n-21) + 7417\,a(n-22) + 70469\,a(n-23) + 71386\,a(n-24) + 16860\,a(n-25) + 14396\,a(n-26) + 8246\,a(n-27) + 5868\,a(n-28) + 2756\,a(n-29) + 716\,a(n-30) + 240\,a(n-31) + 48\,a(n-32)
\end{equation}
for all $n>33$.
...
\#\{\text{neighbours with value }f(x_{t,u})\}=x_{t,u},\quad f=(4,2,1,1,1)
\end{equation}
for every cell $(t,u)$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A197608.
