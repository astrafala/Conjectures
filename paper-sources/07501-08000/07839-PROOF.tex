...
\title{The empirical recurrence for OEIS A283546, proved by transfer matrix}
...
\begin{abstract}
OEIS A283546 counts $5\times n$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
every CELL over a neighbour set the entry names, and it carries an empirical recurrence of
order $21$ contributed by R.~H.~Hardin. It is true, and it is decidable rather than
...
walk, and $a(n)$ is a walk count on $S=323$ vertices, which is $C$-finite. Whether the
...
OEIS A283546 is ``Number of 5Xn 0..1 arrays with no 1 equal to more than one of its horizontal, diagonal and antidiagonal neighbors.''. It has offset $1$ and begins
\[
32, 291, 2615, 29558, 282773, 2905717, 29377334, 295789859,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 10 2017 09:33:35, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + 42\,a(n-2) + 198\,a(n-3) - 64\,a(n-4) + 925\,a(n-5) - 1855\,a(n-6) + 7735\,a(n-7) - 27083\,a(n-8) + 45326\,a(n-9) - 73559\,a(n-10) + 51145\,a(n-11) + 19879\,a(n-12) + 10890\,a(n-13) + 32935\,a(n-14) - 24368\,a(n-15) + 328\,a(n-16) + 7803\,a(n-17) - 32113\,a(n-18) - 558\,a(n-19) + 29\,a(n-20) + 30\,a(n-21)
\]
for every $n>21$.
\end{theorem}
...
integers vanish from the index corresponding to $n=21+1$ onwards, and the run was
continued until the working vector was identically zero, which settles all larger $j$ at once.
By Lemma~\ref{lem:crit} the recurrence holds for every $n>21$.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A283546.
