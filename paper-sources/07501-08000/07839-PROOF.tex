...
\title{The empirical recurrence for OEIS A252009, proved by transfer matrix}
...
\begin{abstract}
OEIS A252009 counts arrays of width $4$ over $\{0,1,2,3\}$ in which every $3\times3$ window has
...
OEIS A252009 is ``Number of (n+2)X(2+2) 0..3 arrays with every 3X3 subblock row and column sum 1 3 6 or 8 and every diagonal and antidiagonal sum not 1 3 6 or 8.''. It has offset $1$ and begins
\[
1168, 1602, 1406, 2002, 3128, 4570, 6562, 10980,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 9*a(n-3) +a(n-5) -22*a(n-6) -9*a(n-8) +6*a(n-9) +23*a(n-11) +23*a(n-12) -15*a(n-14) -15*a(n-15) for n>22
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 10:41:48, revision 6) this is still
...
\text{each row} & \text{must be 1 or 3 or 6 or 8} \\
\text{each column} & \text{must be 1 or 3 or 6 or 8} \\
\text{the main diagonal} & \text{must NOT be 1 or 3 or 6 or 8} \\
\text{the antidiagonal} & \text{must NOT be 1 or 3 or 6 or 8} \\
\end{array}
\]
...
\begin{theorem}
\[
a(n)\;=\;9\,a(n-3) + a(n-5) - 22\,a(n-6) - 9\,a(n-8) + 6\,a(n-9) + 23\,a(n-11) + 23\,a(n-12) - 15\,a(n-14) - 15\,a(n-15)
\]
for every $n>22$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252009.
