...
\title{The empirical recurrence for OEIS A252609, proved by transfer matrix}
...
\begin{abstract}
OEIS A252609 counts $(n+2)\times4$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252609 is ``Number of (n+2)X(2+2) 0..3 arrays with every 3X3 subblock row and diagonal sum equal to 0 3 5 6 or 8 and every 3X3 column and antidiagonal sum not equal to 0 3 5 6 or 8.''. It has offset $1$ and begins
\[
1051, 1379, 2817, 5304, 14435, 37917, 75859, 213611,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:26:31, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;37\,a(n-3) - 445\,a(n-6) + 2151\,a(n-9) - 4973\,a(n-12) + 7261\,a(n-15) - 8366\,a(n-18) + 5776\,a(n-21) - 1440\,a(n-24)
\]
for every $n>33$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252609.
