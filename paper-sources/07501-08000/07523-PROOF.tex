...
\title{The empirical recurrence for OEIS A316547, proved by transfer matrix}
...
\begin{abstract}
OEIS A316547 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A316547 is ``Number of nX3 0..1 arrays with every element unequal to 0, 1, 3, 4, 7 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
3, 7, 10, 17, 36, 69, 129, 260,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 06 2018 12:31:59, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) - 4\,a(n-3) + 2\,a(n-4) - 3\,a(n-5) - 4\,a(n-7) - 5\,a(n-8) + 17\,a(n-9) + 9\,a(n-10) - a(n-11) - 3\,a(n-12) - 15\,a(n-13) + 4\,a(n-14) + 3\,a(n-15)
\end{equation}
for all $n>15$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A316547.
