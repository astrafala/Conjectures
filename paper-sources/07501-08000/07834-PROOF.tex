...
\title{The empirical recurrence for OEIS A253704, proved by transfer matrix}
...
\begin{abstract}
OEIS A253704 counts arrays of width $8$ over $\{0,1\}$ in which two diagonal numbers of every $2\times2$ subblock each differ from the same number at a neighbouring subblock. The entry carries an
...
OEIS A253704 is ``Number of (7+1)X(n+1) 0..1 arrays with every 2X2 subblock ne-sw antidiagonal difference unequal to its neighbors horizontally and nw+se diagonal sum unequal to its neighbors vertically.''. It has offset $1$ and begins
\[
4456, 2416, 2982, 3136, 4180, 5030, 6558, 8846,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 14:10:43, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-2) + a(n-5) - a(n-6) + 2\,a(n-7) + a(n-8) - 8\,a(n-9) - a(n-10) + 2\,a(n-11) + 5\,a(n-13) - 11\,a(n-15) + 6\,a(n-17) + 6\,a(n-19) - 8\,a(n-21) + a(n-23) + 4\,a(n-25)
\]
for every $n>37$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253704.
