...
\title{The empirical recurrence for OEIS A185463, proved by transfer matrix}
...
\begin{abstract}
OEIS A185463 counts arrays over $\{0,\dots,1\}$ under a condition on the determinant of every
$2\times2$ subblock, and carries an empirical recurrence of order $15$ contributed by
R.~H.~Hardin. It is true, and it is decidable rather than empirical. The condition is local to
a bounded window of consecutive rows, so the count is a walk count on $S=540$ states and is
...
OEIS A185463 is ``Number of (n+1) X 6 binary arrays with no 2 X 2 subblock determinant equal to any horizontal or vertical neighbor 2 X 2 subblock determinant.''. It has offset $1$ and begins
\[
540, 1646, 8762, 49670, 265724, 1388736, 7232746, 37562322,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 11 2024 00:05:28, revision 7) this is still
...
entry's first term is $540$, and the model reproduces it along with every later term; that
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + 6\,a(n-2) + 20\,a(n-3) + 24\,a(n-4) + 64\,a(n-5) + 107\,a(n-6) + 125\,a(n-7) + 88\,a(n-8) - 76\,a(n-9) + 63\,a(n-10) + 42\,a(n-11) + 4\,a(n-12) - 10\,a(n-13) - 6\,a(n-14) + 2\,a(n-15)
\]
for every $n>21$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A185463.
