...
\title{The empirical recurrence for OEIS A320368, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A320368 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A320368 is ``Number of nX5 0..1 arrays with every element unequal to 0, 1, 2, 3 or 4 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
16, 512, 11396, 245060, 5304988, 114844160, 2486026176, 53815748216,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 11 2018 14:10:10, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;32\,a(n-1) - 260\,a(n-2) + 855\,a(n-3) - 1752\,a(n-4) + 899\,a(n-5) + 11429\,a(n-6) - 29910\,a(n-7) + 39242\,a(n-8) - 69476\,a(n-9) - 200949\,a(n-10) + 247388\,a(n-11) - 579287\,a(n-12) + 468675\,a(n-13) + 1570257\,a(n-14) - 1702902\,a(n-15) - 82110\,a(n-16) + 1217792\,a(n-17) - 748544\,a(n-18) - 204624\,a(n-19) + 48992\,a(n-20) - 41128\,a(n-21) + 4960\,a(n-22) + 1360\,a(n-23) - 688\,a(n-24) + 64\,a(n-25)
\end{equation}
for all $n>26$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A320368.
