...
\title{The empirical recurrence for OEIS A303085, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A303085 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A303085 is ``Number of 3Xn 0..1 arrays with every element equal to 0, 2, 3, 4 or 6 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
4, 2, 32, 29, 258, 432, 2525, 6313,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 18 2018 12:21:48, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;7\,a(n-1) - 2\,a(n-2) - 67\,a(n-3) + 80\,a(n-4) + 187\,a(n-5) - 202\,a(n-6) - 298\,a(n-7) + 122\,a(n-8) + 213\,a(n-9) + 122\,a(n-10) + 126\,a(n-11) - 63\,a(n-12) - 416\,a(n-13) + 152\,a(n-14) + 20\,a(n-15) - 21\,a(n-16) + 9\,a(n-17)
\end{equation}
for all $n>18$.
...
\#\{\text{neighbours with a value }equal to\ x_{t,u}\}\in\{0,2,3,4,6\}
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A303085.
