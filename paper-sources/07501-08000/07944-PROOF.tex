...
\title{The empirical recurrence for OEIS A234485, proved by transfer matrix}
...
\begin{abstract}
OEIS A234485 counts $4$-column arrays over $\{0,\dots,3\}$ in which every
...
OEIS A234485 is ``Number of (n+1) X (3+1) 0..3 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 2 (constant-stress 1 X 1 tilings).''. It has offset
$1$ and begins
\[
944, 3540, 13260, 49784, 187196, 705072, 2659824,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 20 2022 19:10:44, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;13\,a(n-1) - 43\,a(n-2) - 107\,a(n-3) + 865\,a(n-4) - 1033\,a(n-5) - 1916\,a(n-6) + 2822\,a(n-7) + 2712\,a(n-8) - 1332\,a(n-9) - 1512\,a(n-10) - 288\,a(n-11)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234485.
