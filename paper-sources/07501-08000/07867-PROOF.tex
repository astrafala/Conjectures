...
\title{The empirical recurrence for OEIS A220623, proved by transfer matrix}
...
\begin{abstract}
OEIS A220623 counts the ways of linking the cells of a grid $4$ cells wide, each cell either to
...
state, the count is a walk count on $S=71$ of them, and the conjectured recurrence is then
...
OEIS A220623 is ``Number of ways to reciprocally link elements of an 4Xn array either to themselves or to exactly one horizontal, diagonal and antidiagonal neighbor.''. It has offset $1$ and begins
\[
1, 71, 765, 17084, 282777, 5280827, 93905509, 1703300073,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 18:55:02, revision 8) this is still
...
one configuration. With $M$ the adjacency matrix of the digraph on the $S=71$ reachable
...
\begin{theorem}
\[
a(n)\;=\;14\,a(n-1) + 98\,a(n-2) - 452\,a(n-3) - 102\,a(n-4) + 876\,a(n-5) - 144\,a(n-6) - 268\,a(n-7) + 22\,a(n-8) - 8\,a(n-9) + 15\,a(n-10)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A220623.
