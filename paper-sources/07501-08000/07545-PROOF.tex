...
\title{The empirical recurrence for OEIS A318072, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A318072 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
values of its neighbours, and carries an empirical recurrence of order $29$ contributed
...
OEIS A318072 is ``Number of nX5 0..1 arrays with every element unequal to 0, 1, 2 or 5 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
16, 42, 81, 149, 316, 854, 2195, 5752,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 15 2018 13:18:59, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) - 2\,a(n-2) + 8\,a(n-3) - 16\,a(n-4) + 16\,a(n-5) - 27\,a(n-6) + 15\,a(n-7) - 6\,a(n-8) + 4\,a(n-9) - 3\,a(n-10) + 29\,a(n-11) - 9\,a(n-12) + 17\,a(n-13) - 7\,a(n-14) - 11\,a(n-15) - 13\,a(n-16) - 7\,a(n-17) + 5\,a(n-18) - 7\,a(n-19) + a(n-20) + 11\,a(n-21) - 2\,a(n-22) + 2\,a(n-23) + 4\,a(n-24) - 4\,a(n-25) + 5\,a(n-26) - 5\,a(n-27) - a(n-28) + a(n-29)
\end{equation}
for all $n>33$.
...
\#\{\text{neighbours with a value }different from\ x_{t,u}\}\in\{0,1,2,5\}
\end{equation}
...
publishes, $n=26$, the arrays have $5\cdot26$ cells over
$2$ values, so there are about $10^{39}$ of them to sift. The
...
$o=1n_0+0-2$. Then for $j\ge29$,
\[
a(n_0+j)-\sum_i c_i\,a(n_0+j-i)\;=\;\,\mathbf{v}^{\!\top}G^{\,j-29}w,
...
\begin{proof}
Substitute Lemma~\ref{lem:walk} and factor $G^{j-29}$ out of
...
the middle row. The vector $w$ was formed by $29$ applications of $G$ in exact integer
arithmetic and $\mathbf{v}^{\!\top}G^{m}w$ evaluated for $m=0,1,\dots$, again exactly.
Every one of those integers vanishes from the index corresponding to $n=33+1$ onwards,
...
every one of the $26$ published indices, with no shift fitted: the number of rows is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A318072.
