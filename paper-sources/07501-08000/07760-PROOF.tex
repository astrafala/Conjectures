...
\title{The empirical recurrence for OEIS A231993, proved by transfer matrix}
...
\begin{abstract}
OEIS A231993 counts $(n+1)\times5$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A231993 is ``Number of (n+1)X(4+1) 0..1 arrays with no element having a strict majority of its horizontal and antidiagonal neighbors equal to one.''. It has offset $1$ and begins
\[
39, 406, 5778, 80511, 1129755, 15851094, 222394359, 3120433160,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 06:46:36, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;15\,a(n-1) + 10\,a(n-2) - 363\,a(n-3) + 300\,a(n-4) + 2289\,a(n-5) - 2814\,a(n-6) - 3711\,a(n-7) + 4416\,a(n-8) + 1713\,a(n-9) - 1638\,a(n-10) - 219\,a(n-11) + 181\,a(n-12) + 6\,a(n-13) - 4\,a(n-14)
\]
for every $n>14$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231993.
