...
\title{The empirical recurrence for OEIS A302955, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A302955 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A302955 is ``Number of 4Xn 0..1 arrays with every element equal to 1, 2, 3, 4 or 5 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
0, 34, 587, 6531, 87901, 1248691, 17374552, 240722070,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 16 2018 11:42:34, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;7\,a(n-1) + 64\,a(n-2) + 323\,a(n-3) + 1423\,a(n-4) + 2602\,a(n-5) - 1745\,a(n-6) - 17308\,a(n-7) - 49332\,a(n-8) - 76942\,a(n-9) - 37653\,a(n-10) + 24133\,a(n-11) + 51188\,a(n-12) + 90867\,a(n-13) + 48713\,a(n-14) - 32390\,a(n-15) - 35672\,a(n-16) - 23781\,a(n-17) + 15831\,a(n-18) + 22745\,a(n-19) - 4476\,a(n-20) - 2492\,a(n-21) - 8\,a(n-22) - 1296\,a(n-23) + 576\,a(n-24)
\end{equation}
for all $n>25$.
...
\#\{\text{neighbours with a value }equal to\ x_{t,u}\}\in\{1,2,3,4,5\}
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302955.
