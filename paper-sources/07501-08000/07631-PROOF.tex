...
\title{The empirical recurrence for OEIS A282858, proved by transfer matrix}
...
\begin{abstract}
OEIS A282858 counts $n\times4$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
walk, and $a(n)$ is a walk count on $S=102$ vertices, which is $C$-finite. Whether the
...
OEIS A282858 is ``Number of nX4 0..1 arrays with no 1 equal to more than one of its horizontal, vertical and antidiagonal neighbors.''. It has offset $1$ and begins
\[
13, 89, 583, 4163, 28537, 197892, 1369929, 9480913,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 23 2017 08:06:27, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 24\,a(n-2) + 86\,a(n-3) + 170\,a(n-4) + 283\,a(n-5) + 346\,a(n-6) + 277\,a(n-7) + 180\,a(n-8) + 108\,a(n-9) - 251\,a(n-10) + 433\,a(n-11) - 547\,a(n-12) + 330\,a(n-13) - 46\,a(n-14) - 68\,a(n-15) + 25\,a(n-16) - 14\,a(n-17) + 11\,a(n-18) - 3\,a(n-19) - 2\,a(n-20) + a(n-21)
\]
for every $n>21$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A282858.
