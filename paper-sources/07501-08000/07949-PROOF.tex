...
\title{The empirical recurrence for OEIS A188602, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A188602 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A188602 is ``Number of nX4 binary arrays without the pattern 1 1 0 diagonally, vertically, antidiagonally or horizontally.''. It has offset $1$ and begins
\[
12, 144, 847, 4914, 24711, 123984, 602049, 2925040,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 04:45:17, revision 12) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;7\,a(n-1) + a(n-2) - 75\,a(n-3) + 37\,a(n-4) + 308\,a(n-5) + 47\,a(n-6) - 950\,a(n-7) - 805\,a(n-8) + 2038\,a(n-9) + 2140\,a(n-10) - 1974\,a(n-11) - 2885\,a(n-12) - 655\,a(n-13) + 2291\,a(n-14) + 3147\,a(n-15) - 853\,a(n-16) - 2458\,a(n-17) - 195\,a(n-18) + 403\,a(n-19) + 268\,a(n-20) + 293\,a(n-21) + 4\,a(n-22) - 9\,a(n-23) - 71\,a(n-24) - 113\,a(n-25) + 24\,a(n-26) + 42\,a(n-27) - 2\,a(n-28) - 4\,a(n-29)
\end{equation}
for all $n>30$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A188602.
