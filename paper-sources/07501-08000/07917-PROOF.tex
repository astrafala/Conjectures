...
\title{The empirical recurrence for OEIS A248062, proved by transfer matrix}
...
\begin{abstract}
OEIS A248062 carries an empirical recurrence of order $13$ contributed by R.~H.~Hardin. It is
...
OEIS A248062 is ``Number of length n+5 0..2 arrays with some disjoint triples in each consecutive six terms having the same sum.''. It has offset $1$ and begins
\[
333, 513, 793, 1221, 1861, 2793, 4113, 6753,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + 20*a(n-6) - 20*a(n-7) - 64*a(n-12) + 64*a(n-13).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 08 2018 06:34:04, revision 10) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 20\,a(n-6) - 20\,a(n-7) - 64\,a(n-12) + 64\,a(n-13)
\]
for every $n>17$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A248062.
