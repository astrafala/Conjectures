...
\title{The empirical recurrence for OEIS A303097, proved by transfer matrix}
...
\begin{abstract}
OEIS A303097 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the six horizontal, diagonal and antidiagonal neighbours, a number $equal to$ itself lying in $\{1,2,3,4,6\}$, and it carries an empirical
...
OEIS A303097 is ``Number of n X 3 0..1 arrays with every element equal to 1, 2, 3, 4 or 6 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 15, 77, 486, 2869, 17229, 102952, 616065,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 5*a(n-1) +9*a(n-2) -14*a(n-3) -28*a(n-4) -6*a(n-5) +32*a(n-6) +10*a(n-7) -2*a(n-8) +32*a(n-9) -32*a(n-11).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 21 2022 23:43:50, revision
6) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) + 9\,a(n-2) - 14\,a(n-3) - 28\,a(n-4) - 6\,a(n-5) + 32\,a(n-6) + 10\,a(n-7) - 2\,a(n-8) + 32\,a(n-9) - 32\,a(n-11)
\end{equation}
for all $n>11$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A303097.
