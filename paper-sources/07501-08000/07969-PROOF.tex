...
\title{The empirical recurrence for OEIS A283516, proved by transfer matrix}
...
\begin{abstract}
OEIS A283516 counts $n\times2$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A283516 is ``Number of nX2 0..1 arrays with no 1 equal to more than three of its horizontal, vertical and antidiagonal neighbors, with the exception of exactly two elements.''. It has offset $1$ and begins
\[
0, 0, 1, 5, 28, 145, 703, 3288,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 09 2017 18:23:59, revision 5) this is still
...
\begin{theorem}
\[
a(n)\;=\;9\,a(n-1) - 18\,a(n-2) - 24\,a(n-3) + 39\,a(n-4) + 75\,a(n-5) + 69\,a(n-6) + 93\,a(n-7) + 99\,a(n-8) + 67\,a(n-9) + 45\,a(n-10) + 33\,a(n-11) + 16\,a(n-12) + 6\,a(n-13) + 3\,a(n-14) + a(n-15)
\]
for every $n>15$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A283516.
