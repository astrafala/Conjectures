...
\title{The empirical recurrence for OEIS A255759, proved by transfer matrix}
...
\begin{abstract}
OEIS A255759 counts the arrays over $\{0,\dots,1\}$ whose $3\times3$ subblocks carry a
...
so the count is a walk count on $S=11929$ states --- the last two array rows together with the
...
OEIS A255759 is ``Number of (4+2)X(n+2) 0..1 arrays with every 3X3 subblock sum of the medians of the diagonal and antidiagonal minus the two sums of the central row and column nondecreasing horizontally, vertically and ne-to-sw antidiagonally.''. It has offset $1$ and begins
\[
30182, 46367, 71651, 118925, 203503, 371616, 619142, 1072628,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 15:12:18, revision 6) this is still
...
\]
on the $S=11929$ reachable states. In particular $a$ is $C$-finite. The alignment of the walk
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) - 17\,a(n-2) + 33\,a(n-3) - 30\,a(n-4) - 61\,a(n-5) + 285\,a(n-6) - 618\,a(n-7) + 911\,a(n-8) - 784\,a(n-9) + 7\,a(n-10) + 1268\,a(n-11) - 2683\,a(n-12) + 3502\,a(n-13) - 3369\,a(n-14) + 2710\,a(n-15) - 1886\,a(n-16) + 1406\,a(n-17) - 1314\,a(n-18) + 891\,a(n-19) + 13\,a(n-20) - 1337\,a(n-21) + 2744\,a(n-22) - 3452\,a(n-23) + 3356\,a(n-24) - 2668\,a(n-25) + 1664\,a(n-26) - 832\,a(n-27) + 320\,a(n-28) - 64\,a(n-29)
\]
for every $n>53$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A255759.
