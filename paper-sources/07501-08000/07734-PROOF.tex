...
\title{The empirical recurrence for OEIS A283095, proved by transfer matrix}
...
\begin{abstract}
OEIS A283095 counts $n\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
walk, and $a(n)$ is a walk count on $S=145$ vertices, which is $C$-finite. Whether the
...
OEIS A283095 is ``Number of nX3 0..1 arrays with no 1 equal to more than one of its horizontal and vertical neighbors, with the exception of exactly two elements.''. It has offset $1$ and begins
\[
0, 6, 72, 600, 4607, 31669, 208949, 1324269,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 28 2017 10:58:06, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) + 18\,a(n-2) - 52\,a(n-3) - 381\,a(n-4) - 543\,a(n-5) + 1654\,a(n-6) + 8943\,a(n-7) + 19026\,a(n-8) + 20615\,a(n-9) + 3639\,a(n-10) - 22728\,a(n-11) - 33125\,a(n-12) - 16047\,a(n-13) + 8640\,a(n-14) + 16878\,a(n-15) + 9570\,a(n-16) + 336\,a(n-17) - 3439\,a(n-18) - 2340\,a(n-19) - 477\,a(n-20) + 210\,a(n-21) + 216\,a(n-22) + 51\,a(n-23) - 13\,a(n-24) - 6\,a(n-25) - 3\,a(n-26) + a(n-27)
\]
for every $n>27$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A283095.
