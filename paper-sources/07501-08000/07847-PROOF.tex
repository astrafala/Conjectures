...
\title{The empirical recurrence for OEIS A237011, proved by transfer matrix}
...
\begin{abstract}
OEIS A237011 counts arrays over $\{0,\dots,3\}$ subject to a condition on the order
...
The condition is local to two consecutive rows, so the count is a walk count on $S=3968$
...
OEIS A237011 is ``Number of (n+1)X(4+1) 0..3 arrays with the sum of all four elements of every 2X2 subblock equal.''. It has offset $1$ and begins
\[
5984, 10776, 20776, 46416, 108824, 282048, 755752, 2169408,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 09:45:45, revision 6) this is still
...
array, which is not among the objects counted. There are $S=3968$ states left.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237011.
