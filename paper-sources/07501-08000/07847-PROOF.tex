...
\title{The empirical recurrence for OEIS A302949, proved by transfer matrix}
...
\begin{abstract}
OEIS A302949 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A302949 is ``Number of nX4 0..1 arrays with every element equal to 1, 2, 3, 4 or 5 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
2, 46, 519, 6531, 80589, 998670, 12365841, 153141597,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 16 2018 11:38:28, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;9\,a(n-1) + 41\,a(n-2) + 29\,a(n-3) - 181\,a(n-4) - 466\,a(n-5) - 225\,a(n-6) + 66\,a(n-7) + 298\,a(n-8) - 52\,a(n-9) + 57\,a(n-10) - 10\,a(n-11) - 25\,a(n-12) + 4\,a(n-13)
\end{equation}
for all $n>13$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302949.
