...
\title{The empirical recurrence for OEIS A279899, proved by transfer matrix}
...
\begin{abstract}
OEIS A279899 counts $n\times5$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
every CELL over a neighbour set the entry names, and counted UP TO RELABELLING of the
alphabet; it carries an empirical recurrence of order $24$ contributed by
...
OEIS A279899 is ``Number of nX5 0..2 arrays with no element unequal to a strict majority of its king-move neighbors, with the exception of exactly one element, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
8, 18, 43, 156, 601, 2006, 7383, 25400,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 22 2016 12:52:24, revision 4) this is still
...
the condition
\[
\text{no cell is unequal to a strict majority of its king-move neighbours},
\]
...
$(r,s)\in(\{0,\dots,2\}^{5}\cup\{\varnothing\})\times\{0,\dots,2\}^{5}$ \times \{0,\dots,1\},
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + 16\,a(n-2) - 56\,a(n-3) - 146\,a(n-4) + 316\,a(n-5) + 814\,a(n-6) - 868\,a(n-7) - 2325\,a(n-8) + 1214\,a(n-9) + 2214\,a(n-10) - 1932\,a(n-11) + 3703\,a(n-12) + 4994\,a(n-13) - 12996\,a(n-14) - 3398\,a(n-15) + 12908\,a(n-16) - 8904\,a(n-17) + 2591\,a(n-18) + 12692\,a(n-19) - 11884\,a(n-20) - 3456\,a(n-21) + 4880\,a(n-22) + 192\,a(n-23) - 576\,a(n-24)
\]
for every $n>27$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A279899.
