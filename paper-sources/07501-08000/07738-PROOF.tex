...
\title{The empirical recurrence for OEIS A297393, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297393 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A297393 is ``Number of nX6 0..1 arrays with every 1 horizontally, diagonally or antidiagonally adjacent to 1 neighboring 1.''. It has offset $1$ and begins
\[
9, 69, 323, 2569, 14940, 99682, 640562, 4101278,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 29 2017 10:54:53, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 16\,a(n-2) + 55\,a(n-3) + 143\,a(n-4) + 377\,a(n-5) - 1022\,a(n-6) - 1350\,a(n-7) - 647\,a(n-8) - 3863\,a(n-9) - 4798\,a(n-10) - 4588\,a(n-11) + 36964\,a(n-12) + 21604\,a(n-13) + 14553\,a(n-14) + 107577\,a(n-15) + 51945\,a(n-16) - 52831\,a(n-17) - 345125\,a(n-18) - 312451\,a(n-19) - 218764\,a(n-20) - 24650\,a(n-21) + 55508\,a(n-22) + 98904\,a(n-23) + 3168\,a(n-24) - 16128\,a(n-25)
\end{equation}
for all $n>26$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297393.
