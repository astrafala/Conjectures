...
\title{The empirical recurrence for OEIS A298384, proved by transfer matrix}
...
\begin{abstract}
OEIS A298384 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $equal to$ itself lying in $\{1,2,3,5,6\}$, and it carries an empirical
...
OEIS A298384 is ``Number of nX3 0..1 arrays with every element equal to 1, 2, 3, 5 or 6 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 18, 56, 223, 849, 3387, 13075, 51006,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 18 2018 07:42:17, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) + 4\,a(n-3) - 17\,a(n-4) - 25\,a(n-5) + 23\,a(n-6) + 33\,a(n-7) + 41\,a(n-8) - 145\,a(n-9) - 147\,a(n-10) + 24\,a(n-11) + 384\,a(n-12) + 267\,a(n-13) - 72\,a(n-14) - 207\,a(n-15) - 61\,a(n-16) + 51\,a(n-17) + 10\,a(n-18) - 14\,a(n-19) - 4\,a(n-20)
\end{equation}
for all $n>21$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A298384.
