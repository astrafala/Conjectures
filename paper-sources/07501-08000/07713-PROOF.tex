...
\title{The empirical recurrence for OEIS A188769, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A188769 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A188769 is ``Number of nX4 binary arrays without the pattern 0 1 0 vertically or horizontally.''. It has offset $1$ and begins
\[
12, 144, 1103, 7868, 60215, 471349, 3658041, 28240356,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 04:50:24, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;9\,a(n-1) - 26\,a(n-2) + 120\,a(n-3) + 55\,a(n-4) - 207\,a(n-5) + 1143\,a(n-6) - 2223\,a(n-7) - 7821\,a(n-8) + 5631\,a(n-9) + 15011\,a(n-10) + 4093\,a(n-11) - 1011\,a(n-12) - 14644\,a(n-13) - 19696\,a(n-14) - 2087\,a(n-15) + 2890\,a(n-16) + 11655\,a(n-17) + 9364\,a(n-18) + 4150\,a(n-19) + 1661\,a(n-20) - 896\,a(n-21) - 501\,a(n-22) - 175\,a(n-23) - 82\,a(n-24) + 24\,a(n-25) + 12\,a(n-26)
\end{equation}
for all $n>27$.
...
Every one of those integers vanishes from the index corresponding to $n=27+1$ onwards,
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A188769.
