...
\title{The empirical recurrence for OEIS A279576, proved by transfer matrix}
...
\begin{abstract}
OEIS A279576 counts $n\times4$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
every CELL over a neighbour set the entry names, and counted UP TO RELABELLING of the
alphabet; it carries an empirical recurrence of order $16$ contributed by
...
OEIS A279576 is ``Number of nX4 0..2 arrays with no element equal to a strict majority of its horizontal and antidiagonal neighbors, with the exception of exactly one element, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
4, 304, 20776, 1356120, 86246944, 5385546376, 331573929104, 20185283466808,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 15 2016 10:57:31, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;130\,a(n-1) - 5401\,a(n-2) + 81048\,a(n-3) - 655576\,a(n-4) + 3394056\,a(n-5) - 12310816\,a(n-6) + 32887040\,a(n-7) - 66357008\,a(n-8) + 101980416\,a(n-9) - 118737920\,a(n-10) + 102678528\,a(n-11) - 63588352\,a(n-12) + 26722304\,a(n-13) - 7077888\,a(n-14) + 1048576\,a(n-15) - 65536\,a(n-16)
\]
for every $n>17$.
\end{theorem}
...
integers vanish from the index corresponding to $n=17+1$ onwards, and the run was
continued until the working vector was identically zero, which settles all larger $j$ at once.
By Lemma~\ref{lem:crit} the recurrence holds for every $n>17$.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A279576.
