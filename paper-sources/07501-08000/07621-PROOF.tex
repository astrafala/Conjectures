...
\title{The empirical recurrence for OEIS A231511, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A231511 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A231511 is ``Number of nX4 0..1 arrays with no element less than a strict majority of its horizontal, vertical, diagonal and antidiagonal neighbors.''. It has offset $1$ and begins
\[
7, 35, 343, 2594, 19435, 158061, 1275558, 10130742,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 06:32:56, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;7\,a(n-1) + a(n-2) + 66\,a(n-3) + 16\,a(n-4) - 688\,a(n-5) - 1519\,a(n-6) - 243\,a(n-7) + 3817\,a(n-8) + 9568\,a(n-9) + 11323\,a(n-10) - 4815\,a(n-11) - 11010\,a(n-12) + 5346\,a(n-13) - 9020\,a(n-14) + 3369\,a(n-15) - 43463\,a(n-16) - 80095\,a(n-17) + 156012\,a(n-18) - 141075\,a(n-19) - 90111\,a(n-20) + 92604\,a(n-21) - 71878\,a(n-22) - 10653\,a(n-23) - 42041\,a(n-24) + 104182\,a(n-25) + 1528\,a(n-26) + 9930\,a(n-27) + 17328\,a(n-28) + 4524\,a(n-29) - 2101\,a(n-30) - 330\,a(n-31) + 292\,a(n-32) - 104\,a(n-33) - 24\,a(n-34)
\end{equation}
for all $n>35$.
...
the middle row. The vector $w$ was formed by $34$ applications of $G$ in exact integer
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231511.
