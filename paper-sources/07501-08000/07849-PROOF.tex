...
\title{The empirical recurrence for OEIS A306055, proved by transfer matrix}
...
\begin{abstract}
OEIS A306055 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A306055 is ``Number of nX3 0..1 arrays with every element unequal to 0, 1, 2, 4, 6 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
4, 12, 27, 58, 189, 526, 1344, 3772,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 18 2018 07:47:33, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 2\,a(n-2) + 11\,a(n-3) + 3\,a(n-4) - 13\,a(n-5) - 46\,a(n-6) - 37\,a(n-7) + 8\,a(n-8) + 45\,a(n-9) + 39\,a(n-10) + 9\,a(n-11) - a(n-12) - 3\,a(n-13)
\end{equation}
for all $n>14$.
...
They vanish from the index corresponding to $n=14+1$ onwards, and the run was continued
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A306055.
