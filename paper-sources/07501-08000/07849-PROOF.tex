...
\title{Parities, differences and neighbours: OEIS A265924}
...
\begin{abstract}
OEIS A265924 carries an empirical recurrence of order $28$ contributed by R.~H.~Hardin. It is
...
walks in it. Hence $a(n)$ is a walk count on $S=231$ vertices and is $C$-finite, and whether the
...
OEIS A265924 is ``Number of nX4 0..4 arrays with the absolute differences of each element with its with horizontal and antidiagonal neighbors unique.''. It has offset $1$ and begins
\[
340, 9016, 72772, 542940, 4044156, 30029860, 225444912, 1691502456,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 18 2015 22:33:51, revision 4) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{The count is a walk count}

The entry counts arrays with $4$ columns over the alphabet $\{0,1,2,3,4\}$, growing one row at a time, and asks that the absolute differences between an element and each of its horizontal and antidiagonal neighbours must all be different from one another.
...
Merging vertices with identical futures leaves $S=231$. An admissible array is exactly a walk, so with $M$ the adjacency matrix and $\iota,\tau$ the vectors recording which states may begin and end an array,
\[
...
\begin{theorem}
\[
a(n)\;=\;16\,a(n-1) + 74\,a(n-2) - 2388\,a(n-3) + 3439\,a(n-4) + 135306\,a(n-5) - 522734\,a(n-6) - 3439014\,a(n-7) + 19923934\,a(n-8) + 36082640\,a(n-9) - 333465409\,a(n-10) - 59196434\,a(n-11) + 2436517719\,a(n-12) + 88992424\,a(n-13) - 9296733480\,a(n-14) - 4787400052\,a(n-15) + 15068783472\,a(n-16) + 20054756552\,a(n-17) + 3031868640\,a(n-18) - 14763124864\,a(n-19) - 19831398480\,a(n-20) - 12928318048\,a(n-21) - 3167850512\,a(n-22) + 1557170880\,a(n-23) + 1561396480\,a(n-24) + 555187200\,a(n-25) + 96018432\,a(n-26) + 6553600\,a(n-27) - 65536\,a(n-28)
\]
for every $n>32$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A265924.
