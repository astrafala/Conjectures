...
\title{The empirical recurrence for OEIS A252294, proved by transfer matrix}
...
\begin{abstract}
OEIS A252294 counts $(n+2)\times3$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252294 is ``Number of (n+2)X(1+2) 0..3 arrays with every 3X3 subblock row, column, diagonal and antidiagonal sum not equal to 0 2 3 6 or 7.''. It has offset $1$ and begins
\[
943, 856, 976, 1481, 2079, 3265, 5676, 10939,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:02:00, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + a(n-2) + 2\,a(n-3) - 3\,a(n-4) - 7\,a(n-5) - 3\,a(n-6) - 13\,a(n-7) + 10\,a(n-8) + 12\,a(n-9) + 20\,a(n-10) + 20\,a(n-11) + 18\,a(n-12) + 12\,a(n-13) - 58\,a(n-14) - 84\,a(n-15) - 26\,a(n-16) + 46\,a(n-17) + 62\,a(n-18) + 26\,a(n-19) - 28\,a(n-20) - 40\,a(n-21) - 16\,a(n-22) + 16\,a(n-23) + 24\,a(n-24) + 8\,a(n-25)
\]
for every $n>30$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252294.
