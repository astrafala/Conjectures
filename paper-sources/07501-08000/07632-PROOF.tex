...
\title{The empirical recurrence for OEIS A233961, proved by transfer matrix}
...
\begin{abstract}
OEIS A233961 counts $(n+1)\times3$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A233961 is ``Number of (n+1) X (2+1) 0..3 arrays with every 2 X 2 subblock having the sum of the absolute values of all six edge and diagonal differences equal to 10.''. It has offset $1$ and begins
\[
188, 864, 3976, 20564, 106056, 587472, 3219000, 18340844,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 07 2014 11:13:42, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;9\,a(n-1) + 6\,a(n-2) - 231\,a(n-3) + 402\,a(n-4) + 1164\,a(n-5) - 3026\,a(n-6) - 973\,a(n-7) + 5685\,a(n-8) - 1687\,a(n-9) - 2838\,a(n-10) + 1862\,a(n-11) - 188\,a(n-12) - 88\,a(n-13) + 16\,a(n-14)
\end{equation}
for all $n>14$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A233961.
