...
\title{The empirical recurrence for OEIS A235306, proved by transfer matrix}
...
\begin{abstract}
OEIS A235306 counts $5$-column arrays over $\{0,\dots,5\}$ in which every
...
OEIS A235306 is ``Number of (n+1) X (4+1) 0..5 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 6 (constant-stress 1 X 1 tilings).''. It has offset
$1$ and begins
\[
1554, 2918, 5042, 10790, 21090, 49574, 107186,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 20 2022 21:29:05, revision 9) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A235306.
