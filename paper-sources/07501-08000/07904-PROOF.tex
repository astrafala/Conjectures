...
\title{The empirical recurrence for OEIS A252365, proved by transfer matrix}
...
\begin{abstract}
OEIS A252365 counts $(n+2)\times6$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
$a(n)$ is a walk count on $S=26590$ vertices. Such a sequence is $C$-finite, so whether a given
...
OEIS A252365 is ``Number of (n+2)X(4+2) 0..3 arrays with every 3X3 subblock row, column, diagonal and antidiagonal sum not equal to 1 3 4 6 or 7.''. It has offset $1$ and begins
\[
658, 2338, 10450, 45516, 192946, 818040, 3482672, 14848406,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:08:40, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252365.
