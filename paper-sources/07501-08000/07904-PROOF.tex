...
\title{The empirical recurrence for OEIS A303891, proved by transfer matrix}
...
\begin{abstract}
OEIS A303891 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A303891 is ``Number of nX3 0..1 arrays with every element unequal to 1, 2, 3 or 4 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 23, 54, 271, 842, 3420, 11916, 45404,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 02 2018 08:01:31, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 10\,a(n-2) + 4\,a(n-3) - 13\,a(n-4) - 13\,a(n-5) + 8\,a(n-6) - 7\,a(n-7) - 13\,a(n-8) - 6\,a(n-9) - 4\,a(n-10) + a(n-11) - 5\,a(n-12) + 2\,a(n-13)
\end{equation}
for all $n>14$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A303891.
