...
\title{The empirical recurrence for OEIS A232062, proved by transfer matrix}
...
\begin{abstract}
OEIS A232062 counts arrays of width $5$ over $\{0,1,2\}$ in which every cell carrying one stated
...
OEIS A232062 is ``Number of nX5 0..2 arrays with every 0 next to a 1 and every 1 next to a 2 horizontally or vertically, with no adjacent values equal.''. It has offset $1$ and begins
\[
10, 66, 410, 2230, 13538, 75462, 457234, 2561258,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 06:51:07, revision 6) this is still
...
adjacency matrix,
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=1780.
\]
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 30\,a(n-2) - 47\,a(n-3) + 39\,a(n-4) - 191\,a(n-5) + 159\,a(n-6) - 134\,a(n-7) + 378\,a(n-8) - 242\,a(n-9) + 203\,a(n-10) - 439\,a(n-11) + 179\,a(n-12) - 147\,a(n-13) + 281\,a(n-14) - 62\,a(n-15) + 49\,a(n-16) - 87\,a(n-17) + 8\,a(n-18) - 6\,a(n-19) + 10\,a(n-20)
\]
for every $n>22$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232062.
