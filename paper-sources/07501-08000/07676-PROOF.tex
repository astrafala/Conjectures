...
\title{The empirical recurrence for OEIS A305688, proved by transfer matrix}
...
\begin{abstract}
OEIS A305688 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A305688 is ``Number of nX4 0..1 arrays with every element unequal to 1, 2, 3, 4, 5 or 6 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
2, 98, 1151, 16658, 236246, 3346848, 47448563, 672609073,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 08 2018 08:16:19, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;11\,a(n-1) + 37\,a(n-2) + 107\,a(n-3) + 97\,a(n-4) - 8\,a(n-5) - 452\,a(n-6) - 308\,a(n-7) - 112\,a(n-8) + 144\,a(n-9) - 160\,a(n-10) + 254\,a(n-11) + 129\,a(n-12) + 9\,a(n-13) + 22\,a(n-14) - 8\,a(n-15) + 12\,a(n-16) - 16\,a(n-17)
\end{equation}
for all $n>17$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A305688.
