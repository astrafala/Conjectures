...
\title{The empirical recurrence for OEIS A299063, proved by transfer matrix}
...
\begin{abstract}
OEIS A299063 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $equal to$ itself lying in $\{1,2,3,4,5,6\}$, and it carries an empirical
...
OEIS A299063 is ``Number of nX4 0..1 arrays with every element equal to 1, 2, 3, 4, 5 or 6 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
2, 64, 993, 13765, 196699, 2827609, 40585250, 582407760,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 01 2018 14:50:49, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;12\,a(n-1) + 26\,a(n-2) + 98\,a(n-3) + 216\,a(n-4) - 360\,a(n-5) - 405\,a(n-6) - 1419\,a(n-7) - 639\,a(n-8) + 4900\,a(n-9) + 2551\,a(n-10) - 4072\,a(n-11) - 2299\,a(n-12) - 1442\,a(n-13) + 1353\,a(n-14) + 2705\,a(n-15) - 1262\,a(n-16) - 1460\,a(n-17) + 621\,a(n-18) + 18\,a(n-19) + 55\,a(n-20) - 12\,a(n-21) - 4\,a(n-22)
\end{equation}
for all $n>23$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A299063.
