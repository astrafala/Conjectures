...
\title{The empirical recurrence for OEIS A297313, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297313 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A297313 is ``Number of nX7 0..1 arrays with every 1 horizontally or antidiagonally adjacent to 1 or 2 neighboring 1s.''. It has offset $1$ and begins
\[
37, 2049, 72541, 2997197, 121339476, 4893232934, 197589351469, 7976248015498,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 28 2017 07:26:55, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;13\,a(n-1) + 964\,a(n-2) + 7855\,a(n-3) - 73030\,a(n-4) - 695613\,a(n-5) + 4192801\,a(n-6) + 21033448\,a(n-7) - 189025018\,a(n-8) + 184530457\,a(n-9) + 2066786840\,a(n-10) - 6682871967\,a(n-11) - 2708665119\,a(n-12) + 45304491886\,a(n-13) - 54509700621\,a(n-14) - 95719215815\,a(n-15) + 223090781321\,a(n-16) + 84502966487\,a(n-17) - 410238492043\,a(n-18) - 12548934436\,a(n-19) + 443801529456\,a(n-20) - 51099076433\,a(n-21) - 300831504736\,a(n-22) + 77062707971\,a(n-23) + 143343109349\,a(n-24) - 51338858358\,a(n-25) - 50336809366\,a(n-26) + 15557513886\,a(n-27) + 10486046289\,a(n-28) - 2094967974\,a(n-29) - 921214165\,a(n-30) + 89836481\,a(n-31) + 14593572\,a(n-32) + 487976\,a(n-33) - 95199\,a(n-34) - 3510\,a(n-35)
\end{equation}
for all $n>39$.
...
publishes, $n=14$, the arrays have $7\cdot14$ cells over
$2$ values, so there are about $10^{29}$ of them to sift. The
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297313.
