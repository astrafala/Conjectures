...
\title{The empirical recurrence for OEIS A253702, proved by transfer matrix}
...
\begin{abstract}
OEIS A253702 counts arrays of width $6$ over $\{0,1\}$ in which two diagonal numbers of every $2\times2$ subblock each differ from the same number at a neighbouring subblock. The entry carries an
...
OEIS A253702 is ``Number of (5+1)X(n+1) 0..1 arrays with every 2X2 subblock ne-sw antidiagonal difference unequal to its neighbors horizontally and nw+se diagonal sum unequal to its neighbors vertically.''. It has offset $1$ and begins
\[
680, 602, 878, 1120, 1632, 1914, 2626, 3598,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 14:10:36, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;-a(n-1) + a(n-2) + a(n-3) + 2\,a(n-4) + 3\,a(n-5) + 2\,a(n-7) + 3\,a(n-8) - 6\,a(n-9) - 5\,a(n-10) - 4\,a(n-11) - 6\,a(n-12) + 6\,a(n-13) + 6\,a(n-14) - 5\,a(n-15) - 5\,a(n-16) - 8\,a(n-17) - 6\,a(n-18) + 6\,a(n-19) + 6\,a(n-20) + 5\,a(n-21) + 3\,a(n-22) - a(n-23) + a(n-24) + a(n-25) + a(n-26) + a(n-27)
\]
for every $n>34$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253702.
