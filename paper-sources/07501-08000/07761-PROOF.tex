...
\title{The empirical recurrence for OEIS A203059, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A203059 counts arrays over $\{0,\dots,6\}$ in which every cell is constrained by the
...
OEIS A203059 is ``Number of nX1 0..6 arrays with every nonzero element less than or equal to some horizontal or vertical neighbor.''. It has offset $1$ and begins
\[
1, 7, 49, 252, 1127, 4977, 22736, 105813,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 10:05:37, revision 9) the statement is
...
publishes, $n=22$, the arrays have $1\cdot22$ cells over
$7$ values, so there are about $10^{18}$ of them to sift. The
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A203059.
