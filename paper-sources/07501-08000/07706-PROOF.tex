...
\title{The empirical recurrence for OEIS A207690, proved by transfer matrix}
...
\begin{abstract}
OEIS A207690 counts arrays over $\{0,\dots,1\}$ of width $5$ that avoid the patterns
...
OEIS A207690 is ``Number of nX5 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 0 1 and 1 1 1 vertically.''. It has offset
$1$ and begins
\[
15, 225, 240, 768, 1872, 4216, 10000,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:10:08, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-2) + 12\,a(n-3) + 2\,a(n-4) + 12\,a(n-5) - 56\,a(n-6) + 12\,a(n-7) - 42\,a(n-8) + 143\,a(n-9) - 13\,a(n-10) + 33\,a(n-11) - 192\,a(n-12) - 6\,a(n-13) + 43\,a(n-14) + 175\,a(n-15) + 11\,a(n-16) - 57\,a(n-17) - 102\,a(n-18) + 5\,a(n-19) + 10\,a(n-20) + 39\,a(n-21) + 2\,a(n-23) - 9\,a(n-24) + a(n-27)
\end{equation}
for all $n>29$. 
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207690.
