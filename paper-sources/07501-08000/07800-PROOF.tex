...
\title{The empirical recurrence for OEIS A317769, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A317769 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A317769 is ``Number of nX4 0..1 arrays with every element unequal to 0, 1 or 3 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
5, 7, 11, 10, 14, 23, 32, 55,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +2*a(n-4) +6*a(n-7) -a(n-8) -a(n-9) -a(n-10) -7*a(n-11) -7*a(n-12) +2*a(n-13) -a(n-14) for n>23
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 06 2018 12:11:30, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 2\,a(n-4) + 6\,a(n-7) - a(n-8) - a(n-9) - a(n-10) - 7\,a(n-11) - 7\,a(n-12) + 2\,a(n-13) - a(n-14)
\end{equation}
for all $n>23$.
...
publishes, $n=37$, the arrays have $4\cdot37$ cells over
...
the middle row. The vector $w$ was formed by $14$ applications of $G$ in exact integer
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A317769.
