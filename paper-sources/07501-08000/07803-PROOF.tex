...
\title{The empirical recurrence for OEIS A234660, proved by transfer matrix}
...
\begin{abstract}
OEIS A234660 counts $3$-column arrays over $\{0,\dots,6\}$ in which every
...
OEIS A234660 is ``Number of (n+1) X (2+1) 0..6 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 4 (constant-stress 1 X 1 tilings).''. It has offset
$1$ and begins
\[
1820, 9774, 52646, 286668, 1566596, 8659270, 48048220,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 20 2022 18:24:22, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;24\,a(n-1) - 116\,a(n-2) - 1573\,a(n-3) + 17655\,a(n-4) - 7512\,a(n-5) - 599532\,a(n-6) + 2201681\,a(n-7) + 4899218\,a(n-8) - 40315144\,a(n-9) + 38576320\,a(n-10) + 130316460\,a(n-11) - 132305400\,a(n-12) - 263116800\,a(n-13) + 8496000\,a(n-14) + 134568000\,a(n-15) + 45360000\,a(n-16)
\end{equation}
for all $n>15$, which is every $n$ at which a recurrence of order $16$ can be
stated.
...
$j=0,1,\dots$. They vanish from $j=15-16+1$ onwards, and the run was continued past
$S$ consecutive zeros, which by Lemma~\ref{lem:crit} settles every larger $j$. Hence the
recurrence holds for every $n>15$.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234660.
