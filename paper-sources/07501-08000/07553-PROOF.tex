...
\title{The empirical recurrence for OEIS A304145, proved by transfer matrix}
...
\begin{abstract}
OEIS A304145 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A304145 is ``Number of nX4 0..1 arrays with every element unequal to 1, 2, 3 or 6 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
2, 33, 25, 61, 157, 117, 244, 936,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 07 2018 08:52:51, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A304145.
