...
\title{The empirical recurrence for OEIS A260604, proved by transfer matrix}
...
\begin{abstract}
OEIS A260604 counts $(n+2)\times5$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A260604 is ``Number of (n+2)X(3+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000101 00010001 or 00010101.''. It has offset $1$ and begins
\[
125, 250, 610, 1334, 3343, 7516, 19069, 42696,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 12:09:38, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-2) + 14\,a(n-4) + 9\,a(n-6) - 25\,a(n-8) + 136\,a(n-10) - 65\,a(n-12) - 59\,a(n-14) + 111\,a(n-16) - 55\,a(n-18) + 22\,a(n-20) - 32\,a(n-22) + 18\,a(n-24)
\]
for every $n>29$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A260604.
