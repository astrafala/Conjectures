...
\title{The empirical recurrence for OEIS A305092, proved by transfer matrix}
...
\begin{abstract}
OEIS A305092 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A305092 is ``Number of nX3 0..1 arrays with every element unequal to 1, 2, 4, 6 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 9, 14, 17, 64, 158, 229, 630,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 25 2018 08:25:38, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-2) + 11\,a(n-3) + 7\,a(n-4) - 16\,a(n-5) - 46\,a(n-6) - 31\,a(n-7) + 27\,a(n-8) + 64\,a(n-9) + 38\,a(n-10) - 20\,a(n-11) - 25\,a(n-12) - 6\,a(n-13) + 7\,a(n-14) + a(n-15) - 2\,a(n-16)
\end{equation}
for all $n>17$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A305092.
