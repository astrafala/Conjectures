...
\title{The empirical recurrence for OEIS A296316, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A296316 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A296316 is ``Number of n X 4 0..1 arrays with each 1 horizontally, vertically or antidiagonally adjacent to 1 neighboring 1.''. It has offset $1$ and begins
\[
4, 27, 96, 434, 1970, 8470, 37431, 164807,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 04 2022 11:27:43, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 6\,a(n-2) + 29\,a(n-3) + 30\,a(n-4) + 61\,a(n-5) + 9\,a(n-6) + 73\,a(n-7) - 93\,a(n-8) + 134\,a(n-9) - 201\,a(n-10) + 173\,a(n-11) - 179\,a(n-12) + 107\,a(n-13) - a(n-14) - 30\,a(n-15) - 15\,a(n-16) + 22\,a(n-17) - 3\,a(n-18) - 2\,a(n-19) - a(n-20) + a(n-21)
\end{equation}
for all $n>22$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A296316.
