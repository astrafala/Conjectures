...
\title{The empirical recurrence for OEIS A250634, proved by transfer matrix}
...
\begin{abstract}
OEIS A250634 counts arrays over $\{0,1,2\}$ in which a statistic taken over short runs
...
OEIS A250634 is ``Number of (2+1)X(n+1) 0..2 arrays with nondecreasing x(i,j)+x(i,j-1) in the i direction and nondecreasing min(x(i,j),x(i-1,j)) in the j direction.''. It has offset $1$ and begins
\[
125, 654, 2969, 12360, 49310, 190213, 720347, 2690076,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 12:37:43, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;9\,a(n-1) - 21\,a(n-2) - 32\,a(n-3) + 195\,a(n-4) - 160\,a(n-5) - 371\,a(n-6) + 679\,a(n-7) + 5\,a(n-8) - 716\,a(n-9) + 413\,a(n-10) + 152\,a(n-11) - 200\,a(n-12) + 48\,a(n-13)
\]
for every $n>16$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250634.
