...
\title{The empirical recurrence for OEIS A223252, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A223252 counts arrays over $\{0,\dots,4\}$ in which every cell is constrained by the
...
OEIS A223252 is ``Two-loop graph coloring a rectangular array: number of nX5 0..4 arrays where 0..4 label nodes of a graph with edges 0,1 1,2 2,0 0,3 3,4 4,0 and every array movement to a horizontal or vertical neighbor moves along an edge of this graph.''. It has offset $1$ and begins
\[
208, 4908, 166892, 5359892, 200258884, 6581646956, 247417877452, 8146965446276,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 21:25:12, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;7\,a(n-1) + 1287\,a(n-2) - 8754\,a(n-3) - 66498\,a(n-4) + 293943\,a(n-5) + 1110271\,a(n-6) - 2420678\,a(n-7) - 6380827\,a(n-8) + 7393360\,a(n-9) + 14420088\,a(n-10) - 8685630\,a(n-11) - 12202500\,a(n-12) + 3405276\,a(n-13) + 3205824\,a(n-14) - 279936\,a(n-15) - 165888\,a(n-16)
\end{equation}
for all $n>16$.
...
and $5$ cells in a row, so $|V|=5^{5}=3125$, and the vertex set is
$V\times V$, of size $3125^2=3125$. That is the whole of the state: two consecutive
...
publishes, $n=14$, the arrays have $5\cdot14$ cells over
$5$ values, so there are about $10^{48}$ of them to sift. The
walk count replaces that by $3125$ states and one matrix--vector product per row.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223252.
