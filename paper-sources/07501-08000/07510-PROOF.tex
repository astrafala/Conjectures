...
\title{The empirical recurrence for OEIS A252346, proved by transfer matrix}
...
\begin{abstract}
OEIS A252346 counts $(n+2)\times4$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252346 is ``Number of (n+2)X(2+2) 0..3 arrays with every 3X3 subblock row and column sum not equal to 0 3 5 6 or 8 and every 3X3 diagonal and antidiagonal sum equal to 0 3 5 6 or 8.''. It has offset $1$ and begins
\[
798, 1386, 2864, 5641, 12419, 29159, 66229, 155733,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:07:39, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) - 2\,a(n-2) + 40\,a(n-3) - 120\,a(n-4) + 80\,a(n-5) - 553\,a(n-6) + 1660\,a(n-7) - 1109\,a(n-8) + 3348\,a(n-9) - 10061\,a(n-10) + 6761\,a(n-11) - 9224\,a(n-12) + 27713\,a(n-13) - 18893\,a(n-14) + 7460\,a(n-15) - 21856\,a(n-16) + 15854\,a(n-17) + 17389\,a(n-18) - 55122\,a(n-19) + 35943\,a(n-20) - 46716\,a(n-21) + 143613\,a(n-22) - 98997\,a(n-23) + 44289\,a(n-24) - 127098\,a(n-25) + 90801\,a(n-26) - 20484\,a(n-27) + 47232\,a(n-28) - 34722\,a(n-29) + 4716\,a(n-30) - 6048\,a(n-31) + 4536\,a(n-32) - 432\,a(n-33)
\]
for every $n>36$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252346.
