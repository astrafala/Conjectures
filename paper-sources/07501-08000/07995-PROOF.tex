...
\title{The empirical recurrence for OEIS A301822, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A301822 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
values of its neighbours, and carries an empirical recurrence of order $26$ contributed
...
OEIS A301822 is ``Number of nX7 0..1 arrays with every element equal to 1 or 2 horizontally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
8, 128, 968, 6653, 47363, 333335, 2341241, 16471479,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 27 2018 10:13:04, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;30\,a(n-1) - 418\,a(n-2) + 3654\,a(n-3) - 22669\,a(n-4) + 106606\,a(n-5) - 395403\,a(n-6) + 1186422\,a(n-7) - 2928707\,a(n-8) + 6014938\,a(n-9) - 10354804\,a(n-10) + 15013356\,a(n-11) - 18384098\,a(n-12) + 19034892\,a(n-13) - 16660310\,a(n-14) + 12301356\,a(n-15) - 7624215\,a(n-16) + 3923202\,a(n-17) - 1635354\,a(n-18) + 519982\,a(n-19) - 103769\,a(n-20) - 2026\,a(n-21) + 11017\,a(n-22) - 4610\,a(n-23) + 1059\,a(n-24) - 138\,a(n-25) + 8\,a(n-26)
\end{equation}
for all $n>28$.
...
\#\{\text{neighbours with a value }equal to\ x_{t,u}\}\in\{1,2\}
\end{equation}
...
publishes, $n=19$, the arrays have $7\cdot19$ cells over
$2$ values, so there are about $10^{40}$ of them to sift. The
...
\begin{proof}
Substitute Lemma~\ref{lem:walk} and factor $G^{j-26}$ out of
...
the middle row. The vector $w$ was formed by $26$ applications of $G$ in exact integer
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A301822.
