...
\title{The empirical recurrence for OEIS A252069, proved by transfer matrix}
...
\begin{abstract}
OEIS A252069 counts $(n+2)\times4$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A252069 is ``Number of (n+2) X (2+2) 0..2 arrays with every 3 X 3 subblock row, column, diagonal and antidiagonal sum not equal to 0 3 or 4.''. It has offset $1$ and begins
\[
105, 152, 419, 1135, 3029, 8352, 23091, 63460,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + a(n-2) + 4*a(n-3) - a(n-4) - 4*a(n-5) - 3*a(n-6) + a(n-8) + a(n-9) for n>11.
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 20 2018 06:51:42, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + a(n-2) + 4\,a(n-3) - a(n-4) - 4\,a(n-5) - 3\,a(n-6) + a(n-8) + a(n-9)
\]
for every $n>11$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252069.
