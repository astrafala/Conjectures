...
\title{The empirical recurrence for OEIS A231971, proved by transfer matrix}
...
\begin{abstract}
OEIS A231971 counts $(n+1)\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A231971 is ``Number of (n+1) X (2+1) 0..1 arrays with no element having a strict majority of its horizontal and vertical neighbors equal to one.''. It has offset $1$ and begins
\[
16, 56, 169, 550, 1764, 5680, 18225, 58596,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) + 2*a(n-3) + 4*a(n-4) - 10*a(n-5) - 2*a(n-6) - a(n-8) + a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 01 2018 21:09:50, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + 2\,a(n-3) + 4\,a(n-4) - 10\,a(n-5) - 2\,a(n-6) - a(n-8) + a(n-9)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231971.
