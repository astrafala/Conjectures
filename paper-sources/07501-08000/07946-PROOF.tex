...
\title{The empirical recurrence for OEIS A185527, proved by transfer matrix}
...
\begin{abstract}
OEIS A185527 counts $(n+2)\times4$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A185527 is ``Number of (n+2)X4 binary arrays with each 3X3 subblock nonsingular.''. It has offset $1$ and begins
\[
726, 4362, 25854, 150234, 886926, 5221098, 30631134, 180225834,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 03:04:41, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + 8\,a(n-2) + 77\,a(n-3) - 79\,a(n-4) - 180\,a(n-5) - 1228\,a(n-6) + 48\,a(n-7) + 232\,a(n-8) + 4208\,a(n-9) - 1184\,a(n-10) - 1664\,a(n-11) - 6144\,a(n-12)
\]
for every $n>12$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A185527.
