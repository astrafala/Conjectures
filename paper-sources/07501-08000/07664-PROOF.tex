...
\title{The empirical recurrence for OEIS A202974, proved by transfer matrix}
...
\begin{abstract}
OEIS A202974 counts $n\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A202974 is ``Number of n X 3 0..1 arrays with every nonzero element less than or equal to at least two horizontal and vertical neighbors.''. It has offset $1$ and begins
\[
1, 4, 17, 58, 215, 866, 3507, 14120,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 6*a(n-1) - 11*a(n-2) + 16*a(n-3) - 14*a(n-4) - 3*a(n-5) + 8*a(n-6) - 9*a(n-7) - 2*a(n-8) + 6*a(n-9) + 2*a(n-10).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 04 2018 04:29:27, revision 12) this is still
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) - 11\,a(n-2) + 16\,a(n-3) - 14\,a(n-4) - 3\,a(n-5) + 8\,a(n-6) - 9\,a(n-7) - 2\,a(n-8) + 6\,a(n-9) + 2\,a(n-10)
\]
for every $n>10$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A202974.
