...
\title{The empirical recurrence for OEIS A204600, proved by transfer matrix}
...
\begin{abstract}
OEIS A204600 counts $(n+2)\times3$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
$a(n)$ is a walk count on $S=729$ vertices. Such a sequence is $C$-finite, so whether a given
...
OEIS A204600 is ``Number of (n+2)X3 0..2 arrays with every 3X3 subblock having three strictly increasing elements in a row horizontally, vertically or nw-to-se diagonally exactly one way.''. It has offset $1$ and begins
\[
3562, 29678, 328845, 2275645, 16247580, 153711850, 1240455298, 9111381604,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 11:20:25, revision 9) this is still
...
$\{0,\dots,2\}^{3}$. A $3\times3$ subblock occupies three consecutive rows and
...
\[
\text{exactly }1\text{ of the horizontally, vertically or nw-to-se diagonally lines of }g\text{ \text{is strictly increasing}}
\]
...
$S=(2+1)^{2\cdot3}=729$, and put an edge $(r,s)\to(s,t)$ exactly when the condition
...
\begin{theorem}
\[
a(n)\;=\;307\,a(n-3) + 1269\,a(n-4) + 3014\,a(n-5) + 3034\,a(n-6) + 25372\,a(n-7) + 79370\,a(n-8) + 86184\,a(n-9) - 18348\,a(n-10) + 325463\,a(n-11) + 986531\,a(n-12) - 990300\,a(n-13) - 1055430\,a(n-14) + 897607\,a(n-15) - 320293\,a(n-16) - 227770\,a(n-17) + 280127\,a(n-18) + 510823\,a(n-19) + 29680\,a(n-20) - 200892\,a(n-21) - 53919\,a(n-22) + 324\,a(n-23) + 5832\,a(n-24)
\]
for every $n>24$.
\end{theorem}
...
exactly. Those integers vanish from the index corresponding to $n=24+1$ onwards, and the
run was continued until the working vector was identically zero, which settles all larger $j$
at once. By Lemma~\ref{lem:crit} the recurrence holds for every $n>24$.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204600.
