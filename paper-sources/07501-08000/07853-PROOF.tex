...
\title{The empirical recurrence for OEIS A207854, proved by transfer matrix}
...
\begin{abstract}
OEIS A207854 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
...
OEIS A207854 is ``Number of nX4 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 1 0 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
9, 81, 289, 1369, 5929, 26569, 117649,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 4*a(n-1) +a(n-2) +18*a(n-4) +4*a(n-5) -2*a(n-6) -8*a(n-7) -a(n-8) +a(n-10)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:21:41, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) + a(n-2) + 18\,a(n-4) + 4\,a(n-5) - 2\,a(n-6) - 8\,a(n-7) - a(n-8) + a(n-10)
\end{equation}
for all $n>10$. 
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207854.
