...
\title{The empirical recurrence for OEIS A298898, proved by transfer matrix}
...
\begin{abstract}
OEIS A298898 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A298898 is ``Number of nX4 0..1 arrays with every element equal to 3, 4, 5, 6 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
0, 2, 2, 4, 10, 24, 56, 142,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 28 2018 09:18:36, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 5\,a(n-2) + 4\,a(n-3) - 6\,a(n-4) - 18\,a(n-5) - 16\,a(n-6) - 12\,a(n-7) - 3\,a(n-8) + 9\,a(n-9) + 22\,a(n-10) + 19\,a(n-11) + 14\,a(n-12) + 3\,a(n-13) - a(n-14) - 2\,a(n-15) - 2\,a(n-16)
\end{equation}
for all $n>16$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A298898.
