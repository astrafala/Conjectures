...
\title{The empirical recurrence for OEIS A283341, proved by transfer matrix}
...
\begin{abstract}
OEIS A283341 counts $n\times2$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
walk, and $a(n)$ is a walk count on $S=34$ vertices, which is $C$-finite. Whether the
...
OEIS A283341 is ``Number of nX2 0..1 arrays with no 1 equal to more than two of its horizontal, vertical and antidiagonal neighbors, with the exception of exactly one element.''. It has offset $1$ and begins
\[
0, 0, 6, 26, 120, 524, 2174, 8816,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 05 2017 10:19:36, revision 5) this is still
...
$(r,s)\in(\{0,\dots,1\}^{2}\cup\{\varnothing\})\times\{0,\dots,1\}^{2} \times \{0,\dots,1\}$,
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) - 7\,a(n-2) - 23\,a(n-4) + 8\,a(n-5) - 15\,a(n-6) + 24\,a(n-7) - 14\,a(n-8) + 20\,a(n-9) - 13\,a(n-10) + 14\,a(n-11) - 10\,a(n-12) + 6\,a(n-13) - 5\,a(n-14) + 2\,a(n-15) - a(n-16)
\]
for every $n>16$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A283341.
