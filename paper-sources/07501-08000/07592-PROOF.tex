...
\title{The empirical recurrence for OEIS A305228, proved by transfer matrix}
...
\begin{abstract}
OEIS A305228 counts $6$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A305228 is ``Number of nX6 0..1 arrays with every element unequal to 0, 1, 2, 3 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
32, 293, 236, 541, 2050, 7062, 26528, 96528,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 27 2018 17:44:12, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) + a(n-2) - 26\,a(n-3) + 5\,a(n-4) + 45\,a(n-5) + 11\,a(n-6) - 33\,a(n-7) - 49\,a(n-8) + 14\,a(n-9) + 29\,a(n-10) + 2\,a(n-11) + 21\,a(n-12) - 20\,a(n-13) - 21\,a(n-14) + 17\,a(n-15) + 4\,a(n-16) - 4\,a(n-17)
\end{equation}
for all $n>22$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A305228.
