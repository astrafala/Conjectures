...
\title{An element and the cells around it: OEIS A183548}
...
\begin{abstract}
OEIS A183548 carries an empirical recurrence of order $32$ contributed by R.~H.~Hardin. It is
...
OEIS A183548 is ``Number of nX3 0..2 arrays with each element equal to either the maximum or the minimum of its horizontal and vertical neighbors.''. It has offset $1$ and begins
\[
3, 71, 583, 5287, 46841, 417809, 3721925, 33169105,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 01:52:57, revision 9) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{The count is a walk count}

The entry counts arrays with $3$ columns over the alphabet $\{0,1,2\}$, growing one row at a time, and asks that every element must equal either the largest or the smallest of its horizontal and vertical neighbours.
...
Merging vertices with identical futures leaves $S=46$. An admissible array is exactly a walk, so with $M$ the adjacency matrix and $\iota,\tau$ the vectors recording which states may begin and end an array,
\[
...
\begin{theorem}
\[
a(n)\;=\;12\,a(n-1) - 26\,a(n-2) - 33\,a(n-3) + 204\,a(n-4) - 244\,a(n-5) - 339\,a(n-6) + 256\,a(n-7) + 1324\,a(n-8) - 559\,a(n-9) - 4420\,a(n-10) + 5965\,a(n-11) + 8096\,a(n-12) - 10724\,a(n-13) - 1370\,a(n-14) + 5054\,a(n-15) - 15721\,a(n-16) + 9505\,a(n-17) - 7190\,a(n-18) - 20835\,a(n-19) + 2723\,a(n-20) + 1324\,a(n-21) + 2340\,a(n-22) + 2496\,a(n-23) - 1996\,a(n-24) - 452\,a(n-25) + 2222\,a(n-26) + 273\,a(n-27) - 941\,a(n-28) + 334\,a(n-29) - 61\,a(n-30) - 44\,a(n-31) + 12\,a(n-32)
\]
for every $n>32$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A183548.
