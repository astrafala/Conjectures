...
\title{The empirical recurrence for OEIS A234818, proved by transfer matrix}
...
\begin{abstract}
OEIS A234818 counts $4$-column arrays over $\{0,\dots,6\}$ in which every
...
OEIS A234818 is ``Number of (n+1) X (3+1) 0..6 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 6 (constant-stress 1 X 1 tilings).''. It has offset
$1$ and begins
\[
2380, 6282, 15224, 47136, 131704, 443220, 1352816,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 20 2022 18:50:07, revision 6) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234818.
