...
\title{The empirical recurrence for OEIS A237456, proved by transfer matrix}
...
\begin{abstract}
OEIS A237456 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
OEIS A237456 is ``Number of (n+1) X (1+1) 0..2 arrays with the maximum plus the lower median of every 2 X 2 subblock differing from its horizontal and vertical neighbors by exactly one.''. It has offset $1$ and begins
\[
81, 308, 1144, 4272, 16280, 61152, 231680, 869120,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 136*a(n-4) + 832*a(n-6) + 1600*a(n-8) + 1024*a(n-10).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 22 2018 14:29:05, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;136\,a(n-4) + 832\,a(n-6) + 1600\,a(n-8) + 1024\,a(n-10)
\]
for every $n>10$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237456.
