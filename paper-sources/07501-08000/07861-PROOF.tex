...
\title{The empirical recurrence for OEIS A237060, proved by transfer matrix}
...
\begin{abstract}
OEIS A237060 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
OEIS A237060 is ``Number of (n+1)X(1+1) 0..2 arrays with the maximum plus the upper median plus the minimum minus the lower median of every 2X2 subblock equal.''. It has offset $1$ and begins
\[
81, 255, 826, 2823, 9815, 34996, 125469, 457125,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 09:47:00, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) + 20\,a(n-2) - 121\,a(n-3) - 85\,a(n-4) + 876\,a(n-5) + 42\,a(n-6) - 2664\,a(n-7) + 168\,a(n-8) + 3696\,a(n-9) - 144\,a(n-10) - 2176\,a(n-11) + 384\,a(n-13)
\]
for every $n>12$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237060.
