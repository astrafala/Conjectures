...
\title{The empirical recurrence for OEIS A252026, proved by transfer matrix}
...
\begin{abstract}
OEIS A252026 counts $(n+2)\times4$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A252026 is ``Number of (n+2)X(2+2) 0..2 arrays with every 3X3 subblock row, column, diagonal and antidiagonal sum not equal to 0 2 or 4.''. It has offset $1$ and begins
\[
227, 323, 781, 1929, 5285, 14831, 41745, 117867,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 10:42:43, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252026.
