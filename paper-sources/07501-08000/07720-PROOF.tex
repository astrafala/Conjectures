...
\title{The empirical recurrence for OEIS A250688, proved by transfer matrix}
...
\begin{abstract}
OEIS A250688 counts arrays over $\{0,1,2,3\}$ in which a statistic taken over short runs
...
OEIS A250688 is ``Number of (n+1)X(5+1) 0..3 arrays with nondecreasing x(i,j)-x(i,j-1) in the i direction and nondecreasing absolute value of x(i,j)-x(i-1,j) in the j direction.''. It has offset $1$ and begins
\[
47002, 249512, 1315446, 6671458, 31728758, 143136866, 617657415, 2571646112,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 12:41:43, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250688.
