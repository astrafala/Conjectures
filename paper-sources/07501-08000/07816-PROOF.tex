...
\title{The empirical recurrence for OEIS A236029, proved by transfer matrix}
...
\begin{abstract}
OEIS A236029 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
The condition is local to two consecutive rows, so the count is a walk count on $S=384$
...
OEIS A236029 is ``Number of (n+1) X (2+1) 0..2 arrays colored with the difference of the upper median and the lower median in each 2 X 2 subblock.''. It has offset $1$ and begins
\[
384, 2460, 14980, 93640, 595416, 3752292, 23516900, 147865936,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 11 2022 13:19:34, revision 6) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The $2\times2$ subblocks of an $(n+1)\times3$ array form an
$n\times2$ grid. Colour each of them by $\sigma=-b+c$, where $a\le b\le c\le d$ are its four entries sorted --- its minimum, lower median, upper median and maximum. ``Coloured with'' is the entry's way of
...
\]
over the $S=384$ pairs whose own subblock row is properly coloured.
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-2) + 82\,a(n-3) + 490\,a(n-4) + 1217\,a(n-5) + 2163\,a(n-6) + 914\,a(n-7) - 9130\,a(n-8) - 22593\,a(n-9) - 22916\,a(n-10) + 10688\,a(n-11) + 64870\,a(n-12) + 38436\,a(n-13) - 42508\,a(n-14) - 30622\,a(n-15) + 4270\,a(n-16) + 9712\,a(n-17) + 528\,a(n-18) - 1536\,a(n-19)
\]
for every $n>19$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A236029.
