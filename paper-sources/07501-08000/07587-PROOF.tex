...
\title{The empirical recurrence for OEIS A253363, proved by transfer matrix}
...
\begin{abstract}
OEIS A253363 counts arrays of width $6$ over $\{0,1\}$ in which the largest entry on the main diagonal minus the smallest on the antidiagonal of every $2\times2$ and $3\times3$ subblock differs from the same number at the neighbouring subblock. The entry carries an
...
$4$ consecutive rows and the count is a walk count on $S=1608$ states.
\end{abstract}
...
OEIS A253363 is ``Number of (n+2)X(4+2) 0..1 arrays with every 2X2 and 3X3 subblock diagonal maximum minus antidiagonal minimum unequal to its neighbors horizontally and vertically.''. It has offset $1$ and begins
\[
976, 1536, 5280, 8904, 23936, 53128, 112864, 286888,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 9*a(n-2) -32*a(n-4) +60*a(n-6) +4*a(n-8) +16*a(n-10) -32*a(n-12) +16*a(n-14) for n>16
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:59:53, revision 6) this is still
...
Thus
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=1608,
\]
...
\begin{theorem}
\[
a(n)\;=\;9\,a(n-2) - 32\,a(n-4) + 60\,a(n-6) + 4\,a(n-8) + 16\,a(n-10) - 32\,a(n-12) + 16\,a(n-14)
\]
for every $n>16$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253363.
