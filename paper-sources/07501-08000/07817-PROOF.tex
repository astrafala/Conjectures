...
\title{The empirical recurrence for OEIS A209653, proved by transfer matrix}
...
\begin{abstract}
OEIS A209653 counts arrays over $\{0,\dots,1\}$ of width $6$ that avoid the patterns
...
OEIS A209653 is ``Number of 6Xn 0..1 arrays avoiding 0 0 1 and 1 0 0 horizontally and 0 0 1 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
12, 144, 636, 2079, 8904, 34012, 145775,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 15:24:23, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;13\,a(n-1) - 15\,a(n-2) - 453\,a(n-3) + 1521\,a(n-4) + 6613\,a(n-5) - 32909\,a(n-6) - 51675\,a(n-7) + 380097\,a(n-8) + 219811\,a(n-9) - 2799167\,a(n-10) - 347187\,a(n-11) + 14122641\,a(n-12) - 1318649\,a(n-13) - 50390909\,a(n-14) + 9520521\,a(n-15) + 128386635\,a(n-16) - 28476569\,a(n-17) - 232248311\,a(n-18) + 53023599\,a(n-19) + 292800435\,a(n-20) - 67701287\,a(n-21) - 248742653\,a(n-22) + 60344055\,a(n-23) + 134128372\,a(n-24) - 35691432\,a(n-25) - 40789736\,a(n-26) + 12200640\,a(n-27) + 5184000\,a(n-28) - 1728000\,a(n-29)
\end{equation}
for all $n>30$. The entry's array has a fixed number of rows and a growing number of
...
index corresponding to $n=30+1$ onwards, and the run was continued past $S$ consecutive
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209653.
