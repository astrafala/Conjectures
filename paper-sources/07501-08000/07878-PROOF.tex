...
\title{The empirical recurrence for OEIS A303243, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A303243 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A303243 is ``Number of 3 X n 0..1 arrays with every element equal to 0, 2, 3, 5 or 6 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
4, 2, 18, 8, 60, 56, 236, 428,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 02 2025 21:47:54, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 9\,a(n-2) - 28\,a(n-3) - 37\,a(n-4) + 117\,a(n-5) + 85\,a(n-6) - 280\,a(n-7) - 118\,a(n-8) + 424\,a(n-9) + 92\,a(n-10) - 428\,a(n-11) - 26\,a(n-12) + 300\,a(n-13) + 12\,a(n-14) - 172\,a(n-15) + 48\,a(n-16) + 24\,a(n-17) - 48\,a(n-18) + 8\,a(n-20)
\end{equation}
for all $n>21$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A303243.
