...
\title{The empirical recurrence for OEIS A234163, proved by transfer matrix}
...
\begin{abstract}
OEIS A234163 counts $3$-column arrays over $\{0,\dots,4\}$ in which every
...
OEIS A234163 is ``Number of (n+1) X (2+1) 0..4 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 2 (constant-stress 1 X 1 tilings).''. It has offset
$1$ and begins
\[
766, 4970, 32070, 208412, 1353986, 8846884, 57811490,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 19 2022 01:44:02, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;17\,a(n-1) + 16\,a(n-2) - 1651\,a(n-3) + 5750\,a(n-4) + 45373\,a(n-5) - 252572\,a(n-6) - 278797\,a(n-7) + 2737923\,a(n-8) + 518738\,a(n-9) - 11300724\,a(n-10) + 169584\,a(n-11) + 18786600\,a(n-12) - 2246544\,a(n-13) - 13289184\,a(n-14) + 2960064\,a(n-15) + 3359232\,a(n-16) - 1119744\,a(n-17)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234163.
