...
\title{The empirical recurrence for OEIS A202975, proved by transfer matrix}
...
\begin{abstract}
OEIS A202975 counts $n\times4$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
walk, and $a(n)$ is a walk count on $S=133$ vertices, which is $C$-finite. Whether the
...
OEIS A202975 is ``Number of nX4 0..1 arrays with every nonzero element less than or equal to at least two horizontal and vertical neighbors.''. It has offset $1$ and begins
\[
1, 7, 58, 385, 2582, 17740, 122468, 846908,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 10:00:34, revision 9) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A202975.
