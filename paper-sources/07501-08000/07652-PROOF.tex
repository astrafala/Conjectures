...
\title{The empirical recurrence for OEIS A187722, proved by transfer matrix}
...
\begin{abstract}
OEIS A187722 counts the $(n+1)\times3$ arrays over $\{0,\dots,1\}$ in which
neighbouring $2\times2$ subblocks do not commute as matrices, and carries an empirical recurrence
of order $27$ contributed by R.~H.~Hardin. It is true, and it is decidable rather than
empirical. The condition ties together $2+1$ consecutive rows, so $2$ consecutive rows are
a state, the count is a walk count on $S=43$ of them, and the conjectured recurrence is then
...
OEIS A187722 is ``Number of (n+1)X3 binary arrays with no 2X2 subblock commuting with any of its horizontal and vertical 2X2 subblock neighbors.''. It has offset $1$ and begins
\[
43, 174, 689, 2804, 11324, 46003, 186672, 758077,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 04:07:39, revision 9) this is still
...
$43$, which the model reproduces along with every later term.
...
\]
on the $S=43$ admissible $2$-tuples. In particular $a$ is $C$-finite.
...
\begin{theorem}
\[
a(n)\;=\;9\,a(n-2) + 31\,a(n-3) + 24\,a(n-4) - 60\,a(n-5) - 167\,a(n-6) - 146\,a(n-7) + 80\,a(n-8) + 321\,a(n-9) + 368\,a(n-10) + 29\,a(n-11) - 621\,a(n-12) - 250\,a(n-13) + 210\,a(n-14) + 167\,a(n-15) + 275\,a(n-16) - 76\,a(n-17) - 88\,a(n-18) - 54\,a(n-19) - 41\,a(n-20) - 16\,a(n-21) + 21\,a(n-22) + 14\,a(n-23) - 5\,a(n-24) + a(n-25) + 2\,a(n-26) - a(n-27)
\]
for every $n>28$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A187722.
