...
\title{The empirical recurrence for OEIS A260834, proved by transfer matrix}
...
\begin{abstract}
OEIS A260834 counts $(n+2)\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A260834 is ``Number of (n+2)X(1+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000001 00000011 or 00010101.''. It has offset $1$ and begins
\[
48, 82, 188, 364, 644, 1320, 2584, 4842,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-3) +3*a(n-4) +4*a(n-5) +12*a(n-8) +12*a(n-9) -8*a(n-11) -12*a(n-12) -12*a(n-13) -8*a(n-14) for n>15
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 12:11:21, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-3) + 3\,a(n-4) + 4\,a(n-5) + 12\,a(n-8) + 12\,a(n-9) - 8\,a(n-11) - 12\,a(n-12) - 12\,a(n-13) - 8\,a(n-14)
\]
for every $n>15$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A260834.
