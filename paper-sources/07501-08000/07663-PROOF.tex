...
\title{The empirical recurrence for OEIS A189061, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A189061 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A189061 is ``Number of nX6 binary arrays without the pattern 0 1 0 antidiagonally or horizontally.''. It has offset $1$ and begins
\[
37, 1369, 33893, 795741, 19468046, 477128662, 11711612310, 287687887135,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 05:00:19, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;37\,a(n-1) - 284\,a(n-2) - 1134\,a(n-3) + 14360\,a(n-4) + 36737\,a(n-5) - 643348\,a(n-6) + 2085746\,a(n-7) - 2368868\,a(n-8) + 807969\,a(n-9) - 4053547\,a(n-10) + 13028432\,a(n-11) - 14665678\,a(n-12) + 6463282\,a(n-13) - 256476\,a(n-14) - 534719\,a(n-15) + 81847\,a(n-16) + 10344\,a(n-17) - 1936\,a(n-18)
\end{equation}
for all $n>19$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A189061.
