...
\title{The empirical recurrence for OEIS A232318, proved by transfer matrix}
...
\begin{abstract}
OEIS A232318 counts arrays of width $3$ over $\{0,\dots,1\}$ under a condition on each cell
...
OEIS A232318 is ``Number of (2+1)X(n+1) 0..1 arrays with every element equal to some horizontal or antidiagonal neighbor, with top left element zero.''. It has offset $1$ and begins
\[
5, 24, 139, 853, 5241, 32089, 196698, 1205422,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 07:18:27, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) + 9\,a(n-2) - 10\,a(n-3) - 19\,a(n-4) + 9\,a(n-5) + 21\,a(n-6) - 15\,a(n-8) - 5\,a(n-9) + 5\,a(n-10) + 4\,a(n-11) - 2\,a(n-12)
\]
for every $n>14$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232318.
