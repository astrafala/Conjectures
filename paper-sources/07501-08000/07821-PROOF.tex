...
\title{The empirical recurrence for OEIS A264471, proved by transfer matrix}
...
\begin{abstract}
OEIS A264471 carries an empirical recurrence of order $15$ contributed by R.~H.~Hardin. It is
...
OEIS A264471 is ``Number of (n+1)X(3+1) arrays of permutations of 0..n*4+3 with each element having directed index change 0,1 1,0 2,1 or -1,-1.''. It has offset $1$ and begins
\[
0, 4, 6, 16, 49, 124, 384, 1041,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 14 2015 15:33:30, revision 4) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264471.
