...
\title{The empirical recurrence for OEIS A235082, proved by transfer matrix}
...
\begin{abstract}
OEIS A235082 counts $4$-column arrays over $\{0,\dots,4\}$ in which every
...
OEIS A235082 is ``Number of (n+1) X (3+1) 0..4 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 4, with no adjacent elements equal (constant-stress tilted 1 X 1 tilings).''. It has offset
$1$ and begins
\[
202, 418, 830, 1758, 3610, 7810, 16390,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 19 2022 23:24:18, revision 7) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) + 9\,a(n-2) - 78\,a(n-3) + 12\,a(n-4) + 462\,a(n-5) - 368\,a(n-6) - 1304\,a(n-7) + 1433\,a(n-8) + 1841\,a(n-9) - 2237\,a(n-10) - 1346\,a(n-11) + 1420\,a(n-12) + 604\,a(n-13) - 300\,a(n-14) - 120\,a(n-15)
\end{equation}
for all $n>15$, which is every $n$ at which a recurrence of order $15$ can be
stated.
...
$j=0,1,\dots$. They vanish from $j=15-15+1$ onwards, and the run was continued past
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A235082.
