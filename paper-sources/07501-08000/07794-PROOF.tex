...
\title{The empirical recurrence for OEIS A250587, proved by transfer matrix}
...
\begin{abstract}
OEIS A250587 counts arrays over $\{0,1,2\}$ in which a statistic taken over short runs
...
OEIS A250587 is ``Number of (n+1)X(3+1) 0..2 arrays with nondecreasing max(x(i,j),x(i,j-1)) in the i direction and nondecreasing min(x(i,j),x(i-1,j)) in the j direction.''. It has offset $1$ and begins
\[
639, 3641, 17718, 79415, 333355, 1347397, 5284985, 20355558,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 12:34:15, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250587.
