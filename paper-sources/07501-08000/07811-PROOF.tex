...
\title{The empirical recurrence for OEIS A230186, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A230186 counts arrays over $\{0,\dots,2\}$ in which every cell is constrained by the
...
OEIS A230186 is ``Number of 3Xn 0..2 arrays x(i,j) with each element horizontally or antidiagonally next to at least one element with value 2-x(i,j).''. It has offset $1$ and begins
\[
0, 33, 231, 3411, 44487, 596973, 7957785, 106248147,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 08:42:37, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;9\,a(n-1) + 59\,a(n-2) + 17\,a(n-3) - 361\,a(n-4) - 569\,a(n-5) + 530\,a(n-6) + 2304\,a(n-7) + 1442\,a(n-8) - 3272\,a(n-9) - 5911\,a(n-10) - 927\,a(n-11) + 5899\,a(n-12) + 3415\,a(n-13) + 293\,a(n-14) - 3915\,a(n-15) - 688\,a(n-16) + 770\,a(n-17) + 146\,a(n-18) + 984\,a(n-19) - 112\,a(n-20) + 176\,a(n-21)
\end{equation}
for all $n>23$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A230186.
