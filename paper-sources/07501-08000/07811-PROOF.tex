...
\title{The empirical recurrence for OEIS A298235, proved by transfer matrix}
...
\begin{abstract}
OEIS A298235 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A298235 is ``Number of nX3 0..1 arrays with every element equal to 0, 2, 3, 4 or 5 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 13, 22, 124, 409, 1921, 8908, 41933,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 16 2018 11:33:56, revision
6) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) + 7\,a(n-2) - 32\,a(n-3) - 51\,a(n-4) + 118\,a(n-5) + 121\,a(n-6) - 249\,a(n-7) - 90\,a(n-8) + 292\,a(n-9) - 150\,a(n-11) + 2\,a(n-12) + 12\,a(n-13)
\end{equation}
for all $n>15$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A298235.
