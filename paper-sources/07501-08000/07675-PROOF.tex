...
\title{The empirical recurrence for OEIS A236134, proved by transfer matrix}
...
\begin{abstract}
OEIS A236134 counts arrays over $\{0,\dots,3\}$ subject to a condition on the order
...
OEIS A236134 is ``Number of (n+1)X(1+1) 0..3 arrays colored with the maximum plus the lower median minus the upper median minus the minimum of every 2X2 subblock.''. It has offset $1$ and begins
\[
256, 2816, 31552, 351872, 3932416, 43917824, 490505216, 5477885952,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 09:08:08, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 12\,a(n-2) + 328\,a(n-3) + 5216\,a(n-4) + 18624\,a(n-5) + 87168\,a(n-6) + 194304\,a(n-7) - 1173760\,a(n-8) - 4189696\,a(n-9) - 15864832\,a(n-10) - 40843264\,a(n-11) + 123420672\,a(n-12) + 390070272\,a(n-13) + 424673280\,a(n-14) + 1104150528\,a(n-15) - 2717908992\,a(n-16) - 8153726976\,a(n-17)
\]
for every $n>17$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A236134.
