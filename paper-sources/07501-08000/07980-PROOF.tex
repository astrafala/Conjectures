...
\title{The empirical recurrence for OEIS A242546, proved by transfer matrix}
...
\begin{abstract}
OEIS A242546 carries an empirical recurrence of order $16$ contributed by R.~H.~Hardin. It is
...
OEIS A242546 is ``Number of length n+3 0..5 arrays with no four elements in a row with pattern aabb (possibly a=b) and new values 0..5 introduced in 0..5 order.''. It has offset $1$ and begins
\[
13, 43, 166, 711, 3311, 16512, 86671, 471698,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 11:17:20, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;11\,a(n-1) - 41\,a(n-2) + 100\,a(n-3) - 259\,a(n-4) + 283\,a(n-5) - 178\,a(n-6) + 383\,a(n-7) + 1393\,a(n-8) + 312\,a(n-9) + 723\,a(n-10) - 1707\,a(n-11) - 5129\,a(n-12) - 5430\,a(n-13) - 5400\,a(n-14) - 3600\,a(n-15) - 900\,a(n-16)
\]
for every $n>19$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A242546.
