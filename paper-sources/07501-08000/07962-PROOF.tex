...
\title{The empirical recurrence for OEIS A259423, proved by transfer matrix}
...
\begin{abstract}
OEIS A259423 counts arrays of width $5$ over $\{0,1\}$ subject to a condition read round the
...
OEIS A259423 is ``Number of (n+1)X(4+1) 0..1 arrays with each 2X2 subblock having clockwise pattern 0000 0001 0011 or 0111.''. It has offset $1$ and begins
\[
469, 7695, 123306, 1990133, 32060569, 516880938, 8331704179, 134312969201,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:51:11, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;18\,a(n-1) + 34\,a(n-2) - 1078\,a(n-3) - 384\,a(n-4) + 17595\,a(n-5) - 3702\,a(n-6) - 104436\,a(n-7) + 47348\,a(n-8) + 254812\,a(n-9) - 155015\,a(n-10) - 240597\,a(n-11) + 170095\,a(n-12) + 72147\,a(n-13) - 60513\,a(n-14) - 2266\,a(n-15) + 6147\,a(n-16) - 594\,a(n-17) - 142\,a(n-18) + 25\,a(n-19) - a(n-20)
\]
for every $n>18$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A259423.
