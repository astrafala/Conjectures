...
\title{The empirical recurrence for OEIS A304005, proved by transfer matrix}
...
\begin{abstract}
OEIS A304005 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A304005 is ``Number of nX3 0..1 arrays with every element unequal to 0, 2, 3 or 5 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 7, 13, 21, 27, 53, 99, 197,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 04 2018 11:19:12, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 5\,a(n-2) - a(n-3) - 12\,a(n-4) - 2\,a(n-5) + 10\,a(n-6) + 2\,a(n-7) + a(n-8) + 7\,a(n-9) - 3\,a(n-10) - 19\,a(n-11) - 2\,a(n-12) + 2\,a(n-13) - 4\,a(n-14) + 10\,a(n-15) + 6\,a(n-16)
\end{equation}
for all $n>17$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A304005.
