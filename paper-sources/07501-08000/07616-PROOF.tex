...
\title{The empirical recurrence for OEIS A320359, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A320359 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A320359 is ``Number of nX3 0..1 arrays with every element unequal to 2, 3, 4 or 6 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
0, 1, 4, 13, 60, 258, 1111, 4836,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 11 2018 14:00:11, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) - 4\,a(n-2) + 9\,a(n-3) - 19\,a(n-4) + 12\,a(n-5) - 24\,a(n-6) + 5\,a(n-7) - 9\,a(n-8) + 28\,a(n-9) + 20\,a(n-10) - 13\,a(n-11) - 31\,a(n-12) - 8\,a(n-13) + 14\,a(n-14) + 19\,a(n-15) + 4\,a(n-16) - a(n-17) - 2\,a(n-18)
\end{equation}
for all $n>20$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A320359.
