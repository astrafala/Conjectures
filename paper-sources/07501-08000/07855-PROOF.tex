...
\title{The empirical recurrence for OEIS A231452, proved by transfer matrix}
...
\begin{abstract}
OEIS A231452 counts $3\times(n+1)$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A231452 is ``Number of (2+1)X(n+1) 0..3 arrays with no element unequal to a strict majority of its horizontal and antidiagonal neighbors, with values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
6, 15, 32, 87, 229, 647, 1829, 5293,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 06:31:01, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) - 7\,a(n-2) - 20\,a(n-3) + 52\,a(n-4) - 14\,a(n-5) - 69\,a(n-6) + 56\,a(n-7) + 24\,a(n-8) + 14\,a(n-9) - 81\,a(n-10) + 112\,a(n-12) - 6\,a(n-13) - 3\,a(n-14) - 36\,a(n-15) - 27\,a(n-16)
\]
for every $n>15$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231452.
