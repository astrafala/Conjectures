...
\title{The empirical recurrence for OEIS A300800, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A300800 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A300800 is ``Number of nX4 0..1 arrays with every element equal to 0, 1, 2, 3 or 4 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
8, 128, 1672, 23096, 317504, 4369224, 60123512, 827349312,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 13*a(n-1) +14*a(n-2) -44*a(n-3) -63*a(n-4) +a(n-5) -17*a(n-6) +11*a(n-7) -36*a(n-8) -6*a(n-9) -a(n-10) +a(n-11)
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 13 2018 07:42:19, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;13\,a(n-1) + 14\,a(n-2) - 44\,a(n-3) - 63\,a(n-4) + a(n-5) - 17\,a(n-6) + 11\,a(n-7) - 36\,a(n-8) - 6\,a(n-9) - a(n-10) + a(n-11)
\end{equation}
for all $n>12$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A300800.
