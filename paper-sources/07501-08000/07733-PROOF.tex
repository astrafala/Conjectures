...
\title{The empirical recurrence for OEIS A237176, proved by transfer matrix}
...
\begin{abstract}
OEIS A237176 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
OEIS A237176 is ``Number of (n+1)X(1+1) 0..2 arrays colored with the maximum plus the minimum minus the lower median of every 2X2 subblock.''. It has offset $1$ and begins
\[
81, 402, 2061, 10488, 53401, 271420, 1382012, 7030000,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 09:56:22, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;32\,a(n-3) + 288\,a(n-4) + 464\,a(n-5) + 2632\,a(n-6) + 2144\,a(n-7) + 6720\,a(n-8) + 3624\,a(n-9) - 10064\,a(n-10) - 96\,a(n-11) - 52480\,a(n-12) - 13312\,a(n-13) - 1536\,a(n-14) - 16384\,a(n-15) + 81920\,a(n-16)
\]
for every $n>16$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237176.
