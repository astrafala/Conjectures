...
\title{The empirical recurrence for OEIS A297097, proved by transfer matrix}
...
\begin{abstract}
OEIS A297097 counts $n\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A297097 is ``Number of nX3 0..1 arrays with no 1 adjacent to 4 king-move neighboring 1s.''. It has offset $1$ and begins
\[
8, 58, 351, 2258, 14566, 93654, 602723, 3879430,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 25 2017 14:13:57, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-1) - 11\,a(n-2) + 20\,a(n-3) - 107\,a(n-4) + 115\,a(n-5) - 97\,a(n-6) + 458\,a(n-7) - 372\,a(n-8) + 65\,a(n-9) - 708\,a(n-10) + 408\,a(n-11) + 327\,a(n-12) + 361\,a(n-13) - 409\,a(n-14) - 68\,a(n-15) - 49\,a(n-16) + 10\,a(n-17) + 45\,a(n-18) - 12\,a(n-19) + 14\,a(n-20)
\]
for every $n>20$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297097.
