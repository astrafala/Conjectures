...
\title{The empirical recurrence for OEIS A252107, proved by transfer matrix}
...
\begin{abstract}
OEIS A252107 counts $(n+2)\times3$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252107 is ``Number of (n+2)X(1+2) 0..3 arrays with every 3X3 subblock row and column sum equal to 0 2 3 6 or 7 and every 3X3 diagonal and antidiagonal sum not equal to 0 2 3 6 or 7.''. It has offset $1$ and begins
\[
1417, 1929, 1568, 1600, 1884, 2058, 2468, 3149,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 10:48:18, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-3) + 2\,a(n-5) - 18\,a(n-6) - 11\,a(n-8) + 20\,a(n-9) - a(n-10) + 20\,a(n-11) - 8\,a(n-12) + 4\,a(n-13) - 11\,a(n-14) - 4\,a(n-16) - 4\,a(n-17) - 2\,a(n-19) + 4\,a(n-20) + 5\,a(n-22) - 2\,a(n-25)
\]
for every $n>33$.
\end{theorem}
...
at once. By Lemma~\ref{lem:crit} the recurrence holds for every $n>33$. The bound is exact: at $n=33$ the recurrence fails on the entry's own published terms, so no larger range holds.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252107.
