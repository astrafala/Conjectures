...
\title{The empirical recurrence for OEIS A234819, proved by transfer matrix}
...
\begin{abstract}
OEIS A234819 counts $5$-column arrays over $\{0,\dots,6\}$ in which every
...
OEIS A234819 is ``Number of (n+1) X (4+1) 0..6 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 6 (constant-stress 1 X 1 tilings).''. It has offset
$1$ and begins
\[
9716, 22098, 47136, 129384, 325424, 994812, 2794776,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 20 2022 18:49:12, revision 6) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234819.
