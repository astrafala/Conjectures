...
\title{The empirical recurrence for OEIS A236641, proved by transfer matrix}
...
\begin{abstract}
OEIS A236641 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
OEIS A236641 is ``Number of (n+1)X(1+1) 0..2 arrays colored with the maximum plus the upper median plus the lower median minus the minimum of every 2X2 subblock.''. It has offset $1$ and begins
\[
81, 518, 3313, 21276, 136697, 877196, 5629192, 36133600,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 09:24:02, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;80\,a(n-3) + 700\,a(n-4) + 2080\,a(n-5) + 6404\,a(n-6) + 8232\,a(n-7) - 23620\,a(n-8) - 91392\,a(n-9) - 276256\,a(n-10) - 395520\,a(n-11) + 444720\,a(n-12) + 1555840\,a(n-13) + 3134080\,a(n-14) + 3744128\,a(n-15) - 6767872\,a(n-16) - 13191168\,a(n-17) - 134144\,a(n-18) + 1472512\,a(n-19) + 3850240\,a(n-20) + 15204352\,a(n-21) + 1310720\,a(n-22) - 6815744\,a(n-23)
\]
for every $n>23$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A236641.
