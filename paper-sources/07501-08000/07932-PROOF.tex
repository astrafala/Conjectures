...
\title{The empirical recurrence for OEIS A300110, proved by transfer matrix}
...
\begin{abstract}
OEIS A300110 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A300110 is ``Number of nX3 0..1 arrays with every element equal to 1, 2, 4, 5, 6, 7 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 7, 15, 29, 63, 199, 629, 1837,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 25 2018 06:28:17, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) - 7\,a(n-2) + 4\,a(n-3) - 4\,a(n-4) + 7\,a(n-5) - 26\,a(n-6) + 26\,a(n-7) + 17\,a(n-8) - 5\,a(n-9) - a(n-10) - 40\,a(n-11) + 22\,a(n-12) - 11\,a(n-13) + 14\,a(n-14) + 2\,a(n-15) - 2\,a(n-16)
\end{equation}
for all $n>17$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A300110.
