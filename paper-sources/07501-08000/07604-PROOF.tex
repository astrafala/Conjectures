...
\title{The empirical recurrence for OEIS A298143, proved by transfer matrix}
...
\begin{abstract}
OEIS A298143 counts $5$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $equal to$ itself lying in $\{2,3,6,7\}$, and it carries an empirical
...
OEIS A298143 is ``Number of nX5 0..1 arrays with every element equal to 2, 3, 6 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
0, 8, 1, 13, 34, 57, 73, 174,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 13 2018 11:22:59, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + a(n-2) - a(n-3) + 6\,a(n-4) - 9\,a(n-5) - 15\,a(n-6) + a(n-7) - 11\,a(n-8) + 12\,a(n-9) + 38\,a(n-10) + 43\,a(n-11) + 14\,a(n-12) - 38\,a(n-13) - 61\,a(n-14) - 5\,a(n-15) - 3\,a(n-17) + 17\,a(n-18) + 19\,a(n-19) - 38\,a(n-20) - 62\,a(n-21) + 16\,a(n-22) + 37\,a(n-23) - 7\,a(n-24) - a(n-25) + 50\,a(n-26) + 35\,a(n-27) + 2\,a(n-28) - 15\,a(n-29) - 2\,a(n-30) - 3\,a(n-32) - 2\,a(n-33) - 2\,a(n-34)
\end{equation}
for all $n>40$.
...
has score in $\{2,3,6,7\}$. The entry also fixes the top-left entry to be $0$; that is a condition on the first row alone, so it restricts the start vector and nothing else.
...
\begin{itemize}
\item $\mathbf{s}(r,s)=1$ when every cell of $r$ has score in $\{2,3,6,7\}$ \emph{with no row
above $r$} and $r_1=0$, and $0$ otherwise;
\item an edge $(r,s)\to(s,t)$ when every cell of $s$ has score in $\{2,3,6,7\}$ computed from
$r$, $s$ and $t$;
\item $\mathbf{e}(r,s)=1$ when every cell of $s$ has score in $\{2,3,6,7\}$ \emph{with no row
...
exactly when every one of its $n$ rows has all scores in $\{2,3,6,7\}$. Read the sequence as the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A298143.
