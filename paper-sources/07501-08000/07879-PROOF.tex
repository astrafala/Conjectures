...
\title{The empirical recurrence for OEIS A207270, proved by transfer matrix}
...
\begin{abstract}
OEIS A207270 counts arrays over $\{0,\dots,1\}$ of width $3$ that avoid the patterns
...
OEIS A207270 is ``Number of 3 X n 0..1 arrays avoiding 0 0 0 and 0 1 1 horizontally and 0 1 1 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
6, 36, 82, 217, 499, 1014, 2141,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 13 2026 12:45:11, revision
11) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 4\,a(n-2) + 2\,a(n-3) - 12\,a(n-4) - 9\,a(n-5) + 6\,a(n-6) + 20\,a(n-7) + 6\,a(n-8) - 2\,a(n-9) - 16\,a(n-10) - 12\,a(n-11) - 4\,a(n-12) + 14\,a(n-13) + 9\,a(n-14) + a(n-15) - 6\,a(n-16) - 2\,a(n-17) + a(n-19)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207270.
