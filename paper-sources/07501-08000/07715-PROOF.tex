...
\title{The empirical recurrence for OEIS A241373, proved by transfer matrix}
...
\begin{abstract}
OEIS A241373 counts $4\times n$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A241373 is ``Number of 4Xn 0..2 arrays with no element equal to fewer vertical neighbors than horizontal neighbors, with new values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
14, 326, 7376, 169982, 3910194, 90008909, 2071815945, 47690157718,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 11:14:19, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;32\,a(n-1) - 214\,a(n-2) + 26\,a(n-3) + 3879\,a(n-4) - 15470\,a(n-5) + 19107\,a(n-6) + 72463\,a(n-7) - 211026\,a(n-8) + 106996\,a(n-9) + 193844\,a(n-10) - 2000756\,a(n-11) + 412552\,a(n-12) + 8652096\,a(n-13) - 3035456\,a(n-14) - 10691648\,a(n-15) + 6530688\,a(n-16) + 2014720\,a(n-17) - 6114304\,a(n-18) + 2244608\,a(n-19) + 1933312\,a(n-20) - 720896\,a(n-21)
\]
for every $n>23$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A241373.
