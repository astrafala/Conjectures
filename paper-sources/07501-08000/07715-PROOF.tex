...
\title{The empirical recurrence for OEIS A185829, proved by transfer matrix}
...
\begin{abstract}
OEIS A185829 counts $n\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A185829 is ``Half the number of nX3 binary arrays with every element equal to exactly one or two of its horizontal and vertical neighbors.''. It has offset $1$ and begins
\[
1, 10, 30, 118, 393, 1430, 5004, 17877,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 03:13:17, revision 11) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 6\,a(n-2) - a(n-3) - 3\,a(n-4) + 4\,a(n-5) - 4\,a(n-6) - 32\,a(n-7) - 9\,a(n-8) - 4\,a(n-9) - 19\,a(n-10) + 17\,a(n-11) + 3\,a(n-12) + a(n-13) - a(n-14)
\]
for every $n>14$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A185829.
