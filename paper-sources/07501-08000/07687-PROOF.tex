...
\title{The empirical recurrence for OEIS A248432, proved by transfer matrix}
...
\begin{abstract}
OEIS A248432 carries an empirical recurrence of order $13$ contributed by R.~H.~Hardin. It is
...
OEIS A248432 is ``Number of length n+2 0..7 arrays with every three consecutive terms having the sum of some two elements equal to twice the third.''. It has offset $1$ and begins
\[
80, 140, 252, 462, 884, 1684, 3200, 6216,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + 10*a(n-3) - 10*a(n-4) - 22*a(n-6) + 22*a(n-7) + 12*a(n-9) - 12*a(n-10) - a(n-12) + a(n-13).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 08 2018 08:53:28, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 10\,a(n-3) - 10\,a(n-4) - 22\,a(n-6) + 22\,a(n-7) + 12\,a(n-9) - 12\,a(n-10) - a(n-12) + a(n-13)
\]
for every $n>13$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A248432.
