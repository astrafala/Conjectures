...
\title{The empirical recurrence for OEIS A238074, proved by transfer matrix}
...
\begin{abstract}
OEIS A238074 counts arrays over $\{0,\dots,3\}$ subject to a condition on the order
...
OEIS A238074 is ``Number of (n+1)X(1+1) 0..3 arrays with the maximum plus the minimum of every 2X2 subblock differing from its horizontal and vertical neighbors by exactly one.''. It has offset $1$ and begins
\[
256, 1592, 9884, 59772, 378708, 2285576, 14349272, 86693008,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 17*a(n-2) +736*a(n-4) +2353*a(n-6) +2483*a(n-8) +800*a(n-10) for n>11
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 10:45:44, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;17\,a(n-2) + 736\,a(n-4) + 2353\,a(n-6) + 2483\,a(n-8) + 800\,a(n-10)
\]
for every $n>11$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A238074.
