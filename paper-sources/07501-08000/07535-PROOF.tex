...
\title{The empirical recurrence for OEIS A202525, proved by transfer matrix}
...
\begin{abstract}
OEIS A202525 counts arrays of width $3$ over $\{0,1\}$ containing no occurrence of certain short
...
OEIS A202525 is ``Number of (n+2) X 3 binary arrays avoiding patterns 000 and 101 in rows, columns and nw-to-se diagonals.''. It has offset $1$ and begins
\[
86, 198, 417, 890, 1940, 4184, 8994, 19420,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) +6*a(n-3) +a(n-5) -7*a(n-6) -3*a(n-7) -a(n-8) +2*a(n-9) +a(n-10).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 01 2018 06:02:08, revision 8) this is still
...
\text{down a diagonal, nw to se} & \mathtt{000},\quad \mathtt{101} \\
\end{array}
\]
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 6\,a(n-3) + a(n-5) - 7\,a(n-6) - 3\,a(n-7) - a(n-8) + 2\,a(n-9) + a(n-10)
\]
for every $n>10$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A202525.
