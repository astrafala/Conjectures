...
\title{The empirical recurrence for OEIS A258540, proved by transfer matrix}
...
\begin{abstract}
OEIS A258540 counts arrays of width $5$ over $\{0,1\}$ in which every $3\times3$ window has
...
OEIS A258540 is ``Number of (n+2)X(3+2) 0..1 arrays with no 3x3 subblock diagonal sum less than the antidiagonal sum or central row sum equal to the central column sum.''. It has offset $1$ and begins
\[
2520, 8836, 20736, 57600, 142544, 381924, 956736, 2496400,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 15:27:54, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + 9\,a(n-2) - 51\,a(n-3) - 20\,a(n-4) + 275\,a(n-5) - 65\,a(n-6) - 820\,a(n-7) + 465\,a(n-8) + 1485\,a(n-9) - 1180\,a(n-10) - 1685\,a(n-11) + 1685\,a(n-12) + 1180\,a(n-13) - 1485\,a(n-14) - 465\,a(n-15) + 820\,a(n-16) + 65\,a(n-17) - 275\,a(n-18) + 20\,a(n-19) + 51\,a(n-20) - 9\,a(n-21) - 4\,a(n-22) + a(n-23)
\]
for every $n>26$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A258540.
