...
\title{The empirical recurrence for OEIS A234733, proved by transfer matrix}
...
\begin{abstract}
OEIS A234733 counts $4$-column arrays over $\{0,\dots,7\}$ in which every
...
OEIS A234733 is ``Number of (n+1) X (3+1) 0..7 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 8 (constant-stress 1 X 1 tilings).''. It has offset
$1$ and begins
\[
2184, 6048, 14760, 45792, 127032, 423072, 1283880,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 20 2022 18:53:59, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;8\,a(n-1) + 53\,a(n-2) - 564\,a(n-3) - 888\,a(n-4) + 17184\,a(n-5) - 2382\,a(n-6) - 296784\,a(n-7) + 308859\,a(n-8) + 3196608\,a(n-9) - 5284083\,a(n-10) - 22169196\,a(n-11) + 48357478\,a(n-12) + 97763896\,a(n-13) - 273091508\,a(n-14) - 253071696\,a(n-15) + 976703832\,a(n-16) + 271829664\,a(n-17) - 2148744960\,a(n-18) + 304750080\,a(n-19) + 2640988800\,a(n-20) - 1133222400\,a(n-21) - 1378944000\,a(n-22) + 870912000\,a(n-23)
\end{equation}
...
\[
\bigl|\,r_j+s_{j+1}-r_{j+1}-s_j\,\bigr|\;=\;8.
\]
...
when $\bigl|r_j+s_{j+1}-r_{j+1}-s_j\bigr|=8$ for every $j$ with
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234733.
