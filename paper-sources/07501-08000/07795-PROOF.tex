...
\title{The empirical recurrence for OEIS A296829, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A296829 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A296829 is ``Number of nX3 0..1 arrays with each 1 adjacent to 0, 3 or 5 king-move neighboring 1s.''. It has offset $1$ and begins
\[
5, 14, 43, 132, 402, 1230, 3755, 11475,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 21 2017 12:41:33, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-2) + 20\,a(n-3) + 13\,a(n-4) - 27\,a(n-5) - 98\,a(n-6) - 115\,a(n-7) - 77\,a(n-8) - 13\,a(n-9) - 7\,a(n-10) - 15\,a(n-11) - 24\,a(n-12) - 4\,a(n-13) + 2\,a(n-14) + 4\,a(n-15)
\end{equation}
for all $n>16$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A296829.
