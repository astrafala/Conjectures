...
\title{The empirical recurrence for OEIS A252027, proved by transfer matrix}
...
\begin{abstract}
OEIS A252027 counts $(n+2)\times5$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A252027 is ``Number of (n+2) X (3+2) 0..2 arrays with every 3 X 3 subblock row, column, diagonal and antidiagonal sum not equal to 0 2 or 4.''. It has offset $1$ and begins
\[
357, 781, 2206, 7182, 24664, 85199, 295050, 1022761,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 26 2021 22:01:26, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252027.
