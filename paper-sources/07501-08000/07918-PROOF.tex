...
\title{The empirical recurrence for OEIS A250521, proved by transfer matrix}
...
\begin{abstract}
OEIS A250521 counts arrays over $\{0,1,2\}$ in which a statistic taken over short runs
...
OEIS A250521 is ``Number of (n+1)X(2+1) 0..2 arrays with nondecreasing x(i,j)-x(i,j-1) in the i direction and nondecreasing x(i,j)-x(i-1,j) in the j direction.''. It has offset $1$ and begins
\[
222, 1180, 5029, 18859, 65310, 214812, 682921, 2122743,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 14*a(n-1) - 85*a(n-2) + 294*a(n-3) - 639*a(n-4) + 906*a(n-5) - 839*a(n-6) + 490*a(n-7) - 164*a(n-8) + 24*a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 14 2018 14:05:31, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250521.
