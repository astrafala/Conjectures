...
\title{The empirical recurrence for OEIS A232671, proved by transfer matrix}
...
\begin{abstract}
OEIS A232671 counts arrays of width $3$ over $\{0,\dots,2\}$ under a condition on each cell
and its neighbours, and carries an empirical recurrence of order $25$ contributed by
...
OEIS A232671 is ``Number of (n+1)X(2+1) 0..2 arrays with every element next to itself plus and minus one within the range 0..2 horizontally, vertically, diagonally or antidiagonally.''. It has offset $1$ and begins
\[
212, 3138, 63632, 1323984, 26350948, 532378308, 10773984656, 217145249724,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 07:33:22, revision 6) this is still
...
$212$, which the model reproduces along with every later term. That is the cheapest check
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-1) + 143\,a(n-2) + 2259\,a(n-3) + 4937\,a(n-4) + 537\,a(n-5) - 135233\,a(n-6) - 381639\,a(n-7) - 575862\,a(n-8) + 1562236\,a(n-9) + 4517962\,a(n-10) + 3839040\,a(n-11) - 6466486\,a(n-12) - 13678168\,a(n-13) + 2830292\,a(n-14) + 12543416\,a(n-15) + 501152\,a(n-16) - 3876392\,a(n-17) - 3294920\,a(n-18) + 1863872\,a(n-19) - 369088\,a(n-20) + 655936\,a(n-21) - 7552\,a(n-22) - 67328\,a(n-23) - 22528\,a(n-24) + 8192\,a(n-25)
\]
for every $n>24$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232671.
