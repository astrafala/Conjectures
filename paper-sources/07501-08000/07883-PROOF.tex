...
\title{The empirical recurrence for OEIS A297225, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297225 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A297225 is ``Number of 3Xn 0..1 arrays with every 1 horizontally or antidiagonally adjacent to 1 neighboring 1s.''. It has offset $1$ and begins
\[
1, 9, 24, 57, 182, 535, 1513, 4415,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 27 2017 15:38:43, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 2\,a(n-2) + 8\,a(n-3) + 6\,a(n-4) + 4\,a(n-5) - 6\,a(n-6) - 8\,a(n-7) - 8\,a(n-8) + 10\,a(n-9) + 4\,a(n-10) - 2\,a(n-11) - 3\,a(n-12) + a(n-13)
\end{equation}
for all $n>14$.
...
publishes, $n=26$, the arrays have $3\cdot26$ cells over
$2$ values, so there are about $10^{23}$ of them to sift. The
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297225.
