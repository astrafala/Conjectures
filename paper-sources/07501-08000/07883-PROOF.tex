...
\title{The empirical recurrence for OEIS A260010, proved by transfer matrix}
...
\begin{abstract}
OEIS A260010 counts $(n+2)\times5$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A260010 is ``Number of (n+2)X(3+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000101 00010101 or 01010101.''. It has offset $1$ and begins
\[
109, 252, 889, 2492, 6944, 18356, 56137, 155304,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-2) +37*a(n-4) -13*a(n-6) -124*a(n-8) +12*a(n-10) +72*a(n-12) for n>13
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:58:40, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-2) + 37\,a(n-4) - 13\,a(n-6) - 124\,a(n-8) + 12\,a(n-10) + 72\,a(n-12)
\]
for every $n>13$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A260010.
