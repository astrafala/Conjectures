...
\title{The empirical recurrence for OEIS A234560, proved by transfer matrix}
...
\begin{abstract}
OEIS A234560 counts $5$-column arrays over $\{0,\dots,4\}$ in which every
...
length $n$. Hence $a(n)=\mathbf{1}^{\!\top}M^{n}\mathbf{1}$ on $S=3125$ vertices, which
...
OEIS A234560 is ``Number of (n+1) X (4+1) 0..4 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 4 (constant-stress 1 X 1 tilings).''. It has offset
$1$ and begins
\[
1954, 3384, 5710, 11982, 23830, 57210, 128614,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 20 2022 19:33:49, revision 6) the statement is
...
Let $V$ consist of all of $\{0,\dots,4\}^{5}$, and put $S=|V|=3125$. For $r,s\in V$ declare $r\to s$ an edge
...
Third, the vanishing test of Lemma~\ref{lem:crit} was carried past $S=3125$ consecutive
zeros rather than to a sampled prefix, in exact integer arithmetic.

\begin{thebibliography}{9}
\bibitem{oeis} The OEIS Foundation, \emph{The On-Line Encyclopedia of Integer
Sequences}, \url{https://oeis.org}, 2026. Sequence A234560.
