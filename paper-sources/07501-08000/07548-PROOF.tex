...
\title{The empirical recurrence for OEIS A202430, proved by transfer matrix}
...
\begin{abstract}
OEIS A202430 counts arrays of width $5$ over $\{0,1\}$ containing no occurrence of certain short
patterns, read along the rows, the columns or the diagonals. The entry carries an empirical
recurrence of order $16$ contributed by R.~H.~Hardin. It is true, and it is decidable
...
OEIS A202430 is ``Number of (n+2) X 5 binary arrays avoiding patterns 000 and 001 in rows, columns and nw-to-se diagonals.''. It has offset $1$ and begins
\[
1344, 10080, 67072, 463632, 3166800, 21708320, 148654000, 1018262528,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 26 2025 15:29:54, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 31\,a(n-2) + 70\,a(n-3) - 27\,a(n-4) - 200\,a(n-5) + 45\,a(n-6) + 376\,a(n-7) - 209\,a(n-8) - 395\,a(n-9) + 543\,a(n-10) - 207\,a(n-11) - 27\,a(n-12) + 27\,a(n-13) + 6\,a(n-14) - 3\,a(n-15) - a(n-16)
\]
for every $n>14$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A202430.
