...
\title{The empirical recurrence for OEIS A260538, proved by transfer matrix}
...
\begin{abstract}
OEIS A260538 counts $(n+2)\times4$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A260538 is ``Number of (n+2) X (2+2) 0..1 arrays with each 3 X 3 subblock having clockwise perimeter pattern 00000001 00000011 or 00010001.''. It has offset $1$ and begins
\[
75, 131, 310, 566, 976, 2229, 4296, 7576,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 29 2018 07:07:58, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-2) + 5\,a(n-3) + 4\,a(n-4) - 3\,a(n-5) - 2\,a(n-6) - 10\,a(n-8) - 6\,a(n-9) + a(n-10) - a(n-11) + a(n-12) + a(n-13)
\]
for every $n>14$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A260538.
