...
\title{The empirical recurrence for OEIS A236887, proved by transfer matrix}
...
\begin{abstract}
OEIS A236887 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
OEIS A236887 is ``Number of (n+1)X(2+1) 0..2 arrays with the maximum plus the upper median minus the lower median minus the minimum of every 2X2 subblock equal.''. It has offset $1$ and begins
\[
245, 975, 4129, 19005, 91617, 464737, 2442897, 13272897,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 09:38:33, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;14\,a(n-1) - 36\,a(n-2) - 311\,a(n-3) + 1782\,a(n-4) - 328\,a(n-5) - 15312\,a(n-6) + 26368\,a(n-7) + 28560\,a(n-8) - 103120\,a(n-9) + 42336\,a(n-10) + 79216\,a(n-11) - 66656\,a(n-12) - 8256\,a(n-13) + 20352\,a(n-14) - 4608\,a(n-15)
\]
for every $n>15$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A236887.
