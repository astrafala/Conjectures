...
\title{The empirical recurrence for OEIS A243638, proved by transfer matrix}
...
\begin{abstract}
OEIS A243638 carries an empirical recurrence of order $12$ contributed by R.~H.~Hardin. It is
...
OEIS A243638 is ``Number of length n+2 0..7 arrays with no three unequal elements in a row and new values 0..7 introduced in 0..7 order.''. It has offset $1$ and begins
\[
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 02 2018 12:28:32, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;13\,a(n-1) - 56\,a(n-2) + 44\,a(n-3) + 305\,a(n-4) - 633\,a(n-5) - 476\,a(n-6) + 1772\,a(n-7) + 308\,a(n-8) - 2060\,a(n-9) - 368\,a(n-10) + 864\,a(n-11) + 288\,a(n-12)
\]
for every $n>13$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A243638.
