...
\title{The empirical recurrence for OEIS A297797, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297797 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A297797 is ``Number of nX3 0..1 arrays with every 1 horizontally, diagonally or antidiagonally adjacent to 2, 3 or 5 neighboring 1s.''. It has offset $1$ and begins
\[
1, 11, 37, 108, 533, 2434, 10287, 45968,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 06 2018 09:28:36, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 46\,a(n-3) - 56\,a(n-4) + 43\,a(n-5) - 576\,a(n-6) + 284\,a(n-7) - 620\,a(n-8) + 1922\,a(n-9) - 364\,a(n-10) + 1288\,a(n-11) + 884\,a(n-12) - 496\,a(n-13) + 504\,a(n-14) - 352\,a(n-15)
\end{equation}
for all $n>16$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297797.
