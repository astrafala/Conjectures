...
\title{The empirical recurrence for OEIS A255154, proved by transfer matrix}
...
\begin{abstract}
OEIS A255154 counts $(n+2)\times5$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A255154 is ``Number of (n+2)X(3+2) 0..1 arrays with no 3x3 subblock diagonal sum 1 and no antidiagonal sum 1 and no row sum 0 or 1 and no column sum 0 or 1.''. It has offset $1$ and begins
\[
141, 459, 1637, 5615, 19437, 67465, 232685, 804189,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:39:38, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + a(n-2) + 13\,a(n-3) + 31\,a(n-4) + 44\,a(n-5) + 33\,a(n-6) - 50\,a(n-7) - 84\,a(n-8) + a(n-9) + 76\,a(n-10) - 86\,a(n-11) - 274\,a(n-12) - 149\,a(n-13) - 14\,a(n-14) + 12\,a(n-15) - 2\,a(n-16) - 4\,a(n-17) + 4\,a(n-18)
\]
for every $n>20$.
\end{theorem}
...
exactly. Those integers vanish from the index corresponding to $n=20+1$ onwards, and the
run was continued until the working vector was identically zero, which settles all larger $j$
at once. By Lemma~\ref{lem:crit} the recurrence holds for every $n>20$. The bound is exact: at $n=20$ the recurrence fails on the entry's own published terms, so no larger range holds.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A255154.
