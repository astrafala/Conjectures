...
\title{The empirical recurrence for OEIS A228665, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A228665 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A228665 is ``Number of 6 X n binary arrays with top left value 1 and no two ones adjacent horizontally, diagonally or antidiagonally.''. It has offset $1$ and begins
\[
32, 70, 2348, 11912, 203762, 1482892, 19236832, 166237206,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 02 2025 21:57:46, revision 12) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) + 88\,a(n-2) - 138\,a(n-3) - 1388\,a(n-4) + 1332\,a(n-5) + 5911\,a(n-6) - 2920\,a(n-7) - 8340\,a(n-8) + 816\,a(n-9) + 2232\,a(n-10)
\end{equation}
for all $n>11$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A228665.
