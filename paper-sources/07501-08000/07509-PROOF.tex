...
\title{The empirical recurrence for OEIS A183339, proved by transfer matrix}
...
\begin{abstract}
OEIS A183339 counts arrays of width $7$ over $\{0,1\}$ under local conditions relating each cell
...
OEIS A183339 is ``Number of nX7 binary arrays with each 1 adjacent to exactly one 1 vertically and one 1 horizontally.''. It has offset $1$ and begins
\[
1, 13, 37, 97, 407, 1397, 4531, 16029,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 01:34:53, revision 9) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The array has $7$ cells across, with entries in $\{0,1\}$. The NEIGHBOURS of a cell are the
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=833.
\]
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 2\,a(n-2) + 18\,a(n-3) + 17\,a(n-4) + 7\,a(n-5) - 40\,a(n-6) - 78\,a(n-7) - 21\,a(n-8) + 88\,a(n-9) + 62\,a(n-10) - 49\,a(n-11) - 24\,a(n-12) + 9\,a(n-13) - 18\,a(n-14) + 2\,a(n-15) + 9\,a(n-16) + 4\,a(n-17) + 4\,a(n-18)
\]
for every $n>17$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A183339.
