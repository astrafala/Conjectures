...
\title{The empirical recurrence for OEIS A207909, proved by transfer matrix}
...
\begin{abstract}
OEIS A207909 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
$(0,0,0), (0,1,1)$ along one axis and $(0,0,0), (0,1,0)$ along the other, and carries an empirical recurrence of
...
OEIS A207909 is ``Number of 4Xn 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 0 0 and 0 1 1 vertically.''. It has offset
$1$ and begins
\[
9, 81, 261, 841, 4089, 19881, 80511,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:26:46, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 15\,a(n-3) + 67\,a(n-4) - 103\,a(n-5) - 69\,a(n-6) - 157\,a(n-7) - 735\,a(n-8) + 867\,a(n-9) + 665\,a(n-10) + 273\,a(n-11) + 2309\,a(n-12) - 2157\,a(n-13) - 1104\,a(n-14) - 82\,a(n-15) - 2401\,a(n-16) + 1858\,a(n-17) + 342\,a(n-18) + 28\,a(n-19) + 644\,a(n-20) - 456\,a(n-21) - 32\,a(n-22) - 48\,a(n-24) + 32\,a(n-25)
\end{equation}
for all $n>25$. The entry's array has a fixed number of rows and a growing number of
...
$(0,0,0), (0,1,1)$ as $3$ consecutive entries. There are $9$ admissible columns; that condition
...
index corresponding to $n=25+1$ onwards, and the run was continued past $S$ consecutive
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207909.
