...
\title{The empirical recurrence for OEIS A304474, proved by transfer matrix}
...
\begin{abstract}
OEIS A304474 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A304474 is ``Number of nX3 0..1 arrays with every element unequal to 0, 1, 2, 4 or 6 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
4, 12, 19, 37, 94, 202, 428, 965,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 13 2018 10:45:45, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-2) + 6\,a(n-3) + 8\,a(n-4) + 5\,a(n-5) - 6\,a(n-6) - 22\,a(n-7) - 25\,a(n-8) - 14\,a(n-9) + 2\,a(n-10) + 7\,a(n-11) + 3\,a(n-12)
\end{equation}
for all $n>13$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A304474.
