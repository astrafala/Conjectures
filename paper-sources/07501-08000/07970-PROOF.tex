...
\title{The empirical recurrence for OEIS A297539, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297539 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A297539 is ``Number of nX3 0..1 arrays with every 1 horizontally, diagonally or antidiagonally adjacent to 2 or 3 neighboring 1s.''. It has offset $1$ and begins
\[
1, 11, 35, 88, 461, 2050, 8057, 35640,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 31 2017 15:00:07, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 38\,a(n-3) - 40\,a(n-4) + 7\,a(n-5) - 296\,a(n-6) + 98\,a(n-7) + 36\,a(n-8) + 388\,a(n-9) - 96\,a(n-10) - 104\,a(n-11) + 400\,a(n-12) - 192\,a(n-13) + 128\,a(n-14)
\end{equation}
for all $n>15$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297539.
