...
\title{The empirical recurrence for OEIS A207882, proved by transfer matrix}
...
\begin{abstract}
OEIS A207882 counts arrays over $\{0,\dots,1\}$ of width $5$ that avoid the patterns
...
OEIS A207882 is ``Number of nX5 0..1 arrays avoiding 0 0 0 and 1 0 1 horizontally and 0 1 1 and 1 1 0 vertically.''. It has offset
$1$ and begins
\[
13, 169, 493, 1360, 4387, 14225, 49586,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:23:47, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;10\,a(n-1) - 10\,a(n-2) - 192\,a(n-3) + 523\,a(n-4) + 1371\,a(n-5) - 5841\,a(n-6) - 3846\,a(n-7) + 32138\,a(n-8) - 2492\,a(n-9) - 101383\,a(n-10) + 45525\,a(n-11) + 191278\,a(n-12) - 128400\,a(n-13) - 213000\,a(n-14) + 178176\,a(n-15) + 129368\,a(n-16) - 132968\,a(n-17) - 32752\,a(n-18) + 50112\,a(n-19) - 1856\,a(n-20) - 7296\,a(n-21) + 1536\,a(n-22)
\end{equation}
for all $n>23$. 
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207882.
