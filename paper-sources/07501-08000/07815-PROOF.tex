...
\title{The empirical recurrence for OEIS A234487, proved by transfer matrix}
...
\begin{abstract}
OEIS A234487 counts $6$-column arrays over $\{0,\dots,3\}$ in which every
...
OEIS A234487 is ``Number of (n+1) X (5+1) 0..3 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 2 (constant-stress 1 X 1 tilings).''. It has offset
$1$ and begins
\[
14402, 51950, 187196, 677138, 2455350, 8928348, 32545706,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 19 2022 02:17:50, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;21\,a(n-1) - 128\,a(n-2) - 301\,a(n-3) + 6470\,a(n-4) - 16377\,a(n-5) - 92720\,a(n-6) + 529264\,a(n-7) + 144134\,a(n-8) - 6281248\,a(n-9) + 8587390\,a(n-10) + 35733302\,a(n-11) - 92619285\,a(n-12) - 93289189\,a(n-13) + 447345822\,a(n-14) + 55762321\,a(n-15) - 1262355944\,a(n-16) + 278493999\,a(n-17) + 2300746886\,a(n-18) - 753516820\,a(n-19) - 2817152264\,a(n-20) + 837146044\,a(n-21) + 2311698968\,a(n-22) - 448826360\,a(n-23) - 1224869744\,a(n-24) + 85822528\,a(n-25) + 391294592\,a(n-26) + 16553184\,a(n-27) - 67375296\,a(n-28) - 8961408\,a(n-29) + 4757760\,a(n-30) + 967680\,a(n-31)
\end{equation}
...
Let $V$ consist of all of $\{0,\dots,3\}^{6}$, and put $S=|V|=4096$. For $r,s\in V$ declare $r\to s$ an edge
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234487.
