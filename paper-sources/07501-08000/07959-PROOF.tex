...
\title{The empirical recurrence for OEIS A238049, proved by transfer matrix}
...
\begin{abstract}
OEIS A238049 counts arrays over $\{0,\dots,3\}$ subject to a condition on the order
...
OEIS A238049 is ``Number of (n+1)X(1+1) 0..3 arrays with the maximum plus the minimum minus the upper median minus the lower median of every 2X2 subblock differing from its horizontal and vertical neighbors by exactly one.''. It has offset $1$ and begins
\[
256, 1760, 12352, 87488, 618752, 4375552, 30949952, 218919168,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2528*a(n-4) -63488*a(n-8) +315392*a(n-12) +147456*a(n-16) +4194304*a(n-20) for n>21
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 10:43:19, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;2528\,a(n-4) - 63488\,a(n-8) + 315392\,a(n-12) + 147456\,a(n-16) + 4194304\,a(n-20)
\]
for every $n>21$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A238049.
