...
\title{The empirical recurrence for OEIS A302627, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A302627 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A302627 is ``Number of 6Xn 0..1 arrays with every element equal to 0, 1, 2 or 6 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
32, 857, 498, 917, 2669, 9015, 30536, 106951,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 10 2018 19:15:45, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) - a(n-2) - 9\,a(n-3) - 28\,a(n-4) - 17\,a(n-5) + 195\,a(n-6) + 29\,a(n-7) - 153\,a(n-8) - 412\,a(n-9) - 101\,a(n-10) + 734\,a(n-11) + 271\,a(n-12) + 208\,a(n-13) - 1151\,a(n-14) - 613\,a(n-15) + 931\,a(n-16) + 599\,a(n-17) + 550\,a(n-18) - 1110\,a(n-19) - 517\,a(n-20) + 301\,a(n-21) + 247\,a(n-22) + 211\,a(n-23) - 103\,a(n-24) - 57\,a(n-25) - 3\,a(n-26) - 13\,a(n-27) + 6\,a(n-28) + 2\,a(n-29)
\end{equation}
for all $n>35$.
...
publishes, $n=23$, the arrays have $6\cdot23$ cells over
$2$ values, so there are about $10^{41}$ of them to sift. The
...
the middle column. The vector $w$ was formed by $29$ applications of $G$ in exact integer
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302627.
