...
\title{The empirical recurrence for OEIS A232304, proved by transfer matrix}
...
\begin{abstract}
OEIS A232304 counts arrays of width $3$ over $\{0,1,2\}$ in which every cell carrying one stated
...
OEIS A232304 is ``Number of nX3 0..2 arrays with every 0 next to a 1 and every 1 next to a 2 horizontally, vertically or antidiagonally.''. It has offset $1$ and begins
\[
7, 257, 5149, 107047, 2245709, 46996227, 983668985, 20589521605,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 07:17:05, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;17\,a(n-1) + 66\,a(n-2) + 338\,a(n-3) + 35\,a(n-4) + 706\,a(n-5) - 4131\,a(n-6) + 6628\,a(n-7) - 20192\,a(n-8) + 4632\,a(n-9) - 22908\,a(n-10) + 92304\,a(n-11) - 22608\,a(n-12) - 9536\,a(n-13) - 7616\,a(n-14) + 4096\,a(n-15)
\]
for every $n>14$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232304.
