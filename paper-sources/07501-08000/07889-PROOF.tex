...
\title{The empirical recurrence for OEIS A259767, proved by transfer matrix}
...
\begin{abstract}
OEIS A259767 counts $(n+2)\times5$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A259767 is ``Number of (n+2)X(3+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000001 or 00000101.''. It has offset $1$ and begins
\[
104, 167, 256, 385, 612, 1108, 1708, 2700,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-3) +3*a(n-6) +4*a(n-7) -2*a(n-9) +2*a(n-11) -8*a(n-13) +6*a(n-14) for n>17
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:55:03, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-3) + 3\,a(n-6) + 4\,a(n-7) - 2\,a(n-9) + 2\,a(n-11) - 8\,a(n-13) + 6\,a(n-14)
\]
for every $n>17$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A259767.
