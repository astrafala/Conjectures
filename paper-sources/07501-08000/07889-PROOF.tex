...
\title{The empirical recurrence for OEIS A298332, proved by transfer matrix}
...
\begin{abstract}
OEIS A298332 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $equal to$ itself lying in $\{1,2,3,4,6\}$, and it carries an empirical
...
OEIS A298332 is ``Number of nX3 0..1 arrays with every element equal to 1, 2, 3, 4 or 6 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 17, 113, 628, 3641, 21375, 124972, 730509,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 17 2018 08:20:20, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) + 3\,a(n-2) + 14\,a(n-3) - 9\,a(n-4) - 29\,a(n-5) - 33\,a(n-6) - 48\,a(n-7) + 34\,a(n-8) - 2\,a(n-9) - 10\,a(n-10) - 32\,a(n-11) + 12\,a(n-12) + 8\,a(n-13)
\end{equation}
for all $n>15$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A298332.
