...
\title{The empirical recurrence for OEIS A208424, proved by transfer matrix}
...
\begin{abstract}
OEIS A208424 counts arrays over $\{0,\dots,1\}$ of width $7$ that avoid the patterns
...
OEIS A208424 is ``Number of 7Xn 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 0 0 and 0 1 1 vertically.''. It has offset
$1$ and begins
\[
25, 625, 2625, 26375, 161975, 1297475, 8948825,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:51:06, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;52\,a(n-2) + 80\,a(n-3) - 477\,a(n-4) - 656\,a(n-5) + 1489\,a(n-6) + 1910\,a(n-7) - 1775\,a(n-8) - 2192\,a(n-9) + 812\,a(n-10) + 984\,a(n-11) - 120\,a(n-12) - 144\,a(n-13)
\end{equation}
...
$(0,0,0), (0,1,1)$ as $3$ consecutive entries. There are $25$ admissible columns; that condition
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208424.
