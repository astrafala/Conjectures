...
\title{The empirical recurrence for OEIS A220612, proved by transfer matrix}
...
\begin{abstract}
OEIS A220612 counts the ways of linking the cells of a grid $6$ cells wide, each cell either to
...
OEIS A220612 is ``Number of ways to reciprocally link elements of an nX6 array either to themselves or to exactly two horizontal and vertical neighbors, without consecutive collinear links.''. It has offset $1$ and begins
\[
1, 13, 43, 281, 1277, 7041, 34981, 183920,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 18:53:56, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + 23\,a(n-2) - 40\,a(n-3) - 160\,a(n-4) + 190\,a(n-5) + 441\,a(n-6) - 369\,a(n-7) - 513\,a(n-8) + 278\,a(n-9) + 240\,a(n-10) - 64\,a(n-11) - 39\,a(n-12) + 3\,a(n-13) + a(n-14)
\]
for every $n>13$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A220612.
