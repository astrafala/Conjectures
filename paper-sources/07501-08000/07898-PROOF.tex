...
\title{The empirical recurrence for OEIS A252145, proved by transfer matrix}
...
\begin{abstract}
OEIS A252145 counts $(n+2)\times7$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
$a(n)$ is a walk count on $S=22407$ vertices. Such a sequence is $C$-finite, so whether a given
...
OEIS A252145 is ``Number of (n+2)X(5+2) 0..3 arrays with every 3X3 subblock row and column sum equal to 0 3 5 6 or 7 and every 3X3 diagonal and antidiagonal sum not equal to 0 3 5 6 or 7.''. It has offset $1$ and begins
\[
14578, 5511, 9443, 8391, 18757, 16958, 44234, 36963,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 10:51:29, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252145.
