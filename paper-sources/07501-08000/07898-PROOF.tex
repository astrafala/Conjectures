...
\title{The empirical recurrence for OEIS A234827, proved by transfer matrix}
...
\begin{abstract}
OEIS A234827 counts arrays of width $4$ over $\{0,1,2\}$ subject to a condition read round the
...
OEIS A234827 is ``Number of (n+1)X(3+1) 0..2 arrays with each 2X2 subblock having the number of clockwise edge increases less than or equal to the number of counterclockwise edge increases.''. It has offset $1$ and begins
\[
3843, 161631, 6566460, 263929692, 10572386472, 423046102605, 16922003634471, 676811269740528,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 08:27:58, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;69\,a(n-1) - 1465\,a(n-2) + 13735\,a(n-3) - 65766\,a(n-4) + 174137\,a(n-5) - 265580\,a(n-6) + 234847\,a(n-7) - 111244\,a(n-8) + 19238\,a(n-9) + 45\,a(n-10) - 6\,a(n-11) + 72\,a(n-12) - 9\,a(n-13)
\]
for every $n>11$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234827.
