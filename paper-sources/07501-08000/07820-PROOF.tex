...
\title{The empirical recurrence for OEIS A203086, proved by transfer matrix}
...
\begin{abstract}
OEIS A203086 counts arrays of width $5$ over $\{0,1\}$ containing no occurrence of certain short
patterns, read along the rows, the columns or the diagonals. The entry carries an empirical
recurrence of order $22$ contributed by R.~H.~Hardin. It is true, and it is decidable
...
OEIS A203086 is ``Number of (n+2)X5 binary arrays avoiding patterns 000 and 101 in rows and columns.''. It has offset $1$ and begins
\[
621, 2237, 7558, 26528, 92748, 319956, 1110338, 3857116,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 10:06:51, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 2\,a(n-2) + 19\,a(n-3) + 17\,a(n-4) + 5\,a(n-5) - 57\,a(n-6) - 51\,a(n-7) + 48\,a(n-8) + 197\,a(n-9) - 63\,a(n-10) - 429\,a(n-11) - 144\,a(n-12) + 443\,a(n-13) + 246\,a(n-14) - 220\,a(n-15) - 81\,a(n-16) + 58\,a(n-17) - 65\,a(n-18) + 10\,a(n-19) + 49\,a(n-20) + 20\,a(n-21) + 20\,a(n-22)
\]
for every $n>24$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A203086.
