...
\title{The empirical recurrence for OEIS A302304, proved by transfer matrix}
...
\begin{abstract}
OEIS A302304 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the six horizontal, diagonal and antidiagonal neighbours, a number $equal to$ itself lying in $\{0,1,3,4\}$, and it carries an empirical
...
OEIS A302304 is ``Number of nX3 0..1 arrays with every element equal to 0, 1, 3 or 4 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
3, 11, 13, 33, 58, 153, 336, 937,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 05 2018 09:34:58, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) - 2\,a(n-2) + 13\,a(n-3) - 23\,a(n-4) + 13\,a(n-5) - 42\,a(n-6) + 25\,a(n-7) - 21\,a(n-8) - 36\,a(n-9) + 48\,a(n-10) - 24\,a(n-11) + 8\,a(n-12) + 32\,a(n-13)
\end{equation}
for all $n>16$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302304.
