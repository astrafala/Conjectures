...
\title{The empirical recurrence for OEIS A301320, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A301320 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A301320 is ``Number of nX5 0..1 arrays with every element equal to 0, 1, 2, 5 or 6 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
16, 138, 293, 726, 1649, 3649, 8035, 17751,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 4*a(n-1) -3*a(n-2) -4*a(n-3) +4*a(n-4) +2*a(n-6) -5*a(n-8) +2*a(n-9) +4*a(n-10) -2*a(n-11) -2*a(n-12) +a(n-14) for n>16
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 18 2018 08:30:30, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) - 3\,a(n-2) - 4\,a(n-3) + 4\,a(n-4) + 2\,a(n-6) - 5\,a(n-8) + 2\,a(n-9) + 4\,a(n-10) - 2\,a(n-11) - 2\,a(n-12) + a(n-14)
\end{equation}
for all $n>16$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A301320.
