...
\title{The empirical recurrence for OEIS A259002, proved by transfer matrix}
...
\begin{abstract}
OEIS A259002 counts the arrays over $\{0,\dots,1\}$ whose $3\times3$ subblocks carry a
...
so the count is a walk count on $S=28189$ states --- the last two array rows together with the
...
OEIS A259002 is ``Number of (n+2)X(4+2) 0..1 arrays with every 3X3 subblock sum of the two medians of the central row and column plus the two sums of the diagonal and antidiagonal nondecreasing horizontally, vertically and ne-to-sw antidiagonally.''. It has offset $1$ and begins
\[
34698, 50654, 159480, 225215, 177118, 174655, 49839, 44035,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) -a(n-2) +a(n-12) -2*a(n-13) +a(n-14) for n>27
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 15:33:54, revision 7) this is still
...
\]
on the $S=28189$ reachable states. In particular $a$ is $C$-finite. The alignment of the walk
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A259002.
