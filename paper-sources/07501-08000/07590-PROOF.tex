...
\title{A condition on each element and its neighbours: OEIS A295202}
...
\begin{abstract}
OEIS A295202 carries an empirical recurrence of order $32$ contributed by R.~H.~Hardin. It is
...
OEIS A295202 is ``Number of n X 5 0..1 arrays with each 1 horizontally or vertically adjacent to 2 or 4 1's.''. It has offset $1$ and begins
\[
1, 6, 25, 108, 438, 1597, 5831, 21717,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 07 2022 13:23:13, revision 6) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{The count is a walk count}

The entry counts arrays with $5$ columns over the alphabet $\{0,1\}$, growing one row at a time. Its condition is that every entry equal to $1$ must have exactly $2$ or $4$ of its horizontal and vertical neighbours equal to $1$.
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) - 7\,a(n-2) + 8\,a(n-3) + 16\,a(n-5) - 4\,a(n-6) - 71\,a(n-7) + 34\,a(n-8) - 123\,a(n-9) - 92\,a(n-10) - 94\,a(n-11) + 52\,a(n-12) + 370\,a(n-13) + 195\,a(n-14) + 622\,a(n-15) + 581\,a(n-16) - 286\,a(n-17) - 603\,a(n-18) - 1135\,a(n-19) - 627\,a(n-20) + 567\,a(n-21) + 347\,a(n-22) + 6\,a(n-23) - 217\,a(n-24) - 5\,a(n-25) + 32\,a(n-26) - 7\,a(n-27) - 7\,a(n-28) - 53\,a(n-29) - 6\,a(n-30) + 7\,a(n-31) + 2\,a(n-32)
\]
for every $n>32$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A295202.
