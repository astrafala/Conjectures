...
\title{The empirical recurrence for OEIS A232050, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A232050 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A232050 is ``Number of 4Xn 0..1 arrays with no element less than a strict majority of its horizontal and antidiagonal neighbors.''. It has offset $1$ and begins
\[
16, 65, 446, 3082, 22063, 153562, 1060850, 7322233,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 06:50:26, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;16\,a(n-1) - 115\,a(n-2) + 565\,a(n-3) - 2034\,a(n-4) + 5817\,a(n-5) - 13565\,a(n-6) + 26712\,a(n-7) - 45206\,a(n-8) + 66931\,a(n-9) - 89161\,a(n-10) + 109246\,a(n-11) - 128417\,a(n-12) + 138117\,a(n-13) - 133354\,a(n-14) + 106727\,a(n-15) - 71595\,a(n-16) + 45288\,a(n-17) - 14520\,a(n-18) - 13147\,a(n-19) + 45149\,a(n-20) - 49440\,a(n-21) + 35999\,a(n-22) - 13855\,a(n-23) + 8496\,a(n-24) + 5713\,a(n-25) + 1489\,a(n-26) - 5200\,a(n-27) - 450\,a(n-28) + 1011\,a(n-29) + 205\,a(n-30) - 126\,a(n-31) - 24\,a(n-32) + 9\,a(n-33)
\end{equation}
for all $n>36$.
...
the middle column. The vector $w$ was formed by $33$ applications of $G$ in exact integer
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232050.
