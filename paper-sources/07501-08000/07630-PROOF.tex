...
\title{The empirical recurrence for OEIS A236805, proved by transfer matrix}
...
\begin{abstract}
OEIS A236805 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
The condition is local to two consecutive rows, so the count is a walk count on $S=675$
...
OEIS A236805 is ``Number of (n+1)X(4+1) 0..2 arrays with the maximum plus the lower median minus the upper median minus the minimum of every 2X2 subblock equal.''. It has offset $1$ and begins
\[
4183, 60187, 929447, 16530709, 270610375, 5140896385, 86863046591, 1730194335025,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 09:34:21, revision 6) this is still
...
$4$ subblocks they form. So a row is a state, an $(n+1)$-row array is a walk of $n$
...
array, which is not among the objects counted. There are $S=675$ states left.
...
\begin{theorem}
\[
a(n)\;=\;36\,a(n-1) + 213\,a(n-2) - 20688\,a(n-3) + 159340\,a(n-4) + 2245440\,a(n-5) - 34534356\,a(n-6) + 121902336\,a(n-7) + 49292928\,a(n-8) - 974576448\,a(n-9) + 1350053568\,a(n-10) + 778781952\,a(n-11) - 2623560192\,a(n-12) + 1330255872\,a(n-13)
\]
for every $n>12$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A236805.
