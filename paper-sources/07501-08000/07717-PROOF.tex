...
\title{The empirical recurrence for OEIS A300180, proved by transfer matrix}
...
\begin{abstract}
OEIS A300180 counts $6$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A300180 is ``Number of nX6 0..1 arrays with every element equal to 0, 1, 2, 3, 4, 5, 6 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
32, 2048, 129217, 8168705, 516368256, 32640586945, 2063278351093, 130424025161538,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 27 2018 12:31:14, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;52\,a(n-1) + 613\,a(n-2) + 5871\,a(n-3) + 11376\,a(n-4) + 9186\,a(n-5) - 411458\,a(n-6) + 66088\,a(n-7) - 1386895\,a(n-8) + 8059846\,a(n-9) - 4373944\,a(n-10) + 14457696\,a(n-11) - 42895616\,a(n-12) + 12292096\,a(n-13) - 11452416\,a(n-14) + 15335424\,a(n-15)
\end{equation}
for all $n>15$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A300180.
