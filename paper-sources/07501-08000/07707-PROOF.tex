...
\title{The empirical recurrence for OEIS A236058, proved by transfer matrix}
...
\begin{abstract}
OEIS A236058 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
OEIS A236058 is ``Number of (n+1)X(1+1) 0..2 arrays colored with the difference of the upper median and the minimum in each 2X2 subblock.''. It has offset $1$ and begins
\[
81, 360, 1616, 7016, 31616, 138988, 620552, 2734804,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 09:03:26, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;16\,a(n-3) + 173\,a(n-4) + 268\,a(n-5) + 1216\,a(n-6) + 1260\,a(n-7) + 2128\,a(n-8) + 1296\,a(n-9) - 3968\,a(n-10) - 1024\,a(n-11) - 12288\,a(n-12) + 256\,a(n-13) - 6144\,a(n-14)
\]
for every $n>14$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A236058.
