...
\title{The empirical recurrence for OEIS A303098, proved by transfer matrix}
...
\begin{abstract}
OEIS A303098 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A303098 is ``Number of n X 4 0..1 arrays with every element equal to 1, 2, 3, 4 or 6 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
2, 46, 431, 4667, 49534, 523578, 5550469, 58797885,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 27 2023 12:30:51, revision
6) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;9\,a(n-1) + 26\,a(n-2) - 57\,a(n-3) - 433\,a(n-4) - 47\,a(n-5) + 1932\,a(n-6) + 2731\,a(n-7) - 3490\,a(n-8) - 6960\,a(n-9) + 156\,a(n-10) + 748\,a(n-11) + 3388\,a(n-12) + 5000\,a(n-13) + 12879\,a(n-14) + 2488\,a(n-15) - 9412\,a(n-16) - 11225\,a(n-17) - 870\,a(n-18) - 5309\,a(n-19) + 3368\,a(n-20) - 2123\,a(n-21) + 1230\,a(n-22) - 349\,a(n-23) + 121\,a(n-24) + 28\,a(n-25) - 26\,a(n-26)
\end{equation}
for all $n>26$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A303098.
