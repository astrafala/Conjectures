...
\title{The empirical recurrence for OEIS A304546, proved by transfer matrix}
...
\begin{abstract}
OEIS A304546 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $different from$ itself lying in $\{0,2,3,4,6\}$, and it carries an empirical
...
OEIS A304546 is ``Number of n X 3 0..1 arrays with every element unequal to 0, 2, 3, 4 or 6 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 8, 13, 60, 217, 749, 2822, 10516,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 13 2026 12:39:09, revision
6) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) - 3\,a(n-2) - a(n-3) - 18\,a(n-4) - 24\,a(n-5) + 44\,a(n-6) + 42\,a(n-7) + 52\,a(n-8) + 31\,a(n-9) - 132\,a(n-10) - 80\,a(n-11) + 48\,a(n-12) - 31\,a(n-13) + 13\,a(n-14) + 17\,a(n-15) - 82\,a(n-16) - 39\,a(n-17) - 2\,a(n-19) - a(n-20)
\end{equation}
for all $n>21$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A304546.
