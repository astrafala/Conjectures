...
\title{The empirical recurrence for OEIS A302523, proved by transfer matrix}
...
\begin{abstract}
OEIS A302523 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the six horizontal, diagonal and antidiagonal neighbours, a number $equal to$ itself lying in $\{1,2,4,5\}$, and it carries an empirical
...
OEIS A302523 is ``Number of nX3 0..1 arrays with every element equal to 1, 2, 4 or 5 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 7, 28, 115, 497, 2086, 9091, 40575,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 09 2018 09:20:42, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 7\,a(n-2) + 34\,a(n-3) - 44\,a(n-4) - 182\,a(n-5) - a(n-6) + 54\,a(n-7) + 479\,a(n-8) - 772\,a(n-9) + 328\,a(n-10) + 2176\,a(n-11) - 1456\,a(n-12) + 1088\,a(n-13) - 4480\,a(n-14) + 5120\,a(n-15) - 2304\,a(n-16) - 5120\,a(n-17) + 4096\,a(n-18)
\end{equation}
for all $n>18$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302523.
