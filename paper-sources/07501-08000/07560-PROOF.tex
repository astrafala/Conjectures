...
\title{The empirical recurrence for OEIS A252611, proved by transfer matrix}
...
\begin{abstract}
OEIS A252611 counts $(n+2)\times6$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
$a(n)$ is a walk count on $S=210066$ vertices. Such a sequence is $C$-finite, so whether a given
...
OEIS A252611 is ``Number of (n+2)X(4+2) 0..3 arrays with every 3X3 subblock row and diagonal sum equal to 0 3 5 6 or 8 and every 3X3 column and antidiagonal sum not equal to 0 3 5 6 or 8.''. It has offset $1$ and begins
\[
3235, 6019, 17762, 43595, 174803, 617798, 1597203, 6498007,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:26:44, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;82\,a(n-3) - 2013\,a(n-6) + 14952\,a(n-9) - 82100\,a(n-12) + 331384\,a(n-15) - 672832\,a(n-18) + 609568\,a(n-21) - 210304\,a(n-24) + 11264\,a(n-27)
\]
for every $n>35$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252611.
