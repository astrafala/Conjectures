...
\title{The empirical recurrence for OEIS A256747, proved by transfer matrix}
...
\begin{abstract}
OEIS A256747 counts $(n+2)\times9$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A256747 is ``Number of (n+2)X(7+2) 0..1 arrays with no 3x3 subblock diagonal sum 3 and no antidiagonal sum 3 and no row sum 0 and no column sum 0.''. It has offset $1$ and begins
\[
31032, 28816, 38376, 33616, 96576, 155792, 404480, 615296,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:45:10, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;-2\,a(n-1) + 2\,a(n-2) + 12\,a(n-3) + 17\,a(n-4) - 6\,a(n-5) - 2\,a(n-6) + 4\,a(n-7) - 144\,a(n-8) - 304\,a(n-9) - 96\,a(n-10) + 512\,a(n-11) + 512\,a(n-12)
\]
for every $n>15$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A256747.
