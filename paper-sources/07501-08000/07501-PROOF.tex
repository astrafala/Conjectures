...
\title{The empirical recurrence for OEIS A302000, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A302000 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A302000 is ``Number of 3Xn 0..1 arrays with every element equal to 1, 2 or 4 horizontally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
0, 5, 5, 26, 84, 309, 1108, 3979,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 30 2018 12:30:42, revision 4) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302000.
