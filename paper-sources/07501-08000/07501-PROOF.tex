...
\title{The empirical recurrence for OEIS A295778, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A295778 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A295778 is ``Number of nX5 0..1 arrays with each 1 adjacent to 0 or 2 king-move neighboring 1s.''. It has offset $1$ and begins
\[
13, 123, 665, 5263, 37897, 262707, 1905471, 13577504,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 27 2017 07:12:27, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;8\,a(n-1) + 2\,a(n-2) - 10\,a(n-3) - 408\,a(n-4) + 303\,a(n-5) + 1027\,a(n-6) + 905\,a(n-7) + 128\,a(n-8) - 5240\,a(n-9) - 261\,a(n-10) + 3150\,a(n-11) - 1753\,a(n-12) + 522\,a(n-13) + 691\,a(n-14) + 1536\,a(n-15) + 1326\,a(n-16) - 327\,a(n-17) + 802\,a(n-18) - 212\,a(n-19) - 739\,a(n-20) - 14\,a(n-21) + 4\,a(n-22)
\end{equation}
for all $n>23$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A295778.
