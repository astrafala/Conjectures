...
\title{The empirical recurrence for OEIS A246889, proved by transfer matrix}
...
\begin{abstract}
OEIS A246889 carries an empirical recurrence of order $14$ contributed by R.~H.~Hardin. It is
...
OEIS A246889 is ``Number of length n+4 0..5 arrays with some pair in every consecutive five terms totalling exactly 5.''. It has offset $1$ and begins
\[
6210, 33294, 177648, 942216, 4971120, 26346486, 139555230, 738947844,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 10:14:33, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + 7\,a(n-2) + 19\,a(n-3) + 53\,a(n-4) - 40\,a(n-5) - 36\,a(n-6) - 24\,a(n-7) - 64\,a(n-8) + 16\,a(n-9) + 29\,a(n-10) - 3\,a(n-11) + 5\,a(n-12) + a(n-13) - a(n-14)
\]
for every $n>-3$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A246889.
