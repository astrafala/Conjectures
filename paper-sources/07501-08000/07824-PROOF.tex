...
\title{The empirical recurrence for OEIS A202641, proved by transfer matrix}
...
\begin{abstract}
OEIS A202641 counts arrays of width $4$ over $\{0,1\}$ containing no occurrence of certain short
...
OEIS A202641 is ``Number of (n+2)X4 binary arrays avoiding patterns 000 and 111 in rows, columns and nw-to-se diagonals.''. It has offset $1$ and begins
\[
172, 530, 1766, 5948, 19880, 66924, 224940, 755816,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 09:46:13, revision 9) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A202641.
