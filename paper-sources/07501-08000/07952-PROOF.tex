...
\title{The empirical recurrence for OEIS A302683, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A302683 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
values of its neighbours, and carries an empirical recurrence of order $11$ contributed
...
OEIS A302683 is ``Number of 5Xn 0..1 arrays with every element equal to 0, 1, 4 or 6 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
16, 9, 11, 33, 63, 187, 661, 1837,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +a(n-2) +10*a(n-3) +13*a(n-4) -7*a(n-6) -6*a(n-7) -11*a(n-8) -6*a(n-9) -4*a(n-10) -2*a(n-11) for n>16
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 11 2018 12:30:44, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + a(n-2) + 10\,a(n-3) + 13\,a(n-4) - 7\,a(n-6) - 6\,a(n-7) - 11\,a(n-8) - 6\,a(n-9) - 4\,a(n-10) - 2\,a(n-11)
\end{equation}
for all $n>16$.
...
$o=1n_0+0-2$. Then for $j\ge11$,
\[
a(n_0+j)-\sum_i c_i\,a(n_0+j-i)\;=\;\,\mathbf{v}^{\!\top}G^{\,j-11}w,
\qquad w=h_{11}-\sum_i c_i\,h_{11-i} .
\]
...
\begin{proof}
Substitute Lemma~\ref{lem:walk} and factor $G^{j-11}$ out of
...
the middle column. The vector $w$ was formed by $11$ applications of $G$ in exact integer
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302683.
