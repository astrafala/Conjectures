...
\title{The empirical recurrence for OEIS A204490, proved by transfer matrix}
...
\begin{abstract}
OEIS A204490 counts $(n+2)\times8$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A204490 is ``Number of (n+2)X8 0..1 arrays with every 3X3 subblock having three equal elements in a row horizontally, vertically or nw-to-se diagonally exactly one way, and new values 0..1 introduced in row major order.''. It has offset $1$ and begins
\[
12809, 12861, 23851, 44712, 85756, 169432, 331723, 640841,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 11:15:42, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + a(n-2) + 9\,a(n-3) - 5\,a(n-4) - 10\,a(n-5) - 7\,a(n-6) - 28\,a(n-7) + 16\,a(n-8) - 9\,a(n-9) + 40\,a(n-10) + 5\,a(n-11) + 2\,a(n-12) + 16\,a(n-13) - 19\,a(n-14) + 10\,a(n-15) - 20\,a(n-16) + 3\,a(n-17) - 2\,a(n-18) - 5\,a(n-19) + 4\,a(n-20) - 2\,a(n-21) + a(n-22)
\]
for every $n>33$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204490.
