...
\title{The empirical recurrence for OEIS A300349, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A300349 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A300349 is ``Number of n X 7 0..1 arrays with every element equal to 1 or 2 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
8, 223, 306, 729, 1496, 3092, 5451, 12038,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 5*a(n-1) -8*a(n-2) +4*a(n-3) +a(n-8) -3*a(n-9) +4*a(n-10) -2*a(n-11) +a(n-12) -a(n-13) -a(n-18) +a(n-19) for n>25.
\end{quote}
As of the ``Last modified'' line on the live entry (May 02 2023 15:21:13, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) - 8\,a(n-2) + 4\,a(n-3) + a(n-8) - 3\,a(n-9) + 4\,a(n-10) - 2\,a(n-11) + a(n-12) - a(n-13) - a(n-18) + a(n-19)
\end{equation}
for all $n>25$.
...
publishes, $n=27$, the arrays have $7\cdot27$ cells over
$2$ values, so there are about $10^{56}$ of them to sift. The
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A300349.
