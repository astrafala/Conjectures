...
\title{The empirical recurrence for OEIS A207781, proved by transfer matrix}
...
\begin{abstract}
OEIS A207781 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
...
OEIS A207781 is ``Number of nX4 0..1 arrays avoiding 0 0 0 and 0 1 1 horizontally and 0 0 0 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
9, 81, 257, 791, 2200, 6418, 19041,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:18:30, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 16\,a(n-3) + 6\,a(n-4) + 6\,a(n-5) - 50\,a(n-6) - 40\,a(n-7) - 3\,a(n-8) + 56\,a(n-9) + 25\,a(n-10) - 10\,a(n-11) - 25\,a(n-12) + 38\,a(n-13) - 16\,a(n-14) - 19\,a(n-15) + 12\,a(n-16) + 25\,a(n-17) + 3\,a(n-18) - 10\,a(n-19) - 8\,a(n-20) + 13\,a(n-21) - 4\,a(n-22) - 11\,a(n-23) + a(n-24) + 5\,a(n-25) - 2\,a(n-27)
\end{equation}
for all $n>31$. 
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207781.
