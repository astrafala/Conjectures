...
\title{The empirical recurrence for OEIS A252265, proved by transfer matrix}
...
\begin{abstract}
OEIS A252265 counts $(n+2)\times6$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
$a(n)$ is a walk count on $S=23626$ vertices. Such a sequence is $C$-finite, so whether a given
...
OEIS A252265 is ``Number of (n+2)X(4+2) 0..3 arrays with every 3X3 subblock row, column, diagonal and antidiagonal sum not equal to 2 3 4 6 or 7.''. It has offset $1$ and begins
\[
598, 2290, 10302, 44612, 188690, 800946, 3410622, 14539062,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 10:59:35, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252265.
