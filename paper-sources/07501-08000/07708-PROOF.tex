...
\title{The empirical recurrence for OEIS A207545, proved by transfer matrix}
...
\begin{abstract}
OEIS A207545 counts arrays of width $3$ over $\{0,1,2\}$ containing no occurrence of certain short
...
OEIS A207545 is ``Number of nX3 0..2 arrays avoiding the pattern z-2 z-1 z in any row, column, nw-to-se diagonal or ne-to-sw antidiagonal.''. It has offset $1$ and begins
\[
26, 676, 14974, 327899, 7104784, 153718531, 3323115736, 71828785449,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:03:13, revision 11) this is still
...
\begin{theorem}
\[
a(n)\;=\;25\,a(n-1) - 14\,a(n-2) - 1439\,a(n-3) + 2416\,a(n-4) + 24494\,a(n-5) - 42148\,a(n-6) - 155315\,a(n-7) + 298717\,a(n-8) + 465648\,a(n-9) - 796742\,a(n-10) - 772730\,a(n-11) - 248746\,a(n-12) + 448619\,a(n-13) + 4500187\,a(n-14) + 1535833\,a(n-15) - 6305900\,a(n-16) - 2969844\,a(n-17) + 2515810\,a(n-18) + 1396963\,a(n-19) + 20165\,a(n-20) + 11517\,a(n-21) - 177480\,a(n-22) - 113665\,a(n-23) + 8548\,a(n-24) + 5517\,a(n-25) + 252\,a(n-26)
\]
for every $n>25$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207545.
