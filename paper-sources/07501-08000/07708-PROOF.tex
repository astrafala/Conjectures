...
\title{The empirical recurrence for OEIS A264425, proved by transfer matrix}
...
\begin{abstract}
OEIS A264425 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=5$ columns in which
...
OEIS A264425 is ``Number of (4+1)X(n+1) arrays of permutations of 0..n*5+4 with each element having directed index change 0,1 2,2 1,0 -1,2 -2,-1 or -1,-1.''. It has offset $1$ and begins
\[
1, 85, 529, 7311, 101862, 1103666, 13805196, 169633649,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 12 2015 23:03:54, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 66\,a(n-2) + 767\,a(n-3) + 1772\,a(n-4) - 5737\,a(n-5) - 60500\,a(n-6) - 147478\,a(n-7) + 248837\,a(n-8) + 915581\,a(n-9) - 595548\,a(n-10) + 1256272\,a(n-11) + 6424752\,a(n-12) + 2523024\,a(n-13) + 20229024\,a(n-14) + 12822912\,a(n-15) - 24975872\,a(n-16)
\]
for every $n>18$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264425.
