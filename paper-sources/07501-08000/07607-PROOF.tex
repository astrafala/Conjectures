...
\title{The empirical recurrence for OEIS A207404, proved by transfer matrix}
...
\begin{abstract}
OEIS A207404 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
...
OEIS A207404 is ``Number of 4Xn 0..1 arrays avoiding 0 0 1 and 0 1 1 horizontally and 0 0 1 and 1 1 0 vertically.''. It has offset
$1$ and begins
\[
8, 64, 216, 729, 1782, 4356, 8910,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 13:51:31, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207404.
