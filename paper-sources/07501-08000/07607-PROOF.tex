...
\title{The empirical recurrence for OEIS A207886, proved by transfer matrix}
...
\begin{abstract}
OEIS A207886 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
$(0,1,1), (1,1,0)$ along one axis and $(0,0,0), (1,0,1)$ along the other, and carries an empirical recurrence of
order $15$ contributed by R.~H.~Hardin. It is true. The patterns have length $3$, so
...
$\mathbf{1}^{\!\top}P^{\,n-2-15}q(P)\mathbf{1}$, which vanishes identically
...
OEIS A207886 is ``Number of 4Xn 0..1 arrays avoiding 0 0 0 and 1 0 1 horizontally and 0 1 1 and 1 1 0 vertically.''. It has offset
$1$ and begins
\[
9, 81, 177, 575, 1360, 3106, 8652,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:24:17, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + a(n-2) + 11\,a(n-3) - 2\,a(n-4) - 7\,a(n-5) - 31\,a(n-6) + a(n-7) + 6\,a(n-8) + 39\,a(n-9) - 4\,a(n-10) + 7\,a(n-11) - 24\,a(n-12) - a(n-13) - 6\,a(n-14) + 6\,a(n-15)
\end{equation}
...
$a(n)-\sum_i c_i a(n-i)=u_{\,n-2-15}$ whenever $n-15\ge2$. Hence
\eqref{eq:conj} holds for every $n>t$ exactly when $u_j=0$ for every
$j>t-2-15$. Moreover $(u_j)$ satisfies the monic linear recurrence whose
...
$P^{\,n-2-15}$ gives the identity. The equivalence follows by letting the exponent
...
\begin{proof}
The vector $q(P)\mathbf{1}\in\mathbb{Z}^{S}$ was formed by $15$ matrix--vector
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207886.
