...
\title{The empirical recurrence for OEIS A231972, proved by transfer matrix}
...
\begin{abstract}
OEIS A231972 counts $(n+1)\times4$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A231972 is ``Number of (n+1)X(3+1) 0..1 arrays with no element having a strict majority of its horizontal and vertical neighbors equal to one.''. It has offset $1$ and begins
\[
36, 169, 841, 4489, 24964, 136900, 741321, 4024036,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 06:45:49, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 8\,a(n-2) + 36\,a(n-3) + 90\,a(n-4) + 170\,a(n-5) + 66\,a(n-6) - 303\,a(n-7) - 268\,a(n-8) + 124\,a(n-9) + 40\,a(n-10) - 200\,a(n-11) - 184\,a(n-12) - 96\,a(n-13) + 57\,a(n-14) + 146\,a(n-15) + 36\,a(n-16) - 4\,a(n-17) + 22\,a(n-18) - 10\,a(n-19) + 6\,a(n-20) - a(n-21)
\]
for every $n>21$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231972.
