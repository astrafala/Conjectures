...
\title{The empirical recurrence for OEIS A208003, proved by transfer matrix}
...
\begin{abstract}
OEIS A208003 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
...
OEIS A208003 is ``Number of n X 4 0..1 arrays avoiding 0 0 1 and 1 0 0 horizontally and 0 1 1 and 1 1 0 vertically.''. It has offset
$1$ and begins
\[
9, 81, 221, 536, 1711, 4993, 16742,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 6*a(n-1) - 3*a(n-2) - 36*a(n-3) + 54*a(n-4) + 24*a(n-5) - 69*a(n-6) + 12*a(n-7) + 19*a(n-8) - 6*a(n-9) for n>10.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 26 2018 11:00:44, revision
8) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) - 3\,a(n-2) - 36\,a(n-3) + 54\,a(n-4) + 24\,a(n-5) - 69\,a(n-6) + 12\,a(n-7) + 19\,a(n-8) - 6\,a(n-9)
\end{equation}
for all $n>10$. 
...
$(0,0,1), (1,0,0)$ as $3$ consecutive entries. There are $9$ admissible rows; that condition
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208003.
