...
\title{The empirical recurrence for OEIS A210294, proved by transfer matrix}
...
\begin{abstract}
OEIS A210294 counts $(n+1)\times3$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A210294 is ``Half the number of (n+1)X3 0..3 arrays with every 2X2 subblock having at most one duplicate clockwise edge difference.''. It has offset $1$ and begins
\[
1578, 78628, 3913002, 194768054, 9694276684, 482519042626, 24016699289368, 1195397128587610,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 15:52:18, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;44\,a(n-1) + 330\,a(n-2) - 1940\,a(n-3) - 9738\,a(n-4) + 33341\,a(n-5) + 57999\,a(n-6) - 257279\,a(n-7) + 188734\,a(n-8) + 117676\,a(n-9) - 161670\,a(n-10) + 4796\,a(n-11) + 34416\,a(n-12) - 4912\,a(n-13) - 1536\,a(n-14)
\end{equation}
for all $n>13$.
...
\[
a(n)-\sum_i c_i\,a(n-i)\;=\;\tfrac1{2}\mathbf{1}^{\!\top}M^{\,n+1-1-14}\,q(M)\,\mathbf{1} .
\]
...
=\tfrac1{2}\mathbf{1}^{\!\top}M^{\,m-14}\,q(M)\,\mathbf{1}
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A210294.
