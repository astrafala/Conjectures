...
\title{The empirical recurrence for OEIS A208412, proved by transfer matrix}
...
\begin{abstract}
OEIS A208412 counts $5\times n$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A208412 is ``Number of 5Xn 0..3 arrays with new values 0..3 introduced in row major order and no element equal to more than two of its immediate leftward or upward or right-upward antidiagonal neighbors.''. It has offset $1$ and begins
\[
51, 43947, 42012698, 40595679634, 39216100214432, 37884515848419250, 36598079445605633928, 35355330691346872093058,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:49:50, revision 9) this is still
...
$\{0,\dots,3\}^{5}$. The neighbourhood of a cell in column $u_i$ meets $u_{i-1}$,
...
\begin{theorem}
\[
a(n)\;=\;846\,a(n-1) + 113055\,a(n-2) + 2929874\,a(n-3) - 109060673\,a(n-4) - 3622824692\,a(n-5) + 65097142029\,a(n-6) + 1105024278376\,a(n-7) - 27292434557458\,a(n-8) + 142062088508752\,a(n-9) + 377948844669748\,a(n-10) - 4808916389539500\,a(n-11) + 4645157287758163\,a(n-12) + 52333669611524778\,a(n-13) - 120575382680010711\,a(n-14) - 210993332876225106\,a(n-15) + 842794866719196543\,a(n-16) + 23751649411434324\,a(n-17) - 2346267769038080739\,a(n-18) + 1537588828184004828\,a(n-19) + 2261528701157029077\,a(n-20) - 2074597977196235322\,a(n-21) - 1044955823075183619\,a(n-22) + 1037909226733865982\,a(n-23) + 266013779180313879\,a(n-24) - 226004933703781188\,a(n-25) - 35288827553849769\,a(n-26) + 20872926611932608\,a(n-27) + 1881175972889916\,a(n-28) - 620089737873840\,a(n-29)
\]
for every $n>32$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208412.
