...
\title{The empirical recurrence for OEIS A238317, proved by transfer matrix}
...
\begin{abstract}
OEIS A238317 counts $(n+1)\times3$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A238317 is ``Number of (n+1)X(2+1) 0..2 arrays with no element greater than all horizontal neighbors or less than all vertical neighbors.''. It has offset $1$ and begins
\[
9, 67, 376, 1867, 9489, 50232, 267174, 1408341,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 10:51:37, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) - 12\,a(n-2) + 39\,a(n-3) + 6\,a(n-4) + 62\,a(n-5) + 49\,a(n-6) + 33\,a(n-7) - 32\,a(n-8) - 41\,a(n-9) - 12\,a(n-10) + 6\,a(n-11) + 5\,a(n-12) + a(n-13)
\]
for every $n>13$.
\end{theorem}
...
By Lemma~\ref{lem:crit} the recurrence holds for every $n>13$.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A238317.
