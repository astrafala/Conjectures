...
\title{The empirical recurrence for OEIS A253838, proved by transfer matrix}
...
\begin{abstract}
OEIS A253838 counts the arrays over $\{0,\dots,1\}$ whose $3\times3$ subblocks carry a
...
OEIS A253838 is ``Number of (n+2)X(5+2) 0..1 arrays with every 3X3 subblock diagonal sum plus antidiagonal sum nondecreasing horizontally, vertically and ne-to-sw antidiagonally.''. It has offset $1$ and begins
\[
91296, 127376, 294870, 550535, 156876, 209862, 168884, 85994,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 14:17:01, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253838.
