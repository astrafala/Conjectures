...
\title{The empirical recurrence for OEIS A234685, proved by transfer matrix}
...
\begin{abstract}
OEIS A234685 counts $4$-column arrays over $\{0,\dots,6\}$ in which every
...
OEIS A234685 is ``Number of (n+1) X (3+1) 0..6 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 5 (constant-stress 1 X 1 tilings).''. It has offset
$1$ and begins
\[
5472, 16580, 49480, 174320, 603480, 2377712, 9134920,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 19 2022 01:08:39, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234685.
