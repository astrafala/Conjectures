...
\title{The empirical recurrence for OEIS A236014, proved by transfer matrix}
...
\begin{abstract}
OEIS A236014 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
The condition is local to two consecutive rows, so the count is a walk count on $S=4672$
...
OEIS A236014 is ``Number of (n+1)X(4+1) 0..2 arrays colored with the sum of the maximum and minimum values of each 2X2 subblock.''. It has offset $1$ and begins
\[
4672, 12544, 34288, 95848, 267424, 771564, 2218212, 6382872,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 09:00:36, revision 6) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The $2\times2$ subblocks of an $(n+1)\times5$ array form an
$n\times4$ grid. Colour each of them by $\sigma=a+d$, where $a\le b\le c\le d$ are its four entries sorted --- its minimum, lower median, upper median and maximum. ``Coloured with'' is the entry's way of
...
\]
over the $S=4672$ pairs whose own subblock row is properly coloured.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A236014.
