...
\title{The empirical recurrence for OEIS A255022, proved by transfer matrix}
...
\begin{abstract}
OEIS A255022 counts $(n+2)\times5$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A255022 is ``Number of (n+2)X(3+2) 0..1 arrays with no 3x3 subblock diagonal sum 0 or 1 and no antidiagonal sum 0 or 1 and no row sum 0 or 1 and no column sum 0 or 1.''. It has offset $1$ and begins
\[
117, 405, 1489, 5077, 17447, 60237, 206739, 711741,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:35:57, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + a(n-2) + 12\,a(n-3) + 32\,a(n-4) + 44\,a(n-5) + 37\,a(n-6) - 32\,a(n-7) - 81\,a(n-8) - 12\,a(n-9) + 47\,a(n-10) + 38\,a(n-11) + 8\,a(n-12) - 6\,a(n-13) - 4\,a(n-14) - 4\,a(n-15)
\]
for every $n>17$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A255022.
