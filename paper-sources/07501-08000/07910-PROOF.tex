...
\title{The empirical recurrence for OEIS A282992, proved by transfer matrix}
...
\begin{abstract}
OEIS A282992 counts $n\times4$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
walk, and $a(n)$ is a walk count on $S=111$ vertices, which is $C$-finite. Whether the
...
OEIS A282992 is ``Number of n X 4 0..1 arrays with no 1 equal to more than one of its horizontal and vertical neighbors.''. It has offset $1$ and begins
\[
13, 98, 803, 6547, 53389, 435027, 3546870, 28911809,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 19 2023 19:27:40, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + 27\,a(n-2) + 59\,a(n-3) - 10\,a(n-4) - 134\,a(n-5) + 12\,a(n-6) + 43\,a(n-7) - 55\,a(n-8) + 42\,a(n-9) - 90\,a(n-10) + 58\,a(n-11) - 30\,a(n-12) + 6\,a(n-13) - 2\,a(n-14) + a(n-15)
\]
for every $n>15$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A282992.
