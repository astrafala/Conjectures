...
\title{The empirical recurrence for OEIS A237334, proved by transfer matrix}
...
\begin{abstract}
OEIS A237334 counts arrays over $\{0,\dots,3\}$ subject to a condition on the order
...
The condition is local to two consecutive rows, so the count is a walk count on $S=144$
...
OEIS A237334 is ``Number of (n+1)X(2+1) 0..3 arrays with the maximum minus the minimum of every 2X2 subblock equal.''. It has offset $1$ and begins
\[
1980, 41220, 821234, 17627820, 380945760, 8406402902, 187274820848, 4212082221444,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 10:06:02, revision 6) this is still
...
array, which is not among the objects counted. There are $S=144$ states left.
...
\begin{theorem}
\[
a(n)\;=\;47\,a(n-1) - 506\,a(n-2) - 5350\,a(n-3) + 119418\,a(n-4) - 292491\,a(n-5) - 5769290\,a(n-6) + 38319506\,a(n-7) + 16591825\,a(n-8) - 782193687\,a(n-9) + 1731908806\,a(n-10) + 3853403204\,a(n-11) - 18163240306\,a(n-12) + 6781065371\,a(n-13) + 52909631318\,a(n-14) - 59067161032\,a(n-15) - 56301011344\,a(n-16) + 103756990512\,a(n-17) + 14034541408\,a(n-18) - 73613340160\,a(n-19) + 8403519488\,a(n-20) + 22531661824\,a(n-21) - 3926882304\,a(n-22) - 2687410176\,a(n-23) + 403046400\,a(n-24) + 86507520\,a(n-25)
\]
for every $n>24$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237334.
