...
\title{The empirical recurrence for OEIS A264537, proved by transfer matrix}
...
\begin{abstract}
OEIS A264537 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=5$ columns in which
...
OEIS A264537 is ``Number of (4+1) X (n+1) arrays of permutations of 0..n*5+4 with each element having directed index change -2,-2 -1,0 0,1 or 1,0.''. It has offset $1$ and begins
\[
0, 19, 40, 166, 824, 3256, 15028, 64156,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) + 18*a(n-3) + 120*a(n-5) - 24*a(n-6) + 288*a(n-7) + 256*a(n-10) for n>11.
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 08 2019 18:48:34, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264537.
