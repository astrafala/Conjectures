...
\title{The empirical recurrence for OEIS A238519, proved by transfer matrix}
...
\begin{abstract}
OEIS A238519 counts $(n+1)\times3$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A238519 is ``Number of (n+1) X (2+1) 0..3 arrays with no element equal to all horizontal neighbors or equal to all vertical neighbors.''. It has offset $1$ and begins
\[
588, 9612, 345744, 10332060, 321566028, 9918146448, 306521859084, 9468890997276,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 20 2024 17:19:14, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;21\,a(n-1) + 297\,a(n-2) + 360\,a(n-3) - 2756\,a(n-4) - 2972\,a(n-5) - 3851\,a(n-6) + 31899\,a(n-7) - 15873\,a(n-8) - 11376\,a(n-9) + 11160\,a(n-10) - 5184\,a(n-11) - 3456\,a(n-12)
\]
for every $n>12$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A238519.
