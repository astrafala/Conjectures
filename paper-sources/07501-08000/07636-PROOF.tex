...
\title{The empirical recurrence for OEIS A237212, proved by transfer matrix}
...
\begin{abstract}
OEIS A237212 counts arrays over $\{0,\dots,3\}$ subject to a condition on the order
statistics of every $2\times2$ subblock, and carries an empirical recurrence of order
$27$ contributed by R.~H.~Hardin. It is true, and it is decidable rather than empirical.
The condition is local to two consecutive rows, so the count is a walk count on $S=76$
...
OEIS A237212 is ``Number of (n+1)X(1+1) 0..3 arrays with the maximum plus the upper median minus the lower median minus the minimum of every 2X2 subblock equal.''. It has offset $1$ and begins
\[
256, 1076, 4770, 22420, 107092, 523218, 2580120, 12870804,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 09:58:08, revision 7) this is still
...
array, which is not among the objects counted. There are $S=76$ states left.
...
\begin{theorem}
\[
a(n)\;=\;14\,a(n-1) + 9\,a(n-2) - 935\,a(n-3) + 2584\,a(n-4) + 23459\,a(n-5) - 105654\,a(n-6) - 285952\,a(n-7) + 1921192\,a(n-8) + 1588348\,a(n-9) - 20149416\,a(n-10) + 685072\,a(n-11) + 132759648\,a(n-12) - 66518688\,a(n-13) - 567564352\,a(n-14) + 438496896\,a(n-15) + 1584509184\,a(n-16) - 1476106752\,a(n-17) - 2857446400\,a(n-18) + 2915932160\,a(n-19) + 3232051200\,a(n-20) - 3441262592\,a(n-21) - 2161868800\,a(n-22) + 2339045376\,a(n-23) + 759037952\,a(n-24) - 824180736\,a(n-25) - 103809024\,a(n-26) + 113246208\,a(n-27)
\]
for every $n>26$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237212.
