...
\title{The empirical recurrence for OEIS A246886, proved by transfer matrix}
...
\begin{abstract}
OEIS A246886 carries an empirical recurrence of order $14$ contributed by R.~H.~Hardin. It is
...
OEIS A246886 is ``Number of length n+4 0..2 arrays with some pair in every consecutive five terms totalling exactly 2.''. It has offset $1$ and begins
\[
231, 673, 1961, 5711, 16621, 48393, 140893, 410197,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) +2*a(n-2) +a(n-3) +3*a(n-4) -2*a(n-6) -2*a(n-7) -3*a(n-8) -3*a(n-9) +a(n-11) +a(n-13) +a(n-14)
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 10:14:11, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 2\,a(n-2) + a(n-3) + 3\,a(n-4) - 2\,a(n-6) - 2\,a(n-7) - 3\,a(n-8) - 3\,a(n-9) + a(n-11) + a(n-13) + a(n-14)
\]
for every $n>-3$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A246886.
