...
\title{The empirical recurrence for OEIS A250631, proved by transfer matrix}
...
\begin{abstract}
OEIS A250631 counts arrays over $\{0,1,2\}$ in which a statistic taken over short runs
...
OEIS A250631 is ``Number of (n+1)X(7+1) 0..2 arrays with nondecreasing x(i,j)+x(i,j-1) in the i direction and nondecreasing min(x(i,j),x(i-1,j)) in the j direction.''. It has offset $1$ and begins
\[
101308, 720347, 3951204, 18465586, 75537881, 280151655, 955747123, 3044656152,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 12:37:30, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250631.
