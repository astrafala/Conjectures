...
\title{The empirical recurrence for OEIS A189198, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A189198 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A189198 is ``Number of 5Xn binary arrays without the pattern 0 0 1 vertically or antidiagonally.''. It has offset $1$ and begins
\[
20, 400, 6446, 101628, 1579664, 24496092, 379515360, 5878642448,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 20*a(n-1) -60*a(n-2) -208*a(n-3) +844*a(n-4) +344*a(n-5) -3476*a(n-6) +3544*a(n-7) -1056*a(n-8)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 05:05:38, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;20\,a(n-1) - 60\,a(n-2) - 208\,a(n-3) + 844\,a(n-4) + 344\,a(n-5) - 3476\,a(n-6) + 3544\,a(n-7) - 1056\,a(n-8)
\end{equation}
for all $n>9$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A189198.
