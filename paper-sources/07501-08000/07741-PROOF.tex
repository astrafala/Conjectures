...
\title{The empirical recurrence for OEIS A188741, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A188741 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A188741 is ``Number of nX3 binary arrays without the pattern 1 1 1 diagonally, vertically or antidiagonally.''. It has offset $1$ and begins
\[
8, 64, 292, 1651, 9504, 52072, 289776, 1617326,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 04:48:10, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 9\,a(n-2) + 50\,a(n-3) + 55\,a(n-4) + 37\,a(n-5) - 108\,a(n-6) - 111\,a(n-7) + 89\,a(n-8) + 27\,a(n-9) - 28\,a(n-10) - 5\,a(n-11) - 48\,a(n-12) - 28\,a(n-13) - 17\,a(n-14) - 4\,a(n-15) - a(n-16)
\end{equation}
for all $n>17$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A188741.
