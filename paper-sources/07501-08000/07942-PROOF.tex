...
\title{The empirical recurrence for OEIS A268259, proved by transfer matrix}
...
\begin{abstract}
OEIS A268259 carries an empirical recurrence of order $12$ contributed by R.~H.~Hardin. It is
...
OEIS A268259 is ``Number of length-(n+1) 0..6 arrays with new repeated values introduced in sequential order starting with zero.''. It has offset $1$ and begins
\[
43, 265, 1634, 10082, 62249, 384605, 2377935, 14712729,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 29 2016 12:46:28, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;43\,a(n-1) - 777\,a(n-2) + 7545\,a(n-3) - 41215\,a(n-4) + 115171\,a(n-5) - 81663\,a(n-6) - 274113\,a(n-7) + 244616\,a(n-8) + 557626\,a(n-9) + 307440\,a(n-10) + 67488\,a(n-11) + 5040\,a(n-12)
\]
for every $n>0$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268259.
