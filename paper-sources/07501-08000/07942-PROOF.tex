...
\title{The empirical recurrence for OEIS A234687, proved by transfer matrix}
...
\begin{abstract}
OEIS A234687 carries an empirical recurrence of order $29$ contributed by R. H. Hardin. It is
...
OEIS A234687 is ``Number of (n+1) X (5+1) 0..6 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 5 (constant-stress 1 X 1 tilings).''. It has offset $1$ and begins
\[
131200, 281612, 603480, 1602224, 4224328, 13220576, 40731576, 144171008,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 20 2022 19:53:14, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234687.
