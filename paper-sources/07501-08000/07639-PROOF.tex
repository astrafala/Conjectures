...
\title{The empirical recurrence for OEIS A283694, proved by transfer matrix}
...
\begin{abstract}
OEIS A283694 counts $4\times n$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A283694 is ``Number of 4Xn 0..1 arrays with no 1 equal to more than two of its horizontal, diagonal and antidiagonal neighbors.''. It has offset $1$ and begins
\[
16, 209, 1525, 15226, 149840, 1392868, 13354587, 127784543,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 14 2017 16:19:07, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-1) + 14\,a(n-2) + 82\,a(n-3) - 658\,a(n-4) - 777\,a(n-5) + 1355\,a(n-6) + 5352\,a(n-7) + 4750\,a(n-8) - 10369\,a(n-9) - 8528\,a(n-10) - 2002\,a(n-11) + 1904\,a(n-12) + 11841\,a(n-13) - 569\,a(n-14) - 451\,a(n-15) + 1759\,a(n-16) - 3860\,a(n-17) - 536\,a(n-18) + 645\,a(n-19) + 66\,a(n-20) + 111\,a(n-21) - 40\,a(n-22) - 4\,a(n-23)
\]
for every $n>23$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A283694.
