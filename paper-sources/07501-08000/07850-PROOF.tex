...
\title{The empirical recurrence for OEIS A316949, proved by transfer matrix}
...
\begin{abstract}
OEIS A316949 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A316949 is ``Number of nX4 0..1 arrays with every element unequal to 1, 2, 3, 4, 5, 6 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
2, 98, 1240, 18956, 287292, 4335826, 65510494, 989703110,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 17 2018 12:21:58, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;12\,a(n-1) + 38\,a(n-2) + 130\,a(n-3) + 69\,a(n-4) + 144\,a(n-5) - 193\,a(n-6) - 26\,a(n-7) - 60\,a(n-8) + 166\,a(n-9) - 97\,a(n-10) + 44\,a(n-11) - 44\,a(n-12) + 16\,a(n-13)
\end{equation}
for all $n>13$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A316949.
