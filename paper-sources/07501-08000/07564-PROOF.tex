...
\title{The empirical recurrence for OEIS A207713, proved by transfer matrix}
...
\begin{abstract}
OEIS A207713 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
...
OEIS A207713 is ``Number of nX4 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 0 1 and 1 0 0 vertically.''. It has offset
$1$ and begins
\[
10, 100, 450, 2205, 11970, 66946, 383845,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:12:06, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;8\,a(n-1) + 6\,a(n-2) - 138\,a(n-3) + 52\,a(n-4) + 850\,a(n-5) - 487\,a(n-6) - 2284\,a(n-7) + 1340\,a(n-8) + 2858\,a(n-9) - 1584\,a(n-10) - 1736\,a(n-11) + 885\,a(n-12) + 500\,a(n-13) - 238\,a(n-14) - 60\,a(n-15) + 28\,a(n-16) + 2\,a(n-17) - a(n-18)
\end{equation}
for all $n>19$. 
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207713.
