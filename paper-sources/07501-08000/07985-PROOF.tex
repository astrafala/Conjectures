...
\title{The empirical recurrence for OEIS A204613, proved by transfer matrix}
...
\begin{abstract}
OEIS A204613 counts arrays over $\{0,\dots,1\}$ under a condition on the determinant of every
...
a bounded window of consecutive rows, so the count is a walk count on $S=907$ states and is
...
OEIS A204613 is ``Number of (n+1) X 6 0..1 arrays with the determinants of 2 X 2 subblocks nondecreasing rightwards and downwards.''. It has offset $1$ and begins
\[
907, 14199, 205117, 3084029, 45645661, 681254361, 10133992449, 150976448169,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 01 2024 19:47:38, revision 7) this is still
...
entry's first term is $907$, and the model reproduces it along with every later term; that
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204613.
