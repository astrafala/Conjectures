...
\title{The empirical recurrence for OEIS A297501, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297501 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A297501 is ``Number of nX3 0..1 arrays with every 1 horizontally, diagonally or antidiagonally adjacent to 1 or 2 neighboring 1s.''. It has offset $1$ and begins
\[
4, 31, 110, 531, 2534, 11405, 53175, 246040,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +5*a(n-2) +37*a(n-3) +63*a(n-4) +101*a(n-5) -45*a(n-6) -198*a(n-7) -254*a(n-8) -40*a(n-9) +88*a(n-10) +96*a(n-11)
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 31 2017 07:24:39, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 5\,a(n-2) + 37\,a(n-3) + 63\,a(n-4) + 101\,a(n-5) - 45\,a(n-6) - 198\,a(n-7) - 254\,a(n-8) - 40\,a(n-9) + 88\,a(n-10) + 96\,a(n-11)
\end{equation}
for all $n>12$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297501.
