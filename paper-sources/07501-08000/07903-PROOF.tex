...
\title{The empirical recurrence for OEIS A251840, proved by transfer matrix}
...
\begin{abstract}
OEIS A251840 counts $(n+2)\times5$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A251840 is ``Number of (n+2)X(3+2) 0..3 arrays with every 3X3 subblock row and column sum nonprime and every diagonal and antidiagonal sum prime.''. It has offset $1$ and begins
\[
641, 828, 1803, 2890, 8582, 21748, 40492, 128431,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:30:00, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;32\,a(n-3) - 310\,a(n-6) + 1096\,a(n-9) - 1790\,a(n-12) + 1558\,a(n-15) - 803\,a(n-18) + 238\,a(n-21) - 20\,a(n-24)
\]
for every $n>33$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251840.
