...
\title{The empirical recurrence for OEIS A250628, proved by transfer matrix}
...
\begin{abstract}
OEIS A250628 counts arrays over $\{0,1,2\}$ in which a statistic taken over short runs
...
OEIS A250628 is ``Number of (n+1)X(4+1) 0..2 arrays with nondecreasing x(i,j)+x(i,j-1) in the i direction and nondecreasing min(x(i,j),x(i-1,j)) in the j direction.''. It has offset $1$ and begins
\[
2183, 12360, 56232, 218680, 747039, 2290189, 6421141, 16675794,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 12:37:09, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;9\,a(n-1) - 30\,a(n-2) + 30\,a(n-3) + 75\,a(n-4) - 243\,a(n-5) + 152\,a(n-6) + 360\,a(n-7) - 690\,a(n-8) + 130\,a(n-9) + 780\,a(n-10) - 780\,a(n-11) - 130\,a(n-12) + 690\,a(n-13) - 360\,a(n-14) - 152\,a(n-15) + 243\,a(n-16) - 75\,a(n-17) - 30\,a(n-18) + 30\,a(n-19) - 9\,a(n-20) + a(n-21)
\]
for every $n>24$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250628.
