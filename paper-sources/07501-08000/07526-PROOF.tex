...
\title{The empirical recurrence for OEIS A208411, proved by transfer matrix}
...
\begin{abstract}
OEIS A208411 counts $4\times n$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A208411 is ``Number of 4 X n 0..3 arrays with new values 0..3 introduced in row major order and no element equal to more than two of its immediate leftward or upward or right-upward antidiagonal neighbors.''. It has offset $1$ and begins
\[
15, 2795, 667478, 163422914, 40039156736, 9810325806914, 2403711876698218, 588954110860577394,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 31 2023 15:40:23, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;226\,a(n-1) + 4747\,a(n-2) - 18294\,a(n-3) - 739509\,a(n-4) - 1661510\,a(n-5) + 17227605\,a(n-6) + 10151090\,a(n-7) - 98711047\,a(n-8) - 11588022\,a(n-9) + 195980121\,a(n-10) - 44074854\,a(n-11) - 121060656\,a(n-12) + 71173728\,a(n-13) - 10077696\,a(n-14)
\]
for every $n>16$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208411.
