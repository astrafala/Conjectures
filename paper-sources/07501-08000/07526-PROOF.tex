...
\title{The empirical recurrence for OEIS A250465, proved by transfer matrix}
...
\begin{abstract}
OEIS A250465 counts arrays over $\{0,1\}$ in which a statistic taken over short runs
...
OEIS A250465 is ``Number of (n+1)X(5+1) 0..1 arrays with nondecreasing min(x(i,j),x(i,j-1)) in the i direction and nondecreasing min(x(i,j),x(i-1,j)) in the j direction.''. It has offset $1$ and begins
\[
637, 9651, 135753, 1920345, 27076065, 381830463, 5383012776, 75892576784,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 12:26:54, revision 6) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The array has $6$ cells across and entries $x(i,j)\in\{0,1\}$.
...
So a single row is a state. Let $M$ be the matrix on the $2^{6}=64$ rows with
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-1) + 130\,a(n-2) - 189\,a(n-3) - 3667\,a(n-4) + 2558\,a(n-5) + 42988\,a(n-6) - 25070\,a(n-7) - 256657\,a(n-8) + 157899\,a(n-9) + 853784\,a(n-10) - 581133\,a(n-11) - 1642795\,a(n-12) + 1229304\,a(n-13) + 1838322\,a(n-14) - 1487824\,a(n-15) - 1178648\,a(n-16) + 1019200\,a(n-17) + 418640\,a(n-18) - 384000\,a(n-19) - 79200\,a(n-20) + 76288\,a(n-21) + 7360\,a(n-22) - 7296\,a(n-23) - 256\,a(n-24) + 256\,a(n-25)
\]
for every $n>24$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250465.
