...
\title{The empirical recurrence for OEIS A241612, proved by transfer matrix}
...
\begin{abstract}
OEIS A241612 carries an empirical recurrence of order $28$ contributed by R.~H.~Hardin. It is
...
OEIS A241612 is ``Number of length n+2 0..6 arrays with no consecutive three elements summing to more than 6.''. It has offset $1$ and begins
\[
84, 336, 1344, 5040, 19374, 75180, 289248, 1113348,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 10:10:28, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + a(n-2) + 16\,a(n-3) - 20\,a(n-4) - 18\,a(n-5) - 65\,a(n-6) + 65\,a(n-7) + 41\,a(n-8) + 132\,a(n-9) - 130\,a(n-10) - 49\,a(n-11) - 144\,a(n-12) + 153\,a(n-13) + 31\,a(n-14) + 113\,a(n-15) - 115\,a(n-16) - 11\,a(n-17) - 60\,a(n-18) + 55\,a(n-19) + 4\,a(n-20) + 23\,a(n-21) - 21\,a(n-22) - a(n-23) - 5\,a(n-24) + 4\,a(n-25) + a(n-27) - a(n-28)
\]
for every $n>30$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A241612.
