...
\title{The empirical recurrence for OEIS A304305, proved by transfer matrix}
...
\begin{abstract}
OEIS A304305 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A304305 is ``Number of n X 3 0..1 arrays with every element unequal to 0, 1, 2, 3 or 5 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
4, 23, 77, 261, 918, 3270, 11739, 42286,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 27 2023 21:25:00, revision
6) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) + a(n-2) - 6\,a(n-3) - 11\,a(n-4) + 2\,a(n-5) + 14\,a(n-6) - 6\,a(n-7) - 7\,a(n-8) + 15\,a(n-9) + 22\,a(n-10) - 6\,a(n-11) - 7\,a(n-12) + a(n-13) + 3\,a(n-14) - 10\,a(n-15) - 8\,a(n-16)
\end{equation}
for all $n>16$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A304305.
