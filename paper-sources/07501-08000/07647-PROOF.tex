...
\title{The empirical recurrence for OEIS A297610, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297610 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
values of its neighbours, and carries an empirical recurrence of order $34$ contributed
...
OEIS A297610 is ``Number of 4Xn 0..1 arrays with every 1 horizontally, diagonally or antidiagonally adjacent to 0, 1 or 3 neighboring 1s.''. It has offset $1$ and begins
\[
16, 106, 953, 6413, 49198, 368007, 2781983, 20760904,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 01 2018 14:55:40, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 23\,a(n-2) + 72\,a(n-3) + 429\,a(n-4) + 561\,a(n-5) - 800\,a(n-6) - 197\,a(n-7) - 3464\,a(n-8) - 3732\,a(n-9) + 16662\,a(n-10) - 9202\,a(n-11) - 60068\,a(n-12) + 49640\,a(n-13) + 96401\,a(n-14) - 135437\,a(n-15) - 55052\,a(n-16) + 244878\,a(n-17) + 36\,a(n-18) - 292197\,a(n-19) + 155850\,a(n-20) + 404250\,a(n-21) - 152837\,a(n-22) - 453526\,a(n-23) - 102914\,a(n-24) + 219408\,a(n-25) + 94484\,a(n-26) - 19094\,a(n-27) - 35125\,a(n-28) - 17407\,a(n-29) + 3583\,a(n-30) + 4202\,a(n-31) + 1102\,a(n-32) + 108\,a(n-33) - 64\,a(n-34)
\end{equation}
for all $n>35$.
...
x_{t,u}=1\ \Rightarrow\ \#\{\text{neighbours equal to }1\}\in\{0,1,3\}
\end{equation}
for every cell $(t,u)$.
...
$o=1n_0+0-2$. Then for $j\ge34$,
\[
a(n_0+j)-\sum_i c_i\,a(n_0+j-i)\;=\;\,\mathbf{v}^{\!\top}G^{\,j-34}w,
...
\begin{proof}
Substitute Lemma~\ref{lem:walk} and factor $G^{j-34}$ out of
...
the middle column. The vector $w$ was formed by $34$ applications of $G$ in exact integer
arithmetic and $\mathbf{v}^{\!\top}G^{m}w$ evaluated for $m=0,1,\dots$, again exactly.
Every one of those integers vanishes from the index corresponding to $n=35+1$ onwards,
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297610.
