...
\title{The empirical recurrence for OEIS A299670, proved by transfer matrix}
...
\begin{abstract}
OEIS A299670 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $equal to$ itself lying in $\{0,1,2,3,5,6,7\}$, and it carries an empirical
...
OEIS A299670 is ``Number of nX3 0..1 arrays with every element equal to 0, 1, 2, 3, 5, 6 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
4, 26, 94, 372, 1512, 6133, 24742, 100035,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 16 2018 07:22:30, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) - 3\,a(n-2) - 12\,a(n-4) - 15\,a(n-5) + 20\,a(n-6) + 17\,a(n-7) + 32\,a(n-8) - 64\,a(n-9) - 5\,a(n-10) + 25\,a(n-11) + 77\,a(n-12) + 11\,a(n-13) - 27\,a(n-14) - 21\,a(n-15) - 14\,a(n-16) - 13\,a(n-17) - 4\,a(n-18)
\end{equation}
for all $n>19$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A299670.
