...
\title{The empirical recurrence for OEIS A206536, proved by transfer matrix}
...
\begin{abstract}
OEIS A206536 counts arrays of width $3$ over $\{0,1,2\}$ subject to a condition read round the
...
count is a walk count on a finite digraph with $S=142$ vertices, and whether a linear
...
OEIS A206536 is ``Number of (n+1) X 3 0..2 arrays with the number of clockwise edge increases in 2 X 2 subblocks nondecreasing, and counterclockwise edge increases nonincreasing, rightwards and downwards.''. It has offset $1$ and begins
\[
399, 2577, 14781, 91674, 594348, 3902463, 25900263, 172835859,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 13 2015 16:31:27, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;14\,a(n-1) - 49\,a(n-2) - 96\,a(n-3) + 814\,a(n-4) - 820\,a(n-5) - 2734\,a(n-6) + 5904\,a(n-7) + 127\,a(n-8) - 8794\,a(n-9) + 6847\,a(n-10) - 336\,a(n-11) - 1164\,a(n-12) + 288\,a(n-13)
\]
for every $n>17$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206536.
