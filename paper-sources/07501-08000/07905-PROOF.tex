...
\title{The empirical recurrence for OEIS A183338, proved by transfer matrix}
...
\begin{abstract}
OEIS A183338 counts arrays of width $6$ over $\{0,1\}$ under local conditions relating each cell
...
OEIS A183338 is ``Number of n X 6 binary arrays with each 1 adjacent to exactly one 1 vertically and one 1 horizontally.''. It has offset $1$ and begins
\[
1, 9, 23, 51, 175, 513, 1397, 4133,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 28 2018 08:13:55, revision 12) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A183338.
