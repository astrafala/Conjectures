...
\title{The empirical recurrence for OEIS A235020, proved by transfer matrix}
...
\begin{abstract}
OEIS A235020 counts $3$-column arrays over $\{0,\dots,5\}$ in which every
...
OEIS A235020 is ``Number of (n+1) X (2+1) 0..5 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 3, with no adjacent elements equal (constant-stress tilted 1 X 1 tilings).''. It has offset
$1$ and begins
\[
332, 1200, 4312, 15572, 56276, 203768, 738516,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 20 2022 00:27:55, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) + 40\,a(n-2) - 213\,a(n-3) - 616\,a(n-4) + 3529\,a(n-5) + 4898\,a(n-6) - 29657\,a(n-7) - 24043\,a(n-8) + 140862\,a(n-9) + 80302\,a(n-10) - 394226\,a(n-11) - 183852\,a(n-12) + 650340\,a(n-13) + 268328\,a(n-14) - 614608\,a(n-15) - 222048\,a(n-16) + 318656\,a(n-17) + 91776\,a(n-18) - 82432\,a(n-19) - 14336\,a(n-20) + 8192\,a(n-21)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A235020.
