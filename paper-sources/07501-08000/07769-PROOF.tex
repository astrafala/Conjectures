...
\title{A local condition on an array: OEIS A202415}
...
\begin{abstract}
OEIS A202415 carries an empirical recurrence of order $13$ contributed by R.~H.~Hardin. It is
...
walks in it. Hence $a(n)$ is a walk count on $S=18$ vertices and is $C$-finite, and whether the
...
OEIS A202415 is ``Number of (n+2)X4 binary arrays with no more than one of any consecutive three bits set in any row or column.''. It has offset $1$ and begins
\[
94, 356, 1369, 5167, 19569, 74358, 281925, 1068716,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 09:34:29, revision 9) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{The count is a walk count}

The entry counts arrays with $4$ columns over the alphabet $\{0,1\}$, growing one row at a time, and asks that no $3$ consecutive entries, taken along a row or down a column, may contain more than $1$ ones.
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 3\,a(n-2) + 21\,a(n-3) + 29\,a(n-4) + 12\,a(n-5) - 21\,a(n-6) - 53\,a(n-7) - 41\,a(n-8) + 5\,a(n-9) + 21\,a(n-10) + 9\,a(n-11) + 4\,a(n-12) + a(n-13)
\]
for every $n>13$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A202415.
