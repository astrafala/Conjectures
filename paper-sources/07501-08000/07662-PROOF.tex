...
\title{The empirical recurrence for OEIS A252612, proved by transfer matrix}
...
\begin{abstract}
OEIS A252612 counts $(n+2)\times7$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
$a(n)$ is a walk count on $S=1912032$ vertices. Such a sequence is $C$-finite, so whether a given
...
OEIS A252612 is ``Number of (n+2)X(5+2) 0..3 arrays with every 3X3 subblock row and diagonal sum equal to 0 3 5 6 or 8 and every 3X3 column and antidiagonal sum not equal to 0 3 5 6 or 8.''. It has offset $1$ and begins
\[
6403, 13879, 58239, 147592, 814008, 4274586, 11003134, 62184813,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:26:51, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;168\,a(n-3) - 8374\,a(n-6) + 137544\,a(n-9) - 1291860\,a(n-12) + 8966234\,a(n-15) - 42372903\,a(n-18) + 111840252\,a(n-21) - 137350852\,a(n-24) + 63180592\,a(n-27) - 3100800\,a(n-30)
\]
for every $n>38$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252612.
