...
\title{The empirical recurrence for OEIS A232371, proved by transfer matrix}
...
\begin{abstract}
OEIS A232371 counts arrays of width $3$ over $\{0,1,2,3\}$ in which every cell carrying one stated
...
OEIS A232371 is ``Number of nX3 0..3 arrays with every 0 next to a 1, every 1 next to a 2 and every 2 next to a 3 horizontally, diagonally or antidiagonally, and no adjacent values equal.''. It has offset $1$ and begins
\[
4, 74, 586, 4550, 36574, 292122, 2324142, 18574882,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 07:21:54, revision 6) this is still
...
adjacency matrix,
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=605.
\]
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + 17\,a(n-2) + 74\,a(n-3) + 170\,a(n-4) + 1012\,a(n-5) + 2868\,a(n-6) + 3592\,a(n-7) + 4816\,a(n-8) + 5356\,a(n-9) + 6245\,a(n-10) + 4504\,a(n-11) + 2633\,a(n-12) + 954\,a(n-13) + 756\,a(n-14) + 216\,a(n-15)
\]
for every $n>14$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232371.
