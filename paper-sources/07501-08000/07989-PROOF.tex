...
\title{The empirical recurrence for OEIS A259246, proved by transfer matrix}
...
\begin{abstract}
OEIS A259246 counts arrays of width $5$ over $\{0,1\}$ subject to a condition read round the
...
OEIS A259246 is ``Number of (n+1)X(4+1) 0..1 arrays with each 2X2 subblock having clockwise pattern 0000 0011 or 0111.''. It has offset $1$ and begins
\[
111, 581, 2816, 14425, 71313, 361728, 1803859, 9106657,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:49:34, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-1) + 12\,a(n-2) - 141\,a(n-3) + 15\,a(n-4) + 798\,a(n-5) - 177\,a(n-6) - 1505\,a(n-7) - 48\,a(n-8) + 375\,a(n-9) - a(n-10) - 6\,a(n-11)
\]
for every $n>11$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A259246.
