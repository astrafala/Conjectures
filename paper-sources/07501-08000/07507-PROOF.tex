...
\title{The empirical recurrence for OEIS A258542, proved by transfer matrix}
...
\begin{abstract}
OEIS A258542 counts arrays of width $7$ over $\{0,1\}$ in which every $3\times3$ window has
...
OEIS A258542 is ``Number of (n+2)X(5+2) 0..1 arrays with no 3x3 subblock diagonal sum less than the antidiagonal sum or central row sum equal to the central column sum.''. It has offset $1$ and begins
\[
25056, 81796, 142544, 367236, 726880, 1784896, 3826716, 9302500,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 15:28:07, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + 13\,a(n-2) - 42\,a(n-3) - 71\,a(n-4) + 255\,a(n-5) + 210\,a(n-6) - 885\,a(n-7) - 355\,a(n-8) + 1950\,a(n-9) + 305\,a(n-10) - 2865\,a(n-11) + 2865\,a(n-13) - 305\,a(n-14) - 1950\,a(n-15) + 355\,a(n-16) + 885\,a(n-17) - 210\,a(n-18) - 255\,a(n-19) + 71\,a(n-20) + 42\,a(n-21) - 13\,a(n-22) - 3\,a(n-23) + a(n-24)
\]
for every $n>27$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A258542.
