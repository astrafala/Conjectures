...
\title{The empirical recurrence for OEIS A255797, proved by transfer matrix}
...
\begin{abstract}
OEIS A255797 counts $(n+2)\times6$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A255797 is ``Number of (n+2) X (4+2) 0..1 arrays with no 3 x 3 subblock diagonal sum 1 and no antidiagonal sum 2 and no row sum 0 and no column sum 3.''. It has offset $1$ and begins
\[
409, 262, 198, 200, 268, 263, 384, 336,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-6) - 2*a(n-12) for n>15.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 20 2018 08:48:52, revision 8) this is still
...
First, the transfer model reproduces all $45$ terms the entry publishes, exactly, in
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A255797.
