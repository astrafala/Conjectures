...
\title{The empirical recurrence for OEIS A237773, proved by transfer matrix}
...
\begin{abstract}
OEIS A237773 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
The condition is local to two consecutive rows, so the count is a walk count on $S=300$
...
OEIS A237773 is ``Number of (n+1)X(2+1) 0..2 arrays with the maximum plus the upper median of every 2X2 subblock differing from its horizontal and vertical neighbors by exactly one.''. It has offset $1$ and begins
\[
300, 1456, 7220, 34738, 168120, 843310, 4176684, 20234876,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 10:26:36, revision 6) this is still
...
differ by $1$. The entry's first term $300$ counts those, and the model was made to
...
\]
over the $S=300$ pairs whose own subblock row already satisfies the condition along itself.
...
\begin{theorem}
\[
a(n)\;=\;16\,a(n-3) + 421\,a(n-4) + 284\,a(n-5) + 499\,a(n-6) + 1042\,a(n-7) - 2558\,a(n-8) + 328\,a(n-9) - 1384\,a(n-10) - 3450\,a(n-11) + 5485\,a(n-12) + 222\,a(n-13) + 384\,a(n-14) - 2174\,a(n-15) + 305\,a(n-16) + 252\,a(n-17) + 36\,a(n-18) + 64\,a(n-19) - 16\,a(n-20)
\]
for every $n>22$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237773.
