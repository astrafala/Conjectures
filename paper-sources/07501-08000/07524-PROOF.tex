...
\title{The empirical recurrence for OEIS A317006, proved by transfer matrix}
...
\begin{abstract}
OEIS A317006 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A317006 is ``Number of nX3 0..1 arrays with every element unequal to 0, 1, 2, 3, 5, 6 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
4, 23, 96, 400, 1704, 7313, 31328, 134118,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 18 2018 19:31:34, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) - 7\,a(n-3) - 27\,a(n-4) - 5\,a(n-5) + 14\,a(n-6) + 78\,a(n-7) + 49\,a(n-8) - 46\,a(n-9) - 81\,a(n-10) + 5\,a(n-11) + 55\,a(n-12) - 2\,a(n-13) - 39\,a(n-14) - 30\,a(n-15) - 8\,a(n-16)
\end{equation}
for all $n>17$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A317006.
