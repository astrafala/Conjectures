...
\title{The empirical recurrence for OEIS A203361, proved by transfer matrix}
...
\begin{abstract}
OEIS A203361 counts arrays of width $7$ over $\{0,1\}$ under local conditions relating each cell
...
OEIS A203361 is ``Number of nX7 binary arrays with every 1 immediately preceded by 0 to the left or above.''. It has offset $1$ and begins
\[
21, 1640, 89610, 5390325, 314688054, 18550312526, 1089970014327, 64114204398028,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 10:22:58, revision 9) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=6301.
\]
...
\begin{theorem}
\[
a(n)\;=\;21\,a(n-1) + 1743\,a(n-2) + 25515\,a(n-3) + 156938\,a(n-4) + 213951\,a(n-5) - 1636533\,a(n-6) - 3128592\,a(n-7) + 23316551\,a(n-8) + 17066544\,a(n-9) - 199519590\,a(n-10) + 291472395\,a(n-11) - 22194350\,a(n-12) - 173766021\,a(n-13) + 129035841\,a(n-14) - 33578772\,a(n-15) - 2885164\,a(n-16) + 4086456\,a(n-17) - 689631\,a(n-18) - 24273\,a(n-19) + 4320\,a(n-20)
\]
for every $n>21$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A203361.
