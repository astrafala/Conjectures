...
\title{The empirical recurrence for OEIS A254256, proved by transfer matrix}
...
\begin{abstract}
OEIS A254256 counts the arrays over $\{0,\dots,1\}$ whose $3\times3$ subblocks carry a
...
OEIS A254256 is ``Number of (n+2)X(4+2) 0..1 arrays with every 3X3 subblock sum of the two maximums of the diagonal and antidiagonal minus the sum of the minimums of the central row and column nondecreasing horizontally, vertically and ne-to-sw antidiagonally.''. It has offset $1$ and begins
\[
54236, 382316, 1420232, 2983064, 9308828, 29231312, 98883824, 378114160,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 14:35:11, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 20\,a(n-2) + 20\,a(n-3) - 104\,a(n-4) - 608\,a(n-5) + 160\,a(n-6) + 1792\,a(n-7) + 5888\,a(n-8) - 5120\,a(n-9) - 8192\,a(n-10) - 18432\,a(n-11) + 24576\,a(n-12)
\]
for every $n>18$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A254256.
