...
\title{The empirical recurrence for OEIS A296330, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A296330 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A296330 is ``Number of n X 3 0..1 arrays with each 1 horizontally, vertically or antidiagonally adjacent to 0 or 2 neighboring 1s.''. It has offset $1$ and begins
\[
5, 19, 64, 230, 816, 2895, 10277, 36480,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) + 4*a(n-2) + 5*a(n-3) + 2*a(n-4) - 2*a(n-5) - 3*a(n-6) - 2*a(n-7) + a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 23 2019 04:21:34, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 4\,a(n-2) + 5\,a(n-3) + 2\,a(n-4) - 2\,a(n-5) - 3\,a(n-6) - 2\,a(n-7) + a(n-9)
\end{equation}
for all $n>10$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A296330.
