...
\title{The empirical recurrence for OEIS A207594, proved by transfer matrix}
...
\begin{abstract}
OEIS A207594 counts arrays over $\{0,\dots,1\}$ of width $7$ that avoid the patterns
...
OEIS A207594 is ``Number of 7Xn 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 0 1 and 1 1 1 vertically.''. It has offset
$1$ and begins
\[
25, 625, 1250, 5000, 18150, 70800, 263550,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:07:01, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;25\,a(n-2) + 2\,a(n-3) - 199\,a(n-4) + 632\,a(n-6) - 30\,a(n-7) - 879\,a(n-8) + 28\,a(n-9) + 548\,a(n-10) - 139\,a(n-12) - 4\,a(n-13) + 10\,a(n-14)
\end{equation}
...
$(0,0,1), (1,1,1)$ as $3$ consecutive entries. There are $25$ admissible columns; that condition
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207594.
