...
\title{The empirical recurrence for OEIS A204602, proved by transfer matrix}
...
\begin{abstract}
OEIS A204602 counts $(n+2)\times5$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A204602 is ``Number of (n+2)X5 0..2 arrays with every 3X3 subblock having three strictly increasing elements in a row horizontally, vertically or nw-to-se diagonally exactly one way.''. It has offset $1$ and begins
\[
328845, 741296, 981914, 5260434, 43980907, 327968423, 2572437376, 19830769591,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 442*a(n-3) +63*a(n-5) +43*a(n-6) -63*a(n-8) +81*a(n-9) -81*a(n-12) for n>20
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 11:20:39, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;442\,a(n-3) + 63\,a(n-5) + 43\,a(n-6) - 63\,a(n-8) + 81\,a(n-9) - 81\,a(n-12)
\]
for every $n>20$.
\end{theorem}
...
at once. By Lemma~\ref{lem:crit} the recurrence holds for every $n>20$.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204602.
