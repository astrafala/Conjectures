...
\title{The empirical recurrence for OEIS A302872, proved by transfer matrix}
...
\begin{abstract}
OEIS A302872 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A302872 is ``Number of nX3 0..1 arrays with every element equal to 0, 1, 3, 4 or 5 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
3, 11, 17, 37, 82, 209, 536, 1549,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 15 2018 10:30:55, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 9\,a(n-3) - 15\,a(n-4) - 5\,a(n-5) - 22\,a(n-6) - 7\,a(n-7) + 9\,a(n-8) - 32\,a(n-9) - 10\,a(n-10) - 16\,a(n-11) - 40\,a(n-12) - 16\,a(n-13)
\end{equation}
for all $n>16$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302872.
