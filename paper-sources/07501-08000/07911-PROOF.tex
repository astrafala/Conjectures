...
\title{The empirical recurrence for OEIS A259638, proved by transfer matrix}
...
\begin{abstract}
OEIS A259638 counts $(n+2)\times6$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A259638 is ``Number of (n+2)X(4+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000000 or 00000001.''. It has offset $1$ and begins
\[
133, 365, 1483, 4146, 12348, 42524, 133078, 406770,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:53:13, revision 6) this is still
...
\[
\text{the clockwise perimeter word of }g\text{ is a rotation of one of }\{00000000,\ 00000001\}
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A259638.
