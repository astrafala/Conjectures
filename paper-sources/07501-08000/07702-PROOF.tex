...
\title{The empirical recurrence for OEIS A234558, proved by transfer matrix}
...
\begin{abstract}
OEIS A234558 counts $3$-column arrays over $\{0,\dots,4\}$ in which every
...
OEIS A234558 is ``Number of (n+1) X (2+1) 0..4 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 4 (constant-stress 1 X 1 tilings).''. It has offset
$1$ and begins
\[
220, 546, 1240, 3384, 8416, 24420, 64240,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 20 2022 19:30:10, revision 6) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234558.
