...
\title{The empirical recurrence for OEIS A254915, proved by transfer matrix}
...
\begin{abstract}
OEIS A254915 counts the arrays over $\{0,\dots,1\}$ whose $3\times3$ subblocks carry a
...
OEIS A254915 is ``Number of (n+2)X(1+2) 0..1 arrays with every 3X3 subblock sum of the two maximums of the central row and central column plus the two minimums of the diagonal and antidiagonal nondecreasing horizontally and vertically.''. It has offset $1$ and begins
\[
512, 2812, 14184, 65548, 294960, 1302500, 5646340, 24197932,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 15:02:47, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A254915.
