...
\title{The empirical recurrence for OEIS A250382, proved by transfer matrix}
...
\begin{abstract}
OEIS A250382 carries an empirical recurrence of order $17$ contributed by R.~H.~Hardin. It is
...
OEIS A250382 is ``Number of length n+3 0..3 arrays with no four consecutive terms having the maximum of any two terms equal to the minimum of the remaining two terms.''. It has offset $1$ and begins
\[
156, 432, 1208, 3384, 9480, 26578, 74528, 208998,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 20 2017 23:29:49, revision 13) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 5\,a(n-2) - 7\,a(n-3) + a(n-4) + 5\,a(n-5) - 48\,a(n-6) + 6\,a(n-7) + 80\,a(n-8) - 37\,a(n-9) - 15\,a(n-10) + 81\,a(n-11) - 34\,a(n-12) - 16\,a(n-13) + 20\,a(n-14) - 26\,a(n-15) - 4\,a(n-16) + 8\,a(n-17)
\]
for every $n>20$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250382.
