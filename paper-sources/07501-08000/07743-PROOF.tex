...
\title{The empirical recurrence for OEIS A231459, proved by transfer matrix}
...
\begin{abstract}
OEIS A231459 counts $(n+1)\times4$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A231459 is ``Number of (n+1)X(3+1) 0..3 arrays with no element unequal to a strict majority of its horizontal, diagonal and antidiagonal neighbors, with values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
14, 38, 100, 272, 741, 2093, 6036, 17569,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 06:31:39, revision 6) this is still
...
$\{0,\dots,3\}^{4}$. The neighbourhood of a cell in row $u_i$ meets $u_{i-1}$,
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-1) - 9\,a(n-2) - 25\,a(n-3) + 25\,a(n-4) + 97\,a(n-5) - 17\,a(n-6) - 113\,a(n-7) - 439\,a(n-8) + 323\,a(n-9) + 944\,a(n-10) - 544\,a(n-11) - 1037\,a(n-12) + 219\,a(n-13) + 1442\,a(n-14) + 1134\,a(n-15) - 1588\,a(n-16) - 3424\,a(n-17) + 2459\,a(n-18) + 3725\,a(n-19) - 4906\,a(n-20) - 2178\,a(n-21) + 4656\,a(n-22) + 60\,a(n-23) - 1844\,a(n-24) + 1914\,a(n-25) + 1068\,a(n-26) - 1242\,a(n-27) - 655\,a(n-28) + 177\,a(n-29) - 12\,a(n-30) - 162\,a(n-31) - 54\,a(n-32)
\]
for every $n>32$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231459.
