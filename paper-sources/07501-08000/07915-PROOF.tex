...
\title{The empirical recurrence for OEIS A233659, proved by transfer matrix}
...
\begin{abstract}
OEIS A233659 counts $(n+1)\times2$ arrays over $\{0,\dots,6\}$ subject to a condition imposed on
...
OEIS A233659 is ``Number of (n+1)X(1+1) 0..6 arrays with every 2X2 subblock having the sum of the squares of the edge differences equal to 26.''. It has offset $1$ and begins
\[
208, 1220, 6656, 37544, 208304, 1166748, 6498312, 36324956,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 08:55:57, revision 7) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;44\,a(n-2) + 30\,a(n-3) - 597\,a(n-4) - 498\,a(n-5) + 3495\,a(n-6) + 2968\,a(n-7) - 9305\,a(n-8) - 7532\,a(n-9) + 10204\,a(n-10) + 7424\,a(n-11) - 3232\,a(n-12) - 1792\,a(n-13)
\end{equation}
for all $n>13$.
...
(\beta-\alpha)^2+(\delta-\beta)^2+(\gamma-\delta)^2+(\alpha-\gamma)^2=26,
\end{equation}
...
\[
a(n)-\sum_i c_i\,a(n-i)\;=\;\mathbf{1}^{\!\top}M^{\,n+1-1-13}\,q(M)\,\mathbf{1} .
\]
...
=\mathbf{1}^{\!\top}M^{\,m-13}\,q(M)\,\mathbf{1}
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A233659.
