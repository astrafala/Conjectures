...
\title{The empirical recurrence for OEIS A255760, proved by transfer matrix}
...
\begin{abstract}
OEIS A255760 counts the arrays over $\{0,\dots,1\}$ whose $3\times3$ subblocks carry a
...
so the count is a walk count on $S=38916$ states --- the last two array rows together with the
...
OEIS A255760 is ``Number of (5+2)X(n+2) 0..1 arrays with every 3X3 subblock sum of the medians of the diagonal and antidiagonal minus the two sums of the central row and column nondecreasing horizontally, vertically and ne-to-sw antidiagonally.''. It has offset $1$ and begins
\[
99200, 86062, 81494, 124928, 196744, 360501, 553072, 962648,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 15:12:25, revision 6) this is still
...
\]
on the $S=38916$ reachable states. In particular $a$ is $C$-finite. The alignment of the walk
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-1) - 28\,a(n-2) + 56\,a(n-3) - 62\,a(n-4) - 8\,a(n-5) + 196\,a(n-6) - 440\,a(n-7) + 543\,a(n-8) - 320\,a(n-9) - 224\,a(n-10) + 832\,a(n-11) - 1112\,a(n-12) + 896\,a(n-13) - 448\,a(n-14) + 128\,a(n-15) - 16\,a(n-16)
\]
for every $n>43$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A255760.
