...
\title{The empirical recurrence for OEIS A300204, proved by transfer matrix}
...
\begin{abstract}
OEIS A300204 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A300204 is ``Number of n X 4 0..1 arrays with every element equal to 0, 1, 2, 3, 4, 5, 6 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
8, 128, 1933, 29561, 451996, 6912249, 105708560, 1616600364,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 18 2026 03:33:26, revision
8) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;15\,a(n-1) + 4\,a(n-2) + 22\,a(n-3) - 200\,a(n-4) - 372\,a(n-5) + 49\,a(n-6) + 405\,a(n-7) + 898\,a(n-8) + 427\,a(n-9) - 28\,a(n-10) - 359\,a(n-11) - 196\,a(n-12) - 30\,a(n-13) + 64\,a(n-14) + 24\,a(n-15)
\end{equation}
for all $n>15$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A300204.
