...
\title{The empirical recurrence for OEIS A234561, proved by transfer matrix}
...
\begin{abstract}
OEIS A234561 counts $6$-column arrays over $\{0,\dots,4\}$ in which every
...
OEIS A234561 is ``Number of (n+1) X (5+1) 0..4 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 4 (constant-stress 1 X 1 tilings).''. It has offset
$1$ and begins
\[
5506, 8416, 12750, 23830, 42982, 94114, 195558,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 20 2022 19:33:02, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) + 30\,a(n-2) - 132\,a(n-3) - 331\,a(n-4) + 1720\,a(n-5) + 1530\,a(n-6) - 11280\,a(n-7) - 1324\,a(n-8) + 39136\,a(n-9) - 12360\,a(n-10) - 67968\,a(n-11) + 39456\,a(n-12) + 46080\,a(n-13) - 34560\,a(n-14)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234561.
