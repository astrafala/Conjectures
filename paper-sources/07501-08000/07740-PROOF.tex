...
\title{The empirical recurrence for OEIS A301821, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A301821 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A301821 is ``Number of nX6 0..1 arrays with every element equal to 1 or 2 horizontally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
5, 50, 278, 1351, 6501, 31061, 147954, 705180,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 27 2018 10:12:20, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;17\,a(n-1) - 130\,a(n-2) + 609\,a(n-3) - 1982\,a(n-4) + 4783\,a(n-5) - 8877\,a(n-6) + 12928\,a(n-7) - 14910\,a(n-8) + 13627\,a(n-9) - 9800\,a(n-10) + 5461\,a(n-11) - 2298\,a(n-12) + 701\,a(n-13) - 145\,a(n-14) + 18\,a(n-15) - a(n-16)
\end{equation}
for all $n>17$.
...
publishes, $n=21$, the arrays have $6\cdot21$ cells over
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A301821.
