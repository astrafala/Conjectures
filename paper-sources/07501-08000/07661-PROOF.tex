...
\title{The empirical recurrence for OEIS A320404, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A320404 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A320404 is ``Number of nX3 0..1 arrays with every element unequal to 0, 1, 2, 4 or 5 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
4, 14, 47, 156, 548, 1970, 7049, 25364,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 12 2018 12:34:59, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) + a(n-2) - 6\,a(n-3) - 7\,a(n-4) - 18\,a(n-5) + 15\,a(n-6) + 23\,a(n-7) + 67\,a(n-8) - 3\,a(n-9) - 72\,a(n-10) - 53\,a(n-11) - 44\,a(n-12) + 47\,a(n-13) + 23\,a(n-14) + 23\,a(n-15) + 37\,a(n-16) - 20\,a(n-17) - 8\,a(n-18) - 12\,a(n-19) - 8\,a(n-20) + 13\,a(n-21) + 2\,a(n-22) - 3\,a(n-23)
\end{equation}
for all $n>25$.
...
\#\{\text{neighbours with a value }different from\ x_{t,u}\}\in\{0,1,2,4,5\}
\end{equation}
...
publishes, $n=24$, the arrays have $3\cdot24$ cells over
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A320404.
