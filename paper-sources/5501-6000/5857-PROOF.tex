...
\title{The empirical recurrence for OEIS A205286, proved by transfer matrix}
...
\begin{abstract}
OEIS A205286 counts arrays over $\{0,\dots,2\}$ under a condition on the permanent of every
...
OEIS A205286 is ``Number of (n+1)X2 0..2 arrays with permanents of 2X2 subblocks differing from horizontal and vertical neighbor permanents.''. It has offset $1$ and begins
\[
81, 476, 2766, 15728, 89630, 511044, 2913944, 16611380,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 11:58:58, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;9\,a(n-2) + 54\,a(n-3) + 283\,a(n-4) + 688\,a(n-5) + 1396\,a(n-6) + 2004\,a(n-7) - 212\,a(n-8) - 4692\,a(n-9) - 13221\,a(n-10) - 22814\,a(n-11) - 14278\,a(n-12) + 4640\,a(n-13) + 31376\,a(n-14) + 58752\,a(n-15) + 41064\,a(n-16) + 7728\,a(n-17)
\]
for every $n>19$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A205286.
