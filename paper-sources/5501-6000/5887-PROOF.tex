...
\title{The empirical recurrence for OEIS A302428, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A302428 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A302428 is ``Number of 3 X n 0..1 arrays with every element equal to 0, 1, 3 or 5 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
4, 6, 11, 21, 38, 88, 188, 377,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 23 2023 07:51:36, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + a(n-2) - a(n-3) + 12\,a(n-4) - 5\,a(n-5) - 7\,a(n-6) + 2\,a(n-7) - 26\,a(n-8) + 7\,a(n-9) + 14\,a(n-10) - 2\,a(n-11) + 18\,a(n-12) - 3\,a(n-13) - 9\,a(n-14) + a(n-15) - 3\,a(n-16) + a(n-18)
\end{equation}
for all $n>19$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302428.
