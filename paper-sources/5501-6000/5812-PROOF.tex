...
\title{The empirical recurrence for OEIS A298128, proved by transfer matrix}
...
\begin{abstract}
OEIS A298128 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A298128 is ``Number of nX3 0..1 arrays with every element equal to 2, 3, 4 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
0, 2, 4, 13, 62, 223, 826, 3200,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 13 2018 10:51:47, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 4\,a(n-2) - 12\,a(n-4) - 7\,a(n-5) - 2\,a(n-6) - 13\,a(n-7) + 46\,a(n-8) + 28\,a(n-9) - 78\,a(n-10) - 23\,a(n-11) + 61\,a(n-12) + 14\,a(n-13) - 8\,a(n-14) - 2\,a(n-15) - 14\,a(n-16) + 4\,a(n-18)
\end{equation}
for all $n>18$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A298128.
