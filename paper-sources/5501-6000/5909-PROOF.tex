...
\title{The empirical recurrence for OEIS A305771, proved by transfer matrix}
...
\begin{abstract}
OEIS A305771 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A305771 is ``Number of n X 3 0..1 arrays with every element unequal to 0, 1, 2, 3, 5 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
4, 23, 81, 292, 1096, 4172, 15953, 61111,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 26 2024 01:05:58, revision
6) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) + a(n-2) - a(n-3) - 20\,a(n-4) - 8\,a(n-5) + 26\,a(n-6) + 14\,a(n-7) - 12\,a(n-8) + 11\,a(n-9) + 23\,a(n-10) - 8\,a(n-11) - 24\,a(n-12) - 10\,a(n-13) + 7\,a(n-14) - 10\,a(n-15) - 8\,a(n-16)
\end{equation}
for all $n>16$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A305771.
