...
\title{The empirical recurrence for OEIS A207489, proved by transfer matrix}
...
\begin{abstract}
OEIS A207489 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
$(0,1,1), (1,1,0)$ along one axis and $(0,0,0), (0,1,1)$ along the other, and carries an empirical recurrence of
order $22$ contributed by R.~H.~Hardin. It is true. The patterns have length $3$, so
...
$\mathbf{1}^{\!\top}P^{\,n-2-22}q(P)\mathbf{1}$, which vanishes identically
...
OEIS A207489 is ``Number of 4Xn 0..1 arrays avoiding 0 0 0 and 0 1 1 horizontally and 0 1 1 and 1 1 0 vertically.''. It has offset
$1$ and begins
\[
9, 81, 177, 530, 1322, 2749, 6217,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 13:58:31, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 2\,a(n-2) + a(n-3) - 11\,a(n-4) - 5\,a(n-5) + a(n-6) + 23\,a(n-7) + 14\,a(n-8) + 4\,a(n-9) - 37\,a(n-10) - 31\,a(n-11) - 6\,a(n-12) + 43\,a(n-13) + 31\,a(n-14) + 2\,a(n-15) - 28\,a(n-16) - 15\,a(n-17) + 9\,a(n-19) + 3\,a(n-20) - a(n-22)
\end{equation}
for all $n>22$. The entry's array has a fixed number of rows and a growing number of
...
$(0,1,1), (1,1,0)$ as $3$ consecutive entries. There are $9$ admissible columns; that condition
...
$a(n)-\sum_i c_i a(n-i)=u_{\,n-2-22}$ whenever $n-22\ge2$. Hence
\eqref{eq:conj} holds for every $n>t$ exactly when $u_j=0$ for every
$j>t-2-22$. Moreover $(u_j)$ satisfies the monic linear recurrence whose
...
$P^{\,n-2-22}$ gives the identity. The equivalence follows by letting the exponent
...
\begin{proof}
The vector $q(P)\mathbf{1}\in\mathbb{Z}^{S}$ was formed by $22$ matrix--vector
products in exact integer arithmetic and the $u_j$ evaluated in turn. They vanish from the
index corresponding to $n=22+1$ onwards, and the run was continued past $S$ consecutive
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207489.
