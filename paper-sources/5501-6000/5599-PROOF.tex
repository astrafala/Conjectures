...
\title{The empirical recurrence for OEIS A326101, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A326101 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A326101 is ``Number of nX4 0..1 arrays with every element equal to 0, 1, 2, 3 or 6 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
8, 108, 929, 8628, 81088, 760989, 7140349, 67004116,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 06 2019 07:53:15, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;9\,a(n-1) + 6\,a(n-2) - 25\,a(n-3) + 20\,a(n-4) + 45\,a(n-5) - 90\,a(n-6) - 223\,a(n-7) - 120\,a(n-8) - 31\,a(n-9) + 380\,a(n-10) + 330\,a(n-11) - 63\,a(n-12) + 1212\,a(n-13) + 225\,a(n-14) + 584\,a(n-15) + 203\,a(n-16) + 317\,a(n-17) + 57\,a(n-18) + 86\,a(n-19) - 5\,a(n-20) + 4\,a(n-21) - 4\,a(n-22)
\end{equation}
for all $n>23$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A326101.
