...
\title{The empirical recurrence for OEIS A206670, proved by transfer matrix}
...
\begin{abstract}
OEIS A206670 counts arrays of width $3$ over $\{0,1,2\}$ subject to a condition read round the
...
count is a walk count on a finite digraph with $S=139$ vertices, and whether a linear
...
OEIS A206670 is ``Number of (n+1) X 3 0..2 arrays with no 2 X 2 subblock having the same number of clockwise edge increases as its horizontal neighbors or the same number of counterclockwise edge increases as its vertical neighbors.''. It has offset $1$ and begins
\[
360, 1812, 9318, 47106, 243432, 1242930, 6474150, 33323136,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 13 2015 21:16:12, revision 7) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=139,
\]
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + 22\,a(n-2) - 59\,a(n-3) - 112\,a(n-4) - 136\,a(n-5) + 525\,a(n-6) + 182\,a(n-7) - 684\,a(n-8) + 417\,a(n-9) + 136\,a(n-10) + 252\,a(n-11) + 514\,a(n-12) + 224\,a(n-13) + 52\,a(n-14) - 80\,a(n-15) - 48\,a(n-16)
\]
for every $n>16$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206670.
