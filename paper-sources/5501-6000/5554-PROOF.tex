...
\title{The empirical recurrence for OEIS A207010, proved by transfer matrix}
...
\begin{abstract}
OEIS A207010 counts arrays of width $3$ over $\{0,1,2\}$ containing no occurrence of certain short
...
OEIS A207010 is ``Number of nX3 0..2 arrays avoiding the patterns z z+1 z or z z-1 z in any row or column.''. It has offset $1$ and begins
\[
23, 529, 7891, 130165, 2113177, 34303001, 555815721, 9009608765,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 13:23:02, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;17\,a(n-1) - 62\,a(n-2) + 504\,a(n-3) + 4150\,a(n-4) + 5956\,a(n-5) + 52500\,a(n-6) + 324172\,a(n-7) - 312336\,a(n-8) - 7411552\,a(n-9) - 17702840\,a(n-10) + 3602080\,a(n-11) + 84650816\,a(n-12) + 197673664\,a(n-13) + 227286144\,a(n-14) + 39420416\,a(n-15) - 347133568\,a(n-16) - 622917632\,a(n-17) - 875376640\,a(n-18) - 427984896\,a(n-19) - 202702848\,a(n-20) + 417185792\,a(n-21) + 142204928\,a(n-22) + 58327040\,a(n-23) - 46792704\,a(n-24) + 1310720\,a(n-25)
\]
for every $n>25$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207010.
