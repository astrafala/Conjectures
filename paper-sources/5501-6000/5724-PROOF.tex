...
\title{A condition on each element and its neighbours: OEIS A240702}
...
\begin{abstract}
OEIS A240702 carries an empirical recurrence of order $20$ contributed by R.~H.~Hardin. It is
...
walks in it. Hence $a(n)$ is a walk count on $S=31$ vertices and is $C$-finite, and whether the
...
OEIS A240702 is ``Number of nX4 0..3 arrays with no element equal to a different number of vertical neighbors than horizontal neighbors, with new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
5, 193, 7980, 332412, 13844254, 576606991, 24015292771, 1000221764213,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 11:05:55, revision 6) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{The count is a walk count}

The entry counts arrays with $4$ columns over the alphabet $\{0,1,2,3\}$, growing one row at a time. Its condition is that every element must equal the same number of its vertical neighbours as it does of its horizontal neighbours.
...
Vertices with identical futures are merged, which leaves $S=31$. An admissible array is exactly a walk, so with $M$ the adjacency matrix and $\iota,\tau$ the vectors recording which states may begin and end an array,
\[
...
\begin{theorem}
\[
a(n)\;=\;45\,a(n-1) - 79\,a(n-2) - 2693\,a(n-3) + 6906\,a(n-4) + 11122\,a(n-5) - 82634\,a(n-6) - 122470\,a(n-7) + 1250800\,a(n-8) - 381472\,a(n-9) - 4689240\,a(n-10) + 10859688\,a(n-11) + 12837510\,a(n-12) - 33250446\,a(n-13) - 54296730\,a(n-14) + 18494730\,a(n-15) + 56054997\,a(n-16) + 33620751\,a(n-17) + 59068683\,a(n-18) - 29229255\,a(n-19) - 70150212\,a(n-20)
\]
for every $n>20$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A240702.
