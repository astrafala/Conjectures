...
\title{The empirical recurrence for OEIS A298225, proved by transfer matrix}
...
\begin{abstract}
OEIS A298225 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A298225 is ``Number of nX3 0..1 arrays with every element equal to 0, 1, 3, 4 or 5 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
3, 4, 5, 17, 12, 100, 219, 498,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 15 2018 08:27:31, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 4\,a(n-2) + 13\,a(n-3) - 14\,a(n-4) - 29\,a(n-5) - 23\,a(n-6) + 29\,a(n-7) + 56\,a(n-8) - 30\,a(n-9) - 7\,a(n-10) + 41\,a(n-11) + 2\,a(n-12) - 26\,a(n-13) - 12\,a(n-14) - 15\,a(n-15) - 7\,a(n-16) + 16\,a(n-17) + 2\,a(n-18)
\end{equation}
for all $n>19$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A298225.
