...
\title{The empirical recurrence for OEIS A232455, proved by transfer matrix}
...
\begin{abstract}
OEIS A232455 counts arrays of width $4$ over $\{0,1,2\}$ in which every cell carrying one stated
...
OEIS A232455 is ``Number of nX4 0..2 arrays with every 0 next to a 1 and every 1 next to a 2 horizontally, vertically, diagonally or antidiagonally.''. It has offset $1$ and begins
\[
15, 3015, 187989, 12521603, 865692227, 59192688269, 4047993038079, 276984506979883,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 07:27:11, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;51\,a(n-1) + 885\,a(n-2) + 20314\,a(n-3) + 51242\,a(n-4) - 287165\,a(n-5) - 7238521\,a(n-6) - 20969007\,a(n-7) - 20079258\,a(n-8) + 379758092\,a(n-9) + 987349124\,a(n-10) + 1940213292\,a(n-11) - 3615001480\,a(n-12) - 3551344432\,a(n-13) + 653913792\,a(n-14) + 2673844992\,a(n-15)
\]
for every $n>14$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232455.
