...
\title{The empirical recurrence for OEIS A302324, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A302324 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A302324 is ``Number of 3 X n 0..1 arrays with every element equal to 0, 1, 2 or 4 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
4, 25, 65, 177, 519, 1528, 4509, 13329,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 27 2024 16:29:04, revision 10) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) - 4\,a(n-2) - 6\,a(n-3) + a(n-4) - 15\,a(n-5) + 25\,a(n-6) + 37\,a(n-7) + 8\,a(n-8) - 27\,a(n-9) - 57\,a(n-10) - 49\,a(n-11) + 51\,a(n-12) + 44\,a(n-13) - 12\,a(n-14)
\end{equation}
for all $n>15$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302324.
