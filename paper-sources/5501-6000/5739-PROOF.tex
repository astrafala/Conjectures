...
\title{The empirical recurrence for OEIS A188871, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A188871 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A188871 is ``Number of nX6 binary arrays without the pattern 0 0 0 antidiagonally or horizontally.''. It has offset $1$ and begins
\[
44, 1936, 65656, 2368612, 84965120, 3043939392, 109002398784, 3903192037184,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 04:54:29, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;44\,a(n-1) - 288\,a(n-2) - 96\,a(n-3) - 5152\,a(n-4) + 62016\,a(n-5) + 22400\,a(n-6) - 907712\,a(n-7) + 671744\,a(n-8) + 4370432\,a(n-9) - 5936128\,a(n-10) - 3608576\,a(n-11) + 6844416\,a(n-12) + 393216\,a(n-13) - 2097152\,a(n-14) + 262144\,a(n-15)
\end{equation}
for all $n>17$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A188871.
