...
\title{The empirical recurrence for OEIS A253866, proved by transfer matrix}
...
\begin{abstract}
OEIS A253866 counts the arrays over $\{0,\dots,1\}$ whose $3\times3$ subblocks carry a
...
OEIS A253866 is ``Number of (n+2)X(3+2) 0..1 arrays with every 3X3 subblock diagonal maximum minus antidiagonal minimum nondecreasing horizontally, vertically and ne-to-sw antidiagonally.''. It has offset $1$ and begins
\[
20480, 288000, 3939840, 50414592, 659280384, 8536982016, 111370158592, 1445588517376,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 14:19:05, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;17\,a(n-1) - 16\,a(n-2) - 608\,a(n-3) + 3168\,a(n-4) - 23040\,a(n-5) + 62464\,a(n-6) + 148480\,a(n-7) - 477184\,a(n-8) + 1499136\,a(n-9) - 3899392\,a(n-10) - 8454144\,a(n-11) + 21626880\,a(n-12) - 2097152\,a(n-13) - 8388608\,a(n-14) + 25165824\,a(n-15) - 41943040\,a(n-16) + 16777216\,a(n-17)
\]
for every $n>18$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253866.
