...
\title{The empirical recurrence for OEIS A298391, proved by transfer matrix}
...
\begin{abstract}
OEIS A298391 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $equal to$ itself lying in $\{1,2,4,5,6\}$, and it carries an empirical
...
OEIS A298391 is ``Number of nX3 0..1 arrays with every element equal to 1, 2, 4, 5 or 6 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 7, 15, 29, 63, 167, 473, 1205,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 18 2018 08:06:06, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) - 3\,a(n-2) + a(n-3) - 11\,a(n-4) + 12\,a(n-5) - 4\,a(n-6) + 19\,a(n-8) - 20\,a(n-9) + 29\,a(n-10) - 65\,a(n-11) + 63\,a(n-12) - 34\,a(n-13) + 10\,a(n-15)
\end{equation}
for all $n>17$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A298391.
