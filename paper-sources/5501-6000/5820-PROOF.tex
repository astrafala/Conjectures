...
\title{The empirical recurrence for OEIS A231391, proved by transfer matrix}
...
\begin{abstract}
OEIS A231391 counts $(n+1)\times4$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A231391 is ``Number of (n+1) X (3+1) 0..2 arrays with no element unequal to a strict majority of its horizontal, diagonal and antidiagonal neighbors, with values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
14, 38, 100, 272, 740, 2061, 5834, 16521,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 04 2022 08:41:55, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) - 8\,a(n-3) - 8\,a(n-4) + 7\,a(n-5) + 12\,a(n-6) + 23\,a(n-7) - 42\,a(n-8) - 16\,a(n-9) + 81\,a(n-10) - 14\,a(n-11) - 52\,a(n-12) + 15\,a(n-13) - 2\,a(n-14) - 17\,a(n-15) + 4\,a(n-16) + 10\,a(n-17) + 4\,a(n-18)
\]
for every $n>18$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231391.
