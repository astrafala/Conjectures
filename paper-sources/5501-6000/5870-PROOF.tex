...
\title{The empirical recurrence for OEIS A207951, proved by transfer matrix}
...
\begin{abstract}
OEIS A207951 counts arrays over $\{0,\dots,1\}$ of width $5$ that avoid the patterns
$(0,1,0), (1,0,1)$ along one axis and $(0,0,1), (0,1,1)$ along the other, and carries an empirical recurrence of
...
OEIS A207951 is ``Number of 5Xn 0..1 arrays avoiding 0 0 1 and 0 1 1 horizontally and 0 1 0 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
16, 256, 1232, 5929, 18172, 55696, 133812,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:30:54, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 8\,a(n-2) - 18\,a(n-3) - 27\,a(n-4) + 72\,a(n-5) + 48\,a(n-6) - 168\,a(n-7) - 42\,a(n-8) + 252\,a(n-9) - 252\,a(n-11) + 42\,a(n-12) + 168\,a(n-13) - 48\,a(n-14) - 72\,a(n-15) + 27\,a(n-16) + 18\,a(n-17) - 8\,a(n-18) - 2\,a(n-19) + a(n-20)
\end{equation}
for all $n>20$. The entry's array has a fixed number of rows and a growing number of
...
index corresponding to $n=20+1$ onwards, and the run was continued past $S$ consecutive
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207951.
