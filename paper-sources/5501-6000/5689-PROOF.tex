...
\title{The empirical recurrence for OEIS A185536, proved by transfer matrix}
...
\begin{abstract}
OEIS A185536 counts $n\times3$ arrays over $\{0,\dots,5\}$ subject to a condition imposed on
...
walk, and $a(n)$ is a walk count on $S=46872$ vertices, which is $C$-finite. Whether the
...
OEIS A185536 is ``1/6 the number of nX3 0..5 arrays with every element equal to exactly one or two of its horizontal and vertical neighbors.''. It has offset $1$ and begins
\[
1, 110, 2990, 127570, 4403225, 167398110, 6079401960, 225574291125,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 03:05:31, revision 11) this is still
...
$\{0,\dots,5\}^{3}$. The neighbourhood of a cell in row $u_i$ meets $u_{i-1}$,
$u_i$ and $u_{i+1}$ and nothing else. Take as vertices the pairs
$(r,s)\in(\{0,\dots,5\}^{3}\cup\{\varnothing\})\times\{0,\dots,5\}^{3}$,
...
$\tfrac1{6}\iota^{\!\top}M^{\,j}q(M)\tau$ for the corresponding walk index $j$, so the
...
\begin{theorem}
\[
a(n)\;=\;22\,a(n-1) + 638\,a(n-2) - 2567\,a(n-3) - 29583\,a(n-4) + 27088\,a(n-5) + 209637\,a(n-6) + 620796\,a(n-7) - 1634411\,a(n-8) - 4083145\,a(n-9) + 17086070\,a(n-10) - 21827225\,a(n-11) - 42404829\,a(n-12) - 73933685\,a(n-13) + 687497360\,a(n-14) - 669370750\,a(n-15) - 1844490625\,a(n-16) + 8145764375\,a(n-17) + 6297734375\,a(n-18) - 14443984375\,a(n-19) - 34831953125\,a(n-20) - 42570312500\,a(n-21) - 47656250000\,a(n-22) - 78125000000\,a(n-23)
\]
for every $n>23$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A185536.
