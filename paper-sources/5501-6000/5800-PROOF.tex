...
\title{The empirical recurrence for OEIS A206867, proved by transfer matrix}
...
\begin{abstract}
OEIS A206867 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
...
OEIS A206867 is ``Number of nX4 0..1 arrays avoiding 0 0 0 horizontally and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
13, 169, 1153, 7675, 55063, 397221, 2841311,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 13:12:24, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;7\,a(n-1) - 9\,a(n-2) + 59\,a(n-3) + 77\,a(n-4) + 95\,a(n-5) + 211\,a(n-6) - 354\,a(n-7) - 1120\,a(n-8) - 115\,a(n-9) + 1235\,a(n-10) + 539\,a(n-11) - 820\,a(n-12) - 522\,a(n-13) - 28\,a(n-14) + 7\,a(n-15) + 88\,a(n-16) + 54\,a(n-17) + 14\,a(n-18) + 13\,a(n-19) + a(n-20) + a(n-21)
\end{equation}
for all $n>21$. 
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206867.
