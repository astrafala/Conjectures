...
\title{The empirical recurrence for OEIS A317768, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A317768 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A317768 is ``Number of nX3 0..1 arrays with every element unequal to 0, 1 or 3 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
3, 4, 5, 11, 16, 28, 44, 74,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +6*a(n-4) -2*a(n-5) -11*a(n-8) -3*a(n-9) +6*a(n-12) +4*a(n-13) -a(n-16) -a(n-17) for n>23
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 06 2018 12:10:50, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 6\,a(n-4) - 2\,a(n-5) - 11\,a(n-8) - 3\,a(n-9) + 6\,a(n-12) + 4\,a(n-13) - a(n-16) - a(n-17)
\end{equation}
for all $n>23$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A317768.
