...
\title{The empirical recurrence for OEIS A317068, proved by transfer matrix}
...
\begin{abstract}
OEIS A317068 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A317068 is ``Number of nX4 0..1 arrays with every element unequal to 1, 2, 3, 4, 5, 6 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
2, 98, 1161, 16910, 241716, 3449720, 49272887, 703694269,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 20 2018 13:39:02, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;11\,a(n-1) + 41\,a(n-2) + 89\,a(n-3) - 48\,a(n-4) - 333\,a(n-5) - 623\,a(n-6) - 225\,a(n-7) - 129\,a(n-8) + 156\,a(n-9) + 110\,a(n-10) + 454\,a(n-11) + 212\,a(n-12) + 29\,a(n-13) - 78\,a(n-14) - 12\,a(n-15) + 12\,a(n-16) - 16\,a(n-17)
\end{equation}
for all $n>17$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A317068.
