...
\title{The empirical recurrence for OEIS A258526, proved by transfer matrix}
...
\begin{abstract}
OEIS A258526 counts the arrays over $\{0,\dots,1\}$ whose $3\times3$ subblocks carry a
...
so the count is a walk count on $S=6644$ states --- the last two array rows together with the
...
OEIS A258526 is ``Number of (n+2)X(4+2) 0..1 arrays with every 3X3 subblock sum of the two maximums of the central row and central column plus the two minimums of the diagonal and antidiagonal nondecreasing horizontally, vertically and ne-to-sw antidiagonally.''. It has offset $1$ and begins
\[
65548, 523452, 3133384, 6505920, 16029944, 49299000, 161983800, 588975448,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 15:26:46, revision 6) this is still
...
\]
on the $S=6644$ reachable states. In particular $a$ is $C$-finite. The alignment of the walk
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 15\,a(n-2) - 8\,a(n-3) - 16\,a(n-4) - 200\,a(n-5) + 272\,a(n-6) - 2368\,a(n-7) - 896\,a(n-8) + 7808\,a(n-9) + 39424\,a(n-10) + 11264\,a(n-11) - 145408\,a(n-12) - 114688\,a(n-13) + 8192\,a(n-14) + 589824\,a(n-15) - 393216\,a(n-16)
\]
for every $n>25$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A258526.
