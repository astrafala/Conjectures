...
\title{The empirical recurrence for OEIS A300262, proved by transfer matrix}
...
\begin{abstract}
OEIS A300262 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $equal to$ itself lying in $\{0,1,2,3,5,6,7,8\}$, and it carries an empirical
...
OEIS A300262 is ``Number of nX3 0..1 arrays with every element equal to 0, 1, 2, 3, 5, 6, 7 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
4, 26, 95, 375, 1526, 6198, 25034, 101312,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 01 2018 07:53:50, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) - 8\,a(n-2) + 4\,a(n-3) - 16\,a(n-4) - 3\,a(n-5) + 32\,a(n-6) + 13\,a(n-7) + 28\,a(n-8) - 91\,a(n-9) + 46\,a(n-10) + 5\,a(n-11) + 79\,a(n-12) - 38\,a(n-13) - 24\,a(n-14) - 22\,a(n-15) - 23\,a(n-16) - 7\,a(n-17) + 4\,a(n-18)
\end{equation}
for all $n>19$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A300262.
