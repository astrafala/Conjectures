...
\title{The empirical recurrence for OEIS A189199, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A189199 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A189199 is ``Number of 6Xn binary arrays without the pattern 0 0 1 vertically or antidiagonally.''. It has offset $1$ and begins
\[
33, 1089, 27170, 657028, 15564047, 367115337, 8646366042, 203562575017,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 05:05:46, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;33\,a(n-1) - 206\,a(n-2) - 738\,a(n-3) + 8753\,a(n-4) - 13693\,a(n-5) - 33068\,a(n-6) + 87427\,a(n-7) - 52757\,a(n-8) + 67082\,a(n-9) - 70312\,a(n-10) - 61118\,a(n-11) + 47608\,a(n-12) - 908\,a(n-13) - 1404\,a(n-14) + 568\,a(n-15) - 192\,a(n-16)
\end{equation}
for all $n>17$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A189199.
