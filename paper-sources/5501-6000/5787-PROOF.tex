...
\title{The empirical recurrence for OEIS A303458, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A303458 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A303458 is ``Number of 4Xn 0..1 arrays with every element equal to 0, 1, 2, 3, 4 or 6 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
8, 128, 1696, 22756, 306448, 4129588, 55681352, 750838628,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 24 2018 10:23:57, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;14\,a(n-1) + 18\,a(n-2) - 338\,a(n-3) - 62\,a(n-4) + 1192\,a(n-5) - 648\,a(n-6) + 1818\,a(n-7) + 1407\,a(n-8) - 3144\,a(n-9) + 3656\,a(n-10) - 8832\,a(n-11) - 7324\,a(n-12) + 8010\,a(n-13) + 2202\,a(n-14) + 3312\,a(n-15)
\end{equation}
for all $n>16$.
...
\#\{\text{neighbours with a value }equal to\ x_{t,u}\}\in\{0,1,2,3,4,6\}
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A303458.
