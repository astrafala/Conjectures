...
\title{A condition on every subblock: the empirical recurrence for OEIS A181258}
...
\begin{abstract}
OEIS A181258 carries an empirical recurrence of order $20$ contributed by R.~H.~Hardin. It is
...
walks in it. Hence $a(n)$ is a walk count on $S=34$ vertices and is $C$-finite, and whether the
...
OEIS A181258 is ``Number of (n+2)X6 binary matrices with every 3X3 block having exactly four 1's.''. It has offset $1$ and begins
\[
2484, 3942, 6360, 10818, 22512, 48846, 112500, 289830,\ \dots
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A181258.
