...
\title{The empirical recurrence for OEIS A250542, proved by transfer matrix}
...
\begin{abstract}
OEIS A250542 counts arrays over $\{0,1,2,3\}$ in which a statistic taken over short runs
...
OEIS A250542 is ``Number of (n+1)X(6+1) 0..3 arrays with nondecreasing x(i,j)-x(i,j-1) in the i direction and nondecreasing x(i,j)-x(i-1,j) in the j direction.''. It has offset $1$ and begins
\[
905440, 13657024, 117777788, 752602024, 4013192386, 19031828420, 83356429646, 345394150196,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 12:31:35, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250542.
