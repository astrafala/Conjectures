...
\title{The empirical recurrence for OEIS A298890, proved by transfer matrix}
...
\begin{abstract}
OEIS A298890 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A298890 is ``Number of nX3 0..1 arrays with every element equal to 2, 3, 5, 6 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
0, 3, 1, 4, 4, 11, 26, 66,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 28 2018 09:03:11, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) - a(n-2) - 5\,a(n-3) - 10\,a(n-4) + 11\,a(n-5) + 15\,a(n-6) + 2\,a(n-7) - 5\,a(n-8) - 33\,a(n-9) - 20\,a(n-10) + 47\,a(n-11) + 36\,a(n-12) + 4\,a(n-14) - 12\,a(n-15) - 2\,a(n-16) + 2\,a(n-17)
\end{equation}
for all $n>18$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A298890.
