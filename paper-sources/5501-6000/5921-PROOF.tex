...
\title{The empirical recurrence for OEIS A295412, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A295412 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A295412 is ``Number of nX4 0..1 arrays with each 1 horizontally or vertically adjacent to 1, 2 or 3 1s.''. It has offset $1$ and begins
\[
7, 126, 1534, 19026, 240439, 3019079, 37927609, 476686533,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 22 2017 10:36:37, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;9\,a(n-1) + 23\,a(n-2) + 218\,a(n-3) + 534\,a(n-4) + 1923\,a(n-5) + 3128\,a(n-6) - 1379\,a(n-7) - 8708\,a(n-8) - 5083\,a(n-9) + 7804\,a(n-10) + 9844\,a(n-11) - 968\,a(n-12) - 6624\,a(n-13) - 3072\,a(n-14)
\end{equation}
for all $n>15$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A295412.
