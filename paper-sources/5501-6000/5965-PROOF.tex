...
\title{The empirical recurrence for OEIS A296573, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A296573 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A296573 is ``Number of nX3 0..1 arrays with each 1 horizontally, vertically or antidiagonally adjacent to 0, 1 or 3 neighboring 1s.''. It has offset $1$ and begins
\[
7, 31, 135, 616, 2782, 12544, 56646, 255699,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 15 2017 21:13:38, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 9\,a(n-2) + 11\,a(n-3) - 2\,a(n-4) - a(n-5) + 10\,a(n-6) + 2\,a(n-7) - 29\,a(n-8) - 16\,a(n-9) + 27\,a(n-10) + 7\,a(n-11) - 12\,a(n-12) - a(n-13) + 2\,a(n-14)
\end{equation}
for all $n>15$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A296573.
