...
\title{The empirical recurrence for OEIS A205731, proved by transfer matrix}
...
\begin{abstract}
OEIS A205731 counts arrays over $\{0,\dots,2\}$ under a condition on the number of clockwise edge increases
...
a bounded window of consecutive rows, so the count is a walk count on $S=1764$ states and is
...
OEIS A205731 is ``Number of (n+1) X 4 0..2 arrays with every 2 X 2 subblock having the same number of clockwise edge increases as its horizontal neighbors and no 2 X 2 subblock having the same number of counterclockwise edge increases as its vertical neighbors.''. It has offset $1$ and begins
\[
1764, 3888, 14715, 39450, 191766, 526680, 2500875, 6985128,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 15*a(n-2) -5*a(n-4) -268*a(n-6) +871*a(n-8) -1225*a(n-10) +919*a(n-12) -364*a(n-14) +60*a(n-16) for n>21.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 08 2026 17:46:30, revision 9) this is still
...
\]
on the $S=1764$ admissible pairs.
...
\begin{theorem}
\[
a(n)\;=\;15\,a(n-2) - 5\,a(n-4) - 268\,a(n-6) + 871\,a(n-8) - 1225\,a(n-10) + 919\,a(n-12) - 364\,a(n-14) + 60\,a(n-16)
\]
for every $n>21$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A205731.
