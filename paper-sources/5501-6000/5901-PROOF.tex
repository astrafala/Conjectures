...
\title{The empirical recurrence for OEIS A207365, proved by transfer matrix}
...
\begin{abstract}
OEIS A207365 counts arrays over $\{0,\dots,1\}$ of width $5$ that avoid the patterns
...
OEIS A207365 is ``Number of nX5 0..1 arrays avoiding 0 0 0 and 0 1 1 horizontally and 0 0 1 and 0 1 1 vertically.''. It has offset
$1$ and begins
\[
13, 169, 624, 2304, 5856, 14884, 31110,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 13:49:19, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207365.
