...
\title{The empirical recurrence for OEIS A236945, proved by transfer matrix}
...
\begin{abstract}
OEIS A236945 counts arrays over $\{0,\dots,3\}$ subject to a condition on the order
...
The condition is local to two consecutive rows, so the count is a walk count on $S=1300$
...
OEIS A236945 is ``Number of (n+1)X(4+1) 0..3 arrays with the maximum of every 2X2 subblock equal.''. It has offset $1$ and begins
\[
357316, 178006252, 73196854050, 33887916009662, 14993765290435528, 6794451721009466204, 3048340953731729204888, 1374356722643878889083728,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 09:41:19, revision 6) this is still
...
array, which is not among the objects counted. There are $S=1300$ states left.
...
\begin{theorem}
\[
a(n)\;=\;424\,a(n-1) + 62841\,a(n-2) - 23821786\,a(n-3) - 323958504\,a(n-4) + 344301777418\,a(n-5) - 9832213915612\,a(n-6) - 1327040412239104\,a(n-7) + 52919393633676596\,a(n-8) + 1661194003472702658\,a(n-9) - 81478174052335909816\,a(n-10) - 414773977421061937634\,a(n-11) + 43172424299930717855749\,a(n-12) - 257155013696867677011256\,a(n-13) - 4323650605031746975388613\,a(n-14) + 25177679306370855714028416\,a(n-15) + 180403547575480950604999824\,a(n-16) - 429577562160330756023400192\,a(n-17) - 1243975490088381892935023616\,a(n-18) + 3997026635500888039521681408\,a(n-19) - 2980738212000703127936040960\,a(n-20) - 103313284358758051809853440\,a(n-21) + 559534813959237271761715200\,a(n-22)
\]
for every $n>21$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A236945.
