...
\title{The empirical recurrence for OEIS A235314, proved by transfer matrix}
...
\begin{abstract}
OEIS A235314 counts $4$-column arrays over $\{0,\dots,6\}$ in which every
...
OEIS A235314 is ``Number of (n+1) X (3+1) 0..6 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 7 (constant-stress 1 X 1 tilings).''. It has offset
$1$ and begins
\[
1120, 2744, 5968, 16352, 40144, 118160, 316912,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 18 2022 23:07:57, revision 7) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A235314.
