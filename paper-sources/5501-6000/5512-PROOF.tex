...
\title{The empirical recurrence for OEIS A298966, proved by transfer matrix}
...
\begin{abstract}
OEIS A298966 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $equal to$ itself lying in $\{0,1,2,3,4,5\}$, and it carries an empirical
...
OEIS A298966 is ``Number of nX4 0..1 arrays with every element equal to 0, 1, 2, 3, 4 or 5 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
8, 128, 1575, 21098, 280468, 3740381, 49885231, 665351771,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 30 2018 13:28:32, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;13\,a(n-1) + 11\,a(n-2) - 67\,a(n-3) - 264\,a(n-4) - 64\,a(n-5) + 1260\,a(n-6) + 656\,a(n-7) - 3045\,a(n-8) - 3423\,a(n-9) + 5088\,a(n-10) + 9482\,a(n-11) - 514\,a(n-12) - 10331\,a(n-13) - 6164\,a(n-14) + 3337\,a(n-15) + 4293\,a(n-16) + 719\,a(n-17) - 809\,a(n-18) + 116\,a(n-19) + 149\,a(n-20) - 62\,a(n-21) - 160\,a(n-22) - 48\,a(n-23)
\end{equation}
for all $n>23$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A298966.
