...
\title{The empirical recurrence for OEIS A318345, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A318345 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A318345 is ``Number of nX3 0..1 arrays with every element unequal to 0, 1, 3 or 6 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
3, 4, 6, 13, 21, 41, 71, 130,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 24 2018 11:09:16, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + a(n-3) + 6\,a(n-4) - 2\,a(n-5) - 2\,a(n-7) - 11\,a(n-8) - 3\,a(n-9) - 3\,a(n-11) + 6\,a(n-12) + 4\,a(n-13) + 4\,a(n-15) - a(n-16) - a(n-17) - a(n-19)
\end{equation}
for all $n>25$.
...
\#\{\text{neighbours with a value }different from\ x_{t,u}\}\in\{0,1,3,6\}
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A318345.
