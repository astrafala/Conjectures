...
\title{The empirical recurrence for OEIS A296381, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A296381 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A296381 is ``Number of n X 3 0..1 arrays with each 1 horizontally, vertically or antidiagonally adjacent to 1 or 2 neighboring 1s.''. It has offset $1$ and begins
\[
4, 28, 127, 641, 3237, 16248, 81661, 410199,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 17 2026 11:42:13, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) - 2\,a(n-2) + 14\,a(n-3) - 20\,a(n-4) + 24\,a(n-5) - 52\,a(n-6) + 83\,a(n-7) - 82\,a(n-8) + 43\,a(n-9) - 5\,a(n-10) - 4\,a(n-11) - 9\,a(n-12) + 19\,a(n-13) - 15\,a(n-14) + 6\,a(n-15) - a(n-16)
\end{equation}
for all $n>17$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A296381.
