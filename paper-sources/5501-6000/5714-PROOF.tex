...
\title{The empirical recurrence for OEIS A297080, proved by transfer matrix}
...
\begin{abstract}
OEIS A297080 counts $n\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A297080 is ``Number of n X 3 0..1 arrays with no 1 adjacent to 2 king-move neighboring 1's.''. It has offset $1$ and begins
\[
7, 30, 136, 687, 3616, 19277, 105494, 581688,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 19 2025 19:36:48, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) + 7\,a(n-2) - a(n-3) - 84\,a(n-4) - 148\,a(n-5) - 38\,a(n-6) + 123\,a(n-7) + 535\,a(n-8) + 532\,a(n-9) + 210\,a(n-10) - 52\,a(n-11) - 279\,a(n-12) - 638\,a(n-13) - 307\,a(n-14) - 75\,a(n-15) - a(n-16) - 2\,a(n-17)
\]
for every $n>17$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297080.
