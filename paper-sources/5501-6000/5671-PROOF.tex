...
\title{The empirical recurrence for OEIS A278282, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A278282 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A278282 is ``Number of 3Xn 0..1 arrays with every element both equal and not equal to some elements at offset (-1,-1) (-1,0) (-1,1) (0,-1) (0,1) or (1,0), with upper left element zero.''. It has offset $1$ and begins
\[
0, 5, 25, 122, 661, 3723, 20736, 115446,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 16 2016 12:12:13, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 14\,a(n-2) + 3\,a(n-3) - a(n-4) - 20\,a(n-5) - 65\,a(n-6) + 20\,a(n-7) + 53\,a(n-8) + 10\,a(n-9) + 55\,a(n-10) + 12\,a(n-11) - 3\,a(n-12) + 13\,a(n-13) - 8\,a(n-14) + 3\,a(n-15) - a(n-16)
\end{equation}
for all $n>17$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A278282.
