...
\title{The empirical recurrence for OEIS A208011, proved by transfer matrix}
...
\begin{abstract}
OEIS A208011 counts arrays over $\{0,\dots,1\}$ of width $6$ that avoid the patterns
$(0,0,0), (1,0,1)$ along one axis and $(0,0,1), (0,1,1)$ along the other, and carries an empirical recurrence of
...
OEIS A208011 is ``Number of nX6 0..1 arrays avoiding 0 0 0 and 1 0 1 horizontally and 0 0 1 and 0 1 1 vertically.''. It has offset
$1$ and begins
\[
19, 361, 1482, 6084, 16224, 43264, 92560,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:34:02, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208011.
