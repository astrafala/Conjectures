...
\title{The empirical recurrence for OEIS A210071, proved by transfer matrix}
...
\begin{abstract}
OEIS A210071 counts $(n+1)\times3$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A210071 is ``1/4 the number of (n+1)X3 0..3 arrays with every 2X2 subblock having one or three distinct clockwise edge differences.''. It has offset $1$ and begins
\[
313, 7653, 183628, 4437262, 107248254, 2593403383, 62718516080, 1516857228897,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 15:40:50, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;40\,a(n-1) - 410\,a(n-2) + 162\,a(n-3) + 13887\,a(n-4) - 37312\,a(n-5) - 114069\,a(n-6) + 441850\,a(n-7) + 251010\,a(n-8) - 1865698\,a(n-9) + 353991\,a(n-10) + 3283497\,a(n-11) - 1672828\,a(n-12) - 2287997\,a(n-13) + 1529824\,a(n-14) + 444317\,a(n-15) - 334882\,a(n-16) - 35990\,a(n-17) + 21286\,a(n-18) + 648\,a(n-19) - 288\,a(n-20)
\end{equation}
for all $n>19$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A210071.
