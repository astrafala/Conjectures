...
\title{The empirical recurrence for OEIS A318071, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A318071 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A318071 is ``Number of nX4 0..1 arrays with every element unequal to 0, 1, 2 or 5 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
8, 20, 41, 73, 149, 372, 861, 2016,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 15 2018 13:18:18, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + a(n-2) + 2\,a(n-3) - 3\,a(n-4) - 5\,a(n-5) - 2\,a(n-7) + 7\,a(n-8) - a(n-9) - 2\,a(n-10) + 8\,a(n-11) - 3\,a(n-12) - a(n-13) - 3\,a(n-14) - 3\,a(n-15) + 4\,a(n-16) + a(n-17) - a(n-18)
\end{equation}
for all $n>21$.
...
The threshold below is exact rather than merely sufficient: at $n=21$ the conjectured
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A318071.
