...
\title{The empirical recurrence for OEIS A301536, proved by transfer matrix}
...
\begin{abstract}
OEIS A301536 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A301536 is ``Number of n X 3 0..1 arrays with every element equal to 0, 1 or 3 horizontally or vertically adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
3, 6, 9, 26, 61, 154, 374, 941,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 20 2021 12:37:59, revision
6) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) - a(n-2) - a(n-3) + 2\,a(n-4) - a(n-5) + 3\,a(n-6) - 11\,a(n-7) - a(n-8) + 2\,a(n-9) - 4\,a(n-10) - 2\,a(n-11) - a(n-12) + 11\,a(n-13) + 3\,a(n-14) + a(n-15) + 2\,a(n-16) + a(n-17) - a(n-18) - 3\,a(n-19) - a(n-20)
\end{equation}
for all $n>20$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A301536.
