...
\title{The empirical recurrence for OEIS A297428, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297428 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A297428 is ``Number of nX5 0..1 arrays with every 1 horizontally, diagonally or antidiagonally adjacent to 2 neighboring 1s.''. It has offset $1$ and begins
\[
1, 18, 43, 105, 535, 1673, 5108, 19690,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 30 2017 06:57:31, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 2\,a(n-2) + 24\,a(n-3) - 22\,a(n-4) - 40\,a(n-5) - 163\,a(n-6) - 40\,a(n-7) + 76\,a(n-8) + 246\,a(n-9) + 160\,a(n-10) - 57\,a(n-11) - 115\,a(n-12) - 50\,a(n-13) + 18\,a(n-14) + 12\,a(n-15) - 33\,a(n-16) + 4\,a(n-17) + 5\,a(n-18) + 7\,a(n-19) - 3\,a(n-20)
\end{equation}
for all $n>21$.
...
publishes, $n=24$, the arrays have $5\cdot24$ cells over
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297428.
