...
\title{The empirical recurrence for OEIS A252214, proved by transfer matrix}
...
\begin{abstract}
OEIS A252214 counts $(n+2)\times5$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252214 is ``Number of (n+2)X(3+2) 0..3 arrays with every 3X3 subblock row, column, diagonal and antidiagonal sum not equal to 0 2 5 6 or 7.''. It has offset $1$ and begins
\[
1843, 1437, 3303, 10486, 35674, 122694, 420596, 1446932,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 10:57:06, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252214.
