...
\title{The empirical recurrence for OEIS A250696, proved by transfer matrix}
...
\begin{abstract}
OEIS A250696 counts arrays over $\{0,1,2,3\}$ in which a statistic taken over short runs
...
OEIS A250696 is ``Number of (5+1)X(n+1) 0..3 arrays with nondecreasing x(i,j)-x(i,j-1) in the i direction and nondecreasing absolute value of x(i,j)-x(i-1,j) in the j direction.''. It has offset $1$ and begins
\[
53032, 362241, 1848953, 8038566, 31728758, 117793753, 420283865, 1461625340,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 12:42:31, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250696.
