...
\title{The empirical recurrence for OEIS A235218, proved by transfer matrix}
...
\begin{abstract}
OEIS A235218 counts arrays of width $4$ over $\{0,1,2\}$ subject to a condition read round the
...
count is a walk count on a finite digraph with $S=82$ vertices, and whether a linear
...
OEIS A235218 is ``Number of (n+1)X(3+1) 0..2 arrays with 2X2 edge jumps all no more than +1 in one of the clockwise or counterclockwise directions or both.''. It has offset $1$ and begins
\[
3037, 145669, 6630699, 306034401, 14077755879, 648127851943, 29833075851519, 1373275806129107,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 08:29:30, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;39\,a(n-1) + 410\,a(n-2) - 3737\,a(n-3) - 13178\,a(n-4) + 103275\,a(n-5) + 89722\,a(n-6) - 961878\,a(n-7) - 181366\,a(n-8) + 4083283\,a(n-9) - 48872\,a(n-10) - 8784678\,a(n-11) + 444362\,a(n-12) + 9715586\,a(n-13) - 378256\,a(n-14) - 5306393\,a(n-15) + 93253\,a(n-16) + 1319247\,a(n-17) + 1378\,a(n-18) - 124156\,a(n-19) - 3168\,a(n-20) + 2456\,a(n-21)
\]
for every $n>19$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A235218.
