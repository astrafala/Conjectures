...
\title{The empirical recurrence for OEIS A296734, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A296734 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A296734 is ``Number of nX3 0..1 arrays with each 1 adjacent to 1, 2 or 4 king-move neighboring 1s.''. It has offset $1$ and begins
\[
4, 31, 126, 575, 2832, 13322, 62874, 299056,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 19 2017 13:40:43, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) + 3\,a(n-2) + 14\,a(n-3) - 42\,a(n-4) - 56\,a(n-5) - 51\,a(n-6) + 118\,a(n-7) + 189\,a(n-8) + 60\,a(n-9) - 114\,a(n-10) - 187\,a(n-11) - 25\,a(n-12) + 82\,a(n-13) + 33\,a(n-14) - 12\,a(n-15) - 4\,a(n-16)
\end{equation}
for all $n>17$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A296734.
