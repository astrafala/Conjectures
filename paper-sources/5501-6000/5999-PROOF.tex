...
\title{The empirical recurrence for OEIS A261706, proved by transfer matrix}
...
\begin{abstract}
OEIS A261706 counts $(n+2)\times5$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A261706 is ``Number of (n+2) X (3+2) 0..1 arrays with each 3 X 3 subblock having clockwise perimeter pattern 00000001 00000101 or 00000111.''. It has offset $1$ and begins
\[
172, 270, 468, 662, 1168, 2372, 3700, 6158,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-3) +3*a(n-6) +4*a(n-7) -2*a(n-9) +4*a(n-11) -8*a(n-13) +10*a(n-14) for n>20.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 18 2023 15:55:43, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-3) + 3\,a(n-6) + 4\,a(n-7) - 2\,a(n-9) + 4\,a(n-11) - 8\,a(n-13) + 10\,a(n-14)
\]
for every $n>20$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A261706.
