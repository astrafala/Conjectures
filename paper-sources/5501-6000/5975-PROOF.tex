...
\title{The empirical recurrence for OEIS A300684, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A300684 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A300684 is ``Number of nX3 0..1 arrays with every element equal to 1, 2, 3 or 6 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
1, 10, 53, 272, 1391, 7187, 37100, 191529,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 11 2018 08:47:57, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) + 3\,a(n-2) - 11\,a(n-3) + a(n-4) - 9\,a(n-5) - 3\,a(n-6) + 10\,a(n-7) - 2\,a(n-8) - 14\,a(n-9) - 8\,a(n-10) - 4\,a(n-11) + 8\,a(n-13) + 4\,a(n-14)
\end{equation}
for all $n>15$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A300684.
