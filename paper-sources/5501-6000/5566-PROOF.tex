...
\title{The empirical recurrence for OEIS A260203, proved by transfer matrix}
...
\begin{abstract}
OEIS A260203 counts $(n+2)\times6$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A260203 is ``Number of (n+2)X(4+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000000 00000001 or 00010001.''. It has offset $1$ and begins
\[
220, 479, 1857, 5998, 20408, 71846, 245486, 841296,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 12:03:00, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A260203.
