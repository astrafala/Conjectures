...
\title{The empirical recurrence for OEIS A208553, proved by transfer matrix}
...
\begin{abstract}
OEIS A208553 counts arrays over $\{0,\dots,1\}$ of width $6$ that avoid the patterns
...
OEIS A208553 is ``Number of nX6 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 0 1 and 0 1 1 vertically.''. It has offset
$1$ and begins
\[
26, 676, 3354, 16641, 50052, 150544, 351140,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:55:07, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208553.
