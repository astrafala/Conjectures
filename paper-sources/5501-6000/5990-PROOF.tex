...
\title{The empirical recurrence for OEIS A185572, proved by transfer matrix}
...
\begin{abstract}
OEIS A185572 counts arrays over $\{0,\dots,3\}$ under a condition on the sum of every
$2\times2$ subblock, and carries an empirical recurrence of order $16$ contributed by
...
OEIS A185572 is ``Number of (n+1)X2 0..3 arrays with no 2X2 subblock sum equal to any horizontal or vertical neighbor 2X2 subblock sum.''. It has offset $1$ and begins
\[
256, 3392, 44944, 598688, 7974976, 106125920, 1412256400, 18797516000,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 17 2025 02:52:57, revision 13) this is still
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) + 692\,a(n-3) + 5325\,a(n-4) + 24966\,a(n-5) + 137368\,a(n-6) + 200736\,a(n-7) - 730404\,a(n-8) - 4060664\,a(n-9) - 19780992\,a(n-10) - 30858624\,a(n-11) + 110419200\,a(n-12) + 328084992\,a(n-13) - 615112704\,a(n-15) - 429981696\,a(n-16)
\]
for every $n>16$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A185572.
