...
\title{The empirical recurrence for OEIS A296647, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A296647 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A296647 is ``Number of nX4 0..1 arrays with each 1 adjacent to 0, 1 or 3 king-move neighboring 1s.''. It has offset $1$ and begins
\[
13, 85, 468, 3159, 20782, 130303, 849983, 5499124,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 17 2017 15:45:25, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 14\,a(n-2) + 79\,a(n-3) - 76\,a(n-4) - 416\,a(n-5) - 956\,a(n-6) - 474\,a(n-7) + 2279\,a(n-8) + 3884\,a(n-9) + 4165\,a(n-10) - 656\,a(n-11) - 3621\,a(n-12) - 3321\,a(n-13) - 1970\,a(n-14) + 654\,a(n-15) - 339\,a(n-16) + 359\,a(n-17) + 20\,a(n-18) + 188\,a(n-19) + 377\,a(n-20) + 44\,a(n-21) + 37\,a(n-22)
\end{equation}
for all $n>23$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A296647.
