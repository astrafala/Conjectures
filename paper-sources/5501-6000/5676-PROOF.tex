...
\title{The empirical recurrence for OEIS A296822, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A296822 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A296822 is ``Number of nX3 0..1 arrays with each 1 adjacent to 2, 3 or 4 king-move neighboring 1s.''. It has offset $1$ and begins
\[
1, 21, 94, 352, 2133, 11930, 60772, 326592,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 21 2017 12:20:07, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) + 3\,a(n-2) + 35\,a(n-3) - 38\,a(n-4) - 111\,a(n-5) - 176\,a(n-6) + 144\,a(n-7) + 267\,a(n-8) + 147\,a(n-9) - 110\,a(n-10) - 107\,a(n-11) + 56\,a(n-12) + 58\,a(n-13) + 49\,a(n-14) - 10\,a(n-15) - 18\,a(n-16)
\end{equation}
for all $n>17$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A296822.
