...
\title{A condition on every subblock: the empirical recurrence for OEIS A181250}
...
\begin{abstract}
OEIS A181250 carries an empirical recurrence of order $18$ contributed by R.~H.~Hardin. It is
...
OEIS A181250 is ``Number of n X 7 binary matrices with no 2 X 2 block having four 1's.''. It has offset $1$ and begins
\[
128, 11772, 1169792, 114142368, 11185495872, 1095020802848, 107224417436160, 10498818149889952,\ \dots
\]
...
\begin{theorem}
\[
a(n)\;=\;68\,a(n-1) + 3106\,a(n-2) - 10300\,a(n-3) - 731184\,a(n-4) + 3930848\,a(n-5) + 47046600\,a(n-6) - 471525808\,a(n-7) + 1012118640\,a(n-8) + 2396096576\,a(n-9) - 9445394304\,a(n-10) - 4382776896\,a(n-11) + 29415041536\,a(n-12) + 8676097024\,a(n-13) - 36065068032\,a(n-14) - 14871987200\,a(n-15) + 10138337280\,a(n-16) + 2907136000\,a(n-17) - 1119682560\,a(n-18)
\]
for every $n>18$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A181250.
