...
\title{The empirical recurrence for OEIS A297460, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297460 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A297460 is ``Number of 4Xn 0..1 arrays with every 1 horizontally, diagonally or antidiagonally adjacent to 0 or 2 neighboring 1s.''. It has offset $1$ and begins
\[
16, 48, 390, 1677, 10579, 52714, 303202, 1595942,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 30 2017 11:12:10, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) + 15\,a(n-2) - 32\,a(n-3) - 18\,a(n-4) - 113\,a(n-5) - 37\,a(n-6) + 422\,a(n-7) - 77\,a(n-8) + 349\,a(n-9) + 165\,a(n-10) - 118\,a(n-11) - 14\,a(n-12) - 48\,a(n-13) - 2\,a(n-14) + 8\,a(n-15)
\end{equation}
for all $n>16$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297460.
