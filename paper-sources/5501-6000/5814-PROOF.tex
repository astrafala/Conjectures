...
\title{The empirical recurrence for OEIS A232049, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A232049 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A232049 is ``Number of 3Xn 0..1 arrays with no element less than a strict majority of its horizontal and antidiagonal neighbors.''. It has offset $1$ and begins
\[
8, 21, 80, 318, 1315, 5364, 21680, 87452,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 06:50:19, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;8\,a(n-1) - 27\,a(n-2) + 64\,a(n-3) - 104\,a(n-4) + 124\,a(n-5) - 102\,a(n-6) + 34\,a(n-7) + 10\,a(n-8) - 34\,a(n-9) + 19\,a(n-10) - 2\,a(n-11) + a(n-12) + 10\,a(n-13) - 2\,a(n-14) - 2\,a(n-15)
\end{equation}
for all $n>18$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232049.
