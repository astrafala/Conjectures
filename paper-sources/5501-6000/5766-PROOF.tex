...
\title{The empirical recurrence for OEIS A260761, proved by transfer matrix}
...
\begin{abstract}
OEIS A260761 counts $(n+2)\times4$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A260761 is ``Number of (n+2)X(2+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000001 00000011 or 00010011.''. It has offset $1$ and begins
\[
82, 115, 265, 481, 798, 1671, 3196, 5596,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 12:10:27, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-3) + 6\,a(n-4) + 2\,a(n-5) - 6\,a(n-6) - 18\,a(n-7) - 18\,a(n-8) - 8\,a(n-9) + 2\,a(n-10) + 21\,a(n-11) + 23\,a(n-12) + 10\,a(n-13) + 11\,a(n-14) - 5\,a(n-15) - 8\,a(n-16) - a(n-17) - 4\,a(n-18) + a(n-20)
\]
for every $n>23$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A260761.
