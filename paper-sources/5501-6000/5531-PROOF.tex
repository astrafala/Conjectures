...
\title{The empirical recurrence for OEIS A202597, proved by transfer matrix}
...
\begin{abstract}
OEIS A202597 counts arrays of width $6$ over $\{0,1\}$ containing no occurrence of certain short
...
OEIS A202597 is ``Number of (n+2)X6 binary arrays avoiding patterns 001 and 000 in rows and columns.''. It has offset $1$ and begins
\[
7722, 107510, 1402544, 18741086, 248094210, 3296516444, 43736102410, 580619927134,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 09:44:05, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + 124\,a(n-2) + 144\,a(n-3) - 2031\,a(n-4) - 1515\,a(n-5) + 12912\,a(n-6) + 76\,a(n-7) - 28781\,a(n-8) + 9107\,a(n-9) + 23165\,a(n-10) - 8484\,a(n-11) - 7936\,a(n-12) + 2195\,a(n-13) + 1273\,a(n-14) - 176\,a(n-15) - 76\,a(n-16) + 4\,a(n-17) + a(n-18)
\]
for every $n>16$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A202597.
