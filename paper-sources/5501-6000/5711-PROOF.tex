...
\title{The empirical recurrence for OEIS A317818, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A317818 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A317818 is ``Number of nX3 0..1 arrays with every element unequal to 1, 2 or 3 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
1, 16, 35, 135, 356, 1113, 3150, 9484,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 07 2018 22:05:10, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 7\,a(n-2) + 2\,a(n-3) - 10\,a(n-4) - 14\,a(n-5) - 16\,a(n-6) - 25\,a(n-7) + 36\,a(n-8) + 42\,a(n-9) - 26\,a(n-10) + 62\,a(n-11) + 10\,a(n-12) - 28\,a(n-13) + 20\,a(n-14) - 16\,a(n-15) + 4\,a(n-16)
\end{equation}
for all $n>18$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A317818.
