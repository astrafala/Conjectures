...
\title{The empirical recurrence for OEIS A304014, proved by transfer matrix}
...
\begin{abstract}
OEIS A304014 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A304014 is ``Number of nX3 0..1 arrays with every element unequal to 1, 2, 3 or 5 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 16, 38, 103, 281, 826, 2421, 7104,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 04 2018 11:28:48, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 4\,a(n-2) + 3\,a(n-3) - 13\,a(n-4) - 20\,a(n-5) + 6\,a(n-6) - 21\,a(n-7) + 23\,a(n-8) + 63\,a(n-9) + 36\,a(n-10) + 14\,a(n-11) - 55\,a(n-12) - 43\,a(n-13) - 7\,a(n-14) + 26\,a(n-15) + 25\,a(n-16) - 6\,a(n-17) + 4\,a(n-18) - 4\,a(n-20)
\end{equation}
for all $n>20$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A304014.
