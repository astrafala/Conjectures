...
\title{The empirical recurrence for OEIS A252272, proved by transfer matrix}
...
\begin{abstract}
OEIS A252272 counts $(n+2)\times4$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252272 is ``Number of (n+2)X(2+2) 0..3 arrays with every 3X3 subblock row and column sum not equal to 2 3 4 6 or 7 and every 3X3 diagonal and antidiagonal sum equal to 2 3 4 6 or 7.''. It has offset $1$ and begins
\[
185, 300, 588, 948, 2154, 4702, 7922, 18772,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 17*a(n-3) -90*a(n-6) +188*a(n-9) -184*a(n-12) +89*a(n-15) -21*a(n-18) +2*a(n-21) for n>22
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:00:09, revision 6) this is still
...
\[
\text{every row, column sum} \notin \{2,3,4,6,7\}\ \text{ and }\ \text{every diagonal, antidiagonal sum} \in \{2,3,4,6,7\}
\]
...
\begin{theorem}
\[
a(n)\;=\;17\,a(n-3) - 90\,a(n-6) + 188\,a(n-9) - 184\,a(n-12) + 89\,a(n-15) - 21\,a(n-18) + 2\,a(n-21)
\]
for every $n>22$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252272.
