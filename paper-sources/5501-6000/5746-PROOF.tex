...
\title{The empirical recurrence for OEIS A234878, proved by transfer matrix}
...
\begin{abstract}
OEIS A234878 counts $5$-column arrays over $\{0,\dots,4\}$ in which every
...
length $n$. Hence $a(n)=\mathbf{1}^{\!\top}M^{n}\mathbf{1}$ on $S=1280$ vertices, which
...
OEIS A234878 is ``Number of (n+1) X (4+1) 0..4 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 1, with no adjacent elements equal (constant-stress tilted 1 X 1 tilings).''. It has offset
$1$ and begins
\[
268, 628, 1116, 3336, 6364, 22748, 44540,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 20 2022 00:39:48, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 27\,a(n-2) - 55\,a(n-3) - 290\,a(n-4) + 607\,a(n-5) + 1617\,a(n-6) - 3524\,a(n-7) - 5091\,a(n-8) + 11799\,a(n-9) + 9192\,a(n-10) - 23475\,a(n-11) - 9214\,a(n-12) + 27620\,a(n-13) + 4652\,a(n-14) - 18518\,a(n-15) - 912\,a(n-16) + 6476\,a(n-17) - 912\,a(n-19)
\end{equation}
...
Let $V$ consist of those $r\in\{0,\dots,4\}^{5}$ with $r_j\ne r_{j+1}$ for every
$j$ --- the rows in which no two horizontally adjacent entries are equal, and put $S=|V|=1280$. For $r,s\in V$ declare $r\to s$ an edge
...
Third, the vanishing test of Lemma~\ref{lem:crit} was carried past $S=1280$ consecutive
zeros rather than to a sampled prefix, in exact integer arithmetic.

\begin{thebibliography}{9}
\bibitem{oeis} The OEIS Foundation, \emph{The On-Line Encyclopedia of Integer
Sequences}, \url{https://oeis.org}, 2026. Sequence A234878.
