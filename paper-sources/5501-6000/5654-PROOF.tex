...
\title{The empirical recurrence for OEIS A260495, proved by transfer matrix}
...
\begin{abstract}
OEIS A260495 counts $(n+2)\times4$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A260495 is ``Number of (n+2)X(2+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000001 00000011 or 00001011.''. It has offset $1$ and begins
\[
83, 136, 347, 683, 942, 2115, 4393, 6800,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 12:07:51, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-3) + 6\,a(n-4) - 7\,a(n-6) - 18\,a(n-7) - 10\,a(n-8) + 5\,a(n-9) + 7\,a(n-10) + 16\,a(n-11) + 6\,a(n-12) - 4\,a(n-13) - 3\,a(n-15) - 2\,a(n-16) + a(n-17)
\]
for every $n>19$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A260495.
