...
\title{The empirical recurrence for OEIS A297632, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297632 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A297632 is ``Number of nX3 0..1 arrays with every 1 horizontally, diagonally or antidiagonally adjacent to 0, 2 or 3 neighboring 1s.''. It has offset $1$ and begins
\[
5, 29, 113, 494, 2344, 10587, 48187, 222804,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 02 2018 11:55:34, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;7\,a(n-1) - 11\,a(n-2) + 33\,a(n-3) - 184\,a(n-4) + 159\,a(n-5) - 265\,a(n-6) + 1190\,a(n-7) - 508\,a(n-8) + 20\,a(n-9) - 1256\,a(n-10) + 664\,a(n-11) + 1408\,a(n-12) - 2464\,a(n-13) + 1024\,a(n-14) - 768\,a(n-15)
\end{equation}
for all $n>16$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297632.
