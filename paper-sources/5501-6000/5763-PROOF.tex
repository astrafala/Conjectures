...
\title{The empirical recurrence for OEIS A196538, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A196538 counts arrays over $\{0,\dots,4\}$ in which every cell is constrained by the
...
OEIS A196538 is ``Number of nX2 0..4 arrays with each element equal to the number its horizontal and vertical neighbors less than or equal to itself.''. It has offset $1$ and begins
\[
3, 23, 56, 461, 2897, 17967, 116911, 757146,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 06:35:34, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 22\,a(n-2) + 24\,a(n-3) - 86\,a(n-4) - 296\,a(n-5) - 126\,a(n-6) + 428\,a(n-7) + 420\,a(n-8) + 239\,a(n-9) + 92\,a(n-10) - 147\,a(n-11) + 22\,a(n-12) + 26\,a(n-13) - 13\,a(n-14) + 5\,a(n-15)
\end{equation}
for all $n>16$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A196538.
