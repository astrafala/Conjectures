...
\title{The empirical recurrence for OEIS A206885, proved by transfer matrix}
...
\begin{abstract}
OEIS A206885 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
$(0,1,0)$ along one axis and $(1,0,0)$ along the other, and carries an empirical recurrence of
order $21$ contributed by R.~H.~Hardin. It is true. The patterns have length $3$, so
...
$\mathbf{1}^{\!\top}P^{\,n-2-21}q(P)\mathbf{1}$, which vanishes identically
...
OEIS A206885 is ``Number of nX4 0..1 arrays avoiding 0 1 0 horizontally and 1 0 0 vertically.''. It has offset
$1$ and begins
\[
12, 144, 1103, 7878, 51800, 330951, 2070564,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 13:14:08, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;11\,a(n-1) - 14\,a(n-2) - 193\,a(n-3) + 496\,a(n-4) + 1310\,a(n-5) - 4382\,a(n-6) - 4486\,a(n-7) + 18762\,a(n-8) + 8132\,a(n-9) - 44696\,a(n-10) - 6382\,a(n-11) + 61529\,a(n-12) - 2253\,a(n-13) - 48436\,a(n-14) + 8149\,a(n-15) + 20392\,a(n-16) - 5560\,a(n-17) - 3842\,a(n-18) + 1352\,a(n-19) + 192\,a(n-20) - 80\,a(n-21)
\end{equation}
for all $n>21$. 
...
$a(n)-\sum_i c_i a(n-i)=u_{\,n-2-21}$ whenever $n-21\ge2$. Hence
\eqref{eq:conj} holds for every $n>t$ exactly when $u_j=0$ for every
$j>t-2-21$. Moreover $(u_j)$ satisfies the monic linear recurrence whose
...
$P^{\,n-2-21}$ gives the identity. The equivalence follows by letting the exponent
...
\begin{proof}
The vector $q(P)\mathbf{1}\in\mathbb{Z}^{S}$ was formed by $21$ matrix--vector
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206885.
