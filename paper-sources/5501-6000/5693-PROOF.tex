...
\title{The empirical recurrence for OEIS A283126, proved by transfer matrix}
...
\begin{abstract}
OEIS A283126 counts $n\times4$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A283126 is ``Number of nX4 0..1 arrays with no 1 equal to more than two of its horizontal and vertical neighbors.''. It has offset $1$ and begins
\[
16, 209, 2521, 30824, 376359, 4598361, 56176300, 686250407,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 01 2017 09:50:26, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;9\,a(n-1) + 26\,a(n-2) + 147\,a(n-3) + 173\,a(n-4) + 239\,a(n-5) - 710\,a(n-6) - 328\,a(n-7) + 319\,a(n-8) - 316\,a(n-9) - 271\,a(n-10) + 194\,a(n-11) + 8\,a(n-12) - 167\,a(n-13) + 28\,a(n-14) + 70\,a(n-15) - 2\,a(n-16) - 8\,a(n-17)
\]
for every $n>17$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A283126.
