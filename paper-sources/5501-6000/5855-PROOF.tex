...
\title{The empirical recurrence for OEIS A252213, proved by transfer matrix}
...
\begin{abstract}
OEIS A252213 counts $(n+2)\times4$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
every $3\times3$ subblock, and it carries an empirical recurrence of order $17$
...
OEIS A252213 is ``Number of (n+2)X(2+2) 0..3 arrays with every 3X3 subblock row, column, diagonal and antidiagonal sum not equal to 0 2 5 6 or 7.''. It has offset $1$ and begins
\[
1212, 1078, 1437, 2836, 6674, 17478, 47580, 130032,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 10:56:58, revision 6) this is still
...
\begin{proof}
The vector $w=q(M)\mathbf{1}$ was formed by $17$ matrix--vector products in exact
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252213.
