...
\title{The empirical recurrence for OEIS A250513, proved by transfer matrix}
...
\begin{abstract}
OEIS A250513 counts arrays over $\{0,1,2,3\}$ in which a statistic taken over short runs
...
OEIS A250513 is ``Number of (n+1)X(2+1) 0..3 arrays with nondecreasing min(x(i,j),x(i,j-1)) in the i direction and nondecreasing min(x(i,j),x(i-1,j)) in the j direction.''. It has offset $1$ and begins
\[
889, 14660, 205022, 2817780, 36999777, 480626844, 6146257386, 78207667892,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 12:29:05, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;20\,a(n-1) - 25\,a(n-2) - 1400\,a(n-3) + 5769\,a(n-4) + 23616\,a(n-5) - 132975\,a(n-6) - 127632\,a(n-7) + 1074132\,a(n-8) + 385732\,a(n-9) - 4202228\,a(n-10) - 1161728\,a(n-11) + 8517056\,a(n-12) + 2583408\,a(n-13) - 9166944\,a(n-14) - 3219264\,a(n-15) + 4980096\,a(n-16) + 2018304\,a(n-17) - 1078272\,a(n-18) - 497664\,a(n-19)
\]
for every $n>18$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250513.
