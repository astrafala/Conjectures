...
\title{The empirical recurrence for OEIS A251795, proved by transfer matrix}
...
\begin{abstract}
OEIS A251795 counts $(n+1)\times3$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A251795 is ``Number of (n+1)X(2+1) 0..3 arrays with no 2X2 subblock having x11-x00 less than x10-x01.''. It has offset $1$ and begins
\[
1080, 28932, 724300, 18577404, 474547100, 12140516092, 310512400748, 7942655953980,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 10:31:38, revision 7) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;30\,a(n-1) - 40\,a(n-2) - 2202\,a(n-3) + 7167\,a(n-4) + 41092\,a(n-5) - 170647\,a(n-6) - 169762\,a(n-7) + 1201353\,a(n-8) - 237196\,a(n-9) - 3305290\,a(n-10) + 2262184\,a(n-11) + 3737187\,a(n-12) - 3793360\,a(n-13) - 1475516\,a(n-14) + 2385944\,a(n-15) - 12352\,a(n-16) - 613952\,a(n-17) + 105792\,a(n-18) + 54144\,a(n-19) - 13824\,a(n-20)
\end{equation}
for all $n>19$.
...
\[
a(n)-\sum_i c_i\,a(n-i)\;=\;\mathbf{1}^{\!\top}M^{\,n+1-1-20}\,q(M)\,\mathbf{1} .
\]
...
=\mathbf{1}^{\!\top}M^{\,m-20}\,q(M)\,\mathbf{1}
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251795.
