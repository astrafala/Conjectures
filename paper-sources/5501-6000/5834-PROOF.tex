...
\title{The empirical recurrence for OEIS A302821, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A302821 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A302821 is ``Number of 3Xn 0..1 arrays with every element equal to 0, 1, 2, 4 or 5 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
4, 25, 75, 220, 731, 2419, 7900, 25645,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 13 2018 13:24:38, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) - 9\,a(n-2) + 2\,a(n-4) - 18\,a(n-5) + 37\,a(n-6) + 34\,a(n-7) + 5\,a(n-8) - 52\,a(n-9) - 118\,a(n-10) - 24\,a(n-11) + 190\,a(n-12) + 10\,a(n-13) - 68\,a(n-14) + 12\,a(n-15)
\end{equation}
for all $n>16$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302821.
