...
\title{The empirical recurrence for OEIS A237561, proved by transfer matrix}
...
\begin{abstract}
OEIS A237561 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
The condition is local to two consecutive rows, so the count is a walk count on $S=316$
...
OEIS A237561 is ``Number of (n+1)X(2+1) 0..2 arrays with the upper median plus the lower median of every 2X2 subblock differing from its horizontal and vertical neighbors by exactly one.''. It has offset $1$ and begins
\[
316, 1536, 7356, 36168, 175768, 848720, 4121060, 20050460,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 10:17:57, revision 6) this is still
...
differ by $1$. The entry's first term $316$ counts those, and the model was made to
...
\]
over the $S=316$ pairs whose own subblock row already satisfies the condition along itself.
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-2) + 42\,a(n-3) + 208\,a(n-4) + 293\,a(n-5) + 900\,a(n-6) - 12\,a(n-7) - 857\,a(n-8) - 1583\,a(n-9) - 4726\,a(n-10) + 4946\,a(n-11) + 5993\,a(n-12) + 3312\,a(n-13) + 3822\,a(n-14) - 3319\,a(n-15) - 540\,a(n-16) - 32\,a(n-17)
\]
for every $n>17$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237561.
