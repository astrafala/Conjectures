...
\title{The empirical recurrence for OEIS A207841, proved by transfer matrix}
...
\begin{abstract}
OEIS A207841 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
...
OEIS A207841 is ``Number of nX4 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 0 0 and 1 1 1 vertically.''. It has offset
$1$ and begins
\[
10, 100, 180, 780, 2816, 9672, 35952,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:20:50, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-2) + 36\,a(n-3) + 6\,a(n-4) + 2\,a(n-5) - 84\,a(n-6) + 34\,a(n-7) + 89\,a(n-8) - 260\,a(n-9) + 91\,a(n-10) - 42\,a(n-11) + 84\,a(n-12) - 2\,a(n-13) + 8\,a(n-14) + 36\,a(n-15) + 3\,a(n-16) + a(n-18)
\end{equation}
for all $n>20$. 
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207841.
