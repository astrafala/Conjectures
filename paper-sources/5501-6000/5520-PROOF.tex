...
\title{The empirical recurrence for OEIS A252204, proved by transfer matrix}
...
\begin{abstract}
OEIS A252204 counts $(n+2)\times4$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252204 is ``Number of (n+2)X(2+2) 0..3 arrays with every 3X3 subblock row and column sum equal to 1 3 4 6 or 7 and every 3X3 diagonal and antidiagonal sum not equal to 1 3 4 6 or 7.''. It has offset $1$ and begins
\[
4743, 5178, 17276, 44322, 215814, 932474, 2568954, 12883538,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 10:55:54, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;118\,a(n-3) - 4263\,a(n-6) + 55050\,a(n-9) - 221016\,a(n-12) + 206976\,a(n-15) + 225280\,a(n-18) - 262144\,a(n-21)
\]
for every $n>25$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252204.
