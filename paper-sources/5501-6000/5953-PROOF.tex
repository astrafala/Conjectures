...
\title{The empirical recurrence for OEIS A188768, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A188768 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A188768 is ``Number of nX3 binary arrays without the pattern 0 1 0 vertically or horizontally.''. It has offset $1$ and begins
\[
7, 49, 240, 1103, 5357, 26564, 130828, 641137,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 04:50:17, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) - 6\,a(n-2) + 23\,a(n-3) + 18\,a(n-4) + 5\,a(n-5) + 49\,a(n-6) - 30\,a(n-7) - 87\,a(n-8) - 6\,a(n-9) + 19\,a(n-10) + 8\,a(n-11) + 5\,a(n-12) - a(n-13) - a(n-14)
\end{equation}
for all $n>15$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A188768.
