...
\title{The empirical recurrence for OEIS A282787, proved by transfer matrix}
...
\begin{abstract}
OEIS A282787 counts $n\times4$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A282787 is ``Number of n X 4 0..1 arrays with no 1 equal to more than one of its king-move neighbors, with the exception of exactly one element.''. It has offset $1$ and begins
\[
2, 16, 318, 1952, 16584, 119176, 832218, 5780340,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 26 2024 01:19:21, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + 28\,a(n-2) + 26\,a(n-3) - 404\,a(n-4) - 1508\,a(n-5) - 2631\,a(n-6) - 1242\,a(n-7) + 1650\,a(n-8) + 5880\,a(n-9) + 5486\,a(n-10) + 2762\,a(n-11) - 2635\,a(n-12) - 3886\,a(n-13) - 3543\,a(n-14) - 896\,a(n-15) - 39\,a(n-16) + 322\,a(n-17) - 49\,a(n-18)
\]
for every $n>18$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A282787.
