...
\title{The empirical recurrence for OEIS A317730, proved by transfer matrix}
...
\begin{abstract}
OEIS A317730 counts $5$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $different from$ itself lying in $\{1,2,3,4,5,6,7,8\}$, and it carries an empirical
recurrence of order $21$ contributed by R.~H.~Hardin. It is true. The neighbourhood
...
OEIS A317730 is ``Number of nX5 0..1 arrays with every element unequal to 1, 2, 3, 4, 5, 6, 7 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
3, 383, 9541, 293378, 8931649, 270714329, 8216055128, 249314217853,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 05 2018 15:48:13, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;22\,a(n-1) + 209\,a(n-2) + 1293\,a(n-3) + 1519\,a(n-4) - 399\,a(n-5) - 23135\,a(n-6) - 10823\,a(n-7) - 23737\,a(n-8) + 123837\,a(n-9) - 47151\,a(n-10) + 125395\,a(n-11) - 208271\,a(n-12) + 64615\,a(n-13) - 97033\,a(n-14) + 92151\,a(n-15) + 1586\,a(n-16) + 11269\,a(n-17) - 11258\,a(n-18) - 240\,a(n-19) - 216\,a(n-20) + 432\,a(n-21)
\end{equation}
for all $n>21$.
...
$a(n)-\sum_i c_i a(n-i)=u_{\,n-2-21}$ whenever $n-21\ge2$. So \eqref{eq:conj}
holds for every $n>t$ exactly when $u_j=0$ for all $j>t-2-21$. Moreover $(u_j)$
...
\begin{proof}
Substituting Lemma~\ref{lem:walk} and factoring $P^{\,n-2-21}$ out of
...
\begin{theorem}
The recurrence \eqref{eq:conj} holds for every $n>21$. This is the statement of
Section~1.
\end{theorem}

\begin{proof}
The vector $q(P)\mathbf{e}\in\mathbb{Z}^{S}$ was formed by $21$ matrix--vector
products in exact integer arithmetic and the $u_j$ evaluated against $\mathbf{s}$ in turn.
They vanish from the index corresponding to $n=21+1$ onwards, and the run was continued
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A317730.
