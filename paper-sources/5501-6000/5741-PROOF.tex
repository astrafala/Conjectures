...
\title{The empirical recurrence for OEIS A236740, proved by transfer matrix}
...
\begin{abstract}
OEIS A236740 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
The condition is local to two consecutive rows, so the count is a walk count on $S=93$
...
OEIS A236740 is ``Number of (n+1)X(2+1) 0..2 arrays with the upper median plus the lower median of every 2X2 subblock equal.''. It has offset $1$ and begins
\[
267, 1411, 7377, 46377, 300555, 2045011, 14169625, 99629489,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 09:31:03, revision 6) this is still
...
array, which is not among the objects counted. There are $S=93$ states left.
...
\begin{theorem}
\[
a(n)\;=\;17\,a(n-1) - 78\,a(n-2) - 142\,a(n-3) + 1902\,a(n-4) - 2258\,a(n-5) - 14868\,a(n-6) + 37484\,a(n-7) + 39431\,a(n-8) - 204023\,a(n-9) + 60026\,a(n-10) + 473554\,a(n-11) - 502900\,a(n-12) - 310088\,a(n-13) + 766120\,a(n-14) - 297584\,a(n-15) - 171072\,a(n-16) + 157120\,a(n-17) - 32640\,a(n-18)
\]
for every $n>17$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A236740.
