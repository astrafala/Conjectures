...
\title{The empirical recurrence for OEIS A303526, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A303526 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A303526 is ``Number of 3Xn 0..1 arrays with every element equal to 0, 1, 3, 4, 5 or 6 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
4, 6, 18, 37, 80, 286, 916, 2532,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 25 2018 12:41:48, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 3\,a(n-2) + a(n-3) + 30\,a(n-4) - 53\,a(n-5) - 102\,a(n-6) + 11\,a(n-7) - 227\,a(n-8) + 351\,a(n-9) + 784\,a(n-10) - 242\,a(n-11) + 351\,a(n-12) - 361\,a(n-13) - 1069\,a(n-14) + 577\,a(n-15) + 8\,a(n-16) + 28\,a(n-17) + 22\,a(n-18) - 11\,a(n-19) - a(n-20)
\end{equation}
for all $n>21$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A303526.
