...
\title{The empirical recurrence for OEIS A202312, proved by transfer matrix}
...
\begin{abstract}
OEIS A202312 counts arrays of width $5$ over $\{0,1\}$ containing no occurrence of certain short
patterns, read along the rows, the columns or the diagonals. The entry carries an empirical
recurrence of order $24$ contributed by R.~H.~Hardin. It is true, and it is decidable
...
OEIS A202312 is ``Number of (n+2)X5 binary arrays avoiding patterns 001 and 100 in rows and columns.''. It has offset $1$ and begins
\[
1144, 7835, 60362, 482118, 3922195, 32097834, 263496670, 2165338373,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 09:31:39, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;15\,a(n-1) - 46\,a(n-2) - 236\,a(n-3) + 1457\,a(n-4) - 378\,a(n-5) - 10889\,a(n-6) + 15984\,a(n-7) + 30274\,a(n-8) - 79303\,a(n-9) - 15775\,a(n-10) + 166748\,a(n-11) - 78659\,a(n-12) - 154849\,a(n-13) + 154482\,a(n-14) + 35466\,a(n-15) - 100861\,a(n-16) + 28186\,a(n-17) + 19289\,a(n-18) - 12510\,a(n-19) + 906\,a(n-20) + 889\,a(n-21) - 181\,a(n-22) - 12\,a(n-23) + 4\,a(n-24)
\]
for every $n>23$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A202312.
