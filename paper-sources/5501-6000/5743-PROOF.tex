...
\title{The empirical recurrence for OEIS A235180, proved by transfer matrix}
...
\begin{abstract}
OEIS A235180 counts $3$-column arrays over $\{0,\dots,5\}$ in which every
...
OEIS A235180 is ``Number of (n+1) X (2+1) 0..5 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 5, with no adjacent elements equal (constant-stress tilted 1 X 1 tilings).''. It has offset
$1$ and begins
\[
212, 560, 1400, 3796, 9780, 27080, 71244,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 19 2022 02:18:12, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 29\,a(n-2) - 88\,a(n-3) - 327\,a(n-4) + 1003\,a(n-5) + 1816\,a(n-6) - 5577\,a(n-7) - 5295\,a(n-8) + 15566\,a(n-9) + 8705\,a(n-10) - 20575\,a(n-11) - 9813\,a(n-12) + 12552\,a(n-13) + 5962\,a(n-14) - 3436\,a(n-15) - 1676\,a(n-16) + 336\,a(n-17) + 168\,a(n-18)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A235180.
