...
\title{The empirical recurrence for OEIS A234374, proved by transfer matrix}
...
\begin{abstract}
OEIS A234374 counts arrays of width $3$ over $\{0,1,2\}$ containing no run of $3$ consecutive
cells, taken along a named direction of the grid, whose entries are strictly increasing. The entry carries
an empirical recurrence of order $19$ contributed by R.~H.~Hardin. It is true, and it is
decidable rather than empirical: every such run lies inside $3$ consecutive array rows, so
the count is a walk count on $S=757$ states.
\end{abstract}
...
OEIS A234374 is ``Number of (n+2) X (1+2) 0..2 arrays with no increasing sequence of length 3 vertically, diagonally downwards or antidiagonally downwards.''. It has offset $1$ and begins
\[
16584, 372690, 8280018, 183669567, 4070647527, 90202925160, 1998695595393, 44285957330064,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 20 2025 13:52:05, revision 8) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=757,\quad\tau=\mathbf{1} .
\]
...
\begin{theorem}
\[
a(n)\;=\;25\,a(n-1) - a(n-2) - 1496\,a(n-3) + 1581\,a(n-4) + 26414\,a(n-5) - 21436\,a(n-6) - 163909\,a(n-7) + 88557\,a(n-8) + 442265\,a(n-9) - 137417\,a(n-10) - 545671\,a(n-11) + 88129\,a(n-12) + 301041\,a(n-13) - 29854\,a(n-14) - 68212\,a(n-15) + 5810\,a(n-16) + 3264\,a(n-17) - 396\,a(n-18) + 36\,a(n-19)
\]
for every $n>16$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234374.
