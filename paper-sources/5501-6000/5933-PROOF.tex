...
\title{The empirical recurrence for OEIS A253733, proved by transfer matrix}
...
\begin{abstract}
OEIS A253733 counts arrays of width $3$ over $\{0,1\}$ in which the sum of the main diagonal minus the sum of the antidiagonal of every $2\times2$ and $3\times3$ subblock differs from the same number at the neighbouring subblock. The entry carries an
...
$4$ consecutive rows and the count is a walk count on $S=277$ states.
\end{abstract}
...
OEIS A253733 is ``Number of (n+2)X(1+2) 0..1 arrays with every 2X2 and 3X3 subblock diagonal sum minus antidiagonal sum unequal to its neighbors horizontally and vertically.''. It has offset $1$ and begins
\[
218, 720, 2212, 6932, 22236, 70372, 222820, 706884,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 14:11:24, revision 6) this is still
...
Thus
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=277,
\]
...
\begin{theorem}
\[
a(n)\;=\;a(n-2) + 15\,a(n-3) + 44\,a(n-4) + 26\,a(n-5) + 36\,a(n-6) - 241\,a(n-7) - 190\,a(n-8) - 589\,a(n-9) - 530\,a(n-10) - 920\,a(n-11) - 1248\,a(n-12) - 800\,a(n-13) - 384\,a(n-14)
\]
for every $n>15$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253733.
