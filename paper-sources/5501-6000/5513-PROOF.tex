...
\title{The empirical recurrence for OEIS A297546, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297546 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A297546 is ``Number of 3Xn 0..1 arrays with every 1 horizontally, diagonally or antidiagonally adjacent to 2 or 3 neighboring 1s.''. It has offset $1$ and begins
\[
1, 4, 35, 93, 197, 905, 4617, 17190,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 31 2017 15:05:37, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) - 4\,a(n-2) + 17\,a(n-3) + 22\,a(n-4) - 76\,a(n-5) - 55\,a(n-6) - 66\,a(n-7) - 151\,a(n-8) + 47\,a(n-9) + 101\,a(n-10) - 39\,a(n-11) + 43\,a(n-12) + 60\,a(n-13) - 21\,a(n-14) + 7\,a(n-15) + 2\,a(n-16) + a(n-17)
\end{equation}
for all $n>18$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297546.
