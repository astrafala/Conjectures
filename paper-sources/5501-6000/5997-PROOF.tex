...
\title{The empirical recurrence for OEIS A298315, proved by transfer matrix}
...
\begin{abstract}
OEIS A298315 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $equal to$ itself lying in $\{0,1,3,4,6\}$, and it carries an empirical
...
OEIS A298315 is ``Number of nX3 0..1 arrays with every element equal to 0, 1, 3, 4 or 6 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
3, 3, 3, 9, 17, 48, 94, 234,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 17 2018 07:13:34, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 4\,a(n-2) + 12\,a(n-3) - 15\,a(n-4) - 40\,a(n-5) - 53\,a(n-6) + 62\,a(n-7) + 133\,a(n-8) + 92\,a(n-9) - 92\,a(n-10) - 146\,a(n-11) - 11\,a(n-12) + 102\,a(n-13) + 49\,a(n-14) - 49\,a(n-15) - 64\,a(n-16) - 48\,a(n-17)
\end{equation}
for all $n>18$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A298315.
