...
\title{The empirical recurrence for OEIS A232151, proved by transfer matrix}
...
\begin{abstract}
OEIS A232151 counts arrays of width $3$ over $\{0,1,2\}$ in which every cell carrying one stated
...
OEIS A232151 is ``Number of 3Xn 0..2 arrays with every 0 next to a 1 and every 1 next to a 2 horizontally, diagonally or antidiagonally.''. It has offset $1$ and begins
\[
1, 145, 3669, 67725, 1345057, 27888353, 572956549, 11720173753,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 06:55:22, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;15\,a(n-1) + 68\,a(n-2) + 683\,a(n-3) + 4587\,a(n-4) + 1332\,a(n-5) - 32302\,a(n-6) - 47941\,a(n-7) - 49247\,a(n-8) - 33578\,a(n-9) + 48420\,a(n-10) + 25707\,a(n-11) + 23404\,a(n-12) + 22761\,a(n-13) + 1376\,a(n-14) + 2938\,a(n-15) - 66\,a(n-16) - 640\,a(n-17) + 368\,a(n-18) - 240\,a(n-19)
\]
for every $n>18$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232151.
