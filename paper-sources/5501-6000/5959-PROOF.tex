...
\title{The empirical recurrence for OEIS A202910, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A202910 counts arrays over $\{0,\dots,7\}$ in which every cell is constrained by the
...
OEIS A202910 is ``Number of nX2 0..7 arrays with every nonzero element less than or equal to some horizontal or vertical neighbor.''. It has offset $1$ and begins
\[
8, 680, 31984, 1194376, 44344428, 1707628408, 66085464308, 2542636404496,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 09:56:51, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;36\,a(n-1) - 238\,a(n-2) + 11172\,a(n-3) + 34719\,a(n-4) + 951582\,a(n-5) + 3347114\,a(n-6) + 29399988\,a(n-7) + 80056473\,a(n-8) + 374118253\,a(n-9) + 709288548\,a(n-10) + 1969872705\,a(n-11) + 2317452024\,a(n-12) + 3743198992\,a(n-13) + 2076708096\,a(n-14) + 1625702400\,a(n-15)
\end{equation}
for all $n>16$.
...
$8$ values, so there are about $10^{27}$ of them to sift. The
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A202910.
