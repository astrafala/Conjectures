...
\title{The empirical recurrence for OEIS A259247, proved by transfer matrix}
...
\begin{abstract}
OEIS A259247 counts arrays of width $6$ over $\{0,1\}$ subject to a condition read round the
...
OEIS A259247 is ``Number of (n+1)X(5+1) 0..1 arrays with each 2X2 subblock having clockwise pattern 0000 0011 or 0111.''. It has offset $1$ and begins
\[
255, 1733, 10720, 71313, 451481, 2964676, 18970267, 123694345,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:49:41, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) + 49\,a(n-2) - 268\,a(n-3) - 920\,a(n-4) + 4050\,a(n-5) + 9218\,a(n-6) - 25662\,a(n-7) - 49822\,a(n-8) + 62672\,a(n-9) + 120020\,a(n-10) - 35270\,a(n-11) - 81969\,a(n-12) + 4820\,a(n-13) + 15497\,a(n-14) - 596\,a(n-15) - 536\,a(n-16) + 24\,a(n-17)
\]
for every $n>17$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A259247.
