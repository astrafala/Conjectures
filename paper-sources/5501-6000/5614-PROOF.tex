...
\title{The empirical recurrence for OEIS A233595, proved by transfer matrix}
...
\begin{abstract}
OEIS A233595 counts arrays of width $3$ over $\{0,1,2\}$ containing no run of $3$ consecutive
...
OEIS A233595 is ``Number of (n+2)X(1+2) 0..2 arrays with no increasing sequence of length 3 horizontally, vertically or antidiagonally downwards.''. It has offset $1$ and begins
\[
15272, 342185, 7610545, 169129037, 3756984641, 83451469774, 1853608731449, 41171843204299,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 08:05:05, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;25\,a(n-1) + 2\,a(n-2) - 1549\,a(n-3) + 1359\,a(n-4) + 35322\,a(n-5) - 27013\,a(n-6) - 345233\,a(n-7) + 159641\,a(n-8) + 1285880\,a(n-9) - 375833\,a(n-10) - 2431870\,a(n-11) + 439479\,a(n-12) + 2628508\,a(n-13) - 276145\,a(n-14) - 1679602\,a(n-15) + 92032\,a(n-16) + 613439\,a(n-17) - 14601\,a(n-18) - 111609\,a(n-19) + 738\,a(n-20) + 6490\,a(n-21) + 22\,a(n-22) - 121\,a(n-23)
\]
for every $n>20$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A233595.
