...
\title{The empirical recurrence for OEIS A299047, proved by transfer matrix}
...
\begin{abstract}
OEIS A299047 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A299047 is ``Number of n X 3 0..1 arrays with every element equal to 0, 1, 3, 4, 5 or 6 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
3, 4, 11, 40, 79, 480, 1542, 5317,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 22 2022 01:43:44, revision
6) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 5\,a(n-2) + 21\,a(n-3) - 39\,a(n-4) - 61\,a(n-5) - 56\,a(n-6) + 110\,a(n-7) + 183\,a(n-8) + 50\,a(n-9) - 27\,a(n-10) - 125\,a(n-11) - 64\,a(n-12) - 141\,a(n-13) + 36\,a(n-14) + 5\,a(n-15) + 8\,a(n-16) + 6\,a(n-17)
\end{equation}
for all $n>18$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A299047.
