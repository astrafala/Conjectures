...
\title{The empirical recurrence for OEIS A196648, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A196648 counts arrays over $\{0,\dots,4\}$ in which every cell is constrained by the
...
OEIS A196648 is ``Number of n X 3 0..4 arrays with each element x equal to the number its horizontal and vertical neighbors equal to 3,4,0,2,1 for x=0,1,2,3,4.''. It has offset $1$ and begins
\[
2, 10, 27, 76, 248, 735, 2178, 6622,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 02 2023 13:16:30, revision 7) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + a(n-2) + 5\,a(n-3) + a(n-4) + 5\,a(n-5) + 9\,a(n-6) + 5\,a(n-7) - 3\,a(n-8) - 8\,a(n-9) - 14\,a(n-11) - 9\,a(n-12) - 2\,a(n-13) + a(n-14) + 2\,a(n-15)
\end{equation}
for all $n>16$.
...
\#\{\text{neighbours with value }f(x_{t,u})\}=x_{t,u},\quad f=(3,4,0,2,1)
\end{equation}
for every cell $(t,u)$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A196648.
