...
\title{The empirical recurrence for OEIS A207113, proved by transfer matrix}
...
\begin{abstract}
OEIS A207113 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
$(0,0,1), (1,1,0)$ along one axis and $(0,0,0), (0,1,1)$ along the other, and carries an empirical recurrence of
...
OEIS A207113 is ``Number of 4Xn 0..1 arrays avoiding 0 0 0 and 0 1 1 horizontally and 0 0 1 and 1 1 0 vertically.''. It has offset
$1$ and begins
\[
8, 64, 200, 643, 1835, 4534, 11511,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 13:29:21, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 5\,a(n-2) - 4\,a(n-3) - 23\,a(n-4) + 4\,a(n-5) + 40\,a(n-6) + 19\,a(n-7) - 38\,a(n-8) - 28\,a(n-9) - a(n-11) + 13\,a(n-12) + 38\,a(n-13) + 15\,a(n-14) - 31\,a(n-15) - 24\,a(n-16) - 2\,a(n-17) + 9\,a(n-18) + 6\,a(n-19) + 6\,a(n-20) - 2\,a(n-21) - 3\,a(n-22) - a(n-23) + a(n-24)
\end{equation}
...
$(0,0,1), (1,1,0)$ as $3$ consecutive entries. There are $8$ admissible columns; that condition
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207113.
