...
\title{The empirical recurrence for OEIS A254581, proved by transfer matrix}
...
\begin{abstract}
OEIS A254581 counts the arrays over $\{0,\dots,1\}$ whose $3\times3$ subblocks carry a
...
so the count is a walk count on $S=2592$ states --- the last two array rows together with the
...
OEIS A254581 is ``Number of (n+2)X(3+2) 0..1 arrays with every 3X3 subblock sum of the two medians of the central row and the central column and the two maximums of the diagonal and antidiagonal nondecreasing horizontally, vertically and ne-to-sw antidiagonally.''. It has offset $1$ and begins
\[
15051, 96756, 774168, 5852880, 42278366, 305579066, 2204567802, 15863354126,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 14:50:53, revision 6) this is still
...
\]
on the $S=2592$ reachable states. In particular $a$ is $C$-finite. The alignment of the walk
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) + 20\,a(n-2) - 58\,a(n-3) - 54\,a(n-4) - 912\,a(n-5) - 345\,a(n-6) + 4548\,a(n-7) + 3996\,a(n-8) + 7744\,a(n-9) - 19200\,a(n-10) - 44864\,a(n-11) + 45920\,a(n-12) + 28416\,a(n-13) - 66176\,a(n-14) + 21504\,a(n-15) + 52224\,a(n-16) - 16384\,a(n-17) - 16384\,a(n-18)
\]
for every $n>25$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A254581.
