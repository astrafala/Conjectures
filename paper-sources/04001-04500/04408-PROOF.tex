...
\title{The empirical recurrence for OEIS A283353, proved from an exact model}
...
\begin{abstract}
OEIS A283353 carries an empirical recurrence of order $3$. It is true, and it is
