...
\title{The empirical recurrence for OEIS A208403, proved by counting patterns}
...
\begin{abstract}
OEIS A208403 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A208403 is ``Number of n X 3 0..3 arrays with new values 0..3 introduced in row major order and no element equal to more than two of its immediate leftward or upward or right-upward antidiagonal neighbors.''. It has offset $1$ and begins
\[
5, 182, 10682, 667478, 42012698, 2646531062, 166729574522, 10503950018198,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 70*a(n-1) - 441*a(n-2) for n>3.
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 02 2018 10:07:36, revision 13) the statement is
...
\[
4!\Bigl(a(n)-\sum_i c_i\,a(n-i)\Bigr)\;=\;\mathbf{v}^{\!\top}N^{\,m-2}q(N)\mathbf{1} .
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208403.
