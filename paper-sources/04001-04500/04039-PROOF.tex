...
\title{The empirical recurrence for OEIS A262414, proved by transfer matrix}
...
\begin{abstract}
OEIS A262414 counts arrays of width $3$ over $\{0,1\}$ whose rows, read as base-$2$
numbers, are divisible by $3$ and whose columns, read the same way, are not divisible by
$3$. The entry carries an empirical recurrence of order $3$ contributed by
...
OEIS A262414 is ``Number of (n+1) X (2+1) 0..1 arrays with each row divisible by 3 and column not divisible by 3, read as a binary number with top and left being the most significant bits.''. It has offset $1$ and begins
\[
0, 4, 12, 48, 144, 468, 1404, 4320,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) + 3*a(n-2) - 9*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 31 2018 11:27:51, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A262414.
