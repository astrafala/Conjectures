...
\title{The empirical recurrence for OEIS A214143, proved by transfer matrix}
...
\begin{abstract}
OEIS A214143 counts the proper colourings of a grid $2\times(n+1)$, wrapped in the growing direction, with at most $5$ colours and
...
down to $S=40$ and makes the exact residual test affordable.
\end{abstract}
...
OEIS A214143 is ``Number of 0..4 colorings of a 2 X (n+1) array circular in the n+1 direction with new values 0..4 introduced in row major order.''. It has offset $1$ and begins
\[
4, 17, 257, 3074, 40434, 522515, 6800539, 88363628,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 10*a(n-1) + 50*a(n-2) - 116*a(n-3) - 361*a(n-4) + 106*a(n-5) + 312*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 22 2018 06:42:20, revision 10) this is still
...
state count is $S=40$ rather than the number of colourings.
...
\begin{theorem}
\[
a(n)\;=\;10\,a(n-1) + 50\,a(n-2) - 116\,a(n-3) - 361\,a(n-4) + 106\,a(n-5) + 312\,a(n-6)
\]
for every $n>5$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A214143.
