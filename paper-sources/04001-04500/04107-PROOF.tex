...
\title{The empirical recurrence for OEIS A252857, proved by transfer matrix}
...
\begin{abstract}
OEIS A252857 counts arrays of width $6$ over an alphabet of $3$ letters in which every three
...
OEIS A252857 is ``Number of (n+2) X (4+2) 0..2 arrays with every consecutive three elements in every row, column, diagonal and antidiagonal having exactly two distinct values, and new values 0 upwards introduced in row major order.''. It has offset $1$ and begins
\[
1719, 1296, 1962, 3582, 7002, 13590, 26766, 52650,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-2) + 4*a(n-3) + 6*a(n-4) - a(n-5) - 5*a(n-6) - 5*a(n-7) + 2*a(n-9) - a(n-10) for n>12.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 07 2018 11:50:39, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-2) + 4\,a(n-3) + 6\,a(n-4) - a(n-5) - 5\,a(n-6) - 5\,a(n-7) + 2\,a(n-9) - a(n-10)
\]
for every $n>12$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252857.
