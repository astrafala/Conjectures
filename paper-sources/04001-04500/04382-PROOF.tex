...
\title{The empirical recurrence for OEIS A283505, proved from an exact model}
...
\begin{abstract}
OEIS A283505 carries an empirical recurrence of order $3$. It is true, and it is
...
\[
1, 0, 101, 11, 10111, 1111, 1011111, 111111,\ \dots
\]
