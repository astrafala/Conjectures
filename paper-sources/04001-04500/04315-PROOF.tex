...
\title{The empirical recurrence for OEIS A286519, proved from an exact model}
...
\begin{abstract}
OEIS A286519 carries an empirical recurrence of order $2$. It is true, and it is
...
\[
1, 11, 101, 1111, 11111, 111111, 1111111, 11111111,\ \dots
\]
