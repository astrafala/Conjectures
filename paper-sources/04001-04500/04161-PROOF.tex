...
\title{The empirical recurrence for OEIS A282911, proved from an exact model}
...
\begin{abstract}
OEIS A282911 carries an empirical recurrence of order $5$. It is true, and it is
...
\[
1, 11, 111, 1101, 11001, 111011, 1111011, 11011011,\ \dots
\]
