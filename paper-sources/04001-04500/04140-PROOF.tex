...
\title{The empirical recurrence for OEIS A279500, proved from an exact model}
...
\begin{abstract}
OEIS A279500 carries an empirical recurrence of order $6$. It is true, and it is
