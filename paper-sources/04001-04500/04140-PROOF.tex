...
\title{The empirical recurrence for OEIS A208562, proved by counting patterns}
...
\begin{abstract}
OEIS A208562 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A208562 is ``Number of n X 3 0..2 arrays with new values 0..2 introduced in row major order and no element equal to more than one of its immediate leftward or upward or left-upward diagonal neighbors.''. It has offset $1$ and begins
\[
5, 68, 1059, 16608, 260856, 4098492, 64398564, 1011891888,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 22*a(n-1) - 110*a(n-2) + 180*a(n-3) - 60*a(n-4) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 05 2018 08:04:14, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;22\,a(n-1) - 110\,a(n-2) + 180\,a(n-3) - 60\,a(n-4)
\end{equation}
for all $n>5$.
...
\[
3!\Bigl(a(n)-\sum_i c_i\,a(n-i)\Bigr)\;=\;\mathbf{v}^{\!\top}N^{\,m-4}q(N)\mathbf{1} .
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208562.
