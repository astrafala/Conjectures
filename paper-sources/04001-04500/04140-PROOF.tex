...
\title{The empirical recurrence for OEIS A263660, proved by transfer matrix}
...
\begin{abstract}
OEIS A263660 carries an empirical recurrence of order $2$ contributed by R.~H.~Hardin. It is
...
OEIS A263660 is ``Number of length n arrays of permutations of 0..n-1 with each element moved by -2 to 2 places and with no two consecutive increases or two consecutive decreases.''. It has offset $1$ and begins
\[
1, 2, 4, 7, 8, 12, 16, 24,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-2) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 02 2019 11:29:54, revision 12) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A263660.
