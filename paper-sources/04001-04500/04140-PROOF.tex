...
\title{The empirical column recurrences for the table OEIS A299067}
...
\begin{abstract}
OEIS A299067 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A299067 is ``T(n,k) = Number of n X k 0..1 arrays with every element equal to 1, 2, 3, 4, 5 or 6 king-move adjacent elements, with upper left element zero.''. It has offset $1$, is
read by antidiagonals, and begins
\[
0, 1, 1, 1, 4, 1, 2, 18,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 22:59:38, revision 6) these are still
...
The sequence is ``Number of n X 2 0..1 arrays with every element equal to 1, 2, 3, 4, 5 or 6 king-move adjacent elements, with upper left element zero.''. Its rows are the vertices of a digraph on
...
model reproduces $9$ published values, $26$ decimal digits in all, every one of
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A299067.
