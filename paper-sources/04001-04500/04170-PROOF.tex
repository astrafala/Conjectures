...
\title{The empirical recurrence for OEIS A283214, proved from an exact model}
...
\begin{abstract}
OEIS A283214 carries an empirical recurrence of order $6$. It is true, and it is
...
OEIS A283214 is ``Binary representation of the x-axis, from the left edge to the origin, of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 597", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 10, 100, 1011, 10001, 101110, 1000100, 10111011,\ \dots
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A283214.
