...
\title{The empirical recurrence for OEIS A252330, proved by transfer matrix}
...
\begin{abstract}
OEIS A252330 counts $(n+2)\times6$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
$a(n)$ is a walk count on $S=772608$ vertices. Such a sequence is $C$-finite, so whether a given
...
OEIS A252330 is ``Number of (n+2)X(4+2) 0..3 arrays with every 3X3 subblock row and column sum equal to 0 3 5 6 or 8 and every 3X3 diagonal and antidiagonal sum not equal to 0 3 5 6 or 8.''. It has offset $1$ and begins
\[
10227, 9142, 22016, 63277, 214176, 632453, 1835652, 6821035,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:05:59, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;80\,a(n-3) - 2144\,a(n-6) + 23724\,a(n-9) - 158776\,a(n-12) + 799868\,a(n-15) - 3070635\,a(n-18) + 8464040\,a(n-21) - 16514775\,a(n-24) + 19850956\,a(n-27) + 507284\,a(n-30) - 49936700\,a(n-33) + 87410468\,a(n-36) - 81815088\,a(n-39) + 52347751\,a(n-42) - 24360640\,a(n-45) + 8126204\,a(n-48) - 1987776\,a(n-51) + 346880\,a(n-54) - 31744\,a(n-57) + 1024\,a(n-60)
\]
for every $n>64$.
\end{theorem}
...
exactly. Those integers vanish from the index corresponding to $n=64+1$ onwards, and the
run was continued until the working vector was identically zero, which settles all larger $j$
at once. By Lemma~\ref{lem:crit} the recurrence holds for every $n>64$.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252330.
