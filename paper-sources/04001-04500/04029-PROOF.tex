...
\title{The conjectured generating function for OEIS A282088, proved}
...
\begin{abstract}
OEIS A282088 counts arrays of a fixed width under a local condition, and carries a conjectured
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 05 2025 15:22:37, revision 28) this is still
