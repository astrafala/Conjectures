...
\title{The empirical recurrence for OEIS A285833, proved from an exact model}
...
\begin{abstract}
OEIS A285833 carries an empirical recurrence of order $6$. It is true, and it is
...
OEIS A285833 is ``Binary representation of the diagonal from the origin to the corner of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 107", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 11, 110, 1111, 1100, 111111, 11000, 11111111,\ \dots
\]
...
\begin{theorem}
\[
a(n)\;=\;111\,a(n-2) - 1110\,a(n-4) + 1000\,a(n-6)
\]
for every $n>12$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A285833.
