...
\title{The empirical recurrence for OEIS A269215, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A269215 counts arrays over $\{0,\dots,3\}$ subject to a condition on the array as a
...
OEIS A269215 is ``Number of 2 X n 0..3 arrays with some element plus some horizontally, diagonally or antidiagonally adjacent neighbor totalling three exactly once.''. It has offset $1$ and begins
\[
0, 96, 768, 6528, 49536, 360960, 2546304, 17563392,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 10*a(n-1) - 13*a(n-2) - 60*a(n-3) - 36*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 25 2024 09:32:20, revision 9) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269215.
