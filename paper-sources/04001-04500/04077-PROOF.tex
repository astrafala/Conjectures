...
\title{The empirical recurrence for OEIS A275133, proved by transfer matrix}
...
\begin{abstract}
OEIS A275133 counts arrays in which no entry may equal the entries at a short list of fixed offsets
...
$2$ consecutive columns, $S=247$ states in all.
\end{abstract}
...
OEIS A275133 is ``Number of 4 X n 0..2 arrays with no element equal to any value at offset (-2,-2) (-1,0) or (-1,1) and new values introduced in order 0..2.''. It has offset $1$ and begins
\[
4, 36, 129, 568, 2545, 11092, 48451, 212897,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + 8*a(n-2) + 22*a(n-3) + 36*a(n-4) + 7*a(n-5) - 48*a(n-6) - 4*a(n-7) + 15*a(n-8) - 18*a(n-9) for n>11.
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 31 2019 19:36:36, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 8\,a(n-2) + 22\,a(n-3) + 36\,a(n-4) + 7\,a(n-5) - 48\,a(n-6) - 4\,a(n-7) + 15\,a(n-8) - 18\,a(n-9)
\]
for every $n>11$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A275133.
