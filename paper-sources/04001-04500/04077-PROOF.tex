...
\title{The empirical column recurrences for the table OEIS A235573}
...
\begin{abstract}
OEIS A235573 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A235573 is ``T(n,k)=Number of (n+1)X(k+1) 0..1 arrays with the difference of the upper and lower median value of each 2X2 subblock in lexicographically nondecreasing order rowwise and columnwise.''. It has offset $1$, is
read by antidiagonals, and begins
\[
16, 50, 50, 144, 250, 144, 398, 1120,\ \dots
\]
...
k=3: [order 39]\\
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 08:40:10, revision 6) these are still
...
The sequence is ``Number of (n+1)X2 0..1 arrays with the difference of the upper and lower median value of each 2X2 subblock in lexicographically nondecreasing order rowwise and columnwise.''. Its rows are the vertices of a digraph on
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A235573.
