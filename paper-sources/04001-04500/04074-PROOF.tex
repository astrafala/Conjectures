...
\title{The empirical recurrence for OEIS A211575, proved by transfer matrix}
...
\begin{abstract}
OEIS A211575 carries an empirical recurrence of order $11$ contributed by R. H. Hardin. It is
...
OEIS A211575 is ``Number of -2..2 arrays x(i) of n+1 elements i=1..n+1 with set{t,u,v in 0,1}((x[i+t]+x[j+u]+x[k+v])*(-1)\^{}(t+u+v)) having two, three, four or six distinct values for every i,j,k<=n.''. It has offset $1$ and begins
\[
24, 80, 202, 476, 1082, 2470, 5562, 12796,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 19 2018 09:49:43, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) - 3\,a(n-2) - 46\,a(n-3) + 88\,a(n-4) + 49\,a(n-5) - 231\,a(n-6) + 82\,a(n-7) + 168\,a(n-8) - 100\,a(n-9) - 36\,a(n-10) + 24\,a(n-11)
\]
for every $n>11$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A211575.
