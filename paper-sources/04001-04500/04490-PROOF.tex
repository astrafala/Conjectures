...
\title{The empirical recurrence for OEIS A211567, proved by transfer matrix}
...
\begin{abstract}
OEIS A211567 carries an empirical recurrence of order $6$ contributed by R. H. Hardin. It is
...
OEIS A211567 is ``Number of -2..2 arrays x(i) of n+1 elements i=1..n+1 with set{t,u,v in 0,1}((x[i+t]+x[j+u]+x[k+v])*(-1)\^{}(t+u+v)) having two or four distinct values for every i,j,k<=n.''. It has offset $1$ and begins
\[
24, 40, 68, 122, 220, 410, 764, 1454,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) + 3*a(n-2) - 15*a(n-3) + 4*a(n-4) + 18*a(n-5) - 12*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 19 2018 08:23:13, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A211567.
