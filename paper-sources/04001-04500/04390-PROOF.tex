...
\title{The empirical recurrence for OEIS A289405, proved from an exact model}
...
\begin{abstract}
OEIS A289405 carries an empirical recurrence of order $3$. It is true, and it is
...
OEIS A289405 is ``Binary representation of the diagonal from the origin to the corner of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 566", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 10, 110, 1100, 11100, 111000, 1111000, 11110000,\ \dots
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A289405.
