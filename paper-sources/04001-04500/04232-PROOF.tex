...
\title{The empirical column recurrences for the table OEIS A263373}
...
\begin{abstract}
OEIS A263373 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A263373 is ``T(n,k)=Number of (n+1)X(k+1) 0..2 arrays with each row and column divisible by 7, read as a base-3 number with top and left being the most significant digits.''. It has offset $1$, is
read by antidiagonals, and begins
\[
1, 1, 1, 2, 2, 2, 5, 7,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 16 2015 07:34:17, revision 4) these are still
...
The sequence is ``Number of (n+1)X2 0..2 arrays with each row and column divisible by 7, read as a base-3 number with top and left being the most significant digits.''. Its rows are the vertices of a digraph on
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A263373.
