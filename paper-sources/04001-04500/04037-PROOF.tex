...
\title{The conjectured generating function for OEIS A279959, proved}
...
\begin{abstract}
OEIS A279959 counts arrays of a fixed width under a local condition, and carries a conjectured
...
\[
1, 10, 10, 1100, 111, 111100,\ \dots
\]
The entry states, as a conjecture contributed by a reader and never marked settled:
\begin{quote}
G.f.: (1 + 10*x - 91*x\^{}2 + 90*x\^{}3 - 799*x\^{}4 + 1000*x\^{}5 - 10100*x\^{}6) / ((1 - x)*(1 + x)*(1 - 10*x)*(1 + 10*x)).
\end{quote}
