...
\title{The empirical closed form and generating function for OEIS A194934, proved}
...
\begin{abstract}
OEIS A194934 counts the lower triangles of a $5\times5$ array over $\{0,\dots,n\}$ in which
...
OEIS A194934 is ``Number of lower triangles of a 5 X 5 0..n array with no element differing from any of its horizontal or vertical neighbors by more than one.''. It has offset $1$ and begins
\[
32768, 344091, 882318, 1481501, 2089736, 2698979,\ \dots
\]
...
Empirical g.f.: x*(32768 + 278555*x + 226904*x\^{}2 + 60956*x\^{}3 + 9052*x\^{}4 + 1008*x\^{}5 + 64*x\^{}6+ 2*x\^{}7) / (1 - x)\^{}2. - \_Colin Barker\_, May 05 2018
\end{quote}
As of the ``Last modified'' line on the live entry (May 05 2018 20:42:50, revision 9) these are still
...
\[
a(n)\;=\;609309\,n-956877\qquad\text{for every }n\ge7,
\]
and $\mathcal P$ has exactly $609309$ elements.
\end{theorem}
...
$a(8+1)$ were computed exactly, giving slope $609309$ and the stated intercept; the slope
...
First, the count reproduces all $25$ terms the entry publishes, exactly, in integer
arithmetic.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A194934.
