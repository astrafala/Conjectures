...
\title{The conjectured generating function for OEIS A278758, proved}
...
\begin{abstract}
OEIS A278758 counts arrays of a fixed width under a local condition, and carries a conjectured
