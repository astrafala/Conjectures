...
\title{The empirical recurrence for OEIS A231139, proved by transfer matrix}
...
\begin{abstract}
OEIS A231139 counts arrays of width $3$ over $\{0,1,2\}$ in which no cell matches a strict majority of its neighbours. The entry carries an
...
$3$ consecutive rows and the count is a walk count on $S=574$ states.
\end{abstract}
...
OEIS A231139 is ``Number of (n+1) X (2+1) 0..2 arrays with no element equal to a strict majority of its horizontal and vertical neighbors, with upper left element zero.''. It has offset $1$ and begins
\[
100, 1470, 22870, 352444, 5441634, 83985430, 1296319964, 20008457170,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 07 2021 15:18:09, revision 6) this is still
...
Thus
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=574,
\]
...
\begin{theorem}
\[
a(n)\;=\;14\,a(n-1) + 28\,a(n-2) - 83\,a(n-3) - 92\,a(n-4) - 342\,a(n-5) + 134\,a(n-6) + 890\,a(n-7) + 432\,a(n-8) - 32\,a(n-9) + 80\,a(n-10) - 320\,a(n-11)
\]
for every $n>10$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231139.
