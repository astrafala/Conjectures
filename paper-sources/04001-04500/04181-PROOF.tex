...
\title{The conjectured generating function for OEIS A278753, proved}
...
\begin{abstract}
OEIS A278753 counts arrays of a fixed width under a local condition, and carries a conjectured
...
\[
1, 0, 11, 1000, 111, 110000,\ \dots
\]
The entry states, as a conjecture contributed by a reader and never marked settled:
\begin{quote}
G.f.: (1000*x\^{}5 - 1000*x\^{}3 + 100*x\^{}2 - 1)/(1000*x\^{}6 - 1110*x\^{}4 + 111*x\^{}2 - 1). (End)
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 05 2025 15:22:35, revision 15) this is still
