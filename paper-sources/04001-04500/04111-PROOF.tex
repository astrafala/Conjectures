...
\title{The conjectured generating function for OEIS A280410, proved}
...
\begin{abstract}
OEIS A280410 counts arrays of a fixed width under a local condition, and carries a conjectured
...
OEIS A280410 is ``Binary representation of the x-axis, from the left edge to the origin, of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 261", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 10, 1, 1110, 1, 111110,\ \dots
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A280410.
