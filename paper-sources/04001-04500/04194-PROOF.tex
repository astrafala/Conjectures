...
\title{The conjectured generating function for OEIS A277797, proved}
...
\begin{abstract}
OEIS A277797 counts arrays of a fixed width under a local condition, and carries a conjectured
