...
\title{The empirical column recurrences for the table OEIS A233903}
...
\begin{abstract}
OEIS A233903 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A233903 is ``T(n,k)=Number of (n+1)X(k+1) 0..6 arrays with every 2X2 subblock having the sum of the squares of all six edge and diagonal differences equal to 35 (35 maximizes T(1,1)).''. It has offset $1$, is
read by antidiagonals, and begins
\[
144, 656, 656, 2688, 2944, 2688, 12288, 12152,\ \dots
\]
...
k=3: [order 69]\\
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 09:04:25, revision 6) these are still
...
The sequence is ``Number of (n+1)X2 0..6 arrays with every 2X2 subblock having the sum of the squares of all six edge and diagonal differences equal to 35.''. Its rows are the vertices of a digraph on
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A233903.
