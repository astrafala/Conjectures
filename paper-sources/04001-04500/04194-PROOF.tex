...
\title{The conjectured generating function for OEIS A283348, proved}
...
\begin{abstract}
OEIS A283348 counts arrays of a fixed width under a local condition, and carries a conjectured
...
\[
1, 0, 110, 1000, 1110, 11000,\ \dots
\]
The entry states, as a conjecture contributed by a reader and never marked settled:
\begin{quote}
G.f.: (1 - 10*x + 109*x\^{}2 - 90*x\^{}3 - 9000*x\^{}4 + 10000*x\^{}6) / ((1 - x)*(1 + x)*(1 - 10*x)).
\end{quote}
