...
\title{The empirical closed form for OEIS A207402, proved}
...
\begin{abstract}
OEIS A207402 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A207402 is ``Number of n X 7 0..1 arrays avoiding 0 0 1 and 0 1 1 horizontally and 0 0 1 and 1 1 0 vertically.''. It has offset $1$ and begins
\[
20, 400, 2340, 8910, 26676, 68060, 154580, 321110,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (1/36)*n\^{}7 + (4/9)*n\^{}6 + (53/18)*n\^{}5 + (91/9)*n\^{}4 + (589/36)*n\^{}3 + (31/9)*n\^{}2 - (58/3)*n + 6.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 22 2018 08:27:28, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{n^{7}}{36} + \frac{4 n^{6}}{9} + \frac{53 n^{5}}{18} + \frac{91 n^{4}}{9} + \frac{589 n^{3}}{36} + \frac{31 n^{2}}{9} - \frac{58 n}{3} + 6.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207402.
