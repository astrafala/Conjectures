...
\title{The conjectured generating function for OEIS A282916, proved}
...
\begin{abstract}
OEIS A282916 counts arrays of a fixed width under a local condition, and carries a conjectured
...
\[
1, 0, 100, 0, 11100, 100000,\ \dots
\]
The entry states, as a conjecture contributed by a reader and never marked settled:
\begin{quote}
G.f.: (1 + 1099*x\^{}4 + 100000*x\^{}5 - 1098900*x\^{}6 - 10000000*x\^{}10) / ((1 - x)*(1 + x)*(1 - 10*x)*(1 + 10*x)*(1 + x\^{}2)).
\end{quote}
