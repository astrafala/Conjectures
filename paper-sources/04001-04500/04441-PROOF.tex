...
\title{The conjectured generating function for OEIS A283589, proved}
...
\begin{abstract}
OEIS A283589 counts arrays of a fixed width under a local condition, and carries a conjectured
...
OEIS A283589 is ``Binary representation of the x-axis, from the left edge to the origin, of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 657", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 0, 101, 1110, 11110, 111110,\ \dots
\]
The entry states, as a conjecture contributed by a reader and never marked settled:
\begin{quote}
G.f.: (1 - 11*x + 111*x\^{}2 - x\^{}3 - 90*x\^{}4) / ((1 - x)*(1 - 10*x)).
\end{quote}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A283589.
