...
\title{The conjectured generating function for OEIS A279053, proved}
...
\begin{abstract}
OEIS A279053 counts arrays of a fixed width under a local condition, and carries a conjectured
...
coefficients of their expansions do. Comparing $11$ coefficients in exact arithmetic
...
OEIS A279053 is ``Binary representation of the x-axis, from the left edge to the origin, of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 131", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 1, 101, 101, 10101, 10101,\ \dots
\]
The entry states, as a conjecture contributed by a reader and never marked settled:
\begin{quote}
G.f.: 1 / ((1 - x)*(1 - 10*x)*(1 + 10*x)).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 05 2025 15:22:35, revision 10) this is still
...
\begin{proof}
Write the conjecture as $N_2/D_2$ with $\deg N_2=0$ and $\deg D_2=3$; its expansion as a
...
exact integer arithmetic, those of $N_2/D_2$ by exact rational long division, and $11$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A279053.
