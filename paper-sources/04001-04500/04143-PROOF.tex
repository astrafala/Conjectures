...
\title{The conjectured generating function for OEIS A286519, proved}
...
\begin{abstract}
OEIS A286519 counts arrays of a fixed width under a local condition, and carries a conjectured
...
OEIS A286519 is ``Binary representation of the diagonal from the origin to the corner (or of the corner to the origin) of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 659", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 11, 101, 1111, 11111, 111111,\ \dots
\]
The entry states, as a conjecture contributed by a reader and never marked settled:
\begin{quote}
G.f.: (1 - 10*x\^{}2 + 110*x\^{}3 - 100*x\^{}4) / ((1 - x)*(1 - 10*x)).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 05 2025 15:22:38, revision 17) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A286519.
