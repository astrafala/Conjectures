...
\title{The empirical recurrence for OEIS A282483, proved from an exact model}
...
\begin{abstract}
OEIS A282483 carries an empirical recurrence of order $6$. It is true, and it is
...
\[
1, 11, 11, 1111, 11, 11111, 1100011, 1111111,\ \dots
\]
