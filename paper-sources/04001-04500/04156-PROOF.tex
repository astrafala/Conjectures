...
\title{The empirical recurrence for OEIS A208390, proved by counting patterns}
...
\begin{abstract}
OEIS A208390 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A208390 is ``Number of nX6 0..2 arrays with new values 0..2 introduced in row major order and no element equal to more than two of its immediate leftward or upward or right-upward antidiagonal neighbors.''. It has offset $1$ and begins
\[
122, 76806, 48890520, 31112194860, 19798894881900, 12599441934740388, 8017919094401985204, 5102370957264743298996,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 649*a(n-1) -8088*a(n-2) +32724*a(n-3) -69156*a(n-4) +80352*a(n-5) -46656*a(n-6) for n>7
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:48:44, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;649\,a(n-1) - 8088\,a(n-2) + 32724\,a(n-3) - 69156\,a(n-4) + 80352\,a(n-5) - 46656\,a(n-6)
\end{equation}
for all $n>7$.
...
\[
3!\Bigl(a(n)-\sum_i c_i\,a(n-i)\Bigr)\;=\;\mathbf{v}^{\!\top}N^{\,m-6}q(N)\mathbf{1} .
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208390.
