...
\title{The empirical recurrence for OEIS A284542, proved from an exact model}
...
\begin{abstract}
OEIS A284542 carries an empirical recurrence of order $5$. It is true, and it is
...
OEIS A284542 is ``Decimal representation of the x-axis, from the left edge to the origin, of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 974", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 3, 7, 13, 29, 53, 113, 219,\ \dots
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A284542.
