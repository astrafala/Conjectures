...
\title{The empirical recurrence for OEIS A209096, proved by counting patterns}
...
\begin{abstract}
OEIS A209096 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A209096 is ``Number of n X 4 0..2 arrays with new values 0..2 introduced in row major order and no element equal to more than one of its immediate leftward or upward or right-upward antidiagonal neighbors.''. It has offset $1$ and begins
\[
14, 520, 20928, 849548, 34538488, 1404480904, 57113932788, 2322577420320,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 49*a(n-1) - 356*a(n-2) + 705*a(n-3) - 425*a(n-4) + 64*a(n-5) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 08 2018 10:48:18, revision 9) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209096.
