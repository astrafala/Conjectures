...
\title{The conjectured generating function for OEIS A278757, proved}
...
\begin{abstract}
OEIS A278757 counts arrays of a fixed width under a local condition, and carries a conjectured
...
\[
1, 0, 11, 1010, 0, 111111,\ \dots
\]
The entry states, as a conjecture contributed by a reader and never marked settled:
\begin{quote}
G.f.: (-10100*x\^{}7 + 1100*x\^{}6 + 9101*x\^{}5 - 1011*x\^{}4 + 1010*x\^{}3 - 90*x\^{}2 + 1)/(100*x\^{}4 - 101*x\^{}2 + 1). (End)
\end{quote}
