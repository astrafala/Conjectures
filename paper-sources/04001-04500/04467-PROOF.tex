...
\title{The empirical recurrence for OEIS A210118, proved by counting patterns}
...
\begin{abstract}
OEIS A210118 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A210118 is ``Number of (n+1) X 2 0..3 arrays with every 2 X 2 subblock having two or four distinct values, and new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
8, 44, 265, 1702, 11369, 77642, 536581, 3731446,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 10*a(n-1) - 19*a(n-2) - 14*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 14 2018 15:34:38, revision 11) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;10\,a(n-1) - 19\,a(n-2) - 14\,a(n-3)
\end{equation}
for all $n>3$.
...
\eqref{eq:walk}, divided by $4!$, was evaluated at every one of the $20$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A210118.
