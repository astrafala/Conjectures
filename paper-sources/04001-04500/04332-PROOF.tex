...
\title{The empirical recurrence for OEIS A214182, proved by transfer matrix}
...
\begin{abstract}
OEIS A214182 counts the proper colourings of a grid $n\times4$, wrapped in the direction of width $4$, with at most $7$ colours and
...
down to $S=20$ and makes the exact residual test affordable.
\end{abstract}
...
OEIS A214182 is ``Number of 0..6 colorings of an nX4 array circular in the 4 direction with new values 0..6 introduced in row major order.''. It has offset $1$ and begins
\[
4, 353, 147943, 96673866, 68272896836, 48807260151073, 34958661918205401, 25047104071770605888,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 16:55:26, revision 8) this is still
...
\]
There are $(i-1)^{4}+(-1)^{4}(i-1)$ such colourings, which at $i=7$ is already more
...
state count is $S=20$ rather than the number of colourings.
...
\begin{theorem}
\[
a(n)\;=\;902\,a(n-1) - 142783\,a(n-2) + 7297504\,a(n-3) - 157308287\,a(n-4) + 1529846974\,a(n-5) - 7002462289\,a(n-6) + 14489273756\,a(n-7) - 12535263856\,a(n-8) + 3668758080\,a(n-9)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A214182.
