...
\title{The empirical recurrence for OEIS A279705, proved by transfer matrix}
...
\begin{abstract}
OEIS A279705 counts $n\times4$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A279705 is ``Number of n X 4 0..1 arrays with no element equal to a strict majority of its horizontal and antidiagonal neighbors and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
2, 4, 22, 125, 717, 4121, 23690, 136181,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 10*a(n-1) - 33*a(n-2) + 61*a(n-3) - 78*a(n-4) + 64*a(n-5) - 32*a(n-6) + 9*a(n-7) - a(n-8) for n>9.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 11 2019 14:25:45, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;10\,a(n-1) - 33\,a(n-2) + 61\,a(n-3) - 78\,a(n-4) + 64\,a(n-5) - 32\,a(n-6) + 9\,a(n-7) - a(n-8)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A279705.
