...
\title{The empirical recurrence for OEIS A279873, proved from an exact model}
...
\begin{abstract}
OEIS A279873 carries an empirical recurrence of order $6$. It is true, and it is
...
OEIS A279873 is ``Binary representation of the x-axis, from the left edge to the origin, of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 211", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 1, 101, 111, 10000, 10111, 1010100, 1111101,\ \dots
\]
...
\begin{theorem}
\[
a(n)\;=\;a(n-2) + 10000\,a(n-4) - 10000\,a(n-6)
\]
for every $n>14$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A279873.
