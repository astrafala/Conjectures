...
\title{The conjectured generating function for OEIS A279872, proved}
...
\begin{abstract}
OEIS A279872 counts arrays of a fixed width under a local condition, and carries a conjectured
...
coefficients of their expansions do. Comparing $14$ coefficients in exact arithmetic
...
OEIS A279872 is ``Decimal representation of the x-axis, from the left edge to the origin, (and also from the origin to the right edge) of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 209", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 0, 7, 0, 31, 0,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 05 2025 15:22:36, revision 21) this is still
...
\begin{proof}
Write the conjecture as $N_2/D_2$ with $\deg N_2=2$ and $\deg D_2=4$; its expansion as a
...
exact integer arithmetic, those of $N_2/D_2$ by exact rational long division, and $14$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A279872.
