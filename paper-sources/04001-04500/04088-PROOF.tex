...
\title{The empirical recurrence for OEIS A222939, proved by transfer matrix}
...
\begin{abstract}
OEIS A222939 counts arrays in which no entry may equal the entries at a short list of fixed offsets
...
$2$ consecutive rows, $S=75$ states in all.
\end{abstract}
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 16 2018 13:23:13, revision 12) this is still
