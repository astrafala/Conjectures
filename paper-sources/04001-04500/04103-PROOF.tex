...
\title{The conjectured generating function for OEIS A290837, proved}
...
\begin{abstract}
OEIS A290837 counts arrays of a fixed width under a local condition, and carries a conjectured
...
\begin{quote}
G.f.: (1 - 2*x + 4*x\^{}2 + 2*x\^{}3 - 28*x\^{}4 + 72*x\^{}5 - 48*x\^{}6) / ((1 - x)*(1 - 2*x)).
\end{quote}
