...
\title{The empirical recurrence for OEIS A269071, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A269071 counts arrays over $\{0,\dots,1\}$ subject to a condition on the array as a
...
OEIS A269071 is ``Number of n X 4 binary arrays with some element plus some horizontally, diagonally or antidiagonally adjacent neighbor totalling two not more than once.''. It has offset $1$ and begins
\[
13, 76, 521, 3288, 20400, 123976, 742688, 4397376,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 12*a(n-1) - 40*a(n-2) + 8*a(n-3) + 92*a(n-4) - 32*a(n-5) - 64*a(n-6) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 18 2019 14:41:12, revision 7) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269071.
