...
\title{The empirical column recurrences for the table OEIS A235319}
...
\begin{abstract}
OEIS A235319 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A235319 is ``T(n,k) is the number of (n+1) X (k+1) 0..6 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 7 (constant-stress 1 X 1 tilings).''. It has offset $1$, is
read by antidiagonals, and begins
\[
112, 392, 392, 1120, 1120, 1120, 3920, 2744,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 18 2022 23:01:13, revision 9) these are still
...
The sequence is ``Number of (n+1) X (2) 0..6 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 7 (constant-stress 1 X 1 tilings).''. Its rows are the vertices of a digraph on
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A235319.
