...
\title{The empirical recurrence for OEIS A289099, proved from an exact model}
...
\begin{abstract}
OEIS A289099 carries an empirical recurrence of order $3$. It is true, and it is
...
\[
1, 1, 7, 7, 23, 31, 95, 127,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
(the empirical recurrence quoted in the entry)
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 05 2025 15:22:40, revision 20)
