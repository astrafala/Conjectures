...
\title{The conjectured generating function for OEIS A283358, proved}
...
\begin{abstract}
OEIS A283358 counts arrays of a fixed width under a local condition, and carries a conjectured
