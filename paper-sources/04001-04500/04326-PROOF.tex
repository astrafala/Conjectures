...
\title{The empirical closed form for OEIS A223953, proved}
...
\begin{abstract}
OEIS A223953 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
$S=262144$ vertices. Any function of the form $\sum_j p_j(n)\lambda_j^{\,n}$ satisfies the
...
OEIS A223953 is ``Number of 6 X n 0..1 arrays with diagonals and antidiagonals unimodal and rows nondecreasing.''. It has offset $1$ and begins
\[
64, 729, 2024, 3645, 5951, 9919, 16845, 28558,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (2/45)*n\^{}6 + (67/36)*n\^{}4 + 8*n\^{}3 + (7757/180)*n\^{}2 + 138*n + 1326 for n>4.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 24 2018 08:52:20, revision 7) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{2 n^{6}}{45} + \frac{67 n^{4}}{36} + 8 n^{3} + \frac{7757 n^{2}}{180} + 138 n + 1326.
\]
...
walk, so with $M$ the adjacency matrix of that digraph on $S=262144$ vertices, and $u,w$ the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223953.
