...
\title{The empirical recurrence for OEIS A279961, proved from an exact model}
...
\begin{abstract}
OEIS A279961 carries an empirical recurrence of order $4$. It is true, and it is
