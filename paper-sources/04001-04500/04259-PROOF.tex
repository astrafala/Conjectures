...
\title{The empirical closed form for OEIS A223951, proved}
...
\begin{abstract}
OEIS A223951 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A223951 is ``Number of 4 X n 0..1 arrays with diagonals and antidiagonals unimodal and rows nondecreasing.''. It has offset $1$ and begins
\[
16, 81, 177, 321, 558, 928, 1479, 2267,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (1/3)*n\^{}4 + (2/3)*n\^{}3 + (37/6)*n\^{}2 + (107/6)*n + 23 for n>2.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 24 2018 08:52:29, revision 7) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{n^{4}}{3} + \frac{2 n^{3}}{3} + \frac{37 n^{2}}{6} + \frac{107 n}{6} + 23.
\]
...
$n=8,\dots,12$ and agree at each. A monic recurrence of order $5$
determines $a(m)$ from $a(m-1),\dots,a(m-5)$, and for every $m\ge13$ both
$m>7$ and $m-5\ge8$ hold, so induction on $m$ gives $a(m)=f(m)$ for every
$m\ge8$.
Below $n=8$ the recurrence argument gives nothing, since \eqref{eq:rec} is only
established for $a$ from $n=8$ on. The remaining indices $n=3,\dots,7$ were
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223951.
