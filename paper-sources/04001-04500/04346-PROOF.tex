...
\title{The empirical recurrence for OEIS A204623, proved by counting patterns}
...
\begin{abstract}
OEIS A204623 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A204623 is ``Number of (n+1)X2 0..2 arrays with every 2X2 subblock having unequal diagonal elements or unequal antidiagonal elements, and new values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
12, 96, 768, 6144, 49152, 393216, 3145728, 25165824,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 8*a(n-1)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 11:22:06, revision 14) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204623.
