...
\title{The empirical recurrence for OEIS A231057, proved by transfer matrix}
...
\begin{abstract}
OEIS A231057 counts arrays of width $2$ over $\{0,1,2,3\}$ in which every cell must see, among its
...
the count is a walk count on $S=97$ states.
\end{abstract}
...
OEIS A231057 is ``Number of n X 2 0..3 arrays x(i,j) with each element horizontally or vertically next to at least one element with value (x(i,j)+1) mod 4, no adjacent elements equal, and upper left element zero.''. It has offset $1$ and begins
\[
0, 2, 6, 20, 68, 230, 778, 2632,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) + a(n-2) + a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 24 2018 09:25:21, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231057.
