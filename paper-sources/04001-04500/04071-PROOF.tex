...
\title{The empirical recurrence for OEIS A241429, proved by transfer matrix}
...
\begin{abstract}
OEIS A241429 counts arrays over $\{0,1,2,3\}$ in which no entry may equal, modulo $4$, a given
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) - 2\,a(n-3) + a(n-4) + a(n-5) - 2\,a(n-6) + a(n-7) + a(n-8) - 2\,a(n-9) + 2\,a(n-10) - a(n-11)
\]
for every $n>13$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A241429.
