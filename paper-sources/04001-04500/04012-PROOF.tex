...
\title{The empirical column recurrences for the table OEIS A234796}
...
\begin{abstract}
OEIS A234796 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A234796 is ``T(n,k)=Number of (n+1)X(k+1) 0..3 arrays with each 2X2 subblock having the number of clockwise edge increases less than or equal to the number of counterclockwise edge increases.''. It has offset $1$, is
read by antidiagonals, and begins
\[
204, 2504, 2504, 30536, 88072, 30536, 371976, 3015344,\ \dots
\]
...
k=4: [order 66]\\
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 08:27:45, revision 6) these are still
...
The sequence is ``Number of (n+1)X2 0..3 arrays with each 2X2 subblock having the number of clockwise edge increases less than or equal to the number of counterclockwise edge increases.''. Its rows are the vertices of a digraph on
...
\[
a(n)\;=\;15\,a(n-1) - 36\,a(n-2) + 20\,a(n-3)
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234796.
