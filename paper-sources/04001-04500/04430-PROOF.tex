...
\title{The empirical closed form for OEIS A223913, proved}
...
\begin{abstract}
OEIS A223913 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
$S=176$ vertices. Any function of the form $\sum_j p_j(n)\lambda_j^{\,n}$ satisfies the
...
OEIS A223913 is ``Number of n X 3 0..2 arrays with rows and antidiagonals unimodal and columns nondecreasing.''. It has offset $1$ and begins
\[
22, 158, 666, 2111, 5548, 12752, 26494, 50863,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (23/360)*n\^{}6 + (23/40)*n\^{}5 + (205/72)*n\^{}4 + (143/24)*n\^{}3 + (364/45)*n\^{}2 + (82/15)*n - 1.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 24 2018 03:59:11, revision 9) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{23 n^{6}}{360} + \frac{23 n^{5}}{40} + \frac{205 n^{4}}{72} + \frac{143 n^{3}}{24} + \frac{364 n^{2}}{45} + \frac{82 n}{15} - 1.
\]
...
walk, so with $M$ the adjacency matrix of that digraph on $S=176$ vertices, and $u,w$ the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223913.
