...
\title{The empirical recurrence for OEIS A290683, proved from an exact model}
...
\begin{abstract}
OEIS A290683 carries an empirical recurrence of order $2$ contributed by Colin Barker. It is true, and it is
...
\[
1, 1, 7, 7, 31, 63, 127, 255,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Aug 09 2017: (Start) a(n) = 3*a(n-1) - 2*a(n-2) for n>5.
\end{quote}
...
neighbourhood to a live cell flips the ENTIRE plane, and rule 929 is read
