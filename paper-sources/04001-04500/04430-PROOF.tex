...
\title{The empirical recurrence for OEIS A204070, proved by counting patterns}
...
\begin{abstract}
OEIS A204070 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A204070 is ``Number of (n+1) X 3 0..2 arrays with every 2 X 2 subblock having equal diagonal elements or equal antidiagonal elements, and new values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
38, 329, 2882, 25277, 221726, 1944977, 17061338, 149662085,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 10*a(n-1) - 11*a(n-2) + 2*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 06 2018 05:41:04, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;10\,a(n-1) - 11\,a(n-2) + 2\,a(n-3)
\end{equation}
for all $n>2$.
...
\eqref{eq:walk}, divided by $3!$, was evaluated at every one of the $18$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204070.
