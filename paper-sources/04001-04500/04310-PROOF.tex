...
\title{The empirical recurrence for OEIS A290528, proved from an exact model}
...
\begin{abstract}
OEIS A290528 carries an empirical recurrence of order $5$. It is true, and it is
