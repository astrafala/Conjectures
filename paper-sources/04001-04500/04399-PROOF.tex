...
\title{The conjectured generating function for OEIS A290835, proved}
...
\begin{abstract}
OEIS A290835 counts arrays of a fixed width under a local condition, and carries a conjectured
...
coefficients of their expansions do. Comparing $18$ coefficients in exact arithmetic
...
\[
1, 1, 101, 1111, 111, 111111,\ \dots
\]
The entry states, as a conjecture contributed by a reader and never marked settled:
\begin{quote}
G.f.: (1 - 10*x + 100*x\^{}2 + 10*x\^{}3 - 11100*x\^{}4 + 121000*x\^{}5 - 110000*x\^{}6) / ((1 - x)*(1 - 10*x)).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 05 2025 15:22:41, revision 12) this is still
...
\begin{proof}
Write the conjecture as $N_2/D_2$ with $\deg N_2=6$ and $\deg D_2=2$; its expansion as a
...
exact integer arithmetic, those of $N_2/D_2$ by exact rational long division, and $18$
