...
\title{The empirical recurrence for OEIS A285543, proved from an exact model}
...
\begin{abstract}
OEIS A285543 carries an empirical recurrence of order $5$. It is true, and it is
