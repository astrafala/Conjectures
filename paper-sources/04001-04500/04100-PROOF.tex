...
\title{The empirical recurrence for OEIS A280853, proved by transfer matrix}
...
\begin{abstract}
OEIS A280853 counts $n\times2$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A280853 is ``Number of n X 2 0..2 arrays with no element equal to more than one of its king-move neighbors and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
2, 9, 29, 110, 442, 1708, 6596, 25624,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) - 2*a(n-2) + 8*a(n-3) - 8*a(n-4) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 22 2018 09:47:20, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A280853.
