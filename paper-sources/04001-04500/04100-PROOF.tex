...
\title{The empirical recurrence for OEIS A206217, proved by transfer matrix}
...
\begin{abstract}
OEIS A206217 counts arrays of width $3$ over $\{0,1,2\}$ by reducing every $2\times2$ subblock to a
...
about it is one bit per adjacent pair of columns, so the count is a walk count on $S=409$
states.
\end{abstract}
...
OEIS A206217 is ``Number of (n+1)X3 0..2 arrays with rows and columns of determinants of all 2X2 subblocks lexicographically nondecreasing.''. It has offset $1$ and begins
\[
452, 7313, 73133, 656053, 5862927, 53835891, 499752207, 4654712482,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 15*a(n-1) -49*a(n-2) -97*a(n-3) +664*a(n-4) -980*a(n-5) +448*a(n-6) for n>16
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 12:48:12, revision 9) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=409.
\]
...
\begin{theorem}
\[
a(n)\;=\;15\,a(n-1) - 49\,a(n-2) - 97\,a(n-3) + 664\,a(n-4) - 980\,a(n-5) + 448\,a(n-6)
\]
for every $n>16$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206217.
