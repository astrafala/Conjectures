...
\title{The empirical recurrence for OEIS A275566, proved by transfer matrix}
...
\begin{abstract}
OEIS A275566 counts arrays in which no entry may equal the entries at a short list of fixed offsets
...
$2$ consecutive columns, $S=365$ states in all.
\end{abstract}
...
OEIS A275566 is ``Number of 3 X n 0..2 arrays with no element equal to any value at offset (-2,0) (-1,2) or (0,-2) and new values introduced in order 0..2.''. It has offset $1$ and begins
\[
3, 54, 126, 294, 672, 1536, 3552, 8214,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) - 5*a(n-3) + a(n-4) + 7*a(n-5) - 5*a(n-6) + 2*a(n-8) - a(n-9) for n>10.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 04 2019 14:12:06, revision 7) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=365.
\]
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) - 5\,a(n-3) + a(n-4) + 7\,a(n-5) - 5\,a(n-6) + 2\,a(n-8) - a(n-9)
\]
for every $n>10$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A275566.
