...
\title{The conjectured generating function for OEIS A279877, proved}
...
\begin{abstract}
OEIS A279877 counts arrays of a fixed width under a local condition, and carries a conjectured
...
\[
1, 10, 10, 1100, 111, 111000,\ \dots
\]
The entry states, as a conjecture contributed by a reader and never marked settled:
\begin{quote}
G.f.: (1 +10*x -101*x\^{}2 -10*x\^{}3 +111*x\^{}4 -1110*x\^{}6 +1000*x\^{}8) / ((1 -x)*(1 +x)*(1 -10*x)*(1 +10*x)*(1 -10*x\^{}2)).
\end{quote}
