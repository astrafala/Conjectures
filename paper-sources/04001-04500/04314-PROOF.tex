...
\title{The empirical recurrence for OEIS A285474, proved from an exact model}
...
\begin{abstract}
OEIS A285474 carries an empirical recurrence of order $4$. It is true, and it is
...
\[
1, 11, 100, 1111, 10000, 111111, 1000000, 11111111,\ \dots
\]
