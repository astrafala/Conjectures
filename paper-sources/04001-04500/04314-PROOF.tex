...
\title{The empirical column recurrences for the table OEIS A235736}
...
\begin{abstract}
OEIS A235736 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A235736 is ``T(n,k)=Number of (n+1)X(k+1) 0..1 arrays with the sum of each 2X2 subblock maximum and minimum lexicographically nondecreasing columnwise and nonincreasing rowwise.''. It has offset $1$, is
read by antidiagonals, and begins
\[
16, 58, 58, 209, 380, 209, 746, 2481,\ \dots
\]
...
k=4: [order 86]\\
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 08:45:14, revision 6) these are still
...
The sequence is ``Number of (n+1)X2 0..1 arrays with the sum of each 2X2 subblock maximum and minimum lexicographically nondecreasing columnwise and nonincreasing rowwise.''. Its rows are the vertices of a digraph on
...
\[
a(n)\;=\;4\,a(n-1) - 6\,a(n-3) + a(n-4) + 2\,a(n-5)
\]
...
model reproduces $8$ published values, $29$ decimal digits in all, every one of
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A235736.
