...
\title{The conjectured generating function for OEIS A279873, proved}
...
\begin{abstract}
OEIS A279873 counts arrays of a fixed width under a local condition, and carries a conjectured
