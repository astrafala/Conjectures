...
\title{The conjectured generating function for OEIS A279960, proved}
...
\begin{abstract}
OEIS A279960 counts arrays of a fixed width under a local condition, and carries a conjectured
...
\[
1, 1, 10, 11, 11100, 1111,\ \dots
\]
The entry states, as a conjecture contributed by a reader and never marked settled:
\begin{quote}
G.f.: (1 + x - 91*x\^{}2 - 90*x\^{}3 + 10190*x\^{}4 + 100*x\^{}5 - 10100*x\^{}6) / ((1 - x)*(1 + x)*(1 - 10*x)*(1 + 10*x)).
\end{quote}
