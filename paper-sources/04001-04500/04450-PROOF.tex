...
\title{The empirical recurrence for OEIS A301537, proved by transfer matrix}
...
\begin{abstract}
OEIS A301537 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the four horizontal and vertical neighbours, a number $equal to$ itself lying in $\{0,1,3\}$, and it carries an empirical
...
OEIS A301537 is ``Number of nX4 0..1 arrays with every element equal to 0, 1 or 3 horizontally or vertically adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
5, 10, 26, 79, 212, 603, 1841, 5663,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 23 2018 11:04:29, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A301537.
