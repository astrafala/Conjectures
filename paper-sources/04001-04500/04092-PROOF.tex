...
\title{The conjectured generating function for OEIS A252970, proved}
...
\begin{abstract}
OEIS A252970 counts arrays of a fixed width under a local condition, and carries a conjectured
...
OEIS A252970 is ``Number of nX2 nonnegative integer arrays with upper left 0 and lower right n+2-5 and value increasing by 0 or 1 with every step right or down.''. It has offset $1$ and begins
\[
0, 0, 1, 13, 61, 192,\ \dots
\]
The entry states, as a conjecture contributed by a reader and never marked settled:
\begin{quote}
Empirical: G.f.: -x\^{}3*(1+6*x-9*x\^{}2+3*x\^{}3) / (x-1)\^{}7 . - \_R. J. Mathar\_, Nov 23 2015
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:49:10, revision 10) this is still
...
\begin{proof}
Write the conjecture as $N_2/D_2$ with $\deg N_2=6$ and $\deg D_2=7$; its expansion as a
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252970.
