...
\title{The empirical recurrence for OEIS A235956, proved by transfer matrix}
...
\begin{abstract}
OEIS A235956 counts arrays of width $3$ over $\{0,1\}$ by reducing every $2\times2$ subblock to a
...
OEIS A235956 is ``Number of (n+1) X (2+1) 0..1 arrays with the difference of the upper and lower median value of each 2 X 2 subblock in lexicographically nondecreasing order columnwise and nonincreasing rowwise.''. It has offset $1$ and begins
\[
50, 228, 928, 3574, 13346, 48848, 176420, 631130,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 8*a(n-1) - 16*a(n-2) - 22*a(n-3) + 105*a(n-4) - 66*a(n-5) - 120*a(n-6) + 176*a(n-7) - 64*a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 20 2018 10:04:24, revision 9) this is still
...
f(B)\;=\;v_3-v_2,
\]
the upper median minus the lower median. An array with $R$ rows and $3$ columns has $(R-1)\times2$ subblocks, and they
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-1) - 16\,a(n-2) - 22\,a(n-3) + 105\,a(n-4) - 66\,a(n-5) - 120\,a(n-6) + 176\,a(n-7) - 64\,a(n-8)
\]
for every $n>7$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A235956.
