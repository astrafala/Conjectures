...
\title{The conjectured generating function for OEIS A283217, proved}
...
\begin{abstract}
OEIS A283217 counts arrays of a fixed width under a local condition, and carries a conjectured
