...
\title{The empirical recurrence for OEIS A269047, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A269047 counts arrays over $\{0,\dots,2\}$ subject to a condition on the array as a
...
OEIS A269047 is ``Number of n X 3 0..2 arrays with some element plus some horizontally, diagonally or antidiagonally adjacent neighbor totalling two not more than once.''. It has offset $1$ and begins
\[
24, 102, 594, 3258, 17346, 90450, 464250, 2353338,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 10*a(n-1) - 29*a(n-2) + 20*a(n-3) - 4*a(n-4) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 18 2019 15:21:26, revision 7) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269047.
