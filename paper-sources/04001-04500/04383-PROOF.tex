...
\title{The empirical recurrence for OEIS A283506, proved from an exact model}
...
\begin{abstract}
OEIS A283506 carries an empirical recurrence of order $3$. It is true, and it is
