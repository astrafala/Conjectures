...
\title{The empirical recurrence for OEIS A282800, proved from an exact model}
...
\begin{abstract}
OEIS A282800 carries an empirical recurrence of order $4$. It is true, and it is
...
OEIS A282800 is ``Binary representation of the x-axis, from the left edge to the origin, of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 507", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 1, 111, 100, 11111, 10100, 1111111, 1010100,\ \dots
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A282800.
