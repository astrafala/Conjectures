...
\title{The conjectured generating function for OEIS A063168, proved}
...
\begin{abstract}
OEIS A063168 counts arrays of a fixed width under a local condition, and carries a conjectured
...
model reproduces all $46$ terms the entry publishes, exactly, in integer arithmetic --- a
...
\begin{proof}
Write the conjecture as $N_2/D_2$ with $\deg N_2=3$ and $\deg D_2=2$; its expansion as a
...
First, the model reproduces every one of the $46$ published terms, with the index shift
