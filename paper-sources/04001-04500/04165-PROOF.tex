...
\title{The conjectured generating function for OEIS A285648, proved}
...
\begin{abstract}
OEIS A285648 counts arrays of a fixed width under a local condition, and carries a conjectured
