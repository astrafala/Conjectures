...
The entry gives only the order for this line: ``k=2: [order 21]''. Its model is a walk on
$S=53$ vertices, so it satisfies a monic recurrence of order at most $S$;
Berlekamp--Massey on $2S=106$ exact terms returns the minimal one, of order
$21$ --- the stated order --- with integer coefficients
\begin{center}\small\begin{tabular}{cccccccc}
$c_{1}$ & $3$ & $c_{7}$ & $110$ & $c_{13}$ & $792$ & $c_{19}$ & $128$ \\
$c_{2}$ & $0$ & $c_{8}$ & $40$ & $c_{14}$ & $288$ & $c_{20}$ & $0$ \\
$c_{3}$ & $47$ & $c_{9}$ & $1601$ & $c_{15}$ & $2480$ & $c_{21}$ & $512$ \\
$c_{4}$ & $-25$ & $c_{10}$ & $-348$ & $c_{16}$ & $-544$ &  &  \\
$c_{5}$ & $21$ & $c_{11}$ & $-520$ & $c_{17}$ & $128$ &  &  \\
$c_{6}$ & $-403$ & $c_{12}$ & $-2656$ & $c_{18}$ & $-1600$ &  &  \\
\end{tabular}\end{center}
Repeating with the first $21+4$ terms removed gives order $21$ again.

\subsection*{Column $k=3$, recovered}
The entry gives only the order for this line: ``k=3: [order 45]''. Its model is a walk on
$S=160$ vertices, so it satisfies a monic recurrence of order at most $S$;
Berlekamp--Massey on $2S=320$ exact terms returns the minimal one, of order
$45$ --- the stated order --- with integer coefficients
\[
(c_1,\dots,c_{45})=(4,\ 12,\ 149,\ 34,\ -745,\ -4377,\ -1298,\ 13107,\ 52121,\ 8083,\ -86996,\ -321488,\ -28134,\ 269200,\ 1028451,\ 72948,\ -507872,\ -2031587,\ -253166,\ 609639,\ 2548479,\ 414970,\ -482501,\ -2033465,\ -288069,\ 243904,\ 1017882,\ 103832,\ -88438,\ -327567,\ -19692,\ 23162,\ 69365,\ 1980,\ -4140,\ -9617,\ -152,\ 478,\ 849,\ 16,\ -33,\ -44,\ -1,\ 1,\ 1).
\]
Repeating with the first $45+4$ terms removed gives order $45$ again.

\subsection*{Row $n=2$, recovered}
The entry gives only the order for this line: ``n=2: [order 36]''. Its model is a walk on
$S=72$ vertices, so it satisfies a monic recurrence of order at most $S$;
Berlekamp--Massey on $2S=144$ exact terms returns the minimal one, of order
$36$ --- the stated order --- with integer coefficients
\[
(c_1,\dots,c_{36})=(4,\ 0,\ 25,\ 92,\ -199,\ -51,\ -940,\ -2001,\ 1652,\ -54,\ 6797,\ 11789,\ -5313,\ 1302,\ -17859,\ -25925,\ 7454,\ -951,\ 18218,\ 22763,\ -3531,\ 270,\ -7326,\ -8414,\ 641,\ -33,\ 1169,\ 1281,\ -43,\ 3,\ -67,\ -71,\ 1,\ 0,\ 1,\ 1).
\]
