...
\title{The empirical recurrence for OEIS A268624, proved by transfer matrix}
...
\begin{abstract}
OEIS A268624 counts arrays of width $4$ over $\{0,1,2\}$ in which the number of adjacent PAIRS of
...
result is a walk count on $S=166$ states.
\end{abstract}
...
OEIS A268624 is ``Number of n X 4 0..2 arrays with some element plus some horizontally or vertically adjacent neighbor totalling two no more than once.''. It has offset $1$ and begins
\[
60, 666, 6300, 55452, 467190, 3819654, 30553014, 240364746,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 18*a(n-1) - 111*a(n-2) + 282*a(n-3) - 333*a(n-4) + 180*a(n-5) - 36*a(n-6) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 14 2019 09:01:34, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The array has $4$ cells across, with entries in $\{0,1,2\}$. An ADJACENT PAIR is a pair of cells
\[
\begin{array}{l}
$(i,j)\text{ and }(i,j{+}1)$ \\
$(i,j)\text{ and }(i{+}1,j)$ \\
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=166.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268624.
