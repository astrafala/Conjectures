...
\title{The empirical recurrence for OEIS A211532, proved by transfer matrix}
...
\begin{abstract}
OEIS A211532 carries an empirical recurrence of order $7$ contributed by R. H. Hardin. It is
...
OEIS A211532 is ``Number of -1..1 arrays x(i) of n+1 elements i=1..n+1 with set{t,u,v in 0,1}((x[i+t]+x[j+u]+x[k+v])*(-1)\^{}(t+u+v)) having two, four, five, six or seven distinct values for every i,j,k<=n.''. It has offset $1$ and begins
\[
8, 22, 46, 100, 204, 422, 856, 1744,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) + 2*a(n-2) - 11*a(n-3) + a(n-4) + 12*a(n-5) - 2*a(n-6) - 4*a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 19 2018 05:18:43, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A211532.
