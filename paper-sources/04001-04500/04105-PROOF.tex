...
\title{The empirical recurrence for OEIS A283581, proved from an exact model}
...
\begin{abstract}
OEIS A283581 carries an empirical recurrence of order $10$. It is true, and it is
...
\[
1, 11, 101, 1101, 10101, 110101, 1010001, 11011011,\ \dots
\]
...
\begin{theorem}
\[
a(n)\;=\;a(n-2) + 100000000\,a(n-8) - 100000000\,a(n-10)
\]
for every $n>11$.
\end{theorem}
