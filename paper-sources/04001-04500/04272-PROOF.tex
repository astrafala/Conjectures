...
\title{The empirical column recurrences for the table OEIS A268781}
...
\begin{abstract}
OEIS A268781 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A268781 is ``T(n,k) = Number of n X k binary arrays with some element plus some horizontally, vertically, diagonally or antidiagonally adjacent neighbor totalling two no more than once.''. It has offset $1$, is
read by antidiagonals, and begins
\[
2, 4, 4, 7, 11, 7, 13, 26,\ \dots
\]
...
k=7: [order 28].\\
\end{quote}
As of the ``Last modified'' line on the live entry (May 24 2024 15:49:04, revision 6) these are still
...
The sequence is ``Number of n X 1 binary arrays with some element plus some horizontally, vertically, diagonally or antidiagonally adjacent neighbor totalling two no more than once.''. Its rows are the vertices of a digraph on
...
The sequence is ``Number of n X 2 binary arrays with some element plus some horizontally, vertically, diagonally or antidiagonally adjacent neighbor totalling two no more than once.''. Its rows are the vertices of a digraph on
...
The sequence is ``Number of n X 3 binary arrays with some element plus some horizontally, vertically, diagonally or antidiagonally adjacent neighbor totalling two no more than once.''. Its rows are the vertices of a digraph on
...
model reproduces $27$ published values, $70$ decimal digits in all, every one of
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268781.
