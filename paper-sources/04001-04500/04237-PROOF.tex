...
\title{The empirical recurrence for OEIS A277953, proved from an exact model}
...
\begin{abstract}
OEIS A277953 carries an empirical recurrence of order $3$. It is true, and it is
...
OEIS A277953 is ``Binary representation of the x-axis, from the origin to the right edge, of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 14", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 11, 11, 111, 1011, 10111, 101011, 1010111,\ \dots
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A277953.
