...
\title{The empirical recurrence for OEIS A208634, proved by counting patterns}
...
\begin{abstract}
OEIS A208634 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A208634 is ``Number of n X 5 0..1 arrays with new values 0..1 introduced in row major order and no element equal to more than one of its immediate leftward or upward or right-upward antidiagonal neighbors.''. It has offset $1$ and begins
\[
16, 47, 150, 494, 1652, 5572, 18888, 64216,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 6*a(n-1) - 10*a(n-2) + 4*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 05 2018 08:34:46, revision 9) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208634.
