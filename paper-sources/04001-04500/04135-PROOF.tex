...
\title{The conjectured generating function for OEIS A283350, proved}
...
\begin{abstract}
OEIS A283350 counts arrays of a fixed width under a local condition, and carries a conjectured
