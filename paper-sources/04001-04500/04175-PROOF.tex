...
\title{The empirical recurrence for OEIS A189248, proved by transfer matrix}
...
\begin{abstract}
OEIS A189248 counts the permutations of the cells of an $n\times3$ array in which every cell
...
OEIS A189248 is ``Number of nX3 array permutations with each element making zero or one king moves.''. It has offset $1$ and begins
\[
3, 152, 2961, 76629, 1818336, 44308389, 1070959431, 25950094568,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 05:06:09, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;20\,a(n-1) + 125\,a(n-2) - 566\,a(n-3) + 249\,a(n-4) + 916\,a(n-5) - 1703\,a(n-6) + 256\,a(n-7) + 691\,a(n-8) - 30\,a(n-9) - 9\,a(n-10)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A189248.
