...
\title{The empirical recurrence for OEIS A288761, proved from an exact model}
...
\begin{abstract}
OEIS A288761 carries an empirical recurrence of order $4$. It is true, and it is
...
OEIS A288761 is ``Binary representation of the diagonal from the origin to the corner of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 501", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 1, 100, 111, 11000, 11111, 1100000, 111111,\ \dots
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A288761.
