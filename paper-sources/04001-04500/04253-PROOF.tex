...
\title{The empirical recurrence for OEIS A214109, proved by transfer matrix}
...
\begin{abstract}
OEIS A214109 counts the proper colourings of a grid $n\times6$, wrapped in the direction of width $6$, with at most $4$ colours and
...
down to $S=43$ and makes the exact residual test affordable.
\end{abstract}
...
OEIS A214109 is ``Number of 0..3 colorings on an nX6 array circular in the 6 direction with new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
31, 4994, 825105, 136579852, 22615881851, 3745149506514, 620197951750765, 102705230544465812,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 200*a(n-1) -5769*a(n-2) +11744*a(n-3) +43057*a(n-4) -89856*a(n-5) +40625*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 16:51:50, revision 10) this is still
...
\]
There are $(i-1)^{6}+(-1)^{6}(i-1)$ such colourings, which at $i=4$ is already more
...
state count is $S=43$ rather than the number of colourings.
...
\begin{theorem}
\[
a(n)\;=\;200\,a(n-1) - 5769\,a(n-2) + 11744\,a(n-3) + 43057\,a(n-4) - 89856\,a(n-5) + 40625\,a(n-6)
\]
for every $n>6$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A214109.
