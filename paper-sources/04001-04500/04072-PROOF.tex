...
\title{The conjectured generating function for OEIS A283581, proved}
...
\begin{abstract}
OEIS A283581 counts arrays of a fixed width under a local condition, and carries a conjectured
...
OEIS A283581 is ``Binary representation of the x-axis, from the left edge to the origin, of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 646", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 11, 101, 1101, 10101, 110101,\ \dots
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A283581.
