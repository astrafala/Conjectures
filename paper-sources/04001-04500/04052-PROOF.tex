...
\title{The conjectured generating function for OEIS A279962, proved}
...
\begin{abstract}
OEIS A279962 counts arrays of a fixed width under a local condition, and carries a conjectured
