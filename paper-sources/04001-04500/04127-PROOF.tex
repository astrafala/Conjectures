...
\title{The empirical recurrence for OEIS A279874, proved from an exact model}
...
\begin{abstract}
OEIS A279874 carries an empirical recurrence of order $6$. It is true, and it is
...
OEIS A279874 is ``Binary representation of the x-axis, from the origin to the right edge, of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 211", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 10, 101, 1110, 1, 111010, 10101, 10111110,\ \dots
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A279874.
