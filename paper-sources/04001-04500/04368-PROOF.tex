...
\title{The empirical recurrence for OEIS A281146, proved from an exact model}
...
\begin{abstract}
OEIS A281146 carries an empirical recurrence of order $3$. It is true, and it is
...
\[
1, 10, 100, 1000, 10100, 101000, 1010100, 10101000,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
(the empirical recurrence quoted in the entry)
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 05 2025 15:22:36, revision 34)
