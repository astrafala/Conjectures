...
\title{The empirical column recurrences for the table OEIS A264017}
...
\begin{abstract}
OEIS A264017 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A264017 is ``T(n,k)=Number of (n+1)X(k+1) arrays of permutations of 0..(n+1)*(k+1)-1 with each element having index change +-(.,.) 0,0 1,2 or 2,2.''. It has offset $1$, is
read by antidiagonals, and begins
\[
1, 2, 1, 4, 5, 1, 8, 25,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 10 2015 10:52:15, revision 6) these are still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264017.
