...
\title{The empirical recurrence for OEIS A298164, proved by transfer matrix}
...
\begin{abstract}
OEIS A298164 counts $5$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A298164 is ``Number of n X 5 0..1 arrays with every element equal to 3, 4, 5 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
0, 3, 3, 6, 10, 18, 32, 80,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 15 2022 22:27:00, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A298164.
