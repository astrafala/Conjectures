...
\title{The empirical recurrence for OEIS A282411, proved from an exact model}
...
\begin{abstract}
OEIS A282411 carries an empirical recurrence of order $4$ contributed by R. J. Mathar. It is true, and it is
...
OEIS A282411 is ``Binary representation of the x-axis, from the left edge to the origin, of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 467", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 1, 111, 0, 11111, 0, 1111111, 0,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Equivalent conjecture: a(n) = A279118(n) for n>=2. - \_R. J. Mathar\_, Jun 21 2025
\end{quote}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A282411.
