...
\title{The empirical recurrence for OEIS A231444, proved by transfer matrix}
...
\begin{abstract}
OEIS A231444 counts $(n+1)\times2$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A231444 is ``Number of (n+1) X (1+1) 0..3 arrays with no element unequal to a strict majority of its horizontal and antidiagonal neighbors, with values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
2, 6, 23, 102, 492, 2485, 12858, 67354,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 11*a(n-1) - 41*a(n-2) + 65*a(n-3) - 43*a(n-4) + 9*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 28 2018 15:19:35, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231444.
