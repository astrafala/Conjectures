...
\title{The empirical recurrence for OEIS A204734, proved by transfer matrix}
...
\begin{abstract}
OEIS A204734 counts arrays of width $3$ over $\{0,1\}$ by reducing every $2\times2$ subblock to a
...
about it is one bit per adjacent pair of columns, so the count is a walk count on $S=20$
states.
\end{abstract}
...
OEIS A204734 is ``Number of (n+1)X3 0..1 arrays with rows and columns of permanents of all 2X2 subblocks lexicographically nondecreasing, and all 2X2 permanents nonzero.''. It has offset $1$ and begins
\[
15, 43, 115, 304, 787, 2033, 5219, 13398,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) -2*a(n-2) -8*a(n-3) +11*a(n-4) -4*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 22 2025 04:34:51, revision 17) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) - 2\,a(n-2) - 8\,a(n-3) + 11\,a(n-4) - 4\,a(n-5)
\]
for every $n>5$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204734.
