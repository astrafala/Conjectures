...
\title{The empirical recurrence for OEIS A214136, proved by transfer matrix}
...
\begin{abstract}
OEIS A214136 counts the proper colourings of a grid $n\times4$, wrapped in the direction of width $4$, with at most $5$ colours and
...
down to $S=364$ and makes the exact residual test affordable.
\end{abstract}
...
OEIS A214136 is ``Number of 0..4 colorings on an nX4 array circular in the 4 direction with new values 0..4 introduced in row major order.''. It has offset $1$ and begins
\[
4, 257, 28278, 3221873, 367793014, 41989913081, 4793901053846, 547309896088193,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 129*a(n-1) -1759*a(n-2) +7575*a(n-3) -9064*a(n-4) +3120*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 16:53:04, revision 10) this is still
...
\]
There are $(i-1)^{4}+(-1)^{4}(i-1)$ such colourings, which at $i=5$ is already more
...
state count is $S=364$ rather than the number of colourings.
...
\begin{theorem}
\[
a(n)\;=\;129\,a(n-1) - 1759\,a(n-2) + 7575\,a(n-3) - 9064\,a(n-4) + 3120\,a(n-5)
\]
for every $n>5$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A214136.
