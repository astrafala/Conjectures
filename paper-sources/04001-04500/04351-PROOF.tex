...
\title{The empirical closed form for OEIS A208286, proved}
...
\begin{abstract}
OEIS A208286 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
$S=1764$ vertices. Any function of the form $\sum_j p_j(n)\lambda_j^{\,n}$ satisfies the
...
OEIS A208286 is ``Number of n X 7 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 0 1 and 1 1 0 vertically.''. It has offset $1$ and begins
\[
42, 1764, 14946, 70216, 239490, 665892, 1604862, 3478160,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (61/180)*n\^{}7 + (121/20)*n\^{}6 + (1157/36)*n\^{}5 + (425/12)*n\^{}4 - (2923/90)*n\^{}3 - (22/15)*n\^{}2 + 2*n.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 29 2018 14:18:35, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{61 n^{7}}{180} + \frac{121 n^{6}}{20} + \frac{1157 n^{5}}{36} + \frac{425 n^{4}}{12} - \frac{2923 n^{3}}{90} - \frac{22 n^{2}}{15} + 2 n.
\]
...
walk, so with $M$ the adjacency matrix of that digraph on $S=1764$ vertices, and $u,w$ the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208286.
