...
\title{The conjectured generating function for OEIS A284354, proved}
...
\begin{abstract}
OEIS A284354 counts arrays of a fixed width under a local condition, and carries a conjectured
