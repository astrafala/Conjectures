...
\title{The empirical recurrence for OEIS A268622, proved by transfer matrix}
...
\begin{abstract}
OEIS A268622 counts arrays of width $2$ over $\{0,1,2\}$ in which the number of adjacent PAIRS of
...
result is a walk count on $S=25$ states.
\end{abstract}
...
OEIS A268622 is ``Number of n X 2 0..2 arrays with some element plus some horizontally or vertically adjacent neighbor totalling two no more than once.''. It has offset $1$ and begins
\[
9, 42, 174, 666, 2430, 8586, 29646, 100602,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 6*a(n-1) - 9*a(n-2) for n>3.
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 21 2018 09:46:40, revision 7) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The array has $2$ cells across, with entries in $\{0,1,2\}$. An ADJACENT PAIR is a pair of cells
\[
\begin{array}{l}
$(i,j)\text{ and }(i,j{+}1)$ \\
$(i,j)\text{ and }(i{+}1,j)$ \\
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268622.
