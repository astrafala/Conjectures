...
\title{The empirical recurrence for OEIS A279501, proved from an exact model}
...
\begin{abstract}
OEIS A279501 carries an empirical recurrence of order $6$. It is true, and it is
