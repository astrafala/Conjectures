...
\title{The empirical recurrence for OEIS A282609, proved from an exact model}
...
\begin{abstract}
OEIS A282609 carries an empirical recurrence of order $6$. It is true, and it is
...
OEIS A282609 is ``Decimal representation of the x-axis, from the origin to the right edge, of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 489", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 0, 7, 2, 27, 30, 103, 90,\ \dots
\]
...
vanish from $n=13+1$ onwards, and the run exceeds $S+6$, which by
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A282609.
