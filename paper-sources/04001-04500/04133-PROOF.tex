...
\title{The empirical recurrence for OEIS A269103, proved by transfer matrix}
...
\begin{abstract}
OEIS A269103 counts arrays of width $2$ over $\{0,1,2,3\}$ in which the number of adjacent PAIRS of
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 21 2018 12:17:26, revision 9) this is still
