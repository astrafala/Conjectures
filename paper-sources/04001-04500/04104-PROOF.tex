...
\title{The conjectured generating function for OEIS A277867, proved}
...
\begin{abstract}
OEIS A277867 counts arrays of a fixed width under a local condition, and carries a conjectured
...
OEIS A277867 is ``Decimal representation of the x-axis, from the origin to the right edge, of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 3", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 2, 4, 11, 16, 47,\ \dots
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A277867.
