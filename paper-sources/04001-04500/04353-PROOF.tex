...
\title{The conjectured generating function for OEIS A289097, proved}
...
\begin{abstract}
OEIS A289097 counts arrays of a fixed width under a local condition, and carries a conjectured
...
OEIS A289097 is ``Binary representation of the diagonal from the origin to the corner of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 545", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 1, 111, 111, 10111, 11111,\ \dots
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A289097.
