...
\title{The empirical recurrence for OEIS A277928, proved from an exact model}
...
\begin{abstract}
OEIS A277928 carries an empirical recurrence of order $4$. It is true, and it is
...
OEIS A277928 is ``Decimal representation of the x-axis, from the left edge to the origin, of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 5", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 2, 0, 15, 0, 63, 0, 255,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
(the empirical recurrence quoted in the entry)
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 13 2026 13:53:12, revision 13)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A277928.
