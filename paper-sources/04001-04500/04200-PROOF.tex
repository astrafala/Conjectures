...
\title{The empirical recurrence for OEIS A285776, proved from an exact model}
...
\begin{abstract}
OEIS A285776 carries an empirical recurrence of order $4$. It is true, and it is
...
\[
1, 1, 100, 111, 0, 111111, 0, 11111111,\ \dots
\]
