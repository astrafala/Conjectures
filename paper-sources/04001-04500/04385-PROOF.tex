...
\title{The conjectured generating function for OEIS A279875, proved}
...
\begin{abstract}
OEIS A279875 counts arrays of a fixed width under a local condition, and carries a conjectured
