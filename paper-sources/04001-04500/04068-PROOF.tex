...
\title{The empirical column recurrences for the table OEIS A255082}
...
\begin{abstract}
OEIS A255082 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A255082 is ``T(n,k)=Number of (n+2)X(k+2) 0..1 arrays with no 3x3 subblock diagonal sum one and no antidiagonal sum one.''. It has offset $1$, is
read by antidiagonals, and begins
\[
208, 676, 676, 2444, 2704, 2444, 8836, 14161,\ \dots
\]
The entry carries the following block:
\begin{quote}\small
Empirical for column k:\\
k=1: a(n) = 5*a(n-1) -25*a(n-3) +25*a(n-4) for n>5\\
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 15:07:47, revision 6) these are still
...
The sequence is ``Number of (n+2)X3 0..1 arrays with no 3x3 subblock diagonal sum one and no antidiagonal sum one.''. Its rows are the vertices of a digraph on
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A255082.
