...
\title{The empirical recurrence for OEIS A210129, proved by counting patterns}
...
\begin{abstract}
OEIS A210129 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A210129 is ``Number of (n+1) X 4 0..3 arrays with every 2 X 2 subblock having one, three or four distinct values, and new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
897, 84381, 7873809, 735336694, 68668190865, 6412512897051, 598825892889354, 55920742053335527,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 07 2026 20:43:28, revision 11) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;95\,a(n-1) - a(n-2) - 14266\,a(n-3) + 20367\,a(n-4) + 435937\,a(n-5) - 1093869\,a(n-6) - 1923590\,a(n-7) + 8479272\,a(n-8) - 8472184\,a(n-9) + 1936944\,a(n-10) + 631296\,a(n-11)
\end{equation}
for all $n>11$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A210129.
