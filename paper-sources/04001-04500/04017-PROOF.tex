...
\title{The empirical recurrence for OEIS A268777, proved by transfer matrix}
...
\begin{abstract}
OEIS A268777 counts arrays of width $4$ over $\{0,1\}$ in which the number of adjacent PAIRS of
...
result is a walk count on $S=38$ states.
\end{abstract}
...
OEIS A268777 is ``Number of n X 4 binary arrays with some element plus some horizontally, vertically, diagonally or antidiagonally adjacent neighbor totalling two no more than once.''. It has offset $1$ and begins
\[
13, 65, 316, 1462, 6383, 27531, 115391, 478849,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) + 10*a(n-2) - 32*a(n-3) - 47*a(n-4) + 40*a(n-5) + 38*a(n-6) - 12*a(n-7) - 9*a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 15 2019 09:11:04, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The array has $4$ cells across, with entries in $\{0,1\}$. An ADJACENT PAIR is a pair of cells
\[
\begin{array}{l}
$(i,j)\text{ and }(i,j{+}1)$ \\
$(i,j)\text{ and }(i{+}1,j)$ \\
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + 10\,a(n-2) - 32\,a(n-3) - 47\,a(n-4) + 40\,a(n-5) + 38\,a(n-6) - 12\,a(n-7) - 9\,a(n-8)
\]
for every $n>7$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268777.
