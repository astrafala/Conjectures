...
\title{The empirical recurrence for OEIS A204565, proved by counting patterns}
...
\begin{abstract}
OEIS A204565 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A204565 is ``Number of (n+1) X 2 0..3 arrays with every 2 X 2 subblock having equal diagonal elements or equal antidiagonal elements, and new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 07 2018 11:47:13, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204565.
