...
\title{The empirical recurrence for OEIS A210006, proved by transfer matrix}
...
\begin{abstract}
OEIS A210006 counts arrays of width $3$ whose every $2\times2$ subblock holds a
...
nothing else. Each fixed-alphabet count is a walk count on $S=36$ states in all.
\end{abstract}
...
OEIS A210006 is ``Number of (n+1) X 3 0..2 arrays containing all values 0..2 with every 2 X 2 subblock having two or three distinct values, and new values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
88, 2691, 70923, 1808865, 45763485, 1155440875, 29157605895, 735696878225,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 30*a(n-1) - 109*a(n-2) - 290*a(n-3) + 96*a(n-4) + 136*a(n-5) - 48*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 14 2018 05:21:09, revision 9) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The array has $3$ cells across and entries in $\{0,1,\dots,2\}$. In every
...
\begin{theorem}
\[
a(n)\;=\;30\,a(n-1) - 109\,a(n-2) - 290\,a(n-3) + 96\,a(n-4) + 136\,a(n-5) - 48\,a(n-6)
\]
for every $n>6$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A210006.
