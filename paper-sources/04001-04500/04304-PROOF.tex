...
\title{The empirical recurrence for OEIS A279880, proved from an exact model}
...
\begin{abstract}
OEIS A279880 carries an empirical recurrence of order $6$. It is true, and it is
...
OEIS A279880 is ``Decimal representation of the x-axis, from the origin to the right edge, of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 213", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 1, 2, 3, 28, 7, 120, 15,\ \dots
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A279880.
