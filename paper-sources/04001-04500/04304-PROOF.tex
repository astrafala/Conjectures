...
\title{The empirical recurrence for OEIS A282451, proved from an exact model}
...
\begin{abstract}
OEIS A282451 carries an empirical recurrence of order $4$. It is true, and it is
...
OEIS A282451 is ``Binary representation of the x-axis, from the left edge to the origin, of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 475", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 1, 111, 100, 11111, 10000, 1111111, 1000000,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
(the empirical recurrence quoted in the entry)
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 05 2025 15:22:37, revision 15)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A282451.
