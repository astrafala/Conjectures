...
\title{The empirical closed form for OEIS A223836, proved}
...
\begin{abstract}
OEIS A223836 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A223836 is ``Number of n X 6 0..1 arrays with rows, diagonals and antidiagonals unimodal and columns nondecreasing.''. It has offset $1$ and begins
\[
22, 148, 503, 1286, 2884, 5992, 11749, 21912,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (2/45)*n\^{}6 + (55/36)*n\^{}4 + (14/3)*n\^{}3 + (3767/180)*n\^{}2 + (293/6)*n - 116 for n>3.
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 18 2025 20:54:05, revision 10) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{2 n^{6}}{45} + \frac{55 n^{4}}{36} + \frac{14 n^{3}}{3} + \frac{3767 n^{2}}{180} + \frac{293 n}{6} - 116.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223836.
