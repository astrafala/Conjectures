...
\title{The empirical recurrence for OEIS A282607, proved from an exact model}
...
\begin{abstract}
OEIS A282607 carries an empirical recurrence of order $6$. It is true, and it is
...
\[
1, 0, 111, 10, 11011, 11110, 1100111, 1011010,\ \dots
\]
