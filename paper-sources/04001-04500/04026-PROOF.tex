...
\title{The empirical recurrence for OEIS A210136, proved by transfer matrix}
...
\begin{abstract}
OEIS A210136 counts arrays of width $2$ whose every $2\times2$ subblock holds a
...
OEIS A210136 is ``Number of (n+1) X 2 0..3 arrays containing all values 0..3 with every 2 X 2 subblock having one, two or four distinct values, and new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
1, 10, 105, 1018, 9157, 77934, 638065, 5084818,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 18*a(n-1) - 111*a(n-2) + 266*a(n-3) - 180*a(n-4) - 24*a(n-5) + 32*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 14 2018 15:35:07, revision 10) this is still
...
\begin{theorem}
\[
a(n)\;=\;18\,a(n-1) - 111\,a(n-2) + 266\,a(n-3) - 180\,a(n-4) - 24\,a(n-5) + 32\,a(n-6)
\]
for every $n>5$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A210136.
