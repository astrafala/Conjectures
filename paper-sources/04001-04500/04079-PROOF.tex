...
\title{The conjectured generating function for OEIS A288761, proved}
...
\begin{abstract}
OEIS A288761 counts arrays of a fixed width under a local condition, and carries a conjectured
...
\[
1, 1, 100, 111, 11000, 11111,\ \dots
\]
The entry states, as a conjecture contributed by a reader and never marked settled:
\begin{quote}
G.f.: (1 + x - x\^{}2 + 10*x\^{}3 + 1000*x\^{}4 - 1000*x\^{}6 - 1000000*x\^{}7 + 1000000*x\^{}9) / ((1 - x)*(1 + x)*(1 - 10*x)*(1 + 10*x)).
\end{quote}
