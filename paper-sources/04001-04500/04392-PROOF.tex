...
\title{The empirical recurrence for OEIS A290233, proved from an exact model}
...
\begin{abstract}
OEIS A290233 carries an empirical recurrence of order $5$. It is true, and it is
...
OEIS A290233 is ``Binary representation of the diagonal from the origin to the corner of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 773", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 1, 111, 11, 11111, 111, 1111111, 1111,\ \dots
\]
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 110\,a(n-2) - 110\,a(n-3) - 1000\,a(n-4) + 1000\,a(n-5)
\]
for every $n>0$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A290233.
