...
The entry gives only the order for this line: ``k=4: [order 10]''. Its model is a walk on
...
$c_{1}$ & $200$ & $c_{4}$ & $-605899$ & $c_{7}$ & $12176608$ & $c_{10}$ & $-2471040$ \\
$c_{2}$ & $5284$ & $c_{5}$ & $5424778$ & $c_{8}$ & $6786256$ &  &  \\
$c_{3}$ & $-29042$ & $c_{6}$ & $-14965624$ & $c_{9}$ & $-7898208$ &  &  \\
...
model reproduces $13$ published values, $76$ decimal digits in all, every one of
