...
\title{The empirical recurrence for OEIS A282655, proved from an exact model}
...
\begin{abstract}
OEIS A282655 carries an empirical recurrence of order $6$. It is true, and it is
...
vanish from $n=11+1$ onwards, and the run exceeds $S+6$, which by
