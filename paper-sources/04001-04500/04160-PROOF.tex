...
\title{The conjectured generating function for OEIS A285833, proved}
...
\begin{abstract}
OEIS A285833 counts arrays of a fixed width under a local condition, and carries a conjectured
...
\[
1, 11, 110, 1111, 1100, 111111,\ \dots
\]
The entry states, as a conjecture contributed by a reader and never marked settled:
\begin{quote}
G.f.: (1 + 11*x - x\^{}2 - 110*x\^{}3 - 10000*x\^{}4 + 10000*x\^{}6 + 11000000*x\^{}8 - 111000000*x\^{}10 + 100000000*x\^{}12) / ((1 - x)*(1 + x)*(1 - 10*x)*(1 + 10*x)*(1 - 10*x\^{}2)).
\end{quote}
...
\begin{proof}
Write the conjecture as $N_2/D_2$ with $\deg N_2=12$ and $\deg D_2=6$; its expansion as a
