...
\title{The empirical recurrence for OEIS A268745, proved by transfer matrix}
...
\begin{abstract}
OEIS A268745 counts arrays of width $3$ over $\{0,1\}$ in which the number of adjacent PAIRS of
...
OEIS A268745 is ``Number of n X 3 binary arrays with some element plus some horizontally or vertically adjacent neighbor totalling two no more than once.''. It has offset $1$ and begins
\[
7, 32, 143, 623, 2615, 10830, 44067, 177429,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) + 8*a(n-2) - 24*a(n-3) - 38*a(n-4) + 4*a(n-5) + 12*a(n-6) - a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 14 2019 08:40:19, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268745.
