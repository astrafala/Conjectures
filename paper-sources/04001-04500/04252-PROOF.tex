...
\title{The empirical column recurrences for the table OEIS A235026}
...
\begin{abstract}
OEIS A235026 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A235026 is ``T(n,k) is the number of (n+1) X (k+1) 0..5 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 3, with no adjacent elements equal (constant-stress tilted 1 X 1 tilings).''. It has offset $1$, is
read by antidiagonals, and begins
\[
88, 332, 332, 1248, 1200, 1248, 4704, 4312,\ \dots
\]
The entry carries the following block:
\begin{quote}\small
Empirical for column k:\\
k=1: a(n) = 18*a(n-2) -56*a(n-4) +32*a(n-6).\\
k=2: [order 21].\\
k=3: [order 63].\\
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 20 2022 21:18:31, revision 6) these are still
...
The sequence is ``Number of (n+1) X (2) 0..5 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 3, with no adjacent elements equal (constant-stress tilted 1 X 1 tilings).''. Its rows are the vertices of a digraph on
...
$c_{1}$ & $5$ & $c_{7}$ & $-29657$ & $c_{13}$ & $650340$ & $c_{19}$ & $-82432$ \\
$c_{2}$ & $40$ & $c_{8}$ & $-24043$ & $c_{14}$ & $268328$ & $c_{20}$ & $-14336$ \\
$c_{3}$ & $-213$ & $c_{9}$ & $140862$ & $c_{15}$ & $-614608$ & $c_{21}$ & $8192$ \\
$c_{4}$ & $-616$ & $c_{10}$ & $80302$ & $c_{16}$ & $-222048$ &  &  \\
$c_{5}$ & $3529$ & $c_{11}$ & $-394226$ & $c_{17}$ & $318656$ &  &  \\
$c_{6}$ & $4898$ & $c_{12}$ & $-183852$ & $c_{18}$ & $91776$ &  &  \\
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A235026.
