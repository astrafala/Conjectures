...
\title{The empirical recurrence for OEIS A208088, proved by transfer matrix}
...
\begin{abstract}
OEIS A208088 counts, up to renaming the letters, the arrays of width $7$ over at most $2$
letters in which horizontally neighbouring $2\times2$ subblocks have the same number of equal edges and vertically neighbouring ones have different numbers. It carries an empirical recurrence of order $2$ contributed by
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 27 2018 15:30:13, revision 8) this is still
...
$w_i$ cleared of denominators and $S=216$ states in all. The walk index $j$ and the entry's own
