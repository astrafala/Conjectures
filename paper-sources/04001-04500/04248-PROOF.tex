...
\title{The empirical recurrence for OEIS A269006, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A269006 counts arrays over $\{0,\dots,1\}$ subject to a condition on the array as a
...
OEIS A269006 is ``Number of n X 3 binary arrays with some element plus some horizontally, diagonally or antidiagonally adjacent neighbor totalling two exactly once.''. It has offset $1$ and begins
\[
2, 8, 46, 224, 1066, 4952, 22654, 102416,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 10*a(n-1) - 31*a(n-2) + 24*a(n-3) + 21*a(n-4) - 18*a(n-5) - 9*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 18 2019 06:33:23, revision 7) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;10\,a(n-1) - 31\,a(n-2) + 24\,a(n-3) + 21\,a(n-4) - 18\,a(n-5) - 9\,a(n-6)
\end{equation}
for all $n>6$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269006.
