...
\title{The empirical recurrence for OEIS A282417, proved from an exact model}
...
\begin{abstract}
OEIS A282417 carries an empirical recurrence of order $6$. It is true, and it is
