...
\title{The empirical recurrence for OEIS A284180, proved from an exact model}
...
\begin{abstract}
OEIS A284180 carries an empirical recurrence of order $5$. It is true, and it is
...
OEIS A284180 is ``Binary representation of the x-axis, from the origin to the right edge, of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 813", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 1, 101, 101, 11101, 111101, 1110101, 11010101,\ \dots
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A284180.
