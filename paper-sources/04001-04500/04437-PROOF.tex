...
\title{The conjectured generating function for OEIS A282453, proved}
...
\begin{abstract}
OEIS A282453 counts arrays of a fixed width under a local condition, and carries a conjectured
...
OEIS A282453 is ``Decimal representation of the x-axis, from the left edge to the origin, of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 475", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 1, 7, 4, 31, 16,\ \dots
\]
The entry states, as a conjecture contributed by a reader and never marked settled:
\begin{quote}
G.f.: (-x\^{}3 + 2*x\^{}2 + x + 1)/(4*x\^{}4 - 5*x\^{}2 + 1). (End)
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 05 2025 15:22:37, revision 15) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A282453.
