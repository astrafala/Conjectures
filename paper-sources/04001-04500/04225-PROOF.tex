...
\title{The empirical recurrence for OEIS A184689, proved by transfer matrix}
...
\begin{abstract}
OEIS A184689 counts arrays of width $4$ over $\{0,1,2\}$ in which no cell equals both the cell above it and the cell to its left. The entry carries an
...
OEIS A184689 is ``1/3 the number of n X 4 0..2 arrays with no element equal both to the element above and to the element to its left.''. It has offset $1$ and begins
\[
27, 1536, 86688, 4890528, 275895264, 15564399648, 878052505824, 49534593003552,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 61*a(n-1) - 266*a(n-2) + 416*a(n-3) - 256*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 14 2018 13:11:33, revision 11) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A184689.
