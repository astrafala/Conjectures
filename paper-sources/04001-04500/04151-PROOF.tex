...
\title{Arrays counted up to renaming: the empirical recurrence for OEIS A205425}
...
\begin{abstract}
OEIS A205425 carries an empirical recurrence of order $4$ contributed by R.~H.~Hardin. It is
...
both in the state the arrays are exactly the walks in a digraph on $S=8$ vertices, so $a(n)$
...
OEIS A205425 is ``Number of (n+1) X 3 0..3 arrays with the number of equal 2 X 2 subblock diagonal pairs and equal antidiagonal pairs differing from each horizontal or vertical neighbor, and new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
102, 1662, 29022, 513038, 9083342, 160862398, 2848901694, 50454831598,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 11 2018 14:03:34, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;16\,a(n-1) + 37\,a(n-2) - 108\,a(n-3) - 192\,a(n-4)
\]
for every $n>4$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A205425.
