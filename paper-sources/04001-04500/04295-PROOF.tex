...
\title{The empirical recurrence for OEIS A279030, proved from an exact model}
...
\begin{abstract}
OEIS A279030 carries an empirical recurrence of order $4$. It is true, and it is
...
OEIS A279030 is ``Decimal representation of the x-axis, from the left edge to the origin, of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 129", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 0, 5, 0, 21, 0, 85, 0,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
(the empirical recurrence quoted in the entry)
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 05 2025 15:22:35, revision 29)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A279030.
