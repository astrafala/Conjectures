...
\title{The empirical recurrence for OEIS A210088, proved by transfer matrix}
...
\begin{abstract}
OEIS A210088 counts arrays of width $2$ whose every $2\times2$ subblock holds a
...
OEIS A210088 is ``Number of (n+1) X 2 0..2 arrays containing all values 0..2 with every 2 X 2 subblock having one or two distinct values, and new values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
0, 9, 90, 657, 4230, 25533, 148410, 842265,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 10*a(n-1) - 27*a(n-2) + 10*a(n-3) + 8*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 14 2018 05:56:18, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;10\,a(n-1) - 27\,a(n-2) + 10\,a(n-3) + 8\,a(n-4)
\]
for every $n>3$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A210088.
