...
\title{The empirical recurrence for OEIS A282798, proved from an exact model}
...
\begin{abstract}
OEIS A282798 carries an empirical recurrence of order $4$. It is true, and it is
