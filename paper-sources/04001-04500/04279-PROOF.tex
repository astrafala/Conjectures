...
\title{The empirical closed form for OEIS A225009, proved}
...
\begin{abstract}
OEIS A225009 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
$S=29$ vertices. Any function of the form $\sum_j p_j(n)\lambda_j^{\,n}$ satisfies the
...
OEIS A225009 is ``Number of n X 7 0..1 arrays with rows unimodal and columns nondecreasing.''. It has offset $1$ and begins
\[
29, 239, 1163, 4166, 12174, 30738, 69498, 144111,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (4/315)*n\^{}7 + (1/5)*n\^{}6 + (58/45)*n\^{}5 + (35/8)*n\^{}4 + (1507/180)*n\^{}3 + (357/40)*n\^{}2 + (2027/420)*n + 1.
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 05 2018 06:13:32, revision 7) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{4 n^{7}}{315} + \frac{n^{6}}{5} + \frac{58 n^{5}}{45} + \frac{35 n^{4}}{8} + \frac{1507 n^{3}}{180} + \frac{357 n^{2}}{40} + \frac{2027 n}{420} + 1.
\]
...
walk, so with $M$ the adjacency matrix of that digraph on $S=29$ vertices, and $u,w$ the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A225009.
