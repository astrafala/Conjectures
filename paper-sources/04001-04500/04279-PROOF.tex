...
\title{The empirical recurrence for OEIS A284482, proved from an exact model}
...
\begin{abstract}
OEIS A284482 carries an empirical recurrence of order $5$. It is true, and it is
...
OEIS A284482 is ``Decimal representation of the x-axis, from the origin to the right edge, of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 950", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 3, 5, 15, 29, 63, 125, 247,\ \dots
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A284482.
