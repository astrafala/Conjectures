...
\title{The empirical closed form for OEIS A207399, proved}
...
\begin{abstract}
OEIS A207399 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A207399 is ``Number of n X 4 0..1 arrays avoiding 0 0 1 and 0 1 1 horizontally and 0 0 1 and 1 1 0 vertically.''. It has offset $1$ and begins
\[
9, 81, 289, 729, 1521, 2809, 4761, 7569,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = n\^{}4 + 6*n\^{}3 + 7*n\^{}2 - 6*n + 1.
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 05 2018 05:36:08, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;n^{4} + 6 n^{3} + 7 n^{2} - 6 n + 1.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207399.
