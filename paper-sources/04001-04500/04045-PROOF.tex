...
\title{The conjectured generating function for OEIS A282485, proved}
...
\begin{abstract}
OEIS A282485 counts arrays of a fixed width under a local condition, and carries a conjectured
...
\begin{quote}
G.f.: (1 + 3*x - x\^{}2 + 3*x\^{}3 - 10*x\^{}4 - 32*x\^{}5 + 88*x\^{}6 + 128*x\^{}10) / ((1 - x)*(1 + x)*(1 - 2*x)*(1 + 2*x)*(1 + x\^{}2)).
\end{quote}
