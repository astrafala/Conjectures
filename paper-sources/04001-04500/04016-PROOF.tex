...
\title{The conjectured generating function for OEIS A281216, proved}
...
\begin{abstract}
OEIS A281216 counts arrays of a fixed width under a local condition, and carries a conjectured
...
OEIS A281216 is ``Decimal representation of the x-axis, from the left edge to the origin, of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 342", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 3, 4, 14, 17, 59,\ \dots
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A281216.
