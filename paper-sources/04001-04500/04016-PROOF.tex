...
\title{The conjectured generating function for OEIS A278756, proved}
...
\begin{abstract}
OEIS A278756 counts arrays of a fixed width under a local condition, and carries a conjectured
...
OEIS A278756 is ``Decimal representation of the x-axis, from the origin to the right edge, of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 65", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 0, 6, 1, 28, 3,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 10 2026 11:41:28, revision 17) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A278756.
