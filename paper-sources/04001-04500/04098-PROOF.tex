...
\title{The conjectured generating function for OEIS A284405, proved}
...
\begin{abstract}
OEIS A284405 counts arrays of a fixed width under a local condition, and carries a conjectured
...
\begin{quote}
G.f.: (1 - 3*x + 7*x\^{}2 - 8*x\^{}3 + 20*x\^{}4 - 16*x\^{}5) / ((1 - x)*(1 - 2*x)).
\end{quote}
