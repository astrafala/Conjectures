...
\title{The empirical recurrence for OEIS A282002, proved from an exact model}
...
\begin{abstract}
OEIS A282002 carries an empirical recurrence of order $4$. It is true, and it is
...
OEIS A282002 is ``Binary representation of the x-axis, from the left edge to the origin, of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 413", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 10, 11, 1110, 11, 111110, 11, 11111110,\ \dots
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A282002.
