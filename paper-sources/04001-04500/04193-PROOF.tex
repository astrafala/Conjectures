...
\title{No column above the one before it in every row: OEIS A212938}
...
\begin{abstract}
OEIS A212938 carries an empirical recurrence of order $3$ contributed by R.~H.~Hardin. It is
...
\[
1, 181, 9019, 331489, 10669771, 320396041, 9245913139, 260489615329,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 55*a(n-1) - 936*a(n-2) + 4860*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 21 2018 15:52:27, revision 13) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{The count is a walk count}

The entry counts arrays of $3$ columns whose rows are arbitrary over the alphabet $\{0,1,2\}$, and asks that no column $j$ be greater than or equal to column $j-1$ \emph{in all rows}.
...
\begin{theorem}
\[
a(n)\;=\;55\,a(n-1) - 936\,a(n-2) + 4860\,a(n-3)
\]
for every $n>3$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A212938.
