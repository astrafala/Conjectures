...
\title{The conjectured generating function for OEIS A282142, proved}
...
\begin{abstract}
OEIS A282142 counts arrays of a fixed width under a local condition, and carries a conjectured
