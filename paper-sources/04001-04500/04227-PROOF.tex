...
\title{The empirical column recurrences for the table OEIS A278280}
...
\begin{abstract}
OEIS A278280 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A278280 is ``T(n,k) = Number of n X k 0..1 arrays with every element both equal and not equal to some elements at offset (-1,-1) (-1,0) (-1,1) (0,-1) (0,1) or (1,0), with upper left element zero.''. It has offset $1$, is
read by antidiagonals, and begins
\[
0, 0, 0, 0, 2, 0, 0, 4,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 05 2022 19:40:56, revision 6) these are still
...
\subsection*{Row $n$$=2$}
The sequence is ``Number of 2 X n 0..1 arrays with every element both equal and not equal to some elements at offset (-1,-1) (-1,0) (-1,1) (0,-1) (0,1) or (1,0), with upper left element zero.''. Its rows are the vertices of a digraph on
...
model reproduces $9$ published values, $20$ decimal digits in all, every one of
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A278280.
