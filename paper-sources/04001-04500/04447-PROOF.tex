...
\title{The empirical recurrence for OEIS A281338, proved by transfer matrix}
...
\begin{abstract}
OEIS A281338 counts $n\times2$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A281338 is ``Number of n X 2 0..1 arrays with no element equal to more than three of its king-move neighbors and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
2, 8, 25, 85, 286, 969, 3281, 11114,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) + a(n-2) + 2*a(n-3) - 2*a(n-4) - 4*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 21 2018 12:51:31, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A281338.
