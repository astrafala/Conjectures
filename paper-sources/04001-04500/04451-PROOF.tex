...
\title{The empirical recurrence for OEIS A214167, proved by transfer matrix}
...
\begin{abstract}
OEIS A214167 counts the proper colourings of a grid $1\times(n+1)$, wrapped in the growing direction, with at most $6$ colours and
...
down to $S=21$ and makes the exact residual test affordable.
\end{abstract}
...
OEIS A214167 is ``Number of 0..5 colorings of a 1 X (n+1) array circular in the n+1 direction with new values 0..5 introduced in row major order.''. It has offset $1$ and begins
\[
1, 1, 4, 11, 41, 161, 694, 3151,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 10*a(n-1) -30*a(n-2) +20*a(n-3) +31*a(n-4) -30*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 15 2023 11:12:57, revision 17) this is still
...
state count is $S=21$ rather than the number of colourings.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A214167.
