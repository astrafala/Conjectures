...
\title{The conjectured generating function for OEIS A279880, proved}
...
\begin{abstract}
OEIS A279880 counts arrays of a fixed width under a local condition, and carries a conjectured
...
\begin{quote}
G.f.: (1+x-5*x\^{}2-4*x\^{}3+28*x\^{}4-56*x\^{}6+32*x\^{}8) / ((1-x)*(1+x)*(1-2*x)*(1+2*x)*(1-2*x\^{}2)).
\end{quote}
