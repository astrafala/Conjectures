...
\title{The conjectured generating function for OEIS A279499, proved}
...
\begin{abstract}
OEIS A279499 counts arrays of a fixed width under a local condition, and carries a conjectured
...
\[
1, 0, 101, 0, 11101, 0,\ \dots
\]
The entry states, as a conjecture contributed by a reader and never marked settled:
\begin{quote}
G.f.: (1 + x\^{}2 + 1000*x\^{}4 - 99000*x\^{}6 - 10000000*x\^{}10) / ((1 - x)*(1 + x)*(1 - 10*x)*(1 + 10*x)*(1 + x\^{}2)).
\end{quote}
