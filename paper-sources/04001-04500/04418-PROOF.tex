...
\title{The empirical closed form for OEIS A207401, proved}
...
\begin{abstract}
OEIS A207401 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A207401 is ``Number of n X 6 0..1 arrays avoiding 0 0 1 and 0 1 1 horizontally and 0 0 1 and 1 1 0 vertically.''. It has offset $1$ and begins
\[
16, 256, 1296, 4356, 11664, 26896, 55696, 106276,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (1/9)*n\^{}6 + (4/3)*n\^{}5 + (58/9)*n\^{}4 + (40/3)*n\^{}3 + (49/9)*n\^{}2 - (44/3)*n + 4.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 22 2018 08:27:36, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{n^{6}}{9} + \frac{4 n^{5}}{3} + \frac{58 n^{4}}{9} + \frac{40 n^{3}}{3} + \frac{49 n^{2}}{9} - \frac{44 n}{3} + 4.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207401.
