...
\title{The empirical recurrence for OEIS A284237, proved from an exact model}
...
\begin{abstract}
OEIS A284237 carries an empirical recurrence of order $3$. It is true, and it is
...
OEIS A284237 is ``Decimal representation of the x-axis, from the left edge to the origin, of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 833", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 0, 3, 5, 10, 21, 42, 85,\ \dots
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A284237.
