...
\title{The empirical recurrence for OEIS A268736, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A268736 counts arrays over $\{0,\dots,1\}$ subject to a condition on the array as a
...
OEIS A268736 is ``Number of nX4 binary arrays with some 1 horizontally or vertically adjacent to some other 1 exactly once.''. It has offset $1$ and begins
\[
5, 48, 396, 2876, 19591, 128232, 816009, 5087814,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 8*a(n-1) +2*a(n-2) -82*a(n-3) -49*a(n-4) +124*a(n-5) +39*a(n-6) -58*a(n-7) -6*a(n-8) +8*a(n-9) -a(n-10)
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 12 2016 08:42:09, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;8\,a(n-1) + 2\,a(n-2) - 82\,a(n-3) - 49\,a(n-4) + 124\,a(n-5) + 39\,a(n-6) - 58\,a(n-7) - 6\,a(n-8) + 8\,a(n-9) - a(n-10)
\end{equation}
for all $n>10$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268736.
