...
\title{The empirical recurrence for OEIS A284484, proved from an exact model}
...
\begin{abstract}
OEIS A284484 carries an empirical recurrence of order $3$. It is true, and it is
...
\[
1, 0, 111, 1011, 1111, 101111, 111111, 10111111,\ \dots
\]
