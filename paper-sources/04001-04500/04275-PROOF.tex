...
\title{The empirical recurrence for OEIS A282918, proved from an exact model}
...
\begin{abstract}
OEIS A282918 carries an empirical recurrence of order $6$. It is true, and it is
