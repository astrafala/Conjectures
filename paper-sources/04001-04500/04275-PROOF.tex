...
\title{The empirical column recurrences for the table OEIS A231977}
...
\begin{abstract}
OEIS A231977 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A231977 is ``T(n,k)=Number of (n+1)X(k+1) 0..1 arrays with no element having a strict majority of its horizontal and vertical neighbors equal to one.''. It has offset $1$, is
read by antidiagonals, and begins
\[
9, 16, 16, 36, 56, 36, 81, 169,\ \dots
\]
...
k=4: [order 49]\\
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 06:46:23, revision 6) these are still
...
The sequence is ``Number of (n+1)X(2) 0..1 arrays with no element having a strict majority of its horizontal and vertical neighbors equal to one.''. Its rows are the vertices of a digraph on
$S=13$ vertices, edges being the admissible consecutive pairs, and the count is
...
$c_{1}$ & $2$ & $c_{7}$ & $-303$ & $c_{13}$ & $-96$ & $c_{19}$ & $-10$ \\
$c_{2}$ & $8$ & $c_{8}$ & $-268$ & $c_{14}$ & $57$ & $c_{20}$ & $6$ \\
$c_{3}$ & $36$ & $c_{9}$ & $124$ & $c_{15}$ & $146$ & $c_{21}$ & $-1$ \\
$c_{4}$ & $90$ & $c_{10}$ & $40$ & $c_{16}$ & $36$ &  &  \\
$c_{5}$ & $170$ & $c_{11}$ & $-200$ & $c_{17}$ & $-4$ &  &  \\
$c_{6}$ & $66$ & $c_{12}$ & $-184$ & $c_{18}$ & $22$ &  &  \\
\end{tabular}\end{center}
Repeating with the first $21+4$ terms removed gives order $21$ again.

\subsection*{Column $k=4$, recovered}
The entry gives only the order for this line: ``k=4: [order 49]''. Its model is a walk on
$S=304$ vertices, so it satisfies a monic recurrence of order at most $S$;
Berlekamp--Massey on $2S=608$ exact terms returns the minimal one, of order
$49$ --- the stated order --- with integer coefficients
\[
(c_1,\dots,c_{49})=(7,\ 0,\ 148,\ 344,\ 673,\ 337,\ 11361,\ 48985,\ -97191,\ -358946,\ 417305,\ 1757105,\ -2002936,\ -7478980,\ -818162,\ 5202627,\ 2279142,\ -18922108,\ -31042348,\ -55043465,\ 23805696,\ -10999792,\ 52136816,\ 30760744,\ 21670317,\ 137708184,\ 27375080,\ 134395920,\ -103979476,\ 49936800,\ -43951872,\ -5680896,\ 5000768,\ -11970048,\ 4762496,\ 3064320,\ 9770624,\ 9022464,\ -7157760,\ 4641792,\ -3973120,\ 204800,\ 663552,\ -86016,\ -205824,\ 73728,\ 0,\ -32768,\ 16384).
\]
...
model reproduces $9$ published values, $24$ decimal digits in all, every one of
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231977.
