...
\title{The empirical recurrence for OEIS A282122, proved from an exact model}
...
\begin{abstract}
OEIS A282122 carries an empirical recurrence of order $4$. It is true, and it is
...
\[
1, 11, 11, 1111, 1011, 111111, 101011, 11111111,\ \dots
\]
