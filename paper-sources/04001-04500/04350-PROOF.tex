...
\title{The empirical recurrence for OEIS A290195, proved from an exact model}
...
\begin{abstract}
OEIS A290195 carries an empirical recurrence of order $3$ contributed by David A. Corneth. It is true, and it is
...
OEIS A290195 is ``Decimal representation of the diagonal from the origin to the corner of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 705", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 1, 5, 11, 7, 47, 31, 191,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjecture: For odd n > 3, a(n) = 2\^{}(n-1) - 1, for even n > 3, a(n) = 3*2\^{}(n-1) - 1. - \_David A. Corneth\_, Jul 23 2017
\end{quote}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A290195.
