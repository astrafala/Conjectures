...
\title{The empirical recurrence for OEIS A237946, proved by transfer matrix}
...
\begin{abstract}
OEIS A237946 counts arrays over $\{0,\dots,3\}$ subject to a condition on the order
...
OEIS A237946 is ``Number of (n+1)X(1+1) 0..3 arrays with the maximum plus the upper median plus the lower median of every 2X2 subblock differing from its horizontal and vertical neighbors by exactly one.''. It has offset $1$ and begins
\[
256, 1460, 8291, 50268, 303996, 1843152, 11184876, 68097912,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 10:37:42, revision 7) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The $2\times2$ subblocks of an $(n+1)\times2$ array form an
$n\times1$ grid, and each carries the value $\sigma=b+c+d$, where $a\le b\le c\le d$ are its four entries sorted --- its minimum, lower median, upper median and maximum. The entry asks that the values of
...
\begin{theorem}
\[
a(n)\;=\;1560\,a(n-4) + 11688\,a(n-6) - 610232\,a(n-8) - 5928792\,a(n-10) + 83894672\,a(n-12) + 940586352\,a(n-14) - 3589253408\,a(n-16) - 53418037952\,a(n-18) + 34878344128\,a(n-20) + 1320056629504\,a(n-22) + 920196238464\,a(n-24) - 14002856470016\,a(n-26) - 18920656812032\,a(n-28) + 49172761794560\,a(n-30) + 77939535077376\,a(n-32) - 51754973675520\,a(n-34) - 94552987795456\,a(n-36) - 9959401586688\,a(n-38) + 16399438184448\,a(n-40) + 2392665882624\,a(n-42) - 847987605504\,a(n-44) - 86973087744\,a(n-46)
\]
for every $n>46$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237946.
