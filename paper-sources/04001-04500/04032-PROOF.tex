...
\title{The empirical closed form for OEIS A224003, proved}
...
\begin{abstract}
OEIS A224003 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A224003 is ``Number of 5Xn 0..2 arrays with antidiagonals unimodal and rows and diagonals nondecreasing.''. It has offset $1$ and begins
\[
243, 4004, 18672, 55333, 132119, 281271, 559188, 1063365,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 18 2025 04:15:42, revision 9) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\begin{multline*}
f(n)\;=\;\frac{n^{10}}{86400} + \frac{n^{9}}{5760} \\
+ \frac{13 n^{8}}{3360} + \frac{1079 n^{7}}{20160} \\
+ \frac{19031 n^{6}}{28800} + \frac{35137 n^{5}}{5760} \\
+ \frac{513623 n^{4}}{8640} + \frac{161053 n^{3}}{480} \\
+ \frac{3838487 n^{2}}{2800} - \frac{614813 n}{210} \\
- 2235.
\end{multline*}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224003.
