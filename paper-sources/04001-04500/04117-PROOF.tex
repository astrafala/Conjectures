...
\title{The empirical recurrence for OEIS A224020, proved by transfer matrix}
...
\begin{abstract}
OEIS A224020 counts arrays over $\{0,\dots,3\}$ whose rows, columns, diagonals or
...
OEIS A224020 is ``Number of nX4 0..3 arrays with rows nondecreasing and antidiagonals unimodal.''. It has offset $1$ and begins
\[
35, 1225, 32523, 772683, 17735200, 403836633, 9186127249, 208983591829,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 23:10:55, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224020.
