...
\title{The empirical closed form for OEIS A223773, proved}
...
\begin{abstract}
OEIS A223773 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A223773 is ``Number of n X 4 0..1 arrays with rows and columns unimodal and antidiagonals nondecreasing.''. It has offset $1$ and begins
\[
11, 56, 180, 461, 1040, 2164, 4246, 7950,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 23 2018 08:29:33, revision 7) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{n^{8}}{40320} + \frac{n^{7}}{3360} + \frac{19 n^{6}}{2880} + \frac{7 n^{5}}{120} + \frac{2447 n^{4}}{5760} + \frac{259 n^{3}}{160} + \frac{126691 n^{2}}{10080} - \frac{12329 n}{840} + 13.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223773.
