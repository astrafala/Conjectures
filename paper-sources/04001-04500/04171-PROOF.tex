...
\title{The empirical recurrence for OEIS A208635, proved by counting patterns}
...
\begin{abstract}
OEIS A208635 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A208635 is ``Number of n X 6 0..1 arrays with new values 0..1 introduced in row major order and no element equal to more than one of its immediate leftward or upward or right-upward antidiagonal neighbors.''. It has offset $1$ and begins
\[
32, 95, 309, 1042, 3577, 12404, 43284, 151656,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 7*a(n-1) - 15*a(n-2) + 10*a(n-3) - a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 05 2018 08:44:18, revision 8) the statement is
...
\[
2!\Bigl(a(n)-\sum_i c_i\,a(n-i)\Bigr)\;=\;\mathbf{v}^{\!\top}N^{\,m-4}q(N)\mathbf{1} .
\]
...
\eqref{eq:walk}, divided by $2!$, was evaluated at every one of the $23$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208635.
