...
\title{The empirical recurrence for OEIS A283216, proved from an exact model}
...
\begin{abstract}
OEIS A283216 carries an empirical recurrence of order $6$. It is true, and it is
...
OEIS A283216 is ``Decimal representation of the x-axis, from the left edge to the origin, of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 597", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 2, 4, 11, 17, 46, 68, 187,\ \dots
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A283216.
