...
\title{The empirical recurrence for OEIS A282871, proved from an exact model}
...
\begin{abstract}
OEIS A282871 carries an empirical recurrence of order $3$. It is true, and it is
...
\[
1, 0, 11, 1, 1110, 110, 111110, 11110,\ \dots
\]
