...
\title{The empirical column recurrences for the table OEIS A251055}
...
\begin{abstract}
OEIS A251055 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A251055 is ``T(n,k)=Number of (n+1)X(k+1) 0..3 arrays with no 2X2 subblock having the sum of its diagonal elements greater than the absolute difference of its antidiagonal elements.''. It has offset $1$, is
read by antidiagonals, and begins
\[
66, 290, 290, 854, 1528, 854, 2243, 4334,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:03:16, revision 6) these are still
...
The sequence is ``Number of (n+1)X(2) 0..3 arrays with no 2X2 subblock having the sum of its diagonal elements greater than the absolute difference of its antidiagonal elements.''. Its rows are the vertices of a digraph on
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251055.
