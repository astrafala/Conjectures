...
\title{The empirical recurrence for OEIS A282121, proved from an exact model}
...
\begin{abstract}
OEIS A282121 carries an empirical recurrence of order $4$. It is true, and it is
...
OEIS A282121 is ``Binary representation of the x-axis, from the left edge to the origin, of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 430", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 11, 110, 1111, 11010, 111111, 1101010, 11111111,\ \dots
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A282121.
