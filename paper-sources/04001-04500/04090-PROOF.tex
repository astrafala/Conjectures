...
\title{The empirical recurrence for OEIS A275185, proved by transfer matrix}
...
\begin{abstract}
OEIS A275185 counts arrays in which no entry may equal the entries at a short list of fixed offsets
...
OEIS A275185 is ``Number of 5 X n 0..2 arrays with no element equal to any value at offset (-2,-1) (-1,0) or (-1,1) and new values introduced in order 0..2.''. It has offset $1$ and begins
\[
8, 21, 85, 353, 1465, 6081, 25241, 104769,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + 7*a(n-2) + 8*a(n-3) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 01 2019 05:32:09, revision 9) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A275185.
