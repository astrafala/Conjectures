...
\title{The empirical recurrence for OEIS A231103, proved by transfer matrix}
...
\begin{abstract}
OEIS A231103 counts arrays of width $3$ over $\{0,1,2,3\}$ in which every cell must see, among its
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 26 2018 08:20:47, revision 8) this is still
