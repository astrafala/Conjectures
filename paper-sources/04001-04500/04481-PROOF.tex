...
\title{The conjectured generating function for OEIS A290195, proved}
...
\begin{abstract}
OEIS A290195 counts arrays of a fixed width under a local condition, and carries a conjectured
