...
\title{The empirical recurrence for OEIS A262789, proved by transfer matrix}
...
\begin{abstract}
OEIS A262789 counts arrays of width $4$ over $\{0,1\}$ whose rows, read as base-$2$
...
OEIS A262789 is ``Number of (n+2) X (2+2) 0..1 arrays with each row divisible by 5 and column not divisible by 5, read as a binary number with top and left being the most significant bits.''. It has offset $1$ and begins
\[
36, 144, 625, 2601, 10404, 41616, 167281, 670761,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 6*a(n-1) - 12*a(n-2) + 24*a(n-3) - 31*a(n-4) - 6*a(n-5) + 12*a(n-6) - 24*a(n-7) + 32*a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 01 2019 08:43:58, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A262789.
