...
\title{The conjectured generating function for OEIS A282415, proved}
...
\begin{abstract}
OEIS A282415 counts arrays of a fixed width under a local condition, and carries a conjectured
...
OEIS A282415 is ``Binary representation of the x-axis, from the left edge to the origin, of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 469", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 10, 11, 1100, 111, 111000,\ \dots
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A282415.
