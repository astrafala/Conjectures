...
\title{The empirical recurrence for OEIS A280373, proved from an exact model}
...
\begin{abstract}
OEIS A280373 carries an empirical recurrence of order $4$. It is true, and it is
...
vanish from $n=12+1$ onwards, and the run exceeds $S+4$, which by
