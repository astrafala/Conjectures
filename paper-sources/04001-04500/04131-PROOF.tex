...
\title{The empirical recurrence for OEIS A223505, proved by transfer matrix}
...
\begin{abstract}
OEIS A223505 counts the ways of writing the vertices of a fixed graph $G$ into an array of width
...
single slice is a state and the count is a walk count on a finite digraph with $S=32$ vertices.
\end{abstract}
...
of length $2$ over $6$ vertices is one of $6^{2}$ words, but only $S-1$ of them are
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223505.
