...
\title{The empirical recurrence for OEIS A269188, proved by transfer matrix}
...
\begin{abstract}
OEIS A269188 counts arrays of width $2$ over $\{0,1,2,3\}$ in which the number of adjacent PAIRS of
...
result is a walk count on $S=45$ states.
\end{abstract}
...
OEIS A269188 is ``Number of n X 2 0..3 arrays with some element plus some horizontally, diagonally, antidiagonally or vertically adjacent neighbor totalling three no more than once.''. It has offset $1$ and begins
\[
16, 108, 708, 4476, 27684, 168252, 1008804, 5983164,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 10*a(n-1) - 21*a(n-2) - 20*a(n-3) - 4*a(n-4) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 19 2019 12:07:24, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269188.
