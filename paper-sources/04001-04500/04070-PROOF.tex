...
\title{The empirical recurrence for OEIS A206514, proved by transfer matrix}
...
\begin{abstract}
OEIS A206514 counts, up to renaming the letters, the arrays of width $2$ over at most $4$
letters in which every $2\times3$ and $3\times2$ subblock has at most $4$ equal edges, an edge of such a window being one of the six steps of its perimeter cycle and an equal edge one whose two cells agree. It carries an empirical recurrence of order $6$ contributed by
...
OEIS A206514 is ``Number of (n+1) X 2 0..3 arrays with every 2 X 3 or 3 X 2 subblock having no more than four equal edges, and new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
15, 186, 2786, 43804, 697369, 11136544, 177977851, 2844864002,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 18*a(n-1) - 27*a(n-2) - 76*a(n-3) - 111*a(n-4) - 66*a(n-5) - 24*a(n-6) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 17 2018 05:52:33, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;18\,a(n-1) - 27\,a(n-2) - 76\,a(n-3) - 111\,a(n-4) - 66\,a(n-5) - 24\,a(n-6)
\]
for every $n>7$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206514.
