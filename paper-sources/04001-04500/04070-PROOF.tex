...
\title{The empirical recurrence for OEIS A214233, proved by transfer matrix}
...
\begin{abstract}
OEIS A214233 counts the proper colourings of a grid $n\times4$, wrapped in the direction of width $4$, with at most $8$ colours and
counted up to renaming the colours, and carries an empirical recurrence of order $11$
...
down to $S=24$ and makes the exact residual test affordable.
\end{abstract}
...
OEIS A214233 is ``Number of 0..7 colorings of an nX4 array circular in the 4 direction with new values 0..7 introduced in row major order.''. It has offset $1$ and begins
\[
4, 354, 175884, 188834753, 253155125338, 356734116034266, 508116551730888266, 725424852023224352701,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 16:56:46, revision 8) this is still
...
\]
There are $(i-1)^{4}+(-1)^{4}(i-1)$ such colourings, which at $i=8$ is already more
...
state count is $S=24$ rather than the number of colourings.
...
\begin{theorem}
\[
a(n)\;=\;1953\,a(n-1) - 829512\,a(n-2) + 119749880\,a(n-3) - 7217451834\,a(n-4) + 211005732306\,a(n-5) - 3163113776744\,a(n-6) + 24791539817472\,a(n-7) - 99982144638429\,a(n-8) + 193376413692421\,a(n-9) - 161723079970872\,a(n-10) + 46496477673360\,a(n-11)
\]
for every $n>11$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A214233.
