...
\title{The empirical recurrence for OEIS A280599, proved by transfer matrix}
...
\begin{abstract}
OEIS A280599 counts $n\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A280599 is ``Number of n X 3 0..1 arrays with no element equal to more than two of its horizontal, vertical and antidiagonal neighbors and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
4, 18, 45, 116, 293, 735, 1844, 4626,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) - 3*a(n-2) - 3*a(n-3) + 2*a(n-4) + 3*a(n-5) - 2*a(n-6) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 22 2018 09:46:59, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) - 3\,a(n-2) - 3\,a(n-3) + 2\,a(n-4) + 3\,a(n-5) - 2\,a(n-6)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A280599.
