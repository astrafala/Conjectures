...
\title{The conjectured generating function for OEIS A290415, proved}
...
\begin{abstract}
OEIS A290415 counts arrays of a fixed width under a local condition, and carries a conjectured
