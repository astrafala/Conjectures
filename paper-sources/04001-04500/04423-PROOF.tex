...
\title{The empirical recurrence for OEIS A224548, proved by transfer matrix}
...
\begin{abstract}
OEIS A224548 counts the $(n+1)\times7$ matrices over $\{0,\dots,1\}$ all of whose
...
makes $a(n)$ a walk count on $S=73$ vertices, hence $C$-finite, and whether the conjectured
...
OEIS A224548 is ``Number of (n+1) X 7 0..1 matrices with each 2 X 2 subblock idempotent.''. It has offset $1$ and begins
\[
132, 218, 302, 448, 635, 916, 1323, 1941,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) - 5*a(n-2) + a(n-3) + 2*a(n-4) - a(n-5) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 31 2018 06:35:18, revision 7) this is still
...
\]
with $M$ the adjacency matrix on $S=73$ states. In particular $a$ is $C$-finite. The
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224548.
