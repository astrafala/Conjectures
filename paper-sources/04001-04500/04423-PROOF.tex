...
\title{The empirical recurrence for OEIS A193695, proved by transfer matrix}
...
\begin{abstract}
OEIS A193695 carries an empirical recurrence of order $5$ contributed by R. H. Hardin. It is
...
OEIS A193695 is ``Number of arrays of -1..1 integers x(1..n) with every x(i) in a subsequence of length 1, 2 or 3 with sum zero.''. It has offset $1$ and begins
\[
1, 3, 9, 23, 57, 141, 351, 875,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) +a(n-2) +a(n-4) +a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 06:00:16, revision 12) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A193695.
