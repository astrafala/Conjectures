...
\title{The empirical recurrence for OEIS A275560, proved by counting patterns}
...
\begin{abstract}
OEIS A275560 counts arrays in which no entry may repeat a value found at any of three stated
...
OEIS A275560 is ``Number of n X 3 0..2 arrays with no element equal to any value at offset (-2,0) (-1,2) or (0,-2) and new values introduced in order 0..2.''. It has offset $1$ and begins
\[
3, 36, 126, 504, 1872, 7200, 27360, 104256,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) + 8*a(n-2) - 16*a(n-4) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 04 2019 13:58:12, revision 7) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A275560.
