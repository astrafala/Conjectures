...
\title{The empirical recurrence for OEIS A278754, proved from an exact model}
...
\begin{abstract}
OEIS A278754 carries an empirical recurrence of order $6$. It is true, and it is
...
\[
1, 0, 110, 1, 11100, 11, 1111000, 111,\ \dots
\]
