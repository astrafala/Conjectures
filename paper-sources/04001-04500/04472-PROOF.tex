...
\title{The empirical recurrence for OEIS A210302, proved by transfer matrix}
...
\begin{abstract}
OEIS A210302 counts arrays of width $2$ whose every $2\times2$ subblock holds a
...
OEIS A210302 is ``Number of (n+1) X 2 0..3 arrays containing all values 0..3 with every 2 X 2 subblock having one or three distinct values, and new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
0, 29, 414, 4553, 45890, 446093, 4266246, 40490097,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 15*a(n-1) - 57*a(n-2) + 41*a(n-3) + 10*a(n-4) - 8*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 15 2018 06:53:38, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;15\,a(n-1) - 57\,a(n-2) + 41\,a(n-3) + 10\,a(n-4) - 8\,a(n-5)
\]
for every $n>5$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A210302.
