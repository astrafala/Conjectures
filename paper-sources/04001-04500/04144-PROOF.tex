...
\title{The empirical recurrence for OEIS A211527, proved by transfer matrix}
...
\begin{abstract}
OEIS A211527 carries an empirical recurrence of order $9$ contributed by R. H. Hardin. It is
...
OEIS A211527 is ``Number of -1..1 arrays x(i) of n+1 elements i=1..n+1 with set{t,u,v in 0,1}((x[i+t]+x[j+u]+x[k+v])*(-1)\^{}(t+u+v)) having two, three, four or five distinct values for every i,j,k<=n.''. It has offset $1$ and begins
\[
8, 18, 42, 90, 192, 394, 806, 1618,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 5*a(n-1) - 4*a(n-2) - 16*a(n-3) + 27*a(n-4) + 8*a(n-5) - 35*a(n-6) + 10*a(n-7) + 10*a(n-8) - 4*a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 18 2018 11:49:52, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A211527.
