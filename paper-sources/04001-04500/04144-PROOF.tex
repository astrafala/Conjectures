...
\title{The empirical recurrence for OEIS A223206, proved by transfer matrix}
...
\begin{abstract}
OEIS A223206 counts the ways of writing the vertices of a fixed graph $G$ into an array of width
$5$ so that any two cells adjacent in one of the named directions carry vertices joined by an
edge of $G$; here $G$ is dodecahedron graph. The entry carries an empirical recurrence of order $7$
...
single slice is a state and the count is a walk count on a finite digraph with $S=1621$ vertices.
\end{abstract}
...
OEIS A223206 is ``Rolling icosahedron face footprints: number of nX5 0..19 arrays starting with 0 where 0..19 label faces of an icosahedron and every array movement to a horizontal or vertical neighbor moves across an icosahedral edge.''. It has offset $1$ and begins
\[
81, 1875, 50553, 1412907, 39868737, 1127761923, 31921015497, 903661481115,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 31*a(n-1) -24*a(n-2) -1612*a(n-3) +3816*a(n-4) +1152*a(n-5) -2784*a(n-6) +256*a(n-7)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 21:21:01, revision 8) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=1621.
\]
...
of length $5$ over $20$ vertices is one of $20^{5}$ words, but only $S-1$ of them are
...
\begin{theorem}
\[
a(n)\;=\;31\,a(n-1) - 24\,a(n-2) - 1612\,a(n-3) + 3816\,a(n-4) + 1152\,a(n-5) - 2784\,a(n-6) + 256\,a(n-7)
\]
for every $n>7$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223206.
