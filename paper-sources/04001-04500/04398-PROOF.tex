...
\title{The empirical recurrence for OEIS A282003, proved from an exact model}
...
\begin{abstract}
OEIS A282003 carries an empirical recurrence of order $4$. It is true, and it is
...
\[
1, 1, 110, 111, 11000, 11111, 1100000, 1111111,\ \dots
\]
