...
\title{The empirical recurrence for OEIS A284404, proved from an exact model}
...
\begin{abstract}
OEIS A284404 carries an empirical recurrence of order $2$. It is true, and it is
...
OEIS A284404 is ``Binary representation of the x-axis, from the origin to the right edge, of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 913", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 0, 101, 111, 11111, 111111, 1111111, 11111111,\ \dots
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A284404.
