...
\title{The empirical recurrence for OEIS A280369, proved from an exact model}
...
\begin{abstract}
OEIS A280369 carries an empirical recurrence of order $4$. It is true, and it is
