...
\title{The empirical recurrence for OEIS A204224, proved by transfer matrix}
...
\begin{abstract}
OEIS A204224 counts arrays over $\{0,\dots,2\}$ under a condition on the sum of every
$2\times2$ subblock, and carries an empirical recurrence of order $79$ contributed by
...
OEIS A204224 is ``Number of (n+1)X3 0..2 arrays with the sums of 2X2 subblocks nondecreasing rightwards and downwards.''. It has offset $1$ and begins
\[
450, 4539, 44641, 312001, 2173565, 12097076, 67329896, 320850651,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 11:02:19, revision 9) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204224.
