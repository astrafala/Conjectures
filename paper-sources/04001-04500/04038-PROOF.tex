...
\title{The conjectured generating function for OEIS A259217, proved}
...
\begin{abstract}
OEIS A259217 counts arrays of a fixed width under a local condition, and carries a conjectured
...
OEIS A259217 is ``Number of (n+1) X (3+1) 0..1 arrays with each 2 X 2 subblock having clockwise pattern 0000 0011 or 0101.''. It has offset $1$ and begins
\[
24, 40, 66, 112, 192, 334,\ \dots
\]
The entry states, as a conjecture contributed by a reader and never marked settled:
\begin{quote}
G.f.: 2*x*(12 - 28*x + x\^{}2 + 16*x\^{}3) / ((1 - x)*(1 - 2*x)*(1 - x - x\^{}2)). - \_Colin Barker\_, Dec 24 2018
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 24 2026 09:41:45, revision 20) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A259217.
