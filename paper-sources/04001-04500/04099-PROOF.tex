...
\title{The empirical recurrence for OEIS A241323, proved by transfer matrix}
...
\begin{abstract}
OEIS A241323 counts $n\times2$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A241323 is ``Number of nX2 0..3 arrays with no element equal to fewer vertical neighbors than horizontal neighbors, with new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
1, 8, 85, 1030, 13011, 165924, 2121033, 27129985,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 17*a(n-1) -57*a(n-2) +43*a(n-3) -37*a(n-4) +109*a(n-5) -62*a(n-6) -48*a(n-8) +36*a(n-9) for n>10
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 11:12:01, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;17\,a(n-1) - 57\,a(n-2) + 43\,a(n-3) - 37\,a(n-4) + 109\,a(n-5) - 62\,a(n-6) - 48\,a(n-8) + 36\,a(n-9)
\]
for every $n>10$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A241323.
