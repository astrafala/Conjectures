...
\title{The empirical recurrence for OEIS A240638, proved by transfer matrix}
...
\begin{abstract}
OEIS A240638 carries an empirical recurrence of order $6$ contributed by R.~H.~Hardin. It is
...
OEIS A240638 is ``Number of n X 3 0..3 arrays with no element equal to one or three horizontal or vertical neighbors, with new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
2, 27, 462, 7993, 138882, 2413198, 41931738, 728606311,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 14*a(n-1) + 54*a(n-2) + 82*a(n-3) - 14*a(n-4) - 54*a(n-5) - 81*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 29 2018 05:02:39, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A240638.
