...
\title{The empirical recurrence for OEIS A262919, proved by transfer matrix}
...
\begin{abstract}
OEIS A262919 counts arrays of width $6$ over $\{0,1\}$ whose rows, read as base-$2$
numbers, are divisible by $7$ and whose columns, read the same way, are divisible by
$3$. The entry carries an empirical recurrence of order $10$ contributed by
...
OEIS A262919 is ``Number of (5+1)X(n+1) 0..1 arrays with each row divisible by 3 and each column divisible by 7, read as a binary number with top and left being the most significant bits.''. It has offset $1$ and begins
\[
10, 27, 318, 1411, 18190, 121507, 1444558, 12031011,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 04 2015 10:15:21, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;14\,a(n-1) + 39\,a(n-2) - 1106\,a(n-3) + 1561\,a(n-4) + 22386\,a(n-5) - 57539\,a(n-6) - 89894\,a(n-7) + 251940\,a(n-8) + 68600\,a(n-9) - 196000\,a(n-10)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A262919.
