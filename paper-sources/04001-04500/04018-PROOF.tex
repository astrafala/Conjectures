...
\title{The empirical recurrence for OEIS A202982, proved by transfer matrix}
...
\begin{abstract}
OEIS A202982 counts arrays of width $2$ over $\{0,1,2\}$ in which every nonzero cell has a neighbour at least as large as itself. The entry carries an
...
OEIS A202982 is ``Number of n X 2 0..2 arrays with every nonzero element less than or equal to some NW, E or S neighbor.''. It has offset $1$ and begins
\[
1, 9, 63, 323, 1629, 8534, 44885, 234728,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 9*a(n-1) -28*a(n-2) +60*a(n-3) -102*a(n-4) +84*a(n-5) -44*a(n-6) +25*a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 03 2018 08:01:33, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;9\,a(n-1) - 28\,a(n-2) + 60\,a(n-3) - 102\,a(n-4) + 84\,a(n-5) - 44\,a(n-6) + 25\,a(n-7)
\]
for every $n>6$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A202982.
