...
\title{The conjectured generating function for OEIS A278759, proved}
...
\begin{abstract}
OEIS A278759 counts arrays of a fixed width under a local condition, and carries a conjectured
