...
\title{The empirical recurrence for OEIS A223205, proved by transfer matrix}
...
\begin{abstract}
OEIS A223205 counts the ways of writing the vertices of a fixed graph $G$ into an array of width
...
single slice is a state and the count is a walk count on a finite digraph with $S=541$ vertices.
\end{abstract}
...
OEIS A223205 is ``Rolling icosahedron face footprints: number of n X 4 0..19 arrays starting with 0 where 0..19 label faces of an icosahedron and every array movement to a horizontal or vertical neighbor moves across an icosahedral edge.''. It has offset $1$ and begins
\[
27, 375, 5763, 90111, 1412907, 22163655, 347696019, 5454600015,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 19*a(n-1) - 54*a(n-2) + 32*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 17 2018 09:22:14, revision 8) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=541.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223205.
