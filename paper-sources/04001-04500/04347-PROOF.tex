...
\title{The empirical recurrence for OEIS A224131, proved by transfer matrix}
...
\begin{abstract}
OEIS A224131 counts arrays over $\{0,\dots,1\}$ whose rows, columns, diagonals or
...
OEIS A224131 is ``Number of n X 6 0..1 arrays with rows nondecreasing and antidiagonals unimodal.''. It has offset $1$ and begins
\[
7, 49, 269, 1279, 5648, 24095, 101412, 425246,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 7*a(n-1) - 14*a(n-2) + 9*a(n-3) + 4*a(n-5) + 16*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 27 2018 06:04:30, revision 9) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224131.
