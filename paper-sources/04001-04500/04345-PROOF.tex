...
\title{The empirical closed form for OEIS A188557, proved}
...
\begin{abstract}
OEIS A188557 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A188557 is ``Number of 6 X n binary arrays without the pattern 0 1 diagonally, vertically, antidiagonally or horizontally.''. It has offset $1$ and begins
\[
7, 13, 24, 44, 80, 144, 256, 448,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (1/720)*n\^{}6 - (1/80)*n\^{}5 + (17/144)*n\^{}4 - (3/16)*n\^{}3 + (497/360)*n\^{}2 + (17/10)*n + 4.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 28 2018 06:52:23, revision 11) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{n^{6}}{720} - \frac{n^{5}}{80} + \frac{17 n^{4}}{144} - \frac{3 n^{3}}{16} + \frac{497 n^{2}}{360} + \frac{17 n}{10} + 4.
\]
...
$n=9,\dots,15$ and agree at each. A monic recurrence of order $7$
determines $a(m)$ from $a(m-1),\dots,a(m-7)$, and for every $m\ge16$ both
$m>8$ and $m-7\ge9$ hold, so induction on $m$ gives $a(m)=f(m)$ for every
$m\ge9$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A188557.
