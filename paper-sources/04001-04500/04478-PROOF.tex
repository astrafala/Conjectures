...
\title{The conjectured generating function for OEIS A285650, proved}
...
\begin{abstract}
OEIS A285650 counts arrays of a fixed width under a local condition, and carries a conjectured
...
\begin{quote}
G.f.: (1 + x - x\^{}2 - 2*x\^{}3 - 16*x\^{}4 + 52*x\^{}5 + 16*x\^{}6 - 48*x\^{}7) / ((1 - x)*(1 + x)*(1 - 2*x)*(1 + 2*x)).
\end{quote}
