...
\title{The empirical recurrence for OEIS A269823, proved by transfer matrix}
...
\begin{abstract}
OEIS A269823 counts arrays of width $2$ over $\{0,1,\dots,4\}$ in which the number of adjacent PAIRS of
cells whose entries add up to $4$ is exactly one. The entry carries an empirical recurrence of
...
result is a walk count on $S=71$ states.
\end{abstract}
...
OEIS A269823 is ``Number of n X 2 0..4 arrays with some element plus some horizontally, diagonally, antidiagonally or vertically adjacent neighbor totaling four exactly once.''. It has offset $1$ and begins
\[
5, 216, 3096, 39784, 462680, 5145736, 55265336, 580002280,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 10*a(n-1) + 47*a(n-2) - 336*a(n-3) - 1416*a(n-4) - 864*a(n-5) - 144*a(n-6) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (May 03 2023 18:02:57, revision 10) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The array has $2$ cells across, with entries in $\{0,1,\dots,4\}$. An ADJACENT PAIR is a pair of cells
\[
\begin{array}{l}
$(i,j)\text{ and }(i,j{+}1)$ \\
$(i,j)\text{ and }(i{+}1,j)$ \\
...
each end. Writing $k$ for the number of adjacent pairs whose two entries add up to $4$, the
...
\begin{theorem}
\[
a(n)\;=\;10\,a(n-1) + 47\,a(n-2) - 336\,a(n-3) - 1416\,a(n-4) - 864\,a(n-5) - 144\,a(n-6)
\]
for every $n>7$.
\end{theorem}
...
adjacent pairs summing to $4$ by running over the array once for each kind of pair, and keep
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269823.
