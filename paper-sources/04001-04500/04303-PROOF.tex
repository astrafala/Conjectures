...
\title{The conjectured generating function for OEIS A283216, proved}
...
\begin{abstract}
OEIS A283216 counts arrays of a fixed width under a local condition, and carries a conjectured
...
\begin{quote}
G.f.: (1 + 2*x + 3*x\^{}3) / ((1 - x)*(1 + x)*(1 - 2*x)*(1 + 2*x)*(1 + x\^{}2)).
\end{quote}
