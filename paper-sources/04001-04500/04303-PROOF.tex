...
\title{The empirical recurrence for OEIS A208561, proved by counting patterns}
...
\begin{abstract}
OEIS A208561 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A208561 is ``Number of n X 2 0..2 arrays with new values 0..2 introduced in row major order and no element equal to more than one of its immediate leftward or upward or left-upward diagonal neighbors.''. It has offset $1$ and begins
\[
2, 10, 68, 464, 3168, 21632, 147712, 1008640,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 8*a(n-1) - 8*a(n-2) for n>3.
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 05 2018 07:21:53, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208561.
