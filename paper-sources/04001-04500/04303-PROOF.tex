...
\title{The empirical recurrence for OEIS A207771, proved by transfer matrix}
...
\begin{abstract}
OEIS A207771 counts arrays over $\{0,\dots,1\}$ of width $5$ that avoid the patterns
...
OEIS A207771 is ``Number of nX5 0..1 arrays avoiding 0 0 0 and 1 1 1 horizontally and 0 0 1 and 0 1 0 vertically.''. It has offset
$1$ and begins
\[
16, 256, 912, 3130, 11950, 43264, 157472,\ \dots
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207771.
