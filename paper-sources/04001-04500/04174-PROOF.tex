...
\title{The empirical closed form for OEIS A184544, proved}
...
\begin{abstract}
OEIS A184544 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
$S=2250$ vertices. Any function of the form $\sum_j p_j(n)\lambda_j^{\,n}$ satisfies the
...
OEIS A184544 is ``Number of (n+2) X 7 binary arrays with each 3 X 3 subblock having rows and columns in lexicographically nondecreasing order.''. It has offset $1$ and begins
\[
309, 792, 1627, 3024, 5313, 8989, 14767, 23648,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (1/5040)*n\^{}7 + (1/120)*n\^{}6 + (53/360)*n\^{}5 + (17/12)*n\^{}4 + (5767/720)*n\^{}3 + (3063/40)*n\^{}2 + (11959/70)*n + 52.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 13 2018 11:01:08, revision 11) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{n^{7}}{5040} + \frac{n^{6}}{120} + \frac{53 n^{5}}{360} + \frac{17 n^{4}}{12} + \frac{5767 n^{3}}{720} + \frac{3063 n^{2}}{40} + \frac{11959 n}{70} + 52.
\]
...
walk, so with $M$ the adjacency matrix of that digraph on $S=2250$ vertices, and $u,w$ the
...
$n=9,\dots,16$ and agree at each. A monic recurrence of order $8$
determines $a(m)$ from $a(m-1),\dots,a(m-8)$, and for every $m\ge17$ both
$m>8$ and $m-8\ge9$ hold, so induction on $m$ gives $a(m)=f(m)$ for every
$m\ge9$.
Below $n=9$ the recurrence argument gives nothing, since \eqref{eq:rec} is only
established for $a$ from $n=9$ on. The remaining indices $n=1,\dots,8$ were
...
First, the walk model reproduces every one of the $30$ terms the entry publishes,
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A184544.
