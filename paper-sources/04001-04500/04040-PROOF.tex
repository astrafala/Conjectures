...
\title{The conjectured generating function for OEIS A284404, proved}
...
\begin{abstract}
OEIS A284404 counts arrays of a fixed width under a local condition, and carries a conjectured
...
\[
1, 0, 101, 111, 11111, 111111,\ \dots
\]
The entry states, as a conjecture contributed by a reader and never marked settled:
\begin{quote}
G.f.: (1 - 11*x + 111*x\^{}2 - 1000*x\^{}3 + 10900*x\^{}4 - 10000*x\^{}5) / ((1 - x)*(1 - 10*x)).
\end{quote}
