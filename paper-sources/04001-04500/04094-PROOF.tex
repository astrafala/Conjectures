...
\title{The empirical recurrence for OEIS A231420, proved by transfer matrix}
...
\begin{abstract}
OEIS A231420 counts $2\times(n+1)$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A231420 is ``Number of (1+1) X (n+1) 0..2 arrays with no element equal to a strict majority of its horizontal, diagonal and antidiagonal neighbors, with values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
9, 71, 514, 3838, 28486, 212060, 1578180, 11748804,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 8*a(n-1) + 4*a(n-2) - 58*a(n-3) - 24*a(n-4) + 40*a(n-5) - 16*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 28 2018 15:19:28, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231420.
