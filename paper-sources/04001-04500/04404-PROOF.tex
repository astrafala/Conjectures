...
\title{The empirical recurrence for OEIS A282577, proved from an exact model}
...
\begin{abstract}
OEIS A282577 carries an empirical recurrence of order $4$. It is true, and it is
...
OEIS A282577 is ``Decimal representation of the x-axis, from the left edge to the origin, of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 553", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 0, 1, 0, 5, 0, 21, 0,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
(the empirical recurrence quoted in the entry)
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 05 2025 15:22:37, revision 21)
...
First, the model reproduces all $44$ terms the entry publishes, exactly, in integer
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A282577.
