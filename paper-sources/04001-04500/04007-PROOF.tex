...
\title{The empirical recurrence for OEIS A202796, proved by transfer matrix}
...
\begin{abstract}
OEIS A202796 counts arrays of width $2$ over $\{0,1\}$ in which every cell of a named value has a neighbour of that same value. The entry carries an
...
OEIS A202796 is ``Number of n X 2 binary arrays with every one adjacent to another one horizontally or vertically.''. It has offset $1$ and begins
\[
2, 10, 36, 126, 454, 1632, 5854, 21010,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) + a(n-2) + 4*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 20 2018 07:19:33, revision 13) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A202796.
