...
\title{The empirical recurrence for OEIS A279876, proved from an exact model}
...
\begin{abstract}
OEIS A279876 carries an empirical recurrence of order $6$. It is true, and it is
...
vanish from $n=14+1$ onwards, and the run exceeds $S+6$, which by
