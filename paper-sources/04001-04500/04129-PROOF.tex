...
\title{The empirical recurrence for OEIS A209892, proved by counting patterns}
...
\begin{abstract}
OEIS A209892 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A209892 is ``Number of (n+1)X4 0..2 arrays with every 2X2 subblock having two distinct values, and new values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
164, 2304, 32800, 470736, 6762544, 97195728, 1397061008, 20081495760,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 14*a(n-1) +31*a(n-2) -366*a(n-3) -210*a(n-4) +2564*a(n-5) +40*a(n-6) -4096*a(n-7) -96*a(n-8) +1152*a(n-9)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 15:34:04, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;14\,a(n-1) + 31\,a(n-2) - 366\,a(n-3) - 210\,a(n-4) + 2564\,a(n-5) + 40\,a(n-6) - 4096\,a(n-7) - 96\,a(n-8) + 1152\,a(n-9)
\end{equation}
for all $n>9$.
...
\[
3!\Bigl(a(n)-\sum_i c_i\,a(n-i)\Bigr)\;=\;\mathbf{v}^{\!\top}N^{\,m-9}q(N)\mathbf{1} .
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209892.
