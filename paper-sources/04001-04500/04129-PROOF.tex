...
\title{The empirical recurrence for OEIS A231414, proved by transfer matrix}
...
\begin{abstract}
OEIS A231414 counts $(n+1)\times3$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A231414 is ``Number of (n+1)X(2+1) 0..2 arrays with no element equal to a strict majority of its horizontal, diagonal and antidiagonal neighbors, with values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
71, 1032, 15125, 221445, 3245016, 47557773, 697029563, 10216062982,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 17*a(n-1) -28*a(n-2) -119*a(n-3) +373*a(n-4) +134*a(n-5) -268*a(n-6) -200*a(n-7)
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 06:28:13, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;17\,a(n-1) - 28\,a(n-2) - 119\,a(n-3) + 373\,a(n-4) + 134\,a(n-5) - 268\,a(n-6) - 200\,a(n-7)
\]
for every $n>7$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231414.
