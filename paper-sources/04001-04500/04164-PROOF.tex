...
\title{The conjectured generating function for OEIS A282914, proved}
...
\begin{abstract}
OEIS A282914 counts arrays of a fixed width under a local condition, and carries a conjectured
