...
\title{The empirical recurrence for OEIS A277560, proved from an exact model}
...
\begin{abstract}
OEIS A277560 carries an empirical recurrence of order $4$. It is true, and it is
...
\[
1, 11, 0, 1111, 0, 111111, 0, 11111111,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
(the empirical recurrence quoted in the entry)
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 05 2025 15:22:35, revision 46)
