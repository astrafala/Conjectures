...
\title{The empirical recurrence for OEIS A186120, proved by transfer matrix}
...
\begin{abstract}
OEIS A186120 counts arrays over $\{0,\dots,1\}$ under a condition comparing a statistic of
...
empirical. The count is a walk count on $S=26$ states and is $C$-finite; whether the
...
OEIS A186120 is ``Number of (n+1) X 2 binary arrays with every 2 X 2 subblock diagonal sum less antidiagonal sum equal to some horizontal or vertical neighbor 2 X 2 subblock diagonal sum less antidiagonal sum.''. It has offset $1$ and begins
\[
0, 14, 18, 50, 74, 182, 298, 678,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) - 6*a(n-3) + 6*a(n-4) - 4*a(n-5) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 17 2018 12:13:02, revision 12) this is still
...
$S=26$ states in all. Getting the two vectors right is the whole of the argument: with
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) - 6\,a(n-3) + 6\,a(n-4) - 4\,a(n-5)
\]
for every $n>6$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A186120.
