...
\begin{abstract}
OEIS A283508 carries an empirical recurrence of order $2$ contributed by R. J. Mathar. It is true, and it is
...
\begin{quote}
Equivalent conjecture: a(n) = A267623(n). - \_R. J. Mathar\_, Mar 17 2017
\end{quote}
