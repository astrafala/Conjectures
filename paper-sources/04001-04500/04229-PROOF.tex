...
\title{The conjectured generating function for OEIS A277799, proved}
...
\begin{abstract}
OEIS A277799 counts arrays of a fixed width under a local condition, and carries a conjectured
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 05 2025 15:22:35, revision 19) this is still
