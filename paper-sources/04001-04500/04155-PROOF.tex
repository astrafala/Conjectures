...
\title{The empirical recurrence for OEIS A268884, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A268884 counts arrays over $\{0,\dots,1\}$ subject to a condition on the array as a
...
OEIS A268884 is ``Number of nX6 binary arrays with some element plus some horizontally or antidiagonally adjacent neighbor totalling two exactly once.''. It has offset $1$ and begins
\[
20, 475, 9996, 186732, 3283890, 55491832, 911930096, 14681855846,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 15 2016 11:32:21, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;42\,a(n-1) - 665\,a(n-2) + 5138\,a(n-3) - 21972\,a(n-4) + 55274\,a(n-5) - 83769\,a(n-6) + 76202\,a(n-7) - 40273\,a(n-8) + 11304\,a(n-9) - 1296\,a(n-10)
\end{equation}
for all $n>12$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268884.
