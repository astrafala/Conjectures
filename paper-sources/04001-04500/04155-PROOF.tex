...
\title{The empirical recurrence for OEIS A210007, proved by transfer matrix}
...
\begin{abstract}
OEIS A210007 counts arrays of width $4$ whose every $2\times2$ subblock holds a
...
OEIS A210007 is ``Number of (n+1)X4 0..2 arrays containing all values 0..2 with every 2X2 subblock having two or three distinct values, and new values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
893, 70923, 5258039, 385841179, 28267925909, 2070471867089, 151644743405597, 11106638825609387,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 15:38:29, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;75\,a(n-1) - 30\,a(n-2) - 7001\,a(n-3) - 18089\,a(n-4) + 52126\,a(n-5) + 91400\,a(n-6) - 118464\,a(n-7) - 92992\,a(n-8) + 85632\,a(n-9) - 13824\,a(n-10)
\]
for every $n>10$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A210007.
