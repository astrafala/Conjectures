...
\title{The conjectured generating function for OEIS A286771, proved}
...
\begin{abstract}
OEIS A286771 counts arrays of a fixed width under a local condition, and carries a conjectured
...
OEIS A286771 is ``Binary representation of the diagonal from the origin to the corner of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 221", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 1, 0, 111, 10000, 11111,\ \dots
\]
The entry states, as a conjecture contributed by a reader and never marked settled:
\begin{quote}
G.f.: (1 + x - 101*x\^{}2 + 10*x\^{}3 + 10100*x\^{}4 - 10000*x\^{}6) / ((1 - x)*(1 + x)*(1 - 10*x)*(1 + 10*x)).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 05 2025 15:22:39, revision 15) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A286771.
