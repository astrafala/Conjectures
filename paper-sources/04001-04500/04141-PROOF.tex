...
\title{The conjectured generating function for OEIS A250764, proved}
...
\begin{abstract}
OEIS A250764 counts arrays of a fixed width under a local condition, and carries a conjectured
...
OEIS A250764 is ``Number of (n+1) X (3+1) 0..1 arrays with nondecreasing x(i,j)-x(i,j-1) in the i direction and nondecreasing absolute value of x(i,j)-x(i-1,j) in the j direction.''. It has offset $1$ and begins
\[
35, 62, 114, 216, 418, 820,\ \dots
\]
The entry states, as a conjecture contributed by a reader and never marked settled:
\begin{quote}
Empirical g.f.: x*(35 - 78*x + 41*x\^{}2) / ((1 - x)\^{}2*(1 - 2*x)). - \_Colin Barker\_, Nov 18 2018
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 18 2018 09:00:25, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250764.
