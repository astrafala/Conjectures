...
\title{The empirical column recurrences for the table OEIS A296739}
...
\begin{abstract}
OEIS A296739 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A296739 is ``T(n,k) = Number of n X k 0..1 arrays with each 1 adjacent to 1, 2 or 4 king-move neighboring 1's.''. It has offset $1$, is
read by antidiagonals, and begins
\[
1, 2, 2, 4, 11, 4, 7, 31,\ \dots
\]
...
k=4: [order 35].\\
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 04 2022 08:25:13, revision 6) these are still
...
The sequence is ``Number of n X 1 0..1 arrays with each 1 adjacent to 1, 2 or 4 king-move neighboring 1's.''. Its rows are the vertices of a digraph on
...
The sequence is ``Number of n X 2 0..1 arrays with each 1 adjacent to 1, 2 or 4 king-move neighboring 1's.''. Its rows are the vertices of a digraph on
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A296739.
