...
\title{The empirical recurrence for OEIS A269285, proved by transfer matrix}
...
\begin{abstract}
OEIS A269285 counts arrays of width $4$ over $\{0,1,2,3\}$ in which the number of adjacent PAIRS of
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 21 2019 06:27:57, revision 8) this is still
