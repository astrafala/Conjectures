...
\title{The empirical recurrence for OEIS A290661, proved from an exact model}
...
\begin{abstract}
OEIS A290661 carries an empirical recurrence of order $3$. It is true, and it is
...
\[
1, 11, 101, 1111, 10111, 111111, 1011111, 11111111,\ \dots
\]
