...
\title{The empirical recurrence for OEIS A284179, proved from an exact model}
...
\begin{abstract}
OEIS A284179 carries an empirical recurrence of order $5$. It is true, and it is
...
OEIS A284179 is ``Binary representation of the x-axis, from the left edge to the origin, of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 813", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 10, 101, 1010, 10111, 101111, 1010111, 10101011,\ \dots
\]
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 10000\,a(n-4) - 10000\,a(n-5)
\]
for every $n>14$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A284179.
