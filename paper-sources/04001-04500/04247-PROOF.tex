...
\title{The empirical recurrence for OEIS A282416, proved from an exact model}
...
\begin{abstract}
OEIS A282416 carries an empirical recurrence of order $6$. It is true, and it is
...
\[
1, 1, 110, 11, 11100, 111, 1111000, 1111,\ \dots
\]
