...
\title{The empirical recurrence for OEIS A284236, proved from an exact model}
...
\begin{abstract}
OEIS A284236 carries an empirical recurrence of order $3$. It is true, and it is
...
\[
1, 0, 110, 1010, 1010, 101010, 101010, 10101010,\ \dots
\]
