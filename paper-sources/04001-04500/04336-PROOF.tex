...
\title{The empirical recurrence for OEIS A250346, proved by transfer matrix}
...
\begin{abstract}
OEIS A250346 carries an empirical recurrence of order $6$ contributed by R. H. Hardin. It is
...
OEIS A250346 is ``Number of length n arrays x(i), i=1..n with x(i) in i..i+3 and no value appearing more than 2 times.''. It has offset $1$ and begins
\[
4, 16, 62, 235, 888, 3349, 12620, 47545,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) - 2*a(n-3) - 5*a(n-4) + a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 12 2018 15:40:07, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) - 2\,a(n-3) - 5\,a(n-4) + a(n-6)
\]
for every $n>0$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250346.
