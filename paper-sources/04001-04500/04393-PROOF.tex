...
\title{The empirical recurrence for OEIS A198405, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A198405 counts arrays in which every cell is constrained by its neighbours on \emph{both}
...
OEIS A198405 is ``Number of 2n X 2 0..4 arrays with values 0..4 introduced in row major order and each element equal to exactly one horizontal and vertical neighbor.''. It has offset $1$ and begins
\[
2, 17, 377, 11473, 375273, 12456897, 414711897, 13814539697,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 51*a(n-1) - 691*a(n-2) + 3601*a(n-3) - 7056*a(n-4) + 4096*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 02 2018 06:27:10, revision 9) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A198405.
