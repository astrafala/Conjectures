...
\title{The empirical recurrence for OEIS A279875, proved from an exact model}
...
\begin{abstract}
OEIS A279875 carries an empirical recurrence of order $6$. It is true, and it is
...
OEIS A279875 is ``Decimal representation of the x-axis, from the left edge to the origin, of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 211", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 1, 5, 7, 16, 23, 84, 125,\ \dots
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A279875.
