...
\title{The empirical recurrence for OEIS A290415, proved from an exact model}
...
\begin{abstract}
OEIS A290415 carries an empirical recurrence of order $5$. It is true, and it is
...
OEIS A290415 is ``Decimal representation of the diagonal from the origin to the corner of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 785", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 1, 5, 7, 19, 63, 7, 255,\ \dots
\]
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 6\,a(n-2) - 6\,a(n-3) - 8\,a(n-4) + 8\,a(n-5)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A290415.
