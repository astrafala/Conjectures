...
\title{The empirical recurrence for OEIS A233084, proved by transfer matrix}
...
\begin{abstract}
OEIS A233084 counts arrays over $\{0,\dots,3\}$ under a neighbour condition together with
...
OEIS A233084 is ``Number of 3 X n 0..3 arrays with no element x(i,j) adjacent to value 3-x(i,j) horizontally or antidiagonally, top left element zero, and 1 appearing before 2 in row major order.''. It has offset $1$ and begins
\[
10, 122, 1985, 32414, 529862, 8662343, 141615905, 2315203034,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 19*a(n-1) - 45*a(n-2) + 27*a(n-3) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 07 2018 08:36:22, revision 8) the statement is
...
x_{t+d_1,\,u+d_2}\ne 3-x_{t,u}\qquad\text{for every offset }(d_1,d_2)\in\mathcal N=\{(1,0),\ (1,-1)\}
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A233084.
