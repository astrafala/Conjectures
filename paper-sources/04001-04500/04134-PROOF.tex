...
\title{The empirical recurrence for OEIS A278665, proved from an exact model}
...
\begin{abstract}
OEIS A278665 carries an empirical recurrence of order $5$. It is true, and it is
...
OEIS A278665 is ``Binary representation of the x-axis, from the origin to the right edge, of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 62", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 11, 11, 11, 11, 10011, 110011, 100011,\ \dots
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A278665.
