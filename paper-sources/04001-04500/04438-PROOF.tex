...
\title{The empirical recurrence for OEIS A284352, proved from an exact model}
...
\begin{abstract}
OEIS A284352 carries an empirical recurrence of order $3$. It is true, and it is
...
\[
1, 10, 111, 1011, 11111, 101111, 1111111, 10111111,\ \dots
\]
