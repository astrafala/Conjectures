...
\title{The empirical recurrence for OEIS A185562, proved by transfer matrix}
...
\begin{abstract}
OEIS A185562 counts arrays of width $4$ over $\{0,1,2,3\}$ in which no cell equals both the cell above it and the cell to its left. The entry carries an
...
OEIS A185562 is ``1/4 the number of n X 4 0..3 arrays with no element equal both to the element above and to the element to its left.''. It has offset $1$ and begins
\[
64, 13500, 2842560, 598507920, 126017211780, 26533211918040, 5586628402633500, 1176277376648694960,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 217*a(n-1) - 1371*a(n-2) + 2835*a(n-3) - 2025*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 06 2026 09:33:33, revision 11) this is still
...
\begin{theorem}
\[
a(n)\;=\;217\,a(n-1) - 1371\,a(n-2) + 2835\,a(n-3) - 2025\,a(n-4)
\]
for every $n>4$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A185562.
