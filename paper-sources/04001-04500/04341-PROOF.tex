...
\title{The empirical column recurrences for the table OEIS A252369}
...
\begin{abstract}
OEIS A252369 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A252369 is ``T(n,k)=Number of (n+2)X(k+2) 0..3 arrays with every 3X3 subblock row, column, diagonal and antidiagonal sum not equal to 1 3 4 6 or 7.''. It has offset $1$, is
read by antidiagonals, and begins
\[
130, 152, 152, 282, 276, 282, 658, 834,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:09:07, revision 6) these are still
...
The sequence is ``Number of (n+2)X(3) 0..3 arrays with every 3X3 subblock row, column, diagonal and antidiagonal sum not equal to 1 3 4 6 or 7.''. Its rows are the vertices of a digraph on
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252369.
