...
\title{The conjectured generating function for OEIS A287191, proved}
...
\begin{abstract}
OEIS A287191 counts arrays of a fixed width under a local condition, and carries a conjectured
