...
\title{The empirical recurrence for OEIS A230904, proved by transfer matrix}
...
\begin{abstract}
OEIS A230904 counts arrays of width $2$ over $\{0,1,2,3\}$ in which every cell must see, among its
...
OEIS A230904 is ``Number of n X 2 0..3 arrays x(i,j) with each element horizontally, vertically or antidiagonally next to at least one element with value (x(i,j)+1) mod 4, no adjacent elements equal, and upper left element zero.''. It has offset $1$ and begins
\[
0, 2, 8, 26, 84, 272, 882, 2862,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 5*a(n-1) -6*a(n-2) +a(n-3) for n>4.
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 24 2018 02:47:33, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A230904.
