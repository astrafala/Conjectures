...
\title{The empirical recurrence for OEIS A268887, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A268887 counts arrays over $\{0,\dots,1\}$ subject to a condition on the array as a
...
OEIS A268887 is ``Number of 2 X n binary arrays with some element plus some horizontally or antidiagonally adjacent neighbor totalling two exactly once.''. It has offset $1$ and begins
\[
0, 5, 14, 54, 158, 475, 1340, 3740,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) + 5*a(n-2) - 4*a(n-3) - 11*a(n-4) - 6*a(n-5) - a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 15 2019 17:31:47, revision 7) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268887.
