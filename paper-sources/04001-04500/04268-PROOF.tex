...
\title{The empirical recurrence for OEIS A282482, proved from an exact model}
...
\begin{abstract}
OEIS A282482 carries an empirical recurrence of order $6$. It is true, and it is
...
\[
1, 11, 110, 1111, 11000, 111110, 1100011, 11111110,\ \dots
\]
