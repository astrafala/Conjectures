...
\title{The empirical column recurrences for the table OEIS A235981}
...
\begin{abstract}
OEIS A235981 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A235981 is ``T(n,k)=Number of (n+1)X(k+1) 0..2 arrays with the upper median equal to the lower median in every 2X2 subblock.''. It has offset $1$, is
read by antidiagonals, and begins
\[
39, 181, 181, 815, 1473, 815, 3741, 11239,\ \dots
\]
The entry carries the following block:
\begin{quote}\small
Empirical for column k:\\
k=1: a(n) = 4*a(n-1) +7*a(n-2) -22*a(n-3) +8*a(n-4)\\
k=2: [order 9]\\
k=3: [order 22]\\
k=4: [order 61]\\
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 08:59:26, revision 6) these are still
...
The sequence is ``Number of (n+1)X(2) 0..2 arrays with the upper median equal to the lower median in every 2X2 subblock.''. Its rows are the vertices of a digraph on
...
\[
a(n)\;=\;4\,a(n-1) + 7\,a(n-2) - 22\,a(n-3) + 8\,a(n-4)
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A235981.
