...
\title{The empirical recurrence for OEIS A286521, proved from an exact model}
...
\begin{abstract}
OEIS A286521 carries an empirical recurrence of order $2$. It is true, and it is
...
\[
1, 3, 5, 15, 31, 63, 127, 255,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
(the empirical recurrence quoted in the entry)
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 05 2025 15:22:38, revision 17)
