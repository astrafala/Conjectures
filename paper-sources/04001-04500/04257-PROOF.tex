...
\title{The conjectured generating function for OEIS A283508, proved}
...
\begin{abstract}
OEIS A283508 counts arrays of a fixed width under a local condition, and carries a conjectured
...
\[
1, 10, 101, 1011, 10111, 101111,\ \dots
\]
...
\]
and there are $S=4$ states. The digraph is built by reading the entry's own English, and the
