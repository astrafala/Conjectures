...
\title{The empirical recurrence for OEIS A281215, proved from an exact model}
...
\begin{abstract}
OEIS A281215 carries an empirical recurrence of order $6$. It is true, and it is
...
\[
1, 11, 1, 111, 10001, 110111, 10001, 1110111,\ \dots
\]
