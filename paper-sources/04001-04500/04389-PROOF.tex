...
\title{The empirical recurrence for OEIS A287199, proved from an exact model}
...
\begin{abstract}
OEIS A287199 carries an empirical recurrence of order $4$. It is true, and it is
