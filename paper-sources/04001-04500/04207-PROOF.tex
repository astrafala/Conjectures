...
\title{The empirical recurrence for OEIS A222940, proved by transfer matrix}
...
\begin{abstract}
OEIS A222940 counts arrays in which no entry may equal the entries at a short list of fixed offsets
...
$2$ consecutive rows, $S=644$ states in all.
\end{abstract}
...
OEIS A222940 is ``Number of n X 2 0..4 arrays with no element equal to another at a city block distance of exactly two, and new values 0..4 introduced in row major order.''. It has offset $1$ and begins
\[
2, 7, 33, 273, 2433, 21873, 196833, 1771473,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 10*a(n-1) - 9*a(n-2) for n>4.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 16 2018 15:13:14, revision 7) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=644.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A222940.
