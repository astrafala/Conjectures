...
\title{The empirical recurrence for OEIS A283650, proved from an exact model}
...
\begin{abstract}
OEIS A283650 carries an empirical recurrence of order $3$. It is true, and it is
...
OEIS A283650 is ``Decimal representation of the x-axis, from the left edge to the origin, of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 705", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 0, 7, 13, 28, 61, 124, 253,\ \dots
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A283650.
