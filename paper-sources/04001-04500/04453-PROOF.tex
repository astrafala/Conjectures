...
\title{The empirical recurrence for OEIS A210079, proved by transfer matrix}
...
\begin{abstract}
OEIS A210079 counts arrays of width $2$ whose every $2\times2$ subblock holds a
...
OEIS A210079 is ``Number of (n+1) X 2 0..3 arrays containing all values 0..3 with every 2 X 2 subblock having one, three or four distinct values, and new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
1, 51, 762, 9405, 109194, 1239185, 13937206, 156188077,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 17*a(n-1) - 71*a(n-2) + 67*a(n-3) - 8*a(n-4) - 4*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 14 2018 05:56:14, revision 12) this is still
...
\begin{theorem}
\[
a(n)\;=\;17\,a(n-1) - 71\,a(n-2) + 67\,a(n-3) - 8\,a(n-4) - 4\,a(n-5)
\]
for every $n>5$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A210079.
