...
\title{The empirical recurrence for OEIS A284480, proved from an exact model}
...
\begin{abstract}
OEIS A284480 carries an empirical recurrence of order $5$. It is true, and it is
...
\[
1, 11, 101, 1111, 11101, 111111, 1111101, 11110111,\ \dots
\]
