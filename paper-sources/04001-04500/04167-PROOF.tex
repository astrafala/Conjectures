...
\title{The empirical recurrence for OEIS A281214, proved from an exact model}
...
\begin{abstract}
OEIS A281214 carries an empirical recurrence of order $6$. It is true, and it is
...
OEIS A281214 is ``Binary representation of the x-axis, from the left edge to the origin, of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 342", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 11, 100, 1110, 10001, 111011, 1000100, 11101110,\ \dots
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A281214.
