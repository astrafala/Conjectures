...
\title{The empirical recurrence for OEIS A217949, proved by transfer matrix}
...
\begin{abstract}
OEIS A217949 carries an empirical recurrence of order $10$ contributed by R. H. Hardin. It is
...
OEIS A217949 is ``Number of n-element 0..3 arrays with each element the minimum of 3 adjacent elements of a random 0..3 array of n+2 elements.''. It has offset $1$ and begins
\[
4, 16, 50, 130, 310, 736, 1821, 4673,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) -6*a(n-2) +4*a(n-3) +5*a(n-4) -4*a(n-5) +6*a(n-6) +4*a(n-7) +2*a(n-9) +a(n-10).
\end{quote}
As of the ``Last modified'' line on the live entry (May 17 2014 12:42:20, revision 11) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A217949.
