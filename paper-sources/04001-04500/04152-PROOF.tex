...
\title{The empirical recurrence for OEIS A268907, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A268907 counts arrays over $\{0,\dots,2\}$ subject to a condition on the array as a
...
OEIS A268907 is ``Number of 4Xn 0..2 arrays with some element plus some horizontally or antidiagonally adjacent neighbor totalling two exactly once.''. It has offset $1$ and begins
\[
0, 1344, 12960, 118584, 1004184, 8250912, 66210264, 522241560,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 18*a(n-1) -111*a(n-2) +282*a(n-3) -333*a(n-4) +180*a(n-5) -36*a(n-6) for n>12
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 15 2016 15:02:12, revision 4) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268907.
