...
\title{The empirical recurrence for OEIS A284481, proved from an exact model}
...
\begin{abstract}
OEIS A284481 carries an empirical recurrence of order $5$. It is true, and it is
