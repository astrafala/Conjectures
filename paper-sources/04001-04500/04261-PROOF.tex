...
\title{The empirical recurrence for OEIS A211526, proved by transfer matrix}
...
\begin{abstract}
OEIS A211526 carries an empirical recurrence of order $4$ contributed by R. H. Hardin. It is
...
OEIS A211526 is ``Number of -1..1 arrays x(i) of n+1 elements i=1..n+1 with set{t,u,v in 0,1}((x[i+t]+x[j+u]+x[k+v])*(-1)\^{}(t+u+v)) having two, four or five distinct values for every i,j,k<=n.''. It has offset $1$ and begins
\[
8, 18, 32, 60, 104, 192, 344, 648,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) - 6*a(n-3) + 4*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 18 2018 10:08:31, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A211526.
