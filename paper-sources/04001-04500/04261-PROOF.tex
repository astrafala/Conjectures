...
\title{The empirical recurrence for OEIS A278667, proved from an exact model}
...
\begin{abstract}
OEIS A278667 carries an empirical recurrence of order $5$. It is true, and it is
...
vanish from $n=10+1$ onwards, and the run exceeds $S+5$, which by
