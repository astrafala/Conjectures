...
\title{The conjectured generating function for OEIS A287199, proved}
...
\begin{abstract}
OEIS A287199 counts arrays of a fixed width under a local condition, and carries a conjectured
...
OEIS A287199 is ``Decimal representation of the diagonal from the origin to the corner of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 259", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 3, 4, 3, 16, 15,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 05 2025 15:22:39, revision 14) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A287199.
