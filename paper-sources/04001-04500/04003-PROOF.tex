...
\title{The empirical recurrence for OEIS A233254, proved by transfer matrix}
...
\begin{abstract}
OEIS A233254 counts arrays over $\{0,\dots,5\}$ in which no two entries that are neighbours in
...
\begin{theorem}
\[
a(n)\;=\;1664\,a(n-1) - 471040\,a(n-2) + 44826624\,a(n-3) - 1358954496\,a(n-4)
\]
for every $n>4$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A233254.
