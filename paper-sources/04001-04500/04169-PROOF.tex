...
\title{The empirical recurrence for OEIS A281216, proved from an exact model}
...
\begin{abstract}
OEIS A281216 carries an empirical recurrence of order $6$. It is true, and it is
