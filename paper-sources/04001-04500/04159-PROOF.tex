...
\title{The empirical recurrence for OEIS A203391, proved by transfer matrix}
...
\begin{abstract}
OEIS A203391 counts arrays of width $2$ over $\{0,1,2,3\}$ in which every nonzero cell has a neighbour at least as large as itself. The entry carries an
...
OEIS A203391 is ``Number of nX2 0..3 arrays with every nonzero element less than or equal to some NW, E or S neighbor.''. It has offset $1$ and begins
\[
1, 16, 185, 1455, 10804, 83876, 661595, 5187181,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 10:25:49, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;16\,a(n-1) - 100\,a(n-2) + 400\,a(n-3) - 1164\,a(n-4) + 2172\,a(n-5) - 2624\,a(n-6) + 2393\,a(n-7) - 1552\,a(n-8) + 736\,a(n-9) - 324\,a(n-10)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A203391.
