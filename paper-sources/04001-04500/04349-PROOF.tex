...
\title{The empirical recurrence for OEIS A214099, proved by transfer matrix}
...
\begin{abstract}
OEIS A214099 counts the proper colourings of a grid $n\times7$, wrapped in the direction of width $7$, with at most $3$ colours and
...
down to $S=126$ and makes the exact residual test affordable.
\end{abstract}
...
OEIS A214099 is ``Number of 0..2 colorings on an n X 7 array circular in the 7 direction with new values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
21, 322, 5068, 79968, 1262128, 19920544, 314412672, 4962482560,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 18*a(n-1) - 36*a(n-2) + 16*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 22 2018 06:42:22, revision 8) this is still
...
\]
There are $(i-1)^{7}+(-1)^{7}(i-1)$ such colourings, which at $i=3$ is already more
...
state count is $S=126$ rather than the number of colourings.
...
\begin{theorem}
\[
a(n)\;=\;18\,a(n-1) - 36\,a(n-2) + 16\,a(n-3)
\]
for every $n>3$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A214099.
