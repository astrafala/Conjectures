...
\title{The empirical recurrence for OEIS A268165, proved by transfer matrix}
...
\begin{abstract}
OEIS A268165 counts arrays in which the REPEATED VALUES of each row, and of each column, stand in a
...
OEIS A268165 is ``Number of n X 2 0..3 arrays with every repeated value in every row and column one larger mod 4 than the previous repeated value, and upper left element zero.''. It has offset $1$ and begins
\[
4, 64, 900, 12100, 155236, 1932100, 23444964, 278956804,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 23*a(n-1) - 106*a(n-2) - 724*a(n-3) + 4128*a(n-4) + 9216*a(n-5) - 20736*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 11 2019 10:44:22, revision 8) this is still
...
one larger modulo 4 than the previous repeated value of that row, and that each repeated value of a column,
read downwards, be one larger modulo 4 than the previous repeated value of that column. The FIRST repeated
...
\begin{theorem}
\[
a(n)\;=\;23\,a(n-1) - 106\,a(n-2) - 724\,a(n-3) + 4128\,a(n-4) + 9216\,a(n-5) - 20736\,a(n-6)
\]
for every $n>6$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268165.
