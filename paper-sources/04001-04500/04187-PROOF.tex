...
\title{The empirical recurrence for OEIS A278755, proved from an exact model}
...
\begin{abstract}
OEIS A278755 carries an empirical recurrence of order $6$. It is true, and it is
...
OEIS A278755 is ``Decimal representation of the x-axis, from the left edge to the origin, of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 65", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 0, 3, 8, 7, 48, 15, 224,\ \dots
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A278755.
