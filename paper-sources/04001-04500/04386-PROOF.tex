...
\begin{abstract}
OEIS A284353 carries an empirical recurrence of order $3$ contributed by {k=0..n-1} C(n,k) * (2-(-1)\^{}k). -. It is true, and it is
...
\begin{quote}
Conjecture: For n > 0, a(n) = Sum\_{k=0..n-1} C(n,k) * (2-(-1)\^{}k). - \_Wesley Ivan Hurt\_, Sep 23 2017
\end{quote}
