...
\title{The conjectured generating function for OEIS A279118, proved}
...
\begin{abstract}
OEIS A279118 counts arrays of a fixed width under a local condition, and carries a conjectured
...
\[
1, 0, 111, 0, 11111, 0,\ \dots
\]
The entry states, as a conjecture contributed by a reader and never marked settled:
\begin{quote}
G.f.: (10*x\^{}2 + 1)/(100*x\^{}4 - 101*x\^{}2 + 1). (End)
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 05 2025 15:22:35, revision 35) this is still
