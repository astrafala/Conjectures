...
\title{The empirical recurrence for OEIS A197436, proved by transfer matrix}
...
\begin{abstract}
OEIS A197436 counts arrays of width $2$ over $\{0,1,2\}$ in which no cell is the average of its neighbours. The entry carries an
...
OEIS A197436 is ``Number of nX2 0..2 arrays with no element equal to the average of its horizontal and vertical neighbors.''. It has offset $1$ and begins
\[
6, 34, 246, 1736, 12450, 89528, 644328, 4638654,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 07:13:05, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-1) + 6\,a(n-2) - 25\,a(n-3) - 57\,a(n-4) - 7\,a(n-5) + 78\,a(n-6) + 71\,a(n-7) + 6\,a(n-8) - 18\,a(n-9) - 10\,a(n-10) - 8\,a(n-11)
\]
for every $n>11$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A197436.
