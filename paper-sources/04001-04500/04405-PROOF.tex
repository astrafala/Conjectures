...
\title{The empirical recurrence for OEIS A282579, proved from an exact model}
...
\begin{abstract}
OEIS A282579 carries an empirical recurrence of order $4$. It is true, and it is
...
\[
1, 0, 4, 0, 20, 0, 84, 0,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
(the empirical recurrence quoted in the entry)
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 05 2025 15:22:37, revision 24)
