...
\title{The empirical recurrence for OEIS A278756, proved from an exact model}
...
\begin{abstract}
OEIS A278756 carries an empirical recurrence of order $6$. It is true, and it is
...
\[
1, 0, 6, 1, 28, 3, 120, 7,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
(the empirical recurrence quoted in the entry)
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 10 2026 11:41:28, revision 17)
