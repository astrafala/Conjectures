...
\title{The empirical recurrence for OEIS A200572, proved by transfer matrix}
...
\begin{abstract}
OEIS A200572 counts arrays of width $1$ over $\{0,1,2\}$ in which no cell averages to a given value with its neighbours. The entry carries an
...
OEIS A200572 is ``Number of n X 1 0..2 arrays with no average of any element and its horizontal and vertical neighbors equal to one.''. It has offset $1$ and begins
\[
2, 6, 10, 22, 52, 114, 260, 600,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + a(n-2) + a(n-3) - 3*a(n-4) - 2*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 02 2018 14:13:54, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + a(n-2) + a(n-3) - 3\,a(n-4) - 2\,a(n-5)
\]
for every $n>4$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A200572.
