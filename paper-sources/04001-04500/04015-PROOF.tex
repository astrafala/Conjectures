...
\title{The empirical recurrence for OEIS A275232, proved by transfer matrix}
...
\begin{abstract}
OEIS A275232 counts arrays in which no entry may equal the entries at a short list of fixed offsets
...
$1$ consecutive columns, $S=197$ states in all.
\end{abstract}
...
OEIS A275232 is ``Number of 7Xn 0..2 arrays with no element equal to any value at offset (-2,-1) (-2,1) or (-1,0) and new values introduced in order 0..2.''. It has offset $1$ and begins
\[
32, 404, 8134, 164645, 3334854, 67550874, 1368326231, 27717164160,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 20 2016 18:31:40, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;20\,a(n-1) + 57\,a(n-2) - 1206\,a(n-3) + 3096\,a(n-4) + 2306\,a(n-5) - 16957\,a(n-6) + 20440\,a(n-7) - 7755\,a(n-8)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A275232.
