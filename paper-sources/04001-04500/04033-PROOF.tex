...
\title{The empirical recurrence for OEIS A224009, proved by transfer matrix}
...
\begin{abstract}
OEIS A224009 counts arrays over $\{0,\dots,2\}$ whose rows, columns, diagonals or
...
OEIS A224009 is ``Number of n X 5 0..2 arrays with rows nondecreasing and antidiagonals unimodal.''. It has offset $1$ and begins
\[
21, 441, 6815, 90051, 1108969, 13275381, 157347899, 1859567103,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 18 2025 04:52:39, revision 10) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224009.
