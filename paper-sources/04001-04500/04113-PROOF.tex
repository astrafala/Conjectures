...
\title{The conjectured generating function for OEIS A282915, proved}
...
\begin{abstract}
OEIS A282915 counts arrays of a fixed width under a local condition, and carries a conjectured
...
\begin{quote}
G.f.: (1 - 9890*x\^{}4 + x\^{}5 + 10989*x\^{}6 - 1000*x\^{}10) / ((1 - x)*(1 + x)*(1 - 10*x)*(1 + 10*x)*(1 + 100*x\^{}2)).
\end{quote}
