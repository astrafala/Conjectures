...
\title{The conjectured generating function for OEIS A290233, proved}
...
\begin{abstract}
OEIS A290233 counts arrays of a fixed width under a local condition, and carries a conjectured
...
\begin{proof}
Write the conjecture as $N_2/D_2$ with $\deg N_2=3$ and $\deg D_2=5$; its expansion as a
