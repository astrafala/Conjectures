...
\title{The empirical closed form for OEIS A224015, proved}
...
\begin{abstract}
OEIS A224015 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A224015 is ``Number of 5 X n 0..2 arrays with rows nondecreasing and antidiagonals unimodal.''. It has offset $1$ and begins
\[
243, 7776, 62764, 297859, 1108969, 3516324, 9866389, 25128396,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 23:10:25, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{1009 n^{10}}{907200} + \frac{913 n^{9}}{36288} + \frac{20887 n^{8}}{60480} + \frac{92987 n^{7}}{30240} + \frac{835267 n^{6}}{43200} + \frac{125341 n^{5}}{1728} + \frac{33910279 n^{4}}{181440} + \frac{8169817 n^{3}}{45360} + \frac{2581069 n^{2}}{25200} + \frac{35674 n}{63} + 336.
\]
...
$n=15,\dots,25$ and agree at each. A monic recurrence of order $11$
determines $a(m)$ from $a(m-1),\dots,a(m-11)$, and for every $m\ge26$ both
$m>14$ and $m-11\ge15$ hold, so induction on $m$ gives $a(m)=f(m)$ for every
$m\ge15$.
Below $n=15$ the recurrence argument gives nothing, since \eqref{eq:rec} is only
established for $a$ from $n=15$ on. The remaining indices $n=4,\dots,14$ were
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224015.
