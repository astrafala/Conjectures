...
\title{The empirical recurrence for OEIS A211569, proved by transfer matrix}
...
\begin{abstract}
OEIS A211569 carries an empirical recurrence of order $8$ contributed by R. H. Hardin. It is
...
OEIS A211569 is ``Number of -2..2 arrays x(i) of n+1 elements i=1..n+1 with set{t,u,v in 0,1}((x[i+t]+x[j+u]+x[k+v])*(-1)\^{}(t+u+v)) having two, four or five distinct values for every i,j,k<=n.''. It has offset $1$ and begins
\[
24, 52, 94, 174, 304, 552, 980, 1802,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) + a(n-2) - 21*a(n-3) + 16*a(n-4) + 29*a(n-5) - 34*a(n-6) - 6*a(n-7) + 12*a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 19 2018 08:23:01, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A211569.
