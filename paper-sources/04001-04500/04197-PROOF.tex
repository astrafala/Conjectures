...
\title{The empirical recurrence for OEIS A285613, proved from an exact model}
...
\begin{abstract}
OEIS A285613 carries an empirical recurrence of order $3$. It is true, and it is
...
OEIS A285613 is ``Binary representation of the diagonal from the origin to the corner of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 62", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 10, 10, 100, 1100, 11000, 111000, 1110000,\ \dots
\]
...
\begin{theorem}
\[
a(n)\;=\;10\,a(n-1) + 10\,a(n-2) - 100\,a(n-3)
\]
for every $n>4$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A285613.
