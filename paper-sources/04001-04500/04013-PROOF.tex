...
\title{The empirical closed form for OEIS A223950, proved}
...
\begin{abstract}
OEIS A223950 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A223950 is ``Number of 3 X n 0..1 arrays with diagonals and antidiagonals unimodal and rows nondecreasing.''. It has offset $1$ and begins
\[
8, 27, 54, 96, 157, 241, 352, 494,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (2/3)*n\^{}3 + (3/2)*n\^{}2 + (41/6)*n + 2 for n>1.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 24 2018 08:52:33, revision 7) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{2 n^{3}}{3} + \frac{3 n^{2}}{2} + \frac{41 n}{6} + 2.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223950.
