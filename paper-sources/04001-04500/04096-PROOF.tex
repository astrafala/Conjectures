...
\title{The empirical closed form for OEIS A203873, proved}
...
\begin{abstract}
OEIS A203873 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
$\prod_j(x-\lambda_j)^{\deg p_j+1}$; here that polynomial is $q(x)=(x-49)(x-1)$, of degree
...
OEIS A203873 is ``Number of (n+1)X4 0..3 arrays with no 2X2 subblock having equal diagonal elements or equal antidiagonal elements, and new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
487, 23815, 1166887, 57177415, 2801693287, 137282971015, 6726865579687, 329616413404615,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 486*49\^{}(n-1) +1
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 10:47:58, revision 9) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;486 \cdot 49^{n - 1} + 1.
\]
...
Here $q(x)=(x-49)(x-1)$, of degree $2$, and the recurrence it encodes is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A203873.
