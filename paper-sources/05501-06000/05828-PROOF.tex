...
\title{The empirical recurrence for OEIS A264381, proved by transfer matrix}
...
\begin{abstract}
OEIS A264381 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=4$ columns in which
...
OEIS A264381 is ``Number of (3+1)X(n+1) arrays of permutations of 0..n*4+3 with each element having directed index change 2,-2 -1,0 -1,2 1,0 or 0,-1.''. It has offset $1$ and begins
\[
1, 13, 80, 385, 2345, 14329, 88264, 538417,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical recurrence of order 70 (see link above)

Empirical: a(n) = 4*a(n-1) + 15*a(n-2) - 23*a(n-3) + 85*a(n-4) - 80*a(n-5) - 523*a(n-6) + 650*a(n-7) - 2928*a(n-8) + 11648*a(n-9) - 292*a(n-10) - 8950*a(n-11) + 73749*a(n-12) - 95388*a(n-13) + 32227*a(n-14) + 174765*a(n-15) - 498904*a(n-16) + 523562*a(n-17) - 157912*a(n-18) - 1768335*a(n-19) + 1015821*a(n-20) - 1986588*a(n-21) + 621687*a(n-22) + 7372680*a(n-23) - 1364061*a(n-24) + 7605392*a(n-25) + 1358167*a(n-26) - 17006655*a(n-27) + 1492898*a(n-28) - 19207328*a(n-29) - 12488088*a(n-30) + 24654701*a(n-31) + 4156975*a(n-32) + 22863202*a(n-33) + 26735865*a(n-34) - 25269514*a(n-35) - 23459191*a(n-36) - 8218390*a(n-37) - 22659261*a(n-38) + 13714845*a(n-39) + 34457684*a(n-40) - 1653848*a(n-41) + 5581470*a(n-42) - 1826631*a(n-43) - 18750261*a(n-44) + 456888*a(n-45) - 266629*a(n-46) + 375672*a(n-47) + 5303623*a(n-48) + 489028*a(n-49) + 454377*a(n-50) - 57791*a(n-51) - 569236*a(n-52) + 64026*a(n-53) - 88324*a(n-54) + 70093*a(n-55) + 42735*a(n-56) - 27508*a(n-57) + 6397*a(n-58) - 9486*a(n-59) - 1340*a(n-60) + 2024*a(n-61) - 688*a(n-62) + 906*a(n-63) - 179*a(n-64) - 152*a(n-65) + 89*a(n-66) - 31*a(n-67) + 3*a(n-68) + 4*a(n-69) - a(n-70)
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 12 2015 08:02:48, revision 4) this is still
...
\[
(i-h_i,\,j-h_j)\;\in\;\{(-2,2),\ (-1,0),\ (0,-1),\ (0,1),\ (2,-1)\},
\]
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + 15\,a(n-2) - 23\,a(n-3) + 85\,a(n-4) - 80\,a(n-5) - 523\,a(n-6) + 650\,a(n-7) - 2928\,a(n-8) + 11648\,a(n-9) - 292\,a(n-10) - 8950\,a(n-11) + 73749\,a(n-12) - 95388\,a(n-13) + 32227\,a(n-14) + 174765\,a(n-15) - 498904\,a(n-16) + 523562\,a(n-17) - 157912\,a(n-18) - 1768335\,a(n-19) + 1015821\,a(n-20) - 1986588\,a(n-21) + 621687\,a(n-22) + 7372680\,a(n-23) - 1364061\,a(n-24) + 7605392\,a(n-25) + 1358167\,a(n-26) - 17006655\,a(n-27) + 1492898\,a(n-28) - 19207328\,a(n-29) - 12488088\,a(n-30) + 24654701\,a(n-31) + 4156975\,a(n-32) + 22863202\,a(n-33) + 26735865\,a(n-34) - 25269514\,a(n-35) - 23459191\,a(n-36) - 8218390\,a(n-37) - 22659261\,a(n-38) + 13714845\,a(n-39) + 34457684\,a(n-40) - 1653848\,a(n-41) + 5581470\,a(n-42) - 1826631\,a(n-43) - 18750261\,a(n-44) + 456888\,a(n-45) - 266629\,a(n-46) + 375672\,a(n-47) + 5303623\,a(n-48) + 489028\,a(n-49) + 454377\,a(n-50) - 57791\,a(n-51) - 569236\,a(n-52) + 64026\,a(n-53) - 88324\,a(n-54) + 70093\,a(n-55) + 42735\,a(n-56) - 27508\,a(n-57) + 6397\,a(n-58) - 9486\,a(n-59) - 1340\,a(n-60) + 2024\,a(n-61) - 688\,a(n-62) + 906\,a(n-63) - 179\,a(n-64) - 152\,a(n-65) + 89\,a(n-66) - 31\,a(n-67) + 3\,a(n-68) + 4\,a(n-69) - a(n-70)
\]
for every $n>70$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264381.
