...
\title{The empirical recurrence for OEIS A303633, proved by transfer matrix}
...
\begin{abstract}
OEIS A303633 counts $5$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A303633 is ``Number of nX5 0..1 arrays with every element unequal to 2 or 3 horizontally or vertically adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
0, 3, 0, 8, 20, 66, 207, 726,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 27 2018 10:15:06, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A303633.
