...
\title{The empirical recurrence for OEIS A283540, proved by transfer matrix}
...
\begin{abstract}
OEIS A283540 counts $n\times5$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A283540 is ``Number of n X 5 0..1 arrays with no 1 equal to more than one of its horizontal, diagonal and antidiagonal neighbors.''. It has offset $1$ and begins
\[
24, 201, 2369, 25532, 282773, 3109801, 34266804, 377393657,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 20 2025 17:03:24, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;13\,a(n-1) - 15\,a(n-2) - 129\,a(n-3) + 568\,a(n-4) + 430\,a(n-5) - 2325\,a(n-6) - 175\,a(n-7) - 2127\,a(n-8) + 3919\,a(n-9) + 438\,a(n-10) - 262\,a(n-11) - 1743\,a(n-12) + 309\,a(n-13) + 1745\,a(n-14) - 463\,a(n-15) - 462\,a(n-16) + 152\,a(n-17) + 53\,a(n-18) - 19\,a(n-19) - 3\,a(n-20) + a(n-21)
\]
for every $n>21$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A283540.
