...
\title{The empirical recurrence for OEIS A301882, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A301882 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A301882 is ``Number of nX6 0..1 arrays with every element equal to 0, 1 or 3 horizontally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
13, 74, 331, 1754, 8829, 46079, 240222, 1258853,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 28 2018 10:57:06, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 48\,a(n-2) - 16\,a(n-3) - 864\,a(n-4) + 3\,a(n-5) + 7667\,a(n-6) + 1179\,a(n-7) - 37181\,a(n-8) - 8572\,a(n-9) + 110043\,a(n-10) + 31823\,a(n-11) - 237350\,a(n-12) - 64544\,a(n-13) + 345618\,a(n-14) + 74271\,a(n-15) - 425703\,a(n-16) - 53446\,a(n-17) + 346542\,a(n-18) + 24267\,a(n-19) - 275496\,a(n-20) - 3139\,a(n-21) + 132994\,a(n-22) - 2714\,a(n-23) - 63515\,a(n-24) + 1651\,a(n-25) + 15195\,a(n-26) - 192\,a(n-27) - 1586\,a(n-28) + 6\,a(n-29) + 68\,a(n-30) - a(n-32)
\end{equation}
for all $n>33$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A301882.
