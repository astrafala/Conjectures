...
\begin{abstract}
OEIS A284352 carries an empirical recurrence of order $3$ contributed by Colin Barker. It is true, and it is
...
\begin{quote}
Conjectures from \_Colin Barker\_, Mar 26 2017: (Start) a(n) = a(n-1) + 100*a(n-2) - 100*a(n-3) for n>2.
\end{quote}
