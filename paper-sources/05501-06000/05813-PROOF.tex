...
\title{The empirical recurrence for OEIS A300600, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A300600 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A300600 is ``Number of nX3 0..1 arrays with every element equal to 0, 2, 3 or 5 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
1, 2, 6, 18, 23, 89, 230, 552,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 09 2018 17:20:35, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 4\,a(n-2) + 5\,a(n-3) - 3\,a(n-4) - 12\,a(n-5) - 9\,a(n-6) + 13\,a(n-7) - 6\,a(n-8) - 21\,a(n-9) - 5\,a(n-10) + 44\,a(n-11) + 23\,a(n-12) + 17\,a(n-13) - 70\,a(n-14) - 9\,a(n-15) + 82\,a(n-16) - 103\,a(n-17) + 91\,a(n-18) - 18\,a(n-19) - 82\,a(n-20) + 96\,a(n-21) - 56\,a(n-22) + 16\,a(n-23) + 21\,a(n-24) - 29\,a(n-25) + 14\,a(n-26) - 3\,a(n-27) - 2\,a(n-28) + 3\,a(n-29) - a(n-30)
\end{equation}
for all $n>31$.
...
\#\{\text{neighbours with a value }equal to\ x_{t,u}\}\in\{0,2,3,5\}
\end{equation}
...
publishes, $n=28$, the arrays have $3\cdot28$ cells over
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A300600.
