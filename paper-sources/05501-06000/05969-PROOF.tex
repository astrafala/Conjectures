...
\title{The empirical recurrence for OEIS A220636, proved by transfer matrix}
...
\begin{abstract}
OEIS A220636 counts the ways of linking the cells of a grid $6$ cells wide, each cell either to
...
state, the count is a walk count on $S=1024$ of them, and the conjectured recurrence is then
...
OEIS A220636 is ``Number of ways to reciprocally link elements of an 6Xn array either to themselves or to exactly two horizontal or antidiagonal neighbors.''. It has offset $1$ and begins
\[
1, 1, 13, 351, 8560, 183961, 3817452, 79063898,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 18:55:56, revision 8) this is still
...
one configuration. With $M$ the adjacency matrix of the digraph on the $S=1024$ reachable
...
\begin{theorem}
\[
a(n)\;=\;32\,a(n-1) - 195\,a(n-2) - 1350\,a(n-3) + 10665\,a(n-4) + 31692\,a(n-5) - 206199\,a(n-6) - 507142\,a(n-7) + 1799954\,a(n-8) + 4606048\,a(n-9) - 7358332\,a(n-10) - 21711948\,a(n-11) + 13920815\,a(n-12) + 54513592\,a(n-13) - 9084809\,a(n-14) - 73913886\,a(n-15) - 4653883\,a(n-16) + 53601160\,a(n-17) + 7698097\,a(n-18) - 21029870\,a(n-19) - 3072503\,a(n-20) + 4411176\,a(n-21) + 533603\,a(n-22) - 476894\,a(n-23) - 41967\,a(n-24) + 24240\,a(n-25) + 1155\,a(n-26) - 450\,a(n-27)
\]
for every $n>32$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A220636.
