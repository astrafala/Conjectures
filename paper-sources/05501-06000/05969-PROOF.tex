...
\title{The empirical recurrence for OEIS A238066, proved by transfer matrix}
...
\begin{abstract}
OEIS A238066 counts arrays over $\{0,\dots,3\}$ subject to a condition on the order
...
The condition is local to two consecutive rows, so the count is a walk count on $S=1644$
...
OEIS A238066 is ``Number of (n+1)X(2+1) 0..3 arrays with the maximum minus the minimum of every 2X2 subblock differing from its horizontal and vertical neighbors by exactly one.''. It has offset $1$ and begins
\[
1644, 16116, 157404, 1499348, 14168952, 135441648, 1301417096, 12431472388,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 10:44:56, revision 6) this is still
...
differ by $1$. The entry's first term $1644$ counts those, and the model was made to
...
\]
over the $S=1644$ pairs whose own subblock row already satisfies the condition along itself.
...
\begin{theorem}
\[
a(n)\;=\;16\,a(n-2) + 245\,a(n-3) + 3175\,a(n-4) + 11026\,a(n-5) + 14790\,a(n-6) + 30547\,a(n-7) + 66976\,a(n-8) - 4677\,a(n-9) - 94176\,a(n-10) - 54207\,a(n-11) - 285131\,a(n-12) - 299281\,a(n-13) + 431751\,a(n-14) + 567877\,a(n-15) - 34526\,a(n-16) - 198712\,a(n-17) - 48032\,a(n-18) + 10752\,a(n-19) + 9216\,a(n-20)
\]
for every $n>24$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A238066.
