...
\title{The empirical recurrence for OEIS A316179, proved by transfer matrix}
...
\begin{abstract}
OEIS A316179 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $different from$ itself lying in $\{0,1,2,3,4,8\}$, and it carries an empirical
...
OEIS A316179 is ``Number of nX4 0..1 arrays with every element unequal to 0, 1, 2, 3, 4 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
8, 112, 601, 3653, 21825, 134426, 822258, 5056910,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 25 2018 17:46:27, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) + 16\,a(n-2) - 43\,a(n-3) - 97\,a(n-4) + 142\,a(n-5) + 21\,a(n-6) - 90\,a(n-7) + 403\,a(n-8) - 124\,a(n-9) - 608\,a(n-10) + 630\,a(n-11) + 284\,a(n-12) - 400\,a(n-13) - 597\,a(n-14) - 326\,a(n-15) + 246\,a(n-16) + 292\,a(n-17) - 25\,a(n-18) - 42\,a(n-19) + 223\,a(n-20) - 39\,a(n-21) - 46\,a(n-22) - 56\,a(n-23) + 16\,a(n-24) - 25\,a(n-25) + 6\,a(n-26) + 11\,a(n-27) + 5\,a(n-28) + a(n-29) + 2\,a(n-30)
\end{equation}
for all $n>34$.
...
has score in $\{0,1,2,3,4,8\}$. The entry also fixes the top-left entry to be $0$; that is a condition on the first row alone, so it restricts the start vector and nothing else.
...
\begin{itemize}
\item $\mathbf{s}(r,s)=1$ when every cell of $r$ has score in $\{0,1,2,3,4,8\}$ \emph{with no row
above $r$} and $r_1=0$, and $0$ otherwise;
\item an edge $(r,s)\to(s,t)$ when every cell of $s$ has score in $\{0,1,2,3,4,8\}$ computed from
$r$, $s$ and $t$;
\item $\mathbf{e}(r,s)=1$ when every cell of $s$ has score in $\{0,1,2,3,4,8\}$ \emph{with no row
...
exactly when every one of its $n$ rows has all scores in $\{0,1,2,3,4,8\}$. Read the sequence as the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A316179.
