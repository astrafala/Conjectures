...
\begin{abstract}
OEIS A287193 carries an empirical recurrence of order $4$ contributed by Colin Barker. It is true, and it is
...
\begin{quote}
Conjectures from \_Colin Barker\_, Nov 22 2017: (Start) a(n) = 5*a(n-2) - 4*a(n-4) for n>4.
\end{quote}
