...
\title{The empirical recurrence for OEIS A234212, proved by transfer matrix}
...
\begin{abstract}
OEIS A234212 counts $(n+1)\times4$ arrays over $\{0,\dots,4\}$ subject to a condition imposed on
every $2\times2$ subblock, and carries an empirical recurrence of order $56$ contributed
...
OEIS A234212 is ``Number of (n+1)X(3+1) 0..4 arrays with every 2X2 subblock having the sum of the squares of all six edge and diagonal differences equal to 11.''. It has offset $1$ and begins
\[
1248, 7348, 40384, 257116, 1493960, 10151836, 61124816, 436731604,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 09:16:19, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;223\,a(n-2) - 22136\,a(n-4) + 1303842\,a(n-6) - 51198565\,a(n-8) + 1426660738\,a(n-10) - 29308622249\,a(n-12) + 455180602960\,a(n-14) - 5436994724661\,a(n-16) + 50553279723332\,a(n-18) - 368988227986457\,a(n-20) + 2126351180635715\,a(n-22) - 9709003146923883\,a(n-24) + 35189269788128342\,a(n-26) - 101259728165773203\,a(n-28) + 231060390001397360\,a(n-30) - 417017561764832798\,a(n-32) + 592925182387254959\,a(n-34) - 660503855304387479\,a(n-36) + 572258984227035715\,a(n-38) - 381879096938313788\,a(n-40) + 193753758860748742\,a(n-42) - 73452183198353516\,a(n-44) + 20317503519116744\,a(n-46) - 3966504433028624\,a(n-48) + 520682605459552\,a(n-50) - 42615909301440\,a(n-52) + 1905181236480\,a(n-54) - 34505662464\,a(n-56)
\end{equation}
for all $n>56$.
...
(\beta-\alpha)^2+(\delta-\beta)^2+(\gamma-\delta)^2+(\alpha-\gamma)^2+(\delta-\alpha)^2+(\gamma-\beta)^2=11,
\end{equation}
...
For every $n$ with $n+1-1\ge56$,
\[
a(n)-\sum_i c_i\,a(n-i)\;=\;\mathbf{1}^{\!\top}M^{\,n+1-1-56}\,q(M)\,\mathbf{1} .
\]
...
=\mathbf{1}^{\!\top}M^{\,m-56}\,q(M)\,\mathbf{1}
\]
with $m=n+1-1$, which is the stated identity; the equivalence follows by letting
$m-56=j$ run over $\ge0$. For the last clause put $w=q(M)\mathbf{1}$. By the
...
$S^2$ pairs. The vector $w=q(M)\mathbf{1}\in\mathbb{Z}^{S}$ was then formed by $56$
...
index corresponding to $n=56+1$ onwards, and the run continued until $w$ itself was the
zero vector, which settles every larger $j$ at once. By Lemma~\ref{lem:crit} the recurrence
holds for every $n>56$.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234212.
