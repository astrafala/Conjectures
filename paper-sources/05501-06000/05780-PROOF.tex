...
\title{The empirical recurrence for OEIS A299077, proved by transfer matrix}
...
\begin{abstract}
OEIS A299077 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $equal to$ itself lying in $\{0,1,2,3,4,7\}$, and it carries an empirical
...
OEIS A299077 is ``Number of nX4 0..1 arrays with every element equal to 0, 1, 2, 3, 4 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
8, 121, 927, 8245, 74329, 664377, 5966905, 53667656,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 02 2018 07:37:45, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;9\,a(n-1) + 37\,a(n-3) - 292\,a(n-4) - 375\,a(n-5) - 491\,a(n-6) + 1814\,a(n-7) + 3581\,a(n-8) + 3193\,a(n-9) - 3202\,a(n-10) - 11261\,a(n-11) - 6211\,a(n-12) - 1851\,a(n-13) + 14158\,a(n-14) - 1752\,a(n-15) + 10727\,a(n-16) - 10489\,a(n-17) + 10142\,a(n-18) - 13135\,a(n-19) + 8571\,a(n-20) - 4435\,a(n-21) + 6805\,a(n-22) - 3831\,a(n-23) + 947\,a(n-24) - 578\,a(n-25) + 842\,a(n-26) - 308\,a(n-27) + 40\,a(n-28) - 154\,a(n-29) + 40\,a(n-30)
\end{equation}
for all $n>31$.
...
has score in $\{0,1,2,3,4,7\}$. The entry also fixes the top-left entry to be $0$; that is a condition on the first row alone, so it restricts the start vector and nothing else.
...
\begin{itemize}
\item $\mathbf{s}(r,s)=1$ when every cell of $r$ has score in $\{0,1,2,3,4,7\}$ \emph{with no row
above $r$} and $r_1=0$, and $0$ otherwise;
\item an edge $(r,s)\to(s,t)$ when every cell of $s$ has score in $\{0,1,2,3,4,7\}$ computed from
$r$, $s$ and $t$;
\item $\mathbf{e}(r,s)=1$ when every cell of $s$ has score in $\{0,1,2,3,4,7\}$ \emph{with no row
...
exactly when every one of its $n$ rows has all scores in $\{0,1,2,3,4,7\}$. Read the sequence as the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A299077.
