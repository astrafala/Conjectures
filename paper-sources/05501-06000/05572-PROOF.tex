...
\title{The empirical recurrence for OEIS A257148, proved by transfer matrix}
...
\begin{abstract}
OEIS A257148 counts the arrays over $\{0,\dots,1\}$ whose $3\times3$ subblocks carry a
...
so the count is a walk count on $S=594$ states --- the last two array rows together with the
...
OEIS A257148 is ``Number of (n+2)X(2+2) 0..1 arrays with every 3X3 subblock sum of the two medians of the central row and column minus the sum of the minimums of the diagonal and antidiagonal nondecreasing horizontally, vertically and ne-to-sw antidiagonally.''. It has offset $1$ and begins
\[
2848, 16677, 101227, 594229, 3374539, 19028310, 106805258, 596053900,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 15:17:17, revision 6) this is still
...
\]
on the $S=594$ reachable states. In particular $a$ is $C$-finite. The alignment of the walk
...
\begin{theorem}
\[
a(n)\;=\;9\,a(n-1) - 14\,a(n-2) - 32\,a(n-3) + 120\,a(n-4) - 1172\,a(n-5) + 3932\,a(n-6) - 6280\,a(n-7) + 19737\,a(n-8) - 12753\,a(n-9) - 31142\,a(n-10) + 10820\,a(n-11) - 324465\,a(n-12) + 244165\,a(n-13) + 487033\,a(n-14) + 676647\,a(n-15) + 2800415\,a(n-16) - 1508929\,a(n-17) - 11016270\,a(n-18) - 1321986\,a(n-19) - 19384745\,a(n-20) + 29741253\,a(n-21) + 65612097\,a(n-22) + 30108231\,a(n-23) - 132843037\,a(n-24) + 1221523\,a(n-25) - 217403908\,a(n-26) + 39811528\,a(n-27) + 1191428040\,a(n-28) - 1237901696\,a(n-29) - 725097232\,a(n-30) + 1861412656\,a(n-31) - 1356213568\,a(n-32) + 572751872\,a(n-33) + 971675648\,a(n-34) - 1887011840\,a(n-35) + 520824832\,a(n-36) + 413429760\,a(n-37) - 34947072\,a(n-38) + 44400640\,a(n-39) - 256638976\,a(n-40) + 222035968\,a(n-41) - 49283072\,a(n-42) - 88080384\,a(n-43) + 50331648\,a(n-44)
\]
for every $n>50$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A257148.
