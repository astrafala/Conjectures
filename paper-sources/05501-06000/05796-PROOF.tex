...
\title{The conjectured generating function for OEIS A290193, proved}
...
\begin{abstract}
OEIS A290193 counts arrays of a fixed width under a local condition, and carries a conjectured
...
OEIS A290193 is ``Binary representation of the diagonal from the origin to the corner of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 705", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 1, 101, 1011, 111, 101111,\ \dots
\]
...
$A(x)=\sum_{n\ge0}a(n)x^n=N_1(x)/D_1(x)$ where $D_1(x)$ has degree at most $S=9$ and
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A290193.
