...
\title{The empirical recurrence for OEIS A255621, proved by transfer matrix}
...
\begin{abstract}
OEIS A255621 carries an empirical recurrence of order $30$ contributed by R.~H.~Hardin. It is
...
OEIS A255621 is ``Number of length n+7 0..2 arrays with at most two downsteps in every 7 consecutive neighbor pairs.''. It has offset $1$ and begins
\[
3834, 9186, 23298, 60390, 156563, 405687, 1047141, 2656032,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 15:08:29, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A255621.
