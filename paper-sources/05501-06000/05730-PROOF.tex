...
\title{The empirical recurrence for OEIS A241613, proved by transfer matrix}
...
\begin{abstract}
OEIS A241613 carries an empirical recurrence of order $36$ contributed by R.~H.~Hardin. It is
...
OEIS A241613 is ``Number of length n+2 0..7 arrays with no consecutive three elements summing to more than 7.''. It has offset $1$ and begins
\[
120, 540, 2430, 10242, 44274, 193194, 835812, 3617703,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 09 2025 00:40:14, revision 9) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A241613.
