...
\title{The empirical recurrence for OEIS A299835, proved by transfer matrix}
...
\begin{abstract}
OEIS A299835 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $equal to$ itself lying in $\{1,2,3,4,5,6,8\}$, and it carries an empirical
...
OEIS A299835 is ``Number of nX4 0..1 arrays with every element equal to 1, 2, 3, 4, 5, 6 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
2, 64, 1000, 13850, 198202, 2853873, 41026724, 589665345,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 20 2018 08:12:34, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;14\,a(n-1) + a(n-2) + 68\,a(n-3) - 24\,a(n-4) - 702\,a(n-5) - 151\,a(n-6) - 1080\,a(n-7) + 2180\,a(n-8) + 6939\,a(n-9) - 2653\,a(n-10) - 6639\,a(n-11) - 3139\,a(n-12) - 3348\,a(n-13) + 8687\,a(n-14) + 5803\,a(n-15) - 5001\,a(n-16) - 1532\,a(n-17) + 484\,a(n-18) - 180\,a(n-19) + 281\,a(n-20) - 17\,a(n-21) - 6\,a(n-22)
\end{equation}
for all $n>23$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A299835.
