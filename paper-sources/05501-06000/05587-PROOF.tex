...
\title{The empirical recurrence for OEIS A252429, proved by transfer matrix}
...
\begin{abstract}
OEIS A252429 counts $(n+2)\times6$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
$a(n)$ is a walk count on $S=253137$ vertices. Such a sequence is $C$-finite, so whether a given
...
OEIS A252429 is ``Number of (n+2)X(4+2) 0..3 arrays with every 3X3 subblock row and diagonal sum equal to 0 2 4 6 or 7 and every 3X3 column and antidiagonal sum not equal to 0 2 4 6 or 7.''. It has offset $1$ and begins
\[
1693, 1488, 2971, 7575, 20187, 53028, 139425, 374789,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:13:28, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;43\,a(n-3) - 607\,a(n-6) + 3969\,a(n-9) - 25465\,a(n-12) + 104694\,a(n-15) - 390554\,a(n-18) + 1065198\,a(n-21) - 2336824\,a(n-24) + 3653382\,a(n-27) - 2758779\,a(n-30) + 95370\,a(n-33) + 1117676\,a(n-36) - 418109\,a(n-39) - 95329\,a(n-42) - 78740\,a(n-45) + 37358\,a(n-48) + 22825\,a(n-51) - 9860\,a(n-54) + 9262\,a(n-57) + 4266\,a(n-60) + 111\,a(n-63) + 92\,a(n-66) + 21\,a(n-69) + a(n-72)
\]
for every $n>74$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252429.
