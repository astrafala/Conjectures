...
\title{The empirical recurrence for OEIS A207371, proved by transfer matrix}
...
\begin{abstract}
OEIS A207371 counts arrays over $\{0,\dots,1\}$ of width $6$ that avoid the patterns
...
OEIS A207371 is ``Number of 6Xn 0..1 arrays avoiding 0 0 0 and 0 1 1 horizontally and 0 0 1 and 0 1 1 vertically.''. It has offset
$1$ and begins
\[
16, 256, 784, 3844, 14884, 42849, 142884,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 13:50:06, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) - 7\,a(n-2) - 15\,a(n-3) + 4\,a(n-4) + 98\,a(n-5) - 47\,a(n-6) - 173\,a(n-7) - 95\,a(n-8) + 424\,a(n-9) + 118\,a(n-10) - 170\,a(n-11) - 483\,a(n-12) + 180\,a(n-13) - 177\,a(n-14) + 465\,a(n-15) + 110\,a(n-16) + 412\,a(n-17) - 805\,a(n-18) + 63\,a(n-19) - 392\,a(n-20) + 462\,a(n-21) - 217\,a(n-22) + 625\,a(n-23) - 324\,a(n-24) + 154\,a(n-25) - 367\,a(n-26) + 207\,a(n-27) - 225\,a(n-28) + 204\,a(n-29) - 74\,a(n-30) + 102\,a(n-31) - 82\,a(n-32) + 50\,a(n-33) - 44\,a(n-34) + 18\,a(n-35) - 11\,a(n-36) + 10\,a(n-37) - 5\,a(n-38) + 3\,a(n-39) - a(n-40)
\end{equation}
for all $n>40$. The entry's array has a fixed number of rows and a growing number of
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207371.
