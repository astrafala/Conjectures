...
\title{The empirical recurrence for OEIS A254770, proved by transfer matrix}
...
\begin{abstract}
OEIS A254770 counts the arrays over $\{0,\dots,1\}$ whose $3\times3$ subblocks carry a
...
so the count is a walk count on $S=3030$ states --- the last two array rows together with the
...
OEIS A254770 is ``Number of (n+2)X(3+2) 0..1 arrays with every 3X3 subblock sum of the two maximums of the central row and the central column and the two medians of the diagonal and antidiagonal nondecreasing horizontally, vertically and ne-to-sw antidiagonally.''. It has offset $1$ and begins
\[
11677, 50173, 295516, 1901784, 11736086, 72739438, 462927268, 2925883667,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 14:55:18, revision 6) this is still
...
\]
on the $S=3030$ reachable states. In particular $a$ is $C$-finite. The alignment of the walk
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-1) + a(n-2) - 36\,a(n-3) + 104\,a(n-4) - 577\,a(n-5) + 406\,a(n-6) - 2654\,a(n-7) - 1083\,a(n-8) + 54521\,a(n-9) - 21741\,a(n-10) - 154770\,a(n-11) + 38931\,a(n-12) - 13306\,a(n-13) - 72151\,a(n-14) + 367153\,a(n-15) + 1186616\,a(n-16) + 175841\,a(n-17) - 2541563\,a(n-18) - 2203312\,a(n-19) - 1102181\,a(n-20) + 5457515\,a(n-21) + 3952319\,a(n-22) - 2371833\,a(n-23) + 70124\,a(n-24) - 8362041\,a(n-25) + 760917\,a(n-26) + 7641448\,a(n-27) - 182502\,a(n-28) - 1743336\,a(n-29) - 1390764\,a(n-30) - 1542892\,a(n-31) - 296088\,a(n-32) + 4265808\,a(n-33) - 720384\,a(n-34) - 1733104\,a(n-35) + 286080\,a(n-36) + 165568\,a(n-37) + 32960\,a(n-38)
\]
for every $n>51$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A254770.
