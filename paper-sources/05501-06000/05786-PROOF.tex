...
\title{The empirical recurrence for OEIS A284070, proved by transfer matrix}
...
\begin{abstract}
OEIS A284070 counts $n\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
walk, and $a(n)$ is a walk count on $S=196$ vertices, which is $C$-finite. Whether the
...
OEIS A284070 is ``Number of n X 3 0..1 arrays with no 1 equal to more than three of its horizontal, diagonal and antidiagonal neighbors, with the exception of exactly two elements.''. It has offset $1$ and begins
\[
0, 1, 15, 314, 3764, 37557, 353608, 3178404,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 09 2023 22:18:05, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;21\,a(n-1) - 153\,a(n-2) + 484\,a(n-3) - 1254\,a(n-4) + 5199\,a(n-5) - 10697\,a(n-6) + 19671\,a(n-7) - 61194\,a(n-8) + 93379\,a(n-9) - 140298\,a(n-10) + 354402\,a(n-11) - 436616\,a(n-12) + 546228\,a(n-13) - 1123992\,a(n-14) + 1218808\,a(n-15) - 1193856\,a(n-16) + 1907040\,a(n-17) - 2009856\,a(n-18) + 1446528\,a(n-19) - 1456128\,a(n-20) + 1486336\,a(n-21) - 890880\,a(n-22) + 270336\,a(n-23) - 32768\,a(n-24)
\]
for every $n>24$.
\end{theorem}
...
integers vanish from the index corresponding to $n=24+1$ onwards, and the run was
continued until the working vector was identically zero, which settles all larger $j$ at once.
By Lemma~\ref{lem:crit} the recurrence holds for every $n>24$.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A284070.
