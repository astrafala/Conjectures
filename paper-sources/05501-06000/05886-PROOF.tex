...
\title{The empirical recurrence for OEIS A237399, proved by transfer matrix}
...
\begin{abstract}
OEIS A237399 counts arrays over $\{0,\dots,3\}$ subject to a condition on the order
...
OEIS A237399 is ``Number of (n+1) X (1+1) 0..3 arrays with the maximum plus the upper median plus the lower median minus the minimum of every 2 X 2 subblock differing from its horizontal and vertical neighbors by exactly one.''. It has offset $1$ and begins
\[
256, 1540, 9296, 58088, 363220, 2273712, 14242608, 89287168,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 07 2014 19:23:52, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;1944\,a(n-4) - 669984\,a(n-8) + 82555584\,a(n-12) - 4702054656\,a(n-16) + 139358364672\,a(n-20) - 2211858219008\,a(n-24) + 17888510001152\,a(n-28) - 60723254525952\,a(n-32) + 30235468759040\,a(n-36) - 3292511862784\,a(n-40)
\]
for every $n>43$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237399.
