...
\title{The empirical recurrence for OEIS A253370, proved by transfer matrix}
...
\begin{abstract}
OEIS A253370 counts the arrays over $\{0,\dots,2\}$ whose $2\times2$ subblocks carry a
...
so a pair of consecutive array rows is a state, the count is a walk count on $S=2500$ of them,
...
OEIS A253370 is ``Number of (n+1)X(3+1) 0..2 arrays with every 2X2 subblock sum nondecreasing horizontally, vertically and antidiagonally ne-to-sw.''. It has offset $1$ and begins
\[
2500, 22877, 219438, 1027387, 5829147, 21245477, 92753092, 299160892,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 14:00:34, revision 6) this is still
...
\]
on the $S=2500$ admissible pairs. In particular $a$ is $C$-finite. The alignment of the walk
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253370.
