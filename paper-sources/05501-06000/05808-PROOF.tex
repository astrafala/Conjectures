...
\title{The empirical recurrence for OEIS A316950, proved by transfer matrix}
...
\begin{abstract}
OEIS A316950 counts $5$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A316950 is ``Number of nX5 0..1 arrays with every element unequal to 1, 2, 3, 4, 5, 6 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
3, 383, 9417, 287292, 8641499, 259163370, 7779344498, 233495963949,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 17 2018 12:22:43, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;21\,a(n-1) + 205\,a(n-2) + 1729\,a(n-3) + 6482\,a(n-4) + 20422\,a(n-5) + 15722\,a(n-6) - 68945\,a(n-7) - 274873\,a(n-8) - 285347\,a(n-9) + 262561\,a(n-10) + 667642\,a(n-11) + 350411\,a(n-12) - 1662532\,a(n-13) + 544892\,a(n-14) - 570000\,a(n-15) + 47220\,a(n-16) + 425272\,a(n-17) - 1298986\,a(n-18) + 2146810\,a(n-19) - 426071\,a(n-20) + 537568\,a(n-21) - 381944\,a(n-22) - 620494\,a(n-23) + 372655\,a(n-24) - 275195\,a(n-25) + 309994\,a(n-26) - 107697\,a(n-27) + 64413\,a(n-28) - 38742\,a(n-29) + 936\,a(n-30) - 1920\,a(n-31) - 816\,a(n-32) + 288\,a(n-33)
\end{equation}
for all $n>33$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A316950.
