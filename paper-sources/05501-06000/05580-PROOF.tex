...
\title{The empirical closed form for OEIS A187379, proved}
...
\begin{abstract}
OEIS A187379 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A187379 is ``Number of 5-step S, NW and NE-moving king's tours on an n X n board summed over all starting positions.''. It has offset $1$ and begins
\[
0, 0, 40, 188, 487, 924, 1499, 2212,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 69*n\^{}2 - 322*n + 372 for n>3.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 22 2025 05:56:01, revision 18) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;69 n^{2} - 322 n + 372.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A187379.
