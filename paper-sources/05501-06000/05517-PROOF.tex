...
\title{The empirical column recurrences for the table OEIS A223186}
...
\begin{abstract}
OEIS A223186 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A223186 is ``T(n,k) = Rolling icosahedron footprints: number of n X k 0..11 arrays starting with 0 where 0..11 label vertices of an icosahedron and every array movement to a horizontal, vertical or antidiagonal neighbor moves along an icosahedral edge.''. It has offset $1$, is
read by antidiagonals, and begins
\[
1, 5, 5, 25, 20, 25, 125, 80,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 21:19:20, revision 8) these are still
...
The sequence is ``Number of rolling icosahedron footprints: number of n X 1 0..11 arrays starting with 0 where 0..11 label vertices of an icosahedron and every array movement to a horizontal, vertical or antidiagonal neighbor moves along an icosahedral edge.''. Its rows are the vertices of a digraph on
...
The sequence is ``Number of rolling icosahedron footprints: number of n X 2 0..11 arrays starting with 0 where 0..11 label vertices of an icosahedron and every array movement to a horizontal, vertical or antidiagonal neighbor moves along an icosahedral edge.''. Its rows are the vertices of a digraph on
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223186.
