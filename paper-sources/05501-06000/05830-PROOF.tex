...
\title{The empirical recurrence for OEIS A207920, proved by transfer matrix}
...
\begin{abstract}
OEIS A207920 counts arrays over $\{0,\dots,1\}$ of width $5$ that avoid the patterns
...
OEIS A207920 is ``Number of 5Xn 0..1 arrays avoiding 0 0 0 and 1 0 1 horizontally and 0 1 0 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
16, 256, 1152, 5371, 21145, 86255, 366330,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:28:08, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 2\,a(n-2) + 37\,a(n-3) + 59\,a(n-4) + 24\,a(n-5) - 269\,a(n-6) - 770\,a(n-7) - 667\,a(n-8) + 1180\,a(n-9) + 3322\,a(n-10) + 2975\,a(n-11) - 1689\,a(n-12) - 6648\,a(n-13) - 6577\,a(n-14) - 387\,a(n-15) + 5843\,a(n-16) + 7354\,a(n-17) + 3010\,a(n-18) - 2018\,a(n-19) - 3068\,a(n-20) - 2386\,a(n-21) + 556\,a(n-22) + 777\,a(n-23) + 764\,a(n-24) - 259\,a(n-25) - 552\,a(n-26) - 503\,a(n-27) - 97\,a(n-28) + 10\,a(n-29) + 168\,a(n-30) + 19\,a(n-31) + 51\,a(n-32) - 19\,a(n-33) + 10\,a(n-34) - 3\,a(n-35) + 3\,a(n-36)
\end{equation}
for all $n>38$. The entry's array has a fixed number of rows and a growing number of
...
index corresponding to $n=38+1$ onwards, and the run was continued past $S$ consecutive
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207920.
