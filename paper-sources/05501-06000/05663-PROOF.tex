...
\title{The empirical recurrence for OEIS A276293, proved by counting patterns}
...
\begin{abstract}
OEIS A276293 counts arrays in which no entry may repeat a value found at any of three stated
...
cutting $98$ pairs to $S=23$ states. The entry's empirical recurrence of order $3$,
...
OEIS A276293 is ``Number of n X 2 0..2 arrays with no element equal to any value at offset (-2,-1) (-1,1) or (0,-1) and new values introduced in order 0..2.''. It has offset $1$ and begins
\[
1, 4, 11, 31, 88, 250, 710, 2016,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 4*a(n-1) - 4*a(n-2) + 2*a(n-3) for n>4.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 05 2019 07:53:34, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A276293.
