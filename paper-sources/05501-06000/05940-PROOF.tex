...
\title{The conjectured generating function for OEIS A250883, proved}
...
\begin{abstract}
OEIS A250883 counts arrays of a fixed width under a local condition, and carries a conjectured
...
OEIS A250883 is ``Number of (6+1) X (n+1) 0..3 arrays with nondecreasing x(i,j)-x(i,j-1) in the i direction and nondecreasing x(i,j)+x(i-1,j) in the j direction.''. It has offset $1$ and begins
\[
155080, 553736, 1350002, 2681528, 4685964, 7500960,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 22 2018 14:35:18, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250883.
