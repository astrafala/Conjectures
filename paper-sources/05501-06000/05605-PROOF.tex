...
\title{The empirical column recurrences for the table OEIS A263337}
...
\begin{abstract}
OEIS A263337 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A263337 is ``T(n,k)=Number of (n+2)X(k+2) 0..2 arrays with each row and column divisible by 13, read as a base-3 number with top and left being the most significant digits.''. It has offset $1$, is
read by antidiagonals, and begins
\[
3, 7, 7, 19, 19, 19, 57, 57,\ \dots
\]
The entry carries the following block:
\begin{quote}\small
Empirical for column k:\\
k=1: a(n) = 3*a(n-1) +a(n-3) -3*a(n-4)\\
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 15 2015 06:54:46, revision 3) these are still
...
The sequence is ``Number of (n+2)X3 0..2 arrays with each row and column divisible by 13, read as a base-3 number with top and left being the most significant digits.''. Its rows are the vertices of a digraph on
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A263337.
