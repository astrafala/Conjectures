...
\title{The empirical recurrence for OEIS A252197, proved by transfer matrix}
...
\begin{abstract}
OEIS A252197 counts $(n+2)\times6$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
$a(n)$ is a walk count on $S=206585$ vertices. Such a sequence is $C$-finite, so whether a given
...
OEIS A252197 is ``Number of (n+2) X (4+2) 0..3 arrays with every 3 X 3 subblock row, column, diagonal and antidiagonal sum not equal to 0 3 5 6 or 7.''. It has offset $1$ and begins
\[
1642, 1313, 5177, 21928, 92287, 391996, 1669356, 7114929,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 25 2024 21:29:34, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 5\,a(n-2) + 14\,a(n-3) + 34\,a(n-4) - 16\,a(n-5) - 79\,a(n-6) - 150\,a(n-7) - 94\,a(n-8) + 581\,a(n-9) + 457\,a(n-10) - 913\,a(n-11) - 631\,a(n-12) + 692\,a(n-13) + 433\,a(n-14) - 236\,a(n-15) - 116\,a(n-16) + 72\,a(n-17) - 57\,a(n-18) - 32\,a(n-19) + 38\,a(n-20) - 15\,a(n-21) + 5\,a(n-22) + 11\,a(n-23) - 4\,a(n-24)
\]
for every $n>28$.
\end{theorem}
...
exactly. Those integers vanish from the index corresponding to $n=28+1$ onwards, and the
run was continued until the working vector was identically zero, which settles all larger $j$
at once. By Lemma~\ref{lem:crit} the recurrence holds for every $n>28$.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252197.
