...
\title{The empirical recurrence for OEIS A281561, proved by transfer matrix}
...
\begin{abstract}
OEIS A281561 counts $n\times6$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A281561 is ``Number of nX6 0..1 arrays with no element equal to more than two of its horizontal, diagonal or antidiagonal neighbors, with the exception of exactly two elements, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
0, 602, 6955, 31300, 119319, 347316, 919632, 2383814,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 24 2017 08:34:25, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) - 7\,a(n-2) + 10\,a(n-3) - 38\,a(n-4) + 34\,a(n-5) + 10\,a(n-6) + 73\,a(n-7) - 17\,a(n-8) - 173\,a(n-9) - 95\,a(n-10) - 32\,a(n-11) + 258\,a(n-12) + 387\,a(n-13) + 108\,a(n-14) - 244\,a(n-15) - 604\,a(n-16) - 538\,a(n-17) + 264\,a(n-18) + 609\,a(n-19) + 474\,a(n-20) + 335\,a(n-21) - 352\,a(n-22) - 742\,a(n-23) - 197\,a(n-24) + 184\,a(n-25) + 172\,a(n-26) + 243\,a(n-27) + 90\,a(n-28) - 162\,a(n-29) - 108\,a(n-30) + 27\,a(n-31) + 27\,a(n-32)
\]
for every $n>52$.
\end{theorem}
...
integers vanish from the index corresponding to $n=52+1$ onwards, and the run was
continued until the working vector was identically zero, which settles all larger $j$ at once.
By Lemma~\ref{lem:crit} the recurrence holds for every $n>52$.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A281561.
