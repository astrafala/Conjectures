...
\title{The empirical recurrence for OEIS A254839, proved by transfer matrix}
...
\begin{abstract}
OEIS A254839 counts the arrays over $\{0,\dots,1\}$ whose $3\times3$ subblocks carry a
...
OEIS A254839 is ``Number of (n+2)X(2+2) 0..1 arrays with every 3X3 subblock sum of the medians of the diagonal and antidiagonal minus the two sums of the central row and column nondecreasing horizontally and vertically.''. It has offset $1$ and begins
\[
2485, 10550, 37642, 117706, 298165, 645882, 1323795, 2679351,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 14:58:55, revision 10) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A254839.
