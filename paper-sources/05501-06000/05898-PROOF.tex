...
\title{The empirical recurrence for OEIS A258919, proved by transfer matrix}
...
\begin{abstract}
OEIS A258919 counts arrays of width $4$ over $\{0,1\}$ in which every $3\times3$ window has
...
OEIS A258919 is ``Number of (n+2)X(2+2) 0..1 arrays with no 3x3 subblock diagonal sum equal to the antidiagonal sum or central row sum equal to the central column sum.''. It has offset $1$ and begins
\[
576, 1156, 1936, 4096, 9216, 17424, 30976, 66564,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 15:32:45, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-2) + a(n-3) + 14\,a(n-4) - 43\,a(n-6) + 3\,a(n-7) - 58\,a(n-8) - 44\,a(n-9) + 201\,a(n-10) + 33\,a(n-11) + 34\,a(n-12) + 42\,a(n-13) - 271\,a(n-14) - 191\,a(n-15) - 208\,a(n-16) + 352\,a(n-17) + 1001\,a(n-18) + 213\,a(n-19) - 574\,a(n-20) - 526\,a(n-21) + 129\,a(n-22) - 91\,a(n-23) + 66\,a(n-24) + 20\,a(n-25) - 7\,a(n-26) + 7\,a(n-27) - a(n-28)
\]
for every $n>27$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A258919.
