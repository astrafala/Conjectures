...
\title{The empirical recurrence for OEIS A247529, proved by transfer matrix}
...
\begin{abstract}
OEIS A247529 carries an empirical recurrence of order $29$ contributed by R.~H.~Hardin. It is
...
OEIS A247529 is ``Number of length n+3 0..4 arrays with some disjoint pairs in every consecutive four terms having the same sum.''. It has offset $1$ and begins
\[
185, 317, 561, 1007, 1823, 3455, 6495, 12105,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 11:35:30, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 4\,a(n-2) - 4\,a(n-3) + 18\,a(n-4) - 18\,a(n-5) - 78\,a(n-6) + 78\,a(n-7) - 67\,a(n-8) + 67\,a(n-9) + 386\,a(n-10) - 386\,a(n-11) + 22\,a(n-12) - 22\,a(n-13) - 686\,a(n-14) + 686\,a(n-15) + 125\,a(n-16) - 125\,a(n-17) + 616\,a(n-18) - 616\,a(n-19) - 178\,a(n-20) + 178\,a(n-21) - 340\,a(n-22) + 340\,a(n-23) + 130\,a(n-24) - 130\,a(n-25) + 80\,a(n-26) - 80\,a(n-27) - 40\,a(n-28) + 40\,a(n-29)
\]
for every $n>30$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A247529.
