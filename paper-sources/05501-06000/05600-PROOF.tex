...
\title{The empirical closed form, generating function and recurrence for OEIS A195237, proved}
...
\begin{abstract}
OEIS A195237 counts the lower triangles of a $7\times7$ array over $\{0,\dots,n\}$ in which
adjacent entries differ by at most $1$, and carries closed form, generating function and recurrence recorded as empirical. The shape here is FIXED
...
OEIS A195237 is ``Number of lower triangles of a 7 X 7 0..n array with each element differing from all of its diagonal, vertical, antidiagonal and horizontal neighbors by one or less.''. It has offset $1$ and begins
\[
268435456, 1663418313, 3601738548, 5618308863, 7640055854, 9661943973,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 06 2018 12:18:37, revision 9) these are still
...
horizontal, antidiagonal, vertical, diagonal offsets, which here gives $78$ adjacent pairs. Each cell carries a value in
...
\[
a(n)\;=\;2021888119\,n-2469384741\qquad\text{for every }n\ge5,
\]
and $\mathcal P$ has exactly $2021888119$ elements.
\end{theorem}
...
$a(6+1)$ were computed exactly, giving slope $2021888119$ and the stated intercept; the slope
...
First, the count reproduces all $18$ terms the entry publishes, exactly, in integer
arithmetic.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A195237.
