...
\title{The conjectured generating function for OEIS A252870, proved}
...
\begin{abstract}
OEIS A252870 counts arrays of a fixed width under a local condition, and carries a conjectured
...
OEIS A252870 is ``Number of n X 2 nonnegative integer arrays with upper left 0 and lower right n+2-4 and value increasing by 0 or 1 with every step right or down.''. It has offset $1$ and begins
\[
0, 1, 8, 26, 61, 120,\ \dots
\]
The entry states, as a conjecture contributed by a reader and never marked settled:
\begin{quote}
Empirical: G.f.: -x\^{}2*(1+3*x-4*x\^{}2+x\^{}3) / (x-1)\^{}5. - \_R. J. Mathar\_, Nov 21 2015
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 22 2015 13:19:33, revision 9) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252870.
