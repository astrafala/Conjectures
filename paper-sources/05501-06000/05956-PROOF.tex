...
\title{The empirical recurrence for OEIS A252438, proved by transfer matrix}
...
\begin{abstract}
OEIS A252438 counts $7\times(n+2)$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
$a(n)$ is a walk count on $S=1824878$ vertices. Such a sequence is $C$-finite, so whether a given
...
OEIS A252438 is ``Number of (5+2)X(n+2) 0..3 arrays with every 3X3 subblock row and diagonal sum equal to 0 2 4 6 or 7 and every 3X3 column and antidiagonal sum not equal to 0 2 4 6 or 7.''. It has offset $1$ and begins
\[
1152, 2993, 9643, 20187, 85563, 302218, 652210, 2786331,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:14:26, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252438.
