...
\title{The empirical recurrence for OEIS A250384, proved by transfer matrix}
...
\begin{abstract}
OEIS A250384 carries an empirical recurrence of order $31$ contributed by R.~H.~Hardin. It is
...
OEIS A250384 is ``Number of length n+3 0..5 arrays with no four consecutive terms having the maximum of any two terms equal to the minimum of the remaining two terms.''. It has offset $1$ and begins
\[
930, 4350, 20518, 96866, 457366, 2160160, 10203222, 48194820,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 12:22:22, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250384.
