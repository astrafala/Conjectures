...
\title{The empirical recurrence for OEIS A254973, proved by transfer matrix}
...
\begin{abstract}
OEIS A254973 counts $(n+2)\times5$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A254973 is ``Number of (n+2)X(3+2) 0..1 arrays with no 3x3 subblock diagonal sum 0 or 1 and no antidiagonal sum 0 or 1 and no row sum 0 and no column sum 0.''. It has offset $1$ and begins
\[
1008, 6915, 49040, 260705, 1592767, 9673960, 57587977, 343845199,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:35:12, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + 11\,a(n-2) + 8\,a(n-3) + 60\,a(n-4) - 284\,a(n-5) - 333\,a(n-6) - 3571\,a(n-7) - 6011\,a(n-8) + 24239\,a(n-9) + 41276\,a(n-10) - 7771\,a(n-11) - 56686\,a(n-12) - 49978\,a(n-13) - 80570\,a(n-14) - 243931\,a(n-15) + 89792\,a(n-16) + 493579\,a(n-17) + 457162\,a(n-18) - 222384\,a(n-19) - 624692\,a(n-20) + 52666\,a(n-21) + 36815\,a(n-22) + 113184\,a(n-23) + 75036\,a(n-24) + 123561\,a(n-25) - 85349\,a(n-26) - 87922\,a(n-27) - 43653\,a(n-28) - 9850\,a(n-29) - 9845\,a(n-30) - 5348\,a(n-31) - 334\,a(n-32) - 16\,a(n-33) + 84\,a(n-34) - 60\,a(n-35)
\]
for every $n>38$.
\end{theorem}
...
exactly. Those integers vanish from the index corresponding to $n=38+1$ onwards, and the
run was continued until the working vector was identically zero, which settles all larger $j$
at once. By Lemma~\ref{lem:crit} the recurrence holds for every $n>38$.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A254973.
