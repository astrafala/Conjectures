...
\title{The empirical recurrence for OEIS A281569, proved by transfer matrix}
...
\begin{abstract}
OEIS A281569 counts $7\times n$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A281569 is ``Number of 7Xn 0..1 arrays with no element equal to more than two of its horizontal, diagonal or antidiagonal neighbors, with the exception of exactly two elements, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
0, 1508, 62882, 162919, 430995, 919632, 1818257, 3326246,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 24 2017 08:42:01, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) - 15\,a(n-2) + 23\,a(n-3) - 30\,a(n-4) + 36\,a(n-5) - 34\,a(n-6) + 30\,a(n-7) - 36\,a(n-8) + 43\,a(n-9) - 42\,a(n-10) + 42\,a(n-11) - 40\,a(n-12) + 27\,a(n-13) - 18\,a(n-14) + 21\,a(n-15) - 21\,a(n-16) + 15\,a(n-17) - 12\,a(n-18) + 9\,a(n-19) - 3\,a(n-20) + a(n-21) - 3\,a(n-22) + 3\,a(n-23) - a(n-24)
\]
for every $n>46$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A281569.
