...
\title{The empirical recurrence for OEIS A184123, proved by transfer matrix}
...
\begin{abstract}
OEIS A184123 counts arrays over $\{0,\dots,3\}$ whose rows, columns, diagonals or
...
OEIS A184123 is ``Number of n X 3 0..3 arrays with rows and columns in nondecreasing order.''. It has offset $1$ and begins
\[
20, 561, 14178, 276427, 4249486, 53817407, 581588614, 5503143135,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 20 2022 23:06:40, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A184123.
