...
\title{The empirical recurrence for OEIS A189106, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A189106 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A189106 is ``Number of nX4 binary arrays without the pattern 1 1 0 diagonally or antidiagonally.''. It has offset $1$ and begins
\[
16, 256, 2500, 23716, 207936, 1806336, 15523600, 133079296,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 05:01:30, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;9\,a(n-1) - 18\,a(n-3) + 12\,a(n-4) - 1350\,a(n-5) + 300\,a(n-6) + 10000\,a(n-7) - 2448\,a(n-8) - 4968\,a(n-9) + 576\,a(n-10) - 71424\,a(n-11) + 30816\,a(n-12) + 71136\,a(n-13) - 56832\,a(n-14) + 206208\,a(n-15) - 93312\,a(n-16) - 201600\,a(n-17) + 182016\,a(n-18) - 281088\,a(n-19) + 64512\,a(n-20) + 348160\,a(n-21) - 221184\,a(n-22) + 110592\,a(n-23) - 270336\,a(n-25) + 147456\,a(n-26) + 98304\,a(n-27) - 65536\,a(n-28)
\end{equation}
for all $n>29$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A189106.
