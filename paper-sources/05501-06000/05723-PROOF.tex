...
\title{The empirical closed form for OEIS A187173, proved}
...
\begin{abstract}
OEIS A187173 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A187173 is ``Number of 3-step left-handed knight's tours (moves only out two, left one) on an n X n board summed over all starting positions.''. It has offset $1$ and begins
\[
0, 0, 0, 16, 60, 128, 220, 336,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 12*n\^{}2 - 64*n + 80 for n>3.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 22 2018 17:46:36, revision 15) this is still
...
First, the walk model reproduces every one of the $44$ terms the entry publishes,
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A187173.
