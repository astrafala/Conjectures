...
\title{The empirical recurrence for OEIS A249838, proved by transfer matrix}
...
\begin{abstract}
OEIS A249838 carries an empirical recurrence of order $40$ contributed by R.~H.~Hardin. It is
...
OEIS A249838 is ``Number of length n+4 0..2 arrays with no five consecutive terms having the maximum of any two terms equal to the minimum of the remaining three terms.''. It has offset $1$ and begins
\[
110, 198, 359, 653, 1189, 2163, 3966, 7269,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 12:06:32, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;22\,a(n-5) + 10\,a(n-6) + 4\,a(n-7) + 10\,a(n-8) + 15\,a(n-9) - 147\,a(n-10) - 121\,a(n-11) - 39\,a(n-12) - 95\,a(n-13) - 174\,a(n-14) + 303\,a(n-15) + 407\,a(n-16) + 75\,a(n-17) + 108\,a(n-18) + 472\,a(n-19) + 15\,a(n-20) - 410\,a(n-21) - 33\,a(n-22) + 294\,a(n-23) - 194\,a(n-24) - 358\,a(n-25) + 30\,a(n-26) + 195\,a(n-27) - 191\,a(n-28) - 67\,a(n-29) + 100\,a(n-30) + 125\,a(n-31) - 114\,a(n-32) - a(n-33) + 19\,a(n-34) + 18\,a(n-35) - 36\,a(n-36) + 16\,a(n-37) + 12\,a(n-38) + 4\,a(n-39) - 8\,a(n-40)
\]
for every $n>44$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A249838.
