...
\title{The empirical recurrence for OEIS A207948, proved by transfer matrix}
...
\begin{abstract}
OEIS A207948 counts arrays over $\{0,\dots,1\}$ of width $7$ that avoid the patterns
...
OEIS A207948 is ``Number of nX7 0..1 arrays avoiding 0 0 1 and 0 1 1 horizontally and 0 1 0 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
20, 400, 2340, 18330, 133812, 1007146, 7513176,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:30:40, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207948.
