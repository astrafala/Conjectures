...
\title{The empirical recurrence for OEIS A252637, proved by transfer matrix}
...
\begin{abstract}
OEIS A252637 counts $(n+2)\times7$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
$a(n)$ is a walk count on $S=1629663$ vertices. Such a sequence is $C$-finite, so whether a given
...
OEIS A252637 is ``Number of (n+2) X (5+2) 0..3 arrays with every 3 X 3 subblock row and diagonal sum equal to 0 3 4 6 or 7 and every 3 X 3 column and antidiagonal sum not equal to 0 3 4 6 or 7.''. It has offset $1$ and begins
\[
6598, 22701, 110665, 448323, 2641643, 13960830, 62261756, 378997999,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 05 2025 14:37:13, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;401\,a(n-3) - 58334\,a(n-6) + 3905774\,a(n-9) - 123912796\,a(n-12) + 1797645518\,a(n-15) - 16104263185\,a(n-18) + 106963513595\,a(n-21) - 484501448416\,a(n-24) + 1241730094740\,a(n-27) - 1500310993968\,a(n-30) + 684083769472\,a(n-33) - 33538252800\,a(n-36)
\]
for every $n>46$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252637.
