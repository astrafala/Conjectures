...
\title{The empirical recurrence for OEIS A252598, proved by transfer matrix}
...
\begin{abstract}
OEIS A252598 counts $(n+2)\times3$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
every $3\times3$ subblock, and it carries an empirical recurrence of order $43$
...
OEIS A252598 is ``Number of (n+2)X(1+2) 0..2 arrays with every 3X3 subblock row, column, diagonal and antidiagonal sum not equal to 1 2 or 5.''. It has offset $1$ and begins
\[
303, 567, 1218, 2792, 6709, 16123, 39372, 97138,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:25:21, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) - 6\,a(n-2) + 31\,a(n-3) - 92\,a(n-4) + 124\,a(n-5) - 375\,a(n-6) + 811\,a(n-7) - 979\,a(n-8) + 2278\,a(n-9) - 3380\,a(n-10) + 3698\,a(n-11) - 7324\,a(n-12) + 6163\,a(n-13) - 6909\,a(n-14) + 11385\,a(n-15) - 602\,a(n-16) + 6670\,a(n-17) - 3170\,a(n-18) - 12304\,a(n-19) - 6355\,a(n-20) - 14914\,a(n-21) + 8655\,a(n-22) + 7225\,a(n-23) + 20083\,a(n-24) + 9981\,a(n-25) - 963\,a(n-26) - 7637\,a(n-27) - 9987\,a(n-28) - 1830\,a(n-29) + 1511\,a(n-30) + 3257\,a(n-31) + 530\,a(n-32) - 1400\,a(n-33) - 2384\,a(n-34) - 1532\,a(n-35) - 732\,a(n-36) + 60\,a(n-37) + 226\,a(n-38) + 120\,a(n-39) + 80\,a(n-40) - 20\,a(n-41) + 12\,a(n-42) - 8\,a(n-43)
\]
for every $n>47$.
\end{theorem}

\begin{proof}
The vector $w=q(M)\mathbf{1}$ was formed by $43$ matrix--vector products in exact
integer arithmetic and $\mathbf{1}^{\!\top}M^{j}w$ evaluated for $j=0,1,\dots$, again
exactly. Those integers vanish from the index corresponding to $n=47+1$ onwards, and the
run was continued until the working vector was identically zero, which settles all larger $j$
at once. By Lemma~\ref{lem:crit} the recurrence holds for every $n>47$.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252598.
