...
\title{The empirical recurrence for OEIS A303185, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A303185 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A303185 is ``Number of 5Xn 0..1 arrays with every element equal to 0, 1, 2, 5 or 6 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
16, 264, 547, 1302, 5613, 24751, 88153, 325770,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 19 2018 13:27:21, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) - 10\,a(n-2) + 13\,a(n-3) - 24\,a(n-4) - 26\,a(n-5) + 68\,a(n-6) + 18\,a(n-7) + 19\,a(n-8) - 33\,a(n-9) - 95\,a(n-10) + 90\,a(n-11) - 139\,a(n-12) + 215\,a(n-13) - 365\,a(n-14) + 372\,a(n-15) + 112\,a(n-16) - 111\,a(n-17) - 23\,a(n-18) - 358\,a(n-19) - 11\,a(n-20) - 178\,a(n-21) + 319\,a(n-22) + 435\,a(n-23) - 225\,a(n-24) + 270\,a(n-25) - 416\,a(n-26) + 142\,a(n-27) - 217\,a(n-28) + 149\,a(n-29) - 12\,a(n-30) + 40\,a(n-31) - 14\,a(n-32) - 4\,a(n-33) - 6\,a(n-34)
\end{equation}
for all $n>40$.
...
\#\{\text{neighbours with a value }equal to\ x_{t,u}\}\in\{0,1,2,5,6\}
\end{equation}
...
publishes, $n=22$, the arrays have $5\cdot22$ cells over
$2$ values, so there are about $10^{33}$ of them to sift. The
...
every one of the $22$ published indices, with no shift fitted: the number of columns is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A303185.
