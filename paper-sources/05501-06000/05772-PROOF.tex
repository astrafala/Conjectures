...
\title{The empirical recurrence for OEIS A223339, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A223339 counts arrays over $\{0,\dots,14\}$ in which every cell is constrained by the
values of its neighbours, and carries an empirical recurrence of order $30$ contributed
...
with $S=3375$ vertices, and the conjectured recurrence is then decided by a finite exact
computation.
\end{abstract}
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 21:32:04, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;18\,a(n-1) + 585\,a(n-2) - 5160\,a(n-3) - 85485\,a(n-4) + 505600\,a(n-5) + 3996404\,a(n-6) - 19237700\,a(n-7) - 89239938\,a(n-8) + 375211256\,a(n-9) + 1104726794\,a(n-10) - 4232791939\,a(n-11) - 8081655126\,a(n-12) + 29153658888\,a(n-13) + 35808212649\,a(n-14) - 125320594701\,a(n-15) - 95870415823\,a(n-16) + 336725591045\,a(n-17) + 149825017362\,a(n-18) - 554412838812\,a(n-19) - 124734888118\,a(n-20) + 531808961051\,a(n-21) + 43836491896\,a(n-22) - 268190168640\,a(n-23) - 2736660827\,a(n-24) + 57764829598\,a(n-25) + 504580148\,a(n-26) - 3286957664\,a(n-27) + 156627216\,a(n-28) + 43946272\,a(n-29) - 3289536\,a(n-30)
\end{equation}
for all $n>30$.
...
row $t$ and column $u$, each in $\{0,\dots,14\}$. With the neighbour offsets
\[
\mathcal N=\{(0,1),\ (1,0)\},
\]
...
\{x_{t,u},x_{t+d_1,u+d_2}\}\in E\ \text{ for every offset in }\mathcal N,\quad E=\{\{0,1\},\{0,2\},\{1,2\},\{1,3\},\{1,4\},\{2,4\},\{2,5\},\{3,4\},\{3,6\},\{3,7\},\{4,5\},\{4,7\},\{4,8\},\{5,8\},\{5,9\},\{6,7\},\{6,10\},\{6,11\},\{7,8\},\{7,11\},\{7,12\},\{8,9\},\{8,12\},\{8,13\},\{9,13\},\{9,14\},\{10,11\},\{11,12\},\{12,13\},\{13,14\}\}
\end{equation}
for every cell $(t,u)$.
...
Let $V=\{0,\dots,14\}^{3}$ be the possible rows and take
$\mathcal V=V\times V$, of size $S=3375$, as the vertex set. Declare $(p,c)\to(c,x)$ an edge
...
The size of $\mathcal V$ is worth seeing concretely. There are $14+1=15$ values
and $3$ cells in a row, so $|V|=15^{3}=3375$, and the vertex set is
$V\times V$, of size $3375^2=3375$. That is the whole of the state: two consecutive
...
$15$ values, so there are about $10^{52}$ of them to sift. The
walk count replaces that by $3375$ states and one matrix--vector product per row.
...
$o=1n_0+0-2$. Then for $j\ge30$,
\[
a(n_0+j)-\sum_i c_i\,a(n_0+j-i)\;=\;\,\mathbf{v}^{\!\top}G^{\,j-30}w,
...
\begin{proof}
Substitute Lemma~\ref{lem:walk} and factor $G^{j-30}$ out of
...
\begin{proof}
The digraph was built directly from \eqref{eq:loc}: for each of the $S=3375$ pairs and each
of the $(14+1)^{3}$ possible next rows, the condition was tested on every cell of
the middle row. The vector $w$ was formed by $30$ applications of $G$ in exact integer
arithmetic and $\mathbf{v}^{\!\top}G^{m}w$ evaluated for $m=0,1,\dots$, again exactly.
Every one of those integers vanishes from the index corresponding to $n=30+1$ onwards,
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223339.
