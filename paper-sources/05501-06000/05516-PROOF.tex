...
\title{The empirical recurrence for OEIS A278760, proved from an exact model}
...
\begin{abstract}
OEIS A278760 carries an empirical recurrence of order $4$ contributed by Chai Wah Wu. It is true, and it is
...
\[
1, 0, 6, 5, 0, 63, 0, 255,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Chai Wah Wu\_, Jun 14 2020: (Start) a(n) = 5*a(n-2) - 4*a(n-4) for n > 7.
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 05 2025 15:22:35, revision 13)
