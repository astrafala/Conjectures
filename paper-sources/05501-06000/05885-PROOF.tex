...
\title{The empirical recurrence for OEIS A183349, proved by transfer matrix}
...
\begin{abstract}
OEIS A183349 counts arrays of width $7$ over $\{0,1\}$ under local conditions relating each cell
...
OEIS A183349 is ``Number of nX7 binary arrays with each 1 adjacent to exactly one 0 vertically and one 0 horizontally.''. It has offset $1$ and begins
\[
1, 109, 289, 943, 5121, 21613, 88177, 387783,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 01:35:35, revision 9) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=1441.
\]
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-2) + 40\,a(n-3) + 89\,a(n-4) + 132\,a(n-5) + a(n-6) - 366\,a(n-7) - 706\,a(n-8) - 596\,a(n-9) + 129\,a(n-10) + 1289\,a(n-11) + 1758\,a(n-12) + 437\,a(n-13) - 1144\,a(n-14) - 1301\,a(n-15) - 300\,a(n-16) + 471\,a(n-17) + 437\,a(n-18) + 38\,a(n-19) - 52\,a(n-20) + 46\,a(n-21) - 84\,a(n-22) - 44\,a(n-23) - 116\,a(n-24) + 24\,a(n-25) - 24\,a(n-26) - 24\,a(n-27) - 64\,a(n-28) - 32\,a(n-29) - 16\,a(n-30)
\]
for every $n>30$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A183349.
