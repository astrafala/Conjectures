...
\title{The empirical recurrence for OEIS A250636, proved by transfer matrix}
...
\begin{abstract}
OEIS A250636 counts arrays over $\{0,1,2\}$ in which a statistic taken over short runs
...
OEIS A250636 is ``Number of (4+1)X(n+1) 0..2 arrays with nondecreasing x(i,j)+x(i,j-1) in the i direction and nondecreasing min(x(i,j),x(i-1,j)) in the j direction.''. It has offset $1$ and begins
\[
1072, 7342, 43185, 218680, 1014946, 4416061, 18465586, 74732823,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 12:37:56, revision 9) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250636.
