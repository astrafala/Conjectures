...
\title{The empirical recurrence for OEIS A183306, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A183306 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A183306 is ``Half the number of nX5 binary arrays with no element equal to a strict majority of its horizontal and vertical neighbors.''. It has offset $1$ and begins
\[
3, 9, 42, 178, 910, 4212, 19899, 94217,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 01:32:55, revision 9) the statement is
...
\[
a(n_0+j)-\sum_i c_i\,a(n_0+j-i)\;=\;\tfrac1{2}\,\mathbf{v}^{\!\top}G^{\,j-29}w,
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A183306.
