...
\title{The empirical recurrence for OEIS A235206, proved by transfer matrix}
...
\begin{abstract}
OEIS A235206 counts $3$-column arrays over $\{0,\dots,7\}$ in which every
...
OEIS A235206 is ``Number of (n+1) X (2+1) 0..7 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 5, with no adjacent elements equal (constant-stress tilted 1 X 1 tilings).''. It has offset
$1$ and begins
\[
1172, 4616, 18444, 76112, 319156, 1374400, 5998924,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 19 2022 02:22:23, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;15\,a(n-1) + 23\,a(n-2) - 1373\,a(n-3) + 3547\,a(n-4) + 50847\,a(n-5) - 236177\,a(n-6) - 957405\,a(n-7) + 6739749\,a(n-8) + 8784137\,a(n-9) - 112122375\,a(n-10) - 8734283\,a(n-11) + 1205207433\,a(n-12) - 682793243\,a(n-13) - 8845512699\,a(n-14) + 8015164257\,a(n-15) + 45997463512\,a(n-16) - 47860413548\,a(n-17) - 173398534628\,a(n-18) + 175140255652\,a(n-19) + 476432770592\,a(n-20) - 402722060848\,a(n-21) - 936013467040\,a(n-22) + 551524974720\,a(n-23) + 1245278007168\,a(n-24) - 366681768960\,a(n-25) - 999476834304\,a(n-26) + 6506053632\,a(n-27) + 362586931200\,a(n-28) + 89712230400\,a(n-29)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A235206.
