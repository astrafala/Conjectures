...
\title{The empirical recurrence for OEIS A252509, proved by transfer matrix}
...
\begin{abstract}
OEIS A252509 counts $(n+2)\times5$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252509 is ``Number of (n+2) X (3+2) 0..3 arrays with every 3 X 3 subblock row and column sum equal to 0 2 5 6 or 7 and every 3 X 3 diagonal and antidiagonal sum not equal to 0 2 5 6 or 7.''. It has offset $1$ and begins
\[
2055, 3980, 11476, 28877, 83016, 252551, 767176, 2326656,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 26 2022 20:01:24, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) - a(n-2) + 35\,a(n-3) - 93\,a(n-4) + 31\,a(n-5) - 442\,a(n-6) + 939\,a(n-7) - 313\,a(n-8) + 2607\,a(n-9) - 3585\,a(n-10) + 1195\,a(n-11) - 8743\,a(n-12) + 6714\,a(n-13) - 2238\,a(n-14) + 21413\,a(n-15) - 14283\,a(n-16) + 4761\,a(n-17) - 46814\,a(n-18) + 26640\,a(n-19) - 8880\,a(n-20) + 86138\,a(n-21) - 23769\,a(n-22) + 7923\,a(n-23) - 125344\,a(n-24) + 19671\,a(n-25) - 6557\,a(n-26) + 157146\,a(n-27) - 12624\,a(n-28) + 4208\,a(n-29) - 170762\,a(n-30) - 16695\,a(n-31) + 5565\,a(n-32) + 140413\,a(n-33) + 53586\,a(n-34) - 17862\,a(n-35) - 68838\,a(n-36) - 37272\,a(n-37) + 12424\,a(n-38) + 13448\,a(n-39) + 768\,a(n-40) - 256\,a(n-41) - 256\,a(n-42)
\]
for every $n>47$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252509.
