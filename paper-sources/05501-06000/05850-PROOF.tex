...
\title{The empirical recurrence for OEIS A253531, proved by transfer matrix}
...
\begin{abstract}
OEIS A253531 counts the arrays over $\{0,\dots,2\}$ whose $2\times2$ subblocks carry a
...
so a pair of consecutive array rows is a state, the count is a walk count on $S=85663$ of them,
...
OEIS A253531 is ``Number of (n+1)X(6+1) 0..2 arrays with every 2X2 subblock antidiagonal maximum minus diagonal minimum nondecreasing horizontally and diagonal maximum minus antidiagonal minimum nondecreasing vertically.''. It has offset $1$ and begins
\[
85663, 176266, 327147, 949158, 1744459, 4292539, 8304638, 18590483,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 14:06:30, revision 6) this is still
...
\]
on the $S=85663$ admissible pairs. In particular $a$ is $C$-finite. The alignment of the walk
...
\begin{theorem}
\[
a(n)\;=\;10\,a(n-1) - 37\,a(n-2) + 42\,a(n-3) + 106\,a(n-4) - 388\,a(n-5) + 284\,a(n-6) + 632\,a(n-7) - 1382\,a(n-8) + 364\,a(n-9) + 1690\,a(n-10) - 1924\,a(n-11) - 208\,a(n-12) + 1808\,a(n-13) - 1076\,a(n-14) - 392\,a(n-15) + 751\,a(n-16) - 262\,a(n-17) - 93\,a(n-18) + 106\,a(n-19) - 34\,a(n-20) + 4\,a(n-21)
\]
for every $n>42$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253531.
