...
\title{The empirical recurrence for OEIS A224128, proved by transfer matrix}
...
\begin{abstract}
OEIS A224128 counts arrays over $\{0,\dots,1\}$ whose rows, columns, diagonals or
...
is a walk count on $S=32$ vertices and the recurrence follows from a finite exact
computation.
\end{abstract}
...
OEIS A224128 is ``Number of n X 3 0..1 arrays with rows nondecreasing and antidiagonals unimodal.''. It has offset $1$ and begins
\[
4, 16, 58, 208, 748, 2692, 9688, 34864,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 4*a(n-1) - 2*a(n-2) + 2*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 27 2018 06:04:13, revision 10) the statement is
...
bit vector), $|\mathcal V|=S=32$; let $(r,f)\to(s,f')$ be an edge when placing $s$ after $r$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224128.
