...
\title{The empirical recurrence for OEIS A253930, proved by transfer matrix}
...
\begin{abstract}
OEIS A253930 counts the arrays over $\{0,\dots,1\}$ whose $3\times3$ subblocks carry a
...
OEIS A253930 is ``Number of (n+2)X(3+2) 0..1 arrays with every 3X3 subblock diagonal sum plus antidiagonal sum nondecreasing horizontally and vertically.''. It has offset $1$ and begins
\[
8392, 30184, 124496, 451721, 992616, 2326216, 4928792, 8796936,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 14:20:33, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253930.
