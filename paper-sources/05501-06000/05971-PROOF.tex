...
\title{The empirical recurrence for OEIS A250836, proved by transfer matrix}
...
\begin{abstract}
OEIS A250836 counts $(n+1)\times4$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A250836 is ``Number of (n+1)X(3+1) 0..2 arrays with no 2X2 subblock having a diagonal absolute difference less than its antidiagonal absolute difference.''. It has offset $1$ and begins
\[
2011, 51105, 1301955, 33244665, 849027611, 21682326473, 553718971855, 14140848207813,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 12:47:55, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;61\,a(n-1) - 1470\,a(n-2) + 19787\,a(n-3) - 170809\,a(n-4) + 991976\,a(n-5) - 3713053\,a(n-6) + 6616739\,a(n-7) + 11490609\,a(n-8) - 99464486\,a(n-9) + 205734801\,a(n-10) + 122438873\,a(n-11) - 1485943225\,a(n-12) + 3033549790\,a(n-13) - 1789266403\,a(n-14) - 3556277194\,a(n-15) + 8728569971\,a(n-16) - 8222271838\,a(n-17) + 2970903256\,a(n-18) + 1231288138\,a(n-19) - 1737010178\,a(n-20) + 565537332\,a(n-21) + 117725104\,a(n-22) - 140920256\,a(n-23) + 40160256\,a(n-24) - 4325376\,a(n-25)
\end{equation}
for all $n>24$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250836.
