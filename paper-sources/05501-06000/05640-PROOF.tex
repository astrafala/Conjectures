...
\title{The empirical recurrence for OEIS A252403, proved by transfer matrix}
...
\begin{abstract}
OEIS A252403 counts $(n+2)\times6$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
$a(n)$ is a walk count on $S=291044$ vertices. Such a sequence is $C$-finite, so whether a given
...
OEIS A252403 is ``Number of (n+2)X(4+2) 0..3 arrays with every 3X3 subblock row and diagonal sum equal to 2 3 4 6 or 7 and every 3X3 column and antidiagonal sum not equal to 2 3 4 6 or 7.''. It has offset $1$ and begins
\[
1551, 1157, 2555, 6231, 16906, 44456, 113146, 311214,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:10:56, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;43\,a(n-3) - 607\,a(n-6) + 3871\,a(n-9) - 22906\,a(n-12) + 87039\,a(n-15) - 288666\,a(n-18) + 675828\,a(n-21) - 1232028\,a(n-24) + 1513050\,a(n-27) - 509862\,a(n-30) - 839791\,a(n-33) + 309408\,a(n-36) + 328998\,a(n-39) + 118167\,a(n-42) - 74798\,a(n-45) - 58186\,a(n-48) - 7379\,a(n-51) - 1782\,a(n-54) - 508\,a(n-57) + 87\,a(n-60) + 22\,a(n-63) + a(n-66)
\]
for every $n>69$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252403.
