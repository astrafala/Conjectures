...
\title{The empirical recurrence for OEIS A297736, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297736 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
values of its neighbours, and carries an empirical recurrence of order $27$ contributed
...
OEIS A297736 is ``Number of 4Xn 0..1 arrays with every 1 horizontally, diagonally or antidiagonally adjacent to 2 or 4 neighboring 1s.''. It has offset $1$ and begins
\[
1, 4, 39, 93, 362, 1103, 4795, 15646,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 04 2018 22:20:07, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) + 4\,a(n-2) - 44\,a(n-3) + 47\,a(n-4) - 22\,a(n-5) - 102\,a(n-6) + 541\,a(n-7) - 336\,a(n-8) - 149\,a(n-9) - 491\,a(n-10) - 154\,a(n-11) + 1086\,a(n-12) - 480\,a(n-13) + 1243\,a(n-14) - 1038\,a(n-15) - 244\,a(n-16) - 259\,a(n-17) + 162\,a(n-18) + 374\,a(n-19) - 62\,a(n-20) - 44\,a(n-21) - 116\,a(n-22) + 76\,a(n-23) + 12\,a(n-24) + 24\,a(n-25) - 16\,a(n-26) - 16\,a(n-27)
\end{equation}
for all $n>28$.
...
x_{t,u}=1\ \Rightarrow\ \#\{\text{neighbours equal to }1\}\in\{2,4\}
\end{equation}
for every cell $(t,u)$.
...
publishes, $n=24$, the arrays have $4\cdot24$ cells over
$2$ values, so there are about $10^{28}$ of them to sift. The
...
$o=1n_0+0-2$. Then for $j\ge27$,
\[
a(n_0+j)-\sum_i c_i\,a(n_0+j-i)\;=\;\,\mathbf{v}^{\!\top}G^{\,j-27}w,
\qquad w=h_{27}-\sum_i c_i\,h_{27-i} .
\]
...
\begin{proof}
Substitute Lemma~\ref{lem:walk} and factor $G^{j-27}$ out of
...
\begin{theorem}
The recurrence \eqref{eq:conj} holds for every $n>28$, which is the statement of
Section~1.
\end{theorem}
...
the middle column. The vector $w$ was formed by $27$ applications of $G$ in exact integer
arithmetic and $\mathbf{v}^{\!\top}G^{m}w$ evaluated for $m=0,1,\dots$, again exactly.
Every one of those integers vanishes from the index corresponding to $n=28+1$ onwards,
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297736.
