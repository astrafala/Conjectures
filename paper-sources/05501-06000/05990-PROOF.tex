...
\title{The empirical recurrence for OEIS A252469, proved by transfer matrix}
...
\begin{abstract}
OEIS A252469 counts $(n+2)\times6$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
$a(n)$ is a walk count on $S=249273$ vertices. Such a sequence is $C$-finite, so whether a given
...
OEIS A252469 is ``Number of (n+2)X(4+2) 0..3 arrays with every 3X3 subblock row, column, diagonal and antidiagonal sum not equal to 0 3 5 6 or 8.''. It has offset $1$ and begins
\[
2380, 1463, 5367, 22832, 96543, 409090, 1741406, 7424273,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:17:07, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252469.
