...
\title{The empirical recurrence for OEIS A252635, proved by transfer matrix}
...
\begin{abstract}
OEIS A252635 counts $(n+2)\times5$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252635 is ``Number of (n+2)X(3+2) 0..3 arrays with every 3X3 subblock row and diagonal sum equal to 0 3 4 6 or 7 and every 3X3 column and antidiagonal sum not equal to 0 3 4 6 or 7.''. It has offset $1$ and begins
\[
1758, 4026, 12840, 39492, 145594, 527688, 1812508, 7013991,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:29:01, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;140\,a(n-3) - 6944\,a(n-6) + 157621\,a(n-9) - 1691268\,a(n-12) + 8267548\,a(n-15) - 25478928\,a(n-18) + 65654144\,a(n-21) - 110095616\,a(n-24) + 126170112\,a(n-27) - 143638528\,a(n-30) + 78643200\,a(n-33)
\]
for every $n>42$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252635.
