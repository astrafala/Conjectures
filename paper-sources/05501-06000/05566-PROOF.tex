...
\title{The empirical recurrence for OEIS A252417, proved by transfer matrix}
...
\begin{abstract}
OEIS A252417 counts $(n+2)\times4$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252417 is ``Number of (n+2)X(2+2) 0..3 arrays with every 3X3 subblock row and column sum not equal to 0 2 5 6 or 7 and every 3X3 diagonal and antidiagonal sum equal to 0 2 5 6 or 7.''. It has offset $1$ and begins
\[
1006, 854, 1098, 1704, 3472, 7186, 12214, 28034,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:12:33, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;23\,a(n-3) - 199\,a(n-6) + 843\,a(n-9) - 1874\,a(n-12) + 2149\,a(n-15) - 1091\,a(n-18) + 15\,a(n-21) + 197\,a(n-24) - 70\,a(n-27) + 8\,a(n-30)
\]
for every $n>37$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252417.
