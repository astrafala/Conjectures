...
\title{The empirical recurrence for OEIS A237922, proved by transfer matrix}
...
\begin{abstract}
OEIS A237922 counts arrays over $\{0,\dots,3\}$ subject to a condition on the order
...
OEIS A237922 is ``Number of (n+1)X(1+1) 0..3 arrays with the maximum plus the lower median of every 2X2 subblock differing from its horizontal and vertical neighbors by exactly one.''. It has offset $1$ and begins
\[
256, 1632, 10316, 66512, 431640, 2776536, 17920936, 115383848,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 10:35:29, revision 7) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The $2\times2$ subblocks of an $(n+1)\times2$ array form an
$n\times1$ grid, and each carries the value $\sigma=b+d$, where $a\le b\le c\le d$ are its four entries sorted --- its minimum, lower median, upper median and maximum. The entry asks that the values of
...
\begin{theorem}
\[
a(n)\;=\;1181\,a(n-4) + 22032\,a(n-6) + 73432\,a(n-8) - 1336476\,a(n-10) - 12277371\,a(n-12) - 12126056\,a(n-14) + 265052455\,a(n-16) + 1326988676\,a(n-18) + 2166031440\,a(n-20) - 838485120\,a(n-22) - 6967321344\,a(n-24) - 7539800064\,a(n-26) - 1875689472\,a(n-28) + 700055552\,a(n-30)
\]
for every $n>30$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237922.
