...
\title{The empirical recurrence for OEIS A238282, proved by transfer matrix}
...
\begin{abstract}
OEIS A238282 counts $(n+1)\times3$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A238282 is ``Number of (n+1)X(2+1) 0..3 arrays with no element greater than all horizontal neighbors or less than all vertical neighbors.''. It has offset $1$ and begins
\[
16, 204, 1844, 13948, 105862, 850420, 6953993, 56279542,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 10:49:43, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;10\,a(n-1) - 39\,a(n-2) + 185\,a(n-3) - 107\,a(n-4) + 907\,a(n-5) + 577\,a(n-6) + 1691\,a(n-7) - 223\,a(n-8) - 2043\,a(n-9) - 4899\,a(n-10) - 7123\,a(n-11) - 255\,a(n-12) + 10972\,a(n-13) + 9211\,a(n-14) - 2698\,a(n-15) - 7428\,a(n-16) - 2381\,a(n-17) + 1946\,a(n-18) + 1556\,a(n-19) + 67\,a(n-20) - 283\,a(n-21) - 88\,a(n-22) + 9\,a(n-23) + 8\,a(n-24) + a(n-25)
\]
for every $n>25$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A238282.
