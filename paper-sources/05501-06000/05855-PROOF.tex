...
\title{The empirical recurrence for OEIS A204149, proved by transfer matrix}
...
\begin{abstract}
OEIS A204149 counts $(n+2)\times6$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A204149 is ``Number of (n+2)X6 0..2 arrays with every 3X3 subblock having equal diagonal elements or equal antidiagonal elements, and new values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
127022, 891662, 4683434, 26497814, 146747822, 826613438, 4577683574, 25733247662,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 11:00:41, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + 9\,a(n-2) - 16\,a(n-3) + 162\,a(n-4) - 680\,a(n-5) + 1316\,a(n-6) + 3646\,a(n-7) - 11416\,a(n-8) - 45560\,a(n-9) + 55336\,a(n-10) - 404680\,a(n-11) - 687384\,a(n-12) + 2793136\,a(n-13) + 5954432\,a(n-14) - 7133728\,a(n-15) + 26057024\,a(n-16) + 51024800\,a(n-17) - 122086400\,a(n-18) - 7443200\,a(n-19) - 170156800\,a(n-20) - 1801072000\,a(n-21) - 482608000\,a(n-22) + 6153120000\,a(n-23) - 3596160000\,a(n-24) + 9433600000\,a(n-25) - 1420800000\,a(n-26) + 6016000000\,a(n-27) - 39680000000\,a(n-28) + 25600000000\,a(n-29)
\]
for every $n>30$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204149.
