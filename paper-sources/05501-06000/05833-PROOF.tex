...
\title{The empirical recurrence for OEIS A228215, proved by transfer matrix}
...
\begin{abstract}
OEIS A228215 carries an empirical recurrence of order $2$ contributed by R. H. Hardin. It is
...
arrays counted are exactly the walks in it; hence $a(n)$ is a walk count on $S=107$ vertices
...
OEIS A228215 is ``Number of second differences of arrays of length n+2 of numbers in 0..5.''. It has offset $1$ and begins
\[
21, 271, 2731, 23351, 176851, 1225631, 8006491, 50556551,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 11*a(n-1) -30*a(n-2) for n>11
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 26 2025 10:33:03, revision 12) this is still
...
An admissible array is then exactly a walk, and $\iota,\tau$ are the vectors recording which windows may begin and end an array, so with $M$ the adjacency matrix on $S=107$ vertices,
\[
a(n)\;=\;\iota^{\!\top}M^{\,n}\tau ,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A228215.
