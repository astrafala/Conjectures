...
\title{The empirical recurrence for OEIS A252559, proved by transfer matrix}
...
\begin{abstract}
OEIS A252559 counts $3\times(n+2)$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252559 is ``Number of (1+2)X(n+2) 0..3 arrays with every 3X3 subblock row and diagonal sum equal to 1 2 4 6 or 7 and every 3X3 column and antidiagonal sum not equal to 1 2 4 6 or 7.''. It has offset $1$ and begins
\[
771, 1107, 1510, 2443, 4284, 7755, 13917, 27182,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:22:13, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;25\,a(n-3) + 2\,a(n-4) - 239\,a(n-6) - 43\,a(n-7) - a(n-8) + 1103\,a(n-9) + 334\,a(n-10) + 17\,a(n-11) - 2670\,a(n-12) - 1108\,a(n-13) - 84\,a(n-14) + 3919\,a(n-15) + 1405\,a(n-16) + 17\,a(n-17) - 4053\,a(n-18) - 354\,a(n-19) + 805\,a(n-20) + 3346\,a(n-21) - 1100\,a(n-22) - 1994\,a(n-23) - 2345\,a(n-24) + 2032\,a(n-25) + 2624\,a(n-26) + 1431\,a(n-27) - 2128\,a(n-28) - 2602\,a(n-29) - 817\,a(n-30) + 1501\,a(n-31) + 1921\,a(n-32) + 463\,a(n-33) - 754\,a(n-34) - 1063\,a(n-35) - 216\,a(n-36) + 276\,a(n-37) + 468\,a(n-38) + 81\,a(n-39) - 63\,a(n-40) - 135\,a(n-41) - 27\,a(n-42) + 27\,a(n-44)
\]
for every $n>60$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252559.
