...
\title{The empirical recurrence for OEIS A252643, proved by transfer matrix}
...
\begin{abstract}
OEIS A252643 counts $5\times(n+2)$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
every $3\times3$ subblock, and it carries an empirical recurrence of order $60$
...
OEIS A252643 is ``Number of (3+2)X(n+2) 0..3 arrays with every 3X3 subblock row and diagonal sum equal to 0 3 4 6 or 7 and every 3X3 column and antidiagonal sum not equal to 0 3 4 6 or 7.''. It has offset $1$ and begins
\[
1189, 4226, 12840, 29463, 110665, 355574, 840655, 3260707,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:29:49, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;128\,a(n-3) - 6795\,a(n-6) + 197027\,a(n-9) - 3485715\,a(n-12) + 40112291\,a(n-15) - 314079654\,a(n-18) + 1729862009\,a(n-21) - 6873668781\,a(n-24) + 20116182638\,a(n-27) - 44166333047\,a(n-30) + 73953140517\,a(n-33) - 95420813777\,a(n-36) + 94546651863\,a(n-39) - 70315286432\,a(n-42) + 37717184263\,a(n-45) - 13857738438\,a(n-48) + 3270640464\,a(n-51) - 453515360\,a(n-54) + 31724800\,a(n-57) - 768000\,a(n-60)
\]
for every $n>63$.
\end{theorem}

\begin{proof}
The vector $w=q(M)\mathbf{1}$ was formed by $60$ matrix--vector products in exact
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252643.
