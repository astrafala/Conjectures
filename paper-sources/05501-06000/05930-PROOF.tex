...
\title{The empirical recurrence for OEIS A275129, proved by counting patterns}
...
\begin{abstract}
OEIS A275129 counts arrays in which no entry may repeat a value found at any of three stated
...
cutting $535538$ pairs to $S=90623$ states. The entry's empirical recurrence of order $67$,
...
OEIS A275129 is ``Number of n X 6 0..2 arrays with no element equal to any value at offset (-2,-2) (-1,0) or (-1,1) and new values introduced in order 0..2.''. It has offset $1$ and begins
\[
122, 1024, 2607, 11092, 71576, 473185, 3146574, 20970214,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical recurrence of order 67 (see link above).

Empirical: a(n) = 13*a(n-1) - 77*a(n-2) + 343*a(n-3) - 875*a(n-4) + 224*a(n-5) + 8271*a(n-6) - 29598*a(n-7) + 23571*a(n-8) + 66361*a(n-9) - 403892*a(n-10) + 279819*a(n-11) + 737771*a(n-12) - 3395712*a(n-13) - 3576643*a(n-14) + 933124*a(n-15) - 1904223*a(n-16) - 4349679*a(n-17) + 22926582*a(n-18) + 82646896*a(n-19) + 80289194*a(n-20) + 174962993*a(n-21) + 548644174*a(n-22) + 620592447*a(n-23) + 190013427*a(n-24) - 228430131*a(n-25) - 901110930*a(n-26) - 2409571494*a(n-27) - 3602138861*a(n-28) - 3349313115*a(n-29) - 3392511479*a(n-30) - 3158132495*a(n-31) - 1510148972*a(n-32) - 573808014*a(n-33) - 110024099*a(n-34) + 342562885*a(n-35) + 553102861*a(n-36) + 589613607*a(n-37) + 563907422*a(n-38) + 751308108*a(n-39) + 707335056*a(n-40) + 328505118*a(n-41) - 75133170*a(n-42) - 185378309*a(n-43) - 232963484*a(n-44) - 154887049*a(n-45) - 27116794*a(n-46) + 36390253*a(n-47) + 46560863*a(n-48) + 32143587*a(n-49) + 12461763*a(n-50) - 463494*a(n-51) - 6907265*a(n-52) - 3371315*a(n-53) - 1373073*a(n-54) - 126609*a(n-55) + 255526*a(n-56) + 203146*a(n-57) + 54007*a(n-58) - 14652*a(n-59) + 16639*a(n-60) - 12595*a(n-61) - 274*a(n-62) + 82*a(n-63) + 226*a(n-64) - 139*a(n-65) + 76*a(n-66) - 12*a(n-67) for n>70
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 12 2026 15:56:49, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;13\,a(n-1) - 77\,a(n-2) + 343\,a(n-3) - 875\,a(n-4) + 224\,a(n-5) + 8271\,a(n-6) - 29598\,a(n-7) + 23571\,a(n-8) + 66361\,a(n-9) - 403892\,a(n-10) + 279819\,a(n-11) + 737771\,a(n-12) - 3395712\,a(n-13) - 3576643\,a(n-14) + 933124\,a(n-15) - 1904223\,a(n-16) - 4349679\,a(n-17) + 22926582\,a(n-18) + 82646896\,a(n-19) + 80289194\,a(n-20) + 174962993\,a(n-21) + 548644174\,a(n-22) + 620592447\,a(n-23) + 190013427\,a(n-24) - 228430131\,a(n-25) - 901110930\,a(n-26) - 2409571494\,a(n-27) - 3602138861\,a(n-28) - 3349313115\,a(n-29) - 3392511479\,a(n-30) - 3158132495\,a(n-31) - 1510148972\,a(n-32) - 573808014\,a(n-33) - 110024099\,a(n-34) + 342562885\,a(n-35) + 553102861\,a(n-36) + 589613607\,a(n-37) + 563907422\,a(n-38) + 751308108\,a(n-39) + 707335056\,a(n-40) + 328505118\,a(n-41) - 75133170\,a(n-42) - 185378309\,a(n-43) - 232963484\,a(n-44) - 154887049\,a(n-45) - 27116794\,a(n-46) + 36390253\,a(n-47) + 46560863\,a(n-48) + 32143587\,a(n-49) + 12461763\,a(n-50) - 463494\,a(n-51) - 6907265\,a(n-52) - 3371315\,a(n-53) - 1373073\,a(n-54) - 126609\,a(n-55) + 255526\,a(n-56) + 203146\,a(n-57) + 54007\,a(n-58) - 14652\,a(n-59) + 16639\,a(n-60) - 12595\,a(n-61) - 274\,a(n-62) + 82\,a(n-63) + 226\,a(n-64) - 139\,a(n-65) + 76\,a(n-66) - 12\,a(n-67)
\end{equation}
for all $n>70$.
...
$o=1n_0+0-2$, we have for $j\ge67$
\[
3!\Bigl(a(n_0+j)-\sum_i c_i\,a(n_0+j-i)\Bigr)
=\mathbf{v}^{\!\top}G^{\,j-67}w,\qquad
w=h_{67}-\sum_i c_i h_{67-i} .
\]
...
the survivors by the pattern of the new pair. The vector $w$ was formed by $67$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A275129.
