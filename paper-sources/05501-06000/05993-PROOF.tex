...
\title{The empirical recurrence for OEIS A280120, proved by transfer matrix}
...
\begin{abstract}
OEIS A280120 counts $n\times4$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A280120 is ``Number of nX4 0..2 arrays with no element unequal to a strict majority of its horizontal, vertical and antidiagonal neighbors, with the exception of exactly one element, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
2, 28, 168, 1030, 5802, 31608, 171100, 916768,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 26 2016 07:54:50, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) + 25\,a(n-2) - 148\,a(n-3) - 307\,a(n-4) + 1228\,a(n-5) + 2475\,a(n-6) - 3210\,a(n-7) - 14762\,a(n-8) - 9146\,a(n-9) + 59251\,a(n-10) + 78496\,a(n-11) - 107489\,a(n-12) - 241242\,a(n-13) - 88943\,a(n-14) + 526534\,a(n-15) + 556734\,a(n-16) - 621460\,a(n-17) - 529201\,a(n-18) - 198256\,a(n-19) - 192232\,a(n-20) + 1078880\,a(n-21) + 376432\,a(n-22) - 508032\,a(n-23) + 30976\,a(n-24) - 331776\,a(n-25) - 28672\,a(n-26) + 229376\,a(n-27) - 65536\,a(n-28)
\]
for every $n>34$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A280120.
