...
\title{The empirical recurrence for OEIS A193641, proved by transfer matrix}
...
\begin{abstract}
OEIS A193641 carries an empirical recurrence of order $3$ contributed by R. H. Hardin. It is
...
OEIS A193641 is ``Number of arrays of -1..1 integers x(1..n) with every x(i) in a subsequence of length 1 or 2 with sum zero.''. It has offset $1$ and begins
\[
1, 3, 7, 15, 33, 73, 161, 355,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 03 2024 11:16:35, revision 43) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A193641.
