...
\title{The empirical recurrence for OEIS A223948, proved by transfer matrix}
...
\begin{abstract}
OEIS A223948 counts arrays over $\{0,\dots,1\}$ whose rows, columns, diagonals or
antidiagonals are required to be monotone or unimodal, and carries an empirical recurrence of
order $33$ contributed by R.~H.~Hardin. A monotone condition is local, but a unimodal one
...
is a walk count on $S=131072$ vertices and the recurrence follows from a finite exact
computation.
\end{abstract}
...
OEIS A223948 is ``Number of n X 7 0..1 arrays with diagonals and antidiagonals unimodal and rows nondecreasing.''. It has offset $1$ and begins
\[
8, 64, 352, 1479, 5233, 16845, 52532, 166076,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 28 2022 03:43:13, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;8\,a(n-1) - 20\,a(n-2) + 11\,a(n-3) + 23\,a(n-4) - 32\,a(n-5) + 18\,a(n-6) - 37\,a(n-7) + 65\,a(n-8) - 257\,a(n-9) - 274\,a(n-10) - 1437\,a(n-11) + 3612\,a(n-12) + 1576\,a(n-13) + 6921\,a(n-14) + 449\,a(n-15) + 4935\,a(n-16) + 22314\,a(n-17) + 7279\,a(n-18) - 8809\,a(n-19) - 58688\,a(n-20) - 81734\,a(n-21) - 86761\,a(n-22) - 2940\,a(n-23) - 21650\,a(n-24) + 16326\,a(n-25) + 13737\,a(n-26) + 26159\,a(n-27) + 10634\,a(n-28) + 2502\,a(n-29) - 384\,a(n-30) - 24\,a(n-31) - 80\,a(n-32) - 16\,a(n-33)
\end{equation}
for all $n>33$.
...
bit vector), $|\mathcal V|=S=131072$; let $(r,f)\to(s,f')$ be an edge when placing $s$ after $r$
...
$h_j=G^{j}N^{o}\mathbf{1}$, we have for $j\ge33$
\[
a(n_0+j)-\sum_i c_i\,a(n_0+j-i)=\,\mathbf{v}^{\!\top}G^{\,j-33}w,
\qquad w=h_{33}-\sum_i c_ih_{33-i} .
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223948.
