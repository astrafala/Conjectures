...
\begin{abstract}
OEIS A290661 carries an empirical recurrence of order $3$ contributed by Chai Wah Wu. It is true, and it is
...
\begin{quote}
Conjectures from \_Chai Wah Wu\_, Aug 03 2020: (Start) a(n) = a(n-1) + 100*a(n-2) - 100*a(n-3) for n > 3.
\end{quote}
