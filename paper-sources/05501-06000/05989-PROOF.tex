...
\title{The empirical recurrence for OEIS A231766, proved by transfer matrix}
...
\begin{abstract}
OEIS A231766 counts $3\times(n+1)$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A231766 is ``Number of (2+1)X(n+1) 0..1 arrays with no element having a strict majority of its horizontal, diagonal and antidiagonal neighbors equal to one.''. It has offset $1$ and begins
\[
16, 136, 625, 2976, 15625, 84817, 440896, 2280000,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 06:41:23, revision 6) this is still
...
the condition
\[
\text{no cell has a strict majority of its horizontal, diagonal and antidiagonal neighbours equal to 1},
\]
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + 25\,a(n-3) + 92\,a(n-4) - 199\,a(n-5) - 51\,a(n-6) - 940\,a(n-7) - 2001\,a(n-8) + 1652\,a(n-9) - 54\,a(n-10) + 6797\,a(n-11) + 11789\,a(n-12) - 5313\,a(n-13) + 1302\,a(n-14) - 17859\,a(n-15) - 25925\,a(n-16) + 7454\,a(n-17) - 951\,a(n-18) + 18218\,a(n-19) + 22763\,a(n-20) - 3531\,a(n-21) + 270\,a(n-22) - 7326\,a(n-23) - 8414\,a(n-24) + 641\,a(n-25) - 33\,a(n-26) + 1169\,a(n-27) + 1281\,a(n-28) - 43\,a(n-29) + 3\,a(n-30) - 67\,a(n-31) - 71\,a(n-32) + a(n-33) + a(n-35) + a(n-36)
\]
for every $n>36$.
\end{theorem}
...
integers vanish from the index corresponding to $n=36+1$ onwards, and the run was
continued until the working vector was identically zero, which settles all larger $j$ at once.
By Lemma~\ref{lem:crit} the recurrence holds for every $n>36$.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231766.
