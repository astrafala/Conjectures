...
\title{The empirical recurrence for OEIS A203340, proved by transfer matrix}
...
\begin{abstract}
OEIS A203340 counts $n\times2$ arrays over $\{0,\dots,4\}$ subject to a condition imposed on
...
walk, and $a(n)$ is a walk count on $S=170$ vertices, which is $C$-finite. Whether the
...
OEIS A203340 is ``Number of nX2 0..4 arrays with every nonzero element less than or equal to at least two horizontal and vertical neighbors.''. It has offset $1$ and begins
\[
1, 5, 25, 95, 425, 2329, 12487, 64444,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 10:20:44, revision 9) this is still
...
$\{0,\dots,4\}^{2}$. The neighbourhood of a cell in row $u_i$ meets $u_{i-1}$,
$u_i$ and $u_{i+1}$ and nothing else. Take as vertices the pairs
$(r,s)\in(\{0,\dots,4\}^{2}\cup\{\varnothing\})\times\{0,\dots,4\}^{2}$,
...
\begin{theorem}
\[
a(n)\;=\;15\,a(n-1) - 95\,a(n-2) + 395\,a(n-3) - 1350\,a(n-4) + 3559\,a(n-5) - 7390\,a(n-6) + 14135\,a(n-7) - 21343\,a(n-8) + 28527\,a(n-9) - 37915\,a(n-10) + 30518\,a(n-11) - 42342\,a(n-12) + 18988\,a(n-13) - 23243\,a(n-14) + 15396\,a(n-15) + 7860\,a(n-16) + 22676\,a(n-17) + 24262\,a(n-18) + 22720\,a(n-19) + 19127\,a(n-20) + 12868\,a(n-21) + 7964\,a(n-22) + 4145\,a(n-23) + 1861\,a(n-24) + 726\,a(n-25) + 227\,a(n-26) + 58\,a(n-27) + 11\,a(n-28) + a(n-29)
\]
for every $n>29$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A203340.
