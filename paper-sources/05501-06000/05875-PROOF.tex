...
\title{The empirical recurrence for OEIS A300430, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A300430 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A300430 is ``Number of nX3 0..1 arrays with every element equal to 1, 2 or 4 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
1, 6, 13, 33, 87, 228, 611, 1656,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 05 2018 14:48:16, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;7\,a(n-1) - 19\,a(n-2) + 26\,a(n-3) - 20\,a(n-4) + 16\,a(n-5) - 21\,a(n-6) + 14\,a(n-7) - 6\,a(n-8) + 7\,a(n-9) - 25\,a(n-10) + 42\,a(n-11) + 42\,a(n-12) - 29\,a(n-13) - 71\,a(n-14) - 56\,a(n-15) - 15\,a(n-16) + 28\,a(n-17) + 78\,a(n-18) + 86\,a(n-19) + 54\,a(n-20) - 7\,a(n-21) - 26\,a(n-22) - 14\,a(n-23) - 5\,a(n-24) - 13\,a(n-25) - 11\,a(n-26) + 6\,a(n-28) + 4\,a(n-29) - a(n-31)
\end{equation}
for all $n>32$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A300430.
