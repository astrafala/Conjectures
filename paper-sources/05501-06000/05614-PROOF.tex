...
\title{The empirical recurrence for OEIS A255086, proved by transfer matrix}
...
\begin{abstract}
OEIS A255086 counts $(n+2)\times5$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
every $3\times3$ subblock, and it carries an empirical recurrence of order $34$
...
OEIS A255086 is ``Number of (n+2)X(3+2) 0..1 arrays with no 3x3 subblock diagonal sum 1 and no antidiagonal sum 2 and no row sum 0 and no column sum 0.''. It has offset $1$ and begins
\[
623, 964, 1824, 3696, 8631, 20972, 50587, 121381,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:36:58, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 7\,a(n-3) - 17\,a(n-4) + 9\,a(n-5) + 109\,a(n-6) - 137\,a(n-7) - 63\,a(n-8) - 799\,a(n-9) + 1061\,a(n-10) + 477\,a(n-11) - 2311\,a(n-12) + 1787\,a(n-13) + 718\,a(n-14) + 13283\,a(n-15) - 14431\,a(n-16) - 6966\,a(n-17) + 10362\,a(n-18) - 3426\,a(n-19) - 2288\,a(n-20) - 22562\,a(n-21) + 25618\,a(n-22) + 22752\,a(n-23) - 27356\,a(n-24) + 4456\,a(n-25) + 2308\,a(n-26) + 32364\,a(n-27) - 34920\,a(n-28) - 23400\,a(n-29) + 23040\,a(n-30) + 324\,a(n-31) + 2916\,a(n-33) - 2916\,a(n-34)
\]
for every $n>39$.
\end{theorem}

\begin{proof}
The vector $w=q(M)\mathbf{1}$ was formed by $34$ matrix--vector products in exact
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A255086.
