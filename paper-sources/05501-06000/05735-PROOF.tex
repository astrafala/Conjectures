...
\title{The empirical closed form for OEIS A187510, proved}
...
\begin{abstract}
OEIS A187510 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A187510 is ``Number of 5-step S, E, and NW-moving king's tours on an n X n board summed over all starting positions.''. It has offset $1$ and begins
\[
0, 0, 40, 184, 435, 788, 1243, 1800,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 51*n\^{}2 - 208*n + 200 for n>3.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 23 2025 00:01:44, revision 16) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;51 n^{2} - 208 n + 200.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A187510.
