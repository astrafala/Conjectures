...
\title{The empirical recurrence for OEIS A269272, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A269272 counts arrays over $\{0,\dots,3\}$ subject to a condition on the array as a
...
OEIS A269272 is ``Number of n X 4 0..3 arrays with some element plus some horizontally or antidiagonally adjacent neighbor totalling three exactly once.''. It has offset $1$ and begins
\[
108, 13896, 1104264, 74853576, 4684312584, 279339197256, 16128206816904, 909870855444936,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 98*a(n-1) - 2401*a(n-2) for n > 3.
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 20 2019 23:18:13, revision 10) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269272.
