...
\title{The empirical recurrence for OEIS A238924, proved by transfer matrix}
...
\begin{abstract}
OEIS A238924 counts $(n+1)\times3$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
every CELL over a neighbour set the entry names, and it carries an empirical recurrence of
order $29$ contributed by R.~H.~Hardin. It is true, and it is decidable rather than
...
OEIS A238924 is ``Number of (n+1)X(2+1) 0..3 arrays with no element greater than all horizontal neighbors or equal to all vertical neighbors.''. It has offset $1$ and begins
\[
116, 864, 13456, 176224, 2391340, 32225410, 434883190, 5866480970,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 10:55:59, revision 6) this is still
...
the condition
\[
\text{no cell is greater than all its horizontal neighbours or equal to all its vertical neighbours},
\]
...
\begin{theorem}
\[
a(n)\;=\;-a(n-1) + 65\,a(n-2) + 1098\,a(n-3) + 6738\,a(n-4) + 26484\,a(n-5) + 45809\,a(n-6) - 10891\,a(n-7) - 263008\,a(n-8) - 387302\,a(n-9) + 562267\,a(n-10) + 230623\,a(n-11) + 750744\,a(n-12) - 1386458\,a(n-13) - 137951\,a(n-14) + 2418439\,a(n-15) - 3558590\,a(n-16) + 4571814\,a(n-17) - 8784507\,a(n-18) + 12140213\,a(n-19) - 12163114\,a(n-20) + 11817304\,a(n-21) - 12288249\,a(n-22) + 11895067\,a(n-23) - 8961637\,a(n-24) + 5972681\,a(n-25) - 4308120\,a(n-26) + 2902293\,a(n-27) - 1401870\,a(n-28) + 315180\,a(n-29)
\]
for every $n>29$.
\end{theorem}
...
integers vanish from the index corresponding to $n=29+1$ onwards, and the run was
continued until the working vector was identically zero, which settles all larger $j$ at once.
By Lemma~\ref{lem:crit} the recurrence holds for every $n>29$.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A238924.
