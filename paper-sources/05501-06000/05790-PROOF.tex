...
\title{The empirical recurrence for OEIS A228259, proved by transfer matrix}
...
\begin{abstract}
OEIS A228259 carries an empirical recurrence of order $2$ contributed by R. H. Hardin. It is
...
arrays counted are exactly the walks in it; hence $a(n)$ is a walk count on $S=8747$ vertices
...
OEIS A228259 is ``Number of third differences of arrays of length n+3 of numbers in 0..7.''. It has offset $1$ and begins
\[
57, 1723, 36471, 596591, 7795501, 83538705, 761638071, 6537612649,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 15*a(n-1) -56*a(n-2) for n>14
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 04 2025 00:01:34, revision 8) this is still
...
An admissible array is then exactly a walk, and $\iota,\tau$ are the vectors recording which windows may begin and end an array, so with $M$ the adjacency matrix on $S=8747$ vertices,
\[
a(n)\;=\;\iota^{\!\top}M^{\,n}\tau ,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A228259.
