...
\title{The empirical recurrence for OEIS A252401, proved by transfer matrix}
...
\begin{abstract}
OEIS A252401 counts $(n+2)\times4$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252401 is ``Number of (n+2) X (2+2) 0..3 arrays with every 3 X 3 subblock row and diagonal sum equal to 2 3 4 6 or 7 and every 3 X 3 column and antidiagonal sum not equal to 2 3 4 6 or 7.''. It has offset $1$ and begins
\[
661, 442, 688, 1224, 2414, 5061, 10129, 21427,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 07 2022 13:59:47, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;16\,a(n-3) - 74\,a(n-6) + 141\,a(n-9) - 235\,a(n-12) + 206\,a(n-15) - 72\,a(n-18) + 16\,a(n-21) + 4\,a(n-24) - a(n-27)
\]
for every $n>31$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252401.
