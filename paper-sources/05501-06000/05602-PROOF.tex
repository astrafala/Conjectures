...
\title{The empirical recurrence for OEIS A223271, proved by transfer matrix}
...
\begin{abstract}
OEIS A223271 counts the ways of writing the vertices of a fixed graph $G$ into an array of width
...
single slice is a state and the count is a walk count on a finite digraph with $S=177$ vertices.
\end{abstract}
...
OEIS A223271 is ``Rolling cube footprints: number of 3 X n 0..5 arrays starting with 0 where 0..5 label faces of a cube and every array movement to a horizontal, diagonal or antidiagonal neighbor moves across a corresponding cube edge.''. It has offset $1$ and begins
\[
36, 576, 20992, 622592, 19726336, 611319808, 19084083200, 594316099584,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 24*a(n-1) + 256*a(n-2) - 1024*a(n-3) for n>4.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 18 2018 08:42:52, revision 7) this is still
...
of length $3$ over $6$ vertices is one of $6^{3}$ words, but only $S-1$ of them are
...
\begin{theorem}
\[
a(n)\;=\;24\,a(n-1) + 256\,a(n-2) - 1024\,a(n-3)
\]
for every $n>4$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223271.
