...
\title{The empirical recurrence for OEIS A207497, proved by transfer matrix}
...
\begin{abstract}
OEIS A207497 counts arrays over $\{0,\dots,1\}$ of width $5$ that avoid the patterns
$(0,0,0), (0,1,1)$ along one axis and $(0,0,1), (1,0,0)$ along the other, and carries an empirical recurrence of
order $34$ contributed by R.~H.~Hardin. It is true. The patterns have length $3$, so
...
$\mathbf{1}^{\!\top}P^{\,n-2-34}q(P)\mathbf{1}$, which vanishes identically
...
OEIS A207497 is ``Number of nX5 0..1 arrays avoiding 0 0 0 and 0 1 1 horizontally and 0 0 1 and 1 0 0 vertically.''. It has offset
$1$ and begins
\[
13, 169, 699, 2942, 14253, 68745, 343310,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 13:59:17, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;13\,a(n-1) - 17\,a(n-2) - 407\,a(n-3) + 1361\,a(n-4) + 5048\,a(n-5) - 24757\,a(n-6) - 30088\,a(n-7) + 231328\,a(n-8) + 66085\,a(n-9) - 1314702\,a(n-10) + 224399\,a(n-11) + 4884111\,a(n-12) - 2047901\,a(n-13) - 12326395\,a(n-14) + 6862627\,a(n-15) + 21620699\,a(n-16) - 13538690\,a(n-17) - 26727847\,a(n-18) + 17354874\,a(n-19) + 23481642\,a(n-20) - 14973565\,a(n-21) - 14711868\,a(n-22) + 8790663\,a(n-23) + 6559254\,a(n-24) - 3492706\,a(n-25) - 2059830\,a(n-26) + 917580\,a(n-27) + 444862\,a(n-28) - 151484\,a(n-29) - 62872\,a(n-30) + 14112\,a(n-31) + 5224\,a(n-32) - 560\,a(n-33) - 192\,a(n-34)
\end{equation}
for all $n>35$. 
...
$a(n)-\sum_i c_i a(n-i)=u_{\,n-2-34}$ whenever $n-34\ge2$. Hence
\eqref{eq:conj} holds for every $n>t$ exactly when $u_j=0$ for every
$j>t-2-34$. Moreover $(u_j)$ satisfies the monic linear recurrence whose
...
$P^{\,n-2-34}$ gives the identity. The equivalence follows by letting the exponent
...
\begin{proof}
The vector $q(P)\mathbf{1}\in\mathbb{Z}^{S}$ was formed by $34$ matrix--vector
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207497.
