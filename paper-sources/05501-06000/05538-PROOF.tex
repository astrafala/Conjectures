...
\title{The empirical recurrence for OEIS A279962, proved from an exact model}
...
\begin{abstract}
OEIS A279962 carries an empirical recurrence of order $4$ contributed by Colin Barker. It is true, and it is
...
OEIS A279962 is ``Decimal representation of the x-axis, from the origin to the right edge, of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 221", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 1, 2, 3, 28, 15, 112, 63,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Dec 24 2016: (Start) a(n) = 5*a(n-2) - 4*a(n-4) for n>6.
\end{quote}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A279962.
