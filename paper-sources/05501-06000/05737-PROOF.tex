...
\title{The empirical recurrence for OEIS A254900, proved by transfer matrix}
...
\begin{abstract}
OEIS A254900 counts the arrays over $\{0,\dots,1\}$ whose $3\times3$ subblocks carry a
...
so the count is a walk count on $S=208$ states --- the last two array rows together with the
...
OEIS A254900 is ``Number of (n+2) X (1+2) 0..1 arrays with every 3 X 3 subblock sum of the two sums of the diagonal and antidiagonal minus the two minimums of the central column and central row nondecreasing horizontally, vertically and ne-to-sw antidiagonally.''. It has offset $1$ and begins
\[
512, 2423, 7579, 22901, 72249, 219706, 616608, 1656147,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 09 2023 08:14:18, revision 6) this is still
...
\]
on the $S=208$ reachable states. In particular $a$ is $C$-finite. The alignment of the walk
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-1) - 17\,a(n-2) + 17\,a(n-3) + a(n-4) - 50\,a(n-5) + 65\,a(n-6) + 89\,a(n-7) - 180\,a(n-8) + 167\,a(n-9) + 282\,a(n-10) - 1618\,a(n-11) + 638\,a(n-12) + 1824\,a(n-13) - 5732\,a(n-14) + 14128\,a(n-15) - 14024\,a(n-16) + 19140\,a(n-17) - 28304\,a(n-18) + 24392\,a(n-19) - 30824\,a(n-20) - 7456\,a(n-21) + 46368\,a(n-22) - 51936\,a(n-23) + 69856\,a(n-24) - 70176\,a(n-25) + 230336\,a(n-26) - 527488\,a(n-27) + 862080\,a(n-28) - 1031040\,a(n-29) + 885248\,a(n-30) - 749824\,a(n-31) + 744960\,a(n-32) - 1154048\,a(n-33) + 1763328\,a(n-34) - 1860608\,a(n-35) + 1447936\,a(n-36) - 688128\,a(n-37) + 45056\,a(n-38) - 90112\,a(n-39) + 385024\,a(n-40) - 655360\,a(n-41) + 655360\,a(n-42) - 163840\,a(n-43) - 65536\,a(n-44)
\]
for every $n>50$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A254900.
