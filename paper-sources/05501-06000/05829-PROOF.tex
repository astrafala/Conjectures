...
\title{The empirical recurrence for OEIS A234706, proved by transfer matrix}
...
\begin{abstract}
OEIS A234706 counts $3$-column arrays over $\{0,\dots,7\}$ in which every
...
OEIS A234706 is ``Number of (n+1) X (2+1) 0..7 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 6 (constant-stress 1 X 1 tilings).''. It has offset
$1$ and begins
\[
1730, 7154, 28170, 127586, 546362, 2630882, 11903466,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 20 2022 19:25:40, revision 6) the statement is
...
a(n)\;=\;12\,a(n-1) + 159\,a(n-2) - 2412\,a(n-3) - 9452\,a(n-4) + 217248\,a(n-5) + 161262\,a(n-6) - 11578680\,a(n-7) + 10718427\,a(n-8) + 405901116\,a(n-9) - 824307633\,a(n-10) - 9828766476\,a(n-11) + 28650887914\,a(n-12) + 167599827384\,a(n-13) - 632763934044\,a(n-14) - 2003077953360\,a(n-15) + 9664372451624\,a(n-16) + 16138030431072\,a(n-17) - 105143721192576\,a(n-18) - 76625123046912\,a(n-19) + 819575849887488\,a(n-20) + 75093856109568\,a(n-21) - 4528143100320768\,a(n-22) + 1633754973450240\,a(n-23) + 17236678723430400\,a(n-24) - 11938042414080000\,a(n-25) - 42782336704512000\,a(n-26) + 40275310510080000\,a(n-27) + 62010467205120000\,a(n-28) - 70124998164480000\,a(n-29) - 39609913835520000\,a(n-30) + 50565847449600000\,a(n-31)
\end{equation}
for all $n>31$, which is every $n$ at which a recurrence of order $31$ can be
stated.
...
$j=0,1,\dots$. They vanish from $j=31-31+1$ onwards, and the run was continued past
$S$ consecutive zeros, which by Lemma~\ref{lem:crit} settles every larger $j$. Hence the
recurrence holds for every $n>31$.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234706.
