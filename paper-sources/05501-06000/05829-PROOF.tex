...
\title{The empirical recurrence for OEIS A258519, proved by transfer matrix}
...
\begin{abstract}
OEIS A258519 counts the arrays over $\{0,\dots,1\}$ whose $3\times3$ subblocks carry a
...
so the count is a walk count on $S=256$ states --- the last two array rows together with the
...
OEIS A258519 is ``Number of (n+2)X(1+2) 0..1 arrays with every 3X3 subblock sum of the two sums of the diagonal and antidiagonal minus the two sums of the central column and central row nondecreasing horizontally and vertically.''. It has offset $1$ and begins
\[
512, 2371, 6516, 16196, 47704, 156873, 488240, 1356489,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 15:26:01, revision 6) this is still
...
\]
on the $S=256$ reachable states. In particular $a$ is $C$-finite. The alignment of the walk
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-1) - 26\,a(n-2) + 44\,a(n-3) - 23\,a(n-4) - 56\,a(n-5) - 7\,a(n-6) + 480\,a(n-7) - 973\,a(n-8) + 412\,a(n-9) + 1761\,a(n-10) - 2196\,a(n-11) - 3393\,a(n-12) + 8720\,a(n-13) - 2593\,a(n-14) - 16840\,a(n-15) + 23470\,a(n-16) + 11156\,a(n-17) - 39087\,a(n-18) + 6704\,a(n-19) + 66632\,a(n-20) - 91824\,a(n-21) - 12160\,a(n-22) + 88000\,a(n-23) - 10048\,a(n-24) - 99584\,a(n-25) + 126720\,a(n-26) - 9216\,a(n-27) - 78848\,a(n-28) + 16384\,a(n-29) + 16384\,a(n-30)
\]
for every $n>34$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A258519.
