...
\title{The empirical recurrence for OEIS A198180, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A198180 counts arrays over $\{0,\dots,4\}$ in which every cell is constrained by the
...
OEIS A198180 is ``Number of nX3 0..4 arrays with each element x equal to the number its horizontal and vertical neighbors equal to 0,2,1,0,0 for x=0,1,2,3,4.''. It has offset $1$ and begins
\[
1, 3, 9, 25, 77, 148, 395, 866,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 07:48:41, revision 9) the statement is
...
\#\{\text{neighbours with value }f(x_{t,u})\}=x_{t,u},\quad f=(0,2,1,0,0)
\end{equation}
for every cell $(t,u)$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A198180.
