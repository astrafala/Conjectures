...
\title{The empirical recurrence for OEIS A239812, proved by transfer matrix}
...
\begin{abstract}
OEIS A239812 counts arrays over $\{0,1,2,3\}$ in which no entry may equal, modulo $4$, a given
...
OEIS A239812 is ``Number of n X 1 0..3 arrays with no element equal to zero plus the sum of elements to its left or one plus the sum of elements above it, modulo 4.''. It has offset $1$ and begins
\[
2, 5, 11, 25, 57, 129, 293, 665,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + 2*a(n-2) + 2*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 21 2018 09:42:15, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A239812.
