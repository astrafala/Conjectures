...
\title{The empirical recurrence for OEIS A290835, proved from an exact model}
...
\begin{abstract}
OEIS A290835 carries an empirical recurrence of order $2$ contributed by Colin Barker. It is true, and it is
...
OEIS A290835 is ``Binary representation of the diagonal from the origin to the corner of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 969", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 1, 101, 1111, 111, 111111, 1111111, 11111111,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Aug 12 2017: (Start) a(n) = 11*a(n-1) - 10*a(n-2) for n>6.
\end{quote}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A290835.
