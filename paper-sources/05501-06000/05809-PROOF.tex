...
\title{The empirical recurrence for OEIS A231694, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A231694 counts arrays over $\{0,\dots,3\}$ in which every cell is constrained by the
...
OEIS A231694 is ``Number of nX2 0..3 arrays with no element less than a strict majority of its horizontal, vertical and antidiagonal neighbors.''. It has offset $1$ and begins
\[
4, 28, 272, 1998, 13260, 94996, 691229, 4926082,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 06:37:30, revision 7) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;16\,a(n-1) - 100\,a(n-2) + 414\,a(n-3) - 1560\,a(n-4) + 4300\,a(n-5) - 7915\,a(n-6) + 14336\,a(n-7) - 26218\,a(n-8) + 36856\,a(n-9) - 47376\,a(n-10) + 63903\,a(n-11) - 72545\,a(n-12) + 70297\,a(n-13) - 69546\,a(n-14) + 62746\,a(n-15) - 45905\,a(n-16) + 31530\,a(n-17) - 23245\,a(n-18) + 11184\,a(n-19) - 5796\,a(n-20) + 2196\,a(n-21) - 1296\,a(n-22)
\end{equation}
for all $n>23$.
...
Let $V=\{0,\dots,3\}^{2}$ be the possible rows and take
...
publishes, $n=20$, the arrays have $2\cdot20$ cells over
$4$ values, so there are about $10^{24}$ of them to sift. The
...
of the $(3+1)^{2}$ possible next rows, the condition was tested on every cell of
the middle row. The vector $w$ was formed by $22$ applications of $G$ in exact integer
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231694.
