...
\title{The empirical recurrence for OEIS A246888, proved by transfer matrix}
...
\begin{abstract}
OEIS A246888 carries an empirical recurrence of order $31$ contributed by R.~H.~Hardin. It is
...
OEIS A246888 is ``Number of length n+4 0..4 arrays with some pair in every consecutive five terms totalling exactly 4.''. It has offset $1$ and begins
\[
2701, 12481, 57585, 264981, 1216081, 5592169, 25710385, 118192273,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 10:14:25, revision 6) this is still
...
admissible array is then exactly a walk, so with $M$ the adjacency matrix on $S=625$ vertices
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A246888.
