...
\title{The empirical recurrence for OEIS A280671, proved by transfer matrix}
...
\begin{abstract}
OEIS A280671 counts $n\times6$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A280671 is ``Number of nX6 0..2 arrays with no element equal to more than one of its horizontal and antidiagonal neighbors and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
82, 10893, 1401470, 183331502, 23952262535, 3130289979912, 409089889172506, 53463025958093933,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 07 2017 08:05:52, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;115\,a(n-1) + 2093\,a(n-2) - 4155\,a(n-3) - 183686\,a(n-4) - 585648\,a(n-5) + 633260\,a(n-6) + 10692868\,a(n-7) - 4449787\,a(n-8) - 90326895\,a(n-9) - 58218792\,a(n-10) - 85358831\,a(n-11) - 153604102\,a(n-12) + 506925527\,a(n-13) + 114376456\,a(n-14) + 783370521\,a(n-15) + 27819835\,a(n-16) + 40476932\,a(n-17) - 4134454\,a(n-18) + 1119384\,a(n-19) - 261121\,a(n-20)
\]
for every $n>22$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A280671.
