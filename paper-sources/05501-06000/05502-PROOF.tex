...
\title{The empirical recurrence for OEIS A236612, proved by transfer matrix}
...
\begin{abstract}
OEIS A236612 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
The condition is local to two consecutive rows, so the count is a walk count on $S=390$
...
OEIS A236612 is ``Number of (n+1)X(2+1) 0..2 arrays colored with the maximum plus the upper median of every 2X2 subblock.''. It has offset $1$ and begins
\[
390, 2586, 17114, 106184, 645208, 4152180, 26549772, 165983800,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 09:22:20, revision 6) this is still
...
\]
over the $S=390$ pairs whose own subblock row is properly coloured.
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-2) + 43\,a(n-3) + 968\,a(n-4) + 1219\,a(n-5) + 848\,a(n-6) + 1022\,a(n-7) - 59812\,a(n-8) - 48024\,a(n-9) + 199299\,a(n-10) + 34257\,a(n-11) + 110622\,a(n-12) + 235004\,a(n-13) - 1402148\,a(n-14) + 410643\,a(n-15) + 1245654\,a(n-16) - 1480077\,a(n-17) + 2710856\,a(n-18) - 1245093\,a(n-19) - 2253045\,a(n-20) + 2250775\,a(n-21) - 4602803\,a(n-22) + 1885365\,a(n-23) + 2227221\,a(n-24) - 1911884\,a(n-25) + 2191380\,a(n-26) - 813800\,a(n-27) - 664553\,a(n-28) + 479557\,a(n-29) - 129361\,a(n-30) + 128225\,a(n-31) - 10056\,a(n-32) - 7436\,a(n-33) + 3464\,a(n-34) - 1712\,a(n-35) + 128\,a(n-36)
\]
for every $n>40$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A236612.
