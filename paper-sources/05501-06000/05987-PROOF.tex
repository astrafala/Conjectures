...
\title{The empirical recurrence for OEIS A317771, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A317771 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
values of its neighbours, and carries an empirical recurrence of order $65$ contributed
...
OEIS A317771 is ``Number of nX6 0..1 arrays with every element unequal to 0, 1 or 3 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
13, 18, 28, 23, 30, 40, 54, 82,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 06 2018 12:12:53, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 2\,a(n-4) + 4\,a(n-7) - 5\,a(n-8) - a(n-9) + 3\,a(n-10) + 17\,a(n-11) - 15\,a(n-12) + 17\,a(n-13) - 9\,a(n-14) - 41\,a(n-15) - 27\,a(n-16) + 39\,a(n-17) - 45\,a(n-18) + 2\,a(n-19) + 22\,a(n-20) - 22\,a(n-21) - 217\,a(n-22) + 33\,a(n-23) + 18\,a(n-24) - 36\,a(n-25) + 89\,a(n-26) + 298\,a(n-27) - 168\,a(n-28) - 194\,a(n-29) - 49\,a(n-30) - 67\,a(n-31) - 406\,a(n-32) + 156\,a(n-33) + 345\,a(n-34) + 144\,a(n-35) + 23\,a(n-36) + 211\,a(n-37) - 198\,a(n-38) - 383\,a(n-39) - 77\,a(n-40) + 135\,a(n-41) + 24\,a(n-42) + 122\,a(n-43) + 171\,a(n-44) + 58\,a(n-45) - 41\,a(n-46) - 24\,a(n-47) + 35\,a(n-48) + 58\,a(n-49) + 40\,a(n-50) - 8\,a(n-51) - 23\,a(n-52) - 51\,a(n-53) - 46\,a(n-54) - 16\,a(n-55) + 2\,a(n-56) + 12\,a(n-57) + 9\,a(n-58) - 6\,a(n-59) - 8\,a(n-60) - 2\,a(n-61) - 4\,a(n-62) + 3\,a(n-64) + a(n-65)
\end{equation}
for all $n>72$.
...
publishes, $n=37$, the arrays have $6\cdot37$ cells over
$2$ values, so there are about $10^{66}$ of them to sift. The
...
$o=1n_0+0-2$. Then for $j\ge65$,
\[
a(n_0+j)-\sum_i c_i\,a(n_0+j-i)\;=\;\,\mathbf{v}^{\!\top}G^{\,j-65}w,
\qquad w=h_{65}-\sum_i c_i\,h_{65-i} .
\]
...
\begin{proof}
Substitute Lemma~\ref{lem:walk} and factor $G^{j-65}$ out of
...
the middle row. The vector $w$ was formed by $65$ applications of $G$ in exact integer
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A317771.
