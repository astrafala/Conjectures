...
\title{The empirical recurrence for OEIS A282588, proved by transfer matrix}
...
\begin{abstract}
OEIS A282588 counts $n\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
walk, and $a(n)$ is a walk count on $S=216$ vertices, which is $C$-finite. Whether the
...
OEIS A282588 is ``Number of nX3 0..1 arrays with no 1 equal to more than two of its king-move neighbors, with the exception of exactly two elements.''. It has offset $1$ and begins
\[
0, 4, 84, 533, 4083, 28060, 184242, 1182850,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 19 2017 06:32:45, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;15\,a(n-1) - 69\,a(n-2) + 62\,a(n-3) + 96\,a(n-4) + 756\,a(n-5) - 1957\,a(n-6) - 768\,a(n-7) - 354\,a(n-8) + 10259\,a(n-9) - 6393\,a(n-10) - 2754\,a(n-11) - 8562\,a(n-12) + 16887\,a(n-13) - 12150\,a(n-14) + 829\,a(n-15) + 13200\,a(n-16) - 11862\,a(n-17) + 3042\,a(n-18) + 1776\,a(n-19) - 3528\,a(n-20) + 1396\,a(n-21) + 72\,a(n-22) - 216\,a(n-23) + 216\,a(n-24)
\]
for every $n>24$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A282588.
