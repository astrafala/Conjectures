...
\title{The empirical recurrence for OEIS A207071, proved by transfer matrix}
...
\begin{abstract}
OEIS A207071 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
...
on $S=64$ vertices, and $a(n)=\mathbf{1}^{\!\top}P^{\,n-2}\mathbf{1}$. Writing $q$
...
OEIS A207071 is ``Number of 4Xn 0..1 arrays avoiding 0 0 1 and 0 1 0 horizontally and 0 0 1 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
8, 64, 216, 720, 2688, 8799, 27063,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 13:26:22, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;7\,a(n-1) - 20\,a(n-2) + 60\,a(n-3) - 200\,a(n-4) + 406\,a(n-5) - 795\,a(n-6) + 1948\,a(n-7) - 2956\,a(n-8) + 4315\,a(n-9) - 9183\,a(n-10) + 10237\,a(n-11) - 11623\,a(n-12) + 25456\,a(n-13) - 18911\,a(n-14) + 17833\,a(n-15) - 49104\,a(n-16) + 18984\,a(n-17) - 18492\,a(n-18) + 71354\,a(n-19) - 5313\,a(n-20) + 14092\,a(n-21) - 75268\,a(n-22) - 12707\,a(n-23) - 8053\,a(n-24) + 56095\,a(n-25) + 16847\,a(n-26) + 4140\,a(n-27) - 28320\,a(n-28) - 9288\,a(n-29) - 828\,a(n-30) + 8208\,a(n-31) + 2376\,a(n-32) - 1296\,a(n-34)
\end{equation}
for all $n>34$. The entry's array has a fixed number of rows and a growing number of
...
$(0,0,1), (1,0,1)$ as $3$ consecutive entries. There are $8$ admissible columns; that condition
...
columns, so $S=64$, and declare $w\to w'$ an edge when $w'$ is $w$ with its first entry
...
index corresponding to $n=34+1$ onwards, and the run was continued past $S$ consecutive
...
values agree exactly, including the initial count of $8$ admissible columns. That is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207071.
