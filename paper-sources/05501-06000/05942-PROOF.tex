...
\title{The empirical recurrence for OEIS A252436, proved by transfer matrix}
...
\begin{abstract}
OEIS A252436 counts $5\times(n+2)$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252436 is ``Number of (3+2)X(n+2) 0..3 arrays with every 3X3 subblock row and diagonal sum equal to 0 2 4 6 or 7 and every 3X3 column and antidiagonal sum not equal to 0 2 4 6 or 7.''. It has offset $1$ and begins
\[
608, 914, 1810, 2971, 8430, 20632, 38186, 110958,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:14:11, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252436.
