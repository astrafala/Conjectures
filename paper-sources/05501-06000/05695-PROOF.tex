...
\title{The empirical recurrence for OEIS A208706, proved by counting patterns}
...
\begin{abstract}
OEIS A208706 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A208706 is ``Number of n X 5 0..1 arrays with new values 0..1 introduced in row major order and no element equal to more than two of its immediate leftward or upward or right-upward antidiagonal neighbors.''. It has offset $1$ and begins
\[
16, 356, 8128, 185344, 4226368, 96373248, 2197585152, 50111214592,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 24*a(n-1) - 28*a(n-2) + 16*a(n-3) for n>4.
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 06 2018 08:52:01, revision 9) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208706.
