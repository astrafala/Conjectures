...
\title{The empirical recurrence for OEIS A255030, proved by transfer matrix}
...
\begin{abstract}
OEIS A255030 counts the arrays over $\{0,\dots,1\}$ whose $3\times3$ subblocks carry a
...
OEIS A255030 is ``Number of (n+2) X (2+2) 0..1 arrays with every 3 X 3 subblock sum of the two sums of the central row and central column minus the two minimums of the diagonal and antidiagonal nondecreasing horizontally, vertically and ne-to-sw antidiagonally.''. It has offset $1$ and begins
\[
2554, 9492, 33778, 87907, 196724, 407885, 794663, 1460513,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 27 2023 17:48:29, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) - a(n-2) - 2\,a(n-3) + 2\,a(n-4) - 11\,a(n-5) + 8\,a(n-6) + 15\,a(n-7) - 15\,a(n-8) + 7\,a(n-9) + 5\,a(n-10) - 7\,a(n-11) - 14\,a(n-12) - 20\,a(n-13) + 24\,a(n-14) + 35\,a(n-15) - 26\,a(n-16) - 51\,a(n-17) + 76\,a(n-18) + 70\,a(n-19) - 105\,a(n-20) - 92\,a(n-21) + 107\,a(n-22) + 85\,a(n-23) - 137\,a(n-24) - 60\,a(n-25) + 141\,a(n-26) + 48\,a(n-27) - 108\,a(n-28) - 16\,a(n-29) + 72\,a(n-30) - 8\,a(n-31) - 44\,a(n-32) + 4\,a(n-33) + 20\,a(n-34) - 4\,a(n-36)
\]
for every $n>42$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A255030.
