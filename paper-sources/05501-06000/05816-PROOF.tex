...
\title{The empirical recurrence for OEIS A238050, proved by transfer matrix}
...
\begin{abstract}
OEIS A238050 counts arrays over $\{0,\dots,3\}$ subject to a condition on the order
...
The condition is local to two consecutive rows, so the count is a walk count on $S=1760$
...
OEIS A238050 is ``Number of (n+1)X(2+1) 0..3 arrays with the maximum plus the minimum minus the upper median minus the lower median of every 2X2 subblock differing from its horizontal and vertical neighbors by exactly one.''. It has offset $1$ and begins
\[
1760, 20732, 249664, 3029204, 36751872, 446229436, 5413951288, 65636758792,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 10:43:26, revision 6) this is still
...
differ by $1$. The entry's first term $1760$ counts those, and the model was made to
...
\]
over the $S=1760$ pairs whose own subblock row already satisfies the condition along itself.
...
\begin{theorem}
\[
a(n)\;=\;21904\,a(n-4) - 5020646\,a(n-8) + 499932588\,a(n-12) - 25264518617\,a(n-16) + 465397769602\,a(n-20) - 8930151275492\,a(n-24) - 30272393514402\,a(n-28) - 940962161512745\,a(n-32) - 9250969739341106\,a(n-36) + 3202689128170244\,a(n-40) + 45277613917985096\,a(n-44) - 41338678777674816\,a(n-48) + 4676290285004864\,a(n-52) - 425308924384640\,a(n-56) + 154898627924480\,a(n-60)
\]
for every $n>64$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A238050.
