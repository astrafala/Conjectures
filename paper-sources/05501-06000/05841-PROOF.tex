...
\title{The empirical recurrence for OEIS A296638, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A296638 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A296638 is ``Number of nX3 0..1 arrays with each 1 horizontally, vertically or antidiagonally adjacent to 1, 2 or 4 neighboring 1s.''. It has offset $1$ and begins
\[
4, 28, 132, 671, 3444, 17558, 89613, 457188,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 17 2017 15:08:28, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) - a(n-2) + 11\,a(n-3) - 18\,a(n-4) + 13\,a(n-5) - 36\,a(n-6) + 63\,a(n-7) - 23\,a(n-8) - 95\,a(n-9) - 52\,a(n-10) + 62\,a(n-11) - 14\,a(n-12) - 78\,a(n-13) + 14\,a(n-14) + 51\,a(n-15) + 59\,a(n-16) + 80\,a(n-17) + 33\,a(n-18) - 30\,a(n-19) - 32\,a(n-20) - 10\,a(n-21) - a(n-22)
\end{equation}
for all $n>23$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A296638.
