...
\title{The empirical recurrence for OEIS A252644, proved by transfer matrix}
...
\begin{abstract}
OEIS A252644 counts $6\times(n+2)$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
$a(n)$ is a walk count on $S=162297$ vertices. Such a sequence is $C$-finite, so whether a given
...
OEIS A252644 is ``Number of (4+2)X(n+2) 0..3 arrays with every 3X3 subblock row and diagonal sum equal to 0 3 4 6 or 7 and every 3X3 column and antidiagonal sum not equal to 0 3 4 6 or 7.''. It has offset $1$ and begins
\[
2230, 10259, 39492, 95904, 448323, 1848350, 4416767, 21690676,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:29:57, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;150\,a(n-3) - 8737\,a(n-6) + 259868\,a(n-9) - 4430048\,a(n-12) + 47350454\,a(n-15) - 340156437\,a(n-18) + 1738274612\,a(n-21) - 6622942497\,a(n-24) + 19454338570\,a(n-27) - 44675220248\,a(n-30) + 79646734248\,a(n-33) - 107698827864\,a(n-36) + 107079631646\,a(n-39) - 75929658840\,a(n-42) + 37409311284\,a(n-45) - 12501763424\,a(n-48) + 2743088704\,a(n-51) - 371898368\,a(n-54) + 27607040\,a(n-57) - 819200\,a(n-60)
\]
for every $n>62$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252644.
