...
\title{The empirical recurrence for OEIS A234722, proved by transfer matrix}
...
\begin{abstract}
OEIS A234722 counts $3$-column arrays over $\{0,\dots,7\}$ in which every
...
OEIS A234722 is ``Number of (n+1) X (2+1) 0..7 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 7 (constant-stress 1 X 1 tilings).''. It has offset
$1$ and begins
\[
1096, 3976, 12464, 48976, 168928, 692512, 2531888,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 20 2022 19:00:15, revision 6) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234722.
