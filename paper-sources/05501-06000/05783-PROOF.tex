...
\title{The empirical closed form for OEIS A187508, proved}
...
\begin{abstract}
OEIS A187508 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A187508 is ``Number of 3-step S, E, and NW-moving king's tours on an n X n board summed over all starting positions.''. It has offset $1$ and begins
\[
0, 6, 31, 74, 135, 214, 311, 426,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 9*n\^{}2 - 20*n + 10 for n>1.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 23 2025 00:01:40, revision 16) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A187508.
