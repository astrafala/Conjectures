...
\title{The empirical recurrence for OEIS A232922, proved by transfer matrix}
...
\begin{abstract}
OEIS A232922 counts arrays over $\{0,\dots,2\}$ in which no two entries that are neighbours in
...
OEIS A232922 is ``Number of 3 X n 0..2 arrays with no element x(i,j) adjacent to value 2-x(i,j) horizontally, diagonally or antidiagonally.''. It has offset $1$ and begins
\[
27, 54, 246, 912, 3612, 13992, 54600, 212544,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) + 4*a(n-2) - 2*a(n-3) for n>4.
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 06 2018 05:47:59, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232922.
