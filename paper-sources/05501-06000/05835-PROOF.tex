...
\title{The empirical recurrence for OEIS A290662, proved from an exact model}
...
\begin{abstract}
OEIS A290662 carries an empirical recurrence of order $3$ contributed by Chai Wah Wu. It is true, and it is
...
\[
1, 3, 5, 15, 23, 63, 95, 255,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Chai Wah Wu\_, Aug 03 2020: (Start) a(n) = a(n-1) + 4*a(n-2) - 4*a(n-3) for n > 3.
\end{quote}
