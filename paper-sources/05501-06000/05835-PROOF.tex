...
\title{The empirical recurrence for OEIS A207789, proved by transfer matrix}
...
\begin{abstract}
OEIS A207789 counts arrays over $\{0,\dots,1\}$ of width $7$ that avoid the patterns
$(0,0,0), (1,0,1)$ along one axis and $(0,0,0), (0,1,1)$ along the other, and carries an empirical recurrence of
order $70$ contributed by R.~H.~Hardin. It is true. The patterns have length $3$, so
...
$\mathbf{1}^{\!\top}P^{\,n-2-70}q(P)\mathbf{1}$, which vanishes identically
...
OEIS A207789 is ``Number of 7 X n 0..1 arrays avoiding 0 0 0 and 0 1 1 horizontally and 0 0 0 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
28, 784, 4000, 19041, 75557, 246087, 786907,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 06 2026 20:28:25, revision
11) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) + a(n-2) - 57\,a(n-3) + 2\,a(n-4) + 372\,a(n-5) + 9\,a(n-6) - 1644\,a(n-7) - 361\,a(n-8) + 5248\,a(n-9) + 2126\,a(n-10) - 12201\,a(n-11) - 6267\,a(n-12) + 20849\,a(n-13) + 9878\,a(n-14) - 28011\,a(n-15) - 2944\,a(n-16) + 33845\,a(n-17) - 22050\,a(n-18) - 42032\,a(n-19) + 58163\,a(n-20) + 44881\,a(n-21) - 89003\,a(n-22) - 23744\,a(n-23) + 105839\,a(n-24) - 24096\,a(n-25) - 106610\,a(n-26) + 81635\,a(n-27) + 79273\,a(n-28) - 121763\,a(n-29) - 29894\,a(n-30) + 134395\,a(n-31) - 29634\,a(n-32) - 109644\,a(n-33) + 75417\,a(n-34) + 62793\,a(n-35) - 93657\,a(n-36) - 14112\,a(n-37) + 83475\,a(n-38) - 25574\,a(n-39) - 51660\,a(n-40) + 39593\,a(n-41) + 22671\,a(n-42) - 38801\,a(n-43) + 2376\,a(n-44) + 24687\,a(n-45) - 11454\,a(n-46) - 11720\,a(n-47) + 11729\,a(n-48) + 2443\,a(n-49) - 8361\,a(n-50) + 2496\,a(n-51) + 3061\,a(n-52) - 2000\,a(n-53) - 1350\,a(n-54) + 2113\,a(n-55) - 524\,a(n-56) - 423\,a(n-57) + 125\,a(n-58) + 346\,a(n-59) - 352\,a(n-60) + 80\,a(n-61) + 26\,a(n-62) + 7\,a(n-63) - 42\,a(n-64) + 32\,a(n-65) - 5\,a(n-66) - a(n-67) - a(n-68) + 2\,a(n-69) - a(n-70)
\end{equation}
...
$(0,0,0), (1,0,1)$ as $3$ consecutive entries. There are $28$ admissible columns; that condition
...
columns, so $S=784$, and declare $w\to w'$ an edge when $w'$ is $w$ with its first entry
...
$a(n)-\sum_i c_i a(n-i)=u_{\,n-2-70}$ whenever $n-70\ge2$. Hence
\eqref{eq:conj} holds for every $n>t$ exactly when $u_j=0$ for every
$j>t-2-70$. Moreover $(u_j)$ satisfies the monic linear recurrence whose
...
$P^{\,n-2-70}$ gives the identity. The equivalence follows by letting the exponent
...
\begin{proof}
The vector $q(P)\mathbf{1}\in\mathbb{Z}^{S}$ was formed by $70$ matrix--vector
...
values agree exactly, including the initial count of $28$ admissible columns. That is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207789.
