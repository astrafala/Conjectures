...
\title{The empirical recurrence for OEIS A302685, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A302685 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A302685 is ``Number of 7Xn 0..1 arrays with every element equal to 0, 1, 4 or 6 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
64, 22, 29, 121, 257, 1125, 6311, 25139,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 11 2018 12:32:06, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 2\,a(n-2) + 35\,a(n-3) + 80\,a(n-4) + 23\,a(n-5) - 141\,a(n-6) - 484\,a(n-7) - 692\,a(n-8) + 387\,a(n-9) - 71\,a(n-10) + 54\,a(n-11) + 3416\,a(n-12) + 397\,a(n-13) - 1793\,a(n-14) + 2391\,a(n-15) - 3515\,a(n-16) + 596\,a(n-17) + 624\,a(n-18) + 213\,a(n-19) - 249\,a(n-20) + 2769\,a(n-21) + 540\,a(n-22) + 1022\,a(n-23) + 146\,a(n-24) - 212\,a(n-25) - 441\,a(n-26) - 128\,a(n-27) + 44\,a(n-28) + 9\,a(n-29) - 73\,a(n-30) - 6\,a(n-31)
\end{equation}
for all $n>38$.
...
\#\{\text{neighbours with a value }equal to\ x_{t,u}\}\in\{0,1,4,6\}
\end{equation}
...
publishes, $n=23$, the arrays have $7\cdot23$ cells over
$2$ values, so there are about $10^{48}$ of them to sift. The
...
the middle column. The vector $w$ was formed by $31$ applications of $G$ in exact integer
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302685.
