...
\title{The empirical recurrence for OEIS A268633, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A268633 counts arrays over $\{0,\dots,2\}$ subject to a condition on the array as a
...
OEIS A268633 is ``Number of n X 2 0..2 arrays with some element plus some horizontally or vertically adjacent neighbor totalling two exactly once.''. It has offset $1$ and begins
\[
3, 24, 120, 504, 1944, 7128, 25272, 87480,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 6*a(n-1) - 9*a(n-2) for n>3.
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 21 2018 09:54:20, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268633.
