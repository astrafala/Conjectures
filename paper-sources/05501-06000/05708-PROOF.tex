...
\title{The empirical closed form for OEIS A187593, proved}
...
\begin{abstract}
OEIS A187593 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
$S=13$ vertices. Any function of the form $\sum_j p_j(n)\lambda_j^{\,n}$ satisfies the
...
OEIS A187593 is ``Number of 10-step E, S, NW and NE-moving king's tours on an n X n board summed over all starting positions.''. It has offset $1$ and begins
\[
0, 0, 0, 3108, 45960, 219432, 609070, 1243461,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 108852*n\^{}2 - 978404*n + 2100276 for n>8
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 04:01:50, revision 10) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;108852 n^{2} - 978404 n + 2100276.
\]
...
walk, so with $M$ the adjacency matrix of that digraph on $S=13$ vertices, and $u,w$ the
...
$n=12,\dots,14$ and agree at each. A monic recurrence of order $3$
determines $a(m)$ from $a(m-1),\dots,a(m-3)$, and for every $m\ge15$ both
$m>11$ and $m-3\ge12$ hold, so induction on $m$ gives $a(m)=f(m)$ for every
$m\ge12$.
Below $n=12$ the recurrence argument gives nothing, since \eqref{eq:rec} is only
established for $a$ from $n=12$ on. The remaining indices $n=9,\dots,11$ were
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A187593.
