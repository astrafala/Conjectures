...
\title{The empirical recurrence for OEIS A297394, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297394 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A297394 is ``Number of nX7 0..1 arrays with every 1 horizontally, diagonally or antidiagonally adjacent to 1 neighboring 1.''. It has offset $1$ and begins
\[
13, 121, 763, 7779, 58901, 514945, 4279111, 35870939,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 29 2017 10:55:48, revision 4) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297394.
