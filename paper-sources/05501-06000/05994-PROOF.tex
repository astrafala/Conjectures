...
\title{The empirical recurrence for OEIS A204835, proved by transfer matrix}
...
\begin{abstract}
OEIS A204835 counts arrays over $\{0,\dots,2\}$ under a condition on the permanent of every
...
a bounded window of consecutive rows, so the count is a walk count on $S=115$ states and is
...
OEIS A204835 is ``Number of (n+1)X4 0..2 arrays with the permanents of all 2X2 subblocks equal and nonzero.''. It has offset $1$ and begins
\[
318, 1616, 7070, 34100, 157872, 752028, 3530808, 16789864,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 11:32:53, revision 9) this is still
...
\]
on the $S=115$ states that survive. Rows carrying no edge at all are dropped: such a row could
...
first term is $318$, and the model reproduces it along with every later term; that is the
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-1) + 46\,a(n-2) - 463\,a(n-3) - 827\,a(n-4) + 11584\,a(n-5) + 7209\,a(n-6) - 167177\,a(n-7) - 24235\,a(n-8) + 1555772\,a(n-9) - 108939\,a(n-10) - 9844492\,a(n-11) + 1639028\,a(n-12) + 43404736\,a(n-13) - 9040868\,a(n-14) - 134200436\,a(n-15) + 30728164\,a(n-16) + 288648563\,a(n-17) - 71549296\,a(n-18) - 422266864\,a(n-19) + 116364363\,a(n-20) + 403049929\,a(n-21) - 126818335\,a(n-22) - 233198888\,a(n-23) + 83721106\,a(n-24) + 71218296\,a(n-25) - 28108413\,a(n-26) - 8643432\,a(n-27) + 3559710\,a(n-28) + 142560\,a(n-29) - 78408\,a(n-30)
\]
for every $n>30$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204835.
