...
\title{The empirical recurrence for OEIS A233499, proved by transfer matrix}
...
\begin{abstract}
OEIS A233499 counts arrays of width $4$ over $\{0,1,2\}$ containing no run of $3$ consecutive
...
OEIS A233499 is ``Number of (2+2) X (n+2) 0..2 arrays with no increasing sequence of length 3 horizontally or antidiagonally downwards.''. It has offset $1$ and begins
\[
424009, 26851581, 1709348346, 108934667695, 6940835448966, 442240878862773, 28176593184596215, 1795219762788597690,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 15 2023 15:33:47, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A233499.
