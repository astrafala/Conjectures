...
\title{The empirical recurrence for OEIS A275181, proved by counting patterns}
...
\begin{abstract}
OEIS A275181 counts arrays in which no entry may repeat a value found at any of three stated
...
cutting $535538$ pairs to $S=90623$ states. The entry's empirical recurrence of order $34$,
...
OEIS A275181 is ``Number of nX6 0..2 arrays with no element equal to any value at offset (-2,-1) (-1,0) or (-1,1) and new values introduced in order 0..2.''. It has offset $1$ and begins
\[
122, 1024, 1129, 1651, 6081, 23313, 90793, 355258,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 19 2016 07:40:56, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;32\,a(n-1) - 496\,a(n-2) + 4961\,a(n-3) - 35960\,a(n-4) + 201091\,a(n-5) - 902032\,a(n-6) + 3333981\,a(n-7) - 10358635\,a(n-8) + 27489359\,a(n-9) - 63147252\,a(n-10) + 127012656\,a(n-11) - 225853366\,a(n-12) + 357739737\,a(n-13) - 507298821\,a(n-14) + 645538311\,a(n-15) - 736806613\,a(n-16) + 752032038\,a(n-17) - 682548311\,a(n-18) + 546209109\,a(n-19) - 380703800\,a(n-20) + 226996531\,a(n-21) - 112609944\,a(n-22) + 44283885\,a(n-23) - 12407657\,a(n-24) + 1618639\,a(n-25) + 454684\,a(n-26) - 304782\,a(n-27) + 64173\,a(n-28) + 1145\,a(n-29) - 3123\,a(n-30) + 439\,a(n-31) + 34\,a(n-32) - 12\,a(n-33) - a(n-34)
\end{equation}
for all $n>39$.
...
$o=1n_0+0-2$, we have for $j\ge34$
\[
3!\Bigl(a(n_0+j)-\sum_i c_i\,a(n_0+j-i)\Bigr)
=\mathbf{v}^{\!\top}G^{\,j-34}w,\qquad
w=h_{34}-\sum_i c_i h_{34-i} .
\]
...
the survivors by the pattern of the new pair. The vector $w$ was formed by $34$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A275181.
