...
\title{The empirical recurrence for OEIS A209095, proved by counting patterns}
...
\begin{abstract}
OEIS A209095 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A209095 is ``Number of n X 3 0..2 arrays with new values 0..2 introduced in row major order and no element equal to more than one of its immediate leftward or upward or right-upward antidiagonal neighbors.''. It has offset $1$ and begins
\[
5, 76, 1326, 23248, 407832, 7154944, 125526240, 2202232576,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 20*a(n-1) - 44*a(n-2) + 16*a(n-3) for n>4.
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 08 2018 10:48:22, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;20\,a(n-1) - 44\,a(n-2) + 16\,a(n-3)
\end{equation}
for all $n>4$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209095.
