...
\title{The empirical recurrence for OEIS A295981, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A295981 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A295981 is ``Number of nX4 0..1 arrays with each 1 adjacent to 2 or 3 king-move neighboring 1s.''. It has offset $1$ and begins
\[
1, 28, 110, 518, 3851, 21577, 124879, 764482,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 01 2017 15:31:16, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) + 26\,a(n-3) - 179\,a(n-4) + 42\,a(n-5) + 130\,a(n-6) + 641\,a(n-7) - 279\,a(n-8) - 739\,a(n-9) - 401\,a(n-10) - 138\,a(n-11) + 816\,a(n-12) + 647\,a(n-13) + 2430\,a(n-14) - 801\,a(n-15) - 2367\,a(n-16) + 603\,a(n-17) + 742\,a(n-18) - 583\,a(n-19) + 1231\,a(n-20) - 74\,a(n-21) - 471\,a(n-22) + 479\,a(n-23) + 53\,a(n-24) - 161\,a(n-25) + 48\,a(n-26) - 4\,a(n-27)
\end{equation}
for all $n>28$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A295981.
