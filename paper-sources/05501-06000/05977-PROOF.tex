...
\title{The conjectured generating function for OEIS A252871, proved}
...
\begin{abstract}
OEIS A252871 counts arrays of a fixed width under a local condition, and carries a conjectured
...
coefficients of their expansions do. Comparing $48$ coefficients in exact arithmetic
...
OEIS A252871 is ``Number of nX3 nonnegative integer arrays with upper left 0 and lower right n+3-4 and value increasing by 0 or 1 with every step right or down.''. It has offset $1$ and begins
\[
1, 8, 44, 153, 413, 949,\ \dots
\]
The entry states, as a conjecture contributed by a reader and never marked settled:
\begin{quote}
Empirical: G.f.: -x*(1+x+9*x\^{}2-22*x\^{}3+21*x\^{}4-10*x\^{}5+2*x\^{}6) / (x-1)\^{}7. - \_R. J. Mathar\_, Nov 23 2015
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:42:36, revision 9) this is still
...
exact integer arithmetic, those of $N_2/D_2$ by exact rational long division, and $48$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252871.
