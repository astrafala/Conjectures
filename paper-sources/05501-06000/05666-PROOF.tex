...
\title{The empirical recurrence for OEIS A264874, proved by transfer matrix}
...
\begin{abstract}
OEIS A264874 carries an empirical recurrence of order $45$ contributed by R.~H.~Hardin. It is
...
OEIS A264874 is ``Number of (n+1)X(3+1) arrays of permutations of 0..n*4+3 with each element having directed index change 0,1 0,-1 -2,0 or 1,1.''. It has offset $1$ and begins
\[
1, 1, 5, 20, 56, 137, 295, 709,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 27 2015 07:31:10, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 5\,a(n-3) + 4\,a(n-4) + 21\,a(n-5) + 21\,a(n-6) + 13\,a(n-7) - 58\,a(n-8) - 70\,a(n-9) - 157\,a(n-10) - 198\,a(n-11) - 102\,a(n-12) + 209\,a(n-13) + 273\,a(n-14) + 553\,a(n-15) + 594\,a(n-16) + 289\,a(n-17) - 359\,a(n-18) - 430\,a(n-19) - 917\,a(n-20) - 765\,a(n-21) - 338\,a(n-22) + 401\,a(n-23) + 387\,a(n-24) + 812\,a(n-25) + 551\,a(n-26) + 167\,a(n-27) - 301\,a(n-28) - 174\,a(n-29) - 444\,a(n-30) - 208\,a(n-31) - 21\,a(n-32) + 107\,a(n-33) + 37\,a(n-34) + 134\,a(n-35) + 34\,a(n-36) - 17\,a(n-38) - 3\,a(n-39) - 19\,a(n-40) - 2\,a(n-41) + a(n-43) + a(n-45)
\]
for every $n>43$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264874.
