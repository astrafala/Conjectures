...
\title{The empirical recurrence for OEIS A304593, proved by transfer matrix}
...
\begin{abstract}
OEIS A304593 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $different from$ itself lying in $\{1,2,3,4,6\}$, and it carries an empirical
...
OEIS A304593 is ``Number of nX4 0..1 arrays with every element unequal to 1, 2, 3, 4 or 6 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
2, 86, 456, 3789, 28251, 211833, 1593375, 12018566,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 15 2018 13:16:55, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) + 20\,a(n-2) + 37\,a(n-3) - 235\,a(n-4) - 769\,a(n-5) - 25\,a(n-6) + 963\,a(n-7) + 3152\,a(n-8) + 9747\,a(n-9) + 20886\,a(n-10) + 3806\,a(n-11) - 54168\,a(n-12) - 90660\,a(n-13) - 155826\,a(n-14) - 69584\,a(n-15) + 208564\,a(n-16) + 378642\,a(n-17) + 207770\,a(n-18) + 638589\,a(n-19) - 2794019\,a(n-20) - 3623431\,a(n-21) + 670249\,a(n-22) + 2868866\,a(n-23) + 8092783\,a(n-24) - 4814013\,a(n-25) - 5122249\,a(n-26) - 2309005\,a(n-27) - 9534705\,a(n-28) + 12646064\,a(n-29) + 2660273\,a(n-30) + 10491806\,a(n-31) + 5057572\,a(n-32) - 8158611\,a(n-33) - 2047303\,a(n-34) - 2847339\,a(n-35) - 2188497\,a(n-36) + 2721818\,a(n-37) - 940015\,a(n-38) + 212622\,a(n-39) + 438536\,a(n-40) - 620998\,a(n-41) + 326690\,a(n-42) - 59519\,a(n-43) - 15786\,a(n-44) + 18709\,a(n-45) - 7534\,a(n-46) + 1137\,a(n-47) - 628\,a(n-48) + 322\,a(n-49) - 50\,a(n-50)
\end{equation}
for all $n>51$.
...
has score in $\{1,2,3,4,6\}$. The entry also fixes the top-left entry to be $0$; that is a condition on the first row alone, so it restricts the start vector and nothing else.
...
\begin{itemize}
\item $\mathbf{s}(r,s)=1$ when every cell of $r$ has score in $\{1,2,3,4,6\}$ \emph{with no row
above $r$} and $r_1=0$, and $0$ otherwise;
\item an edge $(r,s)\to(s,t)$ when every cell of $s$ has score in $\{1,2,3,4,6\}$ computed from
$r$, $s$ and $t$;
\item $\mathbf{e}(r,s)=1$ when every cell of $s$ has score in $\{1,2,3,4,6\}$ \emph{with no row
...
exactly when every one of its $n$ rows has all scores in $\{1,2,3,4,6\}$. Read the sequence as the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A304593.
