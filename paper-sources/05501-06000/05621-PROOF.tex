...
\title{The empirical recurrence for OEIS A304601, proved by transfer matrix}
...
\begin{abstract}
OEIS A304601 counts $5$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $different from$ itself lying in $\{0,1,2,5,6\}$, and it carries an empirical
...
OEIS A304601 is ``Number of nX5 0..1 arrays with every element unequal to 0, 1, 2, 5 or 6 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
16, 22, 53, 179, 560, 1726, 5205, 15474,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 15 2018 13:29:32, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 3\,a(n-2) - 11\,a(n-3) + 10\,a(n-4) + 4\,a(n-5) - 67\,a(n-6) + 52\,a(n-7) + 80\,a(n-8) - 134\,a(n-9) + 50\,a(n-10) + 85\,a(n-11) - 134\,a(n-12) + 124\,a(n-13) + 62\,a(n-14) - 158\,a(n-15) + 85\,a(n-16) - 26\,a(n-17) - 85\,a(n-18) + 50\,a(n-19) - 19\,a(n-20) + 32\,a(n-21) - 22\,a(n-22) + 5\,a(n-23) + 43\,a(n-24) - 59\,a(n-25) + 33\,a(n-26) + 12\,a(n-27) - 34\,a(n-28) + 23\,a(n-29) - 4\,a(n-30) - 5\,a(n-31) + 4\,a(n-32) - a(n-33)
\end{equation}
for all $n>39$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A304601.
