...
\title{The empirical recurrence for OEIS A284353, proved from an exact model}
...
\begin{abstract}
OEIS A284353 carries an empirical recurrence of order $3$ contributed by Colin Barker. It is true, and it is
...
\[
1, 1, 7, 13, 31, 61, 127, 253,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Mar 26 2017: (Start) a(n) = 2*a(n-1) + a(n-2) - 2*a(n-3) for n>2. (End)
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 05 2025 15:22:38, revision 32)
...
neighbourhood to a live cell flips the ENTIRE plane, and rule 899 is read
...
vanish from $n=0+1$ onwards, and the run exceeds $S+3$, which by
