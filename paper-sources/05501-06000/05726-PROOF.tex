...
\title{The empirical recurrence for OEIS A298585, proved by transfer matrix}
...
\begin{abstract}
OEIS A298585 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $equal to$ itself lying in $\{0,3,4,5,7\}$, and it carries an empirical
...
OEIS A298585 is ``Number of nX4 0..1 arrays with every element equal to 0, 3, 4, 5 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 2, 5, 4, 13, 31, 83, 262,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 22 2018 06:50:51, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 7\,a(n-2) + 5\,a(n-3) - 35\,a(n-4) - 43\,a(n-5) - 2\,a(n-6) + 110\,a(n-7) + 102\,a(n-8) + 114\,a(n-9) - 67\,a(n-10) - 202\,a(n-11) - 325\,a(n-12) - 89\,a(n-13) + 61\,a(n-14) + 109\,a(n-15) + 328\,a(n-16) + 163\,a(n-17) + 194\,a(n-18) - 164\,a(n-19) - 33\,a(n-20) - 176\,a(n-21) - 212\,a(n-22) + 41\,a(n-23) + 14\,a(n-24) + 15\,a(n-25) + 62\,a(n-26) + 41\,a(n-27) - 27\,a(n-28) + 13\,a(n-29) + 11\,a(n-30) - 14\,a(n-31) + 2\,a(n-32) - a(n-33) - 3\,a(n-34)
\end{equation}
for all $n>34$.
...
has score in $\{0,3,4,5,7\}$. The entry also fixes the top-left entry to be $0$; that is a condition on the first row alone, so it restricts the start vector and nothing else.
...
\begin{itemize}
\item $\mathbf{s}(r,s)=1$ when every cell of $r$ has score in $\{0,3,4,5,7\}$ \emph{with no row
above $r$} and $r_1=0$, and $0$ otherwise;
\item an edge $(r,s)\to(s,t)$ when every cell of $s$ has score in $\{0,3,4,5,7\}$ computed from
$r$, $s$ and $t$;
\item $\mathbf{e}(r,s)=1$ when every cell of $s$ has score in $\{0,3,4,5,7\}$ \emph{with no row
...
exactly when every one of its $n$ rows has all scores in $\{0,3,4,5,7\}$. Read the sequence as the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A298585.
