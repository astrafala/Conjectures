...
\title{The empirical recurrence for OEIS A318547, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A318547 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A318547 is ``Number of nX3 0..1 arrays with every element unequal to 1, 2, 4 or 6 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
1, 6, 5, 21, 44, 106, 258, 600,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 28 2018 11:12:12, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-2) + 10\,a(n-3) - 4\,a(n-4) - 39\,a(n-5) - 51\,a(n-6) + 7\,a(n-7) + 78\,a(n-8) + 78\,a(n-9) + a(n-10) - 54\,a(n-11) - 4\,a(n-12) + 34\,a(n-13) + 4\,a(n-14) - 15\,a(n-15) - 6\,a(n-16) + 33\,a(n-17) + 29\,a(n-18) - 38\,a(n-19) - 40\,a(n-20) + 11\,a(n-21) + 5\,a(n-22) + 2\,a(n-23) - 8\,a(n-24) - 5\,a(n-25) + 14\,a(n-26) - 4\,a(n-27) - 6\,a(n-28) + 5\,a(n-29) + a(n-30) - a(n-31)
\end{equation}
for all $n>32$.
...
\#\{\text{neighbours with a value }different from\ x_{t,u}\}\in\{1,2,4,6\}
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A318547.
