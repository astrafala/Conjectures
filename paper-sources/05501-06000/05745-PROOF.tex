...
\title{The empirical recurrence for OEIS A296153, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A296153 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A296153 is ``Number of nX4 0..1 arrays with each 1 adjacent to 3 or 5 king-move neighboring 1s.''. It has offset $1$ and begins
\[
1, 7, 16, 32, 91, 237, 585, 1513,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 06 2017 08:34:58, revision 4) the statement is
...
x_{t,u}=1\ \Rightarrow\ \#\{\text{neighbours equal to }1\}\in\{3,5\}
\end{equation}
for every cell $(t,u)$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A296153.
