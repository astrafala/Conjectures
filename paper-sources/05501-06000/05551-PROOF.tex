...
\begin{abstract}
OEIS A285776 carries an empirical recurrence of order $4$ contributed by Colin Barker. It is true, and it is
...
\begin{quote}
Conjectures from \_Colin Barker\_, Apr 26 2017: (Start) a(n) = 101*a(n-2) - 100*a(n-4) for n>7.
\end{quote}
