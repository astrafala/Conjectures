...
\title{The empirical recurrence for OEIS A254169, proved by transfer matrix}
...
\begin{abstract}
OEIS A254169 counts the arrays over $\{0,\dots,1\}$ whose $3\times3$ subblocks carry a
...
OEIS A254169 is ``Number of (2+2)X(n+2) 0..1 arrays with every 3X3 subblock diagonal maximum minus antidiagonal median nondecreasing horizontally, vertically and ne-to-sw antidiagonally.''. It has offset $1$ and begins
\[
3036, 23660, 164408, 1078032, 6831024, 41678024, 251430924, 1509107876,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 14:29:37, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A254169.
