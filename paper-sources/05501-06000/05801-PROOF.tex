...
\title{The empirical recurrence for OEIS A317516, proved by transfer matrix}
...
\begin{abstract}
OEIS A317516 counts $7$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $different from$ itself lying in $\{0,1,2,3,4,5,6,7\}$, and it carries an empirical
recurrence of order $34$ contributed by R.~H.~Hardin. It is true. The neighbourhood
...
OEIS A317516 is ``Number of nX7 0..1 arrays with every element unequal to 0, 1, 2, 3, 4, 5, 6 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
64, 8192, 1028335, 129072576, 16206294085, 2034862700902, 255495837970145, 32079862886682262,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 30 2018 11:30:31, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;120\,a(n-1) + 187\,a(n-2) + 61002\,a(n-3) + 325211\,a(n-4) + 8540018\,a(n-5) + 55665488\,a(n-6) + 197081135\,a(n-7) + 679772036\,a(n-8) - 13105227717\,a(n-9) - 94788188007\,a(n-10) + 105665592115\,a(n-11) + 1800234791684\,a(n-12) + 1093938256678\,a(n-13) - 14583514197672\,a(n-14) - 20050560105580\,a(n-15) + 57977995880940\,a(n-16) + 115650903098871\,a(n-17) - 105222965589160\,a(n-18) - 320560034452090\,a(n-19) + 29052185905214\,a(n-20) + 431159735045996\,a(n-21) + 164127473071996\,a(n-22) - 201290198060152\,a(n-23) - 181630216283952\,a(n-24) - 89746931670336\,a(n-25) + 5796742093472\,a(n-26) + 84410545306560\,a(n-27) + 50872693326464\,a(n-28) + 10683412435968\,a(n-29) - 1911278949888\,a(n-30) - 9878941541376\,a(n-31) - 5707247892480\,a(n-32) - 1805856768000\,a(n-33) - 746496000000\,a(n-34)
\end{equation}
for all $n>34$.
...
has score in $\{0,1,2,3,4,5,6,7\}$. The entry also fixes the top-left entry to be $0$; that is a condition on the first row alone, so it restricts the start vector and nothing else.
...
\begin{itemize}
\item $\mathbf{s}(r,s)=1$ when every cell of $r$ has score in $\{0,1,2,3,4,5,6,7\}$ \emph{with no row
above $r$} and $r_1=0$, and $0$ otherwise;
\item an edge $(r,s)\to(s,t)$ when every cell of $s$ has score in $\{0,1,2,3,4,5,6,7\}$ computed from
$r$, $s$ and $t$;
\item $\mathbf{e}(r,s)=1$ when every cell of $s$ has score in $\{0,1,2,3,4,5,6,7\}$ \emph{with no row
...
exactly when every one of its $n$ rows has all scores in $\{0,1,2,3,4,5,6,7\}$. Read the sequence as the
...
$a(n)-\sum_i c_i a(n-i)=u_{\,n-2-34}$ whenever $n-34\ge2$. So \eqref{eq:conj}
holds for every $n>t$ exactly when $u_j=0$ for all $j>t-2-34$. Moreover $(u_j)$
...
\begin{proof}
Substituting Lemma~\ref{lem:walk} and factoring $P^{\,n-2-34}$ out of
...
\begin{proof}
The vector $q(P)\mathbf{e}\in\mathbb{Z}^{S}$ was formed by $34$ matrix--vector
...
compared against the entry's DATA at every one of the $12$ published indices; they
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A317516.
