...
\title{The empirical recurrence for OEIS A207490, proved by transfer matrix}
...
\begin{abstract}
OEIS A207490 counts arrays over $\{0,\dots,1\}$ of width $5$ that avoid the patterns
$(0,1,1), (1,1,0)$ along one axis and $(0,0,0), (0,1,1)$ along the other, and carries an empirical recurrence of
order $43$ contributed by R.~H.~Hardin. It is true. The patterns have length $3$, so
...
$\mathbf{1}^{\!\top}P^{\,n-2-43}q(P)\mathbf{1}$, which vanishes identically
...
OEIS A207490 is ``Number of 5Xn 0..1 arrays avoiding 0 0 0 and 0 1 1 horizontally and 0 1 1 and 1 1 0 vertically.''. It has offset
$1$ and begins
\[
14, 196, 408, 1459, 4041, 8808, 21991,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 13:58:39, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 5\,a(n-2) + 9\,a(n-3) - 24\,a(n-4) - 39\,a(n-5) - 30\,a(n-6) + 138\,a(n-7) + 174\,a(n-8) + 93\,a(n-9) - 491\,a(n-10) - 626\,a(n-11) - 220\,a(n-12) + 1436\,a(n-13) + 1645\,a(n-14) + 53\,a(n-15) - 3311\,a(n-16) - 2794\,a(n-17) + 1013\,a(n-18) + 5466\,a(n-19) + 3055\,a(n-20) - 2604\,a(n-21) - 6394\,a(n-22) - 2236\,a(n-23) + 3343\,a(n-24) + 5400\,a(n-25) + 1218\,a(n-26) - 2618\,a(n-27) - 3363\,a(n-28) - 623\,a(n-29) + 1314\,a(n-30) + 1559\,a(n-31) + 321\,a(n-32) - 425\,a(n-33) - 525\,a(n-34) - 124\,a(n-35) + 88\,a(n-36) + 119\,a(n-37) + 26\,a(n-38) - 12\,a(n-39) - 16\,a(n-40) - 2\,a(n-41) + a(n-42) + a(n-43)
\end{equation}
for all $n>43$. The entry's array has a fixed number of rows and a growing number of
...
$a(n)-\sum_i c_i a(n-i)=u_{\,n-2-43}$ whenever $n-43\ge2$. Hence
\eqref{eq:conj} holds for every $n>t$ exactly when $u_j=0$ for every
$j>t-2-43$. Moreover $(u_j)$ satisfies the monic linear recurrence whose
...
$P^{\,n-2-43}$ gives the identity. The equivalence follows by letting the exponent
...
\begin{proof}
The vector $q(P)\mathbf{1}\in\mathbb{Z}^{S}$ was formed by $43$ matrix--vector
products in exact integer arithmetic and the $u_j$ evaluated in turn. They vanish from the
index corresponding to $n=43+1$ onwards, and the run was continued past $S$ consecutive
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207490.
