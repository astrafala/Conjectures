...
\title{The empirical recurrence for OEIS A299369, proved by transfer matrix}
...
\begin{abstract}
OEIS A299369 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $equal to$ itself lying in $\{1,2,3,4,5,8\}$, and it carries an empirical
recurrence of order $31$ contributed by R.~H.~Hardin. It is true. The neighbourhood
...
OEIS A299369 is ``Number of n X 4 0..1 arrays with every element equal to 1, 2, 3, 4, 5 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
2, 64, 876, 10692, 136106, 1736688, 22129704, 281996650,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 22 2022 12:01:09, revision
6) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;14\,a(n-1) - 11\,a(n-2) - 60\,a(n-3) - 45\,a(n-4) - 86\,a(n-5) + 217\,a(n-6) + 1113\,a(n-7) + 2167\,a(n-8) - 7569\,a(n-9) + 495\,a(n-10) + 7012\,a(n-11) + 2755\,a(n-12) - 16094\,a(n-13) - 918\,a(n-14) + 21559\,a(n-15) + 1334\,a(n-16) - 12014\,a(n-17) - 10046\,a(n-18) + 6016\,a(n-19) + 7512\,a(n-20) + 2397\,a(n-21) - 1838\,a(n-22) - 2359\,a(n-23) - 1700\,a(n-24) - 102\,a(n-25) + 36\,a(n-26) - 87\,a(n-27) + 44\,a(n-28) + 130\,a(n-29) + 67\,a(n-30) + 14\,a(n-31)
\end{equation}
for all $n>32$.
...
$a(n)-\sum_i c_i a(n-i)=u_{\,n-2-31}$ whenever $n-31\ge2$. So \eqref{eq:conj}
holds for every $n>t$ exactly when $u_j=0$ for all $j>t-2-31$. Moreover $(u_j)$
...
\begin{proof}
Substituting Lemma~\ref{lem:walk} and factoring $P^{\,n-2-31}$ out of
...
\begin{proof}
The vector $q(P)\mathbf{e}\in\mathbb{Z}^{S}$ was formed by $31$ matrix--vector
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A299369.
