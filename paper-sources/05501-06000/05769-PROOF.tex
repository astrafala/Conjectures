...
\title{The empirical recurrence for OEIS A186056, proved by transfer matrix}
...
\begin{abstract}
OEIS A186056 counts $(n+2)\times4$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A186056 is ``Number of (n+2)X4 binary arrays with each 3X3 subblock having a positive determinant.''. It has offset $1$ and begins
\[
267, 1217, 5050, 18376, 77987, 319247, 1206478, 5004260,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 03:22:58, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;86\,a(n-3) + 21\,a(n-4) + 24\,a(n-5) - 2063\,a(n-6) - 225\,a(n-7) - 146\,a(n-8) + 21658\,a(n-9) - 491\,a(n-10) - 2391\,a(n-11) - 114917\,a(n-12) + 12598\,a(n-13) + 28684\,a(n-14) + 319161\,a(n-15) - 45052\,a(n-16) - 111463\,a(n-17) - 457411\,a(n-18) + 54439\,a(n-19) + 170509\,a(n-20) + 348902\,a(n-21) - 15249\,a(n-22) - 102795\,a(n-23) - 166851\,a(n-24) - 5337\,a(n-25) + 30958\,a(n-26) + 46900\,a(n-27) + 2286\,a(n-28) - 5094\,a(n-29) - 6511\,a(n-30) - 509\,a(n-31) + 764\,a(n-32) + 350\,a(n-33) + 6\,a(n-34) + 32\,a(n-35)
\]
for every $n>35$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A186056.
