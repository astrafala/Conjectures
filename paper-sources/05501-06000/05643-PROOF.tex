...
\title{The empirical recurrence for OEIS A280668, proved by transfer matrix}
...
\begin{abstract}
OEIS A280668 counts $n\times3$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A280668 is ``Number of n X 3 0..2 arrays with no element equal to more than one of its horizontal and antidiagonal neighbors and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
4, 59, 858, 12484, 181640, 2642832, 38452768, 559481408,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 14*a(n-1) + 8*a(n-2).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 14 2019 07:44:27, revision 9) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A280668.
