...
\title{The empirical closed form for OEIS A187378, proved}
...
\begin{abstract}
OEIS A187378 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A187378 is ``Number of 4-step S, NW and NE-moving king's tours on an n X n board summed over all starting positions.''. It has offset $1$ and begins
\[
0, 4, 40, 132, 278, 478, 732, 1040,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 27*n\^{}2 - 97*n + 88 for n>2.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 22 2025 05:57:12, revision 18) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A187378.
