...
\title{The empirical closed form for OEIS A187047, proved}
...
\begin{abstract}
OEIS A187047 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A187047 is ``Number of 3-step one or two space at a time bishop's tours on an n X n board summed over all starting positions.''. It has offset $1$ and begins
\[
0, 0, 28, 136, 360, 696, 1144, 1704,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 56*n\^{}2 - 280*n + 360 for n>3
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 03:51:47, revision 11) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;56 n^{2} - 280 n + 360.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A187047.
