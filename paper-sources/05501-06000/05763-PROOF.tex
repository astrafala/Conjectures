...
\title{The empirical recurrence for OEIS A203087, proved by transfer matrix}
...
\begin{abstract}
OEIS A203087 counts arrays of width $6$ over $\{0,1\}$ containing no occurrence of certain short
...
OEIS A203087 is ``Number of (n+2)X6 binary arrays avoiding patterns 000 and 101 in rows and columns.''. It has offset $1$ and begins
\[
1575, 6615, 26528, 112334, 470807, 1946072, 8108104, 33749405,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 10:06:58, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 4\,a(n-2) + 34\,a(n-3) + 40\,a(n-4) - 31\,a(n-5) - 224\,a(n-6) - 413\,a(n-7) + 433\,a(n-8) + 1505\,a(n-9) + 703\,a(n-10) - 2455\,a(n-11) - 5056\,a(n-12) + 2075\,a(n-13) + 4934\,a(n-14) - 656\,a(n-15) + 3696\,a(n-16) + 18044\,a(n-17) - 16513\,a(n-18) - 39362\,a(n-19) + 8986\,a(n-20) + 39868\,a(n-21) - 19137\,a(n-22) + 10671\,a(n-23) + 7513\,a(n-24) - 14687\,a(n-25) - 4882\,a(n-26) - 718\,a(n-27) + 4632\,a(n-28) + 3198\,a(n-29) + 2571\,a(n-30) + 1542\,a(n-31) - 1549\,a(n-32) + 249\,a(n-33) - 84\,a(n-34) - 330\,a(n-35) + 54\,a(n-36) - 216\,a(n-37)
\]
for every $n>41$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A203087.
