...
\title{The empirical recurrence for OEIS A228802, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A228802 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
with $S=128$ vertices, and the conjectured recurrence is then decided by a finite exact
computation.
\end{abstract}
...
OEIS A228802 is ``Number of 7Xn binary arrays with top left element equal to 1 and no two ones adjacent horizontally or nw-se.''. It has offset $1$ and begins
\[
64, 233, 12444, 135768, 3459357, 53992646, 1104367784, 19393508581,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 04 2025 00:08:08, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 288\,a(n-2) + 1417\,a(n-3) - 11199\,a(n-4) - 59098\,a(n-5) + 236338\,a(n-6) + 948288\,a(n-7) - 3278724\,a(n-8) - 6872522\,a(n-9) + 27696998\,a(n-10) + 17458752\,a(n-11) - 128873759\,a(n-12) + 35614933\,a(n-13) + 298960774\,a(n-14) - 258487597\,a(n-15) - 292412017\,a(n-16) + 426432960\,a(n-17) + 93229829\,a(n-18) - 323469437\,a(n-19) + 28233040\,a(n-20) + 135906279\,a(n-21) - 29253017\,a(n-22) - 34819910\,a(n-23) + 8867758\,a(n-24) + 5748836\,a(n-25) - 1311708\,a(n-26) - 619302\,a(n-27) + 94650\,a(n-28) + 41064\,a(n-29) - 2481\,a(n-30) - 1413\,a(n-31) - 22\,a(n-32) + 17\,a(n-33) + a(n-34)
\end{equation}
for all $n>34$.
...
$\mathcal V=V\times V$, of size $S=128$, as the vertex set. Declare $(p,c)\to(c,x)$ an edge
...
publishes, $n=15$, the arrays have $7\cdot15$ cells over
$2$ values, so there are about $10^{31}$ of them to sift. The
walk count replaces that by $128$ states and one matrix--vector product per column.
...
\begin{proof}
The digraph was built directly from \eqref{eq:loc}: for each of the $S=128$ pairs and each
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A228802.
