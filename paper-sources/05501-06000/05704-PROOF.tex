...
\title{The empirical closed form for OEIS A187174, proved}
...
\begin{abstract}
OEIS A187174 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A187174 is ``Number of 4-step left-handed knight's tours (moves only out two, left one) on an n X n board summed over all starting positions.''. It has offset $1$ and begins
\[
0, 0, 0, 8, 48, 176, 384, 664,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 36*n\^{}2 - 260*n + 440 for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 18 2022 17:48:34, revision 16) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;36 n^{2} - 260 n + 440.
\]
...
First, the walk model reproduces every one of the $41$ terms the entry publishes,
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A187174.
