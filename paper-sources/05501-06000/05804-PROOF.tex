...
\title{The empirical recurrence for OEIS A254547, proved by transfer matrix}
...
\begin{abstract}
OEIS A254547 counts the arrays over $\{0,\dots,1\}$ whose $3\times3$ subblocks carry a
...
OEIS A254547 is ``Number of (n+2) X (2+2) 0..1 arrays with every 3 X 3 subblock diagonal sum minus antidiagonal minimum nondecreasing horizontally, vertically and ne-to-sw antidiagonally.''. It has offset $1$ and begins
\[
2696, 9292, 39661, 128366, 443179, 1412248, 4537801, 14148124,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 18 2022 00:30:55, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) - 8\,a(n-2) - 11\,a(n-3) + 31\,a(n-4) - 30\,a(n-5) + 24\,a(n-6) + 40\,a(n-7) - 51\,a(n-8) - 273\,a(n-9) + 426\,a(n-10) + 529\,a(n-11) - 1549\,a(n-12) + 1752\,a(n-13) - 1771\,a(n-14) - 1226\,a(n-15) + 4804\,a(n-16) - 5488\,a(n-17) + 6566\,a(n-18) - 214\,a(n-19) - 6805\,a(n-20) + 4801\,a(n-21) - 5890\,a(n-22) + 3586\,a(n-23) - 495\,a(n-24) + 2835\,a(n-25) - 1421\,a(n-26) - 2137\,a(n-27) + 5690\,a(n-28) - 5577\,a(n-29) + 5418\,a(n-30) - 2363\,a(n-31) - 2053\,a(n-32) + 1040\,a(n-33) - 2407\,a(n-34) + 1715\,a(n-35) - 491\,a(n-36) + 1543\,a(n-37) - 859\,a(n-38) + 468\,a(n-39) + 246\,a(n-40) - 539\,a(n-41) + 730\,a(n-42) - 411\,a(n-43) - 114\,a(n-44) - 86\,a(n-45) - 132\,a(n-46) + 8\,a(n-47) + 112\,a(n-48) + 16\,a(n-49) + 32\,a(n-50) + 16\,a(n-51) - 32\,a(n-52)
\]
for every $n>59$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A254547.
