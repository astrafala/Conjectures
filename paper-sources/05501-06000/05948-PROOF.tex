...
\title{The empirical recurrence for OEIS A204601, proved by transfer matrix}
...
\begin{abstract}
OEIS A204601 counts $(n+2)\times4$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
every $3\times3$ subblock, and it carries an empirical recurrence of order $30$
...
OEIS A204601 is ``Number of (n+2)X4 0..2 arrays with every 3X3 subblock having three strictly increasing elements in a row horizontally, vertically or nw-to-se diagonally exactly one way.''. It has offset $1$ and begins
\[
29678, 144168, 741296, 4820300, 40672735, 304865717, 1982068849, 16593833004,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 11:20:32, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;547\,a(n-3) + 171\,a(n-4) + 516\,a(n-5) - 55018\,a(n-6) - 23950\,a(n-7) - 111316\,a(n-8) - 332965\,a(n-9) - 876536\,a(n-10) - 1739333\,a(n-11) - 5080524\,a(n-12) + 403621\,a(n-13) + 39118183\,a(n-14) + 100221391\,a(n-15) + 150158400\,a(n-16) + 289571495\,a(n-17) + 999909003\,a(n-18) + 1798876517\,a(n-19) + 1319087584\,a(n-20) + 4156586902\,a(n-21) + 3249204289\,a(n-22) + 154789000\,a(n-23) - 450688699\,a(n-24) + 584511220\,a(n-25) + 1180063251\,a(n-26) + 474269436\,a(n-27) - 510888456\,a(n-28) - 433559772\,a(n-29) + 60300180\,a(n-30)
\]
for every $n>33$.
\end{theorem}

\begin{proof}
The vector $w=q(M)\mathbf{1}$ was formed by $30$ matrix--vector products in exact
integer arithmetic and $\mathbf{1}^{\!\top}M^{j}w$ evaluated for $j=0,1,\dots$, again
exactly. Those integers vanish from the index corresponding to $n=33+1$ onwards, and the
run was continued until the working vector was identically zero, which settles all larger $j$
at once. By Lemma~\ref{lem:crit} the recurrence holds for every $n>33$.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204601.
