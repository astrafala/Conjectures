...
\title{The empirical recurrence for OEIS A300368, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A300368 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A300368 is ``Number of nX4 0..1 arrays with every element equal to 2 or 3 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
0, 1, 3, 3, 4, 22, 39, 102,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 04 2018 09:07:13, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-2) + 8\,a(n-3) + 8\,a(n-4) + 12\,a(n-5) - 44\,a(n-7) - 152\,a(n-8) - 241\,a(n-9) - 140\,a(n-10) - 68\,a(n-11) - 156\,a(n-12) + 283\,a(n-13) + 514\,a(n-14) + 1368\,a(n-15) + 980\,a(n-16) + 28\,a(n-17) - 659\,a(n-18) - 792\,a(n-19) - 790\,a(n-20) - 705\,a(n-21) - 657\,a(n-22) + 8\,a(n-23) + 390\,a(n-24) + 453\,a(n-25) - 341\,a(n-26) + 569\,a(n-27) - 377\,a(n-28) + 201\,a(n-29) - 183\,a(n-30) - 139\,a(n-31) + 314\,a(n-32) - 196\,a(n-33) + 10\,a(n-34) + 78\,a(n-35) - 34\,a(n-36) + 2\,a(n-37) - 24\,a(n-38) + 52\,a(n-39) - 52\,a(n-40) + 28\,a(n-41) - 8\,a(n-42) + a(n-43)
\end{equation}
for all $n>45$.
...
\#\{\text{neighbours with a value }equal to\ x_{t,u}\}\in\{2,3\}
\end{equation}
...
the middle row. The vector $w$ was formed by $43$ applications of $G$ in exact integer
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A300368.
