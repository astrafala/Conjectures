...
\title{The empirical recurrence for OEIS A186468, proved by transfer matrix}
...
\begin{abstract}
OEIS A186468 counts the $(n+1)\times6$ arrays over $\{0,\dots,2\}$ in which
...
a state, the count is a walk count on $S=966$ of them, and the conjectured recurrence is then
...
OEIS A186468 is ``Number of (n+1)X6 0..2 arrays with every 2X2 subblock commuting with each of its horizontal and vertical 2X2 subblock neighbors.''. It has offset $1$ and begins
\[
966, 903, 3190, 4875, 13278, 16083, 40626, 52755,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n)=2*a(n-1)+a(n-2)-4*a(n-3)+4*a(n-4)-2*a(n-5) for n>14
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 03:30:44, revision 9) this is still
...
$966$, which the model reproduces along with every later term.
...
\]
on the $S=966$ admissible $2$-tuples. In particular $a$ is $C$-finite.
...
size of the construction is therefore $3^{2\cdot6}$ before the condition prunes
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A186468.
