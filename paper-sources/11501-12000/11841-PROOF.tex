...
\title{The empirical recurrence for OEIS A204414, proved by transfer matrix}
...
\begin{abstract}
OEIS A204414 counts $(n+2)\times7$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
$a(n)$ is a walk count on $S=59692$ vertices. Such a sequence is $C$-finite, so whether a given
...
OEIS A204414 is ``Number of (n+2)X7 0..2 arrays with every 3X3 subblock having three strictly increasing elements in a row horizontally or vertically, exactly one way.''. It has offset $1$ and begins
\[
22956524, 52039032, 49914501, 89459577, 253954944, 1364559057, 8802512928, 94119917760,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 577*a(n-3) for n>16
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 11:13:38, revision 9) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204414.
