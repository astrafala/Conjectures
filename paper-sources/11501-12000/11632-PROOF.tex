...
\title{The empirical recurrence for OEIS A186479, proved by transfer matrix}
...
\begin{abstract}
OEIS A186479 counts the $(n+1)\times7$ arrays over $\{0,\dots,3\}$ in which
...
a state, the count is a walk count on $S=5955$ of them, and the conjectured recurrence is then
...
OEIS A186479 is ``Number of (n+1)X7 0..3 arrays with every 2X2 subblock commuting with each of its horizontal and vertical 2X2 subblock neighbors.''. It has offset $1$ and begins
\[
5955, 8223, 21760, 67714, 108025, 305089, 418177, 1286113,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n)=2*a(n-1)+2*a(n-2)-6*a(n-3)+6*a(n-4)-3*a(n-5) for n>17
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 03:31:40, revision 9) this is still
...
$5955$, which the model reproduces along with every later term.
...
\]
on the $S=5955$ admissible $2$-tuples. In particular $a$ is $C$-finite.
...
size of the construction is therefore $4^{2\cdot7}$ before the condition prunes
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A186479.
