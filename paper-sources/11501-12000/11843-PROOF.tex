...
\title{The empirical recurrence for OEIS A302310, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A302310 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A302310 is ``Number of 2Xn 0..1 arrays with every element equal to 0, 1, 3 or 4 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
2, 3, 11, 21, 31, 113, 363, 813,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) -a(n-2) +4*a(n-3) +12*a(n-4) -16*a(n-5) for n>6
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 05 2018 09:39:22, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) - a(n-2) + 4\,a(n-3) + 12\,a(n-4) - 16\,a(n-5)
\end{equation}
for all $n>6$.
...
publishes, $n=28$, the arrays have $2\cdot28$ cells over
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302310.
