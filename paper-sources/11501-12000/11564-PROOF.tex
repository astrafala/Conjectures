...
\title{The empirical recurrence for OEIS A297545, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297545 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A297545 is ``Number of 2 X n 0..1 arrays with every 1 horizontally, diagonally or antidiagonally adjacent to 2 or 3 neighboring 1s.''. It has offset $1$ and begins
\[
1, 2, 11, 24, 38, 105, 381, 1067,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) - 2*a(n-2) + 5*a(n-3) + 6*a(n-4) - 16*a(n-5) - 12*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 22 2018 09:47:50, revision 7) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) - 2\,a(n-2) + 5\,a(n-3) + 6\,a(n-4) - 16\,a(n-5) - 12\,a(n-6)
\end{equation}
for all $n>7$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297545.
