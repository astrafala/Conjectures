...
\title{The empirical recurrence for OEIS A259291, proved by transfer matrix}
...
\begin{abstract}
OEIS A259291 counts arrays of width $3$ over $\{0,1\}$ subject to a condition read round the
...
OEIS A259291 is ``Number of (n+1) X (2+1) 0..1 arrays with each 2 X 2 subblock having clockwise pattern 0001 0101 or 0111.''. It has offset $1$ and begins
\[
26, 94, 322, 1134, 3938, 13774, 48002, 167598,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) + 4*a(n-2) - 8*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 25 2018 06:22:23, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A259291.
