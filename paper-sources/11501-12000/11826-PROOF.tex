...
\title{The empirical recurrence for OEIS A250730, proved by transfer matrix}
...
\begin{abstract}
OEIS A250730 counts arrays over $\{0,1\}$ in which a statistic taken over short runs
...
OEIS A250730 is ``Number of (1+1)X(n+1) 0..1 arrays with nondecreasing x(i,j)+x(i,j-1) in the i direction and nondecreasing min(x(i,j),x(i-1,j)) in the j direction.''. It has offset $1$ and begins
\[
9, 22, 50, 114, 257, 579, 1302, 2927,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) -a(n-2) -2*a(n-3) +a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 12:44:47, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250730.
