...
\title{The empirical recurrence for OEIS A255102, proved by transfer matrix}
...
\begin{abstract}
OEIS A255102 carries an empirical recurrence of order $6$ contributed by R.~H.~Hardin. It is
...
OEIS A255102 is ``Number of length n+3 0..2 arrays with at most one downstep in every 3 consecutive neighbor pairs.''. It has offset $1$ and begins
\[
66, 168, 441, 1137, 2907, 7498, 19338, 49698,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) -3*a(n-2) +8*a(n-3) -9*a(n-4) +3*a(n-5) -a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 24 2018 10:55:24, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) - 3\,a(n-2) + 8\,a(n-3) - 9\,a(n-4) + 3\,a(n-5) - a(n-6)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A255102.
