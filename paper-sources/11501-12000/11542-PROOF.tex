...
\title{The empirical recurrence for OEIS A234659, proved by transfer matrix}
...
\begin{abstract}
OEIS A234659 counts $2$-column arrays over $\{0,\dots,6\}$ in which every
...
OEIS A234659 is ``Number of (n+1) X (1+1) 0..6 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 4 (constant-stress 1 X 1 tilings).''. It has offset
$1$ and begins
\[
298, 1820, 11112, 68086, 417050, 2564388, 15760606,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 11*a(n-1) + 17*a(n-2) - 492*a(n-3) + 1050*a(n-4) + 1260*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 19 2022 01:03:24, revision 11) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;11\,a(n-1) + 17\,a(n-2) - 492\,a(n-3) + 1050\,a(n-4) + 1260\,a(n-5)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234659.
