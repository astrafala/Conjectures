...
\title{The empirical recurrence for OEIS A251319, proved by transfer matrix}
...
\begin{abstract}
OEIS A251319 counts $(n+1)\times2$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A251319 is ``Number of (n+1) X (1+1) 0..1 arrays with every 2 X 2 subblock having one or two 1s.''. It has offset $1$ and begins
\[
10, 28, 78, 220, 618, 1740, 4894, 13772,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) + 3*a(n-2) - 2*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 28 2018 11:50:56, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251319.
