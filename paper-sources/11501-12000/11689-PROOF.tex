...
\title{The empirical recurrence for OEIS A209507, proved by transfer matrix}
...
\begin{abstract}
OEIS A209507 counts $(n+1)\times5$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A209507 is ``Half the number of (n+1) X 5 0..2 arrays with every 2 X 2 subblock having two or four distinct clockwise edge differences.''. It has offset $1$ and begins
\[
243, 2559, 27225, 290493, 3102219, 33137271, 353991129, 3781613733,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 16*a(n-1) - 65*a(n-2) + 92*a(n-3) - 48*a(n-4) + 8*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 10 2018 13:57:04, revision 8) the statement is
...
\[
a(n)-\sum_i c_i\,a(n-i)\;=\;\tfrac1{2}\mathbf{1}^{\!\top}M^{\,n+1-1-5}\,q(M)\,\mathbf{1} .
\]
...
=\tfrac1{2}\mathbf{1}^{\!\top}M^{\,m-5}\,q(M)\,\mathbf{1}
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209507.
