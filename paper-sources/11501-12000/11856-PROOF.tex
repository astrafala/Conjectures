...
\begin{quote}\small
\textbf{Conjecture:} 2*n*(2*n+3)*(n+3)*(n+1)*a(n) -n*(57*n\^{}3+228*n\^{}2+107*n+8)*a(n-1) +4*(2*n-1) *(33*n\^{}3+99*n\^{}2-88*n+36)*a(n-2) -100*(n-1)*(2*n-1)*(2*n-3)*(n+4)*a(n-3)=0. - \emph{R. J. Mathar}, Jun 07 2016
\end{quote}
...
\[
p_{0}(n)=2 n \left(n + 1\right) \left(n + 3\right) \left(2 n + 3\right),\qquad p_{1}(n)=- n \left(57 n^{3} + 228 n^{2} + 107 n + 8\right),\qquad p_{2}(n)=4 \left(2 n - 1\right) \left(33 n^{3} + 99 n^{2} - 88 n + 36\right),\qquad p_{3}(n)=- 100 \left(n - 1\right) \left(n + 4\right) \left(2 n - 3\right) \left(2 n - 1\right)
\]
...
\[
2 n \left(n + 1\right) \left(n + 3\right) \left(2 n + 3\right)\,a(n) -  n \left(57 n^{3} + 228 n^{2} + 107 n + 8\right)\,a(n-1) + 4 \left(2 n - 1\right) \left(33 n^{3} + 99 n^{2} - 88 n + 36\right)\,a(n-2) -  100 \left(n - 1\right) \left(n + 4\right) \left(2 n - 3\right) \left(2 n - 1\right)\,a(n-3) \;=\;0
\]
holds for every $n>-1$.
\end{theorem}
...
vanish, for all 18 values of $n$ from $n=3$ upward. This is what
