...
\title{The empirical recurrence for OEIS A245992, proved by transfer matrix}
...
\begin{abstract}
OEIS A245992 carries an empirical recurrence of order $2$ contributed by R.~H.~Hardin. It is
...
OEIS A245992 is ``Number of length n+2 0..5 arrays with no pair in any consecutive three terms totalling exactly 5.''. It has offset $1$ and begins
\[
126, 534, 2262, 9582, 40590, 171942, 728358, 3085374,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) +a(n-2).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 10:13:37, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A245992.
