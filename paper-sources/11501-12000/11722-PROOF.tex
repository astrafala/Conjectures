...
\title{The empirical recurrence for OEIS A202441, proved by transfer matrix}
...
\begin{abstract}
OEIS A202441 counts arrays of width $4$ over $\{0,1\}$ containing no occurrence of certain short
...
OEIS A202441 is ``Number of (n+2) X 4 binary arrays avoiding patterns 001 and 110 in rows, columns and nw-to-se diagonals.''. It has offset $1$ and begins
\[
138, 226, 376, 574, 836, 1162, 1568, 2054,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) -2*a(n-2) -2*a(n-3) +3*a(n-4) -a(n-5) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (May 28 2018 18:26:11, revision 10) this is still
...
\text{along a row, left to right} & \mathtt{001},\quad \mathtt{110} \\
\text{down a column} & \mathtt{001},\quad \mathtt{110} \\
\text{down a diagonal, nw to se} & \mathtt{001},\quad \mathtt{110} \\
\end{array}
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A202441.
