...
\title{The empirical recurrence for OEIS A185552, proved by transfer matrix}
...
\begin{abstract}
OEIS A185552 counts $n\times2$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A185552 is ``1/3 the number of n X 2 0..2 arrays with every element equal to exactly one or two of its horizontal and vertical neighbors.''. It has offset $1$ and begins
\[
1, 5, 26, 120, 576, 2768, 13256, 63544,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) + 7*a(n-2) + 8*a(n-3) - 8*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 16 2018 09:09:32, revision 10) this is still
...
$\tfrac1{3}\iota^{\!\top}M^{\,j}q(M)\tau$ for the corresponding walk index $j$, so the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A185552.
