...
\title{The empirical recurrence for OEIS A253007, proved by transfer matrix}
...
\begin{abstract}
OEIS A253007 carries an empirical recurrence of order $4$ contributed by R. H. Hardin. It is
true, and it is decidable rather than empirical. The entry's condition is local to a bounded window of consecutive lines, so
the admissible configurations of such a window are the vertices of a finite digraph and the
arrays counted are exactly the walks in it; hence $a(n)$ is a walk count on $S=220$ vertices
...
\begin{quote}
Empirical: a(n) = (65536/3)*n\^{}3 - 422912*n\^{}2 + (8343128/3)*n - 6208382 for n>9. a(n) = 4*a(n-1) - 6*a(n-2) + 4*a(n-3) - a(n-4) for n>13.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 08 2018 05:43:56, revision 8) this is still
...
admissible array is then exactly a walk, so with $M$ the adjacency matrix on $S=220$ vertices
