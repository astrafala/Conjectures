...
\title{The empirical recurrence for OEIS A301994, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A301994 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A301994 is ``Number of n X 3 0..1 arrays with every element equal to 1, 2 or 4 horizontally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
1, 2, 5, 15, 48, 155, 499, 1602,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 5*a(n-1) - 7*a(n-2) + 4*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 14 2022 02:31:33, revision 12) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A301994.
