...
closed form. Here it equals $3 x^{4} + 12 x^{3} - 18 x^{2} - 12 x + 3$, a polynomial of degree $4$, which proves
...
\begin{quote}\small
\textbf{Conjecture:} (n+1)*(n\^{}2-5*n+3)*a(n) -2*n*(3*n\^{}2-16*n+14)*a(n-1) +2*(n+4)*(n-3)*a(n-2) +2*(5*n\^{}3-31*n\^{}2+39*n+9)*a(n-3) +(-n\^{}3+2*n\^{}2+21)*a(n-4) -2*(2*n-9)*(n\^{}2-3*n-1)*a(n-5)=0. - \emph{R. J. Mathar}, Jun 07 2016
\end{quote}
...
\[
p_{0}(n)=\left(n + 1\right) \left(n^{2} - 5 n + 3\right),\qquad p_{1}(n)=- 2 n \left(3 n^{2} - 16 n + 14\right),\qquad p_{2}(n)=2 \left(n - 3\right) \left(n + 4\right),\qquad p_{3}(n)=2 \left(5 n^{3} - 31 n^{2} + 39 n + 9\right),\qquad p_{4}(n)=- n^{3} + 2 n^{2} + 21,\qquad p_{5}(n)=- 2 \left(2 n - 9\right) \left(n^{2} - 3 n - 1\right)
\]
...
\[
B(x)\;=\;3 x^{4} + 12 x^{3} - 18 x^{2} - 12 x + 3 ,
\]
...
\[
\left(n + 1\right) \left(n^{2} - 5 n + 3\right)\,a(n) -  2 n \left(3 n^{2} - 16 n + 14\right)\,a(n-1) + 2 \left(n - 3\right) \left(n + 4\right)\,a(n-2) + 2 \left(5 n^{3} - 31 n^{2} + 39 n + 9\right)\,a(n-3) + (- n^{3} + 2 n^{2} + 21)\,a(n-4) -  2 \left(2 n - 9\right) \left(n^{2} - 3 n - 1\right)\,a(n-5) \;=\;0
\]
holds for every $n>4$.
\end{theorem}
...
cancellation in $K$, not by series truncation, so the identity $B=3 x^{4} + 12 x^{3} - 18 x^{2} - 12 x + 3$ is an
