...
\title{The empirical recurrence for OEIS A232289, proved by transfer matrix}
...
\begin{abstract}
OEIS A232289 counts arrays of width $2$ over $\{0,1,2\}$ in which every cell carrying one stated
...
OEIS A232289 is ``Number of nX2 0..2 arrays with every 0 next to a 1 and every 1 next to a 2 horizontally or antidiagonally.''. It has offset $1$ and begins
\[
3, 15, 73, 355, 1727, 8401, 40867, 198799,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) +4*a(n-2) +a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 07:15:35, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232289.
