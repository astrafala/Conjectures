...
\title{The empirical recurrence for OEIS A258961, proved by transfer matrix}
...
\begin{abstract}
OEIS A258961 counts $(n+2)\times5$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A258961 is ``Number of (n+2) X (3+2) 0..1 arrays with no 3 X 3 subblock diagonal sum 0 and no antidiagonal sum 3 and no row sum 0 or 3 and no column sum 0 or 3.''. It has offset $1$ and begins
\[
214, 274, 192, 286, 288, 412, 456, 670,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-2) - 2*a(n-4) for n>10.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 24 2018 08:29:37, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A258961.
