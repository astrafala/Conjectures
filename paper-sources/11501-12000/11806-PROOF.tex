...
\title{The empirical recurrence for OEIS A183630, proved by transfer matrix}
...
\begin{abstract}
OEIS A183630 counts $8$-column arrays over $\{0,\dots,2\}$ in which every
...
OEIS A183630 is ``Number of (n+1) X 8 0..2 arrays with every 2 X 2 subblock summing to 4.''. It has offset $1$
and begins
\[
7075, 8109, 10195, 14421, 23035, 40749, 77635, 155781,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 6*a(n-1) - 11*a(n-2) + 6*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 31 2018 14:29:04, revision 12) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A183630.
