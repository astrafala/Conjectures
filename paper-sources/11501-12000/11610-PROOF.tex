...
\title{The empirical recurrence for OEIS A264073, proved by transfer matrix}
...
\begin{abstract}
OEIS A264073 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=5$ columns in which
...
OEIS A264073 is ``Number of (4+1) X (n+1) arrays of permutations of 0..n*5+4 with each element having index change +-(.,.) 0,0 1,1 or 1,2.''. It has offset $1$ and begins
\[
16, 377, 12100, 239580, 5645376, 130697424, 3057071776, 70815364224,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 24*a(n-1) -19*a(n-2) -11*a(n-3) +36*a(n-4) +3*a(n-5) for n > 9.
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 26 2025 19:12:44, revision 11) this is still
...
\[
(i-h_i,\,j-h_j)\;\in\;\{(-2,-1),\ (-1,-1),\ (0,0),\ (1,1),\ (2,1)\},
\]
...
\begin{theorem}
\[
a(n)\;=\;24\,a(n-1) - 19\,a(n-2) - 11\,a(n-3) + 36\,a(n-4) + 3\,a(n-5)
\]
for every $n>9$.
\end{theorem}
...
until the working vector was identically zero, settling every larger $j$ at once. The bound is exact: at $n=9$ the recurrence fails on the entry's own published terms, so no larger range holds.
\end{proof}
...
Second, the transfer model reproduces all $17$ terms this entry publishes, exactly, in
integer arithmetic.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264073.
