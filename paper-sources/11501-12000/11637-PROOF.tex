...
\title{The empirical recurrence for OEIS A320366, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A320366 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A320366 is ``Number of nX3 0..1 arrays with every element unequal to 0, 1, 2, 3 or 4 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
4, 32, 228, 1612, 11396, 80568, 569608, 4027076,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 8*a(n-1) -7*a(n-2) +3*a(n-3)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 11 2018 14:08:47, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;8\,a(n-1) - 7\,a(n-2) + 3\,a(n-3)
\end{equation}
for all $n>4$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A320366.
