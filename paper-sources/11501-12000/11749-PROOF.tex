...
\title{The empirical recurrence for OEIS A303464, proved by transfer matrix}
...
\begin{abstract}
OEIS A303464 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A303464 is ``Number of nX3 0..1 arrays with every element equal to 0, 1, 2, 3, 5 or 6 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
4, 29, 170, 1033, 6369, 39098, 240109, 1476141,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 7*a(n-1) -5*a(n-2) +20*a(n-3) -144*a(n-4) +72*a(n-5) for n>6
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 24 2018 10:39:46, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A303464.
