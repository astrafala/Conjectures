...
\title{The empirical recurrence for OEIS A253497, proved by transfer matrix}
...
\begin{abstract}
OEIS A253497 counts the arrays over $\{0,\dots,2\}$ whose $2\times2$ subblocks carry a
...
OEIS A253497 is ``Number of (3+1) X (n+1) 0..2 arrays with every 2 X 2 subblock diagonal minus antidiagonal sum nondecreasing horizontally, vertically and ne-to-sw antidiagonally.''. It has offset $1$ and begins
\[
1388, 2640, 4196, 6476, 11937, 25715, 60586, 151946,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 6*a(n-1) - 11*a(n-2) + 6*a(n-3) for n>9.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 16 2018 07:12:01, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253497.
