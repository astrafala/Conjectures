...
\title{The empirical recurrence for OEIS A185925, proved by transfer matrix}
...
\begin{abstract}
OEIS A185925 counts arrays over $\{0,\dots,3\}$ under a condition on the trace of every
...
OEIS A185925 is ``Number of (n+1) X 2 0..3 arrays with no 2 X 2 subblock trace equal to any horizontal or vertical neighbor 2 X 2 subblock trace.''. It has offset $1$ and begins
\[
256, 3392, 45184, 601280, 8003200, 106519232, 1417744768, 18869769920,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 6*a(n-1) + 81*a(n-2) + 206*a(n-3) + 144*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 17 2018 06:16:33, revision 9) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A185925.
