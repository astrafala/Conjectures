...
\title{The empirical recurrence for OEIS A251222, proved by transfer matrix}
...
\begin{abstract}
OEIS A251222 counts $(n+1)\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A251222 is ``Number of (n+1) X (2+1) 0..1 arrays with no 2 X 2 subblock having the minimum of its diagonal elements greater than the absolute difference of its antidiagonal elements.''. It has offset $1$ and begins
\[
49, 305, 1892, 11753, 72985, 453273, 2814985, 17482154,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 5*a(n-1) + 9*a(n-2) - 8*a(n-3) - 8*a(n-4) + 3*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 27 2018 09:01:12, revision 9) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251222.
