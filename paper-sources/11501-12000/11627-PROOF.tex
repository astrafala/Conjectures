...
\title{The empirical closed form for OEIS A219680, proved}
...
\begin{abstract}
OEIS A219680 states an explicit closed form for $a(n)$ and records it as empirical. It is true, and
...
OEIS A219680 is ``Number of n X 2 arrays of the minimum value of corresponding elements and their horizontal, vertical or antidiagonal neighbors in a random, but sorted with lexicographically nondecreasing rows and nonincreasing columns, 0..2 n X 2 array.''. It has offset $1$ and begins
\[
3, 4, 9, 19, 35, 60, 98, 154,\ \dots
\]
and states:
\begin{quote}
Empirical: a(n) = (1/24)*n\^{}4 - (1/4)*n\^{}3 + (47/24)*n\^{}2 - (7/4)*n for n>2.
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 26 2018 13:47:29, revision 7)
...
\begin{theorem}
The closed form OEIS A219680 records is correct for all $n>2$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A219680.
