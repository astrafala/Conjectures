...
\title{The empirical recurrence for OEIS A202594, proved by transfer matrix}
...
\begin{abstract}
OEIS A202594 counts arrays of width $3$ over $\{0,1\}$ containing no occurrence of certain short
...
OEIS A202594 is ``Number of (n+2) X 3 binary arrays avoiding patterns 001 and 000 in rows and columns.''. It has offset $1$ and begins
\[
126, 510, 1968, 7722, 30114, 117708, 459690, 1795842,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) +7*a(n-2) +2*a(n-3) -a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 01 2018 10:32:01, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A202594.
