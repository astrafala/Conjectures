...
\title{The empirical recurrence for OEIS A251329, proved by transfer matrix}
...
\begin{abstract}
OEIS A251329 counts $3$-column arrays over $\{0,\dots,2\}$ in which every
...
\mathbf{1}$ for the adjacency matrix $M$ of that digraph, on $S=27$ vertices. Writing
...
OEIS A251329 is ``Number of (n+1) X (2+1) 0..2 arrays with every 2 X 2 subblock summing to 2 4 or 6.''. It has offset $1$
and begins
\[
171, 1115, 7393, 49937, 343299, 2399159, 17016861, 122275189,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 18*a(n-1) - 98*a(n-2) + 100*a(n-3) + 331*a(n-4) + 42*a(n-5) - 72*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 16 2024 18:53:37, revision 12) the statement is
...
Let $V=\{0,1,\dots,2\}^{3}$, the set of possible rows, so $|V|=S=27$. For
...
bound $j<S=27$ rather than to a sampled prefix, in exact integer arithmetic, and returned
zero throughout.

\begin{thebibliography}{9}
\bibitem{oeis} The OEIS Foundation, \emph{The On-Line Encyclopedia of Integer
Sequences}, \url{https://oeis.org}, 2026. Sequence A251329.
