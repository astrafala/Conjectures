...
\title{The empirical recurrence for OEIS A183785, proved by transfer matrix}
...
\begin{abstract}
OEIS A183785 counts $(n+1)\times3$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A183785 is ``Half the number of (n+1) X 3 0..2 arrays with no 2 X 2 subblock having sum 4.''. It has offset $1$ and begins
\[
216, 3552, 57966, 948164, 15497634, 253372446, 4142036148, 67714639662,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 12*a(n-1) + 90*a(n-2) - 279*a(n-3) - 618*a(n-4) + 2092*a(n-5) - 1344*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 04 2018 12:09:32, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;12\,a(n-1) + 90\,a(n-2) - 279\,a(n-3) - 618\,a(n-4) + 2092\,a(n-5) - 1344\,a(n-6)
\end{equation}
for all $n>5$.
...
\[
a(n)-\sum_i c_i\,a(n-i)\;=\;\tfrac1{2}\mathbf{1}^{\!\top}M^{\,n+1-1-6}\,q(M)\,\mathbf{1} .
\]
...
=\tfrac1{2}\mathbf{1}^{\!\top}M^{\,m-6}\,q(M)\,\mathbf{1}
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A183785.
