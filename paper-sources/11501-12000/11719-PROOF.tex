...
\title{The empirical recurrence for OEIS A185791, proved by transfer matrix}
...
\begin{abstract}
OEIS A185791 counts arrays over $\{0,\dots,1\}$ under a condition on the sum of every
...
OEIS A185791 is ``Number of (n+1) X 3 binary arrays with no 2 X 2 subblock sum equal to any horizontal or vertical neighbor 2 X 2 subblock sum.''. It has offset $1$ and begins
\[
40, 96, 224, 576, 1408, 3456, 8320, 20864,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + 2*a(n-2) + 16*a(n-4) - 16*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 16 2018 16:47:43, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A185791.
