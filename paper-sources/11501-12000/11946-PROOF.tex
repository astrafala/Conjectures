...
\title{The empirical recurrence for OEIS A252935, proved by transfer matrix}
...
\begin{abstract}
OEIS A252935 carries an empirical recurrence of order $4$ contributed by R. H. Hardin. It is
true, and it is decidable rather than empirical. The entry's condition is local to a bounded window of consecutive lines, so
the admissible configurations of such a window are the vertices of a finite digraph and the
arrays counted are exactly the walks in it; hence $a(n)$ is a walk count on $S=504$ vertices
...
\begin{quote}
Empirical: a(n) = (133120/3)*n\^{}3 - 760496*n\^{}2 + (13526246/3)*n - 9199709 for n>8. a(n) = 4*a(n-1) - 6*a(n-2) + 4*a(n-3) - a(n-4) for n>12.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 07 2018 11:51:50, revision 8) this is still
...
admissible array is then exactly a walk, so with $M$ the adjacency matrix on $S=504$ vertices
