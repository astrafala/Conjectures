...
\title{The empirical recurrence for OEIS A220733, proved by transfer matrix}
...
\begin{abstract}
OEIS A220733 counts the ways of linking the cells of a grid $3$ cells wide, each cell either to
...
OEIS A220733 is ``Number of ways to reciprocally link elements of an n X 3 array either to themselves or to exactly two horizontal, diagonal and antidiagonal neighbors, without consecutive collinear links.''. It has offset $1$ and begins
\[
1, 5, 22, 72, 258, 949, 3403, 12241,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + 3*a(n-2) + 9*a(n-3) + 4*a(n-4) - a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 03 2018 05:09:02, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 3\,a(n-2) + 9\,a(n-3) + 4\,a(n-4) - a(n-5)
\]
for every $n>4$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A220733.
