...
\title{The empirical recurrence for OEIS A252834, proved by transfer matrix}
...
\begin{abstract}
OEIS A252834 carries an empirical recurrence of order $3$ contributed by R. H. Hardin. It is
true, and it is decidable rather than empirical. The entry's condition is local to a bounded window of consecutive lines, so
the admissible configurations of such a window are the vertices of a finite digraph and the
arrays counted are exactly the walks in it; hence $a(n)$ is a walk count on $S=640$ vertices
...
\begin{quote}
Empirical: a(n) = 90112*n\^{}2 - 1032064*n + 3059590 for n>9. a(n) = 3*a(n-1) - 3*a(n-2) + a(n-3) for n>12.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 07 2018 06:16:50, revision 7) this is still
...
admissible array is then exactly a walk, so with $M$ the adjacency matrix on $S=640$ vertices
