...
\title{The empirical recurrence for OEIS A229366, proved by transfer matrix}
...
\begin{abstract}
OEIS A229366 counts arrays of width $2$ over $\{0,1,2\}$ containing no occurrence of certain short
...
OEIS A229366 is ``Number of n X 2 0..2 arrays avoiding 11 horizontally, 22 vertically and 00 antidiagonally.''. It has offset $1$ and begins
\[
8, 38, 184, 869, 4144, 19675, 93589, 444824,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + 13*a(n-2) + 3*a(n-3) - 13*a(n-4) + 4*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 14 2018 16:12:37, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 13\,a(n-2) + 3\,a(n-3) - 13\,a(n-4) + 4\,a(n-5)
\]
for every $n>4$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A229366.
