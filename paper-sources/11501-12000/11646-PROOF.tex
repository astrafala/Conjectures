...
\title{The empirical recurrence for OEIS A196204, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A196204 counts arrays over $\{0,\dots,4\}$ in which every cell is constrained by the
...
OEIS A196204 is ``Number of n X 2 0..4 arrays with each element x equal to the number its horizontal and vertical neighbors equal to 2,0,3,4,1 for x=0,1,2,3,4.''. It has offset $1$ and begins
\[
3, 5, 8, 11, 18, 28, 43, 67,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) - a(n-4) - a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 01 2018 05:34:50, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A196204.
