...
\title{The empirical recurrence for OEIS A223434, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A223434 counts arrays over $\{0,\dots,15\}$ in which every cell is constrained by the
...
OEIS A223434 is ``Generalized Petersen graph (8,2) coloring a rectangular array: number of n X 2 0..15 arrays where 0..15 label nodes of a graph with edges 0,1 0,8 8,14 8,10 1,2 1,9 9,15 9,11 2,3 2,10 10,12 3,4 3,11 11,13 4,5 4,12 12,14 5,6 5,13 13,15 6,7 6,14 7,0 7,15 and every array movement to a horizontal or vertical neighbor moves along an edge of this graph.''. It has offset $1$ and begins
\[
48, 256, 1376, 7424, 40160, 217600, 1180256, 6405888,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 8*a(n-1) - 11*a(n-2) - 16*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 16 2018 07:23:54, revision 7) the statement is
...
Let $V=\{0,\dots,15\}^{2}$ be the possible rows and take
...
of the $(15+1)^{2}$ possible next rows, the condition was tested on every cell of
the middle row. The vector $w$ was formed by $3$ applications of $G$ in exact integer
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223434.
