...
\title{The empirical recurrence for OEIS A196700, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A196700 counts arrays over $\{0,\dots,4\}$ in which every cell is constrained by the
...
OEIS A196700 is ``Number of n X 1 0..4 arrays with each element x equal to the number of its horizontal and vertical neighbors equal to 3,1,0,4,2 for x=0,1,2,3,4.''. It has offset $1$ and begins
\[
1, 2, 4, 6, 12, 22, 40, 74,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) + a(n-2) + a(n-3) for n > 4.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 18 2018 23:45:38, revision 52) the statement is
...
publishes, $n=34$, the arrays have $1\cdot34$ cells over
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A196700.
