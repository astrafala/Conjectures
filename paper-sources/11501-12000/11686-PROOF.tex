...
\title{The empirical recurrence for OEIS A243027, proved by transfer matrix}
...
\begin{abstract}
OEIS A243027 carries an empirical recurrence of order $3$ contributed by R.~H.~Hardin. It is
...
OEIS A243027 is ``Number of length n+3 0..2 arrays with no four elements in a row with pattern abba (possibly a=b) and new values 0..2 introduced in 0..2 order.''. It has offset $1$ and begins
\[
12, 32, 85, 226, 601, 1598, 4249, 11298,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + a(n-2) + 2*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 01 2018 11:39:16, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A243027.
