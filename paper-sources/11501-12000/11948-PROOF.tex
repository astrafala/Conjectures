...
\title{The empirical recurrence for OEIS A301959, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A301959 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A301959 is ``Number of nX3 0..1 arrays with every element equal to 0, 1 or 4 horizontally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
3, 6, 16, 40, 100, 252, 632, 1588,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +3*a(n-2) +2*a(n-3)
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 29 2018 12:58:40, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 3\,a(n-2) + 2\,a(n-3)
\end{equation}
for all $n>4$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A301959.
