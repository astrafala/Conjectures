...
\title{The empirical recurrence for OEIS A239028: recovering a conjecture that is not written down}
...
\begin{abstract}
OEIS A239028 records ``Empirical recurrence of order $90$'', with the recurrence itself in a
...
OEIS A239028 is ``Number of nX6 0..2 arrays with no element equal to the sum of elements to its left or one plus the sum of elements above it, modulo 3.''. It has offset $1$ and begins
\[
1, 7, 22, 189, 757, 7265, 33699, 339315,\ \dots
\]
The entry states:
\begin{quote}
Empirical recurrence of order 90 (see link above)
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 09:23:00, revision 9) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A239028.
