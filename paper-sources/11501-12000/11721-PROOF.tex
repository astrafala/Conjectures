...
\title{The empirical recurrence for OEIS A298234, proved by transfer matrix}
...
\begin{abstract}
OEIS A298234 counts $2$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A298234 is ``Number of nX2 0..1 arrays with every element equal to 0, 2, 3, 4 or 5 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 5, 13, 42, 127, 389, 1192, 3645,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +5*a(n-2) +4*a(n-3)
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 15 2018 09:42:31, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A298234.
