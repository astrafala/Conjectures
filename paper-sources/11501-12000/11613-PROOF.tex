...
\title{The empirical recurrence for OEIS A186478, proved by transfer matrix}
...
\begin{abstract}
OEIS A186478 counts the $(n+1)\times6$ arrays over $\{0,\dots,3\}$ in which
...
a state, the count is a walk count on $S=4895$ of them, and the conjectured recurrence is then
...
OEIS A186478 is ``Number of (n+1)X6 0..3 arrays with every 2X2 subblock commuting with each of its horizontal and vertical 2X2 subblock neighbors.''. It has offset $1$ and begins
\[
4895, 3442, 20224, 25633, 107353, 108025, 433513, 479785,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n)=2*a(n-1)+2*a(n-2)-6*a(n-3)+6*a(n-4)-3*a(n-5) for n>16
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 03:31:33, revision 10) this is still
...
$4895$, which the model reproduces along with every later term.
...
\]
on the $S=4895$ admissible $2$-tuples. In particular $a$ is $C$-finite.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A186478.
