...
\title{The empirical recurrence for OEIS A280669, proved by transfer matrix}
...
\begin{abstract}
OEIS A280669 counts $n\times4$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A280669 is ``Number of n X 4 0..2 arrays with no element equal to more than one of its horizontal and antidiagonal neighbors and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
11, 338, 10205, 310365, 9439606, 287101721, 8732086113, 265582964074,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 29*a(n-1) + 44*a(n-2) - 27*a(n-3) - 81*a(n-4) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 14 2019 07:44:34, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;29\,a(n-1) + 44\,a(n-2) - 27\,a(n-3) - 81\,a(n-4)
\]
for every $n>5$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A280669.
