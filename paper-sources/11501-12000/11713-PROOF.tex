...
\title{The empirical recurrence for OEIS A299590, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A299590 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A299590 is ``Number of n X 3 0..1 arrays with every element unequal to 0, 1 or 4 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
3, 3, 5, 11, 19, 35, 65, 120,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +2*a(n-3) +a(n-4) +a(n-5) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 15 2018 12:04:15, revision 7) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 2\,a(n-3) + a(n-4) + a(n-5)
\end{equation}
for all $n>8$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A299590.
