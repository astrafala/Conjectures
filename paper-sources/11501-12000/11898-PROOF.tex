...
\title{The empirical recurrence for OEIS A253351, proved by transfer matrix}
...
\begin{abstract}
OEIS A253351 counts the arrays over $\{0,\dots,1\}$ whose $2\times2$ subblocks carry a
...
OEIS A253351 is ``Number of (2+1) X (n+1) 0..1 arrays with every 2 X 2 subblock diagonal maximum minus antidiagonal maximum nondecreasing horizontally, vertically and ne-to-sw antidiagonally.''. It has offset $1$ and begins
\[
47, 173, 724, 3160, 13810, 60368, 263920, 1153880,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 5*a(n-1) - 12*a(n-3) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 11 2018 08:59:59, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253351.
