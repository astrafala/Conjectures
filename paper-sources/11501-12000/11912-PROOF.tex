...
\title{The empirical recurrence for OEIS A185514, proved by transfer matrix}
...
\begin{abstract}
OEIS A185514 counts arrays over $\{0,\dots,2\}$ under a condition on the determinant of every
...
OEIS A185514 is ``Number of (n+1) X 3 0..2 arrays with every 2 X 2 subblock singular.''. It has offset $1$ and begins
\[
143, 1489, 12361, 115979, 1058503, 9856209, 91539073, 853020411,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 12*a(n-1) - 11*a(n-2) - 154*a(n-3) + 224*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 16 2018 08:42:24, revision 8) this is still
...
first term is $143$, and the model reproduces it along with every later term; that is the
...
\begin{theorem}
\[
a(n)\;=\;12\,a(n-1) - 11\,a(n-2) - 154\,a(n-3) + 224\,a(n-4)
\]
for every $n>3$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A185514.
