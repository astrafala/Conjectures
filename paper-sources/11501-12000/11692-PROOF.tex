...
\title{The empirical recurrence for OEIS A258965, proved by transfer matrix}
...
\begin{abstract}
OEIS A258965 counts $(n+2)\times9$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A258965 is ``Number of (n+2) X (7+2) 0..1 arrays with no 3 X 3 subblock diagonal sum 0 and no antidiagonal sum 3 and no row sum 0 or 3 and no column sum 0 or 3.''. It has offset $1$ and begins
\[
2040, 1228, 456, 662, 552, 788, 720, 1046,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-2) - 2*a(n-4) for n>10.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 24 2018 08:30:12, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A258965.
