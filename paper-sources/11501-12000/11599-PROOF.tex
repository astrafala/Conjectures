...
\title{The empirical recurrence for OEIS A260131, proved by transfer matrix}
...
\begin{abstract}
OEIS A260131 counts $(n+2)\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A260131 is ``Number of (n+2) X (1+2) 0..1 arrays with each 3 X 3 subblock having clockwise perimeter pattern 00010101 01010101 or 01010111.''. It has offset $1$ and begins
\[
36, 58, 138, 266, 472, 944, 1880, 3562,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + 3*a(n-3) + a(n-4) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 28 2018 09:06:27, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A260131.
