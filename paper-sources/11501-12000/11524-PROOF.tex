...
\title{The empirical recurrence for OEIS A206131, proved by transfer matrix}
...
\begin{abstract}
OEIS A206131 counts arrays over $\{0,\dots,3\}$ under a condition on the perimeter cycle of
...
a bounded window of consecutive rows, so the count is a walk count on $S=564$ states and is
...
OEIS A206131 is ``Number of (n+1) X 3 0..3 arrays with every 2 X 3 or 3 X 2 subblock having exactly three counterclockwise and three clockwise edge increases.''. It has offset $1$ and begins
\[
564, 6668, 91924, 1269044, 17521788, 241927532, 3340355572, 46121153588,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 17*a(n-1) - 47*a(n-2) + 41*a(n-3) - 10*a(n-4) for n > 5.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 13 2018 14:48:34, revision 16) this is still
...
\begin{theorem}
\[
a(n)\;=\;17\,a(n-1) - 47\,a(n-2) + 41\,a(n-3) - 10\,a(n-4)
\]
for every $n>5$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206131.
