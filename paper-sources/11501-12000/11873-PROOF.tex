...
\title{An element and the cells around it: OEIS A180752}
...
\begin{abstract}
OEIS A180752 carries an empirical recurrence of order $5$ contributed by R.~H.~Hardin. It is
...
OEIS A180752 is ``Half the number of nX3 binary arrays with each element equal to at least two neighbors.''. It has offset $1$ and begins
\[
0, 1, 1, 2, 3, 7, 14, 31,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + a(n-2) - a(n-3) - a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 01:08:19, revision 9) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{The count is a walk count}

The entry counts arrays with $3$ columns over the alphabet $\{0,1\}$, growing one row at a time, and asks that every element must equal at least $2$ of its horizontal and vertical neighbours.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A180752.
