...
\title{The empirical recurrence for OEIS A304349, proved by transfer matrix}
...
\begin{abstract}
OEIS A304349 counts $2$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A304349 is ``Number of nX2 0..1 arrays with every element unequal to 0, 1, 3, 4 or 5 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
2, 5, 9, 21, 57, 125, 289, 741,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) -a(n-2) +8*a(n-3) -8*a(n-4)
\end{quote}
As of the ``Last modified'' line on the live entry (May 11 2018 14:21:14, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) - a(n-2) + 8\,a(n-3) - 8\,a(n-4)
\end{equation}
for all $n>4$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A304349.
