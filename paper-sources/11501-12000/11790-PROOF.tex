...
\title{The empirical recurrence for OEIS A228386, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A228386 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A228386 is ``Number of n X 4 binary arrays with top left value 1 and no two ones adjacent horizontally or vertically.''. It has offset $1$ and begins
\[
3, 12, 72, 382, 2104, 11449, 62546, 341249,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 4*a(n-1) +9*a(n-2) -5*a(n-3) -4*a(n-4) +a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 11 2018 05:41:10, revision 10) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A228386.
