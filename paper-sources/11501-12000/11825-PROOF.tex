...
\title{The empirical recurrence for OEIS A232453, proved by transfer matrix}
...
\begin{abstract}
OEIS A232453 counts arrays of width $2$ over $\{0,1,2\}$ in which every cell carrying one stated
...
OEIS A232453 is ``Number of n X 2 0..2 arrays with every 0 next to a 1 and every 1 next to a 2 horizontally, vertically, diagonally or antidiagonally.''. It has offset $1$ and begins
\[
3, 51, 381, 3015, 24651, 198945, 1607067, 12991131,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 6*a(n-1) + 12*a(n-2) + 39*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 05 2018 12:00:25, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232453.
