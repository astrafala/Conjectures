...
\title{The empirical recurrence for OEIS A302006, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A302006 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A302006 is ``Number of nX4 0..1 arrays with every element equal to 0, 1, 2 or 3 horizontally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
8, 128, 1808, 25808, 368144, 5251712, 74917424, 1068722240,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 13*a(n-1) +18*a(n-2) +a(n-3) -4*a(n-4)
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 30 2018 12:50:09, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;13\,a(n-1) + 18\,a(n-2) + a(n-3) - 4\,a(n-4)
\end{equation}
for all $n>5$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302006.
