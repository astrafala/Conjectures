...
\title{Recovering the unwritten recurrences of the table OEIS A237538}
...
\begin{abstract}
OEIS A237538 is a two-dimensional table $T(n,k)$ whose empirical recurrences are, for several of
...
OEIS A237538 is ``T(n,k)=Number of (n+1)X(k+1) 0..3 arrays with the upper median minus the lower median of every 2X2 subblock equal.''. It is read by antidiagonals and begins
\[
256, 1692, 1692, 11602, 23680, 11602, 83104, 330210,\ \dots
\]
The entry carries, among its empirical claims:
\begin{quote}\small
k=2: [order 38]
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 10:15:46, revision 6) these are still
...
count, a walk on $S=186$ vertices. Berlekamp--Massey on $2S=372$ exact terms
returns a minimal recurrence of order $38$ --- the order the entry states --- with
integer coefficients
\[
(c_1,\dots,c_{38})=(47,\ -675,\ -810,\ 107490,\ -753870,\ -3728513,\ 65859073,\ -123687800,\ -2007587521,\ 10800711085,\ 16437340004,\ -264618937482,\ 369214865044,\ 2894230333829,\ -9979447783839,\ -10944096685319,\ 100654415455700,\ -69129777741518,\ -511744167031420,\ 978711927496840,\ 1107715147870232,\ -4746153386626400,\ 1182455795364544,\ 11288425244052672,\ -12064396386569728,\ -10967797365122048,\ 25840597232986112,\ -3924169727397888,\ -22676299835465728,\ 15318553143066624,\ 6317603403530240,\ -9914010538475520,\ 1568639825215488,\ 2013635656286208,\ -854911508021248,\ -16545757528064,\ 50490024919040,\ -4423816314880).
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237538.
