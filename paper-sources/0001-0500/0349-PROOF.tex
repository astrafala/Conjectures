...
\title{The empirical recurrence for OEIS A220372, proved by transfer matrix}
...
\begin{abstract}
OEIS A220372 counts the distinct indicator arrays obtained from the $n\times2$ arrays over
...
indicator row by row turns it into one, on $S=97$ states, after which the conjectured
...
OEIS A220372 is ``Equals two maps: number of nX2 binary arrays indicating the locations of corresponding elements equal to exactly two of their horizontal and vertical neighbors in a random 0..2 nX2 array.''. It has offset $1$ and begins
\[
1, 6, 23, 94, 380, 1494, 5939, 23398,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 18:44:15, revision 9) this is still
...
\]
There are $S=97$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite. Note
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-1) - 21\,a(n-2) + 23\,a(n-3) - 17\,a(n-4) + 11\,a(n-5) + 55\,a(n-6) - 199\,a(n-7) + 241\,a(n-8) - 157\,a(n-9) - 14\,a(n-10) + 217\,a(n-11) - 546\,a(n-12) + 850\,a(n-13) - 927\,a(n-14) + 254\,a(n-15) + 555\,a(n-16) - 375\,a(n-17) + 150\,a(n-18) + 848\,a(n-19) + 368\,a(n-20) + 998\,a(n-21) + 666\,a(n-22) + 1091\,a(n-23) + 2744\,a(n-24) + 1499\,a(n-25) + 3393\,a(n-26) + 1420\,a(n-27) + 3704\,a(n-28) - 272\,a(n-29) + 3190\,a(n-30) - 1290\,a(n-31) + 1774\,a(n-32) - 418\,a(n-33) + 486\,a(n-34) - 72\,a(n-35) + 68\,a(n-36) - 8\,a(n-37)
\]
for every $n>37$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A220372.
