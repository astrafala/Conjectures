...
\title{The empirical recurrence for OEIS A264258, proved by transfer matrix}
...
\begin{abstract}
OEIS A264258 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=3$ columns in which
...
OEIS A264258 is ``Number of (2+1)X(n+1) arrays of permutations of 0..n*3+2 with each element having directed index change 0,1 0,-1 0,2 1,0 or -1,0.''. It has offset $1$ and begins
\[
9, 33, 157, 1124, 5468, 32361, 181644, 1005279,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 10 2015 12:01:12, revision 6) this is still
...
\[
(i-h_i,\,j-h_j)\;\in\;\{(-1,0),\ (0,-1),\ (0,1),\ (1,0),\ (2,0)\},
\]
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 17\,a(n-2) + 43\,a(n-3) - 83\,a(n-4) - 228\,a(n-5) - 480\,a(n-6) + 71\,a(n-7) + 609\,a(n-8) + 2735\,a(n-9) + 2856\,a(n-10) + 3120\,a(n-11) - 2421\,a(n-12) - 9482\,a(n-13) - 15686\,a(n-14) - 15853\,a(n-15) - 3218\,a(n-16) + 19635\,a(n-17) + 34505\,a(n-18) + 38737\,a(n-19) + 6502\,a(n-20) - 13346\,a(n-21) - 42550\,a(n-22) - 21272\,a(n-23) - 15028\,a(n-24) + 21102\,a(n-25) - 1882\,a(n-26) + 11158\,a(n-27) - 14067\,a(n-28) + 12940\,a(n-29) - 3299\,a(n-30) + 12679\,a(n-31) - 7545\,a(n-32) + 3298\,a(n-33) - 5594\,a(n-34) + 2651\,a(n-35) - 1511\,a(n-36) + 1117\,a(n-37) - 692\,a(n-38) + 246\,a(n-39) - 165\,a(n-40) + 132\,a(n-41) - 10\,a(n-42) + 19\,a(n-43) - 16\,a(n-44) - a(n-45) - a(n-46) + a(n-47)
\]
for every $n>45$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264258.
