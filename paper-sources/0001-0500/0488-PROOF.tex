...
\title{The empirical recurrence for OEIS A221770, proved by transfer matrix}
...
\begin{abstract}
OEIS A221770 counts the distinct OCCUPANCY arrays obtained when every cell of an $n\times3$ grid
...
an empirical recurrence of order $18$ contributed by R.~H.~Hardin. It is true, and it is
...
one, on $S=3417$ states, after which the conjectured recurrence is settled by a finite exact
computation.
\end{abstract}
...
OEIS A221770 is ``Number of nX3 arrays of occupancy after each element stays put or moves to some horizontal or vertical neighbor, without move-in move-out left turns.''. It has offset $1$ and begins
\[
8, 240, 7371, 225873, 6916881, 211747695, 6481445220, 198382906386,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 19:57:01, revision 8) this is still
...
$S=3417$ reachable sets. In particular $a$ is $C$-finite.
...
\begin{theorem}
\[
a(n)\;=\;84\,a(n-1) - 2905\,a(n-2) + 56716\,a(n-3) - 709393\,a(n-4) + 6061574\,a(n-5) - 36651293\,a(n-6) + 159758786\,a(n-7) - 505601632\,a(n-8) + 1158517028\,a(n-9) - 1893716704\,a(n-10) + 2129563639\,a(n-11) - 1500050698\,a(n-12) + 447745570\,a(n-13) + 217671350\,a(n-14) - 275450748\,a(n-15) + 109467496\,a(n-16) - 17701536\,a(n-17) + 715760\,a(n-18)
\]
for every $n>18$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221770.
