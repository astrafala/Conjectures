...
\title{The empirical recurrence for OEIS A264301, proved by transfer matrix}
...
\begin{abstract}
OEIS A264301 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=3$ columns in which
...
OEIS A264301 is ``Number of (2+1)X(n+1) arrays of permutations of 0..n*3+2 with each element having directed index change 0,1 0,-2 1,0 or -1,0.''. It has offset $1$ and begins
\[
0, 9, 8, 24, 177, 288, 944, 4209,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 11 2015 07:43:54, revision 4) this is still
...
\[
(i-h_i,\,j-h_j)\;\in\;\{(-2,0),\ (0,-1),\ (0,1),\ (1,0)\},
\]
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) - a(n-2) + 19\,a(n-3) - 22\,a(n-4) + 35\,a(n-5) - 55\,a(n-6) + 46\,a(n-7) - 103\,a(n-8) - 27\,a(n-9) - 106\,a(n-10) + 133\,a(n-11) + 270\,a(n-12) + 548\,a(n-13) - 330\,a(n-14) - 218\,a(n-15) - 1668\,a(n-16) + 622\,a(n-17) - 350\,a(n-18) + 2004\,a(n-19) - 766\,a(n-20) + 922\,a(n-21) - 1476\,a(n-22) + 522\,a(n-23) - 493\,a(n-24) + 586\,a(n-25) - 133\,a(n-26) + 135\,a(n-27) - 118\,a(n-28) + 31\,a(n-29) - 11\,a(n-30) + 14\,a(n-31) - 11\,a(n-32) + a(n-33) - 2\,a(n-34) + a(n-35)
\]
for every $n>33$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264301.
