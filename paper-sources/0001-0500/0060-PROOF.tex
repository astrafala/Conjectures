...
\title{The empirical recurrence for OEIS A211816, proved by a one-dimensional reduction}
...
\begin{abstract}
OEIS A211816 counts symmetric $(n+1)\times(n+1)$ matrices over
$\{-10,\dots,10\}$ in which every $2\times2$ subblock sums to zero and has two or three distinct
...
on $S=1658$ states, and the empirical recurrence of order $34$ contributed by R.~H.~Hardin
follows.
\end{abstract}
...
OEIS A211816 is ``Number of (n+1)X(n+1) -10..10 symmetric matrices with every 2X2 subblock having sum zero and two or three distinct values.''. It has offset $1$ and begins
\[
220, 602, 1368, 2942, 6088, 12442, 24924, 50194,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 16:22:59, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{The sum-zero condition solved}

Let $x$ be an $N\times N$ symmetric matrix with entries in $\{-10,\dots,10\}$ such that
\[
...
\qquad u_0,\dots,u_{N-1}\in\{-10,\dots,10\}\ \text{all of the same parity},
\]
...
the same parity; and $|x(i,j)|=|u_i+u_j|/2\le10$ for all $i,j$ is equivalent to $|u_i|\le10$
...
$\{-10,\dots,10\}$ with all entries of one parity. What remains is to say, in terms of $u$,
that every $2\times2$ subblock has two or three distinct entries.
...
Call two consecutive pairs COMPATIBLE when that number lies in $\{2,3\}$. The condition on the
...
the compatibility graph on the $\le 441$ pairs.
\end{corollary}
...
$S=1658$. The two parity classes never mix, so the walk starts by choosing a parity and a first
value, and every state may end a sequence:
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad \tau=\mathbf{1},\qquad S=1658.
\]
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) + 16\,a(n-2) - 160\,a(n-3) - 15\,a(n-4) + 1883\,a(n-5) - 1614\,a(n-6) - 12827\,a(n-7) + 18643\,a(n-8) + 55534\,a(n-9) - 110733\,a(n-10) - 156457\,a(n-11) + 420605\,a(n-12) + 273571\,a(n-13) - 1096609\,a(n-14) - 220702\,a(n-15) + 2018897\,a(n-16) - 191679\,a(n-17) - 2645653\,a(n-18) + 814093\,a(n-19) + 2453538\,a(n-20) - 1164914\,a(n-21) - 1580007\,a(n-22) + 985631\,a(n-23) + 680255\,a(n-24) - 535843\,a(n-25) - 180672\,a(n-26) + 188098\,a(n-27) + 23218\,a(n-28) - 41026\,a(n-29) + 676\,a(n-30) + 5032\,a(n-31) - 568\,a(n-32) - 264\,a(n-33) + 48\,a(n-34)
\]
for every $n>34$.
\end{theorem}
...
symmetric matrices were written out entry by entry over $\{-10,\dots,10\}$ and each
$2\times2$ subblock tested for summing to zero and for having two or three distinct entries. The
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A211816.
