...
\title{The empirical recurrence for OEIS A217960, proved by transfer matrix}
...
\begin{abstract}
OEIS A217960 counts the distinct arrays obtained by applying a fixed local operation to every cell
...
$S=396$ states, after which the conjectured recurrence is settled by a finite exact
computation.
\end{abstract}
...
OEIS A217960 is ``Number of nX4 arrays of the minimum value of corresponding elements and their horizontal or antidiagonal neighbors in a random 0..2 nX4 array.''. It has offset $1$ and begins
\[
17, 321, 5415, 93765, 1602741, 27317977, 465184959, 7919256577,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 17:29:07, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

Let $R=\{0,\dots,2\}^{4}$ be the set of rows and let the neighbours of
...
\]
There are $S=396$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite.
...
\begin{theorem}
\[
a(n)\;=\;19\,a(n-1) - 23\,a(n-2) - 144\,a(n-3) - 675\,a(n-4) + 378\,a(n-5) + 3291\,a(n-6) + 4937\,a(n-7) - 1247\,a(n-8) - 12054\,a(n-9) - 12369\,a(n-10) - 5436\,a(n-11) - 816\,a(n-12) + 744\,a(n-13) + 364\,a(n-14) + 100\,a(n-15)
\]
for every $n>16$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A217960.
