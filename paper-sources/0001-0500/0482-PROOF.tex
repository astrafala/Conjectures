...
\title{The empirical recurrence for OEIS A218811, proved by transfer matrix}
...
\begin{abstract}
OEIS A218811 counts the distinct indicator arrays obtained from the $n\times2$ arrays over
...
indicator row by row turns it into one, on $S=63$ states, after which the conjectured
...
OEIS A218811 is ``Hilltop maps: number of 2Xn binary arrays indicating the locations of corresponding elements not exceeded by any horizontal or antidiagonal neighbor in a random 0..3 2Xn array.''. It has offset $1$ and begins
\[
1, 15, 61, 249, 993, 3969, 15871, 63467,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 17:46:40, revision 8) this is still
...
\]
There are $S=63$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite. Note
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + 3\,a(n-2) + 3\,a(n-3) + 3\,a(n-4) + 3\,a(n-5) + a(n-6) + 5\,a(n-7) + 2\,a(n-8) + 2\,a(n-9) + 2\,a(n-10) + 2\,a(n-11) + a(n-12) + a(n-13) - a(n-14) - a(n-15) - a(n-16) - a(n-17) - a(n-18) - a(n-19)
\]
for every $n>20$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A218811.
