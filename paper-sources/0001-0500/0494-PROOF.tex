...
\title{The empirical recurrence for OEIS A264240, proved by transfer matrix}
...
\begin{abstract}
OEIS A264240 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=5$ rows in which
...
OEIS A264240 is ``Number of (n+1)X(4+1) arrays of permutations of 0..n*5+4 with each element having directed index change 0,0 1,1 0,-1 -1,1 or 0,-2.''. It has offset $1$ and begins
\[
57, 557, 9005, 119737, 1696877, 23471441, 327315125, 4550623993,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 10 2015 11:48:31, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;19\,a(n-1) - 42\,a(n-2) - 600\,a(n-3) + 2768\,a(n-4) + 2064\,a(n-5) - 29636\,a(n-6) + 37104\,a(n-7) + 54432\,a(n-8) - 121808\,a(n-9) + 3440\,a(n-10) + 66048\,a(n-11) + 320\,a(n-12) + 115712\,a(n-13) - 190720\,a(n-14) - 115456\,a(n-15) + 246016\,a(n-16) + 15360\,a(n-17) - 81920\,a(n-18)
\]
for every $n>16$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264240.
