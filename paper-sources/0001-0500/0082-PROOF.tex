...
\title{The empirical recurrence for OEIS A211468, proved by a one-dimensional reduction}
...
\begin{abstract}
OEIS A211468 counts symmetric $(n+1)\times(n+1)$ matrices over
$\{-8,\dots,8\}$ in which every $2\times2$ subblock sums to zero and has one or three distinct
...
on $S=513$ states, and the empirical recurrence of order $16$ contributed by R.~H.~Hardin
follows.
\end{abstract}
...
OEIS A211468 is ``Number of (n+1)X(n+1) -8..8 symmetric matrices with every 2X2 subblock having sum zero and one or three distinct values.''. It has offset $1$ and begins
\[
121, 277, 565, 1101, 2135, 4047, 7739, 14661,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 16:11:19, revision 8) this is still
...
$S=513$. The two parity classes never mix, so the walk starts by choosing a parity and a first
value, and every state may end a sequence:
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad \tau=\mathbf{1},\qquad S=513.
\]
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + 13\,a(n-2) - 43\,a(n-3) - 68\,a(n-4) + 255\,a(n-5) + 185\,a(n-6) - 810\,a(n-7) - 289\,a(n-8) + 1487\,a(n-9) + 292\,a(n-10) - 1577\,a(n-11) - 242\,a(n-12) + 895\,a(n-13) + 170\,a(n-14) - 210\,a(n-15) - 60\,a(n-16)
\]
for every $n>16$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A211468.
