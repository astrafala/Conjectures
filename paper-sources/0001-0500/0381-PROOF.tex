...
\title{The empirical recurrence for OEIS A264252, proved by transfer matrix}
...
\begin{abstract}
OEIS A264252 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=4$ rows in which
...
OEIS A264252 is ``Number of (n+1)X(3+1) arrays of permutations of 0..n*4+3 with each element having directed index change 0,1 0,-1 0,2 1,0 or -1,0.''. It has offset $1$ and begins
\[
29, 157, 1920, 14893, 147797, 1273553, 11868873, 105792288,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 10 2015 11:58:43, revision 6) this is still
...
\[
(i-h_i,\,j-h_j)\;\in\;\{(-1,0),\ (0,-1),\ (0,1),\ (0,2),\ (1,0)\},
\]
...
\begin{theorem}
\[
a(n)\;=\;19\,a(n-1) - 84\,a(n-2) - 440\,a(n-3) + 4562\,a(n-4) - 6128\,a(n-5) - 52306\,a(n-6) + 176044\,a(n-7) + 178409\,a(n-8) - 1566967\,a(n-9) + 1071970\,a(n-10) + 6050538\,a(n-11) - 10528356\,a(n-12) - 8015378\,a(n-13) + 32496674\,a(n-14) - 11033682\,a(n-15) - 40764983\,a(n-16) + 40764983\,a(n-17) + 11033682\,a(n-18) - 32496674\,a(n-19) + 8015378\,a(n-20) + 10528356\,a(n-21) - 6050538\,a(n-22) - 1071970\,a(n-23) + 1566967\,a(n-24) - 178409\,a(n-25) - 176044\,a(n-26) + 52306\,a(n-27) + 6128\,a(n-28) - 4562\,a(n-29) + 440\,a(n-30) + 84\,a(n-31) - 19\,a(n-32) + a(n-33)
\]
for every $n>31$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264252.
