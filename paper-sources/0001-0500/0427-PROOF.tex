...
\title{Recovering the unwritten recurrences of the table OEIS A232677}
...
\begin{abstract}
OEIS A232677 is a two-dimensional table $T(n,k)$ whose empirical recurrences are, for several of
...
OEIS A232677 is ``T(n,k)=Number of (n+1)X(k+1) 0..2 arrays with every element next to itself plus and minus one within the range 0..2 horizontally, vertically, diagonally or antidiagonally.''. It is read by antidiagonals and begins
\[
36, 212, 212, 1568, 3138, 1568, 11878, 63632,\ \dots
\]
The entry carries, among its empirical claims:
\begin{quote}\small
k=2: [order 25]
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 07:33:55, revision 6) these are still
...
\[
(c_1,\dots,c_{25})=(7,\ 143,\ 2259,\ 4937,\ 537,\ -135233,\ -381639,\ -575862,\ 1562236,\ 4517962,\ 3839040,\ -6466486,\ -13678168,\ 2830292,\ 12543416,\ 501152,\ -3876392,\ -3294920,\ 1863872,\ -369088,\ 655936,\ -7552,\ -67328,\ -22528,\ 8192).
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232677.
