...
\title{Recovering the unwritten recurrences of the table OEIS A237412}
...
\begin{abstract}
OEIS A237412 is a two-dimensional table $T(n,k)$ whose empirical recurrences are, for several of
...
OEIS A237412 is ``T(n,k)=Number of (n+1) X (k+1) 0..2 arrays with the maximum plus the upper median plus the minimum of every 2 X 2 subblock differing from its horizontal and vertical neighbors by exactly one.''. It is read by antidiagonals and begins
\[
81, 322, 322, 1278, 1632, 1278, 5228, 8236,\ \dots
\]
The entry carries, among its empirical claims:
\begin{quote}\small
k=2: [order 37]
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 07 2014 19:26:57, revision 7) these are still
...
count, a walk on $S=322$ vertices. Berlekamp--Massey on $2S=644$ exact terms
returns a minimal recurrence of order $37$ --- the order the entry states --- with
integer coefficients
\[
(c_1,\dots,c_{37})=(0,\ 0,\ 35,\ 422,\ 861,\ 1775,\ 703,\ -24448,\ -61622,\ -68118,\ 25946,\ 456293,\ 865728,\ 610758,\ -676767,\ -3048586,\ -3041167,\ -326886,\ 2509173,\ 5909549,\ 3426904,\ -1802161,\ -2482842,\ -2687207,\ -458763,\ 1972154,\ 1952715,\ 779599,\ -268828,\ -154455,\ -76262,\ 51183,\ -16342,\ 5863,\ -1640,\ 614,\ 64).
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237412.
