...
\title{The empirical recurrence for OEIS A264373, proved by transfer matrix}
...
\begin{abstract}
OEIS A264373 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=3$ rows in which
...
OEIS A264373 is ``Number of (n+1)X(2+1) arrays of permutations of 0..n*3+2 with each element having directed index change 2,-2 -1,0 -1,2 1,0 or 0,-1.''. It has offset $1$ and begins
\[
2, 1, 13, 25, 128, 347, 1343, 4172,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 12 2015 07:55:43, revision 4) this is still
...
\[
(i-h_i,\,j-h_j)\;\in\;\{(-1,0),\ (-1,2),\ (0,-1),\ (1,0),\ (2,-2)\},
\]
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 13\,a(n-2) - 4\,a(n-3) - 57\,a(n-4) + 11\,a(n-5) + 138\,a(n-6) - 25\,a(n-7) - 213\,a(n-8) + 38\,a(n-9) + 220\,a(n-10) - 26\,a(n-11) - 151\,a(n-12) - 7\,a(n-13) + 62\,a(n-14) + 19\,a(n-15) - 21\,a(n-16) - 8\,a(n-17) + 7\,a(n-18) + a(n-19) - a(n-20)
\]
for every $n>18$.
\end{theorem}
...
Second, the transfer model reproduces all $26$ terms this entry publishes, exactly, in
integer arithmetic.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264373.
