...
\title{The empirical recurrence for OEIS A279324, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A279324 imposes three things at once: a condition on each cell that reaches one row up and
...
numbers. The empirical recurrence of order $34$ contributed by R.~H.~Hardin then follows
from a finite exact computation on $S=1588$ states.
\end{abstract}
...
OEIS A279324 is ``Number of nX3 0..2 arrays with no element equal to a strict majority of its king-move neighbors, with the exception of exactly one element, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
2, 16, 664, 16092, 384180, 8854880, 198179722, 4349449420,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 09 2016 22:59:26, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;42\,a(n-1) - 493\,a(n-2) + 954\,a(n-3) - 858\,a(n-4) + 64710\,a(n-5) - 158273\,a(n-6) - 161852\,a(n-7) - 2287658\,a(n-8) + 6484208\,a(n-9) - 177947\,a(n-10) + 11804176\,a(n-11) - 49983075\,a(n-12) + 91094328\,a(n-13) - 173959667\,a(n-14) + 162252702\,a(n-15) - 380972477\,a(n-16) + 1361216068\,a(n-17) - 1961010260\,a(n-18) + 1550329916\,a(n-19) - 2391450876\,a(n-20) + 6220276480\,a(n-21) - 11713534100\,a(n-22) + 12134895968\,a(n-23) - 3049399072\,a(n-24) + 3376854336\,a(n-25) - 27370283344\,a(n-26) + 31787315136\,a(n-27) + 20476192704\,a(n-28) - 69504679168\,a(n-29) + 47220424704\,a(n-30) + 7849958400\,a(n-31) - 27469923328\,a(n-32) + 14445785088\,a(n-33) - 2627997696\,a(n-34)
\end{equation}
for all $n>35$.
...
\[
2\,\#\{\text{neighbours equal to }x_{t,u}\}>\#\{\text{neighbours}\} .
\]
...
Let $q(t)=t^{34}-\sum_i c_i\,t^{34-i}$ be the characteristic polynomial of
\eqref{eq:conj} and $G=N$.

\begin{lemma}\label{lem:crit}
With $n_0$ the least index for which $L\ge2$, $o=1n_0+0-2$ and
$h_j=G^{j}N^{o}\mathbf{u}$, we have for $j\ge34$
\[
3!\Bigl(a(n_0+j)-\sum_i c_i\,a(n_0+j-i)\Bigr)=\mathbf{v}^{\!\top}G^{\,j-34}w,
\qquad w=h_{34}-\sum_i c_i h_{34-i} .
\]
...
$34$ applications of $G$ in exact integer arithmetic and $\mathbf{v}^{\!\top}G^{m}w$
evaluated for $m=0,1,\dots$, again exactly. Every one of those integers vanishes from the
index corresponding to $n=35+1$ onwards, and the run continued until $S+1$ consecutive
zeros had been seen.
\end{proof}
...
one of the $16$ published indices and agrees with the entry's DATA exactly, the quotient
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A279324.
