...
\title{The empirical recurrence for OEIS A220223, proved by transfer matrix}
...
\begin{abstract}
OEIS A220223 counts the distinct indicator arrays obtained from the $n\times3$ arrays over
$\{0,\dots,1\}$ by marking the cells whose value is equal to at least half of their neighbours, and carries an
...
indicator row by row turns it into one, on $S=80$ states, after which the conjectured
...
OEIS A220223 is ``Majority value maps: number of nX3 binary arrays indicating the locations of corresponding elements equal to at least half of their horizontal, diagonal and antidiagonal neighbors in a random 0..1 nX3 array.''. It has offset $1$ and begins
\[
4, 18, 115, 697, 4406, 27584, 173216, 1087102,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 18:35:45, revision 9) this is still
...
\]
There are $S=80$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite. Note
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + 11\,a(n-2) + 20\,a(n-3) + 10\,a(n-4) - 22\,a(n-5) - 73\,a(n-6) - 130\,a(n-7) - 255\,a(n-8) - 324\,a(n-9) + 76\,a(n-10) + 462\,a(n-11) + 1018\,a(n-12) + 1198\,a(n-13) + 626\,a(n-14) - 544\,a(n-15) - 1353\,a(n-16) - 1612\,a(n-17) - 1219\,a(n-18) - 68\,a(n-19) + 153\,a(n-20) + 934\,a(n-21) + 548\,a(n-22) - 166\,a(n-23) - 146\,a(n-24) - 642\,a(n-25) - 164\,a(n-26) + 140\,a(n-27) + 76\,a(n-28) + 120\,a(n-29) - 8\,a(n-30) - 32\,a(n-31)
\]
for every $n>32$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A220223.
