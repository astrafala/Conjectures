...
\title{The empirical recurrence for OEIS A280280, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A280280 imposes three things at once: a condition on each cell that reaches one row up and
...
OEIS A280280 is ``Number of n X 3 0..2 arrays with no element equal to more than one of its horizontal and vertical neighbors, with the exception of exactly one element, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
1, 46, 996, 16860, 259040, 3753846, 52433492, 713549156,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 19 2023 15:22:28, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;20\,a(n-1) - 48\,a(n-2) - 636\,a(n-3) + 286\,a(n-4) + 4870\,a(n-5) + 2994\,a(n-6) - 7250\,a(n-7) - 20395\,a(n-8) - 27254\,a(n-9) + 18145\,a(n-10) + 42436\,a(n-11) + 25187\,a(n-12) + 8976\,a(n-13) - 53063\,a(n-14) + 3942\,a(n-15) + 11087\,a(n-16) - 3576\,a(n-17) + 616\,a(n-18) - 6944\,a(n-19) - 48\,a(n-20) + 512\,a(n-21) - 384\,a(n-22) - 256\,a(n-24)
\end{equation}
for all $n>25$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A280280.
