...
\title{The empirical recurrence for OEIS A250803, proved by transfer matrix}
...
\begin{abstract}
OEIS A250803 counts arrays over $\{0,1\}$ in which a statistic taken over short runs
...
OEIS A250803 is ``Number of (6+1)X(n+1) 0..1 arrays with nondecreasing min(x(i,j),x(i,j-1)) in the i direction and nondecreasing absolute value of x(i,j)-x(i-1,j) in the j direction.''. It has offset $1$ and begins
\[
816, 3646, 12706, 38676, 105954, 270598, 653880, 1517666,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 12:46:17, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) - 17\,a(n-3) + 12\,a(n-4) + 28\,a(n-5) - 28\,a(n-6) - 22\,a(n-7) + 27\,a(n-8) + 8\,a(n-9) - 12\,a(n-10) - a(n-11) + 2\,a(n-12)
\]
for every $n>11$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250803.
