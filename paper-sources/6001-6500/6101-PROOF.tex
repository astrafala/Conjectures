...
\title{The empirical recurrence for OEIS A297938, proved by transfer matrix}
...
\begin{abstract}
OEIS A297938 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A297938 is ``Number of nX3 0..1 arrays with every element equal to 0, 2, 3 or 5 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 7, 4, 14, 16, 51, 102, 258,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 09 2018 07:08:41, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) - a(n-2) - 7\,a(n-3) - 5\,a(n-4) + 11\,a(n-5) + 22\,a(n-6) - 15\,a(n-7) - 15\,a(n-8) - 22\,a(n-9) - 25\,a(n-10) + 55\,a(n-11) + 35\,a(n-12) - 15\,a(n-13) - 6\,a(n-14) - 11\,a(n-15) - 4\,a(n-16)
\end{equation}
for all $n>17$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297938.
