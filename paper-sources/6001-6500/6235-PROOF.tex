...
\title{The empirical recurrence for OEIS A261109, proved by transfer matrix}
...
\begin{abstract}
OEIS A261109 counts $(n+2)\times6$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
every $3\times3$ subblock, and it carries an empirical recurrence of order $13$
...
OEIS A261109 is ``Number of (n+2) X (4+2) 0..1 arrays with each 3 X 3 subblock having clockwise perimeter pattern 00010001 00010101 or 01010101.''. It has offset $1$ and begins
\[
97, 206, 566, 1498, 3908, 10268, 27030, 70980,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 25 2022 18:44:26, revision 6) this is still
...
\[
\text{the clockwise perimeter word of }g\text{ is a rotation of one of }\{00010001,\ 00010101,\ 01010101\}
\]
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 6\,a(n-3) + 8\,a(n-4) + 10\,a(n-5) + 11\,a(n-6) + 7\,a(n-7) + a(n-8) - 7\,a(n-9) - 6\,a(n-10) + a(n-11) + 3\,a(n-12) + a(n-13)
\]
for every $n>14$.
\end{theorem}

\begin{proof}
The vector $w=q(M)\mathbf{1}$ was formed by $13$ matrix--vector products in exact
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A261109.
