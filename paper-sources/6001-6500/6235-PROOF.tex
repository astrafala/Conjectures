...
\title{The empirical recurrence for OEIS A297340, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297340 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A297340 is ``Number of 3Xn 0..1 arrays with every 1 horizontally or antidiagonally adjacent to 0 or 2 neighboring 1s.''. It has offset $1$ and begins
\[
8, 21, 96, 334, 1310, 4888, 18604, 70255,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) +7*a(n-2) +2*a(n-3) -8*a(n-4) -12*a(n-5) +4*a(n-7) +5*a(n-8) -2*a(n-9) +2*a(n-10) -a(n-12)
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 28 2017 11:33:03, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 7\,a(n-2) + 2\,a(n-3) - 8\,a(n-4) - 12\,a(n-5) + 4\,a(n-7) + 5\,a(n-8) - 2\,a(n-9) + 2\,a(n-10) - a(n-12)
\end{equation}
for all $n>13$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297340.
