...
\title{The empirical recurrence for OEIS A223460, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A223460 counts arrays over $\{0,\dots,20\}$ in which every cell is constrained by the
...
OEIS A223460 is ``6 X 6 X 6 triangular graph without horizontal edges coloring a rectangular array: number of n X 1 0..20 arrays where 0..20 label nodes of a graph with edges 0,1 0,2 1,3 1,4 2,4 2,5 3,6 3,7 4,7 4,8 5,8 5,9 6,10 6,11 7,11 7,12 8,12 8,13 9,13 9,14 10,15 10,16 11,16 11,17 12,17 12,18 13,18 13,19 14,19 14,20 and every array movement to a horizontal or vertical neighbor moves along an edge of this graph.''. It has offset $1$ and begins
\[
21, 60, 190, 600, 1946, 6264, 20440, 66208,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 20*a(n-2) -126*a(n-4) +304*a(n-6) -252*a(n-8) +80*a(n-10) -8*a(n-12).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 21:42:41, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;20\,a(n-2) - 126\,a(n-4) + 304\,a(n-6) - 252\,a(n-8) + 80\,a(n-10) - 8\,a(n-12)
\end{equation}
for all $n>13$.
...
Let $V=\{0,\dots,20\}^{1}$ be the possible rows and take
...
and $1$ columns. In the walk, the cells of row $t$ for $2\le t\le L-1$ are tested
...
of the $(20+1)^{1}$ possible next rows, the condition was tested on every cell of
the middle row. The vector $w$ was formed by $12$ applications of $G$ in exact integer
...
every one of the $24$ published indices, with no shift fitted: the number of rows is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223460.
