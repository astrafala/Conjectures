...
\title{The empirical recurrence for OEIS A316378, proved by transfer matrix}
...
\begin{abstract}
OEIS A316378 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A316378 is ``Number of nX3 0..1 arrays with every element unequal to 1, 2, 3, 4, 6 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 23, 83, 464, 2280, 11423, 57453, 288496,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 30 2018 19:15:33, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 10\,a(n-2) + 12\,a(n-3) - 46\,a(n-4) - 52\,a(n-5) + 14\,a(n-6) - 57\,a(n-7) - 58\,a(n-8) - 38\,a(n-9) + 33\,a(n-10) + 61\,a(n-11) - 7\,a(n-12) + 5\,a(n-13) - 9\,a(n-14) + 2\,a(n-15)
\end{equation}
for all $n>16$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A316378.
