...
\title{The empirical recurrence for OEIS A183382, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A183382 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A183382 is ``Half the number of n X 3 binary arrays with no element equal to a strict majority of its king-move neighbors.''. It has offset $1$ and begins
\[
1, 5, 11, 29, 89, 245, 669, 1891,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 4*a(n-1) - 4*a(n-2) + 6*a(n-3) - 13*a(n-4) + 3*a(n-5) - 2*a(n-6) + 6*a(n-7) + 4*a(n-8) + 5*a(n-9) - 4*a(n-10) - 2*a(n-11).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 28 2018 07:21:39, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) - 4\,a(n-2) + 6\,a(n-3) - 13\,a(n-4) + 3\,a(n-5) - 2\,a(n-6) + 6\,a(n-7) + 4\,a(n-8) + 5\,a(n-9) - 4\,a(n-10) - 2\,a(n-11)
\end{equation}
for all $n>12$.
...
\[
a(n_0+j)-\sum_i c_i\,a(n_0+j-i)\;=\;\tfrac1{2}\,\mathbf{v}^{\!\top}G^{\,j-11}w,
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A183382.
