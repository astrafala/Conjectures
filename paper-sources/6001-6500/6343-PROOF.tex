...
\title{The empirical recurrence for OEIS A203085, proved by transfer matrix}
...
\begin{abstract}
OEIS A203085 counts arrays of width $4$ over $\{0,1\}$ containing no occurrence of certain short
...
OEIS A203085 is ``Number of (n+2)X4 binary arrays avoiding patterns 000 and 101 in rows and columns.''. It has offset $1$ and begins
\[
253, 787, 2237, 6615, 19723, 57699, 169561, 500813,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 10:06:44, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 2\,a(n-2) + 10\,a(n-3) + 6\,a(n-4) - 5\,a(n-5) - 10\,a(n-6) - 8\,a(n-7) + 2\,a(n-8) + 10\,a(n-9) - 24\,a(n-10) - 20\,a(n-11) + 23\,a(n-12) + 22\,a(n-13) - 10\,a(n-14)
\]
for every $n>14$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A203085.
