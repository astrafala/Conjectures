...
\title{The empirical recurrence for OEIS A233853, proved by transfer matrix}
...
\begin{abstract}
OEIS A233853 counts $(n+1)\times2$ arrays over $\{0,\dots,7\}$ subject to a condition imposed on
...
OEIS A233853 is ``Number of (n+1)X(1+1) 0..7 arrays with every 2X2 subblock having the sum of the squares of all six edge and diagonal differences equal to 59.''. It has offset $1$ and begins
\[
216, 1040, 4640, 22592, 104576, 511232, 2416128, 11843584,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 64*a(n-2) -1536*a(n-4) +17408*a(n-6) -95488*a(n-8) +235520*a(n-10) -237568*a(n-12) +65536*a(n-14)
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 09:01:30, revision 7) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;64\,a(n-2) - 1536\,a(n-4) + 17408\,a(n-6) - 95488\,a(n-8) + 235520\,a(n-10) - 237568\,a(n-12) + 65536\,a(n-14)
\end{equation}
for all $n>14$.
...
(\beta-\alpha)^2+(\delta-\beta)^2+(\gamma-\delta)^2+(\alpha-\gamma)^2+(\delta-\alpha)^2+(\gamma-\beta)^2=59,
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A233853.
