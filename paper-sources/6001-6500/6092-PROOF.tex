...
\title{The empirical recurrence for OEIS A252008, proved by transfer matrix}
...
\begin{abstract}
OEIS A252008 counts arrays of width $3$ over $\{0,1,2,3\}$ in which every $3\times3$ window has
...
OEIS A252008 is ``Number of (n+2)X(1+2) 0..3 arrays with every 3X3 subblock row and column sum 1 3 6 or 8 and every diagonal and antidiagonal sum not 1 3 6 or 8.''. It has offset $1$ and begins
\[
756, 1168, 1110, 1618, 1970, 2458, 3246, 4410,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 10:41:41, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) - 2\,a(n-2) + 5\,a(n-3) - 8\,a(n-4) + 9\,a(n-5) - 8\,a(n-6) + 6\,a(n-7) - 9\,a(n-8) + 6\,a(n-9) + a(n-10) - a(n-11) - 3\,a(n-13) + 3\,a(n-14)
\]
for every $n>22$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252008.
