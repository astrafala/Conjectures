...
\title{The empirical recurrence for OEIS A255799, proved by transfer matrix}
...
\begin{abstract}
OEIS A255799 counts $(n+2)\times8$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A255799 is ``Number of (n+2) X (6+2) 0..1 arrays with no 3 x 3 subblock diagonal sum 1 and no antidiagonal sum 2 and no row sum 0 and no column sum 3.''. It has offset $1$ and begins
\[
1318, 472, 258, 263, 290, 214, 270, 358,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-6) - 2*a(n-12) for n>15.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 20 2018 08:47:40, revision 8) this is still
...
First, the transfer model reproduces all $44$ terms the entry publishes, exactly, in
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A255799.
