...
\title{The empirical recurrence for OEIS A234338, proved by transfer matrix}
...
\begin{abstract}
OEIS A234338 counts $(n+1)\times2$ arrays over $\{0,\dots,7\}$ subject to a condition imposed on
...
OEIS A234338 is ``Number of (n+1)X(1+1) 0..7 arrays with every 2X2 subblock having the sum of the absolute values of the edge differences equal to 14.''. It has offset $1$ and begins
\[
604, 9076, 120838, 1709528, 23776684, 333289866, 4661112720, 65252337120,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 09:16:54, revision 7) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;11\,a(n-1) + 100\,a(n-2) - 657\,a(n-3) - 3362\,a(n-4) + 13855\,a(n-5) + 47579\,a(n-6) - 118877\,a(n-7) - 254743\,a(n-8) + 334913\,a(n-9) + 167982\,a(n-10) - 130132\,a(n-11) - 15912\,a(n-12) + 10008\,a(n-13)
\end{equation}
for all $n>13$.
...
|\beta-\alpha|+|\delta-\beta|+|\gamma-\delta|+|\alpha-\gamma|=14,
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234338.
