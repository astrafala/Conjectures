...
\title{The empirical recurrence for OEIS A236698, proved by transfer matrix}
...
\begin{abstract}
OEIS A236698 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
OEIS A236698 is ``Number of (n+1)X(1+1) 0..2 arrays colored with the maximum plus the lower median minus the upper median of every 2X2 subblock.''. It has offset $1$ and begins
\[
81, 426, 2285, 12076, 64277, 340944, 1814328, 9631020,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 09:26:57, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-3) + 352\,a(n-4) + 916\,a(n-5) + 3728\,a(n-6) + 10464\,a(n-7) + 16592\,a(n-8) + 26464\,a(n-9) + 20624\,a(n-10) + 6240\,a(n-11) + 2048\,a(n-12) - 5632\,a(n-13)
\]
for every $n>13$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A236698.
