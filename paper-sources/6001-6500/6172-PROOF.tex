...
\title{The empirical recurrence for OEIS A274731, proved by counting patterns}
...
\begin{abstract}
OEIS A274731 counts arrays in which no entry may repeat a value found at any of three stated
...
cutting $535538$ pairs to $S=90623$ states. The entry's empirical recurrence of order $18$,
...
OEIS A274731 is ``Number of 6Xn 0..2 arrays with no element equal to any value at offset (-1,-2) (-2,-1) or (-1,0) and new values introduced in order 0..2.''. It has offset $1$ and begins
\[
16, 432, 4132, 52912, 687248, 8960464, 116633012, 1520042284,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 03 2016 20:20:38, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;15\,a(n-1) + a(n-2) - 456\,a(n-3) + 1455\,a(n-4) - 196\,a(n-5) - 5263\,a(n-6) + 5258\,a(n-7) + 7193\,a(n-8) - 12179\,a(n-9) - 1317\,a(n-10) + 8177\,a(n-11) - 894\,a(n-12) - 2235\,a(n-13) + 104\,a(n-14) + 350\,a(n-15) + 27\,a(n-16) - 44\,a(n-17) + 5\,a(n-18)
\end{equation}
for all $n>20$.
...
$o=1n_0+0-2$, we have for $j\ge18$
\[
3!\Bigl(a(n_0+j)-\sum_i c_i\,a(n_0+j-i)\Bigr)
=\mathbf{v}^{\!\top}G^{\,j-18}w,\qquad
w=h_{18}-\sum_i c_i h_{18-i} .
\]
...
the survivors by the pattern of the new pair. The vector $w$ was formed by $18$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A274731.
