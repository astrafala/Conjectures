...
\title{The empirical recurrence for OEIS A188702, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A188702 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A188702 is ``Number of nX5 binary arrays without the pattern 0 0 diagonally or vertically.''. It has offset $1$ and begins
\[
32, 144, 1665, 11556, 103484, 813309, 6814290, 55337580,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 04:47:13, revision 9) the statement is
...
\text{no }0,0\text{ occurs consecutively along any direction in }\mathcal N
\end{equation}
for every cell $(t,u)$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A188702.
