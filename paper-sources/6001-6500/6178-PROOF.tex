...
\title{The empirical recurrence for OEIS A317038, proved by transfer matrix}
...
\begin{abstract}
OEIS A317038 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A317038 is ``Number of n X 3 0..1 arrays with every element unequal to 0, 1, 3, 4, 5, 6 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
3, 9, 14, 33, 90, 204, 527, 1547,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 08 2023 11:59:03, revision
6) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) - 7\,a(n-2) + 19\,a(n-3) - 60\,a(n-4) + 56\,a(n-5) - 70\,a(n-6) + 166\,a(n-7) - 101\,a(n-8) + 21\,a(n-9) - 30\,a(n-10) + 72\,a(n-11) - 41\,a(n-12) - 333\,a(n-13) + 428\,a(n-14) - 122\,a(n-15) - 36\,a(n-16) + 16\,a(n-17)
\end{equation}
for all $n>19$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A317038.
