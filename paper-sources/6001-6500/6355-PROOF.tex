...
\title{The empirical recurrence for OEIS A302455, proved by transfer matrix}
...
\begin{abstract}
OEIS A302455 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A302455 is ``Number of nX3 0..1 arrays with every element equal to 0, 2, 3 or 5 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 11, 18, 55, 177, 474, 1397, 4135,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 08 2018 09:59:29, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) - 2\,a(n-2) + 13\,a(n-3) - 23\,a(n-4) + 12\,a(n-5) - 42\,a(n-6) + 32\,a(n-7) - 24\,a(n-8) - 18\,a(n-9) + 24\,a(n-10) + 40\,a(n-11) + 32\,a(n-12)
\end{equation}
for all $n>12$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302455.
