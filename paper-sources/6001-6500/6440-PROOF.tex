...
\title{The empirical recurrence for OEIS A196282, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A196282 counts arrays over $\{0,\dots,4\}$ in which every cell is constrained by the
...
OEIS A196282 is ``Number of n X 3 0..4 arrays with each element x equal to the number its horizontal and vertical neighbors equal to 2,0,3,1,4 for x=0,1,2,3,4.''. It has offset $1$ and begins
\[
4, 8, 7, 50, 111, 259, 728, 1800,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 17 2022 18:03:02, revision 7) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) - a(n-3) - 5\,a(n-4) + 6\,a(n-5) + 2\,a(n-6) - 14\,a(n-7) - 63\,a(n-8) - 7\,a(n-9) + 88\,a(n-10) + 28\,a(n-11) + 122\,a(n-12) - 20\,a(n-13) - 48\,a(n-14)
\end{equation}
for all $n>15$.
...
\#\{\text{neighbours with value }f(x_{t,u})\}=x_{t,u},\quad f=(2,0,3,1,4)
\end{equation}
for every cell $(t,u)$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A196282.
