...
\title{The empirical recurrence for OEIS A204410, proved by transfer matrix}
...
\begin{abstract}
OEIS A204410 counts $(n+2)\times3$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
every $3\times3$ subblock, and it carries an empirical recurrence of order $14$
...
OEIS A204410 is ``Number of (n+2)X3 0..2 arrays with every 3X3 subblock having three strictly increasing elements in a row horizontally or vertically, exactly one way.''. It has offset $1$ and begins
\[
3570, 34274, 423416, 2827014, 22956524, 254913953, 2004465237, 15823989959,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 11:13:07, revision 9) this is still
...
\[
\text{exactly }1\text{ of the horizontally or vertically lines of }g\text{ \text{is strictly increasing}}
\]
...
\begin{theorem}
\[
a(n)\;=\;460\,a(n-3) + 1362\,a(n-4) + 2847\,a(n-5) + 2179\,a(n-6) + 26106\,a(n-7) + 51165\,a(n-8) + 60758\,a(n-9) - 30501\,a(n-10) - 91290\,a(n-11) - 24768\,a(n-12) + 6156\,a(n-13) + 36936\,a(n-14)
\]
for every $n>14$.
\end{theorem}

\begin{proof}
The vector $w=q(M)\mathbf{1}$ was formed by $14$ matrix--vector products in exact
integer arithmetic and $\mathbf{1}^{\!\top}M^{j}w$ evaluated for $j=0,1,\dots$, again
exactly. Those integers vanish from the index corresponding to $n=14+1$ onwards, and the
run was continued until the working vector was identically zero, which settles all larger $j$
at once. By Lemma~\ref{lem:crit} the recurrence holds for every $n>14$.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204410.
