...
\title{The empirical recurrence for OEIS A250937, proved by transfer matrix}
...
\begin{abstract}
OEIS A250937 counts arrays over $\{0,1,2\}$ in which a statistic taken over short runs
...
OEIS A250937 is ``Number of (n+1)X(3+1) 0..2 arrays with nondecreasing x(i,j)+x(i,j-1) in the i direction and nondecreasing absolute value of x(i,j)-x(i-1,j) in the j direction.''. It has offset $1$ and begins
\[
599, 3355, 16208, 71014, 289407, 1115035, 4106983, 14585505,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 12:52:37, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;24\,a(n-1) - 266\,a(n-2) + 1806\,a(n-3) - 8400\,a(n-4) + 28350\,a(n-5) - 71722\,a(n-6) + 138498\,a(n-7) - 205823\,a(n-8) + 235410\,a(n-9) - 205548\,a(n-10) + 134568\,a(n-11) - 63952\,a(n-12) + 20832\,a(n-13) - 4160\,a(n-14) + 384\,a(n-15)
\]
for every $n>21$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250937.
