...
\title{The empirical recurrence for OEIS A251030, proved by transfer matrix}
...
\begin{abstract}
OEIS A251030 counts arrays over $\{0,1,2,3\}$ in which a statistic taken over short runs
...
OEIS A251030 is ``Number of (n+1)X(1+1) 0..3 arrays with nondecreasing min(x(i,j),x(i,j-1)) in the i direction and nondecreasing absolute value of x(i,j)-x(i-1,j) in the j direction.''. It has offset $1$ and begins
\[
110, 636, 3550, 19112, 100633, 521227, 2668193, 13542602,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:00:58, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;12\,a(n-1) - 46\,a(n-2) + 40\,a(n-3) + 111\,a(n-4) - 168\,a(n-5) - 110\,a(n-6) + 172\,a(n-7) + 95\,a(n-8) - 52\,a(n-9) - 48\,a(n-10) - 12\,a(n-11) - a(n-12)
\]
for every $n>11$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251030.
