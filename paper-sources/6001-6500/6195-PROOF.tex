...
\title{The empirical recurrence for OEIS A236994, proved by transfer matrix}
...
\begin{abstract}
OEIS A236994 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
The condition is local to two consecutive rows, so the count is a walk count on $S=32400$
...
OEIS A236994 is ``Number of (n+1)X(5+1) 0..2 arrays with the maximum plus the lower median minus the upper median minus the minimum of every 2X2 subblock differing from its horizontal and vertical neighbors by exactly one.''. It has offset $1$ and begins
\[
32400, 699840, 14963200, 363916800, 8552563200, 192222720000, 4279521280000, 109212364800000,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 1115200*a(n-4) -430632960000*a(n-8) +66962587648000000*a(n-12) -3428940827852800000000*a(n-16)
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 09:44:05, revision 6) this is still
...
differ by $1$. The entry's first term $32400$ counts those, and the model was made to
...
\]
over the $S=32400$ pairs whose own subblock row already satisfies the condition along itself.
...
\begin{theorem}
\[
a(n)\;=\;1115200\,a(n-4) - 430632960000\,a(n-8) + 66962587648000000\,a(n-12) - 3428940827852800000000\,a(n-16)
\]
for every $n>16$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A236994.
