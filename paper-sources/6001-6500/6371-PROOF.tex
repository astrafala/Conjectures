...
\title{The empirical recurrence for OEIS A252377, proved by transfer matrix}
...
\begin{abstract}
OEIS A252377 counts $(n+2)\times3$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252377 is ``Number of (n+2)X(1+2) 0..3 arrays with every 3X3 subblock row and diagonal sum equal to 0 3 5 6 or 7 and every 3X3 column and antidiagonal sum not equal to 0 3 5 6 or 7.''. It has offset $1$ and begins
\[
578, 540, 588, 651, 785, 904, 1051, 1290,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 5*a(n-3) -8*a(n-6) +5*a(n-9) -a(n-12) for n>22
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:09:23, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252377.
