...
\title{The empirical recurrence for OEIS A237958, proved by transfer matrix}
...
\begin{abstract}
OEIS A237958 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
OEIS A237958 is ``Number of (n+1)X(1+1) 0..2 arrays with the maximum plus the lower median minus the minimum of every 2X2 subblock differing from its horizontal and vertical neighbors by exactly one.''. It has offset $1$ and begins
\[
81, 340, 1422, 6042, 25777, 109200, 462852, 1962464,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 216*a(n-4) +1692*a(n-6) +4288*a(n-8) +3968*a(n-10) +1024*a(n-12)
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 10:38:49, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;216\,a(n-4) + 1692\,a(n-6) + 4288\,a(n-8) + 3968\,a(n-10) + 1024\,a(n-12)
\]
for every $n>12$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237958.
