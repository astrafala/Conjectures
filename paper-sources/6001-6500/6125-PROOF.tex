...
\title{The empirical recurrence for OEIS A208684, proved by transfer matrix}
...
\begin{abstract}
OEIS A208684 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
...
OEIS A208684 is ``Number of nX4 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 1 1 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
10, 100, 282, 927, 3430, 11067, 34627,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:57:47, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208684.
