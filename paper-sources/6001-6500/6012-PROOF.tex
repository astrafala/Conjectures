...
\title{The empirical recurrence for OEIS A197085, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A197085 counts arrays over $\{0,\dots,4\}$ in which every cell is constrained by the
...
OEIS A197085 is ``Number of nX3 0..4 arrays with each element x equal to the number its horizontal and vertical neighbors equal to 4,3,2,0,1 for x=0,1,2,3,4.''. It has offset $1$ and begins
\[
1, 5, 25, 96, 422, 1780, 7537, 31911,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 06:57:35, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 3\,a(n-2) + 10\,a(n-3) - 3\,a(n-4) + 2\,a(n-5) + 11\,a(n-6) - 15\,a(n-7) - 15\,a(n-8) - 2\,a(n-9) + a(n-10) - 2\,a(n-11) + 4\,a(n-12) + 2\,a(n-13)
\end{equation}
for all $n>14$.
...
\#\{\text{neighbours with value }f(x_{t,u})\}=x_{t,u},\quad f=(4,3,2,0,1)
\end{equation}
for every cell $(t,u)$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A197085.
