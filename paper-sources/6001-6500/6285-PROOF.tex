...
\title{The empirical recurrence for OEIS A283568, proved by transfer matrix}
...
\begin{abstract}
OEIS A283568 counts $n\times4$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
walk, and $a(n)$ is a walk count on $S=239$ vertices, which is $C$-finite. Whether the
...
OEIS A283568 is ``Number of nX4 0..1 arrays with no 1 equal to more than one of its horizontal, diagonal and antidiagonal neighbors, with the exception of exactly one element.''. It has offset $1$ and begins
\[
2, 72, 674, 6812, 60802, 528436, 4441052, 36589848,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 11 2017 08:13:52, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;12\,a(n-1) - 16\,a(n-2) - 148\,a(n-3) + 122\,a(n-4) + 8\,a(n-5) - 1218\,a(n-6) + 1236\,a(n-7) + 1851\,a(n-8) - 3776\,a(n-9) + 3314\,a(n-10) + 5408\,a(n-11) - 7569\,a(n-12) - 2532\,a(n-13) + 2620\,a(n-14) + 320\,a(n-15) - 256\,a(n-16)
\]
for every $n>16$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A283568.
