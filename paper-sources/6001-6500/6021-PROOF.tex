...
\title{The empirical recurrence for OEIS A297336, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297336 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A297336 is ``Number of nX6 0..1 arrays with every 1 horizontally or antidiagonally adjacent to 0 or 2 neighboring 1s.''. It has offset $1$ and begins
\[
21, 333, 4888, 73147, 1091456, 16277492, 242728633, 3619361855,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 28 2017 11:29:54, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;24\,a(n-1) - 154\,a(n-2) + 246\,a(n-3) + 521\,a(n-4) - 1157\,a(n-5) - 1119\,a(n-6) + 1776\,a(n-7) + 1209\,a(n-8) - 621\,a(n-9) - 454\,a(n-10) - 25\,a(n-11) + 10\,a(n-12) + a(n-13)
\end{equation}
for all $n>14$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297336.
