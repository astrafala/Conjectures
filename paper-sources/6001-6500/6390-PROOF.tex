...
\title{The empirical recurrence for OEIS A205305, proved by transfer matrix}
...
\begin{abstract}
OEIS A205305 counts arrays of width $3$ over $\{0,1,2,3\}$ containing no run of $3$ consecutive
...
OEIS A205305 is ``Number of nX3 0..3 arrays with no occurrence of three equal elements in a row horizontally or vertically, and new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
4, 159, 7445, 381958, 19490790, 996536552, 50933680120, 2603456557653,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 11:59:44, revision 10) this is still
...
\begin{theorem}
\[
a(n)\;=\;45\,a(n-1) + 360\,a(n-2) - 2443\,a(n-3) + 752\,a(n-4) + 1861\,a(n-5) + 17330\,a(n-6) + 3931\,a(n-7) - 55696\,a(n-8) - 6621\,a(n-9) + 28764\,a(n-10) - 5265\,a(n-11) - 9477\,a(n-12) + 1080\,a(n-13) + 1080\,a(n-14)
\]
for every $n>14$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A205305.
