...
\title{The empirical recurrence for OEIS A208423, proved by transfer matrix}
...
\begin{abstract}
OEIS A208423 counts arrays over $\{0,\dots,1\}$ of width $6$ that avoid the patterns
...
OEIS A208423 is ``Number of 6Xn 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 0 0 and 0 1 1 vertically.''. It has offset
$1$ and begins
\[
18, 324, 1278, 10098, 55404, 365094, 2187162,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:50:58, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 35\,a(n-2) + 18\,a(n-3) - 225\,a(n-4) - 67\,a(n-5) + 494\,a(n-6) + 85\,a(n-7) - 455\,a(n-8) - 40\,a(n-9) + 178\,a(n-10) + 6\,a(n-11) - 24\,a(n-12)
\end{equation}
...
$(0,0,0), (0,1,1)$ as $3$ consecutive entries. There are $18$ admissible columns; that condition
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208423.
