...
\title{The empirical recurrence for OEIS A317120, proved by transfer matrix}
...
\begin{abstract}
OEIS A317120 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A317120 is ``Number of nX3 0..1 arrays with every element unequal to 0, 1, 2, 3, 5, 7 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
4, 23, 82, 302, 1164, 4561, 17966, 70913,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 21 2018 17:30:46, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) + 2\,a(n-2) - 4\,a(n-3) - 19\,a(n-4) - 3\,a(n-5) + 20\,a(n-6) + 11\,a(n-7) - 8\,a(n-8) + 19\,a(n-9) + 19\,a(n-10) - 10\,a(n-11) - 21\,a(n-12) - 9\,a(n-13) + 2\,a(n-14) - 14\,a(n-15) - 8\,a(n-16)
\end{equation}
for all $n>16$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A317120.
