...
\title{The empirical recurrence for OEIS A304144, proved by transfer matrix}
...
\begin{abstract}
OEIS A304144 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $different from$ itself lying in $\{1,2,3,6\}$, and it carries an empirical
...
OEIS A304144 is ``Number of nX3 0..1 arrays with every element unequal to 1, 2, 3 or 6 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 14, 18, 25, 113, 238, 359, 1309,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 07 2018 08:52:05, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 3\,a(n-2) + 11\,a(n-3) - 5\,a(n-4) - 39\,a(n-5) - 29\,a(n-6) + 4\,a(n-7) + 42\,a(n-8) + 15\,a(n-9) + 12\,a(n-10) - 2\,a(n-11) - 4\,a(n-12) - 16\,a(n-13) - 8\,a(n-14)
\end{equation}
for all $n>16$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A304144.
