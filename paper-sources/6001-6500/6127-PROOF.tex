...
\title{The empirical recurrence for OEIS A283687, proved by transfer matrix}
...
\begin{abstract}
OEIS A283687 counts $n\times4$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
walk, and $a(n)$ is a walk count on $S=177$ vertices, which is $C$-finite. Whether the
...
OEIS A283687 is ``Number of nX4 0..1 arrays with no 1 equal to more than two of its horizontal, diagonal and antidiagonal neighbors.''. It has offset $1$ and begins
\[
16, 161, 1521, 15226, 150497, 1489917, 14754038, 146079023,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 14 2017 16:13:00, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-1) + 24\,a(n-2) + 55\,a(n-3) - 57\,a(n-4) - 195\,a(n-5) - 458\,a(n-6) + 154\,a(n-7) + 630\,a(n-8) + 634\,a(n-9) - 160\,a(n-10) - 239\,a(n-11) - 42\,a(n-12) - 20\,a(n-13) - 8\,a(n-14)
\]
for every $n>14$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A283687.
