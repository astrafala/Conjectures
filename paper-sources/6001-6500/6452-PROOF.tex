...
\title{The empirical recurrence for OEIS A256729, proved by transfer matrix}
...
\begin{abstract}
OEIS A256729 counts arrays of width $4$ over $\{0,1\}$ in which every $3\times3$ window has
...
OEIS A256729 is ``Number of (n+2)X(2+2) 0..1 arrays with no 3x3 subblock diagonal sum zero and no antidiagonal sum three.''. It has offset $1$ and begins
\[
2304, 21904, 186624, 1648656, 14137600, 122323600, 1047687424, 9002973456,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 15:13:12, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;13\,a(n-1) - 39\,a(n-2) - 69\,a(n-3) + 1104\,a(n-4) - 4048\,a(n-5) + 3968\,a(n-6) - 19840\,a(n-7) + 92928\,a(n-8) - 52992\,a(n-9) - 98304\,a(n-10) + 180224\,a(n-11) - 393216\,a(n-12) + 2097152\,a(n-13) - 12582912\,a(n-14) + 16777216\,a(n-15)
\]
for every $n>12$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A256729.
