...
\title{The empirical recurrence for OEIS A230270, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A230270 counts arrays over $\{0,\dots,2\}$ in which every cell is constrained by the
...
OEIS A230270 is ``Number of n X 3 0..2 arrays x(i,j) with each element horizontally or vertically next to at least one element with value (x(i,j)+1) mod 3, and upper left element zero.''. It has offset $1$ and begins
\[
0, 2, 28, 258, 2318, 19996, 173042, 1495602,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 11*a(n-1) -18*a(n-2) -22*a(n-3) -6*a(n-4) +162*a(n-5) -29*a(n-6) -105*a(n-7) -62*a(n-8) -22*a(n-9) -4*a(n-10).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 14 2023 11:28:32, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;11\,a(n-1) - 18\,a(n-2) - 22\,a(n-3) - 6\,a(n-4) + 162\,a(n-5) - 29\,a(n-6) - 105\,a(n-7) - 62\,a(n-8) - 22\,a(n-9) - 4\,a(n-10)
\end{equation}
for all $n>11$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A230270.
