...
\title{The empirical recurrence for OEIS A250689, proved by transfer matrix}
...
\begin{abstract}
OEIS A250689 counts arrays over $\{0,1,2,3\}$ in which a statistic taken over short runs
...
OEIS A250689 is ``Number of (n+1)X(6+1) 0..3 arrays with nondecreasing x(i,j)-x(i,j-1) in the i direction and nondecreasing absolute value of x(i,j)-x(i-1,j) in the j direction.''. It has offset $1$ and begins
\[
193117, 995624, 5098590, 25235016, 117793753, 523260542, 2224688673, 9121206688,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 12:41:50, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250689.
