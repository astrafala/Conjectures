...
\title{The empirical recurrence for OEIS A297609, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297609 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A297609 is ``Number of 3Xn 0..1 arrays with every 1 horizontally, diagonally or antidiagonally adjacent to 0, 1 or 3 neighboring 1s.''. It has offset $1$ and begins
\[
8, 35, 181, 787, 3691, 17186, 80140, 371557,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 01 2018 14:54:57, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 7\,a(n-2) + 13\,a(n-3) + 52\,a(n-4) + 19\,a(n-5) - 36\,a(n-6) + 2\,a(n-7) - 98\,a(n-8) - 31\,a(n-9) + 32\,a(n-10) + 22\,a(n-11) + 6\,a(n-12) + a(n-13)
\end{equation}
for all $n>14$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297609.
