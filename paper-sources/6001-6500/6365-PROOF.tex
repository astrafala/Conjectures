...
\title{The empirical recurrence for OEIS A317599, proved by transfer matrix}
...
\begin{abstract}
OEIS A317599 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A317599 is ``Number of nX3 0..1 arrays with every element unequal to 0, 1, 2, 3, 5, 6, 7 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
4, 23, 100, 435, 1959, 8872, 40080, 181116,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 01 2018 13:36:12, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) - 2\,a(n-3) - 34\,a(n-4) - 13\,a(n-5) + 8\,a(n-6) + 114\,a(n-7) + 36\,a(n-8) - 48\,a(n-9) - 68\,a(n-10) + 13\,a(n-11) + 14\,a(n-12) - 21\,a(n-13) - 21\,a(n-14) - 22\,a(n-15) - 8\,a(n-16)
\end{equation}
for all $n>17$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A317599.
