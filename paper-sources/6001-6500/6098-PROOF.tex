...
\title{The empirical recurrence for OEIS A237551, proved by transfer matrix}
...
\begin{abstract}
OEIS A237551 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
The condition is local to two consecutive rows, so the count is a walk count on $S=312$
...
OEIS A237551 is ``Number of (n+1)X(2+1) 0..2 arrays with the maximum minus the upper median of every 2X2 subblock differing from its horizontal and vertical neighbors by exactly one.''. It has offset $1$ and begins
\[
312, 1668, 8764, 44668, 224948, 1181206, 6170564, 31538382,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 10:17:02, revision 6) this is still
...
differ by $1$. The entry's first term $312$ counts those, and the model was made to
...
\]
over the $S=312$ pairs whose own subblock row already satisfies the condition along itself.
...
\begin{theorem}
\[
a(n)\;=\;26\,a(n-3) + 473\,a(n-4) + 382\,a(n-5) + 716\,a(n-6) + 1304\,a(n-7) - 5953\,a(n-8) - 1004\,a(n-9) - 1124\,a(n-10) - 466\,a(n-11) + 9039\,a(n-12) + 792\,a(n-13) - 3360\,a(n-14)
\]
for every $n>14$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237551.
