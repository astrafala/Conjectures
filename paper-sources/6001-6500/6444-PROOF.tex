...
\title{The empirical recurrence for OEIS A298960, proved by transfer matrix}
...
\begin{abstract}
OEIS A298960 counts $5$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A298960 is ``Number of nX5 0..1 arrays with every element equal to 3, 5, 6, 7 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
0, 3, 3, 14, 31, 91, 230, 633,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) -a(n-2) +5*a(n-4) -9*a(n-5) -a(n-6) -8*a(n-7) +8*a(n-9) -6*a(n-10) +2*a(n-11)
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 30 2018 13:12:29, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) - a(n-2) + 5\,a(n-4) - 9\,a(n-5) - a(n-6) - 8\,a(n-7) + 8\,a(n-9) - 6\,a(n-10) + 2\,a(n-11)
\end{equation}
for all $n>11$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A298960.
