...
\title{The empirical recurrence for OEIS A207601, proved by transfer matrix}
...
\begin{abstract}
OEIS A207601 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
...
OEIS A207601 is ``Number of 4Xn 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 0 1 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
8, 64, 168, 441, 1995, 9025, 30400,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:07:24, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) - 3\,a(n-2) + 16\,a(n-3) + 88\,a(n-4) + 72\,a(n-5) + 312\,a(n-6) - 936\,a(n-8) - 648\,a(n-9) - 2376\,a(n-10) - 1296\,a(n-11) + 729\,a(n-12) - 729\,a(n-13) + 2187\,a(n-14)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207601.
