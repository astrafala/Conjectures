...
\title{The empirical recurrence for OEIS A306124, proved by transfer matrix}
...
\begin{abstract}
OEIS A306124 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A306124 is ``Number of n X 3 0..1 arrays with every element unequal to 0, 1, 3, 4, 6 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
3, 7, 9, 19, 39, 73, 147, 319,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) -a(n-3) -7*a(n-4) +4*a(n-5) -4*a(n-6) -7*a(n-8) +9*a(n-9) +14*a(n-10) +11*a(n-11) -7*a(n-12) -6*a(n-13).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 13 2021 14:57:11, revision
6) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) - a(n-3) - 7\,a(n-4) + 4\,a(n-5) - 4\,a(n-6) - 7\,a(n-8) + 9\,a(n-9) + 14\,a(n-10) + 11\,a(n-11) - 7\,a(n-12) - 6\,a(n-13)
\end{equation}
for all $n>13$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A306124.
