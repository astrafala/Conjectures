...
\title{The empirical recurrence for OEIS A305218, proved by transfer matrix}
...
\begin{abstract}
OEIS A305218 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A305218 is ``Number of nX3 0..1 arrays with every element unequal to 2, 3, 5, 6 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
0, 4, 8, 15, 31, 92, 264, 784,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 27 2018 17:34:24, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 5\,a(n-2) - 12\,a(n-4) - 15\,a(n-5) + 3\,a(n-6) + 30\,a(n-7) + 14\,a(n-8) - 40\,a(n-9) - 44\,a(n-10) + 23\,a(n-11) + 66\,a(n-12) + 22\,a(n-13) - 15\,a(n-14) - 6\,a(n-15)
\end{equation}
for all $n>18$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A305218.
