...
\title{The empirical recurrence for OEIS A236611, proved by transfer matrix}
...
\begin{abstract}
OEIS A236611 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
OEIS A236611 is ``Number of (n+1)X(1+1) 0..2 arrays colored with the maximum plus the upper median of every 2X2 subblock.''. It has offset $1$ and begins
\[
81, 390, 1885, 8876, 41473, 193372, 912752, 4290712,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 09:22:12, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;16\,a(n-3) + 280\,a(n-4) + 376\,a(n-5) + 932\,a(n-6) + 1120\,a(n-7) - 1456\,a(n-8) - 1696\,a(n-9) - 768\,a(n-10) - 1152\,a(n-11)
\]
for every $n>13$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A236611.
