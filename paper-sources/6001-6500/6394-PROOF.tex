...
\title{The empirical recurrence for OEIS A202770, proved by transfer matrix}
...
\begin{abstract}
OEIS A202770 counts arrays of width $3$ over $\{0,1\}$ containing no occurrence of certain short
...
OEIS A202770 is ``Number of (n+2)X3 binary arrays avoiding patterns 000 and 011 in rows, columns and nw-to-se diagonals.''. It has offset $1$ and begins
\[
86, 201, 424, 833, 1602, 2981, 5467, 9909,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 09:54:09, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) - a(n-2) - a(n-3) - 6\,a(n-4) + 7\,a(n-5) + 4\,a(n-7) - 7\,a(n-8) + 3\,a(n-9) - 3\,a(n-10) + 2\,a(n-11) - a(n-12) + 2\,a(n-13) - a(n-14)
\]
for every $n>11$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A202770.
