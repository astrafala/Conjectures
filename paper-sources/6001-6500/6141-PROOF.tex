...
\title{The empirical recurrence for OEIS A232834, proved by transfer matrix}
...
\begin{abstract}
OEIS A232834 counts arrays of width $3$ over $\{0,\dots,2\}$ under a condition on each cell
...
OEIS A232834 is ``Number of (n+1) X (2+1) 0..2 arrays with every element next to itself plus and minus one within the range 0..2 horizontally, diagonally or antidiagonally.''. It has offset $1$ and begins
\[
16, 312, 3720, 44832, 500516, 5809256, 71242892, 828231244,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 22 2023 14:34:37, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + 18\,a(n-2) + 772\,a(n-3) + 844\,a(n-4) + 9204\,a(n-5) - 55335\,a(n-6) - 127538\,a(n-7) - 311040\,a(n-8) + 198402\,a(n-9) + 173348\,a(n-10) - 196912\,a(n-11) + 1920\,a(n-12) + 15360\,a(n-13)
\]
for every $n>12$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232834.
