...
\title{The empirical recurrence for OEIS A233718, proved by transfer matrix}
...
\begin{abstract}
OEIS A233718 counts $(n+1)\times2$ arrays over $\{0,\dots,7\}$ subject to a condition imposed on
...
OEIS A233718 is ``Number of (n+1)X(1+1) 0..7 arrays with every 2X2 subblock having the sum of the squares of the edge differences equal to 26.''. It has offset $1$ and begins
\[
280, 1820, 11016, 68828, 423220, 2624872, 16201200, 100277820,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 08:58:20, revision 7) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 58\,a(n-2) - 58\,a(n-3) - 1227\,a(n-4) + 461\,a(n-5) + 12296\,a(n-6) + 722\,a(n-7) - 62278\,a(n-8) - 22804\,a(n-9) + 155159\,a(n-10) + 90798\,a(n-11) - 162636\,a(n-12) - 121112\,a(n-13) + 35968\,a(n-14) + 28416\,a(n-15) - 1152\,a(n-16)
\end{equation}
for all $n>16$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A233718.
