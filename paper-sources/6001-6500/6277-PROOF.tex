...
\title{The empirical recurrence for OEIS A252237, proved by transfer matrix}
...
\begin{abstract}
OEIS A252237 counts $(n+2)\times4$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252237 is ``Number of (n+2)X(2+2) 0..3 arrays with every 3X3 subblock row and column sum not equal to 1 3 4 6 or 7 and every 3X3 diagonal and antidiagonal sum equal to 1 3 4 6 or 7.''. It has offset $1$ and begins
\[
858, 3896, 16056, 43848, 215424, 932024, 2568432, 12882368,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 118*a(n-3) -4264*a(n-6) +55168*a(n-9) -225280*a(n-12) +262144*a(n-15) for n>16
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 10:58:12, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;118\,a(n-3) - 4264\,a(n-6) + 55168\,a(n-9) - 225280\,a(n-12) + 262144\,a(n-15)
\]
for every $n>16$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252237.
