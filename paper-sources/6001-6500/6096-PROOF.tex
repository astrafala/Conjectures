...
\title{The empirical recurrence for OEIS A297973, proved by transfer matrix}
...
\begin{abstract}
OEIS A297973 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $equal to$ itself lying in $\{2,3,4,5\}$, and it carries an empirical
...
OEIS A297973 is ``Number of nX3 0..1 arrays with every element equal to 2, 3, 4 or 5 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
0, 3, 8, 20, 124, 501, 2410, 11304,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 10 2018 06:52:07, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) + 10\,a(n-2) - 22\,a(n-3) - 58\,a(n-4) + 51\,a(n-5) + 136\,a(n-6) - 75\,a(n-7) - 137\,a(n-8) + 70\,a(n-9) + 57\,a(n-10) - 33\,a(n-11) - 2\,a(n-12) + 8\,a(n-13)
\end{equation}
for all $n>15$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297973.
