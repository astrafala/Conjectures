...
\title{The empirical recurrence for OEIS A278152, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A278152 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A278152 is ``Number of nX3 0..1 arrays with every element both equal and not equal to some elements at offset (-1,-1) (-1,0) (-1,1) (0,-1) (0,1) (1,-1) or (1,0), with upper left element zero.''. It has offset $1$ and begins
\[
0, 7, 42, 268, 1759, 11675, 77102, 509336,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 13 2016 06:34:06, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) + 5\,a(n-2) - 5\,a(n-3) - 4\,a(n-4) - 38\,a(n-5) - 25\,a(n-6) + 26\,a(n-7) + 3\,a(n-8) + 14\,a(n-9) + 19\,a(n-10) - 3\,a(n-11) + 3\,a(n-12) - a(n-13) - a(n-14)
\end{equation}
for all $n>15$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A278152.
