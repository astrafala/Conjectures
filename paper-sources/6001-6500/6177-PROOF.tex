...
\title{The empirical recurrence for OEIS A251675, proved by transfer matrix}
...
\begin{abstract}
OEIS A251675 counts arrays of width $3$ over $\{0,1,2\}$ in which every $3\times3$ window has
...
OEIS A251675 is ``Number of (n+2)X(1+2) 0..2 arrays with no row, column, diagonal or antidiagonal in any 3X3 subblock summing to 2 or 4.''. It has offset $1$ and begins
\[
293, 489, 953, 2257, 5151, 12063, 29839, 72345,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 10:29:09, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) - a(n-2) + 11\,a(n-3) - 13\,a(n-4) + 8\,a(n-5) - 32\,a(n-6) + 16\,a(n-7) - 18\,a(n-8) + 24\,a(n-9) + 20\,a(n-10) + 16\,a(n-11) - 8\,a(n-12) - 16\,a(n-13) - 8\,a(n-14)
\]
for every $n>15$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251675.
