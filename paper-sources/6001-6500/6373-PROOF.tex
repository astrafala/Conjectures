...
\title{The empirical recurrence for OEIS A236895, proved by transfer matrix}
...
\begin{abstract}
OEIS A236895 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
OEIS A236895 is ``Number of (n+1)X(1+1) 0..2 arrays with the maximum plus the upper median of every 2X2 subblock equal.''. It has offset $1$ and begins
\[
81, 339, 1426, 6545, 30727, 148966, 734805, 3679063,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 09:39:15, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;9\,a(n-1) - 187\,a(n-3) + 343\,a(n-4) + 1052\,a(n-5) - 2856\,a(n-6) - 1872\,a(n-7) + 8792\,a(n-8) - 856\,a(n-9) - 11368\,a(n-10) + 5024\,a(n-11) + 4992\,a(n-12) - 3072\,a(n-13)
\]
for every $n>13$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A236895.
