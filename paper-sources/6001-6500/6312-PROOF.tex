...
\title{The empirical recurrence for OEIS A236806, proved by transfer matrix}
...
\begin{abstract}
OEIS A236806 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
The condition is local to two consecutive rows, so the count is a walk count on $S=1923$
...
OEIS A236806 is ``Number of (n+1)X(5+1) 0..2 arrays with the maximum plus the lower median minus the upper median minus the minimum of every 2X2 subblock equal.''. It has offset $1$ and begins
\[
17481, 410305, 9558409, 270610375, 6612746409, 203606804707, 5094225962785, 167431587932179,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 09:34:28, revision 6) this is still
...
$5$ subblocks they form. So a row is a state, an $(n+1)$-row array is a walk of $n$
...
array, which is not among the objects counted. There are $S=1923$ states left.
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) + 2037\,a(n-2) - 12282\,a(n-3) - 1251404\,a(n-4) + 7631304\,a(n-5) + 222376028\,a(n-6) - 1410692088\,a(n-7) + 774758880\,a(n-8) + 9534803520\,a(n-9) - 17365107200\,a(n-10) - 5340748800\,a(n-11) + 29872128000\,a(n-12) - 16293888000\,a(n-13)
\]
for every $n>12$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A236806.
