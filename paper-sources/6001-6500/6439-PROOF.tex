...
\title{The empirical recurrence for OEIS A184469, proved by transfer matrix}
...
\begin{abstract}
OEIS A184469 counts arrays of width $3$ over $\{0,1,2\}$ in which every $3\times3$ subblock
satisfies a condition on its nine entries. The entry carries an empirical recurrence of order
$10$ contributed by R.~H.~Hardin. It is true, and it is decidable rather than empirical: a
...
OEIS A184469 is ``1/6 the number of (n+2) X 3 0..2 arrays with each 3 X 3 subblock containing one of one value, four of another, and four of the last.''. It has offset $1$ and begins
\[
315, 1095, 3705, 12339, 45585, 161739, 559305, 2147931,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) + 96*a(n-3) - 288*a(n-4) - 2700*a(n-6) + 8100*a(n-7) + 23328*a(n-9) - 69984*a(n-10).
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 12 2018 12:27:59, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + 96\,a(n-3) - 288\,a(n-4) - 2700\,a(n-6) + 8100\,a(n-7) + 23328\,a(n-9) - 69984\,a(n-10)
\]
for every $n>10$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A184469.
