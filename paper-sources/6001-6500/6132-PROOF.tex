...
\title{The empirical recurrence for OEIS A252467, proved by transfer matrix}
...
\begin{abstract}
OEIS A252467 counts $(n+2)\times4$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252467 is ``Number of (n+2)X(2+2) 0..3 arrays with every 3X3 subblock row, column, diagonal and antidiagonal sum not equal to 0 3 5 6 or 8.''. It has offset $1$ and begins
\[
716, 682, 813, 1463, 3497, 9056, 24331, 66366,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:16:53, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252467.
