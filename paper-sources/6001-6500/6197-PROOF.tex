...
\title{The empirical recurrence for OEIS A237000, proved by transfer matrix}
...
\begin{abstract}
OEIS A237000 counts arrays over $\{0,\dots,3\}$ subject to a condition on the order
...
The condition is local to two consecutive rows, so the count is a walk count on $S=84$
...
OEIS A237000 is ``Number of (n+1) X (1+1) 0..3 arrays with the upper median plus the lower median of every 2 X 2 subblock equal.''. It has offset $1$ and begins
\[
256, 1200, 5288, 26320, 131280, 677344, 3518120, 18477584,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 06 2026 20:46:22, revision 9) this is still
...
array, which is not among the objects counted. There are $S=84$ states left.
...
\begin{theorem}
\[
a(n)\;=\;13\,a(n-1) - 21\,a(n-2) - 329\,a(n-3) + 1031\,a(n-4) + 3487\,a(n-5) - 13091\,a(n-6) - 21599\,a(n-7) + 79282\,a(n-8) + 90220\,a(n-9) - 248320\,a(n-10) - 246896\,a(n-11) + 371200\,a(n-12) + 361344\,a(n-13) - 192000\,a(n-14) - 184320\,a(n-15)
\]
for every $n>14$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237000.
