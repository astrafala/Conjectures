...
\title{The empirical recurrence for OEIS A253978, proved by transfer matrix}
...
\begin{abstract}
OEIS A253978 counts the arrays over $\{0,\dots,1\}$ whose $3\times3$ subblocks carry a
...
OEIS A253978 is ``Number of (n+2)X(1+2) 0..1 arrays with every 3X3 subblock diagonal maximum plus antidiagonal maximum nondecreasing horizontally and vertically.''. It has offset $1$ and begins
\[
512, 3372, 21304, 136868, 881432, 5659548, 36317408, 233116252,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 14:22:59, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-1) - 6\,a(n-2) + 18\,a(n-3) - 3\,a(n-4) - 123\,a(n-5) + 14\,a(n-6) - 74\,a(n-7) + 60\,a(n-8) + 396\,a(n-9) + 120\,a(n-10) + 24\,a(n-11) + 32\,a(n-12) - 32\,a(n-13)
\]
for every $n>13$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253978.
