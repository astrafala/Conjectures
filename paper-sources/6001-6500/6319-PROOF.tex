...
\title{The empirical recurrence for OEIS A252068, proved by transfer matrix}
...
\begin{abstract}
OEIS A252068 counts $(n+2)\times3$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A252068 is ``Number of (n+2)X(1+2) 0..2 arrays with every 3X3 subblock row, column, diagonal and antidiagonal sum not equal to 0 3 or 4.''. It has offset $1$ and begins
\[
92, 105, 183, 375, 767, 1573, 3279, 6994,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 10:45:19, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 2\,a(n-3) + 2\,a(n-4) - 5\,a(n-5) - 6\,a(n-6) - 8\,a(n-7) - 3\,a(n-8) + 3\,a(n-9) + 6\,a(n-10) + 6\,a(n-11) + 2\,a(n-12)
\]
for every $n>14$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252068.
