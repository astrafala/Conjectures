...
\title{The empirical recurrence for OEIS A261108, proved by transfer matrix}
...
\begin{abstract}
OEIS A261108 counts $(n+2)\times5$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A261108 is ``Number of (n+2) X (3+2) 0..1 arrays with each 3 X 3 subblock having clockwise perimeter pattern 00010001 00010101 or 01010101.''. It has offset $1$ and begins
\[
63, 106, 278, 566, 1408, 2902, 7284, 14942,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-2) + 10*a(n-4) + 5*a(n-6) + 2*a(n-8) - 2*a(n-10) + a(n-12) for n>13.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 30 2018 06:35:10, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A261108.
