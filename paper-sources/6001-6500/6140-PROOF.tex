...
\title{The empirical recurrence for OEIS A234125, proved by transfer matrix}
...
\begin{abstract}
OEIS A234125 counts $(n+1)\times3$ arrays over $\{0,\dots,6\}$ subject to a condition imposed on
...
OEIS A234125 is ``Number of (n+1)X(2+1) 0..6 arrays with every 2X2 subblock having the absolute values of all six edge and diagonal differences no larger than 1.''. It has offset $1$ and begins
\[
469, 4757, 47933, 484731, 4909103, 49779251, 505273311, 5132833317,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 09:12:36, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;26\,a(n-1) - 218\,a(n-2) + 474\,a(n-3) + 1603\,a(n-4) - 5034\,a(n-5) - 4660\,a(n-6) + 14440\,a(n-7) + 7897\,a(n-8) - 13910\,a(n-9) - 6694\,a(n-10) + 2654\,a(n-11) + 581\,a(n-12) - 250\,a(n-13) + 20\,a(n-14)
\end{equation}
for all $n>14$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234125.
