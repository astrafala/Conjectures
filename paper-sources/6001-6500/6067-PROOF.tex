...
\title{The empirical recurrence for OEIS A282475, proved by transfer matrix}
...
\begin{abstract}
OEIS A282475 counts $n\times2$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A282475 is ``Number of n X 2 0..1 arrays with no 1 equal to more than three of its king-move neighbors, with the exception of exactly two elements.''. It has offset $1$ and begins
\[
0, 0, 5, 18, 89, 408, 1754, 7528,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 01 2024 02:30:23, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;9\,a(n-1) - 24\,a(n-2) + 30\,a(n-3) - 108\,a(n-4) + 192\,a(n-5) - 74\,a(n-6) + 582\,a(n-7) - 207\,a(n-8) + 391\,a(n-9) - 846\,a(n-10) + 60\,a(n-11) - 596\,a(n-12) + 480\,a(n-13) + 336\,a(n-15) - 96\,a(n-16) - 64\,a(n-18)
\]
for every $n>18$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A282475.
