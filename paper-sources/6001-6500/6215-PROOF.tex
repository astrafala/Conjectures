...
\title{The empirical recurrence for OEIS A298082, proved by transfer matrix}
...
\begin{abstract}
OEIS A298082 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A298082 is ``Number of nX3 0..1 arrays with every element equal to 2, 3, 5 or 6 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
0, 3, 0, 3, 1, 7, 18, 52,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 12 2018 08:59:05, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 2\,a(n-2) - 4\,a(n-3) - 11\,a(n-4) + a(n-5) + 15\,a(n-6) + 7\,a(n-7) + a(n-8) - 24\,a(n-9) - 39\,a(n-10) + 13\,a(n-11) + 32\,a(n-12) + 8\,a(n-13) + 5\,a(n-14) - 2\,a(n-15) - 2\,a(n-16)
\end{equation}
for all $n>17$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A298082.
