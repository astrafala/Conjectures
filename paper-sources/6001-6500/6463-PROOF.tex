...
\title{The empirical recurrence for OEIS A295777, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A295777 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A295777 is ``Number of nX4 0..1 arrays with each 1 adjacent to 0 or 2 king-move neighboring 1s.''. It has offset $1$ and begins
\[
8, 49, 198, 1059, 5263, 25529, 127731, 630988,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 4*a(n-1) +6*a(n-2) +6*a(n-3) -58*a(n-4) -20*a(n-5) +29*a(n-6) -92*a(n-7) +7*a(n-8) +2*a(n-9) -2*a(n-10)
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 27 2017 07:11:23, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) + 6\,a(n-2) + 6\,a(n-3) - 58\,a(n-4) - 20\,a(n-5) + 29\,a(n-6) - 92\,a(n-7) + 7\,a(n-8) + 2\,a(n-9) - 2\,a(n-10)
\end{equation}
for all $n>11$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A295777.
