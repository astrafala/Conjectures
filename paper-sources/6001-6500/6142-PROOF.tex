...
\title{The empirical recurrence for OEIS A229842, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A229842 counts arrays over $\{0,\dots,2\}$ in which every cell is constrained by the
...
OEIS A229842 is ``Number of nX3 0..2 arrays x(i,j) with each element horizontally or vertically next to at least one element with value 2-x(i,j).''. It has offset $1$ and begins
\[
3, 81, 987, 13401, 178311, 2381469, 31783299, 424240833,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 08:38:49, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;10\,a(n-1) + 44\,a(n-2) + 20\,a(n-3) - 122\,a(n-4) - 303\,a(n-5) - 129\,a(n-6) + 244\,a(n-7) + 526\,a(n-8) - 74\,a(n-9) - 220\,a(n-10) - 225\,a(n-11) + 96\,a(n-12) + 172\,a(n-13) - 50\,a(n-14) + 44\,a(n-15)
\end{equation}
for all $n>16$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A229842.
