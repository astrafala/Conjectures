...
\title{The empirical recurrence for OEIS A204717, proved by transfer matrix}
...
\begin{abstract}
OEIS A204717 counts arrays over $\{0,\dots,1\}$ under a condition on the permanent of every
$2\times2$ subblock, and carries an empirical recurrence of order $13$ contributed by
R.~H.~Hardin. It is true, and it is decidable rather than empirical. The condition is local to
a bounded window of consecutive rows, so the count is a walk count on $S=51$ states and is
...
OEIS A204717 is ``Number of (n+1) X 3 0..1 arrays with the permanents of 2 X 2 subblocks nondecreasing rightwards and downwards.''. It has offset $1$ and begins
\[
51, 261, 1271, 5821, 26128, 115060, 502546, 2181023,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 11:25:41, revision 9) this is still
...
entry's first term is $51$, and the model reproduces it along with every later term; that
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-1) - a(n-2) - 74\,a(n-3) + 80\,a(n-4) + 292\,a(n-5) - 406\,a(n-6) - 510\,a(n-7) + 827\,a(n-8) + 333\,a(n-9) - 745\,a(n-10) + 24\,a(n-11) + 246\,a(n-12) - 72\,a(n-13)
\]
for every $n>13$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204717.
