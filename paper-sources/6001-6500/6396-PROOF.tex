...
\title{The empirical recurrence for OEIS A298282, proved by transfer matrix}
...
\begin{abstract}
OEIS A298282 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $equal to$ itself lying in $\{0,1,2,3,6\}$, and it carries an empirical
...
OEIS A298282 is ``Number of n X 3 0..1 arrays with every element equal to 0, 1, 2, 3 or 6 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
4, 25, 70, 205, 614, 1860, 5631, 17034,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) - a(n-2) + 2*a(n-3) + 4*a(n-4) - a(n-5) + 2*a(n-6) - 2*a(n-7) - 3*a(n-8) - 2*a(n-9) - 2*a(n-10) - 2*a(n-11) for n>12.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 26 2018 12:15:36, revision
8) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) - a(n-2) + 2\,a(n-3) + 4\,a(n-4) - a(n-5) + 2\,a(n-6) - 2\,a(n-7) - 3\,a(n-8) - 2\,a(n-9) - 2\,a(n-10) - 2\,a(n-11)
\end{equation}
for all $n>12$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A298282.
