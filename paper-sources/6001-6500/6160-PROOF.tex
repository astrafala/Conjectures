...
\title{The empirical recurrence for OEIS A260469, proved by transfer matrix}
...
\begin{abstract}
OEIS A260469 counts $(n+2)\times4$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A260469 is ``Number of (n+2)X(2+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000000 00000001 or 00010101.''. It has offset $1$ and begins
\[
49, 92, 213, 471, 1085, 2562, 5891, 13530,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 12:06:53, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + a(n-2) + 5\,a(n-3) + a(n-4) - 3\,a(n-5) - 3\,a(n-6) + a(n-7) + 2\,a(n-8) - a(n-9) - 5\,a(n-10) - 5\,a(n-11) - 2\,a(n-15) - 2\,a(n-16)
\]
for every $n>17$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A260469.
