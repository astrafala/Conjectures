...
\title{The empirical recurrence for OEIS A256804, proved by transfer matrix}
...
\begin{abstract}
OEIS A256804 counts $(n+2)\times4$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A256804 is ``Number of (n+2)X(2+2) 0..1 arrays with no 3x3 subblock diagonal sum 0 and no antidiagonal sum 0 and no row sum 0 or 1 and no column sum 0 or 1.''. It has offset $1$ and begins
\[
86, 312, 1167, 4219, 15291, 55798, 203129, 738760,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:45:31, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 4\,a(n-2) + 17\,a(n-3) + 18\,a(n-4) - 7\,a(n-5) - 37\,a(n-6) - 47\,a(n-7) + 2\,a(n-8) + 40\,a(n-9) + 21\,a(n-10) - 7\,a(n-11) - 3\,a(n-12) - 2\,a(n-13) - a(n-14)
\]
for every $n>14$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A256804.
