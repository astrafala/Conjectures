...
\title{The empirical recurrence for OEIS A230064, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A230064 counts arrays over $\{0,\dots,2\}$ in which every cell is constrained by the
...
OEIS A230064 is ``Number of nX4 0..2 arrays x(i,j) with each element diagonally or antidiagonally next to at least one element with value 2-x(i,j).''. It has offset $1$ and begins
\[
0, 81, 441, 15129, 281961, 6487209, 137945025, 3020271849,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 08:40:43, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;17\,a(n-1) + 132\,a(n-2) - 633\,a(n-3) - 223\,a(n-4) + 1688\,a(n-5) + 49\,a(n-6) - 593\,a(n-7) + 68\,a(n-8) + 9\,a(n-9) - a(n-10)
\end{equation}
for all $n>11$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A230064.
