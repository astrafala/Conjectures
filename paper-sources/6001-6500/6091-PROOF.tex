...
\title{The empirical recurrence for OEIS A278089, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A278089 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A278089 is ``Number of n X 3 0..1 arrays with every element both equal and not equal to some elements at offset (-1,0) (-1,1) (0,-1) (0,1) or (1,0), with upper left element zero.''. It has offset $1$ and begins
\[
0, 3, 16, 66, 351, 1758, 9033, 46159,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 09 2021 20:39:14, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 14\,a(n-2) - 9\,a(n-3) - 44\,a(n-4) + 21\,a(n-5) + 83\,a(n-6) - 19\,a(n-7) - 81\,a(n-8) + a(n-9) + 17\,a(n-10) - 10\,a(n-11) + 4\,a(n-12) + 5\,a(n-13)
\end{equation}
for all $n>16$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A278089.
