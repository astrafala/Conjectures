...
\title{The empirical recurrence for OEIS A301445, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A301445 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A301445 is ``Number of nX3 0..1 arrays with every element equal to 0, 1, 2, 3, 5 or 6 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
4, 29, 171, 1008, 5930, 34976, 206266, 1216562,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 5*a(n-1) +7*a(n-2) -10*a(n-3) -a(n-4) +7*a(n-5) -17*a(n-6) +5*a(n-8) -11*a(n-9) +5*a(n-10) -2*a(n-12) +2*a(n-13)
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 21 2018 11:53:06, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) + 7\,a(n-2) - 10\,a(n-3) - a(n-4) + 7\,a(n-5) - 17\,a(n-6) + 5\,a(n-8) - 11\,a(n-9) + 5\,a(n-10) - 2\,a(n-12) + 2\,a(n-13)
\end{equation}
for all $n>14$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A301445.
