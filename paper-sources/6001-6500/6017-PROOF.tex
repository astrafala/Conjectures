...
\title{The empirical recurrence for OEIS A230246, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A230246 counts arrays over $\{0,\dots,3\}$ in which every cell is constrained by the
...
OEIS A230246 is ``Number of nX3 0..3 arrays x(i,j) with each element horizontally or vertically next to at least one element with value (x(i,j)+1) mod 4, and upper left element zero.''. It has offset $1$ and begins
\[
0, 6, 34, 514, 5838, 64838, 722386, 8040426,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 05:48:46, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;19\,a(n-1) - 112\,a(n-2) + 308\,a(n-3) - 443\,a(n-4) + 531\,a(n-5) - 1290\,a(n-6) + 2646\,a(n-7) - 1150\,a(n-8) - 3528\,a(n-9) + 4044\,a(n-10) - 384\,a(n-11) + 752\,a(n-12) - 384\,a(n-13)
\end{equation}
for all $n>14$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A230246.
