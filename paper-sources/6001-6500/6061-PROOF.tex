...
\title{The empirical recurrence for OEIS A296323, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A296323 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A296323 is ``Number of nX4 0..1 arrays with each 1 horizontally, vertically or antidiagonally adjacent to 2 neighboring 1s.''. It has offset $1$ and begins
\[
1, 8, 23, 61, 185, 562, 1677, 4998,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 10 2017 11:44:30, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) - 6\,a(n-2) + 13\,a(n-3) - 17\,a(n-4) + 22\,a(n-5) - 30\,a(n-6) + 33\,a(n-7) - 42\,a(n-8) + 37\,a(n-9) - 34\,a(n-10) + 21\,a(n-11) - 12\,a(n-12) + 4\,a(n-13) - a(n-14)
\end{equation}
for all $n>15$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A296323.
