...
\title{The empirical recurrence for OEIS A188993, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A188993 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A188993 is ``Number of 3Xn binary arrays without the pattern 0 0 1 antidiagonally or horizontally.''. It has offset $1$ and begins
\[
8, 64, 295, 1256, 5304, 21952, 89744, 364088,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 04:59:30, revision 9) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A188993.
