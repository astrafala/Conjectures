...
\title{The empirical recurrence for OEIS A278001, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A278001 counts arrays over $\{0,\dots,2\}$ in which every cell is constrained by the
...
OEIS A278001 is ``Number of nX3 0..2 arrays with every element plus 1 mod 3 equal to some element at offset (-1,-1) (-1,0) (-1,1) (0,-1) (0,1) (1,-1) or (1,0), with upper left element zero.''. It has offset $1$ and begins
\[
0, 52, 866, 16583, 316432, 6031565, 114975158, 2191741025,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 08 2016 08:34:06, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;18\,a(n-1) + 21\,a(n-2) + 15\,a(n-3) - 530\,a(n-4) - 562\,a(n-5) + 986\,a(n-6) + 5831\,a(n-7) - 1452\,a(n-8) - 8962\,a(n-9) - 19556\,a(n-10) + 24096\,a(n-11) + 21600\,a(n-12) + 12480\,a(n-13) - 45824\,a(n-14) + 3456\,a(n-15) - 768\,a(n-16)
\end{equation}
for all $n>17$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A278001.
