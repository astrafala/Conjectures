...
\title{The empirical recurrence for OEIS A260242, proved by transfer matrix}
...
\begin{abstract}
OEIS A260242 counts $(n+2)\times4$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A260242 is ``Number of (n+2)X(2+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000001 00000101 or 00001001.''. It has offset $1$ and begins
\[
99, 213, 551, 1235, 3026, 7822, 18837, 45114,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 12:03:36, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + a(n-2) + 4\,a(n-3) + 9\,a(n-4) - 13\,a(n-5) + 14\,a(n-6) + 6\,a(n-7) - 35\,a(n-8) + 11\,a(n-9) + 11\,a(n-10) - 4\,a(n-11) - 14\,a(n-12) + 10\,a(n-13) - 4\,a(n-14)
\]
for every $n>15$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A260242.
