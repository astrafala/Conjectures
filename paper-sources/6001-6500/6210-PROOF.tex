...
\title{The empirical recurrence for OEIS A202909, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A202909 counts arrays over $\{0,\dots,7\}$ in which every cell is constrained by the
...
OEIS A202909 is ``Number of nX1 0..7 arrays with every nonzero element less than or equal to some horizontal or vertical neighbor.''. It has offset $1$ and begins
\[
1, 8, 64, 372, 1856, 9052, 45648, 235538,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 09:56:44, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;8\,a(n-1) - 28\,a(n-2) + 84\,a(n-3) - 126\,a(n-4) + 252\,a(n-5) - 210\,a(n-6) + 330\,a(n-7) - 165\,a(n-8) + 220\,a(n-9) - 66\,a(n-10) + 78\,a(n-11) - 13\,a(n-12) + 14\,a(n-13) - a(n-14) + a(n-15)
\end{equation}
for all $n>16$.
...
Let $V=\{0,\dots,7\}^{1}$ be the possible rows and take
...
$8$ values, so there are about $10^{18}$ of them to sift. The
...
of the $(7+1)^{1}$ possible next rows, the condition was tested on every cell of
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A202909.
