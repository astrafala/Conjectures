...
\title{The empirical recurrence for OEIS A196317, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A196317 counts arrays over $\{0,\dots,4\}$ in which every cell is constrained by the
...
OEIS A196317 is ``Number of n X 3 0..4 arrays with each element x equal to the number its horizontal and vertical neighbors equal to 1,3,0,2,4 for x=0,1,2,3,4.''. It has offset $1$ and begins
\[
2, 10, 30, 88, 299, 978, 3132, 10106,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) + 3*a(n-2) + 2*a(n-3) + 4*a(n-4) - 2*a(n-5) + 3*a(n-6) + 7*a(n-7) - a(n-8) - 10*a(n-9) - 9*a(n-10) - 2*a(n-11).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 01 2018 05:31:01, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 3\,a(n-2) + 2\,a(n-3) + 4\,a(n-4) - 2\,a(n-5) + 3\,a(n-6) + 7\,a(n-7) - a(n-8) - 10\,a(n-9) - 9\,a(n-10) - 2\,a(n-11)
\end{equation}
for all $n>12$.
...
\#\{\text{neighbours with value }f(x_{t,u})\}=x_{t,u},\quad f=(1,3,0,2,4)
\end{equation}
for every cell $(t,u)$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A196317.
