...
\title{The empirical recurrence for OEIS A250582, proved by transfer matrix}
...
\begin{abstract}
OEIS A250582 counts arrays over $\{0,1\}$ in which a statistic taken over short runs
...
OEIS A250582 is ``Number of (n+1)X(7+1) 0..1 arrays with nondecreasing max(x(i,j),x(i,j-1)) in the i direction and nondecreasing min(x(i,j),x(i-1,j)) in the j direction.''. It has offset $1$ and begins
\[
1428, 4009, 9346, 20510, 44104, 94623, 203560, 441215,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 12:33:49, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-1) - 20\,a(n-2) - 5\,a(n-3) + 113\,a(n-4) - 184\,a(n-5) - 13\,a(n-6) + 366\,a(n-7) - 407\,a(n-8) + 49\,a(n-9) + 244\,a(n-10) - 210\,a(n-11) + 59\,a(n-12) + 7\,a(n-13) - 7\,a(n-14) + a(n-15)
\]
for every $n>19$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250582.
