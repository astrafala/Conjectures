...
\title{The empirical recurrence for OEIS A318011, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A318011 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A318011 is ``Number of nX3 0..1 arrays with every element unequal to 0, 1, 2 or 3 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
4, 28, 118, 508, 2130, 8971, 37700, 158613,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) +5*a(n-2) +3*a(n-4) -4*a(n-5) -11*a(n-6) -6*a(n-7) -a(n-8) -4*a(n-9) -4*a(n-10) -a(n-11) for n>14
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2018 19:33:57, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 5\,a(n-2) + 3\,a(n-4) - 4\,a(n-5) - 11\,a(n-6) - 6\,a(n-7) - a(n-8) - 4\,a(n-9) - 4\,a(n-10) - a(n-11)
\end{equation}
for all $n>14$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A318011.
