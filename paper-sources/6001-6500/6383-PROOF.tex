...
\title{The empirical recurrence for OEIS A252547, proved by transfer matrix}
...
\begin{abstract}
OEIS A252547 counts $5\times(n+2)$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252547 is ``Number of (3+2)X(n+2) 0..3 arrays with every 3X3 subblock row and diagonal sum equal to 1 3 4 6 or 7 and every 3X3 column and antidiagonal sum not equal to 1 3 4 6 or 7.''. It has offset $1$ and begins
\[
2142, 15480, 88146, 331884, 2576592, 15204660, 65274264, 519308064,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 454*a(n-3) -60040*a(n-6) +2444800*a(n-9) -13041664*a(n-12) +16777216*a(n-15)
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:20:47, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;454\,a(n-3) - 60040\,a(n-6) + 2444800\,a(n-9) - 13041664\,a(n-12) + 16777216\,a(n-15)
\]
for every $n>15$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252547.
