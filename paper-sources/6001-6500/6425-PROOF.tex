...
\title{The empirical recurrence for OEIS A302008, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A302008 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A302008 is ``Number of nX6 0..1 arrays with every element equal to 0, 1, 2 or 3 horizontally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
32, 2048, 102544, 5276816, 270990144, 13918667808, 714887543376, 36717919842624,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 30 2018 12:51:31, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;45\,a(n-1) + 324\,a(n-2) + 190\,a(n-3) - 2434\,a(n-4) - 3156\,a(n-5) + 5467\,a(n-6) + 5122\,a(n-7) - 6753\,a(n-8) + 1356\,a(n-9) - 16\,a(n-10)
\end{equation}
for all $n>12$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302008.
