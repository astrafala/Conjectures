...
\title{The empirical recurrence for OEIS A296034, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A296034 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A296034 is ``Number of n X 3 0..1 arrays with each 1 adjacent to 2 or 4 king-move neighboring 1s.''. It has offset $1$ and begins
\[
1, 11, 31, 70, 251, 799, 2266, 7005,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) + a(n-2) + 11*a(n-3) - 7*a(n-4) - 12*a(n-5) - 23*a(n-6) + 19*a(n-8) + 9*a(n-9) - 3*a(n-10) - 2*a(n-11).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 22 2019 15:27:05, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + a(n-2) + 11\,a(n-3) - 7\,a(n-4) - 12\,a(n-5) - 23\,a(n-6) + 19\,a(n-8) + 9\,a(n-9) - 3\,a(n-10) - 2\,a(n-11)
\end{equation}
for all $n>12$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A296034.
