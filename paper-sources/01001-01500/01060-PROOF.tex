...
\title{The empirical recurrence for OEIS A199911, proved from an exact model}
...
\begin{abstract}
OEIS A199911 carries an empirical recurrence of order $10$. It is true, and it is
...
OEIS A199911 is ``Number of -n..n arrays x(0..3) of 4 elements with zero sum, and adjacent elements not equal modulo three (with -1 modulo 3 = 2).''. It has offset $1$ and begins
\[
8, 24, 72, 152, 256, 448, 680, 952,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) +3*a(n-3) -3*a(n-4) -3*a(n-6) +3*a(n-7) +a(n-9) -a(n-10).
\end{quote}
As of the ``Last modified'' line on the live entry (May 17 2018 08:39:17, revision 9)
...
\]
annihilates $a$, and $S=\deg A=46$. A congruence condition modulo $m$ is counted one residue
...
exactly $\deg A$. The bound in force is therefore $zA(z)$, of order $S=46$, and
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A199911.
