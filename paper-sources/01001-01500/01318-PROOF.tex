...
\title{The empirical recurrence for OEIS A264484, proved by transfer matrix}
...
\begin{abstract}
OEIS A264484 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=2$ rows in which
...
OEIS A264484 is ``Number of (n+1) X (1+1) arrays of permutations of 0..n*2+1 with each element having directed index change 2,-1 1,0 2,1 0,-1 -2,-2 or -1,0.''. It has offset $1$ and begins
\[
1, 3, 4, 12, 25, 52, 121, 261,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + a(n-3) - 2*a(n-4) + 4*a(n-5) + a(n-6) - a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 08 2019 06:45:29, revision 11) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + a(n-3) - 2\,a(n-4) + 4\,a(n-5) + a(n-6) - a(n-9)
\]
for every $n>7$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264484.
