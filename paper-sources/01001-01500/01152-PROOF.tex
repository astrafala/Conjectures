...
\title{The empirical recurrence for OEIS A264068, proved by transfer matrix}
...
\begin{abstract}
OEIS A264068 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=6$ rows in which
...
OEIS A264068 is ``Number of (n+1) X (5+1) arrays of permutations of 0..n*6+5 with each element having index change +-(.,.) 0,0 1,1 or 1,2.''. It has offset $1$ and begins
\[
89, 3025, 131890, 5645376, 242621698, 10427064769, 448121165789, 19258783041289,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 43*a(n-1) - 43*a(n-3) + a(n-4) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 26 2025 18:44:49, revision 12) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264068.
