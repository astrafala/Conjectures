...
\title{The empirical recurrence for OEIS A200158, proved from an exact model}
...
\begin{abstract}
OEIS A200158 carries an empirical recurrence of order $64$. It is true, and it is
...
OEIS A200158 is ``Number of 0..n arrays x(0..6) of 7 elements with zero 6th difference.''. It has offset $1$ and begins
\[
2, 45, 182, 685, 2036, 5153, 11370, 23035,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 08:27:45, revision 9)
...
$q(z)=z^{64}-\sum_ic_iz^{64-i}$ the characteristic polynomial of the conjectured
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) - a(n-2) + 2\,a(n-6) - 4\,a(n-7) + 2\,a(n-8) - a(n-12) + 2\,a(n-13) - a(n-14) + 2\,a(n-15) - 4\,a(n-16) + 2\,a(n-17) + a(n-20) - 6\,a(n-21) + 9\,a(n-22) - 4\,a(n-23) - 2\,a(n-26) + 6\,a(n-27) - 6\,a(n-28) + 2\,a(n-29) - a(n-30) + 2\,a(n-31) - 2\,a(n-33) + a(n-34) - 2\,a(n-35) + 6\,a(n-36) - 6\,a(n-37) + 2\,a(n-38) + 4\,a(n-41) - 9\,a(n-42) + 6\,a(n-43) - a(n-44) - 2\,a(n-47) + 4\,a(n-48) - 2\,a(n-49) + a(n-50) - 2\,a(n-51) + a(n-52) - 2\,a(n-56) + 4\,a(n-57) - 2\,a(n-58) + a(n-62) - 2\,a(n-63) + a(n-64)
\]
for every $n>0$.
\end{theorem}
...
vanish from $n=0+1$ onwards, and the run exceeds $S+64$, which by
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A200158.
