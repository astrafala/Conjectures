...
\title{The empirical recurrence for OEIS A281406, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A281406 imposes three things at once: a condition on each cell that reaches one column up and
...
OEIS A281406 is ``Number of 7Xn 0..1 arrays with no element equal to more than two of its horizontal, diagonal or antidiagonal neighbors, with the exception of exactly one element, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
0, 2692, 10226, 17194, 30959, 51940, 84474, 129934,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 21 2017 08:06:39, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) - 6\,a(n-2) + 6\,a(n-3) - 7\,a(n-4) + 6\,a(n-5) - 3\,a(n-6) + 4\,a(n-7) - 7\,a(n-8) + 6\,a(n-9) - 4\,a(n-10) + 4\,a(n-11) - 2\,a(n-12) - a(n-14) + 2\,a(n-15) - a(n-16)
\end{equation}
for all $n>31$.
...
\begin{theorem}
The recurrence \eqref{eq:conj} holds for every $n>31$, which is the statement of
Section~1.
\end{theorem}
...
index corresponding to $n=31+1$ onwards, and the run continued until $S+1$ consecutive
zeros had been seen.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A281406.
