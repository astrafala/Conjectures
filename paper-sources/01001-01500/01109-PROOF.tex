...
\title{The empirical recurrence for OEIS A279162, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A279162 imposes three things at once: a condition on each cell that reaches one row up and
...
OEIS A279162 is ``Number of n X 2 0..1 arrays with no element equal to a strict majority of its king-move neighbors, with the exception of exactly two elements, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
1, 0, 0, 8, 24, 88, 284, 772,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 7*a(n-1) - 19*a(n-2) + 31*a(n-3) - 52*a(n-4) + 82*a(n-5) - 84*a(n-6) + 84*a(n-7) - 96*a(n-8) + 56*a(n-9) - 32*a(n-10) + 32*a(n-11).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 10 2019 09:01:28, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;7\,a(n-1) - 19\,a(n-2) + 31\,a(n-3) - 52\,a(n-4) + 82\,a(n-5) - 84\,a(n-6) + 84\,a(n-7) - 96\,a(n-8) + 56\,a(n-9) - 32\,a(n-10) + 32\,a(n-11)
\end{equation}
for all $n>12$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A279162.
