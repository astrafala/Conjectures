...
\title{The empirical recurrence for OEIS A263120, proved by transfer matrix}
...
\begin{abstract}
OEIS A263120 counts arrays of width $5$ over $\{0,1\}$ whose rows, read as base-$2$
numbers, are divisible by $15$ and whose columns, read the same way, are not divisible by
$15$. The entry carries an empirical recurrence of order $46$ contributed by
...
is then a walk count on $S=225$ states.
\end{abstract}
...
OEIS A263120 is ``Number of (n+3)X(2+3) 0..1 arrays with each row divisible by 15 and column not divisible by 15, read as a binary number with top and left being the most significant bits.''. It has offset $1$ and begins
\[
36, 148, 522, 1708, 5124, 15640, 47602, 144236,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 10 2015 07:05:36, revision 4) this is still
...
$15$ and every $\gamma_j$ be not divisible by $15$.
...
\gamma_j^{(i)}\bmod 15\;=\;
\bigl(2\,(\gamma_j^{(i-1)}\bmod 15)+x(i,j)\bigr)\bmod 15 .
\]
\end{lemma}
...
$15$ commutes with both operations.
\end{proof}

So the vector $\bigl(\gamma_1\bmod 15,\dots,\gamma_{5}\bmod
15\bigr)$ is a state: at most $15^{5}$ of them, and each array row
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) - a(n-2) - 8\,a(n-3) + 48\,a(n-4) - 168\,a(n-5) + 48\,a(n-6) + 312\,a(n-7) - 955\,a(n-8) + 2884\,a(n-9) - 955\,a(n-10) - 4832\,a(n-11) + 7632\,a(n-12) - 16032\,a(n-13) + 7632\,a(n-14) + 17568\,a(n-15) + 4886\,a(n-16) - 72248\,a(n-17) + 4886\,a(n-18) + 197200\,a(n-19) - 366336\,a(n-20) + 873744\,a(n-21) - 366336\,a(n-22) - 1155888\,a(n-23) + 1014058\,a(n-24) - 588568\,a(n-25) + 1014058\,a(n-26) - 2290528\,a(n-27) + 6020160\,a(n-28) - 17209056\,a(n-29) + 6020160\,a(n-30) + 27546528\,a(n-31) - 27604133\,a(n-32) + 27776948\,a(n-33) - 27604133\,a(n-34) + 27085688\,a(n-35) - 75797424\,a(n-36) + 221932632\,a(n-37) - 75797424\,a(n-38) - 362608200\,a(n-39) + 362785825\,a(n-40) - 363318700\,a(n-41) + 362785825\,a(n-42) - 361187200\,a(n-43) + 406335600\,a(n-44) - 541780800\,a(n-45) + 406335600\,a(n-46)
\]
for every $n>43$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A263120.
