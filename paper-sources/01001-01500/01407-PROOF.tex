...
\title{The empirical recurrence for OEIS A233160, proved by transfer matrix}
...
\begin{abstract}
OEIS A233160 counts arrays over $\{0,\dots,2\}$ in which no two entries that are neighbours in
...
carried by one bounded piece of extra state, so the count is a walk count on $S=365$ states.
\end{abstract}
...
OEIS A233160 is ``Number of 7Xn 0..2 arrays with no element x(i,j) adjacent to value 2-x(i,j) horizontally or antidiagonally.''. It has offset $1$ and begins
\[
2187, 24576, 559872, 12754584, 310536504, 7663517136, 191184793128, 4789657390320,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 07:55:41, revision 6) this is still
...
identified; after that identification there are $S=365$ of them.
...
\begin{theorem}
\[
a(n)\;=\;55\,a(n-1) - 1066\,a(n-2) + 8965\,a(n-3) - 19778\,a(n-4) - 225541\,a(n-5) + 2020719\,a(n-6) - 6851286\,a(n-7) + 7381301\,a(n-8) + 20655503\,a(n-9) - 79401996\,a(n-10) + 80882723\,a(n-11) + 65337447\,a(n-12) - 222811374\,a(n-13) + 135953338\,a(n-14) + 120111164\,a(n-15) - 197698384\,a(n-16) + 43440564\,a(n-17) + 76879396\,a(n-18) - 52839536\,a(n-19) - 1810608\,a(n-20) + 13170096\,a(n-21) - 4166800\,a(n-22) - 433792\,a(n-23) + 532928\,a(n-24) - 126464\,a(n-25) + 13056\,a(n-26) - 512\,a(n-27)
\]
for every $n>33$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A233160.
