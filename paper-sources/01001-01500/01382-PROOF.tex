...
\title{The empirical recurrence for OEIS A218843, proved by transfer matrix}
...
\begin{abstract}
OEIS A218843 counts the distinct indicator arrays obtained from the $n\times2$ arrays over
...
OEIS A218843 is ``Unmatched value maps: number of 2 X n binary arrays indicating the locations of corresponding elements not equal to any horizontal or antidiagonal neighbor in a random 0..1 2 X n array.''. It has offset $1$ and begins
\[
1, 7, 20, 57, 156, 438, 1220, 3398,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + a(n-2) + 3*a(n-3) + 2*a(n-5) + 2*a(n-6) - 2*a(n-7) for n>9.
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 24 2018 20:38:24, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + a(n-2) + 3\,a(n-3) + 2\,a(n-5) + 2\,a(n-6) - 2\,a(n-7)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A218843.
