...
\title{The empirical recurrence for OEIS A245873, proved from an exact model}
...
\begin{abstract}
OEIS A245873 carries an empirical recurrence of order $7$. It is true, and it is
...
OEIS A245873 is ``Number of length 4+2 0..n arrays with some pair in every consecutive three terms totalling exactly n.''. It has offset $1$ and begins
\[
26, 239, 676, 1629, 3102, 5515, 8840, 13625,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) - a(n-2) - 5*a(n-3) + 5*a(n-4) + a(n-5) - 3*a(n-6) + a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 05 2018 03:05:18, revision 11)
...
\]
annihilates $a$, and $S=\deg A=15$. A congruence condition modulo $m$ is counted one residue
...
exactly $\deg A$. The bound in force is therefore $zA(z)$, of order $S=15$, and
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A245873.
