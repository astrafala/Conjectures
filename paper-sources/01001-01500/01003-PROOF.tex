...
\title{The empirical recurrence for OEIS A249850, proved from an exact model}
...
\begin{abstract}
OEIS A249850 carries an empirical recurrence of order $11$. It is true, and it is
...
\begin{quote}
Empirical: a(n) = n\^{}10 - (19/35)*n\^{}9 + (4327/840)*n\^{}8 - (104/63)*n\^{}7 + (52/15)*n\^{}6 + (367/90)*n\^{}5 - (491/120)*n\^{}4 + (389/126)*n\^{}3 - (221/420)*n\^{}2 + (1/35)*n. a(n) = 11*a(n-1) - 55*a(n-2) + 165*a(n-3) - 330*a(n-4) + 462*a(n-5) - 462*a(n-6) + 330*a(n-7) - 165*a(n-8) + 55*a(n-9) - 11*a(n-10) + a(n-11) for n>11.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 18 2017 18:11:13, revision 8)
