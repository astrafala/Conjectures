...
\title{The empirical recurrence for OEIS A264528, proved by transfer matrix}
...
\begin{abstract}
OEIS A264528 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=3$ rows in which
...
OEIS A264528 is ``Number of (n+1)X(2+1) arrays of permutations of 0..n*3+2 with each element having directed index change -2,-2 -1,0 0,1 or 1,0.''. It has offset $1$ and begins
\[
1, 4, 4, 19, 49, 100, 316, 766,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 17 2015 09:22:43, revision 5) this is still
...
\[
(i-h_i,\,j-h_j)\;\in\;\{(-2,-2),\ (-1,0),\ (0,1),\ (1,0)\},
\]
...
Second, the transfer model reproduces all $28$ terms this entry publishes, exactly, in
integer arithmetic.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264528.
