...
\title{The empirical recurrence for OEIS A274956, proved by counting patterns}
...
\begin{abstract}
OEIS A274956 counts arrays in which no entry may repeat a value found at any of three stated
...
cutting $60074$ pairs to $S=10355$ states. The entry's empirical recurrence of order $25$,
...
OEIS A274956 is ``Number of nX5 0..2 arrays with no element equal to any value at offset (-1,-1) (-2,0) or (0,-2) and new values introduced in order 0..2.''. It has offset $1$ and begins
\[
12, 216, 1638, 14406, 126540, 1119744, 9902040, 87416934,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 12 2016 08:03:16, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;9\,a(n-1) - 14\,a(n-3) + 126\,a(n-4) - 1046\,a(n-5) - 596\,a(n-6) + 6988\,a(n-7) - 890\,a(n-8) - 10542\,a(n-9) + 7876\,a(n-10) - 14656\,a(n-11) - 2216\,a(n-12) + 23008\,a(n-13) - 19912\,a(n-14) + 17376\,a(n-15) - 4912\,a(n-16) - 8912\,a(n-17) + 7632\,a(n-18) - 3520\,a(n-19) + 704\,a(n-20) + 1568\,a(n-21) - 1120\,a(n-22) + 160\,a(n-24) - 32\,a(n-25)
\end{equation}
for all $n>28$.
...
$o=1n_0+0-2$, we have for $j\ge25$
\[
3!\Bigl(a(n_0+j)-\sum_i c_i\,a(n_0+j-i)\Bigr)
=\mathbf{v}^{\!\top}G^{\,j-25}w,\qquad
w=h_{25}-\sum_i c_i h_{25-i} .
\]
...
the survivors by the pattern of the new pair. The vector $w$ was formed by $25$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A274956.
