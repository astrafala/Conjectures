...
\title{The empirical recurrence for OEIS A280481, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A280481 imposes three things at once: a condition on each cell that reaches one column up and
...
OEIS A280481 is ``Number of 2 X n 0..2 arrays with no element unequal to a strict majority of its horizontal and antidiagonal neighbors, with the exception of exactly two elements, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
0, 6, 22, 63, 162, 381, 884, 1995,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 5*a(n-1) - 4*a(n-2) - 14*a(n-3) + 19*a(n-4) + 13*a(n-5) - 22*a(n-6) - 4*a(n-7) + 8*a(n-8) for n>10.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 13 2019 11:20:10, revision 7) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A280481.
