...
\title{The empirical recurrence for OEIS A202254, proved from an exact model}
...
\begin{abstract}
OEIS A202254 carries an empirical recurrence of order $5$. It is true, and it is
...
OEIS A202254 is ``Number of zero-sum -n..n arrays of 4 elements with adjacent element differences also in -n..n.''. It has offset $1$ and begins
\[
7, 31, 81, 171, 309, 509, 779, 1133,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) - 2*a(n-2) - 2*a(n-3) + 3*a(n-4) - a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 03 2018 05:35:49, revision 11)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A202254.
