...
\title{The empirical recurrence for OEIS A250145, proved from an exact model}
...
\begin{abstract}
OEIS A250145 carries an empirical recurrence of order $9$. It is true, and it is
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 12 2018 03:01:22, revision 11)
