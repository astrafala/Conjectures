...
\title{The empirical recurrence for OEIS A221066, proved by transfer matrix}
...
\begin{abstract}
OEIS A221066 counts the distinct indicator arrays obtained from the $n\times2$ arrays over
...
OEIS A221066 is ``Sum of neighbor maps: number of n X 2 binary arrays indicating the locations of corresponding elements equal to the sum mod 4 of their king-move neighbors in a random 0..3 n X 2 array.''. It has offset $1$ and begins
\[
2, 8, 20, 56, 168, 476, 1364, 3952,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + 2*a(n-2) + 4*a(n-3) - 5*a(n-4) - 6*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 03 2018 08:11:35, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 2\,a(n-2) + 4\,a(n-3) - 5\,a(n-4) - 6\,a(n-5)
\]
for every $n>5$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221066.
