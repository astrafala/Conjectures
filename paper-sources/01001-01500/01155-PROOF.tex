...
\title{The empirical recurrence for OEIS A199838, proved from an exact model}
...
\begin{abstract}
OEIS A199838 carries an empirical recurrence of order $9$. It is true, and it is
...
OEIS A199838 is ``Number of -n..n arrays x(0..8) of 9 elements with zero sum and no two neighbors summing to zero.''. It has offset $1$ and begins
\[
66, 23206, 645780, 6715618, 41008804, 179213048, 622300326, 1827026482,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 25 2021 05:11:21, revision 11)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A199838.
