...
\title{Every term of OEIS A397241 is odd}
...
\begin{abstract}
OEIS A397241 is defined by the coefficient condition
...
OEIS A397241 is ``G.f. A(x) satisfies n * [x\^{}n] A(x)\^{}n = (n-1) * [x\^{}n] A(x)\^{}(n+1) for n > 1.''. It has offset $0$ and begins
\[
1, 1, 1, 11, 191, 5279, 205739, 10703027,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 20 2026 05:53:17, revision 12) the statement is
...
\begin{theorem}
Every term of OEIS A397241 is odd. This is the conjecture of Section~1.
\end{theorem}
...
$a(0)=a(1)=1$ and compared against the entry's DATA at every one of the $19$ published
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A397241.
