...
\title{The empirical recurrence for OEIS A269438, proved from an exact model}
...
\begin{abstract}
OEIS A269438 carries an empirical recurrence of order $7$. It is true, and it is
...
OEIS A269438 is ``Number of length-6 0..n arrays with no repeated value greater than the previous repeated value.''. It has offset $1$ and begins
\[
51, 622, 3674, 14455, 44021, 112476, 252932, 516189,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = n\^{}6 + 6*n\^{}5 + 12*n\^{}4 + (44/3)*n\^{}3 + (23/2)*n\^{}2 + (29/6)*n + 1. a(n) = 7*a(n-1) - 21*a(n-2) + 35*a(n-3) - 35*a(n-4) + 21*a(n-5) - 7*a(n-6) + a(n-7) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 22 2019 07:44:37, revision 8)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269438.
