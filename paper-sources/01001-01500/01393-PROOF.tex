...
\title{The empirical recurrence for OEIS A220387, proved by transfer matrix}
...
\begin{abstract}
OEIS A220387 counts the distinct indicator arrays obtained from the $n\times2$ arrays over
...
OEIS A220387 is ``Majority value maps: number of 2Xn binary arrays indicating the locations of corresponding elements equal to at least half of their horizontal and antidiagonal neighbors in a random 0..1 2Xn array.''. It has offset $1$ and begins
\[
1, 7, 25, 79, 278, 966, 3362, 11642,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 18:45:28, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + 4\,a(n-3) + 7\,a(n-4) - 7\,a(n-6) - 19\,a(n-7) - 21\,a(n-8) - 33\,a(n-9) - 14\,a(n-10) + a(n-11) + 6\,a(n-12) + 45\,a(n-13) + 27\,a(n-14) + 72\,a(n-15) - a(n-16) + 6\,a(n-17) - 32\,a(n-18) - 16\,a(n-19) - 4\,a(n-20) + 4\,a(n-22)
\]
for every $n>23$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A220387.
