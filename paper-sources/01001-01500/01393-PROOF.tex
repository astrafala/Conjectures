...
\title{The empirical recurrence for OEIS A297503, proved by transfer matrix}
...
\begin{abstract}
OEIS A297503 counts arrays of width $5$ over $\{0,1\}$ in which every cell of one value has an allowed number of neighbours of another. The entry carries an
...
OEIS A297503 is ``Number of n X 5 0..1 arrays with every 1 horizontally, diagonally or antidiagonally adjacent to 1 or 2 neighboring 1's.''. It has offset $1$ and begins
\[
12, 218, 1829, 23348, 270845, 3075264, 35919085, 414559944,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 31 2023 10:16:49, revision 6) this is still
...
The condition is that every cell equal to $1$ has exactly $1$ or exactly $2$ neighbours equal to $1$:
\[
x(i,j)=1\ \Longrightarrow\ \#\{(a,b)\in S(i,j):x(a,b)=1\}\in\{1,2\}.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297503.
