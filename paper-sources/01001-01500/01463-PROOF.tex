...
\title{The empirical recurrence for OEIS A280805, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A280805 imposes three things at once: a condition on each cell that reaches one row up and
...
OEIS A280805 is ``Number of nX3 0..1 arrays with no element equal to more than two of its horizontal, vertical and antidiagonal neighbors, with the exception of exactly two elements, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
0, 3, 56, 332, 1578, 6540, 24490, 86010,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 08 2017 09:43:09, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;12\,a(n-1) - 57\,a(n-2) + 127\,a(n-3) - 93\,a(n-4) - 129\,a(n-5) + 216\,a(n-6) + 165\,a(n-7) - 477\,a(n-8) + 66\,a(n-9) + 411\,a(n-10) - 123\,a(n-11) - 319\,a(n-12) + 183\,a(n-13) + 102\,a(n-14) - 81\,a(n-15) - 30\,a(n-16) + 36\,a(n-17) - 8\,a(n-18)
\end{equation}
for all $n>24$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A280805.
