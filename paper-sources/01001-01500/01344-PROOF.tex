...
\title{Recovering the unwritten recurrences of the table OEIS A231957}
...
\begin{abstract}
OEIS A231957 is a two-dimensional table $T(n,k)$ whose empirical recurrences are, for several of
its lines, given only as an ORDER --- ``k=3: [order 12]'' and the like --- with the
...
that polynomial. This note settles column 3, column 4.
\end{abstract}
...
OEIS A231957 is ``T(n,k)=Number of (n+1)X(k+1) 0..1 arrays with every element equal to some horizontal, vertical, diagonal or antidiagonal neighbor, with top left element zero.''. It is read by antidiagonals and begins
\[
4, 18, 18, 64, 142, 64, 236, 1034,\ \dots
\]
...
k=4: [order 26]
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 06:45:36, revision 6) these are still
...
$c_{1}$ & $14$ & $c_{4}$ & $170$ & $c_{7}$ & $-99$ & $c_{10}$ & $181$ \\
$c_{2}$ & $6$ & $c_{5}$ & $-39$ & $c_{8}$ & $-375$ & $c_{11}$ & $18$ \\
$c_{3}$ & $103$ & $c_{6}$ & $-13$ & $c_{9}$ & $-29$ & $c_{12}$ & $-24$ \\
...
integer coefficients
\[
(c_1,\dots,c_{26})=(27,\ 43,\ 979,\ 3959,\ 5024,\ 13587,\ -30380,\ -229403,\ -225428,\ 119690,\ 600710,\ 1399515,\ 477099,\ -2452480,\ -2052385,\ 1138184,\ 1422082,\ 42409,\ -158339,\ -56561,\ -79639,\ -16514,\ 4502,\ -496,\ 1440,\ 720).
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231957.
