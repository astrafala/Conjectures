...
\title{The empirical recurrence for OEIS A281050, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A281050 imposes three things at once: a condition on each cell that reaches one row up and
...
OEIS A281050 is ``Number of n X 2 0..1 arrays with no element equal to more than one of its horizontal and antidiagonal neighbors, with the exception of exactly two elements, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
0, 1, 6, 29, 122, 468, 1686, 5807,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 9*a(n-1) - 30*a(n-2) + 45*a(n-3) - 30*a(n-4) + 9*a(n-5) - a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 15 2019 04:40:39, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A281050.
