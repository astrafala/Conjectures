...
\title{The empirical recurrence for OEIS A229602, proved by counting defective colourings}
...
\begin{abstract}
OEIS A229602 counts the colourings of an array with $K=3$ colours that are proper except at
...
numbers. What is left is a walk count on $S=294$ vertices, and the empirical recurrence of
...
OEIS A229602 is ``Number of defective 3-colorings of an n X 4 0..2 array connected horizontally and vertically with exactly two mistakes, and colors introduced in row-major 0..2 order.''. It has offset $1$ and begins
\[
3, 202, 3040, 35182, 362100, 3476928, 31848813, 281845934,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 27 2021 21:26:38, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;27\,a(n-1) - 288\,a(n-2) + 1557\,a(n-3) - 4644\,a(n-4) + 8073\,a(n-5) - 8343\,a(n-6) + 5022\,a(n-7) - 1620\,a(n-8) + 216\,a(n-9)
\end{equation}
for all $n>11$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A229602.
