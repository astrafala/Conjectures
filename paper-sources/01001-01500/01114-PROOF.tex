...
\title{The empirical recurrence for OEIS A221694, proved by transfer matrix}
...
\begin{abstract}
OEIS A221694 counts the distinct OCCUPANCY arrays obtained when every cell of an $n\times2$ grid
...
one, on $S=192$ states, after which the conjectured recurrence is settled by a finite exact
computation.
\end{abstract}
...
OEIS A221694 is ``Number of 2 X n arrays of occupancy after each element stays put or moves to some horizontal or antidiagonal neighbor, without consecutive moves in the same direction.''. It has offset $1$ and begins
\[
1, 21, 152, 1336, 11036, 92660, 774380, 6479664,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 5*a(n-1) + 28*a(n-2) + 9*a(n-3) - 62*a(n-4) - 30*a(n-5) + 64*a(n-6) + 32*a(n-7) - 32*a(n-8) + 32*a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2018 17:33:35, revision 8) this is still
...
$S=192$ reachable sets. In particular $a$ is $C$-finite.
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) + 28\,a(n-2) + 9\,a(n-3) - 62\,a(n-4) - 30\,a(n-5) + 64\,a(n-6) + 32\,a(n-7) - 32\,a(n-8) + 32\,a(n-9)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221694.
