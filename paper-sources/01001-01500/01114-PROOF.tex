...
\title{The empirical recurrence for OEIS A222382, proved by transfer matrix}
...
\begin{abstract}
OEIS A222382 counts the distinct indicator arrays obtained from the $n\times3$ arrays over
...
indicator row by row turns it into one, on $S=55$ states, after which the conjectured
...
OEIS A222382 is ``Sum of neighbor maps: number of n X 3 binary arrays indicating the locations of corresponding elements equal to the sum mod 3 of their horizontal and antidiagonal neighbors in a random 0..2 n X 3 array.''. It has offset $1$ and begins
\[
8, 48, 512, 3968, 32768, 261376, 2097152, 16773120,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 8*a(n-1) + 8*a(n-2) - 64*a(n-3) - 16*a(n-4) + 128*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 16 2018 08:58:20, revision 8) this is still
...
\]
There are $S=55$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite. Note
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-1) + 8\,a(n-2) - 64\,a(n-3) - 16\,a(n-4) + 128\,a(n-5)
\]
for every $n>5$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A222382.
