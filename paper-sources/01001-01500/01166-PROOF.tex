...
\title{The empirical recurrence for OEIS A221783, proved by transfer matrix}
...
\begin{abstract}
OEIS A221783 counts the distinct OCCUPANCY arrays obtained when every cell of an $n\times4$ grid
...
an empirical recurrence of order $5$ contributed by Vaclav Kotesovec. It is true, and it is
...
one, on $S=39$ states, after which the conjectured recurrence is settled by a finite exact
computation.
\end{abstract}
...
OEIS A221783 is ``Number of nX4 arrays of occupancy after each element moves to some horizontal or antidiagonal neighbor, without 2-loops or left turns.''. It has offset $1$ and begins
\[
0, 3, 5, 16, 41, 105, 288, 735,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 5*a(n-2) + 5*a(n-3) + a(n-5). - \_Vaclav Kotesovec\_, May 23 2013
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 19:58:29, revision 11) this is still
...
$S=39$ reachable sets. In particular $a$ is $C$-finite.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221783.
