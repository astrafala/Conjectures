...
\title{The empirical recurrence for OEIS A220997, proved by transfer matrix}
...
\begin{abstract}
OEIS A220997 counts the distinct OCCUPANCY arrays obtained when every cell of an $n\times2$ grid
...
determinising the machine that emits the occupancy row by row turns it into one, on $S=134$
...
OEIS A220997 is ``Number of n X 2 arrays of occupancy after each element stays put or moves to some horizontal or vertical neighbor.''. It has offset $1$ and begins
\[
3, 31, 306, 2989, 29135, 283872, 2765627, 26943707,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 11*a(n-1) - 11*a(n-2) - 12*a(n-3) - 2*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 23 2018 11:28:43, revision 8) this is still
...
\]
There are $S=134$ reachable sets. In particular $a$ is $C$-finite.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A220997.
