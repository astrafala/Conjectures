...
\title{The empirical recurrence for OEIS A212838, proved from an exact model}
...
\begin{abstract}
OEIS A212838 carries an empirical recurrence of order $6$. It is true, and it is
...
OEIS A212838 is ``Number of 0..n arrays of length 5 with 0 never adjacent to n.''. It has offset $1$ and begins
\[
2, 99, 634, 2309, 6306, 14407, 29114, 53769,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = n\^{}5 + 5*n\^{}4 + 2*n\^{}3 - 8*n\^{}2 + n + 1.
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 21 2018 10:07:24, revision 10)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A212838.
