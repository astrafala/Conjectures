...
\title{The empirical recurrence for OEIS A249713, proved from an exact model}
...
\begin{abstract}
OEIS A249713 carries an empirical recurrence of order $8$. It is true, and it is
...
\begin{quote}
Empirical: a(n) = (1/70)*n\^{}7 + (19/15)*n\^{}6 + (178/15)*n\^{}5 + 30*n\^{}4 + (851/30)*n\^{}3 + (56/15)*n\^{}2 - (446/105)*n + 1. a(n) = 8*a(n-1) - 28*a(n-2) + 56*a(n-3) - 70*a(n-4) + 56*a(n-5) - 28*a(n-6) + 8*a(n-7) - a(n-8) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 10 2018 05:46:41, revision 8)
