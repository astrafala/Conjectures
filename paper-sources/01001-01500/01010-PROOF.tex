...
\title{The empirical recurrence for OEIS A250060, proved by transfer matrix}
...
\begin{abstract}
OEIS A250060 carries an empirical recurrence of order $8$ contributed by R.~H.~Hardin. It is
...
OEIS A250060 is ``Number of length 1+6 0..n arrays with no seven consecutive terms having the maximum of any two terms equal to the minimum of the remaining five terms.''. It has offset $1$ and begins
\[
21, 735, 7224, 40320, 160545, 509691, 1375080, 3281544,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = n\^{}7 + (7/2)*n\^{}6 + 7*n\^{}5 + (35/4)*n\^{}4 + (7/2)*n\^{}3 - (7/4)*n\^{}2 - n.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 22 2017 06:36:19, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250060.
