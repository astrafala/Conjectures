...
\title{The empirical recurrence for OEIS A280474, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A280474 imposes three things at once: a condition on each cell that reaches one row up and
...
OEIS A280474 is ``Number of n X 2 0..2 arrays with no element unequal to a strict majority of its horizontal and antidiagonal neighbors, with the exception of exactly two elements, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
1, 6, 30, 158, 846, 4446, 22734, 113310,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 15*a(n-1) - 87*a(n-2) + 245*a(n-3) - 348*a(n-4) + 240*a(n-5) - 64*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 13 2019 11:19:27, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A280474.
