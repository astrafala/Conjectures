...
\title{The empirical recurrence for OEIS A221652, proved by transfer matrix}
...
\begin{abstract}
OEIS A221652 counts the distinct OCCUPANCY arrays obtained when every cell of an $n\times2$ grid
...
an empirical recurrence of order $3$ contributed by R.~H.~Hardin. It is true, and it is
...
one, on $S=24$ states, after which the conjectured recurrence is settled by a finite exact
computation.
\end{abstract}
...
OEIS A221652 is ``Number of n X 2 arrays of occupancy after each element moves to some horizontal, diagonal or antidiagonal neighbor, without move-in move-out left turns.''. It has offset $1$ and begins
\[
1, 4, 12, 40, 136, 460, 1556, 5264,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) + a(n-2) + a(n-3) for n>4.
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 14 2018 11:20:31, revision 9) this is still
...
$S=24$ reachable sets. In particular $a$ is $C$-finite.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221652.
