...
\title{The empirical recurrence for OEIS A282185, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A282185 imposes three things at once: a condition on each cell that reaches one row up and
...
OEIS A282185 is ``Number of n X 2 0..2 arrays with no element equal to more than four of its king-move neighbors, with the exception of exactly two elements, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
0, 0, 1, 8, 104, 1222, 13552, 144784,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 16*a(n-1) - 48*a(n-2) - 116*a(n-3) - 160*a(n-4) - 96*a(n-5) - 36*a(n-6) for n>9.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 20 2019 11:53:01, revision 9) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A282185.
