...
\title{The empirical recurrence for OEIS A250015, proved by transfer matrix}
...
\begin{abstract}
OEIS A250015 carries an empirical recurrence of order $7$ contributed by R.~H.~Hardin. It is
...
OEIS A250015 is ``Number of length 1+5 0..n arrays with no six consecutive terms having the maximum of any three terms equal to the minimum of the remaining three terms.''. It has offset $1$ and begins
\[
20, 300, 2040, 8840, 28860, 77700, 182000, 383760,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = n\^{}6 + 3*n\^{}5 + 5*n\^{}4 + 5*n\^{}3 + 4*n\^{}2 + 2*n.
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 10 2018 12:43:59, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250015.
