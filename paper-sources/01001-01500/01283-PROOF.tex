...
\title{The empirical recurrence for OEIS A200873, proved from an exact model}
...
\begin{abstract}
OEIS A200873 carries an empirical recurrence of order $6$. It is true, and it is
...
OEIS A200873 is ``Number of 0..n arrays x(0..4) of 5 elements without any interior element greater than both neighbors or less than both neighbors.''. It has offset $1$ and begins
\[
16, 77, 236, 567, 1168, 2163, 3704, 5973,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (1/60)*n\^{}5 + (3/4)*n\^{}4 + (15/4)*n\^{}3 + (25/4)*n\^{}2 + (127/30)*n + 1.
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 16 2017 12:22:28, revision 10)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A200873.
