...
\title{The empirical closed form for OEIS A219465, proved}
...
\begin{abstract}
OEIS A219465 states an explicit closed form for $a(n)$ and records it as empirical. It is true, and
...
OEIS A219465 is ``Number of n X 2 arrays of the minimum value of corresponding elements and their horizontal or antidiagonal neighbors in a random, but sorted with lexicographically nondecreasing rows and columns, 0..3 n X 2 array.''. It has offset $1$ and begins
\[
4, 23, 82, 239, 619, 1471, 3259, 6800,\ \dots
\]
and states:
\begin{quote}
Empirical: a(n) = (1/20160)*n\^{}8 + (1/1260)*n\^{}7 + (1/480)*n\^{}6 + (4/45)*n\^{}5 - (11/960)*n\^{}4 + (277/180)*n\^{}3 + (7607/5040)*n\^{}2 + (61/70)*n.
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 26 2018 05:17:14, revision 8)
...
\begin{theorem}
The closed form OEIS A219465 records is correct for all $n>0$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A219465.
