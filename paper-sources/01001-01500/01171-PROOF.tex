...
\title{The empirical recurrence for OEIS A249846, proved from an exact model}
...
\begin{abstract}
OEIS A249846 carries an empirical recurrence of order $7$. It is true, and it is
...
OEIS A249846 is ``Number of length 2+4 0..n arrays with no five consecutive terms having the maximum of any two terms equal to the minimum of the remaining three terms.''. It has offset $1$ and begins
\[
10, 198, 1500, 6916, 23526, 65226, 156184, 335016,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = n\^{}6 + (9/5)*n\^{}5 + 3*n\^{}4 + 3*n\^{}3 + n\^{}2 + (1/5)*n.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 18 2017 18:10:39, revision 8)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A249846.
