...
\title{The empirical recurrence for OEIS A221899, proved by transfer matrix}
...
\begin{abstract}
OEIS A221899 counts the distinct OCCUPANCY arrays obtained when every cell of an $n\times2$ grid
...
one, on $S=166$ states, after which the conjectured recurrence is settled by a finite exact
computation.
\end{abstract}
...
OEIS A221899 is ``Number of 2 X n arrays of occupancy after each element stays put or moves to some horizontal, vertical or antidiagonal neighbor, without move-in move-out straight through or left turns.''. It has offset $1$ and begins
\[
3, 31, 258, 2241, 19408, 167960, 1453952, 12585637,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 5*a(n-1) + 26*a(n-2) + 45*a(n-3) + 34*a(n-4) - 2*a(n-5) - 4*a(n-6) + a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 11 2018 13:05:37, revision 8) this is still
...
$S=166$ reachable sets. In particular $a$ is $C$-finite.
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) + 26\,a(n-2) + 45\,a(n-3) + 34\,a(n-4) - 2\,a(n-5) - 4\,a(n-6) + a(n-7)
\]
for every $n>7$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221899.
