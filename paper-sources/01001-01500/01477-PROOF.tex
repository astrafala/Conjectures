...
\title{The empirical recurrence for OEIS A238723, proved by transfer matrix}
...
\begin{abstract}
OEIS A238723 counts arrays over $\{0,1,2\}$ in which no entry may equal, modulo $3$, a given
...
OEIS A238723 is ``Number of nX5 0..2 arrays with no element equal to the sum modulo 3 of elements to its left or elements above it.''. It has offset $1$ and begins
\[
8, 42, 336, 1506, 11440, 48538, 359456, 1502622,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 10:54:15, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A238723.
