...
\title{The empirical recurrence for OEIS A200253, proved from an exact model}
...
\begin{abstract}
OEIS A200253 carries an empirical recurrence of order $12$. It is true, and it is
...
OEIS A200253 is ``Number of 0..n arrays x(0..3) of 4 elements with each no smaller than the sum of its previous elements modulo (n+1).''. It has offset $1$ and begins
\[
8, 24, 69, 135, 267, 448, 750, 1125,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) - 2*a(n-3) + 3*a(n-4) - 4*a(n-5) + 4*a(n-7) - 3*a(n-8) + 2*a(n-9) - 2*a(n-11) + a(n-12).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 23 2018 07:47:29, revision 8)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A200253.
