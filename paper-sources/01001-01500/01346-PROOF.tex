...
\title{The empirical recurrence for OEIS A264307, proved by transfer matrix}
...
\begin{abstract}
OEIS A264307 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=3$ rows in which
...
OEIS A264307 is ``Number of (n+1) X (2+1) arrays of permutations of 0..n*3+2 with each element having directed index change 0,0 0,1 1,0 -1,-2 or 0,2.''. It has offset $1$ and begins
\[
6, 20, 68, 240, 832, 2896, 10080, 35072,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + 4*a(n-2) + 4*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 21 2018 06:55:14, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264307.
