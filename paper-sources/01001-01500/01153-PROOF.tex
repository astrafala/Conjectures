...
\title{The empirical recurrence for OEIS A221796, proved by transfer matrix}
...
\begin{abstract}
OEIS A221796 counts the distinct OCCUPANCY arrays obtained when every cell of an $n\times3$ grid
...
one, on $S=163$ states, after which the conjectured recurrence is settled by a finite exact
computation.
\end{abstract}
...
OEIS A221796 is ``Number of n X 3 arrays of occupancy after each element moves to some horizontal or vertical neighbor, without move-in move-out straight through or left turns.''. It has offset $1$ and begins
\[
0, 12, 12, 207, 470, 4073, 13314, 85974,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 27*a(n-2) + 14*a(n-3) - 165*a(n-4) - 20*a(n-5) + 329*a(n-6) - 48*a(n-7) - 131*a(n-8) - 34*a(n-9) + 9*a(n-10).
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 11 2018 07:13:51, revision 8) this is still
...
$S=163$ reachable sets. In particular $a$ is $C$-finite.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221796.
