...
\title{The empirical recurrence for OEIS A229472, proved by counting defective colourings}
...
\begin{abstract}
OEIS A229472 counts the colourings of an array with $K=4$ colours that are proper except at
...
numbers. What is left is a walk count on $S=20$ vertices, and the empirical recurrence of
...
OEIS A229472 is ``Number of defective 4-colorings of an n X 1 0..3 array connected horizontally, antidiagonally and vertically with exactly one mistake, and colors introduced in row-major 0..3 order.''. It has offset $1$ and begins
\[
0, 1, 2, 6, 20, 70, 246, 854,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 8*a(n-1) - 22*a(n-2) + 24*a(n-3) - 9*a(n-4) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 17 2018 05:45:42, revision 10) the statement is
...
Assembling the $4$ chains block-diagonally into $N$ of size $S=20$ with the weights of
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A229472.
