...
\title{The empirical recurrence for OEIS A183900, proved from an exact model}
...
\begin{abstract}
OEIS A183900 carries an empirical recurrence of order $6$. It is true, and it is
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 05 2018 11:13:05, revision 8)
...
size, so $a$ is a polynomial of degree below $M$ and $(z-1)^{M}$ annihilates it: $S=6$.
