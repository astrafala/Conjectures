...
\title{The empirical recurrence for OEIS A264360, proved by transfer matrix}
...
\begin{abstract}
OEIS A264360 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=5$ rows in which
...
OEIS A264360 is ``Number of (n+1) X (4+1) arrays of permutations of 0..n*5+4 with each element having directed index change 0,0 0,2 1,0 or -1,-2.''. It has offset $1$ and begins
\[
18, 120, 936, 7168, 54720, 418992, 3204336, 24514000,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) + 28*a(n-2) + 57*a(n-3) + 10*a(n-4) - 24*a(n-5) + 8*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 07 2019 12:42:13, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264360.
