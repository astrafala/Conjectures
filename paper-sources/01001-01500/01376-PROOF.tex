...
\title{The empirical recurrence for OEIS A276245, proved by counting patterns}
...
\begin{abstract}
OEIS A276245 counts arrays in which no entry may repeat a value found at any of three stated
...
cutting $60074$ pairs to $S=10355$ states. The entry's empirical recurrence of order $41$,
...
OEIS A276245 is ``Number of nX5 0..2 arrays with no element equal to any value at offset (-2,-1) (-1,1) or (0,-2) and new values introduced in order 0..2.''. It has offset $1$ and begins
\[
12, 216, 900, 6372, 43662, 291113, 2003694, 13727745,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 25 2016 11:01:49, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;9\,a(n-1) - 15\,a(n-2) + 193\,a(n-3) - 1673\,a(n-4) + 2361\,a(n-5) - 13142\,a(n-6) + 119938\,a(n-7) - 153895\,a(n-8) + 427606\,a(n-9) - 4363581\,a(n-10) + 5536053\,a(n-11) - 7687709\,a(n-12) + 89955043\,a(n-13) - 118267531\,a(n-14) + 83663690\,a(n-15) - 1111701314\,a(n-16) + 1540668051\,a(n-17) - 578797811\,a(n-18) + 8437597818\,a(n-19) - 12402279754\,a(n-20) + 2556185764\,a(n-21) - 39106130132\,a(n-22) + 61573100446\,a(n-23) - 6751787454\,a(n-24) + 105856537916\,a(n-25) - 184309560828\,a(n-26) + 8639167892\,a(n-27) - 147643128228\,a(n-28) + 315356494588\,a(n-29) - 1551938012\,a(n-30) + 63541767808\,a(n-31) - 274843851584\,a(n-32) - 4525044880\,a(n-33) + 51262094912\,a(n-34) + 89401851200\,a(n-35) + 1588916224\,a(n-36) - 39509856000\,a(n-37) + 2071917568\,a(n-38) + 578055168\,a(n-39) - 118431744\,a(n-40) - 1064960\,a(n-41)
\end{equation}
for all $n>45$.
...
$o=1n_0+0-2$, we have for $j\ge41$
\[
3!\Bigl(a(n_0+j)-\sum_i c_i\,a(n_0+j-i)\Bigr)
=\mathbf{v}^{\!\top}G^{\,j-41}w,\qquad
w=h_{41}-\sum_i c_i h_{41-i} .
\]
...
the survivors by the pattern of the new pair. The vector $w$ was formed by $41$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A276245.
