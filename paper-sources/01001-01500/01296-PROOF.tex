...
\title{The empirical recurrence for OEIS A249845, proved from an exact model}
...
\begin{abstract}
OEIS A249845 carries an empirical recurrence of order $6$. It is true, and it is
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 18 2017 11:15:42, revision 10)
