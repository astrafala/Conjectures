...
\title{The empirical recurrence for OEIS A218066, proved by transfer matrix}
...
\begin{abstract}
OEIS A218066 counts the distinct arrays obtained by applying a fixed local operation to every cell
of an array over a bounded alphabet, and carries an empirical recurrence of order $15$
...
$S=65$ states, after which the conjectured recurrence is settled by a finite exact
computation.
\end{abstract}
...
OEIS A218066 is ``Number of 3Xn arrays of the minimum value of corresponding elements and their horizontal or antidiagonal neighbors in a random 0..1 3Xn array.''. It has offset $1$ and begins
\[
8, 16, 74, 260, 1046, 3974, 15578, 60242,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 17:33:05, revision 10) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

Let $R=\{0,\dots,1\}^{3}$ be the set of rows and let the neighbours of
...
\]
There are $S=65$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite.
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 11\,a(n-2) - 7\,a(n-3) - 34\,a(n-4) + 11\,a(n-5) + 49\,a(n-6) - 14\,a(n-7) - 36\,a(n-8) + 7\,a(n-9) + a(n-10) + 8\,a(n-11) + 2\,a(n-12) - 13\,a(n-13) + 2\,a(n-14) + 4\,a(n-15)
\]
for every $n>18$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A218066.
