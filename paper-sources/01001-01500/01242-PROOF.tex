...
\title{Recovering the unwritten recurrences of the table OEIS A237082}
...
\begin{abstract}
OEIS A237082 is a two-dimensional table $T(n,k)$ whose empirical recurrences are, for several of
...
OEIS A237082 is ``T(n,k)=Number of (n+1)X(k+1) 0..2 arrays colored with the maximum plus the minimum minus the upper median minus the lower median of every 2X2 subblock.''. It is read by antidiagonals and begins
\[
81, 484, 484, 2928, 4526, 2928, 17644, 42300,\ \dots
\]
The entry carries, among its empirical claims:
\begin{quote}\small
k=2: [order 35]
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 09:49:23, revision 6) these are still
...
count, a walk on $S=484$ vertices. Berlekamp--Massey on $2S=968$ exact terms
returns a minimal recurrence of order $35$ --- the order the entry states --- with
integer coefficients
\[
(c_1,\dots,c_{35})=(0,\ 10,\ 200,\ 3494,\ 10363,\ 24691,\ 34689,\ -505130,\ -1188173,\ 1553345,\ 3053671,\ -3123651,\ -5222443,\ 618387,\ 19081478,\ 50000542,\ 154214784,\ 97630438,\ -137167730,\ 484064408,\ -223962514,\ -2119272884,\ 140443024,\ 730934940,\ -2147396648,\ -549613744,\ 1151284384,\ 1359699984,\ 1254555424,\ -443113344,\ -741621696,\ -65819904,\ 117950464,\ 33722368,\ 2539520).
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237082.
