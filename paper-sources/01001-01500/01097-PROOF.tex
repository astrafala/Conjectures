...
\title{The empirical recurrence for OEIS A264203, proved by transfer matrix}
...
\begin{abstract}
OEIS A264203 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=4$ rows in which
...
OEIS A264203 is ``Number of (n+1) X (3+1) arrays of permutations of 0..n*4+3 with each element having index change +-(.,.) 0,0 0,2 or 1,0.''. It has offset $1$ and begins
\[
81, 1024, 14641, 202500, 2825761, 39337984, 547981281, 7632119044,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 11*a(n-1) + 44*a(n-2) - 44*a(n-3) - 11*a(n-4) + a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 05 2019 06:58:56, revision 10) this is still
...
\[
(i-h_i,\,j-h_j)\;\in\;\{(-1,0),\ (0,-2),\ (0,0),\ (0,2),\ (1,0)\},
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264203.
