...
\title{The empirical recurrence for OEIS A250156, proved from an exact model}
...
\begin{abstract}
OEIS A250156 carries an empirical recurrence of order $8$. It is true, and it is
...
OEIS A250156 is ``Number of length 2+6 0..n arrays with every seven consecutive terms having the maximum of some two terms equal to the minimum of the remaining five terms.''. It has offset $1$ and begins
\[
193, 3450, 26710, 129595, 468231, 1382188, 3522460, 8028405,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (11/7)*n\^{}7 + 13*n\^{}6 + (67/2)*n\^{}5 + (97/2)*n\^{}4 + (103/2)*n\^{}3 + 34*n\^{}2 + (139/14)*n + 1.
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 12 2018 14:35:26, revision 8)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250156.
