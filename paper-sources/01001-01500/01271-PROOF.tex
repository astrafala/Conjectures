...
\title{The empirical recurrence for OEIS A264122, proved by transfer matrix}
...
\begin{abstract}
OEIS A264122 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=3$ rows in which
...
OEIS A264122 is ``Number of (n+1) X (2+1) arrays of permutations of 0..n*3+2 with each element having index change +-(.,.) 0,0 1,-2 or 2,-1.''. It has offset $1$ and begins
\[
2, 9, 45, 200, 845, 3549, 14994, 63525,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) + a(n-2) - 4*a(n-3) + 16*a(n-4) + 4*a(n-5) + a(n-6) - 4*a(n-7) - a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 04 2019 17:38:06, revision 10) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264122.
