...
\title{The empirical recurrence for OEIS A245951, proved from an exact model}
...
\begin{abstract}
OEIS A245951 carries an empirical recurrence of order $6$. It is true, and it is
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 05 2018 07:59:51, revision 8)
