...
\title{The empirical recurrence for OEIS A199707, proved from an exact model}
...
\begin{abstract}
OEIS A199707 carries an empirical recurrence of order $11$. It is true, and it is
...
OEIS A199707 is ``Number of -n..n arrays x(0..4) of 5 elements with zero sum and no two neighbors equal.''. It has offset $1$ and begins
\[
14, 200, 892, 2734, 6504, 13324, 24394, 41344,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n)=2*a(n-1)-a(n-3)-2*a(n-5)+2*a(n-6)+a(n-8)-2*a(n-10)+a(n-11).
\end{quote}
As of the ``Last modified'' line on the live entry (May 16 2018 11:19:49, revision 13)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A199707.
