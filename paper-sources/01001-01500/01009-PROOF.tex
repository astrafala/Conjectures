...
\title{The cross-base identity for OEIS A126547, proved}
...
\begin{abstract}
OEIS A126547 carries an empirical identity, in two clauses, relating its counts to those of the
...
OEIS A126547 is ``Number of base 26 n-digit numbers with adjacent digits differing by five or less.''. It has offset $0$ and begins
\[
1, 26, 256, 2596, 26586, 273768, 2828090, 29270910,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:18:38, revision 11)
this is still recorded as empirical, and nothing on the entry records it as proved.

For this entry the base is $26$ and the permitted difference is $d=5$, so the first clause
claims $a_{26}(n)-a_{25}(n)=11^{\,n-1}$ whenever $5(n-1)+1\le26$, that is for
$1\le n\le6$, and the second claims $a_{26}(n)-a_{25}(n)=11^{\,n-1}-2$ at the single
$n$ with $5(n-1)=26$.
...
arithmetic, $L_{5}$ at base $26$ reproduces all $18$ terms A126547 publishes.
...
First, the model reproduces all $18$ terms A126547 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $L_{5}(26,n)$ & $L_{5}(25,n)$ & $11^{\,n-1}$ \\ \hline
1 & 26 & 25 & 1 \\
2 & 256 & 245 & 11 \\
3 & 2596 & 2475 & 121 \\
4 & 26586 & 25255 & 1331 \\
5 & 273768 & 259127 & 14641 \\
6 & 2828090 & 2667039 & 161051 \\
\end{tabular}
\end{center}
