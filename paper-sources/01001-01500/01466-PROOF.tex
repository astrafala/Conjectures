...
\title{The empirical recurrence for OEIS A250339, proved from an exact model}
...
\begin{abstract}
OEIS A250339 carries an empirical recurrence of order $8$. It is true, and it is
...
OEIS A250339 is ``Number of length 3+5 0..n arrays with every six consecutive terms having the maximum of some three terms equal to the minimum of the remaining three terms.''. It has offset $1$ and begins
\[
108, 1989, 14040, 62041, 206724, 569693, 1369136, 2966769,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (2/7)*n\^{}7 + (28/5)*n\^{}6 + (112/5)*n\^{}5 + (109/3)*n\^{}4 + (94/3)*n\^{}3 + (166/15)*n\^{}2 - (2/105)*n + 1. a(n) = 8*a(n-1) - 28*a(n-2) + 56*a(n-3) - 70*a(n-4) + 56*a(n-5) - 28*a(n-6) + 8*a(n-7) - a(n-8) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 12 2018 14:41:57, revision 8)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250339.
