...
\title{The empirical recurrence for OEIS A220283, proved by transfer matrix}
...
\begin{abstract}
OEIS A220283 counts the distinct indicator arrays obtained from the $n\times2$ arrays over
...
OEIS A220283 is ``Equals one maps: number of nX2 binary arrays indicating the locations of corresponding elements equal to exactly one of their horizontal and vertical neighbors in a random 0..1 nX2 array.''. It has offset $1$ and begins
\[
2, 4, 31, 96, 424, 1422, 5504, 19606,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 18:39:25, revision 9) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A220283.
