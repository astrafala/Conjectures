...
\title{The empirical recurrence for OEIS A241620, proved from an exact model}
...
\begin{abstract}
OEIS A241620 carries an empirical recurrence of order $8$. It is true, and it is
...
OEIS A241620 is ``Number of length 5+2 0..n arrays with no consecutive three elements summing to more than n.''. It has offset $1$ and begins
\[
19, 147, 711, 2567, 7586, 19374, 44274, 92697,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (47/5040)*n\^{}7 + (47/360)*n\^{}6 + (7/9)*n\^{}5 + (23/9)*n\^{}4 + (3599/720)*n\^{}3 + (2093/360)*n\^{}2 + (26/7)*n + 1.
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 30 2018 10:34:37, revision 8)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A241620.
