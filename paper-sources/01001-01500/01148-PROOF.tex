...
\title{The empirical recurrence for OEIS A245953, proved from an exact model}
...
\begin{abstract}
OEIS A245953 carries an empirical recurrence of order $9$. It is true, and it is
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 05 2018 18:09:16, revision 10)
