...
\title{Recovering the unwritten recurrences of the table OEIS A237007}
...
\begin{abstract}
OEIS A237007 is a two-dimensional table $T(n,k)$ whose empirical recurrences are, for several of
...
OEIS A237007 is ``T(n,k) = Number of (n+1) X (k+1) 0..3 arrays with the upper median plus the lower median of every 2 X 2 subblock equal.''. It is read by antidiagonals and begins
\[
256, 1200, 1200, 5288, 10000, 5288, 26320, 79164,\ \dots
\]
The entry carries, among its empirical claims:
\begin{quote}\small
k=2: [order 42]
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 22 2021 14:35:07, revision 6) these are still
...
count, a walk on $S=296$ vertices. Berlekamp--Massey on $2S=592$ exact terms
returns a minimal recurrence of order $42$ --- the order the entry states --- with
integer coefficients
\[
(c_1,\dots,c_{42})=(38,\ -468,\ 218,\ 42647,\ -286743,\ -862127,\ 15950000,\ -24849106,\ -391927524,\ 1608022032,\ 4542403924,\ -37525303758,\ -2872192710,\ 499944714462,\ -694033809584,\ -4068669093257,\ 11050525673198,\ 18486952651648,\ -93553579562390,\ -15640564245929,\ 496377275042677,\ -365880965169655,\ -1661629390163616,\ 2579019375022268,\ 3105274042211800,\ -9031762043603828,\ -1005832317657720,\ 18641702983195264,\ -9780640678096544,\ -21728749031190400,\ 24478231844265600,\ 10062281672931328,\ -26934026561310208,\ 5454921963176960,\ 13868674463645696,\ -8550224146538496,\ -1975603837353984,\ 3269184288915456,\ -651588353261568,\ -329553047715840,\ 164517579325440,\ -20741042995200).
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237007.
