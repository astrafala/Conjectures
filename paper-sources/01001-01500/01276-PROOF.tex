...
\title{The empirical recurrence for OEIS A245997, proved from an exact model}
...
\begin{abstract}
OEIS A245997 carries an empirical recurrence of order $7$. It is true, and it is
...
OEIS A245997 is ``Number of length 2+2 0..n arrays with no pair in any consecutive three terms totalling exactly n.''. It has offset $1$ and begins
\[
2, 12, 68, 208, 534, 1116, 2120, 3648,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) -a(n-2) -5*a(n-3) +5*a(n-4) +a(n-5) -3*a(n-6) +a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 11:30:55, revision 8)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A245997.
