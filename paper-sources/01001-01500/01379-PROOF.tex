...
\title{The empirical recurrence for OEIS A281559, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A281559 imposes three things at once: a condition on each cell that reaches one row up and
...
numbers. The empirical recurrence of order $24$ contributed by R.~H.~Hardin then follows
...
OEIS A281559 is ``Number of nX4 0..1 arrays with no element equal to more than two of its horizontal, diagonal or antidiagonal neighbors, with the exception of exactly two elements, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
0, 18, 621, 3374, 15508, 53568, 162919, 463916,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 24 2017 08:32:33, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 7\,a(n-3) - 21\,a(n-4) - 27\,a(n-5) - 17\,a(n-6) + 84\,a(n-7) + 168\,a(n-8) + 79\,a(n-9) - 231\,a(n-10) - 480\,a(n-11) - 209\,a(n-12) + 417\,a(n-13) + 768\,a(n-14) + 266\,a(n-15) - 561\,a(n-16) - 705\,a(n-17) - 44\,a(n-18) + 468\,a(n-19) + 252\,a(n-20) - 108\,a(n-21) - 135\,a(n-22) + 27\,a(n-24)
\end{equation}
for all $n>34$.
...
$h_j=G^{j}N^{o}\mathbf{u}$, we have for $j\ge24$
\[
2!\Bigl(a(n_0+j)-\sum_i c_i\,a(n_0+j-i)\Bigr)=\mathbf{v}^{\!\top}G^{\,j-24}w,
\qquad w=h_{24}-\sum_i c_i h_{24-i} .
\]
...
\begin{theorem}
The recurrence \eqref{eq:conj} holds for every $n>34$, which is the statement of
Section~1.
\end{theorem}
...
index corresponding to $n=34+1$ onwards, and the run continued until $S+1$ consecutive
zeros had been seen.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A281559.
