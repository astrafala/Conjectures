...
\title{The empirical recurrence for OEIS A229506, proved by counting defective colourings}
...
\begin{abstract}
OEIS A229506 counts the colourings of an array with $K=3$ colours that are proper except at
...
OEIS A229506 is ``Number of defective 3-colorings of an n X 4 0..2 array connected diagonally and antidiagonally with exactly one mistake, and colors introduced in row-major 0..2 order.''. It has offset $1$ and begins
\[
0, 288, 4032, 50112, 575424, 6298560, 66764736, 691581888,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 18*a(n-1) - 81*a(n-2) for n>4.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 16 2017 05:29:02, revision 10) the statement is
...
index corresponding to $n=4+1$ onwards, and the run continued until $S+1$ consecutive
zeros had been seen.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A229506.
