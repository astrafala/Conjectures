...
\title{The empirical recurrence for OEIS A250338, proved from an exact model}
...
\begin{abstract}
OEIS A250338 carries an empirical recurrence of order $7$. It is true, and it is
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 12 2018 14:42:21, revision 8)
