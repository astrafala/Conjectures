...
\title{The empirical recurrence for OEIS A254700, proved from an exact model}
...
\begin{abstract}
OEIS A254700 carries an empirical recurrence of order $6$. It is true, and it is
...
\begin{quote}
Empirical: a(n) = (4/5)*n\^{}5 + (19/3)*n\^{}4 + (34/3)*n\^{}3 + (29/3)*n\^{}2 + (73/15)*n + 1. a(n) = 6*a(n-1) - 15*a(n-2) + 20*a(n-3) - 15*a(n-4) + 6*a(n-5) - a(n-6) for n>6. (End)
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 02 2025 12:14:58, revision 13)
