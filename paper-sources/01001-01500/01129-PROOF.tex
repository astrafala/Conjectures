...
\title{The empirical recurrence for OEIS A245875, proved from an exact model}
...
\begin{abstract}
OEIS A245875 carries an empirical recurrence of order $9$. It is true, and it is
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 04 2018 14:15:32, revision 7)
