...
\title{The empirical recurrence for OEIS A220932, proved by transfer matrix}
...
\begin{abstract}
OEIS A220932 counts the distinct indicator arrays obtained from the $n\times3$ arrays over
...
indicator row by row turns it into one, on $S=23$ states, after which the conjectured
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 13 2018 16:33:46, revision 9) this is still
...
\]
There are $S=23$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite. Note
