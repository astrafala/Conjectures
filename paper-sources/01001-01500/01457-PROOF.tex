...
\title{The empirical recurrence for OEIS A264515, proved by transfer matrix}
...
\begin{abstract}
OEIS A264515 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=4$ rows in which
...
OEIS A264515 is ``Number of (n+1)X(3+1) arrays of permutations of 0..n*4+3 with each element having directed index change -1,0 0,2 -1,-2 or 1,0.''. It has offset $1$ and begins
\[
1, 1, 9, 36, 144, 576, 2116, 8281,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 11 2026 23:20:18, revision 12) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + 7\,a(n-2) - 17\,a(n-3) - 5\,a(n-4) + 60\,a(n-5) + 8\,a(n-6) - 24\,a(n-7) - 36\,a(n-8) + 36\,a(n-11) + 24\,a(n-12) - 8\,a(n-13) - 60\,a(n-14) + 5\,a(n-15) + 17\,a(n-16) - 7\,a(n-17) - 3\,a(n-18) + a(n-19)
\]
for every $n>17$.
\end{theorem}
...
Second, the transfer model reproduces all $25$ terms this entry publishes, exactly, in
integer arithmetic.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264515.
