...
\title{The empirical recurrence for OEIS A207102, proved from an exact model}
...
\begin{abstract}
OEIS A207102 carries an empirical recurrence of order $24$. It is true, and it is
decidable rather than empirical. The entry's sequence is given exactly by an Ehrhart quasi-polynomial, from
which $a$ provably satisfies a MONIC linear recurrence of order $S=61$, derived below and not
...
OEIS A207102 is ``Number of 0..n arrays x(0..4) of 5 elements with each no smaller than the sum of its two previous neighbors modulo (n+1).''. It has offset $1$ and begins
\[
12, 55, 176, 441, 989, 1904, 3504, 5925,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 05 2025 13:13:33, revision 9)
...
\]
annihilates $a$, and $S=\deg A=61$. A congruence condition modulo $m$ is counted one residue
...
exactly $\deg A$. The bound in force is therefore $zA(z)$, of order $S=61$, and
...
$q(z)=z^{24}-\sum_ic_iz^{24-i}$ the characteristic polynomial of the conjectured
...
\begin{theorem}
\[
a(n)\;=\;-3\,a(n-1) - 2\,a(n-2) + 5\,a(n-3) + 12\,a(n-4) + 9\,a(n-5) - 3\,a(n-6) - 14\,a(n-7) - 19\,a(n-8) - 17\,a(n-9) - 3\,a(n-10) + 20\,a(n-11) + 32\,a(n-12) + 20\,a(n-13) - 3\,a(n-14) - 17\,a(n-15) - 19\,a(n-16) - 14\,a(n-17) - 3\,a(n-18) + 9\,a(n-19) + 12\,a(n-20) + 5\,a(n-21) - 2\,a(n-22) - 3\,a(n-23) - a(n-24)
\]
for every $n>0$.
\end{theorem}
...
vanish from $n=0+1$ onwards, and the run exceeds $S+24$, which by
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207102.
