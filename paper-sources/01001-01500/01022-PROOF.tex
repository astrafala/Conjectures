...
\title{The empirical recurrence for OEIS A200876, proved from an exact model}
...
\begin{abstract}
OEIS A200876 carries an empirical recurrence of order $9$. It is true, and it is
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 16 2017 09:58:30, revision 10)
