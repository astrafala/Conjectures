...
\title{Recovering the unwritten recurrences of the table OEIS A237965}
...
\begin{abstract}
OEIS A237965 is a two-dimensional table $T(n,k)$ whose empirical recurrences are, for several of
...
OEIS A237965 is ``T(n,k)=Number of (n+1)X(k+1) 0..2 arrays with the maximum plus the lower median minus the minimum of every 2X2 subblock differing from its horizontal and vertical neighbors by exactly one.''. It is read by antidiagonals and begins
\[
81, 340, 340, 1422, 1944, 1422, 6042, 10942,\ \dots
\]
The entry carries, among its empirical claims:
\begin{quote}\small
k=2: [order 24]
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 10:39:37, revision 6) these are still
...
$c_{1}$ & $0$ & $c_{7}$ & $3022$ & $c_{13}$ & $199163$ & $c_{19}$ & $170336$ \\
$c_{2}$ & $0$ & $c_{8}$ & $-19803$ & $c_{14}$ & $160145$ & $c_{20}$ & $-29888$ \\
$c_{3}$ & $57$ & $c_{9}$ & $-54071$ & $c_{15}$ & $195840$ & $c_{21}$ & $33280$ \\
$c_{4}$ & $519$ & $c_{10}$ & $-91685$ & $c_{16}$ & $-405526$ & $c_{22}$ & $-16256$ \\
$c_{5}$ & $1274$ & $c_{11}$ & $-63215$ & $c_{17}$ & $-460000$ & $c_{23}$ & $-24576$ \\
$c_{6}$ & $3325$ & $c_{12}$ & $160130$ & $c_{18}$ & $241952$ & $c_{24}$ & $8192$ \\
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237965.
