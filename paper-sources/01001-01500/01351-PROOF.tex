...
\title{The empirical recurrence for OEIS A219437, proved by transfer matrix}
...
\begin{abstract}
OEIS A219437 counts the distinct indicator arrays obtained from the $n\times4$ arrays over
$\{0,\dots,1\}$ by marking the cells whose value differs from every one of their neighbours, and carries an
...
indicator row by row turns it into one, on $S=107$ states, after which the conjectured
...
OEIS A219437 is ``Unmatched value maps: number of nX4 binary arrays indicating the locations of corresponding elements not equal to any horizontal, diagonal or antidiagonal neighbor in a random 0..1 nX4 array.''. It has offset $1$ and begins
\[
7, 39, 281, 1750, 11283, 72272, 465400, 2995163,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 18:03:28, revision 8) this is still
...
\]
There are $S=107$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite. Note
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-1) - 12\,a(n-2) + 6\,a(n-3) + 77\,a(n-4) - 184\,a(n-5) - 385\,a(n-6) + 137\,a(n-7) + 1716\,a(n-8) + 983\,a(n-9) - 3491\,a(n-10) - 525\,a(n-11) + 2567\,a(n-12) - 7634\,a(n-13) + 5725\,a(n-14) + 1489\,a(n-15) + 3574\,a(n-16) + 1516\,a(n-17) - 12799\,a(n-18) + 706\,a(n-19) - 3864\,a(n-20) + 7628\,a(n-21) + 8580\,a(n-22) - 6068\,a(n-23) - 1312\,a(n-24) + 160\,a(n-25) + 224\,a(n-26) + 48\,a(n-27)
\]
for every $n>27$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A219437.
