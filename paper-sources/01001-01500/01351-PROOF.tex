...
\title{The empirical recurrence for OEIS A269471, proved from an exact model}
...
\begin{abstract}
OEIS A269471 carries an empirical recurrence of order $8$. It is true, and it is
...
\begin{quote}
Empirical: a(n) = n\^{}7 + 7*n\^{}6 + 16*n\^{}5 + 8*n\^{}4 - n\^{}3 - n. a(n) = 8*a(n-1) - 28*a(n-2) + 56*a(n-3) - 70*a(n-4) + 56*a(n-5) - 28*a(n-6) + 8*a(n-7) - a(n-8) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 23 2019 07:14:53, revision 7)
