...
\title{The empirical recurrence for OEIS A250391, proved from an exact model}
...
\begin{abstract}
OEIS A250391 carries an empirical recurrence of order $9$. It is true, and it is
...
OEIS A250391 is ``Number of length 5+3 0..n arrays with no four consecutive terms having the maximum of any two terms equal to the minimum of the remaining two terms.''. It has offset $1$ and begins
\[
6, 514, 9480, 82398, 457366, 1886948, 6308960, 18038628,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = n\^{}8 + (1/5)*n\^{}7 + (563/180)*n\^{}6 + (19/30)*n\^{}5 + (1/9)*n\^{}4 + (9/5)*n\^{}3 - (223/180)*n\^{}2 + (11/30)*n.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 21 2017 05:59:10, revision 7)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250391.
