...
\title{The empirical recurrence for OEIS A218759, proved by transfer matrix}
...
\begin{abstract}
OEIS A218759 counts the distinct indicator arrays obtained from the $n\times2$ arrays over
...
OEIS A218759 is ``Unmatched value maps: number of n X 2 binary arrays indicating the locations of corresponding elements not equal to any horizontal or vertical neighbor in a random 0..1 n X 2 array.''. It has offset $1$ and begins
\[
2, 6, 18, 47, 134, 373, 1035, 2889,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + a(n-2) + 3*a(n-3) + 2*a(n-5) + 2*a(n-6) - 2*a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 10 2018 07:15:27, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A218759.
