...
\title{Recovering the unwritten recurrences of the table OEIS A237574}
...
\begin{abstract}
OEIS A237574 is a two-dimensional table $T(n,k)$ whose empirical recurrences are, for several of
...
OEIS A237574 is ``T(n,k)=Number of (n+1)X(k+1) 0..3 arrays with the upper median minus the lower median of every 2X2 subblock differing from its horizontal and vertical neighbors by exactly one.''. It is read by antidiagonals and begins
\[
256, 1876, 1876, 13924, 24332, 13924, 103264, 315664,\ \dots
\]
The entry carries, among its empirical claims:
\begin{quote}\small
k=2: [order 45]
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 10:19:20, revision 6) these are still
...
count, a walk on $S=1876$ vertices. Berlekamp--Massey on $2S=3752$ exact terms
returns a minimal recurrence of order $45$ --- the order the entry states --- with
integer coefficients
\[
(c_1,\dots,c_{45})=(0,\ 22,\ 717,\ 9851,\ 58039,\ 282363,\ 932626,\ 763157,\ -5054633,\ -31588581,\ -115776674,\ -160827826,\ 333525933,\ 1758583042,\ 2964658024,\ 49163147,\ -10533038460,\ -24197541615,\ -20964618288,\ 43163041975,\ 142771631658,\ 71165049213,\ -205125362959,\ -286625063582,\ 3665735376,\ 250982853215,\ 153419401277,\ 29910572638,\ 69334272134,\ 26030554320,\ -157877752948,\ -279343069536,\ -104462683872,\ 65989529824,\ 87578561472,\ 21371116928,\ -36675133952,\ -23711340544,\ -4557326336,\ -796352512,\ -238338048,\ 625999872,\ -578551808,\ -315621376,\ -50331648).
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237574.
