...
\title{The empirical recurrence for OEIS A218065, proved by transfer matrix}
...
\begin{abstract}
OEIS A218065 counts the distinct arrays obtained by applying a fixed local operation to every cell
...
$S=16$ states, after which the conjectured recurrence is settled by a finite exact
computation.
\end{abstract}
...
OEIS A218065 is ``Number of 2 X n arrays of the minimum value of corresponding elements and their horizontal or antidiagonal neighbors in a random 0..1 2 X n array.''. It has offset $1$ and begins
\[
4, 6, 18, 42, 108, 268, 676, 1694,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + 4*a(n-2) + a(n-3) - 3*a(n-4) - 2*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2018 14:23:43, revision 9) this is still
...
\]
There are $S=16$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite.
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 4\,a(n-2) + a(n-3) - 3\,a(n-4) - 2\,a(n-5)
\]
for every $n>5$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A218065.
