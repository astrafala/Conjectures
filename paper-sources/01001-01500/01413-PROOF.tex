...
\title{The empirical recurrence for OEIS A200254, proved from an exact model}
...
\begin{abstract}
OEIS A200254 carries an empirical recurrence of order $24$. It is true, and it is
decidable rather than empirical. The entry's sequence is given exactly by an Ehrhart quasi-polynomial, from
which $a$ provably satisfies a MONIC linear recurrence of order $S=49$, derived below and not
...
OEIS A200254 is ``Number of 0..n arrays x(0..4) of 5 elements with each no smaller than the sum of its previous elements modulo (n+1).''. It has offset $1$ and begins
\[
13, 48, 181, 405, 951, 1792, 3434, 5625,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 08:32:29, revision 9)
...
\]
annihilates $a$, and $S=\deg A=49$. A congruence condition modulo $m$ is counted one residue
...
exactly $\deg A$. The bound in force is therefore $zA(z)$, of order $S=49$, and
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) - 2\,a(n-3) + 2\,a(n-4) - 2\,a(n-5) + 2\,a(n-7) + a(n-8) - 4\,a(n-9) + 4\,a(n-11) - 4\,a(n-12) + 4\,a(n-13) - 4\,a(n-15) + a(n-16) + 2\,a(n-17) - 2\,a(n-19) + 2\,a(n-20) - 2\,a(n-21) + 2\,a(n-23) - a(n-24)
\]
for every $n>0$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A200254.
