...
\title{The empirical recurrence for OEIS A221883, proved by transfer matrix}
...
\begin{abstract}
OEIS A221883 counts the distinct OCCUPANCY arrays obtained when every cell of an $n\times2$ grid
...
one, on $S=224$ states, after which the conjectured recurrence is settled by a finite exact
computation.
\end{abstract}
...
OEIS A221883 is ``Number of n X 2 arrays of occupancy after each element stays put or moves to some horizontal, vertical or antidiagonal neighbor, without consecutive moves in the same direction.''. It has offset $1$ and begins
\[
3, 33, 326, 3223, 31832, 314426, 3105733, 30676867,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 7*a(n-1) + 27*a(n-2) + 16*a(n-3) - 18*a(n-4) - 13*a(n-5) + 5*a(n-6) + 3*a(n-7) - a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 11 2018 10:45:53, revision 9) this is still
...
$S=224$ reachable sets. In particular $a$ is $C$-finite.
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-1) + 27\,a(n-2) + 16\,a(n-3) - 18\,a(n-4) - 13\,a(n-5) + 5\,a(n-6) + 3\,a(n-7) - a(n-8)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221883.
