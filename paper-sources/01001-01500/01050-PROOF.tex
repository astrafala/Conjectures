...
\title{The empirical recurrence for OEIS A199708, proved from an exact model}
...
\begin{abstract}
OEIS A199708 carries an empirical recurrence of order $13$. It is true, and it is
...
OEIS A199708 is ``Number of -n..n arrays x(0..5) of 6 elements with zero sum and no two neighbors equal.''. It has offset $1$ and begins
\[
32, 708, 4964, 20116, 59992, 147072, 314532, 608420,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n)=3*a(n-1)-2*a(n-2)-a(n-3)+2*a(n-5)-a(n-6)-a(n-7)+2*a(n-8)-a(n-10)-2*a(n-11)+3*a(n-12)-a(n-13)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 08:18:54, revision 14)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A199708.
