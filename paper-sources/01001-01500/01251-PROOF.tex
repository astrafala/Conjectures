...
\title{The empirical recurrence for OEIS A229454, proved by counting defective colourings}
...
\begin{abstract}
OEIS A229454 counts the colourings of an array with $K=3$ colours that are proper except at
...
OEIS A229454 is ``Number of defective 3-colorings of an n X 3 0..2 array connected horizontally and vertically with exactly one mistake and colors introduced in row-major 0..2 order.''. It has offset $1$ and begins
\[
2, 20, 140, 863, 4962, 27313, 145932, 763031,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 10*a(n-1) - 29*a(n-2) + 20*a(n-3) - 4*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 17 2018 08:32:19, revision 7) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A229454.
