...
\title{The empirical recurrence for OEIS A199945, proved from an exact model}
...
\begin{abstract}
OEIS A199945 carries an empirical recurrence of order $11$. It is true, and it is
...
OEIS A199945 is ``Number of -n..n arrays x(0..3) of 4 elements with zeroth through 3rd differences all nonzero.''. It has offset $1$ and begins
\[
2, 104, 660, 2474, 6604, 14696, 28490, 50448,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) +2*a(n-2) -3*a(n-4) -3*a(n-5) +3*a(n-6) +3*a(n-7) -2*a(n-9) -a(n-10) +a(n-11).
\end{quote}
As of the ``Last modified'' line on the live entry (May 17 2018 09:11:52, revision 8)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A199945.
