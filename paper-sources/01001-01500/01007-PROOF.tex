...
\title{The cross-base identity for OEIS A126526, proved}
...
\begin{abstract}
OEIS A126526 carries an empirical identity, in two clauses, relating its counts to those of the
...
OEIS A126526 is ``Number of base 31 n-digit numbers with adjacent digits differing by four or less.''. It has offset $0$ and begins
\[
1, 31, 259, 2211, 19019, 164343, 1424235, 12368115,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2026 17:52:31, revision 9)
this is still recorded as empirical, and nothing on the entry records it as proved.

For this entry the base is $31$ and the permitted difference is $d=4$, so the first clause
claims $a_{31}(n)-a_{30}(n)=9^{\,n-1}$ whenever $4(n-1)+1\le31$, that is for
$1\le n\le8$, and the second claims $a_{31}(n)-a_{30}(n)=9^{\,n-1}-2$ at the single
$n$ with $4(n-1)=31$.
...
arithmetic, $L_{4}$ at base $31$ reproduces all $19$ terms A126526 publishes.
...
First, the model reproduces all $19$ terms A126526 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $L_{4}(31,n)$ & $L_{4}(30,n)$ & $9^{\,n-1}$ \\ \hline
1 & 31 & 30 & 1 \\
2 & 259 & 250 & 9 \\
3 & 2211 & 2130 & 81 \\
4 & 19019 & 18290 & 729 \\
5 & 164343 & 157782 & 6561 \\
6 & 1424235 & 1365186 & 59049 \\
7 & 12368115 & 11836674 & 531441 \\
8 & 107567215 & 102784246 & 4782969 \\
\end{tabular}
\end{center}
