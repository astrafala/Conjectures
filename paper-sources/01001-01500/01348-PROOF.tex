...
\title{The empirical closed form for OEIS A219454, proved}
...
\begin{abstract}
OEIS A219454 states an explicit closed form for $a(n)$ and records it as empirical. It is true, and
...
OEIS A219454 is ``Number of n X 2 arrays of the minimum value of corresponding elements and their horizontal, vertical, diagonal or antidiagonal neighbors in a random, but sorted with lexicographically nondecreasing rows and columns, 0..3 n X 2 array.''. It has offset $1$ and begins
\[
4, 4, 13, 26, 57, 116, 231, 450,\ \dots
\]
and states:
\begin{quote}
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 11 2018 15:09:21, revision 7)
...
\begin{theorem}
The closed form OEIS A219454 records is correct for all $n>5$.
\end{theorem}
...
$1 + 34 - 1$, which is more than the $9$ consecutive agreements a
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A219454.
