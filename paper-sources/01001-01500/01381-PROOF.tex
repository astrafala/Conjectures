...
\title{The empirical recurrence for OEIS A248464, proved from an exact model}
...
\begin{abstract}
OEIS A248464 carries an empirical recurrence of order $27$. It is true, and it is
...
OEIS A248464 is ``Number of length 3+2 0..n arrays with no three consecutive terms having the sum of any two elements equal to twice the third.''. It has offset $1$ and begins
\[
16, 72, 460, 1512, 4272, 9684, 20236, 37868,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 11:44:07, revision 8)
...
$q(z)=z^{27}-\sum_ic_iz^{27-i}$ the characteristic polynomial of the conjectured
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + a(n-3) - 2\,a(n-7) + a(n-8) - 2\,a(n-9) + a(n-10) - a(n-11) + 2\,a(n-12) + 2\,a(n-15) - a(n-16) + a(n-17) - 2\,a(n-18) + a(n-19) - 2\,a(n-20) + a(n-24) + a(n-26) - a(n-27)
\]
for every $n>0$.
\end{theorem}
...
vanish from $n=0+1$ onwards, and the run exceeds $S+27$, which by
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A248464.
