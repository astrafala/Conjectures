...
\title{The empirical recurrence for OEIS A220801, proved by transfer matrix}
...
\begin{abstract}
OEIS A220801 counts the distinct indicator arrays obtained from the $n\times2$ arrays over
...
indicator row by row turns it into one, on $S=246$ states, after which the conjectured
...
OEIS A220801 is ``Sum of neighbor maps: number of nX2 binary arrays indicating the locations of corresponding elements equal to the sum mod 4 of their horizontal and vertical neighbors in a random 0..3 nX2 array.''. It has offset $1$ and begins
\[
2, 16, 48, 256, 928, 4096, 15820, 65536,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 19:05:14, revision 9) this is still
...
\]
There are $S=246$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite. Note
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + 8\,a(n-2) - 32\,a(n-3) - 16\,a(n-4) + 64\,a(n-5) + 44\,a(n-8) - 176\,a(n-9) - 352\,a(n-10) + 1408\,a(n-11) + 704\,a(n-12) - 2816\,a(n-13) - 688\,a(n-16) + 2752\,a(n-17) + 5504\,a(n-18) - 22016\,a(n-19) - 11008\,a(n-20) + 44032\,a(n-21) + 4672\,a(n-24) - 18688\,a(n-25) - 37376\,a(n-26) + 149504\,a(n-27) + 74752\,a(n-28) - 299008\,a(n-29) - 14336\,a(n-32) + 57344\,a(n-33) + 114688\,a(n-34) - 458752\,a(n-35) - 229376\,a(n-36) + 917504\,a(n-37) + 16384\,a(n-40) - 65536\,a(n-41) - 131072\,a(n-42) + 524288\,a(n-43) + 262144\,a(n-44) - 1048576\,a(n-45)
\]
for every $n>45$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A220801.
