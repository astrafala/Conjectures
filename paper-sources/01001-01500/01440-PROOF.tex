...
\title{The empirical recurrence for OEIS A264631, proved by transfer matrix}
...
\begin{abstract}
OEIS A264631 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=5$ columns in which
...
OEIS A264631 is ``Number of (4+1)X(n+1) arrays of permutations of 0..n*5+4 with each element having directed index change -2,0 -1,0 0,-1 or 1,1.''. It has offset $1$ and begins
\[
1, 8, 22, 108, 684, 2736, 13556, 68972,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 19 2015 06:59:26, revision 4) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{The object is a matching}

The grid has $W=5$ columns across and holds each of $0,1,\dots,LW-1$ exactly once. The value
...
\[
(i-h_i,\,j-h_j)\;\in\;\{(-1,0),\ (0,-2),\ (0,-1),\ (1,1)\},
\]
...
Let $R=1$ be the largest $|i-h_i|$ on the list. A value whose home column is $h$ can only be
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + 36\,a(n-3) - 18\,a(n-4) + 186\,a(n-5) + 83\,a(n-6) + 144\,a(n-7) + 684\,a(n-8) - 1872\,a(n-9) + 508\,a(n-10) - 5048\,a(n-11) - 3240\,a(n-12) + 720\,a(n-13) - 95040\,a(n-14) + 3072\,a(n-15) + 3456\,a(n-16) + 13824\,a(n-18)
\]
for every $n>21$.
\end{theorem}
...
until the working vector was identically zero, settling every larger $j$ at once. The bound is exact: at $n=21$ the recurrence fails on the entry's own published terms, so no larger range holds.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264631.
