...
\title{The empirical recurrence for OEIS A264564, proved by transfer matrix}
...
\begin{abstract}
OEIS A264564 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=4$ rows in which
...
OEIS A264564 is ``Number of (n+1)X(3+1) arrays of permutations of 0..n*4+3 with each element having directed index change 1,0 1,1 0,-1 or -1,1.''. It has offset $1$ and begins
\[
1, 4, 10, 31, 79, 224, 646, 1784,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 17 2015 19:08:28, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + a(n-2) + 6\,a(n-3) - 6\,a(n-4) + 6\,a(n-5) - 27\,a(n-6) + 5\,a(n-7) - 9\,a(n-8) + 33\,a(n-9) - 4\,a(n-10) + 7\,a(n-11) - 12\,a(n-12) + a(n-13) - a(n-14) + a(n-15)
\]
for every $n>13$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264564.
