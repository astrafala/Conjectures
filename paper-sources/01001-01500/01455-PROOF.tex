...
\title{The empirical recurrence for OEIS A267474, proved from an exact model}
...
\begin{abstract}
OEIS A267474 carries an empirical recurrence of order $7$. It is true, and it is
...
\begin{quote}
Empirical: a(n) = n\^{}6 + (197/60)*n\^{}5 + 7*n\^{}4 + (43/4)*n\^{}3 + 10*n\^{}2 + (149/30)*n + 1. a(n) = 7*a(n-1) - 21*a(n-2) + 35*a(n-3) - 35*a(n-4) + 21*a(n-5) - 7*a(n-6) + a(n-7) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 05 2018 09:36:32, revision 7)
