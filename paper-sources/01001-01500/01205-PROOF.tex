...
\title{The empirical recurrence for OEIS A221189, proved by transfer matrix}
...
\begin{abstract}
OEIS A221189 counts the distinct OCCUPANCY arrays obtained when every cell of an $n\times2$ grid
...
determinising the machine that emits the occupancy row by row turns it into one, on $S=302$
...
OEIS A221189 is ``Number of n X 2 arrays of occupancy after each element moves to some king-move neighbor.''. It has offset $1$ and begins
\[
1, 31, 318, 3605, 39851, 441912, 4896043, 54248371,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 15*a(n-1) - 41*a(n-2) - 42*a(n-3) + 174*a(n-4) - 86*a(n-5) - 2*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 14 2018 07:16:48, revision 8) this is still
...
\]
There are $S=302$ reachable sets. In particular $a$ is $C$-finite.
...
\begin{theorem}
\[
a(n)\;=\;15\,a(n-1) - 41\,a(n-2) - 42\,a(n-3) + 174\,a(n-4) - 86\,a(n-5) - 2\,a(n-6)
\]
for every $n>6$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221189.
