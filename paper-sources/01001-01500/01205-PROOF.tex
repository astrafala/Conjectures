...
\title{The empirical recurrence for OEIS A230932, proved by transfer matrix}
...
\begin{abstract}
OEIS A230932 counts the black-square subarrays of arrays of width $7$ over $\{0,1,2,3\}$ in which
...
OEIS A230932 is ``Number of black-square subarrays of (n+2)X(5+2) 0..3 arrays x(i,j) with each element diagonally or antidiagonally next to at least one element with value (x(i,j)+1) mod 4, no adjacent elements equal, and upper left element zero.''. It has offset $1$ and begins
\[
42, 146, 1682, 6896, 98296, 396950, 5528862, 22368688,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 06:07:05, revision 6) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=4185.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A230932.
