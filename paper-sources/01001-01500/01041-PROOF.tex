...
\title{The empirical recurrence for OEIS A264314, proved by transfer matrix}
...
\begin{abstract}
OEIS A264314 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=2$ columns in which
...
OEIS A264314 is ``Number of (1+1)X(n+1) arrays of permutations of 0..n*2+1 with each element having directed index change 0,0 0,1 1,0 -1,-2 or 0,2.''. It has offset $1$ and begins
\[
1, 6, 20, 52, 140, 392, 1117, 3155,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) +a(n-2) +2*a(n-3) +5*a(n-4) -a(n-6) -8*a(n-7) -3*a(n-8) +6*a(n-9) -a(n-10) -2*a(n-11) -a(n-12) +a(n-14)
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 11 2015 09:59:22, revision 4) this is still
...
\[
(i-h_i,\,j-h_j)\;\in\;\{(-2,-1),\ (0,0),\ (0,1),\ (1,0),\ (2,0)\},
\]
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + a(n-2) + 2\,a(n-3) + 5\,a(n-4) - a(n-6) - 8\,a(n-7) - 3\,a(n-8) + 6\,a(n-9) - a(n-10) - 2\,a(n-11) - a(n-12) + a(n-14)
\]
for every $n>12$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264314.
