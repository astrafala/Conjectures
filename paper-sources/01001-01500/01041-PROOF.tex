...
\title{The empirical recurrence for OEIS A250390, proved from an exact model}
...
\begin{abstract}
OEIS A250390 carries an empirical recurrence of order $8$. It is true, and it is
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 21 2017 05:56:01, revision 8)
