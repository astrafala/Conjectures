...
\title{The empirical recurrence for OEIS A280279, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A280279 imposes three things at once: a condition on each cell that reaches one row up and
...
OEIS A280279 is ``Number of n X 1 0..2 arrays with no element equal to more than one of its horizontal and vertical neighbors, with the exception of exactly one element, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
0, 0, 1, 2, 8, 28, 94, 304,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 4*a(n-1) - 8*a(n-3) - 4*a(n-4) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 19 2018 11:01:52, revision 9) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A280279.
