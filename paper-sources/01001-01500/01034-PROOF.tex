...
\title{The empirical recurrence for OEIS A231135, proved by transfer matrix}
...
\begin{abstract}
OEIS A231135 counts the black-square subarrays of arrays of width $5$ over $\{0,1,2\}$ in which
...
OEIS A231135 is ``Number of (n+1)X(4+1) black-square subarrays of 0..2 arrays with no element equal to a strict majority of its diagonal and antidiagonal neighbors, with values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
16, 182, 2260, 27171, 336004, 4066129, 50257244, 608468617,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 06:16:32, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231135.
