...
\title{The empirical recurrence for OEIS A230986, proved by transfer matrix}
...
\begin{abstract}
OEIS A230986 counts the white-square subarrays of arrays of width $6$ over $\{0,1\}$ in which
no cell matches a strict majority of its diagonal neighbours. The entry carries an empirical recurrence of order $32$ contributed by
...
OEIS A230986 is ``Number of white square subarrays of (n+1)X(5+1) binary arrays with no element equal to a strict majority of its diagonal and antidiagonal neighbors, with upper left element zero.''. It has offset $1$ and begins
\[
5, 15, 59, 191, 685, 2379, 8357, 29493,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 06:09:48, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A230986.
