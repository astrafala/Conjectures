...
\title{The empirical closed form for OEIS A220198, proved}
...
\begin{abstract}
OEIS A220198 states an explicit closed form for $a(n)$ and records it as empirical. It is true, and
...
OEIS A220198 is ``Number of n X 2 arrays of the minimum value of corresponding elements and their horizontal, vertical or diagonal neighbors in a random, but sorted with lexicographically nondecreasing rows and nonincreasing columns, 0..3 n X 2 array.''. It has offset $1$ and begins
\[
4, 10, 38, 103, 245, 547, 1168, 2395,\ \dots
\]
and states:
\begin{quote}
Empirical: a(n) = (1/20160)*n\^{}8 - (1/5040)*n\^{}7 - (1/480)*n\^{}6 + (107/720)*n\^{}5 - (1151/960)*n\^{}4 + (278/45)*n\^{}3 - (54427/5040)*n\^{}2 + (5323/420)*n - 7 for n>1.
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 30 2018 10:05:49, revision 7)
...
\begin{theorem}
The closed form OEIS A220198 records is correct for all $n>1$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A220198.
