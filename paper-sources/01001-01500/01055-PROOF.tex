...
\title{The empirical closed form for OEIS A219514, proved}
...
\begin{abstract}
OEIS A219514 states an explicit closed form for $a(n)$ and records it as empirical. It is true, and
...
OEIS A219514 is ``Number of n X 3 arrays of the minimum value of corresponding elements and their horizontal, diagonal or antidiagonal neighbors in a random, but sorted with lexicographically nondecreasing rows and columns, 0..1 n X 3 array.''. It has offset $1$ and begins
\[
3, 4, 11, 22, 42, 74, 124, 199,\ \dots
\]
and states:
\begin{quote}
Empirical: a(n) = (1/24)*n\^{}4 + (1/12)*n\^{}3 - (37/24)*n\^{}2 + (161/12)*n - 23 for n>3.
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 26 2018 06:35:16, revision 8)
...
\begin{theorem}
The closed form OEIS A219514 records is correct for all $n>3$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A219514.
