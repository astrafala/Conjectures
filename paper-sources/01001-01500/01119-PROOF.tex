...
\title{The empirical recurrence for OEIS A281320, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A281320 imposes three things at once: a condition on each cell that reaches one row up and
...
OEIS A281320 is ``Number of n X 2 0..2 arrays with no element equal to more than one of its horizontal and antidiagonal neighbors, with the exception of exactly one element, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
0, 2, 28, 304, 2976, 27488, 244544, 2119168,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 16*a(n-1) - 72*a(n-2) + 64*a(n-3) - 16*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 18 2019 08:57:29, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A281320.
