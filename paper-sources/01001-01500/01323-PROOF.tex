...
\title{The empirical recurrence for OEIS A264281, proved by transfer matrix}
...
\begin{abstract}
OEIS A264281 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=5$ rows in which
...
OEIS A264281 is ``Number of (n+1) X (4+1) arrays of permutations of 0..n*5+4 with each element having directed index change 0,0 0,1 1,0 or -1,-2.''. It has offset $1$ and begins
\[
16, 102, 675, 4484, 29742, 197283, 1308629, 8680430,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 7*a(n-1) - 2*a(n-2) - 2*a(n-3) - 6*a(n-4) + a(n-5) + 3*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 07 2019 06:09:06, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264281.
