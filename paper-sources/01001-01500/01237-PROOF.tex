...
\title{The empirical recurrence for OEIS A201046, proved from an exact model}
...
\begin{abstract}
OEIS A201046 carries an empirical recurrence of order $8$. It is true, and it is
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 22 2018 03:47:32, revision 9)
