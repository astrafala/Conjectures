...
\title{The empirical recurrence for OEIS A231125, proved by transfer matrix}
...
\begin{abstract}
OEIS A231125 counts the white-square subarrays of arrays of width $3$ over $\{0,1,2\}$ in which
...
OEIS A231125 is ``Number of (n+1) X (2+1) white-square subarrays of 0..2 arrays with no element equal to a strict majority of its diagonal and antidiagonal neighbors, with values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
2, 8, 40, 176, 808, 3584, 16368, 72640,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 22*a(n-2) - 36*a(n-4) + 16*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 26 2018 14:33:40, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231125.
