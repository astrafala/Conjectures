...
\title{The empirical recurrence for OEIS A269437, proved from an exact model}
...
\begin{abstract}
OEIS A269437 carries an empirical recurrence of order $6$. It is true, and it is
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 22 2019 07:46:33, revision 8)
