...
\title{The empirical recurrence for OEIS A264138, proved by transfer matrix}
...
\begin{abstract}
OEIS A264138 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=5$ rows in which
...
OEIS A264138 is ``Number of (n+1)X(4+1) arrays of permutations of 0..n*5+4 with each element having index change +-(.,.) 0,0 1,-2 or 1,1.''. It has offset $1$ and begins
\[
45, 720, 15488, 297920, 5953600, 117534144, 2330885440, 46152976320,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 19*a(n-1) +16*a(n-2) -304*a(n-3) +5776*a(n-4) +4864*a(n-5) +4096*a(n-6) -77824*a(n-7) -65536*a(n-8)
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 10 2015 11:15:06, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;19\,a(n-1) + 16\,a(n-2) - 304\,a(n-3) + 5776\,a(n-4) + 4864\,a(n-5) + 4096\,a(n-6) - 77824\,a(n-7) - 65536\,a(n-8)
\]
for every $n>7$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264138.
