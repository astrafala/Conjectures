...
\title{The empirical recurrence for OEIS A183906, proved by transfer matrix}
...
\begin{abstract}
OEIS A183906 carries an empirical recurrence of order $4$ contributed by R.~H.~Hardin. It is
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 05 2018 20:38:32, revision 8) this is still
