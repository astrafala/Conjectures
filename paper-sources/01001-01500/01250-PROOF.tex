...
\title{The empirical recurrence for OEIS A229666, proved by counting defective colourings}
...
\begin{abstract}
OEIS A229666 counts the colourings of an array with $K=4$ colours that are proper except at
...
numbers. What is left is a walk count on $S=90$ vertices, and the empirical recurrence of
...
OEIS A229666 is ``Number of defective 4-colorings of an n X 2 0..3 array connected horizontally, antidiagonally and vertically with exactly two mistakes, and colors introduced in row-major 0..3 order.''. It has offset $1$ and begins
\[
0, 4, 61, 652, 5048, 33152, 197248, 1098752,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 12*a(n-1) - 48*a(n-2) + 64*a(n-3) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 20 2018 09:10:32, revision 8) the statement is
...
Assembling the $4$ chains block-diagonally into $N$ of size $S=90$ with the weights of
...
\[
4!\Bigl(a(n_0+j)-\sum_i c_i\,a(n_0+j-i)\Bigr)=\mathbf{v}^{\!\top}G^{\,j-3}w,
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A229666.
