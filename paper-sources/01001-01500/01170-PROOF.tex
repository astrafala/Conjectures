...
\title{The empirical closed form for OEIS A241970, proved from an exact model}
...
\begin{abstract}
OEIS A241970 carries an empirical closed form: a polynomial in $n$ of degree $10$, recorded on the
entry and never marked settled. It is true. The entry's count is given exactly by an Ehrhart
quasi-polynomial, from which $a$ provably satisfies a monic linear recurrence of order $S=12$
derived below; a polynomial of degree $10$ satisfies $(z-1)^{10+1}$; so the difference
satisfies the product, and $12+10+1$ consecutive agreements settle it. No transfer matrix is
...
OEIS A241970 is ``Number of length 7+3 0..n arrays with no consecutive four elements summing to more than 2*n.''. It has offset $1$ and begins
\[
285, 11518, 172980, 1460409, 8476317, 37822419, 138925925, 439298830,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (1057/10368)*n\^{}10 + (16313/13440)*n\^{}9 + (787993/120960)*n\^{}8 + (139919/6720)*n\^{}7 + 
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 11:15:20, revision 6)
...
\]
annihilates $a$, and $S=\deg A=12$. A congruence condition modulo $m$ is counted one residue
...
exactly $\deg A$. The bound in force is therefore $zA(z)$, of order $S=12$, and
...
kills $a$, and $(z-1)^{10+1}$ kills $P$, so $A(z)(z-1)^{10+1}$ --- monic, of order
$12+10+1$ --- kills $r$. The model was evaluated exactly in integer arithmetic and $P$ in
exact rational arithmetic at every index from $n=1$ to $n=1+12+10+1$, and $r$ vanished
at all of them. A monic recurrence with $12+10+1$ consecutive zeros has every later term zero,
so $r\equiv0$.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A241970.
