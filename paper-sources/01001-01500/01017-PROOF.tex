...
\title{The empirical recurrence for OEIS A219101, proved by transfer matrix}
...
\begin{abstract}
OEIS A219101 counts the distinct indicator arrays obtained from the $n\times3$ arrays over
...
indicator row by row turns it into one, on $S=89$ states, after which the conjectured
...
OEIS A219101 is ``Unmatched value maps: number of nX3 binary arrays indicating the locations of corresponding elements not equal to any horizontal, vertical or antidiagonal neighbor in a random 0..2 nX3 array.''. It has offset $1$ and begins
\[
4, 42, 288, 1971, 13674, 95146, 660556, 4584620,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 17:52:58, revision 8) this is still
...
\]
There are $S=89$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite. Note
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-1) - 11\,a(n-2) + 25\,a(n-3) + 7\,a(n-4) - 46\,a(n-5) + 115\,a(n-6) - 75\,a(n-7) - 10\,a(n-8) + 180\,a(n-9) - 264\,a(n-10) + 268\,a(n-11) - 132\,a(n-12) + 28\,a(n-13) + 16\,a(n-14) - 8\,a(n-15)
\]
for every $n>21$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A219101.
