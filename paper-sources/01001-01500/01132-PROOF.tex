...
\begin{quote}
Empirical: a(n) = (1/20160)*n\^{}8 + (19/720)*n\^{}7 + (211/288)*n\^{}6 + (1889/360)*n\^{}5 + (44167/2880)*n\^{}4 + (15991/720)*n\^{}3 + (5689/336)*n\^{}2 + (391/60)*n + 1. a(n) = 9*a(n-1) - 36*a(n-2) + 84*a(n-3) - 126*a(n-4) + 126*a(n-5) - 84*a(n-6) + 36*a(n-7) - 9*a(n-8) + a(n-9) for n>9.
\end{quote}
