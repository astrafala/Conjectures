...
\title{The empirical recurrence for OEIS A254701, proved from an exact model}
...
\begin{abstract}
OEIS A254701 carries an empirical recurrence of order $7$. It is true, and it is
...
OEIS A254701 is ``Number of length 3+4 0..n arrays with every five consecutive terms having the maximum of some two terms equal to the minimum of the remaining three terms.''. It has offset $1$ and begins
\[
54, 552, 2764, 9507, 25962, 60634, 126456, 242037,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (1/5)*n\^{}6 + (19/5)*n\^{}5 + (27/2)*n\^{}4 + (35/2)*n\^{}3 + (123/10)*n\^{}2 + (57/10)*n + 1.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 17 2018 09:23:14, revision 7)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A254701.
