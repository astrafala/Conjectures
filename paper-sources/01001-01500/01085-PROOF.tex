...
\title{The empirical recurrence for OEIS A229668, proved by counting defective colourings}
...
\begin{abstract}
OEIS A229668 counts the colourings of an array with $K=4$ colours that are proper except at
...
numbers. What is left is a walk count on $S=1062$ vertices, and the empirical recurrence of
...
OEIS A229668 is ``Number of defective 4-colorings of an n X 4 0..3 array connected horizontally, antidiagonally and vertically with exactly two mistakes, and colors introduced in row-major 0..3 order.''. It has offset $1$ and begins
\[
3, 652, 19805, 328160, 4331928, 50919512, 557478448, 5814322288,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 28 2021 01:24:14, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;36\,a(n-1) - 552\,a(n-2) + 4812\,a(n-3) - 27168\,a(n-4) + 107904\,a(n-5) - 316720\,a(n-6) + 703296\,a(n-7) - 1187712\,a(n-8) + 1506368\,a(n-9) - 1379328\,a(n-10) + 835584\,a(n-11) - 262144\,a(n-12)
\end{equation}
for all $n>14$.
...
Assembling the $4$ chains block-diagonally into $N$ of size $S=1062$ with the weights of
...
\[
4!\Bigl(a(n_0+j)-\sum_i c_i\,a(n_0+j-i)\Bigr)=\mathbf{v}^{\!\top}G^{\,j-12}w,
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A229668.
