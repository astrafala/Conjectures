...
\title{The empirical recurrence for OEIS A241967, proved from an exact model}
...
\begin{abstract}
OEIS A241967 carries an empirical recurrence of order $8$. It is true, and it is
...
OEIS A241967 is ``Number of length 4+3 0..n arrays with no consecutive four elements summing to more than 2*n.''. It has offset $1$ and begins
\[
57, 775, 5211, 23320, 80132, 228826, 569874, 1277427,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (293/1260)*n\^{}7 + (691/360)*n\^{}6 + (2443/360)*n\^{}5 + (121/9)*n\^{}4 + (5857/360)*n\^{}3 + (4369/360)*n\^{}2 + (2189/420)*n + 1.
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 31 2018 06:33:33, revision 7)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A241967.
