...
\title{The empirical recurrence for OEIS A250016, proved from an exact model}
...
\begin{abstract}
OEIS A250016 carries an empirical recurrence of order $8$. It is true, and it is
...
OEIS A250016 is ``Number of length 2+5 0..n arrays with no six consecutive terms having the maximum of any three terms equal to the minimum of the remaining three terms.''. It has offset $1$ and begins
\[
20, 520, 5200, 30360, 125780, 412160, 1140160, 2776080,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = n\^{}7 + 2*n\^{}6 + 4*n\^{}5 + 5*n\^{}4 + (17/3)*n\^{}3 + 3*n\^{}2 - (2/3)*n.
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 10 2018 12:44:04, revision 20)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250016.
