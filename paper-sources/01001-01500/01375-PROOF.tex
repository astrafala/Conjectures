...
\title{The empirical recurrence for OEIS A199944, proved from an exact model}
...
\begin{abstract}
OEIS A199944 carries an empirical recurrence of order $5$. It is true, and it is
...
OEIS A199944 is ``Number of -n..n arrays x(0..2) of 3 elements with zeroth through 2nd differences all nonzero.''. It has offset $1$ and begins
\[
2, 36, 142, 376, 778, 1404, 2294, 3504,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) -2*a(n-2) -2*a(n-3) +3*a(n-4) -a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (May 17 2018 09:11:58, revision 8)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A199944.
