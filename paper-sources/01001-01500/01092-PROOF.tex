...
\title{The empirical recurrence for OEIS A281557, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A281557 imposes three things at once: a condition on each cell that reaches one row up and
...
numbers. The empirical recurrence of order $12$ contributed by R.~H.~Hardin then follows
from a finite exact computation on $S=51$ states.
\end{abstract}
...
OEIS A281557 is ``Number of nX2 0..1 arrays with no element equal to more than two of its horizontal, diagonal or antidiagonal neighbors, with the exception of exactly two elements, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
0, 0, 1, 6, 57, 310, 1508, 6854,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 9*a(n-1) -24*a(n-2) +9*a(n-3) +18*a(n-4) +45*a(n-5) -41*a(n-6) -36*a(n-7) -18*a(n-8) +36*a(n-9) +12*a(n-10) -8*a(n-12)
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 24 2017 08:30:42, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;9\,a(n-1) - 24\,a(n-2) + 9\,a(n-3) + 18\,a(n-4) + 45\,a(n-5) - 41\,a(n-6) - 36\,a(n-7) - 18\,a(n-8) + 36\,a(n-9) + 12\,a(n-10) - 8\,a(n-12)
\end{equation}
for all $n>13$.
...
Assembling the $2$ chains block-diagonally into $N$ of size $S=51$ with the weights of
...
$h_j=G^{j}N^{o}\mathbf{u}$, we have for $j\ge12$
\[
2!\Bigl(a(n_0+j)-\sum_i c_i\,a(n_0+j-i)\Bigr)=\mathbf{v}^{\!\top}G^{\,j-12}w,
...
$12$ applications of $G$ in exact integer arithmetic and $\mathbf{v}^{\!\top}G^{m}w$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A281557.
