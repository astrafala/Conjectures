...
\title{The empirical recurrence for OEIS A250143, proved from an exact model}
...
\begin{abstract}
OEIS A250143 carries an empirical recurrence of order $7$. It is true, and it is
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 12 2018 03:00:59, revision 11)
