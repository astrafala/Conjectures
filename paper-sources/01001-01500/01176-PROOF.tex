...
\title{The empirical recurrence for OEIS A267235, proved from an exact model}
...
\begin{abstract}
OEIS A267235 carries an empirical recurrence of order $7$. It is true, and it is
...
OEIS A267235 is ``Number of length-6 0..n arrays with no following elements greater than or equal to the first repeated value.''. It has offset $1$ and begins
\[
8, 223, 1790, 8274, 27854, 76237, 180292, 382404,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = n\^{}6 + (197/60)*n\^{}5 + 3*n\^{}4 + (3/4)*n\^{}3 - (1/30)*n.
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 10 2019 15:22:24, revision 8)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267235.
