...
\title{The empirical recurrence for OEIS A249849, proved from an exact model}
...
\begin{abstract}
OEIS A249849 carries an empirical recurrence of order $10$. It is true, and it is
...
\begin{quote}
Empirical: a(n) = n\^{}9 + (4/105)*n\^{}8 + (859/210)*n\^{}7 + (161/180)*n\^{}6 + (37/30)*n\^{}5 + (313/90)*n\^{}4 - (7/5)*n\^{}3 + (743/1260)*n\^{}2 + (8/105)*n. a(n) = 10*a(n-1) - 45*a(n-2) + 120*a(n-3) - 210*a(n-4) + 252*a(n-5) - 210*a(n-6) + 120*a(n-7) - 45*a(n-8) + 10*a(n-9) - a(n-10) for n>10.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 18 2017 09:16:07, revision 8)
