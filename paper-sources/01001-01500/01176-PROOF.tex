...
\title{The empirical recurrence for OEIS A229680, proved by counting defective colourings}
...
\begin{abstract}
OEIS A229680 counts the colourings of an array with $K=3$ colours that are proper except at
...
OEIS A229680 is ``Number of defective 3-colorings of an n X 3 0..2 array connected diagonally and antidiagonally with exactly two mistakes, and colors introduced in row-major 0..2 order.''. It has offset $1$ and begins
\[
0, 36, 888, 10896, 108000, 959040, 7952256, 62892288,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 18*a(n-1) -108*a(n-2) +216*a(n-3) for n>4.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 16 2017 08:16:08, revision 9) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A229680.
