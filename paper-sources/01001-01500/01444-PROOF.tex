...
\title{The empirical recurrence for OEIS A221933, proved by transfer matrix}
...
\begin{abstract}
OEIS A221933 counts the distinct OCCUPANCY arrays obtained when every cell of an $n\times3$ grid
...
one, on $S=175$ states, after which the conjectured recurrence is settled by a finite exact
computation.
\end{abstract}
...
OEIS A221933 is ``Number of n X 3 arrays of occupancy after each element stays put or moves to some horizontal or antidiagonal neighbor, without move-in move-out straight through or left turns.''. It has offset $1$ and begins
\[
6, 105, 1599, 24535, 376389, 5773962, 88575493, 1358791848,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 14*a(n-1) + 21*a(n-2) - 5*a(n-3) - 26*a(n-4) + a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 11 2018 13:10:11, revision 9) this is still
...
$S=175$ reachable sets. In particular $a$ is $C$-finite.
...
\begin{theorem}
\[
a(n)\;=\;14\,a(n-1) + 21\,a(n-2) - 5\,a(n-3) - 26\,a(n-4) + a(n-5)
\]
for every $n>5$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221933.
