...
\title{The empirical recurrence for OEIS A247728, proved from an exact model}
...
\begin{abstract}
OEIS A247728 carries an empirical recurrence of order $8$. It is true, and it is
...
OEIS A247728 is ``Number of length 2+3 0..n arrays with no disjoint pairs in any consecutive four terms having the same sum.''. It has offset $1$ and begins
\[
8, 90, 456, 1592, 4344, 10098, 20816, 39264,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) -4*a(n-2) -4*a(n-3) +10*a(n-4) -4*a(n-5) -4*a(n-6) +4*a(n-7) -a(n-8)
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 11:37:09, revision 8)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A247728.
