...
\title{The empirical recurrence for OEIS A241966, proved from an exact model}
...
\begin{abstract}
OEIS A241966 carries an empirical recurrence of order $7$. It is true, and it is
...
OEIS A241966 is ``Number of length 3+3 0..n arrays with no consecutive four elements summing to more than 2*n.''. It has offset $1$ and begins
\[
33, 311, 1597, 5778, 16660, 40978, 89622, 179079,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (3/10)*n\^{}6 + (127/60)*n\^{}5 + (149/24)*n\^{}4 + (59/6)*n\^{}3 + (1079/120)*n\^{}2 + (91/20)*n + 1. a(n) = 7*a(n-1) - 21*a(n-2) + 35*a(n-3) - 35*a(n-4) + 21*a(n-5) - 7*a(n-6) + a(n-7) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 31 2018 06:33:43, revision 8)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A241966.
