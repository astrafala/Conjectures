...
\title{The empirical recurrence for OEIS A280804, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A280804 imposes three things at once: a condition on each cell that reaches one row up and
...
OEIS A280804 is ``Number of nX2 0..1 arrays with no element equal to more than two of its horizontal, vertical and antidiagonal neighbors, with the exception of exactly two elements, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
0, 1, 3, 18, 72, 284, 1047, 3722,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 08 2017 09:42:18, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;9\,a(n-1) - 30\,a(n-2) + 48\,a(n-3) - 45\,a(n-4) + 18\,a(n-5) + 44\,a(n-6) - 60\,a(n-7) + 30\,a(n-8) - 2\,a(n-9) - 51\,a(n-10) + 21\,a(n-11) + 13\,a(n-12) - 3\,a(n-13) + 18\,a(n-14) + 7\,a(n-15) - 9\,a(n-16) - 6\,a(n-17) - a(n-18)
\end{equation}
for all $n>19$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A280804.
