...
\begin{quote}
Empirical: a(n) = n\^{}7 + (19/30)*n\^{}6 + (51/20)*n\^{}5 + (17/12)*n\^{}4 - (1/4)*n\^{}3 + (19/20)*n\^{}2 - (3/10)*n. a(n) = 8*a(n-1) - 28*a(n-2) + 56*a(n-3) - 70*a(n-4) + 56*a(n-5) - 28*a(n-6) + 8*a(n-7) - a(n-8) for n>8.
\end{quote}
