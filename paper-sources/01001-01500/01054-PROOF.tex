...
\title{The empirical recurrence for OEIS A281803, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A281803 imposes three things at once: a condition on each cell that reaches one column up and
...
OEIS A281803 is ``Number of 2 X n 0..1 arrays with no element unequal to a strict majority of its horizontal, diagonal and antidiagonal neighbors, with the exception of exactly two elements, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
0, 0, 6, 38, 157, 524, 1631, 4694,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 19 2022 13:59:18, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;7\,a(n-1) - 10\,a(n-2) - 29\,a(n-3) + 68\,a(n-4) + 67\,a(n-5) - 195\,a(n-6) - 108\,a(n-7) + 306\,a(n-8) + 132\,a(n-9) - 276\,a(n-10) - 96\,a(n-11) + 136\,a(n-12) + 32\,a(n-13) - 32\,a(n-14)
\end{equation}
for all $n>15$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A281803.
