...
\title{The empirical recurrence for OEIS A221887, proved by transfer matrix}
...
\begin{abstract}
OEIS A221887 counts the distinct OCCUPANCY arrays obtained when every cell of an $n\times3$ grid
...
one, on $S=130$ states, after which the conjectured recurrence is settled by a finite exact
computation.
\end{abstract}
...
OEIS A221887 is ``Number of nX3 arrays of occupancy after each element moves to some horizontal, diagonal or antidiagonal neighbor, without 2-loops or left turns.''. It has offset $1$ and begins
\[
0, 8, 0, 90, 204, 1297, 4608, 23159,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 20:03:53, revision 9) this is still
...
$S=130$ reachable sets. In particular $a$ is $C$-finite.
...
\begin{theorem}
\[
a(n)\;=\;14\,a(n-2) + 28\,a(n-3) + a(n-4) - 104\,a(n-5) - 92\,a(n-6) + 84\,a(n-7) + 19\,a(n-8) - 4\,a(n-9) + 75\,a(n-10) - 15\,a(n-12) - 8\,a(n-13) + 4\,a(n-14)
\]
for every $n>14$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221887.
