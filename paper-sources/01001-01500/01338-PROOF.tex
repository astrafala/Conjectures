...
\begin{quote}
Empirical: a(n) = (47/5040)*n\^{}7 + (47/360)*n\^{}6 + (7/9)*n\^{}5 + (23/9)*n\^{}4 + (3599/720)*n\^{}3 + (2093/360)*n\^{}2 + (26/7)*n + 1. a(n) = 8*a(n-1) - 28*a(n-2) + 56*a(n-3) - 70*a(n-4) + 56*a(n-5) - 28*a(n-6) + 8*a(n-7) - a(n-8) for n>8.
\end{quote}
