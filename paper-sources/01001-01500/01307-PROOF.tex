...
\title{Recovering the unwritten recurrences of the table OEIS A237868}
...
\begin{abstract}
OEIS A237868 is a two-dimensional table $T(n,k)$ whose empirical recurrences are, for several of
...
OEIS A237868 is ``T(n,k)=Number of (n+1)X(k+1) 0..2 arrays with the upper median plus the lower median minus the minimum of every 2X2 subblock differing from its horizontal and vertical neighbors by exactly one.''. It is read by antidiagonals and begins
\[
81, 336, 336, 1414, 1944, 1414, 6030, 11454,\ \dots
\]
The entry carries, among its empirical claims:
\begin{quote}\small
k=2: [order 33]
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 10:32:16, revision 6) these are still
...
count, a walk on $S=336$ vertices. Berlekamp--Massey on $2S=672$ exact terms
returns a minimal recurrence of order $33$ --- the order the entry states --- with
integer coefficients
\[
(c_1,\dots,c_{33})=(0,\ 0,\ 48,\ 764,\ 1113,\ 2630,\ -1330,\ -76808,\ -103834,\ 42139,\ 213170,\ 624044,\ 404402,\ -474767,\ -1195423,\ -845864,\ -233832,\ -278031,\ 2684781,\ -785243,\ 690749,\ 16053,\ -191039,\ -140612,\ -402983,\ 152122,\ -120738,\ -14602,\ 3372,\ 2280,\ -1368,\ 264,\ 128).
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237868.
