...
\title{The empirical recurrence for OEIS A282126, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A282126 imposes three things at once: a condition on each cell that reaches one row up and
...
numbers. The empirical recurrence of order $30$ contributed by R.~H.~Hardin then follows
...
OEIS A282126 is ``Number of nX3 0..2 arrays with no element unequal to more than four of its king-move neighbors, with the exception of exactly one element, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
0, 30, 1826, 14952, 137676, 1032030, 7679079, 54233948,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 06 2017 09:40:35, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) + 27\,a(n-2) - 94\,a(n-3) - 412\,a(n-4) - 278\,a(n-5) + 975\,a(n-6) + 3434\,a(n-7) + 6707\,a(n-8) + 15412\,a(n-9) + 19348\,a(n-10) - 28040\,a(n-11) - 141880\,a(n-12) - 289800\,a(n-13) - 384816\,a(n-14) - 381408\,a(n-15) - 137472\,a(n-16) + 808096\,a(n-17) + 1991216\,a(n-18) + 2345536\,a(n-19) + 726976\,a(n-20) - 2580224\,a(n-21) - 3660160\,a(n-22) - 1949440\,a(n-23) + 888832\,a(n-24) + 2543616\,a(n-25) + 829184\,a(n-26) - 98304\,a(n-27) - 399360\,a(n-28) - 147456\,a(n-29) - 36864\,a(n-30)
\end{equation}
for all $n>33$.
...
\[
\#\{\text{neighbours different from }x_{t,u}\}>4 .
\]
...
$h_j=G^{j}N^{o}\mathbf{u}$, we have for $j\ge30$
\[
3!\Bigl(a(n_0+j)-\sum_i c_i\,a(n_0+j-i)\Bigr)=\mathbf{v}^{\!\top}G^{\,j-30}w,
\qquad w=h_{30}-\sum_i c_i h_{30-i} .
\]
...
\begin{theorem}
The recurrence \eqref{eq:conj} holds for every $n>33$, which is the statement of
Section~1.
\end{theorem}

\begin{proof}
The digraph was built directly from the definitions above. The vector $w$ was formed by
$30$ applications of $G$ in exact integer arithmetic and $\mathbf{v}^{\!\top}G^{m}w$
evaluated for $m=0,1,\dots$, again exactly. Every one of those integers vanishes from the
index corresponding to $n=33+1$ onwards, and the run continued until $S+1$ consecutive
zeros had been seen.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A282126.
