...
\title{The empirical recurrence for OEIS A264502, proved by transfer matrix}
...
\begin{abstract}
OEIS A264502 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=5$ rows in which
...
OEIS A264502 is ``Number of (n+1) X (4+1) arrays of permutations of 0..n*5+4 with each element having directed index change -1,1 0,-1 0,1 or 1,0.''. It has offset $1$ and begins
\[
6, 38, 211, 1224, 7177, 41622, 241432, 1401492,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 6*a(n-1) - 5*a(n-2) + 36*a(n-3) - 72*a(n-4) - 243*a(n-6) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 08 2019 08:19:34, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264502.
