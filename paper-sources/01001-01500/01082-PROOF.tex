...
\title{The empirical recurrence for OEIS A279867, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A279867 imposes three things at once: a condition on each cell that reaches one row up and
...
OEIS A279867 is ``Number of n X 3 0..2 arrays with no element unequal to a strict majority of its horizontal and vertical neighbors, with the exception of exactly two elements, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
0, 33, 176, 824, 3199, 11983, 42296, 143968,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 02 2025 11:47:14, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;7\,a(n-1) - 13\,a(n-2) - 3\,a(n-3) + 13\,a(n-4) + 11\,a(n-5) + 29\,a(n-6) - 49\,a(n-7) - 8\,a(n-8) - 38\,a(n-9) + 28\,a(n-10) + 8\,a(n-11) + 16\,a(n-12)
\end{equation}
for all $n>18$.
...
index corresponding to $n=18+1$ onwards, and the run continued until $S+1$ consecutive
zeros had been seen.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A279867.
