...
\title{The empirical recurrence for OEIS A219144, proved by transfer matrix}
...
\begin{abstract}
OEIS A219144 counts the distinct indicator arrays obtained from the $n\times3$ arrays over
...
indicator row by row turns it into one, on $S=46$ states, after which the conjectured
...
OEIS A219144 is ``Unchanging value maps: number of 3Xn binary arrays indicating the locations of corresponding elements unequal to no horizontal, diagonal or antidiagonal neighbor in a random 0..2 3Xn array.''. It has offset $1$ and begins
\[
1, 18, 78, 281, 1072, 4033, 15255, 57963,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 17:55:09, revision 8) this is still
...
\]
There are $S=46$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite. Note
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) - 8\,a(n-3) + 17\,a(n-4) + 17\,a(n-5) - 29\,a(n-6) - 13\,a(n-7) + 9\,a(n-8) - 31\,a(n-9) - 26\,a(n-10) + 30\,a(n-11) - 3\,a(n-12) + 6\,a(n-13) + 17\,a(n-14) - 3\,a(n-15) + 3\,a(n-16) - 2\,a(n-17)
\]
for every $n>18$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A219144.
