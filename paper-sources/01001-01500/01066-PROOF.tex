...
\title{The empirical recurrence for OEIS A217639, proved by transfer matrix}
...
\begin{abstract}
OEIS A217639 counts the distinct arrays obtained by applying a fixed local operation to every cell
...
$S=24$ states, after which the conjectured recurrence is settled by a finite exact
computation.
\end{abstract}
...
OEIS A217639 is ``Number of nX2 arrays of the minimum value of corresponding elements and their horizontal, vertical or antidiagonal neighbors in a random 0..2 nX2 array.''. It has offset $1$ and begins
\[
3, 9, 27, 91, 293, 959, 3121, 10171,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) +3*a(n-2) +3*a(n-3) +2*a(n-4) -a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 17:27:01, revision 10) this is still
...
\]
There are $S=24$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite.
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 3\,a(n-2) + 3\,a(n-3) + 2\,a(n-4) - a(n-6)
\]
for every $n>6$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A217639.
