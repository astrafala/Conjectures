...
\title{The empirical recurrence for OEIS A221162, proved by transfer matrix}
...
\begin{abstract}
OEIS A221162 counts the distinct OCCUPANCY arrays obtained when every cell of an $n\times2$ grid
...
determinising the machine that emits the occupancy row by row turns it into one, on $S=167$
...
OEIS A221162 is ``Number of n X 2 arrays of occupancy after each element stays put or moves to some horizontal, vertical or antidiagonal neighbor.''. It has offset $1$ and begins
\[
3, 33, 352, 3721, 39254, 413908, 4363921, 46008619,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 13*a(n-1) - 26*a(n-2) + a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 04 2018 06:40:46, revision 10) this is still
...
\]
There are $S=167$ reachable sets. In particular $a$ is $C$-finite.
...
arithmetic. The entry's first term is $3$, and it is a sharp test of the boundary: a
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221162.
