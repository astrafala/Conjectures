...
\title{The cross-base identity for OEIS A126543, proved}
...
\begin{abstract}
OEIS A126543 carries an empirical identity, in two clauses, relating its counts to those of the
...
OEIS A126543 is ``Number of base 22 n-digit numbers with adjacent digits differing by five or less.''. It has offset $0$ and begins
\[
1, 22, 212, 2112, 21262, 215204, 2183942, 22191818,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:18:16, revision 11)
this is still recorded as empirical, and nothing on the entry records it as proved.

For this entry the base is $22$ and the permitted difference is $d=5$, so the first clause
claims $a_{22}(n)-a_{21}(n)=11^{\,n-1}$ whenever $5(n-1)+1\le22$, that is for
$1\le n\le5$, and the second claims $a_{22}(n)-a_{21}(n)=11^{\,n-1}-2$ at the single
$n$ with $5(n-1)=22$.
...
arithmetic, $L_{5}$ at base $22$ reproduces all $18$ terms A126543 publishes.
...
First, the model reproduces all $18$ terms A126543 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $L_{5}(22,n)$ & $L_{5}(21,n)$ & $11^{\,n-1}$ \\ \hline
1 & 22 & 21 & 1 \\
2 & 212 & 201 & 11 \\
3 & 2112 & 1991 & 121 \\
4 & 21262 & 19931 & 1331 \\
5 & 215204 & 200563 & 14641 \\
\end{tabular}
\end{center}
