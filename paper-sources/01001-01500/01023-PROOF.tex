...
\title{The empirical recurrence for OEIS A264239, proved by transfer matrix}
...
\begin{abstract}
OEIS A264239 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=4$ rows in which
...
OEIS A264239 is ``Number of (n+1) X (3+1) arrays of permutations of 0..n*4+3 with each element having directed index change 0,0 1,1 0,-1 -1,1 or 0,-2.''. It has offset $1$ and begins
\[
21, 95, 804, 5055, 36193, 243881, 1688581, 11546272,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 7*a(n-1) + 7*a(n-2) - 65*a(n-3) + 65*a(n-4) + 62*a(n-5) - 72*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 06 2019 10:43:09, revision 10) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264239.
