...
\title{The empirical recurrence for OEIS A221338, proved by transfer matrix}
...
\begin{abstract}
OEIS A221338 counts the distinct OCCUPANCY arrays obtained when every cell of an $n\times2$ grid
...
one, on $S=212$ states, after which the conjectured recurrence is settled by a finite exact
computation.
\end{abstract}
...
OEIS A221338 is ``Number of nX2 arrays of occupancy after each element moves to some king-move neighbor, with no 2-loops and with no occupancy greater than 2.''. It has offset $1$ and begins
\[
0, 13, 85, 758, 5736, 44186, 335511, 2551999,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 19:32:38, revision 9) this is still
...
$S=212$ reachable sets. In particular $a$ is $C$-finite.
...
\begin{theorem}
\[
a(n)\;=\;17\,a(n-1) - 96\,a(n-2) + 174\,a(n-3) + 255\,a(n-4) - 1452\,a(n-5) + 1878\,a(n-6) + 67\,a(n-7) - 2335\,a(n-8) + 1974\,a(n-9) - 508\,a(n-10)
\]
for every $n>10$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221338.
