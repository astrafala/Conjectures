...
\title{The empirical recurrence for OEIS A218229, proved by transfer matrix}
...
\begin{abstract}
OEIS A218229 counts the distinct indicator arrays obtained from the $n\times4$ arrays over
...
indicator row by row turns it into one, on $S=398$ states, after which the conjectured
...
OEIS A218229 is ``Hilltop maps: number of nX4 binary arrays indicating the locations of corresponding elements not exceeded by any horizontal, vertical or antidiagonal neighbor in a random 0..2 nX4 array.''. It has offset $1$ and begins
\[
13, 241, 3969, 63309, 1012165, 16187585, 258892017, 4140512637,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 17:37:19, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

Let $R=\{0,\dots,2\}^{4}$ be the set of rows and let the neighbours of a cell be the
...
\]
There are $S=398$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite. Note
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A218229.
