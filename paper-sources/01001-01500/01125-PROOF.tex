...
\title{The empirical recurrence for OEIS A229633, proved by counting defective colourings}
...
\begin{abstract}
OEIS A229633 counts the colourings of an array with $K=3$ colours that are proper except at
...
OEIS A229633 is ``Number of defective 3-colorings of an n X 4 0..2 array connected horizontally, diagonally and antidiagonally with exactly two mistakes, and colors introduced in row-major 0..2 order.''. It has offset $1$ and begins
\[
3, 122, 1109, 10227, 89331, 747299, 6049298, 47723226,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 21*a(n-1) - 159*a(n-2) + 511*a(n-3) - 636*a(n-4) + 336*a(n-5) - 64*a(n-6) for n>9.
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 20 2018 09:19:27, revision 7) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;21\,a(n-1) - 159\,a(n-2) + 511\,a(n-3) - 636\,a(n-4) + 336\,a(n-5) - 64\,a(n-6)
\end{equation}
for all $n>9$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A229633.
