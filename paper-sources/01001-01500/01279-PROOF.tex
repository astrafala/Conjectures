...
\title{The empirical recurrence for OEIS A221465, proved from an exact model}
...
\begin{abstract}
OEIS A221465 carries an empirical recurrence of order $6$. It is true, and it is
...
OEIS A221465 is ``Number of 0..n arrays of length 6 with each element unequal to at least one neighbor, starting with 0.''. It has offset $1$ and begins
\[
5, 88, 513, 1856, 5125, 11880, 24353, 45568,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 1*n\^{}5 + 3*n\^{}4 + 1*n\^{}3.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 05 2018 13:46:25, revision 8)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221465.
