...
\title{The empirical recurrence for OEIS A202080, proved from an exact model}
...
\begin{abstract}
OEIS A202080 carries an empirical recurrence of order $17$. It is true, and it is
...
\[
6, 726, 8412, 80812, 340660, 1516410, 4213042, 12861252,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 09:26:37, revision 9)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A202080.
