...
\title{The empirical recurrence for OEIS A264245, proved by transfer matrix}
...
\begin{abstract}
OEIS A264245 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=2$ columns in which
...
OEIS A264245 is ``Number of (1+1) X (n+1) arrays of permutations of 0..n*2+1 with each element having directed index change 0,0 1,1 0,-1 -1,1 or 0,-2.''. It has offset $1$ and begins
\[
2, 8, 21, 57, 164, 460, 1289, 3629,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + a(n-2) + 4*a(n-3) - a(n-4) - a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 06 2019 10:42:28, revision 10) this is still
...
\[
(i-h_i,\,j-h_j)\;\in\;\{(-2,0),\ (-1,0),\ (0,0),\ (1,-1),\ (1,1)\},
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264245.
