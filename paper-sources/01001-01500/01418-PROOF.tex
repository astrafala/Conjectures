...
\title{The empirical recurrence for OEIS A280175, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A280175 imposes three things at once: a condition on each cell that reaches one row up and
...
OEIS A280175 is ``Number of nX3 0..1 arrays with no element unequal to a strict majority of its horizontal, vertical and antidiagonal neighbors, with the exception of exactly two elements, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
0, 12, 60, 279, 1082, 3931, 13720, 46467,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 28 2016 06:59:34, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;9\,a(n-1) - 24\,a(n-2) - 9\,a(n-3) + 147\,a(n-4) - 213\,a(n-5) - 80\,a(n-6) + 567\,a(n-7) - 624\,a(n-8) - 30\,a(n-9) + 711\,a(n-10) - 687\,a(n-11) + 215\,a(n-12) + 84\,a(n-13) + 3\,a(n-14) - 86\,a(n-15) + 27\,a(n-16) + 6\,a(n-17) - 17\,a(n-18) - 18\,a(n-19) - 6\,a(n-20) - a(n-21)
\end{equation}
for all $n>28$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A280175.
