...
\title{The empirical recurrence for OEIS A218314, proved by transfer matrix}
...
\begin{abstract}
OEIS A218314 counts the distinct indicator arrays obtained from the $n\times3$ arrays over
...
OEIS A218314 is ``Hilltop maps: number of n X 3 binary arrays indicating the locations of corresponding elements not exceeded by any king-move neighbor in a random 0..2 n X 3 array.''. It has offset $1$ and begins
\[
7, 63, 511, 4081, 32641, 261121, 2088919, 16710911,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 7*a(n-1) + 7*a(n-2) + 7*a(n-3) + 7*a(n-4) + 7*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 24 2018 09:39:50, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A218314.
