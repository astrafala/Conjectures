...
\title{The empirical recurrence for OEIS A280549, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A280549 imposes three things at once: a condition on each cell that reaches one row up and
...
OEIS A280549 is ``Number of n X 3 0..1 arrays with no element equal to more than one of its horizontal and vertical neighbors, with the exception of exactly two elements, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
0, 9, 50, 144, 325, 670, 1316, 2502,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 5*a(n-1) - 7*a(n-2) - 2*a(n-3) + 10*a(n-4) - 2*a(n-5) - 5*a(n-6) + a(n-7) + a(n-8) for n>10.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 13 2019 11:33:29, revision 7) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A280549.
