...
\title{The empirical recurrence for OEIS A200434, proved from an exact model}
...
\begin{abstract}
OEIS A200434 carries an empirical recurrence of order $7$. It is true, and it is
...
OEIS A200434 is ``Number of -n..n arrays x(0..6) of 7 elements with zero sum and no two or three adjacent elements summing to zero.''. It has offset $1$ and begins
\[
0, 594, 9898, 67852, 293464, 955602, 2567334, 6003816,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (5887/180)*n\^{}6 - (5813/60)*n\^{}5 + (6083/36)*n\^{}4 - (2191/12)*n\^{}3 + (9119/90)*n\^{}2 - (353/15)*n.
\end{quote}
As of the ``Last modified'' line on the live entry (May 21 2018 08:48:14, revision 9)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A200434.
