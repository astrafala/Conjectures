...
\title{The empirical recurrence for OEIS A279973, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A279973 imposes three things at once: a condition on each cell that reaches one row up and
...
OEIS A279973 is ``Number of nX4 0..1 arrays with no element equal to a strict majority of its horizontal and antidiagonal neighbors, with the exception of exactly two elements, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
3, 24, 221, 1922, 15511, 118857, 876704, 6281773,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 24 2016 08:31:27, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;30\,a(n-1) - 399\,a(n-2) + 3163\,a(n-3) - 17061\,a(n-4) + 67920\,a(n-5) - 210660\,a(n-6) + 527724\,a(n-7) - 1093560\,a(n-8) + 1904479\,a(n-9) - 2816082\,a(n-10) + 3556545\,a(n-11) - 3846177\,a(n-12) + 3560349\,a(n-13) - 2812614\,a(n-14) + 1885732\,a(n-15) - 1064382\,a(n-16) + 500283\,a(n-17) - 192971\,a(n-18) + 59883\,a(n-19) - 14538\,a(n-20) + 2649\,a(n-21) - 339\,a(n-22) + 27\,a(n-23) - a(n-24)
\end{equation}
for all $n>25$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A279973.
