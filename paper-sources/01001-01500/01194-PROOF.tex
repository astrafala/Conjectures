...
\title{Recovering the unwritten recurrences of the table OEIS A251175}
...
\begin{abstract}
OEIS A251175 is a two-dimensional table $T(n,k)$ whose empirical recurrences are, for several of
its lines, given only as an ORDER --- ``k=2: [order 39]'' and the like --- with the
...
OEIS A251175 is ``T(n,k)=Number of (n+1)X(k+1) 0..3 arrays with no 2X2 subblock having the minimum of its diagonal elements less than the absolute difference of its antidiagonal elements.''. It is read by antidiagonals and begins
\[
136, 1192, 1192, 10950, 28598, 10950, 100462, 710438,\ \dots
\]
The entry carries, among its empirical claims:
\begin{quote}\small
k=2: [order 39]
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:09:07, revision 6) these are still
...
\[
(c_1,\dots,c_{39})=(18,\ 207,\ -467,\ -6600,\ -1875,\ 63326,\ 73820,\ -229957,\ -336653,\ 261015,\ 44686,\ -128915,\ 2430445,\ 2129961,\ -3221584,\ -3772828,\ -1458815,\ -1624091,\ 1337778,\ -594676,\ -2421161,\ 4990735,\ 3825613,\ -2837931,\ -1064416,\ 460189,\ -570147,\ -263513,\ 428467,\ 62098,\ -84117,\ 2517,\ 12555,\ -1695,\ -1864,\ 80,\ 142,\ -1,\ -2).
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251175.
