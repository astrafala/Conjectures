...
\title{The empirical recurrence for OEIS A206652, proved by transfer matrix}
...
\begin{abstract}
OEIS A206652 counts $(n+2)\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A206652 is ``Number of (n+2)X3 0..1 arrays with every 3X3 subblock having three equal elements in a row horizontally, vertically or nw-to-se diagonally exactly two ways, and new values 0..1 introduced in row major order.''. It has offset $1$ and begins
\[
102, 390, 1517, 5805, 22346, 86251, 332419, 1281181,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 13:04:04, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-2) + 26\,a(n-3) + 42\,a(n-4) + 33\,a(n-5) - 28\,a(n-6) - 100\,a(n-7) - 102\,a(n-8) - 100\,a(n-9) - 122\,a(n-10) - 266\,a(n-11) - 194\,a(n-12) - 25\,a(n-13) + 279\,a(n-14) + 129\,a(n-15) - 147\,a(n-16) - 429\,a(n-17) - 379\,a(n-18) - 594\,a(n-19) - 576\,a(n-20) - 396\,a(n-21) + 452\,a(n-22) + 1179\,a(n-23) + 660\,a(n-24) + 391\,a(n-25) - 322\,a(n-26) - 54\,a(n-27) + 90\,a(n-28)
\]
for every $n>28$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206652.
