...
\title{The empirical recurrence for OEIS A254703, proved from an exact model}
...
\begin{abstract}
OEIS A254703 carries an empirical recurrence of order $8$. It is true, and it is
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 18 2018 09:24:41, revision 8)
