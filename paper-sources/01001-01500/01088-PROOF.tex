...
\title{The empirical recurrence for OEIS A229536, proved by counting defective colourings}
...
\begin{abstract}
OEIS A229536 counts the colourings of an array with $K=3$ colours that are proper except at
...
OEIS A229536 is ``Number of defective 3-colorings of a 3 X n 0..2 array connected horizontally, diagonally and antidiagonally with exactly one mistake, and colors introduced in row-major 0..2 order.''. It has offset $1$ and begins
\[
0, 20, 58, 361, 1588, 7460, 33136, 146300,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 6*a(n-1) - a(n-2) - 28*a(n-3) - 4*a(n-4) + 16*a(n-5) - 4*a(n-6) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 18 2018 12:55:08, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A229536.
