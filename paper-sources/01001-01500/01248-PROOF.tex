...
\title{The empirical closed form for OEIS A219382, proved}
...
\begin{abstract}
OEIS A219382 states an explicit closed form for $a(n)$ and records it as empirical. It is true, and
...
OEIS A219382 is ``Number of 2 X n arrays of the minimum value of corresponding elements and their horizontal, diagonal or antidiagonal neighbors in a random, but sorted with lexicographically nondecreasing rows and columns, 0..2 2 X n array.''. It has offset $1$ and begins
\[
6, 7, 14, 25, 40, 66, 103, 157,\ \dots
\]
and states:
\begin{quote}
Empirical: a(n) = (1/24)*n\^{}4 - (1/4)*n\^{}3 + (35/24)*n\^{}2 + (15/4)*n - 9 for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 26 2018 05:16:38, revision 10)
...
\begin{theorem}
The closed form OEIS A219382 records is correct for all $n>5$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A219382.
