...
\title{The empirical recurrence for OEIS A200874, proved from an exact model}
...
\begin{abstract}
OEIS A200874 carries an empirical recurrence of order $7$. It is true, and it is
...
OEIS A200874 is ``Number of 0..n arrays x(0..5) of 6 elements without any interior element greater than both neighbors or less than both neighbors.''. It has offset $1$ and begins
\[
26, 163, 602, 1673, 3886, 7973, 14932, 26073,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (1/360)*n\^{}6 + (7/24)*n\^{}5 + (197/72)*n\^{}4 + (185/24)*n\^{}3 + (1667/180)*n\^{}2 + 5*n + 1. a(n) = 7*a(n-1) - 21*a(n-2) + 35*a(n-3) - 35*a(n-4) + 21*a(n-5) - 7*a(n-6) + a(n-7) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 16 2017 10:07:15, revision 10)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A200874.
