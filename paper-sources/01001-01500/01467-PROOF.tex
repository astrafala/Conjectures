...
\title{The empirical recurrence for OEIS A221548, proved by transfer matrix}
...
\begin{abstract}
OEIS A221548 counts the distinct OCCUPANCY arrays obtained when every cell of an $n\times2$ grid
...
OEIS A221548 is ``Number of n X 2 arrays of occupancy after each element moves to some horizontal, vertical or antidiagonal neighbor, without move-in move-out left turns.''. It has offset $1$ and begins
\[
1, 10, 71, 494, 3448, 24055, 167811, 1170709,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 22:58:35, revision 9) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221548.
