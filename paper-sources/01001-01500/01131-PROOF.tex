...
\title{The empirical recurrence for OEIS A221484, proved by transfer matrix}
...
\begin{abstract}
OEIS A221484 counts the distinct OCCUPANCY arrays obtained when every cell of an $n\times2$ grid
...
one, on $S=67$ states, after which the conjectured recurrence is settled by a finite exact
computation.
\end{abstract}
...
OEIS A221484 is ``Number of 2 X n arrays of occupancy after each element moves to some horizontal or antidiagonal neighbor, without consecutive moves in the same direction.''. It has offset $1$ and begins
\[
0, 4, 8, 73, 292, 1713, 8235, 43733,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + 17*a(n-2) + 22*a(n-3) + a(n-4) - 14*a(n-5) - 2*a(n-6) + a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 06 2018 05:33:34, revision 7) this is still
...
$S=67$ reachable sets. In particular $a$ is $C$-finite.
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 17\,a(n-2) + 22\,a(n-3) + a(n-4) - 14\,a(n-5) - 2\,a(n-6) + a(n-7)
\]
for every $n>7$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221484.
