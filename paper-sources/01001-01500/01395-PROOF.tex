...
\title{The empirical recurrence for OEIS A208599, proved from an exact model}
...
\begin{abstract}
OEIS A208599 carries an empirical recurrence of order $5$. It is true, and it is
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 18 2018 15:43:39, revision 12)
