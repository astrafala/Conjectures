...
\title{The empirical closed form for OEIS A219775, proved}
...
\begin{abstract}
OEIS A219775 states an explicit closed form for $a(n)$ and records it as empirical. It is true, and
...
OEIS A219775 is ``Number of 4Xn arrays of the minimum value of corresponding elements and their horizontal or antidiagonal neighbors in a random, but sorted with lexicographically nondecreasing rows and columns, 0..1 4Xn array.''. It has offset $1$ and begins
\[
5, 8, 29, 100, 291, 771, 1887, 4278,\ \dots
\]
and states:
\begin{quote}
Empirical: a(n) = (1/10080)*n\^{}8 + (1/1680)*n\^{}7 - (1/48)*n\^{}6 + (41/120)*n\^{}5 - (571/480)*n\^{}4 - (593/240)*n\^{}3 + (19457/252)*n\^{}2 - (43041/70)*n + 1735 for n>9
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 18:16:38, revision 8)
...
$4\times n$ arrays over that range whose rows are lexicographically nondecreasing read downwards
...
\begin{theorem}
The closed form OEIS A219775 records is correct for all $n>9$.
\end{theorem}
...
$S$ consecutive zeros force every later one. The last index at which it fails is $18$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A219775.
