...
\title{The empirical recurrence for OEIS A221256, proved by transfer matrix}
...
\begin{abstract}
OEIS A221256 counts the distinct OCCUPANCY arrays obtained when every cell of an $n\times2$ grid
...
OEIS A221256 is ``Number of 2 X n arrays of occupancy after each element moves to some horizontal or antidiagonal neighbor, with no occupancy greater than 2.''. It has offset $1$ and begins
\[
0, 4, 8, 81, 392, 2500, 14112, 83521,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 6*a(n-1) + 6*a(n-2) - 42*a(n-3) + 42*a(n-5) - 6*a(n-6) - 6*a(n-7) + a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 04 2018 14:32:54, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) + 6\,a(n-2) - 42\,a(n-3) + 42\,a(n-5) - 6\,a(n-6) - 6\,a(n-7) + a(n-8)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221256.
