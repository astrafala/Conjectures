...
\title{The empirical recurrence for OEIS A269586, proved from an exact model}
...
\begin{abstract}
OEIS A269586 carries an empirical recurrence of order $7$. It is true, and it is
...
\[
64, 659, 3680, 14239, 43184, 110339, 248464, 507935,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = n\^{}6 + 6*n\^{}5 + 9*n\^{}4 + 22*n\^{}3 + 15*n\^{}2 + 12*n - 1. a(n) = 7*a(n-1) - 21*a(n-2) + 35*a(n-3) - 35*a(n-4) + 21*a(n-5) - 7*a(n-6) + a(n-7) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 24 2019 11:45:32, revision 7)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269586.
