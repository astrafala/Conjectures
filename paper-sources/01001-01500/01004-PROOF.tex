...
\title{The empirical recurrence for OEIS A264879, proved by transfer matrix}
...
\begin{abstract}
OEIS A264879 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=3$ columns in which
...
OEIS A264879 is ``Number of (2+1)X(n+1) arrays of permutations of 0..n*3+2 with each element having directed index change 0,1 0,-1 -2,0 or 1,1.''. It has offset $1$ and begins
\[
1, 0, 1, 1, 7, 20, 49, 175,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 27 2015 07:35:30, revision 4) this is still
...
\[
(i-h_i,\,j-h_j)\;\in\;\{(-1,0),\ (0,-2),\ (1,0),\ (1,1)\},
\]
...
\begin{theorem}
\[
a(n)\;=\;10\,a(n-2) + 6\,a(n-3) - 42\,a(n-4) - 40\,a(n-5) + 117\,a(n-6) + 143\,a(n-7) - 222\,a(n-8) - 266\,a(n-9) + 272\,a(n-10) + 266\,a(n-11) - 222\,a(n-12) - 143\,a(n-13) + 117\,a(n-14) + 40\,a(n-15) - 42\,a(n-16) - 6\,a(n-17) + 10\,a(n-18) - a(n-20)
\]
for every $n>18$.
\end{theorem}
...
Second, the transfer model reproduces all $30$ terms this entry publishes, exactly, in
integer arithmetic.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264879.
