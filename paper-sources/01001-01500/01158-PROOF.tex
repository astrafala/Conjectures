...
\title{The empirical recurrence for OEIS A254699, proved by transfer matrix}
...
\begin{abstract}
OEIS A254699 carries an empirical recurrence of order $5$ contributed by R.~H.~Hardin. It is
...
OEIS A254699 is ``Number of length 1+4 0..n arrays with every five consecutive terms having the maximum of some two terms equal to the minimum of the remaining three terms.''. It has offset $1$ and begins
\[
22, 133, 464, 1205, 2606, 4977, 8688, 14169,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (5/2)*n\^{}4 + (20/3)*n\^{}3 + (15/2)*n\^{}2 + (13/3)*n + 1.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 17 2018 09:12:40, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A254699.
