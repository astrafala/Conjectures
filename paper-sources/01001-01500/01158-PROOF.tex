...
\title{The empirical recurrence for OEIS A249709, proved by transfer matrix}
...
\begin{abstract}
OEIS A249709 carries an empirical recurrence of order $6$ contributed by R.~H.~Hardin. It is
...
OEIS A249709 is ``Number of length 3+3 0..n arrays with every four consecutive terms having the maximum of some two terms equal to the minimum of the remaining two terms.''. It has offset $1$ and begins
\[
20, 125, 440, 1153, 2524, 4893, 8688, 14433,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (1/15)*n\^{}5 + 2*n\^{}4 + 7*n\^{}3 + 7*n\^{}2 + (44/15)*n + 1.
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 10 2018 04:40:13, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A249709.
