...
\title{The empirical recurrence for OEIS A230938, proved by transfer matrix}
...
\begin{abstract}
OEIS A230938 counts the white-square subarrays of arrays of width $7$ over $\{0,1,2,3\}$ in which
every cell has a diagonal neighbour one greater than it modulo 4, and none equal to it. The entry carries an empirical recurrence of order $44$ contributed by
...
OEIS A230938 is ``Number of white-square subarrays of (n+2)X(5+2) 0..3 arrays x(i,j) with each element diagonally or antidiagonally next to at least one element with value (x(i,j)+1) mod 4, no adjacent elements equal, and upper left element zero.''. It has offset $1$ and begins
\[
8, 146, 522, 6896, 28216, 396950, 1604098, 22368688,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 06:07:31, revision 6) this is still
...
condition is that every cell has a neighbour one greater than it modulo $4$, and no neighbour equal to it:
\[
\exists\,(a,b)\in S(i,j)\ \ x(a,b)\equiv x(i,j)+1 \!\!\pmod{4},\qquad x(a,b)\neq x(i,j)\ \ \text{for all }(a,b)\in S(i,j).
\]
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=4233.
\]
...
\begin{theorem}
\[
a(n)\;=\;63\,a(n-2) - 257\,a(n-4) - 6639\,a(n-6) + 14476\,a(n-8) + 210885\,a(n-10) + 297473\,a(n-12) - 149746\,a(n-14) + 3509820\,a(n-16) + 15998822\,a(n-18) + 18439507\,a(n-20) - 5600207\,a(n-22) - 23359537\,a(n-24) - 11139145\,a(n-26) + 4160133\,a(n-28) + 3040715\,a(n-30) - 1579065\,a(n-32) - 872680\,a(n-34) + 360423\,a(n-36) + 62740\,a(n-38) - 14788\,a(n-40) + 16\,a(n-42) - 256\,a(n-44)
\]
for every $n>43$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A230938.
