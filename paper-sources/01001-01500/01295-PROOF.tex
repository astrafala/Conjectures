...
\title{The empirical recurrence for OEIS A270510, proved by an exact quasi-polynomial}
...
\begin{abstract}
OEIS A270510 counts triangular arrays of a FIXED shape over the alphabet $0..n$, and carries an
...
OEIS A270510 is ``Number of 2X2X2 triangular 0..n arrays with some element plus some adjacent element totalling n+1 exactly once.''. It has offset $1$ and begins
\[
3, 6, 21, 36, 63, 90,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) -2*a(n-3) +a(n-4)
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 18 2016 08:04:34, revision 4) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A270510.
