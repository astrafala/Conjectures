...
\title{The empirical recurrence for OEIS A231134, proved by transfer matrix}
...
\begin{abstract}
OEIS A231134 counts the black-square subarrays of arrays of width $3$ over $\{0,1,2\}$ in which
...
OEIS A231134 is ``Number of (n+1) X (2+1) black-square subarrays of 0..2 arrays with no element equal to a strict majority of its diagonal and antidiagonal neighbors, with values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
2, 9, 40, 182, 808, 3688, 16368, 74728,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 22*a(n-2) - 36*a(n-4) + 16*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 26 2018 15:43:35, revision 10) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231134.
