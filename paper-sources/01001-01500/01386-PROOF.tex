...
\title{The empirical recurrence for OEIS A183897, proved from an exact model}
...
\begin{abstract}
OEIS A183897 carries an empirical recurrence of order $3$. It is true, and it is
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 05 2018 09:52:28, revision 14)
...
size, so $a$ is a polynomial of degree below $M$ and $(z-1)^{M}$ annihilates it: $S=3$.
