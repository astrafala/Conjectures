...
\title{The empirical recurrence for OEIS A230930, proved by transfer matrix}
...
\begin{abstract}
OEIS A230930 counts the black-square subarrays of arrays of width $5$ over $\{0,1,2,3\}$ in which
every cell has a diagonal neighbour one greater than it modulo 4, and none equal to it. The entry carries an empirical recurrence of order $10$ contributed by
...
OEIS A230930 is ``Number of black-square subarrays of (n+2) X (3+2) 0..3 arrays x(i,j) with each element diagonally or antidiagonally next to at least one element with value (x(i,j)+1) mod 4, no adjacent elements equal, and upper left element zero.''. It has offset $1$ and begins
\[
8, 16, 102, 232, 1682, 3768, 27106, 60824,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 16*a(n-2) + 3*a(n-4) - 10*a(n-6) + 24*a(n-8) - 16*a(n-10).
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 23 2018 09:07:20, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;16\,a(n-2) + 3\,a(n-4) - 10\,a(n-6) + 24\,a(n-8) - 16\,a(n-10)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A230930.
