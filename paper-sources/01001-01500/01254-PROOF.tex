...
\title{The empirical recurrence for OEIS A281328, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A281328 imposes three things at once: a condition on each cell that reaches one column up and
...
numbers. The empirical recurrence of order $36$ contributed by R.~H.~Hardin then follows
...
OEIS A281328 is ``Number of 3 X n 0..2 arrays with no element equal to more than one of its horizontal and antidiagonal neighbors, with the exception of exactly one element, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
0, 28, 1266, 21734, 350818, 5192104, 73653131, 1013236400,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 21 2026 19:41:06, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;22\,a(n-1) - 75\,a(n-2) - 826\,a(n-3) + 2647\,a(n-4) + 12524\,a(n-5) - 31666\,a(n-6) - 101028\,a(n-7) + 172228\,a(n-8) + 478380\,a(n-9) - 327766\,a(n-10) - 1371744\,a(n-11) - 848245\,a(n-12) + 2223326\,a(n-13) + 5363769\,a(n-14) - 723658\,a(n-15) - 9633470\,a(n-16) - 5756578\,a(n-17) + 5497899\,a(n-18) + 13633286\,a(n-19) + 3670518\,a(n-20) - 13409438\,a(n-21) - 7736445\,a(n-22) + 6852658\,a(n-23) + 5255219\,a(n-24) - 1543628\,a(n-25) - 2237348\,a(n-26) - 373776\,a(n-27) + 751904\,a(n-28) + 458560\,a(n-29) - 160320\,a(n-30) - 151296\,a(n-31) + 4608\,a(n-32) + 23552\,a(n-33) + 11264\,a(n-34) - 4096\,a(n-35) - 4096\,a(n-36)
\end{equation}
for all $n>39$.
...
$h_j=G^{j}N^{o}\mathbf{u}$, we have for $j\ge36$
\[
3!\Bigl(a(n_0+j)-\sum_i c_i\,a(n_0+j-i)\Bigr)=\mathbf{v}^{\!\top}G^{\,j-36}w,
...
$36$ applications of $G$ in exact integer arithmetic and $\mathbf{v}^{\!\top}G^{m}w$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A281328.
