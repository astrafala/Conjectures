...
\title{The empirical recurrence for OEIS A241968, proved from an exact model}
...
\begin{abstract}
OEIS A241968 carries an empirical recurrence of order $9$. It is true, and it is
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 31 2018 06:33:23, revision 7)
