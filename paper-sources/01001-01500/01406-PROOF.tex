...
\title{The empirical recurrence for OEIS A241965, proved from an exact model}
...
\begin{abstract}
OEIS A241965 carries an empirical recurrence of order $6$. It is true, and it is
...
\begin{quote}
Empirical: a(n) = (23/60)*n\^{}5 + (9/4)*n\^{}4 + (21/4)*n\^{}3 + (25/4)*n\^{}2 + (58/15)*n + 1. a(n) = 6*a(n-1) - 15*a(n-2) + 20*a(n-3) - 15*a(n-4) + 6*a(n-5) - a(n-6) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 31 2018 05:49:35, revision 7)
