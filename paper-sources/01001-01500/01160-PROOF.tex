...
\title{The empirical recurrence for OEIS A220964, proved by transfer matrix}
...
\begin{abstract}
OEIS A220964 counts the distinct indicator arrays obtained from the $n\times2$ arrays over
...
OEIS A220964 is ``Equals one maps: number of nX2 binary arrays indicating the locations of corresponding elements equal to exactly one of their king-move neighbors in a random 0..2 nX2 array.''. It has offset $1$ and begins
\[
2, 8, 40, 176, 744, 3144, 13128, 54424,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 19:09:55, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) - 3\,a(n-2) - 22\,a(n-3) + 15\,a(n-4) - 36\,a(n-5) + 36\,a(n-6) - 16\,a(n-7) + 4\,a(n-8) - 8\,a(n-9) - 40\,a(n-10) + 32\,a(n-11) + 4\,a(n-12) - 16\,a(n-13)
\]
for every $n>13$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A220964.
