...
\title{The empirical recurrence for OEIS A199901, proved from an exact model}
...
\begin{abstract}
OEIS A199901 carries an empirical recurrence of order $6$. It is true, and it is
...
\begin{quote}
Empirical: a(n) = (11/10)*n\^{}5 + (55/6)*n\^{}4 + (55/2)*n\^{}3 + (173/6)*n\^{}2 + (37/5)*n + 1. a(n) = 6*a(n-1) - 15*a(n-2) + 20*a(n-3) - 15*a(n-4) + 6*a(n-5) - a(n-6) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (May 16 2018 16:29:06, revision 9)
