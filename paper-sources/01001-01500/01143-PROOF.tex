...
\title{The empirical recurrence for OEIS A218892, proved by transfer matrix}
...
\begin{abstract}
OEIS A218892 counts the distinct arrays obtained by applying a fixed local operation to every cell
...
$S=19$ states, after which the conjectured recurrence is settled by a finite exact
computation.
\end{abstract}
...
OEIS A218892 is ``Number of n X 3 arrays of the minimum value of corresponding elements and their horizontal, diagonal or antidiagonal neighbors in a random 0..1 n X 3 array.''. It has offset $1$ and begins
\[
4, 18, 72, 286, 1162, 4700, 19046, 77198,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) + 2*a(n-2) - 5*a(n-3) - 8*a(n-4) - 4*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 24 2018 20:38:35, revision 8) this is still
...
\]
There are $S=19$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite.
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + 2\,a(n-2) - 5\,a(n-3) - 8\,a(n-4) - 4\,a(n-5)
\]
for every $n>5$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A218892.
