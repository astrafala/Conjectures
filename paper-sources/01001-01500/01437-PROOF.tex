...
\title{The empirical recurrence for OEIS A281558, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A281558 imposes three things at once: a condition on each cell that reaches one row up and
...
OEIS A281558 is ``Number of nX3 0..1 arrays with no element equal to more than two of its horizontal, diagonal or antidiagonal neighbors, with the exception of exactly two elements, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
0, 5, 68, 815, 4172, 18020, 62882, 201551,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 24 2017 08:31:37, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) - 12\,a(n-2) + 17\,a(n-3) - 45\,a(n-4) + 60\,a(n-5) - 3\,a(n-6) + 33\,a(n-8) - 255\,a(n-9) + 303\,a(n-10) - 195\,a(n-11) + 105\,a(n-12) + 96\,a(n-13) - 348\,a(n-14) + 644\,a(n-15) - 528\,a(n-16) + 48\,a(n-17) + 304\,a(n-18) - 384\,a(n-19) + 192\,a(n-20) - 64\,a(n-21)
\end{equation}
for all $n>29$.
...
index corresponding to $n=29+1$ onwards, and the run continued until $S+1$ consecutive
zeros had been seen.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A281558.
