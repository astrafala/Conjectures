...
\title{The empirical recurrence for OEIS A218062, proved by transfer matrix}
...
\begin{abstract}
OEIS A218062 counts the distinct arrays obtained by applying a fixed local operation to every cell
...
$S=535$ states, after which the conjectured recurrence is settled by a finite exact
computation.
\end{abstract}
...
OEIS A218062 is ``Number of nX6 arrays of the minimum value of corresponding elements and their horizontal or antidiagonal neighbors in a random 0..1 nX6 array.''. It has offset $1$ and begins
\[
16, 268, 3974, 60804, 925904, 14096488, 214514380, 3263893360,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 17:32:42, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

Let $R=\{0,\dots,1\}^{6}$ be the set of rows and let the neighbours of
...
\]
There are $S=535$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite.
...
\begin{theorem}
\[
a(n)\;=\;26\,a(n-1) - 199\,a(n-2) + 527\,a(n-3) + 257\,a(n-4) - 3086\,a(n-5) + 918\,a(n-6) + 11050\,a(n-7) - 6781\,a(n-8) - 25737\,a(n-9) + 23534\,a(n-10) + 29646\,a(n-11) - 36015\,a(n-12) - 15207\,a(n-13) + 25338\,a(n-14) + 2853\,a(n-15) - 8912\,a(n-16) + 2728\,a(n-17) - 200\,a(n-18) + 36\,a(n-19) - 16\,a(n-20)
\]
for every $n>21$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A218062.
