...
\title{The empirical recurrence for OEIS A250017, proved from an exact model}
...
\begin{abstract}
OEIS A250017 carries an empirical recurrence of order $9$. It is true, and it is
...
OEIS A250017 is ``Number of length 3+5 0..n arrays with no six consecutive terms having the maximum of any three terms equal to the minimum of the remaining three terms.''. It has offset $1$ and begins
\[
20, 912, 13512, 106352, 558588, 2224848, 7259024, 20384352,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = n\^{}8 + (41/35)*n\^{}7 + (56/15)*n\^{}6 + (22/5)*n\^{}5 + (19/3)*n\^{}4 + (17/5)*n\^{}3 - (16/15)*n\^{}2 + (36/35)*n. a(n) = 9*a(n-1) - 36*a(n-2) + 84*a(n-3) - 126*a(n-4) + 126*a(n-5) - 84*a(n-6) + 36*a(n-7) - 9*a(n-8) + a(n-9) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 10 2018 12:44:08, revision 8)
...
$a$ and $S=9$. Nothing is fitted and no threshold is guessed: the $N_m$ are counted, not
estimated.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250017.
