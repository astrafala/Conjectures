...
\title{The empirical recurrence for OEIS A264309, proved by transfer matrix}
...
\begin{abstract}
OEIS A264309 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=5$ rows in which
...
OEIS A264309 is ``Number of (n+1)X(4+1) arrays of permutations of 0..n*5+4 with each element having directed index change 0,0 0,1 1,0 -1,-2 or 0,2.''. It has offset $1$ and begins
\[
52, 735, 11206, 167348, 2495425, 37246076, 555887421, 8296387518,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 11 2015 09:54:38, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;16\,a(n-1) - 15\,a(n-2) - 269\,a(n-4) + 567\,a(n-5) - 632\,a(n-6) + 622\,a(n-7) - 669\,a(n-8) + 1942\,a(n-9) - 5477\,a(n-10) + 10021\,a(n-11) - 10882\,a(n-12) + 10635\,a(n-13) - 9753\,a(n-14) + 6511\,a(n-15) - 4210\,a(n-16) + 2145\,a(n-17) - 946\,a(n-18) + 450\,a(n-19) - 162\,a(n-20) + 27\,a(n-21)
\]
for every $n>20$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264309.
