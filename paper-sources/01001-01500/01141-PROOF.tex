...
\title{The empirical recurrence for OEIS A264417, proved by transfer matrix}
...
\begin{abstract}
OEIS A264417 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=3$ rows in which
...
OEIS A264417 is ``Number of (n+1)X(2+1) arrays of permutations of 0..n*3+2 with each element having directed index change 0,1 2,2 1,0 -1,2 -2,-1 or -1,-1.''. It has offset $1$ and begins
\[
2, 3, 20, 85, 351, 1462, 6021, 25188,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 12 2015 22:57:45, revision 5) this is still
...
Second, the transfer model reproduces all $23$ terms this entry publishes, exactly, in
integer arithmetic.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264417.
