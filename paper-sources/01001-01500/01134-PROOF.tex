...
\title{The empirical recurrence for OEIS A202965, proved from an exact model}
...
\begin{abstract}
OEIS A202965 carries an empirical recurrence of order $11$. It is true, and it is
...
OEIS A202965 is ``Number of arrays of 5 integers in -n..n with sum zero and adjacent elements differing in absolute value.''. It has offset $1$ and begins
\[
2, 82, 414, 1562, 4048, 9010, 17296, 30648,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) -a(n-3) -2*a(n-5) +2*a(n-6) +a(n-8) -2*a(n-10) +a(n-11).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 03 2018 07:57:55, revision 9)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A202965.
