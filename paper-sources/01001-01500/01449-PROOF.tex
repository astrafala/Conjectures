...
\title{The empirical recurrence for OEIS A221777, proved by transfer matrix}
...
\begin{abstract}
OEIS A221777 counts the distinct OCCUPANCY arrays obtained when every cell of an $n\times2$ grid
...
one, on $S=98$ states, after which the conjectured recurrence is settled by a finite exact
computation.
\end{abstract}
...
OEIS A221777 is ``Number of n X 2 arrays of occupancy after each element stays put or moves to some horizontal, diagonal or antidiagonal neighbor, without move-in move-out left turns.''. It has offset $1$ and begins
\[
3, 25, 184, 1367, 10179, 75782, 564169, 4200043,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 8*a(n-1) - 5*a(n-2) + 7*a(n-3) - 4*a(n-4) - a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 14 2018 12:20:55, revision 9) this is still
...
$S=98$ reachable sets. In particular $a$ is $C$-finite.
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-1) - 5\,a(n-2) + 7\,a(n-3) - 4\,a(n-4) - a(n-5)
\]
for every $n>5$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221777.
