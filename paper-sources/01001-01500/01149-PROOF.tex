...
\title{The empirical recurrence for OEIS A246480, proved from an exact model}
...
\begin{abstract}
OEIS A246480 carries an empirical recurrence of order $7$. It is true, and it is
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 06 2018 06:44:52, revision 7)
