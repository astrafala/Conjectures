...
\title{The empirical recurrence for OEIS A228982, proved by transfer matrix}
...
\begin{abstract}
OEIS A228982 counts the distinct arrays obtained by applying a fixed local operation to every cell
of an array over a bounded alphabet, and carries an empirical recurrence of order $35$
...
$S=203$ states, after which the conjectured recurrence is settled by a finite exact
computation.
\end{abstract}
...
OEIS A228982 is ``Number of n X 4 0..1 arrays of the median of the corresponding element, the element to the east and the element to the south in a larger (n+1) X 5 0..1 array.''. It has offset $1$ and begins
\[
16, 252, 3928, 56472, 796568, 11130176, 155031688, 2156604552,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 17 2022 14:38:50, revision 10) this is still
...
\]
There are $S=203$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite.
...
\begin{theorem}
\[
a(n)\;=\;24\,a(n-1) - 158\,a(n-2) + 138\,a(n-3) + 1882\,a(n-4) - 5541\,a(n-5) - 1765\,a(n-6) + 27052\,a(n-7) - 30183\,a(n-8) - 16618\,a(n-9) + 43878\,a(n-10) - 6404\,a(n-11) - 24571\,a(n-12) - 114255\,a(n-13) + 310172\,a(n-14) - 393716\,a(n-15) + 434392\,a(n-16) - 95694\,a(n-17) - 310560\,a(n-18) + 812652\,a(n-19) - 826336\,a(n-20) + 1196502\,a(n-21) - 1064116\,a(n-22) + 1165296\,a(n-23) - 1004064\,a(n-24) - 70272\,a(n-25) - 250304\,a(n-26) - 1624864\,a(n-27) + 1044992\,a(n-28) - 1669888\,a(n-29) + 756544\,a(n-30) - 334784\,a(n-31) + 79104\,a(n-32) + 115200\,a(n-33) - 9216\,a(n-34) + 18432\,a(n-35)
\]
for every $n>36$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A228982.
