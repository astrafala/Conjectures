...
\title{The empirical recurrence for OEIS A282227, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A282227 imposes three things at once: a condition on each cell that reaches one row up and
...
OEIS A282227 is ``Number of nX3 0..2 arrays with no element equal to more than four of its king-move neighbors, with the exception of exactly one element, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
0, 0, 240, 9506, 329630, 10549476, 322266792, 9542402912,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 09 2017 09:32:42, revision 5) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;44\,a(n-1) - 320\,a(n-2) - 3556\,a(n-3) - 10716\,a(n-4) + 50424\,a(n-5) + 405964\,a(n-6) + 817056\,a(n-7) - 2493088\,a(n-8) - 15933280\,a(n-9) - 25854848\,a(n-10) + 44982016\,a(n-11) + 245905088\,a(n-12) + 342215168\,a(n-13) - 181768192\,a(n-14) - 1149643776\,a(n-15) - 1772187648\,a(n-16) - 1392648192\,a(n-17) - 622891008\,a(n-18) - 101744640\,a(n-19) - 5308416\,a(n-20)
\end{equation}
for all $n>21$.
...
\[
3!\Bigl(a(n_0+j)-\sum_i c_i\,a(n_0+j-i)\Bigr)=\mathbf{v}^{\!\top}G^{\,j-20}w,
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A282227.
