...
\title{The empirical recurrence for OEIS A199709, proved from an exact model}
...
\begin{abstract}
OEIS A199709 carries an empirical recurrence of order $22$. It is true, and it is
...
OEIS A199709 is ``Number of -n..n arrays x(0..6) of 7 elements with zero sum and no two neighbors equal.''. It has offset $1$ and begins
\[
56, 2642, 27854, 149942, 559028, 1643204, 4099204, 9059092,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 08:19:01, revision 14)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A199709.
