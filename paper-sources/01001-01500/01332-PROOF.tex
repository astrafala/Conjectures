...
\title{The empirical recurrence for OEIS A217959, proved by transfer matrix}
...
\begin{abstract}
OEIS A217959 counts the distinct arrays obtained by applying a fixed local operation to every cell
...
$S=53$ states, after which the conjectured recurrence is settled by a finite exact
computation.
\end{abstract}
...
OEIS A217959 is ``Number of n X 3 arrays of the minimum value of corresponding elements and their horizontal or antidiagonal neighbors in a random 0..2 n X 3 array.''. It has offset $1$ and begins
\[
9, 91, 835, 7765, 72257, 672627, 6261827, 58295677,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 10*a(n-1) - 4*a(n-2) - 20*a(n-3) - 23*a(n-4) - 10*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2018 13:48:20, revision 7) this is still
...
\]
There are $S=53$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite.
...
\begin{theorem}
\[
a(n)\;=\;10\,a(n-1) - 4\,a(n-2) - 20\,a(n-3) - 23\,a(n-4) - 10\,a(n-5)
\]
for every $n>5$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A217959.
