...
\title{The empirical recurrence for OEIS A250141, proved by transfer matrix}
...
\begin{abstract}
OEIS A250141 carries an empirical recurrence of order $5$ contributed by R.~H.~Hardin. It is
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 12 2018 03:00:45, revision 11) this is still
