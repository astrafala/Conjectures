...
\title{The empirical recurrence for OEIS A250337, proved from an exact model}
...
\begin{abstract}
OEIS A250337 carries an empirical recurrence of order $6$. It is true, and it is
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 12 2018 11:13:11, revision 7)
