...
\title{The empirical recurrence for OEIS A219399, proved by transfer matrix}
...
\begin{abstract}
OEIS A219399 counts the distinct indicator arrays obtained from the $n\times4$ arrays over
$\{0,\dots,1\}$ by marking the cells whose value is equal to every one of their neighbours, and carries an
...
indicator row by row turns it into one, on $S=47$ states, after which the conjectured
...
OEIS A219399 is ``Unchanging value maps: number of nX4 binary arrays indicating the locations of corresponding elements unequal to no king-move neighbor in a random 0..1 nX4 array.''. It has offset $1$ and begins
\[
7, 7, 43, 165, 649, 2527, 10011, 39787,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 18:01:31, revision 8) this is still
...
\]
There are $S=47$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite. Note
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) - 7\,a(n-2) + 8\,a(n-3) + 19\,a(n-4) - 19\,a(n-5) - 17\,a(n-6) + 26\,a(n-7) - 13\,a(n-8) - 41\,a(n-9) - 11\,a(n-10) - 14\,a(n-11) + 18\,a(n-12) + 45\,a(n-13) - 11\,a(n-14) - 36\,a(n-15) + 8\,a(n-16) + 17\,a(n-17) - 5\,a(n-18) - 5\,a(n-19) + 2\,a(n-20)
\]
for every $n>21$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A219399.
