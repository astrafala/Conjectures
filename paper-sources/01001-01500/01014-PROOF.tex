...
\title{The empirical recurrence for OEIS A280119, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A280119 imposes three things at once: a condition on each cell that reaches one row up and
...
OEIS A280119 is ``Number of nX3 0..2 arrays with no element unequal to a strict majority of its horizontal, vertical and antidiagonal neighbors, with the exception of exactly one element, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
2, 8, 37, 168, 705, 2852, 11249, 44120,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 26 2016 07:53:51, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) + a(n-2) - 52\,a(n-3) + 51\,a(n-4) + 78\,a(n-5) - 173\,a(n-6) + 136\,a(n-7) + 17\,a(n-8) - 38\,a(n-9) - 49\,a(n-10) + 32\,a(n-11) - 24\,a(n-12) - 32\,a(n-13) - 16\,a(n-14)
\end{equation}
for all $n>19$.
...
\[
3!\Bigl(a(n_0+j)-\sum_i c_i\,a(n_0+j-i)\Bigr)=\mathbf{v}^{\!\top}G^{\,j-14}w,
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A280119.
