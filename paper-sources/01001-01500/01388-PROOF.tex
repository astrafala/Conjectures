...
\title{The empirical recurrence for OEIS A200887, proved from an exact model}
...
\begin{abstract}
OEIS A200887 carries an empirical recurrence of order $5$. It is true, and it is
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 16 2017 09:57:36, revision 10)
