...
\title{The empirical recurrence for OEIS A219151, proved by transfer matrix}
...
\begin{abstract}
OEIS A219151 counts the distinct indicator arrays obtained from the $n\times3$ arrays over
...
indicator row by row turns it into one, on $S=24$ states, after which the conjectured
...
OEIS A219151 is ``Unchanging value maps: number of n X 3 binary arrays indicating the locations of corresponding elements unequal to no horizontal, antidiagonal or vertical neighbor in a random 0..1 n X 3 array.''. It has offset $1$ and begins
\[
4, 9, 32, 104, 360, 1234, 4224, 14421,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) - 6*a(n-2) + 14*a(n-3) - 2*a(n-4) + a(n-5) + 11*a(n-6) - 9*a(n-7) + 6*a(n-8) - 3*a(n-9) - 4*a(n-10).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 25 2018 08:06:00, revision 7) this is still
...
\]
There are $S=24$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite. Note
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) - 6\,a(n-2) + 14\,a(n-3) - 2\,a(n-4) + a(n-5) + 11\,a(n-6) - 9\,a(n-7) + 6\,a(n-8) - 3\,a(n-9) - 4\,a(n-10)
\]
for every $n>10$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A219151.
