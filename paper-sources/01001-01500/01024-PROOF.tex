...
\title{The empirical recurrence for OEIS A241621, proved from an exact model}
...
\begin{abstract}
OEIS A241621 carries an empirical recurrence of order $9$. It is true, and it is
...
OEIS A241621 is ``Number of length 6+2 0..n arrays with no consecutive three elements summing to more than n.''. It has offset $1$ and begins
\[
28, 287, 1730, 7483, 25774, 75180, 193194, 449295,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 30 2018 12:52:33, revision 8)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A241621.
