...
\title{The empirical recurrence for OEIS A200840, proved from an exact model}
...
\begin{abstract}
OEIS A200840 carries an empirical recurrence of order $6$. It is true, and it is
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 08:49:18, revision 11)
