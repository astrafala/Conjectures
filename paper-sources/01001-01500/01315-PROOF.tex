...
\title{The empirical recurrence for OEIS A218837, proved by transfer matrix}
...
\begin{abstract}
OEIS A218837 counts the distinct indicator arrays obtained from the $n\times3$ arrays over
...
indicator row by row turns it into one, on $S=11$ states, after which the conjectured
...
OEIS A218837 is ``Unmatched value maps: number of n X 3 binary arrays indicating the locations of corresponding elements not equal to any horizontal or antidiagonal neighbor in a random 0..1 n X 3 array.''. It has offset $1$ and begins
\[
4, 20, 93, 436, 2043, 9573, 44857, 210190,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) + 3*a(n-2) + a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 10 2018 07:15:12, revision 8) this is still
...
\]
There are $S=11$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite. Note
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A218837.
