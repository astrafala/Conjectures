...
\title{The empirical recurrence for OEIS A240286, proved by transfer matrix}
...
\begin{abstract}
OEIS A240286 counts arrays over $\{0,1,2,3\}$ in which no entry may equal, modulo $4$, a given
constant plus the SUM of all the entries lying before it along one of several rays. The entry
carries an empirical recurrence of order $48$ contributed by R.~H.~Hardin. It is true, and
...
count is then a walk count on $S=148$ states.
\end{abstract}
...
OEIS A240286 is ``Number of 3Xn 0..3 arrays with no element equal to one plus the sum of elements to its left or two plus the sum of the elements above it or zero plus the sum of the elements diagonally to its northwest, modulo 4.''. It has offset $1$ and begins
\[
3, 19, 80, 570, 2574, 20764, 97348, 802835,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 09:46:48, revision 6) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=148.
\]
...
\begin{theorem}
\[
a(n)\;=\;63\,a(n-2) - 1109\,a(n-4) + 7143\,a(n-6) - 395\,a(n-8) - 201246\,a(n-10) + 762860\,a(n-12) + 347011\,a(n-14) - 7366154\,a(n-16) + 11744674\,a(n-18) + 3758987\,a(n-20) + 10095295\,a(n-22) - 126415852\,a(n-24) + 204390541\,a(n-26) - 65238786\,a(n-28) - 59211883\,a(n-30) - 114625640\,a(n-32) + 381020006\,a(n-34) - 342073760\,a(n-36) + 16725276\,a(n-38) + 181283664\,a(n-40) - 110895680\,a(n-42) + 16492080\,a(n-44) + 1175136\,a(n-46) + 390464\,a(n-48)
\]
for every $n>51$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A240286.
