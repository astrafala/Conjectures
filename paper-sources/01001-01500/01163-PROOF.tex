...
\title{The empirical recurrence for OEIS A264629, proved by transfer matrix}
...
\begin{abstract}
OEIS A264629 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=3$ columns in which
...
OEIS A264629 is ``Number of (2+1) X (n+1) arrays of permutations of 0..n*3+2 with each element having directed index change -2,0 -1,0 0,-1 or 1,1.''. It has offset $1$ and begins
\[
1, 2, 4, 9, 16, 37, 76, 160,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + 2*a(n-5) - 2*a(n-6) + 4*a(n-7) - a(n-10).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 08 2019 15:11:19, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264629.
