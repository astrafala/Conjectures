...
\title{The empirical closed form for OEIS A220205, proved}
...
\begin{abstract}
OEIS A220205 states an explicit closed form for $a(n)$ and records it as empirical. It is true, and
...
OEIS A220205 is ``Number of 2 X n arrays of the minimum value of corresponding elements and their horizontal, vertical or diagonal neighbors in a random, but sorted with lexicographically nondecreasing rows and nonincreasing columns, 0..3 2 X n array.''. It has offset $1$ and begins
\[
4, 10, 36, 89, 182, 333, 567, 918,\ \dots
\]
and states:
\begin{quote}
Empirical: a(n) = (1/60)*n\^{}5 - (1/8)*n\^{}4 + (11/6)*n\^{}3 - (7/8)*n\^{}2 + (3/20)*n for n>1.
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 31 2018 07:22:37, revision 7)
...
\begin{theorem}
The closed form OEIS A220205 records is correct for all $n>1$.
\end{theorem}
...
$S$ consecutive zeros force every later one. The last index at which it fails is $7$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A220205.
