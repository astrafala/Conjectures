...
\title{The cross-base identity for OEIS A126539, proved}
...
\begin{abstract}
OEIS A126539 carries an empirical identity, in two clauses, relating its counts to those of the
...
OEIS A126539 is ``Number of base 18 n-digit numbers with adjacent digits differing by five or less.''. It has offset $0$ and begins
\[
1, 18, 168, 1628, 15938, 156652, 1541646, 15178334,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2026 19:17:55, revision 15)
this is still recorded as empirical, and nothing on the entry records it as proved.

For this entry the base is $18$ and the permitted difference is $d=5$, so the first clause
claims $a_{18}(n)-a_{17}(n)=11^{\,n-1}$ whenever $5(n-1)+1\le18$, that is for
$1\le n\le4$, and the second claims $a_{18}(n)-a_{17}(n)=11^{\,n-1}-2$ at the single
$n$ with $5(n-1)=18$.
...
arithmetic, $L_{5}$ at base $18$ reproduces all $18$ terms A126539 publishes.
...
First, the model reproduces all $18$ terms A126539 publishes, exactly, in integer
...
\begin{center}
\begin{tabular}{rrrr}
$n$ & $L_{5}(18,n)$ & $L_{5}(17,n)$ & $11^{\,n-1}$ \\ \hline
1 & 18 & 17 & 1 \\
2 & 168 & 157 & 11 \\
3 & 1628 & 1507 & 121 \\
4 & 15938 & 14607 & 1331 \\
