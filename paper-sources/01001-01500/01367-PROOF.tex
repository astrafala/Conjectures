...
\title{The empirical recurrence for OEIS A198622, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A198622 counts arrays in which every cell is constrained by its neighbours on \emph{both}
...
$6!\,a(n)=\sum_i\binom{6}{i}D_{6-i}L_i(n)$ with $D_m$ the derangement numbers and
...
lumpable, cutting $67171$ pairs down to $S=747$ states. The entry's empirical recurrence of
order $54$, contributed by R.~H.~Hardin, then follows from a finite exact computation.
\end{abstract}
...
OEIS A198622 is ``Number of nX3 0..5 arrays with values 0..5 introduced in row major order and each element equal to at least one horizontal or vertical neighbor.''. It has offset $1$ and begins
\[
1, 14, 185, 3904, 98330, 3003238, 102181788, 3756159287,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 07:56:37, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;56\,a(n-1) - 242\,a(n-2) - 19881\,a(n-3) + 120902\,a(n-4) + 2112477\,a(n-5) - 6256525\,a(n-6) - 101767298\,a(n-7) - 5468008\,a(n-8) + 2257760921\,a(n-9) + 5511348504\,a(n-10) - 17561720854\,a(n-11) - 103692545247\,a(n-12) - 60746908311\,a(n-13) + 712406449678\,a(n-14) + 1810526971885\,a(n-15) - 935776136224\,a(n-16) - 11174744312766\,a(n-17) - 14176630199333\,a(n-18) + 23636831875616\,a(n-19) + 88324427447726\,a(n-20) + 49461877521458\,a(n-21) - 194580674524516\,a(n-22) - 394749803665092\,a(n-23) - 43750123538823\,a(n-24) + 834612247143814\,a(n-25) + 1120498973762742\,a(n-26) - 260260207784843\,a(n-27) - 2332700905156438\,a(n-28) - 2195467410288443\,a(n-29) + 1363858632829917\,a(n-30) + 5047559929957346\,a(n-31) + 3496200778786576\,a(n-32) - 3866700158460727\,a(n-33) - 8482902906392220\,a(n-34) - 3615459462374434\,a(n-35) + 6702588538914563\,a(n-36) + 10398070155253321\,a(n-37) + 822587148343118\,a(n-38) - 8696663320634001\,a(n-39) - 6092253427570816\,a(n-40) + 1959554757727956\,a(n-41) + 6051088905373429\,a(n-42) + 994119275897256\,a(n-43) - 2259128912126806\,a(n-44) - 1053519679785884\,a(n-45) + 136416475608456\,a(n-46) + 571399798005636\,a(n-47) - 182004404229116\,a(n-48) - 12355456901400\,a(n-49) + 86305990184544\,a(n-50) - 45657449449760\,a(n-51) + 6952728447120\,a(n-52) - 1117686283968\,a(n-53) - 26923343040\,a(n-54)
\end{equation}
for all $n>55$.
...
class, so with $K=6$ available values the entry counts admissible patterns with at most $K$
classes.
...
\[
6!\,\sum_{j\le 6}N_j(n)\;=\;\sum_{i=0}^{6}\binom{6}{i}D_{6-i}\,L_i(n),
...
$j!N_j=\sum_i(-1)^{j-i}\binom{j}{i}L_i$. Summing over $j\le6$ and exchanging the
order of summation, the coefficient of $L_i$ is
$\sum_{t\le6-i}(-1)^t/(i!\,t!)$, which multiplied by $6!$ is
$\binom{6}{i}(6-i)!\sum_{t\le6-i}(-1)^t/t!=\binom{6}{i}D_{6-i}$.
\end{proof}
...
Assembling the $6$ lumped chains block-diagonally into $N$ of size $S=747$, with the
...
6!\;a(n)\;=\;\mathbf{v}^{\!\top}N^{\,L-2}\mathbf{u},\qquad L=n .
\end{equation}
...
index,
\[
6!\Bigl(a(n)-\sum_i c_i\,a(n-i)\Bigr)\;=\;\mathbf{v}^{\!\top}G^{\,j-54}\,
\Bigl(h_{54}-\sum_i c_i h_{54-i}\Bigr)
\]
...
$w=h_{54}-\sum_i c_ih_{54-i}$; and it is enough to check $m=0,1,\dots,S-1$.
\end{lemma}

\begin{proof}
Substitute \eqref{eq:walk2} and factor. The scalar $6!$ is nonzero, so it does not
...
$54$ applications of $G$ in exact integer arithmetic and $\mathbf{v}^{\!\top}G^{m}w$
evaluated for $m=0,1,\dots$, again exactly. Every one of those integers vanishes from the
index corresponding to $n=55+1$ onwards, and the run was continued until $S+1$
...
\eqref{eq:walk2}, divided by $6!$, was evaluated at every one of the $16$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A198622.
