...
\title{The empirical recurrence for OEIS A269468, proved from an exact model}
...
\begin{abstract}
OEIS A269468 carries an empirical recurrence of order $5$. It is true, and it is
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 23 2019 07:18:35, revision 7)
