...
\title{Recovering the unwritten recurrences of the table OEIS A237463}
...
\begin{abstract}
OEIS A237463 is a two-dimensional table $T(n,k)$ whose empirical recurrences are, for several of
...
OEIS A237463 is ``T(n,k)=Number of (n+1)X(k+1) 0..2 arrays with the maximum plus the lower median of every 2X2 subblock differing from its horizontal and vertical neighbors by exactly one.''. It is read by antidiagonals and begins
\[
81, 308, 308, 1144, 1376, 1144, 4272, 5938,\ \dots
\]
The entry carries, among its empirical claims:
\begin{quote}\small
k=2: [order 19]
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 10:10:46, revision 6) these are still
...
count, a walk on $S=308$ vertices. Berlekamp--Massey on $2S=616$ exact terms
returns a minimal recurrence of order $19$ --- the order the entry states --- with
integer coefficients
\begin{center}\small\begin{tabular}{cccccccc}
$c_{1}$ & $0$ & $c_{6}$ & $282$ & $c_{11}$ & $13908$ & $c_{16}$ & $-7392$ \\
$c_{2}$ & $0$ & $c_{7}$ & $-973$ & $c_{12}$ & $5602$ & $c_{17}$ & $-13696$ \\
$c_{3}$ & $34$ & $c_{8}$ & $-4066$ & $c_{13}$ & $-22988$ & $c_{18}$ & $4608$ \\
$c_{4}$ & $172$ & $c_{9}$ & $-3238$ & $c_{14}$ & $-3264$ & $c_{19}$ & $4096$ \\
$c_{5}$ & $254$ & $c_{10}$ & $3634$ & $c_{15}$ & $22488$ &  &  \\
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237463.
