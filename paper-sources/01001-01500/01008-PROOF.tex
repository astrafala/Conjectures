...
\title{The empirical recurrence for OEIS A221059, proved by transfer matrix}
...
\begin{abstract}
OEIS A221059 counts the distinct indicator arrays obtained from the $n\times3$ arrays over
...
OEIS A221059 is ``Equals one maps: number of n X 3 binary arrays indicating the locations of corresponding elements equal to exactly one of their horizontal and antidiagonal neighbors in a random 0..3 n X 3 array.''. It has offset $1$ and begins
\[
4, 37, 323, 2735, 22683, 185563, 1503659, 12103019,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 11*a(n-1) - 10*a(n-2) - 104*a(n-3) - 80*a(n-4) - 8*a(n-5) - 32*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 13 2018 16:39:31, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;11\,a(n-1) - 10\,a(n-2) - 104\,a(n-3) - 80\,a(n-4) - 8\,a(n-5) - 32\,a(n-6)
\]
for every $n>6$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221059.
