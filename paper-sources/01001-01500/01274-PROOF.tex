...
\title{The empirical recurrence for OEIS A249711, proved from an exact model}
...
\begin{abstract}
OEIS A249711 carries an empirical recurrence of order $6$. It is true, and it is
...
OEIS A249711 is ``Number of length 5+3 0..n arrays with every four consecutive terms having the maximum of some two terms equal to the minimum of the remaining two terms.''. It has offset $1$ and begins
\[
38, 377, 1724, 5425, 13666, 29673, 57912, 104289,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (5/3)*n\^{}5 + 10*n\^{}4 + 16*n\^{}3 + 8*n\^{}2 + (4/3)*n + 1.
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 10 2018 04:40:17, revision 8)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A249711.
