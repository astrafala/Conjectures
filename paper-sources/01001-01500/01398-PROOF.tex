...
\title{The empirical recurrence for OEIS A230931, proved by transfer matrix}
...
\begin{abstract}
OEIS A230931 counts the black-square subarrays of arrays of width $6$ over $\{0,1,2,3\}$ in which
every cell has a diagonal neighbour one greater than it modulo 4, and none equal to it. The entry carries an empirical recurrence of order $17$ contributed by
...
OEIS A230931 is ``Number of black-square subarrays of (n+2) X (4+2) 0..3 arrays x(i,j) with each element diagonally or antidiagonally next to at least one element with value (x(i,j)+1) mod 4, no adjacent elements equal, and upper left element zero.''. It has offset $1$ and begins
\[
8, 48, 232, 1242, 6896, 37984, 208172, 1142054,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 12 2025 20:47:33, revision 8) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=1401.
\]
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) + a(n-2) + 11\,a(n-3) - a(n-4) - 33\,a(n-5) - 82\,a(n-6) + a(n-7) - 33\,a(n-8) + 71\,a(n-9) + 125\,a(n-10) + 117\,a(n-11) + 140\,a(n-12) + 66\,a(n-13) + 35\,a(n-14) + 2\,a(n-15) - 4\,a(n-16) - 4\,a(n-17)
\]
for every $n>16$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A230931.
