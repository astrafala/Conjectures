...
\title{Recovering the unwritten recurrences of the table OEIS A232431}
...
\begin{abstract}
OEIS A232431 is a two-dimensional table $T(n,k)$ whose empirical recurrences are, for several of
its lines, given only as an ORDER --- ``k=2: [order 21]'' and the like --- with the
...
OEIS A232431 is ``T(n,k)=Number of (n+1)X(k+1) 0..2 arrays with every element next to itself plus and minus one within the range 0..2 horizontally or vertically.''. It is read by antidiagonals and begins
\[
4, 16, 16, 64, 192, 64, 240, 1632,\ \dots
\]
The entry carries, among its empirical claims:
\begin{quote}\small
k=2: [order 21]
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 07:26:50, revision 6) these are still
...
$c_{1}$ & $5$ & $c_{7}$ & $-19491$ & $c_{13}$ & $1239102$ & $c_{19}$ & $-1454080$ \\
$c_{2}$ & $14$ & $c_{8}$ & $50600$ & $c_{14}$ & $-2382756$ & $c_{20}$ & $-884736$ \\
$c_{3}$ & $177$ & $c_{9}$ & $-46439$ & $c_{15}$ & $350424$ & $c_{21}$ & $262144$ \\
$c_{4}$ & $593$ & $c_{10}$ & $-300305$ & $c_{16}$ & $2450976$ &  &  \\
$c_{5}$ & $-762$ & $c_{11}$ & $356396$ & $c_{17}$ & $-5740800$ &  &  \\
$c_{6}$ & $-9725$ & $c_{12}$ & $708476$ & $c_{18}$ & $1144832$ &  &  \\
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232431.
