...
\title{The empirical recurrence for OEIS A221201, proved by transfer matrix}
...
\begin{abstract}
OEIS A221201 counts the distinct OCCUPANCY arrays obtained when every cell of an $n\times2$ grid
...
OEIS A221201 is ``Number of 2 X n arrays of occupancy after each element moves to some horizontal, diagonal or antidiagonal neighbor, with no occupancy greater than 2.''. It has offset $1$ and begins
\[
0, 9, 10, 196, 720, 6400, 34272, 242064,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 7*a(n-1) + 14*a(n-2) - 126*a(n-3) + 504*a(n-5) - 224*a(n-6) - 448*a(n-7) + 256*a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 04 2018 10:35:10, revision 10) this is still
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-1) + 14\,a(n-2) - 126\,a(n-3) + 504\,a(n-5) - 224\,a(n-6) - 448\,a(n-7) + 256\,a(n-8)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221201.
