...
\title{The empirical recurrence for OEIS A229640, proved by counting defective colourings}
...
\begin{abstract}
OEIS A229640 counts the colourings of an array with $K=3$ colours that are proper except at
...
OEIS A229640 is ``Number of defective 3-colorings of a 4 X n 0..2 array connected horizontally, diagonally and antidiagonally with exactly two mistakes, and colors introduced in row-major 0..2 order.''. It has offset $1$ and begins
\[
0, 202, 1496, 10227, 77620, 535671, 3723370, 25022190,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 28 2021 01:23:00, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;9\,a(n-1) + 21\,a(n-2) - 270\,a(n-3) - 357\,a(n-4) + 2967\,a(n-5) + 4906\,a(n-6) - 10083\,a(n-7) - 18957\,a(n-8) + 15750\,a(n-9) + 31293\,a(n-10) - 13335\,a(n-11) - 23929\,a(n-12) + 6426\,a(n-13) + 7824\,a(n-14) - 1336\,a(n-15) - 1152\,a(n-16) + 96\,a(n-17) + 64\,a(n-18)
\end{equation}
for all $n>21$.

\section{Mistakes, and the colour clause}

The arrays have $4$ rows and $L=n$ columns, entries in $\{0,\dots,3-1\}$.
...
Fix $i$ and take as vertices the pairs $(r,c)$ with $r\in\{0,\dots,i-1\}^{4}$ a column
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A229640.
