...
\title{The empirical recurrence for OEIS A208826, proved from an exact model}
...
\begin{abstract}
OEIS A208826 carries an empirical recurrence of order $7$. It is true, and it is
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 06 2018 17:11:59, revision 11)
...
over the group's elements annihilates $a$: $S=36$.
