...
\title{The empirical recurrence for OEIS A200255, proved from an exact model}
...
\begin{abstract}
OEIS A200255 carries an empirical recurrence of order $48$. It is true, and it is
decidable rather than empirical. The entry's sequence is given exactly by an Ehrhart quasi-polynomial, from
which $a$ provably satisfies a MONIC linear recurrence of order $S=113$, derived below and not
...
OEIS A200255 is ``Number of 0..n arrays x(0..5) of 6 elements with each no smaller than the sum of its previous elements modulo (n+1).''. It has offset $1$ and begins
\[
21, 96, 476, 1215, 3387, 7168, 15724, 28125,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 08:32:37, revision 9)
...
\]
annihilates $a$, and $S=\deg A=113$. A congruence condition modulo $m$ is counted one residue
...
exactly $\deg A$. The bound in force is therefore $zA(z)$, of order $S=113$, and
...
$q(z)=z^{48}-\sum_ic_iz^{48-i}$ the characteristic polynomial of the conjectured
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) - 2\,a(n-3) + 2\,a(n-4) - 2\,a(n-5) + 2\,a(n-7) - 2\,a(n-9) + 2\,a(n-11) - 2\,a(n-12) + 2\,a(n-13) - 2\,a(n-15) + 3\,a(n-16) - 4\,a(n-17) + 4\,a(n-19) - 4\,a(n-20) + 4\,a(n-21) - 4\,a(n-23) + 4\,a(n-25) - 4\,a(n-27) + 4\,a(n-28) - 4\,a(n-29) + 4\,a(n-31) - 3\,a(n-32) + 2\,a(n-33) - 2\,a(n-35) + 2\,a(n-36) - 2\,a(n-37) + 2\,a(n-39) - 2\,a(n-41) + 2\,a(n-43) - 2\,a(n-44) + 2\,a(n-45) - 2\,a(n-47) + a(n-48)
\]
for every $n>0$.
\end{theorem}
...
vanish from $n=0+1$ onwards, and the run exceeds $S+48$, which by
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A200255.
