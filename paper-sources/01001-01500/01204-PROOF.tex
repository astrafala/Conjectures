...
\title{Recovering the unwritten recurrences of the table OEIS A237898}
...
\begin{abstract}
OEIS A237898 is a two-dimensional table $T(n,k)$ whose empirical recurrences are, for several of
its lines, given only as an ORDER --- ``k=2: [order 47]'' and the like --- with the
...
OEIS A237898 is ``T(n,k)=Number of (n+1)X(k+1) 0..3 arrays with the maximum minus the upper median of every 2X2 subblock equal.''. It is read by antidiagonals and begins
\[
256, 1848, 1848, 13600, 32404, 13600, 103536, 563534,\ \dots
\]
The entry carries, among its empirical claims:
\begin{quote}\small
k=2: [order 47]
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 10:33:22, revision 6) these are still
...
count, a walk on $S=156$ vertices. Berlekamp--Massey on $2S=312$ exact terms
returns a minimal recurrence of order $47$ --- the order the entry states --- with
integer coefficients
\[
(c_1,\dots,c_{47})=(62,\ -1145,\ -4015,\ 383852,\ -3680952,\ -18457082,\ 503621981,\ -1580676045,\ -22629861466,\ 171994178529,\ 263617129716,\ -6306561400978,\ 10021246907709,\ 113941299484248,\ -412840967285495,\ -1008101938004709,\ 6855228218809292,\ 1765336887356429,\ -65453666549209182,\ 53041024469186198,\ 393978040473440396,\ -613415506563754210,\ -1541096290052114160,\ 3533599971915524892,\ 3870239213375413728,\ -12963297094512860560,\ -5664955966438169584,\ 32606571649242881176,\ 2480623385975901888,\ -58069250056462812896,\ 7480870294724021696,\ 74343569053176476352,\ -17190455248457969728,\ -68838813140007288448,\ 17327891704624158208,\ 46033268683623180160,\ -9156565597849079296,\ -21896440409678540800,\ 1835674733797232128,\ 7040621509842425856,\ 507462521605609472,\ -1320567482265907200,\ -333297172917915648,\ 82634458145882112,\ 48168713329459200,\ 7655936741867520,\ 419046624460800).
\]
so that $a(m)=\sum_{i=1}^{47}c_i\,a(m-i)$ for every $m$. Removing the first
$47+4$ terms and repeating gives order $47$ again, which is what the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237898.
