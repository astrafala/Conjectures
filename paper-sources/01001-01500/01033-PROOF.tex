...
\title{The empirical recurrence for OEIS A221357, proved by transfer matrix}
...
\begin{abstract}
OEIS A221357 counts the distinct OCCUPANCY arrays obtained when every cell of an $n\times2$ grid
...
OEIS A221357 is ``Number of n X 2 arrays of occupancy after each element moves to some horizontal, vertical or antidiagonal neighbor, with no 2-loops and with no occupancy greater than 2.''. It has offset $1$ and begins
\[
0, 5, 39, 292, 2088, 14799, 104532, 737498,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 12*a(n-1) - 38*a(n-2) + 14*a(n-3) + 59*a(n-4) - 21*a(n-5) - 33*a(n-6) + 16*a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 05 2018 08:21:35, revision 10) this is still
...
\begin{theorem}
\[
a(n)\;=\;12\,a(n-1) - 38\,a(n-2) + 14\,a(n-3) + 59\,a(n-4) - 21\,a(n-5) - 33\,a(n-6) + 16\,a(n-7)
\]
for every $n>7$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221357.
