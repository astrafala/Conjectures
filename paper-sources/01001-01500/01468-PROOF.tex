...
\title{The empirical closed form for OEIS A219349, proved}
...
\begin{abstract}
OEIS A219349 states an explicit closed form for $a(n)$ and records it as empirical. It is true, and
...
OEIS A219349 is ``Number of n X 3 arrays of the minimum value of corresponding elements and their horizontal, vertical, diagonal or antidiagonal neighbors in a random, but sorted with lexicographically nondecreasing rows and columns, 0..1 n X 3 array.''. It has offset $1$ and begins
\[
3, 3, 8, 15, 27, 46, 76, 122,\ \dots
\]
and states:
\begin{quote}
Empirical: a(n) = (1/24)*n\^{}4 - (1/4)*n\^{}3 + (23/24)*n\^{}2 + (13/4)*n - 8 for n > 3.
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 26 2018 06:34:54, revision 14)
...
\begin{theorem}
The closed form OEIS A219349 records is correct for all $n>3$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A219349.
