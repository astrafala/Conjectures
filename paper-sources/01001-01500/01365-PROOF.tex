...
\title{The empirical recurrence for OEIS A220933, proved by transfer matrix}
...
\begin{abstract}
OEIS A220933 counts the distinct indicator arrays obtained from the $n\times4$ arrays over
...
indicator row by row turns it into one, on $S=298$ states, after which the conjectured
...
OEIS A220933 is ``Equals two maps: number of nX4 binary arrays indicating the locations of corresponding elements equal to exactly two of their horizontal and antidiagonal neighbors in a random 0..2 nX4 array.''. It has offset $1$ and begins
\[
4, 52, 673, 9107, 123958, 1686304, 22931365, 311813067,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 19:08:15, revision 8) this is still
...
\]
There are $S=298$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite. Note
...
\begin{theorem}
\[
a(n)\;=\;28\,a(n-1) - 296\,a(n-2) + 1804\,a(n-3) - 7384\,a(n-4) + 21847\,a(n-5) - 48816\,a(n-6) + 85558\,a(n-7) - 123954\,a(n-8) + 160701\,a(n-9) - 200185\,a(n-10) + 236867\,a(n-11) - 248056\,a(n-12) + 226758\,a(n-13) - 197374\,a(n-14) + 171224\,a(n-15) - 136118\,a(n-16) + 103073\,a(n-17) - 90758\,a(n-18) + 83397\,a(n-19) - 61987\,a(n-20) + 38070\,a(n-21) - 26150\,a(n-22) + 15689\,a(n-23) - 3389\,a(n-24) - 92\,a(n-25) - 312\,a(n-26) + 112\,a(n-27) - 16\,a(n-28)
\]
for every $n>28$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A220933.
