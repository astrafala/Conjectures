...
\title{The empirical closed form for OEIS A241969, proved from an exact model}
...
\begin{abstract}
OEIS A241969 carries an empirical closed form: a polynomial in $n$ of degree $9$, recorded on the
entry and never marked settled. It is true. The entry's count is given exactly by an Ehrhart
quasi-polynomial, from which $a$ provably satisfies a monic linear recurrence of order $S=11$
derived below; a polynomial of degree $9$ satisfies $(z-1)^{9+1}$; so the difference
satisfies the product, and $11+9+1$ consecutive agreements settle it. No transfer matrix is
...
OEIS A241969 is ``Number of length 6+3 0..n arrays with no consecutive four elements summing to more than 2*n.''. It has offset $1$ and begins
\[
166, 4663, 53553, 365810, 1782453, 6853011, 22111157, 62336336,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (24187/181440)*n\^{}9 + (57493/40320)*n\^{}8 + (12829/1890)*n\^{}7 + (54583/2880)*n\^{}6 + (29
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 11:15:12, revision 6)
...
kills $a$, and $(z-1)^{9+1}$ kills $P$, so $A(z)(z-1)^{9+1}$ --- monic, of order
$11+9+1$ --- kills $r$. The model was evaluated exactly in integer arithmetic and $P$ in
exact rational arithmetic at every index from $n=1$ to $n=1+11+9+1$, and $r$ vanished
at all of them. A monic recurrence with $11+9+1$ consecutive zeros has every later term zero,
so $r\equiv0$.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A241969.
