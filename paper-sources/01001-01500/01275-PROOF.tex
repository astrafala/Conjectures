...
\title{The empirical recurrence for OEIS A254699, proved from an exact model}
...
\begin{abstract}
OEIS A254699 carries an empirical recurrence of order $5$. It is true, and it is
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 17 2018 09:12:40, revision 8)
