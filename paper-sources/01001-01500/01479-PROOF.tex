...
\title{The empirical recurrence for OEIS A189452, proved by transfer matrix}
...
\begin{abstract}
OEIS A189452 counts the permutations of the cells of an $n\times4$ array in which every cell
...
OEIS A189452 is ``Number of 4Xn array permutations with each element moving zero or one space horizontally or diagonally.''. It has offset $1$ and begins
\[
1, 34, 400, 7300, 118128, 2008890, 33735505, 569476049,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 05:14:36, revision 9) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A189452.
