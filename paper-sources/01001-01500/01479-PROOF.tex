...
\title{The empirical recurrence for OEIS A262475, proved by transfer matrix}
...
\begin{abstract}
OEIS A262475 counts arrays of width $6$ over $\{0,1\}$ whose rows, read as base-$2$
numbers, are divisible by $5$ and whose columns, read the same way, are divisible by
$3$. The entry carries an empirical recurrence of order $33$ contributed by
...
OEIS A262475 is ``Number of (5+1)X(n+1) 0..1 arrays with each row divisible by 3 and each column divisible by 5, read as a binary number with top and left being the most significant bits.''. It has offset $1$ and begins
\[
13, 37, 469, 2413, 30229, 234421, 2924245, 29005981,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 23 2015 18:54:34, revision 4) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A262475.
