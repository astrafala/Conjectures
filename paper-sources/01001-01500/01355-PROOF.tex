...
\title{The empirical recurrence for OEIS A220309, proved by transfer matrix}
...
\begin{abstract}
OEIS A220309 counts the distinct indicator arrays obtained from the $n\times2$ arrays over
$\{0,\dots,3\}$ by marking the cells whose value is equal to at least half of their neighbours, and carries an
...
indicator row by row turns it into one, on $S=21$ states, after which the conjectured
...
OEIS A220309 is ``Majority value maps: number of n X 2 binary arrays indicating the locations of corresponding elements equal to at least half of their horizontal, vertical and antidiagonal neighbors in a random 0..3 n X 2 array.''. It has offset $1$ and begins
\[
2, 9, 40, 155, 617, 2457, 9785, 38986,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) + 2*a(n-2) - 8*a(n-3) - 3*a(n-4) + 9*a(n-5) - 2*a(n-6) - 2*a(n-7) - a(n-8) + a(n-9) for n>10.
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 13 2018 11:12:24, revision 9) this is still
...
\]
There are $S=21$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite. Note
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + 2\,a(n-2) - 8\,a(n-3) - 3\,a(n-4) + 9\,a(n-5) - 2\,a(n-6) - 2\,a(n-7) - a(n-8) + a(n-9)
\]
for every $n>10$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A220309.
