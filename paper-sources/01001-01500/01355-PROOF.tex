...
\title{Recovering the unwritten recurrences of the table OEIS A237511}
...
\begin{abstract}
OEIS A237511 is a two-dimensional table $T(n,k)$ whose empirical recurrences are, for several of
...
OEIS A237511 is ``T(n,k)=Number of (n+1)X(k+1) 0..2 arrays with the maximum plus the upper median minus the minimum of every 2X2 subblock differing from its horizontal and vertical neighbors by exactly one.''. It is read by antidiagonals and begins
\[
81, 328, 328, 1342, 1724, 1342, 5622, 9108,\ \dots
\]
The entry carries, among its empirical claims:
\begin{quote}\small
k=2: [order 29]
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 10:14:57, revision 6) these are still
...
count, a walk on $S=328$ vertices. Berlekamp--Massey on $2S=656$ exact terms
returns a minimal recurrence of order $29$ --- the order the entry states --- with
integer coefficients
\[
(c_1,\dots,c_{29})=(0,\ 0,\ 51,\ 452,\ 957,\ 1876,\ -1653,\ -28721,\ -62762,\ -54279,\ 103874,\ 439699,\ 514519,\ 101483,\ -1040322,\ -1791750,\ -259805,\ 1006112,\ 1409914,\ 1597459,\ -244216,\ -1055715,\ -360036,\ -212913,\ -59275,\ -17332,\ -1418,\ -86,\ 8).
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237511.
