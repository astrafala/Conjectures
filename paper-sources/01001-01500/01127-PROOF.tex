...
\title{The empirical recurrence for OEIS A250393, proved from an exact model}
...
\begin{abstract}
OEIS A250393 carries an empirical recurrence of order $11$. It is true, and it is
...
\begin{quote}
Empirical: a(n) = n\^{}10 - (2/3)*n\^{}9 + (4087/840)*n\^{}8 - (259/90)*n\^{}7 + (713/180)*n\^{}6 + (119/90)*n\^{}5 - (1493/360)*n\^{}4 + (202/45)*n\^{}3 - (844/315)*n\^{}2 + (11/15)*n. a(n) = 11*a(n-1) - 55*a(n-2) + 165*a(n-3) - 330*a(n-4) + 462*a(n-5) - 462*a(n-6) + 330*a(n-7) - 165*a(n-8) + 55*a(n-9) - 11*a(n-10) + a(n-11) for n>11.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 21 2017 06:19:51, revision 8)
