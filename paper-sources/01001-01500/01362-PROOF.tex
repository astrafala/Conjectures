...
\title{The empirical recurrence for OEIS A240757, proved by transfer matrix}
...
\begin{abstract}
OEIS A240757 counts arrays over $\{0,1,2,3\}$ in which no entry may equal, modulo $4$, a given
...
count is then a walk count on $S=336$ states.
\end{abstract}
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 08 2023 13:43:40, revision 6) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=336.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A240757.
