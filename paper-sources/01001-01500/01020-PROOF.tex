...
\title{The empirical recurrence for OEIS A246482, proved from an exact model}
...
\begin{abstract}
OEIS A246482 carries an empirical recurrence of order $11$. It is true, and it is
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 06 2018 06:45:05, revision 7)
