...
\title{The empirical recurrence for OEIS A221922, proved by transfer matrix}
...
\begin{abstract}
OEIS A221922 counts the distinct OCCUPANCY arrays obtained when every cell of an $n\times2$ grid
...
one, on $S=419$ states, after which the conjectured recurrence is settled by a finite exact
computation.
\end{abstract}
...
OEIS A221922 is ``Number of nX2 arrays of occupancy after each element stays put or moves to some king-move neighbor, without move-in move-out straight through or left turns.''. It has offset $1$ and begins
\[
3, 35, 350, 3487, 34714, 345744, 3443699, 34300167,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 9*a(n-1) +12*a(n-2) -29*a(n-3) +41*a(n-4) +75*a(n-5) -129*a(n-6) -30*a(n-7) +61*a(n-8) -a(n-9) -4*a(n-10)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 20:05:17, revision 9) this is still
...
$S=419$ reachable sets. In particular $a$ is $C$-finite.
...
\begin{theorem}
\[
a(n)\;=\;9\,a(n-1) + 12\,a(n-2) - 29\,a(n-3) + 41\,a(n-4) + 75\,a(n-5) - 129\,a(n-6) - 30\,a(n-7) + 61\,a(n-8) - a(n-9) - 4\,a(n-10)
\]
for every $n>10$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221922.
