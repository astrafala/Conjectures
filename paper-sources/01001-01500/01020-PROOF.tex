...
\title{The empirical recurrence for OEIS A229601, proved by counting defective colourings}
...
\begin{abstract}
OEIS A229601 counts the colourings of an array with $K=3$ colours that are proper except at
...
OEIS A229601 is ``Number of defective 3-colorings of an n X 3 0..2 array connected horizontally and vertically with exactly two mistakes, and colors introduced in row-major 0..2 order.''. It has offset $1$ and begins
\[
1, 39, 396, 3040, 20714, 131345, 792929, 4618048,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 15*a(n-1) - 81*a(n-2) + 185*a(n-3) - 162*a(n-4) + 60*a(n-5) - 8*a(n-6) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 19 2018 15:14:29, revision 7) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A229601.
