...
\title{The empirical recurrence for OEIS A221891, proved by transfer matrix}
...
\begin{abstract}
OEIS A221891 counts the distinct OCCUPANCY arrays obtained when every cell of an $n\times2$ grid
...
OEIS A221891 is ``Number of 2 X n arrays of occupancy after each element moves to some horizontal, diagonal or antidiagonal neighbor, without 2-loops or left turns.''. It has offset $1$ and begins
\[
0, 0, 8, 37, 169, 811, 3878, 18502,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 5*a(n-1) -2*a(n-2) +5*a(n-3) -3*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 12 2018 15:12:45, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) - 2\,a(n-2) + 5\,a(n-3) - 3\,a(n-4)
\]
for every $n>4$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221891.
