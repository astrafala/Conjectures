...
\title{The empirical recurrence for OEIS A221236, proved by transfer matrix}
...
\begin{abstract}
OEIS A221236 counts the distinct OCCUPANCY arrays obtained when every cell of an $n\times2$ grid
...
determinising the machine that emits the occupancy row by row turns it into one, on $S=110$
...
OEIS A221236 is ``Number of n X 2 arrays of occupancy after each element moves to some horizontal, vertical or antidiagonal neighbor, without 2-loops.''. It has offset $1$ and begins
\[
0, 5, 53, 467, 3913, 32299, 265353, 2176758,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 11*a(n-1) - 23*a(n-2) - a(n-3) + 10*a(n-4) - a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 04 2018 10:35:03, revision 9) this is still
...
\]
There are $S=110$ reachable sets. In particular $a$ is $C$-finite.
...
\begin{theorem}
\[
a(n)\;=\;11\,a(n-1) - 23\,a(n-2) - a(n-3) + 10\,a(n-4) - a(n-6)
\]
for every $n>6$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221236.
