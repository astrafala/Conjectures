...
\title{The empirical recurrence for OEIS A249709, proved from an exact model}
...
\begin{abstract}
OEIS A249709 carries an empirical recurrence of order $6$. It is true, and it is
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 10 2018 04:40:13, revision 8)
