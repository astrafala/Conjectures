...
\title{The empirical recurrence for OEIS A279866, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A279866 imposes three things at once: a condition on each cell that reaches one row up and
...
from a finite exact computation on $S=294$ states.
\end{abstract}
...
OEIS A279866 is ``Number of n X 2 0..2 arrays with no element unequal to a strict majority of its horizontal and vertical neighbors, with the exception of exactly two elements, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
1, 4, 33, 96, 255, 610, 1437, 3292,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 5*a(n-1) - 4*a(n-2) - 14*a(n-3) + 19*a(n-4) + 13*a(n-5) - 22*a(n-6) - 4*a(n-7) + 8*a(n-8) for n>9.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 12 2019 09:24:51, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) - 4\,a(n-2) - 14\,a(n-3) + 19\,a(n-4) + 13\,a(n-5) - 22\,a(n-6) - 4\,a(n-7) + 8\,a(n-8)
\end{equation}
for all $n>9$.
...
Assembling the $3$ chains block-diagonally into $N$ of size $S=294$ with the weights of
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A279866.
