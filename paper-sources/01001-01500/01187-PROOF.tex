...
\title{The empirical recurrence for OEIS A218812, proved by transfer matrix}
...
\begin{abstract}
OEIS A218812 counts the distinct indicator arrays obtained from the $n\times3$ arrays over
$\{0,\dots,3\}$ by marking the cells whose value is at least as large as every one of their neighbours, and carries an
...
indicator row by row turns it into one, on $S=699$ states, after which the conjectured
...
OEIS A218812 is ``Hilltop maps: number of 3Xn binary arrays indicating the locations of corresponding elements not exceeded by any horizontal or antidiagonal neighbor in a random 0..3 3Xn array.''. It has offset $1$ and begins
\[
1, 57, 481, 3969, 31741, 253877, 2030789, 16245185,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 17:46:45, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

Let $R=\{0,\dots,3\}^{3}$ be the set of rows and let the neighbours of a cell be the
...
is at least as large as every one of its neighbours. The entry counts
\[
...
\]
There are $S=699$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite. Note
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-1) + 7\,a(n-2) + 7\,a(n-3) + 5\,a(n-4) + 17\,a(n-5) + 25\,a(n-6) + 115\,a(n-7) + 43\,a(n-8) + 47\,a(n-9) + 51\,a(n-10) + 119\,a(n-11) + 146\,a(n-12) + 284\,a(n-13) - 148\,a(n-14) - 18\,a(n-15) - 3\,a(n-16) - 27\,a(n-17) + 73\,a(n-18) - 255\,a(n-19) - 441\,a(n-20) - 343\,a(n-21) - 233\,a(n-22) - 153\,a(n-23) - 75\,a(n-24) - 11\,a(n-25) + 359\,a(n-26) + 227\,a(n-27) + 183\,a(n-28) + 123\,a(n-29) + 21\,a(n-30) + 37\,a(n-31) - 69\,a(n-32) - 57\,a(n-33) - 41\,a(n-34) - 59\,a(n-35) - 51\,a(n-36) - 23\,a(n-37) + 9\,a(n-38) + 21\,a(n-39) + 24\,a(n-40) + 34\,a(n-41) + 30\,a(n-42) + 16\,a(n-43) + 7\,a(n-44) - a(n-45) - 9\,a(n-46) - 9\,a(n-47) - 7\,a(n-48) - a(n-49) + a(n-50) + a(n-51) - a(n-52) - a(n-53) - a(n-54) - a(n-55)
\]
for every $n>56$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A218812.
