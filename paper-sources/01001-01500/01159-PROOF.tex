...
\title{The empirical recurrence for OEIS A200788, proved from an exact model}
...
\begin{abstract}
OEIS A200788 carries an empirical recurrence of order $7$. It is true, and it is
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 15 2017 20:28:02, revision 13)
