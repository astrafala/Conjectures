...
\title{The empirical recurrence for OEIS A219980, proved by transfer matrix}
...
\begin{abstract}
OEIS A219980 counts the distinct indicator arrays obtained from the $n\times3$ arrays over
$\{0,\dots,3\}$ by marking the cells whose value differs from every one of their neighbours, and carries an
...
indicator row by row turns it into one, on $S=31$ states, after which the conjectured
...
OEIS A219980 is ``Unmatched value maps: number of nX3 binary arrays indicating the locations of corresponding elements not equal to any horizontal, vertical or antidiagonal neighbor in a random 0..3 nX3 array.''. It has offset $1$ and begins
\[
4, 42, 316, 2344, 17591, 131978, 989813, 7423785,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 8*a(n-1) -7*a(n-2) +27*a(n-3) -23*a(n-4) +28*a(n-5) -18*a(n-6) -5*a(n-7) +10*a(n-8) -a(n-9) -3*a(n-10) +a(n-11)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 18:26:43, revision 8) this is still
...
\]
There are $S=31$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite. Note
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-1) - 7\,a(n-2) + 27\,a(n-3) - 23\,a(n-4) + 28\,a(n-5) - 18\,a(n-6) - 5\,a(n-7) + 10\,a(n-8) - a(n-9) - 3\,a(n-10) + a(n-11)
\]
for every $n>11$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A219980.
