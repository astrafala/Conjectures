...
\title{The empirical recurrence for OEIS A200256, proved from an exact model}
...
\begin{abstract}
OEIS A200256 carries an empirical recurrence of order $96$. It is true, and it is
decidable rather than empirical. The entry's sequence is given exactly by an Ehrhart quasi-polynomial, from
which $a$ provably satisfies a MONIC linear recurrence of order $S=257$, derived below and not
...
OEIS A200256 is ``Number of 0..n arrays x(0..6) of 7 elements with each no smaller than the sum of its previous elements modulo (n+1).''. It has offset $1$ and begins
\[
34, 192, 1252, 3645, 12063, 28672, 71970, 140625,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 08:32:45, revision 9)
...
\]
annihilates $a$, and $S=\deg A=257$. A congruence condition modulo $m$ is counted one residue
...
exactly $\deg A$. The bound in force is therefore $zA(z)$, of order $S=257$, and
...
$q(z)=z^{96}-\sum_ic_iz^{96-i}$ the characteristic polynomial of the conjectured
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) - 2\,a(n-3) + 2\,a(n-4) - 2\,a(n-5) + 2\,a(n-7) - 2\,a(n-9) + 2\,a(n-11) - 2\,a(n-12) + 2\,a(n-13) - 2\,a(n-15) + 2\,a(n-16) - 2\,a(n-17) + 2\,a(n-19) - 2\,a(n-20) + 2\,a(n-21) - 2\,a(n-23) + 2\,a(n-25) - 2\,a(n-27) + 2\,a(n-28) - 2\,a(n-29) + 2\,a(n-31) + a(n-32) - 4\,a(n-33) + 4\,a(n-35) - 4\,a(n-36) + 4\,a(n-37) - 4\,a(n-39) + 4\,a(n-41) - 4\,a(n-43) + 4\,a(n-44) - 4\,a(n-45) + 4\,a(n-47) - 4\,a(n-48) + 4\,a(n-49) - 4\,a(n-51) + 4\,a(n-52) - 4\,a(n-53) + 4\,a(n-55) - 4\,a(n-57) + 4\,a(n-59) - 4\,a(n-60) + 4\,a(n-61) - 4\,a(n-63) + a(n-64) + 2\,a(n-65) - 2\,a(n-67) + 2\,a(n-68) - 2\,a(n-69) + 2\,a(n-71) - 2\,a(n-73) + 2\,a(n-75) - 2\,a(n-76) + 2\,a(n-77) - 2\,a(n-79) + 2\,a(n-80) - 2\,a(n-81) + 2\,a(n-83) - 2\,a(n-84) + 2\,a(n-85) - 2\,a(n-87) + 2\,a(n-89) - 2\,a(n-91) + 2\,a(n-92) - 2\,a(n-93) + 2\,a(n-95) - a(n-96)
\]
for every $n>0$.
\end{theorem}
...
vanish from $n=0+1$ onwards, and the run exceeds $S+96$, which by
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A200256.
