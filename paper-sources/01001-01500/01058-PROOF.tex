...
\title{The empirical recurrence for OEIS A221656, proved by transfer matrix}
...
\begin{abstract}
OEIS A221656 counts the distinct OCCUPANCY arrays obtained when every cell of an $n\times2$ grid
...
one, on $S=164$ states, after which the conjectured recurrence is settled by a finite exact
computation.
\end{abstract}
...
OEIS A221656 is ``Number of 2 X n arrays of occupancy after each element moves to some horizontal, diagonal or antidiagonal neighbor, without move-in move-out left turns.''. It has offset $1$ and begins
\[
0, 4, 24, 165, 1054, 6862, 44576, 289789,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 12 2026 11:59:07, revision 10) this is still
...
$S=164$ reachable sets. In particular $a$ is $C$-finite.
...
\begin{theorem}
\[
a(n)\;=\;9\,a(n-1) - 15\,a(n-2) - 15\,a(n-3) + 52\,a(n-4) - 51\,a(n-5) - a(n-6) + 127\,a(n-7) - 32\,a(n-8) - 28\,a(n-9) + 25\,a(n-10)
\]
for every $n>12$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221656.
