...
\title{The empirical recurrence for OEIS A221610, proved by transfer matrix}
...
\begin{abstract}
OEIS A221610 counts the distinct OCCUPANCY arrays obtained when every cell of an $n\times2$ grid
...
one, on $S=68$ states, after which the conjectured recurrence is settled by a finite exact
computation.
\end{abstract}
...
OEIS A221610 is ``Number of 2 X n arrays of occupancy after each element moves to some horizontal or antidiagonal neighbor, without move-in move-out left turns.''. It has offset $1$ and begins
\[
0, 2, 10, 53, 269, 1378, 7057, 36152,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 7*a(n-1) - 9*a(n-2) - 5*a(n-3) + 10*a(n-4) - 3*a(n-5) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 09 2018 15:12:58, revision 8) this is still
...
$S=68$ reachable sets. In particular $a$ is $C$-finite.
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-1) - 9\,a(n-2) - 5\,a(n-3) + 10\,a(n-4) - 3\,a(n-5)
\]
for every $n>7$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221610.
