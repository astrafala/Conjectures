...
\title{The empirical recurrence for OEIS A200157, proved from an exact model}
...
\begin{abstract}
OEIS A200157 carries an empirical recurrence of order $32$. It is true, and it is
...
OEIS A200157 is ``Number of 0..n arrays x(0..5) of 6 elements with zero 5th difference.''. It has offset $1$ and begins
\[
8, 39, 112, 275, 730, 1589, 3000, 5181,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 08:27:37, revision 9)
...
$q(z)=z^{32}-\sum_ic_iz^{32-i}$ the characteristic polynomial of the conjectured
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) - a(n-2) + 2\,a(n-5) - 4\,a(n-6) + 2\,a(n-7) + a(n-10) - 2\,a(n-11) + a(n-12) - 4\,a(n-15) + 8\,a(n-16) - 4\,a(n-17) + a(n-20) - 2\,a(n-21) + a(n-22) + 2\,a(n-25) - 4\,a(n-26) + 2\,a(n-27) - a(n-30) + 2\,a(n-31) - a(n-32)
\]
for every $n>0$.
\end{theorem}
...
vanish from $n=0+1$ onwards, and the run exceeds $S+32$, which by
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A200157.
