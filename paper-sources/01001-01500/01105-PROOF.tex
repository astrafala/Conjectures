...
\title{The empirical recurrence for OEIS A221769, proved by transfer matrix}
...
\begin{abstract}
OEIS A221769 counts the distinct OCCUPANCY arrays obtained when every cell of an $n\times2$ grid
...
OEIS A221769 is ``Number of n X 2 arrays of occupancy after each element stays put or moves to some horizontal or vertical neighbor, without move-in move-out left turns.''. It has offset $1$ and begins
\[
3, 27, 240, 2127, 18828, 166581, 1473549, 13033908,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 15*a(n-1) - 67*a(n-2) + 120*a(n-3) - 80*a(n-4) + 10*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2018 17:34:17, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221769.
