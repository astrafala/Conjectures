...
\title{The empirical recurrence for OEIS A264294, proved by transfer matrix}
...
\begin{abstract}
OEIS A264294 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=3$ rows in which
...
OEIS A264294 is ``Number of (n+1) X (2+1) arrays of permutations of 0..n*3+2 with each element having directed index change 0,1 0,-2 1,0 or -1,0.''. It has offset $1$ and begins
\[
2, 9, 20, 56, 169, 441, 1258, 3520,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + 4*a(n-2) + 5*a(n-3) - 5*a(n-4) - 5*a(n-5) + 4*a(n-6) - a(n-7) - a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 07 2019 11:17:03, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 4\,a(n-2) + 5\,a(n-3) - 5\,a(n-4) - 5\,a(n-5) + 4\,a(n-6) - a(n-7) - a(n-8)
\]
for every $n>6$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264294.
