...
\title{The empirical recurrence for OEIS A281321, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A281321 imposes three things at once: a condition on each cell that reaches one row up and
...
OEIS A281321 is ``Number of n X 3 0..2 arrays with no element equal to more than one of its horizontal and antidiagonal neighbors, with the exception of exactly one element, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
1, 46, 1266, 27144, 521848, 9439296, 164206368, 2780073856,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 28*a(n-1) - 180*a(n-2) - 224*a(n-3) - 64*a(n-4) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 18 2019 08:57:35, revision 7) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;28\,a(n-1) - 180\,a(n-2) - 224\,a(n-3) - 64\,a(n-4)
\end{equation}
for all $n>5$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A281321.
