...
\title{The empirical recurrence for OEIS A183909, proved from an exact model}
...
\begin{abstract}
OEIS A183909 carries an empirical recurrence of order $7$. It is true, and it is
...
\begin{quote}
Empirical: a(n) = (1/720)*n\^{}6 + (11/240)*n\^{}5 + (89/144)*n\^{}4 + (209/48)*n\^{}3 - (13003/360)*n\^{}2 + (531/10)*n + 12 for n>3. a(n) = 7*a(n-1) - 21*a(n-2) + 35*a(n-3) - 35*a(n-4) + 21*a(n-5) - 7*a(n-6) + a(n-7) for n>10.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 06 2018 07:00:59, revision 8)
