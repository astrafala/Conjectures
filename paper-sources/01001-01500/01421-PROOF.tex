...
\title{The empirical recurrence for OEIS A239027, proved by transfer matrix}
...
\begin{abstract}
OEIS A239027 counts arrays over $\{0,1,2\}$ in which no entry may equal, modulo $3$, a given
...
count is then a walk count on $S=243$ states.
\end{abstract}
...
OEIS A239027 is ``Number of nX5 0..2 arrays with no element equal to the sum of elements to its left or one plus the sum of elements above it, modulo 3.''. It has offset $1$ and begins
\[
1, 6, 16, 110, 354, 2592, 9319, 69288,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 09:22:54, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;167\,a(n-2) - 12737\,a(n-4) + 590522\,a(n-6) - 18674960\,a(n-8) + 428232709\,a(n-10) - 7384832953\,a(n-12) + 97981999331\,a(n-14) - 1014383126841\,a(n-16) + 8257937387592\,a(n-18) - 53002256526176\,a(n-20) + 267655608403835\,a(n-22) - 1056157718233604\,a(n-24) + 3216196113264380\,a(n-26) - 7411332048725488\,a(n-28) + 12543993016224416\,a(n-30) - 14892794784221696\,a(n-32) + 11503438838397440\,a(n-34) - 5030303892805632\,a(n-36) + 890642713919488\,a(n-38)
\]
for every $n>38$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A239027.
