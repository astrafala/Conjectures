...
\title{The empirical recurrence for OEIS A250388, proved from an exact model}
...
\begin{abstract}
OEIS A250388 carries an empirical recurrence of order $6$. It is true, and it is
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 19 2025 13:03:50, revision 13)
