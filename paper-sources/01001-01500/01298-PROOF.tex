...
\title{The empirical recurrence for OEIS A218367, proved by transfer matrix}
...
\begin{abstract}
OEIS A218367 counts the distinct indicator arrays obtained from the $n\times3$ arrays over
...
indicator row by row turns it into one, on $S=153$ states, after which the conjectured
...
OEIS A218367 is ``Hilltop maps: number of nX3 binary arrays indicating the locations of corresponding elements not exceeded by any horizontal, vertical or antidiagonal neighbor in a random 0..3 nX3 array.''. It has offset $1$ and begins
\[
7, 63, 509, 4081, 32641, 261121, 2088955, 16711551,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 17:40:14, revision 8) this is still
...
\]
There are $S=153$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite. Note
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-1) + 7\,a(n-2) + 7\,a(n-3) + 7\,a(n-4) + 7\,a(n-5) + 5\,a(n-6) + 9\,a(n-7) + 9\,a(n-8) + 9\,a(n-9) + 9\,a(n-10) + 9\,a(n-11) + 8\,a(n-12) + 4\,a(n-13) + a(n-14) + a(n-15) + a(n-16) + a(n-17) + a(n-18) + a(n-19) - a(n-20) - a(n-21) - a(n-22) - a(n-23) - a(n-24) - a(n-25)
\]
for every $n>25$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A218367.
