...
\title{The empirical recurrence for OEIS A200435, proved from an exact model}
...
\begin{abstract}
OEIS A200435 carries an empirical recurrence of order $8$. It is true, and it is
...
\begin{quote}
Empirical: a(n) = (19328/315)*n\^{}7 - (18373/90)*n\^{}6 + (18602/45)*n\^{}5 - (20887/36)*n\^{}4 + (46687/90)*n\^{}3 - (48359/180)*n\^{}2 + (12499/210)*n. a(n) = 8*a(n-1) - 28*a(n-2) + 56*a(n-3) - 70*a(n-4) + 56*a(n-5) - 28*a(n-6) + 8*a(n-7) - a(n-8) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (May 21 2018 09:22:37, revision 8)
