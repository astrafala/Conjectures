...
\title{The empirical recurrence for OEIS A200039, proved from an exact model}
...
\begin{abstract}
OEIS A200039 carries an empirical recurrence of order $4$. It is true, and it is
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 17 2018 09:10:07, revision 8)
