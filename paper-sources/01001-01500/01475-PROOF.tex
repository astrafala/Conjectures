...
\title{The empirical recurrence for OEIS A246001, proved from an exact model}
...
\begin{abstract}
OEIS A246001 carries an empirical recurrence of order $15$. It is true, and it is
...
OEIS A246001 is ``Number of length 6+2 0..n arrays with no pair in any consecutive three terms totalling exactly n.''. It has offset $1$ and begins
\[
2, 56, 2308, 23168, 171942, 795144, 3057032, 9401216,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 28 2023 19:31:54, revision 6)
...
\]
annihilates $a$, and $S=\deg A=37$. A congruence condition modulo $m$ is counted one residue
...
exactly $\deg A$. The bound in force is therefore $zA(z)$, of order $S=37$, and
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + 3\,a(n-2) - 17\,a(n-3) + 3\,a(n-4) + 39\,a(n-5) - 25\,a(n-6) - 45\,a(n-7) + 45\,a(n-8) + 25\,a(n-9) - 39\,a(n-10) - 3\,a(n-11) + 17\,a(n-12) - 3\,a(n-13) - 3\,a(n-14) + a(n-15)
\]
for every $n>0$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A246001.
