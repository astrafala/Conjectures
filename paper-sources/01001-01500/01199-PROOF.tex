...
\title{The empirical recurrence for OEIS A267473, proved from an exact model}
...
\begin{abstract}
OEIS A267473 carries an empirical recurrence of order $6$. It is true, and it is
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 05 2018 09:36:22, revision 7)
