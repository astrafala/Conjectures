...
\title{The empirical recurrence for OEIS A279461, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A279461 imposes three things at once: a condition on each cell that reaches one row up and
...
OEIS A279461 is ``Number of n X 3 0..1 arrays with no element equal to a strict majority of its horizontal, vertical and antidiagonal neighbors, with the exception of exactly one element, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
2, 6, 33, 180, 1024, 5228, 26670, 134438,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 19 2022 14:18:28, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;10\,a(n-1) - 33\,a(n-2) + 58\,a(n-3) - 110\,a(n-4) + 76\,a(n-5) - 37\,a(n-6) + 46\,a(n-7) + 216\,a(n-8) - 90\,a(n-9) + 274\,a(n-10) - 480\,a(n-11) - 570\,a(n-12) + 82\,a(n-13) - 243\,a(n-14) + 666\,a(n-15) + 1279\,a(n-16) + 1154\,a(n-17) - 450\,a(n-18) - 3012\,a(n-19) - 1514\,a(n-20) + 298\,a(n-21) - 265\,a(n-22) + 2182\,a(n-23) + 4582\,a(n-24) + 864\,a(n-25) - 4441\,a(n-26) - 4314\,a(n-27) - 91\,a(n-28) + 2472\,a(n-29) + 1759\,a(n-30) + 214\,a(n-31) - 414\,a(n-32) - 306\,a(n-33) - 100\,a(n-34) - 16\,a(n-35) - a(n-36)
\end{equation}
for all $n>37$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A279461.
