...
\title{The empirical recurrence for OEIS A221126, proved by transfer matrix}
...
\begin{abstract}
OEIS A221126 counts the distinct OCCUPANCY arrays obtained when every cell of an $n\times2$ grid
...
determinising the machine that emits the occupancy row by row turns it into one, on $S=159$
...
OEIS A221126 is ``Number of 2 X n arrays of occupancy after each element stays put or moves to some horizontal or antidiagonal neighbor.''. It has offset $1$ and begins
\[
1, 21, 200, 1950, 19005, 185164, 1803949, 17574675,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 11*a(n-1) - 11*a(n-2) - 12*a(n-3) - 2*a(n-4) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 04 2018 06:40:39, revision 8) this is still
...
\]
There are $S=159$ reachable sets. In particular $a$ is $C$-finite.
...
\begin{theorem}
\[
a(n)\;=\;11\,a(n-1) - 11\,a(n-2) - 12\,a(n-3) - 2\,a(n-4)
\]
for every $n>6$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221126.
