...
\title{The empirical recurrence for OEIS A264211, proved by transfer matrix}
...
\begin{abstract}
OEIS A264211 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=3$ rows in which
...
OEIS A264211 is ``Number of (n+1) X (2+1) arrays of permutations of 0..n*3+2 with each element having directed index change 0,0 0,1 1,0 -1,0 or 0,-2.''. It has offset $1$ and begins
\[
17, 96, 596, 3610, 21997, 133836, 814609, 4957760,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 6*a(n-1) + 3*a(n-2) - 16*a(n-3) + 3*a(n-4) + 16*a(n-5) + 3*a(n-6) - 6*a(n-7) - a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 06 2019 07:08:08, revision 11) this is still
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) + 3\,a(n-2) - 16\,a(n-3) + 3\,a(n-4) + 16\,a(n-5) + 3\,a(n-6) - 6\,a(n-7) - a(n-8)
\]
for every $n>6$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264211.
