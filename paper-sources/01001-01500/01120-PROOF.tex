...
\title{The empirical recurrence for OEIS A264570, proved by transfer matrix}
...
\begin{abstract}
OEIS A264570 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=3$ columns in which
...
OEIS A264570 is ``Number of (2+1) X (n+1) arrays of permutations of 0..n*3+2 with each element having directed index change 1,0 1,1 0,-1 or -1,1.''. It has offset $1$ and begins
\[
1, 2, 4, 8, 24, 64, 160, 384,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + 8*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 08 2019 19:00:20, revision 8) this is still
...
\[
(i-h_i,\,j-h_j)\;\in\;\{(-1,0),\ (0,1),\ (1,-1),\ (1,1)\},
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264570.
