...
\title{The empirical recurrence for OEIS A229386, proved by transfer matrix}
...
\begin{abstract}
OEIS A229386 counts the distinct arrays obtained by applying a fixed local operation to every cell
...
$S=11$ states, after which the conjectured recurrence is settled by a finite exact
computation.
\end{abstract}
...
OEIS A229386 is ``Number of n X 2 0..3 arrays of the sum of the corresponding element, the element to the east and the element to the south in a larger (n+1) X 3 0..1 array.''. It has offset $1$ and begins
\[
14, 128, 1064, 8592, 68672, 546752, 4346752, 34537984,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 12*a(n-1) - 36*a(n-2) + 32*a(n-3) - 16*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 14 2018 16:12:13, revision 9) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

Let $R$ be the set of rows of length $3$ over $\{0,\dots,1\}$.
...
\]
There are $S=11$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite.
...
\begin{theorem}
\[
a(n)\;=\;12\,a(n-1) - 36\,a(n-2) + 32\,a(n-3) - 16\,a(n-4)
\]
for every $n>3$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A229386.
