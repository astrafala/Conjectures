...
\title{The empirical recurrence for OEIS A267236, proved from an exact model}
...
\begin{abstract}
OEIS A267236 carries an empirical recurrence of order $8$. It is true, and it is
...
OEIS A267236 is ``Number of length-7 0..n arrays with no following elements greater than or equal to the first repeated value.''. It has offset $1$ and begins
\[
9, 479, 5646, 34396, 143695, 469623, 1291052, 3121008,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = n\^{}7 + (69/20)*n\^{}6 + (7/2)*n\^{}5 + (7/6)*n\^{}4 - (7/60)*n\^{}2. a(n) = 8*a(n-1) - 28*a(n-2) + 56*a(n-3) - 70*a(n-4) + 56*a(n-5) - 28*a(n-6) + 8*a(n-7) - a(n-8) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 10 2019 15:22:31, revision 8)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267236.
