...
\title{The empirical recurrence for OEIS A231857, proved by transfer matrix}
...
\begin{abstract}
OEIS A231857 counts arrays of width $3$ over $\{0,1,2\}$ in which no cell is beaten by a strict majority of its neighbours. The entry carries an
...
$3$ consecutive rows and the count is a walk count on $S=658$ states.
\end{abstract}
...
OEIS A231857 is ``Number of 3Xn 0..2 arrays with no element having a strict majority of its horizontal and antidiagonal neighbors equal to itself plus one mod 3, with upper left element zero (rock paper and scissors drawn positions).''. It has offset $1$ and begins
\[
9, 55, 656, 7339, 85288, 991167, 11529929, 134163686,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 08:48:35, revision 6) this is still
...
Thus
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=658,
\]
...
\begin{theorem}
\[
a(n)\;=\;15\,a(n-1) - 33\,a(n-2) - 96\,a(n-3) + 258\,a(n-4) + 412\,a(n-5) - 873\,a(n-6) - 1455\,a(n-7) + 1110\,a(n-8) + 4203\,a(n-9) + 2658\,a(n-10) - 10249\,a(n-11) - 12826\,a(n-12) + 15687\,a(n-13) + 27224\,a(n-14) - 12857\,a(n-15) - 37317\,a(n-16) + 9206\,a(n-17) + 17841\,a(n-18) + 107\,a(n-19) + 3350\,a(n-20) - 8989\,a(n-21) + 583\,a(n-22) + 8\,a(n-23) + 12093\,a(n-24) - 21445\,a(n-25) + 13211\,a(n-26) - 2506\,a(n-27) + 2401\,a(n-28) - 2357\,a(n-29) + 397\,a(n-30) - 8\,a(n-31) + 70\,a(n-32) - 32\,a(n-33) - 10\,a(n-34) - 4\,a(n-35)
\]
for every $n>39$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231857.
