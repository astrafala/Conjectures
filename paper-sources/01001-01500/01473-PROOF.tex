...
\title{The empirical recurrence for OEIS A202255, proved from an exact model}
...
\begin{abstract}
OEIS A202255 carries an empirical recurrence of order $15$. It is true, and it is
...
OEIS A202255 is ``Number of zero-sum -n..n arrays of 5 elements with adjacent element differences also in -n..n.''. It has offset $1$ and begins
\[
15, 107, 397, 1077, 2385, 4643, 8211, 13533,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) +a(n-2) -a(n-5) -a(n-6) -a(n-7) +a(n-8) +a(n-9) +a(n-10) -a(n-13) -a(n-14) +a(n-15).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 15 2025 10:20:25, revision 15)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A202255.
