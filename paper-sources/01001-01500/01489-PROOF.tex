...
\title{The empirical recurrence for OEIS A240780, proved by transfer matrix}
...
\begin{abstract}
OEIS A240780 counts $n\times5$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A240780 is ``Number of nX5 0..1 arrays with no element equal to fewer vertical neighbors than horizontal neighbors, with new values 0..1 introduced in row major order.''. It has offset $1$ and begins
\[
1, 9, 97, 959, 10150, 106411, 1120383, 11791412,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 11:07:02, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A240780.
