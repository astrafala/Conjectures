...
\title{The empirical recurrence for OEIS A229476, proved by counting defective colourings}
...
\begin{abstract}
OEIS A229476 counts the colourings of an array with $K=4$ colours that are proper except at
...
numbers. What is left is a walk count on $S=2600$ vertices, and the empirical recurrence of
...
OEIS A229476 is ``Number of defective 4-colorings of an n X 5 0..3 array connected horizontally, antidiagonally and vertically with exactly one mistake, and colors introduced in row-major 0..3 order.''. It has offset $1$ and begins
\[
20, 1312, 23964, 360912, 5068384, 68447552, 900320160, 11614790144,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 27 2021 21:34:12, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;44\,a(n-1) - 838\,a(n-2) + 9452\,a(n-3) - 73265\,a(n-4) + 422560\,a(n-5) - 1882320\,a(n-6) + 6531392\,a(n-7) - 17307072\,a(n-8) + 32474112\,a(n-9) - 31011840\,a(n-10) - 38977536\,a(n-11) + 220663808\,a(n-12) - 419692544\,a(n-13) + 332922880\,a(n-14) + 233046016\,a(n-15) - 839122944\,a(n-16) + 788529152\,a(n-17) - 268435456\,a(n-18)
\end{equation}
for all $n>19$.

\section{Mistakes, and the colour clause}

The arrays have $5$ columns and $L=n$ rows, entries in $\{0,\dots,4-1\}$.
...
Assembling the $4$ chains block-diagonally into $N$ of size $S=2600$ with the weights of
...
\[
4!\Bigl(a(n_0+j)-\sum_i c_i\,a(n_0+j-i)\Bigr)=\mathbf{v}^{\!\top}G^{\,j-18}w,
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A229476.
