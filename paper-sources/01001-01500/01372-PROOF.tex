...
\title{The empirical recurrence for OEIS A220382, proved by transfer matrix}
...
\begin{abstract}
OEIS A220382 counts the distinct indicator arrays obtained from the $n\times4$ arrays over
...
OEIS A220382 is ``Majority value maps: number of nX4 binary arrays indicating the locations of corresponding elements equal to at least half of their horizontal and antidiagonal neighbors in a random 0..1 nX4 array.''. It has offset $1$ and begins
\[
7, 79, 757, 7462, 73066, 715412, 7003040, 68557435,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 18:44:52, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-1) + 33\,a(n-2) - 35\,a(n-3) - 198\,a(n-4) - 52\,a(n-5) + 60\,a(n-6) - 248\,a(n-7) + 327\,a(n-8) + 2885\,a(n-9) + 3686\,a(n-10) - 391\,a(n-11) - 2646\,a(n-12) + 1576\,a(n-13) + 5693\,a(n-14) + 4779\,a(n-15) + 1858\,a(n-16) + 790\,a(n-17) + 571\,a(n-18) + 145\,a(n-19) - 48\,a(n-20) - 28\,a(n-21) - 4\,a(n-22)
\]
for every $n>23$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A220382.
