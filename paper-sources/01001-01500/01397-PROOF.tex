...
\title{The empirical recurrence for OEIS A267233, proved from an exact model}
...
\begin{abstract}
OEIS A267233 carries an empirical recurrence of order $5$. It is true, and it is
...
OEIS A267233 is ``Number of length-4 0..n arrays with no following elements greater than or equal to the first repeated value.''. It has offset $1$ and begins
\[
6, 47, 176, 470, 1030, 1981, 3472, 5676,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = n\^{}4 + (17/6)*n\^{}3 + 2*n\^{}2 + (1/6)*n.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 05 2018 17:10:08, revision 7)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267233.
