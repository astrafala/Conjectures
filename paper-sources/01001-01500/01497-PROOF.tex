...
\title{The empirical recurrence for OEIS A218523, proved by transfer matrix}
...
\begin{abstract}
OEIS A218523 counts the distinct arrays obtained by applying a fixed local operation to every cell
of an array over a bounded alphabet, and carries an empirical recurrence of order $16$
...
OEIS A218523 is ``Number of 2Xn arrays of the minimum value of corresponding elements and their horizontal or antidiagonal neighbors in a random 0..3 2Xn array.''. It has offset $1$ and begins
\[
16, 36, 286, 1348, 7902, 42812, 242438, 1349524,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 17:41:57, revision 10) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

Let $R=\{0,\dots,3\}^{2}$ be the set of rows and let the neighbours of
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 17\,a(n-2) + 26\,a(n-3) - 19\,a(n-4) - 123\,a(n-5) - 138\,a(n-6) - 248\,a(n-7) - 329\,a(n-8) + 41\,a(n-9) + 1108\,a(n-10) + 1469\,a(n-11) - 54\,a(n-12) - 1158\,a(n-13) - 316\,a(n-14) + 144\,a(n-15) + 32\,a(n-16)
\]
for every $n>16$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A218523.
