...
\title{The empirical recurrence for OEIS A264545, proved by transfer matrix}
...
\begin{abstract}
OEIS A264545 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=4$ rows in which
...
OEIS A264545 is ``Number of (n+1)X(3+1) arrays of permutations of 0..n*4+3 with each element having directed index change -1,1 -1,2 1,0 or 0,-1.''. It has offset $1$ and begins
\[
1, 6, 16, 45, 133, 400, 1204, 3561,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 17 2015 15:33:21, revision 4) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264545.
