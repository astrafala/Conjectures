...
\title{The empirical recurrence for OEIS A221246, proved by transfer matrix}
...
\begin{abstract}
OEIS A221246 counts the distinct OCCUPANCY arrays obtained when every cell of an $n\times2$ grid
...
determinising the machine that emits the occupancy row by row turns it into one, on $S=101$
...
OEIS A221246 is ``Number of 2 X n arrays of occupancy after each element moves to some horizontal, diagonal or antidiagonal neighbor.''. It has offset $1$ and begins
\[
0, 9, 50, 484, 3864, 32400, 267264, 2214144,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 9*a(n-1) - 54*a(n-3) + 36*a(n-4) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 04 2018 14:32:42, revision 9) this is still
...
\]
There are $S=101$ reachable sets. In particular $a$ is $C$-finite.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221246.
