...
\title{The empirical recurrence for OEIS A250389, proved from an exact model}
...
\begin{abstract}
OEIS A250389 carries an empirical recurrence of order $7$. It is true, and it is
...
OEIS A250389 is ``Number of length 3+3 0..n arrays with no four consecutive terms having the maximum of any two terms equal to the minimum of the remaining two terms.''. It has offset $1$ and begins
\[
6, 146, 1208, 5848, 20518, 58114, 141344, 306816,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = n\^{}6 + (16/15)*n\^{}5 + (13/6)*n\^{}4 + (5/3)*n\^{}3 - (1/6)*n\^{}2 + (4/15)*n. a(n) = 7*a(n-1) - 21*a(n-2) + 35*a(n-3) - 35*a(n-4) + 21*a(n-5) - 7*a(n-6) + a(n-7) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 21 2017 05:50:38, revision 8)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250389.
