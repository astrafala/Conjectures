...
\title{The empirical recurrence for OEIS A220250, proved by transfer matrix}
...
\begin{abstract}
OEIS A220250 counts the distinct indicator arrays obtained from the $n\times2$ arrays over
...
indicator row by row turns it into one, on $S=18$ states, after which the conjectured
...
\[
2, 16, 48, 256, 928, 4096, 15872, 65536,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n)=4*a(n-1)+8*a(n-2)-32*a(n-3)-16*a(n-4)+64*a(n-5)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 18:37:42, revision 12) this is still
...
\]
There are $S=18$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite. Note
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A220250.
