...
\title{Recovering the unwritten recurrences of the table OEIS A237921}
...
\begin{abstract}
OEIS A237921 is a two-dimensional table $T(n,k)$ whose empirical recurrences are, for several of
its lines, given only as an ORDER --- ``k=2: [order 56]'' and the like --- with the
...
OEIS A237921 is ``T(n,k)=Number of (n+1)X(k+1) 0..3 arrays with the upper median plus the lower median of every 2X2 subblock differing from its horizontal and vertical neighbors by exactly one.''. It is read by antidiagonals and begins
\[
256, 1584, 1584, 9892, 14564, 9892, 63476, 133528,\ \dots
\]
The entry carries, among its empirical claims:
\begin{quote}\small
k=2: [order 56]
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 10:35:22, revision 6) these are still
...
count, a walk on $S=1584$ vertices. Berlekamp--Massey on $2S=3168$ exact terms
returns a minimal recurrence of order $56$ --- the order the entry states --- with
integer coefficients
\[
(c_1,\dots,c_{56})=(0,\ 2,\ 255,\ 3757,\ 13616,\ 47401,\ -25505,\ -932370,\ -3860895,\ -11545724,\ -1524360,\ 96190333,\ 332844966,\ 737564667,\ -150051033,\ -4850870369,\ -11601614555,\ -18892092770,\ 10967563098,\ 106856146054,\ 168211373723,\ 209254201183,\ -139106691068,\ -889917877073,\ -824567552453,\ -1319850041908,\ -521617085467,\ 2134581812927,\ 1641700608949,\ 9430103990677,\ 7369677987952,\ -4478125311899,\ 6690181097568,\ -24022145387087,\ -34064906872771,\ 9777677742276,\ -7457253550017,\ 3695674195173,\ 38962336451681,\ -7365829224566,\ -9071328727397,\ 4641830369912,\ -9299219232096,\ 2468687420723,\ 2493601672060,\ -1288883254306,\ 830987890634,\ -353617333640,\ -282644584056,\ 156533573296,\ -67009111424,\ 33082422880,\ 1918348800,\ -2929969152,\ 393615360,\ -190218240).
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237921.
