...
\title{The empirical recurrence for OEIS A269410, proved by transfer matrix}
...
\begin{abstract}
OEIS A269410 carries an empirical recurrence of order $5$ contributed by R.~H.~Hardin. It is
...
\[
9, 63, 222, 570, 1215, 2289, 3948, 6372,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = n\^{}4 + 4*n\^{}3 + (7/2)*n\^{}2 + (1/2)*n.
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 21 2019 10:06:51, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269410.
