...
\title{A proof of the conjectured recurrence for OEIS A157328}
...
\begin{abstract}
OEIS A157328 carries a conjectured linear recurrence with polynomial coefficients, of
...
OEIS A157328 is ``Expansion of 1/(1-2x*c(4x)) with c(x) g.f. of Catalan numbers (A000108)''. It has offset $0$ and begins
\[
a(0),\dots,a(7)\;=\;1, 2, 12, 104, 1072, 12192, 147648, 1867392,\ \dots
\]
The entry gives the generating function
\begin{equation}\label{eq:gf}
A(x)\;=\;\sum_{n\ge 0} a(n)\,x^{n}\;=\;\frac{4}{\sqrt{1 - 16 x} + 3} ,
\end{equation}
and it carries the following comment:
\begin{quote}\small
\textbf{Conjecture:} n*a(n) +2*(12-7n)*a(n-1) +16*(3-2n)*a(n-2) = 0. - \emph{R. J. Mathar}, Dec 14 2011
\end{quote}
As of the ``Last modified'' line on the live entry (2025-02-04, revision 20) the
...
\[
p_{0}(n)=n,\qquad p_{1}(n)=- 2 \left(7 n - 12\right),\qquad p_{2}(n)=- 16 \left(2 n - 3\right)
\]
...
\section{The computation for A157328}
...
\[
n\,a(n) -  2 \left(7 n - 12\right)\,a(n-1) -  16 \left(2 n - 3\right)\,a(n-2) \;=\;0
\]
holds for every $n>1$.
\end{theorem}
...
section of A157328, agreeing on all 13 terms compared.
...
\url{https://oeis.org}, 2026. Sequence A157328.
