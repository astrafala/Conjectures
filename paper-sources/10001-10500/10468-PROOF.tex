...
\title{The empirical recurrence for OEIS A183690, proved by transfer matrix}
...
\begin{abstract}
OEIS A183690 counts arrays over $\{0,\dots,2\}$ under a condition on the determinant of every
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 04 2018 10:48:15, revision 9) this is still
...
first term is $50$, and the model reproduces it along with every later term; that is the
