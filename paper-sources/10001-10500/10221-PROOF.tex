...
\title{The empirical recurrence for OEIS A183898, derived from the entry's generating function}
...
\begin{abstract}
OEIS A183898 carries an empirical recurrence of order $4$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 05 2018 10:27:29, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{8 x^{5} - 18 x^{4} + 12 x^{3} - 6 x^{2} + 5 x}{x^{4} - 4 x^{3} + 6 x^{2} - 4 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;8 x^{5} - 18 x^{4} + 12 x^{3} - 6 x^{2} + 5 x,
\]
