...
\title{The empirical recurrence for OEIS A206505, proved by transfer matrix}
...
\begin{abstract}
OEIS A206505 counts arrays of width $2$ over $\{0,1,2\}$ subject to a condition read round the
...
OEIS A206505 is ``Number of (n+1) X 2 0..2 arrays with the number of clockwise edge increases in 2 X 2 subblocks nondecreasing rightwards and downwards.''. It has offset $1$ and begins
\[
81, 549, 3399, 19797, 111495, 614367, 3337695, 17958813,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 9*a(n-1) - 18*a(n-2) - 15*a(n-3) + 36*a(n-4) - 20*a(n-5) + 11*a(n-6) - 2*a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 17 2018 05:51:32, revision 9) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206505.
