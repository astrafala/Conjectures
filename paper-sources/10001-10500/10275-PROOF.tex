...
\title{The empirical recurrence for OEIS A253362, proved by transfer matrix}
...
\begin{abstract}
OEIS A253362 counts arrays of width $5$ over $\{0,1\}$ in which the largest entry on the main diagonal minus the smallest on the antidiagonal of every $2\times2$ and $3\times3$ subblock differs from the same number at the neighbouring subblock. The entry carries an
...
$4$ consecutive rows and the count is a walk count on $S=825$ states.
\end{abstract}
...
OEIS A253362 is ``Number of (n+2) X (3+2) 0..1 arrays with every 2 X 2 and 3 X 3 subblock diagonal maximum minus antidiagonal minimum unequal to its neighbors horizontally and vertically.''. It has offset $1$ and begins
\[
560, 960, 2992, 5280, 13800, 27072, 63496, 130464,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 7*a(n-2) - 15*a(n-4) + 17*a(n-6) + 16*a(n-8) for n>11.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 11 2018 08:43:23, revision 7) this is still
...
Thus
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=825,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253362.
