...
\title{The empirical recurrence for OEIS A256022, proved by transfer matrix}
...
\begin{abstract}
OEIS A256022 counts $(n+2)\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A256022 is ``Number of (n+2) X (1+2) 0..1 arrays with no 3 x 3 subblock diagonal sum 0 or 1 and no antidiagonal sum 0 or 1 and no row sum 1 and no column sum 1.''. It has offset $1$ and begins
\[
33, 68, 154, 352, 798, 1804, 4086, 9304,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) -a(n-2) +4*a(n-3) -2*a(n-6) -4*a(n-7) +2*a(n-9) for n>10.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 20 2018 10:16:59, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) - a(n-2) + 4\,a(n-3) - 2\,a(n-6) - 4\,a(n-7) + 2\,a(n-9)
\]
for every $n>10$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A256022.
