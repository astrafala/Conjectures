...
\title{The empirical recurrence for OEIS A302164, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A302164 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A302164 is ``Number of 2Xn 0..1 arrays with every element equal to 0, 1 or 3 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
2, 3, 9, 17, 25, 65, 185, 385,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +16*a(n-4) -8*a(n-5) for n>6
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 02 2018 14:50:06, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 16\,a(n-4) - 8\,a(n-5)
\end{equation}
for all $n>6$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302164.
