...
\title{The empirical recurrence for OEIS A269692, derived from the entry's generating function}
...
\begin{abstract}
OEIS A269692 carries an empirical recurrence of order $7$. The entry separately records a
...
OEIS A269692 is ``Number of length-6 0..n arrays with no repeated value differing from the previous repeated value by plus or minus one modulo n+1.''. It has offset $1$ and begins
\[
40, 525, 3544, 14465, 44556, 114205, 256880, 523809,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 28 2019 09:51:49, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{20 x^{8} - 141 x^{7} + 427 x^{6} - 750 x^{5} + 718 x^{4} - 709 x^{3} - 245 x^{2} - 40 x}{x^{7} - 7 x^{6} + 21 x^{5} - 35 x^{4} + 35 x^{3} - 21 x^{2} + 7 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 20 x^{8} + 141 x^{7} - 427 x^{6} + 750 x^{5} - 718 x^{4} + 709 x^{3} + 245 x^{2} + 40 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269692.
