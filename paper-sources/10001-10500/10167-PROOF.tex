...
\title{The empirical recurrence for OEIS A236991, proved by transfer matrix}
...
\begin{abstract}
OEIS A236991 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
OEIS A236991 is ``Number of (n+1)X(2+1) 0..2 arrays with the maximum plus the lower median minus the upper median minus the minimum of every 2X2 subblock differing from its horizontal and vertical neighbors by exactly one.''. It has offset $1$ and begins
\[
360, 2376, 15552, 104976, 699840, 4618944, 30233088, 204073344,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 1944*a(n-4)
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 09:43:50, revision 6) this is still
...
differ by $1$. The entry's first term $360$ counts those, and the model was made to
...
\]
over the $S=360$ pairs whose own subblock row already satisfies the condition along itself.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A236991.
