...
\title{The empirical recurrence for OEIS A269469, derived from the entry's generating function}
...
\begin{abstract}
OEIS A269469 carries an empirical recurrence of order $6$. The entry separately records a
...
OEIS A269469 is ``Number of length-5 0..n arrays with no repeated value equal to the previous repeated value.''. It has offset $1$ and begins
\[
14, 174, 852, 2780, 7170, 15834, 31304, 56952,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 23 2019 07:18:50, revision 7) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 2 x^{4} + 18 x^{3} + 90 x^{2} + 14 x}{x^{6} - 6 x^{5} + 15 x^{4} - 20 x^{3} + 15 x^{2} - 6 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 2 x^{4} + 18 x^{3} + 90 x^{2} + 14 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269469.
