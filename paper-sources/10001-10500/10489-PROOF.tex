...
\title{The empirical recurrence for OEIS A253006, derived from the entry's generating function}
...
\begin{abstract}
OEIS A253006 carries an empirical recurrence of order $4$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 08 2018 05:28:47, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{4 x^{10} + 44 x^{9} + 385 x^{8} + 694 x^{7} + 422 x^{6} + 50 x^{5} + x^{4}}{x^{4} - 4 x^{3} + 6 x^{2} - 4 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;4 x^{10} + 44 x^{9} + 385 x^{8} + 694 x^{7} + 422 x^{6} + 50 x^{5} + x^{4},
\]
