...
\title{The empirical recurrence for OEIS A236664, proved by transfer matrix}
...
\begin{abstract}
OEIS A236664 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
OEIS A236664 is ``Number of (n+1) X (1+1) 0..2 arrays colored with the maximum plus the lower median minus the upper median minus the minimum of every 2 X 2 subblock.''. It has offset $1$ and begins
\[
81, 452, 2608, 14760, 84948, 484400, 2771648, 15802528,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + 436*a(n-4) + 888*a(n-5) + 2304*a(n-6) + 5760*a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 21 2018 13:44:47, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 436\,a(n-4) + 888\,a(n-5) + 2304\,a(n-6) + 5760\,a(n-7)
\]
for every $n>7$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A236664.
