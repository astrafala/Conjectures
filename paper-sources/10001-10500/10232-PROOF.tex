...
\title{The empirical recurrence for OEIS A206113, proved by transfer matrix}
...
\begin{abstract}
OEIS A206113 counts arrays over $\{0,\dots,3\}$ under a condition on the perimeter cycle of
...
a bounded window of consecutive rows, so the count is a walk count on $S=6028$ states and is
...
OEIS A206113 is ``Number of (n+1) X 4 0..3 arrays with every 2 X 3 or 3 X 2 subblock having exactly two counterclockwise and two clockwise edge increases.''. It has offset $1$ and begins
\[
6028, 22624, 88596, 520800, 2408480, 10792800, 59892000, 276975200,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 115*a(n-3) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 11 2015 11:54:41, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206113.
