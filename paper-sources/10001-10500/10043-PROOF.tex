...
\title{The empirical recurrence for OEIS A300541, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A300541 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A300541 is ``Number of nX3 0..1 arrays with every element equal to 1, 2, 3 or 4 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
1, 11, 71, 450, 2879, 18365, 117146, 747252,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 5*a(n-1) +9*a(n-2) -8*a(n-4) -3*a(n-5) +4*a(n-6) +4*a(n-7) +2*a(n-8) for n>10
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 08 2018 12:31:25, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) + 9\,a(n-2) - 8\,a(n-4) - 3\,a(n-5) + 4\,a(n-6) + 4\,a(n-7) + 2\,a(n-8)
\end{equation}
for all $n>10$.
...
\#\{\text{neighbours with a value }equal to\ x_{t,u}\}\in\{1,2,3,4\}
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A300541.
