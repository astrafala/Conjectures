...
\title{The empirical recurrence for OEIS A183325, proved by transfer matrix}
...
\begin{abstract}
OEIS A183325 counts arrays of width $4$ over $\{0,1\}$ under local conditions relating each cell
...
OEIS A183325 is ``Number of n X 4 binary arrays with each 1 adjacent to exactly two other 1s.''. It has offset $1$ and begins
\[
1, 4, 10, 27, 72, 179, 447, 1139,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) - 2*a(n-2) + 2*a(n-3) + 2*a(n-5) - 5*a(n-7) - 3*a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 27 2018 08:49:44, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) - 2\,a(n-2) + 2\,a(n-3) + 2\,a(n-5) - 5\,a(n-7) - 3\,a(n-8)
\]
for every $n>7$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A183325.
