...
\title{The empirical recurrence for OEIS A206056, proved by transfer matrix}
...
\begin{abstract}
OEIS A206056 counts arrays over $\{0,\dots,3\}$ under a condition on the perimeter cycle of
every $2\times3$ and $3\times2$ subblock, and carries an empirical recurrence of order $9$ contributed by
...
OEIS A206056 is ``Number of (n+1)X2 0..3 arrays with every 2X3 or 3X2 subblock having exactly two clockwise edge increases.''. It has offset $1$ and begins
\[
256, 2184, 19832, 170688, 1499080, 13136860, 114770680, 1005245456,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) +34*a(n-2) +145*a(n-3) -18*a(n-4) -2*a(n-5) +11*a(n-6) +6*a(n-7) +2*a(n-8) +4*a(n-9) for n>10
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 12:25:22, revision 9) this is still
...
of every window of either shape that its number of clockwise edge increases is exactly $2$.
...
nonexistent $2\times3$ windows apply; the entry's first term is
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + 34\,a(n-2) + 145\,a(n-3) - 18\,a(n-4) - 2\,a(n-5) + 11\,a(n-6) + 6\,a(n-7) + 2\,a(n-8) + 4\,a(n-9)
\]
for every $n>10$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206056.
