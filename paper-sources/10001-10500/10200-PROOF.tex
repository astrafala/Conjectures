...
\title{The empirical recurrence for OEIS A253507, derived from the entry's generating function}
...
\begin{abstract}
OEIS A253507 carries an empirical recurrence of order $5$. The entry separately records a
...
OEIS A253507 is ``Number of (n+2) X (5+2) 0..1 arrays with every 2 X 2 and 3 X 3 subblock diagonal maximum minus antidiagonal minimum nondecreasing horizontally and vertically.''. It has offset $1$ and begins
\[
884, 1712, 3052, 5136, 7948, 11740, 16592, 22720,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 17 2018 08:13:42, revision 7) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{4 x^{13} - 12 x^{12} + 40 x^{11} - 92 x^{10} + 176 x^{9} - 308 x^{8} + 440 x^{7} - 516 x^{6} - 88 x^{5} + 1844 x^{4} - 3332 x^{3} + 2708 x^{2} - 884 x}{x^{5} - 5 x^{4} + 10 x^{3} - 10 x^{2} + 5 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 4 x^{13} + 12 x^{12} - 40 x^{11} + 92 x^{10} - 176 x^{9} + 308 x^{8} - 440 x^{7} + 516 x^{6} + 88 x^{5} - 1844 x^{4} + 3332 x^{3} - 2708 x^{2} + 884 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253507.
