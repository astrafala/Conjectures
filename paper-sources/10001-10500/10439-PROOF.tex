...
\title{The empirical recurrence for OEIS A236049, proved by transfer matrix}
...
\begin{abstract}
OEIS A236049 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
The condition is local to two consecutive rows, so the count is a walk count on $S=292$
...
OEIS A236049 is ``Number of (n+1) X (2+1) 0..2 arrays colored with the difference of the maximum and minimum in each 2 X 2 subblock.''. It has offset $1$ and begins
\[
292, 1068, 3516, 11656, 38700, 128920, 429252, 1429352,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + 4*a(n-2) + 5*a(n-3) + 21*a(n-4) + 12*a(n-5) + 4*a(n-6) for n>9.
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 20 2018 11:02:16, revision 7) this is still
...
\]
over the $S=292$ pairs whose own subblock row is properly coloured.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A236049.
