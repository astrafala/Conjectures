...
\title{The empirical recurrence for OEIS A255751, proved by transfer matrix}
...
\begin{abstract}
OEIS A255751 counts the arrays over $\{0,\dots,1\}$ whose $3\times3$ subblocks carry a
...
OEIS A255751 is ``Number of (n+2)X(3+2) 0..1 arrays with every 3X3 subblock sum of the medians of the diagonal and antidiagonal minus the two sums of the central row and column nondecreasing horizontally, vertically and ne-to-sw antidiagonally.''. It has offset $1$ and begins
\[
8776, 24536, 51064, 71651, 81494, 108201, 145536, 211742,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) -a(n-2) +4*a(n-4) -8*a(n-5) +4*a(n-6) for n>18
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 15:11:25, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A255751.
