...
\title{The empirical recurrence for OEIS A208598, derived from the entry's generating function}
...
\begin{abstract}
OEIS A208598 carries an empirical recurrence of order $4$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 18 2018 15:18:12, revision 12) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{4} + 4 x^{3} - x^{2} + 6 x}{x^{4} - 4 x^{3} + 6 x^{2} - 4 x + 1},
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208598.
