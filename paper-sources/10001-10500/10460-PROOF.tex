...
\title{The empirical recurrence for OEIS A206203, proved by transfer matrix}
...
\begin{abstract}
OEIS A206203 counts arrays over $\{0,\dots,3\}$ under a condition on the perimeter cycle of
every $2\times3$ and $3\times2$ subblock, and carries an empirical recurrence of order $3$ contributed by
R.~H.~Hardin. It is true, and it is decidable rather than empirical. The condition is local to
a bounded window of consecutive rows, so the count is a walk count on $S=29724$ states and is
...
OEIS A206203 is ``Number of (n+1)X6 0..3 arrays with every 2X3 or 3X2 subblock having exactly one clockwise edge increases.''. It has offset $1$ and begins
\[
29724, 22576, 27400, 70168, 118936, 236488, 713408, 1226384,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 10*a(n-3) for n>15
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 12:46:57, revision 9) this is still
...
of every window of either shape that its number of clockwise edge increases is exactly $1$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206203.
