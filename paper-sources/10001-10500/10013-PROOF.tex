...
\title{The empirical recurrence for OEIS A301965, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A301965 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A301965 is ``Number of 3Xn 0..1 arrays with every element equal to 0, 1 or 4 horizontally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
4, 13, 16, 25, 41, 74, 132, 239,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) -a(n-4) for n>6
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 29 2018 13:02:49, revision 4) the statement is
...
publishes, $n=33$, the arrays have $3\cdot33$ cells over
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A301965.
