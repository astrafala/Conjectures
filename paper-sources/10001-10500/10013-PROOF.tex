...
\title{The empirical recurrence for OEIS A229448, derived from the entry's generating function}
...
\begin{abstract}
OEIS A229448 carries an empirical recurrence of order $6$. The entry separately records a
...
OEIS A229448 is ``Number of 5 X n 0..2 arrays with horizontal differences mod 3 never 1, vertical differences mod 3 never -1, and rows and columns lexicographically nondecreasing.''. It has offset $1$ and begins
\[
17, 47, 128, 324, 753, 1609, 3184, 5890,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 05 2022 12:13:26, revision 12) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 6 x^{6} + 44 x^{5} - 79 x^{4} + 101 x^{3} - 55 x^{2} + 17 x}{x^{6} - 6 x^{5} + 15 x^{4} - 20 x^{3} + 15 x^{2} - 6 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 6 x^{6} + 44 x^{5} - 79 x^{4} + 101 x^{3} - 55 x^{2} + 17 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A229448.
