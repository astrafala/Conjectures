...
\title{The empirical recurrence for OEIS A266461, derived from the entry's generating function}
...
\begin{abstract}
OEIS A266461 carries an empirical recurrence of order $6$. The entry separately records a
...
OEIS A266461 is ``Decimal representation of the n-th iteration of the "Rule 27" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 5, 2, 123, 4, 2039, 8, 32751,\ \dots
\]
...
\begin{quote}
G.f.: (1+5*x-17*x\^{}2+28*x\^{}3+16*x\^{}4-48*x\^{}5) / ((1-x)*(1+x)*(1-4*x)*(1+4*x)*(1-2*x\^{}2)).
\end{quote}
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{48 x^{5} - 16 x^{4} - 28 x^{3} + 17 x^{2} - 5 x - 1}{32 x^{6} - 50 x^{4} + 19 x^{2} - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 48 x^{5} + 16 x^{4} + 28 x^{3} - 17 x^{2} + 5 x + 1,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A266461.
