...
\title{The empirical recurrence for OEIS A232332, proved by transfer matrix}
...
\begin{abstract}
OEIS A232332 counts arrays of width $5$ over $\{0,1,2\}$ in which every cell carrying one stated
...
OEIS A232332 is ``Number of n X 5 0..2 arrays with every 0 next to a 1 and every 1 next to a 2 horizontally or antidiagonally, with no adjacent elements equal.''. It has offset $1$ and begins
\[
10, 82, 628, 4906, 38986, 312276, 2510674, 20221026,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 11*a(n-1) - 21*a(n-2) - 20*a(n-3) - 12*a(n-4) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 04 2018 11:50:28, revision 8) this is still
...
adjacency matrix,
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=2068.
\]
...
\begin{theorem}
\[
a(n)\;=\;11\,a(n-1) - 21\,a(n-2) - 20\,a(n-3) - 12\,a(n-4)
\]
for every $n>5$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232332.
