...
\title{The empirical recurrence for OEIS A221543, derived from the entry's generating function}
...
\begin{abstract}
OEIS A221543 carries an empirical recurrence of order $5$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 08 2018 07:55:51, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{x^{8} - 6 x^{7} + 18 x^{6} - 26 x^{5} + 22 x^{4} - 23 x^{3} - 7 x^{2} - 3 x}{x^{5} - 5 x^{4} + 10 x^{3} - 10 x^{2} + 5 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- x^{8} + 6 x^{7} - 18 x^{6} + 26 x^{5} - 22 x^{4} + 23 x^{3} + 7 x^{2} + 3 x,
\]
