...
\title{The empirical recurrence for OEIS A268459, derived from the entry's generating function}
...
\begin{abstract}
OEIS A268459 carries an empirical recurrence of order $6$. The entry separately records a
...
OEIS A268459 is ``Number of length-5 0..n arrays with no adjacent pair x,x+1 followed at any distance by x+1,x.''. It has offset $1$ and begins
\[
16, 176, 852, 2776, 7160, 15816, 31276, 56912,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 14 2019 03:09:39, revision 12) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{4 x^{5} - 16 x^{4} + 36 x^{3} + 80 x^{2} + 16 x}{x^{6} - 6 x^{5} + 15 x^{4} - 20 x^{3} + 15 x^{2} - 6 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;4 x^{5} - 16 x^{4} + 36 x^{3} + 80 x^{2} + 16 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268459.
