...
\title{The empirical recurrence for OEIS A211851, derived from the entry's generating function}
...
\begin{abstract}
OEIS A211851 carries an empirical recurrence of order $5$. The entry separately records a
...
OEIS A211851 is ``Number of nonnegative integer arrays of length 2n+6 with new values 0 upwards introduced in order, no three adjacent elements all unequal, and containing the value n+1.''. It has offset $1$ and begins
\[
196, 561, 1302, 2619, 4755, 7996, 12671, 19152,\ \dots
\]
...
\begin{quote}
G.f.: x*(196 - 419*x + 457*x\^{}2 - 241*x\^{}3 + 50*x\^{}4) / (1 - x)\^{}5.
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 20 2018 08:01:58, revision 7) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 50 x^{5} + 241 x^{4} - 457 x^{3} + 419 x^{2} - 196 x}{x^{5} - 5 x^{4} + 10 x^{3} - 10 x^{2} + 5 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;50 x^{5} - 241 x^{4} + 457 x^{3} - 419 x^{2} + 196 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A211851.
