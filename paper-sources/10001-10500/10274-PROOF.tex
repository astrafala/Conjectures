...
\title{The empirical recurrence for OEIS A229447, derived from the entry's generating function}
...
\begin{abstract}
OEIS A229447 carries an empirical recurrence of order $5$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 17 2018 08:31:54, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 7 x^{5} + 26 x^{4} - 48 x^{3} + 35 x^{2} - 12 x}{x^{5} - 5 x^{4} + 10 x^{3} - 10 x^{2} + 5 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;7 x^{5} - 26 x^{4} + 48 x^{3} - 35 x^{2} + 12 x,
\]
