...
\title{The empirical recurrence for OEIS A204480, proved by transfer matrix}
...
\begin{abstract}
OEIS A204480 counts $(n+2)\times7$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A204480 is ``Number of (n+2)X7 0..3 arrays with every 3X3 subblock having three equal elements in a row horizontally, vertically or nw-to-se diagonally exactly three ways, and new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
7191, 8114, 2632, 3270, 6494, 11338, 35990, 132258,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 11:14:44, revision 9) this is still
...
$u_1,u_2,\dots$ over $\{0,\dots,3\}^{7}$, the condition
\[
...
\]
on $S=44927$ vertices in total, the exponent fixed by the entry's own shape and checked against
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204480.
