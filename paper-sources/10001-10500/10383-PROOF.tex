...
\title{The empirical recurrence for OEIS A187288, derived from the entry's generating function}
...
\begin{abstract}
OEIS A187288 carries an empirical recurrence of order $3$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 22 2018 17:48:17, revision 10) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{12 x^{6} - 4 x^{5} - 28 x^{4} - 84 x^{3} - 8 x^{2}}{x^{3} - 3 x^{2} + 3 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 12 x^{6} + 4 x^{5} + 28 x^{4} + 84 x^{3} + 8 x^{2},
\]
