...
\title{The empirical recurrence for OEIS A184541, derived from the entry's generating function}
...
\begin{abstract}
OEIS A184541 carries an empirical recurrence of order $5$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 25 2021 05:09:59, revision 11) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 22 x^{5} + 123 x^{4} - 265 x^{3} + 252 x^{2} - 89 x}{x^{5} - 5 x^{4} + 10 x^{3} - 10 x^{2} + 5 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;22 x^{5} - 123 x^{4} + 265 x^{3} - 252 x^{2} + 89 x,
\]
