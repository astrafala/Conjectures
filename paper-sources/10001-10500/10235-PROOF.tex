...
\title{The empirical recurrence for OEIS A199944, derived from the entry's generating function}
...
\begin{abstract}
OEIS A199944 carries an empirical recurrence of order $5$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 17 2018 09:11:58, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{26 x^{4} + 38 x^{3} + 30 x^{2} + 2 x}{x^{5} - 3 x^{4} + 2 x^{3} + 2 x^{2} - 3 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;26 x^{4} + 38 x^{3} + 30 x^{2} + 2 x,
\]
