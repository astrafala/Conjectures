...
\title{The empirical recurrence for OEIS A188819, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A188819 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A188819 is ``Number of n X 3 binary arrays without the pattern 0 1 diagonally or antidiagonally.''. It has offset $1$ and begins
\[
8, 25, 48, 81, 120, 169, 224, 289,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) - 2*a(n-3) + a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 29 2018 08:46:46, revision 9) the statement is
...
publishes, $n=46$, the arrays have $3\cdot46$ cells over
...
every one of the $46$ published indices, with no shift fitted: the number of rows is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A188819.
