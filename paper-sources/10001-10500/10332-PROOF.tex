...
\title{The empirical recurrence for OEIS A202595, proved by transfer matrix}
...
\begin{abstract}
OEIS A202595 counts arrays of width $4$ over $\{0,1\}$ containing no occurrence of certain short
...
OEIS A202595 is ``Number of (n+2) X 4 binary arrays avoiding patterns 001 and 000 in rows and columns.''. It has offset $1$ and begins
\[
510, 3150, 18160, 107510, 629790, 3704980, 21758550, 127872530,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) +22*a(n-2) +12*a(n-3) -43*a(n-4) -8*a(n-5) +18*a(n-6) -a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 01 2018 10:35:22, revision 12) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 22\,a(n-2) + 12\,a(n-3) - 43\,a(n-4) - 8\,a(n-5) + 18\,a(n-6) - a(n-8)
\]
for every $n>6$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A202595.
