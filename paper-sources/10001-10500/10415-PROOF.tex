...
\title{The empirical recurrence for OEIS A204609, proved by transfer matrix}
...
\begin{abstract}
OEIS A204609 counts arrays over $\{0,\dots,1\}$ under a condition on the determinant of every
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 20 2018 07:38:48, revision 13) this is still
