...
\title{The empirical recurrence for OEIS A250784, proved by transfer matrix}
...
\begin{abstract}
OEIS A250784 carries an empirical recurrence of order $4$ contributed by R.~H.~Hardin. It is
...
OEIS A250784 is ``Number of (2+1) X (n+1) 0..1 arrays with nondecreasing x(i,j)+x(i,j-1) in the i direction and nondecreasing absolute value of x(i,j)-x(i-1,j) in the j direction.''. It has offset $1$ and begins
\[
18, 46, 106, 238, 518, 1106, 2326, 4838,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) - 4*a(n-2) - a(n-3) + 2*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 19 2018 12:58:41, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250784.
