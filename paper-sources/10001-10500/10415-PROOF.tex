...
\title{The empirical recurrence for OEIS A278183, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A278183 counts arrays over $\{0,\dots,3\}$ in which every cell is constrained by the
...
OEIS A278183 is ``Number of n X 2 0..3 arrays with every element plus 1 mod 4 equal to some element at offset (-1,-1) (-1,0) (-1,1) (0,-1) (0,1) or (1,0), with upper left element zero.''. It has offset $1$ and begins
\[
0, 3, 28, 200, 1532, 11794, 90538, 695252,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 8*a(n-1) - 4*a(n-2) + 15*a(n-3) - 26*a(n-4) + 14*a(n-5) - 16*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 08 2019 12:30:03, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;8\,a(n-1) - 4\,a(n-2) + 15\,a(n-3) - 26\,a(n-4) + 14\,a(n-5) - 16\,a(n-6)
\end{equation}
for all $n>7$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A278183.
