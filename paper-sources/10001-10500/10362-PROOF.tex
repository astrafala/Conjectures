...
\title{The empirical recurrence for OEIS A135231, derived from the entry's generating function}
...
\begin{abstract}
OEIS A135231 carries an empirical recurrence of order $3$. The entry separately records a
...
OEIS A135231 is ``Row sums of triangle A135230.''. It has offset $0$ and begins
\[
1, 2, 4, 6, 12, 22, 44, 86,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 03 2026 10:22:53, revision 14) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 2 x^{3} - x^{2} + 1}{2 x^{3} - x^{2} - 2 x + 1},
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A135231.
