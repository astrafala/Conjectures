...
\title{The empirical recurrence for OEIS A199532, derived from the entry's generating function}
...
\begin{abstract}
OEIS A199532 carries an empirical recurrence of order $5$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 15 2018 20:43:57, revision 9) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{6 x^{4} - 44 x^{3} - 160 x^{2} - 32 x}{x^{5} - 5 x^{4} + 10 x^{3} - 10 x^{2} + 5 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 6 x^{4} + 44 x^{3} + 160 x^{2} + 32 x,
\]
