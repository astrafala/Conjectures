...
\title{The empirical recurrence for OEIS A187170, derived from the entry's generating function}
...
\begin{abstract}
OEIS A187170 carries an empirical recurrence of order $4$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 05 2022 22:12:08, revision 14) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{294 x^{11} + 5016 x^{10} + 27750 x^{9} + 27456 x^{8} - 197424 x^{7} - 224016 x^{6} + 1176408 x^{5} + 1345296 x^{4} + 167016 x^{3}}{x^{4} - 4 x^{3} + 6 x^{2} - 4 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;294 x^{11} + 5016 x^{10} + 27750 x^{9} + 27456 x^{8} - 197424 x^{7} - 224016 x^{6} + 1176408 x^{5} + 1345296 x^{4} + 167016 x^{3},
\]
