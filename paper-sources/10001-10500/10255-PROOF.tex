...
\title{The empirical recurrence for OEIS A260200, proved by transfer matrix}
...
\begin{abstract}
OEIS A260200 counts $(n+2)\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
every $3\times3$ subblock, and it carries an empirical recurrence of order $5$
...
OEIS A260200 is ``Number of (n+2) X (1+2) 0..1 arrays with each 3 X 3 subblock having clockwise perimeter pattern 00000000 00000001 or 00010001.''. It has offset $1$ and begins
\[
26, 44, 106, 220, 478, 1044, 2274, 4940,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + a(n-2) - 2*a(n-4) - 2*a(n-5) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 28 2018 09:06:51, revision 7) this is still
...
\begin{proof}
The vector $w=q(M)\mathbf{1}$ was formed by $5$ matrix--vector products in exact
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A260200.
