...
\title{The empirical recurrence for OEIS A185761, proved by transfer matrix}
...
\begin{abstract}
OEIS A185761 carries an empirical recurrence of order $2$ contributed by R.~H.~Hardin. It is
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 22 2018 09:13:55, revision 8) this is still
