...
\title{The empirical recurrence for OEIS A252251, proved by transfer matrix}
...
\begin{abstract}
OEIS A252251 counts $(n+2)\times7$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
$a(n)$ is a walk count on $S=1125517$ vertices. Such a sequence is $C$-finite, so whether a given
...
OEIS A252251 is ``Number of (n+2) X (5+2) 0..3 arrays with every 3 X 3 subblock row and column sum not equal to 0 3 5 6 or 7 and every 3 X 3 diagonal and antidiagonal sum equal to 0 3 5 6 or 7.''. It has offset $1$ and begins
\[
463, 302, 279, 297, 327, 366, 414, 492,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + 3*a(n-3) - 3*a(n-4) - a(n-6) + a(n-7) for n>9.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 02 2018 14:26:31, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252251.
