...
\title{The empirical recurrence for OEIS A236148, proved by transfer matrix}
...
\begin{abstract}
OEIS A236148 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
OEIS A236148 is ``Number of (n+1) X (1+1) 0..2 arrays colored with the sets of distinct values in every 2 X 2 subblock.''. It has offset $1$ and begins
\[
81, 414, 2148, 11064, 57132, 294648, 1520856, 7845624,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + 18*a(n-2) + 16*a(n-3) + 12*a(n-4) - 12*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 20 2018 14:20:06, revision 7) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The $2\times2$ subblocks of an $(n+1)\times2$ array form an
$n\times1$ grid. Colour each of them by the SET of values occurring in it. ``Coloured with'' is the entry's way of
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 18\,a(n-2) + 16\,a(n-3) + 12\,a(n-4) - 12\,a(n-5)
\]
for every $n>5$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A236148.
