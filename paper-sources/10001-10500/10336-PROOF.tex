...
\title{The empirical recurrence for OEIS A257442, proved by transfer matrix}
...
\begin{abstract}
OEIS A257442 counts $(n+2)\times5$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A257442 is ``Number of (n+2) X (3+2) 0..1 arrays with no 3 x 3 subblock diagonal sum 0 and no antidiagonal sum 3 and no row sum 1 and no column sum 1.''. It has offset $1$ and begins
\[
39, 41, 47, 59, 77, 104, 143, 200,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) - a(n-2) + a(n-3) - a(n-4) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 21 2018 07:49:42, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A257442.
