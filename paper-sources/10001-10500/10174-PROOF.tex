...
\title{The empirical recurrence for OEIS A269680, derived from the entry's generating function}
...
\begin{abstract}
OEIS A269680 carries an empirical recurrence of order $6$. The entry separately records a
...
OEIS A269680 is ``Number of length-5 0..n arrays with no repeated value differing from the previous repeated value by other than plus or minus one modulo n+1.''. It has offset $1$ and begins
\[
14, 174, 820, 2670, 6918, 15358, 30504, 55710,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 26 2019 11:10:17, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 4 x^{7} + 26 x^{6} - 72 x^{5} + 80 x^{4} - 14 x^{3} + 90 x^{2} + 14 x}{x^{6} - 6 x^{5} + 15 x^{4} - 20 x^{3} + 15 x^{2} - 6 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 4 x^{7} + 26 x^{6} - 72 x^{5} + 80 x^{4} - 14 x^{3} + 90 x^{2} + 14 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269680.
