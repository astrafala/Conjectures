...
\title{The empirical recurrence for OEIS A232150, proved by transfer matrix}
...
\begin{abstract}
OEIS A232150 counts arrays of width $2$ over $\{0,1,2\}$ in which every cell carrying one stated
...
OEIS A232150 is ``Number of 2 X n 0..2 arrays with every 0 next to a 1 and every 1 next to a 2 horizontally, diagonally or antidiagonally.''. It has offset $1$ and begins
\[
1, 23, 191, 1299, 9097, 65837, 474721, 3410799,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 6*a(n-1) + 4*a(n-2) + 25*a(n-3) + 60*a(n-4) - 24*a(n-5) - 72*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2018 10:41:34, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) + 4\,a(n-2) + 25\,a(n-3) + 60\,a(n-4) - 24\,a(n-5) - 72\,a(n-6)
\]
for every $n>5$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232150.
