...
\title{The empirical recurrence for OEIS A266839, derived from the entry's generating function}
...
\begin{abstract}
OEIS A266839 carries an empirical recurrence of order $6$. The entry separately records a
...
OEIS A266839 is ``Decimal representation of the n-th iteration of the "Rule 67" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 4, 10, 97, 92, 1803, 736, 30815,\ \dots
\]
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{64 x^{9} - 192 x^{8} + 28 x^{7} + 172 x^{6} + 14 x^{5} + 6 x^{4} + 3 x^{3} + 15 x^{2} - 4 x - 1}{128 x^{6} - 152 x^{4} + 25 x^{2} - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 64 x^{9} + 192 x^{8} - 28 x^{7} - 172 x^{6} - 14 x^{5} - 6 x^{4} - 3 x^{3} - 15 x^{2} + 4 x + 1,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A266839.
