...
\title{The empirical recurrence for OEIS A298897, proved by transfer matrix}
...
\begin{abstract}
OEIS A298897 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A298897 is ``Number of nX3 0..1 arrays with every element equal to 3, 4, 5, 6 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
0, 1, 1, 2, 3, 7, 12, 25,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) +a(n-2) -2*a(n-3) +a(n-4) -2*a(n-5)
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 28 2018 09:17:53, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A298897.
