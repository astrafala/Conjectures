...
\title{The empirical recurrence for OEIS A298448, proved by transfer matrix}
...
\begin{abstract}
OEIS A298448 counts $2$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A298448 is ``Number of nX2 0..1 arrays with every element equal to 1, 3, 4, 5 or 6 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 4, 4, 16, 48, 88, 240, 704,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) +8*a(n-3) -8*a(n-4) -8*a(n-5)
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 19 2018 08:34:05, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A298448.
