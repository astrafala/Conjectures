...
\title{The empirical recurrence for OEIS A269609, derived from the entry's generating function}
...
\begin{abstract}
OEIS A269609 carries an empirical recurrence of order $7$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 25 2019 08:28:47, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{2 x^{7} - 24 x^{6} + 4 x^{5} + 100 x^{4} - 498 x^{3} - 292 x^{2} - 12 x}{x^{7} - 7 x^{6} + 21 x^{5} - 35 x^{4} + 35 x^{3} - 21 x^{2} + 7 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 2 x^{7} + 24 x^{6} - 4 x^{5} - 100 x^{4} + 498 x^{3} + 292 x^{2} + 12 x,
\]
