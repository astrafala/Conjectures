...
\title{The empirical recurrence for OEIS A266471, derived from the entry's generating function}
...
\begin{abstract}
OEIS A266471 carries an empirical recurrence of order $6$. The entry separately records a
...
OEIS A266471 is ``Number of 4 X n binary arrays with rows and columns lexicographically nondecreasing and column sums nonincreasing.''. It has offset $1$ and begins
\[
5, 12, 29, 66, 137, 261, 463, 775,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 10 2019 08:08:43, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{6} + 11 x^{5} - 28 x^{4} + 32 x^{3} - 18 x^{2} + 5 x}{x^{6} - 6 x^{5} + 15 x^{4} - 20 x^{3} + 15 x^{2} - 6 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- x^{6} + 11 x^{5} - 28 x^{4} + 32 x^{3} - 18 x^{2} + 5 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A266471.
