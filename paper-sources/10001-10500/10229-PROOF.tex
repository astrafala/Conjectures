...
\title{The empirical recurrence for OEIS A316948, proved by transfer matrix}
...
\begin{abstract}
OEIS A316948 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $different from$ itself lying in $\{1,2,3,4,5,6,7\}$, and it carries an empirical
...
OEIS A316948 is ``Number of nX3 0..1 arrays with every element unequal to 1, 2, 3, 4, 5, 6 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 25, 160, 1240, 9417, 71505, 543155, 4125662,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 6*a(n-1) +10*a(n-2) +15*a(n-3) +8*a(n-4) +3*a(n-5) +a(n-6) +2*a(n-7)
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 17 2018 12:21:16, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) + 10\,a(n-2) + 15\,a(n-3) + 8\,a(n-4) + 3\,a(n-5) + a(n-6) + 2\,a(n-7)
\end{equation}
for all $n>7$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A316948.
