...
\title{The empirical recurrence for OEIS A236990, proved by transfer matrix}
...
\begin{abstract}
OEIS A236990 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
OEIS A236990 is ``Number of (n+1)X(1+1) 0..2 arrays with the maximum plus the lower median minus the upper median minus the minimum of every 2X2 subblock differing from its horizontal and vertical neighbors by exactly one.''. It has offset $1$ and begins
\[
81, 360, 1600, 7200, 32400, 144000, 640000, 2880000,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 400*a(n-4)
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 09:43:43, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A236990.
