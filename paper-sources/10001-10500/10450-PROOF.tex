...
\title{The empirical recurrence for OEIS A252833, derived from the entry's generating function}
...
\begin{abstract}
OEIS A252833 carries an empirical recurrence of order $3$. The entry separately records a
...
OEIS A252833 is ``Number of n X 5 nonnegative integer arrays with upper left 0 and every value within 2 of its king move distance from the upper left and every value increasing by 0 or 1 with every step right, diagonally se or down.''. It has offset $1$ and begins
\[
11, 53, 288, 1474, 6068, 18528, 42738, 79563,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 06 2018 16:37:00, revision 7) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 15 x^{10} - 170 x^{9} - 865 x^{8} - 3884 x^{7} - 4458 x^{6} - 2457 x^{5} - 758 x^{4} - 162 x^{3} - 20 x^{2} - 11 x}{x^{3} - 3 x^{2} + 3 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;15 x^{10} + 170 x^{9} + 865 x^{8} + 3884 x^{7} + 4458 x^{6} + 2457 x^{5} + 758 x^{4} + 162 x^{3} + 20 x^{2} + 11 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252833.
