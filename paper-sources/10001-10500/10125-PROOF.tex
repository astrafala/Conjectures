...
\title{The empirical recurrence for OEIS A295842, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A295842 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A295842 is ``Number of n X 3 0..1 arrays with each 1 adjacent to 1 or 2 king-move neighboring 1s.''. It has offset $1$ and begins
\[
4, 29, 104, 467, 2197, 9645, 43335, 195508,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 4*a(n-1) + a(n-2) + 12*a(n-3) - 30*a(n-4) + 3*a(n-5) - 6*a(n-6) + 6*a(n-7) + 5*a(n-8) + 2*a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 22 2019 10:04:50, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) + a(n-2) + 12\,a(n-3) - 30\,a(n-4) + 3\,a(n-5) - 6\,a(n-6) + 6\,a(n-7) + 5\,a(n-8) + 2\,a(n-9)
\end{equation}
for all $n>10$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A295842.
