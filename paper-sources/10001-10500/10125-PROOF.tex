...
\title{The empirical recurrence for OEIS A305581, proved by transfer matrix}
...
\begin{abstract}
OEIS A305581 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A305581 is ``Number of nX3 0..1 arrays with every element unequal to 0, 1, 2, 7 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
4, 3, 6, 8, 19, 33, 60, 112,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +a(n-2) +a(n-3) for n>5
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 20 2018 11:12:54, revision
15) the statement is still recorded as empirical, and nothing on the entry
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A305581.
