...
\title{The empirical recurrence for OEIS A266460, derived from the entry's generating function}
...
\begin{abstract}
OEIS A266460 carries an empirical recurrence of order $6$. The entry separately records a
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{110000 x^{5} - 10000 x^{4} - 99900 x^{3} + 10001 x^{2} - 101 x - 1}{100000 x^{6} - 110010 x^{4} + 10011 x^{2} - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 110000 x^{5} + 10000 x^{4} + 99900 x^{3} - 10001 x^{2} + 101 x + 1,
\]
