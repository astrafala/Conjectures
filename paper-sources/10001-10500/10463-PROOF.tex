...
\title{The empirical recurrence for OEIS A235271, proved by transfer matrix}
...
\begin{abstract}
OEIS A235271 counts $2$-column arrays over $\{0,\dots,4\}$ in which every
...
OEIS A235271 is ``Number of (n+1) X (1+1) 0..4 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 5 (constant-stress 1 X 1 tilings).''. It has offset
$1$ and begins
\[
40, 100, 208, 520, 1120, 2800, 6208,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 10*a(n-2) - 24*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 20 2022 21:30:33, revision 12) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A235271.
