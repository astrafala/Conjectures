...
\title{The empirical recurrence for OEIS A203830, proved by transfer matrix}
...
\begin{abstract}
OEIS A203830 counts $(n+1)\times4$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A203830 is ``Number of (n+1) X 4 0..2 arrays with every 2 X 2 subblock having equal diagonal elements or equal antidiagonal elements.''. It has offset $1$ and begins
\[
1125, 17289, 270333, 4238721, 66490965, 1043088057, 16363800045, 256713156657,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 19*a(n-1) -54*a(n-2) +32*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 05 2018 11:32:58, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;19\,a(n-1) - 54\,a(n-2) + 32\,a(n-3)
\end{equation}
for all $n>2$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A203830.
