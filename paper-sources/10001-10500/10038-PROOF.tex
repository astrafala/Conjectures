...
\title{The empirical recurrence for OEIS A251888, proved by transfer matrix}
...
\begin{abstract}
OEIS A251888 counts arrays of width $4$ over $\{0,1,2,3\}$ in which every $3\times3$ window has
...
OEIS A251888 is ``Number of (n+2) X (2+2) 0..3 arrays with every 3 X 3 subblock row and column sum not 2 3 6 or 7 and every diagonal and antidiagonal sum 2 3 6 or 7.''. It has offset $1$ and begins
\[
1664, 1232, 602, 530, 594, 790, 1182, 1670,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + 6*a(n-3) - 6*a(n-4) - 8*a(n-6) + 8*a(n-7) for n>14.
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 30 2018 10:05:21, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251888.
