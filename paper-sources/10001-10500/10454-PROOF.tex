...
\title{A proof of the conjectured recurrence for OEIS A259457}
...
\begin{abstract}
OEIS A259457 carries a conjectured linear recurrence with polynomial coefficients, of
...
OEIS A259457 is ``From higher-order arithmetic progressions''. It has offset $0$ and begins
\[
a(0),\dots,a(7)\;=\;3, 66, 1050, 15300, 220500, 3245760, 49533120, 789264000,\ \dots
\]
...
a(n)\;=\;\frac{\left(n + 1\right) \left(n + 2\right) \left(n + 3\right) \left(3 n + 8\right) \left(n + 3\right)!}{96} .
\end{equation}
...
\begin{quote}\small
\textbf{Conjecture:} 3*n*a(n) +(-3*n\^{}2-19*n-44)*a(n-1) -2*(n+2)\^{}2*a(n-2)=0. - \emph{R. J. Mathar}, Jul 15 2015
\end{quote}
As of the ``Last modified'' line on the live entry (2026-06-24, revision 16) the
...
3 n\,a(n) + (- 3 n^{2} - 19 n - 44)\,a(n-1) -  2 \left(n + 2\right)^{2}\,a(n-2)
\end{equation}
...
entry \href{https://oeis.org/A259457}{A259457}, 2026-06-24.
