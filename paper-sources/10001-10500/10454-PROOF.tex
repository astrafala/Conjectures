...
\title{The empirical recurrence for OEIS A252389, proved by transfer matrix}
...
\begin{abstract}
OEIS A252389 counts $7\times(n+2)$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
$a(n)$ is a walk count on $S=1720956$ vertices. Such a sequence is $C$-finite, so whether a given
...
OEIS A252389 is ``Number of (5+2) X (n+2) 0..3 arrays with every 3 X 3 subblock row and diagonal sum equal to 0 3 5 6 or 7 and every 3 X 3 column and antidiagonal sum not equal to 0 3 5 6 or 7.''. It has offset $1$ and begins
\[
785, 637, 799, 916, 1305, 1894, 2310, 3280,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-3) - 4*a(n-6) + a(n-9) for n>14.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 03 2018 11:52:48, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252389.
