...
\title{The empirical recurrence for OEIS A253001, derived from the entry's generating function}
...
\begin{abstract}
OEIS A253001 carries an empirical recurrence of order $4$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 08 2018 05:28:52, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{1453 x^{12} + 12629 x^{11} + 45975 x^{10} + 87826 x^{9} + 87677 x^{8} + 27642 x^{7} + 3088 x^{6} - 55 x^{5} + x^{4} + 2 x^{3} - 2 x^{2} + 4 x}{x^{4} - 4 x^{3} + 6 x^{2} - 4 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;1453 x^{12} + 12629 x^{11} + 45975 x^{10} + 87826 x^{9} + 87677 x^{8} + 27642 x^{7} + 3088 x^{6} - 55 x^{5} + x^{4} + 2 x^{3} - 2 x^{2} + 4 x,
\]
