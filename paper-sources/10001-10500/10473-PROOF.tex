...
\title{The empirical recurrence for OEIS A228262, derived from the entry's generating function}
...
\begin{abstract}
OEIS A228262 carries an empirical recurrence of order $4$. The entry separately records a
...
OEIS A228262 is ``Number of third differences of arrays of length 6 of numbers in 0..n.''. It has offset $1$ and begins
\[
63, 621, 2511, 6419, 12947, 22727, 36471, 54851,\ \dots
\]
...
\begin{quote}
G.f.: x*(63 + 369*x + 405*x\^{}2 - 151*x\^{}3 - 84*x\^{}4 + 30*x\^{}5 + 80*x\^{}6 - 40*x\^{}7) / (1 - x)\^{}4.
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 11 2018 05:41:24, revision 7) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 40 x^{8} + 80 x^{7} + 30 x^{6} - 84 x^{5} - 151 x^{4} + 405 x^{3} + 369 x^{2} + 63 x}{x^{4} - 4 x^{3} + 6 x^{2} - 4 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 40 x^{8} + 80 x^{7} + 30 x^{6} - 84 x^{5} - 151 x^{4} + 405 x^{3} + 369 x^{2} + 63 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A228262.
