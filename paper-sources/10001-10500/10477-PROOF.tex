...
\title{The empirical recurrence for OEIS A237243, proved by transfer matrix}
...
\begin{abstract}
OEIS A237243 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
OEIS A237243 is ``Number of (n+1) X (2+1) 0..2 arrays with the maximum plus the upper median minus the lower median minus the minimum of every 2 X 2 subblock differing from its horizontal and vertical neighbors by exactly one.''. It has offset $1$ and begins
\[
344, 2064, 12600, 78420, 477144, 2908188, 17766000, 110572200,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 1410*a(n-4) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 22 2018 10:55:07, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237243.
