...
\title{The empirical recurrence for OEIS A267228, derived from the entry's generating function}
...
\begin{abstract}
OEIS A267228 carries an empirical recurrence of order $5$. The entry separately records a
...
OEIS A267228 is ``Number of length-n 0..4 arrays with no following elements greater than or equal to the first repeated value.''. It has offset $1$ and begins
\[
5, 25, 110, 470, 1980, 8274, 34396, 142474,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 05 2018 17:08:12, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 24 x^{6} - 20 x^{5} + 145 x^{4} - 135 x^{3} + 45 x^{2} - 5 x}{96 x^{5} - 224 x^{4} + 190 x^{3} - 75 x^{2} + 14 x - 1},
\]
the entry's own generating function, and let
\[
D(x)\;=\;1-\sum_i c_i x^{i}\;=\;- 96 x^{5} + 224 x^{4} - 190 x^{3} + 75 x^{2} - 14 x + 1
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;24 x^{6} + 20 x^{5} - 145 x^{4} + 135 x^{3} - 45 x^{2} + 5 x,
\]
...
\[
96 x^{5} - 224 x^{4} + 190 x^{3} - 75 x^{2} + 14 x - 1,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267228.
