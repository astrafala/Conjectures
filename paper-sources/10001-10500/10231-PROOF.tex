...
\title{The empirical recurrence for OEIS A188788, derived from the entry's generating function}
...
\begin{abstract}
OEIS A188788 carries an empirical recurrence of order $5$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 29 2018 08:46:42, revision 9) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{216 x^{8} - 184 x^{7} - 2440 x^{6} + 7016 x^{5} - 36048 x^{4} - 31728 x^{3} - 1536 x^{2}}{x^{5} - 5 x^{4} + 10 x^{3} - 10 x^{2} + 5 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 216 x^{8} + 184 x^{7} + 2440 x^{6} - 7016 x^{5} + 36048 x^{4} + 31728 x^{3} + 1536 x^{2},
\]
