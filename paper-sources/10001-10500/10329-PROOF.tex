...
\title{The empirical recurrence for OEIS A267472, derived from the entry's generating function}
...
\begin{abstract}
OEIS A267472 carries an empirical recurrence of order $5$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 05 2018 09:36:15, revision 7) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{5} + 5 x^{4} - 14 x^{3} - 2 x^{2} - 12 x}{x^{5} - 5 x^{4} + 10 x^{3} - 10 x^{2} + 5 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;x^{5} - 5 x^{4} + 14 x^{3} + 2 x^{2} + 12 x,
\]
