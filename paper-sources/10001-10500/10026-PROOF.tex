...
\title{The empirical recurrence for OEIS A209780, proved by transfer matrix}
...
\begin{abstract}
OEIS A209780 counts $(n+1)\times2$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A209780 is ``Half the number of (n+1) X 2 0..3 arrays with every 2 X 2 subblock having exactly one duplicate clockwise edge difference.''. It has offset $1$ and begins
\[
64, 576, 5074, 44948, 397734, 3520628, 31161462, 275819644,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 7*a(n-1) + 22*a(n-2) - 39*a(n-3) - 95*a(n-4) + 30*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 12 2018 15:31:43, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;7\,a(n-1) + 22\,a(n-2) - 39\,a(n-3) - 95\,a(n-4) + 30\,a(n-6)
\end{equation}
for all $n>5$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209780.
