...
\title{The empirical recurrence for OEIS A234914, proved by transfer matrix}
...
\begin{abstract}
OEIS A234914 counts $2$-column arrays over $\{0,\dots,4\}$ in which every
...
OEIS A234914 is ``Number of (n+1) X (1+1) 0..4 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 2, with no adjacent elements equal (constant-stress tilted 1 X 1 tilings).''. It has offset
$1$ and begins
\[
40, 120, 376, 1200, 3848, 12360, 39720,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 4*a(n-1) - 2*a(n-2) - 2*a(n-3) + a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 19 2022 01:20:28, revision 10) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234914.
