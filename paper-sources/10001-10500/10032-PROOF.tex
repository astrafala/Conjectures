...
\title{The empirical recurrence for OEIS A221544, derived from the entry's generating function}
...
\begin{abstract}
OEIS A221544 carries an empirical recurrence of order $6$. The entry separately records a
...
OEIS A221544 is ``Number of 0..n arrays of length 6 with each element differing from at least one neighbor by something other than 1, starting with 0.''. It has offset $1$ and begins
\[
5, 54, 364, 1386, 4018, 9665, 20386, 39007,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 08 2018 09:07:50, revision 9) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{10} + 8 x^{9} - 34 x^{8} + 87 x^{7} - 153 x^{6} + 157 x^{5} - 88 x^{4} + 115 x^{3} + 24 x^{2} + 5 x}{x^{6} - 6 x^{5} + 15 x^{4} - 20 x^{3} + 15 x^{2} - 6 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- x^{10} + 8 x^{9} - 34 x^{8} + 87 x^{7} - 153 x^{6} + 157 x^{5} - 88 x^{4} + 115 x^{3} + 24 x^{2} + 5 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221544.
