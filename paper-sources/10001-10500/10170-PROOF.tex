...
\title{The empirical recurrence for OEIS A253227, proved by transfer matrix}
...
\begin{abstract}
OEIS A253227 counts the arrays over $\{0,\dots,1\}$ whose $2\times2$ subblocks carry a
...
OEIS A253227 is ``Number of (n+1) X (4+1) 0..1 arrays with every 2 X 2 subblock diagonal minimum minus antidiagonal minimum nondecreasing horizontally and diagonal maximum minus antidiagonal maximum nondecreasing vertically.''. It has offset $1$ and begins
\[
335, 742, 914, 1498, 2543, 4490, 8216, 15476,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 5*a(n-1) - 9*a(n-2) + 7*a(n-3) - 2*a(n-4) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 10 2018 12:18:41, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253227.
