...
\title{The empirical recurrence for OEIS A269585, derived from the entry's generating function}
...
\begin{abstract}
OEIS A269585 carries an empirical recurrence of order $6$. The entry separately records a
...
OEIS A269585 is ``Number of length-5 0..n arrays with no repeated value differing from the previous repeated value by more than one.''. It has offset $1$ and begins
\[
32, 229, 964, 2969, 7456, 16237, 31844, 57649,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 24 2019 11:44:26, revision 7) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{6} + 2 x^{5} - 20 x^{4} + 70 x^{3} + 37 x^{2} + 32 x}{x^{6} - 6 x^{5} + 15 x^{4} - 20 x^{3} + 15 x^{2} - 6 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- x^{6} + 2 x^{5} - 20 x^{4} + 70 x^{3} + 37 x^{2} + 32 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269585.
