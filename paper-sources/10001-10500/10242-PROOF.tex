...
\title{The empirical recurrence for OEIS A201043, derived from the entry's generating function}
...
\begin{abstract}
OEIS A201043 carries an empirical recurrence of order $5$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 21 2018 15:05:23, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{5} + 4 x^{4} - 46 x^{3} - 90 x^{2} - 41 x}{x^{5} - 5 x^{4} + 10 x^{3} - 10 x^{2} + 5 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;x^{5} - 4 x^{4} + 46 x^{3} + 90 x^{2} + 41 x,
\]
