...
\title{The empirical recurrence for OEIS A252934, derived from the entry's generating function}
...
\begin{abstract}
OEIS A252934 carries an empirical recurrence of order $4$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 07 2018 11:51:34, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{20 x^{10} + 293 x^{9} + 1331 x^{8} + 2849 x^{7} + 2340 x^{6} + 1013 x^{5} + 271 x^{4} + 65 x^{3} + 2 x^{2} + 8 x}{x^{4} - 4 x^{3} + 6 x^{2} - 4 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;20 x^{10} + 293 x^{9} + 1331 x^{8} + 2849 x^{7} + 2340 x^{6} + 1013 x^{5} + 271 x^{4} + 65 x^{3} + 2 x^{2} + 8 x,
\]
