...
\title{The empirical recurrence for OEIS A187592, derived from the entry's generating function}
...
\begin{abstract}
OEIS A187592 carries an empirical recurrence of order $3$. The entry separately records a
...
OEIS A187592 is ``Number of 9-step E, S, NW and NE-moving king's tours on an n X n board summed over all starting positions.''. It has offset $1$ and begins
\[
0, 0, 13, 2792, 27252, 103108, 246792, 458018,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 24 2018 14:31:07, revision 10) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{1634 x^{10} + 3976 x^{9} + 286 x^{8} - 16432 x^{7} - 29715 x^{6} - 18915 x^{5} - 2753 x^{4} - 13 x^{3}}{x^{3} - 3 x^{2} + 3 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 1634 x^{10} - 3976 x^{9} - 286 x^{8} + 16432 x^{7} + 29715 x^{6} + 18915 x^{5} + 2753 x^{4} + 13 x^{3},
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A187592.
