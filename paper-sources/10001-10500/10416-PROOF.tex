...
\title{The empirical recurrence for OEIS A298920, proved by transfer matrix}
...
\begin{abstract}
OEIS A298920 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A298920 is ``Number of n X 4 0..1 arrays with every element equal to 1, 3, 5, 7 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 8, 2, 3, 7, 6, 9, 20,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +a(n-2) +a(n-6) -a(n-7) -a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 04 2022 13:19:04, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A298920.
