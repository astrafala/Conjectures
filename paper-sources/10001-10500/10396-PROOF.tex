...
\title{The empirical recurrence for OEIS A187382, derived from the entry's generating function}
...
\begin{abstract}
OEIS A187382 carries an empirical recurrence of order $3$. The entry separately records a
...
OEIS A187382 is ``Number of 8-step S, NW and NE-moving king's tours on an n X n board summed over all starting positions.''. It has offset $1$ and begins
\[
0, 0, 0, 404, 2140, 6380, 13220, 22996,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 24 2018 08:50:51, revision 12) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{342 x^{9} - 336 x^{8} - 96 x^{7} - 1172 x^{6} - 928 x^{5} - 404 x^{4}}{x^{3} - 3 x^{2} + 3 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 342 x^{9} + 336 x^{8} + 96 x^{7} + 1172 x^{6} + 928 x^{5} + 404 x^{4},
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A187382.
