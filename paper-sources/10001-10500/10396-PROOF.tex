...
\title{The empirical recurrence for OEIS A258675, proved by transfer matrix}
...
\begin{abstract}
OEIS A258675 counts arrays of width $4$ over $\{0,1\}$ in which every $3\times3$ window has
...
OEIS A258675 is ``Number of (n+2) X (2+2) 0..1 arrays with no 3 x 3 subblock diagonal sum equal to the antidiagonal sum.''. It has offset $1$ and begins
\[
1600, 10000, 67600, 456976, 2944656, 18974736, 125888400, 835210000,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 9*a(n-1) - 36*a(n-2) + 180*a(n-3) - 2880*a(n-5) + 9216*a(n-6) - 36864*a(n-7) + 65536*a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 22 2018 11:32:25, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;9\,a(n-1) - 36\,a(n-2) + 180\,a(n-3) - 2880\,a(n-5) + 9216\,a(n-6) - 36864\,a(n-7) + 65536\,a(n-8)
\]
for every $n>7$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A258675.
