...
\title{The empirical recurrence for OEIS A228221, derived from the entry's generating function}
...
\begin{abstract}
OEIS A228221 carries an empirical recurrence of order $5$. The entry separately records a
...
OEIS A228221 is ``Number of second differences of arrays of length 6 of numbers in 0..n.''. It has offset $1$ and begins
\[
63, 665, 3151, 9705, 23351, 47953, 88215, 149681,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 10 2018 05:44:14, revision 7) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{5} + 30 x^{4} - 456 x^{3} - 350 x^{2} - 63 x}{x^{5} - 5 x^{4} + 10 x^{3} - 10 x^{2} + 5 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;x^{5} - 30 x^{4} + 456 x^{3} + 350 x^{2} + 63 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A228221.
