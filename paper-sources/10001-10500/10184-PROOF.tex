...
\title{The empirical recurrence for OEIS A301780, proved by transfer matrix}
...
\begin{abstract}
OEIS A301780 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A301780 is ``Number of nX4 0..1 arrays with every element equal to 0, 1, 2 or 3 horizontally or vertically adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
8, 128, 1808, 25872, 369936, 5289488, 75632400, 1081436176,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 13*a(n-1) +20*a(n-2) -16*a(n-3) -64*a(n-4)
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 26 2018 16:25:24, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A301780.
