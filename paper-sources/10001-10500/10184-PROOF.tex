...
\title{The empirical recurrence for OEIS A232333, proved by transfer matrix}
...
\begin{abstract}
OEIS A232333 counts arrays of width $6$ over $\{0,1,2\}$ in which every cell carrying one stated
...
OEIS A232333 is ``Number of n X 6 0..2 arrays with every 0 next to a 1 and every 1 next to a 2 horizontally or antidiagonally, with no adjacent elements equal.''. It has offset $1$ and begins
\[
16, 162, 1470, 13170, 117690, 1047700, 9298730, 82332898,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 16*a(n-1) -60*a(n-2) -47*a(n-3) +92*a(n-4) +448*a(n-5) +448*a(n-6) +256*a(n-7) for n>9.
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 04 2018 11:50:23, revision 8) this is still
...
adjacency matrix,
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=8026.
\]
...
\begin{theorem}
\[
a(n)\;=\;16\,a(n-1) - 60\,a(n-2) - 47\,a(n-3) + 92\,a(n-4) + 448\,a(n-5) + 448\,a(n-6) + 256\,a(n-7)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232333.
