...
\title{The empirical recurrence for OEIS A211852, derived from the entry's generating function}
...
\begin{abstract}
OEIS A211852 carries an empirical recurrence of order $6$. The entry separately records a
...
OEIS A211852 is ``Number of nonnegative integer arrays of length 2n+7 with new values 0 upwards introduced in order, no three adjacent elements all unequal, and containing the value n+1.''. It has offset $1$ and begins
\[
588, 2013, 5486, 12713, 26163, 49210, 86275, 142968,\ \dots
\]
...
\begin{quote}
G.f.: x*(588 - 1515*x + 2228*x\^{}2 - 1768*x\^{}3 + 735*x\^{}4 - 126*x\^{}5) / (1 - x)\^{}6.
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 20 2018 08:11:50, revision 7) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 126 x^{6} + 735 x^{5} - 1768 x^{4} + 2228 x^{3} - 1515 x^{2} + 588 x}{x^{6} - 6 x^{5} + 15 x^{4} - 20 x^{3} + 15 x^{2} - 6 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 126 x^{6} + 735 x^{5} - 1768 x^{4} + 2228 x^{3} - 1515 x^{2} + 588 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A211852.
