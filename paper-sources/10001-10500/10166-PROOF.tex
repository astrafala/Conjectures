...
\title{The empirical recurrence for OEIS A269437, derived from the entry's generating function}
...
\begin{abstract}
OEIS A269437 carries an empirical recurrence of order $6$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 22 2019 07:46:33, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{6} + 6 x^{5} - 19 x^{4} + 52 x^{3} + 54 x^{2} + 28 x}{x^{6} - 6 x^{5} + 15 x^{4} - 20 x^{3} + 15 x^{2} - 6 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- x^{6} + 6 x^{5} - 19 x^{4} + 52 x^{3} + 54 x^{2} + 28 x,
\]
