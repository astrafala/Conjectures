...
\title{The empirical recurrence for OEIS A183691, proved by transfer matrix}
...
\begin{abstract}
OEIS A183691 counts arrays over $\{0,\dots,2\}$ under a condition on the determinant of every
...
a bounded window of consecutive rows, so the count is a walk count on $S=27$ states and is
...
OEIS A183691 is ``Number of (n+1) X 3 0..2 arrays with every 2 X 2 subblock nonsingular.''. It has offset $1$ and begins
\[
314, 4594, 66658, 969978, 14100346, 205047906, 2981428242, 43352455562,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 8*a(n-1) + 91*a(n-2) + 74*a(n-3) - 208*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 04 2018 10:48:11, revision 9) this is still
...
first term is $314$, and the model reproduces it along with every later term; that is the
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-1) + 91\,a(n-2) + 74\,a(n-3) - 208\,a(n-4)
\]
for every $n>4$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A183691.
