...
\title{The empirical recurrence for OEIS A209725, proved by transfer matrix}
...
\begin{abstract}
OEIS A209725 counts $(n+1)\times7$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A209725 is ``1/4 the number of (n+1) X 7 0..2 arrays with every 2 X 2 subblock having distinct clockwise edge differences.''. It has offset $1$ and begins
\[
12, 13, 14, 16, 18, 22, 26, 34,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) + 2*a(n-2) - 2*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 12 2018 09:15:35, revision 8) the statement is
...
\[
a(n)-\sum_i c_i\,a(n-i)\;=\;\tfrac1{4}\mathbf{1}^{\!\top}M^{\,n+1-1-3}\,q(M)\,\mathbf{1} .
\]
...
=\tfrac1{4}\mathbf{1}^{\!\top}M^{\,m-3}\,q(M)\,\mathbf{1}
\]
...
every one of the $41$ published indices; the values agree exactly. That is what ties
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209725.
