...
\title{The empirical recurrence for OEIS A229422, derived from the entry's generating function}
...
\begin{abstract}
OEIS A229422 carries an empirical recurrence of order $5$. The entry separately records a
...
OEIS A229422 is ``Number of n X 2 0..2 arrays with horizontal differences mod 3 never 1, vertical differences mod 3 never -1, rows lexicographically nondecreasing, and columns lexicographically nonincreasing.''. It has offset $1$ and begins
\[
5, 12, 27, 55, 102, 175, 282, 432,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 15 2018 08:45:07, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 2 x^{5} + 10 x^{4} - 17 x^{3} + 13 x^{2} - 5 x}{x^{5} - 5 x^{4} + 10 x^{3} - 10 x^{2} + 5 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;2 x^{5} - 10 x^{4} + 17 x^{3} - 13 x^{2} + 5 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A229422.
