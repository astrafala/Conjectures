...
\title{The empirical recurrence for OEIS A203357, proved by transfer matrix}
...
\begin{abstract}
OEIS A203357 counts arrays of width $3$ over $\{0,1\}$ under local conditions relating each cell
...
OEIS A203357 is ``Number of n X 3 binary arrays with every 1 immediately preceded by 0 to the left or above.''. It has offset $1$ and begins
\[
3, 20, 102, 565, 3042, 16538, 89610, 486103,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) +12*a(n-2) +6*a(n-3) +a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 04 2018 05:47:39, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + 12\,a(n-2) + 6\,a(n-3) + a(n-4)
\]
for every $n>3$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A203357.
