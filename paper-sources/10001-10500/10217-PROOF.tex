...
\title{The empirical recurrence for OEIS A210270, proved by transfer matrix}
...
\begin{abstract}
OEIS A210270 counts $(n+1)\times3$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A210270 is ``Half the number of (n+1)X3 0..2 arrays with every 2X2 subblock having two or three distinct clockwise edge differences.''. It has offset $1$ and begins
\[
273, 5558, 113248, 2307956, 47036870, 958632858, 19537398722, 398181683100,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 20*a(n-1) +26*a(n-2) -364*a(n-3) -218*a(n-4) +1203*a(n-5) -418*a(n-6) -394*a(n-7) +216*a(n-8) -20*a(n-9)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 15:51:18, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;20\,a(n-1) + 26\,a(n-2) - 364\,a(n-3) - 218\,a(n-4) + 1203\,a(n-5) - 418\,a(n-6) - 394\,a(n-7) + 216\,a(n-8) - 20\,a(n-9)
\end{equation}
for all $n>8$.
...
\[
a(n)-\sum_i c_i\,a(n-i)\;=\;\tfrac1{2}\mathbf{1}^{\!\top}M^{\,n+1-1-9}\,q(M)\,\mathbf{1} .
\]
...
=\tfrac1{2}\mathbf{1}^{\!\top}M^{\,m-9}\,q(M)\,\mathbf{1}
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A210270.
