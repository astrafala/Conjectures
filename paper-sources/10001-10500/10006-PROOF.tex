...
\title{The empirical recurrence for OEIS A220633, proved by transfer matrix}
...
\begin{abstract}
OEIS A220633 counts the ways of linking the cells of a grid $3$ cells wide, each cell either to
...
OEIS A220633 is ``Number of ways to reciprocally link elements of an 3 X n array either to themselves or to exactly two horizontal or antidiagonal neighbors.''. It has offset $1$ and begins
\[
1, 1, 3, 12, 44, 158, 564, 2010,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) - a(n-2) - 2*a(n-3) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 02 2018 04:42:20, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A220633.
