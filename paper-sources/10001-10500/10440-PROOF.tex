...
\title{The empirical recurrence for OEIS A187166, derived from the entry's generating function}
...
\begin{abstract}
OEIS A187166 carries an empirical recurrence of order $4$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 20 2018 14:38:43, revision 11) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{54 x^{7} + 24 x^{6} - 690 x^{5} + 2160 x^{4} + 2664 x^{3} + 144 x^{2}}{x^{4} - 4 x^{3} + 6 x^{2} - 4 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;54 x^{7} + 24 x^{6} - 690 x^{5} + 2160 x^{4} + 2664 x^{3} + 144 x^{2},
\]
