...
\title{The empirical recurrence for OEIS A269691, derived from the entry's generating function}
...
\begin{abstract}
OEIS A269691 carries an empirical recurrence of order $6$. The entry separately records a
...
OEIS A269691 is ``Number of length-5 0..n arrays with no repeated value differing from the previous repeated value by plus or minus one modulo n+1.''. It has offset $1$ and begins
\[
24, 201, 944, 2995, 7584, 16541, 32416, 58599,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 28 2019 09:00:25, revision 7) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{8 x^{7} - 47 x^{6} + 114 x^{5} - 134 x^{4} + 98 x^{3} + 57 x^{2} + 24 x}{x^{6} - 6 x^{5} + 15 x^{4} - 20 x^{3} + 15 x^{2} - 6 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;8 x^{7} - 47 x^{6} + 114 x^{5} - 134 x^{4} + 98 x^{3} + 57 x^{2} + 24 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269691.
