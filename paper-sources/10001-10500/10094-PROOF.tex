...
\title{The empirical recurrence for OEIS A204214, derived from the entry's generating function}
...
\begin{abstract}
OEIS A204214 carries an empirical recurrence of order $5$. The entry separately records a
...
OEIS A204214 is ``Number of length 6 nonnegative integer arrays starting and ending with 0 with adjacent elements differing by no more than n.''. It has offset $1$ and begins
\[
21, 120, 404, 1025, 2181, 4116, 7120, 11529,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 06 2018 11:35:31, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{5} + 5 x^{4} - 14 x^{3} - 15 x^{2} - 21 x}{x^{5} - 5 x^{4} + 10 x^{3} - 10 x^{2} + 5 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;x^{5} - 5 x^{4} + 14 x^{3} + 15 x^{2} + 21 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204214.
