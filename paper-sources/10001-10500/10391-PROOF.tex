...
\title{The empirical recurrence for OEIS A187301, derived from the entry's generating function}
...
\begin{abstract}
OEIS A187301 carries an empirical recurrence of order $3$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 23 2018 08:37:51, revision 10) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{18 x^{12} - 22 x^{11} + 138 x^{10} - 150 x^{9} + 302 x^{8} - 470 x^{7} - 10 x^{6} - 786 x^{5} - 452 x^{4} - 144 x^{3}}{x^{3} - 3 x^{2} + 3 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 18 x^{12} + 22 x^{11} - 138 x^{10} + 150 x^{9} - 302 x^{8} + 470 x^{7} + 10 x^{6} + 786 x^{5} + 452 x^{4} + 144 x^{3},
\]
