...
\title{The empirical recurrence for OEIS A200840, derived from the entry's generating function}
...
\begin{abstract}
OEIS A200840 carries an empirical recurrence of order $6$. The entry separately records a
...
OEIS A200840 is ``Number of 0..n arrays x(0..4) of 5 elements without any two consecutive increases or two consecutive decreases.''. It has offset $1$ and begins
\[
32, 191, 676, 1817, 4108, 8239, 15128, 25953,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 08:49:18, revision 11) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{6} + 6 x^{5} - 14 x^{4} + 10 x^{3} - x^{2} + 32 x}{x^{6} - 6 x^{5} + 15 x^{4} - 20 x^{3} + 15 x^{2} - 6 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- x^{6} + 6 x^{5} - 14 x^{4} + 10 x^{3} - x^{2} + 32 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A200840.
