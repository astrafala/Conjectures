...
\title{The empirical recurrence for OEIS A253491, proved by transfer matrix}
...
\begin{abstract}
OEIS A253491 counts the arrays over $\{0,\dots,2\}$ whose $2\times2$ subblocks carry a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 15 2018 15:15:46, revision 11) this is still
