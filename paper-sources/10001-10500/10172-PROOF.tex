...
\title{The empirical recurrence for OEIS A269621, derived from the entry's generating function}
...
\begin{abstract}
OEIS A269621 carries an empirical recurrence of order $6$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 25 2019 08:28:03, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 6 x^{5} + 2 x^{4} + 42 x^{3} + 54 x^{2} + 28 x}{x^{6} - 6 x^{5} + 15 x^{4} - 20 x^{3} + 15 x^{2} - 6 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 6 x^{5} + 2 x^{4} + 42 x^{3} + 54 x^{2} + 28 x,
\]
