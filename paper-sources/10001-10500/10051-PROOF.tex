...
\title{The empirical recurrence for OEIS A249710, derived from the entry's generating function}
...
\begin{abstract}
OEIS A249710 carries an empirical recurrence of order $6$. The entry separately records a
...
OEIS A249710 is ``Number of length 4+3 0..n arrays with every four consecutive terms having the maximum of some two terms equal to the minimum of the remaining two terms.''. It has offset $1$ and begins
\[
28, 221, 896, 2601, 6172, 12789, 24032, 41937,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 10 2018 04:40:21, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{6} + 6 x^{5} - 20 x^{4} - 10 x^{3} + 53 x^{2} + 28 x}{x^{6} - 6 x^{5} + 15 x^{4} - 20 x^{3} + 15 x^{2} - 6 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- x^{6} + 6 x^{5} - 20 x^{4} - 10 x^{3} + 53 x^{2} + 28 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A249710.
