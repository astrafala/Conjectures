...
\title{The empirical recurrence for OEIS A207142, proved by transfer matrix}
...
\begin{abstract}
OEIS A207142 counts the $(n+1)\times2$ arrays over $\{0,\dots,2\}$ in which
...
a state, the count is a walk count on $S=50$ of them, and the conjectured recurrence is then
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 19 2018 12:25:11, revision 11) this is still
...
$50$, which the model reproduces along with every later term.
...
\]
on the $S=50$ admissible $2$-tuples. In particular $a$ is $C$-finite.
