...
\title{The empirical recurrence for OEIS A187299, derived from the entry's generating function}
...
\begin{abstract}
OEIS A187299 carries an empirical recurrence of order $3$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 23 2018 08:34:12, revision 11) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{10 x^{8} - 14 x^{7} + 30 x^{6} - 54 x^{5} - 34 x^{4} - 54 x^{3}}{x^{3} - 3 x^{2} + 3 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 10 x^{8} + 14 x^{7} - 30 x^{6} + 54 x^{5} + 34 x^{4} + 54 x^{3},
\]
