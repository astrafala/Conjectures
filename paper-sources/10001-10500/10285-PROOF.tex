...
\title{The empirical recurrence for OEIS A243038, proved by transfer matrix}
...
\begin{abstract}
OEIS A243038 carries an empirical recurrence of order $4$ contributed by R.~H.~Hardin. It is
...
OEIS A243038 is ``Number of length n+3 0..2 arrays with no four elements in a row with pattern abab (with a!=b) and new values 0..2 introduced in 0..2 order.''. It has offset $1$ and begins
\[
13, 36, 101, 285, 806, 2281, 6457, 18280,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) - a(n-3) - a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 01 2018 12:24:25, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A243038.
