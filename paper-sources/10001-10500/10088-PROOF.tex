...
\title{The empirical recurrence for OEIS A228462, derived from the entry's generating function}
...
\begin{abstract}
OEIS A228462 carries an empirical recurrence of order $6$. The entry separately records a
...
OEIS A228462 is ``Number of arrays of maxima of three adjacent elements of some length 7 0..n array.''. It has offset $1$ and begins
\[
17, 91, 310, 821, 1847, 3703, 6812, 11721,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 11 2018 05:51:47, revision 10) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{6} + 6 x^{5} - 14 x^{4} + 19 x^{3} - 11 x^{2} + 17 x}{x^{6} - 6 x^{5} + 15 x^{4} - 20 x^{3} + 15 x^{2} - 6 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- x^{6} + 6 x^{5} - 14 x^{4} + 19 x^{3} - 11 x^{2} + 17 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A228462.
