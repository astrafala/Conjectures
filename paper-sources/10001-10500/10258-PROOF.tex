...
\title{The empirical recurrence for OEIS A206068, proved by transfer matrix}
...
\begin{abstract}
OEIS A206068 counts arrays over $\{0,\dots,2\}$ under a condition on the perimeter cycle of
every $2\times3$ and $3\times2$ subblock, and carries an empirical recurrence of order $8$ contributed by
R.~H.~Hardin. It is true, and it is decidable rather than empirical. The condition is local to
a bounded window of consecutive rows, so the count is a walk count on $S=2052$ states and is
...
OEIS A206068 is ``Number of (n+1)X5 0..2 arrays with every 2X3 or 3X2 subblock having exactly three clockwise edge increases.''. It has offset $1$ and begins
\[
2052, 18534, 233058, 2991276, 38532894, 496478790, 6395526408, 82373437782,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 25*a(n-1) -206*a(n-2) +741*a(n-3) -1371*a(n-4) +1388*a(n-5) -844*a(n-6) +228*a(n-7) +4*a(n-8) for n>13
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 12:26:27, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;25\,a(n-1) - 206\,a(n-2) + 741\,a(n-3) - 1371\,a(n-4) + 1388\,a(n-5) - 844\,a(n-6) + 228\,a(n-7) + 4\,a(n-8)
\]
for every $n>13$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206068.
