...
\title{The empirical recurrence for OEIS A269775, proved by transfer matrix}
...
\begin{abstract}
OEIS A269775 carries an empirical recurrence of order $3$ contributed by R.~H.~Hardin. It is
...
OEIS A269775 is ``Number of length-n 0..7 arrays with every repeated value unequal to the previous repeated value plus one mod 7+1.''. It has offset $1$ and begins
\[
8, 64, 512, 4088, 32592, 259504, 2063880, 16398144,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 14*a(n-1) - 42*a(n-2)  -49*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 29 2019 05:49:52, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;14\,a(n-1) - 42\,a(n-2) - 49\,a(n-3)
\]
for every $n>1$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269775.
