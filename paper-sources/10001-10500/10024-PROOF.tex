...
\title{The empirical recurrence for OEIS A250142, derived from the entry's generating function}
...
\begin{abstract}
OEIS A250142 carries an empirical recurrence of order $6$. The entry separately records a
...
OEIS A250142 is ``Number of length 3+2 0..n arrays with the medians of every three consecutive terms nondecreasing.''. It has offset $1$ and begins
\[
24, 162, 632, 1827, 4368, 9156, 17424, 30789,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 11 2018 18:21:48, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{6} + 6 x^{5} - 15 x^{4} + 20 x^{3} + 18 x^{2} + 24 x}{x^{6} - 6 x^{5} + 15 x^{4} - 20 x^{3} + 15 x^{2} - 6 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- x^{6} + 6 x^{5} - 15 x^{4} + 20 x^{3} + 18 x^{2} + 24 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250142.
