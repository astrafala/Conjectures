...
\title{The empirical recurrence for OEIS A188701, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A188701 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A188701 is ``Number of n X 4 binary arrays without the pattern 0 0 diagonally or vertically.''. It has offset $1$ and begins
\[
16, 55, 387, 1876, 10857, 57665, 318732, 1729531,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) + 20*a(n-2) + 27*a(n-3) - 14*a(n-4) - 25*a(n-5) + 4*a(n-6) + 5*a(n-7) - a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 28 2018 08:12:05, revision 9) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A188701.
