...
\title{The empirical recurrence for OEIS A187167, derived from the entry's generating function}
...
\begin{abstract}
OEIS A187167 carries an empirical recurrence of order $4$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 20 2018 14:39:02, revision 14) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{96 x^{8} + 444 x^{7} - 1320 x^{6} - 1728 x^{5} + 14928 x^{4} + 8544 x^{3} + 240 x^{2}}{x^{4} - 4 x^{3} + 6 x^{2} - 4 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;96 x^{8} + 444 x^{7} - 1320 x^{6} - 1728 x^{5} + 14928 x^{4} + 8544 x^{3} + 240 x^{2},
\]
