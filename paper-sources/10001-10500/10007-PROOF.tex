...
\title{The empirical recurrence for OEIS A269659, derived from the entry's generating function}
...
\begin{abstract}
OEIS A269659 carries an empirical recurrence of order $7$. The entry separately records a
...
OEIS A269659 is ``Number of length-6 0..n arrays with no adjacent pair x,x+1 repeated.''. It has offset $1$ and begins
\[
42, 626, 3816, 15036, 45590, 115902, 259476, 527576,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 25 2019 16:49:52, revision 7) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{4 x^{6} - 34 x^{5} - 316 x^{3} - 332 x^{2} - 42 x}{x^{7} - 7 x^{6} + 21 x^{5} - 35 x^{4} + 35 x^{3} - 21 x^{2} + 7 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 4 x^{6} + 34 x^{5} + 316 x^{3} + 332 x^{2} + 42 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269659.
