...
\title{The empirical recurrence for OEIS A260170, proved by transfer matrix}
...
\begin{abstract}
OEIS A260170 counts $(n+2)\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A260170 is ``Number of (n+2) X (1+2) 0..1 arrays with each 3 X 3 subblock having clockwise perimeter pattern 00000001 00000101 or 00010001.''. It has offset $1$ and begins
\[
40, 74, 183, 409, 950, 2221, 5235, 12063,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + 2*a(n-2) + 2*a(n-3) + 6*a(n-4) - 8*a(n-5) - 3*a(n-6) - 4*a(n-7) - 10*a(n-8) - 4*a(n-9) + 8*a(n-10) for n>11.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 28 2018 09:06:45, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 2\,a(n-2) + 2\,a(n-3) + 6\,a(n-4) - 8\,a(n-5) - 3\,a(n-6) - 4\,a(n-7) - 10\,a(n-8) - 4\,a(n-9) + 8\,a(n-10)
\]
for every $n>11$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A260170.
