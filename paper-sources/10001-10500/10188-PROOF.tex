...
\title{The empirical recurrence for OEIS A235251, proved by transfer matrix}
...
\begin{abstract}
OEIS A235251 counts $2$-column arrays over $\{0,\dots,7\}$ in which every
...
OEIS A235251 is ``Number of (n+1) X (1+1) 0..7 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 7, with no adjacent elements equal (constant-stress tilted 1 X 1 tilings).''. It has offset
$1$ and begins
\[
184, 744, 2672, 10820, 39680, 161060, 600928,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 43*a(n-2) -617*a(n-4) +3073*a(n-6) -1762*a(n-8) +264*a(n-10).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 18 2022 23:51:44, revision 7) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A235251.
