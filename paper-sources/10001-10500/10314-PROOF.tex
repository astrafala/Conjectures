...
\title{The empirical recurrence for OEIS A317378, proved by transfer matrix}
...
\begin{abstract}
OEIS A317378 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A317378 is ``Number of nX3 0..1 arrays with every element unequal to 0, 1, 2, 5, 6, 7 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
4, 5, 18, 36, 94, 270, 731, 1973,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +3*a(n-2) +5*a(n-3) +2*a(n-4) -3*a(n-5) -10*a(n-6) -8*a(n-7) for n>10
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 26 2018 16:58:48, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 3\,a(n-2) + 5\,a(n-3) + 2\,a(n-4) - 3\,a(n-5) - 10\,a(n-6) - 8\,a(n-7)
\end{equation}
for all $n>10$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A317378.
