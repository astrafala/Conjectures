...
\title{The empirical recurrence for OEIS A238173, proved by transfer matrix}
...
\begin{abstract}
OEIS A238173 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
The condition is local to two consecutive rows, so the count is a walk count on $S=19$
...
OEIS A238173 is ``Number of (n+1) X (1+1) 0..2 arrays with the maximum plus the minimum of every 2 X 2 subblock equal.''. It has offset $1$ and begins
\[
81, 423, 2329, 13447, 79641, 479703, 2918233, 17859079,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 10*a(n-1) - 22*a(n-2) - 20*a(n-3) + 63*a(n-4) - 6*a(n-5) - 24*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 24 2018 08:21:40, revision 7) this is still
...
array, which is not among the objects counted. There are $S=19$ states left.
...
\begin{theorem}
\[
a(n)\;=\;10\,a(n-1) - 22\,a(n-2) - 20\,a(n-3) + 63\,a(n-4) - 6\,a(n-5) - 24\,a(n-6)
\]
for every $n>5$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A238173.
