...
\title{The empirical recurrence for OEIS A243601, proved by transfer matrix}
...
\begin{abstract}
OEIS A243601 carries an empirical recurrence of order $7$ contributed by R.~H.~Hardin. It is
...
OEIS A243601 is ``Number of length n+2 0..4 arrays with no three elements in a row with pattern aba (with a!=b) and new values 0..4 introduced in 0..4 order.''. It has offset $1$ and begins
\[
4, 10, 29, 96, 349, 1350, 5425, 22297,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 8*a(n-1) - 18*a(n-2) + 5*a(n-3) + 17*a(n-4) - 4*a(n-5) - 6*a(n-6) - a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 02 2018 12:29:52, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-1) - 18\,a(n-2) + 5\,a(n-3) + 17\,a(n-4) - 4\,a(n-5) - 6\,a(n-6) - a(n-7)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A243601.
