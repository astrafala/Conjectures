...
\title{The empirical recurrence for OEIS A185513, proved by transfer matrix}
...
\begin{abstract}
OEIS A185513 counts arrays over $\{0,\dots,2\}$ under a condition on the determinant of every
...
OEIS A185513 is ``Number of (n+1) X 2 0..2 arrays with every 2 X 2 subblock singular.''. It has offset $1$ and begins
\[
31, 143, 593, 2553, 10847, 46303, 197329, 841449,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) + 3*a(n-2) - 8*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 16 2018 08:37:46, revision 8) this is still
...
first term is $31$, and the model reproduces it along with every later term; that is the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A185513.
