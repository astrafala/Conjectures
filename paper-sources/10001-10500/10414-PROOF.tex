...
\title{The empirical recurrence for OEIS A234674, proved by transfer matrix}
...
\begin{abstract}
OEIS A234674 counts $2$-column arrays over $\{0,\dots,5\}$ in which every
...
OEIS A234674 is ``Number of (n+1) X (1+1) 0..5 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 5 (constant-stress 1 X 1 tilings).''. It has offset
$1$ and begins
\[
112, 404, 1264, 4568, 14368, 52016, 164416,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 22*a(n-2) - 120*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 19 2022 01:05:24, revision 9) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234674.
