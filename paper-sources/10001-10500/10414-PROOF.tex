...
\title{The empirical recurrence for OEIS A223332, proved by transfer matrix}
...
\begin{abstract}
OEIS A223332 carries an empirical recurrence of order $2$ contributed by R.~H.~Hardin. It is
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 19 2018 10:42:02, revision 10) this is still
