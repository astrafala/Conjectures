...
\title{The empirical recurrence for OEIS A266609, derived from the entry's generating function}
...
\begin{abstract}
OEIS A266609 carries an empirical recurrence of order $6$. The entry separately records a
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{110111000 x^{5} - 1010000 x^{4} + 1100100 x^{3} - 9899 x^{2} + 1}{10000 x^{6} - x^{4} - 10000 x^{2} + 1},
\]
the entry's own generating function, and let
\[
D(x)\;=\;1-\sum_i c_i x^{i}\;=\;10000 x^{6} - x^{4} - 10000 x^{2} + 1
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;110111000 x^{5} - 1010000 x^{4} + 1100100 x^{3} - 9899 x^{2} + 1,
\]
