...
\title{The empirical recurrence for OEIS A212838, derived from the entry's generating function}
...
\begin{abstract}
OEIS A212838 carries an empirical recurrence of order $6$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 21 2018 10:07:24, revision 10) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{6} + 12 x^{5} - 50 x^{4} + 70 x^{3} + 87 x^{2} + 2 x}{x^{6} - 6 x^{5} + 15 x^{4} - 20 x^{3} + 15 x^{2} - 6 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- x^{6} + 12 x^{5} - 50 x^{4} + 70 x^{3} + 87 x^{2} + 2 x,
\]
