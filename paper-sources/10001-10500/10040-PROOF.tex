...
\title{The empirical recurrence for OEIS A227554, derived from the entry's generating function}
...
\begin{abstract}
OEIS A227554 carries an empirical recurrence of order $6$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 08 2018 12:43:04, revision 9) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{6} + 8 x^{5} - 17 x^{4} + 21 x^{3} - 12 x^{2} + 4 x}{x^{6} - 6 x^{5} + 15 x^{4} - 20 x^{3} + 15 x^{2} - 6 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- x^{6} + 8 x^{5} - 17 x^{4} + 21 x^{3} - 12 x^{2} + 4 x,
\]
