...
\title{The empirical recurrence for OEIS A260602, proved by transfer matrix}
...
\begin{abstract}
OEIS A260602 counts $(n+2)\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A260602 is ``Number of (n+2) X (1+2) 0..1 arrays with each 3 X 3 subblock having clockwise perimeter pattern 00000101 00010001 or 00010101.''. It has offset $1$ and begins
\[
40, 58, 125, 241, 525, 1029, 2246, 4407,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 29 2018 07:07:54, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 2\,a(n-2) - a(n-3) + 7\,a(n-4) - 10\,a(n-5) + 6\,a(n-6) - 5\,a(n-7) - 3\,a(n-8) + 6\,a(n-9) + 2\,a(n-10) - 8\,a(n-11) + 4\,a(n-12)
\]
for every $n>13$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A260602.
