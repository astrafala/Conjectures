...
\title{The empirical recurrence for OEIS A250141, derived from the entry's generating function}
...
\begin{abstract}
OEIS A250141 carries an empirical recurrence of order $5$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 12 2018 03:00:45, revision 11) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{5} + 5 x^{4} - 9 x^{3} + 3 x^{2} - 14 x}{x^{5} - 5 x^{4} + 10 x^{3} - 10 x^{2} + 5 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;x^{5} - 5 x^{4} + 9 x^{3} - 3 x^{2} + 14 x,
\]
