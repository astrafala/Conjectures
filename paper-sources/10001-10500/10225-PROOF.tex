...
\title{The empirical recurrence for OEIS A304265, proved by transfer matrix}
...
\begin{abstract}
OEIS A304265 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A304265 is ``Number of nX3 0..1 arrays with every element unequal to 0, 1, 5 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
3, 3, 6, 10, 19, 37, 67, 124,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +3*a(n-3) for n>4
\end{quote}
As of the ``Last modified'' line on the live entry (May 09 2018 10:11:31, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A304265.
