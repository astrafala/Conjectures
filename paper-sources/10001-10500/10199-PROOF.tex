...
\title{The empirical recurrence for OEIS A253506, derived from the entry's generating function}
...
\begin{abstract}
OEIS A253506 carries an empirical recurrence of order $5$. The entry separately records a
...
OEIS A253506 is ``Number of (n+2) X (4+2) 0..1 arrays with every 2 X 2 and 3 X 3 subblock diagonal maximum minus antidiagonal minimum nondecreasing horizontally and vertically.''. It has offset $1$ and begins
\[
636, 1196, 2088, 3400, 5136, 7396, 10236, 13748,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 16 2018 09:09:57, revision 7) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{4 x^{11} - 12 x^{10} + 36 x^{9} - 80 x^{8} + 140 x^{7} - 180 x^{6} - 236 x^{5} + 1440 x^{4} - 2468 x^{3} + 1984 x^{2} - 636 x}{x^{5} - 5 x^{4} + 10 x^{3} - 10 x^{2} + 5 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 4 x^{11} + 12 x^{10} - 36 x^{9} + 80 x^{8} - 140 x^{7} + 180 x^{6} + 236 x^{5} - 1440 x^{4} + 2468 x^{3} - 1984 x^{2} + 636 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253506.
