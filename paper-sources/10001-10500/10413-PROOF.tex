...
\title{The empirical recurrence for OEIS A187851, derived from the entry's generating function}
...
\begin{abstract}
OEIS A187851 carries an empirical recurrence of order $3$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 26 2018 08:38:59, revision 12) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{24 x^{6} - 32 x^{5} - 216 x^{4} - 232 x^{3} - 24 x^{2}}{x^{3} - 3 x^{2} + 3 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 24 x^{6} + 32 x^{5} + 216 x^{4} + 232 x^{3} + 24 x^{2},
\]
