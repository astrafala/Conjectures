...
\title{The empirical recurrence for OEIS A221517, derived from the entry's generating function}
...
\begin{abstract}
OEIS A221517 carries an empirical recurrence of order $6$. The entry separately records a
...
OEIS A221517 is ``Number of 0..n arrays of length 6 with each element differing from at least one neighbor by 2 or more, starting with 0.''. It has offset $1$ and begins
\[
0, 5, 89, 532, 1970, 5513, 12872, 26477,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 06 2018 05:35:49, revision 7) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{10} + 3 x^{9} - 9 x^{8} + 9 x^{7} - 32 x^{6} + 13 x^{5} + 73 x^{4} + 59 x^{3} + 5 x^{2}}{x^{6} - 6 x^{5} + 15 x^{4} - 20 x^{3} + 15 x^{2} - 6 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- x^{10} + 3 x^{9} - 9 x^{8} + 9 x^{7} - 32 x^{6} + 13 x^{5} + 73 x^{4} + 59 x^{3} + 5 x^{2},
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221517.
