...
\title{The empirical recurrence for OEIS A185858, proved by transfer matrix}
...
\begin{abstract}
OEIS A185858 carries an empirical recurrence of order $2$ contributed by R.~H.~Hardin. It is
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 17 2018 06:18:34, revision 9) this is still
