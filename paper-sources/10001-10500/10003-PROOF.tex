...
\title{The empirical recurrence for OEIS A269586, derived from the entry's generating function}
...
\begin{abstract}
OEIS A269586 carries an empirical recurrence of order $7$. The entry separately records a
...
\begin{quote}
G.f.: x*(64 + 211*x + 411*x\^{}2 + 78*x\^{}3 - 34*x\^{}4 - 9*x\^{}5 - x\^{}6) / (1 - x)\^{}7.
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 24 2019 11:45:32, revision 7) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{x^{7} + 9 x^{6} + 34 x^{5} - 78 x^{4} - 411 x^{3} - 211 x^{2} - 64 x}{x^{7} - 7 x^{6} + 21 x^{5} - 35 x^{4} + 35 x^{3} - 21 x^{2} + 7 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- x^{7} - 9 x^{6} - 34 x^{5} + 78 x^{4} + 411 x^{3} + 211 x^{2} + 64 x,
\]
