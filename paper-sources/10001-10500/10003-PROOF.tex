...
\title{The empirical recurrence for OEIS A260468, proved by transfer matrix}
...
\begin{abstract}
OEIS A260468 counts $(n+2)\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A260468 is ``Number of (n+2) X (1+2) 0..1 arrays with each 3 X 3 subblock having clockwise perimeter pattern 00000000 00000001 or 00010101.''. It has offset $1$ and begins
\[
34, 49, 103, 205, 414, 840, 1716, 3477,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + 3*a(n-3) + a(n-4) + 2*a(n-5) + 12*a(n-8) - 4*a(n-9) - 4*a(n-11) - 4*a(n-12) for n>13.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 29 2018 07:08:11, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 3\,a(n-3) + a(n-4) + 2\,a(n-5) + 12\,a(n-8) - 4\,a(n-9) - 4\,a(n-11) - 4\,a(n-12)
\]
for every $n>13$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A260468.
