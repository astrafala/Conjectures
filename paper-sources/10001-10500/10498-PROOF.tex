...
\title{The empirical recurrence for OEIS A251517, proved by transfer matrix}
...
\begin{abstract}
OEIS A251517 counts $2$-column arrays over $\{0,\dots,3\}$ in which every
...
OEIS A251517 is ``Number of (n+1) X (1+1) 0..3 arrays with every 2 X 2 subblock summing to 2 3 4 5 6 7 8 9 or 10.''. It has offset $1$
and begins
\[
246, 3798, 58618, 904734, 13963994, 215525422, 3326498602, 51342402526,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 15*a(n-1) + 8*a(n-2) - 20*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 30 2018 10:05:03, revision 7) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;15\,a(n-1) + 8\,a(n-2) - 20\,a(n-3)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251517.
