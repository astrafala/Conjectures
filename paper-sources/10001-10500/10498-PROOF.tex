...
\title{The empirical recurrence for OEIS A236323, proved by transfer matrix}
...
\begin{abstract}
OEIS A236323 counts arrays over $\{0,\dots,1\}$ subject to a condition on the order
...
The condition is local to two consecutive rows, so the count is a walk count on $S=16$
...
OEIS A236323 is ``Number of (n+1) X (1+1) 0..1 arrays colored with the sum of the upper and lower median values of each 2 X 2 subblock.''. It has offset $1$ and begins
\[
16, 32, 60, 120, 252, 496, 972, 1960,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-2) + 2*a(n-3) + 8*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 21 2018 13:45:21, revision 10) this is still
...
\]
over the $S=16$ pairs whose own subblock row is properly coloured.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A236323.
