...
\title{The empirical recurrence for OEIS A251501, proved by transfer matrix}
...
\begin{abstract}
OEIS A251501 counts $3$-column arrays over $\{0,\dots,3\}$ in which every
...
OEIS A251501 is ``Number of (n+1)X(2+1) 0..3 arrays with every 2X2 subblock summing to 3 4 5 6 7 8 or 9.''. It has offset $1$
and begins
\[
3250, 170038, 8888108, 464687066, 24294592462, 1270162626436, 66406260528122, 3471832190942254,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 10:26:14, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;51\,a(n-1) + 98\,a(n-2) - 1591\,a(n-3) - 1723\,a(n-4) + 10123\,a(n-5) + 2357\,a(n-6) - 17329\,a(n-7) + 4004\,a(n-8) + 5484\,a(n-9) - 1920\,a(n-10)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251501.
