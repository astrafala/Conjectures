...
\title{The empirical recurrence for OEIS A252187, proved by transfer matrix}
...
\begin{abstract}
OEIS A252187 counts $(n+2)\times5$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252187 is ``Number of (n+2) X (3+2) 0..3 arrays with every 3 X 3 subblock row and column sum equal to 0 1 3 6 or 7 and every 3 X 3 diagonal and antidiagonal sum not equal to 0 1 3 6 or 7.''. It has offset $1$ and begins
\[
2055, 2610, 3705, 5460, 8945, 13737, 20974, 34209,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 7*a(n-3) -14*a(n-6) +8*a(n-9) for n>15.
\end{quote}
As of the ``Last modified'' line on the live entry (May 04 2024 11:35:45, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252187.
