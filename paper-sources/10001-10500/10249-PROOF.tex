...
\title{The empirical recurrence for OEIS A257444, proved by transfer matrix}
...
\begin{abstract}
OEIS A257444 counts $(n+2)\times7$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A257444 is ``Number of (n+2) X (5+2) 0..1 arrays with no 3 x 3 subblock diagonal sum 0 and no antidiagonal sum 3 and no row sum 1 and no column sum 1.''. It has offset $1$ and begins
\[
65, 68, 77, 89, 107, 134, 173, 230,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) - a(n-2) + a(n-3) - a(n-4) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 21 2018 09:40:09, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A257444.
