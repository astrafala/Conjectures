...
\title{The empirical recurrence for OEIS A267350, derived from the entry's generating function}
...
\begin{abstract}
OEIS A267350 carries an empirical recurrence of order $6$. The entry separately records a
...
OEIS A267350 is ``Binary representation of the n-th iteration of the "Rule 123" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 101, 1110, 1110111, 111000, 11111011111, 11100000, 111111101111111,\ \dots
\]
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 10100000 x^{6} + 200000 x^{5} + 10091010 x^{4} - 89910 x^{3} + 8991 x^{2} - 101 x - 1}{1000000 x^{6} - 1010100 x^{4} + 10101 x^{2} - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;10100000 x^{6} - 200000 x^{5} - 10091010 x^{4} + 89910 x^{3} - 8991 x^{2} + 101 x + 1,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267350.
