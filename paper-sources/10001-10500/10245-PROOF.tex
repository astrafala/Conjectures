...
\title{The empirical recurrence for OEIS A206727, proved by transfer matrix}
...
\begin{abstract}
OEIS A206727 counts arrays of width $1$ over $\{0,1,2\}$ containing no occurrence of certain short
...
count is a walk count on $S=13$ states.
\end{abstract}
...
OEIS A206727 is ``Number of nX1 0..2 arrays avoiding the pattern z-1 z-1 z in any row, column or nw-to-se diagonal.''. It has offset $1$ and begins
\[
3, 9, 25, 69, 190, 523, 1440, 3965,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) -2*a(n-3) +a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 13:06:45, revision 11) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The array has $1$ cells across, with entries in $\{0,1,2\}$. An OCCURRENCE of a pattern in a
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206727.
