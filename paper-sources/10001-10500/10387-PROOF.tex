...
\title{The empirical recurrence for OEIS A298965, proved by transfer matrix}
...
\begin{abstract}
OEIS A298965 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A298965 is ``Number of nX3 0..1 arrays with every element equal to 0, 1, 2, 3, 4 or 5 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
4, 32, 219, 1575, 11283, 80972, 581057, 4169867,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 7*a(n-1) +3*a(n-2) -11*a(n-3) -11*a(n-4) +2*a(n-5) +19*a(n-6) -8*a(n-7) -12*a(n-8)
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 30 2018 13:27:51, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;7\,a(n-1) + 3\,a(n-2) - 11\,a(n-3) - 11\,a(n-4) + 2\,a(n-5) + 19\,a(n-6) - 8\,a(n-7) - 12\,a(n-8)
\end{equation}
for all $n>8$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A298965.
