...
\title{The empirical recurrence for OEIS A269539, derived from the entry's generating function}
...
\begin{abstract}
OEIS A269539 carries an empirical recurrence of order $6$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 24 2019 08:20:53, revision 7) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 8 x^{5} + 4 x^{4} + 30 x^{3} + 80 x^{2} + 14 x}{x^{6} - 6 x^{5} + 15 x^{4} - 20 x^{3} + 15 x^{2} - 6 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 8 x^{5} + 4 x^{4} + 30 x^{3} + 80 x^{2} + 14 x,
\]
