...
\title{The empirical recurrence for OEIS A212837, derived from the entry's generating function}
...
\begin{abstract}
OEIS A212837 carries an empirical recurrence of order $5$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 21 2018 10:07:16, revision 10) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{5} + 3 x^{4} + 7 x^{3} - 31 x^{2} - 2 x}{x^{5} - 5 x^{4} + 10 x^{3} - 10 x^{2} + 5 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;x^{5} - 3 x^{4} - 7 x^{3} + 31 x^{2} + 2 x,
\]
