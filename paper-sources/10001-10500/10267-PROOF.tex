...
\title{The empirical recurrence for OEIS A247399, proved by transfer matrix}
...
\begin{abstract}
OEIS A247399 carries an empirical recurrence of order $10$ contributed by R.~H.~Hardin. It is
...
OEIS A247399 is ``Number of length n+4 0..3 arrays with no disjoint pairs in any consecutive five terms having the same sum.''. It has offset $1$ and begins
\[
200, 264, 340, 428, 528, 640, 864, 1136,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 6*a(n-5) - 8*a(n-10).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 07 2018 09:56:45, revision 9) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A247399.
