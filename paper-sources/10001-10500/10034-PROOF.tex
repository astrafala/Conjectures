...
\title{The empirical recurrence for OEIS A232331, proved by transfer matrix}
...
\begin{abstract}
OEIS A232331 counts arrays of width $4$ over $\{0,1,2\}$ in which every cell carrying one stated
...
OEIS A232331 is ``Number of nX4 0..2 arrays with every 0 next to a 1 and every 1 next to a 2 horizontally or antidiagonally, with no adjacent elements equal.''. It has offset $1$ and begins
\[
6, 32, 154, 734, 3472, 16338, 76630, 358656,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 7*a(n-1) -9*a(n-2) -8*a(n-3) -4*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 07:19:08, revision 8) this is still
...
adjacency matrix,
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=538.
\]
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-1) - 9\,a(n-2) - 8\,a(n-3) - 4\,a(n-4)
\]
for every $n>4$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232331.
