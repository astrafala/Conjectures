...
\title{The empirical recurrence for OEIS A201812, derived from the entry's generating function}
...
\begin{abstract}
OEIS A201812 carries an empirical recurrence of order $4$. The entry separately records a
...
OEIS A201812 is ``Number of arrays of 4 integers in -n..n with sum zero and equal numbers of elements greater than zero and less than zero.''. It has offset $1$ and begins
\[
19, 61, 151, 313, 571, 949, 1471, 2161,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 25 2018 08:56:37, revision 10) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{4} + 21 x^{3} - 15 x^{2} + 19 x}{x^{4} - 4 x^{3} + 6 x^{2} - 4 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- x^{4} + 21 x^{3} - 15 x^{2} + 19 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A201812.
