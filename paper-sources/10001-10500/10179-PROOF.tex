...
\title{The empirical recurrence for OEIS A246732, proved by transfer matrix}
...
\begin{abstract}
OEIS A246732 carries an empirical recurrence of order $4$ contributed by R.~H.~Hardin. It is
...
OEIS A246732 is ``Number of length n+4 0..3 arrays with no pair in any consecutive five terms totalling exactly 3.''. It has offset $1$ and begins
\[
124, 260, 548, 1156, 2436, 5132, 10812, 22780,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 06 2018 08:19:55, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A246732.
