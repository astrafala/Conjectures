...
\title{The empirical recurrence for OEIS A246736, proved by transfer matrix}
...
\begin{abstract}
OEIS A246736 carries an empirical recurrence of order $8$ contributed by R.~H.~Hardin. It is
...
OEIS A246736 is ``Number of length n+4 0..7 arrays with no pair in any consecutive five terms totalling exactly 7.''. It has offset $1$ and begins
\[
9368, 47432, 241544, 1231304, 6272072, 31944440, 162700376, 828690200,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) +4*a(n-2) +4*a(n-3) +18*a(n-4) +12*a(n-5) -4*a(n-7) -a(n-8)
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 10:14:05, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + 4\,a(n-2) + 4\,a(n-3) + 18\,a(n-4) + 12\,a(n-5) - 4\,a(n-7) - a(n-8)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A246736.
