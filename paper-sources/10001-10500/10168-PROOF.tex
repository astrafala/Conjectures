...
\title{The empirical recurrence for OEIS A269496, derived from the entry's generating function}
...
\begin{abstract}
OEIS A269496 carries an empirical recurrence of order $6$. The entry separately records a
...
OEIS A269496 is ``Number of length-5 0..n arrays with no repeated value differing from the previous repeated value by one.''. It has offset $1$ and begins
\[
24, 215, 964, 3021, 7616, 16579, 32460, 58649,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 21 2025 05:20:10, revision 12) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{6} + 10 x^{5} - 18 x^{4} + 34 x^{3} + 71 x^{2} + 24 x}{x^{6} - 6 x^{5} + 15 x^{4} - 20 x^{3} + 15 x^{2} - 6 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- x^{6} + 10 x^{5} - 18 x^{4} + 34 x^{3} + 71 x^{2} + 24 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269496.
