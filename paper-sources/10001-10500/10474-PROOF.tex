...
\title{The empirical recurrence for OEIS A243513, proved by transfer matrix}
...
\begin{abstract}
OEIS A243513 carries an empirical recurrence of order $3$ contributed by R.~H.~Hardin. It is
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 02 2018 12:27:31, revision 9) this is still
...
admissible array is then exactly a walk, so with $M$ the adjacency matrix on $S=37$ vertices
