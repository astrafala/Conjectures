...
\title{The empirical recurrence for OEIS A250363, derived from the entry's generating function}
...
\begin{abstract}
OEIS A250363 carries an empirical recurrence of order $6$. The entry separately records a
...
OEIS A250363 is ``Number of length 5 arrays x(i), i=1..5 with x(i) in i..i+n and no value appearing more than 3 times.''. It has offset $1$ and begins
\[
32, 243, 1016, 3094, 7712, 16700, 32608, 58826,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 13 2018 12:48:29, revision 7) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 5 x^{8} + 22 x^{7} - 29 x^{6} + 8 x^{5} + 3 x^{4} + 38 x^{3} + 51 x^{2} + 32 x}{x^{6} - 6 x^{5} + 15 x^{4} - 20 x^{3} + 15 x^{2} - 6 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 5 x^{8} + 22 x^{7} - 29 x^{6} + 8 x^{5} + 3 x^{4} + 38 x^{3} + 51 x^{2} + 32 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250363.
