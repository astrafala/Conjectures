...
\title{The empirical recurrence for OEIS A206059, proved by transfer matrix}
...
\begin{abstract}
OEIS A206059 counts arrays over $\{0,\dots,3\}$ under a condition on the perimeter cycle of
...
a bounded window of consecutive rows, so the count is a walk count on $S=170688$ states and is
...
OEIS A206059 is ``Number of (n+1)X5 0..3 arrays with every 2X3 or 3X2 subblock having exactly two clockwise edge increases.''. It has offset $1$ and begins
\[
170688, 1390488, 11155584, 111242648, 1198231144, 12877680064, 144759802024, 1569116858248,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 1307*a(n-3) +24*a(n-4) +677*a(n-5) +44*a(n-6) +256*a(n-7) for n>16
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 12:25:44, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;1307\,a(n-3) + 24\,a(n-4) + 677\,a(n-5) + 44\,a(n-6) + 256\,a(n-7)
\]
for every $n>16$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206059.
