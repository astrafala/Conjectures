...
\title{The empirical recurrence for OEIS A188786, derived from the entry's generating function}
...
\begin{abstract}
OEIS A188786 carries an empirical recurrence of order $5$. The entry separately records a
...
OEIS A188786 is ``Number of 3-step self-avoiding walks on an n X n X n X n 4-cube summed over all starting positions.''. It has offset $1$ and begins
\[
0, 192, 1944, 7936, 22200, 50112, 98392, 175104,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 28 2018 12:49:00, revision 9) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{8 x^{6} - 40 x^{5} - 136 x^{4} - 984 x^{3} - 192 x^{2}}{x^{5} - 5 x^{4} + 10 x^{3} - 10 x^{2} + 5 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 8 x^{6} + 40 x^{5} + 136 x^{4} + 984 x^{3} + 192 x^{2},
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A188786.
