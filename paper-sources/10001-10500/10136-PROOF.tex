...
\title{The empirical recurrence for OEIS A317760, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A317760 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A317760 is ``Number of nX4 0..1 arrays with every element unequal to 0, 1 or 2 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
8, 20, 28, 43, 72, 127, 232, 432,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) +a(n-2) -2*a(n-3) -a(n-4) +a(n-5) for n>6
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 06 2018 11:49:26, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + a(n-2) - 2\,a(n-3) - a(n-4) + a(n-5)
\end{equation}
for all $n>6$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A317760.
