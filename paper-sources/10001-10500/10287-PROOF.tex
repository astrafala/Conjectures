...
\title{The empirical recurrence for OEIS A251123, proved by transfer matrix}
...
\begin{abstract}
OEIS A251123 counts $(n+1)\times4$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A251123 is ``Number of (n+1) X (3+1) 0..1 arrays with no 2 X 2 subblock having the sum of its diagonal elements greater than the maximum of its antidiagonal elements.''. It has offset $1$ and begins
\[
40, 69, 108, 173, 272, 430, 680, 1080,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 4*a(n-1) -5*a(n-2) +a(n-3) +2*a(n-4) -a(n-5) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 25 2018 11:44:18, revision 10) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251123.
