...
\title{The empirical recurrence for OEIS A199533, derived from the entry's generating function}
...
\begin{abstract}
OEIS A199533 carries an empirical recurrence of order $6$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 15 2018 20:43:48, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 2 x^{5} + 42 x^{4} + 1058 x^{3} + 934 x^{2} + 80 x}{x^{6} - 6 x^{5} + 15 x^{4} - 20 x^{3} + 15 x^{2} - 6 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 2 x^{5} + 42 x^{4} + 1058 x^{3} + 934 x^{2} + 80 x,
\]
