...
\title{The empirical recurrence for OEIS A206982, proved by transfer matrix}
...
\begin{abstract}
OEIS A206982 counts arrays of width $3$ over $\{0,1\}$ containing no occurrence of certain short
...
OEIS A206982 is ``Number of n X 3 0..1 arrays avoiding the patterns 0 1 0 or 1 0 1 in any row, column, diagonal or antidiagonal.''. It has offset $1$ and begins
\[
6, 36, 58, 158, 420, 1066, 2754, 7140,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + a(n-2) + 2*a(n-3) - a(n-4) - 2*a(n-5) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 17 2018 14:40:04, revision 11) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + a(n-2) + 2\,a(n-3) - a(n-4) - 2\,a(n-5)
\]
for every $n>7$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206982.
