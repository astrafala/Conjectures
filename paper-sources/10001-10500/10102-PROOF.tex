...
\title{The empirical recurrence for OEIS A251233, proved by transfer matrix}
...
\begin{abstract}
OEIS A251233 counts $6$-column arrays over $\{0,\dots,3\}$ in which every
...
\mathbf{1}$ for the adjacency matrix $M$ of that digraph, on $S=4096$ vertices. Writing
...
OEIS A251233 is ``Number of (n+1) X (5+1) 0..3 arrays with every 2 X 2 subblock summing to 6 and no 2 X 2 subblock having exactly two nonzero entries.''. It has offset $1$
and begins
\[
2930, 5194, 9914, 20490, 44966, 103926, 250622, 626122,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2015 23:46:23, revision 10) the statement is
...
Let $V=\{0,1,\dots,3\}^{6}$, the set of possible rows, so $|V|=S=4096$. For
...
bound $j<S=4096$ rather than to a sampled prefix, in exact integer arithmetic, and returned
zero throughout.

\begin{thebibliography}{9}
\bibitem{oeis} The OEIS Foundation, \emph{The On-Line Encyclopedia of Integer
Sequences}, \url{https://oeis.org}, 2026. Sequence A251233.
