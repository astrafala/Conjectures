...
\title{The empirical recurrence for OEIS A221575, derived from the entry's generating function}
...
\begin{abstract}
OEIS A221575 carries an empirical recurrence of order $6$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 08 2018 18:36:55, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 2 x^{8} + 12 x^{7} - 39 x^{6} + 56 x^{5} - 24 x^{4} + 90 x^{3} + 21 x^{2} + 6 x}{x^{6} - 6 x^{5} + 15 x^{4} - 20 x^{3} + 15 x^{2} - 6 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 2 x^{8} + 12 x^{7} - 39 x^{6} + 56 x^{5} - 24 x^{4} + 90 x^{3} + 21 x^{2} + 6 x,
\]
