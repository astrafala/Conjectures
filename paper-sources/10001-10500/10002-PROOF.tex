...
\title{The empirical recurrence for OEIS A269540, derived from the entry's generating function}
...
\begin{abstract}
OEIS A269540 carries an empirical recurrence of order $7$. The entry separately records a
...
\begin{quote}
G.f.: 2*x*(11 + 132*x + 207*x\^{}2 + 38*x\^{}3 - 21*x\^{}4 - 6*x\^{}5 - x\^{}6) / (1 - x)\^{}7.
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 24 2019 09:13:59, revision 7) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{2 x^{7} + 12 x^{6} + 42 x^{5} - 76 x^{4} - 414 x^{3} - 264 x^{2} - 22 x}{x^{7} - 7 x^{6} + 21 x^{5} - 35 x^{4} + 35 x^{3} - 21 x^{2} + 7 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 2 x^{7} - 12 x^{6} - 42 x^{5} + 76 x^{4} + 414 x^{3} + 264 x^{2} + 22 x,
\]
