...
\title{The empirical recurrence for OEIS A200888, derived from the entry's generating function}
...
\begin{abstract}
OEIS A200888 carries an empirical recurrence of order $6$. The entry separately records a
...
OEIS A200888 is ``Number of 0..n arrays x(0..4) of 5 elements without any interior element greater than both neighbors.''. It has offset $1$ and begins
\[
21, 121, 422, 1121, 2507, 4977, 9052, 15393,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 17 2026 12:00:36, revision 15) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{6} + 6 x^{5} - 16 x^{4} + 11 x^{3} - 5 x^{2} + 21 x}{x^{6} - 6 x^{5} + 15 x^{4} - 20 x^{3} + 15 x^{2} - 6 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- x^{6} + 6 x^{5} - 16 x^{4} + 11 x^{3} - 5 x^{2} + 21 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A200888.
