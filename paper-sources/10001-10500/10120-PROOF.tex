...
\title{The empirical recurrence for OEIS A266610, derived from the entry's generating function}
...
\begin{abstract}
OEIS A266610 carries an empirical recurrence of order $6$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 16 2025 08:33:28, revision 26) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{440 x^{5} - 80 x^{4} + 100 x^{3} - 11 x^{2} + 1}{16 x^{6} - x^{4} - 16 x^{2} + 1},
\]
the entry's own generating function, and let
\[
D(x)\;=\;1-\sum_i c_i x^{i}\;=\;16 x^{6} - x^{4} - 16 x^{2} + 1
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;440 x^{5} - 80 x^{4} + 100 x^{3} - 11 x^{2} + 1,
\]
