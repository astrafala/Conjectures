...
\title{The empirical recurrence for OEIS A282643, proved by transfer matrix}
...
\begin{abstract}
OEIS A282643 counts $n\times4$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A282643 is ``Number of nX4 0..1 arrays with no 1 equal to more than one of its king-move neighbors.''. It has offset $1$ and begins
\[
13, 76, 413, 2638, 15460, 92817, 557439, 3332685,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) +16*a(n-2) +45*a(n-3) +16*a(n-4) -2*a(n-5) -51*a(n-6) -35*a(n-7) -23*a(n-8) +7*a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 02 2017 12:36:01, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 16\,a(n-2) + 45\,a(n-3) + 16\,a(n-4) - 2\,a(n-5) - 51\,a(n-6) - 35\,a(n-7) - 23\,a(n-8) + 7\,a(n-9)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A282643.
