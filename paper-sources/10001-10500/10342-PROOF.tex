...
\title{The empirical recurrence for OEIS A201618, derived from the entry's generating function}
...
\begin{abstract}
OEIS A201618 carries an empirical recurrence of order $4$. The entry separately records a
...
OEIS A201618 is ``Number of n X 1 0..3 arrays with rows and columns lexicographically nondecreasing and every element equal to at least one horizontal or vertical neighbor.''. It has offset $1$ and begins
\[
0, 4, 4, 10, 16, 26, 40, 59,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 23 2018 20:03:57, revision 13) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{x^{8} - 4 x^{7} + 10 x^{6} - 16 x^{5} + 18 x^{4} - 12 x^{3} + 4 x^{2}}{x^{4} - 4 x^{3} + 6 x^{2} - 4 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;x^{8} - 4 x^{7} + 10 x^{6} - 16 x^{5} + 18 x^{4} - 12 x^{3} + 4 x^{2},
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A201618.
