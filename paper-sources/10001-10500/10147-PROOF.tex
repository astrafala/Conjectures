...
\title{The empirical recurrence for OEIS A200872, derived from the entry's generating function}
...
\begin{abstract}
OEIS A200872 carries an empirical recurrence of order $5$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 16 2017 12:22:22, revision 10) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{5} + 5 x^{4} - 9 x^{3} + 13 x^{2} - 10 x}{x^{5} - 5 x^{4} + 10 x^{3} - 10 x^{2} + 5 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;x^{5} - 5 x^{4} + 9 x^{3} - 13 x^{2} + 10 x,
\]
