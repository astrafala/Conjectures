...
\title{The empirical recurrence for OEIS A267153, derived from the entry's generating function}
...
\begin{abstract}
OEIS A267153 carries an empirical recurrence of order $6$. The entry separately records a
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 11009890000000000 x^{12} + 100990000000000 x^{11} - 109887911000000 x^{10} + 989801000000 x^{9} - 1099001110000 x^{8} + 9900910000 x^{7} - 10990090000 x^{6} + 99010910 x^{5} - 8999890 x^{4} + 101110 x^{3} - 8989 x^{2} + 100 x + 1}{10000 x^{6} - x^{4} - 10000 x^{2} + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 11009890000000000 x^{12} + 100990000000000 x^{11} - 109887911000000 x^{10} + 989801000000 x^{9} - 1099001110000 x^{8} + 9900910000 x^{7} - 10990090000 x^{6} + 99010910 x^{5} - 8999890 x^{4} + 101110 x^{3} - 8989 x^{2} + 100 x + 1,
\]
...
$n=8$ & $-1099001110000$ \\
$n=9$ & $989801000000$ \\
$n=10$ & $-109887911000000$ \\
$n=11$ & $100990000000000$ \\
$n=12$ & $-11009890000000000$ \\
$n=13$ & $0$ \\
$n=14$ & $0$ \\
$n=15$ & $0$ \\
$n=16$ & $0$
