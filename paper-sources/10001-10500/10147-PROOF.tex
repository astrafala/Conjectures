...
\title{The empirical recurrence for OEIS A231458, proved by transfer matrix}
...
\begin{abstract}
OEIS A231458 counts $(n+1)\times3$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A231458 is ``Number of (n+1) X (2+1) 0..3 arrays with no element unequal to a strict majority of its horizontal, diagonal and antidiagonal neighbors, with values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
7, 8, 15, 20, 32, 56, 111, 230,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) + a(n-2) - 7*a(n-3) + a(n-4) + 3*a(n-5) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 29 2018 03:12:51, revision 9) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231458.
