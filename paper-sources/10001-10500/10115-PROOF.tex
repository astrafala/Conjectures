...
\title{The empirical recurrence for OEIS A283489, proved by transfer matrix}
...
\begin{abstract}
OEIS A283489 counts $n\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A283489 is ``Number of nX3 0..1 arrays with no 1 equal to more than three of its horizontal, vertical and antidiagonal neighbors, with the exception of exactly one element.''. It has offset $1$ and begins
\[
0, 2, 59, 576, 5444, 47712, 402588, 3304736,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 08 2017 14:12:07, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;10\,a(n-1) + a(n-2) - 110\,a(n-3) - 267\,a(n-4) - 266\,a(n-5) - 146\,a(n-6) - 72\,a(n-7) - 41\,a(n-8) - 4\,a(n-9) - 4\,a(n-10)
\]
for every $n>13$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A283489.
