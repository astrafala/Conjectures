...
\title{The empirical recurrence for OEIS A187164, derived from the entry's generating function}
...
\begin{abstract}
OEIS A187164 carries an empirical recurrence of order $4$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 05 2022 22:11:36, revision 13) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{6 x^{5} - 24 x^{4} + 150 x^{3} + 48 x^{2}}{x^{4} - 4 x^{3} + 6 x^{2} - 4 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;6 x^{5} - 24 x^{4} + 150 x^{3} + 48 x^{2},
\]
