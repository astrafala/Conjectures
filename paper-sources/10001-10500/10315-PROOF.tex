...
\title{The empirical recurrence for OEIS A196316, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A196316 counts arrays over $\{0,\dots,4\}$ in which every cell is constrained by the
...
OEIS A196316 is ``Number of n X 2 0..4 arrays with each element x equal to the number its horizontal and vertical neighbors equal to 1,3,0,2,4 for x=0,1,2,3,4.''. It has offset $1$ and begins
\[
1, 7, 10, 23, 57, 122, 275, 623,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +2*a(n-2) +2*a(n-3) -a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 18 2018 10:02:29, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A196316.
