...
\title{The empirical recurrence for OEIS A252814, derived from the entry's generating function}
...
\begin{abstract}
OEIS A252814 carries an empirical recurrence of order $5$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 05 2025 15:22:28, revision 12) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{5} + 5 x^{4} - 7 x^{3} + 4 x^{2} - 2 x}{x^{5} - 5 x^{4} + 10 x^{3} - 10 x^{2} + 5 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;x^{5} - 5 x^{4} + 7 x^{3} - 4 x^{2} + 2 x,
\]
