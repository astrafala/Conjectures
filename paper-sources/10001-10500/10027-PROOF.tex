...
\title{The empirical recurrence for OEIS A261285, proved by transfer matrix}
...
\begin{abstract}
OEIS A261285 counts $(n+2)\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A261285 is ``Number of (n+2) X (1+2) 0..1 arrays with each 3 X 3 subblock having clockwise perimeter pattern 00000001 00010101 or 01010101.''. It has offset $1$ and begins
\[
36, 50, 96, 166, 307, 540, 1015, 1786,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-2) + 2*a(n-3) + 4*a(n-4) + 3*a(n-6) - 8*a(n-7) + 9*a(n-8) - 6*a(n-9) - 4*a(n-10) - 4*a(n-11) - 4*a(n-12) for n>13.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 30 2018 09:09:57, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-2) + 2\,a(n-3) + 4\,a(n-4) + 3\,a(n-6) - 8\,a(n-7) + 9\,a(n-8) - 6\,a(n-9) - 4\,a(n-10) - 4\,a(n-11) - 4\,a(n-12)
\]
for every $n>13$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A261285.
