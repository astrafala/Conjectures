...
\title{The empirical recurrence for OEIS A059142, derived from the entry's generating function}
...
\begin{abstract}
OEIS A059142 carries an empirical recurrence of order $3$. The entry separately records a
...
OEIS A059142 is ``A hierarchical sequence (S(W2{3}*) - see A059126).''. It has offset $0$ and begins
\[
11, 40, 105, 242, 523, 1092, 2237, 4534,\ \dots
\]
...
\begin{quote}
G.f.: (4*x-11) / ((x-1)\^{}2*(2*x-1)).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 02 2023 16:14:37, revision 32) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{4 x - 11}{2 x^{3} - 5 x^{2} + 4 x - 1},
\]
the entry's own generating function, and let
\[
D(x)\;=\;1-\sum_i c_i x^{i}\;=\;- 2 x^{3} + 5 x^{2} - 4 x + 1
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A059142.
