...
\title{The empirical recurrence for OEIS A301786, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A301786 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A301786 is ``Number of nX4 0..1 arrays with every element equal to 0 or 1 horizontally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
5, 9, 17, 32, 61, 116, 221, 421,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +2*a(n-2) -a(n-4)
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 26 2018 16:38:56, revision 4) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A301786.
