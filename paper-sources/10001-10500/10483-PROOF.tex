...
\title{The empirical recurrence for OEIS A252933, derived from the entry's generating function}
...
\begin{abstract}
OEIS A252933 carries an empirical recurrence of order $4$. The entry separately records a
...
OEIS A252933 is ``Number of n X 3 nonnegative integer arrays with upper left 0 and every value within 3 of its king move distance from the upper left and every value increasing by 0 or 1 with every step right, diagonally se or down.''. It has offset $1$ and begins
\[
4, 13, 44, 153, 494, 1343, 3016, 5833,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 07 2018 11:51:20, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{4 x^{8} + 40 x^{7} + 122 x^{6} + 98 x^{5} + 39 x^{4} + 16 x^{3} - 3 x^{2} + 4 x}{x^{4} - 4 x^{3} + 6 x^{2} - 4 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;4 x^{8} + 40 x^{7} + 122 x^{6} + 98 x^{5} + 39 x^{4} + 16 x^{3} - 3 x^{2} + 4 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252933.
