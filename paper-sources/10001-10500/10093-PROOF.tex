...
\title{The empirical recurrence for OEIS A243516, derived from the entry's generating function}
...
\begin{abstract}
OEIS A243516 carries an empirical recurrence of order $6$. The entry separately records a
...
OEIS A243516 is ``Number of length n+2 0..7 arrays with no three elements in a row with pattern aba or abb (with a!=b) and new values 0..7 introduced in 0..7 order.''. It has offset $1$ and begins
\[
3, 5, 10, 25, 77, 280, 1156, 5267,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 02 2018 12:26:30, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 288 x^{6} + 739 x^{5} - 655 x^{4} + 258 x^{3} - 46 x^{2} + 3 x}{144 x^{6} - 468 x^{5} + 584 x^{4} - 355 x^{3} + 111 x^{2} - 17 x + 1},
\]
the entry's own generating function, and let
\[
D(x)\;=\;1-\sum_i c_i x^{i}\;=\;144 x^{6} - 468 x^{5} + 584 x^{4} - 355 x^{3} + 111 x^{2} - 17 x + 1
\]
...
\begin{theorem}
\[
a(n)\;=\;17\,a(n-1) - 111\,a(n-2) + 355\,a(n-3) - 584\,a(n-4) + 468\,a(n-5) - 144\,a(n-6)
\]
for every $n>6$.
\end{theorem}
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 288 x^{6} + 739 x^{5} - 655 x^{4} + 258 x^{3} - 46 x^{2} + 3 x,
\]
...
\[
144 x^{6} - 468 x^{5} + 584 x^{4} - 355 x^{3} + 111 x^{2} - 17 x + 1,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A243516.
