...
\title{The empirical recurrence for OEIS A267139, derived from the entry's generating function}
...
\begin{abstract}
OEIS A267139 carries an empirical recurrence of order $6$. The entry separately records a
...
OEIS A267139 is ``Decimal representation of the n-th iteration of the "Rule 103" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 6, 6, 117, 60, 1931, 376, 32535,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 16 2025 08:33:29, revision 35) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 4096 x^{10} + 1536 x^{9} + 3584 x^{8} - 1504 x^{7} + 496 x^{6} - 8 x^{5} + 4 x^{4} - 3 x^{3} + 13 x^{2} - 6 x - 1}{32 x^{6} - 50 x^{4} + 19 x^{2} - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;4096 x^{10} - 1536 x^{9} - 3584 x^{8} + 1504 x^{7} - 496 x^{6} + 8 x^{5} - 4 x^{4} + 3 x^{3} - 13 x^{2} + 6 x + 1,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267139.
