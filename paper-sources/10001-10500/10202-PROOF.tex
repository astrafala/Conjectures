...
\title{The empirical recurrence for OEIS A278189, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A278189 counts arrays over $\{0,\dots,3\}$ in which every cell is constrained by the
...
OEIS A278189 is ``Number of 2 X n 0..3 arrays with every element plus 1 mod 4 equal to some element at offset (-1,-1) (-1,0) (-1,1) (0,-1) (0,1) or (1,0), with upper left element zero.''. It has offset $1$ and begins
\[
0, 3, 19, 136, 935, 6381, 43478, 296105,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 9*a(n-1) - 16*a(n-2) + 9*a(n-3) - 12*a(n-4) + 5*a(n-5) + 7*a(n-6) - 4*a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 08 2019 12:32:07, revision 7) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;9\,a(n-1) - 16\,a(n-2) + 9\,a(n-3) - 12\,a(n-4) + 5\,a(n-5) + 7\,a(n-6) - 4\,a(n-7)
\end{equation}
for all $n>8$.
...
Let $V=\{0,\dots,3\}^{2}$ be the possible columns and take
...
publishes, $n=21$, the arrays have $2\cdot21$ cells over
$4$ values, so there are about $10^{25}$ of them to sift. The
...
of the $(3+1)^{2}$ possible next columns, the condition was tested on every cell of
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A278189.
