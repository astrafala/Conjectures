...
\title{The empirical recurrence for OEIS A248456, proved by transfer matrix}
...
\begin{abstract}
OEIS A248456 carries an empirical recurrence of order $6$ contributed by R.~H.~Hardin. It is
...
OEIS A248456 is ``Number of length n+2 0..3 arrays with no three consecutive terms having the sum of any two elements equal to twice the third.''. It has offset $1$ and begins
\[
48, 148, 460, 1436, 4488, 14040, 43940, 137532,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + 3*a(n-2) + 4*a(n-3) - 3*a(n-4) - 12*a(n-5) - 4*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 08 2018 19:08:42, revision 9) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A248456.
