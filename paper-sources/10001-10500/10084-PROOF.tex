...
\title{The empirical recurrence for OEIS A200839, derived from the entry's generating function}
...
\begin{abstract}
OEIS A200839 carries an empirical recurrence of order $5$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 08:49:11, revision 12) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{5} + 5 x^{4} - 9 x^{3} + 11 x^{2} - 16 x}{x^{5} - 5 x^{4} + 10 x^{3} - 10 x^{2} + 5 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;x^{5} - 5 x^{4} + 9 x^{3} - 11 x^{2} + 16 x,
\]
