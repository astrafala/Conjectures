...
\title{The empirical recurrence for OEIS A209546, proved by transfer matrix}
...
\begin{abstract}
OEIS A209546 counts $(n+1)\times2$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A209546 is ``1/4 the number of (n+1) X 2 0..3 arrays with every 2 X 2 subblock having exactly two distinct clockwise edge differences.''. It has offset $1$ and begins
\[
7, 20, 61, 191, 603, 1909, 6049, 19173,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 5*a(n-1) - 6*a(n-2) + 2*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 11 2018 06:18:03, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) - 6\,a(n-2) + 2\,a(n-4)
\end{equation}
for all $n>4$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209546.
