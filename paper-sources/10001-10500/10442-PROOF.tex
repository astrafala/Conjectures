...
\title{The empirical recurrence for OEIS A187168, derived from the entry's generating function}
...
\begin{abstract}
OEIS A187168 carries an empirical recurrence of order $4$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 05 2022 22:11:52, revision 14) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{150 x^{9} + 1320 x^{8} + 798 x^{7} - 13440 x^{6} + 11064 x^{5} + 76896 x^{4} + 24576 x^{3} + 192 x^{2}}{x^{4} - 4 x^{3} + 6 x^{2} - 4 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;150 x^{9} + 1320 x^{8} + 798 x^{7} - 13440 x^{6} + 11064 x^{5} + 76896 x^{4} + 24576 x^{3} + 192 x^{2},
\]
