...
\title{The empirical recurrence for OEIS A269778, derived from the entry's generating function}
...
\begin{abstract}
OEIS A269778 carries an empirical recurrence of order $7$. The entry separately records a
...
OEIS A269778 is ``Number of length-6 0..n arrays with every repeated value unequal to the previous repeated value plus one mod n+1.''. It has offset $1$ and begins
\[
40, 624, 3816, 15040, 45600, 115920, 259504, 527616,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 29 2019 09:27:03, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 16 x^{5} - 32 x^{4} - 288 x^{3} - 344 x^{2} - 40 x}{x^{7} - 7 x^{6} + 21 x^{5} - 35 x^{4} + 35 x^{3} - 21 x^{2} + 7 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;16 x^{5} + 32 x^{4} + 288 x^{3} + 344 x^{2} + 40 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269778.
