...
\title{The empirical recurrence for OEIS A201044, derived from the entry's generating function}
...
\begin{abstract}
OEIS A201044 carries an empirical recurrence of order $6$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 22 2018 03:34:04, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{6} + 7 x^{5} + 78 x^{4} + 602 x^{3} + 567 x^{2} + 99 x}{x^{6} - 6 x^{5} + 15 x^{4} - 20 x^{3} + 15 x^{2} - 6 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- x^{6} + 7 x^{5} + 78 x^{4} + 602 x^{3} + 567 x^{2} + 99 x,
\]
