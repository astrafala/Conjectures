...
\title{The empirical recurrence for OEIS A188152, derived from the entry's generating function}
...
\begin{abstract}
OEIS A188152 carries an empirical recurrence of order $3$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 27 2018 09:22:39, revision 14) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{20 x^{8} + 116 x^{7} + 72 x^{6} - 744 x^{5} - 912 x^{4} - 112 x^{3}}{x^{3} - 3 x^{2} + 3 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 20 x^{8} - 116 x^{7} - 72 x^{6} + 744 x^{5} + 912 x^{4} + 112 x^{3},
\]
