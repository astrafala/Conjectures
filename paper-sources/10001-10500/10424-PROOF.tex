...
\title{The empirical recurrence for OEIS A304137, proved by transfer matrix}
...
\begin{abstract}
OEIS A304137 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A304137 is ``Number of nX4 0..1 arrays with every element unequal to 0, 2, 3 or 6 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 13, 9, 11, 20, 17, 25, 62,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) +2*a(n-3) -6*a(n-4) +3*a(n-6) for n>10
\end{quote}
As of the ``Last modified'' line on the live entry (May 07 2018 08:09:36, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 2\,a(n-3) - 6\,a(n-4) + 3\,a(n-6)
\end{equation}
for all $n>10$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A304137.
