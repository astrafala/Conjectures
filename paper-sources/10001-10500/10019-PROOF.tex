...
\title{The empirical recurrence for OEIS A297334, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297334 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A297334 is ``Number of n X 4 0..1 arrays with every 1 horizontally or antidiagonally adjacent to 0 or 2 neighboring 1s.''. It has offset $1$ and begins
\[
8, 53, 334, 2119, 13428, 85065, 538819, 3412881,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 8*a(n-1) - 10*a(n-2) - 4*a(n-3) + 3*a(n-4) + a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 27 2019 11:00:06, revision 7) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;8\,a(n-1) - 10\,a(n-2) - 4\,a(n-3) + 3\,a(n-4) + a(n-5)
\end{equation}
for all $n>6$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297334.
