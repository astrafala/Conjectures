...
\title{The empirical recurrence for OEIS A188787, derived from the entry's generating function}
...
\begin{abstract}
OEIS A188787 carries an empirical recurrence of order $5$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 28 2018 12:49:04, revision 10) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{64 x^{7} - 304 x^{6} + 560 x^{5} - 3104 x^{4} - 6048 x^{3} - 576 x^{2}}{x^{5} - 5 x^{4} + 10 x^{3} - 10 x^{2} + 5 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 64 x^{7} + 304 x^{6} - 560 x^{5} + 3104 x^{4} + 6048 x^{3} + 576 x^{2},
\]
