...
\title{The empirical recurrence for OEIS A232337, proved by transfer matrix}
...
\begin{abstract}
OEIS A232337 counts arrays of width $3$ over $\{0,1,2\}$ in which every cell carrying one stated
...
OEIS A232337 is ``Number of 3 X n 0..2 arrays with every 0 next to a 1 and every 1 next to a 2 horizontally or antidiagonally, with no adjacent elements equal.''. It has offset $1$ and begins
\[
1, 16, 74, 154, 628, 1470, 5530, 13906,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + 7*a(n-2) - 3*a(n-3) + 3*a(n-4) - 7*a(n-5) + 2*a(n-6) - 2*a(n-7) + 2*a(n-8) for n>12.
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 05 2018 11:03:40, revision 7) this is still
...
adjacency matrix,
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=110.
\]
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 7\,a(n-2) - 3\,a(n-3) + 3\,a(n-4) - 7\,a(n-5) + 2\,a(n-6) - 2\,a(n-7) + 2\,a(n-8)
\]
for every $n>12$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232337.
