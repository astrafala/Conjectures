...
\title{The empirical recurrence for OEIS A303717, proved by transfer matrix}
...
\begin{abstract}
OEIS A303717 counts $6$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A303717 is ``Number of nX6 0..1 arrays with every element unequal to 0, 1 or 5 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
13, 13, 24, 76, 169, 343, 741, 1618,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +a(n-2) +3*a(n-3) +a(n-4) -a(n-5) -a(n-6) for n>9
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 29 2018 10:53:20, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A303717.
