...
\title{The empirical recurrence for OEIS A269681, derived from the entry's generating function}
...
\begin{abstract}
OEIS A269681 carries an empirical recurrence of order $7$. The entry separately records a
...
OEIS A269681 is ``Number of length-6 0..n arrays with no repeated value differing from the previous repeated value by other than plus or minus one modulo n+1.''. It has offset $1$ and begins
\[
22, 462, 2976, 12390, 39156, 102606, 234912, 485766,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 26 2019 11:10:20, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 14 x^{8} + 92 x^{7} - 252 x^{6} + 478 x^{5} - 490 x^{4} - 204 x^{3} - 308 x^{2} - 22 x}{x^{7} - 7 x^{6} + 21 x^{5} - 35 x^{4} + 35 x^{3} - 21 x^{2} + 7 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;14 x^{8} - 92 x^{7} + 252 x^{6} - 478 x^{5} + 490 x^{4} + 204 x^{3} + 308 x^{2} + 22 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269681.
