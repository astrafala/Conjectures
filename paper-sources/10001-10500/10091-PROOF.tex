...
\title{The empirical recurrence for OEIS A243636, proved by transfer matrix}
...
\begin{abstract}
OEIS A243636 carries an empirical recurrence of order $8$ contributed by R.~H.~Hardin. It is
...
OEIS A243636 is ``Number of length n+2 0..5 arrays with no three unequal elements in a row and new values 0..5 introduced in 0..5 order.''. It has offset $1$ and begins
\[
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 02 2018 12:28:03, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;9\,a(n-1) - 25\,a(n-2) + 7\,a(n-3) + 64\,a(n-4) - 54\,a(n-5) - 48\,a(n-6) + 32\,a(n-7) + 16\,a(n-8)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A243636.
