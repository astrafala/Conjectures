...
\title{The empirical recurrence for OEIS A250891, proved by transfer matrix}
...
\begin{abstract}
OEIS A250891 counts arrays over $\{0,1,2\}$ in which a statistic taken over short runs
...
OEIS A250891 is ``Number of (n+1) X (1+1) 0..2 arrays with nondecreasing x(i,j)-x(i,j-1) in the i direction and nondecreasing absolute value of x(i,j)-x(i-1,j) in the j direction.''. It has offset $1$ and begins
\[
37, 125, 413, 1333, 4213, 13111, 40357, 123271,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 8*a(n-1) - 23*a(n-2) + 28*a(n-3) - 12*a(n-4) for n > 6.
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 19 2018 22:09:19, revision 11) this is still
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-1) - 23\,a(n-2) + 28\,a(n-3) - 12\,a(n-4)
\]
for every $n>6$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250891.
