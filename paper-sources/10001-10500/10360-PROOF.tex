...
\title{The empirical recurrence for OEIS A127069, derived from the entry's generating function}
...
\begin{abstract}
OEIS A127069 carries an empirical recurrence of order $3$. The entry separately records a
...
OEIS A127069 is ``Number of lines in a Pauli graph of order n.''. It has offset $2$ and begins
\[
15, 45, 153, 561, 2145, 8385, 33153, 131841,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 03 2019 11:49:29, revision 17) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 48 x^{4} + 60 x^{3} - 15 x^{2}}{8 x^{3} - 14 x^{2} + 7 x - 1},
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A127069.
