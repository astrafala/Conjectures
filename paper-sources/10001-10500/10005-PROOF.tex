...
\title{The empirical recurrence for OEIS A269622, derived from the entry's generating function}
...
\begin{abstract}
OEIS A269622 carries an empirical recurrence of order $7$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 25 2019 08:27:48, revision 7) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{x^{9} - 5 x^{8} + 14 x^{7} - 17 x^{6} + 86 x^{5} - 167 x^{4} - 314 x^{3} - 267 x^{2} - 51 x}{x^{7} - 7 x^{6} + 21 x^{5} - 35 x^{4} + 35 x^{3} - 21 x^{2} + 7 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- x^{9} + 5 x^{8} - 14 x^{7} + 17 x^{6} - 86 x^{5} + 167 x^{4} + 314 x^{3} + 267 x^{2} + 51 x,
\]
