...
\title{The empirical recurrence for OEIS A184540, derived from the entry's generating function}
...
\begin{abstract}
OEIS A184540 carries an empirical recurrence of order $4$. The entry separately records a
...
OEIS A184540 is ``Number of (n+2) X 3 binary arrays with each 3 X 3 subblock having rows and columns in lexicographically nondecreasing order.''. It has offset $1$ and begins
\[
45, 89, 147, 220, 309, 415, 539, 682,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 25 2026 16:04:18, revision 11) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 14 x^{4} + 61 x^{3} - 91 x^{2} + 45 x}{x^{4} - 4 x^{3} + 6 x^{2} - 4 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 14 x^{4} + 61 x^{3} - 91 x^{2} + 45 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A184540.
