...
\title{The empirical recurrence for OEIS A251232, proved by transfer matrix}
...
\begin{abstract}
OEIS A251232 counts $5$-column arrays over $\{0,\dots,3\}$ in which every
...
\mathbf{1}$ for the adjacency matrix $M$ of that digraph, on $S=1024$ vertices. Writing
...
OEIS A251232 is ``Number of (n+1) X (4+1) 0..3 arrays with every 2 X 2 subblock summing to 6 and no 2 X 2 subblock having exactly two nonzero entries.''. It has offset $1$
and begins
\[
966, 1870, 3886, 8686, 20490, 50570, 129378, 340782,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2015 23:35:02, revision 10) the statement is
...
Let $V=\{0,1,\dots,3\}^{5}$, the set of possible rows, so $|V|=S=1024$. For
...
bound $j<S=1024$ rather than to a sampled prefix, in exact integer arithmetic, and returned
zero throughout.

\begin{thebibliography}{9}
\bibitem{oeis} The OEIS Foundation, \emph{The On-Line Encyclopedia of Integer
Sequences}, \url{https://oeis.org}, 2026. Sequence A251232.
