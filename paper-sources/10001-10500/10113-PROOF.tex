...
\title{The empirical recurrence for OEIS A251293, proved by transfer matrix}
...
\begin{abstract}
OEIS A251293 counts $2$-column arrays over $\{0,\dots,3\}$ in which every
...
OEIS A251293 is ``Number of (n+1) X (1+1) 0..3 arrays with every 2 X 2 subblock summing to 3 6 or 9.''. It has offset $1$
and begins
\[
84, 444, 2356, 12556, 67204, 361244, 1950036, 10570156,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 10*a(n-1) - 21*a(n-2) - 20*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 28 2018 08:04:08, revision 9) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251293.
