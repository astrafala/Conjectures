...
\title{The empirical recurrence for OEIS A267054, derived from the entry's generating function}
...
\begin{abstract}
OEIS A267054 carries an empirical recurrence of order $6$. The entry separately records a
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{100000 x^{5} + 10000 x^{3} + x^{2} - 11 x - 1}{1000000 x^{6} - 1010100 x^{4} + 10101 x^{2} - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 100000 x^{5} - 10000 x^{3} - x^{2} + 11 x + 1,
\]
