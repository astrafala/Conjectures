...
\title{The empirical recurrence for OEIS A118109, derived from the entry's generating function}
...
\begin{abstract}
OEIS A118109 carries an empirical recurrence of order $4$. The entry separately records a
...
OEIS A118109 is ``Binary representation of n-th iteration of the Rule 54 elementary cellular automaton starting with a single black cell.''. It has offset $0$ and begins
\[
1, 111, 10001, 1110111, 100010001, 11101110111, 1000100010001, 111011101110111,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 16 2025 08:33:00, revision 53) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{111 x + 1}{10000 x^{4} - 10001 x^{2} + 1},
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A118109.
