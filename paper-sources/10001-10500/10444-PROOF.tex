...
\title{The empirical recurrence for OEIS A228261, derived from the entry's generating function}
...
\begin{abstract}
OEIS A228261 carries an empirical recurrence of order $3$. The entry separately records a
...
OEIS A228261 is ``Number of third differences of arrays of length 5 of numbers in 0..n.''. It has offset $1$ and begins
\[
31, 143, 319, 565, 881, 1267, 1723, 2249,\ \dots
\]
...
\begin{quote}
G.f.: x*(31 + 50*x - 17*x\^{}2 + 6*x\^{}3) / (1 - x)\^{}3.
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 10 2018 15:18:51, revision 7) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 6 x^{4} + 17 x^{3} - 50 x^{2} - 31 x}{x^{3} - 3 x^{2} + 3 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;6 x^{4} - 17 x^{3} + 50 x^{2} + 31 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A228261.
