...
\title{The empirical recurrence for OEIS A302966, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A302966 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A302966 is ``Number of 3Xn 0..1 arrays with every element equal to 0, 1, 2, 3 or 6 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
4, 32, 154, 786, 3924, 19868, 100161, 505908,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 16 2018 11:56:10, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 15\,a(n-2) - 11\,a(n-3) - 64\,a(n-4) - 10\,a(n-5) + 73\,a(n-6) + 15\,a(n-7) - 7\,a(n-8) + 4\,a(n-9) - 30\,a(n-10) - 9\,a(n-11) + 8\,a(n-12)
\end{equation}
for all $n>13$.
...
publishes, $n=21$, the arrays have $3\cdot21$ cells over
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302966.
