...
\title{The empirical recurrence for OEIS A252834, derived from the entry's generating function}
...
\begin{abstract}
OEIS A252834 carries an empirical recurrence of order $3$. The entry separately records a
...
OEIS A252834 is ``Number of n X 6 nonnegative integer arrays with upper left 0 and every value within 2 of its king move distance from the upper left and every value increasing by 0 or 1 with every step right, diagonally se or down.''. It has offset $1$ and begins
\[
16, 85, 529, 3365, 18528, 78674, 244131, 569420,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 07 2018 06:16:50, revision 7) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 50 x^{12} - 676 x^{11} - 4171 x^{10} - 15495 x^{9} - 54521 x^{8} - 60328 x^{7} - 32656 x^{6} - 9935 x^{5} - 2017 x^{4} - 322 x^{3} - 37 x^{2} - 16 x}{x^{3} - 3 x^{2} + 3 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;50 x^{12} + 676 x^{11} + 4171 x^{10} + 15495 x^{9} + 54521 x^{8} + 60328 x^{7} + 32656 x^{6} + 9935 x^{5} + 2017 x^{4} + 322 x^{3} + 37 x^{2} + 16 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252834.
