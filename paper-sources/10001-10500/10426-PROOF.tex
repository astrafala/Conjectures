...
\title{The empirical recurrence for OEIS A188154, derived from the entry's generating function}
...
\begin{abstract}
OEIS A188154 carries an empirical recurrence of order $3$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 27 2018 08:31:37, revision 10) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{28 x^{10} + 284 x^{9} + 960 x^{8} + 288 x^{7} - 4112 x^{6} - 6720 x^{5} - 2520 x^{4} - 40 x^{3}}{x^{3} - 3 x^{2} + 3 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 28 x^{10} - 284 x^{9} - 960 x^{8} - 288 x^{7} + 4112 x^{6} + 6720 x^{5} + 2520 x^{4} + 40 x^{3},
\]
