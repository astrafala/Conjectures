...
\title{The empirical recurrence for OEIS A267854, derived from the entry's generating function}
...
\begin{abstract}
OEIS A267854 carries an empirical recurrence of order $6$. The entry separately records a
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 10000000 x^{5} + 100000 x^{4} + 11000 x^{3} + 100 x^{2} + 110 x + 1}{100000000 x^{6} - 10000 x^{4} - 10000 x^{2} + 1},
\]
the entry's own generating function, and let
\[
D(x)\;=\;1-\sum_i c_i x^{i}\;=\;100000000 x^{6} - 10000 x^{4} - 10000 x^{2} + 1
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 10000000 x^{5} + 100000 x^{4} + 11000 x^{3} + 100 x^{2} + 110 x + 1,
\]
...
\[
100000000 x^{6} - 10000 x^{4} - 10000 x^{2} + 1,
\]
