...
\title{The empirical recurrence for OEIS A269679, derived from the entry's generating function}
...
\begin{abstract}
OEIS A269679 carries an empirical recurrence of order $5$. The entry separately records a
...
OEIS A269679 is ``Number of length-4 0..n arrays with no repeated value differing from the previous repeated value by other than plus or minus one modulo n+1.''. It has offset $1$ and begins
\[
10, 66, 224, 570, 1212, 2282, 3936, 6354,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 26 2019 11:10:14, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 2 x^{6} + 8 x^{5} - 10 x^{4} + 6 x^{3} - 16 x^{2} - 10 x}{x^{5} - 5 x^{4} + 10 x^{3} - 10 x^{2} + 5 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;2 x^{6} - 8 x^{5} + 10 x^{4} - 6 x^{3} + 16 x^{2} + 10 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269679.
