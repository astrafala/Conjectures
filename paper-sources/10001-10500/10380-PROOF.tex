...
\title{The empirical recurrence for OEIS A299316, proved by transfer matrix}
...
\begin{abstract}
OEIS A299316 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A299316 is ``Number of nX3 0..1 arrays with every element equal to 0, 3, 4, 5, 6 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 1, 15, 10, 70, 146, 434, 1206,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) +5*a(n-2) -5*a(n-3) -10*a(n-4) +4*a(n-5) +a(n-6) +3*a(n-7) -3*a(n-8) +4*a(n-9) -2*a(n-10) for n>12
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 06 2018 13:45:54, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 5\,a(n-2) - 5\,a(n-3) - 10\,a(n-4) + 4\,a(n-5) + a(n-6) + 3\,a(n-7) - 3\,a(n-8) + 4\,a(n-9) - 2\,a(n-10)
\end{equation}
for all $n>12$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A299316.
