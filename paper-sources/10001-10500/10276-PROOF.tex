...
\title{The empirical recurrence for OEIS A250728, proved by transfer matrix}
...
\begin{abstract}
OEIS A250728 counts arrays over $\{0,1\}$ in which a statistic taken over short runs
...
OEIS A250728 is ``Number of (n+1)X(7+1) 0..1 arrays with nondecreasing x(i,j)+x(i,j-1) in the i direction and nondecreasing min(x(i,j),x(i-1,j)) in the j direction.''. It has offset $1$ and begins
\[
1302, 3173, 6257, 11377, 19887, 34069, 57397, 95231,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 8*a(n-1) -27*a(n-2) +48*a(n-3) -42*a(n-4) +42*a(n-6) -48*a(n-7) +27*a(n-8) -8*a(n-9) +a(n-10) for n>17
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 12:44:33, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250728.
