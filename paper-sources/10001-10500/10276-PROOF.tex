...
\title{The empirical recurrence for OEIS A223435, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A223435 counts arrays over $\{0,\dots,15\}$ in which every cell is constrained by the
...
OEIS A223435 is ``Generalized Petersen graph (8,2) coloring a rectangular array: number of nX3 0..15 arrays where 0..15 label nodes of a graph with edges 0,1 0,8 8,14 8,10 1,2 1,9 9,15 9,11 2,3 2,10 10,12 3,4 3,11 11,13 4,5 4,12 12,14 5,6 5,13 13,15 6,7 6,14 7,0 7,15 and every array movement to a horizontal or vertical neighbor moves along an edge of this graph.''. It has offset $1$ and begins
\[
144, 1376, 14112, 147520, 1562176, 16693920, 179532768, 1939216640,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 15*a(n-1) -18*a(n-2) -310*a(n-3) +167*a(n-4) +475*a(n-5) -244*a(n-6) -100*a(n-7) +48*a(n-8)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 21:40:47, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;15\,a(n-1) - 18\,a(n-2) - 310\,a(n-3) + 167\,a(n-4) + 475\,a(n-5) - 244\,a(n-6) - 100\,a(n-7) + 48\,a(n-8)
\end{equation}
for all $n>8$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223435.
