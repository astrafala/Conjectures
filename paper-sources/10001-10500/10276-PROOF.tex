...
\title{The empirical recurrence for OEIS A206115, proved by transfer matrix}
...
\begin{abstract}
OEIS A206115 counts arrays over $\{0,\dots,3\}$ under a condition on the perimeter cycle of
...
a bounded window of consecutive rows, so the count is a walk count on $S=171564$ states and is
...
OEIS A206115 is ``Number of (n+1) X 6 0..3 arrays with every 2 X 3 or 3 X 2 subblock having exactly two counterclockwise and two clockwise edge increases.''. It has offset $1$ and begins
\[
171564, 588840, 2408480, 21702240, 190349280, 1990281312, 18371031840, 163028308320,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 859*a(n-3) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 11 2015 11:53:47, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206115.
