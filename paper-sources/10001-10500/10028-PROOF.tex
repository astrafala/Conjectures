...
\title{The empirical recurrence for OEIS A297339, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297339 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A297339 is ``Number of 2 X n 0..1 arrays with every 1 horizontally or antidiagonally adjacent to 0 or 2 neighboring 1s.''. It has offset $1$ and begins
\[
4, 8, 22, 53, 134, 333, 833, 2078,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) + 3*a(n-2) + 2*a(n-3) - a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 27 2019 11:45:27, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 3\,a(n-2) + 2\,a(n-3) - a(n-5)
\end{equation}
for all $n>6$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297339.
