...
\title{The empirical recurrence for OEIS A206790, proved by transfer matrix}
...
\begin{abstract}
OEIS A206790 counts arrays of width $1$ over $\{0,1,2,3\}$ containing no occurrence of certain short
...
OEIS A206790 is ``Number of nX1 0..3 arrays avoiding the pattern z z+1 z in any row, column, diagonal or antidiagonal.''. It has offset $1$ and begins
\[
4, 16, 61, 232, 883, 3361, 12793, 48694,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) -a(n-2) +a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 22 2025 19:41:35, revision 9) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206790.
