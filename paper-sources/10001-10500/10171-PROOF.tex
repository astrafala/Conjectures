...
\title{The empirical recurrence for OEIS A269608, derived from the entry's generating function}
...
\begin{abstract}
OEIS A269608 carries an empirical recurrence of order $6$. The entry separately records a
...
OEIS A269608 is ``Number of length-5 0..n arrays with no repeated value differing from the previous repeated value by one or less.''. It has offset $1$ and begins
\[
10, 154, 804, 2692, 7030, 15630, 31024, 56584,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 25 2019 08:29:09, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{8 x^{5} - 22 x^{4} + 30 x^{3} + 94 x^{2} + 10 x}{x^{6} - 6 x^{5} + 15 x^{4} - 20 x^{3} + 15 x^{2} - 6 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;8 x^{5} - 22 x^{4} + 30 x^{3} + 94 x^{2} + 10 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269608.
