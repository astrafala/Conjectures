...
\title{The empirical recurrence for OEIS A250967, proved by transfer matrix}
...
\begin{abstract}
OEIS A250967 counts $(n+1)\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A250967 is ``Number of (n+1) X (2+1) 0..1 arrays with no 2 X 2 subblock having the sum of its diagonal elements less than the absolute difference of its antidiagonal elements.''. It has offset $1$ and begins
\[
49, 308, 1945, 12281, 77537, 489543, 3090834, 19514643,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 8*a(n-1) - 13*a(n-2) + 17*a(n-3) - 14*a(n-4) + 3*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 24 2018 08:11:46, revision 10) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250967.
