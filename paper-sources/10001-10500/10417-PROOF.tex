...
\title{The empirical recurrence for OEIS A304467, proved by transfer matrix}
...
\begin{abstract}
OEIS A304467 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A304467 is ``Number of nX3 0..1 arrays with every element unequal to 0, 1, 2, 3 or 6 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
4, 21, 41, 117, 316, 810, 2208, 6012,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) +8*a(n-3) -21*a(n-4) -26*a(n-5) +10*a(n-6) +31*a(n-7) +20*a(n-8) -20*a(n-9) -10*a(n-10) for n>12
\end{quote}
As of the ``Last modified'' line on the live entry (May 13 2018 10:38:01, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 8\,a(n-3) - 21\,a(n-4) - 26\,a(n-5) + 10\,a(n-6) + 31\,a(n-7) + 20\,a(n-8) - 20\,a(n-9) - 10\,a(n-10)
\end{equation}
for all $n>12$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A304467.
