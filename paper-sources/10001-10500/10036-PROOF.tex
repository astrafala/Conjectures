...
\title{The empirical recurrence for OEIS A226866, derived from the entry's generating function}
...
\begin{abstract}
OEIS A226866 carries an empirical recurrence of order $6$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 23:51:34, revision 9) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{6} + 8 x^{5} - 16 x^{4} + 19 x^{3} - 11 x^{2} + 4 x}{x^{6} - 6 x^{5} + 15 x^{4} - 20 x^{3} + 15 x^{2} - 6 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- x^{6} + 8 x^{5} - 16 x^{4} + 19 x^{3} - 11 x^{2} + 4 x,
\]
