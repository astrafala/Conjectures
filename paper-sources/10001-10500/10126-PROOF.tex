...
\title{The empirical recurrence for OEIS A266718, derived from the entry's generating function}
...
\begin{abstract}
OEIS A266718 carries an empirical recurrence of order $6$. The entry separately records a
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 64 x^{6} + 48 x^{5} + 52 x^{4} - 28 x^{3} + 13 x^{2} - 5 x - 1}{32 x^{6} - 50 x^{4} + 19 x^{2} - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;64 x^{6} - 48 x^{5} - 52 x^{4} + 28 x^{3} - 13 x^{2} + 5 x + 1,
\]
