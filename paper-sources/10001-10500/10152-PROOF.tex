...
\title{The empirical recurrence for OEIS A184036, derived from the entry's generating function}
...
\begin{abstract}
OEIS A184036 carries an empirical recurrence of order $4$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 10 2018 05:39:59, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 1276 x^{4} + 653 x^{3} + 638 x^{2} - 325 x}{4 x^{4} - 6 x^{3} + 3 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;1276 x^{4} - 653 x^{3} - 638 x^{2} + 325 x,
\]
