...
\title{The empirical recurrence for OEIS A266849, derived from the entry's generating function}
...
\begin{abstract}
OEIS A266849 carries an empirical recurrence of order $6$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 16 2025 08:33:29, revision 25) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{110000 x^{5} - 10000 x^{4} + 99 x^{3} + 10001 x^{2} - 110 x - 1}{1000000 x^{6} - 1010100 x^{4} + 10101 x^{2} - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 110000 x^{5} + 10000 x^{4} - 99 x^{3} - 10001 x^{2} + 110 x + 1,
\]
