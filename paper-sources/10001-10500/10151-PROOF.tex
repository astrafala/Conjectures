...
\title{The empirical recurrence for OEIS A264072, proved by transfer matrix}
...
\begin{abstract}
OEIS A264072 carries an empirical recurrence of order $5$ contributed by R.~H.~Hardin. It is
...
OEIS A264072 is ``Number of (3+1) X (n+1) arrays of permutations of 0..n*4+3 with each element having index change +-(.,.) 0,0 1,1 or 1,2.''. It has offset $1$ and begins
\[
8, 89, 1210, 12100, 131890, 1445345, 15892745, 174807490,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 12*a(n-1) - 12*a(n-2) + 12*a(n-3) - 12*a(n-4) + a(n-5) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 26 2025 18:45:16, revision 12) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264072.
