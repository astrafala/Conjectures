...
\title{The empirical recurrence for OEIS A316688, proved by transfer matrix}
...
\begin{abstract}
OEIS A316688 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A316688 is ``Number of nX3 0..1 arrays with every element unequal to 0, 1, 2, 6, 7 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
4, 3, 8, 9, 21, 42, 81, 165,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +a(n-2) +2*a(n-3) for n>6
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 10 2018 15:03:14, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A316688.
