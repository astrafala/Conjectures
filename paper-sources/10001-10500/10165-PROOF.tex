...
\title{The empirical recurrence for OEIS A269411, derived from the entry's generating function}
...
\begin{abstract}
OEIS A269411 carries an empirical recurrence of order $6$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 21 2019 10:06:44, revision 7) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 9 x^{4} + 30 x^{3} + 87 x^{2} + 12 x}{x^{6} - 6 x^{5} + 15 x^{4} - 20 x^{3} + 15 x^{2} - 6 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 9 x^{4} + 30 x^{3} + 87 x^{2} + 12 x,
\]
