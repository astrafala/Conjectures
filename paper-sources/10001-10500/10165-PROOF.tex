...
\title{The empirical recurrence for OEIS A228795, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A228795 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A228795 is ``Number of nX7 binary arrays with top left element equal to 1 and no two ones adjacent horizontally or nw-se.''. It has offset $1$ and begins
\[
13, 240, 5223, 111966, 2404290, 51557716, 1104367784, 23641626212,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 34*a(n-1) -324*a(n-2) +1264*a(n-3) -2236*a(n-4) +1816*a(n-5) -624*a(n-6) +64*a(n-7) for n>10
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 04 2025 00:07:40, revision 10) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A228795.
