...
\title{The empirical recurrence for OEIS A266660, derived from the entry's generating function}
...
\begin{abstract}
OEIS A266660 carries an empirical recurrence of order $4$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 08 2025 12:21:40, revision 37) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{100000 x^{5} - 100000 x^{4} + 10990 x^{3} - 9990 x^{2} + 110 x + 1}{10000 x^{4} - 10001 x^{2} + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;100000 x^{5} - 100000 x^{4} + 10990 x^{3} - 9990 x^{2} + 110 x + 1,
\]
