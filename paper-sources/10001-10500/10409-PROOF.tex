...
\title{The empirical recurrence for OEIS A187609, derived from the entry's generating function}
...
\begin{abstract}
OEIS A187609 carries an empirical recurrence of order $3$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 25 2018 11:49:02, revision 11) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{97 x^{10} - 159 x^{9} + 80 x^{8} - 156 x^{7} - 134 x^{6} - 106 x^{5} - 8 x^{4}}{x^{3} - 3 x^{2} + 3 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 97 x^{10} + 159 x^{9} - 80 x^{8} + 156 x^{7} + 134 x^{6} + 106 x^{5} + 8 x^{4},
\]
