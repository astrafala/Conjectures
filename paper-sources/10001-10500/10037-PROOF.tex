...
\title{The empirical recurrence for OEIS A305342, proved by transfer matrix}
...
\begin{abstract}
OEIS A305342 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A305342 is ``Number of nX3 0..1 arrays with every element unequal to 0, 1, 3, 5 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
3, 9, 14, 28, 63, 126, 245, 505,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +3*a(n-3) +2*a(n-4) +a(n-5) +a(n-6) -a(n-7) -a(n-8) -a(n-9) -a(n-11) -a(n-12)
\end{quote}
As of the ``Last modified'' line on the live entry (May 30 2018 17:04:09, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 3\,a(n-3) + 2\,a(n-4) + a(n-5) + a(n-6) - a(n-7) - a(n-8) - a(n-9) - a(n-11) - a(n-12)
\end{equation}
for all $n>12$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A305342.
