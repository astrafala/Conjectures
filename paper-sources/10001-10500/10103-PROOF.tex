...
\title{The empirical recurrence for OEIS A250354, derived from the entry's generating function}
...
\begin{abstract}
OEIS A250354 carries an empirical recurrence of order $6$. The entry separately records a
...
OEIS A250354 is ``Number of length 5 arrays x(i), i=1..5 with x(i) in i..i+n and no value appearing more than 2 times.''. It has offset $1$ and begins
\[
32, 216, 888, 2724, 6900, 15186, 30072, 54888,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 13 2018 08:37:46, revision 7) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 6 x^{8} + 32 x^{7} - 66 x^{6} + 36 x^{5} - 4 x^{4} + 72 x^{3} + 24 x^{2} + 32 x}{x^{6} - 6 x^{5} + 15 x^{4} - 20 x^{3} + 15 x^{2} - 6 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 6 x^{8} + 32 x^{7} - 66 x^{6} + 36 x^{5} - 4 x^{4} + 72 x^{3} + 24 x^{2} + 32 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250354.
