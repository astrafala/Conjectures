...
\title{The empirical recurrence for OEIS A283951, proved by transfer matrix}
...
\begin{abstract}
OEIS A283951 counts $2\times n$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
walk, and $a(n)$ is a walk count on $S=36$ vertices, which is $C$-finite. Whether the
...
OEIS A283951 is ``Number of 2Xn 0..1 arrays with no 1 equal to more than three of its horizontal, diagonal and antidiagonal neighbors, with the exception of exactly one element.''. It has offset $1$ and begins
\[
0, 0, 2, 16, 84, 408, 1926, 8776,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 6*a(n-1) -7*a(n-2) +8*a(n-3) -31*a(n-4) -50*a(n-5) -61*a(n-6) -84*a(n-7) -36*a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 21 2017 23:19:50, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) - 7\,a(n-2) + 8\,a(n-3) - 31\,a(n-4) - 50\,a(n-5) - 61\,a(n-6) - 84\,a(n-7) - 36\,a(n-8)
\]
for every $n>8$.
\end{theorem}
...
integers vanish from the index corresponding to $n=8+1$ onwards, and the run was
continued until the working vector was identically zero, which settles all larger $j$ at once.
By Lemma~\ref{lem:crit} the recurrence holds for every $n>8$.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A283951.
