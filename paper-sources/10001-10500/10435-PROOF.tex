...
\title{The empirical recurrence for OEIS A184064, derived from the entry's generating function}
...
\begin{abstract}
OEIS A184064 carries an empirical recurrence of order $4$. The entry separately records a
...
OEIS A184064 is ``Number of (n+1) X 3 binary arrays with rows and columns in nondecreasing order and with no 2 X 2 subblock sum differing from a horizontal or vertical neighbor subblock sum by more than one.''. It has offset $1$ and begins
\[
11, 16, 36, 73, 134, 225, 354, 529,\ \dots
\]
...
\begin{quote}
G.f.: x*(11 - 28*x + 38*x\^{}2 - 19*x\^{}3 + 5*x\^{}4 - x\^{}5 + 2*x\^{}6) / (1 - x)\^{}4.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 11 2018 08:46:22, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{2 x^{7} - x^{6} + 5 x^{5} - 19 x^{4} + 38 x^{3} - 28 x^{2} + 11 x}{x^{4} - 4 x^{3} + 6 x^{2} - 4 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;2 x^{7} - x^{6} + 5 x^{5} - 19 x^{4} + 38 x^{3} - 28 x^{2} + 11 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A184064.
