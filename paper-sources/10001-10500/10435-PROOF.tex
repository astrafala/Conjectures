...
\title{The empirical recurrence for OEIS A251646, proved by transfer matrix}
...
\begin{abstract}
OEIS A251646 counts arrays of width $4$ over $\{0,1,2,3\}$ in which every $3\times3$ window has
...
OEIS A251646 is ``Number of (n+2)X(2+2) 0..3 arrays with no row, column, diagonal or antidiagonal in any 3X3 subblock summing to 0 2 4 5 7 or 9.''. It has offset $1$ and begins
\[
448, 908, 1928, 4008, 10248, 22904, 49956, 129296,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) -2*a(n-2) +4*a(n-3) -36*a(n-4) +22*a(n-5) +59*a(n-6) -40*a(n-7) -20*a(n-8) +10*a(n-9) for n>15
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 10:28:21, revision 6) this is still
...
\text{each row} & \text{must NOT be 0 or 2 or 4 or 5 or 7 or 9} \\
\text{each column} & \text{must NOT be 0 or 2 or 4 or 5 or 7 or 9} \\
\text{the main diagonal} & \text{must NOT be 0 or 2 or 4 or 5 or 7 or 9} \\
\text{the antidiagonal} & \text{must NOT be 0 or 2 or 4 or 5 or 7 or 9} \\
\end{array}
\]
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) - 2\,a(n-2) + 4\,a(n-3) - 36\,a(n-4) + 22\,a(n-5) + 59\,a(n-6) - 40\,a(n-7) - 20\,a(n-8) + 10\,a(n-9)
\]
for every $n>15$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251646.
