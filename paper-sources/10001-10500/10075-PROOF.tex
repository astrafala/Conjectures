...
\title{The empirical recurrence for OEIS A266787, derived from the entry's generating function}
...
\begin{abstract}
OEIS A266787 carries an empirical recurrence of order $6$. The entry separately records a
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 100000000 x^{10} + 1100000000 x^{9} - 9990000 x^{8} - 1090110000 x^{7} + 109001000 x^{6} - 7891000 x^{5} + 979100 x^{4} - 889100 x^{3} + 9901 x^{2} - 11 x - 1}{10000000 x^{6} - 10011000 x^{4} + 11001 x^{2} - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;100000000 x^{10} - 1100000000 x^{9} + 9990000 x^{8} + 1090110000 x^{7} - 109001000 x^{6} + 7891000 x^{5} - 979100 x^{4} + 889100 x^{3} - 9901 x^{2} + 11 x + 1,
\]
