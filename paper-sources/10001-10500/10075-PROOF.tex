...
\title{The empirical recurrence for OEIS A232059, proved by transfer matrix}
...
\begin{abstract}
OEIS A232059 counts arrays of width $2$ over $\{0,1,2\}$ in which every cell carrying one stated
...
OEIS A232059 is ``Number of n X 2 0..2 arrays with every 0 next to a 1 and every 1 next to a 2 horizontally or vertically, with no adjacent values equal.''. It has offset $1$ and begins
\[
2, 6, 14, 30, 66, 146, 322, 710,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2018 05:44:53, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232059.
