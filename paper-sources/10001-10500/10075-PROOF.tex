...
\title{The empirical recurrence for OEIS A221465, derived from the entry's generating function}
...
\begin{abstract}
OEIS A221465 carries an empirical recurrence of order $6$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 05 2018 13:46:25, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{5} - 2 x^{4} + 60 x^{3} + 58 x^{2} + 5 x}{x^{6} - 6 x^{5} + 15 x^{4} - 20 x^{3} + 15 x^{2} - 6 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- x^{5} - 2 x^{4} + 60 x^{3} + 58 x^{2} + 5 x,
\]
