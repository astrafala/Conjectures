...
\title{The empirical recurrence for OEIS A202530, proved by transfer matrix}
...
\begin{abstract}
OEIS A202530 counts arrays of width $8$ over $\{0,1\}$ containing no occurrence of certain short
...
OEIS A202530 is ``Number of (n+2) X 8 binary arrays avoiding patterns 000 and 101 in rows, columns and nw-to-se diagonals.''. It has offset $1$ and begins
\[
4184, 10584, 22118, 45899, 100550, 216973, 462445, 994256,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) +2*a(n-3) -2*a(n-4) -2*a(n-5) +a(n-7) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 01 2018 09:36:47, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A202530.
