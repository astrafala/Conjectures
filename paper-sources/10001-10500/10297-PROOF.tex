...
\title{The empirical recurrence for OEIS A190030, proved by transfer matrix}
...
\begin{abstract}
OEIS A190030 counts the $(n+2)\times8$ arrays over $\{0,\dots,1\}$ in which
...
a state, the count is a walk count on $S=880$ of them, and the conjectured recurrence is then
...
OEIS A190030 is ``Number of (n+2) X 8 binary arrays with every 3 X 3 subblock commuting with each horizontal and vertical neighbor 3 X 3 subblock.''. It has offset $1$ and begins
\[
880, 295, 430, 670, 970, 1230, 1494, 1834,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) -a(n-2) +a(n-3) -2*a(n-4) +a(n-5) +a(n-6) -a(n-7) for n>14.
\end{quote}
As of the ``Last modified'' line on the live entry (May 03 2018 09:59:18, revision 8) this is still
...
$880$, which the model reproduces along with every later term.
...
\]
on the $S=880$ admissible $3$-tuples. In particular $a$ is $C$-finite.
...
size of the construction is therefore $2^{3\cdot8}$ before the condition prunes
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A190030.
