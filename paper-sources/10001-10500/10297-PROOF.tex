...
\title{The empirical recurrence for OEIS A206067, proved by transfer matrix}
...
\begin{abstract}
OEIS A206067 counts arrays over $\{0,\dots,2\}$ under a condition on the perimeter cycle of
...
a bounded window of consecutive rows, so the count is a walk count on $S=537$ states and is
...
OEIS A206067 is ``Number of (n+1) X 4 0..2 arrays with every 2 X 3 or 3 X 2 subblock having exactly three clockwise edge increases.''. It has offset $1$ and begins
\[
537, 3330, 27654, 233058, 1967814, 16608978, 140136942, 1182218562,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 14*a(n-1) -56*a(n-2) +82*a(n-3) -47*a(n-4) for n>9.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 19 2022 12:51:48, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;14\,a(n-1) - 56\,a(n-2) + 82\,a(n-3) - 47\,a(n-4)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206067.
