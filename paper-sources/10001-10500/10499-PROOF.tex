...
\title{The empirical recurrence for OEIS A230683, proved by transfer matrix}
...
\begin{abstract}
OEIS A230683 carries an empirical recurrence of order $9$ contributed by R. H. Hardin. It is
true, and it is decidable rather than empirical. The entry's condition is local to a bounded window of consecutive lines, so
the admissible configurations of such a window are the vertices of a finite digraph and the
arrays counted are exactly the walks in it; hence $a(n)$ is a walk count on $S=9317$ vertices
...
OEIS A230683 is ``Number of n X 4 0..6 arrays x(i,j) with each element horizontally or antidiagonally next to at least one element with value (x(i,j)+1) mod 7, and upper left element zero.''. It has offset $1$ and begins
\[
0, 0, 0, 2, 32, 432, 5182, 58298,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 17*a(n-1) - 64*a(n-2) - 66*a(n-3) + 20*a(n-4) + 14*a(n-5) + 671*a(n-6) + 1404*a(n-7) - 76*a(n-8) +a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 22 2018 10:54:02, revision 9) this is still
...
An admissible array is then exactly a walk, and $\iota,\tau$ are the vectors recording which windows may begin and end an array, so with $M$ the adjacency matrix on $S=9317$ vertices,
\[
a(n)\;=\;\iota^{\!\top}M^{\,n}\tau ,
\]
...
\begin{theorem}
\[
a(n)\;=\;17\,a(n-1) - 64\,a(n-2) - 66\,a(n-3) + 20\,a(n-4) + 14\,a(n-5) + 671\,a(n-6) + 1404\,a(n-7) - 76\,a(n-8) + a(n-9)
\]
for every $n>10$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A230683.
