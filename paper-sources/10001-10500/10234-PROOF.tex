...
\title{The empirical recurrence for OEIS A199900, derived from the entry's generating function}
...
\begin{abstract}
OEIS A199900 carries an empirical recurrence of order $5$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 16 2018 16:33:12, revision 9) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{5} + 2 x^{4} + 4 x^{3} + 6 x^{2} - 33 x}{x^{5} - 5 x^{4} + 10 x^{3} - 10 x^{2} + 5 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;x^{5} - 2 x^{4} - 4 x^{3} - 6 x^{2} + 33 x,
\]
