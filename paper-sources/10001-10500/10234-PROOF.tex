...
\title{The empirical recurrence for OEIS A190040, derived from the entry's generating function}
...
\begin{abstract}
OEIS A190040 carries an empirical recurrence of order $4$. The entry separately records a
...
OEIS A190040 is ``Number of nondecreasing arrangements of n+2 numbers in 0..8 with the last equal to 8 and each after the second equal to the sum of one or two of the preceding three.''. It has offset $1$ and begins
\[
13, 24, 40, 65, 105, 164, 246, 349,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 04 2018 08:10:29, revision 9) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{3 x^{10} + x^{9} - 6 x^{8} - 2 x^{6} + 2 x^{5} - 3 x^{4} + 22 x^{3} - 28 x^{2} + 13 x}{x^{4} - 4 x^{3} + 6 x^{2} - 4 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;3 x^{10} + x^{9} - 6 x^{8} - 2 x^{6} + 2 x^{5} - 3 x^{4} + 22 x^{3} - 28 x^{2} + 13 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A190040.
