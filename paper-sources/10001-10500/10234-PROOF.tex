...
\title{A condition on the multiset of every subblock: OEIS A184190}
...
\begin{abstract}
OEIS A184190 carries an empirical recurrence of order $5$ contributed by R.~H.~Hardin. It is
...
OEIS A184190 is ``Half the number of (n+1) X 3 binary arrays with no 2 X 2 subblock containing exactly one 1.''. It has offset $1$ and begins
\[
19, 104, 561, 3050, 16581, 90185, 490546, 2668339,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 7*a(n-1) - 7*a(n-2) - 10*a(n-3) + 10*a(n-4) + 2*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 27 2025 23:44:13, revision 11) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{The count is a walk count}

The entry counts arrays with $3$ columns over the alphabet $\{0,1\}$, growing one row at a time, and asks that no $2\times2$ subblock holds exactly $1$ entries equal to $1$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A184190.
