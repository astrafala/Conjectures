...
\title{The empirical recurrence for OEIS A268255, proved by transfer matrix}
...
\begin{abstract}
OEIS A268255 carries an empirical recurrence of order $4$ contributed by R.~H.~Hardin. It is
...
OEIS A268255 is ``Number of length-(n+1) 0..2 arrays with new repeated values introduced in sequential order starting with zero.''. It has offset $1$ and begins
\[
7, 17, 42, 106, 273, 717, 1918, 5218,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 7*a(n-1) - 15*a(n-2) + 7*a(n-3) + 6*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 11 2019 15:14:17, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-1) - 15\,a(n-2) + 7\,a(n-3) + 6\,a(n-4)
\]
for every $n>0$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268255.
