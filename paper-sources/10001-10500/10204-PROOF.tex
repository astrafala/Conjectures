...
\title{The empirical recurrence for OEIS A202310, proved by transfer matrix}
...
\begin{abstract}
OEIS A202310 counts arrays of width $3$ over $\{0,1\}$ containing no occurrence of certain short
...
OEIS A202310 is ``Number of (n+2) X 3 binary arrays avoiding patterns 001 and 100 in rows and columns.''. It has offset $1$ and begins
\[
108, 333, 1144, 4048, 14743, 54250, 201098, 747683,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 6*a(n-1) -5*a(n-2) -22*a(n-3) +32*a(n-4) +16*a(n-5) -35*a(n-6) +2*a(n-7) +9*a(n-8) -2*a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 14 2018 11:10:17, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) - 5\,a(n-2) - 22\,a(n-3) + 32\,a(n-4) + 16\,a(n-5) - 35\,a(n-6) + 2\,a(n-7) + 9\,a(n-8) - 2\,a(n-9)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A202310.
