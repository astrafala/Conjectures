...
\title{The empirical recurrence for OEIS A260063, proved by transfer matrix}
...
\begin{abstract}
OEIS A260063 counts $(n+2)\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A260063 is ``Number of (n+2) X (1+2) 0..1 arrays with each 3 X 3 subblock having clockwise perimeter pattern 00000001 00000011 or 00000111.''. It has offset $1$ and begins
\[
48, 91, 256, 557, 956, 2131, 5088, 10235,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + 4*a(n-3) + 5*a(n-4) - 5*a(n-5) - 2*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 28 2018 09:06:11, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A260063.
