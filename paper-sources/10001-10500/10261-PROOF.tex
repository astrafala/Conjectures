...
\title{The empirical recurrence for OEIS A223687, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A223687 counts arrays over $\{0,\dots,15\}$ in which every cell is constrained by the
...
\[
144, 2304, 37008, 595584, 9594000, 154616832, 2492365968, 40180445568,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 24*a(n-1) - 127*a(n-2).
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 22 2018 09:52:15, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;24\,a(n-1) - 127\,a(n-2)
\end{equation}
for all $n>2$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223687.
