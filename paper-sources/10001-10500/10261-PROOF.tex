...
\title{The empirical recurrence for OEIS A252132, proved by transfer matrix}
...
\begin{abstract}
OEIS A252132 counts $(n+2)\times3$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252132 is ``Number of (n+2) X (1+2) 0..3 arrays with every 3 X 3 subblock row, column, diagonal and antidiagonal sum not equal to 0 3 4 6 or 7.''. It has offset $1$ and begins
\[
172, 134, 209, 439, 909, 1864, 3905, 8406,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + a(n-2) + a(n-4) - 5*a(n-5) - 7*a(n-6) - 3*a(n-7) + 4*a(n-8) + 6*a(n-9) + 2*a(n-10) for n>12.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 01 2018 12:02:03, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + a(n-2) + a(n-4) - 5\,a(n-5) - 7\,a(n-6) - 3\,a(n-7) + 4\,a(n-8) + 6\,a(n-9) + 2\,a(n-10)
\]
for every $n>12$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252132.
