...
\title{The empirical recurrence for OEIS A267473, derived from the entry's generating function}
...
\begin{abstract}
OEIS A267473 carries an empirical recurrence of order $6$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 05 2018 09:36:22, revision 7) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{6} + 6 x^{5} - 7 x^{4} + 67 x^{3} + 34 x^{2} + 21 x}{x^{6} - 6 x^{5} + 15 x^{4} - 20 x^{3} + 15 x^{2} - 6 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- x^{6} + 6 x^{5} - 7 x^{4} + 67 x^{3} + 34 x^{2} + 21 x,
\]
