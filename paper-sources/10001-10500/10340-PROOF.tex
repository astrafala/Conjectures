...
\title{The empirical recurrence for OEIS A283692, proved by transfer matrix}
...
\begin{abstract}
OEIS A283692 counts $2\times n$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A283692 is ``Number of 2 X n 0..1 arrays with no 1 equal to more than two of its horizontal, diagonal and antidiagonal neighbors.''. It has offset $1$ and begins
\[
4, 16, 49, 161, 548, 1824, 6081, 20353,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) + a(n-2) + 3*a(n-3) - 6*a(n-4) - 8*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 21 2019 11:36:29, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A283692.
