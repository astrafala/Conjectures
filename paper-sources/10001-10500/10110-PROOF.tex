...
\title{The empirical recurrence for OEIS A301438, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A301438 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A301438 is ``Number of nX3 0..1 arrays with every element equal to 0, 1, 2, 3, 4 or 6 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
4, 32, 232, 1708, 12576, 92616, 682084, 5023328,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 8*a(n-1) -4*a(n-2) -5*a(n-3)
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 21 2018 11:44:09, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;8\,a(n-1) - 4\,a(n-2) - 5\,a(n-3)
\end{equation}
for all $n>4$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A301438.
