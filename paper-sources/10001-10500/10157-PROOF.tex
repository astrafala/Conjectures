...
\title{The empirical recurrence for OEIS A267351, derived from the entry's generating function}
...
\begin{abstract}
OEIS A267351 carries an empirical recurrence of order $6$. The entry separately records a
...
OEIS A267351 is ``Decimal representation of the n-th iteration of the "Rule 123" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 5, 14, 119, 56, 2015, 224, 32639,\ \dots
\]
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 160 x^{6} + 64 x^{5} + 154 x^{4} - 14 x^{3} + 7 x^{2} - 5 x - 1}{64 x^{6} - 84 x^{4} + 21 x^{2} - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;160 x^{6} - 64 x^{5} - 154 x^{4} + 14 x^{3} - 7 x^{2} + 5 x + 1,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267351.
