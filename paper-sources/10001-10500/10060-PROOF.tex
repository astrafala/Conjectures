...
\title{The empirical recurrence for OEIS A268256, proved by transfer matrix}
...
\begin{abstract}
OEIS A268256 carries an empirical recurrence of order $6$ contributed by R.~H.~Hardin. It is
...
OEIS A268256 is ``Number of length-(n+1) 0..3 arrays with new repeated values introduced in sequential order starting with zero.''. It has offset $1$ and begins
\[
13, 43, 143, 479, 1616, 5492, 18804, 64869,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 13*a(n-1) - 60*a(n-2) + 105*a(n-3) - 11*a(n-4) - 94*a(n-5) - 24*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 11 2019 14:51:33, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268256.
