...
\title{A condition on each element and its neighbours: OEIS A241345}
...
\begin{abstract}
OEIS A241345 carries an empirical recurrence of order $10$ contributed by R.~H.~Hardin. It is
...
OEIS A241345 is ``Number of n X 2 0..3 arrays with no element equal to the same number of vertical neighbors as horizontal neighbors, with new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
1, 2, 5, 22, 103, 519, 2656, 13798,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 30 2018 05:20:26, revision 13) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{The count is a walk count}

The entry counts arrays with $2$ columns over the alphabet $\{0,1,2,3\}$, growing one row at a time. Its condition is that every element must equal a different number of its vertical neighbours than it does of its horizontal neighbours.
...
Vertices with identical futures are merged, which leaves $S=11$. An admissible array is exactly a walk, so with $M$ the adjacency matrix and $\iota,\tau$ the vectors recording which states may begin and end an array,
\[
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-1) - 8\,a(n-2) - 48\,a(n-3) + 59\,a(n-4) + 102\,a(n-5) - 77\,a(n-6) - 112\,a(n-7) + 38\,a(n-8) + 66\,a(n-9) - 27\,a(n-10)
\]
for every $n>11$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A241345.
