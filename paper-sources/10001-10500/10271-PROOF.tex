...
\title{The empirical recurrence for OEIS A296329, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A296329 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A296329 is ``Number of n X 2 0..1 arrays with each 1 horizontally, vertically or antidiagonally adjacent to 0 or 2 neighboring 1s.''. It has offset $1$ and begins
\[
3, 8, 19, 47, 116, 286, 705, 1738,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) + 2*a(n-2) + 3*a(n-3) + 2*a(n-4) + a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 22 2018 09:47:35, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 2\,a(n-2) + 3\,a(n-3) + 2\,a(n-4) + a(n-5)
\end{equation}
for all $n>6$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A296329.
