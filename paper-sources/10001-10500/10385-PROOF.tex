...
\title{The empirical recurrence for OEIS A187290, derived from the entry's generating function}
...
\begin{abstract}
OEIS A187290 carries an empirical recurrence of order $3$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 23 2018 02:58:50, revision 15) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{28 x^{10} + 60 x^{9} + 256 x^{8} + 96 x^{7} - 312 x^{6} - 2072 x^{5} - 2416 x^{4} - 720 x^{3}}{x^{3} - 3 x^{2} + 3 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 28 x^{10} - 60 x^{9} - 256 x^{8} - 96 x^{7} + 312 x^{6} + 2072 x^{5} + 2416 x^{4} + 720 x^{3},
\]
