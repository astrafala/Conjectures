...
\title{The empirical recurrence for OEIS A208486, proved by transfer matrix}
...
\begin{abstract}
OEIS A208486 counts arrays of width $3$ over $\{0,1,2,3\}$ subject to a condition read round the
...
OEIS A208486 is ``Number of (n+1) X 3 0..3 arrays with the number of clockwise edge increases in every 2 X 2 subblock equal to the number of counterclockwise edge increases.''. It has offset $1$ and begins
\[
1448, 33416, 773288, 17903016, 414522184, 9597910280, 222232271912, 5145622169576,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 32*a(n-1) - 227*a(n-2) + 528*a(n-3) - 328*a(n-4) - 104*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:54:16, revision 12) this is still
...
\begin{theorem}
\[
a(n)\;=\;32\,a(n-1) - 227\,a(n-2) + 528\,a(n-3) - 328\,a(n-4) - 104\,a(n-5)
\]
for every $n>4$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208486.
