...
\title{The empirical recurrence for OEIS A268258, proved by transfer matrix}
...
\begin{abstract}
OEIS A268258 carries an empirical recurrence of order $10$ contributed by R.~H.~Hardin. It is
...
OEIS A268258 is ``Number of length-(n+1) 0..5 arrays with new repeated values introduced in sequential order starting with zero.''. It has offset $1$ and begins
\[
31, 161, 837, 4357, 22710, 118530, 619490, 3242265,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 29 2016 12:45:42, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;31\,a(n-1) - 390\,a(n-2) + 2490\,a(n-3) - 7960\,a(n-4) + 8610\,a(n-5) + 11775\,a(n-6) - 18175\,a(n-7) - 22024\,a(n-8) - 7236\,a(n-9) - 720\,a(n-10)
\]
for every $n>0$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268258.
