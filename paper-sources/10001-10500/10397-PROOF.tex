...
\title{The empirical recurrence for OEIS A187383, derived from the entry's generating function}
...
\begin{abstract}
OEIS A187383 carries an empirical recurrence of order $3$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 24 2018 08:07:34, revision 10) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{865 x^{10} - 687 x^{9} + 364 x^{8} - 2772 x^{7} - 2160 x^{6} - 2040 x^{5} - 340 x^{4}}{x^{3} - 3 x^{2} + 3 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 865 x^{10} + 687 x^{9} - 364 x^{8} + 2772 x^{7} + 2160 x^{6} + 2040 x^{5} + 340 x^{4},
\]
