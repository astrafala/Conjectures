...
\title{The empirical recurrence for OEIS A128957, derived from the entry's generating function}
...
\begin{abstract}
OEIS A128957 carries an empirical recurrence of order $6$. The entry separately records a
...
OEIS A128957 is ``a(n) is equal to the number of positive integers m less than or equal to 10\^{}n such that m is not divisible by at least one of the primes 2,5 and is not divisible by at least one of the primes 3,7.''. It has offset $2$ and begins
\[
86, 857, 8571, 85715, 857142, 8571429, 85714286, 857142857,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 08 2022 08:45:30, revision 17) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 90 x^{7} - 81 x^{6} - 89 x^{5} - 84 x^{4} - 83 x^{3} - 86 x^{2}}{10 x^{6} + 9 x^{5} + 9 x^{4} + 9 x^{3} + 9 x^{2} + 9 x - 1},
\]
the entry's own generating function, and let
\[
D(x)\;=\;1-\sum_i c_i x^{i}\;=\;- 10 x^{6} - 9 x^{5} - 9 x^{4} - 9 x^{3} - 9 x^{2} - 9 x + 1
\]
...
\begin{theorem}
\[
a(n)\;=\;9\,a(n-1) + 9\,a(n-2) + 9\,a(n-3) + 9\,a(n-4) + 9\,a(n-5) + 10\,a(n-6)
\]
for every $n>7$.
\end{theorem}
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;90 x^{7} + 81 x^{6} + 89 x^{5} + 84 x^{4} + 83 x^{3} + 86 x^{2},
\]
...
\[
10 x^{6} + 9 x^{5} + 9 x^{4} + 9 x^{3} + 9 x^{2} + 9 x - 1,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A128957.
