...
\title{The empirical recurrence for OEIS A237368, proved by transfer matrix}
...
\begin{abstract}
OEIS A237368 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
OEIS A237368 is ``Number of (n+1)X(1+1) 0..2 arrays with the maximum plus the upper median plus the lower median plus the minimum of every 2X2 subblock differing from its horizontal and vertical neighbors by exactly one.''. It has offset $1$ and begins
\[
81, 288, 1024, 3840, 14400, 53760, 200704, 752640,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 196*a(n-4) for n>6
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 10:06:49, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237368.
