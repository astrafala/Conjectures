...
\title{The empirical recurrence for OEIS A241965, derived from the entry's generating function}
...
\begin{abstract}
OEIS A241965 carries an empirical recurrence of order $6$. The entry separately records a
...
OEIS A241965 is ``Number of length 2+3 0..n arrays with no consecutive four elements summing to more than 2*n.''. It has offset $1$ and begins
\[
19, 124, 486, 1421, 3437, 7280, 13980, 24897,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 31 2018 05:49:35, revision 7) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{6} + 6 x^{5} - 15 x^{4} + 27 x^{3} + 10 x^{2} + 19 x}{x^{6} - 6 x^{5} + 15 x^{4} - 20 x^{3} + 15 x^{2} - 6 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- x^{6} + 6 x^{5} - 15 x^{4} + 27 x^{3} + 10 x^{2} + 19 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A241965.
