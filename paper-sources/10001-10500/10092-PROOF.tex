...
\title{The empirical recurrence for OEIS A251213, proved by transfer matrix}
...
\begin{abstract}
OEIS A251213 counts $(n+1)\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A251213 is ``Number of (n+1)X(2+1) 0..1 arrays with no 2X2 subblock having zero or two 1s.''. It has offset $1$ and begins
\[
21, 63, 191, 589, 1807, 5569, 17119, 52713,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) +4*a(n-2) -12*a(n-3) +4*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:10:46, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 4\,a(n-2) - 12\,a(n-3) + 4\,a(n-5)
\end{equation}
for all $n>4$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251213.
