...
\title{The empirical recurrence for OEIS A188789, derived from the entry's generating function}
...
\begin{abstract}
OEIS A188789 carries an empirical recurrence of order $5$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 30 2018 11:19:10, revision 9) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{512 x^{9} + 2192 x^{8} - 11152 x^{7} + 3648 x^{6} + 26496 x^{5} - 309888 x^{4} - 153600 x^{3} - 4224 x^{2}}{x^{5} - 5 x^{4} + 10 x^{3} - 10 x^{2} + 5 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 512 x^{9} - 2192 x^{8} + 11152 x^{7} - 3648 x^{6} - 26496 x^{5} + 309888 x^{4} + 153600 x^{3} + 4224 x^{2},
\]
