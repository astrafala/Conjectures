...
\title{The empirical recurrence for OEIS A266838, derived from the entry's generating function}
...
\begin{abstract}
OEIS A266838 carries an empirical recurrence of order $6$. The entry separately records a
...
\begin{quote}
a(n) = 11001*a(n-2) - 10011000*a(n-4) + 10000000*a(n-6) for n > 9.
\end{quote}
and, separately and NOT as a conjecture:
\begin{quote}
G.f.: (1 + 100*x - 9991*x\^{}2 - 99*x\^{}3 - 88910*x\^{}4 - 9990*x\^{}5 - 10901100*x\^{}6 - 99900*x\^{}7 + 11000000*x\^{}8 - 1000000*x\^{}9) / ((1-x)*(1+x)*(1-100*x)*(1+100*x)*(1-1000*x\^{}2)).
\end{quote}
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{1000000 x^{9} - 11000000 x^{8} + 99900 x^{7} + 10901100 x^{6} + 9990 x^{5} + 88910 x^{4} + 99 x^{3} + 9991 x^{2} - 100 x - 1}{10000000 x^{6} - 10011000 x^{4} + 11001 x^{2} - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 1000000 x^{9} + 11000000 x^{8} - 99900 x^{7} - 10901100 x^{6} - 9990 x^{5} - 88910 x^{4} - 99 x^{3} - 9991 x^{2} + 100 x + 1,
\]
