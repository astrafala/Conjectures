...
\title{The empirical recurrence for OEIS A221525, derived from the entry's generating function}
...
\begin{abstract}
OEIS A221525 carries an empirical recurrence of order $6$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 06 2018 07:25:17, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 2 x^{8} + 4 x^{7} - 22 x^{6} + 14 x^{5} + 62 x^{4} + 58 x^{3} + 6 x^{2}}{x^{6} - 6 x^{5} + 15 x^{4} - 20 x^{3} + 15 x^{2} - 6 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 2 x^{8} + 4 x^{7} - 22 x^{6} + 14 x^{5} + 62 x^{4} + 58 x^{3} + 6 x^{2},
\]
