...
\title{The empirical recurrence for OEIS A183682, proved by transfer matrix}
...
\begin{abstract}
OEIS A183682 counts arrays over $\{0,\dots,1\}$ under a condition on the determinant of every
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 27 2018 07:11:10, revision 9) this is still
...
first term is $12$, and the model reproduces it along with every later term; that is the
