...
\title{The empirical recurrence for OEIS A268263, derived from the entry's generating function}
...
\begin{abstract}
OEIS A268263 carries an empirical recurrence of order $6$. The entry separately records a
...
OEIS A268263 is ``Number of length-(4+1) 0..n arrays with new repeated values introduced in sequential order starting with zero.''. It has offset $1$ and begins
\[
17, 106, 479, 1610, 4357, 10082, 20771, 39154,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 13 2019 08:49:08, revision 7) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 2 x^{6} + 17 x^{5} - 14 x^{4} + 98 x^{3} + 4 x^{2} + 17 x}{x^{6} - 6 x^{5} + 15 x^{4} - 20 x^{3} + 15 x^{2} - 6 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 2 x^{6} + 17 x^{5} - 14 x^{4} + 98 x^{3} + 4 x^{2} + 17 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268263.
