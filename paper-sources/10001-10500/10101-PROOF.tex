...
\title{The empirical recurrence for OEIS A208874, proved by transfer matrix}
...
\begin{abstract}
OEIS A208874 counts $3\times n$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A208874 is ``Number of 3Xn 0..3 arrays with new values 0..3 introduced in row major order and no element equal to more than one of its immediate leftward or upward or right-upward antidiagonal neighbors.''. It has offset $1$ and begins
\[
5, 143, 6520, 307165, 14493405, 683903931, 32271626438, 1522813452263,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 61*a(n-1) -722*a(n-2) +3476*a(n-3) -7851*a(n-4) +8583*a(n-5) -4266*a(n-6) +720*a(n-7) for n>8
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 15:04:02, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;61\,a(n-1) - 722\,a(n-2) + 3476\,a(n-3) - 7851\,a(n-4) + 8583\,a(n-5) - 4266\,a(n-6) + 720\,a(n-7)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208874.
