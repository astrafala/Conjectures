...
\title{The empirical recurrence for OEIS A202640, proved by transfer matrix}
...
\begin{abstract}
OEIS A202640 counts arrays of width $3$ over $\{0,1\}$ containing no occurrence of certain short
...
OEIS A202640 is ``Number of (n+2) X 3 binary arrays avoiding patterns 000 and 111 in rows, columns and nw-to-se diagonals.''. It has offset $1$ and begins
\[
66, 172, 462, 1278, 3448, 9394, 25526, 69336,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) +3*a(n-2) -a(n-3) -5*a(n-4) -2*a(n-5) +5*a(n-6) +a(n-7) -2*a(n-8) for n>9.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 01 2018 11:24:17, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A202640.
