...
\title{A condition on each element and its neighbours: OEIS A297370}
...
\begin{abstract}
OEIS A297370 carries an empirical recurrence of order $6$ contributed by R.~H.~Hardin. It is
...
OEIS A297370 is ``Number of n X 4 0..1 arrays with every 1 horizontally or antidiagonally adjacent to 0, 1 or 2 neighboring 1's.''. It has offset $1$ and begins
\[
16, 208, 2610, 33054, 418344, 5294713, 67012245, 848136217,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 13*a(n-1) - 4*a(n-2) - 3*a(n-3) - 19*a(n-4) + 15*a(n-5) - a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 08 2021 12:15:26, revision 10) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{The count is a walk count}

The entry counts arrays with $4$ columns over the alphabet $\{0,1\}$, growing one row at a time. Its condition is that every entry equal to $1$ must have exactly $0$, $1$ or $2$ of its horizontal and antidiagonal neighbours equal to $1$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297370.
