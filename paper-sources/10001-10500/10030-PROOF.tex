...
\title{The empirical recurrence for OEIS A196012, proved by transfer matrix}
...
\begin{abstract}
OEIS A196012 counts $n\times3$ arrays over $\{0,\dots,4\}$ subject to a condition imposed on
...
walk, and $a(n)$ is a walk count on $S=42$ vertices, which is $C$-finite. Whether the
...
OEIS A196012 is ``Number of n X 3 0..4 arrays with each element equal to the number its horizontal and vertical neighbors within one of itself.''. It has offset $1$ and begins
\[
1, 1, 2, 7, 13, 16, 32, 65,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) +a(n-2) +3*a(n-4) -a(n-5) -2*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (May 08 2018 06:19:43, revision 9) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A196012.
