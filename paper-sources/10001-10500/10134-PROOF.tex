...
\title{Parities, differences and neighbours: OEIS A265922}
...
\begin{abstract}
OEIS A265922 carries an empirical recurrence of order $8$ contributed by R.~H.~Hardin. It is
...
OEIS A265922 is ``Number of nX2 0..4 arrays with the absolute differences of each element with its with horizontal and antidiagonal neighbors unique.''. It has offset $1$ and begins
\[
25, 340, 4616, 62696, 851496, 11564952, 157071768, 2133318088,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 5*a(n-1) +110*a(n-2) +186*a(n-3) -1189*a(n-4) -2127*a(n-5) +4920*a(n-6) +5776*a(n-7) -9216*a(n-8)
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 18 2015 22:32:26, revision 4) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{The count is a walk count}

The entry counts arrays with $2$ columns over the alphabet $\{0,1,2,3,4\}$, growing one row at a time, and asks that the absolute differences between an element and each of its horizontal and antidiagonal neighbours must all be different from one another.
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) + 110\,a(n-2) + 186\,a(n-3) - 1189\,a(n-4) - 2127\,a(n-5) + 4920\,a(n-6) + 5776\,a(n-7) - 9216\,a(n-8)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A265922.
