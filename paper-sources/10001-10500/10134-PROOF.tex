...
\title{The empirical recurrence for OEIS A266850, derived from the entry's generating function}
...
\begin{abstract}
OEIS A266850 carries an empirical recurrence of order $6$. The entry separately records a
...
OEIS A266850 is ``Decimal representation of the n-th iteration of the "Rule 71" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 6, 4, 123, 16, 2031, 64, 32703,\ \dots
\]
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{48 x^{5} - 16 x^{4} + 3 x^{3} + 17 x^{2} - 6 x - 1}{64 x^{6} - 84 x^{4} + 21 x^{2} - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 48 x^{5} + 16 x^{4} - 3 x^{3} - 17 x^{2} + 6 x + 1,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A266850.
