...
\title{The empirical recurrence for OEIS A206199, proved by transfer matrix}
...
\begin{abstract}
OEIS A206199 counts arrays over $\{0,\dots,3\}$ under a condition on the perimeter cycle of
...
OEIS A206199 is ``Number of (n+1) X 2 0..3 arrays with every 2 X 3 or 3 X 2 subblock having exactly one clockwise edge increases.''. It has offset $1$ and begins
\[
256, 480, 1768, 7388, 29724, 117084, 468968, 1878808,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) + 17*a(n-3) - 5*a(n-4) + 2*a(n-5) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 14 2018 08:18:31, revision 10) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206199.
