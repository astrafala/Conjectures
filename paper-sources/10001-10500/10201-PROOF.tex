...
\title{The empirical recurrence for OEIS A278095, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A278095 counts arrays over $\{0,\dots,3\}$ in which every cell is constrained by the
...
OEIS A278095 is ``Number of n X 2 0..3 arrays with every element plus 1 mod 4 equal to some element at offset (-1,0) (-1,1) (0,-1) (0,1) or (1,0), with upper left element zero.''. It has offset $1$ and begins
\[
0, 2, 10, 58, 334, 1910, 10910, 62314,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 6*a(n-1) - a(n-2) - 3*a(n-3) - 3*a(n-4) - 6*a(n-5) + 2*a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 07 2019 10:27:20, revision 11) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) - a(n-2) - 3\,a(n-3) - 3\,a(n-4) - 6\,a(n-5) + 2\,a(n-7)
\end{equation}
for all $n>8$.
...
$4$ values, so there are about $10^{26}$ of them to sift. The
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A278095.
