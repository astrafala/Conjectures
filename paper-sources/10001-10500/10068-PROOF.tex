...
\title{The empirical recurrence for OEIS A266515, derived from the entry's generating function}
...
\begin{abstract}
OEIS A266515 carries an empirical recurrence of order $6$. The entry separately records a
...
OEIS A266515 is ``Binary representation of the n-th iteration of the "Rule 29" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 11, 100, 1101111, 10000, 11110111111, 1000000, 111111011111111,\ \dots
\]
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{1100000 x^{5} - 10000 x^{4} - 990000 x^{3} + 10001 x^{2} - 11 x - 1}{1000000 x^{6} - 1010100 x^{4} + 10101 x^{2} - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 1100000 x^{5} + 10000 x^{4} + 990000 x^{3} - 10001 x^{2} + 11 x + 1,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A266515.
