...
\title{The empirical recurrence for OEIS A253007, derived from the entry's generating function}
...
\begin{abstract}
OEIS A253007 carries an empirical recurrence of order $4$. The entry separately records a
...
OEIS A253007 is ``Number of n X 4 nonnegative integer arrays with upper left 0 and lower right its king-move distance away minus 3 and every value increasing by 0 or 1 with every step right, diagonally se or down.''. It has offset $1$ and begins
\[
1, 1, 1, 1, 124, 3423, 33533, 158877,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 08 2018 05:43:56, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{25 x^{13} + 375 x^{12} + 2605 x^{11} + 17119 x^{10} + 42525 x^{9} + 44788 x^{8} + 20582 x^{7} + 2930 x^{6} + 123 x^{5} - x^{4} + 3 x^{3} - 3 x^{2} + x}{x^{4} - 4 x^{3} + 6 x^{2} - 4 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;25 x^{13} + 375 x^{12} + 2605 x^{11} + 17119 x^{10} + 42525 x^{9} + 44788 x^{8} + 20582 x^{7} + 2930 x^{6} + 123 x^{5} - x^{4} + 3 x^{3} - 3 x^{2} + x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253007.
