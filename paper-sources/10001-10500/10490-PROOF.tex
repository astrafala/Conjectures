...
\title{The empirical recurrence for OEIS A186562, proved by transfer matrix}
...
\begin{abstract}
OEIS A186562 counts the $(n+2)\times5$ arrays over $\{0,\dots,2\}$ in which
...
a state, the count is a walk count on $S=2917$ of them, and the conjectured recurrence is then
...
OEIS A186562 is ``Number of (n+2) X 5 0..2 arrays with every 3 X 3 subblock commuting with each horizontal and vertical neighbor 3 X 3 subblock.''. It has offset $1$ and begins
\[
2917, 401, 1399, 3421, 4807, 5605, 6511, 8029,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) - a(n-2) + 2*a(n-3) - 4*a(n-4) + 2*a(n-5) + 2*a(n-6) - 2*a(n-7) for n>11.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 18 2018 15:24:35, revision 9) this is still
...
$2917$, which the model reproduces along with every later term.
...
\]
on the $S=2917$ admissible $3$-tuples. In particular $a$ is $C$-finite.
...
size of the construction is therefore $3^{3\cdot5}$ before the condition prunes
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A186562.
