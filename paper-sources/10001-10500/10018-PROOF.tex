...
\title{The empirical recurrence for OEIS A245951, derived from the entry's generating function}
...
\begin{abstract}
OEIS A245951 carries an empirical recurrence of order $6$. The entry separately records a
...
OEIS A245951 is ``Number of length 1+3 0..n arrays with some pair in every consecutive four terms totalling exactly n.''. It has offset $1$ and begins
\[
14, 71, 196, 453, 834, 1435, 2216, 3305,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 05 2018 07:59:51, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{6} + 2 x^{5} + 46 x^{4} + 40 x^{3} + 43 x^{2} + 14 x}{x^{6} - 2 x^{5} - x^{4} + 4 x^{3} - x^{2} - 2 x + 1},
\]
the entry's own generating function, and let
\[
D(x)\;=\;1-\sum_i c_i x^{i}\;=\;x^{6} - 2 x^{5} - x^{4} + 4 x^{3} - x^{2} - 2 x + 1
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- x^{6} + 2 x^{5} + 46 x^{4} + 40 x^{3} + 43 x^{2} + 14 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A245951.
