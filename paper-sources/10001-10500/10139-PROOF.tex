...
\title{The empirical recurrence for OEIS A267041, derived from the entry's generating function}
...
\begin{abstract}
OEIS A267041 carries an empirical recurrence of order $6$. The entry separately records a
...
OEIS A267041 is ``Binary representation of the n-th iteration of the "Rule 91" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 101, 1010, 1100011, 1111100, 11110001111, 111110000, 111111000111111,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 16 2025 08:33:29, revision 29) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 10101000000 x^{8} + 101000000 x^{7} + 10092910100 x^{6} - 100810100 x^{5} + 8080810 x^{4} - 79810 x^{3} + 9091 x^{2} - 101 x - 1}{1000000 x^{6} - 1010100 x^{4} + 10101 x^{2} - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;10101000000 x^{8} - 101000000 x^{7} - 10092910100 x^{6} + 100810100 x^{5} - 8080810 x^{4} + 79810 x^{3} - 9091 x^{2} + 101 x + 1,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267041.
