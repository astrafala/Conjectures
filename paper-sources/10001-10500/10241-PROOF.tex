...
\title{The empirical recurrence for OEIS A186565, proved by transfer matrix}
...
\begin{abstract}
OEIS A186565 counts the $(n+2)\times8$ arrays over $\{0,\dots,2\}$ in which
...
a state, the count is a walk count on $S=20056$ of them, and the conjectured recurrence is then
...
OEIS A186565 is ``Number of (n+2) X 8 0..2 arrays with every 3 X 3 subblock commuting with each horizontal and vertical neighbor 3 X 3 subblock.''. It has offset $1$ and begins
\[
20056, 3379, 5605, 12895, 23389, 29935, 36133, 44887,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) - a(n-2) + 2*a(n-3) - 4*a(n-4) + 2*a(n-5) + 2*a(n-6) - 2*a(n-7) for n>14.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 18 2018 15:24:07, revision 8) this is still
...
$20056$, which the model reproduces along with every later term.
...
\]
on the $S=20056$ admissible $3$-tuples. In particular $a$ is $C$-finite.
...
size of the construction is therefore $3^{3\cdot8}$ before the condition prunes
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A186565.
