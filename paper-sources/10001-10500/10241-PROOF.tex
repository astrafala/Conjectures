...
\title{The empirical recurrence for OEIS A208410, proved by transfer matrix}
...
\begin{abstract}
OEIS A208410 counts $3\times n$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A208410 is ``Number of 3 X n 0..3 arrays with new values 0..3 introduced in row major order and no element equal to more than two of its immediate leftward or upward or right-upward antidiagonal neighbors.''. It has offset $1$ and begins
\[
5, 187, 10682, 658450, 40883360, 2540446156, 157873031498, 9810914663050,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 62*a(n-1) + 39*a(n-2) - 1790*a(n-3) - 4703*a(n-4) - 1254*a(n-5) + 3249*a(n-6) + 918*a(n-7) - 648*a(n-8) for n>10.
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 02 2018 14:13:20, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;62\,a(n-1) + 39\,a(n-2) - 1790\,a(n-3) - 4703\,a(n-4) - 1254\,a(n-5) + 3249\,a(n-6) + 918\,a(n-7) - 648\,a(n-8)
\]
for every $n>10$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208410.
