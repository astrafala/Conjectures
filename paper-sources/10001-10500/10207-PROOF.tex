...
\title{The empirical recurrence for OEIS A206407, proved by transfer matrix}
...
\begin{abstract}
OEIS A206407 counts arrays over $\{0,\dots,2\}$ under a condition on the perimeter cycle of
...
OEIS A206407 is ``Number of (n+1) X 2 0..2 arrays with every 2 X 3 or 3 X 2 subblock having an equal number of clockwise and counterclockwise edge increases.''. It has offset $1$ and begins
\[
81, 423, 2457, 15087, 94761, 600519, 3818649, 24314127,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 9*a(n-1) - 17*a(n-2) + a(n-3) + 4*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 16 2018 16:10:33, revision 14) this is still
...
\begin{theorem}
\[
a(n)\;=\;9\,a(n-1) - 17\,a(n-2) + a(n-3) + 4\,a(n-4)
\]
for every $n>4$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206407.
