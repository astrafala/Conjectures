...
\title{The empirical recurrence for OEIS A235297, proved by transfer matrix}
...
\begin{abstract}
OEIS A235297 carries an empirical recurrence of order $10$ contributed by R. H. Hardin. It is
...
OEIS A235297 is ``Number of (n+1) X (7+1) 0..3 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 3 (constant-stress 1 X 1 tilings).''. It has offset $1$ and begins
\[
13376, 15692, 18832, 25592, 35936, 58688, 97888, 187184,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 18 2022 23:38:50, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A235297.
