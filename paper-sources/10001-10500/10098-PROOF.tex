...
\title{The empirical recurrence for OEIS A249711, derived from the entry's generating function}
...
\begin{abstract}
OEIS A249711 carries an empirical recurrence of order $6$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 10 2018 04:40:17, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{6} + 6 x^{5} - 24 x^{4} + 32 x^{3} + 149 x^{2} + 38 x}{x^{6} - 6 x^{5} + 15 x^{4} - 20 x^{3} + 15 x^{2} - 6 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- x^{6} + 6 x^{5} - 24 x^{4} + 32 x^{3} + 149 x^{2} + 38 x,
\]
