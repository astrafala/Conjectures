...
\title{The empirical recurrence for OEIS A187050, derived from the entry's generating function}
...
\begin{abstract}
OEIS A187050 carries an empirical recurrence of order $3$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 20 2018 10:05:16, revision 11) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n-1}\;=\;\frac{452 x^{11} + 1160 x^{10} + 652 x^{9} - 2124 x^{8} - 6604 x^{7} - 10860 x^{6} - 10396 x^{5} - 5200 x^{4} - 584 x^{3}}{x^{3} - 3 x^{2} + 3 x - 1},
\]
...
For every $n$ in range, $a(n)-\sum_i c_i\,a(n-i)$ is the coefficient of $x^{n-1}$ in
$D(x)G(x)$.
\end{lemma}
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 452 x^{11} - 1160 x^{10} - 652 x^{9} + 2124 x^{8} + 6604 x^{7} + 10860 x^{6} + 10396 x^{5} + 5200 x^{4} + 584 x^{3},
\]
...
they stop at index $12$ because that polynomial has degree $11$. A reader who trusts
