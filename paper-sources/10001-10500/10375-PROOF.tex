...
\title{The empirical recurrence for OEIS A208079, proved by transfer matrix}
...
\begin{abstract}
OEIS A208079 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
$(0,0,0), (0,1,0)$ along one axis and $(0,0,0), (0,0,1)$ along the other, and carries an empirical recurrence of
...
OEIS A208079 is ``Number of 4 X n 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 0 0 and 0 1 0 vertically.''. It has offset
$1$ and begins
\[
9, 81, 441, 2601, 15129, 88209, 514089,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 5*a(n-1) + 5*a(n-2) - a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 20 2018 12:40:38, revision
...
$(0,0,0), (0,1,0)$ as $3$ consecutive entries. There are $9$ admissible columns; that condition
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208079.
