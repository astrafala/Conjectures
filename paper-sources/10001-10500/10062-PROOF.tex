...
\title{The empirical recurrence for OEIS A202933, derived from the entry's generating function}
...
\begin{abstract}
OEIS A202933 carries an empirical recurrence of order $6$. The entry separately records a
...
OEIS A202933 is ``Number of (n+3) X 5 binary arrays with consecutive windows of four bits considered as a binary number nondecreasing in every row and column.''. It has offset $1$ and begins
\[
83521, 113856, 153874, 206145, 273683, 359970, 468980, 605203,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2018 14:17:56, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 60719 x^{6} + 320618 x^{5} - 679679 x^{4} + 723553 x^{3} - 387270 x^{2} + 83521 x}{x^{6} - 6 x^{5} + 15 x^{4} - 20 x^{3} + 15 x^{2} - 6 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 60719 x^{6} + 320618 x^{5} - 679679 x^{4} + 723553 x^{3} - 387270 x^{2} + 83521 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A202933.
