...
\title{The empirical recurrence for OEIS A207436, proved by transfer matrix}
...
\begin{abstract}
OEIS A207436 counts arrays over $\{0,\dots,1\}$ of width $2$ that avoid the patterns
...
OEIS A207436 is ``Number of n X 2 0..1 arrays avoiding 0 0 1 and 0 1 0 horizontally and 0 0 1 and 1 0 0 vertically.''. It has offset
$1$ and begins
\[
4, 16, 36, 81, 196, 484, 1225,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 4*a(n-1) - 2*a(n-2) - 6*a(n-3) + 4*a(n-4) + 2*a(n-5) - a(n-6) for n > 7.
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 09 2018 05:24:21, revision
...
$(0,0,1), (0,1,0)$ as $3$ consecutive entries. There are $4$ admissible rows; that condition
...
rows, so $S=16$, and declare $w\to w'$ an edge when $w'$ is $w$ with its first entry
...
values agree exactly, including the initial count of $4$ admissible rows. That is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207436.
