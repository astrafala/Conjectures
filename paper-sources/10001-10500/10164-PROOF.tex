...
\title{The empirical recurrence for OEIS A268946, derived from the entry's generating function}
...
\begin{abstract}
OEIS A268946 carries an empirical recurrence of order $6$. The entry separately records a
...
OEIS A268946 is ``Number of length-5 0..n arrays with no repeated value unequal to the previous repeated value plus one mod n+1.''. It has offset $1$ and begins
\[
14, 159, 788, 2615, 6834, 15239, 30344, 55503,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 17 2019 04:20:49, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{x^{6} - 6 x^{5} - 8 x^{4} + 44 x^{3} + 75 x^{2} + 14 x}{x^{6} - 6 x^{5} + 15 x^{4} - 20 x^{3} + 15 x^{2} - 6 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;x^{6} - 6 x^{5} - 8 x^{4} + 44 x^{3} + 75 x^{2} + 14 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268946.
