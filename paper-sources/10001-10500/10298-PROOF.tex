...
\title{The empirical recurrence for OEIS A253219, proved by transfer matrix}
...
\begin{abstract}
OEIS A253219 carries an empirical recurrence of order $3$ contributed by R.~H.~Hardin. It is
true, and it is decidable rather than empirical. The entry's condition is local to a bounded window of consecutive lines, so
the admissible configurations of such a window are the vertices of a finite digraph and the
arrays counted are exactly the walks in it; hence $a(n)$ is a walk count on $S=100$ vertices
...
OEIS A253219 is ``Number of n X 4 nonnegative integer arrays with upper left 0 and lower right its king-move distance away minus 2 and every value within 2 of its king move distance from the upper left and every value increasing by 0 or 1 with every step right, diagonally se or down.''. It has offset $1$ and begins
\[
3, 9, 19, 19, 268, 1249, 3140, 5986,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 480*n\^{}2 - 4354*n + 10098 for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 10 2018 08:55:00, revision 8) this is still
...
admissible array is then exactly a walk, so with $M$ the adjacency matrix on $S=100$ vertices
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253219.
