...
\title{The empirical recurrence for OEIS A246478, proved by transfer matrix}
...
\begin{abstract}
OEIS A246478 carries an empirical recurrence of order $4$ contributed by R.~H.~Hardin. It is
...
OEIS A246478 is ``Number of length n+3 0..7 arrays with no pair in any consecutive four terms totalling exactly 7.''. It has offset $1$ and begins
\[
1880, 10376, 57416, 317576, 1756472, 9714968, 53733080, 297195272,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 5*a(n-1) + 2*a(n-2) + 5*a(n-3) + a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 06 2018 06:44:46, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A246478.
