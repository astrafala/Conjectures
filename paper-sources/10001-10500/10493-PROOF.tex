...
\title{The empirical recurrence for OEIS A235288, proved by transfer matrix}
...
\begin{abstract}
OEIS A235288 carries an empirical recurrence of order $6$ contributed by R. H. Hardin. It is
...
OEIS A235288 is ``Number of (n+1) X (7+1) 0..3 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 4 (constant-stress 1 X 1 tilings).''. It has offset $1$ and begins
\[
836, 968, 1108, 1400, 1724, 2408, 3220, 4952,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) +3*a(n-2) -15*a(n-3) +4*a(n-4) +18*a(n-5) -12*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 18 2022 23:38:11, revision 7) this is still
...
An admissible array is then exactly a walk, and $\iota,\tau$ are the vectors recording which windows may begin and end an array, so with $M$ the adjacency matrix on $S=65536$ vertices,
\[
a(n)\;=\;\iota^{\!\top}M^{\,n}\tau ,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A235288.
