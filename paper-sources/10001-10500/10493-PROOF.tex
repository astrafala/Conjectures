...
\title{The empirical recurrence for OEIS A253505, derived from the entry's generating function}
...
\begin{abstract}
OEIS A253505 carries an empirical recurrence of order $4$. The entry separately records a
...
OEIS A253505 is ``Number of (n+2) X (3+2) 0..1 arrays with every 2 X 2 and 3 X 3 subblock diagonal maximum minus antidiagonal minimum nondecreasing horizontally and vertically.''. It has offset $1$ and begins
\[
428, 784, 1332, 2088, 3052, 4248, 5692, 7404,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 16 2018 09:16:24, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{4 x^{8} - 8 x^{7} + 24 x^{6} - 16 x^{5} - 248 x^{4} + 764 x^{3} - 928 x^{2} + 428 x}{x^{4} - 4 x^{3} + 6 x^{2} - 4 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;4 x^{8} - 8 x^{7} + 24 x^{6} - 16 x^{5} - 248 x^{4} + 764 x^{3} - 928 x^{2} + 428 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253505.
