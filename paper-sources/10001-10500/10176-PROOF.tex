...
\title{The empirical recurrence for OEIS A303803, proved by transfer matrix}
...
\begin{abstract}
OEIS A303803 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A303803 is ``Number of nX3 0..1 arrays with every element unequal to 0, 1, 3 or 4 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
3, 7, 9, 15, 27, 47, 83, 161,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) -a(n-2) -3*a(n-3) +6*a(n-4) -5*a(n-5) -2*a(n-6) -a(n-7) -6*a(n-8) +4*a(n-9) +2*a(n-10)
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 30 2018 17:19:15, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) - a(n-2) - 3\,a(n-3) + 6\,a(n-4) - 5\,a(n-5) - 2\,a(n-6) - a(n-7) - 6\,a(n-8) + 4\,a(n-9) + 2\,a(n-10)
\end{equation}
for all $n>10$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A303803.
