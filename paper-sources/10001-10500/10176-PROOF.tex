...
\title{The empirical recurrence for OEIS A269777, derived from the entry's generating function}
...
\begin{abstract}
OEIS A269777 carries an empirical recurrence of order $6$. The entry separately records a
...
OEIS A269777 is ``Number of length-5 0..n arrays with every repeated value unequal to the previous repeated value plus one mod n+1.''. It has offset $1$ and begins
\[
24, 222, 984, 3060, 7680, 16674, 32592, 58824,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 29 2019 05:49:46, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{6 x^{4} + 12 x^{3} + 78 x^{2} + 24 x}{x^{6} - 6 x^{5} + 15 x^{4} - 20 x^{3} + 15 x^{2} - 6 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;6 x^{4} + 12 x^{3} + 78 x^{2} + 24 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269777.
