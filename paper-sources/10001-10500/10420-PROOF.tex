...
\title{The empirical recurrence for OEIS A187861, derived from the entry's generating function}
...
\begin{abstract}
OEIS A187861 carries an empirical recurrence of order $3$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 26 2018 09:18:51, revision 10) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{2685 x^{12} - 3655 x^{11} + 8800 x^{10} - 10073 x^{9} + 3232 x^{8} - 17172 x^{7} - 11461 x^{6} - 20704 x^{5} - 7394 x^{4} - 846 x^{3}}{x^{3} - 3 x^{2} + 3 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 2685 x^{12} + 3655 x^{11} - 8800 x^{10} + 10073 x^{9} - 3232 x^{8} + 17172 x^{7} + 11461 x^{6} + 20704 x^{5} + 7394 x^{4} + 846 x^{3},
\]
