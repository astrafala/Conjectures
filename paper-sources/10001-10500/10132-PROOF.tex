...
\title{The empirical recurrence for OEIS A183899, derived from the entry's generating function}
...
\begin{abstract}
OEIS A183899 carries an empirical recurrence of order $5$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 05 2018 10:27:10, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{2 x^{8} + 5 x^{7} + 2 x^{6} - 74 x^{5} + 116 x^{4} - 51 x^{3} - x}{x^{5} - 5 x^{4} + 10 x^{3} - 10 x^{2} + 5 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 2 x^{8} - 5 x^{7} - 2 x^{6} + 74 x^{5} - 116 x^{4} + 51 x^{3} + x,
\]
