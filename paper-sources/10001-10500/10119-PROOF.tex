...
\title{The empirical recurrence for OEIS A146125, derived from the entry's generating function}
...
\begin{abstract}
OEIS A146125 carries an empirical recurrence of order $5$. The entry separately records a
...
OEIS A146125 is ``Number of n X n arrays of squares of integers with every (n-1) X (n-1) subblock summing to 5 and every element equal to at least one neighbor.''. It has offset $3$ and begins
\[
0, 93, 2046, 8675, 24622, 56389, 112078, 201457,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 23 2018 12:28:44, revision 12) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 14 x^{11} - 66 x^{10} + 260 x^{9} - 34 x^{8} - 777 x^{7} + 625 x^{6} - 1581 x^{5} - 93 x^{4}}{x^{5} - 5 x^{4} + 10 x^{3} - 10 x^{2} + 5 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;14 x^{11} + 66 x^{10} - 260 x^{9} + 34 x^{8} + 777 x^{7} - 625 x^{6} + 1581 x^{5} + 93 x^{4},
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A146125.
