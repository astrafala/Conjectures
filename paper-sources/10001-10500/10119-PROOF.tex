...
\title{The empirical recurrence for OEIS A252154, proved by transfer matrix}
...
\begin{abstract}
OEIS A252154 counts $(n+2)\times7$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
every $3\times3$ subblock, and it carries an empirical recurrence of order $11$
...
$a(n)$ is a walk count on $S=18867$ vertices. Such a sequence is $C$-finite, so whether a given
...
OEIS A252154 is ``Number of (n+2)X(5+2) 0..3 arrays with every 3X3 subblock row and column sum not equal to 0 1 3 6 or 7 and every 3X3 diagonal and antidiagonal sum equal to 0 1 3 6 or 7.''. It has offset $1$ and begins
\[
5577, 4732, 9572, 15460, 29276, 57271, 114243, 225966,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 10:52:32, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;-a(n-1) + 2\,a(n-2) + 14\,a(n-3) + 14\,a(n-4) - 28\,a(n-5) - 56\,a(n-6) - 56\,a(n-7) + 112\,a(n-8) + 64\,a(n-9) + 64\,a(n-10) - 128\,a(n-11)
\]
for every $n>16$.
\end{theorem}

\begin{proof}
The vector $w=q(M)\mathbf{1}$ was formed by $11$ matrix--vector products in exact
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252154.
