...
\title{The empirical recurrence for OEIS A232060, proved by transfer matrix}
...
\begin{abstract}
OEIS A232060 counts arrays of width $3$ over $\{0,1,2\}$ in which every cell carrying one stated
...
OEIS A232060 is ``Number of n X 3 0..2 arrays with every 0 next to a 1 and every 1 next to a 2 horizontally or vertically, with no adjacent values equal.''. It has offset $1$ and begins
\[
4, 14, 46, 130, 410, 1194, 3722, 10942,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + 7*a(n-2) - 3*a(n-3) + 3*a(n-4) - 7*a(n-5) + 2*a(n-6) - 2*a(n-7) + 2*a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2018 05:54:47, revision 8) this is still
...
adjacency matrix,
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=124.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232060.
