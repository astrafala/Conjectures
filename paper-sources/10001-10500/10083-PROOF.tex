...
\title{The empirical recurrence for OEIS A267058, derived from the entry's generating function}
...
\begin{abstract}
OEIS A267058 carries an empirical recurrence of order $6$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 16 2025 08:33:29, revision 23) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{236 x^{5} - 20 x^{4} + 19 x^{3} + 19 x^{2} + 1}{256 x^{6} - 256 x^{4} - x^{2} + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;236 x^{5} - 20 x^{4} + 19 x^{3} + 19 x^{2} + 1,
\]
