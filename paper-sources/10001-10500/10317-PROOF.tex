...
\title{The empirical recurrence for OEIS A232155, proved by transfer matrix}
...
\begin{abstract}
OEIS A232155 counts arrays of width $2$ over $\{0,1,2,3\}$ in which every cell carrying one stated
...
OEIS A232155 is ``Number of n X 2 0..3 arrays with every 0 next to a 1, every 1 next to a 2 and every 2 next to a 3 horizontally, vertically or antidiagonally, and no adjacent values equal.''. It has offset $1$ and begins
\[
2, 18, 62, 218, 746, 2600, 9004, 31262,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) + 2*a(n-2) - 13*a(n-3) - 5*a(n-4) + 14*a(n-5) - 3*a(n-6) + 3*a(n-7) + 8*a(n-8) + a(n-9) - a(n-10) for n>11.
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2018 10:50:05, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + 2\,a(n-2) - 13\,a(n-3) - 5\,a(n-4) + 14\,a(n-5) - 3\,a(n-6) + 3\,a(n-7) + 8\,a(n-8) + a(n-9) - a(n-10)
\]
for every $n>11$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232155.
