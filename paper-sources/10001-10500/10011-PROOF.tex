...
\title{The empirical recurrence for OEIS A201814, derived from the entry's generating function}
...
\begin{abstract}
OEIS A201814 carries an empirical recurrence of order $6$. The entry separately records a
...
OEIS A201814 is ``Number of arrays of 6 integers in -n..n with sum zero and equal numbers of elements greater than zero and less than zero.''. It has offset $1$ and begins
\[
141, 1001, 4621, 15681, 42821, 99961, 207621, 394241,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 25 2018 10:33:27, revision 9) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{6} + 145 x^{5} + 150 x^{4} + 730 x^{3} + 155 x^{2} + 141 x}{x^{6} - 6 x^{5} + 15 x^{4} - 20 x^{3} + 15 x^{2} - 6 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- x^{6} + 145 x^{5} + 150 x^{4} + 730 x^{3} + 155 x^{2} + 141 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A201814.
