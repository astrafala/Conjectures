...
\title{The empirical recurrence for OEIS A302011, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A302011 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A302011 is ``Number of 4 X n 0..1 arrays with every element equal to 0, 1, 2 or 3 horizontally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
8, 128, 1808, 25808, 369040, 5276816, 75450768, 1078839952,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 13*a(n-1) +20*a(n-2) -16*a(n-3) -64*a(n-4) for n > 6.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 23 2021 11:31:23, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;13\,a(n-1) + 20\,a(n-2) - 16\,a(n-3) - 64\,a(n-4)
\end{equation}
for all $n>6$.
...
publishes, $n=16$, the arrays have $4\cdot16$ cells over
$2$ values, so there are about $10^{19}$ of them to sift. The
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302011.
