...
\title{The empirical recurrence for OEIS A267466, derived from the entry's generating function}
...
\begin{abstract}
OEIS A267466 carries an empirical recurrence of order $5$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 05 2018 09:35:33, revision 7) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 46 x^{5} + 130 x^{4} - 110 x^{3} + 36 x^{2} - 4 x}{72 x^{5} - 174 x^{4} + 155 x^{3} - 65 x^{2} + 13 x - 1},
\]
the entry's own generating function, and let
\[
D(x)\;=\;1-\sum_i c_i x^{i}\;=\;- 72 x^{5} + 174 x^{4} - 155 x^{3} + 65 x^{2} - 13 x + 1
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;46 x^{5} - 130 x^{4} + 110 x^{3} - 36 x^{2} + 4 x,
\]
...
\[
72 x^{5} - 174 x^{4} + 155 x^{3} - 65 x^{2} + 13 x - 1,
\]
