...
\title{The empirical recurrence for OEIS A196630, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A196630 counts arrays over $\{0,\dots,4\}$ in which every cell is constrained by the
...
OEIS A196630 is ``Number of n X 2 0..4 arrays with each element x equal to the number its horizontal and vertical neighbors equal to 1,3,2,0,4 for x=0,1,2,3,4.''. It has offset $1$ and begins
\[
1, 2, 5, 10, 26, 65, 161, 403,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) + a(n-2) + a(n-3) - a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 22 2018 11:04:38, revision 8) the statement is
...
\#\{\text{neighbours with value }f(x_{t,u})\}=x_{t,u},\quad f=(1,3,2,0,4)
\end{equation}
for every cell $(t,u)$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A196630.
