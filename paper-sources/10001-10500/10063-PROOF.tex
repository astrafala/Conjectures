...
\title{The empirical recurrence for OEIS A189258, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A189258 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A189258 is ``Number of n X 3 binary arrays without the pattern 0 0 1 diagonally, antidiagonally or horizontally.''. It has offset $1$ and begins
\[
7, 49, 280, 1600, 8985, 50397, 282332, 1581428,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 6*a(n-1) -2*a(n-2) +a(n-4) -50*a(n-5) -6*a(n-6) +140*a(n-7) -56*a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (May 01 2018 14:28:58, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) - 2\,a(n-2) + a(n-4) - 50\,a(n-5) - 6\,a(n-6) + 140\,a(n-7) - 56\,a(n-8)
\end{equation}
for all $n>9$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A189258.
