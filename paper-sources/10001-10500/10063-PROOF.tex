...
\title{The empirical recurrence for OEIS A297721, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297721 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A297721 is ``Number of 2Xn 0..1 arrays with every 1 horizontally, diagonally or antidiagonally adjacent to 1, 2 or 4 neighboring 1s.''. It has offset $1$ and begins
\[
1, 10, 34, 83, 258, 865, 2651, 8041,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 4*a(n-1) -3*a(n-2) +3*a(n-3) -2*a(n-4) -24*a(n-5) +24*a(n-6)
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 04 2018 21:59:59, revision 4) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297721.
