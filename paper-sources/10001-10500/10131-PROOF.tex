...
\title{The empirical recurrence for OEIS A238518, proved by transfer matrix}
...
\begin{abstract}
OEIS A238518 counts $(n+1)\times2$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A238518 is ``Number of (n+1) X (1+1) 0..3 arrays with no element equal to all horizontal neighbors or equal to all vertical neighbors.''. It has offset $1$ and begins
\[
84, 588, 7056, 74676, 812028, 8777664, 95006100, 1028017452,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 9*a(n-1) + 21*a(n-2) - 14*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 24 2018 08:26:21, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A238518.
