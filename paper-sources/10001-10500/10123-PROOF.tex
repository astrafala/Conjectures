...
\title{The empirical recurrence for OEIS A206745, proved by transfer matrix}
...
\begin{abstract}
OEIS A206745 counts arrays over $\{0,\dots,3\}$ under a condition on the perimeter cycle of
...
OEIS A206745 is ``Number of (n+1) X 2 0..3 arrays with every 2 X 3 or 3 X 2 subblock having an equal number of clockwise and counterclockwise edge increases.''. It has offset $1$ and begins
\[
256, 1888, 15680, 139744, 1289472, 12105120, 114566336, 1088409696,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 15*a(n-1) - 55*a(n-2) + 17*a(n-3) + 108*a(n-4) - 84*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 17 2018 09:24:51, revision 11) this is still
...
\begin{theorem}
\[
a(n)\;=\;15\,a(n-1) - 55\,a(n-2) + 17\,a(n-3) + 108\,a(n-4) - 84\,a(n-5)
\]
for every $n>5$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206745.
