...
\title{The empirical recurrence for OEIS A266670, derived from the entry's generating function}
...
\begin{abstract}
OEIS A266670 carries an empirical recurrence of order $6$. The entry separately records a
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{2000000 x^{5} - 10000 x^{4} - 890100 x^{3} + 10001 x^{2} - 11 x - 1}{10000000 x^{6} - 10011000 x^{4} + 11001 x^{2} - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 2000000 x^{5} + 10000 x^{4} + 890100 x^{3} - 10001 x^{2} + 11 x + 1,
\]
