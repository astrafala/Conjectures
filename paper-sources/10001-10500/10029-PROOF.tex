...
\title{The empirical recurrence for OEIS A305764, proved by transfer matrix}
...
\begin{abstract}
OEIS A305764 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $different from$ itself lying in $\{0,1,2,3,4,7\}$, and it carries an empirical
...
OEIS A305764 is ``Number of nX3 0..1 arrays with every element unequal to 0, 1, 2, 3, 4 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
4, 30, 141, 684, 3282, 15874, 76613, 370087,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) +9*a(n-2) -6*a(n-4) +12*a(n-5) -3*a(n-6) -27*a(n-7) +17*a(n-8) -4*a(n-9) -7*a(n-10) +a(n-11)
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 10 2018 09:31:50, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 9\,a(n-2) - 6\,a(n-4) + 12\,a(n-5) - 3\,a(n-6) - 27\,a(n-7) + 17\,a(n-8) - 4\,a(n-9) - 7\,a(n-10) + a(n-11)
\end{equation}
for all $n>11$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A305764.
