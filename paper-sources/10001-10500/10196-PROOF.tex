...
\title{The empirical recurrence for OEIS A186460, proved by transfer matrix}
...
\begin{abstract}
OEIS A186460 counts the $(n+1)\times8$ arrays over $\{0,\dots,1\}$ in which
...
a state, the count is a walk count on $S=245$ of them, and the conjectured recurrence is then
...
OEIS A186460 is ``Number of (n+1) X 8 binary arrays with every 2 X 2 subblock commuting with each of its horizontal and vertical 2 X 2 subblock neighbors.''. It has offset $1$ and begins
\[
245, 292, 590, 945, 1681, 2377, 4121, 5633,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) - 2*a(n-3) + 2*a(n-4) - a(n-5) for n>13.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 18 2018 06:26:02, revision 9) this is still
...
$245$, which the model reproduces along with every later term.
...
\]
on the $S=245$ admissible $2$-tuples. In particular $a$ is $C$-finite.
...
size of the construction is therefore $2^{2\cdot8}$ before the condition prunes
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A186460.
