...
\title{The empirical recurrence for OEIS A300210, proved by transfer matrix}
...
\begin{abstract}
OEIS A300210 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A300210 is ``Number of n X 3 0..1 arrays with every element equal to 0, 1, 2, 3, 4, 5, 7 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
4, 32, 228, 1651, 11965, 86775, 629440, 4566023,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 8*a(n-1) -4*a(n-2) -8*a(n-3) -15*a(n-4) -4*a(n-5) -25*a(n-6) -44*a(n-7) -12*a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 26 2025 10:26:52, revision
6) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;8\,a(n-1) - 4\,a(n-2) - 8\,a(n-3) - 15\,a(n-4) - 4\,a(n-5) - 25\,a(n-6) - 44\,a(n-7) - 12\,a(n-8)
\end{equation}
for all $n>8$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A300210.
