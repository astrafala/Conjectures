...
\title{The empirical recurrence for OEIS A233257, derived from the entry's generating function}
...
\begin{abstract}
OEIS A233257 carries an empirical recurrence of order $2$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 11 2018 04:42:26, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{88 x^{3} - 38 x^{2} + 3 x}{48 x^{2} - 16 x + 1},
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A233257.
