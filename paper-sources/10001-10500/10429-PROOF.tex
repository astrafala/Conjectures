...
\title{The empirical recurrence for OEIS A214181, proved by transfer matrix}
...
\begin{abstract}
OEIS A214181 carries an empirical recurrence of order $4$ contributed by R.~H.~Hardin. It is
...
OEIS A214181 is ``Number of 0..6 colorings of an n X 3 array circular in the 3 direction with new values 0..6 introduced in row major order.''. It has offset $1$ and begins
\[
1, 18, 1046, 108893, 13701111, 1808609113, 241491378451, 32332391658753,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 179*a(n-1) - 6468*a(n-2) + 59396*a(n-3) - 94336*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 22 2018 06:42:13, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;179\,a(n-1) - 6468\,a(n-2) + 59396\,a(n-3) - 94336\,a(n-4)
\]
for every $n>4$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A214181.
