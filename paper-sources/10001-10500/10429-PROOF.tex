...
\title{The empirical recurrence for OEIS A202117, proved by transfer matrix}
...
\begin{abstract}
OEIS A202117 carries an empirical recurrence of order $4$ contributed by R.~H.~Hardin. It is
...
OEIS A202117 is ``Number of -1..1 arrays of n elements with first, second and third differences also in -1..1.''. It has offset $1$ and begins
\[
3, 7, 13, 19, 27, 35, 47, 65,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) -a(n-2) +a(n-3) -a(n-4) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (May 27 2018 06:56:14, revision 10) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A202117.
