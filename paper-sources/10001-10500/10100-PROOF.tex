...
\title{The empirical recurrence for OEIS A234877, proved by transfer matrix}
...
\begin{abstract}
OEIS A234877 counts $4$-column arrays over $\{0,\dots,4\}$ in which every
...
OEIS A234877 is ``Number of (n+1) X (3+1) 0..4 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 1, with no adjacent elements equal (constant-stress tilted 1 X 1 tilings).''. It has offset
$1$ and begins
\[
128, 268, 472, 1116, 2096, 5316, 10240,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) + 11*a(n-2) - 23*a(n-3) - 38*a(n-4) + 87*a(n-5) + 46*a(n-6) - 130*a(n-7) - 16*a(n-8) + 78*a(n-9) - 16*a(n-11).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 19 2022 01:17:36, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 11\,a(n-2) - 23\,a(n-3) - 38\,a(n-4) + 87\,a(n-5) + 46\,a(n-6) - 130\,a(n-7) - 16\,a(n-8) + 78\,a(n-9) - 16\,a(n-11)
\end{equation}
...
$j=0,1,\dots$. They vanish from $j=11-11+1$ onwards, and the run was continued past
$S$ consecutive zeros, which by Lemma~\ref{lem:crit} settles every larger $j$. Hence the
recurrence holds for every $n>11$.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234877.
