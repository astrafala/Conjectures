...
\title{The empirical recurrence for OEIS A250082, derived from the entry's generating function}
...
\begin{abstract}
OEIS A250082 carries an empirical recurrence of order $6$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 10 2018 13:33:57, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{6} + 6 x^{5} - x^{4} + 157 x^{3} + 150 x^{2} + 49 x}{x^{6} - 6 x^{5} + 15 x^{4} - 20 x^{3} + 15 x^{2} - 6 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- x^{6} + 6 x^{5} - x^{4} + 157 x^{3} + 150 x^{2} + 49 x,
\]
