...
\title{The empirical recurrence for OEIS A211837, derived from the entry's generating function}
...
\begin{abstract}
OEIS A211837 carries an empirical recurrence of order $5$. The entry separately records a
...
OEIS A211837 is ``Number of nonnegative integer arrays of length n+4 with new values 0 upwards introduced in order, no three adjacent elements equal, and containing the value n+1.''. It has offset $1$ and begins
\[
33, 77, 157, 289, 492, 788, 1202, 1762,\ \dots
\]
...
\begin{quote}
G.f.: x*(33 - 88*x + 102*x\^{}2 - 56*x\^{}3 + 12*x\^{}4) / (1 - x)\^{}5.
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 20 2018 06:03:06, revision 7) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 12 x^{5} + 56 x^{4} - 102 x^{3} + 88 x^{2} - 33 x}{x^{5} - 5 x^{4} + 10 x^{3} - 10 x^{2} + 5 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;12 x^{5} - 56 x^{4} + 102 x^{3} - 88 x^{2} + 33 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A211837.
