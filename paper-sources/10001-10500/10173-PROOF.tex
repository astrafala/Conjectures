...
\title{The empirical recurrence for OEIS A269642, derived from the entry's generating function}
...
\begin{abstract}
OEIS A269642 carries an empirical recurrence of order $6$. The entry separately records a
...
OEIS A269642 is ``Number of length-5 0..n arrays with no repeated value differing from the previous repeated value by other than plus two or minus 1.''. It has offset $1$ and begins
\[
12, 159, 796, 2637, 6876, 15307, 30444, 55641,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 25 2019 11:45:24, revision 9) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{6} - 6 x^{5} + 6 x^{4} + 22 x^{3} + 87 x^{2} + 12 x}{x^{6} - 6 x^{5} + 15 x^{4} - 20 x^{3} + 15 x^{2} - 6 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- x^{6} - 6 x^{5} + 6 x^{4} + 22 x^{3} + 87 x^{2} + 12 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269642.
