...
\title{The empirical recurrence for OEIS A185515, proved by transfer matrix}
...
\begin{abstract}
OEIS A185515 counts arrays over $\{0,\dots,2\}$ under a condition on the determinant of every
...
OEIS A185515 is ``Number of (n+1) X 4 0..2 arrays with every 2 X 2 subblock singular.''. It has offset $1$ and begins
\[
593, 12361, 154561, 2490449, 35659489, 541370505, 7998109489, 119752453041,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 21*a(n-1) - 47*a(n-2) - 1009*a(n-3) + 5624*a(n-4) - 3060*a(n-5) - 27360*a(n-6) + 36864*a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 16 2018 08:59:17, revision 13) this is still
...
first term is $593$, and the model reproduces it along with every later term; that is the
...
\begin{theorem}
\[
a(n)\;=\;21\,a(n-1) - 47\,a(n-2) - 1009\,a(n-3) + 5624\,a(n-4) - 3060\,a(n-5) - 27360\,a(n-6) + 36864\,a(n-7)
\]
for every $n>6$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A185515.
