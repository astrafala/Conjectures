...
\title{The empirical recurrence for OEIS A303724, proved by transfer matrix}
...
\begin{abstract}
OEIS A303724 counts $5$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A303724 is ``Number of nX5 0..1 arrays with every element unequal to 0, 1, 2 or 3 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
16, 120, 77, 133, 219, 345, 564, 974,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) -a(n-4) -a(n-6) -a(n-7) +2*a(n-8) for n>12
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 29 2018 11:09:55, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A303724.
