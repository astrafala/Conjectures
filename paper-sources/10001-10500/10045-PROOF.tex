...
\title{The empirical recurrence for OEIS A253757, proved by transfer matrix}
...
\begin{abstract}
OEIS A253757 counts the arrays over $\{0,\dots,1\}$ whose $3\times3$ subblocks carry a
...
OEIS A253757 is ``Number of (n+2)X(1+2) 0..1 arrays with every 3X3 subblock diagonal median minus antidiagonal median nondecreasing horizontally and vertically.''. It has offset $1$ and begins
\[
512, 2992, 16544, 82064, 423232, 2154496, 11244672, 58351744,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 6*a(n-1) +12*a(n-2) -96*a(n-3) +384*a(n-5) -192*a(n-6) -384*a(n-7) +256*a(n-8) for n>15
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 14:13:35, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) + 12\,a(n-2) - 96\,a(n-3) + 384\,a(n-5) - 192\,a(n-6) - 384\,a(n-7) + 256\,a(n-8)
\]
for every $n>15$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253757.
