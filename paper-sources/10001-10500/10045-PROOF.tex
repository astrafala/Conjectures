...
\title{The empirical recurrence for OEIS A241937, derived from the entry's generating function}
...
\begin{abstract}
OEIS A241937 carries an empirical recurrence of order $6$. The entry separately records a
...
OEIS A241937 is ``Number of length 1+4 0..n arrays with no consecutive five elements summing to more than 2*n.''. It has offset $1$ and begins
\[
16, 96, 357, 1007, 2373, 4928, 9318, 16389,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 30 2018 20:20:14, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{6} + 6 x^{5} - 15 x^{4} + 21 x^{3} + 16 x}{x^{6} - 6 x^{5} + 15 x^{4} - 20 x^{3} + 15 x^{2} - 6 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- x^{6} + 6 x^{5} - 15 x^{4} + 21 x^{3} + 16 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A241937.
