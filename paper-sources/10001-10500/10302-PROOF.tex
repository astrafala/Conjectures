...
\title{The empirical recurrence for OEIS A207720, proved by transfer matrix}
...
\begin{abstract}
OEIS A207720 counts arrays over $\{0,\dots,1\}$ of width $5$ that avoid the patterns
...
OEIS A207720 is ``Number of 5Xn 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 0 1 and 1 0 0 vertically.''. It has offset
$1$ and begins
\[
14, 196, 1414, 11970, 97580, 805154, 6614706,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 4*a(n-1) +37*a(n-2) -3*a(n-3) -132*a(n-4) +26*a(n-5) +132*a(n-6) -59*a(n-7) -15*a(n-8) +6*a(n-9) +a(n-10)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:12:44, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) + 37\,a(n-2) - 3\,a(n-3) - 132\,a(n-4) + 26\,a(n-5) + 132\,a(n-6) - 59\,a(n-7) - 15\,a(n-8) + 6\,a(n-9) + a(n-10)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207720.
