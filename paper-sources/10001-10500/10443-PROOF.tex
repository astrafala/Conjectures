...
\title{The empirical recurrence for OEIS A187169, derived from the entry's generating function}
...
\begin{abstract}
OEIS A187169 carries an empirical recurrence of order $4$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 05 2022 22:12:00, revision 15) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{216 x^{10} + 2796 x^{9} + 8976 x^{8} - 15840 x^{7} - 72960 x^{6} + 159264 x^{5} + 338496 x^{4} + 67248 x^{3} + 144 x^{2}}{x^{4} - 4 x^{3} + 6 x^{2} - 4 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;216 x^{10} + 2796 x^{9} + 8976 x^{8} - 15840 x^{7} - 72960 x^{6} + 159264 x^{5} + 338496 x^{4} + 67248 x^{3} + 144 x^{2},
\]
