...
\title{The empirical recurrence for OEIS A252536, proved by transfer matrix}
...
\begin{abstract}
OEIS A252536 counts $6\times(n+2)$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
$a(n)$ is a walk count on $S=443463$ vertices. Such a sequence is $C$-finite, so whether a given
...
OEIS A252536 is ``Number of (4+2) X (n+2) 0..3 arrays with every 3 X 3 subblock row and diagonal sum equal to 0 2 3 6 or 7 and every 3 X 3 column and antidiagonal sum not equal to 0 2 3 6 or 7.''. It has offset $1$ and begins
\[
535, 426, 610, 790, 1592, 2440, 3160, 6368,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-3) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 05 2018 03:39:29, revision 9) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252536.
