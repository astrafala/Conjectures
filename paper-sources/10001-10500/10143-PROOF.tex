...
\title{The empirical recurrence for OEIS A267057, derived from the entry's generating function}
...
\begin{abstract}
OEIS A267057 carries an empirical recurrence of order $6$. The entry separately records a
...
OEIS A267057 is ``Binary representation of the n-th iteration of the "Rule 97" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 0, 10100, 10011, 100000000, 11111111, 1010000000000, 1001111111111,\ \dots
\]
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{11101100 x^{5} - 10100 x^{4} + 10011 x^{3} + 10099 x^{2} + 1}{100000000 x^{6} - 100000000 x^{4} - x^{2} + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;11101100 x^{5} - 10100 x^{4} + 10011 x^{3} + 10099 x^{2} + 1,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267057.
