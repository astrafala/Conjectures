...
\title{The empirical recurrence for OEIS A267138, derived from the entry's generating function}
...
\begin{abstract}
OEIS A267138 carries an empirical recurrence of order $6$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 16 2025 08:33:29, revision 34) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 1000000000000 x^{10} + 11000000000 x^{9} + 999000000000 x^{8} - 10991100000 x^{7} + 999110000 x^{6} - 8881000 x^{5} + 880100 x^{4} - 8891 x^{3} + 9901 x^{2} - 110 x - 1}{100000 x^{6} - 110010 x^{4} + 10011 x^{2} - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;1000000000000 x^{10} - 11000000000 x^{9} - 999000000000 x^{8} + 10991100000 x^{7} - 999110000 x^{6} + 8881000 x^{5} - 880100 x^{4} + 8891 x^{3} - 9901 x^{2} + 110 x + 1,
\]
