...
\title{The empirical recurrence for OEIS A243722, proved by transfer matrix}
...
\begin{abstract}
OEIS A243722 carries an empirical recurrence of order $4$ contributed by R.~H.~Hardin. It is
...
OEIS A243722 is ``Number of length n+2 0..3 arrays with no three unequal elements in a row and no three equal elements in a row and new values 0..3 introduced in 0..3 order.''. It has offset $1$ and begins
\[
3, 6, 12, 25, 53, 115, 253, 564,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + 3*a(n-2) - 4*a(n-3) - 3*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 03 2018 08:39:39, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A243722.
