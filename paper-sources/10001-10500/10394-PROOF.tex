...
\title{The empirical recurrence for OEIS A187380, derived from the entry's generating function}
...
\begin{abstract}
OEIS A187380 carries an empirical recurrence of order $3$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 24 2018 06:43:40, revision 12) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{44 x^{7} - 82 x^{6} - 112 x^{5} - 192 x^{4} - 24 x^{3}}{x^{3} - 3 x^{2} + 3 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 44 x^{7} + 82 x^{6} + 112 x^{5} + 192 x^{4} + 24 x^{3},
\]
