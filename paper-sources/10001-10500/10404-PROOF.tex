...
\title{The empirical recurrence for OEIS A187590, derived from the entry's generating function}
...
\begin{abstract}
OEIS A187590 carries an empirical recurrence of order $3$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 24 2018 15:42:14, revision 11) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{258 x^{8} + 190 x^{7} - 1152 x^{6} - 2776 x^{5} - 1474 x^{4} - 78 x^{3}}{x^{3} - 3 x^{2} + 3 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 258 x^{8} - 190 x^{7} + 1152 x^{6} + 2776 x^{5} + 1474 x^{4} + 78 x^{3},
\]
