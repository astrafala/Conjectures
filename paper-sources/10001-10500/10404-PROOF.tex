...
\title{The empirical recurrence for OEIS A188826, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A188826 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A188826 is ``Number of 4 X n binary arrays without the pattern 0 1 diagonally or antidiagonally.''. It has offset $1$ and begins
\[
16, 25, 81, 256, 841, 2704, 8836, 28561,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) + 5*a(n-2) - 15*a(n-3) + 3*a(n-4) + 5*a(n-5) - a(n-6) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 30 2018 14:11:27, revision 9) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A188826.
