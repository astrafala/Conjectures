...
\title{A condition on the multiset of every subblock: OEIS A183596}
...
\begin{abstract}
OEIS A183596 carries an empirical recurrence of order $4$ contributed by R.~H.~Hardin. It is
...
OEIS A183596 is ``1/6 the number of (n+1) X 3 0..2 arrays with every 2 X 2 subblock containing all three values.''. It has offset $1$ and begins
\[
27, 204, 1479, 10797, 78729, 574185, 4187499, 30539367,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 8*a(n-1) - 3*a(n-2) - 16*a(n-3) + 2*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 30 2018 09:11:12, revision 9) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{The count is a walk count}

The entry counts arrays with $3$ columns over the alphabet $\{0,1,2\}$, growing one row at a time, and asks that every $2\times2$ subblock holds exactly $3$ distinct values.
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-1) - 3\,a(n-2) - 16\,a(n-3) + 2\,a(n-4)
\]
for every $n>3$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A183596.
