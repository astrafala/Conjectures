...
\title{The empirical recurrence for OEIS A249984, derived from the entry's generating function}
...
\begin{abstract}
OEIS A249984 carries an empirical recurrence of order $5$. The entry separately records a
...
OEIS A249984 is ``Number of length 4+1 0..2*n arrays with the sum of the absolute values of adjacent differences equal to 4*n.''. It has offset $1$ and begins
\[
64, 384, 1242, 3030, 6252, 11524, 19574, 31242,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 10 2018 05:46:27, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 2 x^{5} - 20 x^{4} + 38 x^{3} - 64 x^{2} - 64 x}{x^{5} - 5 x^{4} + 10 x^{3} - 10 x^{2} + 5 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;2 x^{5} + 20 x^{4} - 38 x^{3} + 64 x^{2} + 64 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A249984.
