...
\title{The empirical recurrence for OEIS A241608, proved by transfer matrix}
...
\begin{abstract}
OEIS A241608 carries an empirical recurrence of order $6$ contributed by R.~H.~Hardin. It is
...
OEIS A241608 is ``Number of length n+2 0..2 arrays with no consecutive three elements summing to more than 2.''. It has offset $1$ and begins
\[
10, 20, 40, 76, 147, 287, 556, 1077,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + a(n-2) + 2*a(n-3) - a(n-5) - a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 30 2018 10:33:49, revision 9) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A241608.
