...
\title{The empirical recurrence for OEIS A249709, derived from the entry's generating function}
...
\begin{abstract}
OEIS A249709 carries an empirical recurrence of order $6$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 10 2018 04:40:13, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{6} + 6 x^{5} - 12 x^{4} - 10 x^{3} + 5 x^{2} + 20 x}{x^{6} - 6 x^{5} + 15 x^{4} - 20 x^{3} + 15 x^{2} - 6 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- x^{6} + 6 x^{5} - 12 x^{4} - 10 x^{3} + 5 x^{2} + 20 x,
\]
