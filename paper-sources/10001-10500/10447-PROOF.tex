...
\title{The empirical recurrence for OEIS A206102, proved by transfer matrix}
...
\begin{abstract}
OEIS A206102 counts arrays of width $2$ over $\{0,1,2,3\}$ subject to a condition read round the
...
count is a walk count on a finite digraph with $S=81$ vertices, and whether a linear
...
OEIS A206102 is ``Number of (n+1) X 2 0..3 arrays with the number of clockwise edge increases in 2 X 2 subblocks nondecreasing, and counterclockwise edge increases nonincreasing, rightwards and downwards.''. It has offset $1$ and begins
\[
256, 2292, 15564, 95408, 574364, 3472540, 21122008, 129099360,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 16*a(n-1) - 87*a(n-2) + 174*a(n-3) - 15*a(n-4) - 420*a(n-5) + 607*a(n-6) - 346*a(n-7) + 72*a(n-8) for n>10.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 11 2015 11:59:08, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;16\,a(n-1) - 87\,a(n-2) + 174\,a(n-3) - 15\,a(n-4) - 420\,a(n-5) + 607\,a(n-6) - 346\,a(n-7) + 72\,a(n-8)
\]
for every $n>10$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206102.
