...
\title{The empirical recurrence for OEIS A220683, proved by transfer matrix}
...
\begin{abstract}
OEIS A220683 counts the ways of linking the cells of a grid $3$ cells wide, each cell either to
...
state, the count is a walk count on $S=16$ of them, and the conjectured recurrence is then
...
OEIS A220683 is ``Number of ways to reciprocally link elements of an n X 3 array either to themselves or to exactly two horizontal, vertical or antidiagonal neighbors.''. It has offset $1$ and begins
\[
1, 12, 94, 745, 5851, 46027, 362057, 2847943,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 6*a(n-1) + 12*a(n-2) + 19*a(n-3) + 16*a(n-4) + 2*a(n-5) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 02 2018 06:24:20, revision 7) this is still
...
one configuration. With $M$ the adjacency matrix of the digraph on the $S=16$ reachable
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) + 12\,a(n-2) + 19\,a(n-3) + 16\,a(n-4) + 2\,a(n-5)
\]
for every $n>6$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A220683.
