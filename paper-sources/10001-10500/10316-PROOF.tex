...
\title{The empirical recurrence for OEIS A184679, proved by transfer matrix}
...
\begin{abstract}
OEIS A184679 counts arrays over $\{0,\dots,1\}$ under a condition on the determinant of every
...
a bounded window of consecutive rows, so the count is a walk count on $S=8$ states and is
...
OEIS A184679 is ``Number of (n+1) X 3 binary arrays with every 2 X 2 subblock singular.''. It has offset $1$ and begins
\[
28, 128, 544, 2384, 10384, 45392, 198352, 867152,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 5*a(n-1) - 12*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 14 2018 08:21:36, revision 9) this is still
...
$2\times3$ arrays over $\{0,\dots,1\}$ all of whose subblocks pass. The entry's
first term is $28$, and the model reproduces it along with every later term; that is the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A184679.
