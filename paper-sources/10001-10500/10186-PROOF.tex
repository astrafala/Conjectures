...
\title{The empirical recurrence for OEIS A206336, proved by transfer matrix}
...
\begin{abstract}
OEIS A206336 counts the $(n+1)\times2$ arrays over $\{0,\dots,3\}$ in which
...
a state, the count is a walk count on $S=192$ of them, and the conjectured recurrence is then
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 15 2018 10:39:22, revision 8) this is still
...
$192$, which the model reproduces along with every later term.
...
\]
on the $S=192$ admissible $2$-tuples. In particular $a$ is $C$-finite.
