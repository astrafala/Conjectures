...
\title{The empirical recurrence for OEIS A245871, derived from the entry's generating function}
...
\begin{abstract}
OEIS A245871 carries an empirical recurrence of order $5$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 04 2018 08:02:19, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{5} + 3 x^{4} - 15 x^{3} + 15 x^{2} + 10 x}{x^{5} - 3 x^{4} + 2 x^{3} + 2 x^{2} - 3 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- x^{5} + 3 x^{4} - 15 x^{3} + 15 x^{2} + 10 x,
\]
