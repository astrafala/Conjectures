...
\title{The empirical recurrence for OEIS A206065, proved by transfer matrix}
...
\begin{abstract}
OEIS A206065 counts arrays over $\{0,\dots,2\}$ under a condition on the perimeter cycle of
...
OEIS A206065 is ``Number of (n+1) X 2 0..2 arrays with every 2 X 3 or 3 X 2 subblock having exactly three clockwise edge increases.''. It has offset $1$ and begins
\[
81, 150, 537, 2052, 7878, 29760, 112236, 423288,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) - a(n-2) + 2*a(n-4) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 13 2018 11:24:10, revision 9) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206065.
