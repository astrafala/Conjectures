...
\title{The empirical recurrence for OEIS A233490, proved by transfer matrix}
...
\begin{abstract}
OEIS A233490 counts arrays of width $3$ over $\{0,1,2\}$ containing no run of $3$ consecutive
...
OEIS A233490 is ``Number of (n+2) X (1+2) 0..2 arrays with no increasing sequence of length 3 horizontally or antidiagonally downwards.''. It has offset $1$ and begins
\[
16928, 424009, 10619963, 265993633, 6662227346, 166865923720, 4179418541288, 104680086586273,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 25*a(n-1) + 2*a(n-2) - 21*a(n-3) + 3*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 11 2018 06:27:37, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A233490.
