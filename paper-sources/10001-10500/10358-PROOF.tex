...
\title{The empirical recurrence for OEIS A221598, derived from the entry's generating function}
...
\begin{abstract}
OEIS A221598 carries an empirical recurrence of order $4$. The entry separately records a
...
OEIS A221598 is ``Number of 0..n arrays of length 6 with each element differing from at least one neighbor by 1 or less.''. It has offset $1$ and begins
\[
64, 393, 1210, 2715, 5082, 8475, 13056, 18987,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 09 2018 08:56:49, revision 7) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 2 x^{7} - 10 x^{6} - 26 x^{5} - 23 x^{4} + 22 x^{3} + 137 x^{2} + 64 x}{x^{4} - 4 x^{3} + 6 x^{2} - 4 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 2 x^{7} - 10 x^{6} - 26 x^{5} - 23 x^{4} + 22 x^{3} + 137 x^{2} + 64 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221598.
