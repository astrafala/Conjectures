...
\title{The empirical recurrence for OEIS A299137, proved by transfer matrix}
...
\begin{abstract}
OEIS A299137 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A299137 is ``Number of n X 3 0..1 arrays with every element equal to 1, 2, 3, 4, 5 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 18, 129, 899, 6205, 43066, 298361, 2068149,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 6*a(n-1) +8*a(n-2) -12*a(n-3) +8*a(n-4) +7*a(n-5) -4*a(n-6) -2*a(n-7) -7*a(n-8) -5*a(n-9) +2*a(n-10) for n>11.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 17 2018 10:26:02, revision
8) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) + 8\,a(n-2) - 12\,a(n-3) + 8\,a(n-4) + 7\,a(n-5) - 4\,a(n-6) - 2\,a(n-7) - 7\,a(n-8) - 5\,a(n-9) + 2\,a(n-10)
\end{equation}
for all $n>11$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A299137.
