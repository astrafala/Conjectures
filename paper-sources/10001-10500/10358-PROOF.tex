...
\title{The empirical recurrence for OEIS A238039, proved by transfer matrix}
...
\begin{abstract}
OEIS A238039 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
OEIS A238039 is ``Number of (n+1) X (1+1) 0..2 arrays with the upper median minus the lower median of every 2 X 2 subblock differing from its horizontal and vertical neighbors by exactly one.''. It has offset $1$ and begins
\[
81, 340, 1440, 6064, 25948, 109200, 466296, 1962720,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 8*a(n-2) + 152*a(n-4) + 472*a(n-6) + 384*a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 24 2018 06:00:26, revision 7) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The $2\times2$ subblocks of an $(n+1)\times2$ array form an
$n\times1$ grid, and each carries the value $\sigma=-b+c$, where $a\le b\le c\le d$ are its four entries sorted --- its minimum, lower median, upper median and maximum. The entry asks that the values of
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-2) + 152\,a(n-4) + 472\,a(n-6) + 384\,a(n-8)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A238039.
