...
\title{The empirical recurrence for OEIS A059138, derived from the entry's generating function}
...
\begin{abstract}
OEIS A059138 carries an empirical recurrence of order $3$. The entry separately records a
...
OEIS A059138 is ``A hierarchical sequence (S(W3{2,2}cc) - see A059126).''. It has offset $0$ and begins
\[
18, 90, 270, 666, 1494, 3186, 6606, 13482,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 02 2023 16:10:26, revision 23) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 18 x - 18}{2 x^{3} - 5 x^{2} + 4 x - 1},
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A059138.
