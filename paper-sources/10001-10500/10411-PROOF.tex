...
\title{The empirical recurrence for OEIS A259244, proved by transfer matrix}
...
\begin{abstract}
OEIS A259244 counts arrays of width $3$ over $\{0,1\}$ subject to a condition read round the
...
OEIS A259244 is ``Number of (n+1) X (2+1) 0..1 arrays with each 2 X 2 subblock having clockwise pattern 0000 0011 or 0111.''. It has offset $1$ and begins
\[
21, 65, 192, 581, 1733, 5216, 15613, 46897,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) + 4*a(n-2) - 11*a(n-3) - 3*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 24 2018 16:21:32, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A259244.
