...
\title{The empirical recurrence for OEIS A187611, derived from the entry's generating function}
...
\begin{abstract}
OEIS A187611 carries an empirical recurrence of order $3$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 25 2018 11:48:56, revision 11) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{729 x^{14} - 983 x^{13} + 960 x^{12} - 1907 x^{10} - 213 x^{9} - 1522 x^{8} - 1232 x^{7} - 472 x^{6} - 48 x^{5}}{x^{3} - 3 x^{2} + 3 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 729 x^{14} + 983 x^{13} - 960 x^{12} + 1907 x^{10} + 213 x^{9} + 1522 x^{8} + 1232 x^{7} + 472 x^{6} + 48 x^{5},
\]
...
compared against all $34$ terms the entry publishes: it reproduces every one. This is
