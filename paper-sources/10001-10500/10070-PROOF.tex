...
\title{The empirical recurrence for OEIS A266590, derived from the entry's generating function}
...
\begin{abstract}
OEIS A266590 carries an empirical recurrence of order $6$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 16 2025 08:33:28, revision 31) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{672 x^{7} - 160 x^{6} - 602 x^{5} + 154 x^{4} - 23 x^{3} + 7 x^{2} - 2 x - 1}{64 x^{6} - 84 x^{4} + 21 x^{2} - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 672 x^{7} + 160 x^{6} + 602 x^{5} - 154 x^{4} + 23 x^{3} - 7 x^{2} + 2 x + 1,
\]
