...
\title{The empirical recurrence for OEIS A059135, derived from the entry's generating function}
...
\begin{abstract}
OEIS A059135 carries an empirical recurrence of order $3$. The entry separately records a
...
OEIS A059135 is ``A hierarchical sequence (S(W2{3}c) - see A059126).''. It has offset $0$ and begins
\[
11, 54, 161, 396, 887, 1890, 3917, 7992,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 02 2023 16:08:59, revision 21) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 10 x - 11}{2 x^{3} - 5 x^{2} + 4 x - 1},
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A059135.
