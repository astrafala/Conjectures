...
\title{The empirical recurrence for OEIS A317521, proved by transfer matrix}
...
\begin{abstract}
OEIS A317521 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A317521 is ``Number of nX4 0..1 arrays with every element unequal to 0, 1, 2, 3, 4, 5, 6 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
8, 128, 1921, 28760, 431529, 6475106, 97158833, 1457871738,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 15*a(n-1) +a(n-2) -8*a(n-3) -84*a(n-4) -63*a(n-5) +24*a(n-6) +20*a(n-7)
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 30 2018 11:37:31, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;15\,a(n-1) + a(n-2) - 8\,a(n-3) - 84\,a(n-4) - 63\,a(n-5) + 24\,a(n-6) + 20\,a(n-7)
\end{equation}
for all $n>7$.
...
\begin{theorem}
The recurrence \eqref{eq:conj} holds for every $n>7$. This is the statement of
Section~1.
\end{theorem}
...
They vanish from the index corresponding to $n=7+1$ onwards, and the run was continued
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A317521.
