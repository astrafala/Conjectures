...
\title{The empirical recurrence for OEIS A229439, derived from the entry's generating function}
...
\begin{abstract}
OEIS A229439 carries an empirical recurrence of order $5$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 16 2018 10:10:18, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 2 x^{5} + 10 x^{4} - 18 x^{3} + 13 x^{2} - 4 x}{x^{5} - 5 x^{4} + 10 x^{3} - 10 x^{2} + 5 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;2 x^{5} - 10 x^{4} + 18 x^{3} - 13 x^{2} + 4 x,
\]
