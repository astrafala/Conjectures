...
\title{The empirical recurrence for OEIS A146124, derived from the entry's generating function}
...
\begin{abstract}
OEIS A146124 carries an empirical recurrence of order $5$. The entry separately records a
...
OEIS A146124 is ``Number of n X n arrays of squares of integers summing to 5 with every element equal to at least one neighbor.''. It has offset $2$ and begins
\[
0, 32, 516, 2307, 6472, 14379, 27684, 48331,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 23 2018 12:28:38, revision 12) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{13 x^{8} - 89 x^{7} + 223 x^{6} - 47 x^{5} - 356 x^{4} - 32 x^{3}}{x^{5} - 5 x^{4} + 10 x^{3} - 10 x^{2} + 5 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 13 x^{8} + 89 x^{7} - 223 x^{6} + 47 x^{5} + 356 x^{4} + 32 x^{3},
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A146124.
