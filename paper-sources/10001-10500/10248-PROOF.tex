...
\title{The empirical recurrence for OEIS A253490, proved by transfer matrix}
...
\begin{abstract}
OEIS A253490 counts the arrays over $\{0,\dots,2\}$ whose $2\times2$ subblocks carry a
...
so a pair of consecutive array rows is a state, the count is a walk count on $S=1388$ of them,
...
OEIS A253490 is ``Number of (n+1) X (3+1) 0..2 arrays with every 2 X 2 subblock diagonal minus antidiagonal sum nondecreasing horizontally, vertically and ne-to-sw antidiagonally.''. It has offset $1$ and begins
\[
1388, 3090, 4196, 6931, 13528, 29370, 68992, 172050,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 6*a(n-1) - 11*a(n-2) + 6*a(n-3) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 15 2018 16:00:48, revision 10) this is still
...
\]
on the $S=1388$ admissible pairs. In particular $a$ is $C$-finite. The alignment of the walk
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253490.
