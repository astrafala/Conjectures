...
\title{The empirical recurrence for OEIS A189450, proved by transfer matrix}
...
\begin{abstract}
OEIS A189450 carries an empirical recurrence of order $4$ contributed by R.~H.~Hardin. It is
...
OEIS A189450 is ``Number of 2 X n array permutations with each element moving zero or one space horizontally or diagonally.''. It has offset $1$ and begins
\[
1, 5, 16, 61, 225, 841, 3136, 11705,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) -4*a(n-3) +a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (May 02 2018 09:23:14, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A189450.
