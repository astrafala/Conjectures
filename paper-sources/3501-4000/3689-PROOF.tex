...
\title{The empirical recurrence for OEIS A318544, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A318544 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
values of its neighbours, and carries an empirical recurrence of order $63$ contributed
...
OEIS A318544 is ``Number of nX7 0..1 arrays with every element unequal to 0, 1, 4 or 6 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
21, 26, 107, 516, 2349, 10496, 46165, 208159,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 28 2018 11:06:27, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 46\,a(n-3) + 50\,a(n-4) + 275\,a(n-5) - 43\,a(n-6) + 362\,a(n-7) - 1637\,a(n-8) - 271\,a(n-9) - 3396\,a(n-10) + 3146\,a(n-11) + 3432\,a(n-12) + 6889\,a(n-13) + 7881\,a(n-14) - 20207\,a(n-15) - 21749\,a(n-16) + 31606\,a(n-17) - 30087\,a(n-18) - 43803\,a(n-19) + 168405\,a(n-20) + 76348\,a(n-21) - 293820\,a(n-22) - 123142\,a(n-23) + 290600\,a(n-24) + 147574\,a(n-25) - 215762\,a(n-26) - 149500\,a(n-27) + 261780\,a(n-28) + 316118\,a(n-29) - 671671\,a(n-30) - 764286\,a(n-31) + 1504462\,a(n-32) + 1206660\,a(n-33) - 2414304\,a(n-34) - 1168911\,a(n-35) + 2765306\,a(n-36) + 641957\,a(n-37) - 2226787\,a(n-38) - 174104\,a(n-39) + 1245814\,a(n-40) + 84501\,a(n-41) - 498990\,a(n-42) - 153476\,a(n-43) + 165047\,a(n-44) + 149749\,a(n-45) - 57567\,a(n-46) - 84000\,a(n-47) + 18254\,a(n-48) + 31251\,a(n-49) - 1064\,a(n-50) - 8936\,a(n-51) - 2803\,a(n-52) + 2260\,a(n-53) + 1619\,a(n-54) - 469\,a(n-55) - 485\,a(n-56) + 34\,a(n-57) + 95\,a(n-58) + 23\,a(n-59) - 11\,a(n-60) - 8\,a(n-61) + a(n-63)
\end{equation}
for all $n>64$.
...
\#\{\text{neighbours with a value }different from\ x_{t,u}\}\in\{0,1,4,6\}
\end{equation}
...
and $7$ cells in a row, so $|V|=2^{7}=128$, and the vertex set is
...
publishes, $n=22$, the arrays have $7\cdot22$ cells over
$2$ values, so there are about $10^{46}$ of them to sift. The
walk count replaces that by $16384$ states and one matrix--vector product per row.
...
$o=1n_0+0-2$. Then for $j\ge63$,
\[
a(n_0+j)-\sum_i c_i\,a(n_0+j-i)\;=\;\,\mathbf{v}^{\!\top}G^{\,j-63}w,
\qquad w=h_{63}-\sum_i c_i\,h_{63-i} .
\]
...
\begin{proof}
Substitute Lemma~\ref{lem:walk} and factor $G^{j-63}$ out of
...
the middle row. The vector $w$ was formed by $63$ applications of $G$ in exact integer
...
every one of the $22$ published indices, with no shift fitted: the number of rows is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A318544.
