...
\title{The empirical recurrence for OEIS A254236, proved by transfer matrix}
...
\begin{abstract}
OEIS A254236 counts the arrays over $\{0,\dots,1\}$ whose $3\times3$ subblocks carry a
...
OEIS A254236 is ``Number of (n+2)X(2+2) 0..1 arrays with every 3X3 subblock diagonal sum plus antidiagonal minimum nondecreasing horizontally and vertically.''. It has offset $1$ and begins
\[
2616, 9209, 38392, 167637, 637570, 2228050, 7570126, 24603175,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 14:34:08, revision 10) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A254236.
