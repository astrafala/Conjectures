...
\title{A condition on each element and its neighbours: OEIS A240652}
...
\begin{abstract}
OEIS A240652 carries an empirical recurrence of order $50$ contributed by R.~H.~Hardin. It is
...
OEIS A240652 is ``Number of nX4 0..1 arrays with no element equal to exactly one horizontal or vertical neighbor, with new values 0..1 introduced in row major order.''. It has offset $1$ and begins
\[
1, 3, 17, 91, 352, 1545, 7154, 33269,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 11:05:21, revision 6) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{The count is a walk count}

The entry counts arrays with $4$ columns over the alphabet $\{0,1\}$, growing one row at a time. Its condition is that no element may equal exactly $1$ of its horizontal and vertical neighbours.
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) - 5\,a(n-2) + 2\,a(n-3) - 17\,a(n-4) - 64\,a(n-5) - 92\,a(n-6) + 24\,a(n-7) + 159\,a(n-8) + 803\,a(n-9) + 1491\,a(n-10) + 1970\,a(n-11) + 1678\,a(n-12) - 661\,a(n-13) - 5546\,a(n-14) - 11953\,a(n-15) - 18840\,a(n-16) - 20162\,a(n-17) - 13954\,a(n-18) + 3124\,a(n-19) + 29982\,a(n-20) + 57408\,a(n-21) + 71870\,a(n-22) + 67778\,a(n-23) + 36825\,a(n-24) - 12790\,a(n-25) - 63687\,a(n-26) - 92941\,a(n-27) - 91422\,a(n-28) - 61244\,a(n-29) - 12245\,a(n-30) + 25219\,a(n-31) + 41068\,a(n-32) + 34422\,a(n-33) + 19986\,a(n-34) + 4392\,a(n-35) - 450\,a(n-36) + 906\,a(n-37) + 3453\,a(n-38) + 4580\,a(n-39) + 4351\,a(n-40) + 1645\,a(n-41) - 1495\,a(n-42) - 2735\,a(n-43) - 2047\,a(n-44) - 913\,a(n-45) - 160\,a(n-46) + 116\,a(n-47) + 114\,a(n-48) + 44\,a(n-49) + 8\,a(n-50)
\]
for every $n>50$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A240652.
