...
\title{The empirical recurrence for OEIS A252620, proved by transfer matrix}
...
\begin{abstract}
OEIS A252620 counts $7\times(n+2)$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
$a(n)$ is a walk count on $S=1556630$ vertices. Such a sequence is $C$-finite, so whether a given
...
OEIS A252620 is ``Number of (5+2)X(n+2) 0..3 arrays with every 3X3 subblock row and diagonal sum equal to 0 3 5 6 or 8 and every 3X3 column and antidiagonal sum not equal to 0 3 5 6 or 8.''. It has offset $1$ and begins
\[
3022, 14435, 51614, 174803, 814008, 3108884, 11582748, 52469568,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:27:41, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;153\,a(n-3) - 8712\,a(n-6) + 255212\,a(n-9) - 4508492\,a(n-12) + 53093559\,a(n-15) - 446651987\,a(n-18) + 2811069562\,a(n-21) - 13591870478\,a(n-24) + 51098703404\,a(n-27) - 149793570874\,a(n-30) + 341702575498\,a(n-33) - 604381946186\,a(n-36) + 825959886406\,a(n-39) - 869742332060\,a(n-42) + 704603552412\,a(n-45) - 438817036584\,a(n-48) + 209303150240\,a(n-51) - 75464022512\,a(n-54) + 20062951584\,a(n-57) - 3814166304\,a(n-60) + 501537088\,a(n-63) - 42523840\,a(n-66) + 1893632\,a(n-69) - 30720\,a(n-72)
\]
for every $n>75$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252620.
