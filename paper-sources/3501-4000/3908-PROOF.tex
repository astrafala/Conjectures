...
\title{The empirical recurrence for OEIS A302810, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A302810 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A302810 is ``Number of 4Xn 0..1 arrays with every element equal to 0, 1, 2, 3 or 5 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
8, 128, 1010, 8718, 74072, 632004, 5396562, 46048956,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 13 2018 13:10:42, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) + 44\,a(n-2) - 54\,a(n-3) - 583\,a(n-4) - 134\,a(n-5) + 3745\,a(n-6) + 2342\,a(n-7) - 19086\,a(n-8) + 5167\,a(n-9) + 100950\,a(n-10) - 95590\,a(n-11) - 330420\,a(n-12) + 300448\,a(n-13) + 120445\,a(n-14) - 580497\,a(n-15) + 1847741\,a(n-16) + 1018090\,a(n-17) - 2871691\,a(n-18) + 1232729\,a(n-19) + 625362\,a(n-20) - 3517102\,a(n-21) - 369126\,a(n-22) - 7215641\,a(n-23) - 3856188\,a(n-24) + 18527258\,a(n-25) + 6990579\,a(n-26) - 24990486\,a(n-27) - 20336354\,a(n-28) + 6888853\,a(n-29) + 27407575\,a(n-30) + 46764683\,a(n-31) + 36690912\,a(n-32) - 29995623\,a(n-33) - 69788022\,a(n-34) - 21863393\,a(n-35) + 29321349\,a(n-36) + 23774779\,a(n-37) + 604618\,a(n-38) - 5816484\,a(n-39) - 2546547\,a(n-40) - 146625\,a(n-41) + 258463\,a(n-42) + 164010\,a(n-43) + 39355\,a(n-44) - 1983\,a(n-45) - 922\,a(n-46) - 480\,a(n-47) - 54\,a(n-48)
\end{equation}
for all $n>50$.
...
\#\{\text{neighbours with a value }equal to\ x_{t,u}\}\in\{0,1,2,3,5\}
\end{equation}
...
publishes, $n=19$, the arrays have $4\cdot19$ cells over
...
the middle column. The vector $w$ was formed by $48$ applications of $G$ in exact integer
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302810.
