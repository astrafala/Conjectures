...
\title{The empirical recurrence for OEIS A207272, proved by transfer matrix}
...
\begin{abstract}
OEIS A207272 counts arrays over $\{0,\dots,1\}$ of width $5$ that avoid the patterns
...
OEIS A207272 is ``Number of 5Xn 0..1 arrays avoiding 0 0 0 and 0 1 1 horizontally and 0 1 1 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
14, 196, 488, 1910, 5904, 14184, 38911,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 13:42:43, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207272.
