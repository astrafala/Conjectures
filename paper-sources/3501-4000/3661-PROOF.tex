...
\title{The empirical recurrence for OEIS A202643, proved by transfer matrix}
...
\begin{abstract}
OEIS A202643 counts arrays of width $6$ over $\{0,1\}$ containing no occurrence of certain short
...
OEIS A202643 is ``Number of (n+2)X6 binary arrays avoiding patterns 000 and 111 in rows, columns and nw-to-se diagonals.''. It has offset $1$ and begins
\[
1278, 5948, 31560, 171362, 923788, 5002208, 27264078, 148104786,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 09:46:29, revision 9) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A202643.
