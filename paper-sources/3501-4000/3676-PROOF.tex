...
\title{The empirical recurrence for OEIS A295940, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A295940 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A295940 is ``Number of nX5 0..1 arrays with each 1 adjacent to 1 or 3 king-move neighboring 1s.''. It has offset $1$ and begins
\[
6, 104, 465, 2976, 29081, 187960, 1311947, 10551008,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 30 2017 06:23:25, revision 4) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A295940.
