...
\title{The empirical recurrence for OEIS A304131, proved by transfer matrix}
...
\begin{abstract}
OEIS A304131 counts $6$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $different from$ itself lying in $\{0,1,3,6\}$, and it carries an empirical
...
OEIS A304131 is ``Number of n X 6 0..1 arrays with every element unequal to 0, 1, 3 or 6 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
13, 49, 53, 140, 320, 651, 1321, 2673,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 01 2021 17:30:41, revision
7) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;19\,a(n-3) + 6\,a(n-4) + 9\,a(n-5) - 153\,a(n-6) - 90\,a(n-7) - 157\,a(n-8) + 652\,a(n-9) + 559\,a(n-10) + 1181\,a(n-11) - 1404\,a(n-12) - 1792\,a(n-13) - 5054\,a(n-14) + 300\,a(n-15) + 2686\,a(n-16) + 13604\,a(n-17) + 7007\,a(n-18) + 884\,a(n-19) - 23893\,a(n-20) - 21475\,a(n-21) - 12130\,a(n-22) + 27170\,a(n-23) + 34384\,a(n-24) + 25529\,a(n-25) - 18535\,a(n-26) - 34229\,a(n-27) - 29564\,a(n-28) + 5242\,a(n-29) + 21519\,a(n-30) + 21219\,a(n-31) + 2161\,a(n-32) - 7919\,a(n-33) - 9483\,a(n-34) - 2452\,a(n-35) + 1164\,a(n-36) + 2492\,a(n-37) + 820\,a(n-38) + 248\,a(n-39) - 332\,a(n-40) - 96\,a(n-41) - 128\,a(n-42) + 16\,a(n-43) + 16\,a(n-45)
\end{equation}
for all $n>48$.
...
has score in $\{0,1,3,6\}$. The entry also fixes the top-left entry to be $0$; that is a condition on the first row alone, so it restricts the start vector and nothing else.
...
\begin{itemize}
\item $\mathbf{s}(r,s)=1$ when every cell of $r$ has score in $\{0,1,3,6\}$ \emph{with no row
above $r$} and $r_1=0$, and $0$ otherwise;
\item an edge $(r,s)\to(s,t)$ when every cell of $s$ has score in $\{0,1,3,6\}$ computed from
$r$, $s$ and $t$;
\item $\mathbf{e}(r,s)=1$ when every cell of $s$ has score in $\{0,1,3,6\}$ \emph{with no row
...
exactly when every one of its $n$ rows has all scores in $\{0,1,3,6\}$. Read the sequence as the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A304131.
