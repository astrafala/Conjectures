...
\title{The empirical recurrence for OEIS A297911, proved by transfer matrix}
...
\begin{abstract}
OEIS A297911 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $equal to$ itself lying in $\{0,2,3,4\}$, and it carries an empirical
...
OEIS A297911 is ``Number of nX4 0..1 arrays with every element equal to 0, 2, 3 or 4 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 37, 49, 268, 1281, 6044, 35788, 202419,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 08 2018 07:39:49, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) + 17\,a(n-2) + 8\,a(n-3) - 175\,a(n-4) - 444\,a(n-5) - 49\,a(n-6) + 2374\,a(n-7) + 5089\,a(n-8) - 767\,a(n-9) - 16094\,a(n-10) - 17688\,a(n-11) + 11930\,a(n-12) + 42137\,a(n-13) + 7116\,a(n-14) - 54064\,a(n-15) - 11042\,a(n-16) + 70736\,a(n-17) + 19957\,a(n-18) - 121239\,a(n-19) - 35346\,a(n-20) + 121686\,a(n-21) + 48545\,a(n-22) + 127703\,a(n-23) + 97831\,a(n-24) - 51313\,a(n-25) - 210204\,a(n-26) - 282230\,a(n-27) + 192823\,a(n-28) + 682034\,a(n-29) + 527451\,a(n-30) - 351619\,a(n-31) - 854102\,a(n-32) - 607231\,a(n-33) + 195221\,a(n-34) + 221981\,a(n-35) + 185987\,a(n-36) + 57479\,a(n-37) - 182348\,a(n-38) - 52811\,a(n-39) - 24298\,a(n-40) + 21989\,a(n-41) + 15590\,a(n-42) + 6759\,a(n-43) - 1730\,a(n-44) - 614\,a(n-45) - 1316\,a(n-46) - 70\,a(n-47) + 264\,a(n-48) - 24\,a(n-49) - 8\,a(n-50)
\end{equation}
for all $n>53$.
...
\begin{theorem}
The recurrence \eqref{eq:conj} holds for every $n>53$. This is the statement of
Section~1.
\end{theorem}
...
They vanish from the index corresponding to $n=53+1$ onwards, and the run was continued
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297911.
