...
\title{The empirical recurrence for OEIS A254562, proved by transfer matrix}
...
\begin{abstract}
OEIS A254562 counts the arrays over $\{0,\dots,1\}$ whose $3\times3$ subblocks carry a
...
so the count is a walk count on $S=1484$ states --- the last two array rows together with the
...
OEIS A254562 is ``Number of (n+2)X(2+2) 0..1 arrays with every 3X3 subblock sum of the four sums of the central row, central column, diagonal and antidiagonal nondecreasing horizontally and vertically.''. It has offset $1$ and begins
\[
2384, 10870, 54212, 183210, 536906, 1612832, 4205934, 10525070,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 14:49:36, revision 7) this is still
...
\]
on the $S=1484$ reachable states. In particular $a$ is $C$-finite. The alignment of the walk
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-1) - 20\,a(n-2) + 41\,a(n-3) - 105\,a(n-4) + 246\,a(n-5) - 414\,a(n-6) + 708\,a(n-7) - 1371\,a(n-8) + 2105\,a(n-9) - 2834\,a(n-10) + 4537\,a(n-11) - 6526\,a(n-12) + 7449\,a(n-13) - 9750\,a(n-14) + 13221\,a(n-15) - 13299\,a(n-16) + 13728\,a(n-17) - 17446\,a(n-18) + 15730\,a(n-19) - 11297\,a(n-20) + 13013\,a(n-21) - 10296\,a(n-22) + 1287\,a(n-23) - 1287\,a(n-25) + 10296\,a(n-26) - 13013\,a(n-27) + 11297\,a(n-28) - 15730\,a(n-29) + 17446\,a(n-30) - 13728\,a(n-31) + 13299\,a(n-32) - 13221\,a(n-33) + 9750\,a(n-34) - 7449\,a(n-35) + 6526\,a(n-36) - 4537\,a(n-37) + 2834\,a(n-38) - 2105\,a(n-39) + 1371\,a(n-40) - 708\,a(n-41) + 414\,a(n-42) - 246\,a(n-43) + 105\,a(n-44) - 41\,a(n-45) + 20\,a(n-46) - 7\,a(n-47) + a(n-48)
\]
for every $n>56$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A254562.
