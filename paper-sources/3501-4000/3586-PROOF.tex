...
\title{The empirical recurrence for OEIS A252327, proved by transfer matrix}
...
\begin{abstract}
OEIS A252327 counts $(n+2)\times3$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252327 is ``Number of (n+2)X(1+2) 0..3 arrays with every 3X3 subblock row and column sum equal to 0 3 5 6 or 8 and every 3X3 diagonal and antidiagonal sum not equal to 0 3 5 6 or 8.''. It has offset $1$ and begins
\[
2018, 4006, 6089, 10227, 20782, 39981, 72899, 153357,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:05:36, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;22\,a(n-3) - 191\,a(n-6) + 8\,a(n-7) + 4\,a(n-8) + 867\,a(n-9) - 115\,a(n-10) - 49\,a(n-11) - 2338\,a(n-12) + 614\,a(n-13) + 210\,a(n-14) + 3930\,a(n-15) - 1747\,a(n-16) - 426\,a(n-17) - 3833\,a(n-18) + 3086\,a(n-19) + 168\,a(n-20) + 730\,a(n-21) - 3642\,a(n-22) + 1755\,a(n-23) + 4220\,a(n-24) + 2727\,a(n-25) - 6202\,a(n-26) - 7619\,a(n-27) - 197\,a(n-28) + 11823\,a(n-29) + 6982\,a(n-30) - 3483\,a(n-31) - 15210\,a(n-32) - 3451\,a(n-33) + 6506\,a(n-34) + 13540\,a(n-35) + 382\,a(n-36) - 7104\,a(n-37) - 8304\,a(n-38) + 255\,a(n-39) + 5692\,a(n-40) + 3867\,a(n-41) + 646\,a(n-42) - 3687\,a(n-43) - 2086\,a(n-44) - 1221\,a(n-45) + 2079\,a(n-46) + 1546\,a(n-47) + 830\,a(n-48) - 1119\,a(n-49) - 864\,a(n-50) + 49\,a(n-51) + 516\,a(n-52) + 348\,a(n-53) - 505\,a(n-54) - 154\,a(n-55) - 156\,a(n-56) + 294\,a(n-57) + 4\,a(n-58) + 44\,a(n-59) - 48\,a(n-60) + 16\,a(n-61) - 8\,a(n-62)
\]
for every $n>73$.
\end{theorem}
...
exactly. Those integers vanish from the index corresponding to $n=73+1$ onwards, and the
run was continued until the working vector was identically zero, which settles all larger $j$
at once. By Lemma~\ref{lem:crit} the recurrence holds for every $n>73$.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252327.
