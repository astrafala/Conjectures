...
\title{The empirical recurrence for OEIS A275502, proved by counting patterns}
...
\begin{abstract}
OEIS A275502 counts arrays in which no entry may repeat a value found at any of three stated
...
OEIS A275502 is ``Number of nX6 0..2 arrays with no element equal to any value at offset (-2,-1) (-2,0) or (-1,-1) and new values introduced in order 0..2.''. It has offset $1$ and begins
\[
122, 11664, 10000, 15296, 17712, 68080, 268152, 1063756,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 30 2016 19:58:39, revision 4) the statement is
...
index corresponding to $n=68+1$ onwards, and the run continued until $S+1$ consecutive
zeros had been seen.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A275502.
