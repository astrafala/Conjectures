...
\title{The empirical recurrence for OEIS A316379, proved by transfer matrix}
...
\begin{abstract}
OEIS A316379 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $different from$ itself lying in $\{1,2,3,4,6,8\}$, and it carries an empirical
...
OEIS A316379 is ``Number of nX4 0..1 arrays with every element unequal to 1, 2, 3, 4, 6 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
2, 86, 464, 3909, 29877, 228485, 1755475, 13526926,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 30 2018 19:16:17, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) + 20\,a(n-2) + 48\,a(n-3) - 228\,a(n-4) - 749\,a(n-5) - 337\,a(n-6) + 42\,a(n-7) + 3576\,a(n-8) + 11148\,a(n-9) + 24999\,a(n-10) + 13867\,a(n-11) - 43655\,a(n-12) - 75724\,a(n-13) - 162509\,a(n-14) - 162802\,a(n-15) + 25775\,a(n-16) + 175237\,a(n-17) + 515244\,a(n-18) + 991244\,a(n-19) - 2078283\,a(n-20) - 3308327\,a(n-21) - 1197780\,a(n-22) + 3576764\,a(n-23) + 8047205\,a(n-24) - 1483094\,a(n-25) - 3422152\,a(n-26) - 3634592\,a(n-27) - 6505616\,a(n-28) + 5506602\,a(n-29) - 1051835\,a(n-30) + 9547248\,a(n-31) + 670104\,a(n-32) - 3020771\,a(n-33) + 863818\,a(n-34) - 2608844\,a(n-35) - 786793\,a(n-36) + 1268466\,a(n-37) - 922393\,a(n-38) + 423451\,a(n-39) + 44439\,a(n-40) - 238610\,a(n-41) + 185616\,a(n-42) - 87520\,a(n-43) + 24217\,a(n-44) + 1501\,a(n-45) - 3713\,a(n-46) + 1444\,a(n-47) - 308\,a(n-48) - 6\,a(n-49) - 4\,a(n-50)
\end{equation}
for all $n>51$.
...
has score in $\{1,2,3,4,6,8\}$. The entry also fixes the top-left entry to be $0$; that is a condition on the first row alone, so it restricts the start vector and nothing else.
...
\begin{itemize}
\item $\mathbf{s}(r,s)=1$ when every cell of $r$ has score in $\{1,2,3,4,6,8\}$ \emph{with no row
above $r$} and $r_1=0$, and $0$ otherwise;
\item an edge $(r,s)\to(s,t)$ when every cell of $s$ has score in $\{1,2,3,4,6,8\}$ computed from
$r$, $s$ and $t$;
\item $\mathbf{e}(r,s)=1$ when every cell of $s$ has score in $\{1,2,3,4,6,8\}$ \emph{with no row
...
exactly when every one of its $n$ rows has all scores in $\{1,2,3,4,6,8\}$. Read the sequence as the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A316379.
