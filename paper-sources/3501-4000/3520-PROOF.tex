...
\title{The empirical recurrence for OEIS A188519, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A188519 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A188519 is ``Number of nX5 binary arrays without the pattern 1 1 0 diagonally, vertically or horizontally.''. It has offset $1$ and begins
\[
20, 400, 4143, 40230, 342240, 2800798, 22015314, 169875850,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 04:29:37, revision 9) the statement is
...
the middle row. The vector $w$ was formed by $71$ applications of $G$ in exact integer
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A188519.
