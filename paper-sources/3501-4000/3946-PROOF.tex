...
\title{The empirical recurrence for OEIS A297752, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297752 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A297752 is ``Number of 4Xn 0..1 arrays with every 1 horizontally, diagonally or antidiagonally adjacent to 1, 3 or 4 neighboring 1s.''. It has offset $1$ and begins
\[
1, 24, 230, 852, 3780, 28540, 187564, 1003470,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 05 2018 16:03:09, revision 4) the statement is
...
x_{t,u}=1\ \Rightarrow\ \#\{\text{neighbours equal to }1\}\in\{1,3,4\}
\end{equation}
for every cell $(t,u)$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297752.
