...
\title{The empirical recurrence for OEIS A302510, proved by transfer matrix}
...
\begin{abstract}
OEIS A302510 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A302510 is ``Number of n X 3 0..1 arrays with every element equal to 0, 1, 4 or 5 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
3, 3, 11, 9, 14, 21, 28, 37,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +a(n-4) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 07 2020 12:36:51, revision
...
compared against the entry's DATA at every one of the $41$ published indices; they
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302510.
