...
\title{The empirical recurrence for OEIS A208642, derived from the entry's generating function}
...
\begin{abstract}
OEIS A208642 carries an empirical recurrence of order $7$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 05 2018 13:55:01, revision 9) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{16 x^{11} + 8 x^{10} - 78 x^{9} - 77 x^{8} + 144 x^{7} + 378 x^{6} - 428 x^{5} - 402 x^{4} + 600 x^{3} - 98 x^{2} - 64 x}{2 x^{7} - 13 x^{6} + 36 x^{5} - 55 x^{4} + 50 x^{3} - 27 x^{2} + 8 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 16 x^{11} - 8 x^{10} + 78 x^{9} + 77 x^{8} - 144 x^{7} - 378 x^{6} + 428 x^{5} + 402 x^{4} - 600 x^{3} + 98 x^{2} + 64 x,
\]
