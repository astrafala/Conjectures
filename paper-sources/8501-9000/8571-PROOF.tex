...
\begin{quote}\small
Conjecture D-finite with recurrence a(n) +(-3*n+8)*a(n-1) +(n-3)*(3*n-14)*a(n-2) +(-n\textasciicircum{}3+19*n\textasciicircum{}2- 98*n+156)*a(n-3) +(-4*n\textasciicircum{}3+56*n\textasciicircum{}2-258*n+395)*a(n-4) +(-6*n\textasciicircum{}3+84*n\textasciicircum{}2-395*n+624)*a(n- 5) -(n-5)*(4*n\textasciicircum{}2-41*n+106)*a(n-6) -(n-5)*(n-6)\textasciicircum{}2*a(n-7)=0.
\end{quote}
...
vanish, for all 14 values of $n$ from $n=9$ upward. This is what
