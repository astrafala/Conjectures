...
\title{A condition on the multiset of every subblock: OEIS A183616}
...
\begin{abstract}
OEIS A183616 carries an empirical recurrence of order $4$ contributed by R.~H.~Hardin. It is
...
on $S=5$ vertices and is $C$-finite, and whether the conjectured recurrence annihilates it
...
OEIS A183616 is ``1/120 the number of (n+1) X 4 0..4 arrays with every 2 X 2 subblock containing four distinct values.''. It has offset $1$ and begins
\[
36, 528, 7792, 115760, 1724208, 25713200, 383674672, 5726373936,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 21*a(n-1) - 84*a(n-2) - 112*a(n-3) + 192*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 31 2018 17:00:58, revision 10) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{The count is a walk count}

The entry counts arrays with $4$ columns over the alphabet $\{0,1,2,3,4\}$, growing one row at a time, and asks that every $2\times2$ subblock holds exactly $4$ distinct values.
...
\begin{theorem}
\[
a(n)\;=\;21\,a(n-1) - 84\,a(n-2) - 112\,a(n-3) + 192\,a(n-4)
\]
for every $n>4$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A183616.
