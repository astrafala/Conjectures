...
\title{The empirical recurrence for OEIS A165373, derived from the entry's generating function}
...
\begin{abstract}
OEIS A165373 carries an empirical recurrence of order $5$. The entry separately records a
...
OEIS A165373 is ``Number of slanted n X 4 (i=1..n) X (j=i..4+i-1) 1..4 arrays with all 1s connected, all 2s connected, all 3s connected, all 4s connected, 1 in the upper left corner, 2 in the upper right corner, 3 in the lower left corner, and 4 in the lower right corner.''. It has offset $2$ and begins
\[
37, 305, 1409, 4569, 11449, 24225, 45585, 78729,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 25 2018 11:41:52, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 68 x^{7} + 171 x^{6} - 204 x^{5} - 254 x^{4} - 120 x^{3} - 37 x^{2}}{x^{5} - 5 x^{4} + 10 x^{3} - 10 x^{2} + 5 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;68 x^{7} - 171 x^{6} + 204 x^{5} + 254 x^{4} + 120 x^{3} + 37 x^{2},
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A165373.
