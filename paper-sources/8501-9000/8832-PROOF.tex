...
\title{A proof of the conjectured recurrence for OEIS A081204}
...
\begin{abstract}
OEIS A081204 carries a conjectured linear recurrence with polynomial coefficients, of
...
OEIS A081204 is ``Staircase on Pascal's triangle''. It has offset $0$ and begins
\[
a(0),\dots,a(7)\;=\;1, 2, 3, 10, 15, 56, 84, 330,\ \dots
\]
...
a(n)\;=\;{\binom{n + \left\lceil{\frac{n}{2}}\right\rceil}{n}} .
\end{equation}
...
\begin{quote}\small
\textbf{Conjecture:} 8*n\^{}2*(n+1)*a(n) - 12*n*(83*n\^{}2 - 313*n + 232)*a(n-1) + 6*(-9*n\^{}3 - 377*n + 384)*a(n-2) + 9*(3*n-5)*(83*n-64)*(3*n-7)*a(n-3) = 0. - \emph{R. J. Mathar}, Nov 07 2014
\end{quote}
...
8 n^{2} \left(n + 1\right)\,a(n) -  12 n \left(83 n^{2} - 313 n + 232\right)\,a(n-1) -  6 \left(9 n^{3} + 377 n - 384\right)\,a(n-2) + 9 \left(3 n - 7\right) \left(3 n - 5\right) \left(83 n - 64\right)\,a(n-3)
\end{equation}
...
\section{The computation for A081204}
...
exact integer arithmetic at every index where it applies: $27$ instances beginning at
...
entry \href{https://oeis.org/A081204}{A081204}, 2022-09-08.
