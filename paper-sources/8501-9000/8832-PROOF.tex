...
\title{The empirical recurrence for OEIS A269284, derived from the entry's generating function}
...
\begin{abstract}
OEIS A269284 carries an empirical recurrence of order $2$. The entry separately records a
...
OEIS A269284 is ``Number of n X 3 0..3 arrays with some element plus some horizontally or antidiagonally adjacent neighbor totalling three no more than once.''. It has offset $1$ and begins
\[
60, 2124, 62748, 1698732, 43674876, 1085203980, 26317946844, 626778812268,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 21 2019 06:12:42, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 396 x^{2} + 60 x}{441 x^{2} - 42 x + 1},
\]
the entry's own generating function, and let
\[
D(x)\;=\;1-\sum_i c_i x^{i}\;=\;441 x^{2} - 42 x + 1
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269284.
