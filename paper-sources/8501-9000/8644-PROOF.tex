...
\title{The empirical recurrence for OEIS A250900, derived from the entry's generating function}
...
\begin{abstract}
OEIS A250900 carries an empirical recurrence of order $6$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 23 2018 06:06:12, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 324 x^{6} + 1392 x^{5} - 2393 x^{4} + 2015 x^{3} - 819 x^{2} + 125 x}{12 x^{6} - 52 x^{5} + 91 x^{4} - 82 x^{3} + 40 x^{2} - 10 x + 1},
\]
the entry's own generating function, and let
\[
D(x)\;=\;1-\sum_i c_i x^{i}\;=\;12 x^{6} - 52 x^{5} + 91 x^{4} - 82 x^{3} + 40 x^{2} - 10 x + 1
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 324 x^{6} + 1392 x^{5} - 2393 x^{4} + 2015 x^{3} - 819 x^{2} + 125 x,
\]
...
\[
12 x^{6} - 52 x^{5} + 91 x^{4} - 82 x^{3} + 40 x^{2} - 10 x + 1,
\]
