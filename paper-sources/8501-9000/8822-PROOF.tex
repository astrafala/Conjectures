...
\title{The empirical recurrence for OEIS A253490, derived from the entry's generating function}
...
\begin{abstract}
OEIS A253490 carries an empirical recurrence of order $3$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 15 2018 16:00:48, revision 10) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{6 x^{7} + 733 x^{6} + 442 x^{5} - 7417 x^{4} - 924 x^{3} + 5238 x^{2} - 1388 x}{6 x^{3} - 11 x^{2} + 6 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 6 x^{7} - 733 x^{6} - 442 x^{5} + 7417 x^{4} + 924 x^{3} - 5238 x^{2} + 1388 x,
\]
