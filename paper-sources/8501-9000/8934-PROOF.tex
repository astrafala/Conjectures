...
\title{The empirical recurrence for OEIS A303963, proved by transfer matrix}
...
\begin{abstract}
OEIS A303963 counts $2$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A303963 is ``Number of nX2 0..1 arrays with every element unequal to 0, 1, 3 or 5 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
2, 5, 9, 21, 53, 105, 237, 577,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +8*a(n-3) -4*a(n-4)
\end{quote}
As of the ``Last modified'' line on the live entry (May 03 2018 12:51:55, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A303963.
