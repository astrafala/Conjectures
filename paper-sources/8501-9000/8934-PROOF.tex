...
\title{The empirical recurrence for OEIS A183625, proved by transfer matrix}
...
\begin{abstract}
OEIS A183625 counts $3$-column arrays over $\{0,\dots,2\}$ in which every
...
OEIS A183625 is ``Number of (n+1) X 3 0..2 arrays with every 2 X 2 subblock summing to 4.''. It has offset $1$
and begins
\[
45, 87, 189, 447, 1125, 2967, 8109, 22767,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 6*a(n-1) - 11*a(n-2) + 6*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 31 2018 17:01:05, revision 10) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A183625.
