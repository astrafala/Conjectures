...
\title{The empirical recurrence for OEIS A253226, derived from the entry's generating function}
...
\begin{abstract}
OEIS A253226 carries an empirical recurrence of order $4$. The entry separately records a
...
OEIS A253226 is ``Number of (n+1) X (3+1) 0..1 arrays with every 2 X 2 subblock diagonal minimum minus antidiagonal minimum nondecreasing horizontally and diagonal maximum minus antidiagonal maximum nondecreasing vertically.''. It has offset $1$ and begins
\[
125, 306, 494, 914, 1709, 3241, 6231, 12122,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 10 2018 11:34:46, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{x^{8} - 3 x^{7} + 76 x^{6} - 307 x^{5} + 323 x^{4} + 89 x^{3} - 319 x^{2} + 125 x}{2 x^{4} - 7 x^{3} + 9 x^{2} - 5 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;x^{8} - 3 x^{7} + 76 x^{6} - 307 x^{5} + 323 x^{4} + 89 x^{3} - 319 x^{2} + 125 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253226.
