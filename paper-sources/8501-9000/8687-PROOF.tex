...
\title{The empirical recurrence for OEIS A299649, proved by transfer matrix}
...
\begin{abstract}
OEIS A299649 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A299649 is ``Number of nX3 0..1 arrays with every element equal to 0, 1, 2, 3, 4, 5 or 6 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
4, 32, 247, 1924, 14981, 116654, 908360, 7073213,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 7*a(n-1) +5*a(n-2) +9*a(n-3) -a(n-4) -6*a(n-5)
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 15 2018 14:38:37, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;7\,a(n-1) + 5\,a(n-2) + 9\,a(n-3) - a(n-4) - 6\,a(n-5)
\end{equation}
for all $n>5$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A299649.
