...
\title{The empirical recurrence for OEIS A295776, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A295776 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A295776 is ``Number of n X 3 0..1 arrays with each 1 adjacent to 0 or 2 king-move neighboring 1s.''. It has offset $1$ and begins
\[
5, 19, 56, 198, 665, 2213, 7479, 25105,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) + 3*a(n-2) + 6*a(n-3) - 3*a(n-4) + 2*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 22 2019 10:04:54, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 3\,a(n-2) + 6\,a(n-3) - 3\,a(n-4) + 2\,a(n-5)
\end{equation}
for all $n>6$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A295776.
