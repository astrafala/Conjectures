...
\title{The empirical recurrence for OEIS A196423, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A196423 counts arrays over $\{0,\dots,4\}$ in which every cell is constrained by the
...
OEIS A196423 is ``Number of n X 1 0..4 arrays with each element equal to the number its horizontal and vertical neighbors less than itself.''. It has offset $1$ and begins
\[
1, 3, 5, 11, 26, 55, 119, 263,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +a(n-2) +3*a(n-3) +a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 26 2024 12:34:35, revision 15) the statement is
...
$5$ values, so there are about $10^{20}$ of them to sift. The
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A196423.
