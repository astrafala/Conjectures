...
\title{The empirical recurrence for OEIS A204413, proved by transfer matrix}
...
\begin{abstract}
OEIS A204413 counts $(n+2)\times6$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A204413 is ``Number of (n+2)X6 0..2 arrays with every 3X3 subblock having three strictly increasing elements in a row horizontally or vertically, exactly one way.''. It has offset $1$ and begins
\[
2827014, 5597126, 5776350, 11785518, 89459577, 1122887052, 6016853259, 53009843553,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 577*a(n-3) for n>15
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 11:13:30, revision 9) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204413.
