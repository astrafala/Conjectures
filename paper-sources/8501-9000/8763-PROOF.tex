...
\title{The empirical recurrence for OEIS A253228, derived from the entry's generating function}
...
\begin{abstract}
OEIS A253228 carries an empirical recurrence of order $4$. The entry separately records a
...
\begin{quote}
G.f.: x*(907 - 2760*x + 997*x\^{}2 + 3624*x\^{}3 - 4009*x\^{}4 + 1208*x\^{}5 - 7*x\^{}6 + x\^{}7) / ((1 - x)\^{}3*(1 - 2*x)).
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 10 2018 12:18:47, revision 7) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{x^{8} - 7 x^{7} + 1208 x^{6} - 4009 x^{5} + 3624 x^{4} + 997 x^{3} - 2760 x^{2} + 907 x}{2 x^{4} - 7 x^{3} + 9 x^{2} - 5 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;x^{8} - 7 x^{7} + 1208 x^{6} - 4009 x^{5} + 3624 x^{4} + 997 x^{3} - 2760 x^{2} + 907 x,
\]
