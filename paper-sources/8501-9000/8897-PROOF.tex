...
\title{The empirical recurrence for OEIS A250899, derived from the entry's generating function}
...
\begin{abstract}
OEIS A250899 carries an empirical recurrence of order $5$. The entry separately records a
...
OEIS A250899 is ``Number of (1+1) X (n+1) 0..2 arrays with nondecreasing x(i,j)-x(i,j-1) in the i direction and nondecreasing absolute value of x(i,j)-x(i-1,j) in the j direction.''. It has offset $1$ and begins
\[
37, 127, 403, 1229, 3673, 10875, 32095, 94729,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 23 2018 06:06:03, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 108 x^{5} + 348 x^{4} - 407 x^{3} + 206 x^{2} - 37 x}{12 x^{5} - 40 x^{4} + 51 x^{3} - 31 x^{2} + 9 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;108 x^{5} - 348 x^{4} + 407 x^{3} - 206 x^{2} + 37 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250899.
