...
\title{The empirical recurrence for OEIS A222993, derived from the entry's generating function}
...
\begin{abstract}
OEIS A222993 carries an empirical recurrence of order $5$. The entry separately records a
...
OEIS A222993 is ``Number of n X 2 0..2 arrays with successive rows and columns fitting to straight lines with nondecreasing slope, with a single point array taken as having zero slope.''. It has offset $1$ and begins
\[
9, 50, 222, 867, 3123, 10660, 35064, 112373,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 03:20:52, revision 12) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 12 x^{5} + 40 x^{4} - 51 x^{3} + 31 x^{2} - 9 x}{12 x^{5} - 40 x^{4} + 51 x^{3} - 31 x^{2} + 9 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;12 x^{5} - 40 x^{4} + 51 x^{3} - 31 x^{2} + 9 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A222993.
