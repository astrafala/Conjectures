...
\title{The empirical recurrence for OEIS A234826, proved by transfer matrix}
...
\begin{abstract}
OEIS A234826 counts arrays of width $3$ over $\{0,1,2\}$ subject to a condition read round the
...
OEIS A234826 is ``Number of (n+1) X (2+1) 0..2 arrays with each 2 X 2 subblock having the number of clockwise edge increases less than or equal to the number of counterclockwise edge increases.''. It has offset $1$ and begins
\[
516, 9207, 161631, 2826144, 49366557, 862112943, 15054585588, 262885602843,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 23*a(n-1) - 102*a(n-2) + 93*a(n-3) - 9*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 16 2018 07:56:29, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234826.
