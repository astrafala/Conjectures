...
\title{The empirical recurrence for OEIS A228751, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A228751 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A228751 is ``Number of n X 5 binary arrays with top left element equal to 1 and no two ones adjacent horizontally or antidiagonally.''. It has offset $1$ and begins
\[
5, 50, 482, 4599, 43862, 418370, 3990739, 38067290,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 13*a(n-1) - 36*a(n-2) + 29*a(n-3) - 5*a(n-4) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 12 2018 15:08:41, revision 10) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;13\,a(n-1) - 36\,a(n-2) + 29\,a(n-3) - 5\,a(n-4)
\end{equation}
for all $n>5$.
...
walk count replaces that by $32$ states and one matrix--vector product per row.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A228751.
