...
\title{The empirical recurrence for OEIS A209953, proved by transfer matrix}
...
\begin{abstract}
OEIS A209953 counts $(n+1)\times2$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A209953 is ``Number of (n+1) X 2 0..2 arrays with every 2 X 2 subblock having one, three or four distinct clockwise edge differences.''. It has offset $1$ and begins
\[
71, 567, 4521, 36057, 287559, 2293335, 18289737, 145863801,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 6*a(n-1) + 15*a(n-2) + 6*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 14 2018 02:47:50, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) + 15\,a(n-2) + 6\,a(n-3)
\end{equation}
for all $n>2$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209953.
