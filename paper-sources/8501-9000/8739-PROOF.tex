...
\title{The empirical recurrence for OEIS A235878, derived from the entry's generating function}
...
\begin{abstract}
OEIS A235878 carries an empirical recurrence of order $3$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 19 2018 08:07:46, revision 7) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 162 x^{3} + 201 x^{2} - 51 x}{6 x^{3} - 11 x^{2} + 6 x - 1},
\]
