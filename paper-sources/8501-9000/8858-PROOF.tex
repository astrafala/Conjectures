...
\title{The empirical recurrence for OEIS A235879, derived from the entry's generating function}
...
\begin{abstract}
OEIS A235879 carries an empirical recurrence of order $3$. The entry separately records a
...
OEIS A235879 is ``Number of (n+1) X (3+1) 0..2 arrays with the minimum plus the upper median equal to the lower median plus the maximum in every 2 X 2 subblock.''. It has offset $1$ and begins
\[
129, 231, 453, 951, 2109, 4911, 11973, 30471,\ \dots
\]
...
\begin{quote}
G.f.: 3*x*(43 - 181*x + 162*x\^{}2) / ((1 - x)*(1 - 2*x)*(1 - 3*x)).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 19 2018 08:15:37, revision 7) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 486 x^{3} + 543 x^{2} - 129 x}{6 x^{3} - 11 x^{2} + 6 x - 1},
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A235879.
