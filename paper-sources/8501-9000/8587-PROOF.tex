...
\title{The empirical recurrence for OEIS A235883, derived from the entry's generating function}
...
\begin{abstract}
OEIS A235883 carries an empirical recurrence of order $3$. The entry separately records a
...
OEIS A235883 is ``Number of (n+1) X (7+1) 0..2 arrays with the minimum plus the upper median equal to the lower median plus the maximum in every 2 X 2 subblock.''. It has offset $1$ and begins
\[
7329, 8871, 11973, 18231, 30909, 56751, 109893, 220551,\ \dots
\]
...
\begin{quote}
G.f.: 3*x*(2443 - 11701*x + 13122*x\^{}2) / ((1 - x)*(1 - 2*x)*(1 - 3*x)).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 19 2018 09:28:05, revision 7) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 39366 x^{3} + 35103 x^{2} - 7329 x}{6 x^{3} - 11 x^{2} + 6 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;39366 x^{3} - 35103 x^{2} + 7329 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A235883.
