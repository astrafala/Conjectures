...
\title{The empirical recurrence for OEIS A251492, proved by transfer matrix}
...
\begin{abstract}
OEIS A251492 counts $2$-column arrays over $\{0,\dots,3\}$ in which every
...
OEIS A251492 is ``Number of (n+1) X (1+1) 0..3 arrays with every 2 X 2 subblock summing to 4 5 6 7 or 8.''. It has offset $1$
and begins
\[
186, 2270, 27844, 341718, 4194002, 51474508, 631765770, 7753896830,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 13*a(n-1) - 5*a(n-2) - 52*a(n-3) + 48*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 30 2018 10:04:57, revision 9) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251492.
