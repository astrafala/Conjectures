...
\title{The empirical recurrence for OEIS A224670, derived from the entry's generating function}
...
\begin{abstract}
OEIS A224670 carries an empirical recurrence of order $5$. The entry separately records a
...
OEIS A224670 is ``Number of (n+1) X 3 0..2 matrices with each 2 X 2 subblock idempotent.''. It has offset $1$ and begins
\[
25, 50, 76, 123, 191, 300, 470, 741,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 05:17:40, revision 9) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 21 x^{5} + 44 x^{4} + x^{3} - 50 x^{2} + 25 x}{x^{5} - 2 x^{4} - x^{3} + 5 x^{2} - 4 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 21 x^{5} + 44 x^{4} + x^{3} - 50 x^{2} + 25 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224670.
