...
\title{The empirical recurrence for OEIS A206262, derived from the entry's generating function}
...
\begin{abstract}
OEIS A206262 carries an empirical recurrence of order $6$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 15 2018 06:03:58, revision 9) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{11 x^{7} - 58 x^{6} + 102 x^{5} - 43 x^{4} - 72 x^{3} + 92 x^{2} - 34 x}{x^{6} - 4 x^{5} + 5 x^{4} - 5 x^{2} + 4 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 11 x^{7} + 58 x^{6} - 102 x^{5} + 43 x^{4} + 72 x^{3} - 92 x^{2} + 34 x,
\]
