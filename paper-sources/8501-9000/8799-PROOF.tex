...
\title{The empirical recurrence for OEIS A317513, proved by transfer matrix}
...
\begin{abstract}
OEIS A317513 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A317513 is ``Number of nX4 0..1 arrays with every element unequal to 0, 1, 2, 3, 4, 5, 6 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
8, 128, 2032, 32256, 512096, 8130048, 129072576, 2049155072,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 16*a(n-1) -6*a(n-2) +64*a(n-3)
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 30 2018 11:28:34, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A317513.
