...
\title{The empirical recurrence for OEIS A303882, proved by transfer matrix}
...
\begin{abstract}
OEIS A303882 counts $2$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A303882 is ``Number of n X 2 0..1 arrays with every element unequal to 0, 2, 3 or 4 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 4, 8, 24, 82, 272, 908, 3076,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 4*a(n-1) -2*a(n-2) +2*a(n-3) -6*a(n-4) -4*a(n-5) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 29 2023 11:48:02, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A303882.
