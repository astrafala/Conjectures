...
\title{The empirical recurrence for OEIS A202442, derived from the entry's generating function}
...
\begin{abstract}
OEIS A202442 carries an empirical recurrence of order $7$. The entry separately records a
...
OEIS A202442 is ``Number of (n+2) X 5 binary arrays avoiding patterns 001 and 110 in rows, columns and nw-to-se diagonals.''. It has offset $1$ and begins
\[
224, 376, 676, 1102, 1722, 2544, 3652, 5054,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 29 2018 03:04:06, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{30 x^{8} - 168 x^{7} + 244 x^{6} + 148 x^{5} - 570 x^{4} + 228 x^{3} + 296 x^{2} - 224 x}{x^{7} - 3 x^{6} + x^{5} + 5 x^{4} - 5 x^{3} - x^{2} + 3 x - 1},
\]
the entry's own generating function, and let
\[
D(x)\;=\;1-\sum_i c_i x^{i}\;=\;- x^{7} + 3 x^{6} - x^{5} - 5 x^{4} + 5 x^{3} + x^{2} - 3 x + 1
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 30 x^{8} + 168 x^{7} - 244 x^{6} - 148 x^{5} + 570 x^{4} - 228 x^{3} - 296 x^{2} + 224 x,
\]
...
\[
x^{7} - 3 x^{6} + x^{5} + 5 x^{4} - 5 x^{3} - x^{2} + 3 x - 1,
\]
...
compared against all $35$ terms the entry publishes: it reproduces every one. This is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A202442.
