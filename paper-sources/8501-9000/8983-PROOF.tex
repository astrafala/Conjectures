...
\title{The empirical recurrence for OEIS A165392, derived from the entry's generating function}
...
\begin{abstract}
OEIS A165392 carries an empirical recurrence of order $3$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 26 2018 19:24:02, revision 7) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{x^{8} - 5 x^{7} + 4 x^{6} + 8 x^{5} - 9 x^{4} - 6 x^{3} - x^{2}}{x^{3} - 3 x^{2} + 3 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- x^{8} + 5 x^{7} - 4 x^{6} - 8 x^{5} + 9 x^{4} + 6 x^{3} + x^{2},
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A165392.
