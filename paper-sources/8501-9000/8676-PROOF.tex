...
\title{The empirical recurrence for OEIS A229374, proved by transfer matrix}
...
\begin{abstract}
OEIS A229374 counts arrays of width $2$ over $\{0,1,2\}$ containing no occurrence of certain short
...
count is a walk count on $S=9$ states.
\end{abstract}
...
OEIS A229374 is ``Number of n X 2 0..2 arrays avoiding 11 horizontally, 22 vertically and 00 diagonally or antidiagonally.''. It has offset $1$ and begins
\[
8, 30, 126, 518, 2138, 8818, 36374, 150038,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) + a(n-2) - 2*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 14 2018 15:59:06, revision 9) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The array has $2$ cells across, with entries in $\{0,1,2\}$. An OCCURRENCE of a pattern in a
...
\text{down an antidiagonal, ne to sw} & \mathtt{00} \\
\end{array}
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A229374.
