...
\title{A local condition on an array: OEIS A222099}
...
\begin{abstract}
OEIS A222099 carries an empirical recurrence of order $5$ contributed by R.~H.~Hardin. It is
...
OEIS A222099 is ``Number of n X 3 0..5 arrays with entries increasing mod 6 by 0, 1, 2 or 3 rightwards and downwards, starting with upper left zero.''. It has offset $1$ and begins
\[
16, 530, 17694, 591476, 19776286, 661254950, 22110369320, 739304841874,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 42*a(n-1) - 302*a(n-2) + 521*a(n-3) + 114*a(n-4) - 144*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 15 2018 12:38:00, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{The count is a walk count}

The entry counts arrays with $3$ columns over the alphabet $\{0,1,2,3,4,5\}$, growing one row at a time, and asks that each step to the right and each step downwards must increase the entry by $0$, $1$, $2$ or $3$ modulo $6$, starting from $0$ in the top left.
...
Merging vertices with identical futures leaves $S=7$. An admissible array is exactly a walk, so with $M$ the adjacency matrix and $\iota,\tau$ the vectors recording which states may begin and end an array,
\[
...
\begin{theorem}
\[
a(n)\;=\;42\,a(n-1) - 302\,a(n-2) + 521\,a(n-3) + 114\,a(n-4) - 144\,a(n-5)
\]
for every $n>5$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A222099.
