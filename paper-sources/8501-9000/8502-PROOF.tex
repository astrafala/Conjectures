...
\title{The empirical recurrence for OEIS A301403, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A301403 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A301403 is ``Number of nX4 0..1 arrays with every element equal to 0, 1, 2, 3, 4 or 5 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
8, 128, 1988, 31012, 483600, 7541492, 117605364, 1833990416,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 13*a(n-1) +40*a(n-2) +9*a(n-3) -29*a(n-4) +4*a(n-5)
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 20 2018 11:08:29, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;13\,a(n-1) + 40\,a(n-2) + 9\,a(n-3) - 29\,a(n-4) + 4\,a(n-5)
\end{equation}
for all $n>6$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A301403.
