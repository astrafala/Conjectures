...
\title{The empirical recurrence for OEIS A222777, derived from the entry's generating function}
...
\begin{abstract}
OEIS A222777 carries an empirical recurrence of order $4$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 16 2018 08:58:56, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{660 x^{6} - 1779 x^{5} - 667 x^{4} + 559 x^{3} - 71 x^{2} + 2 x}{900 x^{4} - 1261 x^{3} + 399 x^{2} - 39 x + 1},
\]
the entry's own generating function, and let
\[
D(x)\;=\;1-\sum_i c_i x^{i}\;=\;900 x^{4} - 1261 x^{3} + 399 x^{2} - 39 x + 1
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;660 x^{6} - 1779 x^{5} - 667 x^{4} + 559 x^{3} - 71 x^{2} + 2 x,
\]
...
\[
900 x^{4} - 1261 x^{3} + 399 x^{2} - 39 x + 1,
\]
