...
\title{The empirical recurrence for OEIS A209729, proved by transfer matrix}
...
\begin{abstract}
OEIS A209729 counts $(n+1)\times2$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A209729 is ``1/4 the number of (n+1) X 2 0..3 arrays with every 2 X 2 subblock having distinct edge sums.''. It has offset $1$ and begins
\[
22, 124, 696, 3912, 21976, 123480, 693752, 3897880,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) + 14*a(n-2) + 4*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 12 2018 20:26:34, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 14\,a(n-2) + 4\,a(n-3)
\end{equation}
for all $n>2$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209729.
