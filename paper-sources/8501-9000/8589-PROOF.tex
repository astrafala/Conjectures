...
\title{The empirical recurrence for OEIS A232336, proved by transfer matrix}
...
\begin{abstract}
OEIS A232336 counts arrays of width $2$ over $\{0,1,2\}$ in which every cell carrying one stated
...
OEIS A232336 is ``Number of 2 X n 0..2 arrays with every 0 next to a 1 and every 1 next to a 2 horizontally or antidiagonally, with no adjacent elements equal.''. It has offset $1$ and begins
\[
1, 6, 18, 32, 82, 162, 388, 806,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + 3*a(n-2) - a(n-3) + a(n-4) - a(n-5) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 04 2018 11:51:54, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 3\,a(n-2) - a(n-3) + a(n-4) - a(n-5)
\]
for every $n>6$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232336.
