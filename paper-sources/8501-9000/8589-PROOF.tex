...
\title{A proof of the conjectured recurrence for OEIS A026026}
...
\begin{abstract}
OEIS A026026 carries a conjectured linear recurrence with polynomial coefficients, of
...
OEIS A026026 is ``a(n) = number of (s(0), s(1), ..., s(2*n-1)) such that s(i) is a nonnegative integer and |s(i) - s(i-1)| = 1 for i = 1,2,...,n, s(0) = 3, s(2*n-1) = 4. Also a(n) = T(2*n-1,n-1), where T is defined in A026022''. It has offset $2$ and begins
\[
a(2),\dots,a(9)\;=\;1, 3, 10, 35, 125, 451, 1638, 5980,\ \dots
\]
The entry states, not as a conjecture,
\begin{quote}\small
a(n) = binomial(2*n-3, n-2) - binomial(2*n-3, n-6). - \emph{Christian Krause}, May 09 2026
\end{quote}
that is,
\begin{equation}\label{eq:cf}
a(n)\;=\;- {\binom{2 n - 3}{n - 6}} + {\binom{2 n - 3}{n - 2}} .
\end{equation}
...
\begin{quote}\small
\textbf{Conjecture:} -(n+3)*(11*n-38)*a(n) +2*(35*n\^{}2-86*n-102)*a(n-1) -4*(13*n-30)*(2*n-5)*a(n-2)=0. - \emph{R. J. Mathar}, Jun 22 2013
\end{quote}
As of the ``Last modified'' line on the live entry (2026-05-14, revision 27) the
...
- \left(n + 3\right) \left(11 n - 38\right)\,a(n) + 2 \left(35 n^{2} - 86 n - 102\right)\,a(n-1) -  4 \left(2 n - 5\right) \left(13 n - 30\right)\,a(n-2)
\end{equation}
...
\section{The computation for A026026}
...
entry \href{https://oeis.org/A026026}{A026026}, 2026-05-14.
