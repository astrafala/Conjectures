...
\title{The empirical recurrence for OEIS A233196, derived from the entry's generating function}
...
\begin{abstract}
OEIS A233196 carries an empirical recurrence of order $2$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 21 2026 00:07:24, revision 12) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{40 x^{3} - 17 x^{2} + x}{64 x^{2} - 20 x + 1},
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A233196.
