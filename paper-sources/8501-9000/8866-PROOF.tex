...
\title{The empirical recurrence for OEIS A234116, proved by transfer matrix}
...
\begin{abstract}
OEIS A234116 counts $(n+1)\times3$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A234116 is ``Number of (n+1) X (2+1) 0..2 arrays with every 2 X 2 subblock having the absolute values of all six edge and diagonal differences no larger than 1.''. It has offset $1$ and begins
\[
145, 1361, 12593, 116801, 1082977, 10041953, 93113761, 863396401,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 10*a(n-1) - 4*a(n-2) - 26*a(n-3) + 5*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 12 2018 15:32:10, revision 7) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234116.
