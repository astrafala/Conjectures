...
\title{The empirical recurrence for OEIS A186133, proved by transfer matrix}
...
\begin{abstract}
OEIS A186133 counts arrays over $\{0,\dots,2\}$ under a condition on the trace of every
...
OEIS A186133 is ``Number of (n+1) X 2 0..2 arrays with no 2 X 2 subblock trace equal to any horizontal or vertical neighbor 2 X 2 subblock trace.''. It has offset $1$ and begins
\[
81, 558, 3888, 27000, 187704, 1304424, 9066168, 63009576,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) + 24*a(n-2) + 24*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 28 2018 08:34:09, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A186133.
