...
\title{The empirical recurrence for OEIS A224673, derived from the entry's generating function}
...
\begin{abstract}
OEIS A224673 carries an empirical recurrence of order $5$. The entry separately records a
...
OEIS A224673 is ``Number of (n+1) X 6 0..2 matrices with each 2 X 2 subblock idempotent.''. It has offset $1$ and begins
\[
115, 191, 257, 381, 542, 793, 1166, 1746,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 05:17:45, revision 12) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{6 x^{6} - 118 x^{5} + 193 x^{4} + 68 x^{3} - 269 x^{2} + 115 x}{x^{5} - 2 x^{4} - x^{3} + 5 x^{2} - 4 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;6 x^{6} - 118 x^{5} + 193 x^{4} + 68 x^{3} - 269 x^{2} + 115 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224673.
