...
\title{The empirical recurrence for OEIS A197092, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A197092 counts arrays over $\{0,\dots,4\}$ in which every cell is constrained by the
...
OEIS A197092 is ``Number of n X 2 0..4 arrays with each element x equal to the number its horizontal and vertical neighbors equal to 4,4,0,0,1 for x=0,1,2,3,4.''. It has offset $1$ and begins
\[
1, 7, 18, 55, 163, 484, 1439, 4275,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) +3*a(n-2) -a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (May 11 2018 09:56:42, revision 9) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A197092.
