...
\title{The empirical recurrence for OEIS A237028, proved by transfer matrix}
...
\begin{abstract}
OEIS A237028 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
The condition is local to two consecutive rows, so the count is a walk count on $S=14$
...
OEIS A237028 is ``Number of (n+1) X (1+1) 0..2 arrays with the maximum of every 2 X 2 subblock equal.''. It has offset $1$ and begins
\[
81, 563, 4042, 30045, 225731, 1709398, 12985257, 98824835,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 9*a(n-1) - 83*a(n-3) + 15*a(n-4) + 60*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 21 2018 12:08:24, revision 7) this is still
...
array, which is not among the objects counted. There are $S=14$ states left.
...
\begin{theorem}
\[
a(n)\;=\;9\,a(n-1) - 83\,a(n-3) + 15\,a(n-4) + 60\,a(n-5)
\]
for every $n>4$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237028.
