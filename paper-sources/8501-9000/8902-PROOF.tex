...
\begin{quote}\small
\textbf{Conjecture:} -(n+1)*(n-2)*a(n) +2*(n-1)*a(n-1) +(5*n-3)*(n-2)*a(n-2) +2*(-n+1)*a(n-3) -4*(n-1)*(n-2)*a(n-4)=0. - \emph{R. J. Mathar}, Jun 14 2016
\end{quote}
...
\[
p_{0}(n)=- \left(n - 2\right) \left(n + 1\right),\qquad p_{1}(n)=2 \left(n - 1\right),\qquad p_{2}(n)=\left(n - 2\right) \left(5 n - 3\right),\qquad p_{3}(n)=- 2 \left(n - 1\right),\qquad p_{4}(n)=- 4 \left(n - 2\right) \left(n - 1\right)
\]
...
\[
- \left(n - 2\right) \left(n + 1\right)\,a(n) + 2 \left(n - 1\right)\,a(n-1) + \left(n - 2\right) \left(5 n - 3\right)\,a(n-2) -  2 \left(n - 1\right)\,a(n-3) -  4 \left(n - 2\right) \left(n - 1\right)\,a(n-4) \;=\;0
\]
holds for every $n>-1$.
\end{theorem}
