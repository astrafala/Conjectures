...
\title{The empirical recurrence for OEIS A251403, proved by transfer matrix}
...
\begin{abstract}
OEIS A251403 counts $(n+1)\times2$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A251403 is ``Number of (n+1) X (1+1) 0..2 arrays with every 2 X 2 subblock summing to a prime.''. It has offset $1$ and begins
\[
46, 238, 1230, 6370, 32954, 170634, 883018, 4571514,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) + 21*a(n-2) - 14*a(n-3) - 52*a(n-4) + 12*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 29 2018 10:37:34, revision 9) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251403.
