...
\title{The empirical recurrence for OEIS A263869, derived from the entry's generating function}
...
\begin{abstract}
OEIS A263869 carries an empirical recurrence of order $14$. The entry separately records a
...
OEIS A263869 is ``Number of (n+1) X (4+1) 0..1 arrays with each row and column divisible by 3, read as a binary number with top and left being the most significant bits, and rows and columns lexicographically nondecreasing.''. It has offset $1$ and begins
\[
3, 3, 7, 7, 16, 17, 41, 48,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 03 2019 06:02:13, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{14} + x^{13} + 7 x^{12} - 7 x^{11} - 20 x^{10} + 20 x^{9} + 31 x^{8} - 31 x^{7} - 29 x^{6} + 30 x^{5} + 14 x^{4} - 14 x^{3} - 3 x^{2} + 3 x}{x^{14} - 2 x^{13} - 5 x^{12} + 12 x^{11} + 9 x^{10} - 30 x^{9} - 5 x^{8} + 40 x^{7} - 5 x^{6} - 30 x^{5} + 9 x^{4} + 12 x^{3} - 5 x^{2} - 2 x + 1},
\]
the entry's own generating function, and let
\[
D(x)\;=\;1-\sum_i c_i x^{i}\;=\;x^{14} - 2 x^{13} - 5 x^{12} + 12 x^{11} + 9 x^{10} - 30 x^{9} - 5 x^{8} + 40 x^{7} - 5 x^{6} - 30 x^{5} + 9 x^{4} + 12 x^{3} - 5 x^{2} - 2 x + 1
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- x^{14} + x^{13} + 7 x^{12} - 7 x^{11} - 20 x^{10} + 20 x^{9} + 31 x^{8} - 31 x^{7} - 29 x^{6} + 30 x^{5} + 14 x^{4} - 14 x^{3} - 3 x^{2} + 3 x,
\]
...
\]
of degree $14$, and that degree is the order of the SHORTEST linear recurrence with
...
compared against all $40$ terms the entry publishes: it reproduces every one. This is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A263869.
