...
\title{The empirical recurrence for OEIS A251368, proved by transfer matrix}
...
\begin{abstract}
OEIS A251368 counts $4$-column arrays over $\{0,\dots,2\}$ in which every
...
OEIS A251368 is ``Number of (n+1) X (3+1) 0..2 arrays with every 2 X 2 subblock summing to 1 2 3 4 5 6 or 7.''. It has offset $1$
and begins
\[
6113, 464393, 35257505, 2676962017, 203249994369, 15431888950873, 1171676222709377, 88960280954218353,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 66*a(n-1) + 746*a(n-2) + 660*a(n-3) - 6281*a(n-4) + 3690*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 29 2018 10:37:10, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;66\,a(n-1) + 746\,a(n-2) + 660\,a(n-3) - 6281\,a(n-4) + 3690\,a(n-5)
\end{equation}
for all $n>4$, which is every $n$ at which a recurrence of order $5$ can be
stated.
...
$j=4-5+1$ onwards, and the run was continued past $S$ consecutive zeros, which by
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251368.
