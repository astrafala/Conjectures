...
\title{The empirical recurrence for OEIS A250731, proved by transfer matrix}
...
\begin{abstract}
OEIS A250731 counts arrays over $\{0,1\}$ in which a statistic taken over short runs
...
OEIS A250731 is ``Number of (2+1) X (n+1) 0..1 arrays with nondecreasing x(i,j)+x(i,j-1) in the i direction and nondecreasing min(x(i,j),x(i-1,j)) in the j direction.''. It has offset $1$ and begins
\[
18, 46, 110, 257, 596, 1376, 3173, 7310,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + 2*a(n-2) - 3*a(n-3) for n>4.
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 16 2018 10:57:24, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250731.
