...
\title{The empirical recurrence for OEIS A165394, derived from the entry's generating function}
...
\begin{abstract}
OEIS A165394 carries an empirical recurrence of order $5$. The entry separately records a
...
OEIS A165394 is ``Number of slanted 2 X n (i=1..2) X (j=i..n+i-1) 1..4 arrays with all 1s connected, all 2s connected, all 3s connected, all 4s connected, 1 in the upper left corner, 2 in the upper right corner, 3 in the lower left corner, 4 in the lower right corner, and with no element having more than 3 neighbors with the same value.''. It has offset $2$ and begins
\[
1, 9, 37, 105, 241, 481, 869, 1457,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 26 2018 09:54:13, revision 7) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{6} - 2 x^{4} - 4 x^{3} - x^{2}}{x^{5} - 5 x^{4} + 10 x^{3} - 10 x^{2} + 5 x - 1},
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A165394.
