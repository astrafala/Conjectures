...
\title{The empirical recurrence for OEIS A253430, proved by transfer matrix}
...
\begin{abstract}
OEIS A253430 counts the arrays over $\{0,\dots,1\}$ whose $2\times2$ subblocks carry a
...
so a pair of consecutive array rows is a state, the count is a walk count on $S=69$ of them,
...
OEIS A253430 is ``Number of (n+1) X (3+1) 0..1 arrays with every 2 X 2 subblock diagonal minus antidiagonal sum nondecreasing horizontally, vertically and ne-to-sw antidiagonally.''. It has offset $1$ and begins
\[
69, 70, 85, 121, 193, 337, 625, 1201,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) - 2*a(n-2) for n>4.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 12 2018 09:40:01, revision 8) this is still
...
\]
on the $S=69$ admissible pairs. In particular $a$ is $C$-finite. The alignment of the walk
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253430.
