...
\title{The empirical recurrence for OEIS A206170, derived from the entry's generating function}
...
\begin{abstract}
OEIS A206170 carries an empirical recurrence of order $4$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 04 2018 06:41:02, revision 9) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 576 x^{4} + 626 x^{3} - 185 x^{2} + 15 x}{108 x^{4} - 192 x^{3} + 101 x^{2} - 18 x + 1},
\]
the entry's own generating function, and let
\[
D(x)\;=\;1-\sum_i c_i x^{i}\;=\;108 x^{4} - 192 x^{3} + 101 x^{2} - 18 x + 1
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 576 x^{4} + 626 x^{3} - 185 x^{2} + 15 x,
\]
...
\[
108 x^{4} - 192 x^{3} + 101 x^{2} - 18 x + 1,
\]
