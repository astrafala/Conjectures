...
\title{The empirical recurrence for OEIS A222869, derived from the entry's generating function}
...
\begin{abstract}
OEIS A222869 carries an empirical recurrence of order $2$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 16 2018 13:22:46, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{234 x^{4} - 261 x^{3} - 92 x^{2} + 3 x}{117 x^{2} - 42 x + 1},
\]
the entry's own generating function, and let
\[
D(x)\;=\;1-\sum_i c_i x^{i}\;=\;117 x^{2} - 42 x + 1
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;234 x^{4} - 261 x^{3} - 92 x^{2} + 3 x,
\]
