...
\title{The empirical recurrence for OEIS A258674, proved by transfer matrix}
...
\begin{abstract}
OEIS A258674 counts arrays of width $3$ over $\{0,1\}$ in which every $3\times3$ window has
...
OEIS A258674 is ``Number of (n+2) X (1+2) 0..1 arrays with no 3 x 3 subblock diagonal sum equal to the antidiagonal sum.''. It has offset $1$ and begins
\[
320, 1600, 8320, 43264, 219648, 1115136, 5744640, 29593600,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + 32*a(n-3) + 256*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 22 2018 11:29:53, revision 10) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A258674.
