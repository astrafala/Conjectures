...
\title{The empirical recurrence for OEIS A253229, derived from the entry's generating function}
...
\begin{abstract}
OEIS A253229 carries an empirical recurrence of order $4$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 10 2018 12:18:53, revision 7) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{x^{8} - 9 x^{7} + 3599 x^{6} - 11033 x^{5} + 8417 x^{4} + 4681 x^{3} - 8192 x^{2} + 2470 x}{2 x^{4} - 7 x^{3} + 9 x^{2} - 5 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;x^{8} - 9 x^{7} + 3599 x^{6} - 11033 x^{5} + 8417 x^{4} + 4681 x^{3} - 8192 x^{2} + 2470 x,
\]
