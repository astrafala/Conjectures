...
\title{The empirical recurrence for OEIS A184146, proved by transfer matrix}
...
\begin{abstract}
OEIS A184146 counts $(n+1)\times3$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A184146 is ``1/4 the number of (n+1) X 3 0..3 arrays with every 2 X 2 subblock having at least two equal elements connected horizontally or vertically.''. It has offset $1$ and begins
\[
499, 17203, 584143, 19882711, 676507975, 23019453235, 783273204631, 26652142523719,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 33*a(n-1) + 53*a(n-2) - 637*a(n-3) + 756*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 12 2018 06:31:44, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;33\,a(n-1) + 53\,a(n-2) - 637\,a(n-3) + 756\,a(n-4)
\end{equation}
for all $n>3$.
...
\[
a(n)-\sum_i c_i\,a(n-i)\;=\;\tfrac1{4}\mathbf{1}^{\!\top}M^{\,n+1-1-4}\,q(M)\,\mathbf{1} .
\]
...
=\tfrac1{4}\mathbf{1}^{\!\top}M^{\,m-4}\,q(M)\,\mathbf{1}
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A184146.
