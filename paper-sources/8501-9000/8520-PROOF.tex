...
\title{The empirical recurrence for OEIS A236003, proved by transfer matrix}
...
\begin{abstract}
OEIS A236003 counts arrays of width $2$ over $\{0,1,2,3\}$ in which the smallest and largest of the
...
wider, so the count is a walk count on $S=16$ states.
\end{abstract}
...
OEIS A236003 is ``Number of (n+1) X (1+1) 0..3 arrays with the minimum plus the maximum equal to the lower median plus the upper median in every 2 X 2 subblock.''. It has offset $1$ and begins
\[
88, 508, 2960, 17464, 104112, 626480, 3800832, 23225504,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 16*a(n-1) - 86*a(n-2) + 156*a(n-3) + 48*a(n-4) - 256*a(n-5) - 64*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 20 2018 10:24:25, revision 9) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The arrays have $2$ columns and a growing number of rows, with entries in $\{0,1,2,3\}$. Take any
...
of the $2-1$ blocks spanning the two rows satisfies the condition.
...
$\mathbf{1}$, and the states are all $4^{2}=16$ rows. Thus
\[
...
\begin{theorem}
\[
a(n)\;=\;16\,a(n-1) - 86\,a(n-2) + 156\,a(n-3) + 48\,a(n-4) - 256\,a(n-5) - 64\,a(n-6)
\]
for every $n>5$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A236003.
