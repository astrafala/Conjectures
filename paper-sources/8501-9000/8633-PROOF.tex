...
\title{The empirical recurrence for OEIS A301658, proved by transfer matrix}
...
\begin{abstract}
OEIS A301658 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A301658 is ``Number of nX4 0..1 arrays with every element equal to 0, 1 or 4 horizontally or vertically adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
5, 6, 9, 13, 24, 45, 89, 182,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) +a(n-2) -a(n-3) -2*a(n-4) +a(n-5)
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 25 2018 11:26:05, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A301658.
