...
\title{The empirical recurrence for OEIS A250781, derived from the entry's generating function}
...
\begin{abstract}
OEIS A250781 carries an empirical recurrence of order $9$. The entry separately records a
...
OEIS A250781 is ``Number of (n+1) X (6+1) 0..1 arrays with nondecreasing x(i,j)+x(i,j-1) in the i direction and nondecreasing absolute value of x(i,j)-x(i-1,j) in the j direction.''. It has offset $1$ and begins
\[
436, 1106, 2604, 5882, 12950, 27986, 59590, 125334,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 19 2018 11:42:02, revision 7) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 320 x^{9} + 2506 x^{8} - 8938 x^{7} + 18518 x^{6} - 24186 x^{5} + 20326 x^{4} - 10728 x^{3} + 3254 x^{2} - 436 x}{2 x^{9} - 17 x^{8} + 64 x^{7} - 140 x^{6} + 196 x^{5} - 182 x^{4} + 112 x^{3} - 44 x^{2} + 10 x - 1},
\]
the entry's own generating function, and let
\[
D(x)\;=\;1-\sum_i c_i x^{i}\;=\;- 2 x^{9} + 17 x^{8} - 64 x^{7} + 140 x^{6} - 196 x^{5} + 182 x^{4} - 112 x^{3} + 44 x^{2} - 10 x + 1
\]
...
\begin{theorem}
\[
a(n)\;=\;10\,a(n-1) - 44\,a(n-2) + 112\,a(n-3) - 182\,a(n-4) + 196\,a(n-5) - 140\,a(n-6) + 64\,a(n-7) - 17\,a(n-8) + 2\,a(n-9)
\]
for every $n>9$.
\end{theorem}
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;320 x^{9} - 2506 x^{8} + 8938 x^{7} - 18518 x^{6} + 24186 x^{5} - 20326 x^{4} + 10728 x^{3} - 3254 x^{2} + 436 x,
\]
...
\[
2 x^{9} - 17 x^{8} + 64 x^{7} - 140 x^{6} + 196 x^{5} - 182 x^{4} + 112 x^{3} - 44 x^{2} + 10 x - 1,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250781.
