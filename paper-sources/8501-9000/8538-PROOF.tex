...
\title{A proof of the conjectured recurrence for OEIS A025754}
...
\begin{abstract}
OEIS A025754 carries a conjectured linear recurrence with polynomial coefficients, of
...
computed in closed form. Here it equals $10 x$, a polynomial of degree $1$, which proves
...
OEIS A025754 is ``9th-order Patalan numbers (generalization of Catalan numbers)''. It has offset $0$ and begins
\[
a(0),\dots,a(7)\;=\;1, 1, 36, 1836, 107406, 6766578, 446594148, 30432201228,\ \dots
\]
The entry gives the generating function
\begin{equation}\label{eq:gf}
A(x)\;=\;\sum_{n\ge 0} a(n)\,x^{n}\;=\;\frac{10}{9} - \frac{\sqrt[9]{1 - 81 x}}{9} ,
\end{equation}
and it carries the following comment:
\begin{quote}\small
\textbf{Conjecture:} n*a(n) + 9*(-9*n+10)*a(n-1) = 0. - \emph{R. J. Mathar}, Jul 28 2014
\end{quote}
As of the ``Last modified'' line on the live entry (2025-11-09, revision 44) the
...
\[
p_{0}(n)=n,\qquad p_{1}(n)=- 9 \left(9 n - 10\right)
\]
...
\section{The computation for A025754}

The generating function \eqref{eq:gf} is algebraic over $\mathbb{Q}(x)$;
its minimal polynomial is
\[
P(x,y) \;=\; - x + 4782969 y^{9} - 47829690 y^{8} + 212576400 y^{7} - 551124000 y^{6} + 918540000 y^{5} - 1020600000 y^{4} + 756000000 y^{3} - 360000000 y^{2} + 100000000 y - 12345679 ,
\]
...
\[
n\,a(n) -  9 \left(9 n - 10\right)\,a(n-1) \;=\;0
\]
holds for every $n>1$.
\end{theorem}
...
section of A025754, agreeing on all 13 terms compared.
...
\url{https://oeis.org}, 2026. Sequence A025754.
