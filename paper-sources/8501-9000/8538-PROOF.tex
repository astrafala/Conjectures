...
\title{The empirical recurrence for OEIS A186788, proved by transfer matrix}
...
\begin{abstract}
OEIS A186788 counts arrays of width $3$ over $\{0,1\}$ in which every $3\times3$ subblock
satisfies a condition on its nine entries. The entry carries an empirical recurrence of order
$5$ contributed by R.~H.~Hardin. It is true, and it is decidable rather than empirical: a
...
OEIS A186788 is ``Half the number of (n+2) X 3 binary arrays with each 3 X 3 subblock having a sum in 2..7.''. It has offset $1$ and begins
\[
246, 1910, 14825, 115069, 893145, 6932452, 53808589, 417653681,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 7*a(n-1) + 4*a(n-2) + 15*a(n-3) - 9*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 19 2018 05:53:59, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-1) + 4\,a(n-2) + 15\,a(n-3) - 9\,a(n-5)
\]
for every $n>3$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A186788.
