...
\title{The empirical recurrence for OEIS A251310, proved by transfer matrix}
...
\begin{abstract}
OEIS A251310 counts $(n+1)\times2$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A251310 is ``Number of (n+1) X (1+1) 0..1 arrays with no 2 X 2 subblock having the maximum of its diagonal elements greater than the absolute difference of its antidiagonal elements.''. It has offset $1$ and begins
\[
10, 25, 61, 149, 365, 894, 2189, 5360,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) - 2*a(n-2) + 2*a(n-3) - a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 28 2018 10:57:51, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251310.
