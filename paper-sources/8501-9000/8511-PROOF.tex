...
\title{The empirical recurrence for OEIS A208485, proved by transfer matrix}
...
\begin{abstract}
OEIS A208485 counts arrays of width $2$ over $\{0,1,2,3\}$ subject to a condition read round the
...
OEIS A208485 is ``Number of (n+1) X 2 0..3 arrays with the number of clockwise edge increases in every 2 X 2 subblock equal to the number of counterclockwise edge increases.''. It has offset $1$ and begins
\[
152, 1448, 13800, 131528, 1253608, 11948296, 113880744, 1085412040,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 11*a(n-1) - 14*a(n-2).
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 16 2025 07:41:37, revision 17) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208485.
