...
\title{The empirical recurrence for OEIS A233838, proved by transfer matrix}
...
\begin{abstract}
OEIS A233838 counts arrays of width $3$ over $\{0,1,2,3\}$ containing no run of $3$ consecutive
...
OEIS A233838 is ``Number of (n+2) X (1+2) 0..3 arrays with no increasing sequence of length 3 horizontally or antidiagonally downwards.''. It has offset $1$ and begins
\[
201664, 11305216, 633584640, 35508588544, 1990039158784, 111529525575680, 6250547858112512, 350304982786899968,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 56*a(n-1) + 16*a(n-2) - 768*a(n-3) + 512*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 11 2018 14:28:20, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;56\,a(n-1) + 16\,a(n-2) - 768\,a(n-3) + 512\,a(n-4)
\]
for every $n>1$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A233838.
