...
\title{The empirical recurrence for OEIS A203651, proved by transfer matrix}
...
\begin{abstract}
OEIS A203651 counts $(n+1)\times4$ arrays over $\{0,\dots,4\}$ subject to a condition imposed on
...
OEIS A203651 is ``1/25 the number of (n+1) X 4 0..4 arrays with every 2 X 2 subblock having equal diagonal elements or equal antidiagonal elements.''. It has offset $1$ and begins
\[
729, 28057, 1116249, 44577561, 1780968921, 71156938905, 2843024036697, 113591039131161,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 45*a(n-1) -204*a(n-2) +96*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 04 2018 12:20:28, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;45\,a(n-1) - 204\,a(n-2) + 96\,a(n-3)
\end{equation}
for all $n>2$.
...
\[
a(n)-\sum_i c_i\,a(n-i)\;=\;\tfrac1{25}\mathbf{1}^{\!\top}M^{\,n+1-1-3}\,q(M)\,\mathbf{1} .
\]
...
=\tfrac1{25}\mathbf{1}^{\!\top}M^{\,m-3}\,q(M)\,\mathbf{1}
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A203651.
