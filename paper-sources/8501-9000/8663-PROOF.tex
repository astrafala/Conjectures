...
\title{The empirical recurrence for OEIS A250896, derived from the entry's generating function}
...
\begin{abstract}
OEIS A250896 carries an empirical recurrence of order $7$. The entry separately records a
...
OEIS A250896 is ``Number of (n+1) X (6+1) 0..2 arrays with nondecreasing x(i,j)-x(i,j-1) in the i direction and nondecreasing absolute value of x(i,j)-x(i-1,j) in the j direction.''. It has offset $1$ and begins
\[
10875, 31215, 91030, 265546, 764315, 2168405, 6060594, 16732140,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 23 2018 05:31:02, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{26568 x^{9} - 63432 x^{8} - 50022 x^{7} + 402400 x^{6} - 755858 x^{5} + 715664 x^{4} - 368950 x^{3} + 99285 x^{2} - 10875 x}{24 x^{7} - 116 x^{6} + 234 x^{5} - 255 x^{4} + 162 x^{3} - 60 x^{2} + 12 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 26568 x^{9} + 63432 x^{8} + 50022 x^{7} - 402400 x^{6} + 755858 x^{5} - 715664 x^{4} + 368950 x^{3} - 99285 x^{2} + 10875 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250896.
