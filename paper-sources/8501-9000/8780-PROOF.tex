...
\title{The empirical recurrence for OEIS A251229, proved by transfer matrix}
...
\begin{abstract}
OEIS A251229 counts $2$-column arrays over $\{0,\dots,3\}$ in which every
...
OEIS A251229 is ``Number of (n+1) X (1+1) 0..3 arrays with every 2 X 2 subblock summing to 6 and no 2 X 2 subblock having exactly two nonzero entries.''. It has offset $1$
and begins
\[
38, 110, 322, 966, 2930, 8982, 27714, 85958,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 7*a(n-1) - 12*a(n-2) - 8*a(n-3) + 24*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 27 2018 09:01:07, revision 16) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;7\,a(n-1) - 12\,a(n-2) - 8\,a(n-3) + 24\,a(n-4)
\end{equation}
...
$j=4-4+1$ onwards, and the run was continued past $S$ consecutive zeros, which by
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251229.
