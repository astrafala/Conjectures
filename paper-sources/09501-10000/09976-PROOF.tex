...
\title{The empirical recurrence for OEIS A302948, proved by transfer matrix}
...
\begin{abstract}
OEIS A302948 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A302948 is ``Number of nX3 0..1 arrays with every element equal to 1, 2, 3, 4 or 5 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 15, 86, 587, 3815, 25131, 164916, 1083375,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 4*a(n-1) +15*a(n-2) +13*a(n-3) -2*a(n-4) -19*a(n-5) -3*a(n-6) +4*a(n-8)
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 16 2018 11:37:47, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) + 15\,a(n-2) + 13\,a(n-3) - 2\,a(n-4) - 19\,a(n-5) - 3\,a(n-6) + 4\,a(n-8)
\end{equation}
for all $n>8$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302948.
