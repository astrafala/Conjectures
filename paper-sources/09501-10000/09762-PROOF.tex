...
\title{The empirical recurrence for OEIS A241621, derived from the entry's generating function}
...
\begin{abstract}
OEIS A241621 carries an empirical recurrence of order $9$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 30 2018 12:52:33, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{9} + 9 x^{8} - 36 x^{7} + 84 x^{6} - 127 x^{5} + 107 x^{4} - 155 x^{3} - 35 x^{2} - 28 x}{x^{9} - 9 x^{8} + 36 x^{7} - 84 x^{6} + 126 x^{5} - 126 x^{4} + 84 x^{3} - 36 x^{2} + 9 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;x^{9} - 9 x^{8} + 36 x^{7} - 84 x^{6} + 127 x^{5} - 107 x^{4} + 155 x^{3} + 35 x^{2} + 28 x,
\]
