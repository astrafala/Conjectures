...
\title{The empirical recurrence for OEIS A211839, derived from the entry's generating function}
...
\begin{abstract}
OEIS A211839 carries an empirical recurrence of order $9$. The entry separately records a
...
OEIS A211839 is ``Number of nonnegative integer arrays of length n+6 with new values 0 upwards introduced in order, no three adjacent elements equal, and containing the value n+1.''. It has offset $1$ and begins
\[
664, 2621, 9068, 27312, 72840, 175475, 388512, 801674,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 25 2021 05:12:01, revision 9) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 159 x^{9} + 1390 x^{8} - 5367 x^{7} + 11983 x^{6} - 16980 x^{5} + 15720 x^{4} - 9383 x^{3} + 3355 x^{2} - 664 x}{x^{9} - 9 x^{8} + 36 x^{7} - 84 x^{6} + 126 x^{5} - 126 x^{4} + 84 x^{3} - 36 x^{2} + 9 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;159 x^{9} - 1390 x^{8} + 5367 x^{7} - 11983 x^{6} + 16980 x^{5} - 15720 x^{4} + 9383 x^{3} - 3355 x^{2} + 664 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A211839.
