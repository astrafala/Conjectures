...
\title{The empirical recurrence for OEIS A250060, derived from the entry's generating function}
...
\begin{abstract}
OEIS A250060 carries an empirical recurrence of order $8$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 22 2017 06:36:19, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{21 x^{6} + 567 x^{5} + 1932 x^{4} + 1932 x^{3} + 567 x^{2} + 21 x}{x^{8} - 8 x^{7} + 28 x^{6} - 56 x^{5} + 70 x^{4} - 56 x^{3} + 28 x^{2} - 8 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;21 x^{6} + 567 x^{5} + 1932 x^{4} + 1932 x^{3} + 567 x^{2} + 21 x,
\]
