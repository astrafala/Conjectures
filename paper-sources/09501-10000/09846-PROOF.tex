...
\title{The empirical recurrence for OEIS A250144, derived from the entry's generating function}
...
\begin{abstract}
OEIS A250144 carries an empirical recurrence of order $8$. The entry separately records a
...
OEIS A250144 is ``Number of length 5+2 0..n arrays with the medians of every three consecutive terms nondecreasing.''. It has offset $1$ and begins
\[
68, 900, 5696, 24125, 79200, 217856, 526032, 1149057,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 12 2018 03:01:13, revision 11) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{8} + 8 x^{7} - 28 x^{6} + 48 x^{5} - 51 x^{4} + 400 x^{3} + 356 x^{2} + 68 x}{x^{8} - 8 x^{7} + 28 x^{6} - 56 x^{5} + 70 x^{4} - 56 x^{3} + 28 x^{2} - 8 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- x^{8} + 8 x^{7} - 28 x^{6} + 48 x^{5} - 51 x^{4} + 400 x^{3} + 356 x^{2} + 68 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250144.
