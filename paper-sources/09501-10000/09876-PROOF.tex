...
\title{The empirical recurrence for OEIS A261704, proved by transfer matrix}
...
\begin{abstract}
OEIS A261704 counts $(n+2)\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A261704 is ``Number of (n+2) X (1+2) 0..1 arrays with each 3 X 3 subblock having clockwise perimeter pattern 00000001 00000101 or 00000111.''. It has offset $1$ and begins
\[
48, 76, 172, 338, 628, 1298, 2752, 5526,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + a(n-2) + a(n-3) + 5*a(n-4) - 3*a(n-5) - 5*a(n-6) + 3*a(n-7) - 4*a(n-8) + 2*a(n-9) for n>11.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 31 2018 05:34:46, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + a(n-2) + a(n-3) + 5\,a(n-4) - 3\,a(n-5) - 5\,a(n-6) + 3\,a(n-7) - 4\,a(n-8) + 2\,a(n-9)
\]
for every $n>11$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A261704.
