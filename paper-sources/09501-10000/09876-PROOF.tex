...
\title{The empirical recurrence for OEIS A248431, proved by transfer matrix}
...
\begin{abstract}
OEIS A248431 carries an empirical recurrence of order $9$ contributed by R.~H.~Hardin. It is
...
OEIS A248431 is ``Number of length n+2 0..6 arrays with every three consecutive terms having the sum of some two elements equal to twice the third.''. It has offset $1$ and begins
\[
61, 105, 185, 327, 601, 1105, 2021, 3761,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 8*a(n-3) - 11*a(n-6) + 4*a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 08 2018 08:53:21, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A248431.
