...
\title{The empirical recurrence for OEIS A269623, derived from the entry's generating function}
...
\begin{abstract}
OEIS A269623 carries an empirical recurrence of order $8$. The entry separately records a
...
OEIS A269623 is ``Number of length-7 0..n arrays with no repeated value differing from the previous repeated value by other than plus two, zero or minus 1.''. It has offset $1$ and begins
\[
92, 1740, 13544, 66925, 246798, 742487, 1923796, 4447329,\ \dots
\]
The entry states, as a conjecture and never marked settled:
\begin{quote}
a(n) = 8*a(n-1) - 28*a(n-2) + 56*a(n-3) - 70*a(n-4) + 56*a(n-5) - 28*a(n-6) + 8*a(n-7) - a(n-8) for n>10. (End)
\end{quote}
and, separately and NOT as a conjecture:
\begin{quote}
G.f.: x*(92 + 1004*x + 2200*x\^{}2 + 2141*x\^{}3 - 370*x\^{}4 + 187*x\^{}5 - 340*x\^{}6 + 179*x\^{}7 - 62*x\^{}8 + 9*x\^{}9) / (1 - x)\^{}8.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 06 2025 11:30:49, revision 11) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{9 x^{10} - 62 x^{9} + 179 x^{8} - 340 x^{7} + 187 x^{6} - 370 x^{5} + 2141 x^{4} + 2200 x^{3} + 1004 x^{2} + 92 x}{x^{8} - 8 x^{7} + 28 x^{6} - 56 x^{5} + 70 x^{4} - 56 x^{3} + 28 x^{2} - 8 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;9 x^{10} - 62 x^{9} + 179 x^{8} - 340 x^{7} + 187 x^{6} - 370 x^{5} + 2141 x^{4} + 2200 x^{3} + 1004 x^{2} + 92 x,
\]
...
$n>10$. The bound is exact: at $n=10$ the recurrence fails on the entry's own published terms.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269623.
