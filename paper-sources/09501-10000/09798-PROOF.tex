...
\title{The empirical recurrence for OEIS A200875, derived from the entry's generating function}
...
\begin{abstract}
OEIS A200875 carries an empirical recurrence of order $8$. The entry separately records a
...
OEIS A200875 is ``Number of 0..n arrays x(0..6) of 7 elements without any interior element greater than both neighbors or less than both neighbors.''. It has offset $1$ and begins
\[
42, 343, 1528, 4917, 12890, 29325, 60112, 113745,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 16 2017 12:22:37, revision 10) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{8} + 8 x^{7} - 29 x^{6} + 70 x^{5} - 55 x^{4} - 40 x^{3} + 7 x^{2} + 42 x}{x^{8} - 8 x^{7} + 28 x^{6} - 56 x^{5} + 70 x^{4} - 56 x^{3} + 28 x^{2} - 8 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- x^{8} + 8 x^{7} - 29 x^{6} + 70 x^{5} - 55 x^{4} - 40 x^{3} + 7 x^{2} + 42 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A200875.
