...
\title{The empirical recurrence for OEIS A221970, derived from the entry's generating function}
...
\begin{abstract}
OEIS A221970 carries an empirical recurrence of order $8$. The entry separately records a
...
OEIS A221970 is ``Number of -n..n arrays of length 7 with the sum ahead of each element differing from the sum following that element by n or less.''. It has offset $1$ and begins
\[
255, 7425, 73983, 419841, 1690623, 5407233, 14661375, 35111681,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 14 2018 08:57:45, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{8} + 9 x^{7} + 219 x^{6} + 5469 x^{5} + 21597 x^{4} + 21723 x^{3} + 5385 x^{2} + 255 x}{x^{8} - 8 x^{7} + 28 x^{6} - 56 x^{5} + 70 x^{4} - 56 x^{3} + 28 x^{2} - 8 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- x^{8} + 9 x^{7} + 219 x^{6} + 5469 x^{5} + 21597 x^{4} + 21723 x^{3} + 5385 x^{2} + 255 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221970.
