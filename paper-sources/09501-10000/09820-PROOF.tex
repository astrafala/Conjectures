...
\title{The empirical recurrence for OEIS A229017, derived from the entry's generating function}
...
\begin{abstract}
OEIS A229017 carries an empirical recurrence of order $8$. The entry separately records a
...
OEIS A229017 is ``Number of arrays of median of three adjacent elements of some length 9 0..n array, with no adjacent equal elements in the latter.''. It has offset $1$ and begins
\[
2, 193, 2054, 10735, 38768, 111311, 273124, 597477,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 14 2018 11:59:37, revision 11) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{8} + 8 x^{7} + 121 x^{6} - 268 x^{5} - 405 x^{4} + 566 x^{3} + 177 x^{2} + 2 x}{x^{8} - 8 x^{7} + 28 x^{6} - 56 x^{5} + 70 x^{4} - 56 x^{3} + 28 x^{2} - 8 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- x^{8} + 8 x^{7} + 121 x^{6} - 268 x^{5} - 405 x^{4} + 566 x^{3} + 177 x^{2} + 2 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A229017.
