...
\title{The empirical recurrence for OEIS A207840, proved by transfer matrix}
...
\begin{abstract}
OEIS A207840 counts arrays over $\{0,\dots,1\}$ of width $3$ that avoid the patterns
$(0,0,0), (0,0,1)$ along one axis and $(0,0,0), (1,1,1)$ along the other, and carries an empirical recurrence of
...
OEIS A207840 is ``Number of n X 3 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 0 0 and 1 1 1 vertically.''. It has offset
$1$ and begins
\[
6, 36, 72, 240, 704, 2080, 6216,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) + 4*a(n-2) + 5*a(n-3) + 2*a(n-4) - a(n-5) + a(n-6) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 21 2018 07:00:04, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207840.
