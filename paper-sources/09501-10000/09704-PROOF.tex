...
\title{The empirical recurrence for OEIS A228655, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A228655 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A228655 is ``Number of nX3 binary arrays with top left value 1 and no two ones adjacent horizontally, diagonally or antidiagonally.''. It has offset $1$ and begins
\[
2, 8, 34, 140, 574, 2348, 9598, 39224,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 5*a(n-1) -3*a(n-2) -3*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 04 2025 00:04:54, revision 11) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) - 3\,a(n-2) - 3\,a(n-3)
\end{equation}
for all $n>3$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A228655.
