...
\title{The empirical recurrence for OEIS A200877, derived from the entry's generating function}
...
\begin{abstract}
OEIS A200877 carries an empirical recurrence of order $10$. The entry separately records a
...
OEIS A200877 is ``Number of 0..n arrays x(0..8) of 9 elements without any interior element greater than both neighbors or less than both neighbors.''. It has offset $1$ and begins
\[
110, 1523, 9858, 42479, 141688, 395929, 971416, 2156867,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 16 2017 10:06:48, revision 10) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{10} + 10 x^{9} - 44 x^{8} + 90 x^{7} - 246 x^{6} + 848 x^{5} - 766 x^{4} - 422 x^{3} + 423 x^{2} + 110 x}{x^{10} - 10 x^{9} + 45 x^{8} - 120 x^{7} + 210 x^{6} - 252 x^{5} + 210 x^{4} - 120 x^{3} + 45 x^{2} - 10 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- x^{10} + 10 x^{9} - 44 x^{8} + 90 x^{7} - 246 x^{6} + 848 x^{5} - 766 x^{4} - 422 x^{3} + 423 x^{2} + 110 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A200877.
