...
\title{The empirical recurrence for OEIS A266430, derived from the entry's generating function}
...
\begin{abstract}
OEIS A266430 carries an empirical recurrence of order $12$. The entry separately records a
...
OEIS A266430 is ``Number of 4 X n binary arrays with rows and columns lexicographically nondecreasing and column sums nondecreasing.''. It has offset $1$ and begins
\[
5, 22, 96, 404, 1556, 5365, 16585, 46463,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 09 2019 21:23:31, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{12} + 12 x^{11} - 65 x^{10} + 213 x^{9} - 471 x^{8} + 737 x^{7} - 833 x^{6} + 679 x^{5} - 396 x^{4} + 162 x^{3} - 38 x^{2} + 5 x}{x^{12} - 12 x^{11} + 66 x^{10} - 220 x^{9} + 495 x^{8} - 792 x^{7} + 924 x^{6} - 792 x^{5} + 495 x^{4} - 220 x^{3} + 66 x^{2} - 12 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- x^{12} + 12 x^{11} - 65 x^{10} + 213 x^{9} - 471 x^{8} + 737 x^{7} - 833 x^{6} + 679 x^{5} - 396 x^{4} + 162 x^{3} - 38 x^{2} + 5 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A266430.
