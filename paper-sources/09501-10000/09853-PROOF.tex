...
\title{The empirical recurrence for OEIS A295115, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A295115 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A295115 is ``Number of n X 3 0..1 arrays with each 1 horizontally or vertically adjacent to 1 or 4 1s.''. It has offset $1$ and begins
\[
3, 9, 26, 77, 226, 665, 1960, 5769,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) + 3*a(n-2) + 5*a(n-3) + 7*a(n-4) + 7*a(n-5) - a(n-6) - 8*a(n-7) - 5*a(n-8) + a(n-10).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 22 2019 06:23:48, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 3\,a(n-2) + 5\,a(n-3) + 7\,a(n-4) + 7\,a(n-5) - a(n-6) - 8\,a(n-7) - 5\,a(n-8) + a(n-10)
\end{equation}
for all $n>11$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A295115.
