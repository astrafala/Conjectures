...
\title{The empirical recurrence for OEIS A253321, proved by transfer matrix}
...
\begin{abstract}
OEIS A253321 counts the arrays over $\{0,\dots,1\}$ whose $2\times2$ subblocks carry a
...
OEIS A253321 is ``Number of (n+1)X(3+1) 0..1 arrays with every 2X2 subblock sum nondecreasing horizontally, vertically and antidiagonally ne-to-sw.''. It has offset $1$ and begins
\[
121, 373, 1217, 2538, 6190, 11795, 25659, 48085,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:57:15, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + 2\,a(n-2) - 26\,a(n-3) + 16\,a(n-4) + 62\,a(n-5) - 70\,a(n-6) - 62\,a(n-7) + 109\,a(n-8) + 14\,a(n-9) - 76\,a(n-10) + 16\,a(n-11) + 20\,a(n-12) - 8\,a(n-13)
\]
for every $n>15$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253321.
