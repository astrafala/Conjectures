...
\title{The empirical recurrence for OEIS A254702, derived from the entry's generating function}
...
\begin{abstract}
OEIS A254702 carries an empirical recurrence of order $8$. The entry separately records a
...
OEIS A254702 is ``Number of length 4+4 0..n arrays with every five consecutive terms having the maximum of some two terms equal to the minimum of the remaining three terms.''. It has offset $1$ and begins
\[
86, 1140, 6808, 26759, 81390, 208114, 469376, 962541,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 17 2018 09:43:44, revision 7) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{8} + 8 x^{7} - 18 x^{6} + 122 x^{5} - 601 x^{4} + 96 x^{3} + 452 x^{2} + 86 x}{x^{8} - 8 x^{7} + 28 x^{6} - 56 x^{5} + 70 x^{4} - 56 x^{3} + 28 x^{2} - 8 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- x^{8} + 8 x^{7} - 18 x^{6} + 122 x^{5} - 601 x^{4} + 96 x^{3} + 452 x^{2} + 86 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A254702.
