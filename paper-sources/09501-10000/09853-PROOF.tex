...
\title{The empirical recurrence for OEIS A254704, derived from the entry's generating function}
...
\begin{abstract}
OEIS A254704 carries an empirical recurrence of order $8$. The entry separately records a
...
OEIS A254704 is ``Number of length 6+4 0..n arrays with every five consecutive terms having the maximum of some two terms equal to the minimum of the remaining three terms.''. It has offset $1$ and begins
\[
212, 4542, 37204, 183491, 665256, 1961608, 4985336, 11325573,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 17 2018 15:24:52, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{8} + 8 x^{7} - 48 x^{6} - 472 x^{5} + 1163 x^{4} + 6804 x^{3} + 2846 x^{2} + 212 x}{x^{8} - 8 x^{7} + 28 x^{6} - 56 x^{5} + 70 x^{4} - 56 x^{3} + 28 x^{2} - 8 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- x^{8} + 8 x^{7} - 48 x^{6} - 472 x^{5} + 1163 x^{4} + 6804 x^{3} + 2846 x^{2} + 212 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A254704.
