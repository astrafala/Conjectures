...
\title{The empirical recurrence for OEIS A183444, proved by transfer matrix}
...
\begin{abstract}
OEIS A183444 counts $n\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A183444 is ``Number of n X 3 binary arrays with every 1 having exactly two king-move neighbors equal to 1.''. It has offset $1$ and begins
\[
1, 9, 18, 30, 107, 265, 553, 1505,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) - a(n-2) + 8*a(n-3) - 7*a(n-4) + 2*a(n-5) - 2*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 27 2018 07:11:06, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) - a(n-2) + 8\,a(n-3) - 7\,a(n-4) + 2\,a(n-5) - 2\,a(n-6)
\]
for every $n>6$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A183444.
