...
\title{The empirical recurrence for OEIS A202934, derived from the entry's generating function}
...
\begin{abstract}
OEIS A202934 carries an empirical recurrence of order $7$. The entry separately records a
...
OEIS A202934 is ``Number of (n+3) X 6 binary arrays with consecutive windows of four bits considered as a binary number nondecreasing in every row and column.''. It has offset $1$ and begins
\[
104976, 153874, 225858, 330853, 481798, 695114, 991196, 1394929,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 03 2018 07:57:24, revision 9) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 71809 x^{7} + 453495 x^{6} - 1197415 x^{5} + 1692959 x^{4} - 1353236 x^{3} + 580958 x^{2} - 104976 x}{x^{7} - 7 x^{6} + 21 x^{5} - 35 x^{4} + 35 x^{3} - 21 x^{2} + 7 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;71809 x^{7} - 453495 x^{6} + 1197415 x^{5} - 1692959 x^{4} + 1353236 x^{3} - 580958 x^{2} + 104976 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A202934.
