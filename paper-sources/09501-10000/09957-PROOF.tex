...
\title{The empirical recurrence for OEIS A229440, derived from the entry's generating function}
...
\begin{abstract}
OEIS A229440 carries an empirical recurrence of order $7$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 17 2018 08:31:23, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 2 x^{7} + 15 x^{6} - 44 x^{5} + 66 x^{4} - 57 x^{3} + 25 x^{2} - 5 x}{x^{7} - 7 x^{6} + 21 x^{5} - 35 x^{4} + 35 x^{3} - 21 x^{2} + 7 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;2 x^{7} - 15 x^{6} + 44 x^{5} - 66 x^{4} + 57 x^{3} - 25 x^{2} + 5 x,
\]
