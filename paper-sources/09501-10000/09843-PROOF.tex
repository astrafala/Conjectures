...
\title{The empirical recurrence for OEIS A249884, derived from the entry's generating function}
...
\begin{abstract}
OEIS A249884 carries an empirical recurrence of order $8$. The entry separately records a
...
OEIS A249884 is ``Number of length 1+6 0..n arrays with no seven consecutive terms having the maximum of any three terms equal to the minimum of the remaining four terms.''. It has offset $1$ and begins
\[
35, 805, 7420, 40740, 161315, 510965, 1377040, 3284400,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 10 2018 05:46:31, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{35 x^{6} + 525 x^{5} + 1960 x^{4} + 1960 x^{3} + 525 x^{2} + 35 x}{x^{8} - 8 x^{7} + 28 x^{6} - 56 x^{5} + 70 x^{4} - 56 x^{3} + 28 x^{2} - 8 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;35 x^{6} + 525 x^{5} + 1960 x^{4} + 1960 x^{3} + 525 x^{2} + 35 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A249884.
