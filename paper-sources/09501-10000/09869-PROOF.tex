...
\title{The empirical recurrence for OEIS A183886, derived from the entry's generating function}
...
\begin{abstract}
OEIS A183886 carries an empirical recurrence of order $7$. The entry separately records a
...
OEIS A183886 is ``Number of arrangements of n+3 numbers in 0..3 with each number being the sum mod 4 of three others.''. It has offset $1$ and begins
\[
16, 292, 2574, 13344, 59518, 250124, 1024174, 4143944,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 05 2018 09:52:41, revision 11) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{1312 x^{8} - 5992 x^{7} + 10672 x^{6} - 8938 x^{5} + 2976 x^{4} + 2 x^{3} - 100 x^{2} - 16 x}{16 x^{7} - 84 x^{6} + 184 x^{5} - 217 x^{4} + 148 x^{3} - 58 x^{2} + 12 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 1312 x^{8} + 5992 x^{7} - 10672 x^{6} + 8938 x^{5} - 2976 x^{4} - 2 x^{3} + 100 x^{2} + 16 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A183886.
