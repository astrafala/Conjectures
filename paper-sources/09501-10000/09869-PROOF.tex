...
\title{The empirical recurrence for OEIS A268948, derived from the entry's generating function}
...
\begin{abstract}
OEIS A268948 carries an empirical recurrence of order $8$. The entry separately records a
...
OEIS A268948 is ``Number of length-7 0..n arrays with no repeated value unequal to the previous repeated value plus one mod n+1.''. It has offset $1$ and begins
\[
30, 969, 9684, 54045, 213042, 667065, 1773384, 4171869,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 17 2019 05:14:30, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{3 x^{8} - 24 x^{7} - 165 x^{6} - 330 x^{5} + 2025 x^{4} + 2772 x^{3} + 729 x^{2} + 30 x}{x^{8} - 8 x^{7} + 28 x^{6} - 56 x^{5} + 70 x^{4} - 56 x^{3} + 28 x^{2} - 8 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;3 x^{8} - 24 x^{7} - 165 x^{6} - 330 x^{5} + 2025 x^{4} + 2772 x^{3} + 729 x^{2} + 30 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268948.
