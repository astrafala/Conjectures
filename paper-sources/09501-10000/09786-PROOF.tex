...
\title{The empirical recurrence for OEIS A295046, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A295046 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A295046 is ``Number of n X 3 0..1 arrays with each 1 horizontally or vertically adjacent to 0 or 2 1s.''. It has offset $1$ and begins
\[
5, 19, 72, 270, 1027, 3879, 14691, 55589,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) + 4*a(n-2) - 3*a(n-3) - 2*a(n-4) - 6*a(n-5) + 3*a(n-6) - a(n-7) + a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 22 2019 06:03:06, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 4\,a(n-2) - 3\,a(n-3) - 2\,a(n-4) - 6\,a(n-5) + 3\,a(n-6) - a(n-7) + a(n-9)
\end{equation}
for all $n>10$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A295046.
