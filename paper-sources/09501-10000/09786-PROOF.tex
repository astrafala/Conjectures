...
\title{The empirical recurrence for OEIS A250340, derived from the entry's generating function}
...
\begin{abstract}
OEIS A250340 carries an empirical recurrence of order $9$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 12 2018 15:39:53, revision 7) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{9} + 9 x^{8} - 65 x^{7} - 227 x^{6} + 2357 x^{5} + 2703 x^{4} - 4335 x^{3} - 2861 x^{2} - 172 x}{x^{9} - 9 x^{8} + 36 x^{7} - 84 x^{6} + 126 x^{5} - 126 x^{4} + 84 x^{3} - 36 x^{2} + 9 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;x^{9} - 9 x^{8} + 65 x^{7} + 227 x^{6} - 2357 x^{5} - 2703 x^{4} + 4335 x^{3} + 2861 x^{2} + 172 x,
\]
