...
\title{The empirical recurrence for OEIS A183901, derived from the entry's generating function}
...
\begin{abstract}
OEIS A183901 carries an empirical recurrence of order $7$. The entry separately records a
...
OEIS A183901 is ``Number of nondecreasing arrangements of n+3 numbers in 0..6 with each number being the sum mod 7 of three others.''. It has offset $1$ and begins
\[
1, 1, 136, 664, 1720, 3491, 6263, 10400,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 05 2018 11:13:21, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{33 x^{10} - 102 x^{9} - 60 x^{8} + 548 x^{7} - 649 x^{6} + 72 x^{5} + 302 x^{4} - 150 x^{3} + 6 x^{2} - x}{x^{7} - 7 x^{6} + 21 x^{5} - 35 x^{4} + 35 x^{3} - 21 x^{2} + 7 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 33 x^{10} + 102 x^{9} + 60 x^{8} - 548 x^{7} + 649 x^{6} - 72 x^{5} - 302 x^{4} + 150 x^{3} - 6 x^{2} + x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A183901.
