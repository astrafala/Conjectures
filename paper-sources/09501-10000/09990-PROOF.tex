...
\title{The empirical recurrence for OEIS A208827, derived from the entry's generating function}
...
\begin{abstract}
OEIS A208827 carries an empirical recurrence of order $6$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 07 2018 06:15:43, revision 13) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{6} + 6 x^{5} - 2 x^{4} + 96 x^{3} + 59 x^{2} + 18 x}{x^{6} - 6 x^{5} + 15 x^{4} - 20 x^{3} + 15 x^{2} - 6 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- x^{6} + 6 x^{5} - 2 x^{4} + 96 x^{3} + 59 x^{2} + 18 x,
\]
