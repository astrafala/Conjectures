...
\title{The empirical recurrence for OEIS A267235, derived from the entry's generating function}
...
\begin{abstract}
OEIS A267235 carries an empirical recurrence of order $7$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 10 2019 15:22:24, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{5} - 147 x^{4} - 397 x^{3} - 167 x^{2} - 8 x}{x^{7} - 7 x^{6} + 21 x^{5} - 35 x^{4} + 35 x^{3} - 21 x^{2} + 7 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;x^{5} + 147 x^{4} + 397 x^{3} + 167 x^{2} + 8 x,
\]
