...
\title{The empirical recurrence for OEIS A201372, derived from the entry's generating function}
...
\begin{abstract}
OEIS A201372 carries an empirical recurrence of order $7$. The entry separately records a
...
OEIS A201372 is ``Number of n X 5 0..1 arrays with rows and columns lexicographically nondecreasing read forwards, and nonincreasing read backwards.''. It has offset $1$ and begins
\[
2, 6, 22, 80, 268, 786, 2016, 4608,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 22 2018 20:37:20, revision 12) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{12 x^{6} - 30 x^{5} + 18 x^{4} - 22 x^{3} + 8 x^{2} - 2 x}{x^{7} - 7 x^{6} + 21 x^{5} - 35 x^{4} + 35 x^{3} - 21 x^{2} + 7 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 12 x^{6} + 30 x^{5} - 18 x^{4} + 22 x^{3} - 8 x^{2} + 2 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A201372.
