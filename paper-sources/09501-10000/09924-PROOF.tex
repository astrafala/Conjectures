...
\title{The empirical recurrence for OEIS A207725, proved by transfer matrix}
...
\begin{abstract}
OEIS A207725 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
$(0,0,0), (0,1,0)$ along one axis and $(0,1,1), (1,0,1)$ along the other, and carries an empirical recurrence of
...
OEIS A207725 is ``Number of n X 4 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 1 1 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
9, 81, 169, 441, 1225, 2809, 6241,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) - 2*a(n-2) + 3*a(n-3) - 6*a(n-4) + 3*a(n-7) + a(n-8) - a(n-10).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 25 2018 12:23:28, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207725.
