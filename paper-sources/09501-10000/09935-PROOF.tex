...
\title{The empirical recurrence for OEIS A229423, derived from the entry's generating function}
...
\begin{abstract}
OEIS A229423 carries an empirical recurrence of order $7$. The entry separately records a
...
OEIS A229423 is ``Number of n X 3 0..2 arrays with horizontal differences mod 3 never 1, vertical differences mod 3 never -1, rows lexicographically nondecreasing, and columns lexicographically nonincreasing.''. It has offset $1$ and begins
\[
8, 27, 83, 222, 524, 1116, 2187, 4005,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 15 2018 08:44:33, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 3 x^{7} + 18 x^{6} - 48 x^{5} + 72 x^{4} - 62 x^{3} + 29 x^{2} - 8 x}{x^{7} - 7 x^{6} + 21 x^{5} - 35 x^{4} + 35 x^{3} - 21 x^{2} + 7 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;3 x^{7} - 18 x^{6} + 48 x^{5} - 72 x^{4} + 62 x^{3} - 29 x^{2} + 8 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A229423.
