...
\title{The empirical recurrence for OEIS A212839, derived from the entry's generating function}
...
\begin{abstract}
OEIS A212839 carries an empirical recurrence of order $7$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 21 2018 10:07:30, revision 12) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{x^{7} - 9 x^{6} + 12 x^{5} + 130 x^{4} - 627 x^{3} - 225 x^{2} - 2 x}{x^{7} - 7 x^{6} + 21 x^{5} - 35 x^{4} + 35 x^{3} - 21 x^{2} + 7 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- x^{7} + 9 x^{6} - 12 x^{5} - 130 x^{4} + 627 x^{3} + 225 x^{2} + 2 x,
\]
