...
\title{The empirical recurrence for OEIS A241966, derived from the entry's generating function}
...
\begin{abstract}
OEIS A241966 carries an empirical recurrence of order $7$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 31 2018 06:33:43, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{7} + 7 x^{6} - 21 x^{5} + 25 x^{4} - 113 x^{3} - 80 x^{2} - 33 x}{x^{7} - 7 x^{6} + 21 x^{5} - 35 x^{4} + 35 x^{3} - 21 x^{2} + 7 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;x^{7} - 7 x^{6} + 21 x^{5} - 25 x^{4} + 113 x^{3} + 80 x^{2} + 33 x,
\]
