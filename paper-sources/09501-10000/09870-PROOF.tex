...
\title{The empirical recurrence for OEIS A269413, derived from the entry's generating function}
...
\begin{abstract}
OEIS A269413 carries an empirical recurrence of order $8$. The entry separately records a
...
OEIS A269413 is ``Number of length-7 0..n arrays with no repeated value greater than or equal to the previous repeated value.''. It has offset $1$ and begins
\[
20, 957, 10132, 56890, 223320, 695135, 1837752, 4302612,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 21 2019 12:25:20, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 27 x^{6} - 296 x^{5} + 1510 x^{4} + 3036 x^{3} + 797 x^{2} + 20 x}{x^{8} - 8 x^{7} + 28 x^{6} - 56 x^{5} + 70 x^{4} - 56 x^{3} + 28 x^{2} - 8 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 27 x^{6} - 296 x^{5} + 1510 x^{4} + 3036 x^{3} + 797 x^{2} + 20 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269413.
