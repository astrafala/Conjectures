...
\title{The empirical recurrence for OEIS A202456, derived from the entry's generating function}
...
\begin{abstract}
OEIS A202456 carries an empirical recurrence of order $6$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 01 2018 07:59:14, revision 11) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 517 x^{6} + 2838 x^{5} - 6297 x^{4} + 7106 x^{3} - 4124 x^{2} + 1000 x}{x^{6} - 6 x^{5} + 15 x^{4} - 20 x^{3} + 15 x^{2} - 6 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 517 x^{6} + 2838 x^{5} - 6297 x^{4} + 7106 x^{3} - 4124 x^{2} + 1000 x,
\]
