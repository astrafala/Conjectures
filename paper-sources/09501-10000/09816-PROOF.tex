...
\title{The empirical recurrence for OEIS A258538, proved by transfer matrix}
...
\begin{abstract}
OEIS A258538 counts arrays of width $3$ over $\{0,1\}$ in which every $3\times3$ window has
...
OEIS A258538 is ``Number of (n+2) X (1+2) 0..1 arrays with no 3 x 3 subblock diagonal sum less than the antidiagonal sum or central row sum equal to the central column sum.''. It has offset $1$ and begins
\[
220, 784, 2520, 8100, 25056, 77284, 234848, 712336,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 5*a(n-1) - 32*a(n-3) + 34*a(n-4) + 54*a(n-5) - 96*a(n-6) + 63*a(n-8) - 27*a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 21 2018 20:03:58, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) - 32\,a(n-3) + 34\,a(n-4) + 54\,a(n-5) - 96\,a(n-6) + 63\,a(n-8) - 27\,a(n-9)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A258538.
