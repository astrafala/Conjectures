...
\title{The empirical recurrence for OEIS A184545, derived from the entry's generating function}
...
\begin{abstract}
OEIS A184545 carries an empirical recurrence of order $9$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 14 2018 02:37:12, revision 12) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 64 x^{9} + 641 x^{8} - 2861 x^{7} + 7310 x^{6} - 11605 x^{5} + 11699 x^{4} - 7327 x^{3} + 2621 x^{2} - 415 x}{x^{9} - 9 x^{8} + 36 x^{7} - 84 x^{6} + 126 x^{5} - 126 x^{4} + 84 x^{3} - 36 x^{2} + 9 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;64 x^{9} - 641 x^{8} + 2861 x^{7} - 7310 x^{6} + 11605 x^{5} - 11699 x^{4} + 7327 x^{3} - 2621 x^{2} + 415 x,
\]
