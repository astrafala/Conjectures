...
\title{The empirical recurrence for OEIS A252189, proved by transfer matrix}
...
\begin{abstract}
OEIS A252189 counts $(n+2)\times7$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
$a(n)$ is a walk count on $S=18102$ vertices. Such a sequence is $C$-finite, so whether a given
...
OEIS A252189 is ``Number of (n+2)X(5+2) 0..3 arrays with every 3X3 subblock row and column sum equal to 0 1 3 6 or 7 and every 3X3 diagonal and antidiagonal sum not equal to 0 1 3 6 or 7.''. It has offset $1$ and begins
\[
5300, 6368, 8945, 14130, 24956, 37035, 57284, 99128,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 15*a(n-3) -70*a(n-6) +120*a(n-9) -64*a(n-12) for n>22
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 10:54:14, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252189.
