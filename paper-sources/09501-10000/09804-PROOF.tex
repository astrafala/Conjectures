...
\title{The empirical recurrence for OEIS A200435, derived from the entry's generating function}
...
\begin{abstract}
OEIS A200435 carries an empirical recurrence of order $8$. The entry separately records a
...
OEIS A200435 is ``Number of -n..n arrays x(0..7) of 8 elements with zero sum and no two or three adjacent elements summing to zero.''. It has offset $1$ and begins
\[
0, 1928, 50592, 473034, 2591502, 10217182, 32233938, 86581308,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 21 2018 09:22:37, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{2106 x^{7} + 31926 x^{6} + 115838 x^{5} + 122282 x^{4} + 35168 x^{3} + 1928 x^{2}}{x^{8} - 8 x^{7} + 28 x^{6} - 56 x^{5} + 70 x^{4} - 56 x^{3} + 28 x^{2} - 8 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;2106 x^{7} + 31926 x^{6} + 115838 x^{5} + 122282 x^{4} + 35168 x^{3} + 1928 x^{2},
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A200435.
