...
\title{The empirical recurrence for OEIS A252815, derived from the entry's generating function}
...
\begin{abstract}
OEIS A252815 carries an empirical recurrence of order $7$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 06 2018 10:10:12, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 2 x^{7} + 11 x^{6} - 27 x^{5} + 37 x^{4} - 28 x^{3} + 11 x^{2} - 4 x}{x^{7} - 7 x^{6} + 21 x^{5} - 35 x^{4} + 35 x^{3} - 21 x^{2} + 7 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;2 x^{7} - 11 x^{6} + 27 x^{5} - 37 x^{4} + 28 x^{3} - 11 x^{2} + 4 x,
\]
