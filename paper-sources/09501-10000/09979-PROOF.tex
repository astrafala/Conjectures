...
\title{The empirical recurrence for OEIS A234883, proved by transfer matrix}
...
\begin{abstract}
OEIS A234883 counts $2$-column arrays over $\{0,\dots,5\}$ in which every
...
OEIS A234883 is ``Number of (n+1) X (1+1) 0..5 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 1, with no adjacent elements equal (constant-stress tilted 1 X 1 tilings).''. It has offset
$1$ and begins
\[
80, 272, 856, 2896, 9192, 31064, 98696,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 14*a(n-2) - 37*a(n-4) + 21*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 19 2022 01:18:50, revision 11) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234883.
