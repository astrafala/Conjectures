...
\title{The empirical recurrence for OEIS A252249, proved by transfer matrix}
...
\begin{abstract}
OEIS A252249 counts $(n+2)\times5$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252249 is ``Number of (n+2) X (3+2) 0..3 arrays with every 3 X 3 subblock row and column sum not equal to 0 3 5 6 or 7 and every 3 X 3 diagonal and antidiagonal sum equal to 0 3 5 6 or 7.''. It has offset $1$ and begins
\[
278, 242, 231, 249, 279, 318, 366, 444,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + 3*a(n-3) - 3*a(n-4) - a(n-6) + a(n-7) for n>9.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 02 2018 13:51:33, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252249.
