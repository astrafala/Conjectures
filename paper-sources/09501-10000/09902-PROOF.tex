...
\title{The empirical recurrence for OEIS A317761, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A317761 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A317761 is ``Number of n X 5 0..1 arrays with every element unequal to 0, 1 or 2 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
16, 42, 52, 72, 109, 177, 302, 532,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) - a(n-4) for n > 6.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 12 2021 02:23:10, revision 18) the statement is
...
\#\{\text{neighbours with a value }different from\ x_{t,u}\}\in\{0,1,2\}
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A317761.
