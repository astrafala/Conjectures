...
\title{The empirical recurrence for OEIS A201045, derived from the entry's generating function}
...
\begin{abstract}
OEIS A201045 carries an empirical recurrence of order $7$. The entry separately records a
...
OEIS A201045 is ``Number of -n..n arrays of 6 elements with adjacent element differences also in -n..n.''. It has offset $1$ and begins
\[
239, 4569, 33305, 148433, 491429, 1333683, 3139529, 6641881,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 22 2018 03:49:35, revision 9) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{7} + 6 x^{6} - 253 x^{5} - 2882 x^{4} - 6341 x^{3} - 2896 x^{2} - 239 x}{x^{7} - 7 x^{6} + 21 x^{5} - 35 x^{4} + 35 x^{3} - 21 x^{2} + 7 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;x^{7} - 6 x^{6} + 253 x^{5} + 2882 x^{4} + 6341 x^{3} + 2896 x^{2} + 239 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A201045.
