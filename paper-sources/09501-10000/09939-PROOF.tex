...
\title{The empirical recurrence for OEIS A211838, derived from the entry's generating function}
...
\begin{abstract}
OEIS A211838 carries an empirical recurrence of order $7$. The entry separately records a
...
OEIS A211838 is ``Number of nonnegative integer arrays of length n+5 with new values 0 upwards introduced in order, no three adjacent elements equal, and containing the value n+1.''. It has offset $1$ and begins
\[
146, 461, 1254, 2997, 6451, 12766, 23596, 41229,\ \dots
\]
...
\begin{quote}
G.f.: x*(146 - 561*x + 1093*x\^{}2 - 1210*x\^{}3 + 781*x\^{}4 - 275*x\^{}5 + 41*x\^{}6) / (1 - x)\^{}7.
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 20 2018 06:01:59, revision 7) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 41 x^{7} + 275 x^{6} - 781 x^{5} + 1210 x^{4} - 1093 x^{3} + 561 x^{2} - 146 x}{x^{7} - 7 x^{6} + 21 x^{5} - 35 x^{4} + 35 x^{3} - 21 x^{2} + 7 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;41 x^{7} - 275 x^{6} + 781 x^{5} - 1210 x^{4} + 1093 x^{3} - 561 x^{2} + 146 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A211838.
