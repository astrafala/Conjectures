...
\title{The empirical recurrence for OEIS A249851, derived from the entry's generating function}
...
\begin{abstract}
OEIS A249851 carries an empirical recurrence of order $12$. The entry separately records a
...
\begin{quote}
G.f.: x*(10 + 3846*x + 176573*x\^{}2 + 2104937*x\^{}3 + 8824523*x\^{}4 + 14875683*x\^{}5 + 10543155*x\^{}6 + 3058279*x\^{}7 + 321259*x\^{}8 + 8535*x\^{}9) / (1 - x)\^{}12.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 18 2017 18:11:20, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{8535 x^{10} + 321259 x^{9} + 3058279 x^{8} + 10543155 x^{7} + 14875683 x^{6} + 8824523 x^{5} + 2104937 x^{4} + 176573 x^{3} + 3846 x^{2} + 10 x}{x^{12} - 12 x^{11} + 66 x^{10} - 220 x^{9} + 495 x^{8} - 792 x^{7} + 924 x^{6} - 792 x^{5} + 495 x^{4} - 220 x^{3} + 66 x^{2} - 12 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;8535 x^{10} + 321259 x^{9} + 3058279 x^{8} + 10543155 x^{7} + 14875683 x^{6} + 8824523 x^{5} + 2104937 x^{4} + 176573 x^{3} + 3846 x^{2} + 10 x,
\]
