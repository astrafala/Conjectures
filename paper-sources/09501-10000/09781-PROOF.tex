...
\title{The empirical recurrence for OEIS A252816, derived from the entry's generating function}
...
\begin{abstract}
OEIS A252816 carries an empirical recurrence of order $9$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 06 2018 10:10:19, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 2 x^{9} + 18 x^{8} - 67 x^{7} + 138 x^{6} - 176 x^{5} + 147 x^{4} - 79 x^{3} + 23 x^{2} - 7 x}{x^{9} - 9 x^{8} + 36 x^{7} - 84 x^{6} + 126 x^{5} - 126 x^{4} + 84 x^{3} - 36 x^{2} + 9 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;2 x^{9} - 18 x^{8} + 67 x^{7} - 138 x^{6} + 176 x^{5} - 147 x^{4} + 79 x^{3} - 23 x^{2} + 7 x,
\]
