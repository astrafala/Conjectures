...
\title{The empirical recurrence for OEIS A250063, derived from the entry's generating function}
...
\begin{abstract}
OEIS A250063 carries an empirical recurrence of order $12$. The entry separately records a
...
OEIS A250063 is ``Number of length 5+6 0..n arrays with no seven consecutive terms having the maximum of any two terms equal to the minimum of the remaining five terms.''. It has offset $1$ and begins
\[
21, 7054, 348066, 6415638, 65419155, 449532868, 2330996068, 9790907652,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 22 2017 06:35:59, revision 11) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{2720 x^{10} + 209945 x^{9} + 2483826 x^{8} + 9550828 x^{7} + 14835694 x^{6} + 9862370 x^{5} + 2699790 x^{4} + 264804 x^{3} + 6802 x^{2} + 21 x}{x^{12} - 12 x^{11} + 66 x^{10} - 220 x^{9} + 495 x^{8} - 792 x^{7} + 924 x^{6} - 792 x^{5} + 495 x^{4} - 220 x^{3} + 66 x^{2} - 12 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;2720 x^{10} + 209945 x^{9} + 2483826 x^{8} + 9550828 x^{7} + 14835694 x^{6} + 9862370 x^{5} + 2699790 x^{4} + 264804 x^{3} + 6802 x^{2} + 21 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250063.
