...
\title{The empirical recurrence for OEIS A226988, derived from the entry's generating function}
...
\begin{abstract}
OEIS A226988 carries an empirical recurrence of order $8$. The entry separately records a
...
OEIS A226988 is ``Number of n X 2 0..4 arrays of sums of 2 X 2 subblocks of some (n+1) X 3 binary array with rows and columns of the latter in lexicographically nondecreasing order.''. It has offset $1$ and begins
\[
10, 42, 120, 313, 729, 1556, 3099, 5818,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 06 2018 10:56:54, revision 7) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 2 x^{12} + 12 x^{11} - 26 x^{10} + 12 x^{9} + 56 x^{8} - 137 x^{7} + 148 x^{6} - 67 x^{5} - 31 x^{4} + 64 x^{3} - 38 x^{2} + 10 x}{x^{8} - 8 x^{7} + 28 x^{6} - 56 x^{5} + 70 x^{4} - 56 x^{3} + 28 x^{2} - 8 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 2 x^{12} + 12 x^{11} - 26 x^{10} + 12 x^{9} + 56 x^{8} - 137 x^{7} + 148 x^{6} - 67 x^{5} - 31 x^{4} + 64 x^{3} - 38 x^{2} + 10 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A226988.
