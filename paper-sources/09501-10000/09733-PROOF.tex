...
\title{The empirical recurrence for OEIS A044140, derived from the entry's generating function}
...
\begin{abstract}
OEIS A044140 carries an empirical recurrence of order $9$. The entry separately records a
...
OEIS A044140 is ``Numbers k such that substring "02" occurs in the base-7 representation of k but not of k-1.''. It has offset $1$ and begins
\[
51, 100, 149, 198, 247, 296, 345, 357,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 20 2019 07:11:07, revision 18) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 14 x^{9} + 12 x^{8} + 49 x^{7} + 49 x^{6} + 49 x^{5} + 49 x^{4} + 49 x^{3} + 49 x^{2} + 51 x}{x^{9} - x^{8} - x + 1},
\]
the entry's own generating function, and let
\[
D(x)\;=\;1-\sum_i c_i x^{i}\;=\;x^{9} - x^{8} - x + 1
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 14 x^{9} + 12 x^{8} + 49 x^{7} + 49 x^{6} + 49 x^{5} + 49 x^{4} + 49 x^{3} + 49 x^{2} + 51 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A044140.
