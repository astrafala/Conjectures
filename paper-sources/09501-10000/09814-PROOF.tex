...
\title{The empirical recurrence for OEIS A202458, derived from the entry's generating function}
...
\begin{abstract}
OEIS A202458 carries an empirical recurrence of order $8$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 31 2018 14:04:13, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 715 x^{8} + 5408 x^{7} - 17650 x^{6} + 32318 x^{5} - 36022 x^{4} + 24626 x^{3} - 9687 x^{2} + 1728 x}{x^{8} - 8 x^{7} + 28 x^{6} - 56 x^{5} + 70 x^{4} - 56 x^{3} + 28 x^{2} - 8 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 715 x^{8} + 5408 x^{7} - 17650 x^{6} + 32318 x^{5} - 36022 x^{4} + 24626 x^{3} - 9687 x^{2} + 1728 x,
\]
