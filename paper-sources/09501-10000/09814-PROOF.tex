...
\title{The empirical recurrence for OEIS A227056, derived from the entry's generating function}
...
\begin{abstract}
OEIS A227056 carries an empirical recurrence of order $8$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 07 2018 03:04:19, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{8} + 9 x^{7} - 35 x^{6} + 77 x^{5} - 103 x^{4} + 84 x^{3} - 40 x^{2} + 10 x}{x^{8} - 8 x^{7} + 28 x^{6} - 56 x^{5} + 70 x^{4} - 56 x^{3} + 28 x^{2} - 8 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- x^{8} + 9 x^{7} - 35 x^{6} + 77 x^{5} - 103 x^{4} + 84 x^{3} - 40 x^{2} + 10 x,
\]
