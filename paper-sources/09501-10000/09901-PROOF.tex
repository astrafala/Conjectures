...
\title{The empirical recurrence for OEIS A070931, derived from the entry's generating function}
...
\begin{abstract}
OEIS A070931 carries an empirical recurrence of order $7$. The entry separately records a
...
OEIS A070931 is ``Numbers k such that the smallest integer value >= 0 of the form x\^{}3 - k\^{}2 equals the smallest integer value >= 0 of the form x\^{}2 - k\^{}3.''. It has offset $1$ and begins
\[
1, 64, 68, 120, 729, 4096, 15625, 46656,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 08 2019 17:55:54, revision 16) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{56 x^{11} - 325 x^{10} + 771 x^{9} - 1001 x^{8} + 895 x^{7} - 1352 x^{6} + 888 x^{5} - 953 x^{4} + 359 x^{3} - 57 x^{2} - x}{x^{7} - 7 x^{6} + 21 x^{5} - 35 x^{4} + 35 x^{3} - 21 x^{2} + 7 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 56 x^{11} + 325 x^{10} - 771 x^{9} + 1001 x^{8} - 895 x^{7} + 1352 x^{6} - 888 x^{5} + 953 x^{4} - 359 x^{3} + 57 x^{2} + x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A070931.
