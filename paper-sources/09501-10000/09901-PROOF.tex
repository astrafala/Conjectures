...
\title{The empirical recurrence for OEIS A200889, derived from the entry's generating function}
...
\begin{abstract}
OEIS A200889 carries an empirical recurrence of order $7$. The entry separately records a
...
OEIS A200889 is ``Number of 0..n arrays x(0..5) of 6 elements without any interior element greater than both neighbors.''. It has offset $1$ and begins
\[
37, 292, 1268, 3985, 10213, 22736, 45648, 84681,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 16 2017 12:23:14, revision 10) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{7} + 7 x^{6} - 21 x^{5} + 54 x^{4} - x^{3} - 33 x^{2} - 37 x}{x^{7} - 7 x^{6} + 21 x^{5} - 35 x^{4} + 35 x^{3} - 21 x^{2} + 7 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;x^{7} - 7 x^{6} + 21 x^{5} - 54 x^{4} + x^{3} + 33 x^{2} + 37 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A200889.
