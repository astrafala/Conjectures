...
\title{The empirical recurrence for OEIS A184547, derived from the entry's generating function}
...
\begin{abstract}
OEIS A184547 carries an empirical recurrence of order $11$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 14 2018 07:33:49, revision 9) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 91 x^{11} + 1104 x^{10} - 6118 x^{9} + 20156 x^{8} - 43442 x^{7} + 63833 x^{6} - 64744 x^{5} + 44828 x^{4} - 20347 x^{3} + 5502 x^{2} - 682 x}{x^{11} - 11 x^{10} + 55 x^{9} - 165 x^{8} + 330 x^{7} - 462 x^{6} + 462 x^{5} - 330 x^{4} + 165 x^{3} - 55 x^{2} + 11 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;91 x^{11} - 1104 x^{10} + 6118 x^{9} - 20156 x^{8} + 43442 x^{7} - 63833 x^{6} + 64744 x^{5} - 44828 x^{4} + 20347 x^{3} - 5502 x^{2} + 682 x,
\]
