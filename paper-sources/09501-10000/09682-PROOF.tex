...
\title{The empirical recurrence for OEIS A243635, proved by transfer matrix}
...
\begin{abstract}
OEIS A243635 carries an empirical recurrence of order $6$ contributed by R.~H.~Hardin. It is
...
OEIS A243635 is ``Number of length n+2 0..4 arrays with no three unequal elements in a row and new values 0..4 introduced in 0..4 order.''. It has offset $1$ and begins
\[
4, 9, 21, 51, 127, 324, 844, 2242,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 7*a(n-1) - 14*a(n-2) + 21*a(n-4) - 7*a(n-5) - 6*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 02 2018 11:52:24, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A243635.
