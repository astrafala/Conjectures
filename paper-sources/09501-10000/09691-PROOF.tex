...
\title{The empirical recurrence for OEIS A234381, proved by transfer matrix}
...
\begin{abstract}
OEIS A234381 counts arrays of width $3$ over $\{0,1,2\}$ containing no run of $3$ consecutive
...
OEIS A234381 is ``Number of (1+2) X (n+2) 0..2 arrays with no increasing sequence of length 3 vertically, diagonally downwards or antidiagonally downwards.''. It has offset $1$ and begins
\[
16584, 406416, 9995040, 245837376, 6045322368, 148657436928, 3655605662208, 89894348448768,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 24*a(n-1) - 12*a(n-2) + 624*a(n-3) + 1056*a(n-4) - 8448*a(n-5) - 9216*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 20 2025 13:53:02, revision 20) this is still
...
\begin{theorem}
\[
a(n)\;=\;24\,a(n-1) - 12\,a(n-2) + 624\,a(n-3) + 1056\,a(n-4) - 8448\,a(n-5) - 9216\,a(n-6)
\]
for every $n>3$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234381.
