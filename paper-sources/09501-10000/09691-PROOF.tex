...
\title{The empirical recurrence for OEIS A229425, derived from the entry's generating function}
...
\begin{abstract}
OEIS A229425 carries an empirical recurrence of order $11$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 15 2018 08:45:48, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 4 x^{11} + 40 x^{10} - 186 x^{9} + 525 x^{8} - 987 x^{7} + 1284 x^{6} - 1172 x^{5} + 755 x^{4} - 337 x^{3} + 85 x^{2} - 17 x}{x^{11} - 11 x^{10} + 55 x^{9} - 165 x^{8} + 330 x^{7} - 462 x^{6} + 462 x^{5} - 330 x^{4} + 165 x^{3} - 55 x^{2} + 11 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;4 x^{11} - 40 x^{10} + 186 x^{9} - 525 x^{8} + 987 x^{7} - 1284 x^{6} + 1172 x^{5} - 755 x^{4} + 337 x^{3} - 85 x^{2} + 17 x,
\]
