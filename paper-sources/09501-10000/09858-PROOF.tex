...
\title{The empirical recurrence for OEIS A267236, derived from the entry's generating function}
...
\begin{abstract}
OEIS A267236 carries an empirical recurrence of order $8$. The entry separately records a
...
\begin{quote}
G.f.: x*(9 + 407*x + 2066*x\^{}2 + 2136*x\^{}3 + 421*x\^{}4 + x\^{}5) / (1 - x)\^{}8.
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 10 2019 15:22:31, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{x^{6} + 421 x^{5} + 2136 x^{4} + 2066 x^{3} + 407 x^{2} + 9 x}{x^{8} - 8 x^{7} + 28 x^{6} - 56 x^{5} + 70 x^{4} - 56 x^{3} + 28 x^{2} - 8 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;x^{6} + 421 x^{5} + 2136 x^{4} + 2066 x^{3} + 407 x^{2} + 9 x,
\]
