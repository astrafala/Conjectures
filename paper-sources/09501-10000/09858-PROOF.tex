...
\title{The empirical recurrence for OEIS A303417, proved by transfer matrix}
...
\begin{abstract}
OEIS A303417 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A303417 is ``Number of nX4 0..1 arrays with every element equal to 0, 1, 2, 3, 4 or 5 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
8, 128, 1985, 30897, 480960, 7486369, 116529645, 1813851698,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 14*a(n-1) +21*a(n-2) +54*a(n-3) -23*a(n-4) -18*a(n-5) -20*a(n-6)
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 23 2018 10:52:04, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A303417.
