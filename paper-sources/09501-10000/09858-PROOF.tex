...
\title{The empirical recurrence for OEIS A027481, derived from the entry's generating function}
...
\begin{abstract}
OEIS A027481 carries an empirical recurrence of order $7$. The entry separately records a
...
OEIS A027481 is ``Second subdiagonal of triangle A027477, constructed from the Stirling numbers of the first kind.''. It has offset $3$ and begins
\[
23, 215, 1035, 3535, 9730, 23058, 48930, 95370,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 08 2021 11:45:48, revision 19) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 13 x^{5} - 54 x^{4} - 23 x^{3}}{x^{7} - 7 x^{6} + 21 x^{5} - 35 x^{4} + 35 x^{3} - 21 x^{2} + 7 x - 1},
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A027481.
