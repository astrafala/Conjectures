...
\title{The empirical recurrence for OEIS A269439, derived from the entry's generating function}
...
\begin{abstract}
OEIS A269439 carries an empirical recurrence of order $8$. The entry separately records a
...
OEIS A269439 is ``Number of length-7 0..n arrays with no repeated value greater than the previous repeated value.''. It has offset $1$ and begins
\[
92, 1722, 13868, 69235, 255576, 767172, 1981512, 4566213,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 22 2019 06:25:35, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{8} + 8 x^{7} - 76 x^{6} + 8 x^{5} + 1355 x^{4} + 2668 x^{3} + 986 x^{2} + 92 x}{x^{8} - 8 x^{7} + 28 x^{6} - 56 x^{5} + 70 x^{4} - 56 x^{3} + 28 x^{2} - 8 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- x^{8} + 8 x^{7} - 76 x^{6} + 8 x^{5} + 1355 x^{4} + 2668 x^{3} + 986 x^{2} + 92 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269439.
