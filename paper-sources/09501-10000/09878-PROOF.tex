...
\title{The empirical recurrence for OEIS A200434, derived from the entry's generating function}
...
\begin{abstract}
OEIS A200434 carries an empirical recurrence of order $7$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 21 2018 08:48:14, revision 9) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 606 x^{6} - 5568 x^{5} - 11040 x^{4} - 5740 x^{3} - 594 x^{2}}{x^{7} - 7 x^{6} + 21 x^{5} - 35 x^{4} + 35 x^{3} - 21 x^{2} + 7 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;606 x^{6} + 5568 x^{5} + 11040 x^{4} + 5740 x^{3} + 594 x^{2},
\]
