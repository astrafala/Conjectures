...
\title{The empirical recurrence for OEIS A269660, derived from the entry's generating function}
...
\begin{abstract}
OEIS A269660 carries an empirical recurrence of order $8$. The entry separately records a
...
OEIS A269660 is ``Number of length-7 0..n arrays with no adjacent pair x,x+1 repeated.''. It has offset $1$ and begins
\[
64, 1710, 14596, 73348, 269472, 803434, 2061940, 4725456,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 26 2019 05:02:47, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{8 x^{8} - 52 x^{7} + 142 x^{6} + 96 x^{5} + 876 x^{4} + 2708 x^{3} + 1198 x^{2} + 64 x}{x^{8} - 8 x^{7} + 28 x^{6} - 56 x^{5} + 70 x^{4} - 56 x^{3} + 28 x^{2} - 8 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;8 x^{8} - 52 x^{7} + 142 x^{6} + 96 x^{5} + 876 x^{4} + 2708 x^{3} + 1198 x^{2} + 64 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269660.
