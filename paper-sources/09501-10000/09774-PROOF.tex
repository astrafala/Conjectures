...
\title{The empirical recurrence for OEIS A245875, derived from the entry's generating function}
...
\begin{abstract}
OEIS A245875 carries an empirical recurrence of order $9$. The entry separately records a
...
OEIS A245875 is ``Number of length 6+2 0..n arrays with some pair in every consecutive three terms totalling exactly n.''. It has offset $1$ and begins
\[
68, 1281, 4624, 13961, 30900, 63241, 113024, 193137,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 04 2018 14:15:32, revision 7) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{9} + 3 x^{8} + 103 x^{7} - 561 x^{6} - 1143 x^{5} + 633 x^{4} + 781 x^{3} + 1077 x^{2} + 68 x}{x^{9} - 3 x^{8} + 8 x^{6} - 6 x^{5} - 6 x^{4} + 8 x^{3} - 3 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- x^{9} + 3 x^{8} + 103 x^{7} - 561 x^{6} - 1143 x^{5} + 633 x^{4} + 781 x^{3} + 1077 x^{2} + 68 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A245875.
