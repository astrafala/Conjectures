...
\title{The empirical recurrence for OEIS A304143, proved by transfer matrix}
...
\begin{abstract}
OEIS A304143 counts $2$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A304143 is ``Number of nX2 0..1 arrays with every element unequal to 1, 2, 3 or 6 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 7, 14, 33, 70, 157, 346, 769,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) +3*a(n-2) -2*a(n-3) -6*a(n-4) -4*a(n-5) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (May 08 2018 13:38:13, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A304143.
