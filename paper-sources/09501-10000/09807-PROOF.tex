...
\title{The empirical recurrence for OEIS A214946, derived from the entry's generating function}
...
\begin{abstract}
OEIS A214946 carries an empirical recurrence of order $8$. The entry separately records a
...
OEIS A214946 is ``Number of squarefree words of length 7 in an (n+1)-ary alphabet.''. It has offset $1$ and begins
\[
0, 60, 1848, 15960, 80040, 292740, 868560, 2218608,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 22 2018 11:52:22, revision 10) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{12 x^{6} + 744 x^{5} + 2856 x^{4} + 1368 x^{3} + 60 x^{2}}{x^{8} - 8 x^{7} + 28 x^{6} - 56 x^{5} + 70 x^{4} - 56 x^{3} + 28 x^{2} - 8 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;12 x^{6} + 744 x^{5} + 2856 x^{4} + 1368 x^{3} + 60 x^{2},
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A214946.
