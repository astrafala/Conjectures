...
\title{The empirical recurrence for OEIS A231445, proved by transfer matrix}
...
\begin{abstract}
OEIS A231445 counts $(n+1)\times3$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A231445 is ``Number of (n+1) X (2+1) 0..3 arrays with no element unequal to a strict majority of its horizontal and antidiagonal neighbors, with values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
3, 15, 97, 715, 5643, 46075, 382341, 3196783,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 19*a(n-1) - 133*a(n-2) + 461*a(n-3) - 867*a(n-4) + 881*a(n-5) - 468*a(n-6) + 108*a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 29 2018 03:12:11, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;19\,a(n-1) - 133\,a(n-2) + 461\,a(n-3) - 867\,a(n-4) + 881\,a(n-5) - 468\,a(n-6) + 108\,a(n-7)
\]
for every $n>6$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231445.
