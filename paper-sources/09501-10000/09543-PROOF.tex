...
\title{The empirical recurrence for OEIS A303631, proved by transfer matrix}
...
\begin{abstract}
OEIS A303631 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the four horizontal and vertical neighbours, a number $different from$ itself lying in $\{2,3\}$, and it carries an empirical
...
OEIS A303631 is ``Number of n X 3 0..1 arrays with every element unequal to 2 or 3 horizontally or vertically adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
0, 1, 0, 1, 0, 3, 2, 9,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +2*a(n-2) +a(n-4) -a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 29 2023 00:27:18, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A303631.
