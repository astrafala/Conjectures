...
\title{The empirical recurrence for OEIS A230567, proved by transfer matrix}
...
\begin{abstract}
OEIS A230567 carries an empirical recurrence of order $7$ contributed by R.~H.~Hardin. It is
true, and it is decidable rather than empirical. The entry's condition is local to a bounded window of consecutive lines, so
the admissible configurations of such a window are the vertices of a finite digraph and the
arrays counted are exactly the walks in it; hence $a(n)$ is a walk count on $S=2315$ vertices
...
OEIS A230567 is ``Number of n X 4 0..4 arrays x(i,j) with each element horizontally or antidiagonally next to at least one element with value (x(i,j)+1) mod 5, and upper left element zero.''. It has offset $1$ and begins
\[
0, 0, 2, 32, 430, 5130, 58474, 651686,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 17*a(n-1) - 66*a(n-2) - 12*a(n-3) + 13*a(n-4) + 476*a(n-5) - 44*a(n-6) + a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 22 2018 10:51:15, revision 8) this is still
...
admissible array is then exactly a walk, so with $M$ the adjacency matrix on $S=2315$ vertices
...
\begin{theorem}
\[
a(n)\;=\;17\,a(n-1) - 66\,a(n-2) - 12\,a(n-3) + 13\,a(n-4) + 476\,a(n-5) - 44\,a(n-6) + a(n-7)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A230567.
