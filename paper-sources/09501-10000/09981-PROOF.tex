...
\title{The empirical recurrence for OEIS A201815, derived from the entry's generating function}
...
\begin{abstract}
OEIS A201815 carries an empirical recurrence of order $6$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 25 2018 11:13:36, revision 9) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{6} + 397 x^{5} + 1782 x^{4} + 4882 x^{3} + 1787 x^{2} + 393 x}{x^{6} - 6 x^{5} + 15 x^{4} - 20 x^{3} + 15 x^{2} - 6 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- x^{6} + 397 x^{5} + 1782 x^{4} + 4882 x^{3} + 1787 x^{2} + 393 x,
\]
