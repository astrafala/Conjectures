...
\title{The empirical recurrence for OEIS A254701, derived from the entry's generating function}
...
\begin{abstract}
OEIS A254701 carries an empirical recurrence of order $7$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 17 2018 09:23:14, revision 7) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{7} + 7 x^{6} - 27 x^{5} + 139 x^{4} - 34 x^{3} - 174 x^{2} - 54 x}{x^{7} - 7 x^{6} + 21 x^{5} - 35 x^{4} + 35 x^{3} - 21 x^{2} + 7 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;x^{7} - 7 x^{6} + 27 x^{5} - 139 x^{4} + 34 x^{3} + 174 x^{2} + 54 x,
\]
