...
\title{The empirical recurrence for OEIS A200874, derived from the entry's generating function}
...
\begin{abstract}
OEIS A200874 carries an empirical recurrence of order $7$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 16 2017 10:07:15, revision 10) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{7} + 7 x^{6} - 22 x^{5} + 28 x^{4} - 7 x^{3} + 19 x^{2} - 26 x}{x^{7} - 7 x^{6} + 21 x^{5} - 35 x^{4} + 35 x^{3} - 21 x^{2} + 7 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;x^{7} - 7 x^{6} + 22 x^{5} - 28 x^{4} + 7 x^{3} - 19 x^{2} + 26 x,
\]
