...
\title{The empirical recurrence for OEIS A269779, derived from the entry's generating function}
...
\begin{abstract}
OEIS A269779 carries an empirical recurrence of order $8$. The entry separately records a
...
OEIS A269779 is ``Number of length-7 0..n arrays with every repeated value unequal to the previous repeated value plus one mod n+1.''. It has offset $1$ and begins
\[
66, 1740, 14724, 73680, 270150, 804636, 2063880, 4728384,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 29 2019 09:26:58, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{36 x^{6} + 162 x^{5} + 912 x^{4} + 2652 x^{3} + 1212 x^{2} + 66 x}{x^{8} - 8 x^{7} + 28 x^{6} - 56 x^{5} + 70 x^{4} - 56 x^{3} + 28 x^{2} - 8 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;36 x^{6} + 162 x^{5} + 912 x^{4} + 2652 x^{3} + 1212 x^{2} + 66 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269779.
