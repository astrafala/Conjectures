...
\title{The empirical recurrence for OEIS A228223, derived from the entry's generating function}
...
\begin{abstract}
OEIS A228223 carries an empirical recurrence of order $7$. The entry separately records a
...
OEIS A228223 is ``Number of second differences of arrays of length 8 of numbers in 0..n.''. It has offset $1$ and begins
\[
255, 6305, 58975, 320481, 1225631, 3693505, 9399615, 21108545,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 10 2018 08:51:49, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{7} + 4616 x^{6} - 8989 x^{5} - 31136 x^{4} - 20195 x^{3} - 4520 x^{2} - 255 x}{x^{7} - 7 x^{6} + 21 x^{5} - 35 x^{4} + 35 x^{3} - 21 x^{2} + 7 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;x^{7} - 4616 x^{6} + 8989 x^{5} + 31136 x^{4} + 20195 x^{3} + 4520 x^{2} + 255 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A228223.
