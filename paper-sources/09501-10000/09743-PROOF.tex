...
\title{The empirical recurrence for OEIS A124352, derived from the entry's generating function}
...
\begin{abstract}
OEIS A124352 carries an empirical recurrence of order $9$. The entry separately records a
...
OEIS A124352 is ``Number of directed Hamiltonian paths on the n-antiprism graph.''. It has offset $3$ and begins
\[
240, 816, 2400, 6480, 16660, 41440, 100836, 241520,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 16 2025 08:33:03, revision 64) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 56 x^{11} - 60 x^{10} + 164 x^{9} + 292 x^{8} - 244 x^{7} - 336 x^{6} + 240 x^{5} + 384 x^{4} - 240 x^{3}}{x^{9} + x^{8} - 3 x^{7} - 5 x^{6} + 5 x^{5} + 7 x^{4} - 4 x^{3} - 6 x^{2} + 5 x - 1},
\]
the entry's own generating function, and let
\[
D(x)\;=\;1-\sum_i c_i x^{i}\;=\;- x^{9} - x^{8} + 3 x^{7} + 5 x^{6} - 5 x^{5} - 7 x^{4} + 4 x^{3} + 6 x^{2} - 5 x + 1
\]
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) - 6\,a(n-2) - 4\,a(n-3) + 7\,a(n-4) + 5\,a(n-5) - 5\,a(n-6) - 3\,a(n-7) + a(n-8) + a(n-9)
\]
for every $n>11$.
\end{theorem}
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;56 x^{11} + 60 x^{10} - 164 x^{9} - 292 x^{8} + 244 x^{7} + 336 x^{6} - 240 x^{5} - 384 x^{4} + 240 x^{3},
\]
...
\[
x^{9} + x^{8} - 3 x^{7} - 5 x^{6} + 5 x^{5} + 7 x^{4} - 4 x^{3} - 6 x^{2} + 5 x - 1,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A124352.
