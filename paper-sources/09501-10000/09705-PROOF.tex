...
\title{The empirical recurrence for OEIS A231258, proved by transfer matrix}
...
\begin{abstract}
OEIS A231258 counts $(n+1)\times4$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A231258 is ``Number of (n+1) X (3+1) 0..2 arrays with no element unequal to a strict majority of its horizontal and antidiagonal neighbors, with values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
4, 32, 304, 2982, 29366, 289230, 2848550, 28054534,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 17*a(n-1) -96*a(n-2) +308*a(n-3) -628*a(n-4) +800*a(n-5) -656*a(n-6) +256*a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 16 2018 09:40:44, revision 12) this is still
...
\begin{theorem}
\[
a(n)\;=\;17\,a(n-1) - 96\,a(n-2) + 308\,a(n-3) - 628\,a(n-4) + 800\,a(n-5) - 656\,a(n-6) + 256\,a(n-7)
\]
for every $n>7$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231258.
