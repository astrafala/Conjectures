...
\title{The empirical recurrence for OEIS A184546, derived from the entry's generating function}
...
\begin{abstract}
OEIS A184546 carries an empirical recurrence of order $10$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 14 2018 13:11:12, revision 9) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 77 x^{10} + 853 x^{9} - 4270 x^{8} + 12502 x^{7} - 23429 x^{6} + 29072 x^{5} - 23898 x^{4} + 12586 x^{3} - 3877 x^{2} + 539 x}{x^{10} - 10 x^{9} + 45 x^{8} - 120 x^{7} + 210 x^{6} - 252 x^{5} + 210 x^{4} - 120 x^{3} + 45 x^{2} - 10 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 77 x^{10} + 853 x^{9} - 4270 x^{8} + 12502 x^{7} - 23429 x^{6} + 29072 x^{5} - 23898 x^{4} + 12586 x^{3} - 3877 x^{2} + 539 x,
\]
