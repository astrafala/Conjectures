...
\title{The empirical recurrence for OEIS A202460, derived from the entry's generating function}
...
\begin{abstract}
OEIS A202460 carries an empirical recurrence of order $10$. The entry separately records a
...
OEIS A202460 is ``Number of (n+2) X 9 binary arrays with consecutive windows of three bits considered as a binary number nondecreasing in every row and column.''. It has offset $1$ and begins
\[
2744, 8064, 21972, 54618, 124740, 264822, 528390, 1000023,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 01 2018 05:26:48, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 937 x^{10} + 9010 x^{9} - 38691 x^{8} + 97542 x^{7} - 159456 x^{6} + 175860 x^{5} - 131502 x^{4} + 64812 x^{3} - 19376 x^{2} + 2744 x}{x^{10} - 10 x^{9} + 45 x^{8} - 120 x^{7} + 210 x^{6} - 252 x^{5} + 210 x^{4} - 120 x^{3} + 45 x^{2} - 10 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 937 x^{10} + 9010 x^{9} - 38691 x^{8} + 97542 x^{7} - 159456 x^{6} + 175860 x^{5} - 131502 x^{4} + 64812 x^{3} - 19376 x^{2} + 2744 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A202460.
