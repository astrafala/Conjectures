...
\title{The empirical recurrence for OEIS A225977, derived from the entry's generating function}
...
\begin{abstract}
OEIS A225977 carries an empirical recurrence of order $10$. The entry separately records a
...
OEIS A225977 is ``Number of n X 3 binary arrays whose sum with another n X 3 binary array containing no more than two 1s has rows and columns in lexicographically nondecreasing order.''. It has offset $1$ and begins
\[
8, 48, 252, 1178, 4722, 16361, 49811, 135672,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 05 2018 14:32:13, revision 7) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{11} + 16 x^{10} - 72 x^{9} + 163 x^{8} - 165 x^{7} - 25 x^{6} + 202 x^{5} - 142 x^{4} + 132 x^{3} - 32 x^{2} + 8 x}{x^{10} - 10 x^{9} + 45 x^{8} - 120 x^{7} + 210 x^{6} - 252 x^{5} + 210 x^{4} - 120 x^{3} + 45 x^{2} - 10 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- x^{11} + 16 x^{10} - 72 x^{9} + 163 x^{8} - 165 x^{7} - 25 x^{6} + 202 x^{5} - 142 x^{4} + 132 x^{3} - 32 x^{2} + 8 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A225977.
