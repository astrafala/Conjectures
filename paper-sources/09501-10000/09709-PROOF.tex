...
\title{The empirical recurrence for OEIS A297514, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297514 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A297514 is ``Number of n X 3 0..1 arrays with every 1 horizontally, diagonally or antidiagonally adjacent to 1 or 3 neighboring 1s.''. It has offset $1$ and begins
\[
3, 17, 49, 177, 727, 2445, 8931, 33841,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) + 2*a(n-2) + 30*a(n-3) + 6*a(n-5) - 124*a(n-6) - 8*a(n-8) + 64*a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 28 2019 16:20:42, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 2\,a(n-2) + 30\,a(n-3) + 6\,a(n-5) - 124\,a(n-6) - 8\,a(n-8) + 64\,a(n-9)
\end{equation}
for all $n>10$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297514.
