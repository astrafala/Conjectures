...
\title{The empirical recurrence for OEIS A235283, proved by transfer matrix}
...
\begin{abstract}
OEIS A235283 counts $3$-column arrays over $\{0,\dots,3\}$ in which every
...
OEIS A235283 is ``Number of (n+1) X (2+1) 0..3 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 4 (constant-stress 1 X 1 tilings).''. It has offset
$1$ and begins
\[
40, 68, 104, 188, 304, 572, 968,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) + 3*a(n-2) - 15*a(n-3) + 4*a(n-4) + 18*a(n-5) - 12*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 18 2022 23:37:52, revision 12) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A235283.
