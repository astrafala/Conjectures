...
\title{The empirical recurrence for OEIS A199901, derived from the entry's generating function}
...
\begin{abstract}
OEIS A199901 carries an empirical recurrence of order $6$. The entry separately records a
...
OEIS A199901 is ``Number of -n..n arrays x(0..5) of 6 elements with zero sum, and adjacent elements not both strictly positive and not both strictly negative.''. It has offset $1$ and begins
\[
75, 533, 2035, 5725, 13363, 27457, 51395, 89577,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 16 2018 16:29:06, revision 9) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{6} + 3 x^{5} + 10 x^{4} - 38 x^{3} + 83 x^{2} + 75 x}{x^{6} - 6 x^{5} + 15 x^{4} - 20 x^{3} + 15 x^{2} - 6 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- x^{6} + 3 x^{5} + 10 x^{4} - 38 x^{3} + 83 x^{2} + 75 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A199901.
