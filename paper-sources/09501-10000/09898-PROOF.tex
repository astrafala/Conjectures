...
\title{The empirical recurrence for OEIS A211563, derived from the entry's generating function}
...
\begin{abstract}
OEIS A211563 carries an empirical recurrence of order $7$. The entry separately records a
...
OEIS A211563 is ``Number of nonnegative integer arrays of length n+3 with new values 0 upwards introduced in order, and containing the value n-1.''. It has offset $1$ and begins
\[
15, 51, 171, 512, 1345, 3145, 6676, 13091,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 19 2018 05:50:02, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 5 x^{7} + 33 x^{6} - 92 x^{5} + 139 x^{4} - 129 x^{3} + 54 x^{2} - 15 x}{x^{7} - 7 x^{6} + 21 x^{5} - 35 x^{4} + 35 x^{3} - 21 x^{2} + 7 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;5 x^{7} - 33 x^{6} + 92 x^{5} - 139 x^{4} + 129 x^{3} - 54 x^{2} + 15 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A211563.
