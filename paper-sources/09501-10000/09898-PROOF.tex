...
\title{The empirical recurrence for OEIS A200788, derived from the entry's generating function}
...
\begin{abstract}
OEIS A200788 carries an empirical recurrence of order $7$. The entry separately records a
...
OEIS A200788 is ``Number of 0..n arrays x(0..5) of 6 elements without any two consecutive increases.''. It has offset $1$ and begins
\[
64, 622, 3136, 11100, 31395, 75992, 164004, 324087,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 15 2017 20:28:02, revision 13) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{7} + 7 x^{6} - 21 x^{5} + 30 x^{4} - 126 x^{3} - 174 x^{2} - 64 x}{x^{7} - 7 x^{6} + 21 x^{5} - 35 x^{4} + 35 x^{3} - 21 x^{2} + 7 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;x^{7} - 7 x^{6} + 21 x^{5} - 30 x^{4} + 126 x^{3} + 174 x^{2} + 64 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A200788.
