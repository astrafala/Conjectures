...
\title{The empirical recurrence for OEIS A246894, derived from the entry's generating function}
...
\begin{abstract}
OEIS A246894 carries an empirical recurrence of order $10$. The entry separately records a
...
OEIS A246894 is ``Number of length 2+4 0..n arrays with some pair in every consecutive five terms totalling exactly n.''. It has offset $1$ and begins
\[
58, 673, 3364, 12481, 33294, 79345, 159688, 303169,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 07 2018 09:56:55, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{10} + 2 x^{9} - 1486 x^{8} - 268 x^{7} + 2876 x^{6} + 3740 x^{5} + 4198 x^{4} + 1844 x^{3} + 557 x^{2} + 58 x}{x^{10} - 2 x^{9} - 3 x^{8} + 8 x^{7} + 2 x^{6} - 12 x^{5} + 2 x^{4} + 8 x^{3} - 3 x^{2} - 2 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- x^{10} + 2 x^{9} - 1486 x^{8} - 268 x^{7} + 2876 x^{6} + 3740 x^{5} + 4198 x^{4} + 1844 x^{3} + 557 x^{2} + 58 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A246894.
