...
\title{The empirical recurrence for OEIS A184038, derived from the entry's generating function}
...
\begin{abstract}
OEIS A184038 carries an empirical recurrence of order $4$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 10 2018 06:28:00, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 4876 x^{4} + 2453 x^{3} + 2438 x^{2} - 1225 x}{4 x^{4} - 6 x^{3} + 3 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;4876 x^{4} - 2453 x^{3} - 2438 x^{2} + 1225 x,
\]
