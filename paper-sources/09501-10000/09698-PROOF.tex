...
\title{The empirical recurrence for OEIS A063292, derived from the entry's generating function}
...
\begin{abstract}
OEIS A063292 carries an empirical recurrence of order $10$. The entry separately records a
...
OEIS A063292 is ``Dimension of the space of weight n cuspidal newforms for Gamma\_1( 19 ).''. It has offset $2$ and begins
\[
-1, 7, 21, 36, 51, 66, 81, 96,\ \dots
\]
...
\begin{quote}
G.f.: -x\^{}2*(1 -7*x -21*x\^{}2 -36*x\^{}3 -52*x\^{}4 -59*x\^{}5 -61*x\^{}6 -53*x\^{}7 -39*x\^{}8 -24*x\^{}9 -8*x\^{}10 +x\^{}11) / ((1 -x)\^{}2*(1 +x)\^{}2*(1 -x +x\^{}2)*(1 +x\^{}2)*(1 +x +x\^{}2)). (End)
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 17 2025 12:32:39, revision 15) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{13} + 8 x^{12} + 24 x^{11} + 39 x^{10} + 53 x^{9} + 61 x^{8} + 59 x^{7} + 52 x^{6} + 36 x^{5} + 21 x^{4} + 7 x^{3} - x^{2}}{x^{10} - x^{6} - x^{4} + 1},
\]
the entry's own generating function, and let
\[
D(x)\;=\;1-\sum_i c_i x^{i}\;=\;x^{10} - x^{6} - x^{4} + 1
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- x^{13} + 8 x^{12} + 24 x^{11} + 39 x^{10} + 53 x^{9} + 61 x^{8} + 59 x^{7} + 52 x^{6} + 36 x^{5} + 21 x^{4} + 7 x^{3} - x^{2},
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A063292.
