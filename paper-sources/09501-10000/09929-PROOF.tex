...
\title{The empirical recurrence for OEIS A221576, derived from the entry's generating function}
...
\begin{abstract}
OEIS A221576 carries an empirical recurrence of order $7$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 08 2018 18:37:20, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{2 x^{10} - 18 x^{9} + 80 x^{8} - 193 x^{7} + 355 x^{6} - 378 x^{5} - 54 x^{4} - 433 x^{3} - 71 x^{2} - 10 x}{x^{7} - 7 x^{6} + 21 x^{5} - 35 x^{4} + 35 x^{3} - 21 x^{2} + 7 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 2 x^{10} + 18 x^{9} - 80 x^{8} + 193 x^{7} - 355 x^{6} + 378 x^{5} + 54 x^{4} + 433 x^{3} + 71 x^{2} + 10 x,
\]
