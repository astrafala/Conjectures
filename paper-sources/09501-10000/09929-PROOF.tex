...
\title{The empirical recurrence for OEIS A250015, derived from the entry's generating function}
...
\begin{abstract}
OEIS A250015 carries an empirical recurrence of order $7$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 10 2018 12:43:59, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 20 x^{5} - 160 x^{4} - 360 x^{3} - 160 x^{2} - 20 x}{x^{7} - 7 x^{6} + 21 x^{5} - 35 x^{4} + 35 x^{3} - 21 x^{2} + 7 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;20 x^{5} + 160 x^{4} + 360 x^{3} + 160 x^{2} + 20 x,
\]
