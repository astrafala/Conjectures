...
\title{The empirical recurrence for OEIS A201696, derived from the entry's generating function}
...
\begin{abstract}
OEIS A201696 carries an empirical recurrence of order $11$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 23 2018 16:39:35, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 185 x^{11} + 1233 x^{10} - 1789 x^{9} + 1972 x^{8} - 5086 x^{7} + 4426 x^{6} + 1328 x^{5} - 1643 x^{4} - 263 x^{3} + 6 x^{2} - 3 x}{x^{11} - 11 x^{10} + 55 x^{9} - 165 x^{8} + 330 x^{7} - 462 x^{6} + 462 x^{5} - 330 x^{4} + 165 x^{3} - 55 x^{2} + 11 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;185 x^{11} - 1233 x^{10} + 1789 x^{9} - 1972 x^{8} + 5086 x^{7} - 4426 x^{6} - 1328 x^{5} + 1643 x^{4} + 263 x^{3} - 6 x^{2} + 3 x,
\]
