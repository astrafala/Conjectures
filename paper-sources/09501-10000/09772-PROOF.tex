...
\title{The empirical recurrence for OEIS A241968, derived from the entry's generating function}
...
\begin{abstract}
OEIS A241968 carries an empirical recurrence of order $9$. The entry separately records a
...
OEIS A241968 is ``Number of length 5+3 0..n arrays with no consecutive four elements summing to more than 2*n.''. It has offset $1$ and begins
\[
97, 1895, 16649, 92037, 376559, 1247602, 3536286, 8889273,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 31 2018 06:33:23, revision 7) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{9} + 9 x^{8} - 36 x^{7} + 65 x^{6} - 632 x^{5} - 2268 x^{4} - 3086 x^{3} - 1022 x^{2} - 97 x}{x^{9} - 9 x^{8} + 36 x^{7} - 84 x^{6} + 126 x^{5} - 126 x^{4} + 84 x^{3} - 36 x^{2} + 9 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;x^{9} - 9 x^{8} + 36 x^{7} - 65 x^{6} + 632 x^{5} + 2268 x^{4} + 3086 x^{3} + 1022 x^{2} + 97 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A241968.
