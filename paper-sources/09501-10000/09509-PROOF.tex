...
\title{The empirical recurrence for OEIS A258559, proved by transfer matrix}
...
\begin{abstract}
OEIS A258559 counts the arrays over $\{0,\dots,1\}$ whose $2\times2$ subblocks carry a
...
so a pair of consecutive array rows is a state, the count is a walk count on $S=988$ of them,
...
OEIS A258559 is ``Number of (6+1) X (n+1) 0..1 arrays with every 2 X 2 subblock ne-sw antidiagonal difference nondecreasing horizontally and nw+se diagonal sum nondecreasing vertically.''. It has offset $1$ and begins
\[
988, 2530, 3980, 6196, 8339, 10854, 13833, 17058,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) - 3*a(n-2) + a(n-3) + a(n-4) - 3*a(n-5) + 3*a(n-6) - a(n-7) for n>13.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 22 2018 11:31:03, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The $2\times2$ subblocks of an $(n+1)\times7$ array over $\{0,\dots,1\}$ form a grid
...
\]
on the $S=988$ admissible pairs. In particular $a$ is $C$-finite. The alignment of the walk
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A258559.
