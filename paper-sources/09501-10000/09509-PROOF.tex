...
\title{The empirical recurrence for OEIS A185405, proved by transfer matrix}
...
\begin{abstract}
OEIS A185405 counts $n\times2$ arrays over $\{0,\dots,6\}$ subject to a condition imposed on
...
walk, and $a(n)$ is a walk count on $S=2450$ vertices, which is $C$-finite. Whether the
...
OEIS A185405 is ``1/7 the number of n X 2 0..6 arrays with every element equal to exactly one or two of its horizontal and vertical neighbors.''. It has offset $1$ and begins
\[
1, 13, 150, 1848, 22656, 278832, 3430776, 42221928,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 11*a(n-1) + 23*a(n-2) - 72*a(n-3) - 144*a(n-4) - 216*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 15 2018 08:38:36, revision 11) this is still
...
$\tfrac1{7}\iota^{\!\top}M^{\,j}q(M)\tau$ for the corresponding walk index $j$, so the
...
\begin{theorem}
\[
a(n)\;=\;11\,a(n-1) + 23\,a(n-2) - 72\,a(n-3) - 144\,a(n-4) - 216\,a(n-5)
\]
for every $n>5$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A185405.
