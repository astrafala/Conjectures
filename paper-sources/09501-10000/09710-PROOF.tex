...
\title{The empirical recurrence for OEIS A203454, proved by transfer matrix}
...
\begin{abstract}
OEIS A203454 counts $n\times2$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
walk, and $a(n)$ is a walk count on $S=38$ vertices, which is $C$-finite. Whether the
...
OEIS A203454 is ``Number of n X 2 0..2 arrays with every nonzero element less than or equal to at least two horizontal and vertical neighbors.''. It has offset $1$ and begins
\[
1, 3, 9, 22, 63, 209, 686, 2228,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 04 2018 09:22:51, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A203454.
