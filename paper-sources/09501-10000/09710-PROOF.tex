...
\title{The empirical recurrence for OEIS A202919, derived from the entry's generating function}
...
\begin{abstract}
OEIS A202919 carries an empirical recurrence of order $10$. The entry separately records a
...
OEIS A202919 is ``Number of n X 3 nonnegative integer arrays with each row and column increasing from zero by 0, 1, 2 or 3.''. It has offset $1$ and begins
\[
1, 10, 90, 534, 2310, 8012, 23661, 61830,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2018 10:35:18, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{x^{7} - 10 x^{6} + 30 x^{5} - 36 x^{4} + 35 x^{3} + x}{x^{10} - 10 x^{9} + 45 x^{8} - 120 x^{7} + 210 x^{6} - 252 x^{5} + 210 x^{4} - 120 x^{3} + 45 x^{2} - 10 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;x^{7} - 10 x^{6} + 30 x^{5} - 36 x^{4} + 35 x^{3} + x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A202919.
