...
\title{The empirical recurrence for OEIS A209506, proved by transfer matrix}
...
\begin{abstract}
OEIS A209506 counts $(n+1)\times4$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A209506 is ``Half the number of (n+1) X 4 0..2 arrays with every 2 X 2 subblock having two or four distinct clockwise edge differences.''. It has offset $1$ and begins
\[
81, 561, 3906, 27225, 189801, 1323270, 9225765, 64321641,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 9*a(n-1) - 15*a(n-2) + 6*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 10 2018 13:58:52, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209506.
