...
\title{The empirical recurrence for OEIS A252223, proved by transfer matrix}
...
\begin{abstract}
OEIS A252223 counts arrays of width $5$ over $\{0,1,2\}$ in which every $3\times3$ window has
...
OEIS A252223 is ``Number of (n+2) X (3+2) 0..2 arrays with every 3 X 3 subblock row and column sum 2 3 or 4 and every diagonal and antidiagonal sum not 2 3 or 4.''. It has offset $1$ and begins
\[
812, 3066, 9566, 24932, 73826, 231254, 718514, 2208224,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) - a(n-2) + 3*a(n-3) + 3*a(n-4) - a(n-5) - a(n-6) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 02 2018 07:15:06, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252223.
