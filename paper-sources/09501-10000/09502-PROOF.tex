...
\title{The empirical recurrence for OEIS A268321, proved by transfer matrix}
...
\begin{abstract}
OEIS A268321 carries an empirical recurrence of order $6$ contributed by R.~H.~Hardin. It is
...
OEIS A268321 is ``Number of length-(n+1) 0..2 arrays with new values introduced in sequential order, and with new repeated values introduced in sequential order, both starting with zero.''. It has offset $1$ and begins
\[
2, 4, 10, 25, 66, 177, 485, 1348,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 7*a(n-1) - 14*a(n-2) + 21*a(n-4) - 7*a(n-5) - 6*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 13 2019 11:30:25, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268321.
