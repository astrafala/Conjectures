...
\title{The empirical recurrence for OEIS A027483, derived from the entry's generating function}
...
\begin{abstract}
OEIS A027483 carries an empirical recurrence of order $9$. The entry separately records a
...
OEIS A027483 is ``Second subdiagonal of triangle A027478, constructed from the Stirling numbers of the first kind.''. It has offset $3$ and begins
\[
176, 2951, 22535, 112435, 426475, 1333906, 3614226, 8762370,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 08 2025 08:55:44, revision 20) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{8} - 112 x^{7} - 1072 x^{6} - 2312 x^{5} - 1367 x^{4} - 176 x^{3}}{x^{9} - 9 x^{8} + 36 x^{7} - 84 x^{6} + 126 x^{5} - 126 x^{4} + 84 x^{3} - 36 x^{2} + 9 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;x^{8} + 112 x^{7} + 1072 x^{6} + 2312 x^{5} + 1367 x^{4} + 176 x^{3},
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A027483.
