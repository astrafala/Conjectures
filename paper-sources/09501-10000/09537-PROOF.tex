...
\title{The empirical recurrence for OEIS A296109, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A296109 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A296109 is ``Number of n X 2 0..1 arrays with each 1 adjacent to 3 or 4 king-move neighboring 1s.''. It has offset $1$ and begins
\[
1, 2, 3, 4, 8, 17, 31, 71,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) + 2*a(n-2) + 5*a(n-3) - 2*a(n-4) - 6*a(n-5) - 4*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 22 2018 09:47:29, revision 9) the statement is
...
x_{t,u}=1\ \Rightarrow\ \#\{\text{neighbours equal to }1\}\in\{3,4\}
\end{equation}
for every cell $(t,u)$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A296109.
