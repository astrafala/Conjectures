...
\title{The empirical recurrence for OEIS A227266, derived from the entry's generating function}
...
\begin{abstract}
OEIS A227266 carries an empirical recurrence of order $10$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 07 2018 18:37:23, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{x^{13} - 4 x^{12} + 9 x^{11} - 31 x^{10} + 90 x^{9} - 156 x^{8} + 177 x^{7} - 162 x^{6} + 146 x^{5} - 118 x^{4} + 69 x^{3} - 24 x^{2} + 4 x}{x^{10} - 10 x^{9} + 45 x^{8} - 120 x^{7} + 210 x^{6} - 252 x^{5} + 210 x^{4} - 120 x^{3} + 45 x^{2} - 10 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;x^{13} - 4 x^{12} + 9 x^{11} - 31 x^{10} + 90 x^{9} - 156 x^{8} + 177 x^{7} - 162 x^{6} + 146 x^{5} - 118 x^{4} + 69 x^{3} - 24 x^{2} + 4 x,
\]
