...
\title{The empirical recurrence for OEIS A249849, derived from the entry's generating function}
...
\begin{abstract}
OEIS A249849 carries an empirical recurrence of order $10$. The entry separately records a
...
OEIS A249849 is ``Number of length 5+4 0..n arrays with no five consecutive terms having the maximum of any two terms equal to the minimum of the remaining three terms.''. It has offset $1$ and begins
\[
10, 1189, 30080, 337396, 2307418, 11342301, 44075760, 143723664,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 18 2017 09:16:07, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{939 x^{8} + 18312 x^{7} + 88511 x^{6} + 146478 x^{5} + 88901 x^{4} + 18640 x^{3} + 1089 x^{2} + 10 x}{x^{10} - 10 x^{9} + 45 x^{8} - 120 x^{7} + 210 x^{6} - 252 x^{5} + 210 x^{4} - 120 x^{3} + 45 x^{2} - 10 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;939 x^{8} + 18312 x^{7} + 88511 x^{6} + 146478 x^{5} + 88901 x^{4} + 18640 x^{3} + 1089 x^{2} + 10 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A249849.
