...
\title{The empirical recurrence for OEIS A204401, proved by transfer matrix}
...
\begin{abstract}
OEIS A204401 counts $(n+2)\times3$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A204401 is ``Number of (n+2)X3 0..2 arrays with every 3X3 subblock having three strictly increasing elements in a row horizontally, vertically or nw-to-se diagonally.''. It has offset $1$ and begins
\[
4293, 47883, 719125, 6579664, 70193731, 852798050, 8916413698, 96129489898,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 11:11:57, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 26\,a(n-2) + 677\,a(n-3) + 2185\,a(n-4) + 4172\,a(n-5) + 2924\,a(n-6) + 787\,a(n-7) - 1302\,a(n-8) - 864\,a(n-9) - 324\,a(n-10)
\]
for every $n>9$.
\end{theorem}
...
at once. By Lemma~\ref{lem:crit} the recurrence holds for every $n>9$.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204401.
