...
\title{The empirical recurrence for OEIS A229450, derived from the entry's generating function}
...
\begin{abstract}
OEIS A229450 carries an empirical recurrence of order $8$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 17 2018 08:32:13, revision 7) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{3 x^{8} + 123 x^{7} - 66 x^{6} + 456 x^{5} - 302 x^{4} + 329 x^{3} - 98 x^{2} + 30 x}{x^{8} - 8 x^{7} + 28 x^{6} - 56 x^{5} + 70 x^{4} - 56 x^{3} + 28 x^{2} - 8 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;3 x^{8} + 123 x^{7} - 66 x^{6} + 456 x^{5} - 302 x^{4} + 329 x^{3} - 98 x^{2} + 30 x,
\]
