...
\title{The empirical recurrence for OEIS A259293, proved by transfer matrix}
...
\begin{abstract}
OEIS A259293 counts arrays of width $5$ over $\{0,1\}$ subject to a condition read round the
...
OEIS A259293 is ``Number of (n+1)X(4+1) 0..1 arrays with each 2X2 subblock having clockwise pattern 0001 0101 or 0111.''. It has offset $1$ and begins
\[
170, 1134, 6870, 43870, 273686, 1729342, 10862998, 68457998,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 5*a(n-1) +26*a(n-2) -98*a(n-3) -188*a(n-4) +580*a(n-5) +392*a(n-6) -1024*a(n-7) -256*a(n-8) +512*a(n-9)
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:50:14, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) + 26\,a(n-2) - 98\,a(n-3) - 188\,a(n-4) + 580\,a(n-5) + 392\,a(n-6) - 1024\,a(n-7) - 256\,a(n-8) + 512\,a(n-9)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A259293.
