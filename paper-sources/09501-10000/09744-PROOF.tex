...
\title{The empirical recurrence for OEIS A258548, proved by transfer matrix}
...
\begin{abstract}
OEIS A258548 counts the arrays over $\{0,\dots,1\}$ whose $2\times2$ subblocks carry a
...
OEIS A258548 is ``Number of (n+1) X (2+1) 0..1 arrays with every 2 X 2 subblock ne-sw antidiagonal difference nondecreasing horizontally and nw+se diagonal sum nondecreasing vertically.''. It has offset $1$ and begins
\[
44, 112, 296, 652, 1329, 2530, 4667, 8419,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) - 5*a(n-2) + a(n-3) + 3*a(n-4) - 4*a(n-5) + 2*a(n-6) + 2*a(n-7) - 3*a(n-8) + a(n-9) for n>11.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 21 2018 15:01:20, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) - 5\,a(n-2) + a(n-3) + 3\,a(n-4) - 4\,a(n-5) + 2\,a(n-6) + 2\,a(n-7) - 3\,a(n-8) + a(n-9)
\]
for every $n>11$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A258548.
