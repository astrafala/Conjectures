...
\title{The empirical recurrence for OEIS A267475, derived from the entry's generating function}
...
\begin{abstract}
OEIS A267475 carries an empirical recurrence of order $8$. The entry separately records a
...
OEIS A267475 is ``Number of length-7 0..n arrays with no following elements larger than the first repeated value.''. It has offset $1$ and begins
\[
71, 1112, 8770, 44901, 171601, 532840, 1418740, 3357537,\ \dots
\]
...
\begin{quote}
G.f.: x*(71 + 544*x + 1862*x\^{}2 + 1901*x\^{}3 + 651*x\^{}4 + 4*x\^{}5 + 8*x\^{}6 - x\^{}7) / (1 - x)\^{}8.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 05 2018 09:36:41, revision 7) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{8} + 8 x^{7} + 4 x^{6} + 651 x^{5} + 1901 x^{4} + 1862 x^{3} + 544 x^{2} + 71 x}{x^{8} - 8 x^{7} + 28 x^{6} - 56 x^{5} + 70 x^{4} - 56 x^{3} + 28 x^{2} - 8 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- x^{8} + 8 x^{7} + 4 x^{6} + 651 x^{5} + 1901 x^{4} + 1862 x^{3} + 544 x^{2} + 71 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267475.
