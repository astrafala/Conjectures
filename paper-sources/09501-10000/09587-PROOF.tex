...
\title{The empirical recurrence for OEIS A206661, proved by transfer matrix}
...
\begin{abstract}
OEIS A206661 counts arrays of width $2$ over $\{0,1,2\}$ subject to a condition read round the
...
OEIS A206661 is ``Number of (n+1) X 2 0..2 arrays with every 2 X 2 subblock having the number of clockwise edge increases equal to the number of counterclockwise edge increases in its adjacent leftward and upward neighbors.''. It has offset $1$ and begins
\[
81, 423, 2286, 12477, 68253, 373644, 2046027, 11205045,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 9*a(n-1) - 18*a(n-2) - 19*a(n-3) + 71*a(n-4) - 28*a(n-5) - 22*a(n-6) + 8*a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 17 2018 07:17:22, revision 11) this is still
...
\begin{theorem}
\[
a(n)\;=\;9\,a(n-1) - 18\,a(n-2) - 19\,a(n-3) + 71\,a(n-4) - 28\,a(n-5) - 22\,a(n-6) + 8\,a(n-7)
\]
for every $n>7$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206661.
