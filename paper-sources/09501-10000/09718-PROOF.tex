...
\title{The empirical recurrence for OEIS A229775, derived from the entry's generating function}
...
\begin{abstract}
OEIS A229775 carries an empirical recurrence of order $10$. The entry separately records a
...
OEIS A229775 is ``Number of 3 X 3 0..n arrays with rows in lexicographically nondecreasing order and columns in nonincreasing order.''. It has offset $1$ and begins
\[
20, 322, 3232, 21331, 103222, 397460, 1287672, 3647349,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 21 2018 08:46:33, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{10} + 10 x^{9} - 45 x^{8} + 118 x^{7} - 125 x^{6} + 912 x^{5} + 1101 x^{4} + 912 x^{3} + 122 x^{2} + 20 x}{x^{10} - 10 x^{9} + 45 x^{8} - 120 x^{7} + 210 x^{6} - 252 x^{5} + 210 x^{4} - 120 x^{3} + 45 x^{2} - 10 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- x^{10} + 10 x^{9} - 45 x^{8} + 118 x^{7} - 125 x^{6} + 912 x^{5} + 1101 x^{4} + 912 x^{3} + 122 x^{2} + 20 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A229775.
