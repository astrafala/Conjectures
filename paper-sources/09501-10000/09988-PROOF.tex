...
\title{The empirical recurrence for OEIS A204192, proved by transfer matrix}
...
\begin{abstract}
OEIS A204192 counts arrays of width $3$ over $\{0,1\}$ containing no run of $3$ consecutive
...
the count is a walk count on $S=43$ states.
\end{abstract}
...
OEIS A204192 is ``Number of n X 3 0..1 arrays with no occurrence of three equal elements in a row horizontally, vertically or nw-to-se diagonally, and new values 0..1 introduced in row major order.''. It has offset $1$ and begins
\[
3, 18, 33, 86, 231, 639, 1724, 4697,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) +3*a(n-2) -a(n-3) -5*a(n-4) -2*a(n-5) +5*a(n-6) +a(n-7) -2*a(n-8) for n>11.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 06 2018 15:11:36, revision 10) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=43,\quad\tau=\mathbf{1} .
\]
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 3\,a(n-2) - a(n-3) - 5\,a(n-4) - 2\,a(n-5) + 5\,a(n-6) + a(n-7) - 2\,a(n-8)
\]
for every $n>11$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204192.
