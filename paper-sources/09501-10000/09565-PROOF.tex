...
\title{The empirical recurrence for OEIS A250724, proved by transfer matrix}
...
\begin{abstract}
OEIS A250724 counts arrays over $\{0,1\}$ in which a statistic taken over short runs
...
OEIS A250724 is ``Number of (n+1) X (3+1) 0..1 arrays with nondecreasing x(i,j)+x(i,j-1) in the i direction and nondecreasing min(x(i,j),x(i-1,j)) in the j direction.''. It has offset $1$ and begins
\[
50, 110, 208, 365, 600, 942, 1418, 2065,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) - 5*a(n-2) + 5*a(n-4) - 4*a(n-5) + a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 16 2018 06:10:57, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250724.
