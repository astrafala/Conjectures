...
\title{The empirical recurrence for OEIS A232936, proved by transfer matrix}
...
\begin{abstract}
OEIS A232936 counts arrays of width $3$ over $\{0,\dots,2\}$ under a condition on each cell
and its neighbours, and carries an empirical recurrence of order $5$ contributed by
...
OEIS A232936 is ``Number of n X 3 0..2 arrays with no element x(i,j) adjacent to value 2-x(i,j) horizontally, vertically or antidiagonally.''. It has offset $1$ and begins
\[
12, 26, 84, 252, 774, 2360, 7212, 22024,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + 5*a(n-2) + 4*a(n-3) - a(n-5) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 06 2018 06:15:17, revision 9) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232936.
