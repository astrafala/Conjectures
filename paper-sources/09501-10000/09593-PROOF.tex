...
\title{The empirical recurrence for OEIS A230610, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A230610 counts arrays over $\{0,\dots,2\}$ in which every cell is constrained by the
...
OEIS A230610 is ``Number of nX4 0..2 arrays x(i,j) with each element horizontally or antidiagonally next to at least one element with value (x(i,j)+1) mod 3, and upper left element zero.''. It has offset $1$ and begins
\[
0, 2, 30, 348, 3956, 44916, 509978, 5790456,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 15*a(n-1) -45*a(n-2) +42*a(n-3) -12*a(n-4) +a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 05:55:26, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;15\,a(n-1) - 45\,a(n-2) + 42\,a(n-3) - 12\,a(n-4) + a(n-5)
\end{equation}
for all $n>6$.
...
$3$ values, so there are about $10^{34}$ of them to sift. The
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A230610.
