...
\title{The empirical recurrence for OEIS A304257, proved by transfer matrix}
...
\begin{abstract}
OEIS A304257 counts $2$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A304257 is ``Number of nX2 0..1 arrays with every element unequal to 2, 3, 5 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
0, 3, 4, 9, 18, 33, 72, 133,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) +3*a(n-2) -4*a(n-3) -6*a(n-4) +4*a(n-5) for n>6
\end{quote}
As of the ``Last modified'' line on the live entry (May 09 2018 10:02:40, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 3\,a(n-2) - 4\,a(n-3) - 6\,a(n-4) + 4\,a(n-5)
\end{equation}
for all $n>6$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A304257.
