...
\title{The empirical recurrence for OEIS A256764, proved by transfer matrix}
...
\begin{abstract}
OEIS A256764 counts arrays of width $3$ over $\{0,1\}$ in which every $3\times3$ window has
...
OEIS A256764 is ``Number of (n+2)X(1+2) 0..1 arrays with no 3x3 subblock diagonal sum less than the antidiagonal sum.''. It has offset $1$ and begins
\[
352, 1936, 9152, 43264, 189696, 831744, 3502080, 14745600,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 8*a(n-1) -144*a(n-3) +272*a(n-4) +704*a(n-5) -2304*a(n-6) +5120*a(n-8) -4096*a(n-9)
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 15:13:58, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-1) - 144\,a(n-3) + 272\,a(n-4) + 704\,a(n-5) - 2304\,a(n-6) + 5120\,a(n-8) - 4096\,a(n-9)
\]
for every $n>6$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A256764.
