...
\title{The empirical recurrence for OEIS A200873, derived from the entry's generating function}
...
\begin{abstract}
OEIS A200873 carries an empirical recurrence of order $6$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 16 2017 12:22:28, revision 10) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{6} + 6 x^{5} - 14 x^{4} + 14 x^{3} - 19 x^{2} + 16 x}{x^{6} - 6 x^{5} + 15 x^{4} - 20 x^{3} + 15 x^{2} - 6 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- x^{6} + 6 x^{5} - 14 x^{4} + 14 x^{3} - 19 x^{2} + 16 x,
\]
