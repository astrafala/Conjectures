...
\title{The empirical recurrence for OEIS A200790, derived from the entry's generating function}
...
\begin{abstract}
OEIS A200790 carries an empirical recurrence of order $9$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 15 2017 20:28:24, revision 12) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{9} + 9 x^{8} - 36 x^{7} + 79 x^{6} - 522 x^{5} - 3294 x^{4} - 6484 x^{3} - 2853 x^{2} - 256 x}{x^{9} - 9 x^{8} + 36 x^{7} - 84 x^{6} + 126 x^{5} - 126 x^{4} + 84 x^{3} - 36 x^{2} + 9 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;x^{9} - 9 x^{8} + 36 x^{7} - 79 x^{6} + 522 x^{5} + 3294 x^{4} + 6484 x^{3} + 2853 x^{2} + 256 x,
\]
