...
\title{The empirical recurrence for OEIS A202936, derived from the entry's generating function}
...
\begin{abstract}
OEIS A202936 carries an empirical recurrence of order $9$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 03 2018 07:57:36, revision 9) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 97073 x^{9} + 812969 x^{8} - 2987174 x^{7} + 6291988 x^{6} - 8314586 x^{5} + 7066186 x^{4} - 3778651 x^{3} + 1166317 x^{2} - 160000 x}{x^{9} - 9 x^{8} + 36 x^{7} - 84 x^{6} + 126 x^{5} - 126 x^{4} + 84 x^{3} - 36 x^{2} + 9 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;97073 x^{9} - 812969 x^{8} + 2987174 x^{7} - 6291988 x^{6} + 8314586 x^{5} - 7066186 x^{4} + 3778651 x^{3} - 1166317 x^{2} + 160000 x,
\]
