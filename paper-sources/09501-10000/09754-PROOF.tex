...
\title{The empirical recurrence for OEIS A237230, proved by transfer matrix}
...
\begin{abstract}
OEIS A237230 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
The condition is local to two consecutive rows, so the count is a walk count on $S=2784$
...
OEIS A237230 is ``Number of (n+1)X(4+1) 0..2 arrays with the maximum plus the minimum of every 2X2 subblock differing from its horizontal and vertical neighbors by exactly one.''. It has offset $1$ and begins
\[
2784, 10888, 29456, 83436, 233536, 671080, 1919288, 5542856,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 09:59:50, revision 6) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The $2\times2$ subblocks of an $(n+1)\times5$ array form an
$n\times4$ grid, and each carries the value $\sigma=a+d$, where $a\le b\le c\le d$ are its four entries sorted --- its minimum, lower median, upper median and maximum. The entry asks that the values of
...
differ by $1$. The entry's first term $2784$ counts those, and the model was made to
...
\]
over the $S=2784$ pairs whose own subblock row already satisfies the condition along itself.
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-2) + 3\,a(n-3) + 24\,a(n-4) + 21\,a(n-5) + 28\,a(n-6) - 64\,a(n-7) - 199\,a(n-8) - 396\,a(n-9) - 578\,a(n-10) - 30\,a(n-11) - 136\,a(n-12) - 192\,a(n-13)
\]
for every $n>16$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237230.
