...
\title{The empirical recurrence for OEIS A202332, derived from the entry's generating function}
...
\begin{abstract}
OEIS A202332 carries an empirical recurrence of order $7$. The entry separately records a
...
OEIS A202332 is ``Number of (n+1) X 6 binary arrays with consecutive windows of two bits considered as a binary number nondecreasing in every row and column.''. It has offset $1$ and begins
\[
64, 191, 478, 1052, 2102, 3896, 6800, 11299,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 28 2018 08:02:29, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 17 x^{7} + 115 x^{6} - 331 x^{5} + 523 x^{4} - 485 x^{3} + 257 x^{2} - 64 x}{x^{7} - 7 x^{6} + 21 x^{5} - 35 x^{4} + 35 x^{3} - 21 x^{2} + 7 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;17 x^{7} - 115 x^{6} + 331 x^{5} - 523 x^{4} + 485 x^{3} - 257 x^{2} + 64 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A202332.
