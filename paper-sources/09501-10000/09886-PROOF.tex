...
\title{The empirical recurrence for OEIS A210293, proved by transfer matrix}
...
\begin{abstract}
OEIS A210293 counts $(n+1)\times2$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A210293 is ``Half the number of (n+1) X 2 0..3 arrays with every 2 X 2 subblock having at most one duplicate clockwise edge difference.''. It has offset $1$ and begins
\[
112, 1578, 22212, 312704, 4402192, 61973516, 872455004, 12282307884,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 11*a(n-1) + 42*a(n-2) + 20*a(n-3) - 18*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 15 2018 06:53:34, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;11\,a(n-1) + 42\,a(n-2) + 20\,a(n-3) - 18\,a(n-4)
\end{equation}
for all $n>3$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A210293.
