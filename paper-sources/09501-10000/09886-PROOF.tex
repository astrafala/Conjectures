...
\title{The empirical recurrence for OEIS A181279, derived from the entry's generating function}
...
\begin{abstract}
OEIS A181279 carries an empirical recurrence of order $7$. The entry separately records a
...
OEIS A181279 is ``Number of 3 X n binary matrices M with rows in strictly increasing order and rows of M*Mtranspose (mod 2) in strictly decreasing order.''. It has offset $1$ and begins
\[
0, 0, 9, 79, 766, 6060, 49928, 395024,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 27 2018 09:36:37, revision 11) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 512 x^{9} + 320 x^{8} - 224 x^{7} - 124 x^{6} + 16 x^{5} + 47 x^{4} - 9 x^{3}}{4096 x^{7} - 3584 x^{6} - 384 x^{5} + 1056 x^{4} - 216 x^{3} - 36 x^{2} + 14 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;512 x^{9} - 320 x^{8} + 224 x^{7} + 124 x^{6} - 16 x^{5} - 47 x^{4} + 9 x^{3},
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A181279.
