...
\title{The empirical recurrence for OEIS A250157, derived from the entry's generating function}
...
\begin{abstract}
OEIS A250157 carries an empirical recurrence of order $9$. The entry separately records a
...
OEIS A250157 is ``Number of length 3+6 0..n arrays with every seven consecutive terms having the maximum of some two terms equal to the minimum of the remaining five terms.''. It has offset $1$ and begins
\[
354, 8377, 79740, 455055, 1879526, 6219899, 17519352, 43657365,\ \dots
\]
...
\begin{quote}
G.f.: x*(354 + 5191*x + 17091*x\^{}2 + 9231*x\^{}3 - 4393*x\^{}4 - 1117*x\^{}5 + 51*x\^{}6 - 9*x\^{}7 + x\^{}8) / (1 - x)\^{}9.
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 12 2018 14:36:13, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{9} + 9 x^{8} - 51 x^{7} + 1117 x^{6} + 4393 x^{5} - 9231 x^{4} - 17091 x^{3} - 5191 x^{2} - 354 x}{x^{9} - 9 x^{8} + 36 x^{7} - 84 x^{6} + 126 x^{5} - 126 x^{4} + 84 x^{3} - 36 x^{2} + 9 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;x^{9} - 9 x^{8} + 51 x^{7} - 1117 x^{6} - 4393 x^{5} + 9231 x^{4} + 17091 x^{3} + 5191 x^{2} + 354 x,
\]
...
compared against all $21$ terms the entry publishes: it reproduces every one. This is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250157.
