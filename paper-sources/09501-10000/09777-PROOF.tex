...
\title{The empirical recurrence for OEIS A246738, derived from the entry's generating function}
...
\begin{abstract}
OEIS A246738 carries an empirical recurrence of order $9$. The entry separately records a
...
OEIS A246738 is ``Number of length 1+4 0..n arrays with no pair in any consecutive five terms totalling exactly n.''. It has offset $1$ and begins
\[
2, 12, 124, 424, 1566, 3876, 9368, 18768,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 06 2018 11:50:04, revision 7) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{332 x^{7} + 86 x^{6} + 378 x^{5} + 68 x^{4} + 88 x^{3} + 6 x^{2} + 2 x}{x^{9} - 3 x^{8} + 8 x^{6} - 6 x^{5} - 6 x^{4} + 8 x^{3} - 3 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;332 x^{7} + 86 x^{6} + 378 x^{5} + 68 x^{4} + 88 x^{3} + 6 x^{2} + 2 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A246738.
