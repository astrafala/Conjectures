...
\title{The empirical recurrence for OEIS A235906, proved by transfer matrix}
...
\begin{abstract}
OEIS A235906 counts arrays of width $4$ over $\{0,1,2\}$ in which the smallest and largest of the
...
OEIS A235906 is ``Number of (n+1)X(3+1) 0..2 arrays with the minimum plus the maximum unequal to the lower median plus the upper median in every 2X2 subblock.''. It has offset $1$ and begins
\[
1408, 26408, 499136, 9533120, 181855488, 3481713664, 66562286592, 1274524104704,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 08:55:28, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) + 396\,a(n-2) - 1048\,a(n-3) - 38944\,a(n-4) + 61312\,a(n-5) + 1096192\,a(n-6) - 877056\,a(n-7) - 1101824\,a(n-8) + 851968\,a(n-9)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A235906.
