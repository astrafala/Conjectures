...
\title{The empirical recurrence for OEIS A260760, proved by transfer matrix}
...
\begin{abstract}
OEIS A260760 counts $(n+2)\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A260760 is ``Number of (n+2)X(1+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000001 00000011 or 00010011.''. It has offset $1$ and begins
\[
48, 82, 190, 350, 622, 1315, 2478, 4597,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 12:10:20, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-3) + 3\,a(n-4) + 2\,a(n-5) + 5\,a(n-6) + 5\,a(n-8) + 2\,a(n-9) + 3\,a(n-10) + 4\,a(n-11) + 2\,a(n-12) + 6\,a(n-13) + a(n-14)
\]
for every $n>15$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A260760.
