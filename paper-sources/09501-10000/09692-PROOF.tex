...
\title{The empirical recurrence for OEIS A249850, derived from the entry's generating function}
...
\begin{abstract}
OEIS A249850 carries an empirical recurrence of order $11$. The entry separately records a
...
OEIS A249850 is ``Number of length 6+4 0..n arrays with no five consecutive terms having the maximum of any two terms equal to the minimum of the remaining three terms.''. It has offset $1$ and begins
\[
10, 2163, 81816, 1234328, 10653298, 63374127, 289372688, 1084868616,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 18 2017 18:11:13, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 2831 x^{9} - 77117 x^{8} - 529155 x^{7} - 1285419 x^{6} - 1221975 x^{5} - 451667 x^{4} - 58573 x^{3} - 2053 x^{2} - 10 x}{x^{11} - 11 x^{10} + 55 x^{9} - 165 x^{8} + 330 x^{7} - 462 x^{6} + 462 x^{5} - 330 x^{4} + 165 x^{3} - 55 x^{2} + 11 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;2831 x^{9} + 77117 x^{8} + 529155 x^{7} + 1285419 x^{6} + 1221975 x^{5} + 451667 x^{4} + 58573 x^{3} + 2053 x^{2} + 10 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A249850.
