...
\title{The empirical recurrence for OEIS A229442, derived from the entry's generating function}
...
\begin{abstract}
OEIS A229442 carries an empirical recurrence of order $11$. The entry separately records a
...
OEIS A229442 is ``Number of n X 5 0..2 arrays with horizontal differences mod 3 never 1, vertical differences mod 3 never -1, and rows and columns lexicographically nondecreasing.''. It has offset $1$ and begins
\[
7, 19, 60, 212, 753, 2546, 8024, 23428,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 17 2018 08:31:42, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{11} + 17 x^{10} - 103 x^{9} + 343 x^{8} - 709 x^{7} + 941 x^{6} - 896 x^{5} + 558 x^{4} - 236 x^{3} + 58 x^{2} - 7 x}{x^{11} - 11 x^{10} + 55 x^{9} - 165 x^{8} + 330 x^{7} - 462 x^{6} + 462 x^{5} - 330 x^{4} + 165 x^{3} - 55 x^{2} + 11 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;x^{11} - 17 x^{10} + 103 x^{9} - 343 x^{8} + 709 x^{7} - 941 x^{6} + 896 x^{5} - 558 x^{4} + 236 x^{3} - 58 x^{2} + 7 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A229442.
