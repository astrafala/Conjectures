...
\title{The empirical recurrence for OEIS A249964, derived from the entry's generating function}
...
\begin{abstract}
OEIS A249964 carries an empirical recurrence of order $10$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 21 2017 13:10:47, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n-1}\;=\;\frac{549 x^{7} + 15359 x^{6} + 81921 x^{5} + 145209 x^{4} + 96055 x^{3} + 22329 x^{2} + 1443 x + 15}{x^{10} - 10 x^{9} + 45 x^{8} - 120 x^{7} + 210 x^{6} - 252 x^{5} + 210 x^{4} - 120 x^{3} + 45 x^{2} - 10 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;549 x^{7} + 15359 x^{6} + 81921 x^{5} + 145209 x^{4} + 96055 x^{3} + 22329 x^{2} + 1443 x + 15,
\]
...
they stop at index $8$ because that polynomial has degree $7$. A reader who trusts
