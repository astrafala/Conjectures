...
\title{The empirical recurrence for OEIS A229441, derived from the entry's generating function}
...
\begin{abstract}
OEIS A229441 carries an empirical recurrence of order $9$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 17 2018 08:31:33, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 2 x^{9} + 19 x^{8} - 77 x^{7} + 177 x^{6} - 255 x^{5} + 224 x^{4} - 127 x^{3} + 40 x^{2} - 6 x}{x^{9} - 9 x^{8} + 36 x^{7} - 84 x^{6} + 126 x^{5} - 126 x^{4} + 84 x^{3} - 36 x^{2} + 9 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;2 x^{9} - 19 x^{8} + 77 x^{7} - 177 x^{6} + 255 x^{5} - 224 x^{4} + 127 x^{3} - 40 x^{2} + 6 x,
\]
