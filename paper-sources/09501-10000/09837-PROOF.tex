...
\title{The empirical recurrence for OEIS A297396, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297396 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A297396 is ``Number of 3 X n 0..1 arrays with every 1 horizontally, diagonally or antidiagonally adjacent to 1 neighboring 1.''. It has offset $1$ and begins
\[
1, 9, 19, 37, 127, 323, 763, 2121,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) + a(n-2) + 8*a(n-3) + a(n-4) - 2*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 28 2019 06:22:40, revision 7) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + a(n-2) + 8\,a(n-3) + a(n-4) - 2\,a(n-6)
\end{equation}
for all $n>7$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297396.
