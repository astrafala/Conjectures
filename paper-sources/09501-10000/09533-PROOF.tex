...
\title{The empirical recurrence for OEIS A304850, proved by transfer matrix}
...
\begin{abstract}
OEIS A304850 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A304850 is ``Number of nX3 0..1 arrays with every element unequal to 0, 1, 3, 4 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
3, 7, 9, 15, 29, 51, 91, 177,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) -6*a(n-3) +7*a(n-4) -a(n-5) -10*a(n-6) +4*a(n-7) -4*a(n-8) +3*a(n-9) +13*a(n-10) -5*a(n-11) -3*a(n-12)
\end{quote}
As of the ``Last modified'' line on the live entry (May 19 2018 12:31:39, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) - 6\,a(n-3) + 7\,a(n-4) - a(n-5) - 10\,a(n-6) + 4\,a(n-7) - 4\,a(n-8) + 3\,a(n-9) + 13\,a(n-10) - 5\,a(n-11) - 3\,a(n-12)
\end{equation}
for all $n>12$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A304850.
