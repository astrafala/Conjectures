...
\title{The empirical recurrence for OEIS A183911, derived from the entry's generating function}
...
\begin{abstract}
OEIS A183911 carries an empirical recurrence of order $9$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 06 2018 10:07:32, revision 9) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{2 x^{12} + 20 x^{11} - 120 x^{10} + 147 x^{9} + 120 x^{8} - 327 x^{7} + 116 x^{6} + 80 x^{5} - 12 x^{4} - 31 x^{3} + 5 x^{2} - x}{x^{9} - 9 x^{8} + 36 x^{7} - 84 x^{6} + 126 x^{5} - 126 x^{4} + 84 x^{3} - 36 x^{2} + 9 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 2 x^{12} - 20 x^{11} + 120 x^{10} - 147 x^{9} - 120 x^{8} + 327 x^{7} - 116 x^{6} - 80 x^{5} + 12 x^{4} + 31 x^{3} - 5 x^{2} + x,
\]
