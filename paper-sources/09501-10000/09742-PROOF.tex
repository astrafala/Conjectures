...
\title{The empirical recurrence for OEIS A236051, proved by transfer matrix}
...
\begin{abstract}
OEIS A236051 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
The condition is local to two consecutive rows, so the count is a walk count on $S=3760$
...
OEIS A236051 is ``Number of (n+1)X(4+1) 0..2 arrays colored with the difference of the maximum and minimum in each 2X2 subblock.''. It has offset $1$ and begins
\[
3760, 11656, 32608, 92392, 258432, 741592, 2124772, 6124496,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 09:02:44, revision 6) this is still
...
\]
over the $S=3760$ pairs whose own subblock row is properly coloured.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A236051.
