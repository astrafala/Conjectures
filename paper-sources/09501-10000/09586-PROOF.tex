...
\title{The empirical recurrence for OEIS A264192, proved by transfer matrix}
...
\begin{abstract}
OEIS A264192 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=5$ rows in which
...
OEIS A264192 is ``Number of (n+1)X(4+1) arrays of permutations of 0..n*5+4 with each element having index change +-(.,.) 0,0 0,2 or 2,1.''. It has offset $1$ and begins
\[
36, 864, 20736, 395280, 7535025, 150305220, 2998219536, 59481442800,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 10 2015 11:10:52, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;19\,a(n-1) + 16\,a(n-2) - 6032\,a(n-4) + 114608\,a(n-5) + 96512\,a(n-6) + 1544192\,a(n-8) - 29339648\,a(n-9) - 24707072\,a(n-10) + 16777216\,a(n-12) - 318767104\,a(n-13) - 268435456\,a(n-14)
\]
for every $n>16$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264192.
