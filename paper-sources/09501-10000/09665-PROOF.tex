...
\title{The empirical recurrence for OEIS A250065, derived from the entry's generating function}
...
\begin{abstract}
OEIS A250065 carries an empirical recurrence of order $13$. The entry separately records a
...
OEIS A250065 is ``Number of length 6+6 0..n arrays with no seven consecutive terms having the maximum of any two terms equal to the minimum of the remaining five terms.''. It has offset $1$ and begins
\[
21, 12284, 915064, 22838540, 295152625, 2461761504, 15032948568, 72725094312,\ \dots
\]
...
\begin{quote}
G.f.: x*(21 + 12011*x + 757010*x\^{}2 + 11894854*x\^{}3 + 66128388*x\^{}4 + 153231228*x\^{}5 + 158628614*x\^{}6 + 73421530*x\^{}7 + 14037031*x\^{}8 + 882297*x\^{}9 + 8616*x\^{}10) / (1 - x)\^{}13.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 23 2017 09:54:53, revision 7) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 8616 x^{11} - 882297 x^{10} - 14037031 x^{9} - 73421530 x^{8} - 158628614 x^{7} - 153231228 x^{6} - 66128388 x^{5} - 11894854 x^{4} - 757010 x^{3} - 12011 x^{2} - 21 x}{x^{13} - 13 x^{12} + 78 x^{11} - 286 x^{10} + 715 x^{9} - 1287 x^{8} + 1716 x^{7} - 1716 x^{6} + 1287 x^{5} - 715 x^{4} + 286 x^{3} - 78 x^{2} + 13 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;8616 x^{11} + 882297 x^{10} + 14037031 x^{9} + 73421530 x^{8} + 158628614 x^{7} + 153231228 x^{6} + 66128388 x^{5} + 11894854 x^{4} + 757010 x^{3} + 12011 x^{2} + 21 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250065.
