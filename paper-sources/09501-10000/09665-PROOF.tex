...
\title{The empirical recurrence for OEIS A232296, proved by transfer matrix}
...
\begin{abstract}
OEIS A232296 counts arrays of width $2$ over $\{0,1,2\}$ in which every cell carrying one stated
...
OEIS A232296 is ``Number of 2Xn 0..2 arrays with every 0 next to a 1 and every 1 next to a 2 horizontally or antidiagonally.''. It has offset $1$ and begins
\[
1, 15, 97, 587, 3615, 22387, 138505, 856719,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 6*a(n-1) -a(n-2) +13*a(n-3) +2*a(n-4) -a(n-5) +a(n-6) -14*a(n-7) -2*a(n-8) +5*a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 07:16:16, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) - a(n-2) + 13\,a(n-3) + 2\,a(n-4) - a(n-5) + a(n-6) - 14\,a(n-7) - 2\,a(n-8) + 5\,a(n-9)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232296.
