...
\title{The empirical recurrence for OEIS A241622, derived from the entry's generating function}
...
\begin{abstract}
OEIS A241622 carries an empirical recurrence of order $10$. The entry separately records a
...
OEIS A241622 is ``Number of length 7+2 0..n arrays with no consecutive three elements summing to more than n.''. It has offset $1$ and begins
\[
41, 556, 4175, 21631, 86828, 289248, 835812, 2159025,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 30 2018 20:20:04, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{10} + 10 x^{9} - 45 x^{8} + 120 x^{7} - 209 x^{6} + 283 x^{5} - 19 x^{4} + 460 x^{3} + 146 x^{2} + 41 x}{x^{10} - 10 x^{9} + 45 x^{8} - 120 x^{7} + 210 x^{6} - 252 x^{5} + 210 x^{4} - 120 x^{3} + 45 x^{2} - 10 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- x^{10} + 10 x^{9} - 45 x^{8} + 120 x^{7} - 209 x^{6} + 283 x^{5} - 19 x^{4} + 460 x^{3} + 146 x^{2} + 41 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A241622.
