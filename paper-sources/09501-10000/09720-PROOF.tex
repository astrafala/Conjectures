...
\title{The empirical recurrence for OEIS A245954, derived from the entry's generating function}
...
\begin{abstract}
OEIS A245954 carries an empirical recurrence of order $10$. The entry separately records a
...
OEIS A245954 is ``Number of length 4+3 0..n arrays with some pair in every consecutive four terms totalling exactly n.''. It has offset $1$ and begins
\[
88, 1501, 7744, 31465, 82968, 199141, 397504, 754321,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 05 2018 18:09:28, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{10} + 2 x^{9} - 658 x^{8} - 310 x^{7} + 2708 x^{6} + 8990 x^{5} + 12178 x^{4} + 4478 x^{3} + 1325 x^{2} + 88 x}{x^{10} - 2 x^{9} - 3 x^{8} + 8 x^{7} + 2 x^{6} - 12 x^{5} + 2 x^{4} + 8 x^{3} - 3 x^{2} - 2 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- x^{10} + 2 x^{9} - 658 x^{8} - 310 x^{7} + 2708 x^{6} + 8990 x^{5} + 12178 x^{4} + 4478 x^{3} + 1325 x^{2} + 88 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A245954.
