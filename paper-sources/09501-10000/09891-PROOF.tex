...
\title{The empirical recurrence for OEIS A204216, derived from the entry's generating function}
...
\begin{abstract}
OEIS A204216 carries an empirical recurrence of order $7$. The entry separately records a
...
OEIS A204216 is ``Number of length 8 nonnegative integer arrays starting and ending with 0 with adjacent elements differing by no more than n.''. It has offset $1$ and begins
\[
127, 1925, 12492, 51945, 164255, 431445, 991152, 2057553,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 06 2018 12:02:56, revision 9) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{7} + 7 x^{6} - 42 x^{5} - 481 x^{4} - 1684 x^{3} - 1036 x^{2} - 127 x}{x^{7} - 7 x^{6} + 21 x^{5} - 35 x^{4} + 35 x^{3} - 21 x^{2} + 7 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;x^{7} - 7 x^{6} + 42 x^{5} + 481 x^{4} + 1684 x^{3} + 1036 x^{2} + 127 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204216.
