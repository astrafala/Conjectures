...
\title{The empirical recurrence for OEIS A241938, derived from the entry's generating function}
...
\begin{abstract}
OEIS A241938 carries an empirical recurrence of order $7$. The entry separately records a
...
OEIS A241938 is ``Number of length 2+4 0..n arrays with no consecutive five elements summing to more than 2*n.''. It has offset $1$ and begins
\[
26, 218, 1043, 3599, 10031, 24052, 51570, 101421,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 30 2018 20:20:23, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{7} + 7 x^{6} - 21 x^{5} + 34 x^{4} - 63 x^{3} - 36 x^{2} - 26 x}{x^{7} - 7 x^{6} + 21 x^{5} - 35 x^{4} + 35 x^{3} - 21 x^{2} + 7 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;x^{7} - 7 x^{6} + 21 x^{5} - 34 x^{4} + 63 x^{3} + 36 x^{2} + 26 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A241938.
