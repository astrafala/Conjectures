...
\title{The empirical recurrence for OEIS A200789, derived from the entry's generating function}
...
\begin{abstract}
OEIS A200789 carries an empirical recurrence of order $8$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 21 2017 21:51:54, revision 15) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{8} + 8 x^{7} - 28 x^{6} + 60 x^{5} + 123 x^{4} + 960 x^{3} + 767 x^{2} + 128 x}{x^{8} - 8 x^{7} + 28 x^{6} - 56 x^{5} + 70 x^{4} - 56 x^{3} + 28 x^{2} - 8 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- x^{8} + 8 x^{7} - 28 x^{6} + 60 x^{5} + 123 x^{4} + 960 x^{3} + 767 x^{2} + 128 x,
\]
