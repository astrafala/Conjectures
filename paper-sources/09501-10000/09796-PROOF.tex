...
\title{The empirical recurrence for OEIS A026201, derived from the entry's generating function}
...
\begin{abstract}
OEIS A026201 carries an empirical recurrence of order $8$. The entry separately records a
...
OEIS A026201 is ``Position of n in A026200.''. It has offset $1$ and begins
\[
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 14 2019 21:08:23, revision 7) the first is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A026201.
