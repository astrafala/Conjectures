...
\title{The empirical recurrence for OEIS A250677, proved by transfer matrix}
...
\begin{abstract}
OEIS A250677 counts arrays over $\{0,1,2,3\}$ in which a statistic taken over short runs
...
OEIS A250677 is ``Number of (1+1) X (n+1) 0..3 arrays with nondecreasing x(i,j)+x(i,j-1) in the i direction and nondecreasing absolute value of x(i,j)-x(i-1,j) in the j direction.''. It has offset $1$ and begins
\[
104, 669, 3927, 22119, 120233, 637948, 3321772, 17052553,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 10*a(n-1) - 21*a(n-2) - 54*a(n-3) + 155*a(n-4) + 118*a(n-5) - 228*a(n-6) - 144*a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 19 2018 22:09:07, revision 11) this is still
...
\begin{theorem}
\[
a(n)\;=\;10\,a(n-1) - 21\,a(n-2) - 54\,a(n-3) + 155\,a(n-4) + 118\,a(n-5) - 228\,a(n-6) - 144\,a(n-7)
\]
for every $n>6$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250677.
