...
\title{The empirical recurrence for OEIS A200844, derived from the entry's generating function}
...
\begin{abstract}
OEIS A200844 carries an empirical recurrence of order $10$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 15 2017 01:12:00, revision 11) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{10} + 10 x^{9} - 44 x^{8} + 94 x^{7} + 36 x^{6} - 622 x^{5} - 618 x^{4} + 10390 x^{3} + 6115 x^{2} + 512 x}{x^{10} - 10 x^{9} + 45 x^{8} - 120 x^{7} + 210 x^{6} - 252 x^{5} + 210 x^{4} - 120 x^{3} + 45 x^{2} - 10 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- x^{10} + 10 x^{9} - 44 x^{8} + 94 x^{7} + 36 x^{6} - 622 x^{5} - 618 x^{4} + 10390 x^{3} + 6115 x^{2} + 512 x,
\]
