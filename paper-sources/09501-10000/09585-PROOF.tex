...
\title{The empirical recurrence for OEIS A297371, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297371 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A297371 is ``Number of nX5 0..1 arrays with every 1 horizontally or antidiagonally adjacent to 0, 1 or 2 neighboring 1s.''. It has offset $1$ and begins
\[
32, 765, 17534, 409507, 9554038, 222925151, 5201484239, 121365562862,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 24*a(n-1) -14*a(n-2) -23*a(n-3) -339*a(n-4) +535*a(n-5) +104*a(n-6) -229*a(n-7) +7*a(n-8) +8*a(n-9) for n>11
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 29 2017 07:38:30, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;24\,a(n-1) - 14\,a(n-2) - 23\,a(n-3) - 339\,a(n-4) + 535\,a(n-5) + 104\,a(n-6) - 229\,a(n-7) + 7\,a(n-8) + 8\,a(n-9)
\end{equation}
for all $n>11$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297371.
