...
\title{The empirical recurrence for OEIS A298275, proved by transfer matrix}
...
\begin{abstract}
OEIS A298275 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $equal to$ itself lying in $\{1,2,3,4,5\}$, and it carries an empirical
...
OEIS A298275 is ``Number of nX3 0..1 arrays with every element equal to 1, 2, 3, 4 or 5 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 18, 129, 873, 6013, 41437, 285280, 1964290,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 6*a(n-1) +8*a(n-2) -12*a(n-3) -8*a(n-4) +2*a(n-5) +3*a(n-6) -2*a(n-7) -7*a(n-9) +2*a(n-10) for n>11
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 16 2018 08:04:34, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) + 8\,a(n-2) - 12\,a(n-3) - 8\,a(n-4) + 2\,a(n-5) + 3\,a(n-6) - 2\,a(n-7) - 7\,a(n-9) + 2\,a(n-10)
\end{equation}
for all $n>11$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A298275.
