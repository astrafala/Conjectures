...
\title{The empirical recurrence for OEIS A246476, proved by transfer matrix}
...
\begin{abstract}
OEIS A246476 carries an empirical recurrence of order $4$ contributed by R.~H.~Hardin. It is
...
OEIS A246476 is ``Number of length n+3 0..5 arrays with no pair in any consecutive four terms totalling exactly 5.''. It has offset $1$ and begins
\[
462, 1734, 6534, 24582, 92478, 347934, 1309038, 4924998,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) + 2*a(n-2) + 3*a(n-3) +a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 06 2018 04:12:22, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A246476.
