...
\title{The empirical recurrence for OEIS A183624, proved by transfer matrix}
...
\begin{abstract}
OEIS A183624 counts $2$-column arrays over $\{0,\dots,2\}$ in which every
...
OEIS A183624 is ``Number of (n+1) X 2 0..2 arrays with every 2 x 2 subblock summing to 4.''. It has offset $1$
and begins
\[
19, 45, 115, 309, 859, 2445, 7075, 20709,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 6*a(n-1) - 11*a(n-2) + 6*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 22 2018 09:01:08, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A183624.
