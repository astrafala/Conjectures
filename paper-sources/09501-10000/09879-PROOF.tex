...
\title{The empirical recurrence for OEIS A269682, derived from the entry's generating function}
...
\begin{abstract}
OEIS A269682 carries an empirical recurrence of order $8$. The entry separately records a
...
OEIS A269682 is ``Number of length-7 0..n arrays with no repeated value differing from the previous repeated value by other than plus or minus one modulo n+1.''. It has offset $1$ and begins
\[
30, 1206, 10700, 57030, 220050, 681254, 1799256, 4215510,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 26 2019 11:10:23, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 24 x^{9} + 202 x^{8} - 752 x^{7} + 1234 x^{6} - 2026 x^{5} + 3518 x^{4} + 1892 x^{3} + 966 x^{2} + 30 x}{x^{8} - 8 x^{7} + 28 x^{6} - 56 x^{5} + 70 x^{4} - 56 x^{3} + 28 x^{2} - 8 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 24 x^{9} + 202 x^{8} - 752 x^{7} + 1234 x^{6} - 2026 x^{5} + 3518 x^{4} + 1892 x^{3} + 966 x^{2} + 30 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269682.
