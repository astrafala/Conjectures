...
\title{The empirical recurrence for OEIS A227382, derived from the entry's generating function}
...
\begin{abstract}
OEIS A227382 carries an empirical recurrence of order $10$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 08 2018 11:06:18, revision 9) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{13} + 6 x^{12} - 16 x^{11} + 19 x^{10} - 42 x^{8} + 107 x^{7} - 179 x^{6} + 207 x^{5} - 160 x^{4} + 84 x^{3} - 25 x^{2} + 4 x}{x^{10} - 10 x^{9} + 45 x^{8} - 120 x^{7} + 210 x^{6} - 252 x^{5} + 210 x^{4} - 120 x^{3} + 45 x^{2} - 10 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- x^{13} + 6 x^{12} - 16 x^{11} + 19 x^{10} - 42 x^{8} + 107 x^{7} - 179 x^{6} + 207 x^{5} - 160 x^{4} + 84 x^{3} - 25 x^{2} + 4 x,
\]
