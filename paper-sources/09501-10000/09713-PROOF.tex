...
\title{The empirical recurrence for OEIS A227122, derived from the entry's generating function}
...
\begin{abstract}
OEIS A227122 carries an empirical recurrence of order $10$. The entry separately records a
...
OEIS A227122 is ``Number of n X 3 0,1 arrays indicating 2 X 2 subblocks of some larger (n+1) X 4 binary array having a sum of zero, with rows and columns of the latter in lexicographically nondecreasing order.''. It has offset $1$ and begins
\[
4, 13, 33, 81, 202, 492, 1143, 2524,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 07 2018 07:59:33, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{x^{12} - 4 x^{11} - x^{10} + 28 x^{9} - 62 x^{8} + 87 x^{7} - 121 x^{6} + 157 x^{5} - 144 x^{4} + 83 x^{3} - 27 x^{2} + 4 x}{x^{10} - 10 x^{9} + 45 x^{8} - 120 x^{7} + 210 x^{6} - 252 x^{5} + 210 x^{4} - 120 x^{3} + 45 x^{2} - 10 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;x^{12} - 4 x^{11} - x^{10} + 28 x^{9} - 62 x^{8} + 87 x^{7} - 121 x^{6} + 157 x^{5} - 144 x^{4} + 83 x^{3} - 27 x^{2} + 4 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A227122.
