...
\title{The empirical recurrence for OEIS A249966, derived from the entry's generating function}
...
\begin{abstract}
OEIS A249966 carries an empirical recurrence of order $12$. The entry separately records a
...
OEIS A249966 is ``Number of length 6+5 0..n arrays with no six consecutive terms having the maximum of any two terms equal to the minimum of the remaining four terms.''. It has offset $1$ and begins
\[
15, 4999, 267004, 5207128, 55191061, 389769865, 2062131616, 8794967112,\ \dots
\]
...
\begin{quote}
G.f.: x*(15 + 4819*x + 208006*x\^{}2 + 2329714*x\^{}3 + 9235434*x\^{}4 + 14869326*x\^{}5 + 10156734*x\^{}6 + 2833778*x\^{}7 + 273635*x\^{}8 + 5339*x\^{}9) / (1 - x)\^{}12.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 21 2017 22:53:15, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{5339 x^{10} + 273635 x^{9} + 2833778 x^{8} + 10156734 x^{7} + 14869326 x^{6} + 9235434 x^{5} + 2329714 x^{4} + 208006 x^{3} + 4819 x^{2} + 15 x}{x^{12} - 12 x^{11} + 66 x^{10} - 220 x^{9} + 495 x^{8} - 792 x^{7} + 924 x^{6} - 792 x^{5} + 495 x^{4} - 220 x^{3} + 66 x^{2} - 12 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;5339 x^{10} + 273635 x^{9} + 2833778 x^{8} + 10156734 x^{7} + 14869326 x^{6} + 9235434 x^{5} + 2329714 x^{4} + 208006 x^{3} + 4819 x^{2} + 15 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A249966.
