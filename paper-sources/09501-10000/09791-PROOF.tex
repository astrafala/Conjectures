...
\title{The empirical recurrence for OEIS A183879, derived from the entry's generating function}
...
\begin{abstract}
OEIS A183879 carries an empirical recurrence of order $8$. The entry separately records a
...
OEIS A183879 is ``Number of arrangements of n+2 numbers in 0..4 with each number being the sum mod 5 of two others.''. It has offset $1$ and begins
\[
1, 25, 821, 8361, 57625, 336617, 1817149, 9433849,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 05 2018 09:05:57, revision 11) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 960 x^{9} + 4312 x^{8} - 7204 x^{7} + 4706 x^{6} + 701 x^{5} - 1960 x^{4} + 538 x^{3} + 10 x^{2} + x}{40 x^{8} - 228 x^{7} + 554 x^{6} - 747 x^{5} + 609 x^{4} - 306 x^{3} + 92 x^{2} - 15 x + 1},
\]
the entry's own generating function, and let
\[
D(x)\;=\;1-\sum_i c_i x^{i}\;=\;40 x^{8} - 228 x^{7} + 554 x^{6} - 747 x^{5} + 609 x^{4} - 306 x^{3} + 92 x^{2} - 15 x + 1
\]
...
\begin{theorem}
\[
a(n)\;=\;15\,a(n-1) - 92\,a(n-2) + 306\,a(n-3) - 609\,a(n-4) + 747\,a(n-5) - 554\,a(n-6) + 228\,a(n-7) - 40\,a(n-8)
\]
for every $n>9$.
\end{theorem}
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 960 x^{9} + 4312 x^{8} - 7204 x^{7} + 4706 x^{6} + 701 x^{5} - 1960 x^{4} + 538 x^{3} + 10 x^{2} + x,
\]
...
\[
40 x^{8} - 228 x^{7} + 554 x^{6} - 747 x^{5} + 609 x^{4} - 306 x^{3} + 92 x^{2} - 15 x + 1,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A183879.
