...
\title{The empirical recurrence for OEIS A267470, derived from the entry's generating function}
...
\begin{abstract}
OEIS A267470 carries an empirical recurrence of order $9$. The entry separately records a
...
OEIS A267470 is ``Number of length-n 0..7 arrays with no following elements larger than the first repeated value.''. It has offset $1$ and begins
\[
8, 64, 484, 3592, 26440, 193852, 1418740, 10378144,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 05 2018 09:36:08, revision 7) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 212976 x^{9} + 640424 x^{8} - 743140 x^{7} + 448476 x^{6} - 156912 x^{5} + 33012 x^{4} - 4116 x^{3} + 280 x^{2} - 8 x}{282240 x^{9} - 807408 x^{8} + 936452 x^{7} - 589112 x^{6} + 224427 x^{5} - 54201 x^{4} + 8358 x^{3} - 798 x^{2} + 43 x - 1},
\]
the entry's own generating function, and let
\[
D(x)\;=\;1-\sum_i c_i x^{i}\;=\;- 282240 x^{9} + 807408 x^{8} - 936452 x^{7} + 589112 x^{6} - 224427 x^{5} + 54201 x^{4} - 8358 x^{3} + 798 x^{2} - 43 x + 1
\]
...
\begin{theorem}
\[
a(n)\;=\;43\,a(n-1) - 798\,a(n-2) + 8358\,a(n-3) - 54201\,a(n-4) + 224427\,a(n-5) - 589112\,a(n-6) + 936452\,a(n-7) - 807408\,a(n-8) + 282240\,a(n-9)
\]
for every $n>9$.
\end{theorem}
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;212976 x^{9} - 640424 x^{8} + 743140 x^{7} - 448476 x^{6} + 156912 x^{5} - 33012 x^{4} + 4116 x^{3} - 280 x^{2} + 8 x,
\]
...
\[
282240 x^{9} - 807408 x^{8} + 936452 x^{7} - 589112 x^{6} + 224427 x^{5} - 54201 x^{4} + 8358 x^{3} - 798 x^{2} + 43 x - 1,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267470.
