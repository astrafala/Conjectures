...
\title{The empirical recurrence for OEIS A207237, proved by transfer matrix}
...
\begin{abstract}
OEIS A207237 counts arrays over $\{0,\dots,1\}$ of width $3$ that avoid the patterns
...
OEIS A207237 is ``Number of nX3 0..1 arrays avoiding 0 0 0 and 0 1 1 horizontally and 0 0 1 and 0 1 0 vertically.''. It has offset
$1$ and begins
\[
6, 36, 102, 287, 882, 2491, 6759,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 13:39:32, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) - a(n-2) + 6\,a(n-3) - 12\,a(n-4) - 8\,a(n-5) - 10\,a(n-6) + 8\,a(n-7) + 13\,a(n-8) + 11\,a(n-9) - 2\,a(n-10) - 4\,a(n-11) - 4\,a(n-12) + a(n-14)
\end{equation}
for all $n>14$. 
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207237.
