...
\title{The empirical recurrence for OEIS A249848, derived from the entry's generating function}
...
\begin{abstract}
OEIS A249848 carries an empirical recurrence of order $9$. The entry separately records a
...
OEIS A249848 is ``Number of length 4+4 0..n arrays with no five consecutive terms having the maximum of any two terms equal to the minimum of the remaining three terms.''. It has offset $1$ and begins
\[
10, 653, 11052, 92190, 499654, 2029683, 6712760, 19039308,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 18 2017 18:10:59, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 311 x^{7} - 4287 x^{6} - 14224 x^{5} - 15390 x^{4} - 5535 x^{3} - 563 x^{2} - 10 x}{x^{9} - 9 x^{8} + 36 x^{7} - 84 x^{6} + 126 x^{5} - 126 x^{4} + 84 x^{3} - 36 x^{2} + 9 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;311 x^{7} + 4287 x^{6} + 14224 x^{5} + 15390 x^{4} + 5535 x^{3} + 563 x^{2} + 10 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A249848.
