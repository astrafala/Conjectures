...
\title{The empirical recurrence for OEIS A250374, derived from the entry's generating function}
...
\begin{abstract}
OEIS A250374 carries an empirical recurrence of order $7$. The entry separately records a
...
\begin{quote}
G.f.: x*(93 + 731*x + 1243*x\^{}2 + 404*x\^{}3 + 55*x\^{}4 - 7*x\^{}5 + x\^{}6) / (1 - x)\^{}7.
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 13 2018 12:48:36, revision 7) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{7} + 7 x^{6} - 55 x^{5} - 404 x^{4} - 1243 x^{3} - 731 x^{2} - 93 x}{x^{7} - 7 x^{6} + 21 x^{5} - 35 x^{4} + 35 x^{3} - 21 x^{2} + 7 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;x^{7} - 7 x^{6} + 55 x^{5} + 404 x^{4} + 1243 x^{3} + 731 x^{2} + 93 x,
\]
