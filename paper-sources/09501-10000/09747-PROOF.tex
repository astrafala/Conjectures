...
\title{The empirical recurrence for OEIS A200843, derived from the entry's generating function}
...
\begin{abstract}
OEIS A200843 carries an empirical recurrence of order $9$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 08:49:41, revision 11) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{9} + 9 x^{8} - 35 x^{7} + 77 x^{6} - 177 x^{5} + 679 x^{4} - 1313 x^{3} - 1753 x^{2} - 256 x}{x^{9} - 9 x^{8} + 36 x^{7} - 84 x^{6} + 126 x^{5} - 126 x^{4} + 84 x^{3} - 36 x^{2} + 9 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;x^{9} - 9 x^{8} + 35 x^{7} - 77 x^{6} + 177 x^{5} - 679 x^{4} + 1313 x^{3} + 1753 x^{2} + 256 x,
\]
