...
\title{The empirical recurrence for OEIS A227555, derived from the entry's generating function}
...
\begin{abstract}
OEIS A227555 carries an empirical recurrence of order $12$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 08 2018 12:43:19, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{31 x^{11} - 150 x^{10} + 439 x^{9} - 848 x^{8} + 1197 x^{7} - 1246 x^{6} + 967 x^{5} - 541 x^{4} + 213 x^{3} - 51 x^{2} + 7 x}{x^{12} - 12 x^{11} + 66 x^{10} - 220 x^{9} + 495 x^{8} - 792 x^{7} + 924 x^{6} - 792 x^{5} + 495 x^{4} - 220 x^{3} + 66 x^{2} - 12 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;31 x^{11} - 150 x^{10} + 439 x^{9} - 848 x^{8} + 1197 x^{7} - 1246 x^{6} + 967 x^{5} - 541 x^{4} + 213 x^{3} - 51 x^{2} + 7 x,
\]
