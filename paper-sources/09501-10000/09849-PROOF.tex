...
\title{The empirical recurrence for OEIS A250156, derived from the entry's generating function}
...
\begin{abstract}
OEIS A250156 carries an empirical recurrence of order $8$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 12 2018 14:35:26, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{8} + 8 x^{7} - 68 x^{6} - 339 x^{5} + 1707 x^{4} + 4514 x^{3} + 1906 x^{2} + 193 x}{x^{8} - 8 x^{7} + 28 x^{6} - 56 x^{5} + 70 x^{4} - 56 x^{3} + 28 x^{2} - 8 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- x^{8} + 8 x^{7} - 68 x^{6} - 339 x^{5} + 1707 x^{4} + 4514 x^{3} + 1906 x^{2} + 193 x,
\]
