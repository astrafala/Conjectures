...
\title{The empirical recurrence for OEIS A250897, derived from the entry's generating function}
...
\begin{abstract}
OEIS A250897 carries an empirical recurrence of order $7$. The entry separately records a
...
OEIS A250897 is ``Number of (n+1) X (7+1) 0..2 arrays with nondecreasing x(i,j)-x(i,j-1) in the i direction and nondecreasing absolute value of x(i,j)-x(i-1,j) in the j direction.''. It has offset $1$ and begins
\[
32095, 88421, 244200, 680504, 1893433, 5232461, 14283986, 38498188,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 23 2018 05:37:45, revision 7) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{73990 x^{9} - 174146 x^{8} - 162292 x^{7} + 1181770 x^{6} - 2239408 x^{5} + 2144026 x^{4} - 1108848 x^{3} + 296719 x^{2} - 32095 x}{24 x^{7} - 116 x^{6} + 234 x^{5} - 255 x^{4} + 162 x^{3} - 60 x^{2} + 12 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 73990 x^{9} + 174146 x^{8} + 162292 x^{7} - 1181770 x^{6} + 2239408 x^{5} - 2144026 x^{4} + 1108848 x^{3} - 296719 x^{2} + 32095 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250897.
