...
\title{The empirical recurrence for OEIS A234697, proved by transfer matrix}
...
\begin{abstract}
OEIS A234697 counts $2$-column arrays over $\{0,\dots,7\}$ in which every
...
OEIS A234697 is ``Number of (n+1) X (1+1) 0..7 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 5 (constant-stress 1 X 1 tilings).''. It has offset
$1$ and begins
\[
408, 2628, 16848, 109224, 704160, 4594320, 29782080,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 6*a(n-1) + 90*a(n-2) - 540*a(n-3) - 2016*a(n-4) + 12096*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 19 2022 01:09:41, revision 10) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) + 90\,a(n-2) - 540\,a(n-3) - 2016\,a(n-4) + 12096\,a(n-5)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234697.
