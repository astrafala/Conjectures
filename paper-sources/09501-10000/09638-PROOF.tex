...
\title{The empirical recurrence for OEIS A261259, proved by transfer matrix}
...
\begin{abstract}
OEIS A261259 counts $(n+2)\times4$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A261259 is ``Number of (n+2) X (2+2) 0..1 arrays with each 3 X 3 subblock having clockwise perimeter pattern 00010101 00100101 or 01010101.''. It has offset $1$ and begins
\[
41, 52, 110, 232, 418, 758, 1436, 2724,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + 2*a(n-3) + a(n-4) + 2*a(n-5) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 30 2018 09:11:11, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A261259.
