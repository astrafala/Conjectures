...
\title{The empirical recurrence for OEIS A300178, proved by transfer matrix}
...
\begin{abstract}
OEIS A300178 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A300178 is ``Number of nX4 0..1 arrays with every element equal to 0, 1, 2, 3, 4, 5, 6 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
8, 128, 2033, 32321, 513832, 8168705, 129863167, 2064518282,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 14*a(n-1) +27*a(n-2) +51*a(n-3) -10*a(n-4) -a(n-5) -10*a(n-6)
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 27 2018 12:29:46, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A300178.
