...
\title{The empirical recurrence for OEIS A304341, proved by transfer matrix}
...
\begin{abstract}
OEIS A304341 counts $2$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A304341 is ``Number of nX2 0..1 arrays with every element unequal to 0, 1, 2, 4 or 5 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
2, 4, 14, 28, 94, 284, 752, 2244,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) +2*a(n-2) +6*a(n-3) -10*a(n-4) -8*a(n-5) for n>6
\end{quote}
As of the ``Last modified'' line on the live entry (May 11 2018 14:12:56, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A304341.
