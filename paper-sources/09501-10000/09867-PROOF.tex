...
\title{The empirical recurrence for OEIS A268265, derived from the entry's generating function}
...
\begin{abstract}
OEIS A268265 carries an empirical recurrence of order $8$. The entry separately records a
...
OEIS A268265 is ``Number of length-(6+1) 0..n arrays with new repeated values introduced in sequential order starting with zero.''. It has offset $1$ and begins
\[
65, 717, 5492, 29461, 118530, 384605, 1061632, 2587557,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 13 2019 11:30:28, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 5 x^{9} + 35 x^{8} - 76 x^{7} + 271 x^{6} + 1016 x^{5} + 1961 x^{4} + 1576 x^{3} + 197 x^{2} + 65 x}{x^{8} - 8 x^{7} + 28 x^{6} - 56 x^{5} + 70 x^{4} - 56 x^{3} + 28 x^{2} - 8 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 5 x^{9} + 35 x^{8} - 76 x^{7} + 271 x^{6} + 1016 x^{5} + 1961 x^{4} + 1576 x^{3} + 197 x^{2} + 65 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268265.
