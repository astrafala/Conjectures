...
\title{The empirical recurrence for OEIS A250143, derived from the entry's generating function}
...
\begin{abstract}
OEIS A250143 carries an empirical recurrence of order $7$. The entry separately records a
...
OEIS A250143 is ``Number of length 4+2 0..n arrays with the medians of every three consecutive terms nondecreasing.''. It has offset $1$ and begins
\[
41, 391, 1959, 6902, 19446, 46914, 100962, 199023,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 12 2018 03:00:59, revision 11) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{7} + 7 x^{6} - 21 x^{5} + 35 x^{4} - 83 x^{3} - 104 x^{2} - 41 x}{x^{7} - 7 x^{6} + 21 x^{5} - 35 x^{4} + 35 x^{3} - 21 x^{2} + 7 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;x^{7} - 7 x^{6} + 21 x^{5} - 35 x^{4} + 83 x^{3} + 104 x^{2} + 41 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250143.
