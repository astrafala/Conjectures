...
\title{The empirical recurrence for OEIS A236804, proved by transfer matrix}
...
\begin{abstract}
OEIS A236804 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
The condition is local to two consecutive rows, so the count is a walk count on $S=235$
...
OEIS A236804 is ``Number of (n+1) X (3+1) 0..2 arrays with the maximum plus the lower median minus the upper median minus the minimum of every 2 X 2 subblock equal.''. It has offset $1$ and begins
\[
1033, 8825, 85929, 929447, 9558409, 107087939, 1117775361, 12821027315,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 24 2025 14:54:12, revision 11) this is still
...
array, which is not among the objects counted. There are $S=235$ states left.
...
\begin{theorem}
\[
a(n)\;=\;24\,a(n-1) - 55\,a(n-2) - 2772\,a(n-3) + 26568\,a(n-4) - 71616\,a(n-5) - 74996\,a(n-6) + 644112\,a(n-7) - 762032\,a(n-8) - 588288\,a(n-9) + 1612416\,a(n-10) - 783360\,a(n-11)
\]
for every $n>10$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A236804.
