...
\title{The empirical recurrence for OEIS A269412, derived from the entry's generating function}
...
\begin{abstract}
OEIS A269412 carries an empirical recurrence of order $7$. The entry separately records a
...
OEIS A269412 is ``Number of length-6 0..n arrays with no repeated value greater than or equal to the previous repeated value.''. It has offset $1$ and begins
\[
16, 394, 2872, 12380, 39560, 104006, 238224, 492312,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 21 2019 12:22:35, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{18 x^{5} + 10 x^{4} - 450 x^{3} - 282 x^{2} - 16 x}{x^{7} - 7 x^{6} + 21 x^{5} - 35 x^{4} + 35 x^{3} - 21 x^{2} + 7 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 18 x^{5} - 10 x^{4} + 450 x^{3} + 282 x^{2} + 16 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269412.
