...
\title{The empirical recurrence for OEIS A185790, proved by transfer matrix}
...
\begin{abstract}
OEIS A185790 counts arrays over $\{0,\dots,1\}$ under a condition on the sum of every
...
OEIS A185790 is ``Number of (n+1) X 2 binary arrays with no 2 X 2 subblock sum equal to any horizontal or vertical neighbor 2 X 2 subblock sum.''. It has offset $1$ and begins
\[
16, 40, 100, 260, 676, 1716, 4356, 11220,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + 4*a(n-3) + 16*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 16 2018 16:25:10, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A185790.
