...
\title{The empirical recurrence for OEIS A250145, derived from the entry's generating function}
...
\begin{abstract}
OEIS A250145 carries an empirical recurrence of order $9$. The entry separately records a
...
OEIS A250145 is ``Number of length 6+2 0..n arrays with the medians of every three consecutive terms nondecreasing.''. It has offset $1$ and begins
\[
111, 2026, 16104, 81664, 311498, 974944, 2637228, 6376143,\ \dots
\]
...
\begin{quote}
G.f.: x*(111 + 1027*x + 1866*x\^{}2 + 340*x\^{}3 + 68*x\^{}4 - 80*x\^{}5 + 36*x\^{}6 - 9*x\^{}7 + x\^{}8) / (1 - x)\^{}9.
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 12 2018 03:01:22, revision 11) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{9} + 9 x^{8} - 36 x^{7} + 80 x^{6} - 68 x^{5} - 340 x^{4} - 1866 x^{3} - 1027 x^{2} - 111 x}{x^{9} - 9 x^{8} + 36 x^{7} - 84 x^{6} + 126 x^{5} - 126 x^{4} + 84 x^{3} - 36 x^{2} + 9 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;x^{9} - 9 x^{8} + 36 x^{7} - 80 x^{6} + 68 x^{5} + 340 x^{4} + 1866 x^{3} + 1027 x^{2} + 111 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250145.
