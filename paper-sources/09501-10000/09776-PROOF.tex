...
\title{The empirical recurrence for OEIS A188820, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A188820 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A188820 is ``Number of n X 5 binary arrays without the pattern 0 1 diagonally or antidiagonally.''. It has offset $1$ and begins
\[
32, 169, 432, 841, 1360, 2025, 2800, 3721,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) - 2*a(n-3) + a(n-4) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 29 2018 09:03:44, revision 10) the statement is
...
publishes, $n=38$, the arrays have $5\cdot38$ cells over
$2$ values, so there are about $10^{57}$ of them to sift. The
...
every one of the $38$ published indices, with no shift fitted: the number of rows is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A188820.
