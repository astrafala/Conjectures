...
\title{The empirical recurrence for OEIS A223374, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A223374 counts arrays over $\{0,\dots,8\}$ in which every cell is constrained by the
...
OEIS A223374 is ``3 X 3 square grid graph coloring a rectangular array: number of n X 3 0..8 arrays where 0..8 label nodes of the square grid graph and every array movement to a horizontal or vertical neighbor moves along an edge of this graph.''. It has offset $1$ and begins
\[
68, 912, 13232, 192752, 2812608, 41044048, 598980512, 8741293936,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 221*a(n-2) - 1718*a(n-4) + 1872*a(n-6) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 20 2018 05:41:14, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;221\,a(n-2) - 1718\,a(n-4) + 1872\,a(n-6)
\end{equation}
for all $n>7$.
...
\{x_{t,u},x_{t+d_1,u+d_2}\}\in E\ \text{ for every offset in }\mathcal N,\quad E=\text{the 3}\times\text{3 grid graph}
\end{equation}
for every cell $(t,u)$.
...
Let $V=\{0,\dots,8\}^{3}$ be the possible rows and take
...
$9$ values, so there are about $10^{45}$ of them to sift. The
...
of the $(8+1)^{3}$ possible next rows, the condition was tested on every cell of
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223374.
