...
\title{The empirical recurrence for OEIS A261548, proved by transfer matrix}
...
\begin{abstract}
OEIS A261548 counts $(n+2)\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A261548 is ``Number of (n+2) X (1+2) 0..1 arrays with each 3 X 3 subblock having clockwise perimeter pattern 00000001 00000101 or 00001011.''. It has offset $1$ and begins
\[
48, 80, 170, 336, 652, 1293, 2588, 5100,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-2) + 2*a(n-3) + 6*a(n-4) - 8*a(n-6) - 2*a(n-7) - 5*a(n-8) - 2*a(n-9) + 5*a(n-10) + 2*a(n-12) for n>14.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 30 2018 17:02:13, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-2) + 2\,a(n-3) + 6\,a(n-4) - 8\,a(n-6) - 2\,a(n-7) - 5\,a(n-8) - 2\,a(n-9) + 5\,a(n-10) + 2\,a(n-12)
\]
for every $n>14$.
\end{theorem}
...
at once. By Lemma~\ref{lem:crit} the recurrence holds for every $n>14$. The bound is exact: at $n=14$ the recurrence fails on the entry's own published terms, so no larger range holds.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A261548.
