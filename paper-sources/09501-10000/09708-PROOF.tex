...
\title{The empirical recurrence for OEIS A200892, derived from the entry's generating function}
...
\begin{abstract}
OEIS A200892 carries an empirical recurrence of order $10$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 16 2017 12:23:26, revision 10) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{10} + 10 x^{9} - 45 x^{8} + 208 x^{7} + 288 x^{6} - 1714 x^{5} - 3509 x^{4} + 2760 x^{3} + 2059 x^{2} + 200 x}{x^{10} - 10 x^{9} + 45 x^{8} - 120 x^{7} + 210 x^{6} - 252 x^{5} + 210 x^{4} - 120 x^{3} + 45 x^{2} - 10 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- x^{10} + 10 x^{9} - 45 x^{8} + 208 x^{7} + 288 x^{6} - 1714 x^{5} - 3509 x^{4} + 2760 x^{3} + 2059 x^{2} + 200 x,
\]
