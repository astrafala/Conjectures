...
\title{The empirical recurrence for OEIS A206263, derived from the entry's generating function}
...
\begin{abstract}
OEIS A206263 carries an empirical recurrence of order $7$. The entry separately records a
...
OEIS A206263 is ``Number of (n+1) X 5 0..1 arrays with the number of rightwards and downwards edge increases in each 2 X 2 subblock equal to the number in all its horizontal and vertical neighbors.''. It has offset $1$ and begins
\[
50, 64, 135, 260, 471, 800, 1296, 2010,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 15 2018 06:39:04, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{20 x^{8} - 114 x^{7} + 240 x^{6} - 184 x^{5} - 89 x^{4} + 265 x^{3} - 186 x^{2} + 50 x}{x^{7} - 5 x^{6} + 9 x^{5} - 5 x^{4} - 5 x^{3} + 9 x^{2} - 5 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;20 x^{8} - 114 x^{7} + 240 x^{6} - 184 x^{5} - 89 x^{4} + 265 x^{3} - 186 x^{2} + 50 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206263.
