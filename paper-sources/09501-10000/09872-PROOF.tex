...
\title{The empirical recurrence for OEIS A269471, derived from the entry's generating function}
...
\begin{abstract}
OEIS A269471 carries an empirical recurrence of order $8$. The entry separately records a
...
OEIS A269471 is ``Number of length-7 0..n arrays with no repeated value equal to the previous repeated value.''. It has offset $1$ and begins
\[
30, 1206, 11796, 63420, 242370, 741090, 1934856, 4488696,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 23 2019 07:14:53, revision 7) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{54 x^{6} - 138 x^{5} + 1140 x^{4} + 2988 x^{3} + 966 x^{2} + 30 x}{x^{8} - 8 x^{7} + 28 x^{6} - 56 x^{5} + 70 x^{4} - 56 x^{3} + 28 x^{2} - 8 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;54 x^{6} - 138 x^{5} + 1140 x^{4} + 2988 x^{3} + 966 x^{2} + 30 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269471.
