...
\title{The empirical recurrence for OEIS A207044, proved by transfer matrix}
...
\begin{abstract}
OEIS A207044 counts arrays over $\{0,\dots,2\}$ under a condition on the perimeter cycle of
...
OEIS A207044 is ``Number of (n+1) X 3 0..2 arrays with every 2 X 3 or 3 X 2 subblock having exactly one clockwise edge increases.''. It has offset $1$ and begins
\[
150, 270, 552, 1182, 2244, 4722, 9582, 18930,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-2) + 5*a(n-3) - a(n-4) - a(n-5) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 17 2018 14:37:45, revision 10) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207044.
