...
\title{The empirical recurrence for OEIS A221527, derived from the entry's generating function}
...
\begin{abstract}
OEIS A221527 carries an empirical recurrence of order $8$. The entry separately records a
...
OEIS A221527 is ``Number of 0..n arrays of length 7 with each element differing from at least one neighbor by 2 or more.''. It has offset $1$ and begins
\[
0, 16, 768, 8544, 50400, 205080, 654864, 1763328,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 06 2018 08:22:06, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 8 x^{10} + 64 x^{9} - 224 x^{8} - 176 x^{7} - 776 x^{6} + 2656 x^{5} + 2848 x^{4} + 640 x^{3} + 16 x^{2}}{x^{8} - 8 x^{7} + 28 x^{6} - 56 x^{5} + 70 x^{4} - 56 x^{3} + 28 x^{2} - 8 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 8 x^{10} + 64 x^{9} - 224 x^{8} - 176 x^{7} - 776 x^{6} + 2656 x^{5} + 2848 x^{4} + 640 x^{3} + 16 x^{2},
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221527.
