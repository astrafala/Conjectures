...
\title{The empirical recurrence for OEIS A221764, proved by transfer matrix}
...
\begin{abstract}
OEIS A221764 carries an empirical recurrence of order $4$ contributed by R.~H.~Hardin. It is
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2018 17:34:10, revision 8) this is still
