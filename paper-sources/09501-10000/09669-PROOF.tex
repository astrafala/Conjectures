...
\title{The empirical recurrence for OEIS A189190, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A189190 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A189190 is ``Number of nX3 binary arrays without the pattern 0 0 1 vertically or antidiagonally.''. It has offset $1$ and begins
\[
8, 64, 316, 1494, 6446, 27170, 111778, 455376,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 05:04:55, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;8\,a(n-1) - 14\,a(n-2) - 29\,a(n-3) + 90\,a(n-4) + 12\,a(n-5) - 159\,a(n-6) + 36\,a(n-7) + 106\,a(n-8) - 35\,a(n-9) - 22\,a(n-10) + 8\,a(n-11)
\end{equation}
for all $n>12$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A189190.
