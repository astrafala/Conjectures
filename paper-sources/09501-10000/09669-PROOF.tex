...
\title{The empirical recurrence for OEIS A216211, derived from the entry's generating function}
...
\begin{abstract}
OEIS A216211 carries an empirical recurrence of order $12$. The entry separately records a
...
OEIS A216211 is ``Number of self-avoiding walks of any length from NW to SW corners of a grid or lattice with n rows and 4 columns.''. It has offset $1$ and begins
\[
1, 4, 28, 178, 1008, 5493, 29879, 163357,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 19 2017 02:28:14, revision 21) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{12} - 3 x^{11} + 11 x^{10} + 26 x^{9} - 45 x^{8} - 64 x^{7} + 85 x^{6} + 21 x^{5} - 66 x^{4} + 34 x^{3} - 8 x^{2} + x}{x^{12} + 4 x^{11} - 12 x^{10} - 40 x^{9} + 69 x^{8} + 94 x^{7} - 175 x^{6} + 16 x^{5} + 133 x^{4} - 124 x^{3} + 54 x^{2} - 12 x + 1},
\]
the entry's own generating function, and let
\[
D(x)\;=\;1-\sum_i c_i x^{i}\;=\;x^{12} + 4 x^{11} - 12 x^{10} - 40 x^{9} + 69 x^{8} + 94 x^{7} - 175 x^{6} + 16 x^{5} + 133 x^{4} - 124 x^{3} + 54 x^{2} - 12 x + 1
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- x^{12} - 3 x^{11} + 11 x^{10} + 26 x^{9} - 45 x^{8} - 64 x^{7} + 85 x^{6} + 21 x^{5} - 66 x^{4} + 34 x^{3} - 8 x^{2} + x,
\]
...
\[
x^{12} + 4 x^{11} - 12 x^{10} - 40 x^{9} + 69 x^{8} + 94 x^{7} - 175 x^{6} + 16 x^{5} + 133 x^{4} - 124 x^{3} + 54 x^{2} - 12 x + 1,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A216211.
