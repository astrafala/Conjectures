...
\title{The empirical recurrence for OEIS A200841, derived from the entry's generating function}
...
\begin{abstract}
OEIS A200841 carries an empirical recurrence of order $7$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 08:49:25, revision 11) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{7} + 7 x^{6} - 22 x^{5} + 36 x^{4} + 3 x^{3} - 81 x^{2} - 64 x}{x^{7} - 7 x^{6} + 21 x^{5} - 35 x^{4} + 35 x^{3} - 21 x^{2} + 7 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;x^{7} - 7 x^{6} + 22 x^{5} - 36 x^{4} - 3 x^{3} + 81 x^{2} + 64 x,
\]
