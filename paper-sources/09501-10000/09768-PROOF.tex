...
\title{The empirical recurrence for OEIS A229424, derived from the entry's generating function}
...
\begin{abstract}
OEIS A229424 carries an empirical recurrence of order $9$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 15 2018 08:46:27, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 3 x^{9} + 27 x^{8} - 103 x^{7} + 222 x^{6} - 302 x^{5} + 272 x^{4} - 159 x^{3} + 53 x^{2} - 12 x}{x^{9} - 9 x^{8} + 36 x^{7} - 84 x^{6} + 126 x^{5} - 126 x^{4} + 84 x^{3} - 36 x^{2} + 9 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;3 x^{9} - 27 x^{8} + 103 x^{7} - 222 x^{6} + 302 x^{5} - 272 x^{4} + 159 x^{3} - 53 x^{2} + 12 x,
\]
