...
\title{The empirical recurrence for OEIS A229796, derived from the entry's generating function}
...
\begin{abstract}
OEIS A229796 carries an empirical recurrence of order $10$. The entry separately records a
...
OEIS A229796 is ``Number of 3 X 3 0..n arrays with rows and columns in lexicographically nondecreasing order.''. It has offset $1$ and begins
\[
45, 1169, 14178, 102251, 520017, 2066505, 6842284, 19692165,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 21 2018 08:54:44, revision 7) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{10} + 10 x^{9} - 46 x^{8} + 121 x^{7} + 420 x^{6} + 4687 x^{5} + 7676 x^{4} + 4513 x^{3} + 719 x^{2} + 45 x}{x^{10} - 10 x^{9} + 45 x^{8} - 120 x^{7} + 210 x^{6} - 252 x^{5} + 210 x^{4} - 120 x^{3} + 45 x^{2} - 10 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- x^{10} + 10 x^{9} - 46 x^{8} + 121 x^{7} + 420 x^{6} + 4687 x^{5} + 7676 x^{4} + 4513 x^{3} + 719 x^{2} + 45 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A229796.
