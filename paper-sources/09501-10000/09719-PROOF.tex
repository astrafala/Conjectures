...
\title{The empirical recurrence for OEIS A259519, proved by transfer matrix}
...
\begin{abstract}
OEIS A259519 counts arrays of width $4$ over $\{0,1\}$ subject to a condition read round the
...
OEIS A259519 is ``Number of (n+1)X(3+1) 0..1 arrays with each 2X2 subblock having clockwise pattern 0000 0001 0011 0101 or 1111.''. It has offset $1$ and begins
\[
120, 1122, 10148, 93028, 851604, 7802386, 71482990, 654942820,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:52:37, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A259519.
