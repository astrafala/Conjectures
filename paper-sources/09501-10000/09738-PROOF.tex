...
\title{The empirical recurrence for OEIS A147817, derived from the entry's generating function}
...
\begin{abstract}
OEIS A147817 carries an empirical recurrence of order $9$. The entry separately records a
...
OEIS A147817 is ``Number of consistent sets of 4 irreflexive binary order relationships over n objects.''. It has offset $4$ and begins
\[
186, 3050, 20790, 93030, 321580, 930636, 2362500, 5420580,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 12 2020 03:05:56, revision 48) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{14 x^{8} - 96 x^{7} - 36 x^{6} - 1376 x^{5} - 186 x^{4}}{x^{9} - 9 x^{8} + 36 x^{7} - 84 x^{6} + 126 x^{5} - 126 x^{4} + 84 x^{3} - 36 x^{2} + 9 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 14 x^{8} + 96 x^{7} + 36 x^{6} + 1376 x^{5} + 186 x^{4},
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A147817.
