...
\title{The empirical recurrence for OEIS A202459, derived from the entry's generating function}
...
\begin{abstract}
OEIS A202459 carries an empirical recurrence of order $9$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 31 2018 14:06:42, revision 10) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 823 x^{9} + 7071 x^{8} - 26730 x^{7} + 58194 x^{6} - 80058 x^{5} + 71610 x^{4} - 40992 x^{3} + 13919 x^{2} - 2197 x}{x^{9} - 9 x^{8} + 36 x^{7} - 84 x^{6} + 126 x^{5} - 126 x^{4} + 84 x^{3} - 36 x^{2} + 9 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;823 x^{9} - 7071 x^{8} + 26730 x^{7} - 58194 x^{6} + 80058 x^{5} - 71610 x^{4} + 40992 x^{3} - 13919 x^{2} + 2197 x,
\]
