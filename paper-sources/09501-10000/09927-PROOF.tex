...
\title{The empirical recurrence for OEIS A253229, proved by transfer matrix}
...
\begin{abstract}
OEIS A253229 counts the arrays over $\{0,\dots,1\}$ whose $2\times2$ subblocks carry a
...
so a pair of consecutive array rows is a state, the count is a walk count on $S=2470$ of them,
...
OEIS A253229 is ``Number of (n+1) X (6+1) 0..1 arrays with every 2 X 2 subblock diagonal minimum minus antidiagonal minimum nondecreasing horizontally and diagonal maximum minus antidiagonal maximum nondecreasing vertically.''. It has offset $1$ and begins
\[
2470, 4158, 3241, 4490, 6414, 9630, 15363, 26064,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 5*a(n-1) - 9*a(n-2) + 7*a(n-3) - 2*a(n-4) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 10 2018 12:18:53, revision 7) this is still
...
\]
on the $S=2470$ admissible pairs. In particular $a$ is $C$-finite. The alignment of the walk
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253229.
