...
\title{The empirical recurrence for OEIS A253344, proved by transfer matrix}
...
\begin{abstract}
OEIS A253344 counts the arrays over $\{0,\dots,1\}$ whose $2\times2$ subblocks carry a
...
OEIS A253344 is ``Number of (n+1) X (2+1) 0..1 arrays with every 2 X 2 subblock diagonal maximum minus antidiagonal maximum nondecreasing horizontally, vertically and ne-to-sw antidiagonally.''. It has offset $1$ and begins
\[
47, 173, 735, 3192, 13917, 60779, 265605, 1161035,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 6*a(n-1) - 5*a(n-2) - 12*a(n-3) + 12*a(n-4) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 11 2018 08:59:48, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253344.
