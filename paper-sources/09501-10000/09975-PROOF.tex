...
\title{The empirical recurrence for OEIS A200787, derived from the entry's generating function}
...
\begin{abstract}
OEIS A200787 carries an empirical recurrence of order $6$. The entry separately records a
...
OEIS A200787 is ``Number of 0..n arrays x(0..4) of 5 elements without any two consecutive increases.''. It has offset $1$ and begins
\[
32, 216, 840, 2425, 5796, 12152, 23136, 40905,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 15 2017 20:26:43, revision 13) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{6} + 6 x^{5} - 15 x^{4} + 24 x^{3} + 24 x^{2} + 32 x}{x^{6} - 6 x^{5} + 15 x^{4} - 20 x^{3} + 15 x^{2} - 6 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- x^{6} + 6 x^{5} - 15 x^{4} + 24 x^{3} + 24 x^{2} + 32 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A200787.
