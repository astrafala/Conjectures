...
\title{The empirical recurrence for OEIS A250364, derived from the entry's generating function}
...
\begin{abstract}
OEIS A250364 carries an empirical recurrence of order $7$. The entry separately records a
...
OEIS A250364 is ``Number of length 6 arrays x(i), i=1..6 with x(i) in i..i+n and no value appearing more than 3 times.''. It has offset $1$ and begins
\[
64, 729, 4048, 15365, 45866, 115963, 259106, 526505,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 13 2018 12:34:21, revision 7) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 42 x^{10} + 232 x^{9} - 482 x^{8} + 405 x^{7} - 57 x^{6} - 44 x^{5} - 98 x^{4} - 289 x^{3} - 281 x^{2} - 64 x}{x^{7} - 7 x^{6} + 21 x^{5} - 35 x^{4} + 35 x^{3} - 21 x^{2} + 7 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;42 x^{10} - 232 x^{9} + 482 x^{8} - 405 x^{7} + 57 x^{6} + 44 x^{5} + 98 x^{4} + 289 x^{3} + 281 x^{2} + 64 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250364.
