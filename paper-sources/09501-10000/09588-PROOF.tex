...
\title{The empirical recurrence for OEIS A200881, proved by transfer matrix}
...
\begin{abstract}
OEIS A200881 carries an empirical recurrence of order $7$ contributed by R.~H.~Hardin. It is
...
OEIS A200881 is ``Number of 0..3 arrays x(0..n+1) of n+2 elements without any interior element greater than both neighbors.''. It has offset $1$ and begins
\[
50, 144, 422, 1268, 3823, 11472, 34350, 102896,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) -6*a(n-2) +10*a(n-3) -5*a(n-4) +6*a(n-5) -a(n-6) +a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 16 2017 12:22:46, revision 10) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A200881.
