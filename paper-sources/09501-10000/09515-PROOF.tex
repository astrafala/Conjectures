...
\title{The empirical recurrence for OEIS A246887, proved by transfer matrix}
...
\begin{abstract}
OEIS A246887 carries an empirical recurrence of order $10$ contributed by R.~H.~Hardin. It is
...
OEIS A246887 is ``Number of length n+4 0..3 arrays with some pair in every consecutive five terms totalling exactly 3.''. It has offset $1$ and begins
\[
900, 3364, 12544, 46656, 173056, 643204, 2390116, 8880400,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) +4*a(n-2) +6*a(n-3) +12*a(n-4) -4*a(n-5) -6*a(n-6) -2*a(n-8) +a(n-10)
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 10:14:19, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 4\,a(n-2) + 6\,a(n-3) + 12\,a(n-4) - 4\,a(n-5) - 6\,a(n-6) - 2\,a(n-8) + a(n-10)
\]
for every $n>-3$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A246887.
