...
\title{The empirical recurrence for OEIS A237861, proved by transfer matrix}
...
\begin{abstract}
OEIS A237861 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
OEIS A237861 is ``Number of (n+1)X(1+1) 0..2 arrays with the upper median plus the lower median minus the minimum of every 2X2 subblock differing from its horizontal and vertical neighbors by exactly one.''. It has offset $1$ and begins
\[
81, 336, 1414, 6030, 25525, 107272, 453088, 1919632,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 252*a(n-4) +1304*a(n-6) -1908*a(n-8) -1312*a(n-10) +1280*a(n-12) -2304*a(n-14)
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 10:31:31, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;252\,a(n-4) + 1304\,a(n-6) - 1908\,a(n-8) - 1312\,a(n-10) + 1280\,a(n-12) - 2304\,a(n-14)
\]
for every $n>14$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237861.
