...
\title{The empirical recurrence for OEIS A269644, derived from the entry's generating function}
...
\begin{abstract}
OEIS A269644 carries an empirical recurrence of order $8$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 25 2019 11:44:42, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{6 x^{10} - 44 x^{9} + 123 x^{8} - 240 x^{7} - 31 x^{6} - 152 x^{5} + 1813 x^{4} + 2736 x^{3} + 809 x^{2} + 20 x}{x^{8} - 8 x^{7} + 28 x^{6} - 56 x^{5} + 70 x^{4} - 56 x^{3} + 28 x^{2} - 8 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;6 x^{10} - 44 x^{9} + 123 x^{8} - 240 x^{7} - 31 x^{6} - 152 x^{5} + 1813 x^{4} + 2736 x^{3} + 809 x^{2} + 20 x,
\]
