...
\title{The empirical recurrence for OEIS A221969, derived from the entry's generating function}
...
\begin{abstract}
OEIS A221969 carries an empirical recurrence of order $7$. The entry separately records a
...
OEIS A221969 is ``Number of -n..n arrays of length 6 with the sum ahead of each element differing from the sum following that element by n or less.''. It has offset $1$ and begins
\[
129, 2305, 16513, 73089, 241153, 653185, 1535745, 3246337,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 14 2018 08:57:38, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{7} + 6 x^{6} - 143 x^{5} - 1388 x^{4} - 3087 x^{3} - 1402 x^{2} - 129 x}{x^{7} - 7 x^{6} + 21 x^{5} - 35 x^{4} + 35 x^{3} - 21 x^{2} + 7 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;x^{7} - 6 x^{6} + 143 x^{5} + 1388 x^{4} + 3087 x^{3} + 1402 x^{2} + 129 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221969.
