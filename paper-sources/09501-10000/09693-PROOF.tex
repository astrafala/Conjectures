...
\title{The empirical recurrence for OEIS A249965, derived from the entry's generating function}
...
\begin{abstract}
OEIS A249965 carries an empirical recurrence of order $11$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 21 2017 13:10:54, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 1715 x^{9} - 65078 x^{8} - 488690 x^{7} - 1248320 x^{6} - 1254698 x^{5} - 497638 x^{4} - 69986 x^{3} - 2660 x^{2} - 15 x}{x^{11} - 11 x^{10} + 55 x^{9} - 165 x^{8} + 330 x^{7} - 462 x^{6} + 462 x^{5} - 330 x^{4} + 165 x^{3} - 55 x^{2} + 11 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;1715 x^{9} + 65078 x^{8} + 488690 x^{7} + 1248320 x^{6} + 1254698 x^{5} + 497638 x^{4} + 69986 x^{3} + 2660 x^{2} + 15 x,
\]
