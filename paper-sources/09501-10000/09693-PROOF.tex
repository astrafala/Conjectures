...
\title{The empirical recurrence for OEIS A246482, derived from the entry's generating function}
...
\begin{abstract}
OEIS A246482 carries an empirical recurrence of order $11$. The entry separately records a
...
OEIS A246482 is ``Number of length 3+3 0..n arrays with no pair in any consecutive four terms totalling exactly n.''. It has offset $1$ and begins
\[
2, 20, 292, 1376, 6534, 20004, 57416, 133664,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 06 2018 06:45:05, revision 7) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 1124 x^{9} - 1234 x^{8} - 4002 x^{7} - 2090 x^{6} - 2322 x^{5} - 502 x^{4} - 230 x^{3} - 14 x^{2} - 2 x}{x^{11} - 3 x^{10} - x^{9} + 11 x^{8} - 6 x^{7} - 14 x^{6} + 14 x^{5} + 6 x^{4} - 11 x^{3} + x^{2} + 3 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;1124 x^{9} + 1234 x^{8} + 4002 x^{7} + 2090 x^{6} + 2322 x^{5} + 502 x^{4} + 230 x^{3} + 14 x^{2} + 2 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A246482.
