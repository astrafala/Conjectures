...
\title{The empirical recurrence for OEIS A305227, proved by transfer matrix}
...
\begin{abstract}
OEIS A305227 counts $5$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A305227 is ``Number of nX5 0..1 arrays with every element unequal to 0, 1, 2, 3 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
16, 120, 108, 253, 757, 2050, 5958, 17002,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 4*a(n-1) -a(n-2) -7*a(n-3) +5*a(n-5) +7*a(n-7) -4*a(n-8) -3*a(n-9) -a(n-10) +a(n-12) for n>16
\end{quote}
As of the ``Last modified'' line on the live entry (May 27 2018 17:43:32, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) - a(n-2) - 7\,a(n-3) + 5\,a(n-5) + 7\,a(n-7) - 4\,a(n-8) - 3\,a(n-9) - a(n-10) + a(n-12)
\end{equation}
for all $n>16$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A305227.
