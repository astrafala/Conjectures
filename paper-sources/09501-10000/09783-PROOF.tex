...
\title{The empirical recurrence for OEIS A255223, proved by transfer matrix}
...
\begin{abstract}
OEIS A255223 counts $(n+2)\times5$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A255223 is ``Number of (n+2)X(3+2) 0..1 arrays with no 3x3 subblock diagonal sum 0 and no antidiagonal sum 0 and no row sum 2 and no column sum 2.''. It has offset $1$ and begins
\[
31, 37, 46, 58, 76, 103, 142, 199,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) -a(n-2) +a(n-3) -a(n-4)
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:40:26, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A255223.
