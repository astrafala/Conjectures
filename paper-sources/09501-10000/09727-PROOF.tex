...
\title{The empirical recurrence for OEIS A250062, derived from the entry's generating function}
...
\begin{abstract}
OEIS A250062 carries an empirical recurrence of order $10$. The entry separately records a
...
OEIS A250062 is ``Number of length 3+6 0..n arrays with no seven consecutive terms having the maximum of any two terms equal to the minimum of the remaining five terms.''. It has offset $1$ and begins
\[
21, 2292, 50028, 505154, 3213429, 15002490, 56118016, 177725772,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 23 2017 09:55:54, revision 9) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{266 x^{8} + 11647 x^{7} + 72798 x^{6} + 142519 x^{5} + 105494 x^{4} + 28053 x^{3} + 2082 x^{2} + 21 x}{x^{10} - 10 x^{9} + 45 x^{8} - 120 x^{7} + 210 x^{6} - 252 x^{5} + 210 x^{4} - 120 x^{3} + 45 x^{2} - 10 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;266 x^{8} + 11647 x^{7} + 72798 x^{6} + 142519 x^{5} + 105494 x^{4} + 28053 x^{3} + 2082 x^{2} + 21 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250062.
