...
\title{The empirical recurrence for OEIS A235303, proved by transfer matrix}
...
\begin{abstract}
OEIS A235303 counts $2$-column arrays over $\{0,\dots,5\}$ in which every
...
OEIS A235303 is ``Number of (n+1) X (1+1) 0..5 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 6 (constant-stress 1 X 1 tilings).''. It has offset
$1$ and begins
\[
70, 210, 518, 1554, 4006, 12018, 32006,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) + 13*a(n-2) - 39*a(n-3) - 40*a(n-4) + 120*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 18 2022 23:19:58, revision 10) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 13\,a(n-2) - 39\,a(n-3) - 40\,a(n-4) + 120\,a(n-5)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A235303.
