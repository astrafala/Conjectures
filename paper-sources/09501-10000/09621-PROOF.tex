...
\title{The empirical recurrence for OEIS A283277, proved by transfer matrix}
...
\begin{abstract}
OEIS A283277 counts $n\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
walk, and $a(n)$ is a walk count on $S=58$ vertices, which is $C$-finite. Whether the
...
OEIS A283277 is ``Number of n X 3 0..1 arrays with no 1 equal to more than two of its horizontal, vertical and antidiagonal neighbors.''. It has offset $1$ and begins
\[
8, 50, 287, 1725, 10299, 61491, 367208, 2192810,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 04 2025 08:40:13, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) + 5\,a(n-2) + 6\,a(n-3) - 7\,a(n-4) - a(n-5) - 4\,a(n-6) + 11\,a(n-7) - 12\,a(n-8) + 7\,a(n-9) - 9\,a(n-10) + 6\,a(n-11) - 2\,a(n-12)
\]
for every $n>12$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A283277.
