...
\title{The empirical recurrence for OEIS A200891, derived from the entry's generating function}
...
\begin{abstract}
OEIS A200891 carries an empirical recurrence of order $9$. The entry separately records a
...
OEIS A200891 is ``Number of 0..n arrays x(0..7) of 8 elements without any interior element greater than both neighbors.''. It has offset $1$ and begins
\[
114, 1691, 11472, 50995, 173606, 491533, 1215616, 2710413,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 16 2017 12:23:20, revision 10) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{9} + 9 x^{8} - 37 x^{7} + 47 x^{6} + 37 x^{5} + 953 x^{4} - 357 x^{3} - 665 x^{2} - 114 x}{x^{9} - 9 x^{8} + 36 x^{7} - 84 x^{6} + 126 x^{5} - 126 x^{4} + 84 x^{3} - 36 x^{2} + 9 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;x^{9} - 9 x^{8} + 37 x^{7} - 47 x^{6} - 37 x^{5} - 953 x^{4} + 357 x^{3} + 665 x^{2} + 114 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A200891.
