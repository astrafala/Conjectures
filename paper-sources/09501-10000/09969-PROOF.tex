...
\title{The empirical recurrence for OEIS A184542, derived from the entry's generating function}
...
\begin{abstract}
OEIS A184542 carries an empirical recurrence of order $6$. The entry separately records a
...
OEIS A184542 is ``Number of (n+2) X 5 binary arrays with each 3 X 3 subblock having rows and columns in lexicographically nondecreasing order.''. It has offset $1$ and begins
\[
147, 340, 631, 1048, 1627, 2413, 3461, 4837,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 13 2018 08:45:54, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 31 x^{6} + 209 x^{5} - 578 x^{4} + 796 x^{3} - 542 x^{2} + 147 x}{x^{6} - 6 x^{5} + 15 x^{4} - 20 x^{3} + 15 x^{2} - 6 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 31 x^{6} + 209 x^{5} - 578 x^{4} + 796 x^{3} - 542 x^{2} + 147 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A184542.
