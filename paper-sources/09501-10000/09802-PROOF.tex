...
\title{The empirical recurrence for OEIS A202333, derived from the entry's generating function}
...
\begin{abstract}
OEIS A202333 carries an empirical recurrence of order $8$. The entry separately records a
...
OEIS A202333 is ``Number of (n+1) X 7 binary arrays with consecutive windows of two bits considered as a binary number nondecreasing in every row and column.''. It has offset $1$ and begins
\[
81, 270, 746, 1796, 3896, 7790, 14588, 25885,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 28 2018 08:09:49, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 19 x^{8} + 148 x^{7} - 502 x^{6} + 966 x^{5} - 1148 x^{4} + 854 x^{3} - 378 x^{2} + 81 x}{x^{8} - 8 x^{7} + 28 x^{6} - 56 x^{5} + 70 x^{4} - 56 x^{3} + 28 x^{2} - 8 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 19 x^{8} + 148 x^{7} - 502 x^{6} + 966 x^{5} - 1148 x^{4} + 854 x^{3} - 378 x^{2} + 81 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A202333.
