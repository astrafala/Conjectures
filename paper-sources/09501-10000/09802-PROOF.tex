...
\title{The empirical recurrence for OEIS A250794, proved by transfer matrix}
...
\begin{abstract}
OEIS A250794 counts arrays over $\{0,1\}$ in which a statistic taken over short runs
...
OEIS A250794 is ``Number of (n+1) X (5+1) 0..1 arrays with nondecreasing min(x(i,j),x(i,j-1)) in the i direction and nondecreasing absolute value of x(i,j)-x(i-1,j) in the j direction.''. It has offset $1$ and begins
\[
252, 838, 2776, 9258, 31220, 105954, 361344, 1236058,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 10*a(n-1) - 33*a(n-2) + 24*a(n-3) + 79*a(n-4) - 138*a(n-5) - 3*a(n-6) + 100*a(n-7) - 18*a(n-8) - 20*a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 20 2018 09:54:45, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;10\,a(n-1) - 33\,a(n-2) + 24\,a(n-3) + 79\,a(n-4) - 138\,a(n-5) - 3\,a(n-6) + 100\,a(n-7) - 18\,a(n-8) - 20\,a(n-9)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250794.
