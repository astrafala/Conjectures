...
\title{The empirical recurrence for OEIS A297390, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297390 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A297390 is ``Number of n X 3 0..1 arrays with every 1 horizontally, diagonally or antidiagonally adjacent to 1 neighboring 1.''. It has offset $1$ and begins
\[
3, 9, 19, 57, 139, 369, 963, 2489,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) + 4*a(n-2) + 2*a(n-3) - 4*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 28 2019 07:44:16, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 4\,a(n-2) + 2\,a(n-3) - 4\,a(n-4)
\end{equation}
for all $n>5$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297390.
