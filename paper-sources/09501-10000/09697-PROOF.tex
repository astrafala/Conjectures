...
\title{The empirical recurrence for OEIS A250064, derived from the entry's generating function}
...
\begin{abstract}
OEIS A250064 carries an empirical recurrence of order $11$. The entry separately records a
...
OEIS A250064 is ``Number of length 4+6 0..n arrays with no seven consecutive terms having the maximum of any two terms equal to the minimum of the remaining five terms.''. It has offset $1$ and begins
\[
21, 4030, 132054, 1800040, 14492075, 82072086, 361440380, 1318262304,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 23 2017 09:55:15, revision 7) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 854 x^{9} - 49661 x^{8} - 430621 x^{7} - 1192749 x^{6} - 1296585 x^{5} - 565631 x^{4} - 88879 x^{3} - 3799 x^{2} - 21 x}{x^{11} - 11 x^{10} + 55 x^{9} - 165 x^{8} + 330 x^{7} - 462 x^{6} + 462 x^{5} - 330 x^{4} + 165 x^{3} - 55 x^{2} + 11 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;854 x^{9} + 49661 x^{8} + 430621 x^{7} + 1192749 x^{6} + 1296585 x^{5} + 565631 x^{4} + 88879 x^{3} + 3799 x^{2} + 21 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250064.
