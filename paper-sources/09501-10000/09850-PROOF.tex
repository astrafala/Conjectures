...
\title{The empirical recurrence for OEIS A250339, derived from the entry's generating function}
...
\begin{abstract}
OEIS A250339 carries an empirical recurrence of order $8$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 12 2018 14:41:57, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{8} + 8 x^{7} - 9 x^{6} - 308 x^{5} - 635 x^{4} + 1152 x^{3} + 1125 x^{2} + 108 x}{x^{8} - 8 x^{7} + 28 x^{6} - 56 x^{5} + 70 x^{4} - 56 x^{3} + 28 x^{2} - 8 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- x^{8} + 8 x^{7} - 9 x^{6} - 308 x^{5} - 635 x^{4} + 1152 x^{3} + 1125 x^{2} + 108 x,
\]
