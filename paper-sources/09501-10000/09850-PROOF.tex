...
\title{The empirical recurrence for OEIS A203366, proved by transfer matrix}
...
\begin{abstract}
OEIS A203366 counts arrays of width $3$ over $\{0,1,2\}$ under local conditions relating each cell
...
OEIS A203366 is ``Number of n X 3 0..2 arrays with every 1 immediately preceded by 0 to the left or above, and every 2 immediately preceded by both a 1 and a 0.''. It has offset $1$ and begins
\[
3, 30, 206, 1570, 11541, 85932, 636912, 4728287,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) +26*a(n-2) +44*a(n-3) +45*a(n-4) +24*a(n-5) -a(n-6) -17*a(n-7) +2*a(n-8) -2*a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 04 2018 05:47:19, revision 8) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=106.
\]
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + 26\,a(n-2) + 44\,a(n-3) + 45\,a(n-4) + 24\,a(n-5) - a(n-6) - 17\,a(n-7) + 2\,a(n-8) - 2\,a(n-9)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A203366.
