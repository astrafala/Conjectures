...
\title{The empirical recurrence for OEIS A206338, proved by transfer matrix}
...
\begin{abstract}
OEIS A206338 counts the $(n+1)\times4$ arrays over $\{0,\dots,3\}$ in which
...
a state, the count is a walk count on $S=455$ of them, and the conjectured recurrence is then
...
OEIS A206338 is ``Number of (n+1) X 4 0..3 arrays with every 2 X 2 subblock having nonzero determinant and commuting with every horizontal or vertical neighbor.''. It has offset $1$ and begins
\[
455, 232, 1340, 682, 4007, 2030, 12005, 6074,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + 3*a(n-2) - 3*a(n-3) for n>12.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 15 2018 11:01:32, revision 9) this is still
...
$455$, which the model reproduces along with every later term.
...
\]
on the $S=455$ admissible $2$-tuples. In particular $a$ is $C$-finite.
...
size of the construction is therefore $4^{2\cdot4}$ before the condition prunes
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206338.
