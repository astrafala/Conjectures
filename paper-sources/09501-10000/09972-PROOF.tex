...
\title{The empirical recurrence for OEIS A220547, proved by transfer matrix}
...
\begin{abstract}
OEIS A220547 counts the ways of linking the cells of a grid $2$ cells wide, each cell either to
...
state, the count is a walk count on $S=5$ of them, and the conjectured recurrence is then
...
OEIS A220547 is ``Number of ways to reciprocally link elements of an n X 2 array either to themselves or to exactly one horizontal, vertical or antidiagonal neighbor.''. It has offset $1$ and begins
\[
2, 8, 29, 108, 401, 1490, 5536, 20569,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) + 3*a(n-2) - a(n-3) - a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 10 2021 22:20:09, revision 12) this is still
...
grid graph on the offset set above, of $n$ rows and $2$ columns,
...
one configuration. With $M$ the adjacency matrix of the digraph on the $S=5$ reachable
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A220547.
