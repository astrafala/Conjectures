...
\title{The empirical recurrence for OEIS A249846, derived from the entry's generating function}
...
\begin{abstract}
OEIS A249846 carries an empirical recurrence of order $7$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 18 2017 18:10:39, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 34 x^{5} - 224 x^{4} - 324 x^{3} - 128 x^{2} - 10 x}{x^{7} - 7 x^{6} + 21 x^{5} - 35 x^{4} + 35 x^{3} - 21 x^{2} + 7 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;34 x^{5} + 224 x^{4} + 324 x^{3} + 128 x^{2} + 10 x,
\]
