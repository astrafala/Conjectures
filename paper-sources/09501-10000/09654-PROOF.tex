...
\title{The empirical recurrence for OEIS A231950, proved by transfer matrix}
...
\begin{abstract}
OEIS A231950 counts arrays of width $2$ over $\{0,\dots,1\}$ under a condition on each cell
...
OEIS A231950 is ``Number of (n+1)X(1+1) 0..1 arrays with every element equal to some horizontal, vertical, diagonal or antidiagonal neighbor, with top left element zero.''. It has offset $1$ and begins
\[
4, 18, 64, 236, 888, 3336, 12512, 46928,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) -2*a(n-2) +4*a(n-3)
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 06:44:56, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231950.
