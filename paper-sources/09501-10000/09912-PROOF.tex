...
\title{The empirical recurrence for OEIS A227675, derived from the entry's generating function}
...
\begin{abstract}
OEIS A227675 carries an empirical recurrence of order $7$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 09 2018 17:17:32, revision 7) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{7} + 5 x^{6} - 14 x^{5} + 23 x^{4} - 22 x^{3} + 12 x^{2} - 4 x}{x^{7} - 7 x^{6} + 21 x^{5} - 35 x^{4} + 35 x^{3} - 21 x^{2} + 7 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;x^{7} - 5 x^{6} + 14 x^{5} - 23 x^{4} + 22 x^{3} - 12 x^{2} + 4 x,
\]
