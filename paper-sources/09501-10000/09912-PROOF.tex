...
\title{The empirical recurrence for OEIS A208601, derived from the entry's generating function}
...
\begin{abstract}
OEIS A208601 carries an empirical recurrence of order $7$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 18 2018 17:29:06, revision 11) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{7} + 6 x^{6} - 71 x^{5} - 750 x^{4} - 1727 x^{3} - 764 x^{2} - 57 x}{x^{7} - 7 x^{6} + 21 x^{5} - 35 x^{4} + 35 x^{3} - 21 x^{2} + 7 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;x^{7} - 6 x^{6} + 71 x^{5} + 750 x^{4} + 1727 x^{3} + 764 x^{2} + 57 x,
\]
