...
\title{The empirical recurrence for OEIS A249967, derived from the entry's generating function}
...
\begin{abstract}
OEIS A249967 carries an empirical recurrence of order $13$. The entry separately records a
...
OEIS A249967 is ``Number of length 7+5 0..n arrays with no six consecutive terms having the maximum of any two terms equal to the minimum of the remaining four terms.''. It has offset $1$ and begins
\[
15, 8823, 709814, 18707320, 251002319, 2149795141, 13385651492, 65717571120,\ \dots
\]
...
\begin{quote}
G.f.: x*(15 + 8628*x + 596285*x\^{}2 + 10163642*x\^{}3 + 60659998*x\^{}4 + 149218290*x\^{}5 + 162389570*x\^{}6 + 78777198*x\^{}7 + 16029715*x\^{}8 + 1141682*x\^{}9 + 16577*x\^{}10) / (1 - x)\^{}13.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 21 2017 22:53:23, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 16577 x^{11} - 1141682 x^{10} - 16029715 x^{9} - 78777198 x^{8} - 162389570 x^{7} - 149218290 x^{6} - 60659998 x^{5} - 10163642 x^{4} - 596285 x^{3} - 8628 x^{2} - 15 x}{x^{13} - 13 x^{12} + 78 x^{11} - 286 x^{10} + 715 x^{9} - 1287 x^{8} + 1716 x^{7} - 1716 x^{6} + 1287 x^{5} - 715 x^{4} + 286 x^{3} - 78 x^{2} + 13 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;16577 x^{11} + 1141682 x^{10} + 16029715 x^{9} + 78777198 x^{8} + 162389570 x^{7} + 149218290 x^{6} + 60659998 x^{5} + 10163642 x^{4} + 596285 x^{3} + 8628 x^{2} + 15 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A249967.
