...
\title{The empirical recurrence for OEIS A183336, proved by transfer matrix}
...
\begin{abstract}
OEIS A183336 counts arrays of width $4$ over $\{0,1\}$ under local conditions relating each cell
...
OEIS A183336 is ``Number of n X 4 binary arrays with each 1 adjacent to exactly one 1 vertically and one 1 horizontally.''. It has offset $1$ and begins
\[
1, 4, 7, 12, 26, 51, 97, 193,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + a(n-2) + 2*a(n-3) - a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 27 2018 09:36:44, revision 9) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A183336.
