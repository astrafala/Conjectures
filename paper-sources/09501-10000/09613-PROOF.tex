...
\title{An element and the cells around it: OEIS A183547}
...
\begin{abstract}
OEIS A183547 carries an empirical recurrence of order $10$ contributed by R.~H.~Hardin. It is
...
OEIS A183547 is ``Number of n X 2 0..2 arrays with each element equal to either the maximum or the minimum of its horizontal and vertical neighbors.''. It has offset $1$ and begins
\[
3, 15, 71, 299, 1325, 5845, 25785, 113841,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 5*a(n-1) - 3*a(n-2) + 4*a(n-3) - 9*a(n-4) - 13*a(n-6) + 8*a(n-7) + 4*a(n-8) + 7*a(n-9) + 2*a(n-10).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 29 2018 13:33:00, revision 9) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{The count is a walk count}

The entry counts arrays with $2$ columns over the alphabet $\{0,1,2\}$, growing one row at a time, and asks that every element must equal either the largest or the smallest of its horizontal and vertical neighbours.
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) - 3\,a(n-2) + 4\,a(n-3) - 9\,a(n-4) - 13\,a(n-6) + 8\,a(n-7) + 4\,a(n-8) + 7\,a(n-9) + 2\,a(n-10)
\]
for every $n>10$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A183547.
