...
\title{The empirical recurrence for OEIS A232583, proved by transfer matrix}
...
\begin{abstract}
OEIS A232583 counts arrays of width $3$ over $\{0,\dots,2\}$ under a condition on each cell
...
OEIS A232583 is ``Number of (n+1)X(2+1) 0..2 arrays with every element next to itself plus and minus one within the range 0..2 horizontally or antidiagonally, with no adjacent elements equal.''. It has offset $1$ and begins
\[
10, 34, 124, 456, 1686, 6232, 23034, 85130,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) -a(n-2) -a(n-3) +2*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 07:30:33, revision 8) this is still
...
$10$, which the model reproduces along with every later term. That is the cheapest check
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232583.
