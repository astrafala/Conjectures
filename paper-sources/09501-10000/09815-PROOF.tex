...
\title{The empirical recurrence for OEIS A202935, derived from the entry's generating function}
...
\begin{abstract}
OEIS A202935 carries an empirical recurrence of order $8$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 03 2018 07:57:30, revision 9) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 83919 x^{8} + 616520 x^{7} - 1947234 x^{6} + 3428986 x^{5} - 3638908 x^{4} + 2330681 x^{3} - 836423 x^{2} + 130321 x}{x^{8} - 8 x^{7} + 28 x^{6} - 56 x^{5} + 70 x^{4} - 56 x^{3} + 28 x^{2} - 8 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 83919 x^{8} + 616520 x^{7} - 1947234 x^{6} + 3428986 x^{5} - 3638908 x^{4} + 2330681 x^{3} - 836423 x^{2} + 130321 x,
\]
