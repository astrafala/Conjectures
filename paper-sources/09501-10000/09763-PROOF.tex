...
\title{The empirical recurrence for OEIS A211564, derived from the entry's generating function}
...
\begin{abstract}
OEIS A211564 carries an empirical recurrence of order $9$. The entry separately records a
...
OEIS A211564 is ``Number of nonnegative integer arrays of length n+4 with new values 0 upwards introduced in order, and containing the value n-1.''. It has offset $1$ and begins
\[
52, 202, 813, 3046, 10096, 29503, 77078, 183074,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 19 2018 08:23:21, revision 7) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 15 x^{9} + 130 x^{8} - 497 x^{7} + 1097 x^{6} - 1534 x^{5} + 1367 x^{4} - 867 x^{3} + 266 x^{2} - 52 x}{x^{9} - 9 x^{8} + 36 x^{7} - 84 x^{6} + 126 x^{5} - 126 x^{4} + 84 x^{3} - 36 x^{2} + 9 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;15 x^{9} - 130 x^{8} + 497 x^{7} - 1097 x^{6} + 1534 x^{5} - 1367 x^{4} + 867 x^{3} - 266 x^{2} + 52 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A211564.
