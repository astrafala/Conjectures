...
\title{The empirical recurrence for OEIS A251345, proved by transfer matrix}
...
\begin{abstract}
OEIS A251345 counts $3$-column arrays over $\{0,\dots,2\}$ in which every
...
OEIS A251345 is ``Number of (n+1)X(2+1) 0..2 arrays with every 2X2 subblock summing to 3 4 or 5.''. It has offset $1$
and begins
\[
309, 3921, 50831, 663307, 8671957, 113445117, 1484345363, 19422725739,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 16*a(n-1) -27*a(n-2) -173*a(n-3) +362*a(n-4) -61*a(n-5) -144*a(n-6) +48*a(n-7)
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 10:22:44, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;16\,a(n-1) - 27\,a(n-2) - 173\,a(n-3) + 362\,a(n-4) - 61\,a(n-5) - 144\,a(n-6) + 48\,a(n-7)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251345.
