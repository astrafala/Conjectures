...
\title{The empirical recurrence for OEIS A241940, derived from the entry's generating function}
...
\begin{abstract}
OEIS A241940 carries an empirical recurrence of order $9$. The entry separately records a
...
OEIS A241940 is ``Number of length 4+4 0..n arrays with no consecutive five elements summing to more than 2*n.''. It has offset $1$ and begins
\[
71, 1187, 9500, 49355, 193179, 619132, 1710198, 4211175,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 31 2018 05:32:28, revision 7) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{9} + 9 x^{8} - 36 x^{7} + 83 x^{6} - 222 x^{5} - 623 x^{4} - 1373 x^{3} - 548 x^{2} - 71 x}{x^{9} - 9 x^{8} + 36 x^{7} - 84 x^{6} + 126 x^{5} - 126 x^{4} + 84 x^{3} - 36 x^{2} + 9 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;x^{9} - 9 x^{8} + 36 x^{7} - 83 x^{6} + 222 x^{5} + 623 x^{4} + 1373 x^{3} + 548 x^{2} + 71 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A241940.
