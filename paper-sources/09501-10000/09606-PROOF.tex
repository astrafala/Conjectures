...
\title{The empirical recurrence for OEIS A248430, proved by transfer matrix}
...
\begin{abstract}
OEIS A248430 carries an empirical recurrence of order $7$ contributed by R.~H.~Hardin. It is
...
OEIS A248430 is ``Number of length n+2 0..5 arrays with every three consecutive terms having the sum of some two elements equal to twice the third.''. It has offset $1$ and begins
\[
42, 70, 118, 198, 342, 590, 1014, 1766,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + 6*a(n-3) - 6*a(n-4) - 4*a(n-6) + 4*a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 08 2018 08:53:11, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 6\,a(n-3) - 6\,a(n-4) - 4\,a(n-6) + 4\,a(n-7)
\]
for every $n>7$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A248430.
