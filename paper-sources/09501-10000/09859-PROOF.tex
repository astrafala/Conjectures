...
\title{The empirical recurrence for OEIS A267231, derived from the entry's generating function}
...
\begin{abstract}
OEIS A267231 carries an empirical recurrence of order $8$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 05 2018 17:09:55, revision 7) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 5040 x^{9} - 14184 x^{8} + 65148 x^{7} - 77980 x^{6} + 44352 x^{5} - 13748 x^{4} + 2380 x^{3} - 216 x^{2} + 8 x}{35280 x^{8} - 96516 x^{7} + 104992 x^{6} - 60515 x^{5} + 20489 x^{4} - 4214 x^{3} + 518 x^{2} - 35 x + 1},
\]
the entry's own generating function, and let
\[
D(x)\;=\;1-\sum_i c_i x^{i}\;=\;35280 x^{8} - 96516 x^{7} + 104992 x^{6} - 60515 x^{5} + 20489 x^{4} - 4214 x^{3} + 518 x^{2} - 35 x + 1
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 5040 x^{9} - 14184 x^{8} + 65148 x^{7} - 77980 x^{6} + 44352 x^{5} - 13748 x^{4} + 2380 x^{3} - 216 x^{2} + 8 x,
\]
...
\[
35280 x^{8} - 96516 x^{7} + 104992 x^{6} - 60515 x^{5} + 20489 x^{4} - 4214 x^{3} + 518 x^{2} - 35 x + 1,
\]
