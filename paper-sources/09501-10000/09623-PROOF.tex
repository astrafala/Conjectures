...
\title{The empirical recurrence for OEIS A252380, proved by transfer matrix}
...
\begin{abstract}
OEIS A252380 counts $(n+2)\times6$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
$a(n)$ is a walk count on $S=286952$ vertices. Such a sequence is $C$-finite, so whether a given
...
OEIS A252380 is ``Number of (n+2) X (4+2) 0..3 arrays with every 3 X 3 subblock row and diagonal sum equal to 0 3 5 6 or 7 and every 3 X 3 column and antidiagonal sum not equal to 0 3 5 6 or 7.''. It has offset $1$ and begins
\[
1966, 771, 663, 744, 916, 1097, 1361, 1791,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-3) - 4*a(n-6) + a(n-9) for n>12.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 03 2018 10:38:49, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252380.
