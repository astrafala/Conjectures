...
\title{The empirical recurrence for OEIS A223954, derived from the entry's generating function}
...
\begin{abstract}
OEIS A223954 carries an empirical recurrence of order $8$. The entry separately records a
...
OEIS A223954 is ``Number of 7 X n 0..1 arrays with diagonals and antidiagonals unimodal and rows nondecreasing.''. It has offset $1$ and begins
\[
128, 2187, 6869, 12856, 20275, 31899, 52532, 89135,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 24 2018 17:21:21, revision 7) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 221 x^{13} + 346 x^{12} + 1146 x^{11} - 2009 x^{10} - 1755 x^{9} + 2119 x^{8} + 7046 x^{7} - 9075 x^{6} - 3753 x^{5} + 11972 x^{4} - 7043 x^{3} + 1163 x^{2} + 128 x}{x^{8} - 8 x^{7} + 28 x^{6} - 56 x^{5} + 70 x^{4} - 56 x^{3} + 28 x^{2} - 8 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 221 x^{13} + 346 x^{12} + 1146 x^{11} - 2009 x^{10} - 1755 x^{9} + 2119 x^{8} + 7046 x^{7} - 9075 x^{6} - 3753 x^{5} + 11972 x^{4} - 7043 x^{3} + 1163 x^{2} + 128 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223954.
