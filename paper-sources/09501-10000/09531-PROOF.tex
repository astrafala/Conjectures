...
\title{The empirical recurrence for OEIS A258920, proved by transfer matrix}
...
\begin{abstract}
OEIS A258920 counts arrays of width $5$ over $\{0,1\}$ in which every $3\times3$ window has
...
OEIS A258920 is ``Number of (n+2) X (3+2) 0..1 arrays with no 3 x 3 subblock diagonal sum equal to the antidiagonal sum or central row sum equal to the central column sum.''. It has offset $1$ and begins
\[
1680, 1936, 1200, 1024, 1440, 1600, 1568, 1936,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) - 3*a(n-2) + 4*a(n-3) - 2*a(n-4) + 2*a(n-6) - 4*a(n-7) + 3*a(n-8) - 2*a(n-9) + a(n-10) for n>13.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 23 2018 08:13:55, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) - 3\,a(n-2) + 4\,a(n-3) - 2\,a(n-4) + 2\,a(n-6) - 4\,a(n-7) + 3\,a(n-8) - 2\,a(n-9) + a(n-10)
\]
for every $n>13$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A258920.
