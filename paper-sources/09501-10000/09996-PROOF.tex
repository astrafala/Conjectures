...
\title{The empirical recurrence for OEIS A268460, derived from the entry's generating function}
...
\begin{abstract}
OEIS A268460 carries an empirical recurrence of order $7$. The entry separately records a
...
OEIS A268460 is ``Number of length-6 0..n arrays with no adjacent pair x,x+1 followed at any distance by x+1,x.''. It has offset $1$ and begins
\[
22, 456, 3146, 13204, 41526, 108032, 245626, 504876,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 14 2019 03:09:36, revision 12) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{4 x^{7} - 22 x^{6} + 26 x^{5} + 12 x^{4} - 416 x^{3} - 302 x^{2} - 22 x}{x^{7} - 7 x^{6} + 21 x^{5} - 35 x^{4} + 35 x^{3} - 21 x^{2} + 7 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 4 x^{7} + 22 x^{6} - 26 x^{5} - 12 x^{4} + 416 x^{3} + 302 x^{2} + 22 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268460.
