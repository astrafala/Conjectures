...
\title{A condition on each element and its neighbours: OEIS A240651}
...
\begin{abstract}
OEIS A240651 carries an empirical recurrence of order $15$ contributed by R.~H.~Hardin. It is
...
OEIS A240651 is ``Number of nX3 0..1 arrays with no element equal to exactly one horizontal or vertical neighbor, with new values 0..1 introduced in row major order.''. It has offset $1$ and begins
\[
1, 2, 9, 17, 43, 136, 402, 1180,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 11:05:15, revision 6) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{The count is a walk count}

The entry counts arrays with $3$ columns over the alphabet $\{0,1\}$, growing one row at a time. Its condition is that no element may equal exactly $1$ of its horizontal and vertical neighbours.
...
Vertices with identical futures are merged, which leaves $S=16$. An admissible array is exactly a walk, so with $M$ the adjacency matrix and $\iota,\tau$ the vectors recording which states may begin and end an array,
\[
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + a(n-2) + 2\,a(n-3) - 11\,a(n-4) - 12\,a(n-5) - 9\,a(n-6) + 15\,a(n-7) + 23\,a(n-8) + 20\,a(n-9) - 6\,a(n-10) - 15\,a(n-11) - 12\,a(n-12) - 2\,a(n-13) + 3\,a(n-14) + a(n-15)
\]
for every $n>15$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A240651.
