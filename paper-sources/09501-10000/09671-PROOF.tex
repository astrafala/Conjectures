...
\title{The empirical recurrence for OEIS A227086, derived from the entry's generating function}
...
\begin{abstract}
OEIS A227086 carries an empirical recurrence of order $12$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 07 2018 03:04:37, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{12} + 11 x^{11} - 58 x^{10} + 197 x^{9} - 468 x^{8} + 794 x^{7} - 964 x^{6} + 837 x^{5} - 512 x^{4} + 213 x^{3} - 55 x^{2} + 7 x}{x^{12} - 12 x^{11} + 66 x^{10} - 220 x^{9} + 495 x^{8} - 792 x^{7} + 924 x^{6} - 792 x^{5} + 495 x^{4} - 220 x^{3} + 66 x^{2} - 12 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- x^{12} + 11 x^{11} - 58 x^{10} + 197 x^{9} - 468 x^{8} + 794 x^{7} - 964 x^{6} + 837 x^{5} - 512 x^{4} + 213 x^{3} - 55 x^{2} + 7 x,
\]
