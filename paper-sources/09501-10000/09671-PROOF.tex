...
\title{The empirical recurrence for OEIS A283859, proved by transfer matrix}
...
\begin{abstract}
OEIS A283859 counts $3\times n$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A283859 is ``Number of 3Xn 0..1 arrays with no 1 equal to more than three of its horizontal, diagonal and antidiagonal neighbors.''. It has offset $1$ and begins
\[
8, 64, 409, 2776, 19220, 131617, 901397, 6182652,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 17 2017 12:02:51, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) + 5\,a(n-2) + 50\,a(n-3) + 21\,a(n-4) + 11\,a(n-5) - 67\,a(n-6) - 229\,a(n-7) - 116\,a(n-8) + 41\,a(n-9) + 116\,a(n-10) + 66\,a(n-11) + 15\,a(n-12) + a(n-13) - 2\,a(n-14)
\]
for every $n>14$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A283859.
