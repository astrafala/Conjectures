...
\title{The empirical recurrence for OEIS A214353, derived from the entry's generating function}
...
\begin{abstract}
OEIS A214353 carries an empirical recurrence of order $7$. The entry separately records a
...
OEIS A214353 is ``Number of 3 X 3 X 3 triangular 0..n arrays with no element lying outside the (possibly reversed) range delimited by its sw and se neighbors.''. It has offset $1$ and begins
\[
26, 169, 660, 1951, 4822, 10507, 20840, 38421,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 22 2018 08:44:00, revision 10) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{7} + 7 x^{6} - 20 x^{5} + 30 x^{4} - 23 x^{3} + 13 x^{2} - 26 x}{x^{7} - 7 x^{6} + 21 x^{5} - 35 x^{4} + 35 x^{3} - 21 x^{2} + 7 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;x^{7} - 7 x^{6} + 20 x^{5} - 30 x^{4} + 23 x^{3} - 13 x^{2} + 26 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A214353.
