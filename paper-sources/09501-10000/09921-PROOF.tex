...
\title{The empirical recurrence for OEIS A302147, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A302147 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A302147 is ``Number of nX5 0..1 arrays with every element equal to 0, 2, 3 or 4 horizontally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
1, 3, 11, 56, 289, 1529, 8152, 43676,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 02 2018 14:25:31, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;14\,a(n-1) - 65\,a(n-2) + 88\,a(n-3) + 132\,a(n-4) - 362\,a(n-5) - 39\,a(n-6) + 438\,a(n-7) - 19\,a(n-8) - 208\,a(n-9) - 16\,a(n-10) + 26\,a(n-11) + 4\,a(n-12)
\end{equation}
for all $n>13$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302147.
