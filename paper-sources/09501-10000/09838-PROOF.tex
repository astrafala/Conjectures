...
\title{The empirical recurrence for OEIS A245952, derived from the entry's generating function}
...
\begin{abstract}
OEIS A245952 carries an empirical recurrence of order $8$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 05 2018 11:36:15, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{8} + 2 x^{7} + 141 x^{6} - 18 x^{5} - 299 x^{4} - 230 x^{3} - 145 x^{2} - 26 x}{x^{8} - 2 x^{7} - 2 x^{6} + 6 x^{5} - 6 x^{3} + 2 x^{2} + 2 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;x^{8} - 2 x^{7} - 141 x^{6} + 18 x^{5} + 299 x^{4} + 230 x^{3} + 145 x^{2} + 26 x,
\]
