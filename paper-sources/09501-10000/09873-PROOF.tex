...
\title{The empirical recurrence for OEIS A269541, derived from the entry's generating function}
...
\begin{abstract}
OEIS A269541 carries an empirical recurrence of order $8$. The entry separately records a
...
OEIS A269541 is ``Number of length-7 0..n arrays with no repeated value differing from the previous repeated value by other than one.''. It has offset $1$ and begins
\[
30, 1048, 10192, 55836, 217714, 677200, 1792788, 4205812,\ \dots
\]
...
\begin{quote}
G.f.: 2*x*(15 + 404*x + 1324*x\^{}2 + 982*x\^{}3 - 93*x\^{}4 - 88*x\^{}5 - 22*x\^{}6 - 2*x\^{}7) / (1 - x)\^{}8.
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 24 2019 08:37:19, revision 7) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 4 x^{8} - 44 x^{7} - 176 x^{6} - 186 x^{5} + 1964 x^{4} + 2648 x^{3} + 808 x^{2} + 30 x}{x^{8} - 8 x^{7} + 28 x^{6} - 56 x^{5} + 70 x^{4} - 56 x^{3} + 28 x^{2} - 8 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 4 x^{8} - 44 x^{7} - 176 x^{6} - 186 x^{5} + 1964 x^{4} + 2648 x^{3} + 808 x^{2} + 30 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269541.
