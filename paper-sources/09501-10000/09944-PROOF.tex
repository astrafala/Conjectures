...
\title{The empirical recurrence for OEIS A214945, derived from the entry's generating function}
...
\begin{abstract}
OEIS A214945 carries an empirical recurrence of order $7$. The entry separately records a
...
OEIS A214945 is ``Number of squarefree words of length 6 in an (n+1)-ary alphabet.''. It has offset $1$ and begins
\[
0, 42, 696, 4260, 16680, 50190, 126672, 281736,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 22 2018 08:44:44, revision 9) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 6 x^{5} - 270 x^{4} - 402 x^{3} - 42 x^{2}}{x^{7} - 7 x^{6} + 21 x^{5} - 35 x^{4} + 35 x^{3} - 21 x^{2} + 7 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;6 x^{5} + 270 x^{4} + 402 x^{3} + 42 x^{2},
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A214945.
