...
\title{The empirical recurrence for OEIS A281474, proved by transfer matrix}
...
\begin{abstract}
OEIS A281474 counts $6\times n$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A281474 is ``Number of 6 X n 0..1 arrays with no element equal to more than two of its horizontal, diagonal or antidiagonal neighbors and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
32, 857, 283, 405, 534, 706, 924, 1190,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) - a(n-2) + a(n-3) - a(n-4) + a(n-6) - a(n-7) for n>12.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 19 2019 14:42:35, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) - a(n-2) + a(n-3) - a(n-4) + a(n-6) - a(n-7)
\]
for every $n>12$.
\end{theorem}
...
First, the transfer model reproduces all $33$ terms the entry publishes, exactly, in
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A281474.
