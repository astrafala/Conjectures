...
\title{The empirical recurrence for OEIS A236324, proved by transfer matrix}
...
\begin{abstract}
OEIS A236324 counts arrays over $\{0,\dots,1\}$ subject to a condition on the order
...
OEIS A236324 is ``Number of (n+1) X (2+1) 0..1 arrays colored with the sum of the upper and lower median values of each 2 X 2 subblock.''. It has offset $1$ and begins
\[
32, 44, 60, 92, 156, 236, 332, 524,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-3) + 4*a(n-4) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 21 2018 13:45:48, revision 8) this is still
...
\]
over the $S=32$ pairs whose own subblock row is properly coloured.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A236324.
