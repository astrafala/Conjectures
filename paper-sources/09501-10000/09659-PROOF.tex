...
\title{The empirical recurrence for OEIS A183686, proved by transfer matrix}
...
\begin{abstract}
OEIS A183686 counts arrays over $\{0,\dots,1\}$ under a condition on the determinant of every
$2\times2$ subblock, and carries an empirical recurrence of order $9$ contributed by
...
OEIS A183686 is ``Number of (n+1)X8 binary arrays with every 2X2 subblock nonsingular.''. It has offset $1$ and begins
\[
384, 3472, 28160, 239424, 1992320, 16748160, 140090240, 1174759296,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 01:58:59, revision 9) this is still
...
first term is $384$, and the model reproduces it along with every later term; that is the
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-1) + 57\,a(n-2) - 332\,a(n-3) - 1122\,a(n-4) + 5412\,a(n-5) + 9248\,a(n-6) - 35984\,a(n-7) - 26624\,a(n-8) + 82304\,a(n-9)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A183686.
