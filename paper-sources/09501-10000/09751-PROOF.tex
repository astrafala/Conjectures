...
\title{The empirical recurrence for OEIS A236012, proved by transfer matrix}
...
\begin{abstract}
OEIS A236012 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
The condition is local to two consecutive rows, so the count is a walk count on $S=306$
...
OEIS A236012 is ``Number of (n+1)X(2+1) 0..2 arrays colored with the sum of the maximum and minimum values of each 2X2 subblock.''. It has offset $1$ and begins
\[
306, 1126, 3744, 12544, 41844, 140716, 471308, 1580152,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 5*a(n-2) +10*a(n-3) +26*a(n-4) +33*a(n-5) +11*a(n-6) -9*a(n-7) -7*a(n-8) -2*a(n-9) for n>11
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 09:00:22, revision 6) this is still
...
\]
over the $S=306$ pairs whose own subblock row is properly coloured.
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-2) + 10\,a(n-3) + 26\,a(n-4) + 33\,a(n-5) + 11\,a(n-6) - 9\,a(n-7) - 7\,a(n-8) - 2\,a(n-9)
\]
for every $n>11$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A236012.
