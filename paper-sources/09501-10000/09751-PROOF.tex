...
\title{The empirical recurrence for OEIS A221788, proved by transfer matrix}
...
\begin{abstract}
OEIS A221788 carries an empirical recurrence of order $4$ contributed by R.~H.~Hardin. It is
...
OEIS A221788 is ``Number of 3 X n arrays of occupancy after each element moves to some horizontal or antidiagonal neighbor, without 2-loops or left turns.''. It has offset $1$ and begins
\[
0, 0, 0, 5, 24, 142, 840, 4919,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 8*a(n-1) - 14*a(n-2) + 8*a(n-3) - a(n-4) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2018 17:34:26, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-1) - 14\,a(n-2) + 8\,a(n-3) - a(n-4)
\]
for every $n>6$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221788.
