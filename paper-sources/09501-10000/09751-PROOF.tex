...
\title{The empirical recurrence for OEIS A202077, derived from the entry's generating function}
...
\begin{abstract}
OEIS A202077 carries an empirical recurrence of order $9$. The entry separately records a
...
OEIS A202077 is ``Number of arrays of 5 integers in -n..n with sum zero and the sum of every adjacent pair being odd.''. It has offset $1$ and begins
\[
2, 26, 78, 264, 504, 1128, 1786, 3262,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 26 2018 08:45:20, revision 12) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 2 x^{7} - 24 x^{6} - 44 x^{5} - 90 x^{4} - 44 x^{3} - 24 x^{2} - 2 x}{x^{9} - x^{8} - 4 x^{7} + 4 x^{6} + 6 x^{5} - 6 x^{4} - 4 x^{3} + 4 x^{2} + x - 1},
\]
the entry's own generating function, and let
\[
D(x)\;=\;1-\sum_i c_i x^{i}\;=\;- x^{9} + x^{8} + 4 x^{7} - 4 x^{6} - 6 x^{5} + 6 x^{4} + 4 x^{3} - 4 x^{2} - x + 1
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;2 x^{7} + 24 x^{6} + 44 x^{5} + 90 x^{4} + 44 x^{3} + 24 x^{2} + 2 x,
\]
...
\[
x^{9} - x^{8} - 4 x^{7} + 4 x^{6} + 6 x^{5} - 6 x^{4} - 4 x^{3} + 4 x^{2} + x - 1,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A202077.
