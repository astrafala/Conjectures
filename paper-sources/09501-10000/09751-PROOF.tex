...
\title{The empirical recurrence for OEIS A184073, derived from the entry's generating function}
...
\begin{abstract}
OEIS A184073 carries an empirical recurrence of order $9$. The entry separately records a
...
OEIS A184073 is ``Number of (n+1) X 2 0..2 arrays with rows and columns in nondecreasing order and with no 2 X 2 subblock sum differing from a horizontal or vertical neighbor subblock sum by more than one.''. It has offset $1$ and begins
\[
29, 58, 150, 335, 728, 1499, 2968, 5645,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 12 2018 03:49:05, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{x^{14} - 12 x^{13} + 65 x^{12} - 209 x^{11} + 450 x^{10} - 749 x^{9} + 1117 x^{8} - 1573 x^{7} + 1939 x^{6} - 1895 x^{5} + 1363 x^{4} - 672 x^{3} + 203 x^{2} - 29 x}{x^{9} - 9 x^{8} + 36 x^{7} - 84 x^{6} + 126 x^{5} - 126 x^{4} + 84 x^{3} - 36 x^{2} + 9 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- x^{14} + 12 x^{13} - 65 x^{12} + 209 x^{11} - 450 x^{10} + 749 x^{9} - 1117 x^{8} + 1573 x^{7} - 1939 x^{6} + 1895 x^{5} - 1363 x^{4} + 672 x^{3} - 203 x^{2} + 29 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A184073.
