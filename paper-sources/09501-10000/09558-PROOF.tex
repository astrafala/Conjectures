...
\title{The empirical recurrence for OEIS A202584, proved by transfer matrix}
...
\begin{abstract}
OEIS A202584 counts arrays of width $3$ over $\{0,1\}$ containing no occurrence of certain short
...
OEIS A202584 is ``Number of (n+2) X 3 binary arrays avoiding patterns 001 and 100 in rows, columns and nw-to-se diagonals.''. It has offset $1$ and begins
\[
96, 260, 804, 2554, 8372, 27649, 91973, 306486,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) +5*a(n-2) -11*a(n-3) -10*a(n-4) +9*a(n-5) +12*a(n-6) -2*a(n-7) -6*a(n-8) +a(n-10).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 14 2018 11:10:37, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + 5\,a(n-2) - 11\,a(n-3) - 10\,a(n-4) + 9\,a(n-5) + 12\,a(n-6) - 2\,a(n-7) - 6\,a(n-8) + a(n-10)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A202584.
