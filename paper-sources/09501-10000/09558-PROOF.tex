...
\title{The empirical recurrence for OEIS A208843, proved by transfer matrix}
...
\begin{abstract}
OEIS A208843 counts arrays over $\{0,\dots,1\}$ of width $6$ that avoid the patterns
...
OEIS A208843 is ``Number of 6 X n 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 1 1 and 1 1 0 vertically.''. It has offset
$1$ and begins
\[
22, 484, 990, 11242, 33088, 272206, 992574,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) + 20*a(n-2) - 19*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 07 2018 06:16:56, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208843.
