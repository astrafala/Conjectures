...
\title{The empirical recurrence for OEIS A208395, proved by transfer matrix}
...
\begin{abstract}
OEIS A208395 counts $4\times n$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A208395 is ``Number of 4 X n 0..2 arrays with new values 0..2 introduced in row major order and no element equal to more than two of its immediate leftward or upward or right-upward antidiagonal neighbors.''. It has offset $1$ and begins
\[
14, 1094, 79092, 5800644, 424785708, 31112194860, 2278687944204, 166893600277548,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 61*a(n-1) +868*a(n-2) +2200*a(n-3) -7744*a(n-4) -17728*a(n-5) +40704*a(n-6) -13824*a(n-7) for n>9.
\end{quote}
As of the ``Last modified'' line on the live entry (May 10 2023 07:52:13, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;61\,a(n-1) + 868\,a(n-2) + 2200\,a(n-3) - 7744\,a(n-4) - 17728\,a(n-5) + 40704\,a(n-6) - 13824\,a(n-7)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208395.
