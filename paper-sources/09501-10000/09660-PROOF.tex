...
\title{The empirical recurrence for OEIS A260064, proved by transfer matrix}
...
\begin{abstract}
OEIS A260064 counts $(n+2)\times4$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A260064 is ``Number of (n+2) X (2+2) 0..1 arrays with each 3 X 3 subblock having clockwise perimeter pattern 00000001 00000011 or 00000111.''. It has offset $1$ and begins
\[
91, 214, 594, 1214, 2367, 5776, 13366, 28064,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + a(n-2) + 6*a(n-3) + 4*a(n-4) - 10*a(n-5) - 13*a(n-6) - 12*a(n-7) - 9*a(n-8) + 7*a(n-9) + 6*a(n-10) + 5*a(n-11).
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 28 2018 09:06:17, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + a(n-2) + 6\,a(n-3) + 4\,a(n-4) - 10\,a(n-5) - 13\,a(n-6) - 12\,a(n-7) - 9\,a(n-8) + 7\,a(n-9) + 6\,a(n-10) + 5\,a(n-11)
\]
for every $n>11$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A260064.
