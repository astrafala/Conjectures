...
\title{The empirical recurrence for OEIS A250859, derived from the entry's generating function}
...
\begin{abstract}
OEIS A250859 carries an empirical recurrence of order $7$. The entry separately records a
...
OEIS A250859 is ``Number of (7+1) X (n+1) 0..3 arrays with nondecreasing x(i,j)-x(i,j-1) in the i direction and nondecreasing min(x(i,j),x(i-1,j)) in the j direction.''. It has offset $1$ and begins
\[
983950, 5480917, 20067117, 57570016, 140301126, 303858745, 601566177, 1109545432,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 22 2018 08:24:05, revision 7) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 65536 x^{7} + 458751 x^{6} - 1326626 x^{5} + 2238796 x^{4} - 2363648 x^{3} + 1406733 x^{2} - 983950 x}{x^{7} - 7 x^{6} + 21 x^{5} - 35 x^{4} + 35 x^{3} - 21 x^{2} + 7 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;65536 x^{7} - 458751 x^{6} + 1326626 x^{5} - 2238796 x^{4} + 2363648 x^{3} - 1406733 x^{2} + 983950 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250859.
