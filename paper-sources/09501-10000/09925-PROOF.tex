...
\title{The empirical recurrence for OEIS A201976, derived from the entry's generating function}
...
\begin{abstract}
OEIS A201976 carries an empirical recurrence of order $7$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 25 2018 11:13:24, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 192 x^{7} + 164 x^{6} + 276 x^{5} - 1028 x^{4} - 952 x^{3} - 44 x^{2} - 4 x}{x^{7} - 7 x^{6} + 21 x^{5} - 35 x^{4} + 35 x^{3} - 21 x^{2} + 7 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;192 x^{7} - 164 x^{6} - 276 x^{5} + 1028 x^{4} + 952 x^{3} + 44 x^{2} + 4 x,
\]
