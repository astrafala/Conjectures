...
\title{The empirical recurrence for OEIS A249712, derived from the entry's generating function}
...
\begin{abstract}
OEIS A249712 carries an empirical recurrence of order $7$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 10 2018 05:46:45, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{7} + 7 x^{6} - 20 x^{5} + 136 x^{4} + 81 x^{3} - 295 x^{2} - 52 x}{x^{7} - 7 x^{6} + 21 x^{5} - 35 x^{4} + 35 x^{3} - 21 x^{2} + 7 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;x^{7} - 7 x^{6} + 20 x^{5} - 136 x^{4} - 81 x^{3} + 295 x^{2} + 52 x,
\]
