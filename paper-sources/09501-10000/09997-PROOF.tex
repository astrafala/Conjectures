...
\title{The empirical recurrence for OEIS A268947, derived from the entry's generating function}
...
\begin{abstract}
OEIS A268947 carries an empirical recurrence of order $7$. The entry separately records a
...
OEIS A268947 is ``Number of length-6 0..n arrays with no repeated value unequal to the previous repeated value plus one mod n+1.''. It has offset $1$ and begins
\[
22, 396, 2780, 11950, 38322, 101192, 232696, 482490,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 17 2019 05:26:07, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 2 x^{7} + 14 x^{6} + 38 x^{5} - 36 x^{4} - 470 x^{3} - 242 x^{2} - 22 x}{x^{7} - 7 x^{6} + 21 x^{5} - 35 x^{4} + 35 x^{3} - 21 x^{2} + 7 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;2 x^{7} - 14 x^{6} - 38 x^{5} + 36 x^{4} + 470 x^{3} + 242 x^{2} + 22 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268947.
