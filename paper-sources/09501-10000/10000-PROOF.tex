...
\title{The empirical recurrence for OEIS A231833, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A231833 counts arrays over $\{0,\dots,3\}$ in which every cell is constrained by the
...
OEIS A231833 is ``Number of n X 2 0..3 arrays with no element less than a strict majority of its horizontal and antidiagonal neighbors.''. It has offset $1$ and begins
\[
4, 50, 422, 3823, 34350, 308419, 2771101, 24892609,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 4*a(n-1) + 34*a(n-2) + 86*a(n-3) + 91*a(n-4) + 46*a(n-5) + 11*a(n-6) + a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 01 2018 06:27:45, revision 7) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) + 34\,a(n-2) + 86\,a(n-3) + 91\,a(n-4) + 46\,a(n-5) + 11\,a(n-6) + a(n-7)
\end{equation}
for all $n>8$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231833.
