...
\title{The empirical recurrence for OEIS A269470, derived from the entry's generating function}
...
\begin{abstract}
OEIS A269470 carries an empirical recurrence of order $7$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 23 2019 07:12:07, revision 7) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 10 x^{5} + 28 x^{4} - 408 x^{3} - 308 x^{2} - 22 x}{x^{7} - 7 x^{6} + 21 x^{5} - 35 x^{4} + 35 x^{3} - 21 x^{2} + 7 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;10 x^{5} - 28 x^{4} + 408 x^{3} + 308 x^{2} + 22 x,
\]
