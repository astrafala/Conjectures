...
\title{The empirical recurrence for OEIS A297220, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297220 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A297220 is ``Number of n X 4 0..1 arrays with every 1 horizontally or antidiagonally adjacent to 1 neighboring 1s.''. It has offset $1$ and begins
\[
4, 16, 57, 207, 751, 2720, 9861, 35741,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) + 6*a(n-2) + 11*a(n-3) + 6*a(n-4) + a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 26 2019 12:05:47, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 6\,a(n-2) + 11\,a(n-3) + 6\,a(n-4) + a(n-5)
\end{equation}
for all $n>6$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297220.
