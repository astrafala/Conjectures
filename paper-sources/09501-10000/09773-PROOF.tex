...
\title{The empirical recurrence for OEIS A242147, derived from the entry's generating function}
...
\begin{abstract}
OEIS A242147 carries an empirical recurrence of order $9$. The entry separately records a
...
OEIS A242147 is ``Number of length 3+5 0..n arrays with no consecutive six elements summing to more than 3*n.''. It has offset $1$ and begins
\[
132, 2902, 27024, 154647, 647404, 2180310, 6256170, 15876783,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 31 2018 21:50:23, revision 10) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{9} + 9 x^{8} - 36 x^{7} + 30 x^{6} - 1309 x^{5} - 4815 x^{4} - 5658 x^{3} - 1714 x^{2} - 132 x}{x^{9} - 9 x^{8} + 36 x^{7} - 84 x^{6} + 126 x^{5} - 126 x^{4} + 84 x^{3} - 36 x^{2} + 9 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;x^{9} - 9 x^{8} + 36 x^{7} - 30 x^{6} + 1309 x^{5} + 4815 x^{4} + 5658 x^{3} + 1714 x^{2} + 132 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A242147.
