...
\title{The empirical recurrence for OEIS A227099, derived from the entry's generating function}
...
\begin{abstract}
OEIS A227099 carries an empirical recurrence of order $8$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 07 2018 05:56:33, revision 7) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{11} + 3 x^{10} - x^{9} - 3 x^{8} + 2 x^{7} - 11 x^{6} + 37 x^{5} - 52 x^{4} + 40 x^{3} - 17 x^{2} + 4 x}{x^{8} - 8 x^{7} + 28 x^{6} - 56 x^{5} + 70 x^{4} - 56 x^{3} + 28 x^{2} - 8 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- x^{11} + 3 x^{10} - x^{9} - 3 x^{8} + 2 x^{7} - 11 x^{6} + 37 x^{5} - 52 x^{4} + 40 x^{3} - 17 x^{2} + 4 x,
\]
