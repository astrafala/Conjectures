...
\title{The empirical recurrence for OEIS A245874, derived from the entry's generating function}
...
\begin{abstract}
OEIS A245874 carries an empirical recurrence of order $8$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 04 2018 13:05:08, revision 7) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{8} + 2 x^{7} + 121 x^{6} - 10 x^{5} - 371 x^{4} - 574 x^{3} - 469 x^{2} - 42 x}{x^{8} - 2 x^{7} - 2 x^{6} + 6 x^{5} - 6 x^{3} + 2 x^{2} + 2 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;x^{8} - 2 x^{7} - 121 x^{6} + 10 x^{5} + 371 x^{4} + 574 x^{3} + 469 x^{2} + 42 x,
\]
