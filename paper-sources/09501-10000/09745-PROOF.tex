...
\title{The empirical recurrence for OEIS A302736, proved by transfer matrix}
...
\begin{abstract}
OEIS A302736 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A302736 is ``Number of nX3 0..1 arrays with every element equal to 0, 1, 2, 3 or 4 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
4, 32, 228, 1652, 11980, 86916, 630604, 4575332,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 7*a(n-1) +2*a(n-2) +2*a(n-3) -20*a(n-4) -16*a(n-5)
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 12 2018 11:18:04, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302736.
