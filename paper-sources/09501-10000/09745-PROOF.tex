...
\title{The empirical recurrence for OEIS A199838, derived from the entry's generating function}
...
\begin{abstract}
OEIS A199838 carries an empirical recurrence of order $9$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 25 2021 05:11:21, revision 11) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 256 x^{8} - 37794 x^{7} - 566180 x^{6} - 1875334 x^{5} - 1733470 x^{4} - 439302 x^{3} - 22612 x^{2} - 66 x}{x^{9} - 9 x^{8} + 36 x^{7} - 84 x^{6} + 126 x^{5} - 126 x^{4} + 84 x^{3} - 36 x^{2} + 9 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;256 x^{8} + 37794 x^{7} + 566180 x^{6} + 1875334 x^{5} + 1733470 x^{4} + 439302 x^{3} + 22612 x^{2} + 66 x,
\]
