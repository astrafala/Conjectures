...
\title{The empirical recurrence for OEIS A234476, proved by transfer matrix}
...
\begin{abstract}
OEIS A234476 counts $2$-column arrays over $\{0,\dots,7\}$ in which every
...
OEIS A234476 is ``Number of (n+1) X (1+1) 0..7 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 1 (constant-stress 1 X 1 tilings).''. It has offset
$1$ and begins
\[
672, 7840, 95872, 1200640, 15217152, 194145280, 2484815872,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 224*a(n-2) -10304*a(n-4) +96256*a(n-6) -80640*a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 20 2022 19:07:06, revision 7) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;224\,a(n-2) - 10304\,a(n-4) + 96256\,a(n-6) - 80640\,a(n-8)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234476.
