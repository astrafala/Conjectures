...
\title{The empirical recurrence for OEIS A242146, derived from the entry's generating function}
...
\begin{abstract}
OEIS A242146 carries an empirical recurrence of order $8$. The entry separately records a
...
OEIS A242146 is ``Number of length 2+5 0..n arrays with no consecutive six elements summing to more than 3*n.''. It has offset $1$ and begins
\[
74, 1113, 7862, 36224, 126894, 367358, 924300, 2088459,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 31 2018 18:42:23, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{8} + 8 x^{7} - 28 x^{6} + 90 x^{5} + 348 x^{4} + 1030 x^{3} + 521 x^{2} + 74 x}{x^{8} - 8 x^{7} + 28 x^{6} - 56 x^{5} + 70 x^{4} - 56 x^{3} + 28 x^{2} - 8 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- x^{8} + 8 x^{7} - 28 x^{6} + 90 x^{5} + 348 x^{4} + 1030 x^{3} + 521 x^{2} + 74 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A242146.
