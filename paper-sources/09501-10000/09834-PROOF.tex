...
\title{The empirical recurrence for OEIS A241939, derived from the entry's generating function}
...
\begin{abstract}
OEIS A241939 carries an empirical recurrence of order $8$. The entry separately records a
...
OEIS A241939 is ``Number of length 3+4 0..n arrays with no consecutive five elements summing to more than 2*n.''. It has offset $1$ and begins
\[
43, 509, 3150, 13339, 44063, 122162, 297324, 654345,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 31 2018 09:24:13, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{8} + 8 x^{7} - 28 x^{6} + 57 x^{5} - 17 x^{4} + 282 x^{3} + 165 x^{2} + 43 x}{x^{8} - 8 x^{7} + 28 x^{6} - 56 x^{5} + 70 x^{4} - 56 x^{3} + 28 x^{2} - 8 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- x^{8} + 8 x^{7} - 28 x^{6} + 57 x^{5} - 17 x^{4} + 282 x^{3} + 165 x^{2} + 43 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A241939.
