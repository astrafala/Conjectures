...
\title{The empirical recurrence for OEIS A250016, derived from the entry's generating function}
...
\begin{abstract}
OEIS A250016 carries an empirical recurrence of order $8$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 10 2018 12:44:04, revision 20) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{80 x^{6} + 780 x^{5} + 2200 x^{4} + 1600 x^{3} + 360 x^{2} + 20 x}{x^{8} - 8 x^{7} + 28 x^{6} - 56 x^{5} + 70 x^{4} - 56 x^{3} + 28 x^{2} - 8 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;80 x^{6} + 780 x^{5} + 2200 x^{4} + 1600 x^{3} + 360 x^{2} + 20 x,
\]
