...
\title{The empirical recurrence for OEIS A147821, derived from the entry's generating function}
...
\begin{abstract}
OEIS A147821 carries an empirical recurrence of order $11$. The entry separately records a
...
OEIS A147821 is ``Number of consistent sets of 5 irreflexive binary order relationships over n objects.''. It has offset $4$ and begins
\[
108, 6180, 83952, 601944, 2991576, 11662056, 38167920, 109368864,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 12 2020 03:11:49, revision 37) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 120 x^{10} + 936 x^{9} - 3492 x^{8} - 552 x^{7} - 21912 x^{6} - 4992 x^{5} - 108 x^{4}}{x^{11} - 11 x^{10} + 55 x^{9} - 165 x^{8} + 330 x^{7} - 462 x^{6} + 462 x^{5} - 330 x^{4} + 165 x^{3} - 55 x^{2} + 11 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;120 x^{10} - 936 x^{9} + 3492 x^{8} + 552 x^{7} + 21912 x^{6} + 4992 x^{5} + 108 x^{4},
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A147821.
