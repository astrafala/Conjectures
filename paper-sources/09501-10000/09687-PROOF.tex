...
\title{The empirical recurrence for OEIS A202753, derived from the entry's generating function}
...
\begin{abstract}
OEIS A202753 carries an empirical recurrence of order $11$. The entry separately records a
...
OEIS A202753 is ``Number of n X 5 nonnegative integer arrays with each row and column increasing from zero by 0 or 1.''. It has offset $1$ and begins
\[
1, 5, 31, 184, 924, 3809, 13197, 39675,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 01 2018 11:57:32, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{11} + 8 x^{10} - 31 x^{9} + 79 x^{8} - 140 x^{7} + 162 x^{6} - 110 x^{5} + 47 x^{4} - 31 x^{3} + 6 x^{2} - x}{x^{11} - 11 x^{10} + 55 x^{9} - 165 x^{8} + 330 x^{7} - 462 x^{6} + 462 x^{5} - 330 x^{4} + 165 x^{3} - 55 x^{2} + 11 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;x^{11} - 8 x^{10} + 31 x^{9} - 79 x^{8} + 140 x^{7} - 162 x^{6} + 110 x^{5} - 47 x^{4} + 31 x^{3} - 6 x^{2} + x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A202753.
