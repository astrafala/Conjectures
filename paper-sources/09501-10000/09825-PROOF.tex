...
\title{The empirical recurrence for OEIS A227329, derived from the entry's generating function}
...
\begin{abstract}
OEIS A227329 carries an empirical recurrence of order $8$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 05 2020 22:12:58, revision 10) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 2 x^{10} + 13 x^{9} - 30 x^{8} + 37 x^{7} - 43 x^{6} + 69 x^{5} - 84 x^{4} + 58 x^{3} - 21 x^{2} + 4 x}{x^{8} - 8 x^{7} + 28 x^{6} - 56 x^{5} + 70 x^{4} - 56 x^{3} + 28 x^{2} - 8 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 2 x^{10} + 13 x^{9} - 30 x^{8} + 37 x^{7} - 43 x^{6} + 69 x^{5} - 84 x^{4} + 58 x^{3} - 21 x^{2} + 4 x,
\]
