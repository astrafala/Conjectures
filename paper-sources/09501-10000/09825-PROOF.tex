...
\title{The empirical recurrence for OEIS A234683, proved by transfer matrix}
...
\begin{abstract}
OEIS A234683 counts $2$-column arrays over $\{0,\dots,6\}$ in which every
...
OEIS A234683 is ``Number of (n+1) X (1+1) 0..6 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 5 (constant-stress 1 X 1 tilings).''. It has offset
$1$ and begins
\[
232, 1148, 5472, 27344, 131200, 661952, 3196416,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 72*a(n-2) - 1712*a(n-4) + 13440*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 19 2022 01:07:32, revision 9) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234683.
