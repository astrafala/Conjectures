...
\title{The empirical recurrence for OEIS A207043, proved by transfer matrix}
...
\begin{abstract}
OEIS A207043 counts arrays over $\{0,\dots,2\}$ under a condition on the perimeter cycle of
...
OEIS A207043 is ``Number of (n+1) X 2 0..2 arrays with every 2 X 3 or 3 X 2 subblock having exactly one clockwise edge increases.''. It has offset $1$ and begins
\[
81, 150, 441, 1416, 4371, 13386, 41589, 128700,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + a(n-2) + 8*a(n-3) - 2*a(n-4) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 17 2018 14:40:18, revision 11) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207043.
