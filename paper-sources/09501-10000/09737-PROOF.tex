...
\title{The empirical recurrence for OEIS A232292, proved by transfer matrix}
...
\begin{abstract}
OEIS A232292 counts arrays of width $5$ over $\{0,1,2\}$ in which every cell carrying one stated
...
OEIS A232292 is ``Number of nX5 0..2 arrays with every 0 next to a 1 and every 1 next to a 2 horizontally or antidiagonally.''. It has offset $1$ and begins
\[
33, 3615, 336079, 31119789, 2885285507, 267483142619, 24797475083765, 2298890419506403,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 07:15:48, revision 6) this is still
...
adjacency matrix,
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=40933.
\]
...
\begin{theorem}
\[
a(n)\;=\;77\,a(n-1) + 1414\,a(n-2) + 4190\,a(n-3) - 25759\,a(n-4) - 74189\,a(n-5) + 246122\,a(n-6) - 20486\,a(n-7) - 1442713\,a(n-8) + 3110141\,a(n-9) - 347652\,a(n-10) - 624656\,a(n-11) + 210492\,a(n-12) - 18900\,a(n-13)
\]
for every $n>14$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232292.
