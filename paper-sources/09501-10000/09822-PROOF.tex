...
\title{The empirical recurrence for OEIS A241620, derived from the entry's generating function}
...
\begin{abstract}
OEIS A241620 carries an empirical recurrence of order $8$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 30 2018 10:34:37, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{8} + 8 x^{7} - 28 x^{6} + 56 x^{5} - 69 x^{4} + 67 x^{3} - 5 x^{2} + 19 x}{x^{8} - 8 x^{7} + 28 x^{6} - 56 x^{5} + 70 x^{4} - 56 x^{3} + 28 x^{2} - 8 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- x^{8} + 8 x^{7} - 28 x^{6} + 56 x^{5} - 69 x^{4} + 67 x^{3} - 5 x^{2} + 19 x,
\]
