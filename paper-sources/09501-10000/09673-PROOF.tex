...
\title{The empirical recurrence for OEIS A185516, proved by transfer matrix}
...
\begin{abstract}
OEIS A185516 counts arrays over $\{0,\dots,2\}$ under a condition on the determinant of every
...
OEIS A185516 is ``Number of (n+1)X5 0..2 arrays with every 2X2 subblock singular.''. It has offset $1$ and begins
\[
2553, 115979, 2490449, 80761059, 2183297449, 65652458491, 1894624012417, 56140705014995,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 03:03:54, revision 9) this is still
...
first term is $2553$, and the model reproduces it along with every later term; that is the
...
\begin{theorem}
\[
a(n)\;=\;61\,a(n-1) - 1038\,a(n-2) - 2374\,a(n-3) + 235515\,a(n-4) - 2269967\,a(n-5) + 4091988\,a(n-6) + 57111048\,a(n-7) - 371380096\,a(n-8) + 662678992\,a(n-9) + 937755776\,a(n-10) - 4856175360\,a(n-11) + 5080858624\,a(n-12) + 506806272\,a(n-13) - 2361655296\,a(n-14)
\]
for every $n>13$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A185516.
