...
\title{The empirical recurrence for OEIS A202334, derived from the entry's generating function}
...
\begin{abstract}
OEIS A202334 carries an empirical recurrence of order $9$. The entry separately records a
...
OEIS A202334 is ``Number of (n+1) X 8 binary arrays with consecutive windows of two bits considered as a binary number nondecreasing in every row and column.''. It has offset $1$ and begins
\[
100, 368, 1112, 2906, 6800, 14588, 29174, 55057,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 28 2018 08:41:58, revision 10) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 21 x^{9} + 185 x^{8} - 722 x^{7} + 1636 x^{6} - 2366 x^{5} + 2254 x^{4} - 1400 x^{3} + 532 x^{2} - 100 x}{x^{9} - 9 x^{8} + 36 x^{7} - 84 x^{6} + 126 x^{5} - 126 x^{4} + 84 x^{3} - 36 x^{2} + 9 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;21 x^{9} - 185 x^{8} + 722 x^{7} - 1636 x^{6} + 2366 x^{5} - 2254 x^{4} + 1400 x^{3} - 532 x^{2} + 100 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A202334.
