...
\title{The empirical recurrence for OEIS A065026, derived from the entry's generating function}
...
\begin{abstract}
OEIS A065026 carries an empirical recurrence of order $6$. The entry separately records a
...
OEIS A065026 is ``a(1) = 1; for n>1, a(n) = smallest number that is not a sum or product of any subset of the numbers a(1) to a(n-1).''. It has offset $1$ and begins
\[
1, 2, 4, 9, 17, 25, 59, 67,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 20 2019 17:49:53, revision 20) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{804 x^{17} - 84 x^{16} - 168 x^{15} - 150 x^{14} - 402 x^{13} - 42 x^{12} + 24 x^{11} + 10 x^{10} - 2 x^{9} - 15 x^{8} + 11 x^{7} - x^{6} + 5 x^{5} + 5 x^{4} + 2 x^{3} + 2 x^{2} + x}{2 x^{6} - 4 x^{4} - 2 x^{2} + 1},
\]
the entry's own generating function, and let
\[
D(x)\;=\;1-\sum_i c_i x^{i}\;=\;2 x^{6} - 4 x^{4} - 2 x^{2} + 1
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;804 x^{17} - 84 x^{16} - 168 x^{15} - 150 x^{14} - 402 x^{13} - 42 x^{12} + 24 x^{11} + 10 x^{10} - 2 x^{9} - 15 x^{8} + 11 x^{7} - x^{6} + 5 x^{5} + 5 x^{4} + 2 x^{3} + 2 x^{2} + x,
\]
...
$n>17$. The bound is exact: at $n=17$ the recurrence fails on the entry's own published terms.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A065026.
