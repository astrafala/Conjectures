...
\title{The empirical recurrence for OEIS A208035, proved by transfer matrix}
...
\begin{abstract}
OEIS A208035 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
...
OEIS A208035 is ``Number of n X 4 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 0 0 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
9, 81, 289, 961, 3249, 11025, 37249,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) + 3*a(n-2) + 6*a(n-3) - a(n-4) - a(n-6) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 27 2018 05:50:34, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208035.
