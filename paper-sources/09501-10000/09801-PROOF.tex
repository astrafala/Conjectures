...
\title{The empirical recurrence for OEIS A201348, derived from the entry's generating function}
...
\begin{abstract}
OEIS A201348 carries an empirical recurrence of order $8$. The entry separately records a
...
OEIS A201348 is ``Number of n X 3 0..1 arrays with rows and columns lexicographically nondecreasing and every element equal to at least one horizontal or vertical neighbor.''. It has offset $1$ and begins
\[
2, 8, 18, 47, 118, 273, 585, 1174,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 22 2018 05:42:07, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 2 x^{9} + 20 x^{8} - 59 x^{7} + 85 x^{6} - 62 x^{5} + 15 x^{4} + 10 x^{3} - 8 x^{2} + 2 x}{x^{8} - 8 x^{7} + 28 x^{6} - 56 x^{5} + 70 x^{4} - 56 x^{3} + 28 x^{2} - 8 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 2 x^{9} + 20 x^{8} - 59 x^{7} + 85 x^{6} - 62 x^{5} + 15 x^{4} + 10 x^{3} - 8 x^{2} + 2 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A201348.
