...
\title{The empirical recurrence for OEIS A268264, derived from the entry's generating function}
...
\begin{abstract}
OEIS A268264 carries an empirical recurrence of order $7$. The entry separately records a
...
OEIS A268264 is ``Number of length-(5+1) 0..n arrays with new repeated values introduced in sequential order starting with zero.''. It has offset $1$ and begins
\[
33, 273, 1616, 6877, 22710, 62249, 148468, 318261,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 13 2019 08:49:17, revision 7) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{8} + 2 x^{7} + 2 x^{6} - 107 x^{5} - 143 x^{4} - 398 x^{3} - 42 x^{2} - 33 x}{x^{7} - 7 x^{6} + 21 x^{5} - 35 x^{4} + 35 x^{3} - 21 x^{2} + 7 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;x^{8} - 2 x^{7} - 2 x^{6} + 107 x^{5} + 143 x^{4} + 398 x^{3} + 42 x^{2} + 33 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268264.
