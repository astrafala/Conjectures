...
\title{The empirical recurrence for OEIS A214944, derived from the entry's generating function}
...
\begin{abstract}
OEIS A214944 carries an empirical recurrence of order $6$. The entry separately records a
...
OEIS A214944 is ``Number of squarefree words of length 5 in an (n+1)-ary alphabet.''. It has offset $1$ and begins
\[
0, 30, 264, 1140, 3480, 8610, 18480, 35784,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 22 2018 08:44:37, revision 9) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{6 x^{4} + 84 x^{3} + 30 x^{2}}{x^{6} - 6 x^{5} + 15 x^{4} - 20 x^{3} + 15 x^{2} - 6 x + 1},
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A214944.
