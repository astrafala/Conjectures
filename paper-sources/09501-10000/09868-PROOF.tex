...
\title{The empirical recurrence for OEIS A268461, derived from the entry's generating function}
...
\begin{abstract}
OEIS A268461 carries an empirical recurrence of order $8$. The entry separately records a
...
OEIS A268461 is ``Number of length-7 0..n arrays with no adjacent pair x,x+1 followed at any distance by x+1,x.''. It has offset $1$ and begins
\[
29, 1169, 11536, 62535, 240170, 736525, 1926444, 4474451,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 14 2019 08:40:56, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{9} + 13 x^{8} - 88 x^{7} + 335 x^{6} - 536 x^{5} + 1355 x^{4} + 2996 x^{3} + 937 x^{2} + 29 x}{x^{8} - 8 x^{7} + 28 x^{6} - 56 x^{5} + 70 x^{4} - 56 x^{3} + 28 x^{2} - 8 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- x^{9} + 13 x^{8} - 88 x^{7} + 335 x^{6} - 536 x^{5} + 1355 x^{4} + 2996 x^{3} + 937 x^{2} + 29 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268461.
