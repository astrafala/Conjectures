...
\title{The empirical recurrence for OEIS A237317, proved by transfer matrix}
...
\begin{abstract}
OEIS A237317 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
OEIS A237317 is ``Number of (n+1) X (1+1) 0..2 arrays with the maximum plus the upper median plus the minimum minus the lower median of every 2 X 2 subblock differing from its horizontal and vertical neighbors by exactly one.''. It has offset $1$ and begins
\[
81, 348, 1508, 6608, 28772, 123888, 536848, 2352448,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 356*a(n-4) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 22 2018 11:07:21, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237317.
