...
\title{The empirical recurrence for OEIS A211912, derived from the entry's generating function}
...
\begin{abstract}
OEIS A211912 carries an empirical recurrence of order $9$. The entry separately records a
...
OEIS A211912 is ``Number of lower triangular n X n arrays colored with integers 0 upwards introduced in row major order, with no element equal to any horizontal, vertical, diagonal or antidiagonal neighbor, and containing the value n(n+1)/2-3.''. It has offset $1$ and begins
\[
0, 1, 10, 214, 1946, 10431, 40561, 127275,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 20 2018 09:36:51, revision 7) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{10} + 13 x^{9} - 66 x^{8} + 104 x^{7} + 93 x^{6} - 296 x^{5} - 160 x^{4} - x^{3} - x^{2}}{x^{9} - 9 x^{8} + 36 x^{7} - 84 x^{6} + 126 x^{5} - 126 x^{4} + 84 x^{3} - 36 x^{2} + 9 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;x^{10} - 13 x^{9} + 66 x^{8} - 104 x^{7} - 93 x^{6} + 296 x^{5} + 160 x^{4} + x^{3} + x^{2},
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A211912.
