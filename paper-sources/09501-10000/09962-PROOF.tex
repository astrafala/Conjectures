...
\title{The empirical recurrence for OEIS A209548, proved by transfer matrix}
...
\begin{abstract}
OEIS A209548 counts $(n+1)\times4$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A209548 is ``1/4 the number of (n+1)X4 0..3 arrays with every 2X2 subblock having exactly two distinct clockwise edge differences.''. It has offset $1$ and begins
\[
61, 562, 5075, 46515, 425803, 3901194, 35741496, 327471411,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 15:20:32, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;15\,a(n-1) - 59\,a(n-2) + 27\,a(n-3) + 267\,a(n-4) - 488\,a(n-5) + 111\,a(n-6) + 312\,a(n-7) - 174\,a(n-8) - 30\,a(n-9) + 18\,a(n-10) + 2\,a(n-11)
\end{equation}
for all $n>11$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209548.
