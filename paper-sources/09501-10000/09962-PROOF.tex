...
\title{The empirical recurrence for OEIS A245159, derived from the entry's generating function}
...
\begin{abstract}
OEIS A245159 carries an empirical recurrence of order $7$. The entry separately records a
...
OEIS A245159 is ``Number of length n 0..4 arrays with new values introduced in order from both ends.''. It has offset $1$ and begins
\[
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 03 2018 10:32:39, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{124 x^{8} - 425 x^{7} + 710 x^{6} - 656 x^{5} + 346 x^{4} - 103 x^{3} + 16 x^{2} - x}{180 x^{7} - 696 x^{6} + 1097 x^{5} - 913 x^{4} + 434 x^{3} - 118 x^{2} + 17 x - 1},
\]
the entry's own generating function, and let
\[
D(x)\;=\;1-\sum_i c_i x^{i}\;=\;- 180 x^{7} + 696 x^{6} - 1097 x^{5} + 913 x^{4} - 434 x^{3} + 118 x^{2} - 17 x + 1
\]
...
\begin{theorem}
\[
a(n)\;=\;17\,a(n-1) - 118\,a(n-2) + 434\,a(n-3) - 913\,a(n-4) + 1097\,a(n-5) - 696\,a(n-6) + 180\,a(n-7)
\]
for every $n>8$.
\end{theorem}
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 124 x^{8} + 425 x^{7} - 710 x^{6} + 656 x^{5} - 346 x^{4} + 103 x^{3} - 16 x^{2} + x,
\]
...
\[
180 x^{7} - 696 x^{6} + 1097 x^{5} - 913 x^{4} + 434 x^{3} - 118 x^{2} + 17 x - 1,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A245159.
