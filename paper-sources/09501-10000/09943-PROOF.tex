...
\title{The empirical recurrence for OEIS A253228, proved by transfer matrix}
...
\begin{abstract}
OEIS A253228 counts the arrays over $\{0,\dots,1\}$ whose $2\times2$ subblocks carry a
...
OEIS A253228 is ``Number of (n+1) X (5+1) 0..1 arrays with every 2 X 2 subblock diagonal minimum minus antidiagonal minimum nondecreasing horizontally and diagonal maximum minus antidiagonal maximum nondecreasing vertically.''. It has offset $1$ and begins
\[
907, 1775, 1709, 2543, 3936, 6414, 11022, 19851,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 5*a(n-1) - 9*a(n-2) + 7*a(n-3) - 2*a(n-4) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 10 2018 12:18:47, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253228.
