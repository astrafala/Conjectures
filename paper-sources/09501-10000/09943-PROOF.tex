...
\title{A local condition on an array: OEIS A183357}
...
\begin{abstract}
OEIS A183357 carries an empirical recurrence of order $4$ contributed by R.~H.~Hardin. It is
...
OEIS A183357 is ``One quarter the number of n X 5 1..4 arrays with no two neighbors of any element equal to each other.''. It has offset $1$ and begins
\[
108, 2304, 3888, 9216, 24192, 57600, 137088, 331776,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + 2*a(n-3) + a(n-4) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 28 2018 08:14:18, revision 9) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{The count is a walk count}

The entry counts arrays with $5$ columns over the alphabet $\{1,2,3,4\}$, growing one row at a time, and asks that the neighbours of any one element --- those directly above, below, left and right of it --- must all be different from each other.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A183357.
