...
\title{The empirical recurrence for OEIS A300203, proved by transfer matrix}
...
\begin{abstract}
OEIS A300203 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A300203 is ``Number of n X 3 0..1 arrays with every element equal to 0, 1, 2, 3, 4, 5, 6 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
4, 32, 248, 1933, 15070, 117494, 916061, 7142233,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 8*a(n-1) - 2*a(n-2) + 5*a(n-3) - 13*a(n-4) - 6*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 21 2018 05:43:34, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A300203.
