...
\title{The empirical recurrence for OEIS A209790, proved by transfer matrix}
...
\begin{abstract}
OEIS A209790 counts $(n+1)\times3$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A209790 is ``Half the number of (n+1) X 3 0..2 arrays with every 2 X 2 subblock having exactly one duplicate clockwise edge difference.''. It has offset $1$ and begins
\[
204, 3171, 49056, 759642, 11761044, 182095128, 2819342124, 43651363500,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 14*a(n-1) + 27*a(n-2) - 64*a(n-3) + 22*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 13 2018 05:33:19, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;14\,a(n-1) + 27\,a(n-2) - 64\,a(n-3) + 22\,a(n-4)
\end{equation}
for all $n>3$.
...
\[
a(n)-\sum_i c_i\,a(n-i)\;=\;\tfrac1{2}\mathbf{1}^{\!\top}M^{\,n+1-1-4}\,q(M)\,\mathbf{1} .
\]
...
=\tfrac1{2}\mathbf{1}^{\!\top}M^{\,m-4}\,q(M)\,\mathbf{1}
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209790.
