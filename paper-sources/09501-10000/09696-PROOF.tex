...
\title{The empirical recurrence for OEIS A252817, derived from the entry's generating function}
...
\begin{abstract}
OEIS A252817 carries an empirical recurrence of order $11$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 06 2018 10:10:26, revision 10) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 3 x^{11} + 29 x^{10} - 131 x^{9} + 360 x^{8} - 657 x^{7} + 822 x^{6} - 711 x^{5} + 430 x^{4} - 182 x^{3} + 40 x^{2} - 11 x}{x^{11} - 11 x^{10} + 55 x^{9} - 165 x^{8} + 330 x^{7} - 462 x^{6} + 462 x^{5} - 330 x^{4} + 165 x^{3} - 55 x^{2} + 11 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;3 x^{11} - 29 x^{10} + 131 x^{9} - 360 x^{8} + 657 x^{7} - 822 x^{6} + 711 x^{5} - 430 x^{4} + 182 x^{3} - 40 x^{2} + 11 x,
\]
