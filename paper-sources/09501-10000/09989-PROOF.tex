...
\title{The empirical recurrence for OEIS A208600, derived from the entry's generating function}
...
\begin{abstract}
OEIS A208600 carries an empirical recurrence of order $6$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 18 2018 17:54:04, revision 13) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{6} + 6 x^{5} + 8 x^{4} + 172 x^{3} + 141 x^{2} + 26 x}{x^{6} - 6 x^{5} + 15 x^{4} - 20 x^{3} + 15 x^{2} - 6 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- x^{6} + 6 x^{5} + 8 x^{4} + 172 x^{3} + 141 x^{2} + 26 x,
\]
