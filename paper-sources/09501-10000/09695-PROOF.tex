...
\title{The empirical recurrence for OEIS A250393, derived from the entry's generating function}
...
\begin{abstract}
OEIS A250393 carries an empirical recurrence of order $11$. The entry separately records a
...
OEIS A250393 is ``Number of length 7+3 0..n arrays with no four consecutive terms having the maximum of any two terms equal to the minimum of the remaining two terms.''. It has offset $1$ and begins
\[
6, 1816, 74528, 1162292, 10203222, 61304844, 281731072, 1060924200,\ \dots
\]
...
\begin{quote}
G.f.: 2*x*(3 + 875*x + 27441*x\^{}2 + 220687*x\^{}3 + 609695*x\^{}4 + 647425*x\^{}5 + 267419*x\^{}6 + 39317*x\^{}7 + 1538*x\^{}8) / (1 - x)\^{}11.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 21 2017 06:19:51, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 3076 x^{9} - 78634 x^{8} - 534838 x^{7} - 1294850 x^{6} - 1219390 x^{5} - 441374 x^{4} - 54882 x^{3} - 1750 x^{2} - 6 x}{x^{11} - 11 x^{10} + 55 x^{9} - 165 x^{8} + 330 x^{7} - 462 x^{6} + 462 x^{5} - 330 x^{4} + 165 x^{3} - 55 x^{2} + 11 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;3076 x^{9} + 78634 x^{8} + 534838 x^{7} + 1294850 x^{6} + 1219390 x^{5} + 441374 x^{4} + 54882 x^{3} + 1750 x^{2} + 6 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250393.
