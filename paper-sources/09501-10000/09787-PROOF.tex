...
\title{The empirical recurrence for OEIS A250376, derived from the entry's generating function}
...
\begin{abstract}
OEIS A250376 carries an empirical recurrence of order $9$. The entry separately records a
...
OEIS A250376 is ``Number of length 3+6 0..n arrays with every seven consecutive terms having the maximum of some three terms equal to the minimum of the remaining four terms.''. It has offset $1$ and begins
\[
252, 7168, 69984, 396745, 1616636, 5272892, 14647808, 36038649,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 13 2018 12:48:48, revision 7) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{9} + 9 x^{8} - 80 x^{7} + 1252 x^{6} + 5005 x^{5} - 3769 x^{4} - 14544 x^{3} - 4900 x^{2} - 252 x}{x^{9} - 9 x^{8} + 36 x^{7} - 84 x^{6} + 126 x^{5} - 126 x^{4} + 84 x^{3} - 36 x^{2} + 9 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;x^{9} - 9 x^{8} + 80 x^{7} - 1252 x^{6} - 5005 x^{5} + 3769 x^{4} + 14544 x^{3} + 4900 x^{2} + 252 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250376.
