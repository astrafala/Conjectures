...
\title{The empirical recurrence for OEIS A234228, proved by transfer matrix}
...
\begin{abstract}
OEIS A234228 counts $2$-column arrays over $\{0,\dots,7\}$ in which every
...
OEIS A234228 is ``Number of (n+1) X (1+1) 0..7 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 3 (constant-stress 1 X 1 tilings).''. It has offset
$1$ and begins
\[
568, 5260, 48592, 449880, 4160672, 38547120, 356781376,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 182*a(n-2) - 9024*a(n-4) + 66960*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 20 2022 21:34:11, revision 13) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234228.
