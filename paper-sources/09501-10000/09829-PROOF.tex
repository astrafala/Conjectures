...
\title{The empirical recurrence for OEIS A228464, derived from the entry's generating function}
...
\begin{abstract}
OEIS A228464 carries an empirical recurrence of order $8$. The entry separately records a
...
OEIS A228464 is ``Number of arrays of maxima of three adjacent elements of some 0..n array of length 9.''. It has offset $1$ and begins
\[
44, 383, 1821, 6254, 17487, 42386, 92430, 185727,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 17 2018 05:45:51, revision 23) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{8} + 8 x^{7} - 28 x^{6} + 75 x^{5} - 54 x^{4} - 11 x^{3} + 31 x^{2} + 44 x}{x^{8} - 8 x^{7} + 28 x^{6} - 56 x^{5} + 70 x^{4} - 56 x^{3} + 28 x^{2} - 8 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- x^{8} + 8 x^{7} - 28 x^{6} + 75 x^{5} - 54 x^{4} - 11 x^{3} + 31 x^{2} + 44 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A228464.
