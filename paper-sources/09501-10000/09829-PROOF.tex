...
\title{The empirical recurrence for OEIS A207045, proved by transfer matrix}
...
\begin{abstract}
OEIS A207045 counts arrays over $\{0,\dots,2\}$ under a condition on the perimeter cycle of
...
a bounded window of consecutive rows, so the count is a walk count on $S=441$ states and is
...
OEIS A207045 is ``Number of (n+1) X 4 0..2 arrays with every 2 X 3 or 3 X 2 subblock having exactly one clockwise edge increases.''. It has offset $1$ and begins
\[
441, 552, 750, 1272, 2094, 3408, 5850, 9792,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-3) +a(n-4) for n>11.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 18 2018 12:29:17, revision 9) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207045.
