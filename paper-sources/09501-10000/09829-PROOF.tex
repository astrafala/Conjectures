...
\title{The empirical recurrence for OEIS A247996, derived from the entry's generating function}
...
\begin{abstract}
OEIS A247996 carries an empirical recurrence of order $8$. The entry separately records a
...
OEIS A247996 is ``Number of length 1+5 0..n arrays with no disjoint triples in any consecutive six terms having the same sum.''. It has offset $1$ and begins
\[
32, 396, 2292, 9080, 28020, 72972, 167576, 349392,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 08 2018 06:33:57, revision 12) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 332 x^{6} - 84 x^{5} - 424 x^{4} - 364 x^{3} - 204 x^{2} - 32 x}{x^{8} - 6 x^{7} + 14 x^{6} - 14 x^{5} + 14 x^{3} - 14 x^{2} + 6 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;332 x^{6} + 84 x^{5} + 424 x^{4} + 364 x^{3} + 204 x^{2} + 32 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A247996.
