...
\title{The empirical recurrence for OEIS A221545, derived from the entry's generating function}
...
\begin{abstract}
OEIS A221545 carries an empirical recurrence of order $7$. The entry separately records a
...
OEIS A221545 is ``Number of 0..n arrays of length 7 with each element differing from at least one neighbor by something other than 1, starting with 0.''. It has offset $1$ and begins
\[
8, 134, 1276, 6311, 22466, 64047, 156098, 338711,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 08 2018 09:07:43, revision 9) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{10 x^{10} - 79 x^{9} + 279 x^{8} - 572 x^{7} + 822 x^{6} - 675 x^{5} + 87 x^{4} - 506 x^{3} - 78 x^{2} - 8 x}{x^{7} - 7 x^{6} + 21 x^{5} - 35 x^{4} + 35 x^{3} - 21 x^{2} + 7 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 10 x^{10} + 79 x^{9} - 279 x^{8} + 572 x^{7} - 822 x^{6} + 675 x^{5} - 87 x^{4} + 506 x^{3} + 78 x^{2} + 8 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221545.
