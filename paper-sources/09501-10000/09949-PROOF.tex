...
\title{The empirical recurrence for OEIS A250899, proved by transfer matrix}
...
\begin{abstract}
OEIS A250899 carries an empirical recurrence of order $5$ contributed by R.~H.~Hardin. It is
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 23 2018 06:06:03, revision 8) this is still
