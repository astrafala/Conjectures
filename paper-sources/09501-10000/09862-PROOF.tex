...
\title{The empirical recurrence for OEIS A133710, derived from the entry's generating function}
...
\begin{abstract}
OEIS A133710 carries an empirical recurrence of order $7$. The entry separately records a
...
OEIS A133710 is ``Column l=3 of irregular triangle in A133709.''. It has offset $1$ and begins
\[
0, 3, 35, 131, 347, 767, 1511, 2744,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 03 2020 07:53:06, revision 15) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 6 x^{7} + 31 x^{6} - 60 x^{5} + 51 x^{4} - 14 x^{3} - 3 x^{2}}{x^{7} - 7 x^{6} + 21 x^{5} - 35 x^{4} + 35 x^{3} - 21 x^{2} + 7 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;6 x^{7} - 31 x^{6} + 60 x^{5} - 51 x^{4} + 14 x^{3} + 3 x^{2},
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A133710.
