...
\title{The empirical recurrence for OEIS A223349, proved by transfer matrix}
...
\begin{abstract}
OEIS A223349 carries an empirical recurrence of order $12$ contributed by R.~H.~Hardin. It is
...
OEIS A223349 is ``3X3X3 triangular graph without horizontal edges coloring a rectangular array: number of nX5 0..5 arrays where 0..5 label nodes of a graph with edges 0,1 0,2 1,3 1,4 2,4 2,5 and every array movement to a horizontal or vertical neighbor moves along an edge of this graph.''. It has offset $1$ and begins
\[
140, 4908, 202264, 7918948, 329268616, 12912752876, 537001573656, 21060038730884,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 21:32:56, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;1711\,a(n-2) - 132500\,a(n-4) + 3202240\,a(n-6) - 28936448\,a(n-8) + 102379520\,a(n-10) - 106561536\,a(n-12)
\]
for every $n>13$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223349.
