...
\title{The empirical recurrence for OEIS A200876, derived from the entry's generating function}
...
\begin{abstract}
OEIS A200876 carries an empirical recurrence of order $9$. The entry separately records a
...
OEIS A200876 is ``Number of 0..n arrays x(0..7) of 8 elements without any interior element greater than both neighbors or less than both neighbors.''. It has offset $1$ and begins
\[
68, 723, 3882, 14455, 42744, 107777, 241718, 495495,\ \dots
\]
...
\begin{quote}
G.f.: x*(68 + 111*x - 177*x\^{}2 - 167*x\^{}3 + 237*x\^{}4 - 97*x\^{}5 + 35*x\^{}6 - 9*x\^{}7 + x\^{}8) / (1 - x)\^{}9.
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 16 2017 09:58:30, revision 10) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{9} + 9 x^{8} - 35 x^{7} + 97 x^{6} - 237 x^{5} + 167 x^{4} + 177 x^{3} - 111 x^{2} - 68 x}{x^{9} - 9 x^{8} + 36 x^{7} - 84 x^{6} + 126 x^{5} - 126 x^{4} + 84 x^{3} - 36 x^{2} + 9 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;x^{9} - 9 x^{8} + 35 x^{7} - 97 x^{6} + 237 x^{5} - 167 x^{4} - 177 x^{3} + 111 x^{2} + 68 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A200876.
