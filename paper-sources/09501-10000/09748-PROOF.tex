...
\title{The empirical recurrence for OEIS A252527, proved by transfer matrix}
...
\begin{abstract}
OEIS A252527 counts $(n+2)\times5$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252527 is ``Number of (n+2) X (3+2) 0..3 arrays with every 3 X 3 subblock row and diagonal sum equal to 0 2 3 6 or 7 and every 3 X 3 column and antidiagonal sum not equal to 0 2 3 6 or 7.''. It has offset $1$ and begins
\[
621, 341, 466, 610, 1114, 1748, 2332, 4244,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 6*a(n-3) - 8*a(n-6) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 04 2018 11:03:53, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252527.
