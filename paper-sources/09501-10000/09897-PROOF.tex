...
\title{The empirical recurrence for OEIS A300968, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A300968 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A300968 is ``Number of n X 3 0..1 arrays with every element equal to 1, 2, 3, 4 or 6 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
1, 11, 72, 459, 2956, 18996, 122043, 784108,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 7*a(n-1) -2*a(n-2) -11*a(n-3) -a(n-4) +10*a(n-5) +6*a(n-6) -4*a(n-7) -4*a(n-8) -2*a(n-9) for n>11.
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 25 2022 21:05:15, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;7\,a(n-1) - 2\,a(n-2) - 11\,a(n-3) - a(n-4) + 10\,a(n-5) + 6\,a(n-6) - 4\,a(n-7) - 4\,a(n-8) - 2\,a(n-9)
\end{equation}
for all $n>11$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A300968.
