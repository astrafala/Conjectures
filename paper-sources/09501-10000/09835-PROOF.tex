...
\title{The empirical recurrence for OEIS A297715, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297715 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A297715 is ``Number of nX3 0..1 arrays with every 1 horizontally, diagonally or antidiagonally adjacent to 1, 2 or 4 neighboring 1s.''. It has offset $1$ and begins
\[
4, 34, 145, 747, 4090, 21116, 110551, 582755,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 04 2018 21:55:16, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 8\,a(n-2) + 64\,a(n-3) + 85\,a(n-4) + 19\,a(n-5) - 569\,a(n-6) - 1161\,a(n-7) - 1173\,a(n-8) + 125\,a(n-9) + 1720\,a(n-10) + 1802\,a(n-11) + 1328\,a(n-12) + 240\,a(n-13)
\end{equation}
for all $n>14$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297715.
