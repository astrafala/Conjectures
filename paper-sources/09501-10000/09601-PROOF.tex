...
\title{The empirical recurrence for OEIS A250900, proved by transfer matrix}
...
\begin{abstract}
OEIS A250900 carries an empirical recurrence of order $6$ contributed by R.~H.~Hardin. It is
...
OEIS A250900 is ``Number of (2+1) X (n+1) 0..2 arrays with nondecreasing x(i,j)-x(i,j-1) in the i direction and nondecreasing absolute value of x(i,j)-x(i-1,j) in the j direction.''. It has offset $1$ and begins
\[
125, 431, 1325, 3867, 11029, 31215, 88421, 251819,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 10*a(n-1) - 40*a(n-2) + 82*a(n-3) - 91*a(n-4) + 52*a(n-5) - 12*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 23 2018 06:06:12, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;10\,a(n-1) - 40\,a(n-2) + 82\,a(n-3) - 91\,a(n-4) + 52\,a(n-5) - 12\,a(n-6)
\]
for every $n>5$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250900.
