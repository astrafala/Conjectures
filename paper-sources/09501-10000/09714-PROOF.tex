...
\title{The empirical recurrence for OEIS A227162, derived from the entry's generating function}
...
\begin{abstract}
OEIS A227162 carries an empirical recurrence of order $10$. The entry separately records a
...
OEIS A227162 is ``Number of n X 3 0,1 arrays indicating 2 X 2 subblocks of some larger (n+1) X 4 binary array having a sum of one or less, with rows and columns of the latter in lexicographically nondecreasing order.''. It has offset $1$ and begins
\[
4, 18, 62, 193, 558, 1507, 3828, 9149,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 07 2018 08:26:56, revision 7) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{x^{13} - 13 x^{12} + 55 x^{11} - 113 x^{10} + 123 x^{9} - 70 x^{8} + 32 x^{7} - 56 x^{6} + 98 x^{5} - 97 x^{4} + 62 x^{3} - 22 x^{2} + 4 x}{x^{10} - 10 x^{9} + 45 x^{8} - 120 x^{7} + 210 x^{6} - 252 x^{5} + 210 x^{4} - 120 x^{3} + 45 x^{2} - 10 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;x^{13} - 13 x^{12} + 55 x^{11} - 113 x^{10} + 123 x^{9} - 70 x^{8} + 32 x^{7} - 56 x^{6} + 98 x^{5} - 97 x^{4} + 62 x^{3} - 22 x^{2} + 4 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A227162.
