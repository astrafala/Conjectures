...
\title{The empirical recurrence for OEIS A212841, derived from the entry's generating function}
...
\begin{abstract}
OEIS A212841 carries an empirical recurrence of order $9$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 21 2018 10:07:36, revision 10) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{9} + 23 x^{8} - 179 x^{7} + 563 x^{6} + 551 x^{5} - 23723 x^{4} - 16177 x^{3} - 1375 x^{2} - 2 x}{x^{9} - 9 x^{8} + 36 x^{7} - 84 x^{6} + 126 x^{5} - 126 x^{4} + 84 x^{3} - 36 x^{2} + 9 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;x^{9} - 23 x^{8} + 179 x^{7} - 563 x^{6} - 551 x^{5} + 23723 x^{4} + 16177 x^{3} + 1375 x^{2} + 2 x,
\]
