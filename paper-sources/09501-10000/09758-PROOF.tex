...
\title{The empirical recurrence for OEIS A201533, derived from the entry's generating function}
...
\begin{abstract}
OEIS A201533 carries an empirical recurrence of order $9$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 23 2018 08:11:29, revision 9) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{x^{12} - 5 x^{11} + 9 x^{10} - x^{9} - 20 x^{8} + 19 x^{7} + 25 x^{6} - 76 x^{5} + 84 x^{4} - 52 x^{3} + 18 x^{2} - 3 x}{x^{9} - 9 x^{8} + 36 x^{7} - 84 x^{6} + 126 x^{5} - 126 x^{4} + 84 x^{3} - 36 x^{2} + 9 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- x^{12} + 5 x^{11} - 9 x^{10} + x^{9} + 20 x^{8} - 19 x^{7} - 25 x^{6} + 76 x^{5} - 84 x^{4} + 52 x^{3} - 18 x^{2} + 3 x,
\]
