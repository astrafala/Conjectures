...
\title{The empirical recurrence for OEIS A269438, derived from the entry's generating function}
...
\begin{abstract}
OEIS A269438 carries an empirical recurrence of order $7$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 22 2019 07:44:37, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{7} + 7 x^{6} - 5 x^{5} - 14 x^{4} - 391 x^{3} - 265 x^{2} - 51 x}{x^{7} - 7 x^{6} + 21 x^{5} - 35 x^{4} + 35 x^{3} - 21 x^{2} + 7 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;x^{7} - 7 x^{6} + 5 x^{5} + 14 x^{4} + 391 x^{3} + 265 x^{2} + 51 x,
\]
