...
\title{The empirical recurrence for OEIS A249963, derived from the entry's generating function}
...
\begin{abstract}
OEIS A249963 carries an empirical recurrence of order $9$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 21 2017 08:22:22, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 175 x^{7} - 3594 x^{6} - 13281 x^{5} - 15932 x^{4} - 6561 x^{3} - 762 x^{2} - 15 x}{x^{9} - 9 x^{8} + 36 x^{7} - 84 x^{6} + 126 x^{5} - 126 x^{4} + 84 x^{3} - 36 x^{2} + 9 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;175 x^{7} + 3594 x^{6} + 13281 x^{5} + 15932 x^{4} + 6561 x^{3} + 762 x^{2} + 15 x,
\]
