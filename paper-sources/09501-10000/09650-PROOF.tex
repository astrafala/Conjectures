...
\title{The empirical recurrence for OEIS A301657, proved by transfer matrix}
...
\begin{abstract}
OEIS A301657 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A301657 is ``Number of nX3 0..1 arrays with every element equal to 0, 1 or 4 horizontally or vertically adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
3, 4, 6, 9, 15, 26, 46, 83,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) -a(n-4)
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 25 2018 11:25:26, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A301657.
