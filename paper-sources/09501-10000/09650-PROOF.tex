...
\title{The empirical recurrence for OEIS A237854, proved by transfer matrix}
...
\begin{abstract}
OEIS A237854 counts $(n+1)\times4$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A237854 is ``Number of (n+1)X(3+1) 0..1 arrays with no element greater than all horizontal neighbors or less than all vertical neighbors.''. It has offset $1$ and begins
\[
7, 41, 184, 773, 3373, 15038, 66838, 295601,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 5*a(n-1) -6*a(n-2) +13*a(n-3) +11*a(n-4) -5*a(n-5) +4*a(n-6) +9*a(n-7) -10*a(n-8) -10*a(n-9) +a(n-11)
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 10:30:52, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) - 6\,a(n-2) + 13\,a(n-3) + 11\,a(n-4) - 5\,a(n-5) + 4\,a(n-6) + 9\,a(n-7) - 10\,a(n-8) - 10\,a(n-9) + a(n-11)
\]
for every $n>11$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237854.
