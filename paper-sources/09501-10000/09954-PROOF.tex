...
\title{The empirical recurrence for OEIS A228463, derived from the entry's generating function}
...
\begin{abstract}
OEIS A228463 carries an empirical recurrence of order $7$. The entry separately records a
...
OEIS A228463 is ``Number of arrays of maxima of three adjacent elements of some length 8 0..n array.''. It has offset $1$ and begins
\[
27, 183, 736, 2227, 5615, 12453, 25096, 46941,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 11 2018 09:45:44, revision 11) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{7} + 7 x^{6} - 22 x^{5} + 27 x^{4} - 22 x^{3} + 6 x^{2} - 27 x}{x^{7} - 7 x^{6} + 21 x^{5} - 35 x^{4} + 35 x^{3} - 21 x^{2} + 7 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;x^{7} - 7 x^{6} + 22 x^{5} - 27 x^{4} + 22 x^{3} - 6 x^{2} + 27 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A228463.
