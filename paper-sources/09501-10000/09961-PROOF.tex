...
\title{The empirical recurrence for OEIS A266429, derived from the entry's generating function}
...
\begin{abstract}
OEIS A266429 carries an empirical recurrence of order $7$. The entry separately records a
...
OEIS A266429 is ``Number of 3 X n binary arrays with rows and columns lexicographically nondecreasing and column sums nondecreasing.''. It has offset $1$ and begins
\[
4, 13, 39, 106, 259, 574, 1170, 2223,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 09 2019 14:45:27, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{7} + 7 x^{6} - 21 x^{5} + 34 x^{4} - 32 x^{3} + 15 x^{2} - 4 x}{x^{7} - 7 x^{6} + 21 x^{5} - 35 x^{4} + 35 x^{3} - 21 x^{2} + 7 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;x^{7} - 7 x^{6} + 21 x^{5} - 34 x^{4} + 32 x^{3} - 15 x^{2} + 4 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A266429.
