...
\title{The empirical recurrence for OEIS A253226, proved by transfer matrix}
...
\begin{abstract}
OEIS A253226 counts the arrays over $\{0,\dots,1\}$ whose $2\times2$ subblocks carry a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 10 2018 11:34:46, revision 8) this is still
