...
\title{The empirical recurrence for OEIS A184681, proved by transfer matrix}
...
\begin{abstract}
OEIS A184681 counts arrays over $\{0,\dots,1\}$ under a condition on the determinant of every
...
a bounded window of consecutive rows, so the count is a walk count on $S=32$ states and is
...
OEIS A184681 is ``Number of (n+1) X 5 binary arrays with every 2 X 2 subblock singular.''. It has offset $1$ and begins
\[
208, 2384, 21968, 221968, 2171152, 21547024, 212829840, 2107074576,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 16*a(n-1) - 51*a(n-2) - 190*a(n-3) + 1058*a(n-4) - 848*a(n-5) - 1392*a(n-6) + 1536*a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 14 2018 08:17:44, revision 9) this is still
...
$2\times5$ arrays over $\{0,\dots,1\}$ all of whose subblocks pass. The entry's
first term is $208$, and the model reproduces it along with every later term; that is the
...
\begin{theorem}
\[
a(n)\;=\;16\,a(n-1) - 51\,a(n-2) - 190\,a(n-3) + 1058\,a(n-4) - 848\,a(n-5) - 1392\,a(n-6) + 1536\,a(n-7)
\]
for every $n>6$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A184681.
