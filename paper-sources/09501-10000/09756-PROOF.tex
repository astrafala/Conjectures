...
\title{The empirical recurrence for OEIS A268952, proved by transfer matrix}
...
\begin{abstract}
OEIS A268952 carries an empirical recurrence of order $9$ contributed by R.~H.~Hardin. It is
...
OEIS A268952 is ``Number of length-n 0..4 arrays with no repeated value equal to the previous repeated value, with new values introduced in sequential order.''. It has offset $1$ and begins
\[
1, 2, 4, 12, 40, 153, 634, 2785,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 17 2019 05:26:15, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;11\,a(n-1) - 31\,a(n-2) - 41\,a(n-3) + 268\,a(n-4) - 90\,a(n-5) - 692\,a(n-6) + 512\,a(n-7) + 576\,a(n-8) - 512\,a(n-9)
\]
for every $n>11$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268952.
