...
\title{The empirical recurrence for OEIS A249962, derived from the entry's generating function}
...
\begin{abstract}
OEIS A249962 carries an empirical recurrence of order $8$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 21 2017 08:22:40, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{55 x^{6} + 825 x^{5} + 2080 x^{4} + 1680 x^{3} + 385 x^{2} + 15 x}{x^{8} - 8 x^{7} + 28 x^{6} - 56 x^{5} + 70 x^{4} - 56 x^{3} + 28 x^{2} - 8 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;55 x^{6} + 825 x^{5} + 2080 x^{4} + 1680 x^{3} + 385 x^{2} + 15 x,
\]
