...
\title{The empirical recurrence for OEIS A200842, derived from the entry's generating function}
...
\begin{abstract}
OEIS A200842 carries an empirical recurrence of order $8$. The entry separately records a
...
OEIS A200842 is ``Number of 0..n arrays x(0..6) of 7 elements without any two consecutive increases or two consecutive decreases.''. It has offset $1$ and begins
\[
128, 1465, 8210, 31677, 96690, 250913, 577660, 1212729,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 08:49:33, revision 11) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{8} + 8 x^{7} - 29 x^{6} + 74 x^{5} - 151 x^{4} + 74 x^{3} + 441 x^{2} + 128 x}{x^{8} - 8 x^{7} + 28 x^{6} - 56 x^{5} + 70 x^{4} - 56 x^{3} + 28 x^{2} - 8 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- x^{8} + 8 x^{7} - 29 x^{6} + 74 x^{5} - 151 x^{4} + 74 x^{3} + 441 x^{2} + 128 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A200842.
