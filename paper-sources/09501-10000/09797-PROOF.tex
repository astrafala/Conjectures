...
\title{The empirical recurrence for OEIS A206645, proved by transfer matrix}
...
\begin{abstract}
OEIS A206645 counts arrays of width $3$ over $\{0,1,2\}$ containing no run of $3$ consecutive
...
the count is a walk count on $S=644$ states.
\end{abstract}
...
OEIS A206645 is ``Number of nX3 0..2 arrays with no occurrence of three equal elements in a row horizontally or vertically, and new values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
4, 96, 1625, 30145, 545520, 9937823, 180716227, 3287842038,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n)=15*a(n-1)+66*a(n-2)-145*a(n-3)+13*a(n-4)-64*a(n-5)+156*a(n-6)-36*a(n-7)-8*a(n-9)-8*a(n-10)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 13:03:12, revision 11) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=644,\quad\tau=\mathbf{1} .
\]
...
\begin{theorem}
\[
a(n)\;=\;15\,a(n-1) + 66\,a(n-2) - 145\,a(n-3) + 13\,a(n-4) - 64\,a(n-5) + 156\,a(n-6) - 36\,a(n-7) - 8\,a(n-9) - 8\,a(n-10)
\]
for every $n>10$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206645.
