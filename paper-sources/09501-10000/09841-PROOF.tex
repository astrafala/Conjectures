...
\title{The empirical recurrence for OEIS A249713, derived from the entry's generating function}
...
\begin{abstract}
OEIS A249713 carries an empirical recurrence of order $8$. The entry separately records a
...
OEIS A249713 is ``Number of length 7+3 0..n arrays with every four consecutive terms having the maximum of some two terms equal to the minimum of the remaining two terms.''. It has offset $1$ and begins
\[
72, 1177, 7056, 27113, 80360, 200489, 442144, 888465,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 10 2018 05:46:41, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{8} + 8 x^{7} - 5 x^{6} + 152 x^{5} - 411 x^{4} - 344 x^{3} + 601 x^{2} + 72 x}{x^{8} - 8 x^{7} + 28 x^{6} - 56 x^{5} + 70 x^{4} - 56 x^{3} + 28 x^{2} - 8 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- x^{8} + 8 x^{7} - 5 x^{6} + 152 x^{5} - 411 x^{4} - 344 x^{3} + 601 x^{2} + 72 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A249713.
