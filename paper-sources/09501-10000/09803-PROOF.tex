...
\title{The empirical recurrence for OEIS A199837, derived from the entry's generating function}
...
\begin{abstract}
OEIS A199837 carries an empirical recurrence of order $8$. The entry separately records a
...
OEIS A199837 is ``Number of -n..n arrays x(0..7) of 8 elements with zero sum and no two neighbors summing to zero.''. It has offset $1$ and begins
\[
34, 6126, 113884, 888420, 4340094, 15805218, 47040968, 120843752,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 16 2018 11:19:31, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{112 x^{7} + 9638 x^{6} + 80810 x^{5} + 146972 x^{4} + 65828 x^{3} + 5854 x^{2} + 34 x}{x^{8} - 8 x^{7} + 28 x^{6} - 56 x^{5} + 70 x^{4} - 56 x^{3} + 28 x^{2} - 8 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;112 x^{7} + 9638 x^{6} + 80810 x^{5} + 146972 x^{4} + 65828 x^{3} + 5854 x^{2} + 34 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A199837.
