...
\title{The empirical recurrence for OEIS A236944, proved by transfer matrix}
...
\begin{abstract}
OEIS A236944 counts arrays over $\{0,\dots,3\}$ subject to a condition on the order
...
The condition is local to two consecutive rows, so the count is a walk count on $S=354$
...
OEIS A236944 is ``Number of (n+1)X(3+1) 0..3 arrays with the maximum of every 2X2 subblock equal.''. It has offset $1$ and begins
\[
30698, 4301002, 534626674, 73196854050, 9747614152466, 1323313139705714, 178570730290963762, 24188583189413610834,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 09:41:12, revision 6) this is still
...
array, which is not among the objects counted. There are $S=354$ states left.
...
\begin{theorem}
\[
a(n)\;=\;120\,a(n-1) + 6357\,a(n-2) - 535534\,a(n-3) - 9438006\,a(n-4) + 451376496\,a(n-5) + 4848440936\,a(n-6) - 103326877056\,a(n-7) - 603997054080\,a(n-8) + 5225099461632\,a(n-9) + 18051212537856\,a(n-10) - 16735126487040\,a(n-11) - 31844444405760\,a(n-12) + 26005292974080\,a(n-13)
\]
for every $n>12$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A236944.
