...
\title{The empirical recurrence for OEIS A283573, proved by transfer matrix}
...
\begin{abstract}
OEIS A283573 counts $2\times n$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
walk, and $a(n)$ is a walk count on $S=30$ vertices, which is $C$-finite. Whether the
...
OEIS A283573 is ``Number of 2Xn 0..1 arrays with no 1 equal to more than one of its horizontal, diagonal and antidiagonal neighbors, with the exception of exactly one element.''. It has offset $1$ and begins
\[
0, 4, 26, 72, 282, 908, 2832, 8856,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) +5*a(n-2) +2*a(n-3) -17*a(n-4) -24*a(n-5) -16*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 11 2017 16:15:20, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 5\,a(n-2) + 2\,a(n-3) - 17\,a(n-4) - 24\,a(n-5) - 16\,a(n-6)
\]
for every $n>6$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A283573.
