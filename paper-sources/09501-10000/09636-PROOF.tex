...
\title{The empirical recurrence for OEIS A205911, proved by transfer matrix}
...
\begin{abstract}
OEIS A205911 counts arrays of width $3$ over $\{0,1,2\}$ subject to a condition read round the
...
count is a walk count on a finite digraph with $S=112$ vertices, and whether a linear
...
OEIS A205911 is ``Number of (n+1) X 3 0..2 arrays with every 2 X 2 subblock having the same number of clockwise edge increases as its horizontal neighbors and the same number of counterclockwise edge increases as its vertical neighbors.''. It has offset $1$ and begins
\[
369, 1791, 9831, 60108, 387267, 2554848, 17051166, 114537918,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 10 2015 02:15:26, revision 7) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=112,
\]
...
\begin{theorem}
\[
a(n)\;=\;16\,a(n-1) - 83\,a(n-2) + 110\,a(n-3) + 335\,a(n-4) - 960\,a(n-5) - 146\,a(n-6) + 2173\,a(n-7) - 531\,a(n-8) - 2598\,a(n-9) + 775\,a(n-10) + 2149\,a(n-11) - 993\,a(n-12) - 552\,a(n-13) + 306\,a(n-14)
\]
for every $n>15$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A205911.
