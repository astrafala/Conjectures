...
\title{The empirical recurrence for OEIS A184544, derived from the entry's generating function}
...
\begin{abstract}
OEIS A184544 carries an empirical recurrence of order $8$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 13 2018 11:01:08, revision 11) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 52 x^{8} + 465 x^{7} - 1819 x^{6} + 3955 x^{5} - 5120 x^{4} + 3943 x^{3} - 1680 x^{2} + 309 x}{x^{8} - 8 x^{7} + 28 x^{6} - 56 x^{5} + 70 x^{4} - 56 x^{3} + 28 x^{2} - 8 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 52 x^{8} + 465 x^{7} - 1819 x^{6} + 3955 x^{5} - 5120 x^{4} + 3943 x^{3} - 1680 x^{2} + 309 x,
\]
