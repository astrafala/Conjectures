...
\title{The empirical recurrence for OEIS A193168, derived from the entry's generating function}
...
\begin{abstract}
OEIS A193168 carries an empirical recurrence of order $12$. The entry separately records a
...
OEIS A193168 is ``Number of simple paths from (1, 1) to (n, 3) on an n X 3 grid with king moves allowed.''. It has offset $1$ and begins
\[
1, 24, 235, 2922, 38169, 494596, 6375379, 82191766,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 06 2019 12:39:51, revision 20) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{54 x^{12} + 75 x^{11} - 109 x^{10} + 67 x^{9} + 178 x^{8} - 102 x^{7} - 280 x^{6} - 195 x^{5} + 92 x^{4} + 59 x^{3} - 12 x^{2} - x}{54 x^{12} + 72 x^{11} - 219 x^{10} - 84 x^{9} + 661 x^{8} + 352 x^{7} - 833 x^{6} - 194 x^{5} + 300 x^{4} + 50 x^{3} + 6 x^{2} + 12 x - 1},
\]
the entry's own generating function, and let
\[
D(x)\;=\;1-\sum_i c_i x^{i}\;=\;- 54 x^{12} - 72 x^{11} + 219 x^{10} + 84 x^{9} - 661 x^{8} - 352 x^{7} + 833 x^{6} + 194 x^{5} - 300 x^{4} - 50 x^{3} - 6 x^{2} - 12 x + 1
\]
...
\begin{theorem}
\[
a(n)\;=\;12\,a(n-1) + 6\,a(n-2) + 50\,a(n-3) + 300\,a(n-4) - 194\,a(n-5) - 833\,a(n-6) + 352\,a(n-7) + 661\,a(n-8) - 84\,a(n-9) - 219\,a(n-10) + 72\,a(n-11) + 54\,a(n-12)
\]
for every $n>12$.
\end{theorem}
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 54 x^{12} - 75 x^{11} + 109 x^{10} - 67 x^{9} - 178 x^{8} + 102 x^{7} + 280 x^{6} + 195 x^{5} - 92 x^{4} - 59 x^{3} + 12 x^{2} + x,
\]
...
\[
54 x^{12} + 72 x^{11} - 219 x^{10} - 84 x^{9} + 661 x^{8} + 352 x^{7} - 833 x^{6} - 194 x^{5} + 300 x^{4} + 50 x^{3} + 6 x^{2} + 12 x - 1,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A193168.
