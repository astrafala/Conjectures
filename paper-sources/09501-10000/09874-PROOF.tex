...
\title{The empirical recurrence for OEIS A208383, proved by transfer matrix}
...
\begin{abstract}
OEIS A208383 counts arrays over $\{0,\dots,1\}$ of width $7$ that avoid the patterns
...
OEIS A208383 is ``Number of 7 X n 0..1 arrays avoiding 0 0 0 and 1 1 1 horizontally and 0 0 1 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
14, 196, 216, 1200, 4416, 14976, 60984,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) + 4*a(n-2) + 21*a(n-3) + 14*a(n-4) - 5*a(n-5) + 25*a(n-6) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 02 2018 09:01:42, revision
8) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 4\,a(n-2) + 21\,a(n-3) + 14\,a(n-4) - 5\,a(n-5) + 25\,a(n-6)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208383.
