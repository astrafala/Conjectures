...
\title{The empirical recurrence for OEIS A269587, derived from the entry's generating function}
...
\begin{abstract}
OEIS A269587 carries an empirical recurrence of order $8$. The entry separately records a
...
OEIS A269587 is ``Number of length-7 0..n arrays with no repeated value differing from the previous repeated value by more than one.''. It has offset $1$ and begins
\[
128, 1889, 13946, 67763, 248324, 745013, 1927694, 4453031,\ \dots
\]
...
\begin{quote}
G.f.: x*(128 + 865*x + 2418*x\^{}2 + 1919*x\^{}3 - 116*x\^{}4 - 129*x\^{}5 - 46*x\^{}6 + x\^{}7) / (1 - x)\^{}8.
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 24 2019 17:26:21, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{x^{8} - 46 x^{7} - 129 x^{6} - 116 x^{5} + 1919 x^{4} + 2418 x^{3} + 865 x^{2} + 128 x}{x^{8} - 8 x^{7} + 28 x^{6} - 56 x^{5} + 70 x^{4} - 56 x^{3} + 28 x^{2} - 8 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;x^{8} - 46 x^{7} - 129 x^{6} - 116 x^{5} + 1919 x^{4} + 2418 x^{3} + 865 x^{2} + 128 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269587.
