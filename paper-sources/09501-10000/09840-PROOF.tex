...
\title{The empirical recurrence for OEIS A250375, derived from the entry's generating function}
...
\begin{abstract}
OEIS A250375 carries an empirical recurrence of order $8$. The entry separately records a
...
OEIS A250375 is ``Number of length 2+6 0..n arrays with every seven consecutive terms having the maximum of some three terms equal to the minimum of the remaining four terms.''. It has offset $1$ and begins
\[
151, 3096, 24566, 119235, 428421, 1256106, 3179756, 7202421,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 13 2018 12:48:42, revision 7) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{8} + 8 x^{7} - 114 x^{6} - 417 x^{5} + 939 x^{4} + 4026 x^{3} + 1888 x^{2} + 151 x}{x^{8} - 8 x^{7} + 28 x^{6} - 56 x^{5} + 70 x^{4} - 56 x^{3} + 28 x^{2} - 8 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- x^{8} + 8 x^{7} - 114 x^{6} - 417 x^{5} + 939 x^{4} + 4026 x^{3} + 1888 x^{2} + 151 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250375.
