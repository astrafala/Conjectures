...
\title{The empirical recurrence for OEIS A246893, derived from the entry's generating function}
...
\begin{abstract}
OEIS A246893 carries an empirical recurrence of order $8$. The entry separately records a
...
OEIS A246893 is ``Number of length 1+4 0..n arrays with some pair in every consecutive five terms totalling exactly n.''. It has offset $1$ and begins
\[
30, 231, 900, 2701, 6210, 12931, 23400, 40281,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 07 2018 10:03:24, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{8} + 2 x^{7} - 329 x^{6} - 394 x^{5} - 619 x^{4} - 378 x^{3} - 171 x^{2} - 30 x}{x^{8} - 2 x^{7} - 2 x^{6} + 6 x^{5} - 6 x^{3} + 2 x^{2} + 2 x - 1},
\]
the entry's own generating function, and let
\[
D(x)\;=\;1-\sum_i c_i x^{i}\;=\;- x^{8} + 2 x^{7} + 2 x^{6} - 6 x^{5} + 6 x^{3} - 2 x^{2} - 2 x + 1
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;x^{8} - 2 x^{7} + 329 x^{6} + 394 x^{5} + 619 x^{4} + 378 x^{3} + 171 x^{2} + 30 x,
\]
...
\[
x^{8} - 2 x^{7} - 2 x^{6} + 6 x^{5} - 6 x^{3} + 2 x^{2} + 2 x - 1,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A246893.
