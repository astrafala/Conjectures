...
\title{The empirical recurrence for OEIS A252337, proved by transfer matrix}
...
\begin{abstract}
OEIS A252337 counts $(n+2)\times4$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A252337 is ``Number of (n+2) X (2+2) 0..2 arrays with every 3 X 3 subblock row, column, diagonal and antidiagonal sum not equal to 2 3 or 4.''. It has offset $1$ and begins
\[
108, 268, 810, 2242, 6030, 16676, 46154, 126892,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + 2*a(n-2) + 6*a(n-3) + 5*a(n-4) + a(n-5) - 2*a(n-6) - 2*a(n-7) -a(n-8) for n>9.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 03 2018 08:31:48, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252337.
