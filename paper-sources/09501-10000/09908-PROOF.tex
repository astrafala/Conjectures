...
\title{The empirical recurrence for OEIS A221526, derived from the entry's generating function}
...
\begin{abstract}
OEIS A221526 carries an empirical recurrence of order $7$. The entry separately records a
...
OEIS A221526 is ``Number of 0..n arrays of length 6 with each element differing from at least one neighbor by 2 or more.''. It has offset $1$ and begins
\[
0, 10, 274, 2172, 9982, 33380, 90684, 212812,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 06 2018 07:25:13, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{2 x^{10} - 8 x^{9} + 30 x^{8} - 6 x^{7} + 122 x^{6} - 182 x^{5} - 464 x^{4} - 204 x^{3} - 10 x^{2}}{x^{7} - 7 x^{6} + 21 x^{5} - 35 x^{4} + 35 x^{3} - 21 x^{2} + 7 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 2 x^{10} + 8 x^{9} - 30 x^{8} + 6 x^{7} - 122 x^{6} + 182 x^{5} + 464 x^{4} + 204 x^{3} + 10 x^{2},
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221526.
