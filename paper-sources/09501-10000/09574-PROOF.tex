...
\title{The empirical recurrence for OEIS A237853, proved by transfer matrix}
...
\begin{abstract}
OEIS A237853 counts $(n+1)\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A237853 is ``Number of (n+1) X (2+1) 0..1 arrays with no element greater than all horizontal neighbors or less than all vertical neighbors.''. It has offset $1$ and begins
\[
4, 14, 41, 114, 325, 943, 2731, 7876,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) - 2*a(n-2) + 4*a(n-3) + 2*a(n-4) + a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 14 2026 20:34:45, revision 11) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) - 2\,a(n-2) + 4\,a(n-3) + 2\,a(n-4) + a(n-5)
\]
for every $n>5$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237853.
