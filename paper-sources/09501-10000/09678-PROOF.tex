...
\title{The empirical recurrence for OEIS A262147, derived from the entry's generating function}
...
\begin{abstract}
OEIS A262147 carries an empirical recurrence of order $12$. The entry separately records a
...
OEIS A262147 is ``Numerators of domain values whose images via the flowsnake Q-function follow a spiral trajectory (see comments).''. It has offset $1$ and begins
\[
3, 13, 115, 125, 19, 141, 1011, 1021,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 13 2016 10:24:37, revision 22) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n-1}\;=\;\frac{147 x^{11} + 77 x^{10} + 931 x^{9} + 1421 x^{8} + 371 x^{7} + 861 x^{6} + 141 x^{5} + 19 x^{4} + 125 x^{3} + 115 x^{2} + 13 x + 3}{49 x^{12} - 50 x^{6} + 1},
\]
the entry's own generating function, and let
\[
D(x)\;=\;1-\sum_i c_i x^{i}\;=\;49 x^{12} - 50 x^{6} + 1
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;147 x^{11} + 77 x^{10} + 931 x^{9} + 1421 x^{8} + 371 x^{7} + 861 x^{6} + 141 x^{5} + 19 x^{4} + 125 x^{3} + 115 x^{2} + 13 x + 3,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A262147.
