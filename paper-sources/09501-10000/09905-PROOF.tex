...
\title{The empirical recurrence for OEIS A301787, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A301787 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A301787 is ``Number of nX5 0..1 arrays with every element equal to 0 or 1 horizontally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
8, 14, 25, 45, 82, 150, 275, 505,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) -a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 03 2018 04:16:24, revision 9) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A301787.
