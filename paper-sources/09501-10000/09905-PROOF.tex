...
\title{The empirical recurrence for OEIS A215229, derived from the entry's generating function}
...
\begin{abstract}
OEIS A215229 carries an empirical recurrence of order $7$. The entry separately records a
...
OEIS A215229 is ``Number of length-6 0..k arrays connected end-around, with no sequence of L<n elements immediately followed by itself (periodic "squarefree").''. It has offset $1$ and begins
\[
0, 18, 408, 2940, 12600, 40110, 105168, 240408,\ \dots
\]
...
\begin{quote}
G.f.: 6*x\^{}2*(3 + 47*x + 77*x\^{}2 - 7*x\^{}3) / (1 - x)\^{}7.
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2018 08:44:22, revision 13) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{42 x^{5} - 462 x^{4} - 282 x^{3} - 18 x^{2}}{x^{7} - 7 x^{6} + 21 x^{5} - 35 x^{4} + 35 x^{3} - 21 x^{2} + 7 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 42 x^{5} + 462 x^{4} + 282 x^{3} + 18 x^{2},
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A215229.
