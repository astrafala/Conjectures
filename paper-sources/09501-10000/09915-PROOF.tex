...
\title{The empirical recurrence for OEIS A236993, proved by transfer matrix}
...
\begin{abstract}
OEIS A236993 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
The condition is local to two consecutive rows, so the count is a walk count on $S=7200$
...
OEIS A236993 is ``Number of (n+1)X(4+1) 0..2 arrays with the maximum plus the lower median minus the upper median minus the minimum of every 2X2 subblock differing from its horizontal and vertical neighbors by exactly one.''. It has offset $1$ and begins
\[
7200, 104976, 1513728, 23825664, 363916800, 5454273024, 80675315712, 1304215105536,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 158112*a(n-4) -7941224448*a(n-8) +124128835928064*a(n-12)
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 09:43:58, revision 6) this is still
...
differ by $1$. The entry's first term $7200$ counts those, and the model was made to
...
\]
over the $S=7200$ pairs whose own subblock row already satisfies the condition along itself.
...
\begin{theorem}
\[
a(n)\;=\;158112\,a(n-4) - 7941224448\,a(n-8) + 124128835928064\,a(n-12)
\]
for every $n>12$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A236993.
