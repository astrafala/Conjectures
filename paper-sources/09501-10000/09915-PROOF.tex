...
\title{The empirical recurrence for OEIS A235510, proved by transfer matrix}
...
\begin{abstract}
OEIS A235510 carries an empirical recurrence of order $5$ contributed by R.~H.~Hardin. It is
...
OEIS A235510 is ``Number of (n+1) X (1+1) 0..1 arrays with the sum of each 2 X 2 subblock maximum and minimum lexicographically nondecreasing rowwise and columnwise.''. It has offset $1$ and begins
\[
16, 58, 209, 746, 2660, 9476, 33753, 120216,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) - 6*a(n-3) + a(n-4) + 2*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 19 2018 10:09:39, revision 9) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A235510.
