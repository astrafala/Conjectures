...
\title{The empirical recurrence for OEIS A252206, proved by transfer matrix}
...
\begin{abstract}
OEIS A252206 counts $(n+2)\times6$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
$a(n)$ is a walk count on $S=820794$ vertices. Such a sequence is $C$-finite, so whether a given
...
OEIS A252206 is ``Number of (n+2)X(4+2) 0..3 arrays with every 3X3 subblock row and column sum equal to 1 3 4 6 or 7 and every 3X3 diagonal and antidiagonal sum not equal to 1 3 4 6 or 7.''. It has offset $1$ and begins
\[
19794, 44322, 332462, 1180226, 11207238, 84935426, 301990806, 2868905558,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 260*a(n-3) -1023*a(n-6) -260*a(n-9) +1024*a(n-12) for n>15
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 10:56:09, revision 6) this is still
...
\[
\text{every row, column sum} \in \{1,3,4,6,7\}\ \text{ and }\ \text{every diagonal, antidiagonal sum} \notin \{1,3,4,6,7\}
\]
...
\begin{theorem}
\[
a(n)\;=\;260\,a(n-3) - 1023\,a(n-6) - 260\,a(n-9) + 1024\,a(n-12)
\]
for every $n>15$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252206.
