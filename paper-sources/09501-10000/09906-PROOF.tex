...
\title{The empirical recurrence for OEIS A181271, derived from the entry's generating function}
...
\begin{abstract}
OEIS A181271 carries an empirical recurrence of order $7$. The entry separately records a
...
OEIS A181271 is ``Number of 3 X n binary matrices M with rows in strictly increasing order and rows of M*Mtranspose (mod 2) in strictly increasing order.''. It has offset $1$ and begins
\[
0, 0, 6, 87, 730, 6236, 49400, 398032,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 27 2018 09:36:26, revision 10) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{512 x^{9} + 960 x^{8} - 832 x^{7} - 444 x^{6} + 272 x^{5} - 3 x^{4} - 6 x^{3}}{4096 x^{7} - 3584 x^{6} - 384 x^{5} + 1056 x^{4} - 216 x^{3} - 36 x^{2} + 14 x - 1},
\]
the entry's own generating function, and let
\[
D(x)\;=\;1-\sum_i c_i x^{i}\;=\;- 4096 x^{7} + 3584 x^{6} + 384 x^{5} - 1056 x^{4} + 216 x^{3} + 36 x^{2} - 14 x + 1
\]
...
\begin{theorem}
\[
a(n)\;=\;14\,a(n-1) - 36\,a(n-2) - 216\,a(n-3) + 1056\,a(n-4) - 384\,a(n-5) - 3584\,a(n-6) + 4096\,a(n-7)
\]
for every $n>9$.
\end{theorem}
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 512 x^{9} - 960 x^{8} + 832 x^{7} + 444 x^{6} - 272 x^{5} + 3 x^{4} + 6 x^{3},
\]
...
\[
4096 x^{7} - 3584 x^{6} - 384 x^{5} + 1056 x^{4} - 216 x^{3} - 36 x^{2} + 14 x - 1,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A181271.
