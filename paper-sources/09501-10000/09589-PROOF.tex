...
\title{The empirical recurrence for OEIS A296309, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A296309 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A296309 is ``Number of n X 4 0..1 arrays with each 1 adjacent to 3 or 6 king-move neighboring 1s.''. It has offset $1$ and begins
\[
1, 4, 7, 10, 23, 45, 76, 150,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) + 4*a(n-3) - a(n-4) - 2*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 22 2019 18:55:23, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A296309.
