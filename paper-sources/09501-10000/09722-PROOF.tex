...
\title{The empirical recurrence for OEIS A245876, derived from the entry's generating function}
...
\begin{abstract}
OEIS A245876 carries an empirical recurrence of order $10$. The entry separately records a
...
OEIS A245876 is ``Number of length 7+2 0..n arrays with some pair in every consecutive three terms totalling exactly n.''. It has offset $1$ and begins
\[
110, 2967, 12100, 40901, 97602, 214315, 404264, 727017,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 05 2018 06:34:23, revision 9) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{10} + 2 x^{9} - 224 x^{8} - 1148 x^{7} - 2178 x^{6} + 3456 x^{5} + 8680 x^{4} + 5836 x^{3} + 2747 x^{2} + 110 x}{x^{10} - 2 x^{9} - 3 x^{8} + 8 x^{7} + 2 x^{6} - 12 x^{5} + 2 x^{4} + 8 x^{3} - 3 x^{2} - 2 x + 1},
\]
the entry's own generating function, and let
\[
D(x)\;=\;1-\sum_i c_i x^{i}\;=\;x^{10} - 2 x^{9} - 3 x^{8} + 8 x^{7} + 2 x^{6} - 12 x^{5} + 2 x^{4} + 8 x^{3} - 3 x^{2} - 2 x + 1
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- x^{10} + 2 x^{9} - 224 x^{8} - 1148 x^{7} - 2178 x^{6} + 3456 x^{5} + 8680 x^{4} + 5836 x^{3} + 2747 x^{2} + 110 x,
\]
...
\[
x^{10} - 2 x^{9} - 3 x^{8} + 8 x^{7} + 2 x^{6} - 12 x^{5} + 2 x^{4} + 8 x^{3} - 3 x^{2} - 2 x + 1,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A245876.
