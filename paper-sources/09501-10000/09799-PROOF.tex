...
\title{A local condition on an array: OEIS A202414}
...
\begin{abstract}
OEIS A202414 carries an empirical recurrence of order $4$ contributed by R.~H.~Hardin. It is
...
OEIS A202414 is ``Number of (n+2) X 3 binary arrays with no more than one of any consecutive three bits set in any row or column.''. It has offset $1$ and begins
\[
34, 94, 265, 739, 2059, 5746, 16033, 44728,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) +a(n-2) +3*a(n-3) +a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (May 28 2018 11:48:39, revision 9) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{The count is a walk count}

The entry counts arrays with $3$ columns over the alphabet $\{0,1\}$, growing one row at a time, and asks that no $3$ consecutive entries, taken along a row or down a column, may contain more than $1$ ones.
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + a(n-2) + 3\,a(n-3) + a(n-4)
\]
for every $n>4$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A202414.
