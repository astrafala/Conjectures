...
\title{The empirical recurrence for OEIS A160845, derived from the entry's generating function}
...
\begin{abstract}
OEIS A160845 carries an empirical recurrence of order $8$. The entry separately records a
...
OEIS A160845 is ``Number of lines through at least 2 points of a 5 X n grid of points.''. It has offset $0$ and begins
\[
0, 1, 27, 52, 93, 140, 207, 274,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 19 2021 09:56:49, revision 27) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 5 x^{9} - x^{7} - 16 x^{6} - 20 x^{5} - 40 x^{4} - 25 x^{3} - 26 x^{2} - x}{x^{8} - x^{7} - x^{5} + x^{3} + x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;5 x^{9} + x^{7} + 16 x^{6} + 20 x^{5} + 40 x^{4} + 25 x^{3} + 26 x^{2} + x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A160845.
