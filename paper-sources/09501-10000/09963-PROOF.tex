...
\title{The empirical recurrence for OEIS A245873, derived from the entry's generating function}
...
\begin{abstract}
OEIS A245873 carries an empirical recurrence of order $7$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 05 2018 03:05:18, revision 11) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{7} + 3 x^{6} + 44 x^{5} + 30 x^{4} + 15 x^{3} - 161 x^{2} - 26 x}{x^{7} - 3 x^{6} + x^{5} + 5 x^{4} - 5 x^{3} - x^{2} + 3 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;x^{7} - 3 x^{6} - 44 x^{5} - 30 x^{4} - 15 x^{3} + 161 x^{2} + 26 x,
\]
