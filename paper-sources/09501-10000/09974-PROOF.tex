...
\title{The empirical recurrence for OEIS A237318, proved by transfer matrix}
...
\begin{abstract}
OEIS A237318 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
The condition is local to two consecutive rows, so the count is a walk count on $S=348$
...
OEIS A237318 is ``Number of (n+1)X(2+1) 0..2 arrays with the maximum plus the upper median plus the minimum minus the lower median of every 2X2 subblock differing from its horizontal and vertical neighbors by exactly one.''. It has offset $1$ and begins
\[
348, 2108, 12756, 79360, 485484, 2938226, 17798196, 110739192,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 1400*a(n-4) -6519*a(n-8) +126*a(n-12) for n>14
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 10:04:11, revision 6) this is still
...
differ by $1$. The entry's first term $348$ counts those, and the model was made to
...
\]
over the $S=348$ pairs whose own subblock row already satisfies the condition along itself.
...
\begin{theorem}
\[
a(n)\;=\;1400\,a(n-4) - 6519\,a(n-8) + 126\,a(n-12)
\]
for every $n>14$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237318.
