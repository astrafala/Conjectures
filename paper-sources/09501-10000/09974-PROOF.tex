...
\title{The empirical recurrence for OEIS A250355, derived from the entry's generating function}
...
\begin{abstract}
OEIS A250355 carries an empirical recurrence of order $7$. The entry separately records a
...
OEIS A250355 is ``Number of length 6 arrays x(i), i=1..6 with x(i) in i..i+n and no value appearing more than 2 times.''. It has offset $1$ and begins
\[
64, 622, 3349, 12734, 38543, 99344, 226247, 467642,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 13 2018 08:37:53, revision 7) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 58 x^{10} + 336 x^{9} - 783 x^{8} + 847 x^{7} - 168 x^{6} - 204 x^{5} - 113 x^{4} - 339 x^{3} - 174 x^{2} - 64 x}{x^{7} - 7 x^{6} + 21 x^{5} - 35 x^{4} + 35 x^{3} - 21 x^{2} + 7 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;58 x^{10} - 336 x^{9} + 783 x^{8} - 847 x^{7} + 168 x^{6} + 204 x^{5} + 113 x^{4} + 339 x^{3} + 174 x^{2} + 64 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250355.
