...
\title{The empirical recurrence for OEIS A160848, derived from the entry's generating function}
...
\begin{abstract}
OEIS A160848 carries an empirical recurrence of order $20$. The entry separately records a
...
OEIS A160848 is ``Number of lines through at least 2 points of an 8 X n grid of points.''. It has offset $0$ and begins
\[
0, 1, 66, 131, 238, 361, 534, 709,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 25 2017 11:21:46, revision 13) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 8 x^{21} - 8 x^{20} - 17 x^{19} - 74 x^{18} - 140 x^{17} - 296 x^{16} - 476 x^{15} - 739 x^{14} - 971 x^{13} - 1241 x^{12} - 1374 x^{11} - 1480 x^{10} - 1390 x^{9} - 1273 x^{8} - 1003 x^{7} - 771 x^{6} - 492 x^{5} - 304 x^{4} - 132 x^{3} - 66 x^{2} - x}{x^{20} + x^{18} - x^{15} - x^{14} - 2 x^{13} - x^{12} - x^{11} + x^{9} + x^{8} + 2 x^{7} + x^{6} + x^{5} - x^{2} - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;8 x^{21} + 8 x^{20} + 17 x^{19} + 74 x^{18} + 140 x^{17} + 296 x^{16} + 476 x^{15} + 739 x^{14} + 971 x^{13} + 1241 x^{12} + 1374 x^{11} + 1480 x^{10} + 1390 x^{9} + 1273 x^{8} + 1003 x^{7} + 771 x^{6} + 492 x^{5} + 304 x^{4} + 132 x^{3} + 66 x^{2} + x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A160848.
