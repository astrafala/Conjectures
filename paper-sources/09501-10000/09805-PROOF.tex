...
\title{The empirical recurrence for OEIS A212840, derived from the entry's generating function}
...
\begin{abstract}
OEIS A212840 carries an empirical recurrence of order $8$. The entry separately records a
...
OEIS A212840 is ``Number of 0..n arrays of length 7 with 0 never adjacent to n.''. It has offset $1$ and begins
\[
2, 577, 8042, 49835, 204994, 654797, 1758602, 4159927,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 21 2018 10:06:45, revision 9) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{x^{8} - 18 x^{7} + 151 x^{6} - 682 x^{5} + 1543 x^{4} + 3482 x^{3} + 561 x^{2} + 2 x}{x^{8} - 8 x^{7} + 28 x^{6} - 56 x^{5} + 70 x^{4} - 56 x^{3} + 28 x^{2} - 8 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;x^{8} - 18 x^{7} + 151 x^{6} - 682 x^{5} + 1543 x^{4} + 3482 x^{3} + 561 x^{2} + 2 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A212840.
