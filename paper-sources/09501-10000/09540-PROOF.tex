...
\title{The empirical recurrence for OEIS A188988, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A188988 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A188988 is ``Number of n X 5 binary arrays without the pattern 0 0 1 antidiagonally or horizontally.''. It has offset $1$ and begins
\[
20, 400, 5304, 68064, 852448, 10682432, 133744640, 1674569728,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 13*a(n-1) +4*a(n-2) -132*a(n-3) +60*a(n-4) +320*a(n-5) -240*a(n-6) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (May 01 2018 09:39:01, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A188988.
