...
\title{The empirical recurrence for OEIS A248457, proved by transfer matrix}
...
\begin{abstract}
OEIS A248457 carries an empirical recurrence of order $6$ contributed by R.~H.~Hardin. It is
...
OEIS A248457 is ``Number of length n+2 0..4 arrays with no three consecutive terms having the sum of any two elements equal to twice the third.''. It has offset $1$ and begins
\[
96, 380, 1512, 6040, 24160, 96736, 387488, 1552448,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) + 5*a(n-2) + 2*a(n-3) - 16*a(n-4) - 28*a(n-5) - 8*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 08 2018 19:08:49, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A248457.
