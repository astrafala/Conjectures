...
\title{The empirical recurrence for OEIS A254703, derived from the entry's generating function}
...
\begin{abstract}
OEIS A254703 carries an empirical recurrence of order $8$. The entry separately records a
...
OEIS A254703 is ``Number of length 5+4 0..n arrays with every five consecutive terms having the maximum of some two terms equal to the minimum of the remaining three terms.''. It has offset $1$ and begins
\[
136, 2310, 16276, 72271, 242076, 670372, 1618264, 3520845,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 18 2018 09:24:41, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{8} + 8 x^{7} - 20 x^{6} - 204 x^{5} - 873 x^{4} + 1604 x^{3} + 1222 x^{2} + 136 x}{x^{8} - 8 x^{7} + 28 x^{6} - 56 x^{5} + 70 x^{4} - 56 x^{3} + 28 x^{2} - 8 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- x^{8} + 8 x^{7} - 20 x^{6} - 204 x^{5} - 873 x^{4} + 1604 x^{3} + 1222 x^{2} + 136 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A254703.
