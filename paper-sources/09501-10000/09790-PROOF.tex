...
\title{The empirical recurrence for OEIS A254705, derived from the entry's generating function}
...
\begin{abstract}
OEIS A254705 carries an empirical recurrence of order $9$. The entry separately records a
...
OEIS A254705 is ``Number of length 7+4 0..n arrays with every five consecutive terms having the maximum of some two terms equal to the minimum of the remaining three terms.''. It has offset $1$ and begins
\[
334, 9106, 87892, 489135, 1954106, 6255136, 17080712, 41376909,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 17 2018 14:50:53, revision 7) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{9} + 9 x^{8} - 56 x^{7} + 614 x^{6} + 6817 x^{5} + 2133 x^{4} - 17962 x^{3} - 6100 x^{2} - 334 x}{x^{9} - 9 x^{8} + 36 x^{7} - 84 x^{6} + 126 x^{5} - 126 x^{4} + 84 x^{3} - 36 x^{2} + 9 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;x^{9} - 9 x^{8} + 56 x^{7} - 614 x^{6} - 6817 x^{5} - 2133 x^{4} + 17962 x^{3} + 6100 x^{2} + 334 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A254705.
