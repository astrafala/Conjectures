...
\title{The empirical recurrence for OEIS A250084, derived from the entry's generating function}
...
\begin{abstract}
OEIS A250084 carries an empirical recurrence of order $8$. The entry separately records a
...
OEIS A250084 is ``Number of length 3+5 0..n arrays with every six consecutive terms having the maximum of some two terms equal to the minimum of the remaining four terms.''. It has offset $1$ and begins
\[
144, 2228, 15472, 68863, 232096, 647122, 1572320, 3441309,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 11 2018 09:55:50, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{8} + 8 x^{7} - 18 x^{6} - 280 x^{5} - 593 x^{4} + 1680 x^{3} + 1076 x^{2} + 144 x}{x^{8} - 8 x^{7} + 28 x^{6} - 56 x^{5} + 70 x^{4} - 56 x^{3} + 28 x^{2} - 8 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- x^{8} + 8 x^{7} - 18 x^{6} - 280 x^{5} - 593 x^{4} + 1680 x^{3} + 1076 x^{2} + 144 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250084.
