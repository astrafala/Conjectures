...
\title{The empirical recurrence for OEIS A221577, derived from the entry's generating function}
...
\begin{abstract}
OEIS A221577 carries an empirical recurrence of order $8$. The entry separately records a
...
OEIS A221577 is ``Number of 0..n arrays of length 7 with each element differing from at least one neighbor by something other than 1.''. It has offset $1$ and begins
\[
16, 345, 4240, 26911, 117104, 395641, 1116400, 2754635,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 08 2018 15:10:29, revision 7) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 20 x^{10} + 160 x^{9} - 579 x^{8} + 1096 x^{7} - 1869 x^{6} + 2336 x^{5} + 1755 x^{4} + 1928 x^{3} + 217 x^{2} + 16 x}{x^{8} - 8 x^{7} + 28 x^{6} - 56 x^{5} + 70 x^{4} - 56 x^{3} + 28 x^{2} - 8 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 20 x^{10} + 160 x^{9} - 579 x^{8} + 1096 x^{7} - 1869 x^{6} + 2336 x^{5} + 1755 x^{4} + 1928 x^{3} + 217 x^{2} + 16 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221577.
