...
\title{The empirical recurrence for OEIS A200890, derived from the entry's generating function}
...
\begin{abstract}
OEIS A200890 carries an empirical recurrence of order $8$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 16 2017 10:50:01, revision 9) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{8} + 8 x^{7} - 27 x^{6} + 48 x^{5} - 224 x^{4} + 11 x^{3} + 184 x^{2} + 65 x}{x^{8} - 8 x^{7} + 28 x^{6} - 56 x^{5} + 70 x^{4} - 56 x^{3} + 28 x^{2} - 8 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- x^{8} + 8 x^{7} - 27 x^{6} + 48 x^{5} - 224 x^{4} + 11 x^{3} + 184 x^{2} + 65 x,
\]
