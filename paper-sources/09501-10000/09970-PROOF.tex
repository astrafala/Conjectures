...
\title{The empirical recurrence for OEIS A250083, derived from the entry's generating function}
...
\begin{abstract}
OEIS A250083 carries an empirical recurrence of order $7$. The entry separately records a
...
OEIS A250083 is ``Number of length 2+5 0..n arrays with every six consecutive terms having the maximum of some two terms equal to the minimum of the remaining four terms.''. It has offset $1$ and begins
\[
83, 982, 5604, 21405, 63611, 159278, 352192, 708609,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 11 2018 09:18:28, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{7} + 7 x^{6} + 5 x^{5} + 106 x^{4} - 473 x^{3} - 401 x^{2} - 83 x}{x^{7} - 7 x^{6} + 21 x^{5} - 35 x^{4} + 35 x^{3} - 21 x^{2} + 7 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;x^{7} - 7 x^{6} - 5 x^{5} - 106 x^{4} + 473 x^{3} + 401 x^{2} + 83 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250083.
