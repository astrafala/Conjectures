...
\title{The empirical recurrence for OEIS A200791, derived from the entry's generating function}
...
\begin{abstract}
OEIS A200791 carries an empirical recurrence of order $10$. The entry separately records a
...
OEIS A200791 is ``Number of 0..n arrays x(0..8) of 9 elements without any two consecutive increases.''. It has offset $1$ and begins
\[
512, 14849, 163020, 1062500, 4975322, 18514405, 58154912, 160338680,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 15 2017 20:28:31, revision 10) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{10} + 10 x^{9} - 45 x^{8} + 124 x^{7} + 551 x^{6} + 11862 x^{5} + 39065 x^{4} + 37570 x^{3} + 9729 x^{2} + 512 x}{x^{10} - 10 x^{9} + 45 x^{8} - 120 x^{7} + 210 x^{6} - 252 x^{5} + 210 x^{4} - 120 x^{3} + 45 x^{2} - 10 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- x^{10} + 10 x^{9} - 45 x^{8} + 124 x^{7} + 551 x^{6} + 11862 x^{5} + 39065 x^{4} + 37570 x^{3} + 9729 x^{2} + 512 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A200791.
