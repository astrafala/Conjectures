...
\title{The empirical recurrence for OEIS A237474, proved by transfer matrix}
...
\begin{abstract}
OEIS A237474 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
OEIS A237474 is ``Number of (n+1)X(1+1) 0..2 arrays with the maximum plus the lower median of every 2X2 subblock equal.''. It has offset $1$ and begins
\[
81, 331, 1337, 5819, 25665, 116187, 532185, 2467403,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 10:11:47, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-1) + 8\,a(n-2) - 176\,a(n-3) + 86\,a(n-4) + 1544\,a(n-5) - 1268\,a(n-6) - 6840\,a(n-7) + 5915\,a(n-8) + 15792\,a(n-9) - 13396\,a(n-10) - 17304\,a(n-11) + 15632\,a(n-12) + 6016\,a(n-13) - 7552\,a(n-14) + 1536\,a(n-15)
\]
for every $n>14$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237474.
