...
\title{The empirical recurrence for OEIS A183908, derived from the entry's generating function}
...
\begin{abstract}
OEIS A183908 carries an empirical recurrence of order $6$. The entry separately records a
...
OEIS A183908 is ``Number of nondecreasing arrangements of n+2 numbers in 0..5 with each number being the sum mod 6 of two others.''. It has offset $1$ and begins
\[
2, 8, 37, 124, 309, 637, 1163, 1953,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 06 2018 06:21:20, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 4 x^{8} + 5 x^{7} + 11 x^{6} - 10 x^{5} - 18 x^{4} + 19 x^{3} - 4 x^{2} + 2 x}{x^{6} - 6 x^{5} + 15 x^{4} - 20 x^{3} + 15 x^{2} - 6 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 4 x^{8} + 5 x^{7} + 11 x^{6} - 10 x^{5} - 18 x^{4} + 19 x^{3} - 4 x^{2} + 2 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A183908.
