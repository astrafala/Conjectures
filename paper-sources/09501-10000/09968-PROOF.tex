...
\title{The empirical recurrence for OEIS A249986, derived from the entry's generating function}
...
\begin{abstract}
OEIS A249986 carries an empirical recurrence of order $7$. The entry separately records a
...
OEIS A249986 is ``Number of length 6+1 0..2*n arrays with the sum of the absolute values of adjacent differences equal to 6*n.''. It has offset $1$ and begins
\[
466, 7138, 43068, 168506, 508902, 1290856, 2886016, 5862924,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 10 2018 09:08:52, revision 7) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{168 x^{6} - 268 x^{5} - 618 x^{4} - 2888 x^{3} - 3876 x^{2} - 466 x}{x^{7} - 7 x^{6} + 21 x^{5} - 35 x^{4} + 35 x^{3} - 21 x^{2} + 7 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 168 x^{6} + 268 x^{5} + 618 x^{4} + 2888 x^{3} + 3876 x^{2} + 466 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A249986.
