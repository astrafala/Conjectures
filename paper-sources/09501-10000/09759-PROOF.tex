...
\title{The empirical recurrence for OEIS A225895, derived from the entry's generating function}
...
\begin{abstract}
OEIS A225895 carries an empirical recurrence of order $9$. The entry separately records a
...
OEIS A225895 is ``Number of n X 3 binary arrays whose sum with another n X 3 binary array containing no more than a single 1 has rows and columns in lexicographically nondecreasing order.''. It has offset $1$ and begins
\[
7, 33, 145, 545, 1770, 5052, 12910, 30055,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 05 2018 14:54:12, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 3 x^{9} + 23 x^{8} - 82 x^{7} + 162 x^{6} - 195 x^{5} + 160 x^{4} - 100 x^{3} + 30 x^{2} - 7 x}{x^{9} - 9 x^{8} + 36 x^{7} - 84 x^{6} + 126 x^{5} - 126 x^{4} + 84 x^{3} - 36 x^{2} + 9 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;3 x^{9} - 23 x^{8} + 82 x^{7} - 162 x^{6} + 195 x^{5} - 160 x^{4} + 100 x^{3} - 30 x^{2} + 7 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A225895.
