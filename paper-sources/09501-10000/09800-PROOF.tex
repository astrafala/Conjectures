...
\title{The empirical recurrence for OEIS A298215, proved by transfer matrix}
...
\begin{abstract}
OEIS A298215 counts $2$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A298215 is ``Number of nX2 0..1 arrays with every element equal to 0, 1, 2, 4 or 5 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
2, 7, 13, 29, 73, 157, 353, 869,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 4*a(n-1) -5*a(n-2) +10*a(n-3) -24*a(n-4) +16*a(n-5) for n>6
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 15 2018 08:04:59, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) - 5\,a(n-2) + 10\,a(n-3) - 24\,a(n-4) + 16\,a(n-5)
\end{equation}
for all $n>6$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A298215.
