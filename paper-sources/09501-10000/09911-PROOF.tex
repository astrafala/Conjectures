...
\title{The empirical recurrence for OEIS A296646, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A296646 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A296646 is ``Number of n X 3 0..1 arrays with each 1 adjacent to 0, 1 or 3 king-move neighboring 1s.''. It has offset $1$ and begins
\[
7, 29, 111, 468, 1985, 8126, 33933, 141664,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) + 6*a(n-2) + 18*a(n-3) - 12*a(n-4) - 42*a(n-5) - 17*a(n- 6) + 9*a(n-7) + 7*a(n-8) + 13*a(n-9) + 2*a(n-10).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 24 2019 09:10:33, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 6\,a(n-2) + 18\,a(n-3) - 12\,a(n-4) - 42\,a(n-5) - 17\,a(n-6) + 9\,a(n-7) + 7\,a(n-8) + 13\,a(n-9) + 2\,a(n-10)
\end{equation}
for all $n>11$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A296646.
