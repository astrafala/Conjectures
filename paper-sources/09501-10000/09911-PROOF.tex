...
\title{The empirical recurrence for OEIS A205345, derived from the entry's generating function}
...
\begin{abstract}
OEIS A205345 carries an empirical recurrence of order $7$. The entry separately records a
...
OEIS A205345 is ``Number of length 8 nonnegative integer arrays starting and ending with 0 with adjacent elements unequal but differing by no more than n.''. It has offset $1$ and begins
\[
0, 272, 3272, 18652, 71630, 214724, 542850, 1211784,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 11 2018 12:33:48, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 6 x^{6} - 258 x^{5} - 1460 x^{4} - 1368 x^{3} - 272 x^{2}}{x^{7} - 7 x^{6} + 21 x^{5} - 35 x^{4} + 35 x^{3} - 21 x^{2} + 7 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;6 x^{6} + 258 x^{5} + 1460 x^{4} + 1368 x^{3} + 272 x^{2},
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A205345.
