...
\title{The empirical recurrence for OEIS A183909, derived from the entry's generating function}
...
\begin{abstract}
OEIS A183909 carries an empirical recurrence of order $7$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 06 2018 07:00:59, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 4 x^{10} + 9 x^{9} + 16 x^{8} - 40 x^{7} - 3 x^{6} + 20 x^{5} + 32 x^{4} - 36 x^{3} + 6 x^{2} - x}{x^{7} - 7 x^{6} + 21 x^{5} - 35 x^{4} + 35 x^{3} - 21 x^{2} + 7 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;4 x^{10} - 9 x^{9} - 16 x^{8} + 40 x^{7} + 3 x^{6} - 20 x^{5} - 32 x^{4} + 36 x^{3} - 6 x^{2} + x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A183909.
