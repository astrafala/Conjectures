...
\title{The empirical recurrence for OEIS A232902, proved by transfer matrix}
...
\begin{abstract}
OEIS A232902 counts arrays of width $3$ over $\{0,\dots,2\}$ under a condition on each cell
...
OEIS A232902 is ``Number of (n+1) X (2+1) 0..2 arrays with every element next to itself plus and minus one within the range 0..2 horizontally or antidiagonally.''. It has offset $1$ and begins
\[
10, 34, 194, 1034, 4986, 24498, 122994, 613658,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) - a(n-2) + 26*a(n-3) + 16*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 06 2018 03:53:04, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232902.
