...
\title{The empirical recurrence for OEIS A245945, proved by transfer matrix}
...
\begin{abstract}
OEIS A245945 carries an empirical recurrence of order $9$ contributed by R.~H.~Hardin. It is
...
OEIS A245945 is ``Number of length n+3 0..2 arrays with some pair in every consecutive four terms totalling exactly 2.''. It has offset $1$ and begins
\[
71, 197, 545, 1501, 4145, 11441, 31577, 87161,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + 2*a(n-2) + a(n-3) - a(n-4) - 2*a(n-5) - 2*a(n-6) - a(n-7) + a(n-8) + a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 05 2018 06:33:59, revision 11) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 2\,a(n-2) + a(n-3) - a(n-4) - 2\,a(n-5) - 2\,a(n-6) - a(n-7) + a(n-8) + a(n-9)
\]
for every $n>-2$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A245945.
