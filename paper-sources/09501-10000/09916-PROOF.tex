...
\title{The empirical recurrence for OEIS A199836, derived from the entry's generating function}
...
\begin{abstract}
OEIS A199836 carries an empirical recurrence of order $7$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 16 2018 11:19:41, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 64 x^{6} - 2334 x^{5} - 10480 x^{4} - 9152 x^{3} - 1496 x^{2} - 22 x}{x^{7} - 7 x^{6} + 21 x^{5} - 35 x^{4} + 35 x^{3} - 21 x^{2} + 7 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;64 x^{6} + 2334 x^{5} + 10480 x^{4} + 9152 x^{3} + 1496 x^{2} + 22 x,
\]
