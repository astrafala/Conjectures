...
\title{The empirical recurrence for OEIS A249961, derived from the entry's generating function}
...
\begin{abstract}
OEIS A249961 carries an empirical recurrence of order $7$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 21 2017 06:22:26, revision 7) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 15 x^{5} - 180 x^{4} - 330 x^{3} - 180 x^{2} - 15 x}{x^{7} - 7 x^{6} + 21 x^{5} - 35 x^{4} + 35 x^{3} - 21 x^{2} + 7 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;15 x^{5} + 180 x^{4} + 330 x^{3} + 180 x^{2} + 15 x,
\]
