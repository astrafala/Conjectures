...
\title{The empirical recurrence for OEIS A257445, proved by transfer matrix}
...
\begin{abstract}
OEIS A257445 counts $(n+2)\times8$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A257445 is ``Number of (n+2) X (6+2) 0..1 arrays with no 3 x 3 subblock diagonal sum 0 and no antidiagonal sum 3 and no row sum 1 and no column sum 1.''. It has offset $1$ and begins
\[
90, 95, 104, 116, 134, 161, 200, 257,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) - a(n-2) + a(n-3) - a(n-4) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 21 2018 09:05:12, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A257445.
