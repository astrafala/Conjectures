...
\title{The empirical recurrence for OEIS A267474, derived from the entry's generating function}
...
\begin{abstract}
OEIS A267474 carries an empirical recurrence of order $7$. The entry separately records a
...
OEIS A267474 is ``Number of length-6 0..n arrays with no following elements larger than the first repeated value.''. It has offset $1$ and begins
\[
38, 418, 2490, 10119, 31880, 83972, 193852, 404589,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 05 2018 09:36:32, revision 7) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{7} + 7 x^{6} - 37 x^{5} - 137 x^{4} - 362 x^{3} - 152 x^{2} - 38 x}{x^{7} - 7 x^{6} + 21 x^{5} - 35 x^{4} + 35 x^{3} - 21 x^{2} + 7 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;x^{7} - 7 x^{6} + 37 x^{5} + 137 x^{4} + 362 x^{3} + 152 x^{2} + 38 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267474.
