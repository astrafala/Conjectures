...
\title{A condition on every subblock: the empirical recurrence for OEIS A183805}
...
\begin{abstract}
OEIS A183805 carries an empirical recurrence of order $5$ contributed by R.~H.~Hardin. It is
...
OEIS A183805 is ``1/16 the number of (n+1) X 4 binary arrays with no 2 X 2 subblock being a reflection across the shared element pair of any horizontal or vertical neighbor.''. It has offset $1$ and begins
\[
9, 55, 322, 1953, 11619, 70044, 418925, 2518389,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 6*a(n-1) + 12*a(n-2) - 83*a(n-3) + 56*a(n-4) + 60*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 05 2018 03:05:13, revision 12) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{The count is a walk count}

The entry counts arrays with $4$ columns over the alphabet $\{0,1\}$, growing one row at a time, and the condition it imposes is that no $2\times2$ subblock may be the mirror image of the subblock beside it or the subblock below it, reflected in the line the two share.
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) + 12\,a(n-2) - 83\,a(n-3) + 56\,a(n-4) + 60\,a(n-5)
\]
for every $n>5$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A183805.
