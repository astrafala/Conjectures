...
\title{The empirical recurrence for OEIS A199902, derived from the entry's generating function}
...
\begin{abstract}
OEIS A199902 carries an empirical recurrence of order $7$. The entry separately records a
...
OEIS A199902 is ``Number of -n..n arrays x(0..6) of 7 elements with zero sum, and adjacent elements not both strictly positive and not both strictly negative.''. It has offset $1$ and begins
\[
171, 1783, 8823, 30199, 82555, 193689, 406575, 783989,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 17 2018 06:35:05, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{7} + 8 x^{6} - 25 x^{5} + 104 x^{4} + 67 x^{3} - 586 x^{2} - 171 x}{x^{7} - 7 x^{6} + 21 x^{5} - 35 x^{4} + 35 x^{3} - 21 x^{2} + 7 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;x^{7} - 8 x^{6} + 25 x^{5} - 104 x^{4} - 67 x^{3} + 586 x^{2} + 171 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A199902.
