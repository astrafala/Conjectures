...
\title{The empirical recurrence for OEIS A228744, derived from the entry's generating function}
...
\begin{abstract}
OEIS A228744 carries an empirical recurrence of order $8$. The entry separately records a
...
OEIS A228744 is ``Number of arrays of the median of three adjacent elements of some length 9 0..n array.''. It has offset $1$ and begins
\[
88, 1071, 6130, 23627, 71278, 181885, 410828, 845517,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 17 2018 05:45:47, revision 15) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{8} + 8 x^{7} - 21 x^{6} + 86 x^{5} - 353 x^{4} + 26 x^{3} + 367 x^{2} + 88 x}{x^{8} - 8 x^{7} + 28 x^{6} - 56 x^{5} + 70 x^{4} - 56 x^{3} + 28 x^{2} - 8 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- x^{8} + 8 x^{7} - 21 x^{6} + 86 x^{5} - 353 x^{4} + 26 x^{3} + 367 x^{2} + 88 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A228744.
