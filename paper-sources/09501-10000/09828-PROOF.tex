...
\title{The empirical recurrence for OEIS A228224, derived from the entry's generating function}
...
\begin{abstract}
OEIS A228224 carries an empirical recurrence of order $8$. The entry separately records a
...
OEIS A228224 is ``Number of second differences of arrays of length 9 of numbers in 0..n.''. It has offset $1$ and begins
\[
511, 19171, 242461, 1688101, 8006491, 29066311, 86929081, 224817481,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 10 2018 08:52:30, revision 10) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{8} - 40313 x^{7} + 16749 x^{6} + 252785 x^{5} + 256585 x^{4} + 103401 x^{3} + 15083 x^{2} + 511 x}{x^{8} - 8 x^{7} + 28 x^{6} - 56 x^{5} + 70 x^{4} - 56 x^{3} + 28 x^{2} - 8 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- x^{8} - 40313 x^{7} + 16749 x^{6} + 252785 x^{5} + 256585 x^{4} + 103401 x^{3} + 15083 x^{2} + 511 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A228224.
