...
\title{The empirical recurrence for OEIS A252378, proved by transfer matrix}
...
\begin{abstract}
OEIS A252378 counts $(n+2)\times4$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252378 is ``Number of (n+2) X (2+2) 0..3 arrays with every 3 X 3 subblock row and diagonal sum equal to 0 3 5 6 or 7 and every 3 X 3 column and antidiagonal sum not equal to 0 3 5 6 or 7.''. It has offset $1$ and begins
\[
897, 555, 529, 570, 637, 764, 903, 1117,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-3) - 4*a(n-6) + a(n-9) for n>15.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 03 2018 08:31:38, revision 8) this is still
...
\[
\text{every row, diagonal sum} \in \{0,3,5,6,7\}\ \text{ and }\ \text{every column, antidiagonal sum} \notin \{0,3,5,6,7\}
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252378.
