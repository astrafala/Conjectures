...
\title{The empirical recurrence for OEIS A228505, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A228505 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A228505 is ``Number of nX7 binary arrays with top left value 1 and no two ones adjacent horizontally, vertically, diagonally or antidiagonally.''. It has offset $1$ and begins
\[
13, 43, 684, 4749, 49101, 413786, 3862849, 34229311,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 04 2025 00:04:35, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) + 50\,a(n-2) - 171\,a(n-3) - 514\,a(n-4) + 1800\,a(n-5) + 845\,a(n-6) - 5430\,a(n-7) + 704\,a(n-8) + 6175\,a(n-9) - 1762\,a(n-10) - 2810\,a(n-11) + 870\,a(n-12) + 392\,a(n-13) - 120\,a(n-14)
\end{equation}
for all $n>14$.
...
publishes, $n=18$, the arrays have $7\cdot18$ cells over
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A228505.
