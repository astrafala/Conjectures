...
\title{The empirical recurrence for OEIS A250392, derived from the entry's generating function}
...
\begin{abstract}
OEIS A250392 carries an empirical recurrence of order $10$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 20 2017 23:30:15, revision 10) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{1098 x^{8} + 19384 x^{7} + 90886 x^{6} + 146990 x^{5} + 86422 x^{4} + 17188 x^{3} + 906 x^{2} + 6 x}{x^{10} - 10 x^{9} + 45 x^{8} - 120 x^{7} + 210 x^{6} - 252 x^{5} + 210 x^{4} - 120 x^{3} + 45 x^{2} - 10 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;1098 x^{8} + 19384 x^{7} + 90886 x^{6} + 146990 x^{5} + 86422 x^{4} + 17188 x^{3} + 906 x^{2} + 6 x,
\]
