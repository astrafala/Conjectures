...
\title{The empirical recurrence for OEIS A206057, proved by transfer matrix}
...
\begin{abstract}
OEIS A206057 counts arrays over $\{0,\dots,3\}$ under a condition on the perimeter cycle of
every $2\times3$ and $3\times2$ subblock, and carries an empirical recurrence of order $12$ contributed by
R.~H.~Hardin. It is true, and it is decidable rather than empirical. The condition is local to
a bounded window of consecutive rows, so the count is a walk count on $S=2184$ states and is
...
OEIS A206057 is ``Number of (n+1)X3 0..3 arrays with every 2X3 or 3X2 subblock having exactly two clockwise edge increases.''. It has offset $1$ and begins
\[
2184, 21140, 167960, 1390488, 11638960, 96831504, 805817696, 6714115792,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 12:25:30, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + 20\,a(n-2) + 189\,a(n-3) + 102\,a(n-4) + 187\,a(n-5) - 612\,a(n-6) - 110\,a(n-7) + 186\,a(n-8) + 82\,a(n-9) + 43\,a(n-10) - 5\,a(n-11) - 16\,a(n-12)
\]
for every $n>17$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206057.
