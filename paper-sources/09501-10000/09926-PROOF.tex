...
\title{The empirical recurrence for OEIS A221518, derived from the entry's generating function}
...
\begin{abstract}
OEIS A221518 carries an empirical recurrence of order $7$. The entry separately records a
...
OEIS A221518 is ``Number of 0..n arrays of length 7 with each element differing from at least one neighbor by 2 or more, starting with 0.''. It has offset $1$ and begins
\[
0, 8, 248, 2088, 9940, 33860, 92934, 219352,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 06 2018 07:25:21, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{6 x^{10} - 38 x^{9} + 98 x^{8} - 86 x^{7} + 272 x^{6} - 252 x^{5} - 520 x^{4} - 192 x^{3} - 8 x^{2}}{x^{7} - 7 x^{6} + 21 x^{5} - 35 x^{4} + 35 x^{3} - 21 x^{2} + 7 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 6 x^{10} + 38 x^{9} - 98 x^{8} + 86 x^{7} - 272 x^{6} + 252 x^{5} + 520 x^{4} + 192 x^{3} + 8 x^{2},
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221518.
