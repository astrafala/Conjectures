...
\title{The empirical recurrence for OEIS A026155, derived from the entry's generating function}
...
\begin{abstract}
OEIS A026155 carries an empirical recurrence of order $12$. The entry separately records a
...
OEIS A026155 is ``T(n,n-4), where T is the array in A026148.''. It has offset $4$ and begins
\[
1, 4, 16, 56, 189, 616, 1967, 6182,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 23 2020 21:46:44, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{x^{12} - 8 x^{11} + 28 x^{9} - 21 x^{8} - 14 x^{7} + 21 x^{6} - 8 x^{5} + x^{4}}{7 x^{12} - 14 x^{11} - 77 x^{10} + 84 x^{9} + 203 x^{8} - 224 x^{7} - 160 x^{6} + 256 x^{5} - 26 x^{4} - 90 x^{3} + 53 x^{2} - 12 x + 1},
\]
the entry's own generating function, and let
\[
D(x)\;=\;1-\sum_i c_i x^{i}\;=\;7 x^{12} - 14 x^{11} - 77 x^{10} + 84 x^{9} + 203 x^{8} - 224 x^{7} - 160 x^{6} + 256 x^{5} - 26 x^{4} - 90 x^{3} + 53 x^{2} - 12 x + 1
\]
...
\begin{theorem}
\[
a(n)\;=\;12\,a(n-1) - 53\,a(n-2) + 90\,a(n-3) + 26\,a(n-4) - 256\,a(n-5) + 160\,a(n-6) + 224\,a(n-7) - 203\,a(n-8) - 84\,a(n-9) + 77\,a(n-10) + 14\,a(n-11) - 7\,a(n-12)
\]
for every $n>12$.
\end{theorem}
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;x^{12} - 8 x^{11} + 28 x^{9} - 21 x^{8} - 14 x^{7} + 21 x^{6} - 8 x^{5} + x^{4},
\]
...
\[
7 x^{12} - 14 x^{11} - 77 x^{10} + 84 x^{9} + 203 x^{8} - 224 x^{7} - 160 x^{6} + 256 x^{5} - 26 x^{4} - 90 x^{3} + 53 x^{2} - 12 x + 1,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A026155.
