...
\title{The empirical recurrence for OEIS A250725, proved by transfer matrix}
...
\begin{abstract}
OEIS A250725 counts arrays over $\{0,1\}$ in which a statistic taken over short runs
...
OEIS A250725 is ``Number of (n+1) X (4+1) 0..1 arrays with nondecreasing x(i,j)+x(i,j-1) in the i direction and nondecreasing min(x(i,j),x(i-1,j)) in the j direction.''. It has offset $1$ and begins
\[
114, 257, 496, 885, 1500, 2434, 3807, 5760,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 5*a(n-1) - 9*a(n-2) + 5*a(n-3) + 5*a(n-4) - 9*a(n-5) + 5*a(n-6) - a(n-7) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 16 2018 07:51:10, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250725.
