...
\title{The empirical recurrence for OEIS A253230, proved by transfer matrix}
...
\begin{abstract}
OEIS A253230 counts the arrays over $\{0,\dots,1\}$ whose $2\times2$ subblocks carry a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 11 2018 08:59:38, revision 8) this is still
