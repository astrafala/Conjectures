...
\title{The empirical recurrence for OEIS A227638, derived from the entry's generating function}
...
\begin{abstract}
OEIS A227638 carries an empirical recurrence of order $10$. The entry separately records a
...
OEIS A227638 is ``Number of n X 3 0,1 arrays indicating 2 X 2 subblocks of some larger (n+1) X 4 binary array having determinant equal to one, with rows and columns of the latter in nondecreasing lexicographic order.''. It has offset $1$ and begins
\[
3, 11, 39, 127, 377, 1014, 2518, 5844,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 09 2018 09:23:40, revision 7) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{2 x^{13} - 13 x^{12} + 49 x^{11} - 107 x^{10} + 151 x^{9} - 154 x^{8} + 151 x^{7} - 167 x^{6} + 172 x^{5} - 128 x^{4} + 64 x^{3} - 19 x^{2} + 3 x}{x^{10} - 10 x^{9} + 45 x^{8} - 120 x^{7} + 210 x^{6} - 252 x^{5} + 210 x^{4} - 120 x^{3} + 45 x^{2} - 10 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;2 x^{13} - 13 x^{12} + 49 x^{11} - 107 x^{10} + 151 x^{9} - 154 x^{8} + 151 x^{7} - 167 x^{6} + 172 x^{5} - 128 x^{4} + 64 x^{3} - 19 x^{2} + 3 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A227638.
