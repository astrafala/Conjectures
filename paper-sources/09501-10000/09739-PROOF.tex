...
\title{The empirical recurrence for OEIS A020880, derived from the entry's generating function}
...
\begin{abstract}
OEIS A020880 carries an empirical recurrence of order $9$. The entry separately records a
...
OEIS A020880 is ``Number of strong elementary edge-subgraphs in Moebius ladder M\_n.''. It has offset $2$ and begins
\[
6, 21, 26, 81, 129, 349, 650, 1614,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 30 2026 16:39:57, revision 18) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 6 x^{10} + 3 x^{9} + 38 x^{8} - 16 x^{7} - 74 x^{6} + 22 x^{5} + 46 x^{4} - 9 x^{3} - 6 x^{2}}{x^{9} - x^{8} - 6 x^{7} + 5 x^{6} + 12 x^{5} - 8 x^{4} - 9 x^{3} + 5 x^{2} + 2 x - 1},
\]
the entry's own generating function, and let
\[
D(x)\;=\;1-\sum_i c_i x^{i}\;=\;- x^{9} + x^{8} + 6 x^{7} - 5 x^{6} - 12 x^{5} + 8 x^{4} + 9 x^{3} - 5 x^{2} - 2 x + 1
\]
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 5\,a(n-2) - 9\,a(n-3) - 8\,a(n-4) + 12\,a(n-5) + 5\,a(n-6) - 6\,a(n-7) - a(n-8) + a(n-9)
\]
for every $n>10$.
\end{theorem}
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;6 x^{10} - 3 x^{9} - 38 x^{8} + 16 x^{7} + 74 x^{6} - 22 x^{5} - 46 x^{4} + 9 x^{3} + 6 x^{2},
\]
...
\[
x^{9} - x^{8} - 6 x^{7} + 5 x^{6} + 12 x^{5} - 8 x^{4} - 9 x^{3} + 5 x^{2} + 2 x - 1,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A020880.
