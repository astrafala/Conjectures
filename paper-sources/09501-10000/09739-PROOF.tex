...
\title{The empirical recurrence for OEIS A206146, proved by transfer matrix}
...
\begin{abstract}
OEIS A206146 counts arrays over $\{0,\dots,2\}$ under a condition on the perimeter cycle of
...
OEIS A206146 is ``Number of (n+1) X 5 0..2 arrays with every 2 X 3 or 3 X 2 subblock having exactly three counterclockwise and three clockwise edge increases.''. It has offset $1$ and begins
\[
486, 5118, 54450, 580986, 6204438, 66274542, 707982258, 7563227466,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 16*a(n-1) - 65*a(n-2) + 92*a(n-3) - 48*a(n-4) + 8*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 13 2018 14:26:16, revision 10) this is still
...
$486$, which the model reproduces along with every later term.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206146.
