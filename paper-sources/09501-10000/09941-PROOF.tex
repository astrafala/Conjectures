...
\title{The empirical recurrence for OEIS A255656, proved by transfer matrix}
...
\begin{abstract}
OEIS A255656 carries an empirical recurrence of order $12$ contributed by R.~H.~Hardin. It is
...
OEIS A255656 is ``Number of length n+4 0..3 arrays with at most two downsteps in every 4 consecutive neighbor pairs.''. It has offset $1$ and begins
\[
968, 3692, 14192, 54560, 209412, 803246, 3083292, 11835664,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 15:08:49, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) - 4\,a(n-3) + 15\,a(n-4) - 24\,a(n-5) - 68\,a(n-6) + 136\,a(n-7) - 81\,a(n-8) + 40\,a(n-9) - 10\,a(n-10) + 4\,a(n-11) - a(n-12)
\]
for every $n>16$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A255656.
