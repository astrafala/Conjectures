...
\title{The empirical recurrence for OEIS A186474, proved by transfer matrix}
...
\begin{abstract}
OEIS A186474 counts the $(n+1)\times2$ arrays over $\{0,\dots,3\}$ in which
...
OEIS A186474 is ``Number of (n+1) X 2 0..3 arrays with every 2 X 2 subblock commuting with each of its horizontal and vertical 2 X 2 subblock neighbors.''. It has offset $1$ and begins
\[
256, 205, 1098, 1251, 4895, 5955, 20079, 27101,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + 2*a(n-2) - 6*a(n-3) + 6*a(n-4) - 3*a(n-5) for n>12.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 28 2018 09:01:49, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A186474.
