...
\title{The empirical recurrence for OEIS A255618, proved by transfer matrix}
...
\begin{abstract}
OEIS A255618 carries an empirical recurrence of order $9$ contributed by R.~H.~Hardin. It is
...
OEIS A255618 is ``Number of length n+4 0..2 arrays with at most two downsteps in every 4 consecutive neighbor pairs.''. It has offset $1$ and begins
\[
237, 694, 2040, 5997, 17622, 51768, 152106, 446932,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) -a(n-3) +3*a(n-4) -3*a(n-5) -8*a(n-6) +9*a(n-7) -3*a(n-8) +a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 25 2018 02:52:18, revision 11) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) - a(n-3) + 3\,a(n-4) - 3\,a(n-5) - 8\,a(n-6) + 9\,a(n-7) - 3\,a(n-8) + a(n-9)
\]
for every $n>12$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A255618.
