...
\title{The empirical recurrence for OEIS A183878, derived from the entry's generating function}
...
\begin{abstract}
OEIS A183878 carries an empirical recurrence of order $7$. The entry separately records a
...
OEIS A183878 is ``Number of arrangements of n+2 numbers in 0..3 with each number being the sum mod 4 of two others.''. It has offset $1$ and begins
\[
4, 35, 446, 2827, 13686, 59859, 250198, 1023347,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 05 2018 09:06:06, revision 11) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{384 x^{9} - 1536 x^{8} + 2040 x^{7} - 444 x^{6} - 1318 x^{5} + 1087 x^{4} - 258 x^{3} + 13 x^{2} - 4 x}{16 x^{7} - 84 x^{6} + 184 x^{5} - 217 x^{4} + 148 x^{3} - 58 x^{2} + 12 x - 1},
\]
the entry's own generating function, and let
\[
D(x)\;=\;1-\sum_i c_i x^{i}\;=\;- 16 x^{7} + 84 x^{6} - 184 x^{5} + 217 x^{4} - 148 x^{3} + 58 x^{2} - 12 x + 1
\]
...
\begin{theorem}
\[
a(n)\;=\;12\,a(n-1) - 58\,a(n-2) + 148\,a(n-3) - 217\,a(n-4) + 184\,a(n-5) - 84\,a(n-6) + 16\,a(n-7)
\]
for every $n>9$.
\end{theorem}
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 384 x^{9} + 1536 x^{8} - 2040 x^{7} + 444 x^{6} + 1318 x^{5} - 1087 x^{4} + 258 x^{3} - 13 x^{2} + 4 x,
\]
...
\[
16 x^{7} - 84 x^{6} + 184 x^{5} - 217 x^{4} + 148 x^{3} - 58 x^{2} + 12 x - 1,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A183878.
