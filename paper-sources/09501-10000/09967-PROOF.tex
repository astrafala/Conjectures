...
\title{The empirical recurrence for OEIS A183900, derived from the entry's generating function}
...
\begin{abstract}
OEIS A183900 carries an empirical recurrence of order $6$. The entry separately records a
...
OEIS A183900 is ``Number of nondecreasing arrangements of n+3 numbers in 0..5 with each number being the sum mod 6 of three others.''. It has offset $1$ and begins
\[
3, 24, 130, 364, 771, 1386, 2281, 3534,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 05 2018 11:13:05, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 6 x^{10} + 38 x^{9} - 78 x^{8} + 59 x^{7} - 38 x^{6} + 102 x^{5} - 116 x^{4} + 31 x^{3} + 6 x^{2} + 3 x}{x^{6} - 6 x^{5} + 15 x^{4} - 20 x^{3} + 15 x^{2} - 6 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 6 x^{10} + 38 x^{9} - 78 x^{8} + 59 x^{7} - 38 x^{6} + 102 x^{5} - 116 x^{4} + 31 x^{3} + 6 x^{2} + 3 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A183900.
