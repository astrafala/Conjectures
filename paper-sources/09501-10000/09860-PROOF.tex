...
\title{The empirical recurrence for OEIS A183684, proved by transfer matrix}
...
\begin{abstract}
OEIS A183684 counts arrays over $\{0,\dots,1\}$ under a condition on the determinant of every
...
OEIS A183684 is ``Number of (n+1) X 6 binary arrays with every 2 X 2 subblock nonsingular.''. It has offset $1$ and begins
\[
96, 528, 2688, 14144, 73344, 382848, 1992320, 10382976,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) + 18*a(n-2) - 20*a(n-3) - 72*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 04 2018 10:48:22, revision 10) this is still
...
first term is $96$, and the model reproduces it along with every later term; that is the
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + 18\,a(n-2) - 20\,a(n-3) - 72\,a(n-4)
\]
for every $n>4$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A183684.
