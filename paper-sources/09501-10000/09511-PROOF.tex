...
\title{The empirical recurrence for OEIS A251048, proved by transfer matrix}
...
\begin{abstract}
OEIS A251048 counts $(n+1)\times2$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A251048 is ``Number of (n+1) X (1+1) 0..3 arrays with no 2 X 2 subblock having the sum of its diagonal elements greater than the absolute difference of its antidiagonal elements.''. It has offset $1$ and begins
\[
66, 290, 854, 2243, 5449, 12858, 29759, 68506,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 7*a(n-1) - 18*a(n-2) + 17*a(n-3) + 10*a(n-4) - 39*a(n-5) + 38*a(n-6) - 17*a(n-7) + 3*a(n-8) for n>9.
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 24 2018 08:12:59, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251048.
