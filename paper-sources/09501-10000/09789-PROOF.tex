...
\title{The empirical recurrence for OEIS A250727, proved by transfer matrix}
...
\begin{abstract}
OEIS A250727 counts arrays over $\{0,1\}$ in which a statistic taken over short runs
...
OEIS A250727 is ``Number of (n+1) X (6+1) 0..1 arrays with nondecreasing x(i,j)+x(i,j-1) in the i direction and nondecreasing min(x(i,j),x(i-1,j)) in the j direction.''. It has offset $1$ and begins
\[
579, 1376, 2699, 4889, 8514, 14437, 23941, 38821,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 7*a(n-1) - 20*a(n-2) + 28*a(n-3) - 14*a(n-4) - 14*a(n-5) + 28*a(n-6) - 20*a(n-7) + 7*a(n-8) - a(n-9) for n>14.
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 16 2018 07:51:24, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250727.
