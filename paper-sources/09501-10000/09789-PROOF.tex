...
\title{The empirical recurrence for OEIS A302007, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A302007 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A302007 is ``Number of nX5 0..1 arrays with every element equal to 0, 1, 2 or 3 horizontally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
16, 512, 13616, 369040, 9989376, 270422672, 7320574992, 198174358400,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 24*a(n-1) +82*a(n-2) +34*a(n-3) -90*a(n-4) -40*a(n-5) +37*a(n-6)
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 30 2018 12:50:52, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;24\,a(n-1) + 82\,a(n-2) + 34\,a(n-3) - 90\,a(n-4) - 40\,a(n-5) + 37\,a(n-6)
\end{equation}
for all $n>7$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302007.
