...
\title{The empirical recurrence for OEIS A124869, derived from the entry's generating function}
...
\begin{abstract}
OEIS A124869 carries an empirical recurrence of order $8$. The entry separately records a
...
OEIS A124869 is ``Numerator of real part of (3*i - 1)\^{}(-n).''. It has offset $0$ and begins
\[
1, -1, -2, 13, 7, -79, 11, 307,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 18 2024 12:47:28, revision 18) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 625 x^{10} + 125 x^{7} + 39 x^{6} - 65 x^{5} - 7 x^{4} + 13 x^{3} - 2 x^{2} - x + 1}{625 x^{8} - 14 x^{4} + 1},
\]
the entry's own generating function, and let
\[
D(x)\;=\;1-\sum_i c_i x^{i}\;=\;625 x^{8} - 14 x^{4} + 1
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 625 x^{10} + 125 x^{7} + 39 x^{6} - 65 x^{5} - 7 x^{4} + 13 x^{3} - 2 x^{2} - x + 1,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A124869.
