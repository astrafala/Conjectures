...
\title{The empirical recurrence for OEIS A269610, derived from the entry's generating function}
...
\begin{abstract}
OEIS A269610 carries an empirical recurrence of order $8$. The entry separately records a
...
OEIS A269610 is ``Number of length-7 0..n arrays with no repeated value differing from the previous repeated value by one or less.''. It has offset $1$ and begins
\[
14, 902, 10192, 58280, 229754, 714874, 1886252, 4405772,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 25 2019 06:37:59, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 4 x^{8} + 12 x^{7} + 286 x^{6} - 642 x^{5} + 1216 x^{4} + 3368 x^{3} + 790 x^{2} + 14 x}{x^{8} - 8 x^{7} + 28 x^{6} - 56 x^{5} + 70 x^{4} - 56 x^{3} + 28 x^{2} - 8 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 4 x^{8} + 12 x^{7} + 286 x^{6} - 642 x^{5} + 1216 x^{4} + 3368 x^{3} + 790 x^{2} + 14 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269610.
