...
\title{The empirical recurrence for OEIS A202937, derived from the entry's generating function}
...
\begin{abstract}
OEIS A202937 carries an empirical recurrence of order $10$. The entry separately records a
...
OEIS A202937 is ``Number of (n+3) X 9 binary arrays with consecutive windows of four bits considered as a binary number nondecreasing in every row and column.''. It has offset $1$ and begins
\[
194481, 359970, 695114, 1360328, 2631416, 4958318, 9044252, 15949741,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 03 2018 07:57:43, revision 9) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 111295 x^{10} + 1046214 x^{9} - 4382257 x^{8} + 10737942 x^{7} - 16970274 x^{6} + 17952876 x^{5} - 12729882 x^{4} + 5847059 x^{3} - 1584840 x^{2} + 194481 x}{x^{10} - 10 x^{9} + 45 x^{8} - 120 x^{7} + 210 x^{6} - 252 x^{5} + 210 x^{4} - 120 x^{3} + 45 x^{2} - 10 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 111295 x^{10} + 1046214 x^{9} - 4382257 x^{8} + 10737942 x^{7} - 16970274 x^{6} + 17952876 x^{5} - 12729882 x^{4} + 5847059 x^{3} - 1584840 x^{2} + 194481 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A202937.
