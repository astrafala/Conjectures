...
\title{The empirical recurrence for OEIS A250581, proved by transfer matrix}
...
\begin{abstract}
OEIS A250581 counts arrays over $\{0,1\}$ in which a statistic taken over short runs
...
OEIS A250581 is ``Number of (n+1)X(6+1) 0..1 arrays with nondecreasing max(x(i,j),x(i,j-1)) in the i direction and nondecreasing min(x(i,j),x(i-1,j)) in the j direction.''. It has offset $1$ and begins
\[
635, 1743, 4077, 9055, 19806, 43202, 94623, 208525,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 12:33:43, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-1) - 14\,a(n-2) - 11\,a(n-3) + 80\,a(n-4) - 93\,a(n-5) - 38\,a(n-6) + 174\,a(n-7) - 134\,a(n-8) + 54\,a(n-10) - 29\,a(n-11) + 5\,a(n-12)
\]
for every $n>15$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250581.
