...
\title{The empirical recurrence for OEIS A201046, derived from the entry's generating function}
...
\begin{abstract}
OEIS A201046 carries an empirical recurrence of order $8$. The entry separately records a
...
OEIS A201046 is ``Number of -n..n arrays of 7 elements with adjacent element differences also in -n..n.''. It has offset $1$ and begins
\[
577, 17981, 182349, 1042167, 4211559, 13497523, 36644243, 87831605,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 22 2018 03:47:32, revision 9) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{8} + 9 x^{7} + 541 x^{6} + 13449 x^{5} + 54531 x^{4} + 54657 x^{3} + 13365 x^{2} + 577 x}{x^{8} - 8 x^{7} + 28 x^{6} - 56 x^{5} + 70 x^{4} - 56 x^{3} + 28 x^{2} - 8 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- x^{8} + 9 x^{7} + 541 x^{6} + 13449 x^{5} + 54531 x^{4} + 54657 x^{3} + 13365 x^{2} + 577 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A201046.
