...
\title{The empirical recurrence for OEIS A254423, proved by transfer matrix}
...
\begin{abstract}
OEIS A254423 counts the arrays over $\{0,\dots,2\}$ whose $2\times2$ subblocks carry a
...
OEIS A254423 is ``Number of (2+1)X(n+1) 0..2 arrays with every 2X2 subblock diagonal maximum minus antidiagonal maximum nondecreasing horizontally, vertically and ne-to-sw antidiagonally.''. It has offset $1$ and begins
\[
470, 3279, 25589, 229652, 2128339, 19879926, 186426904, 1752614398,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 14:40:29, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;21\,a(n-1) - 139\,a(n-2) + 191\,a(n-3) + 1344\,a(n-4) - 4896\,a(n-5) + 1972\,a(n-6) + 10548\,a(n-7) - 8240\,a(n-8) - 8576\,a(n-9) + 4704\,a(n-10) + 3072\,a(n-11)
\]
for every $n>18$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A254423.
