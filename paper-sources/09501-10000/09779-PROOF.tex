...
\title{The empirical recurrence for OEIS A188709, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A188709 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A188709 is ``Number of 5 X n binary arrays without the pattern 0 0 diagonally or vertically.''. It has offset $1$ and begins
\[
13, 120, 1141, 10857, 103484, 986929, 9413801, 89796720,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 13*a(n-1) - 36*a(n-2) + 29*a(n-3) - 5*a(n-4) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 28 2018 12:49:10, revision 11) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A188709.
