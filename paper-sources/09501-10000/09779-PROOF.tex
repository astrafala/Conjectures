...
\title{The empirical recurrence for OEIS A249885, derived from the entry's generating function}
...
\begin{abstract}
OEIS A249885 carries an empirical recurrence of order $9$. The entry separately records a
...
OEIS A249885 is ``Number of length 2+6 0..n arrays with no seven consecutive terms having the maximum of any three terms equal to the minimum of the remaining four terms.''. It has offset $1$ and begins
\[
35, 1365, 18390, 136010, 684585, 2644815, 8435180, 23274900,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 10 2018 05:46:38, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 155 x^{7} - 2730 x^{6} - 12285 x^{5} - 16700 x^{4} - 7365 x^{3} - 1050 x^{2} - 35 x}{x^{9} - 9 x^{8} + 36 x^{7} - 84 x^{6} + 126 x^{5} - 126 x^{4} + 84 x^{3} - 36 x^{2} + 9 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;155 x^{7} + 2730 x^{6} + 12285 x^{5} + 16700 x^{4} + 7365 x^{3} + 1050 x^{2} + 35 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A249885.
