...
\title{The empirical recurrence for OEIS A298095, proved by transfer matrix}
...
\begin{abstract}
OEIS A298095 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A298095 is ``Number of nX3 0..1 arrays with every element equal to 3, 4, 5 or 6 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
0, 1, 0, 1, 0, 3, 0, 7,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +2*a(n-2) -a(n-3) +a(n-4) -2*a(n-5)
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 12 2018 09:46:15, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 2\,a(n-2) - a(n-3) + a(n-4) - 2\,a(n-5)
\end{equation}
for all $n>5$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A298095.
