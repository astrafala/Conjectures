...
\title{The empirical recurrence for OEIS A229449, derived from the entry's generating function}
...
\begin{abstract}
OEIS A229449 carries an empirical recurrence of order $7$. The entry separately records a
...
OEIS A229449 is ``Number of 6 X n 0..2 arrays with horizontal differences mod 3 never 1, vertical differences mod 3 never -1, and rows and columns lexicographically nondecreasing.''. It has offset $1$ and begins
\[
23, 84, 293, 915, 2546, 6374, 14536, 30571,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 17 2018 08:32:08, revision 7) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 11 x^{7} + 31 x^{6} - 159 x^{5} + 177 x^{4} - 188 x^{3} + 77 x^{2} - 23 x}{x^{7} - 7 x^{6} + 21 x^{5} - 35 x^{4} + 35 x^{3} - 21 x^{2} + 7 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;11 x^{7} - 31 x^{6} + 159 x^{5} - 177 x^{4} + 188 x^{3} - 77 x^{2} + 23 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A229449.
