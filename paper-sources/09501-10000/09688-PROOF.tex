...
\title{The empirical recurrence for OEIS A222835, derived from the entry's generating function}
...
\begin{abstract}
OEIS A222835 carries an empirical recurrence of order $4$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 16 2018 08:59:15, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{72 x^{7} + 144 x^{6} - 173 x^{5} - 202 x^{4} + 120 x^{3} - 346 x^{2} - 19 x}{x^{4} + 2 x^{3} + 2 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 72 x^{7} - 144 x^{6} + 173 x^{5} + 202 x^{4} - 120 x^{3} + 346 x^{2} + 19 x,
\]
