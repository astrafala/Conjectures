...
\title{The empirical recurrence for OEIS A296669, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A296669 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A296669 is ``Number of nX3 0..1 arrays with each 1 adjacent to 0, 2 or 3 king-move neighboring 1s.''. It has offset $1$ and begins
\[
5, 25, 82, 334, 1451, 5938, 25144, 108174,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 18 2017 11:02:02, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) - a(n-2) + 5\,a(n-3) - 55\,a(n-4) - 22\,a(n-5) + 42\,a(n-6) + 48\,a(n-7) + 37\,a(n-8) - 16\,a(n-9) + 30\,a(n-10) - 22\,a(n-11) + 4\,a(n-12)
\end{equation}
for all $n>13$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A296669.
