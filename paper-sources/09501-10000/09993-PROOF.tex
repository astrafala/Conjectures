...
\title{The empirical recurrence for OEIS A267468, derived from the entry's generating function}
...
\begin{abstract}
OEIS A267468 carries an empirical recurrence of order $7$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 05 2018 09:35:52, revision 7) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 2556 x^{7} + 7336 x^{6} - 7539 x^{5} + 3710 x^{4} - 945 x^{3} + 120 x^{2} - 6 x}{3600 x^{7} - 9540 x^{6} + 9884 x^{5} - 5299 x^{4} + 1610 x^{3} - 280 x^{2} + 26 x - 1},
\]
the entry's own generating function, and let
\[
D(x)\;=\;1-\sum_i c_i x^{i}\;=\;- 3600 x^{7} + 9540 x^{6} - 9884 x^{5} + 5299 x^{4} - 1610 x^{3} + 280 x^{2} - 26 x + 1
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;2556 x^{7} - 7336 x^{6} + 7539 x^{5} - 3710 x^{4} + 945 x^{3} - 120 x^{2} + 6 x,
\]
...
\[
3600 x^{7} - 9540 x^{6} + 9884 x^{5} - 5299 x^{4} + 1610 x^{3} - 280 x^{2} + 26 x - 1,
\]
