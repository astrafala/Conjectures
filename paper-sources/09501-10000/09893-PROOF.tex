...
\title{The empirical recurrence for OEIS A186044, proved by transfer matrix}
...
\begin{abstract}
OEIS A186044 counts $(n+2)\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A186044 is ``Number of (n+2) X 3 binary arrays with each 3 X 3 subblock singular.''. It has offset $1$ and begins
\[
338, 2038, 12278, 72802, 434174, 2588842, 15426974, 91951882,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 5*a(n-1) + 4*a(n-2) + 18*a(n-3) - 40*a(n-4) - 24*a(n-5) - 72*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 17 2018 08:19:41, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) + 4\,a(n-2) + 18\,a(n-3) - 40\,a(n-4) - 24\,a(n-5) - 72\,a(n-6)
\]
for every $n>5$.
\end{theorem}
...
at once. By Lemma~\ref{lem:crit} the recurrence holds for every $n>5$.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A186044.
