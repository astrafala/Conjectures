...
\title{The empirical recurrence for OEIS A160849, derived from the entry's generating function}
...
\begin{abstract}
OEIS A160849 carries an empirical recurrence of order $20$. The entry separately records a
...
OEIS A160849 is ``Number of lines through at least 2 points of a 9 X n grid of points.''. It has offset $0$ and begins
\[
0, 1, 83, 164, 299, 454, 673, 894,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 25 2017 11:22:17, revision 12) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 9 x^{21} - 9 x^{20} - 19 x^{19} - 92 x^{18} - 174 x^{17} - 373 x^{16} - 600 x^{15} - 935 x^{14} - 1228 x^{13} - 1571 x^{12} - 1738 x^{11} - 1873 x^{10} - 1756 x^{9} - 1607 x^{8} - 1264 x^{7} - 971 x^{6} - 618 x^{5} - 382 x^{4} - 165 x^{3} - 83 x^{2} - x}{x^{20} + x^{18} - x^{15} - x^{14} - 2 x^{13} - x^{12} - x^{11} + x^{9} + x^{8} + 2 x^{7} + x^{6} + x^{5} - x^{2} - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;9 x^{21} + 9 x^{20} + 19 x^{19} + 92 x^{18} + 174 x^{17} + 373 x^{16} + 600 x^{15} + 935 x^{14} + 1228 x^{13} + 1571 x^{12} + 1738 x^{11} + 1873 x^{10} + 1756 x^{9} + 1607 x^{8} + 1264 x^{7} + 971 x^{6} + 618 x^{5} + 382 x^{4} + 165 x^{3} + 83 x^{2} + x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A160849.
