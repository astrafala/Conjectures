...
\title{The empirical recurrence for OEIS A266472, derived from the entry's generating function}
...
\begin{abstract}
OEIS A266472 carries an empirical recurrence of order $10$. The entry separately records a
...
OEIS A266472 is ``Number of 5 X n binary arrays with rows and columns lexicographically nondecreasing and column sums nonincreasing.''. It has offset $1$ and begins
\[
6, 19, 67, 232, 735, 2090, 5371, 12645,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 10 2019 08:08:32, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 4 x^{10} + 30 x^{9} - 109 x^{8} + 248 x^{7} - 382 x^{6} + 410 x^{5} - 303 x^{4} + 147 x^{3} - 41 x^{2} + 6 x}{x^{10} - 10 x^{9} + 45 x^{8} - 120 x^{7} + 210 x^{6} - 252 x^{5} + 210 x^{4} - 120 x^{3} + 45 x^{2} - 10 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 4 x^{10} + 30 x^{9} - 109 x^{8} + 248 x^{7} - 382 x^{6} + 410 x^{5} - 303 x^{4} + 147 x^{3} - 41 x^{2} + 6 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A266472.
