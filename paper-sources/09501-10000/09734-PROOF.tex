...
\title{The empirical recurrence for OEIS A255153, proved by transfer matrix}
...
\begin{abstract}
OEIS A255153 counts $(n+2)\times4$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A255153 is ``Number of (n+2) X (2+2) 0..1 arrays with no 3 x 3 subblock diagonal sum 1 and no antidiagonal sum 1 and no row sum 0 or 1 and no column sum 0 or 1.''. It has offset $1$ and begins
\[
62, 158, 459, 1285, 3553, 9978, 27903, 77798,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + 2*a(n-2) + 7*a(n-3) + 4*a(n-4) + a(n-6) - 6*a(n-8) - 6*a(n-9) - 3*a(n-10) - a(n-11).
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 18 2018 11:48:43, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 2\,a(n-2) + 7\,a(n-3) + 4\,a(n-4) + a(n-6) - 6\,a(n-8) - 6\,a(n-9) - 3\,a(n-10) - a(n-11)
\]
for every $n>11$.
\end{theorem}
...
at once. By Lemma~\ref{lem:crit} the recurrence holds for every $n>11$.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A255153.
