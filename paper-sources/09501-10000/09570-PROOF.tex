...
\title{The empirical recurrence for OEIS A317460, proved by transfer matrix}
...
\begin{abstract}
OEIS A317460 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A317460 is ``Number of nX3 0..1 arrays with every element unequal to 2, 3, 4, 5, 6, 7 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
0, 5, 16, 107, 636, 3893, 23769, 145280,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 28 2018 20:58:36, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) + 8\,a(n-2) + 2\,a(n-3) - 48\,a(n-4) - 62\,a(n-5) + 35\,a(n-6) + 62\,a(n-7) + 5\,a(n-8) - 25\,a(n-9) + 2\,a(n-10) + 14\,a(n-11) + 4\,a(n-12)
\end{equation}
for all $n>14$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A317460.
