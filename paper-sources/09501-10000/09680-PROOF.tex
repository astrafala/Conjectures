...
\title{The empirical recurrence for OEIS A250987, proved by transfer matrix}
...
\begin{abstract}
OEIS A250987 counts arrays over $\{0,1,2\}$ in which a statistic taken over short runs
...
OEIS A250987 is ``Number of (n+1) X (1+1) 0..2 arrays with nondecreasing min(x(i,j),x(i,j-1)) in the i direction and nondecreasing absolute value of x(i,j)-x(i-1,j) in the j direction.''. It has offset $1$ and begins
\[
40, 158, 612, 2323, 8726, 32554, 120930, 447985,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 6*a(n-1) - 7*a(n-2) - 8*a(n-3) + 7*a(n-4) + 6*a(n-5) + a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 24 2018 08:12:02, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250987.
