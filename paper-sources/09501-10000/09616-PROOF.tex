...
\title{The empirical recurrence for OEIS A223292, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A223292 counts arrays over $\{0,\dots,8\}$ in which every cell is constrained by the
...
OEIS A223292 is ``4-loop graph coloring a rectangular array: number of n X 3 0..8 arrays where 0..8 label nodes of a graph with edges 0,1 1,2 2,0 0,3 3,4 4,0 0,5 5,6 6,0 0,7 7,8 8,0 and every array movement to a horizontal or vertical neighbor moves along an edge of this graph.''. It has offset $1$ and begins
\[
96, 1368, 42168, 709320, 22346136, 377262504, 11864385048, 200704309992,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) + 531*a(n-2) - 1022*a(n-3) - 750*a(n-4) + 448*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 19 2018 07:36:26, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 531\,a(n-2) - 1022\,a(n-3) - 750\,a(n-4) + 448\,a(n-5)
\end{equation}
for all $n>5$.
...
$9$ values, so there are about $10^{42}$ of them to sift. The
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223292.
