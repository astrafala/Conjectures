...
\title{The empirical recurrence for OEIS A250338, derived from the entry's generating function}
...
\begin{abstract}
OEIS A250338 carries an empirical recurrence of order $7$. The entry separately records a
...
OEIS A250338 is ``Number of length 2+5 0..n arrays with every six consecutive terms having the maximum of some three terms equal to the minimum of the remaining three terms.''. It has offset $1$ and begins
\[
68, 907, 5264, 20085, 59396, 147903, 325312, 651369,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 12 2018 14:42:21, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{7} + 7 x^{6} + 20 x^{5} + 96 x^{4} - 343 x^{3} - 431 x^{2} - 68 x}{x^{7} - 7 x^{6} + 21 x^{5} - 35 x^{4} + 35 x^{3} - 21 x^{2} + 7 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;x^{7} - 7 x^{6} - 20 x^{5} - 96 x^{4} + 343 x^{3} + 431 x^{2} + 68 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250338.
