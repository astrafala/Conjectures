...
\title{The empirical recurrence for OEIS A222140, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A222140 counts arrays over $\{0,\dots,4\}$ in which every cell is constrained by the
...
OEIS A222140 is ``Number of n X 4 0..4 arrays with no entry increasing mod 5 by 4 rightwards or downwards, starting with upper left zero.''. It has offset $1$ and begins
\[
64, 8788, 1206964, 165770032, 22767656980, 3127020364012, 429480137694664, 58986884432558548,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 153*a(n-1) - 2197*a(n-2) + 6434*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 14 2018 14:11:45, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;153\,a(n-1) - 2197\,a(n-2) + 6434\,a(n-3)
\end{equation}
for all $n>3$.
...
publishes, $n=12$, the arrays have $4\cdot12$ cells over
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A222140.
