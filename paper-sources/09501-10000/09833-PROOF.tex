...
\title{The empirical recurrence for OEIS A241967, derived from the entry's generating function}
...
\begin{abstract}
OEIS A241967 carries an empirical recurrence of order $8$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 31 2018 06:33:33, revision 7) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{8} + 8 x^{7} - 28 x^{6} + 70 x^{5} + 140 x^{4} + 607 x^{3} + 319 x^{2} + 57 x}{x^{8} - 8 x^{7} + 28 x^{6} - 56 x^{5} + 70 x^{4} - 56 x^{3} + 28 x^{2} - 8 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- x^{8} + 8 x^{7} - 28 x^{6} + 70 x^{5} + 140 x^{4} + 607 x^{3} + 319 x^{2} + 57 x,
\]
