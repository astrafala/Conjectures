...
\title{The empirical recurrence for OEIS A302260, proved by transfer matrix}
...
\begin{abstract}
OEIS A302260 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A302260 is ``Number of n X 3 0..1 arrays with every element equal to 0, 1, 2 or 3 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
4, 29, 153, 818, 4386, 23516, 126162, 676988,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 6*a(n-1) -2*a(n-2) +2*a(n-3) -54*a(n-4) +16*a(n-5) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 16 2024 09:34:00, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302260.
