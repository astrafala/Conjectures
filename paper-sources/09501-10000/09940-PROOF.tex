...
\title{The empirical recurrence for OEIS A242145, derived from the entry's generating function}
...
\begin{abstract}
OEIS A242145 carries an empirical recurrence of order $7$. The entry separately records a
...
OEIS A242145 is ``Number of length 1+5 0..n arrays with no consecutive six elements summing to more than 3*n.''. It has offset $1$ and begins
\[
42, 435, 2338, 8688, 25494, 63490, 140148, 282051,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 31 2018 21:50:15, revision 10) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{7} + 7 x^{6} - 21 x^{5} + 13 x^{4} - 175 x^{3} - 141 x^{2} - 42 x}{x^{7} - 7 x^{6} + 21 x^{5} - 35 x^{4} + 35 x^{3} - 21 x^{2} + 7 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;x^{7} - 7 x^{6} + 21 x^{5} - 13 x^{4} + 175 x^{3} + 141 x^{2} + 42 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A242145.
