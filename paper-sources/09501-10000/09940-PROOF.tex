...
\title{The empirical recurrence for OEIS A252822, derived from the entry's generating function}
...
\begin{abstract}
OEIS A252822 carries an empirical recurrence of order $7$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 06 2018 19:24:00, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{7} + 4 x^{6} - 9 x^{5} + 17 x^{4} - 18 x^{3} + 8 x^{2} - 2 x}{x^{7} - 7 x^{6} + 21 x^{5} - 35 x^{4} + 35 x^{3} - 21 x^{2} + 7 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;x^{7} - 4 x^{6} + 9 x^{5} - 17 x^{4} + 18 x^{3} - 8 x^{2} + 2 x,
\]
