...
\title{The empirical recurrence for OEIS A250085, derived from the entry's generating function}
...
\begin{abstract}
OEIS A250085 carries an empirical recurrence of order $9$. The entry separately records a
...
OEIS A250085 is ``Number of length 4+5 0..n arrays with every six consecutive terms having the maximum of some two terms equal to the minimum of the remaining four terms.''. It has offset $1$ and begins
\[
252, 5084, 42936, 222329, 847708, 2623376, 6978064, 16547001,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 12 2018 03:00:27, revision 11) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{9} + 9 x^{8} - 52 x^{7} - 56 x^{6} + 2861 x^{5} + 2239 x^{4} - 6252 x^{3} - 2816 x^{2} - 252 x}{x^{9} - 9 x^{8} + 36 x^{7} - 84 x^{6} + 126 x^{5} - 126 x^{4} + 84 x^{3} - 36 x^{2} + 9 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;x^{9} - 9 x^{8} + 52 x^{7} + 56 x^{6} - 2861 x^{5} - 2239 x^{4} + 6252 x^{3} + 2816 x^{2} + 252 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250085.
