...
\title{The empirical recurrence for OEIS A245953, derived from the entry's generating function}
...
\begin{abstract}
OEIS A245953 carries an empirical recurrence of order $9$. The entry separately records a
...
OEIS A245953 is ``Number of length 3+3 0..n arrays with some pair in every consecutive four terms totalling exactly n.''. It has offset $1$ and begins
\[
48, 545, 2304, 7769, 18384, 39721, 73728, 130193,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 05 2018 18:09:16, revision 10) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{9} + 3 x^{8} + 7 x^{7} - 557 x^{6} - 851 x^{5} + 1241 x^{4} + 669 x^{3} + 401 x^{2} + 48 x}{x^{9} - 3 x^{8} + 8 x^{6} - 6 x^{5} - 6 x^{4} + 8 x^{3} - 3 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- x^{9} + 3 x^{8} + 7 x^{7} - 557 x^{6} - 851 x^{5} + 1241 x^{4} + 669 x^{3} + 401 x^{2} + 48 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A245953.
