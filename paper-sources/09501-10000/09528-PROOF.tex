...
\title{The empirical recurrence for OEIS A209789, proved by transfer matrix}
...
\begin{abstract}
OEIS A209789 counts $(n+1)\times2$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A209789 is ``Half the number of (n+1) X 2 0..2 arrays with every 2 X 2 subblock having exactly one duplicate clockwise edge difference.''. It has offset $1$ and begins
\[
30, 204, 1380, 9348, 63300, 428676, 2902980, 19659012,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 5*a(n-1) + 12*a(n-2).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 13 2018 05:33:13, revision 10) the statement is
...
\[
a(n)-\sum_i c_i\,a(n-i)\;=\;\tfrac1{2}\mathbf{1}^{\!\top}M^{\,n+1-1-2}\,q(M)\,\mathbf{1} .
\]
...
=\tfrac1{2}\mathbf{1}^{\!\top}M^{\,m-2}\,q(M)\,\mathbf{1}
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209789.
