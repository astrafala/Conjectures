...
\title{The empirical recurrence for OEIS A251645, proved by transfer matrix}
...
\begin{abstract}
OEIS A251645 counts arrays of width $3$ over $\{0,1,2,3\}$ in which every $3\times3$ window has
...
OEIS A251645 is ``Number of (n+2) X (1+2) 0..3 arrays with no row, column, diagonal or antidiagonal in any 3 X 3 subblock summing to 0 2 4 5 7 or 9.''. It has offset $1$ and begins
\[
376, 448, 738, 1248, 2382, 4140, 6978, 13532,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + 2*a(n-2) + 5*a(n-3) - 7*a(n-4) - 12*a(n-5) + 6*a(n-6) + 6*a(n-7) for n>14.
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 14 2025 07:37:15, revision 11) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251645.
