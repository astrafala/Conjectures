...
\title{The empirical recurrence for OEIS A207849, proved by transfer matrix}
...
\begin{abstract}
OEIS A207849 counts arrays over $\{0,\dots,1\}$ of width $6$ that avoid the patterns
...
OEIS A207849 is ``Number of 6Xn 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 0 0 and 1 1 1 vertically.''. It has offset
$1$ and begins
\[
26, 676, 2080, 9672, 41444, 181896, 794768,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:21:19, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 17\,a(n-2) - 45\,a(n-3) - 47\,a(n-4) + 155\,a(n-5) - 155\,a(n-7) + 47\,a(n-8) + 45\,a(n-9) - 17\,a(n-10) - 3\,a(n-11) + a(n-12)
\end{equation}
...
$(0,0,0), (1,1,1)$ as $3$ consecutive entries. There are $26$ admissible columns; that condition
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207849.
