...
\title{The empirical recurrence for OEIS A250391, derived from the entry's generating function}
...
\begin{abstract}
OEIS A250391 carries an empirical recurrence of order $9$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 21 2017 05:59:10, revision 7) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 392 x^{7} - 4670 x^{6} - 14644 x^{5} - 15078 x^{4} - 5070 x^{3} - 460 x^{2} - 6 x}{x^{9} - 9 x^{8} + 36 x^{7} - 84 x^{6} + 126 x^{5} - 126 x^{4} + 84 x^{3} - 36 x^{2} + 9 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;392 x^{7} + 4670 x^{6} + 14644 x^{5} + 15078 x^{4} + 5070 x^{3} + 460 x^{2} + 6 x,
\]
