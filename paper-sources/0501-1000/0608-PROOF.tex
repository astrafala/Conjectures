...
\title{The empirical recurrence for OEIS A229508, proved by counting defective colourings}
...
\begin{abstract}
OEIS A229508 counts the colourings of an array with $K=3$ colours that are proper except at
...
OEIS A229508 is ``Number of defective 3-colorings of an n X 6 0..2 array connected diagonally and antidiagonally with exactly one mistake, and colors introduced in row-major 0..2 order.''. It has offset $1$ and begins
\[
0, 7680, 228096, 6298560, 162171072, 4032737280, 97662620160, 2320483572864,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 16 2017 08:12:54, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;50\,a(n-1) - 715\,a(n-2) + 324\,a(n-3) + 50175\,a(n-4) - 180630\,a(n-5) - 940491\,a(n-6) + 4556250\,a(n-7) + 2329155\,a(n-8) - 27398736\,a(n-9) + 13286025\,a(n-10) + 47829690\,a(n-11) - 43046721\,a(n-12)
\end{equation}
for all $n>13$.

\section{Mistakes, and the colour clause}

The arrays have $6$ columns and $L=n$ rows, entries in $\{0,\dots,3-1\}$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A229508.
