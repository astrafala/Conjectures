...
\title{The empirical recurrence for OEIS A229584, proved by counting defective colourings}
...
\begin{abstract}
OEIS A229584 counts the colourings of an array with $K=3$ colours that are proper except at
...
OEIS A229584 is ``Number of defective 3-colorings of an n X 6 0..2 array connected horizontally and antidiagonally with exactly one mistake, and colors introduced in row-major 0..2 order.''. It has offset $1$ and begins
\[
40, 1620, 49848, 1375152, 35690460, 890824020, 21639043284, 515235810840,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 50*a(n-1) - 805*a(n-2) + 4662*a(n-3) - 12150*a(n-4) + 14580*a(n-5) - 6561*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 19 2018 15:15:15, revision 7) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A229584.
