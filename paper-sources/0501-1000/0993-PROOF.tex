...
\title{The empirical recurrence for OEIS A221223, proved by transfer matrix}
...
\begin{abstract}
OEIS A221223 counts the distinct OCCUPANCY arrays obtained when every cell of an $n\times2$ grid
...
determinising the machine that emits the occupancy row by row turns it into one, on $S=281$
...
OEIS A221223 is ``Number of n X 2 arrays of occupancy after each element stays put or moves to some king-move neighbor.''. It has offset $1$ and begins
\[
3, 35, 400, 4525, 51025, 574800, 6473175, 72891475,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 15*a(n-1) - 43*a(n-2) + 10*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 04 2018 10:35:06, revision 9) this is still
...
\]
There are $S=281$ reachable sets. In particular $a$ is $C$-finite.
...
\begin{theorem}
\[
a(n)\;=\;15\,a(n-1) - 43\,a(n-2) + 10\,a(n-3)
\]
for every $n>3$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221223.
