...
\title{The empirical recurrence for OEIS A264085, proved by transfer matrix}
...
\begin{abstract}
OEIS A264085 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=3$ rows in which
...
OEIS A264085 is ``Number of (n+1) X (2+1) arrays of permutations of 0..n*3+2 with each element having index change +-(.,.) 0,0 0,1 or 2,-2.''. It has offset $1$ and begins
\[
9, 39, 169, 715, 3025, 12815, 54289, 229971,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) + 4*a(n-3) + a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 04 2019 09:02:15, revision 9) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264085.
