...
\title{The empirical recurrence for OEIS A264508, proved by transfer matrix}
...
\begin{abstract}
OEIS A264508 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=3$ columns in which
...
partly used. Carrying those as bitmasks makes the count a walk on $S=64$ vertices, so it is
...
OEIS A264508 is ``Number of (2+1)X(n+1) arrays of permutations of 0..n*3+2 with each element having directed index change -1,1 0,-1 0,1 or 1,0.''. It has offset $1$ and begins
\[
2, 2, 14, 38, 137, 432, 1417, 4554,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 15 2015 18:39:40, revision 4) this is still
...
\[
(i-h_i,\,j-h_j)\;\in\;\{(-1,0),\ (0,1),\ (1,-1),\ (1,0)\},
\]
...
Hence $a$ is a walk count on $S=64$ vertices,
\[
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 7\,a(n-2) - 8\,a(n-3) - 9\,a(n-4) + 10\,a(n-5) - a(n-6) + a(n-8) - 10\,a(n-9) + 9\,a(n-10) + 8\,a(n-11) - 7\,a(n-12) - 2\,a(n-13) + a(n-14)
\]
for every $n>12$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264508.
