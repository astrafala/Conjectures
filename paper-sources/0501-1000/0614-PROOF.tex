...
\title{The empirical recurrence for OEIS A279530, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A279530 imposes three things at once: a condition on each cell that reaches one row up and
...
OEIS A279530 is ``Number of nX2 0..2 arrays with no element equal to a strict majority of its horizontal and vertical neighbors, with the exception of exactly two elements, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
1, 0, 15, 222, 2348, 21302, 176125, 1370378,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 14 2016 10:22:46, revision 5) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;18\,a(n-1) - 108\,a(n-2) + 183\,a(n-3) + 408\,a(n-4) - 1332\,a(n-5) + 69\,a(n-6) + 2442\,a(n-7) - 1632\,a(n-8) - 1043\,a(n-9) + 1452\,a(n-10) - 528\,a(n-11) + 64\,a(n-12)
\end{equation}
for all $n>13$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A279530.
