...
\title{The empirical recurrence for OEIS A279801, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A279801 imposes three things at once: a condition on each cell that reaches one row up and
...
OEIS A279801 is ``Number of nX2 0..2 arrays with no element equal to a strict majority of its horizontal, vertical and antidiagonal neighbors, with the exception of exactly one element, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
0, 2, 22, 196, 1848, 16720, 149392, 1317720,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 19 2016 09:10:12, revision 5) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;16\,a(n-1) - 64\,a(n-2) - 8\,a(n-3) + 72\,a(n-4) - 88\,a(n-5) + 144\,a(n-6) + 288\,a(n-7) - 112\,a(n-8) - 32\,a(n-9) - 16\,a(n-10) - 384\,a(n-11) - 256\,a(n-12)
\end{equation}
for all $n>13$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A279801.
