...
\title{The empirical recurrence for OEIS A221276, proved by transfer matrix}
...
\begin{abstract}
OEIS A221276 counts the distinct OCCUPANCY arrays obtained when every cell of an $n\times2$ grid
...
determinising the machine that emits the occupancy row by row turns it into one, on $S=17$
...
OEIS A221276 is ``Number of 2 X n arrays of occupancy after each element moves to some horizontal, diagonal or antidiagonal neighbor, with every occupancy equal to zero or two.''. It has offset $1$ and begins
\[
0, 4, 4, 25, 52, 196, 520, 1681,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) - 12*a(n-3) + 9*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 04 2018 14:33:10, revision 7) this is still
...
\]
There are $S=17$ reachable sets. In particular $a$ is $C$-finite.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221276.
