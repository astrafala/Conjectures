...
\title{The empirical recurrence for OEIS A264544, proved by transfer matrix}
...
\begin{abstract}
OEIS A264544 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=3$ rows in which
...
OEIS A264544 is ``Number of (n+1) X (2+1) arrays of permutations of 0..n*3+2 with each element having directed index change -1,1 -1,2 1,0 or 0,-1.''. It has offset $1$ and begins
\[
1, 2, 5, 10, 21, 44, 93, 196,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 08 2019 19:00:32, revision 8) this is still
...
Second, the transfer model reproduces all $31$ terms this entry publishes, exactly, in
integer arithmetic.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264544.
