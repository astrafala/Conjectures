...
\title{The empirical recurrence for OEIS A281690, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A281690 imposes three things at once: a condition on each cell that reaches one row up and
...
OEIS A281690 is ``Number of nX3 0..2 arrays with no element equal to more than one of its horizontal, diagonal or antidiagonal neighbors, with the exception of exactly two elements, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
0, 6, 847, 19326, 293814, 3714629, 42265965, 449985840,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 27 2017 12:36:34, revision 5) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;21\,a(n-1) - 117\,a(n-2) - 155\,a(n-3) + 2070\,a(n-4) + 2406\,a(n-5) - 15836\,a(n-6) - 33948\,a(n-7) + 35640\,a(n-8) + 184600\,a(n-9) + 158208\,a(n-10) - 213408\,a(n-11) - 613504\,a(n-12) - 616320\,a(n-13) - 307200\,a(n-14) - 64000\,a(n-15)
\end{equation}
for all $n>20$.
...
\[
3!\Bigl(a(n_0+j)-\sum_i c_i\,a(n_0+j-i)\Bigr)=\mathbf{v}^{\!\top}G^{\,j-15}w,
...
index corresponding to $n=20+1$ onwards, and the run continued until $S+1$ consecutive
zeros had been seen.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A281690.
