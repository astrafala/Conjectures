...
\title{The empirical recurrence for OEIS A279897, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A279897 imposes three things at once: a condition on each cell that reaches one row up and
...
OEIS A279897 is ``Number of n X 3 0..2 arrays with no element unequal to a strict majority of its king-move neighbors, with the exception of exactly one element, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
2, 6, 9, 20, 43, 94, 213, 456,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) + 3*a(n-2) - 4*a(n-3) - 4*a(n-4) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 12 2019 08:47:28, revision 7) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A279897.
