...
\title{The empirical recurrence for OEIS A279736, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A279736 imposes three things at once: a condition on each cell that reaches one row up and
...
OEIS A279736 is ``Number of n X 3 0..1 arrays with no element equal to a strict majority of its horizontal and antidiagonal neighbors, with the exception of exactly one element, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
2, 6, 35, 168, 766, 3402, 14827, 63680,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 10*a(n-1) - 35*a(n-2) + 54*a(n-3) - 45*a(n-4) + 20*a(n-5) - 4*a(n-6) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 11 2019 14:23:06, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;10\,a(n-1) - 35\,a(n-2) + 54\,a(n-3) - 45\,a(n-4) + 20\,a(n-5) - 4\,a(n-6)
\end{equation}
for all $n>7$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A279736.
