...
\title{The empirical recurrence for OEIS A221241, proved by transfer matrix}
...
\begin{abstract}
OEIS A221241 counts the distinct OCCUPANCY arrays obtained when every cell of an $n\times3$ grid
...
OEIS A221241 is ``Number of n X 3 arrays of occupancy after each element moves to some horizontal, diagonal or antidiagonal neighbor.''. It has offset $1$ and begins
\[
2, 50, 1056, 21660, 441720, 8997120, 183206016, 3730330800,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 30*a(n-1) - 222*a(n-2) + 540*a(n-3) - 324*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 04 2018 13:42:17, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;30\,a(n-1) - 222\,a(n-2) + 540\,a(n-3) - 324\,a(n-4)
\]
for every $n>4$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221241.
