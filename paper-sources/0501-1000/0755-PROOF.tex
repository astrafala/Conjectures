...
\title{The empirical recurrence for OEIS A218645, proved by transfer matrix}
...
\begin{abstract}
OEIS A218645 counts the distinct arrays obtained by applying a fixed local operation to every cell
of an array over a bounded alphabet, and carries an empirical recurrence of order $8$
...
$S=57$ states, after which the conjectured recurrence is settled by a finite exact
computation.
\end{abstract}
...
OEIS A218645 is ``Number of n X 2 arrays of the minimum value of corresponding elements and their horizontal, vertical or antidiagonal neighbors in a random 0..3 n X 2 array.''. It has offset $1$ and begins
\[
4, 16, 66, 292, 1280, 5644, 24782, 108940,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + 7*a(n-2) + 12*a(n-3) + 14*a(n-4) + 7*a(n-5) - 2*a(n-6) - 3*a(n-7) - a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 24 2018 09:49:41, revision 7) this is still
...
\]
There are $S=57$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite.
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 7\,a(n-2) + 12\,a(n-3) + 14\,a(n-4) + 7\,a(n-5) - 2\,a(n-6) - 3\,a(n-7) - a(n-8)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A218645.
