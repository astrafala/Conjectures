...
\title{The empirical recurrence for OEIS A221196, proved by transfer matrix}
...
\begin{abstract}
OEIS A221196 counts the distinct OCCUPANCY arrays obtained when every cell of an $n\times3$ grid
...
determinising the machine that emits the occupancy row by row turns it into one, on $S=112$
...
OEIS A221196 is ``Number of n X 3 arrays of occupancy after each element moves to some horizontal, diagonal or antidiagonal neighbor, with no occupancy greater than 2.''. It has offset $1$ and begins
\[
2, 10, 46, 212, 976, 4492, 20672, 95128,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 6*a(n-1) - 6*a(n-2) - 2*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 04 2018 06:40:53, revision 11) this is still
...
\]
There are $S=112$ reachable sets. In particular $a$ is $C$-finite.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221196.
