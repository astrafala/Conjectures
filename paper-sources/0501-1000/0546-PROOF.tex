...
\title{The empirical recurrence for OEIS A264630, proved by transfer matrix}
...
\begin{abstract}
OEIS A264630 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=4$ columns in which
...
OEIS A264630 is ``Number of (3+1)X(n+1) arrays of permutations of 0..n*4+3 with each element having directed index change -2,0 -1,0 0,-1 or 1,1.''. It has offset $1$ and begins
\[
2, 4, 13, 40, 125, 393, 1200, 3759,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 19 2015 06:58:42, revision 4) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{The object is a matching}

The grid has $W=4$ columns across and holds each of $0,1,\dots,LW-1$ exactly once. The value
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-2) + 10\,a(n-3) + 4\,a(n-4) - 2\,a(n-5) - a(n-6) + 4\,a(n-7) + 18\,a(n-8) + 25\,a(n-9) - 8\,a(n-10) - 6\,a(n-11) - 10\,a(n-12) + a(n-15)
\]
for every $n>13$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264630.
