...
\title{The empirical recurrence for OEIS A221404, proved by transfer matrix}
...
\begin{abstract}
OEIS A221404 counts the distinct OCCUPANCY arrays obtained when every cell of an $n\times3$ grid
...
determinising the machine that emits the occupancy row by row turns it into one, on $S=231$
...
OEIS A221404 is ``Number of nX3 arrays of occupancy after each element stays put or moves to some horizontal or vertical neighbor, with every occupancy equal to zero or two.''. It has offset $1$ and begins
\[
0, 16, 0, 436, 0, 12668, 0, 368268,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 36*a(n-2) -200*a(n-4) -40*a(n-6) -84*a(n-8) +80*a(n-10) -20*a(n-12) +80*a(n-14)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 19:37:23, revision 11) this is still
...
\]
There are $S=231$ reachable sets. In particular $a$ is $C$-finite.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221404.
