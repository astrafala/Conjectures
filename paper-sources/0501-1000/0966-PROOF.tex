...
\title{The empirical recurrence for OEIS A221795, proved by transfer matrix}
...
\begin{abstract}
OEIS A221795 counts the distinct OCCUPANCY arrays obtained when every cell of an $n\times2$ grid
...
one, on $S=28$ states, after which the conjectured recurrence is settled by a finite exact
computation.
\end{abstract}
...
OEIS A221795 is ``Number of n X 2 arrays of occupancy after each element moves to some horizontal or vertical neighbor, without move-in move-out straight through or left turns.''. It has offset $1$ and begins
\[
1, 5, 12, 39, 112, 338, 1001, 2985,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) +6*a(n-2) +a(n-3) -4*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 11 2018 07:13:55, revision 9) this is still
...
$S=28$ reachable sets. In particular $a$ is $C$-finite.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221795.
