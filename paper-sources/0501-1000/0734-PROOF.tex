...
\title{The empirical recurrence for OEIS A279523, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A279523 imposes three things at once: a condition on each cell that reaches one row up and
...
numbers. The empirical recurrence of order $8$ contributed by R.~H.~Hardin then follows
...
OEIS A279523 is ``Number of n X 2 0..2 arrays with no element equal to a strict majority of its horizontal and vertical neighbors, with the exception of exactly one element, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
0, 4, 46, 384, 2894, 20444, 138944, 918744,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 12*a(n-1) - 36*a(n-2) - 22*a(n-3) + 140*a(n-4) - 48*a(n-5) - 121*a(n-6) + 88*a(n-7) - 16*a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 26 2018 09:15:11, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;12\,a(n-1) - 36\,a(n-2) - 22\,a(n-3) + 140\,a(n-4) - 48\,a(n-5) - 121\,a(n-6) + 88\,a(n-7) - 16\,a(n-8)
\end{equation}
for all $n>9$.
...
\[
3!\Bigl(a(n_0+j)-\sum_i c_i\,a(n_0+j-i)\Bigr)=\mathbf{v}^{\!\top}G^{\,j-8}w,
\qquad w=h_{8}-\sum_i c_i h_{8-i} .
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A279523.
