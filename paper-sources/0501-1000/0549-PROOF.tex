...
\title{The empirical recurrence for OEIS A264578, proved by transfer matrix}
...
\begin{abstract}
OEIS A264578 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=4$ rows in which
...
OEIS A264578 is ``Number of (n+1)X(3+1) arrays of permutations of 0..n*4+3 with each element having directed index change 1,0 0,-1 1,2 or -1,1.''. It has offset $1$ and begins
\[
0, 4, 4, 6, 25, 68, 112, 281,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 18 2015 20:30:58, revision 5) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-2) + 10\,a(n-3) + 4\,a(n-4) - 4\,a(n-5) - 33\,a(n-6) + 4\,a(n-7) + 25\,a(n-9) - 8\,a(n-10) + 4\,a(n-11) - 10\,a(n-12) - 2\,a(n-14) + a(n-15)
\]
for every $n>13$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264578.
