...
\title{The empirical recurrence for OEIS A229387, proved by transfer matrix}
...
\begin{abstract}
OEIS A229387 counts the distinct arrays obtained by applying a fixed local operation to every cell
...
$S=52$ states, after which the conjectured recurrence is settled by a finite exact
computation.
\end{abstract}
...
OEIS A229387 is ``Number of n X 3 0..3 arrays of the sum of the corresponding element, the element to the east and the element to the south in a larger (n+1) X 4 0..1 array.''. It has offset $1$ and begins
\[
48, 1064, 19124, 319340, 5212236, 84210828, 1353901580, 21715025932,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 25*a(n-1) -152*a(n-2) +144*a(n-3) -368*a(n-4) +1888*a(n-5) -1536*a(n-6) for n>9.
\end{quote}
As of the ``Last modified'' line on the live entry (May 12 2014 13:17:10, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;25\,a(n-1) - 152\,a(n-2) + 144\,a(n-3) - 368\,a(n-4) + 1888\,a(n-5) - 1536\,a(n-6)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A229387.
