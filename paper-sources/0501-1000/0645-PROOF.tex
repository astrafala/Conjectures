...
\title{The empirical recurrence for OEIS A264380, proved by transfer matrix}
...
\begin{abstract}
OEIS A264380 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=3$ columns in which
...
OEIS A264380 is ``Number of (2+1) X (n+1) arrays of permutations of 0..n*3+2 with each element having directed index change 2,-2 -1,0 -1,2 1,0 or 0,-1.''. It has offset $1$ and begins
\[
0, 1, 6, 9, 61, 121, 544, 1357,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + 5*a(n-2) - 6*a(n-3) + 7*a(n-4) - 4*a(n-5) - a(n-6) + 5*a(n-7) - 4*a(n-8) + 2*a(n-9) - a(n-10).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 07 2019 19:15:22, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 5\,a(n-2) - 6\,a(n-3) + 7\,a(n-4) - 4\,a(n-5) - a(n-6) + 5\,a(n-7) - 4\,a(n-8) + 2\,a(n-9) - a(n-10)
\]
for every $n>10$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264380.
