...
\title{The empirical recurrence for OEIS A221853, proved by transfer matrix}
...
\begin{abstract}
OEIS A221853 counts the distinct OCCUPANCY arrays obtained when every cell of an $n\times2$ grid
...
one, on $S=550$ states, after which the conjectured recurrence is settled by a finite exact
computation.
\end{abstract}
...
OEIS A221853 is ``Number of 2 X n arrays of occupancy after each element stays put or moves to some horizontal, diagonal or antidiagonal neighbor, without consecutive moves in the same direction.''. It has offset $1$ and begins
\[
1, 31, 302, 3437, 37155, 406612, 4434129, 48397883,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 13*a(n-1) - 14*a(n-2) - 113*a(n-3) + 189*a(n-4) - 10*a(n-5) - 42*a(n-6) + 18*a(n-7) - 2*a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 11 2018 10:45:36, revision 8) this is still
...
$S=550$ reachable sets. In particular $a$ is $C$-finite.
...
\begin{theorem}
\[
a(n)\;=\;13\,a(n-1) - 14\,a(n-2) - 113\,a(n-3) + 189\,a(n-4) - 10\,a(n-5) - 42\,a(n-6) + 18\,a(n-7) - 2\,a(n-8)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221853.
