...
\title{The empirical recurrence for OEIS A228972, proved by transfer matrix}
...
\begin{abstract}
OEIS A228972 counts the distinct arrays obtained by applying a fixed local operation to every cell
...
OEIS A228972 is ``Number of n X 2 0..2 arrays of the median of the corresponding element, the element to the east and the element to the south in a larger (n+1) X 3 0..2 array.''. It has offset $1$ and begins
\[
9, 81, 729, 6387, 55887, 488037, 4259277, 37155951,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 07 2025 19:43:02, revision 10) this is still
...
\begin{theorem}
\[
a(n)\;=\;13\,a(n-1) - 26\,a(n-2) - 122\,a(n-3) + 179\,a(n-4) + 248\,a(n-5) - 404\,a(n-6) + 135\,a(n-7) + 130\,a(n-8) - 374\,a(n-9) + 297\,a(n-10) - 120\,a(n-11) + 45\,a(n-12)
\]
for every $n>12$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A228972.
