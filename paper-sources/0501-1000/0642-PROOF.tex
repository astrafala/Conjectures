...
\title{The empirical recurrence for OEIS A220407, proved by transfer matrix}
...
\begin{abstract}
OEIS A220407 counts the distinct indicator arrays obtained from the $n\times2$ arrays over
...
OEIS A220407 is ``Equals two maps: number of 2 X n binary arrays indicating the locations of corresponding elements equal to exactly two of their horizontal, diagonal and antidiagonal neighbors in a random 0..1 2 X n array.''. It has offset $1$ and begins
\[
1, 6, 17, 40, 93, 206, 431, 924,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 31 2018 14:04:38, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 7\,a(n-2) - 14\,a(n-3) - 19\,a(n-4) + 38\,a(n-5) + 25\,a(n-6) - 50\,a(n-7) - 16\,a(n-8) + 32\,a(n-9) + 4\,a(n-10) - 8\,a(n-11)
\]
for every $n>11$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A220407.
