...
\title{The empirical recurrence for OEIS A221673, proved by transfer matrix}
...
\begin{abstract}
OEIS A221673 counts the distinct OCCUPANCY arrays obtained when every cell of an $n\times2$ grid
...
one, on $S=48$ states, after which the conjectured recurrence is settled by a finite exact
computation.
\end{abstract}
...
OEIS A221673 is ``Number of n X 2 arrays of occupancy after each element moves to some horizontal or vertical neighbor, without move-in move-out left turns.''. It has offset $1$ and begins
\[
1, 5, 27, 139, 715, 3666, 18787, 96249,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 7*a(n-1) - 9*a(n-2) - 5*a(n-3) + 10*a(n-4) - 3*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2018 09:14:21, revision 9) this is still
...
$S=48$ reachable sets. In particular $a$ is $C$-finite.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221673.
