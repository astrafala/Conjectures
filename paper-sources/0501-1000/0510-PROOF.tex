...
\title{The empirical recurrence for OEIS A221930, proved by transfer matrix}
...
\begin{abstract}
OEIS A221930 counts the distinct OCCUPANCY arrays obtained when every cell of an $n\times2$ grid
...
an empirical recurrence of order $13$ contributed by R.~H.~Hardin. It is true, and it is
...
one, on $S=466$ states, after which the conjectured recurrence is settled by a finite exact
computation.
\end{abstract}
...
OEIS A221930 is ``Number of 2Xn arrays of occupancy after each element stays put or moves to some horizontal, diagonal or antidiagonal neighbor, without move-in move-out straight through or left turns.''. It has offset $1$ and begins
\[
1, 25, 232, 2197, 20933, 198589, 1885324, 17896442,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 20:06:14, revision 8) this is still
...
$S=466$ reachable sets. In particular $a$ is $C$-finite.
...
\begin{theorem}
\[
a(n)\;=\;9\,a(n-1) + 10\,a(n-2) - 45\,a(n-3) - 57\,a(n-4) + 45\,a(n-5) - 3\,a(n-6) - 616\,a(n-7) - 57\,a(n-8) + 1200\,a(n-9) - 268\,a(n-10) - 289\,a(n-11) - 9\,a(n-12) + 6\,a(n-13)
\]
for every $n>13$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221930.
