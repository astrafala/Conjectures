...
\title{The empirical recurrence for OEIS A229681, proved by counting defective colourings}
...
\begin{abstract}
OEIS A229681 counts the colourings of an array with $K=3$ colours that are proper except at
...
order $3$ contributed by R.~H.~Hardin follows from a finite exact computation.
\end{abstract}
...
OEIS A229681 is ``Number of defective 3-colorings of an n X 4 0..2 array connected diagonally and antidiagonally with exactly two mistakes, and colors introduced in row-major 0..2 order.''. It has offset $1$ and begins
\[
0, 360, 10896, 186576, 2700432, 35485776, 437924880, 5169543120,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 27*a(n-1) - 243*a(n-2) + 729*a(n-3) for n > 6.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 28 2021 01:23:52, revision 11) the statement is
...
\[
3!\Bigl(a(n_0+j)-\sum_i c_i\,a(n_0+j-i)\Bigr)=\mathbf{v}^{\!\top}G^{\,j-3}w,
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A229681.
