...
\title{The empirical recurrence for OEIS A270511, proved by an exact quasi-polynomial}
...
\begin{abstract}
OEIS A270511 counts triangular arrays of a FIXED shape over the alphabet $0..n$, and carries an
...
\[
15, 144, 1137, 4584, 15843, 40392,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) +3*a(n-2) -8*a(n-3) -2*a(n-4) +12*a(n-5) -2*a(n-6) -8*a(n-7) +3*a(n-8) +2*a(n-9) -a(n-10)
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 18 2016 08:06:26, revision 4) this is still
...
A(n)=9n^{5} - 36n^{4} + 102n^{3} - \tfrac{267}{2}n^{2} + 93n - 21,
\]
\[
...
\[
a(n)=\begin{cases}
9n^{5} - 36n^{4} + 96n^{3} - 111n^{2} + 54n, & n\ \text{even},\\[2pt]
9n^{5} - 36n^{4} + 108n^{3} - 156n^{2} + 132n - 42, & n\ \text{odd},
\end{cases}
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A270511.
