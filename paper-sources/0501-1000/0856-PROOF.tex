...
\title{The empirical recurrence for OEIS A281982, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A281982 imposes three things at once: a condition on each cell that reaches one row up and
...
OEIS A281982 is ``Number of n X 2 0..1 arrays with no element unequal to more than four of its king-move neighbors, with the exception of exactly one element, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
0, 0, 2, 16, 88, 432, 2008, 8992,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 8*a(n-1) - 20*a(n-2) + 24*a(n-3) - 36*a(n-4) + 16*a(n-5) - 16*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 20 2019 09:51:21, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;8\,a(n-1) - 20\,a(n-2) + 24\,a(n-3) - 36\,a(n-4) + 16\,a(n-5) - 16\,a(n-6)
\end{equation}
for all $n>7$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A281982.
