...
\title{The empirical recurrence for OEIS A279323, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A279323 imposes three things at once: a condition on each cell that reaches one row up and
...
OEIS A279323 is ``Number of nX2 0..2 arrays with no element equal to a strict majority of its king-move neighbors, with the exception of exactly one element, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
0, 0, 16, 152, 1536, 13776, 118664, 991616,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 16*a(n-1) -68*a(n-2) -16*a(n-3) +300*a(n-4) +576*a(n-5) -992*a(n-6) -1856*a(n-7) -832*a(n-8) +1280*a(n-9) -256*a(n-10)
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 09 2016 22:58:41, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;16\,a(n-1) - 68\,a(n-2) - 16\,a(n-3) + 300\,a(n-4) + 576\,a(n-5) - 992\,a(n-6) - 1856\,a(n-7) - 832\,a(n-8) + 1280\,a(n-9) - 256\,a(n-10)
\end{equation}
for all $n>11$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A279323.
