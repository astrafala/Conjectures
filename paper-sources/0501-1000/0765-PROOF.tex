...
\title{The empirical recurrence for OEIS A279971, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A279971 imposes three things at once: a condition on each cell that reaches one row up and
...
OEIS A279971 is ``Number of n X 2 0..1 arrays with no element equal to a strict majority of its horizontal and antidiagonal neighbors, with the exception of exactly two elements, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
1, 3, 9, 31, 108, 366, 1205, 3873,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 9*a(n-1) - 30*a(n-2) + 45*a(n-3) - 30*a(n-4) + 9*a(n-5) -a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 12 2019 12:02:23, revision 7) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A279971.
