...
\title{The empirical recurrence for OEIS A221251, proved by transfer matrix}
...
\begin{abstract}
OEIS A221251 counts the distinct OCCUPANCY arrays obtained when every cell of an $n\times4$ grid
...
determinising the machine that emits the occupancy row by row turns it into one, on $S=517$
...
OEIS A221251 is ``Number of nX4 arrays of occupancy after each element moves to some horizontal or antidiagonal neighbor, with no occupancy greater than 2.''. It has offset $1$ and begins
\[
4, 81, 2116, 58081, 1612900, 44903401, 1250753956, 34842328921,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 19:25:33, revision 8) this is still
...
\]
There are $S=517$ reachable sets. In particular $a$ is $C$-finite.
...
\begin{theorem}
\[
a(n)\;=\;39\,a(n-1) - 356\,a(n-2) + 1365\,a(n-3) - 2739\,a(n-4) + 2904\,a(n-5) - 1683\,a(n-6) + 573\,a(n-7) - 116\,a(n-8) + 15\,a(n-9) - a(n-10)
\]
for every $n>10$.
\end{theorem}
...
arithmetic. The entry's first term is $4$, and it is a sharp test of the boundary: a
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221251.
