...
\title{The empirical recurrence for OEIS A303632, proved by transfer matrix}
...
\begin{abstract}
OEIS A303632 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A303632 is ``Number of nX4 0..1 arrays with every element unequal to 2 or 3 horizontally or vertically adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
0, 2, 1, 4, 8, 22, 47, 123,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 27 2018 10:14:27, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + a(n-2) - 5\,a(n-3) + a(n-4) - 4\,a(n-5) - 9\,a(n-6) - a(n-7) + 39\,a(n-8) - 5\,a(n-9) - 26\,a(n-10) + 22\,a(n-11) - a(n-12) + a(n-13) - 8\,a(n-14) - a(n-15) + 2\,a(n-16)
\end{equation}
for all $n>16$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A303632.
