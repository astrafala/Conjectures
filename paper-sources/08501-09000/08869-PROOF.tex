...
\title{The empirical recurrence for OEIS A207249, proved by transfer matrix}
...
\begin{abstract}
OEIS A207249 counts arrays over $\{0,\dots,1\}$ of width $3$ that avoid the patterns
...
OEIS A207249 is ``Number of n X 3 0..1 arrays avoiding 0 0 1 and 1 0 1 horizontally and 0 1 0 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
6, 36, 102, 370, 1232, 4238, 14406,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) + 4*a(n-2) + 7*a(n-4) + 8*a(n-5) - a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 20 2018 14:26:44, revision
...
$(0,0,1), (1,0,1)$ as $3$ consecutive entries. There are $6$ admissible rows; that condition
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207249.
