...
\title{The empirical recurrence for OEIS A260975, proved by transfer matrix}
...
\begin{abstract}
OEIS A260975 counts $(n+2)\times5$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A260975 is ``Number of (n+2)X(3+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000001 00001001 or 00100101.''. It has offset $1$ and begins
\[
204, 239, 372, 732, 1288, 2576, 4688, 8760,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 8*a(n-4) +6*a(n-5) +10*a(n-7) +5*a(n-8) -24*a(n-9) -4*a(n-10) -26*a(n-11) +39*a(n-12) -a(n-14) for n>18
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 12:13:16, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-4) + 6\,a(n-5) + 10\,a(n-7) + 5\,a(n-8) - 24\,a(n-9) - 4\,a(n-10) - 26\,a(n-11) + 39\,a(n-12) - a(n-14)
\]
for every $n>18$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A260975.
