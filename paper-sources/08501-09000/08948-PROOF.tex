...
\title{The empirical recurrence for OEIS A202400, proved by transfer matrix}
...
\begin{abstract}
OEIS A202400 counts arrays of width $4$ over $\{0,1\}$ containing no occurrence of certain short
...
OEIS A202400 is ``Number of (n+2) X 4 binary arrays avoiding patterns 000 and 010 in rows and columns.''. It has offset $1$ and begins
\[
441, 2401, 14161, 83521, 485809, 2825761, 16475481, 96059601,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 6*a(n-1) - 6*a(n-2) + 30*a(n-3) - 30*a(n-5) + 6*a(n-6) - 6*a(n-7) + a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (May 28 2018 08:41:50, revision 10) this is still
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) - 6\,a(n-2) + 30\,a(n-3) - 30\,a(n-5) + 6\,a(n-6) - 6\,a(n-7) + a(n-8)
\]
for every $n>5$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A202400.
