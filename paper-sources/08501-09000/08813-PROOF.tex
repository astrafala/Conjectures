...
\title{The empirical recurrence for OEIS A231510, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A231510 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A231510 is ``Number of nX3 0..1 arrays with no element less than a strict majority of its horizontal, vertical, diagonal and antidiagonal neighbors.''. It has offset $1$ and begins
\[
4, 14, 78, 343, 1537, 7505, 35872, 168887,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 06:32:49, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) + 19\,a(n-3) + 4\,a(n-4) - 56\,a(n-5) - 49\,a(n-6) - 44\,a(n-7) - 93\,a(n-8) + 91\,a(n-9) - 11\,a(n-10) + 105\,a(n-11) + 153\,a(n-12) + 75\,a(n-13) + 98\,a(n-14) + 21\,a(n-15) + 28\,a(n-16)
\end{equation}
for all $n>17$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231510.
