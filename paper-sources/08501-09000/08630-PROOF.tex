...
\title{The empirical recurrence for OEIS A301962, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A301962 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A301962 is ``Number of nX6 0..1 arrays with every element equal to 0, 1 or 4 horizontally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
13, 22, 74, 219, 749, 2544, 8705, 29750,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +8*a(n-2) +4*a(n-3) -8*a(n-4) -7*a(n-5) -a(n-6) -3*a(n-7) +a(n-8) +5*a(n-9) -3*a(n-10) +a(n-11) for n>12
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 29 2018 13:00:41, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 8\,a(n-2) + 4\,a(n-3) - 8\,a(n-4) - 7\,a(n-5) - a(n-6) - 3\,a(n-7) + a(n-8) + 5\,a(n-9) - 3\,a(n-10) + a(n-11)
\end{equation}
for all $n>12$.
...
publishes, $n=24$, the arrays have $6\cdot24$ cells over
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A301962.
