...
\title{The empirical recurrence for OEIS A267231, proved by transfer matrix}
...
\begin{abstract}
OEIS A267231 carries an empirical recurrence of order $8$ contributed by R.~H.~Hardin. It is
...
OEIS A267231 is ``Number of length-n 0..7 arrays with no following elements greater than or equal to the first repeated value.''. It has offset $1$ and begins
\[
8, 64, 476, 3472, 25088, 180292, 1291052, 9222184,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 05 2018 17:09:55, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;35\,a(n-1) - 518\,a(n-2) + 4214\,a(n-3) - 20489\,a(n-4) + 60515\,a(n-5) - 104992\,a(n-6) + 96516\,a(n-7) - 35280\,a(n-8)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267231.
