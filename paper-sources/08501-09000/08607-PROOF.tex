...
\title{The empirical recurrence for OEIS A228758, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A228758 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A228758 is ``Number of 6Xn binary arrays with top left element equal to 1 and no two ones adjacent horizontally or antidiagonally.''. It has offset $1$ and begins
\[
32, 144, 3111, 29608, 418370, 4823826, 61534448, 746135864,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 04 2025 00:07:19, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 119\,a(n-2) + 397\,a(n-3) - 1395\,a(n-4) - 5213\,a(n-5) + 8797\,a(n-6) + 24443\,a(n-7) - 36756\,a(n-8) - 45888\,a(n-9) + 84092\,a(n-10) + 19388\,a(n-11) - 83412\,a(n-12) + 24912\,a(n-13) + 22741\,a(n-14) - 12257\,a(n-15) - 1459\,a(n-16) + 1607\,a(n-17) - 49\,a(n-18) - 71\,a(n-19) + 3\,a(n-20) + a(n-21)
\end{equation}
for all $n>22$.
...
publishes, $n=16$, the arrays have $6\cdot16$ cells over
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A228758.
