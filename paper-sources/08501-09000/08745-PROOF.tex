...
\title{The empirical recurrence for OEIS A297602, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297602 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A297602 is ``Number of nX3 0..1 arrays with every 1 horizontally, diagonally or antidiagonally adjacent to 0, 1 or 3 neighboring 1s.''. It has offset $1$ and begins
\[
7, 35, 181, 953, 4997, 26155, 137033, 717905,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 5*a(n-1) -a(n-2) +19*a(n-3) -36*a(n-4) -62*a(n-6) +62*a(n-7) +24*a(n-8) +4*a(n-9) -40*a(n-10) -32*a(n-11)
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 01 2018 14:49:57, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) - a(n-2) + 19\,a(n-3) - 36\,a(n-4) - 62\,a(n-6) + 62\,a(n-7) + 24\,a(n-8) + 4\,a(n-9) - 40\,a(n-10) - 32\,a(n-11)
\end{equation}
for all $n>12$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297602.
