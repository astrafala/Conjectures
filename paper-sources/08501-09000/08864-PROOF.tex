...
\title{The empirical recurrence for OEIS A250539, proved by transfer matrix}
...
\begin{abstract}
OEIS A250539 counts arrays over $\{0,1,2,3\}$ in which a statistic taken over short runs
...
OEIS A250539 is ``Number of (n+1)X(3+1) 0..3 arrays with nondecreasing x(i,j)-x(i,j-1) in the i direction and nondecreasing x(i,j)-x(i-1,j) in the j direction.''. It has offset $1$ and begins
\[
6627, 79366, 644779, 4169584, 23289547, 117777788, 555362165, 2489782728,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 12:31:23, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250539.
