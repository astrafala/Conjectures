...
\title{The empirical recurrence for OEIS A237092, proved by transfer matrix}
...
\begin{abstract}
OEIS A237092 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
OEIS A237092 is ``Number of (n+1) X (1+1) 0..2 arrays with the maximum plus the lower median minus the upper median of every 2 X 2 subblock equal.''. It has offset $1$ and begins
\[
81, 303, 1178, 4783, 19735, 83052, 352077, 1509309,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 26 2022 04:08:59, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) + 24\,a(n-2) - 133\,a(n-3) - 161\,a(n-4) + 1148\,a(n-5) + 166\,a(n-6) - 3580\,a(n-7) + 364\,a(n-8) + 4024\,a(n-9) - 48\,a(n-10) - 1120\,a(n-11)
\]
for every $n>11$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237092.
