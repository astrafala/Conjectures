...
\title{The empirical recurrence for OEIS A260835, proved by transfer matrix}
...
\begin{abstract}
OEIS A260835 counts $(n+2)\times4$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A260835 is ``Number of (n+2)X(2+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000001 00000011 or 00010101.''. It has offset $1$ and begins
\[
82, 131, 288, 496, 796, 1645, 2976, 4890,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 12:11:28, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 5\,a(n-3) - a(n-4) - 3\,a(n-5) - 5\,a(n-6) + 3\,a(n-9) - 2\,a(n-10) - 5\,a(n-11) - 2\,a(n-12) - a(n-13) + 5\,a(n-14) - 2\,a(n-15) - 2\,a(n-17) + 2\,a(n-18)
\]
for every $n>19$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A260835.
