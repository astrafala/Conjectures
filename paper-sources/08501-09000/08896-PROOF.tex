...
\title{The empirical recurrence for OEIS A304600, proved by transfer matrix}
...
\begin{abstract}
OEIS A304600 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A304600 is ``Number of nX4 0..1 arrays with every element unequal to 0, 1, 2, 5 or 6 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
8, 9, 23, 73, 179, 515, 1450, 4024,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 15 2018 13:28:51, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 4\,a(n-2) - 5\,a(n-3) + 4\,a(n-4) - 4\,a(n-5) - 29\,a(n-6) + 18\,a(n-7) + 16\,a(n-8) - 7\,a(n-9) + 30\,a(n-10) - 8\,a(n-11) - 24\,a(n-12) + 12\,a(n-13) - 20\,a(n-15) + 12\,a(n-17)
\end{equation}
for all $n>22$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A304600.
