...
\title{The empirical recurrence for OEIS A243639, proved by transfer matrix}
...
\begin{abstract}
OEIS A243639 carries an empirical recurrence of order $14$ contributed by R.~H.~Hardin. It is
...
OEIS A243639 is ``Number of length n+2 0..8 arrays with no three unequal elements in a row and new values 0..8 introduced in 0..8 order.''. It has offset $1$ and begins
\[
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 11:21:23, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;15\,a(n-1) - 76\,a(n-2) + 78\,a(n-3) + 554\,a(n-4) - 1518\,a(n-5) - 1000\,a(n-6) + 6492\,a(n-7) - 505\,a(n-8) - 13105\,a(n-9) + 2036\,a(n-10) + 13670\,a(n-11) + 672\,a(n-12) - 5632\,a(n-13) - 1680\,a(n-14)
\]
for every $n>15$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A243639.
