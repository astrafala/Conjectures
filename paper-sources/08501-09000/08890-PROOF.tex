...
\title{The empirical recurrence for OEIS A253522, proved by transfer matrix}
...
\begin{abstract}
OEIS A253522 counts the arrays over $\{0,\dots,2\}$ whose $2\times2$ subblocks carry a
...
so a pair of consecutive array rows is a state, the count is a walk count on $S=192393$ of them,
...
OEIS A253522 is ``Number of (n+1)X(6+1) 0..2 arrays with every 2X2 subblock diagonal minimum minus antidiagonal minimum nondecreasing horizontally and diagonal maximum minus antidiagonal maximum nondecreasing vertically.''. It has offset $1$ and begins
\[
192393, 666239, 791232, 930046, 1439791, 2662626, 5591131, 13347833,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 9*a(n-1) -33*a(n-2) +65*a(n-3) -75*a(n-4) +51*a(n-5) -19*a(n-6) +3*a(n-7) for n>15
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 14:05:36, revision 6) this is still
...
\]
on the $S=192393$ admissible pairs. In particular $a$ is $C$-finite. The alignment of the walk
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253522.
