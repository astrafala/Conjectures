...
\title{The empirical recurrence for OEIS A234675, proved by transfer matrix}
...
\begin{abstract}
OEIS A234675 counts $3$-column arrays over $\{0,\dots,5\}$ in which every
...
OEIS A234675 is ``Number of (n+1) X (2+1) 0..5 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 5 (constant-stress 1 X 1 tilings).''. It has offset
$1$ and begins
\[
404, 1152, 2924, 9108, 25292, 82956, 243164,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 20 2022 18:44:34, revision 6) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234675.
