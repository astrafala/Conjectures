...
\title{The empirical recurrence for OEIS A189618, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A189618 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A189618 is ``Number of 3Xn binary arrays without the pattern 0 1 0 diagonally, antidiagonally or horizontally.''. It has offset $1$ and begins
\[
8, 64, 292, 1164, 5238, 25046, 116100, 526418,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 05:22:09, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) - 8\,a(n-2) + 24\,a(n-3) + 35\,a(n-4) - 90\,a(n-5) + 103\,a(n-6) - 92\,a(n-7) - 479\,a(n-8) + 312\,a(n-9) + 411\,a(n-10) - 97\,a(n-11) + 212\,a(n-12) - 154\,a(n-13) - 300\,a(n-14) + 72\,a(n-15) - 175\,a(n-16) + 42\,a(n-17) - 20\,a(n-18) + 4\,a(n-19)
\end{equation}
for all $n>20$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A189618.
