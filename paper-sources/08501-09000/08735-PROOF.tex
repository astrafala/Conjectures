...
\title{The empirical recurrence for OEIS A250541, proved by transfer matrix}
...
\begin{abstract}
OEIS A250541 counts arrays over $\{0,1,2,3\}$ in which a statistic taken over short runs
...
OEIS A250541 is ``Number of (n+1)X(5+1) 0..3 arrays with nondecreasing x(i,j)-x(i,j-1) in the i direction and nondecreasing x(i,j)-x(i-1,j) in the j direction.''. It has offset $1$ and begins
\[
187000, 2701872, 23289547, 151170400, 824599694, 4013192386, 18064444143, 76961701472,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 12:31:29, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250541.
