...
\title{The empirical recurrence for OEIS A252271, proved by transfer matrix}
...
\begin{abstract}
OEIS A252271 counts $(n+2)\times3$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252271 is ``Number of (n+2) X (1+2) 0..3 arrays with every 3 X 3 subblock row and column sum not equal to 2 3 4 6 or 7 and every 3 X 3 diagonal and antidiagonal sum equal to 2 3 4 6 or 7.''. It has offset $1$ and begins
\[
206, 185, 232, 322, 535, 852, 1260, 2221,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 6*a(n-3) - 7*a(n-6) + 2*a(n-9) for n>12.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 03 2018 06:28:42, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252271.
