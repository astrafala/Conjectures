...
\title{The empirical recurrence for OEIS A207712, proved by transfer matrix}
...
\begin{abstract}
OEIS A207712 counts arrays over $\{0,\dots,1\}$ of width $3$ that avoid the patterns
...
OEIS A207712 is ``Number of n X 3 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 0 1 and 1 0 0 vertically.''. It has offset
$1$ and begins
\[
6, 36, 114, 387, 1414, 5302, 20265,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 6*a(n-1) - 4*a(n-2) - 23*a(n-3) + 20*a(n-4) + 28*a(n-5) - 13*a(n-6) - 14*a(n-7) + a(n-9) for n>10.
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 05 2018 11:21:04, revision
8) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) - 4\,a(n-2) - 23\,a(n-3) + 20\,a(n-4) + 28\,a(n-5) - 13\,a(n-6) - 14\,a(n-7) + a(n-9)
\end{equation}
for all $n>10$. 
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207712.
