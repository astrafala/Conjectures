...
\title{The empirical recurrence for OEIS A250512, proved by transfer matrix}
...
\begin{abstract}
OEIS A250512 counts arrays over $\{0,1,2,3\}$ in which a statistic taken over short runs
...
OEIS A250512 is ``Number of (n+1)X(1+1) 0..3 arrays with nondecreasing min(x(i,j),x(i,j-1)) in the i direction and nondecreasing min(x(i,j),x(i-1,j)) in the j direction.''. It has offset $1$ and begins
\[
120, 889, 5996, 39187, 248942, 1555689, 9605300, 58826247,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 10*a(n-1) - 15*a(n-2) - 80*a(n-3) + 122*a(n-4) + 228*a(n-5) - 120*a(n-6) - 144*a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 14 2018 11:04:25, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;10\,a(n-1) - 15\,a(n-2) - 80\,a(n-3) + 122\,a(n-4) + 228\,a(n-5) - 120\,a(n-6) - 144\,a(n-7)
\]
for every $n>6$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250512.
