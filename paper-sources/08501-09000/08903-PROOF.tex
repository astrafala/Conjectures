...
\title{The empirical recurrence for OEIS A210070, proved by transfer matrix}
...
\begin{abstract}
OEIS A210070 counts $(n+1)\times2$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A210070 is ``1/4 the number of (n+1) X 2 0..3 arrays with every 2 X 2 subblock having one or three distinct clockwise edge differences.''. It has offset $1$ and begins
\[
33, 313, 2908, 27129, 252951, 2358878, 21997263, 205132657,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 9*a(n-1) + 9*a(n-2) - 50*a(n-3) - 54*a(n-4) + 12*a(n-5) + 16*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 14 2018 05:56:11, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;9\,a(n-1) + 9\,a(n-2) - 50\,a(n-3) - 54\,a(n-4) + 12\,a(n-5) + 16\,a(n-6)
\end{equation}
for all $n>5$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A210070.
