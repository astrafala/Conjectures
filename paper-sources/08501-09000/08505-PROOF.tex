...
\title{The empirical recurrence for OEIS A207312, proved by transfer matrix}
...
\begin{abstract}
OEIS A207312 counts arrays of width $3$ over $\{0,1,2\}$ containing no occurrence of certain short
...
OEIS A207312 is ``Number of nX3 0..2 arrays avoiding the pattern z-2 z-1 z in any row, column or nw-to-se diagonal.''. It has offset $1$ and begins
\[
26, 676, 15390, 347502, 7791488, 174545777, 3908531208, 87515884741,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 13:46:21, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;27\,a(n-1) - 43\,a(n-2) - 1591\,a(n-3) + 4195\,a(n-4) + 31861\,a(n-5) - 81210\,a(n-6) - 248372\,a(n-7) + 529289\,a(n-8) + 552322\,a(n-9) - 1158991\,a(n-10) - 641935\,a(n-11) + 1301158\,a(n-12) + 424638\,a(n-13) - 829889\,a(n-14) - 156675\,a(n-15) + 298360\,a(n-16) + 28115\,a(n-17) - 53314\,a(n-18) - 1015\,a(n-19) + 2751\,a(n-20) + 80\,a(n-21) - 64\,a(n-22)
\]
for every $n>21$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207312.
