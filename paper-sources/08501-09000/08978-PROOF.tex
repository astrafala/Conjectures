...
\title{The empirical recurrence for OEIS A303310, proved by transfer matrix}
...
\begin{abstract}
OEIS A303310 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A303310 is ``Number of nX4 0..1 arrays with every element equal to 0, 1, 4, 5 or 6 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
5, 5, 17, 36, 74, 165, 361, 783,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +a(n-2) +3*a(n-3) +2*a(n-4) -a(n-5) -2*a(n-6) -a(n-7) for n>10
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 21 2018 12:45:40, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + a(n-2) + 3\,a(n-3) + 2\,a(n-4) - a(n-5) - 2\,a(n-6) - a(n-7)
\end{equation}
for all $n>10$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A303310.
