...
\title{The empirical recurrence for OEIS A222142, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A222142 counts arrays over $\{0,\dots,4\}$ in which every cell is constrained by the
...
OEIS A222142 is ``Number of nX6 0..4 arrays with no entry increasing mod 5 by 4 rightwards or downwards, starting with upper left zero.''. It has offset $1$ and begins
\[
1024, 1485172, 2154990196, 3127020364012, 4537511642094436, 6584229526795818280, 9554152945600145235628, 13863708507689968892320744,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 20:12:17, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;1910\,a(n-1) - 746856\,a(n-2) + 124320628\,a(n-3) - 10313248058\,a(n-4) + 417297259303\,a(n-5) - 5371776948993\,a(n-6) - 144881780734145\,a(n-7) + 5274831960463364\,a(n-8) - 45780209792137640\,a(n-9) - 140573041383130216\,a(n-10) + 3955153630968769080\,a(n-11) - 18222739641404543648\,a(n-12) + 22673499799174192384\,a(n-13)
\end{equation}
for all $n>13$.
...
x_{t,u+1}\ne x_{t,u}+4\ (\mathrm{mod}\ 5)\ \text{ and }\ x_{t+1,u}\ne x_{t,u}+4\ (\mathrm{mod}\ 5)
\end{equation}
...
Let $V=\{0,\dots,4\}^{6}$ be the possible rows and take
...
and $6$ cells in a row, so $|V|=5^{6}=15625$, and the vertex set is
$V\times V$, of size $15625^2=15625$. That is the whole of the state: two consecutive
...
publishes, $n=10$, the arrays have $6\cdot10$ cells over
$5$ values, so there are about $10^{41}$ of them to sift. The
...
of the $(4+1)^{6}$ possible next rows, the condition was tested on every cell of
...
every one of the $10$ published indices, with no shift fitted: the number of rows is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A222142.
