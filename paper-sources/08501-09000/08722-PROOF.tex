...
\title{The empirical recurrence for OEIS A254085, proved by transfer matrix}
...
\begin{abstract}
OEIS A254085 counts the arrays over $\{0,\dots,1\}$ whose $3\times3$ subblocks carry a
...
OEIS A254085 is ``Number of (n+2)X(1+2) 0..1 arrays with every 3X3 subblock diagonal maximum minus antidiagonal maximum nondecreasing horizontally, vertically and ne-to-sw antidiagonally.''. It has offset $1$ and begins
\[
512, 3436, 22728, 148004, 977192, 6446656, 42580424, 281186200,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 14:27:07, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) + 7\,a(n-2) - 18\,a(n-3) + 14\,a(n-4) - 156\,a(n-5) - 116\,a(n-6) + 72\,a(n-7) + 32\,a(n-8) + 96\,a(n-9) + 64\,a(n-10)
\]
for every $n>17$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A254085.
