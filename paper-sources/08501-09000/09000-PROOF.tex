...
\title{The empirical recurrence for OEIS A283037, proved by transfer matrix}
...
\begin{abstract}
OEIS A283037 counts $n\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A283037 is ``Number of nX3 0..1 arrays with no 1 equal to more than one of its horizontal and vertical neighbors, with the exception of exactly one element.''. It has offset $1$ and begins
\[
1, 16, 119, 818, 5065, 30378, 175963, 997302,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 27 2017 08:55:38, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + 16\,a(n-2) - 154\,a(n-4) - 470\,a(n-5) - 644\,a(n-6) - 306\,a(n-7) + 401\,a(n-8) + 700\,a(n-9) + 315\,a(n-10) - 82\,a(n-11) - 168\,a(n-12) - 104\,a(n-13) - 11\,a(n-14) + 14\,a(n-15) + 5\,a(n-16) + 2\,a(n-17) - a(n-18)
\]
for every $n>18$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A283037.
