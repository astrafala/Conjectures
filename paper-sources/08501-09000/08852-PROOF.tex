...
\title{The empirical recurrence for OEIS A251274, proved by transfer matrix}
...
\begin{abstract}
OEIS A251274 counts $8\times(n+1)$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A251274 is ``Number of (7+1)X(n+1) 0..1 arrays with no 2X2 subblock having x11-x00 less than x10-x01.''. It has offset $1$ and begins
\[
10179, 161906, 1501739, 9772880, 49523566, 208452452, 760734085, 2480493084,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 10:20:31, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;17\,a(n-1) - 135\,a(n-2) + 665\,a(n-3) - 2275\,a(n-4) + 5733\,a(n-5) - 11011\,a(n-6) + 16445\,a(n-7) - 19305\,a(n-8) + 17875\,a(n-9) - 13013\,a(n-10) + 7371\,a(n-11) - 3185\,a(n-12) + 1015\,a(n-13) - 225\,a(n-14) + 31\,a(n-15) - 2\,a(n-16)
\end{equation}
for all $n>15$.
...
$V=\{0,1,\dots,1\}^{8}$, so $|V|=S=256$. A $2\times2$ subblock of the array
...
\begin{proof}
An array with $L$ columns and $8$ rows is precisely a sequence
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251274.
