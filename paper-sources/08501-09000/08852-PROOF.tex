...
\title{The empirical recurrence for OEIS A254257, proved by transfer matrix}
...
\begin{abstract}
OEIS A254257 counts the arrays over $\{0,\dots,1\}$ whose $3\times3$ subblocks carry a
...
OEIS A254257 is ``Number of (n+2)X(5+2) 0..1 arrays with every 3X3 subblock sum of the two maximums of the diagonal and antidiagonal minus the sum of the minimums of the central row and column nondecreasing horizontally, vertically and ne-to-sw antidiagonally.''. It has offset $1$ and begins
\[
236024, 1989857, 7815717, 12249828, 35691048, 87535036, 214982444, 718305580,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 14:35:18, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + 2\,a(n-2) + 12\,a(n-3) - 32\,a(n-4) - 16\,a(n-5) + 96\,a(n-6) - 1600\,a(n-7) + 512\,a(n-8) + 29696\,a(n-10) - 20480\,a(n-11) - 8192\,a(n-12) - 131072\,a(n-13) + 131072\,a(n-14)
\]
for every $n>21$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A254257.
