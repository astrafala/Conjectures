...
\title{The empirical recurrence for OEIS A196212, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A196212 counts arrays over $\{0,\dots,4\}$ in which every cell is constrained by the
...
OEIS A196212 is ``Number of n X 2 0..4 arrays with each element x equal to the number its horizontal and vertical neighbors equal to 3,0,1,2,4 for x=0,1,2,3,4.''. It has offset $1$ and begins
\[
3, 9, 20, 61, 189, 544, 1629, 4973,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) +4*a(n-2) +6*a(n-3) -8*a(n-4) -39*a(n-5) -33*a(n-6) -17*a(n-7) +5*a(n-8) +8*a(n-9) +a(n-10).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 22 2018 09:36:42, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 4\,a(n-2) + 6\,a(n-3) - 8\,a(n-4) - 39\,a(n-5) - 33\,a(n-6) - 17\,a(n-7) + 5\,a(n-8) + 8\,a(n-9) + a(n-10)
\end{equation}
for all $n>11$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A196212.
