...
\title{The empirical recurrence for OEIS A186873, proved by transfer matrix}
...
\begin{abstract}
OEIS A186873 counts the $(n+2)\times3$ arrays over $\{0,\dots,3\}$ in which
...
a state, the count is a walk count on $S=262144$ of them, and the conjectured recurrence is then
...
OEIS A186873 is ``Number of (n+2)X3 0..3 arrays with every 3X3 subblock commuting with each horizontal and vertical neighbor 3X3 subblock.''. It has offset $1$ and begins
\[
262144, 2428, 19236, 46583, 104701, 186096, 277659, 322910,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n)=2*a(n-1)-a(n-2)+3*a(n-3)-6*a(n-4)+3*a(n-5)+3*a(n-6)-3*a(n-7) for n>20
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 03:45:54, revision 9) this is still
...
$262144$, which the model reproduces along with every later term.
...
\]
on the $S=262144$ admissible $3$-tuples. In particular $a$ is $C$-finite.
...
size of the construction is therefore $4^{3\cdot3}$ before the condition prunes
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A186873.
