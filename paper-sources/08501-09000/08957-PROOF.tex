...
\title{The empirical recurrence for OEIS A234698, proved by transfer matrix}
...
\begin{abstract}
OEIS A234698 counts $3$-column arrays over $\{0,\dots,7\}$ in which every
...
OEIS A234698 is ``Number of (n+1) X (2+1) 0..7 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 5 (constant-stress 1 X 1 tilings).''. It has offset
$1$ and begins
\[
2628, 13952, 74308, 409268, 2261220, 12903164, 73793620,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 20 2022 19:53:55, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;15\,a(n-1) + 125\,a(n-2) - 2865\,a(n-3) - 1490\,a(n-4) + 219360\,a(n-5) - 507740\,a(n-6) - 8437740\,a(n-7) + 34905816\,a(n-8) + 161734320\,a(n-9) - 1006299360\,a(n-10) - 1062547200\,a(n-11) + 13887417600\,a(n-12) - 8926848000\,a(n-13) - 75188736000\,a(n-14) + 121927680000\,a(n-15)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234698.
