...
\title{The empirical recurrence for OEIS A298050, proved by transfer matrix}
...
\begin{abstract}
OEIS A298050 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A298050 is ``Number of nX3 0..1 arrays with every element equal to 1, 2, 4 or 6 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 7, 15, 19, 23, 34, 63, 96,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 11 2018 07:16:52, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) - a(n-2) - 2\,a(n-3) - 3\,a(n-5) + 3\,a(n-6) + 3\,a(n-7) - a(n-8) + 2\,a(n-9) + 6\,a(n-10) - 8\,a(n-11) - 3\,a(n-12) - 4\,a(n-13) - 2\,a(n-14) + 4\,a(n-15) + 8\,a(n-16) - a(n-17) - 3\,a(n-18)
\end{equation}
for all $n>19$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A298050.
