...
\title{The empirical recurrence for OEIS A245946, proved by transfer matrix}
...
\begin{abstract}
OEIS A245946 carries an empirical recurrence of order $15$ contributed by R.~H.~Hardin. It is
...
OEIS A245946 is ``Number of length n+3 0..4 arrays with some pair in every consecutive four terms totalling exactly 4.''. It has offset $1$ and begins
\[
453, 1889, 7769, 31465, 128649, 525041, 2141609, 8740385,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 26 2021 19:28:33, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + 5\,a(n-2) + 3\,a(n-3) - 10\,a(n-4) - 37\,a(n-5) - 48\,a(n-6) - 37\,a(n-7) + 83\,a(n-8) + 143\,a(n-9) + 5\,a(n-10) - 11\,a(n-11) - 41\,a(n-12) - 10\,a(n-13) - 2\,a(n-14) + 3\,a(n-15)
\]
for every $n>-2$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A245946.
