...
\title{The empirical recurrence for OEIS A304053, proved by transfer matrix}
...
\begin{abstract}
OEIS A304053 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A304053 is ``Number of nX3 0..1 arrays with every element unequal to 1, 2, 4 or 5 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 11, 6, 18, 32, 60, 124, 288,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 05 2018 15:18:04, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 2\,a(n-2) + 7\,a(n-3) - 3\,a(n-4) - 11\,a(n-5) - 21\,a(n-6) - 8\,a(n-7) + 13\,a(n-8) + 25\,a(n-9) + 22\,a(n-10) + 4\,a(n-11) + 3\,a(n-12) - 6\,a(n-13) - 6\,a(n-14) - 9\,a(n-15)
\end{equation}
for all $n>18$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A304053.
