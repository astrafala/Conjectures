...
\title{The empirical recurrence for OEIS A223594, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A223594 counts arrays over $\{0,\dots,15\}$ in which every cell is constrained by the
...
$16$ values, so there are about $10^{57}$ of them to sift. The
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223594.
