...
\title{The empirical recurrence for OEIS A230332, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A230332 counts arrays over $\{0,\dots,2\}$ in which every cell is constrained by the
...
OEIS A230332 is ``Number of nX3 0..2 arrays x(i,j) with each element horizontally, vertically or antidiagonally next to at least one element with value (x(i,j)+1) mod 3, and upper left element zero.''. It has offset $1$ and begins
\[
0, 34, 534, 9162, 157200, 2696012, 46237080, 792976550,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 15*a(n-1) +37*a(n-2) +6*a(n-3) -137*a(n-4) -75*a(n-5) +577*a(n-6) +1558*a(n-7) +1020*a(n-8) -8*a(n-9) for n>10
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 05:49:58, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;15\,a(n-1) + 37\,a(n-2) + 6\,a(n-3) - 137\,a(n-4) - 75\,a(n-5) + 577\,a(n-6) + 1558\,a(n-7) + 1020\,a(n-8) - 8\,a(n-9)
\end{equation}
for all $n>10$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A230332.
