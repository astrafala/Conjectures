...
\title{The empirical recurrence for OEIS A232146, proved by transfer matrix}
...
\begin{abstract}
OEIS A232146 counts arrays of width $3$ over $\{0,1,2\}$ in which every cell carrying one stated
...
OEIS A232146 is ``Number of nX3 0..2 arrays with every 0 next to a 1 and every 1 next to a 2 horizontally, diagonally or antidiagonally.''. It has offset $1$ and begins
\[
7, 191, 3669, 67311, 1270511, 23931701, 450210003, 8472530835,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 06:55:01, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;12\,a(n-1) + 85\,a(n-2) + 715\,a(n-3) + 1790\,a(n-4) + 2337\,a(n-5) - 7031\,a(n-6) - 36834\,a(n-7) - 50760\,a(n-8) - 20925\,a(n-9)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232146.
