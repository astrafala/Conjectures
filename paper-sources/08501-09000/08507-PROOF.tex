...
\title{The empirical recurrence for OEIS A188501, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A188501 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A188501 is ``Number of n X 2 binary arrays without the pattern 0 1 0 diagonally, vertically or horizontally.''. It has offset $1$ and begins
\[
4, 16, 49, 144, 441, 1369, 4225, 12996,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n)=3*a(n-1)-a(n-2)+3*a(n-3)+3*a(n-4)-a(n-5)-a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 18 2018 08:33:16, revision 11) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) - a(n-2) + 3\,a(n-3) + 3\,a(n-4) - a(n-5) - a(n-6)
\end{equation}
for all $n>7$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A188501.
