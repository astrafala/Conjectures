...
\title{The empirical recurrence for OEIS A260922, proved by transfer matrix}
...
\begin{abstract}
OEIS A260922 counts $(n+2)\times5$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A260922 is ``Number of (n+2)X(3+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00010101 00101011 or 01010101.''. It has offset $1$ and begins
\[
104, 146, 401, 896, 1800, 3358, 7680, 14924,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-2) +11*a(n-4) +13*a(n-6) -2*a(n-8) -2*a(n-10) +4*a(n-12) for n>15
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 12:12:26, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-2) + 11\,a(n-4) + 13\,a(n-6) - 2\,a(n-8) - 2\,a(n-10) + 4\,a(n-12)
\]
for every $n>15$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A260922.
