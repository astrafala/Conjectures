...
\title{The empirical recurrence for OEIS A248996, proved by transfer matrix}
...
\begin{abstract}
OEIS A248996 carries an empirical recurrence of order $9$ contributed by R.~H.~Hardin. It is
...
OEIS A248996 is ``Number of length n+4 0..3 arrays with no five consecutive terms having two times the sum of any three elements equal to three times the sum of the remaining two.''. It has offset $1$ and begins
\[
820, 2668, 8680, 28240, 91888, 299044, 973204, 3167500,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) + 2*a(n-2) - a(n-3) - 9*a(n-4) + 16*a(n-5) - 48*a(n-6) - 21*a(n-7) + 8*a(n-8) + 3*a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 09 2018 08:10:21, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + 2\,a(n-2) - a(n-3) - 9\,a(n-4) + 16\,a(n-5) - 48\,a(n-6) - 21\,a(n-7) + 8\,a(n-8) + 3\,a(n-9)
\]
for every $n>12$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A248996.
