...
\title{The empirical recurrence for OEIS A188846, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A188846 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A188846 is ``Number of nX4 binary arrays without the pattern 0 0 1 vertically, antidiagonally or horizontally.''. It has offset $1$ and begins
\[
12, 144, 908, 5711, 32204, 181557, 1001368, 5521489,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 04:52:59, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 28\,a(n-2) - 6\,a(n-3) - 237\,a(n-4) - 150\,a(n-5) + 757\,a(n-6) + 891\,a(n-7) - 942\,a(n-8) - 1844\,a(n-9) + 173\,a(n-10) + 1695\,a(n-11) + 562\,a(n-12) - 619\,a(n-13) - 422\,a(n-14) + 78\,a(n-16) + 31\,a(n-17) + 4\,a(n-18)
\end{equation}
for all $n>19$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A188846.
