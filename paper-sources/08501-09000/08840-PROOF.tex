...
\title{The empirical recurrence for OEIS A206058, proved by transfer matrix}
...
\begin{abstract}
OEIS A206058 counts arrays over $\{0,\dots,3\}$ under a condition on the perimeter cycle of
every $2\times3$ and $3\times2$ subblock, and carries an empirical recurrence of order $13$ contributed by
R.~H.~Hardin. It is true, and it is decidable rather than empirical. The condition is local to
a bounded window of consecutive rows, so the count is a walk count on $S=19832$ states and is
...
OEIS A206058 is ``Number of (n+1)X4 0..3 arrays with every 2X3 or 3X2 subblock having exactly two clockwise edge increases.''. It has offset $1$ and begins
\[
19832, 167960, 1278672, 11155584, 101369476, 910785080, 8150091296, 73102971728,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-2) +695*a(n-3) +2*a(n-4) +1693*a(n-5) -1278*a(n-7) +682*a(n-9) +286*a(n-11) +32*a(n-13) for n>20
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 12:25:37, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-2) + 695\,a(n-3) + 2\,a(n-4) + 1693\,a(n-5) - 1278\,a(n-7) + 682\,a(n-9) + 286\,a(n-11) + 32\,a(n-13)
\]
for every $n>20$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206058.
