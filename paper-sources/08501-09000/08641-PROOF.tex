...
\title{The empirical recurrence for OEIS A302369, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A302369 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A302369 is ``Number of 3Xn 0..1 arrays with every element equal to 0, 2, 3 or 4 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
4, 2, 31, 20, 154, 284, 1109, 3472,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 06 2018 12:22:39, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) + a(n-2) - 47\,a(n-3) + 13\,a(n-4) + 158\,a(n-5) - 30\,a(n-6) - 242\,a(n-7) - 62\,a(n-8) + 224\,a(n-9) + 26\,a(n-10) + 11\,a(n-11) + 64\,a(n-12) - 114\,a(n-13) - 27\,a(n-14) + 26\,a(n-15) - 6\,a(n-16)
\end{equation}
for all $n>18$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302369.
