...
\title{The empirical recurrence for OEIS A304258, proved by transfer matrix}
...
\begin{abstract}
OEIS A304258 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A304258 is ``Number of nX3 0..1 arrays with every element unequal to 2, 3, 5 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
0, 4, 8, 13, 17, 26, 61, 120,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 09 2018 10:03:24, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 5\,a(n-2) - a(n-3) - 13\,a(n-4) + 5\,a(n-5) + 10\,a(n-6) - 16\,a(n-7) + 4\,a(n-8) + 14\,a(n-9) - 10\,a(n-10) - 14\,a(n-11) + 14\,a(n-12) + 4\,a(n-13) - 5\,a(n-14) + 13\,a(n-15) - 2\,a(n-17)
\end{equation}
for all $n>18$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A304258.
