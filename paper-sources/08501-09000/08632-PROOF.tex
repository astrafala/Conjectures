...
\title{The empirical recurrence for OEIS A280898, proved by transfer matrix}
...
\begin{abstract}
OEIS A280898 counts $n\times4$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A280898 is ``Number of nX4 0..2 arrays with no element equal to more than one of its horizontal and antidiagonal neighbors, with the exception of exactly two elements, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
1, 213, 22568, 1451655, 75809243, 3521886844, 151803173493, 6210239609889,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 10 2017 10:22:42, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;87\,a(n-1) - 2391\,a(n-2) + 16652\,a(n-3) + 109659\,a(n-4) + 121533\,a(n-5) - 306694\,a(n-6) - 726651\,a(n-7) - 13365\,a(n-8) + 1128492\,a(n-9) + 688905\,a(n-10) - 531441\,a(n-11) - 531441\,a(n-12)
\]
for every $n>14$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A280898.
