...
\title{The empirical recurrence for OEIS A236121, proved by transfer matrix}
...
\begin{abstract}
OEIS A236121 counts arrays over $\{0,\dots,3\}$ subject to a condition on the order
...
The condition is local to two consecutive rows, so the count is a walk count on $S=3096$
...
OEIS A236121 is ``Number of (n+1)X(2+1) 0..3 arrays colored with the sets of distinct values in every 2X2 subblock.''. It has offset $1$ and begins
\[
3096, 91128, 2692656, 79581792, 2351803200, 69503976144, 2054050501536, 60703643502048,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 09:07:05, revision 6) this is still
...
\]
over the $S=3096$ pairs whose own subblock row is properly coloured.
...
\begin{theorem}
\[
a(n)\;=\;14\,a(n-1) + 405\,a(n-2) + 1830\,a(n-3) - 4691\,a(n-4) - 47998\,a(n-5) - 55581\,a(n-6) + 505153\,a(n-7) + 1001824\,a(n-8) - 3123526\,a(n-9) - 5008625\,a(n-10) + 10507909\,a(n-11) + 11310434\,a(n-12) - 17345214\,a(n-13) - 7739207\,a(n-14) + 1315249\,a(n-15) + 11274820\,a(n-16) - 7267628\,a(n-17) - 6244408\,a(n-18) + 11830548\,a(n-19) + 7508592\,a(n-20) - 544968\,a(n-21)
\]
for every $n>21$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A236121.
