...
\title{The empirical recurrence for OEIS A299809, proved by transfer matrix}
...
\begin{abstract}
OEIS A299809 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A299809 is ``Number of nX3 0..1 arrays with every element equal to 0, 1, 3, 4, 5, 6 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
3, 4, 12, 43, 91, 519, 1721, 5886,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 19 2018 15:35:01, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 3\,a(n-2) + 17\,a(n-3) - 59\,a(n-4) - 28\,a(n-5) - 32\,a(n-6) + 159\,a(n-7) + 115\,a(n-8) + 5\,a(n-9) - 25\,a(n-10) - 90\,a(n-11) - 105\,a(n-12) - 175\,a(n-13) + 66\,a(n-14) + 5\,a(n-15) + 8\,a(n-16) + 6\,a(n-17)
\end{equation}
for all $n>18$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A299809.
