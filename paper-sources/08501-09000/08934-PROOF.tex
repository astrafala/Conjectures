...
\title{The empirical recurrence for OEIS A250687, proved by transfer matrix}
...
\begin{abstract}
OEIS A250687 counts arrays over $\{0,1,2,3\}$ in which a statistic taken over short runs
...
OEIS A250687 is ``Number of (n+1)X(4+1) 0..3 arrays with nondecreasing x(i,j)-x(i,j-1) in the i direction and nondecreasing absolute value of x(i,j)-x(i-1,j) in the j direction.''. It has offset $1$ and begins
\[
11150, 60508, 324648, 1670016, 8038566, 36673634, 160222342, 676640344,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 12:41:37, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;27\,a(n-1) - 331\,a(n-2) + 2439\,a(n-3) - 12049\,a(n-4) + 42129\,a(n-5) - 107225\,a(n-6) + 201069\,a(n-7) - 277706\,a(n-8) + 278928\,a(n-9) - 197984\,a(n-10) + 94032\,a(n-11) - 26784\,a(n-12) + 3456\,a(n-13)
\]
for every $n>17$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250687.
