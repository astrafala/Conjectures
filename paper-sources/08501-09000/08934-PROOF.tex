...
\title{The empirical recurrence for OEIS A234891, proved by transfer matrix}
...
\begin{abstract}
OEIS A234891 counts $2$-column arrays over $\{0,\dots,6\}$ in which every
...
OEIS A234891 is ``Number of (n+1) X (1+1) 0..6 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 1, with no adjacent elements equal (constant-stress tilted 1 X 1 tilings).''. It has offset
$1$ and begins
\[
160, 760, 3456, 16572, 76032, 365024, 1676576,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 30*a(n-2) -194*a(n-4) +428*a(n-6) -288*a(n-8) +48*a(n-10).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 20 2022 16:04:07, revision 7) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;30\,a(n-2) - 194\,a(n-4) + 428\,a(n-6) - 288\,a(n-8) + 48\,a(n-10)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234891.
