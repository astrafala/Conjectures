...
\title{The empirical recurrence for OEIS A298216, proved by transfer matrix}
...
\begin{abstract}
OEIS A298216 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A298216 is ``Number of nX3 0..1 arrays with every element equal to 0, 1, 2, 4 or 5 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
4, 13, 20, 40, 89, 195, 451, 1046,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 15 2018 08:05:40, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + a(n-3) - 13\,a(n-4) + 3\,a(n-5) - a(n-6) + 18\,a(n-7) - 4\,a(n-8) + 7\,a(n-9) - 7\,a(n-10) + 5\,a(n-11) - 6\,a(n-12) - a(n-13) - 4\,a(n-14)
\end{equation}
for all $n>15$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A298216.
