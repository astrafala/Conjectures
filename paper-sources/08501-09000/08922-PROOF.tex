...
\title{The empirical recurrence for OEIS A300467, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A300467 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A300467 is ``Number of n X 3 0..1 arrays with every element equal to 0, 1, 2 or 3 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
4, 29, 160, 925, 5363, 31106, 180397, 1046223,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 6*a(n-1) -a(n-2) -a(n-3) +a(n-4) -4*a(n-5) +a(n-6) -a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 27 2023 21:04:58, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) - a(n-2) - a(n-3) + a(n-4) - 4\,a(n-5) + a(n-6) - a(n-7)
\end{equation}
for all $n>8$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A300467.
