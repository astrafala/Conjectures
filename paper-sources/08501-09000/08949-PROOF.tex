...
\title{The empirical recurrence for OEIS A209508, proved by transfer matrix}
...
\begin{abstract}
OEIS A209508 counts $(n+1)\times6$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A209508 is ``Half the number of (n+1)X6 0..2 arrays with every 2X2 subblock having two or four distinct clockwise edge differences.''. It has offset $1$ and begins
\[
729, 11673, 189801, 3102219, 50798448, 832374135, 13642432110, 223616134827,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 30*a(n-1) -291*a(n-2) +1278*a(n-3) -2901*a(n-4) +3519*a(n-5) -2152*a(n-6) +516*a(n-7)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 15:17:37, revision 9) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209508.
