...
\title{The empirical recurrence for OEIS A203969, proved by transfer matrix}
...
\begin{abstract}
OEIS A203969 counts arrays of width $2$ over $\{0,1,2\}$ under local conditions relating each cell
...
OEIS A203969 is ``Number of n X 2 0..2 arrays with every 1 immediately preceded by 0 to the left or above, and every 2 immediately preceded by 0 1 to the left or above.''. It has offset $1$ and begins
\[
2, 7, 29, 106, 396, 1488, 5569, 20859,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) +3*a(n-2) +12*a(n-3) +4*a(n-4) +5*a(n-5) -9*a(n-6) -a(n-8) +a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 22 2025 17:41:33, revision 10) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 3\,a(n-2) + 12\,a(n-3) + 4\,a(n-4) + 5\,a(n-5) - 9\,a(n-6) - a(n-8) + a(n-9)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A203969.
