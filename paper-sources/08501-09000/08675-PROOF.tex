...
\title{The empirical recurrence for OEIS A234721, proved by transfer matrix}
...
\begin{abstract}
OEIS A234721 counts $2$-column arrays over $\{0,\dots,7\}$ in which every
...
OEIS A234721 is ``Number of (n+1) X (1+1) 0..7 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 7 (constant-stress 1 X 1 tilings).''. It has offset
$1$ and begins
\[
240, 1096, 4192, 19120, 74496, 339328, 1344640,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 68*a(n-2) - 1724*a(n-4) + 19312*a(n-6) - 80640*a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 19 2022 01:11:57, revision 10) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;68\,a(n-2) - 1724\,a(n-4) + 19312\,a(n-6) - 80640\,a(n-8)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234721.
