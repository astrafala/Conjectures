...
\title{The empirical recurrence for OEIS A247989, proved by transfer matrix}
...
\begin{abstract}
OEIS A247989 carries an empirical recurrence of order $13$ contributed by R.~H.~Hardin. It is
...
OEIS A247989 is ``Number of length n+5 0..2 arrays with no disjoint triples in any consecutive six terms having the same sum.''. It has offset $1$ and begins
\[
396, 702, 1264, 2314, 4308, 8150, 15640, 30620,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) +10*a(n-6) -20*a(n-7) -16*a(n-12) +32*a(n-13)
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 11:39:11, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 10\,a(n-6) - 20\,a(n-7) - 16\,a(n-12) + 32\,a(n-13)
\]
for every $n>17$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A247989.
