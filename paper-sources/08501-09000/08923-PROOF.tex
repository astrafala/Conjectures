...
\title{The empirical recurrence for OEIS A249285, proved by transfer matrix}
...
\begin{abstract}
OEIS A249285 carries an empirical recurrence of order $8$ contributed by R.~H.~Hardin. It is
...
OEIS A249285 is ``Number of length n+3 0..3 arrays with no four consecutive terms having the sum of any three elements equal to three times the fourth.''. It has offset $1$ and begins
\[
204, 660, 2144, 6960, 22572, 73204, 237480, 770416,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + 2*a(n-2) + 4*a(n-3) + 8*a(n-4) + 4*a(n-5) - 8*a(n-6) - 2*a(n-7) + 3*a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 09 2018 21:54:53, revision 10) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 2\,a(n-2) + 4\,a(n-3) + 8\,a(n-4) + 4\,a(n-5) - 8\,a(n-6) - 2\,a(n-7) + 3\,a(n-8)
\]
for every $n>7$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A249285.
