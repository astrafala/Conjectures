...
\title{The empirical recurrence for OEIS A228387, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A228387 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A228387 is ``Number of nX5 binary arrays with top left value 1 and no two ones adjacent horizontally or vertically.''. It has offset $1$ and begins
\[
5, 29, 268, 2104, 17578, 143072, 1177709, 9646285,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 4*a(n-1) +36*a(n-2) -105*a(n-4) +15*a(n-5) +64*a(n-6) -20*a(n-7) -4*a(n-8) +a(n-9)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 04 2025 00:02:56, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) + 36\,a(n-2) - 105\,a(n-4) + 15\,a(n-5) + 64\,a(n-6) - 20\,a(n-7) - 4\,a(n-8) + a(n-9)
\end{equation}
for all $n>9$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A228387.
