...
\title{The empirical recurrence for OEIS A206983, proved by transfer matrix}
...
\begin{abstract}
OEIS A206983 counts arrays of width $4$ over $\{0,1\}$ containing no occurrence of certain short
...
OEIS A206983 is ``Number of nX4 0..1 arrays avoiding the patterns 0 1 0 or 1 0 1 in any row, column, diagonal or antidiagonal.''. It has offset $1$ and begins
\[
10, 100, 158, 556, 1866, 5804, 18528, 59888,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 13:20:20, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) - 4\,a(n-2) + 10\,a(n-3) - 18\,a(n-4) + 8\,a(n-5) - 16\,a(n-6) - 4\,a(n-7) - 3\,a(n-8) + 21\,a(n-9) + 13\,a(n-10) - 12\,a(n-11)
\]
for every $n>13$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206983.
