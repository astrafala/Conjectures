...
\title{The empirical recurrence for OEIS A195957, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A195957 counts arrays over $\{0,\dots,4\}$ in which every cell is constrained by the
...
OEIS A195957 is ``Number of nX3 0..4 arrays with each element equal to the number its horizontal and vertical neighbors unequal to itself.''. It has offset $1$ and begins
\[
2, 6, 10, 16, 21, 44, 82, 144,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 06:20:47, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-2) + 5\,a(n-3) + 5\,a(n-4) - 4\,a(n-5) - 15\,a(n-6) - 14\,a(n-7) - a(n-8) + 10\,a(n-9) + 2\,a(n-10) - 16\,a(n-11) - 15\,a(n-12) + 9\,a(n-13) + 29\,a(n-14) + 20\,a(n-15) - 2\,a(n-16) - 10\,a(n-17) - 4\,a(n-18)
\end{equation}
for all $n>19$.
...
$5$ values, so there are about $10^{69}$ of them to sift. The
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A195957.
