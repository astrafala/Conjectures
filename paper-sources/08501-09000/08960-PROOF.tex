...
\title{The empirical recurrence for OEIS A316306, proved by transfer matrix}
...
\begin{abstract}
OEIS A316306 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A316306 is ``Number of nX3 0..1 arrays with every element unequal to 0, 1, 3, 4, 6 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
3, 7, 10, 21, 44, 83, 168, 365,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 29 2018 07:19:27, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) - 4\,a(n-2) + 5\,a(n-3) - 16\,a(n-4) + 12\,a(n-5) - 7\,a(n-6) + 18\,a(n-7) - 14\,a(n-8) + 12\,a(n-9) + 2\,a(n-10) + 11\,a(n-11) - 13\,a(n-12) - 10\,a(n-13) - 5\,a(n-14) - 2\,a(n-15) + 4\,a(n-16)
\end{equation}
for all $n>16$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A316306.
