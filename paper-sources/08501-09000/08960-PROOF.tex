...
\title{The empirical recurrence for OEIS A207704, proved by transfer matrix}
...
\begin{abstract}
OEIS A207704 counts arrays over $\{0,\dots,1\}$ of width $3$ that avoid the patterns
...
OEIS A207704 is ``Number of 3Xn 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 0 1 and 1 1 0 vertically.''. It has offset
$1$ and begins
\[
6, 36, 102, 289, 1071, 3969, 13230,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:11:22, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 10\,a(n-3) + 25\,a(n-4) - 2\,a(n-5) + 4\,a(n-6) - 28\,a(n-7) - 68\,a(n-8) - 2\,a(n-9) + 4\,a(n-10) + 10\,a(n-11) + 25\,a(n-12) + 2\,a(n-13) - a(n-16)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207704.
