...
\title{The empirical recurrence for OEIS A234394, proved by transfer matrix}
...
\begin{abstract}
OEIS A234394 counts arrays of width $3$ over $\{0,1,2,3\}$ containing no run of $3$ consecutive
cells, taken along a named direction of the grid, whose entries are strictly increasing. The entry carries
an empirical recurrence of order $20$ contributed by R.~H.~Hardin. It is true, and it is
...
OEIS A234394 is ``Number of (1+2) X (n+2) 0..3 arrays with no increasing sequence of length 3 vertically, diagonally downwards or antidiagonally downwards.''. It has offset $1$ and begins
\[
196316, 10683130, 585790562, 32129615500, 1761338821822, 96553476935058, 5293088906692756, 290169408255194858,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 19 2025 14:06:38, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;59\,a(n-1) - 321\,a(n-2) + 5250\,a(n-3) + 11912\,a(n-4) - 1362734\,a(n-5) + 2774640\,a(n-6) + 51543392\,a(n-7) - 111860552\,a(n-8) - 142606384\,a(n-9) - 375586128\,a(n-10) - 4285167120\,a(n-11) + 4322222432\,a(n-12) - 4985269824\,a(n-13) + 9926880896\,a(n-14) + 25978108928\,a(n-15) - 24346223616\,a(n-16) + 12931098624\,a(n-17) - 20510392320\,a(n-18) - 28179726336\,a(n-19) + 22454599680\,a(n-20)
\]
for every $n>17$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234394.
