...
\title{The empirical recurrence for OEIS A237151, proved by transfer matrix}
...
\begin{abstract}
OEIS A237151 counts arrays over $\{0,\dots,3\}$ subject to a condition on the order
...
OEIS A237151 is ``Number of (n+1)X(1+1) 0..3 arrays with the maximum plus the minimum of every 2X2 subblock equal.''. It has offset $1$ and begins
\[
256, 1868, 14096, 111900, 912848, 7609244, 64386416, 550822812,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 09:53:52, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;20\,a(n-1) - 123\,a(n-2) + 130\,a(n-3) + 1001\,a(n-4) - 2016\,a(n-5) - 2381\,a(n-6) + 4474\,a(n-7) + 2016\,a(n-8) - 2160\,a(n-9) - 960\,a(n-10)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237151.
