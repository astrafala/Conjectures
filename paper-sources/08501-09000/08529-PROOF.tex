...
\title{The empirical recurrence for OEIS A236654, proved by transfer matrix}
...
\begin{abstract}
OEIS A236654 counts arrays over $\{0,\dots,3\}$ subject to a condition on the order
...
OEIS A236654 is ``Number of (n+1)X(1+1) 0..3 arrays colored with the sum of the upper and lower median values of each 2X2 subblock.''. It has offset $1$ and begins
\[
256, 2896, 32424, 370352, 4235056, 48229536, 549313480, 6261494544,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 09:25:19, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;32\,a(n-2) + 510\,a(n-3) + 4422\,a(n-4) + 20562\,a(n-5) + 76184\,a(n-6) + 152730\,a(n-7) - 90401\,a(n-8) - 1395282\,a(n-9) - 5373988\,a(n-10) - 8188928\,a(n-11) + 9036688\,a(n-12) + 47478176\,a(n-13) + 64503872\,a(n-14) + 4474624\,a(n-15) - 119940096\,a(n-16) - 162693120\,a(n-17) - 71368704\,a(n-18)
\]
for every $n>18$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A236654.
