...
\title{The empirical recurrence for OEIS A302518, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A302518 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A302518 is ``Number of 5Xn 0..1 arrays with every element equal to 0, 1, 4 or 5 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
16, 9, 14, 48, 90, 199, 689, 2125,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 09 2018 09:12:06, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + a(n-2) + 3\,a(n-3) + 20\,a(n-4) + 7\,a(n-5) - 2\,a(n-6) - 6\,a(n-7) - 40\,a(n-8) - 6\,a(n-9) - 2\,a(n-10) - 2\,a(n-11) + 22\,a(n-12) - 5\,a(n-13)
\end{equation}
for all $n>17$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302518.
