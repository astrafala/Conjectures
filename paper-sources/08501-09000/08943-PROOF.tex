...
\title{A condition on the multiset of every subblock: OEIS A183588}
...
\begin{abstract}
OEIS A183588 carries an empirical recurrence of order $11$ contributed by R.~H.~Hardin. It is
...
on $S=11$ vertices and is $C$-finite, and whether the conjectured recurrence annihilates it
...
OEIS A183588 is ``1/24 the number of (n+1)X4 0..3 arrays with every 2X2 subblock containing exactly three distinct values.''. It has offset $1$ and begins
\[
520, 27380, 1427084, 74491726, 3887550226, 202888369698, 10588548225946, 552606468835138,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 16 2025 13:42:31, revision 10) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{The count is a walk count}

The entry counts arrays with $4$ columns over the alphabet $\{0,1,2,3\}$, growing one row at a time, and asks that every $2\times2$ subblock holds exactly $3$ distinct values.
...
Merging vertices with identical futures leaves $S=11$. An admissible array is exactly a walk, so with $M$ the adjacency matrix and $\iota,\tau$ the vectors recording which states may begin and end an array,
\[
...
\begin{theorem}
\[
a(n)\;=\;51\,a(n-1) + 274\,a(n-2) - 10688\,a(n-3) - 31344\,a(n-4) + 590588\,a(n-5) + 1621408\,a(n-6) - 5825824\,a(n-7) - 7929216\,a(n-8) + 17443840\,a(n-9) + 6201344\,a(n-10) - 11993088\,a(n-11)
\]
for every $n>10$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A183588.
