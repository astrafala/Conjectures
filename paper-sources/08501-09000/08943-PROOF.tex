...
\title{The empirical recurrence for OEIS A203103, proved by transfer matrix}
...
\begin{abstract}
OEIS A203103 counts arrays of width $3$ over $\{0,1\}$ under local conditions relating each cell
...
OEIS A203103 is ``Number of n X 3 binary arrays with every 1 immediately preceded by 0 0 to the left or above.''. It has offset $1$ and begins
\[
2, 4, 23, 90, 296, 1125, 4314, 15844,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) +2*a(n-2) +15*a(n-3) +8*a(n-4) -4*a(n-5) -17*a(n-6) -12*a(n-7) -10*a(n-8) +5*a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 04 2018 03:11:36, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The array has $3$ cells across, with entries in $\{0,1\}$. The NEIGHBOURS of a cell are the
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 2\,a(n-2) + 15\,a(n-3) + 8\,a(n-4) - 4\,a(n-5) - 17\,a(n-6) - 12\,a(n-7) - 10\,a(n-8) + 5\,a(n-9)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A203103.
