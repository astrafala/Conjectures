...
\title{The empirical recurrence for OEIS A204494, proved by transfer matrix}
...
\begin{abstract}
OEIS A204494 counts $(n+2)\times3$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A204494 is ``Number of (n+2)X3 0..2 arrays with every 3X3 subblock having three strictly increasing elements in a row horizontally or vertically.''. It has offset $1$ and begins
\[
3971, 46458, 699151, 6047817, 65606908, 797822969, 8067170432, 86968465645,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 11:16:12, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 26\,a(n-2) + 677\,a(n-3) + 1863\,a(n-4) + 3391\,a(n-5) + 2222\,a(n-6) + 485\,a(n-7) - 1392\,a(n-8) - 864\,a(n-9) - 324\,a(n-10)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204494.
