...
\title{The empirical recurrence for OEIS A252387, proved by transfer matrix}
...
\begin{abstract}
OEIS A252387 counts $5\times(n+2)$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252387 is ``Number of (3+2) X (n+2) 0..3 arrays with every 3 X 3 subblock row and diagonal sum equal to 0 3 5 6 or 7 and every 3 X 3 column and antidiagonal sum not equal to 0 3 5 6 or 7.''. It has offset $1$ and begins
\[
588, 529, 632, 663, 963, 1341, 1610, 2376,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-3) - 4*a(n-6) + a(n-9) for n>17.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 03 2018 11:09:38, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252387.
