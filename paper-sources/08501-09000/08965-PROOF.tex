...
\title{The empirical recurrence for OEIS A252816, proved by transfer matrix}
...
\begin{abstract}
OEIS A252816 carries an empirical recurrence of order $9$ contributed by R.~H.~Hardin. It is
...
OEIS A252816 is ``Number of n X 4 nonnegative integer arrays with upper left 0 and every value within 2 of its city block distance from the upper left and every value increasing by 0 or 1 with every step right or down.''. It has offset $1$ and begins
\[
7, 40, 187, 684, 2078, 5490, 13015, 28299,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 06 2018 10:10:19, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252816.
