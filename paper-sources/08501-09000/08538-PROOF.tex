...
\title{The empirical recurrence for OEIS A297376, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297376 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A297376 is ``Number of 3Xn 0..1 arrays with every 1 horizontally or antidiagonally adjacent to 0, 1 or 2 neighboring 1s.''. It has offset $1$ and begins
\[
8, 64, 393, 2610, 17534, 116932, 780273, 5208625,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 29 2017 07:42:30, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) + 5\,a(n-2) + 36\,a(n-3) + 27\,a(n-4) + 55\,a(n-5) - 9\,a(n-6) - 9\,a(n-7) - 49\,a(n-8) - 8\,a(n-9) + 21\,a(n-10) + a(n-11) - 2\,a(n-12)
\end{equation}
for all $n>14$.
...
x_{t,u}=1\ \Rightarrow\ \#\{\text{neighbours equal to }1\}\in\{0,1,2\}
\end{equation}
for every cell $(t,u)$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297376.
