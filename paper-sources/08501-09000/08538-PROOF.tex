...
\title{The empirical recurrence for OEIS A208144, proved by transfer matrix}
...
\begin{abstract}
OEIS A208144 counts arrays over $\{0,\dots,1\}$ of width $5$ that avoid the patterns
...
OEIS A208144 is ``Number of 5Xn 0..1 arrays avoiding 0 0 1 and 0 1 1 horizontally and 0 0 1 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
10, 100, 450, 2025, 6300, 19600, 49000,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:40:06, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208144.
