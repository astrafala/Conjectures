...
\title{The empirical recurrence for OEIS A250995, proved by transfer matrix}
...
\begin{abstract}
OEIS A250995 counts arrays over $\{0,1,2\}$ in which a statistic taken over short runs
...
OEIS A250995 is ``Number of (1+1) X (n+1) 0..2 arrays with nondecreasing min(x(i,j),x(i,j-1)) in the i direction and nondecreasing absolute value of x(i,j)-x(i-1,j) in the j direction.''. It has offset $1$ and begins
\[
40, 169, 646, 2359, 8298, 28450, 95628, 316568,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 6*a(n-1) - 7*a(n-2) - 12*a(n-3) + 15*a(n-4) + 11*a(n-5) - 5*a(n-6) - 3*a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 24 2018 04:36:24, revision 10) this is still
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) - 7\,a(n-2) - 12\,a(n-3) + 15\,a(n-4) + 11\,a(n-5) - 5\,a(n-6) - 3\,a(n-7)
\]
for every $n>6$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250995.
