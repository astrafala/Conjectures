...
\title{The empirical recurrence for OEIS A251196, proved by transfer matrix}
...
\begin{abstract}
OEIS A251196 counts $(n+1)\times4$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A251196 is ``Number of (n+1)X(3+1) 0..1 arrays with no 2X2 subblock having the minimum of its diagonal elements less than the absolute difference of its antidiagonal elements.''. It has offset $1$ and begins
\[
64, 310, 1654, 8976, 49104, 268638, 1470646, 8050116,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) +19*a(n-2) +8*a(n-3) -41*a(n-4) -16*a(n-5) +21*a(n-6) -10*a(n-8) +2*a(n-9) for n>10
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:10:03, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 19\,a(n-2) + 8\,a(n-3) - 41\,a(n-4) - 16\,a(n-5) + 21\,a(n-6) - 10\,a(n-8) + 2\,a(n-9)
\end{equation}
for all $n>10$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251196.
