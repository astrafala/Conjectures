...
\title{The empirical recurrence for OEIS A304350, proved by transfer matrix}
...
\begin{abstract}
OEIS A304350 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A304350 is ``Number of nX3 0..1 arrays with every element unequal to 0, 1, 3, 4 or 5 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
3, 9, 13, 27, 60, 123, 280, 729,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 11 2018 14:21:54, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 8\,a(n-3) - 14\,a(n-4) - 12\,a(n-5) + 12\,a(n-6) - 39\,a(n-7) + 6\,a(n-8) - 14\,a(n-9) + 81\,a(n-10) + 28\,a(n-11) - 71\,a(n-12) - 53\,a(n-13) + 51\,a(n-14) + 27\,a(n-15) - 20\,a(n-16) - 2\,a(n-17) + 2\,a(n-18)
\end{equation}
for all $n>20$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A304350.
