...
\title{The empirical recurrence for OEIS A269408, proved by transfer matrix}
...
\begin{abstract}
OEIS A269408 carries an empirical recurrence of order $16$ contributed by R.~H.~Hardin. It is
...
OEIS A269408 is ``Number of length-n 0..7 arrays with no repeated value greater than or equal to the previous repeated value.''. It has offset $1$ and begins
\[
8, 64, 504, 3948, 30744, 238224, 1837752, 14121282,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 25 2016 14:37:57, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;56\,a(n-1) - 1344\,a(n-2) + 17752\,a(n-3) - 135716\,a(n-4) + 545496\,a(n-5) - 463792\,a(n-6) - 4675336\,a(n-7) + 12240018\,a(n-8) + 21847336\,a(n-9) - 72913568\,a(n-10) - 123833976\,a(n-11) + 152002508\,a(n-12) + 520479176\,a(n-13) + 513890832\,a(n-14) + 230592040\,a(n-15) + 40353607\,a(n-16)
\]
for every $n>1$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269408.
