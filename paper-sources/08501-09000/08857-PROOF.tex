...
\title{The empirical recurrence for OEIS A252301, proved by transfer matrix}
...
\begin{abstract}
OEIS A252301 counts $(n+2)\times6$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
$a(n)$ is a walk count on $S=459211$ vertices. Such a sequence is $C$-finite, so whether a given
...
OEIS A252301 is ``Number of (n+2)X(4+2) 0..3 arrays with every 3X3 subblock row and diagonal sum equal to 0 1 3 6 or 7 and every 3X3 column and antidiagonal sum not equal to 0 1 3 6 or 7.''. It has offset $1$ and begins
\[
2670, 1992, 2287, 3032, 5117, 7489, 10626, 18971,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 7*a(n-3) -14*a(n-6) +8*a(n-9) for n>18
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:02:42, revision 6) this is still
...
at once. By Lemma~\ref{lem:crit} the recurrence holds for every $n>18$. The bound is exact: at $n=18$ the recurrence fails on the entry's own published terms, so no larger range holds.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252301.
