...
\title{The empirical recurrence for OEIS A269582, proved by transfer matrix}
...
\begin{abstract}
OEIS A269582 carries an empirical recurrence of order $9$ contributed by R.~H.~Hardin. It is
...
OEIS A269582 is ``Number of length-n 0..7 arrays with no repeated value differing from the previous repeated value by more than one.''. It has offset $1$ and begins
\[
8, 64, 512, 4054, 31844, 248464, 1927694, 14883506,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 01 2016 07:57:01, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;35\,a(n-1) - 485\,a(n-2) + 3290\,a(n-3) - 10541\,a(n-4) + 10073\,a(n-5) + 11122\,a(n-6) + 2072\,a(n-7) - 47\,a(n-8) - 14\,a(n-9)
\]
for every $n>1$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269582.
