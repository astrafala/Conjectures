...
\title{The empirical recurrence for OEIS A206695, proved by transfer matrix}
...
\begin{abstract}
OEIS A206695 counts arrays of width $3$ over $\{0,1,2\}$ containing no occurrence of certain short
...
OEIS A206695 is ``Number of nX3 0..2 arrays avoiding the pattern z-2 z-1 z in any row or column.''. It has offset $1$ and begins
\[
26, 676, 15712, 363465, 8366690, 192513201, 4428597297, 101873060353,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 13:05:54, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;29\,a(n-1) - 84\,a(n-2) - 1570\,a(n-3) + 6618\,a(n-4) + 28026\,a(n-5) - 136815\,a(n-6) - 145173\,a(n-7) + 1005714\,a(n-8) - 486446\,a(n-9) - 1842056\,a(n-10) + 1805556\,a(n-11) + 1069186\,a(n-12) - 1763040\,a(n-13) + 27675\,a(n-14) + 626313\,a(n-15) - 148782\,a(n-16) - 66294\,a(n-17) + 19454\,a(n-18) + 2708\,a(n-19) - 849\,a(n-20) - 37\,a(n-21) + 12\,a(n-22)
\]
for every $n>21$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206695.
