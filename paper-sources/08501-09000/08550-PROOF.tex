...
\title{The empirical recurrence for OEIS A317514, proved by transfer matrix}
...
\begin{abstract}
OEIS A317514 counts $5$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A317514 is ``Number of nX5 0..1 arrays with every element unequal to 0, 1, 2, 3, 4, 5, 6 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
16, 512, 16193, 512096, 16198017, 512358002, 16206294085, 512618027974,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 31*a(n-1) -3*a(n-2) +708*a(n-3) +474*a(n-4) +2957*a(n-5) +2350*a(n-6) -1836*a(n-7) -1440*a(n-8)
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 30 2018 11:29:10, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;31\,a(n-1) - 3\,a(n-2) + 708\,a(n-3) + 474\,a(n-4) + 2957\,a(n-5) + 2350\,a(n-6) - 1836\,a(n-7) - 1440\,a(n-8)
\end{equation}
for all $n>8$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A317514.
