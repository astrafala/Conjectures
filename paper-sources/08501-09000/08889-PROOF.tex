...
\title{The empirical recurrence for OEIS A252533, proved by transfer matrix}
...
\begin{abstract}
OEIS A252533 counts $3\times(n+2)$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252533 is ``Number of (1+2)X(n+2) 0..3 arrays with every 3X3 subblock row and diagonal sum equal to 0 2 3 6 or 7 and every 3X3 column and antidiagonal sum not equal to 0 2 3 6 or 7.''. It has offset $1$ and begins
\[
750, 730, 621, 719, 778, 932, 1200, 1498,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-3) -3*a(n-6) -4*a(n-9) +4*a(n-12) for n>39
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:20:13, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252533.
