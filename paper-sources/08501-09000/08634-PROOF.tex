...
\title{The empirical recurrence for OEIS A301837, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A301837 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A301837 is ``Number of nX4 0..1 arrays with every element equal to 0, 1 or 2 horizontally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
8, 81, 678, 5748, 48802, 414385, 3518619, 29877293,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 13*a(n-1) -46*a(n-2) +72*a(n-3) -57*a(n-4) +16*a(n-5) for n>6
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 27 2018 14:28:14, revision 4) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A301837.
