...
\title{The empirical recurrence for OEIS A255103, proved by transfer matrix}
...
\begin{abstract}
OEIS A255103 carries an empirical recurrence of order $9$ contributed by R.~H.~Hardin. It is
...
OEIS A255103 is ``Number of length n+4 0..2 arrays with at most one downstep in every 4 consecutive neighbor pairs.''. It has offset $1$ and begins
\[
147, 331, 789, 1905, 4429, 10125, 23463, 55246,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) -3*a(n-2) +a(n-3) +12*a(n-4) -18*a(n-5) +7*a(n-6) -3*a(n-8) +a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 24 2018 19:02:16, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) - 3\,a(n-2) + a(n-3) + 12\,a(n-4) - 18\,a(n-5) + 7\,a(n-6) - 3\,a(n-8) + a(n-9)
\]
for every $n>13$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A255103.
