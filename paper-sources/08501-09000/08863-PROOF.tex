...
\title{The empirical recurrence for OEIS A250736, proved by transfer matrix}
...
\begin{abstract}
OEIS A250736 counts arrays over $\{0,1\}$ in which a statistic taken over short runs
...
OEIS A250736 is ``Number of (7+1)X(n+1) 0..1 arrays with nondecreasing x(i,j)+x(i,j-1) in the i direction and nondecreasing min(x(i,j),x(i-1,j)) in the j direction.''. It has offset $1$ and begins
\[
275, 513, 1418, 3807, 9728, 23941, 57397, 135645,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 12:45:00, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-1) - 13\,a(n-2) - 18\,a(n-3) + 95\,a(n-4) - 89\,a(n-5) - 102\,a(n-6) + 264\,a(n-7) - 143\,a(n-8) - 94\,a(n-9) + 150\,a(n-10) - 60\,a(n-11) - a(n-12) + 6\,a(n-13) - a(n-14)
\]
for every $n>19$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250736.
