...
\title{The empirical recurrence for OEIS A297649, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297649 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A297649 is ``Number of nX3 0..1 arrays with every 1 horizontally, diagonally or antidiagonally adjacent to 1, 2 or 3 neighboring 1s.''. It has offset $1$ and begins
\[
4, 43, 231, 1421, 9033, 55706, 346032, 2151932,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 02 2018 15:05:44, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 9\,a(n-2) + 60\,a(n-3) + 51\,a(n-4) + 54\,a(n-5) - 303\,a(n-6) - 336\,a(n-7) - 234\,a(n-8) + 316\,a(n-9) + 264\,a(n-10) - 144\,a(n-11)
\end{equation}
for all $n>12$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297649.
