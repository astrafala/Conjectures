...
\title{The empirical recurrence for OEIS A306162, proved by transfer matrix}
...
\begin{abstract}
OEIS A306162 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A306162 is ``Number of nX4 0..1 arrays with every element unequal to 0, 1, 2, 5, 6 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
8, 9, 32, 103, 298, 962, 2966, 8756,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 23 2018 12:43:53, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 4\,a(n-2) - a(n-4) - 17\,a(n-5) - 22\,a(n-6) + 2\,a(n-7) + 38\,a(n-8) + 42\,a(n-9) - 5\,a(n-10) - 5\,a(n-11) - 9\,a(n-12) - 24\,a(n-13) - 26\,a(n-14) - 20\,a(n-15) + 6\,a(n-16) + 20\,a(n-17) + 16\,a(n-18)
\end{equation}
for all $n>23$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A306162.
