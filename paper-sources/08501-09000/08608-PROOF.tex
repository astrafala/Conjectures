...
\title{The empirical recurrence for OEIS A296315, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A296315 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A296315 is ``Number of n X 3 0..1 arrays with each 1 horizontally, vertically or antidiagonally adjacent to 1 neighboring 1.''. It has offset $1$ and begins
\[
3, 11, 32, 96, 295, 902, 2747, 8380,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) + 4*a(n-2) + 6*a(n-3) + 3*a(n-4) - 3*a(n-6) + a(n-7) - 3*a(n-9) + a(n-11).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 23 2019 04:21:31, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 4\,a(n-2) + 6\,a(n-3) + 3\,a(n-4) - 3\,a(n-6) + a(n-7) - 3\,a(n-9) + a(n-11)
\end{equation}
for all $n>12$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A296315.
