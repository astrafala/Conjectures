...
\title{The empirical recurrence for OEIS A228504, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A228504 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A228504 is ``Number of n X 6 binary arrays with top left value 1 and no two ones adjacent horizontally, vertically, diagonally or antidiagonally.''. It has offset $1$ and begins
\[
8, 21, 239, 1252, 9528, 59839, 413786, 2724191,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) + 30*a(n-2) - 17*a(n-3) - 138*a(n-4) + 85*a(n-5) + 116*a(n-6) - 42*a(n-7) - 32*a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 12 2018 06:13:36, revision 10) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 30\,a(n-2) - 17\,a(n-3) - 138\,a(n-4) + 85\,a(n-5) + 116\,a(n-6) - 42\,a(n-7) - 32\,a(n-8)
\end{equation}
for all $n>8$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A228504.
