...
\title{The empirical recurrence for OEIS A202531, proved by transfer matrix}
...
\begin{abstract}
OEIS A202531 counts arrays of width $9$ over $\{0,1\}$ containing no occurrence of certain short
...
count is a walk count on $S=3661$ states.
\end{abstract}
...
OEIS A202531 is ``Number of (n+2) X 9 binary arrays avoiding patterns 000 and 101 in rows, columns and nw-to-se diagonals.''. It has offset $1$ and begins
\[
8994, 22525, 47098, 97936, 214388, 462445, 986000, 2119913,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) +2*a(n-3) -2*a(n-4) -2*a(n-5) +a(n-7) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 01 2018 09:41:29, revision 8) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=3661.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A202531.
