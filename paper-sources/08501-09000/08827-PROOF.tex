...
\title{The empirical recurrence for OEIS A250789, proved by transfer matrix}
...
\begin{abstract}
OEIS A250789 counts arrays over $\{0,1\}$ in which a statistic taken over short runs
...
OEIS A250789 is ``Number of (7+1) X (n+1) 0..1 arrays with nondecreasing x(i,j)+x(i,j-1) in the i direction and nondecreasing absolute value of x(i,j)-x(i-1,j) in the j direction.''. It has offset $1$ and begins
\[
576, 1596, 4054, 10306, 25126, 59590, 137082, 307762,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 8*a(n-1) - 25*a(n-2) + 35*a(n-3) - 9*a(n-4) - 37*a(n-5) + 47*a(n-6) - 15*a(n-7) - 10*a(n-8) + 9*a(n-9) - 2*a(n-10).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 20 2018 08:16:16, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-1) - 25\,a(n-2) + 35\,a(n-3) - 9\,a(n-4) - 37\,a(n-5) + 47\,a(n-6) - 15\,a(n-7) - 10\,a(n-8) + 9\,a(n-9) - 2\,a(n-10)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250789.
