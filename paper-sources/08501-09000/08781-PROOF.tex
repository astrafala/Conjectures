...
\title{The empirical recurrence for OEIS A204411, proved by transfer matrix}
...
\begin{abstract}
OEIS A204411 counts $(n+2)\times4$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A204411 is ``Number of (n+2)X4 0..2 arrays with every 3X3 subblock having three strictly increasing elements in a row horizontally or vertically, exactly one way.''. It has offset $1$ and begins
\[
34274, 154938, 781884, 5597126, 52039032, 395943745, 2826265830, 26252359826,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 11:13:14, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;737\,a(n-3) + 135\,a(n-4) + 564\,a(n-5) - 109084\,a(n-6) - 27511\,a(n-7) - 186930\,a(n-8) - 429594\,a(n-9) - 166223\,a(n-10) + 2117595\,a(n-11) + 208279\,a(n-12) + 1766751\,a(n-13) + 6306642\,a(n-14) + 17530589\,a(n-15) + 9984342\,a(n-16) - 3716271\,a(n-17) - 2952990\,a(n-18) + 123210\,a(n-19)
\]
for every $n>22$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204411.
