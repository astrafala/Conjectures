...
\title{The empirical recurrence for OEIS A251198, proved by transfer matrix}
...
\begin{abstract}
OEIS A251198 counts $(n+1)\times6$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A251198 is ``Number of (n+1)X(5+1) 0..1 arrays with no 2X2 subblock having the minimum of its diagonal elements less than the absolute difference of its antidiagonal elements.''. It has offset $1$ and begins
\[
421, 4172, 49104, 599869, 7392190, 91120318, 1123772109, 13857491196,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:10:10, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 118\,a(n-2) + 279\,a(n-3) - 1792\,a(n-4) - 3874\,a(n-5) + 13807\,a(n-6) + 15815\,a(n-7) - 60874\,a(n-8) - 9844\,a(n-9) + 120750\,a(n-10) - 46021\,a(n-11) - 141005\,a(n-12) + 176283\,a(n-13) - 34545\,a(n-14) - 57511\,a(n-15) + 27381\,a(n-16) + 6840\,a(n-17) - 5394\,a(n-18) + 98\,a(n-19) + 271\,a(n-20) - 11\,a(n-21) - 4\,a(n-22)
\end{equation}
for all $n>25$.
...
\text{not }\bigl(\min(\alpha,\delta)<|\beta-\gamma|\bigr),
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251198.
