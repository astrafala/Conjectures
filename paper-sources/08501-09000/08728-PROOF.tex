...
\title{The empirical recurrence for OEIS A183305, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A183305 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A183305 is ``Half the number of nX4 binary arrays with no element equal to a strict majority of its horizontal and vertical neighbors.''. It has offset $1$ and begins
\[
2, 6, 19, 55, 178, 572, 1798, 5700,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 01:32:48, revision 9) the statement is
...
\[
a(n_0+j)-\sum_i c_i\,a(n_0+j-i)\;=\;\tfrac1{2}\,\mathbf{v}^{\!\top}G^{\,j-14}w,
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A183305.
