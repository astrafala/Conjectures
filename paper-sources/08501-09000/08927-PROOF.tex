...
\title{The empirical recurrence for OEIS A183692, proved by transfer matrix}
...
\begin{abstract}
OEIS A183692 counts arrays over $\{0,\dots,2\}$ under a condition on the determinant of every
...
OEIS A183692 is ``Number of (n+1)X4 0..2 arrays with every 2X2 subblock nonsingular.''. It has offset $1$ and begins
\[
1970, 66658, 2235330, 75166498, 2525447442, 84872526674, 2852069116186, 95843840904146,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n)=17*a(n-1)+526*a(n-2)+1525*a(n-3)-14279*a(n-4)-31924*a(n-5)+135724*a(n-6)+14896*a(n-7)-63104*a(n-8)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 01:59:27, revision 9) this is still
...
$2\times4$ arrays over $\{0,\dots,2\}$ all of whose subblocks pass. The entry's
first term is $1970$, and the model reproduces it along with every later term; that is the
...
\begin{theorem}
\[
a(n)\;=\;17\,a(n-1) + 526\,a(n-2) + 1525\,a(n-3) - 14279\,a(n-4) - 31924\,a(n-5) + 135724\,a(n-6) + 14896\,a(n-7) - 63104\,a(n-8)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A183692.
