...
\title{The empirical recurrence for OEIS A238930, proved by transfer matrix}
...
\begin{abstract}
OEIS A238930 counts $2\times(n+1)$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A238930 is ``Number of (1+1)X(n+1) 0..3 arrays with no element greater than all horizontal neighbors or equal to all vertical neighbors.''. It has offset $1$ and begins
\[
12, 116, 782, 5008, 34302, 238418, 1646042, 11326068,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 10:56:35, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) - a(n-2) + 39\,a(n-3) + 58\,a(n-4) + 84\,a(n-5) - 27\,a(n-6) - 224\,a(n-7) - 281\,a(n-8) - 40\,a(n-9) + 129\,a(n-10) + 229\,a(n-11) + 137\,a(n-12) - 191\,a(n-13) - 61\,a(n-14) + 61\,a(n-15) + 3\,a(n-16) - 7\,a(n-17) + a(n-18)
\]
for every $n>18$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A238930.
