...
\title{The empirical recurrence for OEIS A252186, proved by transfer matrix}
...
\begin{abstract}
OEIS A252186 counts $(n+2)\times4$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252186 is ``Number of (n+2) X (2+2) 0..3 arrays with every 3 X 3 subblock row and column sum equal to 0 1 3 6 or 7 and every 3 X 3 diagonal and antidiagonal sum not equal to 0 1 3 6 or 7.''. It has offset $1$ and begins
\[
1440, 1886, 2610, 3996, 6368, 9508, 15094, 24092,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 7*a(n-3) -14*a(n-6) +8*a(n-9) for n>16.
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 20 2022 23:37:21, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252186.
