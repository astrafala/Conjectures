...
\title{The empirical recurrence for OEIS A242469, proved by transfer matrix}
...
\begin{abstract}
OEIS A242469 carries an empirical recurrence of order $10$ contributed by R.~H.~Hardin. It is
...
OEIS A242469 is ``Number of length n+2 0..6 arrays with no three equal elements in a row and new values 0..6 introduced in 0..6 order.''. It has offset $1$ and begins
\[
4, 12, 41, 159, 685, 3232, 16497, 90075,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 11:16:31, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A242469.
