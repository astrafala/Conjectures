...
\title{The empirical recurrence for OEIS A254691, proved by transfer matrix}
...
\begin{abstract}
OEIS A254691 carries an empirical recurrence of order $15$ contributed by R.~H.~Hardin. It is
...
OEIS A254691 is ``Number of length n+4 0..1 arrays with every five consecutive terms having the maximum of some two terms equal to the minimum of the remaining three terms.''. It has offset $1$ and begins
\[
22, 34, 54, 86, 136, 212, 334, 532,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) - a(n-2) + a(n-3) - a(n-4) + 3*a(n-5) - 3*a(n-6) - 2*a(n-8) + a(n-9) - 3*a(n-10) + a(n-11) + a(n-13) + a(n-15).
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 17 2018 09:12:55, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) - a(n-2) + a(n-3) - a(n-4) + 3\,a(n-5) - 3\,a(n-6) - 2\,a(n-8) + a(n-9) - 3\,a(n-10) + a(n-11) + a(n-13) + a(n-15)
\]
for every $n>18$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A254691.
