...
\title{The empirical recurrence for OEIS A220617, proved by transfer matrix}
...
\begin{abstract}
OEIS A220617 counts the ways of linking the cells of a grid $4$ cells wide, each cell either to
...
state, the count is a walk count on $S=25$ of them, and the conjectured recurrence is then
...
OEIS A220617 is ``Number of ways to reciprocally link elements of an nX4 array either to themselves or to exactly one horizontal, diagonal and antidiagonal neighbor.''. It has offset $1$ and begins
\[
5, 87, 1189, 17084, 243119, 3466455, 49406943, 704243629,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 16*a(n-1) -18*a(n-2) -114*a(n-3) +230*a(n-4) -66*a(n-5) -78*a(n-6) +48*a(n-7) -4*a(n-8) -4*a(n-9) +a(n-10)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 18:54:25, revision 8) this is still
...
one configuration. With $M$ the adjacency matrix of the digraph on the $S=25$ reachable
...
\begin{theorem}
\[
a(n)\;=\;16\,a(n-1) - 18\,a(n-2) - 114\,a(n-3) + 230\,a(n-4) - 66\,a(n-5) - 78\,a(n-6) + 48\,a(n-7) - 4\,a(n-8) - 4\,a(n-9) + a(n-10)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A220617.
