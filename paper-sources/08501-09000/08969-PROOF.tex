...
\title{A condition on every subblock: the empirical recurrence for OEIS A183847}
...
\begin{abstract}
OEIS A183847 carries an empirical recurrence of order $10$ contributed by R.~H.~Hardin. It is
...
OEIS A183847 is ``Number of (n+1)X3 0..3 arrays with each element of every 2X2 subblock being the sum mod 4 of two others.''. It has offset $1$ and begins
\[
107, 429, 1766, 7453, 31767, 136894, 591211, 2568541,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 02:06:41, revision 9) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{The count is a walk count}

The entry counts arrays with $3$ columns over the alphabet $\{0,1,2,3\}$, growing one row at a time, and the condition it imposes is that in every $2\times2$ subblock, each of the four entries must be congruent modulo $4$ to the sum of two of the other three.
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-1) + 5\,a(n-2) - 180\,a(n-3) + 373\,a(n-4) + 420\,a(n-5) - 1862\,a(n-6) + 1280\,a(n-7) + 660\,a(n-8) - 912\,a(n-9) + 216\,a(n-10)
\]
for every $n>10$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A183847.
