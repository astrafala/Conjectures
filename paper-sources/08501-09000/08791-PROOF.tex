...
\title{The empirical recurrence for OEIS A183722, proved by transfer matrix}
...
\begin{abstract}
OEIS A183722 counts arrays of width $3$ over $\{0,1,\dots,5\}$ subject to a condition read round the
...
count is a walk count on a finite digraph with $S=445$ vertices, and whether a linear
...
OEIS A183722 is ``1/12 the number of (n+1) X 3 0..5 arrays with every 2 X 2 subblock strictly increasing clockwise or counterclockwise with one decrease, and at least two adjacent blocks having the same increasing direction.''. It has offset $1$ and begins
\[
1, 2, 29, 388, 4170, 41423, 388998, 3528126,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n)=14*a(n-1)-36*a(n-2)-115*a(n-3)+125*a(n-4)+164*a(n-5)-155*a(n-6)-29*a(n-7)+34*a(n-8)+a(n-9)-2*a(n-10).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 06 2015 22:02:46, revision 7) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The arrays have $3$ columns and a growing number of rows, with entries in $\{0,1,\dots,5\}$. A
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=445,
\]
...
\begin{theorem}
\[
a(n)\;=\;14\,a(n-1) - 36\,a(n-2) - 115\,a(n-3) + 125\,a(n-4) + 164\,a(n-5) - 155\,a(n-6) - 29\,a(n-7) + 34\,a(n-8) + a(n-9) - 2\,a(n-10)
\]
for every $n>10$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A183722.
