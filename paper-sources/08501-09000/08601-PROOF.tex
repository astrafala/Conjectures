...
\title{The empirical recurrence for OEIS A302878, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A302878 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A302878 is ``Number of 3Xn 0..1 arrays with every element equal to 0, 1, 3, 4 or 5 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
4, 6, 17, 35, 72, 241, 722, 1821,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 15 2018 10:35:06, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 3\,a(n-2) + 2\,a(n-3) + 36\,a(n-4) - 22\,a(n-5) - 100\,a(n-6) - 5\,a(n-7) - 280\,a(n-8) + 97\,a(n-9) + 725\,a(n-10) - 111\,a(n-11) + 481\,a(n-12) - 72\,a(n-13) - 1160\,a(n-14) + 511\,a(n-15) + 19\,a(n-16) + 9\,a(n-17) + 24\,a(n-18) - 10\,a(n-19) - a(n-20)
\end{equation}
for all $n>21$.
...
the middle column. The vector $w$ was formed by $20$ applications of $G$ in exact integer
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302878.
