...
\title{The empirical recurrence for OEIS A236013, proved by transfer matrix}
...
\begin{abstract}
OEIS A236013 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
The condition is local to two consecutive rows, so the count is a walk count on $S=1276$
...
OEIS A236013 is ``Number of (n+1)X(3+1) 0..2 arrays colored with the sum of the maximum and minimum values of each 2X2 subblock.''. It has offset $1$ and begins
\[
1276, 3744, 13750, 34288, 110274, 313060, 1059410, 2852400,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 5*a(n-2) +42*a(n-4) -21*a(n-6) -207*a(n-8) for n>13
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 09:00:29, revision 6) this is still
...
\]
over the $S=1276$ pairs whose own subblock row is properly coloured.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A236013.
