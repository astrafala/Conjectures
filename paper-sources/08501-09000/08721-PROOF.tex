...
\title{The empirical recurrence for OEIS A296552, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A296552 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A296552 is ``Number of n X 6 0..1 arrays with each 1 horizontally, vertically or antidiagonally adjacent to 3 or 6 neighboring 1s.''. It has offset $1$ and begins
\[
1, 1, 5, 10, 18, 32, 62, 118,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) + 4*a(n-4) + a(n-5) + 3*a(n-6) + 6*a(n-7) + 2*a(n-9) + 4*a(n-10) + a(n-13).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 23 2019 07:24:08, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 4\,a(n-4) + a(n-5) + 3\,a(n-6) + 6\,a(n-7) + 2\,a(n-9) + 4\,a(n-10) + a(n-13)
\end{equation}
for all $n>14$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A296552.
