...
\title{The empirical recurrence for OEIS A223375, proved by transfer matrix}
...
\begin{abstract}
OEIS A223375 carries an empirical recurrence of order $9$ contributed by R.~H.~Hardin. It is
true, and it is decidable rather than empirical. The entry's condition is local to a bounded window of consecutive lines, so
the admissible configurations of such a window are the vertices of a finite digraph and the
arrays counted are exactly the walks in it; hence $a(n)$ is a walk count on $S=6561$ vertices
...
OEIS A223375 is ``3X3 square grid graph coloring a rectangular array: number of nX4 0..8 arrays where 0..8 label nodes of the square grid graph and every array movement to a horizontal or vertical neighbor moves along an edge of this graph.''. It has offset $1$ and begins
\[
192, 5808, 192752, 6443888, 215773456, 7226963248, 242067684912, 8108163611488,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 21:35:00, revision 8) this is still
...
admissible array is then exactly a walk, so with $M$ the adjacency matrix on $S=6561$ vertices
...
\begin{theorem}
\[
a(n)\;=\;43\,a(n-1) - 319\,a(n-2) - 105\,a(n-3) + 4371\,a(n-4) - 4177\,a(n-5) - 9101\,a(n-6) + 12732\,a(n-7) - 5244\,a(n-8) + 704\,a(n-9)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223375.
