...
\title{The empirical recurrence for OEIS A282394, proved by transfer matrix}
...
\begin{abstract}
OEIS A282394 counts $n\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A282394 is ``Number of nX3 0..1 arrays with no 1 equal to more than three of its king-move neighbors.''. It has offset $1$ and begins
\[
8, 57, 324, 2048, 12771, 79266, 493671, 3072417,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 5*a(n-1) +5*a(n-2) +21*a(n-3) -29*a(n-4) +7*a(n-5) -61*a(n-6) +25*a(n-7) -62*a(n-8) +4*a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 28 2017 04:03:32, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) + 5\,a(n-2) + 21\,a(n-3) - 29\,a(n-4) + 7\,a(n-5) - 61\,a(n-6) + 25\,a(n-7) - 62\,a(n-8) + 4\,a(n-9)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A282394.
