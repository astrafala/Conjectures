...
\title{The empirical recurrence for OEIS A183331, proved by transfer matrix}
...
\begin{abstract}
OEIS A183331 counts arrays of width $3$ over $\{0,1\}$ under local conditions relating each cell
...
OEIS A183331 is ``Number of n X 3 binary arrays with each 1 adjacent to exactly two 0's.''. It has offset $1$ and begins
\[
2, 10, 26, 66, 194, 534, 1468, 4102,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + a(n-2) + 3*a(n-3) + a(n-5) + 3*a(n-6) - a(n-7) - 3*a(n-8) - a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 05 2020 21:41:21, revision 10) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + a(n-2) + 3\,a(n-3) + a(n-5) + 3\,a(n-6) - a(n-7) - 3\,a(n-8) - a(n-9)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A183331.
