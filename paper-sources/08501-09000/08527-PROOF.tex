...
\title{The empirical recurrence for OEIS A269493, proved by transfer matrix}
...
\begin{abstract}
OEIS A269493 carries an empirical recurrence of order $9$ contributed by R.~H.~Hardin. It is
...
OEIS A269493 is ``Number of length-n 0..7 arrays with no repeated value differing from the previous repeated value by one.''. It has offset $1$ and begins
\[
8, 64, 512, 4082, 32460, 257536, 2039274, 16120298,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 28 2016 06:40:46, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;35\,a(n-1) - 483\,a(n-2) + 3234\,a(n-3) - 9950\,a(n-4) + 7266\,a(n-5) + 16356\,a(n-6) + 1169\,a(n-7) - 487\,a(n-8) - 21\,a(n-9)
\]
for every $n>1$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269493.
