...
\title{The empirical recurrence for OEIS A302665, proved by transfer matrix}
...
\begin{abstract}
OEIS A302665 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A302665 is ``Number of nX3 0..1 arrays with every element equal to 1, 2, 3 or 6 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 14, 43, 194, 691, 2802, 10660, 41839,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 11 2018 11:56:15, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) + 4\,a(n-2) - 11\,a(n-3) - 27\,a(n-4) - 12\,a(n-5) + 85\,a(n-6) + 22\,a(n-7) - 22\,a(n-8) - 108\,a(n-9) + 72\,a(n-10) - 80\,a(n-11) + 120\,a(n-12) + 64\,a(n-14)
\end{equation}
for all $n>14$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302665.
