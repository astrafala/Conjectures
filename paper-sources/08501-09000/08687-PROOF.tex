...
\title{The empirical recurrence for OEIS A258726, proved by transfer matrix}
...
\begin{abstract}
OEIS A258726 carries an empirical recurrence of order $12$ contributed by R.~H.~Hardin. It is
...
OEIS A258726 is ``Number of length n+4 0..3 arrays with at most one downstep in every 4 consecutive neighbor pairs.''. It has offset $1$ and begins
\[
512, 1408, 4184, 12549, 35540, 98676, 281136, 819453,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 15:31:07, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) - 6\,a(n-2) + 4\,a(n-3) + 30\,a(n-4) - 72\,a(n-5) + 58\,a(n-6) - 16\,a(n-7) - 31\,a(n-8) + 36\,a(n-9) - 10\,a(n-10) + a(n-12)
\]
for every $n>16$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A258726.
