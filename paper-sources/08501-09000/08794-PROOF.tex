...
\title{The empirical recurrence for OEIS A301963, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A301963 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A301963 is ``Number of n X 7 0..1 arrays with every element equal to 0, 1 or 4 horizontally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
21, 35, 132, 443, 1803, 7795, 33860, 148299,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 24 2023 10:01:35, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 13\,a(n-2) + 13\,a(n-3) - 19\,a(n-4) - 27\,a(n-5) + 16\,a(n-6) + 32\,a(n-7) - 23\,a(n-8) - 43\,a(n-9) + 45\,a(n-10) + 11\,a(n-11) - 29\,a(n-12) + 13\,a(n-13) - 2\,a(n-14)
\end{equation}
for all $n>17$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A301963.
