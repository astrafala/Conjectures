...
\title{The empirical recurrence for OEIS A196424, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A196424 counts arrays over $\{0,\dots,4\}$ in which every cell is constrained by the
...
OEIS A196424 is ``Number of nX2 0..4 arrays with each element equal to the number its horizontal and vertical neighbors less than itself.''. It has offset $1$ and begins
\[
3, 23, 123, 809, 5274, 33923, 219807, 1424725,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 06:31:39, revision 9) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A196424.
