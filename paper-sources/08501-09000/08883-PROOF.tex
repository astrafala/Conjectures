...
\title{The empirical recurrence for OEIS A207848, proved by transfer matrix}
...
\begin{abstract}
OEIS A207848 counts arrays over $\{0,\dots,1\}$ of width $5$ that avoid the patterns
...
OEIS A207848 is ``Number of 5 X n 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 0 0 and 1 1 1 vertically.''. It has offset
$1$ and begins
\[
16, 256, 704, 2816, 10144, 38208, 140032,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 15*a(n-2) + 4*a(n-3) - 32*a(n-4) - 4*a(n-5) + 15*a(n-6) - a(n-8) for n>9.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 26 2018 05:41:40, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207848.
