...
\title{The empirical recurrence for OEIS A222002, proved by transfer matrix}
...
\begin{abstract}
OEIS A222002 carries an empirical recurrence of order $11$ contributed by R.~H.~Hardin. It is
...
OEIS A222002 is ``Number of n X 4 arrays with each row a permutation of 1..4 having at least as many downsteps as the preceding row, with rows in lexicographically nonincreasing order.''. It has offset $1$ and begins
\[
24, 157, 704, 2470, 7328, 19228, 45894, 101543,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 14 2018 21:03:28, revision 9) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A222002.
