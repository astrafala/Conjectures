...
\title{The empirical recurrence for OEIS A231282, proved by transfer matrix}
...
\begin{abstract}
OEIS A231282 carries an empirical recurrence of order $10$ contributed by R.~H.~Hardin. It is
true, and it is decidable rather than empirical. The entry's condition is local to a bounded window of consecutive lines, so
the admissible configurations of such a window are the vertices of a finite digraph and the
arrays counted are exactly the walks in it; hence $a(n)$ is a walk count on $S=5612$ vertices
...
OEIS A231282 is ``Number of nX5 0..3 arrays x(i,j) with each element horizontally or antidiagonally next to at least one element with value (x(i,j)+1) mod 4, and upper left element zero.''. It has offset $1$ and begins
\[
0, 26, 834, 34786, 1400418, 56442770, 2276141330, 91775666754,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 06:22:03, revision 6) this is still
...
admissible array is then exactly a walk, so with $M$ the adjacency matrix on $S=5612$ vertices
...
\begin{theorem}
\[
a(n)\;=\;30\,a(n-1) + 422\,a(n-2) + 112\,a(n-3) - 13713\,a(n-4) - 12558\,a(n-5) + 109956\,a(n-6) - 205672\,a(n-7) + 110336\,a(n-8) + 3309440\,a(n-9) - 849920\,a(n-10)
\]
for every $n>11$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231282.
