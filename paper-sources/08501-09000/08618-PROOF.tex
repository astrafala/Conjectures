...
\title{The empirical recurrence for OEIS A183795, proved by transfer matrix}
...
\begin{abstract}
OEIS A183795 counts $(n+1)\times3$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A183795 is ``1/4 the number of (n+1)X3 0..3 arrays with no 2X2 subblock having sum 6.''. It has offset $1$ and begins
\[
706, 31541, 1405874, 62693809, 2795479074, 124651925557, 5558261214722, 247844696877249,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 02:01:39, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;32\,a(n-1) + 611\,a(n-2) - 1696\,a(n-3) - 25173\,a(n-4) + 95128\,a(n-5) + 140335\,a(n-6) - 1227112\,a(n-7) + 2372316\,a(n-8) - 1955184\,a(n-9) + 601344\,a(n-10)
\end{equation}
for all $n>9$.
...
\[
a(n)-\sum_i c_i\,a(n-i)\;=\;\tfrac1{4}\mathbf{1}^{\!\top}M^{\,n+1-1-10}\,q(M)\,\mathbf{1} .
\]
...
=\tfrac1{4}\mathbf{1}^{\!\top}M^{\,m-10}\,q(M)\,\mathbf{1}
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A183795.
