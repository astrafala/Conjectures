...
\title{The empirical recurrence for OEIS A237325, proved by transfer matrix}
...
\begin{abstract}
OEIS A237325 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
OEIS A237325 is ``Number of (n+1)X(1+1) 0..2 arrays with the maximum plus the upper median plus the lower median minus the minimum of every 2X2 subblock differing from its horizontal and vertical neighbors by exactly one.''. It has offset $1$ and begins
\[
81, 320, 1264, 5120, 20692, 82800, 332192, 1346016,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 288*a(n-4) -6720*a(n-8) +33536*a(n-12) for n>15
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 10:05:00, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;288\,a(n-4) - 6720\,a(n-8) + 33536\,a(n-12)
\]
for every $n>15$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237325.
