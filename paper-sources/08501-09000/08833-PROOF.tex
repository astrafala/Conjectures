...
\title{A condition on each element and its neighbours: OEIS A297744}
...
\begin{abstract}
OEIS A297744 carries an empirical recurrence of order $14$ contributed by R.~H.~Hardin. It is
...
walks in it. Hence $a(n)$ is a walk count on $S=17$ vertices and is $C$-finite, and whether the
...
OEIS A297744 is ``Number of n X 3 0..1 arrays with every 1 horizontally, diagonally or antidiagonally adjacent to 1, 3 or 4 neighboring 1's.''. It has offset $1$ and begins
\[
3, 19, 66, 230, 1142, 4344, 16384, 72571,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 21 2025 15:29:50, revision 6) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{The count is a walk count}

The entry counts arrays with $3$ columns over the alphabet $\{0,1\}$, growing one row at a time. Its condition is that every entry equal to $1$ must have exactly $1$, $3$ or $4$ of its horizontal and diagonal and antidiagonal neighbours equal to $1$.
...
Vertices with identical futures are merged, which leaves $S=17$. An admissible array is exactly a walk, so with $M$ the adjacency matrix and $\iota,\tau$ the vectors recording which states may begin and end an array,
\[
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + 46\,a(n-3) - 97\,a(n-4) - 5\,a(n-5) - 406\,a(n-6) + 458\,a(n-7) - 219\,a(n-8) + 686\,a(n-9) - 458\,a(n-10) + 566\,a(n-11) + 308\,a(n-12) - 860\,a(n-13) + 240\,a(n-14)
\]
for every $n>14$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297744.
