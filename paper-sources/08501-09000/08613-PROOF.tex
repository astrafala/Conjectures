...
\title{The empirical recurrence for OEIS A207584, proved by transfer matrix}
...
\begin{abstract}
OEIS A207584 counts arrays over $\{0,\dots,1\}$ of width $3$ that avoid the patterns
...
OEIS A207584 is ``Number of n X 3 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 0 1 and 1 1 1 vertically.''. It has offset
$1$ and begins
\[
6, 36, 60, 144, 312, 612, 1250,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) + a(n-2) + 4*a(n-3) - 2*a(n-4) - a(n-5) - 8*a(n-6) + a(n-7) - 3*a(n-8) + 3*a(n-9) -2 *a(n-10) - a(n-12) for n>14.
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 05 2018 09:28:04, revision
8) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + a(n-2) + 4\,a(n-3) - 2\,a(n-4) - a(n-5) - 8\,a(n-6) + a(n-7) - 3\,a(n-8) + 3\,a(n-9) - 2\,a(n-10) - a(n-12)
\end{equation}
for all $n>14$. 
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207584.
