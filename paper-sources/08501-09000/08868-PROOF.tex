...
\title{The empirical recurrence for OEIS A243517, proved by transfer matrix}
...
\begin{abstract}
OEIS A243517 carries an empirical recurrence of order $7$ contributed by R.~H.~Hardin. It is
true, and it is decidable rather than empirical. The entry's condition is local to a bounded window of consecutive lines, so
the admissible configurations of such a window are the vertices of a finite digraph and the
arrays counted are exactly the walks in it; hence $a(n)$ is a walk count on $S=237$ vertices
...
OEIS A243517 is ``Number of length n+2 0..8 arrays with no three elements in a row with pattern aba or abb (with a!=b) and new values 0..8 introduced in 0..8 order.''. It has offset $1$ and begins
\[
3, 5, 10, 25, 77, 280, 1157, 5296,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 23*a(n-1) - 212*a(n-2) + 1010*a(n-3) - 2669*a(n-4) + 3887*a(n-5) - 2878*a(n-6) + 840*a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 02 2018 12:25:20, revision 8) this is still
...
admissible array is then exactly a walk, so with $M$ the adjacency matrix on $S=237$ vertices
...
\begin{theorem}
\[
a(n)\;=\;23\,a(n-1) - 212\,a(n-2) + 1010\,a(n-3) - 2669\,a(n-4) + 3887\,a(n-5) - 2878\,a(n-6) + 840\,a(n-7)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A243517.
