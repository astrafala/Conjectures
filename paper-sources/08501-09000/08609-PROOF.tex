...
\title{The empirical recurrence for OEIS A296152, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A296152 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A296152 is ``Number of nX3 0..1 arrays with each 1 adjacent to 3 or 5 king-move neighboring 1s.''. It has offset $1$ and begins
\[
1, 4, 9, 16, 34, 76, 157, 325,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 06 2017 08:34:08, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;14\,a(n-3) + 5\,a(n-4) + 7\,a(n-5) - 44\,a(n-6) - 41\,a(n-7) - 63\,a(n-8) - 11\,a(n-9) - 21\,a(n-10) - a(n-11) - 20\,a(n-12) - 2\,a(n-13) - 2\,a(n-14) + 4\,a(n-15)
\end{equation}
for all $n>16$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A296152.
