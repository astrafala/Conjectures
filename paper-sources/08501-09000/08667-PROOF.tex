...
\title{The empirical recurrence for OEIS A299594, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A299594 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A299594 is ``Number of n X 7 0..1 arrays with every element unequal to 0, 1 or 4 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
21, 26, 65, 250, 541, 1225, 2583, 5488,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +a(n-2) +3*a(n-3) +a(n-4) -a(n-5) -a(n-6) for n>9.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 15 2018 15:24:05, revision 8) the statement is
...
publishes, $n=28$, the arrays have $7\cdot28$ cells over
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A299594.
