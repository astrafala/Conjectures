...
\title{The empirical recurrence for OEIS A305038, proved by transfer matrix}
...
\begin{abstract}
OEIS A305038 counts $6$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A305038 is ``Number of n X 6 0..1 arrays with every element unequal to 0, 1, 2, 6 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
32, 13, 23, 61, 109, 362, 1359, 3503,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 21 2021 08:19:07, revision
7) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + a(n-2) + 14\,a(n-3) + 6\,a(n-4) - 4\,a(n-5) - 29\,a(n-6) - 16\,a(n-7) + 2\,a(n-8) + a(n-9) + 5\,a(n-10) + 3\,a(n-11) + a(n-12) + 3\,a(n-13)
\end{equation}
for all $n>19$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A305038.
