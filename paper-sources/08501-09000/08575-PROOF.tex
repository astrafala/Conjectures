...
\title{The empirical recurrence for OEIS A302009, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A302009 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A302009 is ``Number of nX7 0..1 arrays with every element equal to 0, 1, 2 or 3 horizontally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
64, 8192, 772272, 75450768, 7350348800, 716213306576, 69786476414080, 6799869079320928,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 30 2018 12:52:14, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;85\,a(n-1) + 1213\,a(n-2) + 405\,a(n-3) - 48433\,a(n-4) - 99541\,a(n-5) + 739091\,a(n-6) + 1518593\,a(n-7) - 5898671\,a(n-8) - 5217125\,a(n-9) + 25830080\,a(n-10) - 16620026\,a(n-11) - 10284072\,a(n-12) + 13380888\,a(n-13) - 2391872\,a(n-14) - 1786496\,a(n-15) + 844032\,a(n-16) - 105472\,a(n-17)
\end{equation}
for all $n>19$.
...
publishes, $n=12$, the arrays have $7\cdot12$ cells over
...
the middle row. The vector $w$ was formed by $17$ applications of $G$ in exact integer
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302009.
