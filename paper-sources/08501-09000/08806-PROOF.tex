...
\title{The empirical recurrence for OEIS A268260, proved by transfer matrix}
...
\begin{abstract}
OEIS A268260 carries an empirical recurrence of order $14$ contributed by R.~H.~Hardin. It is
...
OEIS A268260 is ``Number of length-(n+1) 0..7 arrays with new repeated values introduced in sequential order starting with zero.''. It has offset $1$ and begins
\[
57, 407, 2907, 20771, 148468, 1061632, 7594224, 54345509,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 29 2016 12:47:13, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;57\,a(n-1) - 1400\,a(n-2) + 19187\,a(n-3) - 157759\,a(n-4) + 765212\,a(n-5) - 1872339\,a(n-6) + 503475\,a(n-7) + 6299972\,a(n-8) - 2706851\,a(n-9) - 14207501\,a(n-10) - 11689832\,a(n-11) - 4172972\,a(n-12) - 680688\,a(n-13) - 40320\,a(n-14)
\]
for every $n>0$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268260.
