...
\title{The empirical recurrence for OEIS A234030, proved by transfer matrix}
...
\begin{abstract}
OEIS A234030 counts $(n+1)\times3$ arrays over $\{0,\dots,4\}$ subject to a condition imposed on
...
OEIS A234030 is ``Number of (n+1)X(2+1) 0..4 arrays with every 2X2 subblock having the absolute values of all six edge and diagonal differences no larger than 1.''. It has offset $1$ and begins
\[
307, 3059, 30263, 300597, 2990333, 29784763, 296931707, 2962134453,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 18*a(n-1) -79*a(n-2) -56*a(n-3) +459*a(n-4) +56*a(n-5) -597*a(n-6) -88*a(n-7) +90*a(n-8) -10*a(n-9)
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 09:08:37, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;18\,a(n-1) - 79\,a(n-2) - 56\,a(n-3) + 459\,a(n-4) + 56\,a(n-5) - 597\,a(n-6) - 88\,a(n-7) + 90\,a(n-8) - 10\,a(n-9)
\end{equation}
for all $n>9$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234030.
