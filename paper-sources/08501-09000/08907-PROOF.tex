...
\title{The empirical recurrence for OEIS A237560, proved by transfer matrix}
...
\begin{abstract}
OEIS A237560 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
OEIS A237560 is ``Number of (n+1) X (1+1) 0..2 arrays with the upper median plus the lower median of every 2 X 2 subblock differing from its horizontal and vertical neighbors by exactly one.''. It has offset $1$ and begins
\[
81, 316, 1256, 4984, 19900, 78144, 311512, 1227648,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-2) + 140*a(n-4) + 632*a(n-6) + 864*a(n-8) for n>9.
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 23 2018 11:57:12, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-2) + 140\,a(n-4) + 632\,a(n-6) + 864\,a(n-8)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237560.
