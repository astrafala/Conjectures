...
\title{The empirical recurrence for OEIS A208875, proved by transfer matrix}
...
\begin{abstract}
OEIS A208875 counts $4\times n$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
every CELL over a neighbour set the entry names, and counted UP TO RELABELLING of the
alphabet; it carries an empirical recurrence of order $14$ contributed by
...
OEIS A208875 is ``Number of 4Xn 0..3 arrays with new values 0..3 introduced in row major order and no element equal to more than one of its immediate leftward or upward or right-upward antidiagonal neighbors.''. It has offset $1$ and begins
\[
15, 1979, 324682, 52947540, 8624977114, 1404920207834, 228847686794351, 37277070892199501,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 15:04:10, revision 9) this is still
...
$\{0,\dots,3\}^{4}$. The neighbourhood of a cell in column $u_i$ meets $u_{i-1}$,
$u_i$ and $u_{i+1}$ and nothing else. Take as vertices the pairs
$(r,s)\in(\{0,\dots,3\}^{4}\cup\{\varnothing\})\times\{0,\dots,3\}^{4}$,
...
\begin{theorem}
\[
a(n)\;=\;222\,a(n-1) - 10949\,a(n-2) + 228692\,a(n-3) - 2273610\,a(n-4) + 10170544\,a(n-5) - 13839646\,a(n-6) - 45418980\,a(n-7) + 225253855\,a(n-8) - 439046430\,a(n-9) + 509809347\,a(n-10) - 407061936\,a(n-11) + 239595084\,a(n-12) - 96068592\,a(n-13) + 18662400\,a(n-14)
\]
for every $n>16$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208875.
