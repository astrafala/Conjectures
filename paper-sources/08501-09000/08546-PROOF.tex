...
\title{The empirical recurrence for OEIS A236589, proved by transfer matrix}
...
\begin{abstract}
OEIS A236589 counts arrays over $\{0,\dots,3\}$ subject to a condition on the order
...
OEIS A236589 is ``Number of (n+1) X (1+1) 0..3 arrays colored with the maximum plus the minimum minus the upper median minus the lower median of every 2 X 2 subblock.''. It has offset $1$ and begins
\[
256, 2968, 34800, 407904, 4780656, 55986224, 655930368, 7685235904,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 19 2021 17:28:24, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-2) + 528\,a(n-3) + 6528\,a(n-4) + 39472\,a(n-5) + 225040\,a(n-6) + 774864\,a(n-7) + 1618048\,a(n-8) + 1466048\,a(n-9) - 12905216\,a(n-10) - 50848448\,a(n-11) - 64647040\,a(n-12) - 17521664\,a(n-13) + 300384512\,a(n-14) + 767878144\,a(n-15) + 186081280\,a(n-16) - 631834624\,a(n-17) - 1580728320\,a(n-18) - 2220163072\,a(n-19) + 2168782848\,a(n-20) + 2489057280\,a(n-21) - 1160773632\,a(n-22)
\]
for every $n>22$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A236589.
