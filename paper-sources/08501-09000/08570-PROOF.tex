...
\title{The empirical recurrence for OEIS A183687, proved by transfer matrix}
...
\begin{abstract}
OEIS A183687 counts arrays over $\{0,\dots,1\}$ under a condition on the determinant of every
...
a bounded window of consecutive rows, so the count is a walk count on $S=512$ states and is
...
OEIS A183687 is ``Number of (n+1)X9 binary arrays with every 2X2 subblock nonsingular.''. It has offset $1$ and begins
\[
768, 8912, 91136, 986128, 10382976, 110871040, 1174759296, 12503757968,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 01:59:07, revision 9) this is still
...
$(n+1)\times9$ array over $\{0,\dots,1\}$ form a grid of $n$ rows and $8$
...
another exactly when all $8$ of the subblocks they form pass. An $(n+1)$-row array is then a
walk of $n$ steps and
\[
...
At $n=1$ the array has two rows and the grid is a single row of $8$
subblocks, each tested on its own, so $a(1)$ counts the
$2\times9$ arrays over $\{0,\dots,1\}$ all of whose subblocks pass. The entry's
first term is $768$, and the model reproduces it along with every later term; that is the
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-1) + 162\,a(n-2) - 935\,a(n-3) - 10301\,a(n-4) + 50843\,a(n-5) + 343104\,a(n-6) - 1473463\,a(n-7) - 6611678\,a(n-8) + 24960936\,a(n-9) + 75737800\,a(n-10) - 253751744\,a(n-11) - 503746592\,a(n-12) + 1513486656\,a(n-13) + 1775133568\,a(n-14) - 4833383936\,a(n-15) - 2525235200\,a(n-16) + 6285426688\,a(n-17)
\]
for every $n>17$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A183687.
