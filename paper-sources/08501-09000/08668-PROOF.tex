...
\title{The empirical recurrence for OEIS A207496, proved by transfer matrix}
...
\begin{abstract}
OEIS A207496 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
...
OEIS A207496 is ``Number of nX4 0..1 arrays avoiding 0 0 0 and 0 1 1 horizontally and 0 0 1 and 1 0 0 vertically.''. It has offset
$1$ and begins
\[
9, 81, 283, 1004, 3939, 15495, 62530,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 13:59:09, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;9\,a(n-1) - 11\,a(n-2) - 92\,a(n-3) + 184\,a(n-4) + 391\,a(n-5) - 806\,a(n-6) - 893\,a(n-7) + 1570\,a(n-8) + 1170\,a(n-9) - 1486\,a(n-10) - 867\,a(n-11) + 679\,a(n-12) + 340\,a(n-13) - 139\,a(n-14) - 62\,a(n-15) + 10\,a(n-16) + 4\,a(n-17)
\end{equation}
for all $n>18$. 
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207496.
