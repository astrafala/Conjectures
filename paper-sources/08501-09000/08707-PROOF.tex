...
\title{The empirical recurrence for OEIS A297871, proved by transfer matrix}
...
\begin{abstract}
OEIS A297871 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A297871 is ``Number of nX3 0..1 arrays with every element equal to 2, 3 or 5 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
0, 3, 0, 3, 0, 3, 6, 23,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 07 2018 11:28:44, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 5\,a(n-2) - 3\,a(n-3) - 15\,a(n-4) - 9\,a(n-5) + 24\,a(n-6) + 29\,a(n-7) - a(n-8) - 36\,a(n-9) - 67\,a(n-10) - 23\,a(n-11) + 49\,a(n-12) + 43\,a(n-13) + 14\,a(n-14) + 3\,a(n-15) - 4\,a(n-16) - 2\,a(n-17)
\end{equation}
for all $n>18$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297871.
