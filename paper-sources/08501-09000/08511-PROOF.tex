...
\title{The empirical recurrence for OEIS A253699, proved by transfer matrix}
...
\begin{abstract}
OEIS A253699 counts arrays of width $3$ over $\{0,1\}$ in which two diagonal numbers of every $2\times2$ subblock each differ from the same number at a neighbouring subblock. The entry carries an
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 14:10:15, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-2) - 2\,a(n-4) + 5\,a(n-5) - 7\,a(n-6) - 3\,a(n-7) + 9\,a(n-8) - 5\,a(n-9) + a(n-10) + 5\,a(n-11) - 6\,a(n-12) - 2\,a(n-13) + 4\,a(n-14) - a(n-16)
\]
for every $n>16$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253699.
