...
\title{The empirical recurrence for OEIS A250732, proved by transfer matrix}
...
\begin{abstract}
OEIS A250732 counts arrays over $\{0,1\}$ in which a statistic taken over short runs
...
OEIS A250732 is ``Number of (3+1) X (n+1) 0..1 arrays with nondecreasing x(i,j)+x(i,j-1) in the i direction and nondecreasing min(x(i,j),x(i-1,j)) in the j direction.''. It has offset $1$ and begins
\[
33, 85, 208, 496, 1158, 2699, 6257, 14520,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) - 2*a(n-2) - 9*a(n-3) + 12*a(n-4) - 2*a(n-5) - 3*a(n-6) + a(n-7) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 16 2018 10:57:50, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) - 2\,a(n-2) - 9\,a(n-3) + 12\,a(n-4) - 2\,a(n-5) - 3\,a(n-6) + a(n-7)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250732.
