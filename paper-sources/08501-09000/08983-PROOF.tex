...
\title{The empirical recurrence for OEIS A207903, proved by transfer matrix}
...
\begin{abstract}
OEIS A207903 counts arrays over $\{0,\dots,1\}$ of width $3$ that avoid the patterns
...
OEIS A207903 is ``Number of nX3 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 0 0 and 0 1 1 vertically.''. It has offset
$1$ and begins
\[
6, 36, 102, 261, 611, 1278, 2625,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:26:00, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) - 4\,a(n-3) - 5\,a(n-4) + 9\,a(n-5) + 3\,a(n-6) - 2\,a(n-7) - 5\,a(n-8) + 2\,a(n-9) - 2\,a(n-10) + a(n-11) + a(n-12) + a(n-13) - a(n-14)
\end{equation}
for all $n>14$. 
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207903.
