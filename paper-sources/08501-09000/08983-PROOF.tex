...
\title{The empirical recurrence for OEIS A188987, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A188987 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A188987 is ``Number of n X 4 binary arrays without the pattern 0 0 1 antidiagonally or horizontally.''. It has offset $1$ and begins
\[
12, 144, 1256, 10812, 92532, 791388, 6768028, 57879084,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 9*a(n-1) -36*a(n-3) +24*a(n-4) +36*a(n-5) -48*a(n-6) +16*a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (May 01 2018 09:38:19, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;9\,a(n-1) - 36\,a(n-3) + 24\,a(n-4) + 36\,a(n-5) - 48\,a(n-6) + 16\,a(n-7)
\end{equation}
for all $n>8$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A188987.
