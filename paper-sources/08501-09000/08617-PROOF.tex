...
\title{The empirical recurrence for OEIS A254847, proved by transfer matrix}
...
\begin{abstract}
OEIS A254847 counts arrays of width $3$ over $\{0,1\}$ in which every $3\times3$ window has
...
OEIS A254847 is ``Number of (n+2) X (1+2) 0..1 arrays with no 3 x 3 subblock diagonal sum one and no antidiagonal sum two.''. It has offset $1$ and begins
\[
192, 576, 1632, 4624, 13328, 38416, 110544, 318096,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + 8*a(n-3) + 12*a(n-4) + 20*a(n-5) + 32*a(n-6) - 64*a(n-8) - 64*a(n-9)
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 18 2018 09:25:37, revision 8) this is still
...
\text{the main diagonal} & \text{must NOT be 1} \\
\text{the antidiagonal} & \text{must NOT be 2} \\
\end{array}
\]
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 8\,a(n-3) + 12\,a(n-4) + 20\,a(n-5) + 32\,a(n-6) - 64\,a(n-8) - 64\,a(n-9)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A254847.
