...
\title{The empirical recurrence for OEIS A264056, proved by transfer matrix}
...
\begin{abstract}
OEIS A264056 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=5$ rows in which
...
OEIS A264056 is ``Number of (n+1) X (4+1) arrays of permutations of 0..n*5+4 with each element having index change +-(.,.) 0,0 1,2 or 2,-2.''. It has offset $1$ and begins
\[
8, 216, 2592, 32400, 450000, 5760000, 74880000, 988650000,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 22 2021 14:03:42, revision 8) this is still
...
\[
(i-h_i,\,j-h_j)\;\in\;\{(-2,2),\ (-1,-2),\ (0,0),\ (1,2),\ (2,-2)\},
\]
...
\begin{theorem}
\[
a(n)\;=\;15\,a(n-1) - 25\,a(n-2) + 375\,a(n-3) - 5625\,a(n-4) + 9375\,a(n-5) - 15625\,a(n-6) + 234375\,a(n-7) - 390625\,a(n-8)
\]
for every $n>10$.
\end{theorem}
...
until the working vector was identically zero, settling every larger $j$ at once. The bound is exact: at $n=10$ the recurrence fails on the entry's own published terms, so no larger range holds.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264056.
