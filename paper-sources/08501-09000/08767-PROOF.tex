...
\title{The empirical recurrence for OEIS A250678, proved by transfer matrix}
...
\begin{abstract}
OEIS A250678 counts arrays over $\{0,1,2,3\}$ in which a statistic taken over short runs
...
OEIS A250678 is ``Number of (2+1)X(n+1) 0..3 arrays with nondecreasing x(i,j)+x(i,j-1) in the i direction and nondecreasing absolute value of x(i,j)-x(i-1,j) in the j direction.''. It has offset $1$ and begins
\[
520, 5154, 42422, 329226, 2406972, 16949262, 115965426, 777137322,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 12:40:43, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;19\,a(n-1) - 115\,a(n-2) + 64\,a(n-3) + 1793\,a(n-4) - 4621\,a(n-5) - 9264\,a(n-6) + 41507\,a(n-7) + 14863\,a(n-8) - 173352\,a(n-9) + 31915\,a(n-10) + 399081\,a(n-11) - 166415\,a(n-12) - 530154\,a(n-13) + 278712\,a(n-14) + 400256\,a(n-15) - 230016\,a(n-16) - 156992\,a(n-17) + 92352\,a(n-18) + 24192\,a(n-19) - 13824\,a(n-20)
\]
for every $n>19$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250678.
