...
\title{The empirical recurrence for OEIS A206932, proved by transfer matrix}
...
\begin{abstract}
OEIS A206932 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
...
OEIS A206932 is ``Number of nX4 0..1 arrays avoiding 0 0 0 horizontally and 0 1 1 vertically.''. It has offset
$1$ and begins
\[
13, 169, 1153, 6837, 35277, 170409, 783557,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 13:16:05, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;10\,a(n-1) - 24\,a(n-2) - 50\,a(n-3) + 241\,a(n-4) - 8\,a(n-5) - 750\,a(n-6) + 328\,a(n-7) + 1008\,a(n-8) - 448\,a(n-9) - 642\,a(n-10) + 200\,a(n-11) + 191\,a(n-12) - 34\,a(n-13) - 24\,a(n-14) + 2\,a(n-15) + a(n-16)
\end{equation}
for all $n>16$. 
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206932.
