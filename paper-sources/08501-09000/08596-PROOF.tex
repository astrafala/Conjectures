...
\title{The empirical recurrence for OEIS A232078, proved by transfer matrix}
...
\begin{abstract}
OEIS A232078 counts arrays of width $3$ over $\{0,\dots,1\}$ under a condition on each cell
...
OEIS A232078 is ``Number of (2+1) X (n+1) 0..1 arrays with every element equal to some horizontal, diagonal or antidiagonal neighbor, with top left element zero.''. It has offset $1$ and begins
\[
11, 87, 520, 3681, 26587, 189404, 1348429, 9607995,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 5*a(n-1) + 11*a(n-2) + 23*a(n-3) + 45*a(n-4) + 10*a(n-5) + a(n-6) - 3*a(n-7) - 2*a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2018 08:41:44, revision 7) this is still
...
$11$, which the model reproduces along with every later term. That is the cheapest check
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) + 11\,a(n-2) + 23\,a(n-3) + 45\,a(n-4) + 10\,a(n-5) + a(n-6) - 3\,a(n-7) - 2\,a(n-8)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232078.
