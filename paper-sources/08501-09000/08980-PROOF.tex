...
\title{The empirical recurrence for OEIS A250902, proved by transfer matrix}
...
\begin{abstract}
OEIS A250902 counts arrays over $\{0,1,2\}$ in which a statistic taken over short runs
...
OEIS A250902 is ``Number of (4+1) X (n+1) 0..2 arrays with nondecreasing x(i,j)-x(i,j-1) in the i direction and nondecreasing absolute value of x(i,j)-x(i-1,j) in the j direction.''. It has offset $1$ and begins
\[
1333, 4750, 14196, 39003, 102789, 265546, 680504, 1742387,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 14*a(n-1) - 85*a(n-2) + 294*a(n-3) - 639*a(n-4) + 906*a(n-5) - 839*a(n-6) + 490*a(n-7) - 164*a(n-8) + 24*a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 23 2018 08:52:49, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250902.
