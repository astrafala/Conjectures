...
\title{The empirical recurrence for OEIS A208837, proved by transfer matrix}
...
\begin{abstract}
OEIS A208837 counts arrays over $\{0,\dots,1\}$ of width $5$ that avoid the patterns
$(0,0,0), (0,0,1)$ along one axis and $(0,1,1), (1,1,0)$ along the other, and carries an empirical recurrence of
...
OEIS A208837 is ``Number of nX5 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 1 1 and 1 1 0 vertically.''. It has offset
$1$ and begins
\[
16, 256, 768, 2421, 8736, 33088, 131355,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 7*a(n-1) -8*a(n-2) -27*a(n-3) +45*a(n-4) +24*a(n-5) -51*a(n-6) -3*a(n-7) +16*a(n-8) -a(n-9) -a(n-10) for n>11
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 15:02:01, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;7\,a(n-1) - 8\,a(n-2) - 27\,a(n-3) + 45\,a(n-4) + 24\,a(n-5) - 51\,a(n-6) - 3\,a(n-7) + 16\,a(n-8) - a(n-9) - a(n-10)
\end{equation}
for all $n>11$. 
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208837.
