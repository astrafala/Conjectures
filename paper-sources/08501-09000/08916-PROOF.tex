...
\title{The empirical recurrence for OEIS A269639, proved by transfer matrix}
...
\begin{abstract}
OEIS A269639 carries an empirical recurrence of order $16$ contributed by R.~H.~Hardin. It is
...
OEIS A269639 is ``Number of length-n 0..7 arrays with no repeated value differing from the previous repeated value by other than plus two or minus 1.''. It has offset $1$ and begins
\[
8, 64, 504, 3933, 30444, 234080, 1789528, 13613507,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 02 2016 07:45:54, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;56\,a(n-1) - 1344\,a(n-2) + 17752\,a(n-3) - 135716\,a(n-4) + 545496\,a(n-5) - 463786\,a(n-6) - 4675564\,a(n-7) + 12243456\,a(n-8) + 21822328\,a(n-9) - 72836660\,a(n-10) - 123804240\,a(n-11) + 151424498\,a(n-12) + 520495760\,a(n-13) + 515921322\,a(n-14) + 232811740\,a(n-15) + 41061559\,a(n-16)
\]
for every $n>1$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269639.
