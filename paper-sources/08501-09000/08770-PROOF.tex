...
\title{The empirical recurrence for OEIS A220740, proved by transfer matrix}
...
\begin{abstract}
OEIS A220740 counts the ways of linking the cells of a grid $3$ cells wide, each cell either to
...
state, the count is a walk count on $S=50$ of them, and the conjectured recurrence is then
...
OEIS A220740 is ``Number of ways to reciprocally link elements of an 3Xn array either to themselves or to exactly two horizontal, diagonal and antidiagonal neighbors, without consecutive collinear links.''. It has offset $1$ and begins
\[
1, 4, 22, 103, 487, 2276, 10653, 49951,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 19:01:50, revision 8) this is still
...
one configuration. With $M$ the adjacency matrix of the digraph on the $S=50$ reachable
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + 11\,a(n-2) - 9\,a(n-3) - 25\,a(n-4) - 9\,a(n-5) + 13\,a(n-6) + 48\,a(n-7) + 76\,a(n-8) - 54\,a(n-9) - 148\,a(n-10) + 66\,a(n-11) - 52\,a(n-12) - 12\,a(n-13) + 105\,a(n-14) - 43\,a(n-15) + 27\,a(n-16) + a(n-17) - 5\,a(n-18) + a(n-19) - a(n-20)
\]
for every $n>19$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A220740.
