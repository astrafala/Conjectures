...
\title{The empirical recurrence for OEIS A223348, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A223348 counts arrays over $\{0,\dots,5\}$ in which every cell is constrained by the
...
OEIS A223348 is ``3 X 3 X 3 triangular graph without horizontal edges coloring a rectangular array: number of n X 4 0..5 arrays where 0..5 label nodes of a graph with edges 0,1 0,2 1,3 1,4 2,4 2,5 and every array movement to a horizontal or vertical neighbor moves along an edge of this graph.''. It has offset $1$ and begins
\[
60, 1076, 20836, 405988, 7918948, 154482340, 3013692516, 58792282660,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 23*a(n-1) - 66*a(n-2) - 52*a(n-3) + 208*a(n-4) + 32*a(n-5) - 128*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 19 2018 13:09:13, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;23\,a(n-1) - 66\,a(n-2) - 52\,a(n-3) + 208\,a(n-4) + 32\,a(n-5) - 128\,a(n-6)
\end{equation}
for all $n>6$.
...
\{x_{t,u},x_{t+d_1,u+d_2}\}\in E\ \text{ for every offset in }\mathcal N,\quad E=\{\{0,1\},\{0,2\},\{1,3\},\{1,4\},\{2,4\},\{2,5\}\}
\end{equation}
for every cell $(t,u)$.
...
$6$ values, so there are about $10^{46}$ of them to sift. The
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223348.
