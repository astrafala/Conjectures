...
\title{The empirical recurrence for OEIS A186045, proved by transfer matrix}
...
\begin{abstract}
OEIS A186045 counts $(n+2)\times4$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A186045 is ``Number of (n+2)X4 binary arrays with each 3X3 subblock singular.''. It has offset $1$ and begins
\[
2038, 21466, 224698, 2270854, 23369314, 240280270, 2466606274, 25348415950,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 03:21:56, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;14\,a(n-1) - 45\,a(n-2) + 184\,a(n-3) - 1468\,a(n-4) + 3604\,a(n-5) - 10460\,a(n-6) + 45192\,a(n-7) - 66568\,a(n-8) + 121728\,a(n-9) - 342032\,a(n-10) + 234240\,a(n-11) - 343296\,a(n-12) + 580608\,a(n-13)
\]
for every $n>12$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A186045.
