...
\title{The empirical recurrence for OEIS A252517, proved by transfer matrix}
...
\begin{abstract}
OEIS A252517 counts $(n+2)\times4$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252517 is ``Number of (n+2)X(2+2) 0..3 arrays with every 3X3 subblock row and column sum not equal to 0 2 4 6 or 7 and every 3X3 diagonal and antidiagonal sum equal to 0 2 4 6 or 7.''. It has offset $1$ and begins
\[
791, 432, 798, 1169, 2492, 5214, 9069, 20926,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 17*a(n-3) -90*a(n-6) +188*a(n-9) -184*a(n-12) +89*a(n-15) -21*a(n-18) +2*a(n-21) for n>24
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:19:13, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252517.
