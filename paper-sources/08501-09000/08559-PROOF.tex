...
\title{The empirical recurrence for OEIS A208143, proved by transfer matrix}
...
\begin{abstract}
OEIS A208143 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
...
OEIS A208143 is ``Number of 4Xn 0..1 arrays avoiding 0 0 1 and 0 1 1 horizontally and 0 0 1 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
8, 64, 240, 900, 2400, 6400, 14000,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:39:58, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208143.
