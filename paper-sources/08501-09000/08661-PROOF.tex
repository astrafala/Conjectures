...
\title{The empirical recurrence for OEIS A269536, proved by transfer matrix}
...
\begin{abstract}
OEIS A269536 carries an empirical recurrence of order $9$ contributed by R.~H.~Hardin. It is
...
OEIS A269536 is ``Number of length-n 0..7 arrays with no repeated value differing from the previous repeated value by other than one.''. It has offset $1$ and begins
\[
8, 64, 504, 3934, 30464, 234358, 1792788, 13648124,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 29 2016 07:03:56, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;31\,a(n-1) - 355\,a(n-2) + 1651\,a(n-3) - 870\,a(n-4) - 13188\,a(n-5) + 7883\,a(n-6) + 59449\,a(n-7) + 59366\,a(n-8) + 18088\,a(n-9)
\]
for every $n>1$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269536.
