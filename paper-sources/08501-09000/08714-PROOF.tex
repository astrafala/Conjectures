...
\title{The empirical recurrence for OEIS A234652, proved by transfer matrix}
...
\begin{abstract}
OEIS A234652 counts $3$-column arrays over $\{0,\dots,5\}$ in which every
...
OEIS A234652 is ``Number of (n+1) X (2+1) 0..5 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 4 (constant-stress 1 X 1 tilings).''. It has offset
$1$ and begins
\[
728, 2648, 9616, 37352, 144512, 593048, 2414992,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 20 2022 19:38:49, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;9\,a(n-1) + 59\,a(n-2) - 741\,a(n-3) - 680\,a(n-4) + 23970\,a(n-5) - 24980\,a(n-6) - 382080\,a(n-7) + 836736\,a(n-8) + 3002976\,a(n-9) - 9941184\,a(n-10) - 8688384\,a(n-11) + 53360640\,a(n-12) - 15759360\,a(n-13) - 107827200\,a(n-14) + 99532800\,a(n-15)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234652.
