...
\title{The empirical recurrence for OEIS A237569, proved by transfer matrix}
...
\begin{abstract}
OEIS A237569 counts arrays over $\{0,\dots,3\}$ subject to a condition on the order
...
OEIS A237569 is ``Number of (n+1)X(1+1) 0..3 arrays with the upper median minus the lower median of every 2X2 subblock differing from its horizontal and vertical neighbors by exactly one.''. It has offset $1$ and begins
\[
256, 1876, 13924, 103264, 769680, 5705156, 42501300, 315065200,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 10:18:47, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;23\,a(n-2) + 1473\,a(n-4) + 15833\,a(n-6) + 60176\,a(n-8) + 65344\,a(n-10) - 70656\,a(n-12) - 139264\,a(n-14)
\]
for every $n>15$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237569.
