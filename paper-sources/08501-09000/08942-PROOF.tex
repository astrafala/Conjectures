...
\title{The empirical recurrence for OEIS A274856, proved by counting patterns}
...
\begin{abstract}
OEIS A274856 counts arrays in which no entry may repeat a value found at any of three stated
...
OEIS A274856 is ``Number of nX6 0..2 arrays with no element equal to any value at offset (-1,0) (0,-1) or (-2,-2) and new values introduced in order 0..2.''. It has offset $1$ and begins
\[
16, 243, 233, 923, 3602, 14414, 58775, 240587,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 09 2016 11:01:23, revision 4) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A274856.
