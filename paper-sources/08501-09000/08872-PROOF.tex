...
\title{Parities, differences and neighbours: OEIS A239151}
...
\begin{abstract}
OEIS A239151 carries an empirical recurrence of order $14$ contributed by R.~H.~Hardin. It is
...
OEIS A239151 is ``Number of (n+1)X(2+1) 0..3 arrays with no element equal to all horizontal neighbors or unequal to all vertical neighbors, and new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
2, 2, 55, 208, 2778, 17050, 166531, 1221727,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 10:57:17, revision 6) this is still
...
Merging vertices with identical futures leaves $S=15$. An admissible array is exactly a walk, so with $M$ the adjacency matrix and $\iota,\tau$ the vectors recording which states may begin and end an array,
\[
a(n)\;=\;\iota^{\!\top}M^{\,n}\tau ,
\]
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + 51\,a(n-2) - 84\,a(n-3) - 529\,a(n-4) + 442\,a(n-5) + 1605\,a(n-6) + 1916\,a(n-7) - 5423\,a(n-8) - 5800\,a(n-9) + 8753\,a(n-10) + 890\,a(n-11) - 5088\,a(n-12) + 4464\,a(n-13) + 3456\,a(n-14)
\]
for every $n>13$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A239151.
