...
\title{The empirical recurrence for OEIS A203360, proved by transfer matrix}
...
\begin{abstract}
OEIS A203360 counts arrays of width $6$ over $\{0,1\}$ under local conditions relating each cell
...
OEIS A203360 is ``Number of nX6 binary arrays with every 1 immediately preceded by 0 to the left or above.''. It has offset $1$ and begins
\[
13, 547, 16538, 547897, 17631496, 572818585, 18550312526, 601393482628,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 10:22:50, revision 9) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=1777.
\]
...
\begin{theorem}
\[
a(n)\;=\;13\,a(n-1) + 510\,a(n-2) + 3549\,a(n-3) + 10014\,a(n-4) + 3375\,a(n-5) - 26874\,a(n-6) - 1779\,a(n-7) + 87219\,a(n-8) - 58872\,a(n-9) - 14769\,a(n-10) + 7653\,a(n-11) + 130\,a(n-12) - 433\,a(n-13) + 39\,a(n-14)
\]
for every $n>14$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A203360.
