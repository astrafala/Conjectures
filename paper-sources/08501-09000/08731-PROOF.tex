...
\title{The empirical recurrence for OEIS A295411, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A295411 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A295411 is ``Number of n X 3 0..1 arrays with each 1 horizontally or vertically adjacent to 1, 2 or 3 1s.''. It has offset $1$ and begins
\[
4, 36, 234, 1534, 10291, 68613, 457178, 3048314,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 6*a(n-1) + 28*a(n-3) + 3*a(n-4) + 49*a(n-5) + 33*a(n-6) - 34*a(n-7) - 22*a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 22 2019 10:04:57, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) + 28\,a(n-3) + 3\,a(n-4) + 49\,a(n-5) + 33\,a(n-6) - 34\,a(n-7) - 22\,a(n-8)
\end{equation}
for all $n>9$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A295411.
