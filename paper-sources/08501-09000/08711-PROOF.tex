...
\title{A condition on the multiset of every subblock: OEIS A184191}
...
\begin{abstract}
OEIS A184191 carries an empirical recurrence of order $10$ contributed by R.~H.~Hardin. It is
...
OEIS A184191 is ``Half the number of (n+1)X4 binary arrays with no 2X2 subblock containing exactly one 1.''. It has offset $1$ and begins
\[
60, 561, 5074, 46514, 425802, 3901193, 35741495, 327471410,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 02:23:11, revision 9) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{The count is a walk count}

The entry counts arrays with $4$ columns over the alphabet $\{0,1\}$, growing one row at a time, and asks that no $2\times2$ subblock holds exactly $1$ entries equal to $1$.
...
\begin{theorem}
\[
a(n)\;=\;14\,a(n-1) - 45\,a(n-2) - 18\,a(n-3) + 249\,a(n-4) - 239\,a(n-5) - 128\,a(n-6) + 184\,a(n-7) + 10\,a(n-8) - 20\,a(n-9) - 2\,a(n-10)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A184191.
