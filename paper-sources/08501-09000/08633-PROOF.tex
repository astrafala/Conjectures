...
\title{The empirical recurrence for OEIS A260066, proved by transfer matrix}
...
\begin{abstract}
OEIS A260066 counts $(n+2)\times6$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A260066 is ``Number of (n+2)X(4+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000001 00000011 or 00000111.''. It has offset $1$ and begins
\[
557, 1214, 3825, 7725, 12664, 34917, 89948, 166473,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:59:40, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-2) + 8\,a(n-3) + 21\,a(n-4) - 14\,a(n-5) - 60\,a(n-6) - 76\,a(n-7) - 98\,a(n-8) + 139\,a(n-9) + 324\,a(n-10) + 176\,a(n-11) + 138\,a(n-12) - 351\,a(n-13) - 596\,a(n-14) - 154\,a(n-15) + 90\,a(n-16) + 484\,a(n-17) + 424\,a(n-18) + 72\,a(n-19) - 160\,a(n-20) - 288\,a(n-21)
\]
for every $n>25$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A260066.
