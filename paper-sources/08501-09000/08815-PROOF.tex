...
\title{The empirical recurrence for OEIS A236739, proved by transfer matrix}
...
\begin{abstract}
OEIS A236739 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
The condition is local to two consecutive rows, so the count is a walk count on $S=35$
...
OEIS A236739 is ``Number of (n+1) X (1+1) 0..2 arrays with the upper median plus the lower median of every 2 X 2 subblock equal.''. It has offset $1$ and begins
\[
81, 267, 833, 2907, 10233, 37467, 139201, 526395,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 7*a(n-1) - 2*a(n-2) - 64*a(n-3) + 53*a(n-4) + 229*a(n-5) - 146*a(n-6) - 364*a(n-7) + 96*a(n-8) + 192*a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 21 2018 13:44:38, revision 8) this is still
...
array, which is not among the objects counted. There are $S=35$ states left.
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-1) - 2\,a(n-2) - 64\,a(n-3) + 53\,a(n-4) + 229\,a(n-5) - 146\,a(n-6) - 364\,a(n-7) + 96\,a(n-8) + 192\,a(n-9)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A236739.
