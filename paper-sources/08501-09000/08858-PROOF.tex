...
\title{The empirical recurrence for OEIS A205737, proved by transfer matrix}
...
\begin{abstract}
OEIS A205737 counts arrays over $\{0,\dots,2\}$ under a condition on the number of clockwise edge increases
...
OEIS A205737 is ``Number of 2 X (n+1) 0..2 arrays with every 2 X 2 subblock having the same number of clockwise edge increases as its horizontal neighbors and no 2 X 2 subblock having the same number of counterclockwise edge increases as its vertical neighbors.''. It has offset $1$ and begins
\[
81, 369, 1764, 8655, 43155, 218034, 1112664, 5722236,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 9*a(n-1) -18*a(n-2) -15*a(n-3) +36*a(n-4) -20*a(n-5) +11*a(n-6) -2*a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 23 2018 09:51:48, revision 10) this is still
...
\begin{theorem}
\[
a(n)\;=\;9\,a(n-1) - 18\,a(n-2) - 15\,a(n-3) + 36\,a(n-4) - 20\,a(n-5) + 11\,a(n-6) - 2\,a(n-7)
\]
for every $n>7$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A205737.
