...
\title{The empirical recurrence for OEIS A184665, proved by transfer matrix}
...
\begin{abstract}
OEIS A184665 counts $(n+1)\times2$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A184665 is ``Number of (n+1) X 2 0..3 arrays with no 2 X 2 subblock summing to less than 6.''. It has offset $1$ and begins
\[
150, 1740, 19269, 216912, 2430631, 27278035, 305991368, 3432961182,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 10*a(n-1) + 25*a(n-2) - 123*a(n-3) - 73*a(n-4) + 304*a(n-5) + 36*a(n-6) - 144*a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 27 2018 10:38:33, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;10\,a(n-1) + 25\,a(n-2) - 123\,a(n-3) - 73\,a(n-4) + 304\,a(n-5) + 36\,a(n-6) - 144\,a(n-7)
\end{equation}
for all $n>6$.
...
\text{not }\bigl(\alpha+\beta+\gamma+\delta<6\bigr),
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A184665.
