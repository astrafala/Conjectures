...
\title{The empirical recurrence for OEIS A207250, proved by transfer matrix}
...
\begin{abstract}
OEIS A207250 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
...
OEIS A207250 is ``Number of n X 4 0..1 arrays avoiding 0 0 1 and 1 0 1 horizontally and 0 1 0 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
8, 64, 216, 940, 3776, 15652, 64176,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) + 7*a(n-2) + 2*a(n-3) + 13*a(n-4) + 27*a(n-5) + 8*a(n-6) - 4*a(n-7) - 4*a(n-8) - 2*a(n-9) + a(n-10).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 21 2018 10:32:06, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 7\,a(n-2) + 2\,a(n-3) + 13\,a(n-4) + 27\,a(n-5) + 8\,a(n-6) - 4\,a(n-7) - 4\,a(n-8) - 2\,a(n-9) + a(n-10)
\end{equation}
for all $n>10$. 
...
$(0,0,1), (1,0,1)$ as $3$ consecutive entries. There are $8$ admissible rows; that condition
...
rows, so $S=64$, and declare $w\to w'$ an edge when $w'$ is $w$ with its first entry
...
values agree exactly, including the initial count of $8$ admissible rows. That is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207250.
