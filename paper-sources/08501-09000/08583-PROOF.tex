...
\title{The empirical recurrence for OEIS A251676, proved by transfer matrix}
...
\begin{abstract}
OEIS A251676 counts arrays of width $4$ over $\{0,1,2\}$ in which every $3\times3$ window has
...
OEIS A251676 is ``Number of (n+2)X(2+2) 0..2 arrays with no row, column, diagonal or antidiagonal in any 3X3 subblock summing to 2 or 4.''. It has offset $1$ and begins
\[
489, 865, 2089, 5065, 13031, 36075, 100307, 282489,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 10:29:15, revision 6) this is still
...
\text{each row} & \text{must NOT be 2 or 4} \\
\text{each column} & \text{must NOT be 2 or 4} \\
\text{the main diagonal} & \text{must NOT be 2 or 4} \\
\text{the antidiagonal} & \text{must NOT be 2 or 4} \\
\end{array}
\]
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) - a(n-2) + 12\,a(n-3) - 29\,a(n-4) + a(n-5) - 36\,a(n-6) + 82\,a(n-7) + 17\,a(n-8) + 26\,a(n-9) - 56\,a(n-10) - 20\,a(n-11) - 18\,a(n-12) - 37\,a(n-13) - 39\,a(n-14) + 20\,a(n-15) + 52\,a(n-16) + 52\,a(n-17) + 12\,a(n-18) - 20\,a(n-19) - 12\,a(n-20) - 8\,a(n-21)
\]
for every $n>22$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251676.
