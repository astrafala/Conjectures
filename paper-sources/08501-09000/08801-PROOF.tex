...
\title{The empirical recurrence for OEIS A259889, proved by transfer matrix}
...
\begin{abstract}
OEIS A259889 counts $(n+2)\times5$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A259889 is ``Number of (n+2)X(3+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000000 00000001 or 00000011.''. It has offset $1$ and begins
\[
215, 653, 3511, 13373, 40435, 151483, 595513, 2101769,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:55:30, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 2\,a(n-2) + 18\,a(n-3) + 41\,a(n-4) - a(n-5) - 34\,a(n-6) - 98\,a(n-7) - 194\,a(n-8) - 5\,a(n-9) + 94\,a(n-10) + 37\,a(n-11) + 97\,a(n-12) + 21\,a(n-13) - 12\,a(n-14) + 2\,a(n-15) - 4\,a(n-16)
\]
for every $n>16$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A259889.
