...
\title{The empirical recurrence for OEIS A233974, proved by transfer matrix}
...
\begin{abstract}
OEIS A233974 counts $(n+1)\times2$ arrays over $\{0,\dots,6\}$ subject to a condition imposed on
...
OEIS A233974 is ``Number of (n+1)X(1+1) 0..6 arrays with every 2X2 subblock having the sum of the absolute values of all six edge and diagonal differences equal to 13.''. It has offset $1$ and begins
\[
216, 1308, 7920, 50680, 323296, 2103216, 13644992, 89161440,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 78*a(n-2) -1896*a(n-4) +18176*a(n-6) -65792*a(n-8) +67072*a(n-10)
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 09:06:54, revision 7) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;78\,a(n-2) - 1896\,a(n-4) + 18176\,a(n-6) - 65792\,a(n-8) + 67072\,a(n-10)
\end{equation}
for all $n>10$.
...
|\beta-\alpha|+|\delta-\beta|+|\gamma-\delta|+|\alpha-\gamma|+|\delta-\alpha|+|\gamma-\beta|\;=\;13,
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A233974.
