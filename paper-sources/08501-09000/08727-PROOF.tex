...
\title{The empirical recurrence for OEIS A259718, proved by transfer matrix}
...
\begin{abstract}
OEIS A259718 counts $(n+2)\times5$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A259718 is ``Number of (n+2)X(3+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000001 or 00000011.''. It has offset $1$ and begins
\[
140, 228, 568, 1064, 1244, 2858, 6092, 8638,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 6*a(n-3) +6*a(n-4) -9*a(n-6) -16*a(n-7) -12*a(n-8) +4*a(n-9) +7*a(n-10) +10*a(n-11) +14*a(n-12) -3*a(n-16)
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:54:02, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-3) + 6\,a(n-4) - 9\,a(n-6) - 16\,a(n-7) - 12\,a(n-8) + 4\,a(n-9) + 7\,a(n-10) + 10\,a(n-11) + 14\,a(n-12) - 3\,a(n-16)
\]
for every $n>16$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A259718.
