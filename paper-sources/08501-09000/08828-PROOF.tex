...
\title{The empirical recurrence for OEIS A299010, proved by transfer matrix}
...
\begin{abstract}
OEIS A299010 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $equal to$ itself lying in $\{0,1,2,4,5,6\}$, and it carries an empirical
...
OEIS A299010 is ``Number of nX3 0..1 arrays with every element equal to 0, 1, 2, 4, 5 or 6 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
4, 13, 20, 44, 123, 343, 957, 2710,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 31 2018 09:35:12, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) - 3\,a(n-2) + 5\,a(n-3) - 22\,a(n-4) + 14\,a(n-5) - a(n-6) + 24\,a(n-7) - a(n-8) - 38\,a(n-9) + 61\,a(n-10) - 84\,a(n-11) + 77\,a(n-12) - 89\,a(n-13) + 54\,a(n-14) - 20\,a(n-15) + 24\,a(n-16)
\end{equation}
for all $n>17$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A299010.
