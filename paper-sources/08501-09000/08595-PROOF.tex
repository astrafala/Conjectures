...
\title{The empirical recurrence for OEIS A237855, proved by transfer matrix}
...
\begin{abstract}
OEIS A237855 counts $(n+1)\times5$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A237855 is ``Number of (n+1)X(4+1) 0..1 arrays with no element greater than all horizontal neighbors or less than all vertical neighbors.''. It has offset $1$ and begins
\[
12, 114, 773, 4826, 31651, 213165, 1428967, 9520138,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 10:30:59, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-1) - 20\,a(n-2) + 71\,a(n-3) + 6\,a(n-4) + 62\,a(n-5) + 230\,a(n-6) + 271\,a(n-7) - 483\,a(n-8) - 760\,a(n-9) - 1175\,a(n-10) + 355\,a(n-11) + 1437\,a(n-12) + 407\,a(n-13) - 1089\,a(n-14) - 275\,a(n-15) + 318\,a(n-16) + 82\,a(n-17) - 25\,a(n-18) - 17\,a(n-19) - a(n-20) + a(n-21)
\]
for every $n>21$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237855.
