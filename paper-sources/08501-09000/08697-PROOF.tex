...
\title{The empirical recurrence for OEIS A258525, proved by transfer matrix}
...
\begin{abstract}
OEIS A258525 counts the arrays over $\{0,\dots,1\}$ whose $3\times3$ subblocks carry a
...
OEIS A258525 is ``Number of (n+2)X(3+2) 0..1 arrays with every 3X3 subblock sum of the two maximums of the central row and central column plus the two minimums of the diagonal and antidiagonal nondecreasing horizontally, vertically and ne-to-sw antidiagonally.''. It has offset $1$ and begins
\[
14184, 92996, 523716, 1455282, 3806582, 11711440, 35610562, 114007482,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 15:26:39, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 11\,a(n-2) - 8\,a(n-3) - 27\,a(n-4) + 14\,a(n-5) - 83\,a(n-6) - 1344\,a(n-7) + 68\,a(n-8) + 8440\,a(n-9) + 5152\,a(n-10) - 15424\,a(n-11) - 28416\,a(n-12) + 17280\,a(n-13) + 47104\,a(n-14) - 32768\,a(n-15)
\]
for every $n>23$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A258525.
