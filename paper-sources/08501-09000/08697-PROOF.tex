...
\title{The empirical recurrence for OEIS A228659, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A228659 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A228659 is ``Number of nX7 binary arrays with top left value 1 and no two ones adjacent horizontally, diagonally or antidiagonally.''. It has offset $1$ and begins
\[
13, 194, 3556, 62368, 1096624, 19236832, 337258048, 5910459096,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 04 2025 00:05:10, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;30\,a(n-1) - 226\,a(n-2) - 108\,a(n-3) + 4324\,a(n-4) - 1612\,a(n-5) - 27016\,a(n-6) - 2240\,a(n-7) + 50112\,a(n-8) + 20032\,a(n-9) - 16768\,a(n-10) - 4864\,a(n-11) + 2048\,a(n-12)
\end{equation}
for all $n>12$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A228659.
