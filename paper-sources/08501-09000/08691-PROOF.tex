...
\title{The empirical recurrence for OEIS A298141, proved by transfer matrix}
...
\begin{abstract}
OEIS A298141 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A298141 is ``Number of n X 3 0..1 arrays with every element equal to 2, 3, 6 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
0, 2, 0, 2, 1, 6, 8, 15,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) + 2*a(n-2) + 2*a(n-5) - 4*a(n-6) - 8*a(n-7) - a(n-8) + a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 22 2018 17:08:01, revision
8) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 2\,a(n-2) + 2\,a(n-5) - 4\,a(n-6) - 8\,a(n-7) - a(n-8) + a(n-9)
\end{equation}
for all $n>9$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A298141.
