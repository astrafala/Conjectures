...
\title{The empirical recurrence for OEIS A250804, proved by transfer matrix}
...
\begin{abstract}
OEIS A250804 counts arrays over $\{0,1\}$ in which a statistic taken over short runs
...
OEIS A250804 is ``Number of (7+1)X(n+1) 0..1 arrays with nondecreasing min(x(i,j),x(i,j-1)) in the i direction and nondecreasing absolute value of x(i,j)-x(i-1,j) in the j direction.''. It has offset $1$ and begins
\[
1970, 9956, 37986, 124366, 361344, 968942, 2437366, 5849556,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 12:46:25, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) - 4\,a(n-2) - 17\,a(n-3) + 29\,a(n-4) + 16\,a(n-5) - 56\,a(n-6) + 6\,a(n-7) + 49\,a(n-8) - 19\,a(n-9) - 20\,a(n-10) + 11\,a(n-11) + 3\,a(n-12) - 2\,a(n-13)
\]
for every $n>12$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250804.
