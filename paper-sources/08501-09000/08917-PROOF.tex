...
\title{The empirical recurrence for OEIS A197345, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A197345 counts arrays over $\{0,\dots,4\}$ in which every cell is constrained by the
...
OEIS A197345 is ``Number of nX3 0..4 arrays with each element x equal to the number its horizontal and vertical neighbors equal to 3,3,1,1,0 for x=0,1,2,3,4.''. It has offset $1$ and begins
\[
1, 9, 18, 83, 245, 914, 3155, 11287,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 07:08:28, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 2\,a(n-2) + 8\,a(n-3) + 52\,a(n-4) + 40\,a(n-5) + 33\,a(n-6) - 34\,a(n-7) - 471\,a(n-8) - 603\,a(n-9) - 944\,a(n-10) - 786\,a(n-11) + 1306\,a(n-12) + 1460\,a(n-13) + 1840\,a(n-14) + 2248\,a(n-15) - 1768\,a(n-16) - 1536\,a(n-17) - 192\,a(n-18)
\end{equation}
for all $n>19$.
...
\#\{\text{neighbours with value }f(x_{t,u})\}=x_{t,u},\quad f=(3,3,1,1,0)
\end{equation}
for every cell $(t,u)$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A197345.
