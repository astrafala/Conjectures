...
\title{The empirical recurrence for OEIS A250586, proved by transfer matrix}
...
\begin{abstract}
OEIS A250586 counts arrays over $\{0,1,2\}$ in which a statistic taken over short runs
...
OEIS A250586 is ``Number of (n+1)X(2+1) 0..2 arrays with nondecreasing max(x(i,j),x(i,j-1)) in the i direction and nondecreasing min(x(i,j),x(i-1,j)) in the j direction.''. It has offset $1$ and begins
\[
167, 825, 3641, 14983, 59160, 226985, 855988, 3188758,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 12:34:09, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250586.
