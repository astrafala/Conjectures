...
\title{The empirical recurrence for OEIS A252450, proved by transfer matrix}
...
\begin{abstract}
OEIS A252450 counts $(n+2)\times3$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252450 is ``Number of (n+2) X (1+2) 0..3 arrays with every 3 X 3 subblock row, column, diagonal and antidiagonal sum not equal to 0 2 4 6 or 7.''. It has offset $1$ and begins
\[
661, 228, 323, 747, 1731, 3938, 9013, 20820,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 27 2026 14:37:21, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) - 3\,a(n-2) + 9\,a(n-3) - 9\,a(n-4) + 4\,a(n-5) - 22\,a(n-6) - 14\,a(n-7) - 19\,a(n-8) - 8\,a(n-9) + 8\,a(n-10) + 18\,a(n-11) + 24\,a(n-12) + 20\,a(n-13) + 6\,a(n-14) - 4\,a(n-15) - 8\,a(n-16) - 4\,a(n-17)
\]
for every $n>20$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252450.
