...
\title{Parities, differences and neighbours: OEIS A229399}
...
\begin{abstract}
OEIS A229399 carries an empirical recurrence of order $16$ contributed by R.~H.~Hardin. It is
...
OEIS A229399 is ``Number of n X 5 0..2 arrays with top left element 0, horizontal differences mod 3 never 1, vertical differences mod 3 never -1, and antidiagonal differences never 0.''. It has offset $1$ and begins
\[
16, 89, 536, 3357, 21464, 138645, 899860, 5852687,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 31 2025 10:49:14, revision 11) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{The count is a walk count}

The entry counts arrays with $5$ columns over the alphabet $\{0,1,2\}$, growing one row at a time, and asks that the top left entry is $0$, and the step to the right may never change the entry by $1$ modulo $3$, the step downwards may never change the entry by $-1$ modulo $3$, the step antidiagonally may never change the entry by $0$ modulo $3$.
...
\begin{theorem}
\[
a(n)\;=\;17\,a(n-1) - 120\,a(n-2) + 505\,a(n-3) - 1511\,a(n-4) + 3524\,a(n-5) - 6668\,a(n-6) + 10300\,a(n-7) - 12840\,a(n-8) + 12612\,a(n-9) - 9484\,a(n-10) + 5308\,a(n-11) - 2151\,a(n-12) + 615\,a(n-13) - 120\,a(n-14) + 15\,a(n-15) - a(n-16)
\]
for every $n>16$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A229399.
