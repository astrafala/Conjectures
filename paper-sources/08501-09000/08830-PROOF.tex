...
\title{The empirical recurrence for OEIS A302884, proved by transfer matrix}
...
\begin{abstract}
OEIS A302884 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the six horizontal, diagonal and antidiagonal neighbours, a number $equal to$ itself lying in $\{0,2,3,4,5\}$, and it carries an empirical
...
OEIS A302884 is ``Number of nX3 0..1 arrays with every element equal to 0, 2, 3, 4 or 5 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 12, 37, 141, 569, 2262, 8968, 35667,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 4*a(n-1) -a(n-2) +5*a(n-3) -3*a(n-4) -9*a(n-5) -3*a(n-6) -8*a(n-7) +4*a(n-8) +8*a(n-9) +4*a(n-10)
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 15 2018 10:46:44, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) - a(n-2) + 5\,a(n-3) - 3\,a(n-4) - 9\,a(n-5) - 3\,a(n-6) - 8\,a(n-7) + 4\,a(n-8) + 8\,a(n-9) + 4\,a(n-10)
\end{equation}
for all $n>10$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302884.
