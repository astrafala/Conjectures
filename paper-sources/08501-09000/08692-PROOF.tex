...
\title{The empirical recurrence for OEIS A297757, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297757 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A297757 is ``Number of nX3 0..1 arrays with every 1 horizontally, diagonally or antidiagonally adjacent to 2, 3 or 4 neighboring 1s.''. It has offset $1$ and begins
\[
1, 12, 52, 186, 1045, 5685, 28565, 148681,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 05 2018 18:56:38, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 2\,a(n-2) + 52\,a(n-3) + 2\,a(n-4) + 27\,a(n-5) - 378\,a(n-6) - 365\,a(n-7) - 173\,a(n-8) + 386\,a(n-9) + 1006\,a(n-10) + 488\,a(n-11) + 468\,a(n-12) + 328\,a(n-13) - 120\,a(n-14) - 80\,a(n-15)
\end{equation}
for all $n>16$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297757.
