...
\title{The empirical recurrence for OEIS A236868, proved by transfer matrix}
...
\begin{abstract}
OEIS A236868 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
The condition is local to two consecutive rows, so the count is a walk count on $S=27$
...
OEIS A236868 is ``Number of (n+1)X(1+1) 0..2 arrays with the maximum plus the upper median minus the lower median of every 2X2 subblock equal.''. It has offset $1$ and begins
\[
81, 287, 1069, 4131, 16153, 63867, 253269, 1008347,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 09:36:49, revision 8) this is still
...
array, which is not among the objects counted. There are $S=27$ states left.
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-1) + 13\,a(n-2) - 169\,a(n-3) + 51\,a(n-4) + 1481\,a(n-5) - 1425\,a(n-6) - 5803\,a(n-7) + 7222\,a(n-8) + 10368\,a(n-9) - 14764\,a(n-10) - 7052\,a(n-11) + 12456\,a(n-12) + 464\,a(n-13) - 3232\,a(n-14) + 128\,a(n-15) + 256\,a(n-16)
\]
for every $n>15$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A236868.
