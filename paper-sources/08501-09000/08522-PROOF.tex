...
\title{The empirical recurrence for OEIS A241324, proved by transfer matrix}
...
\begin{abstract}
OEIS A241324 counts $n\times3$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
every CELL over a neighbour set the entry names, and counted UP TO RELABELLING of the
alphabet; it carries an empirical recurrence of order $15$ contributed by
...
OEIS A241324 is ``Number of nX3 0..3 arrays with no element equal to fewer vertical neighbors than horizontal neighbors, with new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
2, 59, 2344, 95144, 3875244, 157912026, 6435036610, 262234101215,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 11:12:08, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;45\,a(n-1) - 171\,a(n-2) - 57\,a(n-3) - 1321\,a(n-4) + 2701\,a(n-5) + 10837\,a(n-6) + 5209\,a(n-7) + 13262\,a(n-8) - 1578\,a(n-9) - 7272\,a(n-10) - 5706\,a(n-11) - 17487\,a(n-12) - 2511\,a(n-13) + 4779\,a(n-14) - 729\,a(n-15)
\]
for every $n>15$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A241324.
