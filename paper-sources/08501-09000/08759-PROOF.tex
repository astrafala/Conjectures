...
\title{The empirical recurrence for OEIS A316514, proved by transfer matrix}
...
\begin{abstract}
OEIS A316514 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A316514 is ``Number of nX4 0..1 arrays with every element unequal to 0, 1, 2, 3, 7 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
8, 49, 75, 204, 619, 1710, 4894, 14053,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +3*a(n-2) +6*a(n-3) +3*a(n-4) -a(n-5) -5*a(n-6) -4*a(n-7) -4*a(n-8) +2*a(n-10) for n>13
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 05 2018 07:14:16, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 3\,a(n-2) + 6\,a(n-3) + 3\,a(n-4) - a(n-5) - 5\,a(n-6) - 4\,a(n-7) - 4\,a(n-8) + 2\,a(n-10)
\end{equation}
for all $n>13$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A316514.
