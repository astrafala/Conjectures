...
\title{The empirical recurrence for OEIS A209378, proved by transfer matrix}
...
\begin{abstract}
OEIS A209378 counts $(n+1)\times5$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A209378 is ``1/4 the number of (n+1) X 5 0..2 arrays with every 2 X 2 subblock having distinct edge sums.''. It has offset $1$ and begins
\[
32, 80, 156, 512, 1076, 4004, 8612, 33716,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) + 12*a(n-2) - 42*a(n-3) - 24*a(n-4) + 156*a(n-5) - 48*a(n-6) - 168*a(n-7) + 112*a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 09 2018 17:34:49, revision 13) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 12\,a(n-2) - 42\,a(n-3) - 24\,a(n-4) + 156\,a(n-5) - 48\,a(n-6) - 168\,a(n-7) + 112\,a(n-8)
\end{equation}
for all $n>8$.
...
\[
a(n)-\sum_i c_i\,a(n-i)\;=\;\tfrac1{4}\mathbf{1}^{\!\top}M^{\,n+1-1-8}\,q(M)\,\mathbf{1} .
\]
...
=\tfrac1{4}\mathbf{1}^{\!\top}M^{\,m-8}\,q(M)\,\mathbf{1}
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209378.
