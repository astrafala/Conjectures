...
\title{The empirical recurrence for OEIS A298584, proved by transfer matrix}
...
\begin{abstract}
OEIS A298584 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A298584 is ``Number of nX3 0..1 arrays with every element equal to 0, 3, 4, 5 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 1, 9, 5, 16, 31, 28, 87,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +2*a(n-2) +2*a(n-3) -4*a(n-4) -2*a(n-5) -a(n-6) -a(n-7) +a(n-9) for n>13
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 22 2018 06:49:45, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 2\,a(n-2) + 2\,a(n-3) - 4\,a(n-4) - 2\,a(n-5) - a(n-6) - a(n-7) + a(n-9)
\end{equation}
for all $n>13$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A298584.
