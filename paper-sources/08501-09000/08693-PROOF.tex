...
\title{The empirical recurrence for OEIS A298915, proved by transfer matrix}
...
\begin{abstract}
OEIS A298915 counts $6$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A298915 is ``Number of nX6 0..1 arrays with every element equal to 0, 3, 5, 7 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 5, 5, 6, 9, 14, 24, 44,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) -2*a(n-2) +a(n-3) -2*a(n-4) -a(n-7) +2*a(n-8) for n>9
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 29 2018 07:44:27, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) - 2\,a(n-2) + a(n-3) - 2\,a(n-4) - a(n-7) + 2\,a(n-8)
\end{equation}
for all $n>9$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A298915.
