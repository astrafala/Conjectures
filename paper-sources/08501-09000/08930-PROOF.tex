...
\title{The empirical recurrence for OEIS A230464, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A230464 counts arrays over $\{0,\dots,2\}$ in which every cell is constrained by the
...
OEIS A230464 is ``Number of n X 3 0..2 arrays x(i,j) with each element horizontally, diagonally or antidiagonally next to at least one element with value (x(i,j)+1) mod 3, and upper left element zero.''. It has offset $1$ and begins
\[
0, 0, 114, 1384, 16926, 212124, 2647098, 33046400,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 12*a(n-1) +12*a(n-2) -66*a(n-3) -91*a(n-4) -186*a(n-5) +360*a(n-6) +216*a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 09 2018 11:08:28, revision 7) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;12\,a(n-1) + 12\,a(n-2) - 66\,a(n-3) - 91\,a(n-4) - 186\,a(n-5) + 360\,a(n-6) + 216\,a(n-7)
\end{equation}
for all $n>8$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A230464.
