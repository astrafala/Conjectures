...
\title{The empirical recurrence for OEIS A260277, proved by transfer matrix}
...
\begin{abstract}
OEIS A260277 counts $(n+2)\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A260277 is ``Number of (n+2) X (1+2) 0..1 arrays with each 3 X 3 subblock having clockwise perimeter pattern 00000000 00000001 or 00001011.''. It has offset $1$ and begins
\[
34, 46, 99, 202, 366, 714, 1428, 2750,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + 3*a(n-3) + a(n-4) + a(n-8) for n>10.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 28 2018 14:00:38, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A260277.
