...
\title{The empirical recurrence for OEIS A206680, proved by transfer matrix}
...
\begin{abstract}
OEIS A206680 counts arrays over $\{0,\dots,2\}$ under a condition on the perimeter cycle of
every $2\times3$ and $3\times2$ subblock, and carries an empirical recurrence of order $18$ contributed by
R.~H.~Hardin. It is true, and it is decidable rather than empirical. The condition is local to
a bounded window of consecutive rows, so the count is a walk count on $S=1404$ states and is
...
OEIS A206680 is ``Number of (n+1) X 4 0..2 arrays with every 2 X 3 or 3 X 2 subblock having an unequal number of clockwise and counterclockwise edge increases.''. It has offset $1$ and begins
\[
1404, 9792, 89022, 645144, 5747676, 41876592, 373903296, 2722587120,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 13 2015 21:21:01, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;60\,a(n-2) + 332\,a(n-4) - 366\,a(n-6) - 3833\,a(n-8) + 2454\,a(n-10) + 1844\,a(n-12) + 3288\,a(n-14) + 9008\,a(n-16) - 864\,a(n-18)
\]
for every $n>19$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206680.
