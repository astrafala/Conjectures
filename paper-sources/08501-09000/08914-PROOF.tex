...
\title{The empirical recurrence for OEIS A250996, proved by transfer matrix}
...
\begin{abstract}
OEIS A250996 counts arrays over $\{0,1,2\}$ in which a statistic taken over short runs
...
OEIS A250996 is ``Number of (2+1)X(n+1) 0..2 arrays with nondecreasing min(x(i,j),x(i,j-1)) in the i direction and nondecreasing absolute value of x(i,j)-x(i-1,j) in the j direction.''. It has offset $1$ and begins
\[
158, 872, 4007, 16993, 67409, 255502, 934786, 3328627,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 12:57:42, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;9\,a(n-1) - 23\,a(n-2) - 12\,a(n-3) + 120\,a(n-4) - 72\,a(n-5) - 213\,a(n-6) + 197\,a(n-7) + 179\,a(n-8) - 186\,a(n-9) - 81\,a(n-10) + 75\,a(n-11) + 22\,a(n-12) - 11\,a(n-13) - 3\,a(n-14)
\]
for every $n>13$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250996.
