...
\title{The empirical recurrence for OEIS A202446, proved by transfer matrix}
...
\begin{abstract}
OEIS A202446 counts arrays of width $9$ over $\{0,1\}$ containing no occurrence of certain short
...
OEIS A202446 is ``Number of (n+2) X 9 binary arrays avoiding patterns 001 and 110 in rows, columns and nw-to-se diagonals.''. It has offset $1$ and begins
\[
888, 1568, 3652, 7238, 14338, 25576, 45156, 74150,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 31 2018 08:15:49, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A202446.
