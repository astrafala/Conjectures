...
\title{The empirical recurrence for OEIS A250735, proved by transfer matrix}
...
\begin{abstract}
OEIS A250735 counts arrays over $\{0,1\}$ in which a statistic taken over short runs
...
OEIS A250735 is ``Number of (6+1)X(n+1) 0..1 arrays with nondecreasing x(i,j)+x(i,j-1) in the i direction and nondecreasing min(x(i,j),x(i-1,j)) in the j direction.''. It has offset $1$ and begins
\[
166, 350, 942, 2434, 6016, 14437, 34069, 79704,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 12:44:54, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) - 8\,a(n-2) - 19\,a(n-3) + 61\,a(n-4) - 32\,a(n-5) - 70\,a(n-6) + 104\,a(n-7) - 30\,a(n-8) - 30\,a(n-9) + 24\,a(n-10) - 5\,a(n-11)
\]
for every $n>15$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250735.
