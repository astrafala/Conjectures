...
\title{The empirical recurrence for OEIS A250625, proved by transfer matrix}
...
\begin{abstract}
OEIS A250625 counts arrays over $\{0,1,2\}$ in which a statistic taken over short runs
...
OEIS A250625 is ``Number of (n+1) X (1+1) 0..2 arrays with nondecreasing x(i,j)+x(i,j-1) in the i direction and nondecreasing min(x(i,j),x(i-1,j)) in the j direction.''. It has offset $1$ and begins
\[
36, 125, 380, 1072, 2856, 7307, 18131, 43966,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 6*a(n-1) - 11*a(n-2) + a(n-3) + 16*a(n-4) - 10*a(n-5) - 7*a(n-6) + 6*a(n-7) + a(n-8) - a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 15 2018 11:07:45, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) - 11\,a(n-2) + a(n-3) + 16\,a(n-4) - 10\,a(n-5) - 7\,a(n-6) + 6\,a(n-7) + a(n-8) - a(n-9)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250625.
