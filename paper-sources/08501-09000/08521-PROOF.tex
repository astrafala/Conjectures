...
\title{The empirical recurrence for OEIS A282991, proved by transfer matrix}
...
\begin{abstract}
OEIS A282991 counts $n\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A282991 is ``Number of nX3 0..1 arrays with no 1 equal to more than one of its horizontal and vertical neighbors.''. It has offset $1$ and begins
\[
7, 33, 163, 803, 3971, 19587, 96693, 477297,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) +10*a(n-2) +20*a(n-3) +13*a(n-4) -9*a(n-5) -10*a(n-6) -3*a(n-7) -a(n-8) +a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 02 2017 12:31:40, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 10\,a(n-2) + 20\,a(n-3) + 13\,a(n-4) - 9\,a(n-5) - 10\,a(n-6) - 3\,a(n-7) - a(n-8) + a(n-9)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A282991.
