...
\title{The empirical recurrence for OEIS A251147, proved by transfer matrix}
...
\begin{abstract}
OEIS A251147 counts $7$-column arrays over $\{0,\dots,2\}$ in which every
...
OEIS A251147 is ``Number of (n+1) X (6+1) 0..2 arrays with every 2 X 2 subblock summing to 4 and no 2 X 2 subblock having exactly two nonzero entries.''. It has offset $1$
and begins
\[
427, 565, 777, 1141, 1743, 2763, 4491, 7453,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) - 5*a(n-3) + a(n-4) + 2*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 26 2018 17:03:52, revision 15) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251147.
