...
\title{The empirical recurrence for OEIS A231213, proved by transfer matrix}
...
\begin{abstract}
OEIS A231213 counts $(n+1)\times3$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A231213 is ``Number of (n+1) X (2+1) 0..2 arrays with no element unequal to a strict majority of its horizontal and vertical neighbors, with values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
4, 9, 22, 59, 156, 413, 1098, 2919,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) - a(n-2) + a(n-3) - 2*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 27 2018 19:49:28, revision 9) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231213.
