...
\title{The empirical recurrence for OEIS A223555, proved by transfer matrix}
...
\begin{abstract}
OEIS A223555 counts the ways of writing the vertices of a fixed graph $G$ into an array of width
...
single slice is a state and the count is a walk count on a finite digraph with $S=4375$ vertices.
\end{abstract}
...
\[
729, 281763, 116124291, 48435199821, 20248676896077, 8468395670690901, 3541866135681593043, 1481382428937450207651,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 21:47:18, revision 8) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=4375.
\]
...
of length $7$ over $6$ vertices is one of $6^{7}$ words, but only $S-1$ of them are
...
\begin{theorem}
\[
a(n)\;=\;579\,a(n-1) - 77474\,a(n-2) + 4635156\,a(n-3) - 154699059\,a(n-4) + 3198735625\,a(n-5) - 43344055546\,a(n-6) + 396489063452\,a(n-7) - 2477765391092\,a(n-8) + 10544713088920\,a(n-9) - 29940917775104\,a(n-10) + 54099319050624\,a(n-11) - 56116354684928\,a(n-12) + 25386144890880\,a(n-13)
\]
for every $n>15$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223555.
