...
\title{The empirical recurrence for OEIS A252718, proved by transfer matrix}
...
\begin{abstract}
OEIS A252718 counts arrays of width $9$ over an alphabet of $4$ letters in which every three
...
brings the state count down to $S=1450665$.
\end{abstract}
...
OEIS A252718 is ``Number of (n+2) X (7+2) 0..3 arrays with every consecutive three elements in every row and diagonal having exactly two distinct values, and in every column and antidiagonal not having exactly two distinct values, and new values 0 upwards introduced in row major order.''. It has offset $1$ and begins
\[
237, 107, 114, 153, 211, 270, 373, 522,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 6*a(n-3) - 11*a(n-6) + 5*a(n-9) + 2*a(n-12) - a(n-15) for n>17.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 05 2018 09:58:22, revision 9) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The array has width $9$ and entries in $\{0,1,\dots,3\}$. Four families of triples
...
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,
\]
with $S=1450665$ states in all. The walk index $j$ and the entry's own $n$ differ by a constant,
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-3) - 11\,a(n-6) + 5\,a(n-9) + 2\,a(n-12) - a(n-15)
\]
for every $n>17$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252718.
