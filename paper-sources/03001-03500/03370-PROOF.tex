...
\title{The empirical recurrence for OEIS A250359, proved by transfer matrix}
...
\begin{abstract}
OEIS A250359 carries an empirical recurrence of order $25$ contributed by R. H. Hardin. It is
...
arrays counted are exactly the walks in it; hence $a(n)$ is a walk count on $S=384$ vertices
...
OEIS A250359 is ``Number of length n arrays x(i), i=1..n with x(i) in i..i+6 and no value appearing more than 3 times.''. It has offset $1$ and begins
\[
7, 49, 343, 2397, 16700, 115963, 803382, 5565230,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 12:20:31, revision 6) this is still
...
admissible array is then exactly a walk, so with $M$ the adjacency matrix on $S=384$ vertices
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-1) - 8\,a(n-4) - 40\,a(n-5) - 265\,a(n-6) - 1800\,a(n-7) + 38\,a(n-8) + 336\,a(n-9) + 1937\,a(n-10) + 3833\,a(n-11) + 6318\,a(n-12) + 303\,a(n-13) - 1245\,a(n-14) - 3056\,a(n-15) - 1258\,a(n-16) + 725\,a(n-17) + 1024\,a(n-18) + 343\,a(n-19) + 34\,a(n-20) - 137\,a(n-21) - 77\,a(n-22) + 47\,a(n-24) + 14\,a(n-25)
\]
for every $n>0$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250359.
