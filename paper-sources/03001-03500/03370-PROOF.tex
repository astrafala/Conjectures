...
\title{The empirical closed form for OEIS A207257, proved}
...
\begin{abstract}
OEIS A207257 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A207257 is ``Number of 6 X n 0..1 arrays avoiding 0 0 1 and 1 0 1 horizontally and 0 1 0 and 1 0 1 vertically.''. It has offset $1$ and begins
\[
26, 676, 4238, 15652, 43498, 101036, 207298, 388232,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (13/180)*n\^{}6 + (143/20)*n\^{}5 + (1235/36)*n\^{}4 - (39/4)*n\^{}3 - (377/45)*n\^{}2 + (13/5)*n.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 21 2018 10:47:43, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{13 n^{6}}{180} + \frac{143 n^{5}}{20} + \frac{1235 n^{4}}{36} - \frac{39 n^{3}}{4} - \frac{377 n^{2}}{45} + \frac{13 n}{5}.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207257.
