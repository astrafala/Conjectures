...
\title{The conjectured generating function for OEIS A250880, proved}
...
\begin{abstract}
OEIS A250880 counts arrays of a fixed width under a local condition, and carries a conjectured
...
OEIS A250880 is ``Number of (3+1) X (n+1) 0..3 arrays with nondecreasing x(i,j)-x(i,j-1) in the i direction and nondecreasing x(i,j)+x(i-1,j) in the j direction.''. It has offset $1$ and begins
\[
2002, 6812, 16262, 31928, 55386, 88212,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 22 2018 11:33:55, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250880.
