...
\title{The empirical recurrence for OEIS A224156, proved by transfer matrix}
...
\begin{abstract}
OEIS A224156 counts arrays over $\{0,\dots,1\}$ whose rows, columns, diagonals or
...
is a walk count on $S=1408$ vertices and the recurrence follows from a finite exact
computation.
\end{abstract}
...
OEIS A224156 is ``Number of nX6 0..1 arrays with diagonals and rows unimodal and antidiagonals nondecreasing.''. It has offset $1$ and begins
\[
22, 169, 702, 2271, 6786, 20065, 60214, 184233,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 23:17:02, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;7\,a(n-1) - 14\,a(n-2) + 3\,a(n-3) + 7\,a(n-4) + 24\,a(n-5) - 58\,a(n-6) + 62\,a(n-7) - 67\,a(n-8) + 112\,a(n-9) - 164\,a(n-10) + 193\,a(n-11) - 92\,a(n-12) - 46\,a(n-13) + 22\,a(n-14) - 60\,a(n-15) - 144\,a(n-16) + 42\,a(n-17) - 254\,a(n-18) - 28\,a(n-19) - 120\,a(n-20) - 72\,a(n-21) + 36\,a(n-22) - 4\,a(n-23) + 12\,a(n-24)
\end{equation}
for all $n>27$.
...
bit vector), $|\mathcal V|=S=1408$; let $(r,f)\to(s,f')$ be an edge when placing $s$ after $r$
...
index corresponding to $n=27+1$ onwards, and the run continued until $S+1$ consecutive
zeros had been seen.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224156.
