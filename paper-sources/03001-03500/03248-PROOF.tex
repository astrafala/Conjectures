...
\title{The empirical recurrence for OEIS A214142, proved by transfer matrix}
...
\begin{abstract}
OEIS A214142 counts the proper colourings of a grid $1\times(n+1)$, wrapped in the growing direction, with at most $5$ colours and
...
down to $S=15$ and makes the exact residual test affordable.
\end{abstract}
...
OEIS A214142 is ``Number of 0..4 colorings of a 1 X (n+1) array circular in the n+1 direction with new values 0..4 introduced in row major order.''. It has offset $1$ and begins
\[
1, 1, 4, 11, 40, 147, 568, 2227,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 6*a(n-1) -7*a(n-2) -6*a(n-3) +8*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 15 2022 21:48:15, revision 16) this is still
...
state count is $S=15$ rather than the number of colourings.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A214142.
