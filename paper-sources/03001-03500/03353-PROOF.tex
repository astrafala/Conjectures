...
\title{The empirical closed form for OEIS A223765, proved}
...
\begin{abstract}
OEIS A223765 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
$S=448$ vertices. Any function of the form $\sum_j p_j(n)\lambda_j^{\,n}$ satisfies the
...
OEIS A223765 is ``Number of n X 3 0..1 arrays with rows, columns and antidiagonals unimodal and diagonals nondecreasing.''. It has offset $1$ and begins
\[
7, 28, 71, 155, 317, 607, 1097, 1887,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (1/720)*n\^{}6 + (1/240)*n\^{}5 + (41/144)*n\^{}4 - (13/48)*n\^{}3 + (2237/360)*n\^{}2 - (217/30)*n + 19 for n>2.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 22 2018 18:04:40, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{n^{6}}{720} + \frac{n^{5}}{240} + \frac{41 n^{4}}{144} - \frac{13 n^{3}}{48} + \frac{2237 n^{2}}{360} - \frac{217 n}{30} + 19.
\]
...
walk, so with $M$ the adjacency matrix of that digraph on $S=448$ vertices, and $u,w$ the
...
$n=10,\dots,16$ and agree at each. A monic recurrence of order $7$
determines $a(m)$ from $a(m-1),\dots,a(m-7)$, and for every $m\ge17$ both
$m>9$ and $m-7\ge10$ hold, so induction on $m$ gives $a(m)=f(m)$ for every
$m\ge10$.
Below $n=10$ the recurrence argument gives nothing, since \eqref{eq:rec} is only
established for $a$ from $n=10$ on. The remaining indices $n=3,\dots,9$ were
...
First, the walk model reproduces every one of the $34$ terms the entry publishes,
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223765.
