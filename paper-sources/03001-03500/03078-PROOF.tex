...
\title{The empirical closed form for OEIS A223952, proved}
...
\begin{abstract}
OEIS A223952 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A223952 is ``Number of 5 X n 0..1 arrays with diagonals and antidiagonals unimodal and rows nondecreasing.''. It has offset $1$ and begins
\[
32, 243, 596, 1062, 1821, 3115, 5233, 8564,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (2/15)*n\^{}5 + (1/6)*n\^{}4 + (23/6)*n\^{}3 + (89/6)*n\^{}2 + (1501/30)*n + 200 for n>3.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 24 2018 08:52:23, revision 7) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{2 n^{5}}{15} + \frac{n^{4}}{6} + \frac{23 n^{3}}{6} + \frac{89 n^{2}}{6} + \frac{1501 n}{30} + 200.
\]
...
$n=10,\dots,15$ and agree at each. A monic recurrence of order $6$
determines $a(m)$ from $a(m-1),\dots,a(m-6)$, and for every $m\ge16$ both
$m>9$ and $m-6\ge10$ hold, so induction on $m$ gives $a(m)=f(m)$ for every
$m\ge10$.
Below $n=10$ the recurrence argument gives nothing, since \eqref{eq:rec} is only
established for $a$ from $n=10$ on. The remaining indices $n=4,\dots,9$ were
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223952.
