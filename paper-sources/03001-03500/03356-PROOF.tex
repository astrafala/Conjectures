...
\title{The empirical closed form for OEIS A223833, proved}
...
\begin{abstract}
OEIS A223833 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A223833 is ``Number of n X 3 0..1 arrays with rows, diagonals and antidiagonals unimodal and columns nondecreasing.''. It has offset $1$ and begins
\[
7, 22, 48, 89, 149, 232, 342, 483,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (2/3)*n\^{}3 + (3/2)*n\^{}2 + (35/6)*n - 1.
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 18 2025 18:18:29, revision 10) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{2 n^{3}}{3} + \frac{3 n^{2}}{2} + \frac{35 n}{6} - 1.
\]
...
First, the walk model reproduces every one of the $42$ terms the entry publishes,
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223833.
