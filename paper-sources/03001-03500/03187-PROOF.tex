...
\title{The empirical closed form for OEIS A208141, proved}
...
\begin{abstract}
OEIS A208141 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A208141 is ``Number of n X 7 0..1 arrays avoiding 0 0 1 and 0 1 1 horizontally and 0 0 1 and 1 0 1 vertically.''. It has offset $1$ and begins
\[
20, 400, 3000, 14000, 49000, 141120, 352800, 792000,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (5/36)*n\^{}7 + (5/4)*n\^{}6 + (155/36)*n\^{}5 + (85/12)*n\^{}4 + (50/9)*n\^{}3 + (5/3)*n\^{}2.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 28 2018 14:35:57, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{5 n^{7}}{36} + \frac{5 n^{6}}{4} + \frac{155 n^{5}}{36} + \frac{85 n^{4}}{12} + \frac{50 n^{3}}{9} + \frac{5 n^{2}}{3}.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208141.
