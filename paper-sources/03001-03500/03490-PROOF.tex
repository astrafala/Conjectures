...
\title{The empirical closed form for OEIS A223635, proved}
...
\begin{abstract}
OEIS A223635 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
$S=90112$ vertices. Any function of the form $\sum_j p_j(n)\lambda_j^{\,n}$ satisfies the
...
OEIS A223635 is ``Number of nX6 0..1 arrays with rows, antidiagonals and columns unimodal.''. It has offset $1$ and begins
\[
22, 484, 5699, 42109, 230619, 1026377, 3907140, 13135511,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 21:54:21, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\begin{multline*}
f(n)\;=\;\frac{271 n^{12}}{5443200} - \frac{10327 n^{11}}{9979200} \\
+ \frac{61997 n^{10}}{2177280} - \frac{21923 n^{9}}{80640} \\
+ \frac{417761 n^{8}}{1814400} + \frac{37222841 n^{7}}{604800} \\
- \frac{2521405483 n^{6}}{2177280} + \frac{8668581613 n^{5}}{725760} \\
- \frac{414044081579 n^{4}}{5443200} + \frac{88564150211 n^{3}}{302400} \\
- \frac{17419930607 n^{2}}{30240} + \frac{542846047 n}{3080} \\
+ 850576.
\end{multline*}
...
walk, so with $M$ the adjacency matrix of that digraph on $S=90112$ vertices, and $u,w$ the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223635.
