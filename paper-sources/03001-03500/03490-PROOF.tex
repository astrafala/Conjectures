...
\title{The empirical closed form for OEIS A223826, proved}
...
\begin{abstract}
OEIS A223826 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A223826 is ``Number of nX3 0..2 arrays with rows and columns unimodal.''. It has offset $1$ and begins
\[
22, 484, 6166, 51136, 310396, 1492552, 5995781, 20879061,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 22:40:42, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\begin{multline*}
f(n)\;=\;\frac{5051 n^{12}}{239500800} + \frac{17911 n^{11}}{39916800} \\
+ \frac{113633 n^{10}}{21772800} + \frac{27157 n^{9}}{725760} \\
+ \frac{1331621 n^{8}}{7257600} + \frac{36461 n^{7}}{57600} \\
+ \frac{35192219 n^{6}}{21772800} + \frac{2190431 n^{5}}{725760} \\
+ \frac{24210049 n^{4}}{5443200} + \frac{4187689 n^{3}}{907200} \\
+ \frac{882989 n^{2}}{207900} + \frac{2173 n}{990} \\
+ 1.
\end{multline*}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223826.
