...
\title{The empirical recurrence for OEIS A275178, proved by counting patterns}
...
\begin{abstract}
OEIS A275178 counts arrays in which no entry may repeat a value found at any of three stated
...
OEIS A275178 is ``Number of n X 3 0..2 arrays with no element equal to any value at offset (-2,-1) (-1,0) or (-1,1) and new values introduced in order 0..2.''. It has offset $1$ and begins
\[
5, 16, 25, 41, 85, 181, 389, 834,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 4*a(n-1) - 6*a(n-2) + 5*a(n-3) - a(n-4) - a(n-5) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 01 2019 05:32:53, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A275178.
