...
\title{The empirical recurrence for OEIS A203917, proved by transfer matrix}
...
\begin{abstract}
OEIS A203917 counts $(n+2)\times4$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A203917 is ``Number of (n+2)X4 0..1 arrays with every 3X3 subblock having equal diagonal elements or equal antidiagonal elements, and new values 0..1 introduced in row major order.''. It has offset $1$ and begins
\[
392, 1682, 6050, 21632, 77618, 279752, 1008200, 3628818,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) +3*a(n-3) +16*a(n-4) +10*a(n-5) -16*a(n-6) -17*a(n-7) -5*a(n-8) -2*a(n-9) +a(n-10) for n>11
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 10:51:18, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + 3\,a(n-3) + 16\,a(n-4) + 10\,a(n-5) - 16\,a(n-6) - 17\,a(n-7) - 5\,a(n-8) - 2\,a(n-9) + a(n-10)
\]
for every $n>11$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A203917.
