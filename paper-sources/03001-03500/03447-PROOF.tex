...
\title{The empirical closed form for OEIS A223616, proved}
...
\begin{abstract}
OEIS A223616 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A223616 is ``Number of n X 4 0..1 arrays with rows and columns unimodal.''. It has offset $1$ and begins
\[
11, 121, 876, 4466, 17594, 57238, 160883, 403159,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 21 2018 10:16:33, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{n^{8}}{112} + \frac{79 n^{7}}{1260} + \frac{59 n^{6}}{180} + \frac{299 n^{5}}{360} + \frac{259 n^{4}}{144} + \frac{821 n^{3}}{360} + \frac{7219 n^{2}}{2520} + \frac{767 n}{420} + 1.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223616.
