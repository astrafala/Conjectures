...
\title{The empirical recurrence for OEIS A270054, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A270054 counts arrays over $\{0,\dots,4\}$ subject to a condition on the array as a
...
which is what keeps the digraph sparse. That makes $a(n)$ a walk count on $S=1250$ vertices,
...
OEIS A270054 is ``Number of nX4 0..4 arrays with some element plus some horizontally or vertically adjacent neighbor totalling four exactly once.''. It has offset $1$ and begins
\[
240, 99840, 22911300, 4410058320, 779206497960, 130850370606120, 21244602958557060, 3367363526042121600,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 306*a(n-1) -27803*a(n-2) +685150*a(n-3) -6795613*a(n-4) +28270996*a(n-5) -41396356*a(n-6) for n>7
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 09 2016 07:11:38, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;306\,a(n-1) - 27803\,a(n-2) + 685150\,a(n-3) - 6795613\,a(n-4) + 28270996\,a(n-5) - 41396356\,a(n-6)
\end{equation}
for all $n>7$.
...
\[
\mathcal V=\bigl\{(r,c):\ r\in\{0,\dots,4\}^{4},\ c\in\{0,1\}\bigr\},
\qquad |\mathcal V|=S=1250,
\]
...
the digraph dense, with $(4+1)^{2\cdot4}$ edges instead of the sparse set used here.
\end{remark}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A270054.
