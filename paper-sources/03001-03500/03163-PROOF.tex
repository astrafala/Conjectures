...
\title{The empirical recurrence for OEIS A268634, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A268634 counts arrays over $\{0,\dots,2\}$ subject to a condition on the array as a
...
OEIS A268634 is ``Number of n X 3 0..2 arrays with some element plus some horizontally or vertically adjacent neighbor totalling two exactly once.''. It has offset $1$ and begins
\[
12, 120, 840, 5178, 29772, 163878, 875592, 4578186,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 10*a(n-1) - 29*a(n-2) + 20*a(n-3) - 4*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 14 2019 09:01:42, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268634.
