...
\title{The empirical recurrence for OEIS A205347, proved by transfer matrix}
...
\begin{abstract}
OEIS A205347 counts, up to renaming the letters, the arrays of width $2$ over at most $4$
letters in which no two $2\times2$ subblocks that are neighbours, horizontally or vertically, have the same number of equal edges. It carries an empirical recurrence of order $8$ contributed by
...
OEIS A205347 is ``Number of (n+1) X 2 0..3 arrays with no 2 X 2 subblock having the same number of equal edges as its horizontal or vertical neighbors, and new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
15, 110, 1024, 9894, 96288, 937926, 9140400, 89074638,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 69*a(n-2) + 248*a(n-3) + 225*a(n-4) - 1296*a(n-5) - 4293*a(n-6) + 1656*a(n-7) + 9072*a(n-8) for n>9.
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 03 2018 13:57:23, revision 12) this is still
...
\begin{theorem}
\[
a(n)\;=\;69\,a(n-2) + 248\,a(n-3) + 225\,a(n-4) - 1296\,a(n-5) - 4293\,a(n-6) + 1656\,a(n-7) + 9072\,a(n-8)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A205347.
