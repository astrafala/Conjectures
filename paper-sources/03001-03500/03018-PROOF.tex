...
\title{The empirical recurrence for OEIS A252945, proved by transfer matrix}
...
\begin{abstract}
OEIS A252945 counts arrays of width $3$ over an alphabet of $3$ letters in which every three
...
OEIS A252945 is ``Number of (n+2) X (1+2) 0..2 arrays with every consecutive three elements in every row, column and nw-se diagonal having exactly two distinct values, and new values 0 upwards introduced in row major order.''. It has offset $1$ and begins
\[
198, 747, 2970, 11943, 48024, 193059, 776160, 3120579,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 6*a(n-1) - 9*a(n-2) + 4*a(n-3) + 2*a(n-4) - 6*a(n-5) + 4*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 07 2018 11:52:03, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) - 9\,a(n-2) + 4\,a(n-3) + 2\,a(n-4) - 6\,a(n-5) + 4\,a(n-6)
\]
for every $n>5$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252945.
