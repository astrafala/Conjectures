...
\title{The empirical closed form for OEIS A207168, proved}
...
\begin{abstract}
OEIS A207168 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
$S=784$ vertices. Any function of the form $\sum_j p_j(n)\lambda_j^{\,n}$ satisfies the
...
OEIS A207168 is ``Number of n X 7 0..1 arrays avoiding 0 0 0 and 1 0 1 horizontally and 0 0 1 and 1 0 1 vertically.''. It has offset $1$ and begins
\[
28, 784, 3808, 11452, 26908, 54208, 98224, 164668,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 35*n\^{}4 + 42*n\^{}3 + 7*n\^{}2 - 84*n + 28.
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 22 2025 20:04:31, revision 10) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;35 n^{4} + 42 n^{3} + 7 n^{2} - 84 n + 28.
\]
...
walk, so with $M$ the adjacency matrix of that digraph on $S=784$ vertices, and $u,w$ the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207168.
