...
\title{The empirical recurrence for OEIS A266096, proved by transfer matrix}
...
\begin{abstract}
OEIS A266096 counts arrays of width $3$ in which every entry is equal to the NUMBER of its own
...
OEIS A266096 is ``Number of n X 3 integer arrays with each element equal to the number of horizontal and antidiagonal neighbors exactly one smaller than itself.''. It has offset $1$ and begins
\[
4, 13, 64, 230, 1012, 3928, 16428, 65736,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + 12*a(n-2) + 5*a(n-3) - 12*a(n-4) - 2*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 09 2019 12:22:12, revision 8) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=1111.
\]
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 12\,a(n-2) + 5\,a(n-3) - 12\,a(n-4) - 2\,a(n-5)
\]
for every $n>5$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A266096.
