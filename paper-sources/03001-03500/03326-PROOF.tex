...
\title{The empirical recurrence for OEIS A222868, proved by transfer matrix}
...
\begin{abstract}
OEIS A222868 counts arrays in which no entry may equal the entries at a short list of fixed offsets
...
$2$ consecutive rows, $S=1581$ states in all.
\end{abstract}
...
OEIS A222868 is ``Number of n X 2 0..5 arrays with no element equal to another at a city block distance of exactly two, and new values 0..5 introduced in row major order.''. It has offset $1$ and begins
\[
2, 7, 34, 370, 5314, 82690, 1313794, 20983810,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 21*a(n-1) - 84*a(n-2) + 64*a(n-3) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 16 2018 08:59:28, revision 7) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=1581.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A222868.
