...
\title{The empirical recurrence for OEIS A217950, proved by transfer matrix}
...
\begin{abstract}
OEIS A217950 carries an empirical recurrence of order $13$ contributed by R. H. Hardin. It is
...
OEIS A217950 is ``Number of n element 0..3 arrays with each element the minimum of 4 adjacent elements of a random 0..3 array of n+3 elements.''. It has offset $1$ and begins
\[
4, 16, 50, 130, 296, 624, 1289, 2741,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2018 09:57:38, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A217950.
