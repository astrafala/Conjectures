...
\title{The empirical column recurrences for the table OEIS A251065}
...
\begin{abstract}
OEIS A251065 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A251065 is ``T(n,k)=Number of (n+1)X(k+1) 0..2 arrays with no 2X2 subblock having x11-x00 less than x10-x01.''. It has offset $1$, is
read by antidiagonals, and begins
\[
50, 222, 336, 867, 2740, 2167, 3123, 17129,\ \dots
\]
...
k=3: [order 39]\\
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 10:17:50, revision 6) these are still
...
The sequence is ``Number of (n+1)X(2) 0..2 arrays with no 2X2 subblock having x11-x00 less than x10-x01.''. Its rows are the vertices of a digraph on
...
\[
a(n)\;=\;6\,a(n-1) + 7\,a(n-2) - 23\,a(n-3) - 4\,a(n-4) + 12\,a(n-5)
\]
...
The entry gives only the order for this line: ``k=2: [order 11]''. Its model is a walk on
...
$11$ --- the stated order --- with integer coefficients
\begin{center}\small\begin{tabular}{cccccccc}
$c_{1}$ & $14$ & $c_{4}$ & $281$ & $c_{7}$ & $-69$ & $c_{10}$ & $-80$ \\
$c_{2}$ & $-12$ & $c_{5}$ & $477$ & $c_{8}$ & $517$ & $c_{11}$ & $24$ \\
$c_{3}$ & $-184$ & $c_{6}$ & $-863$ & $c_{9}$ & $-106$ &  &  \\
\end{tabular}\end{center}
Repeating with the first $11+4$ terms removed gives order $11$ again.

\subsection*{Column $k=3$, recovered}
The entry gives only the order for this line: ``k=3: [order 39]''. Its model is a walk on
...
$39$ --- the stated order --- with integer coefficients
\[
(c_1,\dots,c_{39})=(20,\ 149,\ -3483,\ -1646,\ 181002,\ -200603,\ -4389443,\ 7563091,\ 57780280,\ -117969316,\ -443230440,\ 1006122140,\ 2058747657,\ -5162805928,\ -5921804997,\ 16838704214,\ 10500869967,\ -36121221195,\ -10740080874,\ 51975978543,\ 4392901894,\ -50615684360,\ 2927992450,\ 33382009991,\ -5129616183,\ -14828202384,\ 3221326394,\ 4390111165,\ -1132749541,\ -851993343,\ 240896502,\ 105264572,\ -31183216,\ -7839280,\ 2367008,\ 314880,\ -95232,\ -5120,\ 1536).
\]
Repeating with the first $39+4$ terms removed gives order $39$ again.

\subsection*{Row $n=2$, recovered}
The entry gives only the order for this line: ``n=2: [order 12]''. Its model is a walk on
$S=27$ vertices, so it satisfies a monic recurrence of order at most $S$;
Berlekamp--Massey on $2S=54$ exact terms returns the minimal one, of order
$12$ --- the stated order --- with integer coefficients
\begin{center}\small\begin{tabular}{cccccccc}
$c_{1}$ & $18$ & $c_{4}$ & $-2268$ & $c_{7}$ & $9654$ & $c_{10}$ & $-1896$ \\
$c_{2}$ & $-146$ & $c_{5}$ & $5102$ & $c_{8}$ & $-8131$ & $c_{11}$ & $448$ \\
$c_{3}$ & $706$ & $c_{6}$ & $-8246$ & $c_{9}$ & $4808$ & $c_{12}$ & $-48$ \\
\end{tabular}\end{center}
Repeating with the first $12+4$ terms removed gives order $12$ again.

\subsection*{Row $n=3$, recovered}
The entry gives only the order for this line: ``n=3: [order 21]''. Its model is a walk on
$S=81$ vertices, so it satisfies a monic recurrence of order at most $S$;
Berlekamp--Massey on $2S=162$ exact terms returns the minimal one, of order
$21$ --- the stated order --- with integer coefficients
\begin{center}\small\begin{tabular}{cccccccc}
$c_{1}$ & $30$ & $c_{7}$ & $1190790$ & $c_{13}$ & $11438610$ & $c_{19}$ & $51552$ \\
$c_{2}$ & $-425$ & $c_{8}$ & $-2816743$ & $c_{14}$ & $-8481295$ & $c_{20}$ & $-6464$ \\
$c_{3}$ & $3782$ & $c_{9}$ & $5459714$ & $c_{15}$ & $5104082$ & $c_{21}$ & $384$ \\
$c_{4}$ & $-23721$ & $c_{10}$ & $-8729643$ & $c_{16}$ & $-2453580$ &  &  \\
$c_{5}$ & $111526$ & $c_{11}$ & $11551618$ & $c_{17}$ & $919720$ &  &  \\
$c_{6}$ & $-408077$ & $c_{12}$ & $-12652835$ & $c_{18}$ & $-259024$ &  &  \\
\end{tabular}\end{center}
Repeating with the first $21+4$ terms removed gives order $21$ again.

\subsection*{Row $n=4$, recovered}
The entry gives only the order for this line: ``n=4: [order 27]''. Its model is a walk on
...
$27$ --- the stated order --- with integer coefficients
\[
(c_1,\dots,c_{27})=(38,\ -691,\ 8006,\ -66388,\ 419576,\ -2101468,\ 8562488,\ -28910110,\ 81971700,\ -197093994,\ 404708052,\ -713198484,\ 1082053944,\ -1415611692,\ 1597131096,\ -1551815913,\ 1294677654,\ -923106107,\ 558641686,\ -284224784,\ 119985952,\ -41268128,\ 11267392,\ -2349056,\ 351232,\ -33536,\ 1536).
\]
Repeating with the first $27+4$ terms removed gives order $27$ again.

\subsection*{Row $n=5$, recovered}
The entry gives only the order for this line: ``n=5: [order 33]''. Its model is a walk on
...
\[
(c_1,\dots,c_{33})=(46,\ -1021,\ 14566,\ -150115,\ 1190818,\ -7565523,\ 39546498,\ -173394318,\ 646904260,\ -2076097186,\ 5779538716,\ -14047031686,\ 29955478756,\ -56258286310,\ 93298957284,\ -136868817069,\ 177768541494,\ -204435461489,\ 208007834270,\ -186949454951,\ 148041763226,\ -102919401431,\ 62512079546,\ -32963315700,\ 14966379960,\ -5788295520,\ 1880029760,\ -503070080,\ 107966720,\ -17863424,\ 2138624,\ -164864,\ 6144).
\]
...
model reproduces $7$ published values, $32$ decimal digits in all, every one of
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251065.
