...
\title{The empirical recurrence for OEIS A270113, proved by transfer matrix}
...
\begin{abstract}
OEIS A270113 counts arrays of width $3$ over $\{0,1,\dots,7\}$ in which the number of adjacent PAIRS of
cells whose entries add up to $7$ is exactly one. The entry carries an empirical recurrence of
...
result is a walk count on $S=1409$ states.
\end{abstract}
...
OEIS A270113 is ``Number of n X 3 0..7 arrays with some element plus some horizontally or vertically adjacent neighbor totaling seven exactly once.''. It has offset $1$ and begins
\[
112, 100800, 45440640, 16972694928, 5795977666752, 1877723928063648, 587581295287557312, 179399371883007424176,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 540*a(n-1) - 75994*a(n-2) + 835380*a(n-3) - 2393209*a(n-4) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 29 2019 14:21:29, revision 9) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The array has $3$ cells across, with entries in $\{0,1,\dots,7\}$. An ADJACENT PAIR is a pair of cells
\[
\begin{array}{l}
$(i,j)\text{ and }(i,j{+}1)$ \\
$(i,j)\text{ and }(i{+}1,j)$ \\
...
each end. Writing $k$ for the number of adjacent pairs whose two entries add up to $7$, the
...
\begin{theorem}
\[
a(n)\;=\;540\,a(n-1) - 75994\,a(n-2) + 835380\,a(n-3) - 2393209\,a(n-4)
\]
for every $n>5$.
\end{theorem}
...
adjacent pairs summing to $7$ by running over the array once for each kind of pair, and keep
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A270113.
