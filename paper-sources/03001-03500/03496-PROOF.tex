...
\title{The empirical recurrence for OEIS A223279, proved by transfer matrix}
...
\begin{abstract}
OEIS A223279 counts the ways of writing the vertices of a fixed graph $G$ into an array of width
...
OEIS A223279 is ``Rolling icosahedron face footprints: number of n X 5 0..19 arrays starting with 0 where 0..19 label faces of an icosahedron and every array movement to a horizontal, diagonal or antidiagonal neighbor moves across an icosahedral edge.''. It has offset $1$ and begins
\[
81, 1575, 38457, 1024071, 28271577, 792881031, 22392745881, 634400697159,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 45*a(n-1) - 518*a(n-2) + 1268*a(n-3) + 1704*a(n-4) - 4064*a(n-5) + 1536*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 18 2018 17:34:04, revision 10) this is still
...
\begin{theorem}
\[
a(n)\;=\;45\,a(n-1) - 518\,a(n-2) + 1268\,a(n-3) + 1704\,a(n-4) - 4064\,a(n-5) + 1536\,a(n-6)
\]
for every $n>6$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223279.
