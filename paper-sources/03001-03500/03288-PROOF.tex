...
\title{The empirical recurrence for OEIS A210054, proved by counting patterns}
...
\begin{abstract}
OEIS A210054 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A210054 is ``Number of (n+1) X 2 0..3 arrays with every 2 X 2 subblock having one, two or four distinct values, and new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
9, 51, 323, 2187, 15435, 111659, 819243, 6058155,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 13*a(n-1) - 48*a(n-2) + 52*a(n-3) - 16*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 14 2018 05:56:01, revision 9) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A210054.
