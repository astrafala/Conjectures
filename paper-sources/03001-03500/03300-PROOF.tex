...
\title{The empirical recurrence for OEIS A211530, proved by transfer matrix}
...
\begin{abstract}
OEIS A211530 carries an empirical recurrence of order $8$ contributed by R. H. Hardin. It is
...
OEIS A211530 is ``Number of -1..1 arrays x(i) of n+1 elements i=1..n+1 with set{t,u,v in 0,1}((x[i+t]+x[j+u]+x[k+v])*(-1)\^{}(t+u+v)) having two, three, four, five or six distinct values for every i,j,k<=n.''. It has offset $1$ and begins
\[
8, 22, 56, 124, 270, 560, 1156, 2336,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) - 16*a(n-3) + 11*a(n-4) + 19*a(n-5) - 16*a(n-6) - 6*a(n-7) + 4*a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 18 2018 14:02:01, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) - 16\,a(n-3) + 11\,a(n-4) + 19\,a(n-5) - 16\,a(n-6) - 6\,a(n-7) + 4\,a(n-8)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A211530.
