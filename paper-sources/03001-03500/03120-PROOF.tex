...
\title{The empirical recurrence for OEIS A183972, proved by transfer matrix}
...
\begin{abstract}
OEIS A183972 counts arrays over $\{0,\dots,3\}$ under a condition comparing a statistic of
every $2\times2$ subblock with those of its neighbours, and carries an empirical recurrence
of order $16$ contributed by R.~H.~Hardin. It is true, and it is decidable rather than
...
OEIS A183972 is ``Half the number of (n+1)X2 0..3 arrays with no 2X2 subblock sum differing from a horizontal or vertical neighbor subblock sum by more than one.''. It has offset $1$ and begins
\[
128, 992, 7688, 64976, 549152, 4780976, 41623688, 366310352,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 02:14:07, revision 10) this is still
...
$128$, which the model reproduces along with every later term, and that is the cheapest
...
\begin{theorem}
\[
a(n)\;=\;10\,a(n-1) - 96\,a(n-3) + 669\,a(n-4) - 6162\,a(n-5) + 3936\,a(n-6) + 20976\,a(n-7) - 24228\,a(n-8) + 291240\,a(n-9) - 94464\,a(n-10) - 1024704\,a(n-11) + 385344\,a(n-12) - 24192\,a(n-13) + 912384\,a(n-15) - 331776\,a(n-16)
\]
for every $n>16$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A183972.
