...
\title{The empirical closed form for OEIS A223860, proved}
...
\begin{abstract}
OEIS A223860 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A223860 is ``Number of n X 4 0..3 arrays with rows and antidiagonals unimodal and columns nondecreasing.''. It has offset $1$ and begins
\[
130, 3526, 41682, 315124, 1771012, 8008548, 30627033, 102479569,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 07 2022 11:52:33, revision 6) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{3551 n^{12}}{47900160} + \frac{3551 n^{11}}{1995840} + \frac{100307 n^{10}}{4354560} + \frac{28081 n^{9}}{145152} + \frac{1559477 n^{8}}{1451520} + \frac{14951 n^{7}}{3456} + \frac{54414629 n^{6}}{4354560} + \frac{18845069 n^{5}}{725760} + \frac{41975947 n^{4}}{1088640} + \frac{7155619 n^{3}}{181440} + \frac{694249 n^{2}}{83160} - \frac{7351 n}{990} - 11.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223860.
