...
\title{The empirical recurrence for OEIS A198904, proved by counting patterns}
...
\begin{abstract}
OEIS A198904 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
state space down from $20515$ to $S=544$. The entry's empirical recurrence of order
$21$, contributed by R.~H.~Hardin, then follows from a finite exact computation.
\end{abstract}
...
OEIS A198904 is ``Number of nX6 0..4 arrays with values 0..4 introduced in row major order and no element equal to any horizontal or vertical neighbor.''. It has offset $1$ and begins
\[
51, 62004, 89793204, 130292546801, 189062985604305, 274342896958292170, 398089706066811447174, 577654521153750977585383,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 08:01:39, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;1941\,a(n-1) - 806387\,a(n-2) + 148087843\,a(n-3) - 14409929271\,a(n-4) + 778094676063\,a(n-5) - 21816737058431\,a(n-6) + 172301552678113\,a(n-7) + 7343185920165785\,a(n-8) - 245567930834154099\,a(n-9) + 3173967512676632848\,a(n-10) - 15227320856420081570\,a(n-11) - 91185217544269175883\,a(n-12) + 1851754850894045611993\,a(n-13) - 13021262413927953929580\,a(n-14) + 53026970301996239080604\,a(n-15) - 137791962761820102384680\,a(n-16) + 234523646685947458039624\,a(n-17) - 259529910793881853229984\,a(n-18) + 179240545997964052307808\,a(n-19) - 69895831119161489802880\,a(n-20) + 11699525896373883270144\,a(n-21)
\end{equation}
for all $n>21$.
...
Assembling the $5$ lumped chains into one block-diagonal matrix $N$ of size $S=544$ and
...
\end{equation}
The unlumped alphabet had $20515$ rows in all; the lumped chain has $S=544$ states.
...
For every $n$ with $m=n+0-1\ge21$,
\[
5!\Bigl(a(n)-\sum_i c_i\,a(n-i)\Bigr)\;=\;\mathbf{v}^{\!\top}N^{\,m-21}q(N)\mathbf{1} .
\]
...
\begin{proof}
Substitute \eqref{eq:walk} into the left side and factor $N^{m-21}$ out of
...
column. The vector $w=q(N)\mathbf{1}$ was then formed by $21$ matrix--vector products
...
\eqref{eq:walk}, divided by $5!$, was evaluated at every one of the $10$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A198904.
