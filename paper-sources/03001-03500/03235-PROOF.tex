...
\title{The empirical recurrence for OEIS A279379, proved by transfer matrix}
...
\begin{abstract}
OEIS A279379 counts $n\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A279379 is ``Number of nX3 0..1 arrays with no element equal to a strict majority of its horizontal, vertical and antidiagonal neighbors, with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
1, 8, 35, 157, 695, 3157, 14243, 64170,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 11 2016 08:47:57, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) - 4\,a(n-2) + 9\,a(n-3) - 2\,a(n-4) - 8\,a(n-5) - 10\,a(n-6) - 13\,a(n-7) + 13\,a(n-8) - 2\,a(n-9) + 10\,a(n-10) + 41\,a(n-11) - 10\,a(n-12) - 53\,a(n-13) - 27\,a(n-14) + 9\,a(n-15) + 18\,a(n-16) + 8\,a(n-17) + a(n-18)
\]
for every $n>18$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A279379.
