...
\title{The empirical closed form for OEIS A223807, proved}
...
\begin{abstract}
OEIS A223807 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
$S=25600$ vertices. Any function of the form $\sum_j p_j(n)\lambda_j^{\,n}$ satisfies the
...
OEIS A223807 is ``Number of nX3 0..3 arrays with rows, columns, diagonals and antidiagonals unimodal.''. It has offset $1$ and begins
\[
50, 2500, 58806, 825896, 8165133, 62305953, 388531932, 2057610878,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 22:34:04, revision 9) this is still
...
+ \frac{131561 n^{16}}{298896998400} + \frac{2899703 n^{15}}{435891456000} \\
+ \frac{20728921 n^{14}}{261534873600} + \frac{44295233 n^{13}}{62270208000} \\
+ \frac{61053571 n^{12}}{11496038400} + \frac{1555111843 n^{11}}{50295168000} \\
+ \frac{157620907 n^{10}}{1045094400} + \frac{3423292861 n^{9}}{6096384000} \\
+ \frac{56948336183 n^{8}}{32188907520} + \frac{18757539769 n^{7}}{4790016000} \\
+ \frac{288950150603 n^{6}}{37362124800} + \frac{2420059673699 n^{5}}{326918592000} \\
+ \frac{12916777153 n^{4}}{889574400} + \frac{2892057797 n^{3}}{4540536000} \\
+ \frac{22972148831 n^{2}}{1029188160} - \frac{1109957 n}{29172} \\
+ 29.
\end{multline*}
...
walk, so with $M$ the adjacency matrix of that digraph on $S=25600$ vertices, and $u,w$ the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223807.
