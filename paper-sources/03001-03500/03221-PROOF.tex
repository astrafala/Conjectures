...
\title{The empirical recurrence for OEIS A223266, proved by transfer matrix}
...
\begin{abstract}
OEIS A223266 counts the ways of writing the vertices of a fixed graph $G$ into an array of width
...
OEIS A223266 is ``Rolling cube footprints: number of n X 5 0..5 arrays starting with 0 where 0..5 label faces of a cube and every array movement to a horizontal, diagonal or antidiagonal neighbor moves across a corresponding cube edge.''. It has offset $1$ and begins
\[
256, 67584, 19726336, 5889851392, 1771674009600, 534392715870208, 161366284997492736, 48747995907588358144,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 448*a(n-1) -46080*a(n-2) +491520*a(n-3) +37748736*a(n-4) -637534208*a(n-5) +2147483648*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 03 2014 01:54:46, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;448\,a(n-1) - 46080\,a(n-2) + 491520\,a(n-3) + 37748736\,a(n-4) - 637534208\,a(n-5) + 2147483648\,a(n-6)
\]
for every $n>6$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223266.
