...
\title{The empirical recurrence for OEIS A265988, proved by transfer matrix}
...
\begin{abstract}
OEIS A265988 counts arrays of width $4$ in which every entry is equal to the NUMBER of its own
...
OEIS A265988 is ``Number of n X 4 integer arrays with each element equal to the number of horizontal and antidiagonal neighbors not equal to itself.''. It has offset $1$ and begins
\[
1, 2, 2, 2, 7, 7, 21, 35,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + 2*a(n-2) + a(n-3) - a(n-5) - 3*a(n-6) + a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 09 2019 06:18:02, revision 10) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=3381.
\]
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 2\,a(n-2) + a(n-3) - a(n-5) - 3\,a(n-6) + a(n-7)
\]
for every $n>7$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A265988.
