...
\title{The empirical recurrence for OEIS A208636, proved by counting patterns}
...
\begin{abstract}
OEIS A208636 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A208636 is ``Number of n X 7 0..1 arrays with new values 0..1 introduced in row major order and no element equal to more than one of its immediate leftward or upward or right-upward antidiagonal neighbors.''. It has offset $1$ and begins
\[
64, 191, 628, 2149, 7504, 26508, 94320, 337227,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 8*a(n-1) - 21*a(n-2) + 20*a(n-3) - 5*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 05 2018 08:56:35, revision 9) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208636.
