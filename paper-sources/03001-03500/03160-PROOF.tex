...
\title{The empirical recurrence for OEIS A252957, proved by transfer matrix}
...
\begin{abstract}
OEIS A252957 counts arrays of width $6$ over an alphabet of $5$ letters in which every three
...
brings the state count down to $S=23031$.
\end{abstract}
...
OEIS A252957 is ``Number of (n+2)X(4+2) 0..4 arrays with every consecutive three elements in every row and diagonal having exactly two distinct values, and in every column and antidiagonal not having exactly two distinct values, and new values 0 upwards introduced in row major order.''. It has offset $1$ and begins
\[
603, 249, 369, 674, 1242, 2201, 4275, 8202,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:48:12, revision 6) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The array has width $6$ and entries in $\{0,1,\dots,4\}$. Four families of triples
...
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,
\]
with $S=23031$ states in all. The walk index $j$ and the entry's own $n$ differ by a constant,
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) - 6\,a(n-2) + 5\,a(n-3) - 40\,a(n-4) + 57\,a(n-5) + 67\,a(n-6) - 110\,a(n-7) + 15\,a(n-8) - 415\,a(n-9) + 1040\,a(n-10) - 861\,a(n-11) + 314\,a(n-12) - 175\,a(n-13) + 147\,a(n-14) - 42\,a(n-15)
\]
for every $n>17$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252957.
