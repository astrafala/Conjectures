...
\title{The empirical recurrence for OEIS A210081, proved by transfer matrix}
...
\begin{abstract}
OEIS A210081 counts arrays of width $4$ whose every $2\times2$ subblock holds a
...
OEIS A210081 is ``Number of (n+1)X4 0..3 arrays containing all values 0..3 with every 2X2 subblock having one, three or four distinct values, and new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
762, 82691, 7853122, 735082380, 68665065250, 6412474476465, 598825420604059, 55920736247669053,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 15:41:57, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;111\,a(n-1) - 1551\,a(n-2) - 11620\,a(n-3) + 269796\,a(n-4) - 346276\,a(n-5) - 10657824\,a(n-6) + 37514734\,a(n-7) + 105399645\,a(n-8) - 595931403\,a(n-9) + 25518343\,a(n-10) + 3128667030\,a(n-11) - 3607436824\,a(n-12) - 4027147296\,a(n-13) + 9243102400\,a(n-14) - 2810113344\,a(n-15) - 3425981120\,a(n-16) + 1936238208\,a(n-17) + 61521408\,a(n-18) - 60604416\,a(n-19)
\]
for every $n>19$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A210081.
