...
\title{The empirical closed form for OEIS A223866, proved}
...
\begin{abstract}
OEIS A223866 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A223866 is ``Number of 3Xn 0..3 arrays with rows and antidiagonals unimodal and columns nondecreasing.''. It has offset $1$ and begins
\[
20, 400, 4884, 41682, 273959, 1477240, 6818350, 27746619,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 22:47:26, revision 8) this is still
...
+ \frac{667 n^{16}}{951035904000} + \frac{3281 n^{15}}{174356582400} \\
+ \frac{148069 n^{14}}{402361344000} + \frac{1366301 n^{13}}{249080832000} \\
+ \frac{3748907 n^{12}}{57480192000} + \frac{1190879 n^{11}}{1916006400} \\
+ \frac{344761547 n^{10}}{73156608000} + \frac{684241027 n^{9}}{24385536000} \\
+ \frac{104051693257 n^{8}}{804722688000} + \frac{54794329 n^{7}}{119750400} \\
+ \frac{786440609 n^{6}}{628992000} + \frac{81330893999 n^{5}}{31135104000} \\
+ \frac{895703793151 n^{4}}{217945728000} + \frac{8582457311 n^{3}}{1816214400} \\
+ \frac{317136049 n^{2}}{79168320} + \frac{10267897 n}{6126120} \\
+ 1.
\end{multline*}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223866.
