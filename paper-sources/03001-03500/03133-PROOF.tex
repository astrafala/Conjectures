...
\title{The empirical recurrence for OEIS A211462, proved by transfer matrix}
...
\begin{abstract}
OEIS A211462 carries an empirical recurrence of order $16$ contributed by R. H. Hardin. It is
...
arrays counted are exactly the walks in it; hence $a(n)$ is a walk count on $S=40$ vertices
...
OEIS A211462 is ``Number of -2..2 arrays x(i) of n+1 elements i=1..n+1 with x(i)+x(j), x(i+1)+x(j+1), -(x(i)+x(j+1)), and -(x(i+1)+x(j)) having one, two or three distinct values for every i<=n and j<=n.''. It has offset $1$ and begins
\[
25, 65, 169, 407, 977, 2283, 5313, 12259,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 16:10:58, revision 8) this is still
...
admissible array is then exactly a walk, so with $M$ the adjacency matrix on $S=40$ vertices
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) - a(n-2) - 55\,a(n-3) + 70\,a(n-4) + 193\,a(n-5) - 357\,a(n-6) - 320\,a(n-7) + 802\,a(n-8) + 238\,a(n-9) - 922\,a(n-10) - 39\,a(n-11) + 533\,a(n-12) - 29\,a(n-13) - 136\,a(n-14) + 6\,a(n-15) + 12\,a(n-16)
\]
for every $n>16$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A211462.
