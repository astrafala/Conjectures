...
\title{The empirical recurrence for OEIS A223678, proved by transfer matrix}
...
\begin{abstract}
OEIS A223678 counts arrays over $\{0,\dots,1\}$ whose rows, columns, diagonals or
antidiagonals are required to be monotone or unimodal, and carries an empirical recurrence of
order $36$ contributed by R.~H.~Hardin. A monotone condition is local, but a unimodal one
...
OEIS A223678 is ``Number of nX6 0..1 arrays with rows and antidiagonals unimodal.''. It has offset $1$ and begins
\[
22, 484, 7745, 105995, 1363639, 17068664, 210660192, 2577807779,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 22:06:56, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;22\,a(n-1) - 151\,a(n-2) + 461\,a(n-3) - 797\,a(n-4) - 4885\,a(n-5) + 28261\,a(n-6) + 53750\,a(n-7) - 398208\,a(n-8) + 360701\,a(n-9) + 952132\,a(n-10) - 5152120\,a(n-11) + 7572284\,a(n-12) + 6140578\,a(n-13) - 18089482\,a(n-14) - 653352\,a(n-15) + 28175814\,a(n-16) + 67786763\,a(n-17) - 392210630\,a(n-18) + 717516941\,a(n-19) - 875602031\,a(n-20) + 904784133\,a(n-21) - 930560603\,a(n-22) + 1037859554\,a(n-23) - 1035189626\,a(n-24) + 1256680629\,a(n-25) - 1842818297\,a(n-26) + 2256596552\,a(n-27) - 2217424297\,a(n-28) + 1613743557\,a(n-29) - 832569368\,a(n-30) + 412448612\,a(n-31) - 308789168\,a(n-32) + 241553248\,a(n-33) - 122269952\,a(n-34) + 31245376\,a(n-35) - 2822400\,a(n-36)
\end{equation}
for all $n>36$.
...
$h_j=G^{j}N^{o}\mathbf{1}$, we have for $j\ge36$
\[
a(n_0+j)-\sum_i c_i\,a(n_0+j-i)=\,\mathbf{v}^{\!\top}G^{\,j-36}w,
\qquad w=h_{36}-\sum_i c_ih_{36-i} .
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223678.
