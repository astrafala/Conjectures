...
\title{The empirical recurrence for OEIS A252688, proved by transfer matrix}
...
\begin{abstract}
OEIS A252688 counts arrays of width $3$ over an alphabet of $4$ letters in which every three
...
OEIS A252688 is ``Number of (n+2)X(1+2) 0..3 arrays with every consecutive three elements in every row and column having exactly two distinct values, and in every diagonal and antidiagonal not having exactly two distinct values, and new values 0 upwards introduced in row major order.''. It has offset $1$ and begins
\[
46, 96, 148, 394, 707, 1982, 3703, 10772,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:38:13, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 9\,a(n-2) - 15\,a(n-3) - 30\,a(n-4) + 21\,a(n-5) + 80\,a(n-6) + 18\,a(n-7) - 132\,a(n-8) - 76\,a(n-9) + 88\,a(n-10) + 108\,a(n-11) - 32\,a(n-12) - 40\,a(n-13)
\]
for every $n>14$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252688.
