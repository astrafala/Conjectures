...
\title{The empirical recurrence for OEIS A275086, proved by counting patterns}
...
\begin{abstract}
OEIS A275086 counts arrays in which no entry may repeat a value found at any of three stated
...
cutting $6818$ pairs to $S=1223$ states. The entry's empirical recurrence of order $14$,
...
OEIS A275086 is ``Number of nX4 0..2 arrays with no element equal to any value at offset (0,-2) (-1,-2) or (-2,-1) and new values introduced in order 0..2.''. It has offset $1$ and begins
\[
6, 96, 508, 3088, 18440, 111900, 675600, 4094240,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 16 2016 09:19:51, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 8\,a(n-2) + 46\,a(n-3) + 133\,a(n-4) - 64\,a(n-5) - 492\,a(n-6) - 520\,a(n-7) + 568\,a(n-8) - 1592\,a(n-9) + 1156\,a(n-10) + 1328\,a(n-11) - 4992\,a(n-12) + 1440\,a(n-13) + 3456\,a(n-14)
\end{equation}
for all $n>15$.
...
$o=1n_0+0-2$, we have for $j\ge14$
\[
3!\Bigl(a(n_0+j)-\sum_i c_i\,a(n_0+j-i)\Bigr)
=\mathbf{v}^{\!\top}G^{\,j-14}w,\qquad
w=h_{14}-\sum_i c_i h_{14-i} .
\]
...
the survivors by the pattern of the new pair. The vector $w$ was formed by $14$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A275086.
