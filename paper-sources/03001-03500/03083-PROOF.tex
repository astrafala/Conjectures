...
\title{The empirical recurrence for OEIS A281600, proved by transfer matrix}
...
\begin{abstract}
OEIS A281600 counts $n\times3$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A281600 is ``Number of n X 3 0..2 arrays with no element equal to more than one of its horizontal, diagonal or antidiagonal neighbors and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
4, 29, 209, 1623, 12413, 95623, 736757, 5678559,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 7*a(n-1) + 10*a(n-2) - 26*a(n-3) - 64*a(n-4) - 40*a(n-5) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 20 2019 05:30:23, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-1) + 10\,a(n-2) - 26\,a(n-3) - 64\,a(n-4) - 40\,a(n-5)
\]
for every $n>6$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A281600.
