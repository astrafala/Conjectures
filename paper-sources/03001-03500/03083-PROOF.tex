...
\title{The empirical recurrence for OEIS A203918, proved by transfer matrix}
...
\begin{abstract}
OEIS A203918 counts $(n+2)\times5$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A203918 is ``Number of (n+2)X5 0..1 arrays with every 3X3 subblock having equal diagonal elements or equal antidiagonal elements, and new values 0..1 introduced in row major order.''. It has offset $1$ and begins
\[
1400, 6050, 21470, 75272, 267066, 949442, 3376768, 12014802,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 10:51:26, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + 7\,a(n-3) - 11\,a(n-4) + 34\,a(n-5) + 46\,a(n-6) - 74\,a(n-7) - 78\,a(n-8) - 92\,a(n-9) + 92\,a(n-10) + 92\,a(n-11) - 44\,a(n-12) + 40\,a(n-13) + 32\,a(n-15) - 16\,a(n-16)
\]
for every $n>17$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A203918.
