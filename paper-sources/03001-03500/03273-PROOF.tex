...
\title{The empirical closed form for OEIS A223790, proved}
...
\begin{abstract}
OEIS A223790 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
$S=13824$ vertices. Any function of the form $\sum_j p_j(n)\lambda_j^{\,n}$ satisfies the
...
OEIS A223790 is ``Number of 3 X n 0..2 arrays with rows, diagonals and antidiagonals unimodal.''. It has offset $1$ and begins
\[
27, 729, 8635, 62365, 334230, 1455816, 5425943, 17876443,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 09 2023 22:57:17, revision 6) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{5051 n^{12}}{239500800} + \frac{9539 n^{11}}{39916800} + \frac{86021 n^{10}}{21772800} + \frac{2861 n^{9}}{103680} + \frac{1419461 n^{8}}{7257600} + \frac{453883 n^{7}}{403200} + \frac{30663023 n^{6}}{21772800} + \frac{10887469 n^{5}}{725760} - \frac{167107181 n^{4}}{5443200} + \frac{16805993 n^{3}}{129600} - \frac{226950043 n^{2}}{831600} + \frac{1171756 n}{3465} - 185.
\]
...
walk, so with $M$ the adjacency matrix of that digraph on $S=13824$ vertices, and $u,w$ the
...
$n=15,\dots,27$ and agree at each. A monic recurrence of order $13$
determines $a(m)$ from $a(m-1),\dots,a(m-13)$, and for every $m\ge28$ both
$m>14$ and $m-13\ge15$ hold, so induction on $m$ gives $a(m)=f(m)$ for every
$m\ge15$.
Below $n=15$ the recurrence argument gives nothing, since \eqref{eq:rec} is only
established for $a$ from $n=15$ on. The remaining indices $n=2,\dots,14$ were
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223790.
