...
\title{The empirical recurrence for OEIS A204487, proved by transfer matrix}
...
\begin{abstract}
OEIS A204487 counts $(n+2)\times5$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A204487 is ``Number of (n+2)X5 0..1 arrays with every 3X3 subblock having three equal elements in a row horizontally, vertically or nw-to-se diagonally exactly one way, and new values 0..1 introduced in row major order.''. It has offset $1$ and begins
\[
610, 1189, 2547, 5407, 11331, 23851, 50897, 109489,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 11:15:20, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + a(n-2) + 9\,a(n-3) - 5\,a(n-4) - 10\,a(n-5) - 7\,a(n-6) - 20\,a(n-7) + 20\,a(n-8) - 15\,a(n-9) + 48\,a(n-10) - 10\,a(n-11) + 20\,a(n-12) - 21\,a(n-13) - 5\,a(n-14) - 6\,a(n-15) - 3\,a(n-16) + 4\,a(n-17)
\]
for every $n>25$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204487.
