...
\title{The empirical recurrence for OEIS A263678, proved by transfer matrix}
...
\begin{abstract}
OEIS A263678 carries an empirical recurrence of order $20$ contributed by R.~H.~Hardin. It is
true, and it is decidable rather than empirical. The entry's condition is local to a bounded window of consecutive lines, so
the admissible configurations of such a window are the vertices of a finite digraph and the
arrays counted are exactly the walks in it; hence $a(n)$ is a walk count on $S=130$ vertices
...
OEIS A263678 is ``Number of length n arrays of permutations of 0..n-1 with each element moved by -3 to 3 places and with no two consecutive decreases.''. It has offset $1$ and begins
\[
1, 2, 5, 17, 53, 155, 429, 1210,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 07 2022 11:47:44, revision 7) this is still
...
admissible array is then exactly a walk, so with $M$ the adjacency matrix on $S=130$ vertices
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 3\,a(n-2) + 3\,a(n-3) + 5\,a(n-4) + 9\,a(n-5) + 22\,a(n-6) - 21\,a(n-8) - 13\,a(n-9) + 2\,a(n-10) + 3\,a(n-11) - 15\,a(n-12) + 7\,a(n-14) + 5\,a(n-15) - a(n-16) - 2\,a(n-17) + 3\,a(n-18) - a(n-20)
\]
for every $n>0$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A263678.
