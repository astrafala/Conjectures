...
\title{The empirical recurrence for OEIS A232945, proved by transfer matrix}
...
\begin{abstract}
OEIS A232945 counts arrays over $\{0,\dots,3\}$ in which no two entries that are neighbours in
...
carried by one bounded piece of extra state, so the count is a walk count on $S=41$ states.
\end{abstract}
...
OEIS A232945 is ``Number of n X 5 0..3 arrays with no element x(i,j) adjacent to value 3-x(i,j) horizontally, vertically or antidiagonally, and top left element zero.''. It has offset $1$ and begins
\[
81, 3363, 161621, 7915555, 389997789, 19245039957, 950054488141, 46905123394619,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 06 2025 13:56:40, revision 10) this is still
...
identified; after that identification there are $S=41$ of them.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232945.
