...
\title{The empirical recurrence for OEIS A275353, proved by transfer matrix}
...
\begin{abstract}
OEIS A275353 counts arrays in which no entry may equal the entries at a short list of fixed offsets
...
$2$ consecutive columns, $S=379$ states in all.
\end{abstract}
...
OEIS A275353 is ``Number of 3Xn 0..2 arrays with no element equal to any value at offset (-2,-1) (-2,1) or (-1,-2) and new values introduced in order 0..2.''. It has offset $1$ and begins
\[
5, 54, 288, 1536, 8192, 43712, 235072, 1264832,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 24 2016 10:05:48, revision 4) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=379.
\]
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) - 2\,a(n-2) - 8\,a(n-3) + 20\,a(n-4) - 44\,a(n-5) - 160\,a(n-6) - 180\,a(n-7) + 152\,a(n-8) - 880\,a(n-9) - 928\,a(n-10) + 848\,a(n-11) + 816\,a(n-12) + 2752\,a(n-13) + 2880\,a(n-14) + 2560\,a(n-15) - 2048\,a(n-16) - 4096\,a(n-18)
\]
for every $n>20$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A275353.
