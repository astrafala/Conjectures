...
\title{The empirical recurrence for OEIS A281711, proved by transfer matrix}
...
\begin{abstract}
OEIS A281711 counts $n\times4$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A281711 is ``Number of nX4 0..1 arrays with no element unequal to a strict majority of its horizontal, diagonal and antidiagonal neighbors and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
2, 14, 38, 97, 245, 631, 1625, 4234,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 28 2017 13:42:33, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) - 2\,a(n-2) - 4\,a(n-3) - 2\,a(n-4) + a(n-5) + 7\,a(n-6) + a(n-7) - 10\,a(n-8) - a(n-9) + 27\,a(n-10) - 8\,a(n-11) - 18\,a(n-12) + 8\,a(n-13) + a(n-14) - 3\,a(n-15)
\]
for every $n>16$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A281711.
