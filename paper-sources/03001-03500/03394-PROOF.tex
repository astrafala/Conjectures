...
\title{The empirical column recurrences for the table OEIS A251201}
...
\begin{abstract}
OEIS A251201 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A251201 is ``T(n,k)=Number of (n+1)X(k+1) 0..1 arrays with no 2X2 subblock having the minimum of its diagonal elements less than the absolute difference of its antidiagonal elements.''. It has offset $1$, is
read by antidiagonals, and begins
\[
10, 25, 25, 64, 86, 64, 164, 310,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:10:32, revision 6) these are still
...
The sequence is ``Number of (n+1)X(2) 0..1 arrays with no 2X2 subblock having the minimum of its diagonal elements less than the absolute difference of its antidiagonal elements.''. Its rows are the vertices of a digraph on
...
The sequence is ``Number of (n+1)X(3) 0..1 arrays with no 2X2 subblock having the minimum of its diagonal elements less than the absolute difference of its antidiagonal elements.''. Its rows are the vertices of a digraph on
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251201.
