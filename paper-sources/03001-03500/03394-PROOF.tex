...
\title{The empirical column recurrences for the table OEIS A236123}
...
\begin{abstract}
OEIS A236123 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A236123 is ``T(n,k)=Number of (n+1)X(k+1) 0..3 arrays colored with the sets of distinct values in every 2X2 subblock.''. It has offset $1$, is
read by antidiagonals, and begins
\[
256, 3096, 3096, 37584, 91128, 37584, 455808, 2692656,\ \dots
\]
The entry carries the following block:
\begin{quote}\small
Empirical for column k:\\
k=1: a(n) = 6*a(n-1) +59*a(n-2) +164*a(n-3) +264*a(n-4) +96*a(n-5) -144*a(n-6)\\
k=2: [order 21]\\
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 09:07:19, revision 6) these are still
...
The sequence is ``Number of (n+1)X(2) 0..3 arrays colored with the sets of distinct values in every 2X2 subblock.''. Its rows are the vertices of a digraph on
...
\[
a(n)\;=\;6\,a(n-1) + 59\,a(n-2) + 164\,a(n-3) + 264\,a(n-4) + 96\,a(n-5) - 144\,a(n-6)
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A236123.
