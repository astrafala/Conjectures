...
\title{The empirical closed form for OEIS A239034, proved}
...
\begin{abstract}
OEIS A239034 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
$S=182$ vertices. Any function of the form $\sum_j p_j(n)\lambda_j^{\,n}$ satisfies the
...
OEIS A239034 is ``Number of 7Xn 0..2 arrays with no element equal to the sum of elements to its left or one plus the sum of the elements above it, modulo 3.''. It has offset $1$ and begins
\[
8, 64, 428, 2195, 9319, 33699, 107611, 311585,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 09:23:20, revision 6) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\begin{multline*}
f(n)\;=\;\frac{n^{12}}{1036800} - \frac{1961 n^{11}}{39916800} \\
+ \frac{13339 n^{10}}{7257600} - \frac{30521 n^{9}}{725760} \\
+ \frac{583409 n^{8}}{806400} - \frac{400873 n^{7}}{44800} \\
+ \frac{86137751 n^{6}}{1036800} - \frac{407381983 n^{5}}{725760} \\
+ \frac{4957467353 n^{4}}{1814400} - \frac{8367100109 n^{3}}{907200} \\
+ \frac{515324983 n^{2}}{25200} - \frac{185067023 n}{6930} \\
+ 15601.
\end{multline*}
...
walk, so with $M$ the adjacency matrix of that digraph on $S=182$ vertices, and $u,w$ the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A239034.
