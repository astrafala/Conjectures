...
\title{The empirical recurrence for OEIS A185848, proved by transfer matrix}
...
\begin{abstract}
OEIS A185848 counts arrays over $\{0,\dots,2\}$ under a condition comparing a statistic of
...
OEIS A185848 is ``Number of (n+1) X 2 0..2 arrays with no 2 X 2 subblock diagonal sum less antidiagonal sum equal to any horizontal or vertical neighbor 2 X 2 subblock diagonal sum less antidiagonal sum.''. It has offset $1$ and begins
\[
81, 630, 4942, 38700, 303212, 2375550, 18611050, 145808838,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) + 20*a(n-2) + 99*a(n-3) + 252*a(n-4) + 510*a(n-5) + 324*a(n-6) - 336*a(n-7) - 288*a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 17 2018 06:18:28, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + 20\,a(n-2) + 99\,a(n-3) + 252\,a(n-4) + 510\,a(n-5) + 324\,a(n-6) - 336\,a(n-7) - 288\,a(n-8)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A185848.
