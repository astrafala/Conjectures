...
\title{The empirical recurrence for OEIS A224132, proved by transfer matrix}
...
\begin{abstract}
OEIS A224132 counts arrays over $\{0,\dots,1\}$ whose rows, columns, diagonals or
...
OEIS A224132 is ``Number of n X 7 0..1 arrays with rows nondecreasing and antidiagonals unimodal.''. It has offset $1$ and begins
\[
8, 64, 392, 2032, 9577, 42832, 186348, 799954,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 8*a(n-1) - 20*a(n-2) + 18*a(n-3) - 4*a(n-4) + 2*a(n-5) + 8*a(n-6) + 32*a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 27 2018 06:04:36, revision 9) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224132.
