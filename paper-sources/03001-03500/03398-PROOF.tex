...
\title{The empirical recurrence for OEIS A217882, proved by transfer matrix}
...
\begin{abstract}
OEIS A217882 carries an empirical recurrence of order $15$ contributed by R. H. Hardin. It is
...
OEIS A217882 is ``Number of n element 0..2 arrays with each element the minimum of 7 adjacent elements of a random 0..2 array of n+6 elements.''. It has offset $1$ and begins
\[
3, 9, 22, 46, 86, 148, 239, 367,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) - 3*a(n-2) + a(n-3) + 3*a(n-8) - a(n-9) + a(n-10) + a(n-11) + a(n-12) + a(n-13) + a(n-14) + a(n-15).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2018 09:53:20, revision 9) this is still
...
An admissible array is then exactly a walk, and $\iota,\tau$ are the vectors recording which windows may begin and end an array, so with $M$ the adjacency matrix on $S=15$ vertices,
\[
a(n)\;=\;\iota^{\!\top}M^{\,n}\tau ,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A217882.
