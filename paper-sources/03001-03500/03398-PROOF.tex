...
\title{The empirical recurrence for OEIS A262328, proved by transfer matrix}
...
\begin{abstract}
OEIS A262328 counts arrays of width $5$ over $\{0,1\}$ whose rows, read as base-$2$
...
OEIS A262328 is ``Number of (n+1) X (4+1) 0..1 arrays with each row and column divisible by 3, read as a binary number with top and left being the most significant bits.''. It has offset $1$ and begins
\[
11, 33, 351, 2399, 26131, 252097, 2767631, 29452071,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 11*a(n-1) + 48*a(n-2) - 528*a(n-3) - 579*a(n-4) + 6369*a(n-5) + 1612*a(n-6) - 17732*a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 31 2018 06:16:39, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A262328.
