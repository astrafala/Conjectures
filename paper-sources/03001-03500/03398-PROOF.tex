...
\title{The empirical column recurrences for the table OEIS A238287}
...
\begin{abstract}
OEIS A238287 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A238287 is ``T(n,k)=Number of (n+1)X(k+1) 0..3 arrays with no element greater than all horizontal neighbors or less than all vertical neighbors.''. It has offset $1$, is
read by antidiagonals, and begins
\[
4, 16, 16, 50, 204, 50, 144, 1844,\ \dots
\]
...
k=2: [order 25]\\
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 10:50:12, revision 6) these are still
...
The sequence is ``Number of (n+1)X(2) 0..3 arrays with no element greater than all horizontal neighbors or less than all vertical neighbors.''. Its rows are the vertices of a digraph on
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A238287.
