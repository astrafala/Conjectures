...
\title{The empirical closed form for OEIS A223916, proved}
...
\begin{abstract}
OEIS A223916 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A223916 is ``Number of nX6 0..2 arrays with rows and antidiagonals unimodal and columns nondecreasing.''. It has offset $1$ and begins
\[
148, 4102, 45988, 323394, 1721356, 7526024, 28247478, 93683295,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 22:54:34, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\begin{multline*}
f(n)\;=\;\frac{761 n^{12}}{8553600} + \frac{761 n^{11}}{475200} \\
+ \frac{21583 n^{10}}{1088640} + \frac{458 n^{9}}{2835} \\
+ \frac{1760837 n^{8}}{1814400} + \frac{1346021 n^{7}}{302400} \\
+ \frac{430403 n^{6}}{31104} + \frac{19199 n^{5}}{480} \\
+ \frac{88406683 n^{4}}{1360800} + \frac{13099679 n^{3}}{226800} \\
- \frac{3421811 n^{2}}{41580} - \frac{5265011 n}{13860} \\
+ 389.
\end{multline*}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223916.
