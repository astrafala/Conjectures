...
\title{The empirical recurrence for OEIS A206392, proved by transfer matrix}
...
\begin{abstract}
OEIS A206392 counts arrays in which no entry may equal the entries at a short list of fixed offsets
from it, the arrays being counted up to renaming the letters. The entry carries an empirical
recurrence of order $13$ contributed by R.~H.~Hardin. It is true, and it is decidable
...
$2$ consecutive rows, $S=19464$ states in all.
\end{abstract}
...
OEIS A206392 is ``Number of n X 4 0..5 arrays with no element equal to another within a city block distance of two, and new values 0..5 introduced in row major order.''. It has offset $1$ and begins
\[
2, 25, 206, 1931, 16784, 151630, 1343560, 12046648,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 16 2025 11:33:40, revision 7) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=19464.
\]
...
\begin{theorem}
\[
a(n)\;=\;14\,a(n-1) - 32\,a(n-2) - 281\,a(n-3) + 1738\,a(n-4) - 1728\,a(n-5) - 9767\,a(n-6) + 21963\,a(n-7) - 7410\,a(n-8) + 5706\,a(n-9) - 19704\,a(n-10) + 6028\,a(n-11) + 2512\,a(n-12) - 2176\,a(n-13)
\]
for every $n>15$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206392.
