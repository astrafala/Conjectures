...
\title{The empirical recurrence for OEIS A280358, proved by transfer matrix}
...
\begin{abstract}
OEIS A280358 counts $n\times3$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A280358 is ``Number of n X 3 0..2 arrays with no element equal to more than one of its horizontal and vertical neighbors and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
4, 50, 571, 6727, 78800, 924579, 10844773, 127214104,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 31 2023 16:15:24, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;10\,a(n-1) + 26\,a(n-2) - 58\,a(n-3) - 99\,a(n-4) - 63\,a(n-5) - 25\,a(n-6) + 229\,a(n-7) - 3\,a(n-8) - 16\,a(n-9) + 12\,a(n-10) + 16\,a(n-12)
\]
for every $n>12$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A280358.
