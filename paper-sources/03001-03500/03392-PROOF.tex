...
\title{The empirical recurrence for OEIS A222835, proved by transfer matrix}
...
\begin{abstract}
OEIS A222835 counts arrays in which no entry may equal the entries at a short list of fixed offsets
...
$2$ consecutive rows, $S=9764$ states in all.
\end{abstract}
...
OEIS A222835 is ``Number of n X 5 0..3 arrays with no element equal to another at a city block distance of exactly two, and new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
19, 384, 648, 1536, 4032, 9600, 22848, 55296,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + 2*a(n-3) + a(n-4) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 16 2018 08:59:15, revision 8) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=9764.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A222835.
