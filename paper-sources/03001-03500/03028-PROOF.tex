...
The entry gives only the order for this line: ``k=2: [order 20]''. Its model is a walk on
$S=55$ vertices, so it satisfies a monic recurrence of order at most $S$;
Berlekamp--Massey on $2S=110$ exact terms returns the minimal one, of order
$20$ --- the stated order --- with integer coefficients
\begin{center}\small\begin{tabular}{cccccccc}
$c_{1}$ & $3$ & $c_{6}$ & $-56$ & $c_{11}$ & $-20$ & $c_{16}$ & $27$ \\
$c_{2}$ & $3$ & $c_{7}$ & $-47$ & $c_{12}$ & $110$ & $c_{17}$ & $48$ \\
$c_{3}$ & $19$ & $c_{8}$ & $-70$ & $c_{13}$ & $-76$ & $c_{18}$ & $1$ \\
$c_{4}$ & $11$ & $c_{9}$ & $91$ & $c_{14}$ & $126$ & $c_{19}$ & $4$ \\
$c_{5}$ & $-49$ & $c_{10}$ & $-34$ & $c_{15}$ & $32$ & $c_{20}$ & $4$ \\
...
$S=181$ vertices, so it satisfies a monic recurrence of order at most $S$;
Berlekamp--Massey on $2S=362$ exact terms returns the minimal one, of order
$45$ --- the stated order --- with integer coefficients
\[
(c_1,\dots,c_{45})=(5,\ 10,\ 63,\ 42,\ -662,\ -1140,\ 905,\ -1388,\ 5735,\ 6185,\ -3923,\ 19540,\ 11566,\ -49577,\ 77585,\ -154556,\ 110582,\ -87034,\ 10724,\ 21118,\ -19280,\ 32064,\ 87255,\ -49901,\ 5955,\ -30246,\ 2649,\ 15546,\ -15886,\ -9862,\ 11413,\ 35,\ -1316,\ -1895,\ 449,\ 1537,\ 876,\ -132,\ -30,\ -22,\ -55,\ -15,\ -24,\ -12,\ -2).
\]
