...
\title{The empirical recurrence for OEIS A268738, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A268738 counts arrays over $\{0,\dots,1\}$ subject to a condition on the array as a
...
and the empirical recurrence of order $22$ contributed by R.~H.~Hardin then follows from
...
OEIS A268738 is ``Number of nX6 binary arrays with some 1 horizontally or vertically adjacent to some other 1 exactly once.''. It has offset $1$ and begins
\[
20, 420, 7831, 128232, 1971414, 29134076, 418632185, 5894815754,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 12 2016 08:45:08, revision 4) the statement is
...
\]
for $j\ge22$. Hence \eqref{eq:conj} holds from that point on if and only if
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268738.
