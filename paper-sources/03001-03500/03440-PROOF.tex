...
\title{The empirical recurrence for OEIS A193696, proved by transfer matrix}
...
\begin{abstract}
OEIS A193696 carries an empirical recurrence of order $18$ contributed by R. H. Hardin. It is
...
arrays counted are exactly the walks in it; hence $a(n)$ is a walk count on $S=51$ vertices
...
OEIS A193696 is ``Number of arrays of -2..2 integers x(1..n) with every x(i) in a subsequence of length 1, 2 or 3 with sum zero.''. It has offset $1$ and begins
\[
1, 5, 23, 83, 299, 1081, 3931, 14293,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 06:00:23, revision 9) this is still
...
admissible array is then exactly a walk, so with $M$ the adjacency matrix on $S=51$ vertices
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + 2\,a(n-2) - 2\,a(n-3) + 5\,a(n-4) + 16\,a(n-5) + 18\,a(n-6) + 20\,a(n-7) + 23\,a(n-8) + 18\,a(n-9) + 7\,a(n-10) + a(n-11) + 4\,a(n-12) + 7\,a(n-13) + a(n-14) - 7\,a(n-15) - 8\,a(n-16) - 4\,a(n-17) - a(n-18)
\]
for every $n>0$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A193696.
