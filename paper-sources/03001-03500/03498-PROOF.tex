...
\title{The empirical closed form for OEIS A203789, proved}
...
\begin{abstract}
OEIS A203789 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
$\prod_j(x-\lambda_j)^{\deg p_j+1}$; here that polynomial is $q(x)=(x-7)$, of degree
...
OEIS A203789 is ``Number of (n+1)X2 0..3 arrays with every 2X2 subblock having equal diagonal elements or equal antidiagonal elements.''. It has offset $1$ and begins
\[
112, 784, 5488, 38416, 268912, 1882384, 13176688, 92236816,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 16*7\^{}n
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 10:43:47, revision 9) this is still
...
Here $q(x)=(x-7)$, of degree $1$, and the recurrence it encodes is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A203789.
