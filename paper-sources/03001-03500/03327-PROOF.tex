...
\title{The empirical closed form for OEIS A223917, proved}
...
\begin{abstract}
OEIS A223917 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A223917 is ``Number of nX7 0..2 arrays with rows and antidiagonals unimodal and columns nondecreasing.''. It has offset $1$ and begins
\[
239, 9503, 140236, 1226491, 7906972, 41334135, 183720802, 715114500,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 22:54:58, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\begin{multline*}
f(n)\;=\;\frac{118519 n^{14}}{21794572800} + \frac{118519 n^{13}}{1037836800} \\
+ \frac{59179 n^{12}}{34214400} + \frac{1397923 n^{11}}{79833600} \\
+ \frac{117161 n^{10}}{870912} + \frac{825457 n^{9}}{1036800} \\
+ \frac{584642563 n^{8}}{152409600} + \frac{98173459 n^{7}}{7257600} \\
+ \frac{34767841 n^{6}}{777600} + \frac{161988637 n^{5}}{1814400} \\
+ \frac{3918685081 n^{4}}{29937600} - \frac{1351991 n^{3}}{44550} \\
- \frac{53319445009 n^{2}}{75675600} - \frac{347075779 n}{180180} \\
+ 4742.
\end{multline*}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223917.
