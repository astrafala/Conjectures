...
\title{The empirical closed form for OEIS A223919, proved}
...
\begin{abstract}
OEIS A223919 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
$S=96$ vertices. Any function of the form $\sum_j p_j(n)\lambda_j^{\,n}$ satisfies the
...
OEIS A223919 is ``Number of 2 X n 0..2 arrays with rows and antidiagonals unimodal and columns nondecreasing.''. It has offset $1$ and begins
\[
6, 36, 158, 548, 1600, 4102, 9503, 20299,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 23 2018 11:41:12, revision 7) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{n^{8}}{10080} + \frac{n^{7}}{504} + \frac{n^{6}}{40} + \frac{109 n^{5}}{720} + \frac{259 n^{4}}{480} + \frac{173 n^{3}}{144} + \frac{4877 n^{2}}{2520} + \frac{481 n}{420} + 1.
\]
...
walk, so with $M$ the adjacency matrix of that digraph on $S=96$ vertices, and $u,w$ the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223919.
