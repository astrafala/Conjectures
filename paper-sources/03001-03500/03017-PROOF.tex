...
\title{The empirical recurrence for OEIS A233068, proved by transfer matrix}
...
\begin{abstract}
OEIS A233068 counts arrays over $\{0,\dots,3\}$ under a neighbour condition together with
...
OEIS A233068 is ``Number of n X 3 0..3 arrays with no element x(i,j) adjacent to value 3-x(i,j) horizontally, antidiagonally or vertically, top left element zero, and 1 appearing before 2 in row major order.''. It has offset $1$ and begins
\[
5, 50, 582, 6854, 80811, 952869, 11235652, 132484030,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 14*a(n-1) - 28*a(n-2) + 24*a(n-3) - 11*a(n-4) + 2*a(n-5) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 07 2018 08:36:04, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;14\,a(n-1) - 28\,a(n-2) + 24\,a(n-3) - 11\,a(n-4) + 2\,a(n-5)
\end{equation}
for all $n>6$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A233068.
