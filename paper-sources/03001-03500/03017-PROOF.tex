...
\title{The empirical recurrence for OEIS A206234, proved by transfer matrix}
...
\begin{abstract}
OEIS A206234 counts, up to renaming the letters, the arrays of width $5$ over at most $4$
...
OEIS A206234 is ``Number of (n+1) X 5 0..3 arrays with every 2 X 3 or 3 X 2 subblock having exactly two equal edges, and new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
1640, 5728, 27168, 283728, 1236432, 9042600, 95322432, 419146392,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + 339*a(n-3) - 339*a(n-4) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 14 2018 09:32:29, revision 8) this is still
...
$w_i$ cleared of denominators and $S=42254$ states in all. The walk index $j$ and the entry's own
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206234.
