...
\title{The empirical recurrence for OEIS A252858, proved by transfer matrix}
...
\begin{abstract}
OEIS A252858 counts arrays of width $7$ over an alphabet of $3$ letters in which every three
...
brings the state count down to $S=14706$.
\end{abstract}
...
OEIS A252858 is ``Number of (n+2)X(5+2) 0..2 arrays with every consecutive three elements in every row, column, diagonal and antidiagonal having exactly two distinct values, and new values 0 upwards introduced in row major order.''. It has offset $1$ and begins
\[
4383, 2502, 3582, 7002, 14229, 28728, 58644, 119727,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:42:08, revision 6) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The array has width $7$ and entries in $\{0,1,\dots,2\}$. Four families of triples
...
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,
\]
with $S=14706$ states in all. The walk index $j$ and the entry's own $n$ differ by a constant,
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 2\,a(n-2) + 4\,a(n-4) - 4\,a(n-5) - 7\,a(n-6) - a(n-7) + 3\,a(n-8) + 9\,a(n-9) - 3\,a(n-10) - 3\,a(n-11) - 2\,a(n-12) + 2\,a(n-14) + a(n-15) - a(n-16)
\]
for every $n>18$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252858.
