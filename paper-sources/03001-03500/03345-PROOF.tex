...
\title{The empirical recurrence for OEIS A208089, proved by transfer matrix}
...
\begin{abstract}
OEIS A208089 counts, up to renaming the letters, the arrays of width $8$ over at most $2$
letters in which horizontally neighbouring $2\times2$ subblocks have the same number of equal edges and vertically neighbouring ones have different numbers. It carries an empirical recurrence of order $4$ contributed by
...
OEIS A208089 is ``Number of 8 X (n+1) 0..1 arrays with every 2 X 2 subblock having the same number of equal edges as its horizontal neighbors and a different number from its vertical neighbors, and new values 0..1 introduced in row major order.''. It has offset $1$ and begins
\[
216, 504, 1206, 3096, 7992, 20862, 54504, 142632,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) - 3*a(n-3) + a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 28 2018 08:25:52, revision 11) this is still
...
$w_i$ cleared of denominators and $S=432$ states in all. The walk index $j$ and the entry's own
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208089.
