...
\title{The empirical recurrence for OEIS A231264, proved by transfer matrix}
...
\begin{abstract}
OEIS A231264 counts $3\times(n+1)$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A231264 is ``Number of (2+1) X (n+1) 0..2 arrays with no element unequal to a strict majority of its horizontal and antidiagonal neighbors, with values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
6, 15, 32, 83, 211, 557, 1471, 3909,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) -2*a(n-2) -8*a(n-3) +11*a(n-4) -4*a(n-6) -4*a(n-7) -4*a(n-8) +8*a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 16 2018 09:38:12, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) - 2\,a(n-2) - 8\,a(n-3) + 11\,a(n-4) - 4\,a(n-6) - 4\,a(n-7) - 4\,a(n-8) + 8\,a(n-9)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231264.
