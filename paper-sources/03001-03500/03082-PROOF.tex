...
\title{The empirical closed form for OEIS A223927, proved}
...
\begin{abstract}
OEIS A223927 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A223927 is ``Number of n X 2 0..2 arrays with rows, columns and antidiagonals unimodal and diagonals nondecreasing.''. It has offset $1$ and begins
\[
9, 54, 218, 698, 1915, 4690, 10511, 21919,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 21 2018 09:22:34, revision 7) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{n^{8}}{10080} + \frac{n^{7}}{504} + \frac{n^{6}}{40} + \frac{109 n^{5}}{720} + \frac{379 n^{4}}{480} + \frac{317 n^{3}}{144} + \frac{8027 n^{2}}{2520} + \frac{691 n}{420} + 1.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223927.
