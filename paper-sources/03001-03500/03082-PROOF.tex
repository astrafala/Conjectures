...
\title{The empirical column recurrences for the table OEIS A305523}
...
\begin{abstract}
OEIS A305523 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A305523 is ``T(n,k) = Number of n X k 0..1 arrays with every element unequal to 0, 1, 2, 3, 4 or 5 king-move adjacent elements, with upper left element zero.''. It has offset $1$, is
read by antidiagonals, and begins
\[
1, 2, 2, 4, 8, 4, 8, 32,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 05 2025 13:47:47, revision 6) these are still
...
The sequence is ``Number of n X 3 0..1 arrays with every element unequal to 0, 1, 2, 3, 4 or 5 king-move adjacent elements, with upper left element zero.''. Its rows are the vertices of a digraph on
...
model reproduces $7$ published values, $26$ decimal digits in all, every one of
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A305523.
