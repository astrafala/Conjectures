...
\title{The empirical recurrence for OEIS A185489, proved by transfer matrix}
...
\begin{abstract}
OEIS A185489 counts arrays over $\{0,\dots,1\}$ under a condition comparing a statistic of
...
empirical. The count is a walk count on $S=32$ states and is $C$-finite; whether the
...
OEIS A185489 is ``Number of (n+1) X 2 binary arrays with every 2 X 2 subblock sum equal to some horizontal or vertical neighbor 2 X 2 subblock sum.''. It has offset $1$ and begins
\[
0, 24, 36, 160, 380, 1332, 3616, 11828,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) + 3*a(n-2) - 14*a(n-3) + 24*a(n-4) - 16*a(n-5) - 24*a(n-6) + 16*a(n-7) - 64*a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 27 2018 11:58:45, revision 9) this is still
...
$S=32$ states in all. Getting the two vectors right is the whole of the argument: with
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + 3\,a(n-2) - 14\,a(n-3) + 24\,a(n-4) - 16\,a(n-5) - 24\,a(n-6) + 16\,a(n-7) - 64\,a(n-8)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A185489.
