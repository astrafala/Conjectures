...
\title{The empirical closed form for OEIS A223721, proved}
...
\begin{abstract}
OEIS A223721 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A223721 is ``Number of nX4 0..2 arrays with rows, antidiagonals and columns unimodal.''. It has offset $1$ and begins
\[
46, 2116, 46613, 608855, 5537147, 38566854, 218619076, 1051051942,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 22:14:08, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\begin{multline*}
f(n)\;=\;\frac{456419 n^{16}}{5230697472000} + \frac{299363 n^{15}}{186810624000} \\
+ \frac{8437981 n^{14}}{261534873600} + \frac{678959 n^{13}}{1868106240} \\
+ \frac{91942579 n^{12}}{28740096000} + \frac{161673031 n^{11}}{7185024000} \\
+ \frac{203867119 n^{10}}{1828915200} + \frac{37055 n^{9}}{81648} \\
+ \frac{59612358509 n^{8}}{36578304000} + \frac{2850286193 n^{7}}{1306368000} \\
+ \frac{7237625987 n^{6}}{718502400} + \frac{573765127 n^{5}}{143700480} \\
- \frac{109277252779 n^{4}}{4036032000} + \frac{59181202013 n^{3}}{216216000} \\
- \frac{12927784033 n^{2}}{16816800} + \frac{36815651 n}{36036} \\
- 470.
\end{multline*}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223721.
