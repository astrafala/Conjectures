...
\title{The empirical recurrence for OEIS A211500, proved by transfer matrix}
...
\begin{abstract}
OEIS A211500 carries an empirical recurrence of order $17$ contributed by R. H. Hardin. It is
...
OEIS A211500 is ``Number of -3..3 arrays x(i) of n+1 elements i=1..n+1 with x(i)+x(j), x(i+1)+x(j+1), -(x(i)+x(j+1)), and -(x(i+1)+x(j)) having two or three distinct values for every i<=n and j<=n.''. It has offset $1$ and begins
\[
48, 130, 298, 660, 1384, 2890, 5850, 11930,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 16:12:36, revision 8) this is still
...
admissible array is then exactly a walk, so with $M$ the adjacency matrix on $S=79$ vertices
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + 13\,a(n-2) - 43\,a(n-3) - 67\,a(n-4) + 254\,a(n-5) + 171\,a(n-6) - 797\,a(n-7) - 213\,a(n-8) + 1427\,a(n-9) + 85\,a(n-10) - 1458\,a(n-11) + 60\,a(n-12) + 810\,a(n-13) - 58\,a(n-14) - 224\,a(n-15) + 12\,a(n-16) + 24\,a(n-17)
\]
for every $n>17$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A211500.
