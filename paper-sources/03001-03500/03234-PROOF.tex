...
\title{The empirical recurrence for OEIS A240789, proved by transfer matrix}
...
\begin{abstract}
OEIS A240789 counts arrays over $\{0,1,2,3\}$ in which no entry may equal, modulo $4$, a given
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-3) + a(n-5) - 3\,a(n-6) - 3\,a(n-8) - 4\,a(n-9) + a(n-11) + 4\,a(n-12) + 3\,a(n-14) - 2\,a(n-17)
\]
for every $n>19$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A240789.
