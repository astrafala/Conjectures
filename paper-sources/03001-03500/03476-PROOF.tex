...
\title{The empirical closed form for OEIS A224192, proved}
...
\begin{abstract}
OEIS A224192 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
$S=672$ vertices. Any function of the form $\sum_j p_j(n)\lambda_j^{\,n}$ satisfies the
...
OEIS A224192 is ``Number of 5Xn 0..2 arrays with rows unimodal and columns nondecreasing.''. It has offset $1$ and begins
\[
21, 441, 5852, 55438, 408222, 2469182, 12741432, 57644194,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 23:18:25, revision 8) this is still
...
+ \frac{9641 n^{16}}{2134978560000} + \frac{44237 n^{15}}{498161664000} \\
+ \frac{115879 n^{14}}{86102016000} + \frac{24029081 n^{13}}{1494484992000} \\
+ \frac{623419 n^{12}}{4055040000} + \frac{18199033 n^{11}}{15328051200} \\
+ \frac{3421967251 n^{10}}{459841536000} + \frac{263944057 n^{9}}{6967296000} \\
+ \frac{8168948285977 n^{8}}{52306974720000} + \frac{193145489021 n^{7}}{373621248000} \\
+ \frac{507138710909 n^{6}}{373621248000} + \frac{13262560631 n^{5}}{4790016000} \\
+ \frac{3783062210933 n^{4}}{882161280000} + \frac{108121887773 n^{3}}{22054032000} \\
+ \frac{27314271011 n^{2}}{6518191680} + \frac{14737223 n}{8314020} \\
+ 1.
\end{multline*}
...
walk, so with $M$ the adjacency matrix of that digraph on $S=672$ vertices, and $u,w$ the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224192.
