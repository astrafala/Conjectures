...
\title{The empirical recurrence for OEIS A197050, proved by transfer matrix}
...
\begin{abstract}
OEIS A197050 counts arrays of width $4$ in which every entry is equal to the NUMBER of its own
...
OEIS A197050 is ``Number of nX4 0..4 arrays with each element equal to the number its horizontal and vertical zero neighbors.''. It has offset $1$ and begins
\[
3, 6, 18, 42, 108, 274, 692, 1754,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) +3*a(n-2) +3*a(n-3) -a(n-4) -2*a(n-5) -a(n-6) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 24 2024 03:13:59, revision 13) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=8392.
\]
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 3\,a(n-2) + 3\,a(n-3) - a(n-4) - 2\,a(n-5) - a(n-6)
\]
for every $n>7$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A197050.
