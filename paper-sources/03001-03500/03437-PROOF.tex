...
\title{The empirical recurrence for OEIS A208404, proved by counting patterns}
...
\begin{abstract}
OEIS A208404 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A208404 is ``Number of n X 4 0..3 arrays with new values 0..3 introduced in row major order and no element equal to more than two of its immediate leftward or upward or right-upward antidiagonal neighbors.''. It has offset $1$ and begins
\[
15, 2698, 658450, 163422914, 40595679634, 10084768380770, 2505261257850802, 622357842865595522,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 262*a(n-1) - 3385*a(n-2) + 2868*a(n-3) - 576*a(n-4) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 02 2018 14:14:19, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;262\,a(n-1) - 3385\,a(n-2) + 2868\,a(n-3) - 576\,a(n-4)
\end{equation}
for all $n>5$.
...
\[
4!\Bigl(a(n)-\sum_i c_i\,a(n-i)\Bigr)\;=\;\mathbf{v}^{\!\top}N^{\,m-4}q(N)\mathbf{1} .
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208404.
