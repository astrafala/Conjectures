...
\title{The empirical closed form for OEIS A208283, proved}
...
\begin{abstract}
OEIS A208283 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A208283 is ``Number of n X 4 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 0 1 and 1 1 0 vertically.''. It has offset $1$ and begins
\[
10, 100, 378, 984, 2090, 3900, 6650, 10608,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (4/3)*n\^{}4 + 10*n\^{}3 + (2/3)*n\^{}2 - 2*n.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 29 2018 11:23:55, revision 10) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{4 n^{4}}{3} + 10 n^{3} + \frac{2 n^{2}}{3} - 2 n.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208283.
