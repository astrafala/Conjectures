...
\title{The empirical recurrence for OEIS A180763, proved by transfer matrix}
...
\begin{abstract}
OEIS A180763 counts arrays of width $3$ over $\{0,1\}$ in which every cell equals at least one of its neighbours. The entry carries an
...
OEIS A180763 is ``Half the number of n X 3 binary arrays with each element equal to at least one neighbor.''. It has offset $1$ and begins
\[
1, 11, 63, 390, 2385, 14621, 89602, 549125,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 5*a(n-1) + 8*a(n-2) - 5*a(n-3) - 10*a(n-4) - a(n-5) + 3*a(n-6) + 4*a(n-7) - 2*a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 26 2018 09:54:52, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) + 8\,a(n-2) - 5\,a(n-3) - 10\,a(n-4) - a(n-5) + 3\,a(n-6) + 4\,a(n-7) - 2\,a(n-8)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A180763.
