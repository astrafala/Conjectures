...
\title{The empirical recurrence for OEIS A275404, proved by transfer matrix}
...
\begin{abstract}
OEIS A275404 counts arrays in which no entry may equal the entries at a short list of fixed offsets
...
$1$ consecutive columns, $S=79$ states in all.
\end{abstract}
...
OEIS A275404 is ``Number of 5 X n 0..2 arrays with no element equal to any value at offset (-2,-1) (-2,0) or (-1,1) and new values introduced in order 0..2.''. It has offset $1$ and begins
\[
12, 63, 394, 2404, 14884, 91849, 566331, 3495079,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + 15*a(n-2) + 55*a(n-3) + 69*a(n-4) + 8*a(n-5) - 50*a(n-6) + 14*a(n-7) + a(n-8) - a(n-9) for n>10.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 04 2019 09:16:09, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 15\,a(n-2) + 55\,a(n-3) + 69\,a(n-4) + 8\,a(n-5) - 50\,a(n-6) + 14\,a(n-7) + a(n-8) - a(n-9)
\]
for every $n>10$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A275404.
