...
\title{The empirical closed form for OEIS A223976, proved}
...
\begin{abstract}
OEIS A223976 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A223976 is ``Number of 3Xn 0..2 arrays with rows and antidiagonals unimodal.''. It has offset $1$ and begins
\[
27, 729, 9515, 76092, 440628, 2026448, 7829639, 26375691,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 23:07:15, revision 8) this is still
...
+ \frac{132833 n^{10}}{21772800} + \frac{35869 n^{9}}{725760} \\
+ \frac{2045741 n^{8}}{7257600} + \frac{425867 n^{7}}{403200} \\
+ \frac{62493899 n^{6}}{21772800} + \frac{727483 n^{5}}{145152} \\
+ \frac{33993559 n^{4}}{5443200} + \frac{2107249 n^{3}}{907200} \\
+ \frac{3822521 n^{2}}{831600} + \frac{49331 n}{13860} \\
+ 1.
\end{multline*}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223976.
