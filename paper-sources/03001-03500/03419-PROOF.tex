...
\title{The empirical recurrence for OEIS A210008, proved by transfer matrix}
...
\begin{abstract}
OEIS A210008 counts arrays of width $5$ whose every $2\times2$ subblock holds a
prescribed number of DISTINCT values, which use ALL of the $3$ available letters, and which
are counted up to renaming. The entry carries an empirical recurrence of order $19$
...
OEIS A210008 is ``Number of (n+1)X5 0..2 arrays containing all values 0..2 with every 2X2 subblock having two or three distinct values, and new values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
8217, 1808865, 385841179, 82060746485, 17447565687601, 3709556186877991, 788692753629890373, 167684774000295868135,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 15:38:36, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;218\,a(n-1) - 672\,a(n-2) - 102513\,a(n-3) + 336965\,a(n-4) + 9441327\,a(n-5) - 64650448\,a(n-6) + 29276745\,a(n-7) + 733248704\,a(n-8) - 1733314135\,a(n-9) - 814273096\,a(n-10) + 6961302814\,a(n-11) - 7307156292\,a(n-12) - 92994368\,a(n-13) + 3740262880\,a(n-14) - 1180127616\,a(n-15) - 466935296\,a(n-16) + 173254656\,a(n-17) + 18587648\,a(n-18) - 5406720\,a(n-19)
\]
for every $n>19$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A210008.
