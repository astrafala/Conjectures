...
\title{The empirical recurrence for OEIS A210120, proved by counting patterns}
...
\begin{abstract}
OEIS A210120 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A210120 is ``Number of (n+1)X4 0..3 arrays with every 2X2 subblock having two or four distinct values, and new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
265, 5587, 122093, 2737637, 62169169, 1421103679, 32591746591, 748700150743,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 15:44:06, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;49\,a(n-1) - 776\,a(n-2) + 3750\,a(n-3) + 14056\,a(n-4) - 142120\,a(n-5) - 40107\,a(n-6) + 1691155\,a(n-7) - 89248\,a(n-8) - 8106546\,a(n-9) + 124804\,a(n-10) + 16077560\,a(n-11) + 19696\,a(n-12) - 11388288\,a(n-13) + 186112\,a(n-14) + 546816\,a(n-15)
\end{equation}
for all $n>15$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A210120.
