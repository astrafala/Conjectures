...
\title{The empirical recurrence for OEIS A235502, proved by transfer matrix}
...
\begin{abstract}
OEIS A235502 counts arrays of width $2$ over $\{0,1,2,3\}$ by reducing every $2\times2$ subblock to a
...
OEIS A235502 is ``Number of (n+1)X(1+1) 0..3 arrays with the sum of each 2X2 subblock maximum and minimum lexicographically nondecreasing rowwise and columnwise.''. It has offset $1$ and begins
\[
256, 2982, 33640, 343500, 3415268, 32611962, 306033109, 2817787860,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 08:34:50, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;16\,a(n-1) - 996\,a(n-3) + 2120\,a(n-4) + 25116\,a(n-5) - 57572\,a(n-6) - 356724\,a(n-7) + 603662\,a(n-8) + 3113580\,a(n-9) - 2452580\,a(n-10) - 15915180\,a(n-11) - 310416\,a(n-12) + 41666900\,a(n-13) + 22553332\,a(n-14) - 51946236\,a(n-15) - 50892645\,a(n-16) + 22355988\,a(n-17) + 43357140\,a(n-18) + 7658496\,a(n-19) - 11766240\,a(n-20) - 6600960\,a(n-21) - 1036800\,a(n-22)
\]
for every $n>20$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A235502.
