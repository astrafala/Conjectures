...
\title{The empirical column recurrences for the table OEIS A233967}
...
\begin{abstract}
OEIS A233967 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A233967 is ``T(n,k)=Number of (n+1)X(k+1) 0..3 arrays with every 2X2 subblock having the sum of the absolute values of all six edge and diagonal differences equal to 10 (10 maximizes T(1,1)).''. It has offset $1$, is
read by antidiagonals, and begins
\[
48, 188, 188, 728, 864, 728, 3016, 3976,\ \dots
\]
The entry carries the following block:
\begin{quote}\small
Empirical for column k:\\
k=1: a(n) = 4*a(n-1) +10*a(n-2) -36*a(n-3) -8*a(n-4) +16*a(n-5)\\
k=2: [order 14]\\
k=3: [order 43]\\
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 09:06:47, revision 6) these are still
...
The sequence is ``Number of (n+1)X2 0..3 arrays with every 2X2 subblock having the sum of the absolute values of all six edge and diagonal differences equal to 10.''. Its rows are the vertices of a digraph on
...
\[
a(n)\;=\;4\,a(n-1) + 10\,a(n-2) - 36\,a(n-3) - 8\,a(n-4) + 16\,a(n-5)
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A233967.
