...
\title{The empirical recurrence for OEIS A209499, proved by counting patterns}
...
\begin{abstract}
OEIS A209499 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A209499 is ``Number of nX4 0..4 arrays with every 2X2 subblock containing exactly one value repeat, and new values 0..4 introduced in row major order.''. It has offset $1$ and begins
\[
15, 690, 78135, 9502354, 1165032679, 142937856372, 17538444837670, 2151975129988088,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 15:16:54, revision 11) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;118\,a(n-1) + 1604\,a(n-2) - 127784\,a(n-3) - 79452\,a(n-4) + 37606360\,a(n-5) - 178547756\,a(n-6) - 2931053296\,a(n-7) + 18312307424\,a(n-8) + 74021561744\,a(n-9) - 495233537616\,a(n-10) - 1023076292096\,a(n-11) + 5490220477440\,a(n-12) + 8804921243328\,a(n-13) - 24309394624512\,a(n-14) - 36012394278144\,a(n-15) + 28360887229440\,a(n-16) + 27667991881728\,a(n-17) - 15907925311488\,a(n-18)
\end{equation}
for all $n>19$.
...
\[
5!\Bigl(a(n)-\sum_i c_i\,a(n-i)\Bigr)\;=\;\mathbf{v}^{\!\top}N^{\,m-18}q(N)\mathbf{1} .
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209499.
