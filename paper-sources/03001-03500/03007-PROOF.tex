...
\title{The empirical column recurrences for the table OEIS A233928}
...
\begin{abstract}
OEIS A233928 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A233928 is ``T(n,k)=Number of (n+1)X(k+1) 0..4 arrays with every 2X2 subblock having the sum of the absolute values of the edge differences equal to 8 and no adjacent elements equal.''. It has offset $1$, is
read by antidiagonals, and begins
\[
98, 518, 518, 2792, 4010, 2792, 15230, 32496,\ \dots
\]
The entry carries the following block:
\begin{quote}\small
Empirical for column k:\\
k=1: a(n) = 6*a(n-1) +5*a(n-2) -46*a(n-3) +5*a(n-4) +60*a(n-5) +20*a(n-6)\\
k=2: [order 25]\\
k=3: [order 82]\\
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 08:16:32, revision 6) these are still
...
The sequence is ``Number of (n+1)X(2) 0..4 arrays with every 2X2 subblock having the sum of the absolute values of the edge differences equal to 8 and no adjacent elements equal.''. Its rows are the vertices of a digraph on
...
\[
a(n)\;=\;6\,a(n-1) + 5\,a(n-2) - 46\,a(n-3) + 5\,a(n-4) + 60\,a(n-5) + 20\,a(n-6)
\]
...
The entry gives only the order for this line: ``k=2: [order 25]''. Its model is a walk on
...
\[
(c_1,\dots,c_{25})=(6,\ 90,\ -457,\ -2820,\ 12576,\ 44887,\ -174476,\ -413814,\ 1377015,\ 2340346,\ -6484142,\ -8332941,\ 18412719,\ 18808062,\ -31000755,\ -26671104,\ 29467485,\ 23060177,\ -14245792,\ -11289280,\ 2644752,\ 2672572,\ 58840,\ -200640,\ -28672).
\]
Repeating with the first $25+4$ terms removed gives order $25$ again.

\subsection*{Column $k=3$, recovered}
The entry gives only the order for this line: ``k=3: [order 82]''. Its model is a walk on
...
\[
(c_1,\dots,c_{82})=(30,\ -41,\ -6745,\ 50230,\ 595825,\ -7351028,\ -22832572,\ 551655707,\ -106308546,\ -26004408747,\ 55317448700,\ 832721839752,\ -3062334448054,\ -18650697157606,\ 100138235881038,\ 287805372584569,\ -2294844217991054,\ -2707972919013118,\ 39253544546232183,\ 3851202417314097,\ -517124161558145841,\ 358871370356739006,\ 5335817120797912981,\ -7207048326212368387,\ -43440874456292182642,\ 85715771675285356183,\ 278621562459493458601,\ -741843426077845664011,\ -1387769655441171569180,\ 4973267250801408723962,\ 5147032653162817911531,\ -26543887870125421781248,\ -12387911916876612162104,\ 114359337253735234030819,\ 5446216078314120915176,\ -400409387433490190107998,\ 113349605209987574776488,\ 1141891316334767350625713,\ -641732540989799573708502,\ -2648380729996730228078784,\ 2159646805227968712909462,\ 4968705180998850471675193,\ -5305811028948073180705546,\ -7462353560274124158529736,\ 10073352433811188668406413,\ 8803599204036324786067402,\ -15098526186874086346480987,\ -7862303360798692296860116,\ 18003997668817654980386900,\ 4859388509825444373228894,\ -17089515174733679765225895,\ -1419634200797792232325849,\ 12859010878940902643953247,\ -790138368983708929833251,\ -7607343933842006300442854,\ 1348254923704510937288636,\ 3494404450787498087210317,\ -956885720218972794883159,\ -1224220792965398098812628,\ 439671591973365789666671,\ 318854323490414734152075,\ -140782135853496786826071,\ -59441908505652634435834,\ 31707428911159626860371,\ 7459337180663070704828,\ -4936255406922351777057,\ -559065750114770302855,\ 512054496566003043493,\ 17023896512372581080,\ -33466943570385646530,\ 534830310701857560,\ 1276878099556380264,\ -51348697374790756,\ -25913272792863280,\ 1174181115077616,\ 240942267771296,\ -8939723749760,\ -805093956864,\ 17183544576,\ 458135552,\ -4866048,\ -49152).
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A233928.
