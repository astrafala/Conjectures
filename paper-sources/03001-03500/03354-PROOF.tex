...
\title{The empirical closed form for OEIS A229427, proved}
...
\begin{abstract}
OEIS A229427 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
$S=513$ vertices. Any function of the form $\sum_j p_j(n)\lambda_j^{\,n}$ satisfies the
...
OEIS A229427 is ``Number of nX7 0..2 arrays with horizontal differences mod 3 never 1, vertical differences mod 3 never -1, rows lexicographically nondecreasing, and columns lexicographically nonincreasing.''. It has offset $1$ and begins
\[
30, 282, 2187, 13345, 66503, 281016, 1037193, 3420692,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 04 2025 00:13:21, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\begin{multline*}
f(n)\;=\;\frac{n^{14}}{660441600} + \frac{n^{13}}{9434880} \\
+ \frac{n^{12}}{311850} + \frac{283 n^{11}}{4989600} \\
+ \frac{23 n^{10}}{34560} + \frac{5 n^{9}}{896} \\
+ \frac{55843 n^{8}}{1587600} + \frac{154153 n^{7}}{907200} \\
+ \frac{4503127 n^{6}}{7257600} + \frac{1244953 n^{5}}{725760} \\
+ \frac{56059 n^{4}}{14400} + \frac{1646347 n^{3}}{302400} \\
+ \frac{401116003 n^{2}}{50450400} + \frac{124079 n}{24024} \\
+ 5.
\end{multline*}
...
walk, so with $M$ the adjacency matrix of that digraph on $S=513$ vertices, and $u,w$ the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A229427.
