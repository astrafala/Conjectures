...
\title{The empirical column recurrences for the table OEIS A250913}
...
\begin{abstract}
OEIS A250913 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A250913 is ``T(n,k)=Number of (n+1)X(k+1) 0..2 arrays with no 2X2 subblock having its maximum diagonal element less than its minimum antidiagonal element.''. It has offset $1$, is
read by antidiagonals, and begins
\[
74, 603, 603, 4909, 13401, 4909, 39960, 297873,\ \dots
\]
...
k=5: [order 30]\\
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 12:50:58, revision 6) these are still
...
The sequence is ``Number of (n+1)X(2) 0..2 arrays with no 2X2 subblock having its maximum diagonal element less than its minimum antidiagonal element.''. Its rows are the vertices of a digraph on
...
The sequence is ``Number of (n+1)X(3) 0..2 arrays with no 2X2 subblock having its maximum diagonal element less than its minimum antidiagonal element.''. Its rows are the vertices of a digraph on
...
The entry gives only the order for this line: ``k=3: [order 7]''. Its model is a walk on
...
$c_{1}$ & $74$ & $c_{3}$ & $1101$ & $c_{5}$ & $231$ & $c_{7}$ & $736$ \\
$c_{2}$ & $-825$ & $c_{4}$ & $-4926$ & $c_{6}$ & $1684$ &  &  \\
\end{tabular}\end{center}
Repeating with the first $7+4$ terms removed gives order $7$ again.

\subsection*{Column $k=4$, recovered}
The entry gives only the order for this line: ``k=4: [order 13]''. Its model is a walk on
...
\begin{center}\small\begin{tabular}{cccccccc}
$c_{1}$ & $202$ & $c_{5}$ & $2308813$ & $c_{9}$ & $18927043$ & $c_{13}$ & $-6773760$ \\
$c_{2}$ & $-6346$ & $c_{6}$ & $-8304217$ & $c_{10}$ & $-60255820$ &  &  \\
$c_{3}$ & $54499$ & $c_{7}$ & $-16011215$ & $c_{11}$ & $18024160$ &  &  \\
$c_{4}$ & $-108047$ & $c_{8}$ & $3358369$ & $c_{12}$ & $47390528$ &  &  \\
\end{tabular}\end{center}
...
model reproduces $13$ published values, $75$ decimal digits in all, every one of
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250913.
