...
\title{The empirical closed form for OEIS A223929, proved}
...
\begin{abstract}
OEIS A223929 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
$S=11776$ vertices. Any function of the form $\sum_j p_j(n)\lambda_j^{\,n}$ satisfies the
...
OEIS A223929 is ``Number of nX4 0..2 arrays with rows, columns and antidiagonals unimodal and diagonals nondecreasing.''. It has offset $1$ and begins
\[
46, 698, 4498, 21334, 86439, 316136, 1065625, 3337831,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 22:58:06, revision 8) this is still
...
+ \frac{n^{14}}{116756640} + \frac{4003 n^{13}}{37362124800} \\
+ \frac{97199 n^{12}}{28740096000} + \frac{670871 n^{11}}{14370048000} \\
+ \frac{94057 n^{10}}{130636800} - \frac{113957 n^{9}}{261273600} \\
+ \frac{565001317 n^{8}}{5225472000} - \frac{887457691 n^{7}}{1306368000} \\
+ \frac{3190047029 n^{6}}{359251200} - \frac{36838723231 n^{5}}{718502400} \\
+ \frac{4745796217531 n^{4}}{15567552000} - \frac{170787179737 n^{3}}{162162000} \\
+ \frac{51300697729 n^{2}}{21621600} - \frac{74839579 n}{180180} \\
- 7017.
\end{multline*}
...
walk, so with $M$ the adjacency matrix of that digraph on $S=11776$ vertices, and $u,w$ the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223929.
