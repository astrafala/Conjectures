...
\title{The empirical recurrence for OEIS A232346, proved by transfer matrix}
...
\begin{abstract}
OEIS A232346 counts arrays of width $3$ over $\{0,1,2\}$ in which every cell has a neighbour at least as large and one at most as large. The entry carries an
...
OEIS A232346 is ``Number of (n+1)X(2+1) 0..2 arrays with every element both >= and <= some horizontal, vertical, diagonal or antidiagonal neighbor.''. It has offset $1$ and begins
\[
207, 5309, 111607, 2435979, 53921761, 1191667231, 26307585827, 580823169565,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 07:20:12, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;18\,a(n-1) + 50\,a(n-2) + 715\,a(n-3) + 3508\,a(n-4) + 5186\,a(n-5) + 5127\,a(n-6) - 9378\,a(n-7) - 73758\,a(n-8) - 108752\,a(n-9) - 97333\,a(n-10) - 110585\,a(n-11) - 18852\,a(n-12) + 50833\,a(n-13) + 28853\,a(n-14) + 12012\,a(n-15) + 71\,a(n-16) - 10643\,a(n-17) - 5897\,a(n-18) - 4501\,a(n-19) - 989\,a(n-20) + 28\,a(n-21) + 100\,a(n-22) + 56\,a(n-23)
\]
for every $n>23$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232346.
