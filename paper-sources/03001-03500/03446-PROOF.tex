...
\title{The empirical closed form for OEIS A223737, proved}
...
\begin{abstract}
OEIS A223737 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
$S=11264$ vertices. Any function of the form $\sum_j p_j(n)\lambda_j^{\,n}$ satisfies the
...
OEIS A223737 is ``Number of nX3 0..2 arrays with rows, columns, diagonals and antidiagonals unimodal.''. It has offset $1$ and begins
\[
22, 484, 5600, 42090, 237088, 1082738, 4207089, 14362171,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 22:15:47, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\begin{multline*}
f(n)\;=\;\frac{5051 n^{12}}{239500800} + \frac{9539 n^{11}}{39916800} \\
+ \frac{75941 n^{10}}{21772800} + \frac{79 n^{9}}{3840} \\
+ \frac{160763 n^{8}}{1036800} + \frac{647089 n^{7}}{1209600} \\
+ \frac{42743903 n^{6}}{21772800} + \frac{1895941 n^{5}}{725760} \\
+ \frac{37871509 n^{4}}{5443200} + \frac{109751 n^{3}}{43200} \\
+ \frac{125047 n^{2}}{14850} - \frac{14101 n}{1155} \\
+ 11.
\end{multline*}
...
walk, so with $M$ the adjacency matrix of that digraph on $S=11264$ vertices, and $u,w$ the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223737.
