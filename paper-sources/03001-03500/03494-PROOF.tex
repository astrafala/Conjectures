...
\title{The empirical closed form for OEIS A224311, proved}
...
\begin{abstract}
OEIS A224311 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
$S=1728$ vertices. Any function of the form $\sum_j p_j(n)\lambda_j^{\,n}$ satisfies the
...
OEIS A224311 is ``Number of 3Xn 0..2 arrays with diagonals and rows unimodal and antidiagonals nondecreasing.''. It has offset $1$ and begins
\[
27, 324, 1586, 5996, 20214, 61953, 174378, 454832,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 23:22:28, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\begin{multline*}
f(n)\;=\;\frac{n^{12}}{19160064} + \frac{n^{11}}{1064448} \\
+ \frac{1507 n^{10}}{43545600} + \frac{73 n^{9}}{161280} \\
+ \frac{23603 n^{8}}{2903040} + \frac{111 n^{7}}{3584} \\
+ \frac{13023121 n^{6}}{43545600} + \frac{130093 n^{5}}{96768} \\
+ \frac{5619469 n^{4}}{2177280} + \frac{54895 n^{3}}{2688} \\
- \frac{11456441 n^{2}}{1663200} + \frac{205131 n}{1540} \\
- 196.
\end{multline*}
...
walk, so with $M$ the adjacency matrix of that digraph on $S=1728$ vertices, and $u,w$ the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224311.
