...
\title{The empirical closed form for OEIS A224141, proved}
...
\begin{abstract}
OEIS A224141 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A224141 is ``Number of n X 3 0..1 arrays with rows and antidiagonals unimodal and columns nondecreasing.''. It has offset $1$ and begins
\[
7, 22, 49, 92, 155, 242, 357, 504,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (2/3)*n\^{}3 + 2*n\^{}2 + (13/3)*n.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 27 2018 16:19:23, revision 7) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{2 n^{3}}{3} + 2 n^{2} + \frac{13 n}{3}.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224141.
