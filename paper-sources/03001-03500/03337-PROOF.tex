...
\title{The empirical recurrence for OEIS A265982, proved by transfer matrix}
...
\begin{abstract}
OEIS A265982 counts arrays of width $2$ in which every entry is equal to the NUMBER of its own
...
OEIS A265982 is ``Number of 2Xn integer arrays with each element equal to the number of horizontal, diagonal and antidiagonal neighbors less than itself.''. It has offset $1$ and begins
\[
1, 23, 117, 583, 5554, 52555, 405165, 3187023,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 19 2015 10:41:28, revision 4) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A265982.
