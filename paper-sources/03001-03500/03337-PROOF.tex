...
\title{The empirical recurrence for OEIS A210304, proved by transfer matrix}
...
\begin{abstract}
OEIS A210304 counts arrays of width $4$ whose every $2\times2$ subblock holds a
prescribed number of DISTINCT values, which use ALL of the $4$ available letters, and which
are counted up to renaming. The entry carries an empirical recurrence of order $20$
...
OEIS A210304 is ``Number of (n+1)X4 0..3 arrays containing all values 0..3 with every 2X2 subblock having one or three distinct values, and new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
414, 27957, 1575467, 85724987, 4628067519, 249417760123, 13436313660615, 723757498910275,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 15:53:26, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;81\,a(n-1) - 1553\,a(n-2) + 2061\,a(n-3) + 172685\,a(n-4) - 899169\,a(n-5) - 6513363\,a(n-6) + 44110455\,a(n-7) + 105719944\,a(n-8) - 862490004\,a(n-9) - 709417008\,a(n-10) + 7693929440\,a(n-11) + 1058374912\,a(n-12) - 32657532864\,a(n-13) + 6969586944\,a(n-14) + 63976482560\,a(n-15) - 23949775872\,a(n-16) - 51839258624\,a(n-17) + 18903613440\,a(n-18) + 14501412864\,a(n-19) - 3227516928\,a(n-20)
\]
for every $n>20$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A210304.
