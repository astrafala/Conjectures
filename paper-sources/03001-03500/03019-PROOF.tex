...
\title{The empirical recurrence for OEIS A206219, proved by transfer matrix}
...
\begin{abstract}
OEIS A206219 counts arrays of width $5$ over $\{0,1,2\}$ by reducing every $2\times2$ subblock to a
...
about it is one bit per adjacent pair of columns, so the count is a walk count on $S=30064$
states.
\end{abstract}
...
OEIS A206219 is ``Number of (n+1)X5 0..2 arrays with rows and columns of determinants of all 2X2 subblocks lexicographically nondecreasing.''. It has offset $1$ and begins
\[
8128, 656053, 35625711, 1827047303, 74479700228, 2537225006229, 77008927829374, 2231343350258712,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 20 2025 11:31:46, revision 15) this is still
...
f(B)\;=\;\det B=ps-qr,
\]
the determinant. An array with $R$ rows and $5$ columns has $(R-1)\times4$ subblocks, and they
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=30064.
\]
...
\begin{theorem}
\[
a(n)\;=\;103\,a(n-1) - 4219\,a(n-2) + 81147\,a(n-3) - 397332\,a(n-4) - 14503310\,a(n-5) + 329978018\,a(n-6) - 2633737466\,a(n-7) - 4621703737\,a(n-8) + 283589064843\,a(n-9) - 2411136838927\,a(n-10) + 4991691652703\,a(n-11) + 67278935952078\,a(n-12) - 620599579539428\,a(n-13) + 1749152997998376\,a(n-14) + 5269824026917280\,a(n-15) - 59102318926312640\,a(n-16) + 172656732006803840\,a(n-17) + 92541855223544832\,a(n-18) - 2145453207148177664\,a(n-19) + 5848239068991970816\,a(n-20) - 854981061398701056\,a(n-21) - 32533098292024866816\,a(n-22) + 77324864401822253056\,a(n-23) - 26377215092523335680\,a(n-24) - 203801804660199915520\,a(n-25) + 404090179964000272384\,a(n-26) - 172703174480063627264\,a(n-27) - 423971470763460919296\,a(n-28) + 707497817831859290112\,a(n-29) - 362831080049269014528\,a(n-30) - 75679024184612093952\,a(n-31) + 150854984897157660672\,a(n-32) - 44931349155019751424\,a(n-33)
\]
for every $n>51$.
\end{theorem}
...
array of width $5$ over $\{0,1,2\}$ with two and with three rows was written out cell by cell,
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206219.
