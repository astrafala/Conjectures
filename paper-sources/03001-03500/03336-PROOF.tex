...
\title{The empirical closed form for OEIS A224354, proved}
...
\begin{abstract}
OEIS A224354 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A224354 is ``Number of 3 X n 0..2 arrays with diagonals and antidiagonals unimodal and rows nondecreasing.''. It has offset $1$ and begins
\[
27, 216, 788, 2321, 5840, 13052, 26610, 50423,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (23/360)*n\^{}6 + (19/40)*n\^{}5 + (235/72)*n\^{}4 + (61/8)*n\^{}3 + (1921/180)*n\^{}2 + (189/10)*n + 3 for n>1.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 29 2018 15:24:39, revision 7) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{23 n^{6}}{360} + \frac{19 n^{5}}{40} + \frac{235 n^{4}}{72} + \frac{61 n^{3}}{8} + \frac{1921 n^{2}}{180} + \frac{189 n}{10} + 3.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224354.
