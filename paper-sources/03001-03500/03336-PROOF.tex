...
\title{The empirical closed form for OEIS A223619, proved}
...
\begin{abstract}
OEIS A223619 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A223619 is ``Number of nX7 0..1 arrays with rows and columns unimodal.''. It has offset $1$ and begins
\[
29, 841, 14547, 160883, 1271969, 7795951, 39162020, 167679972,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 21:52:54, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\begin{multline*}
f(n)\;=\;\frac{503 n^{14}}{209563200} + \frac{6527 n^{13}}{155675520} \\
+ \frac{17 n^{12}}{31185} + \frac{37901 n^{11}}{8553600} \\
+ \frac{76799 n^{10}}{2721600} + \frac{46471 n^{9}}{362880} \\
+ \frac{3497567 n^{8}}{7620480} + \frac{936493 n^{7}}{777600} \\
+ \frac{467419 n^{6}}{181440} + \frac{320807 n^{5}}{77760} \\
+ \frac{69073271 n^{4}}{11975040} + \frac{29326111 n^{3}}{4989600} \\
+ \frac{60167903 n^{2}}{11642400} + \frac{191717 n}{72072} \\
+ 1.
\end{multline*}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223619.
