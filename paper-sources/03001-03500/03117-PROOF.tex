...
\title{The empirical recurrence for OEIS A211531, proved by transfer matrix}
...
\begin{abstract}
OEIS A211531 carries an empirical recurrence of order $9$ contributed by R. H. Hardin. It is
...
OEIS A211531 is ``Number of -1..1 arrays x(i) of n+1 elements i=1..n+1 with set{t,u,v in 0,1}((x[i+t]+x[j+u]+x[k+v])*(-1)\^{}(t+u+v)) having one, two, three, four, five or six distinct values for every i,j,k<=n.''. It has offset $1$ and begins
\[
9, 27, 77, 199, 503, 1239, 3021, 7303,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 5*a(n-1) - 3*a(n-2) - 17*a(n-3) + 17*a(n-4) + 22*a(n-5) - 18*a(n-6) - 14*a(n-7) + 3*a(n-8) + 2*a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 18 2018 14:30:49, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) - 3\,a(n-2) - 17\,a(n-3) + 17\,a(n-4) + 22\,a(n-5) - 18\,a(n-6) - 14\,a(n-7) + 3\,a(n-8) + 2\,a(n-9)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A211531.
