...
\title{The empirical recurrence for OEIS A206515, proved by transfer matrix}
...
\begin{abstract}
OEIS A206515 counts, up to renaming the letters, the arrays of width $3$ over at most $4$
letters in which every $2\times3$ and $3\times2$ subblock has at most $4$ equal edges, an edge of such a window being one of the six steps of its perimeter cycle and an equal edge one whose two cells agree. It carries an empirical recurrence of order $10$ contributed by
...
OEIS A206515 is ``Number of (n+1) X 3 0..3 arrays with every 2 X 3 or 3 X 2 subblock having no more than four equal edges, and new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
186, 10998, 695541, 44350086, 2830665213, 180689239504, 11534052523389, 736261766040550,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 12 2026 12:47:07, revision 11) this is still
...
$w_i$ cleared of denominators and $S=4880$ states in all. The walk index $j$ and the entry's own
...
\begin{theorem}
\[
a(n)\;=\;66\,a(n-1) - 116\,a(n-2) - 1310\,a(n-3) - 7016\,a(n-4) - 9076\,a(n-5) - 9408\,a(n-6) - 4662\,a(n-7) - 4635\,a(n-8) - 378\,a(n-9) - 648\,a(n-10)
\]
for every $n>10$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206515.
