...
\title{The empirical recurrence for OEIS A239334, proved by transfer matrix}
...
\begin{abstract}
OEIS A239334 counts arrays over $\{0,1,2,3\}$ in which no entry may equal, modulo $4$, a given
...
OEIS A239334 is ``Number of nX2 0..3 arrays with no element equal to one plus the sum of elements to its left or three plus the sum of elements above it, modulo 4.''. It has offset $1$ and begins
\[
5, 31, 172, 926, 5078, 27861, 152260, 832207,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 09:26:04, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A239334.
