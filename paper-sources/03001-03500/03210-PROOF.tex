...
\title{The empirical recurrence for OEIS A269050, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A269050 counts arrays over $\{0,\dots,2\}$ subject to a condition on the array as a
...
OEIS A269050 is ``Number of n X 6 0..2 arrays with some element plus some horizontally, diagonally or antidiagonally adjacent neighbor totalling two not more than once.''. It has offset $1$ and begins
\[
336, 3288, 58752, 971844, 15547380, 242861616, 3726221592, 56376679620,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 29 2023 10:31:44, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;36\,a(n-1) - 436\,a(n-2) + 1854\,a(n-3) + 340\,a(n-4) - 19128\,a(n-5) + 23849\,a(n-6) + 56184\,a(n-7) - 108224\,a(n-8) - 40816\,a(n-9) + 160400\,a(n-10) - 34136\,a(n-11) - 83203\,a(n-12) + 42628\,a(n-13) + 6468\,a(n-14) - 6334\,a(n-15) + 204\,a(n-16) + 240\,a(n-17) - 25\,a(n-18)
\end{equation}
for all $n>19$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269050.
