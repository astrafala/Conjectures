...
\title{The empirical recurrence for OEIS A240785, proved by transfer matrix}
...
\begin{abstract}
OEIS A240785 counts $4\times n$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A240785 is ``Number of 4Xn 0..1 arrays with no element equal to fewer vertical neighbors than horizontal neighbors, with new values 0..1 introduced in row major order.''. It has offset $1$ and begins
\[
8, 34, 97, 305, 959, 3033, 9581, 30354,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 11:07:30, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) - 11\,a(n-2) + 7\,a(n-3) - 10\,a(n-5) + 13\,a(n-6) - 3\,a(n-7) + 27\,a(n-8) - 44\,a(n-9) + 13\,a(n-10) + 5\,a(n-11) - 8\,a(n-12) + 8\,a(n-13) - 3\,a(n-14) + a(n-15)
\]
for every $n>15$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A240785.
