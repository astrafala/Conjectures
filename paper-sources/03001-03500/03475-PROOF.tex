...
\title{The empirical closed form for OEIS A224413, proved}
...
\begin{abstract}
OEIS A224413 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A224413 is ``Number of 6Xn 0..1 arrays with rows unimodal and antidiagonals nondecreasing.''. It has offset $1$ and begins
\[
64, 972, 4636, 13440, 31710, 68282, 139638, 275766,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 23:27:04, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\begin{multline*}
f(n)\;=\;\frac{n^{12}}{479001600} + \frac{n^{11}}{7257600} \\
+ \frac{199 n^{10}}{43545600} + \frac{n^{9}}{10752} \\
+ \frac{19951 n^{8}}{14515200} + \frac{5143 n^{7}}{345600} \\
+ \frac{6148357 n^{6}}{43545600} + \frac{3015961 n^{5}}{1451520} \\
+ \frac{128983289 n^{4}}{10886400} + \frac{40193333 n^{3}}{604800} \\
+ \frac{444089893 n^{2}}{1663200} - \frac{4351 n}{20} \\
- 222.
\end{multline*}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224413.
