...
\title{The empirical recurrence for OEIS A189437, proved by transfer matrix}
...
\begin{abstract}
OEIS A189437 counts the permutations of the cells of an $n\times5$ array in which every cell
...
That makes $a$ a walk count on $S=46$ states, hence $C$-finite, and whether the published
...
OEIS A189437 is ``Number of 5 X n array permutations with each element not moving, or moving one space N, SW or SE.''. It has offset $1$ and begins
\[
1, 20, 109, 841, 5680, 40065, 278105, 1940868,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 10*a(n-1) -17*a(n-2) -47*a(n-3) +138*a(n-4) -75*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (May 02 2018 08:48:06, revision 8) this is still
...
cell by $\delta_15+\delta_2$ places in that order, so every image lies between $lo=-4$ and
...
$k+-4,\dots,k+6$ are taken --- a subset of a set of size $11$, and nothing else.
...
\begin{theorem}
\[
a(n)\;=\;10\,a(n-1) - 17\,a(n-2) - 47\,a(n-3) + 138\,a(n-4) - 75\,a(n-5)
\]
for every $n>4$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A189437.
