...
\title{The empirical recurrence for OEIS A203721, proved by transfer matrix}
...
\begin{abstract}
OEIS A203721 counts arrays of width $2$ over $\{0,1,2\}$ through two derived arrays of PAIR SUMS ---
...
OEIS A203721 is ``Number of (n+1) X 2 0..2 arrays with column and row pair sums b(i,j)=a(i,j)+a(i,j-1) and c(i,j)=a(i,j)+a(i-1,j) nondecreasing in column and row directions, respectively.''. It has offset $1$ and begins
\[
32, 113, 326, 888, 2278, 5653, 13665, 32440,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 6*a(n-1) -11*a(n-2) +a(n-3) +16*a(n-4) -10*a(n-5) -7*a(n-6) +6*a(n-7) +a(n-8) -a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 04 2018 14:17:42, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The array $a$ has $2$ cells across, with entries in $\{0,1,2\}$. Two derived arrays are formed,
\[
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A203721.
