...
\title{The empirical column recurrences for the table OEIS A235765}
...
\begin{abstract}
OEIS A235765 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A235765 is ``T(n,k)=Number of (n+1)X(k+1) 0..1 arrays with the sum of each 2X2 subblock two median terms lexicographically nondecreasing columnwise and nonincreasing rowwise.''. It has offset $1$, is
read by antidiagonals, and begins
\[
16, 48, 48, 141, 216, 141, 378, 977,\ \dots
\]
...
k=3: [order 54]\\
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 08:48:06, revision 6) these are still
...
The sequence is ``Number of (n+1)X2 0..1 arrays with the sum of each 2X2 subblock two median terms lexicographically nondecreasing columnwise and nonincreasing rowwise.''. Its rows are the vertices of a digraph on
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A235765.
