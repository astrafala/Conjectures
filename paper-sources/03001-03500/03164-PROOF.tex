...
\title{The empirical recurrence for OEIS A205057, proved by transfer matrix}
...
\begin{abstract}
OEIS A205057 counts arrays of width $2$ over $\{0,1,2\}$ by reducing every $2\times2$ subblock to a
...
about it is one bit per adjacent pair of columns, so the count is a walk count on $S=47$
states.
\end{abstract}
...
OEIS A205057 is ``Number of (n+1)X2 0..2 arrays with rows and columns of permanents of all 2X2 subblocks lexicographically nondecreasing.''. It has offset $1$ and begins
\[
81, 491, 2830, 14206, 68508, 311076, 1375313, 5904417,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 11:44:13, revision 9) this is still
...
\]
the permanent. An array with $R$ rows and $2$ columns has $(R-1)\times1$ subblocks, and they
...
\begin{theorem}
\[
a(n)\;=\;9\,a(n-1) - 9\,a(n-2) - 130\,a(n-3) + 330\,a(n-4) + 668\,a(n-5) - 2784\,a(n-6) - 966\,a(n-7) + 11477\,a(n-8) - 4085\,a(n-9) - 26019\,a(n-10) + 21040\,a(n-11) + 31242\,a(n-12) - 39912\,a(n-13) - 14020\,a(n-14) + 35744\,a(n-15) - 6168\,a(n-16) - 11920\,a(n-17) + 6272\,a(n-18) - 768\,a(n-19)
\]
for every $n>17$.
\end{theorem}
...
array of width $2$ over $\{0,1,2\}$ with two and with three rows was written out cell by cell,
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A205057.
