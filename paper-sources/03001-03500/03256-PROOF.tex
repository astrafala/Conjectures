...
\title{The empirical recurrence for OEIS A211459, proved by transfer matrix}
...
\begin{abstract}
OEIS A211459 carries an empirical recurrence of order $8$ contributed by R. H. Hardin. It is
...
OEIS A211459 is ``Number of -2..2 arrays x(i) of n+1 elements i=1..n+1 with x(i)+x(j), x(i+1)+x(j+1), -(x(i)+x(j+1)), and -(x(i+1)+x(j)) having three distinct values for every i<=n and j<=n.''. It has offset $1$ and begins
\[
20, 44, 92, 178, 348, 658, 1260, 2382,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) + a(n-2) - 21*a(n-3) + 16*a(n-4) + 29*a(n-5) - 34*a(n-6) - 6*a(n-7) + 12*a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 17 2018 09:00:25, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A211459.
