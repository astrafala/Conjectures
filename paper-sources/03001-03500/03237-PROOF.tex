...
\title{The empirical recurrence for OEIS A241103, proved by transfer matrix}
...
\begin{abstract}
OEIS A241103 counts arrays of width $3$ over $\{0,\dots,2\}$ under a condition on each cell
...
OEIS A241103 is ``Number of n X 3 0..2 arrays with no element equal to one or three horizontal or vertical neighbors, with new values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
2, 11, 58, 294, 1522, 7846, 40418, 208374,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) + 8*a(n-2) + 16*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 29 2018 12:50:13, revision 8) this is still
...
(-1,0), (0,-1), (0,1), (1,0),
\]
those falling outside the array being absent. The entry requires that no cell equals exactly $1 or 3$ of its neighbours.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A241103.
