...
\title{The empirical recurrence for OEIS A204775, proved by transfer matrix}
...
\begin{abstract}
OEIS A204775 counts $(n+2)\times3$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A204775 is ``Number of (n+2) X 3 0..2 arrays with no 3 X 3 subblock having three equal diagonal elements or three equal antidiagonal elements, and new values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
2592, 55296, 1180224, 25190406, 537665796, 11475976536, 244944162648, 5228107832664,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 22*a(n-1) - 308*a(n-3) + 196*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 10 2018 20:47:26, revision 10) this is still
...
\begin{theorem}
\[
a(n)\;=\;22\,a(n-1) - 308\,a(n-3) + 196\,a(n-4)
\]
for every $n>4$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204775.
