...
\title{The empirical recurrence for OEIS A268637, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A268637 counts arrays over $\{0,\dots,2\}$ subject to a condition on the array as a
...
OEIS A268637 is ``Number of nX6 0..2 arrays with some element plus some horizontally or vertically adjacent neighbor totalling two exactly once.''. It has offset $1$ and begins
\[
240, 7128, 163878, 3440052, 68710116, 1328460312, 25093766490, 465757993812,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 09 2016 12:22:18, revision 4) the statement is
...
those integers vanishes from the index corresponding to $n=15+1$ onwards, and the run
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268637.
