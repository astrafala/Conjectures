...
\title{The empirical recurrence for OEIS A214162, proved by transfer matrix}
...
\begin{abstract}
OEIS A214162 counts the proper colourings of a grid $n\times5$, wrapped in the direction of width $5$, with at most $6$ colours and
counted up to renaming the colours, and carries an empirical recurrence of order $5$
...
down to $S=37$ and makes the exact residual test affordable.
\end{abstract}
...
OEIS A214162 is ``Number of 0..5 colorings of an nX5 array circular in the 5 direction with new values 0..5 introduced in row major order.''. It has offset $1$ and begins
\[
11, 5994, 7386816, 9601970064, 12515731371696, 16315987753015584, 21270302008568180976, 27728993363693782195104,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 1402*a(n-1) -130492*a(n-2) +2979072*a(n-3) -15573492*a(n-4) +12571416*a(n-5)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 16:54:25, revision 8) this is still
...
\]
There are $(i-1)^{5}+(-1)^{5}(i-1)$ such colourings, which at $i=6$ is already more
...
state count is $S=37$ rather than the number of colourings.
...
\begin{theorem}
\[
a(n)\;=\;1402\,a(n-1) - 130492\,a(n-2) + 2979072\,a(n-3) - 15573492\,a(n-4) + 12571416\,a(n-5)
\]
for every $n>5$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A214162.
