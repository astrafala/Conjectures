...
\title{The empirical closed form for OEIS A223984, proved}
...
\begin{abstract}
OEIS A223984 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
$S=296$ vertices. Any function of the form $\sum_j p_j(n)\lambda_j^{\,n}$ satisfies the
...
OEIS A223984 is ``Number of nX5 0..3 arrays with rows unimodal and columns nondecreasing.''. It has offset $1$ and begins
\[
296, 14751, 308470, 3770722, 31831914, 204647416, 1067023886, 4710529013,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 23:08:20, revision 8) this is still
...
+ \frac{1419127 n^{13}}{1037836800} + \frac{108727 n^{12}}{6842880} \\
+ \frac{30122453 n^{11}}{239500800} + \frac{15632539 n^{10}}{21772800} \\
+ \frac{66446071 n^{9}}{21772800} + \frac{299560531 n^{8}}{30481920} \\
+ \frac{4868287 n^{7}}{201600} + \frac{5624957 n^{6}}{124416} \\
+ \frac{7644136631 n^{5}}{119750400} + \frac{797122847 n^{4}}{11975040} \\
+ \frac{85565105 n^{3}}{1729728} + \frac{933168347 n^{2}}{37837800} \\
+ \frac{73789 n}{10010} + 1.
\end{multline*}
...
walk, so with $M$ the adjacency matrix of that digraph on $S=296$ vertices, and $u,w$ the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223984.
