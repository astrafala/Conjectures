...
\title{The empirical recurrence for OEIS A222777, proved by transfer matrix}
...
\begin{abstract}
OEIS A222777 counts arrays in which no entry may equal the entries at a short list of fixed offsets
...
$2$ consecutive rows, $S=3395$ states in all.
\end{abstract}
...
OEIS A222777 is ``Number of n X 2 0..6 arrays with no element equal to another at a city block distance of exactly two, and new values 0..6 introduced in row major order.''. It has offset $1$ and begins
\[
2, 7, 34, 388, 6814, 148168, 3518434, 86343148,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 39*a(n-1) - 399*a(n-2) + 1261*a(n-3) - 900*a(n-4) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 16 2018 08:58:56, revision 8) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=3395.
\]
...
\begin{theorem}
\[
a(n)\;=\;39\,a(n-1) - 399\,a(n-2) + 1261\,a(n-3) - 900\,a(n-4)
\]
for every $n>6$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A222777.
