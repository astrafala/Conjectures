...
\title{The empirical recurrence for OEIS A183510, proved by transfer matrix}
...
\begin{abstract}
OEIS A183510 counts arrays of width $2$ over $\{0,1\}$ in which every cell is the sum of one of two groups of its neighbours. The entry carries an
...
OEIS A183510 is ``Number of n X 2 binary arrays with each element equal to either the sum mod 2 of its horizontal and vertical neighbors or the sum mod 2 of its diagonal and antidiagonal neighbors.''. It has offset $1$ and begins
\[
2, 4, 11, 24, 56, 121, 272, 612,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + a(n-2) - 2*a(n-4) + a(n-5) - a(n-6) - 6*a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 29 2018 13:33:03, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + a(n-2) - 2\,a(n-4) + a(n-5) - a(n-6) - 6\,a(n-7)
\]
for every $n>6$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A183510.
