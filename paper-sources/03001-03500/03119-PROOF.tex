...
\title{The empirical recurrence for OEIS A208708, proved by counting patterns}
...
\begin{abstract}
OEIS A208708 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
$8$, contributed by R.~H.~Hardin, then follows from a finite exact computation.
\end{abstract}
...
OEIS A208708 is ``Number of nX7 0..1 arrays with new values 0..1 introduced in row major order and no element equal to more than two of its immediate leftward or upward or right-upward antidiagonal neighbors.''. It has offset $1$ and begins
\[
64, 4516, 334948, 24754628, 1830045552, 135288700496, 10001404535216, 739367693888784,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 83*a(n-1) -710*a(n-2) +3004*a(n-3) -7952*a(n-4) +16752*a(n-5) -27360*a(n-6) +33984*a(n-7) -26368*a(n-8) for n>10
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:59:31, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;83\,a(n-1) - 710\,a(n-2) + 3004\,a(n-3) - 7952\,a(n-4) + 16752\,a(n-5) - 27360\,a(n-6) + 33984\,a(n-7) - 26368\,a(n-8)
\end{equation}
for all $n>10$.
...
For every $n$ with $m=n+0-1\ge8$,
\[
2!\Bigl(a(n)-\sum_i c_i\,a(n-i)\Bigr)\;=\;\mathbf{v}^{\!\top}N^{\,m-8}q(N)\mathbf{1} .
\]
...
\begin{proof}
Substitute \eqref{eq:walk} into the left side and factor $N^{m-8}$ out of
...
column. The vector $w=q(N)\mathbf{1}$ was then formed by $8$ matrix--vector products
...
corresponding to $n=10+1$ onwards, and the run continued until $w$ was the zero vector,
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208708.
