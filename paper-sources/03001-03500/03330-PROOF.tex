...
\title{The empirical closed form for OEIS A224151, proved}
...
\begin{abstract}
OEIS A224151 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
$S=131072$ vertices. Any function of the form $\sum_j p_j(n)\lambda_j^{\,n}$ satisfies the
...
OEIS A224151 is ``Number of 7Xn 0..1 arrays with rows and antidiagonals unimodal and columns nondecreasing.''. It has offset $1$ and begins
\[
8, 64, 357, 1536, 5471, 16885, 46586, 117510,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 23:16:40, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\begin{multline*}
f(n)\;=\;\frac{n^{14}}{87178291200} + \frac{n^{13}}{4151347200} \\
+ \frac{n^{12}}{136857600} + \frac{19 n^{11}}{106444800} \\
+ \frac{53 n^{10}}{12441600} + \frac{121 n^{9}}{1382400} \\
+ \frac{1007857 n^{8}}{609638400} + \frac{427321 n^{7}}{29030400} \\
+ \frac{5519 n^{6}}{62208} + \frac{217709 n^{5}}{604800} \\
+ \frac{8736011 n^{4}}{8553600} + \frac{1790117 n^{3}}{950400} \\
+ \frac{90367957 n^{2}}{37837800} + \frac{49717 n}{40040} \\
+ 1.
\end{multline*}
...
walk, so with $M$ the adjacency matrix of that digraph on $S=131072$ vertices, and $u,w$ the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224151.
