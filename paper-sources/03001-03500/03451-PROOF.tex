...
\title{The empirical recurrence for OEIS A268178, proved by transfer matrix}
...
\begin{abstract}
OEIS A268178 counts arrays in which the REPEATED VALUES of each row, and of each column, stand in a
prescribed relation to one another in the order they occur. The entry carries an empirical
recurrence of order $17$ contributed by R.~H.~Hardin. It is true, and it is decidable
...
value so far in each column of the scan, so the count is a walk count on $S=9950$ states.
\end{abstract}
...
OEIS A268178 is ``Number of nX3 0..3 arrays with every repeated value in every row equal to, and in every column unequal to, the previous repeated value, and new values introduced in row-major sequential order.''. It has offset $1$ and begins
\[
5, 187, 9054, 494098, 25770278, 1339895662, 68390077014, 3463876525750,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 28 2016 07:33:58, revision 5) this is still
...
equal to the previous repeated value of that row, and that each repeated value of a column,
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=9950,\quad\tau=\mathbf{1} .
\]
...
\begin{theorem}
\[
a(n)\;=\;108\,a(n-1) - 2343\,a(n-2) - 95508\,a(n-3) + 3418760\,a(n-4) + 23547420\,a(n-5) - 1342943052\,a(n-6) - 883192104\,a(n-7) + 173217160160\,a(n-8) - 342228942720\,a(n-9) - 5613350923584\,a(n-10) + 8457106112640\,a(n-11) + 55966350739968\,a(n-12) - 69629468894208\,a(n-13) - 198751111188480\,a(n-14) + 222436679786496\,a(n-15) + 215814907920384\,a(n-16) - 228509902503936\,a(n-17)
\]
for every $n>19$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268178.
