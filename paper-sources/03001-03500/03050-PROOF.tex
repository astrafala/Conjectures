...
\title{The empirical recurrence for OEIS A205435, proved by transfer matrix}
...
\begin{abstract}
OEIS A205435 counts, up to renaming the letters, the arrays of width $4$ over at most $4$
letters in which all the $2\times2$ subblocks of one array have the SAME number of equal edges, an equal edge being one of the four perimeter edges whose two cells agree; the common value is not named, so the count splits by it. It carries an empirical recurrence of order $18$ contributed by
...
OEIS A205435 is ``Number of (n+1)X4 0..3 arrays with every 2X2 subblock having the same number of equal edges, and new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
443, 10275, 302148, 10308161, 375775257, 14089784418, 534222700494, 20344347242650,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 12:06:49, revision 9) this is still
...
$w_i$ cleared of denominators and $S=822$ states in all. The walk index $j$ and the entry's own
...
\begin{theorem}
\[
a(n)\;=\;84\,a(n-1) - 2478\,a(n-2) + 31310\,a(n-3) - 105688\,a(n-4) - 1447728\,a(n-5) + 16566156\,a(n-6) - 52644616\,a(n-7) - 112948204\,a(n-8) + 1286364942\,a(n-9) - 3365762496\,a(n-10) + 989417336\,a(n-11) + 13822996149\,a(n-12) - 35396231412\,a(n-13) + 42837090738\,a(n-14) - 29104419996\,a(n-15) + 11035031040\,a(n-16) - 2101181472\,a(n-17) + 147246336\,a(n-18)
\]
for every $n>17$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A205435.
