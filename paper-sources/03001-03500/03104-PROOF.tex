...
\title{The empirical recurrence for OEIS A231464, proved by transfer matrix}
...
\begin{abstract}
OEIS A231464 counts $2\times(n+1)$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A231464 is ``Number of (1+1) X (n+1) 0..3 arrays with no element unequal to a strict majority of its horizontal, diagonal and antidiagonal neighbors, with values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
3, 7, 14, 33, 78, 197, 531, 1471,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 29 2018 08:45:56, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) + 3\,a(n-2) - 41\,a(n-3) + 11\,a(n-4) + 137\,a(n-5) - 82\,a(n-6) - 176\,a(n-7) + 108\,a(n-8) + 108\,a(n-9) - 72\,a(n-10)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231464.
