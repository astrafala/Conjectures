...
\title{The empirical recurrence for OEIS A211688, proved by transfer matrix}
...
\begin{abstract}
OEIS A211688 carries an empirical recurrence of order $13$ contributed by R. H. Hardin. It is
...
OEIS A211688 is ``Number of -4..4 arrays x(i) of n+1 elements i=1..n+1 with x(i)+x(j), x(i+1)+x(j+1), -(x(i)+x(j+1)), and -(x(i+1)+x(j)) having one or three distinct values for every i<=n and j<=n.''. It has offset $1$ and begins
\[
69, 173, 375, 765, 1545, 3029, 5973, 11621,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 16:16:50, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + 10\,a(n-2) - 35\,a(n-3) - 35\,a(n-4) + 160\,a(n-5) + 45\,a(n-6) - 365\,a(n-7) + 6\,a(n-8) + 437\,a(n-9) - 55\,a(n-10) - 260\,a(n-11) + 30\,a(n-12) + 60\,a(n-13)
\]
for every $n>13$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A211688.
