...
\title{The empirical recurrence for OEIS A198908, proved by counting patterns}
...
\begin{abstract}
OEIS A198908 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A198908 is ``Number of n X 2 0..7 arrays with values 0..7 introduced in row major order and no element equal to any horizontal or vertical neighbor.''. It has offset $1$ and begins
\[
1, 4, 34, 500, 10867, 313132, 10856948, 418689772,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 88*a(n-1) - 2613*a(n-2) + 33232*a(n-3) - 184531*a(n-4) + 400344*a(n-5) - 246519*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 22 2018 16:29:08, revision 8) the statement is
...
\[
8!\Bigl(a(n)-\sum_i c_i\,a(n-i)\Bigr)\;=\;\mathbf{v}^{\!\top}N^{\,m-6}q(N)\mathbf{1} .
\]
...
corresponding to $n=6+1$ onwards, and the run continued until $w$ was the zero vector,
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A198908.
