...
\title{The empirical recurrence for OEIS A276243, proved by counting patterns}
...
\begin{abstract}
OEIS A276243 counts arrays in which no entry may repeat a value found at any of three stated
...
cutting $794$ pairs to $S=155$ states. The entry's empirical recurrence of order $6$,
...
OEIS A276243 is ``Number of n X 3 0..2 arrays with no element equal to any value at offset (-2,-1) (-1,1) or (0,-2) and new values introduced in order 0..2.''. It has offset $1$ and begins
\[
3, 24, 85, 347, 1404, 5671, 23000, 93204,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 5*a(n-1) - 4*a(n-2) + 17*a(n-3) - 83*a(n-4) + 54*a(n-5) + 56*a(n-6) for n>9.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 05 2019 04:45:34, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) - 4\,a(n-2) + 17\,a(n-3) - 83\,a(n-4) + 54\,a(n-5) + 56\,a(n-6)
\end{equation}
for all $n>9$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A276243.
