...
\title{The empirical recurrence for OEIS A275501, proved by counting patterns}
...
\begin{abstract}
OEIS A275501 counts arrays in which no entry may repeat a value found at any of three stated
...
cutting $60074$ pairs to $S=10355$ states. The entry's empirical recurrence of order $32$,
...
OEIS A275501 is ``Number of nX5 0..2 arrays with no element equal to any value at offset (-2,-1) (-2,0) or (-1,-1) and new values introduced in order 0..2.''. It has offset $1$ and begins
\[
41, 1944, 2000, 3168, 4180, 13384, 43780, 143784,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 30 2016 19:56:08, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 16\,a(n-2) - 120\,a(n-4) - 55\,a(n-5) + 549\,a(n-6) + 319\,a(n-7) - 1772\,a(n-8) - 891\,a(n-9) + 4300\,a(n-10) + 1407\,a(n-11) - 7992\,a(n-12) - 1155\,a(n-13) + 11470\,a(n-14) + a(n-15) - 12854\,a(n-16) + 1155\,a(n-17) + 11372\,a(n-18) - 1407\,a(n-19) - 7960\,a(n-20) + 891\,a(n-21) + 4357\,a(n-22) - 320\,a(n-23) - 1820\,a(n-24) + 55\,a(n-25) + 560\,a(n-26) - 120\,a(n-28) - a(n-29) + 16\,a(n-30) - a(n-32)
\end{equation}
for all $n>36$.
...
$o=1n_0+0-2$, we have for $j\ge32$
\[
3!\Bigl(a(n_0+j)-\sum_i c_i\,a(n_0+j-i)\Bigr)
=\mathbf{v}^{\!\top}G^{\,j-32}w,\qquad
w=h_{32}-\sum_i c_i h_{32-i} .
\]
...
the survivors by the pattern of the new pair. The vector $w$ was formed by $32$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A275501.
