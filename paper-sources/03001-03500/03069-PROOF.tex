...
\title{The empirical recurrence for OEIS A193697, proved by transfer matrix}
...
\begin{abstract}
OEIS A193697 carries an empirical recurrence of order $31$ contributed by R. H. Hardin. It is
...
arrays counted are exactly the walks in it; hence $a(n)$ is a walk count on $S=109$ vertices
...
OEIS A193697 is ``Number of arrays of -3..3 integers x(1..n) with every x(i) in a subsequence of length 1, 2 or 3 with sum zero.''. It has offset $1$ and begins
\[
1, 7, 43, 181, 827, 3773, 17197, 78407,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 27 2025 09:08:15, revision 10) this is still
...
admissible array is then exactly a walk, so with $M$ the adjacency matrix on $S=109$ vertices
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + a(n-2) - a(n-3) + 21\,a(n-4) + 47\,a(n-5) + 60\,a(n-6) + 155\,a(n-7) + 255\,a(n-8) + 386\,a(n-9) + 623\,a(n-10) + 899\,a(n-11) + 976\,a(n-12) + 972\,a(n-13) + 664\,a(n-14) + 119\,a(n-15) - 414\,a(n-16) - 754\,a(n-17) - 970\,a(n-18) - 886\,a(n-19) - 786\,a(n-20) - 580\,a(n-21) - 358\,a(n-22) - 109\,a(n-23) + 40\,a(n-24) + 116\,a(n-25) + 100\,a(n-26) + 66\,a(n-27) + 37\,a(n-28) + 19\,a(n-29) + 6\,a(n-30) + a(n-31)
\]
for every $n>0$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A193697.
