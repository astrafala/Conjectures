...
\title{The empirical recurrence for OEIS A204355, proved by transfer matrix}
...
\begin{abstract}
OEIS A204355 counts $(n+2)\times4$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A204355 is ``Number of (n+2)X4 0..1 arrays with every 3X3 subblock having three equal elements in a row horizontally, vertically, diagonally or antidiagonally exactly one way, and new values 0..1 introduced in row major order.''. It has offset $1$ and begins
\[
241, 713, 2063, 5812, 16792, 48226, 137407, 391892,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 11:09:26, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-2) + 8\,a(n-3) + 16\,a(n-4) - 7\,a(n-5) - 76\,a(n-6) - 52\,a(n-7) + 39\,a(n-8) + 33\,a(n-9) + 27\,a(n-10) + 105\,a(n-11) + 24\,a(n-12) - 102\,a(n-13) + 36\,a(n-14) + 13\,a(n-15) - 86\,a(n-16) - 26\,a(n-17) + 20\,a(n-18) + 14\,a(n-19) - 12\,a(n-20) + 18\,a(n-21) + 6\,a(n-22) - 4\,a(n-23) + 2\,a(n-24)
\]
for every $n>28$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204355.
