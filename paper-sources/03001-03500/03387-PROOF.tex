...
\title{The empirical recurrence for OEIS A198702, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A198702 counts arrays in which every cell is constrained by its neighbours on \emph{both}
...
order $12$, contributed by R.~H.~Hardin, then follows from a finite exact computation.
\end{abstract}
...
OEIS A198702 is ``Number of nX2 0..4 arrays with values 0..4 introduced in row major order and each element equal to at least one horizontal or vertical neighbor.''. It has offset $1$ and begins
\[
1, 3, 14, 76, 488, 3508, 27422, 227045,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 07:59:34, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;17\,a(n-1) - 80\,a(n-2) + 37\,a(n-3) + 349\,a(n-4) - 60\,a(n-5) - 729\,a(n-6) - 553\,a(n-7) + 572\,a(n-8) + 783\,a(n-9) + 139\,a(n-10) - 304\,a(n-11) - 170\,a(n-12)
\end{equation}
for all $n>13$.
...
index,
\[
5!\Bigl(a(n)-\sum_i c_i\,a(n-i)\Bigr)\;=\;\mathbf{v}^{\!\top}G^{\,j-12}\,
\Bigl(h_{12}-\sum_i c_i h_{12-i}\Bigr)
\]
...
$w=h_{12}-\sum_i c_ih_{12-i}$; and it is enough to check $m=0,1,\dots,S-1$.
\end{lemma}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A198702.
