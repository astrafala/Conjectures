...
\title{The empirical closed form for OEIS A224393, proved}
...
\begin{abstract}
OEIS A224393 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A224393 is ``Number of 4Xn 0..3 arrays with diagonals and antidiagonals unimodal and rows nondecreasing.''. It has offset $1$ and begins
\[
256, 10000, 86701, 497958, 2332222, 9331553, 32806574, 103452812,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 23:26:15, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\begin{multline*}
f(n)\;=\;\frac{3551 n^{12}}{47900160} + \frac{17561 n^{11}}{13305600} \\
+ \frac{410317 n^{10}}{21772800} + \frac{127787 n^{9}}{725760} \\
+ \frac{394837 n^{8}}{290304} + \frac{4724393 n^{7}}{1209600} \\
+ \frac{880093831 n^{6}}{21772800} - \frac{673403 n^{5}}{80640} \\
+ \frac{476636641 n^{4}}{1088640} + \frac{58121267 n^{3}}{907200} \\
- \frac{1924453 n^{2}}{415800} - \frac{1998055 n}{2772} \\
+ 1906.
\end{multline*}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224393.
