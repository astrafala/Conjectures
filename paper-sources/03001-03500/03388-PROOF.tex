...
\title{The empirical closed form for OEIS A207302, proved}
...
\begin{abstract}
OEIS A207302 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A207302 is ``Number of n X 5 0..1 arrays avoiding 0 0 0 and 1 0 1 horizontally and 0 0 1 and 1 1 0 vertically.''. It has offset $1$ and begins
\[
13, 169, 665, 1759, 3773, 7093, 12169, 19515,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (8/3)*n\^{}4 + (49/3)*n\^{}3 + (16/3)*n\^{}2 - (43/3)*n + 3.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 21 2018 14:29:53, revision 10) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{8 n^{4}}{3} + \frac{49 n^{3}}{3} + \frac{16 n^{2}}{3} - \frac{43 n}{3} + 3.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207302.
