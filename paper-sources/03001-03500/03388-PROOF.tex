...
\title{The empirical recurrence for OEIS A214100, proved by transfer matrix}
...
\begin{abstract}
OEIS A214100 counts the proper colourings of a grid $n\times8$, wrapped in the direction of width $8$, with at most $3$ colours and
...
down to $S=260$ and makes the exact residual test affordable.
\end{abstract}
...
OEIS A214100 is ``Number of 0..2 colorings on an nX8 array circular in the 8 direction with new values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
43, 1179, 37441, 1241355, 41634729, 1400634371, 47155766193, 1587939072699,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 54*a(n-1) -820*a(n-2) +4906*a(n-3) -11803*a(n-4) +11888*a(n-5) -4672*a(n-6) +576*a(n-7)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 16:50:59, revision 8) this is still
...
\]
There are $(i-1)^{8}+(-1)^{8}(i-1)$ such colourings, which at $i=3$ is already more
...
state count is $S=260$ rather than the number of colourings.
...
\begin{theorem}
\[
a(n)\;=\;54\,a(n-1) - 820\,a(n-2) + 4906\,a(n-3) - 11803\,a(n-4) + 11888\,a(n-5) - 4672\,a(n-6) + 576\,a(n-7)
\]
for every $n>7$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A214100.
