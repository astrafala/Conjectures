...
\title{The empirical column recurrences for the table OEIS A233618}
...
\begin{abstract}
OEIS A233618 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A233618 is ``T(n,k)=Number of (n+2)X(k+2) 0..2 arrays with no increasing sequence of length 3 horizontally or diagonally downwards.''. It has offset $1$, is
read by antidiagonals, and begins
\[
17064, 395955, 430608, 9120456, 27826929, 10864544, 209902869, 1777375908,\ \dots
\]
The entry carries the following block:
\begin{quote}\small
Empirical for column k:\\
k=1: a(n) = 26*a(n-1) -16*a(n-2) -88*a(n-3) +48*a(n-4)\\
k=2: [order 7]\\
k=3: [order 12]\\
k=4: [order 26]\\
k=5: [order 51]\\
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 08:07:36, revision 6) these are still
...
The sequence is ``Number of (n+2)X3 0..2 arrays with no increasing sequence of length 3 horizontally or diagonally downwards.''. Its rows are the vertices of a digraph on
...
\[
a(n)\;=\;26\,a(n-1) - 16\,a(n-2) - 88\,a(n-3) + 48\,a(n-4)
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A233618.
