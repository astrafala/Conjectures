...
\title{The empirical recurrence for OEIS A208196, proved by counting patterns}
...
\begin{abstract}
OEIS A208196 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A208196 is ``Number of n X 3 0..3 arrays with new values 0..3 introduced in row major order and no element equal to more than two of its immediate leftward or upward or left-upward diagonal neighbors.''. It has offset $1$ and begins
\[
5, 178, 10366, 639701, 39725054, 2468504665, 153402542384, 9533100532733,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 66*a(n-1) - 222*a(n-2) - 1100*a(n-3) + 363*a(n-4) + 594*a(n-5) - 216*a(n-6) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 29 2018 06:42:30, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208196.
