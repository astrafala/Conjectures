...
\title{The empirical recurrence for OEIS A274800, proved by counting patterns}
...
\begin{abstract}
OEIS A274800 counts arrays in which no entry may repeat a value found at any of three stated
...
OEIS A274800 is ``Number of n X 5 0..2 arrays with no element equal to any value at offset (-1,-2) (-2,-1) (0,-1) or (-1,0) and new values introduced in order 0..2.''. It has offset $1$ and begins
\[
8, 60, 420, 3104, 22988, 169328, 1252608, 9243332,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) + 35*a(n-2) + 42*a(n-3) - 41*a(n-4) - 60*a(n-5) - 23*a(n-6) - 2*a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 31 2019 08:06:26, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 35\,a(n-2) + 42\,a(n-3) - 41\,a(n-4) - 60\,a(n-5) - 23\,a(n-6) - 2\,a(n-7)
\end{equation}
for all $n>8$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A274800.
