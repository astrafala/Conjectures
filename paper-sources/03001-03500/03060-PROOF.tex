...
\title{The empirical recurrence for OEIS A224582, proved by transfer matrix}
...
\begin{abstract}
OEIS A224582 counts the $(n+6)\times8$ matrices over $\{0,\dots,1\}$ all of whose
...
makes $a(n)$ a walk count on $S=208746$ vertices, hence $C$-finite, and whether the conjectured
...
OEIS A224582 is ``Number of (n+6)X8 0..1 matrices with each 7X7 subblock idempotent.''. It has offset $1$ and begins
\[
164935, 26918, 22928, 24643, 26542, 27611, 28629, 29006,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 23:29:09, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{The count is a walk count}

Call a $7\times7$ matrix over $\{0,\dots,1\}$ a \emph{window} when it is idempotent, and
call a $7\times8$ matrix a \emph{band} when every one of its $2$ contiguous
$7\times7$ subblocks is a window. What the entry counts is the matrices of $8$ columns
whose every $7$ consecutive rows form a band.

Take as states the $6\times8$ strips that occur as the top $6$ rows of a band,
...
\]
with $M$ the adjacency matrix on $S=208746$ states. In particular $a$ is $C$-finite. The
alignment was checked against the entry's published terms rather than assumed.

There are $(1 + 1)^{48}$ strips of $6$ rows and $8$ columns, far too
many to test one by one, and they are not tested one by one. Two consecutive windows of a band
overlap in $7\times6$ entries, so a band is exactly a walk of $2$ windows in
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) - 5\,a(n-2) + 7\,a(n-3) - 9\,a(n-4) + 11\,a(n-5) - 12\,a(n-6) + 13\,a(n-7) - 13\,a(n-8) + 12\,a(n-9) - 10\,a(n-10) + 7\,a(n-11) - 4\,a(n-12) + 3\,a(n-14) - 6\,a(n-15) + 8\,a(n-16) - 10\,a(n-17) + 11\,a(n-18) - 11\,a(n-19) + 11\,a(n-20) - 10\,a(n-21) + 9\,a(n-22) - 7\,a(n-23) + 6\,a(n-24) - 5\,a(n-25) + 4\,a(n-26) - 3\,a(n-27) + 2\,a(n-28) - a(n-29)
\]
for every $n>39$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224582.
