...
\title{The empirical column recurrences for the table OEIS A233818}
...
\begin{abstract}
OEIS A233818 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A233818 is ``T(n,k)=Number of (n+1)X(k+1) 0..5 arrays with every 2X2 subblock having the sum of the squares of all six edge and diagonal differences equal to 11 (11 maximizes T(1,1)).''. It has offset $1$, is
read by antidiagonals, and begins
\[
96, 428, 428, 1824, 2216, 1824, 8136, 10972,\ \dots
\]
...
k=3: [order 78]\\
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 09:01:24, revision 6) these are still
...
The sequence is ``Number of (n+1)X2 0..5 arrays with every 2X2 subblock having the sum of the squares of all six edge and diagonal differences equal to 11.''. Its rows are the vertices of a digraph on
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A233818.
