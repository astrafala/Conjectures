...
\title{The empirical recurrence for OEIS A280854, proved by transfer matrix}
...
\begin{abstract}
OEIS A280854 counts $n\times3$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A280854 is ``Number of n X 3 0..2 arrays with no element equal to more than one of its king-move neighbors and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
4, 29, 46, 96, 256, 678, 1698, 4358,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + 4*a(n-3) - a(n-4) + 2*a(n-6) - 2*a(n-7) for n>9.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 14 2019 10:07:43, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 4\,a(n-3) - a(n-4) + 2\,a(n-6) - 2\,a(n-7)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A280854.
