...
\title{The empirical closed form for OEIS A223776, proved}
...
\begin{abstract}
OEIS A223776 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
$S=3712$ vertices. Any function of the form $\sum_j p_j(n)\lambda_j^{\,n}$ satisfies the
...
OEIS A223776 is ``Number of nX7 0..1 arrays with rows and columns unimodal and antidiagonals nondecreasing.''. It has offset $1$ and begins
\[
29, 267, 1269, 4246, 11635, 28346, 64256, 138913,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 22:25:07, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\begin{multline*}
f(n)\;=\;\frac{n^{14}}{87178291200} + \frac{n^{13}}{4151347200} \\
+ \frac{n^{12}}{106444800} + \frac{53 n^{11}}{319334400} \\
+ \frac{409 n^{10}}{87091200} + \frac{1681 n^{9}}{29030400} \\
+ \frac{862999 n^{8}}{609638400} - \frac{56411 n^{7}}{29030400} \\
+ \frac{3673639 n^{6}}{14515200} - \frac{4250857 n^{5}}{7257600} \\
+ \frac{1960444733 n^{4}}{119750400} - \frac{326164913 n^{3}}{4989600} \\
+ \frac{89807927381 n^{2}}{151351200} - \frac{113103797 n}{51480} \\
+ 3030.
\end{multline*}
...
walk, so with $M$ the adjacency matrix of that digraph on $S=3712$ vertices, and $u,w$ the
...
$n=20,\dots,34$ and agree at each. A monic recurrence of order $15$
determines $a(m)$ from $a(m-1),\dots,a(m-15)$, and for every $m\ge35$ both
$m>19$ and $m-15\ge20$ hold, so induction on $m$ gives $a(m)=f(m)$ for every
$m\ge20$.
Below $n=20$ the recurrence argument gives nothing, since \eqref{eq:rec} is only
established for $a$ from $n=20$ on. The remaining indices $n=5,\dots,19$ were
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223776.
