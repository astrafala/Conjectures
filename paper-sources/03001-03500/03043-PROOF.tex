...
\title{The empirical closed form for OEIS A223766, proved}
...
\begin{abstract}
OEIS A223766 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A223766 is ``Number of n X 4 0..1 arrays with rows, columns and antidiagonals unimodal and diagonals nondecreasing.''. It has offset $1$ and begins
\[
11, 56, 155, 361, 782, 1601, 3141, 5907,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 04:29:25, revision 10) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{n^{8}}{40320} - \frac{n^{7}}{10080} + \frac{3 n^{6}}{320} + \frac{n^{5}}{45} + \frac{1109 n^{4}}{1920} - \frac{4837 n^{3}}{1440} + \frac{422483 n^{2}}{10080} - \frac{109337 n}{840} + 226.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223766.
