...
\title{The empirical recurrence for OEIS A252856, proved by transfer matrix}
...
\begin{abstract}
OEIS A252856 counts arrays of width $5$ over an alphabet of $3$ letters in which every three
...
OEIS A252856 is ``Number of (n+2) X (3+2) 0..2 arrays with every consecutive three elements in every row, column, diagonal and antidiagonal having exactly two distinct values, and new values 0 upwards introduced in row major order.''. It has offset $1$ and begins
\[
684, 738, 1197, 1962, 3582, 6795, 12762, 24552,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) - a(n-5) + a(n-6) - 2*a(n-7) + a(n-8) for n>10.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 07 2018 11:50:15, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) - a(n-5) + a(n-6) - 2\,a(n-7) + a(n-8)
\]
for every $n>10$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252856.
