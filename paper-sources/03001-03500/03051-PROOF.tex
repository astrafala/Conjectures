...
\title{The empirical recurrence for OEIS A210119, proved by counting patterns}
...
\begin{abstract}
OEIS A210119 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A210119 is ``Number of (n+1) X 3 0..3 arrays with every 2 X 2 subblock having two or four distinct values, and new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
44, 481, 5587, 67585, 836053, 10466659, 131849767, 1666227265,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 24*a(n-1) - 174*a(n-2) + 368*a(n-3) + 303*a(n-4) - 888*a(n-5) - 340*a(n-6) + 240*a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 14 2018 15:34:45, revision 11) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;24\,a(n-1) - 174\,a(n-2) + 368\,a(n-3) + 303\,a(n-4) - 888\,a(n-5) - 340\,a(n-6) + 240\,a(n-7)
\end{equation}
for all $n>7$.
...
\eqref{eq:walk}, divided by $4!$, was evaluated at every one of the $16$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A210119.
