...
\title{The empirical recurrence for OEIS A210303, proved by transfer matrix}
...
\begin{abstract}
OEIS A210303 counts arrays of width $3$ whose every $2\times2$ subblock holds a
prescribed number of DISTINCT values, which use ALL of the $4$ available letters, and which
are counted up to renaming. The entry carries an empirical recurrence of order $7$
...
OEIS A210303 is ``Number of (n+1)X3 0..3 arrays containing all values 0..3 with every 2X2 subblock having one or three distinct values, and new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
29, 1091, 27957, 655743, 14976529, 339125187, 7657326365, 172736626311,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 35*a(n-1) -315*a(n-2) +729*a(n-3) +1132*a(n-4) -3804*a(n-5) +688*a(n-6) +1536*a(n-7)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 15:53:19, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;35\,a(n-1) - 315\,a(n-2) + 729\,a(n-3) + 1132\,a(n-4) - 3804\,a(n-5) + 688\,a(n-6) + 1536\,a(n-7)
\]
for every $n>7$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A210303.
