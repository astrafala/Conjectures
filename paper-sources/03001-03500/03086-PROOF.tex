...
\title{The empirical recurrence for OEIS A240637, proved by transfer matrix}
...
\begin{abstract}
OEIS A240637 counts arrays of width $2$ over $\{0,\dots,3\}$ under a condition on each cell
...
OEIS A240637 is ``Number of n X 2 0..3 arrays with no element equal to one or three horizontal or vertical neighbors, with new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
1, 5, 27, 193, 1391, 10072, 72941, 528283,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 6*a(n-1) + 10*a(n-2) - 6*a(n-3) - 9*a(n-4) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 19 2018 13:22:18, revision 9) this is still
...
$1$, which the model reproduces along with every later term. That is the cheapest check
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) + 10\,a(n-2) - 6\,a(n-3) - 9\,a(n-4)
\]
for every $n>6$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A240637.
