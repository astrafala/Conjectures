...
\title{The empirical recurrence for OEIS A198535, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A198535 counts arrays in which every cell is constrained by its neighbours on \emph{both}
...
OEIS A198535 is ``Number of 2n X 2 0..4 arrays with values 0..4 introduced in row major order and each element equal to an even number of horizontal and vertical neighbors.''. It has offset $1$ and begins
\[
5, 404, 67442, 11739910, 2048681430, 357559607382, 62405998006614, 10891920070833494,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 189*a(n-1) -2572*a(n-2) +8272*a(n-3) -9984*a(n-4) +4096*a(n-5) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (May 14 2018 14:23:21, revision 10) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;189\,a(n-1) - 2572\,a(n-2) + 8272\,a(n-3) - 9984\,a(n-4) + 4096\,a(n-5)
\end{equation}
for all $n>6$.
...
\eqref{eq:walk2}, divided by $5!$, was evaluated at every one of the $12$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A198535.
