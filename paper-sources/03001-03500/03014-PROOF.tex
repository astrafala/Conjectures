...
\title{The empirical recurrence for OEIS A203536, proved by transfer matrix}
...
\begin{abstract}
OEIS A203536 counts arrays of width $2$ over $\{0,1,2\}$ in which every cell has neighbours equal to each of two named values. The entry carries an
...
OEIS A203536 is ``Number of nX2 0..2 arrays with every element neighboring horizontally or vertically both a 0 and a 1.''. It has offset $1$ and begins
\[
0, 4, 4, 16, 64, 196, 676, 2304,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) +3*a(n-2) +6*a(n-3) -a(n-4) -a(n-6)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 10:32:14, revision 13) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A203536.
