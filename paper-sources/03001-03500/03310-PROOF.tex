...
\title{The empirical recurrence for OEIS A267960, proved by transfer matrix}
...
\begin{abstract}
OEIS A267960 counts arrays in which the REPEATED VALUES of each row, and of each column, stand in a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 25 2018 15:14:44, revision 9) this is still
