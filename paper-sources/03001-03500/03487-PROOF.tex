...
\title{The empirical recurrence for OEIS A198978, proved by counting patterns}
...
\begin{abstract}
OEIS A198978 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A198978 is ``Number of nX4 0..5 arrays with values 0..5 introduced in row major order and no element equal to any horizontal or vertical neighbor.''. It has offset $1$ and begins
\[
5, 481, 146286, 53082012, 19622872903, 7267830860056, 2692353648978984, 997397244990907738,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 08:02:38, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;454\,a(n-1) - 33435\,a(n-2) + 955655\,a(n-3) - 13146749\,a(n-4) + 95351613\,a(n-5) - 373512375\,a(n-6) + 780821577\,a(n-7) - 866661210\,a(n-8) + 478426797\,a(n-9) - 102202326\,a(n-10)
\end{equation}
for all $n>10$.
...
\[
6!\Bigl(a(n)-\sum_i c_i\,a(n-i)\Bigr)\;=\;\mathbf{v}^{\!\top}N^{\,m-10}q(N)\mathbf{1} .
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A198978.
