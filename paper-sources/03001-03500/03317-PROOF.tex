...
\title{The empirical column recurrences for the table OEIS A258681}
...
\begin{abstract}
OEIS A258681 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A258681 is ``T(n,k)=Number of (n+2)X(k+2) 0..1 arrays with no 3x3 subblock diagonal sum equal to the antidiagonal sum.''. It has offset $1$, is
read by antidiagonals, and begins
\[
320, 1600, 1600, 8320, 10000, 8320, 43264, 67600,\ \dots
\]
The entry carries the following block:
\begin{quote}\small
Empirical for column k:\\
k=1: a(n) = 2*a(n-1) +32*a(n-3) +256*a(n-4)\\
k=2: [order 8]\\
k=3: [order 30]\\
k=4: [order 27]\\
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 15:30:35, revision 6) these are still
...
The sequence is ``Number of (n+2)X3 0..1 arrays with no 3x3 subblock diagonal sum equal to the antidiagonal sum.''. Its rows are the vertices of a digraph on
...
\[
a(n)\;=\;2\,a(n-1) + 32\,a(n-3) + 256\,a(n-4)
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A258681.
