...
\title{The empirical closed form for OEIS A222156, proved}
...
\begin{abstract}
OEIS A222156 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
$S=24$ vertices. Any function of the form $\sum_j p_j(n)\lambda_j^{\,n}$ satisfies the
...
OEIS A222156 is ``Number of n X 4 arrays with each row a permutation of 1..4 having at least as many downsteps as the preceding row, with rows in lexicographically nondecreasing order.''. It has offset $1$ and begins
\[
24, 277, 2132, 12521, 60344, 249641, 913748, 3023603,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 15 2023 14:34:45, revision 7) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\begin{multline*}
f(n)\;=\;\frac{n^{18}}{3201186852864000} + \frac{n^{17}}{19760412672000} \\
+ \frac{251 n^{16}}{62768369664000} + \frac{29 n^{15}}{145297152000} \\
+ \frac{217031 n^{14}}{31384184832000} + \frac{43447 n^{13}}{249080832000} \\
+ \frac{2169611 n^{12}}{658409472000} + \frac{3183331 n^{11}}{67060224000} \\
+ \frac{231419681 n^{10}}{438939648000} + \frac{36901183 n^{9}}{8128512000} \\
+ \frac{146423897891 n^{8}}{4828336128000} + \frac{1499409367 n^{7}}{9580032000} \\
+ \frac{14551383635479 n^{6}}{23538138624000} + \frac{400802254661 n^{5}}{217945728000} \\
+ \frac{5254041870533 n^{4}}{1307674368000} + \frac{112591393237 n^{3}}{18162144000} \\
+ \frac{17776195417 n^{2}}{2806876800} + \frac{46566643 n}{12252240} \\
+ 1.
\end{multline*}
...
walk, so with $M$ the adjacency matrix of that digraph on $S=24$ vertices, and $u,w$ the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A222156.
