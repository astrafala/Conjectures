...
\title{The empirical recurrence for OEIS A233153, proved by transfer matrix}
...
\begin{abstract}
OEIS A233153 counts arrays over $\{0,\dots,2\}$ in which no two entries that are neighbours in
...
carried by one bounded piece of extra state, so the count is a walk count on $S=8$ states.
\end{abstract}
...
OEIS A233153 is ``Number of n X 6 0..2 arrays with no element x(i,j) adjacent to value 2-x(i,j) horizontally or antidiagonally.''. It has offset $1$ and begins
\[
96, 1944, 40392, 842616, 17587584, 367125912, 7663517136, 159971190624,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 25*a(n-1) - 90*a(n-2) + 81*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 08 2018 10:20:08, revision 8) this is still
...
identified; after that identification there are $S=8$ of them.
...
\begin{theorem}
\[
a(n)\;=\;25\,a(n-1) - 90\,a(n-2) + 81\,a(n-3)
\]
for every $n>3$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A233153.
