...
\title{The empirical recurrence for OEIS A211576, proved by transfer matrix}
...
\begin{abstract}
OEIS A211576 carries an empirical recurrence of order $10$ contributed by R. H. Hardin. It is
...
OEIS A211576 is ``Number of -2..2 arrays x(i) of n+1 elements i=1..n+1 with set{t,u,v in 0,1}((x[i+t]+x[j+u]+x[k+v])*(-1)\^{}(t+u+v)) having four, five or six distinct values for every i,j,k<=n.''. It has offset $1$ and begins
\[
16, 48, 124, 294, 680, 1578, 3600, 8458,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 19 2018 09:49:37, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + 7\,a(n-2) - 45\,a(n-3) + 10\,a(n-4) + 155\,a(n-5) - 130\,a(n-6) - 180\,a(n-7) + 216\,a(n-8) + 36\,a(n-9) - 72\,a(n-10)
\]
for every $n>10$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A211576.
