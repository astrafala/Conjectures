...
\title{The empirical recurrence for OEIS A269094, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A269094 counts arrays over $\{0,\dots,3\}$ subject to a condition on the array as a
...
OEIS A269094 is ``Number of nX5 0..3 arrays with some element plus some horizontally or vertically adjacent neighbor totalling three exactly once.''. It has offset $1$ and begins
\[
432, 103488, 15024096, 1856325000, 211625837280, 22984646281176, 2416707037884480, 248267055360211392,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 19 2016 09:48:52, revision 5) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;236\,a(n-1) - 19546\,a(n-2) + 707906\,a(n-3) - 13261621\,a(n-4) + 137719076\,a(n-5) - 784626841\,a(n-6) + 2025590366\,a(n-7) + 1091882414\,a(n-8) - 18874661724\,a(n-9) + 33829878231\,a(n-10) + 10605114324\,a(n-11) - 91783964484\,a(n-12) + 94503314304\,a(n-13) - 30762353664\,a(n-14)
\end{equation}
for all $n>15$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269094.
