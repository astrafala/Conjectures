...
\title{The empirical recurrence for OEIS A275223, proved by counting patterns}
...
\begin{abstract}
OEIS A275223 counts arrays in which no entry may repeat a value found at any of three stated
...
OEIS A275223 is ``Number of nX3 0..2 arrays with no element equal to any value at offset (-2,-1) (-2,1) or (-1,0) and new values introduced in order 0..2.''. It has offset $1$ and begins
\[
5, 36, 61, 187, 648, 2282, 8134, 29027,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) +5*a(n-2) -10*a(n-3) -a(n-4) -10*a(n-5) +21*a(n-6) -4*a(n-7) -4*a(n-8) +a(n-9) for n>13
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 20 2016 18:24:41, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 5\,a(n-2) - 10\,a(n-3) - a(n-4) - 10\,a(n-5) + 21\,a(n-6) - 4\,a(n-7) - 4\,a(n-8) + a(n-9)
\end{equation}
for all $n>13$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A275223.
