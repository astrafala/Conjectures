...
\title{The empirical recurrence for OEIS A209841, proved by counting patterns}
...
\begin{abstract}
OEIS A209841 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A209841 is ``Number of (n+1) X 2 0..3 arrays with every 2 X 2 subblock having one or two distinct values, and new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
8, 41, 227, 1331, 8123, 50987, 326123, 2111531,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 11*a(n-1) - 30*a(n-2) + 4*a(n-3) + 16*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 13 2018 05:48:04, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;11\,a(n-1) - 30\,a(n-2) + 4\,a(n-3) + 16\,a(n-4)
\end{equation}
for all $n>3$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209841.
