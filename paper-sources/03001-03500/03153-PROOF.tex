...
\title{The empirical recurrence for OEIS A211693, proved by transfer matrix}
...
\begin{abstract}
OEIS A211693 carries an empirical recurrence of order $9$ contributed by R. H. Hardin. It is
...
OEIS A211693 is ``Number of -4..4 arrays x(i) of n+1 elements i=1..n+1 with x(i)+x(j), x(i+1)+x(j+1), -(x(i)+x(j+1)), and -(x(i+1)+x(j)) having two, three or four distinct values for every i<=n and j<=n.''. It has offset $1$ and begins
\[
80, 712, 6328, 56184, 498328, 4415576, 39087704, 345688344,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 16:17:28, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;40\,a(n-1) - 630\,a(n-2) + 4800\,a(n-3) - 16675\,a(n-4) + 13128\,a(n-5) + 34290\,a(n-6) + 17120\,a(n-7) + 3176\,a(n-8) + 192\,a(n-9)
\]
for every $n>0$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A211693.
