...
\title{The conjectured generating function for OEIS A184138, proved}
...
\begin{abstract}
OEIS A184138 counts arrays of a fixed width under a local condition, and carries a conjectured
...
coefficients of their expansions do. Comparing $50$ coefficients in exact arithmetic
...
OEIS A184138 is ``Number of n X 3 binary arrays with rows and columns in nondecreasing order.''. It has offset $1$ and begins
\[
4, 14, 45, 130, 336, 785,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 13 2026 15:26:19, revision 14) this is still
...
exact integer arithmetic, those of $N_2/D_2$ by exact rational long division, and $50$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A184138.
