...
\title{The empirical recurrence for OEIS A224369, proved by transfer matrix}
...
\begin{abstract}
OEIS A224369 counts arrays over $\{0,\dots,2\}$ whose rows, columns, diagonals or
...
OEIS A224369 is ``Number of n X 3 0..2 arrays with rows unimodal and antidiagonals nondecreasing.''. It has offset $1$ and begins
\[
22, 218, 1838, 15540, 132236, 1126072, 9588028, 81634704,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 10*a(n-1) - 16*a(n-2) + 30*a(n-3) - 14*a(n-4) + 12*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 30 2018 06:07:18, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224369.
