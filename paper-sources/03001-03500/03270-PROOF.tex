...
\title{The empirical closed form for OEIS A223764, proved}
...
\begin{abstract}
OEIS A223764 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A223764 is ``Number of n X 2 0..1 arrays with rows, columns and antidiagonals unimodal and diagonals nondecreasing.''. It has offset $1$ and begins
\[
4, 12, 28, 56, 101, 169, 267, 403,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (1/24)*n\^{}4 + (1/4)*n\^{}3 + (35/24)*n\^{}2 + (5/4)*n + 1.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 21 2018 11:57:38, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{n^{4}}{24} + \frac{n^{3}}{4} + \frac{35 n^{2}}{24} + \frac{5 n}{4} + 1.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223764.
