...
\title{The empirical recurrence for OEIS A189439, proved by transfer matrix}
...
\begin{abstract}
OEIS A189439 counts the permutations of the cells of an $n\times7$ array in which every cell
...
That makes $a$ a walk count on $S=570$ states, hence $C$-finite, and whether the published
...
OEIS A189439 is ``Number of 7Xn array permutations with each element not moving, or moving one space N, SW or SE.''. It has offset $1$ and begins
\[
1, 85, 1245, 26589, 493941, 9557077, 181540773, 3467525301,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 05:13:42, revision 9) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

Write the cells of the array as pairs $(i,j)$ with $0\le i<n$ and $0\le j<7$. An
...
Equivalently, $a(n)$ is the permanent of the $n7\times n7$ matrix whose $(c,c')$ entry is
$1$ exactly when $c'-c\in\Delta$.

\section{A window of 15 positions}

Number the cells in row-major order, $k=i\cdot7+j$. An offset $(\delta_1,\delta_2)$ moves a
cell by $\delta_17+\delta_2$ places in that order, so every image lies between $lo=-6$ and
$hi=8$ places from its source. Process the cells in order and let each one choose its image.
Once the cell at position $k$ has been dealt with, the position $k+-6$ can never be chosen
again by anybody, so it must already be taken; and no position beyond $k+8$ can have been
taken yet. What has to be remembered is therefore exactly which of the $15$ positions
$k+-6,\dots,k+8$ are taken --- a subset of a set of size $15$, and nothing else.

That is the state. One step of the walk is one row, that is $7$ cell choices, and the
...
\begin{theorem}
\[
a(n)\;=\;23\,a(n-1) + 26\,a(n-2) - 2256\,a(n-3) + 3272\,a(n-4) + 63936\,a(n-5) - 101752\,a(n-6) - 714624\,a(n-7) + 1041216\,a(n-8) + 3522752\,a(n-9) - 4444032\,a(n-10) - 7691264\,a(n-11) + 5545472\,a(n-12) + 11157504\,a(n-13) - 4947968\,a(n-14) - 4030464\,a(n-15)
\]
for every $n>14$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A189439.
