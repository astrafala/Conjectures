...
\title{The empirical column recurrences for the table OEIS A251410}
...
\begin{abstract}
OEIS A251410 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A251410 is ``T(n,k)=Number of (n+1)X(k+1) 0..2 arrays with every 2X2 subblock summing to a prime.''. It has offset $1$, is
read by antidiagonals, and begins
\[
46, 238, 238, 1230, 2164, 1230, 6370, 19654,\ \dots
\]
The entry carries the following block:
\begin{quote}\small
Empirical for column k:\\
k=1: a(n) = 2*a(n-1) +21*a(n-2) -14*a(n-3) -52*a(n-4) +12*a(n-5)\\
k=2: [order 12]\\
k=3: [order 37]\\
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:19:33, revision 6) these are still
...
The sequence is ``Number of (n+1)X(2) 0..2 arrays with every 2X2 subblock summing to a prime.''. Its rows are the vertices of a digraph on
...
\[
a(n)\;=\;2\,a(n-1) + 21\,a(n-2) - 14\,a(n-3) - 52\,a(n-4) + 12\,a(n-5)
\]
...
$c_{1}$ & $8$ & $c_{4}$ & $-649$ & $c_{7}$ & $-23417$ & $c_{10}$ & $-7348$ \\
$c_{2}$ & $60$ & $c_{5}$ & $5937$ & $c_{8}$ & $4582$ & $c_{11}$ & $-1208$ \\
$c_{3}$ & $-452$ & $c_{6}$ & $916$ & $c_{9}$ & $26384$ & $c_{12}$ & $48$ \\
\end{tabular}\end{center}
Repeating with the first $12+4$ terms removed gives order $12$ again.

\subsection*{Column $k=3$, recovered}
The entry gives only the order for this line: ``k=3: [order 37]''. Its model is a walk on
...
$37$ --- the stated order --- with integer coefficients
\[
(c_1,\dots,c_{37})=(7,\ 415,\ -2170,\ -65018,\ 279158,\ 5209878,\ -19110091,\ -241884065,\ 770936285,\ 6925377809,\ -19408276678,\ -126423709248,\ 316443716761,\ 1497304356328,\ -3412859931553,\ -11572642532092,\ 24480490792547,\ 58017621913005,\ -115645342019311,\ -185048719496534,\ 350615451009020,\ 363598533038691,\ -653187102277345,\ -423563887277148,\ 702290291166770,\ 283913177157700,\ -400320176322800,\ -106630599041392,\ 108533272966240,\ 18430917299936,\ -12244527293952,\ -1022082252800,\ 426212623232,\ 14250333696,\ -4553766400,\ -32858112,\ 9977856).
\]
Repeating with the first $37+4$ terms removed gives order $37$ again.
...
model reproduces $8$ published values, $37$ decimal digits in all, every one of
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251410.
