...
\title{The empirical recurrence for OEIS A267947, proved by transfer matrix}
...
\begin{abstract}
OEIS A267947 counts arrays in which the REPEATED VALUES of each row, and of each column, stand in a
...
OEIS A267947 is ``Number of n X 2 0..2 arrays with every repeated value in every row and column one larger mod 3 than the previous repeated value, and upper left element zero.''. It has offset $1$ and begins
\[
3, 27, 192, 1323, 8427, 52272, 312987, 1839267,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 10*a(n-1) - 8*a(n-2) - 163*a(n-3) + 306*a(n-4) + 684*a(n-5) - 1296*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 21 2018 09:39:34, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;10\,a(n-1) - 8\,a(n-2) - 163\,a(n-3) + 306\,a(n-4) + 684\,a(n-5) - 1296\,a(n-6)
\]
for every $n>6$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267947.
