...
\title{The empirical closed form for OEIS A223720, proved}
...
\begin{abstract}
OEIS A223720 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A223720 is ``Number of n X 3 0..2 arrays with rows, antidiagonals and columns unimodal.''. It has offset $1$ and begins
\[
22, 484, 5883, 46613, 273562, 1285547, 5087912, 17557701,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 20 2024 16:38:52, revision 6) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{5051 n^{12}}{239500800} + \frac{61 n^{11}}{177408} + \frac{91271 n^{10}}{21772800} + \frac{27 n^{9}}{896} + \frac{1198121 n^{8}}{7257600} + \frac{1087 n^{7}}{1792} + \frac{36617153 n^{6}}{21772800} + \frac{63719 n^{5}}{20160} + \frac{26821099 n^{4}}{5443200} + \frac{305 n^{3}}{56} + \frac{149993 n^{2}}{207900} + \frac{3277 n}{770} + 1.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223720.
