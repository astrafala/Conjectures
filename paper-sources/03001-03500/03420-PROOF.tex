...
\title{The empirical closed form for OEIS A224039, proved}
...
\begin{abstract}
OEIS A224039 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A224039 is ``Number of 3 X n 0..1 arrays with antidiagonals unimodal and rows and diagonals nondecreasing.''. It has offset $1$ and begins
\[
8, 21, 37, 58, 85, 119, 161, 212,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (1/6)*n\^{}3 + 1*n\^{}2 + (47/6)*n for n>1.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 26 2018 11:11:16, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{n^{3}}{6} + n^{2} + \frac{47 n}{6}.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224039.
