...
\title{The conjectured generating function for OEIS A250874, proved}
...
\begin{abstract}
OEIS A250874 counts arrays of a fixed width under a local condition, and carries a conjectured
...
OEIS A250874 is ``Number of (n+1) X (5+1) 0..3 arrays with nondecreasing x(i,j)-x(i,j-1) in the i direction and nondecreasing x(i,j)+x(i-1,j) in the j direction.''. It has offset $1$ and begins
\[
2306, 11644, 55386, 250964, 1097986, 4685964,\ \dots
\]
The entry states, as a conjecture contributed by a reader and never marked settled:
\begin{quote}
Empirical g.f.: 2*x*(1153 - 5708*x + 9828*x\^{}2 - 5328*x\^{}3) / ((1 - x)*(1 - 2*x)*(1 - 3*x)*(1 - 4*x)). - \_Colin Barker\_, Nov 22 2018
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 22 2018 11:33:38, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250874.
