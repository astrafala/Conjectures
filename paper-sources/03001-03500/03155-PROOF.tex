...
\title{The empirical recurrence for OEIS A210128, proved by counting patterns}
...
\begin{abstract}
OEIS A210128 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A210128 is ``Number of (n+1) X 3 0..3 arrays with every 2 X 2 subblock having one, three or four distinct values, and new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
81, 2609, 84381, 2731088, 88392872, 2860882075, 92593947153, 2996851648908,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 35*a(n-1) - 81*a(n-2) - 153*a(n-3) + 492*a(n-4) - 292*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 14 2018 15:35:02, revision 11) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;35\,a(n-1) - 81\,a(n-2) - 153\,a(n-3) + 492\,a(n-4) - 292\,a(n-5)
\end{equation}
for all $n>5$.
...
\#\{\alpha,\beta,\gamma,\delta\}\in\{1,3,4\}.
\end{equation}
...
\[
4!\Bigl(a(n)-\sum_i c_i\,a(n-i)\Bigr)\;=\;\mathbf{v}^{\!\top}N^{\,m-5}q(N)\mathbf{1} .
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A210128.
