...
\title{The empirical recurrence for OEIS A211578, proved by transfer matrix}
...
\begin{abstract}
OEIS A211578 carries an empirical recurrence of order $8$ contributed by R. H. Hardin. It is
...
OEIS A211578 is ``Number of -2..2 arrays x(i) of n+1 elements i=1..n+1 with set{t,u,v in 0,1}((x[i+t]+x[j+u]+x[k+v])*(-1)\^{}(t+u+v)) having three, four, five or six distinct values for every i,j,k<=n.''. It has offset $1$ and begins
\[
16, 52, 144, 380, 964, 2456, 6124, 15508,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + 12*a(n-2) - 21*a(n-3) - 48*a(n-4) + 64*a(n-5) + 80*a(n-6) - 60*a(n-7) - 48*a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 19 2018 14:53:38, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 12\,a(n-2) - 21\,a(n-3) - 48\,a(n-4) + 64\,a(n-5) + 80\,a(n-6) - 60\,a(n-7) - 48\,a(n-8)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A211578.
