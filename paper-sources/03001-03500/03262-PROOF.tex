...
\title{The empirical recurrence for OEIS A211463, proved by transfer matrix}
...
\begin{abstract}
OEIS A211463 carries an empirical recurrence of order $8$ contributed by R. H. Hardin. It is
...
OEIS A211463 is ``Number of -2..2 arrays x(i) of n+1 elements i=1..n+1 with x(i)+x(j), x(i+1)+x(j+1), -(x(i)+x(j+1)), and -(x(i+1)+x(j)) having three or four distinct values for every i<=n and j<=n.''. It has offset $1$ and begins
\[
20, 80, 304, 1144, 4232, 15536, 56616, 205400,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 5*a(n-1) + 9*a(n-2) - 57*a(n-3) - 36*a(n-4) + 196*a(n-5) + 96*a(n-6) - 124*a(n-7) + 24*a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 17 2018 15:44:51, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) + 9\,a(n-2) - 57\,a(n-3) - 36\,a(n-4) + 196\,a(n-5) + 96\,a(n-6) - 124\,a(n-7) + 24\,a(n-8)
\]
for every $n>0$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A211463.
