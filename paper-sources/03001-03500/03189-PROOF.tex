...
\title{The empirical recurrence for OEIS A203710, proved by transfer matrix}
...
\begin{abstract}
OEIS A203710 counts arrays of width $2$ over $\{0,1,\dots,5\}$ through two derived arrays of PAIR SUMS ---
...
OEIS A203710 is ``Number of (n+1)X2 0..5 arrays with column and row pair sums b(i,j)=a(i,j)+a(i,j-1) and c(i,j)=a(i,j)+a(i-1,j) such that rows of b(i,j) and columns of c(i,j) are lexicographically nondecreasing.''. It has offset $1$ and begins
\[
406, 5411, 64568, 680400, 6489940, 57269565, 475164554, 3751457500,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 10:39:41, revision 10) this is still
...
\begin{theorem}
\[
a(n)\;=\;40\,a(n-1) - 725\,a(n-2) + 7890\,a(n-3) - 57598\,a(n-4) + 298496\,a(n-5) - 1133650\,a(n-6) + 3211340\,a(n-7) - 6839701\,a(n-8) + 10954608\,a(n-9) - 13092665\,a(n-10) + 11477170\,a(n-11) - 7151500\,a(n-12) + 2994456\,a(n-13) - 754560\,a(n-14) + 86400\,a(n-15)
\]
for every $n>14$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A203710.
