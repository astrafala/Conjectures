...
\title{The empirical recurrence for OEIS A275144, proved by counting patterns}
...
\begin{abstract}
OEIS A275144 counts arrays in which no entry may repeat a value found at any of three stated
...
OEIS A275144 is ``Number of 4 X n 0..2 arrays with no element equal to any value at offset (-2,-2) (-1,-2) or (0,-1) and new values introduced in order 0..2.''. It has offset $1$ and begins
\[
14, 216, 400, 1088, 2320, 6464, 17872, 49792,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 5*a(n-1) - 9*a(n-2) + 10*a(n-3) - 6*a(n-4) + a(n-5) for n>9.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 01 2019 05:03:46, revision 7) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A275144.
