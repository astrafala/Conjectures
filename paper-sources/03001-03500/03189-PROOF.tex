...
\title{The empirical column recurrences for the table OEIS A251028}
...
\begin{abstract}
OEIS A251028 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A251028 is ``T(n,k)=Number of (n+1)X(k+1) 0..3 arrays with no 2X2 subblock having the sum of its diagonal elements greater than the maximum of its antidiagonal elements.''. It has offset $1$, is
read by antidiagonals, and begins
\[
110, 526, 526, 1966, 2546, 1966, 6321, 8207,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:00:50, revision 8) these are still
...
The sequence is ``Number of (n+1)X(2) 0..3 arrays with no 2X2 subblock having the sum of its diagonal elements greater than the maximum of its antidiagonal elements.''. Its rows are the vertices of a digraph on
...
values, $49$ decimal digits in all, every one of them exactly; a misreading of the entry
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251028.
