...
\title{The empirical column recurrences for the table OEIS A234549}
...
\begin{abstract}
OEIS A234549 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A234549 is ``T(n,k) is the number of (n+1) X (k+1) 0..5 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 3 (constant-stress 1 X 1 tilings).''. It has offset $1$, is
read by antidiagonals, and begins
\[
208, 1212, 1212, 7056, 6896, 7056, 41112, 39188,\ \dots
\]
The entry carries the following block:
\begin{quote}\small
Empirical for column k:\\
k=1: a(n) = 6*a(n-1) +34*a(n-2) -204*a(n-3) -40*a(n-4) +240*a(n-5).\\
k=2: [order 15].\\
k=3: [order 49].\\
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 20 2022 20:47:39, revision 7) these are still
...
The sequence is ``Number of (n+1) X (2) 0..5 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 3 (constant-stress 1 X 1 tilings).''. Its rows are the vertices of a digraph on
...
\[
a(n)\;=\;6\,a(n-1) + 34\,a(n-2) - 204\,a(n-3) - 40\,a(n-4) + 240\,a(n-5)
\]
...
$c_{1}$ & $17$ & $c_{5}$ & $8720$ & $c_{9}$ & $-632528$ & $c_{13}$ & $-478976$ \\
$c_{2}$ & $-30$ & $c_{6}$ & $-112704$ & $c_{10}$ & $-548544$ & $c_{14}$ & $-76800$ \\
$c_{3}$ & $-944$ & $c_{7}$ & $148224$ & $c_{11}$ & $867968$ & $c_{15}$ & $92160$ \\
$c_{4}$ & $5146$ & $c_{8}$ & $392632$ & $c_{12}$ & $341120$ &  &  \\
...
model reproduces $8$ published values, $44$ decimal digits in all, every one of
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234549.
