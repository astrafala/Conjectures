...
\title{The empirical recurrence for OEIS A267730, proved by transfer matrix}
...
\begin{abstract}
OEIS A267730 counts arrays in which the REPEATED VALUES of each row, and of each column, stand in a
...
value so far in each column of the scan, so the count is a walk count on $S=217$ states.
\end{abstract}
...
OEIS A267730 is ``Number of nX3 0..1 arrays with every repeated value in every row and column greater than or equal to the previous repeated value.''. It has offset $1$ and begins
\[
8, 64, 512, 3375, 21952, 132651, 778688, 4410944,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 20 2016 07:03:41, revision 4) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=217,\quad\tau=\mathbf{1} .
\]
...
\begin{theorem}
\[
a(n)\;=\;12\,a(n-1) - 30\,a(n-2) - 120\,a(n-3) + 455\,a(n-4) + 576\,a(n-5) - 2142\,a(n-6) - 1980\,a(n-7) + 3180\,a(n-8) + 1980\,a(n-9) - 2142\,a(n-10) - 576\,a(n-11) + 455\,a(n-12) + 120\,a(n-13) - 30\,a(n-14) - 12\,a(n-15) - a(n-16)
\]
for every $n>15$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267730.
