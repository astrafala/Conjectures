...
\title{The empirical recurrence for OEIS A269210, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A269210 counts arrays over $\{0,\dots,3\}$ subject to a condition on the array as a
...
OEIS A269210 is ``Number of n X 4 0..3 arrays with some element plus some horizontally, diagonally or antidiagonally adjacent neighbor totalling three exactly once.''. It has offset $1$ and begins
\[
108, 6528, 308544, 12548544, 474091776, 17118725376, 599456856000, 20531285093184,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 62*a(n-1) - 1031*a(n-2) + 2180*a(n-3) - 1535*a(n-4) + 350*a(n-5) - 25*a(n-6) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 20 2019 08:56:48, revision 9) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269210.
