...
\title{The empirical recurrence for OEIS A269181, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A269181 counts arrays over $\{0,\dots,3\}$ subject to a condition on the array as a
...
OEIS A269181 is ``Number of nX3 0..3 arrays with some element plus some horizontally, diagonally, antidiagonally or vertically adjacent neighbor totalling three exactly once.''. It has offset $1$ and begins
\[
24, 384, 5888, 80112, 1031344, 12791896, 154606864, 1833130768,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 22*a(n-1) -131*a(n-2) +88*a(n-3) +221*a(n-4) -154*a(n-5) -101*a(n-6) +44*a(n-7) -4*a(n-8) for n>9
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 20 2016 09:11:10, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;22\,a(n-1) - 131\,a(n-2) + 88\,a(n-3) + 221\,a(n-4) - 154\,a(n-5) - 101\,a(n-6) + 44\,a(n-7) - 4\,a(n-8)
\end{equation}
for all $n>9$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269181.
