...
\title{The empirical recurrence for OEIS A197056, proved by transfer matrix}
...
\begin{abstract}
OEIS A197056 counts arrays of width $3$ in which every entry is equal to the NUMBER of its own
...
OEIS A197056 is ``Number of nX3 0..4 arrays with each element equal to the number its horizontal and vertical neighbors equal to 2.''. It has offset $1$ and begins
\[
1, 3, 6, 10, 14, 22, 38, 67,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) +2*a(n-4) +a(n-5) +a(n-6)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 06:55:26, revision 9) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A197056.
