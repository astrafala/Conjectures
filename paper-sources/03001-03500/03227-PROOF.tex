...
\title{The empirical column recurrences for the table OEIS A259770}
...
\begin{abstract}
OEIS A259770 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A259770 is ``T(n,k)=Number of (n+2)X(k+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000001 or 00000101.''. It has offset $1$, is
read by antidiagonals, and begins
\[
32, 49, 49, 104, 87, 104, 201, 167,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:55:16, revision 6) these are still
...
The sequence is ``Number of (n+2)X(3) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000001 or 00000101.''. Its rows are the vertices of a digraph on
...
\[
a(n)\;=\;a(n-2) + 2\,a(n-3) + 6\,a(n-4) + 2\,a(n-5) - a(n-6) + 2\,a(n-7) - a(n-8)
\]
...
model reproduces $10$ published values, $33$ decimal digits in all, every one of
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A259770.
