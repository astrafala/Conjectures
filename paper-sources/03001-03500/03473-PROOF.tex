...
\title{The empirical column recurrences for the table OEIS A234036}
...
\begin{abstract}
OEIS A234036 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A234036 is ``T(n,k)=Number of (n+1)X(k+1) 0..4 arrays with every 2X2 subblock having the absolute values of all six edge and diagonal differences no larger than 1.''. It has offset $1$, is
read by antidiagonals, and begins
\[
61, 307, 307, 1543, 3059, 1543, 7783, 30263,\ \dots
\]
The entry carries the following block:
\begin{quote}\small
Empirical for column k:\\
k=1: a(n) = 7*a(n-1) -6*a(n-2) -18*a(n-3) -6*a(n-4)\\
k=2: [order 9]\\
k=3: [order 16]\\
k=4: [order 44]\\
k=5: [order 95]\\
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 09:09:04, revision 6) these are still
...
The sequence is ``Number of (n+1)X(2) 0..4 arrays with every 2X2 subblock having the absolute values of all six edge and diagonal differences no larger than 1.''. Its rows are the vertices of a digraph on
...
\[
a(n)\;=\;7\,a(n-1) - 6\,a(n-2) - 18\,a(n-3) - 6\,a(n-4)
\]
...
$c_{1}$ & $18$ & $c_{4}$ & $459$ & $c_{7}$ & $-88$ &  &  \\
$c_{2}$ & $-79$ & $c_{5}$ & $56$ & $c_{8}$ & $90$ &  &  \\
$c_{3}$ & $-56$ & $c_{6}$ & $-597$ & $c_{9}$ & $-10$ &  &  \\
...
\begin{center}\small\begin{tabular}{cccccccc}
$c_{1}$ & $41$ & $c_{5}$ & $-24456$ & $c_{9}$ & $180876$ & $c_{13}$ & $501820$ \\
$c_{2}$ & $-473$ & $c_{6}$ & $-191256$ & $c_{10}$ & $-2156866$ & $c_{14}$ & $-106672$ \\
$c_{3}$ & $378$ & $c_{7}$ & $160111$ & $c_{11}$ & $-1359614$ & $c_{15}$ & $-46728$ \\
$c_{4}$ & $15090$ & $c_{8}$ & $1124270$ & $c_{12}$ & $738304$ & $c_{16}$ & $7920$ \\
\end{tabular}\end{center}
...
model reproduces $8$ published values, $38$ decimal digits in all, every one of
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234036.
