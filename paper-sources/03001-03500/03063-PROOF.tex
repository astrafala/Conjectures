...
\title{The empirical recurrence for OEIS A275187, proved by transfer matrix}
...
\begin{abstract}
OEIS A275187 counts arrays in which no entry may equal the entries at a short list of fixed offsets
...
OEIS A275187 is ``Number of 7 X n 0..2 arrays with no element equal to any value at offset (-2,-1) (-1,0) or (-1,1) and new values introduced in order 0..2.''. It has offset $1$ and begins
\[
32, 65, 389, 2386, 14643, 90793, 561044, 3472521,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + 20*a(n-2) + 43*a(n-3) - 20*a(n-4) - 92*a(n-5) - 176*a(n-6) - 16*a(n-7) - 16*a(n-8) + 64*a(n-9) for n>10.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 01 2019 11:55:28, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 20\,a(n-2) + 43\,a(n-3) - 20\,a(n-4) - 92\,a(n-5) - 176\,a(n-6) - 16\,a(n-7) - 16\,a(n-8) + 64\,a(n-9)
\]
for every $n>10$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A275187.
