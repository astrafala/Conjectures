...
\title{The empirical recurrence for OEIS A268901, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A268901 counts arrays over $\{0,\dots,2\}$ subject to a condition on the array as a
...
OEIS A268901 is ``Number of n X 5 0..2 arrays with some element plus some horizontally or antidiagonally adjacent neighbor totalling two exactly once.''. It has offset $1$ and begins
\[
96, 2664, 54936, 1004184, 17194680, 282550680, 4513169016, 70609114584,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 30*a(n-1) - 261*a(n-2) + 540*a(n-3) - 324*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 16 2019 09:23:30, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268901.
