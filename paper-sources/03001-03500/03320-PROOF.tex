...
\title{The empirical recurrence for OEIS A223507, proved by transfer matrix}
...
\begin{abstract}
OEIS A223507 counts the ways of writing the vertices of a fixed graph $G$ into an array of width
$4$ so that any two cells adjacent in one of the named directions carry vertices joined by an
edge of $G$; here $G$ is graph named in the entry. The entry carries an empirical recurrence of order $21$
...
single slice is a state and the count is a walk count on a finite digraph with $S=592$ vertices.
\end{abstract}
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 21:46:33, revision 8) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=592.
\]
...
\begin{theorem}
\[
a(n)\;=\;25\,a(n-1) + a(n-2) - 1509\,a(n-3) + 3743\,a(n-4) + 21956\,a(n-5) - 87188\,a(n-6) - 23069\,a(n-7) + 409623\,a(n-8) - 235845\,a(n-9) - 749323\,a(n-10) + 679813\,a(n-11) + 599294\,a(n-12) - 680632\,a(n-13) - 199246\,a(n-14) + 294548\,a(n-15) + 14686\,a(n-16) - 53558\,a(n-17) + 3396\,a(n-18) + 3220\,a(n-19) - 192\,a(n-20) - 64\,a(n-21)
\]
for every $n>22$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223507.
