...
different counts. Across the columns settled here the model reproduces $64$ published
values, $200$ decimal digits in all, every one of them exactly; a misreading of the entry
