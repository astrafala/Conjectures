...
\title{The empirical recurrence for OEIS A199651, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A199651 counts arrays in which every cell is constrained by its neighbours on \emph{both}
...
order $31$, contributed by R.~H.~Hardin, then follows from a finite exact computation.
\end{abstract}
...
OEIS A199651 is ``Number of nX4 0..2 arrays with values 0..2 introduced in row major order and each element equal to no more than two horizontal and vertical neighbors.''. It has offset $1$ and begins
\[
14, 953, 59212, 3695683, 230693158, 14399942873, 898852775335, 56106912155198,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 08:17:26, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;60\,a(n-1) + 157\,a(n-2) - 186\,a(n-3) - 11412\,a(n-4) - 1614\,a(n-5) + 148235\,a(n-6) - 464921\,a(n-7) - 2730456\,a(n-8) + 11303105\,a(n-9) + 29242473\,a(n-10) - 103029710\,a(n-11) - 216889526\,a(n-12) + 436759588\,a(n-13) + 1010594719\,a(n-14) - 529467638\,a(n-15) - 1980627795\,a(n-16) - 809314204\,a(n-17) - 566374358\,a(n-18) + 1148311243\,a(n-19) + 1261859278\,a(n-20) + 753254801\,a(n-21) - 240681242\,a(n-22) - 120679796\,a(n-23) - 174398008\,a(n-24) - 109877696\,a(n-25) - 6812544\,a(n-26) + 7732736\,a(n-27) + 5814784\,a(n-28) + 1263616\,a(n-29) + 155648\,a(n-30) + 98304\,a(n-31)
\end{equation}
for all $n>32$.
...
index,
\[
3!\Bigl(a(n)-\sum_i c_i\,a(n-i)\Bigr)\;=\;\mathbf{v}^{\!\top}G^{\,j-31}\,
\Bigl(h_{31}-\sum_i c_i h_{31-i}\Bigr)
\]
...
$w=h_{31}-\sum_i c_ih_{31-i}$; and it is enough to check $m=0,1,\dots,S-1$.
\end{lemma}
...
$31$ applications of $G$ in exact integer arithmetic and $\mathbf{v}^{\!\top}G^{m}w$
evaluated for $m=0,1,\dots$, again exactly. Every one of those integers vanishes from the
index corresponding to $n=32+1$ onwards, and the run was continued until $S+1$
...
\eqref{eq:walk2}, divided by $3!$, was evaluated at every one of the $14$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A199651.
