...
\title{The empirical closed form for OEIS A207167, proved}
...
\begin{abstract}
OEIS A207167 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
$S=361$ vertices. Any function of the form $\sum_j p_j(n)\lambda_j^{\,n}$ satisfies the
...
OEIS A207167 is ``Number of n X 6 0..1 arrays avoiding 0 0 0 and 1 0 1 horizontally and 0 0 1 and 1 0 1 vertically.''. It has offset $1$ and begins
\[
19, 361, 1482, 3952, 8455, 15789, 26866, 42712,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (19/4)*n\^{}4 + (95/2)*n\^{}3 - (57/4)*n\^{}2 - 19*n.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 20 2018 08:29:23, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{19 n^{4}}{4} + \frac{95 n^{3}}{2} - \frac{57 n^{2}}{4} - 19 n.
\]
...
walk, so with $M$ the adjacency matrix of that digraph on $S=361$ vertices, and $u,w$ the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207167.
