...
\title{The empirical recurrence for OEIS A235653, proved by transfer matrix}
...
\begin{abstract}
OEIS A235653 counts arrays of width $2$ over $\{0,1\}$ by reducing every $2\times2$ subblock to a
...
OEIS A235653 is ``Number of (n+1) X (1+1) 0..1 arrays with the difference of the upper median and minimum value of each 2 X 2 subblock in lexicographically nondecreasing order rowwise and columnwise.''. It has offset $1$ and begins
\[
16, 52, 160, 476, 1392, 4020, 11520, 32828,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) - a(n-2) - 8*a(n-3) + 4*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 19 2018 11:58:40, revision 8) this is still
...
f(B)\;=\;v_3-v_1,
\]
the upper median minus the smallest entry. An array with $R$ rows and $2$ columns has $(R-1)\times1$ subblocks, and they
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) - a(n-2) - 8\,a(n-3) + 4\,a(n-4)
\]
for every $n>3$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A235653.
