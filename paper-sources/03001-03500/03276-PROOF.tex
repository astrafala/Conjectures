...
\title{The empirical recurrence for OEIS A262426, proved by transfer matrix}
...
\begin{abstract}
OEIS A262426 counts arrays of width $8$ over $\{0,1\}$ whose rows, read as base-$2$
numbers, are not divisible by $3$ and whose columns, read the same way, are divisible by
$3$. The entry carries an empirical recurrence of order $21$ contributed by
...
is then a walk count on $S=6561$ states.
\end{abstract}
...
OEIS A262426 is ``Number of (7+1)X(n+1) 0..1 arrays with each row divisible by 3 and column not divisible by 3, read as a binary number with top and left being the most significant bits.''. It has offset $1$ and begins
\[
170, 1404, 371790, 25901100, 4856629870, 655089996204, 114043973318270, 18287074397509740,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 22 2015 09:38:21, revision 4) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A262426.
