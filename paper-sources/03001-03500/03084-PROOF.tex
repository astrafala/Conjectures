...
\title{The empirical column recurrences for the table OEIS A234497}
...
\begin{abstract}
OEIS A234497 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A234497 is ``T(n,k) is the number of (n+1) X (k+1) 0..5 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 2 (constant-stress 1 X 1 tilings).''. It has offset $1$, is
read by antidiagonals, and begins
\[
250, 1834, 1834, 13464, 17022, 13464, 99142, 158288,\ \dots
\]
The entry carries the following block:
\begin{quote}\small
Empirical for column k:\\
k=1: a(n) = 5*a(n-1) +74*a(n-2) -295*a(n-3) -1008*a(n-4) +840*a(n-5).\\
k=2: [order 23].\\
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 20 2022 20:48:47, revision 6) these are still
...
The sequence is ``Number of (n+1) X (2) 0..5 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 2 (constant-stress 1 X 1 tilings).''. Its rows are the vertices of a digraph on
...
The entry gives only the order for this line: ``k=2: [order 23].''. Its model is a walk on
...
$c_{1}$ & $27$ & $c_{7}$ & $-1314423$ & $c_{13}$ & $-45869779722$ & $c_{19}$ & $-26459811072$ \\
$c_{2}$ & $-7$ & $c_{8}$ & $134764409$ & $c_{14}$ & $19646271368$ & $c_{20}$ & $-102846620160$ \\
$c_{3}$ & $-5642$ & $c_{9}$ & $-274870060$ & $c_{15}$ & $128555834088$ & $c_{21}$ & $35034937344$ \\
$c_{4}$ & $38876$ & $c_{10}$ & $-1754310602$ & $c_{16}$ & $-144208395792$ & $c_{22}$ & $13514784768$ \\
$c_{5}$ & $328643$ & $c_{11}$ & $6188057089$ & $c_{17}$ & $-115200081792$ & $c_{23}$ & $-5918883840$ \\
$c_{6}$ & $-3991917$ & $c_{12}$ & $6383741530$ & $c_{18}$ & $233207698368$ &  &  \\
...
model reproduces $7$ published values, $38$ decimal digits in all, every one of
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234497.
