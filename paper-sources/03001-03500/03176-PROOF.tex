...
\title{The empirical closed form for OEIS A223988, proved}
...
\begin{abstract}
OEIS A223988 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
$S=160$ vertices. Any function of the form $\sum_j p_j(n)\lambda_j^{\,n}$ satisfies the
...
OEIS A223988 is ``Number of 3Xn 0..3 arrays with rows unimodal and columns nondecreasing.''. It has offset $1$ and begins
\[
20, 400, 5029, 44803, 308470, 1738756, 8350154, 35158856,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 23:08:49, revision 8) this is still
...
+ \frac{2915977 n^{14}}{5230697472000} + \frac{6071381 n^{13}}{747242496000} \\
+ \frac{748919 n^{12}}{8211456000} + \frac{23111713 n^{11}}{28740096000} \\
+ \frac{409218107 n^{10}}{73156608000} + \frac{320706361 n^{9}}{10450944000} \\
+ \frac{107018740483 n^{8}}{804722688000} + \frac{467745209 n^{7}}{1026432000} \\
+ \frac{10942630223 n^{6}}{8895744000} + \frac{239853259979 n^{5}}{93405312000} \\
+ \frac{882554800469 n^{4}}{217945728000} + \frac{6093492161 n^{3}}{1297296000} \\
+ \frac{4200944633 n^{2}}{1029188160} + \frac{1784593 n}{1021020} \\
+ 1.
\end{multline*}
...
walk, so with $M$ the adjacency matrix of that digraph on $S=160$ vertices, and $u,w$ the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223988.
