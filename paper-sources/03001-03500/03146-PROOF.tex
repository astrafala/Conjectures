...
\title{The empirical recurrence for OEIS A267640, proved by transfer matrix}
...
\begin{abstract}
OEIS A267640 counts arrays in which the REPEATED VALUES of each row, and of each column, stand in a
prescribed relation to one another in the order they occur. The entry carries an empirical
recurrence of order $35$ contributed by R.~H.~Hardin. It is true, and it is decidable
...
value so far in each column of the scan, so the count is a walk count on $S=699$ states.
\end{abstract}
...
OEIS A267640 is ``Number of nX4 0..1 arrays with every repeated value in every row and column unequal to the previous repeated value, and new values introduced in row-major sequential order.''. It has offset $1$ and begins
\[
5, 50, 189, 1015, 2887, 12623, 32303, 131673,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 18 2016 20:09:16, revision 4) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=699,\quad\tau=\mathbf{1} .
\]
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) + 57\,a(n-2) - 319\,a(n-3) - 1391\,a(n-4) + 9145\,a(n-5) + 18468\,a(n-6) - 155864\,a(n-7) - 132459\,a(n-8) + 1760919\,a(n-9) + 254909\,a(n-10) - 13917643\,a(n-11) + 4638860\,a(n-12) + 79124590\,a(n-13) - 54513835\,a(n-14) - 327439835\,a(n-15) + 320570891\,a(n-16) + 985750855\,a(n-17) - 1225493352\,a(n-18) - 2130193456\,a(n-19) + 3242322831\,a(n-20) + 3203056845\,a(n-21) - 6029044853\,a(n-22) - 3134570201\,a(n-23) + 7833336809\,a(n-24) + 1655845581\,a(n-25) - 6967179434\,a(n-26) - 21114162\,a(n-27) + 4096193100\,a(n-28) - 565113380\,a(n-29) - 1504086120\,a(n-30) + 349509240\,a(n-31) + 309916800\,a(n-32) - 91209600\,a(n-33) - 27216000\,a(n-34) + 9072000\,a(n-35)
\]
for every $n>35$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267640.
