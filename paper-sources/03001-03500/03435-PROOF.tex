...
\title{The empirical recurrence for OEIS A214110, proved by transfer matrix}
...
\begin{abstract}
OEIS A214110 counts the proper colourings of a grid $n\times7$, wrapped in the direction of width $7$, with at most $4$ colours and
...
OEIS A214110 is ``Number of 0..3 colorings on an nX7 array circular in the 7 direction with new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
91, 34041, 12777541, 4797577911, 1801391900581, 676387200779521, 253970131976197721, 95360806682222518731,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 416*a(n-1) -15454*a(n-2) +89758*a(n-3) +90848*a(n-4) -438718*a(n-5) +62801*a(n-6)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 16:51:58, revision 8) this is still
...
\]
There are $(i-1)^{7}+(-1)^{7}(i-1)$ such colourings, which at $i=4$ is already more
...
\begin{theorem}
\[
a(n)\;=\;416\,a(n-1) - 15454\,a(n-2) + 89758\,a(n-3) + 90848\,a(n-4) - 438718\,a(n-5) + 62801\,a(n-6)
\]
for every $n>6$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A214110.
