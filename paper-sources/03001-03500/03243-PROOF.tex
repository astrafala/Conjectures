...
\title{The empirical recurrence for OEIS A205315, proved by transfer matrix}
...
\begin{abstract}
OEIS A205315 counts, up to renaming the letters, the arrays of width $6$ over at most $2$
letters in which all the $2\times2$ subblocks of one array have the SAME number of equal edges, an equal edge being one of the four perimeter edges whose two cells agree; the common value is not named, so the count splits by it. It carries an empirical recurrence of order $8$ contributed by
...
OEIS A205315 is ``Number of (n+1)X6 0..1 arrays with every 2X2 subblock having the same number of equal edges, and new values 0..1 introduced in row major order.''. It has offset $1$ and begins
\[
488, 7784, 126536, 2068148, 33865634, 554916092, 9094954742, 149077423220,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 31*a(n-1) -321*a(n-2) +1569*a(n-3) -4179*a(n-4) +6420*a(n-5) -5671*a(n-6) +2668*a(n-7) -516*a(n-8)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 12:00:15, revision 9) this is still
...
$w_i$ cleared of denominators and $S=69$ states in all. The walk index $j$ and the entry's own
...
\begin{theorem}
\[
a(n)\;=\;31\,a(n-1) - 321\,a(n-2) + 1569\,a(n-3) - 4179\,a(n-4) + 6420\,a(n-5) - 5671\,a(n-6) + 2668\,a(n-7) - 516\,a(n-8)
\]
for every $n>7$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A205315.
