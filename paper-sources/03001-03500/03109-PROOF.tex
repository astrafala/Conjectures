...
\title{The empirical recurrence for OEIS A210046, proved by transfer matrix}
...
\begin{abstract}
OEIS A210046 counts arrays of width $3$ whose every $2\times2$ subblock holds a
...
OEIS A210046 is ``Number of (n+1) X 3 0..2 arrays containing all values 0..2 with every 2 X 2 subblock having two distinct values, and new values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
9, 119, 1271, 12377, 114237, 1020363, 8917959, 76781969,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 14*a(n-1) - 41*a(n-2) - 66*a(n-3) + 100*a(n-4) + 56*a(n-5) - 32*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 14 2018 05:56:05, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;14\,a(n-1) - 41\,a(n-2) - 66\,a(n-3) + 100\,a(n-4) + 56\,a(n-5) - 32\,a(n-6)
\]
for every $n>6$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A210046.
