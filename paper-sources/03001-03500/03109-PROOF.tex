...
\title{The empirical recurrence for OEIS A235579, proved by transfer matrix}
...
\begin{abstract}
OEIS A235579 counts arrays of width $2$ over $\{0,1,2,3\}$ by reducing every $2\times2$ subblock to a
...
about it is one bit per adjacent pair of columns, so the count is a walk count on $S=77$
states.
\end{abstract}
...
OEIS A235579 is ``Number of (n+1)X(1+1) 0..3 arrays with the difference of the upper median and minimum value of each 2X2 subblock in lexicographically nondecreasing order rowwise and columnwise.''. It has offset $1$ and begins
\[
256, 2896, 29902, 283672, 2573798, 22515040, 192101098, 1606970816,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 08:40:46, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;16\,a(n-1) - 1088\,a(n-3) + 2822\,a(n-4) + 32220\,a(n-5) - 115405\,a(n-6) - 550832\,a(n-7) + 2287907\,a(n-8) + 6094288\,a(n-9) - 27451466\,a(n-10) - 46518640\,a(n-11) + 215602416\,a(n-12) + 255565900\,a(n-13) - 1144084105\,a(n-14) - 1037102496\,a(n-15) + 4127924328\,a(n-16) + 3118730008\,a(n-17) - 9990319584\,a(n-18) - 6756169120\,a(n-19) + 15678479104\,a(n-20) + 9914486656\,a(n-21) - 15072576768\,a(n-22) - 9022539264\,a(n-23) + 8159504384\,a(n-24) + 4603113472\,a(n-25) - 2141929472\,a(n-26) - 1129512960\,a(n-27) + 192675840\,a(n-28) + 94371840\,a(n-29)
\]
for every $n>28$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A235579.
