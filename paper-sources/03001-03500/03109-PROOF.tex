...
\title{The empirical recurrence for OEIS A263796, proved by transfer matrix}
...
\begin{abstract}
OEIS A263796 counts arrays of width $6$ over $\{0,1\}$ whose rows, read as base-$2$
...
is then a walk count on $S=2733$ states.
\end{abstract}
...
OEIS A263796 is ``Number of (n+1)X(5+1) 0..1 arrays with each row and column divisible by 3, read as a binary number with top and left being the most significant bits, and rows and columns lexicographically nonincreasing.''. It has offset $1$ and begins
\[
4, 4, 14, 17, 61, 130, 494, 1435,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 15:38:50, revision 6) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=2733.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A263796.
