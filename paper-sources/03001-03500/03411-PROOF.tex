...
\title{The empirical recurrence for OEIS A280674, proved by transfer matrix}
...
\begin{abstract}
OEIS A280674 counts $2\times n$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A280674 is ``Number of 2 X n 0..2 arrays with no element equal to more than one of its horizontal and antidiagonal neighbors and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
2, 11, 59, 338, 1917, 10893, 61880, 351541,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 5*a(n-1) + 6*a(n-2) - 11*a(n-3) - 7*a(n-4) + 4*a(n-5) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 14 2019 12:29:32, revision 10) this is still
...
$\{0,\dots,2\}^{2}$. The neighbourhood of a cell in column $u_i$ meets $u_{i-1}$,
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) + 6\,a(n-2) - 11\,a(n-3) - 7\,a(n-4) + 4\,a(n-5)
\]
for every $n>6$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A280674.
