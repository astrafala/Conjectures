...
\title{The empirical column recurrences for the table OEIS A264272}
...
\begin{abstract}
OEIS A264272 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A264272 is ``T(n,k)=Number of (n+1)X(k+1) arrays of permutations of 0..(n+1)*(k+1)-1 with each element having index change +-(.,.) 0,0 1,0 or 1,2.''. It has offset $1$, is
read by antidiagonals, and begins
\[
4, 10, 9, 25, 48, 25, 65, 256,\ \dots
\]
...
k=5: [order 96]\\
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 10 2015 11:32:23, revision 6) these are still
...
The sequence is ``Number of (n+1)X(2) arrays of permutations of 0..(n+1)*(2)-1 with each element having index change +-(.,.) 0,0 1,0 or 1,2.''. Its rows are the vertices of a digraph on
...
\subsection*{Row $n$$=1$}
The sequence is ``Number of (2)X(n+1) arrays of permutations of 0..(2)*(n+1)-1 with each element having index change +-(.,.) 0,0 1,0 or 1,2.''. Its rows are the vertices of a digraph on
...
The entry gives only the order for this line: ``k=2: [order 8]''. Its model is a walk on
...
$c_{1}$ & $4$ & $c_{3}$ & $-16$ & $c_{5}$ & $16$ & $c_{7}$ & $-4$ \\
$c_{2}$ & $16$ & $c_{4}$ & $-41$ & $c_{6}$ & $16$ & $c_{8}$ & $-1$ \\
\end{tabular}\end{center}
Repeating with the first $8+4$ terms removed gives order $8$ again.

\subsection*{Column $k=4$, recovered}
The entry gives only the order for this line: ``k=4: [order 52]''. Its model is a walk on
...
$52$ --- the stated order --- with integer coefficients
\[
(c_1,\dots,c_{52})=(24,\ 411,\ -6360,\ -61196,\ 672824,\ 4437625,\ -36769704,\ -172245969,\ 1144491264,\ 3729595154,\ -21721475392,\ -47984881699,\ 263551716600,\ 389326578687,\ -2125360577000,\ -2079876285629,\ 11735434374432,\ 7536887092416,\ -45291488450272,\ -18978490324031,\ 123769506884792,\ 34232099835285,\ -241235675104680,\ -46520765844531,\ 336543397331056,\ 50928885196972,\ -336543397331056,\ -46520765844531,\ 241235675104680,\ 34232099835285,\ -123769506884792,\ -18978490324031,\ 45291488450272,\ 7536887092416,\ -11735434374432,\ -2079876285629,\ 2125360577000,\ 389326578687,\ -263551716600,\ -47984881699,\ 21721475392,\ 3729595154,\ -1144491264,\ -172245969,\ 36769704,\ 4437625,\ -672824,\ -61196,\ 6360,\ 411,\ -24,\ -1).
\]
Repeating with the first $52+4$ terms removed gives order $52$ again.
...
model reproduces $17$ published values, $45$ decimal digits in all, every one of
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264272.
