...
\title{The empirical closed form for OEIS A184566, proved}
...
\begin{abstract}
OEIS A184566 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
$S=152$ vertices. Any function of the form $\sum_j p_j(n)\lambda_j^{\,n}$ satisfies the
...
OEIS A184566 is ``Number of (n+2)X3 0..3 arrays with each 3X3 subblock having rows and columns in lexicographically nondecreasing order.''. It has offset $1$ and begins
\[
14178, 102445, 545662, 2430950, 9496395, 33351260, 107058241, 318063303,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 02:45:33, revision 9) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{n^{19}}{121645100408832000} + \frac{53 n^{18}}{3201186852864000} + \frac{5743 n^{17}}{2134124568576000} + \frac{12931 n^{16}}{62768369664000} + \frac{621041 n^{15}}{62768369664000} + \frac{10734523 n^{14}}{31384184832000} + \frac{1720232317 n^{13}}{188305108992000} + \frac{127448011 n^{12}}{658409472000} + \frac{6294370109 n^{11}}{1931334451200} + \frac{18970604773 n^{10}}{438939648000} + \frac{4321841102639 n^{9}}{9656672256000} + \frac{17491957547611 n^{8}}{4828336128000} + \frac{1086794057312713 n^{7}}{47076277248000} + \frac{2752481070552527 n^{6}}{23538138624000} + \frac{1237909924891457 n^{5}}{2615348736000} + \frac{1921023328483453 n^{4}}{1307674368000} + \frac{249101413506019 n^{3}}{77189112000} + \frac{12857906145353 n^{2}}{2806876800} + \frac{288855292519 n}{77597520} + 561.
\]
...
walk, so with $M$ the adjacency matrix of that digraph on $S=152$ vertices, and $u,w$ the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A184566.
