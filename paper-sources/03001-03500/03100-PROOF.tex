...
\title{The empirical recurrence for OEIS A266027, proved by transfer matrix}
...
\begin{abstract}
OEIS A266027 counts arrays of width $2$ in which every entry is equal to the NUMBER of its own
...
OEIS A266027 is ``Number of n X 2 integer arrays with each element equal to the number of horizontal and antidiagonal neighbors less than itself.''. It has offset $1$ and begins
\[
3, 11, 55, 263, 1248, 5959, 28399, 135383,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) + 7*a(n-2) + 7*a(n-3) - a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 09 2019 09:23:35, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + 7\,a(n-2) + 7\,a(n-3) - a(n-4)
\]
for every $n>4$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A266027.
