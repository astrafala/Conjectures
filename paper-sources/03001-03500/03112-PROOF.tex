...
\title{The empirical recurrence for OEIS A281472, proved by transfer matrix}
...
\begin{abstract}
OEIS A281472 counts $4\times n$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A281472 is ``Number of 4 X n 0..1 arrays with no element equal to more than two of its horizontal, diagonal or antidiagonal neighbors and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
8, 81, 60, 96, 130, 176, 260, 406,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) - a(n-2) + a(n-3) - a(n-5) for n>9.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 19 2019 14:41:06, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A281472.
