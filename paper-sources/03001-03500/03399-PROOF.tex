...
\title{The empirical closed form for OEIS A224059, proved}
...
\begin{abstract}
OEIS A224059 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A224059 is ``Number of nX3 0..3 arrays with rows, columns and antidiagonals unimodal and diagonals nondecreasing.''. It has offset $1$ and begins
\[
50, 984, 8854, 58814, 324702, 1557606, 6643979, 25596389,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 23:14:18, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\begin{multline*}
f(n)\;=\;\frac{n^{18}}{3629463552000} + \frac{n^{17}}{80654745600} \\
+ \frac{673 n^{16}}{1307674368000} + \frac{3163 n^{15}}{237758976000} \\
+ \frac{208801 n^{14}}{747242496000} + \frac{625841 n^{13}}{149448499200} \\
+ \frac{1696897 n^{12}}{28740096000} + \frac{14064731 n^{11}}{28740096000} \\
+ \frac{339240647 n^{10}}{73156608000} + \frac{339530671 n^{9}}{14631321600} \\
+ \frac{4767368563 n^{8}}{28740096000} + \frac{637757023 n^{7}}{1026432000} \\
+ \frac{26329719541 n^{6}}{10378368000} + \frac{2426824577 n^{5}}{339655680} \\
+ \frac{343572662101 n^{4}}{18162144000} - \frac{189957341011 n^{3}}{9081072000} \\
+ \frac{1627071089 n^{2}}{5834400} - \frac{2276993179 n}{3063060} \\
+ 701.
\end{multline*}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224059.
