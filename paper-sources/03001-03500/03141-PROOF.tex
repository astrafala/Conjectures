...
\title{The empirical recurrence for OEIS A282051, proved by transfer matrix}
...
\begin{abstract}
OEIS A282051 counts $n\times2$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A282051 is ``Number of n X 2 0..2 arrays with no element unequal to more than four of its king-move neighbors and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
2, 14, 91, 600, 4039, 27212, 183195, 1233336,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 8*a(n-1) - 11*a(n-2) + 20*a(n-3) - 24*a(n-4) + 8*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 20 2019 10:42:34, revision 10) this is still
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-1) - 11\,a(n-2) + 20\,a(n-3) - 24\,a(n-4) + 8\,a(n-5)
\]
for every $n>5$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A282051.
