...
\title{The empirical recurrence for OEIS A276296, proved by counting patterns}
...
\begin{abstract}
OEIS A276296 counts arrays in which no entry may repeat a value found at any of three stated
...
cutting $60074$ pairs to $S=10355$ states. The entry's empirical recurrence of order $33$,
...
OEIS A276296 is ``Number of nX5 0..2 arrays with no element equal to any value at offset (-2,-1) (-1,1) or (0,-1) and new values introduced in order 0..2.''. It has offset $1$ and begins
\[
8, 108, 693, 5909, 50949, 442001, 3861469, 33851605,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 28 2016 08:24:45, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;15\,a(n-1) - 59\,a(n-2) + 88\,a(n-3) - 753\,a(n-4) + 3144\,a(n-5) - 3566\,a(n-6) + 15470\,a(n-7) - 60036\,a(n-8) + 63424\,a(n-9) - 166302\,a(n-10) + 522272\,a(n-11) - 496170\,a(n-12) + 872844\,a(n-13) - 2184470\,a(n-14) + 1728684\,a(n-15) - 2023510\,a(n-16) + 4274276\,a(n-17) - 2552010\,a(n-18) + 1711922\,a(n-19) - 3752238\,a(n-20) + 1631282\,a(n-21) - 390844\,a(n-22) + 1591096\,a(n-23) - 522438\,a(n-24) - 63580\,a(n-25) - 336430\,a(n-26) + 92712\,a(n-27) + 24271\,a(n-28) + 31601\,a(n-29) - 8451\,a(n-30) - 1540\,a(n-31) - 993\,a(n-32) + 290\,a(n-33)
\end{equation}
for all $n>37$.
...
$o=1n_0+0-2$, we have for $j\ge33$
\[
3!\Bigl(a(n_0+j)-\sum_i c_i\,a(n_0+j-i)\Bigr)
=\mathbf{v}^{\!\top}G^{\,j-33}w,\qquad
w=h_{33}-\sum_i c_i h_{33-i} .
\]
...
the survivors by the pattern of the new pair. The vector $w$ was formed by $33$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A276296.
