...
\title{The empirical recurrence for OEIS A208394, proved by transfer matrix}
...
\begin{abstract}
OEIS A208394 counts $3\times n$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A208394 is ``Number of 3 X n 0..2 arrays with new values 0..2 introduced in row major order and no element equal to more than two of its immediate leftward or upward or right-upward antidiagonal neighbors.''. It has offset $1$ and begins
\[
5, 122, 3042, 76806, 1937736, 48890520, 1233536544, 31122868320,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 22*a(n-1) + 80*a(n-2) + 40*a(n-3) - 48*a(n-4) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 02 2018 10:16:01, revision 9) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208394.
