...
\title{The empirical closed form for OEIS A223768, proved}
...
\begin{abstract}
OEIS A223768 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A223768 is ``Number of nX6 0..1 arrays with rows, columns and antidiagonals unimodal and diagonals nondecreasing.''. It has offset $1$ and begins
\[
22, 169, 607, 1601, 3699, 8007, 16742, 34096,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 22:23:31, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\begin{multline*}
f(n)\;=\;\frac{n^{12}}{479001600} - \frac{n^{11}}{15966720} \\
+ \frac{23 n^{10}}{8709120} - \frac{59 n^{9}}{1451520} \\
+ \frac{22591 n^{8}}{14515200} - \frac{1159 n^{7}}{53760} \\
+ \frac{713737 n^{6}}{1741824} - \frac{1665749 n^{5}}{290304} \\
+ \frac{795178259 n^{4}}{10886400} - \frac{220668799 n^{3}}{362880} \\
+ \frac{73774259 n^{2}}{20790} - \frac{340682581 n}{27720} \\
+ 20228.
\end{multline*}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223768.
