...
\title{The empirical recurrence for OEIS A270145, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A270145 counts arrays over $\{0,\dots,7\}$ subject to a condition on the array as a
...
OEIS A270145 is ``Number of n X 2 0..7 arrays with some element plus some horizontally, diagonally, antidiagonally or vertically adjacent neighbor totalling seven exactly once.''. It has offset $1$ and begins
\[
8, 1440, 85056, 4126368, 182257536, 7623445344, 307704553920, 12111206870304,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 66*a(n-1) - 1021*a(n-2) - 2244*a(n-3) - 1156*a(n-4) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 30 2019 06:21:29, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;66\,a(n-1) - 1021\,a(n-2) - 2244\,a(n-3) - 1156\,a(n-4)
\end{equation}
for all $n>5$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A270145.
