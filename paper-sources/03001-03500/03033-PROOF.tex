...
\title{The empirical recurrence for OEIS A269824, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A269824 counts arrays over $\{0,\dots,4\}$ subject to a condition on the array as a
...
which is what keeps the digraph sparse. That makes $a(n)$ a walk count on $S=250$ vertices,
...
OEIS A269824 is ``Number of nX3 0..4 arrays with some element plus some horizontally, diagonally, antidiagonally or vertically adjacent neighbor totalling four exactly once.''. It has offset $1$ and begins
\[
40, 3096, 103296, 3200604, 90748696, 2472983556, 65284613232, 1686961414812,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 05 2016 19:23:39, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;34\,a(n-1) + 37\,a(n-2) - 7276\,a(n-3) + 2525\,a(n-4) + 294806\,a(n-5) - 785545\,a(n-6) - 1242552\,a(n-7) + 4983512\,a(n-8) + 814900\,a(n-9) - 9636844\,a(n-10) + 1645224\,a(n-11) + 5010412\,a(n-12) - 1220112\,a(n-13) - 975664\,a(n-14) + 242688\,a(n-15) + 70464\,a(n-16) - 11520\,a(n-17) - 2304\,a(n-18)
\end{equation}
for all $n>19$.
...
\[
\mathcal V=\bigl\{(r,c):\ r\in\{0,\dots,4\}^{3},\ c\in\{0,1\}\bigr\},
\qquad |\mathcal V|=S=250,
\]
...
the digraph dense, with $(4+1)^{2\cdot3}$ edges instead of the sparse set used here.
\end{remark}
...
those integers vanishes from the index corresponding to $n=19+1$ onwards, and the run
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269824.
