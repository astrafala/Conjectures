...
\title{The empirical recurrence for OEIS A250347, proved by transfer matrix}
...
\begin{abstract}
OEIS A250347 carries an empirical recurrence of order $12$ contributed by R. H. Hardin. It is
...
OEIS A250347 is ``Number of length n arrays x(i), i=1..n with x(i) in i..i+4 and no value appearing more than 2 times.''. It has offset $1$ and begins
\[
5, 25, 122, 581, 2724, 12734, 59406, 276816,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 5*a(n-1) -4*a(n-3) -9*a(n-4) -36*a(n-5) +7*a(n-6) +23*a(n-7) +13*a(n-8) +2*a(n-9) -5*a(n-10) +a(n-12)
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 12:19:43, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) - 4\,a(n-3) - 9\,a(n-4) - 36\,a(n-5) + 7\,a(n-6) + 23\,a(n-7) + 13\,a(n-8) + 2\,a(n-9) - 5\,a(n-10) + a(n-12)
\]
for every $n>0$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250347.
