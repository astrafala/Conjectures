...
\title{The empirical closed form for OEIS A185473, proved}
...
\begin{abstract}
OEIS A185473 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
$S=58036$ vertices. Any function of the form $\sum_j p_j(n)\lambda_j^{\,n}$ satisfies the
monic linear recurrence whose characteristic polynomial is
$\prod_j(x-\lambda_j)^{\deg p_j+1}$; here that polynomial is $q(x)=(x-1)^{18}$, of degree
$18$. Two things are then checked exactly: that the walk count satisfies the same
recurrence from some index on, which the Cayley--Hamilton theorem reduces to a finite
computation, and that the two sequences agree at $18$ consecutive indices past that
...
OEIS A185473 is ``Number of (n+2)X7 0..2 arrays with each 3X3 subblock having rows and columns in lexicographically nondecreasing order.''. It has offset $1$ and begins
\[
79743, 594798, 3097348, 12990375, 46410729, 146203201, 416227164, 1090826214,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 03:00:37, revision 9) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{n^{17}}{2155681382400} + \frac{47 n^{16}}{697426329600} + \frac{611 n^{15}}{134120448000} + \frac{33559 n^{14}}{174356582400} + \frac{189341 n^{13}}{33210777600} + \frac{178309 n^{12}}{1277337600} + \frac{147904279 n^{11}}{44706816000} + \frac{87015563 n^{10}}{1219276800} + \frac{11642696389 n^{9}}{9754214400} + \frac{69578815777 n^{8}}{4877107200} + \frac{3848584871 n^{7}}{32256000} + \frac{44384094767 n^{6}}{63866880} + \frac{247986427893683 n^{5}}{87178291200} + \frac{124742663704661 n^{4}}{14529715200} + \frac{1115145293971 n^{3}}{58212000} + \frac{2731472131849 n^{2}}{100900800} + \frac{9965552297 n}{510510} + 1735.
\]
...
walk, so with $M$ the adjacency matrix of that digraph on $S=58036$ vertices, and $u,w$ the
...
Here $q(x)=(x-1)^{18}$, of degree $18$; the closed form is a polynomial in $n$, so this is $(x-1)^{18}$, and the recurrence it encodes is
\begin{equation}\label{eq:rec}
a(n)\;=\;18\,a(n-1) - 153\,a(n-2) + 816\,a(n-3) - 3060\,a(n-4) + 8568\,a(n-5) - 18564\,a(n-6) + 31824\,a(n-7) - 43758\,a(n-8) + 48620\,a(n-9) - 43758\,a(n-10) + 31824\,a(n-11) - 18564\,a(n-12) + 8568\,a(n-13) - 3060\,a(n-14) + 816\,a(n-15) - 153\,a(n-16) + 18\,a(n-17) - a(n-18).
\end{equation}
...
\begin{proof}
The vector $w'=q(M)w$ was formed by $18$ matrix--vector products in exact integer
...
identically. Both were then evaluated in exact arithmetic at the $18$ consecutive indices
$n=19,\dots,36$ and agree at each. A monic recurrence of order $18$
determines $a(m)$ from $a(m-1),\dots,a(m-18)$, and for every $m\ge37$ both
$m>18$ and $m-18\ge19$ hold, so induction on $m$ gives $a(m)=f(m)$ for every
$m\ge19$.
Below $n=19$ the recurrence argument gives nothing, since \eqref{eq:rec} is only
established for $a$ from $n=19$ on. The remaining indices $n=1,\dots,18$ were
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A185473.
