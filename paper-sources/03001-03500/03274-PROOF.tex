...
\title{The empirical recurrence for OEIS A238720, proved by transfer matrix}
...
\begin{abstract}
OEIS A238720 counts arrays over $\{0,1,2\}$ in which no entry may equal, modulo $3$, a given
...
count is then a walk count on $S=9$ states.
\end{abstract}
...
OEIS A238720 is ``Number of nX2 0..2 arrays with no element equal to the sum modulo 3 of elements to its left or elements above it.''. It has offset $1$ and begins
\[
2, 4, 10, 16, 42, 64, 170, 256,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 5*a(n-2) -4*a(n-4)
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 10:54:00, revision 6) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The array has $2$ cells across one way, entries $x(i,j)\in\{0,1,2\}$, and the entry names these
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A238720.
