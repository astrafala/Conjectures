...
\title{The empirical recurrence for OEIS A223871, proved by transfer matrix}
...
\begin{abstract}
OEIS A223871 counts arrays over $\{0,\dots,3\}$ whose rows, columns, diagonals or
antidiagonals are required to be monotone or unimodal, and carries an empirical recurrence of
order $28$ contributed by R.~H.~Hardin. A monotone condition is local, but a unimodal one
...
is a walk count on $S=3200$ vertices and the recurrence follows from a finite exact
computation.
\end{abstract}
...
OEIS A223871 is ``Number of n X 3 0..3 arrays with rows, diagonals and antidiagonals unimodal.''. It has offset $1$ and begins
\[
50, 2500, 99223, 3863372, 152918517, 6066668157, 240345697904, 9519219712534,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 26 2025 13:18:37, revision 7) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;40\,a(n-1) - 132\,a(n-2) + 4459\,a(n-3) + 13745\,a(n-4) - 279374\,a(n-5) - 216409\,a(n-6) - 10116301\,a(n-7) - 38256907\,a(n-8) + 322157439\,a(n-9) + 897495274\,a(n-10) + 3199485479\,a(n-11) + 15600399494\,a(n-12) - 40103358672\,a(n-13) - 213466075938\,a(n-14) - 190360919826\,a(n-15) - 232629523048\,a(n-16) + 234440936372\,a(n-17) + 1759786495760\,a(n-18) + 1770736417792\,a(n-19) + 1582997734272\,a(n-20) + 781069335952\,a(n-21) - 1858101760192\,a(n-22) - 2045017763520\,a(n-23) - 1010972140800\,a(n-24) - 530550835200\,a(n-25) + 130955034624\,a(n-26) + 240537600000\,a(n-27) + 51314688000\,a(n-28)
\end{equation}
for all $n>28$.
...
bit vector), $|\mathcal V|=S=3200$; let $(r,f)\to(s,f')$ be an edge when placing $s$ after $r$
...
$h_j=G^{j}N^{o}\mathbf{1}$, we have for $j\ge28$
\[
a(n_0+j)-\sum_i c_i\,a(n_0+j-i)=\,\mathbf{v}^{\!\top}G^{\,j-28}w,
\qquad w=h_{28}-\sum_i c_ih_{28-i} .
\]
...
$28$ applications of $G$ in exact integer arithmetic and $\mathbf{v}^{\!\top}G^{m}w$
evaluated for $m=0,1,\dots$, again exactly. Every one of those integers vanishes from the
index corresponding to $n=28+1$ onwards, and the run continued until $S+1$ consecutive
zeros had been seen.
\end{proof}
...
every one of the $14$ published indices, with no shift fitted. The values agree exactly.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223871.
