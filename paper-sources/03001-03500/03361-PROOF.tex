...
\title{The empirical recurrence for OEIS A211687, proved by transfer matrix}
...
\begin{abstract}
OEIS A211687 carries an empirical recurrence of order $12$ contributed by R. H. Hardin. It is
...
arrays counted are exactly the walks in it; hence $a(n)$ is a walk count on $S=53$ vertices
...
OEIS A211687 is ``Number of -4..4 arrays x(i) of n+1 elements i=1..n+1 with x(i)+x(j), x(i+1)+x(j+1), -(x(i)+x(j+1)), and -(x(i+1)+x(j)) having three distinct values for every i<=n and j<=n.''. It has offset $1$ and begins
\[
68, 156, 318, 604, 1144, 2108, 3924, 7236,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 19 2018 14:07:45, revision 8) this is still
...
admissible array is then exactly a walk, so with $M$ the adjacency matrix on $S=53$ vertices
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + 6\,a(n-2) - 41\,a(n-3) + 6\,a(n-4) + 154\,a(n-5) - 109\,a(n-6) - 256\,a(n-7) + 262\,a(n-8) + 175\,a(n-9) - 230\,a(n-10) - 30\,a(n-11) + 60\,a(n-12)
\]
for every $n>12$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A211687.
