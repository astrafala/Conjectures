...
\title{The empirical recurrence for OEIS A224547, proved by transfer matrix}
...
\begin{abstract}
OEIS A224547 counts the $(n+1)\times6$ matrices over $\{0,\dots,1\}$ all of whose
...
makes $a(n)$ a walk count on $S=44$ vertices, hence $C$-finite, and whether the conjectured
...
OEIS A224547 is ``Number of (n+1) X 6 0..1 matrices with each 2 X 2 subblock idempotent.''. It has offset $1$ and begins
\[
80, 137, 193, 294, 428, 635, 943, 1420,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) - 5*a(n-2) + a(n-3) + 2*a(n-4) - a(n-5) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 30 2018 15:03:16, revision 7) this is still
...
\]
with $M$ the adjacency matrix on $S=44$ states. In particular $a$ is $C$-finite. The
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224547.
