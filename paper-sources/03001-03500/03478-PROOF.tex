...
\title{The empirical closed form for OEIS A224058, proved}
...
\begin{abstract}
OEIS A224058 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A224058 is ``Number of nX2 0..3 arrays with rows, columns and antidiagonals unimodal and diagonals nondecreasing.''. It has offset $1$ and begins
\[
16, 160, 984, 4580, 17723, 59792, 180821, 499357,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 23:14:10, revision 9) this is still
...
+ \frac{2861 n^{8}}{414720} + \frac{7187 n^{7}}{161280} \\
+ \frac{10695901 n^{6}}{43545600} + \frac{212027 n^{5}}{207360} \\
+ \frac{6072841 n^{4}}{2177280} + \frac{1652783 n^{3}}{362880} \\
+ \frac{1059277 n^{2}}{237600} + \frac{26023 n}{13860} \\
+ 1.
\end{multline*}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224058.
