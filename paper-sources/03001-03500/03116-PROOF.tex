...
\title{The empirical recurrence for OEIS A210314, proved by transfer matrix}
...
\begin{abstract}
OEIS A210314 counts arrays of width $3$ whose every $2\times2$ subblock holds a
...
OEIS A210314 is ``Number of (n+1)X3 0..3 arrays containing all values 0..3 with every 2X2 subblock having two or three distinct values, and new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
35, 4125, 279526, 16048775, 863174816, 45102170733, 2324938770750, 119066365167743,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 15:54:19, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;79\,a(n-1) - 1474\,a(n-2) + 1450\,a(n-3) + 39515\,a(n-4) - 30297\,a(n-5) - 122076\,a(n-6) + 99228\,a(n-7) + 43912\,a(n-8) - 53472\,a(n-9) + 11232\,a(n-10)
\]
for every $n>10$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A210314.
