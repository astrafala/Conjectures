...
\title{The empirical closed form for OEIS A207256, proved}
...
\begin{abstract}
OEIS A207256 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A207256 is ``Number of 5 X n 0..1 arrays avoiding 0 0 1 and 1 0 1 horizontally and 0 1 0 and 1 0 1 vertically.''. It has offset $1$ and begins
\[
16, 256, 1232, 3776, 9072, 18688, 34608, 59264,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (4/15)*n\^{}5 + (32/3)*n\^{}4 + (44/3)*n\^{}3 - (32/3)*n\^{}2 + (16/15)*n.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 21 2018 10:31:50, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{4 n^{5}}{15} + \frac{32 n^{4}}{3} + \frac{44 n^{3}}{3} - \frac{32 n^{2}}{3} + \frac{16 n}{15}.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207256.
