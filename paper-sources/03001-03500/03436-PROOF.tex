...
\title{The empirical recurrence for OEIS A268737, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A268737 counts arrays over $\{0,\dots,1\}$ subject to a condition on the array as a
...
OEIS A268737 is ``Number of nX5 binary arrays with some 1 horizontally or vertically adjacent to some other 1 exactly once.''. It has offset $1$ and begins
\[
10, 145, 1788, 19591, 200204, 1971414, 18847982, 176668038,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 12 2016 08:44:14, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;8\,a(n-1) + 56\,a(n-2) - 288\,a(n-3) - 1506\,a(n-4) + 870\,a(n-5) + 7568\,a(n-6) - 1632\,a(n-7) - 15481\,a(n-8) + 4624\,a(n-9) + 13495\,a(n-10) - 6192\,a(n-11) - 4336\,a(n-12) + 2890\,a(n-13) + 82\,a(n-14) - 288\,a(n-15) + 24\,a(n-16) + 8\,a(n-17) - a(n-18)
\end{equation}
for all $n>18$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268737.
