...
\title{The empirical recurrence for OEIS A183467, proved by transfer matrix}
...
\begin{abstract}
OEIS A183467 counts arrays of width $2$ over $\{0,1\}$ in which every cell is the sum of one of two groups of its neighbours. The entry carries an
...
OEIS A183467 is ``Number of n X 2 binary arrays with every element equal to either the sum mod 2 of its vertical neighbors or the sum mod 2 of its horizontal neighbors.''. It has offset $1$ and begins
\[
2, 6, 12, 28, 68, 156, 368, 872,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + 4*a(n-3) - 4*a(n-4) - 4*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 29 2018 09:17:22, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 4\,a(n-3) - 4\,a(n-4) - 4\,a(n-6)
\]
for every $n>5$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A183467.
