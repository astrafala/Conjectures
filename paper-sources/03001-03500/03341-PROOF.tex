...
\title{The empirical recurrence for OEIS A204364, proved by transfer matrix}
...
\begin{abstract}
OEIS A204364 counts $(n+2)\times4$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A204364 is ``Number of (n+2) X 4 0..2 arrays with every 3 X 3 subblock having three equal elements in a row horizontally, vertically or nw-to-se diagonally exactly three ways, and new values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
212, 466, 673, 713, 1715, 4355, 11671, 31891,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) -6*a(n-4) +4*a(n-6) for n>9.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 07 2018 06:39:00, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204364.
