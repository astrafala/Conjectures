...
\title{The empirical recurrence for OEIS A217881, proved by transfer matrix}
...
\begin{abstract}
OEIS A217881 carries an empirical recurrence of order $13$ contributed by R. H. Hardin. It is
...
OEIS A217881 is ``Number of n element 0..2 arrays with each element the minimum of 6 adjacent elements of a random 0..2 array of n+5 elements.''. It has offset $1$ and begins
\[
3, 9, 22, 46, 86, 148, 239, 372,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) - 3*a(n-2) + a(n-3) + 3*a(n-7) - a(n-8) + a(n-9) + a(n-10) + a(n-11) + a(n-12) + a(n-13).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2018 09:53:15, revision 11) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A217881.
