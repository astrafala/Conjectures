...
\title{No column above the one before it in every row: OEIS A212926}
...
\begin{abstract}
OEIS A212926 carries an empirical recurrence of order $5$ contributed by R.~H.~Hardin. It is
...
OEIS A212926 is ``Number of n X 4 0..3 arrays with no column j greater than column j-1 in all rows.''. It has offset $1$ and begins
\[
35, 39695, 14177855, 4041974015, 1075113010175, 279128913678335, 71832238695530495, 18425105216039878655,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 405*a(n-1) -43860*a(n-2) +1524160*a(n-3) -15636480*a(n-4) +14155776*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 04 2025 19:20:55, revision 13) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{The count is a walk count}

The entry counts arrays of $4$ columns whose rows are arbitrary over the alphabet $\{0,1,2,3\}$, and asks that no column $j$ be greater than column $j-1$ \emph{in all rows}.
...
\begin{theorem}
\[
a(n)\;=\;405\,a(n-1) - 43860\,a(n-2) + 1524160\,a(n-3) - 15636480\,a(n-4) + 14155776\,a(n-5)
\]
for every $n>5$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A212926.
