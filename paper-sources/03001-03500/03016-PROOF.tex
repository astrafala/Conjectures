...
\title{The empirical recurrence for OEIS A269291, proved by transfer matrix}
...
\begin{abstract}
OEIS A269291 counts arrays of width $3$ over $\{0,1,2,3\}$ in which the number of adjacent PAIRS of
...
result is a walk count on $S=193$ states.
\end{abstract}
...
OEIS A269291 is ``Number of 3 X n 0..3 arrays with some element plus some horizontally or antidiagonally adjacent neighbor totalling three no more than once.''. It has offset $1$ and begins
\[
64, 2592, 62748, 1363572, 27788292, 544118148, 10363900428, 193439931300,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 36*a(n-1) - 378*a(n-2) + 972*a(n-3) - 729*a(n-4) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 21 2019 10:07:11, revision 8) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=193.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269291.
