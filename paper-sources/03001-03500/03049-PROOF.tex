...
\title{The empirical recurrence for OEIS A267975, proved by transfer matrix}
...
\begin{abstract}
OEIS A267975 counts arrays in which the REPEATED VALUES of each row, and of each column, stand in a
...
OEIS A267975 is ``Number of 1 X n 0..3 arrays with every repeated value in every row greater than or equal to, and in every column greater than, the previous repeated value.''. It has offset $1$ and begins
\[
4, 16, 64, 250, 964, 3674, 13868, 51917,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 12*a(n-1) - 50*a(n-2) + 72*a(n-3) + 21*a(n-4) - 72*a(n-5) - 50*a(n-6) - 12*a(n-7) -a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 26 2018 08:21:53, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;12\,a(n-1) - 50\,a(n-2) + 72\,a(n-3) + 21\,a(n-4) - 72\,a(n-5) - 50\,a(n-6) - 12\,a(n-7) - a(n-8)
\]
for every $n>7$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267975.
