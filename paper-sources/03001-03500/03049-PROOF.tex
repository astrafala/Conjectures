...
\title{The empirical recurrence for OEIS A274746, proved by counting patterns}
...
\begin{abstract}
OEIS A274746 counts arrays in which no entry may repeat a value found at any of three stated
...
cutting $60074$ pairs to $S=10355$ states. The entry's empirical recurrence of order $5$,
...
OEIS A274746 is ``Number of n X 5 0..2 arrays with no element equal to any value at offset (-1,-2) (0,-1) or (-1,0) and new values introduced in order 0..2.''. It has offset $1$ and begins
\[
8, 60, 518, 4554, 40242, 355504, 3140840, 27748676,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 9*a(n-1) - 14*a(n-3) + 10*a(n-4) - 2*a(n-5) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 30 2019 11:17:09, revision 7) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A274746.
