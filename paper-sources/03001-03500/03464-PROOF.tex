...
\title{The empirical recurrence for OEIS A208633, proved by counting patterns}
...
\begin{abstract}
OEIS A208633 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A208633 is ``Number of n X 4 0..1 arrays with new values 0..1 introduced in row major order and no element equal to more than one of its immediate leftward or upward or right-upward antidiagonal neighbors.''. It has offset $1$ and begins
\[
8, 23, 71, 225, 722, 2331, 7548, 24476,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 5*a(n-1) - 6*a(n-2) + a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 05 2018 08:22:51, revision 8) the statement is
...
\eqref{eq:walk}, divided by $2!$, was evaluated at every one of the $24$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208633.
