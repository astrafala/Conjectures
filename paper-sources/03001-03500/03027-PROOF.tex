...
\title{The empirical recurrence for OEIS A263059, proved by transfer matrix}
...
\begin{abstract}
OEIS A263059 counts arrays of width $8$ over $\{0,1\}$ whose rows, read as base-$2$
numbers, are not divisible by $3$ and whose columns, read the same way, are not divisible by
...
OEIS A263059 is ``Number of (n+1)X(7+1) 0..1 arrays with each row and column not divisible by 3, read as a binary number with top and left being the most significant bits.''. It has offset $1$ and begins
\[
170, 113486, 19499266, 4880746710, 830550961170, 155157177242886, 26380510465997186, 4591006241105432150,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 08 2015 15:01:15, revision 4) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A263059.
