...
\title{The empirical recurrence for OEIS A217953, proved by transfer matrix}
...
\begin{abstract}
OEIS A217953 carries an empirical recurrence of order $22$ contributed by R. H. Hardin. It is
...
OEIS A217953 is ``Number of n element 0..3 arrays with each element the minimum of 7 adjacent elements of a random 0..3 array of n+6 elements.''. It has offset $1$ and begins
\[
4, 16, 50, 130, 296, 610, 1163, 2083,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 17:28:52, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A217953.
