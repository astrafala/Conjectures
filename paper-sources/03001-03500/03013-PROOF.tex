...
\title{The empirical recurrence for OEIS A238510, proved by transfer matrix}
...
\begin{abstract}
OEIS A238510 counts $(n+1)\times2$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A238510 is ``Number of (n+1)X(1+1) 0..3 arrays with no element equal to all horizontal neighbors or equal to all vertical neighbors, and new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
4, 25, 295, 3113, 33837, 365740, 3958594, 42834071,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 10*a(n-1) +13*a(n-2) -44*a(n-3) -7*a(n-4) +14*a(n-5)
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 10:52:17, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A238510.
