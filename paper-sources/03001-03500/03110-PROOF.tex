...
\title{The empirical recurrence for OEIS A262331, proved by transfer matrix}
...
\begin{abstract}
OEIS A262331 counts arrays of width $8$ over $\{0,1\}$ whose rows, read as base-$2$
...
OEIS A262331 is ``Number of (n+1)X(7+1) 0..1 arrays with each row and column divisible by 3, read as a binary number with top and left being the most significant bits.''. It has offset $1$ and begins
\[
86, 783, 65610, 2767631, 237172426, 16940254423, 1456404454010, 119519290640511,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 18 2015 07:36:32, revision 4) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A262331.
