...
\title{The empirical closed form for OEIS A223772, proved}
...
\begin{abstract}
OEIS A223772 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A223772 is ``Number of n X 3 0..1 arrays with rows and columns unimodal and antidiagonals nondecreasing.''. It has offset $1$ and begins
\[
7, 28, 78, 180, 371, 707, 1269, 2170,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (1/720)*n\^{}6 + (1/80)*n\^{}5 + (29/144)*n\^{}4 + (25/48)*n\^{}3 + (1727/360)*n\^{}2 - (8/15)*n + 2.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 23 2018 08:29:43, revision 7) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{n^{6}}{720} + \frac{n^{5}}{80} + \frac{29 n^{4}}{144} + \frac{25 n^{3}}{48} + \frac{1727 n^{2}}{360} - \frac{8 n}{15} + 2.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223772.
