...
\title{The empirical column recurrences for the table OEIS A264878}
...
\begin{abstract}
OEIS A264878 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A264878 is ``T(n,k)=Number of (n+1)X(k+1) arrays of permutations of 0..(n+1)*(k+1)-1 with each element having directed index change 0,1 0,-1 -2,0 or 1,1.''. It has offset $1$, is
read by antidiagonals, and begins
\[
1, 0, 1, 1, 0, 1, 0, 1,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 27 2015 07:34:35, revision 4) these are still
...
The sequence is ``Number of (n+1)X(2) arrays of permutations of 0..(n+1)*(2)-1 with each element having directed index change 0,1 0,-1 -2,0 or 1,1.''. Its rows are the vertices of a digraph on
...
\subsection*{Row $n$$=1$}
The sequence is ``Number of (2)X(n+1) arrays of permutations of 0..(2)*(n+1)-1 with each element having directed index change 0,1 0,-1 -2,0 or 1,1.''. Its rows are the vertices of a digraph on
...
The entry gives only the order for this line: ``n=2: [order 20]''. Its model is a walk on
...
$20$ --- the stated order --- with integer coefficients
\begin{center}\small\begin{tabular}{cccccccc}
$c_{1}$ & $0$ & $c_{6}$ & $117$ & $c_{11}$ & $266$ & $c_{16}$ & $-42$ \\
$c_{2}$ & $10$ & $c_{7}$ & $143$ & $c_{12}$ & $-222$ & $c_{17}$ & $-6$ \\
$c_{3}$ & $6$ & $c_{8}$ & $-222$ & $c_{13}$ & $-143$ & $c_{18}$ & $10$ \\
$c_{4}$ & $-42$ & $c_{9}$ & $-266$ & $c_{14}$ & $117$ & $c_{19}$ & $0$ \\
$c_{5}$ & $-40$ & $c_{10}$ & $272$ & $c_{15}$ & $40$ & $c_{20}$ & $-1$ \\
\end{tabular}\end{center}
Repeating with the first $20+4$ terms removed gives order $20$ again.

\subsection*{Row $n=3$, recovered}
The entry gives only the order for this line: ``n=3: [order 46]''. Its model is a walk on
...
$46$ --- the stated order --- with integer coefficients
\[
(c_1,\dots,c_{46})=(4,\ 15,\ -68,\ -69,\ 516,\ -5,\ -2512,\ 1593,\ 11468,\ -15799,\ -49100,\ 101093,\ 164044,\ -436187,\ -389856,\ 1321846,\ 642184,\ -2924570,\ -715336,\ 4872606,\ 473736,\ -6251634,\ 0,\ 6251634,\ -473736,\ -4872606,\ 715336,\ 2924570,\ -642184,\ -1321846,\ 389856,\ 436187,\ -164044,\ -101093,\ 49100,\ 15799,\ -11468,\ -1593,\ 2512,\ 5,\ -516,\ 69,\ 68,\ -15,\ -4,\ 1).
\]
Repeating with the first $46+4$ terms removed gives order $46$ again.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264878.
