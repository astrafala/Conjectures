...
\title{The empirical recurrence for OEIS A223482, proved by transfer matrix}
...
\begin{abstract}
OEIS A223482 counts the ways of writing the vertices of a fixed graph $G$ into an array of width
$4$ so that any two cells adjacent in one of the named directions carry vertices joined by an
edge of $G$; here $G$ is dodecahedron graph. The entry carries an empirical recurrence of order $4$
...
single slice is a state and the count is a walk count on a finite digraph with $S=14518$ vertices.
\end{abstract}
...
OEIS A223482 is ``Rolling icosahedron face footprints: number of 4 X n 0..19 arrays starting with 0 where 0..19 label faces of an icosahedron and every array movement to a horizontal or antidiagonal neighbor moves across an icosahedral edge.''. It has offset $1$ and begins
\[
8000, 2187, 30375, 421875, 6526575, 101331675, 1588785975, 24919035075,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 17*a(n-1) - 16*a(n-2) - 76*a(n-3) + 64*a(n-4) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 20 2018 14:38:35, revision 7) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=14518.
\]
...
\begin{theorem}
\[
a(n)\;=\;17\,a(n-1) - 16\,a(n-2) - 76\,a(n-3) + 64\,a(n-4)
\]
for every $n>7$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223482.
