...
\title{The empirical recurrence for OEIS A235560, proved by transfer matrix}
...
\begin{abstract}
OEIS A235560 counts arrays of width $2$ over $\{0,1,2\}$ by reducing every $2\times2$ subblock to a
...
about it is one bit per adjacent pair of columns, so the count is a walk count on $S=32$
states.
\end{abstract}
...
OEIS A235560 is ``Number of (n+1) X (1+1) 0..2 arrays with the difference of the upper and lower median value of each 2 X 2 subblock in lexicographically nondecreasing order rowwise and columnwise.''. It has offset $1$ and begins
\[
81, 537, 3199, 17837, 95679, 498597, 2546207, 12796069,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 22 2022 01:21:10, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A235560.
