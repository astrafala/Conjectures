...
\title{The empirical recurrence for OEIS A205584, proved by transfer matrix}
...
\begin{abstract}
OEIS A205584 counts, up to renaming the letters, the arrays of width $3$ over at most $3$
letters in which no two $2\times2$ subblocks that are neighbours, horizontally or vertically, have the same number of equal edges. It carries an empirical recurrence of order $7$ contributed by
...
OEIS A205584 is ``Number of (n+1) X 3 0..2 arrays with no 2 X 2 subblock having the same number of equal edges as its horizontal or vertical neighbors, and new values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
74, 550, 4220, 32500, 248940, 1910922, 14668206, 112560786,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) +24*a(n-2) +82*a(n-3) +83*a(n-4) -107*a(n-5) +30*a(n-6) +250*a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 12 2018 09:49:44, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + 24\,a(n-2) + 82\,a(n-3) + 83\,a(n-4) - 107\,a(n-5) + 30\,a(n-6) + 250\,a(n-7)
\]
for every $n>7$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A205584.
