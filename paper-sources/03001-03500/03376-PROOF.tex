...
\title{The empirical recurrence for OEIS A211592, proved by transfer matrix}
...
\begin{abstract}
OEIS A211592 carries an empirical recurrence of order $13$ contributed by R. H. Hardin. It is
...
OEIS A211592 is ``Number of -2..2 arrays x(i) of n+1 elements i=1..n+1 with set{t,u,v in 0,1}((x[i+t]+x[j+u]+x[k+v])*(-1)\^{}(t+u+v)) having three, four, five, six or eight distinct values for every i,j,k<=n.''. It has offset $1$ and begins
\[
16, 52, 144, 392, 996, 2560, 6348, 16060,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 28 2023 20:16:03, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + 14\,a(n-2) - 45\,a(n-3) - 69\,a(n-4) + 250\,a(n-5) + 144\,a(n-6) - 654\,a(n-7) - 106\,a(n-8) + 832\,a(n-9) - 16\,a(n-10) - 472\,a(n-11) + 24\,a(n-12) + 96\,a(n-13)
\]
for every $n>0$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A211592.
