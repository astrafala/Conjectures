...
\title{The empirical recurrence for OEIS A239025, proved by transfer matrix}
...
\begin{abstract}
OEIS A239025 counts arrays over $\{0,1,2\}$ in which no entry may equal, modulo $3$, a given
...
OEIS A239025 is ``Number of n X 3 0..2 arrays with no element equal to the sum of elements to its left or one plus the sum of elements above it, modulo 3.''. It has offset $1$ and begins
\[
1, 4, 7, 28, 54, 212, 428, 1652,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 17*a(n-2) - 96*a(n-4) + 210*a(n-6) - 152*a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 25 2018 08:13:12, revision 10) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A239025.
