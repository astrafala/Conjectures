...
\title{The empirical recurrence for OEIS A268735, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A268735 counts arrays over $\{0,\dots,1\}$ subject to a condition on the array as a
...
OEIS A268735 is ``Number of n X 3 binary arrays with some 1 horizontally or vertically adjacent to some other 1 exactly once.''. It has offset $1$ and begins
\[
2, 15, 80, 396, 1788, 7831, 33170, 137868,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 4*a(n-1) + 8*a(n-2) - 24*a(n-3) - 38*a(n-4) + 4*a(n-5) + 12*a(n-6) - a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 14 2019 09:01:55, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) + 8\,a(n-2) - 24\,a(n-3) - 38\,a(n-4) + 4\,a(n-5) + 12\,a(n-6) - a(n-8)
\end{equation}
for all $n>8$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268735.
