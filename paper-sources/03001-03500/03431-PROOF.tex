...
\title{The empirical recurrence for OEIS A211499, proved by transfer matrix}
...
\begin{abstract}
OEIS A211499 carries an empirical recurrence of order $11$ contributed by R. H. Hardin. It is
...
OEIS A211499 is ``Number of -3..3 arrays x(i) of n+1 elements i=1..n+1 with x(i)+x(j), x(i+1)+x(j+1), -(x(i)+x(j+1)), and -(x(i+1)+x(j)) having one or three distinct values for every i<=n and j<=n.''. It has offset $1$ and begins
\[
39, 97, 207, 429, 869, 1733, 3449, 6815,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 18 2018 14:30:16, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + 6\,a(n-2) - 23\,a(n-3) - 9\,a(n-4) + 62\,a(n-5) - 2\,a(n-6) - 74\,a(n-7) + 10\,a(n-8) + 40\,a(n-9) - 4\,a(n-10) - 8\,a(n-11)
\]
for every $n>11$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A211499.
