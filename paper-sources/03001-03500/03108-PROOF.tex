...
\title{The empirical recurrence for OEIS A274752, proved by counting patterns}
...
\begin{abstract}
OEIS A274752 counts arrays in which no entry may repeat a value found at any of three stated
...
cutting $60074$ pairs to $S=10355$ states. The entry's empirical recurrence of order $16$,
...
OEIS A274752 is ``Number of 5Xn 0..2 arrays with no element equal to any value at offset (-1,-2) (0,-1) or (-1,0) and new values introduced in order 0..2.''. It has offset $1$ and begins
\[
8, 81, 610, 4967, 40242, 327123, 2661918, 21656459,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 04 2016 10:27:22, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 55\,a(n-2) + 38\,a(n-3) - 614\,a(n-4) - 600\,a(n-5) + 2769\,a(n-6) + 2140\,a(n-7) - 6482\,a(n-8) - 2606\,a(n-9) + 7803\,a(n-10) + 678\,a(n-11) - 4266\,a(n-12) + 304\,a(n-13) + 924\,a(n-14) - 72\,a(n-15) - 72\,a(n-16)
\end{equation}
for all $n>17$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A274752.
