...
\title{The empirical recurrence for OEIS A211582, proved by transfer matrix}
...
\begin{abstract}
OEIS A211582 carries an empirical recurrence of order $10$ contributed by R. H. Hardin. It is
...
OEIS A211582 is ``Number of -2..2 arrays x(i) of n+1 elements i=1..n+1 with set{t,u,v in 0,1}((x[i+t]+x[j+u]+x[k+v])*(-1)\^{}(t+u+v)) having three, four, six or seven distinct values for every i,j,k<=n.''. It has offset $1$ and begins
\[
16, 44, 116, 284, 696, 1672, 3996, 9580,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 19 2018 14:53:49, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 13\,a(n-2) - 26\,a(n-3) - 57\,a(n-4) + 116\,a(n-5) + 97\,a(n-6) - 216\,a(n-7) - 36\,a(n-8) + 144\,a(n-9) - 36\,a(n-10)
\]
for every $n>10$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A211582.
