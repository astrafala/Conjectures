...
\title{The empirical recurrence for OEIS A241050, proved by transfer matrix}
...
\begin{abstract}
OEIS A241050 counts arrays over $\{0,1,2,3\}$ in which no entry may equal, modulo $4$, a given
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-2) - a(n-4) + a(n-5) - a(n-7) + a(n-8) + a(n-11)
\]
for every $n>15$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A241050.
