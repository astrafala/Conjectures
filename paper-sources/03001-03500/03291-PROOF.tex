...
\title{The empirical recurrence for OEIS A268889, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A268889 counts arrays over $\{0,\dots,1\}$ subject to a condition on the array as a
...
OEIS A268889 is ``Number of 4Xn binary arrays with some element plus some horizontally or antidiagonally adjacent neighbor totalling two exactly once.''. It has offset $1$ and begins
\[
0, 71, 462, 4133, 27130, 186732, 1187838, 7529253,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 15 2016 11:36:23, revision 4) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268889.
