...
\title{The empirical recurrence for OEIS A269216, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A269216 counts arrays over $\{0,\dots,3\}$ subject to a condition on the array as a
...
OEIS A269216 is ``Number of 3Xn 0..3 arrays with some element plus some horizontally, diagonally or antidiagonally adjacent neighbor totalling three exactly once.''. It has offset $1$ and begins
\[
0, 1152, 18048, 308544, 4744704, 70371048, 1012764384, 14272781904,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 24*a(n-1) -130*a(n-2) -248*a(n-3) +935*a(n-4) +272*a(n-5) -1768*a(n-6) +960*a(n-7) -144*a(n-8)
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 20 2016 11:31:21, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;24\,a(n-1) - 130\,a(n-2) - 248\,a(n-3) + 935\,a(n-4) + 272\,a(n-5) - 1768\,a(n-6) + 960\,a(n-7) - 144\,a(n-8)
\end{equation}
for all $n>8$.
...
\[
\mathcal V=\bigl\{(r,c):\ r\in\{0,\dots,3\}^{3},\ c\in\{0,1\}\bigr\},
...
the digraph dense, with $(3+1)^{2\cdot3}$ edges instead of the sparse set used here.
\end{remark}
...
those integers vanishes from the index corresponding to $n=8+1$ onwards, and the run
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269216.
