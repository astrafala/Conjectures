...
\title{The empirical recurrence for OEIS A205166, proved by counting patterns}
...
\begin{abstract}
OEIS A205166 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A205166 is ``Number of (n+1)X5 0..3 arrays with every 2X2 subblock having unequal diagonal elements or unequal antidiagonal elements, and new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
33831, 26702419, 21125224557, 16713430246949, 13223001109687815, 10461512493459648399, 8276732547425415428669, 6548221560172100787717125,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 11:48:34, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;833\,a(n-1) - 33758\,a(n-2) + 523880\,a(n-3) - 3857129\,a(n-4) + 13605853\,a(n-5) - 17604432\,a(n-6) - 15652010\,a(n-7) + 55894364\,a(n-8) - 22106688\,a(n-9) - 29904720\,a(n-10) + 18240672\,a(n-11) + 492672\,a(n-12) - 1016064\,a(n-13)
\end{equation}
for all $n>13$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A205166.
