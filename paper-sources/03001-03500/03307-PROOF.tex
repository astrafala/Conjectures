...
\title{The empirical recurrence for OEIS A269209, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A269209 counts arrays over $\{0,\dots,3\}$ subject to a condition on the array as a
...
OEIS A269209 is ``Number of n X 3 0..3 arrays with some element plus some horizontally, diagonally or antidiagonally adjacent neighbor totalling three exactly once.''. It has offset $1$ and begins
\[
24, 768, 18048, 361728, 6712704, 118872576, 2039727744, 34214296320,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 30*a(n-1) - 237*a(n-2) + 180*a(n-3) - 36*a(n-4) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 20 2019 08:56:41, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;30\,a(n-1) - 237\,a(n-2) + 180\,a(n-3) - 36\,a(n-4)
\end{equation}
for all $n>5$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269209.
