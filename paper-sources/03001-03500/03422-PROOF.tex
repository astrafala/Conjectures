...
\title{The empirical closed form for OEIS A239845, proved}
...
\begin{abstract}
OEIS A239845 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
$S=99$ vertices. Any function of the form $\sum_j p_j(n)\lambda_j^{\,n}$ satisfies the
...
OEIS A239845 is ``Number of nX3 0..3 arrays with no element equal to one plus the sum of elements to its left or one plus the sum of elements above it or two plus the sum of the elements diagonally to its northwest, modulo 4.''. It has offset $1$ and begins
\[
4, 17, 68, 244, 777, 2221, 5853, 14488,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 09:33:50, revision 6) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\begin{multline*}
f(n)\;=\;\frac{n^{13}}{6227020800} - \frac{n^{12}}{119750400} \\
+ \frac{221 n^{11}}{479001600} - \frac{103 n^{10}}{10886400} \\
+ \frac{649 n^{9}}{4838400} + \frac{3569 n^{8}}{3628800} \\
- \frac{2313347 n^{7}}{43545600} + \frac{10192331 n^{6}}{10886400} \\
- \frac{87698557 n^{5}}{10886400} + \frac{82688371 n^{4}}{2721600} \\
+ \frac{101725069 n^{3}}{1247400} - \frac{505121941 n^{2}}{415800} \\
+ \frac{698568509 n}{180180} - 2851.
\end{multline*}
...
walk, so with $M$ the adjacency matrix of that digraph on $S=99$ vertices, and $u,w$ the
...
$n=24,\dots,37$ and agree at each. A monic recurrence of order $14$
determines $a(m)$ from $a(m-1),\dots,a(m-14)$, and for every $m\ge38$ both
$m>23$ and $m-14\ge24$ hold, so induction on $m$ gives $a(m)=f(m)$ for every
$m\ge24$.
Below $n=24$ the recurrence argument gives nothing, since \eqref{eq:rec} is only
established for $a$ from $n=24$ on. The remaining indices $n=10,\dots,23$ were
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A239845.
