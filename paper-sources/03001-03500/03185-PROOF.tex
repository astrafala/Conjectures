...
\title{A value repeated at its own distance: OEIS A209470}
...
\begin{abstract}
OEIS A209470 carries an empirical recurrence of order $33$ contributed by R.~H.~Hardin. It is
...
walks in it. Hence $a(n)$ is a walk count on $S=40$ vertices and is $C$-finite, and whether the
...
OEIS A209470 is ``Number of nX2 0..2 arrays with every element value z a city block distance of exactly z from another element value z.''. It has offset $1$ and begins
\[
2, 13, 93, 635, 4357, 27989, 175599, 1097149,\ \dots
\]
...
Merging vertices with identical futures leaves $S=40$. An admissible array is exactly a walk, so with $M$ the adjacency matrix and $\iota,\tau$ the vectors recording which states may begin and end an array,
\[
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-1) - 7\,a(n-2) - 4\,a(n-3) + 66\,a(n-4) + 304\,a(n-5) + 718\,a(n-6) + 1784\,a(n-7) - 1409\,a(n-8) - 3322\,a(n-9) - 13020\,a(n-10) - 15966\,a(n-11) - 18299\,a(n-12) - 14110\,a(n-13) - 25099\,a(n-14) - 14477\,a(n-15) - 28326\,a(n-16) + 8287\,a(n-17) - 13319\,a(n-18) + 13953\,a(n-19) - 8803\,a(n-20) + 22525\,a(n-21) + 4118\,a(n-22) + 2705\,a(n-23) + 3161\,a(n-24) + 4528\,a(n-25) - 280\,a(n-26) - 1198\,a(n-27) - 384\,a(n-28) - 1636\,a(n-29) - 200\,a(n-30) + 80\,a(n-31) + 32\,a(n-32) + 128\,a(n-33)
\]
for every $n>33$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209470.
