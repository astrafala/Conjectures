...
\title{The empirical closed form for OEIS A223757, proved}
...
\begin{abstract}
OEIS A223757 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A223757 is ``Number of nX3 0..3 arrays with rows, antidiagonals and columns unimodal.''. It has offset $1$ and begins
\[
50, 2500, 61733, 916107, 9478535, 74824917, 477860225, 2571238699,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 22:21:28, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\begin{multline*}
f(n)\;=\;\frac{89 n^{18}}{169374965760} + \frac{673039 n^{17}}{29640619008000} \\
+ \frac{5753323 n^{16}}{10461394944000} + \frac{20639 n^{15}}{2335132800} \\
+ \frac{5460977 n^{14}}{52306974720} + \frac{350675333 n^{13}}{373621248000} \\
+ \frac{34569853 n^{12}}{5225472000} + \frac{744079211 n^{11}}{20118067200} \\
+ \frac{1214093389 n^{10}}{7315660800} + \frac{3120210973 n^{9}}{5225472000} \\
+ \frac{1381865894063 n^{8}}{804722688000} + \frac{2224350329 n^{7}}{574801920} \\
+ \frac{252375235967 n^{6}}{37362124800} + \frac{1486577243227 n^{5}}{163459296000} \\
+ \frac{2159143550149 n^{4}}{217945728000} + \frac{154699301 n^{3}}{14414400} \\
- \frac{959722661 n^{2}}{467812800} + \frac{50040773 n}{6126120} \\
+ 1.
\end{multline*}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223757.
