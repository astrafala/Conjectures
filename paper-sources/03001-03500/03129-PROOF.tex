...
\title{The empirical recurrence for OEIS A206754, proved by transfer matrix}
...
\begin{abstract}
OEIS A206754 counts, up to renaming the letters, the arrays of width $2$ over at most $3$
letters in which every $2\times3$ and $3\times2$ subblock has at most $3$ equal edges, an edge of such a window being one of the six steps of its perimeter cycle and an equal edge one whose two cells agree. It carries an empirical recurrence of order $5$ contributed by
...
OEIS A206754 is ``Number of (n+1) X 2 0..2 arrays with every 2 X 3 or 3 X 2 subblock having no more than three equal edges, and new values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
14, 106, 861, 7010, 56970, 463064, 3764188, 30597928,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 7*a(n-1) + 5*a(n-2) + 34*a(n-3) - 2*a(n-4) + 12*a(n-5) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 17 2018 10:45:13, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-1) + 5\,a(n-2) + 34\,a(n-3) - 2\,a(n-4) + 12\,a(n-5)
\]
for every $n>6$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206754.
