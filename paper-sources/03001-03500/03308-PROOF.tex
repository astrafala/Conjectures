...
\title{The empirical recurrence for OEIS A275186, proved by transfer matrix}
...
\begin{abstract}
OEIS A275186 counts arrays in which no entry may equal the entries at a short list of fixed offsets
...
OEIS A275186 is ``Number of 6 X n 0..2 arrays with no element equal to any value at offset (-2,-1) (-1,0) or (-1,1) and new values introduced in order 0..2.''. It has offset $1$ and begins
\[
16, 37, 181, 914, 4603, 23313, 117916, 596625,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + 12*a(n-2) + 19*a(n-3) - 4*a(n-4) - 12*a(n-5) - 16*a(n-6) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 01 2019 11:55:39, revision 7) this is still
...
\[
x(i,j)\ \ne\ x(i+d_1,\,j+d_2)\qquad\text{for each offset }(d_1,d_2)\in\{(-2,-1), (-1,0), (-1,1)\}
\]
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 12\,a(n-2) + 19\,a(n-3) - 4\,a(n-4) - 12\,a(n-5) - 16\,a(n-6)
\]
for every $n>7$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A275186.
