...
\title{The empirical recurrence for OEIS A209823, proved by counting patterns}
...
\begin{abstract}
OEIS A209823 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A209823 is ``Number of (n+1) X 3 0..2 arrays with every 2 X 2 subblock having one or two distinct values, and new values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
41, 425, 4418, 46034, 479693, 4998707, 52089776, 542809448,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 12*a(n-1) - 16*a(n-2) - 6*a(n-3) + 13*a(n-4) - 2*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 13 2018 05:47:57, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;12\,a(n-1) - 16\,a(n-2) - 6\,a(n-3) + 13\,a(n-4) - 2\,a(n-5)
\end{equation}
for all $n>4$.
...
For every $n$ with $m=n+1-1\ge5$,
\[
3!\Bigl(a(n)-\sum_i c_i\,a(n-i)\Bigr)\;=\;\mathbf{v}^{\!\top}N^{\,m-5}q(N)\mathbf{1} .
\]
...
\eqref{eq:walk}, divided by $3!$, was evaluated at every one of the $17$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209823.
