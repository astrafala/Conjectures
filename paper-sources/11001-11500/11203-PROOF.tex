...
\title{The empirical recurrence for OEIS A237029, proved by transfer matrix}
...
\begin{abstract}
OEIS A237029 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
The condition is local to two consecutive rows, so the count is a walk count on $S=36$
...
OEIS A237029 is ``Number of (n+1) X (2+1) 0..2 arrays with the maximum of every 2 X 2 subblock equal.''. It has offset $1$ and begins
\[
563, 11205, 221994, 4552617, 93224611, 1918085364, 39451935691, 811987649749,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 22*a(n-1) +31*a(n-2) -1351*a(n-3) +2166*a(n-4) +3313*a(n-5) -5940*a(n-6) +1760*a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 28 2014 03:40:33, revision 8) this is still
...
array, which is not among the objects counted. There are $S=36$ states left.
...
\begin{theorem}
\[
a(n)\;=\;22\,a(n-1) + 31\,a(n-2) - 1351\,a(n-3) + 2166\,a(n-4) + 3313\,a(n-5) - 5940\,a(n-6) + 1760\,a(n-7)
\]
for every $n>6$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237029.
