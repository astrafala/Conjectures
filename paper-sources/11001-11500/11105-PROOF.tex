...
\title{The empirical recurrence for OEIS A206112, proved by transfer matrix}
...
\begin{abstract}
OEIS A206112 counts arrays over $\{0,\dots,3\}$ under a condition on the perimeter cycle of
...
a bounded window of consecutive rows, so the count is a walk count on $S=1140$ states and is
...
OEIS A206112 is ``Number of (n+1) X 3 0..3 arrays with every 2 X 3 or 3 X 2 subblock having exactly two counterclockwise and two clockwise edge increases.''. It has offset $1$ and begins
\[
1140, 5228, 22624, 111552, 588840, 3048096, 16072760, 84203240,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + 19*a(n-2) + 6*a(n-3) - 90*a(n-4) + 19*a(n-5) + 45*a(n-6) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 13 2018 12:00:12, revision 10) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206112.
