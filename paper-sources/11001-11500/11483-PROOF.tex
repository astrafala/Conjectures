...
\title{The empirical recurrence for OEIS A252110, proved by transfer matrix}
...
\begin{abstract}
OEIS A252110 counts $(n+2)\times6$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
$a(n)$ is a walk count on $S=649260$ vertices. Such a sequence is $C$-finite, so whether a given
...
OEIS A252110 is ``Number of (n+2) X (4+2) 0..3 arrays with every 3 X 3 subblock row and column sum equal to 0 2 3 6 or 7 and every 3 X 3 diagonal and antidiagonal sum not equal to 0 2 3 6 or 7.''. It has offset $1$ and begins
\[
1600, 584, 776, 1314, 1956, 2658, 4488, 7248,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-3) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 01 2018 10:13:08, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252110.
