...
\title{The empirical recurrence for OEIS A250447, proved by transfer matrix}
...
\begin{abstract}
OEIS A250447 counts arrays over $\{0,1,2\}$ in which a statistic taken over short runs
...
OEIS A250447 is ``Number of (n+1)X(1+1) 0..2 arrays with nondecreasing min(x(i,j),x(i,j-1)) in the i direction and nondecreasing min(x(i,j),x(i-1,j)) in the j direction.''. It has offset $1$ and begins
\[
44, 217, 1000, 4535, 20242, 89677, 395240, 1736779,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 6*a(n-1) - 3*a(n-2) - 20*a(n-3) + 6*a(n-4) + 12*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 14 2018 09:36:36, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250447.
