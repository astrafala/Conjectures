...
\title{The empirical recurrence for OEIS A186458, proved by transfer matrix}
...
\begin{abstract}
OEIS A186458 counts the $(n+1)\times6$ arrays over $\{0,\dots,1\}$ in which
...
a state, the count is a walk count on $S=106$ of them, and the conjectured recurrence is then
...
OEIS A186458 is ``Number of (n+1) X 6 binary arrays with every 2 X 2 subblock commuting with each of its horizontal and vertical 2 X 2 subblock neighbors.''. It has offset $1$ and begins
\[
106, 128, 270, 449, 797, 1061, 1681, 2285,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) - 2*a(n-3) + 2*a(n-4) - a(n-5) for n>11.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 17 2018 14:13:22, revision 8) this is still
...
$106$, which the model reproduces along with every later term.
...
\]
on the $S=106$ admissible $2$-tuples. In particular $a$ is $C$-finite.
...
size of the construction is therefore $2^{2\cdot6}$ before the condition prunes
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A186458.
