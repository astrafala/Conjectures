...
\title{The empirical recurrence for OEIS A202428, proved by transfer matrix}
...
\begin{abstract}
OEIS A202428 counts arrays of width $3$ over $\{0,1\}$ containing no occurrence of certain short
...
OEIS A202428 is ``Number of (n+2) X 3 binary arrays avoiding patterns 000 and 001 in rows, columns and nw-to-se diagonals.''. It has offset $1$ and begins
\[
108, 390, 1344, 4680, 16254, 56508, 196350, 682452,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) +7*a(n-2) +6*a(n-3) -a(n-4) -2*a(n-5) +a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (May 28 2018 11:48:32, revision 9) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A202428.
