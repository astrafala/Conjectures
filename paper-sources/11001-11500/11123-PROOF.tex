...
\title{The empirical recurrence for OEIS A259994, proved by transfer matrix}
...
\begin{abstract}
OEIS A259994 counts $(n+2)\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A259994 is ``Number of (n+2) X (1+2) 0..1 arrays with each 3 X 3 subblock having clockwise perimeter pattern 00000001 00000011 or 00000101.''. It has offset $1$ and begins
\[
48, 99, 284, 641, 1228, 2943, 7284, 15683,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + 5*a(n-3) + 7*a(n-4) - 7*a(n-5) - 5*a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 27 2018 11:57:46, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 5\,a(n-3) + 7\,a(n-4) - 7\,a(n-5) - 5\,a(n-7)
\]
for every $n>7$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A259994.
