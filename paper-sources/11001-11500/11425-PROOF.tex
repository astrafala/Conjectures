...
\title{The empirical recurrence for OEIS A203791, proved by transfer matrix}
...
\begin{abstract}
OEIS A203791 counts $(n+1)\times4$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A203791 is ``Number of (n+1) X 4 0..3 arrays with every 2 X 2 subblock having equal diagonal elements or equal antidiagonal elements.''. It has offset $1$ and begins
\[
5488, 142192, 3784288, 101071600, 2700695728, 72168659104, 1928524187248, 51534966781936,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 31*a(n-1) -117*a(n-2) +72*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 05 2018 08:18:53, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;31\,a(n-1) - 117\,a(n-2) + 72\,a(n-3)
\end{equation}
for all $n>2$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A203791.
