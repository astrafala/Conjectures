...
\title{The empirical recurrence for OEIS A247720, proved by transfer matrix}
...
\begin{abstract}
OEIS A247720 carries an empirical recurrence of order $5$ contributed by R.~H.~Hardin. It is
...
OEIS A247720 is ``Number of length n+3 0..2 arrays with no disjoint pairs in any consecutive four terms having the same sum.''. It has offset $1$ and begins
\[
48, 90, 172, 334, 656, 1300, 2584, 5148,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) +2*a(n-4) -4*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 11:36:25, revision 9) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A247720.
