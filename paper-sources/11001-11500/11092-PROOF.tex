...
\title{The empirical recurrence for OEIS A196917, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A196917 counts arrays over $\{0,\dots,4\}$ in which every cell is constrained by the
...
OEIS A196917 is ``Number of n X 3 0..4 arrays with each element x equal to the number its horizontal and vertical neighbors equal to 1,3,2,4,0 for x=0,1,2,3,4.''. It has offset $1$ and begins
\[
1, 3, 7, 12, 27, 58, 121, 257,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) +a(n-3) -a(n-4) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (May 09 2018 15:55:51, revision 9) the statement is
...
\#\{\text{neighbours with value }f(x_{t,u})\}=x_{t,u},\quad f=(1,3,2,4,0)
\end{equation}
for every cell $(t,u)$.
...
$5$ values, so there are about $10^{65}$ of them to sift. The
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A196917.
