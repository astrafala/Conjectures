...
\title{The empirical recurrence for OEIS A295841, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A295841 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A295841 is ``Number of n X 2 0..1 arrays with each 1 adjacent to 1 or 2 king-move neighboring 1s.''. It has offset $1$ and begins
\[
2, 11, 29, 80, 261, 789, 2354, 7199,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) - a(n-2) + 6*a(n-3) - 8*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 22 2019 10:04:52, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) - a(n-2) + 6\,a(n-3) - 8\,a(n-4)
\end{equation}
for all $n>5$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A295841.
