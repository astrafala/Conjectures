...
\title{The empirical recurrence for OEIS A259421, proved by transfer matrix}
...
\begin{abstract}
OEIS A259421 counts arrays of width $3$ over $\{0,1\}$ subject to a condition read round the
...
OEIS A259421 is ``Number of (n+1) X (2+1) 0..1 arrays with each 2 X 2 subblock having clockwise pattern 0000 0001 0011 or 0111.''. It has offset $1$ and begins
\[
43, 243, 1366, 7695, 43347, 244228, 1376077, 7753553,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 6*a(n-1) + 2*a(n-2) - 22*a(n-3) - 6*a(n-4) + 6*a(n-5) + a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 25 2018 08:30:22, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A259421.
