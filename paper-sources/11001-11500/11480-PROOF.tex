...
\title{The empirical recurrence for OEIS A253220, proved by transfer matrix}
...
\begin{abstract}
OEIS A253220 carries an empirical recurrence of order $3$ contributed by R. H. Hardin. It is
...
\begin{quote}
Empirical: a(n) = 6400*n\^{}2 - 71990*n + 206573 for n>8. a(n) = 3*a(n-1) - 3*a(n-2) + a(n-3) for n>11.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 10 2018 08:54:52, revision 8) this is still
