...
\title{The empirical recurrence for OEIS A232290, proved by transfer matrix}
...
\begin{abstract}
OEIS A232290 counts arrays of width $3$ over $\{0,1,2\}$ in which every cell carrying one stated
...
OEIS A232290 is ``Number of n X 3 0..2 arrays with every 0 next to a 1 and every 1 next to a 2 horizontally or antidiagonally.''. It has offset $1$ and begins
\[
7, 97, 1313, 17759, 240241, 3249889, 43963319, 594719777,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 12*a(n-1) + 20*a(n-2) + 9*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 04 2018 11:50:36, revision 8) this is still
...
adjacency matrix,
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=517.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232290.
