...
\title{The empirical recurrence for OEIS A259518, proved by transfer matrix}
...
\begin{abstract}
OEIS A259518 counts arrays of width $3$ over $\{0,1\}$ subject to a condition read round the
...
OEIS A259518 is ``Number of (n+1) X (2+1) 0..1 arrays with each 2 X 2 subblock having clockwise pattern 0000 0001 0011 0101 or 1111.''. It has offset $1$ and begins
\[
38, 208, 1122, 6100, 33162, 180370, 981092, 5336678,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 7*a(n-1) - 7*a(n-2) - 10*a(n-3) + 10*a(n-4) + 2*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 25 2018 11:15:18, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-1) - 7\,a(n-2) - 10\,a(n-3) + 10\,a(n-4) + 2\,a(n-5)
\]
for every $n>3$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A259518.
