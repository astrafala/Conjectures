...
\title{The empirical recurrence for OEIS A255988, proved by transfer matrix}
...
\begin{abstract}
OEIS A255988 carries an empirical recurrence of order $5$ contributed by R.~H.~Hardin. It is
...
OEIS A255988 is ``Number of length n+4 0..1 arrays with at most one downstep in every 4 consecutive neighbor pairs.''. It has offset $1$ and begins
\[
26, 45, 80, 144, 256, 451, 796, 1413,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) -a(n-2) +3*a(n-4) -2*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 24 2018 14:03:07, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) - a(n-2) + 3\,a(n-4) - 2\,a(n-5)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A255988.
