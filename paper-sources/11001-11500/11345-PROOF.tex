...
\title{The empirical recurrence for OEIS A205982, proved by transfer matrix}
...
\begin{abstract}
OEIS A205982 counts arrays over $\{0,\dots,2\}$ under a condition on the perimeter cycle of
...
a bounded window of consecutive rows, so the count is a walk count on $S=11568$ states and is
...
OEIS A205982 is ``Number of (n+1)X5 0..2 arrays with every 2X3 or 3X2 subblock having exactly two clockwise edge increases.''. It has offset $1$ and begins
\[
11568, 33504, 103998, 419088, 1814784, 7793856, 35107968, 152423040,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 84*a(n-3) for n>9
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 12:22:16, revision 10) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A205982.
