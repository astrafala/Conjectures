...
\title{The empirical recurrence for OEIS A228791, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A228791 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A228791 is ``Number of n X 3 binary arrays with top left element equal to 1 and no two ones adjacent horizontally or nw-se.''. It has offset $1$ and begins
\[
2, 8, 36, 156, 672, 2892, 12444, 53544,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 5*a(n-1) - 3*a(n-2) for n>3.
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 13 2018 06:07:56, revision 12) the statement is
...
walk count replaces that by $8$ states and one matrix--vector product per row.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A228791.
