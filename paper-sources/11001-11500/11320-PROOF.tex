...
\title{The empirical recurrence for OEIS A204282, proved by transfer matrix}
...
\begin{abstract}
OEIS A204282 counts $(n+2)\times8$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A204282 is ``Number of (n+2) X 8 0..2 arrays with every 3 X 3 subblock having three equal elements in a row horizontally, vertically, diagonally or antidiagonally exactly three ways, and new values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
14141, 735, 778, 982, 996, 1496, 2860, 5500,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) -6*a(n-4) +4*a(n-6) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 07 2018 02:51:06, revision 11) this is still
...
$u_1,u_2,\dots$ over $\{0,\dots,2\}^{8}$, the condition
\[
...
\]
on $S=21607$ vertices in total, the exponent fixed by the entry's own shape and checked against
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204282.
