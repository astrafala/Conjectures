...
\title{The empirical recurrence for OEIS A228680, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A228680 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A228680 is ``Number of n X 5 binary arrays with no two ones adjacent horizontally, diagonally or antidiagonally.''. It has offset $1$ and begins
\[
13, 97, 809, 6737, 56549, 475809, 4008817, 33795201,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 12*a(n-1) -27*a(n-2) -32*a(n-3) +49*a(n-4) +20*a(n-5) -5*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 19 2023 19:39:00, revision 13) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A228680.
