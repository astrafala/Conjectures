...
\title{The empirical recurrence for OEIS A234162, proved by transfer matrix}
...
\begin{abstract}
OEIS A234162 counts $2$-column arrays over $\{0,\dots,4\}$ in which every
...
OEIS A234162 is ``Number of (n+1) X (1+1) 0..4 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 2 (constant-stress 1 X 1 tilings).''. It has offset
$1$ and begins
\[
136, 766, 4296, 24158, 135752, 764190, 4299592,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 4*a(n-1) + 41*a(n-2) - 132*a(n-3) - 264*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 20 2022 21:34:54, revision 13) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234162.
