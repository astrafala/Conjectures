...
\title{The empirical recurrence for OEIS A295979, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A295979 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A295979 is ``Number of n X 2 0..1 arrays with each 1 adjacent to 2 or 3 king-move neighboring 1s.''. It has offset $1$ and begins
\[
1, 6, 15, 28, 90, 281, 737, 2095,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) - 2*a(n-2) + 9*a(n-3) - 10*a(n-4) - 4*a(n-5) - 4*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 22 2019 11:22:34, revision 7) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) - 2\,a(n-2) + 9\,a(n-3) - 10\,a(n-4) - 4\,a(n-5) - 4\,a(n-6)
\end{equation}
for all $n>7$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A295979.
