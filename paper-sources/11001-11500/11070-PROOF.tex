...
\title{The empirical recurrence for OEIS A208559, proved by transfer matrix}
...
\begin{abstract}
OEIS A208559 counts arrays over $\{0,\dots,1\}$ of width $7$ that avoid the patterns
...
OEIS A208559 is ``Number of 7 X n 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 0 1 and 0 1 1 vertically.''. It has offset
$1$ and begins
\[
20, 400, 1260, 11020, 52000, 351140, 1913940,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) + 31*a(n-2) + 12*a(n-3) - 144*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 05 2018 07:03:45, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208559.
