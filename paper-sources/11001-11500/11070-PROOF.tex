...
\title{The empirical recurrence for OEIS A255753, proved by transfer matrix}
...
\begin{abstract}
OEIS A255753 counts the arrays over $\{0,\dots,1\}$ whose $3\times3$ subblocks carry a
...
OEIS A255753 is ``Number of (n+2)X(5+2) 0..1 arrays with every 3X3 subblock sum of the medians of the diagonal and antidiagonal minus the two sums of the central row and column nondecreasing horizontally, vertically and ne-to-sw antidiagonally.''. It has offset $1$ and begins
\[
99200, 180619, 197284, 203503, 196744, 237248, 300504, 402972,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) -a(n-2) +4*a(n-4) -8*a(n-5) +4*a(n-6) for n>18
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 15:11:37, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A255753.
