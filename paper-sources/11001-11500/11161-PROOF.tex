...
\title{The empirical recurrence for OEIS A196976, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A196976 counts arrays over $\{0,\dots,4\}$ in which every cell is constrained by the
...
OEIS A196976 is ``Number of n X 2 0..4 arrays with each element x equal to the number its horizontal and vertical neighbors equal to 3,2,1,0,4 for x=0,1,2,3,4.''. It has offset $1$ and begins
\[
1, 5, 14, 37, 104, 290, 803, 2233,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) + a(n-2) + 4*a(n-3) - 2*a(n-4) - a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 01 2018 11:07:01, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A196976.
