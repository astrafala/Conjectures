...
\title{The empirical recurrence for OEIS A233611, proved by transfer matrix}
...
\begin{abstract}
OEIS A233611 counts arrays of width $3$ over $\{0,1,2\}$ containing no run of $3$ consecutive
...
OEIS A233611 is ``Number of (n+2) X (1+2) 0..2 arrays with no increasing sequence of length 3 horizontally or diagonally downwards.''. It has offset $1$ and begins
\[
17064, 430608, 10864544, 274119232, 6916192896, 174499696896, 4402732038656, 111083570603008,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 26*a(n-1) - 16*a(n-2) - 88*a(n-3) + 48*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 11 2018 09:02:48, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A233611.
