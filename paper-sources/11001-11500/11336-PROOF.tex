...
\title{The empirical recurrence for OEIS A297883, proved by transfer matrix}
...
\begin{abstract}
OEIS A297883 counts $2$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $equal to$ itself lying in $\{0,1,2,4\}$, and it carries an empirical
...
OEIS A297883 is ``Number of n X 2 0..1 arrays with every element equal to 0, 1, 2 or 4 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
2, 7, 13, 29, 69, 137, 301, 705,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) - 2*a(n-2) + 8*a(n-3) -  20*a(n-4) + 8*a(n-5) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 19 2018 14:05:47, revision
7) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) - 2\,a(n-2) + 8\,a(n-3) - 20\,a(n-4) + 8\,a(n-5)
\end{equation}
for all $n>6$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297883.
