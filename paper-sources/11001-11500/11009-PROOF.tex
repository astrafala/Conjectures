...
\title{The empirical recurrence for OEIS A184556, proved by transfer matrix}
...
\begin{abstract}
OEIS A184556 counts $(n+1)\times2$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A184556 is ``Number of (n+1) X 2 0..2 arrays with no 2 X 2 subblock summing to less than 4.''. It has offset $1$ and begins
\[
50, 336, 2167, 14180, 92429, 603249, 3935721, 25680486,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 6*a(n-1) + 7*a(n-2) - 23*a(n-3) - 4*a(n-4) + 12*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 27 2018 10:38:26, revision 9) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A184556.
