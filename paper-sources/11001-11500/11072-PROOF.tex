...
\title{The empirical recurrence for OEIS A190029, proved by transfer matrix}
...
\begin{abstract}
OEIS A190029 counts the $(n+2)\times7$ arrays over $\{0,\dots,1\}$ in which
...
a state, the count is a walk count on $S=616$ of them, and the conjectured recurrence is then
...
OEIS A190029 is ``Number of (n+2) X 7 binary arrays with every 3 X 3 subblock commuting with each horizontal and vertical neighbor 3 X 3 subblock.''. It has offset $1$ and begins
\[
616, 235, 362, 578, 834, 970, 1162, 1418,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) -a(n-2) +a(n-3) -2*a(n-4) +a(n-5) +a(n-6) -a(n-7) for n>13.
\end{quote}
As of the ``Last modified'' line on the live entry (May 03 2018 08:53:07, revision 8) this is still
...
$616$, which the model reproduces along with every later term.
...
\]
on the $S=616$ admissible $3$-tuples. In particular $a$ is $C$-finite.
...
size of the construction is therefore $2^{3\cdot7}$ before the condition prunes
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A190029.
