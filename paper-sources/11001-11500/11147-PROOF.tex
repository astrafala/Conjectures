...
\title{The empirical recurrence for OEIS A188827, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A188827 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A188827 is ``Number of 5 X n binary arrays without the pattern 0 1 diagonally or antidiagonally.''. It has offset $1$ and begins
\[
32, 36, 120, 400, 1360, 4624, 15776, 53824,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 4*a(n-1) -8*a(n-3) +4*a(n-4) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 30 2018 12:35:04, revision 9) the statement is
...
\text{no }0,1\text{ occurs consecutively along any direction in }\mathcal N
\end{equation}
for every cell $(t,u)$.
...
publishes, $n=23$, the arrays have $5\cdot23$ cells over
...
the middle column. The vector $w$ was formed by $4$ applications of $G$ in exact integer
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A188827.
