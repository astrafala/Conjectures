...
\title{The empirical recurrence for OEIS A204611, proved by transfer matrix}
...
\begin{abstract}
OEIS A204611 counts arrays over $\{0,\dots,1\}$ under a condition on the determinant of every
...
a bounded window of consecutive rows, so the count is a walk count on $S=125$ states and is
...
OEIS A204611 is ``Number of (n+1)X4 0..1 arrays with the determinants of 2X2 subblocks nondecreasing rightwards and downwards.''. It has offset $1$ and begins
\[
125, 749, 4901, 31805, 205117, 1322417, 8522985, 54938417,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 9*a(n-1) -8*a(n-2) -72*a(n-3) +96*a(n-4) +128*a(n-5) -128*a(n-6) -64*a(n-7) for n>10
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 11:21:28, revision 9) this is still
...
entry's first term is $125$, and the model reproduces it along with every later term; that
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204611.
