...
\title{The empirical recurrence for OEIS A205983, proved by transfer matrix}
...
\begin{abstract}
OEIS A205983 counts arrays over $\{0,\dots,2\}$ under a condition on the perimeter cycle of
...
a bounded window of consecutive rows, so the count is a walk count on $S=60432$ states and is
...
OEIS A205983 is ``Number of (n+1)X6 0..2 arrays with every 2X3 or 3X2 subblock having exactly two clockwise edge increases.''. It has offset $1$ and begins
\[
60432, 140802, 408411, 1814784, 9653376, 50843904, 279003648, 1502833632,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 156*a(n-3) for n>10
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 12:22:23, revision 9) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A205983.
