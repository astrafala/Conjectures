...
\title{The empirical recurrence for OEIS A235216, proved by transfer matrix}
...
\begin{abstract}
OEIS A235216 counts arrays of width $2$ over $\{0,1,2\}$ subject to a condition read round the
...
OEIS A235216 is ``Number of (n+1) X (1+1) 0..2 arrays with 2 X 2 edge jumps all no more than +1 in one of the clockwise or counterclockwise directions or both.''. It has offset $1$ and begins
\[
59, 427, 3037, 21693, 154811, 1105027, 7887229, 56296365,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 6*a(n-1) + 9*a(n-2) - 6*a(n-3) - 2*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 17 2018 09:29:21, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A235216.
