...
\title{The empirical recurrence for OEIS A204415, proved by transfer matrix}
...
\begin{abstract}
OEIS A204415 counts $(n+2)\times8$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
$a(n)$ is a walk count on $S=301408$ vertices. Such a sequence is $C$-finite, so whether a given
...
OEIS A204415 is ``Number of (n+2)X8 0..2 arrays with every 3X3 subblock having three strictly increasing elements in a row horizontally or vertically, exactly one way.''. It has offset $1$ and begins
\[
254913953, 395943745, 422397021, 1122887052, 1364559057, 2050960896, 13168291392, 115434720000,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 577*a(n-3) for n>17
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 11:13:45, revision 9) this is still
...
at once. By Lemma~\ref{lem:crit} the recurrence holds for every $n>17$.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204415.
