...
\title{The empirical recurrence for OEIS A264123, proved by transfer matrix}
...
\begin{abstract}
OEIS A264123 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=4$ rows in which
...
OEIS A264123 is ``Number of (n+1) X (3+1) arrays of permutations of 0..n*4+3 with each element having index change +-(.,.) 0,0 1,-2 or 2,-1.''. It has offset $1$ and begins
\[
4, 45, 576, 5733, 53361, 533610, 5336100, 53361000,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 10*a(n-1) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 29 2023 11:23:22, revision 11) this is still
...
\[
(i-h_i,\,j-h_j)\;\in\;\{(-2,1),\ (-1,2),\ (0,0),\ (1,-2),\ (2,-1)\},
\]
...
until the working vector was identically zero, settling every larger $j$ at once. The bound is exact: at $n=5$ the recurrence fails on the entry's own published terms, so no larger range holds.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264123.
