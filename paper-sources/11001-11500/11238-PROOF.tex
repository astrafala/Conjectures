...
\title{The empirical recurrence for OEIS A235947, proved by transfer matrix}
...
\begin{abstract}
OEIS A235947 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
OEIS A235947 is ``Number of (n+1) X (1+1) 0..2 arrays colored with the upper median value of each 2 X 2 subblock.''. It has offset $1$ and begins
\[
81, 294, 905, 2584, 7353, 20800, 58896, 167240,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 8*a(n-3) + 36*a(n-4) + 48*a(n-6) for n>9.
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 20 2018 10:22:55, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The $2\times2$ subblocks of an $(n+1)\times2$ array form an
$n\times1$ grid. Colour each of them by $\sigma=c$, where $a\le b\le c\le d$ are its four entries sorted --- its minimum, lower median, upper median and maximum. ``Coloured with'' is the entry's way of
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A235947.
