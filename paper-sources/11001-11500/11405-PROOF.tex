...
\title{The empirical recurrence for OEIS A251500, proved by transfer matrix}
...
\begin{abstract}
OEIS A251500 counts $2$-column arrays over $\{0,\dots,3\}$ in which every
...
OEIS A251500 is ``Number of (n+1) X (1+1) 0..3 arrays with every 2 X 2 subblock summing to 3 4 5 6 7 8 or 9.''. It has offset $1$
and begins
\[
226, 3250, 46684, 670690, 9635410, 138426508, 1988695378, 28570462642,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 13*a(n-1) + 21*a(n-2) - 18*a(n-3) - 24*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 29 2018 15:41:06, revision 9) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251500.
