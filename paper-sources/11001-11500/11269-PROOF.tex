...
\title{The empirical recurrence for OEIS A207896, proved by transfer matrix}
...
\begin{abstract}
OEIS A207896 counts arrays over $\{0,\dots,1\}$ of width $3$ that avoid the patterns
...
OEIS A207896 is ``Number of 3 X n 0..1 arrays avoiding 0 0 0 and 1 0 1 horizontally and 0 0 0 and 1 1 1 vertically.''. It has offset
$1$ and begins
\[
6, 36, 84, 198, 462, 1080, 2520,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) + 2*a(n-2) + 2*a(n-3) + a(n-4) + a(n-5) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 26 2018 06:09:36, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207896.
