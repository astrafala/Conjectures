...
\title{The empirical recurrence for OEIS A299190, recovered from its tail}
...
\begin{abstract}
OEIS A299190 records ``Empirical recurrence of order $69$'' and keeps the recurrence itself in
...
OEIS A299190 is ``Number of nX4 0..1 arrays with every element equal to 0, 1, 3, 4, 6 or 7 king-move adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
5, 13, 9, 80, 220, 518, 2466, 8609,\ \dots
\]
The entry states:
\begin{quote}
Empirical recurrence of order 69 (see link above)
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 04 2018 13:25:36, revision 4)
...
\begin{theorem}
The recurrence above holds for every $n\ge71$, and it is the recurrence OEIS A299190 records.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A299190.
