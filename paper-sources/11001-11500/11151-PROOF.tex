...
\title{The empirical recurrence for OEIS A206087, proved by transfer matrix}
...
\begin{abstract}
OEIS A206087 counts arrays over $\{0,\dots,2\}$ under a condition on the perimeter cycle of
...
OEIS A206087 is ``Number of (n+1) X 2 0..2 arrays with every 2 X 3 or 3 X 2 subblock having exactly two counterclockwise and two clockwise edge increases.''. It has offset $1$ and begins
\[
81, 270, 972, 3564, 13608, 52812, 205416, 803844,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) - a(n-2) + 12*a(n-3) - 36*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 13 2018 11:23:49, revision 12) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206087.
