...
\title{The empirical recurrence for OEIS A206200, proved by transfer matrix}
...
\begin{abstract}
OEIS A206200 counts arrays over $\{0,\dots,3\}$ under a condition on the perimeter cycle of
...
a bounded window of consecutive rows, so the count is a walk count on $S=480$ states and is
...
OEIS A206200 is ``Number of (n+1) X 3 0..3 arrays with every 2 X 3 or 3 X 2 subblock having exactly one clockwise edge increases.''. It has offset $1$ and begins
\[
480, 1060, 3008, 9464, 22576, 67968, 192808, 496088,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-2) + 14*a(n-3) - 3*a(n-4) + a(n-5) + a(n-6) + a(n-7) for n > 9.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 14 2018 08:18:52, revision 10) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-2) + 14\,a(n-3) - 3\,a(n-4) + a(n-5) + a(n-6) + a(n-7)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206200.
