...
\title{A proof of the conjectured recurrence for OEIS A228329}
...
\begin{abstract}
OEIS A228329 carries a conjectured linear recurrence with polynomial coefficients, of
...
OEIS A228329 is ``a(n) = Sum\_\{k=0..n\} (k+1)\^{}2*T(n,k)\^{}2 where T(n,k) is the Catalan triangle A039598''. It has offset $0$ and begins
\[
a(0),\dots,a(7)\;=\;1, 8, 98, 1320, 18590, 268736, 3952228, 58837680,\ \dots
\]
The entry states, not as a conjecture,
\begin{quote}\small
a(n) = ((4n)!*(3n+1))/((2n)!\^{}2*(2n+1)) = binomial(4n,2n)*(3n+1)/(2n+1). - \emph{Philippe Deléham}, Nov 25 2013
\end{quote}
that is,
\begin{equation}\label{eq:cf}
a(n)\;=\;\frac{\left(3 n + 1\right) \left(4 n\right)!}{\left(2 n + 1\right) \left(2 n\right)!^{2}} .
\end{equation}
...
\begin{quote}\small
\textbf{Conjecture:} n*(2*n+1)*a(n) + 2*(-26*n\^{}2+25*n-11)*a(n-1) + 20*(4*n-5)*(4*n-7)*a(n-2) = 0. - \emph{R. J. Mathar}, Sep 08 2013
\end{quote}
As of the ``Last modified'' line on the live entry (2026-03-13, revision 61) the
...
n \left(2 n + 1\right)\,a(n) -  2 \left(26 n^{2} - 25 n + 11\right)\,a(n-1) + 20 \left(4 n - 7\right) \left(4 n - 5\right)\,a(n-2)
\end{equation}
...
\section{The computation for A228329}

The closed form \eqref{eq:cf} splits into one similarity class, with
representative
\[
\frac{\left(4 n\right)!}{2 n \left(2 n\right)!^{2} + \left(2 n\right)!^{2}}
\]
...
entry \href{https://oeis.org/A228329}{A228329}, 2026-03-13.
