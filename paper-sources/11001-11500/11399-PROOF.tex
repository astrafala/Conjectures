...
\title{The empirical recurrence for OEIS A303723, proved by transfer matrix}
...
\begin{abstract}
OEIS A303723 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A303723 is ``Number of n X 4 0..1 arrays with every element unequal to 0, 1, 2 or 3 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
8, 49, 46, 84, 133, 221, 406, 743,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +a(n-2) +a(n-3) +a(n-4) -a(n-5) -2*a(n-6) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 30 2022 20:57:50, revision
6) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + a(n-2) + a(n-3) + a(n-4) - a(n-5) - 2\,a(n-6)
\end{equation}
for all $n>8$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A303723.
