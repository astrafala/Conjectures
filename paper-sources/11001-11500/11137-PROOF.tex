...
\title{The empirical recurrence for OEIS A186481, proved by transfer matrix}
...
\begin{abstract}
OEIS A186481 counts the $(n+1)\times9$ arrays over $\{0,\dots,3\}$ in which
...
a state, the count is a walk count on $S=27101$ of them, and the conjectured recurrence is then
...
OEIS A186481 is ``Number of (n+1)X9 0..3 arrays with every 2X2 subblock commuting with each of its horizontal and vertical 2X2 subblock neighbors.''. It has offset $1$ and begins
\[
27101, 35081, 101108, 286290, 479785, 1286113, 1894849, 5977657,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n)=2*a(n-1)+2*a(n-2)-6*a(n-3)+6*a(n-4)-3*a(n-5) for n>19
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 03:31:54, revision 9) this is still
...
$27101$, which the model reproduces along with every later term.
...
\]
on the $S=27101$ admissible $2$-tuples. In particular $a$ is $C$-finite.
...
size of the construction is therefore $4^{2\cdot9}$ before the condition prunes
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A186481.
