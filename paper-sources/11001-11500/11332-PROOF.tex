...
\title{The empirical recurrence for OEIS A220611, proved by transfer matrix}
...
\begin{abstract}
OEIS A220611 counts the ways of linking the cells of a grid $5$ cells wide, each cell either to
...
OEIS A220611 is ``Number of ways to reciprocally link elements of an n X 5 array either to themselves or to exactly two horizontal and vertical neighbors, without consecutive collinear links.''. It has offset $1$ and begins
\[
1, 8, 21, 95, 324, 1277, 4673, 17768,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) + 6*a(n-2) - 11*a(n-3) - 5*a(n-4) + 6*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 01 2018 14:29:44, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + 6\,a(n-2) - 11\,a(n-3) - 5\,a(n-4) + 6\,a(n-5)
\]
for every $n>4$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A220611.
