...
\title{The empirical recurrence for OEIS A238923, proved by transfer matrix}
...
\begin{abstract}
OEIS A238923 counts $(n+1)\times2$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A238923 is ``Number of (n+1) X (1+1) 0..3 arrays with no element greater than all horizontal neighbors or equal to all vertical neighbors.''. It has offset $1$ and begins
\[
12, 36, 144, 540, 2052, 7776, 29484, 111780,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) + 3*a(n-2).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 24 2018 14:26:36, revision 8) this is still
...
integers vanish from the index corresponding to $n=2+1$ onwards, and the run was
continued until the working vector was identically zero, which settles all larger $j$ at once.
By Lemma~\ref{lem:crit} the recurrence holds for every $n>2$.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A238923.
