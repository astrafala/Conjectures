...
\title{The empirical recurrence for OEIS A297870, proved by transfer matrix}
...
\begin{abstract}
OEIS A297870 counts $2$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A297870 is ``Number of nX2 0..1 arrays with every element equal to 2, 3 or 5 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
0, 1, 3, 2, 11, 13, 34, 65,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +3*a(n-2) -4*a(n-4)
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 07 2018 11:28:02, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297870.
