...
\title{The empirical recurrence for OEIS A234138, proved by transfer matrix}
...
\begin{abstract}
OEIS A234138 counts $(n+1)\times7$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A234138 is ``Number of (n+1) X (6+1) 0..3 arrays with every 2 X 2 subblock having the sum of the absolute values of all six edge and diagonal differences equal to 9.''. It has offset $1$ and begins
\[
3584, 4040, 4808, 6440, 9512, 16424, 30632, 65192,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) + 8*a(n-2) - 30*a(n-3) + 4*a(n-4) + 48*a(n-5) - 32*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 13 2018 11:53:06, revision 11) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234138.
