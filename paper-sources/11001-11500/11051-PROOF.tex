...
\title{The empirical recurrence for OEIS A252535, proved by transfer matrix}
...
\begin{abstract}
OEIS A252535 counts $5\times(n+2)$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252535 is ``Number of (3+2) X (n+2) 0..3 arrays with every 3 X 3 subblock row and diagonal sum equal to 0 2 3 6 or 7 and every 3 X 3 column and antidiagonal sum not equal to 0 2 3 6 or 7.''. It has offset $1$ and begins
\[
460, 334, 466, 626, 1120, 1760, 2404, 4304,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 6*a(n-3) - 8*a(n-6) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 05 2018 03:39:33, revision 8) this is still
...
at once. By Lemma~\ref{lem:crit} the recurrence holds for every $n>8$. The bound is exact: at $n=8$ the recurrence fails on the entry's own published terms, so no larger range holds.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252535.
