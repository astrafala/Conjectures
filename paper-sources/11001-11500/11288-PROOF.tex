...
\title{The empirical recurrence for OEIS A185828, proved by transfer matrix}
...
\begin{abstract}
OEIS A185828 counts $n\times2$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A185828 is ``Half the number of n X 2 binary arrays with every element equal to exactly one or two of its horizontal and vertical neighbors.''. It has offset $1$ and begins
\[
1, 3, 10, 23, 61, 162, 421, 1103,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + a(n-2) + 2*a(n-3) - a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 26 2020 14:50:13, revision 32) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A185828.
