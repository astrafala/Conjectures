...
\title{The empirical recurrence for OEIS A208381, proved by transfer matrix}
...
\begin{abstract}
OEIS A208381 counts arrays over $\{0,\dots,1\}$ of width $5$ that avoid the patterns
...
OEIS A208381 is ``Number of 5 X n 0..1 arrays avoiding 0 0 0 and 1 1 1 horizontally and 0 0 1 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
10, 100, 144, 640, 2176, 7072, 25200,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) + 4*a(n-2) + 13*a(n-3) + 8*a(n-4) - 3*a(n-5) + 9*a(n-6) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 02 2018 08:51:58, revision
8) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 4\,a(n-2) + 13\,a(n-3) + 8\,a(n-4) - 3\,a(n-5) + 9\,a(n-6)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208381.
