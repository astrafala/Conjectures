...
\title{The empirical recurrence for OEIS A297300, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297300 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A297300 is ``Number of 3 X n 0..1 arrays with every 1 horizontally or antidiagonally adjacent to 2 neighboring 1s.''. It has offset $1$ and begins
\[
1, 1, 3, 5, 9, 17, 32, 60,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) - a(n-2) + 2*a(n-3) - a(n-4) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 26 2019 12:06:01, revision 7) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297300.
