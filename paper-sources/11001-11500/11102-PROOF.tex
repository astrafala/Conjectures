...
\title{The empirical recurrence for OEIS A202528, proved by transfer matrix}
...
\begin{abstract}
OEIS A202528 counts arrays of width $6$ over $\{0,1\}$ containing no occurrence of certain short
...
count is a walk count on $S=381$ states.
\end{abstract}
...
OEIS A202528 is ``Number of (n+2) X 6 binary arrays avoiding patterns 000 and 101 in rows, columns and nw-to-se diagonals.''. It has offset $1$ and begins
\[
890, 2232, 4669, 9746, 21297, 45899, 97936, 210562,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) +2*a(n-3) -2*a(n-4) -2*a(n-5) +a(n-7) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 22 2025 16:38:25, revision 10) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=381.
\]
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 2\,a(n-3) - 2\,a(n-4) - 2\,a(n-5) + a(n-7)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A202528.
