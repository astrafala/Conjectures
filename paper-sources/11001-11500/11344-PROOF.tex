...
\title{The empirical recurrence for OEIS A221621, proved by transfer matrix}
...
\begin{abstract}
OEIS A221621 carries an empirical recurrence of order $6$ contributed by R. H. Hardin. It is
true, and it is decidable rather than empirical. The entry's condition is local to a bounded window of consecutive lines, so
the admissible configurations of such a window are the vertices of a finite digraph and the
arrays counted are exactly the walks in it; hence $a(n)$ is a walk count on $S=720$ vertices
...
OEIS A221621 is ``Number of nX6 arrays with each row a permutation of 1..6 having at least as many downsteps as the preceding row.''. It has offset $1$ and begins
\[
720, 353654, 148700748, 57614883627, 21241004664348, 7575106427737240, 2638115823321645192, 902542985526634773509,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 720*a(n-1) -164746*a(n-2) +12686988*a(n-3) -321204409*a(n-4) +605003244*a(n-5) -296321796*a(n-6)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 19:48:41, revision 8) this is still
...
An admissible array is then exactly a walk, and $\iota,\tau$ are the vectors recording which windows may begin and end an array, so with $M$ the adjacency matrix on $S=720$ vertices,
\[
a(n)\;=\;\iota^{\!\top}M^{\,n}\tau ,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221621.
