...
\title{The empirical recurrence for OEIS A206092, proved by transfer matrix}
...
\begin{abstract}
OEIS A206092 counts arrays over $\{0,\dots,2\}$ under a condition on the perimeter cycle of
...
a bounded window of consecutive rows, so the count is a walk count on $S=52812$ states and is
...
OEIS A206092 is ``Number of (n+1) X 7 0..2 arrays with every 2 X 3 or 3 X 2 subblock having exactly two counterclockwise and two clockwise edge increases.''. It has offset $1$ and begins
\[
52812, 54432, 86496, 444480, 2156544, 10584000, 56633472, 279244800,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 130*a(n-3) for n>9.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 10 2015 01:53:12, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206092.
