...
\title{The empirical recurrence for OEIS A209945, proved by transfer matrix}
...
\begin{abstract}
OEIS A209945 counts $(n+1)\times3$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A209945 is ``Half the number of (n+1) X 3 0..2 arrays with every 2 X 2 subblock having at most one duplicate clockwise edge difference.''. It has offset $1$ and begins
\[
258, 4975, 95794, 1845126, 35537484, 684469520, 13183187396, 253914272972,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 20*a(n-1) +25*a(n-2) -708*a(n-3) -1034*a(n-4) +2172*a(n-5) -160*a(n-6) -320*a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 19 2025 08:42:46, revision 11) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;20\,a(n-1) + 25\,a(n-2) - 708\,a(n-3) - 1034\,a(n-4) + 2172\,a(n-5) - 160\,a(n-6) - 320\,a(n-7)
\end{equation}
for all $n>6$.
...
\[
a(n)-\sum_i c_i\,a(n-i)\;=\;\tfrac1{2}\mathbf{1}^{\!\top}M^{\,n+1-1-7}\,q(M)\,\mathbf{1} .
\]
...
=\tfrac1{2}\mathbf{1}^{\!\top}M^{\,m-7}\,q(M)\,\mathbf{1}
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209945.
