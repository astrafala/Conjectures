...
\title{The empirical recurrence for OEIS A206270, proved by transfer matrix}
...
\begin{abstract}
OEIS A206270 counts arrays of width $2$ over $\{0,1,2\}$ subject to a condition read round the
...
count is a walk count on a finite digraph with $S=31$ vertices, and whether a linear
...
OEIS A206270 is ``Number of (n+1) X 2 0..2 arrays with no 2 X 2 subblock having the number of clockwise edge increases equal to the number of counterclockwise edge increases in its adjacent leftward or upward neighbors.''. It has offset $1$ and begins
\[
81, 306, 1233, 4884, 19509, 77580, 309057, 1230480,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 6*a(n-2) + 20*a(n-3) + 58*a(n-4) + 66*a(n-5) + 29*a(n-6) + 16*a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 15 2018 11:01:47, revision 12) this is still
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-2) + 20\,a(n-3) + 58\,a(n-4) + 66\,a(n-5) + 29\,a(n-6) + 16\,a(n-7)
\]
for every $n>7$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206270.
