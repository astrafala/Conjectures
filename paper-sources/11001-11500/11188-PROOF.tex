...
\title{The empirical recurrence for OEIS A250786, proved by transfer matrix}
...
\begin{abstract}
OEIS A250786 counts arrays over $\{0,1\}$ in which a statistic taken over short runs
...
OEIS A250786 is ``Number of (4+1) X (n+1) 0..1 arrays with nondecreasing x(i,j)+x(i,j-1) in the i direction and nondecreasing absolute value of x(i,j)-x(i-1,j) in the j direction.''. It has offset $1$ and begins
\[
72, 196, 482, 1152, 2640, 5882, 12796, 27344,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 5*a(n-1) - 7*a(n-2) - 2*a(n-3) + 11*a(n-4) - 5*a(n-5) - 3*a(n-6) + 2*a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 20 2018 03:32:00, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) - 7\,a(n-2) - 2\,a(n-3) + 11\,a(n-4) - 5\,a(n-5) - 3\,a(n-6) + 2\,a(n-7)
\]
for every $n>6$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250786.
