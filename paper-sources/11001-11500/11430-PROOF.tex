...
\title{The empirical recurrence for OEIS A207737, proved by transfer matrix}
...
\begin{abstract}
OEIS A207737 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
...
OEIS A207737 is ``Number of n X 4 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 0 1 and 1 0 0 vertically.''. It has offset
$1$ and begins
\[
9, 81, 361, 1849, 10201, 58081, 335241,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 8*a(n-1) -11*a(n-2) -12*a(n-3) +13*a(n-4) +4*a(n-5) -a(n-6) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 25 2018 12:32:22, revision
8) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;8\,a(n-1) - 11\,a(n-2) - 12\,a(n-3) + 13\,a(n-4) + 4\,a(n-5) - a(n-6)
\end{equation}
for all $n>7$. 
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207737.
