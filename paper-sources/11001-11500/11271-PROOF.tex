...
\title{The empirical recurrence for OEIS A206249, proved by transfer matrix}
...
\begin{abstract}
OEIS A206249 counts $(n+1)\times3$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A206249 is ``Number of (n+1) X 3 0..3 arrays with every 2 X 2 subblock having zero permanent.''. It has offset $1$ and begins
\[
361, 8029, 99856, 1718209, 26512201, 434613664, 6990799321, 113636628469,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 19*a(n-1) - 855*a(n-3) + 2025*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 14 2018 11:35:39, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;19\,a(n-1) - 855\,a(n-3) + 2025\,a(n-4)
\end{equation}
for all $n>3$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206249.
