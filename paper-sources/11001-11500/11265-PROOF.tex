...
\title{The empirical recurrence for OEIS A302516, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A302516 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A302516 is ``Number of 3 X n 0..1 arrays with every element equal to 0, 1, 4 or 5 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
4, 4, 11, 15, 21, 52, 118, 220,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +2*a(n-3) +4*a(n-4) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 16 2022 01:12:11, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 2\,a(n-3) + 4\,a(n-4)
\end{equation}
for all $n>7$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302516.
