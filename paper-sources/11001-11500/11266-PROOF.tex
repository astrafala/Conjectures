...
\title{The empirical recurrence for OEIS A220640, derived from the entry's generating function}
...
\begin{abstract}
OEIS A220640 carries an empirical recurrence of order $9$. The entry separately records a
...
OEIS A220640 is ``Number of ways to reciprocally link elements of an n X 4 array either to themselves or to exactly one king-move neighbor.''. It has offset $0$ and begins
\[
1, 5, 172, 3755, 92801, 2226936, 53841725, 1299348473,\ \dots
\]
...
\begin{quote}
G.f.: -(3*x\^{}7 -x\^{}6 +14*x\^{}5 -58*x\^{}4 -70*x\^{}3 +42*x\^{}2 +15*x-1) / (15*x\^{}9 -2*x\^{}8 +48*x\^{}7 -245*x\^{}6 -460*x\^{}5 +340*x\^{}4 +325*x\^{}3 -114*x\^{}2 -20*x+1). - \_Alois P. Heinz\_, Jun 03 2014
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 03 2023 15:41:06, revision 12) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 3 x^{7} + x^{6} - 14 x^{5} + 58 x^{4} + 70 x^{3} - 42 x^{2} - 15 x + 1}{15 x^{9} - 2 x^{8} + 48 x^{7} - 245 x^{6} - 460 x^{5} + 340 x^{4} + 325 x^{3} - 114 x^{2} - 20 x + 1},
\]
the entry's own generating function, and let
\[
D(x)\;=\;1-\sum_i c_i x^{i}\;=\;15 x^{9} - 2 x^{8} + 48 x^{7} - 245 x^{6} - 460 x^{5} + 340 x^{4} + 325 x^{3} - 114 x^{2} - 20 x + 1
\]
...
\begin{theorem}
\[
a(n)\;=\;20\,a(n-1) + 114\,a(n-2) - 325\,a(n-3) - 340\,a(n-4) + 460\,a(n-5) + 245\,a(n-6) - 48\,a(n-7) + 2\,a(n-8) - 15\,a(n-9)
\]
for every $n>7$.
\end{theorem}
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 3 x^{7} + x^{6} - 14 x^{5} + 58 x^{4} + 70 x^{3} - 42 x^{2} - 15 x + 1,
\]
...
\[
15 x^{9} - 2 x^{8} + 48 x^{7} - 245 x^{6} - 460 x^{5} + 340 x^{4} + 325 x^{3} - 114 x^{2} - 20 x + 1,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A220640.
