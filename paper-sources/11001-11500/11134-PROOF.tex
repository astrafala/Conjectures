...
\title{The empirical recurrence for OEIS A185899, proved by transfer matrix}
...
\begin{abstract}
OEIS A185899 counts $n\times2$ arrays over $\{0,\dots,7\}$ subject to a condition imposed on
...
OEIS A185899 is ``1/8 the number of n X 2 0..7 arrays with every element equal to exactly one or two of its horizontal and vertical neighbors.''. It has offset $1$ and begins
\[
1, 15, 196, 2765, 38731, 545328, 7675381, 108065699,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 13*a(n-1) + 27*a(n-2) - 147*a(n-3) - 245*a(n-4) - 343*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 17 2018 06:16:48, revision 12) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A185899.
