...
\title{The empirical recurrence for OEIS A252111, proved by transfer matrix}
...
\begin{abstract}
OEIS A252111 counts $(n+2)\times7$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
$a(n)$ is a walk count on $S=17242$ vertices. Such a sequence is $C$-finite, so whether a given
...
OEIS A252111 is ``Number of (n+2) X (5+2) 0..3 arrays with every 3 X 3 subblock row and column sum equal to 0 2 3 6 or 7 and every 3 X 3 diagonal and antidiagonal sum not equal to 0 2 3 6 or 7.''. It has offset $1$ and begins
\[
1884, 624, 1258, 1956, 3528, 6070, 11760, 21344,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 12*a(n-3) - 32*a(n-6) for n>11.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 01 2018 10:13:16, revision 8) this is still
...
\[
\text{every row, column sum} \in \{0,2,3,6,7\}\ \text{ and }\ \text{every diagonal, antidiagonal sum} \notin \{0,2,3,6,7\}
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252111.
