...
\title{The empirical recurrence for OEIS A255990, proved by transfer matrix}
...
\begin{abstract}
OEIS A255990 carries an empirical recurrence of order $7$ contributed by R.~H.~Hardin. It is
...
OEIS A255990 is ``Number of length n+6 0..1 arrays with at most one downstep in every 6 consecutive neighbor pairs.''. It has offset $1$ and begins
\[
64, 98, 156, 257, 428, 705, 1134, 1797,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) -a(n-2) +5*a(n-6) -4*a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 24 2018 14:52:15, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) - a(n-2) + 5\,a(n-6) - 4\,a(n-7)
\]
for every $n>13$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A255990.
