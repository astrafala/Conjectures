...
\title{The empirical recurrence for OEIS A209225, proved by transfer matrix}
...
\begin{abstract}
OEIS A209225 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
...
OEIS A209225 is ``Number of 4 X n 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 1 0 and 1 1 1 vertically.''. It has offset
$1$ and begins
\[
9, 81, 126, 196, 504, 1296, 3312,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) + 4*a(n-3) + 16*a(n-4) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 08 2018 21:31:22, revision
10) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 4\,a(n-3) + 16\,a(n-4)
\end{equation}
...
$(0,1,0), (1,1,1)$ as $3$ consecutive entries. There are $9$ admissible columns; that condition
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209225.
