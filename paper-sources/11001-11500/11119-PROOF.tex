...
\title{The empirical recurrence for OEIS A259887, proved by transfer matrix}
...
\begin{abstract}
OEIS A259887 counts $(n+2)\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A259887 is ``Number of (n+2) X (1+2) 0..1 arrays with each 3 X 3 subblock having clockwise perimeter pattern 00000000 00000001 or 00000011.''. It has offset $1$ and begins
\[
34, 67, 215, 499, 936, 2212, 5352, 11529,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + 5*a(n-3) + 3*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 27 2018 08:42:28, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A259887.
