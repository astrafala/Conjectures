...
\title{The empirical recurrence for OEIS A186469, proved by transfer matrix}
...
\begin{abstract}
OEIS A186469 counts the $(n+1)\times7$ arrays over $\{0,\dots,2\}$ in which
...
a state, the count is a walk count on $S=1321$ of them, and the conjectured recurrence is then
...
OEIS A186469 is ``Number of (n+1) X 7 0..2 arrays with every 2 X 2 subblock commuting with each of its horizontal and vertical 2 X 2 subblock neighbors.''. It has offset $1$ and begins
\[
1321, 1754, 4023, 9834, 16083, 34314, 49407, 109950,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1)+a(n-2)-4*a(n-3)+4*a(n-4)-2*a(n-5) for n>15.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 22 2022 11:19:43, revision 7) this is still
...
$1321$, which the model reproduces along with every later term.
...
\]
on the $S=1321$ admissible $2$-tuples. In particular $a$ is $C$-finite.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A186469.
