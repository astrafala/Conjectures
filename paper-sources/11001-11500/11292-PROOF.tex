...
\title{The empirical recurrence for OEIS A204606, proved by transfer matrix}
...
\begin{abstract}
OEIS A204606 counts $(n+2)\times9$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
$a(n)$ is a walk count on $S=315011$ vertices. Such a sequence is $C$-finite, so whether a given
...
OEIS A204606 is ``Number of (n+2)X9 0..2 arrays with every 3X3 subblock having three strictly increasing elements in a row horizontally, vertically or nw-to-se diagonally exactly one way.''. It has offset $1$ and begins
\[
1240455298, 1982068849, 2572437376, 4518555426, 6656676736, 9620299328, 20253298532, 128896188864,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 442*a(n-3) +43*a(n-6) for n>18
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 11:21:07, revision 9) this is still
...
$\{0,\dots,2\}^{9}$. A $3\times3$ subblock occupies three consecutive rows and
...
$(2+1)^{2\cdot9}=387420489$, and put an edge $(r,s)\to(s,t)$ exactly when the condition
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204606.
