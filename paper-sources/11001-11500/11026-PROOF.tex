...
\title{A condition on the multiset of every subblock: OEIS A235843}
...
\begin{abstract}
OEIS A235843 carries an empirical recurrence of order $5$ contributed by R.~H.~Hardin. It is
...
OEIS A235843 is ``Number of (n+1) X (1+1) 0..3 arrays with the upper median unequal to the lower median in every 2 X 2 subblock.''. It has offset $1$ and begins
\[
156, 1584, 16228, 166816, 1716484, 17668128, 181881988, 1872430816,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 14*a(n-1) - 31*a(n-2) - 94*a(n-3) + 192*a(n-4) + 192*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 19 2018 08:08:32, revision 9) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A235843.
