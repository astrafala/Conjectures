...
\title{The empirical recurrence for OEIS A230181, proved by transfer matrix}
...
\begin{abstract}
OEIS A230181 carries an empirical recurrence of order $6$ contributed by R.~H.~Hardin. It is
...
OEIS A230181 is ``Number of nX5 0..2 arrays x(i,j) with each element horizontally or antidiagonally next to at least one element with value 2-x(i,j).''. It has offset $1$ and begins
\[
15, 825, 44487, 2432241, 133265847, 7303192425, 400233701367, 21933865129257,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 63*a(n-1) -464*a(n-2) +800*a(n-3) +500*a(n-4) -124*a(n-5) -64*a(n-6) for n>8
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 08:42:09, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;63\,a(n-1) - 464\,a(n-2) + 800\,a(n-3) + 500\,a(n-4) - 124\,a(n-5) - 64\,a(n-6)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A230181.
