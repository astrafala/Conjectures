...
\title{The empirical recurrence for OEIS A250723, proved by transfer matrix}
...
\begin{abstract}
OEIS A250723 counts arrays over $\{0,1\}$ in which a statistic taken over short runs
...
OEIS A250723 is ``Number of (n+1) X (2+1) 0..1 arrays with nondecreasing x(i,j)+x(i,j-1) in the i direction and nondecreasing min(x(i,j),x(i-1,j)) in the j direction.''. It has offset $1$ and begins
\[
22, 46, 85, 144, 230, 350, 513, 728,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) - 5*a(n-2) + 5*a(n-4) - 4*a(n-5) + a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 16 2018 06:07:46, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250723.
