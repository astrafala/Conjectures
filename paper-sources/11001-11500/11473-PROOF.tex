...
\title{The empirical recurrence for OEIS A234550, proved by transfer matrix}
...
\begin{abstract}
OEIS A234550 counts $2$-column arrays over $\{0,\dots,6\}$ in which every
...
OEIS A234550 is ``Number of (n+1) X (1+1) 0..6 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 3 (constant-stress 1 X 1 tilings).''. It has offset
$1$ and begins
\[
360, 2716, 20416, 153752, 1157728, 8726336, 65777344,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 118*a(n-2) - 3660*a(n-4) + 10800*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 20 2022 21:31:39, revision 12) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234550.
