...
\title{The empirical recurrence for OEIS A206408, proved by transfer matrix}
...
\begin{abstract}
OEIS A206408 counts arrays over $\{0,\dots,2\}$ under a condition on the perimeter cycle of
every $2\times3$ and $3\times2$ subblock, and carries an empirical recurrence of order $6$ contributed by
R.~H.~Hardin. It is true, and it is decidable rather than empirical. The condition is local to
a bounded window of consecutive rows, so the count is a walk count on $S=423$ states and is
...
OEIS A206408 is ``Number of (n+1) X 3 0..2 arrays with every 2 X 3 or 3 X 2 subblock having an equal number of clockwise and counterclockwise edge increases.''. It has offset $1$ and begins
\[
423, 5199, 69585, 953865, 13148043, 181467207, 2505335985, 34591087977,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 19*a(n-1) - 78*a(n-2) + 86*a(n-3) + 17*a(n-4) - 41*a(n-5) + 10*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 16 2018 16:10:45, revision 14) this is still
...
\begin{theorem}
\[
a(n)\;=\;19\,a(n-1) - 78\,a(n-2) + 86\,a(n-3) + 17\,a(n-4) - 41\,a(n-5) + 10\,a(n-6)
\]
for every $n>6$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206408.
