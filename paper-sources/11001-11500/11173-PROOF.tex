...
\title{The empirical recurrence for OEIS A196596, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A196596 counts arrays over $\{0,\dots,4\}$ in which every cell is constrained by the
...
OEIS A196596 is ``Number of n X 3 0..4 arrays with each element x equal to the number its horizontal and vertical neighbors equal to 1,2,4,0,3 for x=0,1,2,3,4.''. It has offset $1$ and begins
\[
1, 3, 16, 37, 116, 356, 1068, 3217,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) + 2*a(n-2) + 3*a(n-3) + a(n-4) - a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 01 2018 09:20:54, revision 8) the statement is
...
\#\{\text{neighbours with value }f(x_{t,u})\}=x_{t,u},\quad f=(1,2,4,0,3)
\end{equation}
for every cell $(t,u)$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A196596.
