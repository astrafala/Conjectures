...
\title{The empirical recurrence for OEIS A183721, proved by transfer matrix}
...
\begin{abstract}
OEIS A183721 counts arrays of width $2$ over $\{0,1,\dots,5\}$ subject to a condition read round the
...
OEIS A183721 is ``1/12 the number of (n+1) X 2 0..5 arrays with every 2 X 2 subblock strictly increasing clockwise or counterclockwise with one decrease, and at least two adjacent blocks having the same increasing direction.''. It has offset $1$ and begins
\[
0, 1, 12, 87, 537, 3070, 16731, 88331,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 8*a(n-1) - 11*a(n-2) - 23*a(n-3) + 6*a(n-4) + 7*a(n-5) - 2*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 04 2018 10:48:01, revision 11) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The arrays have $2$ columns and a growing number of rows, with entries in $\{0,1,\dots,5\}$. A
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-1) - 11\,a(n-2) - 23\,a(n-3) + 6\,a(n-4) + 7\,a(n-5) - 2\,a(n-6)
\]
for every $n>6$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A183721.
