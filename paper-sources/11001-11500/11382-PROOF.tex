...
\title{The empirical recurrence for OEIS A302368, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A302368 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A302368 is ``Number of 2Xn 0..1 arrays with every element equal to 0, 2, 3 or 4 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
2, 2, 12, 20, 72, 168, 496, 1296,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) +4*a(n-2) -4*a(n-3) -4*a(n-4)
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 06 2018 12:21:58, revision 4) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302368.
