...
\title{The empirical recurrence for OEIS A259245, proved by transfer matrix}
...
\begin{abstract}
OEIS A259245 counts arrays of width $4$ over $\{0,1\}$ subject to a condition read round the
...
OEIS A259245 is ``Number of (n+1) X (3+1) 0..1 arrays with each 2 X 2 subblock having clockwise pattern 0000 0011 or 0111.''. It has offset $1$ and begins
\[
48, 192, 720, 2816, 10720, 41552, 159168, 614560,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + 12*a(n-2) - 11*a(n-3) - 30*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 24 2018 16:22:38, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A259245.
