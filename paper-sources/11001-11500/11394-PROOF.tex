...
\title{The empirical recurrence for OEIS A232317, proved by transfer matrix}
...
\begin{abstract}
OEIS A232317 counts arrays of width $2$ over $\{0,\dots,1\}$ under a condition on each cell
...
OEIS A232317 is ``Number of (1+1)X(n+1) 0..1 arrays with every element equal to some horizontal or antidiagonal neighbor, with top left element zero.''. It has offset $1$ and begins
\[
2, 5, 16, 52, 169, 549, 1784, 5797,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) +a(n-2) -2*a(n-4) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 07:18:20, revision 12) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232317.
