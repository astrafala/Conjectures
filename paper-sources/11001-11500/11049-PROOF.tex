...
\title{The empirical recurrence for OEIS A303687, recovered from its tail}
...
\begin{abstract}
OEIS A303687 records ``Empirical recurrence of order $93$'' and keeps the recurrence itself in
a linked file rather than in the entry, so the conjecture cannot be read off the entry at all.
It can still be settled. The entry counts arrays under a condition local to a bounded window of
lines, which makes the count a walk count on a finite digraph and forces a monic integer
recurrence of order at most the number $S'=161$ of states with distinct futures. Berlekamp--Massey on
...
Its last coefficient is $c_{93}=128\neq0$, so no further tail satisfies anything
...
\[
0, 61, 27, 343, 349, 2809, 4619, 29475,\ \dots
\]
The entry states:
\begin{quote}
Empirical recurrence of order 93 (see link above)
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 28 2018 09:32:39, revision 5)
...
merging $S'=161$ states remain, and it is that bound every computation below uses.

\begin{lemma}\label{lem:cf}
$a$ satisfies a monic linear recurrence with integer coefficients of order at most $S'=161$.
\end{lemma}
...
Applied to $2S'=322$ exact terms from $n=5$ on, it returns order $93$ --- the
...
$c_{1}$ & $0$ & $c_{25}$ & $-306557503$ & $c_{49}$ & $-6619594617$ & $c_{73}$ & $-382402090$ \\
$c_{2}$ & $37$ & $c_{26}$ & $-363264431$ & $c_{50}$ & $-19017220855$ & $c_{74}$ & $-141624352$ \\
$c_{3}$ & $6$ & $c_{27}$ & $549209385$ & $c_{51}$ & $2090846187$ & $c_{75}$ & $157772157$ \\
$c_{4}$ & $-610$ & $c_{28}$ & $638113805$ & $c_{52}$ & $16499920987$ & $c_{76}$ & $88078560$ \\
$c_{5}$ & $-166$ & $c_{29}$ & $-903056841$ & $c_{53}$ & $452879832$ & $c_{77}$ & $-49002106$ \\
$c_{6}$ & $6044$ & $c_{30}$ & $-824394297$ & $c_{54}$ & $-12016400524$ & $c_{78}$ & $-39288206$ \\
$c_{7}$ & $2189$ & $c_{31}$ & $1396257280$ & $c_{55}$ & $-774136629$ & $c_{79}$ & $10600206$ \\
$c_{8}$ & $-40686$ & $c_{32}$ & $625336677$ & $c_{56}$ & $7445458891$ & $c_{80}$ & $13456710$ \\
$c_{9}$ & $-18701$ & $c_{33}$ & $-2102990543$ & $c_{57}$ & $-26474938$ & $c_{81}$ & $-1112918$ \\
...
\begin{theorem}
The recurrence above holds for every $n\ge98$, and it is the recurrence OEIS A303687 records.
\end{theorem}
...
$-c_{93}=-128$, which is not zero, so $q_{\min}(0)\neq0$ and $q_{\min}$ has no
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A303687.
