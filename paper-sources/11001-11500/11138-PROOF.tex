...
\title{The empirical recurrence for OEIS A186470, proved by transfer matrix}
...
\begin{abstract}
OEIS A186470 counts the $(n+1)\times8$ arrays over $\{0,\dots,2\}$ in which
...
a state, the count is a walk count on $S=3078$ of them, and the conjectured recurrence is then
...
OEIS A186470 is ``Number of (n+1)X8 0..2 arrays with every 2X2 subblock commuting with each of its horizontal and vertical 2X2 subblock neighbors.''. It has offset $1$ and begins
\[
3078, 2937, 9982, 14883, 40626, 49407, 136086, 170811,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n)=2*a(n-1)+a(n-2)-4*a(n-3)+4*a(n-4)-2*a(n-5) for n>16
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 03:30:51, revision 9) this is still
...
$3078$, which the model reproduces along with every later term.
...
\]
on the $S=3078$ admissible $2$-tuples. In particular $a$ is $C$-finite.
...
size of the construction is therefore $3^{2\cdot8}$ before the condition prunes
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A186470.
