...
\title{The empirical recurrence for OEIS A234483, proved by transfer matrix}
...
\begin{abstract}
OEIS A234483 counts $2$-column arrays over $\{0,\dots,3\}$ in which every
...
OEIS A234483 is ``Number of (n+1) X (1+1) 0..3 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 2 (constant-stress 1 X 1 tilings).''. It has offset
$1$ and begins
\[
62, 242, 944, 3686, 14402, 56312, 220334,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 7*a(n-1) - 9*a(n-2) - 12*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 20 2022 21:32:16, revision 11) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234483.
