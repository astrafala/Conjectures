...
\title{The empirical recurrence for OEIS A283124, proved by transfer matrix}
...
\begin{abstract}
OEIS A283124 counts $n\times2$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A283124 is ``Number of nX2 0..1 arrays with no 1 equal to more than two of its horizontal and vertical neighbors.''. It has offset $1$ and begins
\[
4, 16, 57, 209, 768, 2816, 10329, 37889,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) +2*a(n-2) +2*a(n-3) -a(n-4) -a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 02 2017 12:23:27, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A283124.
