...
\title{The empirical recurrence for OEIS A207769, proved by transfer matrix}
...
\begin{abstract}
OEIS A207769 counts arrays over $\{0,\dots,1\}$ of width $3$ that avoid the patterns
...
OEIS A207769 is ``Number of n X 3 0..1 arrays avoiding 0 0 0 and 1 1 1 horizontally and 0 0 1 and 0 1 0 vertically.''. It has offset
$1$ and begins
\[
6, 36, 84, 192, 450, 972, 2040,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) - 2*a(n-2) + a(n-3) - 2*a(n-4) + a(n-6) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 25 2018 16:05:46, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207769.
