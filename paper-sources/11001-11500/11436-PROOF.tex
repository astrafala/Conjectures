...
\title{The empirical recurrence for OEIS A204752, proved by transfer matrix}
...
\begin{abstract}
OEIS A204752 counts $(n+2)\times8$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A204752 is ``Number of (n+2) X 8 0..1 arrays with every 3 X 3 subblock having three equal elements in a row horizontally, vertically, diagonally or antidiagonally exactly three ways, and new values 0..1 introduced in row major order.''. It has offset $1$ and begins
\[
590, 49, 48, 53, 61, 74, 95, 129,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) - a(n-3) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 10 2018 20:46:57, revision 11) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204752.
