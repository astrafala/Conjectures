...
\title{The empirical recurrence for OEIS A245947, proved by transfer matrix}
...
\begin{abstract}
OEIS A245947 carries an empirical recurrence of order $7$ contributed by R.~H.~Hardin. It is
...
OEIS A245947 is ``Number of length n+3 0..5 arrays with some pair in every consecutive four terms totalling exactly 5.''. It has offset $1$ and begins
\[
834, 3966, 18384, 82968, 381222, 1744494, 7972932, 36489120,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) + 5*a(n-2) + 13*a(n-3) - 13*a(n-4) - a(n-5) - 3*a(n-6) + a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 05 2018 06:33:04, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + 5\,a(n-2) + 13\,a(n-3) - 13\,a(n-4) - a(n-5) - 3\,a(n-6) + a(n-7)
\]
for every $n>-2$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A245947.
