...
\title{The empirical recurrence for OEIS A230063, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A230063 counts arrays over $\{0,\dots,2\}$ in which every cell is constrained by the
...
OEIS A230063 is ``Number of nX3 0..2 arrays x(i,j) with each element diagonally or antidiagonally next to at least one element with value 2-x(i,j).''. It has offset $1$ and begins
\[
0, 9, 45, 441, 3645, 31329, 266805, 2277081,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 7*a(n-1) +14*a(n-2) -8*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 08:40:35, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A230063.
