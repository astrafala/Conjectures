...
\title{The empirical recurrence for OEIS A275140, proved by counting patterns}
...
\begin{abstract}
OEIS A275140 counts arrays in which no entry may repeat a value found at any of three stated
...
OEIS A275140 is ``Number of n X 6 0..2 arrays with no element equal to any value at offset (-2,-2) (-1,-2) or (0,-1) and new values introduced in order 0..2.''. It has offset $1$ and begins
\[
16, 432, 1216, 6464, 32384, 165568, 841536, 4283968,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) + 10*a(n-2) + 4*a(n-3) - 4*a(n-4) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 31 2019 19:36:52, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A275140.
