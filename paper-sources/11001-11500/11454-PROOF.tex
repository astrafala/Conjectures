...
\title{The empirical recurrence for OEIS A268788: recovering a conjecture that is not written down}
...
\begin{abstract}
OEIS A268788 records ``Empirical recurrence of order $68$'', with the recurrence itself in a
...
OEIS A268788 is ``Number of nX7 binary arrays with some element plus some horizontally, vertically or antidiagonally adjacent neighbor totalling two exactly once.''. It has offset $1$ and begins
\[
38, 850, 14984, 228384, 3295246, 45515227, 611932378, 8057509992,\ \dots
\]
The entry states:
\begin{quote}
Empirical recurrence of order 68 (see link above)
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 13 2016 12:26:07, revision 4) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268788.
