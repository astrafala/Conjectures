...
\title{The empirical recurrence for OEIS A185535, proved by transfer matrix}
...
\begin{abstract}
OEIS A185535 counts $n\times2$ arrays over $\{0,\dots,5\}$ subject to a condition imposed on
...
walk, and $a(n)$ is a walk count on $S=1332$ vertices, which is $C$-finite. Whether the
...
OEIS A185535 is ``1/6 the number of n X 2 0..5 arrays with every element equal to exactly one or two of its horizontal and vertical neighbors.''. It has offset $1$ and begins
\[
1, 11, 110, 1155, 12105, 127190, 1336205, 14039455,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 9*a(n-1) + 19*a(n-2) - 25*a(n-3) - 75*a(n-4) - 125*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 16 2018 09:06:17, revision 11) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A185535.
