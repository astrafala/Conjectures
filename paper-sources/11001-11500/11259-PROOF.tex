...
\title{The empirical recurrence for OEIS A303718, proved by transfer matrix}
...
\begin{abstract}
OEIS A303718 counts $7$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A303718 is ``Number of n X 7 0..1 arrays with every element unequal to 0, 1 or 5 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
21, 23, 40, 161, 361, 741, 1592, 3469,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +a(n-2) +3*a(n-3) +a(n-4) -a(n-5) -a(n-6) for n>9
\end{quote}
As of the ``Last modified'' line on the live entry (May 12 2023 15:21:56, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A303718.
