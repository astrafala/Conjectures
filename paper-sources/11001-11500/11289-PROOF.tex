...
\title{The empirical recurrence for OEIS A230611, proved by transfer matrix}
...
\begin{abstract}
OEIS A230611 carries an empirical recurrence of order $6$ contributed by R. H. Hardin. It is
...
OEIS A230611 is ``Number of n X 5 0..2 arrays x(i,j) with each element horizontally or antidiagonally next to at least one element with value (x(i,j)+1) mod 3, and upper left element zero.''. It has offset $1$ and begins
\[
0, 8, 260, 7072, 186396, 4899200, 128706852, 3381000336,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 31*a(n-1) - 126*a(n-2) + 42*a(n-3) + 79*a(n-4) - a(n-5) + 8*a(n-6) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 22 2018 10:52:00, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;31\,a(n-1) - 126\,a(n-2) + 42\,a(n-3) + 79\,a(n-4) - a(n-5) + 8\,a(n-6)
\]
for every $n>7$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A230611.
