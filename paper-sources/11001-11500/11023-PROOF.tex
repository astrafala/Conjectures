...
\title{The empirical recurrence for OEIS A302148, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A302148 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A302148 is ``Number of nX6 0..1 arrays with every element equal to 0, 2, 3 or 4 horizontally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
1, 6, 34, 255, 2005, 15999, 128319, 1030709,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 13*a(n-1) -44*a(n-2) +25*a(n-3) +71*a(n-4) -44*a(n-5) -36*a(n-6) +16*a(n-7) for n>9
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 02 2018 14:26:13, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;13\,a(n-1) - 44\,a(n-2) + 25\,a(n-3) + 71\,a(n-4) - 44\,a(n-5) - 36\,a(n-6) + 16\,a(n-7)
\end{equation}
for all $n>9$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302148.
