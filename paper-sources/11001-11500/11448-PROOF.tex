...
\title{The empirical recurrence for OEIS A301793, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A301793 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A301793 is ``Number of 4Xn 0..1 arrays with every element equal to 0 or 1 horizontally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
8, 34, 24, 32, 45, 66, 100, 155,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) -a(n-3) for n>5
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 26 2018 16:44:10, revision 4) the statement is
...
publishes, $n=35$, the arrays have $4\cdot35$ cells over
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A301793.
