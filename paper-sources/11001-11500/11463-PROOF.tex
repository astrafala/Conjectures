...
\title{The empirical recurrence for OEIS A231992, proved by transfer matrix}
...
\begin{abstract}
OEIS A231992 counts $(n+1)\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A231992 is ``Number of (n+1) X (2+1) 0..1 arrays with no element having a strict majority of its horizontal and antidiagonal neighbors equal to one.''. It has offset $1$ and begins
\[
6, 32, 156, 800, 4000, 20228, 101808, 513400,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) + 12*a(n-2) - 5*a(n-3) - 19*a(n-4) + 2*a(n-5) + 4*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 01 2018 21:09:56, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231992.
