...
\title{A proof of the conjectured recurrence for OEIS A101602}
...
\begin{abstract}
OEIS A101602 carries a conjectured linear recurrence with polynomial coefficients, of
...
OEIS A101602 is ``Expansion of g.f. c(3x)\^{}4, where c(x) is the g.f. of A000108''. It has offset $0$ and begins
\[
a(0),\dots,a(7)\;=\;1, 12, 126, 1296, 13365, 138996, 1459458, 15466464,\ \dots
\]
The entry gives the generating function
\begin{equation}\label{eq:gf}
A(x)\;=\;\sum_{n\ge 0} a(n)\,x^{n}\;=\;\frac{16}{\left(\sqrt{1 - 12 x} + 1\right)^{4}} ,
\end{equation}
and it carries the following comment:
\begin{quote}\small
\textbf{Conjecture:} (n+4)*a(n) - 6*(3*n+7)*a(n-1) + 36*(2*n+1)*a(n-2) = 0. - \emph{R. J. Mathar}, Nov 15 2011
\end{quote}
As of the ``Last modified'' line on the live entry (2025-10-10, revision 20) the
...
\[
p_{0}(n)=n + 4,\qquad p_{1}(n)=- 6 \left(3 n + 7\right),\qquad p_{2}(n)=36 \left(2 n + 1\right)
\]
...
\section{The computation for A101602}
...
\[
(n + 4)\,a(n) -  6 \left(3 n + 7\right)\,a(n-1) + 36 \left(2 n + 1\right)\,a(n-2) \;=\;0
\]
holds for every $n>0$.
\end{theorem}
...
section of A101602, agreeing on all 13 terms compared.
...
\url{https://oeis.org}, 2026. Sequence A101602.
