...
\title{The empirical recurrence for OEIS A250462, proved by transfer matrix}
...
\begin{abstract}
OEIS A250462 counts arrays over $\{0,1\}$ in which a statistic taken over short runs
...
OEIS A250462 is ``Number of (n+1)X(2+1) 0..1 arrays with nondecreasing min(x(i,j),x(i,j-1)) in the i direction and nondecreasing min(x(i,j),x(i-1,j)) in the j direction.''. It has offset $1$ and begins
\[
31, 134, 557, 2322, 9651, 40124, 166765, 693150,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) + 3*a(n-2) - 10*a(n-3) + 4*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 14 2018 11:58:11, revision 12) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250462.
