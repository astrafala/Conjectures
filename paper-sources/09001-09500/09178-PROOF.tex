...
\title{The empirical recurrence for OEIS A295711, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A295711 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A295711 is ``Number of nX3 0..1 arrays with each 1 horizontally or vertically adjacent to 0, 1, 2 or 4 1s.''. It has offset $1$ and begins
\[
8, 57, 385, 2580, 17364, 116902, 786804, 5295555,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 26 2017 09:24:42, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) + 8\,a(n-2) + 22\,a(n-3) + 18\,a(n-4) - 2\,a(n-5) - 21\,a(n-6) - 20\,a(n-7) - 5\,a(n-8) + 3\,a(n-9) + 11\,a(n-10) + a(n-11) - 2\,a(n-12)
\end{equation}
for all $n>13$.
...
x_{t,u}=1\ \Rightarrow\ \#\{\text{neighbours equal to }1\}\in\{0,1,2,4\}
\end{equation}
for every cell $(t,u)$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A295711.
