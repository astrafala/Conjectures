...
\title{The empirical recurrence for OEIS A299593, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A299593 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A299593 is ``Number of n X 6 0..1 arrays with every element unequal to 0, 1 or 4 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
13, 15, 35, 121, 256, 576, 1225, 2601,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +a(n-2) +3*a(n-3) +a(n-4) -a(n-5) -a(n-6) for n>9.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 15 2018 20:48:15, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A299593.
