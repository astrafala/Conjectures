...
\title{The empirical recurrence for OEIS A231221, proved by transfer matrix}
...
\begin{abstract}
OEIS A231221 counts $(n+2)\times4$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A231221 is ``Number of (n+2) X (2+2) 0..2 arrays with no element unequal to a strict majority of its horizontal, vertical, diagonal and antidiagonal neighbors, with values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
2, 4, 8, 17, 45, 103, 264, 676,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) + 2*a(n-2) - 6*a(n-3) - 7*a(n-4) + 5*a(n-5) - a(n-6) + 6*a(n-7) + 17*a(n-8) - 20*a(n-9) - 2*a(n-10) + 4*a(n-11).
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 27 2018 15:31:46, revision 7) this is still
...
the condition
\[
\text{no cell is unequal to a strict majority of its horizontal, vertical, diagonal and antidiagonal neighbours},
\]
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + 2\,a(n-2) - 6\,a(n-3) - 7\,a(n-4) + 5\,a(n-5) - a(n-6) + 6\,a(n-7) + 17\,a(n-8) - 20\,a(n-9) - 2\,a(n-10) + 4\,a(n-11)
\]
for every $n>10$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231221.
