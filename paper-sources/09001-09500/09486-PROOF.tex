...
\title{The empirical recurrence for OEIS A234437, proved by transfer matrix}
...
\begin{abstract}
OEIS A234437 counts $3$-column arrays over $\{0,\dots,2\}$ in which every
...
OEIS A234437 is ``Number of (n+1) X (2+1) 0..2 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 1 (constant-stress 1 X 1 tilings).''. It has offset
$1$ and begins
\[
120, 582, 2804, 13676, 66228, 324556, 1578036,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 5*a(n-1) + 24*a(n-2) - 130*a(n-3) + 36*a(n-4) + 80*a(n-5) - 32*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 20 2022 21:32:40, revision 12) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234437.
