...
\title{The empirical recurrence for OEIS A255033, proved by transfer matrix}
...
\begin{abstract}
OEIS A255033 counts the arrays over $\{0,\dots,1\}$ whose $3\times3$ subblocks carry a
...
OEIS A255033 is ``Number of (n+2)X(5+2) 0..1 arrays with every 3X3 subblock sum of the two sums of the central row and central column minus the two minimums of the diagonal and antidiagonal nondecreasing horizontally, vertically and ne-to-sw antidiagonally.''. It has offset $1$ and begins
\[
154680, 470542, 566341, 474308, 509796, 427420, 427492, 432916,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 15:05:50, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A255033.
