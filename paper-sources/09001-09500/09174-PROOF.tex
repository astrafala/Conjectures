...
\title{The empirical recurrence for OEIS A253692, proved by transfer matrix}
...
\begin{abstract}
OEIS A253692 counts arrays of width $3$ over $\{0,1\}$ in which two diagonal numbers of every $2\times2$ subblock each differ from the same number at a neighbouring subblock. The entry carries an
...
$3$ consecutive rows and the count is a walk count on $S=49$ states.
\end{abstract}
...
OEIS A253692 is ``Number of (n+1)X(2+1) 0..1 arrays with every 2X2 subblock ne-sw antidiagonal difference unequal to its neighbors horizontally and nw+se diagonal sum unequal to its neighbors vertically.''. It has offset $1$ and begins
\[
40, 76, 146, 304, 602, 1182, 2416, 4772,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 14:09:27, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-2) + 2\,a(n-3) - 2\,a(n-4) - a(n-5) - 7\,a(n-6) - 3\,a(n-7) + 9\,a(n-8) + 3\,a(n-9) + a(n-10) - a(n-11) - 6\,a(n-12) + 4\,a(n-14) - a(n-16)
\]
for every $n>16$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253692.
