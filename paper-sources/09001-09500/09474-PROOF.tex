...
\title{The empirical recurrence for OEIS A295116, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A295116 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A295116 is ``Number of nX4 0..1 arrays with each 1 horizontally or vertically adjacent to 1 or 4 1s.''. It has offset $1$ and begins
\[
4, 20, 77, 326, 1373, 5793, 24347, 102398,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 15 2017 06:17:42, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 5\,a(n-2) + 22\,a(n-3) + 43\,a(n-4) + 52\,a(n-5) + 35\,a(n-6) + 35\,a(n-7) + 21\,a(n-8) + 14\,a(n-9) + 6\,a(n-10) + 9\,a(n-11) - 7\,a(n-12) - a(n-14)
\end{equation}
for all $n>15$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A295116.
