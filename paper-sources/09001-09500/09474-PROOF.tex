...
\title{The empirical recurrence for OEIS A207701, proved by transfer matrix}
...
\begin{abstract}
OEIS A207701 counts arrays over $\{0,\dots,1\}$ of width $6$ that avoid the patterns
...
OEIS A207701 is ``Number of n X 6 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 0 1 and 1 1 0 vertically.''. It has offset
$1$ and begins
\[
25, 625, 3969, 15129, 43681, 105625, 225625,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 7*a(n-1) - 21*a(n-2) + 35*a(n-3) - 35*a(n-4) + 21*a(n-5) - 7*a(n-6) + a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 25 2018 08:54:57, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207701.
