...
\title{The empirical recurrence for OEIS A232291, proved by transfer matrix}
...
\begin{abstract}
OEIS A232291 counts arrays of width $4$ over $\{0,1,2\}$ in which every cell carrying one stated
...
OEIS A232291 is ``Number of nX4 0..2 arrays with every 0 next to a 1 and every 1 next to a 2 horizontally or antidiagonally.''. It has offset $1$ and begins
\[
15, 587, 20563, 718483, 25116353, 877968487, 30690409685, 1072818688305,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 07:15:42, revision 6) this is still
...
adjacency matrix,
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=4603.
\]
...
\begin{theorem}
\[
a(n)\;=\;30\,a(n-1) + 171\,a(n-2) + 93\,a(n-3) - 496\,a(n-4) - 281\,a(n-5) + 186\,a(n-6) + 206\,a(n-7) - 173\,a(n-8) + 45\,a(n-9) - 4\,a(n-10)
\]
for every $n>10$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232291.
