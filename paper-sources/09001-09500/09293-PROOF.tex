...
\title{The empirical recurrence for OEIS A301885, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A301885 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A301885 is ``Number of 2Xn 0..1 arrays with every element equal to 0, 1 or 3 horizontally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
2, 5, 10, 18, 35, 74, 154, 317,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) +a(n-3) -a(n-4) -2*a(n-6) +a(n-7)
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 28 2018 10:59:41, revision 4) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A301885.
