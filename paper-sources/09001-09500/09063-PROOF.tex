...
\title{The empirical recurrence for OEIS A304267, proved by transfer matrix}
...
\begin{abstract}
OEIS A304267 counts $5$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A304267 is ``Number of nX5 0..1 arrays with every element unequal to 0, 1, 5 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
8, 7, 19, 50, 146, 404, 1074, 2990,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +a(n-2) +10*a(n-3) +4*a(n-4) -2*a(n-5) -12*a(n-6) -5*a(n-7) -4*a(n-8) +4*a(n-9) for n>10
\end{quote}
As of the ``Last modified'' line on the live entry (May 09 2018 10:12:52, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + a(n-2) + 10\,a(n-3) + 4\,a(n-4) - 2\,a(n-5) - 12\,a(n-6) - 5\,a(n-7) - 4\,a(n-8) + 4\,a(n-9)
\end{equation}
for all $n>10$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A304267.
