...
\title{The empirical recurrence for OEIS A228658, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A228658 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A228658 is ``Number of n X 6 binary arrays with top left value 1 and no two ones adjacent horizontally, diagonally or antidiagonally.''. It has offset $1$ and begins
\[
8, 80, 968, 11148, 128740, 1482892, 17074988, 196565912,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 14*a(n-1) - 17*a(n-2) - 142*a(n-3) + 59*a(n-4) + 352*a(n-5) + 103*a(n-6) - 48*a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 12 2018 09:08:23, revision 11) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;14\,a(n-1) - 17\,a(n-2) - 142\,a(n-3) + 59\,a(n-4) + 352\,a(n-5) + 103\,a(n-6) - 48\,a(n-7)
\end{equation}
for all $n>7$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A228658.
