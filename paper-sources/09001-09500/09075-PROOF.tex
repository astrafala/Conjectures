...
\title{The empirical recurrence for OEIS A234047, proved by transfer matrix}
...
\begin{abstract}
OEIS A234047 counts arrays of width $3$ over $\{0,1,2\}$ containing no run of $3$ consecutive
...
OEIS A234047 is ``Number of (n+2)X(1+2) 0..2 arrays with no increasing sequence of length 3 horizontally, diagonally downwards or antidiagonally downwards.''. It has offset $1$ and begins
\[
16488, 402000, 9780884, 237966121, 5789254059, 140841087777, 3426377423999, 83356792653385,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 08:18:32, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;25\,a(n-1) - 14\,a(n-2) - 53\,a(n-3) + 257\,a(n-4) - 8907\,a(n-5) + 3783\,a(n-6) + 24912\,a(n-7) - 11484\,a(n-8) + 1593\,a(n-9) - 5184\,a(n-10) - 3888\,a(n-11)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234047.
