...
\title{The empirical recurrence for OEIS A250526, proved by transfer matrix}
...
\begin{abstract}
OEIS A250526 counts arrays over $\{0,1,2\}$ in which a statistic taken over short runs
...
OEIS A250526 is ``Number of (n+1)X(7+1) 0..2 arrays with nondecreasing x(i,j)-x(i,j-1) in the i direction and nondecreasing x(i,j)-x(i-1,j) in the j direction.''. It has offset $1$ and begins
\[
112373, 682921, 2771901, 9240559, 27710543, 78204775, 212707851, 565044857,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 14*a(n-1) -85*a(n-2) +294*a(n-3) -639*a(n-4) +906*a(n-5) -839*a(n-6) +490*a(n-7) -164*a(n-8) +24*a(n-9)
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 12:30:06, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250526.
