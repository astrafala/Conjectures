...
\title{The empirical recurrence for OEIS A302682, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A302682 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A302682 is ``Number of 4Xn 0..1 arrays with every element equal to 0, 1, 4 or 6 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
8, 6, 7, 20, 30, 76, 217, 509,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +a(n-2) +5*a(n-3) +5*a(n-4) -3*a(n-5) -3*a(n-6) +2*a(n-7) for n>11
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 11 2018 22:07:04, revision 7) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + a(n-2) + 5\,a(n-3) + 5\,a(n-4) - 3\,a(n-5) - 3\,a(n-6) + 2\,a(n-7)
\end{equation}
for all $n>11$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302682.
