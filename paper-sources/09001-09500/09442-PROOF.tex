...
\title{The empirical recurrence for OEIS A245949, proved by transfer matrix}
...
\begin{abstract}
OEIS A245949 carries an empirical recurrence of order $7$ contributed by R.~H.~Hardin. It is
...
OEIS A245949 is ``Number of length n+3 0..7 arrays with some pair in every consecutive four terms totalling exactly 7.''. It has offset $1$ and begins
\[
2216, 13064, 73728, 397504, 2217096, 12257032, 67596992, 373997376,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) + 9*a(n-2) + 31*a(n-3) - 19*a(n-4) - 3*a(n-5) - 5*a(n-6) + a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 05 2018 06:32:55, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + 9\,a(n-2) + 31\,a(n-3) - 19\,a(n-4) - 3\,a(n-5) - 5\,a(n-6) + a(n-7)
\]
for every $n>-2$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A245949.
