...
\title{The empirical recurrence for OEIS A250801, proved by transfer matrix}
...
\begin{abstract}
OEIS A250801 counts arrays over $\{0,1\}$ in which a statistic taken over short runs
...
OEIS A250801 is ``Number of (4+1) X (n+1) 0..1 arrays with nondecreasing min(x(i,j),x(i,j-1)) in the i direction and nondecreasing absolute value of x(i,j)-x(i-1,j) in the j direction.''. It has offset $1$ and begins
\[
140, 490, 1430, 3776, 9258, 21610, 48600, 106426,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) - 2*a(n-2) - 9*a(n-3) + 9*a(n-4) + 6*a(n-5) - 8*a(n-6) -a(n-7) + 2*a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 20 2018 11:41:02, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) - 2\,a(n-2) - 9\,a(n-3) + 9\,a(n-4) + 6\,a(n-5) - 8\,a(n-6) - a(n-7) + 2\,a(n-8)
\]
for every $n>7$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250801.
