...
\title{The empirical recurrence for OEIS A246734, proved by transfer matrix}
...
\begin{abstract}
OEIS A246734 carries an empirical recurrence of order $7$ contributed by R.~H.~Hardin. It is
...
OEIS A246734 is ``Number of length n+4 0..5 arrays with no pair in any consecutive five terms totalling exactly 5.''. It has offset $1$ and begins
\[
1566, 5430, 18966, 66294, 231414, 807630, 2818830, 9838974,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) + a(n-2) + a(n-3) + 5*a(n-4) + a(n-5) - a(n-6) - a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 06 2018 11:26:45, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + a(n-2) + a(n-3) + 5\,a(n-4) + a(n-5) - a(n-6) - a(n-7)
\]
for every $n>7$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A246734.
