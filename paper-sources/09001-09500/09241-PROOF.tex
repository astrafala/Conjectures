...
\title{The empirical recurrence for OEIS A208641, proved by transfer matrix}
...
\begin{abstract}
OEIS A208641 counts $6\times n$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 22 2025 21:27:21, revision 11) this is still
