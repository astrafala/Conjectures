...
\title{The empirical recurrence for OEIS A317891, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A317891 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A317891 is ``Number of nX3 0..1 arrays with every element unequal to 2, 3 or 4 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
0, 1, 4, 13, 59, 252, 1074, 4633,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2018 10:30:21, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) + 8\,a(n-3) - 10\,a(n-4) + 3\,a(n-5) - 17\,a(n-6) - 7\,a(n-7) - 21\,a(n-8) + 6\,a(n-9) + 10\,a(n-10) + 4\,a(n-11) - 18\,a(n-12) - 21\,a(n-13) - 9\,a(n-14) - a(n-15) + 2\,a(n-16)
\end{equation}
for all $n>18$.
...
\#\{\text{neighbours with a value }different from\ x_{t,u}\}\in\{2,3,4\}
\end{equation}
...
the middle row. The vector $w$ was formed by $16$ applications of $G$ in exact integer
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A317891.
