...
\title{The empirical recurrence for OEIS A228666, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A228666 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A228666 is ``Number of 7 X n binary arrays with top left value 1 and no two ones adjacent horizontally, diagonally or antidiagonally.''. It has offset $1$ and begins
\[
64, 169, 9598, 63688, 1720343, 17074988, 337258048, 4073313193,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 25 2023 07:49:16, revision 10) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;9\,a(n-1) + 184\,a(n-2) - 1201\,a(n-3) - 7155\,a(n-4) + 46048\,a(n-5) + 70745\,a(n-6) - 591673\,a(n-7) - 154744\,a(n-8) + 3207657\,a(n-9) - 715173\,a(n-10) - 7580648\,a(n-11) + 3369552\,a(n-12) + 7114920\,a(n-13) - 3800952\,a(n-14) - 1923264\,a(n-15) + 1083456\,a(n-16)
\end{equation}
for all $n>17$.
...
publishes, $n=16$, the arrays have $7\cdot16$ cells over
...
Every one of those integers vanishes from the index corresponding to $n=17+1$ onwards,
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A228666.
