...
\title{The empirical recurrence for OEIS A300367, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A300367 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A300367 is ``Number of nX3 0..1 arrays with every element equal to 2 or 3 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
0, 1, 0, 3, 3, 8, 16, 32,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-2) +2*a(n-3) +5*a(n-4) +6*a(n-5) +4*a(n-6) +6*a(n-7) +a(n-8) -a(n-12) +2*a(n-13) -a(n-14)
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 04 2018 09:06:13, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-2) + 2\,a(n-3) + 5\,a(n-4) + 6\,a(n-5) + 4\,a(n-6) + 6\,a(n-7) + a(n-8) - a(n-12) + 2\,a(n-13) - a(n-14)
\end{equation}
for all $n>15$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A300367.
