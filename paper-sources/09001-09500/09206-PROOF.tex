...
\title{The empirical recurrence for OEIS A301880, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A301880 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A301880 is ``Number of n X 4 0..1 arrays with every element equal to 0, 1 or 3 horizontally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
5, 18, 58, 203, 673, 2340, 7883, 27175,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +12*a(n-2) -2*a(n-3) -38*a(n-4) +a(n-5) +12*a(n-6) -a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 23 2026 14:01:36, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 12\,a(n-2) - 2\,a(n-3) - 38\,a(n-4) + a(n-5) + 12\,a(n-6) - a(n-8)
\end{equation}
for all $n>9$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A301880.
