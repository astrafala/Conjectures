...
\title{The empirical recurrence for OEIS A302207, proved by transfer matrix}
...
\begin{abstract}
OEIS A302207 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A302207 is ``Number of nX3 0..1 arrays with every element equal to 0, 2 or 3 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 11, 16, 47, 147, 386, 1065, 3063,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) -2*a(n-2) +9*a(n-3) -13*a(n-4) +2*a(n-5) -12*a(n-6) +12*a(n-7) -16*a(n-9)
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 03 2018 11:58:21, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) - 2\,a(n-2) + 9\,a(n-3) - 13\,a(n-4) + 2\,a(n-5) - 12\,a(n-6) + 12\,a(n-7) - 16\,a(n-9)
\end{equation}
for all $n>9$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302207.
