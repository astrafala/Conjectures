...
\title{The empirical recurrence for OEIS A296033, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A296033 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A296033 is ``Number of n X 2 0..1 arrays with each 1 adjacent to 2 or 4 king-move neighboring 1s.''. It has offset $1$ and begins
\[
1, 5, 11, 21, 55, 125, 271, 645,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) + 6*a(n-3) + 4*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 22 2019 15:52:35, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 6\,a(n-3) + 4\,a(n-5)
\end{equation}
for all $n>6$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A296033.
