...
\title{The empirical recurrence for OEIS A189197, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A189197 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A189197 is ``Number of 4 X n binary arrays without the pattern 0 0 1 vertically or antidiagonally.''. It has offset $1$ and begins
\[
12, 144, 1494, 15326, 156564, 1598444, 16316636, 166552852,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 12*a(n-1) -14*a(n-2) -52*a(n-3) +82*a(n-4) +16*a(n-5) -56*a(n-6) +16*a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (May 01 2018 13:24:13, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;12\,a(n-1) - 14\,a(n-2) - 52\,a(n-3) + 82\,a(n-4) + 16\,a(n-5) - 56\,a(n-6) + 16\,a(n-7)
\end{equation}
for all $n>8$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A189197.
