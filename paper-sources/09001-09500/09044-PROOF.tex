...
\title{The empirical recurrence for OEIS A203883, proved by transfer matrix}
...
\begin{abstract}
OEIS A203883 counts $(n+1)\times5$ arrays over $\{0,\dots,6\}$ subject to a condition imposed on
...
OEIS A203883 is ``Number of (n+1)X5 0..6 arrays with every 2X2 subblock having equal diagonal elements or equal antidiagonal elements.''. It has offset $1$ and begins
\[
1399489, 222645367, 39572771665, 7265109130279, 1337957259758497, 247090069595954263, 45601045546133880817, 8420752441494326059399,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 115*a(n-1) +17016*a(n-2) -763308*a(n-3) -1177416*a(n-4) +49714560*a(n-5) +35870688*a(n-6) -153031680*a(n-7)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 10:48:57, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;115\,a(n-1) + 17016\,a(n-2) - 763308\,a(n-3) - 1177416\,a(n-4) + 49714560\,a(n-5) + 35870688\,a(n-6) - 153031680\,a(n-7)
\end{equation}
for all $n>6$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A203883.
