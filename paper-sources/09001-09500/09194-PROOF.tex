...
\title{The empirical recurrence for OEIS A235296, proved by transfer matrix}
...
\begin{abstract}
OEIS A235296 counts $7$-column arrays over $\{0,\dots,3\}$ in which every
...
OEIS A235296 is ``Number of (n+1) X (6+1) 0..3 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 3 (constant-stress 1 X 1 tilings).''. It has offset
$1$ and begins
\[
5232, 6532, 8336, 12328, 18624, 32992, 58688,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) +17*a(n-2) -57*a(n-3) -86*a(n-4) +372*a(n-5) +76*a(n-6) -972*a(n-7) +360*a(n-8) +864*a(n-9) -576*a(n-10).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 18 2022 23:38:46, revision 7) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A235296.
