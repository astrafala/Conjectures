...
\title{The empirical recurrence for OEIS A250633, proved by transfer matrix}
...
\begin{abstract}
OEIS A250633 counts arrays over $\{0,1,2\}$ in which a statistic taken over short runs
...
OEIS A250633 is ``Number of (1+1) X (n+1) 0..2 arrays with nondecreasing x(i,j)+x(i,j-1) in the i direction and nondecreasing min(x(i,j),x(i-1,j)) in the j direction.''. It has offset $1$ and begins
\[
36, 154, 585, 2183, 7924, 28456, 101308, 358990,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 5*a(n-1) - 2*a(n-2) - 14*a(n-3) + 7*a(n-4) + 10*a(n-5) - 5*a(n-6) - 2*a(n-7) + a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 15 2018 11:07:50, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) - 2\,a(n-2) - 14\,a(n-3) + 7\,a(n-4) + 10\,a(n-5) - 5\,a(n-6) - 2\,a(n-7) + a(n-8)
\]
for every $n>7$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250633.
