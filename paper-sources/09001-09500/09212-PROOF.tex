...
\title{The empirical recurrence for OEIS A235312, proved by transfer matrix}
...
\begin{abstract}
OEIS A235312 counts $2$-column arrays over $\{0,\dots,6\}$ in which every
...
OEIS A235312 is ``Number of (n+1) X (1+1) 0..6 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 7 (constant-stress 1 X 1 tilings).''. It has offset
$1$ and begins
\[
112, 392, 1120, 3920, 11776, 41216, 128128,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 28*a(n-2) -252*a(n-4) +720*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 18 2022 23:07:47, revision 10) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;28\,a(n-2) - 252\,a(n-4) + 720\,a(n-6)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A235312.
