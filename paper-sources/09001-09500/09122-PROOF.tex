...
\title{The empirical recurrence for OEIS A186817, proved by transfer matrix}
...
\begin{abstract}
OEIS A186817 counts arrays of width $3$ over $\{0,1\}$ in which every $3\times3$ subblock
...
OEIS A186817 is ``Half the number of (n+2) X 3 binary arrays with each 3 X 3 subblock having sum 4 or 5.''. It has offset $1$ and begins
\[
126, 606, 2904, 14229, 70767, 351549, 1750896, 8730234,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) + 9*a(n-2) + 15*a(n-3) - 36*a(n-4) - 72*a(n-5) - 27*a(n-6) - 81*a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 19 2018 05:59:59, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + 9\,a(n-2) + 15\,a(n-3) - 36\,a(n-4) - 72\,a(n-5) - 27\,a(n-6) - 81\,a(n-7)
\]
for every $n>7$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A186817.
