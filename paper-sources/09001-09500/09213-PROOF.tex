...
\title{The empirical recurrence for OEIS A230065, proved by transfer matrix}
...
\begin{abstract}
OEIS A230065 carries an empirical recurrence of order $16$ contributed by R. H. Hardin. It is
...
OEIS A230065 is ``Number of nX5 0..2 arrays x(i,j) with each element diagonally or antidiagonally next to at least one element with value 2-x(i,j).''. It has offset $1$ and begins
\[
0, 225, 3645, 281961, 14082255, 793041921, 43142680647, 2369158188849,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 08:40:51, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;59\,a(n-1) - 13572\,a(n-3) + 53018\,a(n-4) - 4614\,a(n-5) - 84248\,a(n-6) + 5703584\,a(n-7) - 22239144\,a(n-8) - 30968\,a(n-9) + 2695936\,a(n-10) - 13901184\,a(n-11) + 54290432\,a(n-12) - 1462272\,a(n-13) + 65536\,a(n-15) - 1048576\,a(n-16)
\]
for every $n>19$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A230065.
