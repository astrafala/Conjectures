...
\title{The empirical recurrence for OEIS A298919, proved by transfer matrix}
...
\begin{abstract}
OEIS A298919 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A298919 is ``Number of nX3 0..1 arrays with every element equal to 1, 3, 5, 7 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
0, 4, 1, 2, 3, 5, 8, 16,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +a(n-2) +a(n-6) -a(n-7) -a(n-8)
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 29 2018 07:56:24, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A298919.
