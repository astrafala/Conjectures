...
\title{The empirical recurrence for OEIS A223426, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A223426 counts arrays over $\{0,\dots,14\}$ in which every cell is constrained by the
...
\{x_{t,u},x_{t+d_1,u+d_2}\}\in E\ \text{ for every offset in }\mathcal N,\quad E=\{\{0,1\},\{0,2\},\{1,3\},\{1,4\},\{2,4\},\{2,5\},\{3,6\},\{3,7\},\{4,7\},\{4,8\},\{5,8\},\{5,9\},\{6,10\},\{6,11\},\{7,11\},\{7,12\},\{8,12\},\{8,13\},\{9,13\},\{9,14\}\}
\end{equation}
for every cell $(t,u)$.
...
$15$ values, so there are about $10^{44}$ of them to sift. The
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223426.
