...
\title{The empirical recurrence for OEIS A188845, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A188845 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A188845 is ``Number of nX3 binary arrays without the pattern 0 0 1 vertically, antidiagonally or horizontally.''. It has offset $1$ and begins
\[
7, 49, 219, 958, 3860, 15358, 59939, 232747,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 04:52:51, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;7\,a(n-1) - 10\,a(n-2) - 22\,a(n-3) + 57\,a(n-4) + 3\,a(n-5) - 77\,a(n-6) + 21\,a(n-7) + 42\,a(n-8) - 10\,a(n-9) - 13\,a(n-10) + a(n-11) + 2\,a(n-12)
\end{equation}
for all $n>13$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A188845.
