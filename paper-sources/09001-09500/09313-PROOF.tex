...
\title{The empirical recurrence for OEIS A250936, proved by transfer matrix}
...
\begin{abstract}
OEIS A250936 counts arrays over $\{0,1,2\}$ in which a statistic taken over short runs
...
OEIS A250936 is ``Number of (n+1)X(2+1) 0..2 arrays with nondecreasing x(i,j)+x(i,j-1) in the i direction and nondecreasing absolute value of x(i,j)-x(i-1,j) in the j direction.''. It has offset $1$ and begins
\[
155, 699, 2812, 10528, 37477, 128507, 428095, 1394237,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 13*a(n-1) -71*a(n-2) +211*a(n-3) -368*a(n-4) +376*a(n-5) -208*a(n-6) +48*a(n-7) for n>11
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 12:52:30, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;13\,a(n-1) - 71\,a(n-2) + 211\,a(n-3) - 368\,a(n-4) + 376\,a(n-5) - 208\,a(n-6) + 48\,a(n-7)
\]
for every $n>11$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250936.
