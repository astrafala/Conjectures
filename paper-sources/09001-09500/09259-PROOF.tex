...
\title{The empirical recurrence for OEIS A203051, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A203051 counts arrays over $\{0,\dots,5\}$ in which every cell is constrained by the
...
OEIS A203051 is ``Number of nX2 0..5 arrays with every nonzero element less than or equal to some horizontal or vertical neighbor.''. It has offset $1$ and begins
\[
6, 286, 7820, 177290, 4078368, 96511488, 2282090278, 53729637298,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 10:04:46, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;21\,a(n-1) - 50\,a(n-2) + 2261\,a(n-3) + 5179\,a(n-4) + 58301\,a(n-5) + 113102\,a(n-6) + 454821\,a(n-7) + 550157\,a(n-8) + 1071256\,a(n-9) + 600336\,a(n-10) + 518400\,a(n-11)
\end{equation}
for all $n>12$.
...
publishes, $n=16$, the arrays have $2\cdot16$ cells over
$6$ values, so there are about $10^{24}$ of them to sift. The
...
the middle row. The vector $w$ was formed by $11$ applications of $G$ in exact integer
arithmetic and $\mathbf{v}^{\!\top}G^{m}w$ evaluated for $m=0,1,\dots$, again exactly.
Every one of those integers vanishes from the index corresponding to $n=12+1$ onwards,
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A203051.
