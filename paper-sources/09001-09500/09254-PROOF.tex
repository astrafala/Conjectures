...
\title{The empirical recurrence for OEIS A237504, proved by transfer matrix}
...
\begin{abstract}
OEIS A237504 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
OEIS A237504 is ``Number of (n+1)X(1+1) 0..2 arrays with the maximum plus the upper median minus the minimum of every 2X2 subblock differing from its horizontal and vertical neighbors by exactly one.''. It has offset $1$ and begins
\[
81, 328, 1342, 5622, 23545, 97700, 406008, 1690160,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 208*a(n-4) +1448*a(n-6) +2500*a(n-8) +528*a(n-10) -624*a(n-12)
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 10:14:16, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;208\,a(n-4) + 1448\,a(n-6) + 2500\,a(n-8) + 528\,a(n-10) - 624\,a(n-12)
\]
for every $n>12$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237504.
