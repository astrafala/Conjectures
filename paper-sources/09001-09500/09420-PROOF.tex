...
\title{The empirical recurrence for OEIS A252264, proved by transfer matrix}
...
\begin{abstract}
OEIS A252264 counts $(n+2)\times5$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252264 is ``Number of (n+2) X (3+2) 0..3 arrays with every 3 X 3 subblock row, column, diagonal and antidiagonal sum not equal to 2 3 4 6 or 7.''. It has offset $1$ and begins
\[
258, 822, 3016, 10302, 35486, 122506, 420420, 1446744,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 19 2025 08:42:29, revision 9) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252264.
