...
\title{The empirical recurrence for OEIS A261107, proved by transfer matrix}
...
\begin{abstract}
OEIS A261107 counts $(n+2)\times4$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A261107 is ``Number of (n+2) X (2+2) 0..1 arrays with each 3 X 3 subblock having clockwise perimeter pattern 00010001 00010101 or 01010101.''. It has offset $1$ and begins
\[
33, 52, 106, 206, 402, 790, 1546, 3026,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) +2*a(n-3) +2*a(n-4) +2*a(n-5) +a(n-6) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 30 2018 06:35:13, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A261107.
