...
\title{The empirical recurrence for OEIS A231799, proved by transfer matrix}
...
\begin{abstract}
OEIS A231799 counts $(n+1)\times2$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A231799 is ``Number of (n+1) X (1+1) 0..1 arrays with no element having a strict majority of its horizontal, vertical, diagonal and antidiagonal neighbors equal to one.''. It has offset $1$ and begins
\[
5, 13, 32, 79, 200, 500, 1249, 3133,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + 2*a(n-2) + 5*a(n-3) - 2*a(n-5) - 4*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 01 2018 06:27:54, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231799.
