...
\title{The empirical recurrence for OEIS A252299, proved by transfer matrix}
...
\begin{abstract}
OEIS A252299 counts $(n+2)\times4$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252299 is ``Number of (n+2)X(2+2) 0..3 arrays with every 3X3 subblock row and diagonal sum equal to 0 1 3 6 or 7 and every 3X3 column and antidiagonal sum not equal to 0 1 3 6 or 7.''. It has offset $1$ and begins
\[
1126, 1031, 1168, 1516, 2350, 3476, 4905, 8198,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 11*a(n-3) -42*a(n-6) +64*a(n-9) -32*a(n-12) for n>24
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:02:28, revision 6) this is still
...
at once. By Lemma~\ref{lem:crit} the recurrence holds for every $n>24$. The bound is exact: at $n=24$ the recurrence fails on the entry's own published terms, so no larger range holds.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252299.
