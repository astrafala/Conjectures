...
\title{The empirical recurrence for OEIS A316299, proved by transfer matrix}
...
\begin{abstract}
OEIS A316299 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A316299 is ``Number of nX3 0..1 arrays with every element unequal to 0, 1, 2, 4, 6 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
4, 12, 20, 39, 110, 245, 572, 1384,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 29 2018 07:11:05, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-2) + 7\,a(n-3) + 8\,a(n-4) + 2\,a(n-5) - 12\,a(n-6) - 26\,a(n-7) - 23\,a(n-8) - 6\,a(n-9) + 9\,a(n-10) + 10\,a(n-11) + 3\,a(n-12)
\end{equation}
for all $n>13$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A316299.
