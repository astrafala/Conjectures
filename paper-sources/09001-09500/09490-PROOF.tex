...
\title{The empirical recurrence for OEIS A205981, proved by transfer matrix}
...
\begin{abstract}
OEIS A205981 counts arrays over $\{0,\dots,2\}$ under a condition on the perimeter cycle of
...
a bounded window of consecutive rows, so the count is a walk count on $S=2232$ states and is
...
OEIS A205981 is ``Number of (n+1) X 4 0..2 arrays with every 2 X 3 or 3 X 2 subblock having exactly two clockwise edge increases.''. It has offset $1$ and begins
\[
2232, 8004, 27060, 103998, 408411, 1599096, 6296976, 24685680,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 60*a(n-3) +8*a(n-5) for n>9.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 13 2018 05:47:11, revision 9) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A205981.
