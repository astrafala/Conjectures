...
\title{The empirical recurrence for OEIS A206263, proved by transfer matrix}
...
\begin{abstract}
OEIS A206263 counts arrays over $\{0,\dots,1\}$ under a condition on the number of rightwards and downwards edge increases
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 15 2018 06:39:04, revision 8) this is still
...
subblocks; the entry's first term is $50$, which the model
