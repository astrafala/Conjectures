...
\title{The empirical recurrence for OEIS A252336, proved by transfer matrix}
...
\begin{abstract}
OEIS A252336 counts $(n+2)\times3$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A252336 is ``Number of (n+2) X (1+2) 0..2 arrays with every 3 X 3 subblock row, column, diagonal and antidiagonal sum not equal to 2 3 or 4.''. It has offset $1$ and begins
\[
52, 108, 234, 538, 1202, 2612, 5706, 12616,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + 3*a(n-3) + 4*a(n-4) + 4*a(n-5) + 2*a(n-6) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 03 2018 07:44:58, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252336.
