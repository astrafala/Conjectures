...
\title{The empirical recurrence for OEIS A252519, proved by transfer matrix}
...
\begin{abstract}
OEIS A252519 counts $(n+2)\times6$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
$a(n)$ is a walk count on $S=183407$ vertices. Such a sequence is $C$-finite, so whether a given
...
OEIS A252519 is ``Number of (n+2)X(4+2) 0..3 arrays with every 3X3 subblock row and column sum not equal to 0 2 4 6 or 7 and every 3X3 diagonal and antidiagonal sum equal to 0 2 4 6 or 7.''. It has offset $1$ and begins
\[
660, 1169, 2818, 5628, 17804, 47308, 96659, 310987,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 21*a(n-3) -62*a(n-6) +47*a(n-9) -5*a(n-12) for n>17
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:19:26, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;21\,a(n-3) - 62\,a(n-6) + 47\,a(n-9) - 5\,a(n-12)
\]
for every $n>17$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252519.
