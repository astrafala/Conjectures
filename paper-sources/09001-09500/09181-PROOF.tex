...
\title{The empirical recurrence for OEIS A184122, proved by transfer matrix}
...
\begin{abstract}
OEIS A184122 counts arrays over $\{0,\dots,3\}$ whose rows, columns, diagonals or
...
OEIS A184122 is ``Number of nX2 0..3 arrays with rows and columns in nondecreasing order.''. It has offset $1$ and begins
\[
10, 86, 561, 2861, 12068, 43947, 142376, 419213,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 02:20:16, revision 10) the statement is
...
The arrays have $2$ columns and $L=n$ rows. Written in (row, column)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A184122.
