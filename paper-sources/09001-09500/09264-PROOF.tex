...
\title{The empirical recurrence for OEIS A281601, proved by transfer matrix}
...
\begin{abstract}
OEIS A281601 counts $n\times4$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A281601 is ``Number of nX4 0..2 arrays with no element equal to more than one of its horizontal, diagonal or antidiagonal neighbors and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
11, 110, 1283, 16198, 203276, 2563481, 32354824, 408458506,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 25 2017 10:37:56, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;13\,a(n-1) + 3\,a(n-2) - 87\,a(n-3) - 125\,a(n-4) - 116\,a(n-5) + 69\,a(n-6) + 522\,a(n-7) - 148\,a(n-8) - 199\,a(n-9) + 690\,a(n-10) - 105\,a(n-11) - 265\,a(n-12) - 155\,a(n-13) - 84\,a(n-14) - 23\,a(n-15) - 13\,a(n-16)
\]
for every $n>18$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A281601.
