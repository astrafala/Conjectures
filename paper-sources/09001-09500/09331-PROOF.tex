...
\title{The empirical recurrence for OEIS A251772, proved by transfer matrix}
...
\begin{abstract}
OEIS A251772 counts arrays of width $3$ over $\{0,1,2,3\}$ in which every $3\times3$ window has
...
OEIS A251772 is ``Number of (n+2) X (1+2) 0..3 arrays with every 3 X 3 subblock row and column sum 3 or 6 and every diagonal and antidiagonal sum not 3 or 6.''. It has offset $1$ and begins
\[
470, 1142, 2402, 4790, 12302, 27242, 55766, 148022,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + 16*a(n-3) - 16*a(n-4) - 39*a(n-6) + 39*a(n-7) - 36*a(n-9) + 36*a(n-10).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 30 2018 10:05:15, revision 7) this is still
...
\text{each row} & \text{must be 3 or 6} \\
\text{each column} & \text{must be 3 or 6} \\
\text{the main diagonal} & \text{must NOT be 3 or 6} \\
\text{the antidiagonal} & \text{must NOT be 3 or 6} \\
\end{array}
\]
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 16\,a(n-3) - 16\,a(n-4) - 39\,a(n-6) + 39\,a(n-7) - 36\,a(n-9) + 36\,a(n-10)
\]
for every $n>10$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251772.
