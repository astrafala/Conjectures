...
\title{The empirical recurrence for OEIS A258725, proved by transfer matrix}
...
\begin{abstract}
OEIS A258725 carries an empirical recurrence of order $8$ contributed by R.~H.~Hardin. It is
...
OEIS A258725 is ``Number of length n+3 0..3 arrays with at most one downstep in every 3 consecutive neighbor pairs.''. It has offset $1$ and begins
\[
190, 608, 2028, 6552, 20955, 68120, 220854, 711432,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) -6*a(n-2) +20*a(n-3) -34*a(n-4) +24*a(n-5) -16*a(n-6) +8*a(n-7) -a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 26 2018 06:14:42, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) - 6\,a(n-2) + 20\,a(n-3) - 34\,a(n-4) + 24\,a(n-5) - 16\,a(n-6) + 8\,a(n-7) - a(n-8)
\]
for every $n>11$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A258725.
