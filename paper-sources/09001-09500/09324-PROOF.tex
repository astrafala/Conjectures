...
\title{The empirical recurrence for OEIS A205209, proved by transfer matrix}
...
\begin{abstract}
OEIS A205209 counts arrays over $\{0,\dots,2\}$ under a condition on the determinant of every
...
a bounded window of consecutive rows, so the count is a walk count on $S=452$ states and is
...
OEIS A205209 is ``Number of (n+1)X3 0..2 arrays with the determinants of 2X2 subblocks nondecreasing rightwards and downwards.''. It has offset $1$ and begins
\[
452, 3248, 23578, 203313, 1846145, 17014174, 157776973, 1467364433,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 15*a(n-1) -49*a(n-2) -97*a(n-3) +664*a(n-4) -980*a(n-5) +448*a(n-6) for n>13
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 11:51:27, revision 9) this is still
...
entry's first term is $452$, and the model reproduces it along with every later term; that
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A205209.
