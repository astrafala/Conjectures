...
\title{The empirical recurrence for OEIS A235232, proved by transfer matrix}
...
\begin{abstract}
OEIS A235232 counts $2$-column arrays over $\{0,\dots,6\}$ in which every
...
OEIS A235232 is ``Number of (n+1) X (1+1) 0..6 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 6, with no adjacent elements equal (constant-stress tilted 1 X 1 tilings).''. It has offset
$1$ and begins
\[
120, 420, 1328, 4652, 14944, 52468, 170864,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) + 23*a(n-2) - 63*a(n-3) - 153*a(n-4) + 333*a(n-5) + 249*a(n-6) - 81*a(n-7) - 54*a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 19 2022 00:04:31, revision 11) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 23\,a(n-2) - 63\,a(n-3) - 153\,a(n-4) + 333\,a(n-5) + 249\,a(n-6) - 81\,a(n-7) - 54\,a(n-8)
\end{equation}
for all $n>8$, which is every $n$ at which a recurrence of order $8$ can be
stated.
...
$j=0,1,\dots$. They vanish from $j=8-8+1$ onwards, and the run was continued past
$S$ consecutive zeros, which by Lemma~\ref{lem:crit} settles every larger $j$. Hence the
recurrence holds for every $n>8$.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A235232.
