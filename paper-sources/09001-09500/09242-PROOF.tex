...
\title{The empirical recurrence for OEIS A202596, proved by transfer matrix}
...
\begin{abstract}
OEIS A202596 counts arrays of width $5$ over $\{0,1\}$ containing no occurrence of certain short
...
OEIS A202596 is ``Number of (n+2)X5 binary arrays avoiding patterns 001 and 000 in rows and columns.''. It has offset $1$ and begins
\[
1968, 18160, 157952, 1402544, 12360432, 109234112, 964348880, 8516820112,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) +43*a(n-2) +16*a(n-3) -169*a(n-4) -8*a(n-5) +161*a(n-6) -16*a(n-7) -31*a(n-8) +4*a(n-9) +a(n-10)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 09:43:58, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + 43\,a(n-2) + 16\,a(n-3) - 169\,a(n-4) - 8\,a(n-5) + 161\,a(n-6) - 16\,a(n-7) - 31\,a(n-8) + 4\,a(n-9) + a(n-10)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A202596.
