...
\title{The empirical recurrence for OEIS A297311, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297311 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A297311 is ``Number of nX5 0..1 arrays with every 1 horizontally or antidiagonally adjacent to 1 or 2 neighboring 1s.''. It has offset $1$ and begins
\[
12, 207, 2577, 35476, 484808, 6623719, 90535227, 1237278512,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 28 2017 07:25:11, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) + 91\,a(n-2) + 215\,a(n-3) - 317\,a(n-4) - 733\,a(n-5) + 1104\,a(n-6) - 40\,a(n-7) - 1643\,a(n-8) + 1667\,a(n-9) - 589\,a(n-10) + 69\,a(n-11) - a(n-12)
\end{equation}
for all $n>14$.
...
The threshold below is exact rather than merely sufficient: at $n=14$ the conjectured
...
Every one of those integers vanishes from the index corresponding to $n=14+1$ onwards,
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297311.
