...
\title{The empirical recurrence for OEIS A232061, proved by transfer matrix}
...
\begin{abstract}
OEIS A232061 counts arrays of width $4$ over $\{0,1,2\}$ in which every cell carrying one stated
...
OEIS A232061 is ``Number of nX4 0..2 arrays with every 0 next to a 1 and every 1 next to a 2 horizontally or vertically, with no adjacent values equal.''. It has offset $1$ and begins
\[
6, 30, 130, 534, 2230, 9310, 38870, 162278,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) +a(n-2) -4*a(n-4) -3*a(n-5) +a(n-7) +3*a(n-8) -a(n-11)
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 06:51:00, revision 6) this is still
...
adjacency matrix,
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=466.
\]
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + a(n-2) - 4\,a(n-4) - 3\,a(n-5) + a(n-7) + 3\,a(n-8) - a(n-11)
\]
for every $n>11$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232061.
