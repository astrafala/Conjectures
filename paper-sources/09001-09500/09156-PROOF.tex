...
\title{The empirical recurrence for OEIS A230782, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A230782 counts arrays over $\{0,\dots,3\}$ in which every cell is constrained by the
...
OEIS A230782 is ``Number of n X 2 0..3 arrays x(i,j) with each element horizontally, vertically, diagonally or antidiagonally next to at least one element with value (x(i,j)+1) mod 4, and upper left element zero.''. It has offset $1$ and begins
\[
0, 6, 86, 820, 8154, 82576, 833986, 8417644,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 10*a(n-1) - 3*a(n-2) + 44*a(n-3) - 40*a(n-4) + 8*a(n-5) - 192*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 22 2018 11:51:48, revision 9) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A230782.
