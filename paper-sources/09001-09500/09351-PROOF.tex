...
\title{The empirical recurrence for OEIS A303237, proved by transfer matrix}
...
\begin{abstract}
OEIS A303237 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A303237 is ``Number of nX3 0..1 arrays with every element equal to 0, 2, 3, 5 or 6 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 11, 18, 55, 181, 494, 1465, 4415,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 20 2018 10:52:00, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A303237.
