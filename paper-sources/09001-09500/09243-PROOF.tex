...
\title{The empirical recurrence for OEIS A234415, proved by transfer matrix}
...
\begin{abstract}
OEIS A234415 counts $(n+1)\times3$ arrays over $\{0,\dots,7\}$ subject to a condition imposed on
...
OEIS A234415 is ``Number of (n+1)X(2+1) 0..7 arrays with every 2X2 subblock having the absolute values of all six edge and diagonal differences no larger than 1.''. It has offset $1$ and begins
\[
550, 5606, 56768, 576798, 5868488, 59776664, 609452862, 6218451874,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 09:18:20, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;32\,a(n-1) - 369\,a(n-2) + 1673\,a(n-3) - 571\,a(n-4) - 14714\,a(n-5) + 17158\,a(n-6) + 49278\,a(n-7) - 48443\,a(n-8) - 82676\,a(n-9) + 36495\,a(n-10) + 61437\,a(n-11) + 3223\,a(n-12) - 8282\,a(n-13) - 92\,a(n-14) + 420\,a(n-15) - 40\,a(n-16)
\end{equation}
for all $n>16$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234415.
