...
\title{The empirical recurrence for OEIS A253441, proved by transfer matrix}
...
\begin{abstract}
OEIS A253441 counts the arrays over $\{0,\dots,1\}$ whose $2\times2$ subblocks carry a
...
so a pair of consecutive array rows is a state, the count is a walk count on $S=613$ of them,
...
OEIS A253441 is ``Number of (7+1) X (n+1) 0..1 arrays with every 2 X 2 subblock diagonal minus antidiagonal sum nondecreasing horizontally, vertically and ne-to-sw antidiagonally.''. It has offset $1$ and begins
\[
613, 612, 625, 660, 732, 876, 1164, 1740,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) - 2*a(n-2) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 13 2018 05:16:50, revision 7) this is still
...
\]
on the $S=613$ admissible pairs. In particular $a$ is $C$-finite. The alignment of the walk
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253441.
