...
\title{The empirical recurrence for OEIS A281204, proved by transfer matrix}
...
\begin{abstract}
OEIS A281204 counts $n\times7$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A281204 is ``Number of n X 7 0..1 arrays with no element equal to more than one of its horizontal and antidiagonal neighbors, with the exception of exactly one element, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
20, 166, 537, 1358, 3137, 6838, 14375, 29416,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) - 4*a(n-2) - 2*a(n-4) + 4*a(n-5) - 2*a(n-6) + 4*a(n-7) - a(n-8) - 2*a(n-10) - a(n-12).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 18 2019 06:49:33, revision 8) this is still
...
$(r,s)\in(\{0,\dots,1\}^{7}\cup\{\varnothing\})\times\{0,\dots,1\}^{7}$ \times \{0,\dots,1\},
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) - 4\,a(n-2) - 2\,a(n-4) + 4\,a(n-5) - 2\,a(n-6) + 4\,a(n-7) - a(n-8) - 2\,a(n-10) - a(n-12)
\]
for every $n>12$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A281204.
