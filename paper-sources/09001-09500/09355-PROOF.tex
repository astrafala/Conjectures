...
\title{The empirical recurrence for OEIS A301792, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A301792 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A301792 is ``Number of 3Xn 0..1 arrays with every element equal to 0 or 1 horizontally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
4, 13, 12, 17, 25, 38, 59, 93,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) -a(n-3) for n>5
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 26 2018 16:43:28, revision 4) the statement is
...
every one of the $36$ published indices, with no shift fitted: the number of columns is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A301792.
