...
\title{The empirical recurrence for OEIS A252263, proved by transfer matrix}
...
\begin{abstract}
OEIS A252263 counts $(n+2)\times4$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252263 is ``Number of (n+2) X (2+2) 0..3 arrays with every 3 X 3 subblock row, column, diagonal and antidiagonal sum not equal to 2 3 4 6 or 7.''. It has offset $1$ and begins
\[
130, 272, 822, 2290, 6164, 17008, 47094, 129530,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + 2*a(n-2) + 6*a(n-3) + 5*a(n-4) + a(n-5) - 2*a(n-6) - 2*a(n-7) - a(n-8) for n>9.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 03 2018 06:28:33, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252263.
