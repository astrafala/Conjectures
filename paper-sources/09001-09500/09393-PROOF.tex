...
\title{The empirical recurrence for OEIS A297452, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297452 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A297452 is ``Number of n X 3 0..1 arrays with every 1 horizontally, diagonally or antidiagonally adjacent to 0 or 2 neighboring 1s.''. It has offset $1$ and begins
\[
5, 25, 92, 390, 1652, 6888, 28971, 121854,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 5*a(n-1) - 3*a(n-2) + 4*a(n-3) - 25*a(n-4) + 10*a(n-5) - 7*a(n-6) + 12*a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 28 2019 17:41:07, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) - 3\,a(n-2) + 4\,a(n-3) - 25\,a(n-4) + 10\,a(n-5) - 7\,a(n-6) + 12\,a(n-7)
\end{equation}
for all $n>8$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297452.
