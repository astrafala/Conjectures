...
\title{The empirical recurrence for OEIS A252240, proved by transfer matrix}
...
\begin{abstract}
OEIS A252240 counts $(n+2)\times7$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
$a(n)$ is a walk count on $S=303062$ vertices. Such a sequence is $C$-finite, so whether a given
...
OEIS A252240 is ``Number of (n+2) X (5+2) 0..3 arrays with every 3 X 3 subblock row and column sum not equal to 1 3 4 6 or 7 and every 3 X 3 diagonal and antidiagonal sum equal to 1 3 4 6 or 7.''. It has offset $1$ and begins
\[
13376, 215424, 2908368, 11206944, 193004352, 2778727776, 10519316352, 185237247744,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 1804*a(n-3) -939040*a(n-6) +145285120*a(n-9) -1639972864*a(n-12) +4294967296*a(n-15) for n>16.
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 22 2023 14:46:02, revision 6) this is still
...
at once. By Lemma~\ref{lem:crit} the recurrence holds for every $n>16$.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252240.
