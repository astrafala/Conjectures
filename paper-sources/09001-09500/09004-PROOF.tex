...
\title{The empirical recurrence for OEIS A305043, proved by transfer matrix}
...
\begin{abstract}
OEIS A305043 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A305043 is ``Number of nX4 0..1 arrays with every element unequal to 0, 2, 3, 6 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 13, 9, 11, 20, 17, 25, 70,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) -2*a(n-2) +4*a(n-3) -12*a(n-4) +6*a(n-5) +2*a(n-6) +3*a(n-7) -3*a(n-9) for n>13
\end{quote}
As of the ``Last modified'' line on the live entry (May 24 2018 08:48:43, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) - 2\,a(n-2) + 4\,a(n-3) - 12\,a(n-4) + 6\,a(n-5) + 2\,a(n-6) + 3\,a(n-7) - 3\,a(n-9)
\end{equation}
for all $n>13$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A305043.
