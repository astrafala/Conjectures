...
\title{The empirical recurrence for OEIS A188517, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A188517 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A188517 is ``Number of nX3 binary arrays without the pattern 1 1 0 diagonally, vertically or horizontally.''. It has offset $1$ and begins
\[
7, 49, 229, 1016, 4143, 16438, 63575, 242843,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 13 2025 23:10:12, revision 15) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;7\,a(n-1) - 5\,a(n-2) - 54\,a(n-3) + 79\,a(n-4) + 173\,a(n-5) - 294\,a(n-6) - 313\,a(n-7) + 521\,a(n-8) + 357\,a(n-9) - 501\,a(n-10) - 255\,a(n-11) + 272\,a(n-12) + 106\,a(n-13) - 84\,a(n-14) - 23\,a(n-15) + 14\,a(n-16) + 2\,a(n-17) - a(n-18)
\end{equation}
for all $n>19$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A188517.
