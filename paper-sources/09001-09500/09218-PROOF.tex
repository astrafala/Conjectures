...
\title{The empirical recurrence for OEIS A251375, proved by transfer matrix}
...
\begin{abstract}
OEIS A251375 counts $3$-column arrays over $\{0,\dots,3\}$ in which every
...
OEIS A251375 is ``Number of (n+1)X(2+1) 0..3 arrays with every 2X2 subblock summing to 5 6 or 7.''. It has offset $1$
and begins
\[
1048, 19644, 385704, 7712232, 155378004, 3140670344, 63575161960, 1287767101980,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 10:24:08, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;33\,a(n-1) - 258\,a(n-2) - 425\,a(n-3) + 9681\,a(n-4) - 20982\,a(n-5) - 28396\,a(n-6) + 102584\,a(n-7) - 55200\,a(n-8) - 23420\,a(n-9) + 17424\,a(n-10) - 528\,a(n-11) - 576\,a(n-12)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251375.
