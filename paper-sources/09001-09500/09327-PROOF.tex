...
\title{The empirical recurrence for OEIS A258553, proved by transfer matrix}
...
\begin{abstract}
OEIS A258553 counts the arrays over $\{0,\dots,1\}$ whose $2\times2$ subblocks carry a
...
so a pair of consecutive array rows is a state, the count is a walk count on $S=2008$ of them,
...
OEIS A258553 is ``Number of (n+1) X (7+1) 0..1 arrays with every 2 X 2 subblock ne-sw antidiagonal difference nondecreasing horizontally and nw+se diagonal sum nondecreasing vertically.''. It has offset $1$ and begins
\[
2008, 894, 2542, 4313, 8612, 13833, 21653, 31254,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) - 6*a(n-2) + 4*a(n-3) - 4*a(n-5) + 6*a(n-6) - 4*a(n-7) + a(n-8) for n>15.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 22 2018 07:29:06, revision 8) this is still
...
\]
on the $S=2008$ admissible pairs. In particular $a$ is $C$-finite. The alignment of the walk
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A258553.
