...
\title{The empirical recurrence for OEIS A233492, proved by transfer matrix}
...
\begin{abstract}
OEIS A233492 counts arrays of width $5$ over $\{0,1,2\}$ containing no run of $3$ consecutive
...
OEIS A233492 is ``Number of (n+2) X (3+2) 0..2 arrays with no increasing sequence of length 3 horizontally or antidiagonally downwards.''. It has offset $1$ and begins
\[
8946936, 1709348346, 325881917874, 62127117326151, 11844001767009636, 2257956973020836034, 430460043429459971151, 82063498573383090200622,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 191*a(n-1) +134*a(n-2) -38637*a(n-3) +3177*a(n-4) +1502613*a(n-5) -3705102*a(n-6) +2380185*a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 17 2022 20:15:35, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;191\,a(n-1) + 134\,a(n-2) - 38637\,a(n-3) + 3177\,a(n-4) + 1502613\,a(n-5) - 3705102\,a(n-6) + 2380185\,a(n-7)
\]
for every $n>7$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A233492.
