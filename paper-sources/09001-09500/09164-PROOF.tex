...
\title{The empirical recurrence for OEIS A301794, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A301794 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A301794 is ``Number of 5Xn 0..1 arrays with every element equal to 0 or 1 horizontally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
16, 89, 48, 61, 82, 116, 171, 260,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) -a(n-3) for n>5
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 26 2018 16:44:53, revision 4) the statement is
...
publishes, $n=35$, the arrays have $5\cdot35$ cells over
$2$ values, so there are about $10^{52}$ of them to sift. The
...
every one of the $35$ published indices, with no shift fitted: the number of columns is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A301794.
