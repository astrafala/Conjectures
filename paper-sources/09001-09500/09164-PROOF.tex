...
\title{The empirical recurrence for OEIS A234876, proved by transfer matrix}
...
\begin{abstract}
OEIS A234876 counts $3$-column arrays over $\{0,\dots,4\}$ in which every
...
OEIS A234876 is ``Number of (n+1) X (2+1) 0..4 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 1, with no adjacent elements equal (constant-stress tilted 1 X 1 tilings).''. It has offset
$1$ and begins
\[
68, 148, 268, 628, 1188, 2944, 5684,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) + 10*a(n-2) - 21*a(n-3) - 29*a(n-4) + 68*a(n-5) + 22*a(n-6) - 73*a(n-7) + 22*a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 19 2022 01:16:44, revision 10) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 10\,a(n-2) - 21\,a(n-3) - 29\,a(n-4) + 68\,a(n-5) + 22\,a(n-6) - 73\,a(n-7) + 22\,a(n-9)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234876.
