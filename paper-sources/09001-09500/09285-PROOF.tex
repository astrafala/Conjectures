...
\title{The empirical recurrence for OEIS A264624, proved by transfer matrix}
...
\begin{abstract}
OEIS A264624 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=5$ rows in which
...
OEIS A264624 is ``Number of (n+1)X(4+1) arrays of permutations of 0..n*5+4 with each element having directed index change -2,0 -1,0 0,-1 or 1,1.''. It has offset $1$ and begins
\[
0, 9, 40, 108, 660, 4032, 19521, 89469,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 19 2015 06:52:14, revision 4) this is still
...
\[
(i-h_i,\,j-h_j)\;\in\;\{(-2,0),\ (-1,0),\ (0,-1),\ (1,1)\},
\]
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + 36\,a(n-3) + 108\,a(n-4) - 36\,a(n-5) - 351\,a(n-6) - 1863\,a(n-7) - 4698\,a(n-8) - 4050\,a(n-9) - 243\,a(n-10) + 729\,a(n-11)
\]
for every $n>12$.
\end{theorem}
...
until the working vector was identically zero, settling every larger $j$ at once. The bound is exact: at $n=12$ the recurrence fails on the entry's own published terms, so no larger range holds.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264624.
