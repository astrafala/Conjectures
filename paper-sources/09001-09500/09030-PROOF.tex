...
\title{The empirical recurrence for OEIS A206728, proved by transfer matrix}
...
\begin{abstract}
OEIS A206728 counts arrays of width $2$ over $\{0,1,2\}$ containing no occurrence of certain short
...
OEIS A206728 is ``Number of n X 2 0..2 arrays avoiding the pattern z-1 z-1 z in any row, column or nw-to-se diagonal.''. It has offset $1$ and begins
\[
9, 81, 625, 4761, 36100, 273529, 2073600, 15721225,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 14 2013 14:03:10, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;9\,a(n-1) - 6\,a(n-2) - 43\,a(n-3) + 34\,a(n-4) + 162\,a(n-5) - 133\,a(n-6) - 13\,a(n-7) + 62\,a(n-8) - 14\,a(n-9) - 15\,a(n-10) - 6\,a(n-11) + 8\,a(n-12) - a(n-13) - 2\,a(n-14) + a(n-15)
\]
for every $n>14$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206728.
