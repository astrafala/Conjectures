...
\title{The empirical recurrence for OEIS A260603, proved by transfer matrix}
...
\begin{abstract}
OEIS A260603 counts $(n+2)\times4$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A260603 is ``Number of (n+2)X(2+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000101 00010001 or 00010101.''. It has offset $1$ and begins
\[
58, 118, 250, 532, 1136, 2480, 5418, 11776,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 12:09:29, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 4\,a(n-3) + 3\,a(n-4) + 2\,a(n-6) + 2\,a(n-7) - 4\,a(n-8) + 3\,a(n-9) + 4\,a(n-10) - a(n-11) + a(n-12) + a(n-13)
\]
for every $n>14$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A260603.
