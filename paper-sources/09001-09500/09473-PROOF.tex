...
\title{The empirical recurrence for OEIS A205635, proved by transfer matrix}
...
\begin{abstract}
OEIS A205635 counts arrays of width $2$ over $\{0,1,2,3\}$ subject to a condition read round the
...
OEIS A205635 is ``Number of (n+1)X2 0..3 arrays with every 2 X 2 subblock having the number of clockwise edge increases equal to the number of counterclockwise edge increases in its adjacent leftward and upward neighbors.''. It has offset $1$ and begins
\[
256, 2320, 21416, 198688, 1843744, 17111320, 158804736, 1473828208,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 09 2015 04:28:48, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;16\,a(n-1) - 64\,a(n-2) - 46\,a(n-3) + 680\,a(n-4) - 1040\,a(n-5) - 73\,a(n-6) + 912\,a(n-7) - 228\,a(n-8) - 176\,a(n-9) + 20\,a(n-10)
\]
for every $n>10$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A205635.
