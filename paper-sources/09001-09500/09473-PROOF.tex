...
\title{The empirical recurrence for OEIS A255989, proved by transfer matrix}
...
\begin{abstract}
OEIS A255989 carries an empirical recurrence of order $6$ contributed by R.~H.~Hardin. It is
...
OEIS A255989 is ``Number of length n+5 0..1 arrays with at most one downstep in every 5 consecutive neighbor pairs.''. It has offset $1$ and begins
\[
42, 68, 114, 196, 337, 568, 945, 1574,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) -a(n-2) +4*a(n-5) -3*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 24 2018 14:03:26, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A255989.
