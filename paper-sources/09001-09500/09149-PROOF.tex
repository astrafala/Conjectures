...
\title{The empirical recurrence for OEIS A297297, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297297 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A297297 is ``Number of nX6 0..1 arrays with every 1 horizontally or antidiagonally adjacent to 2 neighboring 1s.''. It has offset $1$ and begins
\[
1, 6, 17, 50, 157, 495, 1574, 5031,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 4*a(n-1) -8*a(n-3) -2*a(n-4) +4*a(n-5) +4*a(n-6) +a(n-7) -a(n-8)
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 27 2017 21:12:01, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) - 8\,a(n-3) - 2\,a(n-4) + 4\,a(n-5) + 4\,a(n-6) + a(n-7) - a(n-8)
\end{equation}
for all $n>9$.
...
publishes, $n=26$, the arrays have $6\cdot26$ cells over
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297297.
