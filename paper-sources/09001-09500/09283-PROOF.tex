...
\title{The empirical recurrence for OEIS A206262, proved by transfer matrix}
...
\begin{abstract}
OEIS A206262 counts arrays over $\{0,\dots,1\}$ under a condition on the number of rightwards and downwards edge increases
...
OEIS A206262 is ``Number of (n+1) X 4 0..1 arrays with the number of rightwards and downwards edge increases in each 2 X 2 subblock equal to the number in all its horizontal and vertical neighbors.''. It has offset $1$ and begins
\[
34, 44, 78, 135, 218, 339, 503, 724,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) - 5*a(n-2) + 5*a(n-4) - 4*a(n-5) + a(n-6) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 15 2018 06:03:58, revision 9) this is still
...
subblocks; the entry's first term is $34$, which the model
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206262.
