...
\title{The empirical recurrence for OEIS A243516, proved by transfer matrix}
...
\begin{abstract}
OEIS A243516 carries an empirical recurrence of order $6$ contributed by R.~H.~Hardin. It is
true, and it is decidable rather than empirical. The entry's condition is local to a bounded window of consecutive lines, so
the admissible configurations of such a window are the vertices of a finite digraph and the
arrays counted are exactly the walks in it; hence $a(n)$ is a walk count on $S=165$ vertices
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 02 2018 12:26:30, revision 8) this is still
...
admissible array is then exactly a walk, so with $M$ the adjacency matrix on $S=165$ vertices
