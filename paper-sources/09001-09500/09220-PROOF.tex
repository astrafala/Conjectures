...
\title{The empirical recurrence for OEIS A231952, proved by transfer matrix}
...
\begin{abstract}
OEIS A231952 counts arrays of width $4$ over $\{0,\dots,1\}$ under a condition on each cell
...
OEIS A231952 is ``Number of (n+1)X(3+1) 0..1 arrays with every element equal to some horizontal, vertical, diagonal or antidiagonal neighbor, with top left element zero.''. It has offset $1$ and begins
\[
64, 1034, 14842, 220472, 3292876, 49124582, 732691918, 10928482748,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 06:45:03, revision 6) this is still
...
$64$, which the model reproduces along with every later term. That is the cheapest check
...
\begin{theorem}
\[
a(n)\;=\;14\,a(n-1) + 6\,a(n-2) + 103\,a(n-3) + 170\,a(n-4) - 39\,a(n-5) - 13\,a(n-6) - 99\,a(n-7) - 375\,a(n-8) - 29\,a(n-9) + 181\,a(n-10) + 18\,a(n-11) - 24\,a(n-12)
\]
for every $n>12$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231952.
