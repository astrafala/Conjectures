...
\title{The empirical recurrence for OEIS A300460, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A300460 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A300460 is ``Number of nX3 0..1 arrays with every element equal to 2, 3 or 4 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
0, 2, 2, 8, 22, 68, 212, 652,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 06 2018 11:25:46, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 2\,a(n-2) + 3\,a(n-3) + a(n-4) + 8\,a(n-5) + 4\,a(n-6) - 5\,a(n-7) - 11\,a(n-8) + 6\,a(n-9) - 2\,a(n-10) - 7\,a(n-11) - a(n-12) + 4\,a(n-13) - 4\,a(n-14) + a(n-15)
\end{equation}
for all $n>16$.
...
\#\{\text{neighbours with a value }equal to\ x_{t,u}\}\in\{2,3,4\}
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A300460.
