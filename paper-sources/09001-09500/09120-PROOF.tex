...
\title{The empirical recurrence for OEIS A238175, proved by transfer matrix}
...
\begin{abstract}
OEIS A238175 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
The condition is local to two consecutive rows, so the count is a walk count on $S=115$
...
OEIS A238175 is ``Number of (n+1)X(3+1) 0..2 arrays with the maximum plus the minimum of every 2X2 subblock equal.''. It has offset $1$ and begins
\[
2329, 69023, 2027833, 62220767, 1917124097, 59356544695, 1839517772097, 57041499462367,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 10:48:13, revision 6) this is still
...
array, which is not among the objects counted. There are $S=115$ states left.
...
\begin{theorem}
\[
a(n)\;=\;49\,a(n-1) - 545\,a(n-2) - 1988\,a(n-3) + 54954\,a(n-4) - 146726\,a(n-5) - 976002\,a(n-6) + 4971928\,a(n-7) - 1809493\,a(n-8) - 23027443\,a(n-9) + 29412787\,a(n-10) + 29650212\,a(n-11) - 62209316\,a(n-12) - 2721808\,a(n-13) + 42539968\,a(n-14) - 8853248\,a(n-15) - 8996864\,a(n-16) + 2113536\,a(n-17)
\]
for every $n>16$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A238175.
