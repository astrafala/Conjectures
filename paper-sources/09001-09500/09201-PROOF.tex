...
\title{The empirical recurrence for OEIS A234223, proved by transfer matrix}
...
\begin{abstract}
OEIS A234223 counts $5$-column arrays over $\{0,\dots,4\}$ in which every
...
OEIS A234223 is ``Number of (n+1) X (4+1) 0..4 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 3 (constant-stress 1 X 1 tilings).''. It has offset
$1$ and begins
\[
7696, 20724, 56936, 167688, 503272, 1597896, 5162984,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 19 2022 02:02:49, revision 6) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234223.
