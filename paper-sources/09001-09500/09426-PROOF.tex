...
\title{The empirical recurrence for OEIS A283693, proved by transfer matrix}
...
\begin{abstract}
OEIS A283693 counts $3\times n$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A283693 is ``Number of 3Xn 0..1 arrays with no 1 equal to more than two of its horizontal, diagonal and antidiagonal neighbors.''. It has offset $1$ and begins
\[
8, 57, 264, 1521, 8687, 47829, 268285, 1503392,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 14 2017 16:18:20, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) + 3\,a(n-2) + 15\,a(n-3) - 72\,a(n-4) - 21\,a(n-5) + 45\,a(n-6) + 96\,a(n-7) + 13\,a(n-8) - 115\,a(n-9) + 50\,a(n-10) - 14\,a(n-11)
\]
for every $n>11$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A283693.
