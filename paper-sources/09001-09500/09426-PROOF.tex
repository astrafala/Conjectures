...
\title{The empirical recurrence for OEIS A280602, proved by transfer matrix}
...
\begin{abstract}
OEIS A280602 counts $n\times6$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A280602 is ``Number of nX6 0..1 arrays with no element equal to more than two of its horizontal, vertical and antidiagonal neighbors and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
32, 383, 735, 1709, 3647, 7594, 15792, 33136,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 06 2017 11:30:18, revision 4) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A280602.
