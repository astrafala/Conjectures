...
\title{The empirical recurrence for OEIS A260287, proved by transfer matrix}
...
\begin{abstract}
OEIS A260287 counts $(n+2)\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A260287 is ``Number of (n+2) X (1+2) 0..1 arrays with each 3 X 3 subblock having clockwise perimeter pattern 00000001 00000011 or 00001001.''. It has offset $1$ and begins
\[
48, 104, 274, 560, 966, 2300, 4762, 8252,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-3) + 5*a(n-4) + 2*a(n-5) + 8*a(n-6) + 8*a(n-7) - 4*a(n-8) - 8*a(n-9) for n>10.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 29 2018 07:08:26, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-3) + 5\,a(n-4) + 2\,a(n-5) + 8\,a(n-6) + 8\,a(n-7) - 4\,a(n-8) - 8\,a(n-9)
\]
for every $n>10$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A260287.
