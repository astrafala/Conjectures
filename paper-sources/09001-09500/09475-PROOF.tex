...
\title{The empirical recurrence for OEIS A220590, proved by transfer matrix}
...
\begin{abstract}
OEIS A220590 counts the ways of linking the cells of a grid $2$ cells wide, each cell either to
...
OEIS A220590 is ``Number of ways to reciprocally link elements of an n X 2 array either to themselves or to exactly two king-move neighbors.''. It has offset $1$ and begins
\[
1, 8, 33, 155, 710, 3265, 15009, 68992,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) + 7*a(n-2) + 2*a(n-3) - 2*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 01 2018 05:52:15, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + 7\,a(n-2) + 2\,a(n-3) - 2\,a(n-4)
\]
for every $n>3$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A220590.
