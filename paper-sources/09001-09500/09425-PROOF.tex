...
\title{The empirical recurrence for OEIS A304218, proved by transfer matrix}
...
\begin{abstract}
OEIS A304218 counts $5$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A304218 is ``Number of nX5 0..1 arrays with every element unequal to 0, 1, 3 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
8, 31, 32, 62, 141, 279, 509, 996,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +3*a(n-3) +a(n-4) +a(n-6) -2*a(n-7) -a(n-10) for n>14
\end{quote}
As of the ``Last modified'' line on the live entry (May 08 2018 10:52:45, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A304218.
