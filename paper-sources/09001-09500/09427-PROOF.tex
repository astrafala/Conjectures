...
\title{The empirical recurrence for OEIS A253856, proved by transfer matrix}
...
\begin{abstract}
OEIS A253856 counts the arrays over $\{0,\dots,1\}$ whose $3\times3$ subblocks carry a
...
OEIS A253856 is ``Number of (n+2)X(1+2) 0..1 arrays with every 3X3 subblock diagonal maximum plus antidiagonal minimum nondecreasing horizontally and vertically.''. It has offset $1$ and begins
\[
512, 3264, 19456, 114880, 660480, 3727552, 20872192, 116568256,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 14:18:11, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-1) - 13\,a(n-2) - 8\,a(n-3) + 77\,a(n-4) - 392\,a(n-5) + 721\,a(n-6) - 504\,a(n-7) + 176\,a(n-8) + 384\,a(n-9) - 960\,a(n-10) + 512\,a(n-11)
\]
for every $n>11$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253856.
