...
\title{The empirical recurrence for OEIS A208372, proved by transfer matrix}
...
\begin{abstract}
OEIS A208372 counts arrays over $\{0,\dots,1\}$ of width $6$ that avoid the patterns
...
OEIS A208372 is ``Number of 6Xn 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 0 1 and 0 1 0 vertically.''. It has offset
$1$ and begins
\[
21, 441, 3633, 41433, 422541, 4503765, 47178453,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:47:59, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;86\,a(n-2) + 334\,a(n-3) - 459\,a(n-4) - 3348\,a(n-5) + 249\,a(n-6) + 13148\,a(n-7) + 1379\,a(n-8) - 25508\,a(n-9) + 377\,a(n-10) + 23840\,a(n-11) - 4337\,a(n-12) - 8632\,a(n-13) + 1927\,a(n-14) + 1170\,a(n-15) - 195\,a(n-16) - 50\,a(n-17)
\end{equation}
for all $n>17$. The entry's array has a fixed number of rows and a growing number of
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208372.
