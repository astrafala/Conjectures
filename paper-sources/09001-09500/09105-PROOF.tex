...
\title{The empirical recurrence for OEIS A260494, proved by transfer matrix}
...
\begin{abstract}
OEIS A260494 counts $(n+2)\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A260494 is ``Number of (n+2) X (1+2) 0..1 arrays with each 3 X 3 subblock having clockwise perimeter pattern 00000001 00000011 or 00001011.''. It has offset $1$ and begins
\[
48, 83, 218, 464, 722, 1600, 3446, 6277,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-3) + 4*a(n-4) + 4*a(n-5) + 4*a(n-6) + 4*a(n-7) + 3*a(n-8) + 2*a(n-9) + 3*a(n-10) + 2*a(n-11) + a(n-12) for n>14.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 29 2018 07:08:07, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-3) + 4\,a(n-4) + 4\,a(n-5) + 4\,a(n-6) + 4\,a(n-7) + 3\,a(n-8) + 2\,a(n-9) + 3\,a(n-10) + 2\,a(n-11) + a(n-12)
\]
for every $n>14$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A260494.
