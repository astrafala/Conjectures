...
\title{The empirical recurrence for OEIS A206989, proved by transfer matrix}
...
\begin{abstract}
OEIS A206989 counts arrays over $\{0,\dots,1\}$ of width $3$ that avoid the patterns
...
OEIS A206989 is ``Number of n X 3 0..1 arrays avoiding 0 0 0 horizontally and 1 1 1 vertically.''. It has offset
$1$ and begins
\[
7, 49, 174, 840, 3858, 17460, 80070,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) + 5*a(n-2) + 11*a(n-3) - 5*a(n-4) + a(n-5) - 3*a(n-6) + a(n-7) for n>9.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 17 2018 14:36:29, revision
11) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 5\,a(n-2) + 11\,a(n-3) - 5\,a(n-4) + a(n-5) - 3\,a(n-6) + a(n-7)
\end{equation}
for all $n>9$. 
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206989.
