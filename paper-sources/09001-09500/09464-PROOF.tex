...
\title{The empirical recurrence for OEIS A186161, proved by transfer matrix}
...
\begin{abstract}
OEIS A186161 counts $n\times2$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A186161 is ``1/4 the number of n X 2 0..3 arrays with every element equal to exactly one or two of its horizontal and vertical neighbors.''. It has offset $1$ and begins
\[
1, 7, 48, 321, 2175, 14748, 99933, 677283,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 5*a(n-1) + 11*a(n-2) + 9*a(n-3) - 9*a(n-4) - 27*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 17 2018 11:24:22, revision 8) this is still
...
$\tfrac1{4}\iota^{\!\top}M^{\,j}q(M)\tau$ for the corresponding walk index $j$, so the
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) + 11\,a(n-2) + 9\,a(n-3) - 9\,a(n-4) - 27\,a(n-5)
\]
for every $n>5$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A186161.
