...
\title{The empirical recurrence for OEIS A260202, proved by transfer matrix}
...
\begin{abstract}
OEIS A260202 counts $(n+2)\times5$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A260202 is ``Number of (n+2) X (3+2) 0..1 arrays with each 3 X 3 subblock having clockwise perimeter pattern 00000000 00000001 or 00010001.''. It has offset $1$ and begins
\[
106, 207, 685, 1857, 5291, 15715, 45181, 129853,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 28 2018 11:02:42, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 2\,a(n-2) + 9\,a(n-3) + 6\,a(n-4) - 3\,a(n-5) - 10\,a(n-6) - 17\,a(n-7) - 7\,a(n-8) + 12\,a(n-9) + 12\,a(n-10) - 6\,a(n-11)
\]
for every $n>12$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A260202.
