...
\title{The empirical recurrence for OEIS A220558, proved by transfer matrix}
...
\begin{abstract}
OEIS A220558 counts the ways of linking the cells of a grid $4$ cells wide, each cell either to
...
OEIS A220558 is ``Number of ways to reciprocally link elements of an n X 4 array either to themselves or to exactly one horizontal or antidiagonal neighbor.''. It has offset $1$ and begins
\[
5, 47, 430, 3966, 36640, 338581, 3128843, 28913910,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 11*a(n-1) - 17*a(n-2) + 7*a(n-3) - a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 31 2018 14:31:37, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;11\,a(n-1) - 17\,a(n-2) + 7\,a(n-3) - a(n-4)
\]
for every $n>4$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A220558.
