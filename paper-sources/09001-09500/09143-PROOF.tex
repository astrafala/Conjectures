...
\title{The empirical recurrence for OEIS A207936, proved by transfer matrix}
...
\begin{abstract}
OEIS A207936 counts arrays over $\{0,\dots,1\}$ of width $6$ that avoid the patterns
$(0,0,1), (1,0,0)$ along one axis and $(0,0,1), (1,1,0)$ along the other, and carries an empirical recurrence of
...
OEIS A207936 is ``Number of n X 6 0..1 arrays avoiding 0 0 1 and 1 0 0 horizontally and 0 0 1 and 1 1 0 vertically.''. It has offset
$1$ and begins
\[
22, 484, 2706, 9430, 25490, 58602, 120276,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 7*a(n-1) - 21*a(n-2) + 35*a(n-3) - 35*a(n-4) + 21*a(n-5) - 7*a(n-6) + a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 26 2018 09:13:35, revision
...
The remaining patterns $(0,0,1), (1,1,0)$ are forbidden along the other axis, so each of them
...
is none of $(0,0,1), (1,1,0)$. Let $P$ be the adjacency matrix.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207936.
