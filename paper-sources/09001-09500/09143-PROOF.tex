...
\title{The empirical recurrence for OEIS A236712, proved by transfer matrix}
...
\begin{abstract}
OEIS A236712 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
OEIS A236712 is ``Number of (n+1)X(1+1) 0..2 arrays colored with the maximum plus the lower median of every 2X2 subblock.''. It has offset $1$ and begins
\[
81, 398, 1940, 9608, 47952, 237952, 1181504, 5866176,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 09:28:26, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;30\,a(n-3) + 269\,a(n-4) + 514\,a(n-5) + 1680\,a(n-6) + 2568\,a(n-7) - 364\,a(n-8) + 264\,a(n-9) - 19856\,a(n-10) - 31072\,a(n-11) - 40512\,a(n-12) - 74112\,a(n-13) - 34048\,a(n-14) - 33280\,a(n-15) - 20480\,a(n-16)
\]
for every $n>16$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A236712.
