...
\title{The empirical recurrence for OEIS A203359, proved by transfer matrix}
...
\begin{abstract}
OEIS A203359 counts arrays of width $5$ over $\{0,1\}$ under local conditions relating each cell
...
OEIS A203359 is ``Number of nX5 binary arrays with every 1 immediately preceded by 0 to the left or above.''. It has offset $1$ and begins
\[
8, 182, 3042, 55517, 984703, 17631496, 314688054, 5622720187,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 8*a(n-1) +148*a(n-2) +471*a(n-3) +578*a(n-4) -25*a(n-5) -302*a(n-6) +171*a(n-7) +90*a(n-8)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 10:22:42, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-1) + 148\,a(n-2) + 471\,a(n-3) + 578\,a(n-4) - 25\,a(n-5) - 302\,a(n-6) + 171\,a(n-7) + 90\,a(n-8)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A203359.
