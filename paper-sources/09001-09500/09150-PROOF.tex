...
\title{The empirical recurrence for OEIS A252109, proved by transfer matrix}
...
\begin{abstract}
OEIS A252109 counts $(n+2)\times5$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252109 is ``Number of (n+2) X (3+2) 0..3 arrays with every 3 X 3 subblock row and column sum equal to 0 2 3 6 or 7 and every 3 X 3 diagonal and antidiagonal sum not equal to 0 2 3 6 or 7.''. It has offset $1$ and begins
\[
1568, 724, 554, 776, 1258, 1634, 2476, 3938,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 6*a(n-3) - 8*a(n-6) for n>11.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 01 2018 08:20:36, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252109.
