...
\title{The empirical recurrence for OEIS A207935, proved by transfer matrix}
...
\begin{abstract}
OEIS A207935 counts arrays over $\{0,\dots,1\}$ of width $5$ that avoid the patterns
...
OEIS A207935 is ``Number of n X 5 0..1 arrays avoiding 0 0 1 and 1 0 0 horizontally and 0 0 1 and 1 1 0 vertically.''. It has offset
$1$ and begins
\[
14, 196, 844, 2422, 5594, 11256, 20568,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 6*a(n-1) - 15*a(n-2) + 20*a(n-3) - 15*a(n-4) + 6*a(n-5) - a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 26 2018 06:25:12, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207935.
