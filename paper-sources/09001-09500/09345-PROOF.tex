...
\title{The empirical recurrence for OEIS A255104, proved by transfer matrix}
...
\begin{abstract}
OEIS A255104 carries an empirical recurrence of order $11$ contributed by R.~H.~Hardin. It is
...
OEIS A255104 is ``Number of length n+5 0..2 arrays with at most one downstep in every 5 consecutive neighbor pairs.''. It has offset $1$ and begins
\[
294, 597, 1302, 2951, 6582, 14001, 29147, 61542,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) -3*a(n-2) +a(n-3) +18*a(n-5) -29*a(n-6) +12*a(n-7) -6*a(n-10) +3*a(n-11).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 24 2018 14:25:42, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) - 3\,a(n-2) + a(n-3) + 18\,a(n-5) - 29\,a(n-6) + 12\,a(n-7) - 6\,a(n-10) + 3\,a(n-11)
\]
for every $n>16$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A255104.
