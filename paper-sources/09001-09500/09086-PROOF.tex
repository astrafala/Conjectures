...
\title{The empirical recurrence for OEIS A241610, proved by transfer matrix}
...
\begin{abstract}
OEIS A241610 carries an empirical recurrence of order $15$ contributed by R.~H.~Hardin. It is
...
OEIS A241610 is ``Number of length n+2 0..4 arrays with no consecutive three elements summing to more than 4.''. It has offset $1$ and begins
\[
35, 105, 315, 889, 2567, 7483, 21631, 62547,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 10:10:10, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + a(n-2) + 7\,a(n-3) - 4\,a(n-4) - 5\,a(n-5) - 12\,a(n-6) + 4\,a(n-7) + 3\,a(n-8) + 9\,a(n-9) - 3\,a(n-10) - a(n-11) - 3\,a(n-12) + a(n-13) + a(n-15)
\]
for every $n>17$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A241610.
