...
\title{The empirical recurrence for OEIS A252548, proved by transfer matrix}
...
\begin{abstract}
OEIS A252548 counts $7\times(n+2)$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
$a(n)$ is a walk count on $S=629986$ vertices. Such a sequence is $C$-finite, so whether a given
...
OEIS A252548 is ``Number of (5+2)X(n+2) 0..3 arrays with every 3X3 subblock row and diagonal sum equal to 1 3 4 6 or 7 and every 3X3 column and antidiagonal sum not equal to 1 3 4 6 or 7.''. It has offset $1$ and begins
\[
13104, 213120, 2576592, 11206944, 187695936, 2316305760, 10519316352, 177838495488,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 1804*a(n-3) -939040*a(n-6) +145285120*a(n-9) -1639972864*a(n-12) +4294967296*a(n-15)
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:20:54, revision 6) this is still
...
\[
\text{every row, diagonal sum} \in \{1,3,4,6,7\}\ \text{ and }\ \text{every column, antidiagonal sum} \notin \{1,3,4,6,7\}
\]
...
\begin{theorem}
\[
a(n)\;=\;1804\,a(n-3) - 939040\,a(n-6) + 145285120\,a(n-9) - 1639972864\,a(n-12) + 4294967296\,a(n-15)
\]
for every $n>15$.
\end{theorem}
...
exactly. Those integers vanish from the index corresponding to $n=15+1$ onwards, and the
run was continued until the working vector was identically zero, which settles all larger $j$
at once. By Lemma~\ref{lem:crit} the recurrence holds for every $n>15$.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252548.
