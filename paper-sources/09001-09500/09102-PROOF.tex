...
\title{The empirical recurrence for OEIS A237160, proved by transfer matrix}
...
\begin{abstract}
OEIS A237160 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
The condition is local to two consecutive rows, so the count is a walk count on $S=31$
...
OEIS A237160 is ``Number of (n+1) X (1+1) 0..2 arrays with the maximum plus the minimum minus the upper median minus the lower median of every 2 X 2 subblock equal.''. It has offset $1$ and begins
\[
81, 245, 777, 2597, 8961, 31837, 115561, 427093,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 7*a(n-1) + 2*a(n-2) - 92*a(n-3) + 80*a(n-4) + 376*a(n-5) - 360*a(n-6) - 600*a(n-7) + 400*a(n-8) + 320*a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 21 2018 17:10:45, revision 8) this is still
...
array, which is not among the objects counted. There are $S=31$ states left.
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-1) + 2\,a(n-2) - 92\,a(n-3) + 80\,a(n-4) + 376\,a(n-5) - 360\,a(n-6) - 600\,a(n-7) + 400\,a(n-8) + 320\,a(n-9)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237160.
