...
\title{The empirical recurrence for OEIS A302161, proved by transfer matrix}
...
\begin{abstract}
OEIS A302161 counts $6$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A302161 is ``Number of nX6 0..1 arrays with every element equal to 0, 1 or 3 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
13, 65, 34, 109, 296, 635, 1563, 3948,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 02 2018 14:47:58, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + a(n-2) + 8\,a(n-3) - 5\,a(n-5) - 17\,a(n-6) - 2\,a(n-7) + 6\,a(n-8) + 10\,a(n-9) + a(n-10) - a(n-11) + a(n-12) - a(n-14) - a(n-15)
\end{equation}
for all $n>26$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302161.
