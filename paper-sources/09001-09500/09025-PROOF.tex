...
\title{The empirical recurrence for OEIS A207025, proved by transfer matrix}
...
\begin{abstract}
OEIS A207025 counts arrays over $\{0,\dots,1\}$ of width $2$ that avoid the patterns
...
OEIS A207025 is ``Number of 2 X n 0..1 arrays avoiding 0 0 0 and 0 1 1 horizontally and 0 0 1 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
4, 16, 36, 81, 169, 324, 625,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) + a(n-2) - a(n-3) - 4*a(n-4) + 2*a(n-5) + a(n-7) + a(n-9) - a(n-10).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 17 2018 15:59:23, revision
10) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + a(n-2) - a(n-3) - 4\,a(n-4) + 2\,a(n-5) + a(n-7) + a(n-9) - a(n-10)
\end{equation}
for all $n>10$. The entry's array has a fixed number of rows and a growing number of
...
compared against the entry's DATA at every one of the $31$ published indices; the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207025.
