...
\title{The empirical recurrence for OEIS A210385, proved by transfer matrix}
...
\begin{abstract}
OEIS A210385 counts $(n+1)\times4$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A210385 is ``Number of (n+1)X4 0..2 arrays with every 2X2 subblock having one, two or three distinct clockwise edge differences.''. It has offset $1$ and begins
\[
4881, 300653, 18515113, 1140445889, 70247824293, 4327063104645, 266534819947777, 16417791900623325,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 15:57:14, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;77\,a(n-1) - 947\,a(n-2) - 762\,a(n-3) + 40729\,a(n-4) - 22510\,a(n-5) - 553105\,a(n-6) + 407431\,a(n-7) + 2820807\,a(n-8) - 2312735\,a(n-9) - 5149392\,a(n-10) + 4029906\,a(n-11) + 3132370\,a(n-12) - 2109672\,a(n-13) - 422196\,a(n-14) + 359552\,a(n-15) - 43456\,a(n-16)
\end{equation}
for all $n>15$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A210385.
