...
\title{The empirical recurrence for OEIS A302317, proved by transfer matrix}
...
\begin{abstract}
OEIS A302317 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the six horizontal, diagonal and antidiagonal neighbours, a number $equal to$ itself lying in $\{0,1,2,4\}$, and it carries an empirical
...
OEIS A302317 is ``Number of nX3 0..1 arrays with every element equal to 0, 1, 2 or 4 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
4, 20, 65, 281, 1144, 4321, 18093, 72746,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 05 2018 09:49:14, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 3\,a(n-2) + 30\,a(n-3) - 88\,a(n-4) - 36\,a(n-5) - 60\,a(n-6) - 116\,a(n-7) + 4\,a(n-8) - 16\,a(n-9) + 20\,a(n-10) + 40\,a(n-11) + 64\,a(n-12) + 16\,a(n-13) - 32\,a(n-14)
\end{equation}
for all $n>14$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302317.
