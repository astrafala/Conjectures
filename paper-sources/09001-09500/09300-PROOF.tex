...
\title{The empirical recurrence for OEIS A220561, proved by transfer matrix}
...
\begin{abstract}
OEIS A220561 counts the ways of linking the cells of a grid $7$ cells wide, each cell either to
...
OEIS A220561 is ``Number of ways to reciprocally link elements of an nX7 array either to themselves or to exactly one horizontal or antidiagonal neighbor.''. It has offset $1$ and begins
\[
21, 1544, 101052, 6743873, 449429440, 29955561052, 1996515036228, 133064181801048,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 85*a(n-1) -1330*a(n-2) +7350*a(n-3) -15316*a(n-4) +12720*a(n-5) -3168*a(n-6) for n>9
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 18:50:38, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;85\,a(n-1) - 1330\,a(n-2) + 7350\,a(n-3) - 15316\,a(n-4) + 12720\,a(n-5) - 3168\,a(n-6)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A220561.
