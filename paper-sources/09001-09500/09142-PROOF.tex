...
\title{The empirical recurrence for OEIS A299597, proved by transfer matrix}
...
\begin{abstract}
OEIS A299597 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A299597 is ``Number of nX3 0..1 arrays with every element equal to 2, 3, 4, 5, 7 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
0, 3, 9, 27, 147, 643, 3051, 14539,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 14 2018 07:00:53, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) + 6\,a(n-2) - 31\,a(n-3) - 35\,a(n-4) + 102\,a(n-5) + 81\,a(n-6) - 227\,a(n-7) - 101\,a(n-8) + 221\,a(n-9) + 74\,a(n-10) - 34\,a(n-11) - 2\,a(n-12) - 8\,a(n-13)
\end{equation}
for all $n>15$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A299597.
