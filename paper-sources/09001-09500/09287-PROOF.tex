...
\title{The empirical recurrence for OEIS A236048, proved by transfer matrix}
...
\begin{abstract}
OEIS A236048 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
OEIS A236048 is ``Number of (n+1) X (1+1) 0..2 arrays colored with the difference of the maximum and minimum in each 2 X 2 subblock.''. It has offset $1$ and begins
\[
81, 292, 1112, 3760, 13716, 46828, 169500, 582300,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 9*a(n-2) + 4*a(n-3) + 24*a(n-4) + 12*a(n-5) + 8*a(n-6) for n > 8.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 22 2026 08:57:27, revision 13) this is still
...
\begin{theorem}
\[
a(n)\;=\;9\,a(n-2) + 4\,a(n-3) + 24\,a(n-4) + 12\,a(n-5) + 8\,a(n-6)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A236048.
