...
\title{The empirical recurrence for OEIS A253462, proved by transfer matrix}
...
\begin{abstract}
OEIS A253462 counts arrays of width $2$ over $\{0,1,2\}$ in which the largest entry on the main diagonal minus the smallest on the antidiagonal of every $2\times2$ subblock differs from the same number at the neighbouring subblock. The entry carries an
...
OEIS A253462 is ``Number of (n+1) X (1+1) 0..2 arrays with every 2 X 2 subblock diagonal maximum minus antidiagonal minimum unequal to its neighbors horizontally, vertically, diagonally and antidiagonally.''. It has offset $1$ and begins
\[
81, 540, 3640, 24208, 162016, 1081504, 7227096, 48272160,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + 27*a(n-2) + 30*a(n-3) - 7*a(n-4) - 8*a(n-5) - 75*a(n-6) - 48*a(n-7) - 16*a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 14 2018 06:29:41, revision 10) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253462.
