...
\title{The empirical recurrence for OEIS A252195, proved by transfer matrix}
...
\begin{abstract}
OEIS A252195 counts $(n+2)\times4$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252195 is ``Number of (n+2)X(2+2) 0..3 arrays with every 3X3 subblock row, column, diagonal and antidiagonal sum not equal to 0 3 5 6 or 7.''. It has offset $1$ and begins
\[
585, 470, 669, 1313, 3201, 8526, 23265, 63626,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 10:54:57, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + a(n-2) + 7\,a(n-3) + 7\,a(n-4) + 7\,a(n-5) + 4\,a(n-6) - 2\,a(n-7) - 4\,a(n-8) - 9\,a(n-9) - 8\,a(n-10) - 7\,a(n-11) - 3\,a(n-12) + a(n-13) + 3\,a(n-14) + 2\,a(n-15) + a(n-16)
\]
for every $n>21$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252195.
