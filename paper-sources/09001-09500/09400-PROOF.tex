...
\title{The empirical recurrence for OEIS A228750, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A228750 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A228750 is ``Number of n X 4 binary arrays with top left element equal to 1 and no two ones adjacent horizontally or antidiagonally.''. It has offset $1$ and begins
\[
3, 20, 126, 780, 4808, 29608, 182288, 1122240,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 8*a(n-1) - 12*a(n-2) + 4*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 12 2018 15:08:35, revision 10) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;8\,a(n-1) - 12\,a(n-2) + 4\,a(n-3)
\end{equation}
for all $n>3$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A228750.
