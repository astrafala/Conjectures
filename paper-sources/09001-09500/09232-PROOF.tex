...
\title{The empirical recurrence for OEIS A206409, proved by transfer matrix}
...
\begin{abstract}
OEIS A206409 counts arrays over $\{0,\dots,2\}$ under a condition on the perimeter cycle of
every $2\times3$ and $3\times2$ subblock, and carries an empirical recurrence of order $16$ contributed by
R.~H.~Hardin. It is true, and it is decidable rather than empirical. The condition is local to
a bounded window of consecutive rows, so the count is a walk count on $S=2457$ states and is
...
OEIS A206409 is ``Number of (n+1) X 4 0..2 arrays with every 2 X 3 or 3 X 2 subblock having an equal number of clockwise and counterclockwise edge increases.''. It has offset $1$ and begins
\[
2457, 69585, 2073999, 62351943, 1876995285, 56515649709, 1701726564411, 51240524315871,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 13 2015 01:14:42, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;47\,a(n-1) - 608\,a(n-2) + 3198\,a(n-3) - 5911\,a(n-4) - 7789\,a(n-5) + 44215\,a(n-6) - 38455\,a(n-7) - 50916\,a(n-8) + 86298\,a(n-9) + 5407\,a(n-10) - 54221\,a(n-11) + 10208\,a(n-12) + 11424\,a(n-13) - 2506\,a(n-14) - 502\,a(n-15) + 112\,a(n-16)
\]
for every $n>16$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206409.
