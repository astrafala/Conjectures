...
\title{The empirical recurrence for OEIS A300337, proved by transfer matrix}
...
\begin{abstract}
OEIS A300337 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A300337 is ``Number of nX3 0..1 arrays with every element equal to 0, 2, 3, 4, 5, 6, 7 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 13, 47, 255, 1272, 6780, 36498, 198531,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 03 2018 08:15:19, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) + 6\,a(n-2) - 40\,a(n-3) - 59\,a(n-4) + 79\,a(n-5) + 97\,a(n-6) - 40\,a(n-7) + 20\,a(n-8) + 8\,a(n-9) - 44\,a(n-10) - 6\,a(n-11)
\end{equation}
for all $n>13$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A300337.
