...
\title{The empirical recurrence for OEIS A209730, proved by transfer matrix}
...
\begin{abstract}
OEIS A209730 counts $(n+1)\times3$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A209730 is ``1/4 the number of (n+1)X3 0..3 arrays with every 2X2 subblock having distinct edge sums.''. It has offset $1$ and begins
\[
124, 1096, 9712, 86744, 775096, 6933120, 62007896, 554698328,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 15:26:51, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;11\,a(n-1) + 13\,a(n-2) - 364\,a(n-3) + 519\,a(n-4) + 2741\,a(n-5) - 6099\,a(n-6) - 4620\,a(n-7) + 15632\,a(n-8) - 1696\,a(n-9) - 8896\,a(n-10) + 3328\,a(n-11)
\end{equation}
for all $n>11$.
...
\#\{\alpha+\beta,\ \beta+\delta,\ \delta+\gamma,\ \gamma+\alpha\}=4,
\end{equation}
...
\[
a(n)-\sum_i c_i\,a(n-i)\;=\;\tfrac1{4}\mathbf{1}^{\!\top}M^{\,n+1-1-11}\,q(M)\,\mathbf{1} .
\]
...
=\tfrac1{4}\mathbf{1}^{\!\top}M^{\,m-11}\,q(M)\,\mathbf{1}
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209730.
