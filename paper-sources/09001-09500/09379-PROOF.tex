...
\title{The empirical recurrence for OEIS A234705, proved by transfer matrix}
...
\begin{abstract}
OEIS A234705 counts $2$-column arrays over $\{0,\dots,7\}$ in which every
...
OEIS A234705 is ``Number of (n+1) X (1+1) 0..7 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 6 (constant-stress 1 X 1 tilings).''. It has offset
$1$ and begins
\[
322, 1730, 8738, 47306, 239890, 1308890, 6664130,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 5*a(n-1) + 84*a(n-2) - 420*a(n-3) - 2336*a(n-4) + 11680*a(n-5) + 21504*a(n-6) - 107520*a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 19 2022 01:10:35, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) + 84\,a(n-2) - 420\,a(n-3) - 2336\,a(n-4) + 11680\,a(n-5) + 21504\,a(n-6) - 107520\,a(n-7)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234705.
