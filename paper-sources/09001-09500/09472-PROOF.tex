...
\title{The empirical recurrence for OEIS A301966, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A301966 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A301966 is ``Number of 4Xn 0..1 arrays with every element equal to 0, 1 or 4 horizontally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
8, 34, 40, 64, 111, 219, 443, 904,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) +a(n-3) -a(n-4) -2*a(n-6) +a(n-7) for n>9
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 29 2018 13:03:31, revision 4) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A301966.
