...
\title{The empirical recurrence for OEIS A205980, proved by transfer matrix}
...
\begin{abstract}
OEIS A205980 counts arrays over $\{0,\dots,2\}$ under a condition on the perimeter cycle of
every $2\times3$ and $3\times2$ subblock, and carries an empirical recurrence of order $7$ contributed by
...
OEIS A205980 is ``Number of (n+1) X 3 0..2 arrays with every 2 X 3 or 3 X 2 subblock having exactly two clockwise edge increases.''. It has offset $1$ and begins
\[
423, 1980, 8004, 33504, 140802, 591336, 2482596, 10425528,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + 7*a(n-2) + 26*a(n-3) + 5*a(n-4) - 12*a(n-6) - 4*a(n-7) for n>9.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 13 2018 05:47:05, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 7\,a(n-2) + 26\,a(n-3) + 5\,a(n-4) - 12\,a(n-6) - 4\,a(n-7)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A205980.
