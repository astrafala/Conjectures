...
\title{The empirical recurrence for OEIS A297397, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297397 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A297397 is ``Number of 4 X n 0..1 arrays with every 1 horizontally, diagonally or antidiagonally adjacent to 1 neighboring 1.''. It has offset $1$ and begins
\[
1, 20, 57, 126, 700, 2569, 7779, 31081,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) + 3*a(n-2) + 24*a(n-3) + 11*a(n-4) - 21*a(n-5) - 67*a(n-6) - 9*a(n-7) - 45*a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 28 2019 06:22:30, revision 7) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 3\,a(n-2) + 24\,a(n-3) + 11\,a(n-4) - 21\,a(n-5) - 67\,a(n-6) - 9\,a(n-7) - 45\,a(n-8)
\end{equation}
for all $n>9$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297397.
