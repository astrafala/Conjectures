...
\title{The empirical recurrence for OEIS A202527, proved by transfer matrix}
...
\begin{abstract}
OEIS A202527 counts arrays of width $5$ over $\{0,1\}$ containing no occurrence of certain short
...
OEIS A202527 is ``Number of (n+2) X 5 binary arrays avoiding patterns 000 and 101 in rows, columns and nw-to-se diagonals.''. It has offset $1$ and begins
\[
417, 1084, 2263, 4669, 10240, 22118, 47098, 101249,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) +2*a(n-3) -2*a(n-4) -2*a(n-5) +a(n-7) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 01 2018 06:17:01, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A202527.
