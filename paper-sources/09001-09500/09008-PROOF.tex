...
\title{The empirical recurrence for OEIS A237245, proved by transfer matrix}
...
\begin{abstract}
OEIS A237245 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
The condition is local to two consecutive rows, so the count is a walk count on $S=6496$
...
OEIS A237245 is ``Number of (n+1) X (4+1) 0..2 arrays with the maximum plus the upper median minus the lower median minus the minimum of every 2 X 2 subblock differing from its horizontal and vertical neighbors by exactly one.''. It has offset $1$ and begins
\[
6496, 78420, 974864, 12987512, 163330432, 2059810392, 26060799904, 355097523776,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 80692*a(n-4) -2102571080*a(n-8) +17424111539232*a(n-12) -28895609836800*a(n-16) for n>20.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 17 2022 22:06:16, revision 6) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The $2\times2$ subblocks of an $(n+1)\times5$ array form an
$n\times4$ grid, and each carries the value $\sigma=-a-b+c+d$, where $a\le b\le c\le d$ are its four entries sorted --- its minimum, lower median, upper median and maximum. The entry asks that the values of
...
differ by $1$. The entry's first term $6496$ counts those, and the model was made to
...
\]
over the $S=6496$ pairs whose own subblock row already satisfies the condition along itself.
...
\begin{theorem}
\[
a(n)\;=\;80692\,a(n-4) - 2102571080\,a(n-8) + 17424111539232\,a(n-12) - 28895609836800\,a(n-16)
\]
for every $n>20$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237245.
