...
\title{The empirical recurrence for OEIS A317763, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A317763 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A317763 is ``Number of nX7 0..1 arrays with every element unequal to 0, 1 or 2 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
64, 190, 196, 232, 302, 425, 639, 1012,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) -2*a(n-2) -a(n-4) +a(n-5) -a(n-6) +a(n-7) for n>11
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 06 2018 11:51:31, revision 4) the statement is
...
publishes, $n=31$, the arrays have $7\cdot31$ cells over
$2$ values, so there are about $10^{65}$ of them to sift. The
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A317763.
