...
\title{The empirical recurrence for OEIS A237009, proved by transfer matrix}
...
\begin{abstract}
OEIS A237009 counts arrays over $\{0,\dots,3\}$ subject to a condition on the order
...
The condition is local to two consecutive rows, so the count is a walk count on $S=368$
...
OEIS A237009 is ``Number of (n+1)X(2+1) 0..3 arrays with the sum of all four elements of every 2X2 subblock equal.''. It has offset $1$ and begins
\[
704, 1632, 3928, 10776, 30248, 92328, 286168, 938568,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 09:45:31, revision 6) this is still
...
array, which is not among the objects counted. There are $S=368$ states left.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237009.
