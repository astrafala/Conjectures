...
\title{The empirical recurrence for OEIS A231338, proved by transfer matrix}
...
\begin{abstract}
OEIS A231338 counts $(n+1)\times3$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A231338 is ``Number of (n+1) X (2+1) 0..3 arrays with no element unequal to a strict majority of its horizontal and vertical neighbors, with values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
4, 9, 22, 59, 159, 439, 1236, 3527,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 5*a(n-1) - 6*a(n-2) + 2*a(n-3) - 8*a(n-4) + 6*a(n-5) - a(n-6) + 3*a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 28 2018 15:19:09, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) - 6\,a(n-2) + 2\,a(n-3) - 8\,a(n-4) + 6\,a(n-5) - a(n-6) + 3\,a(n-7)
\]
for every $n>6$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231338.
