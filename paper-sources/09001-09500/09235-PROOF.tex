...
\title{The empirical recurrence for OEIS A208111, proved by transfer matrix}
...
\begin{abstract}
OEIS A208111 counts arrays over $\{0,\dots,1\}$ of width $6$ that avoid the patterns
...
OEIS A208111 is ``Number of 6 X n 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 1 1 and 1 1 0 vertically.''. It has offset
$1$ and begins
\[
22, 484, 990, 2025, 22995, 261121, 768544,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) + 21*a(n-3) + 438*a(n-4) - 456*a(n-5) - 399*a(n-6) - 7220*a(n-8) + 6859*a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 28 2018 08:42:14, revision
8) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 21\,a(n-3) + 438\,a(n-4) - 456\,a(n-5) - 399\,a(n-6) - 7220\,a(n-8) + 6859\,a(n-9)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208111.
