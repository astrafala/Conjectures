...
\title{The empirical recurrence for OEIS A190025, proved by transfer matrix}
...
\begin{abstract}
OEIS A190025 counts the $(n+2)\times3$ arrays over $\{0,\dots,1\}$ in which
...
OEIS A190025 is ``Number of (n+2) X 3 binary arrays with every 3 X 3 subblock commuting with each horizontal and vertical neighbor 3 X 3 subblock.''. It has offset $1$ and begins
\[
512, 112, 228, 415, 616, 880, 1205, 1508,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) -a(n-2) +a(n-3) -2*a(n-4) +a(n-5) +a(n-6) -a(n-7) for n>11.
\end{quote}
As of the ``Last modified'' line on the live entry (May 03 2018 07:02:48, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A190025.
