...
\title{The empirical recurrence for OEIS A238908, proved by transfer matrix}
...
\begin{abstract}
OEIS A238908 counts $(n+1)\times4$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A238908 is ``Number of (n+1) X (3+1) 0..2 arrays with no element equal to all horizontal neighbors or equal to all vertical neighbors, and new values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
54, 486, 17496, 408726, 10789686, 274834944, 7073353350, 181499433750,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 22*a(n-1) + 120*a(n-2) - 678*a(n-3) + 522*a(n-4) + 432*a(n-5) - 81*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 24 2018 10:10:48, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;22\,a(n-1) + 120\,a(n-2) - 678\,a(n-3) + 522\,a(n-4) + 432\,a(n-5) - 81\,a(n-6)
\]
for every $n>6$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A238908.
