...
\title{The empirical recurrence for OEIS A183324, proved by transfer matrix}
...
\begin{abstract}
OEIS A183324 counts arrays of width $3$ over $\{0,1\}$ under local conditions relating each cell
...
OEIS A183324 is ``Number of nX3 binary arrays with each 1 adjacent to exactly two other 1s.''. It has offset $1$ and begins
\[
1, 3, 6, 10, 19, 37, 69, 129,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n)=2*a(n-1)-a(n-2)+2*a(n-3)-a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 01:34:19, revision 12) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A183324.
