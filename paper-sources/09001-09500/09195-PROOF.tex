...
\title{The empirical recurrence for OEIS A223425, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A223425 counts arrays over $\{0,\dots,14\}$ in which every cell is constrained by the
...
$15$ values, so there are about $10^{29}$ of them to sift. The
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223425.
