...
\title{The empirical recurrence for OEIS A234136, proved by transfer matrix}
...
\begin{abstract}
OEIS A234136 counts $(n+1)\times5$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A234136 is ``Number of (n+1) X (4+1) 0..3 arrays with every 2 X 2 subblock having the sum of the absolute values of all six edge and diagonal differences equal to 9.''. It has offset $1$ and begins
\[
512, 680, 968, 1640, 2984, 6440, 14120, 35624,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) + 8*a(n-2) - 30*a(n-3) + 4*a(n-4) + 48*a(n-5) - 32*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 13 2018 11:53:20, revision 11) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234136.
