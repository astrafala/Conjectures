...
\title{The empirical recurrence for OEIS A209722, proved by transfer matrix}
...
\begin{abstract}
OEIS A209722 counts $(n+1)\times4$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A209722 is ``1/4 the number of (n+1) X 4 0..2 arrays with every 2 X 2 subblock having distinct clockwise edge differences.''. It has offset $1$ and begins
\[
4, 5, 6, 8, 10, 14, 18, 26,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) + 2*a(n-2) - 2*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 15 2022 11:31:00, revision 14) the statement is
...
every one of the $42$ published indices; the values agree exactly. That is what ties
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209722.
