...
\title{The empirical recurrence for OEIS A252274, proved by transfer matrix}
...
\begin{abstract}
OEIS A252274 counts $(n+2)\times6$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
$a(n)$ is a walk count on $S=91605$ vertices. Such a sequence is $C$-finite, so whether a given
...
OEIS A252274 is ``Number of (n+2)X(4+2) 0..3 arrays with every 3X3 subblock row and column sum not equal to 2 3 4 6 or 7 and every 3X3 diagonal and antidiagonal sum equal to 2 3 4 6 or 7.''. It has offset $1$ and begins
\[
322, 948, 2513, 4895, 15739, 43488, 85808, 276544,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 21*a(n-3) -62*a(n-6) +47*a(n-9) -5*a(n-12) for n>15
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:00:23, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252274.
