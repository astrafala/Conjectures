...
\title{The empirical recurrence for OEIS A305637, proved by transfer matrix}
...
\begin{abstract}
OEIS A305637 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A305637 is ``Number of n X 3 0..1 arrays with every element unequal to 0, 1, 2, 4, 5 or 6 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
4, 14, 29, 78, 255, 743, 2197, 6663,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 18 2022 18:17:08, revision
6) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 3\,a(n-2) + 9\,a(n-3) - 11\,a(n-4) - 37\,a(n-5) - 56\,a(n-6) + 14\,a(n-7) + 135\,a(n-8) + 177\,a(n-9) + 40\,a(n-10) - 179\,a(n-11) - 188\,a(n-12) - 61\,a(n-13) + 34\,a(n-14) + 3\,a(n-15)
\end{equation}
for all $n>17$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A305637.
