...
\title{The empirical recurrence for OEIS A298577, proved by transfer matrix}
...
\begin{abstract}
OEIS A298577 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A298577 is ``Number of nX3 0..1 arrays with every element equal to 1, 2, 4, 5 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 7, 15, 25, 47, 113, 261, 601,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 22 2018 06:25:51, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) - a(n-3) - 7\,a(n-4) + 2\,a(n-5) - 2\,a(n-6) + 4\,a(n-7) - 3\,a(n-8) + 13\,a(n-9) + 8\,a(n-10) - 5\,a(n-11) - 15\,a(n-12) + 4\,a(n-14)
\end{equation}
for all $n>15$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A298577.
