...
\title{The empirical recurrence for OEIS A250894, proved by transfer matrix}
...
\begin{abstract}
OEIS A250894 carries an empirical recurrence of order $7$ contributed by R.~H.~Hardin. It is
...
OEIS A250894 is ``Number of (n+1) X (4+1) 0..2 arrays with nondecreasing x(i,j)-x(i,j-1) in the i direction and nondecreasing absolute value of x(i,j)-x(i-1,j) in the j direction.''. It has offset $1$ and begins
\[
1229, 3867, 12387, 39003, 119359, 357335, 1052787, 3069907,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 12*a(n-1) - 60*a(n-2) + 162*a(n-3) - 255*a(n-4) + 234*a(n-5) - 116*a(n-6) + 24*a(n-7) for n>9.
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 23 2018 03:17:54, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250894.
