...
\title{The empirical recurrence for OEIS A260279, proved by transfer matrix}
...
\begin{abstract}
OEIS A260279 counts $(n+2)\times5$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A260279 is ``Number of (n+2)X(3+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000000 00000001 or 00001011.''. It has offset $1$ and begins
\[
99, 230, 747, 2027, 5420, 15306, 42175, 114513,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 12:04:26, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;14\,a(n-3) + 17\,a(n-4) + 20\,a(n-5) - 19\,a(n-6) - 46\,a(n-7) - 49\,a(n-8) + 2\,a(n-9) + 27\,a(n-10) + 34\,a(n-11) + 9\,a(n-12) - 4\,a(n-13) - 4\,a(n-14)
\]
for every $n>19$.
\end{theorem}
...
exactly. Those integers vanish from the index corresponding to $n=19+1$ onwards, and the
run was continued until the working vector was identically zero, which settles all larger $j$
at once. By Lemma~\ref{lem:crit} the recurrence holds for every $n>19$. The bound is exact: at $n=19$ the recurrence fails on the entry's own published terms, so no larger range holds.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A260279.
