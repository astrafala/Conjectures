...
\title{The empirical recurrence for OEIS A283517, proved by transfer matrix}
...
\begin{abstract}
OEIS A283517 counts $n\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A283517 is ``Number of nX3 0..1 arrays with no 1 equal to more than three of its horizontal, vertical and antidiagonal neighbors, with the exception of exactly two elements.''. It has offset $1$ and begins
\[
0, 1, 20, 270, 2763, 26662, 241796, 2115564,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 09 2017 18:24:44, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;15\,a(n-1) - 36\,a(n-2) - 235\,a(n-3) + 171\,a(n-4) + 2481\,a(n-5) + 5734\,a(n-6) + 6894\,a(n-7) + 5364\,a(n-8) + 3397\,a(n-9) + 1947\,a(n-10) + 846\,a(n-11) + 277\,a(n-12) + 126\,a(n-13) + 12\,a(n-14) + 8\,a(n-15)
\]
for every $n>19$.
\end{theorem}
...
integers vanish from the index corresponding to $n=19+1$ onwards, and the run was
continued until the working vector was identically zero, which settles all larger $j$ at once.
By Lemma~\ref{lem:crit} the recurrence holds for every $n>19$. The bound is exact: at $n=19$ the recurrence fails on the entry's own published terms, so no larger range holds.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A283517.
