...
\title{The empirical recurrence for OEIS A297684, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297684 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
values of its neighbours, and carries an empirical recurrence of order $17$ contributed
...
OEIS A297684 is ``Number of 4Xn 0..1 arrays with every 1 horizontally, diagonally or antidiagonally adjacent to 0, 1 or 4 neighboring 1s.''. It has offset $1$ and begins
\[
16, 98, 742, 4633, 32911, 221420, 1519630, 10322924,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 03 2018 09:31:13, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 20\,a(n-2) + 60\,a(n-3) + 184\,a(n-4) + 57\,a(n-5) - 73\,a(n-6) - 458\,a(n-7) + 105\,a(n-8) + 215\,a(n-9) + 380\,a(n-10) - 574\,a(n-11) - 435\,a(n-12) + 162\,a(n-13) - 270\,a(n-14) - 87\,a(n-15) + 32\,a(n-16) + 8\,a(n-17)
\end{equation}
for all $n>18$.
...
$o=1n_0+0-2$. Then for $j\ge17$,
\[
a(n_0+j)-\sum_i c_i\,a(n_0+j-i)\;=\;\,\mathbf{v}^{\!\top}G^{\,j-17}w,
...
\begin{proof}
Substitute Lemma~\ref{lem:walk} and factor $G^{j-17}$ out of
...
the middle column. The vector $w$ was formed by $17$ applications of $G$ in exact integer
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297684.
