...
\title{The empirical recurrence for OEIS A207956, proved by transfer matrix}
...
\begin{abstract}
OEIS A207956 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
...
OEIS A207956 is ``Number of nX4 0..1 arrays avoiding 0 0 0 and 1 0 1 horizontally and 0 0 1 and 1 0 0 vertically.''. It has offset
$1$ and begins
\[
9, 81, 281, 989, 3923, 15921, 67007,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:31:24, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;7\,a(n-1) + 2\,a(n-2) - 87\,a(n-3) + 48\,a(n-4) + 445\,a(n-5) - 280\,a(n-6) - 1175\,a(n-7) + 613\,a(n-8) + 1664\,a(n-9) - 614\,a(n-10) - 1206\,a(n-11) + 264\,a(n-12) + 392\,a(n-13) - 32\,a(n-14) - 40\,a(n-15)
\end{equation}
for all $n>16$. 
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207956.
