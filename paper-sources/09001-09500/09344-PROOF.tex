...
\title{The empirical recurrence for OEIS A183304, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A183304 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A183304 is ``Half the number of n X 3 binary arrays with no element equal to a strict majority of its horizontal and vertical neighbors.''. It has offset $1$ and begins
\[
1, 4, 9, 19, 42, 93, 205, 452,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1)+a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 27 2025 10:34:45, revision 10) the statement is
...
\[
a(n_0+j)-\sum_i c_i\,a(n_0+j-i)\;=\;\tfrac1{2}\,\mathbf{v}^{\!\top}G^{\,j-3}w,
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A183304.
