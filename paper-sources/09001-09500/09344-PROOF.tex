...
\title{The empirical recurrence for OEIS A232017, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A232017 counts arrays over $\{0,\dots,2\}$ in which every cell is constrained by the
...
OEIS A232017 is ``Number of n X 2 0..2 arrays with no element less than a strict majority of its horizontal and antidiagonal neighbors.''. It has offset $1$ and begins
\[
3, 22, 121, 704, 4059, 23422, 135166, 779977,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) + 13*a(n-2) + 16*a(n-3) + 7*a(n-4) + a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 01 2018 21:10:12, revision 7) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 13\,a(n-2) + 16\,a(n-3) + 7\,a(n-4) + a(n-5)
\end{equation}
for all $n>6$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232017.
