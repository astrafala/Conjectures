...
\title{The empirical recurrence for OEIS A283036, proved by transfer matrix}
...
\begin{abstract}
OEIS A283036 counts $n\times2$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A283036 is ``Number of n X 2 0..1 arrays with no 1 equal to more than one of its horizontal and vertical neighbors, with the exception of exactly one element.''. It has offset $1$ and begins
\[
0, 4, 16, 68, 256, 924, 3232, 11044,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) +2*a(n-2) -12*a(n-3) -11*a(n-4) +4*a(n-5) +6*a(n-6) -a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 16 2021 21:42:13, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + 2\,a(n-2) - 12\,a(n-3) - 11\,a(n-4) + 4\,a(n-5) + 6\,a(n-6) - a(n-8)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A283036.
