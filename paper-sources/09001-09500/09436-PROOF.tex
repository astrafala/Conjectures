...
\title{The empirical recurrence for OEIS A204478, proved by transfer matrix}
...
\begin{abstract}
OEIS A204478 counts $(n+2)\times5$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A204478 is ``Number of (n+2) X 5 0..3 arrays with every 3 X 3 subblock having three equal elements in a row horizontally, vertically or nw-to-se diagonally exactly three ways, and new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
1157, 3147, 608, 1587, 2632, 9290, 34964, 124697,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 11 2026 09:24:14, revision 13) this is still
...
\[
\text{exactly }3\text{ of the horizontally, vertically or nw-to-se diagonally lines of }g\text{ \text{is constant}}
\]
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + a(n-2) - 2\,a(n-3) - 19\,a(n-4) - 4\,a(n-5) + 21\,a(n-6) + 24\,a(n-7) + 3\,a(n-8) - 18\,a(n-9) - 9\,a(n-10)
\]
for every $n>13$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204478.
