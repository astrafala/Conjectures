...
\title{The empirical recurrence for OEIS A235083, proved by transfer matrix}
...
\begin{abstract}
OEIS A235083 counts $5$-column arrays over $\{0,\dots,4\}$ in which every
...
OEIS A235083 is ``Number of (n+1) X (4+1) 0..4 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 4, with no adjacent elements equal (constant-stress tilted 1 X 1 tilings).''. It has offset
$1$ and begins
\[
478, 930, 1758, 3558, 7046, 14702, 29970,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 19 2022 21:18:26, revision 7) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A235083.
