...
\title{The empirical recurrence for OEIS A204604, proved by transfer matrix}
...
\begin{abstract}
OEIS A204604 counts $(n+2)\times7$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
$a(n)$ is a walk count on $S=106496$ vertices. Such a sequence is $C$-finite, so whether a given
...
OEIS A204604 is ``Number of (n+2)X7 0..2 arrays with every 3X3 subblock having three strictly increasing elements in a row horizontally, vertically or nw-to-se diagonally exactly one way.''. It has offset $1$ and begins
\[
16247580, 40672735, 43980907, 69792825, 207096000, 1139760144, 6656676736, 61015724528,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 442*a(n-3) +43*a(n-6) for n>16
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 11:20:53, revision 9) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204604.
