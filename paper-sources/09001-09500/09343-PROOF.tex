...
\title{The empirical recurrence for OEIS A236495, proved by transfer matrix}
...
\begin{abstract}
OEIS A236495 counts arrays over $\{0,\dots,3\}$ subject to a condition on the order
...
OEIS A236495 is ``Number of (n+1)X(1+1) 0..3 arrays colored with the sum of the maximum and minimum values of each 2X2 subblock.''. It has offset $1$ and begins
\[
256, 2228, 19856, 171436, 1503360, 13078180, 114229184, 995583500,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 09:17:33, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;32\,a(n-2) + 208\,a(n-3) + 1222\,a(n-4) + 2448\,a(n-5) + 2716\,a(n-6) + 944\,a(n-7) - 681\,a(n-8) - 1944\,a(n-9) - 1248\,a(n-10) - 512\,a(n-11)
\]
for every $n>12$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A236495.
