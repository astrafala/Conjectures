...
\title{The empirical recurrence for OEIS A230615, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A230615 counts arrays over $\{0,\dots,2\}$ in which every cell is constrained by the
values of its neighbours, and carries an empirical recurrence of order $14$ contributed
...
OEIS A230615 is ``Number of 3Xn 0..2 arrays x(i,j) with each element horizontally or antidiagonally next to at least one element with value (x(i,j)+1) mod 3, and upper left element zero.''. It has offset $1$ and begins
\[
0, 0, 0, 30, 260, 2358, 20430, 176774,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 05:55:40, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;15\,a(n-1) - 64\,a(n-2) + 61\,a(n-3) + 181\,a(n-4) - 210\,a(n-5) - 679\,a(n-6) + 577\,a(n-7) + 2166\,a(n-8) - 2571\,a(n-9) - 789\,a(n-10) + 760\,a(n-11) + 618\,a(n-12) + 264\,a(n-13) + 56\,a(n-14)
\end{equation}
for all $n>17$.
...
The threshold below is exact rather than merely sufficient: at $n=17$ the conjectured
...
\begin{proof}
Substitute Lemma~\ref{lem:walk} and factor $G^{j-14}$ out of
...
the middle column. The vector $w$ was formed by $14$ applications of $G$ in exact integer
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A230615.
