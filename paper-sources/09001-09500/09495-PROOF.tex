...
\title{The empirical recurrence for OEIS A299368, proved by transfer matrix}
...
\begin{abstract}
OEIS A299368 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A299368 is ``Number of nX3 0..1 arrays with every element equal to 1, 2, 3, 4, 5 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 18, 130, 876, 6025, 41528, 285931, 1968966,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 7*a(n-1) +2*a(n-2) -19*a(n-3) -a(n-4) -2*a(n-5) +4*a(n-6) -2*a(n-7) -3*a(n-8) -5*a(n-9) +2*a(n-10) for n>11
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 08 2018 14:05:28, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;7\,a(n-1) + 2\,a(n-2) - 19\,a(n-3) - a(n-4) - 2\,a(n-5) + 4\,a(n-6) - 2\,a(n-7) - 3\,a(n-8) - 5\,a(n-9) + 2\,a(n-10)
\end{equation}
for all $n>11$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A299368.
