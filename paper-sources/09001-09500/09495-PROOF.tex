...
\title{The empirical recurrence for OEIS A206694, proved by transfer matrix}
...
\begin{abstract}
OEIS A206694 counts arrays of width $2$ over $\{0,1,2\}$ containing no occurrence of certain short
...
OEIS A206694 is ``Number of n X 2 0..2 arrays avoiding the pattern z-2 z-1 z in any row or column.''. It has offset $1$ and begins
\[
9, 81, 676, 5625, 46656, 386884, 3207681, 26594649,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 9*a(n-1) -3*a(n-2) -25*a(n-3) +9*a(n-4) +3*a(n-5) -a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 23 2018 09:52:07, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206694.
