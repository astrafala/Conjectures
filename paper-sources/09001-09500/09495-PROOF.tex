...
\title{The empirical recurrence for OEIS A234107, proved by transfer matrix}
...
\begin{abstract}
OEIS A234107 counts $(n+1)\times2$ arrays over $\{0,\dots,4\}$ subject to a condition imposed on
...
OEIS A234107 is ``Number of (n+1) X (1+1) 0..4 arrays with every 2 X 2 subblock having the sum of the absolute values of all six edge and diagonal differences equal to 12.''. It has offset $1$ and begins
\[
56, 186, 604, 2064, 6964, 24156, 83012, 290164,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 5*a(n-1) + 6*a(n-2) - 50*a(n-3) + 16*a(n-4) + 80*a(n-5) - 16*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 12 2018 15:32:21, revision 7) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234107.
