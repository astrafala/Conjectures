...
\title{The empirical recurrence for OEIS A202585, proved by transfer matrix}
...
\begin{abstract}
OEIS A202585 counts arrays of width $4$ over $\{0,1\}$ containing no occurrence of certain short
...
OEIS A202585 is ``Number of (n+2)X4 binary arrays avoiding patterns 001 and 100 in rows, columns and nw-to-se diagonals.''. It has offset $1$ and begins
\[
260, 943, 3906, 16595, 72124, 315526, 1386452, 6101978,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 09:42:59, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + 12\,a(n-2) - 13\,a(n-3) - 58\,a(n-4) - 15\,a(n-5) + 99\,a(n-6) + 100\,a(n-7) - 11\,a(n-8) - 61\,a(n-9) - 54\,a(n-10) - 16\,a(n-11) + 10\,a(n-12) + 6\,a(n-13) - 2\,a(n-14) + a(n-16)
\]
for every $n>17$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A202585.
