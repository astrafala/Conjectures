...
\title{The empirical recurrence for OEIS A235013, proved by transfer matrix}
...
\begin{abstract}
OEIS A235013 counts $5$-column arrays over $\{0,\dots,4\}$ in which every
...
OEIS A235013 is ``Number of (n+1) X (4+1) 0..4 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 3, with no adjacent elements equal (constant-stress tilted 1 X 1 tilings).''. It has offset
$1$ and begins
\[
680, 1112, 1912, 3560, 6856, 13912, 28968,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 5*a(n-1) + a(n-2) - 38*a(n-3) + 33*a(n-4) + 97*a(n-5) - 127*a(n-6) - 88*a(n-7) + 154*a(n-8) + 12*a(n-9) - 48*a(n-10).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 19 2022 01:26:17, revision 9) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A235013.
