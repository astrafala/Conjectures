...
\title{The empirical recurrence for OEIS A252108, proved by transfer matrix}
...
\begin{abstract}
OEIS A252108 counts $(n+2)\times4$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252108 is ``Number of (n+2) X (2+2) 0..3 arrays with every 3 X 3 subblock row and column sum equal to 0 2 3 6 or 7 and every 3 X 3 diagonal and antidiagonal sum not equal to 0 2 3 6 or 7.''. It has offset $1$ and begins
\[
1929, 1424, 724, 584, 624, 788, 1180, 1668,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 6*a(n-3) - 8*a(n-6) for n>13.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 01 2018 07:58:01, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252108.
