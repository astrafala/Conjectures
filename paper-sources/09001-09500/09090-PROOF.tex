...
\title{The empirical recurrence for OEIS A231446, proved by transfer matrix}
...
\begin{abstract}
OEIS A231446 counts $(n+1)\times4$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A231446 is ``Number of (n+1)X(3+1) 0..3 arrays with no element unequal to a strict majority of its horizontal and antidiagonal neighbors, with values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
4, 32, 340, 4179, 54868, 741430, 10145989, 139597860,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 06:30:23, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;37\,a(n-1) - 570\,a(n-2) + 5132\,a(n-3) - 31207\,a(n-4) + 138163\,a(n-5) - 465831\,a(n-6) + 1230771\,a(n-7) - 2586152\,a(n-8) + 4340528\,a(n-9) - 5811522\,a(n-10) + 6165034\,a(n-11) - 5094306\,a(n-12) + 3181860\,a(n-13) - 1438353\,a(n-14) + 441099\,a(n-15) - 81243\,a(n-16) + 6561\,a(n-17)
\]
for every $n>17$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231446.
