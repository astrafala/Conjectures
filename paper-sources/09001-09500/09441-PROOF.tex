...
\title{The empirical recurrence for OEIS A188700, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A188700 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A188700 is ``Number of n X 3 binary arrays without the pattern 0 0 diagonally or vertically.''. It has offset $1$ and begins
\[
8, 21, 90, 304, 1141, 4084, 14925, 54049,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) + 8*a(n-2) + 6*a(n-3) - a(n-4) - a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 28 2018 08:11:23, revision 10) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A188700.
