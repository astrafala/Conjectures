...
\title{The empirical recurrence for OEIS A237905, proved by transfer matrix}
...
\begin{abstract}
OEIS A237905 counts arrays over $\{0,\dots,3\}$ subject to a condition on the order
...
OEIS A237905 is ``Number of (n+1)X(1+1) 0..3 arrays with the maximum minus the upper median of every 2X2 subblock differing from its horizontal and vertical neighbors by exactly one.''. It has offset $1$ and begins
\[
256, 1780, 12552, 88544, 635200, 4438816, 31507328, 221652256,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 10:34:06, revision 7) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The $2\times2$ subblocks of an $(n+1)\times2$ array form an
$n\times1$ grid, and each carries the value $\sigma=-c+d$, where $a\le b\le c\le d$ are its four entries sorted --- its minimum, lower median, upper median and maximum. The entry asks that the values of
...
\begin{theorem}
\[
a(n)\;=\;1884\,a(n-4) + 28048\,a(n-6) + 134800\,a(n-8) + 241600\,a(n-10) + 86848\,a(n-12) - 80384\,a(n-14) + 25600\,a(n-16)
\]
for every $n>17$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237905.
