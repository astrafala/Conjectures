...
\title{The empirical recurrence for OEIS A188757, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A188757 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A188757 is ``Number of nX3 binary arrays without the pattern 0 0 1 vertically or horizontally.''. It has offset $1$ and begins
\[
7, 49, 240, 1112, 4792, 20129, 82807, 337209,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 04:49:20, revision 9) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A188757.
