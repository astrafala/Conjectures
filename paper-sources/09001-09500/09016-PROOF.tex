...
\title{The empirical recurrence for OEIS A250908, proved by transfer matrix}
...
\begin{abstract}
OEIS A250908 counts $(n+1)\times4$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A250908 is ``Number of (n+1)X(3+1) 0..2 arrays with no 2X2 subblock having its maximum diagonal element less than its minimum antidiagonal element.''. It has offset $1$ and begins
\[
4909, 297873, 18077319, 1096982379, 66566704705, 4039362762435, 245114118899485, 14873861407326111,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 74*a(n-1) -825*a(n-2) +1101*a(n-3) -4926*a(n-4) +231*a(n-5) +1684*a(n-6) +736*a(n-7)
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 12:50:31, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;74\,a(n-1) - 825\,a(n-2) + 1101\,a(n-3) - 4926\,a(n-4) + 231\,a(n-5) + 1684\,a(n-6) + 736\,a(n-7)
\end{equation}
for all $n>6$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250908.
