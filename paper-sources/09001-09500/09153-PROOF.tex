...
\title{The empirical recurrence for OEIS A183495, proved by transfer matrix}
...
\begin{abstract}
OEIS A183495 counts arrays of width $2$ over $\{0,\dots,2\}$ under a condition on each cell
and its neighbours, and carries an empirical recurrence of order $9$ contributed by
...
OEIS A183495 is ``Half the number of n X 2 0..2 arrays with no element equal to the sum mod 3 of its horizontal and vertical neighbors.''. It has offset $1$ and begins
\[
3, 9, 36, 128, 540, 2048, 8256, 32784,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) + 4*a(n-2) - 16*a(n-3) + 16*a(n-6) - 64*a(n-7) - 64*a(n-8) + 256*a(n-9)
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 29 2018 08:49:03, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + 4\,a(n-2) - 16\,a(n-3) + 16\,a(n-6) - 64\,a(n-7) - 64\,a(n-8) + 256\,a(n-9)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A183495.
