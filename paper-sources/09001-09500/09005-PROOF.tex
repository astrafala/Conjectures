...
\title{The empirical recurrence for OEIS A255105, proved by transfer matrix}
...
\begin{abstract}
OEIS A255105 carries an empirical recurrence of order $13$ contributed by R.~H.~Hardin. It is
...
OEIS A255105 is ``Number of length n+6 0..2 arrays with at most one downstep in every 6 consecutive neighbor pairs.''. It has offset $1$ and begins
\[
540, 1008, 2032, 4338, 9297, 19263, 38010, 73278,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) -3*a(n-2) +a(n-3) +25*a(n-6) -42*a(n-7) +18*a(n-8) -10*a(n-12) +6*a(n-13)
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 15:07:54, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) - 3\,a(n-2) + a(n-3) + 25\,a(n-6) - 42\,a(n-7) + 18\,a(n-8) - 10\,a(n-12) + 6\,a(n-13)
\]
for every $n>19$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A255105.
