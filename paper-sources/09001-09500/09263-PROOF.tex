...
\title{The empirical recurrence for OEIS A280670, proved by transfer matrix}
...
\begin{abstract}
OEIS A280670 counts $n\times5$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A280670 is ``Number of nX5 0..2 arrays with no element equal to more than one of its horizontal and antidiagonal neighbors and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
30, 1917, 119440, 7533245, 474736149, 29920114246, 1885698283255, 118845116023725,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 59*a(n-1) +268*a(n-2) -869*a(n-3) -2331*a(n-4) +3754*a(n-5) -8240*a(n-6) -88*a(n-7) -3472*a(n-8) for n>9
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 07 2017 08:05:00, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;59\,a(n-1) + 268\,a(n-2) - 869\,a(n-3) - 2331\,a(n-4) + 3754\,a(n-5) - 8240\,a(n-6) - 88\,a(n-7) - 3472\,a(n-8)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A280670.
