...
\title{The empirical recurrence for OEIS A317729, proved by transfer matrix}
...
\begin{abstract}
OEIS A317729 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A317729 is ``Number of n X 4 0..1 arrays with every element unequal to 1, 2, 3, 4, 5, 6, 7 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
2, 98, 1250, 19208, 293378, 4458098, 67837952, 1032124178,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 12*a(n-1) +42*a(n-2) +107*a(n-3) -30*a(n-4) +12*a(n-5) -16*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (May 16 2023 15:47:04, revision
6) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;12\,a(n-1) + 42\,a(n-2) + 107\,a(n-3) - 30\,a(n-4) + 12\,a(n-5) - 16\,a(n-6)
\end{equation}
for all $n>6$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A317729.
