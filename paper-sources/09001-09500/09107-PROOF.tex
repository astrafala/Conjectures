...
\title{The empirical recurrence for OEIS A295843, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A295843 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A295843 is ``Number of nX4 0..1 arrays with each 1 adjacent to 1 or 2 king-move neighboring 1s.''. It has offset $1$ and begins
\[
7, 80, 467, 3472, 26544, 190943, 1406191, 10368395,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 29 2017 06:52:08, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) + 6\,a(n-2) + 47\,a(n-3) - 138\,a(n-4) + 33\,a(n-5) + 55\,a(n-6) - 397\,a(n-7) - 225\,a(n-8) + 305\,a(n-9) - 243\,a(n-10) - 191\,a(n-11) + 206\,a(n-12) - 56\,a(n-13) - 26\,a(n-14) + 21\,a(n-15) + 2\,a(n-16)
\end{equation}
for all $n>17$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A295843.
