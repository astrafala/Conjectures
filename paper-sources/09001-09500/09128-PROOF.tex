...
\title{The empirical recurrence for OEIS A206321, proved by transfer matrix}
...
\begin{abstract}
OEIS A206321 counts arrays over $\{0,\dots,3\}$ under a condition on the perimeter cycle of
...
a bounded window of consecutive rows, so the count is a walk count on $S=1344$ states and is
...
OEIS A206321 is ``Number of (n+1) X 3 0..3 arrays with every 2 X 3 or 3 X 2 subblock having exactly three clockwise edge increases.''. It has offset $1$ and begins
\[
1344, 16892, 282996, 4796092, 81302880, 1377662868, 23340152044, 395403752128,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 24*a(n-1) -131*a(n-2) +200*a(n-3) -116*a(n-4) +35*a(n-5) -13*a(n-6) +2*a(n-7) for n>10.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 08 2026 21:44:54, revision 11) this is still
...
\begin{theorem}
\[
a(n)\;=\;24\,a(n-1) - 131\,a(n-2) + 200\,a(n-3) - 116\,a(n-4) + 35\,a(n-5) - 13\,a(n-6) + 2\,a(n-7)
\]
for every $n>10$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206321.
