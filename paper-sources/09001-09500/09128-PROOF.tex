...
\title{The empirical recurrence for OEIS A250726, proved by transfer matrix}
...
\begin{abstract}
OEIS A250726 counts arrays over $\{0,1\}$ in which a statistic taken over short runs
...
OEIS A250726 is ``Number of (n+1) X (5+1) 0..1 arrays with nondecreasing x(i,j)+x(i,j-1) in the i direction and nondecreasing min(x(i,j),x(i-1,j)) in the j direction.''. It has offset $1$ and begins
\[
257, 596, 1158, 2092, 3605, 6016, 9728, 15297,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 6*a(n-1) - 14*a(n-2) + 14*a(n-3) - 14*a(n-5) + 14*a(n-6) - 6*a(n-7) + a(n-8) for n>10.
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 16 2018 07:51:17, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250726.
