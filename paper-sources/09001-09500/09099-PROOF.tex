...
\title{The empirical recurrence for OEIS A208382, proved by transfer matrix}
...
\begin{abstract}
OEIS A208382 counts arrays over $\{0,\dots,1\}$ of width $6$ that avoid the patterns
$(0,0,1), (1,0,1)$ along one axis and $(0,0,0), (1,1,1)$ along the other, and carries an empirical recurrence of
...
OEIS A208382 is ``Number of 6 X n 0..1 arrays avoiding 0 0 0 and 1 1 1 horizontally and 0 0 1 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
12, 144, 180, 900, 3200, 10660, 40740,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) + 4*a(n-2) + 17*a(n-3) + 11*a(n-4) - 4*a(n-5) + 16*a(n-6) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 02 2018 09:01:35, revision
8) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 4\,a(n-2) + 17\,a(n-3) + 11\,a(n-4) - 4\,a(n-5) + 16\,a(n-6)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208382.
