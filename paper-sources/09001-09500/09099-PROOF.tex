...
\title{The empirical recurrence for OEIS A253391, proved by transfer matrix}
...
\begin{abstract}
OEIS A253391 counts the arrays over $\{0,\dots,1\}$ whose $2\times2$ subblocks carry a
...
OEIS A253391 is ``Number of (n+1) X (2+1) 0..1 arrays with every 2 X 2 subblock antidiagonal maximum minus diagonal minimum nondecreasing horizontally and diagonal maximum minus antidiagonal minimum nondecreasing vertically.''. It has offset $1$ and begins
\[
44, 102, 143, 197, 250, 320, 391, 477,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) - 2*a(n-3) + a(n-4) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 11 2018 08:42:03, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253391.
