...
\title{The empirical recurrence for OEIS A239179, proved by transfer matrix}
...
\begin{abstract}
OEIS A239179 counts $2\times(n+1)$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A239179 is ``Number of (1+1) X (n+1) 0..2 arrays with no element greater than all horizontal neighbors or equal to all vertical neighbors.''. It has offset $1$ and begins
\[
6, 26, 98, 378, 1512, 6018, 23890, 94846,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) - a(n-2) + 3*a(n-3) + 3*a(n-4) - 4*a(n-5) + a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 25 2018 11:53:12, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A239179.
