...
\title{The empirical recurrence for OEIS A264124, proved by transfer matrix}
...
\begin{abstract}
OEIS A264124 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=5$ rows in which
...
OEIS A264124 is ``Number of (n+1)X(4+1) arrays of permutations of 0..n*5+4 with each element having index change +-(.,.) 0,0 1,-2 or 2,-1.''. It has offset $1$ and begins
\[
8, 200, 5733, 108045, 1995525, 39592980, 791859600, 15730470000,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 10 2015 11:01:57, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264124.
