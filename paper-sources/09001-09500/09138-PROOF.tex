...
\title{The empirical recurrence for OEIS A204603, proved by transfer matrix}
...
\begin{abstract}
OEIS A204603 counts $(n+2)\times6$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A204603 is ``Number of (n+2)X6 0..2 arrays with every 3X3 subblock having three strictly increasing elements in a row horizontally, vertically or nw-to-se diagonally exactly one way.''. It has offset $1$ and begins
\[
2275645, 4820300, 5260434, 10978524, 69792825, 774393122, 4518555426, 32448416953,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 442*a(n-3) +43*a(n-6) for n>15
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 11:20:46, revision 9) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204603.
