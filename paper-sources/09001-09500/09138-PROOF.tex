...
\title{The empirical recurrence for OEIS A281475, proved by transfer matrix}
...
\begin{abstract}
OEIS A281475 counts $7\times n$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A281475 is ``Number of 7 X n 0..1 arrays with no element equal to more than two of its horizontal, diagonal or antidiagonal neighbors and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
64, 2785, 634, 897, 1106, 1422, 1887, 2429,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) - a(n-2) + a(n-3) - a(n-4) + a(n-7) - a(n-8) for n>16.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 20 2019 05:30:15, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) - a(n-2) + a(n-3) - a(n-4) + a(n-7) - a(n-8)
\]
for every $n>16$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A281475.
