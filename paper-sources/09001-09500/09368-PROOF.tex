...
\title{The empirical recurrence for OEIS A278267, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A278267 counts arrays over $\{0,\dots,3\}$ in which every cell is constrained by the
...
OEIS A278267 is ``Number of n X 2 0..3 arrays with every element plus 1 mod 4 equal to some element at offset (-1,-1) (-1,0) (-1,1) (0,-1) (0,1) (1,-1) or (1,0), with upper left element zero.''. It has offset $1$ and begins
\[
0, 4, 47, 395, 3453, 30475, 268257, 2360984,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 10*a(n-1) - 14*a(n-2) + 37*a(n-3) - 65*a(n-4) + 70*a(n-5) - 76*a(n-6) + 74*a(n-7) - 32*a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 09 2019 08:49:19, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;10\,a(n-1) - 14\,a(n-2) + 37\,a(n-3) - 65\,a(n-4) + 70\,a(n-5) - 76\,a(n-6) + 74\,a(n-7) - 32\,a(n-8)
\end{equation}
for all $n>9$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A278267.
