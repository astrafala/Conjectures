...
\title{The empirical recurrence for OEIS A236004, proved by transfer matrix}
...
\begin{abstract}
OEIS A236004 counts arrays of width $3$ over $\{0,1,2,3\}$ in which the smallest and largest of the
...
OEIS A236004 is ``Number of (n+1)X(2+1) 0..3 arrays with the minimum plus the maximum equal to the lower median plus the upper median in every 2X2 subblock.''. It has offset $1$ and begins
\[
508, 4568, 41608, 389520, 3726296, 36383144, 361779592, 3655701448,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 08:59:33, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;43\,a(n-1) - 763\,a(n-2) + 7147\,a(n-3) - 36573\,a(n-4) + 84065\,a(n-5) + 69894\,a(n-6) - 844584\,a(n-7) + 1395964\,a(n-8) + 1156720\,a(n-9) - 4996336\,a(n-10) + 928096\,a(n-11) + 6404480\,a(n-12) - 1078656\,a(n-13) - 4024832\,a(n-14) - 1081344\,a(n-15) + 79872\,a(n-16) + 32768\,a(n-17)
\]
for every $n>16$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A236004.
