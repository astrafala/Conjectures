...
\title{The empirical recurrence for OEIS A252238, proved by transfer matrix}
...
\begin{abstract}
OEIS A252238 counts $(n+2)\times5$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252238 is ``Number of (n+2)X(3+2) 0..3 arrays with every 3X3 subblock row and column sum not equal to 1 3 4 6 or 7 and every 3X3 diagonal and antidiagonal sum equal to 1 3 4 6 or 7.''. It has offset $1$ and begins
\[
2174, 16056, 108882, 331884, 2908368, 22430004, 65274264, 634913568,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 454*a(n-3) -60040*a(n-6) +2444800*a(n-9) -13041664*a(n-12) +16777216*a(n-15) for n>16
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 10:58:19, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252238.
