...
\title{The empirical recurrence for OEIS A237550, proved by transfer matrix}
...
\begin{abstract}
OEIS A237550 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
OEIS A237550 is ``Number of (n+1) X (1+1) 0..2 arrays with the maximum minus the upper median of every 2 X 2 subblock differing from its horizontal and vertical neighbors by exactly one.''. It has offset $1$ and begins
\[
81, 312, 1240, 4752, 19128, 72736, 290112, 1110080,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 192*a(n-4) + 608*a(n-6) + 400*a(n-8) for n>9.
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 22 2018 17:39:41, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;192\,a(n-4) + 608\,a(n-6) + 400\,a(n-8)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237550.
