...
\title{The empirical recurrence for OEIS A252222, proved by transfer matrix}
...
\begin{abstract}
OEIS A252222 counts arrays of width $4$ over $\{0,1,2\}$ in which every $3\times3$ window has
...
OEIS A252222 is ``Number of (n+2) X (2+2) 0..2 arrays with every 3 X 3 subblock row and column sum 2 3 or 4 and every diagonal and antidiagonal sum not 2 3 or 4.''. It has offset $1$ and begins
\[
368, 1028, 3066, 7724, 22256, 70284, 219824, 675264,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) - a(n-2) + 3*a(n-3) + 3*a(n-4) - a(n-5) - a(n-6) for n>9.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 02 2018 07:15:11, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252222.
