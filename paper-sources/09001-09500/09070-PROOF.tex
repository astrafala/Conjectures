...
\title{The empirical recurrence for OEIS A296380, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A296380 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A296380 is ``Number of n X 2 0..1 arrays with each 1 horizontally, vertically or antidiagonally adjacent to 1 or 2 neighboring 1s.''. It has offset $1$ and begins
\[
2, 10, 28, 86, 279, 869, 2728, 8596,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) - a(n-2) + 6*a(n-3) - 6*a(n-4) + 6*a(n-5) - 5*a(n-6) + 3*a(n-7) - a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 22 2018 09:47:43, revision 7) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) - a(n-2) + 6\,a(n-3) - 6\,a(n-4) + 6\,a(n-5) - 5\,a(n-6) + 3\,a(n-7) - a(n-8)
\end{equation}
for all $n>9$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A296380.
