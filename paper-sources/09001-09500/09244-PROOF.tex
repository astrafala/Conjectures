...
\title{A condition on the multiset of every subblock: OEIS A235975}
...
\begin{abstract}
OEIS A235975 carries an empirical recurrence of order $9$ contributed by R.~H.~Hardin. It is
...
OEIS A235975 is ``Number of (n+1)X(2+1) 0..2 arrays with the upper median equal to the lower median in every 2X2 subblock.''. It has offset $1$ and begins
\[
181, 1473, 11239, 89555, 703565, 5579529, 44112111, 349456139,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 11*a(n-1) -9*a(n-2) -173*a(n-3) +380*a(n-4) +324*a(n-5) -1056*a(n-6) +176*a(n-7) +256*a(n-8) -64*a(n-9)
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 08:58:44, revision 6) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{The count is a walk count}

The entry counts arrays with $3$ columns over the alphabet $\{0,1,2\}$, growing one row at a time, and asks that in every $2\times2$ subblock the two middle order statistics are equal: writing the $4$ entries of the block in nondecreasing order $v_1\le\cdots\le v_{4}$, the lower median is $v_{2}$ and the upper median $v_{3}$, and these must be equal.
...
\begin{theorem}
\[
a(n)\;=\;11\,a(n-1) - 9\,a(n-2) - 173\,a(n-3) + 380\,a(n-4) + 324\,a(n-5) - 1056\,a(n-6) + 176\,a(n-7) + 256\,a(n-8) - 64\,a(n-9)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A235975.
