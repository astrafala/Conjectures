...
\title{The empirical recurrence for OEIS A299055, proved by transfer matrix}
...
\begin{abstract}
OEIS A299055 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $equal to$ itself lying in $\{0,2,3,4,5,6\}$, and it carries an empirical
...
OEIS A299055 is ``Number of nX3 0..1 arrays with every element equal to 0, 2, 3, 4, 5 or 6 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 13, 38, 199, 864, 4366, 21804, 111861,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 01 2018 14:33:22, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) + 9\,a(n-2) - 31\,a(n-3) - 62\,a(n-4) + 46\,a(n-5) + 78\,a(n-6) - 36\,a(n-7) + 53\,a(n-8) + 101\,a(n-9) - 86\,a(n-10) - 14\,a(n-11) - 26\,a(n-12) - 28\,a(n-13) + 6\,a(n-14)
\end{equation}
for all $n>16$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A299055.
