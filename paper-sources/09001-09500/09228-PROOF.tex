...
\title{The empirical recurrence for OEIS A234452, proved by transfer matrix}
...
\begin{abstract}
OEIS A234452 counts $2$-column arrays over $\{0,\dots,5\}$ in which every
...
OEIS A234452 is ``Number of (n+1) X (1+1) 0..5 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 1 (constant-stress 1 X 1 tilings).''. It has offset
$1$ and begins
\[
280, 2400, 21344, 192960, 1755520, 16026240, 146415104,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 100*a(n-2) - 1384*a(n-4) + 1440*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 20 2022 21:32:26, revision 13) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234452.
