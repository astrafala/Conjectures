...
\title{The empirical recurrence for OEIS A208065, proved by transfer matrix}
...
\begin{abstract}
OEIS A208065 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
...
OEIS A208065 is ``Number of n X 4 0..1 arrays avoiding 0 0 0 and 1 1 1 horizontally and 0 0 1 and 0 1 1 vertically.''. It has offset
$1$ and begins
\[
10, 100, 240, 576, 1008, 1764, 2688,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) + 2*a(n-2) - 6*a(n-3) + 6*a(n-5) - 2*a(n-6) - 2*a(n-7) + a(n-8) for n>9.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 27 2018 06:15:47, revision
...
compared against the entry's DATA at every one of the $35$ published indices; the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208065.
