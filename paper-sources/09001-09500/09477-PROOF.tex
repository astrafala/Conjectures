...
\title{The empirical recurrence for OEIS A207277, proved by transfer matrix}
...
\begin{abstract}
OEIS A207277 counts arrays of width $2$ over $\{0,1,2,3\}$ containing no occurrence of certain short
...
OEIS A207277 is ``Number of n X 2 0..3 arrays avoiding the patterns z z+1 z or z z-1 z in any row, column, diagonal or antidiagonal.''. It has offset $1$ and begins
\[
16, 256, 3364, 45796, 620944, 8421604, 114190596, 1548422500,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 10 2020 04:28:53, revision 14) this is still
...
\begin{theorem}
\[
a(n)\;=\;11\,a(n-1) + 28\,a(n-2) + 48\,a(n-3) + 536\,a(n-4) + 664\,a(n-5) - 205\,a(n-6) - 656\,a(n-7) - 535\,a(n-8) + 4\,a(n-9) + 212\,a(n-10) + 175\,a(n-11) - 36\,a(n-12) + 5\,a(n-13) - 8\,a(n-14) + a(n-15)
\]
for every $n>15$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207277.
