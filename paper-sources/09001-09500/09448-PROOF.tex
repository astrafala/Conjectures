...
\title{The empirical recurrence for OEIS A259517, proved by transfer matrix}
...
\begin{abstract}
OEIS A259517 counts arrays of width $2$ over $\{0,1\}$ subject to a condition read round the
...
OEIS A259517 is ``Number of (n+1) X (1+1) 0..1 arrays with each 2 X 2 subblock having clockwise pattern 0000 0001 0011 0101 or 1111.''. It has offset $1$ and begins
\[
12, 38, 120, 380, 1204, 3816, 12096, 38344,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) - 2*a(n-2) - 2*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 25 2018 11:15:21, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A259517.
