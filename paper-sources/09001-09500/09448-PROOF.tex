...
\title{The empirical recurrence for OEIS A238065, proved by transfer matrix}
...
\begin{abstract}
OEIS A238065 counts arrays over $\{0,\dots,3\}$ subject to a condition on the order
...
OEIS A238065 is ``Number of (n+1)X(1+1) 0..3 arrays with the maximum minus the minimum of every 2X2 subblock differing from its horizontal and vertical neighbors by exactly one.''. It has offset $1$ and begins
\[
256, 1644, 10700, 67056, 438768, 2752364, 17963540, 112686608,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 23*a(n-2) +689*a(n-4) +1889*a(n-6) +1784*a(n-8) +512*a(n-10) for n>13
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 10:44:49, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;23\,a(n-2) + 689\,a(n-4) + 1889\,a(n-6) + 1784\,a(n-8) + 512\,a(n-10)
\]
for every $n>13$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A238065.
