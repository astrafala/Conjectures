...
\title{A proof of the conjectured recurrence for OEIS A081046}
...
\begin{abstract}
OEIS A081046 carries a conjectured linear recurrence with polynomial coefficients, of
...
OEIS A081046 is ``Difference of the first two Stirling numbers of the first kind''. It has offset $0$ and begins
\[
a(0),\dots,a(7)\;=\;1, -2, 5, -17, 74, -394, 2484, -18108,\ \dots
\]
The entry gives the exponential generating function
\begin{equation}\label{eq:gf}
A(x)\;=\;\sum_{n\ge 0} a(n)\,\frac{x^{n}}{n!}\;=\;\frac{1 - \log{\left(x + 1 \right)}}{x + 1} ,
\end{equation}
and it carries the following comment:
\begin{quote}\small
\textbf{Conjecture:} a(n) +(2*n-1)*a(n-1) +(n-1)\^{}2*a(n-2)=0. - \emph{R. J. Mathar}, Oct 27 2014
\end{quote}
...
\[
p_{0}(n)=1,\qquad p_{1}(n)=2 n - 1,\qquad p_{2}(n)=\left(n - 1\right)^{2}
\]
...
\section{The computation for A081046}
...
\[
1\,a(n) + (2 n - 1)\,a(n-1) + (n^{2} - 2 n + 1)\,a(n-2) \;=\;0
\]
holds for every $n>0$.
\end{theorem}
...
section of A081046, agreeing on all 13 terms compared.
...
\url{https://oeis.org}, 2026. Sequence A081046.
