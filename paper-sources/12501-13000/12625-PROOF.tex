...
\begin{quote}\small
\textbf{Conjecture:} n*(13*n-40)*a(n) +(-55*n\^{}2+211*n-129)*a(n-1) +(38*n\^{}2-212*n+255)*a(n-2) +(-6*n\^{}2+56*n-75)*a(n-3) +(13*n\^{}2-66*n+3)*a(n-4) -(3*n-13)*(n-6)*a(n-5)=0. - \emph{R. J. Mathar}, Jun 06 2016
\end{quote}
...
\[
p_{0}(n)=n \left(13 n - 40\right),\qquad p_{1}(n)=- 55 n^{2} + 211 n - 129,\qquad p_{2}(n)=38 n^{2} - 212 n + 255,\qquad p_{3}(n)=- 6 n^{2} + 56 n - 75,\qquad p_{4}(n)=13 n^{2} - 66 n + 3,\qquad p_{5}(n)=- \left(n - 6\right) \left(3 n - 13\right)
\]
...
\[
n \left(13 n - 40\right)\,a(n) + (- 55 n^{2} + 211 n - 129)\,a(n-1) + (38 n^{2} - 212 n + 255)\,a(n-2) + (- 6 n^{2} + 56 n - 75)\,a(n-3) + (13 n^{2} - 66 n + 3)\,a(n-4) -  \left(n - 6\right) \left(3 n - 13\right)\,a(n-5) \;=\;0
\]
holds for every $n>2$.
\end{theorem}
