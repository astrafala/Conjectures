...
\title{The empirical recurrence for OEIS A264547, recovered from its tail}
...
\begin{abstract}
OEIS A264547 records ``Empirical recurrence of order $84$'' and keeps the recurrence itself in
...
OEIS A264547 is ``Number of (n+1)X(5+1) arrays of permutations of 0..n*6+5 with each element having directed index change -1,1 -1,2 1,0 or 0,-1.''. It has offset $1$ and begins
\[
1, 40, 172, 1528, 14852, 105081, 813473, 6587227,\ \dots
\]
The entry states:
\begin{quote}
Empirical recurrence of order 84 (see link above)
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 17 2015 15:35:00, revision 4)
...
\begin{theorem}
The recurrence above holds for every $n\ge85$, and it is the recurrence OEIS A264547 records.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264547.
