...
\title{A proof of the conjectured recurrence for OEIS A273019}
...
\begin{abstract}
OEIS A273019 carries a conjectured linear recurrence with polynomial coefficients, of
...
OEIS A273019 is ``a(n) = hypergeom([-2*n-1, 1/2], [2], 4) + (2*n+1)*hypergeom([-n+1/2, -n], [2], 4)''. It has offset $0$ and begins
\[
a(0),\dots,a(7)\;=\;1, 5, 39, 321, 2675, 22483, 190345, 1621413,\ \dots
\]
The entry carries the following comment, still recorded as a conjecture:
\begin{quote}\small
\textbf{Conjecture:} +(241*n+56) *(2*n+1) *(n+1)*a(n) +(482*n\^{}3-25561*n\^{}2+13831*n-56) *a(n-1) +(-48682*n\^{}3+225897*n\^{}2-300131*n+125310) *a(n-2) +9*(n-2) *(2651*n-3183) *(2*n-3) *a(n-3)=0. - \emph{R. J. Mathar}, May 16 2016
\end{quote}
As of the ``Last modified'' line on the live entry (2026-05-24, revision 20) it is still
...
\begin{quote}\small
Recurrence (of order 2): (n+1)*(2*n + 1)*(12*n\^{}2 - 19*n + 9)*a(n) = (240*n\^{}4 - 140*n\^{}3 - 42*n\^{}2 - 7*n + 9)*a(n-1) - 9*(n-1)*(2*n - 1)*(12*n\^{}2 + 5*n + 2)*a(n-2). - \emph{Vaclav Kotesovec}, Jul 05 2018
\end{quote}
...
\section{The computation for A273019}

Reading both relations as operators and dividing the conjectured one by the stated one
leaves remainder $0$, with quotient
\[
Q \;=\; \left(\frac{2651 n + 4770}{12 n^{2} + 53 n + 60}\right) + \left(\frac{241 n + 779}{12 n^{2} + 53 n + 60}\right)\,N .
\]
...
\[
\left(n + 1\right) \left(2 n + 1\right) \left(241 n + 56\right)\,a(n) + (482 n^{3} - 25561 n^{2} + 13831 n - 56)\,a(n-1) + (- 48682 n^{3} + 225897 n^{2} - 300131 n + 125310)\,a(n-2) + 9 \left(n - 2\right) \left(2 n - 3\right) \left(2651 n - 3183\right)\,a(n-3) \;=\;0
\]
...
entry's own values and found to vanish, for all 19 values of $n$ from
$n=3$ upward.

\begin{thebibliography}{9}
\bibitem{oeis} The OEIS Foundation, \emph{The On-Line Encyclopedia of Integer Sequences},
\url{https://oeis.org}, 2026. Sequence A273019.
