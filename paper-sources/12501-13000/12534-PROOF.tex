...
\title{The empirical recurrence for OEIS A228678, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A228678 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A228678 is ``Number of nX3 binary arrays with no two ones adjacent horizontally, diagonally or antidiagonally.''. It has offset $1$ and begins
\[
5, 19, 77, 313, 1277, 5215, 21305, 87049,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 5*a(n-1) -3*a(n-2) -3*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 04 2025 00:05:23, revision 12) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A228678.
