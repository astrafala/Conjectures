...
\title{The empirical recurrence for OEIS A252367, recovered from its tail}
...
\begin{abstract}
OEIS A252367 records ``Empirical recurrence of order $71$'' and keeps the recurrence itself in
...
OEIS A252367 is ``Number of (n+2)X(6+2) 0..3 arrays with every 3X3 subblock row, column, diagonal and antidiagonal sum not equal to 1 3 4 6 or 7.''. It has offset $1$ and begins
\[
3188, 17340, 124538, 818040, 5340334, 35124242, 230366506, 1511215256,\ \dots
\]
The entry states:
\begin{quote}
Empirical recurrence of order 71 (see link above)
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:08:54, revision 8)
...
Applied to $2S'=258$ exact terms from $n=3$ on, it returns order $71$ --- the
...
\begin{theorem}
The recurrence above holds for every $n\ge74$, and it is the recurrence OEIS A252367 records.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252367.
