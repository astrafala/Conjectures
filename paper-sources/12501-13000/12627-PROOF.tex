...
\title{The empirical recurrence for OEIS A269001: recovering a conjecture that is not written down}
...
\begin{abstract}
OEIS A269001 records ``Empirical recurrence of order $68$'', with the recurrence itself in a
...
OEIS A269001 is ``Number of 7Xn binary arrays with some element plus some horizontally or antidiagonally adjacent neighbor totalling two not more than once.''. It has offset $1$ and begins
\[
128, 3272, 91491, 2144780, 49084071, 1073436321, 22995344760, 483176766982,\ \dots
\]
The entry states:
\begin{quote}
Empirical recurrence of order 68 (see link above)
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 17 2016 07:32:51, revision 4) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269001.
