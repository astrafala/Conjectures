...
\title{The empirical recurrence for OEIS A251344, proved by transfer matrix}
...
\begin{abstract}
OEIS A251344 counts $2$-column arrays over $\{0,\dots,2\}$ in which every
$2\times2$ subblock sums to one of $\{3, 4, 5\}$, and carries an empirical
...
OEIS A251344 is ``Number of (n+1) X (1+1) 0..2 arrays with every 2 X 2 subblock summing to 3 4 or 5.''. It has offset $1$
and begins
\[
51, 309, 1899, 11709, 72243, 445797, 2751003, 16976493,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 6*a(n-1) + 3*a(n-2) - 12*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 29 2018 10:37:04, revision 9) the statement is
...
\begin{itemize}
\item $r_j+r_{j+1}+s_j+s_{j+1}\in\{3, 4, 5\}$;
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251344.
