...
\title{A proof of the conjectured recurrence for OEIS A068551}
...
\begin{abstract}
OEIS A068551 carries a conjectured linear recurrence with polynomial coefficients, of
...
OEIS A068551 is ``a(n) = 4\^{}n - binomial(2*n,n)''. It has offset $0$ and begins
\[
a(0),\dots,a(7)\;=\;0, 2, 10, 44, 186, 772, 3172, 12952,\ \dots
\]
The entry gives the generating function
\begin{equation}\label{eq:gf}
A(x)\;=\;\sum_{n\ge 0} a(n)\,x^{n}\;=\;\frac{\sqrt{1 - 4 x} - 1}{4 x - 1} ,
\end{equation}
and it carries the following comment:
\begin{quote}\small
\textbf{Conjecture:} n*a(n) + 2*(3-4*n)*a(n-1) + 8*(2*n-3)*a(n-2) = 0. - \emph{R. J. Mathar}, Apr 01 2012
\end{quote}
As of the ``Last modified'' line on the live entry (2026-05-30, revision 88) the
...
\section{The computation for A068551}
...
section of A068551, agreeing on all 13 terms compared.
...
vanish, for all 22 values of $n$ from $n=2$ upward. This is what
...
\url{https://oeis.org}, 2026. Sequence A068551.
