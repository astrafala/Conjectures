...
\title{The empirical recurrence for OEIS A208160, proved by transfer matrix}
...
\begin{abstract}
OEIS A208160 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
$(0,0,0), (1,0,1)$ along one axis and $(0,0,1), (0,1,0)$ along the other, and carries an empirical recurrence of
...
OEIS A208160 is ``Number of nX4 0..1 arrays avoiding 0 0 0 and 1 0 1 horizontally and 0 0 1 and 0 1 0 vertically.''. It has offset
$1$ and begins
\[
9, 81, 281, 981, 3893, 13825, 46611,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:40:36, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) - 7\,a(n-2) + 26\,a(n-3) - 87\,a(n-4) + 51\,a(n-5) - 163\,a(n-6) + 536\,a(n-7) + 125\,a(n-8) + 462\,a(n-9) - 1927\,a(n-10) - 1705\,a(n-11) - 1375\,a(n-12) + 4932\,a(n-13) + 5862\,a(n-14) + 3665\,a(n-15) - 7873\,a(n-16) - 11151\,a(n-17) - 6258\,a(n-18) + 7798\,a(n-19) + 11789\,a(n-20) + 6835\,a(n-21) - 4479\,a(n-22) - 7296\,a(n-23) - 4064\,a(n-24) + 1214\,a(n-25) + 2388\,a(n-26) + 1296\,a(n-27) - 138\,a(n-28) - 312\,a(n-29) - 136\,a(n-30) - 12\,a(n-31) + 8\,a(n-32) - 8\,a(n-33)
\end{equation}
for all $n>33$. 
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208160.
