...
\title{The empirical recurrence for OEIS A297598, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297598 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A297598 is ``Number of 5Xn 0..1 arrays with every 1 horizontally, diagonally or antidiagonally adjacent to 1 or 5 neighboring 1s.''. It has offset $1$ and begins
\[
1, 41, 205, 577, 3747, 23066, 103673, 514290,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 01 2018 12:10:44, revision 4) the statement is
...
the middle column. The vector $w$ was formed by $26$ applications of $G$ in exact integer
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297598.
