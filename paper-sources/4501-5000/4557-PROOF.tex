...
\title{The empirical recurrence for OEIS A299933, proved by transfer matrix}
...
\begin{abstract}
OEIS A299933 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $equal to$ itself lying in $\{1,2,3,4,5,7,8\}$, and it carries an empirical
recurrence of order $33$ contributed by R.~H.~Hardin. It is true. The neighbourhood
...
OEIS A299933 is ``Number of nX4 0..1 arrays with every element equal to 1, 2, 3, 4, 5, 7 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
2, 64, 902, 11212, 144072, 1858165, 23924290, 308062375,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 22 2018 07:17:39, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;14\,a(n-1) - 10\,a(n-2) - 49\,a(n-3) - 101\,a(n-4) - 86\,a(n-5) - 334\,a(n-6) + 948\,a(n-7) + 1849\,a(n-8) + 322\,a(n-9) + 6856\,a(n-10) + 14322\,a(n-11) + 17947\,a(n-12) - 60181\,a(n-13) - 1521\,a(n-14) + 121363\,a(n-15) + 54529\,a(n-16) - 112699\,a(n-17) - 165594\,a(n-18) + 17437\,a(n-19) + 121385\,a(n-20) - 7107\,a(n-21) - 29057\,a(n-22) - 1422\,a(n-23) - 28011\,a(n-24) - 28909\,a(n-25) - 7393\,a(n-26) + 3074\,a(n-27) - 412\,a(n-28) - 822\,a(n-29) - 51\,a(n-30) + 137\,a(n-31) + 83\,a(n-32) + 14\,a(n-33)
\end{equation}
for all $n>34$.
...
has score in $\{1,2,3,4,5,7,8\}$. The entry also fixes the top-left entry to be $0$; that is a condition on the first row alone, so it restricts the start vector and nothing else.
...
\begin{itemize}
\item $\mathbf{s}(r,s)=1$ when every cell of $r$ has score in $\{1,2,3,4,5,7,8\}$ \emph{with no row
above $r$} and $r_1=0$, and $0$ otherwise;
\item an edge $(r,s)\to(s,t)$ when every cell of $s$ has score in $\{1,2,3,4,5,7,8\}$ computed from
$r$, $s$ and $t$;
\item $\mathbf{e}(r,s)=1$ when every cell of $s$ has score in $\{1,2,3,4,5,7,8\}$ \emph{with no row
...
exactly when every one of its $n$ rows has all scores in $\{1,2,3,4,5,7,8\}$. Read the sequence as the
...
$a(n)-\sum_i c_i a(n-i)=u_{\,n-2-33}$ whenever $n-33\ge2$. So \eqref{eq:conj}
holds for every $n>t$ exactly when $u_j=0$ for all $j>t-2-33$. Moreover $(u_j)$
...
\begin{proof}
Substituting Lemma~\ref{lem:walk} and factoring $P^{\,n-2-33}$ out of
...
\begin{proof}
The vector $q(P)\mathbf{e}\in\mathbb{Z}^{S}$ was formed by $33$ matrix--vector
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A299933.
