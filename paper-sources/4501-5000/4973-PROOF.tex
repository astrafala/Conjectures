...
\title{The empirical recurrence for OEIS A184379, proved by transfer matrix}
...
\begin{abstract}
OEIS A184379 counts arrays of width $4$ over $\{0,1,2\}$ in which every $3\times3$ subblock
...
OEIS A184379 is ``1/12 the number of (n+2) X 4 0..2 arrays with each 3 X 3 subblock containing three of each value.''. It has offset $1$ and begins
\[
545, 1494, 4281, 13616, 55386, 242370, 1165496, 6248040,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 01 2025 04:29:26, revision 12) this is still
...
\begin{theorem}
\[
a(n)\;=\;12\,a(n-1) - 47\,a(n-2) + 184\,a(n-3) - 1380\,a(n-4) + 5264\,a(n-5) - 12447\,a(n-6) + 56628\,a(n-7) - 206001\,a(n-8) + 396180\,a(n-9) - 1125036\,a(n-10) + 3788388\,a(n-11) - 6578172\,a(n-12) + 12197952\,a(n-13) - 36410148\,a(n-14) + 59740416\,a(n-15) - 75446640\,a(n-16) + 186268896\,a(n-17) - 295472448\,a(n-18) + 264166272\,a(n-19) - 475844544\,a(n-20) + 739031040\,a(n-21) - 485409024\,a(n-22) + 473651712\,a(n-23) - 725594112\,a(n-24) + 362797056\,a(n-25)
\]
for every $n>25$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A184379.
