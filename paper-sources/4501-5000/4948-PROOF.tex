...
\title{The empirical recurrence for OEIS A303959, proved by transfer matrix}
...
\begin{abstract}
OEIS A303959 counts $6$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A303959 is ``Number of nX6 0..1 arrays with every element unequal to 0, 1, 2 or 5 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
32, 45, 119, 452, 1431, 4645, 14067, 44800,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 03 2018 12:45:47, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 4\,a(n-2) - 4\,a(n-3) + 29\,a(n-4) - 23\,a(n-5) - 117\,a(n-6) + 69\,a(n-7) - 146\,a(n-8) - 43\,a(n-9) + 837\,a(n-10) - 263\,a(n-11) - 495\,a(n-12) + 796\,a(n-13) - 726\,a(n-14) - 281\,a(n-15) + 713\,a(n-16) - 607\,a(n-17) + 276\,a(n-18) + 37\,a(n-19) - 367\,a(n-20) + 479\,a(n-21) - 247\,a(n-22) - 63\,a(n-23) + 259\,a(n-24) - 142\,a(n-25) + 3\,a(n-26) + 36\,a(n-27) - 33\,a(n-28) + 10\,a(n-29) + 2\,a(n-30) - 3\,a(n-31) + a(n-32)
\end{equation}
for all $n>38$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A303959.
