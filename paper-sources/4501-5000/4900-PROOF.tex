...
\title{The empirical recurrence for OEIS A188994, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A188994 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A188994 is ``Number of 4 X n binary arrays without the pattern 0 0 1 antidiagonally or horizontally.''. It has offset $1$ and begins
\[
16, 256, 1793, 10812, 68064, 423606, 2613530, 16035624,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 21 2025 15:21:27, revision 7) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A188994.
