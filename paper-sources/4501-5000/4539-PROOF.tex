...
\title{The empirical recurrence for OEIS A259741, proved by transfer matrix}
...
\begin{abstract}
OEIS A259741 counts $(n+2)\times9$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A259741 is ``Number of (n+2) X (7+2) 0..1 arrays with each 3 X 3 subblock having clockwise perimeter pattern 00010101 or 01010101.''. It has offset $1$ and begins
\[
265, 760, 3480, 10570, 35036, 110886, 416107, 1244504,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 17 2023 12:28:25, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-2) + 72\,a(n-4) + 126\,a(n-6) - 506\,a(n-8) - 177\,a(n-10) + 2157\,a(n-12) - 663\,a(n-14) - 6554\,a(n-16) + 8949\,a(n-18) - 1807\,a(n-20) - 4122\,a(n-22) + 1182\,a(n-24) + 500\,a(n-26) + 261\,a(n-28) + 111\,a(n-30) - 10\,a(n-32) + 10\,a(n-34)
\]
for every $n>37$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A259741.
