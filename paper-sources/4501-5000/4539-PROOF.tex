...
\title{A condition on each element and its neighbours: OEIS A297657}
...
\begin{abstract}
OEIS A297657 carries an empirical recurrence of order $38$ contributed by R.~H.~Hardin. It is
...
walks in it. Hence $a(n)$ is a walk count on $S=59$ vertices and is $C$-finite, and whether the
...
OEIS A297657 is ``Number of 4 X n 0..1 arrays with every 1 horizontally, diagonally or antidiagonally adjacent to 1, 2 or 3 neighboring 1's.''. It has offset $1$ and begins
\[
1, 126, 1421, 11024, 131044, 1580681, 16899640, 184447765,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 04 2024 11:42:18, revision 6) this is still
...
Vertices with identical futures are merged, which leaves $S=59$. An admissible array is exactly a walk, so with $M$ the adjacency matrix and $\iota,\tau$ the vectors recording which states may begin and end an array,
\[
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) + 15\,a(n-2) + 372\,a(n-3) + 1025\,a(n-4) - 46\,a(n-5) - 4101\,a(n-6) - 34244\,a(n-7) - 94085\,a(n-8) - 21654\,a(n-9) + 165356\,a(n-10) + 639904\,a(n-11) + 1471523\,a(n-12) - 895908\,a(n-13) - 4864047\,a(n-14) - 1270214\,a(n-15) + 3721117\,a(n-16) + 3725224\,a(n-17) + 1517589\,a(n-18) - 2895666\,a(n-19) + 611461\,a(n-20) - 1569477\,a(n-21) - 5436112\,a(n-22) + 6015995\,a(n-23) - 1131454\,a(n-24) - 3262066\,a(n-25) + 5806854\,a(n-26) - 3112355\,a(n-27) - 927930\,a(n-28) + 2386399\,a(n-29) - 1228290\,a(n-30) - 18124\,a(n-31) + 313018\,a(n-32) - 154300\,a(n-33) + 36726\,a(n-34) + 142\,a(n-35) - 2108\,a(n-36) + 652\,a(n-37) + 4\,a(n-38)
\]
for every $n>38$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297657.
