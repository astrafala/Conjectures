...
\title{The empirical recurrence for OEIS A257358, proved by transfer matrix}
...
\begin{abstract}
OEIS A257358 counts arrays of width $7$ over $\{0,1\}$ in which every $3\times3$ window has
...
OEIS A257358 is ``Number of (n+2)X(5+2) 0..1 arrays with no 3x3 subblock diagonal sum equal to the antidiagonal sum or central row sum less than the central column sum.''. It has offset $1$ and begins
\[
45684, 53824, 112236, 246016, 482560, 1196836, 2980712, 6240004,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 15:21:53, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A257358.
