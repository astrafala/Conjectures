...
\title{The empirical recurrence for OEIS A261111, proved by transfer matrix}
...
\begin{abstract}
OEIS A261111 counts $(n+2)\times8$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A261111 is ``Number of (n+2)X(6+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00010001 00010101 or 01010101.''. It has offset $1$ and begins
\[
289, 790, 2902, 10268, 35934, 127038, 449132, 1582692,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 12:14:13, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) - 2\,a(n-2) + 17\,a(n-3) + 16\,a(n-4) + 45\,a(n-5) + 44\,a(n-6) + a(n-7) - 14\,a(n-8) - 72\,a(n-9) - 126\,a(n-10) - 168\,a(n-11) + 14\,a(n-12) + 436\,a(n-13) + 288\,a(n-14) - 354\,a(n-15) - 316\,a(n-16) + 132\,a(n-17) + 181\,a(n-18) - 2\,a(n-19) - 53\,a(n-20) - 25\,a(n-21) - 3\,a(n-22) + a(n-23) + 5\,a(n-24) + 2\,a(n-25) + a(n-26) + a(n-27)
\]
for every $n>28$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A261111.
