...
\title{The empirical recurrence for OEIS A236822, proved by transfer matrix}
...
\begin{abstract}
OEIS A236822 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
The condition is local to two consecutive rows, so the count is a walk count on $S=65$
...
OEIS A236822 is ``Number of (n+1)X(2+1) 0..2 arrays with the maximum plus the minimum minus the lower median of every 2X2 subblock equal.''. It has offset $1$ and begins
\[
327, 2211, 15254, 109205, 786609, 5747502, 42215123, 312592339,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 09:36:04, revision 6) this is still
...
array, which is not among the objects counted. There are $S=65$ states left.
...
\begin{theorem}
\[
a(n)\;=\;20\,a(n-1) - 74\,a(n-2) - 950\,a(n-3) + 7675\,a(n-4) + 5902\,a(n-5) - 208583\,a(n-6) + 358712\,a(n-7) + 2437168\,a(n-8) - 8245218\,a(n-9) - 11507689\,a(n-10) + 77981588\,a(n-11) - 13353740\,a(n-12) - 390127858\,a(n-13) + 398463912\,a(n-14) + 1060576100\,a(n-15) - 1911844548\,a(n-16) - 1338399672\,a(n-17) + 4592202520\,a(n-18) - 205399632\,a(n-19) - 6115028512\,a(n-20) + 2874814400\,a(n-21) + 4321062784\,a(n-22) - 3582260416\,a(n-23) - 1253904064\,a(n-24) + 1886965760\,a(n-25) - 92450688\,a(n-26) - 394737408\,a(n-27) + 90316800\,a(n-28) + 17190912\,a(n-29) - 4915200\,a(n-30)
\]
for every $n>30$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A236822.
