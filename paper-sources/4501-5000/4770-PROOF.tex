...
\title{The empirical recurrence for OEIS A204973, proved by transfer matrix}
...
\begin{abstract}
OEIS A204973 counts arrays of width $3$ over $\{0,1,2\}$ containing no run of $3$ consecutive
cells, taken along a named direction of the grid, whose entries are all equal. The entry carries
an empirical recurrence of order $27$ contributed by R.~H.~Hardin. It is true, and it is
...
OEIS A204973 is ``Number of nX3 0..2 arrays with no occurrence of three equal elements in a row horizontally, vertically, diagonally or antidiagonally, and new values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
4, 96, 1217, 16813, 226908, 3074889, 41618941, 563504926,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 11:39:29, revision 10) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204973.
