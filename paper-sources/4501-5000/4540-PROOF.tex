...
\title{The empirical recurrence for OEIS A252124, proved by transfer matrix}
...
\begin{abstract}
OEIS A252124 counts $(n+2)\times4$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252124 is ``Number of (n+2)X(2+2) 0..3 arrays with every 3X3 subblock row and column sum not equal to 0 3 4 6 or 7 and every 3X3 diagonal and antidiagonal sum equal to 0 3 4 6 or 7.''. It has offset $1$ and begins
\[
634, 1732, 5622, 10379, 34891, 120600, 218388, 776527,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 10:49:14, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 73\,a(n-3) - 73\,a(n-4) - 2065\,a(n-6) + 2065\,a(n-7) + 29083\,a(n-9) - 29083\,a(n-10) - 218284\,a(n-12) + 218284\,a(n-13) + 853720\,a(n-15) - 853720\,a(n-16) - 1434309\,a(n-18) + 1434309\,a(n-19) - 512391\,a(n-21) + 512391\,a(n-22) + 5300937\,a(n-24) - 5300937\,a(n-25) - 6791661\,a(n-27) + 6791661\,a(n-28) + 3067146\,a(n-30) - 3067146\,a(n-31) - 437400\,a(n-33) + 437400\,a(n-34)
\]
for every $n>37$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252124.
