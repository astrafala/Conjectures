...
\title{The empirical recurrence for OEIS A197532, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A197532 counts arrays over $\{0,\dots,4\}$ in which every cell is constrained by the
...
OEIS A197532 is ``Number of nX3 0..4 arrays with each element x equal to the number its horizontal and vertical neighbors equal to 2,0,1,0,0 for x=0,1,2,3,4.''. It has offset $1$ and begins
\[
4, 16, 56, 216, 868, 3500, 14085, 56842,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 07:17:53, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) + 5\,a(n-2) - 15\,a(n-3) - 21\,a(n-4) + 3\,a(n-5) + 28\,a(n-6) + 32\,a(n-7) - 5\,a(n-8) - 57\,a(n-9) + 10\,a(n-10) + 90\,a(n-11) + 44\,a(n-12) - 14\,a(n-13) - 101\,a(n-14) - 56\,a(n-15) + 46\,a(n-16) + 14\,a(n-17) + 11\,a(n-18) - 20\,a(n-19) + 9\,a(n-20) + 10\,a(n-21) - 9\,a(n-22) - a(n-25)
\end{equation}
for all $n>26$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A197532.
