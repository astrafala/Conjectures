...
\title{The empirical recurrence for OEIS A283490, proved by transfer matrix}
...
\begin{abstract}
OEIS A283490 counts $n\times4$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
walk, and $a(n)$ is a walk count on $S=500$ vertices, which is $C$-finite. Whether the
...
OEIS A283490 is ``Number of nX4 0..1 arrays with no 1 equal to more than three of its horizontal, vertical and antidiagonal neighbors, with the exception of exactly one element.''. It has offset $1$ and begins
\[
0, 12, 576, 10000, 174232, 2836520, 44556288, 682531252,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 08 2017 14:12:56, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;16\,a(n-1) + 52\,a(n-2) - 654\,a(n-3) - 5302\,a(n-4) - 17804\,a(n-5) - 34717\,a(n-6) - 39544\,a(n-7) - 19349\,a(n-8) + 12798\,a(n-9) + 21900\,a(n-10) + 25134\,a(n-11) - 8508\,a(n-12) + 27210\,a(n-13) - 49683\,a(n-14) + 51034\,a(n-15) - 55534\,a(n-16) + 47912\,a(n-17) - 34845\,a(n-18) + 22796\,a(n-19) - 12555\,a(n-20) + 5822\,a(n-21) - 2280\,a(n-22) + 694\,a(n-23) - 145\,a(n-24) + 18\,a(n-25) - a(n-26)
\]
for every $n>29$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A283490.
