...
\title{The empirical recurrence for OEIS A305248, proved by transfer matrix}
...
\begin{abstract}
OEIS A305248 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A305248 is ``Number of nX4 0..1 arrays with every element unequal to 0, 1, 3, 4 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
5, 17, 17, 42, 79, 163, 356, 794,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 28 2018 08:48:32, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) - 4\,a(n-2) + 2\,a(n-3) + a(n-4) - 23\,a(n-5) + 32\,a(n-6) - 28\,a(n-7) + 37\,a(n-8) - 21\,a(n-9) + a(n-10) + 88\,a(n-11) - 93\,a(n-12) + 99\,a(n-13) - 13\,a(n-14) - 120\,a(n-15) - 149\,a(n-16) + 30\,a(n-17) + 36\,a(n-18) - 137\,a(n-19) + 117\,a(n-20) + 45\,a(n-21) + 25\,a(n-22) + 51\,a(n-23) + 30\,a(n-24) - 4\,a(n-25) - 5\,a(n-26)
\end{equation}
for all $n>30$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A305248.
