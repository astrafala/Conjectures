...
\title{The empirical recurrence for OEIS A207952, proved by transfer matrix}
...
\begin{abstract}
OEIS A207952 counts arrays over $\{0,\dots,1\}$ of width $6$ that avoid the patterns
...
OEIS A207952 is ``Number of 6Xn 0..1 arrays avoiding 0 0 1 and 0 1 1 horizontally and 0 1 0 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
26, 676, 4238, 26569, 98126, 362404, 1007146,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:31:02, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207952.
