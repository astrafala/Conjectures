...
\title{The empirical recurrence for OEIS A261377, proved by transfer matrix}
...
\begin{abstract}
OEIS A261377 counts $(n+2)\times7$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A261377 is ``Number of (n+2)X(5+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00001011 00010101 or 01010101.''. It has offset $1$ and begins
\[
154, 266, 869, 2282, 5633, 14312, 39494, 99168,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 17 2015 08:30:55, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;31\,a(n-4) + 97\,a(n-6) + 39\,a(n-8) - 144\,a(n-10) - 29\,a(n-12) + 189\,a(n-14) - 125\,a(n-16) - 14\,a(n-18) + 40\,a(n-20) - 13\,a(n-22) - a(n-24) + a(n-26)
\]
for every $n>29$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A261377.
