...
\title{The empirical recurrence for OEIS A282476, proved by transfer matrix}
...
\begin{abstract}
OEIS A282476 counts $n\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A282476 is ``Number of nX3 0..1 arrays with no 1 equal to more than three of its king-move neighbors, with the exception of exactly two elements.''. It has offset $1$ and begins
\[
0, 5, 40, 483, 4328, 36425, 297210, 2327123,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 16 2017 09:57:39, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;15\,a(n-1) - 60\,a(n-2) + 38\,a(n-3) - 417\,a(n-4) + 2211\,a(n-5) + 254\,a(n-6) + 9714\,a(n-7) - 19866\,a(n-8) + 11292\,a(n-9) - 83508\,a(n-10) + 94758\,a(n-11) - 162290\,a(n-12) + 333372\,a(n-13) - 354804\,a(n-14) + 698218\,a(n-15) - 723297\,a(n-16) + 960537\,a(n-17) - 1190332\,a(n-18) + 1011360\,a(n-19) - 1264665\,a(n-20) + 756661\,a(n-21) - 868110\,a(n-22) + 386904\,a(n-23) - 278456\,a(n-24) + 47328\,a(n-25) - 2976\,a(n-26) + 64\,a(n-27)
\]
for every $n>27$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A282476.
