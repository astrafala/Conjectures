...
\title{The empirical recurrence for OEIS A254982, proved by transfer matrix}
...
\begin{abstract}
OEIS A254982 counts the arrays over $\{0,\dots,1\}$ whose $3\times3$ subblocks carry a
...
OEIS A254982 is ``Number of (n+2)X(1+2) 0..1 arrays with every 3X3 subblock sum of the two medians of the diagonal and antidiagonal minus the sum of the minimums of the central row and column nondecreasing horizontally and vertically.''. It has offset $1$ and begins
\[
512, 2642, 10285, 39891, 160753, 639228, 2462249, 9299264,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 15:03:41, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-1) - 17\,a(n-2) + 26\,a(n-3) - 12\,a(n-4) - 92\,a(n-5) + 89\,a(n-6) - 116\,a(n-7) - 121\,a(n-8) + 727\,a(n-9) + 341\,a(n-10) + 262\,a(n-11) + 1668\,a(n-12) - 1380\,a(n-13) - 791\,a(n-14) - 5504\,a(n-15) - 1622\,a(n-16) - 1160\,a(n-17) - 1450\,a(n-18) + 18620\,a(n-19) - 316\,a(n-20) + 1254\,a(n-21) - 27288\,a(n-22) + 3524\,a(n-23) + 42952\,a(n-24) - 9576\,a(n-25) - 34248\,a(n-26) + 8272\,a(n-27) + 11264\,a(n-28) - 15296\,a(n-29) + 7200\,a(n-30) + 3168\,a(n-31) - 384\,a(n-33)
\]
for every $n>38$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A254982.
