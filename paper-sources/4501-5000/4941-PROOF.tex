...
\title{The empirical recurrence for OEIS A261262, proved by transfer matrix}
...
\begin{abstract}
OEIS A261262 counts $(n+2)\times7$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A261262 is ``Number of (n+2)X(5+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00010101 00100101 or 01010101.''. It has offset $1$ and begins
\[
321, 418, 1483, 4350, 11733, 28540, 85617, 217484,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 13 2015 06:37:47, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-2) + 26\,a(n-4) + a(n-5) + 42\,a(n-6) - 2\,a(n-7) + 7\,a(n-8) - 8\,a(n-9) - 52\,a(n-10) + 13\,a(n-11) - 40\,a(n-12) - 25\,a(n-13) + 33\,a(n-14) - 14\,a(n-15) + 11\,a(n-16) + 17\,a(n-17) + 14\,a(n-18) - 7\,a(n-19) - 14\,a(n-20) + 12\,a(n-21) - 10\,a(n-23) + 4\,a(n-25)
\]
for every $n>28$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A261262.
