...
\title{The empirical recurrence for OEIS A238140, proved by transfer matrix}
...
\begin{abstract}
OEIS A238140 counts arrays over $\{0,\dots,3\}$ subject to a condition on the order
...
OEIS A238140 is ``Number of (n+1)X(1+1) 0..3 arrays with the maximum plus the lower median minus the minimum of every 2X2 subblock differing from its horizontal and vertical neighbors by exactly one.''. It has offset $1$ and begins
\[
256, 1810, 12981, 94458, 687254, 4977790, 36125717, 262009080,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 10:46:34, revision 7) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The $2\times2$ subblocks of an $(n+1)\times2$ array form an
$n\times1$ grid, and each carries the value $\sigma=-a+b+d$, where $a\le b\le c\le d$ are its four entries sorted --- its minimum, lower median, upper median and maximum. The entry asks that the values of
...
\begin{theorem}
\[
a(n)\;=\;1808\,a(n-4) + 44640\,a(n-6) + 335068\,a(n-8) - 484208\,a(n-10) - 15068144\,a(n-12) - 32087616\,a(n-14) + 167504512\,a(n-16) + 586957568\,a(n-18) - 435685376\,a(n-20) - 3412492288\,a(n-22) - 1807720448\,a(n-24) + 6958792704\,a(n-26) + 9003270144\,a(n-28) + 190054400\,a(n-30) - 3628072960\,a(n-32) - 1132462080\,a(n-34)
\]
for every $n>34$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A238140.
