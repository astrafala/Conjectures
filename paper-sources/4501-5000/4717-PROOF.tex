...
\title{The empirical recurrence for OEIS A220677, proved by transfer matrix}
...
\begin{abstract}
OEIS A220677 counts the ways of linking the cells of a grid $4$ cells wide, each cell either to
...
state, the count is a walk count on $S=60$ of them, and the conjectured recurrence is then
...
OEIS A220677 is ``Number of ways to reciprocally link elements of an nX4 array either to themselves or to exactly two horizontal, vertical and antidiagonal neighbors, without consecutive collinear links.''. It has offset $1$ and begins
\[
1, 25, 201, 2024, 21380, 220299, 2316754, 24198121,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 18:57:02, revision 8) this is still
...
one configuration. With $M$ the adjacency matrix of the digraph on the $S=60$ reachable
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A220677.
