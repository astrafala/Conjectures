...
\title{The empirical recurrence for OEIS A301949, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A301949 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A301949 is ``Number of nX6 0..1 arrays with every element equal to 1, 2 or 3 horizontally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
5, 169, 4070, 98839, 2406169, 58609226, 1427656268, 34776685046,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 29 2018 12:44:31, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;33\,a(n-1) - 194\,a(n-2) - 715\,a(n-3) + 7892\,a(n-4) - 2145\,a(n-5) - 104797\,a(n-6) + 126737\,a(n-7) + 639098\,a(n-8) - 780482\,a(n-9) - 2453736\,a(n-10) + 1736864\,a(n-11) + 5706799\,a(n-12) - 506462\,a(n-13) - 5848822\,a(n-14) - 644915\,a(n-15) + 3230474\,a(n-16) + 509931\,a(n-17) - 1056960\,a(n-18) - 144139\,a(n-19) + 202757\,a(n-20) + 17729\,a(n-21) - 20624\,a(n-22) - 825\,a(n-23) + 894\,a(n-24) + 25\,a(n-25) - 16\,a(n-26)
\end{equation}
for all $n>28$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A301949.
