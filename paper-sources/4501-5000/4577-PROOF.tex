...
\title{The empirical recurrence for OEIS A197202, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A197202 counts arrays over $\{0,\dots,4\}$ in which every cell is constrained by the
...
OEIS A197202 is ``Number of nX3 0..4 arrays with each element x equal to the number its horizontal and vertical neighbors equal to 4,2,1,0,3 for x=0,1,2,3,4.''. It has offset $1$ and begins
\[
2, 16, 100, 588, 3649, 22210, 135560, 827698,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 07:02:15, revision 9) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A197202.
