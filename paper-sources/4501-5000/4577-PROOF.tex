...
\title{The empirical recurrence for OEIS A250431, proved by transfer matrix}
...
\begin{abstract}
OEIS A250431 counts arrays over $\{0,1\}$ in which a statistic taken over short runs
...
OEIS A250431 is ``Number of (n+1)X(7+1) 0..1 arrays with nondecreasing sum of every two consecutive values in every row and column.''. It has offset $1$ and begins
\[
625, 5625, 50625, 275625, 1500625, 6002500, 24010000, 77792400,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 12:24:21, revision 10) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250431.
