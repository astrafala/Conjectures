...
\title{The empirical recurrence for OEIS A298997, proved by transfer matrix}
...
\begin{abstract}
OEIS A298997 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $equal to$ itself lying in $\{0,1,2,3,4,6\}$, and it carries an empirical
recurrence of order $37$ contributed by R.~H.~Hardin. It is true. The neighbourhood
...
OEIS A298997 is ``Number of nX4 0..1 arrays with every element equal to 0, 1, 2, 3, 4 or 6 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
8, 121, 1073, 10150, 97462, 932318, 8918662, 85379274,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 31 2018 09:03:02, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;9\,a(n-1) + 8\,a(n-2) + 38\,a(n-3) - 490\,a(n-4) - 1002\,a(n-5) - 1061\,a(n-6) + 8079\,a(n-7) + 23108\,a(n-8) + 19262\,a(n-9) - 30209\,a(n-10) - 172074\,a(n-11) - 127690\,a(n-12) - 120925\,a(n-13) + 524664\,a(n-14) + 337275\,a(n-15) + 702573\,a(n-16) - 827151\,a(n-17) - 958523\,a(n-18) - 1581927\,a(n-19) - 619058\,a(n-20) + 414995\,a(n-21) + 389515\,a(n-22) + 901857\,a(n-23) - 168659\,a(n-24) + 31470\,a(n-25) - 151466\,a(n-26) - 27657\,a(n-27) + 129562\,a(n-28) - 14754\,a(n-29) + 50563\,a(n-30) - 12466\,a(n-31) - 14531\,a(n-32) + 10488\,a(n-33) - 5321\,a(n-34) + 799\,a(n-35) - 120\,a(n-36) + 12\,a(n-37)
\end{equation}
for all $n>38$.
...
has score in $\{0,1,2,3,4,6\}$. The entry also fixes the top-left entry to be $0$; that is a condition on the first row alone, so it restricts the start vector and nothing else.
...
\begin{itemize}
\item $\mathbf{s}(r,s)=1$ when every cell of $r$ has score in $\{0,1,2,3,4,6\}$ \emph{with no row
above $r$} and $r_1=0$, and $0$ otherwise;
\item an edge $(r,s)\to(s,t)$ when every cell of $s$ has score in $\{0,1,2,3,4,6\}$ computed from
$r$, $s$ and $t$;
\item $\mathbf{e}(r,s)=1$ when every cell of $s$ has score in $\{0,1,2,3,4,6\}$ \emph{with no row
...
exactly when every one of its $n$ rows has all scores in $\{0,1,2,3,4,6\}$. Read the sequence as the
...
$a(n)-\sum_i c_i a(n-i)=u_{\,n-2-37}$ whenever $n-37\ge2$. So \eqref{eq:conj}
holds for every $n>t$ exactly when $u_j=0$ for all $j>t-2-37$. Moreover $(u_j)$
...
\begin{proof}
Substituting Lemma~\ref{lem:walk} and factoring $P^{\,n-2-37}$ out of
...
\begin{proof}
The vector $q(P)\mathbf{e}\in\mathbb{Z}^{S}$ was formed by $37$ matrix--vector
products in exact integer arithmetic and the $u_j$ evaluated against $\mathbf{s}$ in turn.
They vanish from the index corresponding to $n=38+1$ onwards, and the run was continued
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A298997.
