...
\title{The empirical recurrence for OEIS A232045, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A232045 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A232045 is ``Number of nX6 0..1 arrays with no element less than a strict majority of its horizontal and antidiagonal neighbors.''. It has offset $1$ and begins
\[
21, 184, 5364, 153562, 4588174, 136134243, 4041385884, 119990644449,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 06:49:59, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;21\,a(n-1) + 314\,a(n-2) - 1045\,a(n-3) - 19776\,a(n-4) + 25231\,a(n-5) + 515946\,a(n-6) - 435697\,a(n-7) - 6637658\,a(n-8) + 7103608\,a(n-9) + 30185726\,a(n-10) - 21604276\,a(n-11) - 75687442\,a(n-12) + 24802802\,a(n-13) + 110712267\,a(n-14) - 9086579\,a(n-15) - 102117142\,a(n-16) - 7051224\,a(n-17) + 60433119\,a(n-18) + 10059839\,a(n-19) - 21510561\,a(n-20) - 4142240\,a(n-21) + 4134848\,a(n-22) + 562752\,a(n-23) - 331776\,a(n-24)
\end{equation}
for all $n>26$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232045.
