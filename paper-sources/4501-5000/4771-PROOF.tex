...
\title{The empirical recurrence for OEIS A261708, proved by transfer matrix}
...
\begin{abstract}
OEIS A261708 counts $(n+2)\times7$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A261708 is ``Number of (n+2)X(5+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000001 00000101 or 00000111.''. It has offset $1$ and begins
\[
628, 892, 1168, 734, 676, 1818, 984, 748,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-7) -2*a(n-21) +a(n-28) for n>34
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 28 2015 20:12:53, revision 4) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A261708.
