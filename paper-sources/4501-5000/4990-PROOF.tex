...
\title{The empirical recurrence for OEIS A220722, proved by transfer matrix}
...
\begin{abstract}
OEIS A220722 counts the ways of linking the cells of a grid $5$ cells wide, each cell either to
...
OEIS A220722 is ``Number of ways to reciprocally link elements of an nX5 array either to themselves or to exactly two horizontal, diagonal or antidiagonal neighbors.''. It has offset $1$ and begins
\[
1, 68, 1819, 52189, 1485872, 42378036, 1208447287, 34459871148,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 19:00:09, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;24\,a(n-1) + 104\,a(n-2) + 571\,a(n-3) + 3582\,a(n-4) + 7794\,a(n-5) + 4788\,a(n-6) - 16926\,a(n-7) - 90288\,a(n-8) - 168845\,a(n-9) - 84443\,a(n-10) + 109179\,a(n-11) + 193126\,a(n-12) + 248993\,a(n-13) + 425415\,a(n-14) + 384428\,a(n-15) + 353459\,a(n-16) + 31964\,a(n-17) - 136170\,a(n-18) - 85703\,a(n-19) - 29195\,a(n-20) + 14155\,a(n-21) + 6903\,a(n-22) + 243\,a(n-23) - 252\,a(n-24) - 25\,a(n-25)
\]
for every $n>24$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A220722.
