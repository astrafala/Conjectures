...
\title{The empirical recurrence for OEIS A256765, proved by transfer matrix}
...
\begin{abstract}
OEIS A256765 counts arrays of width $4$ over $\{0,1\}$ in which every $3\times3$ window has
...
OEIS A256765 is ``Number of (n+2)X(2+2) 0..1 arrays with no 3x3 subblock diagonal sum less than the antidiagonal sum.''. It has offset $1$ and begins
\[
1936, 14641, 81796, 456976, 2196324, 10556001, 46785600, 207360000,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 15:14:05, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) + 30\,a(n-2) - 230\,a(n-3) - 312\,a(n-4) + 3822\,a(n-5) + 534\,a(n-6) - 36354\,a(n-7) + 17505\,a(n-8) + 220020\,a(n-9) - 193524\,a(n-10) - 889056\,a(n-11) + 1056104\,a(n-12) + 2438976\,a(n-13) - 3613728\,a(n-14) - 4492832\,a(n-15) + 8271888\,a(n-16) + 5259072\,a(n-17) - 12868032\,a(n-18) - 3211008\,a(n-19) + 13425408\,a(n-20) - 181248\,a(n-21) - 8979456\,a(n-22) + 1806336\,a(n-23) + 3473408\,a(n-24) - 1179648\,a(n-25) - 589824\,a(n-26) + 262144\,a(n-27)
\]
for every $n>24$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A256765.
