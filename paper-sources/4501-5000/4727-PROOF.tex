...
\title{The empirical recurrence for OEIS A260243, proved by transfer matrix}
...
\begin{abstract}
OEIS A260243 counts $(n+2)\times5$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A260243 is ``Number of (n+2)X(3+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000001 00000101 or 00001001.''. It has offset $1$ and begins
\[
256, 551, 1476, 3287, 8242, 22944, 56634, 134576,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 12:03:43, revision 6) this is still
...
\[
\text{the clockwise perimeter word of }g\text{ is a rotation of one of }\{00000001,\ 00000101,\ 00001001\}
\]
...
\begin{theorem}
\[
a(n)\;=\;15\,a(n-3) + 20\,a(n-4) - 54\,a(n-6) - 128\,a(n-7) - 62\,a(n-8) - 12\,a(n-9) + 50\,a(n-10) + 335\,a(n-11) + 445\,a(n-12) + 138\,a(n-13) - 249\,a(n-14) - 161\,a(n-15) + 145\,a(n-16) - 398\,a(n-17) - 519\,a(n-18) + 118\,a(n-19) - 4\,a(n-20) - 60\,a(n-21) + 2\,a(n-22) + 16\,a(n-23) + 12\,a(n-24) - 36\,a(n-25) + 32\,a(n-26) + 8\,a(n-27) - 8\,a(n-28) + 8\,a(n-29)
\]
for every $n>30$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A260243.
