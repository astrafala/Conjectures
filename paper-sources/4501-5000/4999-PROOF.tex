...
\title{The empirical recurrence for OEIS A302208, proved by transfer matrix}
...
\begin{abstract}
OEIS A302208 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
recurrence of order $28$ contributed by R.~H.~Hardin. It is true. The neighbourhood
...
OEIS A302208 is ``Number of nX4 0..1 arrays with every element equal to 0, 2 or 3 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 13, 5, 7, 18, 55, 172, 575,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 03 2018 11:59:05, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) - 3\,a(n-2) + 12\,a(n-3) - 21\,a(n-4) - 18\,a(n-5) - 16\,a(n-6) + 14\,a(n-7) + 21\,a(n-8) + 37\,a(n-9) - 6\,a(n-10) + 25\,a(n-11) + 62\,a(n-12) - 20\,a(n-13) - 7\,a(n-14) - 75\,a(n-15) - 76\,a(n-16) - 51\,a(n-17) + 57\,a(n-18) + 43\,a(n-19) + 35\,a(n-20) + 30\,a(n-21) - 35\,a(n-22) - 27\,a(n-23) + 10\,a(n-24) + 2\,a(n-25) + 6\,a(n-26) - 2\,a(n-28)
\end{equation}
for all $n>32$.
...
$a(n)-\sum_i c_i a(n-i)=u_{\,n-2-28}$ whenever $n-28\ge2$. So \eqref{eq:conj}
holds for every $n>t$ exactly when $u_j=0$ for all $j>t-2-28$. Moreover $(u_j)$
...
\begin{proof}
Substituting Lemma~\ref{lem:walk} and factoring $P^{\,n-2-28}$ out of
...
\begin{proof}
The vector $q(P)\mathbf{e}\in\mathbb{Z}^{S}$ was formed by $28$ matrix--vector
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302208.
