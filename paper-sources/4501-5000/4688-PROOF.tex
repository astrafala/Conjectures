...
\title{The empirical recurrence for OEIS A261552, proved by transfer matrix}
...
\begin{abstract}
OEIS A261552 counts $(n+2)\times7$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A261552 is ``Number of (n+2)X(5+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000001 00000101 or 00001011.''. It has offset $1$ and begins
\[
652, 871, 1210, 816, 656, 1273, 1084, 855,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-7) -2*a(n-21) +a(n-28) for n>34
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 24 2015 11:00:49, revision 4) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A261552.
