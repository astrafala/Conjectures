...
\title{The empirical recurrence for OEIS A252673, proved by transfer matrix}
...
\begin{abstract}
OEIS A252673 counts $(n+2)\times4$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252673 is ``Number of (n+2) X (2+2) 0..3 arrays with every 3 X 3 subblock row and diagonal sum equal to 0, 2, 5, 6 or 7 and every 3 X 3 column and antidiagonal sum not equal to 0, 2, 5, 6 or 7.''. It has offset $1$ and begins
\[
775, 630, 991, 1677, 3573, 7164, 13494, 30552,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 18 2021 17:03:31, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;22\,a(n-3) - 178\,a(n-6) + 713\,a(n-9) - 1673\,a(n-12) + 2744\,a(n-15) - 3188\,a(n-18) + 2096\,a(n-21) - 668\,a(n-24) + 103\,a(n-27) + 38\,a(n-30) - 8\,a(n-33)
\]
for every $n>37$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252673.
