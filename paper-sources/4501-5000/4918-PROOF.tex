...
\title{The empirical recurrence for OEIS A299651, proved by transfer matrix}
...
\begin{abstract}
OEIS A299651 counts $5$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $equal to$ itself lying in $\{0,1,2,3,4,5,6\}$, and it carries an empirical
...
OEIS A299651 is ``Number of n X 5 0..1 arrays with every element equal to 0, 1, 2, 3, 4, 5 or 6 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
16, 512, 14981, 448993, 13431706, 401989538, 12030404350, 360039414559,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 15 2026 14:54:11, revision
6) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;25\,a(n-1) + 125\,a(n-2) + 679\,a(n-3) + 248\,a(n-4) - 12105\,a(n-5) - 34335\,a(n-6) - 131485\,a(n-7) + 98396\,a(n-8) + 444773\,a(n-9) + 1528691\,a(n-10) + 120695\,a(n-11) - 1628382\,a(n-12) - 7147705\,a(n-13) - 5406767\,a(n-14) - 1469117\,a(n-15) + 21686910\,a(n-16) + 26174174\,a(n-17) + 12379712\,a(n-18) - 42253252\,a(n-19) - 49440333\,a(n-20) - 12271694\,a(n-21) + 46804842\,a(n-22) + 37422506\,a(n-23) - 492636\,a(n-24) - 22290578\,a(n-25) - 11763494\,a(n-26) + 2197936\,a(n-27) + 4276248\,a(n-28) + 1359552\,a(n-29) - 435456\,a(n-30) - 235008\,a(n-31)
\end{equation}
for all $n>31$.
...
has score in $\{0,1,2,3,4,5,6\}$. The entry also fixes the top-left entry to be $0$; that is a condition on the first row alone, so it restricts the start vector and nothing else.
...
\begin{itemize}
\item $\mathbf{s}(r,s)=1$ when every cell of $r$ has score in $\{0,1,2,3,4,5,6\}$ \emph{with no row
above $r$} and $r_1=0$, and $0$ otherwise;
\item an edge $(r,s)\to(s,t)$ when every cell of $s$ has score in $\{0,1,2,3,4,5,6\}$ computed from
$r$, $s$ and $t$;
\item $\mathbf{e}(r,s)=1$ when every cell of $s$ has score in $\{0,1,2,3,4,5,6\}$ \emph{with no row
...
exactly when every one of its $n$ rows has all scores in $\{0,1,2,3,4,5,6\}$. Read the sequence as the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A299651.
