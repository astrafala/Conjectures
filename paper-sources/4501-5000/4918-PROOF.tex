...
\title{The empirical recurrence for OEIS A252434, proved by transfer matrix}
...
\begin{abstract}
OEIS A252434 counts $3\times(n+2)$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252434 is ``Number of (1+2)X(n+2) 0..3 arrays with every 3X3 subblock row and diagonal sum equal to 0 2 4 6 or 7 and every 3X3 column and antidiagonal sum not equal to 0 2 4 6 or 7.''. It has offset $1$ and begins
\[
641, 915, 1142, 1693, 2710, 4342, 6941, 12295,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:13:55, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;17\,a(n-3) - 105\,a(n-6) + 2\,a(n-7) + 277\,a(n-9) - 28\,a(n-10) - 267\,a(n-12) + 139\,a(n-13) - a(n-14) + 19\,a(n-15) - 291\,a(n-16) + 11\,a(n-17) + 85\,a(n-18) + 232\,a(n-19) - 34\,a(n-20) - 25\,a(n-21) + 6\,a(n-22) + 14\,a(n-23) - 85\,a(n-25) + 35\,a(n-26) + 25\,a(n-28) - 25\,a(n-29)
\]
for every $n>44$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252434.
