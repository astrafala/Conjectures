...
\title{The empirical recurrence for OEIS A302519, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A302519 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A302519 is ``Number of 6Xn 0..1 arrays with every element equal to 0, 1, 4 or 5 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
32, 14, 21, 89, 184, 458, 1784, 7182,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 09 2018 09:12:48, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 2\,a(n-2) + 3\,a(n-3) + 46\,a(n-4) + 32\,a(n-5) - 18\,a(n-6) - 33\,a(n-7) - 230\,a(n-8) - 144\,a(n-9) + 146\,a(n-10) + 151\,a(n-11) + 360\,a(n-12) + 319\,a(n-13) - 195\,a(n-14) - 371\,a(n-15) - 150\,a(n-16) - 170\,a(n-17) + 50\,a(n-18) + 96\,a(n-19) - 45\,a(n-20) + 87\,a(n-21) - 3\,a(n-22) - 9\,a(n-23)
\end{equation}
for all $n>29$.
...
the middle column. The vector $w$ was formed by $23$ applications of $G$ in exact integer
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302519.
