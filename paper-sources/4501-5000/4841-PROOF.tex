...
\title{The empirical recurrence for OEIS A283541, proved by transfer matrix}
...
\begin{abstract}
OEIS A283541 counts $n\times6$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
walk, and $a(n)$ is a walk count on $S=581$ vertices, which is $C$-finite. Whether the
...
OEIS A283541 is ``Number of n X 6 0..1 arrays with no 1 equal to more than one of its horizontal, diagonal and antidiagonal neighbors.''. It has offset $1$ and begins
\[
44, 537, 10069, 167920, 2905717, 49760703, 854841910, 14672363665,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 23 2026 16:11:26, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;15\,a(n-1) + 58\,a(n-2) - 419\,a(n-3) + 549\,a(n-4) + 9774\,a(n-5) - 8488\,a(n-6) - 118308\,a(n-7) - 78845\,a(n-8) + 478855\,a(n-9) + 460388\,a(n-10) + 780487\,a(n-11) - 1463834\,a(n-12) - 3318118\,a(n-13) + 1351800\,a(n-14) + 6126749\,a(n-15) - 1699911\,a(n-16) - 5411438\,a(n-17) - 2127087\,a(n-18) + 2727723\,a(n-19) + 7791596\,a(n-20) - 8102395\,a(n-21) - 4823004\,a(n-22) + 8249065\,a(n-23) + 1316588\,a(n-24) - 3377260\,a(n-25) + 134761\,a(n-26) + 308508\,a(n-27)
\]
for every $n>27$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A283541.
