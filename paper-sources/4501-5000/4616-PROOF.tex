...
\title{The empirical recurrence for OEIS A295712, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A295712 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A295712 is ``Number of nX4 0..1 arrays with each 1 horizontally or vertically adjacent to 0, 1, 2 or 4 1s.''. It has offset $1$ and begins
\[
16, 209, 2580, 31985, 396571, 4919857, 61023234, 756896741,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 26 2017 09:25:31, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;9\,a(n-1) + 29\,a(n-2) + 146\,a(n-3) + 207\,a(n-4) + 226\,a(n-5) - 429\,a(n-6) - 36\,a(n-7) - 458\,a(n-8) - 1628\,a(n-9) - 786\,a(n-10) + 346\,a(n-11) + 70\,a(n-12) + 39\,a(n-13) + 868\,a(n-14) + 670\,a(n-15) - 18\,a(n-16) - 347\,a(n-17) - 146\,a(n-18) + a(n-19) + 34\,a(n-20) + 22\,a(n-21) + 11\,a(n-22) - 23\,a(n-23) - 16\,a(n-24) + 6\,a(n-25) + 7\,a(n-26) - a(n-28)
\end{equation}
for all $n>29$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A295712.
