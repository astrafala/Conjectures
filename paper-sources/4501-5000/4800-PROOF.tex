...
\title{The empirical recurrence for OEIS A254840, proved by transfer matrix}
...
\begin{abstract}
OEIS A254840 counts the arrays over $\{0,\dots,1\}$ whose $3\times3$ subblocks carry a
...
OEIS A254840 is ``Number of (n+2)X(3+2) 0..1 arrays with every 3X3 subblock sum of the medians of the diagonal and antidiagonal minus the two sums of the central row and column nondecreasing horizontally and vertically.''. It has offset $1$ and begins
\[
8776, 37642, 131776, 340387, 638688, 1102937, 1795490, 2870508,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 14:59:02, revision 10) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A254840.
