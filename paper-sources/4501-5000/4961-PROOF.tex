...
\title{The empirical recurrence for OEIS A259640, proved by transfer matrix}
...
\begin{abstract}
OEIS A259640 counts $(n+2)\times8$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A259640 is ``Number of (n+2)X(6+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000000 or 00000001.''. It has offset $1$ and begins
\[
472, 1964, 11261, 42524, 182654, 899557, 3919925, 16946757,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:53:27, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A259640.
