...
\title{The empirical recurrence for OEIS A252427, proved by transfer matrix}
...
\begin{abstract}
OEIS A252427 counts $(n+2)\times4$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252427 is ``Number of (n+2) X (2+2) 0..3 arrays with every 3 X 3 subblock row and diagonal sum equal to 0 2 4 6 or 7 and every 3 X 3 column and antidiagonal sum not equal to 0 2 4 6 or 7.''. It has offset $1$ and begins
\[
915, 688, 914, 1801, 2993, 6164, 13139, 26670,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 25 2024 21:13:56, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;16\,a(n-3) - 74\,a(n-6) + 146\,a(n-9) - 294\,a(n-12) + 336\,a(n-15) - 316\,a(n-18) + 290\,a(n-21) - 119\,a(n-24) + 11\,a(n-27) + 6\,a(n-30) - a(n-33)
\]
for every $n>37$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252427.
