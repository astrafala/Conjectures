...
\title{The empirical recurrence for OEIS A253696, proved by transfer matrix}
...
\begin{abstract}
OEIS A253696 counts arrays of width $7$ over $\{0,1\}$ in which two diagonal numbers of every $2\times2$ subblock each differ from the same number at a neighbouring subblock. The entry carries an
...
$3$ consecutive rows and the count is a walk count on $S=1865$ states.
\end{abstract}
...
OEIS A253696 is ``Number of (n+1)X(6+1) 0..1 arrays with every 2X2 subblock ne-sw antidiagonal difference unequal to its neighbors horizontally and nw+se diagonal sum unequal to its neighbors vertically.''. It has offset $1$ and begins
\[
1736, 1026, 968, 1262, 1914, 3042, 5030, 7800,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 14:09:55, revision 6) this is still
...
Thus
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=1865,
\]
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-2) + 2\,a(n-3) - a(n-4) - a(n-6) - 13\,a(n-7) - 8\,a(n-8) + 9\,a(n-9) - 3\,a(n-10) + 7\,a(n-11) + 37\,a(n-12) - 3\,a(n-13) - 22\,a(n-14) + 24\,a(n-15) - 7\,a(n-16) - 37\,a(n-17) + 11\,a(n-18) - a(n-19) - 26\,a(n-20) + 11\,a(n-21) + 11\,a(n-22) - 7\,a(n-23) + 7\,a(n-24) + 6\,a(n-25) - 2\,a(n-26) + 2\,a(n-27) + 2\,a(n-28)
\]
for every $n>33$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253696.
