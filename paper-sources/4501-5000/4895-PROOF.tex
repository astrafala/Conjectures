...
\title{The empirical recurrence for OEIS A300493, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A300493 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A300493 is ``Number of nX3 0..1 arrays with every element equal to 0, 1, 2 or 4 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
4, 18, 52, 143, 412, 1225, 3699, 11243,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 07 2018 07:21:01, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;7\,a(n-1) - 17\,a(n-2) + 12\,a(n-3) + 23\,a(n-4) - 46\,a(n-5) + 4\,a(n-6) + 24\,a(n-7) + 20\,a(n-8) - 52\,a(n-9) + 5\,a(n-10) + 53\,a(n-11) + 22\,a(n-12) - 47\,a(n-13) - 86\,a(n-14) + 78\,a(n-15) + 89\,a(n-16) + 84\,a(n-17) - 64\,a(n-18) - 22\,a(n-19) - 35\,a(n-20) + 15\,a(n-21) + a(n-22) + 4\,a(n-23) - a(n-24)
\end{equation}
for all $n>25$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A300493.
