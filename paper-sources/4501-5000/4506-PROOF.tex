...
\title{The empirical recurrence for OEIS A236813, proved by transfer matrix}
...
\begin{abstract}
OEIS A236813 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
The condition is local to two consecutive rows, so the count is a walk count on $S=63$
...
OEIS A236813 is ``Number of (n+1)X(2+1) 0..2 arrays with the maximum plus the lower median minus the minimum of every 2X2 subblock equal.''. It has offset $1$ and begins
\[
303, 1791, 10702, 66853, 419301, 2680296, 17221539, 111813697,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 09:35:07, revision 6) this is still
...
array, which is not among the objects counted. There are $S=63$ states left.
...
\begin{theorem}
\[
a(n)\;=\;21\,a(n-1) - 100\,a(n-2) - 822\,a(n-3) + 9025\,a(n-4) - 6166\,a(n-5) - 227164\,a(n-6) + 761691\,a(n-7) + 2056841\,a(n-8) - 14904183\,a(n-9) + 4818303\,a(n-10) + 131300778\,a(n-11) - 239600971\,a(n-12) - 518603618\,a(n-13) + 1978489660\,a(n-14) + 49780225\,a(n-15) - 7775913759\,a(n-16) + 7725412959\,a(n-17) + 14487841224\,a(n-18) - 31018825865\,a(n-19) - 3698011866\,a(n-20) + 55220616016\,a(n-21) - 33860955124\,a(n-22) - 43168404248\,a(n-23) + 59680526360\,a(n-24) + 1187247872\,a(n-25) - 39820734688\,a(n-26) + 18284518864\,a(n-27) + 8552972960\,a(n-28) - 9006433472\,a(n-29) + 1006397632\,a(n-30) + 1171967872\,a(n-31) - 352288384\,a(n-32) - 23834624\,a(n-33) + 14026752\,a(n-34)
\]
for every $n>34$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A236813.
