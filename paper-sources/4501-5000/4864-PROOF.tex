...
\title{The empirical recurrence for OEIS A235181, proved by transfer matrix}
...
\begin{abstract}
OEIS A235181 counts $4$-column arrays over $\{0,\dots,5\}$ in which every
...
OEIS A235181 is ``Number of (n+1) X (3+1) 0..5 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 5, with no adjacent elements equal (constant-stress tilted 1 X 1 tilings).''. It has offset
$1$ and begins
\[
576, 1400, 3240, 8224, 19952, 52328, 131120,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 19 2022 02:18:07, revision 8) the statement is
...
a(n)\;=\;3\,a(n-1) + 44\,a(n-2) - 133\,a(n-3) - 842\,a(n-4) + 2563\,a(n-5) + 9221\,a(n-6) - 28202\,a(n-7) - 64059\,a(n-8) + 195733\,a(n-9) + 296446\,a(n-10) - 893437\,a(n-11) - 937956\,a(n-12) + 2714749\,a(n-13) + 2064161\,a(n-14) - 5442684\,a(n-15) - 3205526\,a(n-16) + 7001040\,a(n-17) + 3522128\,a(n-18) - 5502080\,a(n-19) - 2622832\,a(n-20) + 2452848\,a(n-21) + 1173648\,a(n-22) - 555264\,a(n-23) - 271584\,a(n-24) + 48384\,a(n-25) + 24192\,a(n-26)
\end{equation}
for all $n>26$, which is every $n$ at which a recurrence of order $26$ can be
stated.
...
$j=0,1,\dots$. They vanish from $j=26-26+1$ onwards, and the run was continued past
$S$ consecutive zeros, which by Lemma~\ref{lem:crit} settles every larger $j$. Hence the
recurrence holds for every $n>26$.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A235181.
