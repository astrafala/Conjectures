...
\title{The empirical recurrence for OEIS A297316, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297316 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A297316 is ``Number of 3Xn 0..1 arrays with every 1 horizontally or antidiagonally adjacent to 1 or 2 neighboring 1s.''. It has offset $1$ and begins
\[
1, 21, 117, 497, 2577, 13937, 72541, 375054,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 28 2017 07:29:35, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) - 7\,a(n-2) + 42\,a(n-3) - 20\,a(n-4) + 120\,a(n-5) - 109\,a(n-6) + 179\,a(n-7) - 371\,a(n-8) + 53\,a(n-9) + 390\,a(n-10) - 408\,a(n-11) + 204\,a(n-12) - 101\,a(n-13) - 43\,a(n-14) + 151\,a(n-15) - 139\,a(n-16) + 61\,a(n-17) + 2\,a(n-18) - 21\,a(n-19) + 15\,a(n-20) - 2\,a(n-21) - a(n-22) + a(n-23)
\end{equation}
for all $n>24$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297316.
