...
\title{The empirical recurrence for OEIS A278184, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A278184 counts arrays over $\{0,\dots,3\}$ in which every cell is constrained by the
...
OEIS A278184 is ``Number of nX3 0..3 arrays with every element plus 1 mod 4 equal to some element at offset (-1,-1) (-1,0) (-1,1) (0,-1) (0,1) or (1,0), with upper left element zero.''. It has offset $1$ and begins
\[
0, 19, 544, 13720, 347116, 8803344, 223230876, 5660949042,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 14 2016 22:29:08, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;31\,a(n-1) - 155\,a(n-2) + 301\,a(n-3) + 159\,a(n-4) - 2992\,a(n-5) + 9662\,a(n-6) - 29732\,a(n-7) + 126855\,a(n-8) - 280808\,a(n-9) - 58215\,a(n-10) + 1824424\,a(n-11) - 5134012\,a(n-12) + 7021960\,a(n-13) - 3782179\,a(n-14) - 161494\,a(n-15) - 12931\,a(n-16) + 1006187\,a(n-17) + 1090\,a(n-18) - 1012324\,a(n-19) - 2180228\,a(n-20) + 2329252\,a(n-21) - 1301360\,a(n-22) + 252136\,a(n-23) + 383856\,a(n-24) + 87584\,a(n-25) - 102976\,a(n-26) + 3840\,a(n-27)
\end{equation}
for all $n>28$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A278184.
