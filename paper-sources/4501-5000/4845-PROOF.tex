...
\title{The empirical recurrence for OEIS A207510, proved by transfer matrix}
...
\begin{abstract}
OEIS A207510 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
...
OEIS A207510 is ``Number of nX4 0..1 arrays avoiding 0 0 0 and 0 1 1 horizontally and 0 0 1 and 1 1 1 vertically.''. It has offset
$1$ and begins
\[
9, 81, 166, 438, 1042, 1992, 4168,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:00:19, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;-a(n-1) + 4\,a(n-2) + 14\,a(n-3) + 5\,a(n-4) - 31\,a(n-5) - 67\,a(n-6) - 28\,a(n-7) + 76\,a(n-8) + 171\,a(n-9) + 113\,a(n-10) - 61\,a(n-11) - 229\,a(n-12) - 197\,a(n-13) - 27\,a(n-14) + 154\,a(n-15) + 175\,a(n-16) + 71\,a(n-17) - 46\,a(n-18) - 89\,a(n-19) - 45\,a(n-20) - 6\,a(n-21) + 32\,a(n-22) + 12\,a(n-23) + 10\,a(n-24) - 7\,a(n-25) - a(n-26) - 2\,a(n-27) + a(n-28)
\end{equation}
for all $n>32$. 
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207510.
