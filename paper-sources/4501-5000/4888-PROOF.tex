...
\title{The empirical recurrence for OEIS A207925, proved by transfer matrix}
...
\begin{abstract}
OEIS A207925 counts arrays over $\{0,\dots,1\}$ of width $5$ that avoid the patterns
...
OEIS A207925 is ``Number of nX5 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 0 0 and 1 1 1 vertically.''. It has offset
$1$ and begins
\[
15, 225, 360, 1872, 7744, 29760, 126688,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:28:39, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-2) + 63\,a(n-3) + 12\,a(n-4) + 21\,a(n-5) - 749\,a(n-6) + 34\,a(n-7) - 343\,a(n-8) + 3571\,a(n-9) - 666\,a(n-10) + 1227\,a(n-11) - 7816\,a(n-12) + 1430\,a(n-13) - 1022\,a(n-14) + 7504\,a(n-15) - 771\,a(n-16) + 78\,a(n-17) - 3329\,a(n-18) + 37\,a(n-19) + 100\,a(n-20) + 661\,a(n-21) + 35\,a(n-22) - 2\,a(n-23) - 45\,a(n-24) - a(n-25) + a(n-27)
\end{equation}
for all $n>29$. 
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207925.
