...
\title{The empirical recurrence for OEIS A258676, proved by transfer matrix}
...
\begin{abstract}
OEIS A258676 counts arrays of width $5$ over $\{0,1\}$ in which every $3\times3$ window has
...
OEIS A258676 is ``Number of (n+2)X(3+2) 0..1 arrays with no 3x3 subblock diagonal sum equal to the antidiagonal sum.''. It has offset $1$ and begins
\[
8320, 67600, 635440, 5973136, 51939888, 451647504, 4096960560, 37164128400,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 15:30:04, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A258676.
