...
\title{The empirical recurrence for OEIS A260365, proved by transfer matrix}
...
\begin{abstract}
OEIS A260365 counts $(n+2)\times5$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A260365 is ``Number of (n+2)X(3+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000001 00000011 or 00001111.''. It has offset $1$ and begins
\[
208, 342, 912, 2014, 2532, 5806, 13632, 20576,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 12:06:03, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-3) + 11\,a(n-4) - 3\,a(n-6) - 46\,a(n-7) - 50\,a(n-8) - 10\,a(n-9) + 29\,a(n-10) + 148\,a(n-11) + 136\,a(n-12) + 12\,a(n-13) - 113\,a(n-14) - 228\,a(n-15) - 260\,a(n-16) + 10\,a(n-17) + 203\,a(n-18) + 200\,a(n-19) + 295\,a(n-20) + 8\,a(n-21) - 104\,a(n-22) - 80\,a(n-23) - 161\,a(n-24) - 16\,a(n-25) + 12\,a(n-26) + 4\,a(n-27) + 16\,a(n-28)
\]
for every $n>30$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A260365.
