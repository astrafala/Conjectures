...
\title{The empirical recurrence for OEIS A236059, proved by transfer matrix}
...
\begin{abstract}
OEIS A236059 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
The condition is local to two consecutive rows, so the count is a walk count on $S=360$
...
OEIS A236059 is ``Number of (n+1)X(2+1) 0..2 arrays colored with the difference of the upper median and the minimum in each 2X2 subblock.''. It has offset $1$ and begins
\[
360, 1784, 8506, 41344, 200906, 983796, 4815318, 23498914,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 09:03:33, revision 6) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The $2\times2$ subblocks of an $(n+1)\times3$ array form an
$n\times2$ grid. Colour each of them by $\sigma=-a+c$, where $a\le b\le c\le d$ are its four entries sorted --- its minimum, lower median, upper median and maximum. ``Coloured with'' is the entry's way of
...
\]
over the $S=360$ pairs whose own subblock row is properly coloured.
...
\begin{theorem}
\[
a(n)\;=\;49\,a(n-3) + 236\,a(n-4) + 426\,a(n-5) + 654\,a(n-6) - 1133\,a(n-7) - 5246\,a(n-8) - 4754\,a(n-9) + 1867\,a(n-10) + 17569\,a(n-11) - 2570\,a(n-12) - 38230\,a(n-13) + 38724\,a(n-14) + 27309\,a(n-15) - 54534\,a(n-16) + 44390\,a(n-17) + 26998\,a(n-18) - 51374\,a(n-19) - 28145\,a(n-20) - 36975\,a(n-21) + 7568\,a(n-22) + 67771\,a(n-23) + 42787\,a(n-24) - 5128\,a(n-25) - 24789\,a(n-26) - 15360\,a(n-27) - 3\,a(n-28) + 2726\,a(n-29) + 348\,a(n-30) - 160\,a(n-31) - 32\,a(n-32)
\]
for every $n>35$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A236059.
