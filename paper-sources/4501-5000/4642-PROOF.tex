...
\title{The empirical recurrence for OEIS A237177, proved by transfer matrix}
...
\begin{abstract}
OEIS A237177 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
The condition is local to two consecutive rows, so the count is a walk count on $S=402$
...
OEIS A237177 is ``Number of (n+1)X(2+1) 0..2 arrays colored with the maximum plus the minimum minus the lower median of every 2X2 subblock.''. It has offset $1$ and begins
\[
402, 2700, 18062, 122882, 836966, 5677464, 38493628, 261361496,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 09:56:29, revision 6) this is still
...
\]
over the $S=402$ pairs whose own subblock row is properly coloured.
...
\begin{theorem}
\[
a(n)\;=\;92\,a(n-3) + 882\,a(n-4) + 2709\,a(n-5) + 9218\,a(n-6) + 14959\,a(n-7) - 31445\,a(n-8) - 146986\,a(n-9) - 482868\,a(n-10) - 943838\,a(n-11) + 336994\,a(n-12) + 3543506\,a(n-13) + 7186094\,a(n-14) + 9446548\,a(n-15) - 6491849\,a(n-16) - 31924590\,a(n-17) - 28642956\,a(n-18) - 15283695\,a(n-19) + 28491559\,a(n-20) + 84665284\,a(n-21) + 23411816\,a(n-22) - 43724842\,a(n-23) - 23336351\,a(n-24) - 1820626\,a(n-25) + 19596591\,a(n-26) - 12757942\,a(n-27) - 45558441\,a(n-28) - 16827881\,a(n-29) + 14050962\,a(n-30) + 8840398\,a(n-31) - 8247379\,a(n-32) - 1547726\,a(n-33) + 2428485\,a(n-34) - 15020\,a(n-35) + 347656\,a(n-36) + 182740\,a(n-37) - 117680\,a(n-38) - 21136\,a(n-39) - 2176\,a(n-40)
\]
for every $n>40$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237177.
