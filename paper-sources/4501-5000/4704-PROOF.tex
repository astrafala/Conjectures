...
\title{The empirical recurrence for OEIS A204700, proved by transfer matrix}
...
\begin{abstract}
OEIS A204700 counts arrays of width $3$ over $\{0,1,2\}$ containing no run of $3$ consecutive
cells, taken along a named direction of the grid, whose entries are all equal. The entry carries
an empirical recurrence of order $28$ contributed by R.~H.~Hardin. It is true, and it is
...
OEIS A204700 is ``Number of nX3 0..2 arrays with no occurrence of three equal elements in a row horizontally, vertically or nw-to-se diagonally, and new values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
4, 96, 1417, 22869, 362020, 5767683, 91733605, 1459710274,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 11:24:52, revision 10) this is still
...
\begin{theorem}
\[
a(n)\;=\;9\,a(n-1) + 117\,a(n-2) - 24\,a(n-3) - 1482\,a(n-4) + 884\,a(n-5) + 6805\,a(n-6) - 7217\,a(n-7) + 875\,a(n-8) - 9444\,a(n-9) + 23926\,a(n-10) - 157560\,a(n-11) + 235676\,a(n-12) + 268960\,a(n-13) - 735296\,a(n-14) + 199456\,a(n-15) + 747264\,a(n-16) - 760384\,a(n-17) - 340800\,a(n-18) + 784192\,a(n-19) - 38208\,a(n-20) - 346880\,a(n-21) + 138880\,a(n-22) + 50176\,a(n-23) - 91904\,a(n-24) + 17408\,a(n-25) + 25600\,a(n-26) - 8192\,a(n-27) - 4096\,a(n-28)
\]
for every $n>31$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204700.
