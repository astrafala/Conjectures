...
\title{The empirical recurrence for OEIS A303965, proved by transfer matrix}
...
\begin{abstract}
OEIS A303965 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $different from$ itself lying in $\{0,1,3,5\}$, and it carries an empirical
...
OEIS A303965 is ``Number of nX4 0..1 arrays with every element unequal to 0, 1, 3 or 5 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
5, 21, 26, 73, 173, 374, 842, 1923,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 03 2018 12:53:22, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 2\,a(n-3) - a(n-4) - 2\,a(n-5) + 7\,a(n-6) - 8\,a(n-7) - 2\,a(n-8) - 11\,a(n-9) + a(n-10) + 6\,a(n-11) - 12\,a(n-12) + 4\,a(n-13) + 4\,a(n-14) + 18\,a(n-15) + 7\,a(n-16) - 3\,a(n-17) + 6\,a(n-18) + 8\,a(n-19) + 2\,a(n-20) - 6\,a(n-21) - 10\,a(n-22) - 5\,a(n-23) + a(n-24) - 6\,a(n-25) - 6\,a(n-26) - 7\,a(n-27) + a(n-28) + 5\,a(n-29) + 2\,a(n-32) + 4\,a(n-33) + 2\,a(n-34) - a(n-35) - a(n-36)
\end{equation}
for all $n>37$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A303965.
