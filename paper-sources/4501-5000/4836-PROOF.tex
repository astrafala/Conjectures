...
\title{The empirical recurrence for OEIS A204718, proved by transfer matrix}
...
\begin{abstract}
OEIS A204718 counts arrays over $\{0,\dots,1\}$ under a condition on the permanent of every
$2\times2$ subblock, and carries an empirical recurrence of order $25$ contributed by
R.~H.~Hardin. It is true, and it is decidable rather than empirical. The condition is local to
a bounded window of consecutive rows, so the count is a walk count on $S=156$ states and is
...
OEIS A204718 is ``Number of (n+1)X4 0..1 arrays with the permanents of 2X2 subblocks nondecreasing rightwards and downwards.''. It has offset $1$ and begins
\[
156, 1271, 9657, 67518, 457635, 2995945, 19292513, 122364692,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 11:25:49, revision 9) this is still
...
entry's first term is $156$, and the model reproduces it along with every later term; that
...
\begin{theorem}
\[
a(n)\;=\;10\,a(n-1) + 12\,a(n-2) - 350\,a(n-3) + 263\,a(n-4) + 5188\,a(n-5) - 6940\,a(n-6) - 42704\,a(n-7) + 68106\,a(n-8) + 215568\,a(n-9) - 376712\,a(n-10) - 696976\,a(n-11) + 1312296\,a(n-12) + 1459424\,a(n-13) - 3006176\,a(n-14) - 1933056\,a(n-15) + 4580288\,a(n-16) + 1473920\,a(n-17) - 4578688\,a(n-18) - 415488\,a(n-19) + 2871808\,a(n-20) - 233472\,a(n-21) - 1019904\,a(n-22) + 217088\,a(n-23) + 155648\,a(n-24) - 49152\,a(n-25)
\]
for every $n>25$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204718.
