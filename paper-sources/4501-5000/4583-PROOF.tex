...
\title{The empirical recurrence for OEIS A237780, proved by transfer matrix}
...
\begin{abstract}
OEIS A237780 counts arrays over $\{0,\dots,3\}$ subject to a condition on the order
...
OEIS A237780 is ``Number of (n+1)X(1+1) 0..3 arrays with the maximum plus the upper median plus the minimum minus the lower median of every 2X2 subblock differing from its horizontal and vertical neighbors by exactly one.''. It has offset $1$ and begins
\[
256, 1764, 12328, 86736, 610052, 4293744, 30217760, 212542304,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 10:27:23, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;2584\,a(n-4) - 329840\,a(n-8) + 11009280\,a(n-12) - 157232128\,a(n-16) + 824834048\,a(n-20) + 1067106304\,a(n-24) - 9353953280\,a(n-28) + 10336862208\,a(n-32)
\]
for every $n>35$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237780.
