...
\title{The empirical recurrence for OEIS A198150, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A198150 counts arrays over $\{0,\dots,4\}$ in which every cell is constrained by the
...
OEIS A198150 is ``Number of nX3 0..4 arrays with each element x equal to the number its horizontal and vertical neighbors equal to 4,3,0,1,1 for x=0,1,2,3,4.''. It has offset $1$ and begins
\[
2, 12, 54, 240, 1170, 5330, 24689, 116890,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 07:47:12, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 3\,a(n-2) + 38\,a(n-3) + 40\,a(n-4) + 21\,a(n-5) - 127\,a(n-6) - 313\,a(n-7) - 143\,a(n-8) + 681\,a(n-9) + 1988\,a(n-10) + 1587\,a(n-11) - 1232\,a(n-12) - 4569\,a(n-13) - 5344\,a(n-14) - 992\,a(n-15) + 3626\,a(n-16) + 4576\,a(n-17) + 2900\,a(n-18) + 162\,a(n-19) - 844\,a(n-20) - 954\,a(n-21) - 250\,a(n-22) + 190\,a(n-23) + 34\,a(n-24) - a(n-25)
\end{equation}
for all $n>26$.
...
\#\{\text{neighbours with value }f(x_{t,u})\}=x_{t,u},\quad f=(4,3,0,1,1)
\end{equation}
for every cell $(t,u)$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A198150.
