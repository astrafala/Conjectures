...
\title{The empirical recurrence for OEIS A302067, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A302067 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
values of its neighbours, and carries an empirical recurrence of order $25$ contributed
...
OEIS A302067 is ``Number of nX6 0..1 arrays with every element equal to 0, 1, 2 or 4 horizontally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
32, 855, 18108, 420121, 9825815, 230634314, 5420105343, 127431664603,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 31 2018 15:43:37, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;64\,a(n-1) - 1690\,a(n-2) + 25482\,a(n-3) - 252419\,a(n-4) + 1780964\,a(n-5) - 9433881\,a(n-6) + 38861751\,a(n-7) - 127364033\,a(n-8) + 336753119\,a(n-9) - 724264377\,a(n-10) + 1273619361\,a(n-11) - 1838285081\,a(n-12) + 2185709769\,a(n-13) - 2148857927\,a(n-14) + 1752766341\,a(n-15) - 1188289983\,a(n-16) + 668874578\,a(n-17) - 311073351\,a(n-18) + 118346399\,a(n-19) - 36213453\,a(n-20) + 8679164\,a(n-21) - 1564108\,a(n-22) + 198432\,a(n-23) - 15696\,a(n-24) + 576\,a(n-25)
\end{equation}
for all $n>27$.
...
\begin{proof}
Substitute Lemma~\ref{lem:walk} and factor $G^{j-25}$ out of
...
the middle row. The vector $w$ was formed by $25$ applications of $G$ in exact integer
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302067.
