...
\title{The empirical recurrence for OEIS A236888, proved by transfer matrix}
...
\begin{abstract}
OEIS A236888 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
The condition is local to two consecutive rows, so the count is a walk count on $S=197$
...
OEIS A236888 is ``Number of (n+1) X (3+1) 0..2 arrays with the maximum plus the upper median minus the lower median minus the minimum of every 2 X 2 subblock equal.''. It has offset $1$ and begins
\[
781, 4129, 22393, 134361, 824753, 5371569, 35771489, 248167409,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 27 2023 00:37:42, revision 6) this is still
...
array, which is not among the objects counted. There are $S=197$ states left.
...
\begin{theorem}
\[
a(n)\;=\;21\,a(n-1) - 56\,a(n-2) - 1596\,a(n-3) + 10598\,a(n-4) + 37506\,a(n-5) - 458265\,a(n-6) - 65787\,a(n-7) + 9671623\,a(n-8) - 11880327\,a(n-9) - 116841126\,a(n-10) + 239765418\,a(n-11) + 846977784\,a(n-12) - 2328600336\,a(n-13) - 3613321941\,a(n-14) + 13171406553\,a(n-15) + 7958267644\,a(n-16) - 45136203792\,a(n-17) - 3285801844\,a(n-18) + 93007353972\,a(n-19) - 22546601120\,a(n-20) - 112104741744\,a(n-21) + 48327996864\,a(n-22) + 75881646528\,a(n-23) - 41191019008\,a(n-24) - 27175387392\,a(n-25) + 16504756224\,a(n-26) + 4679811072\,a(n-27) - 3017687040\,a(n-28) - 297271296\,a(n-29) + 198180864\,a(n-30)
\]
for every $n>30$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A236888.
