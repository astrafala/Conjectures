...
\title{The empirical recurrence for OEIS A184787, proved by transfer matrix}
...
\begin{abstract}
OEIS A184787 counts $(n+2)\times3$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
every $3\times3$ subblock, and it carries an empirical recurrence of order $28$
...
OEIS A184787 is ``Number of (n+2)X3 0..2 arrays with each 3X3 subblock singular.''. It has offset $1$ and begins
\[
6891, 100941, 1451439, 19143309, 264517911, 3635551053, 49631761863, 680594596269,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 02:55:49, revision 10) this is still
...
\begin{theorem}
\[
a(n)\;=\;23\,a(n-1) - 133\,a(n-2) + 359\,a(n-3) - 6981\,a(n-4) + 44653\,a(n-5) - 46861\,a(n-6) + 510397\,a(n-7) - 3119750\,a(n-8) - 4266752\,a(n-9) - 7337146\,a(n-10) + 97617840\,a(n-11) + 421337240\,a(n-12) + 194265216\,a(n-13) - 2452885280\,a(n-14) - 11665215256\,a(n-15) - 13514300128\,a(n-16) + 36492062528\,a(n-17) + 161174571904\,a(n-18) + 234355030272\,a(n-19) - 208323990528\,a(n-20) - 1253913449472\,a(n-21) - 1586195787776\,a(n-22) + 535347175424\,a(n-23) + 4616948760576\,a(n-24) + 4932168384512\,a(n-25) - 1803615731712\,a(n-26) - 6148702863360\,a(n-27) - 2853804441600\,a(n-28)
\]
for every $n>27$.
\end{theorem}

\begin{proof}
The vector $w=q(M)\mathbf{1}$ was formed by $28$ matrix--vector products in exact
integer arithmetic and $\mathbf{1}^{\!\top}M^{j}w$ evaluated for $j=0,1,\dots$, again
exactly. Those integers vanish from the index corresponding to $n=27+1$ onwards, and the
run was continued until the working vector was identically zero, which settles all larger $j$
at once. By Lemma~\ref{lem:crit} the recurrence holds for every $n>27$.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A184787.
