...
\title{The empirical recurrence for OEIS A297435, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297435 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A297435 is ``Number of 5 X n 0..1 arrays with every 1 horizontally, diagonally or antidiagonally adjacent to 2 neighboring 1s.''. It has offset $1$ and begins
\[
1, 6, 68, 183, 535, 2430, 12005, 45977,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 06 2026 21:12:04, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) - 2\,a(n-2) - 21\,a(n-3) + 55\,a(n-4) - 312\,a(n-5) - 47\,a(n-6) + 1417\,a(n-7) - 1322\,a(n-8) + 1486\,a(n-9) + 5063\,a(n-10) - 11080\,a(n-11) + 5229\,a(n-12) - 1399\,a(n-13) - 24687\,a(n-14) + 35875\,a(n-15) + 3906\,a(n-16) - 14117\,a(n-17) - 22633\,a(n-18) + 43774\,a(n-19) - 41598\,a(n-20) + 41345\,a(n-21) - 37878\,a(n-22) + 32034\,a(n-23) - 16314\,a(n-24) + 6016\,a(n-25) - 2376\,a(n-26) + 968\,a(n-27) - 432\,a(n-28) + 64\,a(n-29)
\end{equation}
for all $n>30$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297435.
