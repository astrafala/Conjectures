...
\title{The empirical recurrence for OEIS A297522, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297522 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A297522 is ``Number of 4Xn 0..1 arrays with every 1 horizontally, diagonally or antidiagonally adjacent to 1 or 3 neighboring 1s.''. It has offset $1$ and begins
\[
1, 24, 177, 624, 2610, 15896, 85843, 402072,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 31 2017 09:56:44, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 7\,a(n-2) + 30\,a(n-3) + 190\,a(n-4) + 135\,a(n-5) - 397\,a(n-6) - 744\,a(n-7) - 3268\,a(n-8) - 2810\,a(n-9) + 6340\,a(n-10) + 2928\,a(n-11) - 2154\,a(n-12) + 11260\,a(n-13) - 3923\,a(n-14) - 40330\,a(n-15) - 10049\,a(n-16) + 42471\,a(n-17) + 30552\,a(n-18) - 645\,a(n-19) - 17700\,a(n-20) - 17696\,a(n-21) + 2847\,a(n-22) + 15106\,a(n-23) - 2542\,a(n-24) - 5927\,a(n-25) + 11368\,a(n-26) + 2122\,a(n-27) - 2117\,a(n-28) + 212\,a(n-29) - 4\,a(n-30) - 94\,a(n-31)
\end{equation}
for all $n>32$.
...
x_{t,u}=1\ \Rightarrow\ \#\{\text{neighbours equal to }1\}\in\{1,3\}
\end{equation}
for every cell $(t,u)$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297522.
