...
\title{The empirical recurrence for OEIS A196213, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A196213 counts arrays over $\{0,\dots,4\}$ in which every cell is constrained by the
...
OEIS A196213 is ``Number of nX3 0..4 arrays with each element x equal to the number its horizontal and vertical neighbors equal to 3,0,1,2,4 for x=0,1,2,3,4.''. It has offset $1$ and begins
\[
4, 20, 58, 290, 1217, 5110, 21969, 93666,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 06:25:51, revision 9) the statement is
...
\#\{\text{neighbours with value }f(x_{t,u})\}=x_{t,u},\quad f=(3,0,1,2,4)
\end{equation}
for every cell $(t,u)$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A196213.
