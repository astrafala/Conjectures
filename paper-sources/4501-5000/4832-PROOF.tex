...
\title{The empirical recurrence for OEIS A300876, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A300876 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A300876 is ``Number of nX3 0..1 arrays with every element equal to 0, 1, 2, 4 or 5 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
4, 18, 52, 148, 440, 1367, 4297, 13510,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 14 2018 07:16:52, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;7\,a(n-1) - 15\,a(n-2) + 44\,a(n-4) - 42\,a(n-5) - 42\,a(n-6) + 45\,a(n-7) + 44\,a(n-8) - 3\,a(n-9) - 15\,a(n-10) - 49\,a(n-11) - 52\,a(n-12) - 26\,a(n-13) + 86\,a(n-14) + 194\,a(n-15) + 84\,a(n-16) + 42\,a(n-17) - 92\,a(n-18) - 76\,a(n-19) - 43\,a(n-20) - a(n-21) + 13\,a(n-22) + 4\,a(n-23) + 3\,a(n-24) - a(n-25)
\end{equation}
for all $n>26$.
...
\#\{\text{neighbours with a value }equal to\ x_{t,u}\}\in\{0,1,2,4,5\}
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A300876.
