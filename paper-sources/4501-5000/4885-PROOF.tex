...
\title{The empirical recurrence for OEIS A202586, proved by transfer matrix}
...
\begin{abstract}
OEIS A202586 counts arrays of width $5$ over $\{0,1\}$ containing no occurrence of certain short
...
OEIS A202586 is ``Number of (n+2)X5 binary arrays avoiding patterns 001 and 100 in rows, columns and nw-to-se diagonals.''. It has offset $1$ and begins
\[
804, 3906, 22018, 127405, 755743, 4512712, 27083790, 162834668,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 09:43:06, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-1) + 5\,a(n-2) - 119\,a(n-3) - 33\,a(n-4) + 836\,a(n-5) + 541\,a(n-6) - 3476\,a(n-7) - 3205\,a(n-8) + 8025\,a(n-9) + 9061\,a(n-10) - 10518\,a(n-11) - 10948\,a(n-12) + 8562\,a(n-13) - 1477\,a(n-14) - 3794\,a(n-15) + 16795\,a(n-16) + 767\,a(n-17) - 20117\,a(n-18) + 1608\,a(n-19) + 13413\,a(n-20) - 3578\,a(n-21) - 5053\,a(n-22) + 2527\,a(n-23) + 1063\,a(n-24) - 1072\,a(n-25) + 8\,a(n-26) + 236\,a(n-27) - 56\,a(n-28) - 12\,a(n-29) + 4\,a(n-30)
\]
for every $n>31$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A202586.
