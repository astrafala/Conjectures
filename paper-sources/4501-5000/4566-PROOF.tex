...
\title{The empirical recurrence for OEIS A297377, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297377 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A297377 is ``Number of 4Xn 0..1 arrays with every 1 horizontally or antidiagonally adjacent to 0, 1 or 2 neighboring 1s.''. It has offset $1$ and begins
\[
16, 256, 2719, 33054, 409507, 4986469, 60872732, 743909663,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 29 2017 07:43:36, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;8\,a(n-1) + 22\,a(n-2) + 297\,a(n-3) + 568\,a(n-4) + 2486\,a(n-5) + 500\,a(n-6) + 2382\,a(n-7) - 19530\,a(n-8) - 3588\,a(n-9) - 20071\,a(n-10) + 74284\,a(n-11) + 27587\,a(n-12) - 124497\,a(n-13) + 26577\,a(n-14) + 93433\,a(n-15) - 61715\,a(n-16) - 42323\,a(n-17) + 61267\,a(n-18) + 1215\,a(n-19) - 40946\,a(n-20) + 11059\,a(n-21) + 18132\,a(n-22) - 7844\,a(n-23) - 5984\,a(n-24) + 3192\,a(n-25) + 1312\,a(n-26) - 708\,a(n-27) - 128\,a(n-28) + 64\,a(n-29)
\end{equation}
for all $n>31$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297377.
