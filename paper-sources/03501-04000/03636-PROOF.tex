...
\title{The empirical recurrence for OEIS A270053, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A270053 counts arrays over $\{0,\dots,4\}$ subject to a condition on the array as a
...
OEIS A270053 is ``Number of nX3 0..4 arrays with some element plus some horizontally or vertically adjacent neighbor totalling four exactly once.''. It has offset $1$ and begins
\[
40, 5400, 385200, 22911300, 1248460920, 64599504300, 3230189811360, 157641639369300,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 90*a(n-1) -2257*a(n-2) +10440*a(n-3) -13456*a(n-4) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 09 2016 12:22:37, revision 6) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A270053.
