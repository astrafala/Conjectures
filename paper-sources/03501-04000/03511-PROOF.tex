...
\title{The empirical recurrence for OEIS A262760, proved by transfer matrix}
...
\begin{abstract}
OEIS A262760 counts arrays of width $5$ over $\{0,1\}$ whose rows, read as base-$2$
numbers, are divisible by $7$ and whose columns, read the same way, are divisible by
$5$. The entry carries an empirical recurrence of order $17$ contributed by
...
OEIS A262760 is ``Number of (3+2)X(n+2) 0..1 arrays with each row divisible by 5 and each column divisible by 7, read as a binary number with top and left being the most significant bits.''. It has offset $1$ and begins
\[
5, 25, 49, 129, 709, 4953, 16705, 73345,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 30 2015 11:03:20, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) + 290\,a(n-4) - 1450\,a(n-5) - 19200\,a(n-8) + 96000\,a(n-9) + 370750\,a(n-12) - 1853750\,a(n-13) - 1409375\,a(n-16) + 7046875\,a(n-17)
\]
for every $n>15$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A262760.
