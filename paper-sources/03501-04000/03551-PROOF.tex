...
\title{The empirical recurrence for OEIS A274955, proved by counting patterns}
...
\begin{abstract}
OEIS A274955 counts arrays in which no entry may repeat a value found at any of three stated
...
OEIS A274955 is ``Number of nX4 0..2 arrays with no element equal to any value at offset (-1,-1) (-2,0) or (0,-2) and new values introduced in order 0..2.''. It has offset $1$ and begins
\[
6, 72, 384, 2376, 14406, 87780, 536406, 3278016,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 6*a(n-1) +4*a(n-3) +13*a(n-4) -74*a(n-5) -8*a(n-6) -4*a(n-8) +8*a(n-9) for n>11
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 12 2016 08:02:28, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) + 4\,a(n-3) + 13\,a(n-4) - 74\,a(n-5) - 8\,a(n-6) - 4\,a(n-8) + 8\,a(n-9)
\end{equation}
for all $n>11$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A274955.
