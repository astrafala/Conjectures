...
\title{The conjectured generating function for OEIS A277928, proved}
...
\begin{abstract}
OEIS A277928 counts arrays of a fixed width under a local condition, and carries a conjectured
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 13 2026 13:53:12, revision 13) this is still
