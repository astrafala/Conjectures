...
\title{The empirical recurrence for OEIS A198712, proved by counting patterns}
...
\begin{abstract}
OEIS A198712 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A198712 is ``Number of nX5 0..3 arrays with values 0..3 introduced in row major order and no element equal to any horizontal or vertical neighbor.''. It has offset $1$ and begins
\[
14, 1201, 107042, 9548295, 851787199, 75987485516, 6778819400772, 604736581320925,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 119*a(n-1) -2929*a(n-2) +25066*a(n-3) -76115*a(n-4) -887*a(n-5) +324153*a(n-6) -444798*a(n-7) +175392*a(n-8)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 08:00:26, revision 9) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A198712.
