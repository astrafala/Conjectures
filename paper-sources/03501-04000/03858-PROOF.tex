...
\title{The conjectured generating function for OEIS A280411, proved}
...
\begin{abstract}
OEIS A280411 counts arrays of a fixed width under a local condition, and carries a conjectured
