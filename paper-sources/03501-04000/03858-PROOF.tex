...
\title{The empirical column recurrences for the table OEIS A299388}
...
\begin{abstract}
OEIS A299388 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A299388 is ``T(n,k) = Number of n X k 0..1 arrays with every element equal to 0, 1, 2, 4, 6 or 8 king-move adjacent elements, with upper left element zero.''. It has offset $1$, is
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 21 2021 15:07:14, revision 6) these are still
...
The sequence is ``Number of n X 2 0..1 arrays with every element equal to 0, 1, 2, 4, 6 or 8 king-move adjacent elements, with upper left element zero.''. Its rows are the vertices of a digraph on
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A299388.
