...
\title{The empirical recurrence for OEIS A262424, proved by transfer matrix}
...
\begin{abstract}
OEIS A262424 counts arrays of width $6$ over $\{0,1\}$ whose rows, read as base-$2$
numbers, are not divisible by $3$ and whose columns, read the same way, are divisible by
$3$. The entry carries an empirical recurrence of order $11$ contributed by
...
OEIS A262424 is ``Number of (5+1)X(n+1) 0..1 arrays with each row divisible by 3 and column not divisible by 3, read as a binary number with top and left being the most significant bits.''. It has offset $1$ and begins
\[
42, 144, 10206, 200880, 9401742, 326005344, 14036526126, 562188062160,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 22 2015 09:36:53, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;42\,a(n-1) + 711\,a(n-2) - 29862\,a(n-3) - 141183\,a(n-4) + 5929686\,a(n-5) + 10349613\,a(n-6) - 434683746\,a(n-7) - 267400116\,a(n-8) + 11230804872\,a(n-9) + 1666598976\,a(n-10) - 69997156992\,a(n-11)
\]
for every $n>10$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A262424.
