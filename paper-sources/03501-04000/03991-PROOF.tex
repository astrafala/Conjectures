...
\title{The empirical recurrence for OEIS A206212, proved by transfer matrix}
...
\begin{abstract}
OEIS A206212 counts, up to renaming the letters, the arrays of width $6$ over at most $3$
...
OEIS A206212 is ``Number of (n+1) X 6 0..2 arrays with every 2 X 3 or 3 X 2 subblock having exactly two equal edges, and new values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
2268, 2996, 5632, 21984, 86152, 359424, 1435584, 5673232,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 66*a(n-3) for n > 810.
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 01 2023 14:03:11, revision 7) this is still
...
$w_i$ cleared of denominators and $S=13894$ states in all. The walk index $j$ and the entry's own
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206212.
