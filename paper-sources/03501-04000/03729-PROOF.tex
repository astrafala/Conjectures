...
\title{The empirical recurrence for OEIS A217951, proved by transfer matrix}
...
\begin{abstract}
OEIS A217951 carries an empirical recurrence of order $16$ contributed by R. H. Hardin. It is
...
OEIS A217951 is ``Number of n element 0..3 arrays with each element the minimum of 5 adjacent elements of a random 0..3 array of n+4 elements.''. It has offset $1$ and begins
\[
4, 16, 50, 130, 296, 610, 1177, 2209,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 17:28:36, revision 9) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A217951.
