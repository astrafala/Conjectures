...
\title{The empirical recurrence for OEIS A208087, proved by transfer matrix}
...
\begin{abstract}
OEIS A208087 counts, up to renaming the letters, the arrays of width $6$ over at most $2$
...
OEIS A208087 is ``Number of 6 X (n+1) 0..1 arrays with every 2 X 2 subblock having the same number of equal edges as its horizontal neighbors and a different number from its vertical neighbors, and new values 0..1 introduced in row major order.''. It has offset $1$ and begins
\[
72, 168, 402, 1032, 2664, 6954, 18168, 47544,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) - 3*a(n-3) + a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 27 2018 14:17:54, revision 8) this is still
...
$w_i$ cleared of denominators and $S=144$ states in all. The walk index $j$ and the entry's own
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208087.
