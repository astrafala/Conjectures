...
\title{The empirical recurrence for OEIS A214138, proved by transfer matrix}
...
\begin{abstract}
OEIS A214138 counts the proper colourings of a grid $n\times6$, wrapped in the direction of width $6$, with at most $5$ colours and
...
down to $S=83$ and makes the exact residual test affordable.
\end{abstract}
...
OEIS A214138 is ``Number of 0..4 colorings on an nX6 array circular in the 6 direction with new values 0..4 introduced in row major order.''. It has offset $1$ and begins
\[
40, 40434, 47730973, 56449101747, 66761857485037, 78958797573536880, 93384051705843287887, 110444707138200962659230,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 16:53:18, revision 8) this is still
...
\]
There are $(i-1)^{6}+(-1)^{6}(i-1)$ such colourings, which at $i=5$ is already more
...
state count is $S=83$ rather than the number of colourings.
...
\begin{theorem}
\[
a(n)\;=\;1343\,a(n-1) - 193139\,a(n-2) + 4182587\,a(n-3) + 13484773\,a(n-4) - 1046489341\,a(n-5) + 9211083518\,a(n-6) - 31222203012\,a(n-7) + 47496470136\,a(n-8) - 30991236576\,a(n-9) + 6534899712\,a(n-10)
\]
for every $n>10$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A214138.
