...
\title{The empirical recurrence for OEIS A266028, proved by transfer matrix}
...
\begin{abstract}
OEIS A266028 counts arrays of width $3$ in which every entry is equal to the NUMBER of its own
...
OEIS A266028 is ``Number of n X 3 integer arrays with each element equal to the number of horizontal and antidiagonal neighbors less than itself.''. It has offset $1$ and begins
\[
5, 50, 481, 4659, 45361, 440405, 4281953, 41605113,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 5*a(n-1) + 46*a(n-2) + 6*a(n-3) - 72*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 09 2019 11:50:24, revision 7) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=1901.
\]
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) + 46\,a(n-2) + 6\,a(n-3) - 72\,a(n-4)
\]
for every $n>4$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A266028.
