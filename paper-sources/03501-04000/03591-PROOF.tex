...
\title{The empirical recurrence for OEIS A266050, proved by transfer matrix}
...
\begin{abstract}
OEIS A266050 counts arrays of width $3$ in which every entry is equal to the NUMBER of its own
...
OEIS A266050 is ``Number of n X 3 integer arrays with each element equal to the number of horizontal and antidiagonal neighbors less than or equal to itself.''. It has offset $1$ and begins
\[
2, 12, 20, 54, 120, 284, 660, 1540,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + 2*a(n-2) - 2*a(n-3) - 2*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 09 2019 12:11:53, revision 8) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=1206.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A266050.
