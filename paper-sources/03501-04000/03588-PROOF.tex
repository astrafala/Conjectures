...
\title{The empirical recurrence for OEIS A269049, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A269049 counts arrays over $\{0,\dots,2\}$ subject to a condition on the array as a
...
OEIS A269049 is ``Number of nX5 0..2 arrays with some element plus some horizontally, diagonally or antidiagonally adjacent neighbor totalling two not more than once.''. It has offset $1$ and begins
\[
144, 1068, 13140, 149358, 1643376, 17696520, 187575858, 1964080920,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 18 2016 11:36:19, revision 4) the statement is
...
those integers vanishes from the index corresponding to $n=13+1$ onwards, and the run
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269049.
