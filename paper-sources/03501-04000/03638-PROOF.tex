...
\title{The empirical recurrence for OEIS A210102, proved by counting patterns}
...
\begin{abstract}
OEIS A210102 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A210102 is ``Number of (n+1) X 4 0..2 arrays with every 2 X 2 subblock having one or three distinct values, and new values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
135, 1690, 20687, 254314, 3125615, 38420586, 472285295, 5805666474,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 17*a(n-1) -46*a(n-2) -190*a(n-3) +523*a(n-4) +341*a(n-5) -1220*a(n-6) +184*a(n-7) +488*a(n-8) -96*a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 17 2022 21:28:38, revision 13) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;17\,a(n-1) - 46\,a(n-2) - 190\,a(n-3) + 523\,a(n-4) + 341\,a(n-5) - 1220\,a(n-6) + 184\,a(n-7) + 488\,a(n-8) - 96\,a(n-9)
\end{equation}
for all $n>8$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A210102.
