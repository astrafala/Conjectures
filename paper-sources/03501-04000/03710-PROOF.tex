...
\title{The empirical closed form for OEIS A227330, proved}
...
\begin{abstract}
OEIS A227330 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
$S=217$ vertices. Any function of the form $\sum_j p_j(n)\lambda_j^{\,n}$ satisfies the
...
OEIS A227330 is ``Number of n X 3 0,1 arrays indicating 2 X 2 subblocks of some larger (n+1) X 4 binary array having two adjacent 1's and two adjacent 0's, with rows and columns of the latter in lexicographically nondecreasing order.''. It has offset $1$ and begins
\[
8, 34, 153, 708, 3013, 11292, 37312, 110816,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 23:57:56, revision 8) this is still
...
+ \frac{19 n^{13}}{7472424960} - \frac{n^{12}}{191600640} \\
+ \frac{36577 n^{11}}{14370048000} - \frac{2689 n^{10}}{87091200} \\
+ \frac{436297 n^{9}}{365783040} - \frac{2115367 n^{8}}{121927680} \\
+ \frac{6669593 n^{7}}{23328000} - \frac{13770361 n^{6}}{4354560} \\
+ \frac{104682953 n^{5}}{3592512} - \frac{2364431063 n^{4}}{11975040} \\
+ \frac{366060925289 n^{3}}{378378000} - \frac{487180400717 n^{2}}{151351200} \\
+ \frac{2320943983 n}{360360} - 5585.
\end{multline*}
...
walk, so with $M$ the adjacency matrix of that digraph on $S=217$ vertices, and $u,w$ the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A227330.
