...
\title{The empirical recurrence for OEIS A223481, proved by transfer matrix}
...
\begin{abstract}
OEIS A223481 counts the ways of writing the vertices of a fixed graph $G$ into an array of width
...
single slice is a state and the count is a walk count on a finite digraph with $S=1332$ vertices.
\end{abstract}
...
OEIS A223481 is ``Rolling icosahedron face footprints: number of 3 X n 0..19 arrays starting with 0 where 0..19 label faces of an icosahedron and every array movement to a horizontal or antidiagonal neighbor moves across an icosahedral edge.''. It has offset $1$ and begins
\[
400, 243, 2025, 16875, 147825, 1296675, 11374425, 99776475,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 9*a(n-1) - 2*a(n-2) for n>4.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 20 2018 14:38:27, revision 8) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=1332.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223481.
