...
\title{The empirical recurrence for OEIS A223557, proved by transfer matrix}
...
\begin{abstract}
OEIS A223557 counts the ways of writing the vertices of a fixed graph $G$ into an array of width
$2$ so that any two cells adjacent in one of the named directions carry vertices joined by an
edge of $G$; here $G$ is graph named in the entry. The entry carries an empirical recurrence of order $2$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223557.
