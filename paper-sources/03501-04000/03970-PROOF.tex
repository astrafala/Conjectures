...
\title{The conjectured generating function for OEIS A284485, proved}
...
\begin{abstract}
OEIS A284485 counts arrays of a fixed width under a local condition, and carries a conjectured
