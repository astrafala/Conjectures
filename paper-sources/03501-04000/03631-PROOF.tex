...
\title{The empirical recurrence for OEIS A275039, proved by counting patterns}
...
\begin{abstract}
OEIS A275039 counts arrays in which no entry may repeat a value found at any of three stated
...
OEIS A275039 is ``Number of 4Xn 0..2 arrays with no element equal to any value at offset (0,-1) (-1,-2) or (-2,0) and new values introduced in order 0..2.''. It has offset $1$ and begins
\[
6, 54, 146, 570, 2185, 8273, 31495, 120845,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 14 2016 09:55:38, revision 4) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A275039.
