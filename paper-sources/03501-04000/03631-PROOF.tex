...
\title{The empirical recurrence for OEIS A223364, proved by transfer matrix}
...
\begin{abstract}
OEIS A223364 counts the ways of writing the vertices of a fixed graph $G$ into an array of width
$2$ so that any two cells adjacent in one of the named directions carry vertices joined by an
edge of $G$; here $G$ is triangular graph of side 6. The entry carries an empirical recurrence of order $9$
...
single slice is a state and the count is a walk count on a finite digraph with $S=91$ vertices.
\end{abstract}
...
OEIS A223364 is ``6X6X6 triangular graph coloring a rectangular array: number of nX2 0..20 arrays where 0..20 label nodes of the fully triangulated graph and every array movement to a horizontal or vertical neighbor moves along an edge of this graph.''. It has offset $1$ and begins
\[
90, 990, 11610, 139158, 1686042, 20537766, 250834914, 3067525350,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 17*a(n-1) -44*a(n-2) -208*a(n-3) +363*a(n-4) +659*a(n-5) -448*a(n-6) -364*a(n-7) +66*a(n-8) +24*a(n-9)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 21:34:09, revision 8) this is still
...
consecutive ones. So a $row$, a word of length $2$ over the vertices of $G$, carries
...
of length $2$ over $21$ vertices is one of $21^{2}$ words, but only $S-1$ of them are
...
\begin{theorem}
\[
a(n)\;=\;17\,a(n-1) - 44\,a(n-2) - 208\,a(n-3) + 363\,a(n-4) + 659\,a(n-5) - 448\,a(n-6) - 364\,a(n-7) + 66\,a(n-8) + 24\,a(n-9)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223364.
