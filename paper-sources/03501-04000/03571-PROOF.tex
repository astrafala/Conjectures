...
\title{The empirical closed form for OEIS A184542, proved}
...
\begin{abstract}
OEIS A184542 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
$S=211$ vertices. Any function of the form $\sum_j p_j(n)\lambda_j^{\,n}$ satisfies the
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 13 2018 08:45:54, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{n^{5}}{120} + \frac{5 n^{4}}{24} + \frac{49 n^{3}}{24} + \frac{739 n^{2}}{24} + \frac{1659 n}{20} + 31.
\]
...
walk, so with $M$ the adjacency matrix of that digraph on $S=211$ vertices, and $u,w$ the
