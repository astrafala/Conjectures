...
\title{The empirical recurrence for OEIS A231822, proved by transfer matrix}
...
\begin{abstract}
OEIS A231822 counts arrays of width $2$ over $\{0,1,2\}$ in which no cell is beaten by a strict majority of its neighbours. The entry carries an
...
$3$ consecutive rows and the count is a walk count on $S=82$ states.
\end{abstract}
...
OEIS A231822 is ``Number of n X 2 0..2 arrays with no element having a strict majority of its horizontal, vertical and antidiagonal neighbors equal to itself plus one mod 3, with upper left element zero (rock paper and scissors drawn positions).''. It has offset $1$ and begins
\[
1, 9, 64, 439, 2992, 20382, 138852, 945923,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 9*a(n-1) - 16*a(n-2) + 11*a(n-3) - 27*a(n-4) + 21*a(n-5) - 4*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 01 2018 06:28:00, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;9\,a(n-1) - 16\,a(n-2) + 11\,a(n-3) - 27\,a(n-4) + 21\,a(n-5) - 4\,a(n-6)
\]
for every $n>5$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231822.
