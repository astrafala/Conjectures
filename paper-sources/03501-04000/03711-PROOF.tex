...
\title{The empirical recurrence for OEIS A268783, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A268783 counts arrays over $\{0,\dots,1\}$ subject to a condition on the array as a
...
OEIS A268783 is ``Number of n X 2 binary arrays with some element plus some horizontally, vertically or antidiagonally adjacent neighbor totalling two exactly once.''. It has offset $1$ and begins
\[
1, 5, 17, 48, 131, 338, 850, 2091,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) + 3*a(n-2) - 2*a(n-3) - 6*a(n-4) - 4*a(n-5) - a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 15 2019 09:14:26, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268783.
