...
\title{The empirical recurrence for OEIS A274724, proved by counting patterns}
...
\begin{abstract}
OEIS A274724 counts arrays in which no entry may repeat a value found at any of three stated
...
OEIS A274724 is ``Number of nX4 0..2 arrays with no element equal to any value at offset (-1,-2) (-2,-1) or (-1,0) and new values introduced in order 0..2.''. It has offset $1$ and begins
\[
14, 96, 296, 1632, 9308, 52912, 301784, 1721528,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) +13*a(n-2) +14*a(n-3) +4*a(n-4) -28*a(n-5) -13*a(n-6) -7*a(n-7) +15*a(n-8) for n>12
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 03 2016 19:59:51, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 13\,a(n-2) + 14\,a(n-3) + 4\,a(n-4) - 28\,a(n-5) - 13\,a(n-6) - 7\,a(n-7) + 15\,a(n-8)
\end{equation}
for all $n>12$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A274724.
