...
\title{The conjectured generating function for OEIS A286521, proved}
...
\begin{abstract}
OEIS A286521 counts arrays of a fixed width under a local condition, and carries a conjectured
...
OEIS A286521 is ``Decimal representation of the diagonal from the origin to the corner (or of the corner to the origin) of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 659", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 3, 5, 15, 31, 63,\ \dots
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A286521.
