...
\title{The empirical recurrence for OEIS A224199, proved by transfer matrix}
...
\begin{abstract}
OEIS A224199 counts arrays over $\{0,\dots,3\}$ whose rows, columns, diagonals or
...
is a walk count on $S=50$ vertices and the recurrence follows from a finite exact
computation.
\end{abstract}
...
OEIS A224199 is ``Number of nX3 0..3 arrays with rows unimodal and antidiagonals nondecreasing.''. It has offset $1$ and begins
\[
50, 984, 16060, 263516, 4357084, 72105068, 1193130640, 19742052632,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 20*a(n-1) -70*a(n-2) +228*a(n-3) -276*a(n-4) +392*a(n-5) -196*a(n-6) +144*a(n-7)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 23:18:47, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;20\,a(n-1) - 70\,a(n-2) + 228\,a(n-3) - 276\,a(n-4) + 392\,a(n-5) - 196\,a(n-6) + 144\,a(n-7)
\end{equation}
for all $n>7$.
...
bit vector), $|\mathcal V|=S=50$; let $(r,f)\to(s,f')$ be an edge when placing $s$ after $r$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224199.
