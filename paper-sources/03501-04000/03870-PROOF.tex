...
\title{The conjectured generating function for OEIS A284352, proved}
...
\begin{abstract}
OEIS A284352 counts arrays of a fixed width under a local condition, and carries a conjectured
...
coefficients of their expansions do. Comparing $13$ coefficients in exact arithmetic
...
OEIS A284352 is ``Binary representation of the x-axis, from the origin to the right edge, of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 899", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 10, 111, 1011, 11111, 101111,\ \dots
\]
The entry states, as a conjecture contributed by a reader and never marked settled:
\begin{quote}
G.f.: (1 + 9*x + x\^{}2) / ((1 - x)*(1 - 10*x)*(1 + 10*x)).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 05 2025 15:22:38, revision 13) this is still
...
exact integer arithmetic, those of $N_2/D_2$ by exact rational long division, and $13$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A284352.
