...
\title{The empirical column recurrences for the table OEIS A235555}
...
\begin{abstract}
OEIS A235555 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A235555 is ``T(n,k)=Number of (n+1)X(k+1) 0..1 arrays with the sum of each 2X2 subblock two extreme terms minus its two median terms lexicographically nondecreasing rowwise and columnwise.''. It has offset $1$, is
read by antidiagonals, and begins
\[
16, 46, 46, 120, 202, 120, 288, 814,\ \dots
\]
...
k=3: [order 55]\\
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 08:38:25, revision 6) these are still
...
The sequence is ``Number of (n+1)X2 0..1 arrays with the sum of each 2X2 subblock two extreme terms minus its two median terms lexicographically nondecreasing rowwise and columnwise.''. Its rows are the vertices of a digraph on
$S=15$ vertices, edges being the admissible consecutive pairs, and the count is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A235555.
