...
\title{The empirical recurrence for OEIS A223994, proved by transfer matrix}
...
\begin{abstract}
OEIS A223994 counts arrays over $\{0,\dots,2\}$ whose rows, columns, diagonals or
...
is a walk count on $S=80$ vertices and the recurrence follows from a finite exact
computation.
\end{abstract}
...
OEIS A223994 is ``Number of nX3 0..2 arrays with antidiagonals unimodal and rows and diagonals nondecreasing.''. It has offset $1$ and begins
\[
10, 76, 476, 2980, 18672, 117386, 739672, 4664776,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 10*a(n-1) -24*a(n-2) -2*a(n-3) +30*a(n-4) +96*a(n-5) -150*a(n-6) -108*a(n-7) +48*a(n-8) +270*a(n-9)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 23:09:33, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;10\,a(n-1) - 24\,a(n-2) - 2\,a(n-3) + 30\,a(n-4) + 96\,a(n-5) - 150\,a(n-6) - 108\,a(n-7) + 48\,a(n-8) + 270\,a(n-9)
\end{equation}
for all $n>9$.
...
bit vector), $|\mathcal V|=S=80$; let $(r,f)\to(s,f')$ be an edge when placing $s$ after $r$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223994.
