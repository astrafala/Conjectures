...
\title{The empirical recurrence for OEIS A235511, proved by transfer matrix}
...
\begin{abstract}
OEIS A235511 counts arrays of width $3$ over $\{0,1\}$ by reducing every $2\times2$ subblock to a
...
about it is one bit per adjacent pair of columns, so the count is a walk count on $S=36$
states.
\end{abstract}
...
OEIS A235511 is ``Number of (n+1)X(2+1) 0..1 arrays with the sum of each 2X2 subblock maximum and minimum lexicographically nondecreasing rowwise and columnwise.''. It has offset $1$ and begins
\[
58, 382, 2501, 16117, 103736, 666171, 4277473, 27457539,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 08:35:16, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-1) - 2\,a(n-2) - 66\,a(n-3) + 70\,a(n-4) + 142\,a(n-5) - 152\,a(n-6) - 166\,a(n-7) + 114\,a(n-8) + 110\,a(n-9) - 22\,a(n-10) - 26\,a(n-11) + a(n-12) + 2\,a(n-13)
\]
for every $n>11$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A235511.
