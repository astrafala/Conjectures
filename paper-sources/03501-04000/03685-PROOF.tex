...
\title{The empirical recurrence for OEIS A202790, proved by transfer matrix}
...
\begin{abstract}
OEIS A202790 counts arrays of width $3$ over $\{0,1\}$ in which every cell of a named value has a neighbour of that same value. The entry carries an
...
OEIS A202790 is ``Number of n X 3 binary arrays with every one adjacent to another one horizontally, diagonally, antidiagonally or vertically.''. It has offset $1$ and begins
\[
4, 50, 398, 3018, 23436, 182430, 1417772, 11017196,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 7*a(n-1) +2*a(n-2) +29*a(n-3) +16*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 01 2018 14:18:41, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-1) + 2\,a(n-2) + 29\,a(n-3) + 16\,a(n-4)
\]
for every $n>3$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A202790.
