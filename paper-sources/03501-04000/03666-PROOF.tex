...
\title{The empirical recurrence for OEIS A275038, proved by counting patterns}
...
\begin{abstract}
OEIS A275038 counts arrays in which no entry may repeat a value found at any of three stated
...
OEIS A275038 is ``Number of 3 X n 0..2 arrays with no element equal to any value at offset (0,-1) (-1,-2) or (-2,0) and new values introduced in order 0..2.''. It has offset $1$ and begins
\[
3, 18, 46, 137, 401, 1152, 3336, 9720,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) - 2*a(n-2) + 4*a(n-3) + a(n-4) + 3*a(n-5) + 8*a(n-6) + a(n-7) - 3*a(n-8) - a(n-9) for n>10.
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 31 2019 09:22:32, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A275038.
