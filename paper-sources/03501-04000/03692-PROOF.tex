...
\title{The empirical closed form for OEIS A223861, proved}
...
\begin{abstract}
OEIS A223861 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A223861 is ``Number of nX5 0..3 arrays with rows and antidiagonals unimodal and columns nondecreasing.''. It has offset $1$ and begins
\[
296, 14751, 273959, 3017129, 23738426, 145947740, 740441932, 3217594840,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 22:45:40, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\begin{multline*}
f(n)\;=\;\frac{769 n^{15}}{444787200} + \frac{769 n^{14}}{14826240} \\
+ \frac{1364177 n^{13}}{1556755200} + \frac{4745443 n^{12}}{479001600} \\
+ \frac{19610293 n^{11}}{239500800} + \frac{21660577 n^{10}}{43545600} \\
+ \frac{51383569 n^{9}}{21772800} + \frac{4604039 n^{8}}{537600} \\
+ \frac{65760287 n^{7}}{2721600} + \frac{2366026111 n^{6}}{43545600} \\
+ \frac{21481491623 n^{5}}{239500800} + \frac{11196959227 n^{4}}{119750400} \\
- \frac{1120821577 n^{3}}{51891840} - \frac{1312521589 n^{2}}{10810800} \\
+ \frac{8123611 n}{51480} - 113.
\end{multline*}
...
$n=19,\dots,34$ and agree at each. A monic recurrence of order $16$
determines $a(m)$ from $a(m-1),\dots,a(m-16)$, and for every $m\ge35$ both
$m>18$ and $m-16\ge19$ hold, so induction on $m$ gives $a(m)=f(m)$ for every
$m\ge19$.
Below $n=19$ the recurrence argument gives nothing, since \eqref{eq:rec} is only
established for $a$ from $n=19$ on. The remaining indices $n=3,\dots,18$ were
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223861.
