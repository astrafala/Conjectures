...
\title{The conjectured generating function for OEIS A280368, proved}
...
\begin{abstract}
OEIS A280368 counts arrays of a fixed width under a local condition, and carries a conjectured
...
\[
1, 10, 110, 1, 11000, 111,\ \dots
\]
The entry states, as a conjecture contributed by a reader and never marked settled:
\begin{quote}
G.f.: (1 + 10*x + 9*x\^{}2 - 1009*x\^{}3 - 10*x\^{}4 + 1010*x\^{}5) / ((1 - x)*(1 + x)*(1 - 10*x)*(1 + 10*x)).
\end{quote}
