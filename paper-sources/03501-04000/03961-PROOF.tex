...
\title{The empirical column recurrences for the table OEIS A229672}
...
\begin{abstract}
OEIS A229672 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A229672 is ``T(n,k) = number of defective 4-colorings of an n X k 0..3 array connected horizontally, antidiagonally and vertically with exactly two mistakes, and colors introduced in row-major 0..3 order.''. It has offset $1$, is
read by antidiagonals, and begins
\[
0, 0, 0, 1, 4, 1, 3, 61,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 28 2021 01:25:46, revision 9) these are still
...
The sequence is ``Number of defective 4-colorings of an n X 1 0..3 array connected horizontally, antidiagonally and vertically with exactly two mistakes, and colors introduced in row-major 0..3 order.''. Its rows are the vertices of a digraph on
...
The sequence is ``Number of defective 4-colorings of an n X 2 0..3 array connected horizontally, antidiagonally and vertically with exactly two mistakes, and colors introduced in row-major 0..3 order.''. Its rows are the vertices of a digraph on
...
model reproduces $17$ published values, $47$ decimal digits in all, every one of
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A229672.
