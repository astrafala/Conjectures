...
\title{The empirical recurrence for OEIS A269085, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A269085 counts arrays over $\{0,\dots,1\}$ subject to a condition on the array as a
...
OEIS A269085 is ``Number of nX4 binary arrays with some element plus some horizontally, vertically or antidiagonally adjacent neighbor totalling two not more than once.''. It has offset $1$ and begins
\[
13, 76, 428, 2238, 11314, 55620, 268289, 1274435,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 19 2016 09:20:56, revision 4) the statement is
...
those integers vanishes from the index corresponding to $n=16+1$ onwards, and the run
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269085.
