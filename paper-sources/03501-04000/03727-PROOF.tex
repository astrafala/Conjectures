...
\title{The empirical recurrence for OEIS A268973, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A268973 counts arrays over $\{0,\dots,2\}$ subject to a condition on the array as a
...
OEIS A268973 is ``Number of 3 X n 0..2 arrays with some element plus some horizontally or antidiagonally adjacent neighbor totalling two not more than once.''. It has offset $1$ and begins
\[
27, 336, 2016, 11664, 63792, 339480, 1770048, 9084744,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 10*a(n-1) - 29*a(n-2) + 20*a(n-3) - 4*a(n-4) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 17 2019 17:20:34, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;10\,a(n-1) - 29\,a(n-2) + 20\,a(n-3) - 4\,a(n-4)
\end{equation}
for all $n>6$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268973.
