...
\title{The conjectured generating function for OEIS A279874, proved}
...
\begin{abstract}
OEIS A279874 counts arrays of a fixed width under a local condition, and carries a conjectured
...
\[
1, 10, 101, 1110, 1, 111010,\ \dots
\]
The entry states, as a conjecture contributed by a reader and never marked settled:
\begin{quote}
G.f.: (1 +10*x +x\^{}2 +110*x\^{}3 -10100*x\^{}4 +10000*x\^{}6 -990000*x\^{}7 +99000000*x\^{}8 +100000000*x\^{}9 -10000000000*x\^{}10 -100000000*x\^{}12 +10000000000*x\^{}14) / ((1 -x)*(1 +x)*(1 -10*x)*(1 +10*x)*(1 +x\^{}2)).
\end{quote}
