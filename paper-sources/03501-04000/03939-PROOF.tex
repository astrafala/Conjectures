...
\title{The empirical recurrence for OEIS A208253, proved by counting patterns}
...
\begin{abstract}
OEIS A208253 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A208253 is ``Number of n X 3 0..2 arrays with new values 0..2 introduced in row major order and no element equal to more than one of its immediate leftward or upward neighbors.''. It has offset $1$ and begins
\[
5, 96, 2040, 43344, 920928, 19566912, 415737216, 8833148160,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 22*a(n-1) - 16*a(n-2) for n>3.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 29 2018 08:06:46, revision 9) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208253.
