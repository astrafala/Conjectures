...
\title{The empirical recurrence for OEIS A209822, proved by counting patterns}
...
\begin{abstract}
OEIS A209822 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A209822 is ``Number of (n+1) X 2 0..2 arrays with every 2 X 2 subblock having one or two distinct values, and new values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
8, 41, 218, 1169, 6278, 33725, 181178, 973337,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 6*a(n-1) - 3*a(n-2) - 2*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 13 2018 05:48:10, revision 8) the statement is
...
\eqref{eq:walk}, divided by $3!$, was evaluated at every one of the $20$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209822.
