...
\title{The empirical closed form for OEIS A224016, proved}
...
\begin{abstract}
OEIS A224016 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A224016 is ``Number of 6Xn 0..2 arrays with rows nondecreasing and antidiagonals unimodal.''. It has offset $1$ and begins
\[
729, 46656, 534352, 3094127, 13275381, 47735665, 150787422, 430109607,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 23:10:32, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\begin{multline*}
f(n)\;=\;\frac{761 n^{12}}{8553600} + \frac{811 n^{11}}{302400} \\
+ \frac{4879 n^{10}}{97200} + \frac{230029 n^{9}}{362880} \\
+ \frac{10666727 n^{8}}{1814400} + \frac{6162019 n^{7}}{151200} \\
+ \frac{76144063 n^{6}}{388800} + \frac{1772311 n^{5}}{2688} \\
+ \frac{230134279 n^{4}}{194400} + \frac{14927389 n^{3}}{453600} \\
- \frac{7982908 n^{2}}{51975} + \frac{2910398 n}{315} \\
+ 7207.
\end{multline*}
...
$n=18,\dots,30$ and agree at each. A monic recurrence of order $13$
determines $a(m)$ from $a(m-1),\dots,a(m-13)$, and for every $m\ge31$ both
$m>17$ and $m-13\ge18$ hold, so induction on $m$ gives $a(m)=f(m)$ for every
$m\ge18$.
Below $n=18$ the recurrence argument gives nothing, since \eqref{eq:rec} is only
established for $a$ from $n=18$ on. The remaining indices $n=5,\dots,17$ were
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224016.
