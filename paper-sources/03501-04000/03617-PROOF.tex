...
\title{The empirical closed form for OEIS A207597, proved}
...
\begin{abstract}
OEIS A207597 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A207597 is ``Number of n X 6 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 0 1 and 1 0 1 vertically.''. It has offset $1$ and begins
\[
25, 625, 3025, 9025, 21025, 42025, 75625, 126025,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 25*n\^{}4 + 50*n\^{}3 - 25*n\^{}2 - 50*n + 25.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 25 2018 06:08:29, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;25 n^{4} + 50 n^{3} - 25 n^{2} - 50 n + 25.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207597.
