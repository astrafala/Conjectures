...
\title{The conjectured generating function for OEIS A063081, proved}
...
\begin{abstract}
OEIS A063081 counts arrays of a fixed width under a local condition, and carries a conjectured
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 22 2025 22:57:00, revision 17) this is still
...
model reproduces all $50$ terms the entry publishes, exactly, in integer arithmetic --- a
