...
\title{The empirical recurrence for OEIS A231317, proved by transfer matrix}
...
\begin{abstract}
OEIS A231317 counts $(n+1)\times2$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A231317 is ``Number of (n+1) X (1+1) 0..2 arrays with no element equal to a strict majority of its diagonal and antidiagonal neighbors, with values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
6, 24, 216, 1536, 11616, 86400, 645504, 4816896,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 6*a(n-1) + 12*a(n-2) - 8*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 18 2018 06:59:15, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231317.
