...
\title{The empirical closed form for OEIS A224258, proved}
...
\begin{abstract}
OEIS A224258 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A224258 is ``Number of n X 4 0..2 arrays with rows, diagonals and antidiagonals unimodal and columns nondecreasing.''. It has offset $1$ and begins
\[
46, 548, 3096, 12467, 41012, 116692, 296646, 688533,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 18 2025 22:33:05, revision 11) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{41 n^{8}}{4032} + \frac{9 n^{7}}{112} + \frac{349 n^{6}}{480} + \frac{69 n^{5}}{20} + \frac{1325 n^{4}}{192} + \frac{1571 n^{3}}{48} + \frac{87503 n^{2}}{5040} - \frac{21949 n}{420} + 43.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224258.
