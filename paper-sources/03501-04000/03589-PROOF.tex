...
\title{The empirical closed form for OEIS A208378, proved}
...
\begin{abstract}
OEIS A208378 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A208378 is ``Number of n X 7 0..1 arrays avoiding 0 0 0 and 1 1 1 horizontally and 0 0 1 and 1 0 1 vertically.''. It has offset $1$ and begins
\[
42, 1764, 6216, 13860, 25200, 40740, 60984, 86436,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 84*n\^{}3 + 840*n\^{}2 - 1344*n + 420 for n>1.
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 02 2018 08:37:36, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;84 n^{3} + 840 n^{2} - 1344 n + 420.
\]
...
$n=6,\dots,9$ and agree at each. A monic recurrence of order $4$
determines $a(m)$ from $a(m-1),\dots,a(m-4)$, and for every $m\ge10$ both
$m>5$ and $m-4\ge6$ hold, so induction on $m$ gives $a(m)=f(m)$ for every
$m\ge6$.
Below $n=6$ the recurrence argument gives nothing, since \eqref{eq:rec} is only
established for $a$ from $n=6$ on. The remaining indices $n=2,\dots,5$ were
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208378.
