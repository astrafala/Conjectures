...
\title{The empirical closed form for OEIS A224149, proved}
...
\begin{abstract}
OEIS A224149 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
$S=6144$ vertices. Any function of the form $\sum_j p_j(n)\lambda_j^{\,n}$ satisfies the
...
OEIS A224149 is ``Number of 5 X n 0..1 arrays with rows and antidiagonals unimodal and columns nondecreasing.''. It has offset $1$ and begins
\[
6, 36, 155, 526, 1509, 3827, 8838, 18969,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 28 2018 07:08:10, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{n^{10}}{3628800} + \frac{n^{9}}{241920} + \frac{11 n^{8}}{120960} + \frac{59 n^{7}}{40320} + \frac{3853 n^{6}}{172800} + \frac{181 n^{5}}{1280} + \frac{100381 n^{4}}{181440} + \frac{76319 n^{3}}{60480} + \frac{24247 n^{2}}{12600} + \frac{23 n}{21} + 1.
\]
...
walk, so with $M$ the adjacency matrix of that digraph on $S=6144$ vertices, and $u,w$ the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224149.
