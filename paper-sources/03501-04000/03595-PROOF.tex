...
\title{The empirical recurrence for OEIS A279704, proved by transfer matrix}
...
\begin{abstract}
OEIS A279704 counts $n\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A279704 is ``Number of n X 3 0..1 arrays with no element equal to a strict majority of its horizontal and antidiagonal neighbors and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
1, 3, 11, 42, 161, 617, 2364, 9057,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 5*a(n-1) - 5*a(n-2) + 2*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 11 2019 12:06:37, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A279704.
