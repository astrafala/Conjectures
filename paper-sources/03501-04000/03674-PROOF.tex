...
\title{The empirical column recurrences for the table OEIS A295051}
...
\begin{abstract}
OEIS A295051 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A295051 is ``T(n,k) = Number of n X k 0..1 arrays with each 1 horizontally or vertically adjacent to 0 or 2 1's.''. It has offset $1$, is
read by antidiagonals, and begins
\[
2, 3, 3, 5, 8, 5, 8, 19,\ \dots
\]
...
k=5: [order 49].\\
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 03 2022 21:51:55, revision 6) these are still
...
The sequence is ``Number of n X 2 0..1 arrays with each 1 horizontally or vertically adjacent to 0 or 2 1's.''. Its rows are the vertices of a digraph on
...
model reproduces $9$ published values, $23$ decimal digits in all, every one of
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A295051.
