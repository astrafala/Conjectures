...
\title{The empirical column recurrences for the table OEIS A251390}
...
\begin{abstract}
OEIS A251390 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A251390 is ``T(n,k)=Number of (n+1)X(k+1) 0..2 arrays with every 2X2 subblock summing to 2 3 4 5 or 6.''. It has offset $1$, is
read by antidiagonals, and begins
\[
71, 571, 571, 4585, 12457, 4585, 36825, 271393,\ \dots
\]
The entry carries the following block:
\begin{quote}\small
Empirical for column k:\\
k=1: a(n) = 8*a(n-1) +a(n-2) -6*a(n-3)\\
k=2: a(n) = 23*a(n-1) -21*a(n-2) -119*a(n-3) +66*a(n-4) +72*a(n-5) -32*a(n-6)\\
k=3: [order 15]\\
k=4: [order 40]\\
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 10:25:34, revision 6) these are still
...
The sequence is ``Number of (n+1)X(2) 0..2 arrays with every 2X2 subblock summing to 2 3 4 5 or 6.''. Its rows are the vertices of a digraph on
...
$c_{1}$ & $63$ & $c_{5}$ & $104334$ & $c_{9}$ & $1584245$ & $c_{13}$ & $-339424$ \\
$c_{2}$ & $-155$ & $c_{6}$ & $-242452$ & $c_{10}$ & $-2822088$ & $c_{14}$ & $-296064$ \\
$c_{3}$ & $-4658$ & $c_{7}$ & $-787537$ & $c_{11}$ & $-447621$ & $c_{15}$ & $90240$ \\
$c_{4}$ & $12612$ & $c_{8}$ & $1342994$ & $c_{12}$ & $1812174$ &  &  \\
\end{tabular}\end{center}
Repeating with the first $15+4$ terms removed gives order $15$ again.

\subsection*{Column $k=4$, recovered}
The entry gives only the order for this line: ``k=4: [order 40]''. Its model is a walk on
...
$40$ --- the stated order --- with integer coefficients
\[
(c_1,\dots,c_{40})=(181,\ -2746,\ -101967,\ 1773145,\ 20348444,\ -368196815,\ -1817676780,\ 34050885969,\ 68842086450,\ -1596722070406,\ -371879429359,\ 40050415526368,\ -39169264660214,\ -536027390436087,\ 988306992895554,\ 3742597767228864,\ -9869631170827003,\ -13304148137941245,\ 52053108117628136,\ 18404308099172964,\ -161484840791772744,\ 25956089194520086,\ 309568007566419607,\ -146656617600451265,\ -373299689053722066,\ 260106568902966205,\ 281607598468032033,\ -251171454190439420,\ -128884855406189532,\ 144229928356813428,\ 33210696300928036,\ -49834078938247524,\ -3873133974409328,\ 10107197179378480,\ -24317744230880,\ -1133607752381056,\ 39921960253568,\ 62475622037504,\ -1879763398656,\ -1321910913024).
\]
Repeating with the first $40+4$ terms removed gives order $40$ again.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251390.
