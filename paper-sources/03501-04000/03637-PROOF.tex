...
\title{The empirical recurrence for OEIS A262417, proved by transfer matrix}
...
\begin{abstract}
OEIS A262417 counts arrays of width $6$ over $\{0,1\}$ whose rows, read as base-$2$
...
OEIS A262417 is ``Number of (n+1)X(5+1) 0..1 arrays with each row divisible by 3 and column not divisible by 3, read as a binary number with top and left being the most significant bits.''. It has offset $1$ and begins
\[
22, 709, 15310, 428301, 9401742, 220808869, 4856629870, 108673357501,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 22 2015 09:29:27, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;22\,a(n-1) + 215\,a(n-2) - 4730\,a(n-3) - 14143\,a(n-4) + 311146\,a(n-5) + 364285\,a(n-6) - 8014270\,a(n-7) - 3615956\,a(n-8) + 79551032\,a(n-9) + 9486400\,a(n-10) - 208700800\,a(n-11)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A262417.
