...
\title{The empirical recurrence for OEIS A269077, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A269077 counts arrays over $\{0,\dots,1\}$ subject to a condition on the array as a
...
which is what keeps the digraph sparse. That makes $a(n)$ a walk count on $S=16$ vertices,
...
OEIS A269077 is ``Number of 3 X n binary arrays with some element plus some horizontally, diagonally or antidiagonally adjacent neighbor totalling two not more than once.''. It has offset $1$ and begins
\[
8, 32, 123, 521, 1887, 7477, 27042, 102070,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 4*a(n-1) + 8*a(n-2) - 34*a(n-3) - 16*a(n-4) + 60*a(n-5) - 25*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 18 2019 14:38:58, revision 7) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) + 8\,a(n-2) - 34\,a(n-3) - 16\,a(n-4) + 60\,a(n-5) - 25\,a(n-6)
\end{equation}
for all $n>6$.
...
\[
\mathcal V=\bigl\{(r,c):\ r\in\{0,\dots,1\}^{3},\ c\in\{0,1\}\bigr\},
\qquad |\mathcal V|=S=16,
\]
...
the digraph dense, with $(1+1)^{2\cdot3}$ edges instead of the sparse set used here.
\end{remark}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269077.
