...
\title{The empirical recurrence for OEIS A268775, proved by transfer matrix}
...
\begin{abstract}
OEIS A268775 counts arrays of width $2$ over $\{0,1\}$ in which the number of adjacent PAIRS of
...
result is a walk count on $S=12$ states.
\end{abstract}
...
OEIS A268775 is ``Number of n X 2 binary arrays with some element plus some horizontally, vertically, diagonally or antidiagonally adjacent neighbor totalling two no more than once.''. It has offset $1$ and begins
\[
4, 11, 26, 65, 148, 343, 766, 1709,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + 3*a(n-2) - 4*a(n-3) - 4*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 16 2025 07:35:42, revision 13) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The array has $2$ cells across, with entries in $\{0,1\}$. An ADJACENT PAIR is a pair of cells
\[
\begin{array}{l}
$(i,j)\text{ and }(i,j{+}1)$ \\
$(i,j)\text{ and }(i{+}1,j)$ \\
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268775.
