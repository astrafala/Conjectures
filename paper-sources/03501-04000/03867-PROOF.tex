...
\title{The empirical recurrence for OEIS A263692, proved by transfer matrix}
...
\begin{abstract}
OEIS A263692 carries an empirical recurrence of order $4$ contributed by R.~H.~Hardin. It is
...
OEIS A263692 is ``Number of length n arrays of permutations of 0..n-1 with each element moved by -3 to 3 places and every three consecutive elements having its maximum within 3 of its minimum.''. It has offset $1$ and begins
\[
1, 2, 6, 24, 18, 18, 24, 40,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + a(n-2) - a(n-3) + a(n-4) for n>12.
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 02 2019 23:12:14, revision 11) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A263692.
