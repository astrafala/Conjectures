...
\title{The empirical recurrence for OEIS A205754, proved by transfer matrix}
...
\begin{abstract}
OEIS A205754 counts, up to renaming the letters, the arrays of width $3$ over at most $3$
...
OEIS A205754 is ``Number of 3X(n+1) 0..2 arrays with every 2X2 subblock having the same number of equal edges as its horizontal neighbors and a different number from its vertical neighbors, and new values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
74, 284, 1074, 4256, 16986, 68692, 279504, 1143842,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 12:15:17, revision 9) this is still
...
$w_i$ cleared of denominators and $S=468$ states in all. The walk index $j$ and the entry's own
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-1) - 2\,a(n-2) - 98\,a(n-3) + 73\,a(n-4) + 496\,a(n-5) - 196\,a(n-6) - 1120\,a(n-7) - 54\,a(n-8) + 813\,a(n-9) + 171\,a(n-10) - 90\,a(n-11)
\]
for every $n>11$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A205754.
