...
\title{The empirical recurrence for OEIS A211598, proved by transfer matrix}
...
\begin{abstract}
OEIS A211598 carries an empirical recurrence of order $13$ contributed by R. H. Hardin. It is
...
OEIS A211598 is ``Number of -2..2 arrays x(i) of n+1 elements i=1..n+1 with set{t,u,v in 0,1}((x[i+t]+x[j+u]+x[k+v])*(-1)\^{}(t+u+v)) having four, five, six, seven or eight distinct values for every i,j,k<=n.''. It has offset $1$ and begins
\[
16, 48, 128, 322, 780, 1874, 4400, 10458,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 16:16:34, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 16\,a(n-2) - 31\,a(n-3) - 97\,a(n-4) + 178\,a(n-5) + 284\,a(n-6) - 473\,a(n-7) - 418\,a(n-8) + 578\,a(n-9) + 288\,a(n-10) - 270\,a(n-11) - 72\,a(n-12) + 36\,a(n-13)
\]
for every $n>13$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A211598.
