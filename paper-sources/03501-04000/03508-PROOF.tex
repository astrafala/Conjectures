...
\title{The empirical recurrence for OEIS A208640, proved by transfer matrix}
...
\begin{abstract}
OEIS A208640 counts $5\times n$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A208640 is ``Number of 5 X n 0..1 arrays with new values 0..1 introduced in row major order and no element equal to more than one of its immediate leftward or upward or right-upward antidiagonal neighbors.''. It has offset $1$ and begins
\[
16, 89, 284, 722, 1652, 3577, 7504, 15448,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 6*a(n-1) - 14*a(n-2) + 16*a(n-3) - 9*a(n-4) + 2*a(n-5) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 05 2018 14:15:27, revision 9) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208640.
