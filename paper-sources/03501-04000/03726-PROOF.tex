...
\title{The empirical recurrence for OEIS A208086, proved by transfer matrix}
...
\begin{abstract}
OEIS A208086 counts, up to renaming the letters, the arrays of width $4$ over at most $2$
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 27 2018 14:17:42, revision 8) this is still
...
$w_i$ cleared of denominators and $S=48$ states in all. The walk index $j$ and the entry's own
