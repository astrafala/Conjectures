...
\title{The empirical closed form for OEIS A223983, proved}
...
\begin{abstract}
OEIS A223983 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
$S=130$ vertices. Any function of the form $\sum_j p_j(n)\lambda_j^{\,n}$ satisfies the
...
OEIS A223983 is ``Number of nX4 0..3 arrays with rows unimodal and columns nondecreasing.''. It has offset $1$ and begins
\[
130, 3526, 44803, 358118, 2086196, 9647292, 37395816, 126087157,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 23:08:12, revision 8) this is still
...
+ \frac{132341 n^{10}}{4354560} + \frac{177787 n^{9}}{725760} \\
+ \frac{1892753 n^{8}}{1451520} + \frac{5834147 n^{7}}{1209600} \\
+ \frac{11057083 n^{6}}{870912} + \frac{17370313 n^{5}}{725760} \\
+ \frac{6973385 n^{4}}{217728} + \frac{26874943 n^{3}}{907200} \\
+ \frac{186503 n^{2}}{10395} + \frac{8831 n}{1386} \\
+ 1.
\end{multline*}
...
walk, so with $M$ the adjacency matrix of that digraph on $S=130$ vertices, and $u,w$ the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223983.
