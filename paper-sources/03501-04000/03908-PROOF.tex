...
\title{The empirical closed form for OEIS A223618, proved}
...
\begin{abstract}
OEIS A223618 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A223618 is ``Number of nX6 0..1 arrays with rows and columns unimodal.''. It has offset $1$ and begins
\[
22, 484, 6504, 57238, 367216, 1856100, 7795951, 28248007,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 21:52:47, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\begin{multline*}
f(n)\;=\;\frac{271 n^{12}}{5443200} + \frac{2327 n^{11}}{3326400} \\
+ \frac{39107 n^{10}}{5443200} + \frac{1579 n^{9}}{36288} \\
+ \frac{52553 n^{8}}{259200} + \frac{192371 n^{7}}{302400} \\
+ \frac{8636441 n^{6}}{5443200} + \frac{56113 n^{5}}{20160} \\
+ \frac{2901677 n^{4}}{680400} + \frac{523927 n^{3}}{113400} \\
+ \frac{23969 n^{2}}{5400} + \frac{33487 n}{13860} \\
+ 1.
\end{multline*}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223618.
