...
\title{The empirical recurrence for OEIS A208860, proved by counting patterns}
...
\begin{abstract}
OEIS A208860 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A208860 is ``Number of nX4 0..3 arrays with new values 0..3 introduced in row major order and no element equal to more than one of its immediate leftward or upward or left-upward diagonal neighbors.''. It has offset $1$ and begins
\[
15, 1691, 273049, 44452082, 7240366702, 1179377179523, 192108983085145, 31292693945057258,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 15:02:40, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;219\,a(n-1) - 10289\,a(n-2) + 197167\,a(n-3) - 1651023\,a(n-4) + 4615685\,a(n-5) + 5157645\,a(n-6) - 45444123\,a(n-7) + 78064236\,a(n-8) - 63363708\,a(n-9) + 40081392\,a(n-10) - 18662400\,a(n-11)
\end{equation}
for all $n>12$.
...
corresponding to $n=12+1$ onwards, and the run continued until $w$ was the zero vector,
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208860.
