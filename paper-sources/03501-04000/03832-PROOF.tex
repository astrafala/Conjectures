...
\title{The empirical recurrence for OEIS A223676, proved by transfer matrix}
...
\begin{abstract}
OEIS A223676 counts arrays over $\{0,\dots,1\}$ whose rows, columns, diagonals or
...
OEIS A223676 is ``Number of nX4 0..1 arrays with rows and antidiagonals unimodal.''. It has offset $1$ and begins
\[
11, 121, 1118, 9822, 85663, 744272, 6458585, 56030742,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 11*a(n-1) -21*a(n-2) +18*a(n-3) -114*a(n-4) +183*a(n-5) -96*a(n-6) +80*a(n-7) -65*a(n-8) +16*a(n-9)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 22:06:19, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;11\,a(n-1) - 21\,a(n-2) + 18\,a(n-3) - 114\,a(n-4) + 183\,a(n-5) - 96\,a(n-6) + 80\,a(n-7) - 65\,a(n-8) + 16\,a(n-9)
\end{equation}
for all $n>9$.
...
every one of the $18$ published indices, with no shift fitted. The values agree exactly.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223676.
