...
\title{The empirical recurrence for OEIS A252965, proved by transfer matrix}
...
\begin{abstract}
OEIS A252965 counts arrays of width $6$ over an alphabet of $5$ letters in which every three
...
OEIS A252965 is ``Number of (4+2)X(n+2) 0..4 arrays with every consecutive three elements in every row and diagonal having exactly two distinct values, and in every column and antidiagonal not having exactly two distinct values, and new values 0 upwards introduced in row major order.''. It has offset $1$ and begins
\[
711, 337, 443, 674, 1027, 1551, 2349, 3759,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:48:41, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-2) + 5\,a(n-3) - 10\,a(n-4) - 30\,a(n-5) - 4\,a(n-6) + 50\,a(n-7) + 39\,a(n-8) - 10\,a(n-9) - 60\,a(n-10) - 15\,a(n-11) + 12\,a(n-12) + 18\,a(n-14)
\]
for every $n>16$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252965.
