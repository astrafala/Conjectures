...
\title{The empirical recurrence for OEIS A202791, proved by transfer matrix}
...
\begin{abstract}
OEIS A202791 counts arrays of width $4$ over $\{0,1\}$ in which every cell of a named value has a neighbour of that same value. The entry carries an
...
OEIS A202791 is ``Number of nX4 binary arrays with every one adjacent to another one horizontally, diagonally, antidiagonally or vertically.''. It has offset $1$ and begins
\[
7, 188, 3018, 45519, 702846, 10892633, 168585867, 2608652667,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 15*a(n-1) -6*a(n-2) +199*a(n-3) +124*a(n-4) -102*a(n-5) +105*a(n-6) -282*a(n-7) -342*a(n-8) +162*a(n-9)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 09:54:54, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;15\,a(n-1) - 6\,a(n-2) + 199\,a(n-3) + 124\,a(n-4) - 102\,a(n-5) + 105\,a(n-6) - 282\,a(n-7) - 342\,a(n-8) + 162\,a(n-9)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A202791.
