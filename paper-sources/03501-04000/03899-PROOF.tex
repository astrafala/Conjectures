...
\title{The empirical recurrence for OEIS A211570, proved by transfer matrix}
...
\begin{abstract}
OEIS A211570 carries an empirical recurrence of order $5$ contributed by R. H. Hardin. It is
...
OEIS A211570 is ``Number of -2..2 arrays x(i) of n+1 elements i=1..n+1 with set{t,u,v in 0,1}((x[i+t]+x[j+u]+x[k+v])*(-1)\^{}(t+u+v)) having three, four or five distinct values for every i,j,k<=n.''. It has offset $1$ and begins
\[
16, 28, 44, 74, 116, 194, 308, 518,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + 5*a(n-2) - 5*a(n-3) - 6*a(n-4) + 6*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 19 2018 09:50:20, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 5\,a(n-2) - 5\,a(n-3) - 6\,a(n-4) + 6\,a(n-5)
\]
for every $n>5$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A211570.
