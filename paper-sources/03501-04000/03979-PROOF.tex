...
\title{The empirical recurrence for OEIS A204795, proved by transfer matrix}
...
\begin{abstract}
OEIS A204795 counts arrays of width $4$ over $\{0,1\}$ by reducing every $2\times2$ subblock to a
...
about it is one bit per adjacent pair of columns, so the count is a walk count on $S=174$
states.
\end{abstract}
...
OEIS A204795 is ``Number of (n+1)X4 0..1 arrays with rows and columns of determinants of all 2X2 subblocks lexicographically nondecreasing.''. It has offset $1$ and begins
\[
125, 1001, 6537, 42214, 270148, 1729515, 11096511, 71369791,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 10*a(n-1) -17*a(n-2) -64*a(n-3) +168*a(n-4) +32*a(n-5) -256*a(n-6) +64*a(n-7) +64*a(n-8) for n>15
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 11:31:51, revision 9) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=174.
\]
...
\begin{theorem}
\[
a(n)\;=\;10\,a(n-1) - 17\,a(n-2) - 64\,a(n-3) + 168\,a(n-4) + 32\,a(n-5) - 256\,a(n-6) + 64\,a(n-7) + 64\,a(n-8)
\]
for every $n>15$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204795.
