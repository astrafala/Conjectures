...
\title{The empirical recurrence for OEIS A233141, proved by transfer matrix}
...
\begin{abstract}
OEIS A233141 counts arrays over $\{0,\dots,5\}$ in which no two entries that are neighbours in
...
OEIS A233141 is ``Number of n X 2 0..5 arrays with no element x(i,j) adjacent to value 5-x(i,j) horizontally, antidiagonally or vertically, top left element zero, and 1 appearing before 2 3 and 4, and 2 appearing before 3 in row major order.''. It has offset $1$ and begins
\[
2, 16, 225, 3727, 65120, 1158334, 20726079, 371568349,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 25*a(n-1) - 134*a(n-2) + 134*a(n-3) - 25*a(n-4) +a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 08 2018 10:20:24, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;25\,a(n-1) - 134\,a(n-2) + 134\,a(n-3) - 25\,a(n-4) + a(n-5)
\]
for every $n>5$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A233141.
