...
\title{The empirical recurrence for OEIS A239041, proved by transfer matrix}
...
\begin{abstract}
OEIS A239041 counts arrays over $\{0,1,2,3\}$ in which no entry may equal, modulo $4$, a given
...
count is then a walk count on $S=16$ states.
\end{abstract}
...
OEIS A239041 is ``Number of nX2 0..3 arrays with no element equal to one plus the sum of elements to its left or one plus the sum of elements above it, modulo 4.''. It has offset $1$ and begins
\[
7, 41, 218, 1187, 6524, 35683, 194936, 1065802,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 09:23:33, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;9\,a(n-1) - 28\,a(n-2) + 74\,a(n-3) - 181\,a(n-4) + 236\,a(n-5) - 261\,a(n-6) + 234\,a(n-7) + 200\,a(n-8) - 279\,a(n-9) + 104\,a(n-10) - 268\,a(n-11) - 36\,a(n-12) + 156\,a(n-13) + 104\,a(n-14) - 32\,a(n-15) - 16\,a(n-16)
\]
for every $n>15$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A239041.
