...
\title{The conjectured generating function for OEIS A278755, proved}
...
\begin{abstract}
OEIS A278755 counts arrays of a fixed width under a local condition, and carries a conjectured
...
\begin{quote}
G.f.: (8*x\^{}5 - 8*x\^{}3 + 4*x\^{}2 - 1)/(8*x\^{}6 - 14*x\^{}4 + 7*x\^{}2 - 1). (End)
\end{quote}
