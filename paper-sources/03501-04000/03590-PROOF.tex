...
\title{The empirical column recurrences for the table OEIS A253495}
...
\begin{abstract}
OEIS A253495 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
exact computation, with the Cayley--Hamilton theorem bounding the work. This note settles the columns $k=1, 2, 3, 4, 5$ and the rows $n=1, 2, 3, 4, 5$.
\end{abstract}
...
OEIS A253495 is ``T(n,k)=Number of (n+1)X(k+1) 0..2 arrays with every 2X2 subblock diagonal minus antidiagonal sum nondecreasing horizontally, vertically and ne-to-sw antidiagonally.''. It has offset $1$, is
read by antidiagonals, and begins
\[
81, 414, 414, 1388, 1377, 1388, 3639, 3090,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 14:04:27, revision 6) these are still
...
column $k$$=1$ & $3$ & $81$ & $>10$ & $9$ \\
column $k$$=2$ & $3$ & $414$ & $>8$ & $7$ \\
column $k$$=3$ & $3$ & $1388$ & $>7$ & $6$ \\
column $k$$=4$ & $3$ & $3639$ & $>6$ & $5$ \\
column $k$$=5$ & $3$ & $8501$ & $>6$ & $10$ \\
row $n$$=1$ & $3$ & $81$ & $>10$ & $8$ \\
row $n$$=2$ & $3$ & $414$ & $>9$ & $8$ \\
row $n$$=3$ & $3$ & $1388$ & $>9$ & $6$ \\
row $n$$=4$ & $3$ & $3639$ & $>9$ & $5$ \\
...
The sequence is ``Number of (n+1)X(2) 0..2 arrays with every 2X2 subblock diagonal minus antidiagonal sum nondecreasing horizontally, vertically and ne-to-sw antidiagonally.''. Its rows are the vertices of a digraph on
$S=81$ vertices, edges being the admissible consecutive pairs, and the count is
...
\]
holds from index $10+1$ on.

\subsection*{Column $k$$=2$}
The sequence is ``Number of (n+1)X(3) 0..2 arrays with every 2X2 subblock diagonal minus antidiagonal sum nondecreasing horizontally, vertically and ne-to-sw antidiagonally.''. Its rows are the vertices of a digraph on
$S=414$ vertices, edges being the admissible consecutive pairs, and the count is
$\mathbf{1}^{\!\top}M^{n}\mathbf{1}$ up to the constant factor in the entry's name.
The conjectured recurrence
\[
a(n)\;=\;6\,a(n-1) - 11\,a(n-2) + 6\,a(n-3)
\]
holds from index $8+1$ on.

\subsection*{Column $k$$=3$}
The sequence is ``Number of (n+1)X(4) 0..2 arrays with every 2X2 subblock diagonal minus antidiagonal sum nondecreasing horizontally, vertically and ne-to-sw antidiagonally.''. Its rows are the vertices of a digraph on
$S=1388$ vertices, edges being the admissible consecutive pairs, and the count is
$\mathbf{1}^{\!\top}M^{n}\mathbf{1}$ up to the constant factor in the entry's name.
The conjectured recurrence
\[
a(n)\;=\;6\,a(n-1) - 11\,a(n-2) + 6\,a(n-3)
\]
holds from index $7+1$ on.

\subsection*{Column $k$$=4$}
The sequence is ``Number of (n+1)X(5) 0..2 arrays with every 2X2 subblock diagonal minus antidiagonal sum nondecreasing horizontally, vertically and ne-to-sw antidiagonally.''. Its rows are the vertices of a digraph on
$S=3639$ vertices, edges being the admissible consecutive pairs, and the count is
$\mathbf{1}^{\!\top}M^{n}\mathbf{1}$ up to the constant factor in the entry's name.
The conjectured recurrence
\[
a(n)\;=\;6\,a(n-1) - 11\,a(n-2) + 6\,a(n-3)
...
The sequence is ``Number of (n+1)X(6) 0..2 arrays with every 2X2 subblock diagonal minus antidiagonal sum nondecreasing horizontally, vertically and ne-to-sw antidiagonally.''. Its rows are the vertices of a digraph on
$S=8501$ vertices, edges being the admissible consecutive pairs, and the count is
$\mathbf{1}^{\!\top}M^{n}\mathbf{1}$ up to the constant factor in the entry's name.
The conjectured recurrence
\[
a(n)\;=\;6\,a(n-1) - 11\,a(n-2) + 6\,a(n-3)
...
\subsection*{Row $n$$=1$}
The sequence is ``Number of (2)X(n+1) 0..2 arrays with every 2X2 subblock diagonal minus antidiagonal sum nondecreasing horizontally, vertically and ne-to-sw antidiagonally.''. Its rows are the vertices of a digraph on
$S=81$ vertices, edges being the admissible consecutive pairs, and the count is
$\mathbf{1}^{\!\top}M^{n}\mathbf{1}$ up to the constant factor in the entry's name.
The conjectured recurrence
\[
...
\subsection*{Row $n$$=2$}
The sequence is ``Number of (3)X(n+1) 0..2 arrays with every 2X2 subblock diagonal minus antidiagonal sum nondecreasing horizontally, vertically and ne-to-sw antidiagonally.''. Its rows are the vertices of a digraph on
$S=414$ vertices, edges being the admissible consecutive pairs, and the count is
$\mathbf{1}^{\!\top}M^{n}\mathbf{1}$ up to the constant factor in the entry's name.
The conjectured recurrence
\[
a(n)\;=\;6\,a(n-1) - 11\,a(n-2) + 6\,a(n-3)
\]
holds from index $9+1$ on.

\subsection*{Row $n$$=3$}
The sequence is ``Number of (4)X(n+1) 0..2 arrays with every 2X2 subblock diagonal minus antidiagonal sum nondecreasing horizontally, vertically and ne-to-sw antidiagonally.''. Its rows are the vertices of a digraph on
$S=1388$ vertices, edges being the admissible consecutive pairs, and the count is
$\mathbf{1}^{\!\top}M^{n}\mathbf{1}$ up to the constant factor in the entry's name.
The conjectured recurrence
\[
...
\subsection*{Row $n$$=4$}
The sequence is ``Number of (5)X(n+1) 0..2 arrays with every 2X2 subblock diagonal minus antidiagonal sum nondecreasing horizontally, vertically and ne-to-sw antidiagonally.''. Its rows are the vertices of a digraph on
$S=3639$ vertices, edges being the admissible consecutive pairs, and the count is
$\mathbf{1}^{\!\top}M^{n}\mathbf{1}$ up to the constant factor in the entry's name.
The conjectured recurrence
\[
...
\subsection*{Row $n$$=5$}
The sequence is ``Number of (6)X(n+1) 0..2 arrays with every 2X2 subblock diagonal minus antidiagonal sum nondecreasing horizontally, vertically and ne-to-sw antidiagonally.''. Its rows are the vertices of a digraph on
$S=8501$ vertices, edges being the admissible consecutive pairs, and the count is
$\mathbf{1}^{\!\top}M^{n}\mathbf{1}$ up to the constant factor in the entry's name.
The conjectured recurrence
\[
...
model reproduces $73$ published values, $331$ decimal digits in all, every one of
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253495.
