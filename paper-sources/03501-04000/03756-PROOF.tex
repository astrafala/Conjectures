...
\title{The empirical recurrence for OEIS A223784, proved by transfer matrix}
...
\begin{abstract}
OEIS A223784 counts arrays over $\{0,\dots,2\}$ whose rows, columns, diagonals or
...
OEIS A223784 is ``Number of n X 3 0..2 arrays with rows, diagonals and antidiagonals unimodal.''. It has offset $1$ and begins
\[
22, 484, 8635, 151580, 2703137, 48302789, 862007289, 15379566078,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 20 2024 17:03:16, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;18\,a(n-1) - 24\,a(n-2) + 364\,a(n-3) + 605\,a(n-4) - 5879\,a(n-5) - 3267\,a(n-6) - 28514\,a(n-7) - 68422\,a(n-8) + 215872\,a(n-9) + 381625\,a(n-10) + 110428\,a(n-11) + 62650\,a(n-12) - 42873\,a(n-13) - 108576\,a(n-14) - 28080\,a(n-15)
\end{equation}
for all $n>15$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223784.
