...
\title{The empirical recurrence for OEIS A231032, proved by transfer matrix}
...
\begin{abstract}
OEIS A231032 counts arrays of width $3$ over $\{0,1,2\}$ in which every cell must see, among its
...
the count is a walk count on $S=550$ states.
\end{abstract}
...
OEIS A231032 is ``Number of n X 3 0..2 arrays x(i,j) with each element horizontally, diagonally or antidiagonally next to at least one element with value (x(i,j)+1) mod 3 and at least one element with value (x(i,j)-1) mod 3, and upper left element zero.''. It has offset $1$ and begins
\[
0, 0, 10, 32, 278, 2988, 23058, 199272,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 9*a(n-1) -a(n-2) +15*a(n-3) -374*a(n-4) +260*a(n-5) +256*a(n-6) +60*a(n-7) -176*a(n-8) -32*a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 09 2018 10:57:36, revision 10) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=550.
\]
...
\begin{theorem}
\[
a(n)\;=\;9\,a(n-1) - a(n-2) + 15\,a(n-3) - 374\,a(n-4) + 260\,a(n-5) + 256\,a(n-6) + 60\,a(n-7) - 176\,a(n-8) - 32\,a(n-9)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231032.
