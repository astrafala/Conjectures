...
\title{The conjectured generating function for OEIS A271094, proved}
...
\begin{abstract}
OEIS A271094 counts arrays of a fixed width under a local condition, and carries a conjectured
...
OEIS A271094 is ``First differences of number of active (ON, black) cells in n-th stage of growth of two-dimensional cellular automaton defined by "Rule 275", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
4, 0, 35, -35, 107, -107,\ \dots
\]
The entry states, as a conjecture contributed by a reader and never marked settled:
\begin{quote}
G.f.: (4+4*x+27*x\^{}2-8*x\^{}3+6*x\^{}4+4*x\^{}5-5*x\^{}6) / ((1-x)\^{}2*(1+x)\^{}3).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 05 2025 15:22:32, revision 14) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A271094.
