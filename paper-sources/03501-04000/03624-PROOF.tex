...
\title{The empirical recurrence for OEIS A240371, proved by transfer matrix}
...
\begin{abstract}
OEIS A240371 counts arrays over $\{0,1,2,3\}$ in which no entry may equal, modulo $4$, a given
...
OEIS A240371 is ``Number of nX2 0..3 arrays with no element equal to one plus the sum of elements to its left or one plus the sum of elements above it or zero plus the sum of the elements diagonally to its northwest, modulo 4.''. It has offset $1$ and begins
\[
3, 11, 21, 67, 155, 353, 998, 2256,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 09:51:46, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A240371.
