...
\title{The empirical recurrence for OEIS A275184, proved by transfer matrix}
...
\begin{abstract}
OEIS A275184 counts arrays in which no entry may equal the entries at a short list of fixed offsets
...
$1$ consecutive columns, $S=29$ states in all.
\end{abstract}
...
OEIS A275184 is ``Number of 4 X n 0..2 arrays with no element equal to any value at offset (-2,-1) (-1,0) or (-1,1) and new values introduced in order 0..2.''. It has offset $1$ and begins
\[
4, 12, 41, 141, 482, 1651, 5653, 19356,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + 4*a(n-2) + 3*a(n-3) for n>4.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 01 2019 05:32:27, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A275184.
