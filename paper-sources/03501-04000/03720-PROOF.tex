...
\title{The empirical recurrence for OEIS A206211, proved by transfer matrix}
...
\begin{abstract}
OEIS A206211 counts, up to renaming the letters, the arrays of width $5$ over at most $3$
...
OEIS A206211 is ``Number of (n+1)X5 0..2 arrays with every 2X3 or 3X2 subblock having exactly two equal edges, and new values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
594, 992, 2224, 8136, 21984, 74080, 274320, 747456,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 34*a(n-3) for n>7
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 12:47:35, revision 9) this is still
...
$w_i$ cleared of denominators and $S=3698$ states in all. The walk index $j$ and the entry's own
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206211.
