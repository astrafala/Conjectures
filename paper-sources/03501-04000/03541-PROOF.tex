...
\title{The empirical recurrence for OEIS A204391, proved by transfer matrix}
...
\begin{abstract}
OEIS A204391 counts $(n+2)\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A204391 is ``Number of (n+2) X 3 0..1 arrays with no 3 X 3 subblock having three equal diagonal elements or three equal antidiagonal elements, and new values 0..1 introduced in row major order.''. It has offset $1$ and begins
\[
144, 648, 2952, 13448, 61336, 279752, 1276088, 5820872,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 5*a(n-1) - 10*a(n-3) + 4*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 07 2018 11:47:20, revision 9) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204391.
