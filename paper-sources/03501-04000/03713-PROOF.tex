...
\title{The empirical recurrence for OEIS A224348, proved by transfer matrix}
...
\begin{abstract}
OEIS A224348 counts arrays over $\{0,\dots,2\}$ whose rows, columns, diagonals or
...
is a walk count on $S=640$ vertices and the recurrence follows from a finite exact
computation.
\end{abstract}
...
OEIS A224348 is ``Number of nX3 0..2 arrays with diagonals and antidiagonals unimodal and rows nondecreasing.''. It has offset $1$ and begins
\[
10, 100, 788, 5880, 45064, 349280, 2710892, 21021916,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 10*a(n-1) -16*a(n-2) -24*a(n-3) +164*a(n-4) -516*a(n-5) +140*a(n-6) +956*a(n-7) -1500*a(n-8) +3180*a(n-9) +60*a(n-10)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 23:23:13, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;10\,a(n-1) - 16\,a(n-2) - 24\,a(n-3) + 164\,a(n-4) - 516\,a(n-5) + 140\,a(n-6) + 956\,a(n-7) - 1500\,a(n-8) + 3180\,a(n-9) + 60\,a(n-10)
\end{equation}
for all $n>10$.
...
bit vector), $|\mathcal V|=S=640$; let $(r,f)\to(s,f')$ be an edge when placing $s$ after $r$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224348.
