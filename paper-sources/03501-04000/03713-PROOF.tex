...
\title{The empirical recurrence for OEIS A214137, proved by transfer matrix}
...
\begin{abstract}
OEIS A214137 counts the proper colourings of a grid $n\times5$, wrapped in the direction of width $5$, with at most $5$ colours and
...
OEIS A214137 is ``Number of 0..4 colorings on an nX5 array circular in the 5 direction with new values 0..4 introduced in row major order.''. It has offset $1$ and begins
\[
11, 3074, 1101051, 396246659, 142612676441, 51327630988519, 18473293023759681, 6648710425444606279,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 373*a(n-1) -4754*a(n-2) +15312*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 16:53:11, revision 10) this is still
...
\]
There are $(i-1)^{5}+(-1)^{5}(i-1)$ such colourings, which at $i=5$ is already more
...
\begin{theorem}
\[
a(n)\;=\;373\,a(n-1) - 4754\,a(n-2) + 15312\,a(n-3)
\]
for every $n>3$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A214137.
