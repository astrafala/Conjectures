...
\title{The empirical closed form for OEIS A223841, proved}
...
\begin{abstract}
OEIS A223841 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
$S=196608$ vertices. Any function of the form $\sum_j p_j(n)\lambda_j^{\,n}$ satisfies the
...
OEIS A223841 is ``Number of 5 X n 0..1 arrays with rows, diagonals and antidiagonals unimodal and columns nondecreasing.''. It has offset $1$ and begins
\[
6, 36, 149, 471, 1240, 2884, 6159, 12371,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 18 2025 17:07:26, revision 7) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{n^{10}}{3628800} - \frac{n^{9}}{241920} + \frac{17 n^{8}}{120960} - \frac{n^{7}}{13440} + \frac{3733 n^{6}}{172800} - \frac{893 n^{5}}{11520} + \frac{178931 n^{4}}{90720} - \frac{188123 n^{3}}{60480} + \frac{504149 n^{2}}{25200} - \frac{30581 n}{420} + 121.
\]
...
walk, so with $M$ the adjacency matrix of that digraph on $S=196608$ vertices, and $u,w$ the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223841.
