...
\title{The empirical recurrence for OEIS A198638, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A198638 counts arrays in which every cell is constrained by its neighbours on \emph{both}
...
OEIS A198638 is ``Number of 2n X 2 0..2 arrays with values 0..2 introduced in row major order and each element equal to an even number of horizontal and vertical neighbors.''. It has offset $1$ and begins
\[
4, 36, 376, 3936, 41216, 431616, 4519936, 47333376,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 12*a(n-1) -16*a(n-2) for n>3.
\end{quote}
As of the ``Last modified'' line on the live entry (May 15 2018 06:42:06, revision 9) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A198638.
