...
\title{The empirical recurrence for OEIS A206361, proved by transfer matrix}
...
\begin{abstract}
OEIS A206361 counts, up to renaming the letters, the arrays of width $2$ over at most $4$
letters in which every $2\times3$ and $3\times2$ subblock has at most $2$ equal edges, an edge of such a window being one of the six steps of its perimeter cycle and an equal edge one whose two cells agree. It carries an empirical recurrence of order $7$ contributed by
...
OEIS A206361 is ``Number of (n+1) X 2 0..3 arrays with every 2 X 3 or 3 X 2 subblock having no more than two equal edges, and new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
15, 151, 1990, 27548, 383021, 5327971, 74147694, 1031960617,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 16*a(n-1) - 42*a(n-2) + 234*a(n-3) - 784*a(n-4) + 714*a(n-5) - 609*a(n-6) + 1008*a(n-7) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 15 2018 11:59:51, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;16\,a(n-1) - 42\,a(n-2) + 234\,a(n-3) - 784\,a(n-4) + 714\,a(n-5) - 609\,a(n-6) + 1008\,a(n-7)
\]
for every $n>8$.
\end{theorem}
...
the integers. The bound is exact: at $n=8$ the recurrence fails on the entry's own published terms, so no larger range holds.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206361.
