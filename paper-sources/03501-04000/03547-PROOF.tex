...
\title{The empirical recurrence for OEIS A185481, proved by transfer matrix}
...
\begin{abstract}
OEIS A185481 counts arrays over $\{0,\dots,1\}$ under a condition comparing a statistic of
every $2\times2$ subblock with those of its neighbours, and carries an empirical recurrence
of order $19$ contributed by R.~H.~Hardin. It is true, and it is decidable rather than
empirical. The count is a walk count on $S=804$ states and is $C$-finite; whether the
...
OEIS A185481 is ``Number of (n+1)X4 binary arrays with every 2X2 subblock determinant equal to some horizontal or vertical neighbor 2X2 subblock determinant.''. It has offset $1$ and begins
\[
76, 684, 4740, 35672, 260172, 1923780, 14150114, 104300522,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 03:01:16, revision 9) this is still
...
$S=804$ states in all. Getting the two vectors right is the whole of the argument: with
...
\begin{theorem}
\[
a(n)\;=\;11\,a(n-1) - 23\,a(n-2) - 69\,a(n-3) + 409\,a(n-4) - 768\,a(n-5) - 571\,a(n-6) + 4622\,a(n-7) - 5573\,a(n-8) + 1199\,a(n-9) + 2111\,a(n-10) - 8400\,a(n-11) + 12500\,a(n-12) - 4419\,a(n-13) - 490\,a(n-14) + 204\,a(n-15) - 1290\,a(n-16) + 1264\,a(n-17) - 1204\,a(n-18) + 320\,a(n-19)
\]
for every $n>22$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A185481.
