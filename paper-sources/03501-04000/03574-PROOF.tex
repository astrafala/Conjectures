...
\title{The empirical column recurrences for the table OEIS A251100}
...
\begin{abstract}
OEIS A251100 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A251100 is ``T(n,k)=Number of (n+1)X(k+1) 0..1 arrays with no 2X2 subblock having its minimum diagonal element less than its minimum antidiagonal element.''. It has offset $1$, is
read by antidiagonals, and begins
\[
13, 41, 41, 129, 212, 129, 406, 1109,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:04:17, revision 6) these are still
...
The sequence is ``Number of (n+1)X(2) 0..1 arrays with no 2X2 subblock having its minimum diagonal element less than its minimum antidiagonal element.''. Its rows are the vertices of a digraph on
...
The sequence is ``Number of (n+1)X(3) 0..1 arrays with no 2X2 subblock having its minimum diagonal element less than its minimum antidiagonal element.''. Its rows are the vertices of a digraph on
$S=8$ vertices, edges being the admissible consecutive pairs, and the count is
$\mathbf{1}^{\!\top}M^{n}\mathbf{1}$ up to the constant factor in the entry's name.
The conjectured recurrence
\[
a(n)\;=\;7\,a(n-1) - 11\,a(n-2) + 10\,a(n-3) - 3\,a(n-4)
\]
...
The entry gives only the order for this line: ``k=3: [order 9]''. Its model is a walk on
...
$9$ --- the stated order --- with integer coefficients
\begin{center}\small\begin{tabular}{cccccccc}
$c_{1}$ & $16$ & $c_{4}$ & $-577$ & $c_{7}$ & $352$ &  &  \\
$c_{2}$ & $-90$ & $c_{5}$ & $763$ & $c_{8}$ & $-112$ &  &  \\
$c_{3}$ & $285$ & $c_{6}$ & $-652$ & $c_{9}$ & $16$ &  &  \\
\end{tabular}\end{center}
Repeating with the first $9+4$ terms removed gives order $9$ again.

\subsection*{Column $k=4$, recovered}
The entry gives only the order for this line: ``k=4: [order 17]''. Its model is a walk on
...
\begin{center}\small\begin{tabular}{cccccccc}
$c_{1}$ & $32$ & $c_{6}$ & $-160070$ & $c_{11}$ & $457960$ & $c_{16}$ & $-1136$ \\
$c_{2}$ & $-408$ & $c_{7}$ & $333703$ & $c_{12}$ & $-256393$ & $c_{17}$ & $80$ \\
$c_{3}$ & $3073$ & $c_{8}$ & $-532992$ & $c_{13}$ & $108609$ &  &  \\
$c_{4}$ & $-15730$ & $c_{9}$ & $656691$ & $c_{14}$ & $-34260$ &  &  \\
$c_{5}$ & $58157$ & $c_{10}$ & $-625063$ & $c_{15}$ & $7752$ &  &  \\
\end{tabular}\end{center}
Repeating with the first $17+4$ terms removed gives order $17$ again.

\subsection*{Column $k=5$, recovered}
The entry gives only the order for this line: ``k=5: [order 31]''. Its model is a walk on
...
\[
(c_1,\dots,c_{31})=(64,\ -1764,\ 29700,\ -350488,\ 3107079,\ -21536824,\ 119757642,\ -543940823,\ 2045999565,\ -6444601609,\ 17157130467,\ -38908214534,\ 75659291228,\ -126869529554,\ 184336056227,\ -233006780681,\ 257060876816,\ -248098761256,\ 209731219435,\ -155260530399,\ 100445433948,\ -56541615273,\ 27492563839,\ -11423056137,\ 3995023081,\ -1152174020,\ 266437832,\ -47464016,\ 6119568,\ -509760,\ 20736).
\]
...
model reproduces $15$ published values, $58$ decimal digits in all, every one of
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251100.
