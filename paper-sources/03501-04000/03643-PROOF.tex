...
\title{The empirical recurrence for OEIS A240034, proved by transfer matrix}
...
\begin{abstract}
OEIS A240034 counts arrays over $\{0,1,2\}$ in which no entry may equal, modulo $3$, a given
...
OEIS A240034 is ``Number of n X 3 0..2 arrays with no element equal to zero plus the sum of elements to its left or zero plus the sum of elements above it or zero plus the sum of the elements diagonally to its northwest, modulo 3.''. It has offset $1$ and begins
\[
4, 6, 16, 16, 42, 44, 114, 122,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-2) - 3*a(n-4)  -a(n-6) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 27 2018 06:21:11, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A240034.
