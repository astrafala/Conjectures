...
\title{The empirical closed form for OEIS A195251, proved}
...
\begin{abstract}
OEIS A195251 counts the lower triangles of a $5\times5$ array over $\{0,\dots,n\}$ in which
...
OEIS A195251 is ``Number of lower triangles of a 5X5 0..n array with each element differing from all of its diagonal, vertical, antidiagonal and horizontal neighbors by two or less.''. It has offset $1$ and begins
\[
32768, 14348907, 67379894, 147824001, 237368212, 329060365,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 06:14:33, revision 9) these are still
...
horizontal, antidiagonal, vertical, diagonal offsets, which here gives $36$ adjacent pairs. Each cell carries a value in
...
Every $y\in\mathcal P$ has $\mathrm{sp}(y)\le 2\cdot4=8$, where $4$ is the
...
entry differ by at most $2\cdot4$.
\end{proof}
...
\[
a(n)\;=\;92031109\,n-223153377\qquad\text{for every }n\ge7,
\]
and $\mathcal P$ has exactly $92031109$ elements.
\end{theorem}
...
$a(8+1)$ were computed exactly, giving slope $92031109$ and the stated intercept; the slope
...
First, the count reproduces all $20$ terms the entry publishes, exactly, in integer
arithmetic.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A195251.
