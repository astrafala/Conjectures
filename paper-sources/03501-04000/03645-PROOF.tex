...
\title{The empirical recurrence for OEIS A239150, proved by transfer matrix}
...
\begin{abstract}
OEIS A239150 counts arrays of width $2$ over $\{0,\dots,3\}$ under a condition on each cell
...
OEIS A239150 is ``Number of (n+1) X (1+1) 0..3 arrays with no element equal to all horizontal neighbors or unequal to all vertical neighbors, and new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
1, 1, 7, 17, 96, 340, 1639, 6623,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) + 7*a(n-2) - 26*a(n-3) + 5*a(n-4) + 14*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 25 2018 09:48:28, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A239150.
