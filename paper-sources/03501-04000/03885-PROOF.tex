...
\title{The conjectured generating function for OEIS A282912, proved}
...
\begin{abstract}
OEIS A282912 counts arrays of a fixed width under a local condition, and carries a conjectured
...
\[
1, 11, 111, 1011, 10011, 110111,\ \dots
\]
