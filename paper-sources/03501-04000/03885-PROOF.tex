...
\title{The empirical recurrence for OEIS A204566, proved by counting patterns}
...
\begin{abstract}
OEIS A204566 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A204566 is ``Number of (n+1) X 3 0..3 arrays with every 2 X 2 subblock having equal diagonal elements or equal antidiagonal elements, and new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
42, 482, 6112, 80518, 1075080, 14421190, 193752824, 2604524150,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 19*a(n-1) - 79*a(n-2) + 57*a(n-3) + 16*a(n-4) - 12*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 07 2018 11:59:41, revision 9) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204566.
