...
\title{The empirical recurrence for OEIS A180762, proved by transfer matrix}
...
\begin{abstract}
OEIS A180762 counts arrays of width $2$ over $\{0,1\}$ in which every cell equals at least one of its neighbours. The entry carries an
...
OEIS A180762 is ``Half the number of nX2 binary arrays with each element equal to at least one neighbor.''. It has offset $1$ and begins
\[
1, 3, 11, 34, 111, 361, 1172, 3809,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) + a(n-2) - 2*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 01:09:30, revision 13) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A180762.
