...
\title{The empirical recurrence for OEIS A185985, proved by transfer matrix}
...
\begin{abstract}
OEIS A185985 counts arrays over $\{0,\dots,1\}$ under a condition comparing a statistic of
...
empirical. The count is a walk count on $S=832$ states and is $C$-finite; whether the
...
OEIS A185985 is ``1/128 the number of (n+2) X 3 binary arrays with each 3 X 3 subblock trace equal to some horizontal or vertical neighbor 3 X 3 subblock trace.''. It has offset $1$ and begins
\[
0, 10, 28, 200, 876, 4838, 23840, 124114,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) + 7*a(n-2) - 12*a(n-3) + 27*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 17 2018 06:16:26, revision 9) this is still
...
$S=832$ states in all. Getting the two vectors right is the whole of the argument: with
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + 7\,a(n-2) - 12\,a(n-3) + 27\,a(n-4)
\]
for every $n>4$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A185985.
