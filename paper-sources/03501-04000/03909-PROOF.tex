...
\title{The empirical recurrence for OEIS A252956, proved by transfer matrix}
...
\begin{abstract}
OEIS A252956 counts arrays of width $5$ over an alphabet of $5$ letters in which every three
...
brings the state count down to $S=4400$.
\end{abstract}
...
OEIS A252956 is ``Number of (n+2) X (3+2) 0..4 arrays with every consecutive three elements in every row and diagonal having exactly two distinct values, and in every column and antidiagonal not having exactly two distinct values, and new values 0 upwards introduced in row major order.''. It has offset $1$ and begins
\[
223, 155, 259, 443, 871, 1681, 2999, 6103,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) - 2*a(n-2) - 3*a(n-3) - 13*a(n-4) + 8*a(n-5) + 70*a(n-6) - 105*a(n-7) + 42*a(n-8) for n>10.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 07 2018 11:52:16, revision 8) this is still
...
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,
\]
with $S=4400$ states in all. The walk index $j$ and the entry's own $n$ differ by a constant,
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) - 2\,a(n-2) - 3\,a(n-3) - 13\,a(n-4) + 8\,a(n-5) + 70\,a(n-6) - 105\,a(n-7) + 42\,a(n-8)
\]
for every $n>10$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252956.
