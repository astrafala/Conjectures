...
\title{The empirical closed form for OEIS A207255, proved}
...
\begin{abstract}
OEIS A207255 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A207255 is ``Number of 4 X n 0..1 arrays avoiding 0 0 1 and 1 0 1 horizontally and 0 1 0 and 1 0 1 vertically.''. It has offset $1$ and begins
\[
10, 100, 370, 940, 1950, 3560, 5950, 9320,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (5/6)*n\^{}4 + (35/3)*n\^{}3 - (5/6)*n\^{}2 - (5/3)*n.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 21 2018 10:31:58, revision 9) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{5 n^{4}}{6} + \frac{35 n^{3}}{3} - \frac{5 n^{2}}{6} - \frac{5 n}{3}.
\]
...
First, the walk model reproduces every one of the $33$ terms the entry publishes,
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207255.
