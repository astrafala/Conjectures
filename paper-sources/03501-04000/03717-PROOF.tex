...
\title{The empirical recurrence for OEIS A235759, proved by transfer matrix}
...
\begin{abstract}
OEIS A235759 counts arrays of width $3$ over $\{0,1\}$ by reducing every $2\times2$ subblock to a
...
about it is one bit per adjacent pair of columns, so the count is a walk count on $S=57$
states.
\end{abstract}
...
OEIS A235759 is ``Number of (n+1)X(2+1) 0..1 arrays with the sum of each 2X2 subblock two median terms lexicographically nondecreasing columnwise and nonincreasing rowwise.''. It has offset $1$ and begins
\[
48, 216, 977, 3900, 15197, 55816, 199720, 691634,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 08:47:30, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;10\,a(n-1) - 29\,a(n-2) - 20\,a(n-3) + 230\,a(n-4) - 196\,a(n-5) - 646\,a(n-6) + 984\,a(n-7) + 839\,a(n-8) - 1926\,a(n-9) - 429\,a(n-10) + 1916\,a(n-11) - 108\,a(n-12) - 960\,a(n-13) + 208\,a(n-14) + 192\,a(n-15) - 64\,a(n-16)
\]
for every $n>15$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A235759.
