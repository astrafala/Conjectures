...
\title{The empirical closed form for OEIS A224159, proved}
...
\begin{abstract}
OEIS A224159 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A224159 is ``Number of 3 X n 0..1 arrays with diagonals and rows unimodal and antidiagonals nondecreasing.''. It has offset $1$ and begins
\[
8, 36, 89, 187, 373, 702, 1252, 2130,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (1/720)*n\^{}6 + (1/240)*n\^{}5 + (47/144)*n\^{}4 - (3/16)*n\^{}3 + (1111/180)*n\^{}2 - (199/60)*n + 20 for n>2.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 28 2018 15:02:04, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{n^{6}}{720} + \frac{n^{5}}{240} + \frac{47 n^{4}}{144} - \frac{3 n^{3}}{16} + \frac{1111 n^{2}}{180} - \frac{199 n}{60} + 20.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224159.
