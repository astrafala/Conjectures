...
\title{The empirical recurrence for OEIS A269009, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A269009 counts arrays over $\{0,\dots,1\}$ subject to a condition on the array as a
...
OEIS A269009 is ``Number of nX6 binary arrays with some element plus some horizontally, diagonally or antidiagonally adjacent neighbor totalling two exactly once.''. It has offset $1$ and begins
\[
20, 272, 4948, 73568, 1049588, 14382480, 192100836, 2516546784,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 17 2016 12:03:19, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;28\,a(n-1) - 230\,a(n-2) + 192\,a(n-3) + 3805\,a(n-4) - 5776\,a(n-5) - 27808\,a(n-6) + 25744\,a(n-7) + 101333\,a(n-8) - 13916\,a(n-9) - 149690\,a(n-10) - 66848\,a(n-11) + 23183\,a(n-12) + 9888\,a(n-13) - 2304\,a(n-14)
\end{equation}
for all $n>14$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269009.
