...
\title{The conjectured generating function for OEIS A270086, proved}
...
\begin{abstract}
OEIS A270086 counts arrays of a fixed width under a local condition, and carries a conjectured
...
OEIS A270086 is ``First differences of number of active (ON, black) cells in n-th stage of growth of two-dimensional cellular automaton defined by "Rule 65", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
3, 1, 31, -27, 87, -79,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 05 2025 15:22:31, revision 16) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A270086.
