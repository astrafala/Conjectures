...
\title{The empirical recurrence for OEIS A203875, proved by counting patterns}
...
\begin{abstract}
OEIS A203875 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A203875 is ``Number of (n+1)X6 0..3 arrays with no 2X2 subblock having equal diagonal elements or equal antidiagonal elements, and new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
39367, 10501975, 2801693287, 748675224487, 200096473566151, 53482170255256135, 14294949784964335495, 3820825310863126339495,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 304*a(n-1) -8430*a(n-2) -386764*a(n-3) +4486195*a(n-4) +17085516*a(n-5) -113413636*a(n-6) +92236816*a(n-7)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 10:48:12, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;304\,a(n-1) - 8430\,a(n-2) - 386764\,a(n-3) + 4486195\,a(n-4) + 17085516\,a(n-5) - 113413636\,a(n-6) + 92236816\,a(n-7)
\end{equation}
for all $n>7$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A203875.
