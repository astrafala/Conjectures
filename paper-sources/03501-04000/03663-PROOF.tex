...
\title{The empirical column recurrences for the table OEIS A258894}
...
\begin{abstract}
OEIS A258894 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A258894 is ``T(n,k)=Number of (n+2)X(k+2) 0..1 arrays with no 3x3 subblock diagonal sum less than the antidiagonal sum or central row sum less than the central column sum.''. It has offset $1$, is
read by antidiagonals, and begins
\[
242, 900, 900, 3036, 2304, 3036, 10201, 4489,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 15:32:05, revision 6) these are still
...
The sequence is ``Number of (n+2)X6 0..1 arrays with no 3x3 subblock diagonal sum less than the antidiagonal sum or central row sum less than the central column sum.''. Its rows are the vertices of a digraph on
...
model reproduces $10$ published values, $47$ decimal digits in all, every one of
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A258894.
