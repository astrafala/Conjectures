...
\title{The empirical recurrence for OEIS A276301, proved by transfer matrix}
...
\begin{abstract}
OEIS A276301 counts arrays in which no entry may equal the entries at a short list of fixed offsets
...
OEIS A276301 is ``Number of 4 X n 0..2 arrays with no element equal to any value at offset (-2,-1) (-1,1) or (0,-1) and new values introduced in order 0..2.''. It has offset $1$ and begins
\[
14, 31, 189, 1017, 5909, 33461, 191289, 1089941,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) + 10*a(n-2) - 6*a(n-4) - 22*a(n-5) + 15*a(n-6) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 05 2019 15:13:38, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A276301.
