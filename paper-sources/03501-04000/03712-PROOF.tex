...
\title{The conjectured generating function for OEIS A284540, proved}
...
\begin{abstract}
OEIS A284540 counts arrays of a fixed width under a local condition, and carries a conjectured
...
\[
1, 11, 111, 1101, 11101, 110101,\ \dots
\]
The entry states, as a conjecture contributed by a reader and never marked settled:
\begin{quote}
G.f.: (1 + 10*x + 100*x\^{}2 + 990*x\^{}3 - 1000*x\^{}5 - 100*x\^{}6 + 1010*x\^{}7 + 100*x\^{}8) / ((1 - x)*(1 - 10*x)*(1 + 10*x)*(1 + 100*x\^{}2)).
\end{quote}
