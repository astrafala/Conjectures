...
\title{The empirical column recurrences for the table OEIS A234658}
...
\begin{abstract}
OEIS A234658 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A234658 is ``T(n,k) is the number of (n+1) X (k+1) 0..5 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 4 (constant-stress 1 X 1 tilings).''. It has offset $1$, is
read by antidiagonals, and begins
\[
160, 728, 728, 3264, 2648, 3264, 15008, 9616,\ \dots
\]
The entry carries the following block:
\begin{quote}\small
Empirical for column k:\\
k=1: a(n) = 4*a(n-1) +44*a(n-2) -176*a(n-3) -480*a(n-4) +1920*a(n-5).\\
k=2: [order 15].\\
k=3: [order 21].\\
k=4: [order 23].\\
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 20 2022 20:27:39, revision 7) these are still
...
The sequence is ``Number of (n+1) X (2) 0..5 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 4 (constant-stress 1 X 1 tilings).''. Its rows are the vertices of a digraph on
...
$c_{1}$ & $9$ & $c_{5}$ & $23970$ & $c_{9}$ & $3002976$ & $c_{13}$ & $-15759360$ \\
$c_{2}$ & $59$ & $c_{6}$ & $-24980$ & $c_{10}$ & $-9941184$ & $c_{14}$ & $-107827200$ \\
$c_{3}$ & $-741$ & $c_{7}$ & $-382080$ & $c_{11}$ & $-8688384$ & $c_{15}$ & $99532800$ \\
$c_{4}$ & $-680$ & $c_{8}$ & $836736$ & $c_{12}$ & $53360640$ &  &  \\
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234658.
