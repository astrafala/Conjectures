...
\title{The empirical closed form for OEIS A208139, proved}
...
\begin{abstract}
OEIS A208139 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
$S=144$ vertices. Any function of the form $\sum_j p_j(n)\lambda_j^{\,n}$ satisfies the
...
OEIS A208139 is ``Number of n X 5 0..1 arrays avoiding 0 0 1 and 0 1 1 horizontally and 0 0 1 and 1 0 1 vertically.''. It has offset $1$ and begins
\[
12, 144, 720, 2400, 6300, 14112, 28224, 51840,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = n\^{}5 + 4*n\^{}4 + 5*n\^{}3 + 2*n\^{}2.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 17 2026 00:40:37, revision 13) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;n^{5} + 4 n^{4} + 5 n^{3} + 2 n^{2}.
\]
...
walk, so with $M$ the adjacency matrix of that digraph on $S=144$ vertices, and $u,w$ the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208139.
