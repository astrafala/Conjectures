...
\title{The empirical recurrence for OEIS A206384, proved by transfer matrix}
...
\begin{abstract}
OEIS A206384 counts arrays in which no entry may equal the entries at a short list of fixed offsets
...
$2$ consecutive rows, $S=14251$ states in all.
\end{abstract}
...
OEIS A206384 is ``Number of n X 3 0..6 arrays with no element equal to another within a city block distance of two, and new values 0..6 introduced in row major order.''. It has offset $1$ and begins
\[
1, 4, 55, 1368, 34442, 868994, 21916090, 552801398,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 21*a(n-1) + 131*a(n-2) - 637*a(n-3) + 486*a(n-4) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 15 2018 12:45:08, revision 9) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=14251.
\]
...
\begin{theorem}
\[
a(n)\;=\;21\,a(n-1) + 131\,a(n-2) - 637\,a(n-3) + 486\,a(n-4)
\]
for every $n>6$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206384.
