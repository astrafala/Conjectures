...
\title{The empirical recurrence for OEIS A185799, proved by transfer matrix}
...
\begin{abstract}
OEIS A185799 counts arrays over $\{0,\dots,3\}$ under a condition comparing a statistic of
every $2\times2$ subblock with those of its neighbours, and carries an empirical recurrence
of order $8$ contributed by R.~H.~Hardin. It is true, and it is decidable rather than
empirical. The count is a walk count on $S=432$ states and is $C$-finite; whether the
...
OEIS A185799 is ``Number of (n+1) X 2 0..3 arrays with every 2 X 2 subblock trace equal to some horizontal or vertical neighbor 2 X 2 subblock trace.''. It has offset $1$ and begins
\[
0, 704, 2176, 30976, 166272, 1567936, 10419200, 85438016,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 10*a(n-1) - 21*a(n-2) - 54*a(n-3) + 799*a(n-4) - 2466*a(n-5) + 5260*a(n-6) - 4944*a(n-7) + 3456*a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 28 2018 06:51:48, revision 10) this is still
...
$S=432$ states in all. Getting the two vectors right is the whole of the argument: with
...
\begin{theorem}
\[
a(n)\;=\;10\,a(n-1) - 21\,a(n-2) - 54\,a(n-3) + 799\,a(n-4) - 2466\,a(n-5) + 5260\,a(n-6) - 4944\,a(n-7) + 3456\,a(n-8)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A185799.
