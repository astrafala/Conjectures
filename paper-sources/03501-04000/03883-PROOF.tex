...
\title{The empirical recurrence for OEIS A210260, proved by transfer matrix}
...
\begin{abstract}
OEIS A210260 counts arrays of width $2$ whose every $2\times2$ subblock holds a
...
OEIS A210260 is ``Number of (n+1) X 2 0..3 arrays containing all values 0..3 with every 2 X 2 subblock having three distinct values, and new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
0, 29, 400, 4298, 42520, 406580, 3828928, 35804264,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 12*a(n-1) - 18*a(n-2) - 64*a(n-3) - 24*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 15 2018 06:53:26, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;12\,a(n-1) - 18\,a(n-2) - 64\,a(n-3) - 24\,a(n-4)
\]
for every $n>4$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A210260.
