...
\title{The empirical recurrence for OEIS A269203, proved by transfer matrix}
...
\begin{abstract}
OEIS A269203 counts arrays of width $3$ over $\{0,1,2,3\}$ in which the number of adjacent PAIRS of
...
OEIS A269203 is ``Number of 3 X n 0..3 arrays with some element plus some horizontally, diagonally or antidiagonally adjacent neighbor totalling three no more than once.''. It has offset $1$ and begins
\[
64, 1740, 25572, 400428, 5877228, 84310620, 1184381844, 16385570076,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 24*a(n-1) -130*a(n-2) -248*a(n-3) +935*a(n-4) +272*a(n-5) -1768*a(n-6) +960*a(n-7) -144*a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (May 27 2025 16:40:08, revision 10) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269203.
