...
\title{The empirical recurrence for OEIS A280598, proved by transfer matrix}
...
\begin{abstract}
OEIS A280598 counts $n\times2$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A280598 is ``Number of n X 2 0..1 arrays with no element equal to more than two of its horizontal, vertical and antidiagonal neighbors and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
2, 7, 18, 50, 138, 383, 1063, 2951,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) -a(n-2) +a(n-3) +a(n-4) -2*a(n-5) -a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 13 2026 14:55:40, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) - a(n-2) + a(n-3) + a(n-4) - 2\,a(n-5) - a(n-6)
\]
for every $n>6$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A280598.
