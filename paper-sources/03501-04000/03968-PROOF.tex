...
\title{The conjectured generating function for OEIS A282609, proved}
...
\begin{abstract}
OEIS A282609 counts arrays of a fixed width under a local condition, and carries a conjectured
