...
\title{The empirical closed form for OEIS A223845, proved}
...
\begin{abstract}
OEIS A223845 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A223845 is ``Number of nX3 0..3 arrays with rows and columns unimodal.''. It has offset $1$ and begins
\[
50, 2500, 64660, 1006318, 10804883, 87613063, 570145144, 3107412546,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 22:42:53, revision 8) this is still
...
+ \frac{2373533 n^{16}}{3487131648000} + \frac{699851 n^{15}}{62270208000} \\
+ \frac{11519407 n^{14}}{87178291200} + \frac{51637 n^{13}}{44352000} \\
+ \frac{7243453 n^{12}}{912384000} + \frac{306562541 n^{11}}{7185024000} \\
+ \frac{148370021 n^{10}}{812851200} + \frac{33909163 n^{9}}{54432000} \\
+ \frac{455467827113 n^{8}}{268240896000} + \frac{5892168577 n^{7}}{1596672000} \\
+ \frac{80009607001 n^{6}}{12454041600} + \frac{31958071429 n^{5}}{3592512000} \\
+ \frac{2175260234977 n^{4}}{217945728000} + \frac{5539161569 n^{3}}{648648000} \\
+ \frac{6387435643 n^{2}}{1029188160} + \frac{637969 n}{235620} \\
+ 1.
\end{multline*}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223845.
