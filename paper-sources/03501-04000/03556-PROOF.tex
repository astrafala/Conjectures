...
\title{The empirical recurrence for OEIS A269292, proved by transfer matrix}
...
\begin{abstract}
OEIS A269292 counts arrays of width $4$ over $\{0,1,2,3\}$ in which the number of adjacent PAIRS of
...
OEIS A269292 is ``Number of 4Xn 0..3 arrays with some element plus some horizontally or antidiagonally adjacent neighbor totalling three no more than once.''. It has offset $1$ and begins
\[
256, 29160, 1698732, 87559668, 4204943820, 193446959076, 8642330207532, 377958654569412,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 21 2016 09:29:40, revision 4) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269292.
