...
\title{The empirical recurrence for OEIS A269284, proved by transfer matrix}
...
\begin{abstract}
OEIS A269284 counts arrays of width $3$ over $\{0,1,2,3\}$ in which the number of adjacent PAIRS of
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 21 2019 06:12:42, revision 8) this is still
