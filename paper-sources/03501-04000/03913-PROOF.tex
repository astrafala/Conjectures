...
\title{The empirical recurrence for OEIS A208859, proved by counting patterns}
...
\begin{abstract}
OEIS A208859 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A208859 is ``Number of n X 3 0..3 arrays with new values 0..3 introduced in row major order and no element equal to more than one of its immediate leftward or upward or left-upward diagonal neighbors.''. It has offset $1$ and begins
\[
5, 127, 5796, 273049, 12883280, 607924387, 28686344276, 1353633375649,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 59*a(n-1) - 603*a(n-2) + 2211*a(n-3) - 2826*a(n-4) + 720*a(n-5) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 07 2018 06:18:54, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;59\,a(n-1) - 603\,a(n-2) + 2211\,a(n-3) - 2826\,a(n-4) + 720\,a(n-5)
\end{equation}
for all $n>6$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208859.
