...
\title{The empirical recurrence for OEIS A224037, proved by transfer matrix}
...
\begin{abstract}
OEIS A224037 counts arrays over $\{0,\dots,1\}$ whose rows, columns, diagonals or
...
is a walk count on $S=1024$ vertices and the recurrence follows from a finite exact
computation.
\end{abstract}
...
OEIS A224037 is ``Number of nX7 0..1 arrays with antidiagonals unimodal and rows and diagonals nondecreasing.''. It has offset $1$ and begins
\[
8, 43, 161, 508, 1505, 4395, 12856, 37808,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 23:12:25, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;8\,a(n-1) - 21\,a(n-2) + 15\,a(n-3) + 15\,a(n-4) - 16\,a(n-5) - 9\,a(n-6) + 12\,a(n-7) - 8\,a(n-8) + 10\,a(n-9) - 12\,a(n-10) + 16\,a(n-11) - 16\,a(n-12) + 32\,a(n-13)
\end{equation}
for all $n>16$.
...
bit vector), $|\mathcal V|=S=1024$; let $(r,f)\to(s,f')$ be an edge when placing $s$ after $r$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224037.
