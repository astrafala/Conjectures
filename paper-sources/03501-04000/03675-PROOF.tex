...
\title{The conjectured generating function for OEIS A273781, proved}
...
\begin{abstract}
OEIS A273781 counts arrays of a fixed width under a local condition, and carries a conjectured
...
coefficients of their expansions do. Comparing $36$ coefficients in exact arithmetic
...
OEIS A273781 is ``Partial sums of the number of active (ON, black) cells in n-th stage of growth of two-dimensional cellular automaton defined by "Rule 929", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 5, 26, 74, 155, 276,\ \dots
\]
The entry states, as a conjecture contributed by a reader and never marked settled:
\begin{quote}
G.f.: (1+x+12*x\^{}2-4*x\^{}3-4*x\^{}4+x\^{}5+x\^{}6) / (1-x)\^{}4.
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 05 2025 15:22:34, revision 13) this is still
...
\begin{proof}
Write the conjecture as $N_2/D_2$ with $\deg N_2=6$ and $\deg D_2=4$; its expansion as a
...
exact integer arithmetic, those of $N_2/D_2$ by exact rational long division, and $36$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A273781.
