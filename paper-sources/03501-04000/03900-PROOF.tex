...
\title{The empirical recurrence for OEIS A211574, proved by transfer matrix}
...
\begin{abstract}
OEIS A211574 carries an empirical recurrence of order $11$ contributed by R. H. Hardin. It is
...
OEIS A211574 is ``Number of -2..2 arrays x(i) of n+1 elements i=1..n+1 with set{t,u,v in 0,1}((x[i+t]+x[j+u]+x[k+v])*(-1)\^{}(t+u+v)) having two, four or six distinct values for every i,j,k<=n.''. It has offset $1$ and begins
\[
24, 76, 192, 456, 1046, 2408, 5458, 12624,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 19 2018 09:49:51, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A211574.
