...
\title{The empirical recurrence for OEIS A238769, proved by transfer matrix}
...
\begin{abstract}
OEIS A238769 counts arrays over $\{0,1,2,3\}$ in which no entry may equal, modulo $4$, a given
...
OEIS A238769 is ``Number of nX2 0..3 arrays with no element equal to the sum modulo 4 of elements to its left or elements above it.''. It has offset $1$ and begins
\[
6, 30, 156, 810, 4106, 21132, 108124, 553828,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) +16*a(n-2) +31*a(n-3) -8*a(n-4) -78*a(n-5) -45*a(n-6) +56*a(n-7) -32*a(n-8) +32*a(n-9) +16*a(n-10)
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 10:54:51, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A238769.
