...
\title{The empirical recurrence for OEIS A252691, proved by transfer matrix}
...
\begin{abstract}
OEIS A252691 counts arrays of width $6$ over an alphabet of $4$ letters in which every three
...
brings the state count down to $S=12177$.
\end{abstract}
...
OEIS A252691 is ``Number of (n+2) X (4+2) 0..3 arrays with every consecutive three elements in every row and column having exactly two distinct values, and in every diagonal and antidiagonal not having exactly two distinct values, and new values 0 upwards introduced in row major order.''. It has offset $1$ and begins
\[
394, 519, 407, 1480, 2048, 6246, 12740, 35128,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 05 2018 06:14:14, revision 7) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The array has width $6$ and entries in $\{0,1,\dots,3\}$. Four families of triples
...
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,
\]
with $S=12177$ states in all. The walk index $j$ and the entry's own $n$ differ by a constant,
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252691.
