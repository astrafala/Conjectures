...
\title{The empirical closed form for OEIS A188821, proved}
...
\begin{abstract}
OEIS A188821 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A188821 is ``Number of n X 6 binary arrays without the pattern 0 1 diagonally or antidiagonally.''. It has offset $1$ and begins
\[
64, 441, 1296, 2704, 4624, 7056, 10000, 13456,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 256*n\^{}2 - 384*n + 144 for n>2.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 30 2018 08:56:18, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;256 n^{2} - 384 n + 144.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A188821.
