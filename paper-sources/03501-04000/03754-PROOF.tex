...
\title{The empirical closed form for OEIS A224145, proved}
...
\begin{abstract}
OEIS A224145 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A224145 is ``Number of n X 7 0..1 arrays with rows and antidiagonals unimodal and columns nondecreasing.''. It has offset $1$ and begins
\[
29, 239, 1037, 3296, 8838, 21183, 46586, 95455,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (4/315)*n\^{}7 + (4/45)*n\^{}6 + (34/45)*n\^{}5 + (29/9)*n\^{}4 + (508/45)*n\^{}3 + (1156/45)*n\^{}2 + (1328/35)*n - 161 for n>4.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 28 2018 05:56:03, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{4 n^{7}}{315} + \frac{4 n^{6}}{45} + \frac{34 n^{5}}{45} + \frac{29 n^{4}}{9} + \frac{508 n^{3}}{45} + \frac{1156 n^{2}}{45} + \frac{1328 n}{35} - 161.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224145.
