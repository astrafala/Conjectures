...
\title{The conjectured generating function for OEIS A278665, proved}
...
\begin{abstract}
OEIS A278665 counts arrays of a fixed width under a local condition, and carries a conjectured
...
\[
1, 11, 11, 11, 11, 10011,\ \dots
\]
The entry states, as a conjecture contributed by a reader and never marked settled:
\begin{quote}
G.f.: (1 +x -99*x\^{}2 -99*x\^{}3 -100*x\^{}4 +9900*x\^{}5 +10000*x\^{}6 -1000000*x\^{}7 +1000000*x\^{}10) / ((1 -x)*(1 +x)*(1 -10*x)*(1 +x\^{}2)).
\end{quote}
