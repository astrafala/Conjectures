...
\title{The empirical closed form for OEIS A188842, proved}
...
\begin{abstract}
OEIS A188842 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A188842 is ``Number of nX8 binary arrays without the pattern 0 1 diagonally or vertically.''. It has offset $1$ and begins
\[
256, 2584, 9841, 25213, 53296, 100947, 177859, 297275,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 04:52:44, revision 9) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{n^{8}}{40320} + \frac{23 n^{7}}{10080} + \frac{17 n^{6}}{192} + \frac{269 n^{5}}{144} + \frac{43949 n^{4}}{1920} + \frac{228401 n^{3}}{1440} + \frac{1054411 n^{2}}{2016} + \frac{9941 n}{56} - 2210.
\]
...
$n=15,\dots,23$ and agree at each. A monic recurrence of order $9$
determines $a(m)$ from $a(m-1),\dots,a(m-9)$, and for every $m\ge24$ both
$m>14$ and $m-9\ge15$ hold, so induction on $m$ gives $a(m)=f(m)$ for every
$m\ge15$.
Below $n=15$ the recurrence argument gives nothing, since \eqref{eq:rec} is only
established for $a$ from $n=15$ on. The remaining indices $n=6,\dots,14$ were
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A188842.
