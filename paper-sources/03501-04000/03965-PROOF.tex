...
\title{The conjectured generating function for OEIS A284236, proved}
...
\begin{abstract}
OEIS A284236 counts arrays of a fixed width under a local condition, and carries a conjectured
...
OEIS A284236 is ``Binary representation of the x-axis, from the origin to the right edge, of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 833", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 0, 110, 1010, 1010, 101010,\ \dots
\]
The entry states, as a conjecture contributed by a reader and never marked settled:
\begin{quote}
G.f.: (10000*x\^{}5 - 11000*x\^{}4 + 1000*x\^{}3 + 10*x\^{}2 - x + 1)/((x - 1)*(10*x - 1)*(10*x + 1)). (End)
\end{quote}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A284236.
