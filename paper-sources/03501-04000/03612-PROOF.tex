...
\title{Arrays counted up to renaming: the empirical recurrence for OEIS A206171}
...
\begin{abstract}
OEIS A206171 carries an empirical recurrence of order $6$ contributed by R.~H.~Hardin. It is
...
OEIS A206171 is ``Number of 3 X (n+1) 0..3 arrays with every 2 X 2 subblock in a row having an equal number of equal diagonal or equal antidiagonal elements, adjacent rows differing in this number, and new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
102, 1070, 14182, 196078, 2728486, 38016046, 529805350, 7383933550,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 14 2018 08:18:18, revision 11) this is still
...
\begin{theorem}
\[
a(n)\;=\;16\,a(n-1) - 21\,a(n-2) - 120\,a(n-3) + 153\,a(n-4) + 216\,a(n-5) - 243\,a(n-6)
\]
for every $n>6$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206171.
