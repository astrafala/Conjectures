...
\title{The empirical recurrence for OEIS A233219, proved by carrying a row major clause across
columns}
...
\begin{abstract}
OEIS A233219 counts $3\times n$ arrays over $\{0,\dots,5\}$ with a forbidden-pair
...
OEIS A233219 is ``Number of 3Xn 0..5 arrays with no element x(i,j) adjacent to value 5-x(i,j) horizontally or antidiagonally, top left element zero, and 1 appearing before 2 3 and 4, and 2 appearing before 3 in row major order.''. It has offset $1$ and begins
\[
11, 452, 35446, 3054973, 268289572, 23644611625,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 111*a(n-1) -2128*a(n-2) +10532*a(n-3) -17559*a(n-4) +9045*a(n-5) for n>7
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 07:56:16, revision 6) this is still
...
row, and there are $S=324$ of them after states with identical futures are merged. Hence
\[
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A233219.
