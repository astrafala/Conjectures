...
\title{The empirical recurrence for OEIS A223198, proved by transfer matrix}
...
\begin{abstract}
OEIS A223198 counts the ways of writing the vertices of a fixed graph $G$ into an array of width
...
single slice is a state and the count is a walk count on a finite digraph with $S=385$ vertices.
\end{abstract}
...
OEIS A223198 is ``Rolling cube footprints: number of n X 4 0..5 arrays starting with 0 where 0..5 label faces of a cube and every array movement to a horizontal or vertical neighbor moves across a corresponding cube edge.''. It has offset $1$ and begins
\[
64, 6912, 765952, 85327872, 9515827200, 1061444124672, 118404195287040, 13208119651860480,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 144*a(n-1) - 3840*a(n-2) + 24576*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 17 2018 09:22:00, revision 8) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=385.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223198.
