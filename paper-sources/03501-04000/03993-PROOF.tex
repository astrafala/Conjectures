...
\title{The empirical recurrence for OEIS A275505, proved by counting patterns}
...
\begin{abstract}
OEIS A275505 counts arrays in which no entry may repeat a value found at any of three stated
...
cutting $60074$ pairs to $S=10355$ states. The entry's empirical recurrence of order $3$,
...
OEIS A275505 is ``Number of 5 X n 0..2 arrays with no element equal to any value at offset (-2,-1) (-2,0) or (-1,-1) and new values introduced in order 0..2.''. It has offset $1$ and begins
\[
12, 56, 232, 988, 4180, 17712, 75024, 317812,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) + 5*a(n-2) + a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 04 2019 10:23:32, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A275505.
