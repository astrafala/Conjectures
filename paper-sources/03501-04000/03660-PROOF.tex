...
\title{The empirical recurrence for OEIS A211460, proved by transfer matrix}
...
\begin{abstract}
OEIS A211460 carries an empirical recurrence of order $9$ contributed by R. H. Hardin. It is
...
OEIS A211460 is ``Number of -2..2 arrays x(i) of n+1 elements i=1..n+1 with x(i)+x(j), x(i+1)+x(j+1), -(x(i)+x(j+1)), and -(x(i+1)+x(j)) having one or three distinct values for every i<=n and j<=n.''. It has offset $1$ and begins
\[
21, 53, 121, 259, 549, 1119, 2285, 4575,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) + 5*a(n-2) - 20*a(n-3) - 5*a(n-4) + 45*a(n-5) - 5*a(n-6) - 40*a(n-7) + 6*a(n-8) + 12*a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 17 2018 15:45:25, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + 5\,a(n-2) - 20\,a(n-3) - 5\,a(n-4) + 45\,a(n-5) - 5\,a(n-6) - 40\,a(n-7) + 6\,a(n-8) + 12\,a(n-9)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A211460.
