...
\title{The empirical recurrence for OEIS A281949, proved by transfer matrix}
...
\begin{abstract}
OEIS A281949 counts $n\times2$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A281949 is ``Number of nX2 0..1 arrays with no element unequal to more than four of its king-move neighbors and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
2, 8, 30, 112, 420, 1576, 5912, 22176,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) -2*a(n-2) +4*a(n-3)
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 03 2017 08:19:43, revision 4) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A281949.
