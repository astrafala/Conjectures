...
\title{The empirical recurrence for OEIS A240778, proved by transfer matrix}
...
\begin{abstract}
OEIS A240778 counts $n\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A240778 is ``Number of n X 3 0..1 arrays with no element equal to fewer vertical neighbors than horizontal neighbors, with new values 0..1 introduced in row major order.''. It has offset $1$ and begins
\[
1, 4, 20, 97, 459, 2187, 10442, 49861,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 5*a(n-1) - a(n-2) - a(n-3) + 4*a(n-4) - 4*a(n-5) - 3*a(n-6) + a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 29 2018 05:59:23, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) - a(n-2) - a(n-3) + 4\,a(n-4) - 4\,a(n-5) - 3\,a(n-6) + a(n-7)
\]
for every $n>7$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A240778.
