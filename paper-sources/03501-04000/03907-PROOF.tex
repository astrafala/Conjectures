...
\title{Arrays counted up to renaming: the empirical recurrence for OEIS A205219}
...
\begin{abstract}
OEIS A205219 carries an empirical recurrence of order $2$ contributed by R.~H.~Hardin. It is
...
both in the state the arrays are exactly the walks in a digraph on $S=3$ vertices, so $a(n)$
...
OEIS A205219 is ``Number of (n+1)X2 0..1 arrays with the number of equal 2X2 subblock diagonal pairs and equal antidiagonal pairs differing from each horizontal or vertical neighbor, and new values 0..1 introduced in row major order.''. It has offset $1$ and begins
\[
8, 20, 52, 132, 340, 868, 2228, 5700,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 11:52:21, revision 11) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{The count is a walk count}

The entry counts arrays of 2 columns over the alphabet $\{0,1\}$, and asks two different kinds of thing of them at once.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A205219.
