...
\title{The empirical recurrence for OEIS A185480, proved by transfer matrix}
...
\begin{abstract}
OEIS A185480 counts arrays over $\{0,\dots,1\}$ under a condition comparing a statistic of
...
OEIS A185480 is ``Number of (n+1)X3 binary arrays with every 2X2 subblock determinant equal to some horizontal or vertical neighbor 2X2 subblock determinant.''. It has offset $1$ and begins
\[
30, 148, 684, 3262, 15402, 73094, 346356, 1642258,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 03:01:10, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-1) - 17\,a(n-2) + a(n-3) + 43\,a(n-4) - 71\,a(n-5) + 48\,a(n-6) - 9\,a(n-7) - 4\,a(n-8) + 10\,a(n-9) - 2\,a(n-10)
\]
for every $n>12$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A185480.
