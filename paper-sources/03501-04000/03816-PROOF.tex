...
\title{The empirical recurrence for OEIS A211568, proved by transfer matrix}
...
\begin{abstract}
OEIS A211568 carries an empirical recurrence of order $8$ contributed by R. H. Hardin. It is
...
OEIS A211568 is ``Number of -2..2 arrays x(i) of n+1 elements i=1..n+1 with set{t,u,v in 0,1}((x[i+t]+x[j+u]+x[k+v])*(-1)\^{}(t+u+v)) having two, three or four distinct values for every i,j,k<=n.''. It has offset $1$ and begins
\[
24, 44, 78, 142, 256, 472, 868, 1626,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) + a(n-2) - 21*a(n-3) + 16*a(n-4) + 29*a(n-5) - 34*a(n-6) - 6*a(n-7) + 12*a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 19 2018 08:23:07, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A211568.
