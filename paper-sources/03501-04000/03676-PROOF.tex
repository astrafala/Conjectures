...
\title{The empirical column recurrences for the table OEIS A241356}
...
\begin{abstract}
OEIS A241356 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 26 2021 19:29:56, revision 8) these are still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A241356.
