...
\title{The empirical recurrence for OEIS A238991, proved by transfer matrix}
...
\begin{abstract}
OEIS A238991 counts arrays over $\{0,1,2,3\}$ in which no entry may equal, modulo $4$, a given
...
OEIS A238991 is ``Number of n X 2 0..3 arrays with no element equal to two plus the sum of elements to its left or two plus the sum of the sum of elements above it, modulo 4.''. It has offset $1$ and begins
\[
7, 41, 203, 955, 4393, 20015, 90841, 411621,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 6*a(n-1) + a(n-2) - 48*a(n-3) + 49*a(n-4) + 70*a(n-5) - 77*a(n-6) - 68*a(n-7) + 52*a(n-8) + 16*a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 24 2018 14:26:55, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) + a(n-2) - 48\,a(n-3) + 49\,a(n-4) + 70\,a(n-5) - 77\,a(n-6) - 68\,a(n-7) + 52\,a(n-8) + 16\,a(n-9)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A238991.
