...
\title{The empirical recurrence for OEIS A232117, proved by transfer matrix}
...
\begin{abstract}
OEIS A232117 counts arrays of width $2$ over $\{0,1,2\}$ in which every cell has a neighbour at least as large and one at most as large. The entry carries an
...
OEIS A232117 is ``Number of (n+1) X (1+1) 0..2 arrays with every element both >= and <= some horizontal or vertical neighbor.''. It has offset $1$ and begins
\[
15, 109, 611, 3635, 21717, 129323, 770747, 4593729,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 5*a(n-1) +4*a(n-2) +12*a(n-3) -7*a(n-4) -14*a(n-5) -33*a(n-6) -22*a(n-7) +4*a(n-8) +4*a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 12 2026 13:33:52, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) + 4\,a(n-2) + 12\,a(n-3) - 7\,a(n-4) - 14\,a(n-5) - 33\,a(n-6) - 22\,a(n-7) + 4\,a(n-8) + 4\,a(n-9)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232117.
