...
\title{The empirical column recurrences for the table OEIS A229586}
...
\begin{abstract}
OEIS A229586 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A229586 is ``T(n,k) = number of defective 3-colorings of an n X k 0..2 array connected horizontally and antidiagonally with exactly one mistake, and colors introduced in row-major 0..2 order.''. It has offset $1$, is
read by antidiagonals, and begins
\[
0, 1, 0, 2, 6, 0, 6, 28,\ \dots
\]
...
k=7: [order 8]\\
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 27 2021 21:22:36, revision 7) these are still
...
\subsection*{Row $n$$=1$}
The sequence is ``Number of defective 3-colorings of an 1 X n 0..2 array connected horizontally and antidiagonally with exactly one mistake, and colors introduced in row-major 0..2 order.''. Its rows are the vertices of a digraph on
...
\subsection*{Row $n$$=2$}
The sequence is ``Number of defective 3-colorings of an 2 X n 0..2 array connected horizontally and antidiagonally with exactly one mistake, and colors introduced in row-major 0..2 order.''. Its rows are the vertices of a digraph on
...
\subsection*{Row $n$$=3$}
The sequence is ``Number of defective 3-colorings of an 3 X n 0..2 array connected horizontally and antidiagonally with exactly one mistake, and colors introduced in row-major 0..2 order.''. Its rows are the vertices of a digraph on
...
model reproduces $27$ published values, $80$ decimal digits in all, every one of
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A229586.
