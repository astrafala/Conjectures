...
\title{The empirical recurrence for OEIS A250357, proved by transfer matrix}
...
\begin{abstract}
OEIS A250357 carries an empirical recurrence of order $8$ contributed by R. H. Hardin. It is
...
OEIS A250357 is ``Number of length n arrays x(i), i=1..n with x(i) in i..i+4 and no value appearing more than 3 times.''. It has offset $1$ and begins
\[
5, 25, 125, 623, 3094, 15365, 76300, 378880,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 5*a(n-1) - 2*a(n-4) - 11*a(n-5) + a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 13 2018 08:38:00, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) - 2\,a(n-4) - 11\,a(n-5) + a(n-8)
\]
for every $n>0$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250357.
