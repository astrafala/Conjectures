...
\title{The empirical recurrence for OEIS A211464, proved by transfer matrix}
...
\begin{abstract}
OEIS A211464 carries an empirical recurrence of order $12$ contributed by R. H. Hardin. It is
...
OEIS A211464 is ``Number of -2..2 arrays x(i) of n+1 elements i=1..n+1 with x(i)+x(j), x(i+1)+x(j+1), -(x(i)+x(j+1)), and -(x(i+1)+x(j)) having one, three or four distinct values for every i<=n and j<=n.''. It has offset $1$ and begins
\[
21, 89, 353, 1373, 5225, 19645, 73105, 270125,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 16:11:05, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;10\,a(n-1) - 16\,a(n-2) - 118\,a(n-3) + 321\,a(n-4) + 560\,a(n-5) - 1724\,a(n-6) - 1636\,a(n-7) + 3492\,a(n-8) + 2984\,a(n-9) - 1216\,a(n-10) - 608\,a(n-11) + 192\,a(n-12)
\]
for every $n>0$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A211464.
