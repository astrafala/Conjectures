...
\title{The empirical recurrence for OEIS A204354, proved by transfer matrix}
...
\begin{abstract}
OEIS A204354 counts $(n+2)\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A204354 is ``Number of (n+2)X3 0..1 arrays with every 3X3 subblock having three equal elements in a row horizontally, vertically, diagonally or antidiagonally exactly one way, and new values 0..1 introduced in row major order.''. It has offset $1$ and begins
\[
74, 241, 764, 2399, 7580, 23912, 75324, 237298,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) +3*a(n-2) +6*a(n-3) +21*a(n-4) -4*a(n-5) -10*a(n-6) +2*a(n-7) -20*a(n-8) +4*a(n-10) for n>13
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 11:09:19, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 3\,a(n-2) + 6\,a(n-3) + 21\,a(n-4) - 4\,a(n-5) - 10\,a(n-6) + 2\,a(n-7) - 20\,a(n-8) + 4\,a(n-10)
\]
for every $n>13$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204354.
