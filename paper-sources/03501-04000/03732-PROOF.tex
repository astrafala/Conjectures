...
\title{The empirical closed form for OEIS A224169, proved}
...
\begin{abstract}
OEIS A224169 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A224169 is ``Number of n X 4 0..3 arrays with rows, diagonals and antidiagonals unimodal and columns nondecreasing.''. It has offset $1$ and begins
\[
130, 3526, 38561, 272130, 1460836, 6425876, 24197608, 80350989,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 18 2025 20:55:01, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{3551 n^{12}}{47900160} + \frac{17561 n^{11}}{13305600} + \frac{376693 n^{10}}{21772800} + \frac{106499 n^{9}}{725760} + \frac{229093 n^{8}}{290304} + \frac{4775993 n^{7}}{1209600} + \frac{239805679 n^{6}}{21772800} + \frac{2313469 n^{5}}{80640} + \frac{85217281 n^{4}}{1088640} - \frac{37150333 n^{3}}{907200} - \frac{7297121 n^{2}}{207900} + \frac{474241 n}{1386} - 383.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224169.
