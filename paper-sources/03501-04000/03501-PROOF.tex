...
\title{The conjectured generating function for OEIS A239031, proved}
...
\begin{abstract}
OEIS A239031 counts arrays of a fixed width under a local condition, and carries a conjectured
...
coefficients of their expansions do. Comparing $28$ coefficients in exact arithmetic
...
OEIS A239031 is ``Number of 4 X n 0..2 arrays with no element equal to the sum of elements to its left or one plus the sum of the elements above it, modulo 3.''. It has offset $1$ and begins
\[
4, 11, 28, 59, 110, 189,\ \dots
\]
The entry states, as a conjecture contributed by a reader and never marked settled:
\begin{quote}
G.f.: x*(4 - 9*x + 13*x\^{}2 - 11*x\^{}3 + 5*x\^{}4) / (1 - x)\^{}5.
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 25 2018 08:13:18, revision 8) this is still
...
exact integer arithmetic, those of $N_2/D_2$ by exact rational long division, and $28$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A239031.
