...
\title{The empirical column recurrences for the table OEIS A203826}
...
\begin{abstract}
OEIS A203826 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A203826 is ``T(n,k)=Number of (n+1)X(k+1) 0..3 arrays with no 2X2 subblock having equal diagonal elements or equal antidiagonal elements.''. It has offset $1$, is
read by antidiagonals, and begins
\[
144, 1296, 1296, 11664, 27216, 11664, 104976, 571536,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 10:45:08, revision 9) these are still
...
The sequence is ``Number of (n+1)X(5) 0..3 arrays with no 2X2 subblock having equal diagonal elements or equal antidiagonal elements.''. Its rows are the vertices of a digraph on
...
\[
a(n)\;=\;117\,a(n-1) - 34398\,a(n-3) + 86436\,a(n-4)
\]
holds for every $n>4$.
...
values, $104$ decimal digits in all, every one of them exactly; a misreading of the entry
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A203826.
