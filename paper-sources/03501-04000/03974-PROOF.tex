...
\title{The empirical recurrence for OEIS A223506, proved by transfer matrix}
...
\begin{abstract}
OEIS A223506 counts the ways of writing the vertices of a fixed graph $G$ into an array of width
...
single slice is a state and the count is a walk count on a finite digraph with $S=132$ vertices.
\end{abstract}
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=132.
\]
...
\begin{theorem}
\[
a(n)\;=\;12\,a(n-1) - 4\,a(n-2) - 73\,a(n-3) + 103\,a(n-4) - 23\,a(n-5) - 16\,a(n-6) + 4\,a(n-7)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223506.
