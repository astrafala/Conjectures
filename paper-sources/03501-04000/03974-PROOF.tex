...
\title{The empirical recurrence for OEIS A232944, proved by transfer matrix}
...
\begin{abstract}
OEIS A232944 counts arrays over $\{0,\dots,3\}$ in which no two entries that are neighbours in
...
carried by one bounded piece of extra state, so the count is a walk count on $S=14$ states.
\end{abstract}
...
OEIS A232944 is ``Number of n X 4 0..3 arrays with no element x(i,j) adjacent to value 3-x(i,j) horizontally, vertically or antidiagonally, and top left element zero.''. It has offset $1$ and begins
\[
27, 577, 13707, 328989, 7915555, 190528543, 4586348177, 110402289283,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 23:34:49, revision 8) this is still
...
identified; after that identification there are $S=14$ of them.
...
\begin{theorem}
\[
a(n)\;=\;29\,a(n-1) - 126\,a(n-2) + 186\,a(n-3) - 207\,a(n-4) + 40\,a(n-5) + 83\,a(n-6) - 29\,a(n-7) - 14\,a(n-8) + 8\,a(n-9) - a(n-10)
\]
for every $n>11$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232944.
