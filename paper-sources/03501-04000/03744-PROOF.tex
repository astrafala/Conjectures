...
\title{The empirical recurrence for OEIS A268898, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A268898 counts arrays over $\{0,\dots,2\}$ subject to a condition on the array as a
...
OEIS A268898 is ``Number of n X 2 0..2 arrays with some element plus some horizontally or antidiagonally adjacent neighbor totalling two exactly once.''. It has offset $1$ and begins
\[
3, 36, 240, 1344, 6912, 33792, 159744, 737280,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 8*a(n-1) - 16*a(n-2).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 16 2019 09:24:00, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268898.
