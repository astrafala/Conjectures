...
\title{The empirical recurrence for OEIS A253029, proved by transfer matrix}
...
\begin{abstract}
OEIS A253029 counts arrays of width $3$ over an alphabet of $3$ letters in which every three
...
OEIS A253029 is ``Number of (n+2) X (1+2) 0..2 arrays with every consecutive three elements in every row and column having exactly two distinct values, and new values 0 upwards introduced in row major order.''. It has offset $1$ and begins
\[
297, 1647, 9126, 50571, 280233, 1552878, 8605089, 47684079,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 5*a(n-1) + 3*a(n-2).
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 08 2018 11:22:29, revision 9) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253029.
