...
\title{The empirical recurrence for OEIS A202373, proved by transfer matrix}
...
\begin{abstract}
OEIS A202373 counts arrays of width $5$ over $\{0,1\}$ containing no occurrence of certain short
...
count is a walk count on $S=183$ states.
\end{abstract}
...
OEIS A202373 is ``Number of (n+2)X5 binary arrays avoiding patterns 001 and 111 in rows and columns.''. It has offset $1$ and begins
\[
611, 2293, 7349, 20247, 54611, 136304, 327679, 763588,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 09:33:01, revision 9) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=183.
\]
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + 6\,a(n-2) - 27\,a(n-3) - 58\,a(n-4) + 123\,a(n-5) + 317\,a(n-6) - 210\,a(n-7) - 1221\,a(n-8) - 292\,a(n-9) + 2673\,a(n-10) + 2865\,a(n-11) - 2824\,a(n-12) - 6786\,a(n-13) - 1929\,a(n-14) + 7083\,a(n-15) + 8031\,a(n-16) + 1548\,a(n-17) - 6345\,a(n-18) - 7798\,a(n-19) - 5052\,a(n-20) + 2589\,a(n-21) + 4899\,a(n-22) + 5997\,a(n-23) + 2472\,a(n-24) + 3139\,a(n-25) - 3481\,a(n-26) - 3858\,a(n-27) - 7252\,a(n-28) - 570\,a(n-29) - 2112\,a(n-30) + 5334\,a(n-31) + 1212\,a(n-32) + 5048\,a(n-33) - 2659\,a(n-34) + 2670\,a(n-35) - 2841\,a(n-36) + 3203\,a(n-37) - 2780\,a(n-38) + 2044\,a(n-39) - 4190\,a(n-40) + 641\,a(n-41) - 3147\,a(n-42) + 2045\,a(n-43) - 992\,a(n-44) + 2429\,a(n-45) - 588\,a(n-46) + 1430\,a(n-47) - 717\,a(n-48) + 793\,a(n-49) - 543\,a(n-50) + 320\,a(n-51) - 513\,a(n-52) + 16\,a(n-53) - 325\,a(n-54) + 59\,a(n-55) - 47\,a(n-56) + 114\,a(n-57) + 23\,a(n-58) + 48\,a(n-59) - 5\,a(n-60) + a(n-61) - 9\,a(n-62) - 2\,a(n-63) - 2\,a(n-64)
\]
for every $n>63$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A202373.
