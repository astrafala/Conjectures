...
\title{The empirical recurrence for OEIS A211590, proved by transfer matrix}
...
\begin{abstract}
OEIS A211590 carries an empirical recurrence of order $14$ contributed by R. H. Hardin. It is
...
OEIS A211590 is ``Number of -2..2 arrays x(i) of n+1 elements i=1..n+1 with set{t,u,v in 0,1}((x[i+t]+x[j+u]+x[k+v])*(-1)\^{}(t+u+v)) having four, five, six or eight distinct values for every i,j,k<=n.''. It has offset $1$ and begins
\[
16, 48, 124, 306, 712, 1682, 3824, 9010,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 16:15:43, revision 8) this is still
...
admissible array is then exactly a walk, so with $M$ the adjacency matrix on $S=22$ vertices
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + 11\,a(n-2) - 61\,a(n-3) - 20\,a(n-4) + 343\,a(n-5) - 156\,a(n-6) - 890\,a(n-7) + 756\,a(n-8) + 1066\,a(n-9) - 1196\,a(n-10) - 504\,a(n-11) + 720\,a(n-12) + 72\,a(n-13) - 144\,a(n-14)
\]
for every $n>14$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A211590.
