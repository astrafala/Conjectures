...
\title{The empirical closed form for OEIS A250146, proved}
...
\begin{abstract}
OEIS A250146 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A250146 is ``Number of length 7+2 0..n arrays with the medians of every three consecutive terms nondecreasing.''. It has offset $1$ and begins
\[
180, 4530, 45232, 274901, 1219944, 4350588, 13201680, 35373129,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 20 2022 23:24:06, revision 6) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\begin{multline*}
f(n)\;=\;\frac{169 n^{9}}{3780} + \frac{1867 n^{8}}{2520} \\
+ \frac{4241 n^{7}}{840} + \frac{829 n^{6}}{45} \\
+ \frac{7103 n^{5}}{180} + \frac{18479 n^{4}}{360} \\
+ \frac{305191 n^{3}}{7560} + \frac{11659 n^{2}}{630} \\
+ \frac{533 n}{105} + 1.
\end{multline*}
...
$n=1,\dots,10$ and agree at each. A monic recurrence of order $10$
determines $a(m)$ from $a(m-1),\dots,a(m-10)$, and for every $m\ge11$ both
$m>0$ and $m-10\ge1$ hold, so induction on $m$ gives $a(m)=f(m)$ for every
$m\ge1$.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250146.
