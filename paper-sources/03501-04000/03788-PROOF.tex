...
\title{The empirical recurrence for OEIS A262330, proved by transfer matrix}
...
\begin{abstract}
OEIS A262330 counts arrays of width $7$ over $\{0,1\}$ whose rows, read as base-$2$
numbers, are divisible by $3$ and whose columns, read the same way, are divisible by
$3$. The entry carries an empirical recurrence of order $15$ contributed by
...
OEIS A262330 is ``Number of (n+1) X (6+1) 0..1 arrays with each row and column divisible by 3, read as a binary number with top and left being the most significant bits.''. It has offset $1$ and begins
\[
43, 261, 10935, 252097, 10789339, 394241389, 16940254423, 699094613961,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 09 2023 22:54:55, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;43\,a(n-1) + 793\,a(n-2) - 34099\,a(n-3) - 191667\,a(n-4) + 8241681\,a(n-5) + 20015927\,a(n-6) - 860684861\,a(n-7) - 980560940\,a(n-8) + 42164120420\,a(n-9) + 22309346640\,a(n-10) - 959301905520\,a(n-11) - 209959392832\,a(n-12) + 9028253891776\,a(n-13) + 540712883200\,a(n-14) - 23250653977600\,a(n-15)
\]
for every $n>13$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A262330.
