...
\title{The empirical recurrence for OEIS A210261, proved by transfer matrix}
...
\begin{abstract}
OEIS A210261 counts arrays of width $3$ whose every $2\times2$ subblock holds a
...
OEIS A210261 is ``Number of (n+1)X3 0..3 arrays containing all values 0..3 with every 2X2 subblock having three distinct values, and new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
29, 1039, 25901, 592969, 13233079, 292930403, 6467110597, 142651105201,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 32*a(n-1) -225*a(n-2) +2856*a(n-4) -2952*a(n-5) -4100*a(n-6) +3664*a(n-7) -384*a(n-8)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 15:50:19, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;32\,a(n-1) - 225\,a(n-2) + 2856\,a(n-4) - 2952\,a(n-5) - 4100\,a(n-6) + 3664\,a(n-7) - 384\,a(n-8)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A210261.
