...
\title{The empirical recurrence for OEIS A232909, proved by transfer matrix}
...
\begin{abstract}
OEIS A232909 counts arrays of width $2$ over $\{0,1,2\}$ in which every cell sees its own value plus and minus one among its neighbours. The entry carries an
...
OEIS A232909 is ``Number of (1+1) X (n+1) 0..2 arrays with every element next to itself plus and minus one within the range 0..2 horizontally or antidiagonally.''. It has offset $1$ and begins
\[
0, 10, 52, 82, 432, 2372, 8456, 29970,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-2) + 28*a(n-3) + 80*a(n-4) + 48*a(n-5) - 67*a(n-6) - 228*a(n-7) - 224*a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 06 2018 04:41:49, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-2) + 28\,a(n-3) + 80\,a(n-4) + 48\,a(n-5) - 67\,a(n-6) - 228\,a(n-7) - 224\,a(n-8)
\]
for every $n>7$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232909.
