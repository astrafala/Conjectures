...
\title{The empirical recurrence for OEIS A269138, proved by transfer matrix}
...
\begin{abstract}
OEIS A269138 counts arrays of width $3$ over $\{0,1,2,3\}$ in which the number of adjacent PAIRS of
...
OEIS A269138 is ``Number of nX3 0..3 arrays with some element plus some horizontally, antidiagonally or vertically adjacent neighbor totalling three no more than once.''. It has offset $1$ and begins
\[
60, 1164, 18556, 275796, 3924212, 54199284, 732561916, 9740150372,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 26*a(n-1) -199*a(n-2) +408*a(n-3) -463*a(n-4) +322*a(n-5) -141*a(n-6) +36*a(n-7) -4*a(n-8) for n>9
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 20 2016 06:50:05, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269138.
