...
\title{The conjectured generating function for OEIS A287193, proved}
...
\begin{abstract}
OEIS A287193 counts arrays of a fixed width under a local condition, and carries a conjectured
