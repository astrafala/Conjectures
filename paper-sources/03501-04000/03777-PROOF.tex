...
\title{The empirical recurrence for OEIS A268164, proved by transfer matrix}
...
\begin{abstract}
OEIS A268164 counts arrays in which the REPEATED VALUES of each row, and of each column, stand in a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 11 2019 10:44:41, revision 9) this is still
