...
\title{The empirical recurrence for OEIS A276294, proved by counting patterns}
...
\begin{abstract}
OEIS A276294 counts arrays in which no entry may repeat a value found at any of three stated
...
cutting $794$ pairs to $S=155$ states. The entry's empirical recurrence of order $5$,
...
OEIS A276294 is ``Number of n X 3 0..2 arrays with no element equal to any value at offset (-2,-1) (-1,1) or (0,-1) and new values introduced in order 0..2.''. It has offset $1$ and begins
\[
2, 12, 45, 189, 805, 3437, 14693, 62829,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 6*a(n-1) - 8*a(n-2) + 4*a(n-3) - 7*a(n-4) + 6*a(n-5) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 05 2019 18:42:28, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) - 8\,a(n-2) + 4\,a(n-3) - 7\,a(n-4) + 6\,a(n-5)
\end{equation}
for all $n>7$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A276294.
