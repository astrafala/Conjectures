...
\title{The empirical recurrence for OEIS A223230, proved by transfer matrix}
...
\begin{abstract}
OEIS A223230 counts the ways of writing the vertices of a fixed graph $G$ into an array of width
$5$ so that any two cells adjacent in one of the named directions carry vertices joined by an
edge of $G$; here $G$ is icosahedron graph. The entry carries an empirical recurrence of order $11$
...
OEIS A223230 is ``Rolling icosahedron footprints: number of n X 5 0..11 arrays starting with 0 where 0..11 label vertices of an icosahedron and every array movement to a horizontal, diagonal or antidiagonal neighbor moves along an icosahedral edge.''. It has offset $1$ and begins
\[
625, 75665, 11043445, 1697263985, 266409703885, 42210625593305, 6716507564288245, 1070788920090847265,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 21:23:34, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;251\,a(n-1) - 15873\,a(n-2) + 195175\,a(n-3) + 2042368\,a(n-4) - 47798442\,a(n-5) + 263976930\,a(n-6) - 451699632\,a(n-7) - 350892000\,a(n-8) + 1964608344\,a(n-9) - 2144659680\,a(n-10) + 765275040\,a(n-11)
\]
for every $n>11$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223230.
