...
\title{The empirical recurrence for OEIS A281717, proved by transfer matrix}
...
\begin{abstract}
OEIS A281717 counts $3\times n$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A281717 is ``Number of 3 X n 0..1 arrays with no element unequal to a strict majority of its horizontal, diagonal and antidiagonal neighbors and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
4, 4, 8, 38, 90, 305, 902, 2710,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 19 2022 15:26:41, revision 6) this is still
...
the condition
\[
\text{no cell is unequal to a strict majority of its horizontal, diagonal and antidiagonal neighbours},
\]
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + 8\,a(n-2) - 16\,a(n-3) - 46\,a(n-4) + 39\,a(n-5) + 121\,a(n-6) - 66\,a(n-7) - 185\,a(n-8) + 78\,a(n-9) + 216\,a(n-10) - 71\,a(n-11) - 182\,a(n-12) + 51\,a(n-13) + 107\,a(n-14) - 24\,a(n-15) - 43\,a(n-16) + 7\,a(n-17) + 10\,a(n-18) - a(n-19) - a(n-20)
\]
for every $n>21$.
\end{theorem}
...
By Lemma~\ref{lem:crit} the recurrence holds for every $n>21$. The bound is exact: at $n=21$ the recurrence fails on the entry's own published terms, so no larger range holds.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A281717.
