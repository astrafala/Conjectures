...
\title{The empirical column recurrences for the table OEIS A235849}
...
\begin{abstract}
OEIS A235849 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A235849 is ``T(n,k)=Number of (n+1)X(k+1) 0..3 arrays with the upper median unequal to the lower median in every 2X2 subblock.''. It has offset $1$, is
read by antidiagonals, and begins
\[
156, 1584, 1584, 16228, 42080, 16228, 166816, 1133608,\ \dots
\]
The entry carries the following block:
\begin{quote}\small
Empirical for column k:\\
k=1: a(n) = 14*a(n-1) -31*a(n-2) -94*a(n-3) +192*a(n-4) +192*a(n-5)\\
k=2: [order 15]\\
k=3: [order 55]\\
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 08:53:37, revision 6) these are still
...
The sequence is ``Number of (n+1)X(2) 0..3 arrays with the upper median unequal to the lower median in every 2X2 subblock.''. Its rows are the vertices of a digraph on
...
\[
a(n)\;=\;14\,a(n-1) - 31\,a(n-2) - 94\,a(n-3) + 192\,a(n-4) + 192\,a(n-5)
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A235849.
