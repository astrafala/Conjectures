...
\title{The empirical closed form for OEIS A223639, proved}
...
\begin{abstract}
OEIS A223639 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
$S=3584$ vertices. Any function of the form $\sum_j p_j(n)\lambda_j^{\,n}$ satisfies the
...
OEIS A223639 is ``Number of n X 3 0..1 arrays with rows, columns, diagonals and antidiagonals unimodal.''. It has offset $1$ and begins
\[
7, 49, 218, 726, 2014, 4904, 10797, 21917,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (23/360)*n\^{}6 - (3/40)*n\^{}5 + (31/18)*n\^{}4 + (5/8)*n\^{}3 + (1517/360)*n\^{}2 - (51/20)*n + 3.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 22 2018 06:25:26, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{23 n^{6}}{360} - \frac{3 n^{5}}{40} + \frac{31 n^{4}}{18} + \frac{5 n^{3}}{8} + \frac{1517 n^{2}}{360} - \frac{51 n}{20} + 3.
\]
...
walk, so with $M$ the adjacency matrix of that digraph on $S=3584$ vertices, and $u,w$ the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223639.
