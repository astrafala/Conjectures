...
\title{The empirical recurrence for OEIS A233083, proved by transfer matrix}
...
\begin{abstract}
OEIS A233083 counts arrays over $\{0,\dots,3\}$ under a neighbour condition together with
...
OEIS A233083 is ``Number of 2 X n 0..3 arrays with no element x(i,j) adjacent to value 3-x(i,j) horizontally or antidiagonally, top left element zero, and 1 appearing before 2 in row major order.''. It has offset $1$ and begins
\[
3, 14, 95, 662, 4631, 32414, 226895, 1588262,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 8*a(n-1) - 7*a(n-2) for n>3.
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 07 2018 08:21:23, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A233083.
