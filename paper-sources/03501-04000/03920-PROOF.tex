...
\title{The empirical recurrence for OEIS A224370, proved by transfer matrix}
...
\begin{abstract}
OEIS A224370 counts arrays over $\{0,\dots,2\}$ whose rows, columns, diagonals or
...
is a walk count on $S=46$ vertices and the recurrence follows from a finite exact
computation.
\end{abstract}
...
OEIS A224370 is ``Number of n X 4 0..2 arrays with rows unimodal and antidiagonals nondecreasing.''. It has offset $1$ and begins
\[
46, 698, 7608, 77793, 800309, 8297747, 86251004, 896856330,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 15*a(n-1) - 58*a(n-2) + 105*a(n-3) + 20*a(n-4) - 183*a(n-5) + 220*a(n-6) + 240*a(n-7) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 30 2018 06:07:24, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;15\,a(n-1) - 58\,a(n-2) + 105\,a(n-3) + 20\,a(n-4) - 183\,a(n-5) + 220\,a(n-6) + 240\,a(n-7)
\end{equation}
for all $n>8$.
...
bit vector), $|\mathcal V|=S=46$; let $(r,f)\to(s,f')$ be an edge when placing $s$ after $r$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224370.
