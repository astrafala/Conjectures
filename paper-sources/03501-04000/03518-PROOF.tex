...
\title{The empirical recurrence for OEIS A269084, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A269084 counts arrays over $\{0,\dots,1\}$ subject to a condition on the array as a
...
OEIS A269084 is ``Number of n X 3 binary arrays with some element plus some horizontally, vertically or antidiagonally adjacent neighbor totalling two not more than once.''. It has offset $1$ and begins
\[
7, 30, 114, 428, 1531, 5387, 18590, 63347,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) + 9*a(n-2) - 2*a(n-3) - 33*a(n-4) - 42*a(n-5) - 14*a(n-6) + 10*a(n-7) + 8*a(n-8) - a(n-10).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 19 2019 06:41:44, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 9\,a(n-2) - 2\,a(n-3) - 33\,a(n-4) - 42\,a(n-5) - 14\,a(n-6) + 10\,a(n-7) + 8\,a(n-8) - a(n-10)
\end{equation}
for all $n>10$.
...
those integers vanishes from the index corresponding to $n=10+1$ onwards, and the run
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269084.
