...
\title{The empirical recurrence for OEIS A208310, proved by counting patterns}
...
\begin{abstract}
OEIS A208310 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A208310 is ``Number of n X 4 0..1 arrays with new values 0..1 introduced in row major order and no element equal to more than one of its immediate leftward or upward neighbors.''. It has offset $1$ and begins
\[
8, 54, 336, 2052, 12474, 75744, 459810, 2791152,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 9*a(n-1) - 21*a(n-2) + 21*a(n-3) - 9*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 30 2018 15:11:03, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208310.
