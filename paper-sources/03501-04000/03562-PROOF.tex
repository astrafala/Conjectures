...
\title{The empirical closed form for OEIS A224002, proved}
...
\begin{abstract}
OEIS A224002 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A224002 is ``Number of 4 X n 0..2 arrays with antidiagonals unimodal and rows and diagonals nondecreasing.''. It has offset $1$ and begins
\[
81, 793, 2980, 7927, 17929, 36845, 71061, 130767,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 25 2018 15:41:25, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{n^{8}}{2880} + \frac{n^{7}}{180} + \frac{25 n^{6}}{288} + \frac{169 n^{5}}{180} + \frac{18649 n^{4}}{2880} + \frac{4247 n^{3}}{90} + \frac{2719 n^{2}}{16} - \frac{6649 n}{30} - 17.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224002.
