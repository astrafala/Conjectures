...
\title{The empirical recurrence for OEIS A268992, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A268992 counts arrays over $\{0,\dots,1\}$ subject to a condition on the array as a
...
OEIS A268992 is ``Number of nX5 binary arrays with some element plus some horizontally or antidiagonally adjacent neighbor totalling two not more than once.''. It has offset $1$ and begins
\[
23, 278, 3331, 37987, 421450, 4583103, 49084071, 519385102,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 26*a(n-1) -241*a(n-2) +994*a(n-3) -2060*a(n-4) +2218*a(n-5) -1201*a(n-6) +290*a(n-7) -25*a(n-8) for n>9
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 17 2016 07:24:12, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;26\,a(n-1) - 241\,a(n-2) + 994\,a(n-3) - 2060\,a(n-4) + 2218\,a(n-5) - 1201\,a(n-6) + 290\,a(n-7) - 25\,a(n-8)
\end{equation}
for all $n>9$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268992.
