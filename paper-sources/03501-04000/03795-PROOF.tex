...
\title{The empirical closed form for OEIS A207390, proved}
...
\begin{abstract}
OEIS A207390 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A207390 is ``Number of n X 7 0..1 arrays avoiding 0 0 1 and 0 1 0 horizontally and 0 0 1 and 1 1 0 vertically.''. It has offset $1$ and begins
\[
31, 961, 6115, 23071, 65955, 158217, 335915, 651531,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (1/210)*n\^{}7 + (103/180)*n\^{}6 + (197/20)*n\^{}5 + (1439/36)*n\^{}4 + (293/20)*n\^{}3 - (3469/90)*n\^{}2 + (157/105)*n + 3.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 22 2018 07:08:16, revision 9) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{n^{7}}{210} + \frac{103 n^{6}}{180} + \frac{197 n^{5}}{20} + \frac{1439 n^{4}}{36} + \frac{293 n^{3}}{20} - \frac{3469 n^{2}}{90} + \frac{157 n}{105} + 3.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207390.
