...
\title{The empirical recurrence for OEIS A209890, proved by counting patterns}
...
\begin{abstract}
OEIS A209890 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A209890 is ``Number of (n+1) X 2 0..2 arrays with every 2 X 2 subblock having two distinct values, and new values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
7, 34, 164, 792, 3824, 18464, 89152, 430464,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 4*a(n-1) +4*a(n-2).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 10 2014 13:27:18, revision 12) the statement is
...
Fix the shape: $2$ columns and $L=n+1$ rows, so $L\cdot2$ cells. Call a
...
\eqref{eq:walk}, divided by $3!$, was evaluated at every one of the $21$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209890.
