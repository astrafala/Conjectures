...
\title{The empirical recurrence for OEIS A240784, proved by transfer matrix}
...
\begin{abstract}
OEIS A240784 counts $3\times n$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A240784 is ``Number of 3 X n 0..1 arrays with no element equal to fewer vertical neighbors than horizontal neighbors, with new values 0..1 introduced in row major order.''. It has offset $1$ and begins
\[
4, 11, 20, 46, 97, 216, 472, 1043,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + a(n-2) - a(n-3) - a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 29 2018 06:43:09, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A240784.
