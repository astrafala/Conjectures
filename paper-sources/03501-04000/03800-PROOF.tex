...
\title{The empirical recurrence for OEIS A231318, proved by transfer matrix}
...
\begin{abstract}
OEIS A231318 counts $(n+1)\times3$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A231318 is ``Number of (n+1) X (2+1) 0..2 arrays with no element equal to a strict majority of its diagonal and antidiagonal neighbors, with values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
24, 432, 9600, 192192, 3917184, 79306752, 1607468544, 32569451520,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 22*a(n-1) -776*a(n-3) +944*a(n-4) +7168*a(n-5) -12416*a(n-6) +9216*a(n-8) -4096*a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 02 2023 14:19:04, revision 6) this is still
...
the set is $\{(-1,-1), (1,1), (-1,1), (1,-1)\}$, written as offsets (row, column) from the cell. Every cell carries
the condition
\[
\text{no cell is equal to a strict majority of its diagonal and antidiagonal neighbours},
\]
...
\begin{theorem}
\[
a(n)\;=\;22\,a(n-1) - 776\,a(n-3) + 944\,a(n-4) + 7168\,a(n-5) - 12416\,a(n-6) + 9216\,a(n-8) - 4096\,a(n-9)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231318.
