...
\title{The empirical closed form for OEIS A223962, proved}
...
\begin{abstract}
OEIS A223962 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A223962 is ``Number of 2 X n 0..3 arrays with antidiagonals unimodal and rows and diagonals nondecreasing.''. It has offset $1$ and begins
\[
16, 85, 295, 805, 1876, 3906, 7470, 13365,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (1/144)*n\^{}6 + (7/48)*n\^{}5 + (157/144)*n\^{}4 + (59/16)*n\^{}3 + (425/72)*n\^{}2 + (25/6)*n + 1.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 24 2018 17:03:56, revision 7) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{n^{6}}{144} + \frac{7 n^{5}}{48} + \frac{157 n^{4}}{144} + \frac{59 n^{3}}{16} + \frac{425 n^{2}}{72} + \frac{25 n}{6} + 1.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223962.
