...
\title{The empirical recurrence for OEIS A262419, proved by transfer matrix}
...
\begin{abstract}
OEIS A262419 counts arrays of width $8$ over $\{0,1\}$ whose rows, read as base-$2$
numbers, are divisible by $3$ and whose columns, read the same way, are not divisible by
$3$. The entry carries an empirical recurrence of order $19$ contributed by
...
OEIS A262419 is ``Number of (n+1)X(7+1) 0..1 arrays with each row divisible by 3 and column not divisible by 3, read as a binary number with top and left being the most significant bits.''. It has offset $1$ and begins
\[
86, 15293, 1299070, 163388421, 14036526126, 1326209720893, 114043973318270, 10040316574125941,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 22 2015 09:31:10, revision 4) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The array has $8$ cells across and entries $x(i,j)\in\{0,1\}$, the digits of
base $2$. Row $i$ of an array with $R$ rows is the number
\[
\rho_i\;=\;\sum_{j=1}^{8}x(i,j)\,2^{8-j} ,
\]
...
$3$ and every $\gamma_j$ be not divisible by $3$.
...
So the vector $\bigl(\gamma_1\bmod 3,\dots,\gamma_{8}\bmod
3\bigr)$ is a state: at most $3^{8}$ of them, and each array row
...
which every entry is not divisible by $3$ --- so the end vector is not the all-ones
...
\begin{theorem}
\[
a(n)\;=\;86\,a(n-1) + 3252\,a(n-2) - 279672\,a(n-3) - 3329646\,a(n-4) + 286349556\,a(n-5) + 1544583660\,a(n-6) - 132834194760\,a(n-7) - 365579378025\,a(n-8) + 31439826510150\,a(n-9) + 46337467429704\,a(n-10) - 3985022198954544\,a(n-11) - 3102790005466128\,a(n-12) + 266839940470087008\,a(n-13) + 99548995158787584\,a(n-14) - 8561213583655732224\,a(n-15) - 1170690303846912000\,a(n-16) + 100679366130834432000\,a(n-17) + 3277061542543360000\,a(n-18) - 281827292658728960000\,a(n-19)
\]
for every $n>17$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A262419.
