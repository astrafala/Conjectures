...
\title{The empirical recurrence for OEIS A262423, proved by transfer matrix}
...
\begin{abstract}
OEIS A262423 counts arrays of width $5$ over $\{0,1\}$ whose rows, read as base-$2$
...
is then a walk count on $S=243$ states.
\end{abstract}
...
OEIS A262423 is ``Number of (4+1)X(n+1) 0..1 arrays with each row divisible by 3 and column not divisible by 3, read as a binary number with top and left being the most significant bits.''. It has offset $1$ and begins
\[
21, 48, 1701, 18228, 428301, 7577424, 163388421, 3287265300,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 22 2015 09:36:11, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;21\,a(n-1) + 189\,a(n-2) - 3969\,a(n-3) - 10719\,a(n-4) + 225099\,a(n-5) + 250803\,a(n-6) - 5266863\,a(n-7) - 2527200\,a(n-8) + 53071200\,a(n-9) + 9062928\,a(n-10) - 190321488\,a(n-11)
\]
for every $n>10$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A262423.
