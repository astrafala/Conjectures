...
\title{The empirical recurrence for OEIS A269048, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A269048 counts arrays over $\{0,\dots,2\}$ subject to a condition on the array as a
...
OEIS A269048 is ``Number of n X 4 0..2 arrays with some element plus some horizontally, diagonally or antidiagonally adjacent neighbor totalling two not more than once.''. It has offset $1$ and begins
\[
60, 360, 3078, 24192, 183072, 1350672, 9779808, 69793968,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 14*a(n-1) - 57*a(n-2) + 56*a(n-3) - 16*a(n-4) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 18 2019 16:24:54, revision 7) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269048.
