...
\title{The empirical recurrence for OEIS A223199, proved by transfer matrix}
...
\begin{abstract}
OEIS A223199 counts the ways of writing the vertices of a fixed graph $G$ into an array of width
$5$ so that any two cells adjacent in one of the named directions carry vertices joined by an
edge of $G$; here $G$ is octahedron graph. The entry carries an empirical recurrence of order $5$
...
single slice is a state and the count is a walk count on a finite digraph with $S=1537$ vertices.
\end{abstract}
...
OEIS A223199 is ``Rolling cube footprints: number of n X 5 0..5 arrays starting with 0 where 0..5 label faces of a cube and every array movement to a horizontal or vertical neighbor moves across a corresponding cube edge.''. It has offset $1$ and begins
\[
256, 82944, 27951104, 9515827200, 3249109204992, 1110327429169152, 379529320596504576, 129739120821684666368,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 512*a(n-1) -66560*a(n-2) +3014656*a(n-3) -50331648*a(n-4) +268435456*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 12 2026 15:40:44, revision 10) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=1537.
\]
...
\begin{theorem}
\[
a(n)\;=\;512\,a(n-1) - 66560\,a(n-2) + 3014656\,a(n-3) - 50331648\,a(n-4) + 268435456\,a(n-5)
\]
for every $n>4$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223199.
