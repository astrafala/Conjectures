...
\title{The empirical recurrence for OEIS A275179, proved by counting patterns}
...
\begin{abstract}
OEIS A275179 counts arrays in which no entry may repeat a value found at any of three stated
...
cutting $6818$ pairs to $S=1223$ states. The entry's empirical recurrence of order $9$,
...
OEIS A275179 is ``Number of n X 4 0..2 arrays with no element equal to any value at offset (-2,-1) (-1,0) or (-1,1) and new values introduced in order 0..2.''. It has offset $1$ and begins
\[
14, 64, 89, 141, 353, 914, 2386, 6228,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 8*a(n-1) - 28*a(n-2) + 57*a(n-3) - 70*a(n-4) + 47*a(n-5) - 12*a(n-6) - a(n-7) - 2*a(n-8) + a(n-9) for n>12.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 01 2019 05:32:43, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;8\,a(n-1) - 28\,a(n-2) + 57\,a(n-3) - 70\,a(n-4) + 47\,a(n-5) - 12\,a(n-6) - a(n-7) - 2\,a(n-8) + a(n-9)
\end{equation}
for all $n>12$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A275179.
