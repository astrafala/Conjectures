...
\title{The empirical closed form for OEIS A184547, proved}
...
\begin{abstract}
OEIS A184547 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
$S=81749$ vertices. Any function of the form $\sum_j p_j(n)\lambda_j^{\,n}$ satisfies the
...
OEIS A184547 is ``Number of (n+2) X 10 binary arrays with each 3 X 3 subblock having rows and columns in lexicographically nondecreasing order.''. It has offset $1$ and begins
\[
682, 2000, 4837, 10909, 23648, 49489, 99872, 194245,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 14 2018 07:33:49, revision 9) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{n^{10}}{3628800} + \frac{n^{9}}{48384} + \frac{83 n^{8}}{120960} + \frac{107 n^{7}}{8064} + \frac{28573 n^{6}}{172800} + \frac{5323 n^{5}}{3840} + \frac{1434973 n^{4}}{181440} + \frac{366371 n^{3}}{12096} + \frac{2399357 n^{2}}{12600} + \frac{151541 n}{420} + 91.
\]
...
walk, so with $M$ the adjacency matrix of that digraph on $S=81749$ vertices, and $u,w$ the
...
$n=12,\dots,22$ and agree at each. A monic recurrence of order $11$
determines $a(m)$ from $a(m-1),\dots,a(m-11)$, and for every $m\ge23$ both
$m>11$ and $m-11\ge12$ hold, so induction on $m$ gives $a(m)=f(m)$ for every
$m\ge12$.
Below $n=12$ the recurrence argument gives nothing, since \eqref{eq:rec} is only
established for $a$ from $n=12$ on. The remaining indices $n=1,\dots,11$ were
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A184547.
