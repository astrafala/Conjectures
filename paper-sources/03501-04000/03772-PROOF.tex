...
\title{The empirical closed form for OEIS A224410, proved}
...
\begin{abstract}
OEIS A224410 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A224410 is ``Number of 3 X n 0..1 arrays with rows unimodal and antidiagonals nondecreasing.''. It has offset $1$ and begins
\[
8, 36, 100, 228, 465, 879, 1568, 2668,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (1/720)*n\^{}6 + (1/48)*n\^{}5 + (29/144)*n\^{}4 + (13/16)*n\^{}3 + (2087/360)*n\^{}2 + (7/6)*n.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 30 2018 22:40:10, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{n^{6}}{720} + \frac{n^{5}}{48} + \frac{29 n^{4}}{144} + \frac{13 n^{3}}{16} + \frac{2087 n^{2}}{360} + \frac{7 n}{6}.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224410.
