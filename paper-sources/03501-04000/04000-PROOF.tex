...
\title{The empirical recurrence for OEIS A223478, proved by transfer matrix}
...
\begin{abstract}
OEIS A223478 counts the ways of writing the vertices of a fixed graph $G$ into an array of width
...
single slice is a state and the count is a walk count on a finite digraph with $S=4861$ vertices.
\end{abstract}
...
OEIS A223478 is ``Rolling icosahedron face footprints: number of n X 6 0..19 arrays starting with 0 where 0..19 label faces of an icosahedron and every array movement to a horizontal or antidiagonal neighbor moves across an icosahedral edge.''. It has offset $1$ and begins
\[
243, 16875, 1296675, 101331675, 7939566675, 622332801675, 48783753036675, 3824122400271675,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 101*a(n-1) -1900*a(n-2) +10000*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 20 2018 14:37:05, revision 8) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=4861.
\]
...
of length $6$ over $20$ vertices is one of $20^{6}$ words, but only $S-1$ of them are
...
\begin{theorem}
\[
a(n)\;=\;101\,a(n-1) - 1900\,a(n-2) + 10000\,a(n-3)
\]
for every $n>3$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223478.
