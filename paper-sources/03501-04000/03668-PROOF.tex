...
\title{The empirical recurrence for OEIS A210101, proved by counting patterns}
...
\begin{abstract}
OEIS A210101 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A210101 is ``Number of (n+1) X 3 0..2 arrays with every 2 X 2 subblock having one or three distinct values, and new values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
30, 225, 1690, 12725, 95830, 721705, 5435250, 40933565,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 8*a(n-1) - 3*a(n-2) - 4*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 14 2018 15:34:32, revision 13) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;8\,a(n-1) - 3\,a(n-2) - 4\,a(n-3)
\end{equation}
for all $n>2$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A210101.
