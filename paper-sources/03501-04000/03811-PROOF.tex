...
\title{The empirical closed form for OEIS A224142, proved}
...
\begin{abstract}
OEIS A224142 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A224142 is ``Number of n X 4 0..1 arrays with rows and antidiagonals unimodal and columns nondecreasing.''. It has offset $1$ and begins
\[
11, 46, 124, 272, 526, 930, 1536, 2404,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (1/3)*n\^{}4 + (4/3)*n\^{}3 + (14/3)*n\^{}2 + (23/3)*n - 4 for n>1.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 27 2018 16:47:25, revision 7) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{n^{4}}{3} + \frac{4 n^{3}}{3} + \frac{14 n^{2}}{3} + \frac{23 n}{3} - 4.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224142.
