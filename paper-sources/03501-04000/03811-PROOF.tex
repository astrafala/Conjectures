...
\title{The empirical recurrence for OEIS A210005, proved by transfer matrix}
...
\begin{abstract}
OEIS A210005 counts arrays of width $2$ whose every $2\times2$ subblock holds a
...
OEIS A210005 is ``Number of (n+1) X 2 0..2 arrays containing all values 0..2 with every 2 X 2 subblock having two or three distinct values, and new values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
6, 88, 893, 8217, 73035, 640495, 5586791, 48624987,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 11*a(n-1) - 16*a(n-2) - 34*a(n-3) - 12*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 14 2018 05:20:29, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;11\,a(n-1) - 16\,a(n-2) - 34\,a(n-3) - 12\,a(n-4)
\]
for every $n>4$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A210005.
