...
\title{The empirical recurrence for OEIS A223267, proved by transfer matrix}
...
\begin{abstract}
OEIS A223267 counts the ways of writing the vertices of a fixed graph $G$ into an array of width
...
OEIS A223267 is ``Rolling cube footprints: number of nX6 0..5 arrays starting with 0 where 0..5 label faces of a cube and every array movement to a horizontal, diagonal or antidiagonal neighbor moves across a corresponding cube edge.''. It has offset $1$ and begins
\[
1024, 737280, 611319808, 522106961920, 450204914417664, 389343801904201728, 337035427916688654336, 291846966499723716853760,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 21:26:27, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;1152\,a(n-1) - 229376\,a(n-2) - 21233664\,a(n-3) + 4697620480\,a(n-4) + 12884901888\,a(n-5) - 17798344474624\,a(n-6) + 343047627866112\,a(n-7) + 6755399441055744\,a(n-8) - 90071992547409920\,a(n-9)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223267.
