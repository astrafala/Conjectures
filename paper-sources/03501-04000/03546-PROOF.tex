...
\title{Arrays counted up to renaming: the empirical recurrence for OEIS A205628}
...
\begin{abstract}
OEIS A205628 carries an empirical recurrence of order $13$ contributed by R.~H.~Hardin. It is
...
both in the state the arrays are exactly the walks in a digraph on $S=20$ vertices, so $a(n)$
...
OEIS A205628 is ``Number of 4X(n+1) 0..2 arrays with every 2X2 subblock in a row having an equal number of equal diagonal or equal antidiagonal elements, adjacent rows differing in this number, and new values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
396, 2052, 13068, 94116, 708300, 5439324, 42094188, 327077484,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 12:13:42, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;23\,a(n-1) - 174\,a(n-2) + 284\,a(n-3) + 2352\,a(n-4) - 10052\,a(n-5) - 1168\,a(n-6) + 65760\,a(n-7) - 78080\,a(n-8) - 116928\,a(n-9) + 255232\,a(n-10) - 49664\,a(n-11) - 116736\,a(n-12) + 49152\,a(n-13)
\]
for every $n>13$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A205628.
