...
\title{The empirical column recurrences for the table OEIS A251249}
...
\begin{abstract}
OEIS A251249 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A251249 is ``T(n,k)=Number of (n+1)X(k+1) 0..2 arrays with no 2X2 subblock having the sum of its diagonal elements less than the minimum of its antidiagonal elements.''. It has offset $1$, is
read by antidiagonals, and begins
\[
75, 621, 621, 5139, 14265, 5139, 42525, 327753,\ \dots
\]
The entry carries the following block:
\begin{quote}\small
Empirical for column k:\\
k=1: a(n) = 9*a(n-1) -6*a(n-2)\\
k=2: a(n) = 27*a(n-1) -94*a(n-2) +36*a(n-3) -4*a(n-4) -36*a(n-5)\\
k=3: [order 10]\\
k=4: [order 24]\\
k=5: [order 51]\\
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:12:42, revision 6) these are still
...
The sequence is ``Number of (n+1)X(2) 0..2 arrays with no 2X2 subblock having the sum of its diagonal elements less than the minimum of its antidiagonal elements.''. Its rows are the vertices of a digraph on
...
$c_{1}$ & $81$ & $c_{4}$ & $-544$ & $c_{7}$ & $-80352$ & $c_{10}$ & $20160$ \\
$c_{2}$ & $-1165$ & $c_{5}$ & $-4428$ & $c_{8}$ & $-67376$ &  &  \\
$c_{3}$ & $4257$ & $c_{6}$ & $7512$ & $c_{9}$ & $32256$ &  &  \\
\end{tabular}\end{center}
Repeating with the first $10+4$ terms removed gives order $10$ again.

\subsection*{Column $k=4$, recovered}
The entry gives only the order for this line: ``k=4: [order 24]''. Its model is a walk on
...
$24$ --- the stated order --- with integer coefficients
\begin{center}\small\begin{tabular}{cccccccc}
$c_{1}$ & $243$ & $c_{7}$ & $36692136$ & $c_{13}$ & $324811988352$ & $c_{19}$ & $114288768000$ \\
$c_{2}$ & $-12974$ & $c_{8}$ & $-81363872$ & $c_{14}$ & $44140742400$ & $c_{20}$ & $-43963103232$ \\
$c_{3}$ & $236322$ & $c_{9}$ & $-13350417264$ & $c_{15}$ & $1172245859712$ & $c_{21}$ & $-23758092288$ \\
$c_{4}$ & $-1209024$ & $c_{10}$ & $-31190025008$ & $c_{16}$ & $1535371786496$ & $c_{22}$ & $-13501624320$ \\
$c_{5}$ & $-2903472$ & $c_{11}$ & $131686132896$ & $c_{17}$ & $-166686769152$ & $c_{23}$ & $51425280$ \\
$c_{6}$ & $39230408$ & $c_{12}$ & $557194797504$ & $c_{18}$ & $514029736704$ & $c_{24}$ & $35831808$ \\
\end{tabular}\end{center}
Repeating with the first $24+4$ terms removed gives order $24$ again.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251249.
