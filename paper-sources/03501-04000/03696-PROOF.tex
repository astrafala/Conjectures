...
\title{The empirical recurrence for OEIS A267729, proved by transfer matrix}
...
\begin{abstract}
OEIS A267729 counts arrays in which the REPEATED VALUES of each row, and of each column, stand in a
...
value so far in each column of the scan, so the count is a walk count on $S=37$ states.
\end{abstract}
...
OEIS A267729 is ``Number of n X 2 0..1 arrays with every repeated value in every row and column greater than or equal to the previous repeated value.''. It has offset $1$ and begins
\[
4, 16, 64, 225, 784, 2601, 8464, 26896,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 6*a(n-1) - 6*a(n-2) - 19*a(n-3) + 24*a(n-4) + 24*a(n-5) - 19*a(n-6) - 6*a(n-7) + 6*a(n-8) - a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 21 2018 09:40:11, revision 7) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=37,\quad\tau=\mathbf{1} .
\]
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) - 6\,a(n-2) - 19\,a(n-3) + 24\,a(n-4) + 24\,a(n-5) - 19\,a(n-6) - 6\,a(n-7) + 6\,a(n-8) - a(n-9)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267729.
