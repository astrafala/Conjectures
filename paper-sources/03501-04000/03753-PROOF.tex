...
\title{The empirical recurrence for OEIS A185561, proved by transfer matrix}
...
\begin{abstract}
OEIS A185561 counts arrays of width $3$ over $\{0,1,2,3\}$ in which no cell equals both the cell above it and the cell to its left. The entry carries an
...
OEIS A185561 is ``1/4 the number of n X 3 0..3 arrays with no element equal both to the element above and to the element to its left.''. It has offset $1$ and begins
\[
16, 900, 50580, 2842560, 159749820, 8977824540, 504547256880, 28355191537860,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 57*a(n-1) - 45*a(n-2).
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 16 2018 09:36:11, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A185561.
