...
\title{The empirical closed form for OEIS A224187, proved}
...
\begin{abstract}
OEIS A224187 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
$S=86$ vertices. Any function of the form $\sum_j p_j(n)\lambda_j^{\,n}$ satisfies the
...
OEIS A224187 is ``Number of nX5 0..2 arrays with rows unimodal and columns nondecreasing.''. It has offset $1$ and begins
\[
86, 1600, 14751, 89380, 408222, 1519738, 4844576, 13669953,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 23:17:55, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\begin{multline*}
f(n)\;=\;\frac{1009 n^{10}}{907200} + \frac{913 n^{9}}{36288} \\
+ \frac{15121 n^{8}}{60480} + \frac{8677 n^{7}}{6048} \\
+ \frac{226987 n^{6}}{43200} + \frac{110621 n^{5}}{8640} \\
+ \frac{3804217 n^{4}}{181440} + \frac{206081 n^{3}}{9072} \\
+ \frac{130433 n^{2}}{8400} + \frac{3793 n}{630} \\
+ 1.
\end{multline*}
...
walk, so with $M$ the adjacency matrix of that digraph on $S=86$ vertices, and $u,w$ the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224187.
