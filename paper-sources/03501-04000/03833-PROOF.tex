...
\title{The empirical closed form for OEIS A223914, proved}
...
\begin{abstract}
OEIS A223914 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A223914 is ``Number of n X 4 0..2 arrays with rows and antidiagonals unimodal and columns nondecreasing.''. It has offset $1$ and begins
\[
46, 548, 3311, 14123, 48182, 139925, 359344, 837243,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 24 2018 04:37:54, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{41 n^{8}}{4032} + \frac{41 n^{7}}{336} + \frac{1277 n^{6}}{1440} + \frac{953 n^{5}}{240} + \frac{5363 n^{4}}{576} + \frac{35 n^{3}}{2} + \frac{28211 n^{2}}{1680} - \frac{223 n}{140} - 7.
\]
...
$n=11,\dots,19$ and agree at each. A monic recurrence of order $9$
determines $a(m)$ from $a(m-1),\dots,a(m-9)$, and for every $m\ge20$ both
$m>10$ and $m-9\ge11$ hold, so induction on $m$ gives $a(m)=f(m)$ for every
$m\ge11$.
Below $n=11$ the recurrence argument gives nothing, since \eqref{eq:rec} is only
established for $a$ from $n=11$ on. The remaining indices $n=2,\dots,10$ were
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223914.
