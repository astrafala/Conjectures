...
\title{The empirical closed form for OEIS A224257, proved}
...
\begin{abstract}
OEIS A224257 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A224257 is ``Number of n X 3 0..2 arrays with rows, diagonals and antidiagonals unimodal and columns nondecreasing.''. It has offset $1$ and begins
\[
22, 158, 648, 2017, 5246, 11990, 24842, 47643,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (23/360)*n\^{}6 + (19/40)*n\^{}5 + (211/72)*n\^{}4 + (119/24)*n\^{}3 + (2161/180)*n\^{}2 + (77/30)*n - 1.
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 18 2025 22:33:10, revision 11) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{23 n^{6}}{360} + \frac{19 n^{5}}{40} + \frac{211 n^{4}}{72} + \frac{119 n^{3}}{24} + \frac{2161 n^{2}}{180} + \frac{77 n}{30} - 1.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224257.
