...
\title{The empirical column recurrences for the table OEIS A234233}
...
\begin{abstract}
OEIS A234233 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A234233 is ``T(n,k) is the number of (n+1) X (k+1) 0..7 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 3 (constant-stress 1 X 1 tilings).''. It has offset $1$, is
read by antidiagonals, and begins
\[
568, 5260, 5260, 48592, 57912, 48592, 449880, 635904,\ \dots
\]
The entry carries the following block:
\begin{quote}\small
Empirical for column k:\\
k=1: a(n) = 182*a(n-2) -9024*a(n-4) +66960*a(n-6).\\
k=2: [order 40].\\
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 20 2022 20:57:31, revision 6) these are still
...
The sequence is ``Number of (n+1) X (2) 0..7 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 3 (constant-stress 1 X 1 tilings).''. Its rows are the vertices of a digraph on
...
The entry gives only the order for this line: ``k=2: [order 40].''. Its model is a walk on
...
\[
(c_1,\dots,c_{40})=(35,\ 297,\ -23436,\ 87922,\ 6354341,\ -57467833,\ -868697509,\ 12179862085,\ 56717124080,\ -1376288977822,\ -389142955323,\ 91724981611836,\ -197800137133940,\ -3712235714726180,\ 14345603246285440,\ 91658915774466240,\ -507226585917587320,\ -1321387528802707232,\ 10762321399020285120,\ 8733841242134807264,\ -145846761811958300832,\ 32785662669701112192,\ 1289945293647306361152,\ -1184349201595312850304,\ -7442731504916052238080,\ 10968787647661156327680,\ 27228854162118940992000,\ -56237696679658175631360,\ -57389962891214459289600,\ 176042457898795709798400,\ 44044366814188644556800,\ -336060660197981758464000,\ 78003673835928625152000,\ 365671160950013706240000,\ -216849659254292643840000,\ -184973172583801651200000,\ 186159917779078348800000,\ 9747586176417792000000,\ -53138008274632704000000,\ 14213870526136320000000).
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234233.
