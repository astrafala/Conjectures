...
\title{The empirical recurrence for OEIS A204796, proved by transfer matrix}
...
\begin{abstract}
OEIS A204796 counts arrays of width $5$ over $\{0,1\}$ by reducing every $2\times2$ subblock to a
...
about it is one bit per adjacent pair of columns, so the count is a walk count on $S=716$
states.
\end{abstract}
...
OEIS A204796 is ``Number of (n+1)X5 0..1 arrays with rows and columns of determinants of all 2X2 subblocks lexicographically nondecreasing.''. It has offset $1$ and begins
\[
335, 4273, 42214, 422426, 4122638, 40446826, 398104735, 3932835872,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 11:31:59, revision 9) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=716.
\]
...
\begin{theorem}
\[
a(n)\;=\;23\,a(n-1) - 169\,a(n-2) + 215\,a(n-3) + 2942\,a(n-4) - 13270\,a(n-5) + 5608\,a(n-6) + 79132\,a(n-7) - 156472\,a(n-8) - 56040\,a(n-9) + 403184\,a(n-10) - 196800\,a(n-11) - 346880\,a(n-12) + 287744\,a(n-13) + 89088\,a(n-14) - 98304\,a(n-15)
\]
for every $n>23$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204796.
