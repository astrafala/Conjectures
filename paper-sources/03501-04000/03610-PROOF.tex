...
\title{The empirical closed form for OEIS A224161, proved}
...
\begin{abstract}
OEIS A224161 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A224161 is ``Number of 5Xn 0..1 arrays with diagonals and rows unimodal and antidiagonals nondecreasing.''. It has offset $1$ and begins
\[
32, 324, 900, 1783, 3469, 6786, 13283, 25624,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 23:17:25, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\begin{multline*}
f(n)\;=\;\frac{n^{10}}{3628800} - \frac{n^{9}}{241920} \\
+ \frac{13 n^{8}}{60480} - \frac{n^{7}}{2688} \\
+ \frac{15793 n^{6}}{172800} - \frac{10013 n^{5}}{11520} \\
+ \frac{3158927 n^{4}}{362880} - \frac{461413 n^{3}}{12096} \\
+ \frac{13189843 n^{2}}{50400} - \frac{797567 n}{840} \\
+ 2301.
\end{multline*}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224161.
