...
\title{Arrays counted up to renaming: the empirical recurrence for OEIS A205621}
...
\begin{abstract}
OEIS A205621 carries an empirical recurrence of order $4$ contributed by R.~H.~Hardin. It is
...
OEIS A205621 is ``Number of (n+1) X 4 0..2 arrays with every 2 X 2 subblock in a row having an equal number of equal diagonal or equal antidiagonal elements, adjacent rows differing in this number, and new values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
194, 1512, 13068, 113592, 992088, 8636544, 75419136, 656729088,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 12 2018 11:12:44, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;72\,a(n-2) + 48\,a(n-3) - 112\,a(n-4)
\]
for every $n>5$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A205621.
