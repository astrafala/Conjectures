...
\title{The empirical recurrence for OEIS A263058, proved by transfer matrix}
...
\begin{abstract}
OEIS A263058 counts arrays of width $7$ over $\{0,1\}$ whose rows, read as base-$2$
...
OEIS A263058 is ``Number of (n+1)X(6+1) 0..1 arrays with each row and column not divisible by 3, read as a binary number with top and left being the most significant bits.''. It has offset $1$ and begins
\[
42, 22921, 1941702, 232738767, 19763462754, 1825928130193, 155157177242886, 13464303796343791,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 08 2015 15:00:32, revision 4) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A263058.
