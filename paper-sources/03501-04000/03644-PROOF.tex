...
\title{The empirical recurrence for OEIS A263057, proved by transfer matrix}
...
\begin{abstract}
OEIS A263057 counts arrays of width $6$ over $\{0,1\}$ whose rows, read as base-$2$
...
OEIS A263057 is ``Number of (n+1)X(5+1) 0..1 arrays with each row and column not divisible by 3, read as a binary number with top and left being the most significant bits.''. It has offset $1$ and begins
\[
42, 4314, 188370, 10416690, 439260642, 19763462754, 830550961170, 35491321238130,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 08 2015 14:59:52, revision 4) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A263057.
