...
\title{The empirical column recurrences for the table OEIS A251228}
...
\begin{abstract}
OEIS A251228 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A251228 is ``T(n,k)=Number of (n+1)X(k+1) 0..1 arrays with no 2X2 subblock having the minimum of its diagonal elements greater than the absolute difference of its antidiagonal elements.''. It has offset $1$, is
read by antidiagonals, and begins
\[
14, 49, 49, 171, 305, 171, 597, 1892,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:11:54, revision 6) these are still
...
The sequence is ``Number of (n+1)X(2) 0..1 arrays with no 2X2 subblock having the minimum of its diagonal elements greater than the absolute difference of its antidiagonal elements.''. Its rows are the vertices of a digraph on
...
The sequence is ``Number of (n+1)X(3) 0..1 arrays with no 2X2 subblock having the minimum of its diagonal elements greater than the absolute difference of its antidiagonal elements.''. Its rows are the vertices of a digraph on
$S=8$ vertices, edges being the admissible consecutive pairs, and the count is
$\mathbf{1}^{\!\top}M^{n}\mathbf{1}$ up to the constant factor in the entry's name.
The conjectured recurrence
\[
a(n)\;=\;5\,a(n-1) + 9\,a(n-2) - 8\,a(n-3) - 8\,a(n-4) + 3\,a(n-5)
\]
...
The entry gives only the order for this line: ``k=3: [order 8]''. Its model is a walk on
...
$c_{1}$ & $8$ & $c_{3}$ & $-48$ & $c_{5}$ & $88$ & $c_{7}$ & $-199$ \\
$c_{2}$ & $39$ & $c_{4}$ & $-210$ & $c_{6}$ & $260$ & $c_{8}$ & $36$ \\
...
\begin{center}\small\begin{tabular}{cccccccc}
$c_{1}$ & $13$ & $c_{6}$ & $30575$ & $c_{11}$ & $-71217$ & $c_{16}$ & $396$ \\
$c_{2}$ & $150$ & $c_{7}$ & $-16105$ & $c_{12}$ & $11160$ & $c_{17}$ & $60$ \\
$c_{3}$ & $-269$ & $c_{8}$ & $-99760$ & $c_{13}$ & $14210$ &  &  \\
$c_{4}$ & $-3713$ & $c_{9}$ & $117265$ & $c_{14}$ & $-3935$ &  &  \\
$c_{5}$ & $1325$ & $c_{10}$ & $20076$ & $c_{15}$ & $-1079$ &  &  \\
\end{tabular}\end{center}
Repeating with the first $17+4$ terms removed gives order $17$ again.

\subsection*{Column $k=5$, recovered}
The entry gives only the order for this line: ``k=5: [order 29]''. Its model is a walk on
...
$29$ --- the stated order --- with integer coefficients
\[
(c_1,\dots,c_{29})=(21,\ 554,\ -1341,\ -56723,\ -7614,\ 2277951,\ 445571,\ -46434220,\ 32482888,\ 467723527,\ -889155765,\ -1188153000,\ 4147652079,\ -132672964,\ -8042725671,\ 4499239992,\ 7457116236,\ -6933658033,\ -3126154333,\ 4558838720,\ 384337441,\ -1441277326,\ 61108155,\ 221926922,\ -13300621,\ -18641195,\ -491525,\ 335825,\ 5625).
\]
Repeating with the first $29+4$ terms removed gives order $29$ again.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251228.
