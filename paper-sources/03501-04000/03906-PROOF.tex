...
\title{The empirical closed form for OEIS A250858, proved}
...
\begin{abstract}
OEIS A250858 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A250858 is ``Number of (6+1) X (n+1) 0..3 arrays with nondecreasing x(i,j)-x(i,j-1) in the i direction and nondecreasing min(x(i,j),x(i-1,j)) in the j direction.''. It has offset $1$ and begins
\[
233683, 1280447, 4648157, 13263136, 32201019, 69543783, 137379337, 252943672,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 198*n\^{}6 + (35807/12)*n\^{}5 + (204911/12)*n\^{}4 + (214827/4)*n\^{}3 + (998209/12)*n\^{}2 + (180451/3)*n + 16384.
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 22 2018 06:33:23, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;198 n^{6} + \frac{35807 n^{5}}{12} + \frac{204911 n^{4}}{12} + \frac{214827 n^{3}}{4} + \frac{998209 n^{2}}{12} + \frac{180451 n}{3} + 16384.
\]
...
$n=7,\dots,13$ and agree at each. A monic recurrence of order $7$
determines $a(m)$ from $a(m-1),\dots,a(m-7)$, and for every $m\ge14$ both
$m>6$ and $m-7\ge7$ hold, so induction on $m$ gives $a(m)=f(m)$ for every
$m\ge7$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250858.
