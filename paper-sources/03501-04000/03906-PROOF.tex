...
\title{The empirical column recurrences for the table OEIS A259962}
...
\begin{abstract}
OEIS A259962 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A259962 is ``T(n,k)=Number of (n+2)X(k+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000000 00000001 or 00001001.''. It has offset $1$, is
read by antidiagonals, and begins
\[
34, 67, 67, 155, 146, 155, 353, 439,\ \dots
\]
The entry carries the following block:
\begin{quote}\small
Empirical for column k:\\
k=1: a(n) = a(n-1) +3*a(n-3) +5*a(n-4) +6*a(n-5) +6*a(n-6) +2*a(n-7) for n>8\\
k=2: [order 8] for n>9\\
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:57:29, revision 6) these are still
...
The sequence is ``Number of (n+2)X(3) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000000 00000001 or 00001001.''. Its rows are the vertices of a digraph on
...
\[
a(n)\;=\;a(n-1) + 3\,a(n-3) + 5\,a(n-4) + 6\,a(n-5) + 6\,a(n-6) + 2\,a(n-7)
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A259962.
