...
\title{The empirical recurrence for OEIS A233241, proved by carrying a row major clause across
columns}
...
\begin{abstract}
OEIS A233241 counts $3\times n$ arrays over $\{0,\dots,5\}$ with a forbidden-pair
condition and a clause on the order in which values first appear, read in ROW MAJOR order, and
it carries an empirical recurrence of order $9$ contributed by R.~H.~Hardin. It is true.
...
OEIS A233241 is ``Number of 3Xn 0..5 arrays with no element x(i,j) adjacent to value 5-x(i,j) horizontally, diagonally or antidiagonally, top left element zero, and 1 appearing before 2 3 and 4, and 2 appearing before 3 in row major order.''. It has offset $1$ and begins
\[
11, 313, 18744, 1212549, 79794804, 5267525102,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 07:58:05, revision 6) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The array has $3$ rows and $n$ columns. Two cells are adjacent when they differ by one of the
offsets
\[
(0,1), (1,-1), (1,1),
\]
and the entry forbids any adjacent pair $u,v$ with $u+v=5$. It fixes the top left cell to
zero. Finally it asks that, reading the cells in ROW MAJOR order --- along the first row, then
along the second, and so on --- the first occurrences of the values $1$, $2$, $3$, $4$ come in a
prescribed order: $1$ before $2$, $1$ before $3$, $1$ before $4$, $2$ before $3$. A precedence involving a value that never occurs is satisfied
...
row, and there are $S=271$ of them after states with identical futures are merged. Hence
\[
...
\begin{theorem}
\[
a(n)\;=\;79\,a(n-1) - 844\,a(n-2) - 956\,a(n-3) + 16385\,a(n-4) - 10631\,a(n-5) - 45620\,a(n-6) + 63092\,a(n-7) - 24384\,a(n-8) + 2880\,a(n-9)
\]
for every $n>10$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A233241.
