...
\title{The empirical recurrence for OEIS A267946, proved by transfer matrix}
...
\begin{abstract}
OEIS A267946 counts arrays in which the REPEATED VALUES of each row, and of each column, stand in a
...
OEIS A267946 is ``Number of n X 1 0..2 arrays with every repeated value in every row and column one larger mod 3 than the previous repeated value, and upper left element zero.''. It has offset $1$ and begins
\[
1, 3, 8, 21, 53, 132, 323, 783,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) + a(n-2) - 6*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 21 2018 09:38:20, revision 8) this is still
...
one larger modulo 3 than the previous repeated value of that row, and that each repeated value of a column,
...
imposes nothing at all. The entry also fixes the top left entry at $0$, which restricts which slices may begin an array and nothing else.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267946.
