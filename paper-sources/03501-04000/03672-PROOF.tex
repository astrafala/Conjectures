...
\title{The empirical recurrence for OEIS A252962, proved by transfer matrix}
...
\begin{abstract}
OEIS A252962 counts arrays of width $3$ over an alphabet of $5$ letters in which every three
...
brings the state count down to $S=94$.
\end{abstract}
...
OEIS A252962 is ``Number of (1+2)X(n+2) 0..4 arrays with every consecutive three elements in every row and diagonal having exactly two distinct values, and in every column and antidiagonal not having exactly two distinct values, and new values 0 upwards introduced in row major order.''. It has offset $1$ and begins
\[
60, 119, 223, 603, 1251, 3465, 7495, 20977,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:48:35, revision 6) this is still
...
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,
\]
with $S=94$ states in all. The walk index $j$ and the entry's own $n$ differ by a constant,
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 9\,a(n-2) - 27\,a(n-4) - 55\,a(n-5) + 46\,a(n-6) + 157\,a(n-7) + 65\,a(n-8) - 168\,a(n-9) - 321\,a(n-10) + 123\,a(n-11) + 171\,a(n-12) + 198\,a(n-13) - 198\,a(n-14)
\]
for every $n>16$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252962.
