...
\title{The empirical recurrence for OEIS A252694, proved by transfer matrix}
...
\begin{abstract}
OEIS A252694 counts arrays of width $9$ over an alphabet of $4$ letters in which every three
...
OEIS A252694 is ``Number of (n+2) X (7+2) 0..3 arrays with every consecutive three elements in every row and column having exactly two distinct values, and in every diagonal and antidiagonal not having exactly two distinct values, and new values 0 upwards introduced in row major order.''. It has offset $1$ and begins
\[
3703, 6483, 727, 12740, 1276, 25382, 2592, 51060,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) - 2*a(n-2) - 7*a(n-3) + 2*a(n-4) + 6*a(n-5) + 14*a(n-6) - 20*a(n-7) - 4*a(n-8) + 8*a(n-9) for n>10.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 05 2018 08:11:12, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252694.
