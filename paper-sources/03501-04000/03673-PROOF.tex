...
\title{The conjectured generating function for OEIS A273447, proved}
...
\begin{abstract}
OEIS A273447 counts arrays of a fixed width under a local condition, and carries a conjectured
...
OEIS A273447 is ``Partial sums of the number of active (ON, black) cells in n-th stage of growth of two-dimensional cellular automaton defined by "Rule 721", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 5, 26, 67, 147, 267,\ \dots
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A273447.
