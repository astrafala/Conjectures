...
\title{The empirical recurrence for OEIS A185743, proved by transfer matrix}
...
\begin{abstract}
OEIS A185743 counts arrays over $\{0,\dots,1\}$ under a condition comparing a statistic of
every $2\times2$ subblock with those of its neighbours, and carries an empirical recurrence
of order $11$ contributed by R.~H.~Hardin. It is true, and it is decidable rather than
...
OEIS A185743 is ``Number of (n+1)X3 binary arrays with every 2X2 subblock trace equal to some horizontal or vertical neighbor 2X2 subblock trace.''. It has offset $1$ and begins
\[
24, 104, 544, 2568, 12656, 62112, 304584, 1494072,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n)=5*a(n-1)-4*a(n-2)+17*a(n-3)+2*a(n-4)-2*a(n-5)+18*a(n-7)-4*a(n-8)-30*a(n-9)-8*a(n-10)-24*a(n-11)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 03:08:58, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) - 4\,a(n-2) + 17\,a(n-3) + 2\,a(n-4) - 2\,a(n-5) + 18\,a(n-7) - 4\,a(n-8) - 30\,a(n-9) - 8\,a(n-10) - 24\,a(n-11)
\]
for every $n>11$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A185743.
