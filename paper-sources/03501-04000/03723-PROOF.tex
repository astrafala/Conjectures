...
\title{The empirical recurrence for OEIS A208172, proved by counting patterns}
...
\begin{abstract}
OEIS A208172 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A208172 is ``Number of nX5 0..3 arrays with new values 0..3 introduced in row major order and no element equal to more than one of its immediate leftward or upward neighbors.''. It has offset $1$ and begins
\[
51, 33831, 26625693, 21002874867, 16567902881244, 13069424064243420, 10309684155118737894, 8132690993759302714128,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:42:00, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;846\,a(n-1) - 46537\,a(n-2) + 1162868\,a(n-3) - 17173907\,a(n-4) + 166807056\,a(n-5) - 1125592122\,a(n-6) + 5444000730\,a(n-7) - 19238506974\,a(n-8) + 50296239144\,a(n-9) - 97844056164\,a(n-10) + 140881555908\,a(n-11) - 146587250745\,a(n-12) + 104533491168\,a(n-13) - 46130948685\,a(n-14) + 10416243600\,a(n-15) - 863591625\,a(n-16)
\end{equation}
for all $n>17$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208172.
