...
\title{The empirical closed form for OEIS A223837, proved}
...
\begin{abstract}
OEIS A223837 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
$S=475136$ vertices. Any function of the form $\sum_j p_j(n)\lambda_j^{\,n}$ satisfies the
...
OEIS A223837 is ``Number of n X 7 0..1 arrays with rows, diagonals and antidiagonals unimodal and columns nondecreasing.''. It has offset $1$ and begins
\[
29, 239, 926, 2578, 6159, 13582, 28369, 56607,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (4/315)*n\^{}7 - (1/45)*n\^{}6 + (28/45)*n\^{}5 + (113/72)*n\^{}4 + (2137/180)*n\^{}3 + (14023/360)*n\^{}2 + (13159/140)*n - 339 for n>4.
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 18 2025 17:06:05, revision 10) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{4 n^{7}}{315} - \frac{n^{6}}{45} + \frac{28 n^{5}}{45} + \frac{113 n^{4}}{72} + \frac{2137 n^{3}}{180} + \frac{14023 n^{2}}{360} + \frac{13159 n}{140} - 339.
\]
...
walk, so with $M$ the adjacency matrix of that digraph on $S=475136$ vertices, and $u,w$ the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223837.
