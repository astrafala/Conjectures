...
\title{The empirical closed form for OEIS A224043, proved}
...
\begin{abstract}
OEIS A224043 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A224043 is ``Number of 7 X n 0..1 arrays with antidiagonals unimodal and rows and diagonals nondecreasing.''. It has offset $1$ and begins
\[
128, 987, 2419, 4160, 6321, 9125, 12856, 17875,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (1/5040)*n\^{}7 + (17/360)*n\^{}5 + (13/24)*n\^{}4 + (5767/720)*n\^{}3 + (1919/24)*n\^{}2 + (37901/70)*n + 143 for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 26 2018 17:00:20, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{n^{7}}{5040} + \frac{17 n^{5}}{360} + \frac{13 n^{4}}{24} + \frac{5767 n^{3}}{720} + \frac{1919 n^{2}}{24} + \frac{37901 n}{70} + 143.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224043.
