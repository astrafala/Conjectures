...
\title{The empirical closed form for OEIS A201374, proved}
...
\begin{abstract}
OEIS A201374 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
$S=2804$ vertices. Any function of the form $\sum_j p_j(n)\lambda_j^{\,n}$ satisfies the
...
OEIS A201374 is ``Number of nX7 0..1 arrays with rows and columns lexicographically nondecreasing read forwards, and nonincreasing read backwards.''. It has offset $1$ and begins
\[
2, 8, 44, 280, 2016, 15574, 115168, 728078,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 09:05:44, revision 9) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\begin{multline*}
f(n)\;=\;\frac{n^{14}}{64864800} + \frac{n^{13}}{831600} \\
+ \frac{1643 n^{12}}{59875200} - \frac{247 n^{11}}{1995840} \\
- \frac{5611 n^{10}}{1360800} + \frac{61807 n^{9}}{1814400} \\
+ \frac{11951 n^{8}}{604800} - \frac{31427 n^{7}}{30240} \\
+ \frac{10739983 n^{6}}{2721600} - \frac{9433741 n^{5}}{1814400} \\
+ \frac{252826879 n^{4}}{29937600} - \frac{52757143 n^{3}}{997920} \\
+ \frac{1595598461 n^{2}}{10810800} - \frac{462725 n}{2772} \\
+ 68.
\end{multline*}
...
walk, so with $M$ the adjacency matrix of that digraph on $S=2804$ vertices, and $u,w$ the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A201374.
