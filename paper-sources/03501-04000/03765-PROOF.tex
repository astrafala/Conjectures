...
\title{The conjectured generating function for OEIS A283650, proved}
...
\begin{abstract}
OEIS A283650 counts arrays of a fixed width under a local condition, and carries a conjectured
