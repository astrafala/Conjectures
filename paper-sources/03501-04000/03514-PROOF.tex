...
\title{The empirical recurrence for OEIS A204078, proved by transfer matrix}
...
\begin{abstract}
OEIS A204078 counts arrays of width $2$ over $\{0,1,2,3\}$ in which every cell has neighbours equal to each of two named values. The entry carries an
...
OEIS A204078 is ``Number of nX2 0..3 arrays with every element neighboring horizontally or vertically both a 0 and a 1.''. It has offset $1$ and begins
\[
0, 4, 4, 16, 100, 324, 1296, 5476,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) +4*a(n-2) +17*a(n-3) -2*a(n-4) -4*a(n-5) -16*a(n-6)
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 06 2018 06:01:56, revision 14) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204078.
