...
\title{The conjectured generating function for OEIS A284182, proved}
...
\begin{abstract}
OEIS A284182 counts arrays of a fixed width under a local condition, and carries a conjectured
...
\begin{quote}
G.f.: (1 - x + 3*x\^{}2 - 5*x\^{}3 + 18*x\^{}4 + 4*x\^{}5 - 8*x\^{}6 - 16*x\^{}7 - 64*x\^{}8 - 256*x\^{}9 + 1024*x\^{}10 + 512*x\^{}13 - 1024*x\^{}14) / ((1 - x)*(1 + x)*(1 - 2*x)*(1 + x\^{}2)).
\end{quote}
