...
\title{The conjectured generating function for OEIS A282917, proved}
...
\begin{abstract}
OEIS A282917 counts arrays of a fixed width under a local condition, and carries a conjectured
...
OEIS A282917 is ``Decimal representation of the x-axis, from the left edge to the origin, of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 529", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 0, 1, 0, 7, 1,\ \dots
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A282917.
