...
\title{The empirical recurrence for OEIS A268420, proved by transfer matrix}
...
\begin{abstract}
OEIS A268420 counts arrays in which the REPEATED VALUES of each row, and of each column, stand in a
...
OEIS A268420 is ``Number of nX2 0..3 arrays with every repeated value in every row unequal to the previous repeated value, and in every column equal to the previous repeated value, and new values introduced in row-major sequential order.''. It has offset $1$ and begins
\[
2, 15, 187, 2530, 34195, 448667, 5720450, 71224847,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 04 2016 09:51:17, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;33\,a(n-1) - 389\,a(n-2) + 1865\,a(n-3) - 2461\,a(n-4) - 3639\,a(n-5) + 7361\,a(n-6) + 2407\,a(n-7) - 5491\,a(n-8) - 585\,a(n-9) + 981\,a(n-10) - 81\,a(n-11)
\]
for every $n>11$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268420.
