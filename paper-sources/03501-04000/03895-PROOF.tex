...
\title{The empirical recurrence for OEIS A198718, proved by counting patterns}
...
\begin{abstract}
OEIS A198718 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A198718 is ``Number of nX3 0..6 arrays with values 0..6 introduced in row major order and no element equal to any horizontal or vertical neighbor.''. It has offset $1$ and begins
\[
2, 34, 2027, 232841, 34003792, 5315840795, 846047363854, 135284283124811,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 08:00:48, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;234\,a(n-1) - 13497\,a(n-2) + 283640\,a(n-3) - 2626919\,a(n-4) + 12277210\,a(n-5) - 30282843\,a(n-6) + 38629620\,a(n-7) - 23115780\,a(n-8) + 4848336\,a(n-9)
\end{equation}
for all $n>9$.
...
\[
7!\Bigl(a(n)-\sum_i c_i\,a(n-i)\Bigr)\;=\;\mathbf{v}^{\!\top}N^{\,m-9}q(N)\mathbf{1} .
\]
...
\eqref{eq:walk}, divided by $7!$, was evaluated at every one of the $13$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A198718.
