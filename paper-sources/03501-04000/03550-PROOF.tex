...
\title{The empirical recurrence for OEIS A235566, proved by transfer matrix}
...
\begin{abstract}
OEIS A235566 counts arrays of width $2$ over $\{0,1\}$ by reducing every $2\times2$ subblock to a
...
about it is one bit per adjacent pair of columns, so the count is a walk count on $S=13$
states.
\end{abstract}
...
OEIS A235566 is ``Number of (n+1) X (1+1) 0..1 arrays with the difference of the upper and lower median value of each 2 X 2 subblock in lexicographically nondecreasing order rowwise and columnwise.''. It has offset $1$ and begins
\[
16, 50, 144, 398, 1076, 2866, 7560, 19798,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) - a(n-2) - 10*a(n-3) + 8*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 19 2018 10:46:05, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) - a(n-2) - 10\,a(n-3) + 8\,a(n-4)
\]
for every $n>3$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A235566.
