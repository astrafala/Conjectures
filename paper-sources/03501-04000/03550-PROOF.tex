...
\title{The empirical closed form for OEIS A224148, proved}
...
\begin{abstract}
OEIS A224148 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A224148 is ``Number of 4 X n 0..1 arrays with rows and antidiagonals unimodal and columns nondecreasing.''. It has offset $1$ and begins
\[
5, 25, 92, 272, 691, 1573, 3296, 6472,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 28 2018 07:09:01, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{n^{8}}{40320} + \frac{n^{7}}{3360} + \frac{n^{6}}{192} + \frac{n^{5}}{16} + \frac{223 n^{4}}{640} + \frac{149 n^{3}}{160} + \frac{3319 n^{2}}{2016} + \frac{169 n}{168} + 1.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224148.
