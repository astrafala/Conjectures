...
\title{The empirical recurrence for OEIS A222942, proved by transfer matrix}
...
\begin{abstract}
OEIS A222942 counts arrays in which no entry may equal the entries at a short list of fixed offsets
...
$2$ consecutive rows, $S=35329$ states in all.
\end{abstract}
...
OEIS A222942 is ``Number of n X 4 0..4 arrays with no element equal to another at a city block distance of exactly two, and new values 0..4 introduced in row major order.''. It has offset $1$ and begins
\[
7, 273, 5880, 130680, 2883000, 63772920, 1409319480, 31155452280,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 17*a(n-1) + 136*a(n-2)  -512*a(n-3) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 16 2018 15:40:03, revision 7) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=35329.
\]
...
\begin{theorem}
\[
a(n)\;=\;17\,a(n-1) + 136\,a(n-2) - 512\,a(n-3)
\]
for every $n>5$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A222942.
