...
\title{The empirical recurrence for OEIS A208790, proved by transfer matrix}
...
\begin{abstract}
OEIS A208790 counts arrays of width $2$ over $\{0,1,2\}$ in which no cell is the average of its neighbours. The entry carries an
...
$2$ consecutive rows and the count is a walk count on $S=10$ states.
\end{abstract}
...
OEIS A208790 is ``Number of n X 2 0..2 arrays with no element equal the average of immediate neighbors vertically above, diagonally above and left, and horizontally left of it.''. It has offset $1$ and begins
\[
6, 30, 160, 852, 4540, 24192, 128904, 686872,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + 16*a(n-2) + 10*a(n-3) - 4*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 06 2018 17:11:50, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 16\,a(n-2) + 10\,a(n-3) - 4\,a(n-4)
\]
for every $n>4$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208790.
