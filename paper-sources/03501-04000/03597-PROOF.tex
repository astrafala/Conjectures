...
\title{The empirical recurrence for OEIS A199650, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A199650 counts arrays in which every cell is constrained by its neighbours on \emph{both}
...
OEIS A199650 is ``Number of nX3 0..2 arrays with values 0..2 introduced in row major order and each element equal to no more than two horizontal and vertical neighbors.''. It has offset $1$ and begins
\[
5, 113, 2584, 59212, 1357484, 31120632, 713445976, 16355879648,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 21*a(n-1) +44*a(n-2) +8*a(n-3) -96*a(n-4) -364*a(n-5) -264*a(n-6) +256*a(n-7) +288*a(n-8) +64*a(n-9) for n>10
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 08:17:19, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;21\,a(n-1) + 44\,a(n-2) + 8\,a(n-3) - 96\,a(n-4) - 364\,a(n-5) - 264\,a(n-6) + 256\,a(n-7) + 288\,a(n-8) + 64\,a(n-9)
\end{equation}
for all $n>10$.
...
index,
\[
3!\Bigl(a(n)-\sum_i c_i\,a(n-i)\Bigr)\;=\;\mathbf{v}^{\!\top}G^{\,j-9}\,
...
\eqref{eq:walk2}, divided by $3!$, was evaluated at every one of the $16$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A199650.
