...
\title{The conjectured generating function for OEIS A225007, proved}
...
\begin{abstract}
OEIS A225007 counts arrays of a fixed width under a local condition, and carries a conjectured
...
OEIS A225007 is ``Number of n X 5 0..1 arrays with rows unimodal and columns nondecreasing.''. It has offset $0$ and begins
\[
1, 16, 86, 296, 791, 1792,\ \dots
\]
The entry states, as a conjecture contributed by a reader and never marked settled:
\begin{quote}
G.f.: (1 + 10*x + 5*x\^{}2) / (1 - x)\^{}6. (End)
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 22 2024 20:31:34, revision 41) this is still
...
\begin{proof}
Write the conjecture as $N_2/D_2$ with $\deg N_2=2$ and $\deg D_2=6$; its expansion as a
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A225007.
