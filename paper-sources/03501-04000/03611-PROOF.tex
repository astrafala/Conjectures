...
\title{The empirical recurrence for OEIS A205468, proved by transfer matrix}
...
\begin{abstract}
OEIS A205468 counts, up to renaming the letters, the arrays of width $2$ over at most $3$
...
OEIS A205468 is ``Number of (n+1) X 2 0..2 arrays with every 2 X 2 subblock having the same number of equal edges, and new values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
14, 48, 175, 677, 2709, 11143, 46709, 198483,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 9*a(n-1) - 21*a(n-2) - 11*a(n-3) + 66*a(n-4) - 6*a(n-5) - 36*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 04 2018 06:05:06, revision 9) this is still
...
$w_i$ cleared of denominators and $S=36$ states in all. The walk index $j$ and the entry's own
...
\begin{theorem}
\[
a(n)\;=\;9\,a(n-1) - 21\,a(n-2) - 11\,a(n-3) + 66\,a(n-4) - 6\,a(n-5) - 36\,a(n-6)
\]
for every $n>5$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A205468.
