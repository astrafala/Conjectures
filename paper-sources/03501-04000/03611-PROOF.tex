...
\title{The empirical closed form for OEIS A223767, proved}
...
\begin{abstract}
OEIS A223767 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A223767 is ``Number of nX5 0..1 arrays with rows, columns and antidiagonals unimodal and diagonals nondecreasing.''. It has offset $1$ and begins
\[
16, 101, 317, 782, 1748, 3699, 7564, 14980,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 22:23:16, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\begin{multline*}
f(n)\;=\;\frac{n^{10}}{3628800} - \frac{n^{9}}{241920} \\
+ \frac{23 n^{8}}{120960} - \frac{43 n^{7}}{40320} \\
+ \frac{11293 n^{6}}{172800} - \frac{1721 n^{5}}{2304} \\
+ \frac{1557823 n^{4}}{181440} - \frac{3058823 n^{3}}{60480} \\
+ \frac{99347 n^{2}}{350} - \frac{196177 n}{210} \\
+ 1664.
\end{multline*}
...
$n=18,\dots,28$ and agree at each. A monic recurrence of order $11$
determines $a(m)$ from $a(m-1),\dots,a(m-11)$, and for every $m\ge29$ both
$m>17$ and $m-11\ge18$ hold, so induction on $m$ gives $a(m)=f(m)$ for every
$m\ge18$.
Below $n=18$ the recurrence argument gives nothing, since \eqref{eq:rec} is only
established for $a$ from $n=18$ on. The remaining indices $n=7,\dots,17$ were
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223767.
