...
\title{The empirical recurrence for OEIS A184690, proved by transfer matrix}
...
\begin{abstract}
OEIS A184690 counts arrays of width $5$ over $\{0,1,2\}$ in which no cell equals both the cell above it and the cell to its left. The entry carries an
...
OEIS A184690 is ``1/3 the number of nX5 0..2 arrays with no element equal both to the element above and to the element to its left.''. It has offset $1$ and begins
\[
81, 12288, 1841856, 275895264, 41325395328, 6189975781728, 927173138866560, 138877768818516672,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 02:50:46, revision 11) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A184690.
