...
\title{The empirical closed form for OEIS A188841, proved}
...
\begin{abstract}
OEIS A188841 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A188841 is ``Number of n X 7 binary arrays without the pattern 0 1 diagonally or vertically.''. It has offset $1$ and begins
\[
128, 987, 3280, 7753, 15504, 28101, 47652, 76912,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (1/5040)*n\^{}7 + (1/72)*n\^{}6 + (143/360)*n\^{}5 + (53/9)*n\^{}4 + (33667/720)*n\^{}3 + (12679/72)*n\^{}2 + (9439/70)*n - 572 for n>4.
\end{quote}
As of the ``Last modified'' line on the live entry (May 01 2018 05:36:11, revision 9) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{n^{7}}{5040} + \frac{n^{6}}{72} + \frac{143 n^{5}}{360} + \frac{53 n^{4}}{9} + \frac{33667 n^{3}}{720} + \frac{12679 n^{2}}{72} + \frac{9439 n}{70} - 572.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A188841.
