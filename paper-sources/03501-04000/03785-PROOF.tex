...
\title{The empirical recurrence for OEIS A280065, proved by transfer matrix}
...
\begin{abstract}
OEIS A280065 counts $n\times4$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A280065 is ``Number of nX4 0..1 arrays with no element unequal to a strict majority of its horizontal, vertical and antidiagonal neighbors and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
2, 4, 15, 52, 170, 603, 2157, 7777,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 25 2016 06:38:25, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + 4\,a(n-2) - 21\,a(n-3) - 4\,a(n-4) + 34\,a(n-5) + 25\,a(n-6) - 37\,a(n-7) - 82\,a(n-8) + 44\,a(n-9) + 36\,a(n-10) + 6\,a(n-11) - a(n-12) - 5\,a(n-13) - 3\,a(n-14) + a(n-15)
\]
for every $n>18$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A280065.
