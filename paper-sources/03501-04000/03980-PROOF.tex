...
\title{The empirical recurrence for OEIS A268906, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A268906 counts arrays over $\{0,\dots,2\}$ subject to a condition on the array as a
...
OEIS A268906 is ``Number of 3 X n 0..2 arrays with some element plus some horizontally or antidiagonally adjacent neighbor totalling two exactly once.''. It has offset $1$ and begins
\[
0, 240, 1584, 9720, 54936, 299088, 1585800, 8244288,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 10*a(n-1) - 29*a(n-2) + 20*a(n-3) - 4*a(n-4) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 16 2019 15:53:47, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268906.
