...
\title{The empirical closed form for OEIS A224375, proved}
...
\begin{abstract}
OEIS A224375 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
$S=216$ vertices. Any function of the form $\sum_j p_j(n)\lambda_j^{\,n}$ satisfies the
...
OEIS A224375 is ``Number of 3Xn 0..2 arrays with rows unimodal and antidiagonals nondecreasing.''. It has offset $1$ and begins
\[
27, 324, 1838, 7608, 26314, 80819, 227112, 593400,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 23:24:51, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\begin{multline*}
f(n)\;=\;\frac{n^{12}}{19160064} + \frac{n^{11}}{456192} \\
+ \frac{2287 n^{10}}{43545600} + \frac{215 n^{9}}{290304} \\
+ \frac{20603 n^{8}}{2903040} + \frac{923 n^{7}}{17920} \\
+ \frac{14627101 n^{6}}{43545600} + \frac{400091 n^{5}}{207360} \\
+ \frac{16965289 n^{4}}{2177280} + \frac{3069023 n^{3}}{362880} \\
+ \frac{13912639 n^{2}}{1663200} + \frac{21001 n}{3465} \\
- 6.
\end{multline*}
...
walk, so with $M$ the adjacency matrix of that digraph on $S=216$ vertices, and $u,w$ the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224375.
