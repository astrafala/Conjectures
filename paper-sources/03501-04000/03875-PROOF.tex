...
\title{The conjectured generating function for OEIS A250772, proved}
...
\begin{abstract}
OEIS A250772 counts arrays of a fixed width under a local condition, and carries a conjectured
...
coefficients of their expansions do. Comparing $42$ coefficients in exact arithmetic
...
OEIS A250772 is ``Number of (4+1) X (n+1) 0..1 arrays with nondecreasing x(i,j)-x(i,j-1) in the i direction and nondecreasing absolute value of x(i,j)-x(i-1,j) in the j direction.''. It has offset $1$ and begins
\[
72, 130, 216, 350, 572, 962,\ \dots
\]
The entry states, as a conjecture contributed by a reader and never marked settled:
\begin{quote}
Empirical g.f.: 2*x*(36 - 115*x + 107*x\^{}2 - 32*x\^{}3) / ((1 - x)\^{}3*(1 - 2*x)). - \_Colin Barker\_, Nov 19 2018
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 19 2018 07:19:00, revision 8) this is still
...
exact integer arithmetic, those of $N_2/D_2$ by exact rational long division, and $42$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250772.
