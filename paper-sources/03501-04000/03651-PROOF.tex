...
\title{The empirical column recurrences for the table OEIS A251351}
...
\begin{abstract}
OEIS A251351 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A251351 is ``T(n,k)=Number of (n+1)X(k+1) 0..2 arrays with every 2X2 subblock summing to 3 4 or 5.''. It has offset $1$, is
read by antidiagonals, and begins
\[
51, 309, 309, 1899, 3921, 1899, 11709, 50831,\ \dots
\]
The entry carries the following block:
\begin{quote}\small
Empirical for column k:\\
k=1: a(n) = 6*a(n-1) +3*a(n-2) -12*a(n-3)\\
k=2: [order 7]\\
k=3: [order 21]\\
k=4: [order 60]\\
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 10:23:27, revision 6) these are still
...
The sequence is ``Number of (n+1)X(2) 0..2 arrays with every 2X2 subblock summing to 3 4 or 5.''. Its rows are the vertices of a digraph on
...
$c_{1}$ & $16$ & $c_{3}$ & $-173$ & $c_{5}$ & $-61$ & $c_{7}$ & $48$ \\
$c_{2}$ & $-27$ & $c_{4}$ & $362$ & $c_{6}$ & $-144$ &  &  \\
\end{tabular}\end{center}
Repeating with the first $7+4$ terms removed gives order $7$ again.

\subsection*{Column $k=3$, recovered}
The entry gives only the order for this line: ``k=3: [order 21]''. Its model is a walk on
...
\begin{center}\small\begin{tabular}{cccccccc}
$c_{1}$ & $39$ & $c_{7}$ & $446832$ & $c_{13}$ & $-28063985$ & $c_{19}$ & $318720$ \\
$c_{2}$ & $-230$ & $c_{8}$ & $5371663$ & $c_{14}$ & $-14001799$ & $c_{20}$ & $-4480$ \\
$c_{3}$ & $-3185$ & $c_{9}$ & $-6391130$ & $c_{15}$ & $16500897$ & $c_{21}$ & $-4608$ \\
$c_{4}$ & $26461$ & $c_{10}$ & $-15263203$ & $c_{16}$ & $4013131$ &  &  \\
$c_{5}$ & $58000$ & $c_{11}$ & $20886926$ & $c_{17}$ & $-3984174$ &  &  \\
$c_{6}$ & $-743602$ & $c_{12}$ & $20718664$ & $c_{18}$ & $-318712$ &  &  \\
\end{tabular}\end{center}
Repeating with the first $21+4$ terms removed gives order $21$ again.

\subsection*{Column $k=4$, recovered}
The entry gives only the order for this line: ``k=4: [order 60]''. Its model is a walk on
...
$60$ --- the stated order --- with integer coefficients
\[
(c_1,\dots,c_{60})=(114,\ -3736,\ 10309,\ 1541974,\ -21668945,\ -130798525,\ 4250013885,\ -10584217483,\ -290099476132,\ 1676479096177,\ 9070017412782,\ -85698058199107,\ -113454531436992,\ 2387253217731570,\ -1007925751667991,\ -41326282472832336,\ 59991498383146496,\ 468775436294232225,\ -1045134580270539760,\ -3546793895262289288,\ 10638815228094880546,\ 17663505897946792061,\ -71532864737224651816,\ -53607662369679072293,\ 332687747659453821743,\ 64948254189598136430,\ -1092737305153041046413,\ 193704615084993432657,\ 2555529214411365139674,\ -1155151329915707349024,\ -4251561494071989583663,\ 2890101987419181989691,\ 4976886982569376978578,\ -4497110141761126817828,\ -3983022366412924843977,\ 4722085541717364879158,\ 2021791782496345098891,\ -3425203116416679118808,\ -487888951588705496190,\ 1714295030945509788328,\ -91974574482056409350,\ -580222921936235036069,\ 117187236925115869920,\ 127109717596886929588,\ -42286604106995109767,\ -16517705303029562595,\ 8087792824172031648,\ 1023479516954833532,\ -868763113462849146,\ 317278555256850,\ 52048671890410656,\ -3488318478656508,\ -1676391379024280,\ 172211157824256,\ 26710462905984,\ -3212478014464,\ -169598924800,\ 21219655680,\ 224952320,\ -30670848).
\]
Repeating with the first $60+4$ terms removed gives order $60$ again.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251351.
