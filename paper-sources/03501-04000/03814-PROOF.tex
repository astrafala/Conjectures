...
\title{The empirical recurrence for OEIS A268763, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A268763 counts arrays over $\{0,\dots,1\}$ subject to a condition on the array as a
...
OEIS A268763 is ``Number of nX5 binary arrays with some element plus some horizontally, vertically, diagonally or antidiagonally adjacent neighbor totalling two exactly once.''. It has offset $1$ and begins
\[
10, 105, 762, 5170, 32056, 193573, 1129042, 6475898,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 13 2016 07:35:58, revision 4) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268763.
