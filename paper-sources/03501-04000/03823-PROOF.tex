...
\title{The conjectured generating function for OEIS A250741, proved}
...
\begin{abstract}
OEIS A250741 counts arrays of a fixed width under a local condition, and carries a conjectured
...
OEIS A250741 is ``Number of (n+1) X (7+1) 0..1 arrays with nondecreasing x(i,j)-x(i,j-1) in the i direction and nonincreasing x(i,j)-x(i-1,j) in the j direction.''. It has offset $1$ and begins
\[
258, 262, 270, 286, 318, 382,\ \dots
\]
The entry states, as a conjecture contributed by a reader and never marked settled:
\begin{quote}
Empirical g.f.: 2*x*(129 - 256*x) / ((1 - x)*(1 - 2*x)). - \_Colin Barker\_, Nov 17 2018
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 19 2025 08:42:34, revision 11) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250741.
