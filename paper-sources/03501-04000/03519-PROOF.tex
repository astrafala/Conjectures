...
\title{The empirical closed form for OEIS A223928, proved}
...
\begin{abstract}
OEIS A223928 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
$S=1408$ vertices. Any function of the form $\sum_j p_j(n)\lambda_j^{\,n}$ satisfies the
...
OEIS A223928 is ``Number of n X 3 0..2 arrays with rows, columns and antidiagonals unimodal and diagonals nondecreasing.''. It has offset $1$ and begins
\[
22, 218, 1116, 4498, 15791, 49646, 142177, 375777,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 17 2022 23:09:17, revision 6) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{n^{12}}{19160064} + \frac{n^{11}}{1064448} + \frac{1387 n^{10}}{43545600} + \frac{577 n^{9}}{1451520} + \frac{2717 n^{8}}{414720} + \frac{10553 n^{7}}{483840} + \frac{13338121 n^{6}}{43545600} + \frac{19135 n^{5}}{32256} + \frac{9514387 n^{4}}{2177280} + \frac{1557389 n^{3}}{362880} + \frac{1225691 n^{2}}{118800} + \frac{1887533 n}{27720} - 124.
\]
...
walk, so with $M$ the adjacency matrix of that digraph on $S=1408$ vertices, and $u,w$ the
...
$n=17,\dots,29$ and agree at each. A monic recurrence of order $13$
determines $a(m)$ from $a(m-1),\dots,a(m-13)$, and for every $m\ge30$ both
$m>16$ and $m-13\ge17$ hold, so induction on $m$ gives $a(m)=f(m)$ for every
$m\ge17$.
Below $n=17$ the recurrence argument gives nothing, since \eqref{eq:rec} is only
established for $a$ from $n=17$ on. The remaining indices $n=4,\dots,16$ were
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223928.
