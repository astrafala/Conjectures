...
\title{The empirical recurrence for OEIS A263691, proved by transfer matrix}
...
\begin{abstract}
OEIS A263691 carries an empirical recurrence of order $4$ contributed by R.~H.~Hardin. It is
...
OEIS A263691 is ``Number of length n arrays of permutations of 0..n-1 with each element moved by -2 to 2 places and every three consecutive elements having its maximum within 3 of its minimum.''. It has offset $1$ and begins
\[
1, 2, 6, 14, 14, 16, 22, 36,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + a(n-2) - a(n-3) + a(n-4) for n>12.
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 02 2019 23:12:07, revision 11) this is still
...
admissible array is then exactly a walk, so with $M$ the adjacency matrix on $S=24$ vertices
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A263691.
