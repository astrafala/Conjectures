...
\title{The empirical recurrence for OEIS A235730, proved by transfer matrix}
...
\begin{abstract}
OEIS A235730 counts arrays of width $3$ over $\{0,1\}$ by reducing every $2\times2$ subblock to a
...
about it is one bit per adjacent pair of columns, so the count is a walk count on $S=34$
states.
\end{abstract}
...
OEIS A235730 is ``Number of (n+1)X(2+1) 0..1 arrays with the sum of each 2X2 subblock maximum and minimum lexicographically nondecreasing columnwise and nonincreasing rowwise.''. It has offset $1$ and begins
\[
58, 380, 2481, 15963, 102683, 659235, 4232565, 27168327,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 08:44:32, revision 6) this is still
...
f(B)\;=\;v_4+v_1,
\]
the largest entry plus the smallest. An array with $R$ rows and $3$ columns has $(R-1)\times2$ subblocks, and they
...
\begin{theorem}
\[
a(n)\;=\;9\,a(n-1) - 11\,a(n-2) - 56\,a(n-3) + 133\,a(n-4) + 13\,a(n-5) - 220\,a(n-6) + 73\,a(n-7) + 147\,a(n-8) - 64\,a(n-9) - 45\,a(n-10) + 19\,a(n-11) + 5\,a(n-12) - 2\,a(n-13)
\]
for every $n>11$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A235730.
