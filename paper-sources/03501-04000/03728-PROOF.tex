...
\title{The empirical closed form for OEIS A201619, proved}
...
\begin{abstract}
OEIS A201619 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
$S=51$ vertices. Any function of the form $\sum_j p_j(n)\lambda_j^{\,n}$ satisfies the
...
OEIS A201619 is ``Number of nX2 0..3 arrays with rows and columns lexicographically nondecreasing and every element equal to at least one horizontal or vertical neighbor.''. It has offset $1$ and begins
\[
4, 16, 56, 211, 718, 2271, 6654, 18191,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 09:12:53, revision 9) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\begin{multline*}
f(n)\;=\;\frac{n^{15}}{1307674368000} - \frac{n^{14}}{21794572800} \\
+ \frac{29 n^{13}}{9340531200} - \frac{19 n^{12}}{159667200} \\
+ \frac{4553 n^{11}}{1026432000} - \frac{5303 n^{10}}{43545600} \\
+ \frac{2614 n^{9}}{893025} - \frac{17060387 n^{8}}{304819200} \\
+ \frac{1165550053 n^{7}}{1306368000} - \frac{165570521 n^{6}}{14515200} \\
+ \frac{11927742139 n^{5}}{102643200} - \frac{109390684973 n^{4}}{119750400} \\
+ \frac{12109762378249 n^{3}}{2270268000} - \frac{3278349949289 n^{2}}{151351200} \\
+ \frac{6533366639 n}{120120} - 63345.
\end{multline*}
...
walk, so with $M$ the adjacency matrix of that digraph on $S=51$ vertices, and $u,w$ the
...
$n=25,\dots,40$ and agree at each. A monic recurrence of order $16$
determines $a(m)$ from $a(m-1),\dots,a(m-16)$, and for every $m\ge41$ both
$m>24$ and $m-16\ge25$ hold, so induction on $m$ gives $a(m)=f(m)$ for every
$m\ge25$.
Below $n=25$ the recurrence argument gives nothing, since \eqref{eq:rec} is only
established for $a$ from $n=25$ on. The remaining indices $n=9,\dots,24$ were
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A201619.
