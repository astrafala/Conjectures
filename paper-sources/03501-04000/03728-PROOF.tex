...
\title{The empirical recurrence for OEIS A211584, proved by transfer matrix}
...
\begin{abstract}
OEIS A211584 carries an empirical recurrence of order $9$ contributed by R. H. Hardin. It is
...
OEIS A211584 is ``Number of -2..2 arrays x(i) of n+1 elements i=1..n+1 with set{t,u,v in 0,1}((x[i+t]+x[j+u]+x[k+v])*(-1)\^{}(t+u+v)) having four, five, six or seven distinct values for every i,j,k<=n.''. It has offset $1$ and begins
\[
16, 48, 128, 302, 704, 1622, 3696, 8626,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) + 10*a(n-2) - 35*a(n-3) - 25*a(n-4) + 130*a(n-5) - 180*a(n-7) + 36*a(n-8) + 72*a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 19 2018 15:29:07, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + 10\,a(n-2) - 35\,a(n-3) - 25\,a(n-4) + 130\,a(n-5) - 180\,a(n-7) + 36\,a(n-8) + 72\,a(n-9)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A211584.
