...
\title{The empirical recurrence for OEIS A268994, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A268994 counts arrays over $\{0,\dots,1\}$ subject to a condition on the array as a
...
OEIS A268994 is ``Number of nX7 binary arrays with some element plus some horizontally or antidiagonally adjacent neighbor totalling two not more than once.''. It has offset $1$ and begins
\[
72, 2037, 57287, 1506570, 38241770, 946498448, 22995344760, 550731432312,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 17 2016 07:26:06, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;68\,a(n-1) - 1804\,a(n-2) + 24560\,a(n-3) - 195400\,a(n-4) + 974752\,a(n-5) - 3171360\,a(n-6) + 6871936\,a(n-7) - 9999248\,a(n-8) + 9740096\,a(n-9) - 6250176\,a(n-10) + 2552576\,a(n-11) - 621824\,a(n-12) + 79872\,a(n-13) - 4096\,a(n-14)
\end{equation}
for all $n>16$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268994.
