...
\title{The empirical closed form for OEIS A229443, proved}
...
\begin{abstract}
OEIS A229443 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
$S=310$ vertices. Any function of the form $\sum_j p_j(n)\lambda_j^{\,n}$ satisfies the
...
OEIS A229443 is ``Number of nX6 0..2 arrays with horizontal differences mod 3 never 1, vertical differences mod 3 never -1, and rows and columns lexicographically nondecreasing.''. It has offset $1$ and begins
\[
8, 25, 93, 387, 1609, 6374, 23610, 81177,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 04 2025 00:14:24, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\begin{multline*}
f(n)\;=\;\frac{73 n^{12}}{159667200} - \frac{19 n^{11}}{26611200} \\
+ \frac{19 n^{10}}{2903040} + \frac{47 n^{9}}{161280} \\
- \frac{1259 n^{8}}{1612800} + \frac{7711 n^{7}}{806400} \\
- \frac{10715 n^{6}}{580608} + \frac{30575 n^{5}}{96768} \\
- \frac{4597853 n^{4}}{3628800} + \frac{1198483 n^{3}}{201600} \\
- \frac{621689 n^{2}}{55440} + \frac{168439 n}{9240} \\
- 4.
\end{multline*}
...
walk, so with $M$ the adjacency matrix of that digraph on $S=310$ vertices, and $u,w$ the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A229443.
