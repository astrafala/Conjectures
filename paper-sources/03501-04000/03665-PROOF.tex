...
\title{The empirical recurrence for OEIS A217880, proved by transfer matrix}
...
\begin{abstract}
OEIS A217880 carries an empirical recurrence of order $11$ contributed by R. H. Hardin. It is
...
OEIS A217880 is ``Number of n element 0..2 arrays with each element the minimum of 5 adjacent elements of a random 0..2 array of n+4 elements.''. It has offset $1$ and begins
\[
3, 9, 22, 46, 86, 148, 244, 402,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) - 3*a(n-2) + a(n-3) + 3*a(n-6) - a(n-7) + a(n-8) + a(n-9) + a(n-10) + a(n-11).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2018 08:45:33, revision 9) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A217880.
