...
\title{The empirical column recurrences for the table OEIS A236278}
...
\begin{abstract}
OEIS A236278 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A236278 is ``T(n,k)=Number of (n+1)X(k+1) 0..2 arrays with the upper median unequal to the lower median in every 2X2 subblock.''. It has offset $1$, is
read by antidiagonals, and begins
\[
42, 208, 208, 1048, 1770, 1048, 5328, 15434,\ \dots
\]
The entry carries the following block:
\begin{quote}\small
Empirical for column k:\\
k=1: a(n) = 5*a(n-1) +4*a(n-2) -16*a(n-3) -8*a(n-4)\\
k=2: [order 9]\\
k=3: [order 25]\\
k=4: [order 65]\\
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 09:12:54, revision 6) these are still
...
The sequence is ``Number of (n+1)X(2) 0..2 arrays with the upper median unequal to the lower median in every 2X2 subblock.''. Its rows are the vertices of a digraph on
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A236278.
