...
\title{The empirical column recurrences for the table OEIS A259642}
...
\begin{abstract}
OEIS A259642 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A259642 is ``T(n,k)=Number of (n+2)X(k+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000000 or 00000001.''. It has offset $1$, is
read by antidiagonals, and begins
\[
18, 29, 29, 69, 64, 69, 133, 171,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:53:41, revision 6) these are still
...
The sequence is ``Number of (n+2)X(3) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000000 or 00000001.''. Its rows are the vertices of a digraph on
...
The sequence is ``Number of (n+2)X(4) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000000 or 00000001.''. Its rows are the vertices of a digraph on
...
model reproduces $17$ published values, $52$ decimal digits in all, every one of
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A259642.
