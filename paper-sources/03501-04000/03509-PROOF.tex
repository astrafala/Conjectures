...
\title{The empirical column recurrences for the table OEIS A304848}
...
\begin{abstract}
OEIS A304848 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A304848 is ``T(n,k) = Number of n X k 0..1 arrays with every element unequal to 0, 1, 2, 4 or 7 king-move adjacent elements, with upper left element zero.''. It has offset $1$, is
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 05 2025 15:21:54, revision 6) these are still
...
The sequence is ``Number of n X 2 0..1 arrays with every element unequal to 0, 1, 2, 4 or 7 king-move adjacent elements, with upper left element zero.''. Its rows are the vertices of a digraph on
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A304848.
