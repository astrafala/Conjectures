...
\title{The empirical closed form for OEIS A224052, proved}
...
\begin{abstract}
OEIS A224052 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A224052 is ``Number of nX3 0..2 arrays with rows and columns unimodal and antidiagonals nondecreasing.''. It has offset $1$ and begins
\[
22, 218, 1232, 5219, 18502, 57911, 164781, 433762,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 23:13:32, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\begin{multline*}
f(n)\;=\;\frac{n^{12}}{19160064} + \frac{5 n^{11}}{3193344} \\
+ \frac{1627 n^{10}}{43545600} + \frac{751 n^{9}}{1451520} \\
+ \frac{3247 n^{8}}{580608} + \frac{18607 n^{7}}{483840} \\
+ \frac{11286841 n^{6}}{43545600} + \frac{1893037 n^{5}}{1451520} \\
+ \frac{2032151 n^{4}}{435456} + \frac{1618571 n^{3}}{362880} \\
+ \frac{7125527 n^{2}}{831600} + \frac{241067 n}{27720} \\
- 9.
\end{multline*}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224052.
