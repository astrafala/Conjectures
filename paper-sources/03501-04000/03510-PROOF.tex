...
\title{The empirical recurrence for OEIS A211589, proved by transfer matrix}
...
\begin{abstract}
OEIS A211589 carries an empirical recurrence of order $13$ contributed by R. H. Hardin. It is
...
OEIS A211589 is ``Number of -2..2 arrays x(i) of n+1 elements i=1..n+1 with set{t,u,v in 0,1}((x[i+t]+x[j+u]+x[k+v])*(-1)\^{}(t+u+v)) having two, three, four, six or eight distinct values for every i,j,k<=n.''. It has offset $1$ and begins
\[
24, 80, 226, 596, 1536, 3966, 10192, 26572,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 16:15:35, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-1) - 6\,a(n-2) - 60\,a(n-3) + 139\,a(n-4) + 94\,a(n-5) - 507\,a(n-6) + 148\,a(n-7) + 690\,a(n-8) - 428\,a(n-9) - 372\,a(n-10) + 272\,a(n-11) + 72\,a(n-12) - 48\,a(n-13)
\]
for every $n>13$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A211589.
