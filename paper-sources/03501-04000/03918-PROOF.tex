...
\title{The empirical closed form for OEIS A184543, proved}
...
\begin{abstract}
OEIS A184543 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
$S=682$ vertices. Any function of the form $\sum_j p_j(n)\lambda_j^{\,n}$ satisfies the
...
OEIS A184543 is ``Number of (n+2) X 6 binary arrays with each 3 X 3 subblock having rows and columns in lexicographically nondecreasing order.''. It has offset $1$ and begins
\[
220, 537, 1048, 1837, 3024, 4774, 7307, 10909,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (1/720)*n\^{}6 + (11/240)*n\^{}5 + (89/144)*n\^{}4 + (209/48)*n\^{}3 + (18317/360)*n\^{}2 + (1231/10)*n + 41.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 13 2018 08:44:45, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{n^{6}}{720} + \frac{11 n^{5}}{240} + \frac{89 n^{4}}{144} + \frac{209 n^{3}}{48} + \frac{18317 n^{2}}{360} + \frac{1231 n}{10} + 41.
\]
...
walk, so with $M$ the adjacency matrix of that digraph on $S=682$ vertices, and $u,w$ the
...
$n=8,\dots,14$ and agree at each. A monic recurrence of order $7$
determines $a(m)$ from $a(m-1),\dots,a(m-7)$, and for every $m\ge15$ both
$m>7$ and $m-7\ge8$ hold, so induction on $m$ gives $a(m)=f(m)$ for every
$m\ge8$.
Below $n=8$ the recurrence argument gives nothing, since \eqref{eq:rec} is only
established for $a$ from $n=8$ on. The remaining indices $n=1,\dots,7$ were
...
First, the walk model reproduces every one of the $32$ terms the entry publishes,
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A184543.
