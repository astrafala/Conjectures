...
\title{The empirical recurrence for OEIS A206687, proved by transfer matrix}
...
\begin{abstract}
OEIS A206687 counts arrays in which no entry may equal the entries at a short list of fixed offsets
...
$2$ consecutive rows, $S=128$ states in all.
\end{abstract}
...
OEIS A206687 is ``Number of n X 2 0..3 arrays with no element equal to another within two positions in the same row or column, and new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
1, 4, 11, 36, 116, 376, 1216, 3936,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + 4*a(n-2) for n>4.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 23 2018 08:35:39, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206687.
