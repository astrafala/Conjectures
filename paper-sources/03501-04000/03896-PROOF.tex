...
\title{The empirical recurrence for OEIS A206231, proved by transfer matrix}
...
\begin{abstract}
OEIS A206231 counts, up to renaming the letters, the arrays of width $2$ over at most $4$
letters in which every $2\times3$ and $3\times2$ subblock has exactly $2$ equal edges, an edge of such a window being one of the six steps of its perimeter cycle and an equal edge one whose two cells agree. It carries an empirical recurrence of order $7$ contributed by
...
OEIS A206231 is ``Number of (n+1) X 2 0..3 arrays with every 2 X 3 or 3 X 2 subblock having exactly two equal edges, and new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
15, 60, 310, 1640, 8910, 51066, 294546, 1710184,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 8*a(n-1) -11*a(n-2) +36*a(n-3) -303*a(n-4) +232*a(n-5) +147*a(n-6) +756*a(n-7) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 14 2018 09:32:37, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-1) - 11\,a(n-2) + 36\,a(n-3) - 303\,a(n-4) + 232\,a(n-5) + 147\,a(n-6) + 756\,a(n-7)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206231.
