...
\title{The empirical recurrence for OEIS A203280, proved by transfer matrix}
...
\begin{abstract}
OEIS A203280 counts arrays of width $3$ over $\{0,1\}$ in which every cell has neighbours equal to each of two named values. The entry carries an
...
OEIS A203280 is ``Number of n X 3 binary arrays with every element neighboring horizontally or vertically both a 0 and a 1.''. It has offset $1$ and begins
\[
0, 4, 28, 64, 372, 1444, 6528, 28900,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 5*a(n-1) -13*a(n-3) -a(n-4) +44*a(n-5) -26*a(n-6) +12*a(n-8) -8*a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 04 2018 03:11:30, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) - 13\,a(n-3) - a(n-4) + 44\,a(n-5) - 26\,a(n-6) + 12\,a(n-8) - 8\,a(n-9)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A203280.
