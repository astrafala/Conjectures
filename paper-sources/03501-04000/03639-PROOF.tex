...
\title{The empirical column recurrences for the table OEIS A234777}
...
\begin{abstract}
OEIS A234777 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A234777 is ``T(n,k)=Number of (n+1)X(k+1) 0..4 arrays with 2X2 edge jumps all no more than +1 in one of the clockwise or counterclockwise directions but not both.''. It has offset $1$, is
read by antidiagonals, and begins
\[
88, 454, 454, 2056, 3980, 2056, 10076, 28840,\ \dots
\]
...
k=3: [order 52]\\
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 08:26:16, revision 6) these are still
...
The sequence is ``Number of (n+1)X2 0..4 arrays with 2X2 edge jumps all no more than +1 in one of the clockwise or counterclockwise directions but not both.''. Its rows are the vertices of a digraph on
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234777.
