...
\title{The empirical recurrence for OEIS A211528, proved by transfer matrix}
...
\begin{abstract}
OEIS A211528 carries an empirical recurrence of order $6$ contributed by R. H. Hardin. It is
...
OEIS A211528 is ``Number of -1..1 arrays x(i) of n+1 elements i=1..n+1 with set{t,u,v in 0,1}((x[i+t]+x[j+u]+x[k+v])*(-1)\^{}(t+u+v)) having two, four or six distinct values for every i,j,k<=n.''. It has offset $1$ and begins
\[
8, 18, 34, 64, 116, 214, 392, 732,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) - 2*a(n-2) - 9*a(n-3) + 10*a(n-4) + 2*a(n-5) - 4*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 18 2018 14:30:35, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A211528.
