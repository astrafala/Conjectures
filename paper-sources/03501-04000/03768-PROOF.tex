...
\title{The empirical closed form for OEIS A223671, proved}
...
\begin{abstract}
OEIS A223671 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A223671 is ``Number of 4Xn 0..1 arrays with rows, diagonals and antidiagonals unimodal.''. It has offset $1$ and begins
\[
16, 256, 1723, 6454, 18980, 49561, 119150, 267643,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 22:04:48, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{n^{8}}{112} - \frac{19 n^{7}}{210} + \frac{59 n^{6}}{45} - \frac{61 n^{5}}{120} - \frac{8789 n^{4}}{144} + \frac{99083 n^{3}}{120} - \frac{10598579 n^{2}}{2520} + \frac{1548737 n}{140} - 11539.
\]
...
$n=16,\dots,24$ and agree at each. A monic recurrence of order $9$
determines $a(m)$ from $a(m-1),\dots,a(m-9)$, and for every $m\ge25$ both
$m>15$ and $m-9\ge16$ hold, so induction on $m$ gives $a(m)=f(m)$ for every
$m\ge16$.
Below $n=16$ the recurrence argument gives nothing, since \eqref{eq:rec} is only
established for $a$ from $n=16$ on. The remaining indices $n=7,\dots,15$ were
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223671.
