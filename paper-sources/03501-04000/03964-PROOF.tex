...
\title{The empirical closed form for OEIS A207067, proved}
...
\begin{abstract}
OEIS A207067 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
$S=961$ vertices. Any function of the form $\sum_j p_j(n)\lambda_j^{\,n}$ satisfies the
...
OEIS A207067 is ``Number of n X 7 0..1 arrays avoiding 0 0 1 and 0 1 0 horizontally and 0 0 1 and 1 0 1 vertically.''. It has offset $1$ and begins
\[
31, 961, 6634, 27063, 82739, 210118, 468348, 947298,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (31/2520)*n\^{}7 + (62/45)*n\^{}6 + (4867/360)*n\^{}5 + (2015/72)*n\^{}4 + (1271/180)*n\^{}3 - (4991/360)*n\^{}2 - (713/140)*n.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 18 2018 14:09:55, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{31 n^{7}}{2520} + \frac{62 n^{6}}{45} + \frac{4867 n^{5}}{360} + \frac{2015 n^{4}}{72} + \frac{1271 n^{3}}{180} - \frac{4991 n^{2}}{360} - \frac{713 n}{140}.
\]
...
walk, so with $M$ the adjacency matrix of that digraph on $S=961$ vertices, and $u,w$ the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207067.
