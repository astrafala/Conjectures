...
\title{The empirical recurrence for OEIS A267905, proved by transfer matrix}
...
\begin{abstract}
OEIS A267905 counts arrays in which the REPEATED VALUES of each row, and of each column, stand in a
...
OEIS A267905 is ``Number of n X 1 0..2 arrays with every repeated value in every row unequal to the previous repeated value, and in every column equal to the previous repeated value, and new values introduced in row-major sequential order.''. It has offset $1$ and begins
\[
1, 2, 5, 13, 34, 88, 225, 569,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 5*a(n-1) -7*a(n-2) +a(n-3) +2*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 11 2019 09:05:52, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) - 7\,a(n-2) + a(n-3) + 2\,a(n-4)
\]
for every $n>4$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267905.
