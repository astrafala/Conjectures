...
\title{The empirical recurrence for OEIS A183476, proved by transfer matrix}
...
\begin{abstract}
OEIS A183476 counts arrays of width $2$ over $\{0,1,2\}$ in which every cell is the sum of one of two groups of its neighbours. The entry carries an
...
OEIS A183476 is ``Number of n X 2 0..2 arrays with every element equal to either the sum mod 3 of its vertical neighbors or the sum mod 3 of its horizontal neighbors.''. It has offset $1$ and begins
\[
3, 15, 39, 135, 495, 1647, 5751, 20223,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) + 12*a(n-3) - 18*a(n-4) - 36*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 29 2018 08:49:13, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + 12\,a(n-3) - 18\,a(n-4) - 36\,a(n-6)
\]
for every $n>5$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A183476.
