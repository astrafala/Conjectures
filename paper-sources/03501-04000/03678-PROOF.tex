...
\title{The empirical closed form for OEIS A223965, proved}
...
\begin{abstract}
OEIS A223965 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A223965 is ``Number of 5 X n 0..3 arrays with antidiagonals unimodal and rows and diagonals nondecreasing.''. It has offset $1$ and begins
\[
1024, 48620, 485714, 2575955, 9779558, 30643468, 85350934, 220335341,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 25 2022 18:36:17, revision 6) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{n^{15}}{217728000} + \frac{n^{14}}{7257600} + \frac{1021 n^{13}}{283046400} + \frac{89 n^{12}}{1267200} + \frac{49747 n^{11}}{42768000} + \frac{114077 n^{10}}{7257600} + \frac{4197611 n^{9}}{21772800} + \frac{2072933 n^{8}}{1036800} + \frac{4176906623 n^{7}}{217728000} + \frac{25808249 n^{6}}{172800} + \frac{198423611 n^{5}}{194400} + \frac{1908980977 n^{4}}{453600} + \frac{19380549743 n^{3}}{4536000} - \frac{3498352713 n^{2}}{30800} + \frac{12988213717 n}{90090} + 329692.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223965.
