...
\title{The empirical recurrence for OEIS A233170, proved by transfer matrix}
...
\begin{abstract}
OEIS A233170 counts arrays over $\{0,\dots,5\}$ in which no two entries that are neighbours in
...
\begin{theorem}
\[
a(n)\;=\;128\,a(n-1) - 2816\,a(n-2) + 16384\,a(n-3)
\]
for every $n>3$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A233170.
