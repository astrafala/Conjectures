...
\title{The empirical closed form for OEIS A224026, proved}
...
\begin{abstract}
OEIS A224026 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A224026 is ``Number of 4Xn 0..3 arrays with rows nondecreasing and antidiagonals unimodal.''. It has offset $1$ and begins
\[
256, 10000, 112436, 772683, 4002738, 16861106, 60614473, 192152734,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 23:11:33, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\begin{multline*}
f(n)\;=\;\frac{3551 n^{12}}{47900160} + \frac{89357 n^{11}}{39916800} \\
+ \frac{787537 n^{10}}{21772800} + \frac{54391 n^{9}}{145152} \\
+ \frac{3628073 n^{8}}{1451520} + \frac{219389 n^{7}}{19200} \\
+ \frac{790310011 n^{6}}{21772800} + \frac{11979533 n^{5}}{145152} \\
+ \frac{26980967 n^{4}}{217728} + \frac{119696723 n^{3}}{907200} \\
+ \frac{46358119 n^{2}}{831600} + \frac{56717 n}{396} \\
+ 52.
\end{multline*}
...
$n=16,\dots,28$ and agree at each. A monic recurrence of order $13$
determines $a(m)$ from $a(m-1),\dots,a(m-13)$, and for every $m\ge29$ both
$m>15$ and $m-13\ge16$ hold, so induction on $m$ gives $a(m)=f(m)$ for every
$m\ge16$.
Below $n=16$ the recurrence argument gives nothing, since \eqref{eq:rec} is only
established for $a$ from $n=16$ on. The remaining indices $n=3,\dots,15$ were
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224026.
