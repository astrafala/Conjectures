...
\title{The conjectured generating function for OEIS A240333, proved}
...
\begin{abstract}
OEIS A240333 counts arrays of a fixed width under a local condition, and carries a conjectured
...
OEIS A240333 is ``Number of n X 2 0..3 arrays with no element equal to two plus the sum of elements to its left or two plus the sum of elements above it or one plus the sum of the elements diagonally to its northwest, modulo 4.''. It has offset $1$ and begins
\[
4, 15, 48, 125, 284, 582,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 27 2018 08:13:53, revision 9) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A240333.
