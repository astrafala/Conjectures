...
\title{The empirical column recurrences for the table OEIS A251326}
...
\begin{abstract}
OEIS A251326 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A251326 is ``T(n,k)=Number of (n+1)X(k+1) 0..1 arrays with every 2X2 subblock having one or two 1s.''. It has offset $1$, is
read by antidiagonals, and begins
\[
10, 28, 28, 78, 116, 78, 220, 474,\ \dots
\]
...
k=6: [order 71]\\
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:17:05, revision 6) these are still
...
The sequence is ``Number of (n+1)X(2) 0..1 arrays with every 2X2 subblock having one or two 1s.''. Its rows are the vertices of a digraph on
...
The sequence is ``Number of (n+1)X(3) 0..1 arrays with every 2X2 subblock having one or two 1s.''. Its rows are the vertices of a digraph on
...
$c_{1}$ & $4$ & $c_{4}$ & $-90$ & $c_{7}$ & $-126$ & $c_{10}$ & $-2$ \\
$c_{2}$ & $24$ & $c_{5}$ & $188$ & $c_{8}$ & $16$ &  &  \\
$c_{3}$ & $-59$ & $c_{6}$ & $51$ & $c_{9}$ & $11$ &  &  \\
\end{tabular}\end{center}
Repeating with the first $10+4$ terms removed gives order $10$ again.

\subsection*{Column $k=4$, recovered}
The entry gives only the order for this line: ``k=4: [order 19]''. Its model is a walk on
...
\begin{center}\small\begin{tabular}{cccccccc}
$c_{1}$ & $6$ & $c_{6}$ & $3684$ & $c_{11}$ & $-36276$ & $c_{16}$ & $222$ \\
$c_{2}$ & $67$ & $c_{7}$ & $-22554$ & $c_{12}$ & $3532$ & $c_{17}$ & $145$ \\
$c_{3}$ & $-299$ & $c_{8}$ & $-2351$ & $c_{13}$ & $14102$ & $c_{18}$ & $-11$ \\
$c_{4}$ & $-1066$ & $c_{9}$ & $42798$ & $c_{14}$ & $-1392$ & $c_{19}$ & $-2$ \\
$c_{5}$ & $4715$ & $c_{10}$ & $-2598$ & $c_{15}$ & $-2361$ &  &  \\
\end{tabular}\end{center}
...
\[
(c_1,\dots,c_{36})=(10,\ 170,\ -1489,\ -8511,\ 78743,\ 147223,\ -1793473,\ -909507,\ 21389764,\ -1766361,\ -147265613,\ 55639283,\ 613951735,\ -340166865,\ -1582274681,\ 1085372756,\ 2516622952,\ -2042203758,\ -2401750473,\ 2319699490,\ 1276676483,\ -1574484075,\ -300315227,\ 622148186,\ -14501288,\ -136996062,\ 21688068,\ 15485396,\ -3992911,\ -751071,\ 287595,\ 6184,\ -7774,\ 298,\ 55,\ -2).
\]
Repeating with the first $36+4$ terms removed gives order $36$ again.

\subsection*{Column $k=6$, recovered}
The entry gives only the order for this line: ``k=6: [order 71]''. Its model is a walk on
...
$71$ --- the stated order --- with integer coefficients
\[
(c_1,\dots,c_{71})=(15,\ 478,\ -6592,\ -81812,\ 1161235,\ 6621742,\ -106611518,\ -281447389,\ 5802243413,\ 6159432751,\ -203568141804,\ -36429467384,\ 4872742472770,\ -1677160847954,\ -82756359945328,\ 55336385443131,\ 1025349936178494,\ -900471100194833,\ -9458256661521335,\ 9638635592633075,\ 65953033029514961,\ -73725323485690372,\ -351716411358642893,\ 418659624707869591,\ 1447285388471743285,\ -1803713339164821453,\ -4626346605521534158,\ 5977177506915681044,\ 11543768132765235380,\ -15374873722815035971,\ -22555465414989973528,\ 30885572233238233485,\ 34565576934711986431,\ -48640253412775680980,\ -41552087106554983292,\ 60176780083914311367,\ 39138697185753304266,\ -58522015482712939101,\ -28821326451228639607,\ 44709863977610128629,\ 16541929797723859976,\ -26789881684402375349,\ -7374146647157743516,\ 12557876312072184903,\ 2544975502551411833,\ -4589327443321297343,\ -678720519150319089,\ 1301797875345873984,\ 140079087563888523,\ -284974771605147184,\ -22549663920826578,\ 47779057927930856,\ 2880493487813647,\ -6072261405131446,\ -299178503090526,\ 576624750407340,\ 25673933418003,\ -40082664672967,\ -1790618210806,\ 1979286893231,\ 95810537621,\ -66333360330,\ -3604312561,\ 1401152526,\ 85000342,\ -16329505,\ -1046121,\ 80100,\ 4325,\ -131,\ -2).
\]
Repeating with the first $71+4$ terms removed gives order $71$ again.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251326.
