...
\title{The empirical closed form for OEIS A223683, proved}
...
\begin{abstract}
OEIS A223683 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A223683 is ``Number of 5Xn 0..1 arrays with rows and antidiagonals unimodal.''. It has offset $1$ and begins
\[
32, 1024, 13045, 85663, 384009, 1363639, 4123210, 11062778,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 22:07:47, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\begin{multline*}
f(n)\;=\;\frac{359 n^{10}}{453600} + \frac{251 n^{9}}{30240} \\
+ \frac{14533 n^{8}}{60480} + \frac{583 n^{7}}{630} \\
+ \frac{62303 n^{6}}{5400} - \frac{4999 n^{5}}{1440} \\
+ \frac{14868751 n^{4}}{181440} - \frac{1038043 n^{3}}{3780} \\
+ \frac{3156491 n^{2}}{8400} - \frac{91003 n}{210} \\
+ 362.
\end{multline*}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223683.
