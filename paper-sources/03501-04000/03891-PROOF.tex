...
\title{The conjectured generating function for OEIS A250777, proved}
...
\begin{abstract}
OEIS A250777 counts arrays of a fixed width under a local condition, and carries a conjectured
...
OEIS A250777 is ``Number of (n+1) X (2+1) 0..1 arrays with nondecreasing x(i,j)+x(i,j-1) in the i direction and nondecreasing absolute value of x(i,j)-x(i-1,j) in the j direction.''. It has offset $1$ and begins
\[
21, 46, 96, 196, 396, 796,\ \dots
\]
The entry states, as a conjecture contributed by a reader and never marked settled:
\begin{quote}
Empirical g.f.: x*(21 - 17*x) / ((1 - x)*(1 - 2*x)). - \_Colin Barker\_, Nov 19 2018
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 19 2018 09:13:56, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250777.
