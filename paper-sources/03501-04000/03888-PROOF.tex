...
\title{The empirical closed form for OEIS A224412, proved}
...
\begin{abstract}
OEIS A224412 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A224412 is ``Number of 5Xn 0..1 arrays with rows unimodal and antidiagonals nondecreasing.''. It has offset $1$ and begins
\[
32, 324, 1288, 3436, 7812, 16420, 32814, 63202,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 23:26:55, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\begin{multline*}
f(n)\;=\;\frac{n^{10}}{3628800} + \frac{n^{9}}{80640} \\
+ \frac{n^{8}}{3456} + \frac{23 n^{7}}{5760} \\
+ \frac{7213 n^{6}}{172800} + \frac{683 n^{5}}{2304} \\
+ \frac{138869 n^{4}}{36288} + \frac{32143 n^{3}}{2240} \\
+ \frac{32909 n^{2}}{450} - \frac{753 n}{20} \\
- 44.
\end{multline*}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224412.
