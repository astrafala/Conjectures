...
\title{The empirical closed form for OEIS A225013, proved}
...
\begin{abstract}
OEIS A225013 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A225013 is ``Number of 6Xn 0..1 arrays with rows unimodal and columns nondecreasing.''. It has offset $1$ and begins
\[
7, 49, 252, 1036, 3612, 11088, 30738, 78354,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 23:37:52, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\begin{multline*}
f(n)\;=\;\frac{n^{12}}{479001600} + \frac{n^{11}}{7257600} \\
+ \frac{187 n^{10}}{43545600} + \frac{13 n^{9}}{161280} \\
+ \frac{14671 n^{8}}{14515200} + \frac{3043 n^{7}}{345600} \\
+ \frac{2380201 n^{6}}{43545600} + \frac{347911 n^{5}}{1451520} \\
+ \frac{8129699 n^{4}}{10886400} + \frac{923183 n^{3}}{604800} \\
+ \frac{913741 n^{2}}{415800} + \frac{49 n}{40} \\
+ 1.
\end{multline*}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A225013.
