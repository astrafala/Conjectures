...
\title{The empirical closed form for OEIS A223865, proved}
...
\begin{abstract}
OEIS A223865 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A223865 is ``Number of 2Xn 0..3 arrays with rows and antidiagonals unimodal and columns nondecreasing.''. It has offset $1$ and begins
\[
10, 100, 684, 3526, 14751, 52591, 165212, 468292,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 22:47:06, revision 8) this is still
...
+ \frac{3991 n^{8}}{580608} + \frac{2369 n^{7}}{53760} \\
+ \frac{8836141 n^{6}}{43545600} + \frac{136571 n^{5}}{207360} \\
+ \frac{654599 n^{4}}{435456} + \frac{865283 n^{3}}{362880} \\
+ \frac{289699 n^{2}}{103950} + \frac{39143 n}{27720} \\
+ 1.
\end{multline*}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223865.
