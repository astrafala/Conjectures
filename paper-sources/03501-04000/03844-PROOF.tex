...
\title{The empirical recurrence for OEIS A205348, proved by transfer matrix}
...
\begin{abstract}
OEIS A205348 counts, up to renaming the letters, the arrays of width $3$ over at most $4$
letters in which no two $2\times2$ subblocks that are neighbours, horizontally or vertically, have the same number of equal edges. It carries an empirical recurrence of order $9$ contributed by
...
OEIS A205348 is ``Number of (n+1)X3 0..3 arrays with no 2X2 subblock having the same number of equal edges as its horizontal or vertical neighbors, and new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
110, 1750, 30904, 544616, 9559986, 168343322, 2962323362, 52122083398,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 12:01:59, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;9\,a(n-1) + 108\,a(n-2) + 739\,a(n-3) + 534\,a(n-4) - 2929\,a(n-5) + 8365\,a(n-6) + 5012\,a(n-7) - 23096\,a(n-8) - 13776\,a(n-9)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A205348.
