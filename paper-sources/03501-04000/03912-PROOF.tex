...
\title{The empirical closed form for OEIS A223920, proved}
...
\begin{abstract}
OEIS A223920 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
$S=640$ vertices. Any function of the form $\sum_j p_j(n)\lambda_j^{\,n}$ satisfies the
...
OEIS A223920 is ``Number of 3Xn 0..2 arrays with rows and antidiagonals unimodal and columns nondecreasing.''. It has offset $1$ and begins
\[
10, 100, 666, 3311, 13347, 45988, 140236, 387671,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 22:55:45, revision 11) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\begin{multline*}
f(n)\;=\;\frac{n^{12}}{19160064} + \frac{5 n^{11}}{3193344} \\
+ \frac{1627 n^{10}}{43545600} + \frac{257 n^{9}}{483840} \\
+ \frac{2309 n^{8}}{414720} + \frac{19319 n^{7}}{483840} \\
+ \frac{8701321 n^{6}}{43545600} + \frac{971137 n^{5}}{1451520} \\
+ \frac{3369229 n^{4}}{2177280} + \frac{294809 n^{3}}{120960} \\
+ \frac{652717 n^{2}}{237600} + \frac{521 n}{385} \\
+ 1.
\end{multline*}
...
walk, so with $M$ the adjacency matrix of that digraph on $S=640$ vertices, and $u,w$ the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223920.
