...
\title{The empirical recurrence for OEIS A211478, proved by transfer matrix}
...
\begin{abstract}
OEIS A211478 carries an empirical recurrence of order $9$ contributed by R. H. Hardin. It is
...
OEIS A211478 is ``Number of -1..1 arrays x(i) of n+1 elements i=1..n+1 with x(i)+x(j), x(i+1)+x(j+1), -(x(i)+x(j+1)), and -(x(i+1)+x(j)) having one, two or three distinct values for every i<=n and j<=n.''. It has offset $1$ and begins
\[
9, 23, 59, 145, 351, 835, 1971, 4625,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 7*a(n-1) - 15*a(n-2) + a(n-3) + 33*a(n-4) - 28*a(n-5) - 12*a(n-6) + 16*a(n-7) + a(n-8) - 2*a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 18 2018 07:47:20, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-1) - 15\,a(n-2) + a(n-3) + 33\,a(n-4) - 28\,a(n-5) - 12\,a(n-6) + 16\,a(n-7) + a(n-8) - 2\,a(n-9)
\]
for every $n>0$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A211478.
