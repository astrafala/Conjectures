...
\title{The empirical recurrence for OEIS A188703, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A188703 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A188703 is ``Number of nX6 binary arrays without the pattern 0 0 diagonally or vertically.''. It has offset $1$ and begins
\[
64, 377, 7164, 71152, 986929, 11462588, 145764780, 1769780565,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 04:47:20, revision 9) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A188703.
