...
\title{The empirical recurrence for OEIS A250989, proved by transfer matrix}
...
\begin{abstract}
OEIS A250989 counts arrays over $\{0,1,2\}$ in which a statistic taken over short runs
...
OEIS A250989 is ``Number of (n+1)X(3+1) 0..2 arrays with nondecreasing min(x(i,j),x(i,j-1)) in the i direction and nondecreasing absolute value of x(i,j)-x(i-1,j) in the j direction.''. It has offset $1$ and begins
\[
646, 4007, 21955, 111175, 542834, 2592734, 12238954, 57388086,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 12:57:00, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;25\,a(n-1) - 263\,a(n-2) + 1465\,a(n-3) - 4208\,a(n-4) + 2752\,a(n-5) + 20591\,a(n-6) - 63149\,a(n-7) + 39306\,a(n-8) + 127182\,a(n-9) - 234935\,a(n-10) - 16967\,a(n-11) + 341508\,a(n-12) - 162216\,a(n-13) - 227787\,a(n-14) + 169273\,a(n-15) + 82343\,a(n-16) - 69183\,a(n-17) - 19686\,a(n-18) + 10818\,a(n-19) + 3132\,a(n-20)
\]
for every $n>20$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250989.
