...
\title{The empirical recurrence for OEIS A253354, proved by transfer matrix}
...
\begin{abstract}
OEIS A253354 counts the arrays over $\{0,\dots,1\}$ whose $2\times2$ subblocks carry a
...
\[
907, 13917, 199512, 3013228, 44555528, 665370612, 9895936900, 147440625572,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:59:25, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253354.
