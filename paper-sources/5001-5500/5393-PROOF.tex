...
\title{The empirical recurrence for OEIS A197745, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A197745 counts arrays over $\{0,\dots,4\}$ in which every cell is constrained by the
...
OEIS A197745 is ``Number of n X 3 0..4 arrays with each element x equal to the number its horizontal and vertical neighbors equal to 3,3,0,1,0 for x=0,1,2,3,4.''. It has offset $1$ and begins
\[
2, 12, 66, 212, 921, 4086, 17332, 75122,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 16 2024 00:58:24, revision 10) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 3\,a(n-2) + 26\,a(n-3) + 20\,a(n-4) + 24\,a(n-5) - 62\,a(n-6) - 166\,a(n-7) - 99\,a(n-8) + 128\,a(n-9) + 383\,a(n-10) + 75\,a(n-11) - 563\,a(n-12) - 540\,a(n-13) + 86\,a(n-14) + 624\,a(n-15) + 663\,a(n-16) + 220\,a(n-17) - 159\,a(n-18) - 266\,a(n-19) - 229\,a(n-20) - 125\,a(n-21) - 30\,a(n-22) + 12\,a(n-23) + 4\,a(n-24)
\end{equation}
for all $n>25$.
...
\#\{\text{neighbours with value }f(x_{t,u})\}=x_{t,u},\quad f=(3,3,0,1,0)
\end{equation}
for every cell $(t,u)$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A197745.
