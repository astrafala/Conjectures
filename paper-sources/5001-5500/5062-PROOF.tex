...
\title{The empirical recurrence for OEIS A237319, proved by transfer matrix}
...
\begin{abstract}
OEIS A237319 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
The condition is local to two consecutive rows, so the count is a walk count on $S=1508$
...
OEIS A237319 is ``Number of (n+1)X(3+1) 0..2 arrays with the maximum plus the upper median plus the minimum minus the lower median of every 2X2 subblock differing from its horizontal and vertical neighbors by exactly one.''. It has offset $1$ and begins
\[
1508, 12756, 107572, 949596, 8219232, 69761476, 591728030, 5221400304,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 10:04:18, revision 6) this is still
...
differ by $1$. The entry's first term $1508$ counts those, and the model was made to
...
\]
over the $S=1508$ pairs whose own subblock row already satisfies the condition along itself.
...
\begin{theorem}
\[
a(n)\;=\;11007\,a(n-4) - 30511165\,a(n-8) + 2416368893\,a(n-12) - 38181989668\,a(n-16) + 148755328110\,a(n-20) + 281773663032\,a(n-24) + 100862271352\,a(n-28) + 2907602208\,a(n-32)
\]
for every $n>35$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237319.
