...
\title{The empirical recurrence for OEIS A302273, proved by transfer matrix}
...
\begin{abstract}
OEIS A302273 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the six horizontal, diagonal and antidiagonal neighbours, a number $equal to$ itself lying in $\{1,2,4\}$, and it carries an empirical
...
OEIS A302273 is ``Number of n X 3 0..1 arrays with every element equal to 1, 2 or 4 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 7, 22, 79, 269, 942, 3401, 12283,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 05 2018 04:09:53, revision
7) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 5\,a(n-2) + 26\,a(n-3) - 66\,a(n-4) - 86\,a(n-5) + 79\,a(n-6) + 14\,a(n-7) + 13\,a(n-8) - 168\,a(n-9) + 250\,a(n-10) + 428\,a(n-11) - 232\,a(n-12) - 24\,a(n-13) - 160\,a(n-14) + 160\,a(n-15) - 256\,a(n-16) - 384\,a(n-17) + 256\,a(n-18)
\end{equation}
for all $n>18$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302273.
