...
\title{The empirical recurrence for OEIS A282644, proved by transfer matrix}
...
\begin{abstract}
OEIS A282644 counts $n\times5$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A282644 is ``Number of n X 5 0..1 arrays with no 1 equal to more than one of its king-move neighbors.''. It has offset $1$ and begins
\[
24, 201, 1601, 15460, 133118, 1190848, 10614316, 94161619,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 21 2025 05:17:59, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + 31\,a(n-2) + 127\,a(n-3) - 103\,a(n-4) - 166\,a(n-5) - 1614\,a(n-6) + 2383\,a(n-7) - 4797\,a(n-8) + 13056\,a(n-9) - 10639\,a(n-10) + 8408\,a(n-11) - 11834\,a(n-12) + 3060\,a(n-13) - 2498\,a(n-14) + 4177\,a(n-15) + 266\,a(n-16) + 332\,a(n-17) - 384\,a(n-18) + 45\,a(n-19) + 21\,a(n-20) + 30\,a(n-21)
\]
for every $n>21$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A282644.
