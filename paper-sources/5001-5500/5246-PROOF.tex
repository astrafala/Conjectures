...
\title{The empirical recurrence for OEIS A269095, proved by transfer matrix}
...
\begin{abstract}
OEIS A269095 carries an empirical recurrence of order $26$ contributed by R.~H.~Hardin. It is
...
OEIS A269095 is ``Number of nX6 0..3 arrays with some element plus some horizontally or vertically adjacent neighbor totalling three exactly once.''. It has offset $1$ and begins
\[
1620, 889056, 300056400, 86415197088, 22984646281176, 5826856525990272, 1430390977786967280, 343122372255163660560,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 19 2016 09:49:40, revision 4) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269095.
