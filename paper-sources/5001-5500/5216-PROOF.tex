...
\title{The empirical recurrence for OEIS A220714, proved by transfer matrix}
...
\begin{abstract}
OEIS A220714 counts the ways of linking the cells of a grid $3$ cells wide, each cell either to
...
OEIS A220714 is ``Number of ways to reciprocally link elements of an n X 3 array either to themselves or to exactly two king-move neighbors, without consecutive collinear links.''. It has offset $1$ and begins
\[
1, 26, 226, 2243, 21195, 201598, 1913495, 18172469,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 13 2022 20:12:59, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-1) + 31\,a(n-2) - 61\,a(n-3) - 118\,a(n-4) + 346\,a(n-5) + 321\,a(n-6) - 404\,a(n-7) - 191\,a(n-8) - 429\,a(n-9) - 270\,a(n-10) + 1567\,a(n-11) - 1015\,a(n-12) - 504\,a(n-13) + 179\,a(n-14) - 554\,a(n-15) + 136\,a(n-16) + 185\,a(n-17) - 21\,a(n-18) - 3\,a(n-19) - a(n-20)
\]
for every $n>19$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A220714.
