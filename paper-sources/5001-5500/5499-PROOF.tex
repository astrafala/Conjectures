...
\title{The empirical recurrence for OEIS A236896, proved by transfer matrix}
...
\begin{abstract}
OEIS A236896 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
statistics of every $2\times2$ subblock, and carries an empirical recurrence of order
$22$ contributed by R.~H.~Hardin. It is true, and it is decidable rather than empirical.
...
OEIS A236896 is ``Number of (n+1)X(2+1) 0..2 arrays with the maximum plus the upper median of every 2X2 subblock equal.''. It has offset $1$ and begins
\[
339, 3205, 30644, 337861, 3782769, 43538228, 504121651, 5869125835,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 09:39:21, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;20\,a(n-1) - 50\,a(n-2) - 1079\,a(n-3) + 5929\,a(n-4) + 13546\,a(n-5) - 136152\,a(n-6) + 32559\,a(n-7) + 1230196\,a(n-8) - 1321510\,a(n-9) - 5558982\,a(n-10) + 8606104\,a(n-11) + 13433556\,a(n-12) - 26908536\,a(n-13) - 16223728\,a(n-14) + 45800336\,a(n-15) + 5469360\,a(n-16) - 41824640\,a(n-17) + 6747552\,a(n-18) + 17907200\,a(n-19) - 5889280\,a(n-20) - 2304000\,a(n-21) + 921600\,a(n-22)
\]
for every $n>22$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A236896.
