...
\title{The empirical recurrence for OEIS A232024, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A232024 counts arrays over $\{0,\dots,2\}$ in which every cell is constrained by the
...
OEIS A232024 is ``Number of 2 X n 0..2 arrays with no element less than a strict majority of its horizontal and antidiagonal neighbors.''. It has offset $1$ and begins
\[
9, 22, 66, 212, 716, 2447, 8312, 28118,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 03 2022 23:06:30, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;9\,a(n-1) - 36\,a(n-2) + 97\,a(n-3) - 202\,a(n-4) + 329\,a(n-5) - 437\,a(n-6) + 459\,a(n-7) - 407\,a(n-8) + 291\,a(n-9) - 161\,a(n-10) + 74\,a(n-11) - 4\,a(n-12) + 4\,a(n-13) + 15\,a(n-14) + 2\,a(n-15) + 3\,a(n-16) + a(n-17)
\end{equation}
for all $n>18$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232024.
