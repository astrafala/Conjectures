...
\title{The empirical recurrence for OEIS A232372, proved by transfer matrix}
...
\begin{abstract}
OEIS A232372 counts arrays of width $4$ over $\{0,1,2,3\}$ in which every cell carrying one stated
...
OEIS A232372 is ``Number of nX4 0..3 arrays with every 0 next to a 1, every 1 next to a 2 and every 2 next to a 3 horizontally, diagonally or antidiagonally, and no adjacent values equal.''. It has offset $1$ and begins
\[
8, 296, 4404, 63744, 957232, 14297980, 213082596, 3180405572,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 07:22:00, revision 6) this is still
...
adjacency matrix,
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=3879.
\]
...
\begin{theorem}
\[
a(n)\;=\;10\,a(n-1) + 46\,a(n-2) + 374\,a(n-3) + 330\,a(n-4) + 2418\,a(n-5) + 7211\,a(n-6) + 9104\,a(n-7) + 1944\,a(n-8) - 21557\,a(n-9) - 54205\,a(n-10) - 77028\,a(n-11) - 83393\,a(n-12) - 57615\,a(n-13) - 34140\,a(n-14) - 9235\,a(n-15) - 944\,a(n-16) + 2734\,a(n-17) + 385\,a(n-18) + 30\,a(n-19) - 35\,a(n-20) + 138\,a(n-21) - 4\,a(n-22)
\]
for every $n>22$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232372.
