...
\title{The empirical recurrence for OEIS A261110, proved by transfer matrix}
...
\begin{abstract}
OEIS A261110 counts $(n+2)\times7$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A261110 is ``Number of (n+2)X(5+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00010001 00010101 or 01010101.''. It has offset $1$ and begins
\[
183, 402, 1408, 3908, 13040, 35934, 121313, 333722,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 12:14:06, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-2) + 35\,a(n-4) + 47\,a(n-6) - 39\,a(n-8) - 15\,a(n-10) - 71\,a(n-12) + 169\,a(n-14) - 113\,a(n-16) + 39\,a(n-18) - 10\,a(n-20) + a(n-22) + a(n-24)
\]
for every $n>25$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A261110.
