...
\title{A condition on each element and its neighbours: OEIS A240644}
...
\begin{abstract}
OEIS A240644 carries an empirical recurrence of order $20$ contributed by R.~H.~Hardin. It is
...
OEIS A240644 is ``Number of nX3 0..1 arrays with no element equal to the same number of vertical neighbors as horizontal neighbors, with new values 0..1 introduced in row major order.''. It has offset $1$ and begins
\[
1, 2, 6, 8, 23, 60, 149, 396,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 11:04:25, revision 6) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{The count is a walk count}

The entry counts arrays with $3$ columns over the alphabet $\{0,1\}$, growing one row at a time. Its condition is that every element must equal a different number of its vertical neighbours than it does of its horizontal neighbours.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A240644.
