...
\title{The empirical recurrence for OEIS A234764, proved by transfer matrix}
...
\begin{abstract}
OEIS A234764 counts arrays of width $4$ over $\{0,1,2,3\}$ subject to a condition read round the
...
OEIS A234764 is ``Number of (n+1)X(3+1) 0..3 arrays with 2X2 edge jumps all no more than +1 in one of the clockwise or counterclockwise directions but not both.''. It has offset $1$ and begins
\[
916, 9404, 71280, 760072, 6340684, 65760368, 570633100, 5760421980,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 08:24:59, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234764.
