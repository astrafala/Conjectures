...
\title{The empirical recurrence for OEIS A259768, proved by transfer matrix}
...
\begin{abstract}
OEIS A259768 counts $(n+2)\times6$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A259768 is ``Number of (n+2)X(4+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000001 or 00000101.''. It has offset $1$ and begins
\[
201, 299, 385, 451, 474, 835, 872, 968,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-7) +5*a(n-10) +a(n-13) -a(n-14) -a(n-17) -2*a(n-21) for n>24
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:55:10, revision 6) this is still
...
\[
\text{the clockwise perimeter word of }g\text{ is a rotation of one of }\{00000001,\ 00000101\}
\]
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-7) + 5\,a(n-10) + a(n-13) - a(n-14) - a(n-17) - 2\,a(n-21)
\]
for every $n>24$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A259768.
