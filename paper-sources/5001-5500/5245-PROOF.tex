...
\title{The empirical recurrence for OEIS A202884, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A202884 counts arrays over $\{0,\dots,2\}$ in which every cell is constrained by the
...
OEIS A202884 is ``Number of nX3 0..2 arrays with every nonzero element less than or equal to some horizontal or vertical neighbor.''. It has offset $1$ and begins
\[
9, 265, 5493, 109119, 2223723, 45332961, 922352267, 18770352883,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 19 2023 09:39:49, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;22\,a(n-1) - 73\,a(n-2) + 857\,a(n-3) - 1769\,a(n-4) + 12671\,a(n-5) + 21249\,a(n-6) + 11663\,a(n-7) - 43772\,a(n-8) - 233931\,a(n-9) - 841906\,a(n-10) - 520038\,a(n-11) - 711742\,a(n-12) + 722084\,a(n-13) + 4070420\,a(n-14) + 788112\,a(n-15) - 3390432\,a(n-16) - 1162224\,a(n-17) + 645120\,a(n-18) + 248832\,a(n-19)
\end{equation}
for all $n>20$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A202884.
