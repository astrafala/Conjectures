...
\title{A condition on each element and its neighbours: OEIS A183438}
...
\begin{abstract}
OEIS A183438 carries an empirical recurrence of order $21$ contributed by R.~H.~Hardin. It is
...
walks in it. Hence $a(n)$ is a walk count on $S=25$ vertices and is $C$-finite, and whether the
...
OEIS A183438 is ``Number of nX5 binary arrays with every 1 having exactly one king-move neighbor equal to 1.''. It has offset $1$ and begins
\[
6, 69, 273, 1620, 10459, 56472, 329520, 1939754,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 01:43:21, revision 9) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{The count is a walk count}

The entry counts arrays with $5$ columns over the alphabet $\{0,1\}$, growing one row at a time. Its condition is that every entry equal to $1$ must have exactly $1$ of its eight king-move neighbours equal to $1$.
...
Vertices with identical futures are merged, which leaves $S=25$. An admissible array is exactly a walk, so with $M$ the adjacency matrix and $\iota,\tau$ the vectors recording which states may begin and end an array,
\[
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 8\,a(n-2) + 81\,a(n-3) + 17\,a(n-4) + 37\,a(n-5) - 840\,a(n-6) - 78\,a(n-7) - 399\,a(n-8) + 3112\,a(n-9) - 36\,a(n-10) - 197\,a(n-11) - 2333\,a(n-12) - 287\,a(n-13) + 99\,a(n-14) + 1081\,a(n-15) - 46\,a(n-16) - 51\,a(n-17) - 230\,a(n-18) + 20\,a(n-19) + 9\,a(n-20) + 30\,a(n-21)
\]
for every $n>21$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A183438.
