...
\title{The empirical recurrence for OEIS A252203, proved by transfer matrix}
...
\begin{abstract}
OEIS A252203 counts $(n+2)\times3$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
every $3\times3$ subblock, and it carries an empirical recurrence of order $21$
...
OEIS A252203 is ``Number of (n+2)X(1+2) 0..3 arrays with every 3X3 subblock row and column sum equal to 1 3 4 6 or 7 and every 3X3 diagonal and antidiagonal sum not equal to 1 3 4 6 or 7.''. It has offset $1$ and begins
\[
2680, 4743, 9312, 19794, 51024, 125554, 278710, 763726,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 10:55:47, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + a(n-2) + 33\,a(n-3) - 31\,a(n-4) - 35\,a(n-5) - 288\,a(n-6) + 218\,a(n-7) + 385\,a(n-8) + 255\,a(n-9) + 417\,a(n-10) - 1371\,a(n-11) - 54\,a(n-12) - 992\,a(n-13) + 1178\,a(n-14) + 1150\,a(n-15) - 740\,a(n-16) + 320\,a(n-17) - 476\,a(n-18) - 448\,a(n-19) + 512\,a(n-20) - 64\,a(n-21)
\]
for every $n>26$.
\end{theorem}

\begin{proof}
The vector $w=q(M)\mathbf{1}$ was formed by $21$ matrix--vector products in exact
integer arithmetic and $\mathbf{1}^{\!\top}M^{j}w$ evaluated for $j=0,1,\dots$, again
exactly. Those integers vanish from the index corresponding to $n=26+1$ onwards, and the
run was continued until the working vector was identically zero, which settles all larger $j$
at once. By Lemma~\ref{lem:crit} the recurrence holds for every $n>26$.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252203.
