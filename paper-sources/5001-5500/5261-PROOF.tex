...
\title{The empirical recurrence for OEIS A259996, proved by transfer matrix}
...
\begin{abstract}
OEIS A259996 counts $(n+2)\times5$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A259996 is ``Number of (n+2)X(3+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000001 00000011 or 00000101.''. It has offset $1$ and begins
\[
284, 805, 2532, 6157, 13562, 39209, 112570, 265595,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:57:51, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;12\,a(n-3) + 22\,a(n-4) - 31\,a(n-6) - 66\,a(n-7) + 42\,a(n-8) + 22\,a(n-9) + 114\,a(n-10) - 169\,a(n-11) + 417\,a(n-12) - 218\,a(n-13) + 439\,a(n-14) - 585\,a(n-15) - 36\,a(n-16) - 74\,a(n-17) + 54\,a(n-18) + 90\,a(n-19)
\]
for every $n>22$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A259996.
