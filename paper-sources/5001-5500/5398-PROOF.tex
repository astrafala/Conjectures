...
\title{The empirical recurrence for OEIS A301664, proved by transfer matrix}
...
\begin{abstract}
OEIS A301664 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A301664 is ``Number of nX3 0..1 arrays with every element equal to 1, 2 or 4 horizontally or vertically adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 10, 30, 118, 407, 1498, 5289, 19184,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 25 2018 11:35:06, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 6\,a(n-2) - 2\,a(n-4) + 2\,a(n-5) - 9\,a(n-6) - 50\,a(n-7) - 37\,a(n-8) + 34\,a(n-9) + 43\,a(n-10) - 16\,a(n-11) + 15\,a(n-12) + 18\,a(n-13) - 7\,a(n-14) - 2\,a(n-16) + 4\,a(n-17) - 6\,a(n-18) + a(n-20)
\end{equation}
for all $n>20$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A301664.
