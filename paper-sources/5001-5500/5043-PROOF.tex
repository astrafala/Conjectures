...
\title{The empirical recurrence for OEIS A207705, proved by transfer matrix}
...
\begin{abstract}
OEIS A207705 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
...
OEIS A207705 is ``Number of 4Xn 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 0 1 and 1 1 0 vertically.''. It has offset
$1$ and begins
\[
8, 64, 216, 729, 3321, 15129, 61254,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:11:30, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 14\,a(n-3) + 48\,a(n-4) - 65\,a(n-5) - 41\,a(n-6) - 103\,a(n-7) - 351\,a(n-8) + 353\,a(n-9) + 286\,a(n-10) + 103\,a(n-11) + 629\,a(n-12) - 480\,a(n-13) - 280\,a(n-14) - 16\,a(n-15) - 367\,a(n-16) + 216\,a(n-17) + 46\,a(n-18) + 2\,a(n-19) + 53\,a(n-20) - 28\,a(n-21) - 2\,a(n-22) - 2\,a(n-24) + a(n-25)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207705.
