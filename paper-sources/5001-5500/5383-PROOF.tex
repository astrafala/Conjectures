...
\title{The empirical recurrence for OEIS A260924, proved by transfer matrix}
...
\begin{abstract}
OEIS A260924 counts $(n+2)\times7$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A260924 is ``Number of (n+2)X(5+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00010101 00101011 or 01010101.''. It has offset $1$ and begins
\[
297, 468, 1800, 4522, 11608, 27582, 82766, 191474,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 12:12:39, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 31\,a(n-4) - 31\,a(n-5) + 97\,a(n-6) - 97\,a(n-7) + 39\,a(n-8) - 39\,a(n-9) - 144\,a(n-10) + 144\,a(n-11) - 29\,a(n-12) + 29\,a(n-13) + 189\,a(n-14) - 189\,a(n-15) - 125\,a(n-16) + 125\,a(n-17) - 14\,a(n-18) + 14\,a(n-19) + 40\,a(n-20) - 40\,a(n-21) - 13\,a(n-22) + 13\,a(n-23) - a(n-24) + a(n-25) + a(n-26) - a(n-27)
\]
for every $n>28$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A260924.
