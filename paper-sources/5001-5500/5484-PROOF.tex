...
\title{The empirical recurrence for OEIS A260923, proved by transfer matrix}
...
\begin{abstract}
OEIS A260923 counts $(n+2)\times6$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A260923 is ``Number of (n+2)X(4+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00010101 00101011 or 01010101.''. It has offset $1$ and begins
\[
186, 279, 896, 2208, 4522, 10617, 25690, 58606,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 12:12:32, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-2) + 18\,a(n-4) + 32\,a(n-6) - 7\,a(n-8) - 33\,a(n-10) + 13\,a(n-12) + 25\,a(n-14) - 28\,a(n-16) + 9\,a(n-18) - a(n-20)
\]
for every $n>22$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A260923.
