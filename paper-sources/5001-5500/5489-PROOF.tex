...
\title{The empirical recurrence for OEIS A237236, proved by transfer matrix}
...
\begin{abstract}
OEIS A237236 counts arrays over $\{0,\dots,3\}$ subject to a condition on the order
...
The condition is local to two consecutive rows, so the count is a walk count on $S=242$
...
OEIS A237236 is ``Number of (n+1)X(2+1) 0..3 arrays with the maximum plus the lower median minus the upper median minus the minimum of every 2X2 subblock equal.''. It has offset $1$ and begins
\[
1280, 10304, 91744, 853152, 8036672, 76825568, 738844928, 7176050400,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 10:00:25, revision 6) this is still
...
array, which is not among the objects counted. There are $S=242$ states left.
...
\begin{theorem}
\[
a(n)\;=\;27\,a(n-1) - 91\,a(n-2) - 3569\,a(n-3) + 35156\,a(n-4) + 49666\,a(n-5) - 1874168\,a(n-6) + 4352300\,a(n-7) + 38774384\,a(n-8) - 177907576\,a(n-9) - 291750128\,a(n-10) + 2804232800\,a(n-11) - 1221147328\,a(n-12) - 21414085888\,a(n-13) + 34643343872\,a(n-14) + 71205959680\,a(n-15) - 216011419648\,a(n-16) - 11342790656\,a(n-17) + 524108857344\,a(n-18) - 420200841216\,a(n-19) - 327413137408\,a(n-20) + 579833167872\,a(n-21) - 214563815424\,a(n-22)
\]
for every $n>22$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237236.
