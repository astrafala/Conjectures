...
\title{The empirical recurrence for OEIS A254580, proved by transfer matrix}
...
\begin{abstract}
OEIS A254580 counts the arrays over $\{0,\dots,1\}$ whose $3\times3$ subblocks carry a
...
OEIS A254580 is ``Number of (n+2)X(2+2) 0..1 arrays with every 3X3 subblock sum of the two medians of the central row and the central column and the two maximums of the diagonal and antidiagonal nondecreasing horizontally, vertically and ne-to-sw antidiagonally.''. It has offset $1$ and begins
\[
2868, 17125, 110259, 649029, 3699505, 20636376, 113625185, 620711336,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 14:50:46, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;12\,a(n-1) - 48\,a(n-2) + 79\,a(n-3) - 92\,a(n-4) + 142\,a(n-5) + 32\,a(n-6) - 478\,a(n-7) + 621\,a(n-8) - 532\,a(n-9) + 163\,a(n-10) + 663\,a(n-11) - 1420\,a(n-12) + 897\,a(n-13) + 747\,a(n-14) - 1090\,a(n-15) + 563\,a(n-16) + 93\,a(n-17) - 976\,a(n-18) + 633\,a(n-19) + 361\,a(n-20) - 596\,a(n-21) + 82\,a(n-22) + 193\,a(n-23) - 32\,a(n-24) - 16\,a(n-25)
\]
for every $n>30$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A254580.
