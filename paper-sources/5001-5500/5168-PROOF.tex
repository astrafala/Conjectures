...
\title{The empirical recurrence for OEIS A198008, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A198008 counts arrays over $\{0,\dots,4\}$ in which every cell is constrained by the
...
OEIS A198008 is ``Number of n X 3 0..4 arrays with each element x equal to the number its horizontal and vertical neighbors equal to 3,3,0,1,2 for x=0,1,2,3,4.''. It has offset $1$ and begins
\[
2, 12, 51, 182, 753, 3061, 12503, 51668,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 23 2026 13:22:40, revision 11) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 3\,a(n-2) + 23\,a(n-3) + 13\,a(n-4) - 9\,a(n-5) - 109\,a(n-6) - 98\,a(n-7) + 122\,a(n-8) + 332\,a(n-9) + 155\,a(n-10) - 557\,a(n-11) - 826\,a(n-12) - 13\,a(n-13) + 838\,a(n-14) + 800\,a(n-15) + 163\,a(n-16) - 309\,a(n-17) - 307\,a(n-18) - 142\,a(n-19) - 51\,a(n-20) - 45\,a(n-21) + 32\,a(n-22) + 12\,a(n-23) - 4\,a(n-24)
\end{equation}
for all $n>25$.
...
\#\{\text{neighbours with value }f(x_{t,u})\}=x_{t,u},\quad f=(3,3,0,1,2)
\end{equation}
for every cell $(t,u)$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A198008.
