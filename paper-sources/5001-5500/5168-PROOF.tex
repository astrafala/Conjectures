...
\title{The empirical recurrence for OEIS A189265, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A189265 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A189265 is ``Number of 3Xn binary arrays without the pattern 0 0 1 diagonally, antidiagonally or horizontally.''. It has offset $1$ and begins
\[
8, 64, 280, 1156, 4720, 18960, 74869, 293495,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 05:07:43, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) + 4\,a(n-2) - 71\,a(n-3) + 33\,a(n-4) + 318\,a(n-5) - 222\,a(n-6) - 671\,a(n-7) + 384\,a(n-8) + 626\,a(n-9) + 97\,a(n-10) - 36\,a(n-11) - 926\,a(n-12) - 422\,a(n-13) + 858\,a(n-14) + 428\,a(n-15) - 119\,a(n-16) - 274\,a(n-17) - 183\,a(n-18) + 127\,a(n-19) + 86\,a(n-20) - 35\,a(n-21) - 11\,a(n-22) + 4\,a(n-23)
\end{equation}
for all $n>26$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A189265.
