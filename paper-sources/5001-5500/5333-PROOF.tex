...
\title{The empirical recurrence for OEIS A237891, proved by transfer matrix}
...
\begin{abstract}
OEIS A237891 counts arrays over $\{0,\dots,3\}$ subject to a condition on the order
...
The condition is local to two consecutive rows, so the count is a walk count on $S=44$
...
OEIS A237891 is ``Number of (n+1)X(1+1) 0..3 arrays with the maximum minus the upper median of every 2X2 subblock equal.''. It has offset $1$ and begins
\[
256, 1848, 13600, 103536, 789664, 6082368, 46779520, 361265248,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 10:32:42, revision 7) this is still
...
array, which is not among the objects counted. There are $S=44$ states left.
...
\begin{theorem}
\[
a(n)\;=\;16\,a(n-1) - 1056\,a(n-3) + 3004\,a(n-4) + 23416\,a(n-5) - 88096\,a(n-6) - 240560\,a(n-7) + 1022032\,a(n-8) + 1305632\,a(n-9) - 5841664\,a(n-10) - 4008768\,a(n-11) + 17716928\,a(n-12) + 6995840\,a(n-13) - 28273408\,a(n-14) - 6652672\,a(n-15) + 21161472\,a(n-16) + 3426816\,a(n-17) - 4948992\,a(n-18) - 1188864\,a(n-19)
\]
for every $n>19$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237891.
