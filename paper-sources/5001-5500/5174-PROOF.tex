...
\title{The empirical recurrence for OEIS A188502, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A188502 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A188502 is ``Number of nX3 binary arrays without the pattern 0 1 0 diagonally, vertically or horizontally.''. It has offset $1$ and begins
\[
7, 49, 229, 971, 4351, 20124, 92597, 423074,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 04:28:27, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;7\,a(n-1) - 21\,a(n-2) + 59\,a(n-3) - 82\,a(n-4) + 97\,a(n-5) - 14\,a(n-6) - 148\,a(n-7) + 166\,a(n-8) - 153\,a(n-9) - 158\,a(n-10) + 340\,a(n-11) + 164\,a(n-12) - 296\,a(n-13) - 87\,a(n-14) + 115\,a(n-15) + 13\,a(n-16) - a(n-17) + 6\,a(n-18) - 5\,a(n-19) - 6\,a(n-20) + 4\,a(n-21) + a(n-23)
\end{equation}
for all $n>24$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A188502.
