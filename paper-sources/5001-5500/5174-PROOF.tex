...
\title{The white squares of a board: OEIS A230650}
...
\begin{abstract}
OEIS A230650 carries an empirical recurrence of order $23$ contributed by R.~H.~Hardin. It is
...
walks in it. Hence $a(n)$ is a walk count on $S=30$ vertices and is $C$-finite, and whether the
...
OEIS A230650 is ``Number of nX6 0..2 white square subarrays x(i,j) with each element diagonally or antidiagonally next to at least one element with value 2-x(i,j).''. It has offset $1$ and begins
\[
0, 33, 177, 2547, 28161, 337977, 3951657, 46564959,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 08:43:59, revision 6) this is still
...
Merging vertices with identical futures leaves $S=30$. An admissible board is exactly a walk, so with $M$ the adjacency matrix and $\iota,\tau$ the vectors recording which states may begin and end a board,
\[
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-1) + 50\,a(n-2) - 22\,a(n-3) - 437\,a(n-4) - 1133\,a(n-5) - 548\,a(n-6) + 2623\,a(n-7) + 5757\,a(n-8) + 6227\,a(n-9) - 194\,a(n-10) - 2664\,a(n-11) - 3827\,a(n-12) + 2327\,a(n-13) - 5991\,a(n-14) - 4452\,a(n-15) - 3865\,a(n-16) - 6535\,a(n-17) - 536\,a(n-18) - 639\,a(n-19) - 373\,a(n-20) - 29\,a(n-21) + 76\,a(n-22) - 16\,a(n-23)
\]
for every $n>24$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A230650.
