...
\title{The empirical recurrence for OEIS A297015, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297015 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A297015 is ``Number of nX3 0..1 arrays with each 1 adjacent to 3, 4 or 6 king-move neighboring 1s.''. It has offset $1$ and begins
\[
1, 3, 8, 14, 39, 135, 400, 1310,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 23 2017 15:02:17, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 5\,a(n-2) + 22\,a(n-3) - 3\,a(n-4) - 80\,a(n-5) - 161\,a(n-6) - 18\,a(n-7) + 288\,a(n-8) + 466\,a(n-9) + 118\,a(n-10) - 275\,a(n-11) - 312\,a(n-12) + 63\,a(n-13) + 36\,a(n-14) - 124\,a(n-15) - 134\,a(n-16) + 22\,a(n-17) + 68\,a(n-18) - 17\,a(n-19) - 20\,a(n-20)
\end{equation}
for all $n>21$.
...
x_{t,u}=1\ \Rightarrow\ \#\{\text{neighbours equal to }1\}\in\{3,4,6\}
\end{equation}
for every cell $(t,u)$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297015.
