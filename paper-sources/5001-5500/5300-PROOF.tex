...
\title{The empirical recurrence for OEIS A207369, proved by transfer matrix}
...
\begin{abstract}
OEIS A207369 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
$(0,0,1), (0,1,1)$ along one axis and $(0,0,0), (0,1,1)$ along the other, and carries an empirical recurrence of
...
OEIS A207369 is ``Number of 4Xn 0..1 arrays avoiding 0 0 0 and 0 1 1 horizontally and 0 0 1 and 0 1 1 vertically.''. It has offset
$1$ and begins
\[
9, 81, 225, 784, 2304, 5625, 14641,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 13:49:50, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) - a(n-2) - 8\,a(n-3) - 10\,a(n-4) + 30\,a(n-5) + 11\,a(n-6) - 15\,a(n-7) - 43\,a(n-8) + 21\,a(n-9) - 5\,a(n-10) + 26\,a(n-11) + a(n-12) + 27\,a(n-13) - 42\,a(n-14) + 3\,a(n-15) - 14\,a(n-16) + 15\,a(n-17) - 9\,a(n-18) + 17\,a(n-19) - 6\,a(n-20) + 2\,a(n-21) - 4\,a(n-22) + 2\,a(n-23) - 2\,a(n-24) + a(n-25)
\end{equation}
...
$(0,0,1), (0,1,1)$ as $3$ consecutive entries. There are $9$ admissible columns; that condition
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207369.
