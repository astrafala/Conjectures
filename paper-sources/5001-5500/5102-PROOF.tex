...
\title{The empirical recurrence for OEIS A186162, proved by transfer matrix}
...
\begin{abstract}
OEIS A186162 counts $n\times3$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A186162 is ``1/4 the number of nX3 0..3 arrays with every element equal to exactly one or two of its horizontal and vertical neighbors.''. It has offset $1$ and begins
\[
1, 48, 702, 14364, 253341, 4762206, 87054174, 1610684397,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 03:27:08, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;12\,a(n-1) + 138\,a(n-2) - 297\,a(n-3) - 1095\,a(n-4) - 588\,a(n-5) + 4871\,a(n-6) + 10632\,a(n-7) - 24375\,a(n-8) + 40893\,a(n-9) - 59724\,a(n-10) - 68247\,a(n-11) - 358891\,a(n-12) + 1270395\,a(n-13) + 391440\,a(n-14) - 2188134\,a(n-15) + 133083\,a(n-16) + 1270323\,a(n-17) + 3453273\,a(n-18) + 1073817\,a(n-19) - 5417199\,a(n-20) - 4448358\,a(n-21) - 13463172\,a(n-22) - 12754584\,a(n-23)
\]
for every $n>23$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A186162.
