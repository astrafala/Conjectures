...
\title{The empirical recurrence for OEIS A237061, proved by transfer matrix}
...
\begin{abstract}
OEIS A237061 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
The condition is local to two consecutive rows, so the count is a walk count on $S=80$
...
OEIS A237061 is ``Number of (n+1) X (2+1) 0..2 arrays with the maximum plus the upper median plus the minimum minus the lower median of every 2 X 2 subblock equal.''. It has offset $1$ and begins
\[
255, 1101, 5034, 25451, 132095, 723774, 3983941, 22797711,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 25 2023 22:39:23, revision 6) this is still
...
array, which is not among the objects counted. There are $S=80$ states left.
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-1) + 41\,a(n-2) - 446\,a(n-3) - 123\,a(n-4) + 7323\,a(n-5) - 4271\,a(n-6) - 59999\,a(n-7) + 45046\,a(n-8) + 286308\,a(n-9) - 194469\,a(n-10) - 837761\,a(n-11) + 441540\,a(n-12) + 1512121\,a(n-13) - 564301\,a(n-14) - 1656226\,a(n-15) + 420594\,a(n-16) + 1074464\,a(n-17) - 181800\,a(n-18) - 395488\,a(n-19) + 41584\,a(n-20) + 75456\,a(n-21) - 3840\,a(n-22) - 5760\,a(n-23)
\]
for every $n>23$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237061.
