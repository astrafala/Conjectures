...
\title{The empirical recurrence for OEIS A207722, proved by transfer matrix}
...
\begin{abstract}
OEIS A207722 counts arrays over $\{0,\dots,1\}$ of width $7$ that avoid the patterns
...
OEIS A207722 is ``Number of 7Xn 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 0 1 and 1 0 0 vertically.''. It has offset
$1$ and begins
\[
35, 1225, 20265, 383845, 7070805, 131365535, 2433018665,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:12:59, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;9\,a(n-1) + 204\,a(n-2) - 218\,a(n-3) - 5837\,a(n-4) + 7253\,a(n-5) + 53229\,a(n-6) - 91405\,a(n-7) - 159544\,a(n-8) + 385275\,a(n-9) + 60956\,a(n-10) - 516325\,a(n-11) + 117854\,a(n-12) + 297983\,a(n-13) - 97139\,a(n-14) - 89135\,a(n-15) + 26027\,a(n-16) + 14356\,a(n-17) - 2512\,a(n-18) - 1087\,a(n-19) + 37\,a(n-20) + 20\,a(n-21)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207722.
