...
\title{The empirical recurrence for OEIS A259769, proved by transfer matrix}
...
\begin{abstract}
OEIS A259769 counts $(n+2)\times7$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A259769 is ``Number of (n+2) X (5+2) 0..1 arrays with each 3 X 3 subblock having clockwise perimeter pattern 00000001 or 00000101.''. It has offset $1$ and begins
\[
376, 564, 612, 474, 400, 798, 524, 450,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-7) -2*a(n-21) +a(n-28) for n>34.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 18 2023 15:02:42, revision 6) this is still
...
at once. By Lemma~\ref{lem:crit} the recurrence holds for every $n>34$. The bound is exact: at $n=34$ the recurrence fails on the entry's own published terms, so no larger range holds.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A259769.
