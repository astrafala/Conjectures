...
\title{A condition on each element and its neighbours: OEIS A241134}
...
\begin{abstract}
OEIS A241134 carries an empirical recurrence of order $26$ contributed by R.~H.~Hardin. It is
...
OEIS A241134 is ``Number of nX3 0..2 arrays with no element equal to the same number of vertical neighbors as horizontal neighbors, with new values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
1, 5, 24, 152, 935, 6150, 40504, 269481,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 11:11:26, revision 6) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{The count is a walk count}

The entry counts arrays with $3$ columns over the alphabet $\{0,1,2\}$, growing one row at a time. Its condition is that every element must equal a different number of its vertical neighbours than it does of its horizontal neighbours.
...
Vertices with identical futures are merged, which leaves $S=27$. An admissible array is exactly a walk, so with $M$ the adjacency matrix and $\iota,\tau$ the vectors recording which states may begin and end an array,
\[
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-1) + 3\,a(n-2) - 21\,a(n-3) - 45\,a(n-4) - 293\,a(n-5) - 87\,a(n-6) + 857\,a(n-7) + 2153\,a(n-8) + 3773\,a(n-9) + 501\,a(n-10) - 1147\,a(n-11) - 4888\,a(n-12) - 15704\,a(n-13) + 1372\,a(n-14) - 4728\,a(n-15) + 4720\,a(n-16) + 1656\,a(n-17) - 59632\,a(n-18) - 55392\,a(n-19) - 57664\,a(n-20) - 22400\,a(n-21) - 2304\,a(n-22) - 19456\,a(n-23) - 47104\,a(n-24) - 114688\,a(n-25) - 65536\,a(n-26)
\]
for every $n>27$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A241134.
