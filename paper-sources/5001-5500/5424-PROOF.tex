...
\title{The empirical recurrence for OEIS A233619, proved by transfer matrix}
...
\begin{abstract}
OEIS A233619 counts arrays of width $3$ over $\{0,1,2\}$ containing no run of $3$ consecutive
...
OEIS A233619 is ``Number of (1+2)X(n+2) 0..2 arrays with no increasing sequence of length 3 horizontally or diagonally downwards.''. It has offset $1$ and begins
\[
17064, 395955, 9120456, 209902869, 4828862487, 111082137228, 2555252447715, 58778922784197,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 08:07:43, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A233619.
