...
\title{The empirical recurrence for OEIS A204834, proved by transfer matrix}
...
\begin{abstract}
OEIS A204834 counts arrays over $\{0,\dots,2\}$ under a condition on the permanent of every
...
a bounded window of consecutive rows, so the count is a walk count on $S=58$ states and is
...
OEIS A204834 is ``Number of (n+1)X3 0..2 arrays with the permanents of all 2X2 subblocks equal and nonzero.''. It has offset $1$ and begins
\[
132, 524, 1616, 6370, 21380, 81706, 284982, 1068556,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 11:32:46, revision 9) this is still
...
\]
on the $S=58$ states that survive. Rows carrying no edge at all are dropped: such a row could
...
$2\times3$ arrays over $\{0,\dots,2\}$ all of whose subblocks pass. The entry's
first term is $132$, and the model reproduces it along with every later term; that is the
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-1) + 27\,a(n-2) - 272\,a(n-3) - 166\,a(n-4) + 4400\,a(n-5) - 2099\,a(n-6) - 38451\,a(n-7) + 40394\,a(n-8) + 197193\,a(n-9) - 288743\,a(n-10) - 602214\,a(n-11) + 1139080\,a(n-12) + 1038852\,a(n-13) - 2693225\,a(n-14) - 762225\,a(n-15) + 3842539\,a(n-16) - 401148\,a(n-17) - 3143804\,a(n-18) + 1172882\,a(n-19) + 1265630\,a(n-20) - 763476\,a(n-21) - 143344\,a(n-22) + 155436\,a(n-23) - 12496\,a(n-24) - 5304\,a(n-25) + 528\,a(n-26)
\]
for every $n>26$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204834.
