...
\title{The empirical recurrence for OEIS A254841, proved by transfer matrix}
...
\begin{abstract}
OEIS A254841 counts the arrays over $\{0,\dots,1\}$ whose $3\times3$ subblocks carry a
...
OEIS A254841 is ``Number of (n+2)X(4+2) 0..1 arrays with every 3X3 subblock sum of the medians of the diagonal and antidiagonal minus the two sums of the central row and column nondecreasing horizontally and vertically.''. It has offset $1$ and begins
\[
30182, 117706, 340387, 701614, 1308339, 2339906, 3986282, 6690291,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 14:59:09, revision 10) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A254841.
