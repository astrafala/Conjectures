...
\title{The empirical recurrence for OEIS A259294, proved by transfer matrix}
...
\begin{abstract}
OEIS A259294 counts arrays of width $6$ over $\{0,1\}$ subject to a condition read round the
...
OEIS A259294 is ``Number of (n+1)X(5+1) 0..1 arrays with each 2X2 subblock having clockwise pattern 0001 0101 or 0111.''. It has offset $1$ and begins
\[
434, 3938, 31774, 273686, 2293928, 19528726, 165147350, 1402044186,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:50:21, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + 94\,a(n-2) - 260\,a(n-3) - 3104\,a(n-4) + 6922\,a(n-5) + 48854\,a(n-6) - 94118\,a(n-7) - 411428\,a(n-8) + 687376\,a(n-9) + 1991983\,a(n-10) - 2792826\,a(n-11) - 5747356\,a(n-12) + 6404184\,a(n-13) + 9882208\,a(n-14) - 8117120\,a(n-15) - 9774592\,a(n-16) + 5218304\,a(n-17) + 5062656\,a(n-18) - 1310720\,a(n-19) - 1048576\,a(n-20)
\]
for every $n>19$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A259294.
