...
\title{The empirical recurrence for OEIS A203377, proved by transfer matrix}
...
\begin{abstract}
OEIS A203377 counts $(n+1)\times8$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A203377 is ``Number of (n+1)X8 0..1 arrays with every 2X2 subblock having equal diagonal elements or equal antidiagonal elements.''. It has offset $1$ and begins
\[
8748, 323852, 12301020, 471988172, 18189909480, 702420750924, 27149753088792, 1049837466171436,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 10:24:19, revision 9) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A203377.
