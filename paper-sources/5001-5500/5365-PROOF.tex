...
\title{The empirical recurrence for OEIS A197074, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A197074 counts arrays over $\{0,\dots,4\}$ in which every cell is constrained by the
...
OEIS A197074 is ``Number of nX3 0..4 arrays with each element x equal to the number its horizontal and vertical neighbors equal to 3,1,2,4,0 for x=0,1,2,3,4.''. It has offset $1$ and begins
\[
3, 13, 51, 205, 812, 3295, 13286, 53418,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 06:56:50, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 3\,a(n-2) + 18\,a(n-3) + 17\,a(n-4) - 8\,a(n-5) - 38\,a(n-6) - 85\,a(n-7) - 42\,a(n-8) + 81\,a(n-9) + 65\,a(n-10) + 14\,a(n-11) - 24\,a(n-12) - 29\,a(n-13) + 19\,a(n-14) + 18\,a(n-15) - a(n-16) - 3\,a(n-17) - 8\,a(n-18) + 2\,a(n-19)
\end{equation}
for all $n>20$.
...
\#\{\text{neighbours with value }f(x_{t,u})\}=x_{t,u},\quad f=(3,1,2,4,0)
\end{equation}
for every cell $(t,u)$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A197074.
