...
\title{The empirical recurrence for OEIS A260470, proved by transfer matrix}
...
\begin{abstract}
OEIS A260470 counts $(n+2)\times5$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
every $3\times3$ subblock, and it carries an empirical recurrence of order $19$
...
OEIS A260470 is ``Number of (n+2)X(3+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000000 00000001 or 00010101.''. It has offset $1$ and begins
\[
103, 213, 658, 1723, 4607, 13198, 36254, 98246,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 12:07:00, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + a(n-2) + 10\,a(n-3) + 4\,a(n-4) - 2\,a(n-5) - 12\,a(n-6) - 5\,a(n-7) - 2\,a(n-8) + 4\,a(n-9) + 4\,a(n-10) - 8\,a(n-11) - 10\,a(n-12) - 8\,a(n-13) + 8\,a(n-14) - a(n-16) + 3\,a(n-17) + 2\,a(n-18) + 2\,a(n-19)
\]
for every $n>22$.
\end{theorem}

\begin{proof}
The vector $w=q(M)\mathbf{1}$ was formed by $19$ matrix--vector products in exact
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A260470.
