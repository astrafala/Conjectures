...
\title{The empirical recurrence for OEIS A207684, proved by transfer matrix}
...
\begin{abstract}
OEIS A207684 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
...
OEIS A207684 is ``Number of 4 X n 0..1 arrays avoiding 0 0 0 and 1 0 1 horizontally and 0 0 1 and 1 1 1 vertically.''. It has offset
$1$ and begins
\[
9, 81, 166, 436, 964, 2132, 4846,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 05 2025 13:38:13, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;12\,a(n-3) + 12\,a(n-4) + 4\,a(n-5) - 54\,a(n-6) - 70\,a(n-7) - 34\,a(n-8) + 148\,a(n-9) + 164\,a(n-10) + 54\,a(n-11) - 237\,a(n-12) - 184\,a(n-13) - 12\,a(n-14) + 234\,a(n-15) + 87\,a(n-16) - 22\,a(n-17) - 126\,a(n-18) - 36\,a(n-19) + 19\,a(n-20) + 32\,a(n-21) + 14\,a(n-22) - 2\,a(n-24)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207684.
