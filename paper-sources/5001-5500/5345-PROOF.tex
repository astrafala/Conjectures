...
\title{The empirical recurrence for OEIS A189260, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A189260 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A189260 is ``Number of nX5 binary arrays without the pattern 0 0 1 diagonally, antidiagonally or horizontally.''. It has offset $1$ and begins
\[
20, 400, 4720, 52748, 552752, 5746968, 59399960, 613358776,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 05:07:06, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;14\,a(n-1) - 30\,a(n-2) - 99\,a(n-3) + 356\,a(n-4) - 2856\,a(n-5) + 8692\,a(n-6) + 17040\,a(n-7) - 65040\,a(n-8) + 142172\,a(n-9) - 523592\,a(n-10) - 577136\,a(n-11) + 4758096\,a(n-12) - 3418384\,a(n-13) - 5978816\,a(n-14) + 8825824\,a(n-15) - 10155968\,a(n-16) + 18636928\,a(n-17) - 17683840\,a(n-18) + 1152\,a(n-19) + 18846208\,a(n-20) - 16343040\,a(n-21) + 1361920\,a(n-22) + 2150400\,a(n-23)
\end{equation}
for all $n>24$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A189260.
