...
\title{The empirical recurrence for OEIS A237219, proved by transfer matrix}
...
\begin{abstract}
OEIS A237219 counts arrays over $\{0,\dots,3\}$ subject to a condition on the order
...
OEIS A237219 is ``Number of (n+1)X(1+1) 0..3 arrays with the maximum plus the lower median minus the upper median of every 2X2 subblock equal.''. It has offset $1$ and begins
\[
256, 1416, 8238, 50998, 324760, 2135910, 14272968, 97077068,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 09:58:57, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;16\,a(n-1) - 8\,a(n-2) - 1098\,a(n-3) + 4586\,a(n-4) + 24400\,a(n-5) - 179753\,a(n-6) - 114082\,a(n-7) + 2989632\,a(n-8) - 3122880\,a(n-9) - 24773900\,a(n-10) + 51198752\,a(n-11) + 103774016\,a(n-12) - 332116608\,a(n-13) - 189089472\,a(n-14) + 1143792096\,a(n-15) - 35184544\,a(n-16) - 2249166912\,a(n-17) + 694237760\,a(n-18) + 2547612544\,a(n-19) - 1068840448\,a(n-20) - 1598213632\,a(n-21) + 687111168\,a(n-22) + 500299776\,a(n-23) - 200097792\,a(n-24) - 60039168\,a(n-25) + 21823488\,a(n-26)
\]
for every $n>26$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237219.
