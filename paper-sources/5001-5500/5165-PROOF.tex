...
\title{The empirical recurrence for OEIS A196962, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A196962 counts arrays over $\{0,\dots,4\}$ in which every cell is constrained by the
...
OEIS A196962 is ``Number of nX3 0..4 arrays with each element x equal to the number its horizontal and vertical neighbors equal to 4,1,2,0,3 for x=0,1,2,3,4.''. It has offset $1$ and begins
\[
3, 15, 101, 562, 3145, 17966, 102080, 579654,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 06:51:19, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 6\,a(n-2) + 39\,a(n-3) + 51\,a(n-4) + 138\,a(n-5) + 64\,a(n-6) + 20\,a(n-7) - 467\,a(n-8) - 492\,a(n-9) - 387\,a(n-10) - 4\,a(n-11) + 151\,a(n-12) - 89\,a(n-13) - 504\,a(n-14) - 447\,a(n-15) + 47\,a(n-16) + 476\,a(n-17) + 586\,a(n-18) + 530\,a(n-19) + 437\,a(n-20) + 422\,a(n-21) + 277\,a(n-22) + 88\,a(n-23) - 16\,a(n-24) - 2\,a(n-25) + 4\,a(n-26) - 2\,a(n-27)
\end{equation}
for all $n>28$.
...
publishes, $n=20$, the arrays have $3\cdot20$ cells over
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A196962.
