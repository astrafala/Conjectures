...
\title{The empirical recurrence for OEIS A236150, proved by transfer matrix}
...
\begin{abstract}
OEIS A236150 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
The condition is local to two consecutive rows, so the count is a walk count on $S=2148$
...
OEIS A236150 is ``Number of (n+1)X(3+1) 0..2 arrays colored with the sets of distinct values in every 2X2 subblock.''. It has offset $1$ and begins
\[
2148, 16128, 146568, 1351296, 12511728, 115757328, 1072589616, 9925448784,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 09:09:12, revision 6) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The $2\times2$ subblocks of an $(n+1)\times4$ array form an
$n\times3$ grid. Colour each of them by the SET of values occurring in it. ``Coloured with'' is the entry's way of
...
\]
over the $S=2148$ pairs whose own subblock row is properly coloured.
...
\begin{theorem}
\[
a(n)\;=\;91\,a(n-2) + 17\,a(n-3) - 555\,a(n-4) - 199\,a(n-5) - 2759\,a(n-6) - 806\,a(n-7) + 12016\,a(n-8) + 8767\,a(n-9) + 37038\,a(n-10) + 23107\,a(n-11) - 30178\,a(n-12) - 50102\,a(n-13) - 64316\,a(n-14) - 22746\,a(n-15) - 28056\,a(n-16) + 29816\,a(n-17) - 137392\,a(n-18) - 67760\,a(n-19) - 1568\,a(n-20) - 11584\,a(n-21) + 3392\,a(n-22) - 192\,a(n-23)
\]
for every $n>26$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A236150.
