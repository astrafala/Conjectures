...
\title{The empirical recurrence for OEIS A317770, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A317770 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A317770 is ``Number of nX5 0..1 arrays with every element unequal to 0, 1 or 3 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
8, 11, 16, 14, 19, 30, 42, 67,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 06 2018 12:12:08, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 6\,a(n-4) - 4\,a(n-5) + 2\,a(n-7) - 11\,a(n-8) + 3\,a(n-9) + 9\,a(n-10) - 13\,a(n-11) + 5\,a(n-12) - 7\,a(n-13) - 24\,a(n-14) + 10\,a(n-15) + 7\,a(n-16) + 9\,a(n-17) + 17\,a(n-18) - 5\,a(n-19) - 8\,a(n-20) + 12\,a(n-21) - a(n-22) + 7\,a(n-23) + 3\,a(n-24) - 3\,a(n-25) + 7\,a(n-26) + 17\,a(n-27) + 4\,a(n-28) - 6\,a(n-29) - 11\,a(n-30) - 15\,a(n-31) - 7\,a(n-32) - a(n-33)
\end{equation}
for all $n>41$.
...
publishes, $n=36$, the arrays have $5\cdot36$ cells over
$2$ values, so there are about $10^{54}$ of them to sift. The
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A317770.
