...
\title{The empirical recurrence for OEIS A260836, proved by transfer matrix}
...
\begin{abstract}
OEIS A260836 counts $(n+2)\times5$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A260836 is ``Number of (n+2)X(3+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000001 00000011 or 00010101.''. It has offset $1$ and begins
\[
188, 288, 700, 1224, 1560, 3470, 6908, 10070,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 12:11:34, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-3) + 6\,a(n-4) - 9\,a(n-6) - 16\,a(n-7) - 10\,a(n-8) + 4\,a(n-9) + 7\,a(n-10) + 6\,a(n-12) + 8\,a(n-14) + 10\,a(n-15) + 2\,a(n-16) + 4\,a(n-17) + 4\,a(n-19) + 3\,a(n-20) + 2\,a(n-22)
\]
for every $n>24$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A260836.
