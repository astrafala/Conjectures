...
\title{The empirical recurrence for OEIS A234654, proved by transfer matrix}
...
\begin{abstract}
OEIS A234654 counts $5$-column arrays over $\{0,\dots,5\}$ in which every
...
OEIS A234654 is ``Number of (n+1) X (4+1) 0..5 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 4 (constant-stress 1 X 1 tilings).''. It has offset
$1$ and begins
\[
15008, 37352, 94432, 274520, 808160, 2646344, 8731840,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 20 2022 19:44:01, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;8\,a(n-1) + 85\,a(n-2) - 820\,a(n-3) - 2645\,a(n-4) + 35720\,a(n-5) + 27415\,a(n-6) - 866260\,a(n-7) + 408982\,a(n-8) + 12858104\,a(n-9) - 16068980\,a(n-10) - 120659920\,a(n-11) + 221967320\,a(n-12) + 709627680\,a(n-13) - 1711158240\,a(n-14) - 2457267840\,a(n-15) + 7901564544\,a(n-16) + 4009471488\,a(n-17) - 21498324480\,a(n-18) + 987863040\,a(n-19) + 31468953600\,a(n-20) - 12541132800\,a(n-21) - 18911232000\,a(n-22) + 11943936000\,a(n-23)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234654.
