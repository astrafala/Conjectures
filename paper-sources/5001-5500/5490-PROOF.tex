...
\title{The empirical recurrence for OEIS A236090, proved by transfer matrix}
...
\begin{abstract}
OEIS A236090 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
The condition is local to two consecutive rows, so the count is a walk count on $S=344$
...
OEIS A236090 is ``Number of (n+1)X(2+1) 0..2 arrays colored with the difference of the maximum and the upper median in each 2X2 subblock.''. It has offset $1$ and begins
\[
344, 1960, 10912, 59398, 321368, 1787690, 9900936, 54118764,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 09:05:33, revision 6) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The $2\times2$ subblocks of an $(n+1)\times3$ array form an
$n\times2$ grid. Colour each of them by $\sigma=-c+d$, where $a\le b\le c\le d$ are its four entries sorted --- its minimum, lower median, upper median and maximum. ``Coloured with'' is the entry's way of
...
\]
over the $S=344$ pairs whose own subblock row is properly coloured.
...
\begin{theorem}
\[
a(n)\;=\;28\,a(n-3) + 591\,a(n-4) + 642\,a(n-5) + 1360\,a(n-6) + 3146\,a(n-7) - 10200\,a(n-8) - 7734\,a(n-9) + 9306\,a(n-10) - 5336\,a(n-11) + 14804\,a(n-12) + 19462\,a(n-13) - 6478\,a(n-14) - 2372\,a(n-15) + 3016\,a(n-16) + 2772\,a(n-17) + 24\,a(n-18) - 582\,a(n-19) - 53\,a(n-20)
\]
for every $n>22$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A236090.
