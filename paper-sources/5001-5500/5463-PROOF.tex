...
\title{The empirical recurrence for OEIS A189259, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A189259 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A189259 is ``Number of nX4 binary arrays without the pattern 0 0 1 diagonally, antidiagonally or horizontally.''. It has offset $1$ and begins
\[
12, 144, 1156, 8900, 65760, 481552, 3510380, 25556548,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 05:06:59, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;9\,a(n-1) - 9\,a(n-2) - 27\,a(n-3) + 62\,a(n-4) - 522\,a(n-5) + 730\,a(n-6) + 2202\,a(n-7) - 3620\,a(n-8) + 5768\,a(n-9) - 7920\,a(n-10) - 45696\,a(n-11) + 71680\,a(n-12) + 75424\,a(n-13) - 146112\,a(n-14) + 13984\,a(n-15) + 51072\,a(n-16) - 17024\,a(n-17)
\end{equation}
for all $n>18$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A189259.
