...
\title{The empirical recurrence for OEIS A260280, proved by transfer matrix}
...
\begin{abstract}
OEIS A260280 counts $(n+2)\times6$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A260280 is ``Number of (n+2)X(4+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000000 00000001 or 00001011.''. It has offset $1$ and begins
\[
202, 525, 2027, 6044, 18380, 60955, 192277, 595506,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 12:04:32, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 24\,a(n-3) + 6\,a(n-4) + 6\,a(n-5) - 134\,a(n-6) - 100\,a(n-7) - 15\,a(n-8) + 357\,a(n-9) + 227\,a(n-10) + 71\,a(n-11) - 416\,a(n-12) - 300\,a(n-13) - 66\,a(n-14) + 222\,a(n-15) + 159\,a(n-16) + 41\,a(n-17) - 61\,a(n-18) - 31\,a(n-19) + 6\,a(n-21)
\]
for every $n>26$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A260280.
