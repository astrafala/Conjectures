...
\title{The empirical recurrence for OEIS A296958, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A296958 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A296958 is ``Number of nX3 0..1 arrays with each 1 adjacent to 2, 3 or 5 king-move neighboring 1s.''. It has offset $1$ and begins
\[
1, 16, 60, 177, 869, 3994, 16348, 71669,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 22 2017 11:36:23, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) - 10\,a(n-2) + 35\,a(n-3) - 116\,a(n-4) + 105\,a(n-5) - 196\,a(n-6) + 548\,a(n-7) - 320\,a(n-8) + 279\,a(n-9) - 955\,a(n-10) + 520\,a(n-11) + 159\,a(n-12) + 545\,a(n-13) - 530\,a(n-14) - 236\,a(n-15) + 188\,a(n-16) + 22\,a(n-17) + 6\,a(n-18) - 40\,a(n-19) + 25\,a(n-20) - 2\,a(n-21)
\end{equation}
for all $n>22$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A296958.
