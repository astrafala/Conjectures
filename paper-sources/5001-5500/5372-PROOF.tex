...
\title{The empirical recurrence for OEIS A237940, proved by transfer matrix}
...
\begin{abstract}
OEIS A237940 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
statistics of every $2\times2$ subblock, and carries an empirical recurrence of order
$23$ contributed by R.~H.~Hardin. It is true, and it is decidable rather than empirical.
The condition is local to two consecutive rows, so the count is a walk count on $S=125$
...
OEIS A237940 is ``Number of (n+1)X(3+1) 0..2 arrays with the maximum minus the minimum of every 2X2 subblock equal.''. It has offset $1$ and begins
\[
2417, 70435, 2020033, 61286941, 1871339377, 57597474709, 1776214151413, 54843034007201,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 10:37:01, revision 6) this is still
...
array, which is not among the objects counted. There are $S=125$ states left.
...
\begin{theorem}
\[
a(n)\;=\;39\,a(n-1) - 58\,a(n-2) - 7030\,a(n-3) + 21065\,a(n-4) + 435029\,a(n-5) - 1133100\,a(n-6) - 11041734\,a(n-7) + 26665646\,a(n-8) + 125943418\,a(n-9) - 291658456\,a(n-10) - 685365122\,a(n-11) + 1522606472\,a(n-12) + 1905197584\,a(n-13) - 4027531552\,a(n-14) - 2766833480\,a(n-15) + 5675870464\,a(n-16) + 1922313440\,a(n-17) - 4271600256\,a(n-18) - 377080192\,a(n-19) + 1576797696\,a(n-20) - 161140224\,a(n-21) - 210014208\,a(n-22) + 47554560\,a(n-23)
\]
for every $n>23$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237940.
