...
\title{The empirical recurrence for OEIS A300375, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A300375 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A300375 is ``Number of nX3 0..1 arrays with every element equal to 0, 2 or 3 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
1, 2, 4, 11, 8, 58, 131, 306,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 04 2018 09:16:23, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-2) + 9\,a(n-3) + 9\,a(n-4) + 3\,a(n-5) - 8\,a(n-6) - a(n-7) - 18\,a(n-8) - 24\,a(n-9) - 45\,a(n-10) - 10\,a(n-11) - 15\,a(n-12) + 39\,a(n-13) - 21\,a(n-14) + 9\,a(n-15) - 7\,a(n-16) - 13\,a(n-17) + 14\,a(n-18) - 5\,a(n-19) + 3\,a(n-20) - 2\,a(n-22) + a(n-23)
\end{equation}
for all $n>25$.
...
publishes, $n=29$, the arrays have $3\cdot29$ cells over
...
The threshold below is exact rather than merely sufficient: at $n=25$ the conjectured
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A300375.
