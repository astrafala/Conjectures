...
\title{The empirical recurrence for OEIS A253986, proved by transfer matrix}
...
\begin{abstract}
OEIS A253986 counts the arrays over $\{0,\dots,1\}$ whose $3\times3$ subblocks carry a
...
OEIS A253986 is ``Number of (n+2)X(1+2) 0..1 arrays with every 3X3 subblock diagonal median plus antidiagonal median nondecreasing horizontally, vertically and ne-to-sw antidiagonally.''. It has offset $1$ and begins
\[
512, 2736, 11872, 51856, 222400, 914112, 3644672, 14254784,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 14:23:42, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-1) - 21\,a(n-2) + 30\,a(n-3) - 44\,a(n-4) - 60\,a(n-5) + 252\,a(n-6) - 140\,a(n-7) + 446\,a(n-8) + 340\,a(n-9) - 1082\,a(n-10) + 32\,a(n-11) - 1048\,a(n-12) - 844\,a(n-13) + 1800\,a(n-14) + 548\,a(n-15) + 215\,a(n-16) + 324\,a(n-17) - 293\,a(n-18) - 54\,a(n-19) - 24\,a(n-21) + 16\,a(n-22)
\]
for every $n>22$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253986.
