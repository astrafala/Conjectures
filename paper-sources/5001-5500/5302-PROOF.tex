...
\title{The empirical recurrence for OEIS A231758, proved by transfer matrix}
...
\begin{abstract}
OEIS A231758 counts $(n+1)\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A231758 is ``Number of (n+1)X(2+1) 0..1 arrays with no element having a strict majority of its horizontal, diagonal and antidiagonal neighbors equal to one.''. It has offset $1$ and begins
\[
33, 136, 660, 3213, 14989, 70927, 338352, 1603633,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 06:40:36, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + 47\,a(n-3) - 25\,a(n-4) + 21\,a(n-5) - 403\,a(n-6) + 110\,a(n-7) + 40\,a(n-8) + 1601\,a(n-9) - 348\,a(n-10) - 520\,a(n-11) - 2656\,a(n-12) + 792\,a(n-13) + 288\,a(n-14) + 2480\,a(n-15) - 544\,a(n-16) + 128\,a(n-17) - 1600\,a(n-18) + 128\,a(n-19) + 512\,a(n-21)
\]
for every $n>21$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231758.
