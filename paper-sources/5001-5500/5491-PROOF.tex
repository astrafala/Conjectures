...
\title{The empirical recurrence for OEIS A207919, proved by transfer matrix}
...
\begin{abstract}
OEIS A207919 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
...
OEIS A207919 is ``Number of 4Xn 0..1 arrays avoiding 0 0 0 and 1 0 1 horizontally and 0 1 0 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
10, 100, 358, 1309, 4181, 13759, 46800,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:28:01, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 2\,a(n-2) + 18\,a(n-3) + 15\,a(n-4) - 6\,a(n-5) - 70\,a(n-6) - 96\,a(n-7) - 14\,a(n-8) + 154\,a(n-9) + 147\,a(n-10) - 113\,a(n-12) - 71\,a(n-13) - 9\,a(n-14) + 33\,a(n-15) + 12\,a(n-16) - a(n-17) - 7\,a(n-18) + 3\,a(n-19) + a(n-20) + 2\,a(n-21)
\end{equation}
...
$(0,1,0), (1,0,1)$ as $3$ consecutive entries. There are $10$ admissible columns; that condition
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207919.
