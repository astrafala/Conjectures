...
\title{The empirical recurrence for OEIS A298181, proved by transfer matrix}
...
\begin{abstract}
OEIS A298181 counts $6$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A298181 is ``Number of nX6 0..1 arrays with every element equal to 3, 5, 6 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
0, 5, 5, 10, 27, 53, 114, 257,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 14 2018 09:29:33, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) - 5\,a(n-2) + 8\,a(n-3) - 14\,a(n-4) + 5\,a(n-5) - 17\,a(n-6) + 19\,a(n-7) + 21\,a(n-8) - 2\,a(n-9) + 50\,a(n-10) - 75\,a(n-11) + 28\,a(n-12) - 57\,a(n-13) + 28\,a(n-14) - 52\,a(n-15) + 38\,a(n-16) - 22\,a(n-17) - 12\,a(n-18) + 4\,a(n-19) + 20\,a(n-20) + 8\,a(n-21) - 8\,a(n-22)
\end{equation}
for all $n>22$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A298181.
