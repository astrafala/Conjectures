...
\title{The empirical recurrence for OEIS A295248, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A295248 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A295248 is ``Number of nX3 0..1 arrays with each 1 horizontally or vertically adjacent to 0, 1 or 3 1s.''. It has offset $1$ and begins
\[
7, 35, 183, 948, 4928, 25596, 132993, 690938,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 18 2017 09:31:26, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) + 6\,a(n-2) + a(n-3) + 2\,a(n-4) - 6\,a(n-5) - 6\,a(n-6) - 18\,a(n-7) - 5\,a(n-8) + 3\,a(n-9) + 4\,a(n-11) + a(n-12) + 9\,a(n-13) - a(n-14) + 3\,a(n-15) - 3\,a(n-16) - a(n-18)
\end{equation}
for all $n>19$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A295248.
