...
\title{The empirical recurrence for OEIS A207561, proved by transfer matrix}
...
\begin{abstract}
OEIS A207561 counts arrays over $\{0,\dots,1\}$ of width $5$ that avoid the patterns
...
OEIS A207561 is ``Number of nX5 0..1 arrays avoiding 0 0 1 and 0 1 0 horizontally and 0 1 1 and 1 1 0 vertically.''. It has offset
$1$ and begins
\[
14, 196, 720, 2234, 9568, 36426, 160652,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:04:34, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;12\,a(n-1) - 18\,a(n-2) - 286\,a(n-3) + 990\,a(n-4) + 2420\,a(n-5) - 13219\,a(n-6) - 7318\,a(n-7) + 87016\,a(n-8) - 13474\,a(n-9) - 326656\,a(n-10) + 164320\,a(n-11) + 729389\,a(n-12) - 512204\,a(n-13) - 962042\,a(n-14) + 804466\,a(n-15) + 713562\,a(n-16) - 680852\,a(n-17) - 265049\,a(n-18) + 296838\,a(n-19) + 35044\,a(n-20) - 56802\,a(n-21) + 984\,a(n-22) + 2880\,a(n-23)
\end{equation}
for all $n>24$. 
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207561.
