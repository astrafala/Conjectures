...
\title{The empirical recurrence for OEIS A300501, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A300501 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A300501 is ``Number of nX3 0..1 arrays with every element equal to 0, 1, 3 or 4 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
3, 2, 4, 7, 6, 17, 34, 57,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 07 2018 07:30:28, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-2) + 2\,a(n-3) - 7\,a(n-4) - 8\,a(n-5) - 5\,a(n-6) + 10\,a(n-7) + 34\,a(n-8) + 10\,a(n-9) - 54\,a(n-10) - 52\,a(n-11) + 26\,a(n-12) + 72\,a(n-13) + 26\,a(n-14) - 40\,a(n-15) - 49\,a(n-16) - 16\,a(n-17) + 21\,a(n-18) + 36\,a(n-19) + 14\,a(n-20) - 12\,a(n-21) - 10\,a(n-22) - 4\,a(n-23) - a(n-24) + 2\,a(n-25) + a(n-26)
\end{equation}
for all $n>31$.
...
publishes, $n=36$, the arrays have $3\cdot36$ cells over
...
The threshold below is exact rather than merely sufficient: at $n=31$ the conjectured
...
every one of the $36$ published indices, with no shift fitted: the number of rows is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A300501.
