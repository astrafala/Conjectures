...
\title{The empirical recurrence for OEIS A302637, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A302637 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A302637 is ``Number of 4 X n 0..1 arrays with every element equal to 0, 1, 3 or 6 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
8, 10, 19, 33, 65, 149, 304, 643,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 07 2021 14:34:17, revision 7) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + a(n-2) + 2\,a(n-3) + 8\,a(n-4) - 6\,a(n-5) - 6\,a(n-6) - 13\,a(n-7) - 22\,a(n-8) + 7\,a(n-9) + 11\,a(n-10) + 28\,a(n-11) + 28\,a(n-12) + 2\,a(n-13) - 9\,a(n-14) - 27\,a(n-15) - 17\,a(n-16) - 2\,a(n-17) + 4\,a(n-18) + 10\,a(n-19) + 4\,a(n-20) - 2\,a(n-21) - a(n-22)
\end{equation}
for all $n>23$.
...
\#\{\text{neighbours with a value }equal to\ x_{t,u}\}\in\{0,1,3,6\}
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302637.
