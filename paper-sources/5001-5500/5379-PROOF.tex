...
\title{The empirical recurrence for OEIS A236658, proved by transfer matrix}
...
\begin{abstract}
OEIS A236658 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
OEIS A236658 is ``Number of (n+1)X(1+1) 0..2 arrays colored with the maximum plus the upper median plus the lower median of every 2X2 subblock.''. It has offset $1$ and begins
\[
81, 518, 3300, 21372, 138364, 891832, 5750552, 37123784,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 09:25:40, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;86\,a(n-3) + 693\,a(n-4) + 2090\,a(n-5) + 6696\,a(n-6) + 7704\,a(n-7) - 24436\,a(n-8) - 96408\,a(n-9) - 299268\,a(n-10) - 335040\,a(n-11) + 729732\,a(n-12) + 2128728\,a(n-13) + 3765488\,a(n-14) + 1789376\,a(n-15) - 13301760\,a(n-16) - 16992768\,a(n-17) + 7848704\,a(n-18) + 15690752\,a(n-19) + 10651648\,a(n-20) + 9836544\,a(n-21) - 9748480\,a(n-22) - 12713984\,a(n-23)
\]
for every $n>23$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A236658.
