...
\title{The empirical recurrence for OEIS A186818, proved by transfer matrix}
...
\begin{abstract}
OEIS A186818 counts arrays of width $4$ over $\{0,1\}$ in which every $3\times3$ subblock
...
OEIS A186818 is ``Half the number of (n+2)X4 binary arrays with each 3X3 subblock having sum 4 or 5.''. It has offset $1$ and begins
\[
606, 3988, 25808, 173121, 1190637, 8178097, 56422648, 390661554,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 03:43:28, revision 9) this is still
...
consecutive rows and three consecutive columns --- and asks that the nine entries sum to one of $4,\,5$. The entry publishes $1/2$ of that count; the division is by a constant and changes nothing about the recurrence.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A186818.
