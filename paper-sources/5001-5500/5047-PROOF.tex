...
\title{The empirical recurrence for OEIS A252426, proved by transfer matrix}
...
\begin{abstract}
OEIS A252426 counts $(n+2)\times3$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252426 is ``Number of (n+2)X(1+2) 0..3 arrays with every 3X3 subblock row and diagonal sum equal to 0 2 4 6 or 7 and every 3X3 column and antidiagonal sum not equal to 0 2 4 6 or 7.''. It has offset $1$ and begins
\[
641, 602, 608, 878, 1152, 1603, 2617, 4131,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 11*a(n-3) -39*a(n-6) +57*a(n-9) -72*a(n-12) +60*a(n-15) -31*a(n-18) +17*a(n-21) -a(n-24) -a(n-27) for n>34
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:13:15, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;11\,a(n-3) - 39\,a(n-6) + 57\,a(n-9) - 72\,a(n-12) + 60\,a(n-15) - 31\,a(n-18) + 17\,a(n-21) - a(n-24) - a(n-27)
\]
for every $n>34$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252426.
