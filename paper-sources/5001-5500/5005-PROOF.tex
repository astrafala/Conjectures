...
\title{The empirical recurrence for OEIS A187310, proved by transfer matrix}
...
\begin{abstract}
OEIS A187310 counts arrays of width $4$ over $\{0,1\}$ in which every $3\times3$ subblock
satisfies a condition on its nine entries. The entry carries an empirical recurrence of order
$25$ contributed by R.~H.~Hardin. It is true, and it is decidable rather than empirical: a
...
OEIS A187310 is ``Half the number of (n+2)X4 binary arrays with each 3X3 subblock having sum 3, 4, 5 or 6.''. It has offset $1$ and begins
\[
1472, 18792, 237650, 3029032, 38586679, 491649803, 6264576384, 79823385565,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 03:54:07, revision 9) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The arrays have $4$ columns and a growing number of rows, with entries in $\{0,1\}$. The
...
\begin{theorem}
\[
a(n)\;=\;12\,a(n-1) + 15\,a(n-2) - 37\,a(n-3) - 410\,a(n-4) - 551\,a(n-5) + 3600\,a(n-6) + 5558\,a(n-7) - 8726\,a(n-8) - 46631\,a(n-9) - 18772\,a(n-10) + 120881\,a(n-11) + 191220\,a(n-12) - 28195\,a(n-13) - 325390\,a(n-14) - 249390\,a(n-15) + 47034\,a(n-16) + 328056\,a(n-17) + 269892\,a(n-18) - 88272\,a(n-19) - 548424\,a(n-20) - 327888\,a(n-21) + 220320\,a(n-22) + 178848\,a(n-23) - 128304\,a(n-24) - 139968\,a(n-25)
\]
for every $n>23$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A187310.
