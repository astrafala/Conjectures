...
\title{The empirical recurrence for OEIS A301349, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A301349 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A301349 is ``Number of nX3 0..1 arrays with every element equal to 1, 2, 3, 5 or 6 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
1, 10, 53, 277, 1433, 7522, 39390, 206370,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 19 2018 09:42:25, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) + 5\,a(n-2) - 19\,a(n-3) - 6\,a(n-4) + 14\,a(n-5) - 3\,a(n-6) + 16\,a(n-7) + 19\,a(n-8) - 59\,a(n-9) - 41\,a(n-10) + 29\,a(n-11) + 8\,a(n-12) + 24\,a(n-13) + 51\,a(n-14) - 6\,a(n-15) - 32\,a(n-16) - 4\,a(n-17) + 4\,a(n-18)
\end{equation}
for all $n>20$.
...
\#\{\text{neighbours with a value }equal to\ x_{t,u}\}\in\{1,2,3,5,6\}
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A301349.
