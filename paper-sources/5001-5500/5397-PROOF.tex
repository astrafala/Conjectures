...
\title{The empirical recurrence for OEIS A297722, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297722 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A297722 is ``Number of 3Xn 0..1 arrays with every 1 horizontally, diagonally or antidiagonally adjacent to 1, 2 or 4 neighboring 1s.''. It has offset $1$ and begins
\[
1, 29, 145, 523, 2717, 14462, 68919, 332306,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 04 2018 22:00:42, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) - 5\,a(n-2) + 6\,a(n-3) - 17\,a(n-4) - 168\,a(n-5) + 284\,a(n-6) + 316\,a(n-7) - 636\,a(n-8) + 40\,a(n-9) + 732\,a(n-10) - 863\,a(n-11) - 414\,a(n-12) + 846\,a(n-13) + 17\,a(n-14) - 297\,a(n-15) + 188\,a(n-16) + 50\,a(n-17) - 52\,a(n-18)
\end{equation}
for all $n>19$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297722.
