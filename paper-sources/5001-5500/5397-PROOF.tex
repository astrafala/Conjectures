...
\title{The empirical recurrence for OEIS A301968, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A301968 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A301968 is ``Number of 6Xn 0..1 arrays with every element equal to 0, 1 or 4 horizontally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
32, 233, 252, 441, 874, 2544, 7795, 22456,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 29 2018 13:04:53, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) - 5\,a(n-2) + 15\,a(n-3) - 27\,a(n-4) + 16\,a(n-5) - 59\,a(n-6) + 50\,a(n-7) - 13\,a(n-8) + 119\,a(n-9) + 11\,a(n-10) + 12\,a(n-11) - 125\,a(n-12) - 138\,a(n-13) - 13\,a(n-14) + 57\,a(n-15) + 150\,a(n-16) + 52\,a(n-17) - 27\,a(n-18) - 87\,a(n-19) - 36\,a(n-20) + 14\,a(n-21) + 34\,a(n-22) + 11\,a(n-23) - 8\,a(n-24) - 7\,a(n-25) - a(n-26) + 2\,a(n-27)
\end{equation}
for all $n>32$.
...
publishes, $n=25$, the arrays have $6\cdot25$ cells over
$2$ values, so there are about $10^{45}$ of them to sift. The
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A301968.
