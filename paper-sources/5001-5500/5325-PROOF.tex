...
\title{The empirical recurrence for OEIS A231519, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A231519 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A231519 is ``Number of n X 4 0..1 arrays with no element less than a strict majority of its horizontal, diagonal and antidiagonal neighbors.''. It has offset $1$ and begins
\[
7, 107, 865, 7697, 66499, 571226, 4944075, 42759650,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 26 2021 14:58:33, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;7\,a(n-1) + 3\,a(n-2) + 117\,a(n-3) - 96\,a(n-4) - 500\,a(n-5) - 1683\,a(n-6) - 40\,a(n-7) + 4807\,a(n-8) + 6898\,a(n-9) - 181\,a(n-10) - 9621\,a(n-11) - 10107\,a(n-12) - 734\,a(n-13) - 9567\,a(n-14) - 4385\,a(n-15) + 24373\,a(n-16) + 1907\,a(n-17) - 17636\,a(n-18) + 2087\,a(n-19) + 6490\,a(n-20) + 1542\,a(n-21) - 233\,a(n-22) - 560\,a(n-23) - 36\,a(n-24)
\end{equation}
for all $n>25$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231519.
