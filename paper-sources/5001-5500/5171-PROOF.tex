...
\title{The empirical recurrence for OEIS A237169, proved by transfer matrix}
...
\begin{abstract}
OEIS A237169 counts arrays over $\{0,\dots,3\}$ subject to a condition on the order
...
OEIS A237169 is ``Number of (n+1)X(1+1) 0..3 arrays with the maximum minus the lower median of every 2X2 subblock equal.''. It has offset $1$ and begins
\[
256, 1696, 11242, 79688, 571176, 4149488, 30302376, 222236840,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 09:55:35, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237169.
