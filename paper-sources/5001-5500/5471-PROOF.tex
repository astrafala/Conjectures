...
\title{The empirical recurrence for OEIS A296035, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A296035 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A296035 is ``Number of nX4 0..1 arrays with each 1 adjacent to 2 or 4 king-move neighboring 1s.''. It has offset $1$ and begins
\[
1, 21, 70, 204, 997, 4102, 15399, 63267,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 03 2017 07:10:29, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 2\,a(n-2) + 25\,a(n-3) - 43\,a(n-4) - 60\,a(n-5) - 170\,a(n-6) + 105\,a(n-7) + 326\,a(n-8) + 30\,a(n-9) - 197\,a(n-10) - 2\,a(n-11) + 223\,a(n-12) - 11\,a(n-13) - 102\,a(n-14) - 2\,a(n-15) + 12\,a(n-16) + 2\,a(n-17)
\end{equation}
for all $n>18$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A296035.
