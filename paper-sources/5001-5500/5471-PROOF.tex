...
\title{The empirical recurrence for OEIS A236791, proved by transfer matrix}
...
\begin{abstract}
OEIS A236791 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
The condition is local to two consecutive rows, so the count is a walk count on $S=32$
...
OEIS A236791 is ``Number of (n+1)X(1+1) 0..2 arrays with the maximum plus the upper median plus the minimum of every 2X2 subblock equal.''. It has offset $1$ and begins
\[
81, 255, 825, 2817, 9717, 34317, 122305, 442285,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 09:33:17, revision 6) this is still
...
array, which is not among the objects counted. There are $S=32$ states left.
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-1) + 8\,a(n-2) - 204\,a(n-3) + 224\,a(n-4) + 1972\,a(n-5) - 3810\,a(n-6) - 9220\,a(n-7) + 24389\,a(n-8) + 20868\,a(n-9) - 81294\,a(n-10) - 13536\,a(n-11) + 150316\,a(n-12) - 33360\,a(n-13) - 148072\,a(n-14) + 72384\,a(n-15) + 63616\,a(n-16) - 48128\,a(n-17) - 2816\,a(n-18) + 8192\,a(n-19) - 1536\,a(n-20)
\]
for every $n>19$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A236791.
