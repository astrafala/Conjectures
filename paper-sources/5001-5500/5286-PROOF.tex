...
\title{The empirical recurrence for OEIS A295375, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A295375 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A295375 is ``Number of nX4 0..1 arrays with each 1 horizontally or vertically adjacent to 0, 2 or 4 1s.''. It has offset $1$ and begins
\[
8, 48, 278, 1634, 9507, 55643, 325134, 1900380,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 21 2017 07:06:47, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) + a(n-2) - 10\,a(n-3) - 8\,a(n-4) + 30\,a(n-5) - 155\,a(n-6) + 161\,a(n-7) - 111\,a(n-8) + 29\,a(n-9) + 18\,a(n-10) + 263\,a(n-11) - 294\,a(n-12) + 267\,a(n-13) - 52\,a(n-14) - 4\,a(n-15) - 83\,a(n-16) - 42\,a(n-17) + 41\,a(n-18) - 62\,a(n-19) - 16\,a(n-20) + 18\,a(n-21) + 17\,a(n-22) + 3\,a(n-23) + a(n-24) - a(n-25)
\end{equation}
for all $n>26$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A295375.
