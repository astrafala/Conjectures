...
\title{The empirical recurrence for OEIS A250709, proved by transfer matrix}
...
\begin{abstract}
OEIS A250709 counts arrays over $\{0,1,2,3\}$ in which a statistic taken over short runs
...
OEIS A250709 is ``Number of (2+1)X(n+1) 0..3 arrays with nondecreasing x(i,j)+x(i,j-1) in the i direction and nondecreasing min(x(i,j),x(i-1,j)) in the j direction.''. It has offset $1$ and begins
\[
536, 4958, 37892, 253578, 1578385, 9240474, 52069631, 284450645,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 12:43:52, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;19\,a(n-1) - 126\,a(n-2) + 183\,a(n-3) + 1796\,a(n-4) - 8913\,a(n-5) + 4573\,a(n-6) + 66844\,a(n-7) - 159500\,a(n-8) - 110347\,a(n-9) + 880170\,a(n-10) - 671453\,a(n-11) - 2023137\,a(n-12) + 3717534\,a(n-13) + 1245646\,a(n-14) - 7902628\,a(n-15) + 3640217\,a(n-16) + 8175766\,a(n-17) - 8942921\,a(n-18) - 2871444\,a(n-19) + 8558015\,a(n-20) - 2088628\,a(n-21) - 3791479\,a(n-22) + 2465772\,a(n-23) + 449922\,a(n-24) - 865945\,a(n-25) + 183465\,a(n-26) + 86000\,a(n-27) - 45400\,a(n-28) + 6000\,a(n-29)
\]
for every $n>34$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250709.
