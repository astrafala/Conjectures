...
\title{The empirical recurrence for OEIS A260172, proved by transfer matrix}
...
\begin{abstract}
OEIS A260172 counts $(n+2)\times5$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A260172 is ``Number of (n+2)X(3+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000001 00000101 or 00010001.''. It has offset $1$ and begins
\[
183, 419, 1054, 2598, 6813, 17889, 46263, 119681,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 12:02:06, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-2) + 3\,a(n-3) + 14\,a(n-4) - a(n-5) + 18\,a(n-6) + 51\,a(n-7) - 28\,a(n-8) - 89\,a(n-9) + 185\,a(n-10) - 62\,a(n-11) - 246\,a(n-12) + 30\,a(n-13) - 128\,a(n-14) - 113\,a(n-15) + 80\,a(n-16) - 301\,a(n-17) - 83\,a(n-18) - 50\,a(n-19) - 118\,a(n-20) + 118\,a(n-21) + 48\,a(n-22) - 86\,a(n-23) + 38\,a(n-24) + 30\,a(n-25) - 6\,a(n-26) + 2\,a(n-27) - 4\,a(n-30)
\]
for every $n>31$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A260172.
