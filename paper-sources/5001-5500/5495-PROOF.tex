...
\title{The empirical recurrence for OEIS A297585, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297585 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A297585 is ``Number of 4Xn 0..1 arrays with every 1 horizontally, diagonally or antidiagonally adjacent to 1 or 4 neighboring 1s.''. It has offset $1$ and begins
\[
1, 20, 102, 254, 1017, 5263, 20771, 76340,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 01 2018 11:14:37, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 4\,a(n-2) + 23\,a(n-3) + 59\,a(n-4) - 6\,a(n-5) - 158\,a(n-6) - 137\,a(n-7) - 2\,a(n-8) + 54\,a(n-9) + 177\,a(n-10) - 230\,a(n-11) - 89\,a(n-12) + 168\,a(n-13) - 28\,a(n-14) - 37\,a(n-15) + 4\,a(n-16) + 2\,a(n-17)
\end{equation}
for all $n>18$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297585.
