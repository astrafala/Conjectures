...
\title{The empirical recurrence for OEIS A209513, proved by transfer matrix}
...
\begin{abstract}
OEIS A209513 counts arrays of width $5$ over $\{0,1,2\}$ subject to a condition read round the
...
OEIS A209513 is ``Number of (n+1) X 5 0..2 arrays with the number of clockwise edge increases in every 2 X 2 subblock equal to the number of counterclockwise edge increases.''. It has offset $1$ and begins
\[
14739, 951777, 62340543, 4099186545, 269845393359, 17769569448759, 1170258116647953, 77072446894479573,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 06 2015 21:46:27, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;115\,a(n-1) - 4157\,a(n-2) + 69117\,a(n-3) - 595705\,a(n-4) + 2449306\,a(n-5) - 240335\,a(n-6) - 43350087\,a(n-7) + 178528425\,a(n-8) - 183199822\,a(n-9) - 751284432\,a(n-10) + 2871335435\,a(n-11) - 3549608757\,a(n-12) - 650892687\,a(n-13) + 7285361378\,a(n-14) - 9372087568\,a(n-15) + 5616780205\,a(n-16) - 1330498112\,a(n-17) - 261001088\,a(n-18) + 232979629\,a(n-19) - 45081325\,a(n-20) - 1230938\,a(n-21) + 1537784\,a(n-22) - 190656\,a(n-23) + 8208\,a(n-24) - 108\,a(n-25)
\]
for every $n>24$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209513.
