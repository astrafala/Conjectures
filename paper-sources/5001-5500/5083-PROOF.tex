...
\title{The empirical recurrence for OEIS A317737, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A317737 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A317737 is ``Number of nX4 0..1 arrays with every element unequal to 2 or 3 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
0, 2, 3, 4, 14, 23, 35, 98,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 05 2018 15:57:46, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 2\,a(n-2) + 3\,a(n-3) - 2\,a(n-4) + a(n-5) - 6\,a(n-6) + 8\,a(n-7) - 16\,a(n-8) - 7\,a(n-9) - 17\,a(n-10) + 7\,a(n-11) + 5\,a(n-12) + 9\,a(n-13) + 3\,a(n-14) + 28\,a(n-15) + 16\,a(n-16) + 18\,a(n-17) - 5\,a(n-18) - 2\,a(n-19) - 3\,a(n-20) - 2\,a(n-21) - a(n-22) + a(n-23)
\end{equation}
for all $n>26$.
...
publishes, $n=31$, the arrays have $4\cdot31$ cells over
...
The threshold below is exact rather than merely sufficient: at $n=26$ the conjectured
...
Every one of those integers vanishes from the index corresponding to $n=26+1$ onwards,
...
every one of the $31$ published indices, with no shift fitted: the number of rows is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A317737.
