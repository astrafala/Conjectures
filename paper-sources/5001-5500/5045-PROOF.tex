...
\title{The empirical recurrence for OEIS A196977, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A196977 counts arrays over $\{0,\dots,4\}$ in which every cell is constrained by the
...
OEIS A196977 is ``Number of nX3 0..4 arrays with each element x equal to the number its horizontal and vertical neighbors equal to 3,2,1,0,4 for x=0,1,2,3,4.''. It has offset $1$ and begins
\[
2, 14, 65, 298, 1422, 6679, 31386, 147574,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 06:52:57, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 4\,a(n-2) + 22\,a(n-3) + 45\,a(n-4) + 166\,a(n-5) + 204\,a(n-6) + 94\,a(n-7) - 372\,a(n-8) - 674\,a(n-9) - 692\,a(n-10) - 170\,a(n-11) + 495\,a(n-12) + 655\,a(n-13) + 521\,a(n-14) + 107\,a(n-15) - 138\,a(n-16) - 139\,a(n-17) - 84\,a(n-18) - 15\,a(n-19) + 9\,a(n-20) + 3\,a(n-21)
\end{equation}
for all $n>22$.
...
\#\{\text{neighbours with value }f(x_{t,u})\}=x_{t,u},\quad f=(3,2,1,0,4)
\end{equation}
for every cell $(t,u)$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A196977.
