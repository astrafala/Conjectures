...
\title{The empirical recurrence for OEIS A236731, proved by transfer matrix}
...
\begin{abstract}
OEIS A236731 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
OEIS A236731 is ``Number of (n+1)X(2+1) 0..2 arrays with the upper median minus the lower median of every 2X2 subblock equal.''. It has offset $1$ and begins
\[
345, 2471, 17583, 131147, 975553, 7370761, 55873999, 426890075,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 09:30:13, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;20\,a(n-1) - 103\,a(n-2) - 358\,a(n-3) + 4749\,a(n-4) - 8438\,a(n-5) - 47573\,a(n-6) + 201166\,a(n-7) - 30204\,a(n-8) - 1074134\,a(n-9) + 1618940\,a(n-10) + 1364656\,a(n-11) - 5060624\,a(n-12) + 2241312\,a(n-13) + 4225728\,a(n-14) - 4631936\,a(n-15) + 436992\,a(n-16) + 1161216\,a(n-17) - 387072\,a(n-18) - 30720\,a(n-19) + 16384\,a(n-20)
\]
for every $n>19$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A236731.
