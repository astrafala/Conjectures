...
\title{The empirical recurrence for OEIS A234157, proved by transfer matrix}
...
\begin{abstract}
OEIS A234157 counts $(n+1)\times5$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A234157 is ``Number of (n+1)X(4+1) 0..3 arrays with every 2X2 subblock having the absolute values of all six edge and diagonal differences no larger than 1.''. It has offset $1$ and begins
\[
5446, 208530, 7952532, 305867942, 11788446834, 454899880956, 17566272589090, 678657896630666,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 09:13:53, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;90\,a(n-1) - 2653\,a(n-2) + 24943\,a(n-3) + 89825\,a(n-4) - 2218609\,a(n-5) + 1432019\,a(n-6) + 71490923\,a(n-7) - 78048525\,a(n-8) - 1164227315\,a(n-9) + 761044775\,a(n-10) + 9924372783\,a(n-11) - 667076603\,a(n-12) - 41948446347\,a(n-13) - 15809876567\,a(n-14) + 78900501505\,a(n-15) + 41327430666\,a(n-16) - 75139994803\,a(n-17) - 37071907734\,a(n-18) + 40119015622\,a(n-19) + 12686351262\,a(n-20) - 12371945864\,a(n-21) - 754232304\,a(n-22) + 1729058752\,a(n-23) - 288379744\,a(n-24) - 6642240\,a(n-25) + 2957184\,a(n-26)
\end{equation}
for all $n>26$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234157.
