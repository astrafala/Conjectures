...
\title{The empirical recurrence for OEIS A318341, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A318341 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A318341 is ``Number of nX6 0..1 arrays with every element unequal to 0, 1, 2 or 6 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
32, 89, 160, 343, 1115, 4133, 16267, 66070,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 24 2018 11:03:35, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) + 9\,a(n-2) - 28\,a(n-3) - 57\,a(n-4) + 78\,a(n-5) + 199\,a(n-6) - 73\,a(n-7) - 366\,a(n-8) - 89\,a(n-9) + 336\,a(n-10) + 298\,a(n-11) - 42\,a(n-12) - 362\,a(n-13) - 234\,a(n-14) + 215\,a(n-15) + 227\,a(n-16) + 16\,a(n-17) - 99\,a(n-18) - 65\,a(n-19) + 7\,a(n-20) + 27\,a(n-21) + 4\,a(n-22) - 4\,a(n-23)
\end{equation}
for all $n>27$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A318341.
