...
\title{The empirical recurrence for OEIS A300534, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A300534 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A300534 is ``Number of nX3 0..1 arrays with every element equal to 0, 2, 3 or 4 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
1, 5, 12, 36, 122, 429, 1585, 5755,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 08 2018 12:22:37, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 7\,a(n-2) + 6\,a(n-3) - 21\,a(n-4) - 36\,a(n-5) - 26\,a(n-6) + 4\,a(n-7) + 62\,a(n-8) + 82\,a(n-9) + 18\,a(n-10) - 52\,a(n-11) - 42\,a(n-12) + 72\,a(n-13) + 38\,a(n-14) + 12\,a(n-15) - 25\,a(n-16) - 16\,a(n-17) - 4\,a(n-18) - 6\,a(n-19) + 8\,a(n-20) - 4\,a(n-21) + 2\,a(n-22)
\end{equation}
for all $n>24$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A300534.
