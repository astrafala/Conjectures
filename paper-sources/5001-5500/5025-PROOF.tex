...
\title{The empirical recurrence for OEIS A259639, proved by transfer matrix}
...
\begin{abstract}
OEIS A259639 counts $(n+2)\times7$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A259639 is ``Number of (n+2)X(5+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000000 or 00000001.''. It has offset $1$ and begins
\[
236, 813, 3849, 12348, 44500, 182654, 670088, 2436036,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:53:20, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A259639.
