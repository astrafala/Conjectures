...
\title{The empirical recurrence for OEIS A203367, proved by transfer matrix}
...
\begin{abstract}
OEIS A203367 counts arrays of width $4$ over $\{0,1,2\}$ under local conditions relating each cell
...
OEIS A203367 is ``Number of nX4 0..2 arrays with every 1 immediately preceded by 0 to the left or above, and every 2 immediately preceded by both a 1 and a 0.''. It has offset $1$ and begins
\[
5, 110, 1570, 25087, 386353, 6026844, 93584344, 1455532600,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 10:23:20, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) + 120\,a(n-2) + 573\,a(n-3) + 1592\,a(n-4) + 1984\,a(n-5) - 149\,a(n-6) - 4874\,a(n-7) - 6407\,a(n-8) + 5949\,a(n-9) + 17221\,a(n-10) - 31639\,a(n-11) + 19681\,a(n-12) - 10104\,a(n-13) + 3649\,a(n-14) + 2588\,a(n-15) - 124\,a(n-16) - 408\,a(n-17) + 112\,a(n-18) - 32\,a(n-19)
\]
for every $n>18$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A203367.
