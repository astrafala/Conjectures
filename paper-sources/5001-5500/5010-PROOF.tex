...
\title{The empirical recurrence for OEIS A300801, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A300801 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A300801 is ``Number of nX5 0..1 arrays with every element equal to 0, 1, 2, 3 or 4 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
16, 512, 12228, 317504, 8170504, 210678360, 5431609016, 140040313680,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 13 2018 07:43:03, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;24\,a(n-1) + 64\,a(n-2) - 417\,a(n-3) - 1350\,a(n-4) + 2413\,a(n-5) + 8677\,a(n-6) - 1690\,a(n-7) - 17000\,a(n-8) - 49614\,a(n-9) - 97662\,a(n-10) - 207652\,a(n-11) + 295556\,a(n-12) - 369400\,a(n-13) + 631816\,a(n-14) + 212360\,a(n-15) + 1245900\,a(n-16) - 397516\,a(n-17) + 1255956\,a(n-18) - 1370636\,a(n-19) + 125796\,a(n-20) - 1384600\,a(n-21) + 1506016\,a(n-22) - 696320\,a(n-23) + 1759968\,a(n-24) - 740160\,a(n-25) + 433728\,a(n-26) - 331776\,a(n-27)
\end{equation}
for all $n>29$.
...
\#\{\text{neighbours with a value }equal to\ x_{t,u}\}\in\{0,1,2,3,4\}
\end{equation}
...
the middle row. The vector $w$ was formed by $27$ applications of $G$ in exact integer
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A300801.
