...
\begin{theorem}
The recurrence \eqref{eq:conj} holds for every $n>88$. This is the statement of
Section~1.
\end{theorem}
...
index corresponding to $n=88+1$ onwards, and the run was continued past $S$ consecutive
