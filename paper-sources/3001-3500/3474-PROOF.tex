...
\title{The empirical recurrence for OEIS A306125, proved by transfer matrix}
...
\begin{abstract}
OEIS A306125 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $different from$ itself lying in $\{0,1,3,4,6,7\}$, and it carries an empirical
...
OEIS A306125 is ``Number of nX4 0..1 arrays with every element unequal to 0, 1, 3, 4, 6 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
5, 17, 19, 70, 134, 360, 964, 2805,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 22 2018 07:33:59, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A306125.
