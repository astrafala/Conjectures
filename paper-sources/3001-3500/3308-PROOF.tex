...
\title{The empirical closed form for OEIS A203821, proved}
...
\begin{abstract}
OEIS A203821 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
$\prod_j(x-\lambda_j)^{\deg p_j+1}$; here that polynomial is $q(x)=(x-49)$, of degree
...
OEIS A203821 is ``Number of (n+1)X4 0..3 arrays with no 2X2 subblock having equal diagonal elements or equal antidiagonal elements.''. It has offset $1$ and begins
\[
11664, 571536, 28005264, 1372257936, 67240638864, 3294791304336, 161444773912464, 7910793921710736,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 11664*49\^{}(n-1)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 10:44:38, revision 9) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;11664 \cdot 49^{n - 1}.
\]
...
Here $q(x)=(x-49)$, of degree $1$, and the recurrence it encodes is
...
First, the walk model reproduces every one of the $12$ terms the entry publishes,
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A203821.
