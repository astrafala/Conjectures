...
\title{The empirical recurrence for OEIS A270111, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A270111 counts arrays over $\{0,\dots,7\}$ subject to a condition on the array as a
...
OEIS A270111 is ``Number of n X 1 0..7 arrays with some element plus some horizontally or vertically adjacent neighbor totalling seven exactly once.''. It has offset $1$ and begins
\[
0, 8, 112, 1176, 10976, 96040, 806736, 6588344,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 14*a(n-1) - 49*a(n-2).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 22 2018 06:51:11, revision 7) the statement is
...
\[
\mathcal V=\bigl\{(r,c):\ r\in\{0,\dots,7\}^{1},\ c\in\{0,1\}\bigr\},
...
the digraph dense, with $(7+1)^{2\cdot1}$ edges instead of the sparse set used here.
\end{remark}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A270111.
