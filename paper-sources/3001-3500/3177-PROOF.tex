...
\title{The empirical recurrence for OEIS A205163, proved by counting patterns}
...
\begin{abstract}
OEIS A205163 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A205163 is ``Number of (n+1) X 2 0..3 arrays with every 2 X 2 subblock having unequal diagonal elements or unequal antidiagonal elements, and new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
13, 159, 2277, 33831, 506493, 7594479, 113908437, 1708600311,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 18*a(n-1) - 45*a(n-2).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 03 2018 13:52:26, revision 12) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A205163.
