...
\title{The empirical closed form for OEIS A188823, proved}
...
\begin{abstract}
OEIS A188823 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A188823 is ``Number of n X 8 binary arrays without the pattern 0 1 diagonally or antidiagonally.''. It has offset $1$ and begins
\[
256, 3025, 11664, 28561, 53824, 87616, 129600, 179776,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4096*n\^{}2 - 11264*n + 7744 for n>4.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 30 2018 13:56:18, revision 10) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;4096 n^{2} - 11264 n + 7744.
\]
...
$n=8,\dots,10$ and agree at each. A monic recurrence of order $3$
determines $a(m)$ from $a(m-1),\dots,a(m-3)$, and for every $m\ge11$ both
$m>7$ and $m-3\ge8$ hold, so induction on $m$ gives $a(m)=f(m)$ for every
$m\ge8$.
Below $n=8$ the recurrence argument gives nothing, since \eqref{eq:rec} is only
established for $a$ from $n=8$ on. The remaining indices $n=5,\dots,7$ were
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A188823.
