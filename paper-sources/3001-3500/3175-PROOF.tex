...
\title{The empirical recurrence for OEIS A209497, proved by counting patterns}
...
\begin{abstract}
OEIS A209497 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A209497 is ``Number of n X 2 0..4 arrays with every 2 X 2 subblock containing exactly one value repeat, and new values 0..4 introduced in row major order.''. It has offset $1$ and begins
\[
2, 6, 57, 690, 9393, 133380, 1920126, 27760512,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 16*a(n-1) - 10*a(n-2) - 168*a(n-3) - 72*a(n-4) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 10 2018 06:15:59, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;16\,a(n-1) - 10\,a(n-2) - 168\,a(n-3) - 72\,a(n-4)
\end{equation}
for all $n>5$.
...
\[
5!\Bigl(a(n)-\sum_i c_i\,a(n-i)\Bigr)\;=\;\mathbf{v}^{\!\top}N^{\,m-4}q(N)\mathbf{1} .
\]
...
\eqref{eq:walk}, divided by $5!$, was evaluated at every one of the $17$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209497.
