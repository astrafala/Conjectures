...
\title{The empirical recurrence for OEIS A275139, proved by counting patterns}
...
\begin{abstract}
OEIS A275139 counts arrays in which no entry may repeat a value found at any of three stated
...
OEIS A275139 is ``Number of n X 5 0..2 arrays with no element equal to any value at offset (-2,-2) (-1,-2) or (0,-1) and new values introduced in order 0..2.''. It has offset $1$ and begins
\[
8, 144, 528, 2320, 9744, 41360, 175120, 741904,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) + 5*a(n-2) + a(n-3) for n>4.
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 31 2019 19:36:47, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A275139.
