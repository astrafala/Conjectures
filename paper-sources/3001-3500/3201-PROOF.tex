...
\title{The empirical recurrence for OEIS A206213, proved by transfer matrix}
...
\begin{abstract}
OEIS A206213 counts, up to renaming the letters, the arrays of width $7$ over at most $3$
...
OEIS A206213 is ``Number of (n+1)X7 0..2 arrays with every 2X3 or 3X2 subblock having exactly two equal edges, and new values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
8802, 9072, 14416, 74080, 359424, 1764000, 9438912, 46540800,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 130*a(n-3) for n>9
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 12:47:42, revision 9) this is still
...
$w_i$ cleared of denominators and $S=53418$ states in all. The walk index $j$ and the entry's own
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206213.
