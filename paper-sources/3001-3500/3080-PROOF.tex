...
\title{The empirical recurrence for OEIS A223359, proved by transfer matrix}
...
\begin{abstract}
OEIS A223359 counts the ways of writing the vertices of a fixed graph $G$ into an array of width
$4$ so that any two cells adjacent in one of the named directions carry vertices joined by an
edge of $G$; here $G$ is octahedron graph. The entry carries an empirical recurrence of order $3$
...
single slice is a state and the count is a walk count on a finite digraph with $S=1297$ vertices.
\end{abstract}
...
OEIS A223359 is ``Rolling cube footprints: number of 4 X n 0..5 arrays starting with 0 where 0..5 label faces of a cube and every array movement to a horizontal or antidiagonal neighbor moves across a corresponding cube edge.''. It has offset $1$ and begins
\[
216, 16384, 1769472, 191102976, 21177040896, 2356125106176, 262687716016128, 29299957655666688,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 144*a(n-1) -3840*a(n-2) +24576*a(n-3) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 28 2023 22:13:55, revision 6) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=1297.
\]
...
\begin{theorem}
\[
a(n)\;=\;144\,a(n-1) - 3840\,a(n-2) + 24576\,a(n-3)
\]
for every $n>7$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223359.
