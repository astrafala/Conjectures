...
\title{The empirical column recurrences for the table OEIS A251524}
...
\begin{abstract}
OEIS A251524 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A251524 is ``T(n,k) = Number of (n+1) X (k+1) 0..3 arrays with every 2 X 2 subblock summing to 2 3 4 5 6 7 8 9 or 10.''. It has offset $1$, is
read by antidiagonals, and begins
\[
246, 3798, 3798, 58618, 227174, 58618, 904734, 13580282,\ \dots
\]
The entry carries the following block:
\begin{quote}\small
Empirical for column k:\\
k=1: a(n) = 15*a(n-1) +8*a(n-2) -20*a(n-3).\\
k=2: a(n) = 59*a(n-1) +67*a(n-2) -1223*a(n-3) +782*a(n-4) +1020*a(n-5) -520*a(n-6).\\
k=3: [order 15].\\
k=4: [order 40].\\
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 03 2022 22:12:06, revision 6) these are still
...
The sequence is ``Number of (n+1) X (2) 0..3 arrays with every 2 X 2 subblock summing to 2 3 4 5 6 7 8 9 or 10.''. Its rows are the vertices of a digraph on
...
$c_{1}$ & $225$ & $c_{5}$ & $18217165$ & $c_{9}$ & $1991291650$ & $c_{13}$ & $-1281849696$ \\
$c_{2}$ & $2020$ & $c_{6}$ & $-41626758$ & $c_{10}$ & $-4108606440$ & $c_{14}$ & $-2223288576$ \\
$c_{3}$ & $-118805$ & $c_{7}$ & $-389697238$ & $c_{11}$ & $-1995135464$ & $c_{15}$ & $901255680$ \\
$c_{4}$ & $-274529$ & $c_{8}$ & $754598477$ & $c_{12}$ & $6354576576$ &  &  \\
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251524.
