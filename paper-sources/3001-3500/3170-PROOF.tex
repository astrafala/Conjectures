...
\title{The empirical closed form, generating function and recurrence for OEIS A195235, proved}
...
\begin{abstract}
OEIS A195235 counts the lower triangles of a $5\times5$ array over $\{0,\dots,n\}$ in which
...
OEIS A195235 is ``Number of lower triangles of a 5 X 5 0..n array with each element differing from all of its diagonal, vertical, antidiagonal and horizontal neighbors by one or less.''. It has offset $1$ and begins
\[
32768, 127785, 237818, 348849, 459880, 570911,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 06 2018 12:18:45, revision 12) these are still
...
\[
a(n)\;=\;111031\,n-95275\qquad\text{for every }n\ge3,
\]
and $\mathcal P$ has exactly $111031$ elements.
\end{theorem}
...
$a(4+1)$ were computed exactly, giving slope $111031$ and the stated intercept; the slope
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A195235.
