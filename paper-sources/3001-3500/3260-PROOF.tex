...
\title{The empirical recurrence for OEIS A270112, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A270112 counts arrays over $\{0,\dots,7\}$ subject to a condition on the array as a
...
OEIS A270112 is ``Number of n X 2 0..7 arrays with some element plus some horizontally or vertically adjacent neighbor totalling seven exactly once.''. It has offset $1$ and begins
\[
8, 1344, 100800, 6183744, 345422784, 18272616768, 932758314432, 46431146637120,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 86*a(n-1) - 1849*a(n-2) for n>3.
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 29 2019 14:23:12, revision 7) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;86\,a(n-1) - 1849\,a(n-2)
\end{equation}
for all $n>3$.
...
\[
\mathcal V=\bigl\{(r,c):\ r\in\{0,\dots,7\}^{2},\ c\in\{0,1\}\bigr\},
...
the digraph dense, with $(7+1)^{2\cdot2}$ edges instead of the sparse set used here.
\end{remark}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A270112.
