...
\begin{theorem}
The recurrence \eqref{eq:conj} holds for every $n>78$. This is the statement of
Section~1.
\end{theorem}
...
index corresponding to $n=78+1$ onwards, and the run was continued past $S$ consecutive
