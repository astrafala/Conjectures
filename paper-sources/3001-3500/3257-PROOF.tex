...
\title{The conjectured generating function for OEIS A250759, proved}
...
\begin{abstract}
OEIS A250759 counts arrays of a fixed width under a local condition, and carries a conjectured
...
OEIS A250759 is ``Number of (4+1) X (n+1) 0..2 arrays with nondecreasing x(i,j)-x(i,j-1) in the i direction and nondecreasing x(i,j)+x(i-1,j) in the j direction.''. It has offset $1$ and begins
\[
1029, 2361, 4239, 6663, 9633, 13149,\ \dots
\]
The entry states, as a conjecture contributed by a reader and never marked settled:
\begin{quote}
G.f.: 3*x*(343 - 242*x + 81*x\^{}2) / (1 - x)\^{}3.
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 18 2018 09:57:32, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250759.
