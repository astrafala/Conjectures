...
\title{The empirical recurrence for OEIS A223354, proved by transfer matrix}
...
\begin{abstract}
OEIS A223354 counts the ways of writing the vertices of a fixed graph $G$ into an array of width
$5$ so that any two cells adjacent in one of the named directions carry vertices joined by an
edge of $G$; here $G$ is octahedron graph. The entry carries an empirical recurrence of order $2$
...
OEIS A223354 is ``Rolling cube footprints: number of n X 5 0..5 arrays starting with 0 where 0..5 label faces of a cube and every array movement to a horizontal or antidiagonal neighbor moves across a corresponding cube edge.''. It has offset $1$ and begins
\[
256, 110592, 48365568, 21177040896, 9273505480704, 4060947412942848, 1778325505192230912, 778744859776908263424,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 480*a(n-1) - 18432*a(n-2).
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 19 2018 18:12:42, revision 9) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223354.
