...
\title{The empirical recurrence for OEIS A204624, proved by counting patterns}
...
\begin{abstract}
OEIS A204624 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A204624 is ``Number of (n+1) X 3 0..2 arrays with every 2 X 2 subblock having unequal diagonal elements or unequal antidiagonal elements, and new values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
96, 2049, 43734, 933462, 19923888, 425257068, 9076721064, 193734264456,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 22*a(n-1) -14*a(n-2).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 07 2018 14:25:52, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;22\,a(n-1) - 14\,a(n-2)
\end{equation}
for all $n>2$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204624.
