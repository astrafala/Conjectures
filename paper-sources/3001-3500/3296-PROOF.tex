...
\title{The empirical recurrence for OEIS A210100, proved by counting patterns}
...
\begin{abstract}
OEIS A210100 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A210100 is ``Number of (n+1) X 2 0..2 arrays with every 2 X 2 subblock having one or three distinct values, and new values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
7, 30, 135, 614, 2799, 12766, 58231, 265622,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 6*a(n-1) - 7*a(n-2) + 2*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 14 2018 07:41:27, revision 13) the statement is
...
\eqref{eq:walk}, divided by $3!$, was evaluated at every one of the $22$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A210100.
