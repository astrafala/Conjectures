...
\title{The empirical recurrence for OEIS A274798, proved by counting patterns}
...
\begin{abstract}
OEIS A274798 counts arrays in which no entry may repeat a value found at any of three stated
...
OEIS A274798 is ``Number of n X 3 0..2 arrays with no element equal to any value at offset (-1,-2) (-2,-1) (0,-1) or (-1,0) and new values introduced in order 0..2.''. It has offset $1$ and begins
\[
2, 8, 30, 112, 420, 1572, 5888, 22048,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) + 6*a(n-2) + 2*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 30 2019 15:51:13, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 6\,a(n-2) + 2\,a(n-3)
\end{equation}
for all $n>4$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A274798.
