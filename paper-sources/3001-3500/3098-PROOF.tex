...
\title{The empirical recurrence for OEIS A231295, proved by transfer matrix}
...
\begin{abstract}
OEIS A231295 counts $(n+1)\times2$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A231295 is ``Number of (n+1) X (1+1) 0..2 arrays with no element unequal to a strict majority of its horizontal, vertical and antidiagonal neighbors, with values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
1, 2, 4, 12, 32, 92, 264, 756,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + 3*a(n-2) - 4*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 28 2018 09:53:29, revision 14) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231295.
