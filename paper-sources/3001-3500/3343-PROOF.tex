...
\title{The empirical recurrence for OEIS A208387, proved by counting patterns}
...
\begin{abstract}
OEIS A208387 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A208387 is ``Number of nX3 0..2 arrays with new values 0..2 introduced in row major order and no element equal to more than two of its immediate leftward or upward or right-upward antidiagonal neighbors.''. It has offset $1$ and begins
\[
5, 117, 3042, 79092, 2056392, 53466192, 1390120992, 36143145792,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 26*a(n-1) for n>2
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:48:37, revision 9) the statement is
...
\[
3!\Bigl(a(n)-\sum_i c_i\,a(n-i)\Bigr)\;=\;\mathbf{v}^{\!\top}N^{\,m-1}q(N)\mathbf{1} .
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208387.
