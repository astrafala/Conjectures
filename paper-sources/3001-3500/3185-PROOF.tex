...
\title{The empirical recurrence for OEIS A274853, proved by counting patterns}
...
\begin{abstract}
OEIS A274853 counts arrays in which no entry may repeat a value found at any of three stated
...
OEIS A274853 is ``Number of n X 3 0..2 arrays with no element equal to any value at offset (-1,0) (0,-1) or (-2,-2) and new values introduced in order 0..2.''. It has offset $1$ and begins
\[
2, 9, 19, 43, 100, 233, 542, 1260,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) - 2*a(n-2) + a(n-3) for n>4.
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 31 2019 08:06:33, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A274853.
