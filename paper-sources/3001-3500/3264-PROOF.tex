...
\title{The empirical recurrence for OEIS A214135, proved by transfer matrix}
...
\begin{abstract}
OEIS A214135 counts the proper colourings of a grid $n\times3$, wrapped in the direction of width $3$, with at most $5$ colours and
counted up to renaming the colours, and carries an empirical recurrence of order $2$
...
down to $S=90$ and makes the exact residual test affordable.
\end{abstract}
...
OEIS A214135 is ``Number of 0..4 colorings on an nX3 array circular in the 3 direction with new values 0..4 introduced in row major order.''. It has offset $1$ and begins
\[
1, 17, 514, 16388, 524296, 16777232, 536870944, 17179869248,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 34*a(n-1) -64*a(n-2).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 16:52:57, revision 12) this is still
...
\]
There are $(i-1)^{3}+(-1)^{3}(i-1)$ such colourings, which at $i=5$ is already more
...
state count is $S=90$ rather than the number of colourings.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A214135.
