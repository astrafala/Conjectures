...
\title{The empirical column recurrences for the table OEIS A251300}
...
\begin{abstract}
OEIS A251300 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A251300 is ``T(n,k)=Number of (n+1)X(k+1) 0..3 arrays with every 2X2 subblock summing to 3 6 or 9.''. It has offset $1$, is
read by antidiagonals, and begins
\[
84, 444, 444, 2356, 3140, 2356, 12556, 22536,\ \dots
\]
The entry carries the following block:
\begin{quote}\small
Empirical for column k:\\
k=1: a(n) = 10*a(n-1) -21*a(n-2) -20*a(n-3)\\
k=2: [order 7]\\
k=3: [order 18]\\
k=4: [order 44]\\
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 10:21:16, revision 6) these are still
...
The sequence is ``Number of (n+1)X(2) 0..3 arrays with every 2X2 subblock summing to 3 6 or 9.''. Its rows are the vertices of a digraph on
...
\[
a(n)\;=\;10\,a(n-1) - 21\,a(n-2) - 20\,a(n-3)
\]
...
$c_{1}$ & $27$ & $c_{3}$ & $970$ & $c_{5}$ & $-3449$ & $c_{7}$ & $840$ \\
$c_{2}$ & $-260$ & $c_{4}$ & $-405$ & $c_{6}$ & $-722$ &  &  \\
\end{tabular}\end{center}
Repeating with the first $7+4$ terms removed gives order $7$ again.

\subsection*{Column $k=3$, recovered}
The entry gives only the order for this line: ``k=3: [order 18]''. Its model is a walk on
...
$18$ --- the stated order --- with integer coefficients
\begin{center}\small\begin{tabular}{cccccccc}
$c_{1}$ & $70$ & $c_{6}$ & $63306$ & $c_{11}$ & $-887148665$ & $c_{16}$ & $-237739072$ \\
$c_{2}$ & $-2063$ & $c_{7}$ & $-20263462$ & $c_{12}$ & $-156301346$ & $c_{17}$ & $-16658880$ \\
$c_{3}$ & $32707$ & $c_{8}$ & $36944351$ & $c_{13}$ & $1188162821$ & $c_{18}$ & $16934400$ \\
$c_{4}$ & $-289660$ & $c_{9}$ & $154483968$ & $c_{14}$ & $919091600$ &  &  \\
$c_{5}$ & $1236213$ & $c_{10}$ & $-251174091$ & $c_{15}$ & $-91672228$ &  &  \\
\end{tabular}\end{center}
Repeating with the first $18+4$ terms removed gives order $18$ again.

\subsection*{Column $k=4$, recovered}
The entry gives only the order for this line: ``k=4: [order 44]''. Its model is a walk on
...
$44$ --- the stated order --- with integer coefficients
\[
(c_1,\dots,c_{44})=(180,\ -14781,\ 730630,\ -24111595,\ 555086319,\ -8985783552,\ 98949942605,\ -647796156160,\ 882754215177,\ 24908280360482,\ -203494191374813,\ 181825477805808,\ 5484452193315518,\ -21986222587047779,\ -72254617451472756,\ 535474117113796655,\ 652832651408939750,\ -7673158167846990497,\ -7365962704206630516,\ 71006846077096892525,\ 100259716410555978251,\ -363807490822335475038,\ -796334522653748968267,\ 717162169212450235554,\ 2897236666963920612541,\ 256247852278506573548,\ -5268639324464830040421,\ -2981015195574035215362,\ 5157235191948489437368,\ 4627562754563976489169,\ -2922582551326018029662,\ -3588426338200083292608,\ 1060916892387494398000,\ 1655068661464948231488,\ -303238933401047262336,\ -478857843836423155072,\ 82855366381438538496,\ 84458690273583399680,\ -18508837755575478784,\ -7748240988834023424,\ 2396240766872494080,\ 177978424445337600,\ -115928274567168000,\ 9941495316480000).
\]
Repeating with the first $44+4$ terms removed gives order $44$ again.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251300.
