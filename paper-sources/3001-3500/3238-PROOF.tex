...
\title{The empirical column recurrences for the table OEIS A263973}
...
\begin{abstract}
OEIS A263973 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A263973 is ``T(n,k)=Number of (n+1)X(k+1) arrays of permutations of 0..(n+1)*(k+1)-1 with each element having index change (+-,+-) 0,2 1,1 or 1,0.''. It has offset $1$, is
read by antidiagonals, and begins
\[
4, 20, 0, 108, 72, 16, 465, 1817,\ \dots
\]
...
k=4: [order 53]\\
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 10 2015 10:30:19, revision 6) these are still
...
The sequence is ``Number of (n+1)X(2) arrays of permutations of 0..(n+1)*(2)-1 with each element having index change (+-,+-) 0,2 1,1 or 1,0.''. Its rows are the vertices of a digraph on
...
$c_{1}$ & $7$ & $c_{4}$ & $-591$ & $c_{7}$ & $-415$ & $c_{10}$ & $-9$ \\
$c_{2}$ & $80$ & $c_{5}$ & $752$ & $c_{8}$ & $768$ &  &  \\
$c_{3}$ & $-135$ & $c_{6}$ & $-823$ & $c_{9}$ & $-81$ &  &  \\
\end{tabular}\end{center}
Repeating with the first $10+4$ terms removed gives order $10$ again.

\subsection*{Column $k=3$, recovered}
The entry gives only the order for this line: ``k=3: [order 27]''. Its model is a walk on
...
\[
(c_1,\dots,c_{27})=(48,\ -111,\ -13143,\ 131701,\ 59295,\ -4720800,\ 12779427,\ 19382471,\ -116442296,\ 280725335,\ -381462119,\ -578575706,\ 1756342049,\ -3626876273,\ 4852378354,\ 1964306003,\ -4666835695,\ 1402574008,\ -678640843,\ 169204617,\ 35040960,\ -9205311,\ 2141847,\ -540093,\ -13833,\ 11952,\ -675).
\]
Repeating with the first $27+4$ terms removed gives order $27$ again.

\subsection*{Column $k=4$, recovered}
The entry gives only the order for this line: ``k=4: [order 53]''. Its model is a walk on
...
$53$ --- the stated order --- with integer coefficients
\[
(c_1,\dots,c_{53})=(100,\ 6087,\ -390976,\ -8403494,\ 474196768,\ 5002152626,\ -260715013792,\ -1403473040977,\ 74204170986356,\ 138338337533047,\ -11747087671883792,\ 8825649132981656,\ 1022710783433343640,\ -2637146528978763792,\ -43525067588896056688,\ 161818387177195861296,\ 475912773522818875440,\ -1486483114546636158032,\ 17935195481479563200224,\ -145444951281278549025344,\ -249150635744669666536320,\ 3076760846040317647500032,\ -4785223727969525937227264,\ 15408224934677544376771584,\ -32145094419417547582588928,\ 129398530007428453999210496,\ -357210748892431242891976704,\ -15866489056824725565236297728,\ 78986562369395514289567662080,\ -6706712031173755395816226816,\ -534621920393806037643865751552,\ 989489981213535893481084157952,\ -668221624829111426184466923520,\ -1660479584643431598263078223872,\ 7190243724787351229119584010240,\ -5096317403500266722222499954688,\ -775947942823691568513814626304,\ -9684858390747275318422101032960,\ -1384504055891744739328585105408,\ 22414394229124014782591520473088,\ 6152966768214105487220402028544,\ 1009789285296792988461912031232,\ -31738133142848611382052595433472,\ -5477614633585659795158062858240,\ 24952030482858066877821394878464,\ -11893376156898118341195259183104,\ -16609890359806883924035606937600,\ 934705446545505551254435135488,\ 6021276219268172274751189811200,\ 1715056353044513427150040203264,\ -416882327215458005628814884864,\ -102651697537977396421338333184,\ 12979329830837562476939182080).
\]
Repeating with the first $53+4$ terms removed gives order $53$ again.
...
model reproduces $7$ published values, $11$ decimal digits in all, every one of
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A263973.
