...
\title{The empirical recurrence for OEIS A250734, proved by transfer matrix}
...
\begin{abstract}
OEIS A250734 counts arrays over $\{0,1\}$ in which a statistic taken over short runs
...
OEIS A250734 is ``Number of (5+1) X (n+1) 0..1 arrays with nondecreasing x(i,j)+x(i,j-1) in the i direction and nondecreasing min(x(i,j),x(i-1,j)) in the j direction.''. It has offset $1$ and begins
\[
99, 230, 600, 1500, 3605, 8514, 19887, 46315,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) - 17*a(n-3) + 17*a(n-4) + 12*a(n-5) - 23*a(n-6) + 6*a(n-7) + 3*a(n-8) - a(n-9) for n>12.
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 16 2018 13:52:05, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) - 17\,a(n-3) + 17\,a(n-4) + 12\,a(n-5) - 23\,a(n-6) + 6\,a(n-7) + 3\,a(n-8) - a(n-9)
\]
for every $n>12$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250734.
