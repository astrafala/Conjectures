...
\title{The empirical recurrence for OEIS A233123, proved by transfer matrix}
...
\begin{abstract}
OEIS A233123 carries an empirical recurrence of order $2$ contributed by R.~H.~Hardin. It is
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 19 2018 09:40:13, revision 7) this is still
