...
\title{The empirical recurrence for OEIS A206791, proved by transfer matrix}
...
\begin{abstract}
OEIS A206791 counts arrays of width $2$ over $\{0,1,2,3\}$ containing no occurrence of certain short
...
OEIS A206791 is ``Number of n X 2 0..3 arrays avoiding the pattern z z+1 z in any row, column, diagonal or antidiagonal.''. It has offset $1$ and begins
\[
16, 256, 3721, 53824, 779689, 11296321, 163660849, 2371105636,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 15*a(n-1) -11*a(n-2) +51*a(n-3) +13*a(n-4) -3*a(n-5) -a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (May 10 2020 02:15:46, revision 17) this is still
...
\begin{theorem}
\[
a(n)\;=\;15\,a(n-1) - 11\,a(n-2) + 51\,a(n-3) + 13\,a(n-4) - 3\,a(n-5) - a(n-6)
\]
for every $n>5$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206791.
