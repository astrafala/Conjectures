...
\title{The empirical recurrence for OEIS A253221, derived from the entry's generating function}
...
\begin{abstract}
OEIS A253221 carries an empirical recurrence of order $3$. The entry separately records a
...
OEIS A253221 is ``Number of n X 6 nonnegative integer arrays with upper left 0 and lower right its king-move distance away minus 2 and every value within 2 of its king move distance from the upper left and every value increasing by 0 or 1 with every step right, diagonally se or down.''. It has offset $1$ and begins
\[
10, 49, 263, 1249, 3568, 3568, 47698, 213155,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 12 2018 09:39:55, revision 13) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 50 x^{13} - 676 x^{12} - 4171 x^{11} - 15495 x^{10} - 38505 x^{9} - 77197 x^{8} - 46449 x^{7} + 3652 x^{6} - 561 x^{5} - 597 x^{4} - 146 x^{3} - 19 x^{2} - 10 x}{x^{3} - 3 x^{2} + 3 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;50 x^{13} + 676 x^{12} + 4171 x^{11} + 15495 x^{10} + 38505 x^{9} + 77197 x^{8} + 46449 x^{7} - 3652 x^{6} + 561 x^{5} + 597 x^{4} + 146 x^{3} + 19 x^{2} + 10 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253221.
