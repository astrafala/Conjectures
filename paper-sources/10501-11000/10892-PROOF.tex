...
\title{The empirical recurrence for OEIS A300177, proved by transfer matrix}
...
\begin{abstract}
OEIS A300177 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A300177 is ``Number of nX3 0..1 arrays with every element equal to 0, 1, 2, 3, 4, 5, 6 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
4, 32, 255, 2033, 16208, 129217, 1030173, 8212978,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 7*a(n-1) +7*a(n-2) +6*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 29 2018 18:18:30, revision
16) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;7\,a(n-1) + 7\,a(n-2) + 6\,a(n-3)
\end{equation}
for all $n>3$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A300177.
