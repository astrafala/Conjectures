...
\title{The empirical recurrence for OEIS A187384, derived from the entry's generating function}
...
\begin{abstract}
OEIS A187384 carries an empirical recurrence of order $3$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 24 2018 08:47:02, revision 10) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{2096 x^{11} - 1382 x^{10} + 2216 x^{9} - 6600 x^{8} - 4404 x^{7} - 6516 x^{6} - 2952 x^{5} - 280 x^{4}}{x^{3} - 3 x^{2} + 3 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 2096 x^{11} + 1382 x^{10} - 2216 x^{9} + 6600 x^{8} + 4404 x^{7} + 6516 x^{6} + 2952 x^{5} + 280 x^{4},
\]
