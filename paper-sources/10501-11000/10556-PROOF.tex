...
\title{The empirical recurrence for OEIS A267688, derived from the entry's generating function}
...
\begin{abstract}
OEIS A267688 carries an empirical recurrence of order $4$. The entry separately records a
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{1000 x^{4} - 10 x^{3} + x^{2} - 1}{1000 x^{4} - 110 x^{3} - 999 x^{2} + 110 x - 1},
\]
