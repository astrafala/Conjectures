...
\title{The empirical recurrence for OEIS A187029, derived from the entry's generating function}
...
\begin{abstract}
OEIS A187029 carries an empirical recurrence of order $3$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 20 2018 06:08:47, revision 10) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{224 x^{8} + 36 x^{7} - 468 x^{6} - 2408 x^{5} - 3096 x^{4} - 1272 x^{3} - 24 x^{2}}{x^{3} - 3 x^{2} + 3 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 224 x^{8} - 36 x^{7} + 468 x^{6} + 2408 x^{5} + 3096 x^{4} + 1272 x^{3} + 24 x^{2},
\]
