...
\title{The empirical recurrence for OEIS A232454, proved by transfer matrix}
...
\begin{abstract}
OEIS A232454 counts arrays of width $3$ over $\{0,1,2\}$ in which every cell carrying one stated
...
OEIS A232454 is ``Number of nX3 0..2 arrays with every 0 next to a 1 and every 1 next to a 2 horizontally, vertically, diagonally or antidiagonally.''. It has offset $1$ and begins
\[
7, 381, 8227, 187989, 4423815, 103104905, 2403848151, 56071521045,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 07:27:04, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;17\,a(n-1) + 110\,a(n-2) + 838\,a(n-3) + 888\,a(n-4) - 958\,a(n-5) - 4291\,a(n-6) - 2173\,a(n-7) + 1764\,a(n-8) + 2290\,a(n-9)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232454.
