...
\title{The empirical recurrence for OEIS A197403, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A197403 counts arrays over $\{0,\dots,4\}$ in which every cell is constrained by the
...
OEIS A197403 is ``Number of n X 2 0..4 arrays with each element x equal to the number its horizontal and vertical neighbors equal to 3,0,1,1,1 for x=0,1,2,3,4.''. It has offset $1$ and begins
\[
3, 9, 20, 71, 227, 664, 2107, 6675,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) + 4*a(n-2) + 7*a(n-3) - 10*a(n-4) - 39*a(n-5) - 30*a(n-6) - 12*a(n-7) + 5*a(n-8) + 2*a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 01 2018 14:31:28, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 4\,a(n-2) + 7\,a(n-3) - 10\,a(n-4) - 39\,a(n-5) - 30\,a(n-6) - 12\,a(n-7) + 5\,a(n-8) + 2\,a(n-9)
\end{equation}
for all $n>10$.
...
\#\{\text{neighbours with value }f(x_{t,u})\}=x_{t,u},\quad f=(3,0,1,1,1)
\end{equation}
for every cell $(t,u)$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A197403.
