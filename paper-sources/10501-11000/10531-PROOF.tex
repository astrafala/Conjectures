...
\title{The empirical recurrence for OEIS A250904, proved by transfer matrix}
...
\begin{abstract}
OEIS A250904 counts arrays over $\{0,1,2\}$ in which a statistic taken over short runs
...
OEIS A250904 is ``Number of (6+1) X (n+1) 0..2 arrays with nondecreasing x(i,j)-x(i,j-1) in the i direction and nondecreasing absolute value of x(i,j)-x(i-1,j) in the j direction.''. It has offset $1$ and begins
\[
13111, 47061, 136509, 357335, 890199, 2168405, 5232461, 12579759,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 14*a(n-1) - 85*a(n-2) + 294*a(n-3) - 639*a(n-4) + 906*a(n-5) - 839*a(n-6) + 490*a(n-7) - 164*a(n-8) + 24*a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 23 2018 21:17:40, revision 10) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250904.
