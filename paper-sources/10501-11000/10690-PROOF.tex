...
\title{The empirical recurrence for OEIS A187589, derived from the entry's generating function}
...
\begin{abstract}
OEIS A187589 carries an empirical recurrence of order $3$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 24 2018 15:28:33, revision 10) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{93 x^{7} - 41 x^{6} - 619 x^{5} - 757 x^{4} - 104 x^{3}}{x^{3} - 3 x^{2} + 3 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 93 x^{7} + 41 x^{6} + 619 x^{5} + 757 x^{4} + 104 x^{3},
\]
