...
\title{The empirical recurrence for OEIS A187591, derived from the entry's generating function}
...
\begin{abstract}
OEIS A187591 carries an empirical recurrence of order $3$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 24 2018 23:15:31, revision 11) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{663 x^{9} + 1095 x^{8} - 1481 x^{7} - 7443 x^{6} - 8231 x^{5} - 2207 x^{4} - 34 x^{3}}{x^{3} - 3 x^{2} + 3 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 663 x^{9} - 1095 x^{8} + 1481 x^{7} + 7443 x^{6} + 8231 x^{5} + 2207 x^{4} + 34 x^{3},
\]
