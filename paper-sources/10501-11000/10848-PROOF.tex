...
\title{The empirical recurrence for OEIS A197311, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A197311 counts arrays over $\{0,\dots,4\}$ in which every cell is constrained by the
...
OEIS A197311 is ``Number of n X 2 0..4 arrays with each element x equal to the number its horizontal and vertical neighbors equal to 0,1,1,0,0 for x=0,1,2,3,4.''. It has offset $1$ and begins
\[
1, 0, 3, 2, 9, 6, 27, 18,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +6*a(n-2) -6*a(n-3) -9*a(n-4) +10*a(n-5) -3*a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (May 12 2018 08:45:54, revision 9) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A197311.
