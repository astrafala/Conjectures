...
\title{The empirical recurrence for OEIS A304227, proved by transfer matrix}
...
\begin{abstract}
OEIS A304227 counts $5$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A304227 is ``Number of n X 5 0..1 arrays with every element unequal to 0, 1, 2 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
16, 8, 11, 20, 31, 89, 237, 494,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +9*a(n-3) -14*a(n-6) for n>10.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 19 2025 20:37:30, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A304227.
