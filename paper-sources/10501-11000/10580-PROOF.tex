...
\title{The empirical recurrence for OEIS A163020, derived from the entry's generating function}
...
\begin{abstract}
OEIS A163020 carries an empirical recurrence of order $9$. The entry separately records a
...
OEIS A163020 is ``Number of nX3 binary arrays with all 1s connected and a path of 1s from left column to lower right corner.''. It has offset $1$ and begins
\[
1, 12, 82, 469, 2502, 12966, 66325, 337222,\ \dots
\]
...
\begin{quote}
G.f.: x*(-1-2*x+5*x\^{}2+x\^{}4+x\^{}6)/((x-1)*(x\^{}2+2*x-1)*(x\^{}6-7*x\^{}5+x\^{}4+6*x\^{}3-11*x\^{}2+7*x-1)). (End)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 07 2024 03:22:33, revision 9) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{x^{7} + x^{5} + 5 x^{3} - 2 x^{2} - x}{x^{9} - 6 x^{8} - 9 x^{7} + 29 x^{6} - 15 x^{5} - 21 x^{4} + 45 x^{3} - 33 x^{2} + 10 x - 1},
\]
the entry's own generating function, and let
\[
D(x)\;=\;1-\sum_i c_i x^{i}\;=\;- x^{9} + 6 x^{8} + 9 x^{7} - 29 x^{6} + 15 x^{5} + 21 x^{4} - 45 x^{3} + 33 x^{2} - 10 x + 1
\]
...
\begin{theorem}
\[
a(n)\;=\;10\,a(n-1) - 33\,a(n-2) + 45\,a(n-3) - 21\,a(n-4) - 15\,a(n-5) + 29\,a(n-6) - 9\,a(n-7) - 6\,a(n-8) + a(n-9)
\]
for every $n>7$.
\end{theorem}
...
\[
x^{9} - 6 x^{8} - 9 x^{7} + 29 x^{6} - 15 x^{5} - 21 x^{4} + 45 x^{3} - 33 x^{2} + 10 x - 1,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A163020.
