...
\title{The empirical recurrence for OEIS A251085, proved by transfer matrix}
...
\begin{abstract}
OEIS A251085 counts $(n+1)\times6$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A251085 is ``Number of (n+1) X (5+1) 0..2 arrays with no 2 X 2 subblock having the sum of its diagonal elements greater than the absolute difference of its antidiagonal elements.''. It has offset $1$ and begins
\[
872, 2534, 4379, 8512, 14891, 27040, 48017, 87488,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 6*a(n-1) - 13*a(n-2) + 10*a(n-3) + 5*a(n-4) - 14*a(n-5) + 9*a(n-6) - 2*a(n-7) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 24 2018 12:06:12, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251085.
