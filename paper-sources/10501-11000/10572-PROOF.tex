...
\title{The empirical recurrence for OEIS A187852, derived from the entry's generating function}
...
\begin{abstract}
OEIS A187852 carries an empirical recurrence of order $3$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 26 2018 08:38:44, revision 10) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{96 x^{8} + 264 x^{7} - 256 x^{6} - 2268 x^{5} - 3492 x^{4} - 1328 x^{3} - 24 x^{2}}{x^{3} - 3 x^{2} + 3 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 96 x^{8} - 264 x^{7} + 256 x^{6} + 2268 x^{5} + 3492 x^{4} + 1328 x^{3} + 24 x^{2},
\]
