...
\title{The empirical recurrence for OEIS A186566, proved by transfer matrix}
...
\begin{abstract}
OEIS A186566 counts the $(n+2)\times9$ arrays over $\{0,\dots,2\}$ in which
...
a state, the count is a walk count on $S=29303$ of them, and the conjectured recurrence is then
...
OEIS A186566 is ``Number of (n+2)X9 0..2 arrays with every 3X3 subblock commuting with each horizontal and vertical neighbor 3X3 subblock.''. It has offset $1$ and begins
\[
29303, 4033, 6511, 14845, 27391, 36133, 47719, 60973,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n)=2*a(n-1)-a(n-2)+2*a(n-3)-4*a(n-4)+2*a(n-5)+2*a(n-6)-2*a(n-7) for n>15
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 03:35:55, revision 9) this is still
...
$29303$, which the model reproduces along with every later term.
...
\]
on the $S=29303$ admissible $3$-tuples. In particular $a$ is $C$-finite.
...
size of the construction is therefore $3^{3\cdot9}$ before the condition prunes
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A186566.
