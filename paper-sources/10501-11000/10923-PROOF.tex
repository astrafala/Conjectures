...
\title{The empirical recurrence for OEIS A226265, derived from the entry's generating function}
...
\begin{abstract}
OEIS A226265 carries an empirical recurrence of order $2$. The entry separately records a
...
OEIS A226265 is ``Number of additive Z\_2 Z\_8 codes of a certain type (see Siap-Aydogdu for precise definition).''. It has offset $1$ and begins
\[
504, 1176, 2520, 5208, 10584, 21336, 42840, 85848,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 05 2025 15:22:24, revision 23) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 336 x^{2} + 504 x}{2 x^{2} - 3 x + 1},
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A226265.
