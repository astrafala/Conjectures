...
\title{The empirical recurrence for OEIS A221686, derived from the entry's generating function}
...
\begin{abstract}
OEIS A221686 carries an empirical recurrence of order $3$. The entry separately records a
...
OEIS A221686 is ``Number of 0..n arrays of length 7 with each element differing from at least one neighbor by 1 or less, starting with 0.''. It has offset $1$ and begins
\[
64, 320, 844, 1692, 2856, 4326, 6102, 8184,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2018 09:14:41, revision 7) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{10 x^{6} + 8 x^{5} - 56 x^{4} - 76 x^{3} - 128 x^{2} - 64 x}{x^{3} - 3 x^{2} + 3 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 10 x^{6} - 8 x^{5} + 56 x^{4} + 76 x^{3} + 128 x^{2} + 64 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221686.
