...
\title{The empirical recurrence for OEIS A087970, derived from the entry's generating function}
...
\begin{abstract}
OEIS A087970 carries an empirical recurrence of order $2$. The entry separately records a
...
OEIS A087970 is ``Maximal term in Collatz-iteration started at 2\^{}n+1.''. It has offset $0$ and begins
\[
2, 16, 16, 52, 52, 100, 196, 9232,\ \dots
\]
The entry states, as a conjecture and never marked settled:
\begin{quote}
a(n) = 3*a(n-1) - 2*a(n-2) for n > 13.
\end{quote}
and, separately and NOT as a conjecture:
\begin{quote}
G.f.: (6168*x\^{}13 - 9252*x\^{}12 + 3084*x\^{}11 + 16920*x\^{}10 - 7692*x\^{}9 - 18072*x\^{}8 + 8844*x\^{}7 + 48*x\^{}5 - 72*x\^{}4 + 36*x\^{}3 - 28*x\^{}2 + 10*x + 2)/((x - 1)*(2*x - 1)). (End)
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 29 2026 13:29:32, revision 19) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{6168 x^{13} - 9252 x^{12} + 3084 x^{11} + 16920 x^{10} - 7692 x^{9} - 18072 x^{8} + 8844 x^{7} + 48 x^{5} - 72 x^{4} + 36 x^{3} - 28 x^{2} + 10 x + 2}{2 x^{2} - 3 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;6168 x^{13} - 9252 x^{12} + 3084 x^{11} + 16920 x^{10} - 7692 x^{9} - 18072 x^{8} + 8844 x^{7} + 48 x^{5} - 72 x^{4} + 36 x^{3} - 28 x^{2} + 10 x + 2,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A087970.
