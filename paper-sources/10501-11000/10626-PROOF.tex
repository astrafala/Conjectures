...
\title{The empirical recurrence for OEIS A266844, derived from the entry's generating function}
...
\begin{abstract}
OEIS A266844 carries an empirical recurrence of order $3$. The entry separately records a
...
OEIS A266844 is ``Binary representation of the n-th iteration of the "Rule 70" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 110, 10100, 1101000, 101010000, 11010100000, 1010101000000, 110101010000000,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 16 2025 08:33:28, revision 24) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 1000 x^{2} + 100 x + 1}{100000 x^{3} - 10000 x^{2} - 10 x + 1},
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A266844.
