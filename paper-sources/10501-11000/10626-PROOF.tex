...
\title{The empirical recurrence for OEIS A297818, proved by transfer matrix}
...
\begin{abstract}
OEIS A297818 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $equal to$ itself lying in $\{1,2,3\}$, and it carries an empirical
...
OEIS A297818 is ``Number of nX3 0..1 arrays with every element equal to 1, 2 or 3 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 17, 48, 146, 399, 1114, 3124, 8861,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) -a(n-2) -a(n-3) +7*a(n-4) -a(n-5) +2*a(n-6) +2*a(n-7) +2*a(n-9) for n>11
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 06 2018 10:54:58, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) - a(n-2) - a(n-3) + 7\,a(n-4) - a(n-5) + 2\,a(n-6) + 2\,a(n-7) + 2\,a(n-9)
\end{equation}
for all $n>11$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297818.
