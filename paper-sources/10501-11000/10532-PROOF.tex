...
\title{The empirical recurrence for OEIS A187049, derived from the entry's generating function}
...
\begin{abstract}
OEIS A187049 carries an empirical recurrence of order $3$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 20 2018 10:05:11, revision 11) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{148 x^{10} + 164 x^{9} - 280 x^{8} - 1232 x^{7} - 1888 x^{6} - 1552 x^{5} - 432 x^{4} - 8 x^{3}}{x^{3} - 3 x^{2} + 3 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 148 x^{10} - 164 x^{9} + 280 x^{8} + 1232 x^{7} + 1888 x^{6} + 1552 x^{5} + 432 x^{4} + 8 x^{3},
\]
