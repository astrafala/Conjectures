...
\title{The empirical recurrence for OEIS A223337, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A223337 counts arrays over $\{0,\dots,14\}$ in which every cell is constrained by the
...
\[
15, 60, 264, 1176, 5280, 23712, 106560, 478848,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 4*a(n-1) + 4*a(n-2) - 8*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 19 2018 16:42:42, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) + 4\,a(n-2) - 8\,a(n-3)
\end{equation}
for all $n>4$.
...
publishes, $n=21$, the arrays have $1\cdot21$ cells over
$15$ values, so there are about $10^{24}$ of them to sift. The
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223337.
