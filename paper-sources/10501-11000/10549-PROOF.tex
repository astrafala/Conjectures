...
\title{The empirical recurrence for OEIS A251094, proved by transfer matrix}
...
\begin{abstract}
OEIS A251094 counts $(n+1)\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A251094 is ``Number of (n+1) X (2+1) 0..1 arrays with no 2 X 2 subblock having its minimum diagonal element less than its minimum antidiagonal element.''. It has offset $1$ and begins
\[
41, 212, 1109, 5817, 30517, 160086, 839758, 4405079,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 7*a(n-1) - 11*a(n-2) + 10*a(n-3) - 3*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 25 2018 09:35:23, revision 7) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251094.
