...
\title{The empirical recurrence for OEIS A202444, proved by transfer matrix}
...
\begin{abstract}
OEIS A202444 counts arrays of width $7$ over $\{0,1\}$ containing no occurrence of certain short
...
OEIS A202444 is ``Number of (n+2) X 7 binary arrays avoiding patterns 001 and 110 in rows, columns and nw-to-se diagonals.''. It has offset $1$ and begins
\[
484, 836, 1722, 3122, 5512, 8996, 14338, 21674,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) -8*a(n-3) +6*a(n-4) +6*a(n-5) -8*a(n-6) +3*a(n-8) -a(n-9) for n>10.
\end{quote}
As of the ``Last modified'' line on the live entry (May 31 2018 08:17:17, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A202444.
