...
\title{The empirical recurrence for OEIS A234825, proved by transfer matrix}
...
\begin{abstract}
OEIS A234825 counts arrays of width $2$ over $\{0,1,2\}$ subject to a condition read round the
...
count is a walk count on a finite digraph with $S=10$ vertices, and whether a linear
...
OEIS A234825 is ``Number of (n+1) X (1+1) 0..2 arrays with each 2 X 2 subblock having the number of clockwise edge increases less than or equal to the number of counterclockwise edge increases.''. It has offset $1$ and begins
\[
69, 516, 3843, 28602, 212850, 1583955, 11787201, 87715899,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 9*a(n-1) - 12*a(n-2) + 3*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 16 2018 07:56:20, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234825.
