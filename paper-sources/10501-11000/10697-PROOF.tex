...
\title{The empirical recurrence for OEIS A264536, proved by transfer matrix}
...
\begin{abstract}
OEIS A264536 carries an empirical recurrence of order $5$ contributed by R.~H.~Hardin. It is
...
OEIS A264536 is ``Number of (3+1) X (n+1) arrays of permutations of 0..n*4+3 with each element having directed index change -2,-2 -1,0 0,1 or 1,0.''. It has offset $1$ and begins
\[
1, 4, 13, 29, 89, 261, 673, 1949,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + 12*a(n-3) + 16*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 08 2019 09:50:57, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264536.
