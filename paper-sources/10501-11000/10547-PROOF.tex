...
\title{The empirical recurrence for OEIS A232937, proved by transfer matrix}
...
\begin{abstract}
OEIS A232937 counts arrays of width $4$ over $\{0,\dots,2\}$ under a condition on each cell
...
OEIS A232937 is ``Number of n X 4 0..2 arrays with no element x(i,j) adjacent to value 2-x(i,j) horizontally, vertically or antidiagonally.''. It has offset $1$ and begins
\[
24, 56, 252, 1048, 4458, 18850, 79810, 337850,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + 10*a(n-2) + 15*a(n-3) + 4*a(n-4) - 6*a(n-5) - a(n-6) + 3*a(n-7) - a(n-8) for n>9.
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 06 2018 06:15:10, revision 8) this is still
...
$24$, which the model reproduces along with every later term. That is the cheapest check
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232937.
