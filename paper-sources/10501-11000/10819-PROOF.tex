...
\title{The empirical recurrence for OEIS A206679, proved by transfer matrix}
...
\begin{abstract}
OEIS A206679 counts arrays over $\{0,\dots,2\}$ under a condition on the perimeter cycle of
every $2\times3$ and $3\times2$ subblock, and carries an empirical recurrence of order $5$ contributed by
R.~H.~Hardin. It is true, and it is decidable rather than empirical. The condition is local to
a bounded window of consecutive rows, so the count is a walk count on $S=306$ states and is
...
OEIS A206679 is ``Number of (n+1) X 3 0..2 arrays with every 2 X 3 or 3 X 2 subblock having an unequal number of clockwise and counterclockwise edge increases.''. It has offset $1$ and begins
\[
306, 1728, 9792, 55836, 317736, 1809324, 10300608, 58646916,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) + 13*a(n-2) + 11*a(n-3) + 12*a(n-4) + 6*a(n-5) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 17 2018 08:14:15, revision 10) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + 13\,a(n-2) + 11\,a(n-3) + 12\,a(n-4) + 6\,a(n-5)
\]
for every $n>6$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206679.
