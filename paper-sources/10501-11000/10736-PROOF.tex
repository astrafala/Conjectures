...
\title{The empirical recurrence for OEIS A252832, derived from the entry's generating function}
...
\begin{abstract}
OEIS A252832 carries an empirical recurrence of order $3$. The entry separately records a
...
OEIS A252832 is ``Number of n X 4 nonnegative integer arrays with upper left 0 and every value within 2 of its king move distance from the upper left and every value increasing by 0 or 1 with every step right, diagonally se or down.''. It has offset $1$ and begins
\[
7, 29, 127, 493, 1474, 3365, 6211, 10017,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 06 2018 16:36:54, revision 7) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 5 x^{8} - 45 x^{7} - 295 x^{6} - 347 x^{5} - 192 x^{4} - 61 x^{3} - 8 x^{2} - 7 x}{x^{3} - 3 x^{2} + 3 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;5 x^{8} + 45 x^{7} + 295 x^{6} + 347 x^{5} + 192 x^{4} + 61 x^{3} + 8 x^{2} + 7 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252832.
