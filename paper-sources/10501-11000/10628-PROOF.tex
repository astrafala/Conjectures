...
\title{The empirical recurrence for OEIS A266975, derived from the entry's generating function}
...
\begin{abstract}
OEIS A266975 carries an empirical recurrence of order $3$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 16 2025 08:33:29, revision 24) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 10000 x^{3} + 100 x + 1}{100000 x^{3} - 10000 x^{2} - 10 x + 1},
\]
the entry's own generating function, and let
\[
D(x)\;=\;1-\sum_i c_i x^{i}\;=\;100000 x^{3} - 10000 x^{2} - 10 x + 1
\]
