...
\title{The empirical recurrence for OEIS A230180, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A230180 counts arrays over $\{0,\dots,2\}$ in which every cell is constrained by the
...
OEIS A230180 is ``Number of n X 4 0..2 arrays x(i,j) with each element horizontally or antidiagonally next to at least one element with value 2-x(i,j).''. It has offset $1$ and begins
\[
9, 159, 3411, 73857, 1603431, 34825803, 756450105, 16430979183,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 26*a(n-1) - 97*a(n-2) + 89*a(n-3) - 18*a(n-4) + a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 21 2018 12:00:45, revision 7) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A230180.
