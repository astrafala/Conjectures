...
\title{The empirical recurrence for OEIS A183344, proved by transfer matrix}
...
\begin{abstract}
OEIS A183344 counts arrays of width $2$ over $\{0,1\}$ under local conditions relating each cell
...
OEIS A183344 is ``Number of n X 2 binary arrays with each 1 adjacent to exactly one 0 vertically and one 0 horizontally.''. It has offset $1$ and begins
\[
1, 7, 9, 17, 33, 59, 109, 201,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + a(n-2) + a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 27 2018 14:50:47, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The array has $2$ cells across, with entries in $\{0,1\}$. The NEIGHBOURS of a cell are the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A183344.
