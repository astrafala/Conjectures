...
\title{The empirical recurrence for OEIS A187381, derived from the entry's generating function}
...
\begin{abstract}
OEIS A187381 carries an empirical recurrence of order $3$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 24 2018 06:43:32, revision 10) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{129 x^{8} - 167 x^{7} - 148 x^{6} - 500 x^{5} - 270 x^{4} - 18 x^{3}}{x^{3} - 3 x^{2} + 3 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 129 x^{8} + 167 x^{7} + 148 x^{6} + 500 x^{5} + 270 x^{4} + 18 x^{3},
\]
