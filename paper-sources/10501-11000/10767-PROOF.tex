...
\title{The empirical recurrence for OEIS A262779, derived from the entry's generating function}
...
\begin{abstract}
OEIS A262779 carries an empirical recurrence of order $2$. The entry separately records a
...
OEIS A262779 is ``Binary representation of the n-th iteration of the "Rule 175" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 110, 11011, 1101111, 110111111, 11011111111, 1101111111111, 110111111111111,\ \dots
\]
...
\begin{quote}
G.f.: (1+9*x+x\^{}2) / ((1-x)*(1-100*x)).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 16 2025 08:33:27, revision 58) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{x^{2} + 9 x + 1}{100 x^{2} - 101 x + 1},
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A262779.
