...
\title{The empirical recurrence for OEIS A203358, proved by transfer matrix}
...
\begin{abstract}
OEIS A203358 counts arrays of width $4$ over $\{0,1\}$ under local conditions relating each cell
...
OEIS A203358 is ``Number of n X 4 binary arrays with every 1 immediately preceded by 0 to the left or above.''. It has offset $1$ and begins
\[
5, 61, 565, 5677, 55517, 547897, 5390325, 53087833,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 5*a(n-1) +42*a(n-2) +54*a(n-3) +23*a(n-4) -7*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 04 2018 05:47:33, revision 9) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The array has $4$ cells across, with entries in $\{0,1\}$. The NEIGHBOURS of a cell are the
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) + 42\,a(n-2) + 54\,a(n-3) + 23\,a(n-4) - 7\,a(n-5)
\]
for every $n>4$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A203358.
