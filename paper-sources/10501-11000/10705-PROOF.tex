...
\title{The empirical recurrence for OEIS A187859, derived from the entry's generating function}
...
\begin{abstract}
OEIS A187859 carries an empirical recurrence of order $3$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 26 2018 08:56:39, revision 10) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{141 x^{8} - 247 x^{7} + 146 x^{6} - 498 x^{5} - 320 x^{4} - 216 x^{3}}{x^{3} - 3 x^{2} + 3 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 141 x^{8} + 247 x^{7} - 146 x^{6} + 498 x^{5} + 320 x^{4} + 216 x^{3},
\]
