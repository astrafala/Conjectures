...
\title{The empirical recurrence for OEIS A233251, proved by transfer matrix}
...
\begin{abstract}
OEIS A233251 carries an empirical recurrence of order $2$ contributed by R.~H.~Hardin. It is
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 10 2018 15:54:06, revision 9) this is still
