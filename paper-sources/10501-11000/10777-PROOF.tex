...
\title{The empirical recurrence for OEIS A264340, proved by transfer matrix}
...
\begin{abstract}
OEIS A264340 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=8$ rows in which
...
OEIS A264340 is ``Number of (n+1)X(7+1) arrays of permutations of 0..n*8+7 with each element having index change +-(.,.) 0,0 0,1 or 1,2.''. It has offset $1$ and begins
\[
9409, 1759250, 345358201, 67833964762, 13323150080401, 2616784941180034, 513959727627375369, 100946240914292115722,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 191*a(n-1) +1102*a(n-2) -7594*a(n-3) -38349*a(n-4) +38507*a(n-5)
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 11 2015 19:42:42, revision 4) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264340.
