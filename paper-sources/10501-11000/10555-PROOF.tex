...
\title{The empirical recurrence for OEIS A267681, derived from the entry's generating function}
...
\begin{abstract}
OEIS A267681 carries an empirical recurrence of order $4$. The entry separately records a
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{40 x^{4} - 14 x^{3} - 21 x^{2} + 5 x - 1}{16 x^{4} - 20 x^{3} + 5 x - 1},
\]
the entry's own generating function, and let
\[
D(x)\;=\;1-\sum_i c_i x^{i}\;=\;- 16 x^{4} + 20 x^{3} - 5 x + 1
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 40 x^{4} + 14 x^{3} + 21 x^{2} - 5 x + 1,
\]
