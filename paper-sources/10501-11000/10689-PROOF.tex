...
\title{The empirical recurrence for OEIS A187515, derived from the entry's generating function}
...
\begin{abstract}
OEIS A187515 carries an empirical recurrence of order $3$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 24 2018 11:08:39, revision 10) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{15 x^{11} + 107 x^{10} + 324 x^{9} + 172 x^{8} - 1366 x^{7} - 3386 x^{6} - 2674 x^{5} - 398 x^{4}}{x^{3} - 3 x^{2} + 3 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 15 x^{11} - 107 x^{10} - 324 x^{9} - 172 x^{8} + 1366 x^{7} + 3386 x^{6} + 2674 x^{5} + 398 x^{4},
\]
