...
\title{The empirical recurrence for OEIS A267873, derived from the entry's generating function}
...
\begin{abstract}
OEIS A267873 carries an empirical recurrence of order $2$. The entry separately records a
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{4} + 3 x^{2} - x + 1}{x^{2} - 2 x + 1},
\]
