...
\title{The empirical recurrence for OEIS A250609, proved by transfer matrix}
...
\begin{abstract}
OEIS A250609 counts arrays over $\{0,1\}$ in which a statistic taken over short runs
...
OEIS A250609 is ``Number of (n+1) X (6+1) 0..1 arrays with nondecreasing x(i,j)-x(i,j-1) in the i direction and nondecreasing x(i,j)-x(i-1,j) in the j direction.''. It has offset $1$ and begins
\[
502, 1172, 2236, 3890, 6526, 10928, 18664, 32870,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 5*a(n-1) - 9*a(n-2) + 7*a(n-3) - 2*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 15 2018 08:38:48, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250609.
