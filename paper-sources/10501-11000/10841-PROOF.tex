...
\title{The empirical recurrence for OEIS A296733, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A296733 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A296733 is ``Number of n X 2 0..1 arrays with each 1 adjacent to 1, 2 or 4 king-move neighboring 1s.''. It has offset $1$ and begins
\[
2, 11, 31, 88, 287, 881, 2686, 8347,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) - a(n-2) + 8*a(n-3) - 12*a(n-4) + 2*a(n-5) - 12*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 25 2019 08:15:56, revision 7) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) - a(n-2) + 8\,a(n-3) - 12\,a(n-4) + 2\,a(n-5) - 12\,a(n-6)
\end{equation}
for all $n>7$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A296733.
