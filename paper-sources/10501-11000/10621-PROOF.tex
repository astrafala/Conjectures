...
\title{The empirical recurrence for OEIS A188748, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A188748 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A188748 is ``Number of 3 X n binary arrays without the pattern 1 1 1 diagonally, vertically or antidiagonally.''. It has offset $1$ and begins
\[
7, 49, 292, 1723, 10327, 61996, 371641, 2227333,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 6*a(n-1) -2*a(n-2) +11*a(n-3) +10*a(n-4) -30*a(n-5) -12*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 20 2018 05:19:07, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) - 2\,a(n-2) + 11\,a(n-3) + 10\,a(n-4) - 30\,a(n-5) - 12\,a(n-6)
\end{equation}
for all $n>7$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A188748.
