...
\title{The empirical recurrence for OEIS A283544, proved by transfer matrix}
...
\begin{abstract}
OEIS A283544 counts $3\times n$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A283544 is ``Number of 3 X n 0..1 arrays with no 1 equal to more than one of its horizontal, diagonal and antidiagonal neighbors.''. It has offset $1$ and begins
\[
8, 33, 127, 578, 2369, 10069, 42664, 179733,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) +7*a(n-2) +11*a(n-3) -6*a(n-4) +11*a(n-5) -2*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 17 2022 22:15:37, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 7\,a(n-2) + 11\,a(n-3) - 6\,a(n-4) + 11\,a(n-5) - 2\,a(n-6)
\]
for every $n>6$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A283544.
