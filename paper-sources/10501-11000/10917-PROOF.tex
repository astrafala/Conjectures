...
\title{A proof of the conjectured recurrence for OEIS A158826}
...
\begin{abstract}
OEIS A158826 carries a conjectured linear recurrence with polynomial coefficients, of
...
computed in closed form. Here it equals $1920 x^{5} - 3480 x^{4}$, a polynomial of degree $5$, which proves
...
OEIS A158826 is ``Third iteration of x*C(x) where C(x) is the Catalan function (A000108)''. It has offset $1$ and begins
\[
a(1),\dots,a(8)\;=\;1, 3, 12, 54, 260, 1310, 6824, 36478,\ \dots
\]
The entry gives the generating function
\begin{equation}\label{eq:gf}
A(x)\;=\;\sum_{n\ge 1} a(n)\,x^{n}\;=\;\frac{1}{2} - \frac{\sqrt{2 \sqrt{2 \sqrt{1 - 4 x} - 1} - 1}}{2} ,
\end{equation}
and it carries the following comment:
\begin{quote}\small
Conjecture D-finite with recurrence 1053*n*(n-1)*(n-2)*(n-3)*a(n) -36*(n-1)*(n-2)*(n-3)*(634*n-1367)*a(n-1) +24*(n-2)*(n-3)*(7966*n\textasciicircum{}2-43500*n+61181)*a(n-2) -8*(n-3)*(96128*n\textasciicircum{}3-957424*n\textasciicircum{}2+3221878*n-3665189)*a(n-3) +16*(91904*n\textasciicircum{}4-1446528*n\textasciicircum{}3+8575792*n\textasciicircum{}2-22703688*n+22652013)*a(n-4) -256*(8*n-35)*(8*n-41)*(8*n-39)*(8*n-37)*a(n-5)=0. - \emph{R. J. Mathar}, Aug 30 2021
\end{quote}
As of the ``Last modified'' line on the live entry (2026-05-25, revision 54) the
...
\[
p_{0}(n)=1053 n \left(n - 3\right) \left(n - 2\right) \left(n - 1\right),\qquad p_{1}(n)=- 36 \left(n - 3\right) \left(n - 2\right) \left(n - 1\right) \left(634 n - 1367\right),\qquad p_{2}(n)=24 \left(n - 3\right) \left(n - 2\right) \left(7966 n^{2} - 43500 n + 61181\right),\qquad p_{3}(n)=- 8 \left(n - 3\right) \left(96128 n^{3} - 957424 n^{2} + 3221878 n - 3665189\right),\qquad p_{4}(n)=16 \left(91904 n^{4} - 1446528 n^{3} + 8575792 n^{2} - 22703688 n + 22652013\right),\qquad p_{5}(n)=- 256 \left(8 n - 41\right) \left(8 n - 39\right) \left(8 n - 37\right) \left(8 n - 35\right)
\]
...
\[
1053 n \left(n - 3\right) \left(n - 2\right) \left(n - 1\right)\,a(n) -  36 \left(n - 3\right) \left(n - 2\right) \left(n - 1\right) \left(634 n - 1367\right)\,a(n-1) + 24 \left(n - 3\right) \left(n - 2\right) \left(7966 n^{2} - 43500 n + 61181\right)\,a(n-2) -  8 \left(n - 3\right) \left(96128 n^{3} - 957424 n^{2} + 3221878 n - 3665189\right)\,a(n-3) + 16 \left(91904 n^{4} - 1446528 n^{3} + 8575792 n^{2} - 22703688 n + 22652013\right)\,a(n-4) -  256 \left(8 n - 41\right) \left(8 n - 39\right) \left(8 n - 37\right) \left(8 n - 35\right)\,a(n-5) \;=\;0
\]
holds for every $n>5$.
\end{theorem}
...
section of A158826, agreeing on all 13 terms compared.
...
vanish, for all 16 values of $n$ from $n=7$ upward. This is what
...
cancellation in $K$, not by series truncation, so the identity $B=1920 x^{5} - 3480 x^{4}$ is an
...
\url{https://oeis.org}, 2026. Sequence A158826.
