...
\title{The empirical recurrence for OEIS A186480, proved by transfer matrix}
...
\begin{abstract}
OEIS A186480 counts the $(n+1)\times8$ arrays over $\{0,\dots,3\}$ in which
neighbouring $2\times2$ subblocks commute as matrices, and carries an empirical
recurrence
...
a state, the count is a walk count on $S=20079$ of them, and the conjectured recurrence is then
...
OEIS A186480 is ``Number of (n+1)X8 0..3 arrays with every 2X2 subblock commuting with each of its horizontal and vertical 2X2 subblock neighbors.''. It has offset $1$ and begins
\[
20079, 14492, 82632, 101305, 433513, 418177, 1849873, 1894849,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n)=2*a(n-1)+2*a(n-2)-6*a(n-3)+6*a(n-4)-3*a(n-5) for n>18
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 03:31:47, revision 9) this is still
...
$20079$, which the model reproduces along with every later term.
...
\]
on the $S=20079$ admissible $2$-tuples. In particular $a$ is $C$-finite.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A186480.
