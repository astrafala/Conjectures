...
\title{The empirical recurrence for OEIS A233020, proved by transfer matrix}
...
\begin{abstract}
OEIS A233020 carries an empirical recurrence of order $2$ contributed by R.~H.~Hardin. It is
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 11 2022 10:28:40, revision 9) this is still
