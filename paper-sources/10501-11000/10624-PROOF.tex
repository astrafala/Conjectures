...
\title{The empirical recurrence for OEIS A303890, proved by transfer matrix}
...
\begin{abstract}
OEIS A303890 counts $2$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A303890 is ``Number of nX2 0..1 arrays with every element unequal to 1, 2, 3 or 4 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 7, 23, 86, 313, 1145, 4184, 15293,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) +a(n-2) +4*a(n-3) +4*a(n-4)
\end{quote}
As of the ``Last modified'' line on the live entry (May 02 2018 08:00:46, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A303890.
