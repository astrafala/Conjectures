...
\title{The empirical recurrence for OEIS A187858, derived from the entry's generating function}
...
\begin{abstract}
OEIS A187858 carries an empirical recurrence of order $3$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 26 2018 08:45:41, revision 10) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{23 x^{6} - 57 x^{5} - 17 x^{4} - 75 x^{3} - 2 x^{2}}{x^{3} - 3 x^{2} + 3 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 23 x^{6} + 57 x^{5} + 17 x^{4} + 75 x^{3} + 2 x^{2},
\]
