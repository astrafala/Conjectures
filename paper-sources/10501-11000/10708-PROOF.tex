...
\title{The empirical recurrence for OEIS A188149, derived from the entry's generating function}
...
\begin{abstract}
OEIS A188149 carries an empirical recurrence of order $3$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 26 2018 11:37:37, revision 10) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{8 x^{5} - 16 x^{4} - 56 x^{3} - 8 x^{2}}{x^{3} - 3 x^{2} + 3 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 8 x^{5} + 16 x^{4} + 56 x^{3} + 8 x^{2},
\]
