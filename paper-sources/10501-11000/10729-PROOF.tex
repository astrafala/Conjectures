...
\title{The empirical recurrence for OEIS A224668, derived from the entry's generating function}
...
\begin{abstract}
OEIS A224668 carries an empirical recurrence of order $3$. The entry separately records a
...
OEIS A224668 is ``Number of 6 X 6 0..n matrices with each 2 X 2 subblock idempotent.''. It has offset $1$ and begins
\[
428, 542, 668, 806, 956, 1118, 1292, 1478,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 02 2018 14:46:11, revision 7) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 326 x^{3} + 742 x^{2} - 428 x}{x^{3} - 3 x^{2} + 3 x - 1},
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224668.
