...
\title{The empirical recurrence for OEIS A188153, derived from the entry's generating function}
...
\begin{abstract}
OEIS A188153 carries an empirical recurrence of order $3$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 27 2018 09:22:45, revision 13) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{24 x^{9} + 192 x^{8} + 408 x^{7} - 648 x^{6} - 2568 x^{5} - 1640 x^{4} - 112 x^{3}}{x^{3} - 3 x^{2} + 3 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 24 x^{9} - 192 x^{8} - 408 x^{7} + 648 x^{6} + 2568 x^{5} + 1640 x^{4} + 112 x^{3},
\]
