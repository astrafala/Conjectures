...
\title{The empirical recurrence for OEIS A232951, proved by transfer matrix}
...
\begin{abstract}
OEIS A232951 carries an empirical recurrence of order $3$ contributed by R.~H.~Hardin. It is
...
OEIS A232951 is ``Number of n X 4 0..3 arrays with no element x(i,j) adjacent to value 3-x(i,j) horizontally, diagonally or antidiagonally, and top left element zero.''. It has offset $1$ and begins
\[
27, 771, 22971, 685251, 20442651, 609853251, 18193384251, 542752261251,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 31*a(n-1) - 35*a(n-2) + 5*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 06 2018 09:39:15, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232951.
