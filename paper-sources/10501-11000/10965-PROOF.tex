...
\title{The empirical recurrence for OEIS A186055, proved by transfer matrix}
...
\begin{abstract}
OEIS A186055 counts $(n+2)\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A186055 is ``Number of (n+2) X 3 binary arrays with each 3 X 3 subblock having a positive determinant.''. It has offset $1$ and begins
\[
87, 267, 792, 2328, 6915, 20475, 60588, 179442,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + a(n-2) + 6*a(n-3) - 2*a(n-4) + 2*a(n-5) - 3*a(n-6) + 2*a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 17 2018 08:33:45, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + a(n-2) + 6\,a(n-3) - 2\,a(n-4) + 2\,a(n-5) - 3\,a(n-6) + 2\,a(n-7)
\]
for every $n>7$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A186055.
