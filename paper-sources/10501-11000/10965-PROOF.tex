...
\title{The empirical recurrence for OEIS A267880, derived from the entry's generating function}
...
\begin{abstract}
OEIS A267880 carries an empirical recurrence of order $2$. The entry separately records a
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{x^{4} - x^{3} + x^{2} - x + 1}{2 x^{2} - 3 x + 1},
\]
