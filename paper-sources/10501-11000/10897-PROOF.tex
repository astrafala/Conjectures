...
\title{The empirical recurrence for OEIS A246474, proved by transfer matrix}
...
\begin{abstract}
OEIS A246474 carries an empirical recurrence of order $3$ contributed by R.~H.~Hardin. It is
...
OEIS A246474 is ``Number of length n+3 0..3 arrays with no pair in any consecutive four terms totalling exactly 3.''. It has offset $1$ and begins
\[
60, 132, 292, 644, 1420, 3132, 6908, 15236,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 06 2018 04:12:30, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A246474.
