...
\title{The empirical recurrence for OEIS A253492, proved by transfer matrix}
...
\begin{abstract}
OEIS A253492 counts the arrays over $\{0,\dots,2\}$ whose $2\times2$ subblocks carry a
...
so a pair of consecutive array rows is a state, the count is a walk count on $S=8501$ of them,
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 15 2018 14:21:23, revision 9) this is still
...
\]
on the $S=8501$ admissible pairs. In particular $a$ is $C$-finite. The alignment of the walk
