...
\title{The empirical recurrence for OEIS A187291, derived from the entry's generating function}
...
\begin{abstract}
OEIS A187291 carries an empirical recurrence of order $3$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 22 2018 17:46:22, revision 12) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{36 x^{12} + 116 x^{11} + 576 x^{10} + 912 x^{9} + 1536 x^{8} - 1424 x^{7} - 7376 x^{6} - 15336 x^{5} - 11104 x^{4} - 1440 x^{3}}{x^{3} - 3 x^{2} + 3 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 36 x^{12} - 116 x^{11} - 576 x^{10} - 912 x^{9} - 1536 x^{8} + 1424 x^{7} + 7376 x^{6} + 15336 x^{5} + 11104 x^{4} + 1440 x^{3},
\]
