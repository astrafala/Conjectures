...
\title{The empirical recurrence for OEIS A063155, derived from the entry's generating function}
...
\begin{abstract}
OEIS A063155 carries an empirical recurrence of order $2$. The entry separately records a
...
OEIS A063155 is ``Dimension of the space of weight 2n cusp forms for Gamma\_0( 87 ).''. It has offset $1$ and begins
\[
9, 28, 48, 68, 88, 108, 128, 148,\ \dots
\]
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{x^{3} + 10 x^{2} + 9 x}{x^{2} - 2 x + 1},
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A063155.
