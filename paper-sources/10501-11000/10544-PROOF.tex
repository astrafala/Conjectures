...
\title{The empirical recurrence for OEIS A267360, derived from the entry's generating function}
...
\begin{abstract}
OEIS A267360 carries an empirical recurrence of order $4$. The entry separately records a
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 64 x^{8} + 192 x^{7} + 16 x^{6} - 176 x^{5} + 36 x^{4} - 4 x^{3} + 11 x^{2} + 3 x + 1}{16 x^{4} - 17 x^{2} + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 64 x^{8} + 192 x^{7} + 16 x^{6} - 176 x^{5} + 36 x^{4} - 4 x^{3} + 11 x^{2} + 3 x + 1,
\]
