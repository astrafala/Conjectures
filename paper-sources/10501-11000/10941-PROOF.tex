...
\title{The empirical recurrence for OEIS A267524, derived from the entry's generating function}
...
\begin{abstract}
OEIS A267524 carries an empirical recurrence of order $2$. The entry separately records a
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{x^{3} - x + 1}{10 x^{2} - 11 x + 1},
\]
