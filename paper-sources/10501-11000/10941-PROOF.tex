...
\title{The empirical recurrence for OEIS A264086, proved by transfer matrix}
...
\begin{abstract}
OEIS A264086 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=5$ rows in which
...
OEIS A264086 is ``Number of (n+1) X (4+1) arrays of permutations of 0..n*5+4 with each element having index change +-(.,.) 0,0 0,1 or 2,-2.''. It has offset $1$ and begins
\[
64, 1448, 32761, 645627, 12723489, 252076323, 4994107561, 98921264827,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 19*a(n-1) + 304*a(n-3) + 256*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 04 2019 09:02:22, revision 9) this is still
...
\[
(i-h_i,\,j-h_j)\;\in\;\{(-2,2),\ (0,-1),\ (0,0),\ (0,1),\ (2,-2)\},
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264086.
