...
\title{The empirical recurrence for OEIS A267705, derived from the entry's generating function}
...
\begin{abstract}
OEIS A267705 carries an empirical recurrence of order $3$. The entry separately records a
...
OEIS A267705 is ``Binary representation of the n-th iteration of the "Rule 205" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 10, 10101, 1101011, 111010111, 11110101111, 1111101011111, 111111010111111,\ \dots
\]
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{10100 x^{3} - 10101 x^{2} + 101 x - 1}{1000 x^{3} - 1110 x^{2} + 111 x - 1},
\]
the entry's own generating function, and let
\[
D(x)\;=\;1-\sum_i c_i x^{i}\;=\;- 1000 x^{3} + 1110 x^{2} - 111 x + 1
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 10100 x^{3} + 10101 x^{2} - 101 x + 1,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267705.
