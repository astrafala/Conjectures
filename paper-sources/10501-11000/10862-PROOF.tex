...
\title{The empirical recurrence for OEIS A233252, proved by transfer matrix}
...
\begin{abstract}
OEIS A233252 carries an empirical recurrence of order $2$ contributed by R.~H.~Hardin. It is
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 10 2018 15:53:50, revision 8) this is still
