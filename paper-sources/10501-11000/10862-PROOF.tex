...
\title{The empirical recurrence for OEIS A188869, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A188869 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A188869 is ``Number of n X 4 binary arrays without the pattern 0 0 0 antidiagonally or horizontally.''. It has offset $1$ and begins
\[
13, 169, 1901, 21937, 252932, 2915832, 33617513, 387583973,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 13*a(n-1) -16*a(n-2) -8*a(n-3) -44*a(n-4) +109*a(n-5) -53*a(n-6) +4*a(n-7) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (May 01 2018 09:40:53, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;13\,a(n-1) - 16\,a(n-2) - 8\,a(n-3) - 44\,a(n-4) + 109\,a(n-5) - 53\,a(n-6) + 4\,a(n-7)
\end{equation}
for all $n>8$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A188869.
