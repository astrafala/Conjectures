...
\title{The empirical recurrence for OEIS A185459, proved by transfer matrix}
...
\begin{abstract}
OEIS A185459 counts arrays over $\{0,\dots,1\}$ under a condition on the determinant of every
...
OEIS A185459 is ``Number of (n+1) X 2 binary arrays with no 2 X 2 subblock determinant equal to any horizontal or vertical neighbor 2 X 2 subblock determinant.''. It has offset $1$ and begins
\[
16, 34, 92, 218, 540, 1320, 3238, 7934,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + 2*a(n-2) + 3*a(n-3) + 2*a(n-4) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 15 2018 08:59:26, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A185459.
