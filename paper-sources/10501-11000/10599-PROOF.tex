...
\title{The empirical recurrence for OEIS A206111, proved by transfer matrix}
...
\begin{abstract}
OEIS A206111 counts arrays over $\{0,\dots,3\}$ under a condition on the perimeter cycle of
...
OEIS A206111 is ``Number of (n+1) X 2 0..3 arrays with every 2 X 3 or 3 X 2 subblock having exactly two counterclockwise and two clockwise edge increases.''. It has offset $1$ and begins
\[
256, 1140, 6028, 31756, 171564, 973388, 5538732, 31668844,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 5*a(n-1) + 5*a(n-2) + 29*a(n-3) - 142*a(n-4) - 248*a(n-5) + 88*a(n-6) + 144*a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 13 2018 12:00:19, revision 10) this is still
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) + 5\,a(n-2) + 29\,a(n-3) - 142\,a(n-4) - 248\,a(n-5) + 88\,a(n-6) + 144\,a(n-7)
\]
for every $n>7$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206111.
