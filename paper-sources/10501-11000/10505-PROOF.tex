...
\title{The empirical recurrence for OEIS A297972, proved by transfer matrix}
...
\begin{abstract}
OEIS A297972 counts $2$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A297972 is ``Number of n X 2 0..1 arrays with every element equal to 2, 3, 4 or 5 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
0, 1, 3, 6, 17, 41, 104, 261,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) + 3*a(n-2) + 2*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 19 2018 14:15:58, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297972.
