...
\title{The empirical recurrence for OEIS A190032, proved by transfer matrix}
...
\begin{abstract}
OEIS A190032 counts the $(n+2)\times10$ arrays over $\{0,\dots,1\}$ in which
...
a state, the count is a walk count on $S=1508$ of them, and the conjectured recurrence is then
...
OEIS A190032 is ``Number of (n+2) X 10 binary arrays with every 3 X 3 subblock commuting with each horizontal and vertical neighbor 3 X 3 subblock.''. It has offset $1$ and begins
\[
1508, 423, 610, 966, 1418, 1834, 2362, 3018,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) -a(n-2) +a(n-3) -2*a(n-4) +a(n-5) +a(n-6) -a(n-7) for n>16.
\end{quote}
As of the ``Last modified'' line on the live entry (May 03 2018 09:56:51, revision 8) this is still
...
$1508$, which the model reproduces along with every later term.
...
\]
on the $S=1508$ admissible $3$-tuples. In particular $a$ is $C$-finite.
...
size of the construction is therefore $2^{3\cdot10}$ before the condition prunes
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A190032.
