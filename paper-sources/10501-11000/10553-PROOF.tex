...
\title{The empirical recurrence for OEIS A186563, proved by transfer matrix}
...
\begin{abstract}
OEIS A186563 counts the $(n+2)\times6$ arrays over $\{0,\dots,2\}$ in which
...
a state, the count is a walk count on $S=6594$ of them, and the conjectured recurrence is then
...
OEIS A186563 is ``Number of (n+2) X 6 0..2 arrays with every 3 X 3 subblock commuting with each horizontal and vertical neighbor 3 X 3 subblock.''. It has offset $1$ and begins
\[
6594, 1411, 3421, 8983, 11557, 12895, 14845, 18415,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) - a(n-2) + 2*a(n-3) - 4*a(n-4) + 2*a(n-5) + 2*a(n-6) - 2*a(n-7) for n>12.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 19 2018 03:28:17, revision 12) this is still
...
$6594$, which the model reproduces along with every later term.
...
\]
on the $S=6594$ admissible $3$-tuples. In particular $a$ is $C$-finite.
...
size of the construction is therefore $3^{3\cdot6}$ before the condition prunes
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A186563.
