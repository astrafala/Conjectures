...
\title{The empirical recurrence for OEIS A222138, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A222138 counts arrays over $\{0,\dots,4\}$ in which every cell is constrained by the
...
OEIS A222138 is ``Number of nX2 0..4 arrays with no entry increasing mod 5 by 4 rightwards or downwards, starting with upper left zero.''. It has offset $1$ and begins
\[
4, 52, 676, 8788, 114244, 1485172, 19307236, 250994068,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 13*a(n-1)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 20:12:03, revision 9) the statement is
...
publishes, $n=17$, the arrays have $2\cdot17$ cells over
$5$ values, so there are about $10^{23}$ of them to sift. The
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A222138.
