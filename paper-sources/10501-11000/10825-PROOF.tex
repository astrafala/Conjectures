...
\title{The empirical recurrence for OEIS A204366, proved by transfer matrix}
...
\begin{abstract}
OEIS A204366 counts $(n+2)\times6$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A204366 is ``Number of (n+2) X 6 0..2 arrays with every 3 X 3 subblock having three equal elements in a row horizontally, vertically or nw-to-se diagonally exactly three ways, and new values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
891, 713, 622, 704, 1264, 2956, 6772, 17852,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) -6*a(n-4) +4*a(n-6) for n>9.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 07 2018 08:05:03, revision 9) this is still
...
$u_1,u_2,\dots$ over $\{0,\dots,2\}^{6}$, the condition
\[
...
\]
on $S=531442$ vertices in total, the exponent fixed by the entry's own shape and checked against
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204366.
