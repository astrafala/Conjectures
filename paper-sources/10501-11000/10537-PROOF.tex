...
\title{The empirical recurrence for OEIS A297426, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297426 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A297426 is ``Number of n X 3 0..1 arrays with every 1 horizontally, diagonally or antidiagonally adjacent to 2 neighboring 1s.''. It has offset $1$ and begins
\[
1, 7, 14, 22, 68, 163, 320, 782,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) + 7*a(n-3) + a(n-5) - 4*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 21 2025 08:37:22, revision 12) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 7\,a(n-3) + a(n-5) - 4\,a(n-6)
\end{equation}
for all $n>7$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297426.
