...
\title{The empirical recurrence for OEIS A187158, derived from the entry's generating function}
...
\begin{abstract}
OEIS A187158 carries an empirical recurrence of order $3$. The entry separately records a
...
OEIS A187158 is ``Number of 5-step one space at a time bishop's tours on an n X n board summed over all starting positions.''. It has offset $1$ and begins
\[
0, 0, 0, 72, 388, 904, 1620, 2536,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 20 2018 09:27:59, revision 10) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{44 x^{6} - 172 x^{5} - 72 x^{4}}{x^{3} - 3 x^{2} + 3 x - 1},
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A187158.
