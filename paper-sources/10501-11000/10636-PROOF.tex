...
\title{The empirical recurrence for OEIS A297433, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297433 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A297433 is ``Number of 3Xn 0..1 arrays with every 1 horizontally, diagonally or antidiagonally adjacent to 2 neighboring 1s.''. It has offset $1$ and begins
\[
1, 3, 14, 26, 43, 109, 301, 649,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +3*a(n-3) +8*a(n-4) +a(n-5) -a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 13 2018 13:46:13, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 3\,a(n-3) + 8\,a(n-4) + a(n-5) - a(n-6)
\end{equation}
for all $n>7$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297433.
