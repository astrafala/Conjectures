...
\title{The empirical recurrence for OEIS A221597, derived from the entry's generating function}
...
\begin{abstract}
OEIS A221597 carries an empirical recurrence of order $3$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 09 2018 08:56:27, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 2 x^{5} - 10 x^{4} - 21 x^{3} - 43 x^{2} - 32 x}{x^{3} - 3 x^{2} + 3 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;2 x^{5} + 10 x^{4} + 21 x^{3} + 43 x^{2} + 32 x,
\]
