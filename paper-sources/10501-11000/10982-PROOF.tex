...
\title{The empirical recurrence for OEIS A267941, derived from the entry's generating function}
...
\begin{abstract}
OEIS A267941 carries an empirical recurrence of order $2$. The entry separately records a
...
OEIS A267941 is ``Decimal representation of the n-th iteration of the "Rule 253" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 3, 31, 127, 511, 2047, 8191, 32767,\ \dots
\]
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 16 x^{3} + 20 x^{2} - 2 x + 1}{4 x^{2} - 5 x + 1},
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267941.
