...
\title{The empirical recurrence for OEIS A262327, proved by transfer matrix}
...
\begin{abstract}
OEIS A262327 carries an empirical recurrence of order $3$ contributed by R.~H.~Hardin. It is
...
OEIS A262327 is ``Number of (n+1) X (3+1) 0..1 arrays with each row and column divisible by 3, read as a binary number with top and left being the most significant bits.''. It has offset $1$ and begins
\[
6, 15, 90, 351, 2106, 10935, 65610, 378351,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 6*a(n-1) + 9*a(n-2) - 54*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 31 2018 06:08:25, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A262327.
