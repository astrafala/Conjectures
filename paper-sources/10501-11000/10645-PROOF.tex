...
\title{The empirical recurrence for OEIS A282522, proved by transfer matrix}
...
\begin{abstract}
OEIS A282522 counts $n\times2$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A282522 is ``Number of nX2 0..1 arrays with no 1 equal to more than two of its king-move neighbors.''. It has offset $1$ and begins
\[
4, 15, 43, 144, 473, 1529, 5004, 16335,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) +a(n-2) +2*a(n-3) -8*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 28 2017 04:05:07, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + a(n-2) + 2\,a(n-3) - 8\,a(n-4)
\]
for every $n>4$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A282522.
