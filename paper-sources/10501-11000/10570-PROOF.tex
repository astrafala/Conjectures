...
\title{The empirical recurrence for OEIS A187612, derived from the entry's generating function}
...
\begin{abstract}
OEIS A187612 carries an empirical recurrence of order $3$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 25 2018 10:12:29, revision 10) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{1809 x^{16} - 2319 x^{15} + 2608 x^{14} + 1689 x^{13} - 6086 x^{12} + 1503 x^{11} - 4759 x^{10} - 4897 x^{9} - 3028 x^{8} - 2358 x^{7} - 474 x^{6}}{x^{3} - 3 x^{2} + 3 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 1809 x^{16} + 2319 x^{15} - 2608 x^{14} - 1689 x^{13} + 6086 x^{12} - 1503 x^{11} + 4759 x^{10} + 4897 x^{9} + 3028 x^{8} + 2358 x^{7} + 474 x^{6},
\]
