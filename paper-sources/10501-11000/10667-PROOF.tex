...
\title{The empirical recurrence for OEIS A187159, derived from the entry's generating function}
...
\begin{abstract}
OEIS A187159 carries an empirical recurrence of order $3$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 20 2018 09:44:27, revision 10) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{164 x^{7} - 388 x^{6} - 288 x^{5} - 56 x^{4}}{x^{3} - 3 x^{2} + 3 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 164 x^{7} + 388 x^{6} + 288 x^{5} + 56 x^{4},
\]
