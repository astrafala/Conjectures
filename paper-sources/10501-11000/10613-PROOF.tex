...
\title{The empirical recurrence for OEIS A253454, proved by transfer matrix}
...
\begin{abstract}
OEIS A253454 counts the arrays over $\{0,\dots,2\}$ whose $2\times2$ subblocks carry a
...
OEIS A253454 is ``Number of (n+1) X (6+1) 0..2 arrays with every 2 X 2 subblock diagonal minus antidiagonal sum nondecreasing horizontally and vertically.''. It has offset $1$ and begins
\[
19701, 31630, 39463, 52912, 83003, 147332, 285681, 590963,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 6*a(n-1) - 11*a(n-2) + 6*a(n-3) for n>9.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 13 2018 08:04:37, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253454.
