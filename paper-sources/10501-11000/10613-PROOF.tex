...
\title{The empirical recurrence for OEIS A234790, proved by transfer matrix}
...
\begin{abstract}
OEIS A234790 counts arrays of width $3$ over $\{0,1,2,3\}$ subject to a condition read round the
...
OEIS A234790 is ``Number of (n+1) X (2+1) 0..3 arrays with each 2 X 2 subblock having the number of clockwise edge increases less than or equal to the number of counterclockwise edge increases.''. It has offset $1$ and begins
\[
2504, 88072, 3015344, 102517088, 3479085232, 118012659040, 4002569571664, 135748608654080,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 47*a(n-1) - 485*a(n-2) + 1429*a(n-3) - 1056*a(n-4) + 208*a(n-5) - 40*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 16 2018 05:41:25, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;47\,a(n-1) - 485\,a(n-2) + 1429\,a(n-3) - 1056\,a(n-4) + 208\,a(n-5) - 40\,a(n-6)
\]
for every $n>4$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234790.
