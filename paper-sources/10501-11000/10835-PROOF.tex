...
\title{The empirical recurrence for OEIS A278151, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A278151 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A278151 is ``Number of n X 2 0..1 arrays with every element both equal and not equal to some elements at offset (-1,-1) (-1,0) (-1,1) (0,-1) (0,1) (1,-1) or (1,0), with upper left element zero.''. It has offset $1$ and begins
\[
0, 2, 7, 22, 75, 254, 859, 2906,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) + a(n-2) + a(n-3) for n>4.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 07 2019 08:55:59, revision 7) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A278151.
