...
\title{The empirical recurrence for OEIS A255162, derived from the entry's generating function}
...
\begin{abstract}
OEIS A255162 carries an empirical recurrence of order $2$. The entry separately records a
...
OEIS A255162 is ``Rational part of circle radii in nested circles and hexagons (see comment).''. It has offset $0$ and begins
\[
2, 0, 24, -288, 3744, -48384, 625536, -8087040,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 22 2015 23:35:53, revision 17) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 24 x - 2}{12 x^{2} - 12 x - 1},
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A255162.
