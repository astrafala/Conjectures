...
\title{The empirical recurrence for OEIS A267623, derived from the entry's generating function}
...
\begin{abstract}
OEIS A267623 carries an empirical recurrence of order $2$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 16 2025 08:33:29, revision 49) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{x^{2} - x + 1}{10 x^{2} - 11 x + 1},
\]
