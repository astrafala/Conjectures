...
\title{The empirical recurrence for OEIS A232132, proved by transfer matrix}
...
\begin{abstract}
OEIS A232132 counts $(n+1)\times4$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A232132 is ``Number of (n+1)X(3+1) 0..2 arrays with no element equal to a strict majority of its horizontal and antidiagonal neighbors, with values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
200, 10956, 602468, 33162868, 1825568436, 100495188564, 5532131001812, 304536704087316,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 65*a(n-1) -588*a(n-2) +2304*a(n-3) -5156*a(n-4) +7136*a(n-5) -5632*a(n-6) +2048*a(n-7) -256*a(n-8)
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 06:53:45, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;65\,a(n-1) - 588\,a(n-2) + 2304\,a(n-3) - 5156\,a(n-4) + 7136\,a(n-5) - 5632\,a(n-6) + 2048\,a(n-7) - 256\,a(n-8)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232132.
