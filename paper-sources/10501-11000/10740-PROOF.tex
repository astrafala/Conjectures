...
\title{The empirical recurrence for OEIS A252979, derived from the entry's generating function}
...
\begin{abstract}
OEIS A252979 carries an empirical recurrence of order $3$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 08 2018 04:35:45, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 730 x^{9} - 3476 x^{8} - 6117 x^{7} - 4917 x^{6} - 1129 x^{5} - 5 x^{4} - 3 x^{3} - 4 x^{2} - 3 x}{x^{3} - 3 x^{2} + 3 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;730 x^{9} + 3476 x^{8} + 6117 x^{7} + 4917 x^{6} + 1129 x^{5} + 5 x^{4} + 3 x^{3} + 4 x^{2} + 3 x,
\]
