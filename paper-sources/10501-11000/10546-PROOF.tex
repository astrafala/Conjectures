...
\title{The empirical recurrence for OEIS A063160, derived from the entry's generating function}
...
\begin{abstract}
OEIS A063160 carries an empirical recurrence of order $2$. The entry separately records a
...
OEIS A063160 is ``Dimension of the space of weight 2n cusp forms for Gamma\_0( 92 ).''. It has offset $1$ and begins
\[
10, 33, 57, 81, 105, 129, 153, 177,\ \dots
\]
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{x^{3} + 13 x^{2} + 10 x}{x^{2} - 2 x + 1},
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A063160.
