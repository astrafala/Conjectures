...
\title{The empirical recurrence for OEIS A187298, derived from the entry's generating function}
...
\begin{abstract}
OEIS A187298 carries an empirical recurrence of order $3$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 23 2018 08:37:43, revision 11) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{6 x^{6} - 10 x^{5} + 4 x^{4} - 30 x^{3} - 2 x^{2}}{x^{3} - 3 x^{2} + 3 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 6 x^{6} + 10 x^{5} - 4 x^{4} + 30 x^{3} + 2 x^{2},
\]
