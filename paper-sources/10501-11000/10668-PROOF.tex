...
\title{The empirical recurrence for OEIS A187160, derived from the entry's generating function}
...
\begin{abstract}
OEIS A187160 carries an empirical recurrence of order $3$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 20 2018 10:05:22, revision 10) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{500 x^{8} - 804 x^{7} - 744 x^{6} - 496 x^{5} - 16 x^{4}}{x^{3} - 3 x^{2} + 3 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 500 x^{8} + 804 x^{7} + 744 x^{6} + 496 x^{5} + 16 x^{4},
\]
