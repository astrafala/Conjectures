...
\title{The empirical recurrence for OEIS A186874, proved by transfer matrix}
...
\begin{abstract}
OEIS A186874 counts the $(n+2)\times4$ arrays over $\{0,\dots,3\}$ in which
...
a state, the count is a walk count on $S=2428$ of them, and the conjectured recurrence is then
...
OEIS A186874 is ``Number of (n+2) X 4 0..3 arrays with every 3 X 3 subblock commuting with each horizontal and vertical neighbor 3 X 3 subblock.''. It has offset $1$ and begins
\[
2428, 421, 1201, 6829, 14221, 18517, 21661, 25381,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) - a(n-2) + 3*a(n-3) - 6*a(n-4) + 3*a(n-5) + 3*a(n-6) - 3*a(n-7) for n>10.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 19 2018 11:07:59, revision 9) this is still
...
$2428$, which the model reproduces along with every later term.
...
\]
on the $S=2428$ admissible $3$-tuples. In particular $a$ is $C$-finite.
...
size of the construction is therefore $4^{3\cdot4}$ before the condition prunes
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A186874.
