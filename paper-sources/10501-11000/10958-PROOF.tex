...
\title{The empirical recurrence for OEIS A267846, derived from the entry's generating function}
...
\begin{abstract}
OEIS A267846 carries an empirical recurrence of order $2$. The entry separately records a
...
\begin{quote}
G.f.: (1-x+1010*x\^{}2+9000*x\^{}3) / ((1-x)*(1-100*x)).
\end{quote}
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{9000 x^{3} + 1010 x^{2} - x + 1}{100 x^{2} - 101 x + 1},
\]
