...
\title{The empirical recurrence for OEIS A232425, proved by transfer matrix}
...
\begin{abstract}
OEIS A232425 counts arrays of width $2$ over $\{0,\dots,2\}$ under a condition on each cell
...
OEIS A232425 is ``Number of (n+1) X (1+1) 0..2 arrays with every element next to itself plus and minus one within the range 0..2 horizontally or vertically.''. It has offset $1$ and begins
\[
4, 16, 64, 240, 988, 3964, 15844, 63808,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + 10*a(n-2) + 11*a(n-3) - a(n-4) - 28*a(n-5) - 32*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 19 2018 09:30:46, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 10\,a(n-2) + 11\,a(n-3) - a(n-4) - 28\,a(n-5) - 32\,a(n-6)
\]
for every $n>5$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232425.
