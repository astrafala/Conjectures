...
\title{The empirical recurrence for OEIS A283276, proved by transfer matrix}
...
\begin{abstract}
OEIS A283276 counts $n\times2$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
walk, and $a(n)$ is a walk count on $S=19$ vertices, which is $C$-finite. Whether the
...
OEIS A283276 is ``Number of n X 2 0..1 arrays with no 1 equal to more than two of its horizontal, vertical and antidiagonal neighbors.''. It has offset $1$ and begins
\[
4, 15, 50, 176, 614, 2141, 7472, 26070,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) + a(n-2) + 3*a(n-3) - 2*a(n-4) + a(n-5) - 2*a(n-6) + a(n-7) - a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 21 2019 08:24:47, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + a(n-2) + 3\,a(n-3) - 2\,a(n-4) + a(n-5) - 2\,a(n-6) + a(n-7) - a(n-8)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A283276.
