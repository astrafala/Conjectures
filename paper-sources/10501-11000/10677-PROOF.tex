...
\title{The empirical recurrence for OEIS A187300, derived from the entry's generating function}
...
\begin{abstract}
OEIS A187300 carries an empirical recurrence of order $3$. The entry separately records a
...
OEIS A187300 is ``Number of 5-step one space leftwards or up, two space rightwards or down asymmetric rook's tours on an n X n board summed over all starting positions.''. It has offset $1$ and begins
\[
0, 0, 90, 416, 1208, 2400, 4092, 6208,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 23 2018 08:39:09, revision 10) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{14 x^{10} - 18 x^{9} + 76 x^{8} - 100 x^{7} + 66 x^{6} - 230 x^{5} - 146 x^{4} - 90 x^{3}}{x^{3} - 3 x^{2} + 3 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 14 x^{10} + 18 x^{9} - 76 x^{8} + 100 x^{7} - 66 x^{6} + 230 x^{5} + 146 x^{4} + 90 x^{3},
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A187300.
