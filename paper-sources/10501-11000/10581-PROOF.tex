...
\title{The empirical recurrence for OEIS A188151, derived from the entry's generating function}
...
\begin{abstract}
OEIS A188151 carries an empirical recurrence of order $3$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 27 2018 09:22:33, revision 14) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{16 x^{7} + 56 x^{6} - 96 x^{5} - 416 x^{4} - 128 x^{3}}{x^{3} - 3 x^{2} + 3 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 16 x^{7} - 56 x^{6} + 96 x^{5} + 416 x^{4} + 128 x^{3},
\]
