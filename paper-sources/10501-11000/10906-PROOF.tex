...
\title{The empirical recurrence for OEIS A112032, derived from the entry's generating function}
...
\begin{abstract}
OEIS A112032 carries an empirical recurrence of order $2$. The entry separately records a
...
OEIS A112032 is ``Denominator of 3/4 + 1/4 - 3/8 - 1/8 + 3/16 + 1/16 - 3/32 - 1/32 + 3/64 ...''. It has offset $0$ and begins
\[
4, 1, 8, 2, 16, 4, 32, 8,\ \dots
\]
...
G.f.: (x+4) / (1-2*x\^{}2). (End)
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 08 2022 08:45:21, revision 31) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x - 4}{2 x^{2} - 1},
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A112032.
