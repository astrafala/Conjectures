...
\title{The empirical recurrence for OEIS A221731, proved by transfer matrix}
...
\begin{abstract}
OEIS A221731 carries an empirical recurrence of order $2$ contributed by R.~H.~Hardin. It is
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 14 2018 11:05:20, revision 8) this is still
