...
\title{The empirical recurrence for OEIS A266873, derived from the entry's generating function}
...
\begin{abstract}
OEIS A266873 carries an empirical recurrence of order $4$. The entry separately records a
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{8 x^{3} + 4 x^{2} + 2 x + 1}{16 x^{4} - 17 x^{2} + 1},
\]
