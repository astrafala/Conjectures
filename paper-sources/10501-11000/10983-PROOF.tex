...
\title{The empirical recurrence for OEIS A275229, proved by transfer matrix}
...
\begin{abstract}
OEIS A275229 carries an empirical recurrence of order $2$ contributed by R.~H.~Hardin. It is
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 02 2019 10:46:56, revision 7) this is still
...
admissible array is then exactly a walk, so with $M$ the adjacency matrix on $S=17$ vertices
