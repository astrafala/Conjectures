...
\title{The empirical recurrence for OEIS A250785, proved by transfer matrix}
...
\begin{abstract}
OEIS A250785 counts arrays over $\{0,1\}$ in which a statistic taken over short runs
...
OEIS A250785 is ``Number of (3+1) X (n+1) 0..1 arrays with nondecreasing x(i,j)+x(i,j-1) in the i direction and nondecreasing absolute value of x(i,j)-x(i-1,j) in the j direction.''. It has offset $1$ and begins
\[
36, 96, 230, 534, 1194, 2604, 5568, 11732,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 5*a(n-1) - 8*a(n-2) + 3*a(n-3) + 3*a(n-4) - 2*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 19 2018 12:59:24, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250785.
