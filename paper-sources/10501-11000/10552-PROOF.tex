...
\title{The empirical recurrence for OEIS A267677, derived from the entry's generating function}
...
\begin{abstract}
OEIS A267677 carries an empirical recurrence of order $4$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 16 2025 08:33:29, revision 22) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{10000 x^{5} + 9900 x^{4} - 100 x^{3} - 9999 x^{2} + 100 x - 1}{1000 x^{4} - 110 x^{3} - 999 x^{2} + 110 x - 1},
\]
the entry's own generating function, and let
\[
D(x)\;=\;1-\sum_i c_i x^{i}\;=\;- 1000 x^{4} + 110 x^{3} + 999 x^{2} - 110 x + 1
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 10000 x^{5} - 9900 x^{4} + 100 x^{3} + 9999 x^{2} - 100 x + 1,
\]
...
$n>5$. The bound is exact: at $n=5$ the recurrence fails on the entry's own published terms.
\end{proof}
...
\[
1000 x^{4} - 110 x^{3} - 999 x^{2} + 110 x - 1,
\]
