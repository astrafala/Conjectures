...
\title{The empirical recurrence for OEIS A267051, derived from the entry's generating function}
...
\begin{abstract}
OEIS A267051 carries an empirical recurrence of order $3$. The entry separately records a
...
OEIS A267051 is ``Binary representation of the n-th iteration of the "Rule 92" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 11, 111, 1011, 10111, 101011, 1010111, 10101011,\ \dots
\]
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 100 x^{3} + x + 1}{10 x^{3} - x^{2} - 10 x + 1},
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267051.
