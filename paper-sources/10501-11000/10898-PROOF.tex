...
\title{The empirical recurrence for OEIS A205021, proved by transfer matrix}
...
\begin{abstract}
OEIS A205021 counts arrays over $\{0,\dots,3\}$ under a condition on the determinant of every
...
a bounded window of consecutive rows, so the count is a walk count on $S=2338$ states and is
...
OEIS A205021 is ``Number of (n+1)X3 0..3 arrays with the determinants of 2X2 subblocks nondecreasing rightwards and downwards.''. It has offset $1$ and begins
\[
2338, 27611, 275853, 3684581, 56088455, 888172440, 14267356381, 230651852383,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 24*a(n-1) -102*a(n-2) -656*a(n-3) +4911*a(n-4) -9576*a(n-5) +5400*a(n-6) for n>21
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 11:40:29, revision 9) this is still
...
\]
on the $S=2338$ admissible pairs.
...
entry's first term is $2338$, and the model reproduces it along with every later term; that
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A205021.
