...
\title{The empirical recurrence for OEIS A316955, proved by transfer matrix}
...
\begin{abstract}
OEIS A316955 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $different from$ itself lying in $\{0,1,2,3,4,5,8\}$, and it carries an empirical
...
OEIS A316955 is ``Number of nX3 0..1 arrays with every element unequal to 0, 1, 2, 3, 4, 5 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
4, 32, 220, 1498, 10243, 70037, 478941, 3275421,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 6*a(n-1) +9*a(n-2) -14*a(n-3) -52*a(n-4) -33*a(n-5) for n>6
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 17 2018 12:29:51, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A316955.
