...
\title{The empirical recurrence for OEIS A187512, derived from the entry's generating function}
...
\begin{abstract}
OEIS A187512 carries an empirical recurrence of order $3$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 24 2018 09:19:57, revision 10) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{9 x^{8} + 29 x^{7} - 24 x^{6} - 294 x^{5} - 270 x^{4} - 20 x^{3}}{x^{3} - 3 x^{2} + 3 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 9 x^{8} - 29 x^{7} + 24 x^{6} + 294 x^{5} + 270 x^{4} + 20 x^{3},
\]
