...
\title{The empirical recurrence for OEIS A059133, derived from the entry's generating function}
...
\begin{abstract}
OEIS A059133 carries an empirical recurrence of order $3$. The entry separately records a
...
OEIS A059133 is ``A hierarchical sequence (S(W2{2}c) - see A059126).''. It has offset $0$ and begins
\[
4, 18, 52, 126, 280, 594, 1228, 2502,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 02 2023 15:52:44, revision 26) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 2 x - 4}{2 x^{3} - 5 x^{2} + 4 x - 1},
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A059133.
