...
\title{The empirical recurrence for OEIS A267052, derived from the entry's generating function}
...
\begin{abstract}
OEIS A267052 carries an empirical recurrence of order $3$. The entry separately records a
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 4 x^{3} + x + 1}{2 x^{3} - x^{2} - 2 x + 1},
\]
