...
\title{The empirical recurrence for OEIS A267923, derived from the entry's generating function}
...
\begin{abstract}
OEIS A267923 carries an empirical recurrence of order $2$. The entry separately records a
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{10000 x^{2} - 90 x + 1}{100 x^{2} - 101 x + 1},
\]
