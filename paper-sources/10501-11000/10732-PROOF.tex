...
\title{The empirical recurrence for OEIS A063158, derived from the entry's generating function}
...
\begin{abstract}
OEIS A063158 carries an empirical recurrence of order $2$. The entry separately records a
...
OEIS A063158 is ``Dimension of the space of weight 2n cusp forms for Gamma\_0( 90 ).''. It has offset $1$ and begins
\[
11, 46, 82, 118, 154, 190, 226, 262,\ \dots
\]
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{x^{3} + 24 x^{2} + 11 x}{x^{2} - 2 x + 1},
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A063158.
