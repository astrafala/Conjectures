...
\title{The empirical recurrence for OEIS A267680, derived from the entry's generating function}
...
\begin{abstract}
OEIS A267680 carries an empirical recurrence of order $4$. The entry separately records a
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{101000 x^{4} - 89910 x^{3} - 10101 x^{2} + 101 x - 1}{10000 x^{4} - 10100 x^{3} + 101 x - 1},
\]
the entry's own generating function, and let
\[
D(x)\;=\;1-\sum_i c_i x^{i}\;=\;- 10000 x^{4} + 10100 x^{3} - 101 x + 1
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 101000 x^{4} + 89910 x^{3} + 10101 x^{2} - 101 x + 1,
\]
