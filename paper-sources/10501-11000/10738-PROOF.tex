...
\title{The empirical recurrence for OEIS A247528, proved by transfer matrix}
...
\begin{abstract}
OEIS A247528 carries an empirical recurrence of order $7$ contributed by R.~H.~Hardin. It is
...
OEIS A247528 is ``Number of length n+3 0..3 arrays with some disjoint pairs in every consecutive four terms having the same sum.''. It has offset $1$ and begins
\[
88, 136, 220, 364, 604, 1018, 1732, 2956,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) - a(n-3) + a(n-4) - a(n-5) - a(n-6) + a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 07 2018 10:49:14, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A247528.
