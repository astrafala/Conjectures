...
\title{The empirical recurrence for OEIS A296682, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A296682 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A296682 is ``Number of n X 2 0..1 arrays with each 1 adjacent to 1, 2 or 3 king-move neighboring 1s.''. It has offset $1$ and begins
\[
2, 12, 43, 145, 524, 1888, 6737, 24093,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) - a(n-2) + 11*a(n-3) - 2*a(n-4) + 8*a(n-5) - 4*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 24 2019 09:11:51, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) - a(n-2) + 11\,a(n-3) - 2\,a(n-4) + 8\,a(n-5) - 4\,a(n-6)
\end{equation}
for all $n>7$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A296682.
