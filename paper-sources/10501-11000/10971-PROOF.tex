...
\title{The empirical recurrence for OEIS A267889, derived from the entry's generating function}
...
\begin{abstract}
OEIS A267889 carries an empirical recurrence of order $2$. The entry separately records a
...
OEIS A267889 is ``Binary representation of the n-th iteration of the "Rule 239" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 110, 11111, 1111111, 111111111, 11111111111, 1111111111111, 111111111111111,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 24 2025 12:53:49, revision 18) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 100 x^{3} + 101 x^{2} + 9 x + 1}{100 x^{2} - 101 x + 1},
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267889.
