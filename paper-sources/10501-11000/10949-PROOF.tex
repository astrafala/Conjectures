...
\title{The empirical recurrence for OEIS A259635, proved by transfer matrix}
...
\begin{abstract}
OEIS A259635 counts $(n+2)\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
every $3\times3$ subblock, and it carries an empirical recurrence of order $4$
...
OEIS A259635 is ``Number of (n+2) X (1+2) 0..1 arrays with each 3 X 3 subblock having clockwise perimeter pattern 00000000 or 00000001.''. It has offset $1$ and begins
\[
18, 29, 69, 133, 236, 472, 940, 1781,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + 3*a(n-3) + a(n-4) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 26 2018 08:58:50, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A259635.
