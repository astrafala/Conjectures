...
\title{The empirical recurrence for OEIS A267588, derived from the entry's generating function}
...
\begin{abstract}
OEIS A267588 carries an empirical recurrence of order $2$. The entry separately records a
...
OEIS A267588 is ``Binary representation of the middle column of the "Rule 169" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 10, 101, 1010, 10100, 101001, 1010011, 10100111,\ \dots
\]
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{x^{5} - x^{3} + x^{2} - x + 1}{10 x^{2} - 11 x + 1},
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267588.
