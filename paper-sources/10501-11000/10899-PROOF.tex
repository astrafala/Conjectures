...
\title{A condition on the multiset of every subblock: OEIS A183587}
...
\begin{abstract}
OEIS A183587 carries an empirical recurrence of order $4$ contributed by R.~H.~Hardin. It is
...
OEIS A183587 is ``1/24 the number of (n+1) X 3 0..3 arrays with every 2 X 2 subblock containing exactly three distinct values.''. It has offset $1$ and begins
\[
56, 1243, 27380, 603766, 13311808, 293504588, 6471298096, 142681644568,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 24*a(n-1) - 30*a(n-2) - 296*a(n-3) + 192*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 29 2018 15:06:23, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{The count is a walk count}

The entry counts arrays with $3$ columns over the alphabet $\{0,1,2,3\}$, growing one row at a time, and asks that every $2\times2$ subblock holds exactly $3$ distinct values.
...
\begin{theorem}
\[
a(n)\;=\;24\,a(n-1) - 30\,a(n-2) - 296\,a(n-3) + 192\,a(n-4)
\]
for every $n>3$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A183587.
