...
\title{The empirical recurrence for OEIS A253493, proved by transfer matrix}
...
\begin{abstract}
OEIS A253493 counts the arrays over $\{0,\dots,2\}$ whose $2\times2$ subblocks carry a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 16 2018 06:44:08, revision 9) this is still
