...
\title{The empirical recurrence for OEIS A278088, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A278088 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A278088 is ``Number of n X 2 0..1 arrays with every element both equal and not equal to some elements at offset (-1,0) (-1,1) (0,-1) (0,1) or (1,0), with upper left element zero.''. It has offset $1$ and begins
\[
0, 2, 3, 10, 27, 76, 214, 599,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) + 4*a(n-2) + 3*a(n-3) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 07 2019 08:42:07, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 4\,a(n-2) + 3\,a(n-3)
\end{equation}
for all $n>5$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A278088.
