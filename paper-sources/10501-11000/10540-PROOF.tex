...
\title{The empirical recurrence for OEIS A267274, derived from the entry's generating function}
...
\begin{abstract}
OEIS A267274 carries an empirical recurrence of order $4$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 13 2025 14:43:36, revision 29) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{32 x^{5} - 8 x^{4} - 20 x^{3} + 7 x^{2} + 3 x + 1}{16 x^{4} - 17 x^{2} + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;32 x^{5} - 8 x^{4} - 20 x^{3} + 7 x^{2} + 3 x + 1,
\]
