...
\title{The empirical recurrence for OEIS A267815, derived from the entry's generating function}
...
\begin{abstract}
OEIS A267815 carries an empirical recurrence of order $3$. The entry separately records a
...
OEIS A267815 is ``Binary representation of the n-th iteration of the "Rule 221" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 11, 10111, 1101111, 111011111, 11110111111, 1111101111111, 111111011111111,\ \dots
\]
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{10000 x^{3} - 10000 x^{2} + 100 x - 1}{1000 x^{3} - 1110 x^{2} + 111 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 10000 x^{3} + 10000 x^{2} - 100 x + 1,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267815.
