...
\title{The empirical recurrence for OEIS A264019, proved by transfer matrix}
...
\begin{abstract}
OEIS A264019 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=5$ columns in which
...
OEIS A264019 is ``Number of (4+1) X (n+1) arrays of permutations of 0..n*5+4 with each element having index change +-(.,.) 0,0 1,2 or 2,2.''. It has offset $1$ and begins
\[
1, 34, 1156, 20570, 366025, 7320500, 146410000, 2898918000,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 19*a(n-1) + 304*a(n-3) + 256*a(n-4) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 03 2019 14:33:07, revision 9) this is still
...
\[
(i-h_i,\,j-h_j)\;\in\;\{(-2,-2),\ (-2,-1),\ (0,0),\ (2,1),\ (2,2)\},
\]
...
until the working vector was identically zero, settling every larger $j$ at once. The bound is exact: at $n=8$ the recurrence fails on the entry's own published terms, so no larger range holds.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264019.
