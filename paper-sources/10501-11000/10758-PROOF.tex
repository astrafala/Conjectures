...
\title{The empirical recurrence for OEIS A228255, derived from the entry's generating function}
...
\begin{abstract}
OEIS A228255 carries an empirical recurrence of order $2$. The entry separately records a
...
\begin{quote}
G.f.: x*(25 + 144*x + 578*x\^{}2 + 184*x\^{}3 - 8488*x\^{}4 - 2720*x\^{}5 - 768*x\^{}6) / ((1 - 3*x)*(1 - 4*x)).
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 10 2018 10:11:53, revision 12) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 768 x^{7} - 2720 x^{6} - 8488 x^{5} + 184 x^{4} + 578 x^{3} + 144 x^{2} + 25 x}{12 x^{2} - 7 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 768 x^{7} - 2720 x^{6} - 8488 x^{5} + 184 x^{4} + 578 x^{3} + 144 x^{2} + 25 x,
\]
