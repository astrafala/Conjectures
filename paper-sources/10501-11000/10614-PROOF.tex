...
\title{The empirical recurrence for OEIS A253218, derived from the entry's generating function}
...
\begin{abstract}
OEIS A253218 carries an empirical recurrence of order $3$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 09 2018 09:10:19, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 2 x^{7} - 13 x^{6} - 47 x^{5} - 18 x^{4} - x^{3} + 2 x^{2} - x}{x^{3} - 3 x^{2} + 3 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;2 x^{7} + 13 x^{6} + 47 x^{5} + 18 x^{4} + x^{3} - 2 x^{2} + x,
\]
