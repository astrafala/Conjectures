...
\title{The empirical recurrence for OEIS A220705, proved by transfer matrix}
...
\begin{abstract}
OEIS A220705 counts the ways of linking the cells of a grid $5$ cells wide, each cell either to
...
state, the count is a walk count on $S=6$ of them, and the conjectured recurrence is then
...
OEIS A220705 is ``Number of ways to reciprocally link elements of an n X 5 array either to themselves or to exactly two horizontal and antidiagonal neighbors, without consecutive collinear links.''. It has offset $1$ and begins
\[
1, 5, 12, 37, 107, 317, 932, 2749,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + 3*a(n-2) - a(n-4) - 2*a(n-5) - a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 02 2018 06:49:16, revision 7) this is still
...
one configuration. With $M$ the adjacency matrix of the digraph on the $S=6$ reachable
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 3\,a(n-2) - a(n-4) - 2\,a(n-5) - a(n-6)
\]
for every $n>5$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A220705.
