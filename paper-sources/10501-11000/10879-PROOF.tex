...
\title{The empirical recurrence for OEIS A264014, proved by transfer matrix}
...
\begin{abstract}
OEIS A264014 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=5$ rows in which
...
OEIS A264014 is ``Number of (n+1) X (4+1) arrays of permutations of 0..n*5+4 with each element having index change +-(.,.) 0,0 1,2 or 2,2.''. It has offset $1$ and begins
\[
8, 105, 1573, 20570, 269225, 3524125, 46131250, 603865625,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 15*a(n-1) - 25*a(n-2) for n>4.
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 03 2019 15:13:23, revision 10) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264014.
