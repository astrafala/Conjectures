...
\title{The empirical recurrence for OEIS A187161, derived from the entry's generating function}
...
\begin{abstract}
OEIS A187161 carries an empirical recurrence of order $3$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 23 2018 12:36:02, revision 13) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{1348 x^{9} - 1652 x^{8} - 1480 x^{7} - 2088 x^{6} - 472 x^{5}}{x^{3} - 3 x^{2} + 3 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 1348 x^{9} + 1652 x^{8} + 1480 x^{7} + 2088 x^{6} + 472 x^{5},
\]
