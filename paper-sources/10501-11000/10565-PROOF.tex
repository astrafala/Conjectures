...
\title{The empirical recurrence for OEIS A269677, proved by transfer matrix}
...
\begin{abstract}
OEIS A269677 carries an empirical recurrence of order $3$ contributed by R.~H.~Hardin. It is
...
OEIS A269677 is ``Number of length-n 0..7 arrays with no repeated value differing from the previous repeated value by other than plus or minus one modulo 7+1.''. It has offset $1$ and begins
\[
8, 64, 504, 3936, 30504, 234912, 1799256, 13716480,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 13*a(n-1) - 33*a(n-2) - 63*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 26 2019 11:10:11, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;13\,a(n-1) - 33\,a(n-2) - 63\,a(n-3)
\]
for every $n>1$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269677.
