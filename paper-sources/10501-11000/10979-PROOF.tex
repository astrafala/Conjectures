...
\title{The empirical recurrence for OEIS A267937, derived from the entry's generating function}
...
\begin{abstract}
OEIS A267937 carries an empirical recurrence of order $2$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 24 2025 12:15:28, revision 18) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 1000 x^{3} + 1010 x^{2} + 1}{100 x^{2} - 101 x + 1},
\]
