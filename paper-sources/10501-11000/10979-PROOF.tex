...
\title{The empirical recurrence for OEIS A303451, proved by transfer matrix}
...
\begin{abstract}
OEIS A303451 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A303451 is ``Number of nX3 0..1 arrays with every element equal to 0, 1, 2, 3, 4 or 6 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
4, 32, 232, 1696, 12408, 90800, 664512, 4863312,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 8*a(n-1) -4*a(n-2) -2*a(n-3) -36*a(n-4) -16*a(n-5)
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 24 2018 10:18:33, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A303451.
