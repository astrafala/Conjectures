...
\title{The empirical recurrence for OEIS A267851, derived from the entry's generating function}
...
\begin{abstract}
OEIS A267851 carries an empirical recurrence of order $2$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 24 2025 12:37:59, revision 23) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 16 x^{3} + 24 x^{2} - 3 x + 1}{4 x^{2} - 5 x + 1},
\]
