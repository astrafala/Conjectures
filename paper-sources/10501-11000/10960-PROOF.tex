...
\title{The empirical recurrence for OEIS A250800, proved by transfer matrix}
...
\begin{abstract}
OEIS A250800 counts arrays over $\{0,1\}$ in which a statistic taken over short runs
...
OEIS A250800 is ``Number of (3+1) X (n+1) 0..1 arrays with nondecreasing min(x(i,j),x(i,j-1)) in the i direction and nondecreasing absolute value of x(i,j)-x(i-1,j) in the j direction.''. It has offset $1$ and begins
\[
58, 180, 482, 1190, 2776, 6230, 13598, 29084,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 5*a(n-1) - 8*a(n-2) + 3*a(n-3) + 3*a(n-4) - 2*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 20 2018 11:41:11, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250800.
