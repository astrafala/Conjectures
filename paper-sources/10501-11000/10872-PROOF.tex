...
\title{The empirical recurrence for OEIS A234491, proved by transfer matrix}
...
\begin{abstract}
OEIS A234491 counts $2$-column arrays over $\{0,\dots,5\}$ in which every
...
length $n$. Hence $a(n)=\mathbf{1}^{\!\top}M^{n}\mathbf{1}$ on $S=36$ vertices, which
...
OEIS A234491 is ``Number of (n+1) X (1+1) 0..5 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 2 (constant-stress 1 X 1 tilings).''. It has offset
$1$ and begins
\[
250, 1834, 13464, 99142, 728536, 5368636, 39476802,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 5*a(n-1) + 74*a(n-2) - 295*a(n-3) - 1008*a(n-4) + 840*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 20 2022 21:32:01, revision 13) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) + 74\,a(n-2) - 295\,a(n-3) - 1008\,a(n-4) + 840\,a(n-5)
\end{equation}
...
Let $V$ consist of all of $\{0,\dots,5\}^{2}$, and put $S=|V|=36$. For $r,s\in V$ declare $r\to s$ an edge
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234491.
