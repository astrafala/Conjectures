...
\title{The empirical recurrence for OEIS A264472, proved by transfer matrix}
...
\begin{abstract}
OEIS A264472 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=5$ rows in which
...
OEIS A264472 is ``Number of (n+1) X (4+1) arrays of permutations of 0..n*5+4 with each element having directed index change 0,1 1,0 2,1 or -1,-1.''. It has offset $1$ and begins
\[
0, 8, 16, 120, 456, 2232, 10116, 45792,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 18*a(n-2) + 36*a(n-3) - 45*a(n-4) - 216*a(n-5) - 243*a(n-6) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 08 2019 06:45:36, revision 9) this is still
...
\[
(i-h_i,\,j-h_j)\;\in\;\{(-1,-1),\ (0,1),\ (1,0),\ (2,1)\},
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264472.
