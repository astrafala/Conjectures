...
\title{The empirical recurrence for OEIS A234543, proved by transfer matrix}
...
\begin{abstract}
OEIS A234543 counts $2$-column arrays over $\{0,\dots,5\}$ in which every
...
OEIS A234543 is ``Number of (n+1) X (1+1) 0..5 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 3 (constant-stress 1 X 1 tilings).''. It has offset
$1$ and begins
\[
208, 1212, 7056, 41112, 239648, 1397712, 8156096,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 6*a(n-1) + 34*a(n-2) - 204*a(n-3) - 40*a(n-4) + 240*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 20 2022 21:31:49, revision 12) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234543.
