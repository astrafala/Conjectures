...
\title{The empirical recurrence for OEIS A258547, proved by transfer matrix}
...
\begin{abstract}
OEIS A258547 counts the arrays over $\{0,\dots,1\}$ whose $2\times2$ subblocks carry a
...
\[
16, 44, 104, 228, 480, 988, 2008, 4052,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) -5*a(n-2) +2*a(n-3)
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 15:28:33, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A258547.
