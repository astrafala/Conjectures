...
\title{The empirical recurrence for OEIS A059140, derived from the entry's generating function}
...
\begin{abstract}
OEIS A059140 carries an empirical recurrence of order $3$. The entry separately records a
...
OEIS A059140 is ``A hierarchical sequence (S(W2{2}*c) - see A059126).''. It has offset $0$ and begins
\[
4, 15, 40, 93, 202, 423, 868, 1761,\ \dots
\]
...
G.f.: (x-4) / ((x-1)\^{}2*(2*x-1)).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 02 2023 16:12:56, revision 23) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{x - 4}{2 x^{3} - 5 x^{2} + 4 x - 1},
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A059140.
