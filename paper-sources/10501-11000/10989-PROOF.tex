...
\title{The empirical recurrence for OEIS A232145, proved by transfer matrix}
...
\begin{abstract}
OEIS A232145 counts arrays of width $2$ over $\{0,1,2\}$ in which every cell carrying one stated
...
OEIS A232145 is ``Number of n X 2 0..2 arrays with every 0 next to a 1 and every 1 next to a 2 horizontally, diagonally or antidiagonally.''. It has offset $1$ and begins
\[
3, 23, 145, 887, 5487, 33957, 210039, 1299219,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 5*a(n-1) + 6*a(n-2) + 8*a(n-3) + 3*a(n-4) - 8*a(n-5) - 5*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 19 2018 09:30:37, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) + 6\,a(n-2) + 8\,a(n-3) + 3\,a(n-4) - 8\,a(n-5) - 5\,a(n-6)
\]
for every $n>5$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232145.
