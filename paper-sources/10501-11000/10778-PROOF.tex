...
\title{The empirical recurrence for OEIS A267780, derived from the entry's generating function}
...
\begin{abstract}
OEIS A267780 carries an empirical recurrence of order $3$. The entry separately records a
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{24 x^{3} + 4 x^{2} + x + 1}{4 x^{3} - x^{2} - 4 x + 1},
\]
