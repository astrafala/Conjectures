...
\title{The empirical recurrence for OEIS A297909, proved by transfer matrix}
...
\begin{abstract}
OEIS A297909 counts $2$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A297909 is ``Number of n X 2 0..1 arrays with every element equal to 0, 2, 3 or 4 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 5, 12, 37, 104, 301, 864, 2485,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 5*a(n-2) + 8*a(n-3) + 4*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 21 2018 14:29:32, revision
7) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-2) + 8\,a(n-3) + 4\,a(n-4)
\end{equation}
for all $n>4$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297909.
