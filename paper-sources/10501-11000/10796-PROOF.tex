...
\title{The empirical recurrence for OEIS A250692, proved by transfer matrix}
...
\begin{abstract}
OEIS A250692 counts arrays over $\{0,1,2,3\}$ in which a statistic taken over short runs
...
OEIS A250692 is ``Number of (1+1) X (n+1) 0..3 arrays with nondecreasing x(i,j)-x(i,j-1) in the i direction and nondecreasing absolute value of x(i,j)-x(i-1,j) in the j direction.''. It has offset $1$ and begins
\[
104, 543, 2541, 11150, 47002, 193117, 780551, 3122604,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 16*a(n-1) - 106*a(n-2) + 376*a(n-3) - 769*a(n-4) + 904*a(n-5) - 564*a(n-6) + 144*a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 21 2018 09:46:11, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250692.
