...
\title{The empirical recurrence for OEIS A205020, proved by transfer matrix}
...
\begin{abstract}
OEIS A205020 counts arrays over $\{0,\dots,3\}$ under a condition on the determinant of every
...
OEIS A205020 is ``Number of (n+1)X2 0..3 arrays with the determinants of 2X2 subblocks nondecreasing rightwards and downwards.''. It has offset $1$ and begins
\[
256, 2338, 15040, 84899, 456043, 2470216, 13615376, 76027865,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 9*a(n-1) -15*a(n-2) -41*a(n-3) +120*a(n-4) -72*a(n-5) for n>21
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 11:40:21, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;9\,a(n-1) - 15\,a(n-2) - 41\,a(n-3) + 120\,a(n-4) - 72\,a(n-5)
\]
for every $n>21$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A205020.
