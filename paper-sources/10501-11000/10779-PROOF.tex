...
\title{The empirical recurrence for OEIS A221121, proved by transfer matrix}
...
\begin{abstract}
OEIS A221121 carries an empirical recurrence of order $2$ contributed by R.~H.~Hardin. It is
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 03 2018 16:33:57, revision 8) this is still
