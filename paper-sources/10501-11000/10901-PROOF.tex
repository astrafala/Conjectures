...
\title{The empirical recurrence for OEIS A283409, proved by transfer matrix}
...
\begin{abstract}
OEIS A283409 counts $n\times2$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A283409 is ``Number of n X 2 0..1 arrays with no 1 equal to more than three of its horizontal, vertical and antidiagonal neighbors.''. It has offset $1$ and begins
\[
4, 16, 61, 236, 912, 3525, 13624, 52656,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) + 3*a(n-2) + a(n-3) + a(n-4) + a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 21 2019 08:24:40, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + 3\,a(n-2) + a(n-3) + a(n-4) + a(n-5)
\]
for every $n>5$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A283409.
