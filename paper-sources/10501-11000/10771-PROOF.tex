...
\title{The empirical recurrence for OEIS A204638, proved by transfer matrix}
...
\begin{abstract}
OEIS A204638 counts $(n+2)\times6$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A204638 is ``Number of (n+2) X 6 0..3 arrays with every 3 X 3 subblock having three equal elements in a row horizontally, vertically, diagonally or antidiagonally exactly three ways, and new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
4246, 379, 933, 478, 1169, 4366, 8179, 29877,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 5*a(n-1) -3*a(n-2) -4*a(n-3) -12*a(n-4) +12*a(n-5) +21*a(n-6) -9*a(n-7) -9*a(n-8) for n>10.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 08 2018 06:33:00, revision 9) this is still
...
$u_1,u_2,\dots$ over $\{0,\dots,3\}^{6}$, the condition
\[
...
\]
on $S=506269$ vertices in total, the exponent fixed by the entry's own shape and checked against
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204638.
