...
\title{The empirical recurrence for OEIS A264185, proved by transfer matrix}
...
\begin{abstract}
OEIS A264185 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=4$ rows in which
...
OEIS A264185 is ``Number of (n+1) X (3+1) arrays of permutations of 0..n*4+3 with each element having index change +-(.,.) 0,0 1,-1 or 2,2.''. It has offset $1$ and begins
\[
8, 81, 720, 7056, 70560, 705600, 7056000, 70560000,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 10*a(n-1) for n>4.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 29 2023 11:24:39, revision 12) this is still
...
until the working vector was identically zero, settling every larger $j$ at once. The bound is exact: at $n=4$ the recurrence fails on the entry's own published terms, so no larger range holds.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264185.
