...
\title{The empirical recurrence for OEIS A266752, derived from the entry's generating function}
...
\begin{abstract}
OEIS A266752 carries an empirical recurrence of order $2$. The entry separately records a
...
OEIS A266752 is ``Binary representation of the n-th iteration of the "Rule 163" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 100, 10010, 1001010, 100101010, 10010101010, 1001010101010, 100101010101010,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 16 2025 08:33:28, revision 40) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{10 x^{2} - x + 1}{100 x^{2} - 101 x + 1},
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A266752.
