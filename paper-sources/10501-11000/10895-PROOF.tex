...
\title{The empirical recurrence for OEIS A260920, proved by transfer matrix}
...
\begin{abstract}
OEIS A260920 counts $(n+2)\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A260920 is ``Number of (n+2) X (1+2) 0..1 arrays with each 3 X 3 subblock having clockwise perimeter pattern 00010101 00101011 or 01010101.''. It has offset $1$ and begins
\[
36, 48, 104, 186, 297, 491, 883, 1489,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-2) + 3*a(n-4) + 2*a(n-5) + 2*a(n-6) + 3*a(n-7) + a(n-8) for n>10.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 29 2018 08:24:36, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A260920.
