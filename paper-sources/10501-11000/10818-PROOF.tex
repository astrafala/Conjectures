...
\title{The empirical recurrence for OEIS A252236, proved by transfer matrix}
...
\begin{abstract}
OEIS A252236 counts $(n+2)\times3$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252236 is ``Number of (n+2) X (1+2) 0..3 arrays with every 3 X 3 subblock row and column sum not equal to 1 3 4 6 or 7 and every 3 X 3 diagonal and antidiagonal sum equal to 1 3 4 6 or 7.''. It has offset $1$ and begins
\[
342, 858, 2174, 4708, 13376, 34364, 74824, 213344,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 18*a(n-3) - 32*a(n-6) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 02 2018 10:22:25, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252236.
