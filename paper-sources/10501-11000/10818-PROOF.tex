...
\title{The empirical recurrence for OEIS A253153, proved by transfer matrix}
...
\begin{abstract}
OEIS A253153 counts the arrays over $\{0,\dots,1\}$ whose $2\times2$ subblocks carry a
...
OEIS A253153 is ``Number of (n+1) X (2+1) 0..1 arrays with every 2 X 2 subblock diagonal minus antidiagonal sum nondecreasing horizontally and vertically.''. It has offset $1$ and begins
\[
39, 72, 88, 120, 192, 336, 624, 1200,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) -2*a(n-2) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 09 2018 07:28:49, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253153.
