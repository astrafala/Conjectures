...
\title{The empirical recurrence for OEIS A186564, proved by transfer matrix}
...
\begin{abstract}
OEIS A186564 counts the $(n+2)\times7$ arrays over $\{0,\dots,2\}$ in which
...
a state, the count is a walk count on $S=12122$ of them, and the conjectured recurrence is then
...
OEIS A186564 is ``Number of (n+2) X 7 0..2 arrays with every 3 X 3 subblock commuting with each horizontal and vertical neighbor 3 X 3 subblock.''. It has offset $1$ and begins
\[
12122, 2617, 4807, 11557, 21007, 23389, 27391, 33445,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1)-a(n-2)+2*a(n-3)-4*a(n-4)+2*a(n-5)+2*a(n-6)-2*a(n-7) for n>13.
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 03:35:48, revision 10) this is still
...
$12122$, which the model reproduces along with every later term.
...
\]
on the $S=12122$ admissible $3$-tuples. In particular $a$ is $C$-finite.
...
size of the construction is therefore $3^{3\cdot7}$ before the condition prunes
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A186564.
