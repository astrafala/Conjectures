...
\title{The empirical recurrence for OEIS A207924, proved by transfer matrix}
...
\begin{abstract}
OEIS A207924 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
...
OEIS A207924 is ``Number of n X 4 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 0 0 and 1 1 1 vertically.''. It has offset
$1$ and begins
\[
9, 81, 144, 576, 1936, 6400, 21904,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) + 3*a(n-2) + 6*a(n-3) - a(n-4) - a(n-6) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 06 2018 08:55:02, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207924.
