...
\title{The empirical recurrence for OEIS A268255, derived from the entry's generating function}
...
\begin{abstract}
OEIS A268255 carries an empirical recurrence of order $4$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 11 2019 15:14:17, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 18 x^{4} - 28 x^{3} + 32 x^{2} - 7 x}{6 x^{4} + 7 x^{3} - 15 x^{2} + 7 x - 1},
\]
the entry's own generating function, and let
\[
D(x)\;=\;1-\sum_i c_i x^{i}\;=\;- 6 x^{4} - 7 x^{3} + 15 x^{2} - 7 x + 1
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;18 x^{4} + 28 x^{3} - 32 x^{2} + 7 x,
\]
