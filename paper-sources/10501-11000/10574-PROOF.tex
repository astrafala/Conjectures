...
\title{The empirical recurrence for OEIS A187854, derived from the entry's generating function}
...
\begin{abstract}
OEIS A187854 carries an empirical recurrence of order $3$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 26 2018 08:38:50, revision 10) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{800 x^{12} + 7000 x^{11} + 25144 x^{10} + 41584 x^{9} - 2832 x^{8} - 185188 x^{7} - 469620 x^{6} - 569936 x^{5} - 244680 x^{4} - 16032 x^{3}}{x^{3} - 3 x^{2} + 3 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 800 x^{12} - 7000 x^{11} - 25144 x^{10} - 41584 x^{9} + 2832 x^{8} + 185188 x^{7} + 469620 x^{6} + 569936 x^{5} + 244680 x^{4} + 16032 x^{3},
\]
