...
\title{The empirical recurrence for OEIS A317728, proved by transfer matrix}
...
\begin{abstract}
OEIS A317728 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A317728 is ``Number of nX3 0..1 arrays with every element unequal to 1, 2, 3, 4, 5, 6, 7 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 25, 161, 1250, 9541, 72715, 554642, 4229957,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 6*a(n-1) +11*a(n-2) +11*a(n-3) -2*a(n-4) -a(n-5) -2*a(n-6)
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 05 2018 15:46:14, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A317728.
