...
\title{The empirical recurrence for OEIS A267774, derived from the entry's generating function}
...
\begin{abstract}
OEIS A267774 carries an empirical recurrence of order $3$. The entry separately records a
...
OEIS A267774 is ``Decimal representation of the n-th iteration of the "Rule 207" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 6, 29, 123, 503, 2031, 8159, 32703,\ \dots
\]
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{4 x^{3} - x^{2} + x - 1}{8 x^{3} - 14 x^{2} + 7 x - 1},
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267774.
