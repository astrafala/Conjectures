...
\title{The empirical recurrence for OEIS A246475, proved by transfer matrix}
...
\begin{abstract}
OEIS A246475 carries an empirical recurrence of order $9$ contributed by R.~H.~Hardin. It is
...
OEIS A246475 is ``Number of length n+3 0..4 arrays with no pair in any consecutive four terms totalling exactly 4.''. It has offset $1$ and begins
\[
172, 484, 1376, 3904, 11020, 31104, 87888, 248568,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + a(n-3) + 14*a(n-4) + 3*a(n-5) + 6*a(n-6) + a(n-8) + a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 06 2018 04:12:13, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + a(n-3) + 14\,a(n-4) + 3\,a(n-5) + 6\,a(n-6) + a(n-8) + a(n-9)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A246475.
