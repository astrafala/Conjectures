...
\title{The empirical recurrence for OEIS A301903, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A301903 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A301903 is ``Number of nX5 0..1 arrays with every element equal to 0, 2 or 3 horizontally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
1, 3, 2, 8, 12, 64, 196, 864,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 4*a(n-1) +5*a(n-2) -20*a(n-3) -4*a(n-4) +16*a(n-5) for n>6
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 28 2018 16:07:12, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) + 5\,a(n-2) - 20\,a(n-3) - 4\,a(n-4) + 16\,a(n-5)
\end{equation}
for all $n>6$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A301903.
