...
\title{The empirical recurrence for OEIS A209505, proved by transfer matrix}
...
\begin{abstract}
OEIS A209505 counts $(n+1)\times3$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A209505 is ``Half the number of (n+1) X 3 0..2 arrays with every 2 X 2 subblock having two or four distinct clockwise edge differences.''. It has offset $1$ and begins
\[
27, 123, 561, 2559, 11673, 53247, 242889, 1107951,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 5*a(n-1) -2*a(n-2).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 10 2018 06:15:48, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209505.
