...
\title{The empirical recurrence for OEIS A259765, proved by transfer matrix}
...
\begin{abstract}
OEIS A259765 counts $(n+2)\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A259765 is ``Number of (n+2) X (1+2) 0..1 arrays with each 3 X 3 subblock having clockwise perimeter pattern 00000001 or 00000101.''. It has offset $1$ and begins
\[
32, 49, 104, 201, 376, 745, 1494, 2897,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-2) + 2*a(n-3) + 6*a(n-4) + 2*a(n-5) - a(n-6) + 2*a(n-7) - a(n-8) for n>9.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 26 2018 12:15:41, revision 11) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A259765.
