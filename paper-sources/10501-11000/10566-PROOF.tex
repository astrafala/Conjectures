...
\title{The empirical recurrence for OEIS A253225, derived from the entry's generating function}
...
\begin{abstract}
OEIS A253225 carries an empirical recurrence of order $3$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 10 2018 11:17:27, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{7 x^{7} + 5 x^{6} + 15 x^{5} - 80 x^{4} - 22 x^{3} + 103 x^{2} - 47 x}{4 x^{3} - 8 x^{2} + 5 x - 1},
\]
the entry's own generating function, and let
\[
D(x)\;=\;1-\sum_i c_i x^{i}\;=\;- 4 x^{3} + 8 x^{2} - 5 x + 1
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 7 x^{7} - 5 x^{6} - 15 x^{5} + 80 x^{4} + 22 x^{3} - 103 x^{2} + 47 x,
\]
