...
\title{The empirical recurrence for OEIS A208502, proved by transfer matrix}
...
\begin{abstract}
OEIS A208502 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
...
OEIS A208502 is ``Number of 4 X n 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 1 0 and 1 1 1 vertically.''. It has offset
$1$ and begins
\[
9, 81, 126, 324, 828, 2124, 5436,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) + 4*a(n-2) for n>4.
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 03 2018 12:40:35, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208502.
