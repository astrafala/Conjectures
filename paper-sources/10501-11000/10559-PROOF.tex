...
\title{The empirical recurrence for OEIS A153010, derived from the entry's generating function}
...
\begin{abstract}
OEIS A153010 carries an empirical recurrence of order $2$. The entry separately records a
...
OEIS A153010 is ``Indices of A153007 where the entry equals zero.''. It has offset $0$ and begins
\[
0, 1, 2, 3, 7, 15, 31, 63,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 23 2025 18:13:31, revision 22) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{2 x^{4} - x^{3} - x^{2} + x}{2 x^{2} - 3 x + 1},
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A153010.
