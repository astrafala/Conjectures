...
\title{The empirical recurrence for OEIS A267805, derived from the entry's generating function}
...
\begin{abstract}
OEIS A267805 carries an empirical recurrence of order $4$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 16 2025 08:33:29, revision 18) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 16 x^{3} + 6 x^{2} + 7 x + 1}{16 x^{4} - 17 x^{2} + 1},
\]
