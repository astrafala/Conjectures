...
\title{The empirical recurrence for OEIS A187514, derived from the entry's generating function}
...
\begin{abstract}
OEIS A187514 carries an empirical recurrence of order $3$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 24 2018 11:08:46, revision 10) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{13 x^{10} + 77 x^{9} + 164 x^{8} - 164 x^{7} - 1250 x^{6} - 1540 x^{5} - 432 x^{4} - 6 x^{3}}{x^{3} - 3 x^{2} + 3 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 13 x^{10} - 77 x^{9} - 164 x^{8} + 164 x^{7} + 1250 x^{6} + 1540 x^{5} + 432 x^{4} + 6 x^{3},
\]
