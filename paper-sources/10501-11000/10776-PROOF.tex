...
\title{The empirical recurrence for OEIS A267775, derived from the entry's generating function}
...
\begin{abstract}
OEIS A267775 carries an empirical recurrence of order $3$. The entry separately records a
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{100 x^{3} - x^{2} + x - 1}{1000 x^{3} - 1110 x^{2} + 111 x - 1},
\]
