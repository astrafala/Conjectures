...
\title{The empirical recurrence for OEIS A267599, derived from the entry's generating function}
...
\begin{abstract}
OEIS A267599 carries an empirical recurrence of order $2$. The entry separately records a
...
OEIS A267599 is ``Binary representation of the n-th iteration of the "Rule 177" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 1, 1001, 101001, 10101001, 1010101001, 101010101001, 10101010101001,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 16 2025 08:33:29, revision 21) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{1000 x^{2} - 100 x + 1}{100 x^{2} - 101 x + 1},
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267599.
