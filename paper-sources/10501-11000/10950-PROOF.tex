...
\title{The empirical recurrence for OEIS A253521, proved by transfer matrix}
...
\begin{abstract}
OEIS A253521 counts the arrays over $\{0,\dots,2\}$ whose $2\times2$ subblocks carry a
...
so a pair of consecutive array rows is a state, the count is a walk count on $S=42669$ of them,
...
OEIS A253521 is ``Number of (n+1)X(5+1) 0..2 arrays with every 2X2 subblock diagonal minimum minus antidiagonal minimum nondecreasing horizontally and diagonal maximum minus antidiagonal maximum nondecreasing vertically.''. It has offset $1$ and begins
\[
42669, 169828, 256914, 370028, 673229, 1439791, 3429207, 8936967,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 9*a(n-1) -33*a(n-2) +65*a(n-3) -75*a(n-4) +51*a(n-5) -19*a(n-6) +3*a(n-7) for n>15
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 14:05:29, revision 6) this is still
...
\]
on the $S=42669$ admissible pairs. In particular $a$ is $C$-finite. The alignment of the walk
...
\begin{theorem}
\[
a(n)\;=\;9\,a(n-1) - 33\,a(n-2) + 65\,a(n-3) - 75\,a(n-4) + 51\,a(n-5) - 19\,a(n-6) + 3\,a(n-7)
\]
for every $n>15$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253521.
