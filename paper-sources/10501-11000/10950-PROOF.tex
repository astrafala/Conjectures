...
\title{The empirical recurrence for OEIS A188822, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A188822 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A188822 is ``Number of n X 7 binary arrays without the pattern 0 1 diagonally or antidiagonally.''. It has offset $1$ and begins
\[
128, 1156, 3888, 8836, 15776, 24964, 36000, 49284,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) -2*a(n-3) +a(n-4) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 30 2018 09:09:52, revision 9) the statement is
...
publishes, $n=32$, the arrays have $7\cdot32$ cells over
$2$ values, so there are about $10^{67}$ of them to sift. The
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A188822.
