...
\title{The empirical recurrence for OEIS A243600, proved by transfer matrix}
...
\begin{abstract}
OEIS A243600 carries an empirical recurrence of order $5$ contributed by R.~H.~Hardin. It is
...
OEIS A243600 is ``Number of length n+2 0..3 arrays with no three elements in a row with pattern aba (with a!=b) and new values 0..3 introduced in 0..3 order.''. It has offset $1$ and begins
\[
4, 10, 28, 85, 269, 870, 2844, 9346,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 5*a(n-1) - 5*a(n-2) - 3*a(n-3) + 3*a(n-4) + a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 02 2018 10:18:16, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) - 5\,a(n-2) - 3\,a(n-3) + 3\,a(n-4) + a(n-5)
\]
for every $n>6$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A243600.
