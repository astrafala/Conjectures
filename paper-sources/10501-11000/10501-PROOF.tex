...
\title{The empirical recurrence for OEIS A233124, proved by transfer matrix}
...
\begin{abstract}
OEIS A233124 carries an empirical recurrence of order $3$ contributed by R.~H.~Hardin. It is
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 19 2018 09:41:50, revision 7) this is still
