...
\title{The empirical recurrence for OEIS A228503, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A228503 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A228503 is ``Number of nX5 binary arrays with top left value 1 and no two ones adjacent horizontally, vertically, diagonally or antidiagonally.''. It has offset $1$ and begins
\[
5, 11, 88, 358, 2002, 9528, 49101, 243118,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) +16*a(n-2) +a(n-3) -27*a(n-4) +a(n-5) +4*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 04 2025 00:04:30, revision 11) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 16\,a(n-2) + a(n-3) - 27\,a(n-4) + a(n-5) + 4\,a(n-6)
\end{equation}
for all $n>6$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A228503.
