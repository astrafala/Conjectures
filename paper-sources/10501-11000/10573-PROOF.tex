...
\title{The empirical recurrence for OEIS A187853, derived from the entry's generating function}
...
\begin{abstract}
OEIS A187853 carries an empirical recurrence of order $3$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 26 2018 08:38:32, revision 10) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{296 x^{10} + 1736 x^{9} + 3352 x^{8} - 1896 x^{7} - 20928 x^{6} - 43696 x^{5} - 33792 x^{4} - 5328 x^{3}}{x^{3} - 3 x^{2} + 3 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 296 x^{10} - 1736 x^{9} - 3352 x^{8} + 1896 x^{7} + 20928 x^{6} + 43696 x^{5} + 33792 x^{4} + 5328 x^{3},
\]
