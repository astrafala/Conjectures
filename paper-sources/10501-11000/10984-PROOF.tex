...
\title{The empirical recurrence for OEIS A183702, proved by transfer matrix}
...
\begin{abstract}
OEIS A183702 counts arrays over $\{0,\dots,3\}$ under a condition on the determinant of every
$2\times2$ subblock, and carries an empirical recurrence of order $2$ contributed by
...
OEIS A183702 is ``Number of (n+1) X 2 0..3 arrays with every 2 X 2 subblock nonsingular.''. It has offset $1$ and begins
\[
192, 2472, 31800, 409128, 5263608, 67718760, 871232952, 11208812712,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 11*a(n-1) + 24*a(n-2).
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 04 2018 10:09:07, revision 9) this is still
...
another exactly when all $1$ of the subblocks they form pass. An $(n+1)$-row array is then a
walk of $n$ steps and
\[
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A183702.
