...
\title{The empirical recurrence for OEIS A297310, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297310 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A297310 is ``Number of n X 4 0..1 arrays with every 1 horizontally or antidiagonally adjacent to 1 or 2 neighboring 1s.''. It has offset $1$ and begins
\[
7, 66, 497, 3808, 29212, 223995, 1717882, 13174266,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 4*a(n-1) + 26*a(n-2) + 22*a(n-3) - 43*a(n-4) - a(n-5) + 7*a(n-6) - a(n-7) - a(n-8) for n>9.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 26 2019 12:06:16, revision 7) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) + 26\,a(n-2) + 22\,a(n-3) - 43\,a(n-4) - a(n-5) + 7\,a(n-6) - a(n-7) - a(n-8)
\end{equation}
for all $n>9$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297310.
