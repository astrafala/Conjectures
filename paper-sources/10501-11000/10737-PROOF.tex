...
\title{The empirical recurrence for OEIS A067360, derived from the entry's generating function}
...
\begin{abstract}
OEIS A067360 carries an empirical recurrence of order $2$. The entry separately records a
...
OEIS A067360 is ``a(n) = 17\^{}n sin(2n arctan(1/4)) or numerator of tan(2n arctan(1/4)).''. It has offset $1$ and begins
\[
8, 240, 4888, 77280, 905768, 4839120, -116593352, -4896306240,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 30 2026 16:40:08, revision 31) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{8 x}{289 x^{2} - 30 x + 1},
\]
the entry's own generating function, and let
\[
D(x)\;=\;1-\sum_i c_i x^{i}\;=\;289 x^{2} - 30 x + 1
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A067360.
