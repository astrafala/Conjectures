...
\title{The empirical recurrence for OEIS A233196, proved by transfer matrix}
...
\begin{abstract}
OEIS A233196 carries an empirical recurrence of order $2$ contributed by R.~H.~Hardin. It is
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 21 2026 00:07:24, revision 12) this is still
