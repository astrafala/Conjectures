...
\title{The empirical recurrence for OEIS A301788, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A301788 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A301788 is ``Number of nX6 0..1 arrays with every element equal to 0 or 1 horizontally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
13, 22, 38, 66, 116, 205, 364, 648,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +2*a(n-2) -a(n-4) -a(n-5) -a(n-6)
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 26 2018 16:40:24, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 2\,a(n-2) - a(n-4) - a(n-5) - a(n-6)
\end{equation}
for all $n>7$.
...
publishes, $n=32$, the arrays have $6\cdot32$ cells over
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A301788.
