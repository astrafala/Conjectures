...
\title{The empirical recurrence for OEIS A264492, proved by transfer matrix}
...
\begin{abstract}
OEIS A264492 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=5$ columns in which
...
OEIS A264492 is ``Number of (4+1) X (n+1) arrays of permutations of 0..n*5+4 with each element having directed index change 2,-1 1,0 2,1 0,-1 -2,-2 or -1,0.''. It has offset $1$ and begins
\[
12, 16, 212, 788, 4772, 23076, 122628, 626276,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + 16*a(n-2) + 24*a(n-3) + 16*a(n-4) + 32*a(n-5) + 32*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 08 2019 08:19:29, revision 10) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264492.
