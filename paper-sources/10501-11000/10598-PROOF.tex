...
\title{The empirical recurrence for OEIS A224666, derived from the entry's generating function}
...
\begin{abstract}
OEIS A224666 carries an empirical recurrence of order $3$. The entry separately records a
...
OEIS A224666 is ``Number of 4 X 4 0..n matrices with each 2 X 2 subblock idempotent.''. It has offset $1$ and begins
\[
78, 108, 142, 180, 222, 268, 318, 372,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 02 2018 17:10:47, revision 10) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 52 x^{3} + 126 x^{2} - 78 x}{x^{3} - 3 x^{2} + 3 x - 1},
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224666.
