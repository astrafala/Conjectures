...
\title{The empirical recurrence for OEIS A243518, proved by transfer matrix}
...
\begin{abstract}
OEIS A243518 carries an empirical recurrence of order $8$ contributed by R.~H.~Hardin. It is
true, and it is decidable rather than empirical. The entry's condition is local to a bounded window of consecutive lines, so
the admissible configurations of such a window are the vertices of a finite digraph and the
arrays counted are exactly the walks in it; hence $a(n)$ is a walk count on $S=327$ vertices
...
OEIS A243518 is ``Number of length n+2 0..9 arrays with no three elements in a row with pattern aba or abb (with a!=b) and new values 0..9 introduced in 0..9 order.''. It has offset $1$ and begins
\[
3, 5, 10, 25, 77, 280, 1157, 5297,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 30*a(n-1) - 372*a(n-2) + 2478*a(n-3) - 9639*a(n-4) + 22260*a(n-5) - 29588*a(n-6) + 20592*a(n-7) - 5760*a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 02 2018 09:28:00, revision 8) this is still
...
admissible array is then exactly a walk, so with $M$ the adjacency matrix on $S=327$ vertices
...
\begin{theorem}
\[
a(n)\;=\;30\,a(n-1) - 372\,a(n-2) + 2478\,a(n-3) - 9639\,a(n-4) + 22260\,a(n-5) - 29588\,a(n-6) + 20592\,a(n-7) - 5760\,a(n-8)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A243518.
