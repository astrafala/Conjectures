...
\title{The empirical recurrence for OEIS A260008, proved by transfer matrix}
...
\begin{abstract}
OEIS A260008 counts $(n+2)\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A260008 is ``Number of (n+2) X (1+2) 0..1 arrays with each 3 X 3 subblock having clockwise perimeter pattern 00000101 00010101 or 01010101.''. It has offset $1$ and begins
\[
36, 49, 109, 209, 436, 828, 1744, 3344,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-2) + 7*a(n-4) + a(n-5) + 2*a(n-6) + a(n-7) - a(n-8) + a(n-9) for n>10.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 27 2018 14:56:06, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-2) + 7\,a(n-4) + a(n-5) + 2\,a(n-6) + a(n-7) - a(n-8) + a(n-9)
\]
for every $n>10$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A260008.
