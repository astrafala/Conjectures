...
\title{The empirical recurrence for OEIS A262326, proved by transfer matrix}
...
\begin{abstract}
OEIS A262326 carries an empirical recurrence of order $3$ contributed by R.~H.~Hardin. It is
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 20 2018 20:36:53, revision 10) this is still
