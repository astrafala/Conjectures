...
\title{The empirical recurrence for OEIS A221829, proved by transfer matrix}
...
\begin{abstract}
OEIS A221829 carries an empirical recurrence of order $2$ contributed by R.~H.~Hardin. It is
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 11 2018 10:45:49, revision 12) this is still
