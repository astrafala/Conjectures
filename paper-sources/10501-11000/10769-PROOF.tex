...
\title{The empirical recurrence for OEIS A234444, proved by transfer matrix}
...
\begin{abstract}
OEIS A234444 counts $2$-column arrays over $\{0,\dots,4\}$ in which every
...
OEIS A234444 is ``Number of (n+1) X (1+1) 0..4 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 1 (constant-stress 1 X 1 tilings).''. It has offset
$1$ and begins
\[
160, 1120, 8064, 58720, 428800, 3137920, 22953984,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 60*a(n-2) - 344*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 20 2022 21:32:33, revision 13) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234444.
