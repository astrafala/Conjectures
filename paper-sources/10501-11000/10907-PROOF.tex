...
\title{The empirical recurrence for OEIS A299656, proved by transfer matrix}
...
\begin{abstract}
OEIS A299656 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $equal to$ itself lying in $\{0,1,2,3,4,5,7\}$, and it carries an empirical
...
OEIS A299656 is ``Number of nX3 0..1 arrays with every element equal to 0, 1, 2, 3, 4, 5 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
4, 32, 227, 1642, 11888, 86123, 624007, 4521433,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 7*a(n-1) +3*a(n-2) -6*a(n-3) -18*a(n-4) -15*a(n-5) -17*a(n-6) -32*a(n-7) -12*a(n-8)
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 15 2018 14:45:45, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;7\,a(n-1) + 3\,a(n-2) - 6\,a(n-3) - 18\,a(n-4) - 15\,a(n-5) - 17\,a(n-6) - 32\,a(n-7) - 12\,a(n-8)
\end{equation}
for all $n>8$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A299656.
