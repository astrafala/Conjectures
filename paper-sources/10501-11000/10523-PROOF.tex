...
\title{The empirical recurrence for OEIS A252516, proved by transfer matrix}
...
\begin{abstract}
OEIS A252516 counts $(n+2)\times3$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252516 is ``Number of (n+2) X (1+2) 0..3 arrays with every 3 X 3 subblock row and column sum not equal to 0 2 4 6 or 7 and every 3 X 3 diagonal and antidiagonal sum equal to 0 2 4 6 or 7.''. It has offset $1$ and begins
\[
806, 791, 475, 660, 1093, 1471, 2176, 3809,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 6*a(n-3) - 7*a(n-6) + 2*a(n-9) for n>14.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 03 2018 18:32:11, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252516.
