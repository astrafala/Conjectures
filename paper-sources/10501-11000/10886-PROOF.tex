...
\title{The empirical recurrence for OEIS A063128, derived from the entry's generating function}
...
\begin{abstract}
OEIS A063128 carries an empirical recurrence of order $2$. The entry separately records a
...
OEIS A063128 is ``Dimension of the space of weight 2n cusp forms for Gamma\_0( 60 ).''. It has offset $1$ and begins
\[
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A063128.
