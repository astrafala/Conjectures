...
\title{The empirical recurrence for OEIS A207719, proved by transfer matrix}
...
\begin{abstract}
OEIS A207719 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
...
OEIS A207719 is ``Number of 4 X n 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 0 1 and 1 0 0 vertically.''. It has offset
$1$ and begins
\[
9, 81, 387, 2205, 12015, 66339, 364869,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 4*a(n-1) +10*a(n-2) -8*a(n-3) -9*a(n-4) +6*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 25 2018 12:21:00, revision
8) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) + 10\,a(n-2) - 8\,a(n-3) - 9\,a(n-4) + 6\,a(n-5)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207719.
