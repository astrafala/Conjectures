...
\title{The empirical recurrence for OEIS A267816, derived from the entry's generating function}
...
\begin{abstract}
OEIS A267816 carries an empirical recurrence of order $3$. The entry separately records a
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{16 x^{3} - 16 x^{2} + 4 x - 1}{8 x^{3} - 14 x^{2} + 7 x - 1},
\]
