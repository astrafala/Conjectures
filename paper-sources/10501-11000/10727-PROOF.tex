...
\title{The empirical recurrence for OEIS A063148, derived from the entry's generating function}
...
\begin{abstract}
OEIS A063148 carries an empirical recurrence of order $2$. The entry separately records a
...
OEIS A063148 is ``Dimension of the space of weight 2n cusp forms for Gamma\_0( 80 ).''. It has offset $1$ and begins
\[
7, 30, 54, 78, 102, 126, 150, 174,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 22 2019 12:18:12, revision 14) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{x^{3} + 16 x^{2} + 7 x}{x^{2} - 2 x + 1},
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A063148.
