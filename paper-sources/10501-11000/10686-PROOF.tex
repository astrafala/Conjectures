...
\title{The empirical recurrence for OEIS A187511, derived from the entry's generating function}
...
\begin{abstract}
OEIS A187511 carries an empirical recurrence of order $3$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 24 2018 09:20:12, revision 11) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{7 x^{7} + 11 x^{6} - 64 x^{5} - 164 x^{4} - 36 x^{3}}{x^{3} - 3 x^{2} + 3 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 7 x^{7} - 11 x^{6} + 64 x^{5} + 164 x^{4} + 36 x^{3},
\]
