...
\title{The empirical recurrence for OEIS A297655, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297655 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A297655 is ``Number of 2Xn 0..1 arrays with every 1 horizontally, diagonally or antidiagonally adjacent to 1, 2 or 3 neighboring 1s.''. It has offset $1$ and begins
\[
1, 10, 43, 140, 494, 1845, 6757, 24479,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) -2*a(n-2) +13*a(n-3) +6*a(n-4) +12*a(n-5) +12*a(n-6)
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 02 2018 15:15:23, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) - 2\,a(n-2) + 13\,a(n-3) + 6\,a(n-4) + 12\,a(n-5) + 12\,a(n-6)
\end{equation}
for all $n>7$.
...
the middle column. The vector $w$ was formed by $6$ applications of $G$ in exact integer
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297655.
