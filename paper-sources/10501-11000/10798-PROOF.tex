...
\title{The empirical recurrence for OEIS A301796, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A301796 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A301796 is ``Number of 7 X n 0..1 arrays with every element equal to 0 or 1 horizontally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
64, 610, 192, 221, 275, 364, 508, 741,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) -a(n-3) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 03 2022 22:51:48, revision 6) the statement is
...
publishes, $n=33$, the arrays have $7\cdot33$ cells over
$2$ values, so there are about $10^{69}$ of them to sift. The
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A301796.
