...
\title{The empirical recurrence for OEIS A297391, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297391 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A297391 is ``Number of n X 4 0..1 arrays with every 1 horizontally, diagonally or antidiagonally adjacent to 1 neighboring 1.''. It has offset $1$ and begins
\[
4, 13, 37, 126, 385, 1243, 3924, 12477,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) + 6*a(n-2) + 4*a(n-3) - 3*a(n-4) - a(n-5) - 2*a(n-6) - a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 28 2019 06:22:49, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297391.
