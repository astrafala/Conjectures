...
\title{The empirical recurrence for OEIS A252980, derived from the entry's generating function}
...
\begin{abstract}
OEIS A252980 carries an empirical recurrence of order $3$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 20 2018 10:17:07, revision 7) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 17856 x^{11} - 116199 x^{10} - 298886 x^{9} - 379211 x^{8} - 243514 x^{7} - 57041 x^{6} - 1673 x^{5} - 566 x^{4} - 161 x^{3} - 23 x^{2} - 6 x}{x^{3} - 3 x^{2} + 3 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;17856 x^{11} + 116199 x^{10} + 298886 x^{9} + 379211 x^{8} + 243514 x^{7} + 57041 x^{6} + 1673 x^{5} + 566 x^{4} + 161 x^{3} + 23 x^{2} + 6 x,
\]
