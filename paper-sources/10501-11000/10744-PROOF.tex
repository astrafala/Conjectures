...
\title{The empirical recurrence for OEIS A253219, derived from the entry's generating function}
...
\begin{abstract}
OEIS A253219 carries an empirical recurrence of order $3$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 10 2018 08:55:00, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 5 x^{9} - 45 x^{8} - 178 x^{7} - 483 x^{6} - 259 x^{5} + 14 x^{4} - x^{3} - 3 x}{x^{3} - 3 x^{2} + 3 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;5 x^{9} + 45 x^{8} + 178 x^{7} + 483 x^{6} + 259 x^{5} - 14 x^{4} + x^{3} + 3 x,
\]
