...
\title{The empirical recurrence for OEIS A255163, derived from the entry's generating function}
...
\begin{abstract}
OEIS A255163 carries an empirical recurrence of order $2$. The entry separately records a
...
OEIS A255163 is ``Irrational parts of circle radii in nested circles and hexagons (see comment).''. It has offset $0$ and begins
\[
1, 2, -12, 168, -2160, 27936, -361152, 4669056,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 22 2015 23:38:15, revision 16) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 14 x - 1}{12 x^{2} - 12 x - 1},
\]
the entry's own generating function, and let
\[
D(x)\;=\;1-\sum_i c_i x^{i}\;=\;- 12 x^{2} + 12 x + 1
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A255163.
