...
\title{The empirical recurrence for OEIS A063151, derived from the entry's generating function}
...
\begin{abstract}
OEIS A063151 carries an empirical recurrence of order $2$. The entry separately records a
...
OEIS A063151 is ``Dimension of the space of weight 2n cusp forms for Gamma\_0( 83 ).''. It has offset $1$ and begins
\[
7, 20, 34, 48, 62, 76, 90, 104,\ \dots
\]
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{x^{3} + 6 x^{2} + 7 x}{x^{2} - 2 x + 1},
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A063151.
