...
\title{The empirical recurrence for OEIS A267461, derived from the entry's generating function}
...
\begin{abstract}
OEIS A267461 carries an empirical recurrence of order $4$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 16 2025 08:33:29, revision 19) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{2 x^{4} - 2 x^{2} - 2 x}{x^{4} - 2 x^{3} + 2 x - 1},
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267461.
