...
\title{The empirical recurrence for OEIS A063144, derived from the entry's generating function}
...
\begin{abstract}
OEIS A063144 carries an empirical recurrence of order $2$. The entry separately records a
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{x^{3} + 11 x^{2} + 8 x}{x^{2} - 2 x + 1},
\]
