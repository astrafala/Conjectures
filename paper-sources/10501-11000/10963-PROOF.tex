...
\title{The empirical recurrence for OEIS A267876, derived from the entry's generating function}
...
\begin{abstract}
OEIS A267876 carries an empirical recurrence of order $2$. The entry separately records a
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 100000 x^{5} + 89910 x^{3} + 10201 x^{2} - 101 x + 1}{100 x^{2} - 101 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 100000 x^{5} + 89910 x^{3} + 10201 x^{2} - 101 x + 1,
\]
