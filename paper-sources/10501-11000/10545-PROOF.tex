...
\title{The empirical recurrence for OEIS A232508, proved by transfer matrix}
...
\begin{abstract}
OEIS A232508 counts arrays of width $2$ over $\{0,\dots,2\}$ under a condition on each cell
...
OEIS A232508 is ``Number of (n+1) X (1+1) 0..2 arrays with every element next to itself plus and minus one within the range 0..2 horizontally, diagonally or antidiagonally, with no adjacent elements equal.''. It has offset $1$ and begins
\[
4, 4, 8, 16, 28, 52, 96, 176,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + a(n-2) + a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 05 2018 11:41:56, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232508.
