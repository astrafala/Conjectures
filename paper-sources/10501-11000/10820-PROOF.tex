...
\title{The empirical recurrence for OEIS A206144, proved by transfer matrix}
...
\begin{abstract}
OEIS A206144 counts arrays over $\{0,\dots,2\}$ under a condition on the perimeter cycle of
every $2\times3$ and $3\times2$ subblock, and carries an empirical recurrence of order $2$ contributed by
R.~H.~Hardin. It is true, and it is decidable rather than empirical. The condition is local to
a bounded window of consecutive rows, so the count is a walk count on $S=60$ states and is
...
OEIS A206144 is ``Number of (n+1) X 3 0..2 arrays with every 2 X 3 or 3 X 2 subblock having exactly three counterclockwise and three clockwise edge increases.''. It has offset $1$ and begins
\[
60, 246, 1122, 5118, 23346, 106494, 485778, 2215902,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 5*a(n-1) - 2*a(n-2) for n > 3.
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 04 2018 06:41:04, revision 11) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206144.
