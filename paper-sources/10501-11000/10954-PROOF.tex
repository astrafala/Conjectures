...
\title{The empirical recurrence for OEIS A267622, derived from the entry's generating function}
...
\begin{abstract}
OEIS A267622 carries an empirical recurrence of order $2$. The entry separately records a
...
OEIS A267622 is ``Binary representation of the n-th iteration of the "Rule 187" elementary cellular automaton starting with a single ON (black) cell.''. It has offset $0$ and begins
\[
1, 101, 10111, 1011111, 101111111, 10111111111, 1011111111111, 101111111111111,\ \dots
\]
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{10 x^{2} + 1}{100 x^{2} - 101 x + 1},
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267622.
