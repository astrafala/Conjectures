...
\title{The empirical recurrence for OEIS A063098, derived from the entry's generating function}
...
\begin{abstract}
OEIS A063098 carries an empirical recurrence of order $2$. The entry separately records a
...
OEIS A063098 is ``Dimension of the space of weight 2n cusp forms for Gamma\_0( 30 ).''. It has offset $1$ and begins
\[
3, 14, 26, 38, 50, 62, 74, 86,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 25 2022 21:43:15, revision 13) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{x^{3} + 8 x^{2} + 3 x}{x^{2} - 2 x + 1},
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A063098.
