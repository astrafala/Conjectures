...
\title{The empirical recurrence for OEIS A253503, derived from the entry's generating function}
...
\begin{abstract}
OEIS A253503 carries an empirical recurrence of order $3$. The entry separately records a
...
OEIS A253503 is ``Number of (n+2) X (1+2) 0..1 arrays with every 2 X 2 and 3 X 3 subblock diagonal maximum minus antidiagonal minimum nondecreasing horizontally and vertically.''. It has offset $1$ and begins
\[
132, 260, 428, 636, 884, 1172, 1500, 1868,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 16 2018 08:37:43, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 44 x^{3} + 136 x^{2} - 132 x}{x^{3} - 3 x^{2} + 3 x - 1},
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253503.
