...
\title{The empirical recurrence for OEIS A207171, proved by transfer matrix}
...
\begin{abstract}
OEIS A207171 counts arrays over $\{0,\dots,1\}$ of width $3$ that avoid the patterns
...
OEIS A207171 is ``Number of 3 X n 0..1 arrays avoiding 0 0 0 and 1 0 1 horizontally and 0 0 1 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
6, 36, 90, 261, 624, 1482, 3808,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) + 9*a(n-3) + 2*a(n-4) + 2*a(n-5) - 12*a(n-6) - 8*a(n-7) + 8*a(n-9) for n>11.
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 05 2018 05:23:15, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 9\,a(n-3) + 2\,a(n-4) + 2\,a(n-5) - 12\,a(n-6) - 8\,a(n-7) + 8\,a(n-9)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207171.
