...
\title{The empirical recurrence for OEIS A253496, proved by transfer matrix}
...
\begin{abstract}
OEIS A253496 counts the arrays over $\{0,\dots,2\}$ whose $2\times2$ subblocks carry a
...
OEIS A253496 is ``Number of (2+1) X (n+1) 0..2 arrays with every 2 X 2 subblock diagonal minus antidiagonal sum nondecreasing horizontally, vertically and ne-to-sw antidiagonally.''. It has offset $1$ and begins
\[
414, 1377, 3090, 5386, 9679, 20975, 51167, 133311,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 6*a(n-1) - 11*a(n-2) + 6*a(n-3) for n>9.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 16 2018 06:44:47, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253496.
