...
\title{The empirical recurrence for OEIS A232956, proved by transfer matrix}
...
\begin{abstract}
OEIS A232956 carries an empirical recurrence of order $2$ contributed by R.~H.~Hardin. It is
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 06 2018 11:37:57, revision 8) this is still
...
admissible array is then exactly a walk, so with $M$ the adjacency matrix on $S=2$ vertices
