...
\title{The empirical recurrence for OEIS A267185, derived from the entry's generating function}
...
\begin{abstract}
OEIS A267185 carries an empirical recurrence of order $3$. The entry separately records a
...
OEIS A267185 is ``Column 2 of the square array in A267181.''. It has offset $0$ and begins
\[
0, 1, 0, 4, 2, 5, 3, 6,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 30 2016 02:31:23, revision 7) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{5} - x^{4} + 3 x^{3} - x^{2} + x}{x^{3} - x^{2} - x + 1},
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267185.
