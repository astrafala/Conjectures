...
\title{The empirical recurrence for OEIS A187610, derived from the entry's generating function}
...
\begin{abstract}
OEIS A187610 carries an empirical recurrence of order $3$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 25 2018 11:48:59, revision 11) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{277 x^{12} - 403 x^{11} + 312 x^{10} - 243 x^{9} - 546 x^{8} - 238 x^{7} - 423 x^{6} - 96 x^{5}}{x^{3} - 3 x^{2} + 3 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 277 x^{12} + 403 x^{11} - 312 x^{10} + 243 x^{9} + 546 x^{8} + 238 x^{7} + 423 x^{6} + 96 x^{5},
\]
