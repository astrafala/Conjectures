...
\title{The empirical recurrence for OEIS A226264, derived from the entry's generating function}
...
\begin{abstract}
OEIS A226264 carries an empirical recurrence of order $2$. The entry separately records a
...
OEIS A226264 is ``Number of additive Z\_2 Z\_8 codes of a certain type (see Siap-Aydogdu for precise definition).''. It has offset $1$ and begins
\[
36, 84, 180, 372, 756, 1524, 3060, 6132,\ \dots
\]
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 24 x^{2} + 36 x}{2 x^{2} - 3 x + 1},
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A226264.
