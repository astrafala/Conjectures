...
\title{The empirical recurrence for OEIS A188710, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A188710 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A188710 is ``Number of 6 X n binary arrays without the pattern 0 0 diagonally or vertically.''. It has offset $1$ and begins
\[
21, 288, 4084, 57665, 813309, 11462588, 161506225, 2275402541,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 21*a(n-1) - 112*a(n-2) + 217*a(n-3) - 157*a(n-4) + 36*a(n-5) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 28 2018 12:49:17, revision 11) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A188710.
