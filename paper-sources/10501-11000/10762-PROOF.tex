...
\title{The empirical recurrence for OEIS A245990, derived from the entry's generating function}
...
\begin{abstract}
OEIS A245990 carries an empirical recurrence of order $2$. The entry separately records a
...
OEIS A245990 is ``Number of length n+2 0..3 arrays with no pair in any consecutive three terms totalling exactly 3.''. It has offset $1$ and begins
\[
28, 68, 164, 396, 956, 2308, 5572, 13452,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 25 2025 19:55:34, revision 13) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 12 x^{2} - 28 x}{x^{2} + 2 x - 1},
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A245990.
