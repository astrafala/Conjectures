...
\title{The empirical recurrence for OEIS A267044, derived from the entry's generating function}
...
\begin{abstract}
OEIS A267044 carries an empirical recurrence of order $3$. The entry separately records a
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{x^{4} - x^{2} + 1}{10 x^{3} - x^{2} - 10 x + 1},
\]
