...
\title{The empirical closed form for OEIS A208140, proved}
...
\begin{abstract}
OEIS A208140 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A208140 is ``Number of n X 6 0..1 arrays avoiding 0 0 1 and 0 1 1 horizontally and 0 0 1 and 1 0 1 vertically.''. It has offset $1$ and begins
\[
16, 256, 1600, 6400, 19600, 50176, 112896, 230400,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (4/9)*n\^{}6 + (8/3)*n\^{}5 + (52/9)*n\^{}4 + (16/3)*n\^{}3 + (16/9)*n\^{}2.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 28 2018 14:35:49, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{4 n^{6}}{9} + \frac{8 n^{5}}{3} + \frac{52 n^{4}}{9} + \frac{16 n^{3}}{3} + \frac{16 n^{2}}{9}.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208140.
