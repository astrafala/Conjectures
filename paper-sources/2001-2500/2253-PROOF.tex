...
\title{The empirical recurrence for OEIS A262268, proved by transfer matrix}
...
\begin{abstract}
OEIS A262268 counts arrays of width $4$ over $\{0,1\}$ whose rows, read as base-$2$
numbers, are divisible by $5$ and whose columns, read the same way, are divisible by
$5$. The entry carries an empirical recurrence of order $8$ contributed by
...
is then a walk count on $S=25$ states.
\end{abstract}
...
OEIS A262268 is ``Number of (n+2) X (2+2) 0..1 arrays with each row and column divisible by 5, read as a binary number with top and left being the most significant bits.''. It has offset $1$ and begins
\[
4, 16, 49, 169, 676, 2704, 10609, 42025,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 6*a(n-1) - 12*a(n-2) + 24*a(n-3) - 31*a(n-4) - 6*a(n-5) + 12*a(n-6) - 24*a(n-7) + 32*a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 31 2018 05:46:00, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) - 12\,a(n-2) + 24\,a(n-3) - 31\,a(n-4) - 6\,a(n-5) + 12\,a(n-6) - 24\,a(n-7) + 32\,a(n-8)
\]
for every $n>5$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A262268.
