...
\title{The empirical recurrence for OEIS A239650, proved by transfer matrix}
...
\begin{abstract}
OEIS A239650 counts arrays over $\{0,1,2,3\}$ in which no entry may equal, modulo $4$, a given
...
OEIS A239650 is ``Number of 2 X n 0..3 arrays with no element equal to zero plus the sum of elements to its left or two plus the sum of the elements above it, modulo 4.''. It has offset $1$ and begins
\[
4, 20, 92, 418, 1898, 8588, 38888, 175974,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) + 12*a(n-2) - 18*a(n-3) - 29*a(n-4) + 19*a(n-5) + 38*a(n-6) + 8*a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 26 2018 11:18:32, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A239650.
