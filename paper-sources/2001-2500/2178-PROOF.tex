...
\title{The empirical recurrence for OEIS A274751, proved by counting patterns}
...
\begin{abstract}
OEIS A274751 counts arrays in which no entry may repeat a value found at any of three stated
...
cutting $6818$ pairs to $S=1223$ states. The entry's empirical recurrence of order $8$,
...
OEIS A274751 is ``Number of 4 X n 0..2 arrays with no element equal to any value at offset (-1,-2) (0,-1) or (-1,0) and new values introduced in order 0..2.''. It has offset $1$ and begins
\[
4, 27, 144, 813, 4554, 25585, 143634, 806695,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) + 20*a(n-2) + 10*a(n-3) - 44*a(n-4) - 20*a(n-5) + 31*a(n-6) + 2*a(n-7) - 4*a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 30 2019 15:26:53, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 20\,a(n-2) + 10\,a(n-3) - 44\,a(n-4) - 20\,a(n-5) + 31\,a(n-6) + 2\,a(n-7) - 4\,a(n-8)
\end{equation}
for all $n>9$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A274751.
