...
\title{The empirical recurrence for OEIS A231397, proved by transfer matrix}
...
\begin{abstract}
OEIS A231397 counts $2\times(n+1)$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A231397 is ``Number of (1+1) X (n+1) 0..2 arrays with no element unequal to a strict majority of its horizontal, diagonal and antidiagonal neighbors, with values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
3, 7, 14, 33, 78, 189, 482, 1225,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) + a(n-2) - 16*a(n-3) + 4*a(n-4) + 24*a(n-5) - 16*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 29 2018 03:01:00, revision 11) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231397.
