...
\title{The empirical recurrence for OEIS A239188, proved by transfer matrix}
...
\begin{abstract}
OEIS A239188 counts arrays over $\{0,1,\dots,4\}$ in which no entry may equal, modulo $5$, a given
...
OEIS A239188 is ``Number of n X 2 0..4 arrays with no element equal to the sum of elements to its left or the sum of elements above it, modulo 5.''. It has offset $1$ and begins
\[
12, 120, 1276, 13128, 136684, 1416192, 14700364, 152485288,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 6*a(n-1) + 50*a(n-2) - 26*a(n-3) - 253*a(n-4) + 240*a(n-5) + 416*a(n-6) - 624*a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 25 2018 11:53:23, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) + 50\,a(n-2) - 26\,a(n-3) - 253\,a(n-4) + 240\,a(n-5) + 416\,a(n-6) - 624\,a(n-7)
\]
for every $n>6$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A239188.
