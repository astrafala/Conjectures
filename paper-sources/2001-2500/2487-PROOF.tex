...
\title{The empirical closed form for OEIS A207400, proved}
...
\begin{abstract}
OEIS A207400 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A207400 is ``Number of n X 5 0..1 arrays avoiding 0 0 1 and 0 1 1 horizontally and 0 0 1 and 1 1 0 vertically.''. It has offset $1$ and begins
\[
12, 144, 612, 1782, 4212, 8692, 16284, 28362,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (1/3)*n\^{}5 + 3*n\^{}4 + (28/3)*n\^{}3 + 7*n\^{}2 - (29/3)*n + 2.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 22 2018 08:27:43, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{n^{5}}{3} + 3 n^{4} + \frac{28 n^{3}}{3} + 7 n^{2} - \frac{29 n}{3} + 2.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207400.
