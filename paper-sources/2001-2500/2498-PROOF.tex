...
\title{The empirical column recurrences for the table OEIS A264003}
...
\begin{abstract}
OEIS A264003 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A264003 is ``T(n,k)=Number of (n+1)X(k+1) arrays of permutations of 0..(n+1)*(k+1)-1 with each element having index change (+-,+-) 0,0 1,2 or 1,0.''. It has offset $1$, is
read by antidiagonals, and begins
\[
4, 18, 9, 81, 99, 25, 288, 1089,\ \dots
\]
...
k=4: [order 30]\\
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 10 2015 10:19:04, revision 6) these are still
...
The sequence is ``Number of (n+1)X(2) arrays of permutations of 0..(n+1)*(2)-1 with each element having index change (+-,+-) 0,0 1,2 or 1,0.''. Its rows are the vertices of a digraph on
...
The sequence is ``Number of (n+1)X(3) arrays of permutations of 0..(n+1)*(3)-1 with each element having index change (+-,+-) 0,0 1,2 or 1,0.''. Its rows are the vertices of a digraph on
$S=64$ vertices, edges being the admissible consecutive pairs, and the count is
$\mathbf{1}^{\!\top}M^{n}\mathbf{1}$ up to the constant factor in the entry's name.
The conjectured recurrence
\[
a(n)\;=\;5\,a(n-1) + 37\,a(n-2) - 44\,a(n-3) - 256\,a(n-4) + 64\,a(n-5) + 256\,a(n-6)
\]
...
\[
(c_1,\dots,c_{30})=(50,\ 2875,\ -69880,\ -2008863,\ 34481460,\ 424664817,\ -6547031494,\ -20222380899,\ 478816817092,\ -1562080962409,\ -10431531548872,\ 119910039231312,\ -60142902473088,\ -2339051645501952,\ 2569755494551552,\ 11855594552791040,\ 3737073326620672,\ 28313788756590592,\ -80667450339753984,\ 150350372894932992,\ -83981604132749312,\ -1823349379172401152,\ 1401420734823137280,\ 2239178480786866176,\ -1256030644895481856,\ -805031842280374272,\ 143810417196531712,\ 71886001504518144,\ -2226511046246400,\ -801543976648704).
\]
...
model reproduces $15$ published values, $53$ decimal digits in all, every one of
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264003.
