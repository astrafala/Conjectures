...
\title{The empirical closed form for OEIS A188556, proved}
...
\begin{abstract}
OEIS A188556 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A188556 is ``Number of 5 X n binary arrays without the pattern 0 1 diagonally, vertically, antidiagonally or horizontally.''. It has offset $1$ and begins
\[
6, 11, 20, 36, 64, 112, 192, 321,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (1/120)*n\^{}5 - (1/24)*n\^{}4 + (3/8)*n\^{}3 + (1/24)*n\^{}2 + (157/60)*n + 3.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 27 2018 11:01:31, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{n^{5}}{120} - \frac{n^{4}}{24} + \frac{3 n^{3}}{8} + \frac{n^{2}}{24} + \frac{157 n}{60} + 3.
\]
...
$n=8,\dots,13$ and agree at each. A monic recurrence of order $6$
determines $a(m)$ from $a(m-1),\dots,a(m-6)$, and for every $m\ge14$ both
$m>7$ and $m-6\ge8$ hold, so induction on $m$ gives $a(m)=f(m)$ for every
$m\ge8$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A188556.
