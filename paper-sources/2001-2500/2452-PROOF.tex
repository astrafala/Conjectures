...
\title{The empirical recurrence for OEIS A262421, proved by transfer matrix}
...
\begin{abstract}
OEIS A262421 counts arrays of width $3$ over $\{0,1\}$ whose rows, read as base-$2$
numbers, are not divisible by $3$ and whose columns, read the same way, are divisible by
$3$. The entry carries an empirical recurrence of order $7$ contributed by
...
is then a walk count on $S=27$ states.
\end{abstract}
...
OEIS A262421 is ``Number of (2+1) X (n+1) 0..1 arrays with each row divisible by 3 and column not divisible by 3, read as a binary number with top and left being the most significant bits.''. It has offset $1$ and begins
\[
5, 4, 45, 114, 709, 2892, 15293, 72370,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 5*a(n-1) + 12*a(n-2) - 60*a(n-3) - 39*a(n-4) + 195*a(n-5) + 28*a(n-6) - 140*a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 31 2018 11:27:10, revision 9) this is still
...
So the vector $\bigl(\gamma_1\bmod 3,\dots,\gamma_{3}\bmod
3\bigr)$ is a state: at most $3^{3}$ of them, and each array row
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) + 12\,a(n-2) - 60\,a(n-3) - 39\,a(n-4) + 195\,a(n-5) + 28\,a(n-6) - 140\,a(n-7)
\]
for every $n>5$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A262421.
