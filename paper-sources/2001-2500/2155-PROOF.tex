...
\title{The conjectured generating function for OEIS A184130, proved}
...
\begin{abstract}
OEIS A184130 counts arrays of a fixed width under a local condition, and carries a conjectured
...
OEIS A184130 is ``Number of n X 2 0..2 arrays with rows and columns in nondecreasing order.''. It has offset $1$ and begins
\[
6, 29, 112, 356, 972, 2359,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 12 2018 04:12:32, revision 10) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A184130.
