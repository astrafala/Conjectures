...
\title{The empirical recurrence for OEIS A204650, proved by transfer matrix}
...
\begin{abstract}
OEIS A204650 counts arrays of width $8$ over $\{0,1\}$ through two derived arrays of PAIR SUMS ---
each cell added to its left neighbour, and each cell added to the one above it --- on which the
entry imposes an order condition. The entry carries an empirical recurrence of order $10$
...
OEIS A204650 is ``Number of (n+1) X 8 0..1 arrays with column and row pair sums b(i,j)=a(i,j)+a(i,j-1) and c(i,j)=a(i,j)+a(i-1,j) nondecreasing in column and row directions, respectively.''. It has offset $1$ and begins
\[
216, 283, 637, 1478, 3261, 6780, 13314, 24862,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 8*a(n-1) - 27*a(n-2) + 48*a(n-3) - 42*a(n-4) + 42*a(n-6) - 48*a(n-7) + 27*a(n-8) - 8*a(n-9) + a(n-10) for n > 15.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 09 2018 18:57:48, revision 11) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The array $a$ has $8$ cells across, with entries in $\{0,1\}$. Two derived arrays are formed,
\[
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-1) - 27\,a(n-2) + 48\,a(n-3) - 42\,a(n-4) + 42\,a(n-6) - 48\,a(n-7) + 27\,a(n-8) - 8\,a(n-9) + a(n-10)
\]
for every $n>15$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204650.
