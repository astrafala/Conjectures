...
\title{The empirical recurrence for OEIS A269014, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A269014 counts arrays over $\{0,\dots,1\}$ subject to a condition on the array as a
...
OEIS A269014 is ``Number of 4 X n binary arrays with some element plus some horizontally, diagonally or antidiagonally adjacent neighbor totalling two exactly once.''. It has offset $1$ and begins
\[
0, 48, 224, 2136, 10976, 73568, 390064, 2291728,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 4*a(n-1) + 28*a(n-2) - 78*a(n-3) - 264*a(n-4) + 296*a(n-5) + 527*a(n-6) - 252*a(n-7) - 324*a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 18 2019 08:31:22, revision 7) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269014.
