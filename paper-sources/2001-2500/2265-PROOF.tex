...
\title{The empirical closed form for OEIS A223670, proved}
...
\begin{abstract}
OEIS A223670 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A223670 is ``Number of 3 X n 0..1 arrays with rows, diagonals and antidiagonals unimodal.''. It has offset $1$ and begins
\[
8, 64, 292, 948, 2527, 5913, 12577, 24821,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (23/360)*n\^{}6 - (3/40)*n\^{}5 + (37/18)*n\^{}4 + (119/24)*n\^{}3 - (3103/360)*n\^{}2 + (997/60)*n - 9 for n>1.
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 16 2018 07:30:11, revision 7) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{23 n^{6}}{360} - \frac{3 n^{5}}{40} + \frac{37 n^{4}}{18} + \frac{119 n^{3}}{24} - \frac{3103 n^{2}}{360} + \frac{997 n}{60} - 9.
\]
...
established for $a$ from $n=9$ on. The remaining indices $n=2,\dots,8$ were
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223670.
