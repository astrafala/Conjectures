...
\title{The empirical closed form for OEIS A223839, proved}
...
\begin{abstract}
OEIS A223839 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
$S=2048$ vertices. Any function of the form $\sum_j p_j(n)\lambda_j^{\,n}$ satisfies the
...
OEIS A223839 is ``Number of 3 X n 0..1 arrays with rows, diagonals and antidiagonals unimodal and columns nondecreasing.''. It has offset $1$ and begins
\[
4, 16, 48, 118, 255, 503, 926, 1614,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (1/720)*n\^{}6 + (1/240)*n\^{}5 + (29/144)*n\^{}4 + (11/48)*n\^{}3 + (1007/360)*n\^{}2 - (37/30)*n + 2.
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 18 2025 18:08:11, revision 10) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{n^{6}}{720} + \frac{n^{5}}{240} + \frac{29 n^{4}}{144} + \frac{11 n^{3}}{48} + \frac{1007 n^{2}}{360} - \frac{37 n}{30} + 2.
\]
...
walk, so with $M$ the adjacency matrix of that digraph on $S=2048$ vertices, and $u,w$ the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223839.
