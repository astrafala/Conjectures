...
\title{The empirical recurrence for OEIS A208197, proved by counting patterns}
...
\begin{abstract}
OEIS A208197 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
$10$, contributed by R.~H.~Hardin, then follows from a finite exact computation.
\end{abstract}
...
OEIS A208197 is ``Number of nX4 0..3 arrays with new values 0..3 introduced in row major order and no element equal to more than two of its immediate leftward or upward or left-upward diagonal neighbors.''. It has offset $1$ and begins
\[
15, 2653, 639701, 156617480, 38372808893, 9402035642924, 2303673397508915, 564442821781056268,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:42:36, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;236\,a(n-1) + 2368\,a(n-2) - 37526\,a(n-3) - 310734\,a(n-4) + 811712\,a(n-5) + 1791667\,a(n-6) - 2516274\,a(n-7) - 1895184\,a(n-8) + 2138400\,a(n-9) - 373248\,a(n-10)
\end{equation}
for all $n>11$.
...
For every $n$ with $m=n+0-1\ge10$,
\[
4!\Bigl(a(n)-\sum_i c_i\,a(n-i)\Bigr)\;=\;\mathbf{v}^{\!\top}N^{\,m-10}q(N)\mathbf{1} .
\]
...
\begin{proof}
Substitute \eqref{eq:walk} into the left side and factor $N^{m-10}$ out of
...
column. The vector $w=q(N)\mathbf{1}$ was then formed by $10$ matrix--vector products
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208197.
