...
\title{The empirical closed form for OEIS A223982, proved}
...
\begin{abstract}
OEIS A223982 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
$S=50$ vertices. Any function of the form $\sum_j p_j(n)\lambda_j^{\,n}$ satisfies the
...
OEIS A223982 is ``Number of n X 3 0..3 arrays with rows unimodal and columns nondecreasing.''. It has offset $1$ and begins
\[
50, 684, 5029, 25410, 99634, 325120, 922768, 2346883,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 25 2018 16:15:50, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{353 n^{9}}{181440} + \frac{5 n^{8}}{126} + \frac{10571 n^{7}}{30240} + \frac{251 n^{6}}{144} + \frac{46793 n^{5}}{8640} + \frac{1565 n^{4}}{144} + \frac{159679 n^{3}}{11340} + \frac{715 n^{2}}{63} + \frac{6491 n}{1260} + 1.
\]
...
walk, so with $M$ the adjacency matrix of that digraph on $S=50$ vertices, and $u,w$ the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223982.
