...
\title{The empirical recurrence for OEIS A252723, proved by transfer matrix}
...
\begin{abstract}
OEIS A252723 counts arrays of width $6$ over an alphabet of $4$ letters in which every three
...
OEIS A252723 is ``Number of (4+2) X (n+2) 0..3 arrays with every consecutive three elements in every row and diagonal having exactly two distinct values, and in every column and antidiagonal not having exactly two distinct values, and new values 0 upwards introduced in row major order.''. It has offset $1$ and begins
\[
84, 76, 80, 97, 112, 132, 153, 196,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = -a(n-1) + 3*a(n-3) + 3*a(n-4) - 2*a(n-6) - 2*a(n-7) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 06 2018 07:51:58, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252723.
