...
\title{The empirical recurrence for OEIS A232591, proved by transfer matrix}
...
\begin{abstract}
OEIS A232591 counts arrays of width $3$ over $\{0,1,2\}$ in which every cell sees its own value plus and minus one among its neighbours. The entry carries an
...
OEIS A232591 is ``Number of (2+1) X (n+1) 0..2 arrays with every element next to itself plus and minus one within the range 0..2 horizontally or antidiagonally, with no adjacent elements equal.''. It has offset $1$ and begins
\[
2, 34, 12, 152, 108, 690, 744, 3232,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 5*a(n-2) + 4*a(n-3) - 3*a(n-4) - 12*a(n-5) - 3*a(n-6) + 6*a(n-7) + 6*a(n-8) + 2*a(n-9) for n>10.
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 05 2018 12:00:18, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-2) + 4\,a(n-3) - 3\,a(n-4) - 12\,a(n-5) - 3\,a(n-6) + 6\,a(n-7) + 6\,a(n-8) + 2\,a(n-9)
\]
for every $n>10$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232591.
