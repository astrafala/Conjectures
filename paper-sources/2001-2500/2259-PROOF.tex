...
\title{The empirical recurrence for OEIS A268762, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A268762 counts arrays over $\{0,\dots,1\}$ subject to a condition on the array as a
...
OEIS A268762 is ``Number of n X 4 binary arrays with some element plus some horizontally, vertically, diagonally or antidiagonally adjacent neighbor totalling two exactly once.''. It has offset $1$ and begins
\[
5, 44, 223, 1148, 5170, 23156, 99057, 418924,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 4*a(n-1) + 10*a(n-2) - 32*a(n-3) - 47*a(n-4) + 40*a(n-5) + 38*a(n-6) - 12*a(n-7) - 9*a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 14 2019 09:02:09, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268762.
