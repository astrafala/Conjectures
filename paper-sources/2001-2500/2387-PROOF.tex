...
\title{The empirical closed form for OEIS A223615, proved}
...
\begin{abstract}
OEIS A223615 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
$S=56$ vertices. Any function of the form $\sum_j p_j(n)\lambda_j^{\,n}$ satisfies the
...
OEIS A223615 is ``Number of n X 3 0..1 arrays with rows and columns unimodal.''. It has offset $1$ and begins
\[
7, 49, 240, 876, 2582, 6504, 14547, 29659,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (23/360)*n\^{}6 + (31/120)*n\^{}5 + (8/9)*n\^{}4 + (31/24)*n\^{}3 + (737/360)*n\^{}2 + (29/20)*n + 1.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 21 2018 10:04:30, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{23 n^{6}}{360} + \frac{31 n^{5}}{120} + \frac{8 n^{4}}{9} + \frac{31 n^{3}}{24} + \frac{737 n^{2}}{360} + \frac{29 n}{20} + 1.
\]
...
walk, so with $M$ the adjacency matrix of that digraph on $S=56$ vertices, and $u,w$ the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223615.
