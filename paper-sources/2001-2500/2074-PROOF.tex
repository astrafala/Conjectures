...
\title{The empirical recurrence for OEIS A275085, proved by counting patterns}
...
\begin{abstract}
OEIS A275085 counts arrays in which no entry may repeat a value found at any of three stated
...
OEIS A275085 is ``Number of n X 3 0..2 arrays with no element equal to any value at offset (0,-2) (-1,-2) or (-2,-1) and new values introduced in order 0..2.''. It has offset $1$ and begins
\[
3, 36, 192, 1024, 5440, 29120, 155904, 834176,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 4*a(n-1) + 4*a(n-2) + 14*a(n-3) + 18*a(n-4) - 8*a(n-5) + 16*a(n-6) + 80*a(n-7) - 32*a(n-8) - 64*a(n-9) for n>10.
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 31 2019 19:33:45, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) + 4\,a(n-2) + 14\,a(n-3) + 18\,a(n-4) - 8\,a(n-5) + 16\,a(n-6) + 80\,a(n-7) - 32\,a(n-8) - 64\,a(n-9)
\end{equation}
for all $n>10$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A275085.
