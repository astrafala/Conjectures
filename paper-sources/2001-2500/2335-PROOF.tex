...
\title{The empirical column recurrences for the table OEIS A234421}
...
\begin{abstract}
OEIS A234421 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A234421 is ``T(n,k)=Number of (n+1)X(k+1) 0..7 arrays with every 2X2 subblock having the absolute values of all six edge and diagonal differences no larger than 1.''. It has offset $1$, is
read by antidiagonals, and begins
\[
106, 550, 550, 2848, 5606, 2848, 14794, 56768,\ \dots
\]
The entry carries the following block:
\begin{quote}\small
Empirical for column k:\\
k=1: a(n) = 13*a(n-1) -54*a(n-2) +57*a(n-3) +90*a(n-4) -96*a(n-5) -108*a(n-6) -24*a(n-7)\\
k=2: [order 16]\\
k=3: [order 33]\\
k=4: [order 94]\\
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 09:19:04, revision 6) these are still
...
The sequence is ``Number of (n+1)X(2) 0..7 arrays with every 2X2 subblock having the absolute values of all six edge and diagonal differences no larger than 1.''. Its rows are the vertices of a digraph on
...
\[
a(n)\;=\;13\,a(n-1) - 54\,a(n-2) + 57\,a(n-3) + 90\,a(n-4) - 96\,a(n-5) - 108\,a(n-6) - 24\,a(n-7)
\]
...
$c_{1}$ & $32$ & $c_{5}$ & $-14714$ & $c_{9}$ & $-82676$ & $c_{13}$ & $-8282$ \\
$c_{2}$ & $-369$ & $c_{6}$ & $17158$ & $c_{10}$ & $36495$ & $c_{14}$ & $-92$ \\
$c_{3}$ & $1673$ & $c_{7}$ & $49278$ & $c_{11}$ & $61437$ & $c_{15}$ & $420$ \\
$c_{4}$ & $-571$ & $c_{8}$ & $-48443$ & $c_{12}$ & $3223$ & $c_{16}$ & $-40$ \\
...
model reproduces $9$ published values, $49$ decimal digits in all, every one of
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234421.
