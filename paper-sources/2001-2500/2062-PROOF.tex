...
\title{The empirical recurrence for OEIS A183996, proved by splitting on the common sum}
...
\begin{abstract}
OEIS A183996 counts arrays over $\{0,\dots,2\}$ in which all $2\times2$ subblock sums are
...
OEIS A183996 is ``Number of (n+1) X 3 0..2 arrays with all 2 X 2 subblock sums the same.''. It has offset $1$ and begins
\[
171, 309, 579, 1233, 2691, 6417, 15555, 40041,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 6*a(n-1) - 60*a(n-3) + 85*a(n-4) + 150*a(n-5) - 360*a(n-6) + 396*a(n-8) - 216*a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 09 2018 13:00:57, revision 8) the statement is
...
$V=\{0,\dots,2\}^{3}$ be the possible rows and let $M_c$ be the adjacency
...
Writing $N=\bigoplus_{c=0}^{8}M_c$, of size $S=243$, and $\mathbf{v}$ for the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A183996.
