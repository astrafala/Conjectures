...
\title{The empirical recurrence for OEIS A268969, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A268969 counts arrays over $\{0,\dots,2\}$ subject to a condition on the array as a
...
OEIS A268969 is ``Number of n X 6 0..2 arrays with some element plus some horizontally or antidiagonally adjacent neighbor totalling two not more than once.''. It has offset $1$ and begins
\[
336, 11664, 339480, 9093528, 231730344, 5712070032, 137497776840, 3251386055664,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 50*a(n-1) - 805*a(n-2) + 4662*a(n-3) - 12150*a(n-4) + 14580*a(n- 5) -6561*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 17 2019 09:19:55, revision 9) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268969.
