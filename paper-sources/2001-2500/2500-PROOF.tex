...
\title{The empirical recurrence for OEIS A275268, proved by transfer matrix}
...
\begin{abstract}
OEIS A275268 counts arrays in which no entry may equal the entries at a short list of fixed offsets
...
OEIS A275268 is ``Number of 4 X n 0..2 arrays with no element equal to any value at offset (-2,-1) (-2,1) or (-1,-1) and new values introduced in order 0..2.''. It has offset $1$ and begins
\[
14, 64, 396, 2564, 17036, 114184, 767400, 5162348,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 8*a(n-1) - 7*a(n-2) - 9*a(n-3) - 8*a(n-4) - 12*a(n-5) + 16*a(n-6) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 04 2019 09:08:17, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-1) - 7\,a(n-2) - 9\,a(n-3) - 8\,a(n-4) - 12\,a(n-5) + 16\,a(n-6)
\]
for every $n>7$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A275268.
