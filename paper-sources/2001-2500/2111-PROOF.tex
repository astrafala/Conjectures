...
\title{The empirical recurrence for OEIS A232840, proved by transfer matrix}
...
\begin{abstract}
OEIS A232840 counts arrays of width $2$ over $\{0,1,2\}$ in which every cell sees its own value plus and minus one among its neighbours. The entry carries an
...
OEIS A232840 is ``Number of (1+1) X (n+1) 0..2 arrays with every element next to itself plus and minus one within the range 0..2 horizontally, diagonally or antidiagonally.''. It has offset $1$ and begins
\[
4, 16, 216, 710, 3648, 25642, 139456, 683250,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + 3*a(n-2) + 66*a(n-3) + 150*a(n-4) - 86*a(n-5) - 36*a(n-6) - 176*a(n-7) - 512*a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 06 2018 03:53:11, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 3\,a(n-2) + 66\,a(n-3) + 150\,a(n-4) - 86\,a(n-5) - 36\,a(n-6) - 176\,a(n-7) - 512\,a(n-8)
\]
for every $n>6$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232840.
