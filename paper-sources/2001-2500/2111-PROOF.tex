...
\title{The empirical recurrence for OEIS A275260, proved by counting patterns}
...
\begin{abstract}
OEIS A275260 counts arrays in which no entry may repeat a value found at any of three stated
...
OEIS A275260 is ``Number of n X 2 0..2 arrays with no element equal to any value at offset (-2,-1) (-2,1) or (-1,-1) and new values introduced in order 0..2.''. It has offset $1$ and begins
\[
2, 9, 24, 64, 172, 476, 1320, 3672,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 4*a(n-1) - 2*a(n-2) - 6*a(n-3) + 6*a(n-4) + 4*a(n-5) - 16*a(n-6) + 12*a(n-7) + 8*a(n-8) - 8*a(n-9) for n>10.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 02 2019 11:33:17, revision 7) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) - 2\,a(n-2) - 6\,a(n-3) + 6\,a(n-4) + 4\,a(n-5) - 16\,a(n-6) + 12\,a(n-7) + 8\,a(n-8) - 8\,a(n-9)
\end{equation}
for all $n>10$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A275260.
