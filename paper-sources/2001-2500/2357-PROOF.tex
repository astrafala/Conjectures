...
\title{The empirical column recurrences for the table OEIS A251088}
...
\begin{abstract}
OEIS A251088 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A251088 is ``T(n,k)=Number of (n+1)X(k+1) 0..2 arrays with no 2X2 subblock having the sum of its diagonal elements greater than the absolute difference of its antidiagonal elements.''. It has offset $1$, is
read by antidiagonals, and begins
\[
27, 83, 83, 192, 284, 192, 420, 616,\ \dots
\]
The entry carries the following block:
\begin{quote}\small
Empirical for column k:\\
k=1: a(n) = 5*a(n-1) -8*a(n-2) +2*a(n-3) +7*a(n-4) -7*a(n-5) +2*a(n-6) for n>7\\
k=2: a(n) = 6*a(n-1) -13*a(n-2) +10*a(n-3) +5*a(n-4) -14*a(n-5) +9*a(n-6) -2*a(n-7) for n>8\\
k=3: a(n) = 6*a(n-1) -13*a(n-2) +10*a(n-3) +5*a(n-4) -14*a(n-5) +9*a(n-6) -2*a(n-7) for n>8\\
k=4: a(n) = 6*a(n-1) -13*a(n-2) +10*a(n-3) +5*a(n-4) -14*a(n-5) +9*a(n-6) -2*a(n-7) for n>8\\
k=5: a(n) = 6*a(n-1) -13*a(n-2) +10*a(n-3) +5*a(n-4) -14*a(n-5) +9*a(n-6) -2*a(n-7) for n>8\\
k=6: a(n) = 6*a(n-1) -13*a(n-2) +10*a(n-3) +5*a(n-4) -14*a(n-5) +9*a(n-6) -2*a(n-7) for n>8\\
k=7: a(n) = 6*a(n-1) -13*a(n-2) +10*a(n-3) +5*a(n-4) -14*a(n-5) +9*a(n-6) -2*a(n-7) for n>8\\
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:03:30, revision 6) these are still
...
The sequence is ``Number of (n+1)X(2) 0..2 arrays with no 2X2 subblock having the sum of its diagonal elements greater than the absolute difference of its antidiagonal elements.''. Its rows are the vertices of a digraph on
...
The sequence is ``Number of (n+1)X(3) 0..2 arrays with no 2X2 subblock having the sum of its diagonal elements greater than the absolute difference of its antidiagonal elements.''. Its rows are the vertices of a digraph on
$S=27$ vertices, edges being the admissible consecutive pairs, and the count is
$\mathbf{1}^{\!\top}M^{n}\mathbf{1}$ up to the constant factor in the entry's name.
The conjectured recurrence
\[
a(n)\;=\;6\,a(n-1) - 13\,a(n-2) + 10\,a(n-3) + 5\,a(n-4) - 14\,a(n-5) + 9\,a(n-6) - 2\,a(n-7)
\]
holds for every $n>8$.

\subsection*{Column $k=3$}
The sequence is ``Number of (n+1)X(4) 0..2 arrays with no 2X2 subblock having the sum of its diagonal elements greater than the absolute difference of its antidiagonal elements.''. Its rows are the vertices of a digraph on
...
The sequence is ``Number of (n+1)X(5) 0..2 arrays with no 2X2 subblock having the sum of its diagonal elements greater than the absolute difference of its antidiagonal elements.''. Its rows are the vertices of a digraph on
$S=243$ vertices, edges being the admissible consecutive pairs, and the count is
$\mathbf{1}^{\!\top}M^{n}\mathbf{1}$ up to the constant factor in the entry's name.
The conjectured recurrence
\[
a(n)\;=\;6\,a(n-1) - 13\,a(n-2) + 10\,a(n-3) + 5\,a(n-4) - 14\,a(n-5) + 9\,a(n-6) - 2\,a(n-7)
...
The sequence is ``Number of (n+1)X(6) 0..2 arrays with no 2X2 subblock having the sum of its diagonal elements greater than the absolute difference of its antidiagonal elements.''. Its rows are the vertices of a digraph on
$S=729$ vertices, edges being the admissible consecutive pairs, and the count is
$\mathbf{1}^{\!\top}M^{n}\mathbf{1}$ up to the constant factor in the entry's name.
The conjectured recurrence
\[
a(n)\;=\;6\,a(n-1) - 13\,a(n-2) + 10\,a(n-3) + 5\,a(n-4) - 14\,a(n-5) + 9\,a(n-6) - 2\,a(n-7)
...
\subsection*{Column $k=6$}
The sequence is ``Number of (n+1)X(7) 0..2 arrays with no 2X2 subblock having the sum of its diagonal elements greater than the absolute difference of its antidiagonal elements.''. Its rows are the vertices of a digraph on
$S=2187$ vertices, edges being the admissible consecutive pairs, and the count is
$\mathbf{1}^{\!\top}M^{n}\mathbf{1}$ up to the constant factor in the entry's name.
The conjectured recurrence
\[
a(n)\;=\;6\,a(n-1) - 13\,a(n-2) + 10\,a(n-3) + 5\,a(n-4) - 14\,a(n-5) + 9\,a(n-6) - 2\,a(n-7)
...
\subsection*{Column $k=7$}
The sequence is ``Number of (n+1)X(8) 0..2 arrays with no 2X2 subblock having the sum of its diagonal elements greater than the absolute difference of its antidiagonal elements.''. Its rows are the vertices of a digraph on
$S=6561$ vertices, edges being the admissible consecutive pairs, and the count is
$\mathbf{1}^{\!\top}M^{n}\mathbf{1}$ up to the constant factor in the entry's name.
The conjectured recurrence
\[
a(n)\;=\;6\,a(n-1) - 13\,a(n-2) + 10\,a(n-3) + 5\,a(n-4) - 14\,a(n-5) + 9\,a(n-6) - 2\,a(n-7)
...
different counts. Across the columns settled here the model reproduces $69$ published
values, $306$ decimal digits in all, every one of them exactly; a misreading of the entry
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251088.
