...
\title{The empirical recurrence for OEIS A210177, proved by transfer matrix}
...
\begin{abstract}
OEIS A210177 counts arrays of width $3$ whose every $2\times2$ subblock holds a
prescribed number of DISTINCT values, which use ALL of the $4$ available letters, and which
are counted up to renaming. The entry carries an empirical recurrence of order $8$
...
nothing else. Each fixed-alphabet count is a walk count on $S=100$ states in all.
\end{abstract}
...
OEIS A210177 is ``Number of (n+1)X3 0..3 arrays containing all values 0..3 with every 2X2 subblock having three or four distinct values, and new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
51, 2316, 79017, 2563795, 82255351, 2632469015, 84200356757, 2692825679001,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 39*a(n-1) -211*a(n-2) -523*a(n-3) +2954*a(n-4) -1030*a(n-5) -4272*a(n-6) +2096*a(n-7) -192*a(n-8)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 15:49:19, revision 9) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The array has $3$ cells across and entries in $\{0,1,\dots,3\}$. In every
$2\times2$ window of it, the number of DISTINCT entries must be one of $3, 4$. Two
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=100.
\]
...
\begin{theorem}
\[
a(n)\;=\;39\,a(n-1) - 211\,a(n-2) - 523\,a(n-3) + 2954\,a(n-4) - 1030\,a(n-5) - 4272\,a(n-6) + 2096\,a(n-7) - 192\,a(n-8)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A210177.
