...
\title{The empirical recurrence for OEIS A204049, proved by transfer matrix}
...
\begin{abstract}
OEIS A204049 counts $(n+2)\times3$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A204049 is ``Number of (n+2)X3 0..3 arrays with every 3X3 subblock having equal diagonal elements or equal antidiagonal elements, and new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
1379, 10447, 80391, 622031, 4823759, 37451727, 290942303, 2260735279,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 11*a(n-1) -31*a(n-2) +69*a(n-3) -176*a(n-4) -8*a(n-5) -116*a(n-6) -132*a(n-7) +240*a(n-8) +144*a(n-9)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 10:57:20, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;11\,a(n-1) - 31\,a(n-2) + 69\,a(n-3) - 176\,a(n-4) - 8\,a(n-5) - 116\,a(n-6) - 132\,a(n-7) + 240\,a(n-8) + 144\,a(n-9)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204049.
