...
\title{The empirical recurrence for OEIS A280064, proved by transfer matrix}
...
\begin{abstract}
OEIS A280064 counts $n\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A280064 is ``Number of n X 3 0..1 arrays with no element unequal to a strict majority of its horizontal, vertical and antidiagonal neighbors and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
1, 2, 5, 15, 39, 104, 281, 771,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) + a(n-2) - 6*a(n-3) + 5*a(n-4) - 2*a(n-5) - 2*a(n-6) - a(n-7) for n>9.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 12 2019 12:16:15, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + a(n-2) - 6\,a(n-3) + 5\,a(n-4) - 2\,a(n-5) - 2\,a(n-6) - a(n-7)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A280064.
