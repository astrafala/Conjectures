...
\title{The empirical closed form for OEIS A224185, proved}
...
\begin{abstract}
OEIS A224185 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A224185 is ``Number of n X 3 0..2 arrays with rows unimodal and columns nondecreasing.''. It has offset $1$ and begins
\[
22, 158, 684, 2205, 5852, 13524, 28176, 54153,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (23/360)*n\^{}6 + (27/40)*n\^{}5 + (205/72)*n\^{}4 + (49/8)*n\^{}3 + (319/45)*n\^{}2 + (21/5)*n + 1.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 29 2018 05:57:48, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{23 n^{6}}{360} + \frac{27 n^{5}}{40} + \frac{205 n^{4}}{72} + \frac{49 n^{3}}{8} + \frac{319 n^{2}}{45} + \frac{21 n}{5} + 1.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224185.
