...
\title{The empirical recurrence for OEIS A210159, proved by counting patterns}
...
\begin{abstract}
OEIS A210159 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A210159 is ``Number of (n+1)X3 0..3 arrays with every 2X2 subblock having two or three distinct values, and new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
148, 6977, 351482, 17864271, 908980864, 46257884813, 2354098130302, 119802073302399,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 55*a(n-1) -186*a(n-2) -1230*a(n-3) +2723*a(n-4) +159*a(n-5) -1604*a(n-6) +468*a(n-7)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 15:47:28, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;55\,a(n-1) - 186\,a(n-2) - 1230\,a(n-3) + 2723\,a(n-4) + 159\,a(n-5) - 1604\,a(n-6) + 468\,a(n-7)
\end{equation}
for all $n>7$.

\section{What the canonical-form clause counts}

Fix the shape: $3$ columns and $L=n+1$ rows, so $L\cdot3$ cells. Call a
...
For every $n$ with $m=n+1-1\ge7$,
\[
4!\Bigl(a(n)-\sum_i c_i\,a(n-i)\Bigr)\;=\;\mathbf{v}^{\!\top}N^{\,m-7}q(N)\mathbf{1} .
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A210159.
