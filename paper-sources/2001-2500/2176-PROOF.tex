...
\title{The empirical recurrence for OEIS A223554, proved by transfer matrix}
...
\begin{abstract}
OEIS A223554 counts the ways of writing the vertices of a fixed graph $G$ into an array of width
$6$ so that any two cells adjacent in one of the named directions carry vertices joined by an
edge of $G$; here $G$ is graph named in the entry. The entry carries an empirical recurrence of order $8$
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 21:47:10, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;229\,a(n-1) - 7630\,a(n-2) + 89386\,a(n-3) - 465129\,a(n-4) + 1124537\,a(n-5) - 1178896\,a(n-6) + 505856\,a(n-7) - 65536\,a(n-8)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223554.
