...
\title{The empirical recurrence for OEIS A231296, proved by transfer matrix}
...
\begin{abstract}
OEIS A231296 counts $(n+1)\times3$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A231296 is ``Number of (n+1) X (2+1) 0..2 arrays with no element unequal to a strict majority of its horizontal, vertical and antidiagonal neighbors, with values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
2, 5, 16, 51, 174, 617, 2223, 8051,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) + 2*a(n-2) - 16*a(n-3) + 16*a(n-4) - 6*a(n-5) - 3*a(n-6) + 4*a(n-8) for n>9.
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 28 2018 10:56:04, revision 10) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + 2\,a(n-2) - 16\,a(n-3) + 16\,a(n-4) - 6\,a(n-5) - 3\,a(n-6) + 4\,a(n-8)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231296.
