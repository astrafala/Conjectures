...
\title{The empirical closed form for OEIS A207304, proved}
...
\begin{abstract}
OEIS A207304 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A207304 is ``Number of n X 7 0..1 arrays avoiding 0 0 0 and 1 0 1 horizontally and 0 0 1 and 1 1 0 vertically.''. It has offset $1$ and begins
\[
28, 784, 4344, 14446, 36868, 79802, 154228, 274288,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (187/60)*n\^{}5 + (153/4)*n\^{}4 + (455/12)*n\^{}3 - (249/4)*n\^{}2 + (209/30)*n + 4.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 22 2018 07:08:36, revision 9) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{187 n^{5}}{60} + \frac{153 n^{4}}{4} + \frac{455 n^{3}}{12} - \frac{249 n^{2}}{4} + \frac{209 n}{30} + 4.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207304.
