...
\title{The empirical closed form for OEIS A208284, proved}
...
\begin{abstract}
OEIS A208284 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A208284 is ``Number of n X 5 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 0 1 and 1 1 0 vertically.''. It has offset $1$ and begins
\[
16, 256, 1260, 3984, 9900, 21096, 40376, 71360,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (5/6)*n\^{}5 + 9*n\^{}4 + (91/6)*n\^{}3 - 9*n\^{}2.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 29 2018 11:37:46, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{5 n^{5}}{6} + 9 n^{4} + \frac{91 n^{3}}{6} - 9 n^{2}.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208284.
