...
\title{The empirical recurrence for OEIS A208711, proved by transfer matrix}
...
\begin{abstract}
OEIS A208711 counts $4\times n$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A208711 is ``Number of 4Xn 0..1 arrays with new values 0..1 introduced in row major order and no element equal to more than two of its immediate leftward or upward or right-upward antidiagonal neighbors.''. It has offset $1$ and begins
\[
8, 128, 1372, 16084, 185344, 2142580, 24754628, 286034292,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 9*a(n-1) +31*a(n-2) -11*a(n-3) -71*a(n-4) -a(n-5) +38*a(n-6) -8*a(n-7) for n>9
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:59:45, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;9\,a(n-1) + 31\,a(n-2) - 11\,a(n-3) - 71\,a(n-4) - a(n-5) + 38\,a(n-6) - 8\,a(n-7)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208711.
