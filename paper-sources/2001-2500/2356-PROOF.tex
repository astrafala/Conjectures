...
\title{The empirical recurrence for OEIS A208311, proved by counting patterns}
...
\begin{abstract}
OEIS A208311 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A208311 is ``Number of n X 5 0..1 arrays with new values 0..1 introduced in row major order and no element equal to more than one of its immediate leftward or upward neighbors.''. It has offset $1$ and begins
\[
16, 162, 1446, 12474, 106488, 906120, 7702668, 65459016,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 17*a(n-1) - 105*a(n-2) + 354*a(n-3) - 756*a(n-4) + 1062*a(n-5) - 945*a(n-6) + 459*a(n-7) - 81*a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 02 2018 04:53:52, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;17\,a(n-1) - 105\,a(n-2) + 354\,a(n-3) - 756\,a(n-4) + 1062\,a(n-5) - 945\,a(n-6) + 459\,a(n-7) - 81\,a(n-8)
\end{equation}
for all $n>8$.
...
\eqref{eq:walk}, divided by $2!$, was evaluated at every one of the $18$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208311.
