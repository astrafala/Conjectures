...
\title{The empirical recurrence for OEIS A240290, proved by transfer matrix}
...
\begin{abstract}
OEIS A240290 counts arrays over $\{0,1,2,3\}$ in which no entry may equal, modulo $4$, a given
...
count is then a walk count on $S=21$ states.
\end{abstract}
...
OEIS A240290 is ``Number of n X 2 0..3 arrays with no element equal to zero plus the sum of elements to its left or two plus the sum of elements above it or two plus the sum of the elements diagonally to its northwest, modulo 4.''. It has offset $1$ and begins
\[
4, 6, 24, 56, 230, 552, 2270, 5456,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 12*a(n-2) - 24*a(n-4) + 31*a(n-6) - 16*a(n-8) for n>9.
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 27 2018 06:22:37, revision 9) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A240290.
