...
\title{The empirical recurrence for OEIS A223280, proved by transfer matrix}
...
\begin{abstract}
OEIS A223280 counts the ways of writing the vertices of a fixed graph $G$ into an array of width
$6$ so that any two cells adjacent in one of the named directions carry vertices joined by an
edge of $G$; here $G$ is dodecahedron graph. The entry carries an empirical recurrence of order $9$
...
OEIS A223280 is ``Rolling icosahedron face footprints: number of nX6 0..19 arrays starting with 0 where 0..19 label faces of an icosahedron and every array movement to a horizontal, diagonal or antidiagonal neighbor moves across an icosahedral edge.''. It has offset $1$ and begins
\[
243, 6831, 261819, 10979127, 473368227, 20570223999, 895927195659, 39047604482055,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 21:27:21, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;63\,a(n-1) - 882\,a(n-2) + 792\,a(n-3) + 35736\,a(n-4) - 70768\,a(n-5) - 246208\,a(n-6) + 327936\,a(n-7) + 146432\,a(n-8) - 180224\,a(n-9)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223280.
