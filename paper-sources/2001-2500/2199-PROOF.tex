...
\title{The empirical recurrence for OEIS A230964, proved by transfer matrix}
...
\begin{abstract}
OEIS A230964 counts arrays of width $2$ over $\{0,1,2,3\}$ in which every cell must see, among its
...
the count is a walk count on $S=261$ states.
\end{abstract}
...
OEIS A230964 is ``Number of n X 2 0..3 arrays x(i,j) with each element horizontally, vertically, diagonally or antidiagonally next to at least one element with value (x(i,j)+1) mod 4 and at least one element with value (x(i,j)-1) mod 4, and upper left element zero.''. It has offset $1$ and begins
\[
0, 6, 22, 200, 1732, 14384, 121696, 1027464,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 7*a(n-1) + 10*a(n-2) + 38*a(n-3) - 132*a(n-4) - 232*a(n-5) - 448*a(n-6) + 320*a(n-7) + 256*a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 24 2018 12:48:47, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-1) + 10\,a(n-2) + 38\,a(n-3) - 132\,a(n-4) - 232\,a(n-5) - 448\,a(n-6) + 320\,a(n-7) + 256\,a(n-8)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A230964.
