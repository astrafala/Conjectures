...
\title{The empirical recurrence for OEIS A214168, proved by transfer matrix}
...
\begin{abstract}
OEIS A214168 counts the proper colourings of a grid $2\times(n+1)$, wrapped in the growing direction, with at most $6$ colours and
counted up to renaming the colours, and carries an empirical recurrence of order $8$
...
down to $S=70$ and makes the exact residual test affordable.
\end{abstract}
...
OEIS A214168 is ``Number of 0..5 colorings of a 2 X (n+1) array circular in the n+1 direction with new values 0..5 introduced in row major order.''. It has offset $1$ and begins
\[
4, 18, 337, 5994, 121778, 2518082, 52655411, 1103993538,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 21*a(n-1) +49*a(n-2) -959*a(n-3) -1869*a(n-4) +7679*a(n-5) +15051*a(n-6) -6741*a(n-7) -13230*a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 18 2022 17:25:27, revision 6) this is still
...
state count is $S=70$ rather than the number of colourings.
...
\begin{theorem}
\[
a(n)\;=\;21\,a(n-1) + 49\,a(n-2) - 959\,a(n-3) - 1869\,a(n-4) + 7679\,a(n-5) + 15051\,a(n-6) - 6741\,a(n-7) - 13230\,a(n-8)
\]
for every $n>7$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A214168.
