...
\title{The empirical recurrence for OEIS A198247, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A198247 counts arrays in which every cell is constrained by its neighbours on \emph{both}
...
OEIS A198247 is ``Number of 2n X 4 0..4 arrays with values 0..4 introduced in row major order and each element equal to exactly two horizontal and vertical neighbors.''. It has offset $1$ and begins
\[
1, 5, 40, 485, 6528, 90641, 1268648, 17794141,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 20*a(n-1) -85*a(n-2) -16*a(n-3) +493*a(n-4) -124*a(n-5) -919*a(n-6) +120*a(n-7) +512*a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 07:50:11, revision 10) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;20\,a(n-1) - 85\,a(n-2) - 16\,a(n-3) + 493\,a(n-4) - 124\,a(n-5) - 919\,a(n-6) + 120\,a(n-7) + 512\,a(n-8)
\end{equation}
for all $n>8$.
...
index,
\[
5!\Bigl(a(n)-\sum_i c_i\,a(n-i)\Bigr)\;=\;\mathbf{v}^{\!\top}G^{\,j-8}\,
...
\eqref{eq:walk2}, divided by $5!$, was evaluated at every one of the $18$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A198247.
