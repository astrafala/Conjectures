...
\title{The empirical recurrence for OEIS A184607, proved by transfer matrix}
...
\begin{abstract}
OEIS A184607 counts arrays over $\{0,\dots,1\}$ under a condition comparing a statistic of
...
empirical. The count is a walk count on $S=56$ states and is $C$-finite; whether the
...
OEIS A184607 is ``Half the number of (n+1) X 3 binary arrays with no 2 X 2 subblock sum differing from a horizontal or vertical neighbor subblock sum by more than one.''. It has offset $1$ and begins
\[
28, 160, 918, 5430, 32042, 188394, 1107926, 6519094,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 5*a(n-1) + 3*a(n-2) + 10*a(n-3) + 29*a(n-4) - 66*a(n-5) - 20*a(n-6) + 8*a(n-7) - 12*a(n-8) + 8*a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 14 2018 07:33:43, revision 9) this is still
...
3}=64$ tuples of $2$ rows, $S=56$ survive the condition inside a single subblock row;
...
$28$, which the model reproduces along with every later term, and that is the cheapest
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) + 3\,a(n-2) + 10\,a(n-3) + 29\,a(n-4) - 66\,a(n-5) - 20\,a(n-6) + 8\,a(n-7) - 12\,a(n-8) + 8\,a(n-9)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A184607.
