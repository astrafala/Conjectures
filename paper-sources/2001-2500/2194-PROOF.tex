...
\title{The conjectured generating function for OEIS A240359, proved}
...
\begin{abstract}
OEIS A240359 counts arrays of a fixed width under a local condition, and carries a conjectured
...
OEIS A240359 is ``Number of n X 2 0..3 arrays with no element equal to one plus the sum of elements to its left or two plus the sum of elements above it or two plus the sum of the elements diagonally to its northwest, modulo 4.''. It has offset $1$ and begins
\[
4, 15, 43, 111, 261, 571,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 27 2018 08:23:59, revision 8) this is still
...
\begin{proof}
Write the conjecture as $N_2/D_2$ with $\deg N_2=13$ and $\deg D_2=9$; its expansion as a
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A240359.
