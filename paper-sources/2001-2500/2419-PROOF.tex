...
\title{The empirical recurrence for OEIS A214239, proved by transfer matrix}
...
\begin{abstract}
OEIS A214239 counts the proper colourings of a grid $1\times(n+1)$, wrapped in the growing direction, with at most $8$ colours and
...
down to $S=36$ and makes the exact residual test affordable.
\end{abstract}
...
OEIS A214239 is ``Number of 0..7 colorings of a 1 X (n+1) array circular in the n+1 direction with new values 0..7 introduced in row major order.''. It has offset $1$ and begins
\[
1, 1, 4, 11, 41, 162, 715, 3424,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 21*a(n-1) - 168*a(n-2) + 630*a(n-3) - 1029*a(n-4) + 189*a(n-5) + 1198*a(n-6) - 840*a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 09 2018 10:21:19, revision 9) this is still
...
state count is $S=36$ rather than the number of colourings.
...
\begin{theorem}
\[
a(n)\;=\;21\,a(n-1) - 168\,a(n-2) + 630\,a(n-3) - 1029\,a(n-4) + 189\,a(n-5) + 1198\,a(n-6) - 840\,a(n-7)
\]
for every $n>6$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A214239.
