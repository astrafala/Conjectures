...
\title{The empirical recurrence for OEIS A224555, proved by transfer matrix}
...
\begin{abstract}
OEIS A224555 counts the $(n+2)\times6$ matrices over $\{0,\dots,1\}$ all of whose
...
makes $a(n)$ a walk count on $S=150$ vertices, hence $C$-finite, and whether the conjectured
...
OEIS A224555 is ``Number of (n+2) X 6 0..1 matrices with each 3 X 3 subblock idempotent.''. It has offset $1$ and begins
\[
172, 174, 230, 286, 395, 551, 749, 1041,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) - 6*a(n-2) + 5*a(n-3) - 4*a(n-4) + 3*a(n-5) - a(n-6) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 31 2018 09:27:16, revision 8) this is still
...
\]
with $M$ the adjacency matrix on $S=150$ states. In particular $a$ is $C$-finite. The
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224555.
