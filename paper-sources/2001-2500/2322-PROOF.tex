...
\title{The empirical closed form for OEIS A223681, proved}
...
\begin{abstract}
OEIS A223681 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A223681 is ``Number of 3 X n 0..1 arrays with rows and antidiagonals unimodal.''. It has offset $1$ and begins
\[
8, 64, 316, 1118, 3177, 7745, 16857, 33615,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (23/360)*n\^{}6 + (31/120)*n\^{}5 + (17/9)*n\^{}4 + (23/24)*n\^{}3 + (917/360)*n\^{}2 + (77/60)*n + 1.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 22 2018 06:25:17, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{23 n^{6}}{360} + \frac{31 n^{5}}{120} + \frac{17 n^{4}}{9} + \frac{23 n^{3}}{24} + \frac{917 n^{2}}{360} + \frac{77 n}{60} + 1.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223681.
