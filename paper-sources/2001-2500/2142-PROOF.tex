...
\title{The empirical recurrence for OEIS A189180, proved by transfer matrix}
...
\begin{abstract}
OEIS A189180 counts the permutations of the cells of an $n\times3$ array in which every cell
...
OEIS A189180 is ``Number of nX3 array permutations with each element making a single king move.''. It has offset $1$ and begins
\[
0, 33, 192, 4081, 47936, 733465, 9925824, 142150545,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 8*a(n-1) +94*a(n-2) -88*a(n-3) -488*a(n-4) +152*a(n-5) -638*a(n-6) -72*a(n-7) +9*a(n-8)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 05:04:07, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-1) + 94\,a(n-2) - 88\,a(n-3) - 488\,a(n-4) + 152\,a(n-5) - 638\,a(n-6) - 72\,a(n-7) + 9\,a(n-8)
\]
for every $n>7$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A189180.
