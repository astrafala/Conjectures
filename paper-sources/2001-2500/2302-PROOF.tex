...
\title{The empirical closed form for OEIS A224042, proved}
...
\begin{abstract}
OEIS A224042 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A224042 is ``Number of 6 X n 0..1 arrays with antidiagonals unimodal and rows and diagonals nondecreasing.''. It has offset $1$ and begins
\[
64, 377, 848, 1422, 2149, 3107, 4395, 6124,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (1/720)*n\^{}6 + (1/240)*n\^{}5 + (35/144)*n\^{}4 + (127/48)*n\^{}3 + (1249/45)*n\^{}2 + (3727/20)*n + 6 for n>4.
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 04:56:24, revision 10) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{n^{6}}{720} + \frac{n^{5}}{240} + \frac{35 n^{4}}{144} + \frac{127 n^{3}}{48} + \frac{1249 n^{2}}{45} + \frac{3727 n}{20} + 6.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224042.
