...
\title{The empirical closed form for OEIS A188840, proved}
...
\begin{abstract}
OEIS A188840 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A188840 is ``Number of n X 6 binary arrays without the pattern 0 1 diagonally or vertically.''. It has offset $1$ and begins
\[
64, 377, 1093, 2380, 4488, 7752, 12597, 19551,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (1/720)*n\^{}6 + (17/240)*n\^{}5 + (203/144)*n\^{}4 + (647/48)*n\^{}3 + (2659/45)*n\^{}2 + (1379/20)*n - 143 for n>3.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 30 2018 14:10:02, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{n^{6}}{720} + \frac{17 n^{5}}{240} + \frac{203 n^{4}}{144} + \frac{647 n^{3}}{48} + \frac{2659 n^{2}}{45} + \frac{1379 n}{20} - 143.
\]
...
$n=11,\dots,17$ and agree at each. A monic recurrence of order $7$
determines $a(m)$ from $a(m-1),\dots,a(m-7)$, and for every $m\ge18$ both
$m>10$ and $m-7\ge11$ hold, so induction on $m$ gives $a(m)=f(m)$ for every
$m\ge11$.
Below $n=11$ the recurrence argument gives nothing, since \eqref{eq:rec} is only
established for $a$ from $n=11$ on. The remaining indices $n=4,\dots,10$ were
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A188840.
