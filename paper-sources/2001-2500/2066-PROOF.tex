...
\title{The empirical recurrence for OEIS A209963, proved by transfer matrix}
...
\begin{abstract}
OEIS A209963 counts arrays of width $3$ whose every $2\times2$ subblock holds a
prescribed number of DISTINCT values, which use ALL of the $4$ available letters, and which
are counted up to renaming. The entry carries an empirical recurrence of order $10$
...
OEIS A209963 is ``Number of (n+1)X3 0..3 arrays containing all values 0..3 with every 2X2 subblock having one or two distinct values, and new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
0, 26, 665, 13529, 235614, 3745144, 56080379, 806021187,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 15:37:36, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;33\,a(n-1) - 374\,a(n-2) + 1586\,a(n-3) - 1093\,a(n-4) - 4559\,a(n-5) + 7212\,a(n-6) - 420\,a(n-7) - 4336\,a(n-8) + 2208\,a(n-9) - 256\,a(n-10)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209963.
