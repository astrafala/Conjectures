...
\title{The empirical recurrence for OEIS A185837, proved by transfer matrix}
...
\begin{abstract}
OEIS A185837 counts arrays over $\{0,\dots,2\}$ under a condition comparing a statistic of
...
empirical. The count is a walk count on $S=138$ states and is $C$-finite; whether the
...
OEIS A185837 is ``Number of (n+1) X 2 0..2 arrays with every 2 X 2 subblock trace equal to some horizontal or vertical neighbor 2 X 2 subblock trace.''. It has offset $1$ and begins
\[
0, 171, 405, 3249, 12609, 72225, 332937, 1731321,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 6*a(n-1) - 6*a(n-2) - 15*a(n-3) + 120*a(n-4) - 144*a(n-5) + 144*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 28 2018 06:51:46, revision 9) this is still
...
$S=138$ states in all. Getting the two vectors right is the whole of the argument: with
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) - 6\,a(n-2) - 15\,a(n-3) + 120\,a(n-4) - 144\,a(n-5) + 144\,a(n-6)
\]
for every $n>6$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A185837.
