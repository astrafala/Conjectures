...
\title{The empirical closed form for OEIS A224144, proved}
...
\begin{abstract}
OEIS A224144 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A224144 is ``Number of n X 6 0..1 arrays with rows and antidiagonals unimodal and columns nondecreasing.''. It has offset $1$ and begins
\[
22, 148, 554, 1573, 3827, 8375, 16885, 31841,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (2/45)*n\^{}6 + (4/15)*n\^{}5 + (16/9)*n\^{}4 + 6*n\^{}3 + (683/45)*n\^{}2 + (341/15)*n - 55 for n>3.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 28 2018 05:50:51, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{2 n^{6}}{45} + \frac{4 n^{5}}{15} + \frac{16 n^{4}}{9} + 6 n^{3} + \frac{683 n^{2}}{45} + \frac{341 n}{15} - 55.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224144.
