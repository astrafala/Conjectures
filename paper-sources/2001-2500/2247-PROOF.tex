...
\title{The empirical recurrence for OEIS A204626, proved by counting patterns}
...
\begin{abstract}
OEIS A204626 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A204626 is ``Number of (n+1)X5 0..2 arrays with every 2X2 subblock having unequal diagonal elements or unequal antidiagonal elements, and new values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
6144, 933462, 141832254, 21550390395, 3274427479938, 497525810748759, 75595484720747496, 11486192649538372653,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 165*a(n-1) -2025*a(n-2) +6241*a(n-3) -270*a(n-4) -17282*a(n-5) +5524*a(n-6) +11864*a(n-7) +1568*a(n-8)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 11:22:14, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;165\,a(n-1) - 2025\,a(n-2) + 6241\,a(n-3) - 270\,a(n-4) - 17282\,a(n-5) + 5524\,a(n-6) + 11864\,a(n-7) + 1568\,a(n-8)
\end{equation}
for all $n>8$.
...
For every $n$ with $m=n+1-1\ge8$,
\[
3!\Bigl(a(n)-\sum_i c_i\,a(n-i)\Bigr)\;=\;\mathbf{v}^{\!\top}N^{\,m-8}q(N)\mathbf{1} .
\]
...
corresponding to $n=8+1$ onwards, and the run continued until $w$ was the zero vector,
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204626.
