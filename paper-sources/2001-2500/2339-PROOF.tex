...
\title{The empirical recurrence for OEIS A240389, proved by transfer matrix}
...
\begin{abstract}
OEIS A240389 counts arrays over $\{0,1,2,3\}$ in which no entry may equal, modulo $4$, a given
...
OEIS A240389 is ``Number of n X 2 0..3 arrays with no element equal to zero plus the sum of elements to its left or one plus the sum of elements above it or two plus the sum of the elements diagonally to its northwest, modulo 4.''. It has offset $1$ and begins
\[
1, 5, 12, 50, 120, 493, 1184, 4863,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 12*a(n-2) - 24*a(n-4) + 31*a(n-6) - 16*a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 27 2018 11:33:36, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A240389.
