...
\title{The empirical closed form for OEIS A223963, proved}
...
\begin{abstract}
OEIS A223963 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A223963 is ``Number of 3 X n 0..3 arrays with antidiagonals unimodal and rows and diagonals nondecreasing.''. It has offset $1$ and begins
\[
64, 707, 3471, 12311, 36028, 92734, 217144, 471994,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 24 2018 17:04:54, revision 7) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{n^{9}}{8640} + \frac{n^{8}}{320} + \frac{503 n^{7}}{10080} + \frac{659 n^{6}}{1440} + \frac{3013 n^{5}}{960} + \frac{37141 n^{4}}{2880} + \frac{106019 n^{3}}{2160} - \frac{18977 n^{2}}{720} + \frac{2711 n}{70} - 6.
\]
...
$n=13,\dots,22$ and agree at each. A monic recurrence of order $10$
determines $a(m)$ from $a(m-1),\dots,a(m-10)$, and for every $m\ge23$ both
$m>12$ and $m-10\ge13$ hold, so induction on $m$ gives $a(m)=f(m)$ for every
$m\ge13$.
Below $n=13$ the recurrence argument gives nothing, since \eqref{eq:rec} is only
established for $a$ from $n=13$ on. The remaining indices $n=3,\dots,12$ were
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223963.
