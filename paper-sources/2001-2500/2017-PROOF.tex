...
\title{The empirical recurrence for OEIS A210090, proved by transfer matrix}
...
\begin{abstract}
OEIS A210090 counts arrays of width $4$ whose every $2\times2$ subblock holds a
...
OEIS A210090 is ``Number of (n+1)X4 0..2 arrays containing all values 0..2 with every 2X2 subblock having one or two distinct values, and new values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
90, 2370, 57232, 1318221, 29356228, 639141361, 13698519779, 290324839303,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 15:42:41, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;40\,a(n-1) - 446\,a(n-2) + 766\,a(n-3) + 4061\,a(n-4) - 6645\,a(n-5) - 8411\,a(n-6) + 13005\,a(n-7) - 317\,a(n-8) - 2372\,a(n-9) + 320\,a(n-10)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A210090.
