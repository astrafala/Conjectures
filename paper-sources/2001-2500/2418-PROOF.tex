...
\title{The empirical recurrence for OEIS A269197, proved by transfer matrix}
...
\begin{abstract}
OEIS A269197 counts arrays of width $4$ over $\{0,1,2,3\}$ in which the number of adjacent PAIRS of
...
OEIS A269197 is ``Number of n X 4 0..3 arrays with some element plus some horizontally, diagonally or antidiagonally adjacent neighbor totalling three no more than once.''. It has offset $1$ and begins
\[
216, 9612, 400428, 15289548, 555862380, 19558138380, 672230393004, 22702294138188,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 62*a(n-1) - 1031*a(n-2) + 2180*a(n-3) - 1535*a(n-4) + 350*a(n-5) - 25*a(n-6) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 20 2019 08:39:30, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269197.
