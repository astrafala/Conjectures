...
\title{The empirical recurrence for OEIS A268902, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A268902 counts arrays over $\{0,\dots,2\}$ subject to a condition on the array as a
...
OEIS A268902 is ``Number of n X 6 0..2 arrays with some element plus some horizontally or antidiagonally adjacent neighbor totalling two exactly once.''. It has offset $1$ and begins
\[
240, 9720, 299088, 8250912, 214142760, 5344944120, 129834259704, 3091414865040,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 50*a(n-1) - 805*a(n-2) + 4662*a(n-3) - 12150*a(n-4) + 14580*a(n-5) - 6561*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 16 2019 11:25:48, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;50\,a(n-1) - 805\,a(n-2) + 4662\,a(n-3) - 12150\,a(n-4) + 14580\,a(n-5) - 6561\,a(n-6)
\end{equation}
for all $n>6$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268902.
