...
\title{The empirical recurrence for OEIS A274855, proved by counting patterns}
...
\begin{abstract}
OEIS A274855 counts arrays in which no entry may repeat a value found at any of three stated
...
OEIS A274855 is ``Number of n X 5 0..2 arrays with no element equal to any value at offset (-1,0) (0,-1) or (-2,-2) and new values introduced in order 0..2.''. It has offset $1$ and begins
\[
8, 81, 100, 330, 1085, 3602, 12102, 40901,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 8*a(n-1) - 27*a(n-2) + 56*a(n-3) - 75*a(n-4) + 61*a(n-5) - 28*a(n-6) + 7*a(n-7) - a(n-8) for n>10.
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 31 2019 08:06:52, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A274855.
