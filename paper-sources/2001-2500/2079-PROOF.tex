...
\title{The empirical recurrence for OEIS A210168, proved by transfer matrix}
...
\begin{abstract}
OEIS A210168 counts arrays of width $3$ whose every $2\times2$ subblock holds a
...
OEIS A210168 is ``Number of (n+1) X 3 0..3 arrays containing all values 0..3 with every 2 X 2 subblock having two or four distinct values, and new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
10, 201, 3283, 48577, 679253, 9173091, 121178151, 1578188865,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 20 2024 13:30:44, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;32\,a(n-1) - 362\,a(n-2) + 1648\,a(n-3) - 1561\,a(n-4) - 7568\,a(n-5) + 11440\,a(n-6) + 11360\,a(n-7) - 14768\,a(n-8) - 6400\,a(n-9) + 3840\,a(n-10)
\]
for every $n>10$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A210168.
