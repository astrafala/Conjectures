...
\title{The empirical recurrence for OEIS A204344, proved by transfer matrix}
...
\begin{abstract}
OEIS A204344 counts $(n+2)\times3$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A204344 is ``Number of (n+2)X3 0..3 arrays with no 3X3 subblock having three equal diagonal elements or three equal antidiagonal elements, and new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
9672, 540324, 30378276, 1708802980, 96125591660, 5407387617220, 304183813284988, 17111367047366980,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 62*a(n-1) -285*a(n-2) -2404*a(n-3) +14308*a(n-4) -9048*a(n-5) -23940*a(n-6) +27216*a(n-7) -7056*a(n-8)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 11:08:10, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;62\,a(n-1) - 285\,a(n-2) - 2404\,a(n-3) + 14308\,a(n-4) - 9048\,a(n-5) - 23940\,a(n-6) + 27216\,a(n-7) - 7056\,a(n-8)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204344.
