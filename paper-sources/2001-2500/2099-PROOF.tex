...
\title{The empirical recurrence for OEIS A274890, proved by counting patterns}
...
\begin{abstract}
OEIS A274890 counts arrays in which no entry may repeat a value found at any of three stated
...
cutting $794$ pairs to $S=155$ states. The entry's empirical recurrence of order $8$,
...
OEIS A274890 is ``Number of n X 3 0..2 arrays with no element equal to any value at offset (0,-1) (-1,-1) or (-2,0) and new values introduced in order 0..2.''. It has offset $1$ and begins
\[
2, 12, 16, 38, 84, 192, 436, 990,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) + 4*a(n-2) - 6*a(n-4) - a(n-5) + 4*a(n-6) - a(n-8) for n>10.
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 31 2019 08:07:02, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A274890.
