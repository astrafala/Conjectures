...
\title{The empirical recurrence for OEIS A269147, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A269147 counts arrays over $\{0,\dots,3\}$ subject to a condition on the array as a
...
OEIS A269147 is ``Number of nX3 0..3 arrays with some element plus some horizontally, antidiagonally or vertically adjacent neighbor totalling three exactly once.''. It has offset $1$ and begins
\[
24, 768, 13904, 220968, 3277728, 46576336, 642676704, 8680278136,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 26*a(n-1) -199*a(n-2) +408*a(n-3) -463*a(n-4) +322*a(n-5) -141*a(n-6) +36*a(n-7) -4*a(n-8) for n>9
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 20 2016 07:16:01, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;26\,a(n-1) - 199\,a(n-2) + 408\,a(n-3) - 463\,a(n-4) + 322\,a(n-5) - 141\,a(n-6) + 36\,a(n-7) - 4\,a(n-8)
\end{equation}
for all $n>9$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269147.
