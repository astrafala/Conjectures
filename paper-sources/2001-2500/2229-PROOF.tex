...
\title{The empirical closed form for OEIS A224013, proved}
...
\begin{abstract}
OEIS A224013 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A224013 is ``Number of 3 X n 0..2 arrays with rows nondecreasing and antidiagonals unimodal.''. It has offset $1$ and begins
\[
27, 216, 868, 2661, 6815, 15340, 31324, 59267,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (23/360)*n\^{}6 + (27/40)*n\^{}5 + (271/72)*n\^{}4 + (65/8)*n\^{}3 + (2101/180)*n\^{}2 + (97/10)*n - 1 for n>1.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 26 2018 05:46:10, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{23 n^{6}}{360} + \frac{27 n^{5}}{40} + \frac{271 n^{4}}{72} + \frac{65 n^{3}}{8} + \frac{2101 n^{2}}{180} + \frac{97 n}{10} - 1.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224013.
