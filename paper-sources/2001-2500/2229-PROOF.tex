...
\title{The empirical recurrence for OEIS A231856, proved by transfer matrix}
...
\begin{abstract}
OEIS A231856 counts arrays of width $2$ over $\{0,1,2\}$ in which no cell is beaten by a strict majority of its neighbours. The entry carries an
...
$3$ consecutive rows and the count is a walk count on $S=76$ states.
\end{abstract}
...
OEIS A231856 is ``Number of 2 X n 0..2 arrays with no element having a strict majority of its horizontal and antidiagonal neighbors equal to itself plus one mod 3, with upper left element zero (rock paper and scissors drawn positions).''. It has offset $1$ and begins
\[
3, 8, 34, 144, 612, 2613, 11159, 47675,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 5*a(n-1) - 2*a(n-2) - 5*a(n-3) - a(n-4) + 10*a(n-5) - 3*a(n-6) - 3*a(n-7) + a(n-8) for n>9.
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 01 2018 09:28:17, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) - 2\,a(n-2) - 5\,a(n-3) - a(n-4) + 10\,a(n-5) - 3\,a(n-6) - 3\,a(n-7) + a(n-8)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231856.
