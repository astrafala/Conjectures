...
\title{No column above the one before it in every row: OEIS A212940}
...
\begin{abstract}
OEIS A212940 carries an empirical recurrence of order $7$ contributed by R.~H.~Hardin. It is
...
OEIS A212940 is ``Number of nX5 0..4 arrays with no column j greater than or equal to than column j-1 in all rows.''. It has offset $1$ and begins
\[
1, 1016501, 10058484751, 52311221188001, 212180664326328751, 764898125476357657001, 2592491557886605293297751, 8492622463881130571398876001,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 16:41:17, revision 11) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{The count is a walk count}

The entry counts arrays of $5$ columns whose rows are arbitrary over the alphabet $\{0,1,2,3,4\}$, and asks that no column $j$ be greater than or equal to column $j-1$ \emph{in all rows}.
...
\begin{theorem}
\[
a(n)\;=\;8001\,a(n-1) - 24144750\,a(n-2) + 35582371250\,a(n-3) - 27539217890625\,a(n-4) + 11055908759765625\,a(n-5) - 2081011816406250000\,a(n-6) + 133539505004882812500\,a(n-7)
\]
for every $n>7$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A212940.
