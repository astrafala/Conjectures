...
\title{The empirical recurrence for OEIS A275499, proved by counting patterns}
...
\begin{abstract}
OEIS A275499 counts arrays in which no entry may repeat a value found at any of three stated
...
cutting $794$ pairs to $S=155$ states. The entry's empirical recurrence of order $7$,
...
OEIS A275499 is ``Number of n X 3 0..2 arrays with no element equal to any value at offset (-2,-1) (-2,0) or (-1,-1) and new values introduced in order 0..2.''. It has offset $1$ and begins
\[
5, 54, 80, 136, 232, 516, 1168, 2660,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) + 2*a(n-2) - 2*a(n-3) - 4*a(n-4) + 3*a(n-5) + a(n-6) - a(n-7) for n>11.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 04 2019 09:22:34, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 2\,a(n-2) - 2\,a(n-3) - 4\,a(n-4) + 3\,a(n-5) + a(n-6) - a(n-7)
\end{equation}
for all $n>11$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A275499.
