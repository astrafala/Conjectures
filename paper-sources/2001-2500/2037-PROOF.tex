...
\title{Arrays counted up to renaming: the empirical recurrence for OEIS A206165}
...
\begin{abstract}
OEIS A206165 carries an empirical recurrence of order $10$ contributed by R.~H.~Hardin. It is
...
both in the state the arrays are exactly the walks in a digraph on $S=39$ vertices, so $a(n)$
...
OEIS A206165 is ``Number of (n+1)X5 0..3 arrays with every 2X2 subblock in a row having an equal number of equal diagonal or equal antidiagonal elements, adjacent rows differing in this number, and new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
5257, 196078, 13899222, 526154358, 37242588902, 1412613762182, 99795262195942, 3792559398258150,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 12:29:19, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 2697\,a(n-2) - 2261\,a(n-3) - 62984\,a(n-4) + 18588\,a(n-5) + 148188\,a(n-6) + 441756\,a(n-7) - 1398384\,a(n-8) + 632448\,a(n-9) + 6137856\,a(n-10)
\]
for every $n>11$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206165.
