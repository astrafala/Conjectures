...
\title{The empirical recurrence for OEIS A198977, proved by counting patterns}
...
\begin{abstract}
OEIS A198977 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A198977 is ``Number of nX3 0..5 arrays with values 0..5 introduced in row major order and no element equal to any horizontal or vertical neighbor.''. It has offset $1$ and begins
\[
2, 34, 1835, 146286, 12662226, 1112962873, 98102456246, 8651794282083,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 116*a(n-1) -2685*a(n-2) +21394*a(n-3) -74475*a(n-4) +117904*a(n-5) -80343*a(n-6) +18090*a(n-7)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 08:02:31, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;116\,a(n-1) - 2685\,a(n-2) + 21394\,a(n-3) - 74475\,a(n-4) + 117904\,a(n-5) - 80343\,a(n-6) + 18090\,a(n-7)
\end{equation}
for all $n>7$.
...
\[
6!\Bigl(a(n)-\sum_i c_i\,a(n-i)\Bigr)\;=\;\mathbf{v}^{\!\top}N^{\,m-7}q(N)\mathbf{1} .
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A198977.
