...
\title{The empirical recurrence for OEIS A206143, proved by transfer matrix}
...
\begin{abstract}
OEIS A206143 counts arrays over $\{0,\dots,2\}$ under a condition on the perimeter cycle of
every $2\times3$ and $3\times2$ subblock, and carries an empirical recurrence of order $1$ contributed by
...
OEIS A206143 is ``Number of (n+1) X 2 0..2 arrays with every 2 X 3 or 3 X 2 subblock having exactly three counterclockwise and three clockwise edge increases.''. It has offset $1$ and begins
\[
81, 60, 162, 486, 1458, 4374, 13122, 39366,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) for n > 3.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 11 2015 11:45:22, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206143.
