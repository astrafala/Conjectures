...
\title{The empirical recurrence for OEIS A204648, derived from the entry's generating function}
...
\begin{abstract}
OEIS A204648 carries an empirical recurrence of order $8$. The entry separately records a
...
OEIS A204648 is ``Number of (n+1) X 6 0..1 arrays with column and row pair sums b(i,j)=a(i,j)+a(i,j-1) and c(i,j)=a(i,j)+a(i-1,j) nondecreasing in column and row directions, respectively.''. It has offset $1$ and begins
\[
80, 137, 284, 571, 1076, 1918, 3261, 5329,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 08 2018 13:51:18, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{4 x^{11} - 8 x^{10} + 4 x^{9} - 89 x^{8} + 379 x^{7} - 600 x^{6} + 292 x^{5} + 335 x^{4} - 582 x^{3} + 343 x^{2} - 80 x}{x^{8} - 6 x^{7} + 14 x^{6} - 14 x^{5} + 14 x^{3} - 14 x^{2} + 6 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 4 x^{11} + 8 x^{10} - 4 x^{9} + 89 x^{8} - 379 x^{7} + 600 x^{6} - 292 x^{5} - 335 x^{4} + 582 x^{3} - 343 x^{2} + 80 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204648.
