...
\title{A proof of the conjectured recurrence for OEIS A114191}
...
\begin{abstract}
OEIS A114191 carries a conjectured linear recurrence with polynomial coefficients, of
...
OEIS A114191 is ``Expansion of 1/(1+x*c(-2*x)), c(x) the g.f. of A000108''. It has offset $0$ and begins
\[
a(0),\dots,a(7)\;=\;1, -1, 3, -13, 67, -381, 2307, -14589,\ \dots
\]
The entry gives the generating function
\begin{equation}\label{eq:gf}
A(x)\;=\;\sum_{n\ge 0} a(n)\,x^{n}\;=\;\frac{4}{\sqrt{8 x + 1} + 3} ,
\end{equation}
and it carries the following comment:
\begin{quote}\small
\textbf{Conjecture:} n*a(n) + (7*n-12)*a(n-1) + 4*(3-2*n)*a(n-2) = 0. - \emph{R. J. Mathar}, Nov 14 2011
\end{quote}
As of the ``Last modified'' line on the live entry (2020-01-22, revision 16) the
...
\[
p_{0}(n)=n,\qquad p_{1}(n)=7 n - 12,\qquad p_{2}(n)=- 4 \left(2 n - 3\right)
\]
...
\section{The computation for A114191}
...
\[
n\,a(n) + (7 n - 12)\,a(n-1) -  4 \left(2 n - 3\right)\,a(n-2) \;=\;0
\]
holds for every $n>1$.
\end{theorem}
...
section of A114191, agreeing on all 13 terms compared.
...
\url{https://oeis.org}, 2026. Sequence A114191.
