...
\title{The empirical recurrence for OEIS A250791, derived from the entry's generating function}
...
\begin{abstract}
OEIS A250791 carries an empirical recurrence of order $4$. The entry separately records a
...
OEIS A250791 is ``Number of (n+1) X (2+1) 0..1 arrays with nondecreasing min(x(i,j),x(i,j-1)) in the i direction and nondecreasing absolute value of x(i,j)-x(i-1,j) in the j direction.''. It has offset $1$ and begins
\[
24, 66, 180, 490, 1336, 3646, 9956, 27194,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 20 2018 07:30:30, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 16 x^{4} + 12 x^{3} + 30 x^{2} - 24 x}{2 x^{4} - 2 x^{3} - 3 x^{2} + 4 x - 1},
\]
the entry's own generating function, and let
\[
D(x)\;=\;1-\sum_i c_i x^{i}\;=\;- 2 x^{4} + 2 x^{3} + 3 x^{2} - 4 x + 1
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;16 x^{4} - 12 x^{3} - 30 x^{2} + 24 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250791.
