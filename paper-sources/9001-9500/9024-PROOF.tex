...
\title{The empirical recurrence for OEIS A250782, derived from the entry's generating function}
...
\begin{abstract}
OEIS A250782 carries an empirical recurrence of order $11$. The entry separately records a
...
OEIS A250782 is ``Number of (n+1) X (7+1) 0..1 arrays with nondecreasing x(i,j)+x(i,j-1) in the i direction and nondecreasing absolute value of x(i,j)-x(i-1,j) in the j direction.''. It has offset $1$ and begins
\[
901, 2326, 5568, 12796, 28692, 63184, 137082, 293588,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 19 2018 12:57:27, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 681 x^{11} + 6482 x^{10} - 29083 x^{9} + 79028 x^{8} - 142536 x^{7} + 177432 x^{6} - 154050 x^{5} + 92040 x^{4} - 36221 x^{3} + 8486 x^{2} - 901 x}{2 x^{11} - 21 x^{10} + 100 x^{9} - 285 x^{8} + 540 x^{7} - 714 x^{6} + 672 x^{5} - 450 x^{4} + 210 x^{3} - 65 x^{2} + 12 x - 1},
\]
the entry's own generating function, and let
\[
D(x)\;=\;1-\sum_i c_i x^{i}\;=\;- 2 x^{11} + 21 x^{10} - 100 x^{9} + 285 x^{8} - 540 x^{7} + 714 x^{6} - 672 x^{5} + 450 x^{4} - 210 x^{3} + 65 x^{2} - 12 x + 1
\]
...
\begin{theorem}
\[
a(n)\;=\;12\,a(n-1) - 65\,a(n-2) + 210\,a(n-3) - 450\,a(n-4) + 672\,a(n-5) - 714\,a(n-6) + 540\,a(n-7) - 285\,a(n-8) + 100\,a(n-9) - 21\,a(n-10) + 2\,a(n-11)
\]
for every $n>11$.
\end{theorem}
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;681 x^{11} - 6482 x^{10} + 29083 x^{9} - 79028 x^{8} + 142536 x^{7} - 177432 x^{6} + 154050 x^{5} - 92040 x^{4} + 36221 x^{3} - 8486 x^{2} + 901 x,
\]
...
\[
2 x^{11} - 21 x^{10} + 100 x^{9} - 285 x^{8} + 540 x^{7} - 714 x^{6} + 672 x^{5} - 450 x^{4} + 210 x^{3} - 65 x^{2} + 12 x - 1,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250782.
