...
\title{The empirical recurrence for OEIS A214181, derived from the entry's generating function}
...
\begin{abstract}
OEIS A214181 carries an empirical recurrence of order $4$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 22 2018 06:42:13, revision 9) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 21313 x^{4} + 4292 x^{3} - 161 x^{2} + x}{94336 x^{4} - 59396 x^{3} + 6468 x^{2} - 179 x + 1},
\]
the entry's own generating function, and let
\[
D(x)\;=\;1-\sum_i c_i x^{i}\;=\;94336 x^{4} - 59396 x^{3} + 6468 x^{2} - 179 x + 1
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 21313 x^{4} + 4292 x^{3} - 161 x^{2} + x,
\]
...
\[
94336 x^{4} - 59396 x^{3} + 6468 x^{2} - 179 x + 1,
\]
