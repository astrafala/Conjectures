...
\title{The empirical recurrence for OEIS A208089, derived from the entry's generating function}
...
\begin{abstract}
OEIS A208089 carries an empirical recurrence of order $4$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 28 2018 08:25:52, revision 11) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 126 x^{4} + 306 x^{3} + 144 x^{2} - 216 x}{x^{4} - 3 x^{3} + 3 x - 1},
\]
the entry's own generating function, and let
\[
D(x)\;=\;1-\sum_i c_i x^{i}\;=\;- x^{4} + 3 x^{3} - 3 x + 1
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;126 x^{4} - 306 x^{3} - 144 x^{2} + 216 x,
\]
