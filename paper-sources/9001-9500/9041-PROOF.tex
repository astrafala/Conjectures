...
\title{The empirical recurrence for OEIS A206066, proved by transfer matrix}
...
\begin{abstract}
OEIS A206066 counts arrays over $\{0,\dots,2\}$ under a condition on the perimeter cycle of
...
OEIS A206066 is ``Number of (n+1) X 3 0..2 arrays with every 2 X 3 or 3 X 2 subblock having exactly three clockwise edge increases.''. It has offset $1$ and begins
\[
150, 606, 3330, 18534, 103194, 574182, 3193722, 17762598,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 7*a(n-1) - 8*a(n-2) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 13 2018 11:24:02, revision 9) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206066.
