...
\title{The empirical recurrence for OEIS A252528, proved by transfer matrix}
...
\begin{abstract}
OEIS A252528 counts $(n+2)\times6$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
$a(n)$ is a walk count on $S=447707$ vertices. Such a sequence is $C$-finite, so whether a given
...
OEIS A252528 is ``Number of (n+2) X (4+2) 0..3 arrays with every 3 X 3 subblock row and diagonal sum equal to 0 2 3 6 or 7 and every 3 X 3 column and antidiagonal sum not equal to 0 2 3 6 or 7.''. It has offset $1$ and begins
\[
719, 462, 626, 790, 1676, 2504, 3160, 6704,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-3) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 04 2018 11:03:58, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252528.
