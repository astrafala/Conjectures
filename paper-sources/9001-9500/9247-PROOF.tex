...
\title{A proof of the conjectured recurrence for OEIS A034267}
...
\begin{abstract}
OEIS A034267 carries a conjectured linear recurrence with polynomial coefficients, of
...
OEIS A034267 is ``a(n) = f(n,n) where f is given in A034261''. It has offset $0$ and begins
\[
a(0),\dots,a(7)\;=\;0, 1, 7, 39, 196, 930, 4257, 19019,\ \dots
\]
The entry states, not as a conjecture,
\begin{quote}\small
a(n) = binomial(2*n, n+1)*(n\textasciicircum{}2+n+1)/(n+2);
\end{quote}
that is,
\begin{equation}\label{eq:cf}
a(n)\;=\;\frac{\left(n^{2} + n + 1\right) {\binom{2 n}{n + 1}}}{n + 2} .
\end{equation}
...
\begin{quote}\small
Conjecture D-finite with recurrence -(n+2)*(11*n-7)*a(n) + 2*(23*n\textasciicircum{}2+44*n+30)*a(n-1) - 4*(n+5)*(2*n-3)*a(n-2) = 0. - \emph{R. J. Mathar}, Feb 10 2025
\end{quote}
As of the ``Last modified'' line on the live entry (2025-09-04, revision 23) the
...
- \left(n + 2\right) \left(11 n - 7\right)\,a(n) + 2 \left(23 n^{2} + 44 n + 30\right)\,a(n-1) -  4 \left(n + 5\right) \left(2 n - 3\right)\,a(n-2)
\end{equation}
...
entry \href{https://oeis.org/A034267}{A034267}, 2025-09-04.
