...
\title{The empirical recurrence for OEIS A250778, derived from the entry's generating function}
...
\begin{abstract}
OEIS A250778 carries an empirical recurrence of order $3$. The entry separately records a
...
OEIS A250778 is ``Number of (n+1) X (3+1) 0..1 arrays with nondecreasing x(i,j)+x(i,j-1) in the i direction and nondecreasing absolute value of x(i,j)-x(i-1,j) in the j direction.''. It has offset $1$ and begins
\[
46, 106, 230, 482, 990, 2010, 4054, 8146,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 19 2018 09:13:59, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 36 x^{3} + 78 x^{2} - 46 x}{2 x^{3} - 5 x^{2} + 4 x - 1},
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250778.
