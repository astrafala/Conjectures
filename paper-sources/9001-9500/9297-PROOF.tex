...
\title{A proof of the conjectured recurrence for OEIS A212938}
...
\begin{abstract}
OEIS A212938 carries a conjectured linear recurrence with polynomial coefficients, of
...
\begin{quote}\small
a(n) = 10\textasciicircum{}n - 2*18\textasciicircum{}n + 27\textasciicircum{}n.
\end{quote}
that is,
\begin{equation}\label{eq:cf}
a(n)\;=\;10^{n} - 2 \cdot 18^{n} + 27^{n} .
\end{equation}
...
\end{quote}
As of the ``Last modified'' line on the live entry (2018-07-21, revision 13) the
...
1\,a(n) - 55\,a(n-1) + 936\,a(n-2) - 4860\,a(n-3)
\end{equation}
...
\section{The computation for A212938}

The closed form \eqref{eq:cf} splits into 3 similarity classes, with
representativees
\[
10^{n},\qquad 27^{n},\qquad - 2 \cdot 18^{n}
\]
...
entry \href{https://oeis.org/A212938}{A212938}, 2018-07-21.
