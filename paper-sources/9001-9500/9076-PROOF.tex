...
\title{A condition on the multiset of every subblock: OEIS A184189}
...
\begin{abstract}
OEIS A184189 carries an empirical recurrence of order $3$ contributed by R.~H.~Hardin. It is
...
on $S=3$ vertices and is $C$-finite, and whether the conjectured recurrence annihilates it
...
OEIS A184189 is ``Half the number of (n+1) X 2 binary arrays with no 2 X 2 subblock containing exactly one 1.''. It has offset $1$ and begins
\[
6, 19, 60, 190, 602, 1908, 6048, 19172,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) - 2*a(n-2) - 2*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 12 2018 08:43:14, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{The count is a walk count}

The entry counts arrays with $2$ columns over the alphabet $\{0,1\}$, growing one row at a time, and asks that no $2\times2$ subblock holds exactly $1$ entries equal to $1$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A184189.
