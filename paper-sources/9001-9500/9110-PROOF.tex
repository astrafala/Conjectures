...
\title{The empirical recurrence for OEIS A250892, derived from the entry's generating function}
...
\begin{abstract}
OEIS A250892 carries an empirical recurrence of order $7$. The entry separately records a
...
OEIS A250892 is ``Number of (n+1) X (2+1) 0..2 arrays with nondecreasing x(i,j)-x(i,j-1) in the i direction and nondecreasing absolute value of x(i,j)-x(i-1,j) in the j direction.''. It has offset $1$ and begins
\[
127, 431, 1450, 4750, 15111, 47061, 144442, 439056,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 22 2018 16:33:35, revision 7) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{88 x^{9} - 328 x^{8} - 498 x^{7} + 3984 x^{6} - 7674 x^{5} + 7364 x^{4} - 3898 x^{3} + 1093 x^{2} - 127 x}{24 x^{7} - 116 x^{6} + 234 x^{5} - 255 x^{4} + 162 x^{3} - 60 x^{2} + 12 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 88 x^{9} + 328 x^{8} + 498 x^{7} - 3984 x^{6} + 7674 x^{5} - 7364 x^{4} + 3898 x^{3} - 1093 x^{2} + 127 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250892.
