...
\title{The empirical recurrence for OEIS A234789, derived from the entry's generating function}
...
\begin{abstract}
OEIS A234789 carries an empirical recurrence of order $3$. The entry separately records a
...
OEIS A234789 is ``Number of (n+1) X (1+1) 0..3 arrays with each 2 X 2 subblock having the number of clockwise edge increases less than or equal to the number of counterclockwise edge increases.''. It has offset $1$ and begins
\[
204, 2504, 30536, 371976, 4530424, 55175944, 671983416, 8184025736,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 16 2018 05:42:15, revision 9) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 320 x^{3} + 556 x^{2} - 204 x}{20 x^{3} - 36 x^{2} + 15 x - 1},
\]
the entry's own generating function, and let
\[
D(x)\;=\;1-\sum_i c_i x^{i}\;=\;- 20 x^{3} + 36 x^{2} - 15 x + 1
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234789.
