...
\title{The empirical recurrence for OEIS A253227, derived from the entry's generating function}
...
\begin{abstract}
OEIS A253227 carries an empirical recurrence of order $4$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 10 2018 12:18:41, revision 7) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{x^{8} - 5 x^{7} + 343 x^{6} - 1245 x^{5} + 1261 x^{4} + 219 x^{3} - 933 x^{2} + 335 x}{2 x^{4} - 7 x^{3} + 9 x^{2} - 5 x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;x^{8} - 5 x^{7} + 343 x^{6} - 1245 x^{5} + 1261 x^{4} + 219 x^{3} - 933 x^{2} + 335 x,
\]
