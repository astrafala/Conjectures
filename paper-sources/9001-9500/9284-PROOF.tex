...
\title{The empirical recurrence for OEIS A250780, derived from the entry's generating function}
...
\begin{abstract}
OEIS A250780 carries an empirical recurrence of order $7$. The entry separately records a
...
OEIS A250780 is ``Number of (n+1) X (5+1) 0..1 arrays with nondecreasing x(i,j)+x(i,j-1) in the i direction and nondecreasing absolute value of x(i,j)-x(i-1,j) in the j direction.''. It has offset $1$ and begins
\[
209, 518, 1194, 2640, 5688, 12036, 25126, 51904,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 19 2018 09:14:08, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 153 x^{7} + 922 x^{6} - 2401 x^{5} + 3376 x^{4} - 2693 x^{3} + 1154 x^{2} - 209 x}{2 x^{7} - 13 x^{6} + 36 x^{5} - 55 x^{4} + 50 x^{3} - 27 x^{2} + 8 x - 1},
\]
the entry's own generating function, and let
\[
D(x)\;=\;1-\sum_i c_i x^{i}\;=\;- 2 x^{7} + 13 x^{6} - 36 x^{5} + 55 x^{4} - 50 x^{3} + 27 x^{2} - 8 x + 1
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;153 x^{7} - 922 x^{6} + 2401 x^{5} - 3376 x^{4} + 2693 x^{3} - 1154 x^{2} + 209 x,
\]
...
\[
2 x^{7} - 13 x^{6} + 36 x^{5} - 55 x^{4} + 50 x^{3} - 27 x^{2} + 8 x - 1,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250780.
