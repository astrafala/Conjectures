...
\title{The empirical recurrence for OEIS A221121, derived from the entry's generating function}
...
\begin{abstract}
OEIS A221121 carries an empirical recurrence of order $2$. The entry separately records a
...
OEIS A221121 is ``Number of n X 3 arrays of occupancy after each element stays put or moves to some horizontal or antidiagonal neighbor.''. It has offset $1$ and begins
\[
8, 200, 4872, 118472, 2880520, 70036168, 1702839048, 41402332360,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 03 2018 16:33:57, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 8 x^{2} + 8 x}{41 x^{2} - 26 x + 1},
\]
the entry's own generating function, and let
\[
D(x)\;=\;1-\sum_i c_i x^{i}\;=\;41 x^{2} - 26 x + 1
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221121.
