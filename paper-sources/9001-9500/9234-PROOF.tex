...
\title{A proof of the conjectured recurrence for OEIS A026019}
...
\begin{abstract}
OEIS A026019 carries a conjectured linear recurrence with polynomial coefficients, of
...
OEIS A026019 is ``a(n) = binomial(3*n,n) - binomial(3*n,n-3)''. It has offset $0$ and begins
\[
a(0),\dots,a(7)\;=\;1, 3, 15, 83, 483, 2898, 17748, 110295,\ \dots
\]
...
\begin{quote}\small
\textbf{Conjecture:} -2*(2*n+3)*(13*n-9)*(n+1)*a(n) + (499*n\textasciicircum{}3-7*n\textasciicircum{}2-120*n-54)*a(n-1) - 3*(3*n-5)*(37*n-24)*(3*n-4)*a(n-2) = 0. - \emph{R. J. Mathar}, Jun 20 2013
\end{quote}
As of the ``Last modified'' line on the live entry (2025-09-06, revision 26) the
...
- 2 \left(n + 1\right) \left(2 n + 3\right) \left(13 n - 9\right)\,a(n) + (499 n^{3} - 7 n^{2} - 120 n - 54)\,a(n-1) -  3 \left(3 n - 5\right) \left(3 n - 4\right) \left(37 n - 24\right)\,a(n-2)
\end{equation}
...
\section{The computation for A026019}
...
entry \href{https://oeis.org/A026019}{A026019}, 2025-09-06.
