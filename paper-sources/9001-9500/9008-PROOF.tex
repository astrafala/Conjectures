...
\title{The empirical recurrence for OEIS A234780, proved by transfer matrix}
...
\begin{abstract}
OEIS A234780 counts arrays of width $3$ over $\{0,1,2,3\}$ subject to a condition read round the
...
count is a walk count on a finite digraph with $S=37$ vertices, and whether a linear
...
OEIS A234780 is ``Number of (n+1) X (2+1) 0..3 arrays with no adjacent elements equal and with each 2 X 2 subblock having the number of clockwise edge increases equal to the number of counterclockwise edge increases.''. It has offset $1$ and begins
\[
484, 6660, 91916, 1269036, 17521780, 241927524, 3340355564, 46121153580,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 16*a(n-1) - 31*a(n-2) + 10*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 16 2018 05:42:09, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234780.
