...
\title{The empirical recurrence for OEIS A188825, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A188825 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A188825 is ``Number of 3Xn binary arrays without the pattern 0 1 diagonally or antidiagonally.''. It has offset $1$ and begins
\[
8, 16, 48, 144, 432, 1296, 3888, 11664,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) for n>2
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 04:52:24, revision 8) the statement is
...
The threshold below is exact rather than merely sufficient: at $n=2$ the conjectured
...
the middle column. The vector $w$ was formed by $1$ applications of $G$ in exact integer
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A188825.
