...
\title{The empirical recurrence for OEIS A222139, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A222139 counts arrays over $\{0,\dots,4\}$ in which every cell is constrained by the
...
OEIS A222139 is ``Number of n X 3 0..4 arrays with no entry increasing mod 5 by 4 rightwards or downwards, starting with upper left zero.''. It has offset $1$ and begins
\[
16, 676, 28564, 1206964, 50999956, 2154990196, 91058563924, 3847656513844,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 45*a(n-1) - 116*a(n-2).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 15 2018 04:47:22, revision 10) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;45\,a(n-1) - 116\,a(n-2)
\end{equation}
for all $n>3$.
...
$5$ values, so there are about $10^{29}$ of them to sift. The
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A222139.
