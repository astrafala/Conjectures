...
\title{The empirical recurrence for OEIS A222892, derived from the entry's generating function}
...
\begin{abstract}
OEIS A222892 carries an empirical recurrence of order $4$. The entry separately records a
...
\begin{quote}
G.f.: x*(3 - 599*x + 21972*x\^{}2 - 138229*x\^{}3 - 495045*x\^{}4 + 558558*x\^{}5) / ((1 - 3*x)*(1 - 14*x)*(1 - 39*x)*(1 - 155*x)).
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 16 2018 13:23:06, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{558558 x^{6} - 495045 x^{5} - 138229 x^{4} + 21972 x^{3} - 599 x^{2} + 3 x}{253890 x^{4} - 110913 x^{3} + 9385 x^{2} - 211 x + 1},
\]
the entry's own generating function, and let
\[
D(x)\;=\;1-\sum_i c_i x^{i}\;=\;253890 x^{4} - 110913 x^{3} + 9385 x^{2} - 211 x + 1
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;558558 x^{6} - 495045 x^{5} - 138229 x^{4} + 21972 x^{3} - 599 x^{2} + 3 x,
\]
...
\[
253890 x^{4} - 110913 x^{3} + 9385 x^{2} - 211 x + 1,
\]
