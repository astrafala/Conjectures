...
\title{The empirical recurrence for OEIS A183682, derived from the entry's generating function}
...
\begin{abstract}
OEIS A183682 carries an empirical recurrence of order $2$. The entry separately records a
...
OEIS A183682 is ``Number of (n+1) X 3 binary arrays with every 2 X 2 subblock nonsingular.''. It has offset $1$ and begins
\[
12, 32, 80, 208, 528, 1360, 3472, 8912,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 27 2018 07:11:10, revision 9) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 20 x^{2} - 12 x}{4 x^{2} + x - 1},
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A183682.
