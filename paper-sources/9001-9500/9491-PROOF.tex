...
\title{The empirical recurrence for OEIS A253491, derived from the entry's generating function}
...
\begin{abstract}
OEIS A253491 carries an empirical recurrence of order $3$. The entry separately records a
...
OEIS A253491 is ``Number of (n+1) X (4+1) 0..2 arrays with every 2 X 2 subblock diagonal minus antidiagonal sum nondecreasing horizontally, vertically and ne-to-sw antidiagonally.''. It has offset $1$ and begins
\[
3639, 5386, 6476, 10477, 19475, 40117, 89339, 211597,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 15 2018 15:15:46, revision 11) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{342 x^{6} + 4467 x^{5} - 9033 x^{4} - 14189 x^{3} + 16448 x^{2} - 3639 x}{6 x^{3} - 11 x^{2} + 6 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 342 x^{6} - 4467 x^{5} + 9033 x^{4} + 14189 x^{3} - 16448 x^{2} + 3639 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253491.
