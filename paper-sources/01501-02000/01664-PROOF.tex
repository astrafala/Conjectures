...
\title{The empirical recurrence for OEIS A238249, proved by transfer matrix}
...
\begin{abstract}
OEIS A238249 counts arrays of width $3$ over $\{0,1\}$ by reducing every $2\times2$ subblock to a
single number---here the sum of the four entries---and requiring the resulting derived array to have its rows
...
about it is one bit per adjacent pair of columns, so the count is a walk count on $S=84$
states.
\end{abstract}
...
OEIS A238249 is ``Number of (n+1)X(2+1) 0..1 arrays with 2X2 subblock sums lexicographically nondecreasing columnwise and rowwise.''. It has offset $1$ and begins
\[
44, 180, 804, 2818, 9991, 29995, 90225, 241945,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 10:48:54, revision 7) this is still
...
f(B)\;=\;p+q+r+s,
\]
the sum of the four entries. An array with $R$ rows and $3$ columns has $(R-1)\times2$ subblocks, and they
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + 16\,a(n-2) - 82\,a(n-3) - 99\,a(n-4) + 774\,a(n-5) + 196\,a(n-6) - 4456\,a(n-7) + 1106\,a(n-8) + 17464\,a(n-9) - 10080\,a(n-10) - 49212\,a(n-11) + 40922\,a(n-12) + 102532\,a(n-13) - 108728\,a(n-14) - 159592\,a(n-15) + 207747\,a(n-16) + 184428\,a(n-17) - 296048\,a(n-18) - 153442\,a(n-19) + 318857\,a(n-20) + 83878\,a(n-21) - 259308\,a(n-22) - 19872\,a(n-23) + 157052\,a(n-24) - 10232\,a(n-25) - 68768\,a(n-26) + 12128\,a(n-27) + 20592\,a(n-28) - 5472\,a(n-29) - 3776\,a(n-30) + 1280\,a(n-31) + 320\,a(n-32) - 128\,a(n-33)
\]
for every $n>32$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A238249.
