...
\title{The empirical recurrence for OEIS A221575, proved from an exact model}
...
\begin{abstract}
OEIS A221575 carries an empirical recurrence of order $6$. It is true, and it is
...
OEIS A221575 is ``Number of 0..n arrays of length 5 with each element differing from at least one neighbor by something other than 1.''. It has offset $1$ and begins
\[
6, 57, 342, 1293, 3734, 8991, 19014, 36497,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 1*n\^{}5 + 1*n\^{}4 - 2*n\^{}3 + 12*n\^{}2 - 15*n + 9 for n>2. a(n) = 6*a(n-1) - 15*a(n-2) + 20*a(n-3) - 15*a(n-4) + 6*a(n-5) - a(n-6) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 08 2018 18:36:55, revision 8)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221575.
