...
\title{The empirical recurrence for OEIS A279865, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A279865 imposes three things at once: a condition on each cell that reaches one row up and
...
OEIS A279865 is ``Number of n X 1 0..2 arrays with no element unequal to a strict majority of its horizontal and vertical neighbors, with the exception of exactly two elements, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
0, 1, 0, 6, 6, 30, 54, 158,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) +3*a(n-2) -11*a(n-3) -6*a(n-4) +12*a(n-5) +8*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 26 2018 09:15:17, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 3\,a(n-2) - 11\,a(n-3) - 6\,a(n-4) + 12\,a(n-5) + 8\,a(n-6)
\end{equation}
for all $n>7$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A279865.
