...
\title{The empirical recurrence for OEIS A224011, proved by transfer matrix}
...
\begin{abstract}
OEIS A224011 counts arrays over $\{0,\dots,2\}$ whose rows, columns, diagonals or
...
is a walk count on $S=4608$ vertices and the recurrence follows from a finite exact
computation.
\end{abstract}
...
OEIS A224011 is ``Number of n X 7 0..2 arrays with rows nondecreasing and antidiagonals unimodal.''. It has offset $1$ and begins
\[
36, 1296, 31324, 595822, 9866389, 150787422, 2200064042, 31256208954,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 18 2025 05:01:38, revision 10) the statement is
...
bit vector), $|\mathcal V|=S=4608$; let $(r,f)\to(s,f')$ be an edge when placing $s$ after $r$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224011.
