...
\title{The empirical recurrence for OEIS A219136, proved by transfer matrix}
...
\begin{abstract}
OEIS A219136 counts the distinct indicator arrays obtained from the $n\times2$ arrays over
...
OEIS A219136 is ``Unchanging value maps: number of n X 2 binary arrays indicating the locations of corresponding elements unequal to no horizontal, diagonal or antidiagonal neighbor in a random 0..2 n X 2 array.''. It has offset $1$ and begins
\[
2, 6, 18, 51, 142, 405, 1157, 3289,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + a(n-2) + 3*a(n-3) + 4*a(n-4) - 2*a(n-5) - 4*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 10 2018 08:37:04, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A219136.
