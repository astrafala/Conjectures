...
\title{The empirical recurrence for OEIS A219123, proved by transfer matrix}
...
\begin{abstract}
OEIS A219123 counts the distinct arrays obtained by applying a fixed local operation to every cell
of an array over a bounded alphabet, and carries an empirical recurrence of order $12$
...
$S=83$ states, after which the conjectured recurrence is settled by a finite exact
computation.
\end{abstract}
...
OEIS A219123 is ``Number of nX3 arrays of the minimum value of corresponding elements and their horizontal, diagonal or antidiagonal neighbors in a random 0..2 nX3 array.''. It has offset $1$ and begins
\[
9, 87, 787, 6981, 63183, 571149, 5167013, 46755215,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 17:53:33, revision 8) this is still
...
\]
There are $S=83$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite.
...
\begin{theorem}
\[
a(n)\;=\;10\,a(n-1) - 5\,a(n-2) - 24\,a(n-3) - 70\,a(n-4) - 58\,a(n-5) - 81\,a(n-6) - 200\,a(n-7) + 269\,a(n-8) + 1056\,a(n-9) + 1650\,a(n-10) + 1036\,a(n-11) + 200\,a(n-12)
\]
for every $n>12$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A219123.
