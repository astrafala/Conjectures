...
\title{The empirical recurrence for OEIS A266014, proved by transfer matrix}
...
\begin{abstract}
OEIS A266014 counts arrays of width $4$ in which every entry is equal to the NUMBER of its own
...
OEIS A266014 is ``Number of 4Xn integer arrays with each element equal to the number of horizontal and antidiagonal neighbors equal to itself.''. It has offset $1$ and begins
\[
1, 1, 14, 9, 27, 61, 75, 281,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 20 2015 07:00:25, revision 4) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=6948.
\]
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-3) + a(n-4) + 14\,a(n-5) + 31\,a(n-6) + 28\,a(n-7) + 17\,a(n-8) - 69\,a(n-9) + 124\,a(n-10) - 41\,a(n-11) - 174\,a(n-12) - 347\,a(n-13) - 293\,a(n-14) + 611\,a(n-15) - 1613\,a(n-16) - 496\,a(n-17) - 15\,a(n-18) + 1102\,a(n-19) + 2041\,a(n-20) - 4267\,a(n-21) + 7710\,a(n-22) + 4851\,a(n-23) + 741\,a(n-24) + 945\,a(n-25) - 5239\,a(n-26) + 16978\,a(n-27) - 16478\,a(n-28) - 21208\,a(n-29) + 4426\,a(n-30) - 7104\,a(n-31) + 466\,a(n-32) - 37612\,a(n-33) + 11472\,a(n-34) + 49808\,a(n-35) - 12912\,a(n-36) + 1664\,a(n-37) + 14944\,a(n-38) + 28288\,a(n-39) + 1536\,a(n-40) - 45056\,a(n-41) + 20480\,a(n-42) + 12288\,a(n-43) - 22528\,a(n-44)
\]
for every $n>53$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A266014.
