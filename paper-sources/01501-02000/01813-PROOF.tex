...
\title{The empirical recurrence for OEIS A246481, proved from an exact model}
...
\begin{abstract}
OEIS A246481 carries an empirical recurrence of order $9$. It is true, and it is
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 06 2018 06:44:59, revision 7)
