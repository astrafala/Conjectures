...
\title{The empirical recurrence for OEIS A209486, proved from an exact model}
...
\begin{abstract}
OEIS A209486 carries an empirical recurrence of order $11$. It is true, and it is
...
OEIS A209486 is ``Number of 5-bead necklaces labeled with numbers -n..n allowing reversal, with sum zero and avoiding the patterns z z+1 z+2 and z z-1 z-2.''. It has offset $1$ and begins
\[
4, 38, 140, 390, 866, 1702, 3014, 4984,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) - a(n-3) - 2*a(n-5) + 2*a(n-6) + a(n-8) - 2*a(n-10) + a(n-11).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 10 2018 06:00:16, revision 11)
...
vanish from $n=11+1$ onwards, and the run exceeds $S+11$, which by
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209486.
