...
\title{The empirical recurrence for OEIS A209117, proved from an exact model}
...
\begin{abstract}
OEIS A209117 carries an empirical recurrence of order $10$. It is true, and it is
...
OEIS A209117 is ``Number of 5-bead necklaces labeled with numbers -n..n not allowing reversal, with sum zero and avoiding the patterns z z+1 z+2 and z z-1 z-2.''. It has offset $1$ and begins
\[
5, 63, 261, 741, 1683, 3325, 5935, 9835,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) - 3*a(n-2) + 2*a(n-3) - 2*a(n-4) + 2*a(n-6) - 2*a(n-7) + 3*a(n-8) - 3*a(n-9) + a(n-10).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 08 2018 21:30:59, revision 13)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209117.
