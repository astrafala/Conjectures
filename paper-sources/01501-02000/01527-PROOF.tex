...
\title{The empirical recurrence for OEIS A249712, proved from an exact model}
...
\begin{abstract}
OEIS A249712 carries an empirical recurrence of order $7$. It is true, and it is
...
OEIS A249712 is ``Number of length 6+3 0..n arrays with every four consecutive terms having the maximum of some two terms equal to the minimum of the remaining two terms.''. It has offset $1$ and begins
\[
52, 659, 3440, 11925, 32500, 75495, 156416, 297321,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (1/5)*n\^{}6 + (73/15)*n\^{}5 + 18*n\^{}4 + 22*n\^{}3 + (34/5)*n\^{}2 - (13/15)*n + 1. a(n) = 7*a(n-1) - 21*a(n-2) + 35*a(n-3) - 35*a(n-4) + 21*a(n-5) - 7*a(n-6) + a(n-7) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 10 2018 05:46:45, revision 8)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A249712.
