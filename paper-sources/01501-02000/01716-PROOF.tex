...
\title{The empirical recurrence for OEIS A221415, proved by transfer matrix}
...
\begin{abstract}
OEIS A221415 counts the distinct OCCUPANCY arrays obtained when every cell of an $n\times4$ grid
...
OEIS A221415 is ``Number of n X 4 arrays of occupancy after each element stays put or moves to some horizontal or antidiagonal neighbor, with every occupancy equal to zero or two.''. It has offset $1$ and begins
\[
4, 29, 226, 1766, 13794, 107695, 840673, 6561928,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 10*a(n-1) - 15*a(n-2) - 19*a(n-3) + 17*a(n-4) + 12*a(n-5) - a(n-6) + a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 05 2018 08:20:59, revision 10) this is still
...
\begin{theorem}
\[
a(n)\;=\;10\,a(n-1) - 15\,a(n-2) - 19\,a(n-3) + 17\,a(n-4) + 12\,a(n-5) - a(n-6) + a(n-7)
\]
for every $n>7$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221415.
