...
\title{The empirical recurrence for OEIS A221230, proved by transfer matrix}
...
\begin{abstract}
OEIS A221230 counts the distinct OCCUPANCY arrays obtained when every cell of an $n\times2$ grid
...
determinising the machine that emits the occupancy row by row turns it into one, on $S=162$
...
OEIS A221230 is ``Number of nX2 arrays of occupancy after each element moves to some horizontal, vertical or antidiagonal neighbor, with no occupancy greater than 2.''. It has offset $1$ and begins
\[
1, 14, 119, 852, 6360, 47334, 351402, 2609499,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 19:23:57, revision 9) this is still
...
\]
There are $S=162$ reachable sets. In particular $a$ is $C$-finite.
...
\begin{theorem}
\[
a(n)\;=\;13\,a(n-1) - 48\,a(n-2) + 60\,a(n-3) - 124\,a(n-4) + 370\,a(n-5) - 458\,a(n-6) + 370\,a(n-7) - 768\,a(n-8) + 889\,a(n-9) - 476\,a(n-10) + 126\,a(n-11) - 17\,a(n-12) + a(n-13)
\]
for every $n>13$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221230.
