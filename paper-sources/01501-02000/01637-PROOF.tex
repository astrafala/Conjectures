...
\title{The empirical recurrence for OEIS A200872, proved from an exact model}
...
\begin{abstract}
OEIS A200872 carries an empirical recurrence of order $5$. It is true, and it is
...
OEIS A200872 is ``Number of 0..n arrays x(0..3) of 4 elements without any interior element greater than both neighbors or less than both neighbors.''. It has offset $1$ and begins
\[
10, 37, 94, 195, 356, 595, 932, 1389,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (1/12)*n\^{}4 + (3/2)*n\^{}3 + (47/12)*n\^{}2 + (7/2)*n + 1. a(n) = 5*a(n-1) - 10*a(n-2) + 10*a(n-3) - 5*a(n-4) + a(n-5) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 16 2017 12:22:22, revision 10)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A200872.
