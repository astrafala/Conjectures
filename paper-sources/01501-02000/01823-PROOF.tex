...
\begin{quote}
Empirical: a(n) = (1/12)*n\^{}8 + (1487/1260)*n\^{}7 + (4757/720)*n\^{}6 + (13757/720)*n\^{}5 + (4519/144)*n\^{}4 + (21611/720)*n\^{}3 + (2957/180)*n\^{}2 + (2183/420)*n + 1. a(n) = 9*a(n-1) - 36*a(n-2) + 84*a(n-3) - 126*a(n-4) + 126*a(n-5) - 84*a(n-6) + 36*a(n-7) - 9*a(n-8) + a(n-9) for n>10.
\end{quote}
