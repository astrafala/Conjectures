...
\title{The empirical recurrence for OEIS A240790, proved by transfer matrix}
...
\begin{abstract}
OEIS A240790 counts arrays over $\{0,1,2,3\}$ in which no entry may equal, modulo $4$, a given
constant plus the SUM of all the entries lying before it along one of several rays. The entry
carries an empirical recurrence of order $76$ contributed by R.~H.~Hardin. It is true, and
...
count is then a walk count on $S=337$ states.
\end{abstract}
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 30 2014 05:03:57, revision 8) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=337.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A240790.
