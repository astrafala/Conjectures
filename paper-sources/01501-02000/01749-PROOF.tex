...
\title{The empirical recurrence for OEIS A200844, proved from an exact model}
...
\begin{abstract}
OEIS A200844 carries an empirical recurrence of order $10$. It is true, and it is
...
OEIS A200844 is ``Number of 0..n arrays x(0..8) of 9 elements without any two consecutive increases or two consecutive decreases.''. It has offset $1$ and begins
\[
512, 11235, 99700, 552247, 2276028, 7642875, 22063924, 56687801,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (124/2835)*n\^{}9 + (1123/1120)*n\^{}8 + (244/27)*n\^{}7 + (1991/48)*n\^{}6 + (57133/540)*n\^{}5 + (74183/480)*n\^{}4 + (291427/2268)*n\^{}3 + (9739/168)*n\^{}2 + (568/45)*n + 1. a(n) = 10*a(n-1) - 45*a(n-2) + 120*a(n-3) - 210*a(n-4) + 252*a(n-5) - 210*a(n-6) + 120*a(n-7) - 45*a(n-8) + 10*a(n-9) - a(n-10) for n > 10.
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 15 2017 01:12:00, revision 11)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A200844.
