...
\title{The empirical recurrence for OEIS A217341, proved by transfer matrix}
...
\begin{abstract}
OEIS A217341 counts the distinct OCCUPANCY arrays obtained when every cell of an $n\times3$ grid
...
determinising the machine that emits the occupancy row by row turns it into one, on $S=340$
...
OEIS A217341 is ``Number of nX3 arrays of occupancy after each element moves to some horizontal or vertical neighbor but without 2-loops.''. It has offset $1$ and begins
\[
0, 7, 144, 2389, 37114, 561573, 8399702, 124988061,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 17:23:41, revision 8) this is still
...
\]
There are $S=340$ reachable sets. In particular $a$ is $C$-finite.
...
\begin{theorem}
\[
a(n)\;=\;23\,a(n-1) - 125\,a(n-2) + 13\,a(n-3) + 648\,a(n-4) - 208\,a(n-5) - 1279\,a(n-6) + 327\,a(n-7) + 1739\,a(n-8) - 1293\,a(n-9) + 138\,a(n-10) + 130\,a(n-11) + 8\,a(n-12)
\]
for every $n>12$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A217341.
