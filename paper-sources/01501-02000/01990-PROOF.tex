...
\title{The empirical closed form for OEIS A224053, proved}
...
\begin{abstract}
OEIS A224053 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A224053 is ``Number of n X 4 0..2 arrays with rows and columns unimodal and antidiagonals nondecreasing.''. It has offset $1$ and begins
\[
46, 698, 5219, 27246, 115716, 428949, 1442005, 4492529,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 15 2023 11:21:10, revision 6) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{n^{16}}{106748928000} + \frac{n^{15}}{2668723200} + \frac{29 n^{14}}{2335132800} + \frac{9677 n^{13}}{37362124800} + \frac{129359 n^{12}}{28740096000} + \frac{171629 n^{11}}{2874009600} + \frac{12139 n^{10}}{18662400} + \frac{195851 n^{9}}{37324800} + \frac{231935077 n^{8}}{5225472000} + \frac{74110763 n^{7}}{261273600} + \frac{324341569 n^{6}}{179625600} + \frac{4052978161 n^{5}}{718502400} + \frac{3589053277 n^{4}}{247104000} - \frac{12388141 n^{3}}{741312} + \frac{87129737 n^{2}}{1029600} + \frac{364945 n}{2574} - 457.
\]
...
$n=21,\dots,37$ and agree at each. A monic recurrence of order $17$
determines $a(m)$ from $a(m-1),\dots,a(m-17)$, and for every $m\ge38$ both
$m>20$ and $m-17\ge21$ hold, so induction on $m$ gives $a(m)=f(m)$ for every
$m\ge21$.
Below $n=21$ the recurrence argument gives nothing, since \eqref{eq:rec} is only
established for $a$ from $n=21$ on. The remaining indices $n=4,\dots,20$ were
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224053.
