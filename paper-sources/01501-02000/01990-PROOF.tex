...
\title{The empirical recurrence for OEIS A200841, proved from an exact model}
...
\begin{abstract}
OEIS A200841 carries an empirical recurrence of order $7$. It is true, and it is
...
OEIS A200841 is ``Number of 0..n arrays x(0..5) of 6 elements without any two consecutive increases or two consecutive decreases.''. It has offset $1$ and begins
\[
64, 529, 2356, 7587, 19930, 45465, 93472, 177381,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (61/360)*n\^{}6 + (93/40)*n\^{}5 + (779/72)*n\^{}4 + (521/24)*n\^{}3 + (1801/90)*n\^{}2 + (239/30)*n + 1. a(n) = 7*a(n-1) - 21*a(n-2) + 35*a(n-3) - 35*a(n-4) + 21*a(n-5) - 7*a(n-6) + a(n-7) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 08:49:25, revision 11)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A200841.
