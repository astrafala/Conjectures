...
\title{The empirical recurrence for OEIS A200790, proved from an exact model}
...
\begin{abstract}
OEIS A200790 carries an empirical recurrence of order $9$. It is true, and it is
...
OEIS A200790 is ``Number of 0..n arrays x(0..7) of 8 elements without any two consecutive increases.''. It has offset $1$ and begins
\[
256, 5157, 43681, 232275, 919413, 2964416, 8216484, 20273247,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (6679/20160)*n\^{}8 + (4799/1260)*n\^{}7 + (26449/1440)*n\^{}6 + (2162/45)*n\^{}5 + (212153/2880)*n\^{}4 + (6019/90)*n\^{}3 + (174571/5040)*n\^{}2 + (3893/420)*n + 1. a(n) = 9*a(n-1) - 36*a(n-2) + 84*a(n-3) - 126*a(n-4) + 126*a(n-5) - 84*a(n-6) + 36*a(n-7) - 9*a(n-8) + a(n-9) for n>9.
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 15 2017 20:28:24, revision 12)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A200790.
