...
\title{The empirical recurrence for OEIS A202079, proved from an exact model}
...
\begin{abstract}
OEIS A202079 carries an empirical recurrence of order $8$. It is true, and it is
...
OEIS A202079 is ``Number of arrays of 8 integers in -n..n with sum zero and the sum of every adjacent pair being odd.''. It has offset $1$ and begins
\[
12, 524, 5832, 34632, 142692, 462436, 1264272, 3044496,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 8*a(n-1) -28*a(n-2) +56*a(n-3) -70*a(n-4) +56*a(n-5) -28*a(n-6) +8*a(n-7) -a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (May 27 2018 06:56:57, revision 9)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A202079.
