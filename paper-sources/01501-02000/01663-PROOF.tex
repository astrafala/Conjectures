...
\title{The empirical recurrence for OEIS A268627, proved by transfer matrix}
...
\begin{abstract}
OEIS A268627 counts arrays of width $7$ over $\{0,1,2\}$ in which the number of adjacent PAIRS of
...
OEIS A268627 is ``Number of nX7 0..2 arrays with some element plus some horizontally or vertically adjacent neighbor totalling two no more than once.''. It has offset $1$ and begins
\[
768, 29646, 982086, 30553014, 915847266, 26758514760, 767057092212, 21665715966234,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 09 2016 09:24:08, revision 4) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268627.
