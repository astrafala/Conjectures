...
\title{The empirical recurrence for OEIS A264677, proved by transfer matrix}
...
\begin{abstract}
OEIS A264677 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=3$ columns in which
...
OEIS A264677 is ``Number of (2+1) X (n+1) arrays of permutations of 0..n*3+2 with each element having directed index change -1,-1 1,0 -1,-2 -2,-2 or 0,1.''. It has offset $1$ and begins
\[
1, 2, 10, 29, 75, 201, 588, 1700,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) - 3*a(n-2) + 5*a(n-3) + 7*a(n-4) - 5*a(n-5) + 7*a(n-6) - 3*a(n-7) + a(n-8) - a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 08 2019 15:19:14, revision 7) this is still
...
\[
(i-h_i,\,j-h_j)\;\in\;\{(-2,-2),\ (-2,-1),\ (-1,-1),\ (0,1),\ (1,0)\},
\]
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) - 3\,a(n-2) + 5\,a(n-3) + 7\,a(n-4) - 5\,a(n-5) + 7\,a(n-6) - 3\,a(n-7) + a(n-8) - a(n-9)
\]
for every $n>9$.
\end{theorem}
...
Second, the transfer model reproduces all $27$ terms this entry publishes, exactly, in
integer arithmetic.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264677.
