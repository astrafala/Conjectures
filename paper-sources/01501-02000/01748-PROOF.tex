...
\title{The empirical recurrence for OEIS A214169, proved by transfer matrix}
...
\begin{abstract}
OEIS A214169 counts the proper colourings of a grid $3\times(n+1)$, wrapped in the growing direction, with at most $6$ colours and
counted up to renaming the colours, and carries an empirical recurrence of order $22$
...
down to $S=558$ and makes the exact residual test affordable.
\end{abstract}
...
OEIS A214169 is ``Number of 0..5 colorings of a 3X(n+1) array circular in the n+1 direction with new values 0..5 introduced in row major order.''. It has offset $1$ and begins
\[
34, 902, 88261, 7386816, 655418810, 57661437162, 5087962926669, 448703414185598,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 16:54:56, revision 8) this is still
...
state count is $S=558$ rather than the number of colourings.
...
\begin{theorem}
\[
a(n)\;=\;67\,a(n-1) + 2324\,a(n-2) - 31516\,a(n-3) - 823431\,a(n-4) + 5444061\,a(n-5) + 84228790\,a(n-6) - 593193810\,a(n-7) - 2829906471\,a(n-8) + 29361035421\,a(n-9) - 5920653848\,a(n-10) - 514810627672\,a(n-11) + 1189252868407\,a(n-12) + 2543264898611\,a(n-13) - 12441462957938\,a(n-14) + 7044950862694\,a(n-15) + 29864975550776\,a(n-16) - 43278546127280\,a(n-17) - 9805436044288\,a(n-18) + 45301498197024\,a(n-19) - 13250017912320\,a(n-20) - 11125130457600\,a(n-21) + 4451355648000\,a(n-22)
\]
for every $n>21$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A214169.
