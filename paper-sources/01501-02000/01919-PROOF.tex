...
\title{The empirical recurrence for OEIS A268771, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A268771 counts arrays over $\{0,\dots,2\}$ subject to a condition on the array as a
...
OEIS A268771 is ``Number of nX5 0..2 arrays with some element plus some horizontally, vertically, diagonally or antidiagonally adjacent neighbor totalling two exactly once.''. It has offset $1$ and begins
\[
96, 248, 1524, 10340, 64112, 387146, 2258084, 12951796,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 13 2016 08:25:56, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) + 28\,a(n-2) - 62\,a(n-3) - 314\,a(n-4) + 78\,a(n-5) + 867\,a(n-6) + 6\,a(n-7) - 859\,a(n-8) + 46\,a(n-9) + 215\,a(n-10) - 8\,a(n-11) - 16\,a(n-12)
\end{equation}
for all $n>14$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268771.
