...
\title{The empirical closed form for OEIS A219700, proved}
...
\begin{abstract}
OEIS A219700 states an explicit closed form for $a(n)$ and records it as empirical. It is true, and
...
OEIS A219700 is ``Number of n X 4 arrays of the minimum value of corresponding elements and their horizontal, vertical or antidiagonal neighbors in a random, but sorted with lexicographically nondecreasing rows and columns, 0..1 n X 4 array.''. It has offset $1$ and begins
\[
4, 7, 25, 64, 158, 374, 841, 1789,\ \dots
\]
and states:
\begin{quote}
Empirical: a(n) = (1/20160)*n\^{}8 - (1/1680)*n\^{}7 + (1/160)*n\^{}6 + (5/48)*n\^{}5 - (2431/960)*n\^{}4 + (1173/40)*n\^{}3 - (874309/5040)*n\^{}2 + (3728/7)*n - 647 for n>4.
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 27 2018 06:11:54, revision 8)
...
\begin{theorem}
The closed form OEIS A219700 records is correct for all $n>4$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A219700.
