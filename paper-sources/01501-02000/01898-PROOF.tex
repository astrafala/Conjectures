...
\begin{quote}
Empirical: a(n) = (5887/180)*n\^{}6 - (5813/60)*n\^{}5 + (6083/36)*n\^{}4 - (2191/12)*n\^{}3 + (9119/90)*n\^{}2 - (353/15)*n. a(n) = 7*a(n-1) - 21*a(n-2) + 35*a(n-3) - 35*a(n-4) + 21*a(n-5) - 7*a(n-6) + a(n-7) for n>7.
\end{quote}
