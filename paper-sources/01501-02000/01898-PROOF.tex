...
\title{The empirical recurrence for OEIS A200155, proved from an exact model}
...
\begin{abstract}
OEIS A200155 carries an empirical recurrence of order $8$. It is true, and it is
...
OEIS A200155 is ``Number of 0..n arrays x(0..3) of 4 elements with zero 3rd differences.''. It has offset $1$ and begins
\[
4, 9, 22, 41, 66, 107, 158, 219,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) - a(n-2) + 2*a(n-3) - 4*a(n-4) + 2*a(n-5) - a(n-6) + 2*a(n-7) - a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 02 2018 14:13:48, revision 14)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A200155.
