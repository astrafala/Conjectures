...
\title{The empirical recurrence for OEIS A279978, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A279978 imposes three things at once: a condition on each cell that reaches one column up and
...
OEIS A279978 is ``Number of 2 X n 0..1 arrays with no element equal to a strict majority of its horizontal and antidiagonal neighbors, with the exception of exactly two elements, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
0, 3, 9, 24, 62, 134, 277, 542,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 5*a(n-1) - 7*a(n-2) - 2*a(n-3) + 10*a(n-4) - 2*a(n-5) - 5*a(n-6) + a(n-7) + a(n-8) for n>10.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 12 2019 12:16:05, revision 7) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A279978.
