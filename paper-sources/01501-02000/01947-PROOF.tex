...
\title{The empirical recurrence for OEIS A221110, proved by transfer matrix}
...
\begin{abstract}
OEIS A221110 counts the distinct OCCUPANCY arrays obtained when every cell of an $n\times4$ grid
...
OEIS A221110 is ``Number of n X 4 arrays of occupancy after each element moves to some horizontal or antidiagonal neighbor, without 2-loops.''. It has offset $1$ and begins
\[
0, 7, 178, 3706, 73267, 1424745, 27551817, 531785885,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 29*a(n-1) - 210*a(n-2) + 451*a(n-3) - 288*a(n-4) + 20*a(n-5) - a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 03 2018 16:28:36, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;29\,a(n-1) - 210\,a(n-2) + 451\,a(n-3) - 288\,a(n-4) + 20\,a(n-5) - a(n-6)
\]
for every $n>6$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221110.
