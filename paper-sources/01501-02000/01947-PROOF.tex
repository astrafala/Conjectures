...
\title{The empirical recurrence for OEIS A248538, proved from an exact model}
...
\begin{abstract}
OEIS A248538 carries an empirical recurrence of order $7$. It is true, and it is
...
OEIS A248538 is ``Number of length 1+3 0..n arrays with every four consecutive terms having the sum of some three elements equal to three times the fourth.''. It has offset $1$ and begins
\[
2, 15, 52, 101, 198, 331, 512, 753,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) - a(n-3) - a(n-4) + 2*a(n-6) - a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 08 2018 19:32:53, revision 8)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A248538.
