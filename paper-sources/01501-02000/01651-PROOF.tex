...
\title{The empirical recurrence for OEIS A208948, proved from an exact model}
...
\begin{abstract}
OEIS A208948 carries an empirical recurrence of order $8$. It is true, and it is
...
OEIS A208948 is ``Number of 6-bead necklaces labeled with numbers -n..n not allowing reversal, with sum zero with no three beads in a row equal.''. It has offset $1$ and begins
\[
20, 264, 1464, 5238, 14430, 33468, 68722, 128844,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 5*a(n-1) - 10*a(n-2) + 11*a(n-3) - 10*a(n-4) + 11*a(n-5) - 10*a(n-6) + 5*a(n-7) - a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 07 2018 08:51:10, revision 12)
...
$S=49$, which includes the pre-period $n_0=0$ the conditions with an offset need. The
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) - 10\,a(n-2) + 11\,a(n-3) - 10\,a(n-4) + 11\,a(n-5) - 10\,a(n-6) + 5\,a(n-7) - a(n-8)
\]
for every $n>0$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208948.
