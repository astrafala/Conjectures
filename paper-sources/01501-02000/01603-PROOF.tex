...
\title{The empirical recurrence for OEIS A281565, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A281565 imposes three things at once: a condition on each cell that reaches one column up and
...
OEIS A281565 is ``Number of 3Xn 0..1 arrays with no element equal to more than two of its horizontal, diagonal or antidiagonal neighbors, with the exception of exactly two elements, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
0, 1, 68, 621, 2426, 6955, 16656, 36578,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 24 2017 08:38:12, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) - 15\,a(n-2) + 26\,a(n-3) - 45\,a(n-4) + 66\,a(n-5) - 73\,a(n-6) + 78\,a(n-7) - 78\,a(n-8) + 56\,a(n-9) - 36\,a(n-10) + 24\,a(n-11) - 8\,a(n-12)
\end{equation}
for all $n>20$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A281565.
