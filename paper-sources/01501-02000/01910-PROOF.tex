...
\begin{quote}
Empirical: a(n) = (11/7)*n\^{}7 + 13*n\^{}6 + (67/2)*n\^{}5 + (97/2)*n\^{}4 + (103/2)*n\^{}3 + 34*n\^{}2 + (139/14)*n + 1. a(n) = 8*a(n-1) - 28*a(n-2) + 56*a(n-3) - 70*a(n-4) + 56*a(n-5) - 28*a(n-6) + 8*a(n-7) - a(n-8) for n>8.
\end{quote}
