...
\title{The empirical recurrence for OEIS A204374, proved by transfer matrix}
...
\begin{abstract}
OEIS A204374 counts $(n+2)\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A204374 is ``Number of (n+2)X3 0..1 arrays with every 3X3 subblock having three equal elements in a row horizontally, vertically or nw-to-se diagonally exactly three ways, and new values 0..1 introduced in row major order.''. It has offset $1$ and begins
\[
33, 51, 78, 113, 182, 286, 439, 710,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 11:10:50, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) - 2\,a(n-2) - 2\,a(n-4) + 2\,a(n-5) + 3\,a(n-6) - 6\,a(n-7) + 3\,a(n-8) - a(n-11) + 2\,a(n-12) - a(n-13) - a(n-14) + 2\,a(n-15) - a(n-16)
\]
for every $n>16$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204374.
