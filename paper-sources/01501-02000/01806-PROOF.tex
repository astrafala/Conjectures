...
\title{The empirical recurrence for OEIS A281654, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A281654 imposes three things at once: a condition on each cell that reaches one column up and
...
OEIS A281654 is ``Number of 2 X n 0..2 arrays with no element equal to more than one of its horizontal, diagonal or antidiagonal neighbors, with the exception of exactly one element, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
0, 4, 70, 400, 2128, 10512, 49352, 225024,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 8*a(n-1) - 20*a(n-2) + 32*a(n-3) - 84*a(n-4) + 96*a(n-5) - 96*a(n-6) + 128*a(n-7) - 64*a(n-8) for n>9.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 20 2019 05:30:29, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;8\,a(n-1) - 20\,a(n-2) + 32\,a(n-3) - 84\,a(n-4) + 96\,a(n-5) - 96\,a(n-6) + 128\,a(n-7) - 64\,a(n-8)
\end{equation}
for all $n>9$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A281654.
