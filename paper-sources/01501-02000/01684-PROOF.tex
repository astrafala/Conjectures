...
\title{The empirical recurrence for OEIS A248463, proved from an exact model}
...
\begin{abstract}
OEIS A248463 carries an empirical recurrence of order $11$. It is true, and it is
...
OEIS A248463 is ``Number of length 2+2 0..n arrays with no three consecutive terms having the sum of any two elements equal to twice the third.''. It has offset $1$ and begins
\[
10, 36, 148, 380, 862, 1652, 2956, 4860,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) - a(n-3) - 2*a(n-5) + 2*a(n-6) + a(n-8) - 2*a(n-10) + a(n-11).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 08 2018 19:09:09, revision 8)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A248463.
