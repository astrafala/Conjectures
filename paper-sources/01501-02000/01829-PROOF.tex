...
\title{The empirical recurrence for OEIS A221732, proved by transfer matrix}
...
\begin{abstract}
OEIS A221732 counts the distinct OCCUPANCY arrays obtained when every cell of an $n\times3$ grid
...
one, on $S=206$ states, after which the conjectured recurrence is settled by a finite exact
computation.
\end{abstract}
...
OEIS A221732 is ``Number of n X 3 arrays of occupancy after each element stays put or moves to some horizontal or antidiagonal neighbor, without move-in move-out left turns.''. It has offset $1$ and begins
\[
8, 152, 2904, 54888, 1038128, 19634240, 371344456, 7023277960,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 18*a(n-1) + 17*a(n-2) + 6*a(n-3) - 17*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2018 17:33:41, revision 8) this is still
...
$S=206$ reachable sets. In particular $a$ is $C$-finite.
...
\begin{theorem}
\[
a(n)\;=\;18\,a(n-1) + 17\,a(n-2) + 6\,a(n-3) - 17\,a(n-4)
\]
for every $n>4$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221732.
