...
\begin{quote}
Empirical: a(n) = (293/1260)*n\^{}7 + (691/360)*n\^{}6 + (2443/360)*n\^{}5 + (121/9)*n\^{}4 + (5857/360)*n\^{}3 + (4369/360)*n\^{}2 + (2189/420)*n + 1. a(n) = 8*a(n-1) - 28*a(n-2) + 56*a(n-3) - 70*a(n-4) + 56*a(n-5) - 28*a(n-6) + 8*a(n-7) - a(n-8) for n>8.
\end{quote}
