...
\title{The empirical recurrence for OEIS A199837, proved from an exact model}
...
\begin{abstract}
OEIS A199837 carries an empirical recurrence of order $8$. It is true, and it is
...
\begin{quote}
Empirical: a(n) = (19328/315)*n\^{}7 - (1424/45)*n\^{}6 + (704/45)*n\^{}5 - (112/9)*n\^{}4 - (124/45)*n\^{}3 + (229/45)*n\^{}2 - (131/105)*n. a(n) = 8*a(n-1) - 28*a(n-2) + 56*a(n-3) - 70*a(n-4) + 56*a(n-5) - 28*a(n-6) + 8*a(n-7) - a(n-8) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (May 16 2018 11:19:31, revision 8)
