...
\title{The empirical recurrence for OEIS A228981, proved by transfer matrix}
...
\begin{abstract}
OEIS A228981 counts the distinct arrays obtained by applying a fixed local operation to every cell
...
$S=43$ states, after which the conjectured recurrence is settled by a finite exact
computation.
\end{abstract}
...
OEIS A228981 is ``Number of nX3 0..1 arrays of the median of the corresponding element, the element to the east and the element to the south in a larger (n+1)X4 0..1 array.''. It has offset $1$ and begins
\[
8, 64, 512, 3928, 29808, 224720, 1690048, 12696384,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 13 2013 21:19:26, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

Let $R$ be the set of rows of length $4$ over $\{0,\dots,1\}$.
...
\]
There are $S=43$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite.
...
\begin{theorem}
\[
a(n)\;=\;12\,a(n-1) - 34\,a(n-2) - 16\,a(n-3) + 152\,a(n-4) - 116\,a(n-5) - 88\,a(n-6) + 136\,a(n-7) - 172\,a(n-8) + 168\,a(n-9) - 40\,a(n-10) + 32\,a(n-11)
\]
for every $n>11$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A228981.
