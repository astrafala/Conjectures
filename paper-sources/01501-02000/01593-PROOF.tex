...
\title{The empirical recurrence for OEIS A246000, proved from an exact model}
...
\begin{abstract}
OEIS A246000 carries an empirical recurrence of order $13$. It is true, and it is
...
OEIS A246000 is ``Number of length 5+2 0..n arrays with no pair in any consecutive three terms totalling exactly n.''. It has offset $1$ and begins
\[
2, 38, 956, 7132, 40590, 153906, 496088, 1319480,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 11:31:07, revision 6)
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + 2\,a(n-2) - 14\,a(n-3) + 5\,a(n-4) + 25\,a(n-5) - 20\,a(n-6) - 20\,a(n-7) + 25\,a(n-8) + 5\,a(n-9) - 14\,a(n-10) + 2\,a(n-11) + 3\,a(n-12) - a(n-13)
\]
for every $n>0$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A246000.
