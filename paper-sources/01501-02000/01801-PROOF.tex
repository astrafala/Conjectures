...
\title{The empirical recurrence for OEIS A254704, proved from an exact model}
...
\begin{abstract}
OEIS A254704 carries an empirical recurrence of order $8$. It is true, and it is
...
\begin{quote}
Empirical: a(n) = (73/35)*n\^{}7 + 19*n\^{}6 + 52*n\^{}5 + 60*n\^{}4 + (377/10)*n\^{}3 + 26*n\^{}2 + (199/14)*n + 1. a(n) = 8*a(n-1) - 28*a(n-2) + 56*a(n-3) - 70*a(n-4) + 56*a(n-5) - 28*a(n-6) + 8*a(n-7) - a(n-8) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 17 2018 15:24:52, revision 8)
