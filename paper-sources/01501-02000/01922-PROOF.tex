...
\title{The empirical recurrence for OEIS A218059, proved by transfer matrix}
...
\begin{abstract}
OEIS A218059 counts the distinct arrays obtained by applying a fixed local operation to every cell
of an array over a bounded alphabet, and carries an empirical recurrence of order $3$
...
$S=13$ states, after which the conjectured recurrence is settled by a finite exact
computation.
\end{abstract}
...
OEIS A218059 is ``Number of n X 3 arrays of the minimum value of corresponding elements and their horizontal or antidiagonal neighbors in a random 0..1 n X 3 array.''. It has offset $1$ and begins
\[
4, 18, 74, 308, 1282, 5338, 22228, 92562,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 5*a(n-1) - 3*a(n-2) - 2*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 09 2018 19:33:03, revision 7) this is still
...
\]
There are $S=13$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A218059.
