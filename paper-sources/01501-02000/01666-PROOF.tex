...
\title{The empirical recurrence for OEIS A189646, proved by transfer matrix}
...
\begin{abstract}
OEIS A189646 counts the permutations of the cells of an $n\times5$ array in which every cell
...
That makes $a$ a walk count on $S=406$ states, hence $C$-finite, and whether the published
...
OEIS A189646 is ``Number of nX5 array permutations with each element moving zero or one space horizontally, diagonally or antidiagonally.''. It has offset $1$ and begins
\[
8, 913, 55440, 3774889, 250758892, 16718653553, 1113666564608, 74192202677913,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 05:22:37, revision 9) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=406,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A189646.
