...
\title{The empirical recurrence for OEIS A229314, proved by transfer matrix}
...
\begin{abstract}
OEIS A229314 counts the distinct arrays obtained by applying a fixed local operation to every cell
...
OEIS A229314 is ``Number of n X 1 0..3 arrays of the median of the corresponding element, the element to the east and the element to the south in a larger (n+1) X 2 0..3 array without adjacent equal elements in the latter.''. It has offset $1$ and begins
\[
4, 14, 50, 176, 622, 2196, 7756, 27390,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) + 2*a(n-2) - a(n-3) + 2*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 14 2018 12:14:29, revision 9) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

Let $R$ be the set of rows of length $2$ over $\{0,\dots,3\}$ and no two adjacent entries of the larger array are equal.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A229314.
