...
\title{The empirical recurrence for OEIS A183905, proved from an exact model}
...
\begin{abstract}
OEIS A183905 carries an empirical recurrence of order $3$. It is true, and it is
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 05 2018 12:04:57, revision 12)
