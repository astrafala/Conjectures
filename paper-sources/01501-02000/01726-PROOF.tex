...
\title{The empirical recurrence for OEIS A204956, proved by transfer matrix}
...
\begin{abstract}
OEIS A204956 counts arrays of width $3$ over $\{0,1\}$ by reducing every $2\times2$ subblock to a
...
OEIS A204956 is ``Number of (n+1)X3 0..1 arrays with rows and columns of permanents of all 2X2 subblocks lexicographically nondecreasing.''. It has offset $1$ and begins
\[
51, 277, 1436, 6921, 32468, 147434, 659392, 2907273,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 11:37:49, revision 9) this is still
...
\]
the permanent. An array with $R$ rows and $3$ columns has $(R-1)\times2$ subblocks, and they
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-1) + 6\,a(n-2) - 121\,a(n-3) + 60\,a(n-4) + 899\,a(n-5) - 794\,a(n-6) - 3741\,a(n-7) + 3822\,a(n-8) + 9513\,a(n-9) - 10198\,a(n-10) - 15151\,a(n-11) + 16736\,a(n-12) + 14873\,a(n-13) - 17358\,a(n-14) - 8327\,a(n-15) + 11131\,a(n-16) + 1988\,a(n-17) - 4040\,a(n-18) + 204\,a(n-19) + 636\,a(n-20) - 144\,a(n-21)
\]
for every $n>19$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204956.
