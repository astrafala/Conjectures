...
\begin{quote}
Empirical: a(n) = (1/40320)*n\^{}8 + (13/10080)*n\^{}7 + (83/2880)*n\^{}6 + (13/36)*n\^{}5 + (15967/5760)*n\^{}4 - (45839/1440)*n\^{}3 + (59583/1120)*n\^{}2 + (20743/168)*n - 297 for n>3. a(n) = 9*a(n-1) - 36*a(n-2) + 84*a(n-3) - 126*a(n-4) + 126*a(n-5) - 84*a(n-6) + 36*a(n-7) - 9*a(n-8) + a(n-9) for n>11.
\end{quote}
