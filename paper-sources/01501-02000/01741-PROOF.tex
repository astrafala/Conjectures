...
\title{The empirical closed form for OEIS A219515, proved}
...
\begin{abstract}
OEIS A219515 states an explicit closed form for $a(n)$ and records it as empirical. It is true, and
...
OEIS A219515 is ``Number of n X 4 arrays of the minimum value of corresponding elements and their horizontal, diagonal or antidiagonal neighbors in a random, but sorted with lexicographically nondecreasing rows and columns, 0..1 n X 4 array.''. It has offset $1$ and begins
\[
4, 5, 24, 68, 187, 465, 1090, 2430,\ \dots
\]
and states:
\begin{quote}
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 26 2018 06:37:01, revision 7)
...
\begin{theorem}
The closed form OEIS A219515 records is correct for all $n>6$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A219515.
