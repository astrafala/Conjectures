...
\title{The empirical recurrence for OEIS A221421, proved by transfer matrix}
...
\begin{abstract}
OEIS A221421 counts the distinct OCCUPANCY arrays obtained when every cell of an $n\times3$ grid
...
determinising the machine that emits the occupancy row by row turns it into one, on $S=481$
...
OEIS A221421 is ``Number of 3Xn arrays of occupancy after each element stays put or moves to some horizontal or antidiagonal neighbor, with every occupancy equal to zero or two.''. It has offset $1$ and begins
\[
0, 8, 0, 226, 0, 6798, 0, 198823,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 36*a(n-2) -200*a(n-4) -40*a(n-6) -84*a(n-8) +80*a(n-10) -20*a(n-12) +80*a(n-14) for n>20
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 19:38:37, revision 8) this is still
...
\]
There are $S=481$ reachable sets. In particular $a$ is $C$-finite.
...
\begin{theorem}
\[
a(n)\;=\;36\,a(n-2) - 200\,a(n-4) - 40\,a(n-6) - 84\,a(n-8) + 80\,a(n-10) - 20\,a(n-12) + 80\,a(n-14)
\]
for every $n>20$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221421.
