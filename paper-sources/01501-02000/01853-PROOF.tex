...
\title{The empirical recurrence for OEIS A269610, proved from an exact model}
...
\begin{abstract}
OEIS A269610 carries an empirical recurrence of order $8$. It is true, and it is
...
\begin{quote}
Empirical: a(n) = n\^{}7 + 7*n\^{}6 + 16*n\^{}5 - 12*n\^{}4 - 5*n\^{}3 + 18*n\^{}2 - 15*n + 4. a(n) = 8*a(n-1) - 28*a(n-2) + 56*a(n-3) - 70*a(n-4) + 56*a(n-5) - 28*a(n-6) + 8*a(n-7) - a(n-8) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 25 2019 06:37:59, revision 8)
