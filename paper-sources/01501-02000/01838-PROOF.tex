...
\title{The empirical recurrence for OEIS A212840, proved from an exact model}
...
\begin{abstract}
OEIS A212840 carries an empirical recurrence of order $8$. It is true, and it is
...
\begin{quote}
Empirical: a(n) = n\^{}7 + 7*n\^{}6 + 9*n\^{}5 - 15*n\^{}4 - 13*n\^{}3 + 15*n\^{}2 - 1*n - 1. a(n) = 8*a(n-1) - 28*a(n-2) + 56*a(n-3) - 70*a(n-4) + 56*a(n-5) - 28*a(n-6) + 8*a(n-7) - a(n-8) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 21 2018 10:06:45, revision 9)
