...
\title{The empirical recurrence for OEIS A185838, proved by transfer matrix}
...
\begin{abstract}
OEIS A185838 counts arrays over $\{0,\dots,2\}$ under a condition comparing a statistic of
every $2\times2$ subblock with those of its neighbours, and carries an empirical recurrence
of order $33$ contributed by R.~H.~Hardin. It is true, and it is decidable rather than
...
OEIS A185838 is ``Number of (n+1)X3 0..2 arrays with every 2X2 subblock trace equal to some horizontal or vertical neighbor 2X2 subblock trace.''. It has offset $1$ and begins
\[
171, 1773, 20097, 222003, 2506851, 28276065, 319126401, 3601102725,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 03:14:06, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;16\,a(n-1) - 81\,a(n-2) + 354\,a(n-3) - 423\,a(n-4) - 1212\,a(n-5) + 11545\,a(n-6) - 26105\,a(n-7) + 39610\,a(n-8) - 45245\,a(n-9) + 44999\,a(n-10) - 392268\,a(n-11) + 783566\,a(n-12) - 3468627\,a(n-13) + 6420741\,a(n-14) - 6371674\,a(n-15) + 3563213\,a(n-16) + 9619160\,a(n-17) - 4795228\,a(n-18) + 26611700\,a(n-19) - 73660858\,a(n-20) + 21692189\,a(n-21) - 69651145\,a(n-22) + 122552900\,a(n-23) + 38894274\,a(n-24) + 38755104\,a(n-25) - 143115104\,a(n-26) - 47053152\,a(n-27) + 38096928\,a(n-28) + 80391744\,a(n-29) - 23458176\,a(n-30) - 26341632\,a(n-31) + 12151296\,a(n-32) - 1354752\,a(n-33)
\]
for every $n>33$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A185838.
