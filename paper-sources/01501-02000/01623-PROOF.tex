...
\title{Recovering the unwritten recurrences of the table OEIS A239537}
...
\begin{abstract}
OEIS A239537 is a two-dimensional table $T(n,k)$ whose empirical recurrences are, for several of
...
OEIS A239537 is ``T(n,k)=Number of (n+1)X(k+1) 0..2 arrays with no element equal to all horizontal neighbors or unequal to all vertical neighbors, and new values 0..2 introduced in row major order.''. It is read by antidiagonals and begins
\[
1, 2, 1, 6, 2, 6, 16, 6,\ \dots
\]
The entry carries, among its empirical claims:
\begin{quote}\small
k=2: [order 10]
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 11:00:23, revision 6) these are still
...
count, a walk on $S=830$ vertices. Berlekamp--Massey on $2S=1660$ exact terms
returns a minimal recurrence of order $10$ --- the order the entry states --- with
integer coefficients
\begin{center}\small\begin{tabular}{cccccccc}
$c_{1}$ & $2$ & $c_{4}$ & $-23$ & $c_{7}$ & $40$ & $c_{10}$ & $5$ \\
$c_{2}$ & $13$ & $c_{5}$ & $-28$ & $c_{8}$ & $-9$ &  &  \\
$c_{3}$ & $-1$ & $c_{6}$ & $11$ & $c_{9}$ & $-5$ &  &  \\
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A239537.
