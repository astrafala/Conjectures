...
\title{The empirical recurrence for OEIS A267789, proved by transfer matrix}
...
\begin{abstract}
OEIS A267789 counts arrays in which the REPEATED VALUES of each row, and of each column, stand in a
...
OEIS A267789 is ``Number of 3Xn 0..1 arrays with every repeated value in every row greater than or equal to, and in every column greater than, the previous repeated value.''. It has offset $1$ and begins
\[
6, 36, 216, 1056, 5004, 22110, 94554, 391314,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 20 2016 12:31:59, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-1) - 12\,a(n-2) - 40\,a(n-3) + 80\,a(n-4) + 100\,a(n-5) - 134\,a(n-6) - 160\,a(n-7) + 8\,a(n-8) + 48\,a(n-9) + 8\,a(n-10) - 4\,a(n-11) - a(n-12)
\]
for every $n>12$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267789.
