...
\begin{quote}
Empirical: a(n) = (13/35)*n\^{}7 + (13/2)*n\^{}6 + 26*n\^{}5 + 41*n\^{}4 + (327/10)*n\^{}3 + (39/2)*n\^{}2 + (125/14)*n + 1. a(n) = 8*a(n-1) - 28*a(n-2) + 56*a(n-3) - 70*a(n-4) + 56*a(n-5) - 28*a(n-6) + 8*a(n-7) - a(n-8) for n>8.
\end{quote}
