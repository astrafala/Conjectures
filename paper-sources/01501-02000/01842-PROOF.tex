...
\title{The empirical recurrence for OEIS A250340, proved from an exact model}
...
\begin{abstract}
OEIS A250340 carries an empirical recurrence of order $9$. It is true, and it is
...
OEIS A250340 is ``Number of length 4+5 0..n arrays with every six consecutive terms having the maximum of some three terms equal to the minimum of the remaining three terms.''. It has offset $1$ and begins
\[
172, 4409, 37824, 193437, 725596, 2210213, 5794496, 13561449,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (9/140)*n\^{}8 + (27/10)*n\^{}7 + 19*n\^{}6 + 48*n\^{}5 + (1203/20)*n\^{}4 + (1189/30)*n\^{}3 + (81/14)*n\^{}2 - (13/3)*n + 1. a(n) = 9*a(n-1) - 36*a(n-2) + 84*a(n-3) - 126*a(n-4) + 126*a(n-5) - 84*a(n-6) + 36*a(n-7) - 9*a(n-8) + a(n-9) for n>9.
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 12 2018 15:39:53, revision 7)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250340.
