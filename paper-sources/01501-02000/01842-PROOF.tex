...
\title{The empirical recurrence for OEIS A200843, proved from an exact model}
...
\begin{abstract}
OEIS A200843 carries an empirical recurrence of order $9$. It is true, and it is
...
OEIS A200843 is ``Number of 0..n arrays x(0..7) of 8 elements without any two consecutive increases or two consecutive decreases.''. It has offset $1$ and begins
\[
256, 4057, 28610, 132263, 469116, 1384813, 3570086, 8291391,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (277/4032)*n\^{}8 + (1375/1008)*n\^{}7 + (4933/480)*n\^{}6 + (2723/72)*n\^{}5 + (14161/192)*n\^{}4 + (11197/144)*n\^{}3 + (216211/5040)*n\^{}2 + (929/84)*n + 1. a(n) = 9*a(n-1) - 36*a(n-2) + 84*a(n-3) - 126*a(n-4) + 126*a(n-5) - 84*a(n-6) + 36*a(n-7) - 9*a(n-8) + a(n-9) for n>9.
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 08:49:41, revision 11)
...
\]
annihilates $a$, and $S=\deg A=10$. A congruence condition modulo $m$ is counted one residue
...
exactly $\deg A$. The bound in force is therefore $zA(z)$, of order $S=10$, and
...
vanish from $n=0+1$ onwards, and the run exceeds $S+9$, which by
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A200843.
