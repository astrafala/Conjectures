...
\title{The empirical recurrence for OEIS A245952, proved from an exact model}
...
\begin{abstract}
OEIS A245952 carries an empirical recurrence of order $8$. It is true, and it is
...
OEIS A245952 is ``Number of length 2+3 0..n arrays with some pair in every consecutive four terms totalling exactly n.''. It has offset $1$ and begins
\[
26, 197, 676, 1889, 3966, 7669, 13064, 21281,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + 2*a(n-2) - 6*a(n-3) + 6*a(n-5) - 2*a(n-6) - 2*a(n-7) + a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 05 2018 11:36:15, revision 8)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A245952.
