...
\title{The empirical recurrence for OEIS A221352, proved by transfer matrix}
...
\begin{abstract}
OEIS A221352 counts the distinct OCCUPANCY arrays obtained when every cell of an $n\times2$ grid
...
determinising the machine that emits the occupancy row by row turns it into one, on $S=133$
...
OEIS A221352 is ``Number of 2 X n arrays of occupancy after each element moves to some horizontal, diagonal or antidiagonal neighbor, without 2-loops.''. It has offset $1$ and begins
\[
0, 1, 18, 148, 1164, 8824, 65932, 489456,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 11*a(n-1) -26*a(n-2) -10*a(n-3) +34*a(n-4) +14*a(n-5) -16*a(n-6) -8*a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 12 2018 15:12:14, revision 10) this is still
...
\]
There are $S=133$ reachable sets. In particular $a$ is $C$-finite.
...
\begin{theorem}
\[
a(n)\;=\;11\,a(n-1) - 26\,a(n-2) - 10\,a(n-3) + 34\,a(n-4) + 14\,a(n-5) - 16\,a(n-6) - 8\,a(n-7)
\]
for every $n>7$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221352.
