...
\title{The empirical recurrence for OEIS A221089, proved by transfer matrix}
...
\begin{abstract}
OEIS A221089 counts the distinct OCCUPANCY arrays obtained when every cell of an $n\times3$ grid
...
determinising the machine that emits the occupancy row by row turns it into one, on $S=962$
...
OEIS A221089 is ``Number of 3 X n arrays of occupancy after each element moves to some horizontal or antidiagonal neighbor.''. It has offset $1$ and begins
\[
0, 16, 270, 6889, 154440, 3538161, 80655102, 1840667409,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 24*a(n-1) - 648*a(n-3) + 729*a(n-4) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 03 2018 08:58:00, revision 7) this is still
...
\]
There are $S=962$ reachable sets. In particular $a$ is $C$-finite.
...
\begin{theorem}
\[
a(n)\;=\;24\,a(n-1) - 648\,a(n-3) + 729\,a(n-4)
\]
for every $n>7$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221089.
