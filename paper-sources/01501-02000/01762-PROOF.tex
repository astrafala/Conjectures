...
\title{The empirical recurrence for OEIS A224022, proved by transfer matrix}
...
\begin{abstract}
OEIS A224022 counts arrays over $\{0,\dots,3\}$ whose rows, columns, diagonals or
...
is a walk count on $S=5376$ vertices and the recurrence follows from a finite exact
computation.
\end{abstract}
...
OEIS A224022 is ``Number of nX6 0..3 arrays with rows nondecreasing and antidiagonals unimodal.''. It has offset $1$ and begins
\[
84, 7056, 387729, 16861106, 646270418, 23151623729, 800511624819, 27185446777503,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 23:11:10, revision 8) the statement is
...
bit vector), $|\mathcal V|=S=5376$; let $(r,f)\to(s,f')$ be an edge when placing $s$ after $r$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224022.
