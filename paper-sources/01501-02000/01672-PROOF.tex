...
\title{The empirical recurrence for OEIS A249965, proved from an exact model}
...
\begin{abstract}
OEIS A249965 carries an empirical recurrence of order $11$. It is true, and it is
...
\begin{quote}
Empirical: a(n) = n\^{}10 + (4/45)*n\^{}9 + (31/6)*n\^{}8 + (634/315)*n\^{}7 - (21/20)*n\^{}6 + (761/90)*n\^{}5 - (19/12)*n\^{}4 - (21/10)*n\^{}3 + (119/30)*n\^{}2 - (67/70)*n. a(n) = 11*a(n-1) - 55*a(n-2) + 165*a(n-3) - 330*a(n-4) + 462*a(n-5) - 462*a(n-6) + 330*a(n-7) - 165*a(n-8) + 55*a(n-9) - 11*a(n-10) + a(n-11) for n>11.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 21 2017 13:10:54, revision 8)
...
$a$ and $S=11$. Nothing is fitted and no threshold is guessed: the $N_m$ are counted, not
estimated.
