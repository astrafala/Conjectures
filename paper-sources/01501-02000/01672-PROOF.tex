...
\title{The empirical recurrence for OEIS A201043, proved from an exact model}
...
\begin{abstract}
OEIS A201043 carries an empirical recurrence of order $5$. It is true, and it is
...
OEIS A201043 is ``Number of -n..n arrays of 4 elements with adjacent element differences also in -n..n.''. It has offset $1$ and begins
\[
41, 295, 1111, 3011, 6691, 13021, 23045, 37981,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (29/4)*n\^{}4 + (29/2)*n\^{}3 + (51/4)*n\^{}2 + (11/2)*n + 1. a(n) = 5*a(n-1) - 10*a(n-2) + 10*a(n-3) - 5*a(n-4) + a(n-5) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (May 21 2018 15:05:23, revision 8)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A201043.
