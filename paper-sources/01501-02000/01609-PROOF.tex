...
\title{The empirical recurrence for OEIS A221516, proved from an exact model}
...
\begin{abstract}
OEIS A221516 carries an empirical recurrence of order $5$. It is true, and it is
...
\begin{quote}
Empirical: a(n) = 1*n\^{}4 - 1*n\^{}3 - 10*n\^{}2 + 33*n - 34 for n>3. a(n) = 5*a(n-1) - 10*a(n-2) + 10*a(n-3) - 5*a(n-4) + a(n-5) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 06 2018 05:35:41, revision 7)
