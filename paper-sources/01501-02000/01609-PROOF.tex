...
\title{The empirical recurrence for OEIS A264584, proved by transfer matrix}
...
\begin{abstract}
OEIS A264584 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=2$ columns in which
...
OEIS A264584 is ``Number of (1+1) X (n+1) arrays of permutations of 0..n*2+1 with each element having directed index change 1,0 0,-1 1,2 or -1,1.''. It has offset $1$ and begins
\[
0, 1, 0, 1, 1, 1, 3, 1,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-3) + a(n-4) + 2*a(n-5) - a(n-9) - a(n-10).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 08 2019 18:48:52, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-3) + a(n-4) + 2\,a(n-5) - a(n-9) - a(n-10)
\]
for every $n>8$.
\end{theorem}
...
Second, the transfer model reproduces all $48$ terms this entry publishes, exactly, in
integer arithmetic.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264584.
