...
\title{The empirical recurrence for OEIS A200791, proved from an exact model}
...
\begin{abstract}
OEIS A200791 carries an empirical recurrence of order $10$. It is true, and it is
...
\begin{quote}
Empirical: a(n) = (99377/362880)*n\^{}9 + (48247/13440)*n\^{}8 + (243673/12096)*n\^{}7 + (60529/960)*n\^{}6 + (2076437/17280)*n\^{}5 + (274529/1920)*n\^{}4 + (952027/9072)*n\^{}3 + (152461/3360)*n\^{}2 + (26399/2520)*n + 1. a(n) = 10*a(n-1) - 45*a(n-2) + 120*a(n-3) - 210*a(n-4) + 252*a(n-5) - 210*a(n-6) + 120*a(n-7) - 45*a(n-8) + 10*a(n-9) - a(n-10) for n>10.
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 15 2017 20:28:31, revision 10)
