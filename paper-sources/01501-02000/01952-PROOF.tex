...
\title{The empirical recurrence for OEIS A224742, proved by transfer matrix}
...
\begin{abstract}
OEIS A224742 counts the $(n+1)\times6$ matrices over $\{0,\dots,1\}$ all of whose
...
makes $a(n)$ a walk count on $S=86$ vertices, hence $C$-finite, and whether the conjectured
...
OEIS A224742 is ``Number of (n+1) X 6 0..1 matrices with each 2 X 2 permanent equal.''. It has offset $1$ and begins
\[
538, 9554, 107665, 1644874, 21910274, 316084673, 4390392346, 62260133978,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 23:36:12, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{The count is a walk count}

Call a $2\times2$ matrix over $\{0,\dots,1\}$ a \emph{window} when it is of equal permanent, and
call a $2\times6$ matrix a \emph{band} when every one of its $5$ contiguous
$2\times2$ subblocks is a window. What the entry counts is the matrices of $6$ columns
whose every $2$ consecutive rows form a band.

Take as states the $1\times6$ strips that occur as the top $1$ rows of a band,
...
\]
with $M$ the adjacency matrix on $S=86$ states. In particular $a$ is $C$-finite. The
alignment was checked against the entry's published terms rather than assumed.

There are $(1 + 1)^{6}$ strips of $1$ rows and $6$ columns, far too
many to test one by one, and they are not tested one by one. Two consecutive windows of a band
overlap in $2\times1$ entries, so a band is exactly a walk of $5$ windows in
...
\begin{theorem}
\[
a(n)\;=\;19\,a(n-1) + 7\,a(n-2) - 1516\,a(n-3) + 4721\,a(n-4) + 32621\,a(n-5) - 149676\,a(n-6) - 264873\,a(n-7) + 1850099\,a(n-8) + 416492\,a(n-9) - 11177731\,a(n-10) + 5573265\,a(n-11) + 33910965\,a(n-12) - 31589024\,a(n-13) - 47422880\,a(n-14) + 62438904\,a(n-15) + 21268656\,a(n-16) - 49177152\,a(n-17) + 6728832\,a(n-18) + 10917504\,a(n-19) - 3359232\,a(n-20)
\]
for every $n>20$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224742.
