...
\title{The empirical recurrence for OEIS A202077, proved from an exact model}
...
\begin{abstract}
OEIS A202077 carries an empirical recurrence of order $9$. It is true, and it is
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 26 2018 08:45:20, revision 12)
