...
\title{The empirical recurrence for OEIS A282155, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A282155 imposes three things at once: a condition on each cell that reaches one row up and
...
OEIS A282155 is ``Number of nX2 0..2 arrays with no element unequal to more than four of its king-move neighbors, with the exception of exactly two elements, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
0, 0, 1, 82, 1599, 20256, 217361, 2130206,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 07 2017 08:12:18, revision 5) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;21\,a(n-1) - 159\,a(n-2) + 559\,a(n-3) - 1332\,a(n-4) + 3408\,a(n-5) - 4888\,a(n-6) + 8256\,a(n-7) - 9024\,a(n-8) + 8512\,a(n-9) - 6912\,a(n-10) + 3072\,a(n-11) - 512\,a(n-12)
\end{equation}
for all $n>13$.
...
\[
3!\Bigl(a(n_0+j)-\sum_i c_i\,a(n_0+j-i)\Bigr)=\mathbf{v}^{\!\top}G^{\,j-12}w,
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A282155.
