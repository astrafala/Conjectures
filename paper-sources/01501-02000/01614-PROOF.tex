...
\title{The empirical recurrence for OEIS A230814, proved by transfer matrix}
...
\begin{abstract}
OEIS A230814 counts arrays of width $3$ over $\{0,1,2\}$ in which every cell must see, among its
...
carries an empirical recurrence of order $19$ contributed by R.~H.~Hardin. It is true, and
it is decidable rather than empirical: a cell's neighbours lie in three consecutive rows, so
the count is a walk count on $S=568$ states.
\end{abstract}
...
OEIS A230814 is ``Number of nX3 0..2 arrays x(i,j) with each element horizontally or vertically next to at least one element with value (x(i,j)+1) mod 3 and at least one element with value (x(i,j)-1) mod 3, and upper left element zero.''. It has offset $1$ and begins
\[
0, 2, 4, 12, 100, 326, 2114, 9226,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 06:02:35, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) - 2\,a(n-2) - 19\,a(n-3) - a(n-4) + 169\,a(n-5) - 607\,a(n-6) + 913\,a(n-7) - 1279\,a(n-8) + 2352\,a(n-9) - 3003\,a(n-10) + 3418\,a(n-11) - 2775\,a(n-12) + 1279\,a(n-13) - 676\,a(n-14) + 156\,a(n-15) - 4\,a(n-16) - 62\,a(n-17) + 60\,a(n-18) - 12\,a(n-19)
\]
for every $n>19$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A230814.
