...
\title{The empirical recurrence for OEIS A214111, proved by transfer matrix}
...
\begin{abstract}
OEIS A214111 counts the proper colourings of a grid $n\times8$, wrapped in the direction of width $8$, with at most $4$ colours and
...
down to $S=318$ and makes the exact residual test affordable.
\end{abstract}
...
OEIS A214111 is ``Number of 0..3 colorings on an n X 8 array circular in the 8 direction with new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
274, 241021, 214404272, 191154162535, 170522196557894, 152139337430979981, 135743316919977662412, 121115464757399493650995,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 08 2023 12:07:27, revision 6) this is still
...
A row of the array is a proper colouring of the cycle $C_{8}$, since the wrapping makes
its first and last cells adjacent, and two consecutive rows must differ in every one of the
$8$ positions. So $L_i(n)$ is the number of walks of $n-1$ steps in the digraph whose
vertices are the proper colourings of $C_{8}$ over $i$ colours and whose edges join
colourings differing everywhere:
\[
L_i(n)\;=\;\iota^{\!\top}M_i^{\,n-1}\iota ,\qquad \iota=(1,\dots,1)^{\!\top} .
\]
There are $(i-1)^{8}+(-1)^{8}(i-1)$ such colourings, which at $i=4$ is already more
...
state count is $S=318$ rather than the number of colourings.
...
\begin{theorem}
\[
a(n)\;=\;1203\,a(n-1) - 297573\,a(n-2) + 18493097\,a(n-3) - 335304937\,a(n-4) - 2841739689\,a(n-5) + 143852359466\,a(n-6) - 1534038361818\,a(n-7) + 6617547976377\,a(n-8) - 7661483975363\,a(n-9) - 26503966569309\,a(n-10) + 78166619202873\,a(n-11) - 32671121962535\,a(n-12) - 67703780939087\,a(n-13) + 56706284940528\,a(n-14) - 5556753823232\,a(n-15)
\]
for every $n>15$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A214111.
