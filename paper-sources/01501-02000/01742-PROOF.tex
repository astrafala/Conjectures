...
\title{The empirical recurrence for OEIS A201089, proved from an exact model}
...
\begin{abstract}
OEIS A201089 carries an empirical recurrence of order $7$. It is true, and it is
...
OEIS A201089 is ``Number of -n..n arrays of 4 elements with first and second differences also in -n..n.''. It has offset $1$ and begins
\[
25, 175, 651, 1759, 3899, 7581, 13405, 22085,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) -a(n-2) -5*a(n-3) +5*a(n-4) +a(n-5) -3*a(n-6) +a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 14 2018 15:00:34, revision 11)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A201089.
