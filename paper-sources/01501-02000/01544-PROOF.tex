...
\title{The empirical recurrence for OEIS A204797, proved by transfer matrix}
...
\begin{abstract}
OEIS A204797 counts arrays of width $6$ over $\{0,1\}$ by reducing every $2\times2$ subblock to a
...
about it is one bit per adjacent pair of columns, so the count is a walk count on $S=3102$
states.
\end{abstract}
...
OEIS A204797 is ``Number of (n+1)X6 0..1 arrays with rows and columns of determinants of all 2X2 subblocks lexicographically nondecreasing.''. It has offset $1$ and begins
\[
907, 18550, 270148, 4122638, 60519533, 897624021, 13302221086, 197792658833,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 11:32:07, revision 9) this is still
...
f(B)\;=\;\det B=ps-qr,
\]
the determinant. An array with $R$ rows and $6$ columns has $(R-1)\times5$ subblocks, and they
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=3102.
\]
...
\begin{theorem}
\[
a(n)\;=\;44\,a(n-1) - 709\,a(n-2) + 4178\,a(n-3) + 14975\,a(n-4) - 337072\,a(n-5) + 1417073\,a(n-6) + 2903810\,a(n-7) - 42888206\,a(n-8) + 94465992\,a(n-9) + 306179836\,a(n-10) - 1722598072\,a(n-11) + 808737736\,a(n-12) + 10623736128\,a(n-13) - 19949811840\,a(n-14) - 24870817280\,a(n-15) + 102186867072\,a(n-16) - 13317484032\,a(n-17) - 250274585600\,a(n-18) + 183648323584\,a(n-19) + 325400336384\,a(n-20) - 382504878080\,a(n-21) - 222713896960\,a(n-22) + 377006850048\,a(n-23) + 75123064832\,a(n-24) - 192002129920\,a(n-25) - 13202620416\,a(n-26) + 46758100992\,a(n-27) + 2264924160\,a(n-28) - 3623878656\,a(n-29)
\]
for every $n>40$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204797.
