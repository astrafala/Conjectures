...
\title{The empirical recurrence for OEIS A221226, proved by transfer matrix}
...
\begin{abstract}
OEIS A221226 counts the distinct OCCUPANCY arrays obtained when every cell of an $n\times2$ grid
...
determinising the machine that emits the occupancy row by row turns it into one, on $S=204$
...
OEIS A221226 is ``Number of n X 2 arrays of occupancy after each element moves to some king-move neighbor, with no occupancy greater than 2.''. It has offset $1$ and begins
\[
1, 19, 137, 1033, 7877, 60223, 460713, 3524857,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 15*a(n-1) - 71*a(n-2) + 123*a(n-3) - 78*a(n-4) + 14*a(n-5) - 12*a(n-6) + 8*a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 14 2018 08:14:41, revision 8) this is still
...
\]
There are $S=204$ reachable sets. In particular $a$ is $C$-finite.
...
\begin{theorem}
\[
a(n)\;=\;15\,a(n-1) - 71\,a(n-2) + 123\,a(n-3) - 78\,a(n-4) + 14\,a(n-5) - 12\,a(n-6) + 8\,a(n-7)
\]
for every $n>7$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221226.
