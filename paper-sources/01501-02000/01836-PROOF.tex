...
\title{The empirical closed form for OEIS A199839, proved from an exact model}
...
\begin{abstract}
OEIS A199839 carries an empirical closed form: a polynomial in $n$ of degree $9$, recorded on the
...
OEIS A199839 is ``Number of -n..n arrays x(0..9) of 10 elements with zero sum and no two neighbors summing to zero.''. It has offset $1$ and begins
\[
138, 88636, 3685550, 51077518, 389832124, 2044221894, 8281149188, 27785393300,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (124952/567)*n\^{}9 - (35524/315)*n\^{}8 + (50588/945)*n\^{}7 - (2494/45)*n\^{}6 + (13739/270)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 08:20:11, revision 12)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A199839.
