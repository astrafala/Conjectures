...
\title{The empirical recurrence for OEIS A264315, proved by transfer matrix}
...
\begin{abstract}
OEIS A264315 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=3$ columns in which
...
OEIS A264315 is ``Number of (2+1)X(n+1) arrays of permutations of 0..n*3+2 with each element having directed index change 0,0 0,1 1,0 -1,-2 or 0,2.''. It has offset $1$ and begins
\[
1, 20, 139, 735, 4103, 24153, 137703, 781453,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 11 2015 10:00:03, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + 10\,a(n-2) + 18\,a(n-3) + 72\,a(n-4) + 40\,a(n-5) - 152\,a(n-6) - 728\,a(n-7) - 400\,a(n-8) + 1008\,a(n-9) + 704\,a(n-10) + 192\,a(n-11)
\]
for every $n>11$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264315.
