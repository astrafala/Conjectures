...
\title{The empirical recurrence for OEIS A201874, proved from an exact model}
...
\begin{abstract}
OEIS A201874 carries an empirical recurrence of order $7$. It is true, and it is
...
OEIS A201874 is ``Number of zero-sum -n..n arrays of 3 elements with first and second differences also in -n..n.''. It has offset $1$ and begins
\[
3, 5, 15, 21, 27, 47, 57, 67,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) +2*a(n-3) -2*a(n-4) -a(n-6) +a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 15 2018 08:13:23, revision 10)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A201874.
