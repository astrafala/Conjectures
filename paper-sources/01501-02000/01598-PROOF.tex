...
\title{The empirical recurrence for OEIS A219058, proved by transfer matrix}
...
\begin{abstract}
OEIS A219058 counts the distinct indicator arrays obtained from the $n\times3$ arrays over
...
indicator row by row turns it into one, on $S=50$ states, after which the conjectured
...
OEIS A219058 is ``Hilltop maps: number of nX3 binary arrays indicating the locations of corresponding elements not exceeded by any horizontal, diagonal or antidiagonal neighbor in a random 0..2 nX3 array.''. It has offset $1$ and begins
\[
7, 63, 503, 4017, 32123, 256849, 2053803, 16422459,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 17:50:46, revision 8) this is still
...
\]
There are $S=50$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite. Note
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-1) + 7\,a(n-2) + 7\,a(n-3) + 3\,a(n-4) + 21\,a(n-5) + 6\,a(n-6) + 6\,a(n-7) + 3\,a(n-8) + 9\,a(n-9) - 9\,a(n-10) - 9\,a(n-11) - 9\,a(n-12) - 9\,a(n-13)
\]
for every $n>13$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A219058.
