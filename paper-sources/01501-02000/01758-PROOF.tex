...
\title{The empirical recurrence for OEIS A231126, proved by transfer matrix}
...
\begin{abstract}
OEIS A231126 counts the white-square subarrays of arrays of width $4$ over $\{0,1,2\}$ in which
...
OEIS A231126 is ``Number of (n+1) X (3+1) white-square subarrays of 0..2 arrays with no element equal to a strict majority of its diagonal and antidiagonal neighbors, with values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
6, 40, 308, 2260, 16812, 124644, 924900, 6862052,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 7*a(n-1) + 8*a(n-2) - 32*a(n-3) - 38*a(n-4) + 40*a(n-5) + 56*a(n-6) - 16*a(n-7) - 16*a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 18 2018 06:22:59, revision 7) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=197.
\]
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-1) + 8\,a(n-2) - 32\,a(n-3) - 38\,a(n-4) + 40\,a(n-5) + 56\,a(n-6) - 16\,a(n-7) - 16\,a(n-8)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231126.
