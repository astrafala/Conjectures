...
\title{The empirical recurrence for OEIS A252946, proved by transfer matrix}
...
\begin{abstract}
OEIS A252946 counts arrays of width $4$ over an alphabet of $3$ letters in which every three
...
brings the state count down to $S=266$.
\end{abstract}
...
OEIS A252946 is ``Number of (n+2)X(2+2) 0..2 arrays with every consecutive three elements in every row, column and nw-se diagonal having exactly two distinct values, and new values 0 upwards introduced in row major order.''. It has offset $1$ and begins
\[
747, 2988, 12915, 57978, 262494, 1192149, 5419521, 24648309,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:47:04, revision 6) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The array has width $4$ and entries in $\{0,1,\dots,2\}$. Four families of triples
...
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,
\]
with $S=266$ states in all. The walk index $j$ and the entry's own $n$ differ by a constant,
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) - 5\,a(n-2) - 8\,a(n-3) + 4\,a(n-4) - 7\,a(n-5) + 14\,a(n-6) + 19\,a(n-7) - 14\,a(n-8) - 12\,a(n-9) - 24\,a(n-10) - 47\,a(n-11) + 18\,a(n-12) + 31\,a(n-13) + 7\,a(n-14) + 40\,a(n-15) - 5\,a(n-16) + a(n-17) - 11\,a(n-18) - 12\,a(n-19) + 2\,a(n-20) + 5\,a(n-21) - a(n-22)
\]
for every $n>21$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252946.
