...
\title{The empirical recurrence for OEIS A229457, proved by counting defective colourings}
...
\begin{abstract}
OEIS A229457 counts the colourings of an array with $K=3$ colours that are proper except at
...
OEIS A229457 is ``Number of defective 3-colorings of an nX6 0..2 array connected horizontally and vertically with exactly one mistake and colors introduced in row-major 0..2 order.''. It has offset $1$ and begins
\[
40, 1188, 27313, 573342, 11451686, 221410052, 4182294415, 77626332302,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 25 2025 10:20:06, revision 11) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;60\,a(n-1) - 1482\,a(n-2) + 20016\,a(n-3) - 167163\,a(n-4) + 924894\,a(n-5) - 3537110\,a(n-6) + 9593166\,a(n-7) - 18693789\,a(n-8) + 26218062\,a(n-9) - 26188161\,a(n-10) + 18139608\,a(n-11) - 8262712\,a(n-12) + 2220864\,a(n-13) - 266256\,a(n-14)
\end{equation}
for all $n>15$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A229457.
