...
\title{The empirical recurrence for OEIS A188239, proved from an exact model}
...
\begin{abstract}
OEIS A188239 carries an empirical recurrence of order $13$. It is true, and it is
...
OEIS A188239 is ``Number of nondecreasing arrangements of 6 numbers in -(n+4)..(n+4) with sum zero and not more than two numbers equal.''. It has offset $1$ and begins
\[
245, 527, 1019, 1818, 3047, 4859, 7435, 10994,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) - 2*a(n-2) - a(n-3) + 2*a(n-5) - a(n-6) - a(n-7) + 2*a(n-8) - a(n-10) - 2*a(n-11) + 3*a(n-12) - a(n-13).
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 27 2018 10:29:37, revision 10)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A188239.
