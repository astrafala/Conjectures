...
\title{The empirical recurrence for OEIS A224021, proved by transfer matrix}
...
\begin{abstract}
OEIS A224021 counts arrays over $\{0,\dots,3\}$ whose rows, columns, diagonals or
...
is a walk count on $S=1792$ vertices and the recurrence follows from a finite exact
computation.
\end{abstract}
...
OEIS A224021 is ``Number of nX5 0..3 arrays with rows nondecreasing and antidiagonals unimodal.''. It has offset $1$ and begins
\[
56, 3136, 122523, 4002738, 120352359, 3491241557, 99853876444, 2841637297963,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 23:11:02, revision 8) the statement is
...
bit vector), $|\mathcal V|=S=1792$; let $(r,f)\to(s,f')$ be an edge when placing $s$ after $r$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224021.
