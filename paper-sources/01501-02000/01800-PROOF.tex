...
\title{The empirical recurrence for OEIS A269293, proved by transfer matrix}
...
\begin{abstract}
OEIS A269293 counts arrays of width $5$ over $\{0,1,2,3\}$ in which the number of adjacent PAIRS of
...
result is a walk count on $S=3073$ states.
\end{abstract}
...
OEIS A269293 is ``Number of 5Xn 0..3 arrays with some element plus some horizontally or antidiagonally adjacent neighbor totalling three no more than once.''. It has offset $1$ and begins
\[
1024, 314928, 43674876, 5306911092, 598478857956, 64538382287988, 6751724437907820, 691013309706097812,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 21 2016 09:30:28, revision 4) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=3073.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269293.
