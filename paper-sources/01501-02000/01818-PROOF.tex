...
\title{The empirical recurrence for OEIS A245998, proved from an exact model}
...
\begin{abstract}
OEIS A245998 carries an empirical recurrence of order $9$. It is true, and it is
...
OEIS A245998 is ``Number of length 3+2 0..n arrays with no pair in any consecutive three terms totalling exactly n.''. It has offset $1$ and begins
\[
2, 18, 164, 676, 2262, 5766, 13064, 25992,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) -8*a(n-3) +6*a(n-4) +6*a(n-5) -8*a(n-6) +3*a(n-8) -a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 11:31:01, revision 8)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A245998.
