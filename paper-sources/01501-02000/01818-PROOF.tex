...
\title{The empirical recurrence for OEIS A200875, proved from an exact model}
...
\begin{abstract}
OEIS A200875 carries an empirical recurrence of order $8$. It is true, and it is
...
\begin{quote}
Empirical: a(n) = (1/2520)*n\^{}7 + (17/180)*n\^{}6 + (281/180)*n\^{}5 + (64/9)*n\^{}4 + (4927/360)*n\^{}3 + (2303/180)*n\^{}2 + (604/105)*n + 1. a(n) = 8*a(n-1) - 28*a(n-2) + 56*a(n-3) - 70*a(n-4) + 56*a(n-5) - 28*a(n-6) + 8*a(n-7) - a(n-8) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 16 2017 12:22:37, revision 10)
