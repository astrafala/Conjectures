...
\title{The empirical recurrence for OEIS A250142, proved from an exact model}
...
\begin{abstract}
OEIS A250142 carries an empirical recurrence of order $6$. It is true, and it is
...
\begin{quote}
Empirical: a(n) = (13/30)*n\^{}5 + 3*n\^{}4 + (22/3)*n\^{}3 + 8*n\^{}2 + (127/30)*n + 1. a(n) = 6*a(n-1) - 15*a(n-2) + 20*a(n-3) - 15*a(n-4) + 6*a(n-5) - a(n-6) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 11 2018 18:21:48, revision 8)
