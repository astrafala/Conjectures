...
\title{The empirical recurrence for OEIS A235542, proved by transfer matrix}
...
\begin{abstract}
OEIS A235542 counts arrays of width $3$ over $\{0,1\}$ by reducing every $2\times2$ subblock to a
...
about it is one bit per adjacent pair of columns, so the count is a walk count on $S=64$
states.
\end{abstract}
...
OEIS A235542 is ``Number of (n+1)X(2+1) 0..1 arrays with the sum of each 2X2 subblock two median terms lexicographically nondecreasing rowwise and columnwise.''. It has offset $1$ and begins
\[
48, 222, 1049, 4348, 17658, 67012, 247639, 880814,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 08:37:00, revision 6) this is still
...
f(B)\;=\;v_2+v_3,
\]
the sum of the two middle entries. An array with $R$ rows and $3$ columns has $(R-1)\times2$ subblocks, and they
...
\begin{theorem}
\[
a(n)\;=\;12\,a(n-1) - 48\,a(n-2) + 26\,a(n-3) + 319\,a(n-4) - 694\,a(n-5) - 524\,a(n-6) + 2932\,a(n-7) - 875\,a(n-8) - 5880\,a(n-9) + 4552\,a(n-10) + 6378\,a(n-11) - 7363\,a(n-12) - 3518\,a(n-13) + 6068\,a(n-14) + 520\,a(n-15) - 2576\,a(n-16) + 352\,a(n-17) + 448\,a(n-18) - 128\,a(n-19)
\]
for every $n>18$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A235542.
