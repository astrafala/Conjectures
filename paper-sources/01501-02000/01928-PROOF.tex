...
\title{The empirical recurrence for OEIS A275127, proved by counting patterns}
...
\begin{abstract}
OEIS A275127 counts arrays in which no entry may repeat a value found at any of three stated
...
cutting $6818$ pairs to $S=1223$ states. The entry's empirical recurrence of order $17$,
...
OEIS A275127 is ``Number of nX4 0..2 arrays with no element equal to any value at offset (-2,-2) (-1,0) or (-1,1) and new values introduced in order 0..2.''. It has offset $1$ and begins
\[
14, 64, 174, 568, 2178, 8321, 31772, 121707,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 17 2016 10:57:51, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) - 9\,a(n-2) + 19\,a(n-3) - 9\,a(n-4) - 9\,a(n-5) + 87\,a(n-6) - 46\,a(n-7) - 84\,a(n-8) + 7\,a(n-9) - 59\,a(n-10) - 45\,a(n-11) + 31\,a(n-12) + 23\,a(n-13) + 4\,a(n-14) - a(n-15) - a(n-16) + a(n-17)
\end{equation}
for all $n>20$.
...
$o=1n_0+0-2$, we have for $j\ge17$
\[
3!\Bigl(a(n_0+j)-\sum_i c_i\,a(n_0+j-i)\Bigr)
=\mathbf{v}^{\!\top}G^{\,j-17}w,\qquad
w=h_{17}-\sum_i c_i h_{17-i} .
\]
...
the survivors by the pattern of the new pair. The vector $w$ was formed by $17$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A275127.
