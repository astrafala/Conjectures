...
\title{The empirical recurrence for OEIS A219422, proved by transfer matrix}
...
\begin{abstract}
OEIS A219422 counts the distinct indicator arrays obtained from the $n\times2$ arrays over
...
OEIS A219422 is ``Unchanging value maps: number of 2 X n binary arrays indicating the locations of corresponding elements unequal to no horizontal or antidiagonal neighbor in a random 0..2 2 X n array.''. It has offset $1$ and begins
\[
1, 7, 20, 57, 160, 454, 1292, 3676,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + a(n-2) + 3*a(n-3) + 4*a(n-4) - 2*a(n-5) - 4*a(n-6) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 26 2018 05:17:07, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A219422.
