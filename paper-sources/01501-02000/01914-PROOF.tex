...
\title{The empirical recurrence for OEIS A232253, proved by transfer matrix}
...
\begin{abstract}
OEIS A232253 counts arrays of width $5$ over $\{0,1,2\}$ in which every cell has a neighbour at least as large and one at most as large. The entry carries an
...
OEIS A232253 is ``Number of (n+1)X(4+1) 0..2 arrays with every element both >= and <= some horizontal or antidiagonal neighbor.''. It has offset $1$ and begins
\[
1287, 96999, 7258599, 544777651, 40896843985, 3070212041183, 230487644229167, 17303223331864431,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 06:57:45, revision 6) this is still
...
Thus
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=37423,
\]
...
\begin{theorem}
\[
a(n)\;=\;69\,a(n-1) + 555\,a(n-2) - 7271\,a(n-3) - 16398\,a(n-4) + 266152\,a(n-5) - 265357\,a(n-6) - 2539887\,a(n-7) - 7724280\,a(n-8) - 6811008\,a(n-9) + 16331136\,a(n-10) + 18397456\,a(n-11) - 13469384\,a(n-12) - 10822060\,a(n-13) + 6278955\,a(n-14) + 1333583\,a(n-15) - 1195787\,a(n-16) + 285229\,a(n-17) - 45161\,a(n-18) + 3471\,a(n-19) - 6\,a(n-20) - 6\,a(n-21)
\]
for every $n>21$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232253.
