...
\title{The empirical recurrence for OEIS A212839, proved from an exact model}
...
\begin{abstract}
OEIS A212839 carries an empirical recurrence of order $7$. It is true, and it is
...
OEIS A212839 is ``Number of 0..n arrays of length 6 with 0 never adjacent to n.''. It has offset $1$ and begins
\[
2, 239, 2258, 10727, 35954, 97127, 226274, 472943,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = n\^{}6 + 6*n\^{}5 + 5*n\^{}4 - 12*n\^{}3 - 3*n\^{}2 + 6*n - 1. a(n) = 7*a(n-1) - 21*a(n-2) + 35*a(n-3) - 35*a(n-4) + 21*a(n-5) - 7*a(n-6) + a(n-7) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 21 2018 10:07:30, revision 12)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A212839.
