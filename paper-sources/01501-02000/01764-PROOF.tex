...
\title{The empirical recurrence for OEIS A199531, proved from an exact model}
...
\begin{abstract}
OEIS A199531 carries an empirical recurrence of order $4$. It is true, and it is
...
OEIS A199531 is ``Number of -n..n arrays x(0..3) of 4 elements with zero sum and no two consecutive zero elements.''. It has offset $1$ and begins
\[
12, 72, 212, 464, 860, 1432, 2212, 3232,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (16/3)*n\^{}3 + 8*n\^{}2 - (4/3)*n. a(n) = 4*a(n-1) - 6*a(n-2) + 4*a(n-3) - a(n-4) for n>4.
\end{quote}
As of the ``Last modified'' line on the live entry (May 15 2018 20:43:35, revision 9)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A199531.
