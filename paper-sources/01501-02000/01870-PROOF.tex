...
\title{The empirical recurrence for OEIS A269609, proved from an exact model}
...
\begin{abstract}
OEIS A269609 carries an empirical recurrence of order $7$. It is true, and it is
...
OEIS A269609 is ``Number of length-6 0..n arrays with no repeated value differing from the previous repeated value by one or less.''. It has offset $1$ and begins
\[
12, 376, 2878, 12570, 40288, 105892, 242226, 499798,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = n\^{}6 + 6*n\^{}5 + 11*n\^{}4 - 8*n\^{}3 + n\^{}2 + 3*n - 2. a(n) = 7*a(n-1) - 21*a(n-2) + 35*a(n-3) - 35*a(n-4) + 21*a(n-5) - 7*a(n-6) + a(n-7) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 25 2019 08:28:47, revision 8)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269609.
