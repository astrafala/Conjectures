...
\title{The empirical recurrence for OEIS A198621, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A198621 counts arrays in which every cell is constrained by its neighbours on \emph{both}
...
lumpable, cutting $2275$ pairs down to $S=68$ states. The entry's empirical recurrence of
order $16$, contributed by R.~H.~Hardin, then follows from a finite exact computation.
\end{abstract}
...
OEIS A198621 is ``Number of nX2 0..5 arrays with values 0..5 introduced in row major order and each element equal to at least one horizontal or vertical neighbor.''. It has offset $1$ and begins
\[
1, 3, 14, 76, 488, 3521, 28009, 241590,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 07:56:30, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;26\,a(n-1) - 225\,a(n-2) + 616\,a(n-3) + 987\,a(n-4) - 5730\,a(n-5) - 1309\,a(n-6) + 15122\,a(n-7) + 15401\,a(n-8) - 20868\,a(n-9) - 34559\,a(n-10) - 3370\,a(n-11) + 29842\,a(n-12) + 18864\,a(n-13) - 3196\,a(n-14) - 9000\,a(n-15) - 2600\,a(n-16)
\end{equation}
for all $n>17$.
...
Assembling the $6$ lumped chains block-diagonally into $N$ of size $S=68$, with the
...
index,
\[
6!\Bigl(a(n)-\sum_i c_i\,a(n-i)\Bigr)\;=\;\mathbf{v}^{\!\top}G^{\,j-16}\,
\Bigl(h_{16}-\sum_i c_i h_{16-i}\Bigr)
\]
...
$w=h_{16}-\sum_i c_ih_{16-i}$; and it is enough to check $m=0,1,\dots,S-1$.
\end{lemma}
...
index corresponding to $n=17+1$ onwards, and the run was continued until $S+1$
...
\eqref{eq:walk2}, divided by $6!$, was evaluated at every one of the $20$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A198621.
