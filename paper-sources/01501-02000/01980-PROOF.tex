...
\title{The empirical recurrence for OEIS A263999, proved by transfer matrix}
...
\begin{abstract}
OEIS A263999 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=3$ rows in which
...
OEIS A263999 is ``Number of (n+1) X (2+1) arrays of permutations of 0..n*3+2 with each element having index change (+-,+-) 0,0 1,2 or 1,0.''. It has offset $1$ and begins
\[
18, 99, 925, 7304, 62101, 516117, 4331090, 36234055,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 5*a(n-1) +37*a(n-2) -44*a(n-3) -256*a(n-4) +64*a(n-5) +256*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 03 2019 10:37:31, revision 11) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A263999.
