...
\title{The empirical recurrence for OEIS A185564, proved by transfer matrix}
...
\begin{abstract}
OEIS A185564 counts arrays of width $6$ over $\{0,1,2,3\}$ in which no cell equals both the cell above it and the cell to its left. The entry carries an
...
$2$ consecutive rows and the count is a walk count on $S=4097$ states.
\end{abstract}
...
OEIS A185564 is ``1/4 the number of nX6 0..3 arrays with no element equal both to the element above and to the element to its left.''. It has offset $1$ and begins
\[
1024, 3037500, 8977824540, 26533211918040, 78416544382742160, 231753101877188629380, 684925618712729136913980, 2024236566241727245692157080,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 03:06:58, revision 9) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The arrays have $6$ columns and a growing number of rows, with entries in $\{0,1,2,3\}$. Fix the
...
\begin{theorem}
\[
a(n)\;=\;3176\,a(n-1) - 673550\,a(n-2) + 65136330\,a(n-3) - 3727689126\,a(n-4) + 139845804688\,a(n-5) - 3603160371660\,a(n-6) + 64834978133874\,a(n-7) - 810096692648238\,a(n-8) + 6824155175157060\,a(n-9) - 36345608355460626\,a(n-10) + 107463532615201134\,a(n-11) - 134880780658290660\,a(n-12) + 77768725332170250\,a(n-13) - 12154766339477250\,a(n-14) - 11593534218480000\,a(n-15) + 6932136333037500\,a(n-16) - 1023032228765625\,a(n-17)
\]
for every $n>17$.
\end{theorem}
...
array of width $6$ over $\{0,1,2,3\}$ with a few rows was written out cell by cell and each cell
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A185564.
