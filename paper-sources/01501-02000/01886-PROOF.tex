...
\title{The empirical recurrence for OEIS A253022, proved by transfer matrix}
...
\begin{abstract}
OEIS A253022 counts arrays of width $7$ over an alphabet of $4$ letters in which every three
...
brings the state count down to $S=6291$.
\end{abstract}
...
OEIS A253022 is ``Number of (n+2)X(5+2) 0..3 arrays with every consecutive three elements in every row and column not having exactly two distinct values, and in every diagonal and antidiagonal having exactly two distinct values, and new values 0 upwards introduced in row major order.''. It has offset $1$ and begins
\[
105, 133, 219, 230, 327, 537, 554, 753,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 5*a(n-3) -6*a(n-6) -2*a(n-9) +2*a(n-12) +3*a(n-15) +a(n-18) for n>22
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:51:48, revision 6) this is still
...
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,
\]
with $S=6291$ states in all. The walk index $j$ and the entry's own $n$ differ by a constant,
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-3) - 6\,a(n-6) - 2\,a(n-9) + 2\,a(n-12) + 3\,a(n-15) + a(n-18)
\]
for every $n>22$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253022.
