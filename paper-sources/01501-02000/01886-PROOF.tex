...
\title{The empirical recurrence for OEIS A210262, proved by transfer matrix}
...
\begin{abstract}
OEIS A210262 counts arrays of width $4$ whose every $2\times2$ subblock holds a
...
OEIS A210262 is ``Number of (n+1)X4 0..3 arrays containing all values 0..3 with every 2X2 subblock having three distinct values, and new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
400, 25901, 1409910, 74289956, 3885183814, 202860601666, 10588222391490, 552602645281386,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 15:50:26, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;63\,a(n-1) - 318\,a(n-2) - 15234\,a(n-3) + 103150\,a(n-4) + 1267432\,a(n-5) - 7283556\,a(n-6) - 49152712\,a(n-7) + 160312712\,a(n-8) + 877545008\,a(n-9) - 931302192\,a(n-10) - 5537877952\,a(n-11) + 2212548864\,a(n-12) + 14304785408\,a(n-13) - 4034892800\,a(n-14) - 15800012800\,a(n-15) + 5312643072\,a(n-16) + 6186336256\,a(n-17) - 2686451712\,a(n-18)
\]
for every $n>18$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A210262.
