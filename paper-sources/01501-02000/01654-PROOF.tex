...
\title{The empirical recurrence for OEIS A250392, proved from an exact model}
...
\begin{abstract}
OEIS A250392 carries an empirical recurrence of order $10$. It is true, and it is
...
OEIS A250392 is ``Number of length 6+3 0..n arrays with no four consecutive terms having the maximum of any two terms equal to the minimum of the remaining two terms.''. It has offset $1$ and begins
\[
6, 966, 26578, 309452, 2160160, 10755158, 42158796, 138336744,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = n\^{}9 - (7/30)*n\^{}8 + (1229/315)*n\^{}7 - (23/30)*n\^{}6 + (49/36)*n\^{}5 + (67/30)*n\^{}4 - (493/180)*n\^{}3 + (53/30)*n\^{}2 - (11/21)*n. a(n) = 10*a(n-1) - 45*a(n-2) + 120*a(n-3) - 210*a(n-4) + 252*a(n-5) - 210*a(n-6) + 120*a(n-7) - 45*a(n-8) + 10*a(n-9) - a(n-10) for n>10.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 20 2017 23:30:15, revision 10)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250392.
