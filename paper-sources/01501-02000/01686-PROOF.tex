...
\title{The empirical recurrence for OEIS A264649, proved by transfer matrix}
...
\begin{abstract}
OEIS A264649 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=3$ rows in which
...
OEIS A264649 is ``Number of (n+1) X (2+1) arrays of permutations of 0..n*3+2 with each element having directed index change 1,1 2,2 -1,0 or 0,-1.''. It has offset $1$ and begins
\[
1, 2, 4, 9, 18, 41, 84, 176,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + 2*a(n-5) - 2*a(n-6) + 4*a(n-7) - a(n-10).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 08 2019 15:11:31, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 2\,a(n-5) - 2\,a(n-6) + 4\,a(n-7) - a(n-10)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264649.
