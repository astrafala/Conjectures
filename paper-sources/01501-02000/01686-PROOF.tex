...
\title{The empirical recurrence for OEIS A188335, proved from an exact model}
...
\begin{abstract}
OEIS A188335 carries an empirical recurrence of order $11$. It is true, and it is
...
OEIS A188335 is ``Number of nondecreasing arrangements of 5 nonzero numbers in -(n+3)..(n+3) with sum zero.''. It has offset $1$ and begins
\[
40, 86, 166, 288, 472, 726, 1076, 1534,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1)-a(n-3)-2*a(n-5)+2*a(n-6)+a(n-8)-2*a(n-10)+a(n-11).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 13 2025 00:25:45, revision 14)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A188335.
