...
\title{The empirical recurrence for OEIS A252804, proved by transfer matrix}
...
\begin{abstract}
OEIS A252804 counts arrays of width $3$ over an alphabet of $5$ letters in which every three
...
OEIS A252804 is ``Number of (n+2)X(1+2) 0..4 arrays with every consecutive three elements in every row and column not having exactly two distinct values, and in every diagonal and antidiagonal having exactly two distinct values, and new values 0 upwards introduced in row major order.''. It has offset $1$ and begins
\[
61, 155, 357, 752, 1808, 4045, 8513, 19432,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:39:30, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) - 11\,a(n-2) + 14\,a(n-3) - 60\,a(n-4) + 120\,a(n-5) - 29\,a(n-6) - 16\,a(n-7) - 165\,a(n-8) - 180\,a(n-9) + 994\,a(n-10) - 952\,a(n-11) + 280\,a(n-12)
\]
for every $n>14$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252804.
