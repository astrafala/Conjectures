...
\title{The empirical recurrence for OEIS A221464, proved from an exact model}
...
\begin{abstract}
OEIS A221464 carries an empirical recurrence of order $6$. It is true, and it is
...
\begin{quote}
Empirical: a(n) = 1*n\^{}4 + 2*n\^{}3. a(n) = 6*a(n-1) - 15*a(n-2) + 20*a(n-3) - 15*a(n-4) + 6*a(n-5) - a(n-6) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 05 2018 13:47:00, revision 8)
