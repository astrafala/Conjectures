...
\title{The empirical recurrence for OEIS A205748, proved by transfer matrix}
...
\begin{abstract}
OEIS A205748 counts, up to renaming the letters, the arrays of width $4$ over at most $3$
letters in which horizontally neighbouring $2\times2$ subblocks have the same number of equal edges and vertically neighbouring ones have different numbers. It carries an empirical recurrence of order $21$ contributed by
...
OEIS A205748 is ``Number of (n+1)X4 0..2 arrays with every 2X2 subblock having the same number of equal edges as its horizontal neighbors and a different number from its vertical neighbors, and new values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
175, 1074, 8926, 63838, 507035, 3797920, 29561841, 224378004,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 12:14:34, revision 9) this is still
...
$w_i$ cleared of denominators and $S=1160$ states in all. The walk index $j$ and the entry's own
...
\begin{theorem}
\[
a(n)\;=\;54\,a(n-2) + 120\,a(n-3) - 417\,a(n-4) - 1856\,a(n-5) - 569\,a(n-6) + 11608\,a(n-7) + 19462\,a(n-8) - 37804\,a(n-9) - 97827\,a(n-10) + 69396\,a(n-11) + 253384\,a(n-12) - 49104\,a(n-13) - 366356\,a(n-14) - 46288\,a(n-15) + 244448\,a(n-16) + 127408\,a(n-17) + 41532\,a(n-18) - 58496\,a(n-19) - 119360\,a(n-20) - 44544\,a(n-21)
\]
for every $n>22$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A205748.
