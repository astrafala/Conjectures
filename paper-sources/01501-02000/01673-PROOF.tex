...
\title{The empirical recurrence for OEIS A209098, proved by counting patterns}
...
\begin{abstract}
OEIS A209098 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A209098 is ``Number of n X 6 0..2 arrays with new values 0..2 introduced in row major order and no element equal to more than one of its immediate leftward or upward or right-upward antidiagonal neighbors.''. It has offset $1$ and begins
\[
122, 24256, 5171088, 1118366188, 242632290432, 52675800891748, 11437585318270860, 2483525516352937680,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 21 2026 19:46:22, revision 11) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;300\,a(n-1) - 20582\,a(n-2) + 603924\,a(n-3) - 9449609\,a(n-4) + 91922233\,a(n-5) - 653230134\,a(n-6) + 4097861625\,a(n-7) - 24669590390\,a(n-8) + 130239438691\,a(n-9) - 543298308924\,a(n-10) + 1704347583868\,a(n-11) - 3917246807088\,a(n-12) + 6481693905844\,a(n-13) - 8041265672017\,a(n-14) + 9445340887084\,a(n-15) - 12785808828112\,a(n-16) + 12798888267640\,a(n-17) - 2070180454016\,a(n-18) - 7015258833920\,a(n-19) + 3949705789040\,a(n-20) + 2252604606848\,a(n-21) - 4177948981504\,a(n-22) + 3059510444288\,a(n-23) - 1376634560512\,a(n-24) + 343950082048\,a(n-25) - 46623096832\,a(n-26) + 4254072832\,a(n-27) - 150994944\,a(n-28)
\end{equation}
for all $n>30$.
...
For every $n$ with $m=n+0-1\ge28$,
\[
3!\Bigl(a(n)-\sum_i c_i\,a(n-i)\Bigr)\;=\;\mathbf{v}^{\!\top}N^{\,m-28}q(N)\mathbf{1} .
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209098.
