...
\title{The empirical recurrence for OEIS A200059, proved from an exact model}
...
\begin{abstract}
OEIS A200059 carries an empirical recurrence of order $11$. It is true, and it is
...
OEIS A200059 is ``Number of -n..n arrays x(0..4) of 5 elements with zero sum and elements alternately strictly increasing and strictly decreasing.''. It has offset $1$ and begins
\[
6, 68, 288, 840, 1948, 3914, 7074, 11862,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) -a(n-3) -2*a(n-5) +2*a(n-6) +a(n-8) -2*a(n-10) +a(n-11).
\end{quote}
As of the ``Last modified'' line on the live entry (May 17 2018 10:59:46, revision 8)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A200059.
