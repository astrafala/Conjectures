...
\title{The empirical recurrence for OEIS A264267, proved by transfer matrix}
...
\begin{abstract}
OEIS A264267 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=4$ rows in which
...
OEIS A264267 is ``Number of (n+1)X(3+1) arrays of permutations of 0..n*4+3 with each element having index change +-(.,.) 0,0 1,0 or 1,2.''. It has offset $1$ and begins
\[
25, 256, 3721, 50625, 707281, 9834496, 137007025, 1908029761,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 14*a(n-1) +14*a(n-2) -210*a(n-3) +210*a(n-5) -14*a(n-6) -14*a(n-7) +a(n-8)
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 10 2015 11:30:25, revision 6) this is still
...
\[
(i-h_i,\,j-h_j)\;\in\;\{(-1,-2),\ (-1,0),\ (0,0),\ (1,0),\ (1,2)\},
\]
...
\begin{theorem}
\[
a(n)\;=\;14\,a(n-1) + 14\,a(n-2) - 210\,a(n-3) + 210\,a(n-5) - 14\,a(n-6) - 14\,a(n-7) + a(n-8)
\]
for every $n>6$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264267.
