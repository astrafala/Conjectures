...
\title{The empirical recurrence for OEIS A205167, proved by counting patterns}
...
\begin{abstract}
OEIS A205167 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
$22$, contributed by R.~H.~Hardin, then follows from a finite exact computation.
\end{abstract}
...
OEIS A205167 is ``Number of (n+1)X6 0..3 arrays with every 2X2 subblock having unequal diagonal elements or unequal antidiagonal elements, and new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
506493, 1502057181, 4456641224469, 13223001109687815, 39233079877190973984, 116405840403665540209755, 345379963095346349517061062, 1024753727940861519383536350663,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 11:48:42, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3135\,a(n-1) - 509484\,a(n-2) + 33380704\,a(n-3) - 1155163860\,a(n-4) + 23371955456\,a(n-5) - 283352222404\,a(n-6) + 1930114342470\,a(n-7) - 4743702198614\,a(n-8) - 28028680059390\,a(n-9) + 252000315195083\,a(n-10) - 580096388359081\,a(n-11) - 1077099927330881\,a(n-12) + 8177716552088449\,a(n-13) - 13288317679713227\,a(n-14) - 9011132978044501\,a(n-15) + 64201793373718340\,a(n-16) - 103107108258103398\,a(n-17) + 83216273965787680\,a(n-18) - 34433623699903508\,a(n-19) + 5133203291666328\,a(n-20) + 802120907583504\,a(n-21) - 253519299407520\,a(n-22)
\end{equation}
for all $n>22$.
...
For every $n$ with $m=n+1-1\ge22$,
\[
4!\Bigl(a(n)-\sum_i c_i\,a(n-i)\Bigr)\;=\;\mathbf{v}^{\!\top}N^{\,m-22}q(N)\mathbf{1} .
\]
...
\begin{proof}
Substitute \eqref{eq:walk} into the left side and factor $N^{m-22}$ out of
...
column. The vector $w=q(N)\mathbf{1}$ was then formed by $22$ matrix--vector products
...
corresponding to $n=22+1$ onwards, and the run continued until $w$ was the zero vector,
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A205167.
