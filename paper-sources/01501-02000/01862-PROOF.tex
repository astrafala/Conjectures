...
\title{The empirical recurrence for OEIS A183910, proved from an exact model}
...
\begin{abstract}
OEIS A183910 carries an empirical recurrence of order $8$. It is true, and it is
...
OEIS A183910 is ``Number of nondecreasing arrangements of n+2 numbers in 0..7 with each number being the sum mod 8 of two others.''. It has offset $1$ and begins
\[
2, 5, 40, 207, 778, 2199, 5126, 10501,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (1/5040)*n\^{}7 + (1/120)*n\^{}6 + (53/360)*n\^{}5 + (17/12)*n\^{}4 - (1313/720)*n\^{}3 - (1777/40)*n\^{}2 + (14876/105)*n - 83 for n>3. a(n) = 8*a(n-1) - 28*a(n-2) + 56*a(n-3) - 70*a(n-4) + 56*a(n-5) - 28*a(n-6) + 8*a(n-7) - a(n-8) for n>10.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 06 2018 10:07:39, revision 9)
...
vanish from $n=11+1$ onwards, and the run exceeds $S+8$, which by
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A183910.
