...
\title{The empirical recurrence for OEIS A229581, proved by counting defective colourings}
...
\begin{abstract}
OEIS A229581 counts the colourings of an array with $K=3$ colours that are proper except at
...
numbers. What is left is a walk count on $S=72$ vertices, and the empirical recurrence of
...
OEIS A229581 is ``Number of defective 3-colorings of an n X 3 0..2 array connected horizontally and antidiagonally with exactly one mistake, and colors introduced in row-major 0..2 order.''. It has offset $1$ and begins
\[
2, 28, 264, 2160, 16416, 119232, 839808, 5785344,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 12*a(n-1) - 36*a(n-2).
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 19 2018 08:50:34, revision 8) the statement is
...
The arrays have $3$ columns and $L=n$ rows, entries in $\{0,\dots,3-1\}$.
...
Assembling the $3$ chains block-diagonally into $N$ of size $S=72$ with the weights of
...
index corresponding to $n=2+1$ onwards, and the run continued until $S+1$ consecutive
zeros had been seen.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A229581.
