...
\title{The empirical recurrence for OEIS A268787, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A268787 counts arrays over $\{0,\dots,1\}$ subject to a condition on the array as a
...
OEIS A268787 is ``Number of nX6 binary arrays with some element plus some horizontally, vertically or antidiagonally adjacent neighbor totalling two exactly once.''. It has offset $1$ and begins
\[
20, 338, 4207, 46195, 477128, 4725018, 45515227, 429442918,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 13 2016 12:24:50, revision 4) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268787.
