...
\title{The empirical recurrence for OEIS A198649, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A198649 counts arrays in which every cell is constrained by its neighbours on \emph{both}
...
lumpable, cutting $4676$ pairs down to $S=83$ states. The entry's empirical recurrence of
order $20$, contributed by R.~H.~Hardin, then follows from a finite exact computation.
\end{abstract}
...
OEIS A198649 is ``Number of n X 2 0..6 arrays with values 0..6 introduced in row major order and each element equal to at least one horizontal or vertical neighbor.''. It has offset $1$ and begins
\[
1, 3, 14, 76, 488, 3521, 28030, 242849,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 17 2023 02:09:22, revision 7) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;37\,a(n-1) - 502\,a(n-2) + 2817\,a(n-3) - 2399\,a(n-4) - 35852\,a(n-5) + 95494\,a(n-6) + 127482\,a(n-7) - 450424\,a(n-8) - 527274\,a(n-9) + 944990\,a(n-10) + 1784424\,a(n-11) - 456873\,a(n-12) - 2779579\,a(n-13) - 1492318\,a(n-14) + 1457417\,a(n-15) + 1939617\,a(n-16) + 390628\,a(n-17) - 559484\,a(n-18) - 375300\,a(n-19) - 62900\,a(n-20)
\end{equation}
for all $n>21$.
...
Assembling the $7$ lumped chains block-diagonally into $N$ of size $S=83$, with the
...
index,
\[
7!\Bigl(a(n)-\sum_i c_i\,a(n-i)\Bigr)\;=\;\mathbf{v}^{\!\top}G^{\,j-20}\,
\Bigl(h_{20}-\sum_i c_i h_{20-i}\Bigr)
\]
...
$w=h_{20}-\sum_i c_ih_{20-i}$; and it is enough to check $m=0,1,\dots,S-1$.
\end{lemma}
...
index corresponding to $n=21+1$ onwards, and the run was continued until $S+1$
...
\eqref{eq:walk2}, divided by $7!$, was evaluated at every one of the $20$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A198649.
