...
\title{The empirical recurrence for OEIS A280212, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A280212 imposes three things at once: a condition on each cell that reaches one row up and
...
OEIS A280212 is ``Number of nX2 0..2 arrays with no element unequal to a strict majority of its horizontal, vertical and antidiagonal neighbors, with the exception of exactly two elements, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
1, 2, 26, 92, 307, 1072, 3541, 11834,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 29 2016 04:00:42, revision 5) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) + 6\,a(n-2) - 20\,a(n-3) - 49\,a(n-4) + 24\,a(n-5) + 148\,a(n-6) + 128\,a(n-7) - 48\,a(n-8) - 128\,a(n-9) - 64\,a(n-10)
\end{equation}
for all $n>14$.
...
index corresponding to $n=14+1$ onwards, and the run continued until $S+1$ consecutive
zeros had been seen.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A280212.
