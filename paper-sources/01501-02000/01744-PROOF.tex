...
\begin{quote}
Empirical: a(n) = (259723/2240)*n\^{}8 - (299869/5040)*n\^{}7 + (39757/1440)*n\^{}6 - (8303/360)*n\^{}5 + (31829/2880)*n\^{}4 - (8083/720)*n\^{}3 + (32213/5040)*n\^{}2 - (509/420)*n. a(n) = 9*a(n-1) - 36*a(n-2) + 84*a(n-3) - 126*a(n-4) + 126*a(n-5) - 84*a(n-6) + 36*a(n-7) - 9*a(n-8) + a(n-9) for n>9.
\end{quote}
