...
\title{The empirical recurrence for OEIS A199836, proved from an exact model}
...
\begin{abstract}
OEIS A199836 carries an empirical recurrence of order $7$. It is true, and it is
...
OEIS A199836 is ``Number of -n..n arrays x(0..6) of 7 elements with zero sum and no two neighbors summing to zero.''. It has offset $1$ and begins
\[
22, 1650, 20240, 118280, 462234, 1402934, 3579520, 8046928,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (5887/180)*n\^{}6 - (1013/60)*n\^{}5 + (245/36)*n\^{}4 - (35/12)*n\^{}3 + (157/45)*n\^{}2 - (6/5)*n. a(n) = 7*a(n-1) - 21*a(n-2) + 35*a(n-3) - 35*a(n-4) + 21*a(n-5) - 7*a(n-6) + a(n-7) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (May 16 2018 11:19:41, revision 8)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A199836.
