...
\begin{quote}
Empirical: a(n) = (2/2835)*n\^{}9 + (131/630)*n\^{}8 + (2803/945)*n\^{}7 + (1349/90)*n\^{}6 + (41449/1080)*n\^{}5 + (20423/360)*n\^{}4 + (1149293/22680)*n\^{}3 + (22741/840)*n\^{}2 + (2011/252)*n + 1. a(n) = 10*a(n-1) - 45*a(n-2) + 120*a(n-3) - 210*a(n-4) + 252*a(n-5) - 210*a(n-6) + 120*a(n-7) - 45*a(n-8) + 10*a(n-9) - a(n-10) for n>10.
\end{quote}
