...
\title{The empirical recurrence for OEIS A264361, proved by transfer matrix}
...
\begin{abstract}
OEIS A264361 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=6$ rows in which
...
OEIS A264361 is ``Number of (n+1) X (5+1) arrays of permutations of 0..n*6+5 with each element having directed index change 0,0 0,2 1,0 or -1,-2.''. It has offset $1$ and begins
\[
36, 400, 5184, 65536, 831744, 10549504, 133818624, 1697440000,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 11*a(n-1) + 22*a(n-2) - 8*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 07 2019 12:41:30, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264361.
