...
\title{The empirical recurrence for OEIS A233102, proved by carrying a row major clause across
columns}
...
\begin{abstract}
OEIS A233102 counts $5\times n$ arrays over $\{0,\dots,3\}$ with a forbidden-pair
condition and a clause on the order in which values first appear, read in ROW MAJOR order, and
it carries an empirical recurrence of order $27$ contributed by R.~H.~Hardin. It is true.
...
OEIS A233102 is ``Number of 5 X n 0..3 arrays with no element x(i,j) adjacent to value 3-x(i,j) horizontally, diagonally or antidiagonally, top left element zero, and 1 appearing before 2 in row major order.''. It has offset $1$ and begins
\[
136, 3602, 200165, 10221326, 537122150, 28141137872,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 08 2014 09:11:54, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The array has $5$ rows and $n$ columns. Two cells are adjacent when they differ by one of the
offsets
\[
(0,1), (1,-1), (1,1),
\]
...
row, and there are $S=618$ of them after states with identical futures are merged. Hence
\[
...
\begin{theorem}
\[
a(n)\;=\;68\,a(n-1) - 600\,a(n-2) - 15127\,a(n-3) + 198891\,a(n-4) + 474114\,a(n-5) - 15054666\,a(n-6) + 40876796\,a(n-7) + 282247277\,a(n-8) - 1702957346\,a(n-9) + 1300734258\,a(n-10) + 10660506741\,a(n-11) - 25827798163\,a(n-12) - 5523934284\,a(n-13) + 82235055992\,a(n-14) - 73298596738\,a(n-15) - 60422455252\,a(n-16) + 120987324040\,a(n-17) - 24800038680\,a(n-18) - 50712556504\,a(n-19) + 26785354528\,a(n-20) + 4082561568\,a(n-21) - 4463628544\,a(n-22) + 203254656\,a(n-23) + 207891200\,a(n-24) - 17481216\,a(n-25) - 2073600\,a(n-26) + 110592\,a(n-27)
\]
for every $n>28$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A233102.
