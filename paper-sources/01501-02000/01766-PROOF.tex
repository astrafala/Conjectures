...
\title{The empirical recurrence for OEIS A201875, proved from an exact model}
...
\begin{abstract}
OEIS A201875 carries an empirical recurrence of order $9$. It is true, and it is
...
OEIS A201875 is ``Number of zero-sum -n..n arrays of 4 elements with first and second differences also in -n..n.''. It has offset $1$ and begins
\[
3, 19, 45, 95, 173, 285, 431, 633,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) +a(n-2) +a(n-3) -2*a(n-4) -2*a(n-5) +a(n-6) +a(n-7) +a(n-8) -a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 15 2018 09:29:55, revision 8)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A201875.
