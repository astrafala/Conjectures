...
\title{The empirical recurrence for OEIS A262845, proved by transfer matrix}
...
\begin{abstract}
OEIS A262845 counts arrays of width $5$ over $\{0,1\}$ whose rows, read as base-$2$
numbers, are divisible by $7$ and whose columns, read the same way, are not divisible by
$7$. The entry carries an empirical recurrence of order $43$ contributed by
...
is then a walk count on $S=343$ states.
\end{abstract}
...
OEIS A262845 is ``Number of (n+2)X(3+2) 0..1 arrays with each row divisible by 7 and column not divisible by 7, read as a binary number with top and left being the most significant bits.''. It has offset $1$ and begins
\[
12, 196, 1336, 5184, 31512, 175820, 793812, 4140908,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2015 16:08:18, revision 4) this is still
...
So the vector $\bigl(\gamma_1\bmod 7,\dots,\gamma_{5}\bmod
7\bigr)$ is a state: at most $7^{5}$ of them, and each array row
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) + 203\,a(n-3) - 1015\,a(n-4) - 17262\,a(n-6) + 86310\,a(n-7) + 803306\,a(n-9) - 4016530\,a(n-10) - 22920723\,a(n-12) + 114603615\,a(n-13) + 424713065\,a(n-15) - 2123565325\,a(n-16) - 5289109868\,a(n-18) + 26445549340\,a(n-19) + 45727616604\,a(n-21) - 228638083020\,a(n-22) - 289788580823\,a(n-24) + 1448942904115\,a(n-25) + 1453125527917\,a(n-27) - 7265627639585\,a(n-28) - 5836364956590\,a(n-30) + 29181824782950\,a(n-31) + 16212555187738\,a(n-33) - 81062775938690\,a(n-34) - 21276199455861\,a(n-36) + 106380997279305\,a(n-37) - 6355957095425\,a(n-39) + 31779785477125\,a(n-40) + 38763541794536\,a(n-42) - 193817708972680\,a(n-43)
\]
for every $n>40$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A262845.
