...
\title{The empirical recurrence for OEIS A229572, proved by counting defective colourings}
...
\begin{abstract}
OEIS A229572 counts the colourings of an array with $K=4$ colours that are proper except at
...
OEIS A229572 is ``Number of defective 4-colorings of an n X 2 0..3 array connected horizontally, vertically, diagonally and antidiagonally with exactly one mistake, and colors introduced in row-major 0..3 order.''. It has offset $1$ and begins
\[
1, 6, 26, 80, 216, 544, 1312, 3072,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 4*a(n-1) - 4*a(n-2) for n>3.
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 21 2022 11:10:03, revision 12) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A229572.
