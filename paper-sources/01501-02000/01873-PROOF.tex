...
\title{The empirical recurrence for OEIS A202964, proved from an exact model}
...
\begin{abstract}
OEIS A202964 carries an empirical recurrence of order $6$. It is true, and it is
...
OEIS A202964 is ``Number of arrays of 4 integers in -n..n with sum zero and adjacent elements differing in absolute value.''. It has offset $1$ and begins
\[
4, 28, 108, 268, 544, 972, 1576, 2392,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) -3*a(n-2) +2*a(n-3) -3*a(n-4) +3*a(n-5) -a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 03 2018 07:57:50, revision 9)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A202964.
