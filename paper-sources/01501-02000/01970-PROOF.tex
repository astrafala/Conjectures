...
\title{The empirical recurrence for OEIS A218079, proved by transfer matrix}
...
\begin{abstract}
OEIS A218079 counts the distinct arrays obtained by applying a fixed local operation to every cell
...
$S=22$ states, after which the conjectured recurrence is settled by a finite exact
computation.
\end{abstract}
...
OEIS A218079 is ``Number of n X 3 arrays of the minimum value of corresponding elements and their horizontal, vertical or antidiagonal neighbors in a random 0..1 n X 3 array.''. It has offset $1$ and begins
\[
4, 8, 26, 78, 246, 762, 2370, 7372,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + 4*a(n-2) - 5*a(n-4) - a(n-5) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 24 2018 09:38:42, revision 7) this is still
...
\]
There are $S=22$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite.
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 4\,a(n-2) - 5\,a(n-4) - a(n-5)
\]
for every $n>6$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A218079.
