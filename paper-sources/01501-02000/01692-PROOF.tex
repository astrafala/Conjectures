...
\title{The empirical recurrence for OEIS A235417, proved by transfer matrix}
...
\begin{abstract}
OEIS A235417 counts arrays of width $2$ over $\{0,1,2\}$ by reducing every $2\times2$ subblock to a
...
OEIS A235417 is ``Number of (n+1)X(1+1) 0..2 arrays with 2X2 subblock sum of squares lexicographically nondecreasing rowwise and nonincreasing columnwise.''. It has offset $1$ and begins
\[
81, 432, 2304, 9504, 39204, 138402, 488601, 1553877,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 08:31:58, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) + 12\,a(n-2) - 138\,a(n-3) + 44\,a(n-4) + 1362\,a(n-5) - 1706\,a(n-6) - 7446\,a(n-7) + 14669\,a(n-8) + 23808\,a(n-9) - 69362\,a(n-10) - 39576\,a(n-11) + 208600\,a(n-12) - 417200\,a(n-14) + 158304\,a(n-15) + 554896\,a(n-16) - 380928\,a(n-17) - 469408\,a(n-18) + 476544\,a(n-19) + 218368\,a(n-20) - 348672\,a(n-21) - 22528\,a(n-22) + 141312\,a(n-23) - 24576\,a(n-24) - 24576\,a(n-25) + 8192\,a(n-26)
\]
for every $n>24$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A235417.
