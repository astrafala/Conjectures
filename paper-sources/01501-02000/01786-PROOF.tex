...
\title{The empirical recurrence for OEIS A210315, proved by transfer matrix}
...
\begin{abstract}
OEIS A210315 counts arrays of width $4$ whose every $2\times2$ subblock holds a
prescribed number of DISTINCT values, which use ALL of the $4$ available letters, and which
are counted up to renaming. The entry carries an empirical recurrence of order $21$
...
OEIS A210315 is ``Number of (n+1)X4 0..3 arrays containing all values 0..3 with every 2X2 subblock having two or three distinct values, and new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
995, 279526, 58464712, 11186190570, 2073034512148, 379491677736164, 69133776440716096, 12569987936154929124,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 15:54:26, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;237\,a(n-1) - 8494\,a(n-2) - 300237\,a(n-3) + 2482313\,a(n-4) + 58239270\,a(n-5) - 296444067\,a(n-6) - 2842201417\,a(n-7) + 12050668766\,a(n-8) + 41834205193\,a(n-9) - 197110345949\,a(n-10) - 109615007438\,a(n-11) + 1042214343696\,a(n-12) - 265321484840\,a(n-13) - 2283447354472\,a(n-14) + 1334391576272\,a(n-15) + 2102283712768\,a(n-16) - 1614381867264\,a(n-17) - 554944840192\,a(n-18) + 578116512768\,a(n-19) - 98061852672\,a(n-20) + 1530150912\,a(n-21)
\]
for every $n>21$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A210315.
