...
\title{The empirical recurrence for OEIS A252806, proved by transfer matrix}
...
\begin{abstract}
OEIS A252806 counts arrays of width $5$ over an alphabet of $5$ letters in which every three
...
OEIS A252806 is ``Number of (n+2)X(3+2) 0..4 arrays with every consecutive three elements in every row and column not having exactly two distinct values, and in every diagonal and antidiagonal having exactly two distinct values, and new values 0 upwards introduced in row major order.''. It has offset $1$ and begins
\[
357, 488, 1337, 551, 2068, 6961, 2891, 10687,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:39:36, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 11\,a(n-3) - 11\,a(n-4) - 30\,a(n-6) + 30\,a(n-7) - 2\,a(n-9) + 2\,a(n-10) + 7\,a(n-12) - 7\,a(n-13) - a(n-15) + a(n-16)
\]
for every $n>19$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252806.
