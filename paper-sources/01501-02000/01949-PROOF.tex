...
\title{The empirical recurrence for OEIS A222090, proved by transfer matrix}
...
\begin{abstract}
OEIS A222090 counts the distinct OCCUPANCY arrays obtained when every cell of an $n\times2$ grid
...
one, on $S=209$ states, after which the conjectured recurrence is settled by a finite exact
computation.
\end{abstract}
...
OEIS A222090 is ``Number of n X 2 arrays of occupancy after each element stays put or moves to some horizontal, vertical or antidiagonal neighbor, without move-in move-out left turns.''. It has offset $1$ and begins
\[
3, 31, 308, 3034, 29860, 293848, 2891636, 28455036,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 17*a(n-1) - 90*a(n-2) + 217*a(n-3) - 258*a(n-4) + 156*a(n-5) - 44*a(n-6) + 4*a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 14 2018 21:03:54, revision 9) this is still
...
$S=209$ reachable sets. In particular $a$ is $C$-finite.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A222090.
