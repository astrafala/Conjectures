...
\title{The empirical recurrence for OEIS A183906, proved from an exact model}
...
\begin{abstract}
OEIS A183906 carries an empirical recurrence of order $4$. It is true, and it is
...
OEIS A183906 is ``Number of nondecreasing arrangements of n+2 numbers in 0..3 with each number being the sum mod 4 of two others.''. It has offset $1$ and begins
\[
2, 5, 17, 38, 67, 105, 153, 212,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (1/6)*n\^{}3 + 2*n\^{}2 + (5/6)*n - 8 for n>2. a(n) = 4*a(n-1) - 6*a(n-2) + 4*a(n-3) - a(n-4) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 05 2018 20:38:32, revision 8)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A183906.
