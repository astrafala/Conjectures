...
\title{The empirical recurrence for OEIS A186844, proved by transfer matrix}
...
\begin{abstract}
OEIS A186844 counts arrays over $\{0,\dots,1\}$ under a condition comparing a statistic of
every $2\times2$ subblock with those of its neighbours, and carries an empirical recurrence
of order $22$ contributed by R.~H.~Hardin. It is true, and it is decidable rather than
...
OEIS A186844 is ``Number of (n+1)X4 binary arrays with no 2X2 subblock diagonal sum less antidiagonal sum equal to any horizontal or vertical neighbor 2X2 subblock diagonal sum less antidiagonal sum.''. It has offset $1$ and begins
\[
162, 970, 6138, 36988, 224714, 1371258, 8335676, 50707346,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 03:44:30, revision 9) this is still
...
\]
on the $S=162$ admissible tuples.
...
4}=256$ tuples of $2$ rows, $S=162$ survive the condition inside a single subblock row;
...
$162$, which the model reproduces along with every later term, and that is the cheapest
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 11\,a(n-2) + 63\,a(n-3) + 112\,a(n-4) + 120\,a(n-5) + 110\,a(n-6) - 849\,a(n-7) - 1709\,a(n-8) - 1167\,a(n-9) + 1006\,a(n-10) + 3341\,a(n-11) + 2742\,a(n-12) + 2484\,a(n-13) - 161\,a(n-14) + 363\,a(n-15) - 1203\,a(n-16) + 126\,a(n-17) - 1692\,a(n-18) + 806\,a(n-19) - 426\,a(n-20) + 204\,a(n-21) + 32\,a(n-22)
\]
for every $n>23$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A186844.
