...
\title{The empirical recurrence for OEIS A279658, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A279658 imposes three things at once: a condition on each cell that reaches one column up and
...
numbers. The empirical recurrence of order $13$ contributed by R.~H.~Hardin then follows
...
OEIS A279658 is ``Number of 2 X n 0..2 arrays with no element equal to a strict majority of its horizontal and antidiagonal neighbors, with the exception of exactly two elements, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
0, 3, 27, 254, 2301, 19053, 149696, 1124969,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 02 2024 09:49:06, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;17\,a(n-1) - 90\,a(n-2) + 75\,a(n-3) + 591\,a(n-4) - 924\,a(n-5) - 1263\,a(n-6) + 2511\,a(n-7) + 810\,a(n-8) - 2675\,a(n-9) + 409\,a(n-10) + 924\,a(n-11) - 464\,a(n-12) + 64\,a(n-13)
\end{equation}
for all $n>14$.
...
$h_j=G^{j}N^{o}\mathbf{u}$, we have for $j\ge13$
\[
3!\Bigl(a(n_0+j)-\sum_i c_i\,a(n_0+j-i)\Bigr)=\mathbf{v}^{\!\top}G^{\,j-13}w,
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A279658.
