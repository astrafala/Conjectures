...
\title{The empirical recurrence for OEIS A269017, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A269017 counts arrays over $\{0,\dots,1\}$ subject to a condition on the array as a
...
and the empirical recurrence of order $32$ contributed by R.~H.~Hardin then follows from
...
OEIS A269017 is ``Number of 7Xn binary arrays with some element plus some horizontally, diagonally or antidiagonally adjacent neighbor totalling two exactly once.''. It has offset $1$ and begins
\[
0, 1183, 22654, 566656, 10002542, 192100836, 3258530608, 56916559941,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 17 2016 12:09:16, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;18\,a(n-1) + 287\,a(n-2) - 5714\,a(n-3) - 26548\,a(n-4) + 662854\,a(n-5) + 503265\,a(n-6) - 36588730\,a(n-7) + 43719737\,a(n-8) + 1055812740\,a(n-9) - 2531478280\,a(n-10) - 16536573196\,a(n-11) + 55382641489\,a(n-12) + 144894098686\,a(n-13) - 653413097167\,a(n-14) - 674041638674\,a(n-15) + 4637903423724\,a(n-16) + 1002070742726\,a(n-17) - 20672353979137\,a(n-18) + 5547728650154\,a(n-19) + 58313438730423\,a(n-20) - 34583201988384\,a(n-21) - 101896578743152\,a(n-22) + 86334749395584\,a(n-23) + 103754510061648\,a(n-24) - 115277187600000\,a(n-25) - 52616533613760\,a(n-26) + 83474612042112\,a(n-27) + 5618980228032\,a(n-28) - 30037873821696\,a(n-29) + 4537384086528\,a(n-30) + 4167543840768\,a(n-31) - 1173876903936\,a(n-32)
\end{equation}
for all $n>32$.
...
\]
for $j\ge32$. Hence \eqref{eq:conj} holds from that point on if and only if
...
formed by $32$ applications of $G$ in exact integer arithmetic and
$\mathbf{v}^{\!\top}G^{m}w$ evaluated for $m=0,1,\dots$, again exactly. Every one of
those integers vanishes from the index corresponding to $n=32+1$ onwards, and the run
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269017.
