...
\title{The empirical recurrence for OEIS A241622, proved from an exact model}
...
\begin{abstract}
OEIS A241622 carries an empirical recurrence of order $10$. It is true, and it is
...
\begin{quote}
Empirical: a(n) = (131/60480)*n\^{}9 + (131/3360)*n\^{}8 + (3137/10080)*n\^{}7 + (347/240)*n\^{}6 + (12407/2880)*n\^{}5 + (4097/480)*n\^{}4 + (169957/15120)*n\^{}3 + (7963/840)*n\^{}2 + (487/105)*n + 1. a(n) = 10*a(n-1) - 45*a(n-2) + 120*a(n-3) - 210*a(n-4) + 252*a(n-5) - 210*a(n-6) + 120*a(n-7) - 45*a(n-8) + 10*a(n-9) - a(n-10) for n>10.
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 30 2018 20:20:04, revision 8)
