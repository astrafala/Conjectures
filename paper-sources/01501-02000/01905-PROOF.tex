...
\begin{quote}
Empirical: a(n) = (17141/630)*n\^{}7 + (17141/180)*n\^{}6 + (28177/180)*n\^{}5 + (2759/18)*n\^{}4 + (17299/180)*n\^{}3 + (6929/180)*n\^{}2 + (1921/210)*n + 1. a(n) = 8*a(n-1) - 28*a(n-2) + 56*a(n-3) - 70*a(n-4) + 56*a(n-5) - 28*a(n-6) + 8*a(n-7) - a(n-8) for n>8.
\end{quote}
