...
\title{The empirical recurrence for OEIS A200789, proved from an exact model}
...
\begin{abstract}
OEIS A200789 carries an empirical recurrence of order $8$. It is true, and it is
...
OEIS A200789 is ``Number of 0..n arrays x(0..6) of 7 elements without any two consecutive increases.''. It has offset $1$ and begins
\[
128, 1791, 11704, 50775, 169884, 474566, 1160616, 2562633,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (2017/5040)*n\^{}7 + (1427/360)*n\^{}6 + (5759/360)*n\^{}5 + (607/18)*n\^{}4 + (28459/720)*n\^{}3 + (9113/360)*n\^{}2 + (848/105)*n + 1. a(n) = 8*a(n-1) - 28*a(n-2) + 56*a(n-3) - 70*a(n-4) + 56*a(n-5) - 28*a(n-6) + 8*a(n-7) - a(n-8) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 21 2017 21:51:54, revision 15)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A200789.
