...
\title{The empirical recurrence for OEIS A280309, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A280309 imposes three things at once: a condition on each cell that reaches one row up and
...
OEIS A280309 is ``Number of n X 1 0..2 arrays with no element equal to more than one of its horizontal and vertical neighbors, with the exception of exactly two elements, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
0, 0, 0, 1, 2, 9, 34, 124,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 6*a(n-1) - 6*a(n-2) - 16*a(n-3) + 12*a(n-4) + 24*a(n-5) + 8*a(n-6) for n>10.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 19 2018 12:36:26, revision 12) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A280309.
