...
\title{The empirical closed form for OEIS A219167, proved}
...
\begin{abstract}
OEIS A219167 states an explicit closed form for $a(n)$ and records it as empirical. It is true, and
...
OEIS A219167 is ``Number of n X 2 arrays of the minimum value of corresponding elements and their horizontal or vertical neighbors in a random, but sorted with lexicographically nondecreasing rows and columns, 0..2 n X 2 array.''. It has offset $1$ and begins
\[
3, 7, 23, 53, 103, 182, 302, 478,\ \dots
\]
and states:
\begin{quote}
Empirical: a(n) = (1/8)*n\^{}4 - (3/4)*n\^{}3 + (55/8)*n\^{}2 - (49/4)*n + 8 for n>1.
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 11 2018 10:09:13, revision 8)
...
\begin{theorem}
The closed form OEIS A219167 records is correct for all $n>1$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A219167.
