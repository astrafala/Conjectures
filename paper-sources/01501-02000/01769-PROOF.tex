...
\title{The empirical recurrence for OEIS A240343, proved by transfer matrix}
...
\begin{abstract}
OEIS A240343 counts arrays over $\{0,1,2,3\}$ in which no entry may equal, modulo $4$, a given
...
OEIS A240343 is ``Number of nX3 0..3 arrays with no element equal to one plus the sum of elements to its left or one plus the sum of elements above it or three plus the sum of the elements diagonally to its northwest, modulo 4.''. It has offset $1$ and begins
\[
8, 78, 722, 6376, 55680, 483926, 4195892, 36331704,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 09:50:02, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A240343.
