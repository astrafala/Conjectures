...
\title{The empirical recurrence for OEIS A202125, proved from an exact model}
...
\begin{abstract}
OEIS A202125 carries an empirical recurrence of order $9$. It is true, and it is
...
OEIS A202125 is ``Number of -n..n arrays of 4 elements with first, second and third differences also in -n..n.''. It has offset $1$ and begins
\[
19, 127, 475, 1279, 2833, 5509, 9739, 16039,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) - 3*a(n-2) + 3*a(n-3) - 6*a(n-4) + 6*a(n-5) - 3*a(n-6) + 3*a(n-7) - 3*a(n-8) + a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 03 2018 05:35:59, revision 11)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A202125.
