...
\title{The empirical recurrence for OEIS A269620, proved from an exact model}
...
\begin{abstract}
OEIS A269620 carries an empirical recurrence of order $5$. It is true, and it is
...
\begin{quote}
Empirical: a(n) = n\^{}4 + 4*n\^{}3 + 5*n\^{}2 + 5*n. a(n) = 5*a(n-1) - 10*a(n-2) + 10*a(n-3) - 5*a(n-4) + a(n-5) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 25 2019 08:28:12, revision 8)
