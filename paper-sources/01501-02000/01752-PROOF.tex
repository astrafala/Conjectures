...
\title{The empirical recurrence for OEIS A279711, proved by transfer matrix}
...
\begin{abstract}
OEIS A279711 counts $4\times n$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A279711 is ``Number of 4Xn 0..1 arrays with no element equal to a strict majority of its horizontal and antidiagonal neighbors and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
8, 13, 42, 125, 385, 1195, 3751, 11823,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 17 2016 13:25:09, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-1) - 24\,a(n-2) + 31\,a(n-3) + 2\,a(n-4) - 66\,a(n-5) + 96\,a(n-6) - 50\,a(n-7) - 14\,a(n-8) - 18\,a(n-9) + 77\,a(n-10) + 32\,a(n-11) - 243\,a(n-12) + 257\,a(n-13) + 22\,a(n-14) - 117\,a(n-15) + 3\,a(n-16) - 28\,a(n-17) + 17\,a(n-18) + 7\,a(n-19) + 5\,a(n-20) + 3\,a(n-21) + a(n-23)
\]
for every $n>25$.
\end{theorem}
...
By Lemma~\ref{lem:crit} the recurrence holds for every $n>25$. The bound is exact: at $n=25$ the recurrence fails on the entry's own published terms, so no larger range holds.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A279711.
