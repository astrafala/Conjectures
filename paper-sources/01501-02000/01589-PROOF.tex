...
\title{The empirical recurrence for OEIS A228980, proved by transfer matrix}
...
\begin{abstract}
OEIS A228980 counts the distinct arrays obtained by applying a fixed local operation to every cell
...
OEIS A228980 is ``Number of n X 2 0..1 arrays of the median of the corresponding element, the element to the east and the element to the south in a larger (n+1) X 3 0..1 array.''. It has offset $1$ and begins
\[
4, 16, 64, 252, 992, 3900, 15328, 60228,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 6*a(n-1) - 7*a(n-2) - 6*a(n-3) + 6*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 13 2018 09:47:27, revision 12) this is still
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) - 7\,a(n-2) - 6\,a(n-3) + 6\,a(n-4)
\]
for every $n>4$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A228980.
