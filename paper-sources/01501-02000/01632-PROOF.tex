...
\title{The empirical recurrence for OEIS A208947, proved from an exact model}
...
\begin{abstract}
OEIS A208947 carries an empirical recurrence of order $10$. It is true, and it is
...
OEIS A208947 is ``Number of 5-bead necklaces labeled with numbers -n..n not allowing reversal, with sum zero with no three beads in a row equal.''. It has offset $1$ and begins
\[
8, 68, 274, 766, 1722, 3376, 6004, 9928,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) - 3*a(n-2) + 2*a(n-3) - 2*a(n-4) + 2*a(n-6) - 2*a(n-7) + 3*a(n-8) - 3*a(n-9) + a(n-10).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 07 2018 08:51:06, revision 13)
...
$S=31$, which includes the pre-period $n_0=0$ the conditions with an offset need. The
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208947.
