...
\title{The empirical recurrence for OEIS A207101, proved from an exact model}
...
\begin{abstract}
OEIS A207101 carries an empirical recurrence of order $12$. It is true, and it is
...
OEIS A207101 is ``Number of 0..n arrays x(0..3) of 4 elements with each no smaller than the sum of its two previous neighbors modulo (n+1).''. It has offset $1$ and begins
\[
8, 26, 68, 140, 274, 462, 760, 1158,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-2) + 2*a(n-3) - 3*a(n-4) - 6*a(n-5) + 6*a(n-7) + 3*a(n-8) - 2*a(n-9) - 3*a(n-10) + a(n-12).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 19 2018 03:32:46, revision 9)
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-2) + 2\,a(n-3) - 3\,a(n-4) - 6\,a(n-5) + 6\,a(n-7) + 3\,a(n-8) - 2\,a(n-9) - 3\,a(n-10) + a(n-12)
\]
for every $n>0$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207101.
