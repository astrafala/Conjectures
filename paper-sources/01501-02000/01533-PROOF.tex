...
\title{The empirical recurrence for OEIS A200839, proved from an exact model}
...
\begin{abstract}
OEIS A200839 carries an empirical recurrence of order $5$. It is true, and it is
...
OEIS A200839 is ``Number of 0..n arrays x(0..3) of 4 elements without any two consecutive increases or two consecutive decreases.''. It has offset $1$ and begins
\[
16, 69, 194, 435, 846, 1491, 2444, 3789,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (5/12)*n\^{}4 + (19/6)*n\^{}3 + (79/12)*n\^{}2 + (29/6)*n + 1.
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 08:49:11, revision 12)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A200839.
