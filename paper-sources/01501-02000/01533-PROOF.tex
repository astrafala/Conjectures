...
\title{The empirical recurrence for OEIS A184705, proved from an exact model}
...
\begin{abstract}
OEIS A184705 carries an empirical recurrence of order $15$. It is true, and it is
...
OEIS A184705 is ``Number of strings of numbers x(i=1..5) in 0..n with sum i*x(i) equal to n*5.''. It has offset $1$ and begins
\[
3, 12, 34, 78, 156, 282, 471, 744,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + a(n-2) - a(n-5) - a(n-6) - a(n-7) + a(n-8) + a(n-9) + a(n-10) - a(n-13) - a(n-14) + a(n-15).
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 14 2018 13:11:26, revision 9)
...
$q(z)=z^{15}-\sum_ic_iz^{15-i}$ the characteristic polynomial of the conjectured
...
vanish from $n=0+1$ onwards, and the run exceeds $S+15$, which by
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A184705.
