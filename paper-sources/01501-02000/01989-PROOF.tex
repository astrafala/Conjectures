...
\begin{quote}
Empirical: a(n) = (349/720)*n\^{}6 + (321/80)*n\^{}5 + (1883/144)*n\^{}4 + (1013/48)*n\^{}3 + (3139/180)*n\^{}2 + (413/60)*n + 1. a(n) = 7*a(n-1) - 21*a(n-2) + 35*a(n-3) - 35*a(n-4) + 21*a(n-5) - 7*a(n-6) + a(n-7) for n>7.
\end{quote}
