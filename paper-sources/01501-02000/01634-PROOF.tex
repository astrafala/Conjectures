...
\title{The empirical recurrence for OEIS A220304, proved by transfer matrix}
...
\begin{abstract}
OEIS A220304 counts the distinct indicator arrays obtained from the $n\times2$ arrays over
...
OEIS A220304 is ``Majority value maps: number of n X 2 binary arrays indicating the locations of corresponding elements equal to at least half of their horizontal, vertical and antidiagonal neighbors in a random 0..1 n X 2 array.''. It has offset $1$ and begins
\[
2, 7, 26, 86, 291, 980, 3309, 11161,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) + a(n-2) - a(n-3) + 6*a(n-4) + 3*a(n-6) + 3*a(n-7) - a(n-8) + 3*a(n-9) - a(n-10).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 31 2018 08:53:20, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + a(n-2) - a(n-3) + 6\,a(n-4) + 3\,a(n-6) + 3\,a(n-7) - a(n-8) + 3\,a(n-9) - a(n-10)
\]
for every $n>10$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A220304.
