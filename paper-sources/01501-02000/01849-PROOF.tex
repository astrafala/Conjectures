...
\title{The empirical recurrence for OEIS A282125, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A282125 imposes three things at once: a condition on each cell that reaches one row up and
...
OEIS A282125 is ``Number of n X 2 0..2 arrays with no element unequal to more than four of its king-move neighbors, with the exception of exactly one element, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
0, 0, 30, 412, 4018, 35472, 296062, 2378276,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 14*a(n-1) - 57*a(n-2) + 88*a(n-3) - 256*a(n-4) + 240*a(n-5) - 320*a(n-6) + 256*a(n-7) - 64*a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 20 2019 10:52:36, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;14\,a(n-1) - 57\,a(n-2) + 88\,a(n-3) - 256\,a(n-4) + 240\,a(n-5) - 320\,a(n-6) + 256\,a(n-7) - 64\,a(n-8)
\end{equation}
for all $n>9$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A282125.
