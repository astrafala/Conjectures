...
\title{The empirical recurrence for OEIS A231823, proved by transfer matrix}
...
\begin{abstract}
OEIS A231823 counts arrays of width $3$ over $\{0,1,2\}$ in which no cell is beaten by a strict majority of its neighbours. The entry carries an
...
$3$ consecutive rows and the count is a walk count on $S=703$ states.
\end{abstract}
...
OEIS A231823 is ``Number of nX3 0..2 arrays with no element having a strict majority of its horizontal, vertical and antidiagonal neighbors equal to itself plus one mod 3, with upper left element zero (rock paper and scissors drawn positions).''. It has offset $1$ and begins
\[
3, 64, 1205, 21770, 393408, 7103846, 128269829, 2316065437,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 08:47:09, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;26\,a(n-1) - 158\,a(n-2) + 239\,a(n-3) + 509\,a(n-4) - 1399\,a(n-5) + 1090\,a(n-6) - 11112\,a(n-7) + 15301\,a(n-8) + 80873\,a(n-9) - 119580\,a(n-10) - 188287\,a(n-11) + 130867\,a(n-12) + 298685\,a(n-13) + 639811\,a(n-14) - 796809\,a(n-15) - 1910156\,a(n-16) + 1602985\,a(n-17) + 1883568\,a(n-18) - 1014662\,a(n-19) - 1402360\,a(n-20) - 8047\,a(n-21) + 1663065\,a(n-22) - 635592\,a(n-23) - 991770\,a(n-24) + 711081\,a(n-25) + 461787\,a(n-26) - 343648\,a(n-27) - 210676\,a(n-28) + 150221\,a(n-29) - 4791\,a(n-30) + 4420\,a(n-31) - 8402\,a(n-32) + 6071\,a(n-33) - 3686\,a(n-34) + 632\,a(n-35) + 69\,a(n-36)
\]
for every $n>37$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231823.
