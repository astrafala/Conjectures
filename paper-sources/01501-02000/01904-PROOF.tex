...
\title{The empirical recurrence for OEIS A221894, proved by transfer matrix}
...
\begin{abstract}
OEIS A221894 counts the distinct OCCUPANCY arrays obtained when every cell of an $n\times2$ grid
...
one, on $S=184$ states, after which the conjectured recurrence is settled by a finite exact
computation.
\end{abstract}
...
OEIS A221894 is ``Number of n X 2 arrays of occupancy after each element stays put or moves to some horizontal, vertical or antidiagonal neighbor, without move-in move-out straight through or left turns.''. It has offset $1$ and begins
\[
3, 31, 266, 2305, 19936, 172624, 1494152, 12933821,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 5*a(n-1) + 26*a(n-2) + 45*a(n-3) + 34*a(n-4) - 2*a(n-5) - 4*a(n-6) + a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 11 2018 10:45:40, revision 9) this is still
...
$S=184$ reachable sets. In particular $a$ is $C$-finite.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221894.
