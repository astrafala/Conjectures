...
\title{The empirical recurrence for OEIS A221544, proved from an exact model}
...
\begin{abstract}
OEIS A221544 carries an empirical recurrence of order $6$. It is true, and it is
...
\begin{quote}
Empirical: a(n) = 1*n\^{}5 + 2*n\^{}4 - 6*n\^{}3 + 21*n\^{}2 - 31*n + 23 for n>4. a(n) = 6*a(n-1) - 15*a(n-2) + 20*a(n-3) - 15*a(n-4) + 6*a(n-5) - a(n-6) for n>10.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 08 2018 09:07:50, revision 9)
