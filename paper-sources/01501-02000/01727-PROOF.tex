...
\title{The empirical recurrence for OEIS A281247, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A281247 imposes three things at once: a condition on each cell that reaches one row up and
...
OEIS A281247 is ``Number of nX2 0..2 arrays with no element equal to more than one of its horizontal, vertical and antidiagonal neighbors, with the exception of exactly two elements, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
0, 0, 12, 139, 1222, 9151, 63138, 412070,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 13*a(n-1) -48*a(n-2) +7*a(n-3) +149*a(n-4) +96*a(n-5) -59*a(n-6) -97*a(n-7) -48*a(n-8) -11*a(n-9) -a(n-10) for n>12
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 18 2017 08:42:26, revision 5) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;13\,a(n-1) - 48\,a(n-2) + 7\,a(n-3) + 149\,a(n-4) + 96\,a(n-5) - 59\,a(n-6) - 97\,a(n-7) - 48\,a(n-8) - 11\,a(n-9) - a(n-10)
\end{equation}
for all $n>12$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A281247.
