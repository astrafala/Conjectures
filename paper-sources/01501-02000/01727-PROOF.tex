...
\title{The empirical recurrence for OEIS A267929, proved by transfer matrix}
...
\begin{abstract}
OEIS A267929 counts arrays in which the REPEATED VALUES of each row, and of each column, stand in a
...
value so far in each column of the scan, so the count is a walk count on $S=401$ states.
\end{abstract}
...
OEIS A267929 is ``Number of nX2 0..3 arrays with every repeated value in every row and column greater than the previous repeated value.''. It has offset $1$ and begins
\[
16, 256, 3600, 49284, 646416, 8248384, 102657424, 1251956689,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 22 2016 10:06:55, revision 4) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=401,\quad\tau=\mathbf{1} .
\]
...
\begin{theorem}
\[
a(n)\;=\;65\,a(n-1) - 1714\,a(n-2) + 21994\,a(n-3) - 104609\,a(n-4) - 629015\,a(n-5) + 9424776\,a(n-6) - 16529832\,a(n-7) - 255376098\,a(n-8) + 1037637378\,a(n-9) + 3611188980\,a(n-10) - 20939962212\,a(n-11) - 32646831786\,a(n-12) + 213582240666\,a(n-13) + 202683094344\,a(n-14) - 1065454174440\,a(n-15) - 388324470141\,a(n-16) + 2871948084957\,a(n-17) - 843801825042\,a(n-18) - 3200868080118\,a(n-19) + 3106724901291\,a(n-20) - 847288609443\,a(n-21)
\]
for every $n>21$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267929.
