...
\title{The empirical recurrence for OEIS A201813, proved from an exact model}
...
\begin{abstract}
OEIS A201813 carries an empirical recurrence of order $4$. It is true, and it is
...
\begin{quote}
Empirical: a(n) = 20*n\^{}3 + 30*n + 1. a(n) = 4*a(n-1) - 6*a(n-2) + 4*a(n-3) - a(n-4) for n>4.
\end{quote}
As of the ``Last modified'' line on the live entry (May 25 2018 10:16:29, revision 8)
