...
\title{The empirical closed form for OEIS A219774, proved}
...
\begin{abstract}
OEIS A219774 states an explicit closed form for $a(n)$ and records it as empirical. It is true, and
...
OEIS A219774 is ``Number of 3 X n arrays of the minimum value of corresponding elements and their horizontal or antidiagonal neighbors in a random, but sorted with lexicographically nondecreasing rows and columns, 0..1 3 X n array.''. It has offset $1$ and begins
\[
4, 6, 14, 33, 65, 114, 189, 298,\ \dots
\]
and states:
\begin{quote}
Empirical: a(n) = (1/24)*n\^{}4 + (1/4)*n\^{}3 - (13/24)*n\^{}2 + (17/4)*n for n>4.
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 27 2018 10:47:06, revision 8)
...
\begin{theorem}
The closed form OEIS A219774 records is correct for all $n>4$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A219774.
