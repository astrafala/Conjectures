...
\title{The empirical recurrence for OEIS A212836, proved from an exact model}
...
\begin{abstract}
OEIS A212836 carries an empirical recurrence of order $4$. It is true, and it is
...
OEIS A212836 is ``Number of 0..n arrays of length 3 with 0 never adjacent to n.''. It has offset $1$ and begins
\[
2, 17, 50, 107, 194, 317, 482, 695,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = n\^{}3 + 3*n\^{}2 - n - 1. a(n) = 4*a(n-1) - 6*a(n-2) + 4*a(n-3) - a(n-4) for n>4.
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 21 2018 10:07:09, revision 10)
...
\]
annihilates $a$, and $S=\deg A=5$. A congruence condition modulo $m$ is counted one residue
...
exactly $\deg A$. The bound in force is therefore $zA(z)$, of order $S=5$, and
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A212836.
