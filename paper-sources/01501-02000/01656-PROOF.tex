...
\title{The empirical recurrence for OEIS A201090, proved from an exact model}
...
\begin{abstract}
OEIS A201090 carries an empirical recurrence of order $11$. It is true, and it is
...
OEIS A201090 is ``Number of -n..n arrays of 5 elements with first and second differences also in -n..n.''. It has offset $1$ and begins
\[
47, 537, 2771, 9593, 25935, 59533, 121371, 226521,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) +2*a(n-2) -5*a(n-3) -2*a(n-4) +4*a(n-5) +4*a(n-6) -2*a(n-7) -5*a(n-8) +2*a(n-9) +2*a(n-10) -a(n-11).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 15 2025 00:32:26, revision 15)
...
\]
annihilates $a$, and $S=\deg A=25$. A congruence condition modulo $m$ is counted one residue
...
exactly $\deg A$. The bound in force is therefore $zA(z)$, of order $S=25$, and
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 2\,a(n-2) - 5\,a(n-3) - 2\,a(n-4) + 4\,a(n-5) + 4\,a(n-6) - 2\,a(n-7) - 5\,a(n-8) + 2\,a(n-9) + 2\,a(n-10) - a(n-11)
\]
for every $n>0$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A201090.
