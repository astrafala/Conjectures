...
\title{The empirical recurrence for OEIS A223957, proved by transfer matrix}
...
\begin{abstract}
OEIS A223957 counts arrays over $\{0,\dots,3\}$ whose rows, columns, diagonals or
antidiagonals are required to be monotone or unimodal, and carries an empirical recurrence of
order $34$ contributed by R.~H.~Hardin. A monotone condition is local, but a unimodal one
...
is a walk count on $S=560$ vertices and the recurrence follows from a finite exact
computation.
\end{abstract}
...
OEIS A223957 is ``Number of nX4 0..3 arrays with antidiagonals unimodal and rows and diagonals nondecreasing.''. It has offset $1$ and begins
\[
35, 805, 12311, 176893, 2575955, 37844037, 559416917, 8299429418,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 23:01:58, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;35\,a(n-1) - 411\,a(n-2) + 1521\,a(n-3) + 4495\,a(n-4) - 33893\,a(n-5) - 76333\,a(n-6) + 769422\,a(n-7) - 657978\,a(n-8) - 4892638\,a(n-9) + 11892141\,a(n-10) + 26545075\,a(n-11) - 212154687\,a(n-12) + 180127811\,a(n-13) + 844199306\,a(n-14) - 1964869675\,a(n-15) - 925267902\,a(n-16) + 18361374116\,a(n-17) - 28421809002\,a(n-18) + 14606204778\,a(n-19) + 43447425250\,a(n-20) + 45550238994\,a(n-21) - 206541843216\,a(n-22) + 420735920152\,a(n-23) + 123206624124\,a(n-24) - 263534650788\,a(n-25) - 263768865528\,a(n-26) + 1543560996888\,a(n-27) + 154734998544\,a(n-28) - 494508716208\,a(n-29) - 124707094560\,a(n-30) + 893424774528\,a(n-31) + 244581703200\,a(n-32) + 20427292800\,a(n-33) + 536699520\,a(n-34)
\end{equation}
for all $n>36$.
...
bit vector), $|\mathcal V|=S=560$; let $(r,f)\to(s,f')$ be an edge when placing $s$ after $r$
...
$h_j=G^{j}N^{o}\mathbf{1}$, we have for $j\ge34$
\[
a(n_0+j)-\sum_i c_i\,a(n_0+j-i)=\,\mathbf{v}^{\!\top}G^{\,j-34}w,
\qquad w=h_{34}-\sum_i c_ih_{34-i} .
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223957.
