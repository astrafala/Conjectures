...
\title{The empirical recurrence for OEIS A200888, proved from an exact model}
...
\begin{abstract}
OEIS A200888 carries an empirical recurrence of order $6$. It is true, and it is
...
\begin{quote}
Empirical: a(n) = (2/15)*n\^{}5 + (11/6)*n\^{}4 + (35/6)*n\^{}3 + (23/3)*n\^{}2 + (68/15)*n + 1. a(n) = 6*a(n-1) - 15*a(n-2) + 20*a(n-3) - 15*a(n-4) + 6*a(n-5) - a(n-6) for n>6. (End)
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 17 2026 12:00:36, revision 15)
