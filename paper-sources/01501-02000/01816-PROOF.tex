...
\title{The empirical recurrence for OEIS A214115, proved by transfer matrix}
...
\begin{abstract}
OEIS A214115 counts the proper colourings of a grid $4\times(n+1)$, wrapped in the growing direction, with at most $4$ colours and
counted up to renaming the colours, and carries an empirical recurrence of order $26$
...
down to $S=638$ and makes the exact residual test affordable.
\end{abstract}
...
OEIS A214115 is ``Number of 0..3 colorings of a 4X(n+1) array circular in the n+1 direction with new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
172, 1331, 110985, 3008980, 136579852, 4797577911, 191154162535, 7146408189140,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 16:52:27, revision 8) this is still
...
state count is $S=638$ rather than the number of colourings.
...
\begin{theorem}
\[
a(n)\;=\;26\,a(n-1) + 793\,a(n-2) - 10672\,a(n-3) - 111685\,a(n-4) + 1555742\,a(n-5) + 3279675\,a(n-6) - 80896036\,a(n-7) + 42501359\,a(n-8) + 1864752866\,a(n-9) - 2747661047\,a(n-10) - 22752052704\,a(n-11) + 41970382902\,a(n-12) + 159827903260\,a(n-13) - 310989873234\,a(n-14) - 665904810616\,a(n-15) + 1268829519909\,a(n-16) + 1620764697790\,a(n-17) - 2947553967077\,a(n-18) - 2132419325552\,a(n-19) + 3856072745271\,a(n-20) + 1195236104310\,a(n-21) - 2617797795489\,a(n-22) + 77268263580\,a(n-23) + 689877538245\,a(n-24) - 233806181994\,a(n-25) + 22293440379\,a(n-26)
\]
for every $n>24$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A214115.
