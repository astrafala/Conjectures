...
\title{The empirical recurrence for OEIS A252883, proved by transfer matrix}
...
\begin{abstract}
OEIS A252883 counts arrays of width $3$ over an alphabet of $3$ letters in which every three
...
brings the state count down to $S=107$.
\end{abstract}
...
OEIS A252883 is ``Number of (1+2)X(n+2) 0..2 arrays with every consecutive three elements in every row having 2 or 3 distinct values, in every column 1 or 2 distinct values, in every diagonal 2 distinct values, and in every antidiagonal 2 distinct values, and new values 0 upwards introduced in row major order.''. It has offset $1$ and begins
\[
510, 3847, 28474, 211881, 1575377, 11720268, 87198323, 648799167,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:43:31, revision 6) this is still
...
\text{a row} & $(i,j),\ (i,j+1),\ (i,j+2)$ & $1, 2$ \\
\text{a column} & $(i,j),\ (i+1,j),\ (i+2,j)$ & $2, 3$ \\
\text{a diagonal (nw--se)} & $(i,j),\ (i+1,j+1),\ (i+2,j+2)$ & $2$ \\
\text{an antidiagonal (ne--sw)} & $(i,j),\ (i+1,j-1),\ (i+2,j-2)$ & $2$ \\
\end{array}
\]
...
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,
\]
with $S=107$ states in all. The walk index $j$ and the entry's own $n$ differ by a constant,
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-1) + 20\,a(n-2) - 185\,a(n-3) - 122\,a(n-4) + 1143\,a(n-5) + 648\,a(n-6) - 1146\,a(n-7) - 3579\,a(n-8) - 11329\,a(n-9) + 5610\,a(n-10) + 46499\,a(n-11) + 12723\,a(n-12) - 51010\,a(n-13) - 23963\,a(n-14) - 86046\,a(n-15) - 67672\,a(n-16) + 201912\,a(n-17) + 206293\,a(n-18) + 29694\,a(n-19) - 172585\,a(n-20) - 239780\,a(n-21) - 25780\,a(n-22) + 111228\,a(n-23) + 97884\,a(n-24) - 1768\,a(n-25) - 49360\,a(n-26) - 9504\,a(n-27) + 2048\,a(n-28) - 256\,a(n-29)
\]
for every $n>29$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252883.
