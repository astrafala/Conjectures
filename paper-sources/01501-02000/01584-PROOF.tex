...
\title{The empirical recurrence for OEIS A208861, proved by counting patterns}
...
\begin{abstract}
OEIS A208861 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
$27$, contributed by R.~H.~Hardin, then follows from a finite exact computation.
\end{abstract}
...
OEIS A208861 is ``Number of nX5 0..3 arrays with new values 0..3 introduced in row major order and no element equal to more than one of its immediate leftward or upward or left-upward diagonal neighbors.''. It has offset $1$ and begins
\[
51, 23047, 12883280, 7240366702, 4071491223248, 2289701830963879, 1287681340443915644, 724166398812363542260,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 15:02:48, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;831\,a(n-1) - 179993\,a(n-2) + 17822337\,a(n-3) - 914949819\,a(n-4) + 23168761555\,a(n-5) - 161356715633\,a(n-6) - 4487021565447\,a(n-7) + 88170625092243\,a(n-8) - 89146256087223\,a(n-9) - 9123849468343275\,a(n-10) + 57411954474413179\,a(n-11) + 280936943350232287\,a(n-12) - 3595338835588287543\,a(n-13) + 1929659835323795485\,a(n-14) + 90093226296032329771\,a(n-15) - 288134852946702870262\,a(n-16) - 742914836218346528932\,a(n-17) + 7115855576376274368216\,a(n-18) - 24955774603971431557536\,a(n-19) + 63937383750208880620992\,a(n-20) - 111375370598187857506560\,a(n-21) + 72057203548966403859456\,a(n-22) + 76274285418217337610240\,a(n-23) - 111975434876548575756288\,a(n-24) + 5300659781619687751680\,a(n-25) + 29374280040899283517440\,a(n-26) - 7836898836947747733504\,a(n-27)
\end{equation}
for all $n>28$.
...
For every $n$ with $m=n+0-1\ge27$,
\[
4!\Bigl(a(n)-\sum_i c_i\,a(n-i)\Bigr)\;=\;\mathbf{v}^{\!\top}N^{\,m-27}q(N)\mathbf{1} .
\]
...
\begin{proof}
Substitute \eqref{eq:walk} into the left side and factor $N^{m-27}$ out of
...
column. The vector $w=q(N)\mathbf{1}$ was then formed by $27$ matrix--vector products
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208861.
