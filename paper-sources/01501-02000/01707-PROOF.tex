...
\title{The empirical recurrence for OEIS A266034, proved by transfer matrix}
...
\begin{abstract}
OEIS A266034 counts arrays of width $2$ in which every entry is equal to the NUMBER of its own
...
OEIS A266034 is ``Number of 2Xn integer arrays with each element equal to the number of horizontal and antidiagonal neighbors less than itself.''. It has offset $1$ and begins
\[
1, 11, 50, 315, 2142, 13796, 89487, 578659,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 20 2015 07:45:49, revision 4) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=294.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A266034.
