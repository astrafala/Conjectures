...
\title{The empirical recurrence for OEIS A221103, proved by transfer matrix}
...
\begin{abstract}
OEIS A221103 counts the distinct OCCUPANCY arrays obtained when every cell of an $n\times2$ grid
...
determinising the machine that emits the occupancy row by row turns it into one, on $S=270$
...
OEIS A221103 is ``Number of nX2 arrays of occupancy after each element moves to some king-move neighbor, without 2-loops.''. It has offset $1$ and begins
\[
0, 13, 141, 1570, 16336, 168102, 1719791, 17563383,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 17*a(n-1) -80*a(n-2) +98*a(n-3) +145*a(n-4) -410*a(n-5) +336*a(n-6) -51*a(n-7) -41*a(n-8) +2*a(n-9)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 19:18:45, revision 9) this is still
...
\]
There are $S=270$ reachable sets. In particular $a$ is $C$-finite.
...
\begin{theorem}
\[
a(n)\;=\;17\,a(n-1) - 80\,a(n-2) + 98\,a(n-3) + 145\,a(n-4) - 410\,a(n-5) + 336\,a(n-6) - 51\,a(n-7) - 41\,a(n-8) + 2\,a(n-9)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221103.
