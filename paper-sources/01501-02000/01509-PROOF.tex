...
\title{The empirical recurrence for OEIS A202966, proved from an exact model}
...
\begin{abstract}
OEIS A202966 carries an empirical recurrence of order $15$. It is true, and it is
...
OEIS A202966 is ``Number of arrays of 6 integers in -n..n with sum zero and adjacent elements differing in absolute value.''. It has offset $1$ and begins
\[
0, 200, 1936, 9884, 33736, 90604, 207184, 421620,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) -3*a(n-4) +a(n-5) +a(n-6) +a(n-9) +a(n-10) -3*a(n-11) +2*a(n-14) -a(n-15)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 09:59:57, revision 9)
...
\]
annihilates $a$, and $S=\deg A=57$. A congruence condition modulo $m$ is counted one residue
...
exactly $\deg A$. The bound in force is therefore $zA(z)$, of order $S=57$, and
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) - 3\,a(n-4) + a(n-5) + a(n-6) + a(n-9) + a(n-10) - 3\,a(n-11) + 2\,a(n-14) - a(n-15)
\]
for every $n>0$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A202966.
