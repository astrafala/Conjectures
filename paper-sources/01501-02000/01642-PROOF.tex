...
\title{The empirical recurrence for OEIS A249964, proved from an exact model}
...
\begin{abstract}
OEIS A249964 carries an empirical recurrence of order $10$. It is true, and it is
...
OEIS A249964 is ``Number of length 4+5 0..n arrays with no six consecutive terms having the maximum of any two terms equal to the minimum of the remaining four terms.''. It has offset $1$ and begins
\[
15, 1593, 37584, 402010, 2662039, 12791191, 48882360, 157381572,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = n\^{}9 + (107/140)*n\^{}8 + (309/70)*n\^{}7 + (187/45)*n\^{}6 - (43/60)*n\^{}5 + (751/180)*n\^{}4 + (113/60)*n\^{}3 - (1003/630)*n\^{}2 + (193/210)*n. a(n) = 10*a(n-1) - 45*a(n-2) + 120*a(n-3) - 210*a(n-4) + 252*a(n-5) - 210*a(n-6) + 120*a(n-7) - 45*a(n-8) + 10*a(n-9) - a(n-10) for n>10.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 21 2017 13:10:47, revision 8)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A249964.
