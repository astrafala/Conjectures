...
\title{The empirical recurrence for OEIS A275269, proved by transfer matrix}
...
\begin{abstract}
OEIS A275269 counts arrays in which no entry may equal the entries at a short list of fixed offsets
...
OEIS A275269 is ``Number of 5Xn 0..2 arrays with no element equal to any value at offset (-2,-1) (-2,1) or (-1,-1) and new values introduced in order 0..2.''. It has offset $1$ and begins
\[
41, 172, 1440, 13156, 126420, 1224088, 11894712, 115625536,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 21 2016 11:37:16, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;11\,a(n-1) - 9\,a(n-2) - 45\,a(n-3) + 145\,a(n-4) - 295\,a(n-5) + 78\,a(n-6) - 438\,a(n-7) + 967\,a(n-8) - 1046\,a(n-9) - 1025\,a(n-10) + 1231\,a(n-11) + 225\,a(n-12) + 568\,a(n-13) + 55\,a(n-14) + 62\,a(n-15) + 6\,a(n-16) - a(n-18)
\]
for every $n>19$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A275269.
