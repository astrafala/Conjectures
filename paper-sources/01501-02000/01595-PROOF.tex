...
\title{The empirical recurrence for OEIS A212841, proved from an exact model}
...
\begin{abstract}
OEIS A212841 carries an empirical recurrence of order $9$. It is true, and it is
...
OEIS A212841 is ``Number of 0..n arrays of length 8 with 0 never adjacent to n.''. It has offset $1$ and begins
\[
2, 1393, 28642, 231521, 1168786, 4414417, 13667858, 36590017,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = n\^{}8 + 8*n\^{}7 + 14*n\^{}6 - 16*n\^{}5 - 30*n\^{}4 + 24*n\^{}3 + 8*n\^{}2 - 8*n + 1. a(n) = 9*a(n-1) - 36*a(n-2) + 84*a(n-3) - 126*a(n-4) + 126*a(n-5) - 84*a(n-6) + 36*a(n-7) - 9*a(n-8) + a(n-9) for n>9.
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 21 2018 10:07:36, revision 10)
...
vanish from $n=9+1$ onwards, and the run exceeds $S+9$, which by
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A212841.
