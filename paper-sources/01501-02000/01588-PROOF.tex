...
\title{The empirical recurrence for OEIS A221810, proved by transfer matrix}
...
\begin{abstract}
OEIS A221810 counts the distinct OCCUPANCY arrays obtained when every cell of an $n\times2$ grid
...
an empirical recurrence of order $11$ contributed by R.~H.~Hardin. It is true, and it is
...
one, on $S=94$ states, after which the conjectured recurrence is settled by a finite exact
computation.
\end{abstract}
...
OEIS A221810 is ``Number of 2Xn arrays of occupancy after each element moves to some horizontal, vertical or antidiagonal neighbor, without move-in move-out straight through or left turns.''. It has offset $1$ and begins
\[
1, 10, 34, 214, 1016, 5429, 27535, 142858,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) +18*a(n-2) +22*a(n-3) -14*a(n-4) -39*a(n-5) -44*a(n-6) -6*a(n-7) +7*a(n-8) +3*a(n-9) +4*a(n-10) +a(n-11)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 20:00:38, revision 8) this is still
...
$S=94$ reachable sets. In particular $a$ is $C$-finite.
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 18\,a(n-2) + 22\,a(n-3) - 14\,a(n-4) - 39\,a(n-5) - 44\,a(n-6) - 6\,a(n-7) + 7\,a(n-8) + 3\,a(n-9) + 4\,a(n-10) + a(n-11)
\]
for every $n>11$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221810.
