...
\title{The empirical recurrence for OEIS A204570, proved by counting patterns}
...
\begin{abstract}
OEIS A204570 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
state space down from $18700$ to $S=1145$. The entry's empirical recurrence of order
$42$, contributed by R.~H.~Hardin, then follows from a finite exact computation.
\end{abstract}
...
OEIS A204570 is ``Number of (n+1)X7 0..3 arrays with every 2X2 subblock having equal diagonal elements or equal antidiagonal elements, and new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
79162, 14421190, 3007468553, 657035534014, 146012317377342, 32661078401030941, 7323990345732323320, 1643927316387847539448,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 11:20:04, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;264\,a(n-1) + 4588\,a(n-2) - 4003265\,a(n-3) + 224879469\,a(n-4) + 553353548\,a(n-5) - 343473134840\,a(n-6) + 7432038196746\,a(n-7) + 88105820552062\,a(n-8) - 5074692763346853\,a(n-9) + 44304087343641647\,a(n-10) + 709536432163690932\,a(n-11) - 16314724685629256523\,a(n-12) + 63894778662957678214\,a(n-13) + 1174599563938664440730\,a(n-14) - 14766169265186897641126\,a(n-15) + 34201195988070896222172\,a(n-16) + 483184746554830772890536\,a(n-17) - 4050950552316502495934004\,a(n-18) + 7023965846622321018012372\,a(n-19) + 58423621132118323037170764\,a(n-20) - 364387094463598276300434216\,a(n-21) + 536365520282134051107838056\,a(n-22) + 2217672560144927305071947880\,a(n-23) - 11343124893545299835325761616\,a(n-24) + 15707887637086874858040622080\,a(n-25) + 22302792181177372943053857648\,a(n-26) - 115849473261152777042198163264\,a(n-27) + 163173820746523207617944424000\,a(n-28) - 19661113052480557168981018272\,a(n-29) - 242349444800289832472711914752\,a(n-30) + 327885678028770191656282433664\,a(n-31) - 130276720665657885355641649152\,a(n-32) - 100107759696457032103856306688\,a(n-33) + 141326010636999185296862355456\,a(n-34) - 58946789841617925076659204096\,a(n-35) - 1869792653347941858435182592\,a(n-36) + 11720692513664269193725820928\,a(n-37) - 5182657928243615484139585536\,a(n-38) + 1153927678640393484058853376\,a(n-39) - 144997235575045389551665152\,a(n-40) + 9789866623312184173658112\,a(n-41) - 276726208539320748343296\,a(n-42)
\end{equation}
for all $n>41$.

\section{What the canonical-form clause counts}

Fix the shape: $7$ columns and $L=n+1$ rows, so $L\cdot7$ cells. Call a
...
Assembling the $4$ lumped chains into one block-diagonal matrix $N$ of size $S=1145$ and
...
\end{equation}
The unlumped alphabet had $18700$ rows in all; the lumped chain has $S=1145$ states.
...
For every $n$ with $m=n+1-1\ge42$,
\[
4!\Bigl(a(n)-\sum_i c_i\,a(n-i)\Bigr)\;=\;\mathbf{v}^{\!\top}N^{\,m-42}q(N)\mathbf{1} .
\]
...
\begin{proof}
Substitute \eqref{eq:walk} into the left side and factor $N^{m-42}$ out of
...
\begin{theorem}
The recurrence \eqref{eq:conj} holds for every $n>41$, which is the statement of
Section~1.
\end{theorem}
...
column. The vector $w=q(N)\mathbf{1}$ was then formed by $42$ matrix--vector products
...
corresponding to $n=41+1$ onwards, and the run continued until $w$ was the zero vector,
...
\eqref{eq:walk}, divided by $4!$, was evaluated at every one of the $10$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204570.
