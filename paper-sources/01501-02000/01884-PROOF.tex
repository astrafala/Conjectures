...
\title{The empirical recurrence for OEIS A209075, proved from an exact model}
...
\begin{abstract}
OEIS A209075 carries an empirical recurrence of order $8$. It is true, and it is
...
OEIS A209075 is ``Number of 6-bead necklaces labeled with numbers -n..n not allowing reversal, with sum zero and avoiding the pattern z z+1 z+2.''. It has offset $1$ and begins
\[
19, 265, 1465, 5239, 14431, 33469, 68723, 128845,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 5*a(n-1) - 10*a(n-2) + 11*a(n-3) - 10*a(n-4) + 11*a(n-5) - 10*a(n-6) + 5*a(n-7) - a(n-8) for n > 9.
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 08 2018 10:48:08, revision 13)
...
vanish from $n=9+1$ onwards, and the run exceeds $S+8$, which by
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209075.
