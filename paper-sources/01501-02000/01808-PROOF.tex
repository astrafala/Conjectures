...
\title{The empirical recurrence for OEIS A200890, proved from an exact model}
...
\begin{abstract}
OEIS A200890 carries an empirical recurrence of order $8$. It is true, and it is
...
OEIS A200890 is ``Number of 0..n arrays x(0..6) of 7 elements without any interior element greater than both neighbors.''. It has offset $1$ and begins
\[
65, 704, 3823, 14288, 42182, 105813, 235538, 478467,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (4/315)*n\^{}7 + (7/9)*n\^{}6 + (241/45)*n\^{}5 + (1067/72)*n\^{}4 + (3757/180)*n\^{}3 + (1145/72)*n\^{}2 + (2629/420)*n + 1. a(n) = 8*a(n-1) - 28*a(n-2) + 56*a(n-3) - 70*a(n-4) + 56*a(n-5) - 28*a(n-6) + 8*a(n-7) - a(n-8) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 16 2017 10:50:01, revision 9)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A200890.
