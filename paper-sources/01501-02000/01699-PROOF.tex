...
\title{The empirical recurrence for OEIS A279574, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A279574 imposes three things at once: a condition on each cell that reaches one row up and
...
OEIS A279574 is ``Number of n X 2 0..2 arrays with no element equal to a strict majority of its horizontal and antidiagonal neighbors, with the exception of exactly one element, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
0, 4, 40, 352, 3008, 25280, 209792, 1723392,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 16*a(n-1) - 72*a(n-2) + 64*a(n-3) - 16*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 11 2019 05:20:16, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;16\,a(n-1) - 72\,a(n-2) + 64\,a(n-3) - 16\,a(n-4)
\end{equation}
for all $n>5$.
...
\[
3!\Bigl(a(n_0+j)-\sum_i c_i\,a(n_0+j-i)\Bigr)=\mathbf{v}^{\!\top}G^{\,j-4}w,
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A279574.
