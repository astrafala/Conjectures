...
\title{The empirical recurrence for OEIS A264491, proved by transfer matrix}
...
\begin{abstract}
OEIS A264491 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=3$ columns in which
...
OEIS A264491 is ``Number of (2+1) X (n+1) arrays of permutations of 0..n*3+2 with each element having directed index change 2,-1 1,0 2,1 0,-1 -2,-2 or -1,0.''. It has offset $1$ and begins
\[
3, 1, 10, 8, 35, 42, 130, 194,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-2) + 2*a(n-3) + a(n-4) - a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 08 2019 06:45:23, revision 10) this is still
...
\[
(i-h_i,\,j-h_j)\;\in\;\{(-2,-2),\ (-1,0),\ (-1,2),\ (0,-1),\ (0,1),\ (1,2)\},
\]
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-2) + 2\,a(n-3) + a(n-4) - a(n-5)
\]
for every $n>3$.
\end{theorem}
...
Second, the transfer model reproduces all $32$ terms this entry publishes, exactly, in
integer arithmetic.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264491.
