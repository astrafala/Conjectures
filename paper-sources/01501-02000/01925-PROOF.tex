...
\title{The empirical recurrence for OEIS A253031, proved by transfer matrix}
...
\begin{abstract}
OEIS A253031 counts arrays of width $5$ over an alphabet of $3$ letters in which every three
...
OEIS A253031 is ``Number of (n+2)X(3+2) 0..2 arrays with every consecutive three elements in every row and column having exactly two distinct values, and new values 0 upwards introduced in row major order.''. It has offset $1$ and begins
\[
9126, 102060, 1134864, 12647772, 141199416, 1576282464, 17600380920, 196546814928,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:52:16, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;12\,a(n-1) + 8\,a(n-2) - 96\,a(n-3) - 1220\,a(n-4) + 332\,a(n-5) + 12548\,a(n-6) + 11360\,a(n-7) - 41384\,a(n-8) - 112608\,a(n-9) + 7728\,a(n-10) + 341792\,a(n-11) + 337408\,a(n-12) - 210560\,a(n-13) - 870400\,a(n-14) - 1209856\,a(n-15) + 668672\,a(n-16) + 2822144\,a(n-17) + 458752\,a(n-18) - 1933312\,a(n-19) - 851968\,a(n-20)
\]
for every $n>19$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253031.
