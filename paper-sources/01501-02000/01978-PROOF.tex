...
\title{No column above the one before it in every row: OEIS A212942}
...
\begin{abstract}
OEIS A212942 carries an empirical recurrence of order $15$ contributed by R.~H.~Hardin. It is
...
OEIS A212942 is ``Number of nX7 0..6 arrays with no column j greater than or equal to than column j-1 in all rows.''. It has offset $1$ and begins
\[
1, 32383630189, 135992452878101359, 221920456466342315024785, 255478496068295791189905082231, 250841509251155966625680184691562929, 227328735342370296661661894900118524516359,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 16:41:25, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{The count is a walk count}

The entry counts arrays of $7$ columns whose rows are arbitrary over the alphabet $\{0,1,\dots,6\}$, and asks that no column $j$ be greater than or equal to column $j-1$ \emph{in all rows}.
...
\begin{theorem}
\[
a(n)\;=\;2323483\,a(n-1) - 2167154969952\,a(n-2) + 1086330796113513244\,a(n-3) - 329778884328286978977952\,a(n-4) + 64517502456132437770369148544\,a(n-5) - 8421554343462670052897532765935616\,a(n-6) + 747012180292693168982253383087616310272\,a(n-7) - 45320700037087646211097507312328132762984448\,a(n-8) + 1872991150391269654429084597380378344674028617728\,a(n-9) - 51936059702018704067955656273063090467733238547218432\,a(n-10) + 938955828089973458590692996057468119367652949010608553984\,a(n-11) - 10544878359956363252917775501846837273628118104421027150823424\,a(n-12) + 67581624519887879771651501946182123485150605725959917286635601920\,a(n-13) - 209181393867491964480827236276816398998810506947956308433062959513600\,a(n-14) + 205819420752306963772376008790571963882492713708055771807588273881088000\,a(n-15)
\]
for every $n>15$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A212942.
