...
\begin{quote}
Empirical: a(n) = n\^{}11 - (118/105)*n\^{}10 + (99637/15120)*n\^{}9 - (27427/5040)*n\^{}8 + (339/40)*n\^{}7 + (33/20)*n\^{}6 - (4957/720)*n\^{}5 + (15979/1680)*n\^{}4 - (34751/7560)*n\^{}3 + (1019/2520)*n\^{}2 + (5/12)*n. a(n) = 12*a(n-1) - 66*a(n-2) + 220*a(n-3) - 495*a(n-4) + 792*a(n-5) - 924*a(n-6) + 792*a(n-7) - 495*a(n-8) + 220*a(n-9) - 66*a(n-10) + 12*a(n-11) - a(n-12) for n>12.
\end{quote}
