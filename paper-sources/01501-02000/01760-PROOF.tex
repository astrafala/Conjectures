...
\title{The empirical recurrence for OEIS A209538, proved by transfer matrix}
...
\begin{abstract}
OEIS A209538 counts the permutations of the cells of an $n\times3$ array in which every cell
...
That makes $a$ a walk count on $S=72$ states, hence $C$-finite, and whether the published
...
OEIS A209538 is ``Number of n X 3 array permutations with every element making zero or one right-handed knight moves (out 2, right 1).''. It has offset $1$ and begins
\[
1, 2, 16, 72, 243, 1125, 5000, 20480,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 12 2026 11:49:36, revision 11) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + a(n-2) - 72\,a(n-5) + 288\,a(n-6) + 72\,a(n-7) + 306\,a(n-10) - 1224\,a(n-11) - 306\,a(n-12) + 72\,a(n-15) - 288\,a(n-16) - 72\,a(n-17) - a(n-20) + 4\,a(n-21) + a(n-22)
\]
for every $n>21$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209538.
