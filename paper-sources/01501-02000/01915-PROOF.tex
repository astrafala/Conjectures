...
\title{The empirical recurrence for OEIS A221576, proved from an exact model}
...
\begin{abstract}
OEIS A221576 carries an empirical recurrence of order $7$. It is true, and it is
...
OEIS A221576 is ``Number of 0..n arrays of length 6 with each element differing from at least one neighbor by something other than 1.''. It has offset $1$ and begins
\[
10, 141, 1210, 5913, 20944, 59705, 145800, 317233,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 1*n\^{}6 + 2*n\^{}5 - 5*n\^{}4 + 24*n\^{}3 - 41*n\^{}2 + 50*n - 31 for n>3. a(n) = 7*a(n-1) - 21*a(n-2) + 35*a(n-3) - 35*a(n-4) + 21*a(n-5) - 7*a(n-6) + a(n-7) for n>10.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 08 2018 18:37:20, revision 8)
...
\]
annihilates $a$, and $S=\deg A=14$. A congruence condition modulo $m$ is counted one residue
...
exactly $\deg A$. The bound in force is therefore $zA(z)$, of order $S=14$, and
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221576.
