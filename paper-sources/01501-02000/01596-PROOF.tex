...
\begin{quote}
Empirical: a(n) = (13/2880)*n\^{}8 + (13/180)*n\^{}7 + (145/288)*n\^{}6 + (719/360)*n\^{}5 + (14197/2880)*n\^{}4 + (2789/360)*n\^{}3 + (121/16)*n\^{}2 + (251/60)*n + 1. a(n) = 9*a(n-1) - 36*a(n-2) + 84*a(n-3) - 126*a(n-4) + 126*a(n-5) - 84*a(n-6) + 36*a(n-7) - 9*a(n-8) + a(n-9) for n>9.
\end{quote}
