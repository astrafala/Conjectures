...
\title{Arrays counted up to renaming: the empirical recurrence for OEIS A205629}
...
\begin{abstract}
OEIS A205629 carries an empirical recurrence of order $23$ contributed by R.~H.~Hardin. It is
...
OEIS A205629 is ``Number of 5X(n+1) 0..2 arrays with every 2X2 subblock in a row having an equal number of equal diagonal or equal antidiagonal elements, adjacent rows differing in this number, and new values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
2160, 13800, 113592, 1103436, 11438856, 122380932, 1324746888, 14418999468,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 12:13:50, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;19\,a(n-1) - 21\,a(n-2) - 1383\,a(n-3) + 5476\,a(n-4) + 38930\,a(n-5) - 219540\,a(n-6) - 522024\,a(n-7) + 4176096\,a(n-8) + 2940528\,a(n-9) - 44547552\,a(n-10) + 4418496\,a(n-11) + 279827584\,a(n-12) - 147694336\,a(n-13) - 1042856448\,a(n-14) + 791872512\,a(n-15) + 2285742080\,a(n-16) - 2019049472\,a(n-17) - 2838331392\,a(n-18) + 2692349952\,a(n-19) + 1810759680\,a(n-20) - 1778909184\,a(n-21) - 452984832\,a(n-22) + 452984832\,a(n-23)
\]
for every $n>23$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A205629.
