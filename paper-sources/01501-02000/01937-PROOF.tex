...
\title{The empirical recurrence for OEIS A281207, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A281207 imposes three things at once: a condition on each cell that reaches one column up and
...
OEIS A281207 is ``Number of 3 X n 0..1 arrays with no element equal to more than one of its horizontal and antidiagonal neighbors, with the exception of exactly one element, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
0, 10, 56, 98, 176, 310, 537, 922,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) - a(n-2) - 3*a(n-3) + a(n-4) + a(n-5) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 18 2019 06:50:34, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A281207.
