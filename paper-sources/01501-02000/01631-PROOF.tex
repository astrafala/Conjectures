...
\title{The empirical recurrence for OEIS A199532, proved from an exact model}
...
\begin{abstract}
OEIS A199532 carries an empirical recurrence of order $5$. It is true, and it is
...
OEIS A199532 is ``Number of -n..n arrays x(0..4) of 5 elements with zero sum and no two consecutive zero elements.''. It has offset $1$ and begins
\[
32, 320, 1324, 3734, 8470, 16682, 29750, 49284,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (115/12)*n\^{}4 + (115/6)*n\^{}3 + (41/12)*n\^{}2 - (1/6)*n. a(n) = 5*a(n-1) - 10*a(n-2) + 10*a(n-3) - 5*a(n-4) + a(n-5) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (May 15 2018 20:43:57, revision 9)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A199532.
