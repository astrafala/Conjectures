...
\title{The empirical recurrence for OEIS A264004, proved by transfer matrix}
...
\begin{abstract}
OEIS A264004 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=2$ columns in which
...
OEIS A264004 is ``Number of (1+1) X (n+1) arrays of permutations of 0..n*2+1 with each element having index change (+-,+-) 0,0 1,2 or 1,0.''. It has offset $1$ and begins
\[
4, 18, 81, 288, 1024, 3872, 14641, 54450,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) - 4*a(n-2) + 12*a(n-3) - 12*a(n-5) + 4*a(n-6) - 4*a(n-7) + a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 20 2018 20:37:10, revision 10) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) - 4\,a(n-2) + 12\,a(n-3) - 12\,a(n-5) + 4\,a(n-6) - 4\,a(n-7) + a(n-8)
\]
for every $n>6$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264004.
