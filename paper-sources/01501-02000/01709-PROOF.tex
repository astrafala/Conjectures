...
\title{The empirical recurrence for OEIS A184704, proved from an exact model}
...
\begin{abstract}
OEIS A184704 carries an empirical recurrence of order $10$. It is true, and it is
...
OEIS A184704 is ``Number of strings of numbers x(i=1..4) in 0..n with sum i*x(i) equal to n*4.''. It has offset $1$ and begins
\[
2, 7, 14, 28, 46, 74, 107, 154,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + a(n-2) - 2*a(n-5) + a(n-8) + a(n-9) - a(n-10).
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 14 2018 13:11:29, revision 9)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A184704.
