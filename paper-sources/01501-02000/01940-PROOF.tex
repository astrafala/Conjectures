...
\title{The empirical recurrence for OEIS A205317, proved by transfer matrix}
...
\begin{abstract}
OEIS A205317 counts, up to renaming the letters, the arrays of width $8$ over at most $2$
letters in which all the $2\times2$ subblocks of one array have the SAME number of equal edges, an equal edge being one of the four perimeter edges whose two cells agree; the common value is not named, so the count splits by it. It carries an empirical recurrence of order $20$ contributed by
...
OEIS A205317 is ``Number of (n+1)X8 0..1 arrays with every 2X2 subblock having the same number of equal edges, and new values 0..1 introduced in row major order.''. It has offset $1$ and begins
\[
4376, 161928, 6150512, 235994088, 9094954742, 351210375464, 13574876544398, 524918733085720,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 12:00:30, revision 9) this is still
...
The clause ``new values $0..1$ introduced in row major order'' says the array is the
...
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau
\]
on the disjoint union of those digraphs for $i=1,\dots,2$, with $\iota$ carrying the weights
$w_i$ cleared of denominators and $S=261$ states in all. The walk index $j$ and the entry's own
...
\begin{theorem}
\[
a(n)\;=\;106\,a(n-1) - 4578\,a(n-2) + 110127\,a(n-3) - 1685691\,a(n-4) + 17662632\,a(n-5) - 132490685\,a(n-6) + 732439565\,a(n-7) - 3041749572\,a(n-8) + 9607185471\,a(n-9) - 23244897123\,a(n-10) + 43214022033\,a(n-11) - 61676422325\,a(n-12) + 67255934696\,a(n-13) - 55515488409\,a(n-14) + 34166147646\,a(n-15) - 15313024644\,a(n-16) + 4816467696\,a(n-17) - 999456992\,a(n-18) + 121777664\,a(n-19) - 6527616\,a(n-20)
\]
for every $n>19$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A205317.
