...
\title{The empirical recurrence for OEIS A264158, proved by transfer matrix}
...
\begin{abstract}
OEIS A264158 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=2$ rows in which
...
OEIS A264158 is ``Number of (n+1) X (1+1) arrays of permutations of 0..n*2+1 with each element having directed index change 0,1 0,-1 0,2 1,0 -1,0 or 2,0.''. It has offset $1$ and begins
\[
4, 10, 29, 89, 260, 772, 2281, 6741,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + 2*a(n-2) + 2*a(n-3) + 4*a(n-5) - a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 21 2018 06:42:32, revision 11) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264158.
