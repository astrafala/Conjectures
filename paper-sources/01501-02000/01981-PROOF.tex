...
\title{The empirical recurrence for OEIS A275270, proved by transfer matrix}
...
\begin{abstract}
OEIS A275270 counts arrays in which no entry may equal the entries at a short list of fixed offsets
...
OEIS A275270 is ``Number of 6Xn 0..2 arrays with no element equal to any value at offset (-2,-1) (-2,1) or (-1,-1) and new values introduced in order 0..2.''. It has offset $1$ and begins
\[
122, 476, 5676, 73012, 1020324, 14005180, 194398028, 2686400148,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 21 2016 11:37:59, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;15\,a(n-1) + 3\,a(n-2) - 370\,a(n-3) + 1735\,a(n-4) - 3994\,a(n-5) + 4671\,a(n-6) - 5557\,a(n-7) + 17662\,a(n-8) - 35794\,a(n-9) - 70438\,a(n-10) + 88858\,a(n-11) + 82464\,a(n-12) + 406924\,a(n-13) + 235375\,a(n-14) + 163182\,a(n-15) - 71035\,a(n-16) - 197836\,a(n-17) - 137928\,a(n-18) - 51312\,a(n-19) + 39632\,a(n-20) + 35968\,a(n-21) + 19456\,a(n-22) - 6144\,a(n-23) - 4096\,a(n-24)
\]
for every $n>26$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A275270.
