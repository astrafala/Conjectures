...
\title{The empirical recurrence for OEIS A269607, proved from an exact model}
...
\begin{abstract}
OEIS A269607 carries an empirical recurrence of order $5$. It is true, and it is
...
OEIS A269607 is ``Number of length-4 0..n arrays with no repeated value differing from the previous repeated value by one or less.''. It has offset $1$ and begins
\[
8, 62, 222, 572, 1220, 2298, 3962, 6392,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = n\^{}4 + 4*n\^{}3 + 4*n\^{}2 - n. a(n) = 5*a(n-1) - 10*a(n-2) + 10*a(n-3) - 5*a(n-4) + a(n-5) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 25 2019 08:28:57, revision 8)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269607.
