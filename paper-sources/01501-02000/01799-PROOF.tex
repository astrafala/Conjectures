...
\title{The empirical recurrence for OEIS A235767, proved by transfer matrix}
...
\begin{abstract}
OEIS A235767 counts arrays of width $3$ over $\{0,1\}$ by reducing every $2\times2$ subblock to a
...
about it is one bit per adjacent pair of columns, so the count is a walk count on $S=60$
states.
\end{abstract}
...
OEIS A235767 is ``Number of (n+1)X(2+1) 0..1 arrays with the sum of each 2X2 subblock two extreme terms minus its two median terms lexicographically nondecreasing columnwise and nonincreasing rowwise.''. It has offset $1$ and begins
\[
46, 178, 628, 1948, 5643, 15185, 39029, 95779,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 08:48:13, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + 6\,a(n-2) - 42\,a(n-3) + 5\,a(n-4) + 178\,a(n-5) - 130\,a(n-6) - 380\,a(n-7) + 440\,a(n-8) + 400\,a(n-9) - 688\,a(n-10) - 128\,a(n-11) + 528\,a(n-12) - 96\,a(n-13) - 160\,a(n-14) + 64\,a(n-15)
\]
for every $n>15$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A235767.
