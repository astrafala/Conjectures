...
\title{Recovering the unwritten recurrences of the table OEIS A236155}
...
\begin{abstract}
OEIS A236155 is a two-dimensional table $T(n,k)$ whose empirical recurrences are, for several of
...
OEIS A236155 is ``T(n,k)=Number of (n+1)X(k+1) 0..2 arrays colored with the sets of distinct values in every 2X2 subblock.''. It is read by antidiagonals and begins
\[
81, 414, 414, 2148, 2502, 2148, 11064, 16128,\ \dots
\]
The entry carries, among its empirical claims:
\begin{quote}\small
k=2: [order 8]
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 09:09:47, revision 6) these are still
...
count, a walk on $S=414$ vertices. Berlekamp--Massey on $2S=828$ exact terms
returns a minimal recurrence of order $8$ --- the order the entry states --- with
integer coefficients
\begin{center}\small\begin{tabular}{cccccccc}
$c_{1}$ & $3$ & $c_{3}$ & $24$ & $c_{5}$ & $-22$ & $c_{7}$ & $-2$ \\
$c_{2}$ & $19$ & $c_{4}$ & $-1$ & $c_{6}$ & $-11$ & $c_{8}$ & $-2$ \\
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A236155.
