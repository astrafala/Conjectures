...
\title{The empirical recurrence for OEIS A275091, proved by counting patterns}
...
\begin{abstract}
OEIS A275091 counts arrays in which no entry may repeat a value found at any of three stated
...
cutting $794$ pairs to $S=155$ states. The entry's empirical recurrence of order $36$,
...
OEIS A275091 is ``Number of 3Xn 0..2 arrays with no element equal to any value at offset (0,-2) (-1,-2) or (-2,-1) and new values introduced in order 0..2.''. It has offset $1$ and begins
\[
5, 81, 192, 508, 1680, 5304, 17184, 54484,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 16 2016 09:23:59, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 9\,a(n-2) - 10\,a(n-3) - 30\,a(n-4) + 3\,a(n-5) + 90\,a(n-6) + 117\,a(n-7) - 366\,a(n-8) - 129\,a(n-9) + 477\,a(n-10) - 102\,a(n-11) - 166\,a(n-12) + 659\,a(n-13) + 144\,a(n-14) - 1305\,a(n-15) - 317\,a(n-16) + 1101\,a(n-17) + 9\,a(n-18) - 613\,a(n-19) + 657\,a(n-20) - 96\,a(n-21) - 422\,a(n-22) + 72\,a(n-23) + 167\,a(n-24) + 295\,a(n-25) - 252\,a(n-26) - 148\,a(n-27) + 133\,a(n-28) + 33\,a(n-29) + 19\,a(n-30) - 39\,a(n-31) + 8\,a(n-33) + 2\,a(n-34) - a(n-36)
\end{equation}
for all $n>38$.
...
$o=1n_0+0-2$, we have for $j\ge36$
\[
3!\Bigl(a(n_0+j)-\sum_i c_i\,a(n_0+j-i)\Bigr)
=\mathbf{v}^{\!\top}G^{\,j-36}w,\qquad
w=h_{36}-\sum_i c_i h_{36-i} .
\]
...
the survivors by the pattern of the new pair. The vector $w$ was formed by $36$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A275091.
