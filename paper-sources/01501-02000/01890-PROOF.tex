...
\title{The empirical recurrence for OEIS A224201, proved by transfer matrix}
...
\begin{abstract}
OEIS A224201 counts arrays over $\{0,\dots,3\}$ whose rows, columns, diagonals or
antidiagonals are required to be monotone or unimodal, and carries an empirical recurrence of
order $19$ contributed by R.~H.~Hardin. A monotone condition is local, but a unimodal one
...
is a walk count on $S=296$ vertices and the recurrence follows from a finite exact
computation.
\end{abstract}
...
OEIS A224201 is ``Number of nX5 0..3 arrays with rows unimodal and antidiagonals nondecreasing.''. It has offset $1$ and begins
\[
296, 17723, 586343, 16355242, 451319098, 12652618110, 357890479324, 10153767871028,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 23:19:01, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;56\,a(n-1) - 1098\,a(n-2) + 10776\,a(n-3) - 59038\,a(n-4) + 197135\,a(n-5) - 527776\,a(n-6) + 1780117\,a(n-7) - 5020078\,a(n-8) + 3603978\,a(n-9) - 19091082\,a(n-10) + 61460622\,a(n-11) + 49090018\,a(n-12) + 274177128\,a(n-13) + 105163104\,a(n-14) + 354022404\,a(n-15) + 28705280\,a(n-16) + 147891456\,a(n-17) - 1275168\,a(n-18) + 15980544\,a(n-19)
\end{equation}
for all $n>23$.
...
bit vector), $|\mathcal V|=S=296$; let $(r,f)\to(s,f')$ be an edge when placing $s$ after $r$
...
$h_j=G^{j}N^{o}\mathbf{1}$, we have for $j\ge19$
\[
a(n_0+j)-\sum_i c_i\,a(n_0+j-i)=\,\mathbf{v}^{\!\top}G^{\,j-19}w,
\qquad w=h_{19}-\sum_i c_ih_{19-i} .
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224201.
