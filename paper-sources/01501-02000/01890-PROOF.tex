...
\title{The empirical recurrence for OEIS A245874, proved from an exact model}
...
\begin{abstract}
OEIS A245874 carries an empirical recurrence of order $8$. It is true, and it is
...
OEIS A245874 is ``Number of length 5+2 0..n arrays with some pair in every consecutive three terms totalling exactly n.''. It has offset $1$ and begins
\[
42, 553, 1764, 4753, 9726, 18505, 31176, 50401,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + 2*a(n-2) - 6*a(n-3) + 6*a(n-5) - 2*a(n-6)  -2*a(n-7) + a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 04 2018 13:05:08, revision 7)
...
\]
annihilates $a$, and $S=\deg A=33$. A congruence condition modulo $m$ is counted one residue
...
exactly $\deg A$. The bound in force is therefore $zA(z)$, of order $S=33$, and
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A245874.
