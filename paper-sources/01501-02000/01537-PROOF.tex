...
\title{The empirical recurrence for OEIS A221304, proved by transfer matrix}
...
\begin{abstract}
OEIS A221304 counts the distinct OCCUPANCY arrays obtained when every cell of an $n\times2$ grid
...
determinising the machine that emits the occupancy row by row turns it into one, on $S=28$
...
OEIS A221304 is ``Number of n X 2 arrays of occupancy after each element moves to some horizontal, vertical or antidiagonal neighbor, with every occupancy equal to zero or two.''. It has offset $1$ and begins
\[
0, 5, 10, 31, 90, 259, 746, 2150,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) - 3*a(n-2) - 2*a(n-4) + a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 05 2018 08:21:57, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) - 3\,a(n-2) - 2\,a(n-4) + a(n-6)
\]
for every $n>6$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221304.
