...
\title{The empirical recurrence for OEIS A245999, proved from an exact model}
...
\begin{abstract}
OEIS A245999 carries an empirical recurrence of order $11$. It is true, and it is
...
OEIS A245999 is ``Number of length 4+2 0..n arrays with no pair in any consecutive three terms totalling exactly n.''. It has offset $1$ and begins
\[
2, 26, 396, 2196, 9582, 29790, 80504, 185192,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) +a(n-2) -11*a(n-3) +6*a(n-4) +14*a(n-5) -14*a(n-6) -6*a(n-7) +11*a(n-8) -a(n-9) -3*a(n-10) +a(n-11).
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 21 2021 15:10:57, revision 9)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A245999.
