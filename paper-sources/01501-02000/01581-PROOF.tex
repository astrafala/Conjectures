...
\title{The empirical recurrence for OEIS A183954, proved from an exact model}
...
\begin{abstract}
OEIS A183954 carries an empirical recurrence of order $11$. It is true, and it is
...
OEIS A183954 is ``Number of strings of numbers x(i=1..3) in 0..n with sum i\^{}2*x(i) equal to n*9.''. It has offset $1$ and begins
\[
1, 2, 2, 3, 4, 6, 7, 9,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) - a(n-2) + a(n-9) - 2*a(n-10) + a(n-11).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 22 2022 05:14:58, revision 13)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A183954.
