...
\title{The empirical recurrence for OEIS A183469, proved by transfer matrix}
...
\begin{abstract}
OEIS A183469 counts arrays of width $4$ over $\{0,1\}$ in which every cell is the sum of one of two groups of its neighbours. The entry carries an
...
OEIS A183469 is ``Number of nX4 binary arrays with every element equal to either the sum mod 2 of its vertical neighbors or the sum mod 2 of its horizontal neighbors.''. It has offset $1$ and begins
\[
4, 28, 111, 550, 2769, 13338, 66012, 326010,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 01:46:02, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + 2\,a(n-2) + 43\,a(n-3) - 120\,a(n-4) - 28\,a(n-5) - 843\,a(n-6) + 1176\,a(n-7) - 295\,a(n-8) + 8176\,a(n-9) - 4388\,a(n-10) + 7759\,a(n-11) - 37223\,a(n-12) + 7835\,a(n-13) - 46292\,a(n-14) + 89188\,a(n-15) - 10524\,a(n-16) + 120676\,a(n-17) - 118801\,a(n-18) + 2332\,a(n-19) - 165492\,a(n-20) + 73493\,a(n-21) + 32085\,a(n-22) + 126221\,a(n-23) + 24117\,a(n-24) - 42421\,a(n-25) - 43901\,a(n-26) - 35527\,a(n-27) + 9272\,a(n-28) + 9759\,a(n-29) - 9458\,a(n-30) + 2573\,a(n-31) - 11427\,a(n-32) + 1448\,a(n-33) + 2224\,a(n-34) - 2291\,a(n-35) + 1897\,a(n-36) - 661\,a(n-37) - 27\,a(n-38) + 297\,a(n-39) + 27\,a(n-40) - 66\,a(n-41) + 3\,a(n-42) - 15\,a(n-43) - 2\,a(n-44) + 4\,a(n-45)
\]
for every $n>44$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A183469.
