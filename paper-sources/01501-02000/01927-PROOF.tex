...
\title{The empirical recurrence for OEIS A275347, proved by counting patterns}
...
\begin{abstract}
OEIS A275347 counts arrays in which no entry may repeat a value found at any of three stated
...
cutting $794$ pairs to $S=155$ states. The entry's empirical recurrence of order $17$,
...
OEIS A275347 is ``Number of nX3 0..2 arrays with no element equal to any value at offset (-2,-1) (-2,1) or (-1,-2) and new values introduced in order 0..2.''. It has offset $1$ and begins
\[
5, 81, 288, 1024, 4100, 16956, 70272, 291320,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 24 2016 10:00:55, revision 5) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) + 12\,a(n-2) - 48\,a(n-3) + 66\,a(n-4) - 210\,a(n-5) - 1120\,a(n-6) + 4028\,a(n-7) - 93\,a(n-8) - 4098\,a(n-9) + 27840\,a(n-10) - 78748\,a(n-11) - 37816\,a(n-12) + 204592\,a(n-13) - 97088\,a(n-14) - 576\,a(n-15) + 25984\,a(n-16) - 12544\,a(n-17)
\end{equation}
for all $n>20$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A275347.
