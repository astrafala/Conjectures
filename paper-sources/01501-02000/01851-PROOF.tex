...
\title{The empirical recurrence for OEIS A265993, proved by transfer matrix}
...
\begin{abstract}
OEIS A265993 counts arrays of width $3$ in which every entry is equal to the NUMBER of its own
...
OEIS A265993 is ``Number of 3 X n integer arrays with each element equal to the number of horizontal and antidiagonal neighbors not equal to itself.''. It has offset $1$ and begins
\[
1, 2, 6, 2, 3, 9, 9, 16,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 09 2019 09:12:34, revision 7) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=609.
\]
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 2\,a(n-3) + a(n-4) - 3\,a(n-5) - a(n-6) - a(n-7) + a(n-8) + 7\,a(n-9) - 2\,a(n-10) - 4\,a(n-11) + 9\,a(n-14) + 3\,a(n-15) - 8\,a(n-16) - 4\,a(n-17)
\]
for every $n>20$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A265993.
