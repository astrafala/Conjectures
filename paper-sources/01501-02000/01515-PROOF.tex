...
\title{The empirical recurrence for OEIS A200060, proved from an exact model}
...
\begin{abstract}
OEIS A200060 carries an empirical recurrence of order $13$. It is true, and it is
...
OEIS A200060 is ``Number of -n..n arrays x(0..5) of 6 elements with zero sum and elements alternately strictly increasing and strictly decreasing.''. It has offset $1$ and begins
\[
10, 178, 1098, 4172, 11962, 28554, 59910, 114232,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) -2*a(n-2) -a(n-3) +2*a(n-5) -a(n-6) -a(n-7) +2*a(n-8) -a(n-10) -2*a(n-11) +3*a(n-12) -a(n-13).
\end{quote}
As of the ``Last modified'' line on the live entry (May 17 2018 11:07:03, revision 8)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A200060.
