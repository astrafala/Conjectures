...
\title{The empirical recurrence for OEIS A281159, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A281159 imposes three things at once: a condition on each cell that reaches one row up and
...
OEIS A281159 is ``Number of nX2 0..1 arrays with no element equal to more than three of its king-move neighbors, with the exception of exactly two elements, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
0, 0, 5, 18, 85, 346, 1388, 5454,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 16 2017 08:55:05, revision 5) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;9\,a(n-1) - 24\,a(n-2) + 15\,a(n-3) - 18\,a(n-4) + 75\,a(n-5) + 55\,a(n-6) - 54\,a(n-7) - 102\,a(n-8) - 184\,a(n-9) + 36\,a(n-10) + 168\,a(n-11) + 136\,a(n-12) + 48\,a(n-13) - 96\,a(n-14) - 64\,a(n-15)
\end{equation}
for all $n>16$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A281159.
