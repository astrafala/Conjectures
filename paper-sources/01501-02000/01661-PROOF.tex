...
\title{The empirical recurrence for OEIS A268747, proved by transfer matrix}
...
\begin{abstract}
OEIS A268747 counts arrays of width $5$ over $\{0,1\}$ in which the number of adjacent PAIRS of
...
result is a walk count on $S=69$ states.
\end{abstract}
...
OEIS A268747 is ``Number of nX5 binary arrays with some element plus some horizontally or vertically adjacent neighbor totalling two no more than once.''. It has offset $1$ and begins
\[
23, 244, 2615, 26334, 255651, 2425799, 22577073, 207252725,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 12 2016 12:31:55, revision 4) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The array has $5$ cells across, with entries in $\{0,1\}$. An ADJACENT PAIR is a pair of cells
\[
\begin{array}{l}
$(i,j)\text{ and }(i,j{+}1)$ \\
$(i,j)\text{ and }(i{+}1,j)$ \\
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268747.
