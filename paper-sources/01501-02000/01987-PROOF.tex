...
\begin{quote}
Empirical: a(n) = (1/720)*n\^{}6 + (13/240)*n\^{}5 + (125/144)*n\^{}4 + (117/16)*n\^{}3 + (12287/360)*n\^{}2 - (4421/30)*n - 44 for n>3. a(n) = 7*a(n-1) - 21*a(n-2) + 35*a(n-3) - 35*a(n-4) + 21*a(n-5) - 7*a(n-6) + a(n-7) for n>10.
\end{quote}
