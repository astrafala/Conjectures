...
\title{The empirical recurrence for OEIS A200554, proved from an exact model}
...
\begin{abstract}
OEIS A200554 carries an empirical recurrence of order $8$. It is true, and it is
...
OEIS A200554 is ``Number of -n..n arrays x(0..3) of 4 elements with zero sum and nonzero second differences.''. It has offset $1$ and begins
\[
14, 76, 200, 446, 836, 1368, 2134, 3140,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) -a(n-2) +2*a(n-3) -4*a(n-4) +2*a(n-5) -a(n-6) +2*a(n-7) -a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 24 2025 11:24:38, revision 12)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A200554.
