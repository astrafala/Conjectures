...
\begin{quote}
Empirical: a(n) = n\^{}8 + (152/105)*n\^{}7 + (62/15)*n\^{}6 + (26/5)*n\^{}5 + (1/2)*n\^{}4 + (19/15)*n\^{}3 + (28/15)*n\^{}2 - (29/70)*n. a(n) = 9*a(n-1) - 36*a(n-2) + 84*a(n-3) - 126*a(n-4) + 126*a(n-5) - 84*a(n-6) + 36*a(n-7) - 9*a(n-8) + a(n-9) for n>9.
\end{quote}
