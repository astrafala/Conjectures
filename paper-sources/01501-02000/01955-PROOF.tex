...
\title{The empirical recurrence for OEIS A269470, proved from an exact model}
...
\begin{abstract}
OEIS A269470 carries an empirical recurrence of order $7$. It is true, and it is
...
OEIS A269470 is ``Number of length-6 0..n arrays with no repeated value equal to the previous repeated value.''. It has offset $1$ and begins
\[
22, 462, 3180, 13300, 41730, 108402, 246232, 505800,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = n\^{}6 + 6*n\^{}5 + 11*n\^{}4 + 4*n\^{}3 - n\^{}2 + n. a(n) = 7*a(n-1) - 21*a(n-2) + 35*a(n-3) - 35*a(n-4) + 21*a(n-5) - 7*a(n-6) + a(n-7) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 23 2019 07:12:07, revision 7)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269470.
