...
\title{The empirical recurrence for OEIS A281401, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A281401 imposes three things at once: a condition on each cell that reaches one column up and
...
OEIS A281401 is ``Number of 2 X n 0..1 arrays with no element equal to more than two of its horizontal, diagonal or antidiagonal neighbors, with the exception of exactly one element, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
0, 0, 10, 52, 170, 484, 1296, 3308,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 4*a(n-1) + a(n-2) - 16*a(n-3) - a(n-4) + 30*a(n-5) + 4*a(n-6) - 24*a(n-7) - 4*a(n-8) + 8*a(n-9) for n>10.
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 06 2026 08:34:33, revision 12) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) + a(n-2) - 16\,a(n-3) - a(n-4) + 30\,a(n-5) + 4\,a(n-6) - 24\,a(n-7) - 4\,a(n-8) + 8\,a(n-9)
\end{equation}
for all $n>10$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A281401.
