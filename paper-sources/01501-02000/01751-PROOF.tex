...
\title{The empirical recurrence for OEIS A232910, proved by transfer matrix}
...
\begin{abstract}
OEIS A232910 counts arrays of width $3$ over $\{0,1,2\}$ in which every cell sees its own value plus and minus one among its neighbours. The entry carries an
...
OEIS A232910 is ``Number of (2+1) X (n+1) 0..2 arrays with every element next to itself plus and minus one within the range 0..2 horizontally or antidiagonally.''. It has offset $1$ and begins
\[
4, 34, 320, 2958, 27692, 250934, 2338508, 21159320,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 09 2023 17:25:27, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 22\,a(n-2) + 284\,a(n-3) + 1034\,a(n-4) + 1536\,a(n-5) - 10076\,a(n-6) - 58252\,a(n-7) + 51408\,a(n-8) + 498496\,a(n-9) - 391702\,a(n-10) - 7998492\,a(n-11) - 4700227\,a(n-12) + 44572282\,a(n-13) - 40476506\,a(n-14) - 186165084\,a(n-15) + 241000952\,a(n-16) + 553905740\,a(n-17) + 53162532\,a(n-18) - 1539394488\,a(n-19) + 525708784\,a(n-20) + 2909661120\,a(n-21) - 4710162944\,a(n-22) + 146430976\,a(n-23) + 3625709568\,a(n-24) - 4520968192\,a(n-25) + 1704722432\,a(n-26) - 506986496\,a(n-27) - 700448768\,a(n-28) + 167772160\,a(n-29)
\]
for every $n>30$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232910.
