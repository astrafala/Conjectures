...
\title{The empirical recurrence for OEIS A209346, proved from an exact model}
...
\begin{abstract}
OEIS A209346 carries an empirical recurrence of order $9$. It is true, and it is
...
OEIS A209346 is ``Number of 5-bead necklaces labeled with numbers -n..n allowing reversal, with sum zero with no three beads in a row equal.''. It has offset $1$ and begins
\[
5, 40, 145, 400, 883, 1724, 3045, 5026,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + a(n-2) - 3*a(n-3) - a(n-4) + a(n-5) + 3*a(n-6) - a(n-7) - 2*a(n-8) + a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 09 2018 08:23:04, revision 11)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209346.
