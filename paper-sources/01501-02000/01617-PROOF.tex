...
\title{The empirical recurrence for OEIS A264585, proved by transfer matrix}
...
\begin{abstract}
OEIS A264585 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=3$ columns in which
...
OEIS A264585 is ``Number of (2+1) X (n+1) arrays of permutations of 0..n*3+2 with each element having directed index change 1,0 0,-1 1,2 or -1,1.''. It has offset $1$ and begins
\[
1, 2, 4, 10, 16, 56, 128, 320,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + 16*a(n-5) - 16*a(n-6) + 32*a(n-7) - 64*a(n-10).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 08 2019 19:00:51, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 16\,a(n-5) - 16\,a(n-6) + 32\,a(n-7) - 64\,a(n-10)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264585.
