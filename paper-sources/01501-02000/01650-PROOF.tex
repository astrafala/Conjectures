...
\title{The empirical recurrence for OEIS A203909, proved by transfer matrix}
...
\begin{abstract}
OEIS A203909 counts arrays of width $2$ over $\{0,1,\dots,6\}$ through two derived arrays of PAIR SUMS ---
each cell added to its left neighbour, and each cell added to the one above it --- on which the
entry imposes an order condition. The entry carries an empirical recurrence of order $18$
contributed by R.~H.~Hardin. It is true, and it is decidable rather than empirical: the count is
a walk count on $S=98$ states.
\end{abstract}
...
OEIS A203909 is ``Number of (n+1)X2 0..6 arrays with column and row pair sums b(i,j)=a(i,j)+a(i,j-1) and c(i,j)=a(i,j)+a(i-1,j) such that rows of b(i,j) and columns of c(i,j) are lexicographically nondecreasing.''. It has offset $1$ and begins
\[
728, 13006, 203994, 2788842, 34183816, 384541867, 4038515481, 40101448387,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 10:50:33, revision 10) this is still
...
\begin{theorem}
\[
a(n)\;=\;54\,a(n-1) - 1340\,a(n-2) + 20282\,a(n-3) - 209613\,a(n-4) + 1569268\,a(n-5) - 8811864\,a(n-6) + 37918836\,a(n-7) - 126686043\,a(n-8) + 330947422\,a(n-9) - 677517012\,a(n-10) + 1084545362\,a(n-11) - 1348021991\,a(n-12) + 1284251736\,a(n-13) - 918050584\,a(n-14) + 475708320\,a(n-15) - 168477552\,a(n-16) + 36443520\,a(n-17) - 3628800\,a(n-18)
\]
for every $n>17$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A203909.
