...
\title{The empirical recurrence for OEIS A264067, proved by transfer matrix}
...
\begin{abstract}
OEIS A264067 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=5$ rows in which
...
OEIS A264067 is ``Number of (n+1) X (4+1) arrays of permutations of 0..n*5+4 with each element having index change +-(.,.) 0,0 1,1 or 1,2.''. It has offset $1$ and begins
\[
34, 605, 12100, 239580, 4745620, 94000060, 1861931060, 36880691100,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 19*a(n-1) +16*a(n-2) for n>3.
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 26 2025 18:44:40, revision 12) this is still
...
\[
(i-h_i,\,j-h_j)\;\in\;\{(-1,-2),\ (-1,-1),\ (0,0),\ (1,1),\ (1,2)\},
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264067.
