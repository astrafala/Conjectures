...
\title{The empirical recurrence for OEIS A269413, proved from an exact model}
...
\begin{abstract}
OEIS A269413 carries an empirical recurrence of order $8$. It is true, and it is
...
\begin{quote}
Empirical: a(n) = n\^{}7 + 7*n\^{}6 + 11*n\^{}5 + (8/3)*n\^{}4 - (11/6)*n\^{}3 + (1/3)*n\^{}2 - (1/6)*n. a(n) = 8*a(n-1) - 28*a(n-2) + 56*a(n-3) - 70*a(n-4) + 56*a(n-5) - 28*a(n-6) + 8*a(n-7) - a(n-8) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 21 2019 12:25:20, revision 8)
