...
\title{The empirical recurrence for OEIS A229573, proved by counting defective colourings}
...
\begin{abstract}
OEIS A229573 counts the colourings of an array with $K=4$ colours that are proper except at
...
numbers. What is left is a walk count on $S=200$ vertices, and the empirical recurrence of
...
OEIS A229573 is ``Number of defective 4-colorings of an n X 3 0..3 array connected horizontally, vertically, diagonally and antidiagonally with exactly one mistake, and colors introduced in row-major 0..3 order.''. It has offset $1$ and begins
\[
2, 26, 76, 171, 362, 757, 1584, 3323,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 6*a(n-1) - 13*a(n-2) + 12*a(n-3) - 4*a(n-4) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 19 2018 06:13:53, revision 7) the statement is
...
The arrays have $3$ columns and $L=n$ rows, entries in $\{0,\dots,4-1\}$.
...
Fix $i$ and take as vertices the pairs $(r,c)$ with $r\in\{0,\dots,i-1\}^{3}$ a row
...
Assembling the $4$ chains block-diagonally into $N$ of size $S=200$ with the weights of
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A229573.
