...
\title{The empirical recurrence for OEIS A275040, proved by counting patterns}
...
\begin{abstract}
OEIS A275040 counts arrays in which no entry may repeat a value found at any of three stated
...
OEIS A275040 is ``Number of 5Xn 0..2 arrays with no element equal to any value at offset (0,-1) (-1,-2) or (-2,0) and new values introduced in order 0..2.''. It has offset $1$ and begins
\[
12, 162, 450, 2334, 11624, 57984, 290927, 1465435,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 14 2016 09:56:27, revision 4) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A275040.
