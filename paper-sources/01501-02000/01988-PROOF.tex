...
\title{The empirical recurrence for OEIS A264166, proved by transfer matrix}
...
\begin{abstract}
OEIS A264166 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=2$ rows in which
...
OEIS A264166 is ``Number of (n+1) X (1+1) arrays of permutations of 0..n*2+1 with each element having directed index change 0,0 0,1 1,0 -2,-1 or -1,-2.''. It has offset $1$ and begins
\[
1, 4, 8, 16, 33, 69, 145, 300,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + a(n-2) + 2*a(n-3) + a(n-4) + a(n-5) -a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 25 2018 08:41:25, revision 10) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264166.
