...
\title{The empirical recurrence for OEIS A229575, proved by counting defective colourings}
...
\begin{abstract}
OEIS A229575 counts the colourings of an array with $K=4$ colours that are proper except at
...
OEIS A229575 is ``Number of defective 4-colorings of an n X 5 0..3 array connected horizontally, vertically, diagonally and antidiagonally with exactly one mistake, and colors introduced in row-major 0..3 order.''. It has offset $1$ and begins
\[
20, 216, 362, 568, 924, 1576, 2852, 5440,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 6*a(n-1) - 13*a(n-2) + 12*a(n-3) - 4*a(n-4) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 19 2018 06:13:36, revision 7) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A229575.
