...
\title{The empirical recurrence for OEIS A200891, proved from an exact model}
...
\begin{abstract}
OEIS A200891 carries an empirical recurrence of order $9$. It is true, and it is
...
\begin{quote}
Empirical: a(n) = (1/315)*n\^{}8 + (134/315)*n\^{}7 + (21/5)*n\^{}6 + (571/36)*n\^{}5 + (1841/60)*n\^{}4 + (6047/180)*n\^{}3 + (26603/1260)*n\^{}2 + (299/42)*n + 1. a(n) = 9*a(n-1) - 36*a(n-2) + 84*a(n-3) - 126*a(n-4) + 126*a(n-5) - 84*a(n-6) + 36*a(n-7) - 9*a(n-8) + a(n-9) for n>9.
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 16 2017 12:23:20, revision 10)
