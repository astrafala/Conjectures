...
\title{The empirical recurrence for OEIS A279460, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A279460 imposes three things at once: a condition on each cell that reaches one row up and
...
OEIS A279460 is ``Number of n X 2 0..1 arrays with no element equal to a strict majority of its horizontal, vertical and antidiagonal neighbors, with the exception of exactly one element, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
0, 2, 6, 20, 66, 210, 658, 2036,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 4*a(n-1) - 2*a(n-2) - 3*a(n-4) - 14*a(n-5) - 14*a(n-6) - 14*a(n-7) - 13*a(n-8) - 6*a(n-9) - a(n-10).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 11 2019 05:20:04, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) - 2\,a(n-2) - 3\,a(n-4) - 14\,a(n-5) - 14\,a(n-6) - 14\,a(n-7) - 13\,a(n-8) - 6\,a(n-9) - a(n-10)
\end{equation}
for all $n>11$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A279460.
