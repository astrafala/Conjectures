...
\begin{quote}
Empirical: a(n) = n\^{}8 + (1/5)*n\^{}7 + (563/180)*n\^{}6 + (19/30)*n\^{}5 + (1/9)*n\^{}4 + (9/5)*n\^{}3 - (223/180)*n\^{}2 + (11/30)*n. a(n) = 9*a(n-1) - 36*a(n-2) + 84*a(n-3) - 126*a(n-4) + 126*a(n-5) - 84*a(n-6) + 36*a(n-7) - 9*a(n-8) + a(n-9) for n>9.
\end{quote}
