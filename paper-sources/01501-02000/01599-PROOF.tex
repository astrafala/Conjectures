...
\title{The empirical recurrence for OEIS A229456, proved by counting defective colourings}
...
\begin{abstract}
OEIS A229456 counts the colourings of an array with $K=3$ colours that are proper except at
...
order $10$ contributed by R.~H.~Hardin follows from a finite exact computation.
\end{abstract}
...
OEIS A229456 is ``Number of defective 3-colorings of an n X 5 0..2 array connected horizontally and vertically with exactly one mistake and colors introduced in row-major 0..2 order.''. It has offset $1$ and begins
\[
16, 324, 4962, 68790, 903332, 11451686, 141595454, 1718447506,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 18 2022 18:35:32, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;32\,a(n-1) - 386\,a(n-2) + 2264\,a(n-3) - 7265\,a(n-4) + 13512\,a(n-5) - 14960\,a(n-6) + 9872\,a(n-7) - 3776\,a(n-8) + 768\,a(n-9) - 64\,a(n-10)
\end{equation}
for all $n>10$.
...
\qquad w=h_{10}-\sum_i c_ih_{10-i} .
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A229456.
