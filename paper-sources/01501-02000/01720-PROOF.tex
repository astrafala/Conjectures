...
\title{The empirical recurrence for OEIS A240456, proved by transfer matrix}
...
\begin{abstract}
OEIS A240456 counts arrays over $\{0,1,2,3\}$ in which no entry may equal, modulo $4$, a given
constant plus the SUM of all the entries lying before it along one of several rays. The entry
carries an empirical recurrence of order $26$ contributed by R.~H.~Hardin. It is true, and
...
count is then a walk count on $S=36$ states.
\end{abstract}
...
OEIS A240456 is ``Number of nX2 0..3 arrays with no element equal to one plus the sum of elements to its left or three plus the sum of elements above it or one plus the sum of the elements diagonally to its northwest, modulo 4.''. It has offset $1$ and begins
\[
4, 21, 102, 476, 2200, 10123, 46471, 213000,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 09:58:22, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-1) - 20\,a(n-2) + 34\,a(n-3) - 84\,a(n-4) + 92\,a(n-5) - 68\,a(n-6) + 222\,a(n-7) + 13\,a(n-8) - 251\,a(n-9) + 25\,a(n-10) - 495\,a(n-11) + 485\,a(n-12) - 44\,a(n-13) - 180\,a(n-14) + 554\,a(n-15) - 648\,a(n-16) + 14\,a(n-17) + 152\,a(n-18) - 190\,a(n-19) - 140\,a(n-20) + 397\,a(n-21) - 273\,a(n-22) + 75\,a(n-23) + 167\,a(n-24) - 136\,a(n-25) + 27\,a(n-26)
\]
for every $n>25$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A240456.
