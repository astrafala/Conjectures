...
\title{The empirical recurrence for OEIS A264501, proved by transfer matrix}
...
\begin{abstract}
OEIS A264501 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=4$ rows in which
...
OEIS A264501 is ``Number of (n+1)X(3+1) arrays of permutations of 0..n*4+3 with each element having directed index change -1,1 0,-1 0,1 or 1,0.''. It has offset $1$ and begins
\[
3, 14, 46, 149, 524, 1790, 6084, 20812,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 15 2015 18:34:12, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-2) + 17\,a(n-3) + 22\,a(n-4) + 5\,a(n-5) - 29\,a(n-6) - 44\,a(n-7) - 25\,a(n-8) + 11\,a(n-9) + 20\,a(n-10) + 11\,a(n-11) - a(n-12) - 2\,a(n-13) - a(n-14)
\]
for every $n>12$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264501.
