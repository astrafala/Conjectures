...
\title{Recovering the unwritten recurrences of the table OEIS A259723}
...
\begin{abstract}
OEIS A259723 is a two-dimensional table $T(n,k)$ whose empirical recurrences are, for several of
...
OEIS A259723 is ``T(n,k) = Number of (n+2) X (k+2) 0..1 arrays with each 3 X 3 subblock having clockwise perimeter pattern 00000001 or 00000011.''. It is read by antidiagonals and begins
\[
32, 54, 54, 140, 95, 140, 242, 228,\ \dots
\]
...
k=3: [order 16];
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 13 2026 09:57:18, revision 8) these are still
...
$c_{1}$ & $0$ & $c_{4}$ & $4$ & $c_{7}$ & $-5$ & $c_{10}$ & $3$ \\
$c_{2}$ & $1$ & $c_{5}$ & $-4$ & $c_{8}$ & $-3$ &  &  \\
$c_{3}$ & $5$ & $c_{6}$ & $-8$ & $c_{9}$ & $2$ &  &  \\
...
integer coefficients
\begin{center}\small\begin{tabular}{cccccccc}
$c_{1}$ & $0$ & $c_{5}$ & $0$ & $c_{9}$ & $4$ & $c_{13}$ & $0$ \\
$c_{2}$ & $0$ & $c_{6}$ & $-9$ & $c_{10}$ & $7$ & $c_{14}$ & $0$ \\
$c_{3}$ & $6$ & $c_{7}$ & $-16$ & $c_{11}$ & $10$ & $c_{15}$ & $0$ \\
$c_{4}$ & $6$ & $c_{8}$ & $-12$ & $c_{12}$ & $14$ & $c_{16}$ & $-3$ \\
\end{tabular}\end{center}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A259723.
