...
\title{The empirical recurrence for OEIS A282052, proved by transfer matrix}
...
\begin{abstract}
OEIS A282052 counts $n\times3$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A282052 is ``Number of nX3 0..2 arrays with no element unequal to more than four of its king-move neighbors and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
5, 91, 388, 2754, 15543, 95045, 565516, 3403942,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 05 2017 08:41:29, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + 15\,a(n-2) - 11\,a(n-3) - 30\,a(n-4) - 59\,a(n-5) - 66\,a(n-6) - 216\,a(n-7) - 348\,a(n-8) + 580\,a(n-9) + 812\,a(n-10) + 488\,a(n-11) - 112\,a(n-12) - 1712\,a(n-13) + 272\,a(n-14) + 192\,a(n-15) + 192\,a(n-16)
\]
for every $n>18$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A282052.
