...
\title{The empirical recurrence for OEIS A198522, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A198522 counts arrays in which every cell is constrained by its neighbours on \emph{both}
...
OEIS A198522 is ``Number of n X 2 0..4 arrays with values 0..4 introduced in row major order and each element equal to no more than two horizontal and vertical neighbors.''. It has offset $1$ and begins
\[
2, 15, 193, 3660, 81844, 1948672, 47436498, 1163606279,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 07:54:03, revision 10) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;35\,a(n-1) - 267\,a(n-2) + 246\,a(n-3) + 924\,a(n-4) + 710\,a(n-5) - 1736\,a(n-6) - 1860\,a(n-7) + 72\,a(n-8) + 1984\,a(n-9) + 720\,a(n-10) - 320\,a(n-11) - 512\,a(n-12)
\end{equation}
for all $n>14$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A198522.
