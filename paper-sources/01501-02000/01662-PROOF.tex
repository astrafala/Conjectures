...
\title{The empirical recurrence for OEIS A249291, proved from an exact model}
...
\begin{abstract}
OEIS A249291 carries an empirical recurrence of order $8$. It is true, and it is
...
OEIS A249291 is ``Number of length 1+3 0..n arrays with no four consecutive terms having the sum of any three elements equal to three times the fourth.''. It has offset $1$ and begins
\[
14, 66, 204, 524, 1098, 2070, 3584, 5808,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) - 2*a(n-2) - a(n-3) + a(n-5) + 2*a(n-6) - 3*a(n-7) +a(n- 8).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 09 2018 21:55:00, revision 10)
...
\]
annihilates $a$, and $S=\deg A=21$. A congruence condition modulo $m$ is counted one residue
...
exactly $\deg A$. The bound in force is therefore $zA(z)$, of order $S=21$, and
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) - 2\,a(n-2) - a(n-3) + a(n-5) + 2\,a(n-6) - 3\,a(n-7) + a(n-8)
\]
for every $n>0$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A249291.
