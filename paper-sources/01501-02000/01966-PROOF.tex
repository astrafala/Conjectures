...
\title{The empirical recurrence for OEIS A275567, proved by transfer matrix}
...
\begin{abstract}
OEIS A275567 counts arrays in which no entry may equal the entries at a short list of fixed offsets
...
$2$ consecutive columns, $S=1355$ states in all.
\end{abstract}
...
OEIS A275567 is ``Number of 4Xn 0..2 arrays with no element equal to any value at offset (-2,0) (-1,2) or (0,-2) and new values introduced in order 0..2.''. It has offset $1$ and begins
\[
6, 216, 504, 1176, 3192, 8664, 23712, 64896,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 01 2016 21:29:55, revision 4) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=1355.
\]
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) - 35\,a(n-3) + 31\,a(n-4) + 131\,a(n-5) - 205\,a(n-6) - 254\,a(n-7) + 705\,a(n-8) - 6\,a(n-9) - 1218\,a(n-10) + 823\,a(n-11) + 1150\,a(n-12) - 1646\,a(n-13) - 439\,a(n-14) + 1789\,a(n-15) - 394\,a(n-16) - 1015\,a(n-17) + 499\,a(n-18) + 285\,a(n-19) - 205\,a(n-20) - 46\,a(n-21) + 51\,a(n-22) - 6\,a(n-24) + a(n-25)
\]
for every $n>28$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A275567.
