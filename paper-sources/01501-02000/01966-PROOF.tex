...
\title{The empirical recurrence for OEIS A250374, proved from an exact model}
...
\begin{abstract}
OEIS A250374 carries an empirical recurrence of order $7$. It is true, and it is
...
\begin{quote}
Empirical: a(n) = (7/2)*n\^{}6 + 14*n\^{}5 + (105/4)*n\^{}4 + (161/6)*n\^{}3 + (63/4)*n\^{}2 + (17/3)*n + 1. a(n) = 7*a(n-1) - 21*a(n-2) + 35*a(n-3) - 35*a(n-4) + 21*a(n-5) - 7*a(n-6) + a(n-7) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 13 2018 12:48:36, revision 7)
