...
\title{The empirical recurrence for OEIS A269540, proved from an exact model}
...
\begin{abstract}
OEIS A269540 carries an empirical recurrence of order $7$. It is true, and it is
...
which $a$ provably satisfies a MONIC linear recurrence of order $S=26$, derived below and not
...
OEIS A269540 is ``Number of length-6 0..n arrays with no repeated value differing from the previous repeated value by other than one.''. It has offset $1$ and begins
\[
22, 418, 2878, 12214, 38878, 102202, 234358, 485038,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = n\^{}6 + 6*n\^{}5 + 5*n\^{}4 + 12*n\^{}3 - 6*n\^{}2 + 6*n - 2. a(n) = 7*a(n-1) - 21*a(n-2) + 35*a(n-3) - 35*a(n-4) + 21*a(n-5) - 7*a(n-6) + a(n-7) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 24 2019 09:13:59, revision 7)
...
everywhere, a monic recurrence of order $S=26$. The annihilator was then asked for terms the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269540.
