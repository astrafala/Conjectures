...
\begin{quote}
Empirical: a(n) = (589/3360)*n\^{}8 + (349/210)*n\^{}7 + (2483/360)*n\^{}6 + (1317/80)*n\^{}5 + (35819/1440)*n\^{}4 + (1963/80)*n\^{}3 + (19597/1260)*n\^{}2 + (613/105)*n + 1. a(n) = 9*a(n-1) - 36*a(n-2) + 84*a(n-3) - 126*a(n-4) + 126*a(n-5) - 84*a(n-6) + 36*a(n-7) - 9*a(n-8) + a(n-9) for n>9.
\end{quote}
