...
\title{The empirical recurrence for OEIS A222015, proved by transfer matrix}
...
\begin{abstract}
OEIS A222015 counts the distinct OCCUPANCY arrays obtained when every cell of an $n\times2$ grid
...
one, on $S=104$ states, after which the conjectured recurrence is settled by a finite exact
computation.
\end{abstract}
...
OEIS A222015 is ``Number of n X 2 arrays of occupancy after each element stays put or moves to some horizontal or vertical neighbor, without move-in move-out straight through or left turns.''. It has offset $1$ and begins
\[
3, 27, 188, 1363, 9838, 70994, 512456, 3698699,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) + 25*a(n-2) + 40*a(n-3) + a(n-4) - 42*a(n-5) - 20*a(n-6) + 10*a(n-7) + 4*a(n-8) - a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 14 2018 21:03:34, revision 9) this is still
...
(-1,0), (0,-1), (0,0), (0,1), (1,0),
\]
a move being available only when it lands inside the grid. The offset $(0,0)$ is among them: the entry lets a token stay put. The OCCUPANCY array
...
$S=104$ reachable sets. In particular $a$ is $C$-finite.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A222015.
