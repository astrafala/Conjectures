...
\title{The empirical recurrence for OEIS A203293, proved from an exact model}
...
\begin{abstract}
OEIS A203293 carries an empirical recurrence of order $10$. It is true, and it is
...
OEIS A203293 is ``Number of arrays of 6 nondecreasing integers in -n..n with sum zero and equal numbers greater than zero and less than zero.''. It has offset $1$ and begins
\[
4, 10, 28, 69, 154, 310, 580, 1013,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) -a(n-2) -4*a(n-3) +2*a(n-4) +2*a(n-5) +2*a(n-6) -4*a(n-7) -a(n-8) +3*a(n-9) -a(n-10).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 04 2018 05:47:46, revision 8)
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) - a(n-2) - 4\,a(n-3) + 2\,a(n-4) + 2\,a(n-5) + 2\,a(n-6) - 4\,a(n-7) - a(n-8) + 3\,a(n-9) - a(n-10)
\]
for every $n>0$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A203293.
