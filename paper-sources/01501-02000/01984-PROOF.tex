...
\title{The empirical recurrence for OEIS A188334, proved from an exact model}
...
\begin{abstract}
OEIS A188334 carries an empirical recurrence of order $7$. It is true, and it is
...
OEIS A188334 is ``Number of nondecreasing arrangements of 4 nonzero numbers in -(n+2)..(n+2) with sum zero.''. It has offset $1$ and begins
\[
10, 20, 37, 61, 94, 136, 191, 257,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1)-a(n-3)-a(n-4)+2*a(n-6)-a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 13 2025 00:25:51, revision 14)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A188334.
