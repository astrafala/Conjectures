...
\title{The empirical recurrence for OEIS A252808, proved by transfer matrix}
...
\begin{abstract}
OEIS A252808 counts arrays of width $7$ over an alphabet of $5$ letters in which every three
...
brings the state count down to $S=203534$.
\end{abstract}
...
OEIS A252808 is ``Number of (n+2)X(5+2) 0..4 arrays with every consecutive three elements in every row and column not having exactly two distinct values, and in every diagonal and antidiagonal having exactly two distinct values, and new values 0 upwards introduced in row major order.''. It has offset $1$ and begins
\[
1808, 702, 2068, 1625, 3186, 9869, 7897, 15217,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:39:43, revision 6) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The array has width $7$ and entries in $\{0,1,\dots,4\}$. Four families of triples
...
That digraph has up to $i^{2\cdot7}$ vertices, which is more than can be written down for
...
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,
\]
with $S=203534$ states in all. The walk index $j$ and the entry's own $n$ differ by a constant,
...
\begin{theorem}
\[
a(n)\;=\;11\,a(n-3) - 34\,a(n-6) + 14\,a(n-9) + 27\,a(n-12) + 24\,a(n-15) - 23\,a(n-18) - 18\,a(n-21) - 2\,a(n-24) + a(n-27) + a(n-30)
\]
for every $n>34$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252808.
