...
\title{The empirical recurrence for OEIS A250083, proved from an exact model}
...
\begin{abstract}
OEIS A250083 carries an empirical recurrence of order $7$. It is true, and it is
...
\begin{quote}
Empirical: a(n) = (7/6)*n\^{}6 + (28/3)*n\^{}5 + (245/12)*n\^{}4 + (47/2)*n\^{}3 + (227/12)*n\^{}2 + (26/3)*n + 1. a(n) = 7*a(n-1) - 21*a(n-2) + 35*a(n-3) - 35*a(n-4) + 21*a(n-5) - 7*a(n-6) + a(n-7) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 11 2018 09:18:28, revision 8)
