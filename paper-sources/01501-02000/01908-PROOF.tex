...
\title{The empirical recurrence for OEIS A209964, proved by transfer matrix}
...
\begin{abstract}
OEIS A209964 counts arrays of width $4$ whose every $2\times2$ subblock holds a
prescribed number of DISTINCT values, which use ALL of the $4$ available letters, and which
are counted up to renaming. The entry carries an empirical recurrence of order $18$
...
OEIS A209964 is ``Number of (n+1)X4 0..3 arrays containing all values 0..3 with every 2X2 subblock having one or two distinct values, and new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
9, 665, 25435, 870686, 27112487, 795773818, 22419183624, 613401570788,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 15:37:44, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;66\,a(n-1) - 1487\,a(n-2) + 11648\,a(n-3) + 14141\,a(n-4) - 454021\,a(n-5) + 667500\,a(n-6) + 5458068\,a(n-7) - 11933206\,a(n-8) - 23623289\,a(n-9) + 65454499\,a(n-10) + 26595728\,a(n-11) - 134617798\,a(n-12) + 33919512\,a(n-13) + 79370592\,a(n-14) - 38830848\,a(n-15) - 7503360\,a(n-16) + 6127616\,a(n-17) - 655360\,a(n-18)
\]
for every $n>17$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209964.
