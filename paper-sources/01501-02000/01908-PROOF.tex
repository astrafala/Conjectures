...
\title{The empirical recurrence for OEIS A198910, proved by counting patterns}
...
\begin{abstract}
OEIS A198910 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
state space down from $8772$ to $S=98$. The entry's empirical recurrence of order
...
OEIS A198910 is ``Number of nX4 0..7 arrays with values 0..7 introduced in row major order and no element equal to any horizontal or vertical neighbor.''. It has offset $1$ and begins
\[
5, 500, 269940, 319608038, 481871809749, 769126451071174, 1243368053336112649, 2015791720035206825303,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 08:02:08, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2296\,a(n-1) - 1239092\,a(n-2) + 252277904\,a(n-3) - 24632440060\,a(n-4) + 1347961370754\,a(n-5) - 44994493075469\,a(n-6) + 960046624478492\,a(n-7) - 13429762946315149\,a(n-8) + 124540876930445980\,a(n-9) - 765040702294085198\,a(n-10) + 3074302608489782520\,a(n-11) - 7884335188124038674\,a(n-12) + 12438514719451024794\,a(n-13) - 11471383995777540513\,a(n-14) + 5595786642970619820\,a(n-15) - 1099871574411268404\,a(n-16)
\end{equation}
for all $n>16$.
...
Assembling the $8$ lumped chains into one block-diagonal matrix $N$ of size $S=98$ and
...
\end{equation}
The unlumped alphabet had $8772$ rows in all; the lumped chain has $S=98$ states.
...
\[
8!\Bigl(a(n)-\sum_i c_i\,a(n-i)\Bigr)\;=\;\mathbf{v}^{\!\top}N^{\,m-16}q(N)\mathbf{1} .
\]
...
\eqref{eq:walk}, divided by $8!$, was evaluated at every one of the $11$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A198910.
