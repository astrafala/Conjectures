...
\title{The empirical recurrence for OEIS A223946, proved by transfer matrix}
...
\begin{abstract}
OEIS A223946 counts arrays over $\{0,\dots,1\}$ whose rows, columns, diagonals or
...
is a walk count on $S=6144$ vertices and the recurrence follows from a finite exact
computation.
\end{abstract}
...
OEIS A223946 is ``Number of nX5 0..1 arrays with diagonals and antidiagonals unimodal and rows nondecreasing.''. It has offset $1$ and begins
\[
6, 36, 157, 558, 1821, 5951, 20275, 71653,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 23:00:09, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) - 9\,a(n-2) - a(n-3) + 11\,a(n-4) - 7\,a(n-5) + 12\,a(n-6) - 51\,a(n-7) - 91\,a(n-8) - 171\,a(n-9) + 353\,a(n-10) + 89\,a(n-11) + 73\,a(n-12) + 177\,a(n-13) + 22\,a(n-14) - 64\,a(n-15) - 24\,a(n-16)
\end{equation}
for all $n>16$.
...
bit vector), $|\mathcal V|=S=6144$; let $(r,f)\to(s,f')$ be an edge when placing $s$ after $r$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223946.
