...
\title{The empirical recurrence for OEIS A283660, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A283660 imposes three things at once: a condition on each cell that reaches one row up and
...
numbers. The empirical recurrence of order $9$ contributed by R.~H.~Hardin then follows
...
OEIS A283660 is ``Number of n X 2 0..1 arrays with no element unequal to more than four of its king-move neighbors, with the exception of exactly two elements, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
0, 0, 0, 0, 4, 40, 264, 1504,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 12*a(n-1) - 54*a(n-2) + 124*a(n-3) - 204*a(n-4) + 288*a(n-5) - 248*a(n-6) + 240*a(n-7) - 96*a(n-8) + 64*a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 21 2019 11:36:42, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;12\,a(n-1) - 54\,a(n-2) + 124\,a(n-3) - 204\,a(n-4) + 288\,a(n-5) - 248\,a(n-6) + 240\,a(n-7) - 96\,a(n-8) + 64\,a(n-9)
\end{equation}
for all $n>10$.
...
$h_j=G^{j}N^{o}\mathbf{u}$, we have for $j\ge9$
\[
2!\Bigl(a(n_0+j)-\sum_i c_i\,a(n_0+j-i)\Bigr)=\mathbf{v}^{\!\top}G^{\,j-9}w,
\qquad w=h_{9}-\sum_i c_i h_{9-i} .
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A283660.
