...
\title{The empirical recurrence for OEIS A249961, proved from an exact model}
...
\begin{abstract}
OEIS A249961 carries an empirical recurrence of order $7$. It is true, and it is
...
OEIS A249961 is ``Number of length 1+5 0..n arrays with no six consecutive terms having the maximum of any two terms equal to the minimum of the remaining four terms.''. It has offset $1$ and begins
\[
15, 285, 2010, 8790, 28785, 77595, 181860, 383580,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = n\^{}6 + 3*n\^{}5 + 5*n\^{}4 + 5*n\^{}3 + (3/2)*n\^{}2 - (1/2)*n. a(n) = 7*a(n-1) - 21*a(n-2) + 35*a(n-3) - 35*a(n-4) + 21*a(n-5) - 7*a(n-6) + a(n-7) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 21 2017 06:22:26, revision 7)
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A249961.
