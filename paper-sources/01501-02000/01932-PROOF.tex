...
\title{The empirical recurrence for OEIS A221821, proved by transfer matrix}
...
\begin{abstract}
OEIS A221821 counts the distinct OCCUPANCY arrays obtained when every cell of an $n\times2$ grid
...
one, on $S=156$ states, after which the conjectured recurrence is settled by a finite exact
computation.
\end{abstract}
...
OEIS A221821 is ``Number of n X 2 arrays of occupancy after each element stays put or moves to some horizontal or vertical neighbor, without consecutive moves in the same direction.''. It has offset $1$ and begins
\[
3, 31, 252, 2113, 17684, 147920, 1237439, 10351593,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 9*a(n-1) - 4*a(n-2) - 11*a(n-3) - 2*a(n-4) + 22*a(n-5) - 16*a(n-6) + 8*a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 11 2018 07:11:05, revision 9) this is still
...
$S=156$ reachable sets. In particular $a$ is $C$-finite.
...
\begin{theorem}
\[
a(n)\;=\;9\,a(n-1) - 4\,a(n-2) - 11\,a(n-3) - 2\,a(n-4) + 22\,a(n-5) - 16\,a(n-6) + 8\,a(n-7)
\]
for every $n>7$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221821.
