...
\title{The empirical recurrence for OEIS A221630, proved by transfer matrix}
...
\begin{abstract}
OEIS A221630 counts the distinct indicator arrays obtained from the $n\times3$ arrays over
...
indicator row by row turns it into one, on $S=188$ states, after which the conjectured
...
OEIS A221630 is ``Equals one maps: number of nX3 binary arrays indicating the locations of corresponding elements equal to exactly one of their horizontal, diagonal and antidiagonal neighbors in a random 0..3 nX3 array.''. It has offset $1$ and begins
\[
4, 37, 395, 3575, 30145, 247495, 2003761, 16117917,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 19:49:46, revision 9) this is still
...
\]
There are $S=188$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite. Note
...
\begin{theorem}
\[
a(n)\;=\;15\,a(n-1) - 69\,a(n-2) + 100\,a(n-3) + 61\,a(n-4) - 209\,a(n-5) - 378\,a(n-6) + 996\,a(n-7) + 544\,a(n-8) - 1560\,a(n-9) - 491\,a(n-10) + 1328\,a(n-11) - 180\,a(n-12) - 112\,a(n-13) + 124\,a(n-14) + 32\,a(n-15)
\]
for every $n>17$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221630.
