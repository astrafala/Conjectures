...
\title{The empirical recurrence for OEIS A200555, proved from an exact model}
...
\begin{abstract}
OEIS A200555 carries an empirical recurrence of order $11$. It is true, and it is
...
OEIS A200555 is ``Number of -n..n arrays x(0..4) of 5 elements with zero sum and nonzero second differences.''. It has offset $1$ and begins
\[
26, 280, 1184, 3396, 7778, 15476, 27806, 46346,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) +2*a(n-2) -3*a(n-4) -3*a(n-5) +3*a(n-6) +3*a(n-7) -2*a(n-9) -a(n-10) +a(n-11).
\end{quote}
As of the ``Last modified'' line on the live entry (May 21 2018 11:26:53, revision 8)
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 2\,a(n-2) - 3\,a(n-4) - 3\,a(n-5) + 3\,a(n-6) + 3\,a(n-7) - 2\,a(n-9) - a(n-10) + a(n-11)
\]
for every $n>0$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A200555.
