...
\title{The empirical recurrence for OEIS A200877, proved from an exact model}
...
\begin{abstract}
OEIS A200877 carries an empirical recurrence of order $10$. It is true, and it is
...
\begin{quote}
Empirical: a(n) = (1/181440)*n\^{}9 + (131/20160)*n\^{}8 + (8893/30240)*n\^{}7 + (4621/1440)*n\^{}6 + (118933/8640)*n\^{}5 + (83957/2880)*n\^{}4 + (763489/22680)*n\^{}3 + (36343/1680)*n\^{}2 + (9169/1260)*n + 1. a(n) = 10*a(n-1) - 45*a(n-2) + 120*a(n-3) - 210*a(n-4) + 252*a(n-5) - 210*a(n-6) + 120*a(n-7) - 45*a(n-8) + 10*a(n-9) - a(n-10) for n>10.
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 16 2017 10:06:48, revision 10)
