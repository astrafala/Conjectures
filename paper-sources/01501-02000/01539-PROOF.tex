...
\title{Recovering the unwritten recurrences of the table OEIS A255101}
...
\begin{abstract}
OEIS A255101 is a two-dimensional table $T(n,k)$ whose empirical recurrences are, for several of
...
OEIS A255101 is ``T(n,k) = Number of (n+2) X (k+2) 0..1 arrays with no 3 X 3 subblock diagonal sum 1 and no antidiagonal sum 1 and no row sum 1 and no column sum 1.''. It is read by antidiagonals and begins
\[
36, 77, 77, 179, 189, 179, 419, 539,\ \dots
\]
The entry carries, among its empirical claims:
\begin{quote}\small
k=2: [order 14];
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 21 2021 12:00:59, revision 6) these are still
...
$c_{1}$ & $3$ & $c_{5}$ & $-3$ & $c_{9}$ & $6$ & $c_{13}$ & $-3$ \\
$c_{2}$ & $-1$ & $c_{6}$ & $-1$ & $c_{10}$ & $1$ & $c_{14}$ & $-2$ \\
$c_{3}$ & $6$ & $c_{7}$ & $6$ & $c_{11}$ & $3$ &  &  \\
$c_{4}$ & $-12$ & $c_{8}$ & $1$ & $c_{12}$ & $-3$ &  &  \\
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A255101.
