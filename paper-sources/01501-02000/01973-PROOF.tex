...
\title{The empirical recurrence for OEIS A224202, proved by transfer matrix}
...
\begin{abstract}
OEIS A224202 counts arrays over $\{0,\dots,3\}$ whose rows, columns, diagonals or
antidiagonals are required to be monotone or unimodal, and carries an empirical recurrence of
order $25$ contributed by R.~H.~Hardin. A monotone condition is local, but a unimodal one
...
is a walk count on $S=610$ vertices and the recurrence follows from a finite exact
computation.
\end{abstract}
...
OEIS A224202 is ``Number of nX6 0..3 arrays with rows unimodal and antidiagonals nondecreasing.''. It has offset $1$ and begins
\[
610, 59792, 2734683, 93052770, 2981774784, 96914926654, 3202561268692, 106630751360602,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 23:19:09, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;84\,a(n-1) - 2771\,a(n-2) + 49004\,a(n-3) - 526214\,a(n-4) + 3641009\,a(n-5) - 16632719\,a(n-6) + 48536326\,a(n-7) - 53423733\,a(n-8) - 313959977\,a(n-9) + 1729942603\,a(n-10) - 7086418537\,a(n-11) + 13780962535\,a(n-12) + 5231265096\,a(n-13) - 20279410782\,a(n-14) + 609579098232\,a(n-15) + 294855159788\,a(n-16) + 2331852968592\,a(n-17) + 7276333185488\,a(n-18) + 4826951354776\,a(n-19) + 18771064269632\,a(n-20) + 25683656373760\,a(n-21) + 16941876341184\,a(n-22) + 25615354625280\,a(n-23) + 22113238049280\,a(n-24) + 5504163840000\,a(n-25)
\end{equation}
for all $n>32$.
...
All the conditions here are local --- each compares two cells one step apart ---
so no extra state is needed beyond the row itself.

\begin{lemma}\label{lem:walk}
Let $\mathcal V$ be the set of pairs (a row satisfying every within-row condition, a
bit vector), $|\mathcal V|=S=610$; let $(r,f)\to(s,f')$ be an edge when placing $s$ after $r$
...
$h_j=G^{j}N^{o}\mathbf{1}$, we have for $j\ge25$
\[
a(n_0+j)-\sum_i c_i\,a(n_0+j-i)=\,\mathbf{v}^{\!\top}G^{\,j-25}w,
\qquad w=h_{25}-\sum_i c_ih_{25-i} .
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224202.
