...
\title{The empirical closed form for OEIS A207388, proved}
...
\begin{abstract}
OEIS A207388 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
$S=196$ vertices. Any function of the form $\sum_j p_j(n)\lambda_j^{\,n}$ satisfies the
...
OEIS A207388 is ``Number of n X 5 0..1 arrays avoiding 0 0 1 and 0 1 0 horizontally and 0 0 1 and 1 1 0 vertically.''. It has offset $1$ and begins
\[
14, 196, 834, 2356, 5348, 10570, 18972, 31710,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (2/15)*n\^{}5 + (55/12)*n\^{}4 + (101/6)*n\^{}3 + (5/12)*n\^{}2 - (299/30)*n + 2.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 22 2018 07:07:44, revision 9) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{2 n^{5}}{15} + \frac{55 n^{4}}{12} + \frac{101 n^{3}}{6} + \frac{5 n^{2}}{12} - \frac{299 n}{30} + 2.
\]
...
walk, so with $M$ the adjacency matrix of that digraph on $S=196$ vertices, and $u,w$ the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207388.
