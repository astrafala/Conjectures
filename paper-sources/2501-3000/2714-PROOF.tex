...
\title{The empirical recurrence for OEIS A275132, proved by transfer matrix}
...
\begin{abstract}
OEIS A275132 counts arrays in which no entry may equal the entries at a short list of fixed offsets
...
$2$ consecutive columns, $S=91$ states in all.
\end{abstract}
...
OEIS A275132 is ``Number of 3 X n 0..2 arrays with no element equal to any value at offset (-2,-2) (-1,0) or (-1,1) and new values introduced in order 0..2.''. It has offset $1$ and begins
\[
2, 12, 45, 174, 675, 2607, 10077, 38967,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) + 2*a(n-2) + 6*a(n-3) - 2*a(n-4) - 4*a(n-5) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 31 2019 19:36:30, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + 2\,a(n-2) + 6\,a(n-3) - 2\,a(n-4) - 4\,a(n-5)
\]
for every $n>6$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A275132.
