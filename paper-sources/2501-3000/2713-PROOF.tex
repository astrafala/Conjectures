...
\title{The empirical closed form for OEIS A207451, proved}
...
\begin{abstract}
OEIS A207451 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
$S=676$ vertices. Any function of the form $\sum_j p_j(n)\lambda_j^{\,n}$ satisfies the
...
OEIS A207451 is ``Number of n X 6 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 0 1 and 1 0 1 vertically.''. It has offset $1$ and begins
\[
26, 676, 3354, 10088, 23530, 46956, 84266, 139984,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 26*n\^{}4 + 78*n\^{}3 - 104*n\^{}2 + 26*n.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 23 2018 06:07:54, revision 12) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;26 n^{4} + 78 n^{3} - 104 n^{2} + 26 n.
\]
...
walk, so with $M$ the adjacency matrix of that digraph on $S=676$ vertices, and $u,w$ the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207451.
