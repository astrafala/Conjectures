...
\title{The empirical recurrence for OEIS A210055, proved by counting patterns}
...
\begin{abstract}
OEIS A210055 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A210055 is ``Number of (n+1) X 3 0..3 arrays with every 2 X 2 subblock having one, two or four distinct values, and new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
51, 646, 8767, 124097, 1800963, 26510247, 393310267, 5860240451,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 29*a(n-1) - 266*a(n-2) + 902*a(n-3) - 968*a(n-4) + 176*a(n-5) + 128*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 14 2018 05:56:08, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;29\,a(n-1) - 266\,a(n-2) + 902\,a(n-3) - 968\,a(n-4) + 176\,a(n-5) + 128\,a(n-6)
\end{equation}
for all $n>5$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A210055.
