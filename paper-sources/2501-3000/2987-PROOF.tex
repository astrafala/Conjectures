...
\title{The empirical recurrence for OEIS A204071, proved by counting patterns}
...
\begin{abstract}
OEIS A204071 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A204071 is ``Number of (n+1) X 4 0..2 arrays with every 2 X 2 subblock having equal diagonal elements or equal antidiagonal elements, and new values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
188, 2882, 45056, 706454, 11081828, 173848010, 2727300008, 42785526110,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 20*a(n-1) - 73*a(n-2) + 86*a(n-3) - 32*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 06 2018 05:40:57, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204071.
