...
\title{The empirical recurrence for OEIS A189348, proved by transfer matrix}
...
\begin{abstract}
OEIS A189348 counts the permutations of the cells of an $n\times2$ array in which every cell
...
OEIS A189348 is ``Number of n X 2 array permutations with each element moving one space diagonally, horizontally or vertically.''. It has offset $1$ and begins
\[
1, 4, 13, 45, 160, 565, 2005, 7108,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) +3*a(n-2) -3*a(n-3) -3*a(n-4) +a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (May 02 2018 09:23:03, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + 3\,a(n-2) - 3\,a(n-3) - 3\,a(n-4) + a(n-5)
\]
for every $n>4$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A189348.
