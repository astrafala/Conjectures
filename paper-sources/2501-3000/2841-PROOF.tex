...
\title{The empirical recurrence for OEIS A269180, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A269180 counts arrays over $\{0,\dots,3\}$ subject to a condition on the array as a
...
OEIS A269180 is ``Number of n X 2 0..3 arrays with some element plus some horizontally, diagonally, antidiagonally or vertically adjacent neighbor totalling three exactly once.''. It has offset $1$ and begins
\[
4, 48, 384, 2736, 18336, 118032, 739008, 4533744,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 10*a(n-1) - 21*a(n-2) - 20*a(n-3) - 4*a(n-4) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 19 2019 12:07:59, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;10\,a(n-1) - 21\,a(n-2) - 20\,a(n-3) - 4\,a(n-4)
\end{equation}
for all $n>5$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269180.
