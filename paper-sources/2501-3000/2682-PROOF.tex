...
\title{The empirical recurrence for OEIS A210313, proved by transfer matrix}
...
\begin{abstract}
OEIS A210313 counts arrays of width $2$ whose every $2\times2$ subblock holds a
...
OEIS A210313 is ``Number of (n+1) X 2 0..3 arrays containing all values 0..3 with every 2 X 2 subblock having two or three distinct values, and new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
0, 35, 995, 19186, 319485, 4963700, 74362241, 1091691712,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 24*a(n-1) - 141*a(n-2) - 24*a(n-3) + 718*a(n-4) + 768*a(n-5) + 216*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 15 2018 06:53:42, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;24\,a(n-1) - 141\,a(n-2) - 24\,a(n-3) + 718\,a(n-4) + 768\,a(n-5) + 216\,a(n-6)
\]
for every $n>6$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A210313.
