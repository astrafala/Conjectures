...
\title{The empirical column recurrences for the table OEIS A234333}
...
\begin{abstract}
OEIS A234333 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A234333 is ``T(n,k) is the number of (n+1) X (k+1) 0..3 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 1 (constant-stress 1 X 1 tilings).''. It has offset $1$, is
read by antidiagonals, and begins
\[
80, 432, 432, 2368, 3296, 2368, 13056, 25728,\ \dots
\]
The entry carries the following block:
\begin{quote}\small
Empirical for column k:\\
k=1: a(n) = 32*a(n-2) -48*a(n-4).\\
k=2: [order 11].\\
k=3: [order 48].\\
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 20 2022 20:31:01, revision 6) these are still
...
The sequence is ``Number of (n+1) X (2) 0..3 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 1 (constant-stress 1 X 1 tilings).''. Its rows are the vertices of a digraph on
...
$c_{1}$ & $10$ & $c_{4}$ & $608$ & $c_{7}$ & $-18088$ & $c_{10}$ & $-17600$ \\
$c_{2}$ & $59$ & $c_{5}$ & $7580$ & $c_{8}$ & $32880$ & $c_{11}$ & $4224$ \\
$c_{3}$ & $-768$ & $c_{6}$ & $-11628$ & $c_{9}$ & $3232$ &  &  \\
\end{tabular}\end{center}
Repeating with the first $11+4$ terms removed gives order $11$ again.

\subsection*{Column $k=3$, recovered}
The entry gives only the order for this line: ``k=3: [order 48].''. Its model is a walk on
...
$48$ --- the stated order --- with integer coefficients
\[
(c_1,\dots,c_{48})=(0,\ 507,\ 0,\ -102295,\ 0,\ 10646830,\ 0,\ -635915377,\ 0,\ 23832852746,\ 0,\ -596280829182,\ 0,\ 10371633339873,\ 0,\ -128744093807520,\ 0,\ 1159671655063068,\ 0,\ -7660667577596808,\ 0,\ 37368059037902308,\ 0,\ -135219186772494408,\ 0,\ 364034788822163472,\ 0,\ -730004249849579520,\ 0,\ 1089413122161376064,\ 0,\ -1205481757762071168,\ 0,\ 981742220067000064,\ 0,\ -581000394777277440,\ 0,\ 244895745327540224,\ 0,\ -71316845470162944,\ 0,\ 13706205520330752,\ 0,\ -1618885433491456,\ 0,\ 103796813856768,\ 0,\ -2721872609280).
\]
Repeating with the first $48+4$ terms removed gives order $48$ again.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234333.
