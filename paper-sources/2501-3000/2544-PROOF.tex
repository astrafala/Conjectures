...
\title{The empirical closed form for OEIS A207065, proved}
...
\begin{abstract}
OEIS A207065 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A207065 is ``Number of n X 5 0..1 arrays avoiding 0 0 1 and 0 1 0 horizontally and 0 0 1 and 1 0 1 vertically.''. It has offset $1$ and begins
\[
14, 196, 896, 2688, 6398, 13132, 24304, 41664,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (7/30)*n\^{}5 + 7*n\^{}4 + (21/2)*n\^{}3 - (56/15)*n.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 18 2018 12:36:01, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{7 n^{5}}{30} + 7 n^{4} + \frac{21 n^{3}}{2} - \frac{56 n}{15}.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207065.
