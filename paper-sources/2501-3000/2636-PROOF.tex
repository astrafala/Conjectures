...
\title{The empirical recurrence for OEIS A275222, proved by counting patterns}
...
\begin{abstract}
OEIS A275222 counts arrays in which no entry may repeat a value found at any of three stated
...
cutting $98$ pairs to $S=23$ states. The entry's empirical recurrence of order $5$,
...
OEIS A275222 is ``Number of n X 2 0..2 arrays with no element equal to any value at offset (-2,-1) (-2,1) or (-1,0) and new values introduced in order 0..2.''. It has offset $1$ and begins
\[
2, 6, 11, 27, 66, 162, 404, 1007,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) - a(n-2) - 2*a(n-4) + a(n-5) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 01 2019 11:58:16, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) - a(n-2) - 2\,a(n-4) + a(n-5)
\end{equation}
for all $n>6$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A275222.
