...
\title{The empirical recurrence for OEIS A274954, proved by counting patterns}
...
\begin{abstract}
OEIS A274954 counts arrays in which no entry may repeat a value found at any of three stated
...
OEIS A274954 is ``Number of n X 3 0..2 arrays with no element equal to any value at offset (-1,-1) (-2,0) or (0,-2) and new values introduced in order 0..2.''. It has offset $1$ and begins
\[
3, 24, 90, 384, 1638, 6936, 29370, 124416,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 4*a(n-1) + 4*a(n-3) + a(n-4) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 31 2019 09:22:20, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A274954.
