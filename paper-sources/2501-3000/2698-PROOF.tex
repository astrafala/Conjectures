...
\title{The empirical recurrence for OEIS A203874, proved by counting patterns}
...
\begin{abstract}
OEIS A203874 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A203874 is ``Number of (n+1)X5 0..3 arrays with no 2X2 subblock having equal diagonal elements or equal antidiagonal elements, and new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
4375, 500095, 57177415, 6542729803, 748675224487, 85671438703075, 9803443695486967, 1121815509393271267,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 118*a(n-1) -117*a(n-2) -34398*a(n-3) +120834*a(n-4) -86436*a(n-5)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 10:48:05, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;118\,a(n-1) - 117\,a(n-2) - 34398\,a(n-3) + 120834\,a(n-4) - 86436\,a(n-5)
\end{equation}
for all $n>5$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A203874.
