...
\title{The empirical recurrence for OEIS A208405, proved by counting patterns}
...
\begin{abstract}
OEIS A208405 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A208405 is ``Number of nX5 0..3 arrays with new values 0..3 introduced in row major order and no element equal to more than two of its immediate leftward or upward or right-upward antidiagonal neighbors.''. It has offset $1$ and begins
\[
51, 41914, 40883360, 40039156736, 39216100214432, 38410047476679936, 37620564383817645696, 36847308431734650845696,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 1008*a(n-1) -28108*a(n-2) +138160*a(n-3) -223680*a(n-4) +168192*a(n-5) -55296*a(n-6) for n>7
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:49:29, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;1008\,a(n-1) - 28108\,a(n-2) + 138160\,a(n-3) - 223680\,a(n-4) + 168192\,a(n-5) - 55296\,a(n-6)
\end{equation}
for all $n>7$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208405.
