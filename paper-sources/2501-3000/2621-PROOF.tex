...
\title{The empirical recurrence for OEIS A269932, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A269932 counts arrays over $\{0,\dots,6\}$ subject to a condition on the array as a
...
OEIS A269932 is ``Number of n X 2 0..6 arrays with some element plus some horizontally, diagonally, antidiagonally or vertically adjacent neighbor totalling six exactly once.''. It has offset $1$ and begins
\[
7, 900, 36312, 1213836, 36926640, 1064495604, 29614748232, 803524526172,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 30*a(n-1) + 159*a(n-2) - 5480*a(n-3) - 41064*a(n-4) - 53760*a(n-5) - 19600*a(n-6) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 29 2019 15:07:10, revision 9) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269932.
