...
\title{The empirical recurrence for OEIS A224738, proved by transfer matrix}
...
\begin{abstract}
OEIS A224738 counts the $(n+1)\times2$ matrices over $\{0,\dots,1\}$ all of whose
...
OEIS A224738 is ``Number of (n+1) X 2 0..1 matrices with each 2 X 2 permanent equal.''. It has offset $1$ and begins
\[
16, 38, 89, 218, 538, 1349, 3410, 8690,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 5*a(n-1) - 6*a(n-2) - 3*a(n-3) + 7*a(n-4) - 2*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 05 2018 05:38:28, revision 7) this is still
...
There are $(1 + 1)^{2}$ strips of $1$ rows and $2$ columns, far too
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) - 6\,a(n-2) - 3\,a(n-3) + 7\,a(n-4) - 2\,a(n-5)
\]
for every $n>4$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224738.
