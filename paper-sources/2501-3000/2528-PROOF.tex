...
\title{The empirical closed form for OEIS A207303, proved}
...
\begin{abstract}
OEIS A207303 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A207303 is ``Number of n X 6 0..1 arrays avoiding 0 0 0 and 1 0 1 horizontally and 0 0 1 and 1 1 0 vertically.''. It has offset $1$ and begins
\[
19, 361, 1675, 4939, 11497, 23091, 41893, 70537,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (4/15)*n\^{}5 + (45/4)*n\^{}4 + (199/6)*n\^{}3 - (73/4)*n\^{}2 - (373/30)*n + 5.
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 26 2024 03:31:59, revision 12) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{4 n^{5}}{15} + \frac{45 n^{4}}{4} + \frac{199 n^{3}}{6} - \frac{73 n^{2}}{4} - \frac{373 n}{30} + 5.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207303.
