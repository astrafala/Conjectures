...
\title{The empirical recurrence for OEIS A208254, proved by counting patterns}
...
\begin{abstract}
OEIS A208254 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A208254 is ``Number of n X 4 0..2 arrays with new values 0..2 introduced in row major order and no element equal to more than one of its immediate leftward or upward neighbors.''. It has offset $1$ and begins
\[
14, 768, 43344, 2445264, 137947632, 7782199824, 439026252912, 24767296501776,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 61*a(n-1) - 266*a(n-2) + 416*a(n-3) - 256*a(n-4) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 29 2018 08:05:00, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;61\,a(n-1) - 266\,a(n-2) + 416\,a(n-3) - 256\,a(n-4)
\end{equation}
for all $n>5$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208254.
