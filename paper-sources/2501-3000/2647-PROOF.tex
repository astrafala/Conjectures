...
\title{The empirical column recurrences for the table OEIS A234131}
...
\begin{abstract}
OEIS A234131 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A234131 is ``T(n,k)=Number of (n+1)X(k+1) 0..6 arrays with every 2X2 subblock having the absolute values of all six edge and diagonal differences no larger than 1.''. It has offset $1$, is
read by antidiagonals, and begins
\[
91, 469, 469, 2413, 4757, 2413, 12457, 47933,\ \dots
\]
The entry carries the following block:
\begin{quote}\small
Empirical for column k:\\
k=1: a(n) = 10*a(n-1) -24*a(n-2) -18*a(n-3) +57*a(n-4) +54*a(n-5) +12*a(n-6)\\
k=2: [order 14]\\
k=3: [order 27]\\
k=4: [order 78]\\
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 09:13:18, revision 6) these are still
...
The sequence is ``Number of (n+1)X(2) 0..6 arrays with every 2X2 subblock having the absolute values of all six edge and diagonal differences no larger than 1.''. Its rows are the vertices of a digraph on
...
\[
a(n)\;=\;10\,a(n-1) - 24\,a(n-2) - 18\,a(n-3) + 57\,a(n-4) + 54\,a(n-5) + 12\,a(n-6)
\]
...
$c_{1}$ & $26$ & $c_{5}$ & $-5034$ & $c_{9}$ & $-13910$ & $c_{13}$ & $-250$ \\
$c_{2}$ & $-218$ & $c_{6}$ & $-4660$ & $c_{10}$ & $-6694$ & $c_{14}$ & $20$ \\
$c_{3}$ & $474$ & $c_{7}$ & $14440$ & $c_{11}$ & $2654$ &  &  \\
$c_{4}$ & $1603$ & $c_{8}$ & $7897$ & $c_{12}$ & $581$ &  &  \\
...
model reproduces $8$ published values, $39$ decimal digits in all, every one of
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234131.
