...
\title{The empirical recurrence for OEIS A274723, proved by counting patterns}
...
\begin{abstract}
OEIS A274723 counts arrays in which no entry may repeat a value found at any of three stated
...
OEIS A274723 is ``Number of n X 3 0..2 arrays with no element equal to any value at offset (-1,-2) (-2,-1) or (-1,0) and new values introduced in order 0..2.''. It has offset $1$ and begins
\[
5, 24, 68, 260, 1040, 4132, 16524, 66088,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) + 4*a(n-2) + a(n-3) - 3*a(n-4) - 4*a(n-5) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 30 2019 09:09:24, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A274723.
