...
\title{The empirical recurrence for OEIS A210407, proved by counting patterns}
...
\begin{abstract}
OEIS A210407 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A210407 is ``Number of (n+1) X 3 0..3 arrays with every 2 X 2 subblock having three or four distinct values, and new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
78, 2520, 80496, 2574592, 82334080, 2633043200, 84204544256, 2692856218368,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 31*a(n-1) + 40*a(n-2) - 280*a(n-3) + 96*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 15 2018 12:03:46, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;31\,a(n-1) + 40\,a(n-2) - 280\,a(n-3) + 96\,a(n-4)
\end{equation}
for all $n>4$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A210407.
