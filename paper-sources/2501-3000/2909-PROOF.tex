...
\title{The empirical recurrence for OEIS A209807, proved by counting patterns}
...
\begin{abstract}
OEIS A209807 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A209807 is ``Number of (n+1) X 2 0..3 arrays with every 2 X 2 subblock having two distinct values, and new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
7, 34, 173, 930, 5193, 29782, 173789, 1025274,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 8*a(n-1) - 7*a(n-2) - 28*a(n-3) - 12*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 13 2018 05:33:28, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;8\,a(n-1) - 7\,a(n-2) - 28\,a(n-3) - 12\,a(n-4)
\end{equation}
for all $n>4$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209807.
