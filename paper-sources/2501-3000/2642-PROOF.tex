...
\title{The empirical recurrence for OEIS A223330, proved by transfer matrix}
...
\begin{abstract}
OEIS A223330 counts the ways of writing the vertices of a fixed graph $G$ into an array of width
$7$ so that any two cells adjacent in one of the named directions carry vertices joined by an
edge of $G$; here $G$ is cube graph $Q_3$. The entry carries an empirical recurrence of order $5$
...
single slice is a state and the count is a walk count on a finite digraph with $S=2917$ vertices.
\end{abstract}
...
OEIS A223330 is ``Rolling cube footprints: number of nX7 0..7 arrays starting with 0 where 0..7 label vertices of a cube and every array movement to a horizontal or antidiagonal neighbor moves along a corresponding cube edge.''. It has offset $1$ and begins
\[
729, 453789, 283231809, 176834343105, 110409049892673, 68935627430614161, 43041050285035823937, 26873361387913413198609,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 692*a(n-1) -43569*a(n-2) +847042*a(n-3) -6303164*a(n-4) +15731352*a(n-5)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 21:31:34, revision 8) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=2917.
\]
...
of length $7$ over $8$ vertices is one of $8^{7}$ words, but only $S-1$ of them are
...
\begin{theorem}
\[
a(n)\;=\;692\,a(n-1) - 43569\,a(n-2) + 847042\,a(n-3) - 6303164\,a(n-4) + 15731352\,a(n-5)
\]
for every $n>5$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223330.
