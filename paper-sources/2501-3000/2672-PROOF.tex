...
\title{The empirical recurrence for OEIS A268013, proved by transfer matrix}
...
\begin{abstract}
OEIS A268013 counts arrays in which the REPEATED VALUES of each row, and of each column, stand in a
...
OEIS A268013 is ``Number of n X 1 0..2 arrays with every repeated value in every row and column greater than or equal to the previous repeated value.''. It has offset $1$ and begins
\[
3, 9, 27, 78, 222, 622, 1722, 4719,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 6*a(n-1) - 9*a(n-2) - 4*a(n-3) + 9*a(n-4) + 6*a(n-5) + a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 26 2018 05:53:36, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268013.
