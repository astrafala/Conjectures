...
\title{The empirical recurrence for OEIS A205165, proved by counting patterns}
...
\begin{abstract}
OEIS A205165 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A205165 is ``Number of (n+1)X4 0..3 arrays with every 2X2 subblock having unequal diagonal elements or unequal antidiagonal elements, and new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
2277, 474853, 100138314, 21125224557, 4456641224469, 940186880752830, 198344748421652865, 41843425013764138653,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 224*a(n-1) -2803*a(n-2) +11196*a(n-3) -16677*a(n-4) +9438*a(n-5) -1728*a(n-6)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 11:48:27, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;224\,a(n-1) - 2803\,a(n-2) + 11196\,a(n-3) - 16677\,a(n-4) + 9438\,a(n-5) - 1728\,a(n-6)
\end{equation}
for all $n>6$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A205165.
