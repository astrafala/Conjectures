...
\title{The empirical column recurrences for the table OEIS A255027}
...
\begin{abstract}
OEIS A255027 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A255027 is ``T(n,k)=Number of (n+2)X(k+2) 0..1 arrays with no 3x3 subblock diagonal sum 0 or 1 and no antidiagonal sum 0 or 1 and no row sum 0 or 1 and no column sum 0 or 1.''. It has offset $1$, is
read by antidiagonals, and begins
\[
26, 54, 54, 117, 134, 117, 269, 405,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:36:32, revision 6) these are still
...
The sequence is ``Number of (n+2)X(3) 0..1 arrays with no 3x3 subblock diagonal sum 0 or 1 and no antidiagonal sum 0 or 1 and no row sum 0 or 1 and no column sum 0 or 1.''. Its rows are the vertices of a digraph on
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A255027.
