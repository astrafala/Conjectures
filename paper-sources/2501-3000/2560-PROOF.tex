...
\title{The empirical closed form for OEIS A207166, proved}
...
\begin{abstract}
OEIS A207166 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A207166 is ``Number of n X 5 0..1 arrays avoiding 0 0 0 and 1 0 1 horizontally and 0 0 1 and 1 0 1 vertically.''. It has offset $1$ and begins
\[
13, 169, 624, 1612, 3445, 6513, 11284, 18304,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (13/4)*n\^{}4 + (13/2)*n\^{}3 + (117/4)*n\^{}2 - 26*n.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 19 2018 12:33:24, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{13 n^{4}}{4} + \frac{13 n^{3}}{2} + \frac{117 n^{2}}{4} - 26 n.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207166.
