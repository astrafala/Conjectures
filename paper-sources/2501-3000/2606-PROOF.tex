...
\title{The empirical recurrence for OEIS A209013, proved by transfer matrix}
...
\begin{abstract}
OEIS A209013 counts arrays of width $2$ over $\{0,1,2,3\}$ in which no cell is the average of its neighbours. The entry carries an
...
$2$ consecutive rows and the count is a walk count on $S=17$ states.
\end{abstract}
...
OEIS A209013 is ``Number of n X 2 0..3 arrays with no element equal the average of immediate neighbors vertically above, diagonally above and left, and horizontally left of it.''. It has offset $1$ and begins
\[
12, 130, 1430, 15724, 172936, 1901964, 20918008, 230058424,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 8*a(n-1) + 38*a(n-2) - 52*a(n-3) - 40*a(n-4) + 44*a(n-5) - 12*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 07 2018 19:29:59, revision 14) this is still
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-1) + 38\,a(n-2) - 52\,a(n-3) - 40\,a(n-4) + 44\,a(n-5) - 12\,a(n-6)
\]
for every $n>6$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209013.
