...
\title{The empirical recurrence for OEIS A209738, proved by counting patterns}
...
\begin{abstract}
OEIS A209738 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A209738 is ``Number of n X 2 0..5 arrays with every 2 X 2 subblock containing exactly one value repeat, and new values 0..5 introduced in row major order.''. It has offset $1$ and begins
\[
2, 6, 57, 700, 10594, 183240, 3412100, 65953664,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 32*a(n-1) - 258*a(n-2) + 296*a(n-3) + 1256*a(n-4) + 480*a(n-5) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 12 2018 20:26:44, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;32\,a(n-1) - 258\,a(n-2) + 296\,a(n-3) + 1256\,a(n-4) + 480\,a(n-5)
\end{equation}
for all $n>6$.
...
\[
6!\Bigl(a(n)-\sum_i c_i\,a(n-i)\Bigr)\;=\;\mathbf{v}^{\!\top}N^{\,m-5}q(N)\mathbf{1} .
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209738.
