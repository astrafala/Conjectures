...
\title{The empirical column recurrences for the table OEIS A259894}
...
\begin{abstract}
OEIS A259894 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A259894 is ``T(n,k)=Number of (n+2)X(k+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000000 00000001 or 00000011.''. It has offset $1$, is
read by antidiagonals, and begins
\[
34, 67, 67, 215, 174, 215, 499, 653,\ \dots
\]
The entry carries the following block:
\begin{quote}\small
Empirical for column k:\\
k=1: a(n) = a(n-1) +5*a(n-3) +3*a(n-4)\\
k=2: [order 8]\\
k=3: [order 16]\\
k=4: [order 22]\\
k=5: [order 44]\\
k=6: [order 84] for n>85\\
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:56:04, revision 6) these are still
...
The sequence is ``Number of (n+2)X(3) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000000 00000001 or 00000011.''. Its rows are the vertices of a digraph on
...
$c_{1}$ & $3$ & $c_{3}$ & $11$ & $c_{5}$ & $-5$ & $c_{7}$ & $-2$ \\
$c_{2}$ & $-3$ & $c_{4}$ & $-8$ & $c_{6}$ & $-5$ & $c_{8}$ & $3$ \\
...
\begin{center}\small\begin{tabular}{cccccccc}
$c_{1}$ & $1$ & $c_{5}$ & $-1$ & $c_{9}$ & $-5$ & $c_{13}$ & $21$ \\
$c_{2}$ & $2$ & $c_{6}$ & $-34$ & $c_{10}$ & $94$ & $c_{14}$ & $-12$ \\
$c_{3}$ & $18$ & $c_{7}$ & $-98$ & $c_{11}$ & $37$ & $c_{15}$ & $2$ \\
$c_{4}$ & $41$ & $c_{8}$ & $-194$ & $c_{12}$ & $97$ & $c_{16}$ & $-4$ \\
\end{tabular}\end{center}
...
model reproduces $9$ published values, $31$ decimal digits in all, every one of
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A259894.
