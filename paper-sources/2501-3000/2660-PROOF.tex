...
\title{The empirical column recurrences for the table OEIS A235198}
...
\begin{abstract}
OEIS A235198 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A235198 is ``T(n,k) is the number of (n+1) X (k+1) 0..6 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 5, with no adjacent elements equal (constant-stress tilted 1 X 1 tilings).''. It has offset $1$, is
read by antidiagonals, and begins
\[
136, 512, 512, 1880, 1544, 1880, 7072, 4724,\ \dots
\]
...
k=2: [order 23].\\
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 19 2022 02:21:21, revision 8) these are still
...
The sequence is ``Number of (n+1) X (2) 0..6 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 5, with no adjacent elements equal (constant-stress tilted 1 X 1 tilings).''. Its rows are the vertices of a digraph on
...
$c_{1}$ & $6$ & $c_{7}$ & $-128869$ & $c_{13}$ & $14714982$ & $c_{19}$ & $-8246780$ \\
$c_{2}$ & $52$ & $c_{8}$ & $26637$ & $c_{14}$ & $-20381230$ & $c_{20}$ & $13170048$ \\
$c_{3}$ & $-367$ & $c_{9}$ & $1045428$ & $c_{15}$ & $-23985995$ & $c_{21}$ & $2801112$ \\
$c_{4}$ & $-995$ & $c_{10}$ & $-801048$ & $c_{16}$ & $38063780$ & $c_{22}$ & $-1572480$ \\
$c_{5}$ & $9350$ & $c_{11}$ & $-5098437$ & $c_{17}$ & $20215810$ & $c_{23}$ & $-393120$ \\
$c_{6}$ & $7034$ & $c_{12}$ & $5754163$ & $c_{18}$ & $-35199080$ &  &  \\
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A235198.
