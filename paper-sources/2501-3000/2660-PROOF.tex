...
\title{The empirical recurrence for OEIS A210398, proved by counting patterns}
...
\begin{abstract}
OEIS A210398 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A210398 is ``Number of (n+1) X 3 0..3 arrays with every 2 X 2 subblock having one or three distinct values, and new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
59, 1316, 29647, 668468, 15072359, 339846892, 7662761615, 172777559876,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 28*a(n-1) - 123*a(n-2) - 20*a(n-3) + 500*a(n-4) - 384*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 15 2018 12:03:30, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;28\,a(n-1) - 123\,a(n-2) - 20\,a(n-3) + 500\,a(n-4) - 384\,a(n-5)
\end{equation}
for all $n>5$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A210398.
