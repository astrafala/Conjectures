...
\title{The empirical column recurrences for the table OEIS A260248}
...
\begin{abstract}
OEIS A260248 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A260248 is ``T(n,k)=Number of (n+2)X(k+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000001 00000101 or 00001001.''. It has offset $1$, is
read by antidiagonals, and begins
\[
48, 99, 99, 256, 213, 256, 635, 551,\ \dots
\]
The entry carries the following block:
\begin{quote}\small
Empirical for column k:\\
k=1: a(n) = 2*a(n-1) -2*a(n-2) +9*a(n-3) -4*a(n-4) +9*a(n-5) -9*a(n-6) for n>7\\
k=2: [order 14] for n>15\\
k=3: [order 29] for n>30\\
k=4: [order 45] for n>47\\
k=5: [order 86] for n>89\\
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 12:04:11, revision 6) these are still
...
The sequence is ``Number of (n+2)X(3) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000001 00000101 or 00001001.''. Its rows are the vertices of a digraph on
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A260248.
