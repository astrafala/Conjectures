...
\title{The empirical recurrence for OEIS A209962, proved by transfer matrix}
...
\begin{abstract}
OEIS A209962 counts arrays of width $2$ whose every $2\times2$ subblock holds a
prescribed number of DISTINCT values, which use ALL of the $4$ available letters, and which
are counted up to renaming. The entry carries an empirical recurrence of order $6$
...
OEIS A209962 is ``Number of (n+1) X 2 0..3 arrays containing all values 0..3 with every 2 X 2 subblock having one or two distinct values, and new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
0, 0, 9, 162, 1845, 17262, 144945, 1138194,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 16*a(n-1) - 83*a(n-2) + 132*a(n-3) + 56*a(n-4) - 88*a(n-5) - 32*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 14 2018 05:19:49, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;16\,a(n-1) - 83\,a(n-2) + 132\,a(n-3) + 56\,a(n-4) - 88\,a(n-5) - 32\,a(n-6)
\]
for every $n>5$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209962.
