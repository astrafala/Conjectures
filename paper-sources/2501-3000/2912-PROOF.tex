...
\title{The empirical recurrence for OEIS A206208, proved by transfer matrix}
...
\begin{abstract}
OEIS A206208 counts, up to renaming the letters, the arrays of width $2$ over at most $3$
...
OEIS A206208 is ``Number of (n+1) X 2 0..2 arrays with every 2 X 3 or 3 X 2 subblock having exactly two equal edges, and new values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
14, 45, 162, 594, 2268, 8802, 34236, 133974,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) - a(n-2) + 12*a(n-3) - 36*a(n-4) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 14 2018 08:19:10, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206208.
