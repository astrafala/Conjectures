...
\title{The empirical recurrence for OEIS A205314, proved by transfer matrix}
...
\begin{abstract}
OEIS A205314 counts, up to renaming the letters, the arrays of width $5$ over at most $2$
...
OEIS A205314 is ``Number of (n+1) X 5 0..1 arrays with every 2 X 2 subblock having the same number of equal edges, and new values 0..1 introduced in row major order.''. It has offset $1$ and begins
\[
164, 1708, 18152, 193664, 2068148, 22091516, 235994088, 2521075824,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 17*a(n-1) -81*a(n-2) +157*a(n-3) -140*a(n-4) +56*a(n-5) -8*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 11 2018 10:51:28, revision 8) this is still
...
$w_i$ cleared of denominators and $S=37$ states in all. The walk index $j$ and the entry's own
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A205314.
