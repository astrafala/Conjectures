...
\title{The empirical column recurrences for the table OEIS A251335}
...
\begin{abstract}
OEIS A251335 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A251335 is ``T(n,k)=Number of (n+1)X(k+1) 0..2 arrays with every 2X2 subblock summing to 2 4 or 6.''. It has offset $1$, is
read by antidiagonals, and begins
\[
39, 171, 171, 753, 1115, 753, 3333, 7393,\ \dots
\]
The entry carries the following block:
\begin{quote}\small
Empirical for column k:\\
k=1: a(n) = 8*a(n-1) -13*a(n-2) -12*a(n-3)\\
k=2: a(n) = 18*a(n-1) -98*a(n-2) +100*a(n-3) +331*a(n-4) +42*a(n-5) -72*a(n-6)\\
k=3: [order 15]\\
k=4: [order 33]\\
k=5: [order 77]\\
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 10:22:01, revision 6) these are still
...
The sequence is ``Number of (n+1)X(2) 0..2 arrays with every 2X2 subblock summing to 2 4 or 6.''. Its rows are the vertices of a digraph on
...
\[
a(n)\;=\;8\,a(n-1) - 13\,a(n-2) - 12\,a(n-3)
\]
holds from index $2+1$ on.

\subsection*{Column $k$$=2$}
The sequence is ``Number of (n+1)X(3) 0..2 arrays with every 2X2 subblock summing to 2 4 or 6.''. Its rows are the vertices of a digraph on
$S=27$ vertices, edges being the admissible consecutive pairs, and the count is
$\mathbf{1}^{\!\top}M^{n}\mathbf{1}$ up to the constant factor in the entry's name.
The conjectured recurrence
\[
a(n)\;=\;18\,a(n-1) - 98\,a(n-2) + 100\,a(n-3) + 331\,a(n-4) + 42\,a(n-5) - 72\,a(n-6)
\]
...
$c_{1}$ & $49$ & $c_{5}$ & $-47347$ & $c_{9}$ & $-3063686$ & $c_{13}$ & $-1443456$ \\
$c_{2}$ & $-940$ & $c_{6}$ & $500152$ & $c_{10}$ & $3924236$ & $c_{14}$ & $-207360$ \\
$c_{3}$ & $8509$ & $c_{7}$ & $81043$ & $c_{11}$ & $5794584$ & $c_{15}$ & $110592$ \\
$c_{4}$ & $-30084$ & $c_{8}$ & $-3272883$ & $c_{12}$ & $519392$ &  &  \\
\end{tabular}\end{center}
Repeating with the first $15+4$ terms removed gives order $15$ again.

\subsection*{Column $k=4$, recovered}
The entry gives only the order for this line: ``k=4: [order 33]''. Its model is a walk on
...
$33$ --- the stated order --- with integer coefficients
\[
(c_1,\dots,c_{33})=(111,\ -5237,\ 134729,\ -1976784,\ 14570501,\ -6257960,\ -691950920,\ 3247825564,\ 12777329879,\ -101388355602,\ -188393021686,\ 1552588774998,\ 3138186098031,\ -10631972625424,\ -29038904778576,\ 24522254457525,\ 115175966523374,\ 1433760275247,\ -228490103219515,\ -79675394560726,\ 256041689359832,\ 114826605322128,\ -180212378888064,\ -68945736471552,\ 83818696903296,\ 16742484728832,\ -24182967520512,\ 158813849088,\ 3514094493696,\ -614056771584,\ -141288800256,\ 49463820288,\ -3822059520).
\]
Repeating with the first $33+4$ terms removed gives order $33$ again.

\subsection*{Column $k=5$, recovered}
The entry gives only the order for this line: ``k=5: [order 77]''. Its model is a walk on
...
$77$ --- the stated order --- with integer coefficients
\[
(c_1,\dots,c_{77})=(275,\ -34345,\ 2565781,\ -126724432,\ 4292522395,\ -98782830473,\ 1413517404314,\ -7612912632320,\ -133383749714916,\ 3020499366138663,\ -15498346546695193,\ -215961707858725792,\ 3182435178964201363,\ 742224312769079570,\ -255649972072533064746,\ 865959431482882404756,\ 13384382789346910149074,\ -72246147667899162384438,\ -549069127657465866397440,\ 3383738157632401895724599,\ 19582455866490607670391052,\ -104184297754863592692102503,\ -604803641655809194720528475,\ 2051317657345021199760224159,\ 14685899404014332688019801641,\ -21473601305560667312642838199,\ -254209984101641247688185667199,\ 1069600625746274705862692070,\ 2979085060420242613091956057303,\ 3209327698074998064598603685128,\ -23050694121290049944116212880016,\ -46959641845109045716859036004609,\ 113600352340335502033665703972821,\ 371384338955202307553267724784813,\ -313174601085497609135744039898035,\ -1916863787738892370194139649642349,\ 105832592488761284751853747838103,\ 6943909201757866800937448756980054,\ 2972593167321852884063800617850059,\ -18440034364001964908591684527354177,\ -14136576882171366548812874771889999,\ 37116717708306902115980380830202066,\ 37935135393840285987519403672968998,\ -58407303628883935977267879396180592,\ -70651618803505213563822919564378456,\ 74199231000094628390505851643327984,\ 97442919899818689943013009976919360,\ -78562477813128728355898951978031424,\ -102197657713469128164008483619737600,\ 70953426143517046227361498876083200,\ 82099168049248897767079891629714432,\ -54827155813695693326047481370763264,\ -50084443438251615988334397704351744,\ 35523334587060878688434778270490624,\ 22541151063932586056268321554268160,\ -18632115574112489006615926243164160,\ -6976376052756043489093283259809792,\ 7594925460022867070789451241357312,\ 1183965459271322357149995882119168,\ -2300001048359807298160958456725504,\ 52976185573881318200172897370112,\ 488186005309435470261569677426688,\ -87305748606191220324656775954432,\ -65697532292008443746177437925376,\ 22962056721905911172479083085824,\ 4214098233763875849356842106880,\ -3042480500730519038285303513088,\ 118991846631088358470327468032,\ 202151902381479986331220180992,\ -38008382788254573015620124672,\ -4234367761007131984159309824,\ 2097124275001632669692854272,\ -161983855235508518044827648,\ -27031648012843645950492672,\ 6221782667964118776938496,\ -462405872390666566238208,\ 12410209205174686187520).
\]
Repeating with the first $77+4$ terms removed gives order $77$ again.
...
model reproduces $16$ published values, $81$ decimal digits in all, every one of
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251335.
