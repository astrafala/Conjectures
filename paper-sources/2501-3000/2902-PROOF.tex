...
\title{The empirical recurrence for OEIS A269092, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A269092 counts arrays over $\{0,\dots,3\}$ subject to a condition on the array as a
...
OEIS A269092 is ``Number of n X 3 0..3 arrays with some element plus some horizontally or vertically adjacent neighbor totalling three exactly once.''. It has offset $1$ and begins
\[
24, 1152, 31296, 715320, 15024096, 300056400, 5795398368, 109294975080,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 36*a(n-1) - 378*a(n-2) + 972*a(n-3) - 729*a(n-4) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 19 2019 06:42:06, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;36\,a(n-1) - 378\,a(n-2) + 972\,a(n-3) - 729\,a(n-4)
\end{equation}
for all $n>5$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269092.
