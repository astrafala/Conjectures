...
\title{The empirical column recurrences for the table OEIS A234114}
...
\begin{abstract}
OEIS A234114 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A234114 is ``T(n,k)=Number of (n+1)X(k+1) 0..4 arrays with every 2X2 subblock having the sum of the absolute values of all six edge and diagonal differences equal to 12.''. It has offset $1$, is
read by antidiagonals, and begins
\[
56, 186, 186, 604, 608, 604, 2064, 2086,\ \dots
\]
...
k=4: [order 96]\\
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 09:11:41, revision 6) these are still
...
The sequence is ``Number of (n+1)X(2) 0..4 arrays with every 2X2 subblock having the sum of the absolute values of all six edge and diagonal differences equal to 12.''. Its rows are the vertices of a digraph on
...
\[
a(n)\;=\;5\,a(n-1) + 6\,a(n-2) - 50\,a(n-3) + 16\,a(n-4) + 80\,a(n-5) - 16\,a(n-6)
\]
...
The entry gives only the order for this line: ``k=2: [order 18]''. Its model is a walk on
...
$c_{1}$ & $8$ & $c_{6}$ & $-1805$ & $c_{11}$ & $-17822$ & $c_{16}$ & $3552$ \\
$c_{2}$ & $6$ & $c_{7}$ & $-6160$ & $c_{12}$ & $25464$ & $c_{17}$ & $-928$ \\
$c_{3}$ & $-172$ & $c_{8}$ & $8467$ & $c_{13}$ & $9216$ & $c_{18}$ & $64$ \\
$c_{4}$ & $144$ & $c_{9}$ & $14464$ & $c_{14}$ & $-15948$ &  &  \\
$c_{5}$ & $1438$ & $c_{10}$ & $-20123$ & $c_{15}$ & $136$ &  &  \\
\end{tabular}\end{center}
Repeating with the first $18+4$ terms removed gives order $18$ again.

\subsection*{Column $k=3$, recovered}
The entry gives only the order for this line: ``k=3: [order 40]''. Its model is a walk on
...
\[
(c_1,\dots,c_{40})=(7,\ 60,\ -438,\ -1782,\ 12360,\ 35330,\ -205978,\ -512290,\ 2229224,\ 5503649,\ -16243635,\ -43372518,\ 79850408,\ 248228062,\ -254990128,\ -1024802383,\ 454865089,\ 3032850159,\ -63270053,\ -6374308278,\ -1896654228,\ 9366697820,\ 5199067584,\ -9374661980,\ -7431981604,\ 6110120008,\ 6536677712,\ -2372079792,\ -3650095360,\ 416839296,\ 1285380768,\ 31536704,\ -277159232,\ -25366784,\ 34816896,\ 3406336,\ -2369024,\ -107520,\ 69632,\ -4096).
\]
...
model reproduces $8$ published values, $32$ decimal digits in all, every one of
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234114.
