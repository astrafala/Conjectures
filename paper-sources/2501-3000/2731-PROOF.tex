...
\title{The empirical closed form for OEIS A188838, proved}
...
\begin{abstract}
OEIS A188838 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A188838 is ``Number of n X 4 binary arrays without the pattern 0 1 diagonally or vertically.''. It has offset $1$ and begins
\[
16, 55, 121, 221, 364, 560, 820, 1156,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (1/24)*n\^{}4 + (11/12)*n\^{}3 + (155/24)*n\^{}2 + (163/12)*n - 6 for n>1.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 30 2018 12:24:13, revision 10) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{n^{4}}{24} + \frac{11 n^{3}}{12} + \frac{155 n^{2}}{24} + \frac{163 n}{12} - 6.
\]
...
First, the walk model reproduces every one of the $39$ terms the entry publishes,
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A188838.
