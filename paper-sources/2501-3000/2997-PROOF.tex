...
\title{The empirical recurrence for OEIS A269036, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A269036 counts arrays over $\{0,\dots,2\}$ subject to a condition on the array as a
...
OEIS A269036 is ``Number of 2 X n 0..2 arrays with some element plus some horizontally, diagonally or antidiagonally adjacent neighbor totalling two exactly once.''. It has offset $1$ and begins
\[
0, 24, 48, 216, 672, 2208, 6912, 21408,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 4*a(n-1) - 8*a(n-3) - 4*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 18 2019 09:57:53, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269036.
