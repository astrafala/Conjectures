...
\title{The empirical recurrence for OEIS A206354, proved by transfer matrix}
...
\begin{abstract}
OEIS A206354 counts arrays in which no entry may equal the entries at a short list of fixed offsets
...
$2$ consecutive rows, $S=2291$ states in all.
\end{abstract}
...
OEIS A206354 is ``Number of n X 3 0..4 arrays with no element equal to another within two positions in the same row or column, and new values 0..4 introduced in row major order.''. It has offset $1$ and begins
\[
1, 17, 230, 3284, 47060, 674564, 9669452, 138605744,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 16*a(n-1) - 20*a(n-2) - 58*a(n-3) + 33*a(n-4) + 30*a(n-5) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 15 2018 12:00:04, revision 9) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=2291.
\]
...
\begin{theorem}
\[
a(n)\;=\;16\,a(n-1) - 20\,a(n-2) - 58\,a(n-3) + 33\,a(n-4) + 30\,a(n-5)
\]
for every $n>6$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206354.
