...
\title{The empirical recurrence for OEIS A258889, proved by transfer matrix}
...
\begin{abstract}
OEIS A258889 counts arrays of width $5$ over $\{0,1\}$ in which every $3\times3$ window has
...
OEIS A258889 is ``Number of (n+2)X(3+2) 0..1 arrays with no 3x3 subblock diagonal sum less than the antidiagonal sum or central row sum less than the central column sum.''. It has offset $1$ and begins
\[
3036, 4489, 6072, 8100, 12804, 20164, 33252, 54756,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 15:31:58, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + 3\,a(n-2) - 16\,a(n-3) + 5\,a(n-4) + 23\,a(n-5) - 24\,a(n-6) + 15\,a(n-7) + 9\,a(n-8) - 58\,a(n-9) + 41\,a(n-10) + 17\,a(n-11) - 32\,a(n-12) + 45\,a(n-13) - 27\,a(n-14) - 24\,a(n-15) + 27\,a(n-16) - 15\,a(n-17) + 8\,a(n-18) + 9\,a(n-19) - 9\,a(n-20) + 2\,a(n-21) - a(n-22) - a(n-23) + a(n-24)
\]
for every $n>27$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A258889.
