...
\title{The empirical recurrence for OEIS A255658, proved by transfer matrix}
...
\begin{abstract}
OEIS A255658 carries an empirical recurrence of order $35$ contributed by R.~H.~Hardin. It is
...
OEIS A255658 is ``Number of length n+6 0..3 arrays with at most two downsteps in every 6 consecutive neighbor pairs.''. It has offset $1$ and begins
\[
10320, 33042, 112196, 385738, 1324872, 4542671, 15269184, 50963540,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 15:09:02, revision 6) this is still
...
admissible array is then exactly a walk, so with $M$ the adjacency matrix on $S=4096$ vertices
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) - 6\,a(n-2) + 20\,a(n-3) - 34\,a(n-4) + 24\,a(n-5) + 230\,a(n-6) - 552\,a(n-7) + 447\,a(n-8) - 4060\,a(n-9) + 6908\,a(n-10) - 2648\,a(n-11) - 10346\,a(n-12) + 26292\,a(n-13) - 21776\,a(n-14) + 185776\,a(n-15) - 406128\,a(n-16) + 326996\,a(n-17) - 196764\,a(n-18) + 82488\,a(n-19) - 13045\,a(n-20) - 115472\,a(n-21) + 108636\,a(n-22) - 29312\,a(n-23) + 73724\,a(n-24) - 12420\,a(n-25) - 41050\,a(n-26) + 38840\,a(n-27) - 21680\,a(n-28) + 3232\,a(n-29) - 12984\,a(n-30) + 13080\,a(n-31) - 4064\,a(n-32) + 320\,a(n-34) + 64\,a(n-35)
\]
for every $n>41$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A255658.
