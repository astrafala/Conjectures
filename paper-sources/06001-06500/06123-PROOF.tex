...
\title{The empirical recurrence for OEIS A232305, proved by transfer matrix}
...
\begin{abstract}
OEIS A232305 counts arrays of width $4$ over $\{0,1,2\}$ in which every cell carrying one stated
...
OEIS A232305 is ``Number of nX4 0..2 arrays with every 0 next to a 1 and every 1 next to a 2 horizontally, vertically or antidiagonally.''. It has offset $1$ and begins
\[
15, 1915, 107047, 6363511, 382995685, 22952606015, 1376103637041, 82507009197797,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 07:17:10, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232305.
