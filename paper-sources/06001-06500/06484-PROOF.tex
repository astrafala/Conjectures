...
\title{The empirical recurrence for OEIS A252577, proved by transfer matrix}
...
\begin{abstract}
OEIS A252577 counts $5\times(n+2)$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252577 is ``Number of (3+2)X(n+2) 0..3 arrays with every 3X3 subblock row and diagonal sum equal to 1 2 5 6 or 7 and every 3X3 column and antidiagonal sum not equal to 1 2 5 6 or 7.''. It has offset $1$ and begins
\[
890, 1558, 4168, 9051, 30532, 92725, 208375, 715437,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:24:12, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252577.
