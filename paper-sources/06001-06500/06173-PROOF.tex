...
\title{The empirical recurrence for OEIS A252571, proved by transfer matrix}
...
\begin{abstract}
OEIS A252571 counts $(n+2)\times7$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
every $3\times3$ subblock, and it carries an empirical recurrence of order $84$
...
$a(n)$ is a walk count on $S=17338$ vertices. Such a sequence is $C$-finite, so whether a given
...
OEIS A252571 is ``Number of (n+2)X(5+2) 0..3 arrays with every 3X3 subblock row and diagonal sum equal to 1 2 5 6 or 7 and every 3X3 column and antidiagonal sum not equal to 1 2 5 6 or 7.''. It has offset $1$ and begins
\[
2985, 8980, 30532, 107651, 498696, 1887578, 7115253, 31894631,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:23:30, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;141\,a(n-3) - 7068\,a(n-6) + 174395\,a(n-9) - 2506081\,a(n-12) + 23429882\,a(n-15) - 154146596\,a(n-18) + 751684236\,a(n-21) - 2807197814\,a(n-24) + 8200818320\,a(n-27) - 19010699089\,a(n-30) + 35232932261\,a(n-33) - 52135315240\,a(n-36) + 60934776517\,a(n-39) - 55197026700\,a(n-42) + 37698656303\,a(n-45) - 18536879660\,a(n-48) + 5844224877\,a(n-51) - 584621719\,a(n-54) - 503336664\,a(n-57) + 341137814\,a(n-60) - 120629020\,a(n-63) + 28933758\,a(n-66) - 4962244\,a(n-69) + 608117\,a(n-72) - 51421\,a(n-75) + 2778\,a(n-78) - 83\,a(n-81) + a(n-84)
\]
for every $n>89$.
\end{theorem}

\begin{proof}
The vector $w=q(M)\mathbf{1}$ was formed by $84$ matrix--vector products in exact
integer arithmetic and $\mathbf{1}^{\!\top}M^{j}w$ evaluated for $j=0,1,\dots$, again
exactly. Those integers vanish from the index corresponding to $n=89+1$ onwards, and the
run was continued until the working vector was identically zero, which settles all larger $j$
at once. By Lemma~\ref{lem:crit} the recurrence holds for every $n>89$.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252571.
