...
\title{The empirical recurrence for OEIS A302520, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A302520 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
values of its neighbours, and carries an empirical recurrence of order $50$ contributed
...
OEIS A302520 is ``Number of 7Xn 0..1 arrays with every element equal to 0, 1, 4 or 5 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
64, 22, 28, 163, 376, 1088, 4558, 23944,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 09 2018 09:13:34, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 2\,a(n-2) + 5\,a(n-3) + 124\,a(n-4) + 113\,a(n-5) + 37\,a(n-6) - 47\,a(n-7) - 2901\,a(n-8) - 2868\,a(n-9) + 1875\,a(n-10) + 1261\,a(n-11) + 23265\,a(n-12) + 25593\,a(n-13) - 20268\,a(n-14) - 3073\,a(n-15) - 107075\,a(n-16) - 94478\,a(n-17) + 62944\,a(n-18) - 76347\,a(n-19) + 312669\,a(n-20) + 13413\,a(n-21) - 39205\,a(n-22) + 181202\,a(n-23) - 498359\,a(n-24) + 274119\,a(n-25) - 94414\,a(n-26) - 149744\,a(n-27) + 474263\,a(n-28) - 414929\,a(n-29) + 213390\,a(n-30) + 15865\,a(n-31) - 247470\,a(n-32) + 277066\,a(n-33) - 158702\,a(n-34) + 55846\,a(n-35) + 49720\,a(n-36) - 84556\,a(n-37) + 33873\,a(n-38) - 14054\,a(n-39) - 8001\,a(n-40) + 7808\,a(n-41) - 664\,a(n-42) + 901\,a(n-43) + 3003\,a(n-44) + 424\,a(n-45) - 703\,a(n-46) - 236\,a(n-47) - 92\,a(n-48) - 40\,a(n-49) - 4\,a(n-50)
\end{equation}
for all $n>55$.

\section{The condition, and why one column is not enough}

The arrays have $7$ rows and $L=n$ columns; write $x_{t,u}$ for the entry in
...
\#\{\text{neighbours with a value }equal to\ x_{t,u}\}\in\{0,1,4,5\}
\end{equation}
...
Let $V=\{0,\dots,1\}^{7}$ be the possible columns and take
...
and $7$ rows. In the walk, the cells of column $t$ for $2\le t\le L-1$ are tested
...
and $7$ cells in a column, so $|V|=2^{7}=128$, and the vertex set is
$V\times V$, of size $128^2=16384$. That is the whole of the state: two consecutive
...
publishes, $n=24$, the arrays have $7\cdot24$ cells over
$2$ values, so there are about $10^{50}$ of them to sift. The
walk count replaces that by $16384$ states and one matrix--vector product per column.
...
$o=1n_0+0-2$. Then for $j\ge50$,
\[
a(n_0+j)-\sum_i c_i\,a(n_0+j-i)\;=\;\,\mathbf{v}^{\!\top}G^{\,j-50}w,
\qquad w=h_{50}-\sum_i c_i\,h_{50-i} .
\]
...
\begin{proof}
Substitute Lemma~\ref{lem:walk} and factor $G^{j-50}$ out of
...
\begin{theorem}
The recurrence \eqref{eq:conj} holds for every $n>55$, which is the statement of
Section~1.
\end{theorem}

\begin{proof}
The digraph was built directly from \eqref{eq:loc}: for each of the $S=16384$ pairs and each
of the $(1+1)^{7}$ possible next columns, the condition was tested on every cell of
the middle column. The vector $w$ was formed by $50$ applications of $G$ in exact integer
arithmetic and $\mathbf{v}^{\!\top}G^{m}w$ evaluated for $m=0,1,\dots$, again exactly.
Every one of those integers vanishes from the index corresponding to $n=55+1$ onwards,
...
every one of the $24$ published indices, with no shift fitted: the number of columns is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302520.
