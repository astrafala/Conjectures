...
\title{The empirical recurrence for OEIS A298543, proved by transfer matrix}
...
\begin{abstract}
OEIS A298543 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $equal to$ itself lying in $\{1,2,3,4,7\}$, and it carries an empirical
...
OEIS A298543 is ``Number of nX4 0..1 arrays with every element equal to 1, 2, 3, 4 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
2, 61, 588, 4771, 41762, 367315, 3215618, 28178880,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 21 2018 06:09:26, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;8\,a(n-1) + 6\,a(n-2) + 36\,a(n-3) - 199\,a(n-4) - 489\,a(n-5) - 607\,a(n-6) + 190\,a(n-7) + 2704\,a(n-8) + 3152\,a(n-9) + 1937\,a(n-10) - 4117\,a(n-11) - 883\,a(n-12) - 1120\,a(n-13) + 4348\,a(n-14) - 5819\,a(n-15) - 5356\,a(n-16) + 140\,a(n-17) + 908\,a(n-18) - 6185\,a(n-19) - 1785\,a(n-20) + 9257\,a(n-21) + 3188\,a(n-22) - 3046\,a(n-23) + 1121\,a(n-24) + 645\,a(n-25) - 4057\,a(n-26) + 101\,a(n-27) + 2424\,a(n-28) - 327\,a(n-29) - 420\,a(n-30) + 312\,a(n-31) - 14\,a(n-32) - 64\,a(n-33) - 6\,a(n-35) + 2\,a(n-36)
\end{equation}
for all $n>39$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A298543.
