...
\title{The empirical recurrence for OEIS A264274, proved by transfer matrix}
...
\begin{abstract}
OEIS A264274 carries an empirical recurrence of order $22$ contributed by R.~H.~Hardin. It is
...
OEIS A264274 is ``Number of (3+1)X(n+1) arrays of permutations of 0..n*4+3 with each element having index change +-(.,.) 0,0 1,0 or 1,2.''. It has offset $1$ and begins
\[
25, 305, 3721, 40626, 443556, 4861800, 53290000, 586058600,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 10 2015 11:33:10, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;11\,a(n-1) + 10\,a(n-2) - 110\,a(n-3) - 111\,a(n-4) + 1210\,a(n-5) + 1341\,a(n-6) - 14630\,a(n-7) - 111\,a(n-8) - 110\,a(n-9) + 1451\,a(n-10) - 1451\,a(n-12) + 110\,a(n-13) + 111\,a(n-14) + 14630\,a(n-15) - 1341\,a(n-16) - 1210\,a(n-17) + 111\,a(n-18) + 110\,a(n-19) - 10\,a(n-20) - 11\,a(n-21) + a(n-22)
\]
for every $n>22$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264274.
