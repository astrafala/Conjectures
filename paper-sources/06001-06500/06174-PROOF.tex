...
\title{The empirical recurrence for OEIS A252610, proved by transfer matrix}
...
\begin{abstract}
OEIS A252610 counts $(n+2)\times5$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252610 is ``Number of (n+2)X(3+2) 0..3 arrays with every 3X3 subblock row and diagonal sum equal to 0 3 5 6 or 8 and every 3X3 column and antidiagonal sum not equal to 0 3 5 6 or 8.''. It has offset $1$ and begins
\[
1717, 2815, 7031, 15119, 51614, 153189, 342559, 1193633,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:26:37, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;52\,a(n-3) - 856\,a(n-6) + 5181\,a(n-9) - 18180\,a(n-12) + 51196\,a(n-15) - 102032\,a(n-18) + 138624\,a(n-21) - 161024\,a(n-24) + 136192\,a(n-27) - 49152\,a(n-30)
\]
for every $n>38$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252610.
