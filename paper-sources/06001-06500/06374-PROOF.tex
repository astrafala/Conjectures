...
\title{The empirical recurrence for OEIS A251841, proved by transfer matrix}
...
\begin{abstract}
OEIS A251841 counts $(n+2)\times6$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
$a(n)$ is a walk count on $S=248779$ vertices. Such a sequence is $C$-finite, so whether a given
...
OEIS A251841 is ``Number of (n+2)X(4+2) 0..3 arrays with every 3X3 subblock row and column sum nonprime and every diagonal and antidiagonal sum prime.''. It has offset $1$ and begins
\[
872, 1229, 2890, 5860, 18708, 48692, 100973, 328235,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:30:07, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;41\,a(n-3) - 521\,a(n-6) + 2122\,a(n-9) - 3698\,a(n-12) + 2906\,a(n-15) - 927\,a(n-18) + 157\,a(n-21) - 89\,a(n-24) + 10\,a(n-27)
\]
for every $n>32$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251841.
