...
\title{An element and the cells around it: OEIS A240480}
...
\begin{abstract}
OEIS A240480 carries an empirical recurrence of order $22$ contributed by R.~H.~Hardin. It is
...
OEIS A240480 is ``Number of nX4 0..1 arrays with no element equal to more than two horizontal or vertical neighbors, with new values 0..1 introduced in row major order.''. It has offset $1$ and begins
\[
8, 81, 578, 4104, 29084, 205754, 1455916, 10304849,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 11:01:26, revision 6) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{The count is a walk count}

The entry counts arrays with $4$ columns over the alphabet $\{0,1\}$, growing one row at a time, and asks that no element may equal more than $2$ of its horizontal and vertical neighbours.
...
Merging vertices with identical futures leaves $S=24$. An admissible array is exactly a walk, so with $M$ the adjacency matrix and $\iota,\tau$ the vectors recording which states may begin and end an array,
\[
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A240480.
