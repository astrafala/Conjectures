...
\title{The empirical recurrence for OEIS A252633, proved by transfer matrix}
...
\begin{abstract}
OEIS A252633 counts $(n+2)\times3$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252633 is ``Number of (n+2)X(1+2) 0..3 arrays with every 3X3 subblock row and diagonal sum equal to 0 3 4 6 or 7 and every 3X3 column and antidiagonal sum not equal to 0 3 4 6 or 7.''. It has offset $1$ and begins
\[
572, 687, 1189, 2230, 4382, 8697, 17046, 34424,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 25*a(n-3) -222*a(n-6) +815*a(n-9) -1085*a(n-12) +696*a(n-15) -756*a(n-18) for n>24
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:28:48, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252633.
