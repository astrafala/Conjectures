...
\title{The empirical recurrence for OEIS A252059, proved by transfer matrix}
...
\begin{abstract}
OEIS A252059 counts $(n+2)\times4$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A252059 is ``Number of (n+2)X(2+2) 0..2 arrays with every 3X3 subblock row, column, diagonal and antidiagonal sum not equal to 1 2 or 4.''. It has offset $1$ and begins
\[
200, 346, 817, 2081, 5610, 15593, 43618, 122839,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 10:44:23, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) - a(n-2) + 10\,a(n-3) - 24\,a(n-4) + a(n-5) - 27\,a(n-6) + 62\,a(n-7) + 7\,a(n-8) + 27\,a(n-9) - 51\,a(n-10) - 2\,a(n-11) - 9\,a(n-12) - 37\,a(n-13) - 48\,a(n-14) - a(n-15) + 95\,a(n-16) + 85\,a(n-17) + 9\,a(n-18) - 55\,a(n-19) - 46\,a(n-20) - 16\,a(n-21) - 7\,a(n-23) + 6\,a(n-24) + 13\,a(n-25) + 13\,a(n-26) + 4\,a(n-27) - 5\,a(n-28) - 3\,a(n-29) - 2\,a(n-30)
\]
for every $n>32$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252059.
