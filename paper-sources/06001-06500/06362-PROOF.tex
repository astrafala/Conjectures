...
\title{The empirical recurrence for OEIS A264343, proved by transfer matrix}
...
\begin{abstract}
OEIS A264343 carries an empirical recurrence of order $34$ contributed by R.~H.~Hardin. It is
...
OEIS A264343 is ``Number of (3+1) X (n+1) arrays of permutations of 0..n*4+3 with each element having index change +-(.,.) 0,0 0,1 or 1,2.''. It has offset $1$ and begins
\[
16, 233, 4900, 70669, 1243225, 20386617, 345358201, 5804687049,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 07 2022 22:27:30, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;14\,a(n-1) + 139\,a(n-2) - 1260\,a(n-3) - 7702\,a(n-4) + 43762\,a(n-5) + 217890\,a(n-6) - 744490\,a(n-7) - 3383575\,a(n-8) + 6630690\,a(n-9) + 29495043\,a(n-10) - 31906396\,a(n-11) - 148462702\,a(n-12) + 80910366\,a(n-13) + 438178264\,a(n-14) - 91294992\,a(n-15) - 756685497\,a(n-16) + 756685497\,a(n-18) + 91294992\,a(n-19) - 438178264\,a(n-20) - 80910366\,a(n-21) + 148462702\,a(n-22) + 31906396\,a(n-23) - 29495043\,a(n-24) - 6630690\,a(n-25) + 3383575\,a(n-26) + 744490\,a(n-27) - 217890\,a(n-28) - 43762\,a(n-29) + 7702\,a(n-30) + 1260\,a(n-31) - 139\,a(n-32) - 14\,a(n-33) + a(n-34)
\]
for every $n>34$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264343.
