...
\title{The empirical column recurrences for the table OEIS A305911}
...
\begin{abstract}
OEIS A305911 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A305911 is ``T(n,k) = Number of n X k 0..1 arrays with every element unequal to 0, 1, 2, 4, 5 or 7 king-move adjacent elements, with upper left element zero.''. It has offset $1$, is
read by antidiagonals, and begins
\[
1, 2, 2, 4, 4, 4, 8, 14,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 26 2021 14:41:05, revision 6) these are still
...
The sequence is ``Number of n X 2 0..1 arrays with every element unequal to 0, 1, 2, 4, 5 or 7 king-move adjacent elements, with upper left element zero.''. Its rows are the vertices of a digraph on
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A305911.
