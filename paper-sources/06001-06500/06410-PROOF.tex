...
\title{The empirical recurrence for OEIS A204360, proved by transfer matrix}
...
\begin{abstract}
OEIS A204360 counts $(n+2)\times9$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A204360 is ``Number of (n+2)X9 0..1 arrays with every 3X3 subblock having three equal elements in a row horizontally, vertically, diagonally or antidiagonally exactly one way, and new values 0..1 introduced in row major order.''. It has offset $1$ and begins
\[
75324, 137407, 236382, 383714, 901622, 2225410, 5145580, 11331092,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 11:10:04, revision 9) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204360.
