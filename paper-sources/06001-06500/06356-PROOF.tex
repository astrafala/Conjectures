...
\title{The empirical recurrence for OEIS A252317, proved by transfer matrix}
...
\begin{abstract}
OEIS A252317 counts $(n+2)\times6$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
every $3\times3$ subblock, and it carries an empirical recurrence of order $32$
...
$a(n)$ is a walk count on $S=1203794$ vertices. Such a sequence is $C$-finite, so whether a given
...
OEIS A252317 is ``Number of (n+2)X(4+2) 0..3 arrays with every 3X3 subblock row, column, diagonal and antidiagonal sum not equal to 0 1 3 6 or 7.''. It has offset $1$ and begins
\[
7815, 2579, 6011, 23422, 97191, 409636, 1741936, 7424869,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:04:28, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 6\,a(n-2) + 20\,a(n-3) + 54\,a(n-4) + 38\,a(n-5) - 41\,a(n-6) - 191\,a(n-7) - 285\,a(n-8) + 297\,a(n-9) + 752\,a(n-10) - 166\,a(n-11) - 811\,a(n-12) - 153\,a(n-13) + 296\,a(n-14) + 139\,a(n-15) + 173\,a(n-16) + 339\,a(n-17) - 299\,a(n-18) - 788\,a(n-19) + 163\,a(n-20) + 779\,a(n-21) + 92\,a(n-22) - 330\,a(n-23) - 98\,a(n-24) + 18\,a(n-25) - 54\,a(n-26) + 3\,a(n-27) + 35\,a(n-28) - 3\,a(n-29) + 12\,a(n-30) + 7\,a(n-31) - 4\,a(n-32)
\]
for every $n>37$.
\end{theorem}

\begin{proof}
The vector $w=q(M)\mathbf{1}$ was formed by $32$ matrix--vector products in exact
integer arithmetic and $\mathbf{1}^{\!\top}M^{j}w$ evaluated for $j=0,1,\dots$, again
exactly. Those integers vanish from the index corresponding to $n=37+1$ onwards, and the
run was continued until the working vector was identically zero, which settles all larger $j$
at once. By Lemma~\ref{lem:crit} the recurrence holds for every $n>37$.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252317.
