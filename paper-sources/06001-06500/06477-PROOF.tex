...
\title{The empirical recurrence for OEIS A260204, proved by transfer matrix}
...
\begin{abstract}
OEIS A260204 counts $(n+2)\times7$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A260204 is ``Number of (n+2) X (5+2) 0..1 arrays with each 3 X 3 subblock having clockwise perimeter pattern 00000000 00000001 or 00010001.''. It has offset $1$ and begins
\[
478, 1163, 5291, 20408, 85168, 359112, 1473681, 6100163,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 02 2025 21:48:59, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A260204.
