...
\title{The empirical recurrence for OEIS A189698, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A189698 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
values of its neighbours, and carries an empirical recurrence of order $47$ contributed
...
OEIS A189698 is ``Number of 5Xn binary arrays without the pattern 0 0 1 diagonally, vertically or antidiagonally.''. It has offset $1$ and begins
\[
20, 400, 5172, 65297, 862652, 11451149, 151788273, 2010430729,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 05:24:35, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;20\,a(n-1) - 60\,a(n-2) - 633\,a(n-3) + 4289\,a(n-4) - 19321\,a(n-5) + 45093\,a(n-6) + 478124\,a(n-7) - 2450407\,a(n-8) + 3842305\,a(n-9) - 5871294\,a(n-10) - 109929744\,a(n-11) + 546273704\,a(n-12) + 220749058\,a(n-13) - 3057836472\,a(n-14) + 4168921034\,a(n-15) - 11914638925\,a(n-16) - 14152632954\,a(n-17) + 115745535531\,a(n-18) - 51347303247\,a(n-19) + 2966824602\,a(n-20) + 207246843786\,a(n-21) - 1457083257908\,a(n-22) + 128501680584\,a(n-23) + 1854676590096\,a(n-24) - 844352601056\,a(n-25) + 5479925969392\,a(n-26) + 1148855458112\,a(n-27) - 10789933618176\,a(n-28) - 902145093976\,a(n-29) - 5459853101552\,a(n-30) - 3627163886960\,a(n-31) + 18812592077712\,a(n-32) + 8566261898624\,a(n-33) - 1211282099328\,a(n-34) - 1296831985536\,a(n-35) - 12299160022784\,a(n-36) - 6520706736128\,a(n-37) + 3578172086272\,a(n-38) + 2696006297600\,a(n-39) + 2021760851968\,a(n-40) + 843021844480\,a(n-41) - 530584764416\,a(n-42) - 302591115264\,a(n-43) - 113839702016\,a(n-44) - 44088426496\,a(n-45) + 14579400704\,a(n-46) + 2214592512\,a(n-47)
\end{equation}
for all $n>48$.
...
$o=1n_0+0-2$. Then for $j\ge47$,
\[
a(n_0+j)-\sum_i c_i\,a(n_0+j-i)\;=\;\,\mathbf{v}^{\!\top}G^{\,j-47}w,
\qquad w=h_{47}-\sum_i c_i\,h_{47-i} .
\]
...
\begin{proof}
Substitute Lemma~\ref{lem:walk} and factor $G^{j-47}$ out of
...
\begin{theorem}
The recurrence \eqref{eq:conj} holds for every $n>48$, which is the statement of
Section~1.
\end{theorem}
...
the middle column. The vector $w$ was formed by $47$ applications of $G$ in exact integer
arithmetic and $\mathbf{v}^{\!\top}G^{m}w$ evaluated for $m=0,1,\dots$, again exactly.
Every one of those integers vanishes from the index corresponding to $n=48+1$ onwards,
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A189698.
