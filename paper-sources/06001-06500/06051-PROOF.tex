...
\title{The empirical recurrence for OEIS A275563, proved by counting patterns}
...
\begin{abstract}
OEIS A275563 counts arrays in which no entry may repeat a value found at any of three stated
...
cutting $535538$ pairs to $S=90623$ states. The entry's empirical recurrence of order $35$,
...
OEIS A275563 is ``Number of nX6 0..2 arrays with no element equal to any value at offset (-2,0) (-1,2) or (0,-2) and new values introduced in order 0..2.''. It has offset $1$ and begins
\[
24, 864, 1536, 8664, 42336, 221184, 1140576, 5880600,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 01 2016 21:26:37, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) + 18\,a(n-2) - 43\,a(n-3) - 174\,a(n-4) + 312\,a(n-5) + 789\,a(n-6) - 1739\,a(n-7) - 1097\,a(n-8) + 5171\,a(n-9) - 1998\,a(n-10) - 9410\,a(n-11) + 11413\,a(n-12) + 12083\,a(n-13) - 26002\,a(n-14) - 10656\,a(n-15) + 37255\,a(n-16) + 8019\,a(n-17) - 36716\,a(n-18) - 8772\,a(n-19) + 28058\,a(n-20) + 9837\,a(n-21) - 18944\,a(n-22) - 7243\,a(n-23) + 11224\,a(n-24) + 2985\,a(n-25) - 5229\,a(n-26) - 484\,a(n-27) + 1725\,a(n-28) - 126\,a(n-29) - 363\,a(n-30) + 74\,a(n-31) + 45\,a(n-32) - 13\,a(n-33) - 3\,a(n-34) + a(n-35)
\end{equation}
for all $n>37$.
...
$o=1n_0+0-2$, we have for $j\ge35$
\[
3!\Bigl(a(n_0+j)-\sum_i c_i\,a(n_0+j-i)\Bigr)
=\mathbf{v}^{\!\top}G^{\,j-35}w,\qquad
w=h_{35}-\sum_i c_i h_{35-i} .
\]
...
the survivors by the pattern of the new pair. The vector $w$ was formed by $35$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A275563.
