...
\title{The empirical recurrence for OEIS A306163, proved by transfer matrix}
...
\begin{abstract}
OEIS A306163 counts $5$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $different from$ itself lying in $\{0,1,2,5,6,7\}$, and it carries an empirical
...
OEIS A306163 is ``Number of n X 5 0..1 arrays with every element unequal to 0, 1, 2, 5, 6 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
16, 22, 77, 298, 1188, 4849, 19176, 75681,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 13 2021 00:27:18, revision
6) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 3\,a(n-2) + 15\,a(n-3) - 18\,a(n-4) - 91\,a(n-5) - 147\,a(n-6) + 121\,a(n-7) + 669\,a(n-8) + 497\,a(n-9) - 719\,a(n-10) - 1587\,a(n-11) - 720\,a(n-12) + 1486\,a(n-13) + 2865\,a(n-14) + 267\,a(n-15) - 2474\,a(n-16) - 2477\,a(n-17) - 1036\,a(n-18) + 2694\,a(n-19) + 2715\,a(n-20) + 347\,a(n-21) - 2258\,a(n-22) - 1637\,a(n-23) - 370\,a(n-24) + 1054\,a(n-25) + 1546\,a(n-26) + 270\,a(n-27) - 379\,a(n-28) - 524\,a(n-29) - 448\,a(n-30) - 10\,a(n-31) + 62\,a(n-32) + 172\,a(n-33) + 77\,a(n-34) + 17\,a(n-35) + 17\,a(n-36) - 44\,a(n-37) - 2\,a(n-38) + 2\,a(n-39) - 4\,a(n-40)
\end{equation}
for all $n>47$.
...
has score in $\{0,1,2,5,6,7\}$. The entry also fixes the top-left entry to be $0$; that is a condition on the first row alone, so it restricts the start vector and nothing else.
...
\begin{itemize}
\item $\mathbf{s}(r,s)=1$ when every cell of $r$ has score in $\{0,1,2,5,6,7\}$ \emph{with no row
above $r$} and $r_1=0$, and $0$ otherwise;
\item an edge $(r,s)\to(s,t)$ when every cell of $s$ has score in $\{0,1,2,5,6,7\}$ computed from
$r$, $s$ and $t$;
\item $\mathbf{e}(r,s)=1$ when every cell of $s$ has score in $\{0,1,2,5,6,7\}$ \emph{with no row
...
exactly when every one of its $n$ rows has all scores in $\{0,1,2,5,6,7\}$. Read the sequence as the
...
\begin{theorem}
The recurrence \eqref{eq:conj} holds for every $n>47$. This is the statement of
Section~1.
\end{theorem}
...
They vanish from the index corresponding to $n=47+1$ onwards, and the run was continued
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A306163.
