...
\title{The empirical recurrence for OEIS A298926, proved by transfer matrix}
...
\begin{abstract}
OEIS A298926 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $equal to$ itself lying in $\{2,3,5,7,8\}$, and it carries an empirical
...
OEIS A298926 is ``Number of n X 4 0..1 arrays with every element equal to 2, 3, 5, 7 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
0, 2, 4, 11, 23, 72, 201, 597,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 04 2022 13:20:04, revision
6) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) - 10\,a(n-2) + 7\,a(n-3) - 23\,a(n-4) + 31\,a(n-5) - 15\,a(n-6) + 104\,a(n-7) - 147\,a(n-8) + 182\,a(n-9) - 366\,a(n-10) + 376\,a(n-11) - 685\,a(n-12) + 689\,a(n-13) - 613\,a(n-14) + 1143\,a(n-15) - 710\,a(n-16) - 129\,a(n-17) - 82\,a(n-18) - 584\,a(n-19) + 5620\,a(n-20) - 1356\,a(n-21) + 6298\,a(n-22) - 15575\,a(n-23) + 6568\,a(n-24) - 15985\,a(n-25) + 6661\,a(n-26) - 23488\,a(n-27) + 19556\,a(n-28) + 16109\,a(n-29) + 18333\,a(n-30) + 8059\,a(n-31) - 12197\,a(n-32) + 16533\,a(n-33) - 27875\,a(n-34) - 8576\,a(n-35) - 28209\,a(n-36) + 16299\,a(n-37) + 26487\,a(n-38) + 4040\,a(n-39) - 22226\,a(n-40) + 1134\,a(n-41) - 9128\,a(n-42) - 7294\,a(n-43) + 16692\,a(n-44) + 6504\,a(n-45) + 1137\,a(n-46) - 5253\,a(n-47) + 2127\,a(n-48) - 324\,a(n-49) + 1885\,a(n-50) - 1689\,a(n-51) - 59\,a(n-52) - 235\,a(n-53) + 346\,a(n-54) - 86\,a(n-55) + 12\,a(n-56) - 46\,a(n-57) + 24\,a(n-58) + 8\,a(n-59) - 4\,a(n-60)
\end{equation}
for all $n>61$.
...
has score in $\{2,3,5,7,8\}$. The entry also fixes the top-left entry to be $0$; that is a condition on the first row alone, so it restricts the start vector and nothing else.
...
\begin{itemize}
\item $\mathbf{s}(r,s)=1$ when every cell of $r$ has score in $\{2,3,5,7,8\}$ \emph{with no row
above $r$} and $r_1=0$, and $0$ otherwise;
\item an edge $(r,s)\to(s,t)$ when every cell of $s$ has score in $\{2,3,5,7,8\}$ computed from
$r$, $s$ and $t$;
\item $\mathbf{e}(r,s)=1$ when every cell of $s$ has score in $\{2,3,5,7,8\}$ \emph{with no row
...
exactly when every one of its $n$ rows has all scores in $\{2,3,5,7,8\}$. Read the sequence as the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A298926.
