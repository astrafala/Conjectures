...
\title{The empirical recurrence for OEIS A247721, proved by transfer matrix}
...
\begin{abstract}
OEIS A247721 carries an empirical recurrence of order $27$ contributed by R.~H.~Hardin. It is
...
OEIS A247721 is ``Number of length n+3 0..3 arrays with no disjoint pairs in any consecutive four terms having the same sum.''. It has offset $1$ and begins
\[
168, 456, 1248, 3424, 9392, 25822, 71060, 195536,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 11:36:31, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) - 3\,a(n-2) + 8\,a(n-3) + 16\,a(n-4) - 8\,a(n-5) + 46\,a(n-6) - 48\,a(n-7) - 25\,a(n-8) - 38\,a(n-10) + 62\,a(n-11) - 58\,a(n-12) + 72\,a(n-13) - 354\,a(n-14) + 246\,a(n-15) - 26\,a(n-16) + 162\,a(n-17) - 183\,a(n-18) - 112\,a(n-19) - 34\,a(n-20) + 112\,a(n-21) + 320\,a(n-22) - 166\,a(n-23) - 80\,a(n-24) - 90\,a(n-25) - 12\,a(n-26) + 72\,a(n-27)
\]
for every $n>26$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A247721.
