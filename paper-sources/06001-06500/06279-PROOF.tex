...
\title{The empirical recurrence for OEIS A318093, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A318093 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A318093 is ``Number of nX3 0..1 arrays with every element unequal to 1, 2, 3 or 5 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
1, 16, 45, 220, 795, 3310, 12774, 51298,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 16 2018 10:27:53, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;14\,a(n-2) + 18\,a(n-3) - 23\,a(n-4) - 69\,a(n-5) - 69\,a(n-6) - 38\,a(n-7) + 82\,a(n-8) + 261\,a(n-9) + 101\,a(n-10) - 10\,a(n-11) - 20\,a(n-12) - 112\,a(n-13) - 112\,a(n-14) - 90\,a(n-15) - 24\,a(n-16) - 12\,a(n-17) + 4\,a(n-18) + 4\,a(n-19)
\end{equation}
for all $n>21$.
...
\#\{\text{neighbours with a value }different from\ x_{t,u}\}\in\{1,2,3,5\}
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A318093.
