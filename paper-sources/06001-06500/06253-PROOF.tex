...
\title{The empirical recurrence for OEIS A204402, proved by transfer matrix}
...
\begin{abstract}
OEIS A204402 counts $(n+2)\times4$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A204402 is ``Number of (n+2)X4 0..2 arrays with every 3X3 subblock having three strictly increasing elements in a row horizontally, vertically or nw-to-se diagonally.''. It has offset $1$ and begins
\[
47883, 347247, 3588983, 45603178, 518498299, 5787193185, 70339685822, 814228386252,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 11:12:05, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;9\,a(n-2) + 1405\,a(n-3) + 2993\,a(n-4) + 6990\,a(n-5) - 315063\,a(n-6) - 613391\,a(n-7) - 2273244\,a(n-8) + 676631\,a(n-9) + 17849170\,a(n-10) - 7846430\,a(n-11) + 10274954\,a(n-12) - 70166717\,a(n-13) + 42969746\,a(n-14) + 240417414\,a(n-15) - 315371199\,a(n-16) - 622366785\,a(n-17) - 1449702147\,a(n-18) + 678506787\,a(n-19) + 1613205171\,a(n-20) + 5474271942\,a(n-21) + 5320562958\,a(n-22) + 2946640590\,a(n-23) + 7655777046\,a(n-24) + 5086973502\,a(n-25) + 18357895944\,a(n-26) + 14540459526\,a(n-27) + 22148256384\,a(n-28) - 867311712\,a(n-29)
\]
for every $n>32$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204402.
