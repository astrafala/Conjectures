...
\title{The empirical recurrence for OEIS A250568, proved by transfer matrix}
...
\begin{abstract}
OEIS A250568 counts arrays over $\{0,1\}$ in which a statistic taken over short runs
...
window of consecutive rows, so the count is a walk count on $S=3375$ states, and the
...
OEIS A250568 is ``Number of (n+2)X(2+2) 0..1 arrays with nondecreasing maximum of every three consecutive values in every row and column.''. It has offset $1$ and begins
\[
3375, 39852, 463006, 5281190, 59025322, 656805747, 7283102949, 80572967431,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 12:32:58, revision 6) this is still
...
Fix the statistic $\sigma(v)=\max_t v_t$ of a run $v$ of $3$ consecutive cells --- in words,
the maximum of the $3$ values. Two derived arrays are formed and both must be
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=3375,
\]
...
\begin{theorem}
\[
a(n)\;=\;14\,a(n-1) - 10\,a(n-2) - 30\,a(n-3) - 3170\,a(n-4) + 4216\,a(n-5) + 25146\,a(n-6) + 250042\,a(n-7) - 341325\,a(n-8) - 1568242\,a(n-9) - 8687308\,a(n-10) + 9449792\,a(n-11) + 35649848\,a(n-12) + 155138752\,a(n-13) - 115721952\,a(n-14) - 382633312\,a(n-15) - 1555690146\,a(n-16) + 675955548\,a(n-17) + 2149108188\,a(n-18) + 9193269172\,a(n-19) - 1764843612\,a(n-20) - 6156832816\,a(n-21) - 32786507324\,a(n-22) + 802730756\,a(n-23) + 7136229438\,a(n-24) + 71641688940\,a(n-25) + 4949326424\,a(n-26) + 2825573648\,a(n-27) - 98127631080\,a(n-28) - 10872718912\,a(n-29) - 16123327568\,a(n-30) + 85681472432\,a(n-31) + 10646497059\,a(n-32) + 17459854358\,a(n-33) - 48074175586\,a(n-34) - 5906103334\,a(n-35) - 9299023250\,a(n-36) + 17317546552\,a(n-37) + 1919830834\,a(n-38) + 2745659890\,a(n-39) - 3906740593\,a(n-40) - 357055738\,a(n-41) - 455410940\,a(n-42) + 517200448\,a(n-43) + 32835072\,a(n-44) + 37028096\,a(n-45) - 36292608\,a(n-46) - 1146880\,a(n-47) - 917504\,a(n-48) + 1048576\,a(n-49)
\]
for every $n>49$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250568.
