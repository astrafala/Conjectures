...
\title{The empirical recurrence for OEIS A252400, proved by transfer matrix}
...
\begin{abstract}
OEIS A252400 counts $(n+2)\times3$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252400 is ``Number of (n+2)X(1+2) 0..3 arrays with every 3X3 subblock row and diagonal sum equal to 2 3 4 6 or 7 and every 3X3 column and antidiagonal sum not equal to 2 3 4 6 or 7.''. It has offset $1$ and begins
\[
458, 293, 319, 426, 631, 964, 1529, 2517,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 11*a(n-3) -39*a(n-6) +55*a(n-9) -59*a(n-12) +40*a(n-15) -10*a(n-18) +2*a(n-21) +a(n-24) for n>28
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:10:40, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;11\,a(n-3) - 39\,a(n-6) + 55\,a(n-9) - 59\,a(n-12) + 40\,a(n-15) - 10\,a(n-18) + 2\,a(n-21) + a(n-24)
\]
for every $n>28$.
\end{theorem}
...
at once. By Lemma~\ref{lem:crit} the recurrence holds for every $n>28$. The bound is exact: at $n=28$ the recurrence fails on the entry's own published terms, so no larger range holds.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252400.
