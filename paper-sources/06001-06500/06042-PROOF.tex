...
\title{The empirical recurrence for OEIS A207468, proved by transfer matrix}
...
\begin{abstract}
OEIS A207468 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
...
OEIS A207468 is ``Number of 4Xn 0..1 arrays avoiding 0 0 0 and 0 1 1 horizontally and 0 1 0 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
10, 100, 358, 1307, 4219, 11760, 33393,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 13:56:36, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 6\,a(n-2) - 2\,a(n-3) - 34\,a(n-4) - 4\,a(n-5) + 52\,a(n-6) + 62\,a(n-7) - 38\,a(n-8) - 7\,a(n-9) - 98\,a(n-10) - 124\,a(n-11) - 15\,a(n-12) + 265\,a(n-13) + 141\,a(n-14) + 30\,a(n-15) - 51\,a(n-16) - 198\,a(n-17) - 224\,a(n-18) - 27\,a(n-19) + 173\,a(n-20) + 99\,a(n-21) + 110\,a(n-22) - a(n-23) - 38\,a(n-24) - 84\,a(n-25) - 9\,a(n-26) - 17\,a(n-27) + 12\,a(n-28) + 8\,a(n-29) + 13\,a(n-30) + 2\,a(n-32) - a(n-33) - a(n-34) - a(n-35)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207468.
