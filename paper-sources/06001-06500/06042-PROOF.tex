...
\title{The empirical recurrence for OEIS A253795, proved by transfer matrix}
...
\begin{abstract}
OEIS A253795 counts the arrays over $\{0,\dots,1\}$ whose $3\times3$ subblocks carry a
...
OEIS A253795 is ``Number of (n+2)X(2+2) 0..1 arrays with every 3X3 subblock diagonal maximum plus antidiagonal median nondecreasing horizontally and vertically.''. It has offset $1$ and begins
\[
2908, 22284, 162604, 1143216, 7346584, 45394736, 275822532, 1652471284,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 14:14:43, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253795.
