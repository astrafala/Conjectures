...
\title{The empirical recurrence for OEIS A260979, proved by transfer matrix}
...
\begin{abstract}
OEIS A260979 counts $(n+2)\times9$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
every $3\times3$ subblock, and it carries an empirical recurrence of order $53$
...
OEIS A260979 is ``Number of (n+2)X(7+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000001 00001001 or 00100101.''. It has offset $1$ and begins
\[
6526, 3683, 4688, 9728, 14672, 30418, 45504, 95248,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 12:13:44, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;20\,a(n-4) + 4\,a(n-5) + 4\,a(n-7) - 147\,a(n-8) - 72\,a(n-9) - 3\,a(n-10) - 66\,a(n-11) + 690\,a(n-12) + 504\,a(n-13) + 48\,a(n-14) + 380\,a(n-15) - 2656\,a(n-16) - 2152\,a(n-17) - 312\,a(n-18) - 1496\,a(n-19) + 6833\,a(n-20) + 5472\,a(n-21) + 1244\,a(n-22) + 4112\,a(n-23) - 9128\,a(n-24) - 4128\,a(n-25) - 1536\,a(n-26) - 7184\,a(n-27) - 3428\,a(n-28) - 10480\,a(n-29) - 5280\,a(n-30) - 4552\,a(n-31) + 41776\,a(n-32) + 27808\,a(n-33) + 18384\,a(n-34) + 26272\,a(n-35) - 37136\,a(n-36) - 33600\,a(n-37) - 9680\,a(n-38) - 16160\,a(n-39) - 42752\,a(n-40) + 22144\,a(n-41) - 25792\,a(n-42) - 3264\,a(n-43) + 71360\,a(n-44) + 55936\,a(n-45) + 18432\,a(n-46) + 13312\,a(n-47) + 36544\,a(n-48) - 86272\,a(n-49) + 16384\,a(n-50) - 13312\,a(n-52) - 53248\,a(n-53)
\]
for every $n>63$.
\end{theorem}

\begin{proof}
The vector $w=q(M)\mathbf{1}$ was formed by $53$ matrix--vector products in exact
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A260979.
