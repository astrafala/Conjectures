...
\title{The empirical recurrence for OEIS A189192, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A189192 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A189192 is ``Number of nX5 binary arrays without the pattern 0 0 1 vertically or antidiagonally.''. It has offset $1$ and begins
\[
32, 1024, 13045, 156564, 1579664, 15564047, 146936454, 1372985912,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 05:05:10, revision 9) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A189192.
