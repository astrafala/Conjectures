...
\title{The empirical recurrence for OEIS A237143, proved by transfer matrix}
...
\begin{abstract}
OEIS A237143 counts arrays over $\{0,\dots,3\}$ subject to a condition on the order
...
The condition is local to two consecutive rows, so the count is a walk count on $S=64$
...
OEIS A237143 is ``Number of (n+1)X(1+1) 0..3 arrays with the maximum plus the lower median of every 2X2 subblock equal.''. It has offset $1$ and begins
\[
256, 1472, 8128, 48672, 289648, 1763648, 10742400, 65979616,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 09:53:06, revision 7) this is still
...
array, which is not among the objects counted. There are $S=64$ states left.
...
\begin{theorem}
\[
a(n)\;=\;15\,a(n-1) + 15\,a(n-2) - 1145\,a(n-3) + 2387\,a(n-4) + 37971\,a(n-5) - 125157\,a(n-6) - 717925\,a(n-7) + 2961789\,a(n-8) + 8497725\,a(n-9) - 42143099\,a(n-10) - 64302155\,a(n-11) + 395479985\,a(n-12) + 292816593\,a(n-13) - 2542859159\,a(n-14) - 536734167\,a(n-15) + 11318363232\,a(n-16) - 2143673968\,a(n-17) - 34416928152\,a(n-18) + 18241618944\,a(n-19) + 68291364640\,a(n-20) - 59473522432\,a(n-21) - 78323431552\,a(n-22) + 105248727808\,a(n-23) + 31220975104\,a(n-24) - 96325931008\,a(n-25) + 27167551488\,a(n-26) + 30305468416\,a(n-27) - 24934612992\,a(n-28) + 7018905600\,a(n-29) - 707788800\,a(n-30)
\]
for every $n>29$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237143.
