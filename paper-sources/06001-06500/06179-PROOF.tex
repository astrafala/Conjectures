...
\title{The empirical recurrence for OEIS A260012, proved by transfer matrix}
...
\begin{abstract}
OEIS A260012 counts $(n+2)\times7$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A260012 is ``Number of (n+2)X(5+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000101 00010101 or 01010101.''. It has offset $1$ and begins
\[
436, 1232, 6944, 25600, 87024, 294336, 1231648, 4380288,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:58:54, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-2) + 108\,a(n-4) - 288\,a(n-6) - 1828\,a(n-8) + 4768\,a(n-10) + 4128\,a(n-12) - 11008\,a(n-14) - 4608\,a(n-16) + 4096\,a(n-18)
\]
for every $n>21$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A260012.
