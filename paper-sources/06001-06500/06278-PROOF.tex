...
\title{The empirical recurrence for OEIS A304151, proved by transfer matrix}
...
\begin{abstract}
OEIS A304151 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A304151 is ``Number of nX3 0..1 arrays with every element unequal to 2, 3, 4 or 6 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
0, 5, 4, 42, 130, 464, 1722, 6378,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 07 2018 09:01:10, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 4\,a(n-2) - 14\,a(n-4) - 35\,a(n-5) + 11\,a(n-6) + 41\,a(n-7) + 53\,a(n-8) + 3\,a(n-9) - 116\,a(n-10) - 148\,a(n-11) + 62\,a(n-12) + 213\,a(n-13) + 137\,a(n-14) + 57\,a(n-15) + 18\,a(n-16) + 6\,a(n-17) + 2\,a(n-18)
\end{equation}
for all $n>19$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A304151.
