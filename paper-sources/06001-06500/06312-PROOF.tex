...
\title{The empirical recurrence for OEIS A207427, proved by transfer matrix}
...
\begin{abstract}
OEIS A207427 counts arrays over $\{0,\dots,1\}$ of width $3$ that avoid the patterns
$(0,0,1), (0,1,0)$ along one axis and $(0,0,0), (0,1,0)$ along the other, and carries an empirical recurrence of
order $24$ contributed by R.~H.~Hardin. It is true. The patterns have length $3$, so
...
on $S=36$ vertices, and $a(n)=\mathbf{1}^{\!\top}P^{\,n-2}\mathbf{1}$. Writing $q$
for the characteristic polynomial of the conjectured recurrence, the residual is
$\mathbf{1}^{\!\top}P^{\,n-2-24}q(P)\mathbf{1}$, which vanishes identically
...
OEIS A207427 is ``Number of 3Xn 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 0 1 and 0 1 0 vertically.''. It has offset
$1$ and begins
\[
6, 36, 114, 361, 1425, 5625, 20550,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 13:53:43, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) - 3\,a(n-2) + 16\,a(n-3) + 35\,a(n-4) - 53\,a(n-5) + 54\,a(n-6) - 183\,a(n-7) - 315\,a(n-8) + 430\,a(n-9) - 115\,a(n-10) + 307\,a(n-11) + 592\,a(n-12) - 693\,a(n-13) + 261\,a(n-14) - 288\,a(n-15) - 285\,a(n-16) + 315\,a(n-17) - 202\,a(n-18) + 153\,a(n-19) - 27\,a(n-20) - 2\,a(n-21) + 5\,a(n-22) - 5\,a(n-23) + a(n-24)
\end{equation}
for all $n>24$. The entry's array has a fixed number of rows and a growing number of
...
$(0,0,1), (0,1,0)$ as $3$ consecutive entries. There are $6$ admissible columns; that condition
...
columns, so $S=36$, and declare $w\to w'$ an edge when $w'$ is $w$ with its first entry
...
$a(n)-\sum_i c_i a(n-i)=u_{\,n-2-24}$ whenever $n-24\ge2$. Hence
\eqref{eq:conj} holds for every $n>t$ exactly when $u_j=0$ for every
$j>t-2-24$. Moreover $(u_j)$ satisfies the monic linear recurrence whose
...
$P^{\,n-2-24}$ gives the identity. The equivalence follows by letting the exponent
...
\begin{proof}
The vector $q(P)\mathbf{1}\in\mathbb{Z}^{S}$ was formed by $24$ matrix--vector
products in exact integer arithmetic and the $u_j$ evaluated in turn. They vanish from the
index corresponding to $n=24+1$ onwards, and the run was continued past $S$ consecutive
...
values agree exactly, including the initial count of $6$ admissible columns. That is
...
Third, the vanishing test of Lemma~\ref{lem:crit} was carried past $S=36$ consecutive
zeros rather than to a sampled prefix.

\begin{thebibliography}{9}
\bibitem{oeis} The OEIS Foundation, \emph{The On-Line Encyclopedia of Integer
Sequences}, \url{https://oeis.org}, 2026. Sequence A207427.
