...
\title{The empirical recurrence for OEIS A317898, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A317898 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A317898 is ``Number of nX4 0..1 arrays with every element unequal to 2, 3 or 6 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
0, 2, 3, 13, 31, 54, 116, 342,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2018 10:38:06, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 2\,a(n-2) + 3\,a(n-3) + 4\,a(n-4) + 12\,a(n-5) + 3\,a(n-6) - 3\,a(n-7) - 39\,a(n-8) - 52\,a(n-9) - 83\,a(n-10) - 74\,a(n-11) - 30\,a(n-12) + 123\,a(n-13) + 206\,a(n-14) + 254\,a(n-15) + 83\,a(n-16) + 26\,a(n-17) - 41\,a(n-18) - 47\,a(n-19) - 79\,a(n-20) - 34\,a(n-21) - 41\,a(n-22) + 11\,a(n-23) - 18\,a(n-24) - 3\,a(n-25) + 7\,a(n-26) + 5\,a(n-27) - 6\,a(n-28) + 4\,a(n-29) - a(n-30)
\end{equation}
for all $n>34$.
...
\#\{\text{neighbours with a value }different from\ x_{t,u}\}\in\{2,3,6\}
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A317898.
