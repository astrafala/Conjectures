...
\title{The empirical recurrence for OEIS A202776, proved by transfer matrix}
...
\begin{abstract}
OEIS A202776 counts arrays of width $9$ over $\{0,1\}$ containing no occurrence of certain short
...
count is a walk count on $S=2163$ states.
\end{abstract}
...
OEIS A202776 is ``Number of (n+2)X9 binary arrays avoiding patterns 000 and 011 in rows, columns and nw-to-se diagonals.''. It has offset $1$ and begins
\[
5467, 19712, 48953, 119735, 269300, 578203, 1195615, 2408130,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 09:54:46, revision 9) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=2163.
\]
...
\begin{theorem}
\[
a(n)\;=\;10\,a(n-2) + 11\,a(n-3) - 44\,a(n-4) - 104\,a(n-5) + 60\,a(n-6) + 433\,a(n-7) + 286\,a(n-8) - 908\,a(n-9) - 1658\,a(n-10) + 432\,a(n-11) + 3907\,a(n-12) + 2831\,a(n-13) - 4421\,a(n-14) - 8575\,a(n-15) - 474\,a(n-16) + 11940\,a(n-17) + 10119\,a(n-18) - 7259\,a(n-19) - 17347\,a(n-20) - 4404\,a(n-21) + 15100\,a(n-22) + 14554\,a(n-23) - 4513\,a(n-24) - 15736\,a(n-25) - 6116\,a(n-26) + 8630\,a(n-27) + 9820\,a(n-28) - 133\,a(n-29) - 6617\,a(n-30) - 3949\,a(n-31) + 1507\,a(n-32) + 3233\,a(n-33) + 1306\,a(n-34) - 885\,a(n-35) - 1386\,a(n-36) - 513\,a(n-37) + 450\,a(n-38) + 626\,a(n-39) + 154\,a(n-40) - 251\,a(n-41) - 222\,a(n-42) - a(n-43) + 94\,a(n-44) + 43\,a(n-45) - 12\,a(n-46) - 17\,a(n-47) - 3\,a(n-48) + 2\,a(n-49) + a(n-50)
\]
for every $n>51$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A202776.
