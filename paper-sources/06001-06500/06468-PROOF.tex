...
\title{The empirical recurrence for OEIS A252617, proved by transfer matrix}
...
\begin{abstract}
OEIS A252617 counts $4\times(n+2)$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252617 is ``Number of (2+2) X (n+2) 0..3 arrays with every 3 X 3 subblock row and diagonal sum equal to 0 3 5 6 or 8 and every 3 X 3 column and antidiagonal sum not equal to 0 3 5 6 or 8.''. It has offset $1$ and begins
\[
725, 1379, 2815, 6019, 13879, 31514, 71856, 170404,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 27 2021 15:02:06, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 48\,a(n-3) - 48\,a(n-4) - 939\,a(n-6) + 939\,a(n-7) + 9891\,a(n-9) - 9891\,a(n-10) - 63231\,a(n-12) + 63231\,a(n-13) + 263827\,a(n-15) - 263827\,a(n-16) - 759379\,a(n-18) + 759379\,a(n-19) + 1583561\,a(n-21) - 1583561\,a(n-22) - 2493304\,a(n-24) + 2493304\,a(n-25) + 3037897\,a(n-27) - 3037897\,a(n-28) - 2885834\,a(n-30) + 2885834\,a(n-31) + 2133236\,a(n-33) - 2133236\,a(n-34) - 1202312\,a(n-36) + 1202312\,a(n-37) + 495108\,a(n-39) - 495108\,a(n-40) - 137768\,a(n-42) + 137768\,a(n-43) + 20352\,a(n-45) - 20352\,a(n-46) - 1152\,a(n-48) + 1152\,a(n-49)
\]
for every $n>52$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252617.
