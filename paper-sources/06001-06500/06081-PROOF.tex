...
\title{The empirical recurrence for OEIS A254492, proved by transfer matrix}
...
\begin{abstract}
OEIS A254492 counts the arrays over $\{0,\dots,1\}$ whose $3\times3$ subblocks carry a
...
so the count is a walk count on $S=432$ states --- the last two array rows together with the
...
OEIS A254492 is ``Number of (2+2)X(n+2) 0..1 arrays with every 3X3 subblock diagonal maximum plus antidiagonal minimum nondecreasing horizontally, vertically and ne-to-sw antidiagonally.''. It has offset $1$ and begins
\[
3264, 29952, 278848, 2523008, 21822912, 186999040, 1608739904, 13816488064,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 14:43:49, revision 6) this is still
...
\]
on the $S=432$ reachable states. In particular $a$ is $C$-finite. The alignment of the walk
...
\begin{theorem}
\[
a(n)\;=\;14\,a(n-1) - 46\,a(n-2) - 42\,a(n-3) + 624\,a(n-4) - 4070\,a(n-5) + 23726\,a(n-6) - 143310\,a(n-7) + 364913\,a(n-8) + 1129936\,a(n-9) - 6925152\,a(n-10) + 15765760\,a(n-11) - 48494080\,a(n-12) + 157092864\,a(n-13) - 333556224\,a(n-14) + 23502848\,a(n-15) + 1872896000\,a(n-16) - 4361814016\,a(n-17) + 12360941568\,a(n-18) - 45439909888\,a(n-19) + 98790080512\,a(n-20) - 104990769152\,a(n-21) - 49694113792\,a(n-22) + 350694146048\,a(n-23) - 1042871746560\,a(n-24) + 3605625044992\,a(n-25) - 7769595838464\,a(n-26) + 8796093022208\,a(n-27) - 4947802324992\,a(n-28) + 1099511627776\,a(n-29)
\]
for every $n>29$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A254492.
