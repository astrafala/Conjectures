...
\title{The empirical recurrence for OEIS A264061, proved by transfer matrix}
...
\begin{abstract}
OEIS A264061 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=5$ columns in which
...
OEIS A264061 is ``Number of (4+1)X(n+1) arrays of permutations of 0..n*5+4 with each element having index change +-(.,.) 0,0 1,2 or 2,-2.''. It has offset $1$ and begins
\[
1, 45, 2025, 32400, 518400, 11151360, 239878144, 4614184960,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 10 2015 10:58:38, revision 6) this is still
...
\[
(i-h_i,\,j-h_j)\;\in\;\{(-2,-1),\ (-2,2),\ (0,0),\ (2,-2),\ (2,1)\},
\]
...
\begin{theorem}
\[
a(n)\;=\;19\,a(n-1) + 16\,a(n-2) - 2366480\,a(n-6) + 44963120\,a(n-7) + 37863680\,a(n-8) + 238086819840\,a(n-12) - 4523649576960\,a(n-13) - 3809389117440\,a(n-14) + 975203614064640\,a(n-18) - 18528868667228160\,a(n-19) - 15603257825034240\,a(n-20) - 162623267306209280\,a(n-24) + 3089842078817976320\,a(n-25) + 2601972276899348480\,a(n-26) - 1152921504606846976\,a(n-30) + 21905508587530092544\,a(n-31) + 18446744073709551616\,a(n-32)
\]
for every $n>32$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264061.
