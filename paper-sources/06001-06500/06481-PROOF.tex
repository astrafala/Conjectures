...
\title{The empirical recurrence for OEIS A196310, proved by transfer matrix}
...
\begin{abstract}
OEIS A196310 counts $n\times4$ arrays over $\{0,\dots,4\}$ subject to a condition imposed on
every CELL over a neighbour set the entry names, and it carries an empirical recurrence of
order $39$ contributed by R.~H.~Hardin. It is true, and it is decidable rather than
...
walk, and $a(n)$ is a walk count on $S=1636$ vertices, which is $C$-finite. Whether the
...
OEIS A196310 is ``Number of nX4 0..4 arrays with each element x equal to the number its horizontal and vertical neighbors equal to 2,0,4,1,3 for x=0,1,2,3,4.''. It has offset $1$ and begins
\[
5, 17, 50, 335, 866, 2942, 13277, 56237,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 06:28:14, revision 9) this is still
...
settled by the terminal weight, which evaluates it with $\varnothing$ below. Most of those pairs are indistinguishable, and exactly so. Every offset named above has $|dj|\le 1$, so whether the cell at column $j$ of the middle row is satisfied depends on the three rows only through their windows at $j-1,j,j+1$. Collect for each $j$ the indicator over the window of the row below, and call that tuple $P(r,s)$: the number of cells any $t$ violates is read off $P$, so is the number violated at the bottom edge, and the successor $(s,t)$ carries $P(s,t)$, which does not mention $r$. Hence two pairs $(r,s)$ and $(r',s)$ with the same $P$ have the same outgoing rows and the same successors, and the vertex is $(s,P)$. That leaves $S=1636$ vertices in place of $390625$. Hence,
with $M$ the adjacency matrix on $S=1636$ vertices, $\iota$ the starting vector and $\tau$ the
terminal weight,
\[
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) - 4\,a(n-2) - 2\,a(n-3) + 29\,a(n-4) + 44\,a(n-5) - 365\,a(n-6) - 563\,a(n-7) - 486\,a(n-8) + 18\,a(n-9) + 424\,a(n-10) - 8576\,a(n-11) + 29598\,a(n-12) + 95820\,a(n-13) + 200698\,a(n-14) + 364105\,a(n-15) + 598354\,a(n-16) - 292736\,a(n-17) - 2334999\,a(n-18) - 6081591\,a(n-19) - 14964178\,a(n-20) - 11648855\,a(n-21) - 17466704\,a(n-22) - 25028551\,a(n-23) + 14094341\,a(n-24) + 14352761\,a(n-25) + 579801\,a(n-26) - 1186235\,a(n-27) - 1593062\,a(n-28) - 225384\,a(n-29) + 3130755\,a(n-30) + 1386124\,a(n-31) - 405424\,a(n-32) - 609745\,a(n-33) - 394802\,a(n-34) + 8031\,a(n-35) + 36199\,a(n-36) + 2246\,a(n-37) + 2252\,a(n-38) + 720\,a(n-39)
\]
for every $n>39$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A196310.
