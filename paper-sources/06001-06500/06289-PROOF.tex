...
\title{The empirical recurrence for OEIS A207859, proved by transfer matrix}
...
\begin{abstract}
OEIS A207859 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
$(0,1,0), (1,0,1)$ along one axis and $(0,0,0), (0,1,0)$ along the other, and carries an empirical recurrence of
...
OEIS A207859 is ``Number of 4Xn 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 1 0 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
10, 100, 370, 1369, 7289, 38809, 178088,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:22:18, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 30\,a(n-3) + 161\,a(n-4) + 45\,a(n-5) + 166\,a(n-6) - 749\,a(n-7) - 4860\,a(n-8) - 1352\,a(n-9) + 3048\,a(n-10) + 4635\,a(n-11) + 28540\,a(n-12) + 11318\,a(n-13) - 11422\,a(n-14) - 4202\,a(n-15) - 69991\,a(n-16) - 28677\,a(n-17) + 609\,a(n-18) - 20891\,a(n-19) + 65400\,a(n-20) + 5094\,a(n-21) + 7969\,a(n-22) + 10090\,a(n-23) - 24802\,a(n-24) + 1479\,a(n-25) - 2070\,a(n-26) - 1380\,a(n-27) + 3917\,a(n-28) - 350\,a(n-29) - 75\,a(n-30) + 41\,a(n-31) - 140\,a(n-32) + 16\,a(n-33) + a(n-35) + a(n-36)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207859.
