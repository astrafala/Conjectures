...
\title{The empirical recurrence for OEIS A298891, proved by transfer matrix}
...
\begin{abstract}
OEIS A298891 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $equal to$ itself lying in $\{2,3,5,6,8\}$, and it carries an empirical
...
OEIS A298891 is ``Number of nX4 0..1 arrays with every element equal to 2, 3, 5, 6 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
0, 2, 4, 11, 31, 80, 229, 681,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 28 2018 09:04:46, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) - 9\,a(n-2) + 5\,a(n-3) - 32\,a(n-4) + 38\,a(n-5) + 25\,a(n-6) + 98\,a(n-7) - 119\,a(n-8) + 40\,a(n-9) - 550\,a(n-10) + 580\,a(n-11) - 916\,a(n-12) + 830\,a(n-13) + 263\,a(n-14) + 83\,a(n-15) + 2328\,a(n-16) - 229\,a(n-17) + 503\,a(n-18) - 4047\,a(n-19) - 417\,a(n-20) - 3044\,a(n-21) + 2435\,a(n-22) - 11065\,a(n-23) + 3356\,a(n-24) - 5303\,a(n-25) + 1559\,a(n-26) + 14545\,a(n-27) + 32995\,a(n-28) + 22512\,a(n-29) - 15204\,a(n-30) - 12820\,a(n-31) - 31577\,a(n-32) - 21644\,a(n-33) + 3315\,a(n-34) + 18307\,a(n-35) - 24537\,a(n-36) - 14373\,a(n-37) + 11731\,a(n-38) + 26599\,a(n-39) + 15792\,a(n-40) - 11544\,a(n-41) - 3386\,a(n-42) - 4977\,a(n-43) + 5179\,a(n-44) - 2851\,a(n-45) + 4056\,a(n-46) - 977\,a(n-47) + 3855\,a(n-48) - 121\,a(n-49) + 305\,a(n-50) - 1567\,a(n-51) - 458\,a(n-52) - 273\,a(n-53) + 321\,a(n-54) - 8\,a(n-55) + 78\,a(n-56) - 20\,a(n-57) - 6\,a(n-58)
\end{equation}
for all $n>59$.
...
has score in $\{2,3,5,6,8\}$. The entry also fixes the top-left entry to be $0$; that is a condition on the first row alone, so it restricts the start vector and nothing else.
...
\begin{itemize}
\item $\mathbf{s}(r,s)=1$ when every cell of $r$ has score in $\{2,3,5,6,8\}$ \emph{with no row
above $r$} and $r_1=0$, and $0$ otherwise;
\item an edge $(r,s)\to(s,t)$ when every cell of $s$ has score in $\{2,3,5,6,8\}$ computed from
$r$, $s$ and $t$;
\item $\mathbf{e}(r,s)=1$ when every cell of $s$ has score in $\{2,3,5,6,8\}$ \emph{with no row
...
exactly when every one of its $n$ rows has all scores in $\{2,3,5,6,8\}$. Read the sequence as the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A298891.
