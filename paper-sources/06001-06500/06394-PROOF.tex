...
\title{The empirical recurrence for OEIS A305179, proved by transfer matrix}
...
\begin{abstract}
OEIS A305179 counts $5$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $different from$ itself lying in $\{1,2,5,6,7\}$, and it carries an empirical
...
OEIS A305179 is ``Number of nX5 0..1 arrays with every element unequal to 1, 2, 5, 6 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
3, 8, 14, 13, 64, 137, 140, 668,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 26 2018 18:37:20, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-2) + 17\,a(n-3) + 9\,a(n-4) - 31\,a(n-5) - 131\,a(n-6) - 91\,a(n-7) + 206\,a(n-8) + 575\,a(n-9) + 361\,a(n-10) - 762\,a(n-11) - 1527\,a(n-12) - 664\,a(n-13) + 1679\,a(n-14) + 2438\,a(n-15) + 360\,a(n-16) - 2241\,a(n-17) - 1976\,a(n-18) + 713\,a(n-19) + 1609\,a(n-20) - 67\,a(n-21) - 1372\,a(n-22) - 101\,a(n-23) + 1502\,a(n-24) + 741\,a(n-25) - 640\,a(n-26) - 994\,a(n-27) + 152\,a(n-28) + 351\,a(n-29) + 44\,a(n-30) - 386\,a(n-31) - 78\,a(n-32) + 338\,a(n-33) + 196\,a(n-34) - 6\,a(n-35) - 204\,a(n-36) - 74\,a(n-37) + 20\,a(n-38) + 52\,a(n-39) + 18\,a(n-40) - 4\,a(n-41) - 16\,a(n-42) + 4\,a(n-43)
\end{equation}
for all $n>50$.
...
has score in $\{1,2,5,6,7\}$. The entry also fixes the top-left entry to be $0$; that is a condition on the first row alone, so it restricts the start vector and nothing else.
...
\begin{itemize}
\item $\mathbf{s}(r,s)=1$ when every cell of $r$ has score in $\{1,2,5,6,7\}$ \emph{with no row
above $r$} and $r_1=0$, and $0$ otherwise;
\item an edge $(r,s)\to(s,t)$ when every cell of $s$ has score in $\{1,2,5,6,7\}$ computed from
$r$, $s$ and $t$;
\item $\mathbf{e}(r,s)=1$ when every cell of $s$ has score in $\{1,2,5,6,7\}$ \emph{with no row
...
exactly when every one of its $n$ rows has all scores in $\{1,2,5,6,7\}$. Read the sequence as the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A305179.
