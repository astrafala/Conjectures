...
\title{The empirical recurrence for OEIS A280370, proved from an exact model}
...
\begin{abstract}
OEIS A280370 carries an empirical recurrence of order $4$ contributed by Colin Barker. It is true, and it is
...
OEIS A280370 is ``Decimal representation of the x-axis, from the origin to the right edge, of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 259", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 2, 6, 1, 24, 7, 96, 31,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Jan 01 2017: (Start) a(n) = 5*a(n-2) - 4*a(n-4) for n>5.
\end{quote}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A280370.
