...
\title{The empirical recurrence for OEIS A256950, proved by transfer matrix}
...
\begin{abstract}
OEIS A256950 counts the arrays over $\{0,\dots,1\}$ whose $3\times3$ subblocks carry a
...
OEIS A256950 is ``Number of (n+2) X (4+2) 0..1 arrays with every 3 X 3 subblock sum of the two sums of the central row and central column minus the two minimums of the diagonal and antidiagonal nondecreasing horizontally and vertically.''. It has offset $1$ and begins
\[
42890, 262251, 1015815, 2782301, 6304044, 11484877, 18040804, 26715881,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 15 2023 18:45:37, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A256950.
