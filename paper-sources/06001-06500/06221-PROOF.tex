...
\title{The empirical recurrence for OEIS A223427, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A223427 counts arrays over $\{0,\dots,14\}$ in which every cell is constrained by the
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 21:39:55, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;466\,a(n-2) - 69185\,a(n-4) + 4382193\,a(n-6) - 130562793\,a(n-8) + 2110263466\,a(n-10) - 20078358067\,a(n-12) + 116999028688\,a(n-14) - 423034699529\,a(n-16) + 947474341907\,a(n-18) - 1308325237689\,a(n-20) + 1105531342712\,a(n-22) - 563527872936\,a(n-24) + 167881696044\,a(n-26) - 27388441192\,a(n-28) + 2145049440\,a(n-30) - 57784320\,a(n-32)
\end{equation}
for all $n>33$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223427.
