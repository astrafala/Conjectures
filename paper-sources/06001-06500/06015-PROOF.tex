...
\title{The empirical recurrence for OEIS A282005, proved from an exact model}
...
\begin{abstract}
OEIS A282005 carries an empirical recurrence of order $4$ contributed by Colin Barker. It is true, and it is
...
OEIS A282005 is ``Decimal representation of the x-axis, from the origin to the right edge, of the n-th stage of growth of the two-dimensional cellular automaton defined by "Rule 413", based on the 5-celled von Neumann neighborhood.''. It has offset $0$ and begins
\[
1, 1, 6, 7, 24, 31, 96, 127,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Conjectures from \_Colin Barker\_, Feb 05 2017: (Start) a(n) = 5*a(n-2) - 4*a(n-4) for n>4.
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 05 2025 15:22:36, revision 12)
...
neighbourhood to a live cell flips the ENTIRE plane, and rule 413 is read
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A282005.
