...
\title{The empirical recurrence for OEIS A189697, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A189697 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A189697 is ``Number of 4Xn binary arrays without the pattern 0 0 1 diagonally, vertically or antidiagonally.''. It has offset $1$ and begins
\[
12, 144, 1298, 11637, 107720, 997264, 9205575, 84987637,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 05:24:29, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;12\,a(n-1) - 14\,a(n-2) - 138\,a(n-3) + 487\,a(n-4) - 2320\,a(n-5) + 3108\,a(n-6) + 19078\,a(n-7) - 43985\,a(n-8) + 63715\,a(n-9) - 58934\,a(n-10) - 538144\,a(n-11) + 884140\,a(n-12) + 235100\,a(n-13) - 383512\,a(n-14) + 2515360\,a(n-15) - 4168592\,a(n-16) - 2271152\,a(n-17) + 2599872\,a(n-18) - 3563680\,a(n-19) + 6711296\,a(n-20) + 3621888\,a(n-21) - 3288064\,a(n-22) + 1212416\,a(n-23) - 3323392\,a(n-24) - 1750016\,a(n-25) + 1122304\,a(n-26) + 45056\,a(n-27) + 393216\,a(n-28) + 196608\,a(n-29)
\end{equation}
for all $n>30$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A189697.
