...
\title{The empirical recurrence for OEIS A255796, proved by transfer matrix}
...
\begin{abstract}
OEIS A255796 counts $(n+2)\times5$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A255796 is ``Number of (n+2) X (3+2) 0..1 arrays with no 3 x 3 subblock diagonal sum 1 and no antidiagonal sum 2 and no row sum 0 and no column sum 3.''. It has offset $1$ and begins
\[
210, 178, 158, 198, 256, 258, 329, 344,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 5*a(n-6) - 8*a(n-12) + 4*a(n-18) for n>20.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 19 2018 09:04:23, revision 7) this is still
...
First, the transfer model reproduces all $43$ terms the entry publishes, exactly, in
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A255796.
