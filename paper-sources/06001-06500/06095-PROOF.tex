...
\title{The empirical recurrence for OEIS A298440, proved by transfer matrix}
...
\begin{abstract}
OEIS A298440 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A298440 is ``Number of nX4 0..1 arrays with every element equal to 0, 3, 4, 5 or 6 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 2, 2, 7, 34, 105, 406, 1504,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 19 2018 08:01:27, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A298440.
