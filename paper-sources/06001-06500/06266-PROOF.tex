...
\title{The empirical recurrence for OEIS A252345, proved by transfer matrix}
...
\begin{abstract}
OEIS A252345 counts $(n+2)\times3$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
every $3\times3$ subblock, and it carries an empirical recurrence of order $33$
...
OEIS A252345 is ``Number of (n+2)X(1+2) 0..3 arrays with every 3X3 subblock row and column sum not equal to 0 3 5 6 or 8 and every 3X3 diagonal and antidiagonal sum equal to 0 3 5 6 or 8.''. It has offset $1$ and begins
\[
562, 798, 1331, 2176, 4013, 7109, 12670, 23051,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:07:31, revision 6) this is still
...
\[
\text{every row, column sum} \notin \{0,3,5,6,8\}\ \text{ and }\ \text{every diagonal, antidiagonal sum} \in \{0,3,5,6,8\}
\]
...
\begin{theorem}
\[
a(n)\;=\;-a(n-1) + 3\,a(n-2) + 24\,a(n-3) + 20\,a(n-4) - 59\,a(n-5) - 225\,a(n-6) - 152\,a(n-7) + 423\,a(n-8) + 1045\,a(n-9) + 574\,a(n-10) - 1357\,a(n-11) - 2485\,a(n-12) - 1178\,a(n-13) + 1910\,a(n-14) + 2505\,a(n-15) + 911\,a(n-16) - 567\,a(n-17) + 830\,a(n-18) + 1299\,a(n-19) - 1040\,a(n-20) - 4171\,a(n-21) - 3547\,a(n-22) + 415\,a(n-23) + 3286\,a(n-24) + 2940\,a(n-25) + 642\,a(n-26) - 731\,a(n-27) - 919\,a(n-28) - 403\,a(n-29) - 91\,a(n-30) + 53\,a(n-31) + 33\,a(n-32) + 14\,a(n-33)
\]
for every $n>39$.
\end{theorem}

\begin{proof}
The vector $w=q(M)\mathbf{1}$ was formed by $33$ matrix--vector products in exact
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252345.
