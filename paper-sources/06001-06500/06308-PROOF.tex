...
\title{The empirical recurrence for OEIS A318086, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A318086 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A318086 is ``Number of nX3 0..1 arrays with every element unequal to 0, 2, 3 or 5 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
1, 2, 2, 7, 7, 11, 15, 62,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 16 2018 10:19:57, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) - a(n-2) + 2\,a(n-3) + 4\,a(n-4) - 12\,a(n-5) + 7\,a(n-6) - 12\,a(n-7) + 20\,a(n-8) - 6\,a(n-9) + 13\,a(n-10) + 10\,a(n-11) - 19\,a(n-12) - 2\,a(n-13) - 26\,a(n-14) + 26\,a(n-15) - 4\,a(n-16) + 10\,a(n-17) - 10\,a(n-18) - 2\,a(n-19) - a(n-20) + a(n-22) + a(n-24)
\end{equation}
for all $n>25$.
...
\#\{\text{neighbours with a value }different from\ x_{t,u}\}\in\{0,2,3,5\}
\end{equation}
...
publishes, $n=34$, the arrays have $3\cdot34$ cells over
...
the middle row. The vector $w$ was formed by $24$ applications of $G$ in exact integer
...
every one of the $34$ published indices, with no shift fitted: the number of rows is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A318086.
