...
\title{The empirical recurrence for OEIS A234191, proved by transfer matrix}
...
\begin{abstract}
OEIS A234191 counts arrays of width $3$ over $\{0,1,2,3\}$ containing no run of $3$ consecutive
...
OEIS A234191 is ``Number of (n+2) X (1+2) 0..3 arrays with no increasing sequence of length 3 horizontally, diagonally downwards or antidiagonally downwards.''. It has offset $1$ and begins
\[
193264, 10370036, 552870656, 29472668500, 1570546543232, 83690878669284, 4459602725105968, 237636889981332820,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 10 2022 20:45:06, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;56\,a(n-1) - 119\,a(n-2) - 1308\,a(n-3) + 23400\,a(n-4) - 1471264\,a(n-5) + 2773580\,a(n-6) + 41183056\,a(n-7) - 96018000\,a(n-8) + 164815744\,a(n-9) - 481311056\,a(n-10) - 1789740992\,a(n-11) + 2706969088\,a(n-12) - 1995040768\,a(n-13) + 114872384\,a(n-14) + 1679949056\,a(n-15) - 1477492736\,a(n-16) + 3012214784\,a(n-17) - 415727616\,a(n-18) + 599916544\,a(n-19) - 1973420032\,a(n-20) + 234881024\,a(n-21) - 167772160\,a(n-22) + 134217728\,a(n-23)
\]
for every $n>20$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234191.
