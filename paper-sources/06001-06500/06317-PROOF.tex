...
\title{The empirical recurrence for OEIS A251899, proved by transfer matrix}
...
\begin{abstract}
OEIS A251899 counts arrays of width $4$ over $\{0,1,2,3\}$ in which every $3\times3$ window has
...
OEIS A251899 is ``Number of (n+2)X(2+2) 0..3 arrays with every 3X3 subblock row and column sum unequal to 4 or 5 and every diagonal and antidiagonal sum equal to 4 or 5.''. It has offset $1$ and begins
\[
2596, 1548, 1586, 1962, 3910, 6744, 9830, 18590,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 10:36:13, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + a(n-2) + 4\,a(n-3) + 5\,a(n-4) - 14\,a(n-5) - 2\,a(n-6) - 44\,a(n-7) + 36\,a(n-8) + 5\,a(n-9) + 64\,a(n-10) + 17\,a(n-11) - 28\,a(n-12) - 22\,a(n-13) - 76\,a(n-14) + 8\,a(n-15) + 4\,a(n-16) + 14\,a(n-17) + 38\,a(n-18) + 6\,a(n-20) - 12\,a(n-21) - 8\,a(n-22) + 8\,a(n-23) - 12\,a(n-24) + 8\,a(n-26)
\]
for every $n>33$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251899.
