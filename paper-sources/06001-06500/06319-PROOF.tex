...
\title{The empirical recurrence for OEIS A209104, proved by transfer matrix}
...
\begin{abstract}
OEIS A209104 counts $5\times n$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A209104 is ``Number of 5Xn 0..2 arrays with new values 0..2 introduced in row major order and no element equal to more than one of its immediate leftward or upward or right-upward antidiagonal neighbors.''. It has offset $1$ and begins
\[
41, 4568, 407832, 34538488, 2896732704, 242632290432, 20321585350224, 1702054356798544,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 15:09:18, revision 9) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209104.
