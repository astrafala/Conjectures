...
\title{The empirical recurrence for OEIS A260496, proved by transfer matrix}
...
\begin{abstract}
OEIS A260496 counts $(n+2)\times5$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A260496 is ``Number of (n+2)X(3+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000001 00000011 or 00001011.''. It has offset $1$ and begins
\[
218, 347, 868, 1756, 2420, 5219, 11450, 17686,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 12:07:59, revision 6) this is still
...
\[
\text{the clockwise perimeter word of }g\text{ is a rotation of one of }\{00000001,\ 00000011,\ 00001011\}
\]
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-3) + 9\,a(n-4) - 19\,a(n-6) - 48\,a(n-7) - 33\,a(n-8) + 24\,a(n-9) + 72\,a(n-10) + 116\,a(n-11) + 46\,a(n-12) - 54\,a(n-13) - 93\,a(n-14) - 128\,a(n-15) - 58\,a(n-16) + 32\,a(n-17) + 29\,a(n-18) + 74\,a(n-19) + 66\,a(n-20) + 8\,a(n-21) + 12\,a(n-22) - 20\,a(n-23) - 38\,a(n-24) - 8\,a(n-25) - 4\,a(n-26) + 2\,a(n-27) + 8\,a(n-28) + 2\,a(n-29) + a(n-30)
\]
for every $n>33$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A260496.
