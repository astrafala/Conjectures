...
\title{The empirical recurrence for OEIS A202773, proved by transfer matrix}
...
\begin{abstract}
OEIS A202773 counts arrays of width $6$ over $\{0,1\}$ containing no occurrence of certain short
patterns, read along the rows, the columns or the diagonals. The entry carries an empirical
recurrence of order $33$ contributed by R.~H.~Hardin. It is true, and it is decidable
...
count is a walk count on $S=343$ states.
\end{abstract}
...
OEIS A202773 is ``Number of (n+2)X6 binary arrays avoiding patterns 000 and 011 in rows, columns and nw-to-se diagonals.''. It has offset $1$ and begins
\[
833, 2600, 6176, 13937, 29826, 60469, 119735, 230808,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 09:54:24, revision 9) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=343.
\]
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 5\,a(n-2) - 4\,a(n-3) - 24\,a(n-4) - 6\,a(n-5) + 60\,a(n-6) + 63\,a(n-7) - 69\,a(n-8) - 177\,a(n-9) - 17\,a(n-10) + 238\,a(n-11) + 206\,a(n-12) - 152\,a(n-13) - 314\,a(n-14) - 61\,a(n-15) + 248\,a(n-16) + 191\,a(n-17) - 70\,a(n-18) - 164\,a(n-19) - 53\,a(n-20) + 62\,a(n-21) + 59\,a(n-22) + 20\,a(n-23) - 21\,a(n-24) - 26\,a(n-25) - 17\,a(n-26) + 11\,a(n-27) + 14\,a(n-28) + 5\,a(n-29) - 6\,a(n-30) - 3\,a(n-31) + a(n-33)
\]
for every $n>30$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A202773.
