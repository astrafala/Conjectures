...
\title{The empirical recurrence for OEIS A261288, proved by transfer matrix}
...
\begin{abstract}
OEIS A261288 counts $(n+2)\times6$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A261288 is ``Number of (n+2)X(4+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000001 00010101 or 01010101.''. It has offset $1$ and begins
\[
166, 233, 504, 1147, 2586, 6034, 14106, 32496,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 14 2015 07:15:09, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) - 2\,a(n-2) + 6\,a(n-3) - a(n-4) + 4\,a(n-5) + a(n-6) - 2\,a(n-8) + 2\,a(n-9) - 2\,a(n-10) - 4\,a(n-11) - 9\,a(n-12) + 4\,a(n-13) - 6\,a(n-14) - 2\,a(n-16) - a(n-19) + 3\,a(n-20) - 3\,a(n-21) - a(n-24)
\]
for every $n>28$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A261288.
