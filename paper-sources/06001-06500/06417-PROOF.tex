...
\title{The empirical recurrence for OEIS A233922, proved by transfer matrix}
...
\begin{abstract}
OEIS A233922 counts $(n+1)\times3$ arrays over $\{0,\dots,4\}$ subject to a condition imposed on
...
OEIS A233922 is ``Number of (n+1)X(2+1) 0..4 arrays with every 2X2 subblock having the sum of the absolute values of the edge differences equal to 8 and no adjacent elements equal.''. It has offset $1$ and begins
\[
518, 4010, 32496, 273318, 2325194, 19931860, 171250610, 1473829746,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 08:15:49, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) + 90\,a(n-2) - 457\,a(n-3) - 2820\,a(n-4) + 12576\,a(n-5) + 44887\,a(n-6) - 174476\,a(n-7) - 413814\,a(n-8) + 1377015\,a(n-9) + 2340346\,a(n-10) - 6484142\,a(n-11) - 8332941\,a(n-12) + 18412719\,a(n-13) + 18808062\,a(n-14) - 31000755\,a(n-15) - 26671104\,a(n-16) + 29467485\,a(n-17) + 23060177\,a(n-18) - 14245792\,a(n-19) - 11289280\,a(n-20) + 2644752\,a(n-21) + 2672572\,a(n-22) + 58840\,a(n-23) - 200640\,a(n-24) - 28672\,a(n-25)
\end{equation}
for all $n>25$.
...
|\beta-\alpha|+|\delta-\beta|+|\gamma-\delta|+|\alpha-\gamma|=8,
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A233922.
