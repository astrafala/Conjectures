...
\title{The empirical recurrence for OEIS A264055, proved by transfer matrix}
...
\begin{abstract}
OEIS A264055 carries an empirical recurrence of order $17$ contributed by R.~H.~Hardin. It is
...
OEIS A264055 is ``Number of (n+1) X (3+1) arrays of permutations of 0..n*4+3 with each element having index change +-(.,.) 0,0 1,2 or 2,-2.''. It has offset $1$ and begins
\[
4, 64, 324, 2025, 15625, 102400, 692224, 4826809,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 01 2024 18:44:19, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-1) - a(n-2) + 55\,a(n-3) - 385\,a(n-4) + 55\,a(n-5) - 385\,a(n-6) + 2695\,a(n-7) - 385\,a(n-8) + 385\,a(n-9) - 2695\,a(n-10) + 385\,a(n-11) - 55\,a(n-12) + 385\,a(n-13) - 55\,a(n-14) + a(n-15) - 7\,a(n-16) + a(n-17)
\]
for every $n>15$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264055.
