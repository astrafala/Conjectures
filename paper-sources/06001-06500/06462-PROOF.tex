...
\title{The empirical recurrence for OEIS A236620, proved by transfer matrix}
...
\begin{abstract}
OEIS A236620 counts arrays over $\{0,\dots,3\}$ subject to a condition on the order
...
OEIS A236620 is ``Number of (n+1) X (1+1) 0..3 arrays colored with the maximum plus the lower median of every 2 X 2 subblock.''. It has offset $1$ and begins
\[
256, 2624, 26560, 272160, 2793840, 28623360, 293206144, 3004474720,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 14 2025 23:03:01, revision 7) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The $2\times2$ subblocks of an $(n+1)\times2$ array form an
$n\times1$ grid. Colour each of them by $\sigma=b+d$, where $a\le b\le c\le d$ are its four entries sorted --- its minimum, lower median, upper median and maximum. ``Coloured with'' is the entry's way of
...
\begin{theorem}
\[
a(n)\;=\;304\,a(n-3) + 4012\,a(n-4) + 21408\,a(n-5) + 131544\,a(n-6) + 480256\,a(n-7) + 1095762\,a(n-8) + 2382528\,a(n-9) - 7588872\,a(n-10) - 47015904\,a(n-11) - 158803396\,a(n-12) - 569595744\,a(n-13) - 679250552\,a(n-14) - 333197568\,a(n-15) + 2056975591\,a(n-16) + 18914327296\,a(n-17) + 34799954216\,a(n-18) + 64591344816\,a(n-19) + 115113338336\,a(n-20) - 23416566272\,a(n-21) - 143590120832\,a(n-22) - 350090976000\,a(n-23) - 1031067717376\,a(n-24) - 1144206867456\,a(n-25) - 1239076647936\,a(n-26) - 1669973962752\,a(n-27) - 1104748867584\,a(n-28) - 692833222656\,a(n-29) - 631651958784\,a(n-30) - 206009008128\,a(n-31)
\]
for every $n>31$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A236620.
