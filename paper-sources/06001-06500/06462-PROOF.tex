...
\title{The empirical recurrence for OEIS A197891, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A197891 counts arrays over $\{0,\dots,4\}$ in which every cell is constrained by the
...
OEIS A197891 is ``Number of nX3 0..4 arrays with each element x equal to the number its horizontal and vertical neighbors equal to 3,3,0,1,1 for x=0,1,2,3,4.''. It has offset $1$ and begins
\[
2, 12, 50, 180, 745, 3046, 12531, 52188,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 07:35:00, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 3\,a(n-2) + 23\,a(n-3) + 13\,a(n-4) + 2\,a(n-5) - 95\,a(n-6) - 60\,a(n-7) + 119\,a(n-8) + 308\,a(n-9) + 152\,a(n-10) - 582\,a(n-11) - 876\,a(n-12) - 339\,a(n-13) + 656\,a(n-14) + 1015\,a(n-15) + 636\,a(n-16) - 148\,a(n-17) - 439\,a(n-18) - 245\,a(n-19) + 16\,a(n-20) + 32\,a(n-21) - 2\,a(n-22)
\end{equation}
for all $n>23$.
...
\#\{\text{neighbours with value }f(x_{t,u})\}=x_{t,u},\quad f=(3,3,0,1,1)
\end{equation}
for every cell $(t,u)$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A197891.
