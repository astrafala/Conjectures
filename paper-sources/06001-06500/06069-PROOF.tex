...
\title{The empirical recurrence for OEIS A305448, proved by transfer matrix}
...
\begin{abstract}
OEIS A305448 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $different from$ itself lying in $\{1,2,4,5,8\}$, and it carries an empirical
...
OEIS A305448 is ``Number of nX4 0..1 arrays with every element unequal to 1, 2, 4, 5 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
2, 10, 20, 26, 169, 475, 1234, 5007,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 01 2018 11:02:07, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 5\,a(n-2) + 38\,a(n-3) - 148\,a(n-4) - 218\,a(n-5) - 519\,a(n-6) + 2884\,a(n-7) + 3905\,a(n-8) + 3339\,a(n-9) - 30562\,a(n-10) - 39086\,a(n-11) - 11324\,a(n-12) + 205212\,a(n-13) + 247611\,a(n-14) + 21938\,a(n-15) - 946170\,a(n-16) - 1056076\,a(n-17) - 58020\,a(n-18) + 3157175\,a(n-19) + 3127065\,a(n-20) + 410332\,a(n-21) - 7983337\,a(n-22) - 6503680\,a(n-23) - 2165557\,a(n-24) + 16028242\,a(n-25) + 9483450\,a(n-26) + 6988788\,a(n-27) - 26528034\,a(n-28) - 9599746\,a(n-29) - 14430143\,a(n-30) + 36550764\,a(n-31) + 6751097\,a(n-32) + 19453991\,a(n-33) - 41014953\,a(n-34) - 3830421\,a(n-35) - 16581030\,a(n-36) + 35888878\,a(n-37) + 3500239\,a(n-38) + 6795491\,a(n-39) - 22738990\,a(n-40) - 5319082\,a(n-41) + 2956273\,a(n-42) + 8693110\,a(n-43) + 6173762\,a(n-44) - 6526618\,a(n-45) - 492143\,a(n-46) - 4460003\,a(n-47) + 4375118\,a(n-48) - 1220728\,a(n-49) + 1893599\,a(n-50) - 1415837\,a(n-51) + 478409\,a(n-52) - 386792\,a(n-53) + 165762\,a(n-54) - 41280\,a(n-55) + 17066\,a(n-56) + 9967\,a(n-57) - 2758\,a(n-58) + 2235\,a(n-59) - 1720\,a(n-60) - 212\,a(n-61) - 32\,a(n-62) - 64\,a(n-63)
\end{equation}
for all $n>65$.
...
has score in $\{1,2,4,5,8\}$. The entry also fixes the top-left entry to be $0$; that is a condition on the first row alone, so it restricts the start vector and nothing else.
...
\begin{itemize}
\item $\mathbf{s}(r,s)=1$ when every cell of $r$ has score in $\{1,2,4,5,8\}$ \emph{with no row
above $r$} and $r_1=0$, and $0$ otherwise;
\item an edge $(r,s)\to(s,t)$ when every cell of $s$ has score in $\{1,2,4,5,8\}$ computed from
$r$, $s$ and $t$;
\item $\mathbf{e}(r,s)=1$ when every cell of $s$ has score in $\{1,2,4,5,8\}$ \emph{with no row
...
exactly when every one of its $n$ rows has all scores in $\{1,2,4,5,8\}$. Read the sequence as the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A305448.
