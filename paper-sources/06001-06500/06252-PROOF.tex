...
\title{The empirical recurrence for OEIS A220598, proved by transfer matrix}
...
\begin{abstract}
OEIS A220598 counts the ways of linking the cells of a grid $4$ cells wide, each cell either to
...
state, the count is a walk count on $S=235$ of them, and the conjectured recurrence is then
...
OEIS A220598 is ``Number of ways to reciprocally link elements of an nX4 array either to themselves or to exactly two horizontal, vertical and antidiagonal neighbors, without 3-loops.''. It has offset $1$ and begins
\[
1, 17, 471, 9047, 167614, 3174778, 60138423, 1137615308,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 18:53:20, revision 8) this is still
...
one configuration. With $M$ the adjacency matrix of the digraph on the $S=235$ reachable
...
\begin{theorem}
\[
a(n)\;=\;15\,a(n-1) + 41\,a(n-2) + 606\,a(n-3) + 405\,a(n-4) + 679\,a(n-5) - 8407\,a(n-6) - 28555\,a(n-7) + 17039\,a(n-8) + 147483\,a(n-9) + 79534\,a(n-10) - 260454\,a(n-11) - 334003\,a(n-12) + 79493\,a(n-13) + 384190\,a(n-14) + 187418\,a(n-15) - 93878\,a(n-16) - 122508\,a(n-17) - 48185\,a(n-18) - 5142\,a(n-19) + 3204\,a(n-20) + 1023\,a(n-21) + 22\,a(n-22) - 9\,a(n-23) - 11\,a(n-24) + a(n-25)
\]
for every $n>24$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A220598.
