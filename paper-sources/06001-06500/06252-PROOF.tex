...
\title{The empirical recurrence for OEIS A304923, proved by transfer matrix}
...
\begin{abstract}
OEIS A304923 counts $5$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A304923 is ``Number of nX5 0..1 arrays with every element unequal to 0, 1, 2, 5 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
16, 22, 73, 266, 1054, 4186, 16158, 63555,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 21 2018 09:14:02, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 3\,a(n-2) + 15\,a(n-3) - 21\,a(n-4) - 101\,a(n-5) - 119\,a(n-6) + 168\,a(n-7) + 750\,a(n-8) + 338\,a(n-9) - 1047\,a(n-10) - 1984\,a(n-11) - 170\,a(n-12) + 2290\,a(n-13) + 3270\,a(n-14) - 457\,a(n-15) - 3277\,a(n-16) - 3185\,a(n-17) + 659\,a(n-18) + 2939\,a(n-19) + 2559\,a(n-20) - 532\,a(n-21) - 2150\,a(n-22) - 1076\,a(n-23) + 37\,a(n-24) + 823\,a(n-25) + 638\,a(n-26) - 122\,a(n-27) - 97\,a(n-28) - 116\,a(n-29) - 96\,a(n-30) + 59\,a(n-31) - 2\,a(n-32) - 8\,a(n-33) + 10\,a(n-34)
\end{equation}
for all $n>41$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A304923.
