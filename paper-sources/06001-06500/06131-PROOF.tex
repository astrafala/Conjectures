...
\title{The empirical recurrence for OEIS A254476, proved by transfer matrix}
...
\begin{abstract}
OEIS A254476 counts the arrays over $\{0,\dots,1\}$ whose $3\times3$ subblocks carry a
...
OEIS A254476 is ``Number of (n+2)X(1+2) 0..1 arrays with every 3X3 subblock diagonal sum minus antidiagonal minimum nondecreasing horizontally and vertically.''. It has offset $1$ and begins
\[
512, 2696, 12260, 47140, 170504, 586508, 1964388, 6462708,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 14:42:13, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) - 8\,a(n-2) - 9\,a(n-3) + 19\,a(n-4) + 4\,a(n-5) - 22\,a(n-6) + 23\,a(n-7) + 5\,a(n-8) - 162\,a(n-9) + 276\,a(n-10) - 83\,a(n-11) - 50\,a(n-12) + 218\,a(n-13) - 326\,a(n-14) + 66\,a(n-15) + 9\,a(n-16) - 60\,a(n-17) + 78\,a(n-18) + 5\,a(n-19) + 23\,a(n-20) - 6\,a(n-21) + 4\,a(n-22) - a(n-23) - 5\,a(n-24) - 2\,a(n-26) - a(n-27)
\]
for every $n>32$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A254476.
