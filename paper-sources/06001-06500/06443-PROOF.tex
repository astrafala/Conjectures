...
\title{The empirical recurrence for OEIS A237968, proved by transfer matrix}
...
\begin{abstract}
OEIS A237968 counts arrays over $\{0,\dots,3\}$ subject to a condition on the order
...
The condition is local to two consecutive rows, so the count is a walk count on $S=1494$
...
OEIS A237968 is ``Number of (n+1)X(2+1) 0..3 arrays with the upper median of every 2X2 subblock differing from its horizontal and vertical neighbors by exactly one.''. It has offset $1$ and begins
\[
1494, 10014, 59014, 357672, 2270776, 14222512, 88114176, 550642732,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 10:39:58, revision 6) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The $2\times2$ subblocks of an $(n+1)\times3$ array form an
$n\times2$ grid, and each carries the value $\sigma=c$, where $a\le b\le c\le d$ are its four entries sorted --- its minimum, lower median, upper median and maximum. The entry asks that the values of
...
differ by $1$. The entry's first term $1494$ counts those, and the model was made to
...
\]
over the $S=1494$ pairs whose own subblock row already satisfies the condition along itself.
...
\begin{theorem}
\[
a(n)\;=\;84\,a(n-3) + 773\,a(n-4) + 1372\,a(n-5) + 3600\,a(n-6) - 8931\,a(n-7) - 55854\,a(n-8) - 94782\,a(n-9) - 31846\,a(n-10) + 191731\,a(n-11) + 369506\,a(n-12) + 355656\,a(n-13) + 149556\,a(n-14) + 448480\,a(n-15) + 642040\,a(n-16) + 99840\,a(n-17)
\]
for every $n>20$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237968.
