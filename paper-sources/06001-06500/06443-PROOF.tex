...
\title{The empirical recurrence for OEIS A239181, proved by transfer matrix}
...
\begin{abstract}
OEIS A239181 counts $4\times(n+1)$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A239181 is ``Number of (3+1)X(n+1) 0..2 arrays with no element greater than all horizontal neighbors or equal to all vertical neighbors.''. It has offset $1$ and begins
\[
36, 676, 9604, 142884, 2286144, 36216324, 570732100, 8995763716,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 10:59:15, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;15\,a(n-1) + 148\,a(n-3) + 922\,a(n-4) - 3635\,a(n-5) - 1087\,a(n-6) + 8846\,a(n-7) - 4276\,a(n-8) + 5182\,a(n-9) + 542\,a(n-10) - 22842\,a(n-11) + 14936\,a(n-12) - 4238\,a(n-13) + 2914\,a(n-14) + 1585\,a(n-15) - 189\,a(n-16) + 354\,a(n-17) - 18\,a(n-18) - 50\,a(n-19) + 13\,a(n-20) - a(n-21)
\]
for every $n>21$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A239181.
