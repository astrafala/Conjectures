...
\title{The empirical recurrence for OEIS A231378, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A231378 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A231378 is ``Number of nX4 0..1 arrays with no element less than a strict majority of its horizontal and vertical neighbors.''. It has offset $1$ and begins
\[
7, 48, 378, 2539, 17363, 120124, 830890, 5746499,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 06:26:31, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;10\,a(n-1) - 31\,a(n-2) + 82\,a(n-3) - 131\,a(n-4) + 226\,a(n-5) - 319\,a(n-6) + 206\,a(n-7) - 574\,a(n-8) + 483\,a(n-9) - 432\,a(n-10) + 517\,a(n-11) + 132\,a(n-12) + 746\,a(n-13) - 145\,a(n-14) - 228\,a(n-15) - 6\,a(n-16) + 41\,a(n-17) + 3\,a(n-18) - 3\,a(n-19)
\end{equation}
for all $n>20$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231378.
