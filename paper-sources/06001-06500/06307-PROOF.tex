...
\title{The empirical recurrence for OEIS A252518, proved by transfer matrix}
...
\begin{abstract}
OEIS A252518 counts $(n+2)\times5$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252518 is ``Number of (n+2)X(3+2) 0..3 arrays with every 3X3 subblock row and column sum not equal to 0 2 4 6 or 7 and every 3X3 diagonal and antidiagonal sum equal to 0 2 4 6 or 7.''. It has offset $1$ and begins
\[
475, 798, 1783, 2818, 8354, 21510, 39689, 125839,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:19:20, revision 6) this is still
...
\[
\text{every row, column sum} \notin \{0,2,4,6,7\}\ \text{ and }\ \text{every diagonal, antidiagonal sum} \in \{0,2,4,6,7\}
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252518.
