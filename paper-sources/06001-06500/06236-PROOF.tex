...
\title{The empirical recurrence for OEIS A251870, proved by transfer matrix}
...
\begin{abstract}
OEIS A251870 counts arrays of width $4$ over $\{0,1,2,3\}$ in which every $3\times3$ window has
...
OEIS A251870 is ``Number of (n+2)X(2+2) 0..3 arrays with every 3X3 subblock row and column sum not 2 4 5 or 7 and every diagonal and antidiagonal sum 2 4 5 or 7.''. It has offset $1$ and begins
\[
2146, 5632, 7160, 15116, 36852, 41816, 99808, 169196,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 10:34:53, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;17\,a(n-3) + 16\,a(n-5) - 95\,a(n-6) - 272\,a(n-8) + 59\,a(n-9) + 1776\,a(n-11) + 1448\,a(n-12) - 5296\,a(n-14) - 5812\,a(n-15) + 5248\,a(n-17) + 6720\,a(n-18) + 8256\,a(n-20) + 7296\,a(n-21) - 23552\,a(n-23) - 23552\,a(n-24) + 15360\,a(n-26) + 15360\,a(n-27)
\]
for every $n>33$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251870.
