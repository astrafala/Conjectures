...
\title{A condition on the multiset of every subblock: OEIS A184193}
...
\begin{abstract}
OEIS A184193 carries an empirical recurrence of order $36$ contributed by R.~H.~Hardin. It is
...
work. The entry does not count the arrays themselves but $1/2$ of them, so every count below is divided by $2$.
\end{abstract}
...
OEIS A184193 is ``Half the number of (n+1)X6 binary arrays with no 2X2 subblock containing exactly one 1.''. It has offset $1$ and begins
\[
602, 16581, 425802, 11226643, 294738261, 7751834608, 203828058160, 5360172454105,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 02:23:26, revision 9) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{The count is a walk count}

The entry counts arrays with $6$ columns over the alphabet $\{0,1\}$, growing one row at a time, and asks that no $2\times2$ subblock holds exactly $1$ entries equal to $1$.
...
The entry counts not the arrays themselves but $1/2$ of them, so every count below is divided by $2$; the division comes out exact at every term the entry publishes, which is itself a check on the model.
...
\begin{theorem}
\[
a(n)\;=\;51\,a(n-1) - 805\,a(n-2) + 3209\,a(n-3) + 37453\,a(n-4) - 417551\,a(n-5) + 815341\,a(n-6) + 7216861\,a(n-7) - 40290699\,a(n-8) + 24318580\,a(n-9) + 307333858\,a(n-10) - 684397564\,a(n-11) - 709536075\,a(n-12) + 3625174740\,a(n-13) - 763760119\,a(n-14) - 9155414619\,a(n-15) + 6719109756\,a(n-16) + 12902695893\,a(n-17) - 13865362580\,a(n-18) - 10797221393\,a(n-19) + 14735900778\,a(n-20) + 5612692485\,a(n-21) - 9068116073\,a(n-22) - 1937157517\,a(n-23) + 3292107469\,a(n-24) + 482465491\,a(n-25) - 683386889\,a(n-26) - 85241972\,a(n-27) + 75921724\,a(n-28) + 9085136\,a(n-29) - 4088944\,a(n-30) - 500115\,a(n-31) + 86878\,a(n-32) + 11224\,a(n-33) - 398\,a(n-34) - 78\,a(n-35) - 2\,a(n-36)
\]
for every $n>35$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A184193.
