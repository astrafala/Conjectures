...
\title{The empirical recurrence for OEIS A238306, proved by transfer matrix}
...
\begin{abstract}
OEIS A238306 counts arrays over $\{0,\dots,3\}$ subject to a condition on the order
...
OEIS A238306 is ``Number of (n+1) X (1+1) 0..3 arrays with the maximum minus the lower median of every 2 X 2 subblock differing from its horizontal and vertical neighbors by exactly one.''. It has offset $1$ and begins
\[
256, 1776, 12372, 85984, 601408, 4181152, 29228452, 203246304,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 25 2023 15:30:37, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;1419\,a(n-4) + 36268\,a(n-6) + 410501\,a(n-8) + 2593208\,a(n-10) + 10304257\,a(n-12) + 28327948\,a(n-14) + 55782736\,a(n-16) + 83338496\,a(n-18) + 93171712\,a(n-20) + 85534720\,a(n-22) + 49102848\,a(n-24) + 25690112\,a(n-26)
\]
for every $n>26$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A238306.
