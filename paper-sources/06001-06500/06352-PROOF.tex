...
\title{The empirical recurrence for OEIS A237489, proved by transfer matrix}
...
\begin{abstract}
OEIS A237489 counts arrays over $\{0,\dots,3\}$ subject to a condition on the order
...
OEIS A237489 is ``Number of (n+1)X(1+1) 0..3 arrays with the maximum plus the upper median minus the lower median minus the minimum of every 2X2 subblock differing from its horizontal and vertical neighbors by exactly one.''. It has offset $1$ and begins
\[
256, 1728, 11960, 84000, 589944, 4135648, 28986208, 203229696,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 10:13:29, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;2568\,a(n-4) - 371328\,a(n-8) + 15212544\,a(n-12) - 125530112\,a(n-16) + 93167616\,a(n-20) - 143392768\,a(n-24)
\]
for every $n>27$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237489.
