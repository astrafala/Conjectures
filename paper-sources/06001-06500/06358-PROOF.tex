...
\title{The empirical recurrence for OEIS A204491, proved by transfer matrix}
...
\begin{abstract}
OEIS A204491 counts $(n+2)\times9$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
every $3\times3$ subblock, and counted UP TO RELABELLING of the
alphabet; it carries an empirical recurrence of order $25$ contributed by
...
OEIS A204491 is ``Number of (n+2)X9 0..1 arrays with every 3X3 subblock having three equal elements in a row horizontally, vertically or nw-to-se diagonally exactly one way, and new values 0..1 introduced in row major order.''. It has offset $1$ and begins
\[
35172, 28743, 50897, 90942, 168567, 331723, 658793, 1277695,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 11:15:49, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + a(n-2) + 9\,a(n-3) - 5\,a(n-4) - 10\,a(n-5) - 7\,a(n-6) - 28\,a(n-7) + 16\,a(n-8) - 9\,a(n-9) + 34\,a(n-10) + 3\,a(n-11) + 4\,a(n-12) + 26\,a(n-13) - 13\,a(n-14) + 14\,a(n-15) - 26\,a(n-16) - 3\,a(n-17) - 10\,a(n-18) - 2\,a(n-19) + 6\,a(n-20) - 6\,a(n-21) + 3\,a(n-22) + 6\,a(n-24) - 3\,a(n-25)
\]
for every $n>37$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204491.
