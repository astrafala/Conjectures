...
\title{The empirical recurrence for OEIS A202598, proved by transfer matrix}
...
\begin{abstract}
OEIS A202598 counts arrays of width $7$ over $\{0,1\}$ containing no occurrence of certain short
...
OEIS A202598 is ``Number of (n+2)X7 binary arrays avoiding patterns 001 and 000 in rows and columns.''. It has offset $1$ and begins
\[
30114, 629790, 12360432, 248094210, 4938195402, 98603761284, 1966507686990, 39237140832414,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 09:44:13, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-1) + 250\,a(n-2) + 184\,a(n-3) - 8341\,a(n-4) - 3864\,a(n-5) + 101382\,a(n-6) - 13547\,a(n-7) - 478599\,a(n-8) + 220430\,a(n-9) + 899746\,a(n-10) - 500871\,a(n-11) - 729610\,a(n-12) + 374846\,a(n-13) + 291331\,a(n-14) - 107013\,a(n-15) - 59556\,a(n-16) + 9986\,a(n-17) + 5219\,a(n-18) - 224\,a(n-19) - 160\,a(n-20) - 2\,a(n-21) + a(n-22)
\]
for every $n>20$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A202598.
