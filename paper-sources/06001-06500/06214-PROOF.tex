...
\title{The empirical recurrence for OEIS A252185, proved by transfer matrix}
...
\begin{abstract}
OEIS A252185 counts $(n+2)\times3$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252185 is ``Number of (n+2)X(1+2) 0..3 arrays with every 3X3 subblock row and column sum equal to 0 1 3 6 or 7 and every 3X3 diagonal and antidiagonal sum not equal to 0 1 3 6 or 7.''. It has offset $1$ and begins
\[
945, 1440, 2055, 3341, 5300, 7973, 13044, 21238,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 10:54:01, revision 6) this is still
...
\[
\text{every row, column sum} \in \{0,1,3,6,7\}\ \text{ and }\ \text{every diagonal, antidiagonal sum} \notin \{0,1,3,6,7\}
\]
...
\begin{theorem}
\[
a(n)\;=\;-a(n-1) + 14\,a(n-3) + 14\,a(n-4) + a(n-5) - 76\,a(n-6) - 77\,a(n-7) - 13\,a(n-8) + 199\,a(n-9) + 212\,a(n-10) + 65\,a(n-11) - 243\,a(n-12) - 308\,a(n-13) - 159\,a(n-14) + 65\,a(n-15) + 224\,a(n-16) + 202\,a(n-17) + 138\,a(n-18) - 64\,a(n-19) - 128\,a(n-20) - 128\,a(n-21) + 32\,a(n-23) + 32\,a(n-24)
\]
for every $n>30$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252185.
