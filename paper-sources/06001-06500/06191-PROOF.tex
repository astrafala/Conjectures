...
\title{The empirical recurrence for OEIS A184148, proved by transfer matrix}
...
\begin{abstract}
OEIS A184148 counts $(n+1)\times5$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A184148 is ``1/4 the number of (n+1) X 5 0..3 arrays with every 2 X 2 subblock having at least two equal elements connected horizontally or vertically.''. It has offset $1$ and begins
\[
65227, 19882711, 5910714349, 1764076701091, 526180845527509, 156962462690881921, 46821946289531019895, 13967039613166010435737,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 22 2022 01:13:51, revision 7) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;337\,a(n-1) - 8104\,a(n-2) - 1212723\,a(n-3) + 55423428\,a(n-4) + 243748616\,a(n-5) - 55724746410\,a(n-6) + 1180316913749\,a(n-7) - 7148510691053\,a(n-8) - 59840603520013\,a(n-9) + 934968573133050\,a(n-10) - 1598999423035027\,a(n-11) - 27702978848203293\,a(n-12) + 119454717270845028\,a(n-13) + 223987686124481997\,a(n-14) - 1840120640662271311\,a(n-15) + 773833281643738361\,a(n-16) + 9090830762002726004\,a(n-17) - 12107110290106201695\,a(n-18) - 9799264640486546212\,a(n-19) + 25471762055592565538\,a(n-20) - 11773742330427714096\,a(n-21) - 1826163119557948194\,a(n-22) + 2019141649808688636\,a(n-23) - 242177999041318032\,a(n-24)
\end{equation}
for all $n>23$.
...
\[
a(n)-\sum_i c_i\,a(n-i)\;=\;\tfrac1{4}\mathbf{1}^{\!\top}M^{\,n+1-1-24}\,q(M)\,\mathbf{1} .
\]
...
=\tfrac1{4}\mathbf{1}^{\!\top}M^{\,m-24}\,q(M)\,\mathbf{1}
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A184148.
