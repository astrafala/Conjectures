...
\title{The empirical recurrence for OEIS A207714, proved by transfer matrix}
...
\begin{abstract}
OEIS A207714 counts arrays over $\{0,\dots,1\}$ of width $5$ that avoid the patterns
...
OEIS A207714 is ``Number of nX5 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 0 1 and 1 0 0 vertically.''. It has offset
$1$ and begins
\[
16, 256, 1644, 12015, 97580, 820820, 7070805,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:12:14, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;16\,a(n-1) - 42\,a(n-2) - 401\,a(n-3) + 1780\,a(n-4) + 3228\,a(n-5) - 21310\,a(n-6) - 7724\,a(n-7) + 117040\,a(n-8) - 14574\,a(n-9) - 345676\,a(n-10) + 104844\,a(n-11) + 593560\,a(n-12) - 209036\,a(n-13) - 617332\,a(n-14) + 210704\,a(n-15) + 393548\,a(n-16) - 121244\,a(n-17) - 151602\,a(n-18) + 42220\,a(n-19) + 33904\,a(n-20) - 9106\,a(n-21) - 4084\,a(n-22) + 1140\,a(n-23) + 217\,a(n-24) - 68\,a(n-25) - 2\,a(n-26) + a(n-27)
\end{equation}
for all $n>28$. 
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207714.
