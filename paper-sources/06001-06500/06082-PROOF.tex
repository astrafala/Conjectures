...
\title{The empirical recurrence for OEIS A317858, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A317858 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A317858 is ``Number of nX3 0..1 arrays with every element unequal to 1, 2 or 4 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
1, 6, 4, 19, 32, 72, 164, 331,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 09 2018 09:43:58, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-2) + 8\,a(n-3) - 2\,a(n-4) - 26\,a(n-5) - 32\,a(n-6) + 6\,a(n-7) + 40\,a(n-8) + 32\,a(n-9) - 3\,a(n-10) - 16\,a(n-11) + 17\,a(n-12) + 6\,a(n-13) - 20\,a(n-14) - 6\,a(n-15) + 19\,a(n-16) + 14\,a(n-17) - 14\,a(n-19) - 5\,a(n-20) + 2\,a(n-21) - 10\,a(n-22) + 3\,a(n-24) + a(n-26)
\end{equation}
for all $n>32$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A317858.
