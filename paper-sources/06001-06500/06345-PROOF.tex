...
\title{The empirical recurrence for OEIS A237786, proved by transfer matrix}
...
\begin{abstract}
OEIS A237786 counts arrays over $\{0,\dots,3\}$ subject to a condition on the order
...
OEIS A237786 is ``Number of (n+1)X(1+1) 0..3 arrays with the maximum plus the minimum minus the lower median of every 2X2 subblock differing from its horizontal and vertical neighbors by exactly one.''. It has offset $1$ and begins
\[
256, 1902, 14369, 108626, 822482, 6206506, 46951577, 354492388,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 10:28:05, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;2044\,a(n-4) + 57712\,a(n-6) + 627304\,a(n-8) + 2916648\,a(n-10) + 5816832\,a(n-12) + 11824576\,a(n-14) + 34380288\,a(n-16) + 53691776\,a(n-18) + 42450944\,a(n-20) + 56373760\,a(n-22) + 52514816\,a(n-24) + 67936256\,a(n-26) + 35323904\,a(n-28) + 5242880\,a(n-30)
\]
for every $n>30$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237786.
