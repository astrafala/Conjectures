...
\title{The empirical recurrence for OEIS A230836, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A230836 counts arrays over $\{0,\dots,3\}$ in which every cell is constrained by the
...
OEIS A230836 is ``Number of n X 3 0..3 arrays x(i,j) with each element horizontally, vertically or antidiagonally next to at least one element with value (x(i,j)+1) mod 4, and upper left element zero.''. It has offset $1$ and begins
\[
0, 22, 656, 16496, 416540, 10550264, 267165468, 6765343878,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 18 2025 04:17:59, revision 10) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;36\,a(n-1) - 321\,a(n-2) + 1424\,a(n-3) - 3860\,a(n-4) + 6696\,a(n-5) + 594\,a(n-6) - 70152\,a(n-7) + 320123\,a(n-8) - 856976\,a(n-9) + 1631595\,a(n-10) - 2066908\,a(n-11) - 1107106\,a(n-12) + 16080172\,a(n-13) - 51553020\,a(n-14) + 118926468\,a(n-15) - 245463204\,a(n-16) + 405589528\,a(n-17) - 400948880\,a(n-18) + 178336048\,a(n-19) - 94909520\,a(n-20) + 225948192\,a(n-21) - 117957824\,a(n-22) - 84255040\,a(n-23) - 5790912\,a(n-24) - 48408704\,a(n-25) + 37228544\,a(n-26) - 12355072\,a(n-27) + 4648960\,a(n-28) - 3346432\,a(n-29) - 225280\,a(n-30)
\end{equation}
for all $n>31$.
...
publishes, $n=18$, the arrays have $3\cdot18$ cells over
$4$ values, so there are about $10^{32}$ of them to sift. The
...
Every one of those integers vanishes from the index corresponding to $n=31+1$ onwards,
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A230836.
