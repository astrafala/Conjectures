...
\title{The empirical recurrence for OEIS A188995, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A188995 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A188995 is ``Number of 5Xn binary arrays without the pattern 0 0 1 antidiagonally or horizontally.''. It has offset $1$ and begins
\[
32, 1024, 10871, 92532, 852448, 7844188, 72609144, 669102268,\ \dots
\]
...
the middle column. The vector $w$ was formed by $57$ applications of $G$ in exact integer
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A188995.
