...
\title{The empirical recurrence for OEIS A210271, proved by transfer matrix}
...
\begin{abstract}
OEIS A210271 counts $(n+1)\times4$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A210271 is ``Half the number of (n+1)X4 0..2 arrays with every 2X2 subblock having two or three distinct clockwise edge differences.''. It has offset $1$ and begins
\[
2130, 113248, 6028871, 321050788, 17097482699, 910532241954, 48490791961375, 2582399328204990,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 15:51:25, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;48\,a(n-1) + 480\,a(n-2) - 9807\,a(n-3) - 58253\,a(n-4) + 657082\,a(n-5) + 2138431\,a(n-6) - 18778839\,a(n-7) - 19795420\,a(n-8) + 235514744\,a(n-9) - 62769938\,a(n-10) - 1259927930\,a(n-11) + 1276469157\,a(n-12) + 2637995603\,a(n-13) - 4298139072\,a(n-14) - 1484220465\,a(n-15) + 5231313990\,a(n-16) - 949603112\,a(n-17) - 2426962356\,a(n-18) + 931229528\,a(n-19) + 400609008\,a(n-20) - 188316850\,a(n-21) - 12522776\,a(n-22) + 5412968\,a(n-23) - 237208\,a(n-24) - 448\,a(n-25)
\end{equation}
for all $n>24$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A210271.
