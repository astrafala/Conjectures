...
\title{The empirical recurrence for OEIS A256948, proved by transfer matrix}
...
\begin{abstract}
OEIS A256948 counts the arrays over $\{0,\dots,1\}$ whose $3\times3$ subblocks carry a
...
so the count is a walk count on $S=811$ states --- the last two array rows together with the
...
OEIS A256948 is ``Number of (n+2)X(2+2) 0..1 arrays with every 3X3 subblock sum of the two sums of the central row and central column minus the two minimums of the diagonal and antidiagonal nondecreasing horizontally and vertically.''. It has offset $1$ and begins
\[
2554, 13349, 66542, 262251, 844499, 2396710, 6268245, 15240141,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 15:16:06, revision 6) this is still
...
\]
on the $S=811$ reachable states. In particular $a$ is $C$-finite. The alignment of the walk
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) - 13\,a(n-2) + 14\,a(n-3) - 13\,a(n-4) + a(n-5) + 42\,a(n-6) - 58\,a(n-7) + 36\,a(n-8) - 46\,a(n-9) - 11\,a(n-10) + 110\,a(n-11) - 129\,a(n-12) + 178\,a(n-13) - 64\,a(n-14) - 139\,a(n-15) + 99\,a(n-16) - 198\,a(n-17) + 230\,a(n-18) - 37\,a(n-19) + 105\,a(n-20) - 130\,a(n-21) + 155\,a(n-22) - 101\,a(n-23) - 134\,a(n-24) + 232\,a(n-25) - 533\,a(n-26) + 202\,a(n-27) + 452\,a(n-28) + 96\,a(n-29) - 732\,a(n-30) + 309\,a(n-31) + 761\,a(n-32) - 681\,a(n-33) - 702\,a(n-34) + 688\,a(n-35) + 552\,a(n-36) - 938\,a(n-37) - 12\,a(n-38) + 892\,a(n-39) - 172\,a(n-40) - 652\,a(n-41) + 252\,a(n-42) + 324\,a(n-43) - 296\,a(n-44) - 112\,a(n-45) + 192\,a(n-46) + 56\,a(n-47) - 80\,a(n-48) - 16\,a(n-49) + 16\,a(n-50)
\]
for every $n>63$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A256948.
