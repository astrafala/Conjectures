...
\title{The empirical recurrence for OEIS A196713, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A196713 counts arrays over $\{0,\dots,4\}$ in which every cell is constrained by the
...
OEIS A196713 is ``Number of n X 3 0..4 arrays with each element x equal to the number its horizontal and vertical neighbors equal to 4,0,2,1,3 for x=0,1,2,3,4.''. It has offset $1$ and begins
\[
4, 14, 40, 171, 543, 1984, 7368, 25698,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 14 2026 20:34:36, revision 13) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) - 3\,a(n-2) + 12\,a(n-3) - 22\,a(n-4) - 8\,a(n-5) + 39\,a(n-6) - 79\,a(n-7) - 147\,a(n-8) + 46\,a(n-9) - 13\,a(n-10) + 140\,a(n-11) + 701\,a(n-12) - 704\,a(n-13) + 732\,a(n-14) - 451\,a(n-15) + 1676\,a(n-16) + 1005\,a(n-17) + 1884\,a(n-18) + 296\,a(n-19) + 383\,a(n-20) + 244\,a(n-21) + 132\,a(n-22) - 160\,a(n-23) - 62\,a(n-24) - 10\,a(n-25) + 2\,a(n-27)
\end{equation}
for all $n>28$.
...
\#\{\text{neighbours with value }f(x_{t,u})\}=x_{t,u},\quad f=(4,0,2,1,3)
\end{equation}
for every cell $(t,u)$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A196713.
