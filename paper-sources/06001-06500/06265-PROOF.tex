...
\title{The empirical recurrence for OEIS A252575, proved by transfer matrix}
...
\begin{abstract}
OEIS A252575 counts $3\times(n+2)$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252575 is ``Number of (1+2)X(n+2) 0..3 arrays with every 3X3 subblock row and diagonal sum equal to 1 2 5 6 or 7 and every 3X3 column and antidiagonal sum not equal to 1 2 5 6 or 7.''. It has offset $1$ and begins
\[
702, 843, 1069, 1694, 2985, 5401, 9936, 18972,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:23:58, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;25\,a(n-3) + a(n-4) - 239\,a(n-6) - 23\,a(n-7) + 1103\,a(n-9) + 192\,a(n-10) - 2670\,a(n-12) - 696\,a(n-13) + 3918\,a(n-15) + 1086\,a(n-16) - 4034\,a(n-18) - 1050\,a(n-19) + 3218\,a(n-21) + 848\,a(n-22) - 1969\,a(n-24) - 472\,a(n-25) + 889\,a(n-27) + 177\,a(n-28) - 303\,a(n-30) - 63\,a(n-31) + 63\,a(n-33)
\]
for every $n>43$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252575.
