...
\title{The empirical recurrence for OEIS A252143, proved by transfer matrix}
...
\begin{abstract}
OEIS A252143 counts $(n+2)\times5$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252143 is ``Number of (n+2)X(3+2) 0..3 arrays with every 3X3 subblock row and column sum equal to 0 3 5 6 or 7 and every 3X3 diagonal and antidiagonal sum not equal to 0 3 5 6 or 7.''. It has offset $1$ and begins
\[
5090, 3073, 5440, 4416, 9443, 8964, 21375, 18900,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 10:51:15, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-2) + 3\,a(n-3) + a(n-4) - 9\,a(n-5) - 2\,a(n-6) - 3\,a(n-7) - 6\,a(n-8) + 3\,a(n-9) - 8\,a(n-10) + 27\,a(n-11) + 3\,a(n-12) + 27\,a(n-13) + 2\,a(n-14) - 12\,a(n-15) - 33\,a(n-17) + a(n-18) - 27\,a(n-19) + 6\,a(n-20) + 9\,a(n-21) + 8\,a(n-22) + 15\,a(n-23) - 2\,a(n-24) + 3\,a(n-25) - 5\,a(n-26) - 3\,a(n-27) - a(n-28) + a(n-30)
\]
for every $n>36$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252143.
