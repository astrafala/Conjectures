...
\title{The empirical recurrence for OEIS A207230, proved by transfer matrix}
...
\begin{abstract}
OEIS A207230 counts arrays of width $3$ over $\{0,1,2\}$ containing no occurrence of certain short
patterns, read along the rows, the columns or the diagonals. The entry carries an empirical
recurrence of order $25$ contributed by R.~H.~Hardin. It is true, and it is decidable
...
count is a walk count on $S=553$ states.
\end{abstract}
...
OEIS A207230 is ``Number of nX3 0..2 arrays avoiding the patterns z z+1 z or z z-1 z in any row, column, diagonal or antidiagonal.''. It has offset $1$ and begins
\[
23, 529, 5853, 79353, 1089017, 14540437, 191801477, 2533992385,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 13:38:47, revision 9) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=553.
\]
...
\begin{theorem}
\[
a(n)\;=\;16\,a(n-1) - 84\,a(n-2) + 531\,a(n-3) + 1301\,a(n-4) - 257\,a(n-5) + 17030\,a(n-6) - 106\,a(n-7) - 212554\,a(n-8) - 1296056\,a(n-9) + 155344\,a(n-10) + 7596656\,a(n-11) + 2224800\,a(n-12) - 11493056\,a(n-13) - 26888992\,a(n-14) - 43257728\,a(n-15) - 8055680\,a(n-16) - 42288128\,a(n-17) - 40871936\,a(n-18) - 16979968\,a(n-19) - 18243584\,a(n-20) + 92192768\,a(n-21) + 1687552\,a(n-22) + 123764736\,a(n-23) - 22282240\,a(n-24) - 27852800\,a(n-25)
\]
for every $n>28$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207230.
