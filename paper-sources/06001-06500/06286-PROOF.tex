...
\end{equation}
for all $n>33$. The entry's array has a fixed number of rows and a growing number of
...
index corresponding to $n=33+1$ onwards, and the run was continued past $S$ consecutive
