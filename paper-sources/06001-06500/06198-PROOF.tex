...
\title{The empirical recurrence for OEIS A301325, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A301325 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A301325 is ``Number of nX3 0..1 arrays with every element equal to 0, 2, 3, 5 or 6 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
1, 2, 7, 18, 25, 89, 233, 552,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 18 2018 08:37:30, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 3\,a(n-2) + 6\,a(n-3) - 6\,a(n-5) - 9\,a(n-6) + 7\,a(n-7) - 15\,a(n-8) - 14\,a(n-9) - 20\,a(n-10) + 30\,a(n-11) + 3\,a(n-12) + 47\,a(n-13) - 67\,a(n-14) + 38\,a(n-15) + 15\,a(n-16) - 65\,a(n-17) + 106\,a(n-18) - 83\,a(n-19) + 24\,a(n-20) + 13\,a(n-21) - 32\,a(n-22) + 29\,a(n-23) - 11\,a(n-24) + 3\,a(n-26) - 3\,a(n-27) + a(n-28)
\end{equation}
for all $n>29$.
...
\#\{\text{neighbours with a value }equal to\ x_{t,u}\}\in\{0,2,3,5,6\}
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A301325.
