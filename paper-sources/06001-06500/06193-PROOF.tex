...
\title{The empirical recurrence for OEIS A197042, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A197042 counts arrays over $\{0,\dots,4\}$ in which every cell is constrained by the
...
OEIS A197042 is ``Number of nX3 0..4 arrays with each element x equal to the number its horizontal and vertical neighbors equal to 4,2,0,1,3 for x=0,1,2,3,4.''. It has offset $1$ and begins
\[
2, 20, 120, 698, 4080, 24074, 141856, 833758,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 06:54:30, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 6\,a(n-2) + 39\,a(n-3) + 104\,a(n-4) + 320\,a(n-5) - 266\,a(n-6) + 209\,a(n-7) - 606\,a(n-8) + 472\,a(n-9) - 2199\,a(n-10) - 4220\,a(n-11) - 79\,a(n-12) - 4287\,a(n-13) - 1432\,a(n-14) + 665\,a(n-15) - 2303\,a(n-16) - 1803\,a(n-17) + 149\,a(n-18) + 1299\,a(n-19) + 3913\,a(n-20) + 1651\,a(n-21) - 2432\,a(n-22) - 901\,a(n-23) + 874\,a(n-24) + 148\,a(n-25) - 184\,a(n-26) - 32\,a(n-27)
\end{equation}
for all $n>28$.
...
\#\{\text{neighbours with value }f(x_{t,u})\}=x_{t,u},\quad f=(4,2,0,1,3)
\end{equation}
for every cell $(t,u)$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A197042.
