...
\title{The empirical recurrence for OEIS A282964, proved by transfer matrix}
...
\begin{abstract}
OEIS A282964 counts $n\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
walk, and $a(n)$ is a walk count on $S=122$ vertices, which is $C$-finite. Whether the
...
OEIS A282964 is ``Number of nX3 0..1 arrays with no 1 equal to more than one of its horizontal, vertical and antidiagonal neighbors, with the exception of exactly two elements.''. It has offset $1$ and begins
\[
0, 5, 38, 309, 2012, 12160, 70722, 395223,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 25 2017 17:45:11, revision 4) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A282964.
