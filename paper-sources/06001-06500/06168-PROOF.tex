...
\title{The empirical recurrence for OEIS A202433, proved by transfer matrix}
...
\begin{abstract}
OEIS A202433 counts arrays of width $8$ over $\{0,1\}$ containing no occurrence of certain short
...
count is a walk count on $S=4693$ states.
\end{abstract}
...
OEIS A202433 is ``Number of (n+2)X8 binary arrays avoiding patterns 000 and 001 in rows, columns and nw-to-se diagonals.''. It has offset $1$ and begins
\[
56508, 1226040, 21708320, 412198592, 7639914240, 142785263584, 2660934612820, 49637957849364,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 09:35:49, revision 9) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=4693.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A202433.
