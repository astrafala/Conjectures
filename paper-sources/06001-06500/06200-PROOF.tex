...
\title{The empirical recurrence for OEIS A252329, proved by transfer matrix}
...
\begin{abstract}
OEIS A252329 counts $(n+2)\times5$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252329 is ``Number of (n+2)X(3+2) 0..3 arrays with every 3X3 subblock row and column sum equal to 0 3 5 6 or 8 and every 3X3 diagonal and antidiagonal sum not equal to 0 3 5 6 or 8.''. It has offset $1$ and begins
\[
6089, 6222, 10070, 22016, 68675, 180469, 503439, 1603276,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:05:50, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;58\,a(n-3) - 1122\,a(n-6) + 10005\,a(n-9) - 54999\,a(n-12) + 226911\,a(n-15) - 741086\,a(n-18) + 1816623\,a(n-21) - 3182005\,a(n-24) + 3900573\,a(n-27) - 3282696\,a(n-30) + 1827728\,a(n-33) - 630683\,a(n-36) + 121014\,a(n-39) - 10608\,a(n-42) + 288\,a(n-45)
\]
for every $n>50$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252329.
