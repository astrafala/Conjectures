...
\title{The empirical recurrence for OEIS A301661, proved by transfer matrix}
...
\begin{abstract}
OEIS A301661 counts $7$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A301661 is ``Number of nX7 0..1 arrays with every element equal to 0, 1 or 4 horizontally or vertically adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
21, 22, 46, 89, 223, 696, 2335, 8380,\ \dots
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A301661.
