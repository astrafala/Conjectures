...
\title{The empirical recurrence for OEIS A233802, proved by transfer matrix}
...
\begin{abstract}
OEIS A233802 counts arrays of width $3$ over $\{0,1,2,3\}$ containing no run of $3$ consecutive
...
OEIS A233802 is ``Number of (1+2)X(n+2) 0..3 arrays with no increasing sequence of length 3 horizontally, vertically or antidiagonally downwards.''. It has offset $1$ and begins
\[
169840, 7949773, 371832256, 17394286865, 812933550972, 37996849382405, 1775753454824996, 82989727430563759,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 08:11:42, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A233802.
