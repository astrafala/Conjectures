...
\title{The empirical recurrence for OEIS A206890, proved by transfer matrix}
...
\begin{abstract}
OEIS A206890 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
$(1,0,0)$ along one axis and $(0,1,0)$ along the other, and carries an empirical recurrence of
order $54$ contributed by R.~H.~Hardin. It is true. The patterns have length $3$, so
...
$\mathbf{1}^{\!\top}P^{\,n-2-54}q(P)\mathbf{1}$, which vanishes identically
...
OEIS A206890 is ``Number of 4Xn 0..1 arrays avoiding 0 1 0 horizontally and 1 0 0 vertically.''. It has offset
$1$ and begins
\[
12, 144, 1112, 7878, 59812, 467146, 3619683,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 13:14:46, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;10\,a(n-1) - 45\,a(n-2) + 229\,a(n-3) - 218\,a(n-4) + 252\,a(n-5) + 4284\,a(n-6) - 13089\,a(n-7) + 3791\,a(n-8) + 11569\,a(n-9) - 213388\,a(n-10) + 260583\,a(n-11) + 666011\,a(n-12) - 920482\,a(n-13) + 2316886\,a(n-14) + 1153148\,a(n-15) - 19066932\,a(n-16) - 2877461\,a(n-17) + 45161671\,a(n-18) + 12663738\,a(n-19) - 32021544\,a(n-20) - 21458469\,a(n-21) - 43223410\,a(n-22) + 3294189\,a(n-23) + 77036208\,a(n-24) + 23573846\,a(n-25) + 2828063\,a(n-26) - 12109495\,a(n-27) - 59453958\,a(n-28) - 11713631\,a(n-29) + 8381537\,a(n-30) + 5628040\,a(n-31) + 26008202\,a(n-32) + 3592611\,a(n-33) - 1894784\,a(n-34) - 982584\,a(n-35) - 6505534\,a(n-36) - 624915\,a(n-37) - 435627\,a(n-38) + 65742\,a(n-39) + 750118\,a(n-40) + 52218\,a(n-41) + 125258\,a(n-42) - 3547\,a(n-43) - 31348\,a(n-44) - 2379\,a(n-45) - 6806\,a(n-46) + 95\,a(n-47) + 594\,a(n-48) + 36\,a(n-49) + 133\,a(n-50) - 6\,a(n-52) - a(n-54)
\end{equation}
for all $n>54$. The entry's array has a fixed number of rows and a growing number of
...
$(1,0,0)$ as $3$ consecutive entries. There are $12$ admissible columns; that condition
...
$a(n)-\sum_i c_i a(n-i)=u_{\,n-2-54}$ whenever $n-54\ge2$. Hence
\eqref{eq:conj} holds for every $n>t$ exactly when $u_j=0$ for every
$j>t-2-54$. Moreover $(u_j)$ satisfies the monic linear recurrence whose
...
$P^{\,n-2-54}$ gives the identity. The equivalence follows by letting the exponent
...
\begin{theorem}
The recurrence \eqref{eq:conj} holds for every $n>54$. This is the statement of
Section~1.
\end{theorem}

\begin{proof}
The vector $q(P)\mathbf{1}\in\mathbb{Z}^{S}$ was formed by $54$ matrix--vector
products in exact integer arithmetic and the $u_j$ evaluated in turn. They vanish from the
index corresponding to $n=54+1$ onwards, and the run was continued past $S$ consecutive
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206890.
