...
\title{The empirical recurrence for OEIS A234551, proved by transfer matrix}
...
\begin{abstract}
OEIS A234551 counts $3$-column arrays over $\{0,\dots,6\}$ in which every
$2\times2$ subblock has its diagonal sum differing from its antidiagonal sum by
exactly $3$, and it
carries an empirical recurrence of order $34$ contributed by R.~H.~Hardin. It is true,
...
the residual is $\mathbf{1}^{\!\top}M^{\,n-34}q(M)\mathbf{1}$, so the recurrence
...
OEIS A234551 is ``Number of (n+1) X (2+1) 0..6 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 3 (constant-stress 1 X 1 tilings).''. It has offset
$1$ and begins
\[
2716, 22458, 184816, 1527660, 12632704, 104793676, 870061872,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 20 2022 18:25:12, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;25\,a(n-1) + 171\,a(n-2) - 8947\,a(n-3) + 20442\,a(n-4) + 1276046\,a(n-5) - 7721142\,a(n-6) - 89665378\,a(n-7) + 835291375\,a(n-8) + 2916848953\,a(n-9) - 45270570765\,a(n-10) - 12096348459\,a(n-11) + 1332333947744\,a(n-12) - 1813960758728\,a(n-13) - 21440506572936\,a(n-14) + 48154351857440\,a(n-15) + 200413362270168\,a(n-16) - 574094316035800\,a(n-17) - 1131202886847072\,a(n-18) + 3914657325465440\,a(n-19) + 3861853479350272\,a(n-20) - 16494937667180864\,a(n-21) - 7509328290739200\,a(n-22) + 44239728068980992\,a(n-23) + 6116716146439680\,a(n-24) - 75931240737844224\,a(n-25) + 4864198828197888\,a(n-26) + 81940531841003520\,a(n-27) - 16357767821991936\,a(n-28) - 52834812420096000\,a(n-29) + 15489875939328000\,a(n-30) + 18143005999104000\,a(n-31) - 6490659697459200\,a(n-32) - 2459495301120000\,a(n-33) + 983798120448000\,a(n-34)
\end{equation}
for all $n>34$, which is every $n$ at which a recurrence of order $34$ can be
stated.
...
For $n\ge34$,
$a(n)-\sum_i c_i a(n-i)=\mathbf{1}^{\!\top}M^{\,n-34}q(M)\mathbf{1}$. Writing
$u_j=\mathbf{1}^{\!\top}M^{j}q(M)\mathbf{1}$, the recurrence therefore holds for every
$n>t$ exactly when $u_j=0$ for every $j>t-34$. Moreover $(u_j)_{j\ge0}$ satisfies the
...
$a(n)-\sum_i c_i a(n-i)
=\mathbf{1}^{\!\top}M^{\,n-34}\bigl(M^{34}-\sum_i c_i M^{34-i}\bigr)
\mathbf{1}$, which is the identity. Putting $j=n-34$ gives the equivalence. For the
...
\begin{proof}
The vector $q(M)\mathbf{1}\in\mathbb{Z}^{S}$ was formed by $34$ matrix--vector
products in exact integer arithmetic and the values $u_j$ evaluated for
$j=0,1,\dots$. They vanish from $j=34-34+1$ onwards, and the run was continued past
$S$ consecutive zeros, which by Lemma~\ref{lem:crit} settles every larger $j$. Hence the
recurrence holds for every $n>34$.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234551.
