...
\title{The empirical recurrence for OEIS A259641, proved by transfer matrix}
...
\begin{abstract}
OEIS A259641 counts $(n+2)\times9$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A259641 is ``Number of (n+2)X(7+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000000 or 00000001.''. It has offset $1$ and begins
\[
940, 4499, 30957, 133078, 670088, 3919925, 19848497, 100074919,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:53:34, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A259641.
