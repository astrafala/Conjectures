...
\title{The empirical recurrence for OEIS A184380, proved by transfer matrix}
...
\begin{abstract}
OEIS A184380 counts arrays of width $5$ over $\{0,1,2\}$ in which every $3\times3$ subblock
satisfies a condition on its nine entries. The entry carries an empirical recurrence of order
$28$ contributed by R.~H.~Hardin. It is true, and it is decidable rather than empirical: a
...
OEIS A184380 is ``1/12 the number of (n+2)X5 0..2 arrays with each 3X3 subblock containing three of each value.''. It has offset $1$ and begins
\[
2174, 4281, 8936, 21473, 73139, 280347, 1245641, 6472317,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 02:34:57, revision 9) this is still
...
consecutive rows and three consecutive columns --- and asks that each of the $3$ values occurs exactly $3$ times among the nine entries. The entry publishes $1/12$ of that count; the division is by a constant and changes nothing about the recurrence.
...
\begin{theorem}
\[
a(n)\;=\;12\,a(n-1) - 47\,a(n-2) + 186\,a(n-3) - 1404\,a(n-4) + 5358\,a(n-5) - 12815\,a(n-6) + 59388\,a(n-7) - 216529\,a(n-8) + 421074\,a(n-9) - 1238292\,a(n-10) + 4200390\,a(n-11) - 7370532\,a(n-12) + 14448024\,a(n-13) - 43986924\,a(n-14) + 72896760\,a(n-15) - 99842544\,a(n-16) + 259089192\,a(n-17) - 414953280\,a(n-18) + 415059552\,a(n-19) - 848382336\,a(n-20) + 1329975936\,a(n-21) - 1013741568\,a(n-22) + 1425340800\,a(n-23) - 2203656192\,a(n-24) + 1333615104\,a(n-25) - 947303424\,a(n-26) + 1451188224\,a(n-27) - 725594112\,a(n-28)
\]
for every $n>28$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A184380.
