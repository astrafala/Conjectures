...
\title{The empirical recurrence for OEIS A297398, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297398 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
values of its neighbours, and carries an empirical recurrence of order $21$ contributed
...
OEIS A297398 is ``Number of 5Xn 0..1 arrays with every 1 horizontally, diagonally or antidiagonally adjacent to 1 neighboring 1.''. It has offset $1$ and begins
\[
1, 41, 139, 385, 3175, 14940, 58901, 325922,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 29 2017 10:59:39, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 4\,a(n-2) + 69\,a(n-3) + 50\,a(n-4) - a(n-5) - 785\,a(n-6) - 696\,a(n-7) - 757\,a(n-8) + 2847\,a(n-9) + 1739\,a(n-10) + 270\,a(n-11) - 1916\,a(n-12) - 1560\,a(n-13) - 932\,a(n-14) + 1326\,a(n-15) + 652\,a(n-16) + 140\,a(n-17) - 373\,a(n-18) - 14\,a(n-19) - 28\,a(n-20) + 30\,a(n-21)
\end{equation}
for all $n>22$.
...
\begin{proof}
Substitute Lemma~\ref{lem:walk} and factor $G^{j-21}$ out of
...
the middle column. The vector $w$ was formed by $21$ applications of $G$ in exact integer
arithmetic and $\mathbf{v}^{\!\top}G^{m}w$ evaluated for $m=0,1,\dots$, again exactly.
Every one of those integers vanishes from the index corresponding to $n=22+1$ onwards,
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297398.
