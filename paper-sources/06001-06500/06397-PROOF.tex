...
\title{The empirical recurrence for OEIS A231539, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A231539 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A231539 is ``Number of nX3 0..1 arrays with no element less than a strict majority of its horizontal, vertical and antidiagonal neighbors.''. It has offset $1$ and begins
\[
4, 20, 116, 589, 3001, 15644, 81179, 420243,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 06:34:33, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;7\,a(n-1) - 14\,a(n-2) + 34\,a(n-3) - 67\,a(n-4) + 86\,a(n-5) - 79\,a(n-6) + 14\,a(n-7) + 47\,a(n-8) - 66\,a(n-9) + 15\,a(n-10) - 105\,a(n-11) + 121\,a(n-12) + 24\,a(n-13) - 40\,a(n-14) - 56\,a(n-15) + 2\,a(n-16) + 43\,a(n-17) - 11\,a(n-18) - 15\,a(n-19) - 6\,a(n-20) + 2\,a(n-21) + a(n-22)
\end{equation}
for all $n>23$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231539.
