...
\title{The empirical recurrence for OEIS A252578, proved by transfer matrix}
...
\begin{abstract}
OEIS A252578 counts $6\times(n+2)$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
$a(n)$ is a walk count on $S=281542$ vertices. Such a sequence is $C$-finite, so whether a given
...
OEIS A252578 is ``Number of (4+2)X(n+2) 0..3 arrays with every 3X3 subblock row and diagonal sum equal to 1 2 5 6 or 7 and every 3X3 column and antidiagonal sum not equal to 1 2 5 6 or 7.''. It has offset $1$ and begins
\[
1469, 3286, 10885, 25882, 107651, 395500, 959944, 4006901,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:24:19, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252578.
