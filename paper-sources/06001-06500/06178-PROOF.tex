...
\title{The empirical recurrence for OEIS A197777, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A197777 counts arrays over $\{0,\dots,4\}$ in which every cell is constrained by the
...
OEIS A197777 is ``Number of nX3 0..4 arrays with each element x equal to the number its horizontal and vertical neighbors equal to 3,2,1,1,1 for x=0,1,2,3,4.''. It has offset $1$ and begins
\[
2, 14, 67, 338, 1646, 8085, 39748, 194964,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 07:28:25, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 4\,a(n-2) + 26\,a(n-3) + 58\,a(n-4) + 224\,a(n-5) + 408\,a(n-6) + 355\,a(n-7) - 572\,a(n-8) - 2544\,a(n-9) - 4095\,a(n-10) - 5378\,a(n-11) - 3143\,a(n-12) - 80\,a(n-13) + 6397\,a(n-14) + 7947\,a(n-15) + 5742\,a(n-16) + 6380\,a(n-17) - 5069\,a(n-18) - 7405\,a(n-19) + 2109\,a(n-20) - 9374\,a(n-21) + 209\,a(n-22) + 6536\,a(n-23) - 6126\,a(n-24) + 2689\,a(n-25) - 279\,a(n-26) - 618\,a(n-27) + 1806\,a(n-28) - 64\,a(n-29) + 218\,a(n-30) + 206\,a(n-31) - 46\,a(n-32) + 10\,a(n-33) - 4\,a(n-35)
\end{equation}
for all $n>36$.
...
\#\{\text{neighbours with value }f(x_{t,u})\}=x_{t,u},\quad f=(3,2,1,1,1)
\end{equation}
for every cell $(t,u)$.
...
publishes, $n=22$, the arrays have $3\cdot22$ cells over
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A197777.
