...
\title{The empirical recurrence for OEIS A231379, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A231379 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A231379 is ``Number of nX5 0..1 arrays with no element less than a strict majority of its horizontal and vertical neighbors.''. It has offset $1$ and begins
\[
12, 113, 1519, 17363, 209118, 2547810, 30936914, 375620622,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 06:26:37, revision 6) the statement is
...
the middle row. The vector $w$ was formed by $46$ applications of $G$ in exact integer
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231379.
