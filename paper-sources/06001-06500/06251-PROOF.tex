...
\title{The empirical recurrence for OEIS A183505, proved by transfer matrix}
...
\begin{abstract}
OEIS A183505 counts arrays of width $3$ over $\{0,\dots,3\}$ under a condition on each cell
and its neighbours, and carries an empirical recurrence of order $31$ contributed by
...
OEIS A183505 is ``Number of nX3 0..3 arrays with no element equal to the sum mod 4 of its horizontal and vertical neighbors.''. It has offset $1$ and begins
\[
27, 776, 19683, 531441, 14369472, 387420489, 10460353203, 282432195144,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 01:49:38, revision 9) this is still
...
$27$, which the model reproduces along with every later term. That is the cheapest check
...
first term. There are $4^{3}=64$ possible rows over the entry's own alphabet. The state count $S=4160$ is exactly $64\cdot65$,
...
\begin{theorem}
\[
a(n)\;=\;27\,a(n-1) + 63909\,a(n-6) - 1725543\,a(n-7) - 274577850\,a(n-12) + 7413601950\,a(n-13) - 739973133990\,a(n-18) + 19979274617730\,a(n-19) + 454993983270891\,a(n-24) - 12284837548314057\,a(n-25) + 150094635296999121\,a(n-30) - 4052555153018976267\,a(n-31)
\]
for every $n>31$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A183505.
