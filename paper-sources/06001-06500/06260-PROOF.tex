...
\title{The empirical recurrence for OEIS A303966, proved by transfer matrix}
...
\begin{abstract}
OEIS A303966 counts $5$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A303966 is ``Number of nX5 0..1 arrays with every element unequal to 0, 1, 3 or 5 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
8, 53, 54, 173, 452, 1014, 2247, 5247,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 03 2018 12:54:04, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 3\,a(n-3) - 2\,a(n-4) - 2\,a(n-5) + 7\,a(n-6) - 13\,a(n-7) - 6\,a(n-8) - 11\,a(n-9) + a(n-10) + 2\,a(n-11) - 9\,a(n-12) + 21\,a(n-13) + 15\,a(n-14) + 21\,a(n-15) + 2\,a(n-16) + a(n-18) - 10\,a(n-19) - 9\,a(n-20) - 13\,a(n-21) - a(n-22) + 2\,a(n-24)
\end{equation}
for all $n>35$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A303966.
