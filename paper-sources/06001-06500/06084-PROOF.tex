...
\title{The empirical recurrence for OEIS A250939, proved by transfer matrix}
...
\begin{abstract}
OEIS A250939 counts arrays over $\{0,1,2\}$ in which a statistic taken over short runs
...
window of consecutive rows, so the count is a walk count on $S=729$ states, and the
...
OEIS A250939 is ``Number of (n+1)X(5+1) 0..2 arrays with nondecreasing x(i,j)+x(i,j-1) in the i direction and nondecreasing absolute value of x(i,j)-x(i-1,j) in the j direction.''. It has offset $1$ and begins
\[
8189, 67595, 442409, 2572787, 13550488, 65910564, 300230097, 1294549437,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 12:52:50, revision 6) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The array has $6$ cells across and entries $x(i,j)\in\{0,1,2\}$.
...
So a single row is a state. Let $M$ be the matrix on the $3^{6}=729$ rows with
...
\begin{theorem}
\[
a(n)\;=\;40\,a(n-1) - 766\,a(n-2) + 9350\,a(n-3) - 81710\,a(n-4) + 544382\,a(n-5) - 2874850\,a(n-6) + 12352582\,a(n-7) - 43985920\,a(n-8) + 131537670\,a(n-9) - 333559974\,a(n-10) + 722313210\,a(n-11) - 1342220274\,a(n-12) + 2146926330\,a(n-13) - 2960548470\,a(n-14) + 3519770370\,a(n-15) - 3602697855\,a(n-16) + 3165299610\,a(n-17) - 2375783300\,a(n-18) + 1512910520\,a(n-19) - 809611616\,a(n-20) + 359318080\,a(n-21) - 129863296\,a(n-22) + 37239040\,a(n-23) - 8149760\,a(n-24) + 1278464\,a(n-25) - 128000\,a(n-26) + 6144\,a(n-27)
\]
for every $n>37$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250939.
