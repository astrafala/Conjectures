...
\title{The empirical recurrence for OEIS A207406, proved by transfer matrix}
...
\begin{abstract}
OEIS A207406 counts arrays over $\{0,\dots,1\}$ of width $6$ that avoid the patterns
$(0,0,1), (1,1,0)$ along one axis and $(0,0,1), (0,1,1)$ along the other, and carries an empirical recurrence of
...
OEIS A207406 is ``Number of 6 X n 0..1 arrays avoiding 0 0 1 and 0 1 1 horizontally and 0 0 1 and 1 1 0 vertically.''. It has offset
$1$ and begins
\[
12, 144, 636, 2809, 8692, 26896, 68060,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 13 2026 13:13:07, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207406.
