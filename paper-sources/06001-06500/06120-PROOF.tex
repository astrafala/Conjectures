...
\title{The empirical recurrence for OEIS A207551, proved by transfer matrix}
...
\begin{abstract}
OEIS A207551 counts arrays of width $3$ over $\{0,1,2\}$ containing no occurrence of certain short
...
OEIS A207551 is ``Number of 3Xn 0..2 arrays avoiding the pattern z-2 z-1 z in any row, column, nw-to-se diagonal or ne-to-sw antidiagonal.''. It has offset $1$ and begins
\[
26, 676, 14974, 327518, 7169168, 156957792, 3434478282, 75148438711,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:03:51, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;26\,a(n-1) - 16\,a(n-2) - 1876\,a(n-3) + 4292\,a(n-4) + 30528\,a(n-5) - 63675\,a(n-6) - 102108\,a(n-7) - 7290\,a(n-8) - 8276\,a(n-9) + 1540054\,a(n-10) - 8712728\,a(n-11) + 14630137\,a(n-12) + 66316954\,a(n-13) - 83820630\,a(n-14) - 96411600\,a(n-15) - 100641171\,a(n-16) - 89584866\,a(n-17) + 324694661\,a(n-18) + 23361212\,a(n-19) + 278938916\,a(n-20) + 273589832\,a(n-21) - 134950279\,a(n-22) - 86365344\,a(n-23) + 5316948\,a(n-24) + 71280\,a(n-25)
\]
for every $n>26$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207551.
