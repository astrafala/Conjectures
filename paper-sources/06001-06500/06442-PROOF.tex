...
\title{The empirical recurrence for OEIS A297540, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297540 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A297540 is ``Number of nX4 0..1 arrays with every 1 horizontally, diagonally or antidiagonally adjacent to 2 or 3 neighboring 1s.''. It has offset $1$ and begins
\[
1, 24, 93, 275, 2205, 13248, 67215, 401415,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 31 2017 15:00:51, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) + 6\,a(n-2) + 48\,a(n-3) - 58\,a(n-4) - 327\,a(n-5) - 368\,a(n-6) + 322\,a(n-7) + 1099\,a(n-8) + 949\,a(n-9) + 1014\,a(n-10) + 648\,a(n-11) + 1037\,a(n-12) + 38\,a(n-13) - 301\,a(n-14) - 141\,a(n-15) - 197\,a(n-16) - 151\,a(n-17) - 27\,a(n-18) + 33\,a(n-19) + 32\,a(n-20) + 3\,a(n-21) - 2\,a(n-22)
\end{equation}
for all $n>23$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297540.
