...
\title{The empirical recurrence for OEIS A232156, proved by transfer matrix}
...
\begin{abstract}
OEIS A232156 counts arrays of width $3$ over $\{0,1,2,3\}$ in which every cell carrying one stated
...
OEIS A232156 is ``Number of nX3 0..3 arrays with every 0 next to a 1, every 1 next to a 2 and every 2 next to a 3 horizontally, vertically or antidiagonally, and no adjacent values equal.''. It has offset $1$ and begins
\[
4, 62, 290, 1284, 5902, 27086, 124436, 572080,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 06:55:50, revision 6) this is still
...
adjacency matrix,
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=497.
\]
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-1) - 12\,a(n-2) - 33\,a(n-3) + 40\,a(n-4) + 286\,a(n-5) - 545\,a(n-6) - 642\,a(n-7) + 2651\,a(n-8) - 1783\,a(n-9) - 2378\,a(n-10) + 4407\,a(n-11) - 1301\,a(n-12) - 2857\,a(n-13) + 3373\,a(n-14) + 157\,a(n-15) - 2558\,a(n-16) + 366\,a(n-17) + 1084\,a(n-18) + 818\,a(n-19) - 2988\,a(n-20) - 2028\,a(n-21) + 2529\,a(n-22) + 1294\,a(n-23) + 328\,a(n-24) + 582\,a(n-25) - 122\,a(n-26) - 180\,a(n-27) + 47\,a(n-28) + 21\,a(n-29) - 3\,a(n-30)
\]
for every $n>33$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232156.
