...
\title{The empirical recurrence for OEIS A278090, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A278090 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A278090 is ``Number of nX4 0..1 arrays with every element both equal and not equal to some elements at offset (-1,0) (-1,1) (0,-1) (0,1) or (1,0), with upper left element zero.''. It has offset $1$ and begins
\[
0, 10, 66, 670, 6285, 61123, 588464, 5678912,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 11 2016 20:32:23, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) + 54\,a(n-2) - 103\,a(n-3) - 918\,a(n-4) + 786\,a(n-5) + 8086\,a(n-6) - 4408\,a(n-7) - 45868\,a(n-8) + 24616\,a(n-9) + 183624\,a(n-10) - 117990\,a(n-11) - 530375\,a(n-12) + 343831\,a(n-13) + 1039812\,a(n-14) - 535859\,a(n-15) - 1198564\,a(n-16) + 527719\,a(n-17) + 525705\,a(n-18) - 722698\,a(n-19) + 101062\,a(n-20) + 428138\,a(n-21) - 1021\,a(n-22) + 532091\,a(n-23) + 129197\,a(n-24) - 510311\,a(n-25) - 171880\,a(n-26) - 29549\,a(n-27) + 39422\,a(n-28) + 32189\,a(n-29) + 16319\,a(n-30) - 2030\,a(n-31) - 2334\,a(n-32) + 36\,a(n-33)
\end{equation}
for all $n>35$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A278090.
