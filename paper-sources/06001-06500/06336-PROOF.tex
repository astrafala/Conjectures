...
\title{The empirical recurrence for OEIS A260135, proved by transfer matrix}
...
\begin{abstract}
OEIS A260135 counts $(n+2)\times7$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A260135 is ``Number of (n+2)X(5+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00010101 01010101 or 01010111.''. It has offset $1$ and begins
\[
472, 1626, 7698, 24696, 89000, 365308, 1340176, 4872072,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 12:01:24, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A260135.
