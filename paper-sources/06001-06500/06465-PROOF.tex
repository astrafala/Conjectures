...
\title{The empirical recurrence for OEIS A230465, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A230465 counts arrays over $\{0,\dots,2\}$ in which every cell is constrained by the
...
OEIS A230465 is ``Number of nX4 0..2 arrays x(i,j) with each element horizontally, diagonally or antidiagonally next to at least one element with value (x(i,j)+1) mod 3, and upper left element zero.''. It has offset $1$ and begins
\[
0, 36, 2398, 76518, 2593962, 89087722, 3045192312, 104165339046,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 05:51:14, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;32\,a(n-1) + 80\,a(n-2) + 240\,a(n-3) - 12842\,a(n-4) - 17792\,a(n-5) - 132265\,a(n-6) - 366801\,a(n-7) + 47024\,a(n-8) + 1005370\,a(n-9) - 553477\,a(n-10) + 4561400\,a(n-11) - 1643703\,a(n-12) - 898500\,a(n-13) + 4633908\,a(n-14) - 443679\,a(n-15) - 4633194\,a(n-16) + 715486\,a(n-17) + 824766\,a(n-18) - 483564\,a(n-19) - 38952\,a(n-20) + 33840\,a(n-21)
\end{equation}
for all $n>22$.
...
$3$ values, so there are about $10^{30}$ of them to sift. The
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A230465.
