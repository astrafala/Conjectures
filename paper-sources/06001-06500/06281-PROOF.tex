...
\title{The empirical recurrence for OEIS A234069, proved by transfer matrix}
...
\begin{abstract}
OEIS A234069 counts arrays of width $3$ over $\{0,1,2,3\}$ containing no run of $3$ consecutive
...
OEIS A234069 is ``Number of (1+2)X(n+2) 0..3 arrays with no increasing sequence of length 3 horizontally or diagonally downwards.''. It has offset $1$ and begins
\[
205808, 10268904, 502595832, 24576912260, 1199897571228, 58576345841356, 2859193780644876, 139560139052400248,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 08:20:44, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234069.
