...
\title{The empirical recurrence for OEIS A207805, proved by transfer matrix}
...
\begin{abstract}
OEIS A207805 counts arrays over $\{0,\dots,1\}$ of width $5$ that avoid the patterns
$(0,0,0), (0,0,1)$ along one axis and $(0,1,0), (1,0,1)$ along the other, and carries an empirical recurrence of
order $44$ contributed by R.~H.~Hardin. It is true. The patterns have length $3$, so
...
$\mathbf{1}^{\!\top}P^{\,n-2-44}q(P)\mathbf{1}$, which vanishes identically
...
OEIS A207805 is ``Number of nX5 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 1 0 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
16, 256, 1260, 9040, 57184, 379444, 2472540,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:19:51, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) + 4\,a(n-2) + a(n-3) + 156\,a(n-4) + 450\,a(n-5) + 1534\,a(n-6) + 284\,a(n-7) - 6636\,a(n-8) - 20429\,a(n-9) - 58954\,a(n-10) - 85923\,a(n-11) - 30935\,a(n-12) + 298240\,a(n-13) + 715086\,a(n-14) + 668992\,a(n-15) - 111819\,a(n-16) - 1321603\,a(n-17) - 1450152\,a(n-18) - 1115039\,a(n-19) + 135434\,a(n-20) + 394522\,a(n-21) + 1112524\,a(n-22) + 852540\,a(n-23) + 503094\,a(n-24) - 120123\,a(n-25) - 590386\,a(n-26) - 94045\,a(n-27) - 172107\,a(n-28) + 175024\,a(n-29) - 88826\,a(n-30) - 2748\,a(n-31) + 28009\,a(n-32) - 5237\,a(n-33) + 22780\,a(n-34) - 15137\,a(n-35) + 3224\,a(n-36) + 3094\,a(n-37) - 2442\,a(n-38) + 500\,a(n-39) + 40\,a(n-40) - 87\,a(n-41) + 10\,a(n-42) - a(n-43) - a(n-44)
\end{equation}
for all $n>44$. 
...
$a(n)-\sum_i c_i a(n-i)=u_{\,n-2-44}$ whenever $n-44\ge2$. Hence
\eqref{eq:conj} holds for every $n>t$ exactly when $u_j=0$ for every
$j>t-2-44$. Moreover $(u_j)$ satisfies the monic linear recurrence whose
...
$P^{\,n-2-44}$ gives the identity. The equivalence follows by letting the exponent
...
\begin{proof}
The vector $q(P)\mathbf{1}\in\mathbb{Z}^{S}$ was formed by $44$ matrix--vector
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207805.
