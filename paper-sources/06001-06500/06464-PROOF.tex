...
\title{The empirical recurrence for OEIS A250429, proved by transfer matrix}
...
\begin{abstract}
OEIS A250429 counts arrays over $\{0,1\}$ in which a statistic taken over short runs
...
OEIS A250429 is ``Number of (n+1)X(5+1) 0..1 arrays with nondecreasing sum of every two consecutive values in every row and column.''. It has offset $1$ and begins
\[
256, 1600, 10000, 40000, 160000, 490000, 1500625, 3841600,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 12:24:06, revision 10) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250429.
