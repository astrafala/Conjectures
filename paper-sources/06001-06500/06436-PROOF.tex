...
\title{The empirical recurrence for OEIS A252144, proved by transfer matrix}
...
\begin{abstract}
OEIS A252144 counts $(n+2)\times6$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
$a(n)$ is a walk count on $S=1066339$ vertices. Such a sequence is $C$-finite, so whether a given
...
OEIS A252144 is ``Number of (n+2)X(4+2) 0..3 arrays with every 3X3 subblock row and column sum equal to 0 3 5 6 or 7 and every 3X3 diagonal and antidiagonal sum not equal to 0 3 5 6 or 7.''. It has offset $1$ and begins
\[
8132, 3797, 4416, 5860, 8391, 11662, 17166, 25025,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 10:51:22, revision 6) this is still
...
\[
\text{every row, column sum} \in \{0,3,5,6,7\}\ \text{ and }\ \text{every diagonal, antidiagonal sum} \notin \{0,3,5,6,7\}
\]
...
\begin{theorem}
\[
a(n)\;=\;a(n-2) + 3\,a(n-3) + a(n-4) - 3\,a(n-5) + 4\,a(n-6) - 3\,a(n-7) + 3\,a(n-8) - 15\,a(n-9) - 6\,a(n-11) + 2\,a(n-12) + 3\,a(n-13) - a(n-14) + 9\,a(n-15) - a(n-16) + 9\,a(n-17) - 4\,a(n-18) - 3\,a(n-20) + 3\,a(n-21) - a(n-24)
\]
for every $n>31$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252144.
