...
\title{The empirical recurrence for OEIS A183400, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A183400 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A183400 is ``Half the number of nX4 binary arrays with no element equal to a strict majority of its diagonal and antidiagonal neighbors.''. It has offset $1$ and begins
\[
8, 8, 32, 242, 1152, 6962, 38642, 220448,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 01:40:23, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;7\,a(n-1) + 9\,a(n-2) - 97\,a(n-3) - 120\,a(n-4) + 838\,a(n-5) + 583\,a(n-6) - 4206\,a(n-7) - 624\,a(n-8) + 12123\,a(n-9) - 3315\,a(n-10) - 22752\,a(n-11) + 21049\,a(n-12) + 24140\,a(n-13) - 56478\,a(n-14) - 646\,a(n-15) + 83495\,a(n-16) - 31249\,a(n-17) - 80941\,a(n-18) + 37933\,a(n-19) + 66083\,a(n-20) - 26176\,a(n-21) - 52120\,a(n-22) + 18250\,a(n-23) + 33570\,a(n-24) - 14461\,a(n-25) - 14422\,a(n-26) + 8548\,a(n-27) + 3617\,a(n-28) - 3175\,a(n-29) - 362\,a(n-30) + 704\,a(n-31) - 43\,a(n-32) - 84\,a(n-33) + 12\,a(n-34) + 5\,a(n-35) - a(n-36)
\end{equation}
for all $n>37$.
...
\[
a(n_0+j)-\sum_i c_i\,a(n_0+j-i)\;=\;\tfrac1{2}\,\mathbf{v}^{\!\top}G^{\,j-36}w,
...
Every one of those integers vanishes from the index corresponding to $n=37+1$ onwards,
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A183400.
