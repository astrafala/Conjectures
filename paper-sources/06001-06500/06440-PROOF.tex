...
\title{The empirical recurrence for OEIS A207567, proved by transfer matrix}
...
\begin{abstract}
OEIS A207567 counts arrays over $\{0,\dots,1\}$ of width $6$ that avoid the patterns
...
OEIS A207567 is ``Number of 6Xn 0..1 arrays avoiding 0 0 1 and 0 1 0 horizontally and 0 1 1 and 1 1 0 vertically.''. It has offset
$1$ and begins
\[
22, 484, 1690, 6709, 36426, 138017, 493471,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:05:18, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) - 6\,a(n-2) + 30\,a(n-3) - 117\,a(n-4) + 51\,a(n-5) - 132\,a(n-6) + 648\,a(n-7) + 291\,a(n-8) - 63\,a(n-9) - 1806\,a(n-10) - 1320\,a(n-11) + 45\,a(n-12) + 2859\,a(n-13) + 2046\,a(n-14) + 198\,a(n-15) - 1821\,a(n-16) - 1203\,a(n-17) - 294\,a(n-18) + 480\,a(n-19) + 153\,a(n-20) - 21\,a(n-21) - 78\,a(n-22) + 18\,a(n-23) + 19\,a(n-24) + 19\,a(n-25)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207567.
