...
\title{The empirical recurrence for OEIS A260540, proved by transfer matrix}
...
\begin{abstract}
OEIS A260540 counts $(n+2)\times6$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
every $3\times3$ subblock, and it carries an empirical recurrence of order $27$
...
OEIS A260540 is ``Number of (n+2)X(4+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000001 00000011 or 00010001.''. It has offset $1$ and begins
\[
337, 566, 1411, 2775, 4398, 10949, 22212, 38389,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 12:08:48, revision 6) this is still
...
\[
\text{the clockwise perimeter word of }g\text{ is a rotation of one of }\{00000001,\ 00000011,\ 00010001\}
\]
...
\begin{theorem}
\[
a(n)\;=\;a(n-2) + 7\,a(n-3) + 8\,a(n-4) - 6\,a(n-5) - 19\,a(n-6) - 23\,a(n-7) - 13\,a(n-8) + 32\,a(n-9) + 51\,a(n-10) - 4\,a(n-11) + 13\,a(n-12) - 6\,a(n-13) - 50\,a(n-14) - 28\,a(n-15) - 34\,a(n-16) - 20\,a(n-17) + a(n-18) + 8\,a(n-19) + 23\,a(n-20) - 3\,a(n-21) + 12\,a(n-22) + 10\,a(n-23) - 12\,a(n-24) + 7\,a(n-25) - 2\,a(n-27)
\]
for every $n>31$.
\end{theorem}

\begin{proof}
The vector $w=q(M)\mathbf{1}$ was formed by $27$ matrix--vector products in exact
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A260540.
