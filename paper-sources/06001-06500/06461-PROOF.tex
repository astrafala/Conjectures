...
\title{The empirical recurrence for OEIS A252100, proved by transfer matrix}
...
\begin{abstract}
OEIS A252100 counts $(n+2)\times5$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252100 is ``Number of (n+2)X(3+2) 0..3 arrays with every 3X3 subblock row and column sum equal to 0 3 4 6 or 7 and every 3X3 diagonal and antidiagonal sum not equal to 0 3 4 6 or 7.''. It has offset $1$ and begins
\[
6549, 5087, 10878, 26996, 86550, 252110, 727203, 2385233,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 10:47:26, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;121\,a(n-3) - 5937\,a(n-6) + 154353\,a(n-9) - 2364224\,a(n-12) + 22951313\,a(n-15) - 152709878\,a(n-18) + 752997828\,a(n-21) - 2920990348\,a(n-24) + 9082319607\,a(n-27) - 22187243836\,a(n-30) + 41247616613\,a(n-33) - 56892460471\,a(n-36) + 57041236287\,a(n-39) - 40490200089\,a(n-42) + 19518932902\,a(n-45) - 5986474912\,a(n-48) + 1050763680\,a(n-51) - 87110400\,a(n-54) + 2304000\,a(n-57)
\]
for every $n>62$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252100.
