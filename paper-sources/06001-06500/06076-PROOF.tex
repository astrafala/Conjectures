...
\title{The empirical recurrence for OEIS A207883, proved by transfer matrix}
...
\begin{abstract}
OEIS A207883 counts arrays over $\{0,\dots,1\}$ of width $6$ that avoid the patterns
$(0,0,0), (1,0,1)$ along one axis and $(0,1,1), (1,1,0)$ along the other, and carries an empirical recurrence of
order $32$ contributed by R.~H.~Hardin. It is true. The patterns have length $3$, so
...
$\mathbf{1}^{\!\top}P^{\,n-2-32}q(P)\mathbf{1}$, which vanishes identically
...
OEIS A207883 is ``Number of nX6 0..1 arrays avoiding 0 0 0 and 1 0 1 horizontally and 0 1 1 and 1 1 0 vertically.''. It has offset
$1$ and begins
\[
19, 361, 1095, 3106, 10207, 33631, 119278,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:23:54, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;15\,a(n-1) - 49\,a(n-2) - 321\,a(n-3) + 2264\,a(n-4) + 629\,a(n-5) - 34535\,a(n-6) + 45426\,a(n-7) + 272671\,a(n-8) - 644045\,a(n-9) - 1212652\,a(n-10) + 4445677\,a(n-11) + 2724392\,a(n-12) - 18859001\,a(n-13) + 42422\,a(n-14) + 52859050\,a(n-15) - 19114180\,a(n-16) - 100657622\,a(n-17) + 59907140\,a(n-18) + 131073520\,a(n-19) - 99525328\,a(n-20) - 115653968\,a(n-21) + 102345632\,a(n-22) + 67340656\,a(n-23) - 67025952\,a(n-24) - 24498368\,a(n-25) + 27442176\,a(n-26) + 4950784\,a(n-27) - 6594048\,a(n-28) - 394240\,a(n-29) + 802816\,a(n-30) - 8192\,a(n-31) - 32768\,a(n-32)
\end{equation}
for all $n>33$. 
...
$a(n)-\sum_i c_i a(n-i)=u_{\,n-2-32}$ whenever $n-32\ge2$. Hence
\eqref{eq:conj} holds for every $n>t$ exactly when $u_j=0$ for every
$j>t-2-32$. Moreover $(u_j)$ satisfies the monic linear recurrence whose
...
$P^{\,n-2-32}$ gives the identity. The equivalence follows by letting the exponent
...
\begin{proof}
The vector $q(P)\mathbf{1}\in\mathbb{Z}^{S}$ was formed by $32$ matrix--vector
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207883.
