...
\title{The empirical recurrence for OEIS A189691, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A189691 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A189691 is ``Number of nX4 binary arrays without the pattern 0 0 1 diagonally, vertically or antidiagonally.''. It has offset $1$ and begins
\[
16, 256, 1723, 11637, 65297, 370045, 1999150, 10867960,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 05:23:46, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) + 9\,a(n-2) - 72\,a(n-3) - 15\,a(n-4) + 208\,a(n-5) + 249\,a(n-6) - 365\,a(n-7) - 957\,a(n-8) + 452\,a(n-9) + 841\,a(n-10) + 303\,a(n-11) + 1413\,a(n-12) - 2116\,a(n-13) - 3083\,a(n-14) + 2561\,a(n-15) + 1244\,a(n-16) - 148\,a(n-17) + 1056\,a(n-18) - 2105\,a(n-19) - 508\,a(n-20) + 1674\,a(n-21) - 720\,a(n-22) - 330\,a(n-23) + 592\,a(n-24) - 100\,a(n-25) - 120\,a(n-26) + 32\,a(n-27)
\end{equation}
for all $n>28$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A189691.
