...
\title{The empirical recurrence for OEIS A204405, proved by transfer matrix}
...
\begin{abstract}
OEIS A204405 counts $(n+2)\times7$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
$a(n)$ is a walk count on $S=83418$ vertices. Such a sequence is $C$-finite, so whether a given
...
OEIS A204405 is ``Number of (n+2)X7 0..2 arrays with every 3X3 subblock having three strictly increasing elements in a row horizontally, vertically or nw-to-se diagonally.''. It has offset $1$ and begins
\[
70193731, 518498299, 3226550173, 23029550325, 218058070601, 2236958307511, 24512116048486, 287545807301142,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 11:12:28, revision 9) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204405.
