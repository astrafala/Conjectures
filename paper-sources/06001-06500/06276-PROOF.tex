...
\title{The empirical recurrence for OEIS A207766, proved by transfer matrix}
...
\begin{abstract}
OEIS A207766 counts arrays over $\{0,\dots,1\}$ of width $6$ that avoid the patterns
...
OEIS A207766 is ``Number of 6 X n 0..1 arrays avoiding 0 0 0 and 1 0 1 horizontally and 0 1 1 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
21, 441, 1087, 6459, 21547, 56651, 235872,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 12 2014 17:30:28, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) - 3\,a(n-2) + 47\,a(n-3) - 100\,a(n-4) + 68\,a(n-5) - 729\,a(n-6) + 1351\,a(n-7) - 599\,a(n-8) + 5751\,a(n-9) - 10798\,a(n-10) + 4250\,a(n-11) - 27354\,a(n-12) + 54520\,a(n-13) - 24176\,a(n-14) + 83574\,a(n-15) - 172480\,a(n-16) + 85820\,a(n-17) - 163088\,a(n-18) + 335152\,a(n-19) - 176096\,a(n-20) + 192808\,a(n-21) - 384288\,a(n-22) + 203280\,a(n-23) - 123648\,a(n-24) + 236544\,a(n-25) - 122496\,a(n-26) + 32640\,a(n-27) - 59904\,a(n-28) + 29952\,a(n-29)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207766.
