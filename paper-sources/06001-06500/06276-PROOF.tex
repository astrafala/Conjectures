...
\title{The empirical recurrence for OEIS A202486, proved by transfer matrix}
...
\begin{abstract}
OEIS A202486 counts arrays of width $4$ over $\{0,1\}$ containing no occurrence of certain short
patterns, read along the rows, the columns or the diagonals. The entry carries an empirical
recurrence of order $27$ contributed by R.~H.~Hardin. It is true, and it is decidable
...
OEIS A202486 is ``Number of (n+2)X4 binary arrays avoiding patterns 000 and 010 in rows, columns and nw-to-se diagonals.''. It has offset $1$ and begins
\[
324, 1296, 6084, 28561, 132496, 614656, 2822400, 12960000,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 09:37:33, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) - 10\,a(n-2) + 41\,a(n-3) - 30\,a(n-4) + 78\,a(n-5) + 57\,a(n-6) - 411\,a(n-7) - 57\,a(n-8) + 1050\,a(n-9) - 117\,a(n-10) - 1458\,a(n-11) + 834\,a(n-12) - 1137\,a(n-13) + 453\,a(n-14) - 825\,a(n-15) + 342\,a(n-16) - 513\,a(n-17) + 210\,a(n-18) - 366\,a(n-19) + 87\,a(n-20) + 87\,a(n-21) - 51\,a(n-22) - 6\,a(n-23) + 13\,a(n-24) - 2\,a(n-25) - 2\,a(n-26) + a(n-27)
\]
for every $n>24$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A202486.
