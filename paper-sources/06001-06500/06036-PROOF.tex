...
\title{The empirical recurrence for OEIS A189613, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A189613 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A189613 is ``Number of nX5 binary arrays without the pattern 0 1 0 diagonally, antidiagonally or horizontally.''. It has offset $1$ and begins
\[
21, 441, 5238, 50024, 532565, 6110500, 69943253, 783072552,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 05:21:33, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;16\,a(n-1) - 47\,a(n-2) - 126\,a(n-3) + 2471\,a(n-4) - 25560\,a(n-5) + 55367\,a(n-6) - 83579\,a(n-7) - 124019\,a(n-8) + 7300122\,a(n-9) - 7365184\,a(n-10) - 599459\,a(n-11) - 31727197\,a(n-12) - 754040572\,a(n-13) + 142951670\,a(n-14) + 953676928\,a(n-15) + 1891140440\,a(n-16) + 29553742000\,a(n-17) + 9452004592\,a(n-18) - 65219737520\,a(n-19) - 36827703408\,a(n-20) - 187343367808\,a(n-21) - 114093863744\,a(n-22) + 354967210752\,a(n-23) + 176354022912\,a(n-24) + 450092691456\,a(n-25) + 319703132160\,a(n-26) - 570350149632\,a(n-27) - 92906913792\,a(n-28) + 66527690752\,a(n-29)
\end{equation}
for all $n>30$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A189613.
