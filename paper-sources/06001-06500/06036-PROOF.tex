...
\title{The empirical recurrence for OEIS A274726, proved by counting patterns}
...
\begin{abstract}
OEIS A274726 counts arrays in which no entry may repeat a value found at any of three stated
...
cutting $535538$ pairs to $S=90623$ states. The entry's empirical recurrence of order $30$,
...
OEIS A274726 is ``Number of nX6 0..2 arrays with no element equal to any value at offset (-1,-2) (-2,-1) or (-1,0) and new values introduced in order 0..2.''. It has offset $1$ and begins
\[
122, 1536, 5728, 66132, 771300, 8960464, 105328812, 1237030912,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 03 2016 20:16:01, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 78\,a(n-2) + 250\,a(n-3) + 558\,a(n-4) - 937\,a(n-5) - 4256\,a(n-6) - 7991\,a(n-7) - 3472\,a(n-8) + 31381\,a(n-9) - 11144\,a(n-10) + 42683\,a(n-11) - 198936\,a(n-12) + 231086\,a(n-13) - 131301\,a(n-14) + 70502\,a(n-15) - 27827\,a(n-16) + 159651\,a(n-17) - 217780\,a(n-18) + 120250\,a(n-19) - 55920\,a(n-20) - 17125\,a(n-21) + 26805\,a(n-22) - 25487\,a(n-23) + 30226\,a(n-24) - 15183\,a(n-25) + 5503\,a(n-26) - 1930\,a(n-27) + 371\,a(n-28) - 65\,a(n-29) + 8\,a(n-30)
\end{equation}
for all $n>35$.
...
$o=1n_0+0-2$, we have for $j\ge30$
\[
3!\Bigl(a(n_0+j)-\sum_i c_i\,a(n_0+j-i)\Bigr)
=\mathbf{v}^{\!\top}G^{\,j-30}w,\qquad
w=h_{30}-\sum_i c_i h_{30-i} .
\]
...
the survivors by the pattern of the new pair. The vector $w$ was formed by $30$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A274726.
