...
\title{The empirical recurrence for OEIS A207691, proved by transfer matrix}
...
\begin{abstract}
OEIS A207691 counts arrays over $\{0,\dots,1\}$ of width $6$ that avoid the patterns
$(0,0,0), (0,1,0)$ along one axis and $(0,0,1), (1,1,1)$ along the other, and carries an empirical recurrence of
order $45$ contributed by R.~H.~Hardin. It is true. The patterns have length $3$, so
...
$\mathbf{1}^{\!\top}P^{\,n-2-45}q(P)\mathbf{1}$, which vanishes identically
...
OEIS A207691 is ``Number of nX6 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 0 1 and 1 1 1 vertically.''. It has offset
$1$ and begins
\[
25, 625, 576, 2304, 6084, 15376, 40000,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:10:15, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + a(n-2) + 14\,a(n-3) - 6\,a(n-4) + 33\,a(n-5) - 128\,a(n-6) + 8\,a(n-7) - 228\,a(n-8) + 384\,a(n-9) + 83\,a(n-10) + 439\,a(n-11) - 949\,a(n-12) - 958\,a(n-13) + 282\,a(n-14) + 3103\,a(n-15) + 1779\,a(n-16) - 3073\,a(n-17) - 7347\,a(n-18) - 2028\,a(n-19) + 5069\,a(n-20) + 9884\,a(n-21) + 3661\,a(n-22) - 4410\,a(n-23) - 8135\,a(n-24) - 4196\,a(n-25) + 2169\,a(n-26) + 4570\,a(n-27) + 1924\,a(n-28) + 429\,a(n-29) - 2446\,a(n-30) - 440\,a(n-31) - 701\,a(n-32) + 1325\,a(n-33) + 181\,a(n-34) + 282\,a(n-35) - 491\,a(n-36) - 4\,a(n-37) - 34\,a(n-38) + 103\,a(n-39) - 6\,a(n-40) - 2\,a(n-41) - 15\,a(n-42) + a(n-43) + a(n-45)
\end{equation}
for all $n>47$. 
...
$a(n)-\sum_i c_i a(n-i)=u_{\,n-2-45}$ whenever $n-45\ge2$. Hence
\eqref{eq:conj} holds for every $n>t$ exactly when $u_j=0$ for every
$j>t-2-45$. Moreover $(u_j)$ satisfies the monic linear recurrence whose
...
$P^{\,n-2-45}$ gives the identity. The equivalence follows by letting the exponent
...
\begin{proof}
The vector $q(P)\mathbf{1}\in\mathbb{Z}^{S}$ was formed by $45$ matrix--vector
products in exact integer arithmetic and the $u_j$ evaluated in turn. They vanish from the
index corresponding to $n=47+1$ onwards, and the run was continued past $S$ consecutive
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207691.
