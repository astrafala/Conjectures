...
\title{The empirical recurrence for OEIS A252316, proved by transfer matrix}
...
\begin{abstract}
OEIS A252316 counts $(n+2)\times5$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252316 is ``Number of (n+2)X(3+2) 0..3 arrays with every 3X3 subblock row, column, diagonal and antidiagonal sum not equal to 0 1 3 6 or 7.''. It has offset $1$ and begins
\[
4197, 1918, 2493, 6011, 18820, 62915, 214325, 735703,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:04:21, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-2) + 13\,a(n-3) + 46\,a(n-4) + 89\,a(n-5) + 125\,a(n-6) + 81\,a(n-7) - 32\,a(n-8) - 87\,a(n-9) - 78\,a(n-10) - 9\,a(n-11) + 68\,a(n-12) + 41\,a(n-13) - 53\,a(n-14) - 131\,a(n-15) - 95\,a(n-16) + 24\,a(n-17) + 84\,a(n-18) + 78\,a(n-19) + 8\,a(n-20) - 81\,a(n-21) - 87\,a(n-22) - 36\,a(n-23) + 6\,a(n-24) + 14\,a(n-25) + 8\,a(n-26) + 4\,a(n-27)
\]
for every $n>34$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252316.
