...
\title{The empirical recurrence for OEIS A248995, proved by transfer matrix}
...
\begin{abstract}
OEIS A248995 carries an empirical recurrence of order $37$ contributed by R.~H.~Hardin. It is
...
OEIS A248995 is ``Number of length n+4 0..2 arrays with no five consecutive terms having two times the sum of any three elements equal to three times the sum of the remaining two.''. It has offset $1$ and begins
\[
190, 464, 1140, 2802, 6872, 16800, 41084, 100590,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 11:49:01, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 2\,a(n-2) + 2\,a(n-3) + 2\,a(n-4) + 16\,a(n-5) - 3\,a(n-6) - 27\,a(n-7) - 36\,a(n-8) - 41\,a(n-9) - 73\,a(n-10) - 56\,a(n-11) + 40\,a(n-12) + 103\,a(n-13) + 182\,a(n-14) + 48\,a(n-15) + 102\,a(n-16) + 147\,a(n-17) + 128\,a(n-18) - 82\,a(n-19) + 74\,a(n-20) + 90\,a(n-21) - 137\,a(n-22) - 220\,a(n-23) - 204\,a(n-24) - 4\,a(n-25) - 152\,a(n-26) - 201\,a(n-27) - 183\,a(n-28) + 54\,a(n-29) - 37\,a(n-30) - 48\,a(n-31) + a(n-32) - 31\,a(n-33) - 10\,a(n-34) - 8\,a(n-35) + 24\,a(n-36) + 16\,a(n-37)
\]
for every $n>40$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A248995.
