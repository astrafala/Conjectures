...
\title{The empirical recurrence for OEIS A207562, proved by transfer matrix}
...
\begin{abstract}
OEIS A207562 counts arrays over $\{0,\dots,1\}$ of width $6$ that avoid the patterns
...
OEIS A207562 is ``Number of nX6 0..1 arrays avoiding 0 0 1 and 0 1 0 horizontally and 0 1 1 and 1 1 0 vertically.''. It has offset
$1$ and begins
\[
21, 441, 1889, 6315, 32823, 138017, 738515,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:04:41, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207562.
