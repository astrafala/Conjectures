...
\title{The empirical recurrence for OEIS A297226, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297226 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A297226 is ``Number of 4Xn 0..1 arrays with every 1 horizontally or antidiagonally adjacent to 1 neighboring 1s.''. It has offset $1$ and begins
\[
1, 19, 68, 207, 997, 4210, 16658, 68769,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 27 2017 15:39:30, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-2) + 29\,a(n-3) + 66\,a(n-4) + 121\,a(n-5) + 83\,a(n-6) - a(n-7) - 205\,a(n-8) - 224\,a(n-9) + 30\,a(n-10) + 473\,a(n-11) - 96\,a(n-12) - 289\,a(n-13) - 109\,a(n-14) - 3\,a(n-15) + 126\,a(n-16) + 160\,a(n-17) - 150\,a(n-18) - 112\,a(n-19) + 43\,a(n-20) + 124\,a(n-21) - 53\,a(n-22) + 3\,a(n-23) - 25\,a(n-24) + 6\,a(n-25) - a(n-26) + a(n-27)
\end{equation}
for all $n>28$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297226.
