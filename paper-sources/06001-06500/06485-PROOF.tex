...
\title{The empirical recurrence for OEIS A300807, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A300807 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A300807 is ``Number of nX4 0..1 arrays with every element equal to 0, 1, 2, 3 or 5 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
8, 108, 1004, 9504, 90980, 872495, 8363710, 80174942,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 13 2018 07:52:08, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;9\,a(n-1) + 14\,a(n-2) - 85\,a(n-3) + 32\,a(n-4) + 173\,a(n-5) - 538\,a(n-6) + 239\,a(n-7) - 314\,a(n-8) - 582\,a(n-9) + 2609\,a(n-10) - 6135\,a(n-11) + 4425\,a(n-12) + 6902\,a(n-13) - 11546\,a(n-14) + 11819\,a(n-15) - 2599\,a(n-16) + 5573\,a(n-17) + 2416\,a(n-18) - 3913\,a(n-19) - 7952\,a(n-20) - 4866\,a(n-21) - 3412\,a(n-22) - 9217\,a(n-23) - 2122\,a(n-24) + 464\,a(n-25) + 4111\,a(n-26) + 2278\,a(n-27) + 158\,a(n-28) + 2257\,a(n-29) + 148\,a(n-30) - 1659\,a(n-31) + 32\,a(n-32) + 273\,a(n-33) - 349\,a(n-34) + 47\,a(n-35) + 134\,a(n-36) - 32\,a(n-37) - 20\,a(n-38) + 9\,a(n-39) - a(n-40)
\end{equation}
for all $n>41$.
...
publishes, $n=18$, the arrays have $4\cdot18$ cells over
$2$ values, so there are about $10^{21}$ of them to sift. The
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A300807.
