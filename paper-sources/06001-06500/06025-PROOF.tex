...
\title{The empirical recurrence for OEIS A236015, proved by transfer matrix}
...
\begin{abstract}
OEIS A236015 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
The condition is local to two consecutive rows, so the count is a walk count on $S=18784$
...
OEIS A236015 is ``Number of (n+1)X(5+1) 0..2 arrays colored with the sum of the maximum and minimum values of each 2X2 subblock.''. It has offset $1$ and begins
\[
18784, 41844, 110274, 267424, 805458, 2004428, 5955918, 15032200,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 09:00:44, revision 6) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The $2\times2$ subblocks of an $(n+1)\times6$ array form an
$n\times5$ grid. Colour each of them by $\sigma=a+d$, where $a\le b\le c\le d$ are its four entries sorted --- its minimum, lower median, upper median and maximum. ``Coloured with'' is the entry's way of
...
\]
over the $S=18784$ pairs whose own subblock row is properly coloured.
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-2) + 10\,a(n-4) + 15\,a(n-6) - 314\,a(n-8) - 1389\,a(n-10) + 1365\,a(n-12) + 3415\,a(n-14) + 2472\,a(n-16) + 2424\,a(n-18) + 3384\,a(n-20) - 6192\,a(n-22) + 1152\,a(n-24) - 2304\,a(n-26)
\]
for every $n>29$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A236015.
