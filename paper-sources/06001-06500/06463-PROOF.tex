...
\title{The empirical recurrence for OEIS A318077, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A318077 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A318077 is ``Number of nX3 0..1 arrays with every element unequal to 0, 1, 3 or 5 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
3, 4, 5, 11, 18, 32, 54, 98,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +8*a(n-4) -2*a(n-5) -24*a(n-8) -3*a(n-9) +34*a(n-12) +4*a(n-13) -24*a(n-16) -a(n-17) +8*a(n-20) -a(n-24)
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 15 2018 13:24:57, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 8\,a(n-4) - 2\,a(n-5) - 24\,a(n-8) - 3\,a(n-9) + 34\,a(n-12) + 4\,a(n-13) - 24\,a(n-16) - a(n-17) + 8\,a(n-20) - a(n-24)
\end{equation}
for all $n>25$.
...
\#\{\text{neighbours with a value }different from\ x_{t,u}\}\in\{0,1,3,5\}
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A318077.
