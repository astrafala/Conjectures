...
\title{The empirical recurrence for OEIS A297541, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297541 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
values of its neighbours, and carries an empirical recurrence of order $54$ contributed
...
OEIS A297541 is ``Number of nX5 0..1 arrays with every 1 horizontally, diagonally or antidiagonally adjacent to 2 or 3 neighboring 1s.''. It has offset $1$ and begins
\[
1, 38, 197, 1233, 12161, 94647, 754342, 6315609,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 31 2017 15:01:39, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) + 6\,a(n-2) + 155\,a(n-3) - 320\,a(n-4) - 693\,a(n-5) - 4997\,a(n-6) - 233\,a(n-7) + 18446\,a(n-8) + 54785\,a(n-9) + 74938\,a(n-10) - 96705\,a(n-11) - 141692\,a(n-12) - 577495\,a(n-13) - 381242\,a(n-14) - 61652\,a(n-15) + 137212\,a(n-16) + 2109779\,a(n-17) - 985889\,a(n-18) + 3157081\,a(n-19) - 2697127\,a(n-20) - 1446343\,a(n-21) + 4917847\,a(n-22) - 1617916\,a(n-23) + 9946573\,a(n-24) + 6569073\,a(n-25) + 7562648\,a(n-26) - 5314261\,a(n-27) - 3981456\,a(n-28) - 8541002\,a(n-29) - 14454297\,a(n-30) - 2043588\,a(n-31) + 1756817\,a(n-32) + 3406323\,a(n-33) + 4985432\,a(n-34) + 911966\,a(n-35) - 2187806\,a(n-36) - 1234552\,a(n-37) - 7367402\,a(n-38) + 1222556\,a(n-39) - 5205982\,a(n-40) + 2083486\,a(n-41) - 1209353\,a(n-42) + 1558920\,a(n-43) + 249369\,a(n-44) + 411843\,a(n-45) + 38223\,a(n-46) + 4006\,a(n-47) + 23004\,a(n-48) - 27954\,a(n-49) - 33818\,a(n-50) - 15404\,a(n-51) + 2096\,a(n-52) + 3336\,a(n-53) + 536\,a(n-54)
\end{equation}
for all $n>55$.
...
x_{t,u}=1\ \Rightarrow\ \#\{\text{neighbours equal to }1\}\in\{2,3\}
\end{equation}
for every cell $(t,u)$.
...
publishes, $n=20$, the arrays have $5\cdot20$ cells over
$2$ values, so there are about $10^{30}$ of them to sift. The
...
$o=1n_0+0-2$. Then for $j\ge54$,
\[
a(n_0+j)-\sum_i c_i\,a(n_0+j-i)\;=\;\,\mathbf{v}^{\!\top}G^{\,j-54}w,
\qquad w=h_{54}-\sum_i c_i\,h_{54-i} .
\]
...
\begin{proof}
Substitute Lemma~\ref{lem:walk} and factor $G^{j-54}$ out of
...
the middle row. The vector $w$ was formed by $54$ applications of $G$ in exact integer
...
every one of the $20$ published indices, with no shift fitted: the number of rows is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297541.
