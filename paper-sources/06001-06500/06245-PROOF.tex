...
\title{The empirical recurrence for OEIS A184491, proved by transfer matrix}
...
\begin{abstract}
OEIS A184491 counts $(n+1)\times4$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A184491 is ``Number of (n+1)X4 0..2 arrays with every 2X2 subblock sum greater than 4.''. It has offset $1$ and begins
\[
792, 20514, 421879, 9573698, 209361859, 4649028105, 102612963762, 2270452765634,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 02:42:00, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;14\,a(n-1) + 235\,a(n-2) - 835\,a(n-3) - 9872\,a(n-4) + 18170\,a(n-5) + 157753\,a(n-6) - 198571\,a(n-7) - 1173439\,a(n-8) + 1189558\,a(n-9) + 4436018\,a(n-10) - 3898484\,a(n-11) - 9184174\,a(n-12) + 7095216\,a(n-13) + 11019526\,a(n-14) - 7342318\,a(n-15) - 7892736\,a(n-16) + 4325550\,a(n-17) + 3382616\,a(n-18) - 1396572\,a(n-19) - 837900\,a(n-20) + 220320\,a(n-21) + 107712\,a(n-22) - 12096\,a(n-23) - 5184\,a(n-24)
\end{equation}
for all $n>24$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A184491.
