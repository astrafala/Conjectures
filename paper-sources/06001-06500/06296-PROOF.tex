...
\title{The empirical recurrence for OEIS A250530, proved by transfer matrix}
...
\begin{abstract}
OEIS A250530 counts arrays over $\{0,1,2,3\}$ in which a statistic taken over short runs
...
OEIS A250530 is ``Number of (n+1)X(2+1) 0..3 arrays with nondecreasing max(x(i,j),x(i,j-1)) in the i direction and nondecreasing min(x(i,j),x(i-1,j)) in the j direction.''. It has offset $1$ and begins
\[
700, 6012, 44017, 289035, 1767743, 10248336, 57297797, 311492811,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 12:30:31, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250530.
