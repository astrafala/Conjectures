...
\title{The empirical recurrence for OEIS A205660, proved by transfer matrix}
...
\begin{abstract}
OEIS A205660 counts arrays over $\{0,\dots,3\}$ under a condition on the number of clockwise edge increases
in every $2\times2$ subblock, and carries an empirical recurrence of order $22$ contributed by
R.~H.~Hardin. It is true, and it is decidable rather than empirical. The condition is local to
a bounded window of consecutive rows, so the count is a walk count on $S=2120$ states and is
...
OEIS A205660 is ``Number of 3X(n+1) 0..3 arrays with every 2 X 2 subblock having the same number of clockwise edge increases as its horizontal neighbors and no 2 X 2 subblock having the same number of counterclockwise edge increases as its vertical neighbors.''. It has offset $1$ and begins
\[
2120, 12296, 95008, 839872, 7919128, 76028256, 732727336, 7068433736,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 09 2015 04:20:55, revision 7) this is still
...
\]
on the $S=2120$ admissible pairs.

At $n=1$ the array has two rows, so the grid is a single row of $2$
subblocks; the entry's first term is $2120$, which the model
...
\begin{theorem}
\[
a(n)\;=\;12\,a(n-1) - 7\,a(n-2) - 173\,a(n-3) + 94\,a(n-4) + 1137\,a(n-5) + 190\,a(n-6) - 3906\,a(n-7) - 4350\,a(n-8) + 5407\,a(n-9) + 16999\,a(n-10) + 5544\,a(n-11) - 28150\,a(n-12) - 28396\,a(n-13) + 18360\,a(n-14) + 34596\,a(n-15) - 399\,a(n-16) - 17679\,a(n-17) - 2832\,a(n-18) + 5324\,a(n-19) + 1556\,a(n-20) - 636\,a(n-21) - 240\,a(n-22)
\]
for every $n>26$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A205660.
