...
\title{The empirical recurrence for OEIS A300084, proved by transfer matrix}
...
\begin{abstract}
OEIS A300084 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A300084 is ``Number of nX3 0..1 arrays with every element equal to 0, 1, 3, 5, 6, 7 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
3, 4, 1, 4, 10, 6, 19, 41,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 25 2018 06:16:50, revision
6) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + a(n-2) + 2\,a(n-3) - 10\,a(n-4) + 2\,a(n-5) + 2\,a(n-6) + 2\,a(n-7) - 3\,a(n-8) - 3\,a(n-9) + 12\,a(n-10) - 4\,a(n-11) + 17\,a(n-12) - 3\,a(n-13) - 5\,a(n-14) + a(n-15) - 12\,a(n-16) - 6\,a(n-17) - 2\,a(n-18) - 3\,a(n-19) - a(n-20)
\end{equation}
for all $n>21$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A300084.
