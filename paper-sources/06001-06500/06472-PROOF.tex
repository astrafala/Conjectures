...
\title{The empirical recurrence for OEIS A304130, proved by transfer matrix}
...
\begin{abstract}
OEIS A304130 counts $5$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A304130 is ``Number of nX5 0..1 arrays with every element unequal to 0, 1, 3 or 6 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
8, 31, 33, 80, 176, 320, 582, 1112,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 07 2018 07:57:56, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 8\,a(n-3) - 3\,a(n-4) - 23\,a(n-6) - 4\,a(n-7) - 4\,a(n-8) + 26\,a(n-9) + 19\,a(n-10) + 8\,a(n-11) - 10\,a(n-12) - 19\,a(n-13) - 4\,a(n-14) + 6\,a(n-16)
\end{equation}
for all $n>22$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A304130.
