...
\title{The empirical recurrence for OEIS A207926, proved by transfer matrix}
...
\begin{abstract}
OEIS A207926 counts arrays over $\{0,\dots,1\}$ of width $6$ that avoid the patterns
...
OEIS A207926 is ``Number of n X 6 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 0 0 and 1 1 1 vertically.''. It has offset
$1$ and begins
\[
25, 625, 900, 6084, 30976, 138384, 732736,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 12 2026 11:45:06, revision
11) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 2\,a(n-2) + 152\,a(n-3) - 69\,a(n-4) + 71\,a(n-5) - 7546\,a(n-6) + 722\,a(n-7) - 5058\,a(n-8) + 150792\,a(n-9) + 8524\,a(n-10) + 55962\,a(n-11) - 1450520\,a(n-12) - 222090\,a(n-13) - 207154\,a(n-14) + 7370978\,a(n-15) + 1456071\,a(n-16) + 592939\,a(n-17) - 21038506\,a(n-18) - 4409754\,a(n-19) - 1950603\,a(n-20) + 34994571\,a(n-21) + 6780102\,a(n-22) + 3913498\,a(n-23) - 34648855\,a(n-24) - 5264075\,a(n-25) - 3740202\,a(n-26) + 20686582\,a(n-27) + 2023371\,a(n-28) + 1740765\,a(n-29) - 7313862\,a(n-30) - 294498\,a(n-31) - 352786\,a(n-32) + 1465632\,a(n-33) - 12928\,a(n-34) + 21778\,a(n-35) - 152676\,a(n-36) + 6042\,a(n-37) + 460\,a(n-38) + 7412\,a(n-39) - 219\,a(n-40) - 73\,a(n-41) - 154\,a(n-42) + a(n-44) + a(n-45)
\end{equation}
for all $n>47$. 
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207926.
