...
\title{The empirical recurrence for OEIS A259959, proved by transfer matrix}
...
\begin{abstract}
OEIS A259959 counts $(n+2)\times7$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A259959 is ``Number of (n+2)X(5+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000000 00000001 or 00001001.''. It has offset $1$ and begins
\[
808, 3227, 18681, 95505, 501606, 2680028, 14134043, 74413321,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:57:08, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A259959.
