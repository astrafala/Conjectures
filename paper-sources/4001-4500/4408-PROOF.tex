...
\title{The empirical recurrence for OEIS A297515, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297515 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A297515 is ``Number of nX4 0..1 arrays with every 1 horizontally, diagonally or antidiagonally adjacent to 1 or 3 neighboring 1s.''. It has offset $1$ and begins
\[
4, 33, 128, 624, 3383, 16173, 80436, 406779,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 31 2017 09:51:15, revision 4) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297515.
