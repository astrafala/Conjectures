...
\title{The empirical recurrence for OEIS A185465, proved by transfer matrix}
...
\begin{abstract}
OEIS A185465 counts arrays over $\{0,\dots,1\}$ under a condition on the determinant of every
$2\times2$ subblock, and carries an empirical recurrence of order $40$ contributed by
R.~H.~Hardin. It is true, and it is decidable rather than empirical. The condition is local to
a bounded window of consecutive rows, so the count is a walk count on $S=3238$ states and is
...
OEIS A185465 is ``Number of (n+1)X8 binary arrays with no 2X2 subblock determinant equal to any horizontal or vertical neighbor 2X2 subblock determinant.''. It has offset $1$ and begins
\[
3238, 11050, 83688, 798330, 7232746, 63886624, 560051658, 4901493530,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 02:59:44, revision 8) this is still
...
\]
on the $S=3238$ admissible pairs.
...
entry's first term is $3238$, and the model reproduces it along with every later term; that
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) + 15\,a(n-2) + 110\,a(n-3) + 219\,a(n-4) + 1139\,a(n-5) + 3106\,a(n-6) + 6741\,a(n-7) + 13370\,a(n-8) + 10913\,a(n-9) + 33532\,a(n-10) - 178405\,a(n-11) - 186527\,a(n-12) - 61094\,a(n-13) + 667105\,a(n-14) + 735729\,a(n-15) - 179902\,a(n-16) - 675888\,a(n-17) - 604129\,a(n-18) + 162873\,a(n-19) + 143017\,a(n-20) - 75725\,a(n-21) + 29933\,a(n-22) + 200849\,a(n-23) + 202206\,a(n-24) - 116380\,a(n-25) - 9910\,a(n-26) + 126750\,a(n-27) - 395\,a(n-28) - 69584\,a(n-29) - 60132\,a(n-30) + 15461\,a(n-31) + 15565\,a(n-32) - 8192\,a(n-33) - 2114\,a(n-34) - 296\,a(n-35) + 2516\,a(n-36) + 806\,a(n-37) + 22\,a(n-38) + 8\,a(n-39) + 8\,a(n-40)
\]
for every $n>46$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A185465.
