...
\title{The empirical recurrence for OEIS A299517, proved by transfer matrix}
...
\begin{abstract}
OEIS A299517 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A299517 is ``Number of nX4 0..1 arrays with every element equal to 0, 3, 4, 5, 6 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 2, 5, 8, 41, 117, 476, 1743,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 11 2018 06:13:22, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A299517.
