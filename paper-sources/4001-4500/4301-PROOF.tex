...
\title{The empirical recurrence for OEIS A207028, proved by transfer matrix}
...
\begin{abstract}
OEIS A207028 counts arrays over $\{0,\dots,1\}$ of width $5$ that avoid the patterns
...
OEIS A207028 is ``Number of 5Xn 0..1 arrays avoiding 0 0 0 and 0 1 1 horizontally and 0 0 1 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
10, 100, 270, 1035, 3315, 8280, 23400,\ \dots
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207028.
