...
\title{The empirical recurrence for OEIS A320398, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A320398 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A320398 is ``Number of nX4 0..1 arrays with every element unequal to 0, 1, 2, 3 or 5 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
8, 97, 732, 5956, 46516, 368049, 2908839, 22987303,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 12 2018 12:27:35, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) + 28\,a(n-2) - 24\,a(n-3) - 136\,a(n-4) + 105\,a(n-5) - 107\,a(n-6) - 286\,a(n-7) - 1000\,a(n-8) + 3256\,a(n-9) - 4082\,a(n-10) + 3419\,a(n-11) - 4880\,a(n-12) + 9893\,a(n-13) + 2718\,a(n-14) + 2078\,a(n-15) + 375\,a(n-16) + 9428\,a(n-17) + 6871\,a(n-18) - 13907\,a(n-19) - 47584\,a(n-20) - 33040\,a(n-21) + 3344\,a(n-22) + 35603\,a(n-23) + 39192\,a(n-24) + 3067\,a(n-25) - 15105\,a(n-26) - 15565\,a(n-27) - 3783\,a(n-28) + 6868\,a(n-29) + 3565\,a(n-30) + 414\,a(n-31) - 1909\,a(n-32) - 770\,a(n-33) + 339\,a(n-34) + 213\,a(n-35) + 64\,a(n-36) - 62\,a(n-37) - 13\,a(n-38) + 10\,a(n-39) - a(n-40)
\end{equation}
for all $n>41$.
...
\#\{\text{neighbours with a value }different from\ x_{t,u}\}\in\{0,1,2,3,5\}
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A320398.
