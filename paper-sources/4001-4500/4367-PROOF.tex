...
\title{The empirical recurrence for OEIS A260925, proved by transfer matrix}
...
\begin{abstract}
OEIS A260925 counts $(n+2)\times8$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A260925 is ``Number of (n+2)X(6+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00010101 00101011 or 01010101.''. It has offset $1$ and begins
\[
491, 831, 3358, 10617, 27582, 81848, 253264, 736065,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 12:12:46, revision 6) this is still
...
\[
\text{the clockwise perimeter word of }g\text{ is a rotation of one of }\{00010101,\ 00101011,\ 01010101\}
\]
...
\begin{theorem}
\[
a(n)\;=\;a(n-2) + 54\,a(n-4) + 147\,a(n-6) - 232\,a(n-8) - 760\,a(n-10) + 1201\,a(n-12) + 1735\,a(n-14) - 4951\,a(n-16) + 1746\,a(n-18) + 4365\,a(n-20) - 3877\,a(n-22) - 2176\,a(n-24) + 4748\,a(n-26) - 2239\,a(n-28) + 25\,a(n-30) + 151\,a(n-32) + 117\,a(n-34) - 35\,a(n-36) - 2\,a(n-38) - a(n-40)
\]
for every $n>42$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A260925.
