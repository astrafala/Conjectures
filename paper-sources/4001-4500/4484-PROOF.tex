...
\title{The empirical recurrence for OEIS A252340, proved by transfer matrix}
...
\begin{abstract}
OEIS A252340 counts $(n+2)\times7$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
$a(n)$ is a walk count on $S=22789$ vertices. Such a sequence is $C$-finite, so whether a given
...
OEIS A252340 is ``Number of (n+2)X(5+2) 0..2 arrays with every 3X3 subblock row, column, diagonal and antidiagonal sum not equal to 2 3 or 4.''. It has offset $1$ and begins
\[
1202, 6030, 34894, 184434, 960912, 5095514, 26921266, 142055830,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:06:55, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252340.
