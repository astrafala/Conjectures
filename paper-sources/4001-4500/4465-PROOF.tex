...
\title{The empirical recurrence for OEIS A203104, proved by transfer matrix}
...
\begin{abstract}
OEIS A203104 counts arrays of width $4$ over $\{0,1\}$ under local conditions relating each cell
...
OEIS A203104 is ``Number of nX4 binary arrays with every 1 immediately preceded by 0 0 to the left or above.''. It has offset $1$ and begins
\[
3, 9, 90, 592, 3229, 20459, 130886, 801559,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 10:08:29, revision 9) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=109.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A203104.
