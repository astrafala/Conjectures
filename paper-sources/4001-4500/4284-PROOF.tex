...
\title{The empirical recurrence for OEIS A258539, proved by transfer matrix}
...
\begin{abstract}
OEIS A258539 counts arrays of width $4$ over $\{0,1\}$ in which every $3\times3$ window has
...
so the count is a walk count on $S=273$ states.
\end{abstract}
...
OEIS A258539 is ``Number of (n+2)X(2+2) 0..1 arrays with no 3x3 subblock diagonal sum less than the antidiagonal sum or central row sum equal to the central column sum.''. It has offset $1$ and begins
\[
784, 2916, 8836, 27889, 81796, 241081, 682276, 1915456,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 15:27:49, revision 6) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The array has $4$ cells across, with entries in $\{0,1\}$. A WINDOW is a $3\times3$ block
...
\text{the central row} & \text{must NOT be equal to the sum along the central column} \\
\end{array}
\]
...
\begin{theorem}
\[
a(n)\;=\;10\,a(n-1) - 36\,a(n-2) + 32\,a(n-3) + 154\,a(n-4) - 516\,a(n-5) + 399\,a(n-6) + 996\,a(n-7) - 2600\,a(n-8) + 1304\,a(n-9) + 3204\,a(n-10) - 5192\,a(n-11) + 547\,a(n-12) + 4342\,a(n-13) - 1404\,a(n-14) - 3448\,a(n-15) - 1178\,a(n-16) + 9156\,a(n-17) - 4109\,a(n-18) - 9736\,a(n-19) + 10960\,a(n-20) + 2160\,a(n-21) - 8008\,a(n-22) - 368\,a(n-23) + 5069\,a(n-24) + 2262\,a(n-25) - 7132\,a(n-26) + 688\,a(n-27) + 5958\,a(n-28) - 3388\,a(n-29) - 1987\,a(n-30) + 2276\,a(n-31) + 216\,a(n-32) - 776\,a(n-33) - 124\,a(n-34) + 312\,a(n-35) + 81\,a(n-36) - 150\,a(n-37) - 4\,a(n-38) + 40\,a(n-39) - 6\,a(n-40) - 4\,a(n-41) + a(n-42)
\]
for every $n>44$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A258539.
