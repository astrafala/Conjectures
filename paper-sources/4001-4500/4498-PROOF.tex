...
\title{The empirical recurrence for OEIS A206410, proved by transfer matrix}
...
\begin{abstract}
OEIS A206410 counts arrays over $\{0,\dots,2\}$ under a condition on the perimeter cycle of
every $2\times3$ and $3\times2$ subblock, and carries an empirical recurrence of order $35$ contributed by
R.~H.~Hardin. It is true, and it is decidable rather than empirical. The condition is local to
a bounded window of consecutive rows, so the count is a walk count on $S=15087$ states and is
...
OEIS A206410 is ``Number of (n+1) X 5 0..2 arrays with every 2 X 3 or 3 X 2 subblock having an equal number of clockwise and counterclockwise edge increases.''. It has offset $1$ and begins
\[
15087, 953865, 62351943, 4099250889, 269845754715, 17769571483479, 1170258128101905, 77072446958972853,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 13 2015 01:18:18, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;121\,a(n-1) - 4842\,a(n-2) + 93442\,a(n-3) - 984794\,a(n-4) + 5503671\,a(n-5) - 9072726\,a(n-6) - 78684541\,a(n-7) + 535626405\,a(n-8) - 991587240\,a(n-9) - 2580309619\,a(n-10) + 15747001849\,a(n-11) - 20598090193\,a(n-12) - 41549984245\,a(n-13) + 164996602285\,a(n-14) - 124687904298\,a(n-15) - 276964848873\,a(n-16) + 640627801097\,a(n-17) - 268835295686\,a(n-18) - 615894146346\,a(n-19) + 919184816798\,a(n-20) - 316305834243\,a(n-21) - 338190799906\,a(n-22) + 415103347869\,a(n-23) - 166830909951\,a(n-24) + 1177218958\,a(n-25) + 23150659951\,a(n-26) - 7462678489\,a(n-27) + 119744345\,a(n-28) + 412765357\,a(n-29) - 80434289\,a(n-30) - 308634\,a(n-31) + 1758176\,a(n-32) - 205020\,a(n-33) + 8424\,a(n-34) - 108\,a(n-35)
\]
for every $n>35$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206410.
