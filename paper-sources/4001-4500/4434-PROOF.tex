...
\title{The empirical recurrence for OEIS A295844, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A295844 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
values of its neighbours, and carries an empirical recurrence of order $35$ contributed
...
OEIS A295844 is ``Number of nX5 0..1 arrays with each 1 adjacent to 1 or 2 king-move neighboring 1s.''. It has offset $1$ and begins
\[
12, 261, 2197, 26544, 333366, 3804661, 45214991, 538013975,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 29 2017 06:53:07, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;11\,a(n-1) - 5\,a(n-2) + 300\,a(n-3) - 1643\,a(n-4) + 3417\,a(n-5) - 18172\,a(n-6) + 29603\,a(n-7) - 51257\,a(n-8) + 272523\,a(n-9) - 231977\,a(n-10) + 788764\,a(n-11) - 1381225\,a(n-12) - 732835\,a(n-13) - 1386114\,a(n-14) - 242317\,a(n-15) + 6665186\,a(n-16) - 996047\,a(n-17) - 5648781\,a(n-18) - 1391422\,a(n-19) + 3035557\,a(n-20) - 1545121\,a(n-21) + 7440631\,a(n-22) + 821652\,a(n-23) - 9685076\,a(n-24) + 1807195\,a(n-25) + 1576716\,a(n-26) - 1619373\,a(n-27) + 2387619\,a(n-28) - 243797\,a(n-29) - 34093\,a(n-30) + 253787\,a(n-31) - 60395\,a(n-32) + 22182\,a(n-33) + 4856\,a(n-34) - 600\,a(n-35)
\end{equation}
for all $n>36$.
...
$o=1n_0+0-2$. Then for $j\ge35$,
\[
a(n_0+j)-\sum_i c_i\,a(n_0+j-i)\;=\;\,\mathbf{v}^{\!\top}G^{\,j-35}w,
...
\begin{proof}
Substitute Lemma~\ref{lem:walk} and factor $G^{j-35}$ out of
...
the middle row. The vector $w$ was formed by $35$ applications of $G$ in exact integer
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A295844.
