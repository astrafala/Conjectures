...
\title{The empirical recurrence for OEIS A250497, proved by transfer matrix}
...
\begin{abstract}
OEIS A250497 counts arrays over $\{0,1\}$ in which a statistic taken over short runs
...
OEIS A250497 is ``Number of (n+2)X(1+2) 0..1 arrays with nondecreasing medians of every three consecutive values in every row and column.''. It has offset $1$ and begins
\[
512, 2744, 13824, 68921, 314432, 1367631, 5832000, 24137569,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 12:27:27, revision 6) this is still
...
Fix the statistic $\sigma(v)=\operatorname{med}(v)$ of a run $v$ of $3$ consecutive cells --- in words,
the median of the $3$ values. Two derived arrays are formed and both must be
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-1) - 20\,a(n-2) + 44\,a(n-3) - 190\,a(n-4) + 292\,a(n-5) - 242\,a(n-6) + 1552\,a(n-7) - 933\,a(n-8) - 728\,a(n-9) - 7846\,a(n-10) - 2828\,a(n-11) + 2191\,a(n-12) + 22952\,a(n-13) + 13106\,a(n-14) - 556\,a(n-15) - 37208\,a(n-16) - 18168\,a(n-17) + 6972\,a(n-18) + 33492\,a(n-19) - 4164\,a(n-20) - 5916\,a(n-21) - 10326\,a(n-22) + 9744\,a(n-23) - 1676\,a(n-24) + 5224\,a(n-25) - 6310\,a(n-26) + 2776\,a(n-27) - 2345\,a(n-28) + 2396\,a(n-29) - 1876\,a(n-30) + 1244\,a(n-31) - 1086\,a(n-32) + 704\,a(n-33) - 410\,a(n-34) + 212\,a(n-35) - 109\,a(n-36) + 40\,a(n-37) - 14\,a(n-38) + 4\,a(n-39) - a(n-40)
\]
for every $n>40$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250497.
