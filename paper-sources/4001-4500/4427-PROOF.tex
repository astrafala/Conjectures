...
\title{The empirical recurrence for OEIS A207115, proved by transfer matrix}
...
\begin{abstract}
OEIS A207115 counts arrays over $\{0,\dots,1\}$ of width $6$ that avoid the patterns
...
OEIS A207115 is ``Number of 6Xn 0..1 arrays avoiding 0 0 0 and 0 1 1 horizontally and 0 0 1 and 1 1 0 vertically.''. It has offset
$1$ and begins
\[
12, 144, 556, 2239, 7837, 22714, 68737,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 13:29:36, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 11\,a(n-2) + 2\,a(n-3) - 65\,a(n-4) - 54\,a(n-5) + 189\,a(n-6) + 289\,a(n-7) - 247\,a(n-8) - 717\,a(n-9) - 70\,a(n-10) + 833\,a(n-11) + 558\,a(n-12) - 116\,a(n-13) - 140\,a(n-14) - 566\,a(n-15) - 1355\,a(n-16) - 342\,a(n-17) + 1914\,a(n-18) + 1998\,a(n-19) - 313\,a(n-20) - 1832\,a(n-21) - 1300\,a(n-22) - 34\,a(n-23) + 883\,a(n-24) + 1032\,a(n-25) + 316\,a(n-26) - 492\,a(n-27) - 565\,a(n-28) - 131\,a(n-29) + 159\,a(n-30) + 164\,a(n-31) + 64\,a(n-32) - 24\,a(n-33) - 47\,a(n-34) - 17\,a(n-35) + 9\,a(n-36) + 7\,a(n-37) - a(n-39)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207115.
