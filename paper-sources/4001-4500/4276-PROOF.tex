...
\title{The empirical recurrence for OEIS A228759, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A228759 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A228759 is ``Number of 7Xn binary arrays with top left element equal to 1 and no two ones adjacent horizontally or antidiagonally.''. It has offset $1$ and begins
\[
64, 377, 13386, 182288, 3990739, 67970044, 1316714732, 23857469157,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 04 2025 00:07:26, revision 9) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A228759.
