...
\title{The empirical recurrence for OEIS A297812, proved by transfer matrix}
...
\begin{abstract}
OEIS A297812 counts $6$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A297812 is ``Number of nX6 0..1 arrays with every element equal to 2 or 3 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
0, 5, 2, 27, 41, 83, 114, 275,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 06 2018 10:28:33, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297812.
