...
\title{The empirical recurrence for OEIS A203332, proved by transfer matrix}
...
\begin{abstract}
OEIS A203332 counts $n\times2$ arrays over $\{0,\dots,5\}$ subject to a condition imposed on
...
walk, and $a(n)$ is a walk count on $S=292$ vertices, which is $C$-finite. Whether the
...
OEIS A203332 is ``Number of nX2 0..5 arrays with every nonzero element less than or equal to at least two horizontal and vertical neighbors.''. It has offset $1$ and begins
\[
1, 6, 36, 161, 846, 5545, 35483, 216488,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 10:19:47, revision 9) this is still
...
$\{0,\dots,5\}^{2}$. The neighbourhood of a cell in row $u_i$ meets $u_{i-1}$,
$u_i$ and $u_{i+1}$ and nothing else. Take as vertices the pairs
$(r,s)\in(\{0,\dots,5\}^{2}\cup\{\varnothing\})\times\{0,\dots,5\}^{2}$,
...
\begin{theorem}
\[
a(n)\;=\;21\,a(n-1) - 195\,a(n-2) + 1175\,a(n-3) - 5545\,a(n-4) + 21045\,a(n-5) - 64898\,a(n-6) + 173439\,a(n-7) - 400482\,a(n-8) + 801950\,a(n-9) - 1477586\,a(n-10) + 2342826\,a(n-11) - 3466079\,a(n-12) + 4698867\,a(n-13) - 5265061\,a(n-14) + 6840484\,a(n-15) - 5130611\,a(n-16) + 7218027\,a(n-17) - 3378370\,a(n-18) + 4680079\,a(n-19) - 2705514\,a(n-20) - 157208\,a(n-21) - 4245554\,a(n-22) - 4490128\,a(n-23) - 5765472\,a(n-24) - 5764538\,a(n-25) - 5166552\,a(n-26) - 4254715\,a(n-27) - 3098347\,a(n-28) - 2091098\,a(n-29) - 1271422\,a(n-30) - 706430\,a(n-31) - 357345\,a(n-32) - 162833\,a(n-33) - 67173\,a(n-34) - 24634\,a(n-35) - 7967\,a(n-36) - 2242\,a(n-37) - 526\,a(n-38) - 100\,a(n-39) - 14\,a(n-40) - a(n-41)
\]
for every $n>41$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A203332.
