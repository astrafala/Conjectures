...
\title{The empirical recurrence for OEIS A207245, proved by transfer matrix}
...
\begin{abstract}
OEIS A207245 counts arrays over $\{0,\dots,1\}$ of width $5$ that avoid the patterns
$(0,0,1), (0,1,0)$ along one axis and $(0,0,0), (0,1,1)$ along the other, and carries an empirical recurrence of
...
OEIS A207245 is ``Number of 5Xn 0..1 arrays avoiding 0 0 0 and 0 1 1 horizontally and 0 0 1 and 0 1 0 vertically.''. It has offset
$1$ and begins
\[
14, 196, 882, 3866, 13876, 40838, 122197,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 13:40:33, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) - 4\,a(n-2) - 31\,a(n-3) + 13\,a(n-4) + 163\,a(n-5) - 55\,a(n-6) - 486\,a(n-7) - 4\,a(n-8) + 1085\,a(n-9) + 240\,a(n-10) - 1523\,a(n-11) - 496\,a(n-12) + 1195\,a(n-13) + 75\,a(n-14) - 489\,a(n-15) + 1746\,a(n-16) - 146\,a(n-17) - 2825\,a(n-18) - 472\,a(n-19) + 2969\,a(n-20) - 441\,a(n-21) - 906\,a(n-22) + 1032\,a(n-23) + 214\,a(n-24) - 2032\,a(n-25) + 630\,a(n-26) + 1340\,a(n-27) - 749\,a(n-28) - 334\,a(n-29) + 486\,a(n-30) - 21\,a(n-31) - 703\,a(n-32) + 657\,a(n-33) - 63\,a(n-34) - 2\,a(n-35) - 178\,a(n-36) + 283\,a(n-37) - 262\,a(n-38) + 99\,a(n-39) - 38\,a(n-40) + 57\,a(n-41) - 61\,a(n-42) + 49\,a(n-43) - 20\,a(n-44) + 6\,a(n-45) - 5\,a(n-46) + 4\,a(n-47) - 3\,a(n-48) + a(n-49)
\end{equation}
for all $n>49$. The entry's array has a fixed number of rows and a growing number of
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207245.
