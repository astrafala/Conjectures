...
\title{The empirical recurrence for OEIS A298663, proved by transfer matrix}
...
\begin{abstract}
OEIS A298663 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A298663 is ``Number of nX4 0..1 arrays with every element equal to 0, 3, 4, 6 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 1, 1, 2, 2, 9, 13, 26,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 24 2018 10:26:06, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A298663.
