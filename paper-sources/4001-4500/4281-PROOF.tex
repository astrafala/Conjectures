...
\title{The empirical recurrence for OEIS A252683, proved by transfer matrix}
...
\begin{abstract}
OEIS A252683 counts $6\times(n+2)$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
$a(n)$ is a walk count on $S=277858$ vertices. Such a sequence is $C$-finite, so whether a given
...
OEIS A252683 is ``Number of (4+2)X(n+2) 0..3 arrays with every 3X3 subblock row and diagonal sum equal to 0 2 5 6 or 7 and every 3X3 column and antidiagonal sum not equal to 0 2 5 6 or 7.''. It has offset $1$ and begins
\[
1010, 1677, 4298, 7747, 26744, 78851, 147462, 519311,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:31:38, revision 6) this is still
...
\[
\text{every row, diagonal sum} \in \{0,2,5,6,7\}\ \text{ and }\ \text{every column, antidiagonal sum} \notin \{0,2,5,6,7\}
\]
...
\begin{theorem}
\[
a(n)\;=\;45\,a(n-3) - 591\,a(n-6) + 1616\,a(n-9) + 5316\,a(n-12) - 24526\,a(n-15) + 2476\,a(n-18) + 88284\,a(n-21) - 67519\,a(n-24) - 126947\,a(n-27) + 143243\,a(n-30) + 52204\,a(n-33) - 73468\,a(n-36) - 2196\,a(n-39) + 2064\,a(n-42)
\]
for every $n>46$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252683.
