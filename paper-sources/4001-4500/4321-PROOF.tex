...
\title{The empirical recurrence for OEIS A237406, proved by transfer matrix}
...
\begin{abstract}
OEIS A237406 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
The condition is local to two consecutive rows, so the count is a walk count on $S=322$
...
OEIS A237406 is ``Number of (n+1) X (2+1) 0..2 arrays with the maximum plus the upper median plus the minimum of every 2 X 2 subblock differing from its horizontal and vertical neighbors by exactly one.''. It has offset $1$ and begins
\[
322, 1632, 8236, 44186, 238640, 1260486, 6627450, 35198148,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 07 2014 19:18:42, revision 8) this is still
...
differ by $1$. The entry's first term $322$ counts those, and the model was made to
...
\]
over the $S=322$ pairs whose own subblock row already satisfies the condition along itself.
...
\begin{theorem}
\[
a(n)\;=\;35\,a(n-3) + 422\,a(n-4) + 861\,a(n-5) + 1775\,a(n-6) + 703\,a(n-7) - 24448\,a(n-8) - 61622\,a(n-9) - 68118\,a(n-10) + 25946\,a(n-11) + 456293\,a(n-12) + 865728\,a(n-13) + 610758\,a(n-14) - 676767\,a(n-15) - 3048586\,a(n-16) - 3041167\,a(n-17) - 326886\,a(n-18) + 2509173\,a(n-19) + 5909549\,a(n-20) + 3426904\,a(n-21) - 1802161\,a(n-22) - 2482842\,a(n-23) - 2687207\,a(n-24) - 458763\,a(n-25) + 1972154\,a(n-26) + 1952715\,a(n-27) + 779599\,a(n-28) - 268828\,a(n-29) - 154455\,a(n-30) - 76262\,a(n-31) + 51183\,a(n-32) - 16342\,a(n-33) + 5863\,a(n-34) - 1640\,a(n-35) + 614\,a(n-36) + 64\,a(n-37)
\]
for every $n>37$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237406.
