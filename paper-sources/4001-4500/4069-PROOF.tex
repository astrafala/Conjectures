...
\title{The empirical recurrence for OEIS A296125, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A296125 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A296125 is ``Number of nX5 0..1 arrays with each 1 adjacent to 2 or 5 king-move neighboring 1s.''. It has offset $1$ and begins
\[
1, 33, 107, 287, 2098, 9344, 35733, 182881,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 05 2017 06:46:14, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;7\,a(n-1) - 10\,a(n-2) + 50\,a(n-3) - 343\,a(n-4) + 344\,a(n-5) - 618\,a(n-6) + 6047\,a(n-7) - 5744\,a(n-8) + 4077\,a(n-9) - 57564\,a(n-10) + 55295\,a(n-11) - 21106\,a(n-12) + 335248\,a(n-13) - 318626\,a(n-14) + 84293\,a(n-15) - 1236170\,a(n-16) + 1106930\,a(n-17) - 187162\,a(n-18) + 2867721\,a(n-19) - 2269772\,a(n-20) + 74097\,a(n-21) - 4021798\,a(n-22) + 2511232\,a(n-23) + 527543\,a(n-24) + 3090935\,a(n-25) - 1014833\,a(n-26) - 1021724\,a(n-27) - 995912\,a(n-28) - 447310\,a(n-29) + 634272\,a(n-30) + 10000\,a(n-31) + 371548\,a(n-32) - 67104\,a(n-33) + 3168\,a(n-34) + 12608\,a(n-35) - 3840\,a(n-36) - 8560\,a(n-37) + 128\,a(n-38) + 256\,a(n-39)
\end{equation}
for all $n>40$.
...
x_{t,u}=1\ \Rightarrow\ \#\{\text{neighbours equal to }1\}\in\{2,5\}
\end{equation}
for every cell $(t,u)$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A296125.
