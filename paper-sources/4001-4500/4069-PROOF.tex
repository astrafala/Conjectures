...
\title{The empirical recurrence for OEIS A258543, proved by transfer matrix}
...
\begin{abstract}
OEIS A258543 counts arrays of width $8$ over $\{0,1\}$ in which every $3\times3$ window has
...
OEIS A258543 is ``Number of (n+2)X(6+2) 0..1 arrays with no 3x3 subblock diagonal sum less than the antidiagonal sum or central row sum equal to the central column sum.''. It has offset $1$ and begins
\[
77284, 241081, 381924, 996004, 1784896, 4359744, 8773444, 21372129,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 15:28:13, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A258543.
