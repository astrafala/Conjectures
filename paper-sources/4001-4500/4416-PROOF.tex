...
\title{The empirical recurrence for OEIS A259521, proved by transfer matrix}
...
\begin{abstract}
OEIS A259521 counts arrays of width $6$ over $\{0,1\}$ subject to a condition read round the
...
OEIS A259521 is ``Number of (n+1)X(5+1) 0..1 arrays with each 2X2 subblock having clockwise pattern 0000 0001 0011 0101 or 1111.''. It has offset $1$ and begins
\[
1204, 33162, 851604, 22453286, 589476522, 15503669216, 407656116320, 10720344908210,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:52:52, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A259521.
