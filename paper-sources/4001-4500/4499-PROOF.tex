...
\title{The empirical recurrence for OEIS A253745, proved by transfer matrix}
...
\begin{abstract}
OEIS A253745 counts the arrays over $\{0,\dots,2\}$ whose $2\times2$ subblocks carry a
...
so a pair of consecutive array rows is a state, the count is a walk count on $S=7803$ of them,
...
OEIS A253745 is ``Number of (n+1)X(4+1) 0..2 arrays with every 2X2 subblock ne-sw antidiagonal difference nondecreasing horizontally and nw+se diagonal sum nondecreasing vertically.''. It has offset $1$ and begins
\[
7803, 29737, 247252, 1143174, 5195288, 17656505, 54890203, 150904540,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 14:12:25, revision 6) this is still
...
\]
on the $S=7803$ admissible pairs. In particular $a$ is $C$-finite. The alignment of the walk
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-1) - 21\,a(n-2) + 36\,a(n-3) - 34\,a(n-4) - 11\,a(n-5) + 107\,a(n-6) - 199\,a(n-7) + 198\,a(n-8) - 46\,a(n-9) - 232\,a(n-10) + 461\,a(n-11) - 440\,a(n-12) + 141\,a(n-13) + 295\,a(n-14) - 581\,a(n-15) + 490\,a(n-16) - 120\,a(n-17) - 270\,a(n-18) + 435\,a(n-19) - 274\,a(n-20) - 17\,a(n-21) + 201\,a(n-22) - 201\,a(n-23) + 54\,a(n-24) + 86\,a(n-25) - 112\,a(n-26) + 59\,a(n-27) + 12\,a(n-28) - 49\,a(n-29) + 37\,a(n-30) - 11\,a(n-31) - 5\,a(n-32) + 9\,a(n-33) - 5\,a(n-34) + a(n-35)
\]
for every $n>47$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253745.
