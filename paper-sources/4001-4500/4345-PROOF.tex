...
\title{The empirical recurrence for OEIS A188690, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A188690 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A188690 is ``Number of nX4 binary arrays without the pattern 0 1 0 diagonally, vertically, antidiagonally or horizontally.''. It has offset $1$ and begins
\[
12, 144, 857, 4008, 20662, 120839, 708519, 3984317,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 04:46:33, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;8\,a(n-1) - 20\,a(n-2) + 38\,a(n-3) + 44\,a(n-4) - 252\,a(n-5) - 94\,a(n-6) - 173\,a(n-7) + 417\,a(n-8) + 2548\,a(n-9) - 384\,a(n-10) + 1193\,a(n-11) - 4772\,a(n-12) - 6984\,a(n-13) + 6677\,a(n-14) - 10923\,a(n-15) + 16477\,a(n-16) + 4376\,a(n-17) - 6808\,a(n-18) + 1546\,a(n-19) - 4577\,a(n-20) + 1179\,a(n-21) + 3261\,a(n-22) - 1466\,a(n-23) - 63\,a(n-24) + 121\,a(n-25) - 246\,a(n-26) + 361\,a(n-27) - 334\,a(n-28) - 3\,a(n-29) + 149\,a(n-30) - 66\,a(n-31) + 4\,a(n-32) + 2\,a(n-33)
\end{equation}
for all $n>34$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A188690.
