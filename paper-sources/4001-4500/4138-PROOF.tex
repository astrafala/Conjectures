...
\title{The empirical recurrence for OEIS A300685, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A300685 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A300685 is ``Number of nX4 0..1 arrays with every element equal to 1, 2, 3 or 6 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
2, 30, 272, 2229, 18225, 150558, 1242620, 10252421,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 11 2018 08:48:40, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;9\,a(n-1) + 2\,a(n-2) - 67\,a(n-3) - 36\,a(n-4) + 254\,a(n-5) + 142\,a(n-6) - 334\,a(n-7) - 580\,a(n-8) - 250\,a(n-9) + 685\,a(n-10) + 1955\,a(n-11) + 908\,a(n-12) - 6774\,a(n-13) - 884\,a(n-14) + 21117\,a(n-15) - 3461\,a(n-16) - 41108\,a(n-17) + 344\,a(n-18) + 78230\,a(n-19) + 46859\,a(n-20) - 80680\,a(n-21) - 54337\,a(n-22) + 64685\,a(n-23) - 9411\,a(n-24) - 50611\,a(n-25) + 75723\,a(n-26) + 35614\,a(n-27) - 86921\,a(n-28) - 74180\,a(n-29) - 62395\,a(n-30) - 58582\,a(n-31) - 8539\,a(n-32) + 14149\,a(n-33) + 8353\,a(n-34) + 8215\,a(n-35) + 8235\,a(n-36) + 2955\,a(n-37) - 1996\,a(n-38) - 1572\,a(n-39) - 316\,a(n-40) - 97\,a(n-41) + 176\,a(n-42) + 69\,a(n-43) - 18\,a(n-44) - 2\,a(n-45) - 4\,a(n-46) + a(n-47)
\end{equation}
for all $n>49$.
...
\#\{\text{neighbours with a value }equal to\ x_{t,u}\}\in\{1,2,3,6\}
\end{equation}
...
the middle row. The vector $w$ was formed by $47$ applications of $G$ in exact integer
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A300685.
