...
\title{A condition on each element and its neighbours: OEIS A296595}
...
\begin{abstract}
OEIS A296595 carries an empirical recurrence of order $44$ contributed by R.~H.~Hardin. It is
...
OEIS A296595 is ``Number of n X 4 0..1 arrays with each 1 horizontally, vertically or antidiagonally adjacent to 1, 2 or 3 neighboring 1's.''. It has offset $1$ and begins
\[
7, 136, 1441, 16524, 194743, 2271055, 26487173, 309059200,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 12 2026 15:38:15, revision 6) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{The count is a walk count}

The entry counts arrays with $4$ columns over the alphabet $\{0,1\}$, growing one row at a time. Its condition is that every entry equal to $1$ must have exactly $1$, $2$ or $3$ of its horizontal and vertical and antidiagonal neighbours equal to $1$.
...
Vertices with identical futures are merged, which leaves $S=60$. An admissible array is exactly a walk, so with $M$ the adjacency matrix and $\iota,\tau$ the vectors recording which states may begin and end an array,
\[
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-1) + 26\,a(n-2) + 168\,a(n-3) + 247\,a(n-4) + 901\,a(n-5) + 146\,a(n-6) + 2230\,a(n-7) - 5046\,a(n-8) - 13683\,a(n-9) + 34114\,a(n-10) - 28566\,a(n-11) - 101067\,a(n-12) + 178744\,a(n-13) + 58416\,a(n-14) - 360931\,a(n-15) + 145098\,a(n-16) + 371598\,a(n-17) - 252966\,a(n-18) - 191251\,a(n-19) + 198012\,a(n-20) + 122010\,a(n-21) - 53967\,a(n-22) - 82652\,a(n-23) - 15645\,a(n-24) + 19759\,a(n-25) + 23703\,a(n-26) + 15676\,a(n-27) - 3224\,a(n-28) - 7147\,a(n-29) + 250\,a(n-30) + 849\,a(n-31) - 3219\,a(n-32) + 897\,a(n-33) - 231\,a(n-34) + 514\,a(n-35) + 640\,a(n-36) + 24\,a(n-37) + 6\,a(n-38) - 92\,a(n-39) - 92\,a(n-40) - 67\,a(n-41) - 38\,a(n-42) - 15\,a(n-43) - 4\,a(n-44)
\]
for every $n>44$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A296595.
