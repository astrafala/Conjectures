...
\title{The empirical recurrence for OEIS A300939, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A300939 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A300939 is ``Number of nX3 0..1 arrays with every element equal to 0, 1, 3, 4 or 6 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
3, 2, 5, 12, 19, 47, 101, 206,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 16 2018 09:03:43, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 3\,a(n-2) - 5\,a(n-3) - 2\,a(n-4) - 3\,a(n-5) - a(n-6) + 22\,a(n-7) + 7\,a(n-8) - 33\,a(n-9) - 28\,a(n-10) + 11\,a(n-11) + 50\,a(n-12) + 40\,a(n-13) - 50\,a(n-14) - 82\,a(n-15) + 3\,a(n-16) + 96\,a(n-17) + 79\,a(n-18) - 49\,a(n-19) - 85\,a(n-20) - 9\,a(n-21) + 46\,a(n-22) + 55\,a(n-23) + 17\,a(n-24) - 28\,a(n-25) - 31\,a(n-26) - 11\,a(n-27) + a(n-28) + 5\,a(n-29) + 4\,a(n-30) + a(n-31)
\end{equation}
for all $n>32$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A300939.
