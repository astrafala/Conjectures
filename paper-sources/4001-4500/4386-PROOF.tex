...
\title{The empirical recurrence for OEIS A205949, proved by transfer matrix}
...
\begin{abstract}
OEIS A205949 counts arrays of width $3$ over $\{0,1,2,3\}$ subject to a condition read round the
...
count is a walk count on a finite digraph with $S=389$ vertices, and whether a linear
...
OEIS A205949 is ``Number of (n+1) X 3 0..3 arrays with no 2 X 2 subblock having the same number of clockwise edge increases as its horizontal neighbors or the same number of counterclockwise edge increases as its vertical neighbors.''. It has offset $1$ and begins
\[
2120, 25512, 310912, 3825072, 47118720, 583496376, 7243545064, 90103381160,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 10 2015 02:03:21, revision 7) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=389,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A205949.
