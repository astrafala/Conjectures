...
\title{The empirical recurrence for OEIS A252328, proved by transfer matrix}
...
\begin{abstract}
OEIS A252328 counts $(n+2)\times4$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
every $3\times3$ subblock, and it carries an empirical recurrence of order $38$
...
OEIS A252328 is ``Number of (n+2)X(2+2) 0..3 arrays with every 3X3 subblock row and column sum equal to 0 3 5 6 or 8 and every 3X3 diagonal and antidiagonal sum not equal to 0 3 5 6 or 8.''. It has offset $1$ and begins
\[
4006, 5716, 6222, 9142, 19540, 40178, 89296, 225890,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:05:43, revision 6) this is still
...
\[
\text{every row, column sum} \in \{0,3,5,6,8\}\ \text{ and }\ \text{every diagonal, antidiagonal sum} \notin \{0,3,5,6,8\}
\]
...
\begin{theorem}
\[
a(n)\;=\;32\,a(n-3) - 387\,a(n-6) + 2471\,a(n-9) + 36\,a(n-11) - 9991\,a(n-12) - 608\,a(n-14) + 28435\,a(n-15) + 3864\,a(n-17) - 57755\,a(n-18) - 12220\,a(n-20) + 80353\,a(n-21) + 21492\,a(n-23) - 72696\,a(n-24) - 21936\,a(n-26) + 40261\,a(n-27) + 12888\,a(n-29) - 12434\,a(n-30) - 4084\,a(n-32) + 1808\,a(n-33) + 600\,a(n-35) - 96\,a(n-36) - 32\,a(n-38)
\]
for every $n>42$.
\end{theorem}

\begin{proof}
The vector $w=q(M)\mathbf{1}$ was formed by $38$ matrix--vector products in exact
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252328.
