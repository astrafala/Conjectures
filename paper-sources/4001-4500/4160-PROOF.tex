...
\title{The empirical recurrence for OEIS A318346, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A318346 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A318346 is ``Number of nX4 0..1 arrays with every element unequal to 0, 1, 3 or 6 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
5, 7, 13, 14, 29, 55, 106, 220,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 24 2018 11:09:58, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 2\,a(n-3) + 2\,a(n-4) + 5\,a(n-5) + 4\,a(n-7) + 3\,a(n-8) + a(n-9) - 9\,a(n-10) - 11\,a(n-11) - 41\,a(n-12) - 29\,a(n-13) - 52\,a(n-14) + 4\,a(n-15) + 7\,a(n-16) + 37\,a(n-17) + 13\,a(n-18) + 28\,a(n-19) + 32\,a(n-20) - 4\,a(n-21) + 39\,a(n-22) + 8\,a(n-23) + 6\,a(n-24) + 37\,a(n-25) - 23\,a(n-26) - 3\,a(n-27) - 20\,a(n-28) - 24\,a(n-29) - 12\,a(n-30) - 8\,a(n-31) - 4\,a(n-32) + 4\,a(n-33) + 8\,a(n-35) - 4\,a(n-36) + 4\,a(n-37)
\end{equation}
for all $n>45$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A318346.
