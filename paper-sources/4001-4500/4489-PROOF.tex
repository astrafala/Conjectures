...
\title{The empirical recurrence for OEIS A260762, proved by transfer matrix}
...
\begin{abstract}
OEIS A260762 counts $(n+2)\times5$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A260762 is ``Number of (n+2)X(3+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000001 00000011 or 00010011.''. It has offset $1$ and begins
\[
190, 265, 652, 1234, 1740, 3891, 8056, 12829,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 12:10:34, revision 6) this is still
...
\[
\text{the clockwise perimeter word of }g\text{ is a rotation of one of }\{00000001,\ 00000011,\ 00010011\}
\]
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-3) + 9\,a(n-4) + 2\,a(n-5) - 20\,a(n-6) - 48\,a(n-7) - 45\,a(n-8) + 10\,a(n-9) + 76\,a(n-10) + 140\,a(n-11) + 104\,a(n-12) - 22\,a(n-13) - 126\,a(n-14) - 204\,a(n-15) - 136\,a(n-16) + 14\,a(n-17) + 105\,a(n-18) + 136\,a(n-19) + 91\,a(n-20) - 30\,a(n-21) - 44\,a(n-22) - 42\,a(n-23) - 10\,a(n-24) + 38\,a(n-25) + 18\,a(n-26) + 16\,a(n-27) - 9\,a(n-28) - 10\,a(n-29) - 3\,a(n-30) - 4\,a(n-31) + 3\,a(n-32)
\]
for every $n>34$.
\end{theorem}
...
exactly. Those integers vanish from the index corresponding to $n=34+1$ onwards, and the
run was continued until the working vector was identically zero, which settles all larger $j$
at once. By Lemma~\ref{lem:crit} the recurrence holds for every $n>34$.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A260762.
