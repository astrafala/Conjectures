...
\title{The empirical recurrence for OEIS A299664, proved by transfer matrix}
...
\begin{abstract}
OEIS A299664 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $equal to$ itself lying in $\{0,1,2,3,4,6,7\}$, and it carries an empirical
...
OEIS A299664 is ``Number of nX4 0..1 arrays with every element equal to 0, 1, 2, 3, 4, 6 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
8, 121, 1080, 10363, 100823, 974646, 9424684, 91234133,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 15 2018 14:53:24, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;10\,a(n-1) + a(n-2) + 31\,a(n-3) - 636\,a(n-4) - 701\,a(n-5) + 820\,a(n-6) + 11910\,a(n-7) + 16436\,a(n-8) - 26642\,a(n-9) - 86995\,a(n-10) - 186911\,a(n-11) + 329595\,a(n-12) + 155354\,a(n-13) + 1326652\,a(n-14) - 2146505\,a(n-15) + 1375067\,a(n-16) - 6071189\,a(n-17) + 7346058\,a(n-18) - 8106363\,a(n-19) + 14679031\,a(n-20) - 11397484\,a(n-21) + 14203441\,a(n-22) - 12222436\,a(n-23) + 1200199\,a(n-24) + 791745\,a(n-25) - 5194748\,a(n-26) + 9667214\,a(n-27) - 11972939\,a(n-28) + 770286\,a(n-29) + 1084560\,a(n-30) - 3011274\,a(n-31) + 9815077\,a(n-32) - 4481104\,a(n-33) - 150016\,a(n-34) + 568897\,a(n-35) - 223438\,a(n-36) + 10096\,a(n-37) - 2408\,a(n-38)
\end{equation}
for all $n>39$.
...
has score in $\{0,1,2,3,4,6,7\}$. The entry also fixes the top-left entry to be $0$; that is a condition on the first row alone, so it restricts the start vector and nothing else.
...
\begin{itemize}
\item $\mathbf{s}(r,s)=1$ when every cell of $r$ has score in $\{0,1,2,3,4,6,7\}$ \emph{with no row
above $r$} and $r_1=0$, and $0$ otherwise;
\item an edge $(r,s)\to(s,t)$ when every cell of $s$ has score in $\{0,1,2,3,4,6,7\}$ computed from
$r$, $s$ and $t$;
\item $\mathbf{e}(r,s)=1$ when every cell of $s$ has score in $\{0,1,2,3,4,6,7\}$ \emph{with no row
...
exactly when every one of its $n$ rows has all scores in $\{0,1,2,3,4,6,7\}$. Read the sequence as the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A299664.
