...
\title{The empirical recurrence for OEIS A253979, proved by transfer matrix}
...
\begin{abstract}
OEIS A253979 counts the arrays over $\{0,\dots,1\}$ whose $3\times3$ subblocks carry a
...
OEIS A253979 is ``Number of (n+2)X(2+2) 0..1 arrays with every 3X3 subblock diagonal maximum plus antidiagonal maximum nondecreasing horizontally and vertically.''. It has offset $1$ and begins
\[
3372, 36434, 417518, 4858102, 55806952, 642845877, 7415403315, 85480006244,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 14:23:06, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253979.
