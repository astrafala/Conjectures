...
\title{The empirical recurrence for OEIS A251784, proved by transfer matrix}
...
\begin{abstract}
OEIS A251784 counts arrays of width $3$ over $\{0,1,2,3\}$ in which every $3\times3$ window has
...
OEIS A251784 is ``Number of (n+2)X(1+2) 0..3 arrays with no row, column, diagonal or antidiagonal in any 3X3 subblock summing to 2 3 6 or 7.''. It has offset $1$ and begins
\[
1280, 1664, 3072, 6144, 11834, 22632, 44792, 86988,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 10:30:44, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 2\,a(n-2) + 14\,a(n-3) - 29\,a(n-4) - 39\,a(n-5) - 60\,a(n-6) + 103\,a(n-7) + 261\,a(n-8) + 219\,a(n-9) + 54\,a(n-10) - 679\,a(n-11) - 1209\,a(n-12) - 512\,a(n-13) + 491\,a(n-14) + 1546\,a(n-15) + 1721\,a(n-16) + 293\,a(n-17) - 756\,a(n-18) - 463\,a(n-19) + 513\,a(n-20) + 1705\,a(n-21) + 1590\,a(n-22) - 297\,a(n-23) - 1862\,a(n-24) - 1774\,a(n-25) - 161\,a(n-26) + 1644\,a(n-27) + 1852\,a(n-28) + 334\,a(n-29) - 1340\,a(n-30) - 1888\,a(n-31) - 1090\,a(n-32) + 44\,a(n-33) + 608\,a(n-34) + 484\,a(n-35) + 32\,a(n-36) - 352\,a(n-37) - 424\,a(n-38) - 336\,a(n-39) - 192\,a(n-40) - 48\,a(n-41)
\]
for every $n>50$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251784.
