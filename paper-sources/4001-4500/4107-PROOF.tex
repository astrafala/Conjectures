...
\title{The empirical recurrence for OEIS A254564, proved by transfer matrix}
...
\begin{abstract}
OEIS A254564 counts the arrays over $\{0,\dots,1\}$ whose $3\times3$ subblocks carry a
...
so the count is a walk count on $S=31160$ states --- the last two array rows together with the
...
OEIS A254564 is ``Number of (n+2)X(4+2) 0..1 arrays with every 3X3 subblock sum of the four sums of the central row, central column, diagonal and antidiagonal nondecreasing horizontally and vertically.''. It has offset $1$ and begins
\[
37200, 183210, 978154, 2148260, 4796417, 12136355, 25618602, 56219231,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 14:49:50, revision 6) this is still
...
\]
on the $S=31160$ reachable states. In particular $a$ is $C$-finite. The alignment of the walk
...
\begin{theorem}
\[
a(n)\;=\;9\,a(n-1) - 35\,a(n-2) + 88\,a(n-3) - 207\,a(n-4) + 497\,a(n-5) - 1011\,a(n-6) + 1782\,a(n-7) - 3201\,a(n-8) + 5555\,a(n-9) - 8415\,a(n-10) + 12310\,a(n-11) - 18434\,a(n-12) + 25038\,a(n-13) - 31174\,a(n-14) + 40170\,a(n-15) - 49491\,a(n-16) + 53547\,a(n-17) - 58201\,a(n-18) + 64350\,a(n-19) - 60203\,a(n-20) + 51337\,a(n-21) - 47619\,a(n-22) + 34892\,a(n-23) - 12870\,a(n-24) + 12870\,a(n-26) - 34892\,a(n-27) + 47619\,a(n-28) - 51337\,a(n-29) + 60203\,a(n-30) - 64350\,a(n-31) + 58201\,a(n-32) - 53547\,a(n-33) + 49491\,a(n-34) - 40170\,a(n-35) + 31174\,a(n-36) - 25038\,a(n-37) + 18434\,a(n-38) - 12310\,a(n-39) + 8415\,a(n-40) - 5555\,a(n-41) + 3201\,a(n-42) - 1782\,a(n-43) + 1011\,a(n-44) - 497\,a(n-45) + 207\,a(n-46) - 88\,a(n-47) + 35\,a(n-48) - 9\,a(n-49) + a(n-50)
\]
for every $n>62$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A254564.
