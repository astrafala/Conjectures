...
\title{The empirical recurrence for OEIS A188704, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A188704 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A188704 is ``Number of nX7 binary arrays without the pattern 0 0 diagonally or vertically.''. It has offset $1$ and begins
\[
128, 987, 30825, 438048, 9413801, 161506225, 3118943536, 56585607231,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 04:47:27, revision 9) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A188704.
