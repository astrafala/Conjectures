...
\title{The empirical recurrence for OEIS A251405, proved by transfer matrix}
...
\begin{abstract}
OEIS A251405 counts $(n+1)\times4$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A251405 is ``Number of (n+1)X(3+1) 0..2 arrays with every 2X2 subblock summing to a prime.''. It has offset $1$ and begins
\[
1230, 19654, 313396, 5037428, 80717134, 1297591952, 20821486740, 334615097454,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:19:04, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;7\,a(n-1) + 415\,a(n-2) - 2170\,a(n-3) - 65018\,a(n-4) + 279158\,a(n-5) + 5209878\,a(n-6) - 19110091\,a(n-7) - 241884065\,a(n-8) + 770936285\,a(n-9) + 6925377809\,a(n-10) - 19408276678\,a(n-11) - 126423709248\,a(n-12) + 316443716761\,a(n-13) + 1497304356328\,a(n-14) - 3412859931553\,a(n-15) - 11572642532092\,a(n-16) + 24480490792547\,a(n-17) + 58017621913005\,a(n-18) - 115645342019311\,a(n-19) - 185048719496534\,a(n-20) + 350615451009020\,a(n-21) + 363598533038691\,a(n-22) - 653187102277345\,a(n-23) - 423563887277148\,a(n-24) + 702290291166770\,a(n-25) + 283913177157700\,a(n-26) - 400320176322800\,a(n-27) - 106630599041392\,a(n-28) + 108533272966240\,a(n-29) + 18430917299936\,a(n-30) - 12244527293952\,a(n-31) - 1022082252800\,a(n-32) + 426212623232\,a(n-33) + 14250333696\,a(n-34) - 4553766400\,a(n-35) - 32858112\,a(n-36) + 9977856\,a(n-37)
\end{equation}
for all $n>36$.
...
\alpha+\beta+\gamma+\delta\ \text{is prime},
\end{equation}
...
index corresponding to $n=36+1$ onwards, and the run continued until $w$ itself was the
zero vector, which settles every larger $j$ at once. By Lemma~\ref{lem:crit} the recurrence
holds for every $n>36$.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251405.
