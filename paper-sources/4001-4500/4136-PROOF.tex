...
\title{The empirical recurrence for OEIS A297429, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297429 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A297429 is ``Number of nX6 0..1 arrays with every 1 horizontally, diagonally or antidiagonally adjacent to 2 neighboring 1s.''. It has offset $1$ and begins
\[
1, 33, 109, 349, 2430, 11345, 50127, 267505,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 30 2017 06:58:30, revision 4) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297429.
