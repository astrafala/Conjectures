...
\title{The empirical recurrence for OEIS A297813, proved by transfer matrix}
...
\begin{abstract}
OEIS A297813 counts $7$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $equal to$ itself lying in $\{2,3\}$, and it carries an empirical
...
OEIS A297813 is ``Number of nX7 0..1 arrays with every element equal to 2 or 3 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
0, 22, 0, 41, 39, 114, 88, 296,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 06 2018 10:29:12, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) - a(n-2) - 3\,a(n-3) + 13\,a(n-4) - 17\,a(n-5) - 18\,a(n-6) + 25\,a(n-7) - 39\,a(n-8) - 10\,a(n-9) + 102\,a(n-10) - 35\,a(n-11) + 17\,a(n-12) + 161\,a(n-13) - 49\,a(n-14) + 149\,a(n-15) + 255\,a(n-16) - 121\,a(n-17) - 115\,a(n-18) - 480\,a(n-19) - 953\,a(n-20) - 406\,a(n-21) + 48\,a(n-22) + 568\,a(n-23) + 1381\,a(n-24) + 972\,a(n-25) + 115\,a(n-26) - 586\,a(n-27) - 1117\,a(n-28) - 643\,a(n-29) + 133\,a(n-30) + 553\,a(n-31) + 667\,a(n-32) + 113\,a(n-33) - 549\,a(n-34) - 669\,a(n-35) - 310\,a(n-36) + 338\,a(n-37) + 593\,a(n-38) + 341\,a(n-39) - 40\,a(n-40) - 268\,a(n-41) - 194\,a(n-42) - 39\,a(n-43) + 49\,a(n-44) + 53\,a(n-45) + 16\,a(n-46) - 2\,a(n-47) - 5\,a(n-48) - 2\,a(n-49)
\end{equation}
for all $n>59$.
...
has score in $\{2,3\}$. The entry also fixes the top-left entry to be $0$; that is a condition on the first row alone, so it restricts the start vector and nothing else.
...
\begin{itemize}
\item $\mathbf{s}(r,s)=1$ when every cell of $r$ has score in $\{2,3\}$ \emph{with no row
above $r$} and $r_1=0$, and $0$ otherwise;
\item an edge $(r,s)\to(s,t)$ when every cell of $s$ has score in $\{2,3\}$ computed from
$r$, $s$ and $t$;
\item $\mathbf{e}(r,s)=1$ when every cell of $s$ has score in $\{2,3\}$ \emph{with no row
...
exactly when every one of its $n$ rows has all scores in $\{2,3\}$. Read the sequence as the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297813.
