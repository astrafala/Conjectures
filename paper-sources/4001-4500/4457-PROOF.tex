...
\title{The empirical recurrence for OEIS A305526, proved by transfer matrix}
...
\begin{abstract}
OEIS A305526 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $different from$ itself lying in $\{0,1,2,3,4,6\}$, and it carries an empirical
...
OEIS A305526 is ``Number of nX4 0..1 arrays with every element unequal to 0, 1, 2, 3, 4 or 6 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
8, 112, 880, 7385, 61139, 506359, 4205030, 34889423,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 04 2018 12:02:51, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;9\,a(n-1) - 4\,a(n-2) + 28\,a(n-3) - 411\,a(n-4) + 338\,a(n-5) + 857\,a(n-6) - 247\,a(n-7) + 155\,a(n-8) - 1915\,a(n-9) + 7665\,a(n-10) - 11746\,a(n-11) + 5851\,a(n-12) - 15110\,a(n-13) - 1432\,a(n-14) + 49754\,a(n-15) - 26190\,a(n-16) + 52001\,a(n-17) - 260844\,a(n-18) + 179368\,a(n-19) - 30268\,a(n-20) - 258974\,a(n-21) + 645731\,a(n-22) - 479209\,a(n-23) - 129902\,a(n-24) - 300495\,a(n-25) - 507419\,a(n-26) + 168476\,a(n-27) - 99617\,a(n-28) + 197668\,a(n-29) + 23175\,a(n-30) + 47733\,a(n-31) + 14282\,a(n-32) + 24379\,a(n-33) + 13120\,a(n-34) + 7194\,a(n-35) + 3784\,a(n-36) - 672\,a(n-37) - 234\,a(n-38)
\end{equation}
for all $n>39$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A305526.
