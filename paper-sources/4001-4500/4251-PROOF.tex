...
\title{The empirical recurrence for OEIS A207001, proved by transfer matrix}
...
\begin{abstract}
OEIS A207001 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
$(0,1,1)$ along one axis and $(0,1,0)$ along the other, and carries an empirical recurrence of
order $41$ contributed by R.~H.~Hardin. It is true. The patterns have length $3$, so
...
$\mathbf{1}^{\!\top}P^{\,n-2-41}q(P)\mathbf{1}$, which vanishes identically
...
OEIS A207001 is ``Number of 4Xn 0..1 arrays avoiding 0 1 0 horizontally and 0 1 1 vertically.''. It has offset
$1$ and begins
\[
12, 144, 1020, 6612, 45932, 329734, 2346621,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 13:22:25, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;12\,a(n-1) - 66\,a(n-2) + 302\,a(n-3) - 765\,a(n-4) + 1446\,a(n-5) - 323\,a(n-6) - 5615\,a(n-7) + 13155\,a(n-8) - 14780\,a(n-9) - 33360\,a(n-10) + 114407\,a(n-11) - 55387\,a(n-12) - 144528\,a(n-13) + 485368\,a(n-14) - 387119\,a(n-15) - 1329517\,a(n-16) + 1697828\,a(n-17) + 2024417\,a(n-18) - 2840081\,a(n-19) - 1775201\,a(n-20) + 2598810\,a(n-21) + 710729\,a(n-22) - 1248295\,a(n-23) + 112490\,a(n-24) + 169231\,a(n-25) - 221480\,a(n-26) + 97360\,a(n-27) + 61312\,a(n-28) - 26508\,a(n-29) + 917\,a(n-30) - 3775\,a(n-31) - 1940\,a(n-32) + 564\,a(n-33) + 66\,a(n-34) + 376\,a(n-35) - 3\,a(n-36) - 41\,a(n-37) + 9\,a(n-38) - 8\,a(n-39) - a(n-40) + a(n-41)
\end{equation}
for all $n>41$. The entry's array has a fixed number of rows and a growing number of
...
$(0,1,1)$ as $3$ consecutive entries. There are $12$ admissible columns; that condition
...
$a(n)-\sum_i c_i a(n-i)=u_{\,n-2-41}$ whenever $n-41\ge2$. Hence
\eqref{eq:conj} holds for every $n>t$ exactly when $u_j=0$ for every
$j>t-2-41$. Moreover $(u_j)$ satisfies the monic linear recurrence whose
...
$P^{\,n-2-41}$ gives the identity. The equivalence follows by letting the exponent
...
\begin{proof}
The vector $q(P)\mathbf{1}\in\mathbb{Z}^{S}$ was formed by $41$ matrix--vector
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207001.
