...
\title{The empirical recurrence for OEIS A252099, proved by transfer matrix}
...
\begin{abstract}
OEIS A252099 counts $(n+2)\times4$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
every $3\times3$ subblock, and it carries an empirical recurrence of order $47$
...
OEIS A252099 is ``Number of (n+2)X(2+2) 0..3 arrays with every 3X3 subblock row and column sum equal to 0 3 4 6 or 7 and every 3X3 diagonal and antidiagonal sum not equal to 0 3 4 6 or 7.''. It has offset $1$ and begins
\[
4581, 4866, 5087, 8941, 21405, 50222, 120128, 312242,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 10:47:19, revision 6) this is still
...
$\{0,\dots,3\}^{4}$. A $3\times3$ subblock occupies three consecutive rows and
...
\[
\text{every row, column sum} \in \{0,3,4,6,7\}\ \text{ and }\ \text{every diagonal, antidiagonal sum} \notin \{0,3,4,6,7\}
\]
...
$S=(3+1)^{2\cdot4}=65536$, and put an edge $(r,s)\to(s,t)$ exactly when the condition
...
\begin{theorem}
\[
a(n)\;=\;69\,a(n-3) - 1953\,a(n-6) + 29920\,a(n-9) + 36\,a(n-11) - 278255\,a(n-12) - 1940\,a(n-14) + 1692745\,a(n-15) + 40112\,a(n-17) - 7161794\,a(n-18) - 420060\,a(n-20) + 22075677\,a(n-21) + 2500924\,a(n-23) - 50523975\,a(n-24) - 8983544\,a(n-26) + 84503984\,a(n-27) + 20012284\,a(n-29) - 98978713\,a(n-30) - 27763500\,a(n-32) + 76679663\,a(n-33) + 23593520\,a(n-35) - 36673389\,a(n-36) - 11815076\,a(n-38) + 9873702\,a(n-39) + 3248004\,a(n-41) - 1302480\,a(n-42) - 432360\,a(n-44) + 64800\,a(n-45) + 21600\,a(n-47)
\]
for every $n>53$.
\end{theorem}

\begin{proof}
The vector $w=q(M)\mathbf{1}$ was formed by $47$ matrix--vector products in exact
integer arithmetic and $\mathbf{1}^{\!\top}M^{j}w$ evaluated for $j=0,1,\dots$, again
exactly. Those integers vanish from the index corresponding to $n=53+1$ onwards, and the
run was continued until the working vector was identically zero, which settles all larger $j$
at once. By Lemma~\ref{lem:crit} the recurrence holds for every $n>53$.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252099.
