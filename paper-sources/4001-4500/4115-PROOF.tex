...
\title{The empirical recurrence for OEIS A255037, proved by transfer matrix}
...
\begin{abstract}
OEIS A255037 counts the arrays over $\{0,\dots,1\}$ whose $3\times3$ subblocks carry a
...
OEIS A255037 is ``Number of (2+2)X(n+2) 0..1 arrays with every 3X3 subblock sum of the two sums of the central row and central column minus the two minimums of the diagonal and antidiagonal nondecreasing horizontally, vertically and ne-to-sw antidiagonally.''. It has offset $1$ and begins
\[
2554, 9492, 39935, 149676, 470542, 1327776, 3504157, 8592073,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 15:06:19, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A255037.
