...
\title{The empirical recurrence for OEIS A237953, proved by transfer matrix}
...
\begin{abstract}
OEIS A237953 counts arrays over $\{0,\dots,3\}$ subject to a condition on the order
...
The condition is local to two consecutive rows, so the count is a walk count on $S=1280$
...
OEIS A237953 is ``Number of (n+1) X (2+1) 0..3 arrays with the maximum plus the upper median plus the lower median plus the minimum of every 2 X 2 subblock differing from its horizontal and vertical neighbors by exactly one.''. It has offset $1$ and begins
\[
1280, 7552, 45504, 300576, 1989792, 13448144, 90873216, 619311968,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 24 2024 08:44:06, revision 6) this is still
...
differ by $1$. The entry's first term $1280$ counts those, and the model was made to
...
\]
over the $S=1280$ pairs whose own subblock row already satisfies the condition along itself.
...
\begin{theorem}
\[
a(n)\;=\;2748\,a(n-4) - 1387988\,a(n-8) + 288215016\,a(n-12) - 28573068288\,a(n-16) + 1342200998400\,a(n-20) - 26806577111808\,a(n-24) + 258758317983744\,a(n-28) - 1294957173878784\,a(n-32) + 3352065764917248\,a(n-36) - 4028458590535680\,a(n-40) + 1526567264059392\,a(n-44)
\]
for every $n>46$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237953.
