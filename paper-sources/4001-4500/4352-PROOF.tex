...
\title{The empirical recurrence for OEIS A254838, proved by transfer matrix}
...
\begin{abstract}
OEIS A254838 counts the arrays over $\{0,\dots,1\}$ whose $3\times3$ subblocks carry a
...
so the count is a walk count on $S=192$ states --- the last two array rows together with the
...
OEIS A254838 is ``Number of (n+2)X(1+2) 0..1 arrays with every 3X3 subblock sum of the medians of the diagonal and antidiagonal minus the two sums of the central row and column nondecreasing horizontally and vertically.''. It has offset $1$ and begins
\[
512, 2485, 8776, 30182, 99200, 293012, 794128, 2084773,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 14:58:48, revision 10) this is still
...
\]
on the $S=192$ reachable states. In particular $a$ is $C$-finite. The alignment of the walk
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) - 3\,a(n-2) - 4\,a(n-3) + 19\,a(n-4) - 52\,a(n-5) + 16\,a(n-6) + 84\,a(n-7) - 81\,a(n-8) + 54\,a(n-9) + 241\,a(n-10) - 548\,a(n-11) - 247\,a(n-12) + 1186\,a(n-13) - 1497\,a(n-14) + 970\,a(n-15) + 2083\,a(n-16) - 4166\,a(n-17) + 1689\,a(n-18) + 1372\,a(n-19) - 2626\,a(n-20) - 634\,a(n-21) + 11103\,a(n-22) - 18990\,a(n-23) + 16085\,a(n-24) - 8600\,a(n-25) + 3843\,a(n-26) - 6236\,a(n-27) + 16348\,a(n-28) - 24736\,a(n-29) + 21996\,a(n-30) - 11504\,a(n-31) + 2384\,a(n-32) + 1920\,a(n-33) - 2496\,a(n-34) + 1280\,a(n-35) - 256\,a(n-36)
\]
for every $n>41$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A254838.
