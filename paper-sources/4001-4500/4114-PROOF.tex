...
\title{The empirical recurrence for OEIS A296310, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A296310 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A296310 is ``Number of nX5 0..1 arrays with each 1 adjacent to 3 or 6 king-move neighboring 1s.''. It has offset $1$ and begins
\[
1, 6, 13, 23, 68, 162, 343, 864,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 10 2017 11:03:39, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + a(n-2) + 67\,a(n-3) - 59\,a(n-4) - 62\,a(n-5) - 1809\,a(n-6) + 1341\,a(n-7) + 1511\,a(n-8) + 25586\,a(n-9) - 14845\,a(n-10) - 18705\,a(n-11) - 209575\,a(n-12) + 85588\,a(n-13) + 130544\,a(n-14) + 1061484\,a(n-15) - 269421\,a(n-16) - 562999\,a(n-17) - 3499136\,a(n-18) + 417881\,a(n-19) + 1591445\,a(n-20) + 7763653\,a(n-21) - 11662\,a(n-22) - 3001912\,a(n-23) - 11769729\,a(n-24) - 1191122\,a(n-25) + 3833180\,a(n-26) + 12194217\,a(n-27) + 2198725\,a(n-28) - 3499229\,a(n-29) - 8621478\,a(n-30) - 1899439\,a(n-31) + 2529304\,a(n-32) + 4247435\,a(n-33) + 883792\,a(n-34) - 1505136\,a(n-35) - 1540053\,a(n-36) - 247920\,a(n-37) + 665714\,a(n-38) + 420856\,a(n-39) + 55872\,a(n-40) - 202184\,a(n-41) - 80280\,a(n-42) - 10232\,a(n-43) + 41448\,a(n-44) + 9568\,a(n-45) + 1056\,a(n-46) - 5344\,a(n-47) - 640\,a(n-48) - 128\,a(n-49) + 384\,a(n-50)
\end{equation}
for all $n>51$.
...
x_{t,u}=1\ \Rightarrow\ \#\{\text{neighbours equal to }1\}\in\{3,6\}
\end{equation}
for every cell $(t,u)$.
...
\begin{theorem}
The recurrence \eqref{eq:conj} holds for every $n>51$, which is the statement of
Section~1.
\end{theorem}
...
the middle row. The vector $w$ was formed by $50$ applications of $G$ in exact integer
arithmetic and $\mathbf{v}^{\!\top}G^{m}w$ evaluated for $m=0,1,\dots$, again exactly.
Every one of those integers vanishes from the index corresponding to $n=51+1$ onwards,
...
every one of the $29$ published indices, with no shift fitted: the number of rows is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A296310.
