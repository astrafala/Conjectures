...
\title{The empirical recurrence for OEIS A233687, proved by transfer matrix}
...
\begin{abstract}
OEIS A233687 counts $(n+1)\times5$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
every $2\times2$ subblock, and carries an empirical recurrence of order $41$ contributed
...
OEIS A233687 is ``Number of (n+1) X (4+1) 0..3 arrays with every 2 X 2 subblock having the sum of the squares of the edge differences equal to 10, and no two adjacent values equal.''. It has offset $1$ and begins
\[
1188, 13324, 145512, 1723204, 19588516, 233101508, 2662026560, 31690526268,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 14 2014 02:39:26, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) + 222\,a(n-2) - 895\,a(n-3) - 14806\,a(n-4) + 61290\,a(n-5) + 479263\,a(n-6) - 2067766\,a(n-7) - 8897249\,a(n-8) + 40799029\,a(n-9) + 102512949\,a(n-10) - 513857547\,a(n-11) - 760171900\,a(n-12) + 4350919810\,a(n-13) + 3628256006\,a(n-14) - 25577829290\,a(n-15) - 10454924632\,a(n-16) + 106480049675\,a(n-17) + 12586615989\,a(n-18) - 317308345201\,a(n-19) + 27167936641\,a(n-20) + 679221981450\,a(n-21) - 157201990004\,a(n-22) - 1040817140533\,a(n-23) + 351215509546\,a(n-24) + 1129423930543\,a(n-25) - 469396649218\,a(n-26) - 850891317254\,a(n-27) + 403441486513\,a(n-28) + 431368323585\,a(n-29) - 223830914820\,a(n-30) - 140453027219\,a(n-31) + 77851050483\,a(n-32) + 27476109266\,a(n-33) - 16042803856\,a(n-34) - 2950519700\,a(n-35) + 1797075893\,a(n-36) + 152255054\,a(n-37) - 93497323\,a(n-38) - 3429989\,a(n-39) + 1518688\,a(n-40) + 74280\,a(n-41)
\end{equation}
for all $n>41$.
...
For every $n$ with $n+1-1\ge41$,
\[
a(n)-\sum_i c_i\,a(n-i)\;=\;\mathbf{1}^{\!\top}M^{\,n+1-1-41}\,q(M)\,\mathbf{1} .
\]
...
=\mathbf{1}^{\!\top}M^{\,m-41}\,q(M)\,\mathbf{1}
\]
with $m=n+1-1$, which is the stated identity; the equivalence follows by letting
$m-41=j$ run over $\ge0$. For the last clause put $w=q(M)\mathbf{1}$. By the
...
$S^2$ pairs. The vector $w=q(M)\mathbf{1}\in\mathbb{Z}^{S}$ was then formed by $41$
...
index corresponding to $n=41+1$ onwards, and the run continued until $w$ itself was the
zero vector, which settles every larger $j$ at once. By Lemma~\ref{lem:crit} the recurrence
holds for every $n>41$.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A233687.
