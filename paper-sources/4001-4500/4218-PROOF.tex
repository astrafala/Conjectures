...
\title{The empirical recurrence for OEIS A207706, proved by transfer matrix}
...
\begin{abstract}
OEIS A207706 counts arrays over $\{0,\dots,1\}$ of width $5$ that avoid the patterns
...
OEIS A207706 is ``Number of 5Xn 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 0 1 and 1 1 0 vertically.''. It has offset
$1$ and begins
\[
10, 100, 390, 1521, 8151, 43681, 206910,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:11:36, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207706.
