...
\title{The empirical recurrence for OEIS A251943, proved by transfer matrix}
...
\begin{abstract}
OEIS A251943 counts $(n+2)\times3$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A251943 is ``Number of (n+2)X(1+2) 0..3 arrays with every 3X3 subblock row and column sum prime and every diagonal and antidiagonal sum nonprime.''. It has offset $1$ and begins
\[
1462, 2255, 1933, 2735, 4346, 7115, 12344, 20995,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:33:56, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;13\,a(n-3) + 3\,a(n-4) + a(n-5) - 58\,a(n-6) - 35\,a(n-7) - 16\,a(n-8) + 108\,a(n-9) + 138\,a(n-10) + 89\,a(n-11) - 86\,a(n-12) - 224\,a(n-13) - 219\,a(n-14) - 53\,a(n-15) + 185\,a(n-16) + 284\,a(n-17) + 237\,a(n-18) - 44\,a(n-19) - 240\,a(n-20) - 357\,a(n-21) - 128\,a(n-22) + 165\,a(n-23) + 353\,a(n-24) + 258\,a(n-25) - 73\,a(n-26) - 285\,a(n-27) - 266\,a(n-28) - 18\,a(n-29) + 190\,a(n-30) + 193\,a(n-31) + 45\,a(n-32) - 82\,a(n-33) - 106\,a(n-34) - 31\,a(n-35) + 25\,a(n-36) + 32\,a(n-37) + 15\,a(n-38) - 4\,a(n-39) - 6\,a(n-40) - 2\,a(n-41)
\]
for every $n>50$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251943.
