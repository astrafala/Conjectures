...
\title{The empirical recurrence for OEIS A209377, proved by transfer matrix}
...
\begin{abstract}
OEIS A209377 counts $(n+1)\times4$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A209377 is ``1/4 the number of (n+1) X 4 0..2 arrays with every 2 X 2 subblock having distinct edge sums.''. It has offset $1$ and begins
\[
16, 34, 64, 156, 320, 840, 1792, 4848,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 8*a(n-2) - 12*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 09 2018 14:56:24, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;8\,a(n-2) - 12\,a(n-4)
\end{equation}
for all $n>4$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209377.
