...
and $4$ cells in a row, so $|V|=7^{4}=2401$, and the vertex set is
$V\times V$, of size $2401^2=2401$. That is the whole of the state: two consecutive
...
$7$ values, so there are about $10^{37}$ of them to sift. The
