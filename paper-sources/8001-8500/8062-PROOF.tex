...
\title{The empirical recurrence for OEIS A232901, proved by transfer matrix}
...
\begin{abstract}
OEIS A232901 counts arrays of width $2$ over $\{0,\dots,2\}$ under a condition on each cell
and its neighbours, and carries an empirical recurrence of order $3$ contributed by
...
OEIS A232901 is ``Number of (n+1) X (1+1) 0..2 arrays with every element next to itself plus and minus one within the range 0..2 horizontally or antidiagonally.''. It has offset $1$ and begins
\[
0, 4, 8, 12, 32, 84, 184, 412,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) - a(n-2) + 4*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 06 2018 03:53:01, revision 8) this is still
...
$0$, which the model reproduces along with every later term. That is the cheapest check
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232901.
