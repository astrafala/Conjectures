...
\title{The empirical recurrence for OEIS A305225, proved by transfer matrix}
...
\begin{abstract}
OEIS A305225 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A305225 is ``Number of nX3 0..1 arrays with every element unequal to 0, 1, 2, 3 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
4, 21, 24, 54, 108, 236, 509, 1091,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) +a(n-2) -3*a(n-4) -a(n-5) +2*a(n-6) for n>9
\end{quote}
As of the ``Last modified'' line on the live entry (May 27 2018 17:42:04, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A305225.
