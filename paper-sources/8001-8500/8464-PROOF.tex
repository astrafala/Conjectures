...
\title{The empirical recurrence for OEIS A278008, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A278008 counts arrays over $\{0,\dots,2\}$ in which every cell is constrained by the
...
OEIS A278008 is ``Number of n X 2 0..2 arrays with every element plus 1 mod 3 equal to some element at offset (-1,-1) (-1,0) (-1,1) (0,-1) (0,1) or (1,0), with upper left element zero.''. It has offset $1$ and begins
\[
0, 6, 30, 198, 1230, 7734, 48510, 304422,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 5*a(n-1) + 8*a(n-2).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 07 2019 08:15:39, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A278008.
