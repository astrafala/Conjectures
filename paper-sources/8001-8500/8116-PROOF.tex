...
\title{The empirical recurrence for OEIS A235291, proved by transfer matrix}
...
\begin{abstract}
OEIS A235291 counts $2$-column arrays over $\{0,\dots,3\}$ in which every
...
OEIS A235291 is ``Number of (n+1) X (1+1) 0..3 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 3 (constant-stress 1 X 1 tilings).''. It has offset
$1$ and begins
\[
40, 108, 272, 744, 1888, 5232, 13376,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 14*a(n-2) - 48*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 18 2022 23:38:23, revision 11) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;14\,a(n-2) - 48\,a(n-4)
\end{equation}
...
$j=0,1,\dots$. They vanish from $j=3-4+1$ onwards, and the run was continued past
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A235291.
