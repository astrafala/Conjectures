...
\title{The empirical recurrence for OEIS A230331, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A230331 counts arrays over $\{0,\dots,2\}$ in which every cell is constrained by the
...
OEIS A230331 is ``Number of n X 2 0..2 arrays x(i,j) with each element horizontally, vertically or antidiagonally next to at least one element with value (x(i,j)+1) mod 3, and upper left element zero.''. It has offset $1$ and begins
\[
0, 6, 34, 218, 1386, 8810, 56010, 356074,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 5*a(n-1) + 8*a(n-2) + 4*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 21 2018 14:58:02, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A230331.
