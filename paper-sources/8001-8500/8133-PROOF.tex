...
\title{The empirical recurrence for OEIS A208503, proved by transfer matrix}
...
\begin{abstract}
OEIS A208503 counts arrays over $\{0,\dots,1\}$ of width $5$ that avoid the patterns
...
OEIS A208503 is ``Number of 5 X n 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 1 0 and 1 1 1 vertically.''. It has offset
$1$ and begins
\[
13, 169, 234, 650, 1794, 4992, 13806,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) + 6*a(n-2) - 3*a(n-3) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 03 2018 16:57:43, revision
8) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 6\,a(n-2) - 3\,a(n-3)
\end{equation}
...
$(0,1,0), (1,1,1)$ as $3$ consecutive entries. There are $13$ admissible columns; that condition
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208503.
