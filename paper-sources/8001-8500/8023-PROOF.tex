...
\title{The empirical recurrence for OEIS A301960, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A301960 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A301960 is ``Number of nX4 0..1 arrays with every element equal to 0, 1 or 4 horizontally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
5, 9, 25, 64, 169, 441, 1156, 3025,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) +2*a(n-2) -a(n-3) for n>4
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 29 2018 12:59:22, revision 4) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A301960.
