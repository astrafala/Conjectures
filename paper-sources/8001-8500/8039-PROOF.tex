...
\title{The empirical recurrence for OEIS A208029, proved by transfer matrix}
...
\begin{abstract}
OEIS A208029 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
...
OEIS A208029 is ``Number of 4 X n 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 0 0 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
9, 81, 279, 1377, 5895, 26685, 118179,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) + 11*a(n-2) + 2*a(n-3) - 10*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 26 2018 14:08:51, revision
8) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 11\,a(n-2) + 2\,a(n-3) - 10\,a(n-4)
\end{equation}
...
$(0,0,0), (1,0,1)$ as $3$ consecutive entries. There are $9$ admissible columns; that condition
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208029.
