...
\title{The empirical recurrence for OEIS A316803, proved by transfer matrix}
...
\begin{abstract}
OEIS A316803 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A316803 is ``Number of nX3 0..1 arrays with every element unequal to 0, 1, 2, 3, 4, 5 or 6 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
4, 32, 247, 1905, 14711, 113606, 877309, 6774916,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 8*a(n-1) -3*a(n-2) +7*a(n-3) -3*a(n-4)
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 14 2018 14:56:42, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A316803.
