...
\title{The empirical recurrence for OEIS A235205, proved by transfer matrix}
...
\begin{abstract}
OEIS A235205 counts $2$-column arrays over $\{0,\dots,7\}$ in which every
...
OEIS A235205 is ``Number of (n+1) X (1+1) 0..7 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 5, with no adjacent elements equal (constant-stress tilted 1 X 1 tilings).''. It has offset
$1$ and begins
\[
240, 1172, 5696, 27812, 135520, 662892, 3236288,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) + 35*a(n-2) - 81*a(n-3) - 264*a(n-4) + 144*a(n-5) + 384*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 19 2022 02:22:09, revision 13) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 35\,a(n-2) - 81\,a(n-3) - 264\,a(n-4) + 144\,a(n-5) + 384\,a(n-6)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A235205.
