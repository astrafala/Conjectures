...
\title{The empirical recurrence for OEIS A258918, proved by transfer matrix}
...
\begin{abstract}
OEIS A258918 counts arrays of width $3$ over $\{0,1\}$ in which every $3\times3$ window has
...
OEIS A258918 is ``Number of (n+2) X (1+2) 0..1 arrays with no 3 x 3 subblock diagonal sum equal to the antidiagonal sum or central row sum equal to the central column sum.''. It has offset $1$ and begins
\[
200, 576, 1680, 5184, 15840, 46656, 138240, 419904,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) - 6*a(n-2) + 18*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 23 2018 08:14:42, revision 9) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A258918.
