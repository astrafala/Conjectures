...
\title{The empirical recurrence for OEIS A318062, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A318062 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A318062 is ``Number of nX2 0..1 arrays with every element unequal to 1, 2, 3 or 4 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
1, 5, 18, 67, 249, 925, 3437, 12770,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) +3*a(n-2) -a(n-3) -a(n-4)
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 15 2018 13:09:04, revision 4) the statement is
...
\#\{\text{neighbours with a value }different from\ x_{t,u}\}\in\{1,2,3,4\}
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A318062.
