...
\title{The empirical recurrence for OEIS A197229, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A197229 counts arrays over $\{0,\dots,4\}$ in which every cell is constrained by the
...
OEIS A197229 is ``Number of n X 2 0..4 arrays with each element x equal to the number its horizontal and vertical neighbors equal to 4,3,0,1,2 for x=0,1,2,3,4.''. It has offset $1$ and begins
\[
1, 7, 12, 31, 79, 186, 465, 1131,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +3*a(n-2) +2*a(n-3) -a(n-4) -a(n-5) -a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 18 2018 15:33:32, revision 8) the statement is
...
\#\{\text{neighbours with value }f(x_{t,u})\}=x_{t,u},\quad f=(4,3,0,1,2)
\end{equation}
for every cell $(t,u)$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A197229.
