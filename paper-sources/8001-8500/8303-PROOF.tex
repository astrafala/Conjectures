...
\title{The empirical recurrence for OEIS A209531, proved by transfer matrix}
...
\begin{abstract}
OEIS A209531 counts $(n+1)\times5$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A209531 is ``Half the number of (n+1) X 5 0..2 arrays with every 2 X 2 subblock having exactly two distinct clockwise edge differences.''. It has offset $1$ and begins
\[
33, 193, 1025, 6145, 32769, 196609, 1048577, 6291457,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) + 32*a(n-2) - 32*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 11 2018 06:18:19, revision 11) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209531.
