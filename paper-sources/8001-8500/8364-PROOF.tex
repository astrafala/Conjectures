...
\title{The empirical recurrence for OEIS A258963, proved by transfer matrix}
...
\begin{abstract}
OEIS A258963 counts $(n+2)\times7$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A258963 is ``Number of (n+2) X (5+2) 0..1 arrays with no 3 X 3 subblock diagonal sum 0 and no antidiagonal sum 3 and no row sum 0 or 3 and no column sum 0 or 3.''. It has offset $1$ and begins
\[
676, 614, 288, 340, 384, 466, 552, 724,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-2) - 2*a(n-4) for n>10.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 24 2018 07:45:56, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A258963.
