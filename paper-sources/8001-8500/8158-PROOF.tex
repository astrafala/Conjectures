...
\title{The empirical recurrence for OEIS A183703, proved by transfer matrix}
...
\begin{abstract}
OEIS A183703 counts arrays over $\{0,\dots,3\}$ under a condition on the determinant of every
...
OEIS A183703 is ``Number of (n+1) X 3 0..3 arrays with every 2 X 2 subblock nonsingular.''. It has offset $1$ and begins
\[
2472, 108624, 4760784, 208772880, 9154058448, 401390133264, 17600152230096, 771732813754128,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 29*a(n-1) + 617*a(n-2) + 1587*a(n-3) - 4104*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 04 2018 10:48:07, revision 9) this is still
...
another exactly when all $2$ of the subblocks they form pass. An $(n+1)$-row array is then a
walk of $n$ steps and
\[
...
first term is $2472$, and the model reproduces it along with every later term; that is the
...
\begin{theorem}
\[
a(n)\;=\;29\,a(n-1) + 617\,a(n-2) + 1587\,a(n-3) - 4104\,a(n-4)
\]
for every $n>4$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A183703.
