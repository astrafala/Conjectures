...
\title{The empirical recurrence for OEIS A301995, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A301995 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A301995 is ``Number of nX4 0..1 arrays with every element equal to 1, 2 or 4 horizontally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
2, 8, 26, 74, 200, 530, 1394, 3656,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 4*a(n-1) -4*a(n-2) +a(n-3)
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 30 2018 12:23:28, revision 4) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A301995.
