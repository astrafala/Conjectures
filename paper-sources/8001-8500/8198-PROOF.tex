...
\title{The empirical recurrence for OEIS A206090, proved by transfer matrix}
...
\begin{abstract}
OEIS A206090 counts arrays over $\{0,\dots,2\}$ under a condition on the perimeter cycle of
...
a bounded window of consecutive rows, so the count is a walk count on $S=3564$ states and is
...
OEIS A206090 is ``Number of (n+1) X 5 0..2 arrays with every 2 X 3 or 3 X 2 subblock having exactly two counterclockwise and two clockwise edge increases.''. It has offset $1$ and begins
\[
3564, 5952, 13344, 48816, 131904, 444480, 1645920, 4484736,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 34*a(n-3) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 10 2015 01:54:14, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206090.
