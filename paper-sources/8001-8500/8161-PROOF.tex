...
\title{The empirical recurrence for OEIS A302065, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A302065 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A302065 is ``Number of nX4 0..1 arrays with every element equal to 0, 1, 2 or 4 horizontally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
8, 81, 748, 7070, 67070, 636852, 6048836, 57457232,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 16*a(n-1) -76*a(n-2) +148*a(n-3) -124*a(n-4) +36*a(n-5) for n>6
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 31 2018 15:42:15, revision 4) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302065.
