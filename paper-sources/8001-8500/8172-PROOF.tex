...
\title{The empirical recurrence for OEIS A204380, proved by transfer matrix}
...
\begin{abstract}
OEIS A204380 counts $(n+2)\times9$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A204380 is ``Number of (n+2) X 9 0..1 arrays with every 3 X 3 subblock having three equal elements in a row horizontally, vertically or nw-to-se diagonally exactly three ways, and new values 0..1 introduced in row major order.''. It has offset $1$ and begins
\[
439, 193, 205, 217, 241, 283, 347, 453,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) +a(n-2) +a(n-3) -a(n-4) -a(n-5) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 07 2018 11:47:05, revision 9) this is still
...
$u_1,u_2,\dots$ over $\{0,\dots,1\}^{9}$, the condition
\[
...
\]
on $S=262144$ vertices in total, the exponent fixed by the entry's own shape and checked against
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204380.
