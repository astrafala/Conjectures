...
\title{The empirical recurrence for OEIS A223241, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A223241 counts arrays over $\{0,\dots,6\}$ in which every cell is constrained by the
...
OEIS A223241 is ``3-loop graph coloring a rectangular array: number of n X 2 0..6 arrays where 0..6 label nodes of a graph with edges 0,1 1,2 2,0 0,3 3,4 4,0 0,5 5,6 6,0 and every array movement to a horizontal or vertical neighbor moves along an edge of this graph.''. It has offset $1$ and begins
\[
18, 102, 642, 4086, 26034, 165894, 1057122, 6736278,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 7*a(n-1) - 4*a(n-2).
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 17 2018 15:28:14, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223241.
