...
\title{The empirical recurrence for OEIS A203829, proved by transfer matrix}
...
\begin{abstract}
OEIS A203829 counts $(n+1)\times3$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A203829 is ``Number of (n+1) X 3 0..2 arrays with every 2 X 2 subblock having equal diagonal elements or equal antidiagonal elements.''. It has offset $1$ and begins
\[
225, 1971, 17289, 151659, 1330353, 11669859, 102368025, 897972507,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 9*a(n-1) -2*a(n-2).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 05 2018 11:17:52, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A203829.
