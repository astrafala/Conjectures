...
\title{The empirical recurrence for OEIS A231951, proved by transfer matrix}
...
\begin{abstract}
OEIS A231951 counts arrays of width $3$ over $\{0,\dots,1\}$ under a condition on each cell
...
OEIS A231951 is ``Number of (n+1) X (2+1) 0..1 arrays with every element equal to some horizontal, vertical, diagonal or antidiagonal neighbor, with top left element zero.''. It has offset $1$ and begins
\[
18, 142, 1034, 7756, 58350, 438540, 3295580, 24766738,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 7*a(n-1) + 2*a(n-2) + 13*a(n-3) + 8*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 01 2018 21:09:43, revision 7) this is still
...
$18$, which the model reproduces along with every later term. That is the cheapest check
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-1) + 2\,a(n-2) + 13\,a(n-3) + 8\,a(n-4)
\]
for every $n>4$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231951.
