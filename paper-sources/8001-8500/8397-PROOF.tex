...
\title{The empirical recurrence for OEIS A186464, proved by transfer matrix}
...
\begin{abstract}
OEIS A186464 counts the $(n+1)\times2$ arrays over $\{0,\dots,2\}$ in which
...
OEIS A186464 is ``Number of (n+1) X 2 0..2 arrays with every 2 X 2 subblock commuting with each of its horizontal and vertical 2 X 2 subblock neighbors.''. It has offset $1$ and begins
\[
81, 83, 277, 367, 966, 1321, 3078, 4553,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + a(n-2) - 4*a(n-3) + 4*a(n-4) - 2*a(n-5) for n>10.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 28 2018 09:02:19, revision 10) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + a(n-2) - 4\,a(n-3) + 4\,a(n-4) - 2\,a(n-5)
\]
for every $n>10$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A186464.
