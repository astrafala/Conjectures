...
\title{The empirical recurrence for OEIS A202443, derived from the entry's generating function}
...
\begin{abstract}
OEIS A202443 carries an empirical recurrence of order $7$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 29 2018 08:29:06, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{56 x^{8} - 274 x^{7} + 352 x^{6} + 266 x^{5} - 848 x^{4} + 282 x^{3} + 440 x^{2} - 338 x}{x^{7} - 3 x^{6} + x^{5} + 5 x^{4} - 5 x^{3} - x^{2} + 3 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;- 56 x^{8} + 274 x^{7} - 352 x^{6} - 266 x^{5} + 848 x^{4} - 282 x^{3} - 440 x^{2} + 338 x,
\]
