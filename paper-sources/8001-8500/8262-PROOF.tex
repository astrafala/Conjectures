...
\title{The empirical recurrence for OEIS A259292, proved by transfer matrix}
...
\begin{abstract}
OEIS A259292 counts arrays of width $4$ over $\{0,1\}$ subject to a condition read round the
...
OEIS A259292 is ``Number of (n+1) X (3+1) 0..1 arrays with each 2 X 2 subblock having clockwise pattern 0001 0101 or 0111.''. It has offset $1$ and begins
\[
66, 322, 1460, 6870, 31774, 148296, 688966, 3208946,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + 18*a(n-2) - 13*a(n-3) - 70*a(n-4) + 24*a(n-5) + 64*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 25 2018 06:22:19, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A259292.
