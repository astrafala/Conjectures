...
\title{The empirical recurrence for OEIS A300799, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A300799 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A300799 is ``Number of nX3 0..1 arrays with every element equal to 0, 1, 2, 3 or 4 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
4, 32, 228, 1672, 12228, 89472, 654628, 4789672,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 7*a(n-1) +3*a(n-2) -5*a(n-3)
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 13 2018 07:41:32, revision 4) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A300799.
