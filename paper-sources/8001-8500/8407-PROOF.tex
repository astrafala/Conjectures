...
\title{The empirical recurrence for OEIS A233982, proved by transfer matrix}
...
\begin{abstract}
OEIS A233982 counts $(n+1)\times2$ arrays over $\{0,\dots,4\}$ subject to a condition imposed on
...
OEIS A233982 is ``Number of (n+1) X (1+1) 0..4 arrays with every 2 X 2 subblock having the sum of the squares of the edge differences equal to 10, and no two adjacent values equal.''. It has offset $1$ and begins
\[
56, 236, 976, 4064, 16880, 70176, 291648, 1212224,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) + 8*a(n-2) + 4*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 12 2018 10:49:41, revision 7) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A233982.
