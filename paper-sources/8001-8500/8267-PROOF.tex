...
\title{The empirical recurrence for OEIS A297458, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297458 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A297458 is ``Number of 2 X n 0..1 arrays with every 1 horizontally, diagonally or antidiagonally adjacent to 0 or 2 neighboring 1s.''. It has offset $1$ and begins
\[
4, 8, 25, 57, 156, 384, 1009, 2545,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) + 3*a(n-2) + a(n-3) + 4*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 28 2019 18:34:30, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297458.
