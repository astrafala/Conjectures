...
\title{The empirical recurrence for OEIS A237377, proved by transfer matrix}
...
\begin{abstract}
OEIS A237377 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
OEIS A237377 is ``Number of (n+1) X (1+1) 0..2 arrays with the maximum plus the minimum minus the upper median minus the lower median of every 2 X 2 subblock differing from its horizontal and vertical neighbors by exactly one.''. It has offset $1$ and begins
\[
81, 344, 1472, 6368, 27280, 115584, 494592, 2139648,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 336*a(n-4) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 22 2018 11:43:16, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The $2\times2$ subblocks of an $(n+1)\times2$ array form an
$n\times1$ grid, and each carries the value $\sigma=a-b-c+d$, where $a\le b\le c\le d$ are its four entries sorted --- its minimum, lower median, upper median and maximum. The entry asks that the values of
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237377.
