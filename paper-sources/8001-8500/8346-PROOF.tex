...
\title{The empirical recurrence for OEIS A207656, proved by transfer matrix}
...
\begin{abstract}
OEIS A207656 counts arrays over $\{0,\dots,1\}$ of width $3$ that avoid the patterns
...
OEIS A207656 is ``Number of n X 3 0..1 arrays avoiding 0 0 0 and 1 1 1 horizontally and 0 0 1 and 1 0 0 vertically.''. It has offset
$1$ and begins
\[
6, 36, 84, 198, 474, 1140, 2748,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) - a(n-2) - a(n-3) for n>4.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 25 2018 07:53:46, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207656.
