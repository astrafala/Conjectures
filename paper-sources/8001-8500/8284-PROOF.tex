...
\title{The empirical recurrence for OEIS A255224, proved by transfer matrix}
...
\begin{abstract}
OEIS A255224 counts $(n+2)\times6$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A255224 is ``Number of (n+2)X(4+2) 0..1 arrays with no 3x3 subblock diagonal sum 0 and no antidiagonal sum 0 and no row sum 2 and no column sum 2.''. It has offset $1$ and begins
\[
43, 49, 58, 70, 88, 115, 154, 211,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) -a(n-2) +a(n-3) -a(n-4)
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:40:33, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A255224.
