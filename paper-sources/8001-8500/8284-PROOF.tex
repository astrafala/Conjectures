...
\title{The empirical recurrence for OEIS A234259, proved by transfer matrix}
...
\begin{abstract}
OEIS A234259 counts $2$-column arrays over $\{0,\dots,2\}$ in which every
...
OEIS A234259 is ``Number of (n+1) X (1+1) 0..2 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 2 (constant-stress 1 X 1 tilings).''. It has offset
$1$ and begins
\[
20, 46, 104, 244, 560, 1336, 3104,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) + 6*a(n-2) - 12*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 20 2022 21:34:03, revision 13) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234259.
