...
\title{The empirical recurrence for OEIS A235926, proved by transfer matrix}
...
\begin{abstract}
OEIS A235926 counts arrays of width $2$ over $\{0,1,2,3\}$ in which the smallest and largest of the
...
OEIS A235926 is ``Number of (n+1) X (1+1) 0..3 arrays with the minimum plus the maximum unequal to the lower median plus the upper median in every 2 X 2 subblock.''. It has offset $1$ and begins
\[
168, 1788, 18992, 201976, 2146656, 22822704, 242602688, 2579082208,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 82*a(n-2) + 320*a(n-3) + 144*a(n-4) - 448*a(n-5) + 64*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 20 2018 06:04:52, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;82\,a(n-2) + 320\,a(n-3) + 144\,a(n-4) - 448\,a(n-5) + 64\,a(n-6)
\]
for every $n>5$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A235926.
