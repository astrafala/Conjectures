...
\title{The empirical recurrence for OEIS A209906, proved by transfer matrix}
...
\begin{abstract}
OEIS A209906 counts $(n+1)\times2$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A209906 is ``Half the number of (n+1) X 2 0..3 arrays with every 2 X 2 subblock having two or four distinct clockwise edge differences.''. It has offset $1$ and begins
\[
62, 562, 5008, 44770, 399930, 3573388, 31926146, 285247762,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 7*a(n-1) + 21*a(n-2) - 30*a(n-3) - 30*a(n-4) + 12*a(n-5) + 8*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 13 2018 08:19:22, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;7\,a(n-1) + 21\,a(n-2) - 30\,a(n-3) - 30\,a(n-4) + 12\,a(n-5) + 8\,a(n-6)
\end{equation}
for all $n>5$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209906.
