...
\title{The empirical recurrence for OEIS A297980, proved by transfer matrix}
...
\begin{abstract}
OEIS A297980 counts $2$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A297980 is ``Number of n X 2 0..1 arrays with every element equal to 0, 2, 3 or 6 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 5, 6, 17, 24, 53, 94, 173,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-2) + 2*a(n-3) - 2*a(n-4) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 22 2018 12:54:29, revision
7) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-2) + 2\,a(n-3) - 2\,a(n-4)
\end{equation}
for all $n>5$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297980.
