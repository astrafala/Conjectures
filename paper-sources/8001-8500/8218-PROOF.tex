...
\title{The empirical recurrence for OEIS A303684, proved by transfer matrix}
...
\begin{abstract}
OEIS A303684 counts $2$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A303684 is ``Number of nX2 0..1 arrays with every element unequal to 2, 3 or 4 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
0, 3, 5, 18, 61, 209, 702, 2381,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) +a(n-2) +2*a(n-3) -2*a(n-4) -4*a(n-5) for n>6
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 28 2018 09:29:50, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A303684.
