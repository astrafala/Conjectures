...
\title{The empirical recurrence for OEIS A300344, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A300344 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A300344 is ``Number of n X 2 0..1 arrays with every element equal to 1 or 2 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
1, 2, 6, 15, 37, 90, 223, 550,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) + 2*a(n-2) + 3*a(n-3) + 2*a(n-4) + a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 21 2018 05:42:57, revision 12) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A300344.
