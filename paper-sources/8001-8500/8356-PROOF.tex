...
\title{The empirical recurrence for OEIS A296957, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A296957 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A296957 is ``Number of n X 2 0..1 arrays with each 1 adjacent to 2, 3 or 5 king-move neighboring 1s.''. It has offset $1$ and begins
\[
1, 6, 16, 31, 96, 301, 801, 2261,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 4*a(n-1) - 5*a(n-2) + 11*a(n-3) - 18*a(n-4) + 4*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 25 2019 14:13:37, revision 7) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A296957.
