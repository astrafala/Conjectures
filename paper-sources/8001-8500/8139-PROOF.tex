...
\title{The empirical recurrence for OEIS A235100, proved by transfer matrix}
...
\begin{abstract}
OEIS A235100 counts $2$-column arrays over $\{0,\dots,6\}$ in which every
...
OEIS A235100 is ``Number of (n+1) X (1+1) 0..6 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 4, with no adjacent elements equal (constant-stress tilted 1 X 1 tilings).''. It has offset
$1$ and begins
\[
154, 670, 2900, 12578, 54530, 236496, 1025770,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 7*a(n-1) - 2*a(n-2) - 47*a(n-3) + 3*a(n-4) + 84*a(n-5) + 36*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 19 2022 01:33:20, revision 9) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A235100.
