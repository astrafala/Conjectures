...
\title{The empirical recurrence for OEIS A297734, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297734 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A297734 is ``Number of 2Xn 0..1 arrays with every 1 horizontally, diagonally or antidiagonally adjacent to 2 or 4 neighboring 1s.''. It has offset $1$ and begins
\[
1, 2, 8, 15, 32, 61, 145, 297,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) +a(n-2) -3*a(n-3) +6*a(n-4) -6*a(n-5)
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 04 2018 22:18:44, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + a(n-2) - 3\,a(n-3) + 6\,a(n-4) - 6\,a(n-5)
\end{equation}
for all $n>6$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297734.
