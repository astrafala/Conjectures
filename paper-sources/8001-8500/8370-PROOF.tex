...
\title{The empirical recurrence for OEIS A297369, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297369 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A297369 is ``Number of n X 3 0..1 arrays with every 1 horizontally or antidiagonally adjacent to 0, 1 or 2 neighboring 1s.''. It has offset $1$ and begins
\[
8, 57, 393, 2719, 18805, 130063, 899565, 6221735,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 7*a(n-1) - 4*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 27 2019 11:45:40, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297369.
