...
\title{The empirical recurrence for OEIS A236011, proved by transfer matrix}
...
\begin{abstract}
OEIS A236011 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
OEIS A236011 is ``Number of (n+1) X (1+1) 0..2 arrays colored with the sum of the maximum and minimum values of each 2 X 2 subblock.''. It has offset $1$ and begins
\[
81, 306, 1276, 4672, 18784, 70688, 278352, 1062192,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 9*a(n-2) + 14*a(n-3) + 30*a(n-4) + 16*a(n-5) + 8*a(n-6) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 20 2018 10:24:30, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A236011.
