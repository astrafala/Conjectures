...
\title{The empirical recurrence for OEIS A250798, proved by transfer matrix}
...
\begin{abstract}
OEIS A250798 counts arrays over $\{0,1\}$ in which a statistic taken over short runs
...
OEIS A250798 is ``Number of (1+1) X (n+1) 0..1 arrays with nondecreasing min(x(i,j),x(i,j-1)) in the i direction and nondecreasing absolute value of x(i,j)-x(i-1,j) in the j direction.''. It has offset $1$ and begins
\[
10, 24, 54, 118, 252, 530, 1102, 2272,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) - a(n-2) - 2*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 20 2018 10:52:01, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250798.
