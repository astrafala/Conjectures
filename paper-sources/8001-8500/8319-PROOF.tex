...
\title{The empirical recurrence for OEIS A253393, proved by transfer matrix}
...
\begin{abstract}
OEIS A253393 counts the arrays over $\{0,\dots,1\}$ whose $2\times2$ subblocks carry a
...
so a pair of consecutive array rows is a state, the count is a walk count on $S=180$ of them,
...
OEIS A253393 is ``Number of (n+1) X (4+1) 0..1 arrays with every 2 X 2 subblock antidiagonal maximum minus diagonal minimum nondecreasing horizontally and diagonal maximum minus antidiagonal minimum nondecreasing vertically.''. It has offset $1$ and begins
\[
180, 197, 246, 346, 465, 632, 823, 1071,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) - 2*a(n-2) - 2*a(n-3) + 3*a(n-4) - a(n-5) for n>11.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 11 2018 14:26:34, revision 7) this is still
...
\]
on the $S=180$ admissible pairs. In particular $a$ is $C$-finite. The alignment of the walk
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253393.
