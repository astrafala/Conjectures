...
\title{The empirical recurrence for OEIS A205208, proved by transfer matrix}
...
\begin{abstract}
OEIS A205208 counts arrays over $\{0,\dots,2\}$ under a condition on the determinant of every
...
OEIS A205208 is ``Number of (n+1) X 2 0..2 arrays with the determinants of 2 X 2 subblocks nondecreasing rightwards and downwards.''. It has offset $1$ and begins
\[
81, 452, 1970, 8128, 33386, 139390, 588254, 2496440,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 7*a(n-1) - 11*a(n-2) - 9*a(n-3) + 30*a(n-4) - 16*a(n-5) for n>13.
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 03 2018 13:57:50, revision 13) this is still
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-1) - 11\,a(n-2) - 9\,a(n-3) + 30\,a(n-4) - 16\,a(n-5)
\]
for every $n>13$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A205208.
