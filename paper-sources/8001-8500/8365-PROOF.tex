...
\title{The empirical recurrence for OEIS A301947, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A301947 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A301947 is ``Number of nX4 0..1 arrays with every element equal to 1, 2 or 3 horizontally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
2, 16, 123, 947, 7326, 56710, 439078, 3399722,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 9*a(n-1) -8*a(n-2) -14*a(n-3) +4*a(n-4) +4*a(n-5) -a(n-6)
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 29 2018 12:43:10, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;9\,a(n-1) - 8\,a(n-2) - 14\,a(n-3) + 4\,a(n-4) + 4\,a(n-5) - a(n-6)
\end{equation}
for all $n>7$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A301947.
