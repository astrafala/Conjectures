...
\title{The empirical recurrence for OEIS A301836, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A301836 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A301836 is ``Number of n X 3 0..1 arrays with every element equal to 0, 1 or 2 horizontally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
4, 25, 139, 773, 4299, 23909, 132971, 739525,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 7*a(n-1) -8*a(n-2) for n > 3.
\end{quote}
As of the ``Last modified'' line on the live entry (May 04 2021 15:29:28, revision 6) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A301836.
