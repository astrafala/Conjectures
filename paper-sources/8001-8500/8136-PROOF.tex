...
\title{The empirical recurrence for OEIS A283858, proved by transfer matrix}
...
\begin{abstract}
OEIS A283858 counts $2\times n$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A283858 is ``Number of 2 X n 0..1 arrays with no 1 equal to more than three of its horizontal, diagonal and antidiagonal neighbors.''. It has offset $1$ and begins
\[
4, 16, 61, 233, 896, 3444, 13225, 50789,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) + a(n-2) + 7*a(n-3) + 6*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 22 2019 05:49:43, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + a(n-2) + 7\,a(n-3) + 6\,a(n-4)
\]
for every $n>4$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A283858.
