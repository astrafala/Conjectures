...
\title{The empirical recurrence for OEIS A251277, proved by transfer matrix}
...
\begin{abstract}
OEIS A251277 counts $(n+1)\times3$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A251277 is ``Number of (n+1) X (2+1) 0..3 arrays with no 2 X 2 subblock having its maximum diagonal element less than its minimum antidiagonal element.''. It has offset $1$ and begins
\[
3264, 164800, 8320896, 420152704, 21215177472, 1071238805248, 54091113672192, 2731275752121856,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 54*a(n-1) - 182*a(n-2) + 228*a(n-3) + 1152*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 27 2018 16:17:18, revision 7) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;54\,a(n-1) - 182\,a(n-2) + 228\,a(n-3) + 1152\,a(n-4)
\end{equation}
for all $n>3$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251277.
