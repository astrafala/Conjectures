...
\title{The empirical recurrence for OEIS A223443, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A223443 counts arrays over $\{0,\dots,14\}$ in which every cell is constrained by the
...
Let $V=\{0,\dots,14\}^{2}$ be the possible rows and take
...
of the $(14+1)^{2}$ possible next rows, the condition was tested on every cell of
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223443.
