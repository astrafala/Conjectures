...
\title{The empirical recurrence for OEIS A237378, proved by transfer matrix}
...
\begin{abstract}
OEIS A237378 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
OEIS A237378 is ``Number of (n+1) X (2+1) 0..2 arrays with the maximum plus the minimum minus the upper median minus the lower median of every 2 X 2 subblock differing from its horizontal and vertical neighbors by exactly one.''. It has offset $1$ and begins
\[
344, 2064, 12408, 76188, 455160, 2721900, 16378560, 100568160,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 1320*a(n-4) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 22 2018 11:56:47, revision 11) this is still
...
differ by $1$. The entry's first term $344$ counts those, and the model was made to
...
\]
over the $S=344$ pairs whose own subblock row already satisfies the condition along itself.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237378.
