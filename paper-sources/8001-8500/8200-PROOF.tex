...
\title{The empirical recurrence for OEIS A223249, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A223249 counts arrays over $\{0,\dots,4\}$ in which every cell is constrained by the
...
OEIS A223249 is ``Two-loop graph coloring a rectangular array: number of n X 2 0..4 arrays where 0..4 label nodes of a graph with edges 0,1 1,2 2,0 0,3 3,4 4,0 and every array movement to a horizontal or vertical neighbor moves along an edge of this graph.''. It has offset $1$ and begins
\[
12, 52, 236, 1076, 4908, 22388, 102124, 465844,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 5*a(n-1) - 2*a(n-2).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 16 2018 06:55:58, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223249.
