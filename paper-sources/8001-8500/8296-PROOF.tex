...
\title{The empirical recurrence for OEIS A207008, proved by transfer matrix}
...
\begin{abstract}
OEIS A207008 counts arrays of width $1$ over $\{0,1,2\}$ containing no occurrence of certain short
...
OEIS A207008 is ``Number of n X 1 0..2 arrays avoiding the patterns z z+1 z or z z-1 z in any row or column.''. It has offset $1$ and begins
\[
3, 9, 23, 61, 161, 425, 1121, 2957,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) - 2*a(n-2) + 2*a(n-3) + 2*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 20 2018 12:33:51, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) - 2\,a(n-2) + 2\,a(n-3) + 2\,a(n-4)
\]
for every $n>4$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207008.
