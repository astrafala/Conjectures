...
\title{The empirical recurrence for OEIS A234557, proved by transfer matrix}
...
\begin{abstract}
OEIS A234557 counts $2$-column arrays over $\{0,\dots,4\}$ in which every
...
OEIS A234557 is ``Number of (n+1) X (1+1) 0..4 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 4 (constant-stress 1 X 1 tilings).''. It has offset
$1$ and begins
\[
70, 220, 618, 1954, 5506, 17518, 49506,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) + 18*a(n-2) - 54*a(n-3) - 80*a(n-4) + 240*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 20 2022 21:31:29, revision 11) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234557.
