...
\title{The empirical recurrence for OEIS A255075, proved by transfer matrix}
...
\begin{abstract}
OEIS A255075 counts arrays of width $3$ over $\{0,1\}$ in which every $3\times3$ window has
...
OEIS A255075 is ``Number of (n+2) X (1+2) 0..1 arrays with no 3 x 3 subblock diagonal sum one and no antidiagonal sum one.''. It has offset $1$ and begins
\[
208, 676, 2444, 8836, 31960, 115600, 418200, 1512900,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 5*a(n-1) - 25*a(n-3) + 25*a(n-4) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 18 2018 11:11:46, revision 8) this is still
...
\text{the antidiagonal} & \text{must NOT be 1} \\
\end{array}
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A255075.
