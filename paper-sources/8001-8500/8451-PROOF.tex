...
\title{The empirical recurrence for OEIS A269202, derived from the entry's generating function}
...
\begin{abstract}
OEIS A269202 carries an empirical recurrence of order $4$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 20 2019 08:56:32, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{72 x^{4} - 308 x^{3} + 20 x^{2} + 16 x}{36 x^{4} + 60 x^{3} + 13 x^{2} - 10 x + 1},
\]
the entry's own generating function, and let
\[
D(x)\;=\;1-\sum_i c_i x^{i}\;=\;36 x^{4} + 60 x^{3} + 13 x^{2} - 10 x + 1
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;72 x^{4} - 308 x^{3} + 20 x^{2} + 16 x,
\]
