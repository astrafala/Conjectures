...
\title{The empirical recurrence for OEIS A297296, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297296 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A297296 is ``Number of n X 5 0..1 arrays with every 1 horizontally or antidiagonally adjacent to 2 neighboring 1s.''. It has offset $1$ and begins
\[
1, 4, 9, 21, 49, 114, 266, 620,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) + 2*a(n-2) - 2*a(n-3) - 2*a(n-4) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 26 2019 11:50:48, revision 7) the statement is
...
publishes, $n=30$, the arrays have $5\cdot30$ cells over
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297296.
