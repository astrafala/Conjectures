...
\title{The empirical recurrence for OEIS A204645, derived from the entry's generating function}
...
\begin{abstract}
OEIS A204645 carries an empirical recurrence of order $6$. The entry separately records a
...
OEIS A204645 is ``Number of (n+1) X 3 0..1 arrays with column and row pair sums b(i,j)=a(i,j)+a(i,j-1) and c(i,j)=a(i,j)+a(i-1,j) nondecreasing in column and row directions, respectively.''. It has offset $1$ and begins
\[
16, 32, 56, 90, 137, 200, 283, 390,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 08 2018 06:41:25, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 6 x^{6} + 23 x^{5} - 26 x^{4} - 8 x^{3} + 32 x^{2} - 16 x}{x^{6} - 4 x^{5} + 5 x^{4} - 5 x^{2} + 4 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;6 x^{6} - 23 x^{5} + 26 x^{4} + 8 x^{3} - 32 x^{2} + 16 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204645.
