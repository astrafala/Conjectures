...
\title{The empirical recurrence for OEIS A183330, proved by transfer matrix}
...
\begin{abstract}
OEIS A183330 counts arrays of width $2$ over $\{0,1\}$ under local conditions relating each cell
...
OEIS A183330 is ``Number of n X 2 binary arrays with each 1 adjacent to exactly two 0's.''. It has offset $1$ and begins
\[
1, 7, 10, 23, 49, 98, 209, 431,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + 2*a(n-2) + a(n-3) - a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 05 2020 21:27:53, revision 11) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A183330.
