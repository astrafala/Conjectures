...
\title{The empirical recurrence for OEIS A206145, proved by transfer matrix}
...
\begin{abstract}
OEIS A206145 counts arrays over $\{0,\dots,2\}$ under a condition on the perimeter cycle of
...
a bounded window of consecutive rows, so the count is a walk count on $S=162$ states and is
...
OEIS A206145 is ``Number of (n+1) X 4 0..2 arrays with every 2 X 3 or 3 X 2 subblock having exactly three counterclockwise and three clockwise edge increases.''. It has offset $1$ and begins
\[
162, 1122, 7812, 54450, 379602, 2646540, 18451530, 128643282,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 9*a(n-1) - 15*a(n-2) + 6*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 14 2018 02:39:05, revision 14) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206145.
