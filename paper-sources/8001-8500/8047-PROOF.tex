...
\title{The empirical recurrence for OEIS A197617, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A197617 counts arrays over $\{0,\dots,4\}$ in which every cell is constrained by the
...
OEIS A197617 is ``Number of n X 2 0..4 arrays with each element x equal to the number its horizontal and vertical neighbors equal to 0,3,1,1,1 for x=0,1,2,3,4.''. It has offset $1$ and begins
\[
0, 0, 8, 0, 8, 32, 16, 64,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-2) +4*a(n-3) +a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (May 14 2018 05:50:24, revision 9) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A197617.
