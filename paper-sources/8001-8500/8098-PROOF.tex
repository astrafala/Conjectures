...
\title{The empirical recurrence for OEIS A203365, proved by transfer matrix}
...
\begin{abstract}
OEIS A203365 counts arrays of width $2$ over $\{0,1,2\}$ under local conditions relating each cell
...
OEIS A203365 is ``Number of n X 2 0..2 arrays with every 1 immediately preceded by 0 to the left or above, and every 2 immediately preceded by both a 1 and a 0.''. It has offset $1$ and begins
\[
2, 9, 30, 110, 390, 1399, 4998, 17881,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) +5*a(n-2) +2*a(n-3) +a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 04 2018 05:47:26, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 5\,a(n-2) + 2\,a(n-3) + a(n-4)
\]
for every $n>3$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A203365.
