...
\title{The empirical recurrence for OEIS A235179, proved by transfer matrix}
...
\begin{abstract}
OEIS A235179 counts $2$-column arrays over $\{0,\dots,5\}$ in which every
...
OEIS A235179 is ``Number of (n+1) X (1+1) 0..5 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 5, with no adjacent elements equal (constant-stress tilted 1 X 1 tilings).''. It has offset
$1$ and begins
\[
72, 212, 576, 1696, 4656, 13736, 38064,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 16*a(n-2) - 65*a(n-4) + 14*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 19 2022 01:34:20, revision 10) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A235179.
