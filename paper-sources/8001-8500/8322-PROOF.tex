...
\title{The empirical recurrence for OEIS A232935, proved by transfer matrix}
...
\begin{abstract}
OEIS A232935 counts arrays of width $2$ over $\{0,\dots,2\}$ under a condition on each cell
...
OEIS A232935 is ``Number of n X 2 0..2 arrays with no element x(i,j) adjacent to value 2-x(i,j) horizontally, vertically or antidiagonally.''. It has offset $1$ and begins
\[
6, 12, 26, 56, 120, 258, 554, 1190,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + 2*a(n-2) + a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 06 2018 06:15:20, revision 8) this is still
...
\]
those falling outside the array being absent. The entry requires that no cell $v$ has a neighbour equal to $2-v$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232935.
