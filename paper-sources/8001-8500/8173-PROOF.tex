...
\title{The empirical recurrence for OEIS A251383, proved by transfer matrix}
...
\begin{abstract}
OEIS A251383 counts $2$-column arrays over $\{0,\dots,2\}$ in which every
...
\mathbf{1}$ for the adjacency matrix $M$ of that digraph, on $S=9$ vertices. Writing
...
OEIS A251383 is ``Number of (n+1) X (1+1) 0..2 arrays with every 2 X 2 subblock summing to 2 3 4 5 or 6.''. It has offset $1$
and begins
\[
71, 571, 4585, 36825, 295759, 2375387, 19077905, 153224073,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 8*a(n-1) + a(n-2) - 6*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 29 2018 10:37:22, revision 8) the statement is
...
Let $V=\{0,1,\dots,2\}^{2}$, the set of possible rows, so $|V|=S=9$. For
...
bound $j<S=9$ rather than to a sampled prefix, in exact integer arithmetic, and returned
zero throughout.

\begin{thebibliography}{9}
\bibitem{oeis} The OEIS Foundation, \emph{The On-Line Encyclopedia of Integer
Sequences}, \url{https://oeis.org}, 2026. Sequence A251383.
