...
\title{The empirical recurrence for OEIS A165381, derived from the entry's generating function}
...
\begin{abstract}
OEIS A165381 carries an empirical recurrence of order $3$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 26 2018 12:14:51, revision 9) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- x^{8} - 13 x^{7} - 58 x^{6} - 249 x^{5} - 268 x^{4} - 174 x^{3} - 37 x^{2}}{x^{3} - 3 x^{2} + 3 x - 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;x^{8} + 13 x^{7} + 58 x^{6} + 249 x^{5} + 268 x^{4} + 174 x^{3} + 37 x^{2},
\]
