...
\title{The empirical recurrence for OEIS A297333, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297333 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A297333 is ``Number of n X 3 0..1 arrays with every 1 horizontally or antidiagonally adjacent to 0 or 2 neighboring 1s.''. It has offset $1$ and begins
\[
5, 22, 96, 421, 1847, 8105, 35568, 156089,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 5*a(n-1) - 2*a(n-2) - 3*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 26 2019 14:32:23, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) - 2\,a(n-2) - 3\,a(n-3)
\end{equation}
for all $n>4$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297333.
