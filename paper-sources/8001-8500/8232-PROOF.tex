...
\title{The empirical recurrence for OEIS A232510, proved by transfer matrix}
...
\begin{abstract}
OEIS A232510 counts arrays of width $4$ over $\{0,\dots,2\}$ under a condition on each cell
...
OEIS A232510 is ``Number of (n+1)X(3+1) 0..2 arrays with every element next to itself plus and minus one within the range 0..2 horizontally, diagonally or antidiagonally, with no adjacent elements equal.''. It has offset $1$ and begins
\[
16, 32, 128, 400, 1344, 4416, 14608, 48224,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) +4*a(n-2) +a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 07:28:03, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232510.
