...
\title{A condition on each element and its neighbours: OEIS A297677}
...
\begin{abstract}
OEIS A297677 carries an empirical recurrence of order $6$ contributed by R.~H.~Hardin. It is
...
OEIS A297677 is ``Number of n X 3 0..1 arrays with every 1 horizontally, diagonally or antidiagonally adjacent to 0, 1 or 4 neighboring 1's.''. It has offset $1$ and begins
\[
7, 29, 150, 742, 3744, 18840, 94891, 477850,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 5*a(n-1) -a(n-2) +8*a(n-3) -5*a(n-4) -30*a(n-5) +17*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 20 2021 11:31:54, revision 6) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{The count is a walk count}

The entry counts arrays with $3$ columns over the alphabet $\{0,1\}$, growing one row at a time. Its condition is that every entry equal to $1$ must have exactly $0$, $1$ or $4$ of its horizontal and diagonal and antidiagonal neighbours equal to $1$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297677.
