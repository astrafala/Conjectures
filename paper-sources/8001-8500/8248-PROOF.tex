...
\title{The empirical recurrence for OEIS A184145, proved by transfer matrix}
...
\begin{abstract}
OEIS A184145 counts $(n+1)\times2$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A184145 is ``1/4 the number of (n+1) X 2 0..3 arrays with every 2 X 2 subblock having at least two equal elements connected horizontally or vertically.''. It has offset $1$ and begins
\[
43, 499, 5695, 65227, 746503, 8544883, 97806031, 1119511003,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 9*a(n-1) + 28*a(n-2).
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 12 2018 06:31:51, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;9\,a(n-1) + 28\,a(n-2)
\end{equation}
for all $n>1$.
...
\[
a(n)-\sum_i c_i\,a(n-i)\;=\;\tfrac1{4}\mathbf{1}^{\!\top}M^{\,n+1-1-2}\,q(M)\,\mathbf{1} .
\]
...
=\tfrac1{4}\mathbf{1}^{\!\top}M^{\,m-2}\,q(M)\,\mathbf{1}
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A184145.
