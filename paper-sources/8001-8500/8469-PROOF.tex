...
\title{The empirical recurrence for OEIS A207683, proved by transfer matrix}
...
\begin{abstract}
OEIS A207683 counts arrays over $\{0,\dots,1\}$ of width $3$ that avoid the patterns
...
OEIS A207683 is ``Number of 3 X n 0..1 arrays avoiding 0 0 0 and 1 0 1 horizontally and 0 0 1 and 1 1 1 vertically.''. It has offset
$1$ and begins
\[
6, 36, 72, 164, 336, 702, 1488,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-2) + 6*a(n-3) + 4*a(n-4) - 6*a(n-6) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 05 2018 10:00:12, revision
8) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-2) + 6\,a(n-3) + 4\,a(n-4) - 6\,a(n-6)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207683.
