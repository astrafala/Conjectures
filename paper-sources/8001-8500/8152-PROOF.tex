...
\title{The empirical recurrence for OEIS A228501, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A228501 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A228501 is ``Number of n X 3 binary arrays with top left value 1 and no two ones adjacent horizontally, vertically, diagonally or antidiagonally.''. It has offset $1$ and begins
\[
2, 3, 12, 29, 88, 239, 684, 1909,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) + 3*a(n-2) - 2*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 11 2018 09:45:51, revision 11) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A228501.
