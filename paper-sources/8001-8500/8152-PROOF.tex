...
\title{The empirical recurrence for OEIS A232077, proved by transfer matrix}
...
\begin{abstract}
OEIS A232077 counts arrays of width $2$ over $\{0,\dots,1\}$ under a condition on each cell
...
OEIS A232077 is ``Number of (1+1) X (n+1) 0..1 arrays with every element equal to some horizontal, diagonal or antidiagonal neighbor, with top left element zero.''. It has offset $1$ and begins
\[
3, 15, 46, 161, 601, 2208, 8053, 29415,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) + a(n-2) + 4*a(n-3) + 4*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 19 2018 06:57:31, revision 7) this is still
...
first term. There are $2^{2}=4$ possible rows over the entry's own alphabet. The state count $S=20$ is exactly $4\cdot5$,
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232077.
