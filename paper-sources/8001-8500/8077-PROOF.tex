...
\title{The empirical recurrence for OEIS A256728, proved by transfer matrix}
...
\begin{abstract}
OEIS A256728 counts arrays of width $3$ over $\{0,1\}$ in which every $3\times3$ window has
...
so the count is a walk count on $S=73$ states.
\end{abstract}
...
OEIS A256728 is ``Number of (n+2) X (1+2) 0..1 arrays with no 3 x 3 subblock diagonal sum zero and no antidiagonal sum three.''. It has offset $1$ and begins
\[
384, 2304, 13056, 73984, 413440, 2310400, 12865280, 71639296,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 7*a(n-1) - 56*a(n-3) + 64*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 20 2018 12:42:08, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The array has $3$ cells across, with entries in $\{0,1\}$. A WINDOW is a $3\times3$ block
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A256728.
