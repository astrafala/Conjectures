...
\title{The empirical recurrence for OEIS A297817, proved by transfer matrix}
...
\begin{abstract}
OEIS A297817 counts $2$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A297817 is ``Number of nX2 0..1 arrays with every element equal to 1, 2 or 3 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 4, 17, 49, 166, 573, 1933, 6538,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) +a(n-2) +2*a(n-3) -2*a(n-4) -4*a(n-5) for n>6
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 06 2018 10:54:14, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297817.
