...
\title{The empirical recurrence for OEIS A255152, proved by transfer matrix}
...
\begin{abstract}
OEIS A255152 counts $(n+2)\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A255152 is ``Number of (n+2) X (1+2) 0..1 arrays with no 3 x 3 subblock diagonal sum 1 and no antidiagonal sum 1 and no row sum 0 or 1 and no column sum 0 or 1.''. It has offset $1$ and begins
\[
28, 62, 141, 331, 773, 1782, 4105, 9484,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) - a(n-2) + 3*a(n-3) + a(n-4) + 2*a(n-5) + 2*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 18 2018 11:30:04, revision 7) this is still
...
at once. By Lemma~\ref{lem:crit} the recurrence holds for every $n>6$.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A255152.
