...
\title{The empirical recurrence for OEIS A301946, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A301946 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A301946 is ``Number of nX3 0..1 arrays with every element equal to 1, 2 or 3 horizontally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
1, 5, 20, 83, 342, 1411, 5820, 24007,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 4*a(n-1) +a(n-2) -2*a(n-3)
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 29 2018 12:42:28, revision 4) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A301946.
