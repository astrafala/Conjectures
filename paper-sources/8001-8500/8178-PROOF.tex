...
\title{The empirical recurrence for OEIS A303416, proved by transfer matrix}
...
\begin{abstract}
OEIS A303416 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A303416 is ``Number of n X 3 0..1 arrays with every element equal to 0, 1, 2, 3, 4 or 5 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
4, 32, 252, 1988, 15684, 123732, 976132, 7700788,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 7*a(n-1) +6*a(n-2) +8*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 02 2022 01:11:01, revision
6) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;7\,a(n-1) + 6\,a(n-2) + 8\,a(n-3)
\end{equation}
for all $n>3$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A303416.
