...
\title{The empirical recurrence for OEIS A251336, proved by transfer matrix}
...
\begin{abstract}
OEIS A251336 counts $(n+1)\times2$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A251336 is ``Number of (n+1) X (1+1) 0..3 arrays with every 2 X 2 subblock summing to a nonzero multiple of 3.''. It has offset $1$ and begins
\[
85, 455, 2450, 13275, 72375, 397000, 2190625, 12156875,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 10*a(n-1) - 20*a(n-2) - 25*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 29 2018 10:36:50, revision 9) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251336.
