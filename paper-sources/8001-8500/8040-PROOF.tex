...
\title{The empirical recurrence for OEIS A206130, proved by transfer matrix}
...
\begin{abstract}
OEIS A206130 counts arrays over $\{0,\dots,3\}$ under a condition on the perimeter cycle of
...
OEIS A206130 is ``Number of (n+1) X 2 0..3 arrays with every 2 X 3 or 3 X 2 subblock having exactly three counterclockwise and three clockwise edge increases.''. It has offset $1$ and begins
\[
256, 564, 3092, 19660, 125236, 797996, 5085012, 32403084,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 8*a(n-1) - 11*a(n-2) + 4*a(n-3) for n > 5.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 13 2018 14:51:04, revision 14) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206130.
