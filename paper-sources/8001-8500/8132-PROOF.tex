...
\title{The empirical recurrence for OEIS A204605, proved by transfer matrix}
...
\begin{abstract}
OEIS A204605 counts $(n+2)\times8$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
$a(n)$ is a walk count on $S=601660$ vertices. Such a sequence is $C$-finite, so whether a given
...
OEIS A204605 is ``Number of (n+2)X8 0..2 arrays with every 3X3 subblock having three strictly increasing elements in a row horizontally, vertically or nw-to-se diagonally exactly one way.''. It has offset $1$ and begins
\[
153711850, 304865717, 327968423, 774393122, 1139760144, 1719348416, 9620299328, 81184579243,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 442*a(n-3) +43*a(n-6) for n>17
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 11:21:00, revision 9) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204605.
