...
\title{The empirical recurrence for OEIS A278274, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A278274 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A278274 is ``Number of n X 2 0..1 arrays with every element both equal and not equal to some elements at offset (-1,-1) (-1,0) (-1,1) (0,-1) (0,1) or (1,0), with upper left element zero.''. It has offset $1$ and begins
\[
0, 2, 5, 16, 49, 153, 476, 1483,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) + a(n-2) - 2*a(n-3) for n>4.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 09 2019 08:49:27, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A278274.
