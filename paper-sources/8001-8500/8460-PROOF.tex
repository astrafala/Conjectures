...
\title{The empirical recurrence for OEIS A223372, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A223372 counts arrays over $\{0,\dots,8\}$ in which every cell is constrained by the
...
OEIS A223372 is ``3X3 square grid graph coloring a rectangular array: number of nX1 0..8 arrays where 0..8 label nodes of the square grid graph and every array movement to a horizontal or vertical neighbor moves along an edge of this graph.''. It has offset $1$ and begins
\[
9, 24, 68, 192, 544, 1536, 4352, 12288,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 8*a(n-2) for n>3
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 21:34:52, revision 8) the statement is
...
$9$ values, so there are about $10^{23}$ of them to sift. The
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223372.
