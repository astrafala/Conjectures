...
\title{The empirical recurrence for OEIS A258962, proved by transfer matrix}
...
\begin{abstract}
OEIS A258962 counts $(n+2)\times6$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A258962 is ``Number of (n+2) X (4+2) 0..1 arrays with no 3 X 3 subblock diagonal sum 0 and no antidiagonal sum 3 and no row sum 0 or 3 and no column sum 0 or 3.''. It has offset $1$ and begins
\[
462, 467, 286, 312, 340, 503, 662, 761,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-2) + 4*a(n-4) - 4*a(n-6) for n>12.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 24 2018 07:45:48, revision 7) this is still
...
First, the transfer model reproduces all $36$ terms the entry publishes, exactly, in
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A258962.
