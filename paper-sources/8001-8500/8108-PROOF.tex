...
\title{The empirical recurrence for OEIS A210149, proved by transfer matrix}
...
\begin{abstract}
OEIS A210149 counts $(n+1)\times2$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A210149 is ``1/4 the number of (n+1) X 2 0..3 arrays with every 2 X 2 subblock having one, three or four distinct clockwise edge differences.''. It has offset $1$ and begins
\[
57, 820, 11783, 169343, 2433709, 34976109, 502659771, 7223984325,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 11*a(n-1) + 46*a(n-2) + 36*a(n-3) - 10*a(n-4) - 8*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 14 2018 15:35:13, revision 10) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;11\,a(n-1) + 46\,a(n-2) + 36\,a(n-3) - 10\,a(n-4) - 8\,a(n-5)
\end{equation}
for all $n>4$.
...
\[
a(n)-\sum_i c_i\,a(n-i)\;=\;\tfrac1{4}\mathbf{1}^{\!\top}M^{\,n+1-1-5}\,q(M)\,\mathbf{1} .
\]
...
=\tfrac1{4}\mathbf{1}^{\!\top}M^{\,m-5}\,q(M)\,\mathbf{1}
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A210149.
