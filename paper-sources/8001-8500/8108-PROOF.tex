...
\title{The empirical recurrence for OEIS A184766, proved by transfer matrix}
...
\begin{abstract}
OEIS A184766 counts arrays over $\{0,\dots,3\}$ under a condition on the determinant of every
...
OEIS A184766 is ``Number of (n+1) X 3 0..3 arrays with every 2 X 2 subblock singular.''. It has offset $1$ and begins
\[
424, 8272, 108496, 1792144, 27993232, 454774672, 7339536784, 119205236368,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 20*a(n-1) - 19*a(n-2) - 792*a(n-3) + 1800*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 15 2018 07:57:48, revision 9) this is still
...
first term is $424$, and the model reproduces it along with every later term; that is the
...
\begin{theorem}
\[
a(n)\;=\;20\,a(n-1) - 19\,a(n-2) - 792\,a(n-3) + 1800\,a(n-4)
\]
for every $n>3$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A184766.
