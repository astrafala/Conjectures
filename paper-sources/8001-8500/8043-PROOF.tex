...
\title{The empirical recurrence for OEIS A228502, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A228502 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A228502 is ``Number of n X 4 binary arrays with top left value 1 and no two ones adjacent horizontally, vertically, diagonally or antidiagonally.''. It has offset $1$ and begins
\[
3, 5, 29, 87, 358, 1252, 4749, 17285,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) + 7*a(n-2) - 2*a(n-3) - 3*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 12 2018 06:13:29, revision 12) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 7\,a(n-2) - 2\,a(n-3) - 3\,a(n-4)
\end{equation}
for all $n>4$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A228502.
