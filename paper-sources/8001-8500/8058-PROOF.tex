...
\title{The empirical recurrence for OEIS A228684, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A228684 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A228684 is ``Number of 3 X n binary arrays with no two ones adjacent horizontally, diagonally or antidiagonally.''. It has offset $1$ and begins
\[
8, 17, 77, 216, 809, 2529, 8832, 28793,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) + 6*a(n-2) - 5*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 12 2018 12:04:10, revision 10) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A228684.
