...
\title{The empirical recurrence for OEIS A205354, derived from the entry's generating function}
...
\begin{abstract}
OEIS A205354 carries an empirical recurrence of order $2$. The entry separately records a
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 03 2018 13:52:29, revision 11) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 20 x^{2} + 14 x}{4 x^{2} - 5 x + 1},
\]
