...
\title{The empirical recurrence for OEIS A164760, derived from the entry's generating function}
...
\begin{abstract}
OEIS A164760 carries an empirical recurrence of order $7$. The entry separately records a
...
OEIS A164760 is ``Number of n X 3 1..4 arrays with all 1s connected, all 2s connected, all 3s connected, all 4s connected, 1 in the upper left corner, 2 in the upper right corner, 3 in the lower left corner, 4 in the lower right corner, and with no element having more than 3 neighbors with the same value.''. It has offset $2$ and begins
\[
8, 104, 670, 3096, 11786, 39564, 121678, 350992,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 25 2018 11:41:55, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 8 x^{8} - 16 x^{7} - 14 x^{6} + 4 x^{5} + 34 x^{4} - 24 x^{3} - 8 x^{2}}{8 x^{7} - 44 x^{6} + 102 x^{5} - 129 x^{4} + 96 x^{3} - 42 x^{2} + 10 x - 1},
\]
the entry's own generating function, and let
\[
D(x)\;=\;1-\sum_i c_i x^{i}\;=\;- 8 x^{7} + 44 x^{6} - 102 x^{5} + 129 x^{4} - 96 x^{3} + 42 x^{2} - 10 x + 1
\]
...
\begin{theorem}
\[
a(n)\;=\;10\,a(n-1) - 42\,a(n-2) + 96\,a(n-3) - 129\,a(n-4) + 102\,a(n-5) - 44\,a(n-6) + 8\,a(n-7)
\]
for every $n>8$.
\end{theorem}
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;8 x^{8} + 16 x^{7} + 14 x^{6} - 4 x^{5} - 34 x^{4} + 24 x^{3} + 8 x^{2},
\]
...
\[
8 x^{7} - 44 x^{6} + 102 x^{5} - 129 x^{4} + 96 x^{3} - 42 x^{2} + 10 x - 1,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A164760.
