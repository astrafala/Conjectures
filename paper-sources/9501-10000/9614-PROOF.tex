...
\title{The empirical recurrence for OEIS A206336, derived from the entry's generating function}
...
\begin{abstract}
OEIS A206336 carries an empirical recurrence of order $3$. The entry separately records a
...
OEIS A206336 is ``Number of (n+1) X 2 0..3 arrays with every 2 X 2 subblock having nonzero determinant and commuting with every horizontal or vertical neighbor.''. It has offset $1$ and begins
\[
192, 96, 455, 296, 1376, 880, 4111, 2622,\ \dots
\]
...
\begin{quote}
G.f.: x*(192 - 96*x - 217*x\^{}2 + 129*x\^{}3 + 3*x\^{}4 - 19*x\^{}5 - 9*x\^{}6 - x\^{}7 + 4*x\^{}8 + 2*x\^{}9) / ((1 - x)*(1 - 3*x\^{}2)).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 15 2018 10:39:22, revision 8) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{2 x^{10} + 4 x^{9} - x^{8} - 9 x^{7} - 19 x^{6} + 3 x^{5} + 129 x^{4} - 217 x^{3} - 96 x^{2} + 192 x}{3 x^{3} - 3 x^{2} - x + 1},
\]
...
In exact arithmetic,
\[
D(x)\,G(x)\;=\;2 x^{10} + 4 x^{9} - x^{8} - 9 x^{7} - 19 x^{6} + 3 x^{5} + 129 x^{4} - 217 x^{3} - 96 x^{2} + 192 x,
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206336.
