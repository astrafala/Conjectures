...
\title{A proof of the conjectured recurrence for OEIS A112703}
...
\begin{abstract}
OEIS A112703 carries a conjectured linear recurrence with polynomial coefficients, of
...
OEIS A112703 is ``Partial sum of Catalan numbers A000108 multiplied by powers of 9''. It has offset $0$ and begins
\[
a(0),\dots,a(7)\;=\;1, 10, 172, 3817, 95671, 2575729, 72725941, 2124619642,\ \dots
\]
The entry gives the generating function
\begin{equation}\label{eq:gf}
A(x)\;=\;\sum_{n\ge 0} a(n)\,x^{n}\;=\;\frac{\sqrt{1 - 36 x} - 1}{18 x \left(x - 1\right)} ,
\end{equation}
and it carries the following comment:
\begin{quote}\small
\textbf{Conjecture:} +(n+1)*a(n) +(-37*n+17)*a(n-1) +18*(2*n-1)*a(n-2)=0. - \emph{R. J. Mathar}, Jun 08 2016
\end{quote}
As of the ``Last modified'' line on the live entry (2016-06-22, revision 9) the
...
\[
p_{0}(n)=n + 1,\qquad p_{1}(n)=17 - 37 n,\qquad p_{2}(n)=18 \left(2 n - 1\right)
\]
...
\section{The computation for A112703}
...
\[
(n + 1)\,a(n) + (17 - 37 n)\,a(n-1) + 18 \left(2 n - 1\right)\,a(n-2) \;=\;0
\]
holds for every $n>0$.
\end{theorem}
...
section of A112703, agreeing on all 13 terms compared.
...
\url{https://oeis.org}, 2026. Sequence A112703.
