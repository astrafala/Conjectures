...
\title{A proof of the conjectured recurrence for OEIS A101601}
...
\begin{abstract}
OEIS A101601 carries a conjectured linear recurrence with polynomial coefficients, of
...
OEIS A101601 is ``Expansion of g.f. c(3x)\^{}3, where c(x) is the g.f. of A000108''. It has offset $0$ and begins
\[
a(0),\dots,a(7)\;=\;1, 9, 81, 756, 7290, 72171, 729729, 7505784,\ \dots
\]
The entry gives the generating function
\begin{equation}\label{eq:gf}
A(x)\;=\;\sum_{n\ge 0} a(n)\,x^{n}\;=\;\frac{8}{\left(\sqrt{1 - 12 x} + 1\right)^{3}} ,
\end{equation}
and it carries the following comment:
\begin{quote}\small
\textbf{Conjecture:} (n+3)*a(n) - 3*(5*n+7)*a(n-1) + 18*(2*n-1)*a(n-2) = 0. - \emph{R. J. Mathar}, Nov 15 2011
\end{quote}
As of the ``Last modified'' line on the live entry (2025-10-10, revision 24) the
...
\[
p_{0}(n)=n + 3,\qquad p_{1}(n)=- 3 \left(5 n + 7\right),\qquad p_{2}(n)=18 \left(2 n - 1\right)
\]
...
\section{The computation for A101601}
...
\[
(n + 3)\,a(n) -  3 \left(5 n + 7\right)\,a(n-1) + 18 \left(2 n - 1\right)\,a(n-2) \;=\;0
\]
holds for every $n>0$.
\end{theorem}
...
section of A101601, agreeing on all 13 terms compared.
...
\url{https://oeis.org}, 2026. Sequence A101601.
