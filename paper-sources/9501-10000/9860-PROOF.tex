...
\title{A proof of the conjectured recurrence for OEIS A126932}
...
\begin{abstract}
OEIS A126932 carries a conjectured linear recurrence with polynomial coefficients, of
...
OEIS A126932 is ``Binomial transform of A127358''. It has offset $0$ and begins
\[
a(0),\dots,a(7)\;=\;1, 4, 15, 55, 199, 714, 2547, 9048,\ \dots
\]
The entry gives the generating function
\begin{equation}\label{eq:gf}
A(x)\;=\;\sum_{n\ge 0} a(n)\,x^{n}\;=\;\frac{- 9 x + \sqrt{- 3 x^{2} - 2 x + 1} + 3}{2 \left(21 x^{2} - 13 x + 2\right)} ,
\end{equation}
and it carries the following comment:
\begin{quote}\small
\textbf{Conjecture:} +2*n*a(n) -11*n*a(n-1) +4*(2*n+3)*a(n-2) +21*(n-2)*a(n-3)=0. - \emph{R. J. Mathar}, Nov 24 2012
\end{quote}
...
\[
p_{0}(n)=2 n,\qquad p_{1}(n)=- 11 n,\qquad p_{2}(n)=4 \left(2 n + 3\right),\qquad p_{3}(n)=21 \left(n - 2\right)
\]
...
\section{The computation for A126932}
...
\[
2 n\,a(n) -  11 n\,a(n-1) + 4 \left(2 n + 3\right)\,a(n-2) + 21 \left(n - 2\right)\,a(n-3) \;=\;0
\]
holds for every $n>1$.
\end{theorem}
...
section of A126932, agreeing on all 13 terms compared.
...
\url{https://oeis.org}, 2026. Sequence A126932.
