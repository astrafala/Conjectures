...
\title{The empirical recurrence for OEIS A232018, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A232018 counts arrays over $\{0,\dots,2\}$ in which every cell is constrained by the
...
OEIS A232018 is ``Number of n X 3 0..2 arrays with no element less than a strict majority of its horizontal and antidiagonal neighbors.''. It has offset $1$ and begins
\[
9, 66, 852, 11517, 156913, 2125749, 28852936, 391447970,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 9*a(n-1) + 59*a(n-2) + 62*a(n-3) - 275*a(n-4) - 257*a(n-5) + 146*a(n-6) + 84*a(n-7) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 01 2018 21:10:18, revision 7) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;9\,a(n-1) + 59\,a(n-2) + 62\,a(n-3) - 275\,a(n-4) - 257\,a(n-5) + 146\,a(n-6) + 84\,a(n-7)
\end{equation}
for all $n>8$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232018.
