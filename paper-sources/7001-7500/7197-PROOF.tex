...
\title{The empirical recurrence for OEIS A317067, proved by transfer matrix}
...
\begin{abstract}
OEIS A317067 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A317067 is ``Number of nX3 0..1 arrays with every element unequal to 1, 2, 3, 4, 5, 6 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 25, 153, 1161, 8529, 62866, 463269, 3413985,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 6*a(n-1) +9*a(n-2) +8*a(n-3) +a(n-4) -5*a(n-5) -2*a(n-6) -a(n-7) -a(n-8)
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 20 2018 13:38:22, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) + 9\,a(n-2) + 8\,a(n-3) + a(n-4) - 5\,a(n-5) - 2\,a(n-6) - a(n-7) - a(n-8)
\end{equation}
for all $n>8$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A317067.
