...
\title{The empirical recurrence for OEIS A283539, proved by transfer matrix}
...
\begin{abstract}
OEIS A283539 counts $n\times4$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
walk, and $a(n)$ is a walk count on $S=89$ vertices, which is $C$-finite. Whether the
...
OEIS A283539 is ``Number of n X 4 0..1 arrays with no 1 equal to more than one of its horizontal, diagonal and antidiagonal neighbors.''. It has offset $1$ and begins
\[
13, 76, 578, 4089, 29558, 212441, 1529463, 11006233,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 6*a(n-1) + 10*a(n-2) - 14*a(n-3) + 27*a(n-4) + 26*a(n-5) - 85*a(n-6) - 10*a(n-7) + 16*a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 21 2019 08:18:56, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) + 10\,a(n-2) - 14\,a(n-3) + 27\,a(n-4) + 26\,a(n-5) - 85\,a(n-6) - 10\,a(n-7) + 16\,a(n-8)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A283539.
