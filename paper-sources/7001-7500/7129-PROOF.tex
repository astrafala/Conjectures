...
\title{The empirical recurrence for OEIS A278275, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A278275 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A278275 is ``Number of n X 3 0..1 arrays with every element both equal and not equal to some elements at offset (-1,-1) (-1,0) (-1,1) (0,-1) (0,1) or (1,0), with upper left element zero.''. It has offset $1$ and begins
\[
0, 4, 25, 136, 839, 5013, 30370, 183403,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 6*a(n-1) + 3*a(n-2) - 17*a(n-3) + 19*a(n-5) - 16*a(n-6) + 8*a(n-7) for n>9.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 09 2019 08:49:34, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) + 3\,a(n-2) - 17\,a(n-3) + 19\,a(n-5) - 16\,a(n-6) + 8\,a(n-7)
\end{equation}
for all $n>9$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A278275.
