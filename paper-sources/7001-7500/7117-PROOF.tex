...
\title{The empirical recurrence for OEIS A228681, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A228681 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A228681 is ``Number of n X 6 binary arrays with no two ones adjacent horizontally, diagonally or antidiagonally.''. It has offset $1$ and begins
\[
21, 217, 2529, 28977, 333517, 3837761, 44171841, 508425617,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 14*a(n-1) - 17*a(n-2) - 142*a(n-3) + 59*a(n-4) + 352*a(n-5) + 103*a(n-6) - 48*a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 12 2018 10:04:55, revision 11) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A228681.
