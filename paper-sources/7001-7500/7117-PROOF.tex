...
\title{The empirical recurrence for OEIS A316178, proved by transfer matrix}
...
\begin{abstract}
OEIS A316178 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A316178 is ``Number of nX3 0..1 arrays with every element unequal to 0, 1, 2, 3, 4 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
4, 30, 134, 601, 2665, 11915, 53134, 237241,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) +8*a(n-2) -4*a(n-3) -11*a(n-4) -a(n-5) -13*a(n-7) +2*a(n-8) -a(n-9) -a(n-10) -a(n-11) for n>12
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 25 2018 17:45:41, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 8\,a(n-2) - 4\,a(n-3) - 11\,a(n-4) - a(n-5) - 13\,a(n-7) + 2\,a(n-8) - a(n-9) - a(n-10) - a(n-11)
\end{equation}
for all $n>12$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A316178.
