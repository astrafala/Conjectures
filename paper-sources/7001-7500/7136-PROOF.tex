...
\title{The empirical recurrence for OEIS A208105, proved by transfer matrix}
...
\begin{abstract}
OEIS A208105 counts arrays over $\{0,\dots,1\}$ of width $5$ that avoid the patterns
...
OEIS A208105 is ``Number of nX5 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 1 1 and 1 1 0 vertically.''. It has offset
$1$ and begins
\[
15, 225, 611, 1805, 6235, 22995, 89815,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 7*a(n-1) -8*a(n-2) -27*a(n-3) +45*a(n-4) +24*a(n-5) -51*a(n-6) -3*a(n-7) +16*a(n-8) -a(n-9) -a(n-10) for n>11
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:38:23, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208105.
