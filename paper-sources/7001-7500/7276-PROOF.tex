...
\title{The empirical recurrence for OEIS A252133, proved by transfer matrix}
...
\begin{abstract}
OEIS A252133 counts $(n+2)\times4$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252133 is ``Number of (n+2) X (2+2) 0..3 arrays with every 3 X 3 subblock row, column, diagonal and antidiagonal sum not equal to 0 3 4 6 or 7.''. It has offset $1$ and begins
\[
134, 156, 431, 1183, 3163, 8684, 24031, 66098,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + a(n-2) + 4*a(n-3) - a(n-4) - 4*a(n-5) - 3*a(n-6) + a(n-8) + a(n-9) for n>11.
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 20 2018 10:16:49, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252133.
