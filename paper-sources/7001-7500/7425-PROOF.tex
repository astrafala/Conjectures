...
\title{The empirical recurrence for OEIS A251352, proved by transfer matrix}
...
\begin{abstract}
OEIS A251352 counts $(n+1)\times2$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A251352 is ``Number of (n+1)X(1+1) 0..3 arrays with no 2X2 subblock having its maximum diagonal element less than the absolute difference of its antidiagonal elements.''. It has offset $1$ and begins
\[
216, 2920, 39594, 536886, 7279536, 98701641, 1338276196, 18145426216,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 16*a(n-1) -40*a(n-2) +104*a(n-3) -150*a(n-4) +118*a(n-5) -48*a(n-6) +9*a(n-7)
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:17:13, revision 7) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;16\,a(n-1) - 40\,a(n-2) + 104\,a(n-3) - 150\,a(n-4) + 118\,a(n-5) - 48\,a(n-6) + 9\,a(n-7)
\end{equation}
for all $n>6$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251352.
