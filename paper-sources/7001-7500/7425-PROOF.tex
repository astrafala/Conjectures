...
\title{The empirical recurrence for OEIS A188516, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A188516 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A188516 is ``Number of nX2 binary arrays without the pattern 1 1 0 diagonally, vertically or horizontally.''. It has offset $1$ and begins
\[
4, 16, 49, 144, 400, 1089, 2916, 7744,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n)=4*a(n-1)-2*a(n-2)-6*a(n-3)+4*a(n-4)+2*a(n-5)-a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 22 2025 11:14:47, revision 19) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A188516.
