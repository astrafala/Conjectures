...
\title{The empirical recurrence for OEIS A189059, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A189059 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A189059 is ``Number of n X 4 binary arrays without the pattern 0 1 0 antidiagonally or horizontally.''. It has offset $1$ and begins
\[
12, 144, 1404, 13452, 128628, 1228512, 11733712, 112065936,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 12*a(n-1) -20*a(n-2) -40*a(n-3) +64*a(n-4) +100*a(n-5) -176*a(n-6) +64*a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (May 01 2018 13:04:39, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;12\,a(n-1) - 20\,a(n-2) - 40\,a(n-3) + 64\,a(n-4) + 100\,a(n-5) - 176\,a(n-6) + 64\,a(n-7)
\end{equation}
for all $n>8$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A189059.
