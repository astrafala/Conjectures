...
\title{The empirical recurrence for OEIS A296798, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A296798 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A296798 is ``Number of n X 2 0..1 arrays with each 1 adjacent to 1, 3 or 4 king-move neighboring 1s.''. It has offset $1$ and begins
\[
2, 8, 15, 41, 122, 308, 855, 2405,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) + 3*a(n-2) + 9*a(n-3) - 4*a(n-4) - 12*a(n-5) - 16*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 25 2019 09:20:56, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 3\,a(n-2) + 9\,a(n-3) - 4\,a(n-4) - 12\,a(n-5) - 16\,a(n-6)
\end{equation}
for all $n>7$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A296798.
