...
\title{The empirical recurrence for OEIS A250669, proved by transfer matrix}
...
\begin{abstract}
OEIS A250669 counts arrays over $\{0,1,2,3\}$ in which a statistic taken over short runs
...
OEIS A250669 is ``Number of (n+1)X(1+1) 0..3 arrays with nondecreasing x(i,j)+x(i,j-1) in the i direction and nondecreasing absolute value of x(i,j)-x(i-1,j) in the j direction.''. It has offset $1$ and begins
\[
104, 520, 2512, 11736, 53032, 233300, 1005121, 4260728,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 16*a(n-1) -106*a(n-2) +376*a(n-3) -769*a(n-4) +904*a(n-5) -564*a(n-6) +144*a(n-7) for n>11
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 12:39:48, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;16\,a(n-1) - 106\,a(n-2) + 376\,a(n-3) - 769\,a(n-4) + 904\,a(n-5) - 564\,a(n-6) + 144\,a(n-7)
\]
for every $n>11$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250669.
