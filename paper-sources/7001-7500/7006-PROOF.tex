...
\title{The empirical recurrence for OEIS A228756, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A228756 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A228756 is ``Number of 4 X n binary arrays with top left element equal to 1 and no two ones adjacent horizontally or antidiagonally.''. It has offset $1$ and begins
\[
8, 21, 168, 780, 4599, 24246, 134440, 728537,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) + 20*a(n-2) + 27*a(n-3) - 14*a(n-4) - 25*a(n-5) + 4*a(n-6) + 5*a(n-7) - a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 13 2018 06:08:03, revision 11) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A228756.
