...
\title{The empirical recurrence for OEIS A234667, proved by transfer matrix}
...
\begin{abstract}
OEIS A234667 counts $2$-column arrays over $\{0,\dots,7\}$ in which every
...
OEIS A234667 is ``Number of (n+1) X (1+1) 0..7 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 4 (constant-stress 1 X 1 tilings).''. It has offset
$1$ and begins
\[
492, 3816, 29568, 229272, 1778412, 13801056, 107144508,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 14*a(n-1) + 25*a(n-2) - 950*a(n-3) + 2091*a(n-4) + 7326*a(n-5) - 3780*a(n-6) - 10080*a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 19 2022 01:04:30, revision 11) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;14\,a(n-1) + 25\,a(n-2) - 950\,a(n-3) + 2091\,a(n-4) + 7326\,a(n-5) - 3780\,a(n-6) - 10080\,a(n-7)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234667.
