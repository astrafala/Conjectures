...
\title{The empirical recurrence for OEIS A237939, proved by transfer matrix}
...
\begin{abstract}
OEIS A237939 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
The condition is local to two consecutive rows, so the count is a walk count on $S=47$
...
OEIS A237939 is ``Number of (n+1)X(2+1) 0..2 arrays with the maximum minus the minimum of every 2X2 subblock equal.''. It has offset $1$ and begins
\[
437, 5519, 70435, 946063, 12909207, 178348911, 2478121687, 34547541807,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 10:36:54, revision 6) this is still
...
array, which is not among the objects counted. There are $S=47$ states left.
...
\begin{theorem}
\[
a(n)\;=\;20\,a(n-1) - 56\,a(n-2) - 524\,a(n-3) + 1719\,a(n-4) + 2496\,a(n-5) - 12490\,a(n-6) + 8016\,a(n-7) + 10172\,a(n-8) - 11936\,a(n-9) + 1560\,a(n-10) + 1344\,a(n-11) - 320\,a(n-12)
\]
for every $n>11$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237939.
