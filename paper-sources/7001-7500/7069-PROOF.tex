...
\title{The empirical recurrence for OEIS A259717, proved by transfer matrix}
...
\begin{abstract}
OEIS A259717 counts $(n+2)\times4$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A259717 is ``Number of (n+2) X (2+2) 0..1 arrays with each 3 X 3 subblock having clockwise perimeter pattern 00000001 or 00000011.''. It has offset $1$ and begins
\[
54, 95, 228, 392, 556, 1219, 2330, 3544,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-2) + 5*a(n-3) + 4*a(n-4) - 4*a(n-5) - 8*a(n-6) - 5*a(n-7) - 3*a(n-8) + 2*a(n-9) + 3*a(n-10).
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 26 2018 11:34:09, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-2) + 5\,a(n-3) + 4\,a(n-4) - 4\,a(n-5) - 8\,a(n-6) - 5\,a(n-7) - 3\,a(n-8) + 2\,a(n-9) + 3\,a(n-10)
\]
for every $n>10$.
\end{theorem}
...
at once. By Lemma~\ref{lem:crit} the recurrence holds for every $n>10$.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A259717.
