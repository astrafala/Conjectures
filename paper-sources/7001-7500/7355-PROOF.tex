...
\title{The empirical recurrence for OEIS A258557, proved by transfer matrix}
...
\begin{abstract}
OEIS A258557 counts the arrays over $\{0,\dots,1\}$ whose $2\times2$ subblocks carry a
...
so a pair of consecutive array rows is a state, the count is a walk count on $S=228$ of them,
...
OEIS A258557 is ``Number of (4+1) X (n+1) 0..1 arrays with every 2 X 2 subblock ne-sw antidiagonal difference nondecreasing horizontally and nw+se diagonal sum nondecreasing vertically.''. It has offset $1$ and begins
\[
228, 652, 1244, 1891, 2509, 3314, 4313, 5356,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) - 3*a(n-2) + a(n-3) + a(n-4) - 3*a(n-5) + 3*a(n-6) - a(n-7) for n>11.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 22 2018 11:33:54, revision 8) this is still
...
\]
on the $S=228$ admissible pairs. In particular $a$ is $C$-finite. The alignment of the walk
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A258557.
