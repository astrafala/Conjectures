...
\title{The empirical recurrence for OEIS A252300, proved by transfer matrix}
...
\begin{abstract}
OEIS A252300 counts $(n+2)\times5$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252300 is ``Number of (n+2)X(3+2) 0..3 arrays with every 3X3 subblock row and diagonal sum equal to 0 1 3 6 or 7 and every 3X3 column and antidiagonal sum not equal to 0 1 3 6 or 7.''. It has offset $1$ and begins
\[
1675, 1370, 1677, 2151, 3669, 5416, 7492, 13386,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 7*a(n-3) -14*a(n-6) +8*a(n-9) for n>18
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:02:34, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252300.
