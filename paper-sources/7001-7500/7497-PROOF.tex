...
\title{The empirical recurrence for OEIS A228657, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A228657 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A228657 is ``Number of n X 5 binary arrays with top left value 1 and no two ones adjacent horizontally, diagonally or antidiagonally.''. It has offset $1$ and begins
\[
5, 38, 335, 2844, 24109, 203762, 1720343, 14516920,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 12*a(n-1) - 27*a(n-2) - 32*a(n-3) + 49*a(n-4) + 20*a(n-5) - 5*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 12 2018 09:08:52, revision 12) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;12\,a(n-1) - 27\,a(n-2) - 32\,a(n-3) + 49\,a(n-4) + 20\,a(n-5) - 5\,a(n-6)
\end{equation}
for all $n>6$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A228657.
