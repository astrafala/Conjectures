...
\title{The empirical recurrence for OEIS A236886, proved by transfer matrix}
...
\begin{abstract}
OEIS A236886 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
OEIS A236886 is ``Number of (n+1) X (1+1) 0..2 arrays with the maximum plus the upper median minus the lower median minus the minimum of every 2 X 2 subblock equal.''. It has offset $1$ and begins
\[
81, 245, 781, 2605, 8901, 31253, 111685, 406949,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 9*a(n-1) - 8*a(n-2) - 136*a(n-3) + 364*a(n-4) + 380*a(n-5) - 2080*a(n-6) + 992*a(n-7) + 2400*a(n-8) - 1920*a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 21 2018 08:27:44, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;9\,a(n-1) - 8\,a(n-2) - 136\,a(n-3) + 364\,a(n-4) + 380\,a(n-5) - 2080\,a(n-6) + 992\,a(n-7) + 2400\,a(n-8) - 1920\,a(n-9)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A236886.
