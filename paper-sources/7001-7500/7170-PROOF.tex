...
\title{The empirical recurrence for OEIS A206201, proved by transfer matrix}
...
\begin{abstract}
OEIS A206201 counts arrays over $\{0,\dots,3\}$ under a condition on the perimeter cycle of
...
a bounded window of consecutive rows, so the count is a walk count on $S=1768$ states and is
...
OEIS A206201 is ``Number of (n+1)X4 0..3 arrays with every 2X3 or 3X2 subblock having exactly one clockwise edge increases.''. It has offset $1$ and begins
\[
1768, 3008, 5136, 11832, 27400, 60800, 145208, 346080,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 10*a(n-3) +5*a(n-4) +a(n-5) +2*a(n-8) +2*a(n-10) for n>18
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 12:46:42, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;10\,a(n-3) + 5\,a(n-4) + a(n-5) + 2\,a(n-8) + 2\,a(n-10)
\]
for every $n>18$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206201.
