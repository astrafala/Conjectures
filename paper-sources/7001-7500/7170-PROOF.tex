...
\title{The empirical recurrence for OEIS A250787, proved by transfer matrix}
...
\begin{abstract}
OEIS A250787 counts arrays over $\{0,1\}$ in which a statistic taken over short runs
...
OEIS A250787 is ``Number of (5+1) X (n+1) 0..1 arrays with nondecreasing x(i,j)+x(i,j-1) in the i direction and nondecreasing absolute value of x(i,j)-x(i-1,j) in the j direction.''. It has offset $1$ and begins
\[
144, 396, 990, 2426, 5688, 12950, 28692, 62274,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 6*a(n-1) - 12*a(n-2) + 5*a(n-3) + 13*a(n-4) - 16*a(n-5) + 2*a(n-6) + 5*a(n-7) - 2*a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 20 2018 03:34:15, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) - 12\,a(n-2) + 5\,a(n-3) + 13\,a(n-4) - 16\,a(n-5) + 2\,a(n-6) + 5\,a(n-7) - 2\,a(n-8)
\]
for every $n>7$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250787.
