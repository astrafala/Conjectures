...
\title{The empirical recurrence for OEIS A297596, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297596 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A297596 is ``Number of 3 X n 0..1 arrays with every 1 horizontally, diagonally or antidiagonally adjacent to 1 or 5 neighboring 1s.''. It has offset $1$ and begins
\[
1, 9, 25, 49, 145, 443, 1141, 3009,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) + a(n-2) + 8*a(n-3) + 7*a(n-4) - 8*a(n-6) - 6*a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 01 2019 14:53:14, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297596.
