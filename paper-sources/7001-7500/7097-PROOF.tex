...
\title{The empirical recurrence for OEIS A204032, proved by transfer matrix}
...
\begin{abstract}
OEIS A204032 counts arrays over $\{0,\dots,1\}$ under a condition on the sum of every
...
OEIS A204032 is ``Number of (n+1) X 2 0..1 arrays with the sums of 2 X 2 subblocks nondecreasing rightwards and downwards.''. It has offset $1$ and begins
\[
16, 44, 121, 286, 676, 1482, 3249, 6840,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) -18*a(n-3) +17*a(n-4) +22*a(n-5) -36*a(n-6) +20*a(n-8) -8*a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 20 2018 07:38:37, revision 11) this is still
...
entry's first term is $16$, and the model reproduces it along with every later term; that
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) - 18\,a(n-3) + 17\,a(n-4) + 22\,a(n-5) - 36\,a(n-6) + 20\,a(n-8) - 8\,a(n-9)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204032.
