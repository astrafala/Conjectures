...
\title{The empirical recurrence for OEIS A252543, proved by transfer matrix}
...
\begin{abstract}
OEIS A252543 counts $(n+2)\times3$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252543 is ``Number of (n+2) X (1+2) 0..3 arrays with every 3 X 3 subblock row and diagonal sum equal to 1 3 4 6 or 7 and every 3 X 3 column and antidiagonal sum not equal to 1 3 4 6 or 7.''. It has offset $1$ and begins
\[
478, 850, 2142, 4644, 13104, 33852, 73800, 208992,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 18*a(n-3) - 32*a(n-6) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 05 2018 06:13:53, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252543.
