...
\title{The empirical recurrence for OEIS A278009, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A278009 counts arrays over $\{0,\dots,2\}$ in which every cell is constrained by the
...
OEIS A278009 is ``Number of nX3 0..2 arrays with every element plus 1 mod 3 equal to some element at offset (-1,-1) (-1,0) (-1,1) (0,-1) (0,1) or (1,0), with upper left element zero.''. It has offset $1$ and begins
\[
0, 28, 410, 7204, 121826, 2072344, 35217368, 598579468,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 16*a(n-1) +19*a(n-2) -38*a(n-3) +57*a(n-4) -146*a(n-5) +201*a(n-6) -264*a(n-7) -36*a(n-8) +144*a(n-9)
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 08 2016 12:26:18, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;16\,a(n-1) + 19\,a(n-2) - 38\,a(n-3) + 57\,a(n-4) - 146\,a(n-5) + 201\,a(n-6) - 264\,a(n-7) - 36\,a(n-8) + 144\,a(n-9)
\end{equation}
for all $n>10$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A278009.
