...
\title{The empirical recurrence for OEIS A261374, proved by transfer matrix}
...
\begin{abstract}
OEIS A261374 counts $(n+2)\times4$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A261374 is ``Number of (n+2) X (2+2) 0..1 arrays with each 3 X 3 subblock having clockwise perimeter pattern 00001011 00010101 or 01010101.''. It has offset $1$ and begins
\[
39, 41, 82, 157, 266, 470, 864, 1553,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-2) + 6*a(n-4) + 4*a(n-6) - a(n-8) for n > 9.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 30 2018 15:41:53, revision 11) this is still
...
\[
\text{the clockwise perimeter word of }g\text{ is a rotation of one of }\{00001011,\ 00010101,\ 01010101\}
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A261374.
