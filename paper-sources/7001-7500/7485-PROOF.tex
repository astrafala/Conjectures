...
\title{The empirical recurrence for OEIS A208119, proved by transfer matrix}
...
\begin{abstract}
OEIS A208119 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
...
OEIS A208119 is ``Number of 4 X n 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 0 1 and 0 1 1 vertically.''. It has offset
$1$ and begins
\[
9, 81, 225, 625, 3025, 14641, 53361,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 5*a(n-1) - 10*a(n-2) + 30*a(n-3) - 120*a(n-5) + 160*a(n-6) - 320*a(n-7) + 256*a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 28 2018 09:22:39, revision
8) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) - 10\,a(n-2) + 30\,a(n-3) - 120\,a(n-5) + 160\,a(n-6) - 320\,a(n-7) + 256\,a(n-8)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208119.
