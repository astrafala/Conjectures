...
\title{The empirical recurrence for OEIS A186134, proved by transfer matrix}
...
\begin{abstract}
OEIS A186134 counts arrays over $\{0,\dots,2\}$ under a condition on the trace of every
...
OEIS A186134 is ``Number of (n+1)X3 0..2 arrays with no 2X2 subblock trace equal to any horizontal or vertical neighbor 2X2 subblock trace.''. It has offset $1$ and begins
\[
558, 7686, 107874, 1512792, 21216780, 297562572, 4173269994, 58529531286,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n)=5*a(n-1)+114*a(n-2)+216*a(n-3)-524*a(n-4)-516*a(n-5)+876*a(n-6)-276*a(n-7)+216*a(n-8)-72*a(n-9)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 03:26:20, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) + 114\,a(n-2) + 216\,a(n-3) - 524\,a(n-4) - 516\,a(n-5) + 876\,a(n-6) - 276\,a(n-7) + 216\,a(n-8) - 72\,a(n-9)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A186134.
