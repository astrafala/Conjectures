...
\title{The empirical recurrence for OEIS A237772, proved by transfer matrix}
...
\begin{abstract}
OEIS A237772 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
OEIS A237772 is ``Number of (n+1)X(1+1) 0..2 arrays with the maximum plus the upper median of every 2X2 subblock differing from its horizontal and vertical neighbors by exactly one.''. It has offset $1$ and begins
\[
81, 300, 1176, 4480, 17768, 67152, 263504, 1002432,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 188*a(n-4) +512*a(n-6) +336*a(n-8) -64*a(n-10) for n>13
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 10:26:29, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;188\,a(n-4) + 512\,a(n-6) + 336\,a(n-8) - 64\,a(n-10)
\]
for every $n>13$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237772.
