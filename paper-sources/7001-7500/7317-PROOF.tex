...
\title{The empirical recurrence for OEIS A252262, proved by transfer matrix}
...
\begin{abstract}
OEIS A252262 counts $(n+2)\times3$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252262 is ``Number of (n+2) X (1+2) 0..3 arrays with every 3 X 3 subblock row, column, diagonal and antidiagonal sum not equal to 2 3 4 6 or 7.''. It has offset $1$ and begins
\[
103, 130, 258, 598, 1342, 2900, 6330, 14024,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + 3*a(n-3) + 4*a(n-4) + 4*a(n-5) + 2*a(n-6) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 03 2018 06:25:35, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252262.
