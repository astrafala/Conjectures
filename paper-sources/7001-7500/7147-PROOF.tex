...
\title{The empirical recurrence for OEIS A318540, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A318540 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A318540 is ``Number of nX3 0..1 arrays with every element unequal to 0, 1, 4 or 6 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
3, 3, 6, 13, 26, 52, 107, 218,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +3*a(n-3) +a(n-4) +3*a(n-5) +a(n-7) for n>8
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 28 2018 11:03:39, revision 4) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A318540.
