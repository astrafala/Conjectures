...
\title{The empirical recurrence for OEIS A196140, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A196140 counts arrays over $\{0,\dots,4\}$ in which every cell is constrained by the
...
OEIS A196140 is ``Number of nX2 0..4 arrays with each element x equal to the number its horizontal and vertical neighbors equal to 3,0,4,1,2 for x=0,1,2,3,4.''. It has offset $1$ and begins
\[
3, 5, 8, 17, 34, 62, 123, 243,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) +a(n-3) -2*a(n-4) -a(n-5) +a(n-6)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 06:24:27, revision 9) the statement is
...
\#\{\text{neighbours with value }f(x_{t,u})\}=x_{t,u},\quad f=(3,0,4,1,2)
\end{equation}
for every cell $(t,u)$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A196140.
