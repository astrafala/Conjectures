...
\title{The empirical recurrence for OEIS A297375, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297375 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A297375 is ``Number of 2 X n 0..1 arrays with every 1 horizontally or antidiagonally adjacent to 0, 1 or 2 neighboring 1s.''. It has offset $1$ and begins
\[
4, 16, 57, 208, 765, 2807, 10294, 37759,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) + a(n-2) + 5*a(n-3) + a(n-4) + a(n-5) - a(n-6) - a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 27 2019 11:45:54, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297375.
