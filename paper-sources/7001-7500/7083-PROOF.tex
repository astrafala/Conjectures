...
\title{The empirical recurrence for OEIS A232903, proved by transfer matrix}
...
\begin{abstract}
OEIS A232903 counts arrays of width $4$ over $\{0,\dots,2\}$ under a condition on each cell
...
OEIS A232903 is ``Number of (n+1)X(3+1) 0..2 arrays with every element next to itself plus and minus one within the range 0..2 horizontally or antidiagonally.''. It has offset $1$ and begins
\[
52, 320, 4928, 62276, 761860, 9880580, 123587140, 1571314692,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 6*a(n-1) +79*a(n-2) +128*a(n-3) -788*a(n-4) +196*a(n-5) -644*a(n-6) +416*a(n-7) -64*a(n-8)
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 07:42:16, revision 6) this is still
...
$52$, which the model reproduces along with every later term. That is the cheapest check
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) + 79\,a(n-2) + 128\,a(n-3) - 788\,a(n-4) + 196\,a(n-5) - 644\,a(n-6) + 416\,a(n-7) - 64\,a(n-8)
\]
for every $n>7$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232903.
