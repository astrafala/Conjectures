...
\title{The empirical recurrence for OEIS A236089, proved by transfer matrix}
...
\begin{abstract}
OEIS A236089 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
OEIS A236089 is ``Number of (n+1)X(1+1) 0..2 arrays colored with the difference of the maximum and the upper median in each 2X2 subblock.''. It has offset $1$ and begins
\[
81, 344, 1512, 6444, 28060, 119928, 519616, 2226672,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 12*a(n-3) +220*a(n-4) +120*a(n-5) +736*a(n-6) +464*a(n-7) -176*a(n-8) +224*a(n-9) -256*a(n-10) for n>11
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 09:05:26, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;12\,a(n-3) + 220\,a(n-4) + 120\,a(n-5) + 736\,a(n-6) + 464\,a(n-7) - 176\,a(n-8) + 224\,a(n-9) - 256\,a(n-10)
\]
for every $n>11$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A236089.
