...
\title{The empirical recurrence for OEIS A228799, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A228799 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A228799 is ``Number of 4 X n binary arrays with top left element equal to 1 and no two ones adjacent horizontally or nw-se.''. It has offset $1$ and begins
\[
8, 13, 156, 586, 3957, 19474, 111966, 596273,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) + 20*a(n-2) + 27*a(n-3) - 14*a(n-4) - 25*a(n-5) + 4*a(n-6) + 5*a(n-7) - a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 13 2018 09:31:51, revision 12) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A228799.
