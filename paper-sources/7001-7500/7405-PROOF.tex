...
\title{The empirical recurrence for OEIS A234221, proved by transfer matrix}
...
\begin{abstract}
OEIS A234221 counts $3$-column arrays over $\{0,\dots,4\}$ in which every
...
OEIS A234221 is ``Number of (n+1) X (2+1) 0..4 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 3 (constant-stress 1 X 1 tilings).''. It has offset
$1$ and begins
\[
436, 1560, 5612, 20724, 76972, 293316, 1123724,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 7*a(n-1) + 20*a(n-2) - 224*a(n-3) + 144*a(n-4) + 1680*a(n-5) - 2880*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 20 2022 21:34:19, revision 12) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234221.
