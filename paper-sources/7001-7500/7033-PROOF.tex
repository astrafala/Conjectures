...
\title{The empirical recurrence for OEIS A301404, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A301404 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A301404 is ``Number of n X 5 0..1 arrays with every element equal to 0, 1, 2, 3, 4 or 5 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
16, 512, 15680, 483600, 14905344, 459428416, 14160945920, 436482419456,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 24*a(n-1) +204*a(n-2) +228*a(n-3) -1008*a(n-4) -1008*a(n-5) +2304*a(n-6) -192*a(n-7) -512*a(n-8) for n>9.
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 20 2024 16:25:43, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;24\,a(n-1) + 204\,a(n-2) + 228\,a(n-3) - 1008\,a(n-4) - 1008\,a(n-5) + 2304\,a(n-6) - 192\,a(n-7) - 512\,a(n-8)
\end{equation}
for all $n>9$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A301404.
