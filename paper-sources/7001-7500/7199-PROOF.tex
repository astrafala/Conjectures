...
\title{The empirical recurrence for OEIS A259945, proved by transfer matrix}
...
\begin{abstract}
OEIS A259945 counts $(n+2)\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A259945 is ``Number of (n+2) X (1+2) 0..1 arrays with each 3 X 3 subblock having clockwise perimeter pattern 00000000 00000001 or 00000101.''. It has offset $1$ and begins
\[
34, 60, 156, 365, 801, 1825, 4272, 9840,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + a(n-2) + 2*a(n-3) + 6*a(n-4) - a(n-6) + a(n-7) - a(n-8) for n>9.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 27 2018 11:54:03, revision 8) this is still
...
\[
\text{the clockwise perimeter word of }g\text{ is a rotation of one of }\{00000000,\ 00000001,\ 00000101\}
\]
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + a(n-2) + 2\,a(n-3) + 6\,a(n-4) - a(n-6) + a(n-7) - a(n-8)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A259945.
