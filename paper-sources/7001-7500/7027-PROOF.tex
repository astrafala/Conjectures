...
\title{The empirical recurrence for OEIS A255142, proved by transfer matrix}
...
\begin{abstract}
OEIS A255142 counts $(n+2)\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A255142 is ``Number of (n+2)X(1+2) 0..1 arrays with no 3x3 subblock diagonal sum 0 and no antidiagonal sum 0 and no row sum 1 and no column sum 1.''. It has offset $1$ and begins
\[
47, 115, 302, 784, 2086, 5661, 15406, 41999,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:38:34, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 8\,a(n-3) - 2\,a(n-4) - 6\,a(n-5) - 16\,a(n-6) - 13\,a(n-7) + 6\,a(n-8) + 14\,a(n-9) + 12\,a(n-10) - 4\,a(n-12) - 4\,a(n-13)
\]
for every $n>13$.
\end{theorem}
...
at once. By Lemma~\ref{lem:crit} the recurrence holds for every $n>13$.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A255142.
