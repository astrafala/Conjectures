...
\title{The empirical recurrence for OEIS A234185, proved by transfer matrix}
...
\begin{abstract}
OEIS A234185 counts $2$-column arrays over $\{0,\dots,6\}$ in which every
...
OEIS A234185 is ``Number of (n+1) X (1+1) 0..6 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 2 (constant-stress 1 X 1 tilings).''. It has offset
$1$ and begins
\[
412, 3710, 33720, 307598, 2802904, 25588052, 233283984,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 6*a(n-1) + 120*a(n-2) - 576*a(n-3) - 3026*a(n-4) + 5484*a(n-5) + 6720*a(n-6) - 10080*a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 20 2022 21:34:36, revision 14) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) + 120\,a(n-2) - 576\,a(n-3) - 3026\,a(n-4) + 5484\,a(n-5) + 6720\,a(n-6) - 10080\,a(n-7)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234185.
