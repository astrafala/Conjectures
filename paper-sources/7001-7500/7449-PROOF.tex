...
\title{The empirical recurrence for OEIS A260201, proved by transfer matrix}
...
\begin{abstract}
OEIS A260201 counts $(n+2)\times4$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A260201 is ``Number of (n+2) X (2+2) 0..1 arrays with each 3 X 3 subblock having clockwise perimeter pattern 00000000 00000001 or 00010001.''. It has offset $1$ and begins
\[
44, 80, 207, 479, 1163, 2864, 6895, 16690,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + a(n-2) + 5*a(n-3) + 2*a(n-4) + a(n-5) - a(n-7) - a(n-8) for n>9.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 28 2018 11:02:13, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A260201.
