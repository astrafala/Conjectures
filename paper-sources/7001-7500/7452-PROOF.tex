...
\title{The empirical recurrence for OEIS A252379, proved by transfer matrix}
...
\begin{abstract}
OEIS A252379 counts $(n+2)\times5$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A252379 is ``Number of (n+2) X (3+2) 0..3 arrays with every 3 X 3 subblock row and diagonal sum equal to 0 3 5 6 or 7 and every 3 X 3 column and antidiagonal sum not equal to 0 3 5 6 or 7.''. It has offset $1$ and begins
\[
1359, 647, 632, 616, 799, 984, 1114, 1541,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-3) - 4*a(n-6) + a(n-9) for n>12.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 03 2018 08:31:34, revision 10) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252379.
