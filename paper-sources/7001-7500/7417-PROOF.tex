...
\title{The white squares of a board: OEIS A230649}
...
\begin{abstract}
OEIS A230649 carries an empirical recurrence of order $8$ contributed by R.~H.~Hardin. It is
...
walks in it. Hence $a(n)$ is a walk count on $S=16$ vertices and is $C$-finite, and whether the
...
OEIS A230649 is ``Number of nX5 0..2 white square subarrays x(i,j) with each element diagonally or antidiagonally next to at least one element with value 2-x(i,j).''. It has offset $1$ and begins
\[
0, 15, 27, 531, 1635, 28161, 90393, 1539207,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 59*a(n-2) -230*a(n-4) -2*a(n-6) +32*a(n-8) for n>11
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 08:43:52, revision 6) this is still
...
Merging vertices with identical futures leaves $S=16$. An admissible board is exactly a walk, so with $M$ the adjacency matrix and $\iota,\tau$ the vectors recording which states may begin and end a board,
\[
...
\begin{theorem}
\[
a(n)\;=\;59\,a(n-2) - 230\,a(n-4) - 2\,a(n-6) + 32\,a(n-8)
\]
for every $n>11$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A230649.
