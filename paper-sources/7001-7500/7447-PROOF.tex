...
\title{The empirical recurrence for OEIS A259888, proved by transfer matrix}
...
\begin{abstract}
OEIS A259888 counts $(n+2)\times4$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A259888 is ``Number of (n+2) X (2+2) 0..1 arrays with each 3 X 3 subblock having clockwise perimeter pattern 00000000 00000001 or 00000011.''. It has offset $1$ and begins
\[
67, 174, 653, 1853, 4662, 13704, 40955, 114098,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) - 3*a(n-2) + 11*a(n-3) - 8*a(n-4) - 5*a(n-5) - 5*a(n-6) - 2*a(n-7) + 3*a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 27 2018 08:42:25, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) - 3\,a(n-2) + 11\,a(n-3) - 8\,a(n-4) - 5\,a(n-5) - 5\,a(n-6) - 2\,a(n-7) + 3\,a(n-8)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A259888.
