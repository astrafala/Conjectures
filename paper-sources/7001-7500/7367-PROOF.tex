...
\title{The empirical recurrence for OEIS A302954, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A302954 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A302954 is ``Number of 3Xn 0..1 arrays with every element equal to 1, 2, 3, 4 or 5 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
0, 11, 86, 519, 3626, 26167, 185810, 1317541,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 4*a(n-1) +15*a(n-2) +37*a(n-3) +80*a(n-4) +68*a(n-5) +26*a(n-6) +5*a(n-7) for n>9
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 16 2018 11:41:57, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) + 15\,a(n-2) + 37\,a(n-3) + 80\,a(n-4) + 68\,a(n-5) + 26\,a(n-6) + 5\,a(n-7)
\end{equation}
for all $n>9$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302954.
