...
\title{The empirical recurrence for OEIS A234984, proved by transfer matrix}
...
\begin{abstract}
OEIS A234984 counts $2$-column arrays over $\{0,\dots,5\}$ in which every
...
OEIS A234984 is ``Number of (n+1) X (1+1) 0..5 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 2, with no adjacent elements equal (constant-stress tilted 1 X 1 tilings).''. It has offset
$1$ and begins
\[
90, 370, 1640, 7554, 35072, 163416, 762002,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 5*a(n-1) + 6*a(n-2) - 33*a(n-3) - 24*a(n-4) + 56*a(n-5) + 34*a(n-6) - 20*a(n-7) - 4*a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 19 2022 01:21:31, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) + 6\,a(n-2) - 33\,a(n-3) - 24\,a(n-4) + 56\,a(n-5) + 34\,a(n-6) - 20\,a(n-7) - 4\,a(n-8)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234984.
