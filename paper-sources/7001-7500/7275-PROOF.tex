...
\title{The empirical recurrence for OEIS A206570, proved by transfer matrix}
...
\begin{abstract}
OEIS A206570 counts arrays of width $1$ over $\{0,1,2,3\}$ containing no occurrence of certain short
...
count is a walk count on $S=21$ states.
\end{abstract}
...
OEIS A206570 is ``Number of n X 1 0..3 arrays avoiding the pattern z-1 z-1 z in any row, column or nw-to-se diagonal.''. It has offset $1$ and begins
\[
4, 16, 61, 232, 882, 3353, 12747, 48460,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) - 3*a(n-3) + 2*a(n-5) - a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 20 2018 09:18:16, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The array has $1$ cells across, with entries in $\{0,1,2,3\}$. An OCCURRENCE of a pattern in a
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) - 3\,a(n-3) + 2\,a(n-5) - a(n-7)
\]
for every $n>6$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206570.
