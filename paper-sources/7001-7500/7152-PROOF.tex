...
\title{The empirical recurrence for OEIS A259738, proved by transfer matrix}
...
\begin{abstract}
OEIS A259738 counts $(n+2)\times6$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A259738 is ``Number of (n+2) X (4+2) 0..1 arrays with each 3 X 3 subblock having clockwise perimeter pattern 00010101 or 01010101.''. It has offset $1$ and begins
\[
62, 136, 374, 868, 1882, 4456, 10570, 24150,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + 4*a(n-3) + 5*a(n-4) + 3*a(n-5) + 5*a(n-6) + a(n-7) - 4*a(n-8) - a(n-9) + a(n-10) for n>11.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 26 2018 12:00:06, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 4\,a(n-3) + 5\,a(n-4) + 3\,a(n-5) + 5\,a(n-6) + a(n-7) - 4\,a(n-8) - a(n-9) + a(n-10)
\]
for every $n>11$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A259738.
