...
\title{The empirical recurrence for OEIS A230521, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A230521 counts arrays over $\{0,\dots,2\}$ in which every cell is constrained by the
...
OEIS A230521 is ``Number of nX3 0..2 arrays x(i,j) with each element horizontally, vertically, diagonally or antidiagonally next to at least one element with value (x(i,j)+1) mod 3, and upper left element zero.''. It has offset $1$ and begins
\[
0, 78, 1408, 29618, 627350, 13230788, 279167078, 5890518102,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 17*a(n-1) +74*a(n-2) +257*a(n-3) +159*a(n-4) -208*a(n-5) -590*a(n-6) -120*a(n-7) +48*a(n-8) +48*a(n-9)
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 05:52:46, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;17\,a(n-1) + 74\,a(n-2) + 257\,a(n-3) + 159\,a(n-4) - 208\,a(n-5) - 590\,a(n-6) - 120\,a(n-7) + 48\,a(n-8) + 48\,a(n-9)
\end{equation}
for all $n>10$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A230521.
