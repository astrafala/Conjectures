...
\title{The empirical recurrence for OEIS A183704, proved by transfer matrix}
...
\begin{abstract}
OEIS A183704 counts arrays over $\{0,\dots,3\}$ under a condition on the determinant of every
...
OEIS A183704 is ``Number of (n+1)X4 0..3 arrays with every 2X2 subblock nonsingular.''. It has offset $1$ and begins
\[
31800, 4760784, 710460576, 106093597920, 15840740585184, 2365244332190880, 353161421431958880, 52731638795200916256,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 02:00:16, revision 9) this is still
...
first term is $31800$, and the model reproduces it along with every later term; that is the
...
\begin{theorem}
\[
a(n)\;=\;86\,a(n-1) + 8599\,a(n-2) + 136224\,a(n-3) - 1175256\,a(n-4) - 18016864\,a(n-5) + 130578912\,a(n-6) - 84468528\,a(n-7) - 318225024\,a(n-8)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A183704.
