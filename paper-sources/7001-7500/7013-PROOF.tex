...
\title{The empirical recurrence for OEIS A222141, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A222141 counts arrays over $\{0,\dots,4\}$ in which every cell is constrained by the
...
with $S=3125$ vertices, and the conjectured recurrence is then decided by a finite exact
computation.
\end{abstract}
...
OEIS A222141 is ``Number of nX5 0..4 arrays with no entry increasing mod 5 by 4 rightwards or downwards, starting with upper left zero.''. It has offset $1$ and begins
\[
256, 114244, 50999956, 22767656980, 10164078082036, 4537511642094436, 2025664524518719732, 904309916809657591444,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 542*a(n-1) -45648*a(n-2) +1362782*a(n-3) -14182035*a(n-4) -10420216*a(n-5) +672452128*a(n-6) -1495546560*a(n-7)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 20:12:10, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;542\,a(n-1) - 45648\,a(n-2) + 1362782\,a(n-3) - 14182035\,a(n-4) - 10420216\,a(n-5) + 672452128\,a(n-6) - 1495546560\,a(n-7)
\end{equation}
for all $n>7$.
...
Let $V=\{0,\dots,4\}^{5}$ be the possible rows and take
$\mathcal V=V\times V$, of size $S=3125$, as the vertex set. Declare $(p,c)\to(c,x)$ an edge
...
\begin{proof}
The digraph was built directly from \eqref{eq:loc}: for each of the $S=3125$ pairs and each
of the $(4+1)^{5}$ possible next rows, the condition was tested on every cell of
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A222141.
