...
\title{The empirical recurrence for OEIS A295937, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A295937 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A295937 is ``Number of n X 2 0..1 arrays with each 1 adjacent to 1 or 3 king-move neighboring 1s.''. It has offset $1$ and begins
\[
2, 8, 15, 33, 104, 228, 529, 1469,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) + a(n-2) + 9*a(n-3) - 4*a(n-4) - 4*a(n-5) - 4*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 22 2019 11:08:42, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + a(n-2) + 9\,a(n-3) - 4\,a(n-4) - 4\,a(n-5) - 4\,a(n-6)
\end{equation}
for all $n>7$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A295937.
