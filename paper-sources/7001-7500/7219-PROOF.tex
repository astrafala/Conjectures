...
\title{The empirical recurrence for OEIS A208114, proved by transfer matrix}
...
\begin{abstract}
OEIS A208114 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
$(0,0,0), (0,1,0)$ along one axis and $(0,0,1), (0,1,1)$ along the other, and carries an empirical recurrence of
...
OEIS A208114 is ``Number of n X 4 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 0 1 and 0 1 1 vertically.''. It has offset
$1$ and begins
\[
9, 81, 225, 625, 1225, 2401, 3969,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) + 2*a(n-2) - 6*a(n-3) + 6*a(n-5) - 2*a(n-6) - 2*a(n-7) + a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 28 2018 08:42:24, revision
...
$(0,0,0), (0,1,0)$ as $3$ consecutive entries. There are $9$ admissible rows; that condition
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208114.
