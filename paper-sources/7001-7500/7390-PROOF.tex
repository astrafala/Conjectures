...
\title{The empirical recurrence for OEIS A297459, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297459 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A297459 is ``Number of 3 X n 0..1 arrays with every 1 horizontally, diagonally or antidiagonally adjacent to 0 or 2 neighboring 1s.''. It has offset $1$ and begins
\[
8, 19, 92, 285, 1143, 3933, 14817, 52868,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) + 4*a(n-2) - 7*a(n-3) + 8*a(n-4) - 19*a(n-5) + 8*a(n-6) + 2*a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 28 2019 16:43:54, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 4\,a(n-2) - 7\,a(n-3) + 8\,a(n-4) - 19\,a(n-5) + 8\,a(n-6) + 2\,a(n-8)
\end{equation}
for all $n>9$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297459.
