...
\title{The empirical recurrence for OEIS A237235, proved by transfer matrix}
...
\begin{abstract}
OEIS A237235 counts arrays over $\{0,\dots,3\}$ subject to a condition on the order
...
The condition is local to two consecutive rows, so the count is a walk count on $S=62$
...
OEIS A237235 is ``Number of (n+1)X(1+1) 0..3 arrays with the maximum plus the lower median minus the upper median minus the minimum of every 2X2 subblock equal.''. It has offset $1$ and begins
\[
256, 1280, 6976, 40064, 234752, 1395200, 8344576, 50202624,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 10:00:18, revision 7) this is still
...
array, which is not among the objects counted. There are $S=62$ states left.
...
\begin{theorem}
\[
a(n)\;=\;14\,a(n-1) - 784\,a(n-3) + 2736\,a(n-4) + 10208\,a(n-5) - 59776\,a(n-6) - 17408\,a(n-7) + 443392\,a(n-8) - 342016\,a(n-9) - 1089536\,a(n-10) + 1376256\,a(n-11)
\]
for every $n>11$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237235.
