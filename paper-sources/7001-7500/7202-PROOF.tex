...
\title{The empirical recurrence for OEIS A259422, proved by transfer matrix}
...
\begin{abstract}
OEIS A259422 counts arrays of width $4$ over $\{0,1\}$ subject to a condition read round the
...
OEIS A259422 is ``Number of (n+1)X(3+1) 0..1 arrays with each 2X2 subblock having clockwise pattern 0000 0001 0011 or 0111.''. It has offset $1$ and begins
\[
142, 1366, 12953, 123306, 1172659, 11155819, 106118138, 1009466878,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 6*a(n-1) +41*a(n-2) -44*a(n-3) -278*a(n-4) +51*a(n-5) +426*a(n-6) +36*a(n-7) -131*a(n-8)
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:51:04, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) + 41\,a(n-2) - 44\,a(n-3) - 278\,a(n-4) + 51\,a(n-5) + 426\,a(n-6) + 36\,a(n-7) - 131\,a(n-8)
\]
for every $n>6$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A259422.
