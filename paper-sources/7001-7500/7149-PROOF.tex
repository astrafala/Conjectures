...
\title{The empirical recurrence for OEIS A259955, proved by transfer matrix}
...
\begin{abstract}
OEIS A259955 counts $(n+2)\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A259955 is ``Number of (n+2) X (1+2) 0..1 arrays with each 3 X 3 subblock having clockwise perimeter pattern 00000000 00000001 or 00001001.''. It has offset $1$ and begins
\[
34, 67, 155, 353, 808, 1884, 4340, 9925,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + 3*a(n-3) + 5*a(n-4) + 6*a(n-5) + 6*a(n-6) + 2*a(n-7) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 27 2018 11:59:02, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A259955.
