...
\title{The empirical recurrence for OEIS A207937, proved by transfer matrix}
...
\begin{abstract}
OEIS A207937 counts arrays over $\{0,\dots,1\}$ of width $7$ that avoid the patterns
...
OEIS A207937 is ``Number of n X 7 0..1 arrays avoiding 0 0 1 and 1 0 0 horizontally and 0 0 1 and 1 1 0 vertically.''. It has offset
$1$ and begins
\[
35, 1225, 8977, 38207, 121313, 319439, 737575,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 8*a(n-1) - 28*a(n-2) + 56*a(n-3) - 70*a(n-4) + 56*a(n-5) - 28*a(n-6) + 8*a(n-7) - a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 26 2018 09:13:28, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207937.
