...
\title{The empirical recurrence for OEIS A184002, proved by transfer matrix}
...
\begin{abstract}
OEIS A184002 carries an empirical recurrence of order $9$ contributed by R.~H.~Hardin. It is
true, and it is decidable rather than empirical. The entry's condition is local to a bounded window of consecutive lines, so
the admissible configurations of such a window are the vertices of a finite digraph and the
arrays counted are exactly the walks in it; hence $a(n)$ is a walk count on $S=177147$ vertices
...
OEIS A184002 is ``Number of (n+1) X 9 0..2 arrays with all 2 X 2 subblock sums the same.''. It has offset $1$ and begins
\[
35535, 40041, 47031, 61125, 85431, 134853, 227319, 418461,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 6*a(n-1) - 60*a(n-3) + 85*a(n-4) + 150*a(n-5) - 360*a(n-6) + 396*a(n-8) - 216*a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 09 2018 14:53:29, revision 8) this is still
...
admissible array is then exactly a walk, so with $M$ the adjacency matrix on $S=177147$ vertices
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A184002.
