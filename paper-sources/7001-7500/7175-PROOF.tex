...
\title{The empirical recurrence for OEIS A283727, proved by transfer matrix}
...
\begin{abstract}
OEIS A283727 counts $2\times n$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A283727 is ``Number of 2 X n 0..1 arrays with no 1 equal to more than two of its horizontal, diagonal and antidiagonal neighbors, with the exception of exactly one element.''. It has offset $1$ and begins
\[
0, 0, 10, 60, 242, 1032, 4220, 16376,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 6*a(n-1) - 7*a(n-2) - 31*a(n-4) + 14*a(n-5) + 51*a(n-6) + 52*a(n-7) + 12*a(n-8) - 96*a(n-9) - 64*a(n-10).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 21 2019 11:36:15, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) - 7\,a(n-2) - 31\,a(n-4) + 14\,a(n-5) + 51\,a(n-6) + 52\,a(n-7) + 12\,a(n-8) - 96\,a(n-9) - 64\,a(n-10)
\]
for every $n>10$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A283727.
