...
\title{The empirical recurrence for OEIS A250802, proved by transfer matrix}
...
\begin{abstract}
OEIS A250802 counts arrays over $\{0,1\}$ in which a statistic taken over short runs
...
OEIS A250802 is ``Number of (5+1) X (n+1) 0..1 arrays with nondecreasing min(x(i,j),x(i,j-1)) in the i direction and nondecreasing absolute value of x(i,j)-x(i-1,j) in the j direction.''. It has offset $1$ and begins
\[
338, 1336, 4258, 12062, 31220, 76110, 177142, 398704,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 5*a(n-1) - 6*a(n-2) - 7*a(n-3) + 18*a(n-4) - 3*a(n-5) - 14*a(n-6) + 7*a(n-7) + 3*a(n-8) - 2*a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 20 2018 16:31:52, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) - 6\,a(n-2) - 7\,a(n-3) + 18\,a(n-4) - 3\,a(n-5) - 14\,a(n-6) + 7\,a(n-7) + 3\,a(n-8) - 2\,a(n-9)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250802.
