...
\title{The empirical recurrence for OEIS A208291, proved by transfer matrix}
...
\begin{abstract}
OEIS A208291 counts arrays over $\{0,\dots,1\}$ of width $7$ that avoid the patterns
...
OEIS A208291 is ``Number of 7 X n 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 0 1 and 1 1 0 vertically.''. It has offset
$1$ and begins
\[
14, 196, 966, 6650, 40376, 256774, 1604862,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 4*a(n-1) + 16*a(n-2) - 7*a(n-3) - 23*a(n-4) + 2*a(n-5) + 9*a(n-6) - a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 30 2018 14:53:47, revision
8) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) + 16\,a(n-2) - 7\,a(n-3) - 23\,a(n-4) + 2\,a(n-5) + 9\,a(n-6) - a(n-8)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208291.
