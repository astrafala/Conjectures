...
\title{The empirical recurrence for OEIS A207793, proved by transfer matrix}
...
\begin{abstract}
OEIS A207793 counts arrays over $\{0,\dots,3\}$ under a condition on the perimeter cycle of
every $2\times3$ and $3\times2$ subblock, and carries an empirical recurrence of order $10$ contributed by
R.~H.~Hardin. It is true, and it is decidable rather than empirical. The condition is local to
a bounded window of consecutive rows, so the count is a walk count on $S=2208$ states and is
...
OEIS A207793 is ``Number of (n+1) X 3 0..3 arrays with every 2 X 3 or 3 X 2 subblock having an unequal number of clockwise and counterclockwise edge increases.''. It has offset $1$ and begins
\[
2208, 37408, 643968, 11074704, 190505040, 3276916896, 56368726448, 969636795792,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 13 2015 21:27:56, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;9\,a(n-1) + 121\,a(n-2) + 356\,a(n-3) + 96\,a(n-4) - 3604\,a(n-5) - 18396\,a(n-6) - 28488\,a(n-7) + 1440\,a(n-8) + 10656\,a(n-9) + 3456\,a(n-10)
\]
for every $n>10$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207793.
