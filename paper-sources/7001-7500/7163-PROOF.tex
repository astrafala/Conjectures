...
\title{The empirical recurrence for OEIS A204612, proved by transfer matrix}
...
\begin{abstract}
OEIS A204612 counts arrays over $\{0,\dots,1\}$ under a condition on the determinant of every
$2\times2$ subblock, and carries an empirical recurrence of order $11$ contributed by
R.~H.~Hardin. It is true, and it is decidable rather than empirical. The condition is local to
a bounded window of consecutive rows, so the count is a walk count on $S=335$ states and is
...
OEIS A204612 is ``Number of (n+1)X5 0..1 arrays with the determinants of 2X2 subblocks nondecreasing rightwards and downwards.''. It has offset $1$ and begins
\[
335, 3254, 31805, 313597, 3084029, 30487865, 301345617, 2981578169,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 11:21:36, revision 9) this is still
...
entry's first term is $335$, and the model reproduces it along with every later term; that
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204612.
