...
\title{The empirical recurrence for OEIS A301881, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A301881 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A301881 is ``Number of nX5 0..1 arrays with every element equal to 0, 1 or 3 horizontally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
8, 35, 125, 510, 1961, 7869, 31173, 124795,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) +14*a(n-2) -34*a(n-3) -56*a(n-4) +120*a(n-5) +64*a(n-6) -128*a(n-7) for n>9
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 28 2018 10:56:22, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 14\,a(n-2) - 34\,a(n-3) - 56\,a(n-4) + 120\,a(n-5) + 64\,a(n-6) - 128\,a(n-7)
\end{equation}
for all $n>9$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A301881.
