...
\title{The empirical recurrence for OEIS A251059, proved by transfer matrix}
...
\begin{abstract}
OEIS A251059 counts $(n+1)\times3$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A251059 is ``Number of (n+1)X(2+1) 0..2 arrays with no 2X2 subblock having x11-x00 less than x10-x01.''. It has offset $1$ and begins
\[
222, 2740, 31895, 379440, 4499219, 53420941, 634161915, 7528829372,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 10:17:14, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;14\,a(n-1) - 12\,a(n-2) - 184\,a(n-3) + 281\,a(n-4) + 477\,a(n-5) - 863\,a(n-6) - 69\,a(n-7) + 517\,a(n-8) - 106\,a(n-9) - 80\,a(n-10) + 24\,a(n-11)
\end{equation}
for all $n>10$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251059.
