...
\title{The empirical recurrence for OEIS A237938, proved by transfer matrix}
...
\begin{abstract}
OEIS A237938 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
OEIS A237938 is ``Number of (n+1) X (1+1) 0..2 arrays with the maximum minus the minimum of every 2 X 2 subblock equal.''. It has offset $1$ and begins
\[
81, 437, 2417, 13893, 81245, 482409, 2893685, 17487137,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 8*a(n-1) - a(n-2) - 64*a(n-3) - 14*a(n-4) + 88*a(n-5) + 8*a(n-6) - 24*a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 24 2018 06:00:34, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237938.
