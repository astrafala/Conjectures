...
\title{The empirical recurrence for OEIS A187721, proved by transfer matrix}
...
\begin{abstract}
OEIS A187721 counts the $(n+1)\times2$ arrays over $\{0,\dots,1\}$ in which
...
OEIS A187721 is ``Number of (n+1) X 2 binary arrays with no 2 X 2 subblock commuting with any of its horizontal and vertical 2 X 2 subblock neighbors.''. It has offset $1$ and begins
\[
16, 43, 130, 391, 1173, 3520, 10558, 31672,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 5*a(n-2) + 10*a(n-3) + 8*a(n-4) - 2*a(n-5) - 10*a(n-6) - 7*a(n-7) + 3*a(n-9) + a(n-10) for n>11.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 25 2018 12:02:03, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-2) + 10\,a(n-3) + 8\,a(n-4) - 2\,a(n-5) - 10\,a(n-6) - 7\,a(n-7) + 3\,a(n-9) + a(n-10)
\]
for every $n>11$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A187721.
