...
\title{The empirical recurrence for OEIS A207173, proved by transfer matrix}
...
\begin{abstract}
OEIS A207173 counts arrays over $\{0,\dots,1\}$ of width $5$ that avoid the patterns
...
OEIS A207173 is ``Number of 5 X n 0..1 arrays avoiding 0 0 0 and 1 0 1 horizontally and 0 0 1 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
10, 100, 270, 1161, 3445, 8455, 26908,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) + 17*a(n-3) + 4*a(n-4) + 4*a(n-5) - 48*a(n-6) - 32*a(n-7) + 64*a(n-9) for n>11.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 20 2018 14:26:15, revision
8) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 17\,a(n-3) + 4\,a(n-4) + 4\,a(n-5) - 48\,a(n-6) - 32\,a(n-7) + 64\,a(n-9)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207173.
