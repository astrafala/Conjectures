...
\title{The empirical recurrence for OEIS A299591, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A299591 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A299591 is ``Number of n X 4 0..1 arrays with every element unequal to 0, 1 or 4 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
5, 5, 11, 23, 53, 121, 250, 533,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +a(n-2) +3*a(n-3) +a(n-4) -a(n-5) -a(n-6) for n>9.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 15 2018 12:18:32, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A299591.
