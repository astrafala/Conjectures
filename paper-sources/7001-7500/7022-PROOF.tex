...
\title{The empirical recurrence for OEIS A231998, proved by transfer matrix}
...
\begin{abstract}
OEIS A231998 counts $2\times(n+1)$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A231998 is ``Number of (1+1) X (n+1) 0..1 arrays with no element having a strict majority of its horizontal and antidiagonal neighbors equal to one.''. It has offset $1$ and begins
\[
4, 6, 16, 39, 81, 168, 361, 780,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + 3*a(n-3) + 3*a(n-4) + 3*a(n-5) + 3*a(n-6) - 2*a(n-8) - a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 01 2018 21:10:06, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231998.
