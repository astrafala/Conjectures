...
\title{The empirical recurrence for OEIS A237101, proved by transfer matrix}
...
\begin{abstract}
OEIS A237101 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
The condition is local to two consecutive rows, so the count is a walk count on $S=20$
...
OEIS A237101 is ``Number of (n+1)X(1+1) 0..2 arrays with the maximum minus the upper median of every 2X2 subblock equal.''. It has offset $1$ and begins
\[
81, 385, 1881, 9491, 48569, 252415, 1324297, 7013479,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 09:51:06, revision 6) this is still
...
array, which is not among the objects counted. There are $S=20$ states left.
...
\begin{theorem}
\[
a(n)\;=\;9\,a(n-1) - 166\,a(n-3) + 224\,a(n-4) + 820\,a(n-5) - 1088\,a(n-6) - 1608\,a(n-7) + 1712\,a(n-8) + 1280\,a(n-9) - 832\,a(n-10) - 320\,a(n-11)
\]
for every $n>10$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237101.
