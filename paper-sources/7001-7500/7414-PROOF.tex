...
\title{The empirical recurrence for OEIS A237465, proved by transfer matrix}
...
\begin{abstract}
OEIS A237465 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
OEIS A237465 is ``Number of (n+1) X (1+1) 0..2 arrays with the maximum plus the lower median minus the upper median of every 2 X 2 subblock differing from its horizontal and vertical neighbors by exactly one.''. It has offset $1$ and begins
\[
81, 356, 1566, 6954, 30913, 136488, 603184, 2671904,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 288*a(n-4) + 1840*a(n-6) + 784*a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 22 2018 17:39:34, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;288\,a(n-4) + 1840\,a(n-6) + 784\,a(n-8)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237465.
