...
\title{The empirical recurrence for OEIS A232370, proved by transfer matrix}
...
\begin{abstract}
OEIS A232370 counts arrays of width $2$ over $\{0,1,2,3\}$ in which every cell carrying one stated
...
OEIS A232370 is ``Number of n X 2 0..3 arrays with every 0 next to a 1, every 1 next to a 2 and every 2 next to a 3 horizontally, diagonally or antidiagonally, and no adjacent values equal.''. It has offset $1$ and begins
\[
2, 14, 58, 230, 934, 3794, 15354, 62266,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + 7*a(n-2) + 6*a(n-3) - 2*a(n-4) - 3*a(n-5) + 2*a(n-6) + a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 05 2018 11:12:37, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 7\,a(n-2) + 6\,a(n-3) - 2\,a(n-4) - 3\,a(n-5) + 2\,a(n-6) + a(n-7)
\]
for every $n>7$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232370.
