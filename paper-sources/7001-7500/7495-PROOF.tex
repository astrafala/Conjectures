...
\title{The empirical recurrence for OEIS A283538, proved by transfer matrix}
...
\begin{abstract}
OEIS A283538 counts $n\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A283538 is ``Number of nX3 0..1 arrays with no 1 equal to more than one of its horizontal, diagonal and antidiagonal neighbors.''. It has offset $1$ and begins
\[
7, 27, 127, 573, 2615, 11903, 54211, 246869,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 5*a(n-1) -a(n-2) -7*a(n-3) +10*a(n-4) +4*a(n-5) -8*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 11 2017 16:26:34, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) - a(n-2) - 7\,a(n-3) + 10\,a(n-4) + 4\,a(n-5) - 8\,a(n-6)
\]
for every $n>6$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A283538.
