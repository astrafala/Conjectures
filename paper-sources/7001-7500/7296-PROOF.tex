...
\title{The empirical recurrence for OEIS A228686, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A228686 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A228686 is ``Number of 5 X n binary arrays with no two ones adjacent horizontally, diagonally or antidiagonally.''. It has offset $1$ and begins
\[
32, 99, 1277, 6160, 56549, 333517, 2644336, 17124415,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 4*a(n-1) + 34*a(n-2) - 76*a(n-3) - 134*a(n-4) + 258*a(n-5) + 45*a(n-6) - 102*a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 12 2018 15:08:28, revision 11) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A228686.
