...
\title{The empirical recurrence for OEIS A223347, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A223347 counts arrays over $\{0,\dots,5\}$ in which every cell is constrained by the
...
OEIS A223347 is ``3 X 3 X 3 triangular graph without horizontal edges coloring a rectangular array: number of n X 3 0..5 arrays where 0..5 label nodes of a graph with edges 0,1 0,2 1,3 1,4 2,4 2,5 and every array movement to a horizontal or vertical neighbor moves along an edge of this graph.''. It has offset $1$ and begins
\[
28, 236, 2280, 20836, 202264, 1851020, 17970056, 164457412,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 91*a(n-2) - 192*a(n-4) + 64*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 19 2018 13:25:06, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;91\,a(n-2) - 192\,a(n-4) + 64\,a(n-6)
\end{equation}
for all $n>6$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223347.
