...
\title{The empirical recurrence for OEIS A282879, proved by transfer matrix}
...
\begin{abstract}
OEIS A282879 counts $n\times2$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
walk, and $a(n)$ is a walk count on $S=28$ vertices, which is $C$-finite. Whether the
...
OEIS A282879 is ``Number of n X 2 0..1 arrays with no 1 equal to more than one of its horizontal, vertical and antidiagonal neighbors, with the exception of exactly one element.''. It has offset $1$ and begins
\[
0, 2, 8, 32, 122, 416, 1414, 4626,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) +7*a(n-2) -2*a(n-3) -20*a(n-4) -24*a(n-5) -19*a(n-6) -14*a(n-7) -7*a(n-8) -2*a(n-9) -a(n-10).
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 19 2025 16:06:28, revision 10) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 7\,a(n-2) - 2\,a(n-3) - 20\,a(n-4) - 24\,a(n-5) - 19\,a(n-6) - 14\,a(n-7) - 7\,a(n-8) - 2\,a(n-9) - a(n-10)
\]
for every $n>10$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A282879.
