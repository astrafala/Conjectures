...
\title{The empirical recurrence for OEIS A250579, proved by transfer matrix}
...
\begin{abstract}
OEIS A250579 counts arrays over $\{0,1\}$ in which a statistic taken over short runs
...
OEIS A250579 is ``Number of (n+1) X (4+1) 0..1 arrays with nondecreasing max(x(i,j),x(i,j-1)) in the i direction and nondecreasing min(x(i,j),x(i-1,j)) in the j direction.''. It has offset $1$ and begins
\[
125, 329, 778, 1776, 4013, 9055, 20510, 46664,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 6*a(n-1) - 10*a(n-2) - 7*a(n-3) + 40*a(n-4) - 40*a(n-5) - 2*a(n-6) + 29*a(n-7) - 19*a(n-8) + 4*a(n-9) for n>10.
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 15 2018 08:38:07, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) - 10\,a(n-2) - 7\,a(n-3) + 40\,a(n-4) - 40\,a(n-5) - 2\,a(n-6) + 29\,a(n-7) - 19\,a(n-8) + 4\,a(n-9)
\]
for every $n>10$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250579.
