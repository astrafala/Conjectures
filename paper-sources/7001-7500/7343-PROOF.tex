...
\title{The empirical recurrence for OEIS A236028, proved by transfer matrix}
...
\begin{abstract}
OEIS A236028 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
OEIS A236028 is ``Number of (n+1)X(1+1) 0..2 arrays colored with the difference of the upper median and the lower median in each 2X2 subblock.''. It has offset $1$ and begins
\[
81, 384, 1848, 8856, 42724, 205660, 990076, 4760380,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 9*a(n-2) +4*a(n-3) +192*a(n-4) +324*a(n-5) +696*a(n-6) +1808*a(n-7) +1312*a(n-8) +1152*a(n-9) +1024*a(n-10)
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 09:01:04, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;9\,a(n-2) + 4\,a(n-3) + 192\,a(n-4) + 324\,a(n-5) + 696\,a(n-6) + 1808\,a(n-7) + 1312\,a(n-8) + 1152\,a(n-9) + 1024\,a(n-10)
\]
for every $n>10$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A236028.
