...
\title{The empirical recurrence for OEIS A302742, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A302742 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A302742 is ``Number of 3Xn 0..1 arrays with every element equal to 0, 1, 2, 3 or 4 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
4, 32, 228, 1637, 11814, 85268, 615589, 4444226,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 7*a(n-1) +4*a(n-2) -17*a(n-3) -3*a(n-4) -9*a(n-6) +14*a(n-7) for n>8
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 12 2018 11:22:39, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;7\,a(n-1) + 4\,a(n-2) - 17\,a(n-3) - 3\,a(n-4) - 9\,a(n-6) + 14\,a(n-7)
\end{equation}
for all $n>8$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302742.
