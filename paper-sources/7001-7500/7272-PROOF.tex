...
\title{The empirical recurrence for OEIS A301996, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A301996 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A301996 is ``Number of nX5 0..1 arrays with every element equal to 1, 2 or 4 horizontally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
3, 18, 84, 468, 2856, 17800, 110036, 674984,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 30 2018 12:24:34, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;18\,a(n-1) - 141\,a(n-2) + 661\,a(n-3) - 2058\,a(n-4) + 4393\,a(n-5) - 6412\,a(n-6) + 6060\,a(n-7) - 3280\,a(n-8) + 640\,a(n-9) + 192\,a(n-10) - 64\,a(n-11)
\end{equation}
for all $n>12$.
...
The threshold below is exact rather than merely sufficient: at $n=12$ the conjectured
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A301996.
