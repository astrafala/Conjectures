...
\title{The empirical recurrence for OEIS A183714, proved by transfer matrix}
...
\begin{abstract}
OEIS A183714 counts arrays of width $5$ over $\{0,1,2,3,4\}$ subject to a condition read round the
...
count is a walk count on a finite digraph with $S=3126$ vertices, and whether a linear
...
OEIS A183714 is ``1/20 of the number of (n+1) X 5 0..4 arrays with every 2 X 2 subblock strictly increasing clockwise or counterclockwise with one decrease.''. It has offset $1$ and begins
\[
29, 174, 950, 5362, 30113, 169560, 954496, 5374440,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 6*a(n-1) + 5*a(n-2) - 42*a(n-3) - 2*a(n-4) + 84*a(n-5) - 20*a(n-6) - 46*a(n-7) + 19*a(n-8) + 2*a(n-9) - a(n-10).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 06 2015 21:58:32, revision 7) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The arrays have $5$ columns and a growing number of rows, with entries in $\{0,1,2,3,4\}$. A
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=3126,
\]
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) + 5\,a(n-2) - 42\,a(n-3) - 2\,a(n-4) + 84\,a(n-5) - 20\,a(n-6) - 46\,a(n-7) + 19\,a(n-8) + 2\,a(n-9) - a(n-10)
\]
for every $n>10$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A183714.
