...
\title{The empirical recurrence for OEIS A260973, proved by transfer matrix}
...
\begin{abstract}
OEIS A260973 counts $(n+2)\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A260973 is ``Number of (n+2) X (1+2) 0..1 arrays with each 3 X 3 subblock having clockwise perimeter pattern 00000001 00001001 or 00100101.''. It has offset $1$ and begins
\[
48, 91, 204, 483, 1146, 2755, 6526, 15419,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) - 2*a(n-2) + 4*a(n-3) + 3*a(n-4) + 6*a(n-5) + 4*a(n-6) + 16*a(n-8) for n>9.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 29 2018 08:17:46, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) - 2\,a(n-2) + 4\,a(n-3) + 3\,a(n-4) + 6\,a(n-5) + 4\,a(n-6) + 16\,a(n-8)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A260973.
