...
\title{The empirical recurrence for OEIS A237030, proved by transfer matrix}
...
\begin{abstract}
OEIS A237030 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
OEIS A237030 is ``Number of (n+1)X(3+1) 0..2 arrays with the maximum of every 2X2 subblock equal.''. It has offset $1$ and begins
\[
4042, 221994, 11703666, 638436002, 34552648978, 1877852845426, 101931021677874, 5535866559864146,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 09:46:26, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;44\,a(n-1) + 881\,a(n-2) - 15698\,a(n-3) - 113114\,a(n-4) + 890992\,a(n-5) + 3248928\,a(n-6) - 2915328\,a(n-7) - 5741568\,a(n-8) + 4644864\,a(n-9)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A237030.
