...
\title{The empirical recurrence for OEIS A208017, proved by transfer matrix}
...
\begin{abstract}
OEIS A208017 counts arrays over $\{0,\dots,1\}$ of width $7$ that avoid the patterns
...
OEIS A208017 is ``Number of 7Xn 0..1 arrays avoiding 0 0 0 and 1 0 1 horizontally and 0 0 1 and 0 1 1 vertically.''. It has offset
$1$ and begins
\[
20, 400, 1260, 8643, 32860, 92560, 393049,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +43*a(n-3) +12*a(n-4) +12*a(n-5) -432*a(n-6) -288*a(n-7) +1728*a(n-9) for n>11
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:34:25, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 43\,a(n-3) + 12\,a(n-4) + 12\,a(n-5) - 432\,a(n-6) - 288\,a(n-7) + 1728\,a(n-9)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208017.
