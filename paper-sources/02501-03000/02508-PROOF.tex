...
\title{A further conjecture on OEIS A235882,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A235882 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $2571, 3345, 4911, 8097, 14631, 28185, 56751, 118257,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = 3*(602 + 63*2\^{}(1+n) + 3\^{}n).\end{quote}
