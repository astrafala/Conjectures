...
\title{A further conjecture on OEIS A207449,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A207449 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $10, 100, 330, 760, 1450, 2460, 3850, 5680,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = 10*n\^{}3 + 10*n\^{}2 - 10*n.\end{quote}
