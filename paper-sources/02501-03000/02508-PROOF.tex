...
\title{A further conjecture on OEIS A207020,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A207020 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $9, 81, 252, 558, 1035, 1719, 2646, 3852,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = 6*n\^{}3 + (27/2)*n\^{}2 - (21/2)*n.\end{quote}
