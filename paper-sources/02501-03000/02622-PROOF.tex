...
\title{A further conjecture on OEIS A268967,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A268967 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $60, 912, 11664, 136080, 1504656, 16061328, 167226768, 1709114256,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = 16*3\^{}(2*n-3) * (8*n+3) for n>1.\end{quote}
