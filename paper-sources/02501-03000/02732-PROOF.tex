...
\title{The empirical recurrence for OEIS A209459, proved by counting patterns}
...
\begin{abstract}
OEIS A209459 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A209459 is ``Number of nX2 0..6 arrays with every 2X2 subblock containing exactly one value repeat, and new values 0..6 introduced in row major order.''. It has offset $1$ and begins
\[
2, 6, 57, 700, 10676, 192994, 3966581, 89157292,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 15:14:54, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;44\,a(n-1) - 456\,a(n-2) - 1360\,a(n-3) + 25892\,a(n-4) + 16752\,a(n-5) - 259776\,a(n-6) - 406080\,a(n-7) - 129600\,a(n-8)
\end{equation}
for all $n>9$.
...
\[
7!\Bigl(a(n)-\sum_i c_i\,a(n-i)\Bigr)\;=\;\mathbf{v}^{\!\top}N^{\,m-8}q(N)\mathbf{1} .
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209459.
