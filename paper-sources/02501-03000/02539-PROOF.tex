...
\title{A further conjecture on OEIS A219699,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A219699 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $3, 5, 13, 25, 45, 78, 130, 208,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (1/24)*n\^{}4 + (1/12)*n\^{}3 - (25/24)*n\^{}2 + (107/12)*n - 10 for n>1.\end{quote}
...
indices, and $a$ and $f$ were checked to agree at $n=7,\dots,11$,
