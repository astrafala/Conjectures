...
\title{A further conjecture on OEIS A266222,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A266222 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $0, 1, 5, 0, 9, 0, 13, 0,\dots$, with offset $0$. The sequence satisfies
\[
  a(n)=2\,a(n-2) - 1\,a(n-4) ,
\]
...
\begin{quote}\raggedright a(n) = 1/2*(1+(-1)\^{}n)*(1+2*n) for n>1.\end{quote}
