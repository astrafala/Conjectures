...
\title{A further conjecture on OEIS A283505,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A283505 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $1, 0, 101, 11, 10111, 1111, 1011111, 111111,\dots$, with offset $0$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = -1/9 + (-5)\^{}n*2\^{}(n-1) + 23*2\^{}n*5\^{}(n-1)/9 for n>1.\end{quote}
