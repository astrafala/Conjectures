...
\title{A further conjecture on OEIS A233083,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A233083 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $3, 14, 95, 662, 4631, 32414, 226895, 1588262,\dots$, with offset $1$. The sequence satisfies
\[
  a(n)=8\,a(n-1) - 7\,a(n-2) ,
\]
...
\begin{quote}\raggedright a(n) = (49 + 27*7\^{}n) / 98 for n>1.\end{quote}
