...
\title{A further conjecture on OEIS A188842,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A188842 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $256, 2584, 9841, 25213, 53296, 100947, 177859, 297275,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (1/40320)*n\^{}8 + (23/10080)*n\^{}7 + (17/192)*n\^{}6 + (269/144)*n\^{}5 + (43949/1920)*n\^{}4 + (228401/1440)*n\^{}3 + (1054411/2016)*n\^{}2 + (9941/56)*n - 2210 for n>5\end{quote}
