...
\title{The empirical recurrence for OEIS A232592, proved by transfer matrix}
...
\begin{abstract}
OEIS A232592 counts arrays of width $4$ over $\{0,1,2\}$ in which every cell sees its own value plus and minus one among its neighbours. The entry carries an
...
OEIS A232592 is ``Number of (3+1)X(n+1) 0..2 arrays with every element next to itself plus and minus one within the range 0..2 horizontally or antidiagonally, with no adjacent elements equal.''. It has offset $1$ and begins
\[
4, 124, 42, 996, 606, 8104, 7568, 66744,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 07:31:25, revision 6) this is still
...
Thus
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=350,
\]
...
\begin{theorem}
\[
a(n)\;=\;10\,a(n-2) + 8\,a(n-3) - 16\,a(n-4) - 56\,a(n-5) - 27\,a(n-6) + 64\,a(n-7) + 154\,a(n-8) + 50\,a(n-9) - 123\,a(n-10) - 248\,a(n-11) - 60\,a(n-12) + 168\,a(n-13) + 246\,a(n-14) + 40\,a(n-15) - 138\,a(n-16) - 128\,a(n-17) - 27\,a(n-18) + 40\,a(n-19) + 30\,a(n-20) + 14\,a(n-21) + a(n-22) - a(n-24)
\]
for every $n>26$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232592.
