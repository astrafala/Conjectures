...
\title{Arrays counted up to renaming: the empirical recurrence for OEIS A206164}
...
\begin{abstract}
OEIS A206164 carries an empirical recurrence of order $6$ contributed by R.~H.~Hardin. It is
...
both in the state the arrays are exactly the walks in a digraph on $S=19$ vertices, so $a(n)$
...
OEIS A206164 is ``Number of (n+1) X 4 0..3 arrays with every 2 X 2 subblock in a row having an equal number of equal diagonal or equal antidiagonal elements, adjacent rows differing in this number, and new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
641, 14182, 463878, 10599630, 345652310, 7934434238, 257597022598, 5939045721006,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 13 2018 14:16:01, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 745\,a(n-2) - 489\,a(n-3) - 5808\,a(n-4) + 1584\,a(n-5) + 10368\,a(n-6)
\]
for every $n>7$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206164.
