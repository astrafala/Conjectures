...
\title{The empirical recurrence for OEIS A223971, proved by transfer matrix}
...
\begin{abstract}
OEIS A223971 counts arrays over $\{0,\dots,2\}$ whose rows, columns, diagonals or
...
is a walk count on $S=736$ vertices and the recurrence follows from a finite exact
computation.
\end{abstract}
...
OEIS A223971 is ``Number of nX4 0..2 arrays with rows and antidiagonals unimodal.''. It has offset $1$ and begins
\[
46, 2116, 76092, 2558848, 84988435, 2809740785, 92756321858, 3060966419662,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 23:05:26, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;46\,a(n-1) - 475\,a(n-2) + 1981\,a(n-3) - 20047\,a(n-4) + 170659\,a(n-5) - 619313\,a(n-6) + 1472430\,a(n-7) - 5125985\,a(n-8) + 14966969\,a(n-9) - 26289219\,a(n-10) + 49504177\,a(n-11) - 100448013\,a(n-12) + 127366991\,a(n-13) - 120709682\,a(n-14) + 121925145\,a(n-15) - 83316868\,a(n-16) + 21878656\,a(n-17) - 230400\,a(n-18)
\end{equation}
for all $n>18$.
...
bit vector), $|\mathcal V|=S=736$; let $(r,f)\to(s,f')$ be an edge when placing $s$ after $r$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223971.
