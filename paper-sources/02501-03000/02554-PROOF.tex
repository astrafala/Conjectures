...
\title{A further conjecture on OEIS A219884,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A219884 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $10, 21, 47, 129, 292, 600, 1158, 2148,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (1/362880)*n\^{}9 - (1/13440)*n\^{}8 + (17/12096)*n\^{}7 - (37/2880)*n\^{}6 + (1813/17280)*n\^{}5 + (1579/5760)*n\^{}4 - (76849/9072)*n\^{}3 + (768487/10080)*n\^{}2 - (590021/2520)*n + 217 for n>6.\end{quote}
