...
\title{A further conjecture on OEIS A266327,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A266327 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $1, 11, 1, 11, 1, 11, 1, 11,\dots$, with offset $0$. The sequence satisfies
\[
  a(n)=1\,a(n-2) ,
\]
...
\begin{quote}\raggedright a(n) = 6-5*(-1)\^{}n.\end{quote}
...
indices, and $a$ and $f$ were checked to agree at $n=2,\dots,3$,
