...
\title{The empirical closed form for OEIS A224376, proved}
...
\begin{abstract}
OEIS A224376 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A224376 is ``Number of 4 X n 0..2 arrays with rows unimodal and antidiagonals nondecreasing.''. It has offset $1$ and begins
\[
81, 1944, 15540, 77793, 311367, 1092281, 3518302, 10643789,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 07 2023 19:14:28, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{n^{16}}{106748928000} + \frac{n^{15}}{1482624000} + \frac{7 n^{14}}{266872320} + \frac{127 n^{13}}{197683200} + \frac{315179 n^{12}}{28740096000} + \frac{24499 n^{11}}{177408000} + \frac{89507 n^{10}}{65318400} + \frac{112109 n^{9}}{9676800} + \frac{68633371 n^{8}}{746496000} + \frac{11395841 n^{7}}{16128000} + \frac{6723664007 n^{6}}{1437004800} + \frac{295741651 n^{5}}{13305600} + \frac{262119224347 n^{4}}{5189184000} - \frac{16331232329 n^{3}}{1297296000} + \frac{12600631 n^{2}}{343200} + \frac{38790413 n}{360360} - 166.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224376.
