...
\title{A further conjecture on OEIS A220205,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A220205 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $4, 10, 36, 89, 182, 333, 567, 918,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (1/60)*n\^{}5 - (1/8)*n\^{}4 + (11/6)*n\^{}3 - (7/8)*n\^{}2 + (3/20)*n for n>1.\end{quote}
