...
\title{A further conjecture on OEIS A266665,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A266665 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $0, 1, 4, 6, 13, 15, 26, 28,\dots$, with offset $0$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = (n\^{}2+2*n+(-1)\^{}n*(n-1)-1)/2 for n>0.\end{quote}
