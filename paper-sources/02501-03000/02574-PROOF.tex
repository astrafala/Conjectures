...
\title{The empirical column recurrences for the table OEIS A260284}
...
\begin{abstract}
OEIS A260284 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A260284 is ``T(n,k)=Number of (n+2)X(k+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000000 00000001 or 00001011.''. It has offset $1$, is
read by antidiagonals, and begins
\[
34, 46, 46, 99, 85, 99, 202, 230,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 12:05:00, revision 6) these are still
...
The sequence is ``Number of (n+2)X(3) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000000 00000001 or 00001011.''. Its rows are the vertices of a digraph on
...
model reproduces $10$ published values, $32$ decimal digits in all, every one of
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A260284.
