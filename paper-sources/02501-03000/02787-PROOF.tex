...
\title{The empirical recurrence for OEIS A265992, proved by transfer matrix}
...
\begin{abstract}
OEIS A265992 counts arrays of width $2$ in which every entry is equal to the NUMBER of its own
...
OEIS A265992 is ``Number of 2 X n integer arrays with each element equal to the number of horizontal and antidiagonal neighbors not equal to itself.''. It has offset $1$ and begins
\[
1, 1, 2, 2, 4, 6, 7, 11,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-3) + a(n-4) + 2*a(n-5) + 2*a(n-6) + 3*a(n-7) + 2*a(n-8) - 4*a(n-9) - 4*a(n-10) - 4*a(n-11) for n>14.
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 09 2019 09:12:28, revision 7) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=143.
\]
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-3) + a(n-4) + 2\,a(n-5) + 2\,a(n-6) + 3\,a(n-7) + 2\,a(n-8) - 4\,a(n-9) - 4\,a(n-10) - 4\,a(n-11)
\]
for every $n>14$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A265992.
