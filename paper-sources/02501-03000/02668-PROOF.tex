...
\title{The empirical recurrence for OEIS A262418, proved by transfer matrix}
...
\begin{abstract}
OEIS A262418 counts arrays of width $7$ over $\{0,1\}$ whose rows, read as base-$2$
numbers, are divisible by $3$ and whose columns, read the same way, are not divisible by
$3$. The entry carries an empirical recurrence of order $13$ contributed by
...
is then a walk count on $S=729$ states.
\end{abstract}
...
OEIS A262418 is ``Number of (n+1)X(6+1) 0..1 arrays with each row divisible by 3 and column not divisible by 3, read as a binary number with top and left being the most significant bits.''. It has offset $1$ and begins
\[
0, 2892, 124572, 7577424, 326005344, 15231780324, 655089996204, 28755516792360,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 22 2015 09:30:12, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;43\,a(n-1) + 777\,a(n-2) - 33411\,a(n-3) - 179235\,a(n-4) + 7707105\,a(n-5) + 17148167\,a(n-6) - 737371181\,a(n-7) - 706190268\,a(n-8) + 30366181524\,a(n-9) + 11010302352\,a(n-10) - 473443001136\,a(n-11) - 33794555200\,a(n-12) + 1453165873600\,a(n-13)
\]
for every $n>11$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A262418.
