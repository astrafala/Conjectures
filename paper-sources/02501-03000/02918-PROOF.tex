...
\title{The empirical recurrence for OEIS A269039, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A269039 counts arrays over $\{0,\dots,2\}$ subject to a condition on the array as a
...
which is what keeps the digraph sparse. That makes $a(n)$ a walk count on $S=486$ vertices,
...
OEIS A269039 is ``Number of 5Xn 0..2 arrays with some element plus some horizontally, diagonally or antidiagonally adjacent neighbor totalling two exactly once.''. It has offset $1$ and begins
\[
0, 1944, 12228, 146064, 1326576, 13031664, 119790816, 1105914780,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 18 2016 09:02:53, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;12\,a(n-1) + 26\,a(n-2) - 566\,a(n-3) - 123\,a(n-4) + 8804\,a(n-5) - 4121\,a(n-6) - 59620\,a(n-7) + 55115\,a(n-8) + 183692\,a(n-9) - 256127\,a(n-10) - 211910\,a(n-11) + 498819\,a(n-12) - 48036\,a(n-13) - 371692\,a(n-14) + 214008\,a(n-15) + 43848\,a(n-16) - 64656\,a(n-17) + 8640\,a(n-18) + 5184\,a(n-19) - 1296\,a(n-20)
\end{equation}
for all $n>22$.
...
\[
\mathcal V=\bigl\{(r,c):\ r\in\{0,\dots,2\}^{5},\ c\in\{0,1\}\bigr\},
\qquad |\mathcal V|=S=486,
\]
...
the digraph dense, with $(2+1)^{2\cdot5}$ edges instead of the sparse set used here.
\end{remark}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269039.
