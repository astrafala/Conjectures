...
\title{The empirical recurrence for OEIS A232516, proved by transfer matrix}
...
\begin{abstract}
OEIS A232516 counts arrays of width $2$ over $\{0,1,2\}$ in which every cell sees its own value plus and minus one among its neighbours. The entry carries an
...
OEIS A232516 is ``Number of (1+1) X (n+1) 0..2 arrays with every element next to itself plus and minus one within the range 0..2 horizontally, diagonally or antidiagonally, with no adjacent elements equal.''. It has offset $1$ and begins
\[
4, 16, 16, 54, 74, 218, 340, 868,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-2) +a(n-3) +2*a(n-4) +2*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 31 2023 17:46:53, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232516.
