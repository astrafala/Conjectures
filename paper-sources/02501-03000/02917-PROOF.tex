...
\title{The empirical recurrence for OEIS A210103, proved by counting patterns}
...
\begin{abstract}
OEIS A210103 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A210103 is ``Number of (n+1)X5 0..2 arrays with every 2X2 subblock having one or three distinct values, and new values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
614, 12725, 254314, 5115121, 102841182, 2068413037, 41604910322, 836912242697,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 15:43:27, revision 11) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;39\,a(n-1) - 424\,a(n-2) - 100\,a(n-3) + 25342\,a(n-4) - 98910\,a(n-5) - 353224\,a(n-6) + 2683456\,a(n-7) - 679949\,a(n-8) - 24899773\,a(n-9) + 39419608\,a(n-10) + 84219756\,a(n-11) - 230024712\,a(n-12) - 56603460\,a(n-13) + 492890768\,a(n-14) - 143861456\,a(n-15) - 452015392\,a(n-16) + 208017984\,a(n-17) + 175455296\,a(n-18) - 65216128\,a(n-19) - 32317440\,a(n-20) + 2433024\,a(n-21) + 925696\,a(n-22)
\end{equation}
for all $n>21$.
...
\[
3!\Bigl(a(n)-\sum_i c_i\,a(n-i)\Bigr)\;=\;\mathbf{v}^{\!\top}N^{\,m-22}q(N)\mathbf{1} .
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A210103.
