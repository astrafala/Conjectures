...
\title{A further conjecture on OEIS A202050,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A202050 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $1392, 5216, 15760, 41088, 95984, 205792, 411696, 777760,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (1/1260)*n\^{}8 + (11/315)*n\^{}7 + (59/90)*n\^{}6 + (308/45)*n\^{}5 + (7807/180)*n\^{}4 + (7667/45)*n\^{}3 + (14139/35)*n\^{}2 + (17876/35)*n + 256.\end{quote}
