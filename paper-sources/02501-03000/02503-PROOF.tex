...
\title{The empirical recurrence for OEIS A252712, proved by transfer matrix}
...
\begin{abstract}
OEIS A252712 counts arrays of width $3$ over an alphabet of $4$ letters in which every three
...
OEIS A252712 is ``Number of (n+2) X (1+2) 0..3 arrays with every consecutive three elements in every row and diagonal having exactly two distinct values, and in every column and antidiagonal not having exactly two distinct values, and new values 0 upwards introduced in row major order.''. It has offset $1$ and begins
\[
39, 45, 54, 84, 111, 165, 257, 376,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + a(n-2) + 6*a(n-3) - 7*a(n-4) - 7*a(n-5) - 5*a(n-6) + 12*a(n-7) + 12*a(n-8) - 12*a(n-9) for n>11.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 05 2018 09:36:17, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + a(n-2) + 6\,a(n-3) - 7\,a(n-4) - 7\,a(n-5) - 5\,a(n-6) + 12\,a(n-7) + 12\,a(n-8) - 12\,a(n-9)
\]
for every $n>11$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252712.
