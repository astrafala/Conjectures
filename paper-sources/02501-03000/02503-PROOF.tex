...
\title{The empirical recurrence for OEIS A253023, proved by transfer matrix}
...
\begin{abstract}
OEIS A253023 counts arrays of width $8$ over an alphabet of $4$ letters in which every three
...
brings the state count down to $S=24851$.
\end{abstract}
...
OEIS A253023 is ``Number of (n+2)X(6+2) 0..3 arrays with every consecutive three elements in every row and column not having exactly two distinct values, and in every diagonal and antidiagonal having exactly two distinct values, and new values 0 upwards introduced in row major order.''. It has offset $1$ and begins
\[
153, 223, 350, 296, 537, 864, 720, 1256,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 5*a(n-3) -7*a(n-6) +2*a(n-9) -2*a(n-12) +3*a(n-15) +a(n-18) +a(n-21) for n>27
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:51:55, revision 6) this is still
...
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,
\]
with $S=24851$ states in all. The walk index $j$ and the entry's own $n$ differ by a constant,
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-3) - 7\,a(n-6) + 2\,a(n-9) - 2\,a(n-12) + 3\,a(n-15) + a(n-18) + a(n-21)
\]
for every $n>27$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253023.
