...
\title{A further conjecture on OEIS A235877,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A235877 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $21, 51, 129, 339, 921, 2571, 7329, 21219,\dots$, with offset $1$. The sequence satisfies
\[
  a(n)=5\,a(n-1) - 6\,a(n-2) ,
\]
...
\begin{quote}\raggedright a(n) = 3*(2\^{}(1+n) + 3\^{}n).\end{quote}
