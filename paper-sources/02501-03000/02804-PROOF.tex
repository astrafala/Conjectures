...
\title{The empirical recurrence for OEIS A183485, proved by transfer matrix}
...
\begin{abstract}
OEIS A183485 counts arrays of width $2$ over $\{0,1,2,3\}$ in which every cell is the sum of one of two groups of its neighbours. The entry carries an
...
$3$ consecutive rows and the count is a walk count on $S=177$ states.
\end{abstract}
...
OEIS A183485 is ``Number of n X 2 0..3 arrays with every element equal to either the sum mod 4 of its vertical neighbors or the sum mod 4 of its horizontal neighbors.''. It has offset $1$ and begins
\[
4, 28, 88, 400, 1936, 8368, 38272, 176320,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) + 24*a(n-3) - 48*a(n-4) - 144*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 29 2018 08:48:51, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + 24\,a(n-3) - 48\,a(n-4) - 144\,a(n-6)
\]
for every $n>5$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A183485.
