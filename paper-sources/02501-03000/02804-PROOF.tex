...
\title{The empirical recurrence for OEIS A250358, proved by transfer matrix}
...
\begin{abstract}
OEIS A250358 carries an empirical recurrence of order $13$ contributed by R. H. Hardin. It is
...
arrays counted are exactly the walks in it; hence $a(n)$ is a walk count on $S=124$ vertices
...
OEIS A250358 is ``Number of length n arrays x(i), i=1..n with x(i) in i..i+5 and no value appearing more than 3 times.''. It has offset $1$ and begins
\[
6, 36, 216, 1293, 7712, 45866, 272760, 1621963,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 6*a(n-1) -4*a(n-4) -22*a(n-5) -130*a(n-6) +7*a(n-8) +50*a(n-9) +66*a(n-10) +a(n-12) -6*a(n-13)
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 12:20:24, revision 6) this is still
...
admissible array is then exactly a walk, so with $M$ the adjacency matrix on $S=124$ vertices
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) - 4\,a(n-4) - 22\,a(n-5) - 130\,a(n-6) + 7\,a(n-8) + 50\,a(n-9) + 66\,a(n-10) + a(n-12) - 6\,a(n-13)
\]
for every $n>0$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250358.
