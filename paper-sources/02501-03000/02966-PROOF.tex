...
\title{The empirical recurrence for OEIS A235550, proved by transfer matrix}
...
\begin{abstract}
OEIS A235550 counts arrays of width $3$ over $\{0,1\}$ by reducing every $2\times2$ subblock to a
...
about it is one bit per adjacent pair of columns, so the count is a walk count on $S=68$
states.
\end{abstract}
...
OEIS A235550 is ``Number of (n+1)X(2+1) 0..1 arrays with the sum of each 2X2 subblock two extreme terms minus its two median terms lexicographically nondecreasing rowwise and columnwise.''. It has offset $1$ and begins
\[
46, 202, 814, 2878, 9320, 27731, 77606, 205571,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 08:37:49, revision 6) this is still
...
f(B)\;=\;(v_1+v_4)-(v_2+v_3),
\]
the two extreme entries minus the two middle ones. An array with $R$ rows and $3$ columns has $(R-1)\times2$ subblocks, and they
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + 9\,a(n-2) - 54\,a(n-3) - 15\,a(n-4) + 312\,a(n-5) - 133\,a(n-6) - 998\,a(n-7) + 840\,a(n-8) + 1896\,a(n-9) - 2268\,a(n-10) - 2088\,a(n-11) + 3472\,a(n-12) + 1088\,a(n-13) - 3120\,a(n-14) + 96\,a(n-15) + 1536\,a(n-16) - 384\,a(n-17) - 320\,a(n-18) + 128\,a(n-19)
\]
for every $n>19$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A235550.
