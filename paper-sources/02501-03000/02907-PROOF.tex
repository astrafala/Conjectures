...
\title{The empirical closed form for OEIS A224378, proved}
...
\begin{abstract}
OEIS A224378 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A224378 is ``Number of 6Xn 0..2 arrays with rows unimodal and antidiagonals nondecreasing.''. It has offset $1$ and begins
\[
729, 69984, 1126072, 8297747, 42132769, 174854516, 644368221, 2212959866,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 23:25:06, revision 8) this is still
...
+ \frac{565139 n^{20}}{810967336058880000} + \frac{50213 n^{19}}{2502985605120000} \\
+ \frac{102275011 n^{18}}{224083079700480000} + \frac{630450937 n^{17}}{74694359900160000} \\
+ \frac{6860509793 n^{16}}{52725430517760000} + \frac{7572768857 n^{15}}{4393785876480000} \\
+ \frac{1975549547 n^{14}}{96566722560000} + \frac{5979889787 n^{13}}{26153487360000} \\
+ \frac{129750858133763 n^{12}}{52725430517760000} + \frac{8852225741519 n^{11}}{337983528960000} \\
+ \frac{1757155928198569 n^{10}}{6590678814720000} + \frac{11208897154284701 n^{9}}{4393785876480000} \\
+ \frac{15905213251807771 n^{8}}{762187345920000} + \frac{60693804091491173 n^{7}}{444609285120000} \\
+ \frac{56813409423945822743 n^{6}}{88699552381440000} + \frac{45278410760324474101 n^{5}}{29566517460480000} \\
- \frac{4851359450955021973 n^{4}}{4927752910080000} - \frac{59510428654061699 n^{3}}{5133075948000} \\
+ \frac{926682017129053 n^{2}}{38440617600} + \frac{89190882279703 n}{5354228880} \\
- 49724.
\end{multline*}
...
$n=30,\dots,54$ and agree at each. A monic recurrence of order $25$
determines $a(m)$ from $a(m-1),\dots,a(m-25)$, and for every $m\ge55$ both
$m>29$ and $m-25\ge30$ hold, so induction on $m$ gives $a(m)=f(m)$ for every
$m\ge30$.
Below $n=30$ the recurrence argument gives nothing, since \eqref{eq:rec} is only
established for $a$ from $n=30$ on. The remaining indices $n=5,\dots,29$ were
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224378.
