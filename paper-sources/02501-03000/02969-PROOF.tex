...
\title{The empirical recurrence for OEIS A209826, proved by counting patterns}
...
\begin{abstract}
OEIS A209826 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A209826 is ``Number of (n+1)X6 0..2 arrays with every 2X2 subblock having one or two distinct values, and new values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
6278, 479693, 37744836, 3025299170, 243825684732, 19693265761805, 1591829337311006, 128707386720462708,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 15:31:33, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;138\,a(n-1) - 5291\,a(n-2) + 41948\,a(n-3) + 1246056\,a(n-4) - 19527125\,a(n-5) - 94011205\,a(n-6) + 2626583096\,a(n-7) + 1511468746\,a(n-8) - 177763031682\,a(n-9) + 138302103902\,a(n-10) + 7019042194083\,a(n-11) - 7969961832191\,a(n-12) - 174075869696471\,a(n-13) + 186648296877104\,a(n-14) + 2832030056843165\,a(n-15) - 2415279667981283\,a(n-16) - 31006473277373149\,a(n-17) + 19111371400840450\,a(n-18) + 232526299989981431\,a(n-19) - 99505929279539438\,a(n-20) - 1213858407562141252\,a(n-21) + 370715377868919185\,a(n-22) + 4475559340570646909\,a(n-23) - 1096935236489998102\,a(n-24) - 11786638113405890713\,a(n-25) + 2781294795279031273\,a(n-26) + 22309407784237294666\,a(n-27) - 5920732121027419916\,a(n-28) - 30324789854047144258\,a(n-29) + 9761270047165567745\,a(n-30) + 29307097858909263706\,a(n-31) - 11646482334059398589\,a(n-32) - 19688084504632376578\,a(n-33) + 9649239854975506279\,a(n-34) + 8805727983122157768\,a(n-35) - 5380377784965746096\,a(n-36) - 2398306480372906352\,a(n-37) + 1943991227752730806\,a(n-38) + 304993982412468654\,a(n-39) - 428499039605489966\,a(n-40) + 11979961616427444\,a(n-41) + 51791333004986360\,a(n-42) - 7840293455999272\,a(n-43) - 2807693417208336\,a(n-44) + 702780093944768\,a(n-45) + 47980140467616\,a(n-46) - 22670306024704\,a(n-47) + 380884158080\,a(n-48) + 247814909440\,a(n-49) - 6850234368\,a(n-50) - 945684480\,a(n-51)
\end{equation}
for all $n>50$.
...
For every $n$ with $m=n+1-1\ge51$,
\[
3!\Bigl(a(n)-\sum_i c_i\,a(n-i)\Bigr)\;=\;\mathbf{v}^{\!\top}N^{\,m-51}q(N)\mathbf{1} .
\]
...
corresponding to $n=50+1$ onwards, and the run continued until $w$ was the zero vector,
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209826.
