...
\title{A further conjecture on OEIS A277867,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A277867 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $1, 2, 4, 11, 16, 47, 64, 191,\dots$, with offset $0$. The sequence satisfies
\[
  a(n)=5\,a(n-2) - 4\,a(n-4) ,
\]
...
\begin{quote}\raggedright a(n) = (-2-(-2)\^{}n+2*(-1)\^{}n+5*2\^{}n)/4. (End)\end{quote}
