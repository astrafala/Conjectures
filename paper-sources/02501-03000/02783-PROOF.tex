...
\title{The empirical closed form for OEIS A224040, proved}
...
\begin{abstract}
OEIS A224040 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A224040 is ``Number of 4 X n 0..1 arrays with antidiagonals unimodal and rows and diagonals nondecreasing.''. It has offset $1$ and begins
\[
16, 55, 105, 168, 252, 363, 508, 695,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (1/24)*n\^{}4 + (1/4)*n\^{}3 + (83/24)*n\^{}2 + (89/4)*n - 3 for n>2.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 26 2018 11:11:25, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{n^{4}}{24} + \frac{n^{3}}{4} + \frac{83 n^{2}}{24} + \frac{89 n}{4} - 3.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224040.
