...
\title{A further conjecture on OEIS A277800,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A277800 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $1, 0, 4, 3, 16, 15, 64, 63,\dots$, with offset $0$. The sequence satisfies
\[
  a(n)=5\,a(n-2) - 4\,a(n-4) ,
\]
...
\begin{quote}\raggedright a(n) = (-2+(-2)\^{}n+2*(-1)\^{}n+3*2\^{}n)/4. (End)\end{quote}
