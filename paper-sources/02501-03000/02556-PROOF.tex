...
\title{A further conjecture on OEIS A219933,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A219933 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $4, 23, 76, 208, 519, 1212, 2670, 5574,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (1/20160)*n\^{}8 + (1/1680)*n\^{}7 + (1/1440)*n\^{}6 + (23/240)*n\^{}5 - (613/2880)*n\^{}4 + (211/120)*n\^{}3 + (11149/5040)*n\^{}2 + (61/420)*n\end{quote}
