...
\title{A further conjecture on OEIS A268052,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A268052 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $1, 8, 86, 1082, 14554, 200818, 2796826, 39082562,\dots$, with offset $1$. The sequence satisfies
\[
  a(n)=21\,a(n-1) - 108\,a(n-2) + 140\,a(n-3) ,
\]
a linear recurrence of order $3$ with characteristic polynomial
\[
  q(x)=x^{3} - 21 x^{2} + 108 x - 140 .
\]
...
\begin{quote}\raggedright a(n) = (105*2\^{}n + 196*5\^{}n + 25*2\^{}(1+n)*7\^{}n) / 1890.\end{quote}
...
indices, and $a$ and $f$ were checked to agree at $n=4,\dots,6$,
