...
\title{A further conjecture on OEIS A250882,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A250882 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $37130, 131068, 317878, 629528, 1097986, 1755220, 2633198, 3763888,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = 5328*n\^{}3 + 14468*n\^{}2 + 13238*n + 4096.\end{quote}
