...
\title{The empirical recurrence for OEIS A200796, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A200796 counts arrays in which every cell is constrained by its neighbours on \emph{both}
...
OEIS A200796 is ``Number of nX3 0..3 arrays with values 0..3 introduced in row major order and each element equal to no more than two horizontal and vertical neighbors.''. It has offset $1$ and begins
\[
5, 178, 9880, 583813, 34679839, 2060918000, 122478253815, 7278777317468,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 08:46:33, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;60\,a(n-1) - 17\,a(n-2) - 964\,a(n-3) - 2509\,a(n-4) + 968\,a(n-5) + 23125\,a(n-6) + 31652\,a(n-7) - 4566\,a(n-8) - 17118\,a(n-9) - 29646\,a(n-10) - 74826\,a(n-11) - 64125\,a(n-12) - 13932\,a(n-13) + 4131\,a(n-14) + 1458\,a(n-15)
\end{equation}
for all $n>16$.
...
\eqref{eq:walk2}, divided by $4!$, was evaluated at every one of the $14$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A200796.
