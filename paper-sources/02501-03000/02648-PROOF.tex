...
\title{A further conjecture on OEIS A253454,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A253454 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $19701, 31630, 39463, 52912, 83003, 147332, 285681, 590963,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = 529*3\^{}(n-3) + 3431*2\^{}(n-1) + 23248 for n>6.\end{quote}
