...
\title{A further conjecture on OEIS A267459,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A267459 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $1, 2, 3, 4, 7, 10, 15, 20,\dots$, with offset $0$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = (2*n\^{}2 - 4*n + (-1)\^{}n + 11)/4 for n > 0.\end{quote}
