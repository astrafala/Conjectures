...
\title{The empirical recurrence for OEIS A235731, proved by transfer matrix}
...
\begin{abstract}
OEIS A235731 counts arrays of width $4$ over $\{0,1\}$ by reducing every $2\times2$ subblock to a
...
about it is one bit per adjacent pair of columns, so the count is a walk count on $S=125$
states.
\end{abstract}
...
OEIS A235731 is ``Number of (n+1)X(3+1) 0..1 arrays with the sum of each 2X2 subblock maximum and minimum lexicographically nondecreasing columnwise and nonincreasing rowwise.''. It has offset $1$ and begins
\[
209, 2481, 29130, 337412, 3906424, 45143913, 521746721, 6028565252,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 08:44:39, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A235731.
