...
\title{A further conjecture on OEIS A250756,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A250756 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $32, 72, 129, 203, 294, 402, 527, 669,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (17/2)*n\^{}2 + (29/2)*n + 9.\end{quote}
