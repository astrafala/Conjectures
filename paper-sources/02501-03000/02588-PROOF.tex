...
\title{A further conjecture on OEIS A267044,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A267044 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $1, 10, 100, 1000, 10001, 100010, 1000101, 10001010,\dots$, with offset $0$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = (-550+450*(-1)\^{}n+9901*10\^{}n)/9900 for n>1.\end{quote}
