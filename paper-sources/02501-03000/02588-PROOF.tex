...
\title{A further conjecture on OEIS A239033,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A239033 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $8, 43, 212, 806, 2592, 7265, 18362, 42809,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (1/8640)*n\^{}9 - (61/20160)*n\^{}8 + (263/3360)*n\^{}7 - (1439/1440)*n\^{}6 + (29843/2880)*n\^{}5 - (194227/2880)*n\^{}4 + (668597/2160)*n\^{}3 - (1477657/1680)*n\^{}2 + (59263/42)*n - 943 for n>2.\end{quote}
...
indices, and $a$ and $f$ were checked to agree at $n=13,\dots,22$,
