...
\title{A further conjecture on OEIS A279030,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A279030 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $1, 0, 5, 0, 21, 0, 85, 0,\dots$, with offset $0$. The sequence satisfies
\[
  a(n)=5\,a(n-2) - 4\,a(n-4) ,
\]
...
\begin{quote}\raggedright a(n) = (1 + (-1)\^{}n)*(2\^{}(2 + n)-1)/6.\end{quote}
