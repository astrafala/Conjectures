...
\title{A further conjecture on OEIS A266304,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A266304 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $0, 1, 5, 6, 14, 15, 27, 28,\dots$, with offset $0$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = n*(n+(-1)\^{}n+2)/2.\end{quote}
