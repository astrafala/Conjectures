...
\title{A further conjecture on OEIS A219853,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A219853 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $6, 7, 17, 33, 56, 86, 125, 173,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (9/2)*n\^{}2 - (39/2)*n + 41 for n>4.\end{quote}
...
indices, and $a$ and $f$ were checked to agree at $n=8,\dots,10$,
