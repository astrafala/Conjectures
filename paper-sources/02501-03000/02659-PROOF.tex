...
\title{The empirical recurrence for OEIS A214183, proved by transfer matrix}
...
\begin{abstract}
OEIS A214183 counts the proper colourings of a grid $n\times5$, wrapped in the direction of width $5$, with at most $7$ colours and
counted up to renaming the colours, and carries an empirical recurrence of order $7$
...
down to $S=48$ and makes the exact residual test affordable.
\end{abstract}
...
OEIS A214183 is ``Number of 0..6 colorings of an nX5 array circular in the 5 direction with new values 0..6 introduced in row major order.''. It has offset $1$ and begins
\[
11, 7434, 21418431, 76892349394, 282135060192286, 1037404464993610934, 3815299253956873853106, 14031944174294607018138494,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 16:55:33, revision 8) this is still
...
\]
There are $(i-1)^{5}+(-1)^{5}(i-1)$ such colourings, which at $i=7$ is already more
...
state count is $S=48$ rather than the number of colourings.
...
\begin{theorem}
\[
a(n)\;=\;4178\,a(n-1) - 1895863\,a(n-2) + 209149752\,a(n-3) - 7928550662\,a(n-4) + 84119844576\,a(n-5) - 298704239064\,a(n-6) + 219967475904\,a(n-7)
\]
for every $n>7$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A214183.
