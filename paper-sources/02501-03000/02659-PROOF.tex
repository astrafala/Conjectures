...
\title{The empirical recurrence for OEIS A238992, proved by transfer matrix}
...
\begin{abstract}
OEIS A238992 counts arrays over $\{0,1,2,3\}$ in which no entry may equal, modulo $4$, a given
...
OEIS A238992 is ``Number of nX3 0..3 arrays with no element equal to two plus the sum of elements to its left or two plus the sum of the sum of elements above it, modulo 4.''. It has offset $1$ and begins
\[
15, 203, 2365, 25601, 270671, 2827709, 29422487, 305525459,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 09:21:57, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A238992.
