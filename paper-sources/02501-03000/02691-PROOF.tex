...
\title{The empirical recurrence for OEIS A268626, proved by transfer matrix}
...
\begin{abstract}
OEIS A268626 counts arrays of width $6$ over $\{0,1,2\}$ in which the number of adjacent PAIRS of
...
result is a walk count on $S=1162$ states.
\end{abstract}
...
OEIS A268626 is ``Number of nX6 0..2 arrays with some element plus some horizontally or vertically adjacent neighbor totalling two no more than once.''. It has offset $1$ and begins
\[
336, 8586, 187224, 3819654, 74914554, 1430057208, 26758514760, 493042858032,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 09 2016 09:23:16, revision 4) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The array has $6$ cells across, with entries in $\{0,1,2\}$. An ADJACENT PAIR is a pair of cells
\[
\begin{array}{l}
$(i,j)\text{ and }(i,j{+}1)$ \\
$(i,j)\text{ and }(i{+}1,j)$ \\
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=1162.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268626.
