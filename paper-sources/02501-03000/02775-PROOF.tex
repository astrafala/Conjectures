...
\title{The empirical closed form for OEIS A225008, proved}
...
\begin{abstract}
OEIS A225008 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
$S=22$ vertices. Any function of the form $\sum_j p_j(n)\lambda_j^{\,n}$ satisfies the
...
OEIS A225008 is ``Number of n X 6 0..1 arrays with rows unimodal and columns nondecreasing.''. It has offset $1$ and begins
\[
22, 148, 610, 1897, 4900, 11088, 22716, 43065,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (2/45)*n\^{}6 + (8/15)*n\^{}5 + (91/36)*n\^{}4 + 6*n\^{}3 + (1337/180)*n\^{}2 + (67/15)*n + 1.
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 05 2018 05:59:46, revision 7) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{2 n^{6}}{45} + \frac{8 n^{5}}{15} + \frac{91 n^{4}}{36} + 6 n^{3} + \frac{1337 n^{2}}{180} + \frac{67 n}{15} + 1.
\]
...
walk, so with $M$ the adjacency matrix of that digraph on $S=22$ vertices, and $u,w$ the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A225008.
