...
\title{A further conjecture on OEIS A266252,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A266252 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $0, 3, 6, 11, 16, 22, 31, 37,\dots$, with offset $0$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = ((-1)\^{}n*(n-4)+n*(n+4))/2 for n>2.\end{quote}
