...
\title{A further conjecture on OEIS A219769,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A219769 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $4, 9, 33, 100, 283, 732, 1745, 3881,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (1/10080)*n\^{}8 - (1/120)*n\^{}6 + (73/240)*n\^{}5 - (487/160)*n\^{}4 + (1015/48)*n\^{}3 - (191389/2520)*n\^{}2 + (2351/20)*n - 5 for n>5.\end{quote}
