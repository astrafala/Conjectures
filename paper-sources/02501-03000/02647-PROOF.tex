...
\title{A further conjecture on OEIS A253453,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A253453 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $8501, 15220, 19254, 26831, 44242, 83003, 170184, 373130,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = 529*3\^{}(n-3) + 1832*2\^{}(n-1) + 10087 for n>6.\end{quote}
