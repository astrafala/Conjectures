...
\title{The empirical recurrence for OEIS A224023, proved by transfer matrix}
...
\begin{abstract}
OEIS A224023 counts arrays over $\{0,\dots,3\}$ whose rows, columns, diagonals or
antidiagonals are required to be monotone or unimodal, and carries an empirical recurrence of
order $41$ contributed by R.~H.~Hardin. A monotone condition is local, but a unimodal one
...
is a walk count on $S=15360$ vertices and the recurrence follows from a finite exact
computation.
\end{abstract}
...
OEIS A224023 is ``Number of nX7 0..3 arrays with rows nondecreasing and antidiagonals unimodal.''. It has offset $1$ and begins
\[
120, 14400, 1074167, 60614473, 2903448338, 126168072638, 5173325036371, 204938686276996,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 23:11:17, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;120\,a(n-1) - 6060\,a(n-2) + 173316\,a(n-3) - 3172287\,a(n-4) + 39656548\,a(n-5) - 352443358\,a(n-6) + 2297379936\,a(n-7) - 11353877196\,a(n-8) + 45067977530\,a(n-9) - 163575910944\,a(n-10) + 627001572604\,a(n-11) - 2683978430932\,a(n-12) + 10780238513518\,a(n-13) - 32948873206590\,a(n-14) + 77959459244560\,a(n-15) - 153434141519476\,a(n-16) + 1059262494852896\,a(n-17) - 2694841466898608\,a(n-18) + 12219509145685508\,a(n-19) + 11985467868644368\,a(n-20) + 94047496662754280\,a(n-21) + 94835829721618640\,a(n-22) + 1050524403777918000\,a(n-23) + 2113714471975471104\,a(n-24) + 5481174460069822848\,a(n-25) + 10535537672809153264\,a(n-26) + 27173919094636341472\,a(n-27) + 47704013358770735568\,a(n-28) + 67212912534846684448\,a(n-29) + 62342889733184689824\,a(n-30) + 49243871592902490976\,a(n-31) + 27263322225301218304\,a(n-32) + 12918679041553050240\,a(n-33) + 2921299068148297728\,a(n-34) + 856946059741420288\,a(n-35) - 327218428029860352\,a(n-36) - 16665963801149440\,a(n-37) - 24912329585756160\,a(n-38) + 4712255288340480\,a(n-39) + 807198452121600\,a(n-40) + 68097422131200\,a(n-41)
\end{equation}
for all $n>41$.
...
bit vector), $|\mathcal V|=S=15360$; let $(r,f)\to(s,f')$ be an edge when placing $s$ after $r$
...
$h_j=G^{j}N^{o}\mathbf{1}$, we have for $j\ge41$
\[
a(n_0+j)-\sum_i c_i\,a(n_0+j-i)=\,\mathbf{v}^{\!\top}G^{\,j-41}w,
\qquad w=h_{41}-\sum_i c_ih_{41-i} .
\]
...
$41$ applications of $G$ in exact integer arithmetic and $\mathbf{v}^{\!\top}G^{m}w$
evaluated for $m=0,1,\dots$, again exactly. Every one of those integers vanishes from the
index corresponding to $n=41+1$ onwards, and the run continued until $S+1$ consecutive
zeros had been seen.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224023.
