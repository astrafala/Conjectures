...
\title{A further conjecture on OEIS A267458,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A267458 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $1, 1, 1, 1, 3, 3, 5, 5,\dots$, with offset $0$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = (2*n+(-1)\^{}n-3)/2 for n>1.\end{quote}
