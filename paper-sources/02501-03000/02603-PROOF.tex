...
\title{A further conjecture on OEIS A250819,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A250819 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $41112, 131455, 315561, 641571, 1167796, 1962717, 3104985, 4683421,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (1695/4)*n\^{}4 + 3786*n\^{}3 + (54287/4)*n\^{}2 + (33539/2)*n + 6561.\end{quote}
