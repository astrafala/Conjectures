...
\title{The empirical recurrence for OEIS A208171, proved by counting patterns}
...
\begin{abstract}
OEIS A208171 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A208171 is ``Number of nX4 0..3 arrays with new values 0..3 introduced in row major order and no element equal to more than one of its immediate leftward or upward neighbors.''. It has offset $1$ and begins
\[
15, 2277, 473928, 99752346, 21002874867, 4422202024212, 931104734002155, 196046229442844736,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:41:52, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;226\,a(n-1) - 3345\,a(n-2) + 19752\,a(n-3) - 60897\,a(n-4) + 108504\,a(n-5) - 114399\,a(n-6) + 68040\,a(n-7) - 18225\,a(n-8)
\end{equation}
for all $n>9$.
...
\[
4!\Bigl(a(n)-\sum_i c_i\,a(n-i)\Bigr)\;=\;\mathbf{v}^{\!\top}N^{\,m-8}q(N)\mathbf{1} .
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208171.
