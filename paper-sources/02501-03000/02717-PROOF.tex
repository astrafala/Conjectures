...
\title{The empirical closed form for OEIS A223859, proved}
...
\begin{abstract}
OEIS A223859 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A223859 is ``Number of n X 3 0..3 arrays with rows and antidiagonals unimodal and columns nondecreasing.''. It has offset $1$ and begins
\[
50, 684, 4884, 24199, 93731, 303560, 857696, 2175884,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 24 2018 03:59:25, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{353 n^{9}}{181440} + \frac{353 n^{8}}{10080} + \frac{9707 n^{7}}{30240} + \frac{13 n^{6}}{8} + \frac{45713 n^{5}}{8640} + \frac{1809 n^{4}}{160} + \frac{332021 n^{3}}{22680} + \frac{6569 n^{2}}{504} + \frac{7241 n}{1260} - 2.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223859.
