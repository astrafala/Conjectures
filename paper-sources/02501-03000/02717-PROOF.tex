...
\title{The empirical recurrence for OEIS A235675, proved by transfer matrix}
...
\begin{abstract}
OEIS A235675 counts arrays of width $5$ over $\{0,1\}$ by reducing every $2\times2$ subblock to a
...
about it is one bit per adjacent pair of columns, so the count is a walk count on $S=129$
states.
\end{abstract}
...
OEIS A235675 is ``Number of (n+1)X(4+1) 0..1 arrays with the difference between each 2X2 subblock maximum and minimum lexicographically nondecreasing columnwise and nonincreasing rowwise.''. It has offset $1$ and begins
\[
742, 15790, 330840, 6894210, 143484144, 2985166430, 62100488254, 1291848133836,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 08:43:55, revision 6) this is still
...
f(B)\;=\;v_4-v_1,
\]
the largest entry minus the smallest. An array with $R$ rows and $5$ columns has $(R-1)\times4$ subblocks, and they
form a derived array
\[
D(i,j)=f\!\left(\begin{pmatrix} x(i,j) & x(i,j+1) \\ x(i+1,j) & x(i+1,j+1)\end{pmatrix}
\right),\qquad 0\le i<R-1,\;\; 0\le j<4 .
\]
...
far''---carries everything the future needs to know, and there are $3$ such pairs. The state
is therefore
\[
...
\begin{theorem}
\[
a(n)\;=\;25\,a(n-1) - 56\,a(n-2) - 760\,a(n-3) + 1870\,a(n-4) + 9093\,a(n-5) - 19671\,a(n-6) - 53908\,a(n-7) + 96797\,a(n-8) + 165297\,a(n-9) - 249510\,a(n-10) - 263103\,a(n-11) + 342224\,a(n-12) + 215121\,a(n-13) - 241863\,a(n-14) - 95529\,a(n-15) + 88208\,a(n-16) + 23290\,a(n-17) - 16128\,a(n-18) - 2854\,a(n-19) + 1362\,a(n-20) + 136\,a(n-21) - 40\,a(n-22)
\]
for every $n>20$.
\end{theorem}
...
array of width $5$ over $\{0,1\}$ with two and with three rows was written out cell by cell,
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A235675.
