...
\title{The empirical recurrence for OEIS A267928, proved by transfer matrix}
...
\begin{abstract}
OEIS A267928 counts arrays in which the REPEATED VALUES of each row, and of each column, stand in a
...
value so far in each column of the scan, so the count is a walk count on $S=21$ states.
\end{abstract}
...
OEIS A267928 is ``Number of n X 1 0..3 arrays with every repeated value in every row and column greater than the previous repeated value.''. It has offset $1$ and begins
\[
4, 16, 60, 222, 804, 2872, 10132, 35383,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 12*a(n-1) - 48*a(n-2) + 44*a(n-3) + 150*a(n-4) - 252*a(n-5) - 216*a(n-6) + 324*a(n-7) + 243*a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 25 2018 09:15:37, revision 10) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=21,\quad\tau=\mathbf{1} .
\]
...
\begin{theorem}
\[
a(n)\;=\;12\,a(n-1) - 48\,a(n-2) + 44\,a(n-3) + 150\,a(n-4) - 252\,a(n-5) - 216\,a(n-6) + 324\,a(n-7) + 243\,a(n-8)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267928.
