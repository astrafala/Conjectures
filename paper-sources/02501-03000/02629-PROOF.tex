...
\title{A further conjecture on OEIS A269760,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A269760 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $0, 6, 60, 450, 3000, 18750, 112500, 656250,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = 6*5\^{}(n-2)*(n-1).\end{quote}
