...
\title{A further conjecture on OEIS A250878,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A250878 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $90, 288, 678, 1328, 2306, 3680, 5518, 7888,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (34/3)*n\^{}3 + 28*n\^{}2 + (104/3)*n + 16.\end{quote}
