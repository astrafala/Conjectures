...
\title{The empirical recurrence for OEIS A233023, proved by transfer matrix}
...
\begin{abstract}
OEIS A233023 counts arrays over $\{0,\dots,3\}$ in which no two entries that are neighbours in
...
OEIS A233023 is ``Number of nX5 0..3 arrays with no element x(i,j) adjacent to value 3-x(i,j) horizontally, vertically, diagonally or antidiagonally, and top left element zero.''. It has offset $1$ and begins
\[
81, 2337, 92067, 3685017, 149128385, 6050598339, 245698677999, 9979662714381,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 07:47:29, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;59\,a(n-1) - 780\,a(n-2) + 619\,a(n-3) + 32493\,a(n-4) - 90013\,a(n-5) - 408784\,a(n-6) + 1361086\,a(n-7) + 1750387\,a(n-8) - 6258928\,a(n-9) - 3161760\,a(n-10) + 10671769\,a(n-11) + 1911277\,a(n-12) - 7549998\,a(n-13) + 65894\,a(n-14) + 2257616\,a(n-15) - 323424\,a(n-16) - 231416\,a(n-17) + 54784\,a(n-18) + 784\,a(n-19) - 480\,a(n-20)
\]
for every $n>20$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A233023.
