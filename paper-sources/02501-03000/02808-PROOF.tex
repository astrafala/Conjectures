...
\title{The empirical recurrence for OEIS A233126, proved by transfer matrix}
...
\begin{abstract}
OEIS A233126 counts arrays over $\{0,\dots,5\}$ in which no two entries that are neighbours in
...
\begin{theorem}
\[
a(n)\;=\;544\,a(n-1) - 82944\,a(n-2) + 5144576\,a(n-3) - 146800640\,a(n-4) + 1879048192\,a(n-5) - 8589934592\,a(n-6)
\]
for every $n>6$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A233126.
