...
\title{The empirical recurrence for OEIS A235443, proved by transfer matrix}
...
\begin{abstract}
OEIS A235443 counts arrays of width $3$ over $\{0,1\}$ by reducing every $2\times2$ subblock to a
...
about it is one bit per adjacent pair of columns, so the count is a walk count on $S=35$
states.
\end{abstract}
...
OEIS A235443 is ``Number of (n+1) X (2+1) 0..1 arrays with the difference between each 2 X 2 subblock maximum and minimum lexicographically nondecreasing rowwise and columnwise.''. It has offset $1$ and begins
\[
58, 382, 2476, 15936, 102376, 657290, 4219322, 27083638,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 8*a(n-1) - 8*a(n-2) - 16*a(n-3) + 12*a(n-4) + 14*a(n-5) - a(n-6) - 2*a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 19 2018 07:56:06, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-1) - 8\,a(n-2) - 16\,a(n-3) + 12\,a(n-4) + 14\,a(n-5) - a(n-6) - 2\,a(n-7)
\]
for every $n>5$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A235443.
