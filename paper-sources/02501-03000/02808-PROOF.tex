...
\title{A further conjecture on OEIS A282871,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A282871 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $1, 0, 11, 1, 1110, 110, 111110, 11110,\dots$, with offset $0$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = (-2000 + 99*(-10)\^{}n + 101*10\^{}n) / 1800 for n>3.\end{quote}
...
indices, and $a$ and $f$ were checked to agree at $n=7,\dots,9$,
