...
\title{A further conjecture on OEIS A285474,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A285474 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $1, 11, 100, 1111, 10000, 111111, 1000000, 11111111,\dots$, with offset $0$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = (-1 - (-10)\^{}n + (-1)\^{}n + 19*10\^{}n)/18.\end{quote}
