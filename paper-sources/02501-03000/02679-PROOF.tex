...
\title{The empirical closed form for OEIS A223633, proved}
...
\begin{abstract}
OEIS A223633 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A223633 is ``Number of n X 4 0..1 arrays with rows, antidiagonals and columns unimodal.''. It has offset $1$ and begins
\[
11, 121, 801, 3712, 13599, 42109, 114713, 282273,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 22 2018 02:01:59, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{n^{8}}{112} - \frac{n^{7}}{72} + \frac{203 n^{6}}{360} + \frac{37 n^{5}}{360} + \frac{41 n^{4}}{144} + \frac{901 n^{3}}{36} - \frac{168481 n^{2}}{2520} + \frac{5693 n}{60} - 45.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223633.
