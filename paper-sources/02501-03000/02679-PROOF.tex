...
\title{A further conjecture on OEIS A290837,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A290837 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $1, 1, 5, 15, 7, 63, 127, 255,\dots$, with offset $0$. The sequence satisfies
\[
  a(n)=3\,a(n-1) - 2\,a(n-2) ,
\]
...
\begin{quote}\raggedright a(n) = 2\^{}(1+n) - 1 for n>4.\end{quote}
...
indices, and $a$ and $f$ were checked to agree at $n=7,\dots,8$,
