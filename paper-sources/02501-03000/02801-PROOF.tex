...
\title{A further conjecture on OEIS A282411,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A282411 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $1, 1, 111, 0, 11111, 0, 1111111, 0,\dots$, with offset $0$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = (1 +(-1)\^{}n) * (10\^{}(1+n)-1)/18 for n>1.\end{quote}
