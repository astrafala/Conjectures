...
\title{The empirical recurrence for OEIS A207297, proved by transfer matrix}
...
\begin{abstract}
OEIS A207297 counts arrays of width $4$ over $\{0,1,2,3\}$ by reducing every $2\times2$ subblock to a
...
about it is one bit per adjacent pair of columns, so the count is a walk count on $S=34804$
states.
\end{abstract}
...
OEIS A207297 is ``Number of (n+1)X4 0..3 arrays with rows and columns of determinants of all 2X2 subblocks lexicographically nondecreasing.''. It has offset $1$ and begins
\[
15040, 2019514, 158967751, 8967460486, 380160979265, 12920283700575, 373780805511860, 9750412079156987,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 13:44:59, revision 9) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=34804.
\]
...
\begin{theorem}
\[
a(n)\;=\;72\,a(n-1) - 1686\,a(n-2) + 5072\,a(n-3) + 401103\,a(n-4) - 6241272\,a(n-5) + 15657512\,a(n-6) + 403835904\,a(n-7) - 3944527488\,a(n-8) + 8453431296\,a(n-9) + 64599109632\,a(n-10) - 475519942656\,a(n-11) + 1287747403776\,a(n-12) - 1583479259136\,a(n-13) + 701730127872\,a(n-14)
\]
for every $n>46$.
\end{theorem}
...
array of width $4$ over $\{0,1,2,3\}$ with two and with three rows was written out cell by cell,
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207297.
