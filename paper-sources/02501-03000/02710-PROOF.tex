...
\title{The empirical recurrence for OEIS A224008, proved by transfer matrix}
...
\begin{abstract}
OEIS A224008 counts arrays over $\{0,\dots,2\}$ whose rows, columns, diagonals or
...
OEIS A224008 is ``Number of n X 4 0..2 arrays with rows nondecreasing and antidiagonals unimodal.''. It has offset $1$ and begins
\[
15, 225, 2661, 28541, 297859, 3094127, 32148473, 334179881,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 15*a(n-1) - 58*a(n-2) + 105*a(n-3) + 20*a(n-4) - 183*a(n-5) + 220*a(n-6) + 240*a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 26 2018 05:46:05, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224008.
