...
\title{A further conjecture on OEIS A277936,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A277936 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $1, 3, 0, 15, 0, 63, 0, 255,\dots$, with offset $0$. The sequence satisfies
\[
  a(n)=5\,a(n-2) - 4\,a(n-4) ,
\]
...
\begin{quote}\raggedright a(n) = (-1/2-(-2)\^{}n+(-1)\^{}n/2+2\^{}n) for n>0. (End)\end{quote}
