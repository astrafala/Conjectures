...
\title{A further conjecture on OEIS A282121,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A282121 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $1, 11, 110, 1111, 11010, 111111, 1101010, 11111111,\dots$, with offset $0$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = (-21 - (-10)\^{}n + (-1)\^{}n + 219*10\^{}n) / 198.\end{quote}
