...
\title{The empirical recurrence for OEIS A268746, proved by transfer matrix}
...
\begin{abstract}
OEIS A268746 counts arrays of width $4$ over $\{0,1\}$ in which the number of adjacent PAIRS of
...
OEIS A268746 is ``Number of nX4 binary arrays with some element plus some horizontally or vertically adjacent neighbor totalling two no more than once.''. It has offset $1$ and begins
\[
13, 89, 623, 4110, 26334, 165019, 1016807, 6183665,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 8*a(n-1) +2*a(n-2) -82*a(n-3) -49*a(n-4) +124*a(n-5) +39*a(n-6) -58*a(n-7) -6*a(n-8) +8*a(n-9) -a(n-10)
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 12 2016 12:31:11, revision 4) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268746.
