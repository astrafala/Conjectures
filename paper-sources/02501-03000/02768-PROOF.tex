...
\title{A further conjecture on OEIS A277864,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A277864 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $1, 1, 1, 1101, 1, 111101, 1, 11111101,\dots$, with offset $0$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = (-41+50*(-1)\^{}n-(-2)\^{}n*5\^{}(1+n)+2\^{}n*5\^{}(1+n))/9. (End)\end{quote}
