...
\title{The empirical closed form for OEIS A188558, proved}
...
\begin{abstract}
OEIS A188558 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A188558 is ``Number of 7 X n binary arrays without the pattern 0 1 diagonally, vertically, antidiagonally or horizontally.''. It has offset $1$ and begins
\[
8, 15, 28, 52, 96, 176, 320, 576,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (1/5040)*n\^{}7 - (1/360)*n\^{}6 + (11/360)*n\^{}5 - (1/9)*n\^{}4 + (427/720)*n\^{}3 + (41/360)*n\^{}2 + (709/210)*n + 4.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 28 2018 06:52:19, revision 9) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{n^{7}}{5040} - \frac{n^{6}}{360} + \frac{11 n^{5}}{360} - \frac{n^{4}}{9} + \frac{427 n^{3}}{720} + \frac{41 n^{2}}{360} + \frac{709 n}{210} + 4.
\]
...
$n=10,\dots,17$ and agree at each. A monic recurrence of order $8$
determines $a(m)$ from $a(m-1),\dots,a(m-8)$, and for every $m\ge18$ both
$m>9$ and $m-8\ge10$ hold, so induction on $m$ gives $a(m)=f(m)$ for every
$m\ge10$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A188558.
