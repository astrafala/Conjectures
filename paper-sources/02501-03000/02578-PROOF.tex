...
\title{A further conjecture on OEIS A239032,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A239032 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $4, 16, 54, 149, 354, 757, 1495, 2773,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (1/144)*n\^{}6 - (17/240)*n\^{}5 + (169/144)*n\^{}4 - (81/16)*n\^{}3 + (1463/72)*n\^{}2 - (1001/30)*n + 25 for n>1.\end{quote}
