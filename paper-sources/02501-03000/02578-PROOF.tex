...
\title{The empirical recurrence for OEIS A223183, proved by transfer matrix}
...
\begin{abstract}
OEIS A223183 counts the ways of writing the vertices of a fixed graph $G$ into an array of width
...
single slice is a state and the count is a walk count on a finite digraph with $S=3266$ vertices.
\end{abstract}
...
OEIS A223183 is ``Rolling icosahedron footprints: number of nX5 0..11 arrays starting with 0 where 0..11 label vertices of an icosahedron and every array movement to a horizontal, vertical or antidiagonal neighbor moves along an icosahedral edge.''. It has offset $1$ and begins
\[
625, 1280, 10880, 103520, 1018720, 10117600, 100734400, 1003652480,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 21:18:58, revision 8) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=3266.
\]
...
\begin{theorem}
\[
a(n)\;=\;18\,a(n-1) - 114\,a(n-2) + 436\,a(n-3) - 1171\,a(n-4) + 2198\,a(n-5) - 2626\,a(n-6) + 1520\,a(n-7) + 79\,a(n-8) - 490\,a(n-9) + 156\,a(n-10) + 20\,a(n-11) - 16\,a(n-12)
\]
for every $n>14$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223183.
