...
\title{A further conjecture on OEIS A223837,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A223837 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $29, 239, 926, 2578, 6159, 13582, 28369, 56607,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (4/315)*n\^{}7 - (1/45)*n\^{}6 + (28/45)*n\^{}5 + (113/72)*n\^{}4 + (2137/180)*n\^{}3 + (14023/360)*n\^{}2 + (13159/140)*n - 339 for n>4.\end{quote}
...
indices, and $a$ and $f$ were checked to agree at $n=13,\dots,20$,
