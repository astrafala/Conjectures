...
\title{A further conjecture on OEIS A267156,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A267156 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $1, 10, 100, 1001, 10011, 100111, 1001111, 10011111,\dots$, with offset $0$. The sequence satisfies
\[
  a(n)=10\,a(n-1) + 1\,a(n-2) - 10\,a(n-3) ,
\]
...
\begin{quote}\raggedright a(n) = (-9*(-1)\^{}n+9910999999*2\^{}(n-7)*5\^{}(n-8)-11)/198 for n>7.\end{quote}
...
indices, and $a$ and $f$ were checked to agree at $n=11,\dots,13$,
