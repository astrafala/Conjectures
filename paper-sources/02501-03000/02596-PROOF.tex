...
\title{A further conjecture on OEIS A250658,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A250658 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $79, 142, 221, 316, 427, 554, 697, 856,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = 8*n\^{}2 + 39*n + 32.\end{quote}
