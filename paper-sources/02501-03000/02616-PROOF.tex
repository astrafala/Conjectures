...
\title{A further conjecture on OEIS A250817,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A250817 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $4356, 13735, 32745, 66291, 120304, 201741, 318585, 479845,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (171/4)*n\^{}4 + 390*n\^{}3 + (5627/4)*n\^{}2 + (3575/2)*n + 729.\end{quote}
