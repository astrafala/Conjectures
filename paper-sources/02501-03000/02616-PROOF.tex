...
\title{A further conjecture on OEIS A250856,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A250856 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $12311, 63631, 223933, 626416, 1499679, 3204951, 6279401, 11485528,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (76/9)*n\^{}6 + (1595/12)*n\^{}5 + (28765/36)*n\^{}4 + (31373/12)*n\^{}3 + (155683/36)*n\^{}2 + (10223/3)*n + 1024.\end{quote}
