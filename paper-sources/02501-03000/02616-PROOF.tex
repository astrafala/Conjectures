...
\title{The empirical recurrence for OEIS A183512, proved by transfer matrix}
...
\begin{abstract}
OEIS A183512 counts arrays of width $4$ over $\{0,1\}$ in which every cell is the sum of one of two groups of its neighbours. The entry carries an
...
OEIS A183512 is ``Number of nX4 binary arrays with each element equal to either the sum mod 2 of its horizontal and vertical neighbors or the sum mod 2 of its diagonal and antidiagonal neighbors.''. It has offset $1$ and begins
\[
4, 24, 138, 736, 3504, 18288, 94376, 490864,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 01:50:29, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + 32\,a(n-3) + 4\,a(n-4) + 96\,a(n-5) - 368\,a(n-6) - 512\,a(n-7) - 2560\,a(n-8) - 1120\,a(n-9) - 1280\,a(n-10) + 3840\,a(n-11) + 40960\,a(n-12) + 64000\,a(n-14)
\]
for every $n>13$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A183512.
