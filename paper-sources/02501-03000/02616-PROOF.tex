...
\title{A further conjecture on OEIS A268898,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A268898 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $3, 36, 240, 1344, 6912, 33792, 159744, 737280,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = 4\^{}(n-1) * (6*n-3).\end{quote}
