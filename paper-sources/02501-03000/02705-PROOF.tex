...
\title{The empirical recurrence for OEIS A208257, proved by counting patterns}
...
\begin{abstract}
OEIS A208257 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A208257 is ``Number of nX7 0..2 arrays with new values 0..2 introduced in row major order and no element equal to more than one of its immediate leftward or upward neighbors.''. It has offset $1$ and begins
\[
365, 393216, 415737216, 439026252912, 463586569433280, 489518751475118880, 516901401841519506624, 545815772261840889783840,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:43:36, revision 9) the statement is
...
For every $n$ with $m=n+0-1\ge36$,
\[
3!\Bigl(a(n)-\sum_i c_i\,a(n-i)\Bigr)\;=\;\mathbf{v}^{\!\top}N^{\,m-36}q(N)\mathbf{1} .
\]
...
corresponding to $n=37+1$ onwards, and the run continued until $w$ was the zero vector,
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208257.
