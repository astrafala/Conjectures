...
\title{A further conjecture on OEIS A250814,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A250814 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $129, 379, 873, 1731, 3097, 5139, 8049, 12043,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = 1*n\^{}4 + 10*n\^{}3 + 37*n\^{}2 + 54*n + 27.\end{quote}
