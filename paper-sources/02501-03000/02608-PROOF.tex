...
\title{A further conjecture on OEIS A250880,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A250880 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $2002, 6812, 16262, 31928, 55386, 88212, 131982, 188272,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (788/3)*n\^{}3 + 744*n\^{}2 + (2218/3)*n + 256.\end{quote}
