...
\title{A further conjecture on OEIS A267678,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A267678 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $1, 2, 20, 104, 468, 1960, 8020, 32424,\dots$, with offset $0$. The sequence satisfies
\[
...
\begin{quote}\raggedright Conjecture: a(n) = 2*(-3 + (-1)\^{}n - 2\^{}(2+n) + 3*4\^{}n)/3 for n>1. - \_Colin Barker\_, Feb 14 2017\end{quote}
