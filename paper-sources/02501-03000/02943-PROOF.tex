...
\title{The empirical column recurrences for the table OEIS A258554}
...
\begin{abstract}
OEIS A258554 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
exact computation, with the Cayley--Hamilton theorem bounding the work. This note settles the rows $n=1, 2, 3, 4, 5, 6, 7$.
\end{abstract}
...
OEIS A258554 is ``T(n,k)=Number of (n+1)X(k+1) 0..1 arrays with every 2X2 subblock ne-sw antidiagonal difference nondecreasing horizontally and nw+se diagonal sum nondecreasing vertically.''. It has offset $1$, is
read by antidiagonals, and begins
\[
16, 44, 44, 104, 112, 104, 228, 210,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 15:28:39, revision 6) these are still
...
\subsection*{Row $n$$=1$}
The sequence is ``Number of (2)X(n+1) 0..1 arrays with every 2X2 subblock ne-sw antidiagonal difference nondecreasing horizontally and nw+se diagonal sum nondecreasing vertically.''. Its rows are the vertices of a digraph on
...
\subsection*{Row $n$$=2$}
The sequence is ``Number of (3)X(n+1) 0..1 arrays with every 2X2 subblock ne-sw antidiagonal difference nondecreasing horizontally and nw+se diagonal sum nondecreasing vertically.''. Its rows are the vertices of a digraph on
...
\subsection*{Row $n$$=3$}
The sequence is ``Number of (4)X(n+1) 0..1 arrays with every 2X2 subblock ne-sw antidiagonal difference nondecreasing horizontally and nw+se diagonal sum nondecreasing vertically.''. Its rows are the vertices of a digraph on
$S=104$ vertices, edges being the admissible consecutive pairs, and the count is
$\mathbf{1}^{\!\top}M^{n}\mathbf{1}$ up to the constant factor in the entry's name.
The conjectured recurrence
\[
a(n)\;=\;3\,a(n-1) - 3\,a(n-2) + a(n-3) + a(n-4) - 3\,a(n-5) + 3\,a(n-6) - a(n-7)
...
\subsection*{Row $n$$=4$}
The sequence is ``Number of (5)X(n+1) 0..1 arrays with every 2X2 subblock ne-sw antidiagonal difference nondecreasing horizontally and nw+se diagonal sum nondecreasing vertically.''. Its rows are the vertices of a digraph on
$S=228$ vertices, edges being the admissible consecutive pairs, and the count is
$\mathbf{1}^{\!\top}M^{n}\mathbf{1}$ up to the constant factor in the entry's name.
The conjectured recurrence
\[
a(n)\;=\;3\,a(n-1) - 3\,a(n-2) + a(n-3) + a(n-4) - 3\,a(n-5) + 3\,a(n-6) - a(n-7)
...
\subsection*{Row $n$$=5$}
The sequence is ``Number of (6)X(n+1) 0..1 arrays with every 2X2 subblock ne-sw antidiagonal difference nondecreasing horizontally and nw+se diagonal sum nondecreasing vertically.''. Its rows are the vertices of a digraph on
$S=480$ vertices, edges being the admissible consecutive pairs, and the count is
$\mathbf{1}^{\!\top}M^{n}\mathbf{1}$ up to the constant factor in the entry's name.
The conjectured recurrence
\[
a(n)\;=\;3\,a(n-1) - 3\,a(n-2) + a(n-3) + a(n-4) - 3\,a(n-5) + 3\,a(n-6) - a(n-7)
...
\subsection*{Row $n$$=6$}
The sequence is ``Number of (7)X(n+1) 0..1 arrays with every 2X2 subblock ne-sw antidiagonal difference nondecreasing horizontally and nw+se diagonal sum nondecreasing vertically.''. Its rows are the vertices of a digraph on
$S=988$ vertices, edges being the admissible consecutive pairs, and the count is
$\mathbf{1}^{\!\top}M^{n}\mathbf{1}$ up to the constant factor in the entry's name.
The conjectured recurrence
\[
a(n)\;=\;3\,a(n-1) - 3\,a(n-2) + a(n-3) + a(n-4) - 3\,a(n-5) + 3\,a(n-6) - a(n-7)
...
\subsection*{Row $n$$=7$}
The sequence is ``Number of (8)X(n+1) 0..1 arrays with every 2X2 subblock ne-sw antidiagonal difference nondecreasing horizontally and nw+se diagonal sum nondecreasing vertically.''. Its rows are the vertices of a digraph on
$S=2008$ vertices, edges being the admissible consecutive pairs, and the count is
$\mathbf{1}^{\!\top}M^{n}\mathbf{1}$ up to the constant factor in the entry's name.
The conjectured recurrence
\[
a(n)\;=\;3\,a(n-1) - 3\,a(n-2) + a(n-3) + a(n-4) - 3\,a(n-5) + 3\,a(n-6) - a(n-7)
...
model reproduces $78$ published values, $309$ decimal digits in all, every one of
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A258554.
