...
\title{The empirical recurrence for OEIS A279710, proved by transfer matrix}
...
\begin{abstract}
OEIS A279710 counts $3\times n$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A279710 is ``Number of 3 X n 0..1 arrays with no element equal to a strict majority of its horizontal and antidiagonal neighbors and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
4, 5, 11, 22, 47, 102, 224, 494,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) - 2*a(n-2) - a(n-3) + 4*a(n-4) - a(n-5) - a(n-7) - a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 11 2019 14:23:22, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) - 2\,a(n-2) - a(n-3) + 4\,a(n-4) - a(n-5) - a(n-7) - a(n-8)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A279710.
