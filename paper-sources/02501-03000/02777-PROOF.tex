...
\title{A further conjecture on OEIS A279028,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A279028 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $1, 0, 101, 0, 10101, 0, 1010101, 0,\dots$, with offset $0$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = (1 + (-1)\^{}n)*(-1 + 10\^{}(2 + n))/198.\end{quote}
