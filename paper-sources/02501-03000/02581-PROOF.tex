...
\title{A further conjecture on OEIS A266795,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A266795 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $0, 1, 4, 6, 11, 15, 23, 27,\dots$, with offset $0$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = (2*n*(n+(-1)\^{}n+1)-7*(-1)\^{}n+3)/4 for n>3.\end{quote}
