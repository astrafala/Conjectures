...
\title{A further conjecture on OEIS A227259,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A227259 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $3, 9, 23, 50, 96, 168, 274, 423,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (1/24)*n\^{}4 + (5/12)*n\^{}3 + (11/24)*n\^{}2 + (13/12)*n + 1.\end{quote}
