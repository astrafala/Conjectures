...
\title{A further conjecture on OEIS A239359,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A239359 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $7, 19, 39, 77, 156, 266, 409, 599,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (8/3)*n\^{}3 - (45/2)*n\^{}2 + (257/6)*n + 330 for n>13.\end{quote}
...
indices, and $a$ and $f$ were checked to agree at $n=18,\dots,21$,
