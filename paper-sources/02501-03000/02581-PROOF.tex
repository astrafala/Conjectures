...
\title{A further conjecture on OEIS A250607,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A250607 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $120, 290, 592, 1126, 2092, 3890, 7320, 13982,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = 100*2\^{}(n-1) + 16*n\^{}2 + 22*n - 18.\end{quote}
