...
\title{The empirical recurrence for OEIS A253020, proved by transfer matrix}
...
\begin{abstract}
OEIS A253020 counts arrays of width $5$ over an alphabet of $4$ letters in which every three
...
OEIS A253020 is ``Number of (n+2) X (3+2) 0..3 arrays with every consecutive three elements in every row and column not having exactly two distinct values, and in every diagonal and antidiagonal having exactly two distinct values, and new values 0 upwards introduced in row major order.''. It has offset $1$ and begins
\[
51, 83, 133, 120, 219, 350, 302, 531,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 5*a(n-3) - 6*a(n-6) - a(n-9) + a(n-12) for n>15.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 08 2018 11:41:06, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253020.
