...
\title{The empirical recurrence for OEIS A203919, proved by transfer matrix}
...
\begin{abstract}
OEIS A203919 counts $(n+2)\times6$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A203919 is ``Number of (n+2)X6 0..1 arrays with every 3X3 subblock having equal diagonal elements or equal antidiagonal elements, and new values 0..1 introduced in row major order.''. It has offset $1$ and begins
\[
5000, 21632, 75272, 262088, 916658, 3220722, 11309768, 39783200,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 10:51:33, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 4\,a(n-2) + 21\,a(n-4) - 44\,a(n-5) + 77\,a(n-6) + 158\,a(n-7) - 83\,a(n-8) - 645\,a(n-9) + 64\,a(n-10) - 2301\,a(n-11) - 3155\,a(n-12) + 1580\,a(n-13) + 6476\,a(n-14) + 55\,a(n-15) + 15516\,a(n-16) + 19296\,a(n-17) - 747\,a(n-18) - 810\,a(n-19) - 5913\,a(n-20) - 75627\,a(n-21) - 49815\,a(n-22) + 27054\,a(n-23) - 243\,a(n-24) + 19926\,a(n-25) + 11664\,a(n-26) + 10935\,a(n-27) - 6561\,a(n-28)
\]
for every $n>29$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A203919.
