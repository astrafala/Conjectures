...
\title{The empirical recurrence for OEIS A239399, proved by transfer matrix}
...
\begin{abstract}
OEIS A239399 counts arrays over $\{0,1,2,3\}$ in which no entry may equal, modulo $4$, a given
...
OEIS A239399 is ``Number of n X 2 0..3 arrays with no element equal to one plus the sum of elements to its left or two plus the sum of elements above it, modulo 4.''. It has offset $1$ and begins
\[
4, 23, 129, 698, 3805, 20818, 113774, 621754,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 06 2023 16:20:59, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A239399.
