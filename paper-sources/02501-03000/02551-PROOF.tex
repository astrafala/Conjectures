...
\title{A further conjecture on OEIS A266287,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A266287 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $0, 2, 5, 8, 14, 18, 27, 32,\dots$, with offset $0$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = (2*n\^{}2+5*n+(-1)\^{}n*(n-1)+1)/4.\end{quote}
