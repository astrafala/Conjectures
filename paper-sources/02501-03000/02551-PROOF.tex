...
\title{A further conjecture on OEIS A219846,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A219846 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $3, 7, 16, 33, 62, 108, 177, 276,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (1/24)*n\^{}4 + (1/12)*n\^{}3 + (23/24)*n\^{}2 - (1/12)*n + 2.\end{quote}
