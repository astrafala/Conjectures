...
\title{An exact count for OEIS A229017: windowed medians over a growing alphabet}
...
\begin{abstract}
OEIS A229017 counts the arrays obtainable as the medians of $3$ adjacent elements of a length
...
The entry's first terms are $2, 193, 2054, 10735, 38768, 111311, 273124, 597477,\dots$ and it states

\begin{quote}\raggedright Empirical: a(n) = (5/126)*n\^{}7 + (233/180)*n\^{}6 + (1073/180)*n\^{}5 - (85/18)*n\^{}4 - (89/36)*n\^{}3 + (617/180)*n\^{}2 - (177/70)*n + 1.\end{quote}
...
\[
  \lvert\Phi(\{0,\dots,n\}^k)\rvert
  = 2\binom{n+1}{2} + 152\binom{n+1}{3} + 858\binom{n+1}{4} + 1472\binom{n+1}{5} + 924\binom{n+1}{6} + 172\binom{n+1}{7} \;+\; 1\binom{n-1}{1} + 34\binom{n-2}{0} + 118\binom{n-2}{1} + 84\binom{n-2}{2} + 422\binom{n-3}{0} + 1498\binom{n-3}{1} + 1730\binom{n-3}{2} + 654\binom{n-3}{3} + 1156\binom{n-4}{0} + 4972\binom{n-4}{1} + 7980\binom{n-4}{2} + 5668\binom{n-4}{3} + 1504\binom{n-4}{4} + 1152\binom{n-5}{0} + 5948\binom{n-5}{1} + 12272\binom{n-5}{2} + 12648\binom{n-5}{3} + 6512\binom{n-5}{4} + 1340\binom{n-5}{5} + 412\binom{n-6}{0} + 2496\binom{n-6}{1} + 6300\binom{n-6}{2} + 8480\binom{n-6}{3} + 6420\binom{n-6}{4} + 2592\binom{n-6}{5} + 436\binom{n-6}{6} + 28\binom{n-7}{0} + 196\binom{n-7}{1} + 588\binom{n-7}{2} + 980\binom{n-7}{3} + 980\binom{n-7}{4} + 588\binom{n-7}{5} + 196\binom{n-7}{6} + 28\binom{n-7}{7}
  = \frac{5 n^{7}}{126} + \frac{233 n^{6}}{180} + \frac{1073 n^{5}}{180} - \frac{85 n^{4}}{18} - \frac{89 n^{3}}{36} + \frac{617 n^{2}}{180} - \frac{177 n}{70} + 1 .
\]

\section{Conclusion}

The right-hand side is the polynomial the entry states, so the empirical claim of OEIS A229017 is
