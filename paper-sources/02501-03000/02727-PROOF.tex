...
\title{The empirical recurrence for OEIS A240266, proved by transfer matrix}
...
\begin{abstract}
OEIS A240266 counts arrays over $\{0,1,2,3\}$ in which no entry may equal, modulo $4$, a given
...
OEIS A240266 is ``Number of n X 2 0..3 arrays with no element equal to zero plus the sum of elements to its left or one plus the sum of elements above it or one plus the sum of the elements diagonally to its northwest, modulo 4.''. It has offset $1$ and begins
\[
4, 7, 14, 36, 72, 170, 411, 879,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-2) + 10*a(n-3) - a(n-4) - 5*a(n-5) - 15*a(n-6) + a(n-7) + 4*a(n-8) + 2*a(n-9) + 10*a(n-10) + 5*a(n-11) - 6*a(n-13).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 27 2018 06:25:58, revision 9) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A240266.
