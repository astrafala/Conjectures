...
\title{The empirical recurrence for OEIS A238721, proved by transfer matrix}
...
\begin{abstract}
OEIS A238721 counts arrays over $\{0,1,2\}$ in which no entry may equal, modulo $3$, a given
...
count is then a walk count on $S=27$ states.
\end{abstract}
...
OEIS A238721 is ``Number of n X 3 0..2 arrays with no element equal to the sum modulo 3 of elements to its left or elements above it.''. It has offset $1$ and begins
\[
4, 10, 40, 86, 336, 704, 2704, 5660,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 17*a(n-2) -96*a(n-4) +210*a(n-6) -152*a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 30 2023 13:08:16, revision 11) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The array has $3$ cells across one way, entries $x(i,j)\in\{0,1,2\}$, and the entry names these
...
\begin{theorem}
\[
a(n)\;=\;17\,a(n-2) - 96\,a(n-4) + 210\,a(n-6) - 152\,a(n-8)
\]
for every $n>7$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A238721.
