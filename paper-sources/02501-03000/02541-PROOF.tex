...
\title{A further conjecture on OEIS A219708,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A219708 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $4, 13, 44, 129, 338, 813, 1822, 3840,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (1/40320)*n\^{}8 + (1/2016)*n\^{}7 + (7/2880)*n\^{}6 + (5/144)*n\^{}5 + (167/5760)*n\^{}4 + (259/288)*n\^{}3 + (4723/10080)*n\^{}2 - (73/168)*n + 3.\end{quote}
