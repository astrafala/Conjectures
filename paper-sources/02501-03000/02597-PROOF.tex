...
\title{A further conjecture on OEIS A267157,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A267157 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $1, 2, 4, 9, 19, 39, 79, 159,\dots$, with offset $0$. The sequence satisfies
\[
  a(n)=2\,a(n-1) + 1\,a(n-2) - 2\,a(n-3) ,
\]
...
\begin{quote}\raggedright a(n) = (-(-1)\^{}n+959*2\^{}(n-7)-3)/6 for n>7.\end{quote}
