...
\title{A further conjecture on OEIS A240395,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A240395 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $2, 12, 32, 62, 118, 206, 351, 568,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (1/6)*n\^{}4 - (5/6)*n\^{}3 + (13/3)*n\^{}2 + (31/3)*n - 48 for n>5.\end{quote}
