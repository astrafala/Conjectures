...
\title{A further conjecture on OEIS A238807,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A238807 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $4, 15, 48, 118, 254, 498, 916, 1605,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (1/360)*n\^{}6 - (1/30)*n\^{}5 + (7/9)*n\^{}4 - (65/12)*n\^{}3 + (11959/360)*n\^{}2 - (1631/20)*n + 83 for n>2.\end{quote}
...
indices, and $a$ and $f$ were checked to agree at $n=10,\dots,16$,
