...
\title{A further conjecture on OEIS A221684,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A221684 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $16, 40, 68, 100, 133, 166, 199, 232,\dots$, with offset $1$. The sequence satisfies
\[
  a(n)=2\,a(n-1) - 1\,a(n-2) ,
\]
...
\begin{quote}\raggedright Empirical: a(n) = 33*n - 32 for n>3\end{quote}
