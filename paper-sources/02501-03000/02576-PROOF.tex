...
\title{A further conjecture on OEIS A266724,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A266724 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $0, 1, 3, 1, 7, 1, 11, 1,\dots$, with offset $0$. The sequence satisfies
\[
  a(n)=2\,a(n-2) - 1\,a(n-4) ,
\]
...
\begin{quote}\raggedright a(n) = (-1)\^{}n*(n-1)+n for n>0.\end{quote}
