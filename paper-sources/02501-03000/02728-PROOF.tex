...
\title{The empirical recurrence for OEIS A239814, proved by transfer matrix}
...
\begin{abstract}
OEIS A239814 counts arrays over $\{0,1,2,3\}$ in which no entry may equal, modulo $4$, a given
...
OEIS A239814 is ``Number of nX3 0..3 arrays with no element equal to zero plus the sum of elements to its left or one plus the sum of elements above it, modulo 4.''. It has offset $1$ and begins
\[
10, 132, 1480, 17552, 204779, 2405330, 28156167, 330152684,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 09:31:53, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A239814.
