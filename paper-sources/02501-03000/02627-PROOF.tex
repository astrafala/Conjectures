...
\title{The empirical recurrence for OEIS A206500, proved by transfer matrix}
...
\begin{abstract}
OEIS A206500 counts arrays in which no entry may equal the entries at a short list of fixed offsets
...
$2$ consecutive rows, $S=49868$ states in all.
\end{abstract}
...
OEIS A206500 is ``Number of nX3 0..7 arrays with no element equal to another within a city block distance of two, and new values 0..7 introduced in row major order.''. It has offset $1$ and begins
\[
1, 4, 65, 3130, 178998, 10502458, 618242826, 36410671102,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 55*a(n-1) +370*a(n-2) -8556*a(n-3) +15608*a(n-4) +70028*a(n-5) -175808*a(n-6) +98304*a(n-7) for n>9
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 12:57:22, revision 10) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=49868.
\]
...
\begin{theorem}
\[
a(n)\;=\;55\,a(n-1) + 370\,a(n-2) - 8556\,a(n-3) + 15608\,a(n-4) + 70028\,a(n-5) - 175808\,a(n-6) + 98304\,a(n-7)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206500.
