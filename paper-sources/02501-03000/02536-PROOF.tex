...
\title{A further conjecture on OEIS A219680,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A219680 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $3, 4, 9, 19, 35, 60, 98, 154,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (1/24)*n\^{}4 - (1/4)*n\^{}3 + (47/24)*n\^{}2 - (7/4)*n for n>2.\end{quote}
