...
\title{A further conjecture on OEIS A266219,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A266219 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $1, 11, 110, 1101, 11010, 110101, 1101010, 11010101,\dots$, with offset $0$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = 1/198*(-9*(-1)\^{}n+109*2\^{}(n+1)*5\^{}n-11).\end{quote}
