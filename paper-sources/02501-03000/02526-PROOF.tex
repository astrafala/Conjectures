...
\title{A further conjecture on OEIS A219515,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A219515 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $4, 5, 24, 68, 187, 465, 1090, 2430,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (1/6720)*n\^{}8 - (1/360)*n\^{}7 + (41/1440)*n\^{}6 + (7/18)*n\^{}5 - (41099/2880)*n\^{}4 + (68651/360)*n\^{}3 - (6724661/5040)*n\^{}2 + (58709/12)*n - 7380 for n>6.\end{quote}
