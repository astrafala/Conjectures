...
\title{The empirical recurrence for OEIS A267639, proved by transfer matrix}
...
\begin{abstract}
OEIS A267639 counts arrays in which the REPEATED VALUES of each row, and of each column, stand in a
...
OEIS A267639 is ``Number of nX3 0..1 arrays with every repeated value in every row and column unequal to the previous repeated value, and new values introduced in row-major sequential order.''. It has offset $1$ and begins
\[
3, 18, 51, 189, 429, 1353, 2829, 8427,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 18 2016 20:08:31, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 16\,a(n-2) - 33\,a(n-3) - 91\,a(n-4) + 198\,a(n-5) + 216\,a(n-6) - 523\,a(n-7) - 180\,a(n-8) + 576\,a(n-9) - 180\,a(n-11)
\]
for every $n>11$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267639.
