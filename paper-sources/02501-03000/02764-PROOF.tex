...
\title{A further conjecture on OEIS A277797,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A277797 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $1, 0, 1, 1100, 1, 111100, 1, 11111100,\dots$, with offset $0$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = (-91+109*(-1)\^{}n+10\^{}(1+n)-(-1)\^{}n*10\^{}(1+n))/18. (End)\end{quote}
