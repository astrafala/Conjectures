...
\title{The empirical recurrence for OEIS A204079, proved by transfer matrix}
...
\begin{abstract}
OEIS A204079 counts arrays of width $3$ over $\{0,1,2,3\}$ in which every cell has neighbours equal to each of two named values. The entry carries an
...
OEIS A204079 is ``Number of nX3 0..3 arrays with every element neighboring horizontally or vertically both a 0 and a 1.''. It has offset $1$ and begins
\[
0, 4, 132, 256, 5260, 37636, 321696, 2951524,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 10:59:12, revision 9) this is still
...
Thus
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=2305,
\]
...
\begin{theorem}
\[
a(n)\;=\;9\,a(n-1) - 3\,a(n-3) - 53\,a(n-4) - 204\,a(n-5) + 6138\,a(n-6) - 54492\,a(n-7) + 9384\,a(n-8) - 51288\,a(n-9) + 466488\,a(n-10) - 62016\,a(n-11) - 306128\,a(n-12) + 3916128\,a(n-13) + 2633856\,a(n-15) - 33362176\,a(n-16)
\]
for every $n>19$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204079.
