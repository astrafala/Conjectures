...
\title{A further conjecture on OEIS A220154,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A220154 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $6, 11, 23, 50, 88, 137, 197, 268,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (11/2)*n\^{}2 - (23/2)*n + 8 for n>2.\end{quote}
