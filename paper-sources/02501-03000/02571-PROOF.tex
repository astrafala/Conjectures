...
\title{A further conjecture on OEIS A239987,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A239987 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $3, 6, 13, 22, 38, 65, 107, 169,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (1/24)*n\^{}4 - (1/4)*n\^{}3 + (71/24)*n\^{}2 - (43/4)*n + 23 for n>3.\end{quote}
