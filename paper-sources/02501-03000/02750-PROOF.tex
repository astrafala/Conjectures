...
\title{The empirical recurrence for OEIS A267976, proved by transfer matrix}
...
\begin{abstract}
OEIS A267976 counts arrays in which the REPEATED VALUES of each row, and of each column, stand in a
...
OEIS A267976 is ``Number of 2Xn 0..3 arrays with every repeated value in every row greater than or equal to, and in every column greater than, the previous repeated value.''. It has offset $1$ and begins
\[
16, 256, 4096, 62500, 929296, 13498276, 192321424, 2695374889,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 23 2016 10:03:25, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;70\,a(n-1) - 2030\,a(n-2) + 30793\,a(n-3) - 246680\,a(n-4) + 794920\,a(n-5) + 1553979\,a(n-6) - 13039450\,a(n-7) - 13949950\,a(n-8) + 88507965\,a(n-9) + 242460400\,a(n-10) + 242460400\,a(n-11) + 88507965\,a(n-12) - 13949950\,a(n-13) - 13039450\,a(n-14) + 1553979\,a(n-15) + 794920\,a(n-16) - 246680\,a(n-17) + 30793\,a(n-18) - 2030\,a(n-19) + 70\,a(n-20) - a(n-21)
\]
for every $n>20$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267976.
