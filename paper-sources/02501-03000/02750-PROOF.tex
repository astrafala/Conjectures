...
\title{The empirical recurrence for OEIS A224157, proved by transfer matrix}
...
\begin{abstract}
OEIS A224157 counts arrays over $\{0,\dots,1\}$ whose rows, columns, diagonals or
...
OEIS A224157 is ``Number of nX7 0..1 arrays with diagonals and rows unimodal and antidiagonals nondecreasing.''. It has offset $1$ and begins
\[
29, 267, 1252, 4339, 13283, 39037, 114537, 340134,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 23:17:09, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;8\,a(n-1) - 20\,a(n-2) + 11\,a(n-3) + 13\,a(n-4) + 18\,a(n-5) - 83\,a(n-6) + 98\,a(n-7) - 99\,a(n-8) + 159\,a(n-9) - 264\,a(n-10) + 312\,a(n-11) - 324\,a(n-12) + 647\,a(n-13) - 757\,a(n-14) + 88\,a(n-15) + 283\,a(n-16) - 257\,a(n-17) - 451\,a(n-18) + 365\,a(n-19) - 1074\,a(n-20) + 477\,a(n-21) - 1092\,a(n-22) + 258\,a(n-23) - 916\,a(n-24) - 142\,a(n-25) + 114\,a(n-26) + 202\,a(n-27) + 118\,a(n-28) - 56\,a(n-29) + 56\,a(n-30) - 24\,a(n-31) + 8\,a(n-32) - 8\,a(n-33)
\end{equation}
for all $n>37$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224157.
