...
\title{The empirical recurrence for OEIS A266097, proved by transfer matrix}
...
\begin{abstract}
OEIS A266097 counts arrays of width $4$ in which every entry is equal to the NUMBER of its own
...
OEIS A266097 is ``Number of nX4 integer arrays with each element equal to the number of horizontal and antidiagonal neighbors exactly one smaller than itself.''. It has offset $1$ and begins
\[
5, 36, 161, 929, 4893, 26948, 145274, 790986,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 21 2015 08:16:51, revision 4) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=11861.
\]
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 24\,a(n-2) + 17\,a(n-3) - 89\,a(n-4) - 40\,a(n-5) + 146\,a(n-6) + 18\,a(n-7) - 82\,a(n-8) - 6\,a(n-9) - 8\,a(n-10) + 36\,a(n-11) - 13\,a(n-12) + a(n-13) - 2\,a(n-14) + a(n-15)
\]
for every $n>16$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A266097.
