...
\title{A further conjecture on OEIS A250879,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A250879 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $440, 1456, 3442, 6728, 11644, 18520, 27686, 39472,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = 55*n\^{}3 + 155*n\^{}2 + 166*n + 64.\end{quote}
