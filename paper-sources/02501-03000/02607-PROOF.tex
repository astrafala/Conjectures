...
\title{A further conjecture on OEIS A267623,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A267623 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $1, 10, 101, 1011, 10111, 101111, 1011111, 10111111,\dots$, with offset $0$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (91*10\^{}n - 10) / 90 for n>0. - \_Colin Barker\_, Mar 10 2017\end{quote}
