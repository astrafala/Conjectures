...
\title{The empirical recurrence for OEIS A209014, proved by transfer matrix}
...
\begin{abstract}
OEIS A209014 counts arrays of width $3$ over $\{0,1,2,3\}$ in which no cell is the average of its neighbours. The entry carries an
...
$2$ consecutive rows and the count is a walk count on $S=65$ states.
\end{abstract}
...
OEIS A209014 is ``Number of n X 3 0..3 arrays with no element equal the average of immediate neighbors vertically above, diagonally above and left, and horizontally left of it.''. It has offset $1$ and begins
\[
36, 1430, 57412, 2303052, 92409982, 3707858104, 148774643618, 5969451726624,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 09 2023 15:41:43, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;30\,a(n-1) + 507\,a(n-2) - 3690\,a(n-3) - 16906\,a(n-4) + 106528\,a(n-5) + 124733\,a(n-6) - 1050424\,a(n-7) + 577820\,a(n-8) + 3131188\,a(n-9) - 4615763\,a(n-10) - 850984\,a(n-11) + 5888706\,a(n-12) - 4406256\,a(n-13) + 1242404\,a(n-14) - 133476\,a(n-15) + 1080\,a(n-16) + 864\,a(n-17)
\]
for every $n>17$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209014.
