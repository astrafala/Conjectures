...
\title{The empirical recurrence for OEIS A185986, proved by transfer matrix}
...
\begin{abstract}
OEIS A185986 counts arrays over $\{0,\dots,1\}$ under a condition comparing a statistic of
...
empirical. The count is a walk count on $S=10256$ states and is $C$-finite; whether the
...
OEIS A185986 is ``1/128 the number of (n+2)X4 binary arrays with each 3X3 subblock trace equal to some horizontal or vertical neighbor 3X3 subblock trace.''. It has offset $1$ and begins
\[
10, 76, 722, 6036, 52966, 462288, 4038360, 35286678,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 03:19:58, revision 9) this is still
...
requires that every subblock carries the same value of $\sigma$ as at least ONE of its neighbours horizontally or vertically. The entry counts $1/128$ of that number, and the model divides by $128$ before anything is compared.
...
supply the match. So the state carries, besides the $3$ consecutive array rows, a tally for
...
$S=10256$ states in all. Getting the two vectors right is the whole of the argument: with
...
$10$, which the model reproduces along with every later term, and that is the cheapest
...
\begin{theorem}
\[
a(n)\;=\;10\,a(n-1) - 11\,a(n-2) - 6\,a(n-3) + 51\,a(n-4) + 30\,a(n-5) - 330\,a(n-6) - 190\,a(n-7) + 568\,a(n-8) - 1888\,a(n-9) + 3442\,a(n-10) - 2512\,a(n-11) + 328\,a(n-12) - 1862\,a(n-13) + 4596\,a(n-14) - 1224\,a(n-15) - 432\,a(n-16)
\]
for every $n>16$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A185986.
