...
\title{The empirical recurrence for OEIS A252959, proved by transfer matrix}
...
\begin{abstract}
OEIS A252959 counts arrays of width $8$ over an alphabet of $5$ letters in which every three
...
brings the state count down to $S=703012$.
\end{abstract}
...
OEIS A252959 is ``Number of (n+2)X(6+2) 0..4 arrays with every consecutive three elements in every row and diagonal having exactly two distinct values, and in every column and antidiagonal not having exactly two distinct values, and new values 0 upwards introduced in row major order.''. It has offset $1$ and begins
\[
3465, 651, 985, 1551, 2822, 5100, 8767, 16909,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:48:19, revision 6) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The array has width $8$ and entries in $\{0,1,\dots,4\}$. Four families of triples
...
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,
\]
with $S=703012$ states in all. The walk index $j$ and the entry's own $n$ differ by a constant,
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) - 6\,a(n-2) - 2\,a(n-3) - 5\,a(n-4) + 15\,a(n-5) + 53\,a(n-6) - 145\,a(n-7) + 120\,a(n-8) - 44\,a(n-9) + 25\,a(n-10) - 21\,a(n-11) + 6\,a(n-12)
\]
for every $n>15$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252959.
