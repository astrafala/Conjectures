...
\title{A further conjecture on OEIS A223953,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A223953 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $64, 729, 2024, 3645, 5951, 9919, 16845, 28558,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (2/45)*n\^{}6 + (67/36)*n\^{}4 + 8*n\^{}3 + (7757/180)*n\^{}2 + 138*n + 1326 for n>4.\end{quote}
...
indices, and $a$ and $f$ were checked to agree at $n=12,\dots,18$,
