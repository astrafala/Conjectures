...
\title{The empirical recurrence for OEIS A202793, proved by transfer matrix}
...
\begin{abstract}
OEIS A202793 counts arrays of width $6$ over $\{0,1\}$ in which every cell of a named value has a neighbour of that same value. The entry carries an
...
OEIS A202793 is ``Number of n X 6 binary arrays with every one adjacent to another one horizontally, diagonally, antidiagonally or vertically.''. It has offset $1$ and begins
\[
21, 2820, 182430, 10892633, 669872090, 41382940317, 2552520578945, 157398925950921,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 03 2026 08:17:31, revision 14) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A202793.
