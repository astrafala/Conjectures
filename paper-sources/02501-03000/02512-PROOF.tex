...
\title{A further conjecture on OEIS A235888,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A235888 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $352, 568, 1096, 2536, 6952, 21928, 76456, 283816,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = 4*(42 + 21*2\^{}n + 4\^{}n).\end{quote}
