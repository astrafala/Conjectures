...
\title{A further conjecture on OEIS A202051,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A202051 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $1926, 7848, 25650, 71964, 180054, 411696, 874998, 1750140,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (1/10080)*n\^{}9 + (3/560)*n\^{}8 + (211/1680)*n\^{}7 + (67/40)*n\^{}6 + (6709/480)*n\^{}5 + (6041/80)*n\^{}4 + (663941/2520)*n\^{}3 + (79913/140)*n\^{}2 + (4735/7)*n + 324.\end{quote}
