...
\title{A further conjecture on OEIS A219287,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A219287 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $4, 9, 42, 149, 423, 1092, 2623, 5937,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (1/2240)*n\^{}8 - (1/90)*n\^{}7 + (17/96)*n\^{}6 - (373/360)*n\^{}5 - (4459/960)*n\^{}4 + (49529/360)*n\^{}3 - (348947/336)*n\^{}2 + (55477/15)*n - 5259 for n>6.\end{quote}
