...
\title{A further conjecture on OEIS A207107,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A207107 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $9, 81, 271, 643, 1271, 2239, 3641, 5581,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (5/12)*n\^{}4 + (13/2)*n\^{}3 + (115/12)*n\^{}2 - (17/2)*n + 1.\end{quote}
