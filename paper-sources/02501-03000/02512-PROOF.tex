...
\title{The empirical recurrence for OEIS A202792, proved by transfer matrix}
...
\begin{abstract}
OEIS A202792 counts arrays of width $5$ over $\{0,1\}$ in which every cell of a named value has a neighbour of that same value. The entry carries an
...
OEIS A202792 is ``Number of n X 5 binary arrays with every one adjacent to another one horizontally, diagonally, antidiagonally or vertically.''. It has offset $1$ and begins
\[
12, 724, 23436, 702846, 21649928, 669872090, 20696263392, 639259508770,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 20 2026 21:05:35, revision 11) this is still
...
\begin{theorem}
\[
a(n)\;=\;29\,a(n-1) - 5\,a(n-2) + 1820\,a(n-3) + 3756\,a(n-4) + 14798\,a(n-5) + 39177\,a(n-6) - 33008\,a(n-7) - 120144\,a(n-8) - 276809\,a(n-9) - 534984\,a(n-10) + 521787\,a(n-11) + 1495342\,a(n-12) + 136066\,a(n-13) - 826372\,a(n-14) - 258636\,a(n-15) - 55508\,a(n-16) - 65340\,a(n-17) + 26654\,a(n-18) + 9760\,a(n-19) + 1452\,a(n-20) + 3060\,a(n-21)
\]
for every $n>20$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A202792.
