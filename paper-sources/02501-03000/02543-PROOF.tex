...
\title{A further conjecture on OEIS A219768,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A219768 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $3, 6, 14, 29, 56, 101, 171, 274,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (1/24)*n\^{}4 + (1/4)*n\^{}3 - (25/24)*n\^{}2 + (23/4)*n - 4 for n>1.\end{quote}
