...
\title{A further conjecture on OEIS A267036,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A267036 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $1, 3, 16, 63, 256, 1023, 4096, 16383,\dots$, with offset $0$. The sequence satisfies
\[
  a(n)=4\,a(n-1) + 1\,a(n-2) - 4\,a(n-3) ,
\]
...
\begin{quote}\raggedright a(n) = ((-1)\^{}n-1)/2+4\^{}n.\end{quote}
