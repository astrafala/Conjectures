...
\title{The empirical closed form for OEIS A223719, proved}
...
\begin{abstract}
OEIS A223719 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A223719 is ``Number of n X 2 0..2 arrays with rows, antidiagonals and columns unimodal.''. It has offset $1$ and begins
\[
9, 81, 484, 2116, 7396, 21904, 57121, 134689,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (1/576)*n\^{}8 + (1/48)*n\^{}7 + (41/288)*n\^{}6 + (13/24)*n\^{}5 + (793/576)*n\^{}4 + (31/16)*n\^{}3 + (119/48)*n\^{}2 + (3/2)*n + 1.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 19 2018 09:27:52, revision 7) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{n^{8}}{576} + \frac{n^{7}}{48} + \frac{41 n^{6}}{288} + \frac{13 n^{5}}{24} + \frac{793 n^{4}}{576} + \frac{31 n^{3}}{16} + \frac{119 n^{2}}{48} + \frac{3 n}{2} + 1.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223719.
