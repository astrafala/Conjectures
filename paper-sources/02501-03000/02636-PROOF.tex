...
\title{A further conjecture on OEIS A253154,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A253154 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $69, 88, 94, 129, 201, 345, 633, 1209,\dots$, with offset $1$. The sequence satisfies
\[
  a(n)=3\,a(n-1) - 2\,a(n-2) ,
\]
...
\begin{quote}\raggedright Empirical: a(n) = 9*2\^{}(n-1) + 57 for n>3.\end{quote}
