...
\title{A further conjecture on OEIS A270145,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A270145 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $8, 1440, 85056, 4126368, 182257536, 7623445344, 307704553920, 12111206870304,\dots$, with offset $1$. The sequence satisfies
\[
  a(n)=66\,a(n-1) - 1021\,a(n-2) - 2244\,a(n-3) - 1156\,a(n-4) ,
\]
a linear recurrence of order $4$ with characteristic polynomial
\[
  q(x)=x^{4} - 66 x^{3} + 1021 x^{2} + 2244 x + 1156 .
\]
...
\begin{quote}\raggedright a(n) = (48*(-383214*(-1)\^{}n - 2660911*34\^{}n + 35*(363562*(-1)\^{}n + 115797*34\^{}n)*n)) / 210644875 for n>1.\end{quote}
...
\[
  p(x)=x^{4} - 66 x^{3} + 1021 x^{2} + 2244 x + 1156 ,
\]
