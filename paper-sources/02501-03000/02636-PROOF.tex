...
\title{A further conjecture on OEIS A269497,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A269497 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $40, 591, 3680, 14695, 44904, 114695, 257536, 524655,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = n\^{}6 + 6*n\^{}5 + 15*n\^{}4 + 8*n\^{}3 + 5*n\^{}2 + 6*n - 1.\end{quote}
