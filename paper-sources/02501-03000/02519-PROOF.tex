...
\title{A further conjecture on OEIS A219465,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A219465 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $4, 23, 82, 239, 619, 1471, 3259, 6800,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (1/20160)*n\^{}8 + (1/1260)*n\^{}7 + (1/480)*n\^{}6 + (4/45)*n\^{}5 - (11/960)*n\^{}4 + (277/180)*n\^{}3 + (7607/5040)*n\^{}2 + (61/70)*n.\end{quote}
