...
\title{A further conjecture on OEIS A266660,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A266660 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $1, 110, 11, 1111100, 11, 11111111100, 11, 111111111111100,\dots$, with offset $0$. The sequence satisfies
\[
  a(n)=10001\,a(n-2) - 10000\,a(n-4) ,
\]
a linear recurrence of order $4$ with characteristic polynomial
\[
  q(x)=x^{4} - 10001 x^{2} + 10000 .
\]
...
\begin{quote}\raggedright a(n) = (199*(-1)\^{}n+10\^{}(2*n+1)-(-1)\^{}n*10\^{}(2*n+1)-1)/18 for n>1.\end{quote}
...
indices, and $a$ and $f$ were checked to agree at $n=6,\dots,9$,
