...
\title{A further conjecture on OEIS A220147,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A220147 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $3, 11, 26, 52, 95, 163, 266, 416,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (1/12)*n\^{}4 - (1/6)*n\^{}3 + (29/12)*n\^{}2 + (2/3)*n.\end{quote}
