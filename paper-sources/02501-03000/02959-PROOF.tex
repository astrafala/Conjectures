...
\title{The empirical column recurrences for the table OEIS A264520}
...
\begin{abstract}
OEIS A264520 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A264520 is ``T(n,k)=Number of (n+1)X(k+1) arrays of permutations of 0..(n+1)*(k+1)-1 with each element having directed index change -1,0 0,2 -1,-2 or 1,0.''. It has offset $1$, is
read by antidiagonals, and begins
\[
1, 1, 0, 1, 0, 1, 2, 1,\ \dots
\]
...
k=5: [order 90]\\
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 16 2015 17:14:47, revision 4) these are still
...
The sequence is ``Number of (n+1)X(2) arrays of permutations of 0..(n+1)*(2)-1 with each element having directed index change -1,0 0,2 -1,-2 or 1,0.''. Its rows are the vertices of a digraph on
...
\subsection*{Row $n$$=1$}
The sequence is ``Number of (2)X(n+1) arrays of permutations of 0..(2)*(n+1)-1 with each element having directed index change -1,0 0,2 -1,-2 or 1,0.''. Its rows are the vertices of a digraph on
...
The entry gives only the order for this line: ``k=3: [order 19]''. Its model is a walk on
...
$c_{1}$ & $3$ & $c_{6}$ & $8$ & $c_{11}$ & $36$ & $c_{16}$ & $17$ \\
$c_{2}$ & $7$ & $c_{7}$ & $-24$ & $c_{12}$ & $24$ & $c_{17}$ & $-7$ \\
$c_{3}$ & $-17$ & $c_{8}$ & $-36$ & $c_{13}$ & $-8$ & $c_{18}$ & $-3$ \\
$c_{4}$ & $-5$ & $c_{9}$ & $0$ & $c_{14}$ & $-60$ & $c_{19}$ & $1$ \\
$c_{5}$ & $60$ & $c_{10}$ & $0$ & $c_{15}$ & $5$ &  &  \\
...
\[
(c_1,\dots,c_{84})=(4,\ 46,\ -162,\ -769,\ 3246,\ 6983,\ -36718,\ -40546,\ 249934,\ 192846,\ -1093946,\ -1002475,\ 3144158,\ 5642561,\ -4361588,\ -29708092,\ -12089012,\ 131640593,\ 103599474,\ -453210430,\ -383548266,\ 1182301310,\ 980431632,\ -2383944670,\ -1920813272,\ 3804117496,\ 3053179766,\ -4814349472,\ -4130018726,\ 4624993035,\ 4950624320,\ -2737843569,\ -5418119852,\ -692722037,\ 5463063972,\ 4897162294,\ -4895850428,\ -8827860683,\ 3480567568,\ 11553685878,\ -1268853264,\ -12517761315,\ -1268853264,\ 11553685878,\ 3480567568,\ -8827860683,\ -4895850428,\ 4897162294,\ 5463063972,\ -692722037,\ -5418119852,\ -2737843569,\ 4950624320,\ 4624993035,\ -4130018726,\ -4814349472,\ 3053179766,\ 3804117496,\ -1920813272,\ -2383944670,\ 980431632,\ 1182301310,\ -383548266,\ -453210430,\ 103599474,\ 131640593,\ -12089012,\ -29708092,\ -4361588,\ 5642561,\ 3144158,\ -1002475,\ -1093946,\ 192846,\ 249934,\ -40546,\ -36718,\ 6983,\ 3246,\ -769,\ -162,\ 46,\ 4,\ -1).
\]
...
model reproduces $21$ published values, $25$ decimal digits in all, every one of
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264520.
