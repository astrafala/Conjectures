...
\title{The empirical recurrence for OEIS A210138, proved by transfer matrix}
...
\begin{abstract}
OEIS A210138 counts arrays of width $4$ whose every $2\times2$ subblock holds a
...
OEIS A210138 is ``Number of (n+1)X4 0..3 arrays containing all values 0..3 with every 2X2 subblock having one, two or four distinct values, and new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
105, 4349, 159327, 5451164, 178904077, 5714971168, 179321691502, 5559548788474,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 15:45:44, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;89\,a(n-1) - 3068\,a(n-2) + 51966\,a(n-3) - 443001\,a(n-4) + 1546826\,a(n-5) + 1718332\,a(n-6) - 24576952\,a(n-7) + 30663994\,a(n-8) + 107350909\,a(n-9) - 226371596\,a(n-10) - 140409398\,a(n-11) + 501187032\,a(n-12) - 47667796\,a(n-13) - 343494224\,a(n-14) + 74492360\,a(n-15) + 92532416\,a(n-16) - 19372128\,a(n-17) - 8588160\,a(n-18) + 1382400\,a(n-19)
\]
for every $n>18$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A210138.
