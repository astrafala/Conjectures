...
\title{The empirical closed form for OEIS A207258, proved}
...
\begin{abstract}
OEIS A207258 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A207258 is ``Number of 7 X n 0..1 arrays avoiding 0 0 1 and 1 0 1 horizontally and 0 1 0 and 1 0 1 vertically.''. It has offset $1$ and begins
\[
42, 1764, 14406, 64176, 206514, 541380, 1231650, 2524704,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (1/60)*n\^{}7 + (77/20)*n\^{}6 + (2527/60)*n\^{}5 + (119/4)*n\^{}4 - (644/15)*n\^{}3 + (42/5)*n\^{}2 + (4/5)*n.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 21 2018 15:00:06, revision 9) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{n^{7}}{60} + \frac{77 n^{6}}{20} + \frac{2527 n^{5}}{60} + \frac{119 n^{4}}{4} - \frac{644 n^{3}}{15} + \frac{42 n^{2}}{5} + \frac{4 n}{5}.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207258.
