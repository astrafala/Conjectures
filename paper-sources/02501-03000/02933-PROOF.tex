...
\title{The empirical recurrence for OEIS A268769, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A268769 counts arrays over $\{0,\dots,2\}$ subject to a condition on the array as a
...
OEIS A268769 is ``Number of n X 3 0..2 arrays with some element plus some horizontally, vertically, diagonally or antidiagonally adjacent neighbor totalling two exactly once.''. It has offset $1$ and begins
\[
12, 32, 112, 446, 1524, 5214, 17000, 54822,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 4*a(n-1) + 2*a(n-2) - 16*a(n-3) - a(n-4) + 12*a(n-5) - 4*a(n-6) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 15 2019 07:54:09, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268769.
