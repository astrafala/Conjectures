...
\title{The empirical column recurrences for the table OEIS A251113}
...
\begin{abstract}
OEIS A251113 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A251113 is ``T(n,k)=Number of (n+1)X(k+1) 0..2 arrays with no 2X2 subblock having the maximum of its diagonal elements greater than the absolute difference of its antidiagonal elements.''. It has offset $1$, is
read by antidiagonals, and begins
\[
37, 147, 147, 526, 810, 526, 1844, 3616,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:05:12, revision 6) these are still
...
The sequence is ``Number of (n+1)X(2) 0..2 arrays with no 2X2 subblock having the maximum of its diagonal elements greater than the absolute difference of its antidiagonal elements.''. Its rows are the vertices of a digraph on
...
$c_{1}$ & $11$ & $c_{5}$ & $717$ & $c_{9}$ & $543$ & $c_{13}$ & $9$ \\
$c_{2}$ & $-53$ & $c_{6}$ & $-999$ & $c_{10}$ & $-268$ & $c_{14}$ & $-1$ \\
$c_{3}$ & $169$ & $c_{7}$ & $1063$ & $c_{11}$ & $115$ &  &  \\
$c_{4}$ & $-400$ & $c_{8}$ & $-860$ & $c_{12}$ & $-40$ &  &  \\
...
model reproduces $10$ published values, $46$ decimal digits in all, every one of
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251113.
