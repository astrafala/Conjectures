...
\title{A further conjecture on OEIS A239031,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A239031 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $4, 11, 28, 59, 110, 189, 306, 473,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (1/12)*n\^{}4 - (1/6)*n\^{}3 + (47/12)*n\^{}2 - (29/6)*n + 5.\end{quote}
