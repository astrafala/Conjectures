...
\title{A further conjecture on OEIS A266794,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A266794 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $0, 1, 3, 2, 5, 4, 8, 4,\dots$, with offset $0$. The sequence satisfies
\[
  a(n)=2\,a(n-2) - 1\,a(n-4) ,
\]
...
\begin{quote}\raggedright a(n) = n+(-1)\^{}n*(n-4) for n>4.\end{quote}
...
indices, and $a$ and $f$ were checked to agree at $n=9,\dots,12$,
