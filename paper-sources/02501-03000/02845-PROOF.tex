...
\title{The empirical recurrence for OEIS A235674, proved by transfer matrix}
...
\begin{abstract}
OEIS A235674 counts arrays of width $4$ over $\{0,1\}$ by reducing every $2\times2$ subblock to a
...
OEIS A235674 is ``Number of (n+1)X(3+1) 0..1 arrays with the difference between each 2X2 subblock maximum and minimum lexicographically nondecreasing columnwise and nonincreasing rowwise.''. It has offset $1$ and begins
\[
208, 2456, 28584, 330840, 3824528, 44196144, 510685176, 5900818062,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 08:43:48, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;13\,a(n-1) - 7\,a(n-2) - 120\,a(n-3) + 60\,a(n-4) + 376\,a(n-5) - 111\,a(n-6) - 477\,a(n-7) + 47\,a(n-8) + 216\,a(n-9) + 20\,a(n-10) - 16\,a(n-11)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A235674.
