...
\title{A further conjecture on OEIS A251131,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A251131 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $133, 416, 1002, 2264, 4786, 9786, 19548, 38674,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = (-873 + 49*(-1)\^{}n + 841*2\^{}(1+n) - 614*n - 11*n\^{}2 + 38*n\^{}3 + 5*n\^{}4) / 12 for n>2.\end{quote}
