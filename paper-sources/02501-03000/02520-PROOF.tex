...
\title{A further conjecture on OEIS A208377,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A208377 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $26, 676, 2080, 4212, 7072, 10660, 14976, 20020,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = 364*n\^{}2 - 416*n + 52 for n>1.\end{quote}
