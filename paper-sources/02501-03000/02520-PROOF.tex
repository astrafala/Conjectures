...
\title{A further conjecture on OEIS A219472,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A219472 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $10, 23, 68, 211, 547, 1248, 2663, 5432,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (1/13440)*n\^{}8 + (1/10080)*n\^{}7 + (1/576)*n\^{}6 + (119/720)*n\^{}5 - (9659/5760)*n\^{}4 + (18247/1440)*n\^{}3 - (50047/2016)*n\^{}2 + (6437/840)*n + 13 for n>3.\end{quote}
