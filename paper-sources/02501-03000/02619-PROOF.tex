...
\title{A further conjecture on OEIS A268905,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A268905 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $0, 36, 168, 696, 2664, 9720, 34344, 118584,\dots$, with offset $1$. The sequence satisfies
\[
  a(n)=6\,a(n-1) - 9\,a(n-2) ,
\]
...
\begin{quote}\raggedright a(n) = 8*3\^{}(n-3) * (8*n-3) for n>2.\end{quote}
