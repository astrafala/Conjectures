...
\title{A further conjecture on OEIS A283349,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A283349 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $1, 0, 3, 1, 14, 6, 62, 30,\dots$, with offset $0$. The sequence satisfies
\[
  a(n)=1\,a(n-1) + 4\,a(n-2) - 4\,a(n-3) ,
\]
...
\begin{quote}\raggedright a(n) = (-16 + 3*(-2)\^{}n + 5*2\^{}n) / 8 for n>3.\end{quote}
