...
\title{A further conjecture on OEIS A279053,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A279053 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $1, 1, 101, 101, 10101, 10101, 1010101, 1010101,\dots$, with offset $0$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = (9*(-2)\^{}n*5\^{}(n+1) + 11*2\^{}n*5\^{}(n+1) - 1)/99.\end{quote}
