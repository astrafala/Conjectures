...
\title{The empirical recurrence for OEIS A233101, proved by carrying a row major clause across
columns}
...
\begin{abstract}
OEIS A233101 counts $4\times n$ arrays over $\{0,\dots,3\}$ with a forbidden-pair
condition and a clause on the order in which values first appear, read in ROW MAJOR order, and
it carries an empirical recurrence of order $11$ contributed by R.~H.~Hardin. It is true.
...
OEIS A233101 is ``Number of 4Xn 0..3 arrays with no element x(i,j) adjacent to value 3-x(i,j) horizontally, diagonally or antidiagonally, top left element zero, and 1 appearing before 2 in row major order.''. It has offset $1$ and begins
\[
36, 515, 13721, 342626, 8714705, 221113913,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 07:52:46, revision 6) this is still
...
row, and there are $S=163$ of them after states with identical futures are merged. Hence
\[
...
\begin{theorem}
\[
a(n)\;=\;25\,a(n-1) + 52\,a(n-2) - 1084\,a(n-3) + 16\,a(n-4) + 9754\,a(n-5) - 16165\,a(n-6) + 5229\,a(n-7) + 5498\,a(n-8) - 3740\,a(n-9) + 320\,a(n-10) + 96\,a(n-11)
\]
for every $n>12$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A233101.
