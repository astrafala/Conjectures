...
\title{The empirical recurrence for OEIS A268001, proved by transfer matrix}
...
\begin{abstract}
OEIS A268001 counts arrays in which the REPEATED VALUES of each row, and of each column, stand in a
...
OEIS A268001 is ``Number of nX3 0..3 arrays with every repeated value in every row and column equal to the previous repeated value, and new values introduced in row-major sequential order.''. It has offset $1$ and begins
\[
5, 187, 11051, 605969, 30785259, 1470330667, 67008101445, 2944599816411,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 24 2016 09:13:01, revision 5) this is still
...
\begin{theorem}
\[
a(n)\;=\;124\,a(n-1) - 5667\,a(n-2) + 109756\,a(n-3) - 600624\,a(n-4) - 4644332\,a(n-5) + 20286127\,a(n-6) + 74454300\,a(n-7) - 192750803\,a(n-8) - 474040024\,a(n-9) + 743672544\,a(n-10) + 1126555256\,a(n-11) - 1288430571\,a(n-12) - 889741996\,a(n-13) + 948105695\,a(n-14) + 142093020\,a(n-15) - 241931952\,a(n-16) + 27042228\,a(n-17) + 11714301\,a(n-18) - 1828332\,a(n-19) - 59049\,a(n-20)
\]
for every $n>20$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268001.
