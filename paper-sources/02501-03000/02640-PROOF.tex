...
\title{The empirical recurrence for OEIS A189306, proved by transfer matrix}
...
\begin{abstract}
OEIS A189306 counts the permutations of the cells of an $n\times3$ array in which every cell
...
That makes $a$ a walk count on $S=35$ states, hence $C$-finite, and whether the published
...
OEIS A189306 is ``Number of nX3 array permutations with each element moving zero or one space diagonally, horizontally or vertically.''. It has offset $1$ and begins
\[
3, 73, 960, 14714, 216708, 3224934, 47862876, 710856569,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 05:09:12, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;10\,a(n-1) + 78\,a(n-2) - 48\,a(n-3) - 627\,a(n-4) + 196\,a(n-5) + 1735\,a(n-6) - 1148\,a(n-7) - 879\,a(n-8) + 788\,a(n-9) + 131\,a(n-10) - 144\,a(n-11) - 22\,a(n-12) + 6\,a(n-13) + a(n-14)
\]
for every $n>13$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A189306.
