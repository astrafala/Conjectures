...
\title{A further conjecture on OEIS A253439,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A253439 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $181, 180, 193, 228, 300, 444, 732, 1308,\dots$, with offset $1$. The sequence satisfies
\[
  a(n)=3\,a(n-1) - 2\,a(n-2) ,
\]
...
\begin{quote}\raggedright Empirical: a(n) = 9*2\^{}(n-1) + 156 for n>3.\end{quote}
