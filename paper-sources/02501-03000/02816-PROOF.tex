...
\title{A further conjecture on OEIS A290681,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A290681 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $1, 1, 111, 111, 11111, 111111, 1111111, 11111111,\dots$, with offset $0$. The sequence satisfies
\[
