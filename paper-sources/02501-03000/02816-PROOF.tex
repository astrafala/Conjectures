...
\title{The empirical recurrence for OEIS A230972, proved by transfer matrix}
...
\begin{abstract}
OEIS A230972 counts arrays of width $5$ over $\{0,1,2,3\}$ in which every cell must see, among its
...
the count is a walk count on $S=48145$ states.
\end{abstract}
...
OEIS A230972 is ``Number of (n+2)X(3+2) 0..3 arrays x(i,j) with each element diagonally or antidiagonally next to at least one element with value (x(i,j)+1) mod 4, no adjacent elements equal, and upper left element zero.''. It has offset $1$ and begins
\[
64, 1024, 13872, 215296, 3512016, 56791296, 916182800, 14798235904,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 06:09:00, revision 6) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=48145.
\]
...
\begin{theorem}
\[
a(n)\;=\;16\,a(n-1) + 38\,a(n-3) + 169\,a(n-4) - 2222\,a(n-5) - 6268\,a(n-6) + 96224\,a(n-7) + 78948\,a(n-8) - 1087800\,a(n-9) - 22464\,a(n-10) + 94592\,a(n-11) - 1544192\,a(n-12) - 77824\,a(n-13) - 1000192\,a(n-14) + 2238464\,a(n-15) - 2001664\,a(n-16) + 2165248\,a(n-17) + 1662976\,a(n-18) - 2408448\,a(n-19) + 1826816\,a(n-20) + 114688\,a(n-21) - 786432\,a(n-22) + 1572864\,a(n-24) - 1048576\,a(n-25)
\]
for every $n>22$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A230972.
