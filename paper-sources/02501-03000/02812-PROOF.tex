...
\title{A further conjecture on OEIS A283523,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A283523 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $1, 0, 5, 14, 31, 63, 127, 255,\dots$, with offset $0$. The sequence satisfies
\[
  a(n)=3\,a(n-1) - 2\,a(n-2) ,
\]
