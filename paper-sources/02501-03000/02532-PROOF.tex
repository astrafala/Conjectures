...
\title{A further conjecture on OEIS A265722,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A265722 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $1, 0, 1, 4, 1, 8, 1, 12,\dots$, with offset $0$. The sequence satisfies
\[
  a(n)=2\,a(n-2) - 1\,a(n-4) ,
\]
...
\begin{quote}\raggedright a(n) = 1/2*(-2*(-1)\^{}n*n+2*n+3*(-1)\^{}n-1).\end{quote}
