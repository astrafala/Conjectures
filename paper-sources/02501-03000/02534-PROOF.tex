...
\title{A further conjecture on OEIS A219621,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A219621 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $3, 11, 27, 56, 105, 183, 301, 472,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (1/12)*n\^{}4 + (23/12)*n\^{}2 + n.\end{quote}
