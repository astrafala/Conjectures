...
\title{A further conjecture on OEIS A265724,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A265724 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $0, 3, 7, 10, 18, 21, 33, 36,\dots$, with offset $0$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = 1/2*(n\^{}2+(-1)\^{}n*n+4*n-(-1)\^{}n+1).\end{quote}
