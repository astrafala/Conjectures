...
\title{A further conjecture on OEIS A253489,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A253489 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $414, 1377, 2640, 4720, 9654, 22236, 55362, 145428,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = 49*3\^{}(n-1) + 291*2\^{}(n-1) + 1017 for n>5.\end{quote}
...
indices, and $a$ and $f$ were checked to agree at $n=9,\dots,11$,
