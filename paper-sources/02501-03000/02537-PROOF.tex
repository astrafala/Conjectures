...
\title{The empirical recurrence for OEIS A232252, proved by transfer matrix}
...
\begin{abstract}
OEIS A232252 counts arrays of width $4$ over $\{0,1,2\}$ in which every cell has a neighbour at least as large and one at most as large. The entry carries an
...
OEIS A232252 is ``Number of (n+1)X(3+1) 0..2 arrays with every element both >= and <= some horizontal or antidiagonal neighbor.''. It has offset $1$ and begins
\[
215, 6189, 175431, 4987471, 141815403, 4032714105, 114676900023, 3261035421093,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 06:57:38, revision 6) this is still
...
Thus
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=4213,
\]
...
\begin{theorem}
\[
a(n)\;=\;27\,a(n-1) + 67\,a(n-2) - 667\,a(n-3) - 2143\,a(n-4) - 874\,a(n-5) - 67\,a(n-6) + 187\,a(n-7) + 95\,a(n-8) + 16\,a(n-9)
\]
for every $n>10$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232252.
