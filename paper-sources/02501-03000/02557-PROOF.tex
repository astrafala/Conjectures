...
\title{The empirical recurrence for OEIS A269148, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A269148 counts arrays over $\{0,\dots,3\}$ subject to a condition on the array as a
...
OEIS A269148 is ``Number of nX4 0..3 arrays with some element plus some horizontally, antidiagonally or vertically adjacent neighbor totalling three exactly once.''. It has offset $1$ and begins
\[
108, 6224, 220968, 7002040, 208984848, 6004186984, 167970539096, 4607603633440,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 20 2016 07:16:41, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;58\,a(n-1) - 1093\,a(n-2) + 7680\,a(n-3) - 27078\,a(n-4) + 58958\,a(n-5) - 88914\,a(n-6) + 82212\,a(n-7) - 35159\,a(n-8) - 20796\,a(n-9) + 39556\,a(n-10) - 11364\,a(n-11) - 13593\,a(n-12) + 9618\,a(n-13) + 429\,a(n-14) - 2060\,a(n-15) + 434\,a(n-16) + 166\,a(n-17) - 92\,a(n-18) + 16\,a(n-19) - a(n-20)
\end{equation}
for all $n>22$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269148.
