...
\title{A further conjecture on OEIS A266440,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A266440 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $0, 0, 5, 5, 14, 14, 27, 27,\dots$, with offset $0$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = (n\^{}2+((-1)\^{}n+2)*n+(-1)\^{}n-1)/2.\end{quote}
