...
\title{A further conjecture on OEIS A219940,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A219940 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $10, 23, 64, 196, 459, 918, 1660, 2802,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (1/15)*n\^{}5 - (3/4)*n\^{}4 + (32/3)*n\^{}3 - (135/4)*n\^{}2 + (1583/30)*n - 34 for n>2.\end{quote}
