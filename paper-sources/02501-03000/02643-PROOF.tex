...
\title{A further conjecture on OEIS A285473,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A285473 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $1, 11, 1, 1111, 1, 111111, 1, 11111111,\dots$, with offset $0$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = (4 + 5*(-1)\^{}n - (-2)\^{}n*5\^{}(1+n) + 2\^{}n*5\^{}(1+n))/9.\end{quote}
