...
\title{A further conjecture on OEIS A253451,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A253451 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $1388, 4782, 7782, 11147, 19254, 39463, 89556, 218326,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = 529*3\^{}(n-3) + 673*2\^{}(n-1) + 3635 for n>6.\end{quote}
