...
\title{The empirical recurrence for OEIS A209740, proved by counting patterns}
...
\begin{abstract}
OEIS A209740 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
state space down from $2275$ to $S=68$. The entry's empirical recurrence of order
...
OEIS A209740 is ``Number of nX4 0..5 arrays with every 2X2 subblock containing exactly one value repeat, and new values 0..5 introduced in row major order.''. It has offset $1$ and begins
\[
15, 700, 103373, 20611956, 4474325828, 991613495404, 220845828478730, 49242046909442868,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 15:27:50, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;244\,a(n-1) + 137\,a(n-2) - 1195614\,a(n-3) + 21837944\,a(n-4) + 1404675270\,a(n-5) - 36835307408\,a(n-6) - 326873376252\,a(n-7) + 14507648154376\,a(n-8) - 8311682181464\,a(n-9) - 2334523810998832\,a(n-10) + 8762975100490480\,a(n-11) + 185277092995650336\,a(n-12) - 908553103605691712\,a(n-13) - 8222060623354335360\,a(n-14) + 40603092591766507264\,a(n-15) + 222543140644632005632\,a(n-16) - 906919532901077344256\,a(n-17) - 3774725396673218404352\,a(n-18) + 10011737555551519784960\,a(n-19) + 37478635910651820179456\,a(n-20) - 48928099712667888910336\,a(n-21) - 182050232765906369380352\,a(n-22) + 115193182556326721486848\,a(n-23) + 411251029796589926350848\,a(n-24) - 170990851031162490454016\,a(n-25) - 418387866292483163947008\,a(n-26) + 167007575033595637530624\,a(n-27) + 154943201526404521918464\,a(n-28) - 70873530141897822044160\,a(n-29)
\end{equation}
for all $n>30$.
...
Assembling the $6$ lumped chains into one block-diagonal matrix $N$ of size $S=68$ and
...
\end{equation}
The unlumped alphabet had $2275$ rows in all; the lumped chain has $S=68$ states.
...
For every $n$ with $m=n+0-1\ge29$,
\[
6!\Bigl(a(n)-\sum_i c_i\,a(n-i)\Bigr)\;=\;\mathbf{v}^{\!\top}N^{\,m-29}q(N)\mathbf{1} .
\]
...
corresponding to $n=30+1$ onwards, and the run continued until $w$ was the zero vector,
...
\eqref{eq:walk}, divided by $6!$, was evaluated at every one of the $12$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209740.
