...
\title{The empirical column recurrences for the table OEIS A233644}
...
\begin{abstract}
OEIS A233644 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A233644 is ``T(n,k)=Number of (n+1)X(k+1) 0..2 arrays with every 2X2 subblock having the sum of the squares of the edge differences equal to 2 (2 maximizes T(1,1)).''. It has offset $1$, is
read by antidiagonals, and begins
\[
24, 90, 90, 324, 534, 324, 1188, 3004,\ \dots
\]
...
k=5: [order 66]\\
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 08:54:53, revision 6) these are still
...
The sequence is ``Number of (n+1)X2 0..2 arrays with every 2X2 subblock having the sum of the squares of the edge differences equal to 2.''. Its rows are the vertices of a digraph on
...
The sequence is ``Number of (n+1)X3 0..2 arrays with every 2X2 subblock having the sum of the squares of the edge differences equal to 2.''. Its rows are the vertices of a digraph on
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A233644.
