...
\title{A further conjecture on OEIS A219499,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A219499 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $5, 9, 26, 58, 107, 179, 281, 421,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (1/24)*n\^{}4 + (1/4)*n\^{}3 + (35/24)*n\^{}2 + (21/4)*n - 13 for n>2.\end{quote}
