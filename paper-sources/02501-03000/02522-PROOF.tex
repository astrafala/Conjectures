...
\title{A further conjecture on OEIS A251133,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A251133 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $919, 2264, 4110, 8008, 14753, 27738, 51679, 97758,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = (3063 + 961*(-1)\^{}n + 121*2\^{}(5+n) + 1726*n + 691*n\^{}2 + 146*n\^{}3 + 11*n\^{}4) / 12 for n>3.\end{quote}
