...
\title{A further conjecture on OEIS A267051,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A267051 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $1, 11, 111, 1011, 10111, 101011, 1010111, 10101011,\dots$, with offset $0$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = (539+450*(-1)\^{}n+10\^{}(2+n))/99 for n>0.\end{quote}
