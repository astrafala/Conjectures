...
\title{A further conjecture on OEIS A250606,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A250606 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $57, 140, 297, 592, 1153, 2236, 4353, 8528,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = 64*2\^{}(n-1) + 5*n\^{}2 + 4*n -16.\end{quote}
