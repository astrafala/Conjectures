...
\title{The empirical recurrence for OEIS A208268, proved by counting patterns}
...
\begin{abstract}
OEIS A208268 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A208268 is ``Number of nX7 0..1 arrays with new values 0..1 introduced in row major order and no element equal to more than two of its immediate leftward or upward or left-upward diagonal neighbors.''. It has offset $1$ and begins
\[
64, 4021, 273205, 18403423, 1240971177, 83670667271, 5641457245533, 380372051615157,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:44:13, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;77\,a(n-1) - 429\,a(n-2) - 16791\,a(n-3) + 132938\,a(n-4) + 1140609\,a(n-5) - 11250708\,a(n-6) - 21101443\,a(n-7) + 356560316\,a(n-8) - 276630106\,a(n-9) - 3595865197\,a(n-10) + 5253257444\,a(n-11) + 16399879057\,a(n-12) - 30419637636\,a(n-13) - 37486637674\,a(n-14) + 87632998667\,a(n-15) + 40083109062\,a(n-16) - 140235056122\,a(n-17) - 7589163210\,a(n-18) + 128111780723\,a(n-19) - 23221600421\,a(n-20) - 65939015129\,a(n-21) + 21868944788\,a(n-22) + 18307048178\,a(n-23) - 8259596531\,a(n-24) - 2431120428\,a(n-25) + 1497147381\,a(n-26) + 85285300\,a(n-27) - 123174410\,a(n-28) + 8581030\,a(n-29) + 3300116\,a(n-30) - 512304\,a(n-31) + 18304\,a(n-32)
\end{equation}
for all $n>32$.
...
entry's requirement is that no cell equals more than $2$ of its neighbours at the
offsets
\[
...
\#\bigl\{(d_1,d_2)\in\mathcal N:\ x_{t+d_1,\,u+d_2}=x_{t,u}\bigr\}\;\le\;2
...
\eqref{eq:walk}, divided by $2!$, was evaluated at every one of the $13$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208268.
