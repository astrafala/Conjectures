...
\title{The empirical recurrence for OEIS A205433, proved by transfer matrix}
...
\begin{abstract}
OEIS A205433 counts, up to renaming the letters, the arrays of width $2$ over at most $4$
letters in which all the $2\times2$ subblocks of one array have the SAME number of equal edges, an equal edge being one of the four perimeter edges whose two cells agree; the common value is not named, so the count splits by it. It carries an empirical recurrence of order $6$ contributed by
...
OEIS A205433 is ``Number of (n+1) X 2 0..3 arrays with every 2 X 2 subblock having the same number of equal edges, and new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
15, 77, 443, 2705, 16955, 108173, 698747, 4558985,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 21*a(n-1) - 156*a(n-2) + 442*a(n-3) - 81*a(n-4) - 1359*a(n-5) + 1134*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 03 2018 13:57:46, revision 11) this is still
...
$w_i$ cleared of denominators and $S=84$ states in all. The walk index $j$ and the entry's own
...
\begin{theorem}
\[
a(n)\;=\;21\,a(n-1) - 156\,a(n-2) + 442\,a(n-3) - 81\,a(n-4) - 1359\,a(n-5) + 1134\,a(n-6)
\]
for every $n>5$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A205433.
