...
\title{A further conjecture on OEIS A266725,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A266725 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $0, 1, 4, 5, 12, 13, 24, 25,\dots$, with offset $0$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = (2*n*(n+(-1)\^{}n+1)-(-1)\^{}n+1)/4.\end{quote}
