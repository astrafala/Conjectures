...
\title{A further conjecture on OEIS A223671,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A223671 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $16, 256, 1723, 6454, 18980, 49561, 119150, 267643,\dots$, with offset $1$. The sequence satisfies
\[
  a(n)=9\,a(n-1) - 36\,a(n-2) + 84\,a(n-3) - 126\,a(n-4) + 126\,a(n-5) - 84\,a(n-6) + 36\,a(n-7) - 9\,a(n-8) + 1\,a(n-9) ,
\]
a linear recurrence of order $9$ with characteristic polynomial
\[
  q(x)=x^{9} - 9 x^{8} + 36 x^{7} - 84 x^{6} + 126 x^{5} - 126 x^{4} + 84 x^{3} - 36 x^{2} + 9 x - 1 .
\]
...
with at least $9+2$ further terms after that index.

\section{The further conjecture}

Separately from the conjecture already settled, the entry records

\begin{quote}\raggedright Empirical: a(n) = (1/112)*n\^{}8 - (19/210)*n\^{}7 + (59/45)*n\^{}6 - (61/120)*n\^{}5 - (8789/144)*n\^{}4 + (99083/120)*n\^{}3 - (10598579/2520)*n\^{}2 + (1548737/140)*n - 11539 for n>6\end{quote}
...
\[
  p(x)=x^{9} - 9 x^{8} + 36 x^{7} - 84 x^{6} + 126 x^{5} - 126 x^{4} + 84 x^{3} - 36 x^{2} + 9 x - 1 ,
\]
of order $D=9$. Since $q\mid p$ and $a$ satisfies the recurrence of $q$, $a$ satisfies that of
...
indices, and $a$ and $f$ were checked to agree at $n=16,\dots,24$,
