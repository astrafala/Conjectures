...
\title{The empirical recurrence for OEIS A223360, proved by transfer matrix}
...
\begin{abstract}
OEIS A223360 counts the ways of writing the vertices of a fixed graph $G$ into an array of width
...
single slice is a state and the count is a walk count on a finite digraph with $S=7777$ vertices.
\end{abstract}
...
OEIS A223360 is ``Rolling cube footprints: number of 5Xn 0..5 arrays starting with 0 where 0..5 label faces of a cube and every array movement to a horizontal or antidiagonal neighbor moves across a corresponding cube edge.''. It has offset $1$ and begins
\[
1296, 262144, 84934656, 27518828544, 9273505480704, 3147420753985536, 1073434373061083136, 366633735578651197440,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 21:33:47, revision 8) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=7777.
\]
...
\begin{theorem}
\[
a(n)\;=\;512\,a(n-1) - 65536\,a(n-2) + 2490368\,a(n-3) + 17825792\,a(n-4) - 2818572288\,a(n-5) + 51539607552\,a(n-6) - 274877906944\,a(n-7)
\]
for every $n>11$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223360.
