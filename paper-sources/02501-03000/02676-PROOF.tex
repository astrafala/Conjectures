...
\title{The empirical recurrence for OEIS A241278, proved by transfer matrix}
...
\begin{abstract}
OEIS A241278 counts arrays over $\{0,1,2,3\}$ in which no entry may equal, modulo $4$, a given
...
count is then a walk count on $S=54$ states.
\end{abstract}
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 10:03:09, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A241278.
