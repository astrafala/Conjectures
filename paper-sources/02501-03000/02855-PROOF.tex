...
\title{The empirical recurrence for OEIS A223970, proved by transfer matrix}
...
\begin{abstract}
OEIS A223970 counts arrays over $\{0,\dots,2\}$ whose rows, columns, diagonals or
...
OEIS A223970 is ``Number of n X 3 0..2 arrays with rows and antidiagonals unimodal.''. It has offset $1$ and begins
\[
22, 484, 9515, 186004, 3628696, 70779056, 1380511272, 26926081924,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 22*a(n-1) - 43*a(n-2) - 125*a(n-3) + 283*a(n-4) - 70*a(n-5) - 111*a(n-6) + 45*a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 25 2018 16:09:59, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;22\,a(n-1) - 43\,a(n-2) - 125\,a(n-3) + 283\,a(n-4) - 70\,a(n-5) - 111\,a(n-6) + 45\,a(n-7)
\end{equation}
for all $n>7$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223970.
