...
\title{A further conjecture on OEIS A219775,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A219775 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $5, 8, 29, 100, 291, 771, 1887, 4278,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (1/10080)*n\^{}8 + (1/1680)*n\^{}7 - (1/48)*n\^{}6 + (41/120)*n\^{}5 - (571/480)*n\^{}4 - (593/240)*n\^{}3 + (19457/252)*n\^{}2 - (43041/70)*n + 1735 for n>9\end{quote}
