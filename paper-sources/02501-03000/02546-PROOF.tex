...
\title{The empirical recurrence for OEIS A206594, proved by transfer matrix}
...
\begin{abstract}
OEIS A206594 counts, up to renaming the letters, the arrays of width $2$ over at most $4$
letters in which every $2\times3$ and $3\times2$ subblock has at most $3$ equal edges, an edge of such a window being one of the six steps of its perimeter cycle and an equal edge one whose two cells agree. It carries an empirical recurrence of order $8$ contributed by
...
OEIS A206594 is ``Number of (n+1)X2 0..3 arrays with every 2X3 or 3X2 subblock having no more than three equal edges, and new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
15, 171, 2532, 38810, 597829, 9217211, 142130380, 2191712741,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 16*a(n-1) -14*a(n-2) +98*a(n-3) -312*a(n-4) +114*a(n-5) -585*a(n-6) +72*a(n-7) -324*a(n-8) for n>9
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 13:00:43, revision 9) this is still
...
$w_i$ cleared of denominators and $S=354$ states in all. The walk index $j$ and the entry's own
...
\begin{theorem}
\[
a(n)\;=\;16\,a(n-1) - 14\,a(n-2) + 98\,a(n-3) - 312\,a(n-4) + 114\,a(n-5) - 585\,a(n-6) + 72\,a(n-7) - 324\,a(n-8)
\]
for every $n>9$.
\end{theorem}
...
the integers. The bound is exact: at $n=9$ the recurrence fails on the entry's own published terms, so no larger range holds.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206594.
