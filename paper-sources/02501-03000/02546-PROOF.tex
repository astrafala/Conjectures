...
\title{A further conjecture on OEIS A266257,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A266257 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $1, 2, 4, 9, 11, 20, 22, 35,\dots$, with offset $0$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = ((n+1)\^{}2-(-1)\^{}n*(n-1))/2.\end{quote}
