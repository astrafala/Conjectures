...
\title{The empirical recurrence for OEIS A239189, proved by transfer matrix}
...
\begin{abstract}
OEIS A239189 counts arrays over $\{0,1,\dots,4\}$ in which no entry may equal, modulo $5$, a given
...
count is then a walk count on $S=125$ states.
\end{abstract}
...
OEIS A239189 is ``Number of nX3 0..4 arrays with no element equal to the sum of elements to its left or the sum of elements above it, modulo 5.''. It has offset $1$ and begins
\[
40, 1276, 43648, 1436268, 47885992, 1588084496, 52771184780, 1752250223616,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 09:24:24, revision 6) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The array has $3$ cells across one way, entries $x(i,j)\in\{0,1,\dots,4\}$, and the entry names these
...
\begin{theorem}
\[
a(n)\;=\;20\,a(n-1) + 609\,a(n-2) - 3844\,a(n-3) - 78166\,a(n-4) + 509936\,a(n-5) + 4176515\,a(n-6) - 38652038\,a(n-7) - 63188831\,a(n-8) + 1459689976\,a(n-9) - 2568978052\,a(n-10) - 22520157031\,a(n-11) + 98699770039\,a(n-12) + 28345550437\,a(n-13) - 841671958032\,a(n-14) + 926865397947\,a(n-15) + 2231140185591\,a(n-16) + 707652733371\,a(n-17) - 15915790759160\,a(n-18) - 19798980156226\,a(n-19) + 105982465124316\,a(n-20) + 43073468973888\,a(n-21) - 266109188058980\,a(n-22) - 158868787983268\,a(n-23) - 52293160322104\,a(n-24) + 1331074976293600\,a(n-25) + 864182907177600\,a(n-26) - 3590559475955792\,a(n-27) - 469514072024064\,a(n-28) + 3671096466576704\,a(n-29) - 1775507453437696\,a(n-30) + 436223558752000\,a(n-31) + 10686328656896\,a(n-32)
\]
for every $n>31$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A239189.
