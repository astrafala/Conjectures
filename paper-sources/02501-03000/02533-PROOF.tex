...
\title{A further conjecture on OEIS A219596,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A219596 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $6, 21, 84, 233, 550, 1188, 2415, 4684,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (1/181440)*n\^{}9 - (1/8064)*n\^{}8 + (11/3780)*n\^{}7 - (107/2880)*n\^{}6 + (749/1728)*n\^{}5 - (1943/1152)*n\^{}4 + (168241/90720)*n\^{}3 + (355057/10080)*n\^{}2 - (306913/2520)*n + 137 for n>3.\end{quote}
