...
\title{A further conjecture on OEIS A208545,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A208545 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $0, 0, 9, 156, 1170, 5580, 19995, 58824,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (1/14)*n\^{}7 - (1/2)*n\^{}6 + (3/2)*n\^{}5 - (5/2)*n\^{}4 + (5/2)*n\^{}3 - (3/2)*n\^{}2 + (3/7)*n.\end{quote}
