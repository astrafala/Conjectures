...
\title{A further conjecture on OEIS A207165,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A207165 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $9, 81, 261, 603, 1161, 1989, 3141, 4671,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = 9*n\^{}3 + 9*n - 9.\end{quote}
