...
\title{A further conjecture on OEIS A235881,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A235881 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $921, 1311, 2109, 3759, 7221, 14631, 30909, 67839,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = 3*(180 + 31*2\^{}(1+n) + 3\^{}n).\end{quote}
