...
\title{The empirical closed form for OEIS A188839, proved}
...
\begin{abstract}
OEIS A188839 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A188839 is ``Number of n X 5 binary arrays without the pattern 0 1 diagonally or vertically.''. It has offset $1$ and begins
\[
32, 144, 364, 728, 1288, 2108, 3264, 4845,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (1/120)*n\^{}5 + (7/24)*n\^{}4 + (89/24)*n\^{}3 + (473/24)*n\^{}2 + (1877/60)*n - 33 for n>2.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 30 2018 13:54:29, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{n^{5}}{120} + \frac{7 n^{4}}{24} + \frac{89 n^{3}}{24} + \frac{473 n^{2}}{24} + \frac{1877 n}{60} - 33.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A188839.
