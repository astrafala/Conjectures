...
\title{The empirical recurrence for OEIS A204376, proved by transfer matrix}
...
\begin{abstract}
OEIS A204376 counts $(n+2)\times5$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A204376 is ``Number of (n+2) X 5 0..1 arrays with every 3 X 3 subblock having three equal elements in a row horizontally, vertically or nw-to-se diagonally exactly three ways, and new values 0..1 introduced in row major order.''. It has offset $1$ and begins
\[
78, 54, 61, 75, 98, 139, 205, 310,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) +a(n-2) +a(n-3) -a(n-4) -a(n-5) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 07 2018 09:13:30, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204376.
