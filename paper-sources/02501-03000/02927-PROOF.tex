...
\title{The empirical recurrence for OEIS A228457, proved by transfer matrix}
...
\begin{abstract}
OEIS A228457 carries an empirical recurrence of order $13$ contributed by R. H. Hardin. It is
...
OEIS A228457 is ``Number of arrays of maxima of three adjacent elements of some length n+2 0..4 array.''. It has offset $1$ and begins
\[
5, 25, 95, 295, 821, 2227, 6254, 18394,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 01 2026 16:12:42, revision 14) this is still
...
An admissible array is then exactly a walk, and $\iota,\tau$ are the vectors recording which windows may begin and end an array, so with $M$ the adjacency matrix on $S=13$ vertices,
\[
a(n)\;=\;\iota^{\!\top}M^{\,n}\tau ,
\]
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) - 10\,a(n-2) + 10\,a(n-3) + 5\,a(n-4) - 9\,a(n-5) + 20\,a(n-6) + 8\,a(n-7) + 2\,a(n-8) + 14\,a(n-9) + 6\,a(n-10) + 2\,a(n-11) + 3\,a(n-12) + a(n-13)
\]
for every $n>0$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A228457.
