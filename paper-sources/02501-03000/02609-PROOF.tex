...
\title{The empirical recurrence for OEIS A208712, proved by transfer matrix}
...
\begin{abstract}
OEIS A208712 counts $5\times n$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A208712 is ``Number of 5Xn 0..1 arrays with new values 0..1 introduced in row major order and no element equal to more than two of its immediate leftward or upward or right-upward antidiagonal neighbors.''. It has offset $1$ and begins
\[
16, 512, 9604, 204020, 4226368, 87985748, 1830045552, 38070302740,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:59:52, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;17\,a(n-1) + 95\,a(n-2) - 269\,a(n-3) - 1372\,a(n-4) + 1500\,a(n-5) + 6585\,a(n-6) - 5267\,a(n-7) - 11175\,a(n-8) + 10357\,a(n-9) + 1757\,a(n-10) - 3001\,a(n-11) + 237\,a(n-12) + 207\,a(n-13) - 30\,a(n-14)
\]
for every $n>17$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208712.
