...
\title{A further conjecture on OEIS A253219,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A253219 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $3, 9, 19, 19, 268, 1249, 3140, 5986,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = 480*n\^{}2 - 4354*n + 10098 for n>6.\end{quote}
