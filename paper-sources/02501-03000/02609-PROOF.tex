...
\title{A further conjecture on OEIS A267802,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A267802 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $1, 3, 19, 115, 499, 2035, 8179, 32755,\dots$, with offset $0$. The sequence satisfies
\[
  a(n)=5\,a(n-1) - 4\,a(n-2) ,
\]
...
\begin{quote}\raggedright Conjecture: a(n) = 2\^{}(2*n+1) - 13 for n>1. - \_Colin Barker\_, Nov 25 2016\end{quote}
