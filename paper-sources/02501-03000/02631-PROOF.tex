...
\title{The empirical recurrence for OEIS A241365, proved by transfer matrix}
...
\begin{abstract}
OEIS A241365 counts $n\times3$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A241365 is ``Number of nX3 0..2 arrays with no element equal to fewer vertical neighbors than horizontal neighbors, with new values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
2, 28, 460, 7376, 118488, 1904096, 30598800, 491723328,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 15*a(n-1) +18*a(n-2) -8*a(n-3) -68*a(n-4) -164*a(n-5) -256*a(n-6) -176*a(n-7) +64*a(n-8)
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 11:13:36, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;15\,a(n-1) + 18\,a(n-2) - 8\,a(n-3) - 68\,a(n-4) - 164\,a(n-5) - 256\,a(n-6) - 176\,a(n-7) + 64\,a(n-8)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A241365.
