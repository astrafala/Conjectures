...
\title{The empirical recurrence for OEIS A183511, proved by transfer matrix}
...
\begin{abstract}
OEIS A183511 counts arrays of width $3$ over $\{0,1\}$ in which every cell is the sum of one of two groups of its neighbours. The entry carries an
...
OEIS A183511 is ``Number of nX3 binary arrays with each element equal to either the sum mod 2 of its horizontal and vertical neighbors or the sum mod 2 of its diagonal and antidiagonal neighbors.''. It has offset $1$ and begins
\[
3, 11, 37, 138, 427, 1444, 4903, 16506,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 01:50:22, revision 9) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A183511.
