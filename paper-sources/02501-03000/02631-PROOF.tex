...
\title{A further conjecture on OEIS A253497,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A253497 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $1388, 2640, 4196, 6476, 11937, 25715, 60586, 151946,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = 400*3\^{}(n-3) + 415*2\^{}(n-1) + 1626 for n>6.\end{quote}
