...
\title{A further conjecture on OEIS A269822,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A269822 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $0, 5, 40, 240, 1280, 6400, 30720, 143360,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = 5*4\^{}(n-2)*(n-1).\end{quote}
