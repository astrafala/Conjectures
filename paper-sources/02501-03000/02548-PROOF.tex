...
\title{A further conjecture on OEIS A266259,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A266259 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $0, 2, 5, 7, 14, 16, 27, 29,\dots$, with offset $0$. The sequence satisfies
\[
