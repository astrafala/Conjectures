...
\title{A further conjecture on OEIS A219810,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A219810 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $3, 6, 16, 33, 61, 106, 176, 281,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (1/12)*n\^{}4 - (1/2)*n\^{}3 + (41/12)*n\^{}2 - 3*n + 1 for n>1.\end{quote}
