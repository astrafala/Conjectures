...
\title{A further conjecture on OEIS A220004,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A220004 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $4, 7, 20, 58, 141, 308, 637, 1271,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (1/40320)*n\^{}8 - (1/10080)*n\^{}7 - (1/2880)*n\^{}6 + (43/720)*n\^{}5 - (2873/5760)*n\^{}4 + (3893/1440)*n\^{}3 - (1121/1120)*n\^{}2 - (10301/840)*n + 18 for n>3.\end{quote}
...
indices, and $a$ and $f$ were checked to agree at $n=13,\dots,21$,
