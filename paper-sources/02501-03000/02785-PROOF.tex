...
\title{A further conjecture on OEIS A277953,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A277953 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $1, 11, 11, 111, 1011, 10111, 101011, 1010111,\dots$, with offset $0$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = (539-450*(-1)\^{}n+10\^{}(1+n))/99. (End)\end{quote}
