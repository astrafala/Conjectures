...
\title{The empirical recurrence for OEIS A189652, proved by transfer matrix}
...
\begin{abstract}
OEIS A189652 counts the permutations of the cells of an $n\times4$ array in which every cell
...
OEIS A189652 is ``Number of 4Xn array permutations with each element moving zero or one space horizontally, diagonally or antidiagonally.''. It has offset $1$ and begins
\[
1, 121, 2161, 107080, 3774889, 157346785, 6156828073, 248034953713,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 05:23:05, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;50\,a(n-1) - 137\,a(n-2) - 14254\,a(n-3) + 150732\,a(n-4) + 6167\,a(n-5) - 5222678\,a(n-6) + 17698431\,a(n-7) + 3110934\,a(n-8) - 124198038\,a(n-9) + 434209880\,a(n-10) - 578102252\,a(n-11) - 1022163576\,a(n-12) + 2063022702\,a(n-13) + 927202798\,a(n-14) - 2166125460\,a(n-15) + 2287055972\,a(n-16) - 2253433780\,a(n-17) - 217909454\,a(n-18) + 358137966\,a(n-19) + 47291569\,a(n-20) + 143053130\,a(n-21) + 25184345\,a(n-22) - 6278728\,a(n-23) - 1184530\,a(n-24) + 75701\,a(n-25) + 13602\,a(n-26) - 675\,a(n-27)
\]
for every $n>26$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A189652.
