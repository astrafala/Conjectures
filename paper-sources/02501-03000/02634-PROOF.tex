...
\title{The empirical recurrence for OEIS A232345, proved by transfer matrix}
...
\begin{abstract}
OEIS A232345 counts arrays of width $2$ over $\{0,1,2\}$ in which every cell has a neighbour at least as large and one at most as large. The entry carries an
...
OEIS A232345 is ``Number of (n+1)X(1+1) 0..2 arrays with every element both >= and <= some horizontal, vertical, diagonal or antidiagonal neighbor.''. It has offset $1$ and begins
\[
21, 207, 1461, 10503, 77613, 575087, 4251717, 31416759,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 7*a(n-1) -2*a(n-2) +30*a(n-3) +44*a(n-4) +8*a(n-5) +16*a(n-6) -32*a(n-7) -64*a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 07:20:04, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-1) - 2\,a(n-2) + 30\,a(n-3) + 44\,a(n-4) + 8\,a(n-5) + 16\,a(n-6) - 32\,a(n-7) - 64\,a(n-8)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232345.
