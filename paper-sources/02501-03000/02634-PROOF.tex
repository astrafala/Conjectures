...
\title{A further conjecture on OEIS A270111,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A270111 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $0, 8, 112, 1176, 10976, 96040, 806736, 6588344,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = 8*7\^{}(n-2)*(n-1).\end{quote}
