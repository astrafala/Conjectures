...
\title{The empirical recurrence for OEIS A241372, proved by transfer matrix}
...
\begin{abstract}
OEIS A241372 counts $3\times n$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A241372 is ``Number of 3 X n 0..2 arrays with no element equal to fewer vertical neighbors than horizontal neighbors, with new values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
5, 47, 460, 4617, 46245, 463567, 4646421, 46573979,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 9*a(n-1) + 16*a(n-2) - 50*a(n-3) - 72*a(n-4) - 32*a(n-5) - 32*a(n-6) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 30 2018 10:34:27, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;9\,a(n-1) + 16\,a(n-2) - 50\,a(n-3) - 72\,a(n-4) - 32\,a(n-5) - 32\,a(n-6)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A241372.
