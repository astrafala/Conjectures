...
\title{The empirical closed form for OEIS A209649, proved}
...
\begin{abstract}
OEIS A209649 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
$S=1225$ vertices. Any function of the form $\sum_j p_j(n)\lambda_j^{\,n}$ satisfies the
...
OEIS A209649 is ``Number of n X 7 0..1 arrays avoiding 0 0 1 and 1 0 0 horizontally and 0 0 1 and 1 0 1 vertically.''. It has offset $1$ and begins
\[
35, 1225, 7210, 24990, 65765, 145775, 287140, 518700,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 7*n\^{}5 + 70*n\^{}4 + (35/3)*n\^{}3 - (105/2)*n\^{}2 - (7/6)*n.
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 09 2018 10:54:46, revision 12) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;7 n^{5} + 70 n^{4} + \frac{35 n^{3}}{3} - \frac{105 n^{2}}{2} - \frac{7 n}{6}.
\]
...
walk, so with $M$ the adjacency matrix of that digraph on $S=1225$ vertices, and $u,w$ the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209649.
