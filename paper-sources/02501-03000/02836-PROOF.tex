...
\title{The empirical recurrence for OEIS A211588, proved by transfer matrix}
...
\begin{abstract}
OEIS A211588 carries an empirical recurrence of order $12$ contributed by R. H. Hardin. It is
...
OEIS A211588 is ``Number of -2..2 arrays x(i) of n+1 elements i=1..n+1 with set{t,u,v in 0,1}((x[i+t]+x[j+u]+x[k+v])*(-1)\^{}(t+u+v)) having two, four, six or eight distinct values for every i,j,k<=n.''. It has offset $1$ and begins
\[
24, 76, 216, 576, 1500, 3904, 10088, 26400,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 16:15:28, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) - 60\,a(n-3) + 79\,a(n-4) + 173\,a(n-5) - 334\,a(n-6) - 186\,a(n-7) + 504\,a(n-8) + 76\,a(n-9) - 296\,a(n-10) - 24\,a(n-11) + 48\,a(n-12)
\]
for every $n>12$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A211588.
