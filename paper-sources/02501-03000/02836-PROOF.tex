...
\title{The empirical column recurrences for the table OEIS A253397}
...
\begin{abstract}
OEIS A253397 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
exact computation, with the Cayley--Hamilton theorem bounding the work. This note settles the columns $k=2, 3, 4, 5, 6, 7$.
\end{abstract}
...
OEIS A253397 is ``T(n,k) = Number of (n+1) X (k+1) 0..1 arrays with every 2 X 2 subblock antidiagonal maximum minus diagonal minimum nondecreasing horizontally and diagonal maximum minus antidiagonal minimum nondecreasing vertically.''. It has offset $1$, is
read by antidiagonals, and begins
\[
16, 44, 44, 96, 102, 96, 180, 143,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 15 2026 14:55:56, revision 11) these are still
...
column $k$$=2$ & $4$ & $44$ & $>8$ & $9$ \\
column $k$$=3$ & $4$ & $96$ & $>8$ & $8$ \\
column $k$$=4$ & $5$ & $180$ & $>11$ & $7$ \\
column $k$$=5$ & $5$ & $304$ & $>13$ & $10$ \\
column $k$$=6$ & $6$ & $476$ & $>16$ & $10$ \\
column $k$$=7$ & $6$ & $704$ & $>18$ & $10$ \\
\end{tabular}
\end{center}
...
The sequence is ``Number of (n+1) X (3) 0..1 arrays with every 2 X 2 subblock antidiagonal maximum minus diagonal minimum nondecreasing horizontally and diagonal maximum minus antidiagonal minimum nondecreasing vertically.''. Its rows are the vertices of a digraph on
$S=44$ vertices, edges being the admissible consecutive pairs, and the count is
...
The sequence is ``Number of (n+1) X (4) 0..1 arrays with every 2 X 2 subblock antidiagonal maximum minus diagonal minimum nondecreasing horizontally and diagonal maximum minus antidiagonal minimum nondecreasing vertically.''. Its rows are the vertices of a digraph on
$S=96$ vertices, edges being the admissible consecutive pairs, and the count is
$\mathbf{1}^{\!\top}M^{n}\mathbf{1}$ up to the constant factor in the entry's name.
The conjectured recurrence
\[
a(n)\;=\;2\,a(n-1) - 2\,a(n-3) + a(n-4)
...
The sequence is ``Number of (n+1) X (5) 0..1 arrays with every 2 X 2 subblock antidiagonal maximum minus diagonal minimum nondecreasing horizontally and diagonal maximum minus antidiagonal minimum nondecreasing vertically.''. Its rows are the vertices of a digraph on
$S=180$ vertices, edges being the admissible consecutive pairs, and the count is
$\mathbf{1}^{\!\top}M^{n}\mathbf{1}$ up to the constant factor in the entry's name.
The conjectured recurrence
\[
a(n)\;=\;3\,a(n-1) - 2\,a(n-2) - 2\,a(n-3) + 3\,a(n-4) - a(n-5)
\]
holds from index $11+1$ on.

\subsection*{Column $k$$=5$}
The sequence is ``Number of (n+1) X (6) 0..1 arrays with every 2 X 2 subblock antidiagonal maximum minus diagonal minimum nondecreasing horizontally and diagonal maximum minus antidiagonal minimum nondecreasing vertically.''. Its rows are the vertices of a digraph on
$S=304$ vertices, edges being the admissible consecutive pairs, and the count is
$\mathbf{1}^{\!\top}M^{n}\mathbf{1}$ up to the constant factor in the entry's name.
The conjectured recurrence
\[
a(n)\;=\;3\,a(n-1) - 2\,a(n-2) - 2\,a(n-3) + 3\,a(n-4) - a(n-5)
\]
holds from index $13+1$ on.

\subsection*{Column $k$$=6$}
The sequence is ``Number of (n+1) X (7) 0..1 arrays with every 2 X 2 subblock antidiagonal maximum minus diagonal minimum nondecreasing horizontally and diagonal maximum minus antidiagonal minimum nondecreasing vertically.''. Its rows are the vertices of a digraph on
$S=476$ vertices, edges being the admissible consecutive pairs, and the count is
$\mathbf{1}^{\!\top}M^{n}\mathbf{1}$ up to the constant factor in the entry's name.
The conjectured recurrence
\[
a(n)\;=\;4\,a(n-1) - 5\,a(n-2) + 5\,a(n-4) - 4\,a(n-5) + a(n-6)
\]
holds from index $16+1$ on.

\subsection*{Column $k$$=7$}
The sequence is ``Number of (n+1) X (8) 0..1 arrays with every 2 X 2 subblock antidiagonal maximum minus diagonal minimum nondecreasing horizontally and diagonal maximum minus antidiagonal minimum nondecreasing vertically.''. Its rows are the vertices of a digraph on
$S=704$ vertices, edges being the admissible consecutive pairs, and the count is
$\mathbf{1}^{\!\top}M^{n}\mathbf{1}$ up to the constant factor in the entry's name.
The conjectured recurrence
\[
a(n)\;=\;4\,a(n-1) - 5\,a(n-2) + 5\,a(n-4) - 4\,a(n-5) + a(n-6)
\]
holds from index $18+1$ on.
...
model reproduces $54$ published values, $175$ decimal digits in all, every one of
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253397.
