...
\title{A further conjecture on OEIS A235879,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A235879 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $129, 231, 453, 951, 2109, 4911, 11973, 30471,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = 3*(12 + 7*2\^{}(1+n) + 3\^{}n).\end{quote}
