...
\title{The empirical recurrence for OEIS A232408, proved by transfer matrix}
...
\begin{abstract}
OEIS A232408 counts arrays of width $3$ over $\{0,1,2\}$ in which every cell has a neighbour at least as large and one at most as large. The entry carries an
...
OEIS A232408 is ``Number of (n+1) X (2+1) 0..2 arrays with every element both >= and <= some horizontal, diagonal or antidiagonal neighbor.''. It has offset $1$ and begins
\[
159, 2689, 48971, 890283, 16262989, 296516955, 5408696699, 98655002241,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 20 2014 19:41:38, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;10\,a(n-1) + 99\,a(n-2) + 761\,a(n-3) + 3010\,a(n-4) + 3817\,a(n-5) - 6407\,a(n-6) - 73996\,a(n-7) - 157764\,a(n-8) - 156451\,a(n-9) - 52584\,a(n-10) + 63306\,a(n-11) + 76836\,a(n-12) + 4720\,a(n-13) - 14400\,a(n-14)
\]
for every $n>13$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232408.
