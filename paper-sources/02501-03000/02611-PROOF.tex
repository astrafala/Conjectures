...
\title{A further conjecture on OEIS A250758,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A250758 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $332, 756, 1353, 2123, 3066, 4182, 5471, 6933,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (173/2)*n\^{}2 + (329/2)*n + 81.\end{quote}
