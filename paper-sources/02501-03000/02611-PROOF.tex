...
\title{A further conjecture on OEIS A250881,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A250881 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $8736, 30360, 73122, 144248, 250964, 400496, 600070, 856912,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (3613/3)*n\^{}3 + 3343*n\^{}2 + (9494/3)*n + 1024.\end{quote}
