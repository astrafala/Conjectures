...
\title{A further conjecture on OEIS A267879,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A267879 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $1, 10, 101, 1010, 10101, 101011, 1010111, 10101111,\dots$, with offset $0$. The sequence satisfies
\[
...
\begin{quote}\raggedright Conjecture: a(n) = (9091*10\^{}(n-3) - 1)/9 for n > 2. - \_Stefano Spezia\_, Dec 25 2021\end{quote}
