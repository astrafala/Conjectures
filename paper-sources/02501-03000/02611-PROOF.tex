...
\title{The empirical recurrence for OEIS A238907, proved by transfer matrix}
...
\begin{abstract}
OEIS A238907 counts $(n+1)\times3$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A238907 is ``Number of (n+1) X (2+1) 0..2 arrays with no element equal to all horizontal neighbors or equal to all vertical neighbors, and new values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
9, 41, 486, 4287, 41165, 385632, 3638773, 34262775,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 6*a(n-1) +32*a(n-2) +8*a(n-3) -51*a(n-4) -43*a(n-5) -5*a(n-6) +37*a(n-7) -5*a(n-8) -2*a(n-9) +4*a(n-10).
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 13 2022 19:46:08, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) + 32\,a(n-2) + 8\,a(n-3) - 51\,a(n-4) - 43\,a(n-5) - 5\,a(n-6) + 37\,a(n-7) - 5\,a(n-8) - 2\,a(n-9) + 4\,a(n-10)
\]
for every $n>10$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A238907.
