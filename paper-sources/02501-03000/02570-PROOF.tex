...
\title{A further conjecture on OEIS A239358,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A239358 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $6, 16, 32, 60, 106, 156, 218, 299,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (7/6)*n\^{}3 - (39/2)*n\^{}2 + (538/3)*n - 486 for n>8.\end{quote}
