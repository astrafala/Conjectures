...
\title{A further conjecture on OEIS A220148,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A220148 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $6, 23, 77, 242, 727, 2062, 5493, 13773,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (1/19958400)*n\^{}11 + (1/725760)*n\^{}10 + (1/145152)*n\^{}9 + (19/120960)*n\^{}8 + (7/3600)*n\^{}7 + (109/34560)*n\^{}6 + (58081/725760)*n\^{}5 + (26759/181440)*n\^{}4 - (400597/907200)*n\^{}3 + (863/126)*n\^{}\end{quote}
...
indices, and $a$ and $f$ were checked to agree at $n=13,\dots,24$,
