...
\title{A further conjecture on OEIS A266661,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A266661 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $1, 6, 3, 124, 3, 2044, 3, 32764,\dots$, with offset $0$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = (7*(-1)\^{}n+2\^{}(2*n+1)-(-1)\^{}n*2\^{}(2*n+1)-1)/2 for n>1.\end{quote}
