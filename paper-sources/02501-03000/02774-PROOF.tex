...
\title{The empirical recurrence for OEIS A231059, proved by transfer matrix}
...
\begin{abstract}
OEIS A231059 counts arrays of width $4$ over $\{0,1,2,3\}$ in which every cell must see, among its
...
the count is a walk count on $S=8365$ states.
\end{abstract}
...
OEIS A231059 is ``Number of nX4 0..3 arrays x(i,j) with each element horizontally or vertically next to at least one element with value (x(i,j)+1) mod 4, no adjacent elements equal, and upper left element zero.''. It has offset $1$ and begins
\[
0, 20, 208, 2376, 27346, 313944, 3607664, 41448458,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 06:13:54, revision 6) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=8365.
\]
...
\begin{theorem}
\[
a(n)\;=\;19\,a(n-1) - 87\,a(n-2) - 96\,a(n-3) + 1323\,a(n-4) - 858\,a(n-5) - 7666\,a(n-6) + 7362\,a(n-7) + 27116\,a(n-8) - 22605\,a(n-9) - 65782\,a(n-10) + 30708\,a(n-11) + 96872\,a(n-12) + 33216\,a(n-13) - 97603\,a(n-14) - 160311\,a(n-15) + 74945\,a(n-16) + 167168\,a(n-17) + 3832\,a(n-18) - 42520\,a(n-19) - 66621\,a(n-20) - 36551\,a(n-21) + 42655\,a(n-22) + 26735\,a(n-23) - 3326\,a(n-24) - 4386\,a(n-25) - 3303\,a(n-26) - 438\,a(n-27) + 676\,a(n-28) + 173\,a(n-29) - 22\,a(n-30) - 16\,a(n-31)
\]
for every $n>31$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231059.
