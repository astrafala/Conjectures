...
\title{A further conjecture on OEIS A219521,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A219521 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $5, 9, 22, 68, 166, 380, 821, 1700,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (1/40320)*n\^{}8 - (1/3360)*n\^{}7 + (7/576)*n\^{}6 - (7/60)*n\^{}5 + (1567/5760)*n\^{}4 + (2201/160)*n\^{}3 - (116111/672)*n\^{}2 + (251961/280)*n - 1757 for n>9\end{quote}
...
indices, and $a$ and $f$ were checked to agree at $n=19,\dots,27$,
