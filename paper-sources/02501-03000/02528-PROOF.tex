...
\title{A further conjecture on OEIS A251271,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A251271 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $337, 2058, 9109, 32636, 100843, 279718, 715685, 1722176,\dots$, with offset $1$. The sequence satisfies
\[
  a(n)=11\,a(n-1) - 54\,a(n-2) + 156\,a(n-3) - 294\,a(n-4) + 378\,a(n-5) - 336\,a(n-6) + 204\,a(n-7) - 81\,a(n-8) + 19\,a(n-9) - 2\,a(n-10) ,
\]
a linear recurrence of order $10$ with characteristic polynomial
\[
  q(x)=x^{10} - 11 x^{9} + 54 x^{8} - 156 x^{7} + 294 x^{6} - 378 x^{5} + 336 x^{4} - 204 x^{3} + 81 x^{2} - 19 x + 2 .
\]
...
with at least $10+2$ further terms after that index.

\section{The further conjecture}

Separately from the conjecture already settled, the entry records

\begin{quote}\raggedright a(n) = (20160*(1369*2\^{}n-1365) - 18907464*n - 6363848*n\^{}2 - 1352064*n\^{}3 - 190036*n\^{}4 - 16401*n\^{}5 - 637*n\^{}6 + 9*n\^{}7 + n\^{}8) / 2520.\end{quote}
...
\[
  p(x)=x^{10} - 11 x^{9} + 54 x^{8} - 156 x^{7} + 294 x^{6} - 378 x^{5} + 336 x^{4} - 204 x^{3} + 81 x^{2} - 19 x + 2 ,
\]
of order $D=10$. Since $q\mid p$ and $a$ satisfies the recurrence of $q$, $a$ satisfies that of
...
indices, and $a$ and $f$ were checked to agree at $n=11,\dots,20$,
