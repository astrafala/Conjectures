...
\title{The empirical recurrence for OEIS A276250, proved by transfer matrix}
...
\begin{abstract}
OEIS A276250 counts arrays in which no entry may equal the entries at a short list of fixed offsets
from it, the arrays being counted up to renaming the letters. The entry carries an empirical
recurrence of order $57$ contributed by R.~H.~Hardin. It is true, and it is decidable
...
$2$ consecutive columns, $S=973$ states in all.
\end{abstract}
...
OEIS A276250 is ``Number of 4Xn 0..2 arrays with no element equal to any value at offset (-2,-1) (-1,1) or (0,-2) and new values introduced in order 0..2.''. It has offset $1$ and begins
\[
14, 144, 347, 1447, 6372, 26325, 115682, 509750,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 25 2016 11:05:43, revision 4) this is still
...
\[
x(i,j)\ \ne\ x(i+d_1,\,j+d_2)\qquad\text{for each offset }(d_1,d_2)\in\{(-2,-1), (-1,1), (0,-2)\}
\]
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 16\,a(n-2) - 5\,a(n-3) - 96\,a(n-4) - 140\,a(n-5) + 637\,a(n-6) + 1845\,a(n-7) - 4795\,a(n-8) - 4911\,a(n-9) + 12349\,a(n-10) - 1040\,a(n-11) - 18997\,a(n-12) + 57322\,a(n-13) + 54548\,a(n-14) - 182018\,a(n-15) - 172148\,a(n-16) + 276602\,a(n-17) + 240887\,a(n-18) - 309700\,a(n-19) - 3428\,a(n-20) + 178083\,a(n-21) - 246987\,a(n-22) - 172205\,a(n-23) + 88525\,a(n-24) + 1238349\,a(n-25) - 316382\,a(n-26) - 1914836\,a(n-27) + 450326\,a(n-28) + 1900140\,a(n-29) + 67773\,a(n-30) - 2250174\,a(n-31) - 208550\,a(n-32) + 2206511\,a(n-33) + 362321\,a(n-34) - 1986445\,a(n-35) - 432077\,a(n-36) + 1246173\,a(n-37) + 592283\,a(n-38) - 611575\,a(n-39) - 456433\,a(n-40) + 225504\,a(n-41) + 147384\,a(n-42) + 9126\,a(n-43) - 62519\,a(n-44) - 16308\,a(n-45) + 12194\,a(n-46) + 3502\,a(n-47) - 600\,a(n-48) - 251\,a(n-49) + 286\,a(n-50) + 69\,a(n-51) - 134\,a(n-52) - 27\,a(n-53) + 19\,a(n-54) + 8\,a(n-55) - a(n-56) - a(n-57)
\]
for every $n>60$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A276250.
