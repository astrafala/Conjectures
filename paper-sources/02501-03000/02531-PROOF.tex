...
\title{A further conjecture on OEIS A219589,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A219589 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $3, 7, 21, 46, 87, 151, 247, 386,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (1/12)*n\^{}4 - (1/3)*n\^{}3 + (47/12)*n\^{}2 - (14/3)*n + 2 for n>1.\end{quote}
