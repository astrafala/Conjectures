...
\title{A further conjecture on OEIS A265284,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A265284 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $1, 4, 8, 14, 20, 28, 36, 46,\dots$, with offset $0$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = (2*n\^{}2+12*n-(-1)\^{}n+1)/4 for n>0.\end{quote}
