...
\title{The empirical column recurrences for the table OEIS A253524}
...
\begin{abstract}
OEIS A253524 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A253524 is ``T(n,k)=Number of (n+1)X(k+1) 0..2 arrays with every 2X2 subblock diagonal minimum minus antidiagonal minimum nondecreasing horizontally and diagonal maximum minus antidiagonal maximum nondecreasing vertically.''. It has offset $1$, is
read by antidiagonals, and begins
\[
81, 470, 470, 2180, 2724, 2180, 9623, 10706,\ \dots
\]
The entry carries the following block:
\begin{quote}\small
Empirical for column k:\\
k=1: a(n) = 8*a(n-1) -15*a(n-2) -12*a(n-3) +44*a(n-4) -8*a(n-5) -16*a(n-6) for n>13\\
k=2: [order 9] for n>17\\
k=3: [order 8] for n>16\\
k=4: [order 8] for n>16\\
k=5: [order 7] for n>15\\
k=6: [same order 7] for n>15\\
k=7: [same order 7] for n>15\\
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 14:05:49, revision 6) these are still
...
The sequence is ``Number of (n+1)X(2) 0..2 arrays with every 2X2 subblock diagonal minimum minus antidiagonal minimum nondecreasing horizontally and diagonal maximum minus antidiagonal maximum nondecreasing vertically.''. Its rows are the vertices of a digraph on
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253524.
