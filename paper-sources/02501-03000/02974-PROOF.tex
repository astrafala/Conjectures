...
\title{The empirical recurrence for OEIS A214114, proved by transfer matrix}
...
\begin{abstract}
OEIS A214114 counts the proper colourings of a grid $3\times(n+1)$, wrapped in the growing direction, with at most $4$ colours and
...
down to $S=98$ and makes the exact residual test affordable.
\end{abstract}
...
OEIS A214114 is ``Number of 0..3 colorings of a 3X(n+1) array circular in the n+1 direction with new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
25, 121, 3502, 44900, 825105, 12777541, 214404272, 3462096250,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 16:52:19, revision 12) this is still
...
state count is $S=98$ rather than the number of colourings.
...
\begin{theorem}
\[
a(n)\;=\;11\,a(n-1) + 123\,a(n-2) - 509\,a(n-3) - 1615\,a(n-4) + 7137\,a(n-5) - 19\,a(n-6) - 20571\,a(n-7) + 13176\,a(n-8) + 13932\,a(n-9) - 11664\,a(n-10)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A214114.
