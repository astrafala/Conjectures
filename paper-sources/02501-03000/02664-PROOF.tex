...
\title{The empirical recurrence for OEIS A231851, proved by transfer matrix}
...
\begin{abstract}
OEIS A231851 counts arrays of width $4$ over $\{0,1,2\}$ in which no cell is beaten by a strict majority of its neighbours. The entry carries an
...
$3$ consecutive rows and the count is a walk count on $S=5401$ states.
\end{abstract}
...
OEIS A231851 is ``Number of nX4 0..2 arrays with no element having a strict majority of its horizontal and antidiagonal neighbors equal to itself plus one mod 3, with upper left element zero (rock paper and scissors drawn positions).''. It has offset $1$ and begins
\[
8, 144, 7339, 360966, 17726611, 870478586, 42745416641, 2099041399895,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 08:47:59, revision 6) this is still
...
Thus
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=5401,
\]
...
\begin{theorem}
\[
a(n)\;=\;62\,a(n-1) - 697\,a(n-2) + 3287\,a(n-3) - 7718\,a(n-4) + 9336\,a(n-5) - 5629\,a(n-6) + 1612\,a(n-7) - 184\,a(n-8) + 4\,a(n-9)
\]
for every $n>10$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231851.
