...
\title{A further conjecture on OEIS A283651,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A283651 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $1, 0, 7, 11, 7, 47, 31, 191,\dots$, with offset $0$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = (-2 - (-2)\^{}n + 2\^{}(1+n)) / 2 for n>2.\end{quote}
