...
\title{A further conjecture on OEIS A235878,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A235878 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $51, 105, 231, 537, 1311, 3345, 8871, 24297,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = 3*(2 + 3*2\^{}(1+n) + 3\^{}n).\end{quote}
