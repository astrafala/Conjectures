...
\title{The empirical recurrence for OEIS A186932, proved by transfer matrix}
...
\begin{abstract}
OEIS A186932 counts arrays over $\{0,\dots,1\}$ under a condition comparing a statistic of
...
empirical. The count is a walk count on $S=188$ states and is $C$-finite; whether the
...
OEIS A186932 is ``Number of (n+1) X 3 binary arrays with every 2 X 2 subblock trace equal to exactly one or two horizontal and vertical neighbor 2 X 2 subblock traces.''. It has offset $1$ and begins
\[
24, 104, 472, 1664, 6848, 27272, 108128, 431656,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 16 2023 20:51:51, revision 7) this is still
...
$S=188$ states in all. Getting the two vectors right is the whole of the argument: with
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 4\,a(n-2) + 12\,a(n-3) + 4\,a(n-4) + 17\,a(n-5) + 136\,a(n-6) - 78\,a(n-7) - 269\,a(n-8) - 496\,a(n-9) + 226\,a(n-10) + 441\,a(n-11) - 110\,a(n-12) + 372\,a(n-13) + 448\,a(n-15) - 512\,a(n-16)
\]
for every $n>16$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A186932.
