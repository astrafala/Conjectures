...
\title{A further conjecture on OEIS A220031,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A220031 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $7, 18, 55, 137, 302, 613, 1165, 2094,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (1/720)*n\^{}6 + (7/240)*n\^{}5 + (11/144)*n\^{}4 + (25/48)*n\^{}3 + (263/90)*n\^{}2 + (29/20)*n - 4 for n>2.\end{quote}
