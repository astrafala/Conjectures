...
\title{A further conjecture on OEIS A266592,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A266592 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $1, 11, 111, 1110, 11101, 111010, 1110101, 11101010,\dots$, with offset $0$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = (45*(-1)\^{}n+1099*10\^{}n-55)/990 for n>0.\end{quote}
