...
\title{The empirical recurrence for OEIS A268022, proved by transfer matrix}
...
\begin{abstract}
OEIS A268022 counts arrays in which the REPEATED VALUES of each row, and of each column, stand in a
...
OEIS A268022 is ``Number of nX3 0..2 arrays with every repeated value in every row greater than or equal to, and in every column greater than, the previous repeated value.''. It has offset $1$ and begins
\[
27, 729, 13824, 250047, 4019679, 61162984, 876467493, 12040481088,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 24 2016 14:07:45, revision 5) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268022.
