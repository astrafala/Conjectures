...
\title{The empirical recurrence for OEIS A207296, proved by transfer matrix}
...
\begin{abstract}
OEIS A207296 counts arrays of width $3$ over $\{0,1,2,3\}$ by reducing every $2\times2$ subblock to a
...
about it is one bit per adjacent pair of columns, so the count is a walk count on $S=2385$
states.
\end{abstract}
...
OEIS A207296 is ``Number of (n+1)X3 0..3 arrays with rows and columns of determinants of all 2X2 subblocks lexicographically nondecreasing.''. It has offset $1$ and begins
\[
2338, 93991, 2019514, 33860323, 521236935, 8125554503, 129766993681, 2097529018861,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 24*a(n-1) -102*a(n-2) -656*a(n-3) +4911*a(n-4) -9576*a(n-5) +5400*a(n-6) for n>28
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 13:44:51, revision 9) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=2385.
\]
...
\begin{theorem}
\[
a(n)\;=\;24\,a(n-1) - 102\,a(n-2) - 656\,a(n-3) + 4911\,a(n-4) - 9576\,a(n-5) + 5400\,a(n-6)
\]
for every $n>28$.
\end{theorem}
...
array of width $3$ over $\{0,1,2,3\}$ with two and with three rows was written out cell by cell,
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207296.
