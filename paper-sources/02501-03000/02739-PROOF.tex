...
\title{The empirical recurrence for OEIS A268625, proved by transfer matrix}
...
\begin{abstract}
OEIS A268625 counts arrays of width $5$ over $\{0,1,2\}$ in which the number of adjacent PAIRS of
...
result is a walk count on $S=436$ states.
\end{abstract}
...
OEIS A268625 is ``Number of n X 5 0..2 arrays with some element plus some horizontally or vertically adjacent neighbor totaling two no more than once.''. It has offset $1$ and begins
\[
144, 2430, 34890, 467190, 6000978, 74914554, 915847266, 11018667294,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 17 2023 12:08:37, revision 6) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The array has $5$ cells across, with entries in $\{0,1,2\}$. An ADJACENT PAIR is a pair of cells
\[
\begin{array}{l}
$(i,j)\text{ and }(i,j{+}1)$ \\
$(i,j)\text{ and }(i{+}1,j)$ \\
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268625.
