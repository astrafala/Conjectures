...
\title{A further conjecture on OEIS A235887,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A235887 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $112, 232, 568, 1624, 5272, 18712, 70168, 271384,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = 4*(6 + 9*2\^{}n + 4\^{}n).\end{quote}
