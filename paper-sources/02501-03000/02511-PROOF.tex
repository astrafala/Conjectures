...
\title{A further conjecture on OEIS A219286,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A219286 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $3, 6, 19, 42, 79, 136, 220, 339,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (1/24)*n\^{}4 + (1/4)*n\^{}3 - (1/24)*n\^{}2 + (27/4)*n - 11 for n>2.\end{quote}
