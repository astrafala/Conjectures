...
\title{A further conjecture on OEIS A207450,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A207450 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $16, 256, 1008, 2560, 5200, 9216, 14896, 22528,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = 48*n\^{}3 - 32*n\^{}2.\end{quote}
