...
\title{The empirical recurrence for OEIS A280066, proved by transfer matrix}
...
\begin{abstract}
OEIS A280066 counts $n\times5$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A280066 is ``Number of nX5 0..1 arrays with no element unequal to a strict majority of its horizontal, vertical and antidiagonal neighbors and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
3, 9, 39, 170, 790, 3729, 17468, 82769,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 25 2016 06:39:10, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-1) - 4\,a(n-2) - 97\,a(n-3) + 176\,a(n-4) + 339\,a(n-5) - 1073\,a(n-6) - 47\,a(n-7) + 3377\,a(n-8) - 3342\,a(n-9) - 7621\,a(n-10) + 13813\,a(n-11) + 10465\,a(n-12) - 31408\,a(n-13) - 5811\,a(n-14) + 90585\,a(n-15) - 69504\,a(n-16) - 167596\,a(n-17) + 292370\,a(n-18) - 85078\,a(n-19) - 228536\,a(n-20) + 394124\,a(n-21) - 113838\,a(n-22) - 192578\,a(n-23) + 250274\,a(n-24) - 199426\,a(n-25) - 58314\,a(n-26) + 185492\,a(n-27) - 136476\,a(n-28) + 48376\,a(n-29) + 64368\,a(n-30) - 69640\,a(n-31) + 27472\,a(n-32) + 2400\,a(n-33) - 15956\,a(n-34) + 6480\,a(n-35)
\]
for every $n>40$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A280066.
