...
\title{A further conjecture on OEIS A253450,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A253450 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $414, 1975, 4782, 8554, 15220, 31630, 74324, 188438,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = 529*3\^{}(n-3) + 444*2\^{}(n-1) + 3059 for n>6.\end{quote}
