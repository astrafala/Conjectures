...
\title{A further conjecture on OEIS A269091,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A269091 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $4, 96, 1152, 11424, 103488, 889056, 7375872, 59698464,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = 96*7\^{}(n-3)*(5*n-3) for n>1.\end{quote}
