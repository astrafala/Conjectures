...
\title{The empirical recurrence for OEIS A204475, proved by transfer matrix}
...
\begin{abstract}
OEIS A204475 counts $(n+2)\times3$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A204475 is ``Number of (n+2)X3 0..3 arrays with every 3X3 subblock having three equal elements in a row horizontally, vertically or nw-to-se diagonally exactly three ways, and new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
80, 307, 1157, 1899, 7191, 24718, 70726, 277992,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 11:14:07, revision 10) this is still
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-1) - 21\,a(n-2) + 22\,a(n-3) - 22\,a(n-4) + 60\,a(n-5) - 12\,a(n-6) - 448\,a(n-7) + 1866\,a(n-8) - 6498\,a(n-9) + 15684\,a(n-10) - 22888\,a(n-11) + 31417\,a(n-12) - 57462\,a(n-13) + 52230\,a(n-14) + 113688\,a(n-15) - 424149\,a(n-16) + 557158\,a(n-17) - 411880\,a(n-18) + 403956\,a(n-19) - 471132\,a(n-20) - 17430\,a(n-21) + 839565\,a(n-22) - 1046718\,a(n-23) + 545742\,a(n-24) - 113292\,a(n-25) + 131571\,a(n-26) - 347004\,a(n-27) + 373977\,a(n-28) - 80190\,a(n-29) - 271188\,a(n-30) + 354294\,a(n-31) - 190269\,a(n-32) + 39366\,a(n-33)
\]
for every $n>33$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204475.
