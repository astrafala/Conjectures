...
\title{A further conjecture on OEIS A245158,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A245158 carries more than one conjecture. One of them has a proof; this paper settles a
...
\[
  q(x)=x^{5} - 10 x^{4} + 37 x^{3} - 64 x^{2} + 52 x - 16 .
\]
...
\begin{quote}\raggedright a(n) = (-64 - 27*2\^{}(2+n) + 4\^{}n + 12*(32+3*2\^{}n)*n) / 576 for n>1.\end{quote}
...
\[
  p(x)=x^{5} - 10 x^{4} + 37 x^{3} - 64 x^{2} + 52 x - 16 ,
\]
