...
\title{A further conjecture on OEIS A219382,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A219382 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $6, 7, 14, 25, 40, 66, 103, 157,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (1/24)*n\^{}4 - (1/4)*n\^{}3 + (35/24)*n\^{}2 + (15/4)*n - 9 for n>5.\end{quote}
