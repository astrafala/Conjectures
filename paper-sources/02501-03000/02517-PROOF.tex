...
\title{A further conjecture on OEIS A207106,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A207106 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $6, 36, 98, 200, 350, 556, 826, 1168,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (4/3)*n\^{}3 + 8*n\^{}2 - (10/3)*n.\end{quote}
