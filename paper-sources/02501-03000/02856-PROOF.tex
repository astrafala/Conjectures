...
\title{The empirical recurrence for OEIS A269287, proved by transfer matrix}
...
\begin{abstract}
OEIS A269287 counts arrays of width $6$ over $\{0,1,2,3\}$ in which the number of adjacent PAIRS of
...
OEIS A269287 is ``Number of nX6 0..3 arrays with some element plus some horizontally or antidiagonally adjacent neighbor totalling three no more than once.''. It has offset $1$ and begins
\[
2592, 1363572, 544118148, 193446959076, 64538382287988, 20680187784811380, 6444304707617709156, 1967513283560471350788,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 564*a(n-1) -87462*a(n-2) +2257724*a(n-3) -21169617*a(n-4) +76236552*a(n-5) -92236816*a(n-6) for n>7
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 21 2016 09:25:35, revision 4) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269287.
