...
\title{A further conjecture on OEIS A277865,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A277865 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $1, 10, 100, 1011, 10000, 101111, 1000000, 10111111,\dots$, with offset $0$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = (-10-(-10)\^{}n+10*(-1)\^{}n+181*10\^{}n)/180. (End)\end{quote}
...
indices, and $a$ and $f$ were checked to agree at $n=4,\dots,7$,
