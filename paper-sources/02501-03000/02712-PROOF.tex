...
\title{The empirical closed form for OEIS A224001, proved}
...
\begin{abstract}
OEIS A224001 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A224001 is ``Number of 3 X n 0..2 arrays with antidiagonals unimodal and rows and diagonals nondecreasing.''. It has offset $1$ and begins
\[
27, 157, 476, 1144, 2403, 4614, 8291, 14141,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (1/144)*n\^{}6 + (5/48)*n\^{}5 + (163/144)*n\^{}4 + (85/16)*n\^{}3 + (895/36)*n\^{}2 - (65/12)*n + 3 for n>2.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 25 2018 15:35:14, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{n^{6}}{144} + \frac{5 n^{5}}{48} + \frac{163 n^{4}}{144} + \frac{85 n^{3}}{16} + \frac{895 n^{2}}{36} - \frac{65 n}{12} + 3.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224001.
