...
\title{A further conjecture on OEIS A266449,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A266449 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $0, 2, 3, 4, 5, 5, 9, 5,\dots$, with offset $0$. The sequence satisfies
\[
  a(n)=2\,a(n-2) - 1\,a(n-4) ,
\]
...
\begin{quote}\raggedright a(n) = (-1)\^{}n*(n-4)+n+1 for n>3.\end{quote}
