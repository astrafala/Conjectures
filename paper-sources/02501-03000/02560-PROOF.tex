...
\title{A further conjecture on OEIS A220029,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A220029 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $5, 12, 30, 61, 111, 187, 297, 450,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (1/24)*n\^{}4 + (5/12)*n\^{}3 + (11/24)*n\^{}2 + (61/12)*n - 4 for n>1.\end{quote}
