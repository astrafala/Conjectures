...
\title{A further conjecture on OEIS A229749,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A229749 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $0, 3, 60, 422, 1840, 6456, 20032, 57440,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = 2\^{}(n-3) * (195 - 192*n + 49*n\^{}2) for n>2.\end{quote}
