...
\title{The empirical column recurrences for the table OEIS A259952}
...
\begin{abstract}
OEIS A259952 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A259952 is ``T(n,k)=Number of (n+2)X(k+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000000 00000001 or 00000101.''. It has offset $1$, is
read by antidiagonals, and begins
\[
34, 60, 60, 156, 170, 156, 365, 549,\ \dots
\]
The entry carries the following block:
\begin{quote}\small
Empirical for column k:\\
k=1: a(n) = a(n-1) +a(n-2) +2*a(n-3) +6*a(n-4) -a(n-6) +a(n-7) -a(n-8) for n>9\\
k=2: [order 9] for n>10\\
k=3: [order 16] for n>17\\
k=4: [order 24] for n>27\\
k=5: [order 40] for n>41\\
k=6: [order 67] for n>71\\
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:56:53, revision 6) these are still
...
The sequence is ``Number of (n+2)X(3) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000000 00000001 or 00000101.''. Its rows are the vertices of a digraph on
...
model reproduces $10$ published values, $35$ decimal digits in all, every one of
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A259952.
