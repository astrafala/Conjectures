...
\title{Arrays counted up to renaming: the empirical recurrence for OEIS A206378}
...
\begin{abstract}
OEIS A206378 carries an empirical recurrence of order $6$ contributed by R.~H.~Hardin. It is
...
both in the state the arrays are exactly the walks in a digraph on $S=17$ vertices, so $a(n)$
...
OEIS A206378 is ``Number of (n+1)X4 0..3 arrays with every 2X2 subblock having the same number of equal diagonal or antidiagonal elements, and new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
641, 25945, 1198601, 57656713, 2808967145, 137393517193, 6728546532521, 329641979105737,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 12:54:30, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;74\,a(n-1) - 1401\,a(n-2) + 9064\,a(n-3) - 21992\,a(n-4) + 21312\,a(n-5) - 7056\,a(n-6)
\]
for every $n>6$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206378.
