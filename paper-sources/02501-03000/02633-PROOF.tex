...
\title{A further conjecture on OEIS A269896,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A269896 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $7, 840, 45360, 2005080, 80724000, 3078006120, 113260615440, 4064194275960,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = 840 * 31\^{}(n-3) * (23*n-15) for n>1.\end{quote}
