...
\title{A further conjecture on OEIS A253499,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A253499 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $8501, 9654, 13528, 19475, 32652, 61955, 127898, 281402,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = 400*3\^{}(n-3) + 1386*2\^{}(n-1) + 6794 for n>6.\end{quote}
