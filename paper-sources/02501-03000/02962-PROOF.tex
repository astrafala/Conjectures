...
\title{The empirical closed form for OEIS A185469, proved}
...
\begin{abstract}
OEIS A185469 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A185469 is ``Number of (n+2)X3 0..2 arrays with each 3X3 subblock having rows and columns in lexicographically nondecreasing order.''. It has offset $1$ and begins
\[
1169, 4594, 13659, 34779, 79743, 169052, 336690, 636698,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 03:00:05, revision 9) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{n^{9}}{362880} + \frac{n^{8}}{1008} + \frac{431 n^{7}}{12096} + \frac{373 n^{6}}{720} + \frac{82453 n^{5}}{17280} + \frac{637 n^{4}}{18} + \frac{2819461 n^{3}}{18144} + \frac{119729 n^{2}}{315} + \frac{605807 n}{1260} + 112.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A185469.
