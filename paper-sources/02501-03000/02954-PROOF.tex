...
\title{The empirical column recurrences for the table OEIS A316686}
...
\begin{abstract}
OEIS A316686 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A316686 is ``T(n,k) = Number of n X k 0..1 arrays with every element unequal to 2, 3, 4, 5, 7 or 8 king-move adjacent elements, with upper left element zero.''. It has offset $1$, is
read by antidiagonals, and begins
\[
0, 0, 0, 0, 3, 0, 0, 5,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 12 2022 19:38:32, revision 6) these are still
...
The sequence is ``Number of n X 2 0..1 arrays with every element unequal to 2, 3, 4, 5, 7 or 8 king-move adjacent elements, with upper left element zero.''. Its rows are the vertices of a digraph on
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A316686.
