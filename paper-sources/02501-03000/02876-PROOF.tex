...
\title{The empirical recurrence for OEIS A210399, proved by counting patterns}
...
\begin{abstract}
OEIS A210399 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A210399 is ``Number of (n+1)X4 0..3 arrays with every 2X2 subblock having one or three distinct values, and new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
549, 29647, 1596154, 85979301, 4631193134, 249456180709, 13436785945910, 723763304576749,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 15:58:10, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;65\,a(n-1) - 483\,a(n-2) - 7397\,a(n-3) + 54220\,a(n-4) + 315572\,a(n-5) - 1567384\,a(n-6) - 4952640\,a(n-7) + 15991008\,a(n-8) + 21762048\,a(n-9) - 51440128\,a(n-10) - 13774848\,a(n-11) + 33619968\,a(n-12)
\end{equation}
for all $n>12$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A210399.
