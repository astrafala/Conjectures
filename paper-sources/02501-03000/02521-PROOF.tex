...
\title{The empirical closed form for OEIS A224411, proved}
...
\begin{abstract}
OEIS A224411 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A224411 is ``Number of 4 X n 0..1 arrays with rows unimodal and antidiagonals nondecreasing.''. It has offset $1$ and begins
\[
16, 108, 358, 884, 1928, 3902, 7490, 13784,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 30 2018 19:37:32, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{n^{8}}{40320} + \frac{n^{7}}{1440} + \frac{31 n^{6}}{2880} + \frac{13 n^{5}}{144} + \frac{3767 n^{4}}{5760} + \frac{6409 n^{3}}{1440} + \frac{189859 n^{2}}{10080} - \frac{73 n}{24} - 7.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224411.
