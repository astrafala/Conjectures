...
\title{The empirical recurrence for OEIS A262817, proved by transfer matrix}
...
\begin{abstract}
OEIS A262817 counts arrays of width $6$ over $\{0,1\}$ whose rows, read as base-$2$
numbers, are divisible by $9$ and whose columns, read the same way, are not divisible by
$9$. The entry carries an empirical recurrence of order $17$ contributed by
...
OEIS A262817 is ``Number of (n+3)X(3+3) 0..1 arrays with each row divisible by 9 and column not divisible by 9, read as a binary number with top and left being the most significant bits.''. It has offset $1$ and begins
\[
2744, 21952, 175616, 1442897, 11697083, 94196375, 753571000, 6028568000,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2015 13:14:23, revision 5) this is still
...
$9$ and every $\gamma_j$ be not divisible by $9$.
...
So the vector $\bigl(\gamma_1\bmod 9,\dots,\gamma_{6}\bmod
9\bigr)$ is a state: at most $9^{6}$ of them, and each array row
...
which every entry is not divisible by $9$ --- so the end vector is not the all-ones
...
\begin{theorem}
\[
a(n)\;=\;12\,a(n-1) - 32\,a(n-2) - 64\,a(n-3) + 768\,a(n-4) - 2048\,a(n-5) + 65\,a(n-6) - 780\,a(n-7) + 2080\,a(n-8) + 4160\,a(n-9) - 49920\,a(n-10) + 133120\,a(n-11) - 64\,a(n-12) + 768\,a(n-13) - 2048\,a(n-14) - 4096\,a(n-15) + 49152\,a(n-16) - 131072\,a(n-17)
\]
for every $n>13$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A262817.
