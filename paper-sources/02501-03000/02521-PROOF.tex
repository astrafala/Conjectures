...
\title{A further conjecture on OEIS A251132,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A251132 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $369, 1002, 1997, 4110, 8050, 15830, 30770, 60088,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = (36*(-5+9*(-1)\^{}n+9*2\^{}(3+n)) + 202*n + 151*n\^{}2 + 50*n\^{}3 + 5*n\^{}4) / 12 for n>3.\end{quote}
