...
\title{A further conjecture on OEIS A219498,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A219498 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $4, 7, 18, 35, 58, 88, 126, 173,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (1/6)*n\^{}3 + 1*n\^{}2 + (23/6)*n - 7 for n>2.\end{quote}
