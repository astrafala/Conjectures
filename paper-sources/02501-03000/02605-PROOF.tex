...
\title{The empirical recurrence for OEIS A297584, proved by transfer matrix}
...
\begin{abstract}
OEIS A297584 counts arrays of width $3$ over $\{0,1\}$ in which every cell of one value has an allowed number of neighbours of another. The entry carries an
...
OEIS A297584 is ``Number of 3 X n 0..1 arrays with every 1 horizontally, diagonally or antidiagonally adjacent to 1 or 4 neighboring 1's.''. It has offset $1$ and begins
\[
1, 9, 36, 72, 188, 688, 2085, 5497,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + a(n-2) + 8*a(n-3) + 18*a(n-4) + a(n-5) - 11*a(n-6) - 12*a(n-7) - a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 26 2023 10:13:33, revision 9) this is still
...
The condition is that every cell equal to $1$ has exactly $1$ or exactly $4$ neighbours equal to $1$:
\[
x(i,j)=1\ \Longrightarrow\ \#\{(a,b)\in S(i,j):x(a,b)=1\}\in\{1,4\}.
\]
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + a(n-2) + 8\,a(n-3) + 18\,a(n-4) + a(n-5) - 11\,a(n-6) - 12\,a(n-7) - a(n-8)
\]
for every $n>7$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297584.
