...
\title{A further conjecture on OEIS A250857,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A250857 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $54410, 291165, 1043885, 2955136, 7134786, 15344785, 30214465, 55486360,\dots$, with offset $1$. The sequence satisfies
\[
  a(n)=7\,a(n-1) - 21\,a(n-2) + 35\,a(n-3) - 35\,a(n-4) + 21\,a(n-5) - 7\,a(n-6) + 1\,a(n-7) ,
\]
a linear recurrence of order $7$ with characteristic polynomial
\[
  q(x)=x^{7} - 7 x^{6} + 21 x^{5} - 35 x^{4} + 35 x^{3} - 21 x^{2} + 7 x - 1 .
\]
...
\begin{quote}\raggedright Empirical: a(n) = (763/18)*n\^{}6 + (1949/3)*n\^{}5 + (136493/36)*n\^{}4 + (72691/6)*n\^{}3 + (693923/36)*n\^{}2 + (43319/3)*n + 4096.\end{quote}
...
indices, and $a$ and $f$ were checked to agree at $n=8,\dots,14$,
