...
\title{A further conjecture on OEIS A267460,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A267460 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $0, 2, 4, 6, 6, 8, 8, 10,\dots$, with offset $0$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = (2*n-(-1)\^{}n+5)/2 for n>1.\end{quote}
