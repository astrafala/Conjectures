...
\title{A further conjecture on OEIS A253158,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A253158 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $613, 624, 633, 668, 740, 884, 1172, 1748,\dots$, with offset $1$. The sequence satisfies
\[
  a(n)=3\,a(n-1) - 2\,a(n-2) ,
\]
...
\begin{quote}\raggedright Empirical: a(n) = 9*2\^{}(n-1) + 596 for n>3.\end{quote}
...
indices, and $a$ and $f$ were checked to agree at $n=6,\dots,7$,
