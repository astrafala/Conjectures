...
\title{A further conjecture on OEIS A269277,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A269277 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $0, 108, 1368, 13896, 127512, 1104264, 9211608, 74853576,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = 72 * 7\^{}(n-4) * (60*n-47) for n>2.\end{quote}
