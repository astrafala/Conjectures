...
\title{A further conjecture on OEIS A250883,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A250883 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $155080, 553736, 1350002, 2681528, 4685964, 7500960, 11264166, 16113232,\dots$, with offset $1$. The sequence satisfies
\[
  a(n)=4\,a(n-1) - 6\,a(n-2) + 4\,a(n-3) - 1\,a(n-4) ,
\]
a linear recurrence of order $4$ with characteristic polynomial
\[
  q(x)=x^{4} - 4 x^{3} + 6 x^{2} - 4 x + 1 .
\]
...
\begin{quote}\raggedright Empirical: a(n) = (68825/3)*n\^{}3 + 61155*n\^{}2 + (163798/3)*n + 16384.\end{quote}
