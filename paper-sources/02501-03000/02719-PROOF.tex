...
\title{A further conjecture on OEIS A266667,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A266667 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $1, 101, 100, 1110111, 10000, 11111011111, 1000000, 111111101111111,\dots$, with offset $0$. The sequence satisfies
\[
  a(n)=-10\,a(n-1) + 10001\,a(n-2) + 100010\,a(n-3) - 10000\,a(n-4) - 100000\,a(n-5) ,
\]
a linear recurrence of order $5$ with characteristic polynomial
\[
  q(x)=x^{5} + 10 x^{4} - 10001 x^{3} - 100010 x^{2} + 10000 x + 100000 .
\]
...
\begin{quote}\raggedright a(n) = (-1+(-1)\^{}n+9*(-5)\^{}n*2\^{}(1+n)+10\^{}(1+2*n)-(-1)\^{}n*10\^{}(1+2*n))/18.\end{quote}
...
\[
  p(x)=x^{5} + 10 x^{4} - 10001 x^{3} - 100010 x^{2} + 10000 x + 100000 ,
\]
