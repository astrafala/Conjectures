...
\title{A further conjecture on OEIS A220033,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A220033 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $4, 6, 10, 19, 30, 42, 55, 69,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (1/2)*n\^{}2 + (13/2)*n - 15 for n>3.\end{quote}
