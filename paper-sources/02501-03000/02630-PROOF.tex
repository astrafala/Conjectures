...
\title{The empirical recurrence for OEIS A232520, proved by transfer matrix}
...
\begin{abstract}
OEIS A232520 counts arrays of width $6$ over $\{0,1,2\}$ in which every cell sees its own value plus and minus one among its neighbours. The entry carries an
...
OEIS A232520 is ``Number of (5+1)X(n+1) 0..2 arrays with every element next to itself plus and minus one within the range 0..2 horizontally, diagonally or antidiagonally, with no adjacent elements equal.''. It has offset $1$ and begins
\[
28, 3052, 1344, 145682, 64290, 7059918, 3267824, 342080372,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 07:29:05, revision 6) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The arrays have $6$ columns and a growing number of rows, with entries in $\{0,1,2\}$. Fix the
...
Thus
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=1478,
\]
...
\begin{theorem}
\[
a(n)\;=\;46\,a(n-2) + a(n-3) + 184\,a(n-4) + 21\,a(n-5) - 3129\,a(n-6) - 1083\,a(n-7) - 3837\,a(n-8) - 5042\,a(n-9) + 64552\,a(n-10) + 42441\,a(n-11) - 10740\,a(n-12) + 85083\,a(n-13) - 472265\,a(n-14) - 520288\,a(n-15) + 646440\,a(n-16) + 58606\,a(n-17) + 990947\,a(n-18) + 2531329\,a(n-19) - 2663947\,a(n-20) - 3853362\,a(n-21) + 526235\,a(n-22) - 243166\,a(n-23) + 2238796\,a(n-24) + 3874611\,a(n-25) + 231546\,a(n-26) - 428600\,a(n-27) - 2131424\,a(n-28) - 2004356\,a(n-29) - 566543\,a(n-30) - 430671\,a(n-31) + 1095449\,a(n-32) + 666920\,a(n-33) + 98319\,a(n-34) + 117471\,a(n-35) - 169012\,a(n-36) - 48051\,a(n-37) - 37792\,a(n-38) - 23820\,a(n-39) + 12960\,a(n-40) - 2700\,a(n-41) + 3600\,a(n-42)
\]
for every $n>42$.
\end{theorem}
...
array of width $6$ over $\{0,1,2\}$ with a few rows was written out cell by cell and each cell
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232520.
