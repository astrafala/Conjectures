...
\title{A further conjecture on OEIS A269761,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A269761 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $6, 480, 17520, 524160, 14288400, 368958240, 9195061680, 223482006720,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = 80 * 3\^{}(n-2) * 7\^{}(n-3) * (31*n-20) for n>1.\end{quote}
