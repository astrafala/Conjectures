...
\title{A further conjecture on OEIS A253496,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A253496 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $414, 1377, 3090, 5386, 9679, 20975, 51167, 133311,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = 400*3\^{}(n-3) + 271*2\^{}(n-1) + 1423 for n>6.\end{quote}
