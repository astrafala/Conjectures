...
\title{A further conjecture on OEIS A283508,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A283508 carries more than one conjecture. One of them has a proof; this paper settles a
...
\begin{quote}\raggedright a(n) = (91*10\^{}n - 10) / 90 for n>0.\end{quote}
