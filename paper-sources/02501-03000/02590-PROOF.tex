...
\title{A further conjecture on OEIS A250661,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A250661 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $639, 1150, 1789, 2556, 3451, 4474, 5625, 6904,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = 64*n\^{}2 + 319*n + 256.\end{quote}
