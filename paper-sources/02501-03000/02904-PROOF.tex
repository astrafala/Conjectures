...
\title{The empirical recurrence for OEIS A233199, proved by transfer matrix}
...
\begin{abstract}
OEIS A233199 counts arrays over $\{0,\dots,7\}$ in which no two entries that are neighbours in
a named set of directions may sum to $7$, together with clauses that pick one array out of
...
carried by one bounded piece of extra state, so the count is a walk count on $S=22$ states.
\end{abstract}
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 08:52:22, revision 6) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The array is $5$ cells across with entries $x(i,j)\in\{0,1,\dots,7\}$. Call two values $u,v$ CLASHING
when $u+v=7$ and, the entry saying ``adjacent to itself or'', also when $u=v$. Two cells are neighbours when one is obtained from the other by one of
the offsets
\[
(0,1), (1,-1), (1,0),
\]
...
\[
1\prec 2,\qquad 1\prec 3,\qquad 1\prec 4,\qquad 1\prec 5,\qquad 1\prec 6,\qquad 2\prec 3,\qquad 2\prec 4,\qquad 2\prec 5,\qquad 3\prec 4 ,
\]
...
$2^{6}$ values, and the state of the walk is a pair (array row, set $T$).
...
identified; after that identification there are $S=22$ of them.
...
\begin{theorem}
\[
a(n)\;=\;736\,a(n-1) - 203776\,a(n-2) + 33062912\,a(n-3) - 3665821696\,a(n-4) + 270851375104\,a(n-5) - 10685878632448\,a(n-6) - 116548232544256\,a(n-7) + 35184372088832000\,a(n-8) - 1423137482249076736\,a(n-9) + 18446744073709551616\,a(n-10)
\]
for every $n>11$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A233199.
