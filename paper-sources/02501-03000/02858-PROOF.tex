...
\title{The empirical recurrence for OEIS A208440, proved by transfer matrix}
...
\begin{abstract}
OEIS A208440 counts arrays of width $3$ over $\{0,1,2\}$ in which no cell is the average of its neighbours. The entry carries an
...
$2$ consecutive rows and the count is a walk count on $S=28$ states.
\end{abstract}
...
OEIS A208440 is ``Number of nX3 0..2 arrays with no element equal the average of immediate neighbors vertically above and horizontally left of it.''. It has offset $1$ and begins
\[
12, 134, 1548, 17992, 209542, 2440104, 28421906, 331022604,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:52:13, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-1) + 50\,a(n-2) - 117\,a(n-3) + 429\,a(n-4) - 1094\,a(n-5) + 1139\,a(n-6) - 1687\,a(n-7) + 1036\,a(n-8) - 1068\,a(n-9) + 144\,a(n-10) - 64\,a(n-11) - 128\,a(n-12)
\]
for every $n>12$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208440.
