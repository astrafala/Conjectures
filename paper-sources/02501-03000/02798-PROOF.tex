...
\title{A further conjecture on OEIS A282123,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A282123 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $1, 3, 6, 15, 26, 63, 106, 255,\dots$, with offset $0$. The sequence satisfies
\[
  a(n)=5\,a(n-2) - 4\,a(n-4) ,
\]
...
\begin{quote}\raggedright a(n) = (-5 - (-2)\^{}n + (-1)\^{}n + 11*2\^{}n) / 6.\end{quote}
