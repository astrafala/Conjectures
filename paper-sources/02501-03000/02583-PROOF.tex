...
\title{A further conjecture on OEIS A266873,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A266873 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $1, 2, 21, 42, 341, 682, 5461, 10922,\dots$, with offset $0$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = ((-1)\^{}n + 3*2\^{}(2*n+1) + (-1)\^{}n*2\^{}(2*n+1) - 3)/6.\end{quote}
