...
\title{A further conjecture on OEIS A250609,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A250609 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $502, 1172, 2236, 3890, 6526, 10928, 18664, 32870,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = 196*2\^{}(n-1) + 99*n\^{}2 + 177*n + 30.\end{quote}
