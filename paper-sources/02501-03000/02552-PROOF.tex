...
\title{A further conjecture on OEIS A219847,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A219847 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $6, 17, 65, 225, 669, 1815, 4617, 11125,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (1/39916800)*n\^{}11 + (1/1209600)*n\^{}10 + (1/120960)*n\^{}9 + (1/10080)*n\^{}8 + (1481/1209600)*n\^{}7 + (131/19200)*n\^{}6 + (14807/181440)*n\^{}5 - (49747/120960)*n\^{}4 + (78101/16800)*n\^{}3 - (136007/1\end{quote}
...
indices, and $a$ and $f$ were checked to agree at $n=16,\dots,27$,
