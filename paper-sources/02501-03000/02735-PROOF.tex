...
\title{The empirical recurrence for OEIS A280600, proved by transfer matrix}
...
\begin{abstract}
OEIS A280600 counts $n\times4$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A280600 is ``Number of n X 4 0..1 arrays with no element equal to more than two of its horizontal, vertical and antidiagonal neighbors and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
8, 50, 116, 302, 726, 1709, 3996, 9346,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) - 4*a(n-2) + 2*a(n-5) - 3*a(n-7) + 2*a(n-8) + a(n-9) - a(n-10) for n>13.
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 22 2018 09:47:13, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) - 4\,a(n-2) + 2\,a(n-5) - 3\,a(n-7) + 2\,a(n-8) + a(n-9) - a(n-10)
\]
for every $n>13$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A280600.
