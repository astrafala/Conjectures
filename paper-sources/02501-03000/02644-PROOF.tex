...
\title{A further conjecture on OEIS A290680,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A290680 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $1, 10, 111, 1110, 11111, 111111, 1111111, 11111111,\dots$, with offset $0$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = (10\^{}(1+n) - 1) / 9 for n>3.\end{quote}
