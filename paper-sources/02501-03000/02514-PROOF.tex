...
\title{A further conjecture on OEIS A235890,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A235890 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $4480, 5272, 6952, 10696, 19720, 43912, 116872, 361096,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = 4*(930 + 93*2\^{}n + 4\^{}n).\end{quote}
