...
\title{A further conjecture on OEIS A219349,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A219349 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $3, 3, 8, 15, 27, 46, 76, 122,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (1/24)*n\^{}4 - (1/4)*n\^{}3 + (23/24)*n\^{}2 + (13/4)*n - 8 for n > 3.\end{quote}
