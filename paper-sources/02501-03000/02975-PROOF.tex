...
\title{The empirical recurrence for OEIS A208391, proved by counting patterns}
...
\begin{abstract}
OEIS A208391 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A208391 is ``Number of nX7 0..2 arrays with new values 0..2 introduced in row major order and no element equal to more than two of its immediate leftward or upward or right-upward antidiagonal neighbors.''. It has offset $1$ and begins
\[
365, 667476, 1233536544, 2278687944204, 4209452449879284, 7776176148498498768, 14365030966055594634024, 26536707847376158191040692,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:48:51, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;1899\,a(n-1) - 96485\,a(n-2) + 1863135\,a(n-3) - 19545624\,a(n-4) + 128977488\,a(n-5) - 573780996\,a(n-6) + 1774673712\,a(n-7) - 3625252848\,a(n-8) + 3358392192\,a(n-9) + 1063196928\,a(n-10)
\end{equation}
for all $n>12$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208391.
