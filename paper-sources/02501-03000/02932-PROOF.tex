...
\title{The empirical recurrence for OEIS A239407, proved by transfer matrix}
...
\begin{abstract}
OEIS A239407 counts arrays over $\{0,1,2,3\}$ in which no entry may equal, modulo $4$, a given
...
count is then a walk count on $S=48$ states.
\end{abstract}
...
OEIS A239407 is ``Number of 3Xn 0..3 arrays with no element equal to one plus the sum of elements to its left or two plus the sum of the elements above it, modulo 4.''. It has offset $1$ and begins
\[
12, 129, 1337, 13977, 144762, 1504399, 15591122, 161801518,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 09:27:55, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-1) + 73\,a(n-2) - 446\,a(n-3) - 1413\,a(n-4) + 8070\,a(n-5) + 12185\,a(n-6) - 63420\,a(n-7) - 49358\,a(n-8) + 220534\,a(n-9) + 39486\,a(n-10) - 241802\,a(n-11) + 244780\,a(n-12) - 89648\,a(n-13) - 386680\,a(n-14) - 228008\,a(n-15) + 129984\,a(n-16) - 457816\,a(n-17) - 1064416\,a(n-18) - 330768\,a(n-19) + 556128\,a(n-20) - 351872\,a(n-21) + 769280\,a(n-22) + 407552\,a(n-23) - 200704\,a(n-24) + 32768\,a(n-25)
\]
for every $n>24$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A239407.
