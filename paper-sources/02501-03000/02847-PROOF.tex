...
\title{The empirical recurrence for OEIS A275230, proved by transfer matrix}
...
\begin{abstract}
OEIS A275230 counts arrays in which no entry may equal the entries at a short list of fixed offsets
...
$1$ consecutive columns, $S=53$ states in all.
\end{abstract}
...
OEIS A275230 is ``Number of 5 X n 0..2 arrays with no element equal to any value at offset (-2,-1) (-2,1) or (-1,0) and new values introduced in order 0..2.''. It has offset $1$ and begins
\[
8, 66, 648, 6448, 64248, 640250, 6380362, 63583084,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 11*a(n-1) - 9*a(n-2) - 15*a(n-3) + 20*a(n-4) - 6*a(n-5) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 02 2019 10:51:45, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;11\,a(n-1) - 9\,a(n-2) - 15\,a(n-3) + 20\,a(n-4) - 6\,a(n-5)
\]
for every $n>6$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A275230.
