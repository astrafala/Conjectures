...
\title{The empirical recurrence for OEIS A252859, proved by transfer matrix}
...
\begin{abstract}
OEIS A252859 counts arrays of width $8$ over an alphabet of $3$ letters in which every three
...
brings the state count down to $S=57608$.
\end{abstract}
...
OEIS A252859 is ``Number of (n+2)X(6+2) 0..2 arrays with every consecutive three elements in every row, column, diagonal and antidiagonal having exactly two distinct values, and new values 0 upwards introduced in row major order.''. It has offset $1$ and begins
\[
11286, 4986, 6795, 13590, 28728, 60588, 126306, 266391,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:42:15, revision 6) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The array has width $8$ and entries in $\{0,1,\dots,2\}$. Four families of triples
...
That digraph has up to $i^{2\cdot8}$ vertices, which is more than can be written down for
...
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,
\]
with $S=57608$ states in all. The walk index $j$ and the entry's own $n$ differ by a constant,
...
\begin{theorem}
\[
a(n)\;=\;-a(n-1) + 4\,a(n-3) + 16\,a(n-4) + 16\,a(n-5) + 9\,a(n-6) - 11\,a(n-7) - 58\,a(n-8) - 64\,a(n-9) - 14\,a(n-10) + 79\,a(n-11) + 143\,a(n-12) + 104\,a(n-13) + 13\,a(n-14) - 101\,a(n-15) - 124\,a(n-16) - 74\,a(n-17) + 2\,a(n-18) + 34\,a(n-19) + 28\,a(n-20) + 8\,a(n-21) - 4\,a(n-22) - 4\,a(n-23)
\]
for every $n>26$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252859.
