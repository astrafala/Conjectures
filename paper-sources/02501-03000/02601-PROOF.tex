...
\title{A further conjecture on OEIS A250757,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A250757 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $105, 237, 423, 663, 957, 1305, 1707, 2163,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = 27*n\^{}2 + 51*n + 27.\end{quote}
