...
\title{A further conjecture on OEIS A252999,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A252999 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $0, 0, 0, 1, 34, 279, 1028, 2601,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (160/3)*n\^{}3 - 708*n\^{}2 + (9539/3)*n - 4831 for n>4.\end{quote}
