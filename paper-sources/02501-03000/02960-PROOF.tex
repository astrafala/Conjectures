...
\title{The empirical recurrence for OEIS A275405, proved by transfer matrix}
...
\begin{abstract}
OEIS A275405 counts arrays in which no entry may equal the entries at a short list of fixed offsets
...
$1$ consecutive columns, $S=151$ states in all.
\end{abstract}
...
OEIS A275405 is ``Number of 6Xn 0..2 arrays with no element equal to any value at offset (-2,-1) (-2,0) or (-1,1) and new values introduced in order 0..2.''. It has offset $1$ and begins
\[
24, 129, 1017, 8122, 65045, 518049, 4142271, 33102260,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 26 2016 14:57:18, revision 4) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=151.
\]
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 28\,a(n-2) + 137\,a(n-3) + 222\,a(n-4) - 178\,a(n-5) - 1692\,a(n-6) - 272\,a(n-7) + 217\,a(n-8) + 3612\,a(n-9) - 2256\,a(n-10) + 1680\,a(n-11) - 1648\,a(n-12) + 1472\,a(n-13) - 192\,a(n-14) + 512\,a(n-15) - 256\,a(n-16)
\]
for every $n>17$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A275405.
