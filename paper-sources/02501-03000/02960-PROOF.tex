...
\title{The empirical recurrence for OEIS A206233, proved by transfer matrix}
...
\begin{abstract}
OEIS A206233 counts, up to renaming the letters, the arrays of width $4$ over at most $4$
...
OEIS A206233 is ``Number of (n+1) X 4 0..3 arrays with every 2 X 3 or 3 X 2 subblock having exactly two equal edges, and new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
310, 1136, 4456, 27168, 133392, 607008, 3503136, 17206032,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + 129*a(n-3) - 129*a(n-4) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 14 2018 09:19:33, revision 8) this is still
...
$w_i$ cleared of denominators and $S=8102$ states in all. The walk index $j$ and the entry's own
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206233.
