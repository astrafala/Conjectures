...
\title{The empirical recurrence for OEIS A231243, proved by transfer matrix}
...
\begin{abstract}
OEIS A231243 counts arrays of width $5$ over $\{0,1,2,3\}$ in which every cell must see, among its
...
the count is a walk count on $S=19045$ states.
\end{abstract}
...
OEIS A231243 is ``Number of nX5 0..3 arrays x(i,j) with each element horizontally, diagonally or antidiagonally next to at least one element with value (x(i,j)+1) mod 4, no adjacent elements equal, and upper left element zero.''. It has offset $1$ and begins
\[
0, 146, 3090, 76264, 1872136, 46019438, 1130422470, 27772974680,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 06:19:52, revision 6) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=19045.
\]
...
\begin{theorem}
\[
a(n)\;=\;15\,a(n-1) + 203\,a(n-2) + 785\,a(n-3) + 446\,a(n-4) - 8109\,a(n-5) - 27863\,a(n-6) - 32425\,a(n-7) + 67085\,a(n-8) + 92178\,a(n-9) - 67506\,a(n-10) - 164672\,a(n-11) + 79296\,a(n-12) + 123152\,a(n-13) - 58240\,a(n-14) - 80128\,a(n-15) + 113792\,a(n-16) - 18944\,a(n-17) - 11264\,a(n-18) + 3072\,a(n-19)
\]
for every $n>19$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231243.
