...
\title{A further conjecture on OEIS A219367,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A219367 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $4, 13, 60, 193, 514, 1231, 2748, 5802,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (1/13440)*n\^{}8 + (1/3360)*n\^{}7 + (1/576)*n\^{}6 + (41/240)*n\^{}5 - (9419/5760)*n\^{}4 + (2009/160)*n\^{}3 - (70291/2016)*n\^{}2 + (42649/840)*n - 29 for n>1.\end{quote}
...
indices, and $a$ and $f$ were checked to agree at $n=11,\dots,19$,
