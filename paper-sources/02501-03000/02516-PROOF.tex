...
\title{A further conjecture on OEIS A235892,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A235892 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $67072, 70168, 76456, 89416, 116872, 177928, 324616, 716296,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = 4*(16002 + 381*2\^{}n + 4\^{}n).\end{quote}
