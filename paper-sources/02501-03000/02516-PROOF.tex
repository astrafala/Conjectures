...
\title{The empirical closed form for OEIS A224138, proved}
...
\begin{abstract}
OEIS A224138 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A224138 is ``Number of 7 X n 0..1 arrays with rows nondecreasing and antidiagonals unimodal.''. It has offset $1$ and begins
\[
128, 2187, 9688, 25047, 52581, 101412, 186348, 329167,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 27 2018 08:14:37, revision 9) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{4 n^{7}}{315} + \frac{n^{6}}{5} + \frac{112 n^{5}}{45} + \frac{461 n^{4}}{24} + \frac{19267 n^{3}}{180} + \frac{50171 n^{2}}{120} + \frac{463243 n}{420} - 511.
\]
...
$n=14,\dots,21$ and agree at each. A monic recurrence of order $8$
determines $a(m)$ from $a(m-1),\dots,a(m-8)$, and for every $m\ge22$ both
$m>13$ and $m-8\ge14$ hold, so induction on $m$ gives $a(m)=f(m)$ for every
$m\ge14$.
Below $n=14$ the recurrence argument gives nothing, since \eqref{eq:rec} is only
established for $a$ from $n=14$ on. The remaining indices $n=6,\dots,13$ were
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224138.
