...
\title{A further conjecture on OEIS A277866,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A277866 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $1, 1, 1, 13, 1, 61, 1, 253,\dots$, with offset $0$. The sequence satisfies
\[
  a(n)=5\,a(n-2) - 4\,a(n-4) ,
\]
...
\begin{quote}\raggedright a(n) = (-1-(-2)\^{}n+2*(-1)\^{}n+2\^{}n). (End)\end{quote}
