...
\title{The empirical recurrence for OEIS A269013, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A269013 counts arrays over $\{0,\dots,1\}$ subject to a condition on the array as a
...
OEIS A269013 is ``Number of 3 X n binary arrays with some element plus some horizontally, diagonally or antidiagonally adjacent neighbor totalling two exactly once.''. It has offset $1$ and begins
\[
0, 15, 46, 305, 1078, 4948, 18210, 73277,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 4*a(n-1) + 8*a(n-2) - 34*a(n-3) - 16*a(n-4) + 60*a(n-5) - 25*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 18 2019 09:58:24, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269013.
