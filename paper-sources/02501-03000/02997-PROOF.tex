...
\title{The empirical recurrence for OEIS A208873, proved by transfer matrix}
...
\begin{abstract}
OEIS A208873 counts $2\times n$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A208873 is ``Number of 2 X n 0..3 arrays with new values 0..3 introduced in row major order and no element equal to more than one of its immediate leftward or upward or right-upward antidiagonal neighbors.''. It has offset $1$ and begins
\[
2, 12, 136, 1798, 24472, 334618, 4578580, 62655190,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 18*a(n-1) - 65*a(n-2) + 84*a(n-3) - 36*a(n-4) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 07 2018 08:51:27, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;18\,a(n-1) - 65\,a(n-2) + 84\,a(n-3) - 36\,a(n-4)
\]
for every $n>5$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208873.
