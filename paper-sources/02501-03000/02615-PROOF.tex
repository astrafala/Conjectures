...
\title{A further conjecture on OEIS A253433,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A253433 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $325, 318, 336, 372, 444, 588, 876, 1452,\dots$, with offset $1$. The sequence satisfies
\[
  a(n)=3\,a(n-1) - 2\,a(n-2) ,
\]
...
\begin{quote}\raggedright Empirical: a(n) = 9*2\^{}(n-1) + 300 for n>1.\end{quote}
