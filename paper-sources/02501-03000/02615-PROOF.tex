...
\title{The empirical recurrence for OEIS A231192, proved by transfer matrix}
...
\begin{abstract}
OEIS A231192 counts $(n+1)\times2$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A231192 is ``Number of (n+1) X (1+1) 0..2 arrays with no element equal to a strict majority of its horizontal, vertical and antidiagonal neighbors, with values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
9, 67, 538, 4264, 33868, 268936, 2135636, 16959144,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 8*a(n-1) - 4*a(n-3) + 4*a(n-4) - 12*a(n-5) - 16*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 27 2018 18:16:24, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231192.
