...
\title{A further conjecture on OEIS A283591,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A283591 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $1, 0, 5, 14, 30, 62, 126, 254,\dots$, with offset $0$. The sequence satisfies
\[
  a(n)=3\,a(n-1) - 2\,a(n-2) ,
\]
...
\begin{quote}\raggedright a(n) = 2*(2\^{}n - 1) for n>2.\end{quote}
