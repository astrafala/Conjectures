...
\title{The empirical recurrence for OEIS A270055, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A270055 counts arrays over $\{0,\dots,4\}$ subject to a condition on the array as a
...
which is what keeps the digraph sparse. That makes $a(n)$ a walk count on $S=6250$ vertices,
...
OEIS A270055 is ``Number of nX5 0..4 arrays with some element plus some horizontally or vertically adjacent neighbor totalling four exactly once.''. It has offset $1$ and begins
\[
1280, 1683240, 1248460920, 779206497960, 446901694424400, 243724207420143600, 128543872461556329960, 66197363387248271149080,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 09 2016 07:12:29, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;1084\,a(n-1) - 385060\,a(n-2) + 52207996\,a(n-3) - 3589359662\,a(n-4) + 139769030980\,a(n-5) - 3139297428484\,a(n-6) + 36970790802932\,a(n-7) - 109715789190473\,a(n-8) - 2264908466581072\,a(n-9) + 23041106193014144\,a(n-10) - 28405594469259904\,a(n-11) - 483359700838242304\,a(n-12) + 2011366933590159360\,a(n-13) - 2236659513127833600\,a(n-14)
\end{equation}
for all $n>15$.
...
\[
\mathcal V=\bigl\{(r,c):\ r\in\{0,\dots,4\}^{5},\ c\in\{0,1\}\bigr\},
\qquad |\mathcal V|=S=6250,
\]
...
the digraph dense, with $(4+1)^{2\cdot5}$ edges instead of the sparse set used here.
\end{remark}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A270055.
