...
\title{The empirical recurrence for OEIS A205228, proved by transfer matrix}
...
\begin{abstract}
OEIS A205228 counts arrays of width $2$ over $\{0,1,2\}$ by reducing every $2\times2$ subblock to a
...
about it is one bit per adjacent pair of columns, so the count is a walk count on $S=38$
states.
\end{abstract}
...
OEIS A205228 is ``Number of (n+1) X 2 0..2 arrays with rows and columns of permanents of all 2 X 2 subblocks lexicographically nondecreasing, and all 2 X 2 permanents nonzero.''. It has offset $1$ and begins
\[
56, 266, 1187, 4584, 17010, 58892, 198325, 642908,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 27 2023 15:05:27, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) + 8\,a(n-2) - 69\,a(n-3) + 389\,a(n-5) - 198\,a(n-6) - 1143\,a(n-7) + 865\,a(n-8) + 1830\,a(n-9) - 1686\,a(n-10) - 1468\,a(n-11) + 1612\,a(n-12) + 376\,a(n-13) - 616\,a(n-14) + 96\,a(n-15)
\]
for every $n>15$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A205228.
