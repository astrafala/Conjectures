...
\title{The empirical recurrence for OEIS A198639, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A198639 counts arrays in which every cell is constrained by its neighbours on \emph{both}
...
order $10$, contributed by R.~H.~Hardin, then follows from a finite exact computation.
\end{abstract}
...
OEIS A198639 is ``Number of 2n X 4 0..2 arrays with values 0..2 introduced in row major order and each element equal to an even number of horizontal and vertical neighbors.''. It has offset $1$ and begins
\[
36, 2436, 162776, 10937316, 734979136, 49393306556, 3319433387656, 223079838087956,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 19 2025 22:33:19, revision 7) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;78\,a(n-1) - 569\,a(n-2) - 11744\,a(n-3) + 71840\,a(n-4) + 745984\,a(n-5) - 2507008\,a(n-6) - 18538496\,a(n-7) + 36110336\,a(n-8) + 142606336\,a(n-9) - 268435456\,a(n-10)
\end{equation}
for all $n>10$.
...
equal to x_{t,u}\bigr\}\ \ \text{is even}
\end{equation}
for every cell $(t,u)$.
...
index,
\[
3!\Bigl(a(n)-\sum_i c_i\,a(n-i)\Bigr)\;=\;\mathbf{v}^{\!\top}G^{\,j-10}\,
\Bigl(h_{10}-\sum_i c_i h_{10-i}\Bigr)
\]
...
$w=h_{10}-\sum_i c_ih_{10-i}$; and it is enough to check $m=0,1,\dots,S-1$.
\end{lemma}
...
\eqref{eq:walk2}, divided by $3!$, was evaluated at every one of the $13$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A198639.
