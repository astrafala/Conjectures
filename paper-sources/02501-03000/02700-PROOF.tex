...
\title{The empirical closed form for OEIS A208285, proved}
...
\begin{abstract}
OEIS A208285 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A208285 is ``Number of n X 6 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 0 1 and 1 1 0 vertically.''. It has offset $1$ and begins
\[
26, 676, 4374, 16872, 49130, 119580, 256774, 502416,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (8/15)*n\^{}6 + (23/3)*n\^{}5 + (82/3)*n\^{}4 + (1/3)*n\^{}3 - (178/15)*n\^{}2 + 2*n.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 29 2018 15:24:05, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{8 n^{6}}{15} + \frac{23 n^{5}}{3} + \frac{82 n^{4}}{3} + \frac{n^{3}}{3} - \frac{178 n^{2}}{15} + 2 n.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208285.
