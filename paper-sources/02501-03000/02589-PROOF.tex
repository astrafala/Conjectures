...
\title{A further conjecture on OEIS A240333,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A240333 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $4, 15, 48, 125, 284, 582, 1097, 1932,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (1/30)*n\^{}5 + (1/24)*n\^{}4 + (23/12)*n\^{}3 - (193/24)*n\^{}2 + (581/20)*n - 30 for n>2.\end{quote}
...
indices, and $a$ and $f$ were checked to agree at $n=9,\dots,14$,
