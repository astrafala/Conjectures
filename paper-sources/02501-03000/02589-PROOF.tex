...
\title{A further conjecture on OEIS A267045,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A267045 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $1, 2, 4, 8, 17, 34, 69, 138,\dots$, with offset $0$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = (2*(-1)\^{}n+13*2\^{}n-6)/12 for n>1.\end{quote}
