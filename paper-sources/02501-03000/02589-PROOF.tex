...
\title{A further conjecture on OEIS A243513,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A243513 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $3, 5, 10, 24, 65, 187, 552, 1646,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = (7 + 3\^{}n + 2*n) / 4.\end{quote}
