...
\title{A further conjecture on OEIS A282122,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A282122 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $1, 11, 11, 1111, 1011, 111111, 101011, 11111111,\dots$, with offset $0$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = (39 + 50*(-1)\^{}n + 3*2\^{}(2+n)*5\^{}(1+n) - (-1)\^{}n*2\^{}(1+n)*5\^{}(2+n)) / 99.\end{quote}
