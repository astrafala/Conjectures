...
\title{A further conjecture on OEIS A253430,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A253430 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $69, 70, 85, 121, 193, 337, 625, 1201,\dots$, with offset $1$. The sequence satisfies
\[
  a(n)=3\,a(n-1) - 2\,a(n-2) ,
\]
...
\begin{quote}\raggedright Empirical: a(n) = 9*2\^{}(n-1) + 49 for n>2.\end{quote}
