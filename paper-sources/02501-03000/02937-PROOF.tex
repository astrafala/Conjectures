...
\title{The empirical recurrence for OEIS A224155, proved by transfer matrix}
...
\begin{abstract}
OEIS A224155 counts arrays over $\{0,\dots,1\}$ whose rows, columns, diagonals or
antidiagonals are required to be monotone or unimodal, and carries an empirical recurrence of
order $20$ contributed by R.~H.~Hardin. A monotone condition is local, but a unimodal one
...
OEIS A224155 is ``Number of nX5 0..1 arrays with diagonals and rows unimodal and antidiagonals nondecreasing.''. It has offset $1$ and begins
\[
16, 101, 373, 1156, 3469, 10562, 32910, 105020,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 23:16:55, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) - 9\,a(n-2) - a(n-3) + a(n-4) + 23\,a(n-5) - 38\,a(n-6) + 42\,a(n-7) - 41\,a(n-8) + 89\,a(n-9) - 67\,a(n-10) - 9\,a(n-11) + 5\,a(n-12) - 32\,a(n-13) - 50\,a(n-14) - 12\,a(n-15) - 58\,a(n-16) - 28\,a(n-17) + 12\,a(n-18) + 4\,a(n-20)
\end{equation}
for all $n>22$.
...
$h_j=G^{j}N^{o}\mathbf{1}$, we have for $j\ge20$
\[
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224155.
