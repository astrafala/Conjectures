...
\title{The empirical recurrence for OEIS A279378, proved by transfer matrix}
...
\begin{abstract}
OEIS A279378 counts $n\times2$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A279378 is ``Number of n X 2 0..1 arrays with no element equal to a strict majority of its horizontal, vertical and antidiagonal neighbors, with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
1, 3, 8, 22, 61, 170, 472, 1310,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + a(n-2) + 2*a(n-3) + 3*a(n-4) + a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 10 2019 12:38:39, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A279378.
