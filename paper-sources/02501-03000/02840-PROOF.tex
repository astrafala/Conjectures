...
\title{The empirical recurrence for OEIS A199642, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A199642 counts arrays in which every cell is constrained by its neighbours on \emph{both}
...
lumpable, cutting $794$ pairs down to $S=155$ states. The entry's empirical recurrence of
...
OEIS A199642 is ``Number of nX3 0..2 arrays with values 0..2 introduced in row major order and each element equal to one or two horizontal and vertical neighbors.''. It has offset $1$ and begins
\[
1, 13, 112, 1265, 12748, 134748, 1396083, 14584050,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 08:16:27, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;7\,a(n-1) + 41\,a(n-2) - 44\,a(n-3) - 111\,a(n-4) - 140\,a(n-5) + 291\,a(n-6) - 225\,a(n-7) + 511\,a(n-8) + 2150\,a(n-9) - 3007\,a(n-10) - 6248\,a(n-11) - 624\,a(n-12) + 19900\,a(n-13) - 14308\,a(n-14) + 15248\,a(n-15) - 13312\,a(n-16) - 1648\,a(n-17) + 21440\,a(n-18) - 5632\,a(n-19) - 3968\,a(n-20) + 5632\,a(n-21) - 14336\,a(n-22) - 8192\,a(n-23)
\end{equation}
for all $n>24$.
...
index,
\[
3!\Bigl(a(n)-\sum_i c_i\,a(n-i)\Bigr)\;=\;\mathbf{v}^{\!\top}G^{\,j-23}\,
...
index corresponding to $n=24+1$ onwards, and the run was continued until $S+1$
...
\eqref{eq:walk2}, divided by $3!$, was evaluated at every one of the $18$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A199642.
