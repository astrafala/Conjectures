...
\title{The empirical recurrence for OEIS A232518, proved by transfer matrix}
...
\begin{abstract}
OEIS A232518 counts arrays of width $4$ over $\{0,1,2\}$ in which every cell sees its own value plus and minus one among its neighbours. The entry carries an
...
OEIS A232518 is ``Number of (3+1)X(n+1) 0..2 arrays with every element next to itself plus and minus one within the range 0..2 horizontally, diagonally or antidiagonally, with no adjacent elements equal.''. It has offset $1$ and begins
\[
8, 200, 128, 2516, 1730, 32084, 24388, 408486,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 12*a(n-2) +a(n-3) +11*a(n-4) +a(n-5) -30*a(n-6) -22*a(n-7) +8*a(n-8) +8*a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 07:28:51, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;12\,a(n-2) + a(n-3) + 11\,a(n-4) + a(n-5) - 30\,a(n-6) - 22\,a(n-7) + 8\,a(n-8) + 8\,a(n-9)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232518.
