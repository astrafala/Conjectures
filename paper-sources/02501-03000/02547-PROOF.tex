...
\title{A further conjecture on OEIS A219803,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A219803 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $4, 4, 10, 21, 39, 68, 114, 186,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (1/120)*n\^{}5 - (1/8)*n\^{}4 + (29/24)*n\^{}3 - (35/8)*n\^{}2 + (737/60)*n - 12 for n>2.\end{quote}
