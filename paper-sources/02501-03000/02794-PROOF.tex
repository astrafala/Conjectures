...
\title{The empirical recurrence for OEIS A223207, proved by transfer matrix}
...
\begin{abstract}
OEIS A223207 counts the ways of writing the vertices of a fixed graph $G$ into an array of width
...
OEIS A223207 is ``Rolling icosahedron face footprints: number of nX6 0..19 arrays starting with 0 where 0..19 label faces of an icosahedron and every array movement to a horizontal or vertical neighbor moves across an icosahedral edge.''. It has offset $1$ and begins
\[
243, 9375, 443451, 22163655, 1127761923, 57728430255, 2960941376139, 151970441720919,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 21:21:09, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223207.
