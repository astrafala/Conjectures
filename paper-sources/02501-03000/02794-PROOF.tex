...
\title{A further conjecture on OEIS A283351,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A283351 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $1, 1, 1, 111, 111, 11111, 11111, 1111111,\dots$, with offset $0$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = (-20 - 9*(-10)\^{}n + 11*10\^{}n) / 180 for n>0.\end{quote}
