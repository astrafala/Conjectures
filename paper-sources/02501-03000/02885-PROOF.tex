...
\title{The empirical recurrence for OEIS A268795, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A268795 counts arrays over $\{0,\dots,2\}$ subject to a condition on the array as a
...
OEIS A268795 is ``Number of nX5 0..2 arrays with some element plus some horizontally, vertically or antidiagonally adjacent neighbor totalling two exactly once.''. It has offset $1$ and begins
\[
96, 652, 3384, 23994, 168740, 1158904, 7801688, 51781418,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 13 2016 13:43:15, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 41\,a(n-2) + 54\,a(n-3) - 509\,a(n-4) - 2182\,a(n-5) - 2830\,a(n-6) + 1766\,a(n-7) + 7914\,a(n-8) + 2584\,a(n-9) - 10583\,a(n-10) - 6092\,a(n-11) + 11506\,a(n-12) + 5348\,a(n-13) - 11688\,a(n-14) - 620\,a(n-15) + 9251\,a(n-16) - 4462\,a(n-17) - 3137\,a(n-18) + 4774\,a(n-19) - 2365\,a(n-20) + 338\,a(n-21) + 198\,a(n-22) - 106\,a(n-23) + 12\,a(n-24) + 4\,a(n-25) - a(n-26)
\end{equation}
for all $n>29$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268795.
