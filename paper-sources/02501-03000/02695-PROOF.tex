...
\title{The empirical recurrence for OEIS A274892, proved by counting patterns}
...
\begin{abstract}
OEIS A274892 counts arrays in which no entry may repeat a value found at any of three stated
...
OEIS A274892 is ``Number of n X 5 0..2 arrays with no element equal to any value at offset (0,-1) (-1,-1) or (-2,0) and new values introduced in order 0..2.''. It has offset $1$ and begins
\[
8, 108, 86, 290, 913, 3017, 9863, 32539,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 21 2021 12:53:43, revision 6) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A274892.
