...
\title{A further conjecture on OEIS A238806,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A238806 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $3, 8, 15, 25, 39, 58, 83, 115,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (1/6)*n\^{}3 + (23/6)*n - 1.\end{quote}
