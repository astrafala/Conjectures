...
\title{A further conjecture on OEIS A266984,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A266984 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $1, 1, 24, 31, 384, 511, 6144, 8191,\dots$, with offset $0$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = ((-4)\^{}n+(-1)\^{}n-1)/2+4\^{}n for n>0.\end{quote}
