...
\title{A further conjecture on OEIS A250660,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A250660 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $319, 574, 893, 1276, 1723, 2234, 2809, 3448,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = 32*n\^{}2 + 159*n + 128.\end{quote}
