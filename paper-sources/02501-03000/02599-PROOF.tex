...
\title{A further conjecture on OEIS A250858,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A250858 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $233683, 1280447, 4648157, 13263136, 32201019, 69543783, 137379337, 252943672,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = 198*n\^{}6 + (35807/12)*n\^{}5 + (204911/12)*n\^{}4 + (214827/4)*n\^{}3 + (998209/12)*n\^{}2 + (180451/3)*n + 16384.\end{quote}
