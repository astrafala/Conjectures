...
\title{A further conjecture on OEIS A219293,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A219293 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $3, 7, 17, 35, 62, 103, 165, 257,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (1/12)*n\^{}4 - (2/3)*n\^{}3 + (53/12)*n\^{}2 - (17/6)*n - 3 for n > 2.\end{quote}
