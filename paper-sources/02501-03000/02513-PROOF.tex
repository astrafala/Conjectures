...
\title{A further conjecture on OEIS A235889,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A235889 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $1216, 1624, 2536, 4744, 10696, 28744, 89416, 309064,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = 4*(210 + 45*2\^{}n + 4\^{}n).\end{quote}
