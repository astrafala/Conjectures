...
\title{A further conjecture on OEIS A267353,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A267353 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $1, 3, 6, 12, 15, 25, 28, 42,\dots$, with offset $0$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = (n\^{}2+(4-(-1)\^{}n)*n+(-1)\^{}n+1)/2.\end{quote}
