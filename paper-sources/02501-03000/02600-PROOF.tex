...
\title{A further conjecture on OEIS A252935,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A252935 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $15, 83, 494, 3067, 17962, 86488, 320270, 917811,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (133120/3)*n\^{}3 - 760496*n\^{}2 + (13526246/3)*n - 9199709 for n>8.\end{quote}
...
indices, and $a$ and $f$ were checked to agree at $n=13,\dots,16$,
