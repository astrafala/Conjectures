...
\title{A further conjecture on OEIS A250815,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A250815 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $432, 1315, 3081, 6171, 11116, 18537, 29145, 43741,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (15/4)*n\^{}4 + 36*n\^{}3 + (527/4)*n\^{}2 + (359/2)*n + 81.\end{quote}
