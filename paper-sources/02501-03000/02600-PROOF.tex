...
\title{A further conjecture on OEIS A250659,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A250659 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $159, 286, 445, 636, 859, 1114, 1401, 1720,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = 16*n\^{}2 + 79*n + 64.\end{quote}
