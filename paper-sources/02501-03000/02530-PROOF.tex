...
\title{A further conjecture on OEIS A208376,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A208376 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $16, 256, 704, 1344, 2176, 3200, 4416, 5824,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = 96*n\^{}2 - 32*n - 64 for n>1.\end{quote}
