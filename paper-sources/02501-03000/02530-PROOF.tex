...
\title{A further conjecture on OEIS A219579,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A219579 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $4, 13, 51, 132, 277, 514, 881, 1429,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (1/40)*n\^{}5 - (5/24)*n\^{}4 + (79/24)*n\^{}3 - (91/24)*n\^{}2 + (161/60)*n - 1 for n>1.\end{quote}
...
indices, and $a$ and $f$ were checked to agree at $n=8,\dots,13$,
