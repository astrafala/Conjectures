...
\title{A further conjecture on OEIS A265225,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A265225 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $1, 4, 6, 12, 15, 24, 28, 40,\dots$, with offset $0$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = (n+1)*(2*n -(-1)\^{}n +5)/4.\end{quote}
