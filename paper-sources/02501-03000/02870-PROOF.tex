...
\title{The empirical recurrence for OEIS A269763, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A269763 counts arrays over $\{0,\dots,5\}$ subject to a condition on the array as a
...
OEIS A269763 is ``Number of n X 4 0..5 arrays with some element plus some horizontally or vertically adjacent neighbor totalling five exactly once.''. It has offset $1$ and begins
\[
450, 524160, 326697720, 170119348800, 81208264293720, 36821411380183680, 16136599337765506680, 6902518041829140001920,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 798*a(n-1) -180699*a(n-2) +8707236*a(n-3) -167225067*a(n-4) +1392360966*a(n-5) -4194764289*a(n-6) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 24 2026 10:22:15, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;798\,a(n-1) - 180699\,a(n-2) + 8707236\,a(n-3) - 167225067\,a(n-4) + 1392360966\,a(n-5) - 4194764289\,a(n-6)
\end{equation}
for all $n>7$.
...
those integers vanishes from the index corresponding to $n=7+1$ onwards, and the run
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269763.
