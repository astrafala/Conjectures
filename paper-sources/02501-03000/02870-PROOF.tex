...
\title{The empirical recurrence for OEIS A206755, proved by transfer matrix}
...
\begin{abstract}
OEIS A206755 counts, up to renaming the letters, the arrays of width $3$ over at most $3$
letters in which every $2\times3$ and $3\times2$ subblock has at most $3$ equal edges, an edge of such a window being one of the six steps of its perimeter cycle and an equal edge one whose two cells agree. It carries an empirical recurrence of order $10$ contributed by
...
OEIS A206755 is ``Number of (n+1)X3 0..2 arrays with every 2X3 or 3X2 subblock having no more than three equal edges, and new values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
106, 2187, 46860, 1002015, 21403411, 457325164, 9771502433, 208781853511,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 13:07:43, revision 9) this is still
...
$w_i$ cleared of denominators and $S=668$ states in all. The walk index $j$ and the entry's own
...
\begin{theorem}
\[
a(n)\;=\;16\,a(n-1) + 86\,a(n-2) + 577\,a(n-3) + 694\,a(n-4) + 1376\,a(n-5) - 823\,a(n-6) + 136\,a(n-7) - 2266\,a(n-8) - 461\,a(n-9) - 1230\,a(n-10)
\]
for every $n>10$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206755.
