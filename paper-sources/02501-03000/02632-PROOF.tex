...
\title{The empirical closed form for OEIS A207110, proved}
...
\begin{abstract}
OEIS A207110 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
$S=625$ vertices. Any function of the form $\sum_j p_j(n)\lambda_j^{\,n}$ satisfies the
...
OEIS A207110 is ``Number of n X 7 0..1 arrays avoiding 0 0 0 and 0 1 1 horizontally and 0 0 1 and 1 1 0 vertically.''. It has offset $1$ and begins
\[
25, 625, 3399, 11511, 30415, 68737, 139341, 260597,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (1/280)*n\^{}7 + (7/45)*n\^{}6 + (47/15)*n\^{}5 + (206/9)*n\^{}4 + (4111/120)*n\^{}3 - (1037/45)*n\^{}2 - (4493/210)*n + 9.
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 22 2025 20:01:44, revision 11) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{n^{7}}{280} + \frac{7 n^{6}}{45} + \frac{47 n^{5}}{15} + \frac{206 n^{4}}{9} + \frac{4111 n^{3}}{120} - \frac{1037 n^{2}}{45} - \frac{4493 n}{210} + 9.
\]
...
walk, so with $M$ the adjacency matrix of that digraph on $S=625$ vertices, and $u,w$ the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207110.
