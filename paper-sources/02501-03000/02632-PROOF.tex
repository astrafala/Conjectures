...
\title{A further conjecture on OEIS A269895,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A269895 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $0, 7, 84, 756, 6048, 45360, 326592, 2286144,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = 7*6\^{}(n-2)*(n-1).\end{quote}
