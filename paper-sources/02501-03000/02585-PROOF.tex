...
\title{A further conjecture on OEIS A239844,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A239844 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $3, 8, 17, 35, 64, 109, 176, 272,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (1/24)*n\^{}4 + (1/12)*n\^{}3 + (11/24)*n\^{}2 + (53/12)*n - 6 for n>2.\end{quote}
