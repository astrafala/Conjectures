...
\title{A further conjecture on OEIS A240002,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A240002 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $12, 61, 190, 526, 1262, 2766, 5647, 10878,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (1/40320)*n\^{}8 + (1/2016)*n\^{}7 + (7/576)*n\^{}6 + (17/360)*n\^{}5 + (6367/5760)*n\^{}4 - (935/288)*n\^{}3 + (28145/672)*n\^{}2 - (114913/840)*n + 237 for n>6.\end{quote}
