...
\title{A further conjecture on OEIS A284352,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A284352 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $1, 10, 111, 1011, 11111, 101111, 1111111, 10111111,\dots$, with offset $0$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = (-20 + 9*(-10)\^{}n + 191*10\^{}n)/180.\end{quote}
