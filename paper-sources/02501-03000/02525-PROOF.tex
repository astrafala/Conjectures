...
\title{A further conjecture on OEIS A219514,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A219514 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $3, 4, 11, 22, 42, 74, 124, 199,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (1/24)*n\^{}4 + (1/12)*n\^{}3 - (37/24)*n\^{}2 + (161/12)*n - 23 for n>3.\end{quote}
