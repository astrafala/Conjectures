...
\title{A further conjecture on OEIS A251136,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A251136 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $10033, 19548, 30770, 51679, 82431, 135959, 223663, 380641,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = (68472 + 6724*(-1)\^{}n + 1369*2\^{}(3+n) + 34882*n + 8827*n\^{}2 + 1130*n\^{}3 + 65*n\^{}4) / 12 for n>3.\end{quote}
