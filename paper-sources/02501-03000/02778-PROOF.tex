...
\title{The conjectured generating function for OEIS A238807, proved}
...
\begin{abstract}
OEIS A238807 counts arrays of a fixed width under a local condition, and carries a conjectured
...
coefficients of their expansions do. Comparing $45$ coefficients in exact arithmetic
...
OEIS A238807 is ``Number of n X 3 0..2 arrays with no element equal to one plus the sum of elements to its left or one plus the sum of the sum of elements above it, modulo 3.''. It has offset $1$ and begins
\[
4, 15, 48, 118, 254, 498,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 24 2018 08:57:04, revision 7) this is still
...
\begin{proof}
Write the conjecture as $N_2/D_2$ with $\deg N_2=9$ and $\deg D_2=7$; its expansion as a
...
exact integer arithmetic, those of $N_2/D_2$ by exact rational long division, and $45$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A238807.
