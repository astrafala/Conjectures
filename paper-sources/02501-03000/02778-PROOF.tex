...
\title{The empirical recurrence for OEIS A214161, proved by transfer matrix}
...
\begin{abstract}
OEIS A214161 counts the proper colourings of a grid $n\times4$, wrapped in the direction of width $4$, with at most $6$ colours and
...
down to $S=16$ and makes the exact residual test affordable.
\end{abstract}
...
OEIS A214161 is ``Number of 0..5 colorings of an nX4 array circular in the 4 direction with new values 0..5 introduced in row major order.''. It has offset $1$ and begins
\[
4, 337, 88261, 27240856, 8548472292, 2687052137887, 844765198701963, 265584804041291390,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 370*a(n-1) -18411*a(n-2) +297448*a(n-3) -1839799*a(n-4) +4424682*a(n-5) -4113757*a(n-6) +1249468*a(n-7)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 16:54:18, revision 8) this is still
...
\]
There are $(i-1)^{4}+(-1)^{4}(i-1)$ such colourings, which at $i=6$ is already more
...
state count is $S=16$ rather than the number of colourings.
...
\begin{theorem}
\[
a(n)\;=\;370\,a(n-1) - 18411\,a(n-2) + 297448\,a(n-3) - 1839799\,a(n-4) + 4424682\,a(n-5) - 4113757\,a(n-6) + 1249468\,a(n-7)
\]
for every $n>7$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A214161.
