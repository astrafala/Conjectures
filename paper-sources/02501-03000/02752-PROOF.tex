...
\title{The empirical recurrence for OEIS A240194, proved by transfer matrix}
...
\begin{abstract}
OEIS A240194 counts arrays over $\{0,1,2,3\}$ in which no entry may equal, modulo $4$, a given
constant plus the SUM of all the entries lying before it along one of several rays. The entry
carries an empirical recurrence of order $29$ contributed by R.~H.~Hardin. It is true, and
...
count is then a walk count on $S=230$ states.
\end{abstract}
...
OEIS A240194 is ``Number of 4 X n 0..3 arrays with no element equal to zero plus the sum of elements to its left or one plus the sum of the elements above it or three plus the sum of the elements diagonally to its northwest, modulo 4.''. It has offset $1$ and begins
\[
4, 27, 138, 771, 5240, 40765, 336257, 2843914,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 26 2025 03:51:12, revision 11) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The array has $4$ cells across one way, entries $x(i,j)\in\{0,1,2,3\}$, and the entry names these
...
\text{northwest} & (i-1,j-1),(i-2,j-2),\dots & 3 \\
\end{array}
\]
...
\begin{theorem}
\[
a(n)\;=\;27\,a(n-1) - 294\,a(n-2) + 1660\,a(n-3) - 4909\,a(n-4) + 4008\,a(n-5) + 28110\,a(n-6) - 141830\,a(n-7) + 316164\,a(n-8) - 141103\,a(n-9) - 1161198\,a(n-10) + 2896480\,a(n-11) - 1515959\,a(n-12) - 3659154\,a(n-13) + 5143300\,a(n-14) - 13602\,a(n-15) - 280443\,a(n-16) - 7998970\,a(n-17) + 9853042\,a(n-18) + 2165540\,a(n-19) - 18119292\,a(n-20) + 21393552\,a(n-21) - 1551144\,a(n-22) - 20485792\,a(n-23) + 14878784\,a(n-24) + 4182464\,a(n-25) - 7981312\,a(n-26) + 1462784\,a(n-27) + 1097728\,a(n-28) - 368640\,a(n-29)
\]
for every $n>34$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A240194.
