...
\title{The empirical closed form for OEIS A223775, proved}
...
\begin{abstract}
OEIS A223775 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A223775 is ``Number of n X 6 0..1 arrays with rows and columns unimodal and antidiagonals nondecreasing.''. It has offset $1$ and begins
\[
22, 169, 707, 2164, 5573, 12975, 28346, 59231,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 22:24:43, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{n^{12}}{479001600} + \frac{n^{11}}{26611200} + \frac{11 n^{10}}{8709120} + \frac{n^{9}}{53760} + \frac{6271 n^{8}}{14515200} + \frac{493 n^{7}}{115200} + \frac{320657 n^{6}}{8709120} + \frac{157151 n^{5}}{483840} + \frac{41441549 n^{4}}{10886400} - \frac{451279 n^{3}}{67200} + \frac{49282619 n^{2}}{332640} - \frac{20927 n}{44} + 563.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223775.
