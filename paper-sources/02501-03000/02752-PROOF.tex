...
\title{The empirical closed form for OEIS A207109, proved}
...
\begin{abstract}
OEIS A207109 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
$S=324$ vertices. Any function of the form $\sum_j p_j(n)\lambda_j^{\,n}$ satisfies the
...
OEIS A207109 is ``Number of n X 6 0..1 arrays avoiding 0 0 0 and 0 1 1 horizontally and 0 0 1 and 1 1 0 vertically.''. It has offset $1$ and begins
\[
18, 324, 1504, 4534, 10898, 22714, 42874, 75198,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (7/360)*n\^{}6 + (77/120)*n\^{}5 + (635/72)*n\^{}4 + (623/24)*n\^{}3 - (511/180)*n\^{}2 - (103/5)*n + 6.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 19 2018 03:32:51, revision 9) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{7 n^{6}}{360} + \frac{77 n^{5}}{120} + \frac{635 n^{4}}{72} + \frac{623 n^{3}}{24} - \frac{511 n^{2}}{180} - \frac{103 n}{5} + 6.
\]
...
walk, so with $M$ the adjacency matrix of that digraph on $S=324$ vertices, and $u,w$ the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207109.
