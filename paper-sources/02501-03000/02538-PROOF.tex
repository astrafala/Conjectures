...
\title{A further conjecture on OEIS A219687,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A219687 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $6, 9, 31, 87, 208, 452, 922, 1799,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (1/181440)*n\^{}9 - (1/4032)*n\^{}8 + (31/4320)*n\^{}7 - (37/288)*n\^{}6 + (14137/8640)*n\^{}5 - (7859/576)*n\^{}4 + (3420947/45360)*n\^{}3 - (240133/1008)*n\^{}2 + (63709/180)*n - 79 for n>6.\end{quote}
