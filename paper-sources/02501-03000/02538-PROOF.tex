...
\title{A further conjecture on OEIS A266221,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A266221 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $1, 3, 3, 10, 10, 21, 21, 36,\dots$, with offset $0$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = 1/2*(n+1)*(n-(-1)\^{}n+1).\end{quote}
