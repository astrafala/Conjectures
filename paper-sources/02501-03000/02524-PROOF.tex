...
\title{A further conjecture on OEIS A219501,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A219501 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $7, 13, 45, 126, 281, 550, 995, 1703,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (1/720)*n\^{}6 + (1/240)*n\^{}5 + (23/144)*n\^{}4 + (13/16)*n\^{}3 + (331/180)*n\^{}2 + (311/60)*n - 27 for n>3.\end{quote}
