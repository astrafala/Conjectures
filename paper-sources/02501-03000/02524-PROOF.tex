...
\title{A further conjecture on OEIS A251135,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A251135 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $4699, 9786, 15830, 27738, 46023, 79226, 135959, 240780,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = (9*(3271+441*(-1)\^{}n+441*2\^{}(1+n)) + 15178*n + 4111*n\^{}2 + 578*n\^{}3 + 35*n\^{}4) / 12 for n>3.\end{quote}
