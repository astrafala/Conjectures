...
\title{The empirical recurrence for OEIS A253038, proved by transfer matrix}
...
\begin{abstract}
OEIS A253038 counts arrays of width $4$ over an alphabet of $4$ letters in which every three
...
brings the state count down to $S=585$.
\end{abstract}
...
OEIS A253038 is ``Number of (n+2)X(2+2) 0..3 arrays with every consecutive three elements in every row, column, diagonal and antidiagonal having exactly two distinct values, and new values 0 upwards introduced in row major order.''. It has offset $1$ and begins
\[
341, 540, 998, 1866, 3894, 8340, 18180, 40264,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:52:56, revision 6) this is still
...
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,
\]
with $S=585$ states in all. The walk index $j$ and the entry's own $n$ differ by a constant,
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 4\,a(n-2) + 15\,a(n-4) - 88\,a(n-5) - 107\,a(n-6) + 69\,a(n-7) + 208\,a(n-8) + 1570\,a(n-9) + 623\,a(n-10) - 2575\,a(n-11) - 6085\,a(n-12) - 12938\,a(n-13) + 8665\,a(n-14) + 33677\,a(n-15) + 47606\,a(n-16) + 37948\,a(n-17) - 135552\,a(n-18) - 192203\,a(n-19) - 136886\,a(n-20) + 93850\,a(n-21) + 716500\,a(n-22) + 430864\,a(n-23) - 588\,a(n-24) - 841362\,a(n-25) - 1722932\,a(n-26) + 53076\,a(n-27) + 397976\,a(n-28) + 1827456\,a(n-29) + 2007160\,a(n-30) - 1043680\,a(n-31) + 865480\,a(n-32) - 2408520\,a(n-33) - 2494080\,a(n-34) - 707600\,a(n-35) - 2686832\,a(n-36) + 6166048\,a(n-37) + 4181856\,a(n-38) + 1880160\,a(n-39) - 1085312\,a(n-40) - 10104640\,a(n-41) - 313024\,a(n-42) + 1998208\,a(n-43) + 3442688\,a(n-44) + 3872256\,a(n-45) - 4363008\,a(n-46) - 91648\,a(n-47) + 326656\,a(n-48) + 128000\,a(n-49) + 844800\,a(n-50) - 2213888\,a(n-51) + 593920\,a(n-52) + 1159168\,a(n-53) - 520192\,a(n-54) - 16384\,a(n-55) - 32768\,a(n-56) + 16384\,a(n-57)
\]
for every $n>61$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253038.
