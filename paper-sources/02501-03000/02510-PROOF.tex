...
\title{A further conjecture on OEIS A235886,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A235886 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $40, 112, 352, 1216, 4480, 17152, 67072, 265216,\dots$, with offset $1$. The sequence satisfies
\[
  a(n)=6\,a(n-1) - 8\,a(n-2) ,
\]
...
\begin{quote}\raggedright a(n) = 2\^{}(2+n) * (3+2\^{}n).\end{quote}
