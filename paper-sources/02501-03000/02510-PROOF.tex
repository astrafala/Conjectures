...
\title{The empirical closed form for OEIS A223842, proved}
...
\begin{abstract}
OEIS A223842 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
$S=1835008$ vertices. Any function of the form $\sum_j p_j(n)\lambda_j^{\,n}$ satisfies the
...
OEIS A223842 is ``Number of 6 X n 0..1 arrays with rows, diagonals and antidiagonals unimodal and columns nondecreasing.''. It has offset $1$ and begins
\[
7, 49, 232, 824, 2388, 5992, 13582, 28642,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 18 2025 17:04:14, revision 9) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{n^{12}}{479001600} - \frac{n^{11}}{15966720} + \frac{13 n^{10}}{6220800} - \frac{n^{9}}{53760} + \frac{6631 n^{8}}{14515200} + \frac{125 n^{7}}{96768} - \frac{1017767 n^{6}}{43545600} + \frac{1429367 n^{5}}{1451520} - \frac{7479853 n^{4}}{1555200} + \frac{4300223 n^{3}}{120960} - \frac{151629803 n^{2}}{1663200} - \frac{12136 n}{231} + 528.
\]
...
walk, so with $M$ the adjacency matrix of that digraph on $S=1835008$ vertices, and $u,w$ the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223842.
