...
\title{A further conjecture on OEIS A207596,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A207596 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $15, 225, 825, 1995, 3915, 6765, 10725, 15975,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = 30*n\^{}3 + 15*n\^{}2 - 45*n + 15.\end{quote}
