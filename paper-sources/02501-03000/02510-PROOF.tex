...
\title{A further conjecture on OEIS A219211,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A219211 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $3, 3, 7, 12, 21, 35, 57, 91,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (1/24)*n\^{}4 - (5/12)*n\^{}3 + (59/24)*n\^{}2 - (37/12)*n + 1 for n>3.\end{quote}
