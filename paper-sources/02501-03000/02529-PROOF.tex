...
\title{A further conjecture on OEIS A219572,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A219572 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $4, 13, 59, 181, 469, 1107, 2447, 5120,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (1/20160)*n\^{}8 + (1/2520)*n\^{}7 + (1/480)*n\^{}6 + (43/360)*n\^{}5 - (297/320)*n\^{}4 + (1271/180)*n\^{}3 - (75973/5040)*n\^{}2 + (2081/105)*n - 12 for n>1.\end{quote}
