...
\title{A further conjecture on OEIS A264273,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A264273 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $9, 48, 256, 1280, 6400, 32000, 160000, 800000,\dots$, with offset $1$. The sequence satisfies
\[
  a(n)=5\,a(n-1) ,
\]
...
\begin{quote}\raggedright a(n) = 256*5\^{}(n-3) for n>2.\end{quote}
...
indices, and $a$ and $f$ were checked to agree at $n=4,\dots,4$,
