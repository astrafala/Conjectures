...
\title{A further conjecture on OEIS A219350,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A219350 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $4, 4, 15, 35, 81, 174, 364, 740,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (1/40320)*n\^{}8 - (1/1120)*n\^{}7 + (5/192)*n\^{}6 - (2/5)*n\^{}5 + (7429/1920)*n\^{}4 - (3037/160)*n\^{}3 + (34483/2016)*n\^{}2 + (71507/280)*n - 791 for n>7.\end{quote}
...
indices, and $a$ and $f$ were checked to agree at $n=17,\dots,25$,
