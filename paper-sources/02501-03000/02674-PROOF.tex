...
\title{A further conjecture on OEIS A287191,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A287191 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $1, 1, 0, 111, 11000, 11111, 1100000, 1111111,\dots$, with offset $0$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = (1/180)*(-10 + 89*(-10)\^{}n + 10*(-1)\^{}n + 109*10\^{}n) for n>2.\end{quote}
