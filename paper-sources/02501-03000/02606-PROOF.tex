...
\title{A further conjecture on OEIS A267461,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A267461 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $0, 2, 6, 12, 18, 26, 34, 44,\dots$, with offset $0$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = (2*n\^{}2+12*n-(-1)\^{}n-7)/4 for n>0.\end{quote}
