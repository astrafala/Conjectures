...
\title{A further conjecture on OEIS A250762,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A250762 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $29012, 67356, 121593, 191723, 277746, 379662, 497471, 631173,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (15893/2)*n\^{}2 + (29009/2)*n + 6561.\end{quote}
