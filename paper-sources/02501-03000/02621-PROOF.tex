...
\title{A further conjecture on OEIS A268966,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A268966 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $24, 240, 2016, 15552, 114048, 808704, 5598720, 38071296,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = 2\^{}(n+2) * 3\^{}(n-1) * (2*n+1).\end{quote}
