...
\title{A further conjecture on OEIS A268900,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A268900 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $36, 696, 9720, 118584, 1347192, 14644152, 154472184, 1594323000,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = 8 * 3\^{}(2*n-3) * (16*n-3) for n>1.\end{quote}
