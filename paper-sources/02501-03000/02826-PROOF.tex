...
\title{The empirical recurrence for OEIS A231052, proved by transfer matrix}
...
\begin{abstract}
OEIS A231052 counts arrays of width $4$ over $\{0,1,2,3\}$ in which every cell must see, among its
...
carries an empirical recurrence of order $31$ contributed by R.~H.~Hardin. It is true, and
it is decidable rather than empirical: a cell's neighbours lie in three consecutive rows, so
the count is a walk count on $S=1653$ states.
\end{abstract}
...
OEIS A231052 is ``Number of 4Xn 0..3 arrays x(i,j) with each element horizontally, diagonally or antidiagonally next to at least one element with value (x(i,j)+1) mod 4 and at least one element with value (x(i,j)-1) mod 4, no adjacent elements equal, and upper left element zero.''. It has offset $1$ and begins
\[
0, 10, 410, 2080, 20050, 310804, 4110640, 50618998,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 06:13:27, revision 6) this is still
...
its neighbours there be at least $1$ carrying $v+1 \bmod 4$ and at least $1$ carrying $v-1 \bmod 4$. The entry also forbids two neighbouring cells from carrying equal values. The top left
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=1653.
\]
...
\begin{theorem}
\[
a(n)\;=\;10\,a(n-1) + 26\,a(n-2) + 92\,a(n-3) + 616\,a(n-4) - 4329\,a(n-5) - 16937\,a(n-6) + 9747\,a(n-7) + 74627\,a(n-8) + 138730\,a(n-9) + 199463\,a(n-10) - 165251\,a(n-11) - 709116\,a(n-12) - 1160893\,a(n-13) - 2172906\,a(n-14) - 2451394\,a(n-15) - 1288052\,a(n-16) + 2653888\,a(n-17) + 4205208\,a(n-18) + 4581464\,a(n-19) + 2645760\,a(n-20) - 2865936\,a(n-21) - 4590592\,a(n-22) - 1547392\,a(n-23) + 1079872\,a(n-24) + 722560\,a(n-25) + 97536\,a(n-26) + 29696\,a(n-27) + 37888\,a(n-28) + 6144\,a(n-29) - 4096\,a(n-30) - 16384\,a(n-31)
\]
for every $n>32$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231052.
