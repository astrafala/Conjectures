...
\title{A further conjecture on OEIS A268633,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A268633 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $3, 24, 120, 504, 1944, 7128, 25272, 87480,\dots$, with offset $1$. The sequence satisfies
\[
  a(n)=6\,a(n-1) - 9\,a(n-2) ,
\]
...
\begin{quote}\raggedright a(n) = 8*3\^{}(n-2)*(2*n-1) for n>1.\end{quote}
