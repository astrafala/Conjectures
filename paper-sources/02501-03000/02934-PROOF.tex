...
\title{The empirical recurrence for OEIS A269037, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A269037 counts arrays over $\{0,\dots,2\}$ subject to a condition on the array as a
...
OEIS A269037 is ``Number of 3 X n 0..2 arrays with some element plus some horizontally, diagonally or antidiagonally adjacent neighbor totalling two exactly once.''. It has offset $1$ and begins
\[
0, 120, 348, 2166, 9528, 44760, 198816, 877800,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 6*a(n-1) - a(n-2) - 28*a(n-3) - 4*a(n-4) + 16*a(n-5) - 4*a(n-6) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 18 2019 09:24:03, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269037.
