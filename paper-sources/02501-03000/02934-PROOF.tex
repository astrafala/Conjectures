...
\title{The empirical closed form for OEIS A223829, proved}
...
\begin{abstract}
OEIS A223829 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A223829 is ``Number of nX6 0..2 arrays with rows and columns unimodal.''. It has offset $1$ and begins
\[
148, 21904, 1492552, 54035194, 1215505987, 18986502099, 222531132820, 2068398813560,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 22:41:27, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\begin{multline*}
f(n)\;=\;\frac{114400861 n^{24}}{793412278431252480000} + \frac{9239627879 n^{23}}{957482101440184320000} \\
+ \frac{2294154892207 n^{22}}{6744004366665646080000} + \frac{31452416351 n^{21}}{3930072474746880000} \\
+ \frac{24193209295183 n^{20}}{175168944588718080000} + \frac{26794300136633 n^{19}}{14597412049059840000} \\
+ \frac{156064264676147 n^{18}}{8066990869217280000} + \frac{2841522664487 n^{17}}{17237159976960000} \\
+ \frac{4371737267991827 n^{16}}{3796230997278720000} + \frac{2108622084806357 n^{15}}{316352583106560000} \\
+ \frac{1962362041518863 n^{14}}{60872508702720000} + \frac{32606172071712193 n^{13}}{248562743869440000} \\
+ \frac{18855796322583547567 n^{12}}{41758540970065920000} + \frac{139121898481058809 n^{11}}{105450861035520000} \\
+ \frac{3110633309061530597 n^{10}}{949057749319680000} + \frac{42100438290827471 n^{9}}{6083703521280000} \\
+ \frac{420754828375884341 n^{8}}{33894919618560000} + \frac{904804704582195107 n^{7}}{48017802792960000} \\
+ \frac{51548680903180914709 n^{6}}{2128789257154560000} + \frac{354934053915002447 n^{5}}{13646084981760000} \\
+ \frac{3825468263928720221 n^{4}}{162615846032640000} + \frac{45410231102313599 n^{3}}{2710264100544000} \\
+ \frac{858998106767 n^{2}}{89625135600} + \frac{2352186769 n}{669278610} \\
+ 1.
\end{multline*}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223829.
