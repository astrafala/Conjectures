...
\title{The empirical recurrence for OEIS A205469, proved by transfer matrix}
...
\begin{abstract}
OEIS A205469 counts, up to renaming the letters, the arrays of width $3$ over at most $3$
letters in which all the $2\times2$ subblocks of one array have the SAME number of equal edges, an equal edge being one of the four perimeter edges whose two cells agree; the common value is not named, so the count splits by it. It carries an empirical recurrence of order $10$ contributed by
...
OEIS A205469 is ``Number of (n+1)X3 0..2 arrays with every 2X2 subblock having the same number of equal edges, and new values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
48, 263, 1548, 9654, 61978, 405702, 2686876, 17926060,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 12:08:40, revision 9) this is still
...
$w_i$ cleared of denominators and $S=82$ states in all. The walk index $j$ and the entry's own
...
\begin{theorem}
\[
a(n)\;=\;16\,a(n-1) - 85\,a(n-2) + 142\,a(n-3) + 159\,a(n-4) - 676\,a(n-5) + 465\,a(n-6) + 298\,a(n-7) - 506\,a(n-8) + 220\,a(n-9) - 32\,a(n-10)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A205469.
