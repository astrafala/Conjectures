...
\title{A further conjecture on OEIS A220926,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A220926 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $4, 13, 41, 114, 260, 545, 1104, 2182,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (1/20160)*n\^{}8 - (1/2520)*n\^{}7 - (1/1440)*n\^{}6 + (7/45)*n\^{}5 - (3953/2880)*n\^{}4 + (2093/360)*n\^{}3 + (1049/560)*n\^{}2 - (12377/420)*n + 28 for n>3.\end{quote}
