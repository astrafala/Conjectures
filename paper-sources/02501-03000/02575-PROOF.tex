...
\title{A further conjecture on OEIS A240359,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A240359 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $4, 15, 43, 111, 261, 571, 1171, 2278,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (1/40320)*n\^{}8 - (1/2016)*n\^{}7 + (7/576)*n\^{}6 - (23/360)*n\^{}5 + (1327/5760)*n\^{}4 + (1271/288)*n\^{}3 - (25027/672)*n\^{}2 + (127387/840)*n - 223 for n>4.\end{quote}
...
indices, and $a$ and $f$ were checked to agree at $n=14,\dots,22$,
