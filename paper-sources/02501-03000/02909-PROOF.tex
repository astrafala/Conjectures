...
\title{The empirical recurrence for OEIS A268806, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A268806 counts arrays over $\{0,\dots,2\}$ subject to a condition on the array as a
...
OEIS A268806 is ``Number of nX5 0..2 arrays with some element plus some horizontally, vertically or antidiagonally adjacent neighbor totalling two not more than once.''. It has offset $1$ and begins
\[
144, 772, 4158, 28452, 195384, 1316226, 8734264, 57302798,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 13 2016 18:21:19, revision 4) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268806.
