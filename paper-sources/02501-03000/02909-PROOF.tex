...
\title{The empirical recurrence for OEIS A224581, proved by transfer matrix}
...
\begin{abstract}
OEIS A224581 counts the $(n+6)\times7$ matrices over $\{0,\dots,1\}$ all of whose
...
makes $a(n)$ a walk count on $S=2423297$ vertices, hence $C$-finite, and whether the conjectured
...
OEIS A224581 is ``Number of (n+6)X7 0..1 matrices with each 7X7 subblock idempotent.''. It has offset $1$ and begins
\[
2185738, 164935, 125525, 122508, 128620, 138581, 146715, 156428,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 23:29:02, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{The count is a walk count}

Call a $7\times7$ matrix over $\{0,\dots,1\}$ a \emph{window} when it is idempotent, and
call a $7\times7$ matrix a \emph{band} when every one of its $1$ contiguous
$7\times7$ subblocks is a window. What the entry counts is the matrices of $7$ columns
whose every $7$ consecutive rows form a band.

Take as states the $6\times7$ strips that occur as the top $6$ rows of a band,
...
\]
with $M$ the adjacency matrix on $S=2423297$ states. In particular $a$ is $C$-finite. The
alignment was checked against the entry's published terms rather than assumed.

There are $(1 + 1)^{42}$ strips of $6$ rows and $7$ columns, far too
many to test one by one, and they are not tested one by one. Two consecutive windows of a band
overlap in $7\times6$ entries, so a band is exactly a walk of $1$ windows in
...
\begin{theorem}
\[
a(n)\;=\;a(n-3) + a(n-5) + a(n-7) + 2\,a(n-8) + 3\,a(n-9) + 2\,a(n-10) - 2\,a(n-13) - 2\,a(n-14) - 3\,a(n-15) - 2\,a(n-16) - 4\,a(n-17) - 3\,a(n-18) - 2\,a(n-19) + a(n-21) + 2\,a(n-22) + 2\,a(n-23) + a(n-24) + a(n-25) + a(n-26) + a(n-27)
\]
for every $n>39$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224581.
