...
\title{The empirical recurrence for OEIS A224552, proved by transfer matrix}
...
\begin{abstract}
OEIS A224552 counts the $(n+2)\times3$ matrices over $\{0,\dots,1\}$ all of whose
...
makes $a(n)$ a walk count on $S=36$ vertices, hence $C$-finite, and whether the conjectured
...
OEIS A224552 is ``Number of (n+2) X 3 0..1 matrices with each 3 X 3 subblock idempotent.''. It has offset $1$ and begins
\[
50, 70, 113, 172, 263, 418, 669, 1064,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) - 3*a(n-2) + 2*a(n-3) - a(n-4) - a(n-5) + a(n-6) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 31 2018 06:38:02, revision 7) this is still
...
\]
with $M$ the adjacency matrix on $S=36$ states. In particular $a$ is $C$-finite. The
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224552.
