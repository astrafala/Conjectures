...
\title{The empirical recurrence for OEIS A268014, proved by transfer matrix}
...
\begin{abstract}
OEIS A268014 counts arrays in which the REPEATED VALUES of each row, and of each column, stand in a
...
OEIS A268014 is ``Number of n X 2 0..2 arrays with every repeated value in every row and column greater than or equal to the previous repeated value.''. It has offset $1$ and begins
\[
9, 81, 729, 6084, 49284, 386884, 2965284, 22268961,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 04 2021 14:04:12, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;25\,a(n-1) - 225\,a(n-2) + 745\,a(n-3) + 475\,a(n-4) - 6275\,a(n-5) - 885\,a(n-6) + 22525\,a(n-7) + 22525\,a(n-8) - 885\,a(n-9) - 6275\,a(n-10) + 475\,a(n-11) + 745\,a(n-12) - 225\,a(n-13) + 25\,a(n-14) - a(n-15)
\]
for every $n>14$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268014.
