...
\title{A further conjecture on OEIS A250760,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A250760 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $3152, 7272, 13089, 20603, 29814, 40722, 53327, 67629,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (1697/2)*n\^{}2 + (3149/2)*n + 729.\end{quote}
