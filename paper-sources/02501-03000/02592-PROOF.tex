...
\title{A further conjecture on OEIS A243516,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A243516 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $3, 5, 10, 25, 77, 280, 1156, 5267,\dots$, with offset $1$. The sequence satisfies
\[
...
\[
  q(x)=x^{6} - 17 x^{5} + 111 x^{4} - 355 x^{3} + 584 x^{2} - 468 x + 144 .
\]
...
\begin{quote}\raggedright a(n) = (2722 + 675*2\^{}n + 25*2\^{}(1+2*n) + 50*3\^{}(1+n) + 2\^{}n*3\^{}(1+n) + 660*n) / 1800.\end{quote}
...
\[
  p(x)=x^{6} - 17 x^{5} + 111 x^{4} - 355 x^{3} + 584 x^{2} - 468 x + 144 ,
\]
