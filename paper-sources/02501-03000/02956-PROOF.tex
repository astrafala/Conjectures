...
\title{The empirical recurrence for OEIS A233214, proved by transfer matrix}
...
\begin{abstract}
OEIS A233214 counts arrays over $\{0,\dots,5\}$ in which no two entries that are neighbours in
...
carried by one bounded piece of extra state, so the count is a walk count on $S=11$ states.
\end{abstract}
...
OEIS A233214 is ``Number of nX5 0..5 arrays with no element x(i,j) adjacent to value 5-x(i,j) horizontally or antidiagonally, top left element zero, and 1 appearing before 2 3 and 4, and 2 appearing before 3 in row major order.''. It has offset $1$ and begins
\[
99, 147019, 268289572, 496475792293, 919538740854193, 1703198747507336644, 3154729081272072714436, 5843309615312787017886631,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 1975*a(n-1) -228357*a(n-2) +1804281*a(n-3) -4170978*a(n-4) +2593080*a(n-5)
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 07:55:55, revision 6) this is still
...
identified; after that identification there are $S=11$ of them.
...
\begin{theorem}
\[
a(n)\;=\;1975\,a(n-1) - 228357\,a(n-2) + 1804281\,a(n-3) - 4170978\,a(n-4) + 2593080\,a(n-5)
\]
for every $n>5$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A233214.
