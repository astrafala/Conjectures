...
\title{The empirical recurrence for OEIS A276303, proved by transfer matrix}
...
\begin{abstract}
OEIS A276303 counts arrays in which no entry may equal the entries at a short list of fixed offsets
...
$1$ consecutive columns, $S=797$ states in all.
\end{abstract}
...
OEIS A276303 is ``Number of 6Xn 0..2 arrays with no element equal to any value at offset (-2,-1) (-1,1) or (0,-1) and new values introduced in order 0..2.''. It has offset $1$ and begins
\[
122, 250, 3437, 34865, 442001, 4988145, 59728757, 693817033,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 28 2016 08:30:47, revision 4) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=797.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A276303.
