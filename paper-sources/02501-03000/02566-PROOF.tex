...
\title{The empirical recurrence for OEIS A240322, proved by transfer matrix}
...
\begin{abstract}
OEIS A240322 counts arrays over $\{0,1,2,3\}$ in which no entry may equal, modulo $4$, a given
...
OEIS A240322 is ``Number of n X 2 0..3 arrays with no element equal to zero plus the sum of elements to its left or zero plus the sum of elements above it or one plus the sum of the elements diagonally to its northwest, modulo 4.''. It has offset $1$ and begins
\[
2, 5, 17, 37, 80, 213, 443, 1028,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 27 2018 06:33:19, revision 9) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A240322.
