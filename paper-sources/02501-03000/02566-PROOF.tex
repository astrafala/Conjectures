...
\title{A further conjecture on OEIS A220036,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A220036 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $7, 12, 28, 83, 187, 358, 613, 962,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (1/120)*n\^{}5 - (1/12)*n\^{}4 + (47/24)*n\^{}3 - (23/12)*n\^{}2 + (1771/30)*n - 323 for n>8.\end{quote}
...
indices, and $a$ and $f$ were checked to agree at $n=15,\dots,20$,
