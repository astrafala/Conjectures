...
\title{A further conjecture on OEIS A266596,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A266596 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $0, 2, 4, 9, 15, 20, 30, 35,\dots$, with offset $0$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = (n\^{}2+4*n+(-1)\^{}n*(n-3)-3)/2 for n>0.\end{quote}
