...
\title{The empirical recurrence for OEIS A268770, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A268770 counts arrays over $\{0,\dots,2\}$ subject to a condition on the array as a
...
OEIS A268770 is ``Number of n X 4 0..2 arrays with some element plus some horizontally, vertically, diagonally or antidiagonally adjacent neighbor totalling two exactly once.''. It has offset $1$ and begins
\[
36, 100, 446, 2296, 10340, 46312, 198114, 837848,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 4*a(n-1) + 10*a(n-2) - 32*a(n-3) - 47*a(n-4) + 40*a(n-5) + 38*a(n-6) - 12*a(n-7) - 9*a(n-8) for n>10.
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 15 2019 07:54:48, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268770.
