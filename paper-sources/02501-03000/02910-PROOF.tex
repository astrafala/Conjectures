...
\title{The empirical recurrence for OEIS A214102, proved by transfer matrix}
...
\begin{abstract}
OEIS A214102 counts the proper colourings of a grid $3\times(n+1)$, wrapped in the growing direction, with at most $3$ colours and
...
down to $S=26$ and makes the exact residual test affordable.
\end{abstract}
...
OEIS A214102 is ``Number of 0..2 colorings of a 3X(n+1) array circular in the n+1 direction with new values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
9, 4, 121, 180, 2041, 5068, 37441, 121588,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) +15*a(n-2) -33*a(n-3) -22*a(n-4) +38*a(n-5) +8*a(n-6) -8*a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 16:51:13, revision 10) this is still
...
state count is $S=26$ rather than the number of colourings.
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + 15\,a(n-2) - 33\,a(n-3) - 22\,a(n-4) + 38\,a(n-5) + 8\,a(n-6) - 8\,a(n-7)
\]
for every $n>5$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A214102.
