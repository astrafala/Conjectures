...
\title{The empirical recurrence for OEIS A180764, proved by transfer matrix}
...
\begin{abstract}
OEIS A180764 counts arrays of width $4$ over $\{0,1\}$ in which every cell equals at least one of its neighbours. The entry carries an
...
OEIS A180764 is ``Half the number of nX4 binary arrays with each element equal to at least one neighbor.''. It has offset $1$ and begins
\[
2, 34, 390, 4475, 52186, 606546, 7053923, 82032712,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 01:09:37, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;9\,a(n-1) + 35\,a(n-2) - 29\,a(n-3) - 256\,a(n-4) - 120\,a(n-5) + 695\,a(n-6) + 579\,a(n-7) - 949\,a(n-8) - 1076\,a(n-9) + 485\,a(n-10) + 1488\,a(n-11) + 588\,a(n-12) - 857\,a(n-13) - 368\,a(n-14) - 73\,a(n-15) - 52\,a(n-16) + 26\,a(n-17) + 14\,a(n-18) + 12\,a(n-19) - 4\,a(n-20)
\]
for every $n>20$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A180764.
