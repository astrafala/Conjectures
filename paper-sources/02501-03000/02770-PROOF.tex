...
\title{The empirical recurrence for OEIS A275087, proved by counting patterns}
...
\begin{abstract}
OEIS A275087 counts arrays in which no entry may repeat a value found at any of three stated
...
cutting $60074$ pairs to $S=10355$ states. The entry's empirical recurrence of order $27$,
...
OEIS A275087 is ``Number of nX5 0..2 arrays with no element equal to any value at offset (0,-2) (-1,-2) or (-2,-1) and new values introduced in order 0..2.''. It has offset $1$ and begins
\[
12, 288, 1680, 12816, 87924, 647648, 4706400, 34281472,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 16 2016 09:20:34, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 15\,a(n-2) + 101\,a(n-3) + 450\,a(n-4) + 587\,a(n-5) - 948\,a(n-6) - 6010\,a(n-7) - 692\,a(n-8) + 18832\,a(n-9) - 31839\,a(n-10) + 1958\,a(n-11) + 58620\,a(n-12) - 170990\,a(n-13) + 243302\,a(n-14) - 278201\,a(n-15) + 182523\,a(n-16) + 57164\,a(n-17) - 121679\,a(n-18) + 9439\,a(n-19) + 37154\,a(n-20) + 841\,a(n-21) - 863\,a(n-22) + 182\,a(n-23) + 60\,a(n-24) - 6\,a(n-25) - 2\,a(n-26) + a(n-27)
\end{equation}
for all $n>28$.
...
$o=1n_0+0-2$, we have for $j\ge27$
\[
3!\Bigl(a(n_0+j)-\sum_i c_i\,a(n_0+j-i)\Bigr)
=\mathbf{v}^{\!\top}G^{\,j-27}w,\qquad
w=h_{27}-\sum_i c_i h_{27-i} .
\]
...
the survivors by the pattern of the new pair. The vector $w$ was formed by $27$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A275087.
