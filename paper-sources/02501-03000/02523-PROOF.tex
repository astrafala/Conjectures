...
\title{A further conjecture on OEIS A219500,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A219500 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $6, 11, 35, 88, 179, 325, 550, 885,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (1/120)*n\^{}5 + (1/24)*n\^{}4 + (13/24)*n\^{}3 + (59/24)*n\^{}2 + (59/20)*n - 17 for n>3.\end{quote}
...
indices, and $a$ and $f$ were checked to agree at $n=10,\dots,15$,
