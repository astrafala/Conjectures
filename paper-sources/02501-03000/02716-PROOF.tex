...
\title{The empirical recurrence for OEIS A268636, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A268636 counts arrays over $\{0,\dots,2\}$ subject to a condition on the array as a
...
OEIS A268636 is ``Number of nX5 0..2 arrays with some element plus some horizontally or vertically adjacent neighbor totalling two exactly once.''. It has offset $1$ and begins
\[
96, 1944, 29772, 412740, 5419992, 68710116, 849572724, 10310685036,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 09 2016 12:21:32, revision 4) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268636.
