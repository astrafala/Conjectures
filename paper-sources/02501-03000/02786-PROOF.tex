...
\title{A further conjecture on OEIS A277954,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A277954 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $1, 3, 6, 14, 26, 58, 106, 234,\dots$, with offset $0$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = (-8-(-2)\^{}n+21*2\^{}n)/12. (End)\end{quote}
