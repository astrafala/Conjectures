...
\title{The empirical closed form for OEIS A207389, proved}
...
\begin{abstract}
OEIS A207389 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A207389 is ``Number of n X 6 0..1 arrays avoiding 0 0 1 and 0 1 0 horizontally and 0 0 1 and 1 1 0 vertically.''. It has offset $1$ and begins
\[
21, 441, 2307, 7561, 19319, 42167, 82477, 148743,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (1/36)*n\^{}6 + (113/60)*n\^{}5 + (151/9)*n\^{}4 + (95/4)*n\^{}3 - (605/36)*n\^{}2 - (229/30)*n + 3.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 22 2018 07:08:25, revision 9) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{n^{6}}{36} + \frac{113 n^{5}}{60} + \frac{151 n^{4}}{9} + \frac{95 n^{3}}{4} - \frac{605 n^{2}}{36} - \frac{229 n}{30} + 3.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207389.
