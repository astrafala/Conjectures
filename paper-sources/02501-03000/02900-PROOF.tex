...
\title{Arrays counted up to renaming: the empirical recurrence for OEIS A206379}
...
\begin{abstract}
OEIS A206379 carries an empirical recurrence of order $11$ contributed by R.~H.~Hardin. It is
...
OEIS A206379 is ``Number of (n+1)X5 0..3 arrays with every 2X2 subblock having the same number of equal diagonal or antidiagonal elements, and new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
5257, 520097, 57656713, 6554439373, 748963157161, 85678539791333, 9803619036105721, 1121819841273065957,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 12:54:37, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;160\,a(n-1) - 5537\,a(n-2) + 25556\,a(n-3) + 1495902\,a(n-4) - 23370552\,a(n-5) + 81849864\,a(n-6) + 544237824\,a(n-7) - 5119960320\,a(n-8) + 15199301376\,a(n-9) - 19180578816\,a(n-10) + 8497004544\,a(n-11)
\]
for every $n>11$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206379.
