...
\title{The empirical recurrence for OEIS A239995, proved by transfer matrix}
...
\begin{abstract}
OEIS A239995 counts arrays over $\{0,1,2,3\}$ in which no entry may equal, modulo $4$, a given
...
OEIS A239995 is ``Number of nX2 0..3 arrays with no element equal to one plus the sum of elements to its left or two plus the sum of elements above it or one plus the sum of the elements diagonally to its northwest, modulo 4.''. It has offset $1$ and begins
\[
3, 13, 61, 256, 1117, 5012, 22592, 102336,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 09:36:56, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A239995.
