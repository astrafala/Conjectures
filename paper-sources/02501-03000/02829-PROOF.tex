...
\title{A further conjecture on OEIS A287193,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A287193 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $1, 1, 0, 7, 24, 31, 96, 127,\dots$, with offset $0$. The sequence satisfies
\[
  a(n)=5\,a(n-2) - 4\,a(n-4) ,
\]
...
\begin{quote}\raggedright a(n) = (1/4)*(-2 + (-2)\^{}n + 2*(-1)\^{}n + 5*2\^{}n) for n>2.\end{quote}
