...
\title{The empirical recurrence for OEIS A252805, proved by transfer matrix}
...
\begin{abstract}
OEIS A252805 counts arrays of width $4$ over an alphabet of $5$ letters in which every three
...
brings the state count down to $S=424$.
\end{abstract}
...
OEIS A252805 is ``Number of (n+2) X (2+2) 0..4 arrays with every consecutive three elements in every row and column not having exactly two distinct values, and in every diagonal and antidiagonal having exactly two distinct values, and new values 0 upwards introduced in row major order.''. It has offset $1$ and begins
\[
155, 259, 488, 369, 702, 2301, 1864, 3971,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) +13*a(n-3) -13*a(n-4) -43*a(n-6) +43*a(n-7) +7*a(n-9) -7*a(n-10) for n>16.
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 03 2022 21:41:27, revision 6) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The array has width $4$ and entries in $\{0,1,\dots,4\}$. Four families of triples
...
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,
\]
with $S=424$ states in all. The walk index $j$ and the entry's own $n$ differ by a constant,
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 13\,a(n-3) - 13\,a(n-4) - 43\,a(n-6) + 43\,a(n-7) + 7\,a(n-9) - 7\,a(n-10)
\]
for every $n>16$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252805.
