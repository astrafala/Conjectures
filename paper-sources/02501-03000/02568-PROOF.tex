...
\title{The empirical recurrence for OEIS A253030, proved by transfer matrix}
...
\begin{abstract}
OEIS A253030 counts arrays of width $4$ over an alphabet of $3$ letters in which every three
...
OEIS A253030 is ``Number of (n+2) X (2+2) 0..2 arrays with every consecutive three elements in every row and column having exactly two distinct values, and new values 0 upwards introduced in row major order.''. It has offset $1$ and begins
\[
1647, 12987, 102060, 802899, 6320511, 49756086, 391717269, 3084008175,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 9*a(n-1) - 5*a(n-2) - 10*a(n-3) - 174*a(n-4) + 80*a(n-5) + 160*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 08 2018 11:22:33, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253030.
