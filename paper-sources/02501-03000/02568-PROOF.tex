...
\title{A further conjecture on OEIS A266613,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A266613 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $1, 2, 5, 10, 20, 41, 82, 165,\dots$, with offset $0$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = (31*2\^{}n-4*((-1)\^{}n+3))/24 for n>2.\end{quote}
