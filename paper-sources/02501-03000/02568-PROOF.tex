...
\title{A further conjecture on OEIS A220045,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A220045 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $10, 13, 25, 50, 90, 152, 249, 397,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (1/120)*n\^{}5 - (1/24)*n\^{}4 + (5/24)*n\^{}3 + (109/24)*n\^{}2 - (1063/60)*n + 39 for n>4.\end{quote}
