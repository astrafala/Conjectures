...
\title{A further conjecture on OEIS A220037,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A220037 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $8, 14, 36, 119, 297, 626, 1165, 1963,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (1/720)*n\^{}6 - (7/240)*n\^{}5 + (107/144)*n\^{}4 - (209/48)*n\^{}3 + (1609/45)*n\^{}2 + (1913/60)*n - 813 for n>9.\end{quote}
...
indices, and $a$ and $f$ were checked to agree at $n=17,\dots,23$,
