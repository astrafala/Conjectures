...
\title{A further conjecture on OEIS A266612,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A266612 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $1, 10, 101, 1010, 10100, 101001, 1010010, 10100101,\dots$, with offset $0$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = (-9*(-1)\^{}n+99991*2\^{}(n-2)*5\^{}(n-3)-11)/198 for n>2.\end{quote}
