...
\title{The empirical closed form for OEIS A224143, proved}
...
\begin{abstract}
OEIS A224143 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A224143 is ``Number of n X 5 0..1 arrays with rows and antidiagonals unimodal and columns nondecreasing.''. It has offset $1$ and begins
\[
16, 86, 275, 691, 1509, 2985, 5471, 9431,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (2/15)*n\^{}5 + (2/3)*n\^{}4 + (10/3)*n\^{}3 + (25/3)*n\^{}2 + (203/15)*n - 17 for n>2.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 24 2026 08:20:05, revision 10) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{2 n^{5}}{15} + \frac{2 n^{4}}{3} + \frac{10 n^{3}}{3} + \frac{25 n^{2}}{3} + \frac{203 n}{15} - 17.
\]
...
$n=9,\dots,14$ and agree at each. A monic recurrence of order $6$
determines $a(m)$ from $a(m-1),\dots,a(m-6)$, and for every $m\ge15$ both
$m>8$ and $m-6\ge9$ hold, so induction on $m$ gives $a(m)=f(m)$ for every
$m\ge9$.
Below $n=9$ the recurrence argument gives nothing, since \eqref{eq:rec} is only
established for $a$ from $n=9$ on. The remaining indices $n=3,\dots,8$ were
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224143.
