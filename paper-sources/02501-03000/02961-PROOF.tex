...
\title{The empirical recurrence for OEIS A233086, proved by carrying a row major clause across
columns}
...
\begin{abstract}
OEIS A233086 counts $5\times n$ arrays over $\{0,\dots,3\}$ with a forbidden-pair
condition and a clause on the order in which values first appear, read in ROW MAJOR order, and
it carries an empirical recurrence of order $10$ contributed by R.~H.~Hardin. It is true.
...
OEIS A233086 is ``Number of 5Xn 0..3 arrays with no element x(i,j) adjacent to value 3-x(i,j) horizontally or antidiagonally, top left element zero, and 1 appearing before 2 in row major order.''. It has offset $1$ and begins
\[
136, 9842, 875165, 77824814, 6938214854, 618844579511,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 07:51:51, revision 6) this is still
...
row, and there are $S=783$ of them after states with identical futures are merged. Hence
\[
...
\begin{theorem}
\[
a(n)\;=\;132\,a(n-1) - 4507\,a(n-2) + 66832\,a(n-3) - 492772\,a(n-4) + 1765654\,a(n-5) - 2023881\,a(n-6) - 4686284\,a(n-7) + 16006509\,a(n-8) - 16068834\,a(n-9) + 5437152\,a(n-10)
\]
for every $n>14$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A233086.
