...
\title{A further conjecture on OEIS A290835,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A290835 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $1, 1, 101, 1111, 111, 111111, 1111111, 11111111,\dots$, with offset $0$. The sequence satisfies
\[
