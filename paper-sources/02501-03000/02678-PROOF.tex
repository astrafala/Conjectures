...
\title{The empirical recurrence for OEIS A202797, proved by transfer matrix}
...
\begin{abstract}
OEIS A202797 counts arrays of width $3$ over $\{0,1\}$ in which every cell of a named value has a neighbour of that same value. The entry carries an
...
OEIS A202797 is ``Number of n X 3 binary arrays with every one adjacent to another one horizontally or vertically.''. It has offset $1$ and begins
\[
4, 36, 250, 1718, 11988, 83518, 581518, 4049700,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 7*a(n-1) -3*a(n-2) +19*a(n-3) -3*a(n-4) +25*a(n-5) +24*a(n-6) -22*a(n-7) -16*a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 01 2018 14:18:24, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-1) - 3\,a(n-2) + 19\,a(n-3) - 3\,a(n-4) + 25\,a(n-5) + 24\,a(n-6) - 22\,a(n-7) - 16\,a(n-8)
\]
for every $n>7$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A202797.
