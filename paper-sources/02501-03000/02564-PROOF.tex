...
\title{A further conjecture on OEIS A220034,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A220034 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $5, 8, 15, 34, 61, 95, 137, 187,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (1/6)*n\^{}3 + (1/2)*n\^{}2 + (43/3)*n - 45 for n>5.\end{quote}
...
indices, and $a$ and $f$ were checked to agree at $n=10,\dots,13$,
