...
\title{A further conjecture on OEIS A266594,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A266594 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $1, 2, 5, 7, 10, 16, 19, 29,\dots$, with offset $0$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = (n\^{}2-(-1)\^{}n*(n-3)+5)/2 for n>0.\end{quote}
