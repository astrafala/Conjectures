...
\title{The empirical recurrence for OEIS A268784, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A268784 counts arrays over $\{0,\dots,1\}$ subject to a condition on the array as a
...
OEIS A268784 is ``Number of n X 3 binary arrays with some element plus some horizontally, vertically or antidiagonally adjacent neighbor totalling two exactly once.''. It has offset $1$ and begins
\[
2, 17, 72, 302, 1144, 4207, 14984, 52335,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) + 9*a(n-2) - 2*a(n-3) - 33*a(n-4) - 42*a(n-5) - 14*a(n-6) + 10*a(n-7) + 8*a(n-8) - a(n-10).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 15 2019 09:14:23, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268784.
