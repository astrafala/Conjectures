...
\title{The empirical recurrence for OEIS A223231, proved by transfer matrix}
...
\begin{abstract}
OEIS A223231 counts the ways of writing the vertices of a fixed graph $G$ into an array of width
$6$ so that any two cells adjacent in one of the named directions carry vertices joined by an
edge of $G$; here $G$ is icosahedron graph. The entry carries an empirical recurrence of order $26$
...
single slice is a state and the count is a walk count on a finite digraph with $S=37501$ vertices.
\end{abstract}
...
OEIS A223231 is ``Rolling icosahedron footprints: number of nX6 0..11 arrays starting with 0 where 0..11 label vertices of an icosahedron and every array movement to a horizontal, diagonal or antidiagonal neighbor moves along an icosahedral edge.''. It has offset $1$ and begins
\[
3125, 753005, 236027705, 78951770585, 27049155640325, 9343721361109325, 3237164242739054345, 1122694859942471556185,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 21:23:42, revision 8) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=37501.
\]
...
of length $6$ over $12$ vertices is one of $12^{6}$ words, but only $S-1$ of them are
...
\begin{theorem}
\[
a(n)\;=\;525\,a(n-1) - 66702\,a(n-2) + 1331899\,a(n-3) + 153275287\,a(n-4) - 7341587858\,a(n-5) + 30374971203\,a(n-6) + 3824146236752\,a(n-7) - 75111050134232\,a(n-8) + 205037655577424\,a(n-9) + 6460684913361019\,a(n-10) - 49290095118307364\,a(n-11) - 140021336623195442\,a(n-12) + 2200689678890462843\,a(n-13) - 1458667313500165314\,a(n-14) - 37187688159845953965\,a(n-15) + 75037715810598760272\,a(n-16) + 230357416636661884542\,a(n-17) - 652626536223111303870\,a(n-18) - 496313838990773846658\,a(n-19) + 2029968756189631881972\,a(n-20) + 256192718593072185252\,a(n-21) - 2481072401873869960176\,a(n-22) + 64389835845560317824\,a(n-23) + 1236374401394896182000\,a(n-24) - 45277328877999388704\,a(n-25) - 205116615409293840384\,a(n-26)
\]
for every $n>26$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223231.
