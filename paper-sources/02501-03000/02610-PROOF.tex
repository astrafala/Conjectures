...
\title{A further conjecture on OEIS A267847,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A267847 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $1, 4, 26, 122, 506, 2042, 8186, 32762,\dots$, with offset $0$. The sequence satisfies
\[
  a(n)=5\,a(n-1) - 4\,a(n-2) ,
\]
...
\begin{quote}\raggedright Conjecture: a(n) = 2*(4\^{}n - 3) for n>1. - \_Colin Barker\_, Nov 26 2016\end{quote}
