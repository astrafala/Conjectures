...
\title{A further conjecture on OEIS A253221,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A253221 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $10, 49, 263, 1249, 3568, 3568, 47698, 213155,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = 90112*n\^{}2 - 1212288*n + 4150790 for n > 10.\end{quote}
...
indices, and $a$ and $f$ were checked to agree at $n=14,\dots,16$,
