...
\title{The empirical recurrence for OEIS A262790, proved by transfer matrix}
...
\begin{abstract}
OEIS A262790 counts arrays of width $5$ over $\{0,1\}$ whose rows, read as base-$2$
numbers, are divisible by $5$ and whose columns, read the same way, are not divisible by
...
OEIS A262790 is ``Number of (n+2)X(3+2) 0..1 arrays with each row divisible by 5 and column not divisible by 5, read as a binary number with top and left being the most significant bits.''. It has offset $1$ and begins
\[
76, 528, 4898, 38688, 269638, 1873728, 13349904, 94039306,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 02 2015 07:44:14, revision 4) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A262790.
