...
\title{The empirical recurrence for OEIS A274730, proved by counting patterns}
...
\begin{abstract}
OEIS A274730 counts arrays in which no entry may repeat a value found at any of three stated
...
cutting $60074$ pairs to $S=10355$ states. The entry's empirical recurrence of order $7$,
...
OEIS A274730 is ``Number of 5 X n 0..2 arrays with no element equal to any value at offset (-1,-2) (-2,-1) or (-1,0) and new values introduced in order 0..2.''. It has offset $1$ and begins
\[
8, 144, 1040, 9308, 84948, 771300, 7016284, 63780144,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 10*a(n-1) - a(n-2) - 80*a(n-3) + 133*a(n-4) - 49*a(n-5) - 16*a(n-6) + 4*a(n-7) for n>9.
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 30 2019 11:16:01, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;10\,a(n-1) - a(n-2) - 80\,a(n-3) + 133\,a(n-4) - 49\,a(n-5) - 16\,a(n-6) + 4\,a(n-7)
\end{equation}
for all $n>9$.
...
$o=1n_0+0-2$, we have for $j\ge7$
\[
3!\Bigl(a(n_0+j)-\sum_i c_i\,a(n_0+j-i)\Bigr)
=\mathbf{v}^{\!\top}G^{\,j-7}w,\qquad
w=h_{7}-\sum_i c_i h_{7-i} .
\]
...
the survivors by the pattern of the new pair. The vector $w$ was formed by $7$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A274730.
