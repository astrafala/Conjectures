...
\title{The empirical recurrence for OEIS A252955, proved by transfer matrix}
...
\begin{abstract}
OEIS A252955 counts arrays of width $4$ over an alphabet of $5$ letters in which every three
...
brings the state count down to $S=923$.
\end{abstract}
...
OEIS A252955 is ``Number of (n+2)X(2+2) 0..4 arrays with every consecutive three elements in every row and diagonal having exactly two distinct values, and in every column and antidiagonal not having exactly two distinct values, and new values 0 upwards introduced in row major order.''. It has offset $1$ and begins
\[
119, 120, 185, 337, 596, 1186, 2279, 4165,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:48:06, revision 6) this is still
...
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,
\]
with $S=923$ states in all. The walk index $j$ and the entry's own $n$ differ by a constant,
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) - 6\,a(n-2) + 8\,a(n-3) - 55\,a(n-4) + 75\,a(n-5) + 71\,a(n-6) - 85\,a(n-7) - 42\,a(n-8) - 600\,a(n-9) + 1575\,a(n-10) - 1323\,a(n-11) + 378\,a(n-12)
\]
for every $n>14$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252955.
