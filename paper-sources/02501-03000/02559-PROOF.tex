...
\title{A further conjecture on OEIS A220011,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A220011 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $4, 7, 19, 43, 85, 154, 263, 431,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (1/60)*n\^{}5 - (1/4)*n\^{}4 + (31/12)*n\^{}3 - (35/4)*n\^{}2 + (102/5)*n - 17 for n>2.\end{quote}
