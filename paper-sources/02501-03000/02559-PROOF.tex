...
\title{A further conjecture on OEIS A266448,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A266448 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $1, 2, 4, 7, 11, 17, 21, 31,\dots$, with offset $0$. The sequence satisfies
\[
  a(n)=1\,a(n-1) + 2\,a(n-2) - 2\,a(n-3) - 1\,a(n-4) + 1\,a(n-5) ,
\]
...
\begin{quote}\raggedright a(n) = (2*n\^{}2+2*n+(-1)\^{}n*(7-2*n)+5)/4 for n>2.\end{quote}
