...
\title{A further conjecture on OEIS A284484,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A284484 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $1, 0, 111, 1011, 1111, 101111, 111111, 10111111,\dots$, with offset $0$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = (-20 - 81*(-10)\^{}n + 101*10\^{}n)/180 for n>2.\end{quote}
