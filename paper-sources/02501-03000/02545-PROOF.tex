...
\title{A further conjecture on OEIS A219774,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A219774 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $4, 6, 14, 33, 65, 114, 189, 298,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (1/24)*n\^{}4 + (1/4)*n\^{}3 - (13/24)*n\^{}2 + (17/4)*n for n>4.\end{quote}
