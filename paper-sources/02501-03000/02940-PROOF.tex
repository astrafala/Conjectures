...
\title{The empirical recurrence for OEIS A208318, proved by counting patterns}
...
\begin{abstract}
OEIS A208318 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A208318 is ``Number of n X 4 0..2 arrays with new values 0..2 introduced in row major order and no element equal to more than two of its immediate leftward or upward or left-upward diagonal neighbors.''. It has offset $1$ and begins
\[
14, 982, 71956, 5269968, 385979024, 28269518640, 2070490270512, 151644956050096,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 65*a(n-1) + 600*a(n-2) + 320*a(n-3) - 4224*a(n-4) + 1728*a(n-5) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 02 2018 04:53:24, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208318.
