...
\title{A further conjecture on OEIS A266250,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A266250 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $1, 1, 3, 5, 9, 14, 18, 27,\dots$, with offset $0$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = (n\^{}2-(-1)\^{}n*(n-4)+2)/2 for n>2.\end{quote}
