...
\title{A further conjecture on OEIS A219715,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A219715 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $10, 13, 45, 125, 283, 561, 1030, 1776,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (1/10)*n\^{}5 - (53/24)*n\^{}4 + (117/4)*n\^{}3 - (4099/24)*n\^{}2 + (10233/20)*n - 594 for n>4.\end{quote}
...
indices, and $a$ and $f$ were checked to agree at $n=11,\dots,16$,
