...
\title{The empirical recurrence for OEIS A203780, proved by transfer matrix}
...
\begin{abstract}
OEIS A203780 counts arrays of width $2$ over $\{0,1,2,3\}$ through two derived arrays of PAIR SUMS ---
...
OEIS A203780 is ``Number of (n+1) X 2 0..3 arrays with column and row pair sums b(i,j)=a(i,j)+a(i,j-1) and c(i,j)=a(i,j)+a(i-1,j) such that rows of b(i,j) and columns of c(i,j) are lexicographically nondecreasing.''. It has offset $1$ and begins
\[
90, 565, 3352, 18332, 93578, 452825, 2103364, 9466880,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 04 2018 14:17:13, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;18\,a(n-1) - 139\,a(n-2) + 604\,a(n-3) - 1627\,a(n-4) + 2818\,a(n-5) - 3141\,a(n-6) + 2176\,a(n-7) - 852\,a(n-8) + 144\,a(n-9)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A203780.
