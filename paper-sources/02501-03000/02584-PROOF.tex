...
\title{A further conjecture on OEIS A266975,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A266975 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $1, 110, 11100, 1101000, 111010000, 11010100000, 1110101000000, 110101010000000,\dots$, with offset $0$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = 2\^{}(n-2)*5\^{}(n-1)*(9*(-10)\^{}n+2189*10\^{}n-20)/99 for n>0.\end{quote}
