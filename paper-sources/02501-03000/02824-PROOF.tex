...
\title{The conjectured generating function for OEIS A202050, proved}
...
\begin{abstract}
OEIS A202050 counts arrays of a fixed width under a local condition, and carries a conjectured
...
coefficients of their expansions do. Comparing $293$ coefficients in exact arithmetic
...
OEIS A202050 is ``Number of (n+2) X 8 binary arrays avoiding patterns 001 and 110 in rows and columns.''. It has offset $1$ and begins
\[
1392, 5216, 15760, 41088, 95984, 205792,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 26 2018 08:45:33, revision 11) this is still
...
exact integer arithmetic, those of $N_2/D_2$ by exact rational long division, and $293$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A202050.
