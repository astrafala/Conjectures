...
\title{The empirical recurrence for OEIS A252807, proved by transfer matrix}
...
\begin{abstract}
OEIS A252807 counts arrays of width $6$ over an alphabet of $5$ letters in which every three
...
brings the state count down to $S=23632$.
\end{abstract}
...
OEIS A252807 is ``Number of (n+2) X (4+2) 0..4 arrays with every consecutive three elements in every row and column not having exactly two distinct values, and in every diagonal and antidiagonal having exactly two distinct values, and new values 0 upwards introduced in row major order.''. It has offset $1$ and begins
\[
752, 369, 551, 742, 1625, 2795, 3763, 8275,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 6*a(n-3) -4*a(n-6) -2*a(n-9) +a(n-12) for n>15.
\end{quote}
As of the ``Last modified'' line on the live entry (May 24 2024 15:32:11, revision 6) this is still
...
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,
\]
with $S=23632$ states in all. The walk index $j$ and the entry's own $n$ differ by a constant,
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-3) - 4\,a(n-6) - 2\,a(n-9) + a(n-12)
\]
for every $n>15$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252807.
