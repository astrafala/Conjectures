...
\title{The empirical recurrence for OEIS A253019, proved by transfer matrix}
...
\begin{abstract}
OEIS A253019 counts arrays of width $4$ over an alphabet of $4$ letters in which every three
...
OEIS A253019 is ``Number of (n+2) X (2+2) 0..3 arrays with every consecutive three elements in every row and column not having exactly two distinct values, and in every diagonal and antidiagonal having exactly two distinct values, and new values 0 upwards introduced in row major order.''. It has offset $1$ and begins
\[
37, 50, 83, 91, 133, 223, 243, 357,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 6*a(n-3) -10*a(n-6) +3*a(n-9) for n>11.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 08 2018 06:45:41, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253019.
