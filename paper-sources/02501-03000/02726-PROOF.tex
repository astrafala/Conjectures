...
\title{The empirical recurrence for OEIS A198509, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A198509 counts arrays in which every cell is constrained by its neighbours on \emph{both}
...
lumpable, cutting $462979$ pairs down to $S=7863$ states. The entry's empirical recurrence of
order $28$, contributed by R.~H.~Hardin, then follows from a finite exact computation.
\end{abstract}
...
OEIS A198509 is ``Number of 2nX4 0..4 arrays with values 0..4 introduced in row major order and each element unequal to exactly two horizontal and vertical neighbors.''. It has offset $1$ and begins
\[
59, 4666, 308854, 23016128, 1768050096, 137433138206, 10767346425686, 846703466364788,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 07:53:48, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;168\,a(n-1) - 9635\,a(n-2) + 230508\,a(n-3) - 1868458\,a(n-4) - 8029700\,a(n-5) - 28347702\,a(n-6) + 7358565368\,a(n-7) - 118460559973\,a(n-8) + 848136638992\,a(n-9) - 2704417624327\,a(n-10) - 758800108020\,a(n-11) + 26654251234560\,a(n-12) + 33477385996812\,a(n-13) - 778269041202000\,a(n-14) + 1691040379701264\,a(n-15) + 5723652909363264\,a(n-16) - 22555014434827584\,a(n-17) - 25385900061199616\,a(n-18) + 137722671189043200\,a(n-19) + 134897275429925888\,a(n-20) - 499905738358480896\,a(n-21) - 804105697954512896\,a(n-22) + 1173387177266905088\,a(n-23) + 2723824778237706240\,a(n-24) - 1319488323495919616\,a(n-25) - 4574511335676575744\,a(n-26) + 529114613380284416\,a(n-27) + 2540311664813670400\,a(n-28)
\end{equation}
for all $n>28$.
...
Assembling the $5$ lumped chains block-diagonally into $N$ of size $S=7863$, with the
...
index,
\[
5!\Bigl(a(n)-\sum_i c_i\,a(n-i)\Bigr)\;=\;\mathbf{v}^{\!\top}G^{\,j-28}\,
\Bigl(h_{28}-\sum_i c_i h_{28-i}\Bigr)
\]
...
$w=h_{28}-\sum_i c_ih_{28-i}$; and it is enough to check $m=0,1,\dots,S-1$.
\end{lemma}
...
index corresponding to $n=28+1$ onwards, and the run was continued until $S+1$
...
\eqref{eq:walk2}, divided by $5!$, was evaluated at every one of the $13$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A198509.
