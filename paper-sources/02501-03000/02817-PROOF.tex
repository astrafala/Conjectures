...
\title{A further conjecture on OEIS A284403,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A284403 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $1, 0, 101, 1110, 11111, 111111, 1111111, 11111111,\dots$, with offset $0$. The sequence satisfies
\[
