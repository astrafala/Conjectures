...
\title{The empirical recurrence for OEIS A189249, proved by transfer matrix}
...
\begin{abstract}
OEIS A189249 counts the permutations of the cells of an $n\times4$ array in which every cell
...
OEIS A189249 is ``Number of n X 4 array permutations with each element making zero or one king moves.''. It has offset $1$ and begins
\[
5, 1168, 76629, 7396009, 637586496, 56892084785, 5025023852501, 445205174822288,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 17 2022 22:23:57, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;86\,a(n-1) + 773\,a(n-2) - 51741\,a(n-3) + 261147\,a(n-4) + 1858799\,a(n-5) - 7576930\,a(n-6) - 18369505\,a(n-7) - 63976305\,a(n-8) + 171881802\,a(n-9) + 1135450371\,a(n-10) - 543543057\,a(n-11) - 2342488484\,a(n-12) - 2204079757\,a(n-13) + 2422263217\,a(n-14) + 6125446560\,a(n-15) - 2843664887\,a(n-16) - 3962040267\,a(n-17) + 2834866226\,a(n-18) - 976262267\,a(n-19) + 196899773\,a(n-20) + 87195350\,a(n-21) - 15444135\,a(n-22) - 1459347\,a(n-23) - 867371\,a(n-24) + 86035\,a(n-25) + 10110\,a(n-26) - 675\,a(n-27)
\]
for every $n>26$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A189249.
