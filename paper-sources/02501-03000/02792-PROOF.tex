...
\title{The empirical recurrence for OEIS A268070, proved by transfer matrix}
...
\begin{abstract}
OEIS A268070 counts arrays in which the REPEATED VALUES of each row, and of each column, stand in a
prescribed relation to one another in the order they occur. The entry carries an empirical
recurrence of order $11$ contributed by R.~H.~Hardin. It is true, and it is decidable
...
value so far in each column of the scan, so the count is a walk count on $S=586$ states.
\end{abstract}
...
OEIS A268070 is ``Number of nX2 0..3 arrays with every repeated value in every row and column unequal to the previous repeated value, and new values introduced in row-major sequential order.''. It has offset $1$ and begins
\[
2, 15, 159, 2191, 30295, 421471, 5797959, 79367143,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 25 2016 21:10:11, revision 4) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=586,\quad\tau=\mathbf{1} .
\]
...
\begin{theorem}
\[
a(n)\;=\;26\,a(n-1) - 109\,a(n-2) - 1668\,a(n-3) + 10384\,a(n-4) + 30340\,a(n-5) - 193268\,a(n-6) - 33480\,a(n-7) + 882432\,a(n-8) - 461376\,a(n-9) - 1073088\,a(n-10) + 839808\,a(n-11)
\]
for every $n>13$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268070.
