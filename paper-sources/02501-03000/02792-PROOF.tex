...
\title{The empirical recurrence for OEIS A240786, proved by transfer matrix}
...
\begin{abstract}
OEIS A240786 counts $5\times n$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
every CELL over a neighbour set the entry names, and counted UP TO RELABELLING of the
alphabet; it carries an empirical recurrence of order $30$ contributed by
...
OEIS A240786 is ``Number of 5Xn 0..1 arrays with no element equal to fewer vertical neighbors than horizontal neighbors, with new values 0..1 introduced in row major order.''. It has offset $1$ and begins
\[
16, 111, 459, 2167, 10150, 47920, 226532, 1071982,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 11:07:37, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;10\,a(n-1) - 35\,a(n-2) + 50\,a(n-3) + 23\,a(n-4) - 204\,a(n-5) + 114\,a(n-6) + 684\,a(n-7) - 1284\,a(n-8) - 309\,a(n-9) + 4412\,a(n-10) - 5481\,a(n-11) - 90\,a(n-12) + 4826\,a(n-13) - 3964\,a(n-14) - 3408\,a(n-15) + 3143\,a(n-16) + 3475\,a(n-17) - 3191\,a(n-18) + 7943\,a(n-19) + 2119\,a(n-20) + 1380\,a(n-21) - 8241\,a(n-22) - 8523\,a(n-23) + 3733\,a(n-24) - 79\,a(n-25) + 1925\,a(n-26) + 1275\,a(n-27) + 131\,a(n-28) - 147\,a(n-29) - 286\,a(n-30)
\]
for every $n>34$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A240786.
