...
\title{A further conjecture on OEIS A253449,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A253449 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $81, 414, 1388, 3639, 8501, 19701, 48293, 126357,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = 400*3\^{}(n-3) + 205*2\^{}(n-1) + 2917 for n>7.\end{quote}
