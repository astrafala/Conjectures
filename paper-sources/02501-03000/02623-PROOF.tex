...
\title{A further conjecture on OEIS A268972,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A268972 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $9, 60, 240, 912, 3312, 11664, 40176, 136080,\dots$, with offset $1$. The sequence satisfies
\[
  a(n)=6\,a(n-1) - 9\,a(n-2) ,
\]
...
\begin{quote}\raggedright a(n) = 16*3\^{}(n-3) * (4*n+3) for n>2.\end{quote}
