...
\title{The empirical recurrence for OEIS A263218, proved by transfer matrix}
...
\begin{abstract}
OEIS A263218 counts arrays of width $3$ over $\{0,1,2\}$ whose rows, read as base-$3$
...
OEIS A263218 is ``Number of (n+1)X(2+1) 0..2 arrays with each row and column divisible by 5, read as a base-3 number with top and left being the most significant digits.''. It has offset $1$ and begins
\[
2, 14, 72, 343, 1920, 11444, 68112, 405019,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 12 2015 11:45:24, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-1) - 16\,a(n-2) + 32\,a(n-3) + 35\,a(n-4) - 664\,a(n-5) + 1328\,a(n-6) - 2656\,a(n-7) + 3121\,a(n-8) + 6904\,a(n-9) - 13808\,a(n-10) + 27616\,a(n-11) - 40643\,a(n-12) - 6248\,a(n-13) + 12496\,a(n-14) - 24992\,a(n-15) + 37488\,a(n-16)
\]
for every $n>14$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A263218.
