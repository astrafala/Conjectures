...
\title{A further conjecture on OEIS A253153,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A253153 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $39, 72, 88, 120, 192, 336, 624, 1200,\dots$, with offset $1$. The sequence satisfies
\[
  a(n)=3\,a(n-1) - 2\,a(n-2) ,
\]
