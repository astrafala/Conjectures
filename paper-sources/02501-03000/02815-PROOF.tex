...
\title{The empirical recurrence for OEIS A223479, proved by transfer matrix}
...
\begin{abstract}
OEIS A223479 counts the ways of writing the vertices of a fixed graph $G$ into an array of width
...
OEIS A223479 is ``Rolling icosahedron face footprints: number of nX7 0..19 arrays starting with 0 where 0..19 label faces of an icosahedron and every array movement to a horizontal or antidiagonal neighbor moves across an icosahedral edge.''. It has offset $1$ and begins
\[
729, 84375, 11374425, 1588785975, 223894186425, 31621425535575, 4468456626780825, 631526586023769975,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 227*a(n-1) -14764*a(n-2) +411840*a(n-3) -5347200*a(n-4) +29600000*a(n-5) -48000000*a(n-6)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 21:44:35, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;227\,a(n-1) - 14764\,a(n-2) + 411840\,a(n-3) - 5347200\,a(n-4) + 29600000\,a(n-5) - 48000000\,a(n-6)
\]
for every $n>6$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223479.
