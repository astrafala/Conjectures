...
\title{A further conjecture on OEIS A268965,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A268965 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $9, 60, 336, 1728, 8448, 39936, 184320, 835584,\dots$, with offset $1$. The sequence satisfies
\[
