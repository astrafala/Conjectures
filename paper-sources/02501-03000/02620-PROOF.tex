...
\title{A further conjecture on OEIS A250855,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A250855 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $2670, 13097, 44797, 123016, 290646, 614965, 1195457, 2172712,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (3/2)*n\^{}6 + (74/3)*n\^{}5 + (621/4)*n\^{}4 + (3161/6)*n\^{}3 + (3691/4)*n\^{}2 + 783*n + 256.\end{quote}
