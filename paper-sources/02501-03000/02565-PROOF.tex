...
\title{A further conjecture on OEIS A266595,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A266595 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $0, 2, 2, 5, 6, 5, 10, 5,\dots$, with offset $0$. The sequence satisfies
\[
  a(n)=2\,a(n-2) - 1\,a(n-4) ,
\]
...
\begin{quote}\raggedright a(n) = (2*(-1)\^{}n*n+2*n-7*(-1)\^{}n+3)/2 for n>1.\end{quote}
