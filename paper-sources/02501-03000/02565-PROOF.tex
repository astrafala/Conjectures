...
\title{A further conjecture on OEIS A220035,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A220035 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $6, 10, 21, 55, 111, 192, 302, 442,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (1/24)*n\^{}4 - (1/12)*n\^{}3 + (95/24)*n\^{}2 + (289/12)*n - 132 for n>6.\end{quote}
...
indices, and $a$ and $f$ were checked to agree at $n=12,\dots,16$,
