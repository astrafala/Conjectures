...
\title{The empirical closed form for OEIS A223632, proved}
...
\begin{abstract}
OEIS A223632 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A223632 is ``Number of n X 3 0..1 arrays with rows, antidiagonals and columns unimodal.''. It has offset $1$ and begins
\[
7, 49, 229, 801, 2297, 5699, 12657, 25753,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (23/360)*n\^{}6 + (11/120)*n\^{}5 + (91/72)*n\^{}4 + (11/8)*n\^{}3 + (301/180)*n\^{}2 + (23/15)*n + 1.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 22 2018 02:02:02, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{23 n^{6}}{360} + \frac{11 n^{5}}{120} + \frac{91 n^{4}}{72} + \frac{11 n^{3}}{8} + \frac{301 n^{2}}{180} + \frac{23 n}{15} + 1.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223632.
