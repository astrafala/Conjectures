...
\title{A further conjecture on OEIS A219167,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A219167 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $3, 7, 23, 53, 103, 182, 302, 478,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (1/8)*n\^{}4 - (3/4)*n\^{}3 + (55/8)*n\^{}2 - (49/4)*n + 8 for n>1.\end{quote}
