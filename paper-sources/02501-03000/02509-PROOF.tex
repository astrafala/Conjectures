...
\title{A further conjecture on OEIS A235883,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A235883 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $7329, 8871, 11973, 18231, 30909, 56751, 109893, 220551,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = 3*(1932 + 127*2\^{}(1+n) + 3\^{}n).\end{quote}
