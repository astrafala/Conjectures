...
\title{The empirical recurrence for OEIS A281464, proved by transfer matrix}
...
\begin{abstract}
OEIS A281464 counts $n\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A281464 is ``Number of n X 3 0..1 arrays with no element equal to more than two of its horizontal, diagonal or antidiagonal neighbors and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 20 2019 05:30:08, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 3\,a(n-3) - 3\,a(n-4) - 4\,a(n-5) + 4\,a(n-6) - 4\,a(n-7)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A281464.
