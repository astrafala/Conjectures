...
\title{A further conjecture on OEIS A279897,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A279897 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $2, 6, 9, 20, 43, 94, 213, 456,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = (1280*(-1)\^{}n + 31*2\^{}(2+n) - 264*(-1)\^{}n*n + 33*2\^{}n*n) / 216 for n>3.\end{quote}
