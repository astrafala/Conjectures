...
\title{A further conjecture on OEIS A253438,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A253438 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $109, 108, 121, 156, 228, 372, 660, 1236,\dots$, with offset $1$. The sequence satisfies
\[
  a(n)=3\,a(n-1) - 2\,a(n-2) ,
\]
...
\begin{quote}\raggedright Empirical: a(n) = 9*2\^{}(n-1) + 84 for n>3.\end{quote}
