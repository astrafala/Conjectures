...
\title{A further conjecture on OEIS A269498,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A269498 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $66, 1609, 13946, 71115, 263794, 791381, 2039274, 4686391,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = n\^{}7 + 7*n\^{}6 + 21*n\^{}5 + 15*n\^{}4 + 7*n\^{}3 + 17*n\^{}2 - n - 1.\end{quote}
