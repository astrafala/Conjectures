...
\title{The empirical recurrence for OEIS A235541, proved by transfer matrix}
...
\begin{abstract}
OEIS A235541 counts arrays of width $2$ over $\{0,1\}$ by reducing every $2\times2$ subblock to a
...
OEIS A235541 is ``Number of (n+1) X (1+1) 0..1 arrays with the sum of each 2 X 2 subblock two median terms lexicographically nondecreasing rowwise and columnwise.''. It has offset $1$ and begins
\[
16, 48, 141, 378, 988, 2482, 6109, 14712,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) - 14*a(n-3) + 5*a(n-4) + 18*a(n-5) - 4*a(n-6) - 8*a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 19 2018 10:28:10, revision 8) this is still
...
f(B)\;=\;v_2+v_3,
\]
the sum of the two middle entries. An array with $R$ rows and $2$ columns has $(R-1)\times1$ subblocks, and they
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) - 14\,a(n-3) + 5\,a(n-4) + 18\,a(n-5) - 4\,a(n-6) - 8\,a(n-7)
\]
for every $n>5$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A235541.
