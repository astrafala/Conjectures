...
\title{Arrays counted up to renaming: the empirical recurrence for OEIS A205221}
...
\begin{abstract}
OEIS A205221 carries an empirical recurrence of order $8$ contributed by R.~H.~Hardin. It is
...
OEIS A205221 is ``Number of (n+1) X 4 0..1 arrays with the number of equal 2 X 2 subblock diagonal pairs and equal antidiagonal pairs differing from each horizontal or vertical neighbor, and new values 0..1 introduced in row major order.''. It has offset $1$ and begins
\[
52, 132, 328, 824, 2072, 5176, 13032, 32488,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 11 2018 06:32:30, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 12\,a(n-2) - 11\,a(n-3) - 47\,a(n-4) + 40\,a(n-5) + 64\,a(n-6) - 48\,a(n-7) - 8\,a(n-8)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A205221.
