...
\title{The empirical recurrence for OEIS A203981, proved by counting patterns}
...
\begin{abstract}
OEIS A203981 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A203981 is ``Number of (n+1) X 6 0..2 arrays with no 2 X 2 subblock having equal diagonal elements or equal antidiagonal elements, and new values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
1536, 31104, 629856, 13071456, 271918944, 5671161216, 118333620576, 2469841766784,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 25*a(n-1) - 45*a(n-2) - 963*a(n-3) + 2025*a(n-4) + 3645*a(n-5) - 6561*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 06 2018 05:41:11, revision 9) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A203981.
