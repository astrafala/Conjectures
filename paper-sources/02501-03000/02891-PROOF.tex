...
\title{The empirical recurrence for OEIS A266019, proved by transfer matrix}
...
\begin{abstract}
OEIS A266019 counts arrays of width $2$ in which every entry is equal to the NUMBER of its own
...
OEIS A266019 is ``Number of nX2 integer arrays with each element equal to the number of horizontal, vertical and antidiagonal neighbors exactly one smaller than itself.''. It has offset $1$ and begins
\[
3, 7, 14, 42, 99, 259, 719, 1784,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 20 2015 07:08:37, revision 4) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=402.
\]
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 2\,a(n-2) + 6\,a(n-3) - a(n-4) + 20\,a(n-5) - 25\,a(n-6) - 37\,a(n-7) - 53\,a(n-8) - 52\,a(n-9) + 47\,a(n-10) + 74\,a(n-11) + 77\,a(n-12) + 30\,a(n-13) - 29\,a(n-14) - 34\,a(n-15) - 34\,a(n-16) - a(n-17) - 6\,a(n-18) + 11\,a(n-19) + a(n-20) + a(n-21)
\]
for every $n>21$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A266019.
