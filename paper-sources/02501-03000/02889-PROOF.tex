...
\title{The empirical recurrence for OEIS A223501, proved by transfer matrix}
...
\begin{abstract}
OEIS A223501 counts the ways of writing the vertices of a fixed graph $G$ into an array of width
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 21:46:04, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;80\,a(n-1) - 1601\,a(n-2) + 9025\,a(n-3) + 32750\,a(n-4) - 458870\,a(n-5) + 1007560\,a(n-6) + 2753424\,a(n-7) - 13680802\,a(n-8) + 9570798\,a(n-9) + 33912359\,a(n-10) - 66671806\,a(n-11) + 25819908\,a(n-12) + 31393403\,a(n-13) - 30099964\,a(n-14) + 2740719\,a(n-15) + 5650986\,a(n-16) - 2070082\,a(n-17) - 348\,a(n-18) + 116444\,a(n-19) - 20740\,a(n-20) + 1120\,a(n-21)
\]
for every $n>21$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223501.
