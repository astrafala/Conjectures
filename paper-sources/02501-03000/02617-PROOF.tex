...
\title{A further conjecture on OEIS A268899,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A268899 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $12, 168, 1584, 12960, 98496, 715392, 5038848, 34712064,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = 2\^{}(n+1) * 3\^{}(n-1) * (4*n-1).\end{quote}
