...
\title{The empirical recurrence for OEIS A266013, proved by transfer matrix}
...
\begin{abstract}
OEIS A266013 counts arrays of width $3$ in which every entry is equal to the NUMBER of its own
...
OEIS A266013 is ``Number of 3Xn integer arrays with each element equal to the number of horizontal and antidiagonal neighbors equal to itself.''. It has offset $1$ and begins
\[
1, 2, 6, 4, 11, 18, 27, 43,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 20 2015 06:59:40, revision 4) this is still
...
that are equal to it: writing $v=x(i,j)$,
\[
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=881.
\]
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-3) + 2\,a(n-4) + 2\,a(n-5) + a(n-6) - 2\,a(n-7) - 2\,a(n-8) - 3\,a(n-9) + 2\,a(n-10) + 2\,a(n-11) + 5\,a(n-12) - a(n-15)
\]
for every $n>19$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A266013.
