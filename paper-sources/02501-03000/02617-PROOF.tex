...
\title{A further conjecture on OEIS A250813,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A250813 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $36, 100, 225, 441, 784, 1296, 2025, 3025,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (1/4)*n\^{}4 + (5/2)*n\^{}3 + (37/4)*n\^{}2 + 15*n + 9.\end{quote}
