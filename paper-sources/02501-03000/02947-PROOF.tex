...
\title{The empirical recurrence for OEIS A279706, proved by transfer matrix}
...
\begin{abstract}
OEIS A279706 counts $n\times5$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A279706 is ``Number of nX5 0..1 arrays with no element equal to a strict majority of its horizontal and antidiagonal neighbors and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
3, 6, 47, 385, 3245, 27346, 230128, 1936687,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 17 2016 13:20:58, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;17\,a(n-1) - 107\,a(n-2) + 388\,a(n-3) - 991\,a(n-4) + 1845\,a(n-5) - 2506\,a(n-6) + 2365\,a(n-7) - 1546\,a(n-8) + 695\,a(n-9) - 219\,a(n-10) + 44\,a(n-11) - 4\,a(n-12)
\]
for every $n>13$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A279706.
