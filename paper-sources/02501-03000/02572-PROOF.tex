...
\title{A further conjecture on OEIS A266663,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A266663 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $1, 3, 5, 10, 12, 21, 23, 36,\dots$, with offset $0$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = (n\^{}2-(-1)\^{}n*n+2*n+(-1)\^{}n+3)/2 for n>0.\end{quote}
