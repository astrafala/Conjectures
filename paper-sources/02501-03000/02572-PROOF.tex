...
\title{The empirical recurrence for OEIS A263870, proved by transfer matrix}
...
\begin{abstract}
OEIS A263870 counts arrays of width $6$ over $\{0,1\}$ whose rows, read as base-$2$
numbers, are divisible by $3$ and whose columns, read the same way, are divisible by
$3$. The entry carries an empirical recurrence of order $37$ contributed by
...
is then a walk count on $S=1688$ states.
\end{abstract}
...
OEIS A263870 is ``Number of (n+1)X(5+1) 0..1 arrays with each row and column divisible by 3, read as a binary number with top and left being the most significant bits, and rows and columns lexicographically nondecreasing.''. It has offset $1$ and begins
\[
4, 4, 14, 16, 61, 93, 494, 975,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 28 2015 11:48:09, revision 4) this is still
...
The entry adds that the rows and the columns are each in lexicographic nondecreasing order. Comparing
...
So the vector $\bigl(\gamma_1\bmod 3,\dots,\gamma_{6}\bmod
3\bigr)$ is a state: at most $3^{6}$ of them, and each array row
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=1688.
\]
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 18\,a(n-2) - 18\,a(n-3) - 153\,a(n-4) + 153\,a(n-5) + 816\,a(n-6) - 816\,a(n-7) - 3060\,a(n-8) + 3060\,a(n-9) + 8568\,a(n-10) - 8568\,a(n-11) - 18564\,a(n-12) + 18564\,a(n-13) + 31824\,a(n-14) - 31824\,a(n-15) - 43758\,a(n-16) + 43758\,a(n-17) + 48620\,a(n-18) - 48620\,a(n-19) - 43758\,a(n-20) + 43758\,a(n-21) + 31824\,a(n-22) - 31824\,a(n-23) - 18564\,a(n-24) + 18564\,a(n-25) + 8568\,a(n-26) - 8568\,a(n-27) - 3060\,a(n-28) + 3060\,a(n-29) + 816\,a(n-30) - 816\,a(n-31) - 153\,a(n-32) + 153\,a(n-33) + 18\,a(n-34) - 18\,a(n-35) - a(n-36) + a(n-37)
\]
for every $n>35$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A263870.
