...
\title{A further conjecture on OEIS A240001,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A240001 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $5, 13, 25, 42, 65, 95, 133, 180,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (1/6)*n\^{}3 + 1*n\^{}2 + (23/6)*n.\end{quote}
