...
\title{A further conjecture on OEIS A220155,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A220155 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $10, 26, 77, 254, 645, 1413, 2841, 5412,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (1/362880)*n\^{}9 + (1/40320)*n\^{}8 - (11/60480)*n\^{}7 - (49/2880)*n\^{}6 + (10837/17280)*n\^{}5 - (30473/5760)*n\^{}4 + (1003267/45360)*n\^{}3 + (41353/3360)*n\^{}2 - (594077/2520)*n + 361 for n>6\end{quote}
...
indices, and $a$ and $f$ were checked to agree at $n=17,\dots,26$,
