...
\title{The empirical recurrence for OEIS A268780, proved by transfer matrix}
...
\begin{abstract}
OEIS A268780 counts arrays of width $7$ over $\{0,1\}$ in which the number of adjacent PAIRS of
...
OEIS A268780 is ``Number of n X 7 binary arrays with some element plus some horizontally, vertically, diagonally or antidiagonally adjacent neighbor totalling two no more than once.''. It has offset $1$ and begins
\[
72, 766, 10615, 115391, 1288693, 13493468, 140404442, 1425678976,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 04 2021 15:33:02, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268780.
