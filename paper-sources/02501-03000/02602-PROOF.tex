...
\title{A further conjecture on OEIS A267457,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A267457 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $1, 2, 4, 8, 84, 168, 1364, 2728,\dots$, with offset $0$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = (3*4\^{}n + 8*(-1)\^{}n + (-4)\^{}n - 24)/12 for n > 1.\end{quote}
