...
\title{A further conjecture on OEIS A250818,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A250818 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $13449, 42769, 102393, 207831, 377857, 634509, 1003089, 1512163,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = 136*n\^{}4 + 1225*n\^{}3 + 4402*n\^{}2 + 5499*n + 2187.\end{quote}
