...
\title{The empirical recurrence for OEIS A275396, proved by counting patterns}
...
\begin{abstract}
OEIS A275396 counts arrays in which no entry may repeat a value found at any of three stated
...
cutting $794$ pairs to $S=155$ states. The entry's empirical recurrence of order $24$,
...
OEIS A275396 is ``Number of nX3 0..2 arrays with no element equal to any value at offset (-2,-1) (-2,0) or (-1,1) and new values introduced in order 0..2.''. It has offset $1$ and begins
\[
5, 54, 84, 178, 394, 1017, 2645, 6980,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 26 2016 14:50:06, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 4\,a(n-2) - 19\,a(n-3) + a(n-4) + 65\,a(n-5) - 47\,a(n-6) - 99\,a(n-7) + 83\,a(n-8) + 66\,a(n-9) - 4\,a(n-10) - 60\,a(n-11) - 73\,a(n-12) + 36\,a(n-13) + 121\,a(n-14) - 88\,a(n-15) + 13\,a(n-16) + 8\,a(n-17) - 19\,a(n-18) + 20\,a(n-19) - 7\,a(n-20) - a(n-21) + 2\,a(n-22) - a(n-23) + a(n-24)
\end{equation}
for all $n>28$.
...
$o=1n_0+0-2$, we have for $j\ge24$
\[
3!\Bigl(a(n_0+j)-\sum_i c_i\,a(n_0+j-i)\Bigr)
=\mathbf{v}^{\!\top}G^{\,j-24}w,\qquad
w=h_{24}-\sum_i c_i h_{24-i} .
\]
...
the survivors by the pattern of the new pair. The vector $w$ was formed by $24$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A275396.
