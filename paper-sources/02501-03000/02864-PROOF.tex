...
\title{The empirical recurrence for OEIS A210167, proved by transfer matrix}
...
\begin{abstract}
OEIS A210167 counts arrays of width $2$ whose every $2\times2$ subblock holds a
prescribed number of DISTINCT values, which use ALL of the $4$ available letters, and which
are counted up to renaming. The entry carries an empirical recurrence of order $5$
...
nothing else. Each fixed-alphabet count is a walk count on $S=30$ states in all.
\end{abstract}
...
OEIS A210167 is ``Number of (n+1) X 2 0..3 arrays containing all values 0..3 with every 2 X 2 subblock having two or four distinct values, and new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
1, 10, 101, 910, 7545, 59178, 447429, 3300982,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 14*a(n-1) - 55*a(n-2) + 22*a(n-3) + 132*a(n-4) + 56*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 15 2018 06:53:20, revision 9) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The array has $2$ cells across and entries in $\{0,1,\dots,3\}$. In every
...
\begin{theorem}
\[
a(n)\;=\;14\,a(n-1) - 55\,a(n-2) + 22\,a(n-3) + 132\,a(n-4) + 56\,a(n-5)
\]
for every $n>5$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A210167.
