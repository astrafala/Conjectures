...
\title{A further conjecture on OEIS A219916,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A219916 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $6, 7, 24, 64, 147, 308, 606, 1144,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (1/362880)*n\^{}9 - (1/10080)*n\^{}8 + (139/60480)*n\^{}7 - (23/720)*n\^{}6 + (5917/17280)*n\^{}5 - (3307/1440)*n\^{}4 + (921359/90720)*n\^{}3 - (391/35)*n\^{}2 - (76861/1260)*n + 182 for n>5.\end{quote}
...
indices, and $a$ and $f$ were checked to agree at $n=16,\dots,25$,
