...
\title{A further conjecture on OEIS A266438,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A266438 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $1, 4, 4, 11, 11, 22, 22, 37,\dots$, with offset $0$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = (n\^{}2+2*n-(-1)\^{}n*(n+1)+3)/2.\end{quote}
...
indices, and $a$ and $f$ were checked to agree at $n=5,\dots,9$,
