...
\title{A further conjecture on OEIS A267052,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A267052 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $1, 3, 7, 11, 23, 43, 87, 171,\dots$, with offset $0$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = (3+2*(-1)\^{}n+2\^{}(2+n))/3 for n>0.\end{quote}
