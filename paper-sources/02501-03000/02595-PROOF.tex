...
\title{A further conjecture on OEIS A250761,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A250761 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $9585, 22197, 40023, 63063, 91317, 124785, 163467, 207363,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = 2607*n\^{}2 + 4791*n + 2187.\end{quote}
