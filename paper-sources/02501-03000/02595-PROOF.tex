...
\title{A further conjecture on OEIS A250608,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A250608 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $247, 586, 1153, 2092, 3691, 6526, 11749, 21664,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = 144*2\^{}(n-1) + 42*n\^{}2 + 69*n - 8.\end{quote}
