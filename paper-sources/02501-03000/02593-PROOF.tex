...
\title{A further conjecture on OEIS A267049,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A267049 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $0, 1, 4, 7, 11, 14, 22, 25,\dots$, with offset $0$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = (n\^{}2+(-1)\^{}n*(n-3)+5)/2 for n>1.\end{quote}
