...
\title{The empirical column recurrences for the table OEIS A260001}
...
\begin{abstract}
OEIS A260001 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A260001 is ``T(n,k)=Number of (n+2)X(k+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000001 00000011 or 00000101.''. It has offset $1$, is
read by antidiagonals, and begins
\[
48, 99, 99, 284, 269, 284, 641, 805,\ \dots
\]
The entry carries the following block:
\begin{quote}\small
Empirical for column k:\\
k=1: a(n) = a(n-1) +5*a(n-3) +7*a(n-4) -7*a(n-5) -5*a(n-7)\\
k=2: [order 14]\\
k=3: [order 19] for n>22\\
k=4: [order 26] for n>30\\
k=5: [order 58] for n>62\\
k=6: [order 96] for n>102\\
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:58:27, revision 6) these are still
...
The sequence is ``Number of (n+2)X(3) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000001 00000011 or 00000101.''. Its rows are the vertices of a digraph on
...
$c_{1}$ & $1$ & $c_{5}$ & $-19$ & $c_{9}$ & $25$ & $c_{13}$ & $9$ \\
$c_{2}$ & $2$ & $c_{6}$ & $-33$ & $c_{10}$ & $13$ & $c_{14}$ & $8$ \\
$c_{3}$ & $10$ & $c_{7}$ & $-45$ & $c_{11}$ & $5$ &  &  \\
$c_{4}$ & $5$ & $c_{8}$ & $-1$ & $c_{12}$ & $3$ &  &  \\
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A260001.
