...
\title{The empirical recurrence for OEIS A209097, proved by counting patterns}
...
\begin{abstract}
OEIS A209097 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A209097 is ``Number of n X 5 0..2 arrays with new values 0..2 introduced in row major order and no element equal to more than one of its immediate leftward or upward or right-upward antidiagonal neighbors.''. It has offset $1$ and begins
\[
41, 3552, 329064, 30836932, 2896732704, 272236743760, 25586970618660, 2404896311723064,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 22 2023 14:48:53, revision 7) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;121\,a(n-1) - 2777\,a(n-2) + 23322\,a(n-3) - 88925\,a(n-4) + 181863\,a(n-5) - 277613\,a(n-6) + 499822\,a(n-7) - 787540\,a(n-8) + 679392\,a(n-9) - 232128\,a(n-10)
\end{equation}
for all $n>12$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209097.
