...
\title{A further conjecture on OEIS A202440,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A202440 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $80, 138, 224, 338, 484, 666, 888, 1154,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (2/3)*n\^{}3 + 8*n\^{}2 + (100/3)*n + 34 for n>1.\end{quote}
