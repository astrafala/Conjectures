...
\title{A further conjecture on OEIS A188790,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A188790 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $0, 9984, 748128, 5886720, 22274448, 59693952, 130988744, 252065024,\dots$, with offset $1$. The sequence satisfies
\[
  a(n)=5\,a(n-1) - 10\,a(n-2) + 10\,a(n-3) - 5\,a(n-4) + 1\,a(n-5) ,
\]
a linear recurrence of order $5$ with characteristic polynomial
\[
  q(x)=x^{5} - 5 x^{4} + 10 x^{3} - 10 x^{2} + 5 x - 1 .
\]
...
\begin{quote}\raggedright Empirical: a(n) = 127160*n\^{}4 - 654960*n\^{}3 + 1132704*n\^{}2 - 762240*n + 162048 for n>5.\end{quote}
...
indices, and $a$ and $f$ were checked to agree at $n=11,\dots,15$,
