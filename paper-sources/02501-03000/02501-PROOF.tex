...
\title{A further conjecture on OEIS A233078,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A233078 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $14, 662, 32414, 1588262, 77824814, 3813415862, 186857377214, 9156011483462,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = (49 + 27*49\^{}n) / 98.\end{quote}
