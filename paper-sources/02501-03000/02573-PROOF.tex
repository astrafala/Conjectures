...
\title{A further conjecture on OEIS A220198,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A220198 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $4, 10, 38, 103, 245, 547, 1168, 2395,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (1/20160)*n\^{}8 - (1/5040)*n\^{}7 - (1/480)*n\^{}6 + (107/720)*n\^{}5 - (1151/960)*n\^{}4 + (278/45)*n\^{}3 - (54427/5040)*n\^{}2 + (5323/420)*n - 7 for n>1.\end{quote}
