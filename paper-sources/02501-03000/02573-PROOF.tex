...
\title{The empirical recurrence for OEIS A263593, proved by transfer matrix}
...
\begin{abstract}
OEIS A263593 carries an empirical recurrence of order $15$ contributed by R.~H.~Hardin. It is
true, and it is decidable rather than empirical. The entry's condition is local to a bounded window of consecutive lines, so
the admissible configurations of such a window are the vertices of a finite digraph and the
arrays counted are exactly the walks in it; hence $a(n)$ is a walk count on $S=1420$ vertices
...
OEIS A263593 is ``Number of length n arrays of permutations of 0..n-1 with each element moved by -4 to 4 places and the median of every three consecutive elements nondecreasing.''. It has offset $1$ and begins
\[
1, 2, 6, 16, 52, 164, 476, 1428,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 22 2015 12:41:56, revision 4) this is still
...
admissible array is then exactly a walk, so with $M$ the adjacency matrix on $S=1420$ vertices
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + a(n-2) + 12\,a(n-3) + 5\,a(n-4) + 7\,a(n-5) + 2\,a(n-6) + 17\,a(n-7) + 31\,a(n-8) - 9\,a(n-9) - 14\,a(n-10) + 10\,a(n-11) - 22\,a(n-12) - 4\,a(n-13) - 4\,a(n-15)
\]
for every $n>0$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A263593.
