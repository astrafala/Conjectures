...
\title{The empirical column recurrences for the table OEIS A235548}
...
\begin{abstract}
OEIS A235548 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A235548 is ``T(n,k)=Number of (n+1)X(k+1) 0..1 arrays with the sum of each 2X2 subblock two median terms lexicographically nondecreasing rowwise and columnwise.''. It has offset $1$, is
read by antidiagonals, and begins
\[
16, 48, 48, 141, 222, 141, 378, 1049,\ \dots
\]
...
k=3: [order 77]\\
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 08:37:42, revision 6) these are still
...
The sequence is ``Number of (n+1)X2 0..1 arrays with the sum of each 2X2 subblock two median terms lexicographically nondecreasing rowwise and columnwise.''. Its rows are the vertices of a digraph on
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A235548.
