...
\title{The empirical closed form for OEIS A224025, proved}
...
\begin{abstract}
OEIS A224025 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A224025 is ``Number of 3 X n 0..3 arrays with rows nondecreasing and antidiagonals unimodal.''. It has offset $1$ and begins
\[
64, 1000, 6796, 32523, 122523, 387729, 1074167, 2679260,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 26 2018 09:50:44, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{353 n^{9}}{181440} + \frac{5 n^{8}}{126} + \frac{12287 n^{7}}{30240} + \frac{131 n^{6}}{60} + \frac{64877 n^{5}}{8640} + \frac{135 n^{4}}{8} + \frac{998257 n^{3}}{45360} + \frac{53933 n^{2}}{2520} + \frac{3421 n}{252} - 2.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224025.
