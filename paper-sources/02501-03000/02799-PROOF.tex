...
\title{A further conjecture on OEIS A283590,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A283590 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $1, 0, 101, 111, 1111, 11111, 111111, 1111111,\dots$, with offset $0$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = (10\^{}n - 1)/9 for n>2.\end{quote}
