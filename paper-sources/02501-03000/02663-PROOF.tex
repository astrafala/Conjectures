...
\title{A further conjecture on OEIS A253498,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A253498 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $3639, 4720, 6931, 10477, 18526, 37469, 82676, 194708,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = 400*3\^{}(n-3) + 738*2\^{}(n-1) + 3044 for n>6.\end{quote}
