...
\title{A further conjecture on OEIS A219829,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A219829 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $10, 13, 38, 87, 176, 370, 721, 1374,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (1/40320)*n\^{}8 - (1/3360)*n\^{}7 - (1/2880)*n\^{}6 + (31/240)*n\^{}5 - (7913/5760)*n\^{}4 + (2933/480)*n\^{}3 + (12179/1120)*n\^{}2 - (33527/280)*n + 202 for n>8\end{quote}
...
indices, and $a$ and $f$ were checked to agree at $n=18,\dots,26$,
