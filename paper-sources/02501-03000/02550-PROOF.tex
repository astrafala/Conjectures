...
\title{A further conjecture on OEIS A266286,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A266286 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $0, 2, 3, 3, 6, 4, 9, 5,\dots$, with offset $0$. The sequence satisfies
\[
  a(n)=2\,a(n-2) - 1\,a(n-4) ,
\]
...
\begin{quote}\raggedright a(n) = (2*((-1)\^{}n+2)*n-3*(-1)\^{}n+3)/4.\end{quote}
