...
\title{The empirical closed form for OEIS A185471, proved}
...
\begin{abstract}
OEIS A185471 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
$S=2066$ vertices. Any function of the form $\sum_j p_j(n)\lambda_j^{\,n}$ satisfies the
...
OEIS A185471 is ``Number of (n+2)X5 0..2 arrays with each 3X3 subblock having rows and columns in lexicographically nondecreasing order.''. It has offset $1$ and begins
\[
13659, 76309, 308692, 1043186, 3097348, 8297059, 20411234, 46732687,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 03:00:21, revision 9) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{n^{13}}{444787200} + \frac{107 n^{12}}{479001600} + \frac{11 n^{11}}{1088640} + \frac{3623 n^{10}}{6220800} + \frac{78227 n^{9}}{3628800} + \frac{6420917 n^{8}}{14515200} + \frac{148481 n^{7}}{27216} + \frac{1861160843 n^{6}}{43545600} + \frac{4966108109 n^{5}}{21772800} + \frac{1448539279 n^{4}}{1555200} + \frac{3663351401 n^{3}}{1330560} + \frac{2013261953 n^{2}}{415800} + \frac{15650889 n}{3640} + 556.
\]
...
walk, so with $M$ the adjacency matrix of that digraph on $S=2066$ vertices, and $u,w$ the
...
$n=15,\dots,28$ and agree at each. A monic recurrence of order $14$
determines $a(m)$ from $a(m-1),\dots,a(m-14)$, and for every $m\ge29$ both
$m>14$ and $m-14\ge15$ hold, so induction on $m$ gives $a(m)=f(m)$ for every
$m\ge15$.
Below $n=15$ the recurrence argument gives nothing, since \eqref{eq:rec} is only
established for $a$ from $n=15$ on. The remaining indices $n=1,\dots,14$ were
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A185471.
