...
\title{The empirical closed form for OEIS A184545, proved}
...
\begin{abstract}
OEIS A184545 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
$S=7464$ vertices. Any function of the form $\sum_j p_j(n)\lambda_j^{\,n}$ satisfies the
...
OEIS A184545 is ``Number of (n+2) X 8 binary arrays with each 3 X 3 subblock having rows and columns in lexicographically nondecreasing order.''. It has offset $1$ and begins
\[
415, 1114, 2413, 4774, 8989, 16345, 28844, 49489,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 14 2018 02:37:12, revision 12) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{n^{8}}{40320} + \frac{13 n^{7}}{10080} + \frac{83 n^{6}}{2880} + \frac{13 n^{5}}{36} + \frac{15967 n^{4}}{5760} + \frac{19201 n^{3}}{1440} + \frac{121183 n^{2}}{1120} + \frac{12673 n}{56} + 64.
\]
...
walk, so with $M$ the adjacency matrix of that digraph on $S=7464$ vertices, and $u,w$ the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A184545.
