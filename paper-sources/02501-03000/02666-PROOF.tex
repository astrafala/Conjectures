...
\title{The empirical recurrence for OEIS A252860, proved by transfer matrix}
...
\begin{abstract}
OEIS A252860 counts arrays of width $9$ over an alphabet of $3$ letters in which every three
...
brings the state count down to $S=227234$.
\end{abstract}
...
OEIS A252860 is ``Number of (n+2)X(7+2) 0..2 arrays with every consecutive three elements in every row, column, diagonal and antidiagonal having exactly two distinct values, and new values 0 upwards introduced in row major order.''. It has offset $1$ and begins
\[
29241, 9936, 12762, 26766, 58644, 126306, 275598, 596250,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:42:22, revision 6) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The array has width $9$ and entries in $\{0,1,\dots,2\}$. Four families of triples
...
That digraph has up to $i^{2\cdot9}$ vertices, which is more than can be written down for
...
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,
\]
with $S=227234$ states in all. The walk index $j$ and the entry's own $n$ differ by a constant,
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 4\,a(n-2) - 2\,a(n-3) + 4\,a(n-4) - 4\,a(n-5) - 29\,a(n-6) + 5\,a(n-7) + 4\,a(n-8) + 75\,a(n-10) + 79\,a(n-11) - 11\,a(n-12) - 163\,a(n-13) - 167\,a(n-14) + 3\,a(n-15) + 123\,a(n-16) + 135\,a(n-17) + 58\,a(n-18) + 4\,a(n-19) - 32\,a(n-20) - 39\,a(n-21) - 84\,a(n-22) - 61\,a(n-23) + 26\,a(n-24) + 47\,a(n-25) + 62\,a(n-26) - 3\,a(n-27) - 17\,a(n-28) - 21\,a(n-29) - 4\,a(n-30) + 6\,a(n-31) + a(n-32) + 2\,a(n-33) - a(n-34)
\]
for every $n>36$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252860.
