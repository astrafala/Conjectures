...
\title{A further conjecture on OEIS A251270,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A251270 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $108, 480, 1667, 4930, 13052, 31936, 73805, 163604,\dots$, with offset $1$. The sequence satisfies
\[
...
\[
  q(x)=x^{8} - 9 x^{7} + 35 x^{6} - 77 x^{5} + 105 x^{4} - 91 x^{3} + 49 x^{2} - 15 x + 2 .
\]
...
\begin{quote}\raggedright a(n) = (5760*(25*2\^{}(1 + n)-49) - 186828*n - 57236*n\^{}2 - 9885*n\^{}3 - 905*n\^{}4 - 27*n\^{}5 + n\^{}6) / 360.\end{quote}
...
\[
  p(x)=x^{8} - 9 x^{7} + 35 x^{6} - 77 x^{5} + 105 x^{4} - 91 x^{3} + 49 x^{2} - 15 x + 2 ,
\]
