...
\title{A further conjecture on OEIS A219520,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A219520 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $4, 6, 11, 24, 43, 70, 111, 172,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (1/24)*n\^{}4 - (1/12)*n\^{}3 - (13/24)*n\^{}2 + (151/12)*n - 22 for n>4.\end{quote}
...
indices, and $a$ and $f$ were checked to agree at $n=10,\dots,14$,
