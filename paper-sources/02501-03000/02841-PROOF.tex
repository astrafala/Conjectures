...
\title{The empirical closed form for OEIS A224041, proved}
...
\begin{abstract}
OEIS A224041 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A224041 is ``Number of 5 X n 0..1 arrays with antidiagonals unimodal and rows and diagonals nondecreasing.''. It has offset $1$ and begins
\[
32, 144, 298, 488, 734, 1064, 1505, 2091,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (1/120)*n\^{}5 + (1/24)*n\^{}4 + (25/24)*n\^{}3 + (227/24)*n\^{}2 + (1289/20)*n - 7 for n>3.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 26 2018 11:11:44, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{n^{5}}{120} + \frac{n^{4}}{24} + \frac{25 n^{3}}{24} + \frac{227 n^{2}}{24} + \frac{1289 n}{20} - 7.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224041.
