...
\title{The empirical recurrence for OEIS A268015, proved by transfer matrix}
...
\begin{abstract}
OEIS A268015 counts arrays in which the REPEATED VALUES of each row, and of each column, stand in a
...
value so far in each column of the scan, so the count is a walk count on $S=1729$ states.
\end{abstract}
...
OEIS A268015 is ``Number of nX3 0..2 arrays with every repeated value in every row and column greater than or equal to the previous repeated value.''. It has offset $1$ and begins
\[
27, 729, 19683, 474552, 10941048, 240641848, 5106219048, 105087226959,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 24 2016 09:54:44, revision 4) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=1729,\quad\tau=\mathbf{1} .
\]
...
\begin{theorem}
\[
a(n)\;=\;84\,a(n-1) - 2814\,a(n-2) + 45276\,a(n-3) - 285019\,a(n-4) - 1063944\,a(n-5) + 20124468\,a(n-6) - 1605816\,a(n-7) - 630123753\,a(n-8) - 402925572\,a(n-9) + 10392502302\,a(n-10) + 30566899188\,a(n-11) + 12457260613\,a(n-12) - 49186967088\,a(n-13) - 30986023080\,a(n-14) + 49186967088\,a(n-15) + 12457260613\,a(n-16) - 30566899188\,a(n-17) + 10392502302\,a(n-18) + 402925572\,a(n-19) - 630123753\,a(n-20) + 1605816\,a(n-21) + 20124468\,a(n-22) + 1063944\,a(n-23) - 285019\,a(n-24) - 45276\,a(n-25) - 2814\,a(n-26) - 84\,a(n-27) - a(n-28)
\]
for every $n>27$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268015.
