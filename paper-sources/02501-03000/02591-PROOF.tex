...
\title{A further conjecture on OEIS A267047,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A267047 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $1, 3, 5, 9, 14, 22, 27, 39,\dots$, with offset $0$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = (n\^{}2+4*n-(-1)\^{}n*(n-3)-3)/2 for n>1.\end{quote}
