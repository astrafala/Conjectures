...
\title{A further conjecture on OEIS A250605,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A250605 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $26, 64, 140, 290, 586, 1172, 2336, 4654,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = 36*2\^{}(n-1) + n\^{}2 - n - 10.\end{quote}
