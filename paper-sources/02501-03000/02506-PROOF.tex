...
\title{A further conjecture on OEIS A235880,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A235880 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $339, 537, 951, 1833, 3759, 8097, 18231, 42873,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = 3*(50 + 15*2\^{}(1+n) + 3\^{}n).\end{quote}
