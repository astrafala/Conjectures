...
\title{A further conjecture on OEIS A219700,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A219700 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $4, 7, 25, 64, 158, 374, 841, 1789,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (1/20160)*n\^{}8 - (1/1680)*n\^{}7 + (1/160)*n\^{}6 + (5/48)*n\^{}5 - (2431/960)*n\^{}4 + (1173/40)*n\^{}3 - (874309/5040)*n\^{}2 + (3728/7)*n - 647 for n>4.\end{quote}
