...
\title{An exact count for OEIS A228742: windowed medians over a growing alphabet}
...
\begin{abstract}
OEIS A228742 counts the arrays obtainable as the medians of $3$ adjacent elements of a length
...
The entry's first terms are $28, 185, 696, 1943, 4504, 9191, 17088, 29589,\dots$ and it states

\begin{quote}\raggedright Empirical: a(n) = (n+1)*(19*n\^{}4+186*n\^{}3+349*n\^{}2+226*n+60)/60.\end{quote}
...
\[
  \lvert\Phi(\{0,\dots,n\}^k)\rvert
  = 1\binom{n+1}{1} + 26\binom{n+1}{2} + 104\binom{n+1}{3} + 120\binom{n+1}{4} + 38\binom{n+1}{5} \;+\; 0
  = \frac{19 n^{5}}{60} + \frac{41 n^{4}}{12} + \frac{107 n^{3}}{12} + \frac{115 n^{2}}{12} + \frac{143 n}{30} + 1 .
\]

\section{Conclusion}

The right-hand side is the polynomial the entry states, so the empirical claim of OEIS A228742 is
