...
\title{A further conjecture on OEIS A266223,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A266223 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $0, 1, 6, 6, 15, 15, 28, 28,\dots$, with offset $0$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = 1/2*(n+1)*(n+(-1)\^{}n+1) for n>0.\end{quote}
