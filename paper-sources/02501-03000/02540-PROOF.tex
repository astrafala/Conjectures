...
\title{The empirical closed form for OEIS A224160, proved}
...
\begin{abstract}
OEIS A224160 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A224160 is ``Number of 4 X n 0..1 arrays with diagonals and rows unimodal and antidiagonals nondecreasing.''. It has offset $1$ and begins
\[
16, 108, 281, 574, 1156, 2271, 4339, 8008,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 28 2018 15:36:58, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{n^{8}}{40320} - \frac{n^{7}}{10080} + \frac{31 n^{6}}{2880} + \frac{43 n^{5}}{720} + \frac{3527 n^{4}}{5760} - \frac{5947 n^{3}}{1440} + \frac{548119 n^{2}}{10080} - \frac{119221 n}{840} + 283.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224160.
