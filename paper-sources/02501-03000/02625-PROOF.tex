...
\title{A further conjecture on OEIS A250854,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A250854 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $543, 2457, 8037, 21436, 49599, 103293, 198297, 356752,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (2/9)*n\^{}6 + (47/12)*n\^{}5 + (953/36)*n\^{}4 + (1141/12)*n\^{}3 + (6527/36)*n\^{}2 + 172*n + 64.\end{quote}
