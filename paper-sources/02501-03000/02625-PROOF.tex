...
\title{A further conjecture on OEIS A269270,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A269270 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $4, 108, 1620, 20412, 236196, 2598156, 27634932, 286978140,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = 9\^{}(n-1) * (8*n-4).\end{quote}
