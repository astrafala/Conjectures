...
\title{The empirical recurrence for OEIS A268999, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A268999 counts arrays over $\{0,\dots,1\}$ subject to a condition on the array as a
...
OEIS A268999 is ``Number of 5Xn binary arrays with some element plus some horizontally or antidiagonally adjacent neighbor totalling two not more than once.''. It has offset $1$ and begins
\[
32, 379, 4083, 43512, 421450, 4097199, 38241770, 354861630,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 17 2016 07:30:45, revision 4) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268999.
