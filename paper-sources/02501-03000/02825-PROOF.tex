...
\title{A further conjecture on OEIS A284485,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A284485 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $1, 0, 7, 11, 15, 47, 63, 191,\dots$, with offset $0$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = (-4 - (-2)\^{}n + 5*2\^{}n)/4 for n>2.\end{quote}
