...
\title{A further conjecture on OEIS A267262,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A267262 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $0, 1, 3, 5, 9, 13, 20, 24,\dots$, with offset $0$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = (n\^{}2+(-1)\^{}n*(n-4)+2)/2 for n>3.\end{quote}
