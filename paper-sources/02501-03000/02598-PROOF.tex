...
\title{The empirical recurrence for OEIS A268779, proved by transfer matrix}
...
\begin{abstract}
OEIS A268779 counts arrays of width $6$ over $\{0,1\}$ in which the number of adjacent PAIRS of
...
result is a walk count on $S=127$ states.
\end{abstract}
...
OEIS A268779 is ``Number of nX6 binary arrays with some element plus some horizontally, vertically, diagonally or antidiagonally adjacent neighbor totalling two no more than once.''. It has offset $1$ and begins
\[
41, 343, 3354, 27531, 224960, 1755113, 13493468, 101738555,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 13 2016 09:47:24, revision 4) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The array has $6$ cells across, with entries in $\{0,1\}$. An ADJACENT PAIR is a pair of cells
\[
\begin{array}{l}
$(i,j)\text{ and }(i,j{+}1)$ \\
$(i,j)\text{ and }(i{+}1,j)$ \\
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=127.
\]
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) + 51\,a(n-2) - 214\,a(n-3) - 1074\,a(n-4) + 2018\,a(n-5) + 7713\,a(n-6) - 10572\,a(n-7) - 22926\,a(n-8) + 30116\,a(n-9) + 25283\,a(n-10) - 32400\,a(n-11) - 15148\,a(n-12) + 15184\,a(n-13) + 5660\,a(n-14) - 2688\,a(n-15) - 1024\,a(n-16)
\]
for every $n>15$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268779.
