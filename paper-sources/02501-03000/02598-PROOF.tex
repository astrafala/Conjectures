...
\title{A further conjecture on OEIS A250657,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A250657 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $39, 70, 109, 156, 211, 274, 345, 424,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = 4*n\^{}2 + 19*n + 16\end{quote}
