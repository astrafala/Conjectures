...
\title{A further conjecture on OEIS A250816,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A250816 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $1389, 4321, 10233, 20631, 37333, 62469, 98481, 148123,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = 13*n\^{}4 + 121*n\^{}3 + 439*n\^{}2 + 573*n + 243.\end{quote}
