...
\title{The empirical recurrence for OEIS A268765, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A268765 counts arrays over $\{0,\dots,1\}$ subject to a condition on the array as a
...
OEIS A268765 is ``Number of nX7 binary arrays with some element plus some horizontally, vertically, diagonally or antidiagonally adjacent neighbor totalling two exactly once.''. It has offset $1$ and begins
\[
38, 595, 8500, 99057, 1129042, 12111209, 127676872, 1312123185,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 13 2016 07:37:40, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;12\,a(n-1) + 64\,a(n-2) - 942\,a(n-3) - 1476\,a(n-4) + 26868\,a(n-5) + 2249\,a(n-6) - 376788\,a(n-7) + 333472\,a(n-8) + 2686292\,a(n-9) - 4376424\,a(n-10) - 8985248\,a(n-11) + 21881197\,a(n-12) + 12658940\,a(n-13) - 55768960\,a(n-14) + 923990\,a(n-15) + 80699088\,a(n-16) - 25850884\,a(n-17) - 69171189\,a(n-18) + 34934900\,a(n-19) + 34833816\,a(n-20) - 22502076\,a(n-21) - 9502460\,a(n-22) + 7752808\,a(n-23) + 1023260\,a(n-24) - 1356480\,a(n-25) + 55136\,a(n-26) + 94080\,a(n-27) - 14400\,a(n-28)
\end{equation}
for all $n>28$.
...
those integers vanishes from the index corresponding to $n=28+1$ onwards, and the run
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268765.
