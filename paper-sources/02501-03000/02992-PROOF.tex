...
\title{The empirical closed form for OEIS A209648, proved}
...
\begin{abstract}
OEIS A209648 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A209648 is ``Number of n X 6 0..1 arrays avoiding 0 0 1 and 1 0 0 horizontally and 0 0 1 and 1 0 1 vertically.''. It has offset $1$ and begins
\[
22, 484, 2354, 7128, 16830, 34012, 61754, 103664,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 22*n\^{}4 + (88/3)*n\^{}3 - 22*n\^{}2 - (22/3)*n.
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 12 2018 08:55:48, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;22 n^{4} + \frac{88 n^{3}}{3} - 22 n^{2} - \frac{22 n}{3}.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209648.
