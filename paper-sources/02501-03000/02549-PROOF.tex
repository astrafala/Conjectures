...
\title{A further conjecture on OEIS A266285,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A266285 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $1, 1, 2, 4, 3, 7, 4, 10,\dots$, with offset $0$. The sequence satisfies
\[
  a(n)=2\,a(n-2) - 1\,a(n-4) ,
\]
...
\begin{quote}\raggedright a(n) = ((-1)\^{}n*(3-2*n)+4*n+1)/4.\end{quote}
