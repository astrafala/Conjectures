...
\title{A further conjecture on OEIS A219817,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A219817 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $6, 16, 62, 165, 377, 795, 1588, 3039,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (1/362880)*n\^{}9 - (1/40320)*n\^{}8 + (13/60480)*n\^{}7 + (1/2880)*n\^{}6 + (305/3456)*n\^{}5 - (1927/5760)*n\^{}4 + (25129/45360)*n\^{}3 + (58243/3360)*n\^{}2 - (135179/2520)*n + 58 for n>3.\end{quote}
...
indices, and $a$ and $f$ were checked to agree at $n=14,\dots,23$,
