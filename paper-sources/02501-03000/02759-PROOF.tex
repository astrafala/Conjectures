...
\title{The empirical recurrence for OEIS A268761, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A268761 counts arrays over $\{0,\dots,1\}$ subject to a condition on the array as a
...
OEIS A268761 is ``Number of n X 3 binary arrays with some element plus some horizontally, vertically, diagonally or antidiagonally adjacent neighbor totalling two exactly once.''. It has offset $1$ and begins
\[
2, 15, 56, 223, 762, 2607, 8500, 27411,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 4*a(n-1) + 2*a(n-2) - 16*a(n-3) - a(n-4) + 12*a(n-5) - 4*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 14 2019 09:02:01, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) + 2\,a(n-2) - 16\,a(n-3) - a(n-4) + 12\,a(n-5) - 4\,a(n-6)
\end{equation}
for all $n>6$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268761.
