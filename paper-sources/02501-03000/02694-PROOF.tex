...
\title{The empirical recurrence for OEIS A223208, proved by transfer matrix}
...
\begin{abstract}
OEIS A223208 counts the ways of writing the vertices of a fixed graph $G$ into an array of width
$7$ so that any two cells adjacent in one of the named directions carry vertices joined by an
edge of $G$; here $G$ is dodecahedron graph. The entry carries an empirical recurrence of order $28$
...
OEIS A223208 is ``Rolling icosahedron face footprints: number of nX7 0..19 arrays starting with 0 where 0..19 label faces of an icosahedron and every array movement to a horizontal or vertical neighbor moves across an icosahedral edge.''. It has offset $1$ and begins
\[
729, 46875, 3889953, 347696019, 31921015497, 2960941376139, 275769851453745, 25725360515161923,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 21:21:16, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223208.
