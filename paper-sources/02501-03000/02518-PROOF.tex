...
\title{A further conjecture on OEIS A245159,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A245159 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $1, 1, 2, 4, 9, 23, 65, 199,\dots$, with offset $1$. The sequence satisfies
\[
...
\[
  q(x)=x^{7} - 17 x^{6} + 118 x^{5} - 434 x^{4} + 913 x^{3} - 1097 x^{2} + 696 x - 180 .
\]
...
\begin{quote}\raggedright a(n) = (-3375 - 525*2\^{}(4+n) - 1300*3\^{}n + 3*5\^{}n + 100*(297+9*2\^{}(2+n) + 2*3\^{}n)*n) / 43200.\end{quote}
...
\[
  p(x)=x^{7} - 17 x^{6} + 118 x^{5} - 434 x^{4} + 913 x^{3} - 1097 x^{2} + 696 x - 180 ,
\]
...
indices, and $a$ and $f$ were checked to agree at $n=9,\dots,15$,
