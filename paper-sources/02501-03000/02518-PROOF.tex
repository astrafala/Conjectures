...
\title{A further conjecture on OEIS A219454,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A219454 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $4, 4, 13, 26, 57, 116, 231, 450,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (1/40320)*n\^{}8 - (1/2016)*n\^{}7 + (7/2880)*n\^{}6 + (53/720)*n\^{}5 - (6313/5760)*n\^{}4 + (1961/288)*n\^{}3 - (170417/10080)*n\^{}2 + (3393/280)*n + 13 for n>5.\end{quote}
...
indices, and $a$ and $f$ were checked to agree at $n=15,\dots,23$,
