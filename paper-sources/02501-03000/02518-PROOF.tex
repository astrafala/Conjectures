...
\title{A further conjecture on OEIS A208375,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A208375 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $10, 100, 240, 420, 640, 900, 1200, 1540,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = 20*n\^{}2 + 40*n - 60 for n>1.\end{quote}
