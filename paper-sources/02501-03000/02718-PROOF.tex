...
\title{The empirical recurrence for OEIS A268882, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A268882 counts arrays over $\{0,\dots,1\}$ subject to a condition on the array as a
...
OEIS A268882 is ``Number of n X 4 binary arrays with some element plus some horizontally or antidiagonally adjacent neighbor totalling two exactly once.''. It has offset $1$ and begins
\[
5, 54, 501, 4133, 31956, 236960, 1706732, 12034000,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 16*a(n-1) - 88*a(n-2) + 200*a(n-3) - 208*a(n-4) + 96*a(n-5) - 16*a(n-6) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 15 2019 14:41:50, revision 7) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268882.
