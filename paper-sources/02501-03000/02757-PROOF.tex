...
\title{A value repeated at its own distance: OEIS A209360}
...
\begin{abstract}
OEIS A209360 carries an empirical recurrence of order $28$ contributed by R.~H.~Hardin. It is
...
walks in it. Hence $a(n)$ is a walk count on $S=39$ vertices and is $C$-finite, and whether the
...
OEIS A209360 is ``Number of nX1 1..3 arrays with every element value z a city block distance of exactly z from another element value z.''. It has offset $1$ and begins
\[
0, 1, 1, 3, 2, 8, 10, 21,\ \dots
\]
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) - 3\,a(n-2) + 3\,a(n-3) - 5\,a(n-4) + 5\,a(n-5) - 5\,a(n-6) + 9\,a(n-7) - 8\,a(n-8) + 2\,a(n-9) + a(n-10) - 4\,a(n-11) + 16\,a(n-12) - 22\,a(n-13) + 18\,a(n-14) - 16\,a(n-15) + 13\,a(n-16) - 8\,a(n-17) - 4\,a(n-18) + 2\,a(n-19) - 5\,a(n-20) + 9\,a(n-21) - 7\,a(n-22) + 6\,a(n-23) - 4\,a(n-24) + 4\,a(n-25) - a(n-26) - a(n-27) - a(n-28)
\]
for every $n>28$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209360.
