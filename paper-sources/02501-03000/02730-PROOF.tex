...
\title{Arrays counted up to renaming: the empirical recurrence for OEIS A205622}
...
\begin{abstract}
OEIS A205622 carries an empirical recurrence of order $8$ contributed by R.~H.~Hardin. It is
...
both in the state the arrays are exactly the walks in a digraph on $S=26$ vertices, so $a(n)$
...
OEIS A205622 is ``Number of (n+1)X5 0..2 arrays with every 2X2 subblock in a row having an equal number of equal diagonal or equal antidiagonal elements, adjacent rows differing in this number, and new values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
770, 8004, 94116, 1103436, 13072068, 153531936, 1819019544, 21373648800,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 12:13:04, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;136\,a(n-2) + 64\,a(n-3) - 264\,a(n-4) - 384\,a(n-5) - 1920\,a(n-6) - 7168\,a(n-8)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A205622.
