...
\title{A further conjecture on OEIS A220030,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A220030 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $6, 15, 42, 95, 192, 358, 626, 1038,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (1/120)*n\^{}5 + (1/8)*n\^{}4 + (5/24)*n\^{}3 + (15/8)*n\^{}2 + (227/60)*n - 4 for n>1.\end{quote}
