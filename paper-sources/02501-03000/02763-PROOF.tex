...
\title{The empirical recurrence for OEIS A189451, proved by transfer matrix}
...
\begin{abstract}
OEIS A189451 counts the permutations of the cells of an $n\times3$ array in which every cell
...
OEIS A189451 is ``Number of 3Xn array permutations with each element moving zero or one space horizontally or diagonally.''. It has offset $1$ and begins
\[
1, 13, 80, 666, 5080, 40106, 313136, 2455013,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 05:14:28, revision 9) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A189451.
