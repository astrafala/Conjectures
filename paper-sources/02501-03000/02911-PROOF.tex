...
\title{The empirical closed form for OEIS A224283, proved}
...
\begin{abstract}
OEIS A224283 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A224283 is ``Number of 4Xn 0..3 arrays with diagonals and rows unimodal and antidiagonals nondecreasing.''. It has offset $1$ and begins
\[
256, 16000, 186516, 1334973, 8073038, 44901359, 233090092, 1121852243,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 23:21:05, revision 8) this is still
...
+ \frac{46391 n^{22}}{53523844179886080000} + \frac{11257 n^{21}}{405483668029440000} \\
+ \frac{1330123 n^{20}}{1390229718958080000} + \frac{8502743 n^{19}}{347557429739520000} \\
+ \frac{35671 n^{18}}{59779399680000} + \frac{133834769 n^{17}}{10670622842880000} \\
+ \frac{7571063047 n^{16}}{30128817438720000} + \frac{2965237343 n^{15}}{836911595520000} \\
+ \frac{328422846067 n^{14}}{15064408719360000} + \frac{22514281381 n^{13}}{48910417920000} \\
+ \frac{7036550185081 n^{12}}{2254537359360000} - \frac{105103493973601 n^{11}}{2510734786560000} \\
+ \frac{1257210817095943 n^{10}}{1076029194240000} - \frac{236735071681049 n^{9}}{19615115520000} \\
+ \frac{3534310707922188979 n^{8}}{32011868528640000} - \frac{767055210116438233 n^{7}}{1143281018880000} \\
+ \frac{10350657608308971137 n^{6}}{3103191336960000} - \frac{8154723578394294443 n^{5}}{703964701440000} \\
+ \frac{16475873524529520931 n^{4}}{527973526080000} - \frac{482012437494247 n^{3}}{8888443200} \\
+ \frac{78892730856408401 n^{2}}{873054262080} - \frac{77283877096589 n}{243374040} \\
+ 643573.
\end{multline*}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224283.
