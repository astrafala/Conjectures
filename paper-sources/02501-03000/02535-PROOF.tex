...
\title{A further conjecture on OEIS A266073,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A266073 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $0, 2, 4, 2, 8, 2, 12, 2,\dots$, with offset $0$. The sequence satisfies
\[
  a(n)=2\,a(n-2) - 1\,a(n-4) ,
\]
...
\begin{quote}\raggedright a(n) = (-1)\^{}n*n+n-(-1)\^{}n+1.\end{quote}
