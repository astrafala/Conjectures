...
\title{A further conjecture on OEIS A219628,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A219628 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $6, 11, 24, 54, 103, 178, 290, 453,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = (1/8)*n\^{}4 - (11/12)*n\^{}3 + (63/8)*n\^{}2 - (145/12)*n + 3 for n>3.\end{quote}
...
indices, and $a$ and $f$ were checked to agree at $n=9,\dots,13$,
