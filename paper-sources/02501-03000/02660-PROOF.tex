...
\title{The empirical recurrence for OEIS A267961, proved by transfer matrix}
...
\begin{abstract}
OEIS A267961 counts arrays in which the REPEATED VALUES of each row, and of each column, stand in a
...
OEIS A267961 is ``Number of n X 2 0..2 arrays with every repeated value in every row and column greater than the previous repeated value.''. It has offset $1$ and begins
\[
9, 81, 576, 3969, 25281, 155236, 915849, 5253264,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 17 2021 14:16:03, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;21\,a(n-1) - 153\,a(n-2) + 263\,a(n-3) + 2094\,a(n-4) - 9792\,a(n-5) - 2752\,a(n-6) + 86256\,a(n-7) - 85536\,a(n-8) - 338048\,a(n-9) + 554496\,a(n-10) + 571392\,a(n-11) - 1335296\,a(n-12) - 98304\,a(n-13) + 1179648\,a(n-14) - 524288\,a(n-15)
\]
for every $n>15$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A267961.
