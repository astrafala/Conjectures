...
\title{A further conjecture on OEIS A283589,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A283589 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $1, 0, 101, 1110, 11110, 111110, 1111110, 11111110,\dots$, with offset $0$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = 10*(10\^{}n - 1)/9 for n>2.\end{quote}
