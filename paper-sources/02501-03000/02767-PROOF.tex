...
\title{A further conjecture on OEIS A277798,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A277798 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $1, 0, 100, 11, 10000, 1111, 1000000, 111111,\dots$, with offset $0$. The sequence satisfies
\[
...
\begin{quote}\raggedright a(n) = (-10+89*(-10)\^{}n+10*(-1)\^{}n+91*10\^{}n)/180. (End)\end{quote}
