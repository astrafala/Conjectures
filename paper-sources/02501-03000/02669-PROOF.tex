...
\title{A further conjecture on OEIS A253500,\\ \large settled by the proof already in hand}
...
\begin{abstract}
OEIS A253500 carries more than one conjecture. One of them has a proof; this paper settles a
...
The entry's first terms are $19701, 22236, 29370, 40117, 63550, 113573, 220988, 457436,\dots$, with offset $1$. The sequence satisfies
\[
...
\begin{quote}\raggedright Empirical: a(n) = 400*3\^{}(n-3) + 2682*2\^{}(n-1) + 16940 for n>6.\end{quote}
