...
\title{The empirical recurrence for OEIS A206516, proved by transfer matrix}
...
\begin{abstract}
OEIS A206516 counts, up to renaming the letters, the arrays of width $4$ over at most $4$
letters in which every $2\times3$ and $3\times2$ subblock has at most $4$ equal edges, an edge of such a window being one of the six steps of its perimeter cycle and an equal edge one whose two cells agree. It carries an empirical recurrence of order $22$ contributed by
...
OEIS A206516 is ``Number of (n+1)X4 0..3 arrays with every 2X3 or 3X2 subblock having no more than four equal edges, and new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
2786, 695541, 177097738, 45142367398, 11507555684346, 2933481908580803, 747797195466172046, 190626930556386514119,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 12:58:59, revision 9) this is still
...
$w_i$ cleared of denominators and $S=72164$ states in all. The walk index $j$ and the entry's own
...
\begin{theorem}
\[
a(n)\;=\;238\,a(n-1) + 4150\,a(n-2) + 44332\,a(n-3) - 679650\,a(n-4) - 12043680\,a(n-5) - 129978174\,a(n-6) - 183422200\,a(n-7) - 661869709\,a(n-8) + 1822894708\,a(n-9) + 3929447237\,a(n-10) + 24688694694\,a(n-11) + 16930214447\,a(n-12) + 31521818926\,a(n-13) - 66759146931\,a(n-14) + 41508795870\,a(n-15) - 100230885135\,a(n-16) + 89003825784\,a(n-17) - 52703068122\,a(n-18) + 46958310468\,a(n-19) - 22966596792\,a(n-20) + 7564885488\,a(n-21) - 2550916800\,a(n-22)
\]
for every $n>22$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206516.
