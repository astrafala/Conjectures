...
\title{The empirical recurrence for OEIS A207721, proved by transfer matrix}
...
\begin{abstract}
OEIS A207721 counts arrays over $\{0,\dots,1\}$ of width $6$ that avoid the patterns
...
OEIS A207721 is ``Number of 6Xn 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 0 1 and 1 0 0 vertically.''. It has offset
$1$ and begins
\[
22, 484, 5302, 66946, 820820, 10150118, 125165018,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:12:52, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;8\,a(n-1) + 63\,a(n-2) - 85\,a(n-3) - 424\,a(n-4) + 387\,a(n-5) + 724\,a(n-6) - 695\,a(n-7) - 148\,a(n-8) + 185\,a(n-9) + 13\,a(n-10) - 14\,a(n-11) - a(n-12)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207721.
