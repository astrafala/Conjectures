...
\title{The empirical recurrence for OEIS A233154, proved by transfer matrix}
...
\begin{abstract}
OEIS A233154 counts arrays over $\{0,\dots,2\}$ in which no two entries that are neighbours in
...
carried by one bounded piece of extra state, so the count is a walk count on $S=16$ states.
\end{abstract}
...
OEIS A233154 is ``Number of n X 7 0..2 arrays with no element x(i,j) adjacent to value 2-x(i,j) horizontally or antidiagonally.''. It has offset $1$ and begins
\[
192, 5832, 184248, 5871528, 187446312, 5986203912, 191184793128, 6106045615848,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 42*a(n-1) - 351*a(n-2) + 972*a(n-3) - 810*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 08 2018 10:21:03, revision 8) this is still
...
and the row above and every clash inside it. There are $S=16$ reachable states.
...
\begin{theorem}
\[
a(n)\;=\;42\,a(n-1) - 351\,a(n-2) + 972\,a(n-3) - 810\,a(n-4)
\]
for every $n>4$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A233154.
