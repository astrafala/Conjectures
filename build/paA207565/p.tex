...
\title{The empirical recurrence for OEIS A207565, proved by transfer matrix}
...
\begin{abstract}
OEIS A207565 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
...
OEIS A207565 is ``Number of 4Xn 0..1 arrays avoiding 0 0 1 and 0 1 0 horizontally and 0 1 1 and 1 1 0 vertically.''. It has offset
$1$ and begins
\[
9, 81, 221, 636, 2234, 6315, 16812,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:05:03, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) - 4\,a(n-2) + 10\,a(n-3) - 30\,a(n-4) + 10\,a(n-5) - 4\,a(n-6) + 54\,a(n-7) + 10\,a(n-8) - 22\,a(n-9) - 62\,a(n-10) - 10\,a(n-11) + 18\,a(n-12) + 32\,a(n-13) + 7\,a(n-14) - 6\,a(n-15) - 6\,a(n-16)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207565.
