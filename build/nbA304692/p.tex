...
\title{The empirical recurrence for OEIS A304692, proved by transfer matrix}
...
\begin{abstract}
OEIS A304692 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $different from$ itself lying in $\{1,2,3,5,6\}$, and it carries an empirical
...
OEIS A304692 is ``Number of nX3 0..1 arrays with every element unequal to 1, 2, 3, 5 or 6 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 16, 56, 178, 669, 2615, 9573, 35581,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 17 2018 09:51:37, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 4\,a(n-2) + 7\,a(n-3) - 28\,a(n-4) - 63\,a(n-5) - 22\,a(n-6) + 66\,a(n-7) + 200\,a(n-8) + 120\,a(n-9) - 46\,a(n-10) - 245\,a(n-11) - 185\,a(n-12) - 23\,a(n-13) + 95\,a(n-14) + 162\,a(n-15) + 71\,a(n-16) - 2\,a(n-17) - 20\,a(n-18) - 8\,a(n-19)
\end{equation}
for all $n>20$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A304692.
