...
\title{The empirical recurrence for OEIS A209723, proved by transfer matrix}
...
\begin{abstract}
OEIS A209723 counts $(n+1)\times5$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A209723 is ``1/4 the number of (n+1) X 5 0..2 arrays with every 2 X 2 subblock having distinct clockwise edge differences.''. It has offset $1$ and begins
\[
6, 7, 8, 10, 12, 16, 20, 28,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) + 2*a(n-2) - 2*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 15 2022 11:31:00, revision 11) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209723.
