...
\title{The empirical recurrence for OEIS A295914, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A295914 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A295914 is ``Number of n X 4 0..1 arrays with each 1 adjacent to 0 or 3 king-move neighboring 1s.''. It has offset $1$ and begins
\[
8, 28, 115, 467, 1880, 7604, 30721, 124117,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) + 7*a(n-2) + 6*a(n-3) - 3*a(n-4) - 4*a(n-5) + a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 22 2019 10:04:47, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 7\,a(n-2) + 6\,a(n-3) - 3\,a(n-4) - 4\,a(n-5) + a(n-6)
\end{equation}
for all $n>7$.
...
x_{t,u}=1\ \Rightarrow\ \#\{\text{neighbours equal to }1\}\in\{0,3\}
\end{equation}
for every cell $(t,u)$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A295914.
