...
\title{The empirical recurrence for OEIS A296799, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A296799 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A296799 is ``Number of nX3 0..1 arrays with each 1 adjacent to 1, 3 or 4 king-move neighboring 1s.''. It has offset $1$ and begins
\[
3, 15, 47, 164, 694, 2605, 10149, 40768,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 20 2017 21:56:38, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 7\,a(n-2) + 26\,a(n-3) + a(n-4) - 69\,a(n-5) - 154\,a(n-6) - 144\,a(n-7) + 16\,a(n-8) + 166\,a(n-9) + 183\,a(n-10) + 6\,a(n-11) - 14\,a(n-12) - 73\,a(n-13) + 16\,a(n-14) - a(n-15) + 2\,a(n-16)
\end{equation}
for all $n>17$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A296799.
