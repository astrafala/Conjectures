...
\title{The empirical recurrence for OEIS A218838, proved by transfer matrix}
...
\begin{abstract}
OEIS A218838 counts the distinct indicator arrays obtained from the $n\times4$ arrays over
...
indicator row by row turns it into one, on $S=45$ states, after which the conjectured
...
OEIS A218838 is ``Unmatched value maps: number of n X 4 binary arrays indicating the locations of corresponding elements not equal to any horizontal or antidiagonal neighbor in a random 0..1 n X 4 array.''. It has offset $1$ and begins
\[
7, 57, 453, 3617, 28888, 230726, 1842766, 14717828,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 7*a(n-1) + 5*a(n-2) + 24*a(n-3) - 9*a(n-4) + 9*a(n-5) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 10 2018 07:15:19, revision 8) this is still
...
\]
There are $S=45$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite. Note
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-1) + 5\,a(n-2) + 24\,a(n-3) - 9\,a(n-4) + 9\,a(n-5)
\]
for every $n>6$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A218838.
