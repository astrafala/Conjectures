...
\title{The empirical recurrence for OEIS A258549, proved by transfer matrix}
...
\begin{abstract}
OEIS A258549 counts the arrays over $\{0,\dots,1\}$ whose $2\times2$ subblocks carry a
...
OEIS A258549 is ``Number of (n+1) X (3+1) 0..1 arrays with every 2 X 2 subblock ne-sw antidiagonal difference nondecreasing horizontally and nw+se diagonal sum nondecreasing vertically.''. It has offset $1$ and begins
\[
104, 210, 598, 1244, 2384, 3980, 6348, 9567,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) - 6*a(n-2) + 4*a(n-3) - 4*a(n-5) + 6*a(n-6) - 4*a(n-7) + a(n-8) for n>11.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 21 2018 14:56:03, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A258549.
