...
\title{The empirical recurrence for OEIS A207251, proved by transfer matrix}
...
\begin{abstract}
OEIS A207251 counts arrays over $\{0,\dots,1\}$ of width $5$ that avoid the patterns
...
OEIS A207251 is ``Number of nX5 0..1 arrays avoiding 0 0 1 and 1 0 1 horizontally and 0 1 0 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
10, 100, 390, 1950, 9072, 43498, 206514,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 13:41:04, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 6\,a(n-2) + a(n-3) + 36\,a(n-4) + 49\,a(n-5) + 31\,a(n-6) + 66\,a(n-7) + 45\,a(n-8) + 15\,a(n-9) - 5\,a(n-10) - 16\,a(n-11) - a(n-12) - a(n-13) + a(n-14)
\end{equation}
for all $n>13$. 
...
$(0,0,1), (1,0,1)$ as $3$ consecutive entries. There are $10$ admissible rows; that condition
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207251.
