...
\title{The empirical recurrence for OEIS A302684, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A302684 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A302684 is ``Number of 6Xn 0..1 arrays with every element equal to 0, 1, 4 or 6 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
32, 14, 18, 64, 125, 453, 2013, 6725,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 11 2018 12:31:23, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 2\,a(n-2) + 18\,a(n-3) + 31\,a(n-4) - 4\,a(n-5) - 56\,a(n-6) - 58\,a(n-7) - 38\,a(n-8) + 52\,a(n-9) + 7\,a(n-10) - 47\,a(n-11) + 10\,a(n-12) + a(n-13) - 32\,a(n-14) + 12\,a(n-15) + 2\,a(n-16) + 8\,a(n-17)
\end{equation}
for all $n>23$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302684.
