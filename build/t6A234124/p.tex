...
\title{The empirical recurrence for OEIS A234124, proved by transfer matrix}
...
\begin{abstract}
OEIS A234124 counts $(n+1)\times2$ arrays over $\{0,\dots,6\}$ subject to a condition imposed on
...
OEIS A234124 is ``Number of (n+1) X (1+1) 0..6 arrays with every 2 X 2 subblock having the absolute values of all six edge and diagonal differences no larger than 1.''. It has offset $1$ and begins
\[
91, 469, 2413, 12457, 64441, 333883, 1731979, 8992639,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 10*a(n-1) - 24*a(n-2) - 18*a(n-3) + 57*a(n-4) + 54*a(n-5) + 12*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 12 2018 14:56:48, revision 7) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234124.
