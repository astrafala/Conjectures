...
\title{The empirical recurrence for OEIS A264132, proved by transfer matrix}
...
\begin{abstract}
OEIS A264132 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=2$ columns in which
...
OEIS A264132 is ``Number of (1+1)X(n+1) arrays of permutations of 0..n*2+1 with each element having index change +-(.,.) 0,0 0,2 or 1,2.''. It has offset $1$ and begins
\[
1, 5, 25, 80, 256, 976, 3721, 13725,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 10 2015 11:05:40, revision 6) this is still
...
\[
(i-h_i,\,j-h_j)\;\in\;\{(-2,-1),\ (-2,0),\ (0,0),\ (2,0),\ (2,1)\},
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264132.
