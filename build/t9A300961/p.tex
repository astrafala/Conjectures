...
\title{The empirical recurrence for OEIS A300961, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A300961 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A300961 is ``Number of n X 3 0..1 arrays with every element equal to 0, 2, 3, 4 or 6 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
1, 5, 16, 44, 159, 580, 2145, 8034,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 05 2021 09:52:44, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 5\,a(n-2) + 2\,a(n-3) - 30\,a(n-4) - 29\,a(n-5) - 3\,a(n-6) + 26\,a(n-7) + 89\,a(n-8) + 79\,a(n-9) - 20\,a(n-10) - 52\,a(n-11) - 28\,a(n-12) + 96\,a(n-13) + 12\,a(n-14) + 4\,a(n-15) - 39\,a(n-16) - 17\,a(n-17) - 4\,a(n-18) - 3\,a(n-19) + 7\,a(n-20) - 3\,a(n-21) + 2\,a(n-22)
\end{equation}
for all $n>24$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A300961.
