...
\title{The empirical recurrence for OEIS A304928, proved by transfer matrix}
...
\begin{abstract}
OEIS A304928 counts $5$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $different from$ itself lying in $\{0,1,3,5,7\}$, and it carries an empirical
...
OEIS A304928 is ``Number of nX5 0..1 arrays with every element unequal to 0, 1, 3, 5 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
8, 53, 54, 173, 452, 1034, 2265, 5306,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 21 2018 09:22:05, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 3\,a(n-3) - 2\,a(n-4) - a(n-5) + 6\,a(n-6) - 15\,a(n-7) - 7\,a(n-8) - 10\,a(n-9) - 3\,a(n-10) - 13\,a(n-11) - 13\,a(n-12) + 62\,a(n-13) + 39\,a(n-14) + 29\,a(n-15) + 13\,a(n-16) + 55\,a(n-17) + 10\,a(n-18) - 64\,a(n-19) - 46\,a(n-20) - 12\,a(n-21) - 90\,a(n-22) - 58\,a(n-23) + 22\,a(n-24) - 20\,a(n-25) + 5\,a(n-26) - 39\,a(n-27) + 8\,a(n-28) + 34\,a(n-29) + 37\,a(n-30) - 4\,a(n-31) + 9\,a(n-32) - 6\,a(n-33) + 4\,a(n-34)
\end{equation}
for all $n>44$.
...
has score in $\{0,1,3,5,7\}$. The entry also fixes the top-left entry to be $0$; that is a condition on the first row alone, so it restricts the start vector and nothing else.
...
\begin{itemize}
\item $\mathbf{s}(r,s)=1$ when every cell of $r$ has score in $\{0,1,3,5,7\}$ \emph{with no row
above $r$} and $r_1=0$, and $0$ otherwise;
\item an edge $(r,s)\to(s,t)$ when every cell of $s$ has score in $\{0,1,3,5,7\}$ computed from
$r$, $s$ and $t$;
\item $\mathbf{e}(r,s)=1$ when every cell of $s$ has score in $\{0,1,3,5,7\}$ \emph{with no row
...
exactly when every one of its $n$ rows has all scores in $\{0,1,3,5,7\}$. Read the sequence as the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A304928.
