...
\title{The empirical recurrence for OEIS A208289, proved by transfer matrix}
...
\begin{abstract}
OEIS A208289 counts arrays over $\{0,\dots,1\}$ of width $5$ that avoid the patterns
...
OEIS A208289 is ``Number of 5 X n 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 0 1 and 1 1 0 vertically.''. It has offset
$1$ and begins
\[
10, 100, 390, 2090, 9900, 49130, 239490,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) + 10*a(n-2) - 2*a(n-3) - 7*a(n-4) + a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 30 2018 14:24:30, revision
8) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 10\,a(n-2) - 2\,a(n-3) - 7\,a(n-4) + a(n-6)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208289.
