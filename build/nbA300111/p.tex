...
\title{The empirical recurrence for OEIS A300111, proved by transfer matrix}
...
\begin{abstract}
OEIS A300111 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $equal to$ itself lying in $\{1,2,4,5,6,7,8\}$, and it carries an empirical
...
OEIS A300111 is ``Number of nX4 0..1 arrays with every element equal to 1, 2, 4, 5, 6, 7 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
2, 13, 29, 112, 515, 2713, 12669, 59569,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 25 2018 06:29:08, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;8\,a(n-1) - 22\,a(n-2) + 50\,a(n-3) - 100\,a(n-4) + 87\,a(n-5) - 28\,a(n-6) + 185\,a(n-7) - 2087\,a(n-8) + 4007\,a(n-9) - 1726\,a(n-10) + 3795\,a(n-11) - 29105\,a(n-12) + 114870\,a(n-13) - 197976\,a(n-14) + 164388\,a(n-15) - 38743\,a(n-16) + 241083\,a(n-17) - 1477448\,a(n-18) + 2958415\,a(n-19) - 3733030\,a(n-20) + 3976582\,a(n-21) - 6534750\,a(n-22) + 11613507\,a(n-23) - 13103127\,a(n-24) + 13163030\,a(n-25) - 16341495\,a(n-26) + 27407619\,a(n-27) - 26545990\,a(n-28) + 6097709\,a(n-29) + 5793810\,a(n-30) - 4770508\,a(n-31) - 1436482\,a(n-32) - 14106740\,a(n-33) + 13977469\,a(n-34) - 5342094\,a(n-35) + 29552651\,a(n-36) - 48375324\,a(n-37) + 47858441\,a(n-38) - 22810038\,a(n-39) + 7904052\,a(n-40) + 2103556\,a(n-41) + 7347362\,a(n-42) - 13339150\,a(n-43) - 10775336\,a(n-44) + 145017\,a(n-45) + 10531212\,a(n-46) - 1184471\,a(n-47) - 806731\,a(n-48) + 431595\,a(n-49) - 409615\,a(n-50) + 100962\,a(n-51) - 7225\,a(n-52) - 27756\,a(n-53) + 4942\,a(n-54) + 1168\,a(n-55) + 38\,a(n-56)
\end{equation}
for all $n>59$.
...
has score in $\{1,2,4,5,6,7,8\}$. The entry also fixes the top-left entry to be $0$; that is a condition on the first row alone, so it restricts the start vector and nothing else.
...
\begin{itemize}
\item $\mathbf{s}(r,s)=1$ when every cell of $r$ has score in $\{1,2,4,5,6,7,8\}$ \emph{with no row
above $r$} and $r_1=0$, and $0$ otherwise;
\item an edge $(r,s)\to(s,t)$ when every cell of $s$ has score in $\{1,2,4,5,6,7,8\}$ computed from
$r$, $s$ and $t$;
\item $\mathbf{e}(r,s)=1$ when every cell of $s$ has score in $\{1,2,4,5,6,7,8\}$ \emph{with no row
...
exactly when every one of its $n$ rows has all scores in $\{1,2,4,5,6,7,8\}$. Read the sequence as the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A300111.
