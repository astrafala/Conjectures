...
\title{The empirical recurrence for OEIS A221664, proved by transfer matrix}
...
\begin{abstract}
OEIS A221664 counts the distinct indicator arrays obtained from the $n\times3$ arrays over
...
indicator row by row turns it into one, on $S=452$ states, after which the conjectured
...
OEIS A221664 is ``Sum of neighbor maps: number of n X 3 binary arrays indicating the locations of corresponding elements equal to the sum mod 3 of their horizontal, diagonal and antidiagonal neighbors in a random 0..2 n X 3 array.''. It has offset $1$ and begins
\[
8, 64, 512, 3772, 32768, 262144, 2097152, 16777216,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 04 2022 08:28:31, revision 6) this is still
...
\]
There are $S=452$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite. Note
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-1) + 360\,a(n-5) - 2880\,a(n-6) - 47232\,a(n-10) + 377856\,a(n-11) + 2872320\,a(n-15) - 22978560\,a(n-16) - 92491776\,a(n-20) + 739934208\,a(n-21) + 1689550848\,a(n-25) - 13516406784\,a(n-26) - 18150850560\,a(n-30) + 145206804480\,a(n-31) + 113850187776\,a(n-35) - 910801502208\,a(n-36) - 386547056640\,a(n-40) + 3092376453120\,a(n-41) + 549755813888\,a(n-45) - 4398046511104\,a(n-46)
\]
for every $n>46$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221664.
