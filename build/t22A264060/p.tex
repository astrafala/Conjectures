...
\title{The empirical recurrence for OEIS A264060, proved by transfer matrix}
...
\begin{abstract}
OEIS A264060 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=3$ columns in which
...
OEIS A264060 is ``Number of (2+1) X (n+1) arrays of permutations of 0..n*3+2 with each element having index change +-(.,.) 0,0 1,2 or 2,-2.''. It has offset $1$ and begins
\[
1, 8, 64, 216, 729, 3375, 15625, 64000,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 15 2023 14:58:57, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) - 4\,a(n-2) + 20\,a(n-3) + 20\,a(n-4) - 60\,a(n-5) - 60\,a(n-7) - 20\,a(n-8) + 20\,a(n-9) + 4\,a(n-10) + 4\,a(n-11) + a(n-12)
\]
for every $n>10$.
\end{theorem}
...
transposed companion A263966. Second, the transfer model reproduces all $23$ terms this
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264060.
