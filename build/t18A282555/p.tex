...
\title{The empirical recurrence for OEIS A282555, proved by transfer matrix}
...
\begin{abstract}
OEIS A282555 counts $n\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
walk, and $a(n)$ is a walk count on $S=144$ vertices, which is $C$-finite. Whether the
...
OEIS A282555 is ``Number of nX3 0..1 arrays with no 1 equal to more than two of its king-move neighbors, with the exception of exactly one element.''. It has offset $1$ and begins
\[
0, 10, 89, 618, 4167, 26278, 160698, 961128,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 18 2017 08:37:12, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;10\,a(n-1) - 21\,a(n-2) - 22\,a(n-3) - 42\,a(n-4) + 270\,a(n-5) - 35\,a(n-6) - 104\,a(n-7) - 518\,a(n-8) + 572\,a(n-9) - 197\,a(n-10) - 84\,a(n-11) + 340\,a(n-12) - 156\,a(n-13) - 4\,a(n-14) + 24\,a(n-15) - 36\,a(n-16)
\]
for every $n>16$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A282555.
