...
\title{The empirical recurrence for OEIS A250955, proved by transfer matrix}
...
\begin{abstract}
OEIS A250955 counts $(n+1)\times8$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A250955 is ``Number of (n+1) X (7+1) 0..1 arrays with no 2 X 2 subblock having its maximum diagonal element less than its minimum antidiagonal element.''. It has offset $1$ and begins
\[
40545, 6588344, 1068793208, 173396103624, 28130774228952, 4563772381621072, 740399698245965774, 120118108984608820672,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 03 2022 23:08:59, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;217\,a(n-1) - 9657\,a(n-2) + 124578\,a(n-3) + 170544\,a(n-4) - 10015311\,a(n-5) + 58649394\,a(n-6) - 123233697\,a(n-7) - 48475236\,a(n-8) + 586861054\,a(n-9) - 648215662\,a(n-10) - 98069529\,a(n-11) + 412774803\,a(n-12) - 157024008\,a(n-13) - 1439235\,a(n-14) + 9306900\,a(n-15) - 1445850\,a(n-16)
\end{equation}
for all $n>15$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250955.
