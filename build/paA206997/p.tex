...
\title{The empirical recurrence for OEIS A206997, proved by transfer matrix}
...
\begin{abstract}
OEIS A206997 counts arrays over $\{0,\dots,1\}$ of width $5$ that avoid the patterns
...
OEIS A206997 is ``Number of nX5 0..1 arrays avoiding 0 1 0 horizontally and 0 1 1 vertically.''. It has offset
$1$ and begins
\[
21, 441, 4705, 45932, 382349, 3032756, 22816988,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 13:21:54, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;18\,a(n-1) - 72\,a(n-2) - 470\,a(n-3) + 3911\,a(n-4) + 769\,a(n-5) - 69764\,a(n-6) + 99094\,a(n-7) + 628042\,a(n-8) - 1523144\,a(n-9) - 3140220\,a(n-10) + 11241633\,a(n-11) + 8300230\,a(n-12) - 50060099\,a(n-13) - 5933234\,a(n-14) + 146226346\,a(n-15) - 32419216\,a(n-16) - 293487699\,a(n-17) + 123234334\,a(n-18) + 417727459\,a(n-19) - 222384126\,a(n-20) - 431256120\,a(n-21) + 252100312\,a(n-22) + 327795585\,a(n-23) - 193166533\,a(n-24) - 184712091\,a(n-25) + 102596274\,a(n-26) + 76980256\,a(n-27) - 37919899\,a(n-28) - 23422618\,a(n-29) + 9646690\,a(n-30) + 5076967\,a(n-31) - 1644172\,a(n-32) - 754228\,a(n-33) + 178184\,a(n-34) + 72234\,a(n-35) - 11036\,a(n-36) - 3988\,a(n-37) + 296\,a(n-38) + 96\,a(n-39)
\end{equation}
for all $n>39$. 
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206997.
