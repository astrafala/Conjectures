...
\title{The empirical recurrence for OEIS A219143, proved by transfer matrix}
...
\begin{abstract}
OEIS A219143 counts the distinct indicator arrays obtained from the $n\times2$ arrays over
...
OEIS A219143 is ``Unchanging value maps: number of 2 X n binary arrays indicating the locations of corresponding elements unequal to no horizontal, diagonal or antidiagonal neighbor in a random 0..2 2 X n array.''. It has offset $1$ and begins
\[
1, 6, 18, 39, 96, 225, 543, 1293,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + a(n-2) - a(n-3) + 2*a(n-4) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 11 2018 09:54:48, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + a(n-2) - a(n-3) + 2\,a(n-4)
\]
for every $n>5$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A219143.
