...
\title{The empirical recurrence for OEIS A208836, proved by transfer matrix}
...
\begin{abstract}
OEIS A208836 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
...
OEIS A208836 is ``Number of n X 4 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 1 1 and 1 1 0 vertically.''. It has offset
$1$ and begins
\[
10, 100, 282, 855, 3010, 11242, 44275,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 7*a(n-1) - 8*a(n-2) - 27*a(n-3) + 45*a(n-4) + 24*a(n-5) - 51*a(n-6) - 3*a(n-7) + 16*a(n-8) - a(n-9) - a(n-10) for n>11.
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 07 2018 09:56:42, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208836.
