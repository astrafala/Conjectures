...
\title{The empirical recurrence for OEIS A203822, proved by transfer matrix}
...
\begin{abstract}
OEIS A203822 counts $(n+1)\times5$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A203822 is ``Number of (n+1) X 5 0..3 arrays with no 2 X 2 subblock having equal diagonal elements or equal antidiagonal elements.''. It has offset $1$ and begins
\[
104976, 12002256, 1372257936, 157025515248, 17968205387664, 2056114528873776, 235282648691687184, 26923572225438510384,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 117*a(n-1) -34398*a(n-3) +86436*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 05 2018 08:18:45, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A203822.
