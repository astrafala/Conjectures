...
\title{The empirical recurrence for OEIS A255087, proved by transfer matrix}
...
\begin{abstract}
OEIS A255087 counts $(n+2)\times6$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
no $3\times3$ subblock, and it carries an empirical recurrence of order $39$
...
OEIS A255087 is ``Number of (n+2)X(4+2) 0..1 arrays with no 3x3 subblock diagonal sum 1 and no antidiagonal sum 2 and no row sum 0 and no column sum 0.''. It has offset $1$ and begins
\[
1483, 2005, 3696, 9484, 24034, 63535, 169879, 457314,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:37:05, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + a(n-2) + 12\,a(n-3) - 13\,a(n-4) + 207\,a(n-6) - 38\,a(n-7) - 181\,a(n-8) - 2510\,a(n-9) + 325\,a(n-10) + 2028\,a(n-11) - 4435\,a(n-12) + 210\,a(n-13) + 2022\,a(n-14) + 55633\,a(n-15) - 702\,a(n-16) - 25584\,a(n-17) + 9187\,a(n-18) - 61\,a(n-19) + 950\,a(n-20) - 120381\,a(n-21) + 1807\,a(n-22) - 14157\,a(n-23) - 24279\,a(n-24) + 788\,a(n-25) + 10708\,a(n-26) + 304919\,a(n-27) + 572\,a(n-28) - 139776\,a(n-29) - 8804\,a(n-30) + 1368\,a(n-31) + 18252\,a(n-32) + 96200\,a(n-33) + 468\,a(n-34) - 237744\,a(n-35) - 6084\,a(n-36) + 79092\,a(n-39)
\]
for every $n>45$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A255087.
