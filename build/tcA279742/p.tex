...
\title{The empirical recurrence for OEIS A279742, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A279742 imposes three things at once: a condition on each cell that reaches one column up and
...
OEIS A279742 is ``Number of 2 X n 0..1 arrays with no element equal to a strict majority of its horizontal and antidiagonal neighbors, with the exception of exactly one element, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
0, 2, 6, 14, 26, 48, 84, 146,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) - a(n-2) - 3*a(n-3) + a(n-4) + a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 11 2019 14:20:57, revision 7) the statement is
...
one of the $35$ published indices and agrees with the entry's DATA exactly, the quotient
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A279742.
