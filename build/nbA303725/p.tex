...
\title{The empirical recurrence for OEIS A303725, proved by transfer matrix}
...
\begin{abstract}
OEIS A303725 counts $6$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A303725 is ``Number of nX6 0..1 arrays with every element unequal to 0, 1, 2 or 3 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
32, 293, 151, 221, 345, 569, 894, 1402,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) -a(n-4) -a(n-5) +a(n-6) -a(n-7) -a(n-8) +2*a(n-9) for n>15
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 29 2018 11:10:35, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) - a(n-4) - a(n-5) + a(n-6) - a(n-7) - a(n-8) + 2\,a(n-9)
\end{equation}
for all $n>14$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A303725.
