...
\title{The empirical recurrence for OEIS A207592, proved by transfer matrix}
...
\begin{abstract}
OEIS A207592 counts arrays over $\{0,\dots,1\}$ of width $5$ that avoid the patterns
...
OEIS A207592 is ``Number of 5 X n 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 0 1 and 1 1 1 vertically.''. It has offset
$1$ and begins
\[
13, 169, 312, 1014, 3094, 9698, 30056,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = -a(n-1) + 11*a(n-2) + 13*a(n-3) - 18*a(n-4) - 18*a(n-5) + 6*a(n-6) + 4*a(n-7) for n>9.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 24 2018 14:43:17, revision
12) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;-a(n-1) + 11\,a(n-2) + 13\,a(n-3) - 18\,a(n-4) - 18\,a(n-5) + 6\,a(n-6) + 4\,a(n-7)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207592.
