...
\title{The empirical recurrence for OEIS A253371, proved by transfer matrix}
...
\begin{abstract}
OEIS A253371 counts the arrays over $\{0,\dots,2\}$ whose $2\times2$ subblocks carry a
...
so a pair of consecutive array rows is a state, the count is a walk count on $S=11100$ of them,
...
OEIS A253371 is ``Number of (n+1)X(4+1) 0..2 arrays with every 2X2 subblock sum nondecreasing horizontally, vertically and antidiagonally ne-to-sw.''. It has offset $1$ and begins
\[
11100, 148389, 2000385, 10639450, 70942616, 263498334, 1236284027, 3879857482,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 14:00:41, revision 6) this is still
...
\]
on the $S=11100$ admissible pairs. In particular $a$ is $C$-finite. The alignment of the walk
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253371.
