...
\title{The empirical recurrence for OEIS A220574, proved by transfer matrix}
...
\begin{abstract}
OEIS A220574 counts the distinct indicator arrays obtained from the $n\times3$ arrays over
...
indicator row by row turns it into one, on $S=25$ states, after which the conjectured
...
OEIS A220574 is ``Equals one maps: number of n X 3 binary arrays indicating the locations of corresponding elements equal to exactly one of their horizontal and antidiagonal neighbors in a random 0..1 n X 3 array.''. It has offset $1$ and begins
\[
4, 21, 91, 375, 1487, 5835, 22775, 88683,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) + 4*a(n-2) + 2*a(n-3) - 12*a(n-4) - 16*a(n-5) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 01 2018 04:56:13, revision 7) this is still
...
\]
There are $S=25$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite. Note
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + 4\,a(n-2) + 2\,a(n-3) - 12\,a(n-4) - 16\,a(n-5)
\]
for every $n>6$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A220574.
