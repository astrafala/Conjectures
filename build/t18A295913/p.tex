...
\title{The empirical recurrence for OEIS A295913, proved by transfer matrix}
...
\begin{abstract}
OEIS A295913 counts $n\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A295913 is ``Number of n X 3 0..1 arrays with each 1 adjacent to 0 or 3 king-move neighboring 1's.''. It has offset $1$ and begins
\[
5, 13, 39, 115, 337, 993, 2919, 8587,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + 3*a(n-2) - 2*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 14 2025 18:40:31, revision 14) this is still
...
\[
\text{every }1\text{ has }\#\{\text{neighbouring }1\text{s}\}\in\{0,3\},
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A295913.
