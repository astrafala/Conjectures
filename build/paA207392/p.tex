...
\title{The empirical recurrence for OEIS A207392, proved by transfer matrix}
...
\begin{abstract}
OEIS A207392 counts arrays over $\{0,\dots,1\}$ of width $3$ that avoid the patterns
...
OEIS A207392 is ``Number of 3Xn 0..1 arrays avoiding 0 0 1 and 0 1 0 horizontally and 0 0 1 and 1 1 0 vertically.''. It has offset
$1$ and begins
\[
6, 36, 98, 271, 834, 2307, 6115,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 13:50:37, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) - 2\,a(n-2) + 9\,a(n-3) - 15\,a(n-4) - 21\,a(n-6) + 16\,a(n-7) + 11\,a(n-8) + 27\,a(n-9) + 2\,a(n-10) - 12\,a(n-12) - a(n-13) - 2\,a(n-14) + 2\,a(n-15)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207392.
