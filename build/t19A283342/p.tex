...
\title{The empirical recurrence for OEIS A283342, proved by transfer matrix}
...
\begin{abstract}
OEIS A283342 counts $n\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
walk, and $a(n)$ is a walk count on $S=114$ vertices, which is $C$-finite. Whether the
...
OEIS A283342 is ``Number of nX3 0..1 arrays with no 1 equal to more than two of its horizontal, vertical and antidiagonal neighbors, with the exception of exactly one element.''. It has offset $1$ and begins
\[
0, 6, 71, 572, 4398, 31952, 224927, 1546856,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 05 2017 10:20:24, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;10\,a(n-1) - 13\,a(n-2) - 60\,a(n-3) - 50\,a(n-4) + 70\,a(n-5) + 78\,a(n-6) + 38\,a(n-7) - 57\,a(n-8) - 28\,a(n-9) - 18\,a(n-10) + 56\,a(n-11) - 37\,a(n-12) + 24\,a(n-13) - 28\,a(n-14) + 16\,a(n-15) - 4\,a(n-16)
\]
for every $n>16$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A283342.
