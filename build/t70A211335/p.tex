...
\title{The empirical recurrence for OEIS A211335, proved by a one-dimensional reduction}
...
\begin{abstract}
OEIS A211335 counts symmetric $(n+1)\times(n+1)$ matrices over
$\{-5,\dots,5\}$ in which every $2\times2$ subblock sums to zero and has one, three or four distinct
...
on $S=37$ states, and the empirical recurrence of order $14$ contributed by R.~H.~Hardin
follows.
\end{abstract}
...
OEIS A211335 is ``Number of (n+1)X(n+1) -5..5 symmetric matrices with every 2X2 subblock having sum zero and one, three or four distinct values.''. It has offset $1$ and begins
\[
47, 203, 851, 3551, 14747, 61279, 255139, 1066031,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 16:09:58, revision 8) this is still
...
that every $2\times2$ subblock has one, three or four distinct entries.
...
Call two consecutive pairs COMPATIBLE when that number lies in $\{1,3,4\}$. The condition on the
...
$S=37$. The two parity classes never mix, so the walk starts by choosing a parity and a first
value, and every state may end a sequence:
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad \tau=\mathbf{1},\qquad S=37.
\]
...
\begin{theorem}
\[
a(n)\;=\;13\,a(n-1) - 40\,a(n-2) - 130\,a(n-3) + 771\,a(n-4) + 305\,a(n-5) - 5330\,a(n-6) + 176\,a(n-7) + 18744\,a(n-8) + 2324\,a(n-9) - 31120\,a(n-10) - 14864\,a(n-11) + 9312\,a(n-12) + 3072\,a(n-13) - 1152\,a(n-14)
\]
for every $n>13$.
\end{theorem}
...
$2\times2$ subblock tested for summing to zero and for having one, three or four distinct entries. The
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A211335.
