...
\title{The empirical recurrence for OEIS A206873, proved by transfer matrix}
...
\begin{abstract}
OEIS A206873 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
$(1,0,1)$ along one axis and $(0,0,0)$ along the other, and carries an empirical recurrence of
...
OEIS A206873 is ``Number of 4Xn 0..1 arrays avoiding 0 0 0 horizontally and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
12, 144, 889, 7675, 63866, 502864, 4108471,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 13:12:53, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 22\,a(n-2) + 195\,a(n-3) + 237\,a(n-4) + 211\,a(n-5) - 2946\,a(n-6) - 1034\,a(n-7) - 4204\,a(n-8) + 13726\,a(n-9) + 2298\,a(n-10) + 9852\,a(n-11) - 18860\,a(n-12) - 5516\,a(n-13) - 8002\,a(n-14) + 9398\,a(n-15) + 3229\,a(n-16) + 2616\,a(n-17) - 2128\,a(n-18) - 839\,a(n-19) - 433\,a(n-20) + 161\,a(n-21) + 68\,a(n-22) + 28\,a(n-23)
\end{equation}
...
$(1,0,1)$ as $3$ consecutive entries. There are $12$ admissible columns; that condition
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206873.
