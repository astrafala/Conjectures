...
\title{The empirical recurrence for OEIS A297885, proved by transfer matrix}
...
\begin{abstract}
OEIS A297885 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A297885 is ``Number of nX4 0..1 arrays with every element equal to 0, 1, 2 or 4 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
8, 29, 26, 36, 84, 134, 223, 396,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 07 2018 16:29:21, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 2\,a(n-2) + 4\,a(n-3) - 3\,a(n-4) - 6\,a(n-5) - 6\,a(n-6) - 16\,a(n-7) - 11\,a(n-8) + 6\,a(n-9) + 60\,a(n-10) + 84\,a(n-11) + 44\,a(n-12) - 55\,a(n-13) - 155\,a(n-14) - 116\,a(n-15) - 26\,a(n-16) + 76\,a(n-17) + 47\,a(n-18) + 5\,a(n-19) + 9\,a(n-20) + 69\,a(n-21) + 139\,a(n-22) + 82\,a(n-23) - 18\,a(n-24) - 119\,a(n-25) - 105\,a(n-26) - 39\,a(n-27) + 14\,a(n-28) + 24\,a(n-29) + 10\,a(n-30)
\end{equation}
for all $n>33$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297885.
