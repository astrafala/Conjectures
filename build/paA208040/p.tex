...
\title{The empirical recurrence for OEIS A208040, proved by transfer matrix}
...
\begin{abstract}
OEIS A208040 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
$(0,0,0), (1,0,1)$ along one axis and $(0,0,0), (0,1,0)$ along the other, and carries an empirical recurrence of
...
OEIS A208040 is ``Number of 4 X n 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 0 0 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
9, 81, 279, 961, 4743, 23409, 100215,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 17 2022 17:47:32, revision
7) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 24\,a(n-3) + 117\,a(n-4) + 10\,a(n-5) + 88\,a(n-6) - 540\,a(n-7) - 2784\,a(n-8) - 648\,a(n-9) + 880\,a(n-10) + 2080\,a(n-11) + 11700\,a(n-12) + 4200\,a(n-13) + 2000\,a(n-15) - 10000\,a(n-16)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208040.
