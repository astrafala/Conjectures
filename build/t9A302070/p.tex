...
\title{The empirical recurrence for OEIS A302070, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A302070 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A302070 is ``Number of 3Xn 0..1 arrays with every element equal to 0, 1, 2 or 4 horizontally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
4, 32, 148, 748, 3657, 18108, 89658, 444359,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 31 2018 15:45:41, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) + 4\,a(n-2) + 2\,a(n-3) + 7\,a(n-4) + 7\,a(n-5) - 4\,a(n-6) - 10\,a(n-7) - 3\,a(n-8) - 5\,a(n-9) - 11\,a(n-10) + 2\,a(n-11) + 8\,a(n-12) + a(n-13) - a(n-15)
\end{equation}
for all $n>18$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302070.
