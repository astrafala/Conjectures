...
\title{The empirical recurrence for OEIS A264129, proved by transfer matrix}
...
\begin{abstract}
OEIS A264129 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=5$ rows in which
...
OEIS A264129 is ``Number of (n+1) X (4+1) arrays of permutations of 0..n*5+4 with each element having index change +-(.,.) 0,0 0,2 or 1,2.''. It has offset $1$ and begins
\[
80, 1040, 13600, 178000, 2330000, 30500000, 399250000, 5226250000,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 15*a(n-1) - 25*a(n-2).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 04 2019 14:44:19, revision 11) this is still
...
\[
(i-h_i,\,j-h_j)\;\in\;\{(-1,-2),\ (0,-2),\ (0,0),\ (0,2),\ (1,2)\},
\]
...
transposed companion A263966. Second, the transfer model reproduces all $16$ terms this
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264129.
