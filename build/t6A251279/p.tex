...
\title{The empirical recurrence for OEIS A251279, proved by transfer matrix}
...
\begin{abstract}
OEIS A251279 counts $(n+1)\times5$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
every $2\times2$ subblock, and carries an empirical recurrence of order $23$ contributed
...
OEIS A251279 is ``Number of (n+1)X(4+1) 0..3 arrays with no 2X2 subblock having its maximum diagonal element less than its minimum antidiagonal element.''. It has offset $1$ and begins
\[
655040, 420152704, 269564757184, 172919373209920, 110920574724652544, 71150650646356529216, 45639971417777166667264, 29276004583234054916462336,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:13:43, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;806\,a(n-1) - 111943\,a(n-2) + 4121346\,a(n-3) - 13373220\,a(n-4) + 518803126\,a(n-5) + 91027897588\,a(n-6) - 4223226636896\,a(n-7) - 3165566113410\,a(n-8) + 807830174039748\,a(n-9) + 2220446028051064\,a(n-10) - 29605166719379408\,a(n-11) + 234129791228315392\,a(n-12) + 1710848209648245632\,a(n-13) - 11053265657875185664\,a(n-14) - 52364613787367517184\,a(n-15) + 144900565749877080064\,a(n-16) + 435967705664201056256\,a(n-17) - 887491236069326815232\,a(n-18) + 852209893822362550272\,a(n-19) - 227064618958082015232\,a(n-20) - 407679314486819291136\,a(n-21) - 43925631376457465856\,a(n-22) - 2507350103656759296\,a(n-23)
\end{equation}
for all $n>22$.
...
For every $n$ with $n+1-1\ge23$,
\[
a(n)-\sum_i c_i\,a(n-i)\;=\;\mathbf{1}^{\!\top}M^{\,n+1-1-23}\,q(M)\,\mathbf{1} .
\]
...
=\mathbf{1}^{\!\top}M^{\,m-23}\,q(M)\,\mathbf{1}
\]
...
$m-23=j$ run over $\ge0$. For the last clause put $w=q(M)\mathbf{1}$. By the
...
$S^2$ pairs. The vector $w=q(M)\mathbf{1}\in\mathbb{Z}^{S}$ was then formed by $23$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251279.
