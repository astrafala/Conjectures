...
\title{The empirical recurrence for OEIS A250922, proved by transfer matrix}
...
\begin{abstract}
OEIS A250922 counts $(n+1)\times4$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A250922 is ``Number of (n+1)X(3+1) 0..2 arrays with no 2X2 subblock having its minimum diagonal element less than its minimum antidiagonal element.''. It has offset $1$ and begins
\[
2007, 50722, 1320397, 34521887, 899626256, 23390844328, 607786907671, 15792648591051,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 12:51:19, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;81\,a(n-1) - 2899\,a(n-2) + 63295\,a(n-3) - 958285\,a(n-4) + 10756670\,a(n-5) - 93330409\,a(n-6) + 644640204\,a(n-7) - 3624496674\,a(n-8) + 16880394940\,a(n-9) - 66023717068\,a(n-10) + 219240302561\,a(n-11) - 623358921354\,a(n-12) + 1527544435817\,a(n-13) - 3241977665792\,a(n-14) + 5979956364272\,a(n-15) - 9608041848406\,a(n-16) + 13461986448007\,a(n-17) - 16448861092094\,a(n-18) + 17508255649822\,a(n-19) - 16196842918537\,a(n-20) + 12974801039902\,a(n-21) - 8952649323986\,a(n-22) + 5282187628341\,a(n-23) - 2638768086999\,a(n-24) + 1101316093488\,a(n-25) - 377022705948\,a(n-26) + 103145374080\,a(n-27) - 21690899280\,a(n-28) + 3292887168\,a(n-29) - 321226560\,a(n-30) + 15116544\,a(n-31)
\end{equation}
for all $n>30$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250922.
