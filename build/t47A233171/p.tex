...
\title{The empirical recurrence for OEIS A233171, proved by transfer matrix}
...
\begin{abstract}
OEIS A233171 counts arrays over $\{0,\dots,5\}$ in which no two entries that are neighbours in
...
carried by one bounded piece of extra state, so the count is a walk count on $S=2834$ states.
\end{abstract}
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 09 2024 15:22:16, revision 10) this is still
...
and every first appearance it contains. There are $S=2834$ reachable states.
...
\begin{theorem}
\[
a(n)\;=\;480\,a(n-1) - 60416\,a(n-2) + 1966080\,a(n-3) + 22020096\,a(n-4) - 1845493760\,a(n-5) + 22548578304\,a(n-6) - 68719476736\,a(n-7)
\]
for every $n>7$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A233171.
