...
\title{The empirical recurrence for OEIS A189065, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A189065 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A189065 is ``Number of 3 X n binary arrays without the pattern 0 1 0 antidiagonally or horizontally.''. It has offset $1$ and begins
\[
8, 64, 316, 1404, 6768, 33893, 167473, 818962,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 22 2022 12:02:19, revision 7) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) - 6\,a(n-2) + 33\,a(n-3) + 51\,a(n-4) + 108\,a(n-5) + 325\,a(n-6) + 320\,a(n-7) + 280\,a(n-8) + 264\,a(n-9) - 424\,a(n-10) - 882\,a(n-11) - 362\,a(n-12) + 68\,a(n-13) + 97\,a(n-14) + 92\,a(n-15) + 38\,a(n-16) - a(n-17) - a(n-18) - 2\,a(n-19) - a(n-20)
\end{equation}
for all $n>21$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A189065.
