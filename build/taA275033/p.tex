...
\title{The empirical recurrence for OEIS A275033, proved by counting patterns}
...
\begin{abstract}
OEIS A275033 counts arrays in which no entry may repeat a value found at any of three stated
...
cutting $6818$ pairs to $S=1223$ states. The entry's empirical recurrence of order $35$,
...
OEIS A275033 is ``Number of nX4 0..2 arrays with no element equal to any value at offset (0,-1) (-1,-2) or (-2,0) and new values introduced in order 0..2.''. It has offset $1$ and begins
\[
4, 48, 137, 570, 2334, 9774, 40572, 169348,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 14 2016 09:50:05, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) + 14\,a(n-2) - 62\,a(n-3) - 40\,a(n-4) + 388\,a(n-5) - 306\,a(n-6) - 1193\,a(n-7) + 2504\,a(n-8) + 1764\,a(n-9) - 7620\,a(n-10) - 1306\,a(n-11) + 13370\,a(n-12) + 1805\,a(n-13) - 16980\,a(n-14) - 5291\,a(n-15) + 18277\,a(n-16) + 10135\,a(n-17) - 18477\,a(n-18) - 12333\,a(n-19) + 18384\,a(n-20) + 9126\,a(n-21) - 15323\,a(n-22) - 4234\,a(n-23) + 9693\,a(n-24) + 1188\,a(n-25) - 4598\,a(n-26) - 61\,a(n-27) + 1605\,a(n-28) - 135\,a(n-29) - 382\,a(n-30) + 68\,a(n-31) + 53\,a(n-32) - 14\,a(n-33) - 3\,a(n-34) + a(n-35)
\end{equation}
for all $n>37$.
