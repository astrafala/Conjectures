...
\title{The empirical recurrence for OEIS A305512, proved by transfer matrix}
...
\begin{abstract}
OEIS A305512 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A305512 is ``Number of nX4 0..1 arrays with every element unequal to 1, 2, 5, 6 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
2, 1, 6, 10, 13, 38, 73, 164,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +a(n-2) +5*a(n-3) -8*a(n-6) -8*a(n-7) -10*a(n-9) -a(n-10) +a(n-11) -2*a(n-12) -2*a(n-14) for n>17
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 03 2018 13:17:48, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + a(n-2) + 5\,a(n-3) - 8\,a(n-6) - 8\,a(n-7) - 10\,a(n-9) - a(n-10) + a(n-11) - 2\,a(n-12) - 2\,a(n-14)
\end{equation}
for all $n>17$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A305512.
