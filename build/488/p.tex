...
OEIS A094905 is ``Expansion of e.g.f.: exp(6*x)/(1-6*x)\^{}(1/6)''. It has offset $0$ and begins
\[
...
\begin{quote}\small
Conjectured to be D-finite with recurrence: a(n) +(-6*n-1)*a(n-1) +36*(n-1)*a(n-2) = 0. - \emph{R. J. Mathar}, Nov 15 2019
\end{quote}
...
vanish, for all 14 values of $n$ from $n=2$ upward. This is what
