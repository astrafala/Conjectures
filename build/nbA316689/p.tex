...
\title{The empirical recurrence for OEIS A316689, proved by transfer matrix}
...
\begin{abstract}
OEIS A316689 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A316689 is ``Number of nX4 0..1 arrays with every element unequal to 0, 1, 2, 6, 7 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
8, 5, 9, 23, 44, 125, 313, 773,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +2*a(n-2) +5*a(n-3) +a(n-4) -2*a(n-5) -6*a(n-6) -4*a(n-7) for n>11
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 10 2018 15:03:53, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 2\,a(n-2) + 5\,a(n-3) + a(n-4) - 2\,a(n-5) - 6\,a(n-6) - 4\,a(n-7)
\end{equation}
for all $n>10$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A316689.
