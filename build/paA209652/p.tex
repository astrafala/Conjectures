...
\title{The empirical recurrence for OEIS A209652, proved by transfer matrix}
...
\begin{abstract}
OEIS A209652 counts arrays over $\{0,\dots,1\}$ of width $5$ that avoid the patterns
...
OEIS A209652 is ``Number of 5Xn 0..1 arrays avoiding 0 0 1 and 1 0 0 horizontally and 0 0 1 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
10, 100, 390, 1215, 4690, 16830, 65765,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 15:24:16, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;11\,a(n-1) - 13\,a(n-2) - 243\,a(n-3) + 709\,a(n-4) + 2169\,a(n-5) - 9198\,a(n-6) - 9930\,a(n-7) + 61958\,a(n-8) + 23330\,a(n-9) - 254062\,a(n-10) - 16614\,a(n-11) + 669763\,a(n-12) - 53961\,a(n-13) - 1146177\,a(n-14) + 176529\,a(n-15) + 1247849\,a(n-16) - 252499\,a(n-17) - 820948\,a(n-18) + 202824\,a(n-19) + 291592\,a(n-20) - 85440\,a(n-21) - 41472\,a(n-22) + 13824\,a(n-23)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209652.
