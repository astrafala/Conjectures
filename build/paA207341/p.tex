...
\title{The empirical recurrence for OEIS A207341, proved by transfer matrix}
...
\begin{abstract}
OEIS A207341 counts arrays over $\{0,\dots,1\}$ of width $3$ that avoid the patterns
...
OEIS A207341 is ``Number of nX3 0..1 arrays avoiding 0 0 0 and 0 1 1 horizontally and 0 0 0 and 1 1 1 vertically.''. It has offset
$1$ and begins
\[
6, 36, 84, 292, 912, 2812, 8928,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 4*a(n-2) +16*a(n-3) +13*a(n-4) -10*a(n-5) -17*a(n-6) -8*a(n-7) +2*a(n-8) -2*a(n-9) -a(n-10) for n>13
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 13:47:21, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-2) + 16\,a(n-3) + 13\,a(n-4) - 10\,a(n-5) - 17\,a(n-6) - 8\,a(n-7) + 2\,a(n-8) - 2\,a(n-9) - a(n-10)
\end{equation}
for all $n>11$. 
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207341.
