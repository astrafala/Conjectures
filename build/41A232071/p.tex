...
\title{The empirical recurrence for OEIS A232071, proved by transfer matrix}
...
\begin{abstract}
OEIS A232071 counts arrays of width $4$ over $\{0,\dots,1\}$ under a condition on each cell
...
OEIS A232071 is ``Number of (n+1)X(3+1) 0..1 arrays with every element equal to some horizontal, diagonal or antidiagonal neighbor, with top left element zero.''. It has offset $1$ and begins
\[
46, 520, 6624, 82996, 1043172, 13105012, 164650280, 2068621706,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 06:51:41, revision 6) this is still
...
$46$, which the model reproduces along with every later term. That is the cheapest check
...
\begin{theorem}
\[
a(n)\;=\;10\,a(n-1) + 33\,a(n-2) + 6\,a(n-3) - 176\,a(n-4) - 300\,a(n-5) - 15\,a(n-6) - 76\,a(n-7) + 79\,a(n-8) + 72\,a(n-9) - 16\,a(n-10)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232071.
