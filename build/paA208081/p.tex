...
\title{The empirical recurrence for OEIS A208081, proved by transfer matrix}
...
\begin{abstract}
OEIS A208081 counts arrays over $\{0,\dots,1\}$ of width $6$ that avoid the patterns
...
OEIS A208081 is ``Number of 6 X n 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 0 0 and 0 1 0 vertically.''. It has offset
$1$ and begins
\[
25, 625, 7225, 99225, 1288225, 17098225, 224850025,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 10*a(n-1) +59*a(n-2) -216*a(n-3) -146*a(n-4) +568*a(n-5) -58*a(n-6) -208*a(n-7) +35*a(n-8) +6*a(n-9) -a(n-10).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 20 2018 12:31:38, revision
12) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;10\,a(n-1) + 59\,a(n-2) - 216\,a(n-3) - 146\,a(n-4) + 568\,a(n-5) - 58\,a(n-6) - 208\,a(n-7) + 35\,a(n-8) + 6\,a(n-9) - a(n-10)
\end{equation}
...
$(0,0,0), (0,1,0)$ as $3$ consecutive entries. There are $25$ admissible columns; that condition
...
columns, so $S=625$, and declare $w\to w'$ an edge when $w'$ is $w$ with its first entry
...
values agree exactly, including the initial count of $25$ admissible columns. That is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208081.
