...
\title{The empirical recurrence for OEIS A251353, proved by transfer matrix}
...
\begin{abstract}
OEIS A251353 counts $(n+1)\times3$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A251353 is ``Number of (n+1)X(2+1) 0..3 arrays with no 2X2 subblock having its maximum diagonal element less than the absolute difference of its antidiagonal elements.''. It has offset $1$ and begins
\[
2920, 137642, 6505867, 307396791, 14522811996, 686136478104, 32416955585740, 1531558664946401,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:17:19, revision 6) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251353.
