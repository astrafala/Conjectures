...
\title{The empirical recurrence for OEIS A317692, proved by transfer matrix}
...
\begin{abstract}
OEIS A317692 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A317692 is ``Number of nX3 0..1 arrays with every element unequal to 0, 1, 3, 4, 5, 6, 7 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
3, 9, 14, 33, 92, 220, 593, 1787,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 04 2018 20:07:33, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) - 6\,a(n-2) + 16\,a(n-3) - 60\,a(n-4) + 43\,a(n-5) - 36\,a(n-6) + 156\,a(n-7) - 49\,a(n-8) - 12\,a(n-9) - 91\,a(n-10) + 28\,a(n-11) - 94\,a(n-12) - 121\,a(n-13) + 362\,a(n-14) - 148\,a(n-15) - 28\,a(n-16) + 16\,a(n-17)
\end{equation}
for all $n>18$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A317692.
