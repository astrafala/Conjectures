...
\title{The empirical recurrence for OEIS A211328, proved by a one-dimensional reduction}
...
\begin{abstract}
OEIS A211328 counts symmetric $(n+1)\times(n+1)$ matrices over
$\{-3,\dots,3\}$ in which every $2\times2$ subblock sums to zero and has two, three or four distinct
...
on $S=46$ states, and the empirical recurrence of order $8$ contributed by R.~H.~Hardin
follows.
\end{abstract}
...
OEIS A211328 is ``Number of (n+1) X (n+1) -3..3 symmetric matrices with every 2 X 2 subblock having sum zero and two, three or four distinct values.''. It has offset $1$ and begins
\[
24, 86, 310, 1134, 4190, 15582, 58130, 217014,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 13*a(n-1) - 63*a(n-2) + 130*a(n-3) - 65*a(n-4) - 115*a(n-5) + 69*a(n-6) + 68*a(n-7) + 12*a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 17 2018 06:36:14, revision 7) this is still
...
$S=46$. The two parity classes never mix, so the walk starts by choosing a parity and a first
value, and every state may end a sequence:
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad \tau=\mathbf{1},\qquad S=46.
\]
...
\begin{theorem}
\[
a(n)\;=\;13\,a(n-1) - 63\,a(n-2) + 130\,a(n-3) - 65\,a(n-4) - 115\,a(n-5) + 69\,a(n-6) + 68\,a(n-7) + 12\,a(n-8)
\]
for every $n>7$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A211328.
