...
\title{The empirical recurrence for OEIS A251081, proved by transfer matrix}
...
\begin{abstract}
OEIS A251081 counts $(n+1)\times2$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A251081 is ``Number of (n+1) X (1+1) 0..2 arrays with no 2 X 2 subblock having the sum of its diagonal elements greater than the absolute difference of its antidiagonal elements.''. It has offset $1$ and begins
\[
27, 83, 192, 420, 872, 1782, 3593, 7215,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 5*a(n-1) - 8*a(n-2) + 2*a(n-3) + 7*a(n-4) - 7*a(n-5) + 2*a(n-6) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 24 2018 11:57:08, revision 8) the statement is
...
every one of the $28$ published indices; the values agree exactly. That is what ties
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251081.
