...
\title{The empirical recurrence for OEIS A208557, proved by transfer matrix}
...
\begin{abstract}
OEIS A208557 counts arrays over $\{0,\dots,1\}$ of width $5$ that avoid the patterns
$(0,0,1), (0,1,1)$ along one axis and $(0,0,0), (0,0,1)$ along the other, and carries an empirical recurrence of
...
OEIS A208557 is ``Number of 5 X n 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 0 1 and 0 1 1 vertically.''. It has offset
$1$ and begins
\[
12, 144, 420, 2508, 10080, 50052, 221340,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) + 17*a(n-2) + 6*a(n-3) - 36*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 04 2018 08:54:39, revision
8) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 17\,a(n-2) + 6\,a(n-3) - 36\,a(n-4)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208557.
