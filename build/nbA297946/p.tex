...
\title{The empirical recurrence for OEIS A297946, proved by transfer matrix}
...
\begin{abstract}
OEIS A297946 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A297946 is ``Number of nX3 0..1 arrays with every element equal to 1, 2, 3 or 5 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 18, 56, 219, 796, 3079, 11614, 44076,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 09 2018 07:33:12, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) - 2\,a(n-3) - 2\,a(n-4) - 12\,a(n-5) + 24\,a(n-6) + 3\,a(n-7) - 4\,a(n-8) - 80\,a(n-9) - 67\,a(n-10) + 37\,a(n-11) + 140\,a(n-12) + 100\,a(n-13) - 32\,a(n-14) - 67\,a(n-15) - 12\,a(n-16) + 24\,a(n-17) + 2\,a(n-18) - 12\,a(n-19) - 4\,a(n-20)
\end{equation}
for all $n>20$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297946.
