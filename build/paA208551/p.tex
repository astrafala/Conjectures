...
\title{The empirical recurrence for OEIS A208551, proved by transfer matrix}
...
\begin{abstract}
OEIS A208551 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
$(0,0,0), (0,0,1)$ along one axis and $(0,0,1), (0,1,1)$ along the other, and carries an empirical recurrence of
...
OEIS A208551 is ``Number of n X 4 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 0 1 and 0 1 1 vertically.''. It has offset
$1$ and begins
\[
10, 100, 330, 1089, 2508, 5776, 11020,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) + 4*a(n-2) - 10*a(n-3) - 5*a(n-4) + 20*a(n-5) - 20*a(n-7) + 5*a(n-8) + 10*a(n-9) - 4*a(n-10) - 2*a(n-11) + a(n-12).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 03 2018 14:58:41, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208551.
