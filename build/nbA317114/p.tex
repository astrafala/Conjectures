...
\title{The empirical recurrence for OEIS A317114, proved by transfer matrix}
...
\begin{abstract}
OEIS A317114 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $different from$ itself lying in $\{0,1,2,3,4,7,8\}$, and it carries an empirical
recurrence of order $35$ contributed by R.~H.~Hardin. It is true. The neighbourhood
...
OEIS A317114 is ``Number of nX4 0..1 arrays with every element unequal to 0, 1, 2, 3, 4, 7 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
8, 112, 698, 5157, 37221, 273221, 2000595, 14657917,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 21 2018 17:23:51, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) + 18\,a(n-2) - 52\,a(n-3) - 87\,a(n-4) + 179\,a(n-5) - 32\,a(n-6) - 71\,a(n-7) + 331\,a(n-8) - 255\,a(n-9) + 742\,a(n-10) - 1606\,a(n-11) - 181\,a(n-12) + 3533\,a(n-13) - 4199\,a(n-14) + 1635\,a(n-15) - 190\,a(n-16) - 239\,a(n-17) + 1405\,a(n-18) - 4311\,a(n-19) + 3687\,a(n-20) - 4321\,a(n-21) + 3412\,a(n-22) - 3747\,a(n-23) + 4780\,a(n-24) - 2739\,a(n-25) + 465\,a(n-26) - 471\,a(n-27) + 287\,a(n-28) + 41\,a(n-29) + 26\,a(n-30) + 101\,a(n-31) - 33\,a(n-32) + 12\,a(n-33) - 14\,a(n-34) + 8\,a(n-35)
\end{equation}
for all $n>36$.
...
has score in $\{0,1,2,3,4,7,8\}$. The entry also fixes the top-left entry to be $0$; that is a condition on the first row alone, so it restricts the start vector and nothing else.
...
\begin{itemize}
\item $\mathbf{s}(r,s)=1$ when every cell of $r$ has score in $\{0,1,2,3,4,7,8\}$ \emph{with no row
above $r$} and $r_1=0$, and $0$ otherwise;
\item an edge $(r,s)\to(s,t)$ when every cell of $s$ has score in $\{0,1,2,3,4,7,8\}$ computed from
$r$, $s$ and $t$;
\item $\mathbf{e}(r,s)=1$ when every cell of $s$ has score in $\{0,1,2,3,4,7,8\}$ \emph{with no row
...
exactly when every one of its $n$ rows has all scores in $\{0,1,2,3,4,7,8\}$. Read the sequence as the
...
$a(n)-\sum_i c_i a(n-i)=u_{\,n-2-35}$ whenever $n-35\ge2$. So \eqref{eq:conj}
holds for every $n>t$ exactly when $u_j=0$ for all $j>t-2-35$. Moreover $(u_j)$
...
\begin{proof}
Substituting Lemma~\ref{lem:walk} and factoring $P^{\,n-2-35}$ out of
...
\begin{proof}
The vector $q(P)\mathbf{e}\in\mathbb{Z}^{S}$ was formed by $35$ matrix--vector
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A317114.
