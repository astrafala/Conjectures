...
\title{The empirical recurrence for OEIS A203392, proved by transfer matrix}
...
\begin{abstract}
OEIS A203392 counts arrays of width $3$ over $\{0,1,2,3\}$ in which every nonzero cell has a neighbour at least as large as itself. The entry carries an
...
OEIS A203392 is ``Number of nX3 0..3 arrays with every nonzero element less than or equal to some NW, E or S neighbor.''. It has offset $1$ and begins
\[
1, 185, 7785, 210342, 5666072, 163500122, 4711784187, 134023641768,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 10:25:56, revision 9) this is still
...
Thus
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=3265,
\]
...
\begin{theorem}
\[
a(n)\;=\;64\,a(n-1) - 1706\,a(n-2) + 30044\,a(n-3) - 404960\,a(n-4) + 4099850\,a(n-5) - 30536063\,a(n-6) + 171426725\,a(n-7) - 757277294\,a(n-8) + 2720190934\,a(n-9) - 8042244702\,a(n-10) + 19622828742\,a(n-11) - 39893786618\,a(n-12) + 68882173897\,a(n-13) - 102395699308\,a(n-14) + 129694096680\,a(n-15) - 135121114784\,a(n-16) + 110642585924\,a(n-17) - 68014475760\,a(n-18) + 29890935888\,a(n-19) - 8795890848\,a(n-20) + 1545208704\,a(n-21) - 122145408\,a(n-22)
\]
for every $n>23$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A203392.
