...
\title{The empirical recurrence for OEIS A302382, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A302382 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A302382 is ``Number of 3Xn 0..1 arrays with every element equal to 1, 2, 3 or 4 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
0, 11, 76, 430, 2886, 19215, 127535, 847604,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 06 2018 12:43:09, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) + 15\,a(n-2) + 14\,a(n-3) + 19\,a(n-4) + 8\,a(n-5) + 9\,a(n-6) - 9\,a(n-7) + 4\,a(n-8) - 5\,a(n-9) + 3\,a(n-10) - 3\,a(n-11) - 5\,a(n-12) + a(n-13) - 2\,a(n-14)
\end{equation}
for all $n>15$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302382.
