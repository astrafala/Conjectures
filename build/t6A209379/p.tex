...
\title{The empirical recurrence for OEIS A209379, proved by transfer matrix}
...
\begin{abstract}
OEIS A209379 counts $(n+1)\times6$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A209379 is ``1/4 the number of (n+1) X 6 0..2 arrays with every 2 X 2 subblock having distinct edge sums.''. It has offset $1$ and begins
\[
64, 170, 320, 1076, 2176, 8648, 18176, 78800,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 16*a(n-2) - 68*a(n-4) + 80*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 09 2018 17:35:01, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;16\,a(n-2) - 68\,a(n-4) + 80\,a(n-6)
\end{equation}
for all $n>6$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209379.
