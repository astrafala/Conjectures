...
\title{The empirical recurrence for OEIS A304844, proved by transfer matrix}
...
\begin{abstract}
OEIS A304844 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $different from$ itself lying in $\{0,1,2,4,7\}$, and it carries an empirical
...
OEIS A304844 is ``Number of n X 4 0..1 arrays with every element unequal to 0, 1, 2, 4 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
8, 24, 51, 132, 502, 1638, 4816, 15697,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 20 2021 12:54:27, revision
6) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 4\,a(n-2) + 10\,a(n-3) - 12\,a(n-4) - 70\,a(n-5) - 57\,a(n-6) + 109\,a(n-7) + 258\,a(n-8) + 80\,a(n-9) - 206\,a(n-10) - 210\,a(n-11) - 54\,a(n-12) - 493\,a(n-13) - 200\,a(n-14) + 1067\,a(n-15) + 336\,a(n-16) - 258\,a(n-17) + 16\,a(n-18) + 129\,a(n-19) + 71\,a(n-20) - 951\,a(n-21) - 578\,a(n-22) + 1082\,a(n-23) - 246\,a(n-24) + 3\,a(n-25) + 1259\,a(n-26) - 962\,a(n-27) - 842\,a(n-28) + 848\,a(n-29) - 98\,a(n-30) - 294\,a(n-31) + 282\,a(n-32) + 48\,a(n-33) - 72\,a(n-34)
\end{equation}
for all $n>37$.
...
has score in $\{0,1,2,4,7\}$. The entry also fixes the top-left entry to be $0$; that is a condition on the first row alone, so it restricts the start vector and nothing else.
...
\begin{itemize}
\item $\mathbf{s}(r,s)=1$ when every cell of $r$ has score in $\{0,1,2,4,7\}$ \emph{with no row
above $r$} and $r_1=0$, and $0$ otherwise;
\item an edge $(r,s)\to(s,t)$ when every cell of $s$ has score in $\{0,1,2,4,7\}$ computed from
$r$, $s$ and $t$;
\item $\mathbf{e}(r,s)=1$ when every cell of $s$ has score in $\{0,1,2,4,7\}$ \emph{with no row
...
exactly when every one of its $n$ rows has all scores in $\{0,1,2,4,7\}$. Read the sequence as the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A304844.
