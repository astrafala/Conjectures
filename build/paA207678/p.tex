...
\title{The empirical recurrence for OEIS A207678, proved by transfer matrix}
...
\begin{abstract}
OEIS A207678 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
...
OEIS A207678 is ``Number of n X 4 0..1 arrays avoiding 0 0 0 and 1 0 1 horizontally and 0 0 1 and 1 1 1 vertically.''. It has offset
$1$ and begins
\[
9, 81, 164, 436, 1030, 2032, 4174,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 29 2023 10:03:43, revision
7) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 2\,a(n-2) + a(n-3) - 12\,a(n-4) - 3\,a(n-5) + 27\,a(n-7) + 8\,a(n-8) - 2\,a(n-9) - 33\,a(n-10) - 15\,a(n-11) + 19\,a(n-13) + 23\,a(n-14) - 4\,a(n-15) + a(n-16) - 19\,a(n-17) + 4\,a(n-18) - 4\,a(n-19) + 7\,a(n-20) - a(n-21) + a(n-22) - a(n-23)
\end{equation}
for all $n>26$. 
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207678.
