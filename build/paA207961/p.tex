...
\title{The empirical recurrence for OEIS A207961, proved by transfer matrix}
...
\begin{abstract}
OEIS A207961 counts arrays over $\{0,\dots,1\}$ of width $3$ that avoid the patterns
...
OEIS A207961 is ``Number of 3 X n 0..1 arrays avoiding 0 0 0 and 1 0 1 horizontally and 0 0 1 and 1 0 0 vertically.''. It has offset
$1$ and begins
\[
6, 36, 102, 281, 699, 1799, 4706,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) + a(n-2) + 7*a(n-3) + 4*a(n-4) - 7*a(n-6) - 6*a(n-7) + 6*a(n-9) + 2*a(n-10) - a(n-11) - a(n-12) for n>13.
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 06 2018 08:55:13, revision
8) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + a(n-2) + 7\,a(n-3) + 4\,a(n-4) - 7\,a(n-6) - 6\,a(n-7) + 6\,a(n-9) + 2\,a(n-10) - a(n-11) - a(n-12)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207961.
