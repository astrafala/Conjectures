...
\title{The empirical recurrence for OEIS A303080, proved by transfer matrix}
...
\begin{abstract}
OEIS A303080 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the six horizontal, diagonal and antidiagonal neighbours, a number $equal to$ itself lying in $\{0,2,3,4,6\}$, and it carries an empirical
...
OEIS A303080 is ``Number of n X 4 0..1 arrays with every element equal to 0, 2, 3, 4 or 6 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 20, 29, 90, 304, 1054, 4182, 17369,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 08 2023 13:31:42, revision
6) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;8\,a(n-1) - 20\,a(n-2) + 40\,a(n-3) - 120\,a(n-4) + 154\,a(n-5) - 227\,a(n-6) + 511\,a(n-7) + 23\,a(n-8) + 913\,a(n-9) - 826\,a(n-10) - 2376\,a(n-11) - 4502\,a(n-12) - 920\,a(n-13) + 3818\,a(n-14) + 8855\,a(n-15) - 818\,a(n-16) - 403\,a(n-17) + 2092\,a(n-18) + 20390\,a(n-19) + 17737\,a(n-20) + 13494\,a(n-21) + 4257\,a(n-22) + 11150\,a(n-23) + 41175\,a(n-24) + 19200\,a(n-25) - 34770\,a(n-26) - 72210\,a(n-27) - 29661\,a(n-28) + 7521\,a(n-29) + 6424\,a(n-30) - 14914\,a(n-31) - 37578\,a(n-32) - 31048\,a(n-33) + 39954\,a(n-34) + 42548\,a(n-35) - 9756\,a(n-36) - 24760\,a(n-37) - 7244\,a(n-38) + 12262\,a(n-39) + 22816\,a(n-40) + 9539\,a(n-41) - 6968\,a(n-42) - 8366\,a(n-43) + 142\,a(n-44) + 5260\,a(n-45) + 1414\,a(n-46) - 1709\,a(n-47) - 1376\,a(n-48) - 1138\,a(n-49) - 624\,a(n-50) + 218\,a(n-51) + 300\,a(n-52) + 84\,a(n-53) + 36\,a(n-54) + 16\,a(n-55) - 16\,a(n-56)
\end{equation}
for all $n>56$.
...
has score in $\{0,2,3,4,6\}$. The entry also fixes the top-left entry to be $0$; that is a condition on the first row alone, so it restricts the start vector and nothing else.
...
\begin{itemize}
\item $\mathbf{s}(r,s)=1$ when every cell of $r$ has score in $\{0,2,3,4,6\}$ \emph{with no row
above $r$} and $r_1=0$, and $0$ otherwise;
\item an edge $(r,s)\to(s,t)$ when every cell of $s$ has score in $\{0,2,3,4,6\}$ computed from
$r$, $s$ and $t$;
\item $\mathbf{e}(r,s)=1$ when every cell of $s$ has score in $\{0,2,3,4,6\}$ \emph{with no row
...
exactly when every one of its $n$ rows has all scores in $\{0,2,3,4,6\}$. Read the sequence as the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A303080.
