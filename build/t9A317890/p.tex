...
\title{The empirical recurrence for OEIS A317890, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A317890 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A317890 is ``Number of nX2 0..1 arrays with every element unequal to 2, 3 or 4 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
0, 1, 1, 2, 5, 16, 45, 123,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) +a(n-2) +2*a(n-3) +3*a(n-4) +a(n-5) for n>6
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2018 10:29:25, revision 4) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A317890.
