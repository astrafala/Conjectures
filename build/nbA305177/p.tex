...
\title{The empirical recurrence for OEIS A305177, proved by transfer matrix}
...
\begin{abstract}
OEIS A305177 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A305177 is ``Number of nX3 0..1 arrays with every element unequal to 1, 2, 5, 6 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 2, 8, 9, 14, 29, 49, 78,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 4*a(n-3) +4*a(n-4) -a(n-6) -8*a(n-7) -2*a(n-9) -4*a(n-10) for n>13
\end{quote}
As of the ``Last modified'' line on the live entry (May 26 2018 18:35:51, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-3) + 4\,a(n-4) - a(n-6) - 8\,a(n-7) - 2\,a(n-9) - 4\,a(n-10)
\end{equation}
for all $n>12$.
...
compared against the entry's DATA at every one of the $35$ published indices; they
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A305177.
