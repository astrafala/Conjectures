...
\title{The empirical recurrence for OEIS A305091, proved by transfer matrix}
...
\begin{abstract}
OEIS A305091 counts $2$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A305091 is ``Number of n X 2 0..1 arrays with every element unequal to 1, 2, 4, 6 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 3, 9, 10, 27, 109, 168, 349,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +a(n-2) +8*a(n-3) -16*a(n-5) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (May 25 2024 22:01:22, revision
6) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + a(n-2) + 8\,a(n-3) - 16\,a(n-5)
\end{equation}
for all $n>5$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A305091.
