...
\title{The empirical recurrence for OEIS A208165, proved by transfer matrix}
...
\begin{abstract}
OEIS A208165 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
...
OEIS A208165 is ``Number of 4Xn 0..1 arrays avoiding 0 0 0 and 1 0 1 horizontally and 0 0 1 and 0 1 0 vertically.''. It has offset
$1$ and begins
\[
9, 81, 287, 981, 2920, 9039, 28681,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:41:14, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 16\,a(n-3) + 13\,a(n-4) + 21\,a(n-5) - 24\,a(n-6) - 56\,a(n-7) - 65\,a(n-8) + 3\,a(n-9) + 93\,a(n-10) + 114\,a(n-11) + a(n-12) - 99\,a(n-13) - 107\,a(n-14) + 14\,a(n-15) + 86\,a(n-16) + 39\,a(n-17) - 34\,a(n-18) - 19\,a(n-19) + 6\,a(n-21)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208165.
