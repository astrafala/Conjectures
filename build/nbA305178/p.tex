...
\title{The empirical recurrence for OEIS A305178, proved by transfer matrix}
...
\begin{abstract}
OEIS A305178 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A305178 is ``Number of n X 4 0..1 arrays with every element unequal to 1, 2, 5, 6 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
2, 1, 9, 10, 13, 47, 71, 118,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +a(n-2) +3*a(n-3) -2*a(n-5) -5*a(n-6) -3*a(n-7) -2*a(n-9) +a(n-10) +2*a(n-11) for n>18.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 26 2025 11:58:02, revision
6) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + a(n-2) + 3\,a(n-3) - 2\,a(n-5) - 5\,a(n-6) - 3\,a(n-7) - 2\,a(n-9) + a(n-10) + 2\,a(n-11)
\end{equation}
for all $n>17$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A305178.
