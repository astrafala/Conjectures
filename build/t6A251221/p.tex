...
\title{The empirical recurrence for OEIS A251221, proved by transfer matrix}
...
\begin{abstract}
OEIS A251221 counts $(n+1)\times2$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A251221 is ``Number of (n+1) X (1+1) 0..1 arrays with no 2 X 2 subblock having the minimum of its diagonal elements greater than the absolute difference of its antidiagonal elements.''. It has offset $1$ and begins
\[
14, 49, 171, 597, 2084, 7275, 25396, 88654,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) + 2*a(n-2) - a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 25 2018 09:17:38, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251221.
