...
\title{The empirical recurrence for OEIS A219100, proved by transfer matrix}
...
\begin{abstract}
OEIS A219100 counts the distinct indicator arrays obtained from the $n\times2$ arrays over
...
indicator row by row turns it into one, on $S=10$ states, after which the conjectured
...
OEIS A219100 is ``Unmatched value maps: number of n X 2 binary arrays indicating the locations of corresponding elements not equal to any horizontal, vertical or antidiagonal neighbor in a random 0..2 n X 2 array.''. It has offset $1$ and begins
\[
2, 11, 42, 154, 582, 2199, 8287, 31240,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) - 2*a(n-2) + 5*a(n-3) - 3*a(n-4) + a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 10 2018 08:37:07, revision 8) this is still
...
\]
There are $S=10$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite. Note
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) - 2\,a(n-2) + 5\,a(n-3) - 3\,a(n-4) + a(n-5)
\]
for every $n>5$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A219100.
