...
\title{The empirical recurrence for OEIS A207183, proved by transfer matrix}
...
\begin{abstract}
OEIS A207183 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
...
OEIS A207183 is ``Number of 4Xn 0..1 arrays avoiding 0 0 0 horizontally and 0 1 0 vertically.''. It has offset
$1$ and begins
\[
12, 144, 1171, 11227, 105836, 981850, 9196215,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 13:34:12, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) + 26\,a(n-2) + 217\,a(n-3) + 103\,a(n-4) + 85\,a(n-5) - 4044\,a(n-6) + 1053\,a(n-7) - 6517\,a(n-8) + 27058\,a(n-9) - 11158\,a(n-10) + 29024\,a(n-11) - 63148\,a(n-12) + 15300\,a(n-13) - 29296\,a(n-14) + 43157\,a(n-15) + 2016\,a(n-16) + 4274\,a(n-17) - 7152\,a(n-18) - 147\,a(n-19) - 45\,a(n-20) + 375\,a(n-21)
\end{equation}
...
$(0,1,0)$ as $3$ consecutive entries. There are $12$ admissible columns; that condition
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207183.
