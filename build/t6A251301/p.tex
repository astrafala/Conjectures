...
\title{The empirical recurrence for OEIS A251301, proved by transfer matrix}
...
\begin{abstract}
OEIS A251301 counts $(n+1)\times2$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A251301 is ``Number of (n+1) X (1+1) 0..3 arrays with no 2 X 2 subblock having the sum of its diagonal elements less than the maximum of its antidiagonal elements.''. It has offset $1$ and begins
\[
196, 2292, 26664, 310224, 3609989, 42010273, 488885832, 5689307216,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 16*a(n-1) - 60*a(n-2) + 116*a(n-3) - 104*a(n-4) + 48*a(n-5) - 11*a(n-6) + a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 28 2018 08:04:19, revision 11) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;16\,a(n-1) - 60\,a(n-2) + 116\,a(n-3) - 104\,a(n-4) + 48\,a(n-5) - 11\,a(n-6) + a(n-7)
\end{equation}
for all $n>6$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251301.
