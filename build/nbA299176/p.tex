...
\title{The empirical recurrence for OEIS A299176, proved by transfer matrix}
...
\begin{abstract}
OEIS A299176 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $equal to$ itself lying in $\{0,1,2,3,6,7\}$, and it carries an empirical
...
OEIS A299176 is ``Number of nX4 0..1 arrays with every element equal to 0, 1, 2, 3, 6 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
8, 85, 205, 649, 2153, 7016, 22819, 73931,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 04 2018 12:58:57, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) - 10\,a(n-2) + 6\,a(n-3) - 15\,a(n-4) + 31\,a(n-5) - 44\,a(n-6) + 33\,a(n-7) + 22\,a(n-8) + 97\,a(n-9) - 84\,a(n-10) - 139\,a(n-11) - 109\,a(n-12) + 111\,a(n-13) + 183\,a(n-14) - 32\,a(n-15) + 12\,a(n-16) - 113\,a(n-17) + 47\,a(n-18) + 33\,a(n-19) - 40\,a(n-20) + 26\,a(n-21) - 20\,a(n-22)
\end{equation}
for all $n>27$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A299176.
