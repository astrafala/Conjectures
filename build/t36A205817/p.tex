...
\title{The empirical recurrence for OEIS A205817, proved by transfer matrix}
...
\begin{abstract}
OEIS A205817 counts arrays over $\{0,\dots,2\}$ under a condition on the number of clockwise edge increases
...
OEIS A205817 is ``Number of (n+1) X 3 0..2 arrays with the number of clockwise edge increases in every 2 X 2 subblock unequal to the number of counterclockwise edge increases.''. It has offset $1$ and begins
\[
66, 216, 714, 2430, 8274, 28242, 96402, 329130,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) - a(n-2) - 4*a(n-3) + 2*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 12 2018 11:12:29, revision 12) this is still
...
subblocks; the entry's first term is $66$, which the model
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) - a(n-2) - 4\,a(n-3) + 2\,a(n-4)
\]
for every $n>3$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A205817.
