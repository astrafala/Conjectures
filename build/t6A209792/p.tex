...
\title{The empirical recurrence for OEIS A209792, proved by transfer matrix}
...
\begin{abstract}
OEIS A209792 counts $(n+1)\times5$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A209792 is ``Half the number of (n+1)X5 0..2 arrays with every 2X2 subblock having exactly one duplicate clockwise edge difference.''. It has offset $1$ and begins
\[
9348, 759642, 61289190, 4953638163, 400252237467, 32342700329739, 2613436161921981, 211178329470822063,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 15:29:42, revision 9) the statement is
...
\[
a(n)-\sum_i c_i\,a(n-i)\;=\;\tfrac1{2}\mathbf{1}^{\!\top}M^{\,n+1-1-25}\,q(M)\,\mathbf{1} .
\]
...
=\tfrac1{2}\mathbf{1}^{\!\top}M^{\,m-25}\,q(M)\,\mathbf{1}
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209792.
