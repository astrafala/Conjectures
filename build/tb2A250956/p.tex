...
different counts. Across the columns settled here the model reproduces $29$ published
values, $162$ decimal digits in all, every one of them exactly; a misreading of the entry
