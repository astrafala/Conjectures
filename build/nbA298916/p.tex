...
\title{The empirical recurrence for OEIS A298916, proved by transfer matrix}
...
\begin{abstract}
OEIS A298916 counts $7$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A298916 is ``Number of nX7 0..1 arrays with every element equal to 0, 3, 5, 7 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 8, 8, 9, 15, 24, 40, 76,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 29 2018 07:45:11, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) - 5\,a(n-2) + 5\,a(n-3) - 9\,a(n-4) + 7\,a(n-5) - 2\,a(n-6) - a(n-7) + 7\,a(n-8) - 5\,a(n-9) + 3\,a(n-10) - 2\,a(n-11) - a(n-12) + a(n-13) - a(n-14)
\end{equation}
for all $n>14$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A298916.
