...
\title{The empirical recurrence for OEIS A218201, proved by transfer matrix}
...
\begin{abstract}
OEIS A218201 counts the distinct indicator arrays obtained from the $n\times3$ arrays over
$\{0,\dots,2\}$ by marking the cells whose value is at least as large as every one of their neighbours, and carries an
...
indicator row by row turns it into one, on $S=141$ states, after which the conjectured
...
OEIS A218201 is ``Hilltop maps: number of nX3 binary arrays indicating the locations of corresponding elements not exceeded by any horizontal or vertical neighbor in a random 0..2 nX3 array.''. It has offset $1$ and begins
\[
7, 59, 483, 3841, 30599, 243953, 1945103, 15508803,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 17:36:26, revision 8) this is still
...
\]
There are $S=141$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite. Note
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-1) + 6\,a(n-2) + 12\,a(n-3) + 10\,a(n-4) + 48\,a(n-5) + 9\,a(n-6) + 5\,a(n-7) + 13\,a(n-8) + 11\,a(n-9) - 51\,a(n-10) - 59\,a(n-11) - 48\,a(n-12) - 38\,a(n-13) + 13\,a(n-14) + 39\,a(n-15) + 33\,a(n-16) + 15\,a(n-17) + 5\,a(n-18) - 5\,a(n-19) - 6\,a(n-20) - 2\,a(n-21) + 2\,a(n-22) - a(n-24) - a(n-25)
\]
for every $n>25$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A218201.
