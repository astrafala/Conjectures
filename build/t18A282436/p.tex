...
\title{The empirical recurrence for OEIS A282436, proved by transfer matrix}
...
\begin{abstract}
OEIS A282436 counts $n\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A282436 is ``Number of nX3 0..1 arrays with no 1 equal to more than three of its king-move neighbors, with the exception of exactly one element.''. It has offset $1$ and begins
\[
0, 2, 96, 784, 6498, 50962, 378380, 2744000,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 15 2017 10:17:05, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;10\,a(n-1) - 15\,a(n-2) - 8\,a(n-3) - 293\,a(n-4) + 94\,a(n-5) - 343\,a(n-6) + 1808\,a(n-7) - 899\,a(n-8) + 3346\,a(n-9) - 4057\,a(n-10) + 4868\,a(n-11) - 7835\,a(n-12) + 4150\,a(n-13) - 8245\,a(n-14) + 3588\,a(n-15) - 4044\,a(n-16) + 496\,a(n-17) - 16\,a(n-18)
\]
for every $n>18$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A282436.
