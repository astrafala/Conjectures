...
\title{The empirical recurrence for OEIS A203373, proved by transfer matrix}
...
\begin{abstract}
OEIS A203373 counts $(n+1)\times4$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A203373 is ``Number of (n+1) X 4 0..1 arrays with every 2 X 2 subblock having equal diagonal elements or equal antidiagonal elements.''. It has offset $1$ and begins
\[
108, 748, 5208, 36300, 253068, 1764360, 12301020, 85762188,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 9*a(n-1) -15*a(n-2) +6*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 04 2018 09:22:28, revision 9) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A203373.
