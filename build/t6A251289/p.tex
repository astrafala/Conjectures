...
\title{The empirical recurrence for OEIS A251289, proved by transfer matrix}
...
\begin{abstract}
OEIS A251289 counts $(n+1)\times6$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A251289 is ``Number of (n+1)X(5+1) 0..1 arrays with every 2X2 subblock having a single 1 or two 1s on the same edge or main diagonally.''. It has offset $1$ and begins
\[
297, 2193, 12954, 94706, 577942, 4109933, 25654154, 178853600,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:14:37, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 88\,a(n-2) - 135\,a(n-3) - 2981\,a(n-4) + 3592\,a(n-5) + 53112\,a(n-6) - 48505\,a(n-7) - 569410\,a(n-8) + 364874\,a(n-9) + 3930122\,a(n-10) - 1540368\,a(n-11) - 17988232\,a(n-12) + 3272127\,a(n-13) + 55124431\,a(n-14) - 1161425\,a(n-15) - 113275406\,a(n-16) - 10826616\,a(n-17) + 154794982\,a(n-18) + 28341285\,a(n-19) - 137492855\,a(n-20) - 36207019\,a(n-21) + 76154295\,a(n-22) + 27994276\,a(n-23) - 24440737\,a(n-24) - 13266099\,a(n-25) + 3650459\,a(n-26) + 3432157\,a(n-27) + 109673\,a(n-28) - 359916\,a(n-29) - 80999\,a(n-30) - 2950\,a(n-31) + 430\,a(n-32) + 24\,a(n-33)
\end{equation}
for all $n>34$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251289.
