...
\title{The empirical recurrence for OEIS A233198, proved by transfer matrix}
...
\begin{abstract}
OEIS A233198 counts arrays over $\{0,\dots,7\}$ in which no two entries that are neighbours in
...
carried by one bounded piece of extra state, so the count is a walk count on $S=6446$ states.
\end{abstract}
...
and every first appearance it contains. There are $S=6446$ reachable states.
...
\begin{theorem}
\[
a(n)\;=\;208\,a(n-1) - 13312\,a(n-2) + 442368\,a(n-3) - 8650752\,a(n-4) + 67108864\,a(n-5)
\]
for every $n>6$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A233198.
