...
\title{The empirical recurrence for OEIS A264191, proved by transfer matrix}
...
\begin{abstract}
OEIS A264191 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=3$ rows in which
...
OEIS A264191 is ``Number of (n+1)X(2+1) arrays of permutations of 0..n*3+2 with each element having index change +-(.,.) 0,0 0,2 or 2,1.''. It has offset $1$ and begins
\[
4, 18, 81, 360, 1600, 6760, 28561, 120666,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 10 2015 11:10:31, revision 7) this is still
...
\[
(i-h_i,\,j-h_j)\;\in\;\{(-2,-1),\ (0,-2),\ (0,0),\ (0,2),\ (2,1)\},
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264191.
