...
\title{The empirical recurrence for OEIS A304592, proved by transfer matrix}
...
\begin{abstract}
OEIS A304592 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A304592 is ``Number of nX3 0..1 arrays with every element unequal to 1, 2, 3, 4 or 6 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 23, 82, 456, 2207, 10949, 54357, 269732,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 15 2018 13:16:13, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 9\,a(n-2) + 13\,a(n-3) - 38\,a(n-4) - 46\,a(n-5) + 28\,a(n-6) - 45\,a(n-7) - 54\,a(n-8) - 34\,a(n-9) + 8\,a(n-10) + 26\,a(n-11) - 37\,a(n-12) - 7\,a(n-13) - 3\,a(n-14) + 2\,a(n-15)
\end{equation}
for all $n>15$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A304592.
