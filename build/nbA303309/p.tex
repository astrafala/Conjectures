...
\title{The empirical recurrence for OEIS A303309, proved by transfer matrix}
...
\begin{abstract}
OEIS A303309 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A303309 is ``Number of nX3 0..1 arrays with every element equal to 0, 1, 4, 5 or 6 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
3, 3, 12, 11, 19, 34, 53, 83,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +a(n-3) +a(n-4) for n>7
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 21 2018 12:44:59, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A303309.
