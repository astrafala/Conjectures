...
\title{The empirical recurrence for OEIS A300607, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A300607 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A300607 is ``Number of nX3 0..1 arrays with every element equal to 1, 2, 3 or 5 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
1, 10, 53, 277, 1432, 7514, 39330, 205958,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 09 2018 17:31:45, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) + 5\,a(n-2) - 19\,a(n-3) - 6\,a(n-4) + 12\,a(n-5) - 2\,a(n-6) + 20\,a(n-7) + 15\,a(n-8) - 49\,a(n-9) - 35\,a(n-10) + 15\,a(n-11) + 4\,a(n-12) + 16\,a(n-13) + 36\,a(n-14) + 8\,a(n-15) - 16\,a(n-16) - 8\,a(n-17)
\end{equation}
for all $n>18$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A300607.
