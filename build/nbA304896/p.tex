...
\title{The empirical recurrence for OEIS A304896, proved by transfer matrix}
...
\begin{abstract}
OEIS A304896 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A304896 is ``Number of nX3 0..1 arrays with every element unequal to 1, 2, 3, 4 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 23, 62, 330, 1249, 5562, 23101, 99064,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 20 2018 10:37:38, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 12\,a(n-2) + 11\,a(n-3) - 12\,a(n-4) - 15\,a(n-5) + 14\,a(n-6) + 14\,a(n-7) + 26\,a(n-8) + 5\,a(n-9) + a(n-10) - a(n-11) - 17\,a(n-12) + a(n-13) - 5\,a(n-14) + 2\,a(n-15)
\end{equation}
for all $n>15$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A304896.
