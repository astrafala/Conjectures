...
carried by one bounded piece of extra state, so the count is a walk count on $S=2870$ states.
\end{abstract}
...
and every first appearance it contains. There are $S=2870$ reachable states.
