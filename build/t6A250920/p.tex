...
\title{The empirical recurrence for OEIS A250920, proved by transfer matrix}
...
\begin{abstract}
OEIS A250920 counts $(n+1)\times2$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A250920 is ``Number of (n+1) X (1+1) 0..2 arrays with no 2 X 2 subblock having its minimum diagonal element less than its minimum antidiagonal element.''. It has offset $1$ and begins
\[
58, 344, 2007, 11693, 68160, 397432, 2317569, 13514765,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 9*a(n-1) - 23*a(n-2) + 29*a(n-3) - 16*a(n-4) + 4*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 23 2018 21:18:01, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250920.
