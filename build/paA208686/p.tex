...
\title{The empirical recurrence for OEIS A208686, proved by transfer matrix}
...
\begin{abstract}
OEIS A208686 counts arrays over $\{0,\dots,1\}$ of width $6$ that avoid the patterns
...
OEIS A208686 is ``Number of nX6 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 1 1 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
26, 676, 2430, 11727, 66094, 301035, 1332721,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:58:01, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208686.
