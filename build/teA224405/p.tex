...
\title{The empirical recurrence for OEIS A224405, proved by transfer matrix}
...
\begin{abstract}
OEIS A224405 counts arrays over $\{0,\dots,1\}$ whose rows, columns, diagonals or
...
is a walk count on $S=11$ vertices and the recurrence follows from a finite exact
computation.
\end{abstract}
...
OEIS A224405 is ``Number of n X 4 0..1 arrays with rows unimodal and antidiagonals nondecreasing.''. It has offset $1$ and begins
\[
11, 56, 228, 884, 3436, 13440, 52700, 206708,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 5*a(n-1) - 5*a(n-2) + 2*a(n-3) + 4*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 30 2018 06:07:41, revision 8) the statement is
...
bit vector), $|\mathcal V|=S=11$; let $(r,f)\to(s,f')$ be an edge when placing $s$ after $r$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224405.
