...
\title{The empirical recurrence for OEIS A233172, proved by transfer matrix}
...
\begin{abstract}
OEIS A233172 counts arrays over $\{0,\dots,5\}$ in which no two entries that are neighbours in
...
carried by one bounded piece of extra state, so the count is a walk count on $S=10170$ states.
\end{abstract}
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 21 2025 11:02:42, revision 9) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The array is $6$ cells across with entries $x(i,j)\in\{0,1,\dots,5\}$. Call two values $u,v$ CLASHING
...
and every first appearance it contains. There are $S=10170$ reachable states.
...
\begin{theorem}
\[
a(n)\;=\;1216\,a(n-1) - 303104\,a(n-2) - 6553600\,a(n-3) + 6056574976\,a(n-4) - 287762808832\,a(n-5) - 18622978195456\,a(n-6) + 1482141674242048\,a(n-7) - 15199648742375424\,a(n-8) - 522417556774977536\,a(n-9) + 5764607523034234880\,a(n-10)
\]
for every $n>10$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A233172.
