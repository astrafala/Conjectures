...
\title{The empirical recurrence for OEIS A208023, proved by transfer matrix}
...
\begin{abstract}
OEIS A208023 counts arrays over $\{0,\dots,1\}$ of width $3$ that avoid the patterns
...
OEIS A208023 is ``Number of n X 3 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 0 0 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
6, 36, 102, 279, 741, 1995, 5404,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) + a(n-2) + 8*a(n-3) + 4*a(n-4) + 3*a(n-5) - 5*a(n-6) - a(n-7) + a(n-9) for n>10.
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 06 2018 15:48:22, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + a(n-2) + 8\,a(n-3) + 4\,a(n-4) + 3\,a(n-5) - 5\,a(n-6) - a(n-7) + a(n-9)
\end{equation}
for all $n>8$. 
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208023.
