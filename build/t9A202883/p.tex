...
\title{The empirical recurrence for OEIS A202883, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A202883 counts arrays over $\{0,\dots,2\}$ in which every cell is constrained by the
...
OEIS A202883 is ``Number of n X 2 0..2 arrays with every nonzero element less than or equal to some horizontal or vertical neighbor.''. It has offset $1$ and begins
\[
3, 35, 265, 1849, 13345, 96941, 701275, 5071167,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 6*a(n-1) +2*a(n-2) +46*a(n-3) +25*a(n-4) +36*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2018 10:35:06, revision 11) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) + 2\,a(n-2) + 46\,a(n-3) + 25\,a(n-4) + 36\,a(n-5)
\end{equation}
for all $n>6$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A202883.
