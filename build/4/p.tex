...
closed form. Here it equals $768000 x^{4}$, a polynomial of degree $4$, which proves
...
\begin{quote}\small
\textbf{Conjecture:} 41*n*(n-1)*(n-2)*(n-3)*a(n) -3*(1367*n-4100)*(n-1)*(n-2)*(n-3)*a(n-1) +50*(n-2)*(n-3)*(3077*n\^{}2-21533*n+38136)*a(n-2) -250*(n-3)*(10265*n\^{}3-123135*n\^{}2+494446*n-664572)*a(n-3) +1875*(8575*n\^{}4-154250*n\^{}3+1039765*n\^{}2-3112730*n+3491808)*a(n-4) -625*(5*n-22)*(5*n-21)*(5*n-24)*(5*n-23)*a(n-5)=0. - \emph{R. J. Mathar}, Jul 28 2014
\end{quote}
