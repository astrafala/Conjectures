...
\title{The empirical recurrence for OEIS A298089, proved by transfer matrix}
...
\begin{abstract}
OEIS A298089 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A298089 is ``Number of nX4 0..1 arrays with every element equal to 1, 2, 4 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
2, 13, 19, 30, 53, 92, 149, 250,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 12 2018 09:30:11, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + a(n-2) - a(n-3) - 2\,a(n-4) + 2\,a(n-5) + 4\,a(n-6) - 28\,a(n-7) - 3\,a(n-8) + 26\,a(n-9) + 22\,a(n-10) + 6\,a(n-11) + 7\,a(n-12) + 53\,a(n-13) - 42\,a(n-14) - 84\,a(n-15) - 64\,a(n-16) - 24\,a(n-17) - 3\,a(n-18) + 40\,a(n-19) + 101\,a(n-20) + 36\,a(n-21) + 51\,a(n-22) + 23\,a(n-23) + 75\,a(n-24) - 85\,a(n-25) - 129\,a(n-26) + 23\,a(n-27) + 6\,a(n-28) - 58\,a(n-29) - 108\,a(n-30) + 41\,a(n-31) + 87\,a(n-32) + 38\,a(n-33) - 2\,a(n-34) - 10\,a(n-35)
\end{equation}
for all $n>39$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A298089.
