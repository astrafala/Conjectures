...
\title{The empirical recurrence for OEIS A220685, proved by transfer matrix}
...
\begin{abstract}
OEIS A220685 counts the ways of linking the cells of a grid $5$ cells wide, each cell either to
...
state, the count is a walk count on $S=256$ of them, and the conjectured recurrence is then
...
OEIS A220685 is ``Number of ways to reciprocally link elements of an nX5 array either to themselves or to exactly two horizontal, vertical or antidiagonal neighbors.''. It has offset $1$ and begins
\[
1, 114, 5851, 312603, 15978924, 822649205, 42362190063, 2181341369109,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 18:58:32, revision 8) this is still
...
one configuration. With $M$ the adjacency matrix of the digraph on the $S=256$ reachable
...
\begin{theorem}
\[
a(n)\;=\;35\,a(n-1) + 673\,a(n-2) + 8237\,a(n-3) + 46927\,a(n-4) - 112480\,a(n-5) - 3992526\,a(n-6) - 35333024\,a(n-7) - 169366609\,a(n-8) - 361164394\,a(n-9) + 47195630\,a(n-10) + 13502054\,a(n-11) + 495005695\,a(n-12) + 6209070799\,a(n-13) + 5791334536\,a(n-14) - 11945755468\,a(n-15) - 10812604841\,a(n-16) + 3004142790\,a(n-17) - 8986269878\,a(n-18) + 26749603735\,a(n-19) - 17268218707\,a(n-20) + 10625240169\,a(n-21) + 1286966410\,a(n-22) - 5196232889\,a(n-23) - 236330168\,a(n-24) + 3747662678\,a(n-25) - 4565014033\,a(n-26) + 2769440835\,a(n-27) - 1086425818\,a(n-28) + 220144889\,a(n-29) - 12788683\,a(n-30) - 5653764\,a(n-31) + 2046130\,a(n-32) - 331034\,a(n-33) + 12027\,a(n-34) + 3632\,a(n-35) + 36\,a(n-36)
\]
for every $n>37$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A220685.
