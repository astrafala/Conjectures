...
\title{The empirical recurrence for OEIS A233639, proved by transfer matrix}
...
\begin{abstract}
OEIS A233639 counts $(n+1)\times4$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A233639 is ``Number of (n+1)X(3+1) 0..2 arrays with every 2X2 subblock having the sum of the squares of the edge differences equal to 2.''. It has offset $1$ and begins
\[
324, 3004, 26192, 238570, 2118568, 19123682, 170872144, 1536664586,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 08:54:25, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 76\,a(n-2) - 5\,a(n-3) - 1165\,a(n-4) + 564\,a(n-5) + 5703\,a(n-6) - 4723\,a(n-7) - 9217\,a(n-8) + 10950\,a(n-9) + 1714\,a(n-10) - 5684\,a(n-11) + 1880\,a(n-12) - 96\,a(n-13)
\end{equation}
for all $n>13$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A233639.
