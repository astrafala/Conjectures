...
\title{The empirical recurrence for OEIS A209547, proved by transfer matrix}
...
\begin{abstract}
OEIS A209547 counts $(n+1)\times3$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A209547 is ``1/4 the number of (n+1) X 3 0..3 arrays with every 2 X 2 subblock having exactly two distinct clockwise edge differences.''. It has offset $1$ and begins
\[
20, 105, 562, 3051, 16582, 90186, 490547, 2668340,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 8*a(n-1) -14*a(n-2) -3*a(n-3) +20*a(n-4) -8*a(n-5) -2*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 13 2026 09:39:38, revision 16) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;8\,a(n-1) - 14\,a(n-2) - 3\,a(n-3) + 20\,a(n-4) - 8\,a(n-5) - 2\,a(n-6)
\end{equation}
for all $n>6$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209547.
