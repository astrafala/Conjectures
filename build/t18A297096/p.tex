...
\title{The empirical recurrence for OEIS A297096, proved by transfer matrix}
...
\begin{abstract}
OEIS A297096 counts $n\times2$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A297096 is ``Number of n X 2 0..1 arrays with no 1 adjacent to 4 king-move neighboring 1s.''. It has offset $1$ and begins
\[
4, 16, 58, 216, 808, 3016, 11264, 42080,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) - 2*a(n-2) + 6*a(n-3) - 8*a(n-4) - 4*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 26 2019 08:20:57, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297096.
