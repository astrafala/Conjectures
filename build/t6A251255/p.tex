...
\title{The empirical recurrence for OEIS A251255, proved by transfer matrix}
...
\begin{abstract}
OEIS A251255 counts $(n+1)\times6$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A251255 is ``Number of (n+1)X(5+1) 0..1 arrays with every 2X2 subblock having a single 1 or two 1s on the same edge.''. It has offset $1$ and begins
\[
180, 1232, 5680, 38332, 185620, 1215600, 6080510, 38748690,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:13:02, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 58\,a(n-2) - 36\,a(n-3) - 1155\,a(n-4) + 410\,a(n-5) + 10503\,a(n-6) - 1721\,a(n-7) - 47392\,a(n-8) + 1567\,a(n-9) + 107095\,a(n-10) + 5793\,a(n-11) - 116154\,a(n-12) - 14099\,a(n-13) + 54760\,a(n-14) + 9080\,a(n-15) - 8738\,a(n-16) - 1844\,a(n-17)
\end{equation}
for all $n>17$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251255.
