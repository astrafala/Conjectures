...
\title{The empirical recurrence for OEIS A218081, proved by transfer matrix}
...
\begin{abstract}
OEIS A218081 counts the distinct arrays obtained by applying a fixed local operation to every cell
of an array over a bounded alphabet, and carries an empirical recurrence of order $23$
...
$S=155$ states, after which the conjectured recurrence is settled by a finite exact
computation.
\end{abstract}
...
OEIS A218081 is ``Number of nX5 arrays of the minimum value of corresponding elements and their horizontal, vertical or antidiagonal neighbors in a random 0..1 nX5 array.''. It has offset $1$ and begins
\[
10, 38, 246, 1508, 9570, 60258, 380952, 2406376,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 17:33:58, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

Let $R=\{0,\dots,1\}^{5}$ be the set of rows and let the neighbours of
...
\]
There are $S=155$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite.
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) + 19\,a(n-2) - 37\,a(n-3) - 231\,a(n-4) + 48\,a(n-5) + 1233\,a(n-6) + 765\,a(n-7) - 3665\,a(n-8) - 3352\,a(n-9) + 5681\,a(n-10) + 6688\,a(n-11) - 7953\,a(n-12) - 1406\,a(n-13) + 2852\,a(n-14) + 584\,a(n-15) - 3967\,a(n-16) + 3715\,a(n-17) - 278\,a(n-18) - 660\,a(n-19) - 621\,a(n-20) + 458\,a(n-21) + 99\,a(n-22) - 4\,a(n-23)
\]
for every $n>25$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A218081.
