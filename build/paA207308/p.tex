...
\title{The empirical recurrence for OEIS A207308, proved by transfer matrix}
...
\begin{abstract}
OEIS A207308 counts arrays over $\{0,\dots,1\}$ of width $5$ that avoid the patterns
...
OEIS A207308 is ``Number of 5Xn 0..1 arrays avoiding 0 0 0 and 1 0 1 horizontally and 0 0 1 and 1 1 0 vertically.''. It has offset
$1$ and begins
\[
10, 100, 350, 1271, 3773, 11497, 36868,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 13:45:51, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 2\,a(n-2) + 11\,a(n-3) + 13\,a(n-4) + 3\,a(n-5) - 12\,a(n-6) - 27\,a(n-7) - 13\,a(n-8) - 3\,a(n-9) + 15\,a(n-10) + 8\,a(n-11) + 4\,a(n-12) - 5\,a(n-13) - a(n-14) - a(n-15) + 2\,a(n-16) - a(n-17)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207308.
