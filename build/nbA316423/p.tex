...
\title{The empirical recurrence for OEIS A316423, proved by transfer matrix}
...
\begin{abstract}
OEIS A316423 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $different from$ itself lying in $\{0,1,3,5,6,8\}$, and it carries an empirical
...
OEIS A316423 is ``Number of nX4 0..1 arrays with every element unequal to 0, 1, 3, 5, 6 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
5, 21, 32, 97, 279, 640, 1660, 4353,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 02 2018 09:11:41, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 16\,a(n-3) - 24\,a(n-4) - 4\,a(n-5) - 97\,a(n-6) + 111\,a(n-7) + 33\,a(n-8) + 301\,a(n-9) - 280\,a(n-10) - 102\,a(n-11) - 610\,a(n-12) + 462\,a(n-13) + 137\,a(n-14) + 1003\,a(n-15) - 460\,a(n-16) - 49\,a(n-17) - 1229\,a(n-18) + 318\,a(n-19) - 40\,a(n-20) + 1076\,a(n-21) - 170\,a(n-22) + 59\,a(n-23) - 756\,a(n-24) - 85\,a(n-25) - 26\,a(n-26) + 258\,a(n-27) - 2\,a(n-28) - 278\,a(n-29) - 208\,a(n-30) - 158\,a(n-31) + 113\,a(n-32) - 92\,a(n-33) + 85\,a(n-34) + 71\,a(n-35) + 166\,a(n-36) + 46\,a(n-37) - 49\,a(n-38) - 63\,a(n-39) - 10\,a(n-40) + 6\,a(n-41) + 6\,a(n-42)
\end{equation}
for all $n>42$.
...
has score in $\{0,1,3,5,6,8\}$. The entry also fixes the top-left entry to be $0$; that is a condition on the first row alone, so it restricts the start vector and nothing else.
...
\begin{itemize}
\item $\mathbf{s}(r,s)=1$ when every cell of $r$ has score in $\{0,1,3,5,6,8\}$ \emph{with no row
above $r$} and $r_1=0$, and $0$ otherwise;
\item an edge $(r,s)\to(s,t)$ when every cell of $s$ has score in $\{0,1,3,5,6,8\}$ computed from
$r$, $s$ and $t$;
\item $\mathbf{e}(r,s)=1$ when every cell of $s$ has score in $\{0,1,3,5,6,8\}$ \emph{with no row
...
exactly when every one of its $n$ rows has all scores in $\{0,1,3,5,6,8\}$. Read the sequence as the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A316423.
