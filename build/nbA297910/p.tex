...
\title{The empirical recurrence for OEIS A297910, proved by transfer matrix}
...
\begin{abstract}
OEIS A297910 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A297910 is ``Number of nX3 0..1 arrays with every element equal to 0, 2, 3 or 4 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 12, 10, 49, 144, 481, 2016, 7730,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 08 2018 07:39:02, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) + a(n-2) - 17\,a(n-4) - 2\,a(n-6) + 3\,a(n-7) + 53\,a(n-8) - 11\,a(n-9) - 60\,a(n-10) + 14\,a(n-11) + 20\,a(n-12) - 4\,a(n-13)
\end{equation}
for all $n>14$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297910.
