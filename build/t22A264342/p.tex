...
\title{The empirical recurrence for OEIS A264342, proved by transfer matrix}
...
\begin{abstract}
OEIS A264342 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=3$ columns in which
...
OEIS A264342 is ``Number of (2+1)X(n+1) arrays of permutations of 0..n*3+2 with each element having index change +-(.,.) 0,0 0,1 or 1,2.''. It has offset $1$ and begins
\[
8, 55, 490, 3567, 28925, 223356, 1759250, 13750304,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 11 2015 19:44:17, revision 4) this is still
...
\[
(i-h_i,\,j-h_j)\;\in\;\{(-2,-1),\ (-1,0),\ (0,0),\ (1,0),\ (2,1)\},
\]
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) + 26\,a(n-2) - 72\,a(n-3) - 195\,a(n-4) + 284\,a(n-5) + 555\,a(n-6) - 424\,a(n-7) - 555\,a(n-8) + 284\,a(n-9) + 195\,a(n-10) - 72\,a(n-11) - 26\,a(n-12) + 6\,a(n-13) + a(n-14)
\]
for every $n>13$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264342.
