...
\title{The empirical recurrence for OEIS A316540, proved by transfer matrix}
...
\begin{abstract}
OEIS A316540 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A316540 is ``Number of nX3 0..1 arrays with every element unequal to 0, 1, 2, 4, 7 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
4, 12, 26, 53, 187, 484, 1262, 3570,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +3*a(n-2) +8*a(n-3) -a(n-4) -12*a(n-5) -26*a(n-6) -2*a(n-7) +10*a(n-8) +15*a(n-9) -a(n-10) +6*a(n-11) for n>12
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 06 2018 12:23:50, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 3\,a(n-2) + 8\,a(n-3) - a(n-4) - 12\,a(n-5) - 26\,a(n-6) - 2\,a(n-7) + 10\,a(n-8) + 15\,a(n-9) - a(n-10) + 6\,a(n-11)
\end{equation}
for all $n>11$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A316540.
