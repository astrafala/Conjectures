...
\title{The empirical recurrence for OEIS A302513, proved by transfer matrix}
...
\begin{abstract}
OEIS A302513 counts $6$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A302513 is ``Number of nX6 0..1 arrays with every element equal to 0, 1, 4 or 5 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
13, 13, 52, 80, 199, 458, 1088, 2651,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +6*a(n-3) +5*a(n-4) +3*a(n-5) -8*a(n-6) -6*a(n-7) -3*a(n-8) for n>12
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 09 2018 09:07:25, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 6\,a(n-3) + 5\,a(n-4) + 3\,a(n-5) - 8\,a(n-6) - 6\,a(n-7) - 3\,a(n-8)
\end{equation}
for all $n>11$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302513.
