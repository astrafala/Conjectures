...
\title{The empirical recurrence for OEIS A220173, proved by transfer matrix}
...
\begin{abstract}
OEIS A220173 counts the distinct indicator arrays obtained from the $n\times2$ arrays over
...
indicator row by row turns it into one, on $S=138$ states, after which the conjectured
...
OEIS A220173 is ``Sum of neighbor maps: number of nX2 binary arrays indicating the locations of corresponding elements equal to the sum mod 3 of their horizontal, vertical and antidiagonal neighbors in a random 0..2 nX2 array.''. It has offset $1$ and begins
\[
2, 16, 48, 256, 856, 4096, 15872, 65536,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 18:32:45, revision 8) this is still
...
\]
There are $S=138$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite. Note
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A220173.
