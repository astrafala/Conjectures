...
\title{The empirical recurrence for OEIS A282645, proved by transfer matrix}
...
\begin{abstract}
OEIS A282645 counts $n\times6$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A282645 is ``Number of nX6 0..1 arrays with no 1 equal to more than one of its king-move neighbors.''. It has offset $1$ and begins
\[
44, 537, 6349, 92817, 1190848, 15985259, 213392087, 2835418176,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 20 2017 07:31:11, revision 4) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A282645.
