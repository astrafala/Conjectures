...
\title{The empirical recurrence for OEIS A228792, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A228792 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A228792 is ``Number of n X 4 binary arrays with top left element equal to 1 and no two ones adjacent horizontally or nw-se.''. It has offset $1$ and begins
\[
3, 16, 97, 586, 3588, 22060, 135768, 835776,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 8*a(n-1) - 12*a(n-2) + 4*a(n-3) for n>4.
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 13 2018 06:07:48, revision 12) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A228792.
