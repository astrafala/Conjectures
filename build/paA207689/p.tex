...
\title{The empirical recurrence for OEIS A207689, proved by transfer matrix}
...
\begin{abstract}
OEIS A207689 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
...
OEIS A207689 is ``Number of n X 4 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 0 1 and 1 1 1 vertically.''. It has offset
$1$ and begins
\[
9, 81, 100, 256, 576, 1156, 2500,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) + a(n-2) + 3*a(n-3) + a(n-4) - a(n-5) - a(n-6) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 25 2018 07:53:21, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207689.
