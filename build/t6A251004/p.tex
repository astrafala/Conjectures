...
\title{The empirical recurrence for OEIS A251004, proved by transfer matrix}
...
\begin{abstract}
OEIS A251004 counts $(n+1)\times3$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A251004 is ``Number of (n+1)X(2+1) 0..2 arrays with no 2X2 subblock having its maximum diagonal element less than the absolute difference of its antidiagonal elements.''. It has offset $1$ and begins
\[
530, 10743, 218298, 4434257, 90065275, 1829373498, 37157718881, 754736624943,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 12:58:24, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;27\,a(n-1) - 169\,a(n-2) + 800\,a(n-3) - 2847\,a(n-4) + 5874\,a(n-5) - 6458\,a(n-6) + 2876\,a(n-7) + 558\,a(n-8) - 1473\,a(n-9) + 1896\,a(n-10) - 1394\,a(n-11) + 460\,a(n-12) - 68\,a(n-13)
\end{equation}
for all $n>12$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251004.
