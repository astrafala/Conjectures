...
\title{The empirical recurrence for OEIS A263817, proved by transfer matrix}
...
\begin{abstract}
OEIS A263817 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=2$ columns in which
...
OEIS A263817 is ``Number of (1+1)X(n+1) arrays of permutations of 0..n*2+1 with each element having index change (+-,+-) 0,0 0,1 0,2 or 1,0.''. It has offset $1$ and begins
\[
9, 82, 572, 3682, 25001, 170946, 1157993, 7844192,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 12:15:01, revision 8) this is still
...
\[
(i-h_i,\,j-h_j)\;\in\;\{(-2,0),\ (-1,0),\ (0,-1),\ (0,0),\ (0,1),\ (1,0),\ (2,0)\},
\]
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-1) - 7\,a(n-2) + 6\,a(n-3) - 62\,a(n-4) - 316\,a(n-5) + 338\,a(n-6) + 756\,a(n-7) + 310\,a(n-8) + 856\,a(n-9) - 2386\,a(n-10) - 3818\,a(n-11) + 1730\,a(n-12) + 1676\,a(n-13) + 990\,a(n-14) + 2322\,a(n-15) - 1106\,a(n-16) - 924\,a(n-17) - 42\,a(n-18) - 452\,a(n-19) + 210\,a(n-20) + 112\,a(n-21) - 30\,a(n-22) + 34\,a(n-23) - 9\,a(n-24) - 4\,a(n-25) + a(n-26)
\]
for every $n>24$.
\end{theorem}
...
transposed companion A263966. Second, the transfer model reproduces all $19$ terms this
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A263817.
