...
\title{The empirical recurrence for OEIS A255020, proved by transfer matrix}
...
\begin{abstract}
OEIS A255020 counts $(n+2)\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
no $3\times3$ subblock, and it carries an empirical recurrence of order $6$
...
OEIS A255020 is ``Number of (n+2) X (1+2) 0..1 arrays with no 3 x 3 subblock diagonal sum 0 or 1 and no antidiagonal sum 0 or 1 and no row sum 0 or 1 and no column sum 0 or 1.''. It has offset $1$ and begins
\[
26, 54, 117, 269, 601, 1306, 2853, 6308,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + 3*a(n-3) + 4*a(n-4) + 4*a(n-5) + 2*a(n-6) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 18 2018 09:25:51, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 3\,a(n-3) + 4\,a(n-4) + 4\,a(n-5) + 2\,a(n-6)
\]
for every $n>7$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A255020.
