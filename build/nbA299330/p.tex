...
\title{The empirical recurrence for OEIS A299330, proved by transfer matrix}
...
\begin{abstract}
OEIS A299330 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $equal to$ itself lying in $\{2,3,4,5,6,7\}$, and it carries an empirical
...
OEIS A299330 is ``Number of nX4 0..1 arrays with every element equal to 2, 3, 4, 5, 6 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
0, 6, 36, 263, 2537, 22718, 214683, 2024559,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 07 2018 04:48:11, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;7\,a(n-1) + 42\,a(n-2) - 97\,a(n-3) - 760\,a(n-4) - 293\,a(n-5) + 4331\,a(n-6) + 7298\,a(n-7) - 1378\,a(n-8) - 15896\,a(n-9) - 25556\,a(n-10) - 16583\,a(n-11) + 646\,a(n-12) + 14623\,a(n-13) + 22835\,a(n-14) + 24608\,a(n-15) + 8564\,a(n-16) - 17982\,a(n-17) + 3869\,a(n-18) - 524\,a(n-19) - 11907\,a(n-20) - 6997\,a(n-21) + 8341\,a(n-22) + 3006\,a(n-23) - 7404\,a(n-24) + 2016\,a(n-25) + 1712\,a(n-26) - 680\,a(n-27)
\end{equation}
for all $n>27$.
...
has score in $\{2,3,4,5,6,7\}$. The entry also fixes the top-left entry to be $0$; that is a condition on the first row alone, so it restricts the start vector and nothing else.
...
\begin{itemize}
\item $\mathbf{s}(r,s)=1$ when every cell of $r$ has score in $\{2,3,4,5,6,7\}$ \emph{with no row
above $r$} and $r_1=0$, and $0$ otherwise;
\item an edge $(r,s)\to(s,t)$ when every cell of $s$ has score in $\{2,3,4,5,6,7\}$ computed from
$r$, $s$ and $t$;
\item $\mathbf{e}(r,s)=1$ when every cell of $s$ has score in $\{2,3,4,5,6,7\}$ \emph{with no row
...
exactly when every one of its $n$ rows has all scores in $\{2,3,4,5,6,7\}$. Read the sequence as the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A299330.
