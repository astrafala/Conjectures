...
\title{The empirical recurrence for OEIS A263966, proved by transfer matrix}
...
\begin{abstract}
OEIS A263966 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=3$ columns in which
...
OEIS A263966 is ``Number of (2+1)X(n+1) arrays of permutations of 0..n*3+2 with each element having index change (+-,+-) 0,0 1,1 or 1,2.''. It has offset $1$ and begins
\[
9, 141, 2089, 23841, 283641, 3408145, 40723017, 484847873,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 10 2015 10:26:22, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;13\,a(n-1) + 6\,a(n-2) - 262\,a(n-3) + 488\,a(n-4) - 652\,a(n-5) - 7720\,a(n-6) + 52376\,a(n-7) + 108848\,a(n-8) + 259552\,a(n-9) - 852288\,a(n-10) - 6712576\,a(n-11) + 8309504\,a(n-12) + 21286400\,a(n-13) - 24625664\,a(n-14) - 121656320\,a(n-15) - 32204800\,a(n-16) + 612724736\,a(n-17) - 186105856\,a(n-18) - 728727552\,a(n-19) + 2890399744\,a(n-20) - 617873408\,a(n-21) - 6594756608\,a(n-22) + 4604821504\,a(n-23) + 3544186880\,a(n-24) - 9990832128\,a(n-25) - 8069840896\,a(n-26) + 6744440832\,a(n-27) + 4026531840\,a(n-28)
\]
for every $n>30$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A263966.
