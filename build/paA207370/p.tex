...
\title{The empirical recurrence for OEIS A207370, proved by transfer matrix}
...
\begin{abstract}
OEIS A207370 counts arrays over $\{0,\dots,1\}$ of width $5$ that avoid the patterns
...
OEIS A207370 is ``Number of 5Xn 0..1 arrays avoiding 0 0 0 and 0 1 1 horizontally and 0 0 1 and 0 1 1 vertically.''. It has offset
$1$ and begins
\[
12, 144, 420, 1736, 5856, 15525, 45738,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 13:49:58, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207370.
