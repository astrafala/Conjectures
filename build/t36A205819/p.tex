...
\title{The empirical recurrence for OEIS A205819, proved by transfer matrix}
...
\begin{abstract}
OEIS A205819 counts arrays over $\{0,\dots,2\}$ under a condition on the number of clockwise edge increases
...
OEIS A205819 is ``Number of (n+1) X 5 0..2 arrays with the number of clockwise edge increases in every 2 X 2 subblock unequal to the number of counterclockwise edge increases.''. It has offset $1$ and begins
\[
492, 2430, 12318, 67944, 380568, 2158482, 12281976, 70022628,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 10 2015 02:12:03, revision 7) this is still
...
subblocks; the entry's first term is $492$, which the model
...
\begin{theorem}
\[
a(n)\;=\;10\,a(n-1) - 18\,a(n-2) - 83\,a(n-3) + 264\,a(n-4) + 171\,a(n-5) - 1140\,a(n-6) + 234\,a(n-7) + 2180\,a(n-8) - 1280\,a(n-9) - 1912\,a(n-10) + 1667\,a(n-11) + 624\,a(n-12) - 873\,a(n-13) + 32\,a(n-14) + 162\,a(n-15) - 31\,a(n-16) - 8\,a(n-17) + 2\,a(n-18)
\]
for every $n>18$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A205819.
