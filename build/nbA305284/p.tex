...
\title{The empirical recurrence for OEIS A305284, proved by transfer matrix}
...
\begin{abstract}
OEIS A305284 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $different from$ itself lying in $\{1,2,3,4,8\}$, and it carries an empirical
...
OEIS A305284 is ``Number of nX4 0..1 arrays with every element unequal to 1, 2, 3, 4 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
2, 86, 279, 1763, 8431, 46983, 246893, 1332201,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 29 2018 08:21:33, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 22\,a(n-2) - 110\,a(n-4) - 30\,a(n-5) + 52\,a(n-6) - 79\,a(n-7) + 285\,a(n-8) + 352\,a(n-9) - 105\,a(n-10) + 287\,a(n-11) + 119\,a(n-12) + 247\,a(n-13) - 551\,a(n-14) - 2706\,a(n-15) + 416\,a(n-16) - 844\,a(n-17) + 717\,a(n-18) + 2294\,a(n-19) - 614\,a(n-20) + 2654\,a(n-21) - 1250\,a(n-22) - 1601\,a(n-23) + 370\,a(n-24) - 1752\,a(n-25) + 1971\,a(n-26) - 572\,a(n-27) + 251\,a(n-28) + 191\,a(n-29) - 489\,a(n-30) + 410\,a(n-31) - 282\,a(n-32) + 191\,a(n-33) - 72\,a(n-34) + 23\,a(n-35) - 6\,a(n-36)
\end{equation}
for all $n>40$.
...
has score in $\{1,2,3,4,8\}$. The entry also fixes the top-left entry to be $0$; that is a condition on the first row alone, so it restricts the start vector and nothing else.
...
\begin{itemize}
\item $\mathbf{s}(r,s)=1$ when every cell of $r$ has score in $\{1,2,3,4,8\}$ \emph{with no row
above $r$} and $r_1=0$, and $0$ otherwise;
\item an edge $(r,s)\to(s,t)$ when every cell of $s$ has score in $\{1,2,3,4,8\}$ computed from
$r$, $s$ and $t$;
\item $\mathbf{e}(r,s)=1$ when every cell of $s$ has score in $\{1,2,3,4,8\}$ \emph{with no row
...
exactly when every one of its $n$ rows has all scores in $\{1,2,3,4,8\}$. Read the sequence as the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A305284.
