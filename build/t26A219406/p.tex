...
\title{The empirical recurrence for OEIS A219406, proved by transfer matrix}
...
\begin{abstract}
OEIS A219406 counts the distinct indicator arrays obtained from the $n\times4$ arrays over
...
OEIS A219406 is ``Unmatched value maps: number of n X 4 binary arrays indicating the locations of corresponding elements not equal to any horizontal or antidiagonal neighbor in a random 0..2 n X 4 array.''. It has offset $1$ and begins
\[
7, 98, 1199, 14737, 181089, 2225293, 27345143, 336026564,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 7*a(n-1) + 57*a(n-2) + 96*a(n-3) + 27*a(n-4) - 11*a(n-5) - 4*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 26 2018 05:16:52, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A219406.
