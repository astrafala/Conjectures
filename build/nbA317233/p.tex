...
\title{The empirical recurrence for OEIS A317233, proved by transfer matrix}
...
\begin{abstract}
OEIS A317233 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A317233 is ``Number of nX3 0..1 arrays with every element unequal to 0, 1, 2, 4, 6, 7 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
4, 12, 28, 60, 211, 597, 1619, 4792,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 24 2018 10:36:52, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 3\,a(n-2) + 11\,a(n-3) + a(n-4) - 18\,a(n-5) - 48\,a(n-6) - 31\,a(n-7) + 19\,a(n-8) + 50\,a(n-9) + 34\,a(n-10) + 2\,a(n-11) - 4\,a(n-12) - 3\,a(n-13)
\end{equation}
for all $n>13$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A317233.
