...
\title{The empirical recurrence for OEIS A299834, proved by transfer matrix}
...
\begin{abstract}
OEIS A299834 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A299834 is ``Number of n X 3 0..1 arrays with every element equal to 1, 2, 3, 4, 5, 6 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 18, 142, 1000, 7388, 54611, 402928, 2973312,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 7*a(n-1) +2*a(n-2) +7*a(n-3) -6*a(n-4) -15*a(n-5) +a(n-6) +2*a(n-7) -5*a(n-8) -2*a(n-9) for n>10.
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 17 2023 01:45:56, revision
6) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;7\,a(n-1) + 2\,a(n-2) + 7\,a(n-3) - 6\,a(n-4) - 15\,a(n-5) + a(n-6) + 2\,a(n-7) - 5\,a(n-8) - 2\,a(n-9)
\end{equation}
for all $n>9$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A299834.
