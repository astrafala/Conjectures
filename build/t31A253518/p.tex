...
\title{The empirical recurrence for OEIS A253518, proved by transfer matrix}
...
\begin{abstract}
OEIS A253518 counts the arrays over $\{0,\dots,2\}$ whose $2\times2$ subblocks carry a
...
so a pair of consecutive array rows is a state, the count is a walk count on $S=470$ of them,
...
OEIS A253518 is ``Number of (n+1)X(2+1) 0..2 arrays with every 2X2 subblock diagonal minimum minus antidiagonal minimum nondecreasing horizontally and diagonal maximum minus antidiagonal maximum nondecreasing vertically.''. It has offset $1$ and begins
\[
470, 2724, 10706, 42476, 169828, 666239, 2544290, 9487609,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 14:05:08, revision 6) this is still
...
\]
on the $S=470$ admissible pairs. In particular $a$ is $C$-finite. The alignment of the walk
...
\begin{theorem}
\[
a(n)\;=\;14\,a(n-1) - 81\,a(n-2) + 248\,a(n-3) - 419\,a(n-4) + 338\,a(n-5) + 17\,a(n-6) - 264\,a(n-7) + 196\,a(n-8) - 48\,a(n-9)
\]
for every $n>17$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253518.
