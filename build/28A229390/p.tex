...
\title{The empirical recurrence for OEIS A229390, proved by transfer matrix}
...
\begin{abstract}
OEIS A229390 counts the distinct arrays obtained by applying a fixed local operation to every cell
...
$S=2390$ states, after which the conjectured recurrence is settled by a finite exact
computation.
\end{abstract}
...
OEIS A229390 is ``Number of nX6 0..3 arrays of the sum of the corresponding element, the element to the east and the element to the south in a larger (n+1)X7 0..1 array.''. It has offset $1$ and begins
\[
1912, 546752, 84210828, 11156280332, 1451228983308, 187243393024012, 24062262212427788, 3086056460257853452,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 193*a(n-1) -8384*a(n-2) +8320*a(n-3) -24704*a(n-4) +1073152*a(n-5) -1048576*a(n-6) for n>9
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 04 2025 00:11:15, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

Let $R$ be the set of rows of length $7$ over $\{0,\dots,1\}$.
...
\]
There are $S=2390$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite.
...
\begin{theorem}
\[
a(n)\;=\;193\,a(n-1) - 8384\,a(n-2) + 8320\,a(n-3) - 24704\,a(n-4) + 1073152\,a(n-5) - 1048576\,a(n-6)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A229390.
