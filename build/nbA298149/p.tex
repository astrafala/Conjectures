...
\title{The empirical recurrence for OEIS A298149, proved by transfer matrix}
...
\begin{abstract}
OEIS A298149 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $equal to$ itself lying in $\{0,1,3,4,5,8\}$, and it carries an empirical
...
OEIS A298149 is ``Number of nX3 0..1 arrays with every element equal to 0, 1, 3, 4, 5 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
3, 4, 6, 18, 15, 104, 227, 510,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 13 2018 11:35:57, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 3\,a(n-2) + 10\,a(n-3) - 28\,a(n-4) - 18\,a(n-5) - 8\,a(n-6) + 63\,a(n-7) + 42\,a(n-8) - 52\,a(n-9) + 9\,a(n-10) + 26\,a(n-11) - 23\,a(n-12) - 43\,a(n-13) - 11\,a(n-14) - 20\,a(n-15) + 9\,a(n-16) + 18\,a(n-17) + 2\,a(n-18)
\end{equation}
for all $n>18$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A298149.
