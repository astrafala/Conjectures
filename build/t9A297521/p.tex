...
\title{The empirical recurrence for OEIS A297521, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297521 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A297521 is ``Number of 3Xn 0..1 arrays with every 1 horizontally, diagonally or antidiagonally adjacent to 1 or 3 neighboring 1s.''. It has offset $1$ and begins
\[
1, 11, 49, 128, 363, 1408, 5079, 16104,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +a(n-2) +10*a(n-3) +37*a(n-4) +23*a(n-5) +21*a(n-6) -25*a(n-7) -40*a(n-8) -44*a(n-9) +17*a(n-11) +5*a(n-12)
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 31 2017 09:55:57, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + a(n-2) + 10\,a(n-3) + 37\,a(n-4) + 23\,a(n-5) + 21\,a(n-6) - 25\,a(n-7) - 40\,a(n-8) - 44\,a(n-9) + 17\,a(n-11) + 5\,a(n-12)
\end{equation}
for all $n>13$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297521.
