...
\title{The empirical recurrence for OEIS A205364, proved by transfer matrix}
...
\begin{abstract}
OEIS A205364 counts arrays over $\{0,\dots,3\}$ under a condition on the number of clockwise edge increases
in every $2\times2$ subblock, and carries an empirical recurrence of order $21$ contributed by
R.~H.~Hardin. It is true, and it is decidable rather than empirical. The condition is local to
a bounded window of consecutive rows, so the count is a walk count on $S=132$ states and is
...
OEIS A205364 is ``Number of (n+1)X3 0..3 arrays with the number of clockwise edge increases in every 2X2 subblock the same.''. It has offset $1$ and begins
\[
1976, 31848, 516364, 8539884, 143559116, 2448719840, 42290474776, 737993545372,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 12:03:28, revision 9) this is still
...
\]
on the $S=132$ states that survive. Rows carrying no edge at all are dropped: such a row could
...
\begin{theorem}
\[
a(n)\;=\;39\,a(n-1) - 494\,a(n-2) + 2341\,a(n-3) - 4372\,a(n-4) - 2243\,a(n-5) + 27629\,a(n-6) - 71364\,a(n-7) + 132199\,a(n-8) - 205216\,a(n-9) + 254720\,a(n-10) - 262592\,a(n-11) + 241702\,a(n-12) - 187260\,a(n-13) + 118740\,a(n-14) - 66636\,a(n-15) + 30712\,a(n-16) - 10072\,a(n-17) + 2648\,a(n-18) - 432\,a(n-19) - 80\,a(n-20) + 32\,a(n-21)
\]
for every $n>20$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A205364.
