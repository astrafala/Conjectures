...
\title{The empirical recurrence for OEIS A253431, proved by transfer matrix}
...
\begin{abstract}
OEIS A253431 counts the arrays over $\{0,\dots,1\}$ whose $2\times2$ subblocks carry a
...
OEIS A253431 is ``Number of (n+1) X (4+1) 0..1 arrays with every 2 X 2 subblock diagonal minus antidiagonal sum nondecreasing horizontally, vertically and ne-to-sw antidiagonally.''. It has offset $1$ and begins
\[
109, 102, 120, 156, 228, 372, 660, 1236,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) - 2*a(n-2) for n>3.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 12 2018 09:40:07, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253431.
