...
\title{The empirical recurrence for OEIS A283380, proved by transfer matrix}
...
\begin{abstract}
OEIS A283380 counts $n\times2$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
walk, and $a(n)$ is a walk count on $S=50$ vertices, which is $C$-finite. Whether the
...
OEIS A283380 is ``Number of nX2 0..1 arrays with no 1 equal to more than two of its horizontal, vertical and antidiagonal neighbors, with the exception of exactly two elements.''. It has offset $1$ and begins
\[
0, 1, 3, 19, 91, 399, 1734, 7257,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 06 2017 17:03:05, revision 5) this is still
...
\begin{theorem}
\[
a(n)\;=\;9\,a(n-1) - 24\,a(n-2) + 18\,a(n-3) - 36\,a(n-4) + 111\,a(n-5) - 38\,a(n-6) + 150\,a(n-7) - 162\,a(n-8) + 135\,a(n-9) - 222\,a(n-10) + 177\,a(n-11) - 212\,a(n-12) + 186\,a(n-13) - 168\,a(n-14) + 160\,a(n-15) - 114\,a(n-16) + 99\,a(n-17) - 68\,a(n-18) + 48\,a(n-19) - 30\,a(n-20) + 16\,a(n-21) - 9\,a(n-22) + 3\,a(n-23) - a(n-24)
\]
for every $n>24$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A283380.
