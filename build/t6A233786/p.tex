...
\title{The empirical recurrence for OEIS A233786, proved by transfer matrix}
...
\begin{abstract}
OEIS A233786 counts $(n+1)\times3$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A233786 is ``Number of (n+1)X(2+1) 0..3 arrays with every 2X2 subblock having the sum of the squares of all six edge and diagonal differences equal to 11.''. It has offset $1$ and begins
\[
188, 864, 3932, 19396, 93100, 479628, 2368972, 12497004,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 09:00:01, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) + 34\,a(n-2) - 196\,a(n-3) - 148\,a(n-4) + 1770\,a(n-5) - 1056\,a(n-6) - 4344\,a(n-7) + 5088\,a(n-8) + 864\,a(n-9) - 2880\,a(n-10) + 864\,a(n-11)
\end{equation}
for all $n>11$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A233786.
