...
\title{The empirical recurrence for OEIS A304921, proved by transfer matrix}
...
\begin{abstract}
OEIS A304921 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A304921 is ``Number of nX3 0..1 arrays with every element unequal to 0, 1, 2, 5 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
4, 5, 15, 31, 73, 191, 466, 1125,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +2*a(n-2) +4*a(n-3) +2*a(n-4) -2*a(n-5) -7*a(n-6) -6*a(n-7) for n>9
\end{quote}
As of the ``Last modified'' line on the live entry (May 21 2018 09:12:31, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 2\,a(n-2) + 4\,a(n-3) + 2\,a(n-4) - 2\,a(n-5) - 7\,a(n-6) - 6\,a(n-7)
\end{equation}
for all $n>8$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A304921.
