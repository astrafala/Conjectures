...
\title{The empirical recurrence for OEIS A217979, proved by transfer matrix}
...
\begin{abstract}
OEIS A217979 counts the distinct arrays obtained by applying a fixed local operation to every cell
of an array over a bounded alphabet, and carries an empirical recurrence of order $21$
...
$S=100$ states, after which the conjectured recurrence is settled by a finite exact
computation.
\end{abstract}
...
OEIS A217979 is ``Number of n X 5 arrays of the minimum value of corresponding elements and their horizontal, vertical, diagonal or antidiagonal neighbors in a random 0..1 n X 5 array.''. It has offset $1$ and begins
\[
10, 10, 100, 362, 1942, 8872, 43258, 205446,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 08 2026 18:05:18, revision 10) this is still
...
\]
There are $S=100$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite.
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + 10\,a(n-2) + a(n-3) - 28\,a(n-4) - 58\,a(n-5) + 41\,a(n-6) + 39\,a(n-7) - 50\,a(n-8) - 9\,a(n-9) + 100\,a(n-10) + 368\,a(n-11) - 439\,a(n-12) - 51\,a(n-13) + 370\,a(n-14) - 249\,a(n-15) - 56\,a(n-16) + 106\,a(n-17) - 33\,a(n-18) - 7\,a(n-19) + 6\,a(n-20) + a(n-21)
\]
for every $n>21$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A217979.
