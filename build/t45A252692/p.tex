...
\title{The empirical recurrence for OEIS A252692, proved by transfer matrix}
...
\begin{abstract}
OEIS A252692 counts arrays of width $7$ over an alphabet of $4$ letters in which every three
...
OEIS A252692 is ``Number of (n+2) X (5+2) 0..3 arrays with every consecutive three elements in every row and column having exactly two distinct values, and in every diagonal and antidiagonal not having exactly two distinct values, and new values 0 upwards introduced in row major order.''. It has offset $1$ and begins
\[
707, 1047, 291, 2048, 568, 4138, 1276, 8608,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) - 2*a(n-2) - 7*a(n-3) + 2*a(n-4) + 6*a(n-5) + 14*a(n-6) - 20*a(n-7) - 4*a(n-8) + 8*a(n-9) for n>10.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 05 2018 06:14:20, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) - 2\,a(n-2) - 7\,a(n-3) + 2\,a(n-4) + 6\,a(n-5) + 14\,a(n-6) - 20\,a(n-7) - 4\,a(n-8) + 8\,a(n-9)
\]
for every $n>10$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A252692.
