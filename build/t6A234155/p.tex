...
\title{The empirical recurrence for OEIS A234155, proved by transfer matrix}
...
\begin{abstract}
OEIS A234155 counts $(n+1)\times3$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A234155 is ``Number of (n+1) X (2+1) 0..3 arrays with every 2 X 2 subblock having the absolute values of all six edge and diagonal differences no larger than 1.''. It has offset $1$ and begins
\[
226, 2210, 21428, 208530, 2031286, 19801468, 193116778, 1883946390,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 16*a(n-1) - 59*a(n-2) - 31*a(n-3) + 118*a(n-4) + 35*a(n-5) - 10*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 13 2018 11:55:51, revision 11) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234155.
