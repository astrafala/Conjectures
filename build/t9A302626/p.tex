...
\title{The empirical recurrence for OEIS A302626, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A302626 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
values of its neighbours, and carries an empirical recurrence of order $16$ contributed
...
OEIS A302626 is ``Number of 5 X n 0..1 arrays with every element equal to 0, 1, 2 or 6 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
16, 264, 191, 367, 896, 2229, 5771, 15303,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 27 2023 15:36:10, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) - 2\,a(n-2) - 2\,a(n-3) - 8\,a(n-4) + 23\,a(n-6) - a(n-7) - 11\,a(n-8) - 16\,a(n-9) + 17\,a(n-10) + 2\,a(n-11) - 5\,a(n-12) - 5\,a(n-13) + 3\,a(n-14) + 3\,a(n-15) - a(n-16)
\end{equation}
for all $n>21$.
...
\begin{proof}
Substitute Lemma~\ref{lem:walk} and factor $G^{j-16}$ out of
...
the middle column. The vector $w$ was formed by $16$ applications of $G$ in exact integer
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302626.
