...
\title{The empirical recurrence for OEIS A251252, proved by transfer matrix}
...
\begin{abstract}
OEIS A251252 counts $(n+1)\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A251252 is ``Number of (n+1) X (2+1) 0..1 arrays with every 2 X 2 subblock having a single 1 or two 1s on the same edge.''. It has offset $1$ and begins
\[
18, 56, 150, 446, 1232, 3602, 10108, 29272,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) + 4*a(n-2) - 14*a(n-3) + 3*a(n-4) + 3*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 27 2018 09:08:33, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251252.
