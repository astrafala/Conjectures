...
\title{The empirical recurrence for OEIS A251066, proved by transfer matrix}
...
\begin{abstract}
OEIS A251066 counts $3\times(n+1)$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A251066 is ``Number of (2+1)X(n+1) 0..2 arrays with no 2X2 subblock having x11-x00 less than x10-x01.''. It has offset $1$ and begins
\[
336, 2740, 17129, 89429, 410718, 1716324, 6678657, 24601591,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 10:17:57, revision 6) the statement is
...
every one of the $21$ published indices; the values agree exactly. That is what ties
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251066.
