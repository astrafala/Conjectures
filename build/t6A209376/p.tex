...
\title{The empirical recurrence for OEIS A209376, proved by transfer matrix}
...
\begin{abstract}
OEIS A209376 counts $(n+1)\times3$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A209376 is ``1/4 the number of (n+1) X 3 0..2 arrays with every 2 X 2 subblock having distinct edge sums.''. It has offset $1$ and begins
\[
8, 17, 34, 80, 170, 410, 882, 2138,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) + 6*a(n-2) - 6*a(n-3) - 4*a(n-4) + 4*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 09 2018 16:19:46, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 6\,a(n-2) - 6\,a(n-3) - 4\,a(n-4) + 4\,a(n-5)
\end{equation}
for all $n>5$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209376.
