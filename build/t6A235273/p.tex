...
\title{The empirical recurrence for OEIS A235273, proved by transfer matrix}
...
\begin{abstract}
OEIS A235273 counts $(n+1)\times4$ arrays over $\{0,\dots,4\}$ subject to a condition imposed on
...
OEIS A235273 is ``Number of (n+1) X (3+1) 0..4 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 5 (constant-stress 1 X 1 tilings).''. It has offset $1$ and begins
\[
208, 380, 632, 1280, 2344, 5096, 10088, 23000,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) + 15*a(n-2) - 15*a(n-3) - 80*a(n-4) + 80*a(n-5) + 180*a(n-6) - 180*a(n-7) - 144*a(n-8) + 144*a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 20 2022 21:30:02, revision 12) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A235273.
