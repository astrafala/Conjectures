...
\title{The empirical recurrence for OEIS A251302, proved by transfer matrix}
...
\begin{abstract}
OEIS A251302 counts $(n+1)\times3$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
every $2\times2$ subblock, and carries an empirical recurrence of order $24$ contributed
...
OEIS A251302 is ``Number of (n+1)X(2+1) 0..3 arrays with no 2X2 subblock having the sum of its diagonal elements less than the maximum of its antidiagonal elements.''. It has offset $1$ and begins
\[
2292, 82241, 2986712, 108857571, 3969434142, 144740268503, 5277635529521, 192436288418395,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:15:03, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;64\,a(n-1) - 1368\,a(n-2) + 16182\,a(n-3) - 121510\,a(n-4) + 614295\,a(n-5) - 2203422\,a(n-6) + 5855414\,a(n-7) - 11858513\,a(n-8) + 18538655\,a(n-9) - 22247279\,a(n-10) + 19763776\,a(n-11) - 11486424\,a(n-12) + 1755813\,a(n-13) + 4675665\,a(n-14) - 6317173\,a(n-15) + 4895605\,a(n-16) - 2772914\,a(n-17) + 1220806\,a(n-18) - 416396\,a(n-19) + 108775\,a(n-20) - 22066\,a(n-21) + 3421\,a(n-22) - 352\,a(n-23) + 14\,a(n-24)
\end{equation}
for all $n>23$.
...
\text{not }\bigl((\alpha+\delta)<\max(\beta,\gamma)\bigr),
\end{equation}
...
For every $n$ with $n+1-1\ge24$,
\[
a(n)-\sum_i c_i\,a(n-i)\;=\;\mathbf{1}^{\!\top}M^{\,n+1-1-24}\,q(M)\,\mathbf{1} .
\]
...
=\mathbf{1}^{\!\top}M^{\,m-24}\,q(M)\,\mathbf{1}
\]
...
$m-24=j$ run over $\ge0$. For the last clause put $w=q(M)\mathbf{1}$. By the
...
$S^2$ pairs. The vector $w=q(M)\mathbf{1}\in\mathbb{Z}^{S}$ was then formed by $24$
...
index corresponding to $n=23+1$ onwards, and the run continued until $w$ itself was the
zero vector, which settles every larger $j$ at once. By Lemma~\ref{lem:crit} the recurrence
holds for every $n>23$.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251302.
