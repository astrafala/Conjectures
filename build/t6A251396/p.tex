...
\title{The empirical recurrence for OEIS A251396, proved by transfer matrix}
...
\begin{abstract}
OEIS A251396 counts $(n+1)\times3$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A251396 is ``Number of (n+1)X(2+1) 0..3 arrays with no 2X2 subblock having the sum of its diagonal elements less than the absolute difference of its antidiagonal elements.''. It has offset $1$ and begins
\[
3205, 165498, 8558283, 442476530, 22875877611, 1182680672547, 61144538351375, 3161169623507538,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:18:15, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;64\,a(n-1) - 765\,a(n-2) + 7612\,a(n-3) - 52441\,a(n-4) + 214718\,a(n-5) - 593810\,a(n-6) + 1025324\,a(n-7) - 199793\,a(n-8) - 5621360\,a(n-9) + 22779258\,a(n-10) - 54455283\,a(n-11) + 92144141\,a(n-12) - 114989494\,a(n-13) + 108478582\,a(n-14) - 77963792\,a(n-15) + 41298509\,a(n-16) - 14996935\,a(n-17) + 2763273\,a(n-18) + 672602\,a(n-19) - 778511\,a(n-20) + 318339\,a(n-21) - 73291\,a(n-22) + 9681\,a(n-23) - 693\,a(n-24) + 25\,a(n-25)
\end{equation}
for all $n>24$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251396.
