...
\title{A proof of the conjectured recurrence for OEIS A000704}
...
\begin{abstract}
OEIS A000704 carries a conjectured linear recurrence with polynomial coefficients, of
...
OEIS A000704 is ``Number of degree-n even permutations of order dividing 2''. It has offset $0$ and begins
\[
a(0),\dots,a(7)\;=\;1, 1, 1, 1, 4, 16, 46, 106,\ \dots
\]
The entry gives the exponential generating function
\begin{equation}\label{eq:gf}
A(x)\;=\;\sum_{n\ge 0} a(n)\,\frac{x^{n}}{n!}\;=\;e^{x} \cosh{\left(\frac{x^{2}}{2} \right)} ,
\end{equation}
and it carries the following comment:
\begin{quote}\small
\textbf{Conjecture:} a(n) -3*a(n-1) +3*a(n-2) -a(n-3) -(n-1)*(n-3)*a(n-4) +(n-3)*(n-4)*a(n-5)=0. - \emph{R. J. Mathar}, Jun 03 2014
\end{quote}
As of the ``Last modified'' line on the live entry (2026-07-18, revision 58) the
...
\section{The computation for A000704}
...
section of A000704, agreeing on all 13 terms compared.
...
\url{https://oeis.org}, 2026. Sequence A000704.
