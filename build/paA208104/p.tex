...
\title{The empirical recurrence for OEIS A208104, proved by transfer matrix}
...
\begin{abstract}
OEIS A208104 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
...
OEIS A208104 is ``Number of n X 4 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 1 1 and 1 1 0 vertically.''. It has offset
$1$ and begins
\[
9, 81, 169, 361, 841, 2025, 5041,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 4*a(n-1) - 2*a(n-2) - 6*a(n-3) + 4*a(n-4) + 2*a(n-5) - a(n-6) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 28 2018 08:25:43, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208104.
