...
\title{The empirical recurrence for OEIS A305017, proved by transfer matrix}
...
\begin{abstract}
OEIS A305017 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A305017 is ``Number of nX3 0..1 arrays with every element unequal to 2, 3, 4, 5 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
0, 5, 14, 73, 387, 2000, 10487, 54957,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 23 2018 16:12:36, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 14\,a(n-2) + 6\,a(n-3) - 79\,a(n-4) - 104\,a(n-5) + 77\,a(n-6) + 181\,a(n-7) + 65\,a(n-8) - 51\,a(n-9) - 5\,a(n-10) + 49\,a(n-11) + 5\,a(n-12) - 18\,a(n-13) - 2\,a(n-14) + 4\,a(n-15)
\end{equation}
for all $n>15$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A305017.
