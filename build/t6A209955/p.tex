...
\title{The empirical recurrence for OEIS A209955, proved by transfer matrix}
...
\begin{abstract}
OEIS A209955 counts $(n+1)\times4$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A209955 is ``Number of (n+1)X4 0..2 arrays with every 2X2 subblock having one, three or four distinct clockwise edge differences.''. It has offset $1$ and begins
\[
4521, 260201, 14922177, 856216289, 49124545369, 2818513213257, 161711349015585, 9278144587101729,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 15:36:47, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;48\,a(n-1) + 720\,a(n-2) - 8224\,a(n-3) - 127687\,a(n-4) - 63722\,a(n-5) + 3510704\,a(n-6) + 8214978\,a(n-7) - 17816696\,a(n-8) - 46577704\,a(n-9) + 37523312\,a(n-10) + 70734912\,a(n-11) - 30102144\,a(n-12) - 26296320\,a(n-13) + 10088448\,a(n-14)
\end{equation}
for all $n>13$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209955.
