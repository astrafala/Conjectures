...
different counts. Across the columns settled here the model reproduces $27$ published
values, $97$ decimal digits in all, every one of them exactly; a misreading of the entry
