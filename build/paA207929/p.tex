...
\title{The empirical recurrence for OEIS A207929, proved by transfer matrix}
...
\begin{abstract}
OEIS A207929 counts arrays over $\{0,\dots,1\}$ of width $3$ that avoid the patterns
$(0,0,0), (1,1,1)$ along one axis and $(0,0,0), (0,1,0)$ along the other, and carries an empirical recurrence of
...
OEIS A207929 is ``Number of 3 X n 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 0 0 and 1 1 1 vertically.''. It has offset
$1$ and begins
\[
6, 36, 72, 144, 360, 900, 2160,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) + 2*a(n-3) + a(n-4) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 26 2018 06:09:29, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207929.
