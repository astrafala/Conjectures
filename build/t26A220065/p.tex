...
\title{The empirical recurrence for OEIS A220065, proved by transfer matrix}
...
\begin{abstract}
OEIS A220065 counts the distinct indicator arrays obtained from the $n\times2$ arrays over
...
indicator row by row turns it into one, on $S=35$ states, after which the conjectured
...
OEIS A220065 is ``Majority value maps: number of nX2 binary arrays indicating the locations of corresponding elements equal to at least half of their horizontal and vertical neighbors in a random 0..1 nX2 array.''. It has offset $1$ and begins
\[
2, 6, 19, 65, 222, 776, 2682, 9310,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 18:30:15, revision 8) this is still
...
\]
There are $S=35$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite. Note
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + 2\,a(n-2) - a(n-3) + a(n-4) - 4\,a(n-5) - 8\,a(n-6) - 6\,a(n-7) - a(n-8) - 9\,a(n-9) - a(n-10) + 14\,a(n-11) + 4\,a(n-12) + 20\,a(n-13) - 4\,a(n-14) + 4\,a(n-15) - 4\,a(n-16)
\]
for every $n>17$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A220065.
