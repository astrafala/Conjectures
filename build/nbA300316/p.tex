...
\title{The empirical recurrence for OEIS A300316, proved by transfer matrix}
...
\begin{abstract}
OEIS A300316 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A300316 is ``Number of nX3 0..1 arrays with every element equal to 0, 1, 3, 4, 5, 6, 7 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
3, 4, 16, 61, 186, 977, 3875, 15976,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 02 2018 18:03:22, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 5\,a(n-2) + 14\,a(n-3) - 45\,a(n-4) - 51\,a(n-5) - 3\,a(n-6) + 122\,a(n-7) + 106\,a(n-8) - 48\,a(n-9) - 52\,a(n-10) - 18\,a(n-11) + 24\,a(n-12) - 75\,a(n-13) - 4\,a(n-14) + 30\,a(n-15)
\end{equation}
for all $n>16$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A300316.
