...
\title{The empirical recurrence for OEIS A207754, proved by transfer matrix}
...
\begin{abstract}
OEIS A207754 counts arrays over $\{0,\dots,1\}$ of width $5$ that avoid the patterns
$(0,0,1), (1,0,0)$ along one axis and $(0,0,1), (0,1,1)$ along the other, and carries an empirical recurrence of
...
OEIS A207754 is ``Number of 5Xn 0..1 arrays avoiding 0 0 1 and 0 1 1 horizontally and 0 0 1 and 1 0 0 vertically.''. It has offset
$1$ and begins
\[
14, 196, 798, 3249, 8778, 23716, 51590,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:16:00, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207754.
