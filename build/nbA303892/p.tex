...
\title{The empirical recurrence for OEIS A303892, proved by transfer matrix}
...
\begin{abstract}
OEIS A303892 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $different from$ itself lying in $\{1,2,3,4\}$, and it carries an empirical
...
OEIS A303892 is ``Number of nX4 0..1 arrays with every element unequal to 1, 2, 3 or 4 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
2, 86, 271, 1659, 7421, 39711, 195279, 1003855,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 02 2018 08:02:33, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 22\,a(n-2) - 8\,a(n-3) - 131\,a(n-4) + a(n-5) + 153\,a(n-6) - 84\,a(n-7) + 542\,a(n-8) + 278\,a(n-9) - 1349\,a(n-10) + 447\,a(n-11) + 711\,a(n-12) - 308\,a(n-13) + 422\,a(n-14) - 2403\,a(n-15) + 1609\,a(n-16) - 250\,a(n-17) - 407\,a(n-18) + 3132\,a(n-19) - 3586\,a(n-20) + 3814\,a(n-21) - 3697\,a(n-22) + 375\,a(n-23) + 1563\,a(n-24) - 1317\,a(n-25) + 1526\,a(n-26) - 1386\,a(n-27) + 563\,a(n-28) - 422\,a(n-29) + 246\,a(n-30) - 59\,a(n-31) + 112\,a(n-32) - 21\,a(n-33) - 2\,a(n-34) - 7\,a(n-35)
\end{equation}
for all $n>39$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A303892.
