...
\title{The empirical recurrence for OEIS A233879, proved by transfer matrix}
...
\begin{abstract}
OEIS A233879 counts $(n+1)\times5$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
every $2\times2$ subblock, and carries an empirical recurrence of order $29$ contributed
...
OEIS A233879 is ``Number of (n+1)X(4+1) 0..2 arrays with every 2X2 subblock having the sum of the squares of all six edge and diagonal differences equal to 11.''. It has offset $1$ and begins
\[
760, 5156, 33656, 251532, 1768660, 14111768, 103547288, 858513368,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 09:03:14, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;10\,a(n-1) + 111\,a(n-2) - 1347\,a(n-3) - 2952\,a(n-4) + 61962\,a(n-5) - 23589\,a(n-6) - 1303743\,a(n-7) + 2061738\,a(n-8) + 13676265\,a(n-9) - 32627870\,a(n-10) - 74205472\,a(n-11) + 248050297\,a(n-12) + 184715702\,a(n-13) - 1058894761\,a(n-14) + 18879451\,a(n-15) + 2642739884\,a(n-16) - 1291495298\,a(n-17) - 3771977707\,a(n-18) + 3244720225\,a(n-19) + 2774675096\,a(n-20) - 3693043205\,a(n-21) - 677649206\,a(n-22) + 2114258648\,a(n-23) - 285661000\,a(n-24) - 570117698\,a(n-25) + 190279800\,a(n-26) + 48545460\,a(n-27) - 28512000\,a(n-28) + 2851200\,a(n-29)
\end{equation}
for all $n>29$.
...
For every $n$ with $n+1-1\ge29$,
\[
a(n)-\sum_i c_i\,a(n-i)\;=\;\mathbf{1}^{\!\top}M^{\,n+1-1-29}\,q(M)\,\mathbf{1} .
\]
...
=\mathbf{1}^{\!\top}M^{\,m-29}\,q(M)\,\mathbf{1}
\]
...
$m-29=j$ run over $\ge0$. For the last clause put $w=q(M)\mathbf{1}$. By the
...
$S^2$ pairs. The vector $w=q(M)\mathbf{1}\in\mathbb{Z}^{S}$ was then formed by $29$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A233879.
