...
\title{The empirical recurrence for OEIS A220923, proved by transfer matrix}
...
\begin{abstract}
OEIS A220923 counts the distinct indicator arrays obtained from the $n\times2$ arrays over
...
OEIS A220923 is ``Majority value maps: number of 2Xn binary arrays indicating the locations of corresponding elements equal to at least half of their horizontal, diagonal and antidiagonal neighbors in a random 0..2 2Xn array.''. It has offset $1$ and begins
\[
1, 10, 44, 163, 626, 2351, 8950, 33895,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 19:07:24, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + 3\,a(n-2) - 16\,a(n-3) + 3\,a(n-4) + 17\,a(n-5) - 16\,a(n-6) - 8\,a(n-7) + 12\,a(n-8) - 12\,a(n-9) + 8\,a(n-10) - 8\,a(n-12) + 16\,a(n-13) - 16\,a(n-14) - 32\,a(n-15)
\]
for every $n>15$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A220923.
