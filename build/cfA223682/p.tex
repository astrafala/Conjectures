...
\title{The empirical closed form for OEIS A223682, proved}
...
\begin{abstract}
OEIS A223682 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A223682 is ``Number of 4 X n 0..1 arrays with rows and antidiagonals unimodal.''. It has offset $1$ and begins
\[
16, 256, 2032, 9822, 35509, 105995, 275775, 646407,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 22 2018 09:18:34, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{n^{8}}{112} + \frac{79 n^{7}}{1260} + \frac{121 n^{6}}{120} + \frac{71 n^{5}}{36} + \frac{475 n^{4}}{48} - \frac{1757 n^{3}}{180} + \frac{8893 n^{2}}{840} - \frac{569 n}{84} + 9.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223682.
