...
\title{The empirical recurrence for OEIS A205048, proved by transfer matrix}
...
\begin{abstract}
OEIS A205048 counts arrays over $\{0,\dots,2\}$ under a condition on the number of rightwards and downwards edge increases
...
OEIS A205048 is ``Number of (n+1)X2 0..2 arrays with the number of rightwards and downwards edge increases in each 2X2 subblock equal to the number in all its horizontal and vertical neighbors.''. It has offset $1$ and begins
\[
81, 243, 803, 2892, 10948, 43261, 174282, 709813,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 11:43:05, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-1) - 19\,a(n-2) + 5\,a(n-3) + 55\,a(n-4) - 130\,a(n-5) + 110\,a(n-6) + 76\,a(n-7) - 206\,a(n-8) + 143\,a(n-9) - 127\,a(n-10) + 149\,a(n-11) - 69\,a(n-12) + 26\,a(n-13) - 34\,a(n-14) + 18\,a(n-15) - 7\,a(n-16) - 3\,a(n-17) + 10\,a(n-18) - 4\,a(n-19)
\]
for every $n>21$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A205048.
