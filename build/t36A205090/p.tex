...
\title{The empirical recurrence for OEIS A205090, proved by transfer matrix}
...
\begin{abstract}
OEIS A205090 counts arrays over $\{0,\dots,3\}$ under a condition on the number of rightwards and downwards edge increases
in every $2\times2$ subblock, and carries an empirical recurrence of order $32$ contributed by
...
OEIS A205090 is ``Number of (n+1)X2 0..3 arrays with the number of rightwards and downwards edge increases in each 2X2 subblock equal to the number in all its horizontal and vertical neighbors.''. It has offset $1$ and begins
\[
256, 1328, 8176, 55848, 401164, 2965056, 22161076, 166572246,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 11:47:02, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;13\,a(n-1) - 43\,a(n-2) - 31\,a(n-3) + 492\,a(n-4) - 1254\,a(n-5) + 378\,a(n-6) + 4294\,a(n-7) - 9634\,a(n-8) + 11950\,a(n-9) - 9176\,a(n-10) - 7034\,a(n-11) + 32979\,a(n-12) - 48847\,a(n-13) + 51554\,a(n-14) - 57136\,a(n-15) + 75170\,a(n-16) - 93014\,a(n-17) + 108855\,a(n-18) - 135255\,a(n-19) + 143481\,a(n-20) - 117173\,a(n-21) + 86814\,a(n-22) - 56300\,a(n-23) + 22871\,a(n-24) - 3267\,a(n-25) - 2926\,a(n-26) + 4318\,a(n-27) - 3158\,a(n-28) + 1328\,a(n-29) - 152\,a(n-30) - 128\,a(n-31) + 32\,a(n-32)
\]
for every $n>35$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A205090.
