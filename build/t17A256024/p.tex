...
\title{The empirical recurrence for OEIS A256024, proved by transfer matrix}
...
\begin{abstract}
OEIS A256024 counts $(n+2)\times5$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
no $3\times3$ subblock, and it carries an empirical recurrence of order $26$
...
OEIS A256024 is ``Number of (n+2)X(3+2) 0..1 arrays with no 3x3 subblock diagonal sum 0 or 1 and no antidiagonal sum 0 or 1 and no row sum 1 and no column sum 1.''. It has offset $1$ and begins
\[
154, 484, 1689, 5559, 18881, 65202, 223901, 772322,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:43:47, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) - 5\,a(n-2) + 17\,a(n-3) - 13\,a(n-4) - 11\,a(n-5) - 53\,a(n-6) - 82\,a(n-7) + 104\,a(n-8) + 226\,a(n-9) + 158\,a(n-10) - 23\,a(n-11) - 338\,a(n-12) - 303\,a(n-13) - 89\,a(n-14) + 231\,a(n-15) + 283\,a(n-16) + 125\,a(n-17) - 59\,a(n-18) - 145\,a(n-19) - 77\,a(n-20) - 31\,a(n-21) + 26\,a(n-22) + 20\,a(n-23) + 24\,a(n-24) + 8\,a(n-25) + 4\,a(n-26)
\]
for every $n>28$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A256024.
