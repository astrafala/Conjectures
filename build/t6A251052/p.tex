...
\title{The empirical recurrence for OEIS A251052, proved by transfer matrix}
...
\begin{abstract}
OEIS A251052 counts $(n+1)\times6$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A251052 is ``Number of (n+1)X(5+1) 0..3 arrays with no 2X2 subblock having the sum of its diagonal elements greater than the absolute difference of its antidiagonal elements.''. It has offset $1$ and begins
\[
5449, 25847, 53306, 123396, 248803, 521785, 1045337, 2159272,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 8*a(n-1) -25*a(n-2) +35*a(n-3) -7*a(n-4) -49*a(n-5) +77*a(n-6) -55*a(n-7) +20*a(n-8) -3*a(n-9) for n>12
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:02:55, revision 6) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251052.
