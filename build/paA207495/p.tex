...
\title{The empirical recurrence for OEIS A207495, proved by transfer matrix}
...
\begin{abstract}
OEIS A207495 counts arrays over $\{0,\dots,1\}$ of width $3$ that avoid the patterns
...
OEIS A207495 is ``Number of n X 3 0..1 arrays avoiding 0 0 0 and 0 1 1 horizontally and 0 0 1 and 1 0 0 vertically.''. It has offset
$1$ and begins
\[
6, 36, 102, 297, 932, 2974, 9723,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 5*a(n-1) -2*a(n-2) -14*a(n-3) +6*a(n-4) +8*a(n-5) -a(n-6) -a(n-7) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 05 2018 05:59:55, revision
8) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) - 2\,a(n-2) - 14\,a(n-3) + 6\,a(n-4) + 8\,a(n-5) - a(n-6) - a(n-7)
\end{equation}
for all $n>6$. 
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207495.
