...
\title{The empirical recurrence for OEIS A219129, proved by transfer matrix}
...
\begin{abstract}
OEIS A219129 counts the distinct arrays obtained by applying a fixed local operation to every cell
...
$S=23$ states, after which the conjectured recurrence is settled by a finite exact
computation.
\end{abstract}
...
OEIS A219129 is ``Number of 2 X n arrays of the minimum value of corresponding elements and their horizontal, diagonal or antidiagonal neighbors in a random 0..2 2 X n array.''. It has offset $1$ and begins
\[
9, 15, 87, 205, 899, 2521, 9709, 29747,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + 6*a(n-2) - 6*a(n-3) + 7*a(n-4) - 10*a(n-5) + 6*a(n-6) - 6*a(n-7) - 4*a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 25 2018 05:35:44, revision 10) this is still
...
\]
There are $S=23$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite.
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 6\,a(n-2) - 6\,a(n-3) + 7\,a(n-4) - 10\,a(n-5) + 6\,a(n-6) - 6\,a(n-7) - 4\,a(n-8)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A219129.
