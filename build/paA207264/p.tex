...
\title{The empirical recurrence for OEIS A207264, proved by transfer matrix}
...
\begin{abstract}
OEIS A207264 counts arrays over $\{0,\dots,1\}$ of width $3$ that avoid the patterns
...
OEIS A207264 is ``Number of nX3 0..1 arrays avoiding 0 0 0 and 0 1 1 horizontally and 0 1 1 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
6, 36, 82, 193, 488, 1087, 2305,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 13:41:42, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) - 9\,a(n-2) + 12\,a(n-3) - 22\,a(n-4) + 25\,a(n-5) - 16\,a(n-6) + 21\,a(n-7) - 17\,a(n-8) + a(n-9) - 6\,a(n-10) + 6\,a(n-11) + a(n-12) + 2\,a(n-13) - 2\,a(n-14)
\end{equation}
for all $n>13$. 
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207264.
