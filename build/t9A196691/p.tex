...
\title{The empirical recurrence for OEIS A196691, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A196691 counts arrays over $\{0,\dots,4\}$ in which every cell is constrained by the
...
OEIS A196691 is ``Number of nX3 0..4 arrays with each element x equal to the number its horizontal and vertical neighbors equal to 2,1,3,0,4 for x=0,1,2,3,4.''. It has offset $1$ and begins
\[
3, 11, 76, 408, 2025, 10548, 55431, 289038,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) +8*a(n-2) +32*a(n-3) +54*a(n-4) +88*a(n-5) +28*a(n-6) -a(n-7) -10*a(n-8) -18*a(n-9) -a(n-11) -a(n-12) for n>13
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 06:41:25, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 8\,a(n-2) + 32\,a(n-3) + 54\,a(n-4) + 88\,a(n-5) + 28\,a(n-6) - a(n-7) - 10\,a(n-8) - 18\,a(n-9) - a(n-11) - a(n-12)
\end{equation}
for all $n>13$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A196691.
