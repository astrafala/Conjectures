...
\title{A proof of the conjectured recurrence for OEIS A052227}
...
\begin{abstract}
OEIS A052227 carries a conjectured linear recurrence with polynomial coefficients, of
...
OEIS A052227 is ``a(n) = (4*n+1)*binomial(3*n,n)/(2*n+1)''. It has offset $0$ and begins
\[
a(0),\dots,a(7)\;=\;1, 5, 27, 156, 935, 5733, 35700, 224808,\ \dots
\]
The entry states, not as a conjecture,
\begin{quote}\small
a(n) = binomial(3*n+1, n) + binomial(3*n, n-1) for n>=0.
\end{quote}
that is,
\begin{equation}\label{eq:cf}
a(n)\;=\;{\binom{3 n}{n - 1}} + {\binom{3 n + 1}{n}} .
\end{equation}
...
\begin{quote}\small
\textbf{Conjecture:} 8*n*(2*n+1)*a(n) + 6*(-8*n\^{}2-25*n+13)*a(n-1) - 45*(3*n-4)*(3*n-5)*a(n-2) = 0. - \emph{R. J. Mathar}, Nov 24 2012
\end{quote}
As of the ``Last modified'' line on the live entry (2025-09-16, revision 46) the
...
8 n \left(2 n + 1\right)\,a(n) -  6 \left(8 n^{2} + 25 n - 13\right)\,a(n-1) -  45 \left(3 n - 5\right) \left(3 n - 4\right)\,a(n-2)
\end{equation}
...
\section{The computation for A052227}
...
entry \href{https://oeis.org/A052227}{A052227}, 2025-09-16.
