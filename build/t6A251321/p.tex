...
\title{The empirical recurrence for OEIS A251321, proved by transfer matrix}
...
\begin{abstract}
OEIS A251321 counts $(n+1)\times4$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A251321 is ``Number of (n+1)X(3+1) 0..1 arrays with every 2X2 subblock having one or two 1s.''. It has offset $1$ and begins
\[
78, 474, 2804, 17216, 104058, 636404, 3866110, 23591052,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 4*a(n-1) +24*a(n-2) -59*a(n-3) -90*a(n-4) +188*a(n-5) +51*a(n-6) -126*a(n-7) +16*a(n-8) +11*a(n-9) -2*a(n-10)
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:16:38, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) + 24\,a(n-2) - 59\,a(n-3) - 90\,a(n-4) + 188\,a(n-5) + 51\,a(n-6) - 126\,a(n-7) + 16\,a(n-8) + 11\,a(n-9) - 2\,a(n-10)
\end{equation}
for all $n>9$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251321.
