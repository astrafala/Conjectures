...
\title{The empirical recurrence for OEIS A316234, proved by transfer matrix}
...
\begin{abstract}
OEIS A316234 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A316234 is ``Number of nX3 0..1 arrays with every element unequal to 0, 1, 3, 4, 5 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
3, 9, 14, 29, 71, 153, 358, 956,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 27 2018 15:31:30, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 10\,a(n-3) - 19\,a(n-4) - 14\,a(n-5) - 23\,a(n-7) + 17\,a(n-8) - 44\,a(n-9) + 131\,a(n-10) + 77\,a(n-11) - 105\,a(n-12) - 165\,a(n-13) + 99\,a(n-14) + 78\,a(n-15) - 42\,a(n-16) - 6\,a(n-17) + 4\,a(n-18)
\end{equation}
for all $n>19$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A316234.
