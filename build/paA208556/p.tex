...
\title{The empirical recurrence for OEIS A208556, proved by transfer matrix}
...
\begin{abstract}
OEIS A208556 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
...
OEIS A208556 is ``Number of 4 X n 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 0 1 and 0 1 1 vertically.''. It has offset
$1$ and begins
\[
9, 81, 225, 1089, 3969, 16641, 65025,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) + 6*a(n-2) - 8*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 07 2018 06:23:26, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208556.
