...
\title{The empirical recurrence for OEIS A256743, proved by transfer matrix}
...
\begin{abstract}
OEIS A256743 counts $(n+2)\times5$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A256743 is ``Number of (n+2)X(3+2) 0..1 arrays with no 3x3 subblock diagonal sum 3 and no antidiagonal sum 3 and no row sum 0 and no column sum 0.''. It has offset $1$ and begins
\[
857, 1564, 2992, 3752, 9112, 16560, 38376, 61376,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:44:43, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 4\,a(n-2) + 2\,a(n-3) - 5\,a(n-4) - 17\,a(n-5) + 20\,a(n-6) - 40\,a(n-7) - 28\,a(n-8) + 16\,a(n-9) + 176\,a(n-10) + 128\,a(n-11) - 256\,a(n-12)
\]
for every $n>17$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A256743.
