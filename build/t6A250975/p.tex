...
\title{The empirical recurrence for OEIS A250975, proved by transfer matrix}
...
\begin{abstract}
OEIS A250975 counts $(n+1)\times2$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A250975 is ``Number of (n+1) X (1+1) 0..2 arrays with no 2 X 2 subblock having the sum of its diagonal elements less than the absolute difference of its antidiagonal elements.''. It has offset $1$ and begins
\[
71, 562, 4459, 35381, 280728, 2227408, 17673153, 140225934,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 9*a(n-1) - 10*a(n-2) + 13*a(n-3) - 6*a(n-4) + a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 24 2018 08:11:55, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250975.
