...
\title{The empirical recurrence for OEIS A220994, proved by transfer matrix}
...
\begin{abstract}
OEIS A220994 counts the distinct indicator arrays obtained from the $n\times2$ arrays over
...
OEIS A220994 is ``Majority value maps: number of 2Xn binary arrays indicating the locations of corresponding elements equal to at least half of their horizontal, diagonal and antidiagonal neighbors in a random 0..3 2Xn array.''. It has offset $1$ and begins
\[
1, 10, 44, 168, 642, 2463, 9454, 36363,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 19:14:05, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + 3\,a(n-2) - 16\,a(n-3) + 3\,a(n-4) + 25\,a(n-5) - 12\,a(n-6) - 16\,a(n-7) + 4\,a(n-9) + 40\,a(n-10) - 16\,a(n-11) - 16\,a(n-12)
\]
for every $n>12$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A220994.
