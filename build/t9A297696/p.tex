...
\title{The empirical recurrence for OEIS A297696, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297696 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A297696 is ``Number of 3Xn 0..1 arrays with every 1 horizontally, diagonally or antidiagonally adjacent to 0, 2 or 4 neighboring 1s.''. It has offset $1$ and begins
\[
8, 19, 95, 293, 1244, 4277, 16931, 61040,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) +10*a(n-2) -24*a(n-3) -24*a(n-4) +43*a(n-5) +22*a(n-6) -17*a(n-7) -4*a(n-8) +2*a(n-9)
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 03 2018 12:29:45, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 10\,a(n-2) - 24\,a(n-3) - 24\,a(n-4) + 43\,a(n-5) + 22\,a(n-6) - 17\,a(n-7) - 4\,a(n-8) + 2\,a(n-9)
\end{equation}
for all $n>10$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297696.
