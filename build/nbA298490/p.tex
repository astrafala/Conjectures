...
\title{The empirical recurrence for OEIS A298490, proved by transfer matrix}
...
\begin{abstract}
OEIS A298490 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $equal to$ itself lying in $\{0,1,2,4,7\}$, and it carries an empirical
...
OEIS A298490 is ``Number of n X 4 0..1 arrays with every element equal to 0, 1, 2, 4 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
8, 29, 27, 41, 101, 158, 263, 481,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 26 2023 18:08:04, revision
6) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + a(n-2) + 6\,a(n-3) - 14\,a(n-4) - 8\,a(n-5) - 12\,a(n-6) + 16\,a(n-7) + 24\,a(n-8) + 27\,a(n-9) + 102\,a(n-10) + 13\,a(n-11) - 99\,a(n-12) - 390\,a(n-13) - 297\,a(n-14) + 126\,a(n-15) + 559\,a(n-16) + 781\,a(n-17) + 129\,a(n-18) - 240\,a(n-19) - 723\,a(n-20) - 356\,a(n-21) - 201\,a(n-22) - 117\,a(n-23) + 59\,a(n-24) - 69\,a(n-25) + 401\,a(n-26) + 250\,a(n-27) + 595\,a(n-28) + 310\,a(n-29) + 46\,a(n-30) - 311\,a(n-31) - 636\,a(n-32) - 423\,a(n-33) - 181\,a(n-34) + 315\,a(n-35) + 344\,a(n-36) + 144\,a(n-37) - 84\,a(n-38) - 96\,a(n-39) - 12\,a(n-40) + 20\,a(n-41)
\end{equation}
for all $n>42$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A298490.
