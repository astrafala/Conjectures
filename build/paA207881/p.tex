...
\title{The empirical recurrence for OEIS A207881, proved by transfer matrix}
...
\begin{abstract}
OEIS A207881 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
...
OEIS A207881 is ``Number of nX4 0..1 arrays avoiding 0 0 0 and 1 0 1 horizontally and 0 1 1 and 1 1 0 vertically.''. It has offset
$1$ and begins
\[
9, 81, 221, 575, 1673, 4881, 14825,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:23:40, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;8\,a(n-1) - 10\,a(n-2) - 67\,a(n-3) + 164\,a(n-4) + 194\,a(n-5) - 751\,a(n-6) - 172\,a(n-7) + 1630\,a(n-8) - 197\,a(n-9) - 1808\,a(n-10) + 490\,a(n-11) + 952\,a(n-12) - 320\,a(n-13) - 176\,a(n-14) + 64\,a(n-15)
\end{equation}
for all $n>14$. 
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207881.
