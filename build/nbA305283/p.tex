...
\title{The empirical recurrence for OEIS A305283, proved by transfer matrix}
...
\begin{abstract}
OEIS A305283 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A305283 is ``Number of nX3 0..1 arrays with every element unequal to 1, 2, 3, 4 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 23, 55, 279, 895, 3696, 13289, 51734,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 29 2018 08:20:53, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 11\,a(n-2) + 5\,a(n-3) - 19\,a(n-4) - 23\,a(n-5) - 2\,a(n-6) - 14\,a(n-7) - 16\,a(n-8) - 19\,a(n-9) - 12\,a(n-10) - a(n-11) - 6\,a(n-12) + 3\,a(n-13) - a(n-14) + 2\,a(n-15)
\end{equation}
for all $n>15$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A305283.
