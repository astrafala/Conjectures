...
\title{The empirical recurrence for OEIS A251468, proved by transfer matrix}
...
\begin{abstract}
OEIS A251468 counts $(n+1)\times2$ arrays over $\{0,\dots,5\}$ subject to a condition imposed on
...
OEIS A251468 is ``Number of (n+1)X(1+1) 0..5 arrays with every 2X2 subblock summing to a prime.''. It has offset $1$ and begins
\[
458, 5896, 75962, 979132, 12620130, 162672044, 2096768998, 27026993956,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:23:53, revision 7) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 227\,a(n-2) - 338\,a(n-3) - 12532\,a(n-4) + 15916\,a(n-5) + 236364\,a(n-6) - 266424\,a(n-7) - 1149984\,a(n-8) + 1209600\,a(n-9) + 414720\,a(n-10)
\end{equation}
for all $n>9$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251468.
