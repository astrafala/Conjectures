...
\title{The empirical recurrence for OEIS A303424, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A303424 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A303424 is ``Number of 5Xn 0..1 arrays with every element equal to 0, 1, 2, 3, 4 or 5 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
16, 512, 15684, 480960, 14783632, 454377792, 13963574592, 429120257920,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 23 2018 10:57:13, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;24\,a(n-1) + 128\,a(n-2) + 1992\,a(n-3) + 12020\,a(n-4) + 34880\,a(n-5) + 114640\,a(n-6) - 50896\,a(n-7) - 1751680\,a(n-8) - 2941888\,a(n-9) + 1000832\,a(n-10) + 4564992\,a(n-11) + 15197184\,a(n-12) + 31211520\,a(n-13) + 9373696\,a(n-14) - 4317184\,a(n-15) - 8290304\,a(n-16) - 40501248\,a(n-17) - 3145728\,a(n-18) + 16777216\,a(n-19)
\end{equation}
for all $n>20$.
...
\#\{\text{neighbours with a value }equal to\ x_{t,u}\}\in\{0,1,2,3,4,5\}
\end{equation}
...
Every one of those integers vanishes from the index corresponding to $n=20+1$ onwards,
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A303424.
