...
\title{The empirical recurrence for OEIS A218282, proved by transfer matrix}
...
\begin{abstract}
OEIS A218282 counts the distinct indicator arrays obtained from the $n\times2$ arrays over
...
indicator row by row turns it into one, on $S=52$ states, after which the conjectured
...
OEIS A218282 is ``Hilltop maps: number of nX2 binary arrays indicating the locations of corresponding elements not exceeded by any horizontal or vertical neighbor in a random 0..4 nX2 array.''. It has offset $1$ and begins
\[
3, 15, 63, 255, 1019, 4073, 16289, 65153,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 17:38:26, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

Let $R=\{0,\dots,4\}^{2}$ be the set of rows and let the neighbours of a cell be the
...
\]
There are $S=52$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite. Note
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + 3\,a(n-2) + 3\,a(n-3) + 3\,a(n-4) + 3\,a(n-5) + 3\,a(n-6) + 3\,a(n-7) + 2\,a(n-8) + 2\,a(n-9) - a(n-10) - a(n-11) - a(n-12) - a(n-13) - a(n-14) - a(n-15) - a(n-16) - a(n-17)
\]
for every $n>17$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A218282.
