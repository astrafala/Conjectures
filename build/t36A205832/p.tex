...
\title{The empirical recurrence for OEIS A205832, proved by transfer matrix}
...
\begin{abstract}
OEIS A205832 counts arrays over $\{0,\dots,2\}$ under a condition on the number of clockwise edge increases
...
OEIS A205832 is ``Number of (n+1)X5 0..2 arrays with the number of clockwise edge increases in every 2X2 subblock equal to two.''. It has offset $1$ and begins
\[
1611, 21126, 284910, 3875376, 52826862, 720376872, 9823579164, 133958429916,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 12:17:01, revision 9) this is still
...
subblocks; the entry's first term is $1611$, which the model
...
\begin{theorem}
\[
a(n)\;=\;25\,a(n-1) - 206\,a(n-2) + 807\,a(n-3) - 1625\,a(n-4) + 1558\,a(n-5) - 399\,a(n-6) - 1818\,a(n-7) + 2122\,a(n-8) - 1092\,a(n-9) + 276\,a(n-10)
\]
for every $n>11$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A205832.
