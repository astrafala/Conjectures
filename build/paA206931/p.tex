...
\title{The empirical recurrence for OEIS A206931, proved by transfer matrix}
...
\begin{abstract}
OEIS A206931 counts arrays over $\{0,\dots,1\}$ of width $3$ that avoid the patterns
...
OEIS A206931 is ``Number of n X 3 0..1 arrays avoiding 0 0 0 horizontally and 0 1 1 vertically.''. It has offset
$1$ and begins
\[
7, 49, 211, 811, 2791, 9055, 28081,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 6*a(n-1) - 9*a(n-2) - 6*a(n-3) + 18*a(n-4) - 9*a(n-6) + a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 17 2018 14:37:03, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206931.
