...
\title{The empirical recurrence for OEIS A234077, proved by transfer matrix}
...
\begin{abstract}
OEIS A234077 counts $(n+1)\times3$ arrays over $\{0,\dots,4\}$ subject to a condition imposed on
...
OEIS A234077 is ``Number of (n+1)X(2+1) 0..4 arrays with every 2X2 subblock having the sum of the absolute values of all six edge and diagonal differences equal to 10.''. It has offset $1$ and begins
\[
476, 2900, 18048, 122532, 849760, 6162980, 45072784, 336800596,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 09:09:18, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) + 110\,a(n-2) - 519\,a(n-3) - 4442\,a(n-4) + 20823\,a(n-5) + 81982\,a(n-6) - 411807\,a(n-7) - 690514\,a(n-8) + 4300171\,a(n-9) + 1861828\,a(n-10) - 23858897\,a(n-11) + 6643493\,a(n-12) + 68557098\,a(n-13) - 46245180\,a(n-14) - 103634888\,a(n-15) + 97714860\,a(n-16) + 81249120\,a(n-17) - 98401776\,a(n-18) - 30312448\,a(n-19) + 51151424\,a(n-20) + 3449856\,a(n-21) - 13460736\,a(n-22) + 567296\,a(n-23) + 1597440\,a(n-24) - 98304\,a(n-25) - 65536\,a(n-26)
\end{equation}
for all $n>26$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234077.
