...
\title{The empirical recurrence for OEIS A207121, proved by transfer matrix}
...
\begin{abstract}
OEIS A207121 counts arrays over $\{0,\dots,1\}$ of width $6$ that avoid the patterns
...
OEIS A207121 is ``Number of nX6 0..1 arrays avoiding 0 0 1 and 0 1 0 horizontally and 0 0 1 and 0 1 1 vertically.''. It has offset
$1$ and begins
\[
21, 441, 2499, 14161, 49861, 175561, 475984,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 13:30:13, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207121.
