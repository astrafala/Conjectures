...
\title{The empirical recurrence for OEIS A207811, proved by transfer matrix}
...
\begin{abstract}
OEIS A207811 counts arrays over $\{0,\dots,1\}$ of width $6$ that avoid the patterns
...
OEIS A207811 is ``Number of 6Xn 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 1 0 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
26, 676, 4238, 44538, 379444, 3511534, 31431114,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:20:28, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) + 47\,a(n-2) - 149\,a(n-3) - 401\,a(n-4) + 1365\,a(n-5) + 291\,a(n-6) - 3183\,a(n-7) + 1053\,a(n-8) + 2463\,a(n-9) - 1038\,a(n-10) - 814\,a(n-11) + 294\,a(n-12) + 112\,a(n-13) - 30\,a(n-14) - 5\,a(n-15) + a(n-16)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207811.
