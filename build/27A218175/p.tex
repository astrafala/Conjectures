...
\title{The empirical recurrence for OEIS A218175, proved by transfer matrix}
...
\begin{abstract}
OEIS A218175 counts the distinct arrays obtained by applying a fixed local operation to every cell
of an array over a bounded alphabet, and carries an empirical recurrence of order $13$
...
$S=170$ states, after which the conjectured recurrence is settled by a finite exact
computation.
\end{abstract}
...
OEIS A218175 is ``Number of nX2 arrays of the minimum value of corresponding elements and their horizontal and vertical neighbors in a random 0..3 nX2 array.''. It has offset $1$ and begins
\[
4, 28, 192, 956, 5494, 30888, 172038, 964828,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 17:34:24, revision 8) this is still
...
\]
There are $S=170$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite.
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + 8\,a(n-2) + 13\,a(n-3) - 33\,a(n-4) - 36\,a(n-5) - 86\,a(n-6) - 145\,a(n-7) - 161\,a(n-8) + 132\,a(n-9) + 538\,a(n-10) + 364\,a(n-11) - 112\,a(n-12) - 32\,a(n-13)
\]
for every $n>13$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A218175.
