...
\title{The empirical recurrence for OEIS A208082, proved by transfer matrix}
...
\begin{abstract}
OEIS A208082 counts arrays over $\{0,\dots,1\}$ of width $7$ that avoid the patterns
...
OEIS A208082 is ``Number of 7Xn 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 0 0 and 0 1 0 vertically.''. It has offset
$1$ and begins
\[
40, 1600, 27880, 572040, 11204720, 223058440, 4412968520,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:37:53, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;8\,a(n-1) + 240\,a(n-2) + 212\,a(n-3) - 6470\,a(n-4) - 2816\,a(n-5) + 58646\,a(n-6) + 3528\,a(n-7) - 215345\,a(n-8) + 36778\,a(n-9) + 305644\,a(n-10) - 78492\,a(n-11) - 174713\,a(n-12) + 38956\,a(n-13) + 42650\,a(n-14) - 5016\,a(n-15) - 4246\,a(n-16) + 194\,a(n-17) + 156\,a(n-18) - a(n-20)
\end{equation}
...
$(0,0,0), (0,1,0)$ as $3$ consecutive entries. There are $40$ admissible columns; that condition
...
columns, so $S=1600$, and declare $w\to w'$ an edge when $w'$ is $w$ with its first entry
...
values agree exactly, including the initial count of $40$ admissible columns. That is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208082.
