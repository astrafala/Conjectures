...
\title{The empirical recurrence for OEIS A209228, proved by transfer matrix}
...
\begin{abstract}
OEIS A209228 counts arrays over $\{0,\dots,1\}$ of width $7$ that avoid the patterns
...
OEIS A209228 is ``Number of 7Xn 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 1 0 and 1 1 1 vertically.''. It has offset
$1$ and begins
\[
28, 784, 896, 1024, 3456, 11664, 38232,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 15:12:22, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 6\,a(n-3) + 84\,a(n-4) - 128\,a(n-5) - 44\,a(n-6) - 144\,a(n-7) - 1872\,a(n-8) + 2504\,a(n-9) + 864\,a(n-10) + 1088\,a(n-11) + 16128\,a(n-12) - 19968\,a(n-13) - 5632\,a(n-14) - 2816\,a(n-15) - 57344\,a(n-16) + 66560\,a(n-17) + 11264\,a(n-18) + 4096\,a(n-19) + 77824\,a(n-20) - 83968\,a(n-21) - 8192\,a(n-22) - 32768\,a(n-24) + 32768\,a(n-25)
\end{equation}
...
$(0,1,0), (1,1,1)$ as $3$ consecutive entries. There are $28$ admissible columns; that condition
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209228.
