...
\title{The empirical recurrence for OEIS A208064, proved by transfer matrix}
...
\begin{abstract}
OEIS A208064 counts arrays over $\{0,\dots,1\}$ of width $3$ that avoid the patterns
$(0,0,0), (1,1,1)$ along one axis and $(0,0,1), (0,1,1)$ along the other, and carries an empirical recurrence of
...
OEIS A208064 is ``Number of n X 3 0..1 arrays avoiding 0 0 0 and 1 1 1 horizontally and 0 0 1 and 0 1 1 vertically.''. It has offset
$1$ and begins
\[
6, 36, 72, 144, 216, 324, 432,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) - 2*a(n-3) + a(n-4) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 27 2018 05:50:17, revision
...
$(0,0,0), (1,1,1)$ as $3$ consecutive entries. There are $6$ admissible rows; that condition
...
compared against the entry's DATA at every one of the $43$ published indices; the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208064.
