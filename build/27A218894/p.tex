...
\title{The empirical recurrence for OEIS A218894, proved by transfer matrix}
...
\begin{abstract}
OEIS A218894 counts the distinct arrays obtained by applying a fixed local operation to every cell
of an array over a bounded alphabet, and carries an empirical recurrence of order $37$
...
$S=249$ states, after which the conjectured recurrence is settled by a finite exact
computation.
\end{abstract}
...
OEIS A218894 is ``Number of nX5 arrays of the minimum value of corresponding elements and their horizontal, diagonal or antidiagonal neighbors in a random 0..1 nX5 array.''. It has offset $1$ and begins
\[
10, 86, 786, 6280, 54726, 463746, 3960146, 33785542,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 17:48:47, revision 8) this is still
...
\]
There are $S=249$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A218894.
