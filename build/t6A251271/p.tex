...
\title{The empirical recurrence for OEIS A251271, proved by transfer matrix}
...
\begin{abstract}
OEIS A251271 counts $5\times(n+1)$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
every $2\times2$ subblock, and carries an empirical recurrence of order $10$ contributed
...
OEIS A251271 is ``Number of (4+1) X (n+1) 0..1 arrays with no 2 X 2 subblock having x11-x00 less than x10-x01.''. It has offset $1$ and begins
\[
337, 2058, 9109, 32636, 100843, 279718, 715685, 1722176,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 11*a(n-1) - 54*a(n-2) + 156*a(n-3) - 294*a(n-4) + 378*a(n-5) - 336*a(n-6) + 204*a(n-7) - 81*a(n-8) + 19*a(n-9) - 2*a(n-10).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 27 2018 12:25:30, revision 7) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;11\,a(n-1) - 54\,a(n-2) + 156\,a(n-3) - 294\,a(n-4) + 378\,a(n-5) - 336\,a(n-6) + 204\,a(n-7) - 81\,a(n-8) + 19\,a(n-9) - 2\,a(n-10)
\end{equation}
for all $n>9$.
...
\begin{proof}
An array with $L$ columns and $5$ rows is precisely a sequence
...
For every $n$ with $n+1-1\ge10$,
\[
a(n)-\sum_i c_i\,a(n-i)\;=\;\mathbf{1}^{\!\top}M^{\,n+1-1-10}\,q(M)\,\mathbf{1} .
\]
...
=\mathbf{1}^{\!\top}M^{\,m-10}\,q(M)\,\mathbf{1}
\]
...
$m-10=j$ run over $\ge0$. For the last clause put $w=q(M)\mathbf{1}$. By the
...
$S^2$ pairs. The vector $w=q(M)\mathbf{1}\in\mathbb{Z}^{S}$ was then formed by $10$
...
index corresponding to $n=9+1$ onwards, and the run continued until $w$ itself was the
...
every one of the $23$ published indices; the values agree exactly. That is what ties
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251271.
