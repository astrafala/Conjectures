...
\title{The empirical recurrence for OEIS A264111, proved by transfer matrix}
...
\begin{abstract}
OEIS A264111 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=2$ columns in which
...
OEIS A264111 is ``Number of (1+1) X (n+1) arrays of permutations of 0..n*2+1 with each element having index change +-(.,.) 0,0 0,2 or 1,1.''. It has offset $1$ and begins
\[
2, 9, 45, 144, 512, 1936, 7381, 27225,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 05 2026 14:06:46, revision 8) this is still
...
\[
(i-h_i,\,j-h_j)\;\in\;\{(-2,0),\ (-1,-1),\ (0,0),\ (1,1),\ (2,0)\},
\]
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) - a(n-2) + 15\,a(n-4) - 60\,a(n-5) + 15\,a(n-6) - 15\,a(n-8) + 60\,a(n-9) - 15\,a(n-10) + a(n-12) - 4\,a(n-13) + a(n-14)
\]
for every $n>12$.
\end{theorem}
...
transposed companion A263966. Second, the transfer model reproduces all $24$ terms this
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264111.
