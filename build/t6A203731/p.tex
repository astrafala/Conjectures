...
\title{The empirical recurrence for OEIS A203731, proved by transfer matrix}
...
\begin{abstract}
OEIS A203731 counts $(n+1)\times5$ arrays over $\{0,\dots,7\}$ subject to a condition imposed on
...
OEIS A203731 is ``Number of (n+1)X5 0..7 arrays with every 2X2 subblock having equal diagonal elements or equal antidiagonal elements.''. It has offset $1$ and begins
\[
3240000, 681461824, 161916229056, 39986164706496, 9889622728751424, 2456635775400515136, 609221928288391040960, 151272719849511664491200,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 141*a(n-1) +34391*a(n-2) -1914087*a(n-3) -5360404*a(n-4) +185626112*a(n-5) +226020536*a(n-6) -801895584*a(n-7)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 10:41:18, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;141\,a(n-1) + 34391\,a(n-2) - 1914087\,a(n-3) - 5360404\,a(n-4) + 185626112\,a(n-5) + 226020536\,a(n-6) - 801895584\,a(n-7)
\end{equation}
for all $n>6$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A203731.
