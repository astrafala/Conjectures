...
\title{The empirical recurrence for OEIS A295526, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A295526 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A295526 is ``Number of nX3 0..1 arrays with each 1 horizontally or vertically adjacent to 1, 2 or 4 1s.''. It has offset $1$ and begins
\[
4, 29, 147, 774, 4080, 21489, 113466, 598374,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 23 2017 09:23:45, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) + 3\,a(n-2) + 15\,a(n-3) + 17\,a(n-4) + 40\,a(n-5) - 6\,a(n-6) - 12\,a(n-7) + 45\,a(n-8) - 21\,a(n-9) - 66\,a(n-10) + 7\,a(n-11) + 6\,a(n-12) - 6\,a(n-13) + 6\,a(n-14) + a(n-15) - 3\,a(n-16) + a(n-18)
\end{equation}
for all $n>19$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A295526.
