...
\title{The empirical recurrence for OEIS A221587, proved by transfer matrix}
...
\begin{abstract}
OEIS A221587 counts the distinct indicator arrays obtained from the $n\times2$ arrays over
$\{0,\dots,3\}$ by marking the cells whose value is equal to exactly one of their neighbours, and carries an
...
OEIS A221587 is ``Equals one maps: number of n X 2 binary arrays indicating the locations of corresponding elements equal to exactly one of their king-move neighbors in a random 0..3 n X 2 array.''. It has offset $1$ and begins
\[
2, 8, 40, 180, 772, 3264, 13634, 56456,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 6*a(n-1) - 3*a(n-2) - 22*a(n-3) + 7*a(n-4) + 4*a(n-5) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 08 2018 15:09:03, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) - 3\,a(n-2) - 22\,a(n-3) + 7\,a(n-4) + 4\,a(n-5)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221587.
