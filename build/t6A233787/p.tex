...
\title{The empirical recurrence for OEIS A233787, proved by transfer matrix}
...
\begin{abstract}
OEIS A233787 counts $(n+1)\times4$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A233787 is ``Number of (n+1)X(3+1) 0..3 arrays with every 2X2 subblock having the sum of the squares of all six edge and diagonal differences equal to 11.''. It has offset $1$ and begins
\[
720, 3932, 20816, 125976, 716768, 4674280, 27765752, 190316292,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 09:00:08, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;139\,a(n-2) - 7929\,a(n-4) + 248319\,a(n-6) - 4798442\,a(n-8) + 60800038\,a(n-10) - 523147257\,a(n-12) + 3118918441\,a(n-14) - 13016374051\,a(n-16) + 38139962547\,a(n-18) - 78218266028\,a(n-20) + 111158046394\,a(n-22) - 107387771932\,a(n-24) + 68279402362\,a(n-26) - 27119287096\,a(n-28) + 6185757504\,a(n-30) - 702040320\,a(n-32) + 29030400\,a(n-34)
\end{equation}
for all $n>34$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A233787.
