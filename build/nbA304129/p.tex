...
\title{The empirical recurrence for OEIS A304129, proved by transfer matrix}
...
\begin{abstract}
OEIS A304129 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A304129 is ``Number of nX4 0..1 arrays with every element unequal to 0, 1, 3 or 6 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
5, 17, 19, 44, 80, 140, 244, 436,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +3*a(n-3) +a(n-5) -a(n-6) -5*a(n-7) -2*a(n-8) +2*a(n-10) for n>13
\end{quote}
As of the ``Last modified'' line on the live entry (May 07 2018 07:57:14, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 3\,a(n-3) + a(n-5) - a(n-6) - 5\,a(n-7) - 2\,a(n-8) + 2\,a(n-10)
\end{equation}
for all $n>12$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A304129.
