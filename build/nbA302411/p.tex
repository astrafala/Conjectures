...
\title{The empirical recurrence for OEIS A302411, proved by transfer matrix}
...
\begin{abstract}
OEIS A302411 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A302411 is ``Number of n X 4 0..1 arrays with every element equal to 0, 1, 2 or 5 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
8, 37, 66, 259, 994, 3548, 12442, 46066,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 01 2023 13:14:42, revision
6) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 4\,a(n-2) + a(n-3) - 17\,a(n-4) - 39\,a(n-5) - 18\,a(n-6) + 96\,a(n-7) + 133\,a(n-8) - a(n-9) - 37\,a(n-10) - 239\,a(n-11) - 212\,a(n-12) - 10\,a(n-13) + 191\,a(n-14) + 299\,a(n-15) - 38\,a(n-16) + 62\,a(n-17) + 145\,a(n-18) - 218\,a(n-19) - 77\,a(n-20) + 21\,a(n-21) - 202\,a(n-22) + 25\,a(n-23) + 144\,a(n-24) + 19\,a(n-25) - 53\,a(n-26) + 2\,a(n-27) + 22\,a(n-28) - 5\,a(n-29) + 4\,a(n-30) - 4\,a(n-31)
\end{equation}
for all $n>32$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302411.
