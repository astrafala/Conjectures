...
\title{The empirical recurrence for OEIS A283952, proved by transfer matrix}
...
\begin{abstract}
OEIS A283952 counts $3\times n$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
walk, and $a(n)$ is a walk count on $S=136$ vertices, which is $C$-finite. Whether the
...
OEIS A283952 is ``Number of 3Xn 0..1 arrays with no 1 equal to more than three of its horizontal, diagonal and antidiagonal neighbors, with the exception of exactly one element.''. It has offset $1$ and begins
\[
0, 0, 87, 906, 7988, 69468, 575456, 4604744,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 18 2017 12:27:07, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;10\,a(n-1) - 15\,a(n-2) + 50\,a(n-3) - 483\,a(n-4) - 688\,a(n-5) - 2954\,a(n-6) - 1998\,a(n-7) + 1187\,a(n-8) + 9770\,a(n-9) + 26575\,a(n-10) + 21254\,a(n-11) - 469\,a(n-12) - 42264\,a(n-13) - 80523\,a(n-14) - 54448\,a(n-15) + 18704\,a(n-16) + 71312\,a(n-17) + 57531\,a(n-18) + 12848\,a(n-19) - 15198\,a(n-20) - 17226\,a(n-21) - 8382\,a(n-22) - 2048\,a(n-23) + 107\,a(n-24) + 234\,a(n-25) + 59\,a(n-26) + 4\,a(n-27) - 4\,a(n-28)
\]
for every $n>28$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A283952.
