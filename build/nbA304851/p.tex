...
\title{The empirical recurrence for OEIS A304851, proved by transfer matrix}
...
\begin{abstract}
OEIS A304851 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $different from$ itself lying in $\{0,1,3,4,7\}$, and it carries an empirical
recurrence of order $41$ contributed by R.~H.~Hardin. It is true. The neighbourhood
...
OEIS A304851 is ``Number of nX4 0..1 arrays with every element unequal to 0, 1, 3, 4 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
5, 17, 15, 38, 65, 127, 264, 626,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 19 2018 12:32:18, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) - 8\,a(n-2) + 4\,a(n-3) + 8\,a(n-4) - 35\,a(n-5) + 57\,a(n-6) - 24\,a(n-7) - 87\,a(n-8) + 154\,a(n-9) - 134\,a(n-10) + 120\,a(n-11) + 163\,a(n-12) - 369\,a(n-13) + 430\,a(n-14) - 288\,a(n-15) - 172\,a(n-16) + 223\,a(n-17) - 1201\,a(n-18) + 574\,a(n-19) + 229\,a(n-20) - 123\,a(n-21) + 916\,a(n-22) + 417\,a(n-23) + 1047\,a(n-24) + 18\,a(n-25) - 834\,a(n-26) - 591\,a(n-27) - 851\,a(n-28) - 687\,a(n-29) - 257\,a(n-30) + 188\,a(n-31) + 500\,a(n-32) + 418\,a(n-33) + 177\,a(n-34) + 96\,a(n-35) + 30\,a(n-36) - 50\,a(n-37) - 84\,a(n-38) - 46\,a(n-39) + 4\,a(n-41)
\end{equation}
for all $n>43$.
...
has score in $\{0,1,3,4,7\}$. The entry also fixes the top-left entry to be $0$; that is a condition on the first row alone, so it restricts the start vector and nothing else.
...
\begin{itemize}
\item $\mathbf{s}(r,s)=1$ when every cell of $r$ has score in $\{0,1,3,4,7\}$ \emph{with no row
above $r$} and $r_1=0$, and $0$ otherwise;
\item an edge $(r,s)\to(s,t)$ when every cell of $s$ has score in $\{0,1,3,4,7\}$ computed from
$r$, $s$ and $t$;
\item $\mathbf{e}(r,s)=1$ when every cell of $s$ has score in $\{0,1,3,4,7\}$ \emph{with no row
...
exactly when every one of its $n$ rows has all scores in $\{0,1,3,4,7\}$. Read the sequence as the
...
$a(n)-\sum_i c_i a(n-i)=u_{\,n-2-41}$ whenever $n-41\ge2$. So \eqref{eq:conj}
holds for every $n>t$ exactly when $u_j=0$ for all $j>t-2-41$. Moreover $(u_j)$
...
\begin{proof}
Substituting Lemma~\ref{lem:walk} and factoring $P^{\,n-2-41}$ out of
...
\begin{proof}
The vector $q(P)\mathbf{e}\in\mathbb{Z}^{S}$ was formed by $41$ matrix--vector
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A304851.
