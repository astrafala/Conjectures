...
\title{The empirical recurrence for OEIS A207763, proved by transfer matrix}
...
\begin{abstract}
OEIS A207763 counts arrays over $\{0,\dots,1\}$ of width $3$ that avoid the patterns
...
OEIS A207763 is ``Number of 3 X n 0..1 arrays avoiding 0 0 0 and 1 0 1 horizontally and 0 1 1 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
6, 36, 82, 221, 493, 1095, 2654,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +8*a(n-3) +a(n-5) -12*a(n-6) -3*a(n-7) +a(n-8) +10*a(n-9) -2*a(n-10) -3*a(n-12) for n>14.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 13 2026 10:24:31, revision
11) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 8\,a(n-3) + a(n-5) - 12\,a(n-6) - 3\,a(n-7) + a(n-8) + 10\,a(n-9) - 2\,a(n-10) - 3\,a(n-12)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207763.
