...
\title{The empirical recurrence for OEIS A206078, proved by transfer matrix}
...
\begin{abstract}
OEIS A206078 counts arrays over $\{0,\dots,3\}$ under a condition on the number of clockwise edge increases
...
OEIS A206078 is ``Number of (n+1) X 2 0..3 arrays with the number of clockwise edge increases in every 2 X 2 subblock equal to one.''. It has offset $1$ and begins
\[
124, 960, 7308, 55864, 426596, 3258496, 24887884, 190093096,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 6*a(n-1) +13*a(n-2) -4*a(n-3) +2*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 13 2018 11:23:56, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) + 13\,a(n-2) - 4\,a(n-3) + 2\,a(n-4)
\]
for every $n>3$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206078.
