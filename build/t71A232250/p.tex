...
\title{The empirical recurrence for OEIS A232250, proved by transfer matrix}
...
\begin{abstract}
OEIS A232250 counts arrays of width $2$ over $\{0,1,2\}$ in which every cell has a neighbour at least as large and one at most as large. The entry carries an
...
OEIS A232250 is ``Number of (n+1) X (1+1) 0..2 arrays with every element both >= and <= some horizontal or antidiagonal neighbor.''. It has offset $1$ and begins
\[
9, 37, 163, 723, 3209, 14245, 63235, 280707,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) + 2*a(n-2) - a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2018 14:08:54, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232250.
