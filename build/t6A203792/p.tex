...
\title{The empirical recurrence for OEIS A203792, proved by transfer matrix}
...
\begin{abstract}
OEIS A203792 counts $(n+1)\times5$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A203792 is ``Number of (n+1)X5 0..3 arrays with every 2X2 subblock having equal diagonal elements or equal antidiagonal elements.''. It has offset $1$ and begins
\[
38416, 1911952, 101071600, 5426653360, 292394880208, 15768587718160, 850544485943152, 45880025360206384,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 49*a(n-1) +543*a(n-2) -15435*a(n-3) +26244*a(n-4) +117288*a(n-5) -79704*a(n-6) -46656*a(n-7)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 10:43:55, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;49\,a(n-1) + 543\,a(n-2) - 15435\,a(n-3) + 26244\,a(n-4) + 117288\,a(n-5) - 79704\,a(n-6) - 46656\,a(n-7)
\end{equation}
for all $n>6$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A203792.
