...
\title{The empirical recurrence for OEIS A205459, proved by transfer matrix}
...
\begin{abstract}
OEIS A205459 counts arrays over $\{0,\dots,3\}$ under a condition on the number of clockwise edge increases
...
OEIS A205459 is ``Number of (n+1) X 2 0..3 arrays with the number of clockwise edge increases in every 2 X 2 subblock differing from each horizontal or vertical neighbor.''. It has offset $1$ and begins
\[
256, 2120, 17920, 151824, 1285076, 10876432, 92062852, 779221408,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 63*a(n-2) +50*a(n-3) +190*a(n-4) +42*a(n-5) +57*a(n-6) +122*a(n-7) +39*a(n-8) -12*a(n-9) for n > 10.
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 12:07:40, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;63\,a(n-2) + 50\,a(n-3) + 190\,a(n-4) + 42\,a(n-5) + 57\,a(n-6) + 122\,a(n-7) + 39\,a(n-8) - 12\,a(n-9)
\]
for every $n>10$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A205459.
