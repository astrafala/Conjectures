...
\title{The empirical recurrence for OEIS A238174, proved by transfer matrix}
...
\begin{abstract}
OEIS A238174 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
The condition is local to two consecutive rows, so the count is a walk count on $S=45$
...
OEIS A238174 is ``Number of (n+1)X(2+1) 0..2 arrays with the maximum plus the minimum of every 2X2 subblock equal.''. It has offset $1$ and begins
\[
423, 5321, 69023, 938601, 12951743, 180345769, 2520461647, 35289713177,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 22*a(n-1) -111*a(n-2) -106*a(n-3) +1473*a(n-4) -2198*a(n-5) -121*a(n-6) +1514*a(n-7) -472*a(n-8)
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 10:48:06, revision 6) this is still
...
array, which is not among the objects counted. There are $S=45$ states left.
...
\begin{theorem}
\[
a(n)\;=\;22\,a(n-1) - 111\,a(n-2) - 106\,a(n-3) + 1473\,a(n-4) - 2198\,a(n-5) - 121\,a(n-6) + 1514\,a(n-7) - 472\,a(n-8)
\]
for every $n>7$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A238174.
