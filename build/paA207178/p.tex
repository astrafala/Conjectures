...
\title{The empirical recurrence for OEIS A207178, proved by transfer matrix}
...
\begin{abstract}
OEIS A207178 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
...
OEIS A207178 is ``Number of nX4 0..1 arrays avoiding 0 0 0 horizontally and 0 1 0 vertically.''. It has offset
$1$ and begins
\[
13, 169, 1393, 11227, 95299, 816667, 6951227,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 13:33:33, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;8\,a(n-1) - 14\,a(n-2) + 122\,a(n-3) + 241\,a(n-4) + 205\,a(n-5) + 1610\,a(n-6) - 1293\,a(n-7) - 8293\,a(n-8) - 3968\,a(n-9) + 3959\,a(n-10) + 8030\,a(n-11) + 12180\,a(n-12) + 3570\,a(n-13) - 245\,a(n-14) - 2586\,a(n-15) - 2664\,a(n-16) - 336\,a(n-17) - 215\,a(n-18) + 31\,a(n-19) + 36\,a(n-20) - 5\,a(n-21) - a(n-22) - 2\,a(n-23) - a(n-24)
\end{equation}
for all $n>23$. 
...
$(0,0,0)$ as $3$ consecutive entries. There are $13$ admissible rows; that condition
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207178.
