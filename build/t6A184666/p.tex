...
\title{The empirical recurrence for OEIS A184666, proved by transfer matrix}
...
\begin{abstract}
OEIS A184666 counts $(n+1)\times3$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A184666 is ``Number of (n+1)X3 0..3 arrays with no 2X2 subblock summing to less than 6.''. It has offset $1$ and begins
\[
1740, 67330, 2405797, 88458672, 3225439429, 117938741095, 4308670152724, 157454260497016,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 02:49:01, revision 9) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A184666.
