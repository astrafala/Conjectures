...
\title{The empirical recurrence for OEIS A297982, proved by transfer matrix}
...
\begin{abstract}
OEIS A297982 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A297982 is ``Number of n X 4 0..1 arrays with every element equal to 0, 2, 3 or 6 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 17, 5, 15, 23, 43, 79, 184,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 27 2023 12:54:20, revision
6) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 2\,a(n-2) - 3\,a(n-3) + 2\,a(n-4) - 3\,a(n-5) - 9\,a(n-6) - 3\,a(n-7) - 3\,a(n-8) + 17\,a(n-9) + 13\,a(n-10) + 11\,a(n-11) - 5\,a(n-12) - 14\,a(n-13) - a(n-14) + 7\,a(n-15) + 10\,a(n-16) - 8\,a(n-17) - 12\,a(n-18) - 3\,a(n-19) - 5\,a(n-20) + 3\,a(n-21) + 2\,a(n-22)
\end{equation}
for all $n>27$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297982.
