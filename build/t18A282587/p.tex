...
\title{The empirical recurrence for OEIS A282587, proved by transfer matrix}
...
\begin{abstract}
OEIS A282587 counts $n\times2$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A282587 is ``Number of nX2 0..1 arrays with no 1 equal to more than two of its king-move neighbors, with the exception of exactly two elements.''. It has offset $1$ and begins
\[
0, 0, 4, 12, 52, 220, 916, 3700,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 19 2017 06:31:56, revision 5) this is still
...
\begin{theorem}
\[
a(n)\;=\;9\,a(n-1) - 24\,a(n-2) + 15\,a(n-3) - 36\,a(n-4) + 195\,a(n-5) - 143\,a(n-6) - 6\,a(n-7) - 492\,a(n-8) + 488\,a(n-9) + 96\,a(n-10) + 384\,a(n-11) - 512\,a(n-12)
\]
for every $n>12$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A282587.
