...
\title{The empirical recurrence for OEIS A219405, proved by transfer matrix}
...
\begin{abstract}
OEIS A219405 counts the distinct indicator arrays obtained from the $n\times3$ arrays over
...
indicator row by row turns it into one, on $S=13$ states, after which the conjectured
...
OEIS A219405 is ``Unmatched value maps: number of n X 3 binary arrays indicating the locations of corresponding elements not equal to any horizontal or antidiagonal neighbor in a random 0..2 n X 3 array.''. It has offset $1$ and begins
\[
4, 28, 181, 1180, 7687, 50077, 326233, 2125270,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) + 15*a(n-2) + 9*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 26 2018 05:16:45, revision 8) this is still
...
\]
There are $S=13$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite. Note
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A219405.
