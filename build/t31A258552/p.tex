...
\title{The empirical recurrence for OEIS A258552, proved by transfer matrix}
...
\begin{abstract}
OEIS A258552 counts the arrays over $\{0,\dots,1\}$ whose $2\times2$ subblocks carry a
...
OEIS A258552 is ``Number of (n+1) X (6+1) 0..1 arrays with every 2 X 2 subblock ne-sw antidiagonal difference nondecreasing horizontally and nw+se diagonal sum nondecreasing vertically.''. It has offset $1$ and begins
\[
988, 683, 1917, 3314, 6662, 10854, 16942, 24300,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) - 6*a(n-2) + 4*a(n-3) - 4*a(n-5) + 6*a(n-6) - 4*a(n-7) + a(n-8) for n>14.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 22 2018 07:29:10, revision 10) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A258552.
