...
\title{The empirical recurrence for OEIS A206312, proved by transfer matrix}
...
\begin{abstract}
OEIS A206312 counts arrays over $\{0,\dots,3\}$ under a condition on the number of clockwise edge increases
in every $2\times2$ subblock, and carries an empirical recurrence of order $29$ contributed by
...
OEIS A206312 is ``Number of (n+1)X3 0..3 arrays with the number of clockwise edge increases in every 2X2 subblock equal to two, and every 2X2 determinant nonzero.''. It has offset $1$ and begins
\[
873, 14990, 258452, 4466450, 77132181, 1332632711, 23019152735, 397663246671,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 12:50:33, revision 9) this is still
...
subblocks; the entry's first term is $873$, which the model
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206312.
