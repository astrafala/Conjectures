...
\title{The empirical recurrence for OEIS A207914, proved by transfer matrix}
...
\begin{abstract}
OEIS A207914 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
...
OEIS A207914 is ``Number of nX4 0..1 arrays avoiding 0 0 0 and 1 0 1 horizontally and 0 1 0 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
9, 81, 271, 1309, 5371, 23637, 101069,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:27:22, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) - 12\,a(n-2) + 17\,a(n-3) + 5\,a(n-4) + 51\,a(n-5) + 36\,a(n-6) - 399\,a(n-7) + 554\,a(n-8) - 625\,a(n-9) - 854\,a(n-10) - 4016\,a(n-11) + 210\,a(n-12) + 9416\,a(n-13) + 9774\,a(n-14) + 4886\,a(n-15) - 6673\,a(n-16) - 6888\,a(n-17) - 6416\,a(n-18) - 2847\,a(n-19) - 607\,a(n-20) + 1513\,a(n-21) + 1902\,a(n-22) + 1033\,a(n-23) + 100\,a(n-24) - 185\,a(n-25) - 162\,a(n-26) - 18\,a(n-27) + 8\,a(n-29)
\end{equation}
for all $n>28$. 
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207914.
