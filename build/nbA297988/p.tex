...
\title{The empirical recurrence for OEIS A297988, proved by transfer matrix}
...
\begin{abstract}
OEIS A297988 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $equal to$ itself lying in $\{1,2,3,6\}$, and it carries an empirical
...
OEIS A297988 is ``Number of nX3 0..1 arrays with every element equal to 1, 2, 3 or 6 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 17, 48, 146, 424, 1274, 3820, 11529,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) -a(n-2) +a(n-3) +6*a(n-4) +4*a(n-6) -2*a(n-8) -a(n-9) -2*a(n-10) -2*a(n-11) for n>13
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 10 2018 07:33:15, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) - a(n-2) + a(n-3) + 6\,a(n-4) + 4\,a(n-6) - 2\,a(n-8) - a(n-9) - 2\,a(n-10) - 2\,a(n-11)
\end{equation}
for all $n>12$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297988.
