...
\title{The empirical recurrence for OEIS A188708, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A188708 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A188708 is ``Number of 4 X n binary arrays without the pattern 0 0 diagonally or vertically.''. It has offset $1$ and begins
\[
8, 49, 304, 1876, 11556, 71152, 438048, 2696784,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 8*a(n-1) - 12*a(n-2) + 4*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 28 2018 12:49:14, revision 13) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A188708.
