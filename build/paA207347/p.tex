...
\title{The empirical recurrence for OEIS A207347, proved by transfer matrix}
...
\begin{abstract}
OEIS A207347 counts arrays over $\{0,\dots,1\}$ of width $3$ that avoid the patterns
$(0,0,0), (1,1,1)$ along one axis and $(0,0,0), (0,1,1)$ along the other, and carries an empirical recurrence of
...
OEIS A207347 is ``Number of 3 X n 0..1 arrays avoiding 0 0 0 and 0 1 1 horizontally and 0 0 0 and 1 1 1 vertically.''. It has offset
$1$ and begins
\[
6, 36, 84, 192, 426, 858, 1704,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) + a(n-3) - 2*a(n-4) - a(n-5) - a(n-6) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 22 2018 06:18:28, revision
8) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + a(n-3) - 2\,a(n-4) - a(n-5) - a(n-6)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207347.
