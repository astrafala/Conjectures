...
\title{The empirical recurrence for OEIS A228663, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A228663 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A228663 is ``Number of 4 X n binary arrays with top left value 1 and no two ones adjacent horizontally, diagonally or antidiagonally.''. It has offset $1$ and begins
\[
8, 12, 140, 416, 2844, 11148, 62368, 275708,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) + 16*a(n-2) - 7*a(n-3) - 18*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 12 2018 07:52:05, revision 11) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 16\,a(n-2) - 7\,a(n-3) - 18\,a(n-4)
\end{equation}
for all $n>5$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A228663.
