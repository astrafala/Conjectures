...
\title{The empirical recurrence for OEIS A297901, proved by transfer matrix}
...
\begin{abstract}
OEIS A297901 counts $2$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A297901 is ``Number of n X 2 0..1 arrays with every element equal to 0, 1, 3 or 4 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
2, 4, 3, 13, 34, 73, 203, 594,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) + 3*a(n-2) + 8*a(n-3) - 4*a(n-4) - 16*a(n-5) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 19 2018 14:13:38, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297901.
