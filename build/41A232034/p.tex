...
\title{The empirical recurrence for OEIS A232034, proved by transfer matrix}
...
\begin{abstract}
OEIS A232034 counts arrays of width $5$ over $\{0,\dots,1\}$ under a condition on each cell
and its neighbours, and carries an empirical recurrence of order $42$ contributed by
...
OEIS A232034 is ``Number of (n+1)X(4+1) 0..1 arrays with every element equal to some horizontal, vertical or antidiagonal neighbor, with top left element zero.''. It has offset $1$ and begins
\[
129, 3588, 94102, 2504637, 66684606, 1775039591, 47248648693, 1257683786423,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 06:49:12, revision 6) this is still
...
$129$, which the model reproduces along with every later term. That is the cheapest check
...
\begin{theorem}
\[
a(n)\;=\;32\,a(n-1) - 138\,a(n-2) - 165\,a(n-3) + 563\,a(n-4) + 2682\,a(n-5) + 7428\,a(n-6) - 27648\,a(n-7) - 100344\,a(n-8) + 94130\,a(n-9) + 491247\,a(n-10) + 558328\,a(n-11) - 1286279\,a(n-12) - 6473911\,a(n-13) + 2965412\,a(n-14) + 25955669\,a(n-15) - 9660799\,a(n-16) - 54343553\,a(n-17) + 25842884\,a(n-18) + 64348242\,a(n-19) - 39312301\,a(n-20) - 46252895\,a(n-21) + 31690610\,a(n-22) + 21351199\,a(n-23) - 12373011\,a(n-24) - 4807549\,a(n-25) + 320723\,a(n-26) + 265278\,a(n-27) + 1796613\,a(n-28) + 752174\,a(n-29) - 362336\,a(n-30) - 284497\,a(n-31) - 234154\,a(n-32) + 51576\,a(n-33) + 4242\,a(n-34) + 33653\,a(n-35) - 3592\,a(n-36) - 90\,a(n-37) - 138\,a(n-38) - 123\,a(n-39) + 25\,a(n-40) - 36\,a(n-41) + 2\,a(n-42)
\]
for every $n>44$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232034.
