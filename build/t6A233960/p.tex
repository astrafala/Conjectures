...
\title{The empirical recurrence for OEIS A233960, proved by transfer matrix}
...
\begin{abstract}
OEIS A233960 counts $(n+1)\times2$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A233960 is ``Number of (n+1) X (1+1) 0..3 arrays with every 2 X 2 subblock having the sum of the absolute values of all six edge and diagonal differences equal to 10.''. It has offset $1$ and begins
\[
48, 188, 728, 3016, 12416, 52880, 224288, 966496,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 4*a(n-1) + 10*a(n-2) - 36*a(n-3) - 8*a(n-4) + 16*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 12 2018 09:44:53, revision 7) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A233960.
