...
\title{The empirical recurrence for OEIS A233897, proved by transfer matrix}
...
\begin{abstract}
OEIS A233897 counts $(n+1)\times2$ arrays over $\{0,\dots,6\}$ subject to a condition imposed on
...
OEIS A233897 is ``Number of (n+1) X (1+1) 0..6 arrays with every 2 X 2 subblock having the sum of the squares of all six edge and diagonal differences equal to 35.''. It has offset $1$ and begins
\[
144, 656, 2688, 12288, 51200, 233984, 987136, 4503552,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 44*a(n-2) - 608*a(n-4) + 2560*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 12 2018 08:29:28, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;44\,a(n-2) - 608\,a(n-4) + 2560\,a(n-6)
\end{equation}
for all $n>6$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A233897.
