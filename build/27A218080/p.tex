...
\title{The empirical recurrence for OEIS A218080, proved by transfer matrix}
...
\begin{abstract}
OEIS A218080 counts the distinct arrays obtained by applying a fixed local operation to every cell
...
$S=58$ states, after which the conjectured recurrence is settled by a finite exact
computation.
\end{abstract}
...
OEIS A218080 is ``Number of nX4 arrays of the minimum value of corresponding elements and their horizontal, vertical or antidiagonal neighbors in a random 0..1 nX4 array.''. It has offset $1$ and begins
\[
6, 18, 78, 342, 1508, 6606, 29136, 128220,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 17:33:51, revision 8) this is still
...
\]
There are $S=58$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite.
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + 9\,a(n-2) - 4\,a(n-3) - 37\,a(n-4) - 13\,a(n-5) + 48\,a(n-6) + 39\,a(n-7) - 25\,a(n-8) - 18\,a(n-9) - 6\,a(n-10) - 3\,a(n-11) - 5\,a(n-12) + 4\,a(n-13)
\]
for every $n>13$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A218080.
