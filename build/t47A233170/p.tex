...
carried by one bounded piece of extra state, so the count is a walk count on $S=806$ states.
\end{abstract}
...
and every first appearance it contains. There are $S=806$ reachable states.
