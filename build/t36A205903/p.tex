...
\title{The empirical recurrence for OEIS A205903, proved by transfer matrix}
...
\begin{abstract}
OEIS A205903 counts arrays over $\{0,\dots,2\}$ under a condition on the number of clockwise edge increases
...
a bounded window of consecutive rows, so the count is a walk count on $S=54$ states and is
...
OEIS A205903 is ``Number of (n+1)X3 0..2 arrays with the number of clockwise edge increases in every 2X2 subblock the same.''. It has offset $1$ and begins
\[
369, 2943, 24045, 201324, 1712907, 14747754, 128014116, 1117395426,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 12:19:23, revision 9) this is still
...
\]
on the $S=54$ states that survive. Rows carrying no edge at all are dropped: such a row could
...
\begin{theorem}
\[
a(n)\;=\;17\,a(n-1) - 86\,a(n-2) + 117\,a(n-3) + 90\,a(n-4) - 446\,a(n-5) + 619\,a(n-6) - 476\,a(n-7) + 234\,a(n-8) - 92\,a(n-9) + 24\,a(n-10)
\]
for every $n>11$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A205903.
