...
\title{The empirical recurrence for OEIS A253449, proved by transfer matrix}
...
\begin{abstract}
OEIS A253449 counts the arrays over $\{0,\dots,2\}$ whose $2\times2$ subblocks carry a
...
OEIS A253449 is ``Number of (n+1) X (1+1) 0..2 arrays with every 2 X 2 subblock diagonal minus antidiagonal sum nondecreasing horizontally and vertically.''. It has offset $1$ and begins
\[
81, 414, 1388, 3639, 8501, 19701, 48293, 126357,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 6*a(n-1) -11*a(n-2) +6*a(n-3) for n>10.
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 20 2018 11:20:36, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253449.
