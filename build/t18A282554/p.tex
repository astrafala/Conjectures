...
\title{The empirical recurrence for OEIS A282554, proved by transfer matrix}
...
\begin{abstract}
OEIS A282554 counts $n\times2$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
walk, and $a(n)$ is a walk count on $S=40$ vertices, which is $C$-finite. Whether the
...
OEIS A282554 is ``Number of nX2 0..1 arrays with no 1 equal to more than two of its king-move neighbors, with the exception of exactly one element.''. It has offset $1$ and begins
\[
0, 0, 10, 36, 154, 652, 2472, 9356,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 6*a(n-1) -7*a(n-2) -2*a(n-3) -29*a(n-4) +44*a(n-5) +12*a(n-6) +32*a(n-7) -64*a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 28 2017 04:08:58, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) - 7\,a(n-2) - 2\,a(n-3) - 29\,a(n-4) + 44\,a(n-5) + 12\,a(n-6) + 32\,a(n-7) - 64\,a(n-8)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A282554.
