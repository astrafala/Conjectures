...
\title{The empirical recurrence for OEIS A251197, proved by transfer matrix}
...
\begin{abstract}
OEIS A251197 counts $(n+1)\times5$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A251197 is ``Number of (n+1) X (4+1) 0..1 arrays with no 2 X 2 subblock having the minimum of its diagonal elements less than the absolute difference of its antidiagonal elements.''. It has offset $1$ and begins
\[
164, 1135, 8976, 73170, 599869, 4923412, 40413851, 331748759,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 22 2022 14:41:27, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 48\,a(n-2) + 59\,a(n-3) - 261\,a(n-4) - 268\,a(n-5) + 610\,a(n-6) + 222\,a(n-7) - 781\,a(n-8) + 127\,a(n-9) + 107\,a(n-10) + 25\,a(n-11) - 11\,a(n-12) - 5\,a(n-13) + a(n-14)
\end{equation}
for all $n>16$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251197.
