...
\title{The empirical recurrence for OEIS A317810, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A317810 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A317810 is ``Number of nX3 0..1 arrays with every element unequal to 0, 2 or 3 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
1, 2, 2, 4, 5, 8, 9, 28,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 07 2018 21:56:54, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) - a(n-2) + 2\,a(n-3) + 2\,a(n-4) - 8\,a(n-5) + 5\,a(n-6) - 8\,a(n-7) + 9\,a(n-8) - 4\,a(n-9) + 7\,a(n-10) + 2\,a(n-11) - 4\,a(n-12) - 2\,a(n-13) - 4\,a(n-14) + 2\,a(n-15) - a(n-16) + 2\,a(n-17)
\end{equation}
for all $n>19$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A317810.
