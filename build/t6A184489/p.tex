...
\title{The empirical recurrence for OEIS A184489, proved by transfer matrix}
...
\begin{abstract}
OEIS A184489 counts $(n+1)\times2$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A184489 is ``Number of (n+1) X 2 0..2 arrays with every 2 X 2 subblock sum greater than 4.''. It has offset $1$ and begins
\[
31, 165, 792, 3971, 19593, 97312, 482071, 2390621,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) + 11*a(n-2) - 4*a(n-3) - 12*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 12 2018 22:24:28, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 11\,a(n-2) - 4\,a(n-3) - 12\,a(n-4)
\end{equation}
for all $n>4$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A184489.
