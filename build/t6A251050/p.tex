...
\title{The empirical recurrence for OEIS A251050, proved by transfer matrix}
...
\begin{abstract}
OEIS A251050 counts $(n+1)\times4$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A251050 is ``Number of (n+1) X (3+1) 0..3 arrays with no 2 X 2 subblock having the sum of its diagonal elements greater than the absolute difference of its antidiagonal elements.''. It has offset $1$ and begins
\[
854, 4334, 10289, 24893, 53306, 114512, 237143, 498593,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 8*a(n-1) - 25*a(n-2) + 35*a(n-3) - 7*a(n-4) - 49*a(n-5) + 77*a(n-6) - 55*a(n-7) + 20*a(n-8) - 3*a(n-9) for n>12.
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 24 2018 08:13:13, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251050.
