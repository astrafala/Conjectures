...
\title{The empirical recurrence for OEIS A318032, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A318032 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A318032 is ``Number of nX3 0..1 arrays with every element unequal to 0, 1, 3 or 4 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
3, 6, 9, 25, 58, 152, 368, 904,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 13 2018 14:21:56, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) - 9\,a(n-2) + 7\,a(n-3) + 6\,a(n-4) - 27\,a(n-5) + 37\,a(n-6) - 22\,a(n-7) - 23\,a(n-8) + 31\,a(n-9) + 9\,a(n-10) - 29\,a(n-11) + 48\,a(n-12) - 27\,a(n-13) + 25\,a(n-14) - 8\,a(n-15) - 24\,a(n-16) + 28\,a(n-17) - 60\,a(n-18) + 60\,a(n-19) - 63\,a(n-20) + 49\,a(n-21) - 39\,a(n-22) + 25\,a(n-23) - 13\,a(n-24) + 4\,a(n-25) + 2\,a(n-26) - 3\,a(n-27) + 4\,a(n-28) - a(n-29) + a(n-30)
\end{equation}
for all $n>33$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A318032.
