...
\title{The empirical recurrence for OEIS A233127, proved by transfer matrix}
...
\begin{abstract}
OEIS A233127 counts arrays over $\{0,\dots,5\}$ in which no two entries that are neighbours in
...
carried by one bounded piece of extra state, so the count is a walk count on $S=10242$ states.
\end{abstract}
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 08:51:02, revision 6) this is still
...
and every first appearance it contains. There are $S=10242$ reachable states.
...
\begin{theorem}
\[
a(n)\;=\;1984\,a(n-1) - 1314816\,a(n-2) + 411303936\,a(n-3) - 70111985664\,a(n-4) + 6893422510080\,a(n-5) - 389708152569856\,a(n-6) + 11733988091625472\,a(n-7) - 145241087982698496\,a(n-8)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A233127.
