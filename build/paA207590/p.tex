...
\title{The empirical recurrence for OEIS A207590, proved by transfer matrix}
...
\begin{abstract}
OEIS A207590 counts arrays over $\{0,\dots,1\}$ of width $3$ that avoid the patterns
$(0,0,1), (1,1,1)$ along one axis and $(0,0,0), (0,0,1)$ along the other, and carries an empirical recurrence of
...
OEIS A207590 is ``Number of 3 X n 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 0 1 and 1 1 1 vertically.''. It has offset
$1$ and begins
\[
6, 36, 60, 144, 324, 756, 1728,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) + 3*a(n-2) for n>4.
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 05 2018 10:00:21, revision
...
a(n)\;=\;a(n-1) + 3\,a(n-2)
\end{equation}
for all $n>2$. The entry's array has a fixed number of rows and a growing number of
...
index corresponding to $n=2+1$ onwards, and the run was continued past $S$ consecutive
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207590.
