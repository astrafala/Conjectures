...
\title{The empirical recurrence for OEIS A282333, proved by transfer matrix}
...
\begin{abstract}
OEIS A282333 counts $n\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A282333 is ``Number of nX3 0..1 arrays with no 1 equal to more than four of its king-move neighbors, with the exception of exactly one element.''. It has offset $1$ and begins
\[
0, 0, 68, 648, 5794, 50800, 425030, 3471260,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 13 2017 11:12:16, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;10\,a(n-1) - 3\,a(n-2) - 48\,a(n-3) - 479\,a(n-4) - 572\,a(n-5) + a(n-6) + 4040\,a(n-7) + 5796\,a(n-8) + 2406\,a(n-9) - 13483\,a(n-10) - 20500\,a(n-11) - 10306\,a(n-12) + 19360\,a(n-13) + 30323\,a(n-14) + 16440\,a(n-15) - 8764\,a(n-16) - 15640\,a(n-17) - 9508\,a(n-18) - 2064\,a(n-19) - 144\,a(n-20)
\]
for every $n>20$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A282333.
