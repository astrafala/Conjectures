...
\title{The empirical recurrence for OEIS A318339, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A318339 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A318339 is ``Number of nX4 0..1 arrays with every element unequal to 0, 1, 2 or 6 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
8, 20, 36, 67, 148, 343, 817, 1975,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +4*a(n-2) +a(n-3) -5*a(n-4) -2*a(n-5) +2*a(n-6) +a(n-7) -a(n-8) for n>9
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 24 2018 11:02:18, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 4\,a(n-2) + a(n-3) - 5\,a(n-4) - 2\,a(n-5) + 2\,a(n-6) + a(n-7) - a(n-8)
\end{equation}
for all $n>9$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A318339.
