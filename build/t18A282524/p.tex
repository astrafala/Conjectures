...
\title{The empirical recurrence for OEIS A282524, proved by transfer matrix}
...
\begin{abstract}
OEIS A282524 counts $n\times4$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A282524 is ``Number of nX4 0..1 arrays with no 1 equal to more than two of its king-move neighbors.''. It has offset $1$ and begins
\[
16, 144, 1097, 10041, 86258, 747184, 6509805, 56491269,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 17 2017 10:17:03, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-1) + 16\,a(n-2) + 17\,a(n-3) - 256\,a(n-4) + 62\,a(n-5) + 45\,a(n-6) - 162\,a(n-7) + 19\,a(n-8) - 123\,a(n-9) + 8\,a(n-10) + 29\,a(n-11) + 2\,a(n-12) + 2\,a(n-13) - a(n-14)
\]
for every $n>14$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A282524.
