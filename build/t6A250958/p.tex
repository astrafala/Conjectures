...
\title{The empirical recurrence for OEIS A250958, proved by transfer matrix}
...
\begin{abstract}
OEIS A250958 counts $(n+1)\times2$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A250958 is ``Number of (n+1) X (1+1) 0..3 arrays with no 2 X 2 subblock having its minimum diagonal element less than its minimum antidiagonal element.''. It has offset $1$ and begins
\[
170, 1592, 14423, 130025, 1172956, 10588744, 95612685, 863389506,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 16*a(n-1) - 86*a(n-2) + 248*a(n-3) - 397*a(n-4) + 361*a(n-5) - 168*a(n-6) + 36*a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 24 2018 08:11:39, revision 11) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;16\,a(n-1) - 86\,a(n-2) + 248\,a(n-3) - 397\,a(n-4) + 361\,a(n-5) - 168\,a(n-6) + 36\,a(n-7)
\end{equation}
for all $n>6$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250958.
