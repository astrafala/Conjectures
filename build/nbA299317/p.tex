...
\title{The empirical recurrence for OEIS A299317, proved by transfer matrix}
...
\begin{abstract}
OEIS A299317 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $equal to$ itself lying in $\{0,3,4,5,6,7\}$, and it carries an empirical
...
OEIS A299317 is ``Number of nX4 0..1 arrays with every element equal to 0, 3, 4, 5, 6 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 2, 10, 12, 130, 284, 1557, 5838,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 06 2018 13:46:34, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 15\,a(n-2) - 12\,a(n-3) - 117\,a(n-4) - 82\,a(n-5) + 220\,a(n-6) + 455\,a(n-7) + 187\,a(n-8) - 278\,a(n-9) - 592\,a(n-10) - 695\,a(n-11) - 353\,a(n-12) + 604\,a(n-13) + 404\,a(n-14) - 92\,a(n-15) + 874\,a(n-16) + 845\,a(n-17) - 523\,a(n-18) - 728\,a(n-19) - 234\,a(n-20) - 26\,a(n-21) + 90\,a(n-22) + 42\,a(n-23) - 39\,a(n-24) + 15\,a(n-25) + 40\,a(n-26) + 4\,a(n-27) - 8\,a(n-28) - 2\,a(n-29)
\end{equation}
for all $n>29$.
...
has score in $\{0,3,4,5,6,7\}$. The entry also fixes the top-left entry to be $0$; that is a condition on the first row alone, so it restricts the start vector and nothing else.
...
\begin{itemize}
\item $\mathbf{s}(r,s)=1$ when every cell of $r$ has score in $\{0,3,4,5,6,7\}$ \emph{with no row
above $r$} and $r_1=0$, and $0$ otherwise;
\item an edge $(r,s)\to(s,t)$ when every cell of $s$ has score in $\{0,3,4,5,6,7\}$ computed from
$r$, $s$ and $t$;
\item $\mathbf{e}(r,s)=1$ when every cell of $s$ has score in $\{0,3,4,5,6,7\}$ \emph{with no row
...
exactly when every one of its $n$ rows has all scores in $\{0,3,4,5,6,7\}$. Read the sequence as the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A299317.
