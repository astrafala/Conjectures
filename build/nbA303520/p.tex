...
\title{The empirical recurrence for OEIS A303520, proved by transfer matrix}
...
\begin{abstract}
OEIS A303520 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A303520 is ``Number of nX3 0..1 arrays with every element equal to 0, 1, 3, 4, 5 or 6 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
3, 11, 18, 39, 95, 246, 687, 2023,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 25 2018 12:37:35, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) - 3\,a(n-2) + 10\,a(n-3) - 22\,a(n-4) + 6\,a(n-5) - 31\,a(n-6) + 10\,a(n-7) - 3\,a(n-8) - 14\,a(n-9) - 8\,a(n-10) - 32\,a(n-11) - 16\,a(n-12)
\end{equation}
for all $n>14$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A303520.
