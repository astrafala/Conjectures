...
\title{The empirical recurrence for OEIS A269762, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A269762 counts arrays over $\{0,\dots,5\}$ subject to a condition on the array as a
...
which is what keeps the digraph sparse. That makes $a(n)$ a walk count on $S=432$ vertices,
...
OEIS A269762 is ``Number of n X 3 0..5 arrays with some element plus some horizontally or vertically adjacent neighbor totalling five exactly once.''. It has offset $1$ and begins
\[
60, 17520, 2624640, 326697720, 37212131520, 4022791852800, 420141188848320, 42818890099881480,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 184*a(n-1) - 9134*a(n-2) + 61640*a(n-3) - 112225*a(n-4) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 28 2019 14:01:41, revision 8) the statement is
...
\[
\mathcal V=\bigl\{(r,c):\ r\in\{0,\dots,5\}^{3},\ c\in\{0,1\}\bigr\},
\qquad |\mathcal V|=S=432,
\]
...
the digraph dense, with $(5+1)^{2\cdot3}$ edges instead of the sparse set used here.
\end{remark}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269762.
