...
\title{The empirical recurrence for OEIS A299092, proved by transfer matrix}
...
\begin{abstract}
OEIS A299092 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $equal to$ itself lying in $\{0,1,2,4,5,7\}$, and it carries an empirical
...
OEIS A299092 is ``Number of nX3 0..1 arrays with every element equal to 0, 1, 2, 4, 5 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
4, 13, 20, 41, 101, 242, 578, 1385,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 02 2018 08:19:19, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) - 3\,a(n-2) + 4\,a(n-3) - 23\,a(n-4) + 18\,a(n-5) - 8\,a(n-6) + 47\,a(n-7) - 29\,a(n-8) + 26\,a(n-9) - 66\,a(n-10) + 17\,a(n-11) - 29\,a(n-12) + 46\,a(n-13) - 3\,a(n-14) + 18\,a(n-15) - 18\,a(n-16)
\end{equation}
for all $n>16$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A299092.
