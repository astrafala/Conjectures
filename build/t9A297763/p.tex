...
\title{The empirical recurrence for OEIS A297763, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297763 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A297763 is ``Number of 2Xn 0..1 arrays with every 1 horizontally, diagonally or antidiagonally adjacent to 2, 3 or 4 neighboring 1s.''. It has offset $1$ and begins
\[
1, 2, 12, 31, 78, 225, 733, 2305,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 4*a(n-1) -3*a(n-2) +a(n-3) +6*a(n-4) -18*a(n-5)
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 05 2018 19:01:19, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) - 3\,a(n-2) + a(n-3) + 6\,a(n-4) - 18\,a(n-5)
\end{equation}
for all $n>6$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297763.
