...
\title{The empirical recurrence for OEIS A251243, proved by transfer matrix}
...
\begin{abstract}
OEIS A251243 counts $(n+1)\times3$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A251243 is ``Number of (n+1) X (2+1) 0..2 arrays with no 2 X 2 subblock having the sum of its diagonal elements less than the minimum of its antidiagonal elements.''. It has offset $1$ and begins
\[
621, 14265, 327753, 7530633, 173028393, 3975606801, 91345992921, 2098821870081,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 27*a(n-1) - 94*a(n-2) + 36*a(n-3) - 4*a(n-4) - 36*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 27 2018 09:01:37, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;27\,a(n-1) - 94\,a(n-2) + 36\,a(n-3) - 4\,a(n-4) - 36\,a(n-5)
\end{equation}
for all $n>4$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251243.
