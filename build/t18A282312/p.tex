...
\title{The empirical recurrence for OEIS A282312, proved by transfer matrix}
...
\begin{abstract}
OEIS A282312 counts $n\times4$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A282312 is ``Number of nX4 0..1 arrays with no 1 equal to more than four of its king-move neighbors.''. It has offset $1$ and begins
\[
16, 249, 2968, 40024, 535494, 7114808, 94872444, 1264480188,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 11 2017 11:25:21, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;9\,a(n-1) + 43\,a(n-2) + 233\,a(n-3) - 369\,a(n-4) - 1432\,a(n-5) - 4530\,a(n-6) + 2472\,a(n-7) + 11204\,a(n-8) + 21774\,a(n-9) - 142\,a(n-10) - 13268\,a(n-11) - 20778\,a(n-12) - 1758\,a(n-13) + 3980\,a(n-14) + 5134\,a(n-15) + 500\,a(n-16) + 68\,a(n-17) + 72\,a(n-18)
\]
for every $n>18$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A282312.
