...
\title{The empirical recurrence for OEIS A233125, proved by transfer matrix}
...
\begin{abstract}
OEIS A233125 counts arrays over $\{0,\dots,5\}$ in which no two entries that are neighbours in
...
carried by one bounded piece of extra state, so the count is a walk count on $S=826$ states.
\end{abstract}
...
and every first appearance it contains. There are $S=826$ reachable states.
...
\begin{theorem}
\[
a(n)\;=\;160\,a(n-1) - 6144\,a(n-2) + 86016\,a(n-3) - 393216\,a(n-4)
\]
for every $n>4$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A233125.
