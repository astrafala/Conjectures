...
\title{The empirical recurrence for OEIS A251285, proved by transfer matrix}
...
\begin{abstract}
OEIS A251285 counts $(n+1)\times2$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A251285 is ``Number of (n+1) X (1+1) 0..1 arrays with every 2 X 2 subblock having a single 1 or two 1s on the same edge or main diagonally.''. It has offset $1$ and begins
\[
9, 22, 52, 125, 297, 710, 1691, 4036,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) + 2*a(n-2) - 3*a(n-3) + a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 28 2018 08:03:52, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251285.
