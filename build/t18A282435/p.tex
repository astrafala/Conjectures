...
\title{The empirical recurrence for OEIS A282435, proved by transfer matrix}
...
\begin{abstract}
OEIS A282435 counts $n\times2$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A282435 is ``Number of nX2 0..1 arrays with no 1 equal to more than three of its king-move neighbors, with the exception of exactly one element.''. It has offset $1$ and begins
\[
0, 0, 2, 12, 58, 280, 1276, 5592,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 15 2017 10:16:09, revision 5) this is still
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) - 7\,a(n-2) + 8\,a(n-3) - 47\,a(n-4) - 2\,a(n-5) - 53\,a(n-6) + 52\,a(n-7) + 4\,a(n-8) + 56\,a(n-9) - 16\,a(n-10) - 16\,a(n-12)
\]
for every $n>12$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A282435.
