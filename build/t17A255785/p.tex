...
\title{The empirical recurrence for OEIS A255785, proved by transfer matrix}
...
\begin{abstract}
OEIS A255785 counts $(n+2)\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A255785 is ``Number of (n+2) X (1+2) 0..1 arrays with no 3 x 3 subblock diagonal sum 2 and no antidiagonal sum 2 and no row sum 0 and no column sum 0.''. It has offset $1$ and begins
\[
90, 177, 361, 715, 1478, 2969, 6186, 12534,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 19 2018 09:04:17, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 5\,a(n-2) - 2\,a(n-3) - 6\,a(n-4) - 7\,a(n-5) + 6\,a(n-6) + 3\,a(n-7) - 6\,a(n-8) + 5\,a(n-9) + 5\,a(n-10) + 5\,a(n-11) + 2\,a(n-12)
\]
for every $n>12$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A255785.
