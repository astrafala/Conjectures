...
\title{The empirical recurrence for OEIS A208371, proved by transfer matrix}
...
\begin{abstract}
OEIS A208371 counts arrays over $\{0,\dots,1\}$ of width $5$ that avoid the patterns
$(0,0,1), (0,1,0)$ along one axis and $(0,0,0), (0,0,1)$ along the other, and carries an empirical recurrence of
order $12$ contributed by R.~H.~Hardin. It is true. The patterns have length $3$, so
...
$\mathbf{1}^{\!\top}P^{\,n-2-12}q(P)\mathbf{1}$, which vanishes identically
...
OEIS A208371 is ``Number of 5Xn 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 0 1 and 0 1 0 vertically.''. It has offset
$1$ and begins
\[
14, 196, 1162, 9338, 67396, 507682, 3759574,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:47:51, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 41\,a(n-2) + 78\,a(n-3) - 153\,a(n-4) - 363\,a(n-5) + 253\,a(n-6) + 566\,a(n-7) - 276\,a(n-8) - 324\,a(n-9) + 165\,a(n-10) + 29\,a(n-11) - 15\,a(n-12)
\end{equation}
for all $n>11$. The entry's array has a fixed number of rows and a growing number of
...
$a(n)-\sum_i c_i a(n-i)=u_{\,n-2-12}$ whenever $n-12\ge2$. Hence
\eqref{eq:conj} holds for every $n>t$ exactly when $u_j=0$ for every
$j>t-2-12$. Moreover $(u_j)$ satisfies the monic linear recurrence whose
...
$P^{\,n-2-12}$ gives the identity. The equivalence follows by letting the exponent
...
\begin{proof}
The vector $q(P)\mathbf{1}\in\mathbb{Z}^{S}$ was formed by $12$ matrix--vector
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208371.
