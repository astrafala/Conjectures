...
\title{The empirical recurrence for OEIS A207748, proved by transfer matrix}
...
\begin{abstract}
OEIS A207748 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
...
OEIS A207748 is ``Number of nX4 0..1 arrays avoiding 0 0 1 and 0 1 1 horizontally and 0 0 1 and 1 0 0 vertically.''. It has offset
$1$ and begins
\[
9, 81, 289, 900, 3249, 11449, 42436,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:15:22, revision
...
$(0,0,1), (0,1,1)$ as $3$ consecutive entries. There are $9$ admissible rows; that condition
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207748.
