...
\title{The empirical recurrence for OEIS A234202, proved by transfer matrix}
...
\begin{abstract}
OEIS A234202 counts $(n+1)\times3$ arrays over $\{0,\dots,5\}$ subject to a condition imposed on
every $2\times2$ subblock, and carries an empirical recurrence of order $35$ contributed
...
OEIS A234202 is ``Number of (n+1) X (2+1) 0..5 arrays with every 2 X 2 subblock having the sum of the absolute values of all six edge and diagonal differences equal to 15.''. It has offset $1$ and begins
\[
440, 1732, 6644, 28016, 115680, 509536, 2169836, 9814536,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 11 2022 13:10:22, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;10\,a(n-1) + 35\,a(n-2) - 651\,a(n-3) + 419\,a(n-4) + 16705\,a(n-5) - 37770\,a(n-6) - 216562\,a(n-7) + 772034\,a(n-8) + 1449450\,a(n-9) - 8226531\,a(n-10) - 3432396\,a(n-11) + 53203704\,a(n-12) - 19299470\,a(n-13) - 221565837\,a(n-14) + 197415839\,a(n-15) + 605551158\,a(n-16) - 820429189\,a(n-17) - 1065993213\,a(n-18) + 2055641766\,a(n-19) + 1094316298\,a(n-20) - 3372056546\,a(n-21) - 351098112\,a(n-22) + 3691267180\,a(n-23) - 636122040\,a(n-24) - 2662114168\,a(n-25) + 998183888\,a(n-26) + 1207919856\,a(n-27) - 667852864\,a(n-28) - 308559296\,a(n-29) + 239536384\,a(n-30) + 30592768\,a(n-31) - 43737088\,a(n-32) + 2252800\,a(n-33) + 3080192\,a(n-34) - 458752\,a(n-35)
\end{equation}
for all $n>35$.
...
|\beta-\alpha|+|\delta-\beta|+|\gamma-\delta|+|\alpha-\gamma|+|\delta-\alpha|+|\gamma-\beta|\;=\;15,
\end{equation}
...
For every $n$ with $n+1-1\ge35$,
\[
a(n)-\sum_i c_i\,a(n-i)\;=\;\mathbf{1}^{\!\top}M^{\,n+1-1-35}\,q(M)\,\mathbf{1} .
\]
...
=\mathbf{1}^{\!\top}M^{\,m-35}\,q(M)\,\mathbf{1}
\]
...
$m-35=j$ run over $\ge0$. For the last clause put $w=q(M)\mathbf{1}$. By the
...
$S^2$ pairs. The vector $w=q(M)\mathbf{1}\in\mathbb{Z}^{S}$ was then formed by $35$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234202.
