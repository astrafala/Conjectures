...
\title{The empirical recurrence for OEIS A233109, proved by transfer matrix}
...
\begin{abstract}
OEIS A233109 counts arrays over $\{0,\dots,5\}$ in which no two entries that are neighbours in
...
carried by one bounded piece of extra state, so the count is a walk count on $S=1832$ states.
\end{abstract}
...
OEIS A233109 is ``Number of nX4 0..5 arrays with no element x(i,j) adjacent to value 5-x(i,j) horizontally or vertically, top left element zero, and 1 appearing before 2 3 and 4, and 2 appearing before 3 in row major order.''. It has offset $1$ and begins
\[
23, 6046, 2154065, 794723482, 294285758398, 109015274761891, 40385221182281560, 14960955484170769147,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 07:53:14, revision 6) this is still
...
and every first appearance it contains. There are $S=1832$ reachable states.
...
\begin{theorem}
\[
a(n)\;=\;445\,a(n-1) - 29415\,a(n-2) + 684239\,a(n-3) - 6544703\,a(n-4) + 26009211\,a(n-5) - 37153497\,a(n-6) + 17033721\,a(n-7)
\]
for every $n>7$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A233109.
