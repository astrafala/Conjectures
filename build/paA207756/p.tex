...
\title{The empirical recurrence for OEIS A207756, proved by transfer matrix}
...
\begin{abstract}
OEIS A207756 counts arrays over $\{0,\dots,1\}$ of width $7$ that avoid the patterns
...
OEIS A207756 is ``Number of 7Xn 0..1 arrays avoiding 0 0 1 and 0 1 1 horizontally and 0 0 1 and 1 0 0 vertically.''. It has offset
$1$ and begins
\[
35, 1225, 7210, 42436, 147084, 509796, 1341606,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:16:14, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207756.
