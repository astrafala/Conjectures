...
\title{The empirical recurrence for OEIS A302305, proved by transfer matrix}
...
\begin{abstract}
OEIS A302305 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A302305 is ``Number of nX4 0..1 arrays with every element equal to 0, 1, 3 or 4 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
5, 21, 26, 66, 153, 380, 1090, 3120,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 05 2018 09:35:41, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302305.
