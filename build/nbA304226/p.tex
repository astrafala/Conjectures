...
\title{The empirical recurrence for OEIS A304226, proved by transfer matrix}
...
\begin{abstract}
OEIS A304226 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A304226 is ``Number of nX4 0..1 arrays with every element unequal to 0, 1, 2 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
8, 5, 6, 11, 20, 46, 97, 189,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +5*a(n-3) -4*a(n-6) for n>8
\end{quote}
As of the ``Last modified'' line on the live entry (May 08 2018 11:04:26, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 5\,a(n-3) - 4\,a(n-6)
\end{equation}
for all $n>7$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A304226.
