...
\title{The empirical recurrence for OEIS A207170, proved by transfer matrix}
...
\begin{abstract}
OEIS A207170 counts arrays over $\{0,\dots,1\}$ of width $2$ that avoid the patterns
...
on $S=16$ vertices, and $a(n)=\mathbf{1}^{\!\top}P^{\,n-2}\mathbf{1}$. Writing $q$
...
OEIS A207170 is ``Number of 2 X n 0..1 arrays avoiding 0 0 0 and 1 0 1 horizontally and 0 0 1 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
4, 16, 36, 81, 169, 361, 784,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +a(n-2) +3*a(n-3) +a(n-4) -a(n-5) -a(n-6) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 26 2025 11:22:17, revision
...
$(0,0,1), (1,0,1)$ as $3$ consecutive entries. There are $4$ admissible columns; that condition
...
columns, so $S=16$, and declare $w\to w'$ an edge when $w'$ is $w$ with its first entry
...
values agree exactly, including the initial count of $4$ admissible columns. That is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207170.
