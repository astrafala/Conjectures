...
\title{The empirical recurrence for OEIS A228662, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A228662 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A228662 is ``Number of 3 X n binary arrays with top left value 1 and no two ones adjacent horizontally, diagonally or antidiagonally.''. It has offset $1$ and begins
\[
4, 5, 34, 78, 335, 968, 3556, 11245,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) + 6*a(n-2) - 5*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 12 2018 09:08:18, revision 11) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 6\,a(n-2) - 5\,a(n-3)
\end{equation}
for all $n>4$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A228662.
