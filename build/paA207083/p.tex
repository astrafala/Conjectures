...
\title{The empirical recurrence for OEIS A207083, proved by transfer matrix}
...
\begin{abstract}
OEIS A207083 counts arrays over $\{0,\dots,1\}$ of width $3$ that avoid the patterns
...
OEIS A207083 is ``Number of n X 3 0..1 arrays avoiding 0 0 0 horizontally and 0 0 1 vertically.''. It has offset
$1$ and begins
\[
7, 49, 241, 1117, 4891, 20953, 88465,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 6*a(n-1) - 5*a(n-2) - 14*a(n-3) + 11*a(n-4) + 4*a(n-5) - a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 18 2018 14:09:33, revision
8) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) - 5\,a(n-2) - 14\,a(n-3) + 11\,a(n-4) + 4\,a(n-5) - a(n-6)
\end{equation}
for all $n>5$. 
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207083.
