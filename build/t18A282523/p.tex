...
\title{The empirical recurrence for OEIS A282523, proved by transfer matrix}
...
\begin{abstract}
OEIS A282523 counts $n\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A282523 is ``Number of n X 3 0..1 arrays with no 1 equal to more than two of its king-move neighbors.''. It has offset $1$ and begins
\[
8, 43, 206, 1097, 5675, 29433, 153037, 794716,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 5*a(n-1) +2*a(n-2) -a(n-3) -24*a(n-4) +13*a(n-5) -2*a(n-7) +6*a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 23 2025 11:21:08, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) + 2\,a(n-2) - a(n-3) - 24\,a(n-4) + 13\,a(n-5) - 2\,a(n-7) + 6\,a(n-8)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A282523.
