...
\title{The empirical recurrence for OEIS A208699, proved by transfer matrix}
...
\begin{abstract}
OEIS A208699 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
...
OEIS A208699 is ``Number of 4Xn 0..1 arrays avoiding 0 0 1 and 1 0 0 horizontally and 0 1 0 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
10, 100, 358, 1309, 5524, 24086, 109599,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:58:56, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;10\,a(n-1) - 19\,a(n-2) - 92\,a(n-3) + 320\,a(n-4) + 223\,a(n-5) - 1644\,a(n-6) + 308\,a(n-7) + 3927\,a(n-8) - 2262\,a(n-9) - 4540\,a(n-10) + 3797\,a(n-11) + 2137\,a(n-12) - 2578\,a(n-13) - 60\,a(n-14) + 622\,a(n-15) - 128\,a(n-16) - 28\,a(n-17) + 8\,a(n-18)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208699.
