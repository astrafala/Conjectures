...
\title{The empirical recurrence for OEIS A316752, proved by transfer matrix}
...
\begin{abstract}
OEIS A316752 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A316752 is ``Number of nX3 0..1 arrays with every element unequal to 1, 2, 4, 6, 7 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 9, 15, 17, 79, 185, 315, 970,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 12 2018 11:42:59, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-2) + 12\,a(n-3) + 5\,a(n-4) - 23\,a(n-5) - 50\,a(n-6) - 25\,a(n-7) + 40\,a(n-8) + 70\,a(n-9) + 32\,a(n-10) - 25\,a(n-11) - 25\,a(n-12) - 5\,a(n-13) + 4\,a(n-14) - a(n-15) - 2\,a(n-16)
\end{equation}
for all $n>16$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A316752.
