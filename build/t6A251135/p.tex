...
\title{The empirical recurrence for OEIS A251135, proved by transfer matrix}
...
\begin{abstract}
OEIS A251135 counts $(n+1)\times7$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A251135 is ``Number of (n+1) X (6+1) 0..2 arrays with no 2 X 2 subblock having the sum of its diagonal elements greater than the maximum of its antidiagonal elements.''. It has offset $1$ and begins
\[
4699, 9786, 15830, 27738, 46023, 79226, 135959, 240780,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 6*a(n-1) - 13*a(n-2) + 10*a(n-3) + 5*a(n-4) - 14*a(n-5) + 9*a(n-6) - 2*a(n-7) for n>10.
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 26 2018 11:44:28, revision 10) the statement is
...
every one of the $25$ published indices; the values agree exactly. That is what ties
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251135.
