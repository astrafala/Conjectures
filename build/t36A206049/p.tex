...
\title{The empirical recurrence for OEIS A206049, proved by transfer matrix}
...
\begin{abstract}
OEIS A206049 counts arrays over $\{0,\dots,2\}$ under a condition on the number of clockwise edge increases
...
OEIS A206049 is ``Number of (n+1)X4 0..2 arrays with the number of clockwise edge increases in every 2X2 subblock equal to one.''. It has offset $1$ and begins
\[
1338, 20400, 295392, 4256868, 61165512, 878480541, 12614174310, 181122252378,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 12:24:30, revision 9) this is still
...
subblocks; the entry's first term is $1338$, which the model
...
\begin{theorem}
\[
a(n)\;=\;14\,a(n-1) + 50\,a(n-2) - 694\,a(n-3) + 231\,a(n-4) + 7859\,a(n-5) - 11033\,a(n-6) - 27843\,a(n-7) + 74031\,a(n-8) - 31227\,a(n-9) - 69492\,a(n-10) + 85038\,a(n-11) - 5841\,a(n-12) - 45285\,a(n-13) + 32933\,a(n-14) - 7422\,a(n-15) - 7010\,a(n-16) + 3796\,a(n-17) - 416\,a(n-18)
\]
for every $n>17$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206049.
