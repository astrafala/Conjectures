...
\title{The empirical recurrence for OEIS A253346, proved by transfer matrix}
...
\begin{abstract}
OEIS A253346 counts the arrays over $\{0,\dots,1\}$ whose $2\times2$ subblocks carry a
...
OEIS A253346 is ``Number of (n+1) X (4+1) 0..1 arrays with every 2 X 2 subblock diagonal maximum minus antidiagonal maximum nondecreasing horizontally, vertically and ne-to-sw antidiagonally.''. It has offset $1$ and begins
\[
335, 3160, 31156, 305872, 3013228, 29779356, 294392852, 2912660356,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 26 2023 11:48:32, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253346.
