...
\title{The empirical recurrence for OEIS A306161, proved by transfer matrix}
...
\begin{abstract}
OEIS A306161 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A306161 is ``Number of nX3 0..1 arrays with every element unequal to 0, 1, 2, 5, 6 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
4, 5, 17, 32, 77, 207, 523, 1304,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +2*a(n-2) +5*a(n-3) +2*a(n-4) -2*a(n-5) -8*a(n-6) -8*a(n-7) for n>10
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 23 2018 12:43:15, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 2\,a(n-2) + 5\,a(n-3) + 2\,a(n-4) - 2\,a(n-5) - 8\,a(n-6) - 8\,a(n-7)
\end{equation}
for all $n>9$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A306161.
