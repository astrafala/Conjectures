...
\title{The empirical recurrence for OEIS A298765, proved by transfer matrix}
...
\begin{abstract}
OEIS A298765 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A298765 is ``Number of nX3 0..1 arrays with every element equal to 1, 2, 3, 5 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 18, 57, 222, 808, 3124, 11807, 44846,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 26 2018 08:27:12, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) - 4\,a(n-2) - a(n-3) - 3\,a(n-4) - 12\,a(n-5) + 33\,a(n-6) - 17\,a(n-7) + 3\,a(n-8) - 81\,a(n-9) - 4\,a(n-10) + 86\,a(n-11) + 127\,a(n-12) + 13\,a(n-13) - 95\,a(n-14) - 56\,a(n-15) + 8\,a(n-16) + 8\,a(n-17) - 16\,a(n-18) - 8\,a(n-19)
\end{equation}
for all $n>19$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A298765.
