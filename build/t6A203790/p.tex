...
\title{The empirical recurrence for OEIS A203790, proved by transfer matrix}
...
\begin{abstract}
OEIS A203790 counts $(n+1)\times3$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A203790 is ``Number of (n+1) X 3 0..3 arrays with every 2 X 2 subblock having equal diagonal elements or equal antidiagonal elements.''. It has offset $1$ and begins
\[
784, 10576, 142192, 1911952, 25708528, 345682576, 4648124656, 62499715984,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 13*a(n-1) +6*a(n-2).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 05 2018 08:19:03, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;13\,a(n-1) + 6\,a(n-2)
\end{equation}
for all $n>1$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A203790.
