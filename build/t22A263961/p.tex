...
\title{The empirical recurrence for OEIS A263961, proved by transfer matrix}
...
\begin{abstract}
OEIS A263961 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=4$ rows in which
...
OEIS A263961 is ``Number of (n+1)X(3+1) arrays of permutations of 0..n*4+3 with each element having index change (+-,+-) 0,0 1,1 or 1,2.''. It has offset $1$ and begins
\[
108, 2089, 95161, 3232688, 123067561, 4487054905, 165950022876, 6104375073457,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 10 2015 10:23:05, revision 6) this is still
...
\[
(i-h_i,\,j-h_j)\;\in\;\{(-1,-2),\ (-1,-1),\ (-1,1),\ (-1,2),\ (0,0),\ (1,-2),\ (1,-1),\ (1,1),\ (1,2)\},
\]
...
\begin{theorem}
\[
a(n)\;=\;59\,a(n-1) - 800\,a(n-2) - 5123\,a(n-3) + 202521\,a(n-4) - 1193960\,a(n-5) - 8299248\,a(n-6) + 121460288\,a(n-7) - 182636544\,a(n-8) - 3955605504\,a(n-9) + 24437587968\,a(n-10) - 38600179712\,a(n-11) - 99925098496\,a(n-12) + 461708984320\,a(n-13) - 618475290624\,a(n-14) + 274877906944\,a(n-15)
\]
for every $n>13$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A263961.
