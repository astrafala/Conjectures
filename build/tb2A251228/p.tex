...
different counts. Across the columns settled here the model reproduces $15$ published
values, $60$ decimal digits in all, every one of them exactly; a misreading of the entry
