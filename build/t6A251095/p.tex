...
\title{The empirical recurrence for OEIS A251095, proved by transfer matrix}
...
\begin{abstract}
OEIS A251095 counts $(n+1)\times4$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A251095 is ``Number of (n+1)X(3+1) 0..1 arrays with no 2X2 subblock having its minimum diagonal element less than its minimum antidiagonal element.''. It has offset $1$ and begins
\[
129, 1109, 9597, 82814, 713769, 6151051, 53009570, 456842112,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 16*a(n-1) -90*a(n-2) +285*a(n-3) -577*a(n-4) +763*a(n-5) -652*a(n-6) +352*a(n-7) -112*a(n-8) +16*a(n-9)
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:03:43, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;16\,a(n-1) - 90\,a(n-2) + 285\,a(n-3) - 577\,a(n-4) + 763\,a(n-5) - 652\,a(n-6) + 352\,a(n-7) - 112\,a(n-8) + 16\,a(n-9)
\end{equation}
for all $n>8$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251095.
