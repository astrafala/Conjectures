...
\title{The empirical recurrence for OEIS A220565, proved by transfer matrix}
...
\begin{abstract}
OEIS A220565 counts the ways of linking the cells of a grid $4$ cells wide, each cell either to
...
state, the count is a walk count on $S=34$ of them, and the conjectured recurrence is then
...
OEIS A220565 is ``Number of ways to reciprocally link elements of an 4Xn array either to themselves or to exactly one horizontal or antidiagonal neighbor.''. It has offset $1$ and begins
\[
1, 34, 292, 3966, 45966, 561636, 6743873, 81437539,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 18:50:52, revision 8) this is still
...
one configuration. With $M$ the adjacency matrix of the digraph on the $S=34$ reachable
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + 84\,a(n-2) + 194\,a(n-3) - 338\,a(n-4) - 1077\,a(n-5) + 616\,a(n-6) + 1932\,a(n-7) - 788\,a(n-8) - 1136\,a(n-9) + 325\,a(n-10) + 284\,a(n-11) - 48\,a(n-12) - 30\,a(n-13) + 2\,a(n-14) + a(n-15)
\]
for every $n>14$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A220565.
