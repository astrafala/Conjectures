...
\title{The empirical recurrence for OEIS A303802, proved by transfer matrix}
...
\begin{abstract}
OEIS A303802 counts $2$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A303802 is ``Number of n X 2 0..1 arrays with every element unequal to 0, 1, 3 or 4 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
2, 5, 7, 17, 35, 61, 127, 265,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) -a(n-2) +4*a(n-3) -4*a(n-4) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 07 2022 14:40:02, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A303802.
