...
\title{The empirical recurrence for OEIS A305242, proved by transfer matrix}
...
\begin{abstract}
OEIS A305242 counts $5$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $different from$ itself lying in $\{0,1,2,4,8\}$, and it carries an empirical
...
OEIS A305242 is ``Number of nX5 0..1 arrays with every element unequal to 0, 1, 2, 4 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
16, 64, 86, 273, 1134, 3288, 11731, 39986,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 28 2018 08:40:58, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 7\,a(n-2) + 10\,a(n-3) - 2\,a(n-4) - 37\,a(n-5) - 73\,a(n-6) - 32\,a(n-7) + 81\,a(n-8) + 136\,a(n-9) + 94\,a(n-10) + 80\,a(n-11) + 98\,a(n-12) - 79\,a(n-13) - 230\,a(n-14) - 294\,a(n-15) - 395\,a(n-16) - 145\,a(n-17) + 212\,a(n-18) + 255\,a(n-19) + 184\,a(n-20) + 258\,a(n-21) + 300\,a(n-22) - 22\,a(n-23) - 40\,a(n-24) - 148\,a(n-25) - 222\,a(n-26) - 4\,a(n-27) - 28\,a(n-28) + 14\,a(n-29) + 6\,a(n-30) + 24\,a(n-31) + 26\,a(n-32) - 6\,a(n-33) - 4\,a(n-34)
\end{equation}
for all $n>41$.
...
has score in $\{0,1,2,4,8\}$. The entry also fixes the top-left entry to be $0$; that is a condition on the first row alone, so it restricts the start vector and nothing else.
...
\begin{itemize}
\item $\mathbf{s}(r,s)=1$ when every cell of $r$ has score in $\{0,1,2,4,8\}$ \emph{with no row
above $r$} and $r_1=0$, and $0$ otherwise;
\item an edge $(r,s)\to(s,t)$ when every cell of $s$ has score in $\{0,1,2,4,8\}$ computed from
$r$, $s$ and $t$;
\item $\mathbf{e}(r,s)=1$ when every cell of $s$ has score in $\{0,1,2,4,8\}$ \emph{with no row
...
exactly when every one of its $n$ rows has all scores in $\{0,1,2,4,8\}$. Read the sequence as the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A305242.
