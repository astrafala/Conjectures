...
\title{The empirical recurrence for OEIS A207591, proved by transfer matrix}
...
\begin{abstract}
OEIS A207591 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
...
OEIS A207591 is ``Number of 4 X n 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 0 1 and 1 1 1 vertically.''. It has offset
$1$ and begins
\[
9, 81, 144, 432, 1098, 3150, 8244,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 8*a(n-2) + 2*a(n-3) - 10*a(n-4) + 2*a(n-6) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 24 2018 14:43:01, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207591.
