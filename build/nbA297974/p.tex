...
\title{The empirical recurrence for OEIS A297974, proved by transfer matrix}
...
\begin{abstract}
OEIS A297974 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A297974 is ``Number of n X 4 0..1 arrays with every element equal to 2, 3, 4 or 5 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
0, 6, 20, 109, 1042, 7302, 60427, 481401,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 21 2026 20:41:19, revision
6) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;7\,a(n-1) + 32\,a(n-2) - 140\,a(n-3) - 598\,a(n-4) + 1159\,a(n-5) + 5304\,a(n-6) - 4333\,a(n-7) - 25781\,a(n-8) + 7663\,a(n-9) + 77338\,a(n-10) - 9186\,a(n-11) - 146950\,a(n-12) + 40670\,a(n-13) + 162366\,a(n-14) - 251269\,a(n-15) - 5153\,a(n-16) + 716034\,a(n-17) - 170543\,a(n-18) - 1303137\,a(n-19) + 206096\,a(n-20) + 1281221\,a(n-21) + 682644\,a(n-22) - 1324101\,a(n-23) - 1132741\,a(n-24) + 1131408\,a(n-25) + 172656\,a(n-26) + 40049\,a(n-27) - 568390\,a(n-28) - 239758\,a(n-29) + 645066\,a(n-30) - 100658\,a(n-31) - 51639\,a(n-32) + 38776\,a(n-33) + 33836\,a(n-34) + 41437\,a(n-35) - 48047\,a(n-36) - 59151\,a(n-37) + 9515\,a(n-38) + 46874\,a(n-39) - 834\,a(n-40) - 25695\,a(n-41) + 1922\,a(n-42) + 7078\,a(n-43) - 1180\,a(n-44) - 1468\,a(n-45) + 204\,a(n-46)
\end{equation}
for all $n>49$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297974.
