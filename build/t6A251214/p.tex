...
\title{The empirical recurrence for OEIS A251214, proved by transfer matrix}
...
\begin{abstract}
OEIS A251214 counts $(n+1)\times4$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A251214 is ``Number of (n+1) X (3+1) 0..1 arrays with no 2 X 2 subblock having zero or two 1s.''. It has offset $1$ and begins
\[
49, 191, 758, 3089, 12503, 50912, 206715, 840931,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) + 17*a(n-2) - 20*a(n-3) - 85*a(n-4) + 68*a(n-5) + 146*a(n-6) - 84*a(n-7) - 56*a(n-8) + 24*a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 27 2018 09:01:42, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 17\,a(n-2) - 20\,a(n-3) - 85\,a(n-4) + 68\,a(n-5) + 146\,a(n-6) - 84\,a(n-7) - 56\,a(n-8) + 24\,a(n-9)
\end{equation}
for all $n>8$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251214.
