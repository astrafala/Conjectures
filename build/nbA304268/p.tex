...
\title{The empirical recurrence for OEIS A304268, proved by transfer matrix}
...
\begin{abstract}
OEIS A304268 counts $6$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A304268 is ``Number of nX6 0..1 arrays with every element unequal to 0, 1, 5 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
13, 13, 37, 116, 404, 1246, 3788, 12342,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 09 2018 10:13:32, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 2\,a(n-2) + 16\,a(n-3) + 7\,a(n-4) - 14\,a(n-5) - 45\,a(n-6) - 14\,a(n-7) + 5\,a(n-8) + 38\,a(n-9) + 13\,a(n-10) - 6\,a(n-11) - 6\,a(n-12)
\end{equation}
for all $n>12$.
...
\begin{theorem}
The recurrence \eqref{eq:conj} holds for every $n>12$. This is the statement of
Section~1.
\end{theorem}
...
They vanish from the index corresponding to $n=12+1$ onwards, and the run was continued
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A304268.
