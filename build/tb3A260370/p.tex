...
\title{The empirical column recurrences for the table OEIS A260370}
...
\begin{abstract}
OEIS A260370 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A260370 is ``T(n,k)=Number of (n+2)X(k+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000001 00000011 or 00001111.''. It has offset $1$, is
read by antidiagonals, and begins
\[
48, 78, 78, 208, 127, 208, 436, 342,\ \dots
\]
The entry carries the following block:
\begin{quote}\small
Empirical for column k:\\
k=1: a(n) = a(n-1) -a(n-2) +5*a(n-3) -a(n-4) +5*a(n-5) -3*a(n-6) -a(n-7)\\
k=2: [order 12]\\
k=3: [order 28] for n>30\\
k=4: [order 44] for n>46\\
k=5: [order 64] for n>66\\
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 12:06:39, revision 6) these are still
...
The sequence is ``Number of (n+2)X(3) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000001 00000011 or 00001111.''. Its rows are the vertices of a digraph on
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A260370.
