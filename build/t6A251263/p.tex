...
\title{The empirical recurrence for OEIS A251263, proved by transfer matrix}
...
\begin{abstract}
OEIS A251263 counts $(n+1)\times4$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A251263 is ``Number of (n+1)X(3+1) 0..1 arrays with no 2X2 subblock having x11-x00 less than x10-x01.''. It has offset $1$ and begins
\[
57, 313, 1667, 9109, 49872, 273607, 1501739, 8244503,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 6*a(n-1) +6*a(n-2) -55*a(n-3) +21*a(n-4) +97*a(n-5) -48*a(n-6) -52*a(n-7) +25*a(n-8) +5*a(n-9) -2*a(n-10)
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 10:19:37, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) + 6\,a(n-2) - 55\,a(n-3) + 21\,a(n-4) + 97\,a(n-5) - 48\,a(n-6) - 52\,a(n-7) + 25\,a(n-8) + 5\,a(n-9) - 2\,a(n-10)
\end{equation}
for all $n>9$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251263.
