...
\title{The empirical recurrence for OEIS A259511, proved by transfer matrix}
...
\begin{abstract}
OEIS A259511 counts arrays of width $5$ over $\{0,1\}$ subject to a condition read round the
...
OEIS A259511 is ``Number of (n+1)X(4+1) 0..1 arrays with each 2X2 subblock having clockwise pattern 0000 0001 0101 0111.''. It has offset $1$ and begins
\[
245, 2219, 20293, 189211, 1769635, 16602297, 155863519, 1464104971,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:51:56, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-1) + 61\,a(n-2) - 432\,a(n-3) - 936\,a(n-4) + 7415\,a(n-5) + 3311\,a(n-6) - 51997\,a(n-7) + 14878\,a(n-8) + 156464\,a(n-9) - 95087\,a(n-10) - 197708\,a(n-11) + 149042\,a(n-12) + 84334\,a(n-13) - 69090\,a(n-14)
\]
for every $n>14$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A259511.
