...
\title{The empirical recurrence for OEIS A253395, proved by transfer matrix}
...
\begin{abstract}
OEIS A253395 counts the arrays over $\{0,\dots,1\}$ whose $2\times2$ subblocks carry a
...
so a pair of consecutive array rows is a state, the count is a walk count on $S=476$ of them,
...
OEIS A253395 is ``Number of (n+1) X (6+1) 0..1 arrays with every 2 X 2 subblock antidiagonal maximum minus diagonal minimum nondecreasing horizontally and diagonal maximum minus antidiagonal minimum nondecreasing vertically.''. It has offset $1$ and begins
\[
476, 320, 419, 632, 932, 1318, 1855, 2528,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) - 5*a(n-2) + 5*a(n-4) - 4*a(n-5) + a(n-6) for n>16.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 12 2018 06:51:47, revision 7) this is still
...
\]
on the $S=476$ admissible pairs. In particular $a$ is $C$-finite. The alignment of the walk
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253395.
