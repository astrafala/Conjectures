...
\title{The empirical recurrence for OEIS A220707, proved by transfer matrix}
...
\begin{abstract}
OEIS A220707 counts the ways of linking the cells of a grid $7$ cells wide, each cell either to
...
state, the count is a walk count on $S=20$ of them, and the conjectured recurrence is then
...
OEIS A220707 is ``Number of ways to reciprocally link elements of an n X 7 array either to themselves or to exactly two horizontal and antidiagonal neighbors, without consecutive collinear links.''. It has offset $1$ and begins
\[
1, 13, 48, 298, 1520, 8338, 44976, 244029,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 01 2021 18:31:42, revision 7) this is still
...
one configuration. With $M$ the adjacency matrix of the digraph on the $S=20$ reachable
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) + 6\,a(n-2) - 17\,a(n-3) - 19\,a(n-4) + 10\,a(n-5) + 16\,a(n-6) - 46\,a(n-7) + 7\,a(n-8) + 15\,a(n-9) - 14\,a(n-10) + 21\,a(n-11) + 3\,a(n-12) + 10\,a(n-13) + 8\,a(n-14) + 2\,a(n-15) + 5\,a(n-16) + a(n-17) + 2\,a(n-18) - a(n-19) - a(n-20)
\]
for every $n>19$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A220707.
