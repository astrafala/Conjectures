...
\title{The empirical recurrence for OEIS A207728, proved by transfer matrix}
...
\begin{abstract}
OEIS A207728 counts arrays over $\{0,\dots,1\}$ of width $7$ that avoid the patterns
...
OEIS A207728 is ``Number of nX7 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 1 1 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
40, 1600, 6016, 33063, 211680, 1029231, 4799749,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:13:22, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207728.
