...
\title{The reduction of OEIS A162314 modulo $k$:\\ a proof that the period divides
$\varphi(k)$}
...
\begin{abstract}
OEIS A162314 carries a conjecture of P.~Bala that for every positive integer $k$ the
...
\[
1, 4, 24, 208, 2400, 34624, 599424, 12107008,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 18 2022 19:46:42, revision
12) the statement is still recorded as a conjecture, and nothing on the entry
...
Write $G(t)=\sum_{j\ge0}c_j t^{j}$, so $c_j\in\mathbb{Z}$; here $c_j = 1, 4, 10, 24, 58, 140, \dots$, and the
first few are
\[
c_0,\dots,c_8 \;=\; 1, 4, 10, 24, 58, 140, 338, 816, 1970.
\]
...
Let $a(n)$ be OEIS A162314. For every integer $k\ge1$,
\[
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A162314.
