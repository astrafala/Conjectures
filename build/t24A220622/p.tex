...
\title{The empirical recurrence for OEIS A220622, proved by transfer matrix}
...
\begin{abstract}
OEIS A220622 counts the ways of linking the cells of a grid $3$ cells wide, each cell either to
...
state, the count is a walk count on $S=22$ of them, and the conjectured recurrence is then
...
OEIS A220622 is ``Number of ways to reciprocally link elements of an 3 X n array either to themselves or to exactly one horizontal, diagonal and antidiagonal neighbor.''. It has offset $1$ and begins
\[
1, 22, 125, 1189, 9176, 76955, 624227, 5131406,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 6*a(n-1) + 22*a(n-2) - 32*a(n-3) - 12*a(n-4) + 8*a(n-5) - 3*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 01:18:35, revision 10) this is still
...
one configuration. With $M$ the adjacency matrix of the digraph on the $S=22$ reachable
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) + 22\,a(n-2) - 32\,a(n-3) - 12\,a(n-4) + 8\,a(n-5) - 3\,a(n-6)
\]
for every $n>5$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A220622.
