...
\title{The empirical recurrence for OEIS A232957, proved by transfer matrix}
...
\begin{abstract}
OEIS A232957 counts arrays over $\{0,\dots,3\}$ in which no two entries that are neighbours in
...
carried by one bounded piece of extra state, so the count is a walk count on $S=64$ states.
\end{abstract}
...
OEIS A232957 is ``Number of 3 X n 0..3 arrays with no element x(i,j) adjacent to value 3-x(i,j) horizontally, diagonally or antidiagonally, and top left element zero.''. It has offset $1$ and begins
\[
16, 147, 1881, 22971, 283131, 3484893, 42904365, 528197043,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 12*a(n-1) + 7*a(n-2) - 40*a(n-3) + 12*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 06 2018 11:45:41, revision 8) this is still
...
and the row above and every clash inside it. There are $S=64$ reachable states.
...
\begin{theorem}
\[
a(n)\;=\;12\,a(n-1) + 7\,a(n-2) - 40\,a(n-3) + 12\,a(n-4)
\]
for every $n>4$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232957.
