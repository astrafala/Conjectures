...
\title{The empirical recurrence for OEIS A234414, proved by transfer matrix}
...
\begin{abstract}
OEIS A234414 counts $(n+1)\times2$ arrays over $\{0,\dots,7\}$ subject to a condition imposed on
...
OEIS A234414 is ``Number of (n+1) X (1+1) 0..7 arrays with every 2 X 2 subblock having the absolute values of all six edge and diagonal differences no larger than 1.''. It has offset $1$ and begins
\[
106, 550, 2848, 14794, 76996, 401332, 2094334, 10939294,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 13*a(n-1) - 54*a(n-2) + 57*a(n-3) + 90*a(n-4) - 96*a(n-5) - 108*a(n-6) - 24*a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 14 2018 21:54:25, revision 11) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234414.
