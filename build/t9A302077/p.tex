...
\title{The empirical recurrence for OEIS A302077, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A302077 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A302077 is ``Number of nX4 0..1 arrays with every element equal to 0, 1, 3 or 4 horizontally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
5, 18, 70, 265, 1018, 3914, 15017, 57850,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +14*a(n-2) -a(n-3) -42*a(n-4) -a(n-5) +14*a(n-6) +a(n-7) -a(n-8)
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 31 2018 15:56:43, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 14\,a(n-2) - a(n-3) - 42\,a(n-4) - a(n-5) + 14\,a(n-6) + a(n-7) - a(n-8)
\end{equation}
for all $n>9$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302077.
