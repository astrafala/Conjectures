...
\title{The empirical recurrence for OEIS A302261, proved by transfer matrix}
...
\begin{abstract}
OEIS A302261 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the six horizontal, diagonal and antidiagonal neighbours, a number $equal to$ itself lying in $\{0,1,2,3\}$, and it carries an empirical
...
OEIS A302261 is ``Number of nX4 0..1 arrays with every element equal to 0, 1, 2 or 3 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
8, 105, 772, 5922, 45717, 353229, 2727755, 21069318,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 04 2018 12:47:37, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;9\,a(n-1) - 2\,a(n-2) - 51\,a(n-3) - 80\,a(n-4) - 11\,a(n-5) + 262\,a(n-6) + 1203\,a(n-7) - 73\,a(n-8) - 847\,a(n-9) - 3807\,a(n-10) + 103\,a(n-11) - 606\,a(n-12) + 4295\,a(n-13) + 1436\,a(n-14) + 1630\,a(n-15) - 3052\,a(n-16) + 576\,a(n-17)
\end{equation}
for all $n>17$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302261.
