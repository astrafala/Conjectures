...
\title{The empirical recurrence for OEIS A208290, proved by transfer matrix}
...
\begin{abstract}
OEIS A208290 counts arrays over $\{0,\dots,1\}$ of width $6$ that avoid the patterns
...
OEIS A208290 is ``Number of 6 X n 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 0 1 and 1 1 0 vertically.''. It has offset
$1$ and begins
\[
12, 144, 636, 3900, 21096, 119580, 665892,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 4*a(n-1) + 11*a(n-2) - 10*a(n-3) - 10*a(n-4) + 6*a(n-5) + 2*a(n-6) - a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 30 2018 14:24:38, revision
8) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) + 11\,a(n-2) - 10\,a(n-3) - 10\,a(n-4) + 6\,a(n-5) + 2\,a(n-6) - a(n-7)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208290.
