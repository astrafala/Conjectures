...
\title{The empirical recurrence for OEIS A207027, proved by transfer matrix}
...
\begin{abstract}
OEIS A207027 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
...
OEIS A207027 is ``Number of 4Xn 0..1 arrays avoiding 0 0 0 and 0 1 1 horizontally and 0 0 1 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
8, 64, 168, 558, 1586, 3726, 9450,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 13:24:24, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) - 11\,a(n-3) - 13\,a(n-4) + 39\,a(n-5) + 29\,a(n-6) - 35\,a(n-7) - 84\,a(n-8) + 25\,a(n-9) + 53\,a(n-10) + 48\,a(n-11) - 15\,a(n-12) + 6\,a(n-13) - 69\,a(n-14) - 25\,a(n-15) + a(n-16) + 54\,a(n-17) + 2\,a(n-18) + 16\,a(n-19) - 12\,a(n-20) - 6\,a(n-21) - 15\,a(n-22) + 6\,a(n-23) + 3\,a(n-25) + a(n-27) - a(n-28)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207027.
