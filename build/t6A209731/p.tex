...
\title{The empirical recurrence for OEIS A209731, proved by transfer matrix}
...
\begin{abstract}
OEIS A209731 counts $(n+1)\times4$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A209731 is ``1/4 the number of (n+1)X4 0..3 arrays with every 2X2 subblock having distinct edge sums.''. It has offset $1$ and begins
\[
696, 9712, 137888, 1995752, 28927984, 420545824, 6111765608, 88883321584,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 15:26:58, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;14\,a(n-1) + 156\,a(n-2) - 2224\,a(n-3) - 7407\,a(n-4) + 130352\,a(n-5) + 139225\,a(n-6) - 3967738\,a(n-7) - 347340\,a(n-8) + 71434181\,a(n-9) - 28076530\,a(n-10) - 808939517\,a(n-11) + 497233986\,a(n-12) + 5937897631\,a(n-13) - 3990226320\,a(n-14) - 28600057758\,a(n-15) + 17484900856\,a(n-16) + 90252403892\,a(n-17) - 42280584722\,a(n-18) - 183177183716\,a(n-19) + 52345388842\,a(n-20) + 228997243328\,a(n-21) - 25762931959\,a(n-22) - 164559319657\,a(n-23) - 1566342824\,a(n-24) + 63269043596\,a(n-25) + 5091355688\,a(n-26) - 11482954208\,a(n-27) - 1243500736\,a(n-28) + 729105088\,a(n-29) + 59218432\,a(n-30) - 12493824\,a(n-31)
\end{equation}
for all $n>31$.
...
\[
a(n)-\sum_i c_i\,a(n-i)\;=\;\tfrac1{4}\mathbf{1}^{\!\top}M^{\,n+1-1-31}\,q(M)\,\mathbf{1} .
\]
...
=\tfrac1{4}\mathbf{1}^{\!\top}M^{\,m-31}\,q(M)\,\mathbf{1}
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209731.
