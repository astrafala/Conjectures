...
\begin{theorem}
The recurrence \eqref{eq:conj} holds for every $n>42$. This is the statement of
Section~1.
\end{theorem}
...
They vanish from the index corresponding to $n=42+1$ onwards, and the run was continued
