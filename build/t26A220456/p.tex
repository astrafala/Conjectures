...
\title{The empirical recurrence for OEIS A220456, proved by transfer matrix}
...
\begin{abstract}
OEIS A220456 counts the distinct indicator arrays obtained from the $n\times2$ arrays over
...
OEIS A220456 is ``Equals one maps: number of nX2 binary arrays indicating the locations of corresponding elements equal to exactly one of their horizontal, vertical and antidiagonal neighbors in a random 0..1 nX2 array.''. It has offset $1$ and begins
\[
2, 4, 22, 74, 250, 848, 2851, 9535,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 18:47:22, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) - 11\,a(n-2) + 10\,a(n-3) - 11\,a(n-4) + 7\,a(n-5) - 22\,a(n-6) + 61\,a(n-7) - 101\,a(n-8) + 159\,a(n-9) - 166\,a(n-10) + 159\,a(n-11) - 137\,a(n-12) + 189\,a(n-13) - 246\,a(n-14) + 239\,a(n-15) - 183\,a(n-16) + 96\,a(n-17) - 60\,a(n-18) + 193\,a(n-19) - 214\,a(n-20) + 187\,a(n-21) - 199\,a(n-22) + 29\,a(n-23) - 105\,a(n-24) + 20\,a(n-25) - 37\,a(n-26) + 13\,a(n-27) - 8\,a(n-28) + 4\,a(n-29)
\]
for every $n>34$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A220456.
