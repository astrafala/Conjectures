...
\title{The empirical recurrence for OEIS A251278, proved by transfer matrix}
...
\begin{abstract}
OEIS A251278 counts $(n+1)\times4$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A251278 is ``Number of (n+1)X(3+1) 0..3 arrays with no 2X2 subblock having its maximum diagonal element less than its minimum antidiagonal element.''. It has offset $1$ and begins
\[
46244, 8320896, 1497752279, 269564757184, 48514315795424, 8731180080790272, 1571357864513534615, 282798467877162729472,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:13:37, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;230\,a(n-1) - 9371\,a(n-2) + 68562\,a(n-3) - 428619\,a(n-4) - 3386398\,a(n-5) + 50923111\,a(n-6) - 44328410\,a(n-7) - 221985864\,a(n-8) - 608157648\,a(n-9)
\end{equation}
for all $n>8$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251278.
