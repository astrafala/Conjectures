...
\title{The empirical recurrence for OEIS A297690, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297690 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A297690 is ``Number of nX4 0..1 arrays with every 1 horizontally, diagonally or antidiagonally adjacent to 0, 2 or 4 neighboring 1s.''. It has offset $1$ and begins
\[
8, 60, 293, 1774, 10647, 61054, 358972, 2106480,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 03 2018 12:25:15, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) - a(n-2) + 28\,a(n-3) - 175\,a(n-4) + 87\,a(n-5) - 113\,a(n-6) + 990\,a(n-7) - 665\,a(n-8) + 109\,a(n-9) - 1670\,a(n-10) + 1463\,a(n-11) - 100\,a(n-12) + 874\,a(n-13) - 1129\,a(n-14) + 190\,a(n-15) + 50\,a(n-16) + 183\,a(n-17) - 97\,a(n-18) - 111\,a(n-19) + 78\,a(n-20) + 6\,a(n-21) - 3\,a(n-22) - 3\,a(n-23)
\end{equation}
for all $n>24$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297690.
