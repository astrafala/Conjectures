...
\title{The empirical recurrence for OEIS A228479, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A228479 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A228479 is ``Number of n X 5 binary arrays with top left value 1 and no two ones adjacent horizontally, vertically or antidiagonally.''. It has offset $1$ and begins
\[
5, 19, 127, 728, 4354, 25699, 152373, 902042,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) + 15*a(n-2) + 16*a(n-3) - 11*a(n-4) - 20*a(n-5) + 19*a(n-6) - 8*a(n-7) + a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 11 2018 09:05:57, revision 11) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 15\,a(n-2) + 16\,a(n-3) - 11\,a(n-4) - 20\,a(n-5) + 19\,a(n-6) - 8\,a(n-7) + a(n-9)
\end{equation}
for all $n>9$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A228479.
