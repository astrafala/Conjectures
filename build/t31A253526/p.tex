...
\title{The empirical recurrence for OEIS A253526, proved by transfer matrix}
...
\begin{abstract}
OEIS A253526 counts the arrays over $\{0,\dots,2\}$ whose $2\times2$ subblocks carry a
...
OEIS A253526 is ``Number of (n+1) X (1+1) 0..2 arrays with every 2 X 2 subblock antidiagonal maximum minus diagonal minimum nondecreasing horizontally and diagonal maximum minus antidiagonal minimum nondecreasing vertically.''. It has offset $1$ and begins
\[
81, 459, 1963, 7253, 25165, 85663, 291511, 997121,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 8*a(n-1) - 22*a(n-2) + 21*a(n-3) + 13*a(n-4) - 46*a(n-5) + 40*a(n-6) - 15*a(n-7) + 2*a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 17 2018 08:24:19, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-1) - 22\,a(n-2) + 21\,a(n-3) + 13\,a(n-4) - 46\,a(n-5) + 40\,a(n-6) - 15\,a(n-7) + 2\,a(n-8)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253526.
