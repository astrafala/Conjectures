...
\title{The empirical recurrence for OEIS A207876, proved by transfer matrix}
...
\begin{abstract}
OEIS A207876 counts arrays over $\{0,\dots,1\}$ of width $5$ that avoid the patterns
...
OEIS A207876 is ``Number of nX5 0..1 arrays avoiding 0 0 0 and 1 0 1 horizontally and 0 1 0 and 1 1 1 vertically.''. It has offset
$1$ and begins
\[
13, 169, 336, 824, 1648, 4160, 8892,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:23:02, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-2) + 8\,a(n-3) + 7\,a(n-4) - 28\,a(n-6) - 4\,a(n-7) + 19\,a(n-8) + 36\,a(n-9) - 24\,a(n-10) - 18\,a(n-11) - 6\,a(n-12) + 10\,a(n-14)
\end{equation}
for all $n>18$. 
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207876.
