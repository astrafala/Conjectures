...
\title{The empirical recurrence for OEIS A233711, proved by transfer matrix}
...
\begin{abstract}
OEIS A233711 counts $(n+1)\times3$ arrays over $\{0,\dots,4\}$ subject to a condition imposed on
...
on $S=125$ vertices whose edges are the admissible consecutive pairs, and the count is a
...
OEIS A233711 is ``Number of (n+1)X(2+1) 0..4 arrays with every 2X2 subblock having the sum of the squares of the edge differences equal to 14.''. It has offset $1$ and begins
\[
444, 2624, 16004, 103152, 662008, 4295540, 27795204, 180350552,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 08:57:38, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;8\,a(n-1) + 56\,a(n-2) - 565\,a(n-3) - 766\,a(n-4) + 15139\,a(n-5) - 7664\,a(n-6) - 200684\,a(n-7) + 302993\,a(n-8) + 1413766\,a(n-9) - 3297757\,a(n-10) - 5115754\,a(n-11) + 18205660\,a(n-12) + 6468818\,a(n-13) - 56612688\,a(n-14) + 15267568\,a(n-15) + 100195210\,a(n-16) - 68399612\,a(n-17) - 95039845\,a(n-18) + 102899681\,a(n-19) + 36863396\,a(n-20) - 73128319\,a(n-21) + 5984214\,a(n-22) + 22126722\,a(n-23) - 7453432\,a(n-24) - 1251600\,a(n-25) + 860624\,a(n-26) - 95168\,a(n-27)
\end{equation}
for all $n>27$.
...
$V=\{0,1,\dots,4\}^{3}$, so $|V|=S=125$. A $2\times2$ subblock of the array
...
(\beta-\alpha)^2+(\delta-\beta)^2+(\gamma-\delta)^2+(\alpha-\gamma)^2=14,
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A233711.
