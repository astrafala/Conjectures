...
\title{The empirical recurrence for OEIS A203729, proved by transfer matrix}
...
\begin{abstract}
OEIS A203729 counts $(n+1)\times3$ arrays over $\{0,\dots,7\}$ subject to a condition imposed on
...
on $S=512$ vertices whose edges are the admissible consecutive pairs, and the count is a
...
OEIS A203729 is ``Number of (n+1) X 3 0..7 arrays with every 2 X 2 subblock having equal diagonal elements or equal antidiagonal elements.''. It has offset $1$ and begins
\[
14400, 539456, 19071424, 681461824, 24301391808, 866928276544, 30924651270080, 1103143816649792,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 29*a(n-1) +238*a(n-2).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 04 2018 17:55:48, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;29\,a(n-1) + 238\,a(n-2)
\end{equation}
for all $n>1$.
...
$V=\{0,1,\dots,7\}^{3}$, so $|V|=S=512$. A $2\times2$ subblock of the array
...
\[
a(n)-\sum_i c_i\,a(n-i)\;=\;\mathbf{1}^{\!\top}M^{\,n+1-1-2}\,q(M)\,\mathbf{1} .
\]
...
=\mathbf{1}^{\!\top}M^{\,m-2}\,q(M)\,\mathbf{1}
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A203729.
