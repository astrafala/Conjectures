...
\title{The empirical recurrence for OEIS A297953, proved by transfer matrix}
...
\begin{abstract}
OEIS A297953 counts $2$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A297953 is ``Number of n X 2 0..1 arrays with every element equal to 1, 2, 4 or 5 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 3, 7, 13, 23, 49, 99, 189,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) - a(n-2) + 4*a(n-3) - 4*a(n-4) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 19 2018 14:14:04, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297953.
