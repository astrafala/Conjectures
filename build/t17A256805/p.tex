...
\title{The empirical recurrence for OEIS A256805, proved by transfer matrix}
...
\begin{abstract}
OEIS A256805 counts $(n+2)\times5$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
no $3\times3$ subblock, and it carries an empirical recurrence of order $28$
...
OEIS A256805 is ``Number of (n+2)X(3+2) 0..1 arrays with no 3x3 subblock diagonal sum 0 and no antidiagonal sum 0 and no row sum 0 or 1 and no column sum 0 or 1.''. It has offset $1$ and begins
\[
237, 1167, 5891, 28655, 140031, 688353, 3375943, 16546465,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:45:38, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 5\,a(n-2) + 48\,a(n-3) + 104\,a(n-4) + 99\,a(n-5) - 202\,a(n-6) - 1024\,a(n-7) - 1496\,a(n-8) - 281\,a(n-9) + 3079\,a(n-10) + 5838\,a(n-11) + 3341\,a(n-12) - 3935\,a(n-13) - 7358\,a(n-14) - 5876\,a(n-15) - 1450\,a(n-16) + 3684\,a(n-17) + 5004\,a(n-18) + 2617\,a(n-19) + 221\,a(n-20) - 821\,a(n-21) - 1170\,a(n-22) - 324\,a(n-23) - 123\,a(n-24) + 49\,a(n-25) + 50\,a(n-26) + 3\,a(n-27) + 6\,a(n-28)
\]
for every $n>28$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A256805.
