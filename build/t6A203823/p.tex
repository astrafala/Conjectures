...
\title{The empirical recurrence for OEIS A203823, proved by transfer matrix}
...
\begin{abstract}
OEIS A203823 counts $(n+1)\times6$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A203823 is ``Number of (n+1)X6 0..3 arrays with no 2X2 subblock having equal diagonal elements or equal antidiagonal elements.''. It has offset $1$ and begins
\[
944784, 252047376, 67240638864, 17968205387664, 4802315365587600, 1283572086126147216, 343078794839144051856, 91699807460715032147856,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 303*a(n-1) -8127*a(n-2) -394891*a(n-3) +4091304*a(n-4) +21176820*a(n-5) -92236816*a(n-6)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 10:44:45, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;303\,a(n-1) - 8127\,a(n-2) - 394891\,a(n-3) + 4091304\,a(n-4) + 21176820\,a(n-5) - 92236816\,a(n-6)
\end{equation}
for all $n>6$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A203823.
