...
\title{The empirical recurrence for OEIS A207847, proved by transfer matrix}
...
\begin{abstract}
OEIS A207847 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
...
OEIS A207847 is ``Number of 4 X n 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 0 0 and 1 1 1 vertically.''. It has offset
$1$ and begins
\[
10, 100, 240, 780, 2320, 7140, 21600,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) + 6*a(n-2) + a(n-3) - a(n-4) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 25 2018 15:55:51, revision
8) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 6\,a(n-2) + a(n-3) - a(n-4)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207847.
