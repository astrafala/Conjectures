...
\title{The empirical recurrence for OEIS A220597, proved by transfer matrix}
...
\begin{abstract}
OEIS A220597 counts the ways of linking the cells of a grid $3$ cells wide, each cell either to
...
state, the count is a walk count on $S=40$ of them, and the conjectured recurrence is then
...
OEIS A220597 is ``Number of ways to reciprocally link elements of an n X 3 array either to themselves or to exactly two horizontal, vertical and antidiagonal neighbors, without 3-loops.''. It has offset $1$ and begins
\[
1, 7, 65, 471, 3469, 25747, 190425, 1408823,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 6*a(n-1) + 7*a(n-2) + 25*a(n-3) - 3*a(n-4) + 9*a(n-5) + 22*a(n-6) - 5*a(n-7) - 2*a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 01 2018 05:52:26, revision 7) this is still
...
one configuration. With $M$ the adjacency matrix of the digraph on the $S=40$ reachable
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) + 7\,a(n-2) + 25\,a(n-3) - 3\,a(n-4) + 9\,a(n-5) + 22\,a(n-6) - 5\,a(n-7) - 2\,a(n-8)
\]
for every $n>7$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A220597.
