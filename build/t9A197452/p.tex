...
\title{The empirical recurrence for OEIS A197452, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A197452 counts arrays over $\{0,\dots,4\}$ in which every cell is constrained by the
...
OEIS A197452 is ``Number of nX3 0..4 arrays with each element x equal to the number of its horizontal and vertical neighbors equal to 3,3,0,2,2 for x=0,1,2,3,4.''. It has offset $1$ and begins
\[
2, 10, 31, 84, 290, 923, 2887, 9216,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 07:14:50, revision 11) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 4\,a(n-2) + 3\,a(n-3) - 7\,a(n-4) - 18\,a(n-5) - 5\,a(n-6) + 18\,a(n-7) + 31\,a(n-8) + 20\,a(n-9) - 5\,a(n-10) - 25\,a(n-11) - 18\,a(n-12) - 7\,a(n-13) + 3\,a(n-14) + 2\,a(n-15)
\end{equation}
for all $n>16$.
...
\#\{\text{neighbours with value }f(x_{t,u})\}=x_{t,u},\quad f=(3,3,0,2,2)
\end{equation}
for every cell $(t,u)$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A197452.
