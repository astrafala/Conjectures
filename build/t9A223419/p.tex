...
\title{The empirical recurrence for OEIS A223419, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A223419 counts arrays over $\{0,\dots,6\}$ in which every cell is constrained by the
...
OEIS A223419 is ``3-level binary fanout graph coloring a rectangular array: number of n X 4 0..6 arrays where 0..6 label nodes of a graph with edges 0,1 1,3 1,4 0,2 2,5 2,6 and every array movement to a horizontal or vertical neighbor moves along an edge of this graph.''. It has offset $1$ and begins
\[
48, 464, 4720, 47872, 486016, 4934272, 50097024, 508632832,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 14*a(n-1) - 36*a(n-2) - 40*a(n-3) + 88*a(n-4) + 32*a(n-5) - 32*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 20 2018 09:13:26, revision 7) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;14\,a(n-1) - 36\,a(n-2) - 40\,a(n-3) + 88\,a(n-4) + 32\,a(n-5) - 32\,a(n-6)
\end{equation}
for all $n>6$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223419.
