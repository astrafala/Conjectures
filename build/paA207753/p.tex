...
\title{The empirical recurrence for OEIS A207753, proved by transfer matrix}
...
\begin{abstract}
OEIS A207753 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
...
OEIS A207753 is ``Number of 4 X n 0..1 arrays avoiding 0 0 1 and 0 1 1 horizontally and 0 0 1 and 1 0 0 vertically.''. It has offset
$1$ and begins
\[
9, 81, 270, 900, 2100, 4900, 9450,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) + 4*a(n-2) - 10*a(n-3) - 5*a(n-4) + 20*a(n-5) - 20*a(n-7) + 5*a(n-8) + 10*a(n-9) - 4*a(n-10) - 2*a(n-11) + a(n-12).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 25 2018 12:46:47, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207753.
