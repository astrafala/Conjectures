...
\title{The empirical recurrence for OEIS A303012, proved by transfer matrix}
...
\begin{abstract}
OEIS A303012 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the six horizontal, diagonal and antidiagonal neighbours, a number $equal to$ itself lying in $\{0,1,2,4,6\}$, and it carries an empirical
recurrence of order $43$ contributed by R.~H.~Hardin. It is true. The neighbourhood
...
OEIS A303012 is ``Number of nX4 0..1 arrays with every element equal to 0, 1, 2, 4 or 6 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
8, 52, 187, 1047, 5299, 24030, 123538, 612923,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 17 2018 13:09:04, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) + 4\,a(n-2) + 85\,a(n-3) - 321\,a(n-4) - 343\,a(n-5) - 2472\,a(n-6) + 7909\,a(n-7) + 10149\,a(n-8) + 29559\,a(n-9) - 63945\,a(n-10) - 98402\,a(n-11) - 124572\,a(n-12) - 16974\,a(n-13) + 164683\,a(n-14) + 221419\,a(n-15) + 214227\,a(n-16) + 32181\,a(n-17) - 113477\,a(n-18) - 158850\,a(n-19) - 106901\,a(n-20) - 44553\,a(n-21) + 13386\,a(n-22) + 51313\,a(n-23) + 65572\,a(n-24) + 39327\,a(n-25) - 9214\,a(n-26) - 54978\,a(n-27) - 59312\,a(n-28) - 20547\,a(n-29) + 21630\,a(n-30) + 31130\,a(n-31) + 20275\,a(n-32) + 1984\,a(n-33) - 5879\,a(n-34) - 5470\,a(n-35) - 2004\,a(n-36) + 570\,a(n-37) + 598\,a(n-38) + 248\,a(n-39) - 66\,a(n-40) - 32\,a(n-41) - 8\,a(n-42) + 4\,a(n-43)
\end{equation}
for all $n>43$.
...
has score in $\{0,1,2,4,6\}$. The entry also fixes the top-left entry to be $0$; that is a condition on the first row alone, so it restricts the start vector and nothing else.
...
\begin{itemize}
\item $\mathbf{s}(r,s)=1$ when every cell of $r$ has score in $\{0,1,2,4,6\}$ \emph{with no row
above $r$} and $r_1=0$, and $0$ otherwise;
\item an edge $(r,s)\to(s,t)$ when every cell of $s$ has score in $\{0,1,2,4,6\}$ computed from
$r$, $s$ and $t$;
\item $\mathbf{e}(r,s)=1$ when every cell of $s$ has score in $\{0,1,2,4,6\}$ \emph{with no row
...
exactly when every one of its $n$ rows has all scores in $\{0,1,2,4,6\}$. Read the sequence as the
...
$a(n)-\sum_i c_i a(n-i)=u_{\,n-2-43}$ whenever $n-43\ge2$. So \eqref{eq:conj}
holds for every $n>t$ exactly when $u_j=0$ for all $j>t-2-43$. Moreover $(u_j)$
...
\begin{proof}
Substituting Lemma~\ref{lem:walk} and factoring $P^{\,n-2-43}$ out of
...
\begin{theorem}
The recurrence \eqref{eq:conj} holds for every $n>43$. This is the statement of
Section~1.
\end{theorem}

\begin{proof}
The vector $q(P)\mathbf{e}\in\mathbb{Z}^{S}$ was formed by $43$ matrix--vector
products in exact integer arithmetic and the $u_j$ evaluated against $\mathbf{s}$ in turn.
They vanish from the index corresponding to $n=43+1$ onwards, and the run was continued
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A303012.
