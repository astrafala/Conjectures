...
\title{The empirical recurrence for OEIS A250951, proved by transfer matrix}
...
\begin{abstract}
OEIS A250951 counts $(n+1)\times4$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A250951 is ``Number of (n+1) X (3+1) 0..1 arrays with no 2 X 2 subblock having its maximum diagonal element less than its minimum antidiagonal element.''. It has offset $1$ and begins
\[
209, 2744, 36016, 472712, 6204344, 81431944, 1068793208, 14027896712,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 15*a(n-1) - 24*a(n-2) - 8*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 24 2018 08:11:25, revision 10) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250951.
