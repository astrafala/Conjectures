...
\title{The empirical column recurrences for the table OEIS A209727}
...
\begin{abstract}
OEIS A209727 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A209727 is ``T(n,k) = 1/4 the number of (n+1) X (k+1) 0..2 arrays with every 2 X 2 subblock having distinct clockwise edge differences.''. It has offset $1$, is
read by antidiagonals, and begins
\[
2, 3, 3, 4, 4, 4, 6, 5,\ \dots
\]
...
k=1: a(n) = 2*a(n-2).\\
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 27 2020 02:30:41, revision 11) these are still
...
The sequence is ``1/4 the number of (n+1) X (2) 0..2 arrays with every 2 X 2 subblock having distinct clockwise edge differences.''. Its rows are the vertices of a digraph on
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209727.
