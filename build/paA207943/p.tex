...
\title{The empirical recurrence for OEIS A207943, proved by transfer matrix}
...
\begin{abstract}
OEIS A207943 counts arrays over $\{0,\dots,1\}$ of width $7$ that avoid the patterns
...
OEIS A207943 is ``Number of 7Xn 0..1 arrays avoiding 0 0 1 and 1 0 0 horizontally and 0 0 1 and 1 1 0 vertically.''. It has offset
$1$ and begins
\[
14, 196, 826, 3641, 20568, 120276, 737575,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:30:19, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;11\,a(n-1) - 12\,a(n-2) - 210\,a(n-3) + 495\,a(n-4) + 1675\,a(n-5) - 4933\,a(n-6) - 7524\,a(n-7) + 24432\,a(n-8) + 22034\,a(n-9) - 69076\,a(n-10) - 45806\,a(n-11) + 114911\,a(n-12) + 67305\,a(n-13) - 109800\,a(n-14) - 63536\,a(n-15) + 56149\,a(n-16) + 33715\,a(n-17) - 13209\,a(n-18) - 8384\,a(n-19) + 1044\,a(n-20) + 720\,a(n-21)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207943.
