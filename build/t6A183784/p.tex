...
\title{The empirical recurrence for OEIS A183784, proved by transfer matrix}
...
\begin{abstract}
OEIS A183784 counts $(n+1)\times2$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A183784 is ``Half the number of (n+1) X 2 0..2 arrays with no 2 X 2 subblock having sum 4.''. It has offset $1$ and begins
\[
31, 216, 1500, 10428, 72468, 503676, 3500532, 24329052,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) + 24*a(n-2) + 24*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 04 2018 10:48:25, revision 9) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A183784.
