...
\title{The empirical recurrence for OEIS A223281, proved by transfer matrix}
...
\begin{abstract}
OEIS A223281 counts the ways of writing the vertices of a fixed graph $G$ into an array of width
$7$ so that any two cells adjacent in one of the named directions carry vertices joined by an
edge of $G$; here $G$ is dodecahedron graph. The entry carries an empirical recurrence of order $20$
...
single slice is a state and the count is a walk count on a finite digraph with $S=14581$ vertices.
\end{abstract}
...
OEIS A223281 is ``Rolling icosahedron face footprints: number of nX7 0..19 arrays starting with 0 where 0..19 label faces of an icosahedron and every array movement to a horizontal, diagonal or antidiagonal neighbor moves across an icosahedral edge.''. It has offset $1$ and begins
\[
729, 29943, 1881441, 137621799, 10801441521, 879050854455, 72981761306721, 6127190749734087,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 21:27:29, revision 8) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=14581.
\]
...
of length $7$ over $20$ vertices is one of $20^{7}$ words, but only $S-1$ of them are
...
\begin{theorem}
\[
a(n)\;=\;193\,a(n-1) - 13138\,a(n-2) + 389164\,a(n-3) - 4361048\,a(n-4) - 16478976\,a(n-5) + 680367552\,a(n-6) - 2205737728\,a(n-7) - 32395676672\,a(n-8) + 159364997888\,a(n-9) + 669407522304\,a(n-10) - 3582601411584\,a(n-11) - 5951537518592\,a(n-12) + 34040410587136\,a(n-13) + 16838602686464\,a(n-14) - 137580342149120\,a(n-15) + 18193951227904\,a(n-16) + 210744868077568\,a(n-17) - 92999396622336\,a(n-18) - 80015240724480\,a(n-19) + 37572373905408\,a(n-20)
\]
for every $n>20$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223281.
