...
\title{The empirical recurrence for OEIS A282310, proved by transfer matrix}
...
\begin{abstract}
OEIS A282310 counts $n\times2$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A282310 is ``Number of n X 2 0..1 arrays with no 1 equal to more than four of its king-move neighbors.''. It has offset $1$ and begins
\[
4, 16, 63, 249, 984, 3888, 15363, 60705,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) + 3*a(n-2) + 3*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 20 2019 11:53:16, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A282310.
