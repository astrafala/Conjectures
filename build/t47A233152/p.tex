...
\title{The empirical recurrence for OEIS A233152, proved by transfer matrix}
...
\begin{abstract}
OEIS A233152 counts arrays over $\{0,\dots,2\}$ in which no two entries that are neighbours in
...
carried by one bounded piece of extra state, so the count is a walk count on $S=3$ states.
\end{abstract}
...
OEIS A233152 is ``Number of n X 5 0..2 arrays with no element x(i,j) adjacent to value 2-x(i,j) horizontally or antidiagonally.''. It has offset $1$ and begins
\[
48, 648, 8856, 121176, 1658232, 22692312, 310536504, 4249585944,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 15*a(n-1) - 18*a(n-2).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 08 2018 10:20:16, revision 8) this is still
...
and the row above and every clash inside it. There are $S=3$ reachable states.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A233152.
