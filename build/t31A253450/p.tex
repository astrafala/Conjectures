...
\title{The empirical recurrence for OEIS A253450, proved by transfer matrix}
...
\begin{abstract}
OEIS A253450 counts the arrays over $\{0,\dots,2\}$ whose $2\times2$ subblocks carry a
...
so a pair of consecutive array rows is a state, the count is a walk count on $S=414$ of them,
...
OEIS A253450 is ``Number of (n+1) X (2+1) 0..2 arrays with every 2 X 2 subblock diagonal minus antidiagonal sum nondecreasing horizontally and vertically.''. It has offset $1$ and begins
\[
414, 1975, 4782, 8554, 15220, 31630, 74324, 188438,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 6*a(n-1) - 11*a(n-2) + 6*a(n-3) for n>9.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 13 2018 08:07:52, revision 10) this is still
...
\]
on the $S=414$ admissible pairs. In particular $a$ is $C$-finite. The alignment of the walk
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253450.
