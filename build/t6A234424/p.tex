...
\title{The empirical recurrence for OEIS A234424, proved by transfer matrix}
...
\begin{abstract}
OEIS A234424 counts $(n+1)\times2$ arrays over $\{0,\dots,7\}$ subject to a condition imposed on
...
OEIS A234424 is ``Number of (n+1)X(1+1) 0..7 arrays with every 2X2 subblock having the sum of the absolute values of the edge differences equal to 14 and no adjacent elements equal.''. It has offset $1$ and begins
\[
448, 4516, 44140, 453728, 4641220, 47946684, 494928936, 5118554604,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 08:23:22, revision 7) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;9\,a(n-1) + 64\,a(n-2) - 451\,a(n-3) - 1542\,a(n-4) + 7659\,a(n-5) + 16809\,a(n-6) - 48643\,a(n-7) - 76610\,a(n-8) + 75468\,a(n-9) + 91816\,a(n-10) - 33928\,a(n-11) - 30960\,a(n-12)
\end{equation}
for all $n>12$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234424.
