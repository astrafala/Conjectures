...
\title{The empirical recurrence for OEIS A206015, proved by transfer matrix}
...
\begin{abstract}
OEIS A206015 counts arrays over $\{0,\dots,3\}$ under a condition on the number of clockwise edge increases
...
OEIS A206015 is ``Number of (n+1) X 3 0..3 arrays with the number of clockwise edge increases in every 2 X 2 subblock unequal to the number of counterclockwise edge increases.''. It has offset $1$ and begins
\[
680, 7688, 87448, 996840, 11364568, 129573608, 1477339224, 16844007528,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 14*a(n-1) - 23*a(n-2) - 94*a(n-3) + 216*a(n-4) - 64*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 13 2018 08:31:20, revision 12) this is still
...
another exactly when all $2$ subblocks they form pass. An $(n+1)$-row array is a walk of $n$
steps and
\[
...
subblocks; the entry's first term is $680$, which the model
...
\begin{theorem}
\[
a(n)\;=\;14\,a(n-1) - 23\,a(n-2) - 94\,a(n-3) + 216\,a(n-4) - 64\,a(n-5)
\]
for every $n>4$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206015.
