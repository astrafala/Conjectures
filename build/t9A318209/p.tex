...
\title{The empirical recurrence for OEIS A318209, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A318209 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A318209 is ``Number of nX3 0..1 arrays with every element unequal to 1, 2, 4 or 5 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
1, 6, 4, 21, 47, 125, 329, 842,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 21 2018 13:10:29, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 5\,a(n-2) + 6\,a(n-3) - 8\,a(n-4) - 32\,a(n-5) - 19\,a(n-6) + 17\,a(n-7) + 43\,a(n-8) + 36\,a(n-9) + 24\,a(n-10) + 8\,a(n-11) - 10\,a(n-12) - 66\,a(n-13) - 26\,a(n-14) + 28\,a(n-15) + 8\,a(n-16) - 20\,a(n-17) - 2\,a(n-18) + 46\,a(n-19) - 18\,a(n-20) - 44\,a(n-21) + 32\,a(n-23) - 5\,a(n-24) - 15\,a(n-25) + 13\,a(n-26) + 6\,a(n-27) - 8\,a(n-28) - 4\,a(n-29) + 5\,a(n-30) + a(n-31) - a(n-32)
\end{equation}
for all $n>33$.
...
\#\{\text{neighbours with a value }different from\ x_{t,u}\}\in\{1,2,4,5\}
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A318209.
