...
\title{The empirical recurrence for OEIS A232311, proved by transfer matrix}
...
\begin{abstract}
OEIS A232311 counts arrays of width $4$ over $\{0,\dots,1\}$ under a condition on each cell
...
OEIS A232311 is ``Number of (n+1)X(3+1) 0..1 arrays with every element equal to some horizontal or antidiagonal neighbor, with top left element zero.''. It has offset $1$ and begins
\[
16, 139, 1202, 10409, 90157, 780922, 6764246, 58591124,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 10*a(n-1) -11*a(n-2) -5*a(n-3) -a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 07:17:38, revision 12) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232311.
