...
\title{The empirical recurrence for OEIS A208068, proved by transfer matrix}
...
\begin{abstract}
OEIS A208068 counts arrays over $\{0,\dots,1\}$ of width $7$ that avoid the patterns
...
OEIS A208068 is ``Number of n X 7 0..1 arrays avoiding 0 0 0 and 1 1 1 horizontally and 0 0 1 and 0 1 1 vertically.''. It has offset
$1$ and begins
\[
42, 1764, 6216, 21904, 48840, 108900, 198000,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 27 2018 09:07:00, revision
...
$(0,0,0), (1,1,1)$ as $3$ consecutive entries. There are $42$ admissible rows; that condition
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208068.
