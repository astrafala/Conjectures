...
\title{The empirical recurrence for OEIS A218227, proved by transfer matrix}
...
\begin{abstract}
OEIS A218227 counts the distinct indicator arrays obtained from the $n\times2$ arrays over
...
OEIS A218227 is ``Hilltop maps: number of n X 2 binary arrays indicating the locations of corresponding elements not exceeded by any horizontal, vertical or antidiagonal neighbor in a random 0..2 n X 2 array.''. It has offset $1$ and begins
\[
3, 15, 61, 241, 961, 3839, 15327, 61185,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) + 3*a(n-2) + 3*a(n-3) + 3*a(n-4) + a(n-5) + a(n-6) + a(n-7) + a(n-8) + a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 24 2018 09:38:48, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + 3\,a(n-2) + 3\,a(n-3) + 3\,a(n-4) + a(n-5) + a(n-6) + a(n-7) + a(n-8) + a(n-9)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A218227.
