...
\title{The empirical recurrence for OEIS A232312, proved by transfer matrix}
...
\begin{abstract}
OEIS A232312 counts arrays of width $5$ over $\{0,\dots,1\}$ under a condition on each cell
...
OEIS A232312 is ``Number of (n+1)X(4+1) 0..1 arrays with every element equal to some horizontal or antidiagonal neighbor, with top left element zero.''. It has offset $1$ and begins
\[
52, 853, 14042, 231454, 3815483, 62897985, 1036869496, 17092731689,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 19*a(n-1) -44*a(n-2) +43*a(n-3) -19*a(n-4) +4*a(n-5) -2*a(n-6) for n>7
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 07:17:45, revision 10) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232312.
