...
\title{The empirical recurrence for OEIS A233159, proved by transfer matrix}
...
\begin{abstract}
OEIS A233159 counts arrays over $\{0,\dots,2\}$ in which no two entries that are neighbours in
...
OEIS A233159 is ``Number of 6Xn 0..2 arrays with no element x(i,j) adjacent to value 2-x(i,j) horizontally or antidiagonally.''. It has offset $1$ and begins
\[
729, 6144, 93312, 1417176, 22692312, 367125912, 5986203912, 97881138720,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 07:55:34, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;30\,a(n-1) - 283\,a(n-2) + 1038\,a(n-3) - 573\,a(n-4) - 6705\,a(n-5) + 21056\,a(n-6) - 27636\,a(n-7) + 17216\,a(n-8) - 4128\,a(n-9)
\]
for every $n>15$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A233159.
