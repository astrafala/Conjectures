...
\title{The empirical recurrence for OEIS A205471, proved by transfer matrix}
...
\begin{abstract}
OEIS A205471 counts, up to renaming the letters, the arrays of width $5$ over at most $3$
letters in which all the $2\times2$ subblocks of one array have the SAME number of equal edges, an equal edge being one of the four perimeter edges whose two cells agree; the common value is not named, so the count splits by it. It carries an empirical recurrence of order $45$ contributed by
...
OEIS A205471 is ``Number of (n+1)X5 0..2 arrays with every 2X2 subblock having the same number of equal edges, and new values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
677, 9654, 147129, 2368164, 38649376, 637115198, 10546235416, 175062268404,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 12:08:55, revision 9) this is still
...
$w_i$ cleared of denominators and $S=502$ states in all. The walk index $j$ and the entry's own
...
\begin{theorem}
\[
a(n)\;=\;49\,a(n-1) - 861\,a(n-2) + 5021\,a(n-3) + 33602\,a(n-4) - 616384\,a(n-5) + 2159023\,a(n-6) + 13154843\,a(n-7) - 126262661\,a(n-8) + 166866281\,a(n-9) + 1911261129\,a(n-10) - 8190366005\,a(n-11) - 4199925495\,a(n-12) + 98595747627\,a(n-13) - 158149981614\,a(n-14) - 480297554430\,a(n-15) + 1810623448866\,a(n-16) + 73856868140\,a(n-17) - 8830642410840\,a(n-18) + 10313214783034\,a(n-19) + 20233405349590\,a(n-20) - 52335000413976\,a(n-21) - 5155452594933\,a(n-22) + 125085995184875\,a(n-23) - 89591754726765\,a(n-24) - 148493098940275\,a(n-25) + 234688188015153\,a(n-26) + 38812319081071\,a(n-27) - 279162204744067\,a(n-28) + 118502255969331\,a(n-29) + 160693504928624\,a(n-30) - 157107476872016\,a(n-31) - 21108318004391\,a(n-32) + 83650248017101\,a(n-33) - 23794461371173\,a(n-34) - 18974234968177\,a(n-35) + 12562468145490\,a(n-36) + 410664770730\,a(n-37) - 2327194771228\,a(n-38) + 521150033512\,a(n-39) + 137884941320\,a(n-40) - 72598222160\,a(n-41) + 5036772224\,a(n-42) + 2386207040\,a(n-43) - 520260992\,a(n-44) + 31264768\,a(n-45)
\]
for every $n>44$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A205471.
