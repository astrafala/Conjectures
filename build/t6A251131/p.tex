...
\title{The empirical recurrence for OEIS A251131, proved by transfer matrix}
...
\begin{abstract}
OEIS A251131 counts $(n+1)\times3$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A251131 is ``Number of (n+1) X (2+1) 0..2 arrays with no 2 X 2 subblock having the sum of its diagonal elements greater than the maximum of its antidiagonal elements.''. It has offset $1$ and begins
\[
133, 416, 1002, 2264, 4786, 9786, 19548, 38674,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 6*a(n-1) - 13*a(n-2) + 10*a(n-3) + 5*a(n-4) - 14*a(n-5) + 9*a(n-6) - 2*a(n-7) for n>9.
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 26 2018 06:56:17, revision 10) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251131.
