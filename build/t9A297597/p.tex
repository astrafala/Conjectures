...
\title{The empirical recurrence for OEIS A297597, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297597 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A297597 is ``Number of 4Xn 0..1 arrays with every 1 horizontally, diagonally or antidiagonally adjacent to 1 or 5 neighboring 1s.''. It has offset $1$ and begins
\[
1, 20, 69, 154, 752, 3145, 10131, 37929,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 01 2018 12:10:04, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 3\,a(n-2) + 24\,a(n-3) + 23\,a(n-4) - 17\,a(n-5) - 95\,a(n-6) - 73\,a(n-7) - 45\,a(n-8) - 36\,a(n-9) + 4\,a(n-10) - 4\,a(n-11) + 2\,a(n-12)
\end{equation}
for all $n>13$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297597.
