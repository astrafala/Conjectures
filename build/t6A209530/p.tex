...
\title{The empirical recurrence for OEIS A209530, proved by transfer matrix}
...
\begin{abstract}
OEIS A209530 counts $(n+1)\times3$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A209530 is ``Half the number of (n+1) X 3 0..2 arrays with every 2 X 2 subblock having exactly two distinct clockwise edge differences.''. It has offset $1$ and begins
\[
9, 25, 65, 193, 513, 1537, 4097, 12289,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) + 8*a(n-2) - 8*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 10 2018 14:37:30, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209530.
