...
\title{The empirical recurrence for OEIS A207568, proved by transfer matrix}
...
\begin{abstract}
OEIS A207568 counts arrays over $\{0,\dots,1\}$ of width $7$ that avoid the patterns
$(0,1,1), (1,1,0)$ along one axis and $(0,0,1), (0,1,0)$ along the other, and carries an empirical recurrence of
order $37$ contributed by R.~H.~Hardin. It is true. The patterns have length $3$, so
...
$\mathbf{1}^{\!\top}P^{\,n-2-37}q(P)\mathbf{1}$, which vanishes identically
...
OEIS A207568 is ``Number of 7Xn 0..1 arrays avoiding 0 0 1 and 0 1 0 horizontally and 0 1 1 and 1 1 0 vertically.''. It has offset
$1$ and begins
\[
35, 1225, 4861, 23276, 160652, 738515, 3275898,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:05:25, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;7\,a(n-1) - 12\,a(n-2) + 66\,a(n-3) - 355\,a(n-4) + 267\,a(n-5) - 845\,a(n-6) + 5223\,a(n-7) + 2042\,a(n-8) - 38\,a(n-9) - 35986\,a(n-10) - 32364\,a(n-11) + 462\,a(n-12) + 151576\,a(n-13) + 113718\,a(n-14) - 7212\,a(n-15) - 265050\,a(n-16) - 171750\,a(n-17) + 35538\,a(n-18) + 249492\,a(n-19) + 31110\,a(n-20) - 88254\,a(n-21) - 112194\,a(n-22) + 56598\,a(n-23) + 69082\,a(n-24) + 41276\,a(n-25) - 31470\,a(n-26) - 11664\,a(n-27) - 1085\,a(n-28) + 5229\,a(n-29) - 2218\,a(n-30) - 420\,a(n-31) - 959\,a(n-32) + 257\,a(n-33) - 65\,a(n-34) - 33\,a(n-35) + 32\,a(n-37)
\end{equation}
for all $n>36$. The entry's array has a fixed number of rows and a growing number of
...
$(0,1,1), (1,1,0)$ as $3$ consecutive entries. There are $35$ admissible columns; that condition
...
$a(n)-\sum_i c_i a(n-i)=u_{\,n-2-37}$ whenever $n-37\ge2$. Hence
\eqref{eq:conj} holds for every $n>t$ exactly when $u_j=0$ for every
$j>t-2-37$. Moreover $(u_j)$ satisfies the monic linear recurrence whose
...
$P^{\,n-2-37}$ gives the identity. The equivalence follows by letting the exponent
...
\begin{proof}
The vector $q(P)\mathbf{1}\in\mathbb{Z}^{S}$ was formed by $37$ matrix--vector
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207568.
