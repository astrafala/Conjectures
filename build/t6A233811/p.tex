...
\title{The empirical recurrence for OEIS A233811, proved by transfer matrix}
...
\begin{abstract}
OEIS A233811 counts $(n+1)\times2$ arrays over $\{0,\dots,5\}$ subject to a condition imposed on
...
OEIS A233811 is ``Number of (n+1) X (1+1) 0..5 arrays with every 2 X 2 subblock having the sum of the squares of all six edge and diagonal differences equal to 11.''. It has offset $1$ and begins
\[
96, 428, 1824, 8136, 34848, 155488, 667200, 2977440,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 30*a(n-2) - 220*a(n-4) + 240*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 11 2018 14:08:56, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;30\,a(n-2) - 220\,a(n-4) + 240\,a(n-6)
\end{equation}
for all $n>6$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A233811.
