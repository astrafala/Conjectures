...
\title{The empirical recurrence for OEIS A209226, proved by transfer matrix}
...
\begin{abstract}
OEIS A209226 counts arrays over $\{0,\dots,1\}$ of width $5$ that avoid the patterns
...
OEIS A209226 is ``Number of 5 X n 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 1 0 and 1 1 1 vertically.''. It has offset
$1$ and begins
\[
13, 169, 234, 324, 900, 2500, 6900,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) + 3*a(n-3) + 39*a(n-4) - 21*a(n-5) - 9*a(n-6) - 54*a(n-8) + 27*a(n-9) for n>12.
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 09 2018 08:23:46, revision
8) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 3\,a(n-3) + 39\,a(n-4) - 21\,a(n-5) - 9\,a(n-6) - 54\,a(n-8) + 27\,a(n-9)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209226.
