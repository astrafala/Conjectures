...
\title{The empirical recurrence for OEIS A207758, proved by transfer matrix}
...
\begin{abstract}
OEIS A207758 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
...
OEIS A207758 is ``Number of nX4 0..1 arrays avoiding 0 0 0 and 1 0 1 horizontally and 0 1 1 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
9, 81, 221, 663, 2245, 6459, 17563,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:16:30, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) - 14\,a(n-2) + 30\,a(n-3) - 77\,a(n-4) + 120\,a(n-5) - 153\,a(n-6) + 281\,a(n-7) - 311\,a(n-8) + 236\,a(n-9) - 422\,a(n-10) + 351\,a(n-11) - 110\,a(n-12) + 387\,a(n-13) - 284\,a(n-14) - 3\,a(n-15) - 264\,a(n-16) + 172\,a(n-17) + 52\,a(n-18) + 84\,a(n-19) - 56\,a(n-20) - 24\,a(n-21) - 16\,a(n-22) + 16\,a(n-23)
\end{equation}
for all $n>22$. 
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207758.
