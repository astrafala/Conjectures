...
\title{The empirical recurrence for OEIS A208005, proved by transfer matrix}
...
\begin{abstract}
OEIS A208005 counts arrays over $\{0,\dots,1\}$ of width $6$ that avoid the patterns
$(0,0,1), (1,0,0)$ along one axis and $(0,1,1), (1,1,0)$ along the other, and carries an empirical recurrence of
...
OEIS A208005 is ``Number of nX6 0..1 arrays avoiding 0 0 1 and 1 0 0 horizontally and 0 1 1 and 1 1 0 vertically.''. It has offset
$1$ and begins
\[
22, 484, 1690, 4993, 24512, 90232, 486443,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:33:31, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;9\,a(n-1) - 2\,a(n-2) - 170\,a(n-3) + 392\,a(n-4) + 322\,a(n-5) - 1512\,a(n-6) + 474\,a(n-7) + 1498\,a(n-8) - 942\,a(n-9) - 376\,a(n-10) + 326\,a(n-11) + a(n-12) - 19\,a(n-13)
\end{equation}
for all $n>12$. 
...
$(0,0,1), (1,0,0)$ as $3$ consecutive entries. There are $22$ admissible rows; that condition
...
rows, so $S=484$, and declare $w\to w'$ an edge when $w'$ is $w$ with its first entry
...
values agree exactly, including the initial count of $22$ admissible rows. That is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208005.
