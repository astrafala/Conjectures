...
\title{The empirical recurrence for OEIS A208504, proved by transfer matrix}
...
\begin{abstract}
OEIS A208504 counts arrays over $\{0,\dots,1\}$ of width $6$ that avoid the patterns
$(0,1,0), (1,1,1)$ along one axis and $(0,0,0), (0,0,1)$ along the other, and carries an empirical recurrence of
...
OEIS A208504 is ``Number of 6 X n 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 1 0 and 1 1 1 vertically.''. It has offset
$1$ and begins
\[
19, 361, 456, 1406, 4104, 12654, 37430,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) + 7*a(n-2) - 11*a(n-3) - 4*a(n-4) + 4*a(n-5) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 03 2018 15:16:43, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 7\,a(n-2) - 11\,a(n-3) - 4\,a(n-4) + 4\,a(n-5)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208504.
