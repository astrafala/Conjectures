...
\title{The empirical recurrence for OEIS A253517, proved by transfer matrix}
...
\begin{abstract}
OEIS A253517 counts the arrays over $\{0,\dots,2\}$ whose $2\times2$ subblocks carry a
...
so a pair of consecutive array rows is a state, the count is a walk count on $S=81$ of them,
...
OEIS A253517 is ``Number of (n+1) X (1+1) 0..2 arrays with every 2 X 2 subblock diagonal minimum minus antidiagonal minimum nondecreasing horizontally and diagonal maximum minus antidiagonal maximum nondecreasing vertically.''. It has offset $1$ and begins
\[
81, 470, 2180, 9623, 42669, 192393, 876277, 4010555,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 8*a(n-1) - 15*a(n-2) - 12*a(n-3) + 44*a(n-4) - 8*a(n-5) - 16*a(n-6) for n>13.
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 20 2018 10:17:33, revision 7) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The $2\times2$ subblocks of an $(n+1)\times2$ array over $\{0,\dots,2\}$ form a grid
of $n$ rows and $1$ columns; write $\sigma(i,j)$ for the value the entry's statistic takes on
...
\]
on the $S=81$ admissible pairs. In particular $a$ is $C$-finite. The alignment of the walk
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-1) - 15\,a(n-2) - 12\,a(n-3) + 44\,a(n-4) - 8\,a(n-5) - 16\,a(n-6)
\]
for every $n>13$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253517.
