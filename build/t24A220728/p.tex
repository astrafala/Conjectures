...
\title{The empirical recurrence for OEIS A220728, proved by transfer matrix}
...
\begin{abstract}
OEIS A220728 counts the ways of linking the cells of a grid $4$ cells wide, each cell either to
...
OEIS A220728 is ``Number of ways to reciprocally link elements of an 4Xn array either to themselves or to exactly two horizontal, diagonal or antidiagonal neighbors.''. It has offset $1$ and begins
\[
1, 8, 126, 2586, 52189, 1071230, 21914482, 449023031,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 19:00:38, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;20\,a(n-1) + 55\,a(n-2) - 913\,a(n-3) - 294\,a(n-4) + 1396\,a(n-5) + 6052\,a(n-6) + 11468\,a(n-7) - 1929\,a(n-8) - 29156\,a(n-9) - 69229\,a(n-10) + 5550\,a(n-11) + 77439\,a(n-12) + 61760\,a(n-13) - 10148\,a(n-14) - 26093\,a(n-15) - 24390\,a(n-16) - 1213\,a(n-17) + 12028\,a(n-18) - 1380\,a(n-19) + 1823\,a(n-20) - 1197\,a(n-21) + 66\,a(n-22) + 47\,a(n-23) - 13\,a(n-24) + 2\,a(n-25)
\]
for every $n>24$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A220728.
