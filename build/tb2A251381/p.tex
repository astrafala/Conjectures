...
\title{The empirical column recurrences for the table OEIS A251381}
...
\begin{abstract}
OEIS A251381 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A251381 is ``T(n,k)=Number of (n+1)X(k+1) 0..3 arrays with every 2X2 subblock summing to 5 6 or 7.''. It has offset $1$, is
read by antidiagonals, and begins
\[
124, 1048, 1048, 9124, 19644, 9124, 80296, 385704,\ \dots
\]
The entry carries the following block:
\begin{quote}\small
Empirical for column k:\\
k=1: a(n) = 10*a(n-1) -3*a(n-2) -66*a(n-3) +24*a(n-4)\\
k=2: [order 12]\\
k=3: [order 52]\\
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 10:24:53, revision 6) these are still
...
The sequence is ``Number of (n+1)X(2) 0..3 arrays with every 2X2 subblock summing to 5 6 or 7.''. Its rows are the vertices of a digraph on
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251381.
