...
\title{The empirical recurrence for OEIS A264130, proved by transfer matrix}
...
\begin{abstract}
OEIS A264130 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=7$ rows in which
...
OEIS A264130 is ``Number of (n+1) X (6+1) arrays of permutations of 0..n*7+6 with each element having index change +-(.,.) 0,0 0,2 or 1,2.''. It has offset $1$ and begins
\[
976, 53280, 2920000, 160564000, 8830490000, 485643650000, 26708584500000, 1468872605000000,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 60*a(n-1) - 300*a(n-2) + 1500*a(n-3) - 7500*a(n-4) + 3125*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 05 2019 06:00:16, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;60\,a(n-1) - 300\,a(n-2) + 1500\,a(n-3) - 7500\,a(n-4) + 3125\,a(n-5)
\]
for every $n>5$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264130.
