...
\title{The empirical recurrence for OEIS A258558, proved by transfer matrix}
...
\begin{abstract}
OEIS A258558 counts the arrays over $\{0,\dots,1\}$ whose $2\times2$ subblocks carry a
...
OEIS A258558 is ``Number of (5+1) X (n+1) 0..1 arrays with every 2 X 2 subblock ne-sw antidiagonal difference nondecreasing horizontally and nw+se diagonal sum nondecreasing vertically.''. It has offset $1$ and begins
\[
480, 1329, 2384, 3754, 5070, 6662, 8612, 10720,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) - 3*a(n-2) + a(n-3) + a(n-4) - 3*a(n-5) + 3*a(n-6) - a(n-7) for n>12.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 22 2018 11:33:02, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A258558.
