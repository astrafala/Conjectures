...
\title{The empirical recurrence for OEIS A282371, proved by transfer matrix}
...
\begin{abstract}
OEIS A282371 counts $n\times2$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A282371 is ``Number of n X 2 0..1 arrays with no 1 equal to more than four of its king-move neighbors, with the exception of exactly two elements.''. It has offset $1$ and begins
\[
0, 0, 1, 6, 33, 168, 810, 3780,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 6*a(n-1) - 3*a(n-2) - 12*a(n-3) - 27*a(n-4) - 18*a(n-5) - 9*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 20 2019 12:22:11, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) - 3\,a(n-2) - 12\,a(n-3) - 27\,a(n-4) - 18\,a(n-5) - 9\,a(n-6)
\]
for every $n>6$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A282371.
