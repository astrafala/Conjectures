...
\title{The empirical recurrence for OEIS A206872, proved by transfer matrix}
...
\begin{abstract}
OEIS A206872 counts arrays over $\{0,\dots,1\}$ of width $3$ that avoid the patterns
...
OEIS A206872 is ``Number of 3 X n 0..1 arrays avoiding 0 0 0 horizontally and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
7, 49, 211, 1153, 6139, 31529, 165783,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) + 7*a(n-2) + 27*a(n-3) - 13*a(n-4) + a(n-5) - 31*a(n-6) + 5*a(n-7) - 2*a(n-8) + 4*a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 04 2018 16:14:57, revision
8) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 7\,a(n-2) + 27\,a(n-3) - 13\,a(n-4) + a(n-5) - 31\,a(n-6) + 5\,a(n-7) - 2\,a(n-8) + 4\,a(n-9)
\end{equation}
...
$(1,0,1)$ as $3$ consecutive entries. There are $7$ admissible columns; that condition
...
columns, so $S=49$, and declare $w\to w'$ an edge when $w'$ is $w$ with its first entry
...
values agree exactly, including the initial count of $7$ admissible columns. That is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206872.
