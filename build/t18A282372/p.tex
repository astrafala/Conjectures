...
\title{The empirical recurrence for OEIS A282372, proved by transfer matrix}
...
\begin{abstract}
OEIS A282372 counts $n\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A282372 is ``Number of n X 3 0..1 arrays with no 1 equal to more than four of its king-move neighbors, with the exception of exactly two elements.''. It has offset $1$ and begins
\[
0, 1, 20, 309, 3499, 33692, 309493, 2721044,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 05 2026 13:27:42, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;15\,a(n-1) - 42\,a(n-2) - 112\,a(n-3) - 540\,a(n-4) + 2619\,a(n-5) + 10088\,a(n-6) + 24930\,a(n-7) - 11745\,a(n-8) - 121823\,a(n-9) - 302973\,a(n-10) - 109557\,a(n-11) + 626061\,a(n-12) + 1677252\,a(n-13) + 1111167\,a(n-14) - 1607654\,a(n-15) - 4968711\,a(n-16) - 3987444\,a(n-17) + 1869096\,a(n-18) + 8096727\,a(n-19) + 7157916\,a(n-20) - 59475\,a(n-21) - 6680688\,a(n-22) - 6454986\,a(n-23) - 1842524\,a(n-24) + 1900140\,a(n-25) + 2314704\,a(n-26) + 1190024\,a(n-27) + 304272\,a(n-28) + 37152\,a(n-29) + 1728\,a(n-30)
\]
for every $n>30$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A282372.
