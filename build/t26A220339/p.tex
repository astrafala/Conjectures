...
\title{The empirical recurrence for OEIS A220339, proved by transfer matrix}
...
\begin{abstract}
OEIS A220339 counts the distinct indicator arrays obtained from the $n\times2$ arrays over
...
OEIS A220339 is ``Equals two maps: number of nX2 binary arrays indicating the locations of corresponding elements equal to exactly two of their king-move neighbors in a random 0..3 nX2 array.''. It has offset $1$ and begins
\[
1, 5, 24, 89, 389, 1570, 6413, 25744,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 18:42:53, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + 6\,a(n-2) - 22\,a(n-3) - 15\,a(n-4) + 10\,a(n-5) + 56\,a(n-6) + 34\,a(n-7) - 68\,a(n-8) - 12\,a(n-9) - 247\,a(n-10) + 258\,a(n-11) + 429\,a(n-12) - 176\,a(n-13) - 798\,a(n-14) + 50\,a(n-15) + 1112\,a(n-16) - 368\,a(n-17) - 628\,a(n-18) + 288\,a(n-19) - 56\,a(n-20) - 248\,a(n-21) + 96\,a(n-22)
\]
for every $n>22$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A220339.
