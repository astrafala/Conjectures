...
\title{The empirical recurrence for OEIS A232048, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A232048 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A232048 is ``Number of 2 X n 0..1 arrays with no element less than a strict majority of its horizontal and antidiagonal neighbors.''. It has offset $1$ and begins
\[
4, 7, 15, 34, 79, 184, 426, 984,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 4*a(n-1) - 6*a(n-2) + 7*a(n-3) - 6*a(n-4) + 3*a(n-5) - a(n-6) - a(n-7) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 02 2018 06:31:45, revision 7) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) - 6\,a(n-2) + 7\,a(n-3) - 6\,a(n-4) + 3\,a(n-5) - a(n-6) - a(n-7)
\end{equation}
for all $n>8$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232048.
