...
\title{The empirical recurrence for OEIS A298489, proved by transfer matrix}
...
\begin{abstract}
OEIS A298489 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A298489 is ``Number of nX3 0..1 arrays with every element equal to 0, 1, 2, 4 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
4, 13, 20, 27, 43, 70, 106, 169,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) -2*a(n-2) +3*a(n-3) -9*a(n-4) +4*a(n-5) -a(n-6) +9*a(n-7) -3*a(n-8) -a(n-9) -4*a(n-10) +2*a(n-11) for n>12
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 20 2018 07:05:05, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) - 2\,a(n-2) + 3\,a(n-3) - 9\,a(n-4) + 4\,a(n-5) - a(n-6) + 9\,a(n-7) - 3\,a(n-8) - a(n-9) - 4\,a(n-10) + 2\,a(n-11)
\end{equation}
for all $n>11$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A298489.
