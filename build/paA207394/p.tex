...
\title{The empirical recurrence for OEIS A207394, proved by transfer matrix}
...
\begin{abstract}
OEIS A207394 counts arrays over $\{0,\dots,1\}$ of width $5$ that avoid the patterns
...
OEIS A207394 is ``Number of 5Xn 0..1 arrays avoiding 0 0 1 and 0 1 0 horizontally and 0 0 1 and 1 1 0 vertically.''. It has offset
$1$ and begins
\[
10, 100, 350, 1271, 5348, 19319, 65955,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 13:50:52, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207394.
