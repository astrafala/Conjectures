...
\title{The empirical recurrence for OEIS A305644, proved by transfer matrix}
...
\begin{abstract}
OEIS A305644 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A305644 is ``Number of n X 3 0..1 arrays with every element unequal to 0, 1, 3, 4, 5 or 6 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
3, 9, 13, 31, 79, 168, 430, 1241,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 23 2021 11:23:03, revision
6) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) - 7\,a(n-2) + 17\,a(n-3) - 52\,a(n-4) + 50\,a(n-5) - 48\,a(n-6) + 92\,a(n-7) - 45\,a(n-8) - 17\,a(n-9) + 68\,a(n-10) - 44\,a(n-11) - 5\,a(n-12) - 127\,a(n-13) + 174\,a(n-14) - 54\,a(n-15) - 16\,a(n-16) + 8\,a(n-17)
\end{equation}
for all $n>19$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A305644.
