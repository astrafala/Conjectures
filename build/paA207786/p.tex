...
\title{The empirical recurrence for OEIS A207786, proved by transfer matrix}
...
\begin{abstract}
OEIS A207786 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
...
OEIS A207786 is ``Number of 4Xn 0..1 arrays avoiding 0 0 0 and 0 1 1 horizontally and 0 0 0 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
9, 81, 253, 791, 2173, 5241, 12567,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:18:59, revision
10) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) - 13\,a(n-3) - 6\,a(n-4) + 41\,a(n-5) + 10\,a(n-6) - 57\,a(n-7) - 32\,a(n-8) + 66\,a(n-9) + 18\,a(n-10) - 31\,a(n-11) + 14\,a(n-13) - 30\,a(n-14) + 4\,a(n-15) + 32\,a(n-16) - 13\,a(n-17) - 12\,a(n-18) + a(n-19) + 6\,a(n-20) - 9\,a(n-21) + 12\,a(n-22) - 2\,a(n-23) - 3\,a(n-25) + 2\,a(n-26) - 2\,a(n-27) + a(n-28)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207786.
