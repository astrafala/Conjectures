...
\title{The empirical recurrence for OEIS A206780, proved by transfer matrix}
...
\begin{abstract}
OEIS A206780 counts arrays over $\{0,\dots,1\}$ of width $3$ that avoid the patterns
...
OEIS A206780 is ``Number of nX3 0..1 arrays avoiding 0 0 1 horizontally and 0 1 1 vertically.''. It has offset
$1$ and begins
\[
7, 49, 230, 1020, 4120, 16109, 61003,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 7*a(n-1) -10*a(n-2) -23*a(n-3) +57*a(n-4) +6*a(n-5) -75*a(n-6) +21*a(n-7) +34*a(n-8) -13*a(n-9) -5*a(n-10) +2*a(n-11)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 13:08:43, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;7\,a(n-1) - 10\,a(n-2) - 23\,a(n-3) + 57\,a(n-4) + 6\,a(n-5) - 75\,a(n-6) + 21\,a(n-7) + 34\,a(n-8) - 13\,a(n-9) - 5\,a(n-10) + 2\,a(n-11)
\end{equation}
for all $n>10$. 
...
$(0,0,1)$ as $3$ consecutive entries. There are $7$ admissible rows; that condition
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206780.
