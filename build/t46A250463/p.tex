...
\title{The empirical recurrence for OEIS A250463, proved by transfer matrix}
...
\begin{abstract}
OEIS A250463 counts arrays over $\{0,1\}$ in which a statistic taken over short runs
...
OEIS A250463 is ``Number of (n+1) X (3+1) 0..1 arrays with nondecreasing min(x(i,j),x(i,j-1)) in the i direction and nondecreasing min(x(i,j),x(i-1,j)) in the j direction.''. It has offset $1$ and begins
\[
85, 557, 3476, 21753, 135753, 847278, 5286723, 32988493,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 5*a(n-1) +14*a(n-2) -35*a(n-3) -37*a(n-4) +68*a(n-5) +30*a(n-6) -44*a(n-7) -8*a(n-8) +8*a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 04 2022 11:04:01, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) + 14\,a(n-2) - 35\,a(n-3) - 37\,a(n-4) + 68\,a(n-5) + 30\,a(n-6) - 44\,a(n-7) - 8\,a(n-8) + 8\,a(n-9)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250463.
