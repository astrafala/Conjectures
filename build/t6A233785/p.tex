...
\title{The empirical recurrence for OEIS A233785, proved by transfer matrix}
...
\begin{abstract}
OEIS A233785 counts $(n+1)\times2$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A233785 is ``Number of (n+1) X (1+1) 0..3 arrays with every 2 X 2 subblock having the sum of the squares of all six edge and diagonal differences equal to 11.''. It has offset $1$ and begins
\[
48, 188, 720, 2856, 11040, 43888, 169920, 675744,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 18*a(n-2) - 40*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 11 2018 14:08:50, revision 7) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A233785.
