...
\title{The empirical recurrence for OEIS A233638, proved by transfer matrix}
...
\begin{abstract}
OEIS A233638 counts $(n+1)\times3$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A233638 is ``Number of (n+1) X (2+1) 0..2 arrays with every 2 X 2 subblock having the sum of the squares of the edge differences equal to 2.''. It has offset $1$ and begins
\[
90, 534, 3004, 17424, 99380, 572192, 3277236, 18825580,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 6*a(n-1) + 9*a(n-2) - 67*a(n-3) + 26*a(n-4) + 81*a(n-5) - 48*a(n-6) + 2*a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 11 2018 09:02:03, revision 7) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) + 9\,a(n-2) - 67\,a(n-3) + 26\,a(n-4) + 81\,a(n-5) - 48\,a(n-6) + 2\,a(n-7)
\end{equation}
for all $n>7$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A233638.
