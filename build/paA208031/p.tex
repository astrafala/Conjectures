...
\title{The empirical recurrence for OEIS A208031, proved by transfer matrix}
...
\begin{abstract}
OEIS A208031 counts arrays over $\{0,\dots,1\}$ of width $6$ that avoid the patterns
...
OEIS A208031 is ``Number of 6Xn 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 0 0 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
19, 361, 1995, 17119, 123709, 955073, 7184755,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 5*a(n-1) +30*a(n-2) -64*a(n-3) -157*a(n-4) +303*a(n-5) +101*a(n-6) -262*a(n-7) -23*a(n-8) +64*a(n-9) -4*a(n-11)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:35:17, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) + 30\,a(n-2) - 64\,a(n-3) - 157\,a(n-4) + 303\,a(n-5) + 101\,a(n-6) - 262\,a(n-7) - 23\,a(n-8) + 64\,a(n-9) - 4\,a(n-11)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208031.
