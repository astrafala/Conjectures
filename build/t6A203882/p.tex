...
\title{The empirical recurrence for OEIS A203882, proved by transfer matrix}
...
\begin{abstract}
OEIS A203882 counts $(n+1)\times4$ arrays over $\{0,\dots,6\}$ subject to a condition imposed on
...
on $S=2401$ vertices whose edges are the admissible consecutive pairs, and the count is a
...
OEIS A203882 is ``Number of (n+1) X 4 0..6 arrays with every 2 X 2 subblock having equal diagonal elements or equal antidiagonal elements.''. It has offset $1$ and begins
\[
107653, 7501753, 543848893, 39572771665, 2880436707253, 209668438383145, 15261911634884845, 1110925438997643073,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 79*a(n-1) -450*a(n-2) -144*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 05 2018 11:37:32, revision 8) the statement is
...
$V=\{0,1,\dots,6\}^{4}$, so $|V|=S=2401$. A $2\times2$ subblock of the array
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A203882.
