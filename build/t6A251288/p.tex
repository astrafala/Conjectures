...
\title{The empirical recurrence for OEIS A251288, proved by transfer matrix}
...
\begin{abstract}
OEIS A251288 counts $(n+1)\times5$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A251288 is ``Number of (n+1)X(4+1) 0..1 arrays with every 2X2 subblock having a single 1 or two 1s on the same edge or main diagonally.''. It has offset $1$ and begins
\[
125, 701, 3390, 18924, 94706, 518711, 2645966, 14292754,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:14:30, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 40\,a(n-2) - 55\,a(n-3) - 533\,a(n-4) + 518\,a(n-5) + 3271\,a(n-6) - 2001\,a(n-7) - 10562\,a(n-8) + 2928\,a(n-9) + 17984\,a(n-10) - 637\,a(n-11) - 15411\,a(n-12) - 1198\,a(n-13) + 6419\,a(n-14) + 561\,a(n-15) - 1099\,a(n-16) - 18\,a(n-17) + 50\,a(n-18) - 2\,a(n-19)
\end{equation}
for all $n>19$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251288.
