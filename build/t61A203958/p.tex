...
\title{The empirical recurrence for OEIS A203958, proved by transfer matrix}
...
\begin{abstract}
OEIS A203958 counts arrays of width $2$ over $\{0,1,2\}$ through two derived arrays of PAIR SUMS ---
...
OEIS A203958 is ``Number of (n+1) X 2 0..2 arrays with column and row pair sums b(i,j)=a(i,j)+a(i,j-1) and c(i,j)=a(i,j)+a(i-1,j) such that rows of b(i,j) and columns of c(i,j) are lexicographically nondecreasing.''. It has offset $1$ and begins
\[
32, 121, 447, 1579, 5352, 17559, 56219, 176797,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 10*a(n-1) -40*a(n-2) +82*a(n-3) -91*a(n-4) +52*a(n-5) -12*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 06 2018 05:05:23, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A203958.
