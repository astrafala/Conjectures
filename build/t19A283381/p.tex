...
\title{The empirical recurrence for OEIS A283381, proved by transfer matrix}
...
\begin{abstract}
OEIS A283381 counts $n\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
walk, and $a(n)$ is a walk count on $S=173$ vertices, which is $C$-finite. Whether the
...
OEIS A283381 is ``Number of nX3 0..1 arrays with no 1 equal to more than two of its horizontal, vertical and antidiagonal neighbors, with the exception of exactly two elements.''. It has offset $1$ and begins
\[
0, 3, 60, 532, 4420, 34531, 257416, 1862717,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 06 2017 17:03:56, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;15\,a(n-1) - 59\,a(n-2) - 23\,a(n-3) + 174\,a(n-4) + 801\,a(n-5) + 482\,a(n-6) - 304\,a(n-7) - 1907\,a(n-8) - 201\,a(n-9) + 416\,a(n-10) + 2195\,a(n-11) - 1927\,a(n-12) + 144\,a(n-13) - 2255\,a(n-14) + 4199\,a(n-15) - 2655\,a(n-16) + 3200\,a(n-17) - 5076\,a(n-18) + 5003\,a(n-19) - 4510\,a(n-20) + 5401\,a(n-21) - 5925\,a(n-22) + 5360\,a(n-23) - 4834\,a(n-24) + 4242\,a(n-25) - 3201\,a(n-26) + 2056\,a(n-27) - 1214\,a(n-28) + 632\,a(n-29) - 252\,a(n-30) + 64\,a(n-31) - 8\,a(n-32)
\]
for every $n>32$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A283381.
