...
\title{The empirical recurrence for OEIS A304342, proved by transfer matrix}
...
\begin{abstract}
OEIS A304342 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A304342 is ``Number of nX3 0..1 arrays with every element unequal to 0, 1, 2, 4 or 5 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
4, 14, 27, 71, 225, 613, 1752, 5102,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 11 2018 14:13:34, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 3\,a(n-2) + 6\,a(n-3) - 11\,a(n-4) - 25\,a(n-5) - 27\,a(n-6) + 19\,a(n-7) + 61\,a(n-8) + 59\,a(n-9) - 39\,a(n-11) - 13\,a(n-12) - 14\,a(n-13) - 20\,a(n-14) - 24\,a(n-15)
\end{equation}
for all $n>15$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A304342.
