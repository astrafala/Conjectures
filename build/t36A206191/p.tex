...
\title{The empirical recurrence for OEIS A206191, proved by transfer matrix}
...
\begin{abstract}
OEIS A206191 counts arrays over $\{0,\dots,3\}$ under a condition on the number of clockwise edge increases
in every $2\times2$ subblock, and carries an empirical recurrence of order $10$ contributed by
...
OEIS A206191 is ``Number of (n+1) X 3 0..3 arrays with the number of clockwise edge increases in every 2 X 2 subblock equal to two.''. It has offset $1$ and begins
\[
1012, 18172, 329216, 5972392, 108363344, 1966171084, 35674679732, 647289744976,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 05 2026 15:35:43, revision 11) this is still
...
subblocks; the entry's first term is $1012$, which the model
...
\begin{theorem}
\[
a(n)\;=\;23\,a(n-1) - 97\,a(n-2) + 169\,a(n-3) - 151\,a(n-4) + 250\,a(n-5) - 178\,a(n-6) + 66\,a(n-7) - 64\,a(n-8) + 8\,a(n-9) + 4\,a(n-10)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206191.
