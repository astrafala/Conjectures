...
\title{The empirical recurrence for OEIS A297854, proved by transfer matrix}
...
\begin{abstract}
OEIS A297854 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $equal to$ itself lying in $\{1,2,4\}$, and it carries an empirical
...
OEIS A297854 is ``Number of nX4 0..1 arrays with every element equal to 1, 2 or 4 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
2, 13, 19, 30, 53, 90, 145, 244,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 07 2018 10:38:47, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + a(n-2) - a(n-3) - 2\,a(n-4) + 2\,a(n-5) + a(n-6) - 22\,a(n-7) + 22\,a(n-9) + 16\,a(n-10) + 14\,a(n-11) + 10\,a(n-12) - 4\,a(n-13) - 40\,a(n-14) - 26\,a(n-15) - 24\,a(n-16) - 12\,a(n-17) - 9\,a(n-18) + 33\,a(n-19) + 55\,a(n-20) + 13\,a(n-21) + 6\,a(n-22) + 10\,a(n-23) + 31\,a(n-24) - 24\,a(n-25) - 29\,a(n-26) - 4\,a(n-27) - 31\,a(n-28) - 25\,a(n-29) + 6\,a(n-30) + 22\,a(n-31) + 10\,a(n-32)
\end{equation}
for all $n>36$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297854.
