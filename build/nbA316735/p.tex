...
\title{The empirical recurrence for OEIS A316735, proved by transfer matrix}
...
\begin{abstract}
OEIS A316735 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A316735 is ``Number of nX3 0..1 arrays with every element unequal to 1, 2, 3, 6, 7 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 14, 23, 36, 210, 509, 1219, 4537,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 11 2018 20:30:47, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 4\,a(n-2) + 12\,a(n-3) - 6\,a(n-4) - 36\,a(n-5) - 28\,a(n-6) + a(n-7) + 42\,a(n-8) + 15\,a(n-9) + 12\,a(n-10) - 2\,a(n-11) - 4\,a(n-12) - 16\,a(n-13) - 8\,a(n-14)
\end{equation}
for all $n>15$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A316735.
