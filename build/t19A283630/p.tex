...
\title{The empirical recurrence for OEIS A283630, proved by transfer matrix}
...
\begin{abstract}
OEIS A283630 counts $n\times4$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
walk, and $a(n)$ is a walk count on $S=424$ vertices, which is $C$-finite. Whether the
...
OEIS A283630 is ``Number of nX4 0..1 arrays with no 1 equal to more than one of its horizontal, diagonal and antidiagonal neighbors, with the exception of exactly two elements.''. It has offset $1$ and begins
\[
1, 36, 639, 7742, 85469, 856710, 8209582, 75625580,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 12 2017 14:28:25, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;18\,a(n-1) - 78\,a(n-2) - 186\,a(n-3) + 1365\,a(n-4) + 234\,a(n-5) - 4523\,a(n-6) + 15594\,a(n-7) + 6057\,a(n-8) - 60614\,a(n-9) + 66588\,a(n-10) + 51762\,a(n-11) - 313536\,a(n-12) + 181776\,a(n-13) + 367095\,a(n-14) - 650452\,a(n-15) + 214245\,a(n-16) + 853410\,a(n-17) - 640177\,a(n-18) - 457782\,a(n-19) + 317076\,a(n-20) + 100568\,a(n-21) - 60480\,a(n-22) - 7680\,a(n-23) + 4096\,a(n-24)
\]
for every $n>24$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A283630.
