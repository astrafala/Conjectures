...
\title{The empirical recurrence for OEIS A299716, proved by transfer matrix}
...
\begin{abstract}
OEIS A299716 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $equal to$ itself lying in $\{0,2,3,4,5,6,7\}$, and it carries an empirical
...
OEIS A299716 is ``Number of nX3 0..1 arrays with every element equal to 0, 2, 3, 4, 5, 6 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 13, 46, 246, 1205, 6354, 33804, 182056,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 17 2018 10:38:08, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) + 11\,a(n-2) - 30\,a(n-3) - 94\,a(n-4) + 6\,a(n-5) + 166\,a(n-6) + 73\,a(n-7) - 28\,a(n-8) + 30\,a(n-9) - 24\,a(n-10) - 50\,a(n-11) - 6\,a(n-12)
\end{equation}
for all $n>13$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A299716.
