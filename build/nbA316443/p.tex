...
\title{The empirical recurrence for OEIS A316443, proved by transfer matrix}
...
\begin{abstract}
OEIS A316443 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $different from$ itself lying in $\{1,2,3,5,6,8\}$, and it carries an empirical
...
OEIS A316443 is ``Number of nX3 0..1 arrays with every element unequal to 1, 2, 3, 5, 6 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 16, 57, 182, 712, 2832, 10696, 41107,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 03 2018 09:09:16, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 5\,a(n-2) + 5\,a(n-3) - 32\,a(n-4) - 53\,a(n-5) - 23\,a(n-6) + 52\,a(n-7) + 182\,a(n-8) + 130\,a(n-9) + 9\,a(n-10) - 218\,a(n-11) - 171\,a(n-12) - 42\,a(n-13) + 59\,a(n-14) + 113\,a(n-15) + 35\,a(n-16) - 30\,a(n-17) - 34\,a(n-18) - 2\,a(n-19) + 4\,a(n-20)
\end{equation}
for all $n>20$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A316443.
