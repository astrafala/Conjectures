...
carried by one bounded piece of extra state, so the count is a walk count on $S=1310$ states.
\end{abstract}
...
and every first appearance it contains. There are $S=1310$ reachable states.
