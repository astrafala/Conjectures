...
\title{The empirical recurrence for OEIS A318039, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A318039 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A318039 is ``Number of nX2 0..1 arrays with every element unequal to 0, 2, 3 or 4 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
1, 2, 2, 3, 6, 17, 46, 124,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) -a(n-2) +a(n-3) +a(n-4) -2*a(n-5) -a(n-6) for n>7
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 13 2018 14:29:41, revision 4) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A318039.
