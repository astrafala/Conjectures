...
\title{The empirical recurrence for OEIS A296985, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A296985 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A296985 is ``Number of nX3 0..1 arrays with each 1 adjacent to 3, 4 or 5 king-move neighboring 1s.''. It has offset $1$ and begins
\[
1, 4, 14, 28, 98, 447, 1653, 6507,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 22 2017 18:22:54, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 2\,a(n-2) + 19\,a(n-3) - 19\,a(n-4) - 52\,a(n-5) - 67\,a(n-6) + 15\,a(n-7) + 155\,a(n-8) + 207\,a(n-9) - 104\,a(n-10) - 157\,a(n-11) - 172\,a(n-12) + 53\,a(n-13) + 63\,a(n-14) + 38\,a(n-15) + 14\,a(n-16) + 19\,a(n-17) + 3\,a(n-18) + 4\,a(n-19) + 2\,a(n-20)
\end{equation}
for all $n>21$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A296985.
