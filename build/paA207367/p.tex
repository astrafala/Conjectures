...
\title{The empirical recurrence for OEIS A207367, proved by transfer matrix}
...
\begin{abstract}
OEIS A207367 counts arrays over $\{0,\dots,1\}$ of width $7$ that avoid the patterns
...
OEIS A207367 is ``Number of nX7 0..1 arrays avoiding 0 0 0 and 0 1 1 horizontally and 0 0 1 and 0 1 1 vertically.''. It has offset
$1$ and begins
\[
25, 625, 3025, 14641, 45738, 142884, 353808,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 13:49:34, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207367.
