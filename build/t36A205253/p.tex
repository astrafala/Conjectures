...
\title{The empirical recurrence for OEIS A205253, proved by transfer matrix}
...
\begin{abstract}
OEIS A205253 counts arrays over $\{0,\dots,1\}$ under a condition on the number of clockwise edge increases
...
OEIS A205253 is ``Number of (n+1)X7 0..1 arrays with the number of clockwise edge increases in every 2X2 subblock the same.''. It has offset $1$ and begins
\[
2920, 71000, 1764364, 44183032, 1109832184, 27913330476, 702420750928, 17679917387408,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 11:55:07, revision 9) this is still
...
a state and rows $r,s$ may follow one another when all $6$ of their subblocks give $v$.
...
subblocks; the entry's first term is $2920$, which the model
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A205253.
