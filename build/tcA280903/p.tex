...
\title{The empirical recurrence for OEIS A280903, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A280903 imposes three things at once: a condition on each cell that reaches one column up and
...
OEIS A280903 is ``Number of 2Xn 0..2 arrays with no element equal to more than one of its horizontal and antidiagonal neighbors, with the exception of exactly two elements, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
0, 1, 10, 213, 2292, 21762, 184076, 1457827,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 10 2017 10:26:34, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;15\,a(n-1) - 57\,a(n-2) - 88\,a(n-3) + 651\,a(n-4) + 333\,a(n-5) - 2520\,a(n-6) - 939\,a(n-7) + 4569\,a(n-8) + 1456\,a(n-9) - 4131\,a(n-10) - 933\,a(n-11) + 1793\,a(n-12) + 60\,a(n-13) - 336\,a(n-14) + 64\,a(n-15)
\end{equation}
for all $n>17$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A280903.
