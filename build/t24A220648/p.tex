...
\title{The empirical recurrence for OEIS A220648, proved by transfer matrix}
...
\begin{abstract}
OEIS A220648 counts the ways of linking the cells of a grid $3$ cells wide, each cell either to
...
state, the count is a walk count on $S=101$ of them, and the conjectured recurrence is then
...
OEIS A220648 is ``Number of ways to reciprocally link elements of an nX3 array either to themselves or to exactly two king-move neighbors, without 3-loops.''. It has offset $1$ and begins
\[
1, 23, 333, 4352, 59846, 816159, 11131560, 151872860,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 18:56:18, revision 8) this is still
...
one configuration. With $M$ the adjacency matrix of the digraph on the $S=101$ reachable
...
\begin{theorem}
\[
a(n)\;=\;9\,a(n-1) + 55\,a(n-2) + 119\,a(n-3) - 44\,a(n-4) - 388\,a(n-5) - 58\,a(n-6) + 355\,a(n-7) + 79\,a(n-8) - 85\,a(n-9) - 13\,a(n-10)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A220648.
