...
\title{The empirical recurrence for OEIS A183388, proved by transfer matrix}
...
\begin{abstract}
OEIS A183388 counts $n\times4$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A183388 is ``Half the number of n X 4 binary arrays with no element unequal to a strict majority of its king-move neighbors.''. It has offset $1$ and begins
\[
2, 2, 2, 4, 8, 16, 36, 74,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + 2*a(n-2) - a(n-3) - 4*a(n-4) - 3*a(n-5) - a(n-6) - a(n-7) + 2*a(n-8) for n>9.
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 28 2018 08:13:33, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 2\,a(n-2) - a(n-3) - 4\,a(n-4) - 3\,a(n-5) - a(n-6) - a(n-7) + 2\,a(n-8)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A183388.
