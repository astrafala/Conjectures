...
\title{The empirical recurrence for OEIS A316171, proved by transfer matrix}
...
\begin{abstract}
OEIS A316171 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $different from$ itself lying in $\{1,2,4,5,6,7\}$, and it carries an empirical
...
OEIS A316171 is ``Number of nX3 0..1 arrays with every element unequal to 1, 2, 4, 5, 6 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 11, 16, 34, 113, 275, 604, 1804,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 25 2018 17:36:48, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 3\,a(n-2) + 16\,a(n-3) - 7\,a(n-4) - 48\,a(n-5) - 97\,a(n-6) - a(n-7) + 213\,a(n-8) + 247\,a(n-9) + 83\,a(n-10) - 282\,a(n-11) - 215\,a(n-12) + 10\,a(n-13) + 105\,a(n-14) - 81\,a(n-15) - 80\,a(n-16) - 38\,a(n-17) - 4\,a(n-18)
\end{equation}
for all $n>19$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A316171.
