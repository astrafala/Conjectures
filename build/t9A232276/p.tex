...
\title{The empirical recurrence for OEIS A232276, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A232276 counts arrays over $\{0,\dots,2\}$ in which every cell is constrained by the
...
OEIS A232276 is ``Number of nX3 0..2 arrays with no element less than a strict majority of its horizontal, diagonal and antidiagonal neighbors.''. It has offset $1$ and begins
\[
9, 199, 1672, 18117, 184115, 1774344, 17764558, 178471267,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 07:14:12, revision 7) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;9\,a(n-1) - 18\,a(n-2) + 519\,a(n-3) - 2040\,a(n-4) + 3043\,a(n-5) - 74525\,a(n-6) + 72611\,a(n-7) - 419003\,a(n-8) + 2780261\,a(n-9) + 746621\,a(n-10) + 13183774\,a(n-11) - 19468140\,a(n-12) - 36145594\,a(n-13) - 110263109\,a(n-14) - 133899468\,a(n-15) + 334282595\,a(n-16) + 329786843\,a(n-17) + 1622613490\,a(n-18) - 411666702\,a(n-19) - 727313352\,a(n-20) - 3837079952\,a(n-21) - 4919529456\,a(n-22) + 1329556928\,a(n-23) + 366342080\,a(n-24) + 11429099072\,a(n-25) + 4372362240\,a(n-26) + 665206272\,a(n-27) + 601740288\,a(n-28) - 11698587648\,a(n-29) + 503857152\,a(n-30) - 3370954752\,a(n-31) - 586579968\,a(n-32) + 3368189952\,a(n-33) - 743178240\,a(n-34) + 1401421824\,a(n-35)
\end{equation}
for all $n>36$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232276.
