...
\title{The empirical recurrence for OEIS A283226, proved by transfer matrix}
...
\begin{abstract}
OEIS A283226 counts $n\times2$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A283226 is ``Number of n X 2 0..1 arrays with no 1 equal to more than two of its horizontal and vertical neighbors, with the exception of exactly two elements.''. It has offset $1$ and begins
\[
0, 0, 1, 6, 49, 272, 1376, 6620,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 25 2022 09:05:37, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;9\,a(n-1) - 21\,a(n-2) - 3\,a(n-3) + 3\,a(n-4) + 81\,a(n-5) + 71\,a(n-6) + 21\,a(n-7) - 51\,a(n-8) - 61\,a(n-9) - 15\,a(n-10) + 15\,a(n-11) + 17\,a(n-12) + 3\,a(n-13) - 3\,a(n-14) - a(n-15)
\]
for every $n>15$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A283226.
