...
\title{The empirical recurrence for OEIS A263970, proved by transfer matrix}
...
\begin{abstract}
OEIS A263970 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=4$ rows in which
...
OEIS A263970 is ``Number of (n+1)X(3+1) arrays of permutations of 0..n*4+3 with each element having index change (+-,+-) 0,2 1,1 or 1,0.''. It has offset $1$ and begins
\[
108, 1817, 86633, 2940624, 118376593, 4465927225, 173624682220, 6667558559121,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 10 2015 10:28:35, revision 6) this is still
...
\[
(i-h_i,\,j-h_j)\;\in\;\{(-1,-1),\ (-1,0),\ (-1,1),\ (0,-2),\ (0,2),\ (1,-1),\ (1,0),\ (1,1)\},
\]
...
\begin{theorem}
\[
a(n)\;=\;48\,a(n-1) - 111\,a(n-2) - 13143\,a(n-3) + 131701\,a(n-4) + 59295\,a(n-5) - 4720800\,a(n-6) + 12779427\,a(n-7) + 19382471\,a(n-8) - 116442296\,a(n-9) + 280725335\,a(n-10) - 381462119\,a(n-11) - 578575706\,a(n-12) + 1756342049\,a(n-13) - 3626876273\,a(n-14) + 4852378354\,a(n-15) + 1964306003\,a(n-16) - 4666835695\,a(n-17) + 1402574008\,a(n-18) - 678640843\,a(n-19) + 169204617\,a(n-20) + 35040960\,a(n-21) - 9205311\,a(n-22) + 2141847\,a(n-23) - 540093\,a(n-24) - 13833\,a(n-25) + 11952\,a(n-26) - 675\,a(n-27)
\]
for every $n>25$.
\end{theorem}
...
transposed companion A263966. Second, the transfer model reproduces all $14$ terms this
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A263970.
