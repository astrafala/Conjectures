...
\title{The empirical recurrence for OEIS A223373, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A223373 counts arrays over $\{0,\dots,8\}$ in which every cell is constrained by the
...
OEIS A223373 is ``3 X 3 square grid graph coloring a rectangular array: number of n X 2 0..8 arrays where 0..8 label nodes of the square grid graph and every array movement to a horizontal or vertical neighbor moves along an edge of this graph.''. It has offset $1$ and begins
\[
24, 144, 912, 5808, 37008, 235824, 1502736, 9575856,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 7*a(n-1) - 4*a(n-2).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 16 2018 07:10:22, revision 7) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223373.
