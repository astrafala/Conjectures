...
\title{The empirical recurrence for OEIS A208122, proved by transfer matrix}
...
\begin{abstract}
OEIS A208122 counts arrays over $\{0,\dots,1\}$ of width $7$ that avoid the patterns
...
OEIS A208122 is ``Number of 7Xn 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 0 1 and 0 1 1 vertically.''. It has offset
$1$ and begins
\[
20, 400, 1260, 3969, 34713, 303601, 1432600,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:39:36, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) - 12\,a(n-2) + 55\,a(n-3) + 805\,a(n-4) + 900\,a(n-5) + 10320\,a(n-6) - 123840\,a(n-8) - 129600\,a(n-9) - 1391040\,a(n-10) - 1140480\,a(n-11) + 2985984\,a(n-12) - 2985984\,a(n-13) + 35831808\,a(n-14)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208122.
