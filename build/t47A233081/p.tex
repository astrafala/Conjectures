...
\title{The empirical recurrence for OEIS A233081, proved by transfer matrix}
...
\begin{abstract}
OEIS A233081 counts arrays over $\{0,\dots,3\}$ in which no two entries that are neighbours in
...
carried by one bounded piece of extra state, so the count is a walk count on $S=42$ states.
\end{abstract}
...
OEIS A233081 is ``Number of nX7 0..3 arrays with no element x(i,j) adjacent to value 3-x(i,j) horizontally or antidiagonally, top left element zero, and 1 appearing before 2 in row major order.''. It has offset $1$ and begins
\[
365, 226895, 141615905, 88417171553, 55204524946337, 34467813715307081, 21520525142517911969, 13436680693956706599305,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 693*a(n-1) -44261*a(n-2) +890611*a(n-3) -7150206*a(n-4) +22034516*a(n-5) -15731352*a(n-6)
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 07:51:31, revision 6) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The array is $7$ cells across with entries $x(i,j)\in\{0,1,2,3\}$. Call two values $u,v$ CLASHING
...
$2^{2}$ values, and the state of the walk is a pair (array row, set $T$).
...
and every first appearance it contains. There are $S=42$ reachable states.
...
\begin{theorem}
\[
a(n)\;=\;693\,a(n-1) - 44261\,a(n-2) + 890611\,a(n-3) - 7150206\,a(n-4) + 22034516\,a(n-5) - 15731352\,a(n-6)
\]
for every $n>6$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A233081.
