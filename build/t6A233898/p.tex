...
\title{The empirical recurrence for OEIS A233898, proved by transfer matrix}
...
\begin{abstract}
OEIS A233898 counts $(n+1)\times3$ arrays over $\{0,\dots,6\}$ subject to a condition imposed on
every $2\times2$ subblock, and carries an empirical recurrence of order $26$ contributed
...
on $S=343$ vertices whose edges are the admissible consecutive pairs, and the count is a
...
OEIS A233898 is ``Number of (n+1)X(2+1) 0..6 arrays with every 2X2 subblock having the sum of the squares of all six edge and diagonal differences equal to 35.''. It has offset $1$ and begins
\[
656, 2944, 12152, 62064, 278416, 1521520, 7123728, 40312912,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 09:03:50, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) + 100\,a(n-2) - 653\,a(n-3) - 3922\,a(n-4) + 29350\,a(n-5) + 75333\,a(n-6) - 716686\,a(n-7) - 663724\,a(n-8) + 10557778\,a(n-9) - 189287\,a(n-10) - 98135157\,a(n-11) + 62654351\,a(n-12) + 580526450\,a(n-13) - 642463362\,a(n-14) - 2125031984\,a(n-15) + 3275337984\,a(n-16) + 4379131280\,a(n-17) - 9343912016\,a(n-18) - 3557715392\,a(n-19) + 14269816000\,a(n-20) - 2397660416\,a(n-21) - 9497517824\,a(n-22) + 4983344128\,a(n-23) + 925209600\,a(n-24) - 965386240\,a(n-25) + 130457600\,a(n-26)
\end{equation}
for all $n>26$.
...
$V=\{0,1,\dots,6\}^{3}$, so $|V|=S=343$. A $2\times2$ subblock of the array
...
(\beta-\alpha)^2+(\delta-\beta)^2+(\gamma-\delta)^2+(\alpha-\gamma)^2+(\delta-\alpha)^2+(\gamma-\beta)^2=35,
\end{equation}
...
For every $n$ with $n+1-1\ge26$,
\[
a(n)-\sum_i c_i\,a(n-i)\;=\;\mathbf{1}^{\!\top}M^{\,n+1-1-26}\,q(M)\,\mathbf{1} .
\]
...
=\mathbf{1}^{\!\top}M^{\,m-26}\,q(M)\,\mathbf{1}
\]
...
$m-26=j$ run over $\ge0$. For the last clause put $w=q(M)\mathbf{1}$. By the
...
$S^2$ pairs. The vector $w=q(M)\mathbf{1}\in\mathbb{Z}^{S}$ was then formed by $26$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A233898.
