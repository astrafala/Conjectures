...
\title{The empirical recurrence for OEIS A197064, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A197064 counts arrays over $\{0,\dots,4\}$ in which every cell is constrained by the
...
OEIS A197064 is ``Number of nX3 0..4 arrays with each element x equal to the number its horizontal and vertical neighbors equal to 4,1,3,0,2 for x=0,1,2,3,4.''. It has offset $1$ and begins
\[
3, 11, 76, 408, 2026, 10582, 55882, 292564,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 06:56:01, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 8\,a(n-2) + 32\,a(n-3) + 58\,a(n-4) + 96\,a(n-5) + 37\,a(n-6) - 10\,a(n-7) - 4\,a(n-8) - 26\,a(n-9) + 3\,a(n-10) - 2\,a(n-11) - a(n-12)
\end{equation}
for all $n>13$.
...
\#\{\text{neighbours with value }f(x_{t,u})\}=x_{t,u},\quad f=(4,1,3,0,2)
\end{equation}
for every cell $(t,u)$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A197064.
