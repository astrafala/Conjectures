...
\title{The empirical recurrence for OEIS A251484, proved by transfer matrix}
...
\begin{abstract}
OEIS A251484 counts $(n+1)\times2$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A251484 is ``Number of (n+1) X (1+1) 0..3 arrays with no 2 X 2 subblock having the sum of its diagonal elements less than the minimum of its antidiagonal elements.''. It has offset $1$ and begins
\[
236, 3456, 50576, 740096, 10830016, 158478336, 2319053056, 33935282176,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 16*a(n-1) - 20*a(n-2).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 29 2018 16:29:20, revision 9) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251484.
