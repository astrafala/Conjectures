...
\title{The empirical recurrence for OEIS A283038, proved by transfer matrix}
...
\begin{abstract}
OEIS A283038 counts $n\times4$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
walk, and $a(n)$ is a walk count on $S=279$ vertices, which is $C$-finite. Whether the
...
OEIS A283038 is ``Number of nX4 0..1 arrays with no 1 equal to more than one of its horizontal and vertical neighbors, with the exception of exactly one element.''. It has offset $1$ and begins
\[
2, 68, 818, 9152, 94368, 931844, 8912378, 83420984,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 27 2017 08:56:36, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-1) + 38\,a(n-2) - 98\,a(n-3) - 1221\,a(n-4) - 3374\,a(n-5) - 1845\,a(n-6) + 8406\,a(n-7) + 14610\,a(n-8) - 5894\,a(n-9) - 20336\,a(n-10) + 9134\,a(n-11) + 9660\,a(n-12) - 7192\,a(n-13) + 3651\,a(n-14) - 16004\,a(n-15) + 9859\,a(n-16) + 3230\,a(n-17) - 14482\,a(n-18) + 15860\,a(n-19) - 16472\,a(n-20) + 13768\,a(n-21) - 9574\,a(n-22) + 4838\,a(n-23) - 2040\,a(n-24) + 772\,a(n-25) - 272\,a(n-26) + 84\,a(n-27) - 16\,a(n-28) + 4\,a(n-29) - a(n-30)
\]
for every $n>30$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A283038.
