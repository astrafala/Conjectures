...
\title{The empirical recurrence for OEIS A208109, proved by transfer matrix}
...
\begin{abstract}
OEIS A208109 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
...
OEIS A208109 is ``Number of 4 X n 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 1 1 and 1 1 0 vertically.''. It has offset
$1$ and begins
\[
9, 81, 171, 361, 1805, 9025, 25555,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) + 8*a(n-3) + 61*a(n-4) - 66*a(n-5) - 48*a(n-6) - 252*a(n-8) + 216*a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 28 2018 08:25:26, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 8\,a(n-3) + 61\,a(n-4) - 66\,a(n-5) - 48\,a(n-6) - 252\,a(n-8) + 216\,a(n-9)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208109.
