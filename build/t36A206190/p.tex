...
\title{The empirical recurrence for OEIS A206190, proved by transfer matrix}
...
\begin{abstract}
OEIS A206190 counts arrays over $\{0,\dots,3\}$ under a condition on the number of clockwise edge increases
...
OEIS A206190 is ``Number of (n+1) X 2 0..3 arrays with the number of clockwise edge increases in every 2 X 2 subblock equal to two.''. It has offset $1$ and begins
\[
124, 1012, 8304, 68180, 559788, 4596072, 37735460, 309822148,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 9*a(n-1) - 7*a(n-2) + 4*a(n-3) + 2*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 14 2018 08:05:31, revision 10) this is still
...
subblock; the entry's first term is $124$, which the model
...
\begin{theorem}
\[
a(n)\;=\;9\,a(n-1) - 7\,a(n-2) + 4\,a(n-3) + 2\,a(n-4)
\]
for every $n>3$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206190.
