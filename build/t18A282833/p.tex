...
\title{The empirical recurrence for OEIS A282833, proved by transfer matrix}
...
\begin{abstract}
OEIS A282833 counts $n\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A282833 is ``Number of nX3 0..1 arrays with no 1 equal to more than one of its king-move neighbors, with the exception of exactly two elements.''. It has offset $1$ and begins
\[
0, 0, 18, 201, 1019, 6472, 34464, 176355,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 22 2017 11:18:29, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) + 6\,a(n-2) - 40\,a(n-3) - 147\,a(n-4) + 90\,a(n-5) + 690\,a(n-6) + 1104\,a(n-7) + 153\,a(n-8) - 358\,a(n-9) - 534\,a(n-10) + 216\,a(n-11) - 617\,a(n-12) + 606\,a(n-13) - 330\,a(n-14) + 224\,a(n-15) - 84\,a(n-16) + 24\,a(n-17) - 8\,a(n-18)
\]
for every $n>18$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A282833.
