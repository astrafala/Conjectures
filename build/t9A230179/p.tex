...
\title{The empirical recurrence for OEIS A230179, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A230179 counts arrays over $\{0,\dots,2\}$ in which every cell is constrained by the
...
OEIS A230179 is ``Number of n X 3 0..2 arrays x(i,j) with each element horizontally or antidiagonally next to at least one element with value 2-x(i,j).''. It has offset $1$ and begins
\[
3, 27, 231, 1971, 16815, 143451, 1223799, 10440387,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 9*a(n-1) - 4*a(n-2).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 23 2025 11:20:51, revision 12) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A230179.
