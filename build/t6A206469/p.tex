...
\title{The empirical recurrence for OEIS A206469, proved by transfer matrix}
...
\begin{abstract}
OEIS A206469 counts $(n+1)\times6$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A206469 is ``Number of (n+1)X6 0..2 arrays with every 2X2 subblock having zero permanent.''. It has offset $1$ and begins
\[
7225, 958441, 23707161, 1693734025, 61244865529, 3420616959081, 144660587865049, 7310031634630729,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 12:56:53, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;55\,a(n-1) + 978\,a(n-2) - 78848\,a(n-3) + 185192\,a(n-4) + 32350560\,a(n-5) - 254580608\,a(n-6) - 5080783360\,a(n-7) + 56605956096\,a(n-8) + 280495972352\,a(n-9) - 4555145707520\,a(n-10) - 1650631114752\,a(n-11) + 144197302616064\,a(n-12) - 230333727375360\,a(n-13) - 1370695862845440\,a(n-14) + 3206175906594816\,a(n-15)
\end{equation}
for all $n>14$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206469.
