...
\title{The empirical recurrence for OEIS A251122, proved by transfer matrix}
...
\begin{abstract}
OEIS A251122 counts $(n+1)\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A251122 is ``Number of (n+1) X (2+1) 0..1 arrays with no 2 X 2 subblock having the sum of its diagonal elements greater than the maximum of its antidiagonal elements.''. It has offset $1$ and begins
\[
21, 40, 69, 117, 193, 315, 510, 823,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 4*a(n-1) - 5*a(n-2) + a(n-3) + 2*a(n-4) - a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 25 2018 11:44:59, revision 10) the statement is
...
index corresponding to $n=5+1$ onwards, and the run continued until $w$ itself was the
...
every one of the $33$ published indices; the values agree exactly. That is what ties
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251122.
