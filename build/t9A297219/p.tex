...
\title{The empirical recurrence for OEIS A297219, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297219 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A297219 is ``Number of n X 3 0..1 arrays with every 1 horizontally or antidiagonally adjacent to 1 neighboring 1s.''. It has offset $1$ and begins
\[
3, 8, 24, 68, 196, 564, 1620, 4660,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) + 4*a(n-2) + 4*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 26 2019 11:52:46, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297219.
