...
\title{The empirical recurrence for OEIS A207930, proved by transfer matrix}
...
\begin{abstract}
OEIS A207930 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
...
OEIS A207930 is ``Number of 4Xn 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 0 0 and 1 1 1 vertically.''. It has offset
$1$ and begins
\[
10, 100, 240, 576, 1872, 6084, 18096,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:29:10, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) - a(n-2) + 8\,a(n-3) + 34\,a(n-4) + 14\,a(n-5) + 42\,a(n-6) - 42\,a(n-8) - 14\,a(n-9) - 34\,a(n-10) - 8\,a(n-11) + a(n-12) - a(n-13) + a(n-14)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207930.
