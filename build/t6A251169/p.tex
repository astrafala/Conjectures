...
\title{The empirical recurrence for OEIS A251169, proved by transfer matrix}
...
\begin{abstract}
OEIS A251169 counts $(n+1)\times3$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A251169 is ``Number of (n+1)X(2+1) 0..3 arrays with no 2X2 subblock having the minimum of its diagonal elements less than the absolute difference of its antidiagonal elements.''. It has offset $1$ and begins
\[
1192, 28598, 710438, 17822017, 447045247, 11217458242, 281464393752, 7062524479907,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:08:25, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;18\,a(n-1) + 207\,a(n-2) - 467\,a(n-3) - 6600\,a(n-4) - 1875\,a(n-5) + 63326\,a(n-6) + 73820\,a(n-7) - 229957\,a(n-8) - 336653\,a(n-9) + 261015\,a(n-10) + 44686\,a(n-11) - 128915\,a(n-12) + 2430445\,a(n-13) + 2129961\,a(n-14) - 3221584\,a(n-15) - 3772828\,a(n-16) - 1458815\,a(n-17) - 1624091\,a(n-18) + 1337778\,a(n-19) - 594676\,a(n-20) - 2421161\,a(n-21) + 4990735\,a(n-22) + 3825613\,a(n-23) - 2837931\,a(n-24) - 1064416\,a(n-25) + 460189\,a(n-26) - 570147\,a(n-27) - 263513\,a(n-28) + 428467\,a(n-29) + 62098\,a(n-30) - 84117\,a(n-31) + 2517\,a(n-32) + 12555\,a(n-33) - 1695\,a(n-34) - 1864\,a(n-35) + 80\,a(n-36) + 142\,a(n-37) - a(n-38) - 2\,a(n-39)
\end{equation}
for all $n>38$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251169.
