...
\title{The empirical recurrence for OEIS A302422, proved by transfer matrix}
...
\begin{abstract}
OEIS A302422 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A302422 is ``Number of nX3 0..1 arrays with every element equal to 0, 1, 3 or 5 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
3, 9, 11, 21, 51, 93, 207, 517,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +10*a(n-3) -8*a(n-4) for n>9
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 07 2018 17:18:18, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 10\,a(n-3) - 8\,a(n-4)
\end{equation}
for all $n>8$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302422.
