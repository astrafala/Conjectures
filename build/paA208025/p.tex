...
\title{The empirical recurrence for OEIS A208025, proved by transfer matrix}
...
\begin{abstract}
OEIS A208025 counts arrays over $\{0,\dots,1\}$ of width $5$ that avoid the patterns
...
OEIS A208025 is ``Number of nX5 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 0 0 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
16, 256, 1260, 5895, 26845, 123709, 574560,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:34:47, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208025.
