...
\title{The empirical recurrence for OEIS A305042, proved by transfer matrix}
...
\begin{abstract}
OEIS A305042 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $different from$ itself lying in $\{0,2,3,6,7\}$, and it carries an empirical
...
OEIS A305042 is ``Number of nX3 0..1 arrays with every element unequal to 0, 2, 3, 6 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 7, 5, 9, 15, 17, 40, 73,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) +a(n-2) +5*a(n-3) -13*a(n-4) -8*a(n-5) +2*a(n-6) +19*a(n-7) +9*a(n-8) -4*a(n-9) -8*a(n-10) -4*a(n-11) for n>13
\end{quote}
As of the ``Last modified'' line on the live entry (May 24 2018 08:48:02, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + a(n-2) + 5\,a(n-3) - 13\,a(n-4) - 8\,a(n-5) + 2\,a(n-6) + 19\,a(n-7) + 9\,a(n-8) - 4\,a(n-9) - 8\,a(n-10) - 4\,a(n-11)
\end{equation}
for all $n>12$.
...
compared against the entry's DATA at every one of the $34$ published indices; they
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A305042.
