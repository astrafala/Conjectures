...
\title{The empirical recurrence for OEIS A206353, proved by transfer matrix}
...
\begin{abstract}
OEIS A206353 counts arrays in which no entry may equal the entries at a short list of fixed offsets
...
$2$ consecutive rows, $S=409$ states in all.
\end{abstract}
...
OEIS A206353 is ``Number of n X 2 0..4 arrays with no element equal to another within two positions in the same row or column, and new values 0..4 introduced in row major order.''. It has offset $1$ and begins
\[
1, 4, 17, 120, 884, 6558, 48680, 361422,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 6*a(n-1) + 13*a(n-2) - 18*a(n-3) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 15 2018 11:59:58, revision 12) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206353.
