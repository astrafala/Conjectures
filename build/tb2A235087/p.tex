...
different counts. Across the columns settled here the model reproduces $9$ published
values, $32$ decimal digits in all, every one of them exactly; a misreading of the entry
