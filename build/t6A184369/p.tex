...
\title{The empirical recurrence for OEIS A184369, proved by transfer matrix}
...
\begin{abstract}
OEIS A184369 counts $(n+1)\times3$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A184369 is ``1/3 the number of (n+1) X 3 0..2 arrays with every 2 X 2 subblock having at least two equal elements connected horizontally or vertically.''. It has offset $1$ and begins
\[
153, 2755, 49235, 880781, 15754461, 281803871, 5040682279, 90163722073,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 17*a(n-1) + 19*a(n-2) - 57*a(n-3) + 18*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 27 2018 08:59:05, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;17\,a(n-1) + 19\,a(n-2) - 57\,a(n-3) + 18\,a(n-4)
\end{equation}
for all $n>3$.
...
\[
a(n)-\sum_i c_i\,a(n-i)\;=\;\tfrac1{3}\mathbf{1}^{\!\top}M^{\,n+1-1-4}\,q(M)\,\mathbf{1} .
\]
...
=\tfrac1{3}\mathbf{1}^{\!\top}M^{\,m-4}\,q(M)\,\mathbf{1}
\]
...
index corresponding to $n=3+1$ onwards, and the run continued until $w$ itself was the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A184369.
