...
\title{The empirical recurrence for OEIS A251395, proved by transfer matrix}
...
\begin{abstract}
OEIS A251395 counts $(n+1)\times2$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A251395 is ``Number of (n+1)X(1+1) 0..3 arrays with no 2X2 subblock having the sum of its diagonal elements less than the absolute difference of its antidiagonal elements.''. It has offset $1$ and begins
\[
226, 3205, 45542, 647154, 9195809, 130668665, 1856748750, 26383648169,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 16*a(n-1) -30*a(n-2) +69*a(n-3) -62*a(n-4) +30*a(n-5) -8*a(n-6) +a(n-7)
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:18:08, revision 7) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;16\,a(n-1) - 30\,a(n-2) + 69\,a(n-3) - 62\,a(n-4) + 30\,a(n-5) - 8\,a(n-6) + a(n-7)
\end{equation}
for all $n>6$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251395.
