...
\title{The empirical recurrence for OEIS A251452, proved by transfer matrix}
...
\begin{abstract}
OEIS A251452 counts $(n+1)\times2$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A251452 is ``Number of (n+1) X (1+1) 0..3 arrays with every 2 X 2 subblock summing to a prime.''. It has offset $1$ and begins
\[
114, 856, 6398, 47874, 358070, 2679006, 20039054, 149921686,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) + 55*a(n-2) - 46*a(n-3) - 470*a(n-4) + 76*a(n-5) + 1092*a(n-6) + 432*a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 30 2018 10:04:51, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 55\,a(n-2) - 46\,a(n-3) - 470\,a(n-4) + 76\,a(n-5) + 1092\,a(n-6) + 432\,a(n-7)
\end{equation}
for all $n>6$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251452.
