...
\title{The empirical recurrence for OEIS A251130, proved by transfer matrix}
...
\begin{abstract}
OEIS A251130 counts $(n+1)\times2$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A251130 is ``Number of (n+1) X (1+1) 0..2 arrays with no 2 X 2 subblock having the sum of its diagonal elements greater than the maximum of its antidiagonal elements.''. It has offset $1$ and begins
\[
40, 133, 369, 919, 2129, 4699, 10033, 20947,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 5*a(n-1) - 8*a(n-2) + 2*a(n-3) + 7*a(n-4) - 7*a(n-5) + 2*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 26 2018 06:56:06, revision 11) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251130.
