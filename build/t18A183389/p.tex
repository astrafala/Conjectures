...
\title{The empirical recurrence for OEIS A183389, proved by transfer matrix}
...
\begin{abstract}
OEIS A183389 counts $n\times5$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A183389 is ``Half the number of n X 5 binary arrays with no element unequal to a strict majority of its king-move neighbors.''. It has offset $1$ and begins
\[
3, 3, 3, 8, 21, 49, 136, 355,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + 5*a(n-2) - 4*a(n-3) - 11*a(n-4) - 3*a(n-5) + 4*a(n-6) - 8*a(n-7) + 10*a(n-9) - 2*a(n-10) - a(n-11) for n>12.
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 28 2018 08:13:25, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 5\,a(n-2) - 4\,a(n-3) - 11\,a(n-4) - 3\,a(n-5) + 4\,a(n-6) - 8\,a(n-7) + 10\,a(n-9) - 2\,a(n-10) - a(n-11)
\]
for every $n>12$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A183389.
