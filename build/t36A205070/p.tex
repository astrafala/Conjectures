...
\title{The empirical recurrence for OEIS A205070, proved by transfer matrix}
...
\begin{abstract}
OEIS A205070 counts arrays over $\{0,\dots,1\}$ under a condition on the number of rightwards and downwards edge increases
...
a bounded window of consecutive rows, so the count is a walk count on $S=1432$ states and is
...
OEIS A205070 is ``Number of (n+1)X7 0..1 arrays with the number of rightwards and downwards edge increases in each 2X2 subblock differing from the number in all its horizontal and vertical neighbors.''. It has offset $1$ and begins
\[
1432, 386, 524, 784, 1232, 1984, 2752, 3936,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 11:45:19, revision 9) this is still
...
\]
on the $S=1432$ admissible pairs.

At $n=1$ the array has two rows, so the grid is a single row of $6$
subblocks; the entry's first term is $1432$, which the model
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-2) - 2\,a(n-6) - 3\,a(n-8) - 3\,a(n-10) - 2\,a(n-12) + a(n-14) + 2\,a(n-16) + 9\,a(n-18) + 14\,a(n-20) + 17\,a(n-22) + 18\,a(n-24) + 17\,a(n-26) + 15\,a(n-28) + 10\,a(n-30) + 6\,a(n-32) + 3\,a(n-34) + a(n-36)
\]
for every $n>41$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A205070.
