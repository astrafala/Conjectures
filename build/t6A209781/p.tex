...
\title{The empirical recurrence for OEIS A209781, proved by transfer matrix}
...
\begin{abstract}
OEIS A209781 counts $(n+1)\times3$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A209781 is ``Half the number of (n+1)X3 0..3 arrays with every 2X2 subblock having exactly one duplicate clockwise edge difference.''. It has offset $1$ and begins
\[
576, 12492, 266126, 5719838, 122871278, 2641341716, 56780957220, 1220714555712,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 15:28:35, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;32\,a(n-1) - 181\,a(n-2) - 1612\,a(n-3) + 14245\,a(n-4) + 3934\,a(n-5) - 228072\,a(n-6) + 286957\,a(n-7) + 1135539\,a(n-8) - 2087315\,a(n-9) - 2118396\,a(n-10) + 5249880\,a(n-11) + 1194011\,a(n-12) - 5705343\,a(n-13) + 530140\,a(n-14) + 2648017\,a(n-15) - 619565\,a(n-16) - 439672\,a(n-17) + 116050\,a(n-18) + 17928\,a(n-19) - 3952\,a(n-20)
\end{equation}
for all $n>19$.
...
\[
a(n)-\sum_i c_i\,a(n-i)\;=\;\tfrac1{2}\mathbf{1}^{\!\top}M^{\,n+1-1-20}\,q(M)\,\mathbf{1} .
\]
...
=\tfrac1{2}\mathbf{1}^{\!\top}M^{\,m-20}\,q(M)\,\mathbf{1}
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209781.
