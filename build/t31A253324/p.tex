...
\title{The empirical recurrence for OEIS A253324, proved by transfer matrix}
...
\begin{abstract}
OEIS A253324 counts the arrays over $\{0,\dots,1\}$ whose $2\times2$ subblocks carry a
...
so a pair of consecutive array rows is a state, the count is a walk count on $S=1482$ of them,
...
OEIS A253324 is ``Number of (n+1)X(6+1) 0..1 arrays with every 2X2 subblock sum nondecreasing horizontally, vertically and antidiagonally ne-to-sw.''. It has offset $1$ and begins
\[
1482, 6936, 31999, 66196, 173903, 283804, 600020, 952108,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:57:35, revision 6) this is still
...
\]
on the $S=1482$ admissible pairs. In particular $a$ is $C$-finite. The alignment of the walk
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253324.
