...
\title{The empirical recurrence for OEIS A255794, proved by transfer matrix}
...
\begin{abstract}
OEIS A255794 counts $(n+2)\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
no $3\times3$ subblock, and it carries an empirical recurrence of order $14$
...
OEIS A255794 is ``Number of (n+2)X(1+2) 0..1 arrays with no 3x3 subblock diagonal sum 1 and no antidiagonal sum 2 and no row sum 0 and no column sum 3.''. It has offset $1$ and begins
\[
70, 134, 210, 409, 733, 1318, 2380, 4187,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:43:14, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-2) + 2\,a(n-3) + 3\,a(n-4) + 3\,a(n-5) + 2\,a(n-6) + 3\,a(n-7) - 13\,a(n-8) - 11\,a(n-9) - 10\,a(n-10) - a(n-11) + 4\,a(n-12) - a(n-13) + a(n-14)
\]
for every $n>21$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A255794.
