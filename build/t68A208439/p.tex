...
\title{The empirical recurrence for OEIS A208439, proved by transfer matrix}
...
\begin{abstract}
OEIS A208439 counts arrays of width $2$ over $\{0,1,2\}$ in which no cell is the average of its neighbours. The entry carries an
...
OEIS A208439 is ``Number of n X 2 0..2 arrays with no element equal the average of immediate neighbors vertically above and horizontally left of it.''. It has offset $1$ and begins
\[
6, 28, 134, 646, 3118, 15052, 72662, 350776,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) + 10*a(n-2) - 7*a(n-3) + 8*a(n-4) - 8*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 03 2018 12:14:31, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + 10\,a(n-2) - 7\,a(n-3) + 8\,a(n-4) - 8\,a(n-5)
\]
for every $n>5$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208439.
