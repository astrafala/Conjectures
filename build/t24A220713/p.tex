...
\title{The empirical recurrence for OEIS A220713, proved by transfer matrix}
...
\begin{abstract}
OEIS A220713 counts the ways of linking the cells of a grid $2$ cells wide, each cell either to
...
OEIS A220713 is ``Number of ways to reciprocally link elements of an n X 2 array either to themselves or to exactly two king-move neighbors, without consecutive collinear links.''. It has offset $1$ and begins
\[
1, 8, 26, 118, 463, 1930, 7843, 32209,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + 8*a(n-2) + 3*a(n-3) - 2*a(n-4) - 3*a(n-5) + a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 02 2018 15:19:49, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 8\,a(n-2) + 3\,a(n-3) - 2\,a(n-4) - 3\,a(n-5) + a(n-6)
\]
for every $n>5$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A220713.
