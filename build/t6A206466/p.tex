...
\title{The empirical recurrence for OEIS A206466, proved by transfer matrix}
...
\begin{abstract}
OEIS A206466 counts $(n+1)\times3$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A206466 is ``Number of (n+1) X 3 0..2 arrays with every 2 X 2 subblock having zero permanent.''. It has offset $1$ and begins
\[
121, 1411, 11025, 106891, 958441, 8963667, 82609921, 767387611,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 11*a(n-1) - 176*a(n-3) + 256*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 16 2018 16:02:47, revision 10) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;11\,a(n-1) - 176\,a(n-3) + 256\,a(n-4)
\end{equation}
for all $n>3$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206466.
