...
\title{The empirical recurrence for OEIS A303686, proved by transfer matrix}
...
\begin{abstract}
OEIS A303686 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A303686 is ``Number of nX4 0..1 arrays with every element unequal to 2, 3 or 4 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
0, 18, 20, 138, 343, 1744, 5563, 23963,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 28 2018 09:31:07, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 16\,a(n-2) - 80\,a(n-4) - 37\,a(n-5) + 195\,a(n-6) + 139\,a(n-7) - 235\,a(n-8) - 254\,a(n-9) + 22\,a(n-10) + 175\,a(n-11) + 412\,a(n-12) + 300\,a(n-13) - 564\,a(n-14) - 853\,a(n-15) + 201\,a(n-16) + 822\,a(n-17) + 70\,a(n-18) - 251\,a(n-19) + 26\,a(n-20) - 139\,a(n-21) - 266\,a(n-22) + 225\,a(n-23) + 290\,a(n-24) - 140\,a(n-25) - 150\,a(n-26) + 24\,a(n-27) + 78\,a(n-28) - 16\,a(n-29) - 14\,a(n-30) + 4\,a(n-31)
\end{equation}
for all $n>34$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A303686.
