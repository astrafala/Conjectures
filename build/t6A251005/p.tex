...
\title{The empirical recurrence for OEIS A251005, proved by transfer matrix}
...
\begin{abstract}
OEIS A251005 counts $(n+1)\times4$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A251005 is ``Number of (n+1)X(3+1) 0..2 arrays with no 2X2 subblock having its maximum diagonal element less than the absolute difference of its antidiagonal elements.''. It has offset $1$ and begins
\[
4083, 218298, 11671623, 623999793, 33363057374, 1783834023550, 95376750510010, 5099532967837334,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 12:58:32, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;81\,a(n-1) - 1954\,a(n-2) + 32379\,a(n-3) - 419520\,a(n-4) + 4000383\,a(n-5) - 27981900\,a(n-6) + 149000935\,a(n-7) - 627790962\,a(n-8) + 2173730790\,a(n-9) - 6430085803\,a(n-10) + 16294231907\,a(n-11) - 32054037021\,a(n-12) + 35251149270\,a(n-13) + 27785627597\,a(n-14) - 214291598331\,a(n-15) + 474340001188\,a(n-16) - 525110612953\,a(n-17) - 51492530582\,a(n-18) + 1353650012855\,a(n-19) - 2781865247427\,a(n-20) + 3444068301525\,a(n-21) - 3009309907241\,a(n-22) + 1966627276737\,a(n-23) - 984303214776\,a(n-24) + 380879357640\,a(n-25) - 116690528485\,a(n-26) + 31239482235\,a(n-27) - 8714904964\,a(n-28) + 2491548140\,a(n-29) - 492231312\,a(n-30) + 38390400\,a(n-31)
\end{equation}
for all $n>30$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251005.
