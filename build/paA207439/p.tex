...
\title{The empirical recurrence for OEIS A207439, proved by transfer matrix}
...
\begin{abstract}
OEIS A207439 counts arrays over $\{0,\dots,1\}$ of width $5$ that avoid the patterns
...
OEIS A207439 is ``Number of nX5 0..1 arrays avoiding 0 0 1 and 0 1 0 horizontally and 0 0 1 and 1 0 0 vertically.''. It has offset
$1$ and begins
\[
14, 196, 1058, 6092, 41092, 287176, 2078416,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 13:54:36, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;12\,a(n-1) + 11\,a(n-2) - 527\,a(n-3) + 509\,a(n-4) + 10409\,a(n-5) - 14705\,a(n-6) - 122529\,a(n-7) + 177998\,a(n-8) + 954829\,a(n-9) - 1262733\,a(n-10) - 5160618\,a(n-11) + 5837090\,a(n-12) + 19745843\,a(n-13) - 18587143\,a(n-14) - 53918092\,a(n-15) + 42406647\,a(n-16) + 105213797\,a(n-17) - 71528289\,a(n-18) - 146069025\,a(n-19) + 90996128\,a(n-20) + 142347619\,a(n-21) - 87266101\,a(n-22) - 94470880\,a(n-23) + 61334863\,a(n-24) + 40008895\,a(n-25) - 29788778\,a(n-26) - 9229349\,a(n-27) + 9062894\,a(n-28) + 557436\,a(n-29) - 1449822\,a(n-30) + 147300\,a(n-31) + 81432\,a(n-32) - 15120\,a(n-33)
\end{equation}
for all $n>32$. 
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207439.
