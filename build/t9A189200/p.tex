...
\title{The empirical recurrence for OEIS A189200, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A189200 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A189200 is ``Number of 7Xn binary arrays without the pattern 0 0 1 vertically or antidiagonally.''. It has offset $1$ and begins
\[
54, 2916, 111778, 4109278, 146936454, 5218915180, 184841938568, 6541724250668,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 05:05:53, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;54\,a(n-1) - 668\,a(n-2) - 1204\,a(n-3) + 61804\,a(n-4) - 256164\,a(n-5) - 878308\,a(n-6) + 10709472\,a(n-7) - 44896206\,a(n-8) + 104874996\,a(n-9) - 43296144\,a(n-10) - 436368072\,a(n-11) + 835505708\,a(n-12) + 306209160\,a(n-13) - 2149084380\,a(n-14) + 1133599936\,a(n-15) + 2259522864\,a(n-16) - 2594329280\,a(n-17) - 746020352\,a(n-18) + 2135481048\,a(n-19) - 324584736\,a(n-20) - 785978048\,a(n-21) + 290785696\,a(n-22) + 115315328\,a(n-23) - 70555264\,a(n-24) + 232448\,a(n-25) + 5530624\,a(n-26) - 1105920\,a(n-27) + 65536\,a(n-28)
\end{equation}
for all $n>29$.
...
the middle column. The vector $w$ was formed by $28$ applications of $G$ in exact integer
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A189200.
