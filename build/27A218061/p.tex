...
\title{The empirical recurrence for OEIS A218061, proved by transfer matrix}
...
\begin{abstract}
OEIS A218061 counts the distinct arrays obtained by applying a fixed local operation to every cell
of an array over a bounded alphabet, and carries an empirical recurrence of order $11$
...
$S=161$ states, after which the conjectured recurrence is settled by a finite exact
computation.
\end{abstract}
...
OEIS A218061 is ``Number of nX5 arrays of the minimum value of corresponding elements and their horizontal or antidiagonal neighbors in a random 0..1 nX5 array.''. It has offset $1$ and begins
\[
10, 108, 1046, 10246, 99934, 975296, 9519284, 92918894,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 17:32:35, revision 8) this is still
...
\]
There are $S=161$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite.
...
\begin{theorem}
\[
a(n)\;=\;15\,a(n-1) - 56\,a(n-2) + 37\,a(n-3) + 117\,a(n-4) - 132\,a(n-5) - 128\,a(n-6) + 164\,a(n-7) + 60\,a(n-8) - 76\,a(n-9) - 4\,a(n-10) + 8\,a(n-11)
\]
for every $n>13$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A218061.
