...
\title{The empirical recurrence for OEIS A250977, proved by transfer matrix}
...
\begin{abstract}
OEIS A250977 counts $(n+1)\times4$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
every $2\times2$ subblock, and carries an empirical recurrence of order $34$ contributed
...
OEIS A250977 is ``Number of (n+1)X(3+1) 0..2 arrays with no 2X2 subblock having the sum of its diagonal elements less than the absolute difference of its antidiagonal elements.''. It has offset $1$ and begins
\[
4459, 260056, 15156945, 883387252, 51487962431, 3000977166321, 174911850250602, 10194729848690817,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 12:56:12, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;81\,a(n-1) - 1684\,a(n-2) + 25348\,a(n-3) - 291723\,a(n-4) + 2424044\,a(n-5) - 15158818\,a(n-6) + 72317084\,a(n-7) - 255573416\,a(n-8) + 577878414\,a(n-9) - 163185020\,a(n-10) - 5109887649\,a(n-11) + 25157774093\,a(n-12) - 71367808333\,a(n-13) + 137995625151\,a(n-14) - 181844817574\,a(n-15) + 136162696861\,a(n-16) + 29883755630\,a(n-17) - 265402122592\,a(n-18) + 470072312498\,a(n-19) - 567382408955\,a(n-20) + 541266269549\,a(n-21) - 424227412036\,a(n-22) + 271877339590\,a(n-23) - 139592889535\,a(n-24) + 56061838432\,a(n-25) - 16978905986\,a(n-26) + 3547582620\,a(n-27) - 264772260\,a(n-28) - 77711536\,a(n-29) + 18671292\,a(n-30) - 1409504\,a(n-31) - 189020\,a(n-32) + 74448\,a(n-33) + 960\,a(n-34)
\end{equation}
for all $n>33$.
...
\text{not }\bigl((\alpha+\delta)<|\beta-\gamma|\bigr),
\end{equation}
...
For every $n$ with $n+1-1\ge34$,
\[
a(n)-\sum_i c_i\,a(n-i)\;=\;\mathbf{1}^{\!\top}M^{\,n+1-1-34}\,q(M)\,\mathbf{1} .
\]
...
=\mathbf{1}^{\!\top}M^{\,m-34}\,q(M)\,\mathbf{1}
\]
...
$m-34=j$ run over $\ge0$. For the last clause put $w=q(M)\mathbf{1}$. By the
...
$S^2$ pairs. The vector $w=q(M)\mathbf{1}\in\mathbb{Z}^{S}$ was then formed by $34$
...
index corresponding to $n=33+1$ onwards, and the run continued until $w$ itself was the
zero vector, which settles every larger $j$ at once. By Lemma~\ref{lem:crit} the recurrence
holds for every $n>33$.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250977.
