...
\title{The empirical recurrence for OEIS A233726, proved by transfer matrix}
...
\begin{abstract}
OEIS A233726 counts $(n+1)\times2$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A233726 is ``Number of (n+1) X (1+1) 0..3 arrays with every 2 X 2 subblock having the sum of the absolute values of the edge differences equal to 6 and no adjacent elements equal.''. It has offset $1$ and begins
\[
40, 148, 556, 2104, 7976, 30260, 114820, 435720,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) + 5*a(n-2) - 7*a(n-3) - 2*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 11 2018 11:23:57, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A233726.
