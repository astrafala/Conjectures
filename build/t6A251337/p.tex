...
\title{The empirical recurrence for OEIS A251337, proved by transfer matrix}
...
\begin{abstract}
OEIS A251337 counts $(n+1)\times3$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A251337 is ``Number of (n+1) X (2+1) 0..3 arrays with every 2 X 2 subblock summing to a nonzero multiple of 3.''. It has offset $1$ and begins
\[
455, 3315, 24714, 189129, 1487375, 12022920, 99776859, 848228679,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 27*a(n-1) - 252*a(n-2) + 813*a(n-3) + 589*a(n-4) - 5250*a(n-5) - 2310*a(n-6) + 1764*a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 29 2018 10:36:57, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;27\,a(n-1) - 252\,a(n-2) + 813\,a(n-3) + 589\,a(n-4) - 5250\,a(n-5) - 2310\,a(n-6) + 1764\,a(n-7)
\end{equation}
for all $n>6$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251337.
