...
\title{The empirical recurrence for OEIS A234708, proved by transfer matrix}
...
\begin{abstract}
OEIS A234708 counts $(n+1)\times5$ arrays over $\{0,\dots,7\}$ subject to a condition imposed on
...
OEIS A234708 is ``Number of (n+1) X (4+1) 0..7 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 6 (constant-stress 1 X 1 tilings).''. It has offset $1$ and begins
\[
47306, 127586, 334938, 1108418, 3530906, 13445762, 48741018, 204403250,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 20 2022 19:21:46, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234708.
