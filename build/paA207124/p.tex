...
\title{The empirical recurrence for OEIS A207124, proved by transfer matrix}
...
\begin{abstract}
OEIS A207124 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
...
OEIS A207124 is ``Number of 4Xn 0..1 arrays avoiding 0 0 1 and 0 1 0 horizontally and 0 0 1 and 0 1 1 vertically.''. It has offset
$1$ and begins
\[
9, 81, 289, 1024, 4096, 14161, 45796,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 13:30:28, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) - 12\,a(n-2) + 30\,a(n-3) - 105\,a(n-4) + 140\,a(n-5) - 191\,a(n-6) + 637\,a(n-7) - 525\,a(n-8) + 374\,a(n-9) - 2132\,a(n-10) + 851\,a(n-11) - 82\,a(n-12) + 4997\,a(n-13) - 364\,a(n-14) - 761\,a(n-15) - 7828\,a(n-16) - 1358\,a(n-17) + 1552\,a(n-18) + 7812\,a(n-19) + 2336\,a(n-20) - 1168\,a(n-21) - 4944\,a(n-22) - 1472\,a(n-23) + 512\,a(n-24) + 1632\,a(n-25) + 448\,a(n-26) - 128\,a(n-27) - 256\,a(n-28)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207124.
