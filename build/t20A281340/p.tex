...
\title{The empirical recurrence for OEIS A281340, proved by transfer matrix}
...
\begin{abstract}
OEIS A281340 counts $n\times4$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A281340 is ``Number of nX4 0..1 arrays with no element equal to more than three of its king-move neighbors and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
8, 85, 193, 607, 1892, 5868, 18189, 56154,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 20 2017 14:11:56, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) - 7\,a(n-2) + 4\,a(n-3) - a(n-5) - 8\,a(n-6) - 35\,a(n-7) + 29\,a(n-8) + 32\,a(n-9) + 39\,a(n-10) - 35\,a(n-11) - 31\,a(n-12) + 5\,a(n-13) + 14\,a(n-14) - 3\,a(n-15) - 14\,a(n-16) + 2\,a(n-17) + 4\,a(n-18)
\]
for every $n>21$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A281340.
