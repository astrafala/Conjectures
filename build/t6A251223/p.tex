...
\title{The empirical recurrence for OEIS A251223, proved by transfer matrix}
...
\begin{abstract}
OEIS A251223 counts $(n+1)\times4$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A251223 is ``Number of (n+1)X(3+1) 0..1 arrays with no 2X2 subblock having the minimum of its diagonal elements greater than the absolute difference of its antidiagonal elements.''. It has offset $1$ and begins
\[
171, 1892, 20782, 228689, 2515011, 27662994, 304255924, 3346446223,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 8*a(n-1) +39*a(n-2) -48*a(n-3) -210*a(n-4) +88*a(n-5) +260*a(n-6) -199*a(n-7) +36*a(n-8)
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:11:28, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;8\,a(n-1) + 39\,a(n-2) - 48\,a(n-3) - 210\,a(n-4) + 88\,a(n-5) + 260\,a(n-6) - 199\,a(n-7) + 36\,a(n-8)
\end{equation}
for all $n>7$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251223.
