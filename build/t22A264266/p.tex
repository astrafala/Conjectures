...
\title{The empirical recurrence for OEIS A264266, proved by transfer matrix}
...
\begin{abstract}
OEIS A264266 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=3$ rows in which
...
OEIS A264266 is ``Number of (n+1) X (2+1) arrays of permutations of 0..n*3+2 with each element having index change +-(.,.) 0,0 1,0 or 1,2.''. It has offset $1$ and begins
\[
10, 48, 305, 1800, 10933, 65856, 397970, 2402455,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) + 16*a(n-2) - 16*a(n-3) - 41*a(n-4) + 16*a(n-5) + 16*a(n-6) - 4*a(n-7) - a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 07 2019 05:57:30, revision 9) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264266.
