...
\title{The empirical recurrence for OEIS A255095, proved by transfer matrix}
...
\begin{abstract}
OEIS A255095 counts $(n+2)\times4$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A255095 is ``Number of (n+2)X(2+2) 0..1 arrays with no 3x3 subblock diagonal sum 1 and no antidiagonal sum 1 and no row sum 1 and no column sum 1.''. It has offset $1$ and begins
\[
77, 189, 539, 1475, 4075, 11573, 32627, 91821,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:37:45, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) - a(n-2) + 6\,a(n-3) - 12\,a(n-4) - 3\,a(n-5) - a(n-6) + 6\,a(n-7) + a(n-8) + 6\,a(n-9) + a(n-10) + 3\,a(n-11) - 3\,a(n-12) - 3\,a(n-13) - 2\,a(n-14)
\]
for every $n>14$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A255095.
