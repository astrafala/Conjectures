...
\title{The empirical recurrence for OEIS A251127, proved by transfer matrix}
...
\begin{abstract}
OEIS A251127 counts $(n+1)\times8$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A251127 is ``Number of (n+1) X (7+1) 0..1 arrays with no 2 X 2 subblock having the sum of its diagonal elements greater than the maximum of its antidiagonal elements.''. It has offset $1$ and begins
\[
354, 510, 680, 938, 1268, 1743, 2420, 3429,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 4*a(n-1) - 5*a(n-2) + a(n-3) + 2*a(n-4) - a(n-5) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 26 2018 06:56:00, revision 10) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251127.
