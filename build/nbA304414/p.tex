...
\title{The empirical recurrence for OEIS A304414, proved by transfer matrix}
...
\begin{abstract}
OEIS A304414 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $different from$ itself lying in $\{0,2,3,4,5\}$, and it carries an empirical
...
OEIS A304414 is ``Number of nX3 0..1 arrays with every element unequal to 0, 2, 3, 4 or 5 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 8, 23, 103, 520, 2671, 13876, 72399,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 12 2018 09:26:36, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) + 7\,a(n-2) - 16\,a(n-3) - 78\,a(n-4) - 11\,a(n-5) + 133\,a(n-6) + 161\,a(n-7) + 58\,a(n-8) - 114\,a(n-9) - 121\,a(n-10) - 91\,a(n-11) - 47\,a(n-12) - 12\,a(n-13) + 4\,a(n-14) + 8\,a(n-15)
\end{equation}
for all $n>16$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A304414.
