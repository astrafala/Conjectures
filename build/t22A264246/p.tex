...
\title{The empirical recurrence for OEIS A264246, proved by transfer matrix}
...
\begin{abstract}
OEIS A264246 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=3$ columns in which
...
OEIS A264246 is ``Number of (2+1) X (n+1) arrays of permutations of 0..n*3+2 with each element having directed index change 0,0 1,1 0,-1 -1,1 or 0,-2.''. It has offset $1$ and begins
\[
3, 21, 95, 557, 3303, 18725, 105839, 602365,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) + 8*a(n-2) + 24*a(n-3) + 88*a(n-4) + 88*a(n-5) + 24*a(n-6) - 552*a(n-7) - 352*a(n-8) - 96*a(n-9) for n>10.
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 06 2019 10:41:48, revision 10) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + 8\,a(n-2) + 24\,a(n-3) + 88\,a(n-4) + 88\,a(n-5) + 24\,a(n-6) - 552\,a(n-7) - 352\,a(n-8) - 96\,a(n-9)
\]
for every $n>10$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264246.
