...
\title{The empirical recurrence for OEIS A220324, proved by transfer matrix}
...
\begin{abstract}
OEIS A220324 counts the distinct indicator arrays obtained from the $n\times3$ arrays over
...
indicator row by row turns it into one, on $S=30$ states, after which the conjectured
...
OEIS A220324 is ``Equals two maps: number of n X 3 binary arrays indicating the locations of corresponding elements equal to exactly two of their horizontal and antidiagonal neighbors in a random 0..1 n X 3 array.''. It has offset $1$ and begins
\[
2, 16, 92, 508, 2788, 15316, 84196, 462940,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 7*a(n-1) - 9*a(n-2) + 3*a(n-3) + 6*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 31 2018 08:53:27, revision 8) this is still
...
\]
There are $S=30$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite. Note
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-1) - 9\,a(n-2) + 3\,a(n-3) + 6\,a(n-4)
\]
for every $n>4$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A220324.
