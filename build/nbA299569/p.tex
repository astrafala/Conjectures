...
\title{The empirical recurrence for OEIS A299569, proved by transfer matrix}
...
\begin{abstract}
OEIS A299569 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A299569 is ``Number of nX3 0..1 arrays with every element equal to 1, 2, 4, 5, 7 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 7, 15, 25, 47, 113, 265, 621,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 13 2018 11:15:11, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) - 3\,a(n-2) - a(n-3) - 6\,a(n-4) + 11\,a(n-5) - 8\,a(n-6) + 4\,a(n-7) - 7\,a(n-8) + 16\,a(n-9) + 5\,a(n-10) - 3\,a(n-11) - 18\,a(n-12) + a(n-13) + 6\,a(n-14)
\end{equation}
for all $n>14$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A299569.
