...
\title{The empirical recurrence for OEIS A264338, proved by transfer matrix}
...
\begin{abstract}
OEIS A264338 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=6$ rows in which
...
OEIS A264338 is ``Number of (n+1) X (5+1) arrays of permutations of 0..n*6+5 with each element having index change +-(.,.) 0,0 0,1 or 1,2.''. It has offset $1$ and begins
\[
676, 28925, 1243225, 53429620, 2296230561, 98684484373, 4241136597604, 182270189212469,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 43*a(n-1) - 43*a(n-3) + a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 07 2019 12:42:57, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264338.
