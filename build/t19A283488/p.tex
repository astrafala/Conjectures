...
\title{The empirical recurrence for OEIS A283488, proved by transfer matrix}
...
\begin{abstract}
OEIS A283488 counts $n\times2$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A283488 is ``Number of n X 2 0..1 arrays with no 1 equal to more than three of its horizontal, vertical and antidiagonal neighbors, with the exception of exactly one element.''. It has offset $1$ and begins
\[
0, 0, 2, 12, 64, 312, 1460, 6624,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 6*a(n-1) - 3*a(n-2) - 16*a(n-3) - 13*a(n-4) - 10*a(n-5) - 13*a(n-6) - 8*a(n-7) - 3*a(n-8) - 2*a(n-9) - a(n-10).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 21 2019 08:19:03, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) - 3\,a(n-2) - 16\,a(n-3) - 13\,a(n-4) - 10\,a(n-5) - 13\,a(n-6) - 8\,a(n-7) - 3\,a(n-8) - 2\,a(n-9) - a(n-10)
\]
for every $n>10$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A283488.
