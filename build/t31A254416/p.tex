...
\title{The empirical recurrence for OEIS A254416, proved by transfer matrix}
...
\begin{abstract}
OEIS A254416 counts the arrays over $\{0,\dots,2\}$ whose $2\times2$ subblocks carry a
...
OEIS A254416 is ``Number of (n+1)X(2+1) 0..2 arrays with every 2X2 subblock diagonal maximum minus antidiagonal maximum nondecreasing horizontally, vertically and ne-to-sw antidiagonally.''. It has offset $1$ and begins
\[
470, 3279, 26783, 238639, 2182689, 20251190, 189197280, 1775014082,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 14:39:41, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A254416.
