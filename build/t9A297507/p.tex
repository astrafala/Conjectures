...
\title{The empirical recurrence for OEIS A297507, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297507 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A297507 is ``Number of 2 X n 0..1 arrays with every 1 horizontally, diagonally or antidiagonally adjacent to 1 or 2 neighboring 1s.''. It has offset $1$ and begins
\[
1, 10, 31, 68, 218, 729, 2097, 6139,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) - 2*a(n-2) + 9*a(n-3) - 6*a(n-4) - 8*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 28 2019 16:21:09, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) - 2\,a(n-2) + 9\,a(n-3) - 6\,a(n-4) - 8\,a(n-5)
\end{equation}
for all $n>6$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297507.
