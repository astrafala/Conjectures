...
\title{The empirical recurrence for OEIS A297079, proved by transfer matrix}
...
\begin{abstract}
OEIS A297079 counts $n\times2$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A297079 is ``Number of n X 2 0..1 arrays with no 1 adjacent to 2 king-move neighboring 1s.''. It has offset $1$ and begins
\[
4, 12, 30, 96, 286, 848, 2620, 7964,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + 4*a(n-2) + 4*a(n-3) - 14*a(n-4) - 14*a(n-5) - 4*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 26 2019 08:20:44, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 4\,a(n-2) + 4\,a(n-3) - 14\,a(n-4) - 14\,a(n-5) - 4\,a(n-6)
\]
for every $n>6$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297079.
