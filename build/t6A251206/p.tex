...
\title{The empirical recurrence for OEIS A251206, proved by transfer matrix}
...
\begin{abstract}
OEIS A251206 counts $(n+1)\times5$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A251206 is ``Number of (n+1)X(4+1) 0..2 arrays with every 2X2 subblock summing to a nonzero multiple of 2.''. It has offset $1$ and begins
\[
3728, 65040, 1273440, 27920380, 667858580, 16965787428, 447556857260, 12076357468990,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 10:18:54, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;111\,a(n-1) - 4967\,a(n-2) + 109599\,a(n-3) - 1025248\,a(n-4) - 3485048\,a(n-5) + 149483818\,a(n-6) - 634279418\,a(n-7) - 7493101806\,a(n-8) + 52970555254\,a(n-9) + 244632286944\,a(n-10) - 1824484685872\,a(n-11) - 7138179533341\,a(n-12) + 28283475913415\,a(n-13) + 147078256032837\,a(n-14) - 29006700811005\,a(n-15) - 947046164348600\,a(n-16) - 737019679290744\,a(n-17) + 2727653845346764\,a(n-18) + 3394186814611740\,a(n-19) - 4178378678092432\,a(n-20) - 6479623724195056\,a(n-21) + 3912298894327776\,a(n-22) + 6489330981253248\,a(n-23) - 2565340219580544\,a(n-24) - 3482996175613440\,a(n-25) + 1206172902583296\,a(n-26) + 890714637803520\,a(n-27) - 323069633740800\,a(n-28) - 69344103628800\,a(n-29) + 26486872473600\,a(n-30)
\end{equation}
for all $n>29$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251206.
