...
\title{The empirical recurrence for OEIS A220727, proved by transfer matrix}
...
\begin{abstract}
OEIS A220727 counts the ways of linking the cells of a grid $3$ cells wide, each cell either to
...
OEIS A220727 is ``Number of ways to reciprocally link elements of an 3Xn array either to themselves or to exactly two horizontal, diagonal or antidiagonal neighbors.''. It has offset $1$ and begins
\[
1, 4, 30, 230, 1819, 14466, 114900, 913187,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 5*a(n-1) +24*a(n-2) -a(n-3) -25*a(n-4) -33*a(n-5) +10*a(n-6) +19*a(n-7) +4*a(n-8) -4*a(n-9) -a(n-10)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 19:00:31, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) + 24\,a(n-2) - a(n-3) - 25\,a(n-4) - 33\,a(n-5) + 10\,a(n-6) + 19\,a(n-7) + 4\,a(n-8) - 4\,a(n-9) - a(n-10)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A220727.
