...
\title{The empirical recurrence for OEIS A208116, proved by transfer matrix}
...
\begin{abstract}
OEIS A208116 counts arrays over $\{0,\dots,1\}$ of width $6$ that avoid the patterns
...
OEIS A208116 is ``Number of nX6 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 0 1 and 0 1 1 vertically.''. It has offset
$1$ and begins
\[
25, 625, 3025, 14641, 43681, 130321, 303601,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:39:06, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208116.
