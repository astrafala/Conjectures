...
\title{The empirical recurrence for OEIS A217958, proved by transfer matrix}
...
\begin{abstract}
OEIS A217958 counts the distinct arrays obtained by applying a fixed local operation to every cell
...
$S=18$ states, after which the conjectured recurrence is settled by a finite exact
computation.
\end{abstract}
...
OEIS A217958 is ``Number of n X 2 arrays of the minimum value of corresponding elements and their horizontal or antidiagonal neighbors in a random 0..2 n X 2 array.''. It has offset $1$ and begins
\[
3, 17, 77, 343, 1523, 6761, 30013, 133231,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) + 2*a(n-2) - a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2018 13:43:49, revision 7) this is still
...
\]
There are $S=18$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A217958.
