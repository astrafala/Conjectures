...
\title{The empirical recurrence for OEIS A208145, proved by transfer matrix}
...
\begin{abstract}
OEIS A208145 counts arrays over $\{0,\dots,1\}$ of width $6$ that avoid the patterns
$(0,0,1), (1,0,1)$ along one axis and $(0,0,1), (0,1,1)$ along the other, and carries an empirical recurrence of
...
OEIS A208145 is ``Number of 6Xn 0..1 arrays avoiding 0 0 1 and 0 1 1 horizontally and 0 0 1 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
12, 144, 756, 3969, 14112, 50176, 141120,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:40:13, revision
12) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 10\,a(n-2) - 22\,a(n-3) - 44\,a(n-4) + 110\,a(n-5) + 110\,a(n-6) - 330\,a(n-7) - 165\,a(n-8) + 660\,a(n-9) + 132\,a(n-10) - 924\,a(n-11) + 924\,a(n-13) - 132\,a(n-14) - 660\,a(n-15) + 165\,a(n-16) + 330\,a(n-17) - 110\,a(n-18) - 110\,a(n-19) + 44\,a(n-20) + 22\,a(n-21) - 10\,a(n-22) - 2\,a(n-23) + a(n-24)
\end{equation}
...
The remaining patterns $(0,0,1), (0,1,1)$ are forbidden along the other axis, so each of them
...
is none of $(0,0,1), (0,1,1)$. Let $P$ be the adjacency matrix.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208145.
