...
\title{The empirical recurrence for OEIS A299677, proved by transfer matrix}
...
\begin{abstract}
OEIS A299677 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $equal to$ itself lying in $\{0,1,2,4,5,6,7\}$, and it carries an empirical
...
OEIS A299677 is ``Number of nX3 0..1 arrays with every element equal to 0, 1, 2, 4, 5, 6 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
4, 13, 20, 45, 147, 506, 1561, 5017,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 16 2018 07:33:08, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) - 2\,a(n-2) + 4\,a(n-3) - 16\,a(n-4) - 13\,a(n-5) + 12\,a(n-6) + 40\,a(n-7) + 23\,a(n-8) - 37\,a(n-9) + 15\,a(n-10) - 88\,a(n-11) + 52\,a(n-12) - 48\,a(n-13) + 49\,a(n-14) - 8\,a(n-15) + 20\,a(n-16)
\end{equation}
for all $n>16$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A299677.
