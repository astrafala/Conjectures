...
\title{The empirical recurrence for OEIS A228656, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A228656 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A228656 is ``Number of nX4 binary arrays with top left value 1 and no two ones adjacent horizontally, diagonally or antidiagonally.''. It has offset $1$ and begins
\[
3, 14, 78, 416, 2228, 11912, 63688, 340480,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 6*a(n-1) -2*a(n-2) -8*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 04 2025 00:05:03, revision 11) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) - 2\,a(n-2) - 8\,a(n-3)
\end{equation}
for all $n>3$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A228656.
