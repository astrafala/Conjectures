...
\title{The empirical recurrence for OEIS A305772, proved by transfer matrix}
...
\begin{abstract}
OEIS A305772 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $different from$ itself lying in $\{0,1,2,3,5,7\}$, and it carries an empirical
...
OEIS A305772 is ``Number of n X 4 0..1 arrays with every element unequal to 0, 1, 2, 3, 5 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
8, 65, 292, 1481, 7528, 38623, 199257, 1028731,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 20 2024 14:00:41, revision
6) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) - 3\,a(n-2) + 16\,a(n-3) - 112\,a(n-4) - 75\,a(n-5) + 64\,a(n-6) + 736\,a(n-7) + 1117\,a(n-8) - 991\,a(n-9) - 2702\,a(n-10) - 4539\,a(n-11) + 5978\,a(n-12) + 9407\,a(n-13) + 2022\,a(n-14) - 23211\,a(n-15) - 51181\,a(n-16) - 5164\,a(n-17) + 46490\,a(n-18) + 126244\,a(n-19) + 94311\,a(n-20) + 83176\,a(n-21) + 69506\,a(n-22) + 6455\,a(n-23) - 125858\,a(n-24) - 448734\,a(n-25) - 573846\,a(n-26) - 555102\,a(n-27) - 480248\,a(n-28) - 236151\,a(n-29) + 48625\,a(n-30) + 551378\,a(n-31) + 1020562\,a(n-32) + 1243916\,a(n-33) + 1154262\,a(n-34) + 943154\,a(n-35) + 630142\,a(n-36) + 281741\,a(n-37) - 149013\,a(n-38) - 356123\,a(n-39) - 439970\,a(n-40) - 355735\,a(n-41) - 284104\,a(n-42) - 170092\,a(n-43) - 34417\,a(n-44) - 37704\,a(n-45) + 25928\,a(n-46) + 26979\,a(n-47) - 6213\,a(n-48) + 10758\,a(n-49) + 3241\,a(n-50) - 381\,a(n-51) + 2032\,a(n-52) - 812\,a(n-53) + 56\,a(n-54) + 156\,a(n-55) - 80\,a(n-56) + 16\,a(n-57)
\end{equation}
for all $n>59$.
...
has score in $\{0,1,2,3,5,7\}$. The entry also fixes the top-left entry to be $0$; that is a condition on the first row alone, so it restricts the start vector and nothing else.
...
\begin{itemize}
\item $\mathbf{s}(r,s)=1$ when every cell of $r$ has score in $\{0,1,2,3,5,7\}$ \emph{with no row
above $r$} and $r_1=0$, and $0$ otherwise;
\item an edge $(r,s)\to(s,t)$ when every cell of $s$ has score in $\{0,1,2,3,5,7\}$ computed from
$r$, $s$ and $t$;
\item $\mathbf{e}(r,s)=1$ when every cell of $s$ has score in $\{0,1,2,3,5,7\}$ \emph{with no row
...
exactly when every one of its $n$ rows has all scores in $\{0,1,2,3,5,7\}$. Read the sequence as the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A305772.
