...
\title{The empirical recurrence for OEIS A231852, proved by transfer matrix}
...
\begin{abstract}
OEIS A231852 counts arrays of width $5$ over $\{0,1,2\}$ in which no cell is beaten by a strict majority of its neighbours. The entry carries an
...
$3$ consecutive rows and the count is a walk count on $S=46576$ states.
\end{abstract}
...
OEIS A231852 is ``Number of nX5 0..2 arrays with no element having a strict majority of its horizontal and antidiagonal neighbors equal to itself plus one mod 3, with upper left element zero (rock paper and scissors drawn positions).''. It has offset $1$ and begins
\[
21, 612, 85288, 11149456, 1454768048, 189801034186, 24762957054535, 3230773305296573,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 08:48:06, revision 6) this is still
...
Thus
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=46576,
\]
...
\begin{theorem}
\[
a(n)\;=\;183\,a(n-1) - 8008\,a(n-2) + 164477\,a(n-3) - 1911762\,a(n-4) + 13545983\,a(n-5) - 59779265\,a(n-6) + 159414566\,a(n-7) - 218855372\,a(n-8) + 7532104\,a(n-9) + 451112826\,a(n-10) - 590711864\,a(n-11) + 106059884\,a(n-12) + 386076754\,a(n-13) - 374591713\,a(n-14) + 131217119\,a(n-15) + 37977619\,a(n-16) - 86897128\,a(n-17) + 54663372\,a(n-18) - 17127366\,a(n-19) + 3057852\,a(n-20) - 413220\,a(n-21)
\]
for every $n>22$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231852.
