...
\title{The empirical recurrence for OEIS A211330, proved by a one-dimensional reduction}
...
\begin{abstract}
OEIS A211330 counts symmetric $(n+1)\times(n+1)$ matrices over
$\{-5,\dots,5\}$ in which every $2\times2$ subblock sums to zero and has three distinct
...
on $S=154$ states, and the empirical recurrence of order $11$ contributed by R.~H.~Hardin
follows.
\end{abstract}
...
OEIS A211330 is ``Number of (n+1) X (n+1) -5..5 symmetric matrices with every 2 X 2 subblock having sum zero and three distinct values.''. It has offset $1$ and begins
\[
46, 90, 172, 316, 588, 1070, 1974, 3608,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 17 2018 08:39:37, revision 7) this is still
...
$S=154$. The two parity classes never mix, so the walk starts by choosing a parity and a first
value, and every state may end a sequence:
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad \tau=\mathbf{1},\qquad S=154.
\]
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) - a(n-2) - 31\,a(n-3) + 39\,a(n-4) + 56\,a(n-5) - 116\,a(n-6) - 14\,a(n-7) + 115\,a(n-8) - 34\,a(n-9) - 30\,a(n-10) + 12\,a(n-11)
\]
for every $n>11$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A211330.
