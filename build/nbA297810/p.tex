...
\title{The empirical recurrence for OEIS A297810, proved by transfer matrix}
...
\begin{abstract}
OEIS A297810 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A297810 is ``Number of nX4 0..1 arrays with every element equal to 2 or 3 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
0, 1, 2, 8, 13, 27, 41, 100,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 06 2018 10:26:57, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 2\,a(n-2) + 3\,a(n-4) + 2\,a(n-5) - 4\,a(n-6) - 11\,a(n-7) - 11\,a(n-8) - 6\,a(n-9) + a(n-10) + 6\,a(n-11) + 5\,a(n-12) - a(n-14)
\end{equation}
for all $n>20$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297810.
