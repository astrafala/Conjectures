...
\title{The empirical recurrence for OEIS A234177, proved by transfer matrix}
...
\begin{abstract}
OEIS A234177 counts $(n+1)\times2$ arrays over $\{0,\dots,5\}$ subject to a condition imposed on
...
OEIS A234177 is ``Number of (n+1) X (1+1) 0..5 arrays with every 2 X 2 subblock having the absolute values of all six edge and diagonal differences no larger than 1.''. It has offset $1$ and begins
\[
76, 388, 1978, 10120, 51886, 266434, 1369642, 7046416,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 10*a(n-1) - 27*a(n-2) + 3*a(n-3) + 36*a(n-4) + 12*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 13 2018 11:53:28, revision 11) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;10\,a(n-1) - 27\,a(n-2) + 3\,a(n-3) + 36\,a(n-4) + 12\,a(n-5)
\end{equation}
for all $n>5$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234177.
