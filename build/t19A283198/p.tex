...
\title{The empirical recurrence for OEIS A283198, proved by transfer matrix}
...
\begin{abstract}
OEIS A283198 counts $n\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A283198 is ``Number of n X 3 0..1 arrays with no 1 equal to more than two of its horizontal and vertical neighbors, with the exception of exactly one element.''. It has offset $1$ and begins
\[
0, 6, 83, 868, 7899, 66412, 535025, 4184880,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 11 2021 22:02:31, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;10\,a(n-1) - 11\,a(n-2) - 20\,a(n-3) - 263\,a(n-4) - 506\,a(n-5) - 1037\,a(n-6) - 898\,a(n-7) - 488\,a(n-8) + 752\,a(n-9) + 1264\,a(n-10) + 842\,a(n-11) - 248\,a(n-12) - 744\,a(n-13) - 153\,a(n-14) + 170\,a(n-15) + 51\,a(n-16) - 12\,a(n-17) - 4\,a(n-18)
\]
for every $n>18$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A283198.
