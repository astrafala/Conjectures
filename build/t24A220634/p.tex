...
\title{The empirical recurrence for OEIS A220634, proved by transfer matrix}
...
\begin{abstract}
OEIS A220634 counts the ways of linking the cells of a grid $4$ cells wide, each cell either to
...
OEIS A220634 is ``Number of ways to reciprocally link elements of an 4 X n array either to themselves or to exactly two horizontal or antidiagonal neighbors.''. It has offset $1$ and begins
\[
1, 1, 5, 37, 257, 1665, 10695, 68637,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 9*a(n-1) - 16*a(n-2) - 6*a(n-3) + 15*a(n-4) + a(n-5) - 2*a(n-6) for n>9.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 02 2018 04:59:22, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;9\,a(n-1) - 16\,a(n-2) - 6\,a(n-3) + 15\,a(n-4) + a(n-5) - 2\,a(n-6)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A220634.
