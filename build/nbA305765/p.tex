...
\title{The empirical recurrence for OEIS A305765, proved by transfer matrix}
...
\begin{abstract}
OEIS A305765 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A305765 is ``Number of nX4 0..1 arrays with every element unequal to 0, 1, 2, 3, 4 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
8, 112, 684, 4893, 34001, 240701, 1696681, 11974403,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 10 2018 09:32:29, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) + 16\,a(n-2) - 52\,a(n-3) - 89\,a(n-4) + 228\,a(n-5) - 65\,a(n-6) - 256\,a(n-7) + 754\,a(n-8) - 428\,a(n-9) - 25\,a(n-10) - 255\,a(n-11) - 768\,a(n-12) + 2580\,a(n-13) - 3804\,a(n-14) + 1874\,a(n-15) + 1205\,a(n-16) - 1287\,a(n-17) + 2505\,a(n-18) - 4282\,a(n-19) + 2886\,a(n-20) - 5280\,a(n-21) + 4994\,a(n-22) - 3929\,a(n-23) + 4905\,a(n-24) - 2280\,a(n-25) + 513\,a(n-26) - 1013\,a(n-27) + 598\,a(n-28) - 103\,a(n-29) - 43\,a(n-30) + 119\,a(n-31) - 31\,a(n-32) + 4\,a(n-33) - 14\,a(n-34) + 8\,a(n-35)
\end{equation}
for all $n>36$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A305765.
