...
\title{The empirical recurrence for OEIS A251199, proved by transfer matrix}
...
\begin{abstract}
OEIS A251199 counts $(n+1)\times7$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A251199 is ``Number of (n+1)X(6+1) 0..1 arrays with no 2X2 subblock having the minimum of its diagonal elements less than the absolute difference of its antidiagonal elements.''. It has offset $1$ and begins
\[
1081, 15353, 268638, 4923412, 91120318, 1688254298, 31288421074, 579864211963,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:10:18, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 287\,a(n-2) + 1130\,a(n-3) - 12616\,a(n-4) - 48060\,a(n-5) + 294590\,a(n-6) + 714706\,a(n-7) - 4215124\,a(n-8) - 3637992\,a(n-9) + 34258426\,a(n-10) - 9071566\,a(n-11) - 149917455\,a(n-12) + 180182722\,a(n-13) + 203004483\,a(n-14) - 391157500\,a(n-15) - 207871972\,a(n-16) + 520621096\,a(n-17) + 174582101\,a(n-18) - 486567998\,a(n-19) - 41959607\,a(n-20) + 184075326\,a(n-21) + 84598884\,a(n-22) - 67114240\,a(n-23) - 50128530\,a(n-24) + 21845566\,a(n-25) + 12740072\,a(n-26) - 3903472\,a(n-27) - 1764730\,a(n-28) + 327790\,a(n-29) + 137151\,a(n-30) - 9862\,a(n-31) - 5231\,a(n-32) - 64\,a(n-33) + 68\,a(n-34) + 4\,a(n-35)
\end{equation}
for all $n>39$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251199.
