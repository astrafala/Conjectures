...
\title{The empirical recurrence for OEIS A256741, proved by transfer matrix}
...
\begin{abstract}
OEIS A256741 counts $(n+2)\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
no $3\times3$ subblock, and it carries an empirical recurrence of order $9$
...
OEIS A256741 is ``Number of (n+2) X (1+2) 0..1 arrays with no 3 x 3 subblock diagonal sum 3 and no antidiagonal sum 3 and no row sum 0 and no column sum 0.''. It has offset $1$ and begins
\[
153, 393, 857, 2065, 5255, 12914, 31032, 75634,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + 2*a(n-2) + 5*a(n-3) + a(n-5) - 14*a(n-6) - 19*a(n-7) + 3*a(n-8) + 3*a(n-9) for n>12.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 20 2018 23:07:06, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 2\,a(n-2) + 5\,a(n-3) + a(n-5) - 14\,a(n-6) - 19\,a(n-7) + 3\,a(n-8) + 3\,a(n-9)
\]
for every $n>12$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A256741.
