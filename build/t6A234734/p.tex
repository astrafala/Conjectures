...
\title{The empirical recurrence for OEIS A234734, proved by transfer matrix}
...
\begin{abstract}
OEIS A234734 counts $(n+1)\times5$ arrays over $\{0,\dots,7\}$ subject to a condition imposed on
...
OEIS A234734 is ``Number of (n+1) X (4+1) 0..7 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 8 (constant-stress 1 X 1 tilings).''. It has offset $1$ and begins
\[
8736, 21048, 45792, 127032, 319488, 972888, 2723040, 8836536,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 20 2022 18:53:12, revision 6) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234734.
