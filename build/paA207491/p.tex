...
\title{The empirical recurrence for OEIS A207491, proved by transfer matrix}
...
\begin{abstract}
OEIS A207491 counts arrays over $\{0,\dots,1\}$ of width $6$ that avoid the patterns
$(0,1,1), (1,1,0)$ along one axis and $(0,0,0), (0,1,1)$ along the other, and carries an empirical recurrence of
order $61$ contributed by R.~H.~Hardin. It is true. The patterns have length $3$, so
...
$\mathbf{1}^{\!\top}P^{\,n-2-61}q(P)\mathbf{1}$, which vanishes identically
...
OEIS A207491 is ``Number of 6 X n 0..1 arrays avoiding 0 0 0 and 0 1 1 horizontally and 0 1 1 and 1 1 0 vertically.''. It has offset
$1$ and begins
\[
22, 484, 942, 3947, 12151, 26980, 73325,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 13:58:47, revision
...
$(0,1,1), (1,1,0)$ as $3$ consecutive entries. There are $22$ admissible columns; that condition
...
$a(n)-\sum_i c_i a(n-i)=u_{\,n-2-61}$ whenever $n-61\ge2$. Hence
\eqref{eq:conj} holds for every $n>t$ exactly when $u_j=0$ for every
$j>t-2-61$. Moreover $(u_j)$ satisfies the monic linear recurrence whose
...
$P^{\,n-2-61}$ gives the identity. The equivalence follows by letting the exponent
...
\begin{proof}
The vector $q(P)\mathbf{1}\in\mathbb{Z}^{S}$ was formed by $61$ matrix--vector
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207491.
