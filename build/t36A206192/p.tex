...
\title{The empirical recurrence for OEIS A206192, proved by transfer matrix}
...
\begin{abstract}
OEIS A206192 counts arrays over $\{0,\dots,3\}$ under a condition on the number of clockwise edge increases
...
OEIS A206192 is ``Number of (n+1)X4 0..3 arrays with the number of clockwise edge increases in every 2X2 subblock equal to two.''. It has offset $1$ and begins
\[
8304, 329216, 13173864, 527945420, 21162670972, 848327900384, 34006136221640, 1363171550451384,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 12:45:48, revision 9) this is still
...
subblocks; the entry's first term is $8304$, which the model
...
\begin{theorem}
\[
a(n)\;=\;69\,a(n-1) - 1503\,a(n-2) + 16061\,a(n-3) - 100719\,a(n-4) + 413071\,a(n-5) - 1200419\,a(n-6) + 2350991\,a(n-7) - 2650016\,a(n-8) + 246039\,a(n-9) + 5103223\,a(n-10) - 8853227\,a(n-11) + 5015318\,a(n-12) + 4249674\,a(n-13) - 9106668\,a(n-14) + 7509128\,a(n-15) - 3026335\,a(n-16) + 952523\,a(n-17) - 1880226\,a(n-18) - 37992\,a(n-19) - 166501\,a(n-20) - 450312\,a(n-21) - 419109\,a(n-22) + 222765\,a(n-23) + 217432\,a(n-24) - 15270\,a(n-25) + 13404\,a(n-26) + 5852\,a(n-27) + 348\,a(n-28)
\]
for every $n>29$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206192.
