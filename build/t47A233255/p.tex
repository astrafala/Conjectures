...
\title{The empirical recurrence for OEIS A233255, proved by transfer matrix}
...
\begin{abstract}
OEIS A233255 counts arrays over $\{0,\dots,5\}$ in which no two entries that are neighbours in
...
carried by one bounded piece of extra state, so the count is a walk count on $S=17$ states.
\end{abstract}
...
and every first appearance it contains. There are $S=17$ reachable states.
...
\begin{theorem}
\[
a(n)\;=\;5504\,a(n-1) - 6438912\,a(n-2) + 2774532096\,a(n-3) - 478351982592\,a(n-4) + 27831388078080\,a(n-5)
\]
for every $n>5$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A233255.
