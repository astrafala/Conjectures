...
\title{The empirical recurrence for OEIS A296550, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A296550 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A296550 is ``Number of n X 4 0..1 arrays with each 1 horizontally, vertically or antidiagonally adjacent to 3 or 6 neighboring 1s.''. It has offset $1$ and begins
\[
1, 1, 3, 5, 7, 10, 17, 28,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) + 2*a(n-4) + a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 21 2022 14:37:57, revision 14) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 2\,a(n-4) + a(n-7)
\end{equation}
for all $n>8$.
...
every one of the $39$ published indices, with no shift fitted: the number of rows is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A296550.
