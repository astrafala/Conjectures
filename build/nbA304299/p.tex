...
\title{The empirical recurrence for OEIS A304299, proved by transfer matrix}
...
\begin{abstract}
OEIS A304299 counts $5$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A304299 is ``Number of nX5 0..1 arrays with every element unequal to 1, 2, 5 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
3, 8, 6, 13, 62, 88, 339, 888,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 10 2018 09:00:54, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-2) + 14\,a(n-3) + 5\,a(n-4) - 12\,a(n-5) - 59\,a(n-6) - 17\,a(n-7) + 17\,a(n-8) + 105\,a(n-9) - 2\,a(n-10) - 43\,a(n-11) - 103\,a(n-12) + 51\,a(n-13) + 109\,a(n-14) + 77\,a(n-15) - 63\,a(n-16) - 97\,a(n-17) - 17\,a(n-18) + 57\,a(n-19) + 11\,a(n-20) - 16\,a(n-21) - 4\,a(n-22) + 12\,a(n-23) - 10\,a(n-24) - 5\,a(n-25) + 28\,a(n-26) + 12\,a(n-27) - 22\,a(n-28) - 6\,a(n-29) + 10\,a(n-30) - 2\,a(n-32)
\end{equation}
for all $n>33$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A304299.
