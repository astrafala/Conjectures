...
\title{The empirical recurrence for OEIS A205460, proved by transfer matrix}
...
\begin{abstract}
OEIS A205460 counts arrays over $\{0,\dots,3\}$ under a condition on the number of clockwise edge increases
...
OEIS A205460 is ``Number of (n+1)X3 0..3 arrays with the number of clockwise edge increases in every 2X2 subblock differing from each horizontal or vertical neighbor.''. It has offset $1$ and begins
\[
2120, 34792, 597288, 10306944, 177411808, 3053150968, 52550629576, 904498008200,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 12:07:48, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;13\,a(n-1) + 47\,a(n-2) + 381\,a(n-3) + 889\,a(n-4) + 1738\,a(n-5) + 1450\,a(n-6) - 1327\,a(n-7) - 5850\,a(n-8) - 6842\,a(n-9) - 201\,a(n-10) + 5987\,a(n-11) + 1609\,a(n-12) - 3010\,a(n-13) + 750\,a(n-14) + 1215\,a(n-15) - 1779\,a(n-16) - 1448\,a(n-17) + 771\,a(n-18) + 670\,a(n-19) - 118\,a(n-20) - 168\,a(n-21) + 44\,a(n-22)
\]
for every $n>22$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A205460.
