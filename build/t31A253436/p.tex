...
\title{The empirical recurrence for OEIS A253436, proved by transfer matrix}
...
\begin{abstract}
OEIS A253436 counts the arrays over $\{0,\dots,1\}$ whose $2\times2$ subblocks carry a
...
OEIS A253436 is ``Number of (2+1) X (n+1) 0..1 arrays with every 2 X 2 subblock diagonal minus antidiagonal sum nondecreasing horizontally, vertically and ne-to-sw antidiagonally.''. It has offset $1$ and begins
\[
39, 58, 70, 102, 174, 318, 606, 1182,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) - 2*a(n-2) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 12 2018 14:12:36, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253436.
