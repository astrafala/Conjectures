...
\title{The empirical recurrence for OEIS A251508, proved by transfer matrix}
...
\begin{abstract}
OEIS A251508 counts $(n+1)\times2$ arrays over $\{0,\dots,4\}$ subject to a condition imposed on
...
on $S=25$ vertices whose edges are the admissible consecutive pairs, and the count is a
...
OEIS A251508 is ``Number of (n+1)X(1+1) 0..4 arrays with every 2X2 subblock summing to a prime.''. It has offset $1$ and begins
\[
234, 2264, 21862, 211680, 2047194, 19818328, 191708742, 1855695600,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) +115*a(n-2) -138*a(n-3) -2996*a(n-4) +2512*a(n-5) +26576*a(n-6) -15680*a(n-7) -65856*a(n-8) +34560*a(n-9)
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:26:08, revision 7) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 115\,a(n-2) - 138\,a(n-3) - 2996\,a(n-4) + 2512\,a(n-5) + 26576\,a(n-6) - 15680\,a(n-7) - 65856\,a(n-8) + 34560\,a(n-9)
\end{equation}
for all $n>8$.
...
$V=\{0,1,\dots,4\}^{2}$, so $|V|=S=25$. A $2\times2$ subblock of the array
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251508.
