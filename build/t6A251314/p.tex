...
\title{The empirical recurrence for OEIS A251314, proved by transfer matrix}
...
\begin{abstract}
OEIS A251314 counts $(n+1)\times6$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A251314 is ``Number of (n+1)X(5+1) 0..1 arrays with no 2X2 subblock having the maximum of its diagonal elements greater than the absolute difference of its antidiagonal elements.''. It has offset $1$ and begins
\[
365, 2199, 12859, 76167, 451826, 2688099, 16024915, 95495471,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:16:05, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;21\,a(n-1) - 209\,a(n-2) + 1373\,a(n-3) - 6671\,a(n-4) + 24836\,a(n-5) - 72066\,a(n-6) + 164681\,a(n-7) - 296387\,a(n-8) + 415164\,a(n-9) - 439957\,a(n-10) + 329594\,a(n-11) - 140172\,a(n-12) - 13684\,a(n-13) + 64019\,a(n-14) - 38491\,a(n-15) + 1377\,a(n-16) + 12766\,a(n-17) - 8365\,a(n-18) + 3157\,a(n-19) - 938\,a(n-20) - 135\,a(n-21) + 270\,a(n-22) - 41\,a(n-23) + 4\,a(n-24) - 5\,a(n-25) - a(n-26)
\end{equation}
for all $n>27$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251314.
