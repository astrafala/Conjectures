...
\title{The empirical recurrence for OEIS A209380, proved by transfer matrix}
...
\begin{abstract}
OEIS A209380 counts $(n+1)\times7$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A209380 is ``1/4 the number of (n+1)X7 0..2 arrays with every 2X2 subblock having distinct edge sums.''. It has offset $1$ and begins
\[
128, 410, 840, 4004, 8648, 52784, 114056, 790712,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 15:14:00, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 38\,a(n-2) - 38\,a(n-3) - 516\,a(n-4) + 516\,a(n-5) + 3144\,a(n-6) - 3144\,a(n-7) - 8480\,a(n-8) + 8480\,a(n-9) + 7936\,a(n-10) - 7936\,a(n-11)
\end{equation}
for all $n>11$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209380.
