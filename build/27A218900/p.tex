...
\title{The empirical recurrence for OEIS A218900, proved by transfer matrix}
...
\begin{abstract}
OEIS A218900 counts the distinct arrays obtained by applying a fixed local operation to every cell
of an array over a bounded alphabet, and carries an empirical recurrence of order $30$
...
$S=137$ states, after which the conjectured recurrence is settled by a finite exact
computation.
\end{abstract}
...
OEIS A218900 is ``Number of 4Xn arrays of the minimum value of corresponding elements and their horizontal, diagonal or antidiagonal neighbors in a random 0..1 4Xn array.''. It has offset $1$ and begins
\[
16, 38, 286, 1096, 6280, 28598, 149238, 722094,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 17:49:18, revision 10) this is still
...
\]
There are $S=137$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A218900.
