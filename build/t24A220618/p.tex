...
\title{The empirical recurrence for OEIS A220618, proved by transfer matrix}
...
\begin{abstract}
OEIS A220618 counts the ways of linking the cells of a grid $5$ cells wide, each cell either to
...
OEIS A220618 is ``Number of ways to reciprocally link elements of an nX5 array either to themselves or to exactly one horizontal, diagonal and antidiagonal neighbor.''. It has offset $1$ and begins
\[
8, 317, 9176, 282777, 8608738, 262680517, 8011414792, 244357686173,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 18:54:32, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;38\,a(n-1) - 189\,a(n-2) - 1434\,a(n-3) + 6910\,a(n-4) - 3882\,a(n-5) - 9380\,a(n-6) + 9742\,a(n-7) - 477\,a(n-8) - 1476\,a(n-9) + 125\,a(n-10)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A220618.
