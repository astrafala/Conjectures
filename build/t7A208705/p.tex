...
\title{The empirical recurrence for OEIS A208705, proved by counting patterns}
...
\begin{abstract}
OEIS A208705 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A208705 is ``Number of n X 4 0..1 arrays with new values 0..1 introduced in row major order and no element equal to more than two of its immediate leftward or upward or right-upward antidiagonal neighbors.''. It has offset $1$ and begins
\[
8, 100, 1268, 16084, 204020, 2587924, 32826932, 416398420,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 13*a(n-1) - 4*a(n-2).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 06 2018 06:04:49, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208705.
