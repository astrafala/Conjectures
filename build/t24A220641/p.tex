...
\title{The empirical recurrence for OEIS A220641, proved by transfer matrix}
...
\begin{abstract}
OEIS A220641 counts the ways of linking the cells of a grid $5$ cells wide, each cell either to
...
OEIS A220641 is ``Number of ways to reciprocally link elements of an n X 5 array either to themselves or to exactly one king-move neighbor.''. It has offset $0$ and begins
\[
1, 8, 728, 37320, 2226936, 128171936, 7444342896, 431408410784,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 03 2023 15:42:29, revision 10) this is still
...
\begin{theorem}
\[
a(n)\;=\;48\,a(n-1) + 694\,a(n-2) - 6232\,a(n-3) - 31552\,a(n-4) + 254384\,a(n-5) + 127448\,a(n-6) - 2270720\,a(n-7) + 175600\,a(n-8) + 6932672\,a(n-9) - 38400\,a(n-10) - 7223680\,a(n-11) - 640000\,a(n-12) + 1681408\,a(n-13) + 237568\,a(n-14) + 192512\,a(n-15) - 16384\,a(n-16) + 32768\,a(n-17)
\]
for every $n>16$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A220641.
