...
\title{The empirical recurrence for OEIS A318019, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A318019 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A318019 is ``Number of nX3 0..1 arrays with every element unequal to 0, 1, 2 or 4 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 12 2018 19:43:12, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 4\,a(n-2) - 5\,a(n-3) - 14\,a(n-4) - 17\,a(n-5) + 18\,a(n-6) + 29\,a(n-7) + 23\,a(n-8) + 12\,a(n-9) - 27\,a(n-10) - 27\,a(n-11) - 16\,a(n-12) - 7\,a(n-13) - 5\,a(n-14) + 18\,a(n-15) - 9\,a(n-16) + 9\,a(n-17) - 3\,a(n-18)
\end{equation}
for all $n>23$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A318019.
