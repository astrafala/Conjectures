...
\title{The empirical recurrence for OEIS A220213, proved by transfer matrix}
...
\begin{abstract}
OEIS A220213 counts the distinct indicator arrays obtained from the $n\times2$ arrays over
...
OEIS A220213 is ``Majority value maps: number of n X 2 binary arrays indicating the locations of corresponding elements equal to at least half of their king-move neighbors in a random 0..1 n X 2 array.''. It has offset $1$ and begins
\[
2, 6, 23, 75, 241, 777, 2512, 8132,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + 2*a(n-2) + 3*a(n-3) + 7*a(n-4) + 9*a(n-5) + 12*a(n-6) + 11*a(n-7) + 4*a(n-8) + 4*a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 31 2018 07:22:22, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 2\,a(n-2) + 3\,a(n-3) + 7\,a(n-4) + 9\,a(n-5) + 12\,a(n-6) + 11\,a(n-7) + 4\,a(n-8) + 4\,a(n-9)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A220213.
