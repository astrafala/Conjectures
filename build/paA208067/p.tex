...
\title{The empirical recurrence for OEIS A208067, proved by transfer matrix}
...
\begin{abstract}
OEIS A208067 counts arrays over $\{0,\dots,1\}$ of width $6$ that avoid the patterns
...
OEIS A208067 is ``Number of n X 6 0..1 arrays avoiding 0 0 0 and 1 1 1 horizontally and 0 0 1 and 0 1 1 vertically.''. It has offset
$1$ and begins
\[
26, 676, 2080, 6400, 12960, 26244, 44064,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) + 2*a(n-2) - 6*a(n-3) + 6*a(n-5) - 2*a(n-6) - 2*a(n-7) + a(n-8) for n>9.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 27 2018 09:07:17, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208067.
