...
\title{The empirical recurrence for OEIS A207657, proved by transfer matrix}
...
\begin{abstract}
OEIS A207657 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
...
OEIS A207657 is ``Number of nX4 0..1 arrays avoiding 0 0 0 and 1 1 1 horizontally and 0 0 1 and 1 0 0 vertically.''. It has offset
$1$ and begins
\[
10, 100, 292, 870, 2774, 9060, 30440,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:08:02, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;8\,a(n-1) - 9\,a(n-2) - 67\,a(n-3) + 135\,a(n-4) + 215\,a(n-5) - 508\,a(n-6) - 375\,a(n-7) + 781\,a(n-8) + 426\,a(n-9) - 467\,a(n-10) - 263\,a(n-11) + 81\,a(n-12) + 51\,a(n-13) - 4\,a(n-14) - 3\,a(n-15)
\end{equation}
for all $n>14$. 
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207657.
