...
\title{The empirical recurrence for OEIS A303327, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A303327 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A303327 is ``Number of 5Xn 0..1 arrays with every element equal to 0, 2, 4, 5 or 6 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
16, 1, 16, 4, 64, 25, 368, 201,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 21 2018 13:15:07, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) + 12\,a(n-2) - 129\,a(n-3) + 69\,a(n-4) + 842\,a(n-5) - 1297\,a(n-6) - 839\,a(n-7) + 3412\,a(n-8) - 9036\,a(n-9) + 11871\,a(n-10) + 17108\,a(n-11) - 45954\,a(n-12) + 47570\,a(n-13) - 53012\,a(n-14) - 66076\,a(n-15) + 203444\,a(n-16) - 165552\,a(n-17) + 190584\,a(n-18) + 4296\,a(n-19) - 282112\,a(n-20) + 206832\,a(n-21) - 309856\,a(n-22) + 208160\,a(n-23) - 21344\,a(n-24) + 101312\,a(n-25) - 1024\,a(n-26) + 22336\,a(n-27) - 32256\,a(n-28) + 2560\,a(n-29) - 2816\,a(n-30) + 2816\,a(n-31) + 1536\,a(n-32) + 1024\,a(n-33) - 1024\,a(n-34)
\end{equation}
for all $n>35$.
...
\#\{\text{neighbours with a value }equal to\ x_{t,u}\}\in\{0,2,4,5,6\}
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A303327.
