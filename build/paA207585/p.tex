...
\title{The empirical recurrence for OEIS A207585, proved by transfer matrix}
...
\begin{abstract}
OEIS A207585 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
$(0,0,0), (0,0,1)$ along one axis and $(0,0,1), (1,1,1)$ along the other, and carries an empirical recurrence of
...
OEIS A207585 is ``Number of nX4 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 0 1 and 1 1 1 vertically.''. It has offset
$1$ and begins
\[
10, 100, 144, 432, 1014, 2232, 5000,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:06:32, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-2) + 12\,a(n-3) - 3\,a(n-4) - 12\,a(n-5) - 61\,a(n-6) - 4\,a(n-7) - a(n-8) + 197\,a(n-9) + 12\,a(n-10) + 109\,a(n-11) - 375\,a(n-12) + 7\,a(n-13) - 346\,a(n-14) + 564\,a(n-15) - 75\,a(n-16) + 480\,a(n-17) - 607\,a(n-18) + 105\,a(n-19) - 355\,a(n-20) + 466\,a(n-21) - 36\,a(n-22) + 101\,a(n-23) - 288\,a(n-24) - 9\,a(n-25) + 21\,a(n-26) + 129\,a(n-27) + a(n-28) - 18\,a(n-29) - 42\,a(n-30) + 2\,a(n-32) + 9\,a(n-33) - a(n-36)
\end{equation}
for all $n>36$. 
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207585.
