...
\title{The empirical recurrence for OEIS A231518, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A231518 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A231518 is ``Number of nX3 0..1 arrays with no element less than a strict majority of its horizontal, diagonal and antidiagonal neighbors.''. It has offset $1$ and begins
\[
4, 34, 153, 776, 3861, 18721, 91993, 453274,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 06:33:29, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) - 2\,a(n-2) + 43\,a(n-3) - 50\,a(n-4) + 33\,a(n-5) - 307\,a(n-6) + 115\,a(n-7) - 66\,a(n-8) + 490\,a(n-9) + 60\,a(n-10) - 144\,a(n-11) + 32\,a(n-12) - 192\,a(n-13)
\end{equation}
for all $n>14$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231518.
