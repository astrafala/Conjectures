...
\title{The empirical recurrence for OEIS A298723, proved by transfer matrix}
...
\begin{abstract}
OEIS A298723 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $equal to$ itself lying in $\{0,2,3,5,8\}$, and it carries an empirical
recurrence of order $58$ contributed by R.~H.~Hardin. It is true. The neighbourhood
...
OEIS A298723 is ``Number of nX4 0..1 arrays with every element equal to 0, 2, 3, 5 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 18, 15, 34, 77, 230, 712, 2167,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 25 2018 08:55:21, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) - 9\,a(n-2) - a(n-3) + 2\,a(n-4) - 2\,a(n-5) + 15\,a(n-6) + 26\,a(n-7) - 157\,a(n-8) + 466\,a(n-9) - 220\,a(n-10) - 444\,a(n-11) + 96\,a(n-12) - 157\,a(n-13) - 652\,a(n-14) + 146\,a(n-15) + 1984\,a(n-16) + 130\,a(n-17) + 2025\,a(n-18) - 2473\,a(n-19) + 6365\,a(n-20) - 4168\,a(n-21) - 11764\,a(n-22) + 5390\,a(n-23) - 9469\,a(n-24) + 8003\,a(n-25) - 14173\,a(n-26) + 26192\,a(n-27) - 10436\,a(n-28) + 27101\,a(n-29) - 15251\,a(n-30) + 9559\,a(n-31) + 14483\,a(n-32) - 50379\,a(n-33) + 34809\,a(n-34) - 58786\,a(n-35) + 60997\,a(n-36) - 73488\,a(n-37) + 83309\,a(n-38) - 55321\,a(n-39) + 43987\,a(n-40) - 38228\,a(n-41) + 37989\,a(n-42) - 14291\,a(n-43) + 2903\,a(n-44) - 12735\,a(n-45) + 11717\,a(n-46) - 10534\,a(n-47) + 5177\,a(n-48) + 1621\,a(n-49) + 1470\,a(n-50) - 2283\,a(n-51) - 323\,a(n-52) - 752\,a(n-53) + 511\,a(n-54) + 22\,a(n-55) + 60\,a(n-56) - 80\,a(n-57) + 16\,a(n-58)
\end{equation}
for all $n>59$.
...
has score in $\{0,2,3,5,8\}$. The entry also fixes the top-left entry to be $0$; that is a condition on the first row alone, so it restricts the start vector and nothing else.
...
\begin{itemize}
\item $\mathbf{s}(r,s)=1$ when every cell of $r$ has score in $\{0,2,3,5,8\}$ \emph{with no row
above $r$} and $r_1=0$, and $0$ otherwise;
\item an edge $(r,s)\to(s,t)$ when every cell of $s$ has score in $\{0,2,3,5,8\}$ computed from
$r$, $s$ and $t$;
\item $\mathbf{e}(r,s)=1$ when every cell of $s$ has score in $\{0,2,3,5,8\}$ \emph{with no row
...
exactly when every one of its $n$ rows has all scores in $\{0,2,3,5,8\}$. Read the sequence as the
...
$a(n)-\sum_i c_i a(n-i)=u_{\,n-2-58}$ whenever $n-58\ge2$. So \eqref{eq:conj}
holds for every $n>t$ exactly when $u_j=0$ for all $j>t-2-58$. Moreover $(u_j)$
...
\begin{proof}
Substituting Lemma~\ref{lem:walk} and factoring $P^{\,n-2-58}$ out of
...
\begin{proof}
The vector $q(P)\mathbf{e}\in\mathbb{Z}^{S}$ was formed by $58$ matrix--vector
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A298723.
