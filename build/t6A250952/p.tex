...
\title{The empirical recurrence for OEIS A250952, proved by transfer matrix}
...
\begin{abstract}
OEIS A250952 counts $(n+1)\times5$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A250952 is ``Number of (n+1) X (4+1) 0..1 arrays with no 2 X 2 subblock having its maximum diagonal element less than its minimum antidiagonal element.''. It has offset $1$ and begins
\[
780, 19208, 472712, 11633448, 286298344, 7045780240, 173396103624, 4267264603784,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 27*a(n-1) - 57*a(n-2) - 46*a(n-3) + 30*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 24 2018 08:11:32, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250952.
