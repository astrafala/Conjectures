...
\title{The empirical recurrence for OEIS A264139, proved by transfer matrix}
...
\begin{abstract}
OEIS A264139 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=6$ rows in which
...
OEIS A264139 is ``Number of (n+1)X(5+1) arrays of permutations of 0..n*6+5 with each element having index change +-(.,.) 0,0 1,-2 or 1,1.''. It has offset $1$ and begins
\[
125, 3600, 168948, 7001316, 302693857, 12968882161, 557669432592, 23961367651225,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 10 2015 11:15:24, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;43\,a(n-1) - a(n-2) + 3413255\,a(n-6) - 146769965\,a(n-7) + 3413255\,a(n-8) - 6304281985\,a(n-12) + 271084125355\,a(n-13) - 6304281985\,a(n-14) + 6304281985\,a(n-18) - 271084125355\,a(n-19) + 6304281985\,a(n-20) - 3413255\,a(n-24) + 146769965\,a(n-25) - 3413255\,a(n-26) + a(n-30) - 43\,a(n-31) + a(n-32)
\]
for every $n>30$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264139.
