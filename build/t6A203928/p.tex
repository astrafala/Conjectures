...
\title{The empirical recurrence for OEIS A203928, proved by transfer matrix}
...
\begin{abstract}
OEIS A203928 counts $(n+1)\times3$ arrays over $\{0,\dots,5\}$ subject to a condition imposed on
...
OEIS A203928 is ``Number of (n+1) X 3 0..5 arrays with every 2 X 2 subblock having equal diagonal elements or equal antidiagonal elements.''. It has offset $1$ and begins
\[
4356, 106596, 2543436, 60873876, 1456391916, 34845401556, 833700866796, 19946896311636,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 21*a(n-1) + 70*a(n-2).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 05 2018 16:13:54, revision 11) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A203928.
