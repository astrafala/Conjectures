...
different counts. Across the columns settled here the model reproduces $10$ published
values, $75$ decimal digits in all, every one of them exactly; a misreading of the entry
