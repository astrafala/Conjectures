...
\title{The empirical recurrence for OEIS A220591, proved by transfer matrix}
...
\begin{abstract}
OEIS A220591 counts the ways of linking the cells of a grid $3$ cells wide, each cell either to
...
OEIS A220591 is ``Number of ways to reciprocally link elements of an nX3 array either to themselves or to exactly two king-move neighbors.''. It has offset $1$ and begins
\[
1, 33, 423, 6156, 87542, 1250507, 17847210, 254759570,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 11*a(n-1) +46*a(n-2) +14*a(n-3) -46*a(n-4) -63*a(n-5) +35*a(n-6) +20*a(n-7) +a(n-8) -4*a(n-9) -a(n-10)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 18:52:44, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;11\,a(n-1) + 46\,a(n-2) + 14\,a(n-3) - 46\,a(n-4) - 63\,a(n-5) + 35\,a(n-6) + 20\,a(n-7) + a(n-8) - 4\,a(n-9) - a(n-10)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A220591.
