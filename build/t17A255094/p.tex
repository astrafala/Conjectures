...
\title{The empirical recurrence for OEIS A255094, proved by transfer matrix}
...
\begin{abstract}
OEIS A255094 counts $(n+2)\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A255094 is ``Number of (n+2) X (1+2) 0..1 arrays with no 3 x 3 subblock diagonal sum 1 and no antidiagonal sum 1 and no row sum 1 and no column sum 1.''. It has offset $1$ and begins
\[
36, 77, 179, 419, 991, 2345, 5537, 13105,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) - a(n-2) + 5*a(n-3) - 2*a(n-4) + 3*a(n-5) - 2*a(n-6) - 2*a(n-7) - 2*a(n-8) - 2*a(n-9) + 2*a(n-11) for n>12.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 18 2018 11:11:37, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) - a(n-2) + 5\,a(n-3) - 2\,a(n-4) + 3\,a(n-5) - 2\,a(n-6) - 2\,a(n-7) - 2\,a(n-8) - 2\,a(n-9) + 2\,a(n-11)
\]
for every $n>12$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A255094.
