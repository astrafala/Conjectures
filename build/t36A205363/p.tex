...
\title{The empirical recurrence for OEIS A205363, proved by transfer matrix}
...
\begin{abstract}
OEIS A205363 counts arrays over $\{0,\dots,3\}$ under a condition on the number of clockwise edge increases
...
a bounded window of consecutive rows, so the count is a walk count on $S=44$ states and is
...
OEIS A205363 is ``Number of (n+1)X2 0..3 arrays with the number of clockwise edge increases in every 2X2 subblock the same.''. It has offset $1$ and begins
\[
256, 1976, 15616, 124048, 986388, 7854572, 62623348, 499915248,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 16*a(n-1) -63*a(n-2) -27*a(n-3) +182*a(n-4) -217*a(n-5) +114*a(n-6) -4*a(n-7) -4*a(n-8) +4*a(n-9) for n>10
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 12:03:20, revision 9) this is still
...
a state and rows $r,s$ may follow one another when all $1$ of their subblocks give $v$.
Taking the disjoint union over $v$,
\[
a(n)\;=\;\iota^{\!\top}M^{\,n}\tau,\qquad\iota=\tau=(1,\dots,1)^{\!\top},
\]
on the $S=44$ states that survive. Rows carrying no edge at all are dropped: such a row could
...
\begin{theorem}
\[
a(n)\;=\;16\,a(n-1) - 63\,a(n-2) - 27\,a(n-3) + 182\,a(n-4) - 217\,a(n-5) + 114\,a(n-6) - 4\,a(n-7) - 4\,a(n-8) + 4\,a(n-9)
\]
for every $n>10$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A205363.
