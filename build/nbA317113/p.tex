...
\title{The empirical recurrence for OEIS A317113, proved by transfer matrix}
...
\begin{abstract}
OEIS A317113 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A317113 is ``Number of nX3 0..1 arrays with every element unequal to 0, 1, 2, 3, 4, 7 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
4, 30, 142, 698, 3398, 16686, 81809, 401415,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) +10*a(n-2) -a(n-3) -12*a(n-4) +7*a(n-5) -a(n-6) -20*a(n-7) +15*a(n-8) -3*a(n-9) -3*a(n-10) for n>12
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 21 2018 17:23:09, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 10\,a(n-2) - a(n-3) - 12\,a(n-4) + 7\,a(n-5) - a(n-6) - 20\,a(n-7) + 15\,a(n-8) - 3\,a(n-9) - 3\,a(n-10)
\end{equation}
for all $n>11$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A317113.
