...
\title{The empirical recurrence for OEIS A207566, proved by transfer matrix}
...
\begin{abstract}
OEIS A207566 counts arrays over $\{0,\dots,1\}$ of width $5$ that avoid the patterns
...
OEIS A207566 is ``Number of 5Xn 0..1 arrays avoiding 0 0 1 and 0 1 0 horizontally and 0 1 1 and 1 1 0 vertically.''. It has offset
$1$ and begins
\[
14, 196, 618, 2135, 9568, 32823, 106833,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:05:11, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) - 6\,a(n-2) + 22\,a(n-3) - 85\,a(n-4) + 35\,a(n-5) - 76\,a(n-6) + 424\,a(n-7) + 187\,a(n-8) - 47\,a(n-9) - 1134\,a(n-10) - 824\,a(n-11) + 5\,a(n-12) + 1715\,a(n-13) + 1238\,a(n-14) + 142\,a(n-15) - 1061\,a(n-16) - 707\,a(n-17) - 174\,a(n-18) + 280\,a(n-19) + 89\,a(n-20) - 13\,a(n-21) - 46\,a(n-22) + 10\,a(n-23) + 11\,a(n-24) + 11\,a(n-25)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207566.
