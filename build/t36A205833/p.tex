...
\title{The empirical recurrence for OEIS A205833, proved by transfer matrix}
...
\begin{abstract}
OEIS A205833 counts arrays over $\{0,\dots,2\}$ under a condition on the number of clockwise edge increases
in every $2\times2$ subblock, and carries an empirical recurrence of order $30$ contributed by
...
OEIS A205833 is ``Number of (n+1)X6 0..2 arrays with the number of clockwise edge increases in every 2X2 subblock equal to two.''. It has offset $1$ and begins
\[
6132, 122526, 2531223, 52826862, 1105752330, 23163320754, 485313697782, 10168541874792,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 12:17:08, revision 9) this is still
...
subblocks; the entry's first term is $6132$, which the model
...
\begin{theorem}
\[
a(n)\;=\;50\,a(n-1) - 967\,a(n-2) + 9966\,a(n-3) - 61665\,a(n-4) + 238876\,a(n-5) - 566620\,a(n-6) + 685346\,a(n-7) + 102414\,a(n-8) - 1329090\,a(n-9) - 88722\,a(n-10) + 6610223\,a(n-11) - 14921326\,a(n-12) + 15135867\,a(n-13) - 2541029\,a(n-14) - 13928242\,a(n-15) + 20602103\,a(n-16) - 14996664\,a(n-17) + 5587268\,a(n-18) + 151004\,a(n-19) - 1261871\,a(n-20) + 642104\,a(n-21) - 175642\,a(n-22) + 40087\,a(n-23) + 7838\,a(n-24) - 9227\,a(n-25) + 687\,a(n-26) - 82\,a(n-27) - 64\,a(n-28) + 3\,a(n-29) - a(n-30)
\]
for every $n>30$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A205833.
