...
\title{The empirical recurrence for OEIS A207941, proved by transfer matrix}
...
\begin{abstract}
OEIS A207941 counts arrays over $\{0,\dots,1\}$ of width $5$ that avoid the patterns
...
OEIS A207941 is ``Number of 5Xn 0..1 arrays avoiding 0 0 1 and 1 0 0 horizontally and 0 0 1 and 1 1 0 vertically.''. It has offset
$1$ and begins
\[
10, 100, 350, 1271, 5594, 25490, 121313,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:30:03, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;8\,a(n-1) - 5\,a(n-2) - 82\,a(n-3) + 113\,a(n-4) + 341\,a(n-5) - 502\,a(n-6) - 765\,a(n-7) + 943\,a(n-8) + 998\,a(n-9) - 797\,a(n-10) - 709\,a(n-11) + 275\,a(n-12) + 233\,a(n-13) - 26\,a(n-14) - 24\,a(n-15)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207941.
