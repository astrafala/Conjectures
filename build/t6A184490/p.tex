...
\title{The empirical recurrence for OEIS A184490, proved by transfer matrix}
...
\begin{abstract}
OEIS A184490 counts $(n+1)\times3$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A184490 is ``Number of (n+1)X3 0..2 arrays with every 2X2 subblock sum greater than 4.''. It has offset $1$ and begins
\[
165, 1983, 20514, 225739, 2429833, 26384550, 285552669, 3094453927,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n)=8*a(n-1)+42*a(n-2)-106*a(n-3)-213*a(n-4)+351*a(n-5)+186*a(n-6)-256*a(n-7)-40*a(n-8)+48*a(n-9)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 02:41:47, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;8\,a(n-1) + 42\,a(n-2) - 106\,a(n-3) - 213\,a(n-4) + 351\,a(n-5) + 186\,a(n-6) - 256\,a(n-7) - 40\,a(n-8) + 48\,a(n-9)
\end{equation}
for all $n>9$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A184490.
