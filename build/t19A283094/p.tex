...
\title{The empirical recurrence for OEIS A283094, proved by transfer matrix}
...
\begin{abstract}
OEIS A283094 counts $n\times2$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A283094 is ``Number of n X 2 0..1 arrays with no 1 equal to more than one of its horizontal and vertical neighbors, with the exception of exactly two elements.''. It has offset $1$ and begins
\[
0, 0, 6, 28, 142, 606, 2458, 9520,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 06 2017 19:30:41, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) - 3\,a(n-2) - 28\,a(n-3) + 6\,a(n-4) + 66\,a(n-5) + 33\,a(n-6) - 36\,a(n-7) - 30\,a(n-8) + 6\,a(n-9) + 9\,a(n-10) - a(n-12)
\]
for every $n>12$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A283094.
