...
\title{The empirical recurrence for OEIS A221757, proved by transfer matrix}
...
\begin{abstract}
OEIS A221757 counts the distinct OCCUPANCY arrays obtained when every cell of an $n\times3$ grid
...
an empirical recurrence of order $10$ contributed by R.~H.~Hardin. It is true, and it is
...
one, on $S=355$ states, after which the conjectured recurrence is settled by a finite exact
computation.
\end{abstract}
...
OEIS A221757 is ``Number of 3 X n arrays of occupancy after each element moves to some horizontal or antidiagonal neighbor, without move-in move-out straight through or left turns.''. It has offset $1$ and begins
\[
0, 4, 0, 43, 44, 736, 1680, 14548,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 27*a(n-2) + 14*a(n-3) - 165*a(n-4) - 20*a(n-5) + 329*a(n-6) - 48*a(n-7) - 131*a(n-8) - 34*a(n-9) + 9*a(n-10).
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2018 17:34:03, revision 7) this is still
...
$S=355$ reachable sets. In particular $a$ is $C$-finite.
...
\begin{theorem}
\[
a(n)\;=\;27\,a(n-2) + 14\,a(n-3) - 165\,a(n-4) - 20\,a(n-5) + 329\,a(n-6) - 48\,a(n-7) - 131\,a(n-8) - 34\,a(n-9) + 9\,a(n-10)
\]
for every $n>10$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221757.
