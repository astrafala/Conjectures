...
\title{The empirical recurrence for OEIS A208120, proved by transfer matrix}
...
\begin{abstract}
OEIS A208120 counts arrays over $\{0,\dots,1\}$ of width $5$ that avoid the patterns
...
OEIS A208120 is ``Number of 5Xn 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 0 1 and 0 1 1 vertically.''. It has offset
$1$ and begins
\[
12, 144, 420, 1225, 7315, 43681, 175560,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:39:28, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) - 6\,a(n-2) + 29\,a(n-3) + 247\,a(n-4) + 246\,a(n-5) + 1656\,a(n-6) - 9936\,a(n-8) - 8856\,a(n-9) - 53352\,a(n-10) - 37584\,a(n-11) + 46656\,a(n-12) - 46656\,a(n-13) + 279936\,a(n-14)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208120.
