...
\title{The empirical recurrence for OEIS A218633, proved by transfer matrix}
...
\begin{abstract}
OEIS A218633 counts the distinct indicator arrays obtained from the $n\times3$ arrays over
...
indicator row by row turns it into one, on $S=78$ states, after which the conjectured
...
OEIS A218633 is ``Hilltop maps: number of nX3 binary arrays indicating the locations of corresponding elements not exceeded by any horizontal, diagonal or antidiagonal neighbor in a random 0..3 nX3 array.''. It has offset $1$ and begins
\[
7, 63, 511, 4087, 32689, 261505, 2092027, 16736081,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 17:43:46, revision 8) this is still
...
\]
There are $S=78$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite. Note
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-1) + 7\,a(n-2) + 7\,a(n-3) + 7\,a(n-4) + 7\,a(n-5) + 3\,a(n-6) + 21\,a(n-7) + 6\,a(n-8) + 6\,a(n-9) + 6\,a(n-10) + 6\,a(n-11) + 3\,a(n-12) + 9\,a(n-13) - 9\,a(n-14) - 9\,a(n-15) - 9\,a(n-16) - 9\,a(n-17) - 9\,a(n-18) - 9\,a(n-19)
\]
for every $n>19$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A218633.
