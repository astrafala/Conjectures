...
\title{The empirical recurrence for OEIS A188711, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A188711 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A188711 is ``Number of 7Xn binary arrays without the pattern 0 0 diagonally or vertically.''. It has offset $1$ and begins
\[
34, 697, 14925, 318732, 6814290, 145764780, 3118943536, 66743533552,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 34*a(n-1) -324*a(n-2) +1264*a(n-3) -2236*a(n-4) +1816*a(n-5) -624*a(n-6) +64*a(n-7) for n>9
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 04:47:48, revision 9) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A188711.
