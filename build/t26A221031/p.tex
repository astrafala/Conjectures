...
\title{The empirical recurrence for OEIS A221031, proved by transfer matrix}
...
\begin{abstract}
OEIS A221031 counts the distinct indicator arrays obtained from the $n\times4$ arrays over
...
indicator row by row turns it into one, on $S=139$ states, after which the conjectured
...
OEIS A221031 is ``Majority value maps: number of n X 4 binary arrays indicating the locations of corresponding elements equal to at least half of their horizontal and antidiagonal neighbors in a random 0..2 n X 4 array.''. It has offset $1$ and begins
\[
7, 119, 1733, 24485, 345755, 4882030, 68933905, 973340015,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 20 2014 10:35:31, revision 8) this is still
...
\]
There are $S=139$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite. Note
...
\begin{theorem}
\[
a(n)\;=\;22\,a(n-1) - 139\,a(n-2) + 446\,a(n-3) - 825\,a(n-4) + 817\,a(n-5) - 168\,a(n-6) - 528\,a(n-7) + 480\,a(n-8) + 48\,a(n-9) - 208\,a(n-10) + 64\,a(n-11)
\]
for every $n>12$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221031.
