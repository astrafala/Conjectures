...
\title{The empirical recurrence for OEIS A233869, proved by transfer matrix}
...
\begin{abstract}
OEIS A233869 counts $(n+1)\times2$ arrays over $\{0,\dots,7\}$ subject to a condition imposed on
...
OEIS A233869 is ``Number of (n+1)X(1+1) 0..7 arrays with every 2X2 subblock having the sum of the absolute values of all six edge and diagonal differences equal to 21.''. It has offset $1$ and begins
\[
224, 1176, 5984, 34416, 189632, 1128928, 6414208, 38622656,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 09:02:19, revision 7) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 72\,a(n-2) - 136\,a(n-3) - 1764\,a(n-4) + 2984\,a(n-5) + 18928\,a(n-6) - 25920\,a(n-7) - 92800\,a(n-8) + 81920\,a(n-9) + 204800\,a(n-10) - 81920\,a(n-11) - 172032\,a(n-12) + 16384\,a(n-13) + 32768\,a(n-14)
\end{equation}
for all $n>14$.
...
|\beta-\alpha|+|\delta-\beta|+|\gamma-\delta|+|\alpha-\gamma|+|\delta-\alpha|+|\gamma-\beta|\;=\;21,
\end{equation}
...
index corresponding to $n=14+1$ onwards, and the run continued until $w$ itself was the
zero vector, which settles every larger $j$ at once. By Lemma~\ref{lem:crit} the recurrence
holds for every $n>14$.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A233869.
