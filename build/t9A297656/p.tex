...
\title{The empirical recurrence for OEIS A297656, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297656 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A297656 is ``Number of 3Xn 0..1 arrays with every 1 horizontally, diagonally or antidiagonally adjacent to 1, 2 or 3 neighboring 1s.''. It has offset $1$ and begins
\[
1, 36, 231, 1073, 6838, 45036, 268655, 1617465,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 02 2018 15:16:08, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) + 67\,a(n-3) + 65\,a(n-4) + 58\,a(n-5) + 60\,a(n-6) - 296\,a(n-7) - 269\,a(n-8) - 48\,a(n-9) + 43\,a(n-10) + 400\,a(n-11) + 473\,a(n-12) + 81\,a(n-13) - 9\,a(n-14) + 23\,a(n-15) + a(n-16) + 4\,a(n-17)
\end{equation}
for all $n>18$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297656.
