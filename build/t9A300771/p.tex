...
\title{The empirical recurrence for OEIS A300771, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A300771 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A300771 is ``Number of nX3 0..1 arrays with every element equal to 2, 3, 4 or 6 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
0, 2, 3, 11, 32, 102, 330, 1059,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 12 2018 11:25:39, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 3\,a(n-3) - 3\,a(n-4) + 5\,a(n-5) - 2\,a(n-6) - 11\,a(n-7) - 13\,a(n-8) + 11\,a(n-9) - 2\,a(n-10) - 5\,a(n-11) + a(n-12) + 5\,a(n-13) - 4\,a(n-14) + a(n-15)
\end{equation}
for all $n>16$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A300771.
