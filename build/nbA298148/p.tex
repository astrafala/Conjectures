...
\title{The empirical recurrence for OEIS A298148, proved by transfer matrix}
...
\begin{abstract}
OEIS A298148 counts $2$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A298148 is ``Number of nX2 0..1 arrays with every element equal to 0, 1, 3, 4, 5 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
2, 4, 4, 16, 50, 112, 348, 1028,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) +2*a(n-2) +6*a(n-3) -10*a(n-4) -8*a(n-5) for n>6
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 13 2018 11:35:12, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 2\,a(n-2) + 6\,a(n-3) - 10\,a(n-4) - 8\,a(n-5)
\end{equation}
for all $n>5$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A298148.
