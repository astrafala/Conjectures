...
\title{The empirical recurrence for OEIS A282786, proved by transfer matrix}
...
\begin{abstract}
OEIS A282786 counts $n\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A282786 is ``Number of nX3 0..1 arrays with no 1 equal to more than one of its king-move neighbors, with the exception of exactly one element.''. It has offset $1$ and begins
\[
1, 8, 73, 318, 1747, 8216, 38027, 173722,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 21 2017 08:40:25, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + 8\,a(n-2) - 8\,a(n-3) - 78\,a(n-4) - 72\,a(n-5) - 16\,a(n-6) + 64\,a(n-7) - 33\,a(n-8) + 52\,a(n-9) - 24\,a(n-10) + 8\,a(n-11) - 4\,a(n-12)
\]
for every $n>12$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A282786.
