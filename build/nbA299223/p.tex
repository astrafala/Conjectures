...
\title{The empirical recurrence for OEIS A299223, proved by transfer matrix}
...
\begin{abstract}
OEIS A299223 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $equal to$ itself lying in $\{1,2,3,4,6,7\}$, and it carries an empirical
...
OEIS A299223 is ``Number of nX3 0..1 arrays with every element equal to 1, 2, 3, 4, 6 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 17, 113, 628, 3669, 21792, 128610, 758715,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 05 2018 13:29:33, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) + 3\,a(n-2) + 16\,a(n-3) - 7\,a(n-4) - 32\,a(n-5) - 25\,a(n-6) - 62\,a(n-7) + 44\,a(n-8) - 57\,a(n-9) - 12\,a(n-10) - 74\,a(n-11) + 46\,a(n-12) - 20\,a(n-13) - 16\,a(n-14)
\end{equation}
for all $n>15$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A299223.
