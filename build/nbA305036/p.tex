...
\title{The empirical recurrence for OEIS A305036, proved by transfer matrix}
...
\begin{abstract}
OEIS A305036 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A305036 is ``Number of nX4 0..1 arrays with every element unequal to 0, 1, 2, 6 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
8, 5, 7, 19, 26, 61, 143, 277,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +5*a(n-3) +a(n-4) -4*a(n-6) -4*a(n-7) for n>11
\end{quote}
As of the ``Last modified'' line on the live entry (May 24 2018 08:41:18, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A305036.
