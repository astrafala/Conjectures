...
\title{The empirical recurrence for OEIS A220757, proved by transfer matrix}
...
\begin{abstract}
OEIS A220757 counts the distinct arrays obtained by applying a fixed local operation to every cell
of an array over a bounded alphabet, and carries an empirical recurrence of order $18$
...
$S=244$ states, after which the conjectured recurrence is settled by a finite exact
computation.
\end{abstract}
...
OEIS A220757 is ``Number of nX3 arrays of the minimum value of corresponding elements and their horizontal, diagonal or antidiagonal neighbors in a random 0..3 nX3 array.''. It has offset $1$ and begins
\[
16, 268, 4328, 68212, 1094438, 17553448, 281649154, 4519836612,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 19:02:34, revision 8) this is still
...
\]
There are $S=244$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite.
...
\begin{theorem}
\[
a(n)\;=\;18\,a(n-1) - 21\,a(n-2) - 138\,a(n-3) - 441\,a(n-4) - 137\,a(n-5) + 1764\,a(n-6) - 1136\,a(n-7) + 14709\,a(n-8) + 67123\,a(n-9) + 121526\,a(n-10) - 80625\,a(n-11) - 792044\,a(n-12) - 1086870\,a(n-13) - 773840\,a(n-14) - 232356\,a(n-15) - 156248\,a(n-16) - 229216\,a(n-17) - 86528\,a(n-18)
\]
for every $n>18$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A220757.
