...
\title{The empirical recurrence for OEIS A207422, proved by transfer matrix}
...
\begin{abstract}
OEIS A207422 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
...
OEIS A207422 is ``Number of nX4 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 0 1 and 0 1 0 vertically.''. It has offset
$1$ and begins
\[
9, 81, 361, 1521, 6889, 29929, 127449,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 13:53:06, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) + a(n-2) + 8\,a(n-3) - 21\,a(n-4) - 46\,a(n-5) - 6\,a(n-6) + 35\,a(n-7) + 49\,a(n-8) + 19\,a(n-9) - 16\,a(n-10) - 21\,a(n-11) - 4\,a(n-13) - 2\,a(n-14) + a(n-15)
\end{equation}
for all $n>14$. 
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207422.
