...
\title{The empirical recurrence for OEIS A301611, proved by transfer matrix}
...
\begin{abstract}
OEIS A301611 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the four horizontal and vertical neighbours, a number $equal to$ itself lying in $\{1,2,3\}$, and it carries an empirical
...
OEIS A301611 is ``Number of nX4 0..1 arrays with every element equal to 1, 2 or 3 horizontally or vertically adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
2, 34, 367, 3816, 40085, 421025, 4422826, 46459647,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 24 2018 11:39:37, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;7\,a(n-1) + 41\,a(n-2) - 12\,a(n-3) - 318\,a(n-4) - 262\,a(n-5) + 724\,a(n-6) + 1034\,a(n-7) - 1340\,a(n-8) - 3422\,a(n-9) + 4016\,a(n-10) + 12158\,a(n-11) + 6925\,a(n-12) - 17989\,a(n-13) - 30269\,a(n-14) + 7574\,a(n-15) + 1694\,a(n-16) + 8004\,a(n-17) - 672\,a(n-18) + 432\,a(n-19) - 864\,a(n-20)
\end{equation}
for all $n>20$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A301611.
