...
\title{The empirical recurrence for OEIS A303956, proved by transfer matrix}
...
\begin{abstract}
OEIS A303956 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A303956 is ``Number of nX3 0..1 arrays with every element unequal to 0, 1, 2 or 5 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
4, 5, 11, 22, 49, 119, 287, 664,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +2*a(n-2) +3*a(n-3) +2*a(n-4) -2*a(n-5) -6*a(n-6) -4*a(n-7) for n>8
\end{quote}
As of the ``Last modified'' line on the live entry (May 03 2018 12:43:43, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 2\,a(n-2) + 3\,a(n-3) + 2\,a(n-4) - 2\,a(n-5) - 6\,a(n-6) - 4\,a(n-7)
\end{equation}
for all $n>7$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A303956.
