...
\title{The empirical recurrence for OEIS A298571, proved by transfer matrix}
...
\begin{abstract}
OEIS A298571 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A298571 is ``Number of nX4 0..1 arrays with every element equal to 0, 2, 4, 5 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 8, 2, 3, 41, 38, 70, 374,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 22 2018 06:14:25, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + a(n-2) + 26\,a(n-3) - 16\,a(n-4) - 20\,a(n-5) - 278\,a(n-6) + 92\,a(n-7) + 146\,a(n-8) + 1603\,a(n-9) - 188\,a(n-10) - 487\,a(n-11) - 5508\,a(n-12) - 255\,a(n-13) + 587\,a(n-14) + 11843\,a(n-15) + 2118\,a(n-16) + 867\,a(n-17) - 16392\,a(n-18) - 4788\,a(n-19) - 3812\,a(n-20) + 14685\,a(n-21) + 5603\,a(n-22) + 5402\,a(n-23) - 8344\,a(n-24) - 3708\,a(n-25) - 4188\,a(n-26) + 2776\,a(n-27) + 1216\,a(n-28) + 1696\,a(n-29) - 384\,a(n-30) - 128\,a(n-31) - 256\,a(n-32)
\end{equation}
for all $n>32$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A298571.
