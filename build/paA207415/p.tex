...
\title{The empirical recurrence for OEIS A207415, proved by transfer matrix}
...
\begin{abstract}
OEIS A207415 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
...
OEIS A207415 is ``Number of n X 4 0..1 arrays avoiding 0 0 1 and 0 1 0 horizontally and 0 1 1 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
9, 81, 241, 742, 2760, 8465, 24317,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 13:52:16, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) - 8\,a(n-2) + 23\,a(n-3) - 74\,a(n-4) + 70\,a(n-5) - 116\,a(n-6) + 362\,a(n-7) - 122\,a(n-8) + 152\,a(n-9) - 916\,a(n-10) - 166\,a(n-11) + 26\,a(n-12) + 1638\,a(n-13) + 657\,a(n-14) - 225\,a(n-15) - 1890\,a(n-16) - 895\,a(n-17) + 372\,a(n-18) + 1268\,a(n-19) + 486\,a(n-20) - 190\,a(n-21) - 454\,a(n-22) - 122\,a(n-23) + 60\,a(n-24) + 60\,a(n-25)
\end{equation}
for all $n>24$. 
...
$(0,0,1), (0,1,0)$ as $3$ consecutive entries. There are $9$ admissible rows; that condition
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207415.
