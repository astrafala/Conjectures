...
\title{The empirical recurrence for OEIS A205050, proved by transfer matrix}
...
\begin{abstract}
OEIS A205050 counts arrays over $\{0,\dots,2\}$ under a condition on the number of rightwards and downwards edge increases
in every $2\times2$ subblock, and carries an empirical recurrence of order $39$ contributed by
R.~H.~Hardin. It is true, and it is decidable rather than empirical. The condition is local to
a bounded window of consecutive rows, so the count is a walk count on $S=803$ states and is
...
OEIS A205050 is ``Number of (n+1)X4 0..2 arrays with the number of rightwards and downwards edge increases in each 2X2 subblock equal to the number in all its horizontal and vertical neighbors.''. It has offset $1$ and begins
\[
803, 4171, 23720, 182720, 1280452, 10523741, 76554719, 627391509,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 11:43:20, revision 9) this is still
...
subblocks; the entry's first term is $803$, which the model
...
\begin{theorem}
\[
a(n)\;=\;9\,a(n-1) + 19\,a(n-2) - 374\,a(n-3) + 1554\,a(n-4) - 3313\,a(n-5) + 2037\,a(n-6) + 13607\,a(n-7) - 59774\,a(n-8) + 133830\,a(n-9) - 181169\,a(n-10) + 85068\,a(n-11) + 288109\,a(n-12) - 978591\,a(n-13) + 1883539\,a(n-14) - 2936585\,a(n-15) + 4267787\,a(n-16) - 5889392\,a(n-17) + 7243591\,a(n-18) - 7562613\,a(n-19) + 7078420\,a(n-20) - 7501425\,a(n-21) + 10198666\,a(n-22) - 13740764\,a(n-23) + 14894742\,a(n-24) - 12577898\,a(n-25) + 8938306\,a(n-26) - 6164409\,a(n-27) + 4354773\,a(n-28) - 2816255\,a(n-29) + 1501042\,a(n-30) - 672694\,a(n-31) + 293114\,a(n-32) - 135385\,a(n-33) + 58189\,a(n-34) - 20496\,a(n-35) + 6012\,a(n-36) - 1564\,a(n-37) + 324\,a(n-38) - 36\,a(n-39)
\]
for every $n>43$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A205050.
