...
\title{The empirical recurrence for OEIS A203832, proved by transfer matrix}
...
\begin{abstract}
OEIS A203832 counts $(n+1)\times6$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A203832 is ``Number of (n+1)X6 0..2 arrays with every 2X2 subblock having equal diagonal elements or equal antidiagonal elements.''. It has offset $1$ and begins
\[
28125, 1330353, 66490965, 3383285769, 173185290765, 8882824128417, 455911325162757, 23404859123410809,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 10:45:30, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;77\,a(n-1) - 1444\,a(n-2) + 5860\,a(n-3) + 38744\,a(n-4) - 300016\,a(n-5) + 339296\,a(n-6) + 1286720\,a(n-7) - 2655360\,a(n-8) - 56832\,a(n-9) + 1682944\,a(n-10) - 149504\,a(n-11) - 163840\,a(n-12)
\end{equation}
for all $n>11$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A203832.
