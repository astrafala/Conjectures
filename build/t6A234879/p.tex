...
\title{The empirical recurrence for OEIS A234879, proved by transfer matrix}
...
\begin{abstract}
OEIS A234879 counts $(n+1)\times6$ arrays over $\{0,\dots,4\}$ subject to a condition imposed on
...
OEIS A234879 is ``Number of (n+1) X (5+1) 0..4 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 1, with no adjacent elements equal (constant-stress tilted 1 X 1 tilings).''. It has offset $1$ and begins
\[
512, 1188, 2096, 6364, 12208, 44348, 87312, 354132,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 20 2022 01:53:38, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 34\,a(n-2) - 34\,a(n-3) - 490\,a(n-4) + 490\,a(n-5) + 3953\,a(n-6) - 3953\,a(n-7) - 19806\,a(n-8) + 19806\,a(n-9) + 64568\,a(n-10) - 64568\,a(n-11) - 139460\,a(n-12) + 139460\,a(n-13) + 199324\,a(n-14) - 199324\,a(n-15) - 184736\,a(n-16) + 184736\,a(n-17) + 105888\,a(n-18) - 105888\,a(n-19) - 33888\,a(n-20) + 33888\,a(n-21) + 4608\,a(n-22) - 4608\,a(n-23)
\end{equation}
for all $n>23$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234879.
