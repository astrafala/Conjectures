...
\title{The empirical recurrence for OEIS A207731, proved by transfer matrix}
...
\begin{abstract}
OEIS A207731 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
...
OEIS A207731 is ``Number of 4Xn 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 1 1 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
9, 81, 189, 441, 2163, 10609, 33063,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:13:37, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 12\,a(n-3) + 98\,a(n-4) + 12\,a(n-5) + 34\,a(n-6) - 230\,a(n-7) - 1980\,a(n-8) - 508\,a(n-9) + 340\,a(n-10) + 840\,a(n-11) + 9800\,a(n-12) + 3000\,a(n-13) + 2000\,a(n-15) - 10000\,a(n-16)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207731.
