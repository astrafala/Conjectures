...
\title{The empirical column recurrences for the table OEIS A260070}
...
\begin{abstract}
OEIS A260070 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A260070 is ``T(n,k)=Number of (n+2)X(k+2) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000001 00000011 or 00000111.''. It has offset $1$, is
read by antidiagonals, and begins
\[
48, 91, 91, 256, 214, 256, 557, 594,\ \dots
\]
The entry carries the following block:
\begin{quote}\small
Empirical for column k:\\
k=1: a(n) = a(n-1) +4*a(n-3) +5*a(n-4) -5*a(n-5) -2*a(n-6)\\
k=2: [order 11]\\
k=3: [order 17] for n>21\\
k=4: [order 21] for n>25\\
k=5: [order 39] for n>43\\
k=6: [order 69] for n>75\\
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 12:00:08, revision 6) these are still
...
The sequence is ``Number of (n+2)X(3) 0..1 arrays with each 3X3 subblock having clockwise perimeter pattern 00000001 00000011 or 00000111.''. Its rows are the vertices of a digraph on
...
\[
a(n)\;=\;a(n-1) + 4\,a(n-3) + 5\,a(n-4) - 5\,a(n-5) - 2\,a(n-6)
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A260070.
