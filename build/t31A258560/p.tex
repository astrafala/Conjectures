...
\title{The empirical recurrence for OEIS A258560, proved by transfer matrix}
...
\begin{abstract}
OEIS A258560 counts the arrays over $\{0,\dots,1\}$ whose $2\times2$ subblocks carry a
...
OEIS A258560 is ``Number of (7+1) X (n+1) 0..1 arrays with every 2 X 2 subblock ne-sw antidiagonal difference nondecreasing horizontally and nw+se diagonal sum nondecreasing vertically.''. It has offset $1$ and begins
\[
2008, 4667, 6348, 9688, 12940, 16942, 21653, 26628,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) - 3*a(n-2) + a(n-3) + a(n-4) - 3*a(n-5) + 3*a(n-6) - a(n-7) for n>14.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 22 2018 11:30:26, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A258560.
