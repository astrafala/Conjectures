...
\title{The empirical recurrence for OEIS A224200, proved by transfer matrix}
...
\begin{abstract}
OEIS A224200 counts arrays over $\{0,\dots,3\}$ whose rows, columns, diagonals or
antidiagonals are required to be monotone or unimodal, and carries an empirical recurrence of
order $10$ contributed by R.~H.~Hardin. A monotone condition is local, but a unimodal one
...
is a walk count on $S=130$ vertices and the recurrence follows from a finite exact
computation.
\end{abstract}
...
OEIS A224200 is ``Number of nX4 0..3 arrays with rows unimodal and antidiagonals nondecreasing.''. It has offset $1$ and begins
\[
130, 4580, 108625, 2411246, 54177872, 1229044416, 27957232796, 636184842092,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 23:18:54, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;35\,a(n-1) - 347\,a(n-2) + 1689\,a(n-3) - 2986\,a(n-4) - 2311\,a(n-5) + 23532\,a(n-6) - 23864\,a(n-7) - 36468\,a(n-8) + 100464\,a(n-9) + 94080\,a(n-10)
\end{equation}
for all $n>12$.
...
bit vector), $|\mathcal V|=S=130$; let $(r,f)\to(s,f')$ be an edge when placing $s$ after $r$
...
$h_j=G^{j}N^{o}\mathbf{1}$, we have for $j\ge10$
\[
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A224200.
