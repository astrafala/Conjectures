...
\title{The empirical recurrence for OEIS A232938, proved by transfer matrix}
...
\begin{abstract}
OEIS A232938 counts arrays over $\{0,\dots,2\}$ in which no two entries that are neighbours in
...
OEIS A232938 is ``Number of nX5 0..2 arrays with no element x(i,j) adjacent to value 2-x(i,j) horizontally, vertically or antidiagonally.''. It has offset $1$ and begins
\[
48, 120, 774, 4458, 26644, 157322, 932576, 5521380,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 07:44:14, revision 6) this is still
...
and the row above and every clash inside it. There are $S=14$ reachable states.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232938.
