...
\title{The empirical recurrence for OEIS A184210, proved by transfer matrix}
...
\begin{abstract}
OEIS A184210 counts $(n+1)\times3$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A184210 is ``Number of (n+1)X3 0..3 arrays with every 2X2 subblock sum greater than 6.''. It has offset $1$ and begins
\[
1036, 30994, 808007, 22249026, 601469417, 16373312263, 444611005885, 12084357225118,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 02:24:45, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;21\,a(n-1) + 243\,a(n-2) - 1800\,a(n-3) - 8335\,a(n-4) + 43037\,a(n-5) + 82290\,a(n-6) - 395548\,a(n-7) - 259095\,a(n-8) + 1530499\,a(n-9) + 86017\,a(n-10) - 2608822\,a(n-11) + 581376\,a(n-12) + 2049624\,a(n-13) - 748352\,a(n-14) - 707040\,a(n-15) + 310464\,a(n-16) + 86400\,a(n-17) - 41472\,a(n-18)
\end{equation}
for all $n>18$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A184210.
