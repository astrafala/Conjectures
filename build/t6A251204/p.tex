...
\title{The empirical recurrence for OEIS A251204, proved by transfer matrix}
...
\begin{abstract}
OEIS A251204 counts $(n+1)\times3$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A251204 is ``Number of (n+1) X (2+1) 0..2 arrays with every 2 X 2 subblock summing to a nonzero multiple of 2.''. It has offset $1$ and begins
\[
180, 1246, 8870, 65040, 489772, 3775022, 29664576, 236740252,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 18*a(n-1) - 90*a(n-2) + 7*a(n-3) + 576*a(n-4) + 210*a(n-5) - 180*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 27 2018 09:02:01, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251204.
