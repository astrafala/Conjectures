...
\end{equation}
for all $n>6$. The entry's array has a fixed number of rows and a growing number of
...
index corresponding to $n=6+1$ onwards, and the run was continued past $S$ consecutive
