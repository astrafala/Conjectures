...
\title{The empirical recurrence for OEIS A239026, proved by transfer matrix}
...
\begin{abstract}
OEIS A239026 counts arrays over $\{0,1,2\}$ in which no entry may equal, modulo $3$, a given
constant plus the SUM of all the entries lying before it along one of several rays. The entry
carries an empirical recurrence of order $18$ contributed by R.~H.~Hardin. It is true, and
...
count is then a walk count on $S=81$ states.
\end{abstract}
...
OEIS A239026 is ``Number of nX4 0..2 arrays with no element equal to the sum of elements to its left or one plus the sum of elements above it, modulo 3.''. It has offset $1$ and begins
\[
1, 5, 11, 59, 149, 806, 2195, 11768,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 09:22:46, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;50\,a(n-2) - 1020\,a(n-4) + 11131\,a(n-6) - 71319\,a(n-8) + 275531\,a(n-10) - 629492\,a(n-12) + 789744\,a(n-14) - 456320\,a(n-16) + 76800\,a(n-18)
\]
for every $n>18$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A239026.
