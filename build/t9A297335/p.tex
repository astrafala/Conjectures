...
\title{The empirical recurrence for OEIS A297335, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297335 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A297335 is ``Number of n X 5 0..1 arrays with every 1 horizontally or antidiagonally adjacent to 0 or 2 neighboring 1s.''. It has offset $1$ and begins
\[
13, 134, 1310, 13067, 130297, 1299649, 12964224, 129324245,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 14*a(n-1) - 40*a(n-2) - 12*a(n-3) + 107*a(n-4) - 12*a(n-5) - 60*a(n-6) + 16*a(n-7) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 27 2019 11:13:47, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;14\,a(n-1) - 40\,a(n-2) - 12\,a(n-3) + 107\,a(n-4) - 12\,a(n-5) - 60\,a(n-6) + 16\,a(n-7)
\end{equation}
for all $n>8$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297335.
