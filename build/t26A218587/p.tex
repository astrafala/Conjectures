...
\title{The empirical recurrence for OEIS A218587, proved by transfer matrix}
...
\begin{abstract}
OEIS A218587 counts the distinct indicator arrays obtained from the $n\times3$ arrays over
...
indicator row by row turns it into one, on $S=37$ states, after which the conjectured
...
OEIS A218587 is ``Hilltop maps: number of n X 3 binary arrays indicating the locations of corresponding elements not exceeded by any horizontal or antidiagonal neighbor in a random 0..2 n X 3 array.''. It has offset $1$ and begins
\[
7, 57, 449, 3567, 28305, 224643, 1782855, 14149449,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 7*a(n-1) + 7*a(n-2) + 3*a(n-3) + 3*a(n-4) + 3*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 24 2018 09:40:10, revision 7) this is still
...
\]
There are $S=37$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite. Note
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A218587.
