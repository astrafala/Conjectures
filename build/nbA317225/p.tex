...
\title{The empirical recurrence for OEIS A317225, proved by transfer matrix}
...
\begin{abstract}
OEIS A317225 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A317225 is ``Number of nX3 0..1 arrays with every element unequal to 0, 1, 2, 3, 6, 7 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
4, 21, 46, 150, 488, 1468, 4626, 14720,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) +a(n-2) +7*a(n-3) -22*a(n-4) -23*a(n-5) +8*a(n-6) +29*a(n-7) +22*a(n-8) -20*a(n-9) -10*a(n-10) for n>12
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 24 2018 10:28:47, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + a(n-2) + 7\,a(n-3) - 22\,a(n-4) - 23\,a(n-5) + 8\,a(n-6) + 29\,a(n-7) + 22\,a(n-8) - 20\,a(n-9) - 10\,a(n-10)
\end{equation}
for all $n>11$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A317225.
