...
\title{The empirical recurrence for OEIS A297954, proved by transfer matrix}
...
\begin{abstract}
OEIS A297954 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A297954 is ``Number of n X 3 0..1 arrays with every element equal to 1, 2, 4 or 5 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 7, 15, 25, 47, 109, 245, 545,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) + 2*a(n-2) + a(n-3) - 8*a(n-4) - 2*a(n-5) - 2*a(n-6) + 2*a(n-7) - a(n-8) + 2*a(n-9) + 3*a(n-11) + 2*a(n-12) for n>13.
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 22 2018 12:54:38, revision
7) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 2\,a(n-2) + a(n-3) - 8\,a(n-4) - 2\,a(n-5) - 2\,a(n-6) + 2\,a(n-7) - a(n-8) + 2\,a(n-9) + 3\,a(n-11) + 2\,a(n-12)
\end{equation}
for all $n>12$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297954.
