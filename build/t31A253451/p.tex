...
\title{The empirical recurrence for OEIS A253451, proved by transfer matrix}
...
\begin{abstract}
OEIS A253451 counts the arrays over $\{0,\dots,2\}$ whose $2\times2$ subblocks carry a
...
OEIS A253451 is ``Number of (n+1) X (3+1) 0..2 arrays with every 2 X 2 subblock diagonal minus antidiagonal sum nondecreasing horizontally and vertically.''. It has offset $1$ and begins
\[
1388, 4782, 7782, 11147, 19254, 39463, 89556, 218326,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 6*a(n-1) - 11*a(n-2) + 6*a(n-3) for n>9.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 13 2018 08:08:00, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253451.
