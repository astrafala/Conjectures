...
\title{The empirical recurrence for OEIS A220559, proved by transfer matrix}
...
\begin{abstract}
OEIS A220559 counts the ways of linking the cells of a grid $5$ cells wide, each cell either to
...
OEIS A220559 is ``Number of ways to reciprocally link elements of an n X 5 array either to themselves or to exactly one horizontal or antidiagonal neighbor.''. It has offset $1$ and begins
\[
8, 149, 2604, 45966, 810778, 14298089, 252139015, 4446314533,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 21*a(n-1) - 62*a(n-2) + 47*a(n-3) - 5*a(n-4) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 31 2018 14:52:03, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;21\,a(n-1) - 62\,a(n-2) + 47\,a(n-3) - 5\,a(n-4)
\]
for every $n>5$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A220559.
