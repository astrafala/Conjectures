...
\title{The empirical recurrence for OEIS A303679, proved by transfer matrix}
...
\begin{abstract}
OEIS A303679 counts $5$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A303679 is ``Number of nX5 0..1 arrays with every element unequal to 0, 1 or 3 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
8, 31, 25, 44, 76, 110, 150, 212,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +a(n-4) +a(n-6) for n>10
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 28 2018 09:21:17, revision
...
compared against the entry's DATA at every one of the $37$ published indices; they
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A303679.
