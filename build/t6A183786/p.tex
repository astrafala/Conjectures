...
\title{The empirical recurrence for OEIS A183786, proved by transfer matrix}
...
\begin{abstract}
OEIS A183786 counts $(n+1)\times4$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A183786 is ``Half the number of (n+1)X4 0..2 arrays with no 2X2 subblock having sum 4.''. It has offset $1$ and begins
\[
1500, 57966, 2214457, 84888699, 3250564943, 124516635830, 4769141272937, 182672398106924,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 02:00:50, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;17\,a(n-1) + 889\,a(n-2) + 67\,a(n-3) - 114442\,a(n-4) + 38222\,a(n-5) + 5710965\,a(n-6) - 8373409\,a(n-7) - 114051095\,a(n-8) + 222632076\,a(n-9) + 1029783661\,a(n-10) - 1946743843\,a(n-11) - 5282620167\,a(n-12) + 7274521160\,a(n-13) + 16742640966\,a(n-14) - 10412461098\,a(n-15) - 29378741112\,a(n-16) - 1262180872\,a(n-17) + 20149053824\,a(n-18) + 9992725504\,a(n-19) + 555859968\,a(n-20) - 154140672\,a(n-21)
\end{equation}
for all $n>20$.
...
\text{not }\bigl(\alpha+\beta+\gamma+\delta=4\bigr),
\end{equation}
...
\[
a(n)-\sum_i c_i\,a(n-i)\;=\;\tfrac1{2}\mathbf{1}^{\!\top}M^{\,n+1-1-21}\,q(M)\,\mathbf{1} .
\]
...
=\tfrac1{2}\mathbf{1}^{\!\top}M^{\,m-21}\,q(M)\,\mathbf{1}
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A183786.
