...
\title{The empirical recurrence for OEIS A198713, proved by counting patterns}
...
\begin{abstract}
OEIS A198713 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A198713 is ``Number of nX6 0..3 arrays with values 0..3 introduced in row major order and no element equal to any horizontal or vertical neighbor.''. It has offset $1$ and begins
\[
41, 8404, 1749965, 364637102, 75987485516, 15835552812749, 3300094936852775, 687733321797971342,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 08:00:33, revision 9) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A198713.
