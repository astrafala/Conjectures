...
\title{The empirical recurrence for OEIS A302676, proved by transfer matrix}
...
\begin{abstract}
OEIS A302676 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A302676 is ``Number of n X 4 0..1 arrays with every element equal to 0, 1, 4 or 6 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
5, 5, 12, 20, 33, 64, 121, 231,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) + 2*a(n-2) - a(n-4) for  n > 8.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 24 2018 12:09:20, revision
31) the statement is still recorded as empirical, and nothing on the entry
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302676.
