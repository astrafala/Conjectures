...
\title{The empirical recurrence for OEIS A209851, proved by transfer matrix}
...
\begin{abstract}
OEIS A209851 counts $(n+1)\times2$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A209851 is ``1/4 the number of (n+1) X 2 0..3 arrays with every 2 X 2 subblock having one or four distinct clockwise edge differences.''. It has offset $1$ and begins
\[
25, 182, 1308, 9455, 68201, 492373, 3553425, 25648639,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 4*a(n-1) + 29*a(n-2) - 28*a(n-3) - 110*a(n-4) + 82*a(n-5) - 8*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 13 2018 08:19:53, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) + 29\,a(n-2) - 28\,a(n-3) - 110\,a(n-4) + 82\,a(n-5) - 8\,a(n-6)
\end{equation}
for all $n>5$.
...
\[
a(n)-\sum_i c_i\,a(n-i)\;=\;\tfrac1{4}\mathbf{1}^{\!\top}M^{\,n+1-1-6}\,q(M)\,\mathbf{1} .
\]
...
=\tfrac1{4}\mathbf{1}^{\!\top}M^{\,m-6}\,q(M)\,\mathbf{1}
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209851.
