...
\title{The empirical recurrence for OEIS A207765, proved by transfer matrix}
...
\begin{abstract}
OEIS A207765 counts arrays over $\{0,\dots,1\}$ of width $5$ that avoid the patterns
$(0,1,1), (1,0,1)$ along one axis and $(0,0,0), (1,0,1)$ along the other, and carries an empirical recurrence of
order $23$ contributed by R.~H.~Hardin. It is true. The patterns have length $3$, so
...
$\mathbf{1}^{\!\top}P^{\,n-2-23}q(P)\mathbf{1}$, which vanishes identically
...
OEIS A207765 is ``Number of 5Xn 0..1 arrays avoiding 0 0 0 and 1 0 1 horizontally and 0 1 1 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
14, 196, 488, 2245, 6552, 16920, 59252,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:17:22, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) - 3\,a(n-2) + 28\,a(n-3) - 56\,a(n-4) + 35\,a(n-5) - 225\,a(n-6) + 391\,a(n-7) - 137\,a(n-8) + 850\,a(n-9) - 1626\,a(n-10) + 593\,a(n-11) - 1884\,a(n-12) + 4000\,a(n-13) - 1860\,a(n-14) + 2560\,a(n-15) - 5448\,a(n-16) + 2844\,a(n-17) - 1904\,a(n-18) + 3760\,a(n-19) - 1984\,a(n-20) + 576\,a(n-21) - 1024\,a(n-22) + 512\,a(n-23)
\end{equation}
...
$(0,1,1), (1,0,1)$ as $3$ consecutive entries. There are $14$ admissible columns; that condition
...
$a(n)-\sum_i c_i a(n-i)=u_{\,n-2-23}$ whenever $n-23\ge2$. Hence
\eqref{eq:conj} holds for every $n>t$ exactly when $u_j=0$ for every
$j>t-2-23$. Moreover $(u_j)$ satisfies the monic linear recurrence whose
...
$P^{\,n-2-23}$ gives the identity. The equivalence follows by letting the exponent
...
\begin{proof}
The vector $q(P)\mathbf{1}\in\mathbb{Z}^{S}$ was formed by $23$ matrix--vector
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207765.
