...
\title{The empirical recurrence for OEIS A208080, proved by transfer matrix}
...
\begin{abstract}
OEIS A208080 counts arrays over $\{0,\dots,1\}$ of width $5$ that avoid the patterns
...
OEIS A208080 is ``Number of 5 X n 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 0 0 and 0 1 0 vertically.''. It has offset
$1$ and begins
\[
15, 225, 1785, 16065, 139605, 1228095, 10751415,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 4*a(n-1) +40*a(n-2) +24*a(n-3) -70*a(n-4) -28*a(n-5) +36*a(n-6) -a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 20 2018 12:16:51, revision
10) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) + 40\,a(n-2) + 24\,a(n-3) - 70\,a(n-4) - 28\,a(n-5) + 36\,a(n-6) - a(n-8)
\end{equation}
...
$(0,0,0), (0,1,0)$ as $3$ consecutive entries. There are $15$ admissible columns; that condition
...
columns, so $S=225$, and declare $w\to w'$ an edge when $w'$ is $w$ with its first entry
...
values agree exactly, including the initial count of $15$ admissible columns. That is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208080.
