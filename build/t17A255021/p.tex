...
\title{The empirical recurrence for OEIS A255021, proved by transfer matrix}
...
\begin{abstract}
OEIS A255021 counts $(n+2)\times4$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A255021 is ``Number of (n+2) X (2+2) 0..1 arrays with no 3 x 3 subblock diagonal sum 0 or 1 and no antidiagonal sum 0 or 1 and no row sum 0 or 1 and no column sum 0 or 1.''. It has offset $1$ and begins
\[
54, 134, 405, 1121, 3015, 8338, 23077, 63446,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + 2*a(n-2) + 6*a(n-3) + 5*a(n-4) + a(n-5) - 2*a(n-6) - 2*a(n-7) - a(n-8) for n>9.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 18 2018 09:25:57, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A255021.
