...
\title{The empirical recurrence for OEIS A300468, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A300468 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A300468 is ``Number of nX4 0..1 arrays with every element equal to 0, 1, 2 or 3 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
8, 108, 925, 8608, 80914, 759100, 7121067, 66808673,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 06 2018 11:38:10, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;9\,a(n-1) + 6\,a(n-2) - 25\,a(n-3) + 20\,a(n-4) + 29\,a(n-5) - 96\,a(n-6) - 202\,a(n-7) - 25\,a(n-8) + 97\,a(n-9) + 311\,a(n-10) + 107\,a(n-11) - 106\,a(n-12) + 1300\,a(n-13) - 663\,a(n-14) + 910\,a(n-15) - 317\,a(n-16) + 343\,a(n-17) - 96\,a(n-18) + 57\,a(n-19) - 29\,a(n-20) - 4\,a(n-22)
\end{equation}
for all $n>23$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A300468.
