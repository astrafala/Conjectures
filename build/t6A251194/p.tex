...
\title{The empirical recurrence for OEIS A251194, proved by transfer matrix}
...
\begin{abstract}
OEIS A251194 counts $(n+1)\times2$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
on $S=4$ vertices whose edges are the admissible consecutive pairs, and the count is a
...
OEIS A251194 is ``Number of (n+1) X (1+1) 0..1 arrays with no 2 X 2 subblock having the minimum of its diagonal elements less than the absolute difference of its antidiagonal elements.''. It has offset $1$ and begins
\[
10, 25, 64, 164, 421, 1081, 2776, 7129,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) + 2*a(n-2) - a(n-3) - a(n-4)
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 26 2018 16:16:20, revision 8) the statement is
...
$V=\{0,1,\dots,1\}^{2}$, so $|V|=S=4$. A $2\times2$ subblock of the array
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251194.
