...
\title{The empirical recurrence for OEIS A295525, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A295525 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A295525 is ``Number of n X 2 0..1 arrays with each 1 horizontally or vertically adjacent to 1, 2 or 4 1s.''. It has offset $1$ and begins
\[
2, 10, 29, 87, 280, 876, 2735, 8583,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) + 2*a(n-2) + 5*a(n-3) - a(n-5) - a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 21 2018 14:40:31, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 2\,a(n-2) + 5\,a(n-3) - a(n-5) - a(n-6)
\end{equation}
for all $n>7$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A295525.
