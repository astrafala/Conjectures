...
\title{The empirical recurrence for OEIS A233943, proved by transfer matrix}
...
\begin{abstract}
OEIS A233943 counts $(n+1)\times3$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A233943 is ``Number of (n+1) X (2+1) 0..2 arrays with every 2 X 2 subblock having the sum of the absolute values of the edge differences equal to 4.''. It has offset $1$ and begins
\[
226, 2108, 19484, 180972, 1679760, 15596008, 144797048, 1344358636,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 10*a(n-1) +9*a(n-2) -154*a(n-3) +24*a(n-4) +569*a(n-5) -305*a(n-6) -372*a(n-7) +163*a(n-8) +31*a(n-9) -6*a(n-10).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 12 2026 13:28:07, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;10\,a(n-1) + 9\,a(n-2) - 154\,a(n-3) + 24\,a(n-4) + 569\,a(n-5) - 305\,a(n-6) - 372\,a(n-7) + 163\,a(n-8) + 31\,a(n-9) - 6\,a(n-10)
\end{equation}
for all $n>9$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A233943.
