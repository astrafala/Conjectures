...
\title{The empirical recurrence for OEIS A230171, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A230171 counts arrays over $\{0,\dots,2\}$ in which every cell is constrained by the
...
OEIS A230171 is ``Number of n X 3 0..2 arrays x(i,j) with each element horizontally, vertically, diagonally or antidiagonally next to at least one element with value 2-x(i,j).''. It has offset $1$ and begins
\[
3, 193, 3787, 78849, 1637019, 33908253, 704822331, 14643857893,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 21 2025 17:38:00, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;14\,a(n-1) + 50\,a(n-2) + 1467\,a(n-3) + 7177\,a(n-4) + 27682\,a(n-5) + 45031\,a(n-6) + 22024\,a(n-7) - 61992\,a(n-8) - 130960\,a(n-9) - 145201\,a(n-10) - 231795\,a(n-11) - 285312\,a(n-12) - 178036\,a(n-13) + 6345\,a(n-14) - 60491\,a(n-15) - 91748\,a(n-16) - 155577\,a(n-17) + 52430\,a(n-18) + 56132\,a(n-19) - 1509\,a(n-20) - 9112\,a(n-21) + 502\,a(n-22) + 1976\,a(n-23) + 240\,a(n-24) - 96\,a(n-25) - 32\,a(n-26)
\end{equation}
for all $n>27$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A230171.
