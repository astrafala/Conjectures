...
\begin{quote}\small
\textbf{Conjecture:} (2*n+1)*(n+3)*(n+2)*a(n) - 4*(2*n\^{}2+4*n+3)*a(n-1) - 16*n*(2*n+3)*(n-1)*a(n-2) = 0. - \emph{R. J. Mathar}, Apr 02 2017
\end{quote}
...
\left(n + 2\right) \left(n + 3\right) \left(2 n + 1\right)\,a(n) -  4 \left(2 n^{2} + 4 n + 3\right)\,a(n-1) -  16 n \left(n - 1\right) \left(2 n + 3\right)\,a(n-2)
\end{equation}
...
exact integer arithmetic at every index where it applies: $26$ instances beginning at
