...
\title{The empirical recurrence for OEIS A207454, proved by transfer matrix}
...
\begin{abstract}
OEIS A207454 counts arrays over $\{0,\dots,1\}$ of width $3$ that avoid the patterns
$(0,0,1), (1,0,1)$ along one axis and $(0,0,0), (0,0,1)$ along the other, and carries an empirical recurrence of
...
OEIS A207454 is ``Number of 3 X n 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 0 1 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
6, 36, 90, 330, 1008, 3354, 10710,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) + 7*a(n-2) + 2*a(n-3) - 4*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 05 2018 05:35:55, revision
8) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 7\,a(n-2) + 2\,a(n-3) - 4\,a(n-4)
\end{equation}
...
$(0,0,1), (1,0,1)$ as $3$ consecutive entries. There are $6$ admissible columns; that condition
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207454.
