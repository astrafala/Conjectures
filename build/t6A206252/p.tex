...
\title{The empirical recurrence for OEIS A206252, proved by transfer matrix}
...
\begin{abstract}
OEIS A206252 counts $(n+1)\times6$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A206252 is ``Number of (n+1)X6 0..3 arrays with every 2X2 subblock having zero permanent.''. It has offset $1$ and begins
\[
47089, 26512201, 944701696, 226637884225, 14139111560401, 2261195747329024, 186370092021300625, 24455901146017548025,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 12:49:49, revision 9) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206252.
