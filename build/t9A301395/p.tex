...
\title{The empirical recurrence for OEIS A301395, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A301395 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A301395 is ``Number of nX3 0..1 arrays with every element equal to 2, 3, 4, 5 or 6 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
0, 2, 3, 13, 44, 156, 554, 1963,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 20 2018 10:58:56, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 2\,a(n-2) - a(n-3) + 3\,a(n-4) + 3\,a(n-5) - 8\,a(n-6) - 13\,a(n-7) - 13\,a(n-8) - 7\,a(n-9) - 8\,a(n-10) - 7\,a(n-11) - a(n-12) + a(n-13) - 2\,a(n-14) + a(n-15)
\end{equation}
for all $n>16$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A301395.
