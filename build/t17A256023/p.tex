...
\title{The empirical recurrence for OEIS A256023, proved by transfer matrix}
...
\begin{abstract}
OEIS A256023 counts $(n+2)\times4$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
no $3\times3$ subblock, and it carries an empirical recurrence of order $12$
...
OEIS A256023 is ``Number of (n+2)X(2+2) 0..1 arrays with no 3x3 subblock diagonal sum 0 or 1 and no antidiagonal sum 0 or 1 and no row sum 1 and no column sum 1.''. It has offset $1$ and begins
\[
68, 164, 484, 1302, 3500, 9820, 27424, 76068,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:43:41, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) - a(n-2) + 5\,a(n-3) - 9\,a(n-4) - 5\,a(n-5) - 3\,a(n-6) + 7\,a(n-7) + 7\,a(n-8) + 4\,a(n-9) - 3\,a(n-10) - 2\,a(n-11) - 2\,a(n-12)
\]
for every $n>12$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A256023.
