...
\title{The empirical recurrence for OEIS A301789, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A301789 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A301789 is ``Number of n X 7 0..1 arrays with every element equal to 0 or 1 horizontally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
21, 35, 59, 100, 171, 294, 508, 881,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) -a(n-4) -a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 07 2021 13:13:40, revision 6) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A301789.
