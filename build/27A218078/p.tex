...
\title{The empirical recurrence for OEIS A218078, proved by transfer matrix}
...
\begin{abstract}
OEIS A218078 counts the distinct arrays obtained by applying a fixed local operation to every cell
...
$S=8$ states, after which the conjectured recurrence is settled by a finite exact
computation.
\end{abstract}
...
OEIS A218078 is ``Number of n X 2 arrays of the minimum value of corresponding elements and their horizontal, vertical or antidiagonal neighbors in a random 0..1 n X 2 array.''. It has offset $1$ and begins
\[
2, 4, 8, 18, 38, 82, 176, 378,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + 2*a(n-2) + a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 29 2020 23:14:13, revision 10) this is still
...
\]
There are $S=8$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A218078.
