...
\title{The empirical recurrence for OEIS A301824, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A301824 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A301824 is ``Number of 3Xn 0..1 arrays with every element equal to 1 or 2 horizontally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
0, 5, 4, 25, 74, 278, 968, 3450,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 27 2018 10:14:32, revision 4) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A301824.
