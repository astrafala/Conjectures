...
\title{The empirical recurrence for OEIS A299084, proved by transfer matrix}
...
\begin{abstract}
OEIS A299084 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $equal to$ itself lying in $\{0,1,2,3,5,7\}$, and it carries an empirical
...
OEIS A299084 is ``Number of nX3 0..1 arrays with every element equal to 0, 1, 2, 3, 5 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
4, 26, 92, 354, 1387, 5470, 21484, 84425,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 02 2018 08:02:54, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) - 4\,a(n-2) - 2\,a(n-3) + 9\,a(n-4) - 23\,a(n-5) + 30\,a(n-6) - 23\,a(n-7) + 24\,a(n-8) - 64\,a(n-9) - 12\,a(n-10) + 66\,a(n-11) + 38\,a(n-12) - 37\,a(n-13) - 44\,a(n-14) + 4\,a(n-15) + 22\,a(n-16) + 8\,a(n-17)
\end{equation}
for all $n>18$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A299084.
