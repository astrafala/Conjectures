...
\title{The empirical recurrence for OEIS A221030, proved by transfer matrix}
...
\begin{abstract}
OEIS A221030 counts the distinct indicator arrays obtained from the $n\times3$ arrays over
...
indicator row by row turns it into one, on $S=22$ states, after which the conjectured
...
OEIS A221030 is ``Majority value maps: number of n X 3 binary arrays indicating the locations of corresponding elements equal to at least half of their horizontal and antidiagonal neighbors in a random 0..2 n X 3 array.''. It has offset $1$ and begins
\[
4, 33, 228, 1561, 10648, 72625, 495329, 3378333,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 8*a(n-1) - 8*a(n-2) - a(n-3) + 5*a(n-4) - 2*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 13 2018 16:39:13, revision 8) this is still
...
\]
There are $S=22$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite. Note
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-1) - 8\,a(n-2) - a(n-3) + 5\,a(n-4) - 2\,a(n-5)
\]
for every $n>5$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221030.
