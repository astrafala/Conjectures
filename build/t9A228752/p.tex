...
\title{The empirical recurrence for OEIS A228752, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A228752 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A228752 is ``Number of n X 6 binary arrays with top left element equal to 1 and no two ones adjacent horizontally or antidiagonally.''. It has offset $1$ and begins
\[
8, 119, 1712, 24246, 342207, 4823826, 67970044, 957616341,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 21*a(n-1) - 112*a(n-2) + 217*a(n-3) - 157*a(n-4) + 36*a(n-5) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 12 2018 15:08:48, revision 10) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A228752.
