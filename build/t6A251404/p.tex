...
\title{The empirical recurrence for OEIS A251404, proved by transfer matrix}
...
\begin{abstract}
OEIS A251404 counts $(n+1)\times3$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A251404 is ``Number of (n+1)X(2+1) 0..2 arrays with every 2X2 subblock summing to a prime.''. It has offset $1$ and begins
\[
238, 2164, 19654, 179400, 1634286, 14919346, 136033976, 1241601558,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:18:57, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;8\,a(n-1) + 60\,a(n-2) - 452\,a(n-3) - 649\,a(n-4) + 5937\,a(n-5) + 916\,a(n-6) - 23417\,a(n-7) + 4582\,a(n-8) + 26384\,a(n-9) - 7348\,a(n-10) - 1208\,a(n-11) + 48\,a(n-12)
\end{equation}
for all $n>11$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251404.
