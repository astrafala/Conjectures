...
\title{The empirical recurrence for OEIS A205818, proved by transfer matrix}
...
\begin{abstract}
OEIS A205818 counts arrays over $\{0,\dots,2\}$ under a condition on the number of clockwise edge increases
...
OEIS A205818 is ``Number of (n+1) X 4 0..2 arrays with the number of clockwise edge increases in every 2 X 2 subblock unequal to the number of counterclockwise edge increases.''. It has offset $1$ and begins
\[
180, 714, 2880, 12318, 53100, 230532, 1002240, 4361064,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) + 10*a(n-2) - 13*a(n-3) - 25*a(n-4) + 12*a(n-5) + 18*a(n-6) - 2*a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 12 2018 11:12:55, revision 10) this is still
...
subblocks; the entry's first term is $180$, which the model
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + 10\,a(n-2) - 13\,a(n-3) - 25\,a(n-4) + 12\,a(n-5) + 18\,a(n-6) - 2\,a(n-8)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A205818.
