...
\title{The empirical recurrence for OEIS A203652, proved by transfer matrix}
...
\begin{abstract}
OEIS A203652 counts $(n+1)\times5$ arrays over $\{0,\dots,4\}$ subject to a condition imposed on
every $2\times2$ subblock, and carries an empirical recurrence of order $7$ contributed
...
OEIS A203652 is ``1/25 the number of (n+1)X5 0..4 arrays with every 2X2 subblock having equal diagonal elements or equal antidiagonal elements.''. It has offset $1$ and begins
\[
6561, 519445, 44577561, 3906948333, 343812029649, 30292030417413, 2669260624372937, 235230466316286557,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 69*a(n-1) +2528*a(n-2) -75120*a(n-3) +59456*a(n-4) +1531904*a(n-5) -345088*a(n-6) -1646592*a(n-7)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 10:37:28, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;69\,a(n-1) + 2528\,a(n-2) - 75120\,a(n-3) + 59456\,a(n-4) + 1531904\,a(n-5) - 345088\,a(n-6) - 1646592\,a(n-7)
\end{equation}
for all $n>6$.
...
For every $n$ with $n+1-1\ge7$,
\[
a(n)-\sum_i c_i\,a(n-i)\;=\;\tfrac1{25}\mathbf{1}^{\!\top}M^{\,n+1-1-7}\,q(M)\,\mathbf{1} .
\]
...
=\tfrac1{25}\mathbf{1}^{\!\top}M^{\,m-7}\,q(M)\,\mathbf{1}
\]
...
$m-7=j$ run over $\ge0$. For the last clause put $w=q(M)\mathbf{1}$. By the
...
$S^2$ pairs. The vector $w=q(M)\mathbf{1}\in\mathbb{Z}^{S}$ was then formed by $7$
...
index corresponding to $n=6+1$ onwards, and the run continued until $w$ itself was the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A203652.
