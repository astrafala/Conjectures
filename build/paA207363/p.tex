...
\title{The empirical recurrence for OEIS A207363, proved by transfer matrix}
...
\begin{abstract}
OEIS A207363 counts arrays over $\{0,\dots,1\}$ of width $3$ that avoid the patterns
...
OEIS A207363 is ``Number of n X 3 0..1 arrays avoiding 0 0 0 and 0 1 1 horizontally and 0 0 1 and 0 1 1 vertically.''. It has offset
$1$ and begins
\[
6, 36, 90, 225, 420, 784, 1260,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) + 2*a(n-2) - 6*a(n-3) + 6*a(n-5) - 2*a(n-6) - 2*a(n-7) + a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 21 2018 07:04:25, revision
...
compared against the entry's DATA at every one of the $36$ published indices; the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207363.
