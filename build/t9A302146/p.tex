...
\title{The empirical recurrence for OEIS A302146, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A302146 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A302146 is ``Number of nX3 0..1 arrays with every element equal to 0, 2, 3 or 4 horizontally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
1, 2, 4, 10, 28, 84, 260, 816,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 4*a(n-1) -2*a(n-2) -2*a(n-3)
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 02 2018 14:24:48, revision 4) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302146.
