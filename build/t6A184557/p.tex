...
\title{The empirical recurrence for OEIS A184557, proved by transfer matrix}
...
\begin{abstract}
OEIS A184557 counts $(n+1)\times3$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A184557 is ``Number of (n+1)X3 0..2 arrays with no 2X2 subblock summing to less than 4.''. It has offset $1$ and begins
\[
336, 5736, 91157, 1486258, 24057629, 390354307, 6329171799, 102644935902,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 02:44:23, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;15\,a(n-1) + 43\,a(n-2) - 381\,a(n-3) - 42\,a(n-4) + 1696\,a(n-5) - 590\,a(n-6) - 2216\,a(n-7) + 1085\,a(n-8) + 858\,a(n-9) - 456\,a(n-10) - 88\,a(n-11) + 48\,a(n-12)
\end{equation}
for all $n>11$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A184557.
