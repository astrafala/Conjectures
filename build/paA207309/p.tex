...
\title{The empirical recurrence for OEIS A207309, proved by transfer matrix}
...
\begin{abstract}
OEIS A207309 counts arrays over $\{0,\dots,1\}$ of width $6$ that avoid the patterns
...
OEIS A207309 is ``Number of 6Xn 0..1 arrays avoiding 0 0 0 and 1 0 1 horizontally and 0 0 1 and 1 1 0 vertically.''. It has offset
$1$ and begins
\[
12, 144, 556, 2239, 7093, 23091, 79802,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 13:45:58, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 3\,a(n-2) + 13\,a(n-3) + 18\,a(n-4) - 2\,a(n-5) - 30\,a(n-6) - 59\,a(n-7) - 25\,a(n-8) + 16\,a(n-9) + 68\,a(n-10) + 44\,a(n-11) + 3\,a(n-12) - 42\,a(n-13) - 23\,a(n-14) - 3\,a(n-15) + 17\,a(n-16) + a(n-17) - 2\,a(n-18) - 2\,a(n-19) + 3\,a(n-20) - a(n-21)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207309.
