...
\title{The empirical recurrence for OEIS A298542, proved by transfer matrix}
...
\begin{abstract}
OEIS A298542 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A298542 is ``Number of nX3 0..1 arrays with every element equal to 1, 2, 3, 4 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 17, 109, 588, 3276, 18500, 104034, 585134,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 21 2018 06:08:42, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) + 3\,a(n-2) + 6\,a(n-3) - 15\,a(n-4) - 11\,a(n-5) - 5\,a(n-6) - 46\,a(n-7) - 2\,a(n-8) - 38\,a(n-9) - 16\,a(n-10) - 8\,a(n-11) - 8\,a(n-12)
\end{equation}
for all $n>12$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A298542.
