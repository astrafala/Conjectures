...
\title{The empirical recurrence for OEIS A264091, proved by transfer matrix}
...
\begin{abstract}
OEIS A264091 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=3$ columns in which
...
OEIS A264091 is ``Number of (2+1) X (n+1) arrays of permutations of 0..n*3+2 with each element having index change +-(.,.) 0,0 0,1 or 2,-2.''. It has offset $1$ and begins
\[
8, 39, 245, 1448, 8788, 52941, 319906, 1931215,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) + 16*a(n-2) - 16*a(n-3) - 41*a(n-4) + 16*a(n-5) + 16*a(n-6) - 4*a(n-7) - a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 04 2019 12:16:52, revision 12) this is still
...
\[
(i-h_i,\,j-h_j)\;\in\;\{(-2,2),\ (-1,0),\ (0,0),\ (1,0),\ (2,-2)\},
\]
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + 16\,a(n-2) - 16\,a(n-3) - 41\,a(n-4) + 16\,a(n-5) + 16\,a(n-6) - 4\,a(n-7) - a(n-8)
\]
for every $n>6$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264091.
