...
\title{The empirical recurrence for OEIS A305447, proved by transfer matrix}
...
\begin{abstract}
OEIS A305447 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A305447 is ``Number of nX3 0..1 arrays with every element unequal to 1, 2, 4, 5 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 11, 7, 20, 44, 77, 181, 379,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 01 2018 11:01:25, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 3\,a(n-2) + 7\,a(n-3) - 6\,a(n-4) - 18\,a(n-5) - 26\,a(n-6) + 8\,a(n-7) + 27\,a(n-8) + 47\,a(n-9) + 16\,a(n-10) - 5\,a(n-11) - 3\,a(n-12) - 7\,a(n-13) - 20\,a(n-14) - 24\,a(n-15) - 5\,a(n-16) - 6\,a(n-17)
\end{equation}
for all $n>17$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A305447.
