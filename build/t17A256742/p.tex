...
\title{The empirical recurrence for OEIS A256742, proved by transfer matrix}
...
\begin{abstract}
OEIS A256742 counts $(n+2)\times4$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
no $3\times3$ subblock, and it carries an empirical recurrence of order $8$
...
OEIS A256742 is ``Number of (n+2)X(2+2) 0..1 arrays with no 3x3 subblock diagonal sum 3 and no antidiagonal sum 3 and no row sum 0 and no column sum 0.''. It has offset $1$ and begins
\[
393, 570, 1564, 2512, 6352, 12280, 28816, 60728,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) +6*a(n-2) +5*a(n-3) -19*a(n-4) -34*a(n-5) +8*a(n-6) +52*a(n-7) +24*a(n-8) for n>13
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:44:36, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 6\,a(n-2) + 5\,a(n-3) - 19\,a(n-4) - 34\,a(n-5) + 8\,a(n-6) + 52\,a(n-7) + 24\,a(n-8)
\]
for every $n>13$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A256742.
