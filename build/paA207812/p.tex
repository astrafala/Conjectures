...
\title{The empirical recurrence for OEIS A207812, proved by transfer matrix}
...
\begin{abstract}
OEIS A207812 counts arrays over $\{0,\dots,1\}$ of width $7$ that avoid the patterns
$(0,1,0), (1,0,1)$ along one axis and $(0,0,0), (0,0,1)$ along the other, and carries an empirical recurrence of
...
OEIS A207812 is ``Number of 7Xn 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 1 0 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
42, 1764, 14406, 212814, 2472540, 31569510, 388134978,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:20:36, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) + 111\,a(n-2) - 215\,a(n-3) - 2612\,a(n-4) + 4413\,a(n-5) + 22651\,a(n-6) - 38339\,a(n-7) - 87492\,a(n-8) + 141631\,a(n-9) + 180683\,a(n-10) - 251999\,a(n-11) - 220845\,a(n-12) + 230015\,a(n-13) + 159866\,a(n-14) - 110128\,a(n-15) - 65501\,a(n-16) + 27211\,a(n-17) + 14223\,a(n-18) - 3284\,a(n-19) - 1500\,a(n-20) + 176\,a(n-21) + 69\,a(n-22) - 3\,a(n-23) - a(n-24)
\end{equation}
...
$(0,1,0), (1,0,1)$ as $3$ consecutive entries. There are $42$ admissible columns; that condition
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207812.
