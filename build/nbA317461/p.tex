...
\title{The empirical recurrence for OEIS A317461, proved by transfer matrix}
...
\begin{abstract}
OEIS A317461 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $different from$ itself lying in $\{2,3,4,5,6,7,8\}$, and it carries an empirical
...
OEIS A317461 is ``Number of nX4 0..1 arrays with every element unequal to 2, 3, 4, 5, 6, 7 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
0, 18, 107, 1429, 16809, 203786, 2461839, 29797355,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 28 2018 20:59:17, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;9\,a(n-1) + 38\,a(n-2) + 50\,a(n-3) - 488\,a(n-4) - 2049\,a(n-5) - 2146\,a(n-6) + 3438\,a(n-7) + 15496\,a(n-8) + 15335\,a(n-9) - 3611\,a(n-10) - 24529\,a(n-11) - 21899\,a(n-12) + 3894\,a(n-13) + 16022\,a(n-14) - 45\,a(n-15) - 19486\,a(n-16) - 16352\,a(n-17) + 4936\,a(n-18) + 14225\,a(n-19) + 7338\,a(n-20) + 486\,a(n-21) + 107\,a(n-22) + 1478\,a(n-23) + 54\,a(n-24) - 1044\,a(n-25) - 384\,a(n-26) + 112\,a(n-27) + 64\,a(n-28)
\end{equation}
for all $n>28$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A317461.
