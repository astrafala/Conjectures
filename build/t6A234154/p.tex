...
\title{The empirical recurrence for OEIS A234154, proved by transfer matrix}
...
\begin{abstract}
OEIS A234154 counts $(n+1)\times2$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A234154 is ``Number of (n+1) X (1+1) 0..3 arrays with every 2 X 2 subblock having the absolute values of all six edge and diagonal differences no larger than 1.''. It has offset $1$ and begins
\[
46, 226, 1108, 5446, 26794, 131896, 649450, 3198322,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 7*a(n-1) - 9*a(n-2) - 6*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 13 2018 09:23:07, revision 11) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234154.
