...
\title{The empirical recurrence for OEIS A183445, proved by transfer matrix}
...
\begin{abstract}
OEIS A183445 counts $n\times4$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A183445 is ``Number of n X 4 binary arrays with every 1 having exactly two king-move neighbors equal to 1.''. It has offset $1$ and begins
\[
1, 13, 30, 72, 283, 831, 2399, 7761,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) + a(n-2) + 5*a(n-3) - 18*a(n-4) - 16*a(n-5) + 7*a(n-6) + 3*a(n-7) + a(n-8) - a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 29 2018 06:28:59, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + a(n-2) + 5\,a(n-3) - 18\,a(n-4) - 16\,a(n-5) + 7\,a(n-6) + 3\,a(n-7) + a(n-8) - a(n-9)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A183445.
