...
\title{The empirical recurrence for OEIS A185479, proved by transfer matrix}
...
\begin{abstract}
OEIS A185479 counts arrays over $\{0,\dots,1\}$ under a condition comparing a statistic of
...
empirical. The count is a walk count on $S=28$ states and is $C$-finite; whether the
...
OEIS A185479 is ``Number of (n+1) X 2 binary arrays with every 2 X 2 subblock determinant equal to some horizontal or vertical neighbor 2 X 2 subblock determinant.''. It has offset $1$ and begins
\[
0, 30, 76, 234, 632, 1832, 5182, 14860,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) + a(n-2) - 5*a(n-3) + 3*a(n-4) - 2*a(n-6) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 27 2018 11:59:18, revision 9) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

Write $\sigma$ for its determinant, taken on a $2\times2$ subblock. The contiguous $2\times2$
subblocks of an $(n+1)\times2$ array over $\{0,\dots,1\}$ form a grid of $n$ rows
...
$S=28$ states in all. Getting the two vectors right is the whole of the argument: with
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + a(n-2) - 5\,a(n-3) + 3\,a(n-4) - 2\,a(n-6)
\]
for every $n>7$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A185479.
