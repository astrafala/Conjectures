...
\title{The empirical recurrence for OEIS A299724, proved by transfer matrix}
...
\begin{abstract}
OEIS A299724 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A299724 is ``Number of nX4 0..1 arrays with every element equal to 1, 2, 3, 4, 5, 6 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
2, 64, 1027, 14701, 217069, 3224826, 47845523, 709688988,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 17 2018 10:53:09, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;12\,a(n-1) + 31\,a(n-2) + 137\,a(n-3) + 377\,a(n-4) + 288\,a(n-5) - 24\,a(n-6) - 577\,a(n-7) - 1562\,a(n-8) - 984\,a(n-9) + 390\,a(n-10) + 450\,a(n-11) + 222\,a(n-12) - 4\,a(n-13) - 131\,a(n-14) - 10\,a(n-15) + 24\,a(n-16)
\end{equation}
for all $n>16$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A299724.
