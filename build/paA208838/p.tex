...
\title{The empirical recurrence for OEIS A208838, proved by transfer matrix}
...
\begin{abstract}
OEIS A208838 counts arrays over $\{0,\dots,1\}$ of width $6$ that avoid the patterns
...
OEIS A208838 is ``Number of n X 6 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 1 1 and 1 1 0 vertically.''. It has offset
$1$ and begins
\[
26, 676, 2430, 9801, 49126, 272206, 1644265,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 13 2026 15:28:28, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208838.
