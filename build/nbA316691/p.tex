...
\title{The empirical recurrence for OEIS A316691, proved by transfer matrix}
...
\begin{abstract}
OEIS A316691 counts $6$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A316691 is ``Number of nX6 0..1 arrays with every element unequal to 0, 1, 2, 6, 7 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
32, 13, 42, 125, 359, 2081, 9442, 38020,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 10 2018 15:05:12, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 5\,a(n-2) + 33\,a(n-3) - 9\,a(n-4) - 53\,a(n-5) - 229\,a(n-6) + 42\,a(n-7) + 42\,a(n-8) + 386\,a(n-9) - 47\,a(n-10) - 52\,a(n-11) - 288\,a(n-12) + 62\,a(n-13) + 216\,a(n-15) + 84\,a(n-16)
\end{equation}
for all $n>20$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A316691.
