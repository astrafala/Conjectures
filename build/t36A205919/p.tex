...
\title{The empirical recurrence for OEIS A205919, proved by transfer matrix}
...
\begin{abstract}
OEIS A205919 counts arrays over $\{0,\dots,3\}$ under a condition on the number of clockwise edge increases
...
OEIS A205919 is ``Number of (n+1) X 2 0..3 arrays with the number of clockwise edge increases in every 2 X 2 subblock equal to one, and every 2 X 2 determinant nonzero.''. It has offset $1$ and begins
\[
76, 389, 1828, 9144, 43572, 215294, 1035724, 5082472,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + 18*a(n-2) + 3*a(n-3) - 2*a(n-4) + 26*a(n-5) + 28*a(n-6) + 8*a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 13 2018 05:43:09, revision 9) this is still
...
subblock; the entry's first term is $76$, which the model
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 18\,a(n-2) + 3\,a(n-3) - 2\,a(n-4) + 26\,a(n-5) + 28\,a(n-6) + 8\,a(n-7)
\]
for every $n>7$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A205919.
