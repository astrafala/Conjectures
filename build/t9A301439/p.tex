...
\title{The empirical recurrence for OEIS A301439, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A301439 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A301439 is ``Number of nX4 0..1 arrays with every element equal to 0, 1, 2, 3, 4 or 6 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
8, 128, 1708, 23672, 327848, 4543028, 62956480, 872451104,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 16*a(n-1) -28*a(n-2) -26*a(n-3) +40*a(n-4) -37*a(n-5) -61*a(n-6) +30*a(n-7) +36*a(n-8) +25*a(n-9) +5*a(n-10) +a(n-11)
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 21 2018 11:44:49, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;16\,a(n-1) - 28\,a(n-2) - 26\,a(n-3) + 40\,a(n-4) - 37\,a(n-5) - 61\,a(n-6) + 30\,a(n-7) + 36\,a(n-8) + 25\,a(n-9) + 5\,a(n-10) + a(n-11)
\end{equation}
for all $n>12$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A301439.
