...
\title{The empirical recurrence for OEIS A207177, proved by transfer matrix}
...
\begin{abstract}
OEIS A207177 counts arrays over $\{0,\dots,1\}$ of width $3$ that avoid the patterns
...
OEIS A207177 is ``Number of n X 3 0..1 arrays avoiding 0 0 0 horizontally and 0 1 0 vertically.''. It has offset
$1$ and begins
\[
7, 49, 241, 1171, 5917, 30067, 151981,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 4*a(n-1) + 2*a(n-2) + 12*a(n-3) + 23*a(n-4) + 6*a(n-5) - a(n-6) - 2*a(n-7) - a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 21 2018 05:49:36, revision
8) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) + 2\,a(n-2) + 12\,a(n-3) + 23\,a(n-4) + 6\,a(n-5) - a(n-6) - 2\,a(n-7) - a(n-8)
\end{equation}
for all $n>7$. 
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207177.
