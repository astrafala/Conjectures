...
\title{The empirical recurrence for OEIS A207307, proved by transfer matrix}
...
\begin{abstract}
OEIS A207307 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
...
OEIS A207307 is ``Number of 4Xn 0..1 arrays avoiding 0 0 0 and 1 0 1 horizontally and 0 0 1 and 1 1 0 vertically.''. It has offset
$1$ and begins
\[
8, 64, 200, 643, 1759, 4939, 14446,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 13:45:43, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 2\,a(n-2) + 8\,a(n-3) + 7\,a(n-4) - 2\,a(n-5) - 10\,a(n-6) - 10\,a(n-7) - a(n-8) + 3\,a(n-9) + 4\,a(n-10) + a(n-11) - a(n-13)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207307.
