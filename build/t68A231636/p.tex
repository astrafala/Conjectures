...
\title{The empirical recurrence for OEIS A231636, proved by transfer matrix}
...
\begin{abstract}
OEIS A231636 counts arrays of width $2$ over $\{0,1,2\}$ in which no cell is beaten by a strict majority of its neighbours. The entry carries an
...
$3$ consecutive rows and the count is a walk count on $S=79$ states.
\end{abstract}
...
OEIS A231636 is ``Number of n X 2 0..2 arrays with no element having a strict majority of its horizontal, vertical, diagonal and antidiagonal neighbors equal to itself plus one mod 3, with upper left element zero (rock paper and scissors drawn positions).''. It has offset $1$ and begins
\[
1, 5, 25, 124, 599, 2907, 14098, 68345,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 7*a(n-1) - 11*a(n-2) + 4*a(n-3) - 14*a(n-4) + 48*a(n-5) - 48*a(n-6) + 16*a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 30 2018 02:44:41, revision 11) this is still
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-1) - 11\,a(n-2) + 4\,a(n-3) - 14\,a(n-4) + 48\,a(n-5) - 48\,a(n-6) + 16\,a(n-7)
\]
for every $n>7$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231636.
