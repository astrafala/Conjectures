...
\title{The empirical recurrence for OEIS A219412, proved by transfer matrix}
...
\begin{abstract}
OEIS A219412 counts the distinct indicator arrays obtained from the $n\times3$ arrays over
...
indicator row by row turns it into one, on $S=83$ states, after which the conjectured
...
OEIS A219412 is ``Unmatched value maps: number of 3 X n binary arrays indicating the locations of corresponding elements not equal to any horizontal or antidiagonal neighbor in a random 0..2 3 X n array.''. It has offset $1$ and begins
\[
1, 21, 181, 1199, 8173, 57097, 398375, 2773933,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 20 2022 23:20:46, revision 6) this is still
...
\]
There are $S=83$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite. Note
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-1) - 14\,a(n-2) + 52\,a(n-3) - 48\,a(n-4) + 110\,a(n-5) - 51\,a(n-6) + 60\,a(n-7) + 52\,a(n-8) - 120\,a(n-9) - 20\,a(n-10) + 32\,a(n-11)
\]
for every $n>11$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A219412.
