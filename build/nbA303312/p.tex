...
\title{The empirical recurrence for OEIS A303312, proved by transfer matrix}
...
\begin{abstract}
OEIS A303312 counts $6$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A303312 is ``Number of nX6 0..1 arrays with every element equal to 0, 1, 4, 5 or 6 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
13, 13, 67, 128, 410, 1221, 3453, 10223,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +2*a(n-2) +10*a(n-3) +6*a(n-4) -5*a(n-5) -15*a(n-6) -8*a(n-7) -4*a(n-8) for n>11
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 21 2018 12:46:58, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 2\,a(n-2) + 10\,a(n-3) + 6\,a(n-4) - 5\,a(n-5) - 15\,a(n-6) - 8\,a(n-7) - 4\,a(n-8)
\end{equation}
for all $n>10$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A303312.
