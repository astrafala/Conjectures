...
\title{The empirical recurrence for OEIS A251215, proved by transfer matrix}
...
\begin{abstract}
OEIS A251215 counts $(n+1)\times5$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A251215 is ``Number of (n+1)X(4+1) 0..1 arrays with no 2X2 subblock having zero or two 1s.''. It has offset $1$ and begins
\[
115, 589, 3089, 16911, 91777, 502971, 2746607, 15040763,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:10:52, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) + 22\,a(n-2) - 157\,a(n-3) - 115\,a(n-4) + 1491\,a(n-5) - 328\,a(n-6) - 6480\,a(n-7) + 4148\,a(n-8) + 13794\,a(n-9) - 11784\,a(n-10) - 13976\,a(n-11) + 13612\,a(n-12) + 6008\,a(n-13) - 6440\,a(n-14) - 768\,a(n-15) + 960\,a(n-16)
\end{equation}
for all $n>16$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251215.
