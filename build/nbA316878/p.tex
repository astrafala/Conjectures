...
\title{The empirical recurrence for OEIS A316878, proved by transfer matrix}
...
\begin{abstract}
OEIS A316878 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A316878 is ``Number of nX3 0..1 arrays with every element unequal to 0, 1, 2, 4, 5, 6 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
4, 14, 37, 105, 388, 1280, 4121, 13933,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 15 2018 14:10:17, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 4\,a(n-2) + 14\,a(n-3) - 19\,a(n-4) - 63\,a(n-5) - 93\,a(n-6) + 71\,a(n-7) + 279\,a(n-8) + 285\,a(n-9) - 86\,a(n-10) - 418\,a(n-11) - 276\,a(n-12) + 28\,a(n-13) + 90\,a(n-14) - 9\,a(n-15)
\end{equation}
for all $n>16$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A316878.
