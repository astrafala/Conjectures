...
\title{The empirical recurrence for OEIS A235241, proved by transfer matrix}
...
\begin{abstract}
OEIS A235241 counts $2$-column arrays over $\{0,\dots,7\}$ in which every
...
OEIS A235241 is ``Number of (n+1) X (1+1) 0..7 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 6, with no adjacent elements equal (constant-stress tilted 1 X 1 tilings).''. It has offset
$1$ and begins
\[
210, 906, 3746, 16150, 66874, 288510, 1195458,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 4*a(n-1) + 39*a(n-2) - 152*a(n-3) - 441*a(n-4) + 1612*a(n-5) + 1185*a(n-6) - 3128*a(n-7) - 782*a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 19 2022 00:00:56, revision 11) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) + 39\,a(n-2) - 152\,a(n-3) - 441\,a(n-4) + 1612\,a(n-5) + 1185\,a(n-6) - 3128\,a(n-7) - 782\,a(n-8)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A235241.
