...
\title{The empirical recurrence for OEIS A251244, proved by transfer matrix}
...
\begin{abstract}
OEIS A251244 counts $(n+1)\times4$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A251244 is ``Number of (n+1)X(3+1) 0..2 arrays with no 2X2 subblock having the sum of its diagonal elements less than the minimum of its antidiagonal elements.''. It has offset $1$ and begins
\[
5139, 327753, 20904689, 1333268433, 85032883789, 5423196612609, 345878548314469, 22059307525808241,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:12:08, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;81\,a(n-1) - 1165\,a(n-2) + 4257\,a(n-3) - 544\,a(n-4) - 4428\,a(n-5) + 7512\,a(n-6) - 80352\,a(n-7) - 67376\,a(n-8) + 32256\,a(n-9) + 20160\,a(n-10)
\end{equation}
for all $n>9$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251244.
