...
\title{The empirical recurrence for OEIS A207604, proved by transfer matrix}
...
\begin{abstract}
OEIS A207604 counts arrays over $\{0,\dots,1\}$ of width $7$ that avoid the patterns
...
OEIS A207604 is ``Number of 7Xn 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 0 1 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
14, 196, 546, 1521, 10725, 75625, 292600,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:07:47, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) - 6\,a(n-2) + 31\,a(n-3) + 319\,a(n-4) + 270\,a(n-5) + 2100\,a(n-6) - 12600\,a(n-8) - 9720\,a(n-9) - 68904\,a(n-10) - 40176\,a(n-11) + 46656\,a(n-12) - 46656\,a(n-13) + 279936\,a(n-14)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207604.
