...
\title{The empirical recurrence for OEIS A207875, proved by transfer matrix}
...
\begin{abstract}
OEIS A207875 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
...
OEIS A207875 is ``Number of nX4 0..1 arrays avoiding 0 0 0 and 1 0 1 horizontally and 0 1 0 and 1 1 1 vertically.''. It has offset
$1$ and begins
\[
9, 81, 164, 400, 824, 1940, 4200,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-2) +7*a(n-3) +4*a(n-4) -3*a(n-5) -17*a(n-6) -5*a(n-7) +7*a(n-8) +2*a(n-9) -13*a(n-10) -a(n-11) -2*a(n-12) for n>14
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:22:54, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-2) + 7\,a(n-3) + 4\,a(n-4) - 3\,a(n-5) - 17\,a(n-6) - 5\,a(n-7) + 7\,a(n-8) + 2\,a(n-9) - 13\,a(n-10) - a(n-11) - 2\,a(n-12)
\end{equation}
for all $n>12$. 
...
$(0,0,0), (1,0,1)$ as $3$ consecutive entries. There are $9$ admissible rows; that condition
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207875.
