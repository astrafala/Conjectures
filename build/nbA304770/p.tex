...
\title{The empirical recurrence for OEIS A304770, proved by transfer matrix}
...
\begin{abstract}
OEIS A304770 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A304770 is ``Number of n X 3 0..1 arrays with every element unequal to 0, 1, 2, 3 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
4, 21, 27, 67, 139, 303, 685, 1511,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +a(n-2) +3*a(n-3) +2*a(n-4) -a(n-5) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 28 2023 23:21:20, revision
6) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + a(n-2) + 3\,a(n-3) + 2\,a(n-4) - a(n-5)
\end{equation}
for all $n>7$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A304770.
