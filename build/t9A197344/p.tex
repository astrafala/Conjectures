...
\title{The empirical recurrence for OEIS A197344, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A197344 counts arrays over $\{0,\dots,4\}$ in which every cell is constrained by the
...
OEIS A197344 is ``Number of n X 2 0..4 arrays with each element x equal to the number its horizontal and vertical neighbors equal to 3,3,1,1,0 for x=0,1,2,3,4.''. It has offset $1$ and begins
\[
1, 1, 9, 17, 33, 89, 249, 553,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) + a(n-2) + 4*a(n-3) + 7*a(n-4) - 4*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 22 2018 16:28:55, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A197344.
