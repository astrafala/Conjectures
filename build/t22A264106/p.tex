...
\title{The empirical recurrence for OEIS A264106, proved by transfer matrix}
...
\begin{abstract}
OEIS A264106 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=3$ rows in which
...
OEIS A264106 is ``Number of (n+1) X (2+1) arrays of permutations of 0..n*3+2 with each element having index change +-(.,.) 0,0 0,2 or 1,1.''. It has offset $1$ and begins
\[
9, 40, 169, 714, 3025, 12816, 54289, 229970,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) + 4*a(n-3) + a(n-4) for n>4.
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 28 2016 21:58:38, revision 28) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264106.
