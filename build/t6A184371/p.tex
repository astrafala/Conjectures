...
\title{The empirical recurrence for OEIS A184371, proved by transfer matrix}
...
\begin{abstract}
OEIS A184371 counts $(n+1)\times5$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A184371 is ``1/3 the number of (n+1) X 5 0..2 arrays with every 2 X 2 subblock having at least two equal elements connected horizontally or vertically.''. It has offset $1$ and begins
\[
8019, 880781, 95528423, 10378244309, 1127256514575, 122443114867993, 13299774554091575, 1444622701339019869,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 02:34:07, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;114\,a(n-1) - 197\,a(n-2) - 44924\,a(n-3) + 280944\,a(n-4) + 3429792\,a(n-5) - 38126443\,a(n-6) + 98209829\,a(n-7) + 162477726\,a(n-8) - 1059045499\,a(n-9) + 651177189\,a(n-10) + 3269771125\,a(n-11) - 4412158618\,a(n-12) - 3526224683\,a(n-13) + 7595898885\,a(n-14) + 727564626\,a(n-15) - 4875456557\,a(n-16) + 367654226\,a(n-17) + 1090025544\,a(n-18) - 17907882\,a(n-19) - 56592728\,a(n-20) + 3381324\,a(n-21) + 616392\,a(n-22) - 47520\,a(n-23)
\end{equation}
for all $n>22$.
...
\[
a(n)-\sum_i c_i\,a(n-i)\;=\;\tfrac1{3}\mathbf{1}^{\!\top}M^{\,n+1-1-23}\,q(M)\,\mathbf{1} .
\]
...
=\tfrac1{3}\mathbf{1}^{\!\top}M^{\,m-23}\,q(M)\,\mathbf{1}
\]
with $m=n+1-1$, which is the stated identity; the scalar $\tfrac1{3}$ never vanishes, so
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A184371.
