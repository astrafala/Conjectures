...
\title{The empirical recurrence for OEIS A303796, proved by transfer matrix}
...
\begin{abstract}
OEIS A303796 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A303796 is ``Number of nX4 0..1 arrays with every element unequal to 0, 1, 2 or 4 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
8, 24, 30, 90, 231, 631, 1586, 4230,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 30 2018 17:11:29, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 3\,a(n-2) + 4\,a(n-3) + 7\,a(n-4) - 12\,a(n-5) - 24\,a(n-6) - 17\,a(n-7) - 5\,a(n-8) + 11\,a(n-9) + 31\,a(n-10) + 43\,a(n-11) + 17\,a(n-12) + 12\,a(n-13) - 15\,a(n-14) - 16\,a(n-15) - 39\,a(n-16) - 24\,a(n-17) + 18\,a(n-18) + 26\,a(n-19) + 4\,a(n-20) + 7\,a(n-21) - 14\,a(n-22) - 32\,a(n-23) + 5\,a(n-24) + 7\,a(n-25) - 6\,a(n-26) + a(n-27) + 2\,a(n-28)
\end{equation}
for all $n>31$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A303796.
