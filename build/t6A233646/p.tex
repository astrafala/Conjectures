...
\title{The empirical recurrence for OEIS A233646, proved by transfer matrix}
...
\begin{abstract}
OEIS A233646 counts $(n+1)\times2$ arrays over $\{0,\dots,5\}$ subject to a condition imposed on
...
OEIS A233646 is ``Number of (n+1)X(1+1) 0..5 arrays with every 2X2 subblock having the sum of the squares of the edge differences equal to 14.''. It has offset $1$ and begins
\[
144, 772, 3984, 20936, 108864, 570208, 2971200, 15541312,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) +31*a(n-2) -36*a(n-3) -261*a(n-4) +206*a(n-5) +714*a(n-6) -356*a(n-7) -528*a(n-8) +256*a(n-9)
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 08:55:00, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 31\,a(n-2) - 36\,a(n-3) - 261\,a(n-4) + 206\,a(n-5) + 714\,a(n-6) - 356\,a(n-7) - 528\,a(n-8) + 256\,a(n-9)
\end{equation}
for all $n>9$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A233646.
