...
\title{The empirical recurrence for OEIS A210408, proved by counting patterns}
...
\begin{abstract}
OEIS A210408 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
OEIS A210408 is ``Number of (n+1)X4 0..3 arrays with every 2X2 subblock having three or four distinct values, and new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
864, 80496, 7380816, 677993552, 62266883792, 5718722907600, 525218223843536, 48237041019306960,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 15:59:05, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;81\,a(n-1) + 1151\,a(n-2) - 13041\,a(n-3) - 117154\,a(n-4) + 478740\,a(n-5) + 445664\,a(n-6) - 2873152\,a(n-7) + 2422784\,a(n-8) - 196608\,a(n-9)
\end{equation}
for all $n>9$.
...
For every $n$ with $m=n+1-1\ge9$,
\[
4!\Bigl(a(n)-\sum_i c_i\,a(n-i)\Bigr)\;=\;\mathbf{v}^{\!\top}N^{\,m-9}q(N)\mathbf{1} .
\]
...
corresponding to $n=9+1$ onwards, and the run continued until $w$ was the zero vector,
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A210408.
