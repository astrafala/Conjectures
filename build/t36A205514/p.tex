...
\title{The empirical recurrence for OEIS A205514, proved by transfer matrix}
...
\begin{abstract}
OEIS A205514 counts arrays over $\{0,\dots,2\}$ under a condition on the number of clockwise edge increases
...
OEIS A205514 is ``Number of (n+1)X3 0..2 arrays with the number of clockwise edge increases in every 2X2 subblock differing from each horizontal or vertical neighbor.''. It has offset $1$ and begins
\[
360, 2412, 17166, 122232, 864948, 6127554, 43434216, 307791390,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) +12*a(n-2) +59*a(n-3) +73*a(n-4) +36*a(n-5) -15*a(n-6) -32*a(n-7) -24*a(n-8) -8*a(n-9) +2*a(n-10)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 12:09:42, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + 12\,a(n-2) + 59\,a(n-3) + 73\,a(n-4) + 36\,a(n-5) - 15\,a(n-6) - 32\,a(n-7) - 24\,a(n-8) - 8\,a(n-9) + 2\,a(n-10)
\]
for every $n>10$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A205514.
