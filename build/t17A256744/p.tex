...
\title{The empirical recurrence for OEIS A256744, proved by transfer matrix}
...
\begin{abstract}
OEIS A256744 counts $(n+2)\times6$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A256744 is ``Number of (n+2)X(4+2) 0..1 arrays with no 3x3 subblock diagonal sum 3 and no antidiagonal sum 3 and no row sum 0 and no column sum 0.''. It has offset $1$ and begins
\[
2065, 2512, 3752, 5888, 10360, 18688, 33616, 61568,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 7*a(n-2) +8*a(n-3) -14*a(n-4) -52*a(n-5) -8*a(n-6) +88*a(n-7) +96*a(n-8) -32*a(n-9) -128*a(n-10) for n>14
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:44:49, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-2) + 8\,a(n-3) - 14\,a(n-4) - 52\,a(n-5) - 8\,a(n-6) + 88\,a(n-7) + 96\,a(n-8) - 32\,a(n-9) - 128\,a(n-10)
\]
for every $n>14$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A256744.
