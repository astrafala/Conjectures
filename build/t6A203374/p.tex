...
\title{The empirical recurrence for OEIS A203374, proved by transfer matrix}
...
\begin{abstract}
OEIS A203374 counts $(n+1)\times5$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A203374 is ``Number of (n+1) X 5 0..1 arrays with every 2 X 2 subblock having equal diagonal elements or equal antidiagonal elements.''. It has offset $1$ and begins
\[
324, 3412, 36300, 387324, 4136292, 44183028, 471988172, 5042151644,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 16*a(n-1) -65*a(n-2) +92*a(n-3) -48*a(n-4) +8*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 04 2018 09:22:35, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A203374.
