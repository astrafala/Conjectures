...
\title{The empirical recurrence for OEIS A208004, proved by transfer matrix}
...
\begin{abstract}
OEIS A208004 counts arrays over $\{0,\dots,1\}$ of width $5$ that avoid the patterns
...
OEIS A208004 is ``Number of nX5 0..1 arrays avoiding 0 0 1 and 1 0 0 horizontally and 0 1 1 and 1 1 0 vertically.''. It has offset
$1$ and begins
\[
14, 196, 618, 1711, 7016, 24512, 106503,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:33:24, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;9\,a(n-1) - 10\,a(n-2) - 106\,a(n-3) + 272\,a(n-4) + 170\,a(n-5) - 936\,a(n-6) + 306\,a(n-7) + 898\,a(n-8) - 558\,a(n-9) - 224\,a(n-10) + 190\,a(n-11) + a(n-12) - 11\,a(n-13)
\end{equation}
for all $n>12$. 
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208004.
