...
\title{The empirical recurrence for OEIS A257441, proved by transfer matrix}
...
\begin{abstract}
OEIS A257441 counts $(n+2)\times4$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A257441 is ``Number of (n+2) X (2+2) 0..1 arrays with no 3 X 3 subblock diagonal sum 0 and no antidiagonal sum 3 and no row sum 1 and no column sum 1.''. It has offset $1$ and begins
\[
36, 38, 41, 51, 68, 95, 134, 191,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) - a(n-2) + a(n-3) - a(n-4) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 04 2022 08:23:29, revision 10) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A257441.
