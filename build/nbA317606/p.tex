...
\title{The empirical recurrence for OEIS A317606, proved by transfer matrix}
...
\begin{abstract}
OEIS A317606 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A317606 is ``Number of n X 3 0..1 arrays with every element unequal to 0, 1, 2, 4, 5, 6, 7 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
4, 14, 38, 109, 419, 1413, 4708, 16406,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 26 2022 05:16:57, revision
6) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 5\,a(n-2) + 13\,a(n-3) - 22\,a(n-4) - 72\,a(n-5) - 88\,a(n-6) + 97\,a(n-7) + 314\,a(n-8) + 287\,a(n-9) - 138\,a(n-10) - 472\,a(n-11) - 290\,a(n-12) + 41\,a(n-13) + 93\,a(n-14) - 9\,a(n-15)
\end{equation}
for all $n>16$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A317606.
