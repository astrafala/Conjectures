...
\title{The empirical recurrence for OEIS A283722, proved by transfer matrix}
...
\begin{abstract}
OEIS A283722 counts $n\times4$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
walk, and $a(n)$ is a walk count on $S=398$ vertices, which is $C$-finite. Whether the
...
OEIS A283722 is ``Number of nX4 0..1 arrays with no 1 equal to more than two of its horizontal, diagonal and antidiagonal neighbors, with the exception of exactly one element.''. It has offset $1$ and begins
\[
0, 60, 1088, 15228, 196548, 2391696, 28103560, 322050940,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 15 2017 07:59:04, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;14\,a(n-1) - a(n-2) - 226\,a(n-3) - 1460\,a(n-4) - 2232\,a(n-5) + 1525\,a(n-6) + 22350\,a(n-7) + 39289\,a(n-8) + 13206\,a(n-9) - 146613\,a(n-10) - 259034\,a(n-11) - 136682\,a(n-12) + 488660\,a(n-13) + 810954\,a(n-14) + 302750\,a(n-15) - 834146\,a(n-16) - 986264\,a(n-17) - 173928\,a(n-18) + 495516\,a(n-19) + 329204\,a(n-20) + 4440\,a(n-21) - 35121\,a(n-22) - 16332\,a(n-23) - 13884\,a(n-24) - 5504\,a(n-25) - 1072\,a(n-26) - 320\,a(n-27) - 64\,a(n-28)
\]
for every $n>28$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A283722.
