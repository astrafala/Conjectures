...
\title{The empirical recurrence for OEIS A282393, proved by transfer matrix}
...
\begin{abstract}
OEIS A282393 counts $n\times2$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A282393 is ``Number of nX2 0..1 arrays with no 1 equal to more than three of its king-move neighbors.''. It has offset $1$ and begins
\[
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 28 2017 04:01:38, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + a(n-2) + 7\,a(n-3) - 2\,a(n-4) - 4\,a(n-6)
\]
for every $n>6$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A282393.
