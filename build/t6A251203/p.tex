...
\title{The empirical recurrence for OEIS A251203, proved by transfer matrix}
...
\begin{abstract}
OEIS A251203 counts $(n+1)\times2$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A251203 is ``Number of (n+1) X (1+1) 0..2 arrays with every 2 X 2 subblock summing to a nonzero multiple of 2.''. It has offset $1$ and begins
\[
40, 180, 816, 3728, 17152, 79424, 369920, 1731840,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 8*a(n-1) - 12*a(n-2) - 16*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 26 2018 16:16:05, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251203.
