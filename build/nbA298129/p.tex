...
\title{The empirical recurrence for OEIS A298129, proved by transfer matrix}
...
\begin{abstract}
OEIS A298129 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $equal to$ itself lying in $\{2,3,4,7\}$, and it carries an empirical
recurrence of order $53$ contributed by R.~H.~Hardin. It is true. The neighbourhood
...
OEIS A298129 is ``Number of n X 4 0..1 arrays with every element equal to 2, 3, 4 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
0, 5, 13, 15, 233, 1055, 5782, 36225,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 26 2025 15:27:27, revision
6) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 18\,a(n-2) + 25\,a(n-3) - 115\,a(n-4) - 418\,a(n-5) - 362\,a(n-6) + 1223\,a(n-7) + 4240\,a(n-8) + 2290\,a(n-9) - 9359\,a(n-10) - 16112\,a(n-11) + 3825\,a(n-12) + 30881\,a(n-13) + 10497\,a(n-14) - 37030\,a(n-15) - 21624\,a(n-16) + 40949\,a(n-17) + 30128\,a(n-18) - 52580\,a(n-19) - 29839\,a(n-20) + 16613\,a(n-21) - 97187\,a(n-22) - 8185\,a(n-23) + 199948\,a(n-24) + 235970\,a(n-25) + 21467\,a(n-26) - 396028\,a(n-27) - 168777\,a(n-28) + 347284\,a(n-29) + 546093\,a(n-30) - 20595\,a(n-31) - 733067\,a(n-32) - 497232\,a(n-33) + 64780\,a(n-34) + 471056\,a(n-35) + 244089\,a(n-36) - 113651\,a(n-37) - 210162\,a(n-38) - 106774\,a(n-39) + 42085\,a(n-40) - 11265\,a(n-41) - 9272\,a(n-42) + 5459\,a(n-43) + 12341\,a(n-44) + 24615\,a(n-45) + 7030\,a(n-46) - 4538\,a(n-47) - 4658\,a(n-48) - 2118\,a(n-49) + 128\,a(n-50) + 580\,a(n-51) - 4\,a(n-52) - 40\,a(n-53)
\end{equation}
for all $n>56$.
...
has score in $\{2,3,4,7\}$. The entry also fixes the top-left entry to be $0$; that is a condition on the first row alone, so it restricts the start vector and nothing else.
...
\begin{itemize}
\item $\mathbf{s}(r,s)=1$ when every cell of $r$ has score in $\{2,3,4,7\}$ \emph{with no row
above $r$} and $r_1=0$, and $0$ otherwise;
\item an edge $(r,s)\to(s,t)$ when every cell of $s$ has score in $\{2,3,4,7\}$ computed from
$r$, $s$ and $t$;
\item $\mathbf{e}(r,s)=1$ when every cell of $s$ has score in $\{2,3,4,7\}$ \emph{with no row
...
exactly when every one of its $n$ rows has all scores in $\{2,3,4,7\}$. Read the sequence as the
...
$a(n)-\sum_i c_i a(n-i)=u_{\,n-2-53}$ whenever $n-53\ge2$. So \eqref{eq:conj}
holds for every $n>t$ exactly when $u_j=0$ for all $j>t-2-53$. Moreover $(u_j)$
...
\begin{proof}
Substituting Lemma~\ref{lem:walk} and factoring $P^{\,n-2-53}$ out of
...
\begin{proof}
The vector $q(P)\mathbf{e}\in\mathbb{Z}^{S}$ was formed by $53$ matrix--vector
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A298129.
