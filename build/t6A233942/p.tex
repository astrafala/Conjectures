...
\title{The empirical recurrence for OEIS A233942, proved by transfer matrix}
...
\begin{abstract}
OEIS A233942 counts $(n+1)\times2$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A233942 is ``Number of (n+1) X (1+1) 0..2 arrays with every 2 X 2 subblock having the sum of the absolute values of the edge differences equal to 4.''. It has offset $1$ and begins
\[
44, 226, 1150, 5874, 29970, 152974, 780718, 3984650,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 5*a(n-1) + 3*a(n-2) - 13*a(n-3) + 2*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 12 2018 09:32:11, revision 7) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) + 3\,a(n-2) - 13\,a(n-3) + 2\,a(n-4)
\end{equation}
for all $n>3$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A233942.
