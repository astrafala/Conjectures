...
\title{The empirical recurrence for OEIS A218516, proved by transfer matrix}
...
\begin{abstract}
OEIS A218516 counts the distinct arrays obtained by applying a fixed local operation to every cell
...
$S=37$ states, after which the conjectured recurrence is settled by a finite exact
computation.
\end{abstract}
...
OEIS A218516 is ``Number of n X 2 arrays of the minimum value of corresponding elements and their horizontal or antidiagonal neighbors in a random 0..3 n X 2 array.''. It has offset $1$ and begins
\[
4, 36, 236, 1528, 9858, 63592, 410218, 2646208,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 6*a(n-1) + 3*a(n-2) - 4*a(n-4) + a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 24 2018 09:39:56, revision 7) this is still
...
\]
There are $S=37$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite.
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) + 3\,a(n-2) - 4\,a(n-4) + a(n-5)
\]
for every $n>5$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A218516.
