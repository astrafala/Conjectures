...
\title{The empirical recurrence for OEIS A303311, proved by transfer matrix}
...
\begin{abstract}
OEIS A303311 counts $5$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A303311 is ``Number of nX5 0..1 arrays with every element equal to 0, 1, 4, 5 or 6 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
8, 7, 24, 50, 139, 349, 853, 2180,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +9*a(n-3) +2*a(n-4) +4*a(n-5) -10*a(n-6) -6*a(n-7) +4*a(n-9) for n>12
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 21 2018 12:46:20, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 9\,a(n-3) + 2\,a(n-4) + 4\,a(n-5) - 10\,a(n-6) - 6\,a(n-7) + 4\,a(n-9)
\end{equation}
for all $n>11$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A303311.
