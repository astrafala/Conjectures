...
\title{The empirical recurrence for OEIS A253327, proved by transfer matrix}
...
\begin{abstract}
OEIS A253327 counts the arrays over $\{0,\dots,1\}$ whose $2\times2$ subblocks carry a
...
OEIS A253327 is ``Number of (2+1)X(n+1) 0..1 arrays with every 2X2 subblock sum nondecreasing horizontally, vertically and antidiagonally ne-to-sw.''. It has offset $1$ and begins
\[
44, 126, 373, 1026, 2797, 6936, 17197, 39616,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:57:56, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + 8\,a(n-2) - 50\,a(n-3) - 9\,a(n-4) + 270\,a(n-5) - 128\,a(n-6) - 820\,a(n-7) + 709\,a(n-8) + 1520\,a(n-9) - 1824\,a(n-10) - 1722\,a(n-11) + 2797\,a(n-12) + 1070\,a(n-13) - 2696\,a(n-14) - 160\,a(n-15) + 1608\,a(n-16) - 240\,a(n-17) - 544\,a(n-18) + 160\,a(n-19) + 80\,a(n-20) - 32\,a(n-21)
\]
for every $n>21$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253327.
