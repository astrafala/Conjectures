...
\title{The empirical recurrence for OEIS A218839, proved by transfer matrix}
...
\begin{abstract}
OEIS A218839 counts the distinct indicator arrays obtained from the $n\times5$ arrays over
...
indicator row by row turns it into one, on $S=213$ states, after which the conjectured
...
OEIS A218839 is ``Unmatched value maps: number of nX5 binary arrays indicating the locations of corresponding elements not equal to any horizontal or antidiagonal neighbor in a random 0..1 nX5 array.''. It has offset $1$ and begins
\[
12, 156, 2050, 26635, 346501, 4507281, 58634265, 762745363,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 17:47:49, revision 8) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

Let $R=\{0,\dots,1\}^{5}$ be the set of rows and let the neighbours of a cell be the
cells at the offsets
\[
$(-1,1)$, $(0,-1)$, $(0,1)$, $(1,-1)$,
\]
those falling outside the array being simply absent. For an array
$A=(r_1,\dots,r_n)\in R^n$ let $\Phi(A)\in\{0,1\}^{n\times5}$ mark the cells whose value
...
on rows $i-1,i,i+1$. Write $\beta(p,c,x)\in\{0,1\}^{5}$ for the marking of the row $c$
...
For a set $D\subseteq(R\cup\{\bot\})\times R$ of pairs and a row $b\in\{0,1\}^{5}$ put
\[
...
\]
the sum over all sequences of rows in $\{0,1\}^{5}$, empty $D$'s contributing nothing.
\end{lemma}
...
\]
There are $S=213$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite. Note
...
\begin{theorem}
\[
a(n)\;=\;12\,a(n-1) + 6\,a(n-2) + 103\,a(n-3) - 128\,a(n-4) - 41\,a(n-5) - 630\,a(n-6) - 523\,a(n-7) + 1154\,a(n-8) - 93\,a(n-9) + 762\,a(n-10) - 787\,a(n-11) - 416\,a(n-12) + 549\,a(n-13) - 178\,a(n-14) + 35\,a(n-15) + 11\,a(n-16) - 7\,a(n-17)
\]
for every $n>18$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A218839.
