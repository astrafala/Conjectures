...
\title{The empirical recurrence for OEIS A303794, proved by transfer matrix}
...
\begin{abstract}
OEIS A303794 counts $2$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A303794 is ``Number of nX2 0..1 arrays with every element unequal to 0, 1, 2 or 4 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
2, 4, 12, 24, 64, 184, 432, 1088,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) +8*a(n-3) -8*a(n-4) -8*a(n-5) for n>6
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 30 2018 17:10:05, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 8\,a(n-3) - 8\,a(n-4) - 8\,a(n-5)
\end{equation}
for all $n>5$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A303794.
