...
\title{The empirical recurrence for OEIS A183794, proved by transfer matrix}
...
\begin{abstract}
OEIS A183794 counts $(n+1)\times2$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A183794 is ``1/4 the number of (n+1) X 2 0..3 arrays with no 2 X 2 subblock having sum 6.''. It has offset $1$ and begins
\[
53, 706, 9395, 125050, 1664363, 22152262, 294840155, 3924240130,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 6*a(n-1) + 81*a(n-2) + 206*a(n-3) + 144*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 04 2018 12:04:29, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) + 81\,a(n-2) + 206\,a(n-3) + 144\,a(n-4)
\end{equation}
for all $n>3$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A183794.
