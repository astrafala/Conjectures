...
\title{The empirical recurrence for OEIS A303681, proved by transfer matrix}
...
\begin{abstract}
OEIS A303681 counts $7$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $different from$ itself lying in $\{0,1,3\}$, and it carries an empirical
...
OEIS A303681 is ``Number of nX7 0..1 arrays with every element unequal to 0, 1 or 3 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
21, 103, 57, 90, 150, 245, 367, 509,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +a(n-4) +a(n-8) for n>14
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 28 2018 09:22:44, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + a(n-4) + a(n-8)
\end{equation}
for all $n>13$.
...
They vanish from the index corresponding to $n=13+1$ onwards, and the run was continued
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A303681.
