...
\title{The empirical recurrence for OEIS A207122, proved by transfer matrix}
...
\begin{abstract}
OEIS A207122 counts arrays over $\{0,\dots,1\}$ of width $7$ that avoid the patterns
$(0,0,1), (0,1,0)$ along one axis and $(0,0,1), (0,1,1)$ along the other, and carries an empirical recurrence of
...
OEIS A207122 is ``Number of n X 7 0..1 arrays avoiding 0 0 1 and 0 1 0 horizontally and 0 0 1 and 0 1 1 vertically.''. It has offset
$1$ and begins
\[
31, 961, 6634, 45796, 186822, 762129, 2330037,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 07 2022 16:13:11, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207122.
