...
\title{The empirical recurrence for OEIS A234076, proved by transfer matrix}
...
\begin{abstract}
OEIS A234076 counts $(n+1)\times2$ arrays over $\{0,\dots,4\}$ subject to a condition imposed on
...
OEIS A234076 is ``Number of (n+1) X (1+1) 0..4 arrays with every 2 X 2 subblock having the sum of the absolute values of all six edge and diagonal differences equal to 10.''. It has offset $1$ and begins
\[
96, 476, 2352, 12152, 63136, 335536, 1789760, 9652704,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 4*a(n-1) + 22*a(n-2) - 56*a(n-3) - 120*a(n-4) + 32*a(n-5) + 64*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 12 2018 15:31:47, revision 7) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234076.
