...
\title{The empirical recurrence for OEIS A232032, proved by transfer matrix}
...
\begin{abstract}
OEIS A232032 counts arrays of width $3$ over $\{0,\dots,1\}$ under a condition on each cell
...
OEIS A232032 is ``Number of (n+1) X (2+1) 0..1 arrays with every element equal to some horizontal, vertical or antidiagonal neighbor, with top left element zero.''. It has offset $1$ and begins
\[
11, 76, 521, 3588, 24719, 170270, 1172854, 8078859,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 7*a(n-1) - 5*a(n-3) - 2*a(n-4) - a(n-5) + 2*a(n-6) + 2*a(n-7) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 02 2018 06:32:24, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-1) - 5\,a(n-3) - 2\,a(n-4) - a(n-5) + 2\,a(n-6) + 2\,a(n-7)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232032.
