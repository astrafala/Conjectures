...
\title{The empirical recurrence for OEIS A299309, proved by transfer matrix}
...
\begin{abstract}
OEIS A299309 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A299309 is ``Number of nX3 0..1 arrays with every element equal to 1, 2, 4, 5, 6 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 7, 15, 29, 63, 199, 593, 1657,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 06 2018 13:35:08, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) - 3\,a(n-2) + a(n-3) - 3\,a(n-4) - 6\,a(n-5) - 8\,a(n-6) + 18\,a(n-7) + 27\,a(n-8) - 18\,a(n-9) + 15\,a(n-10) - 55\,a(n-11) + 21\,a(n-12) - 6\,a(n-13) + 14\,a(n-14) + 2\,a(n-15) - 2\,a(n-16)
\end{equation}
for all $n>16$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A299309.
