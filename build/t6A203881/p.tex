...
\title{The empirical recurrence for OEIS A203881, proved by transfer matrix}
...
\begin{abstract}
OEIS A203881 counts $(n+1)\times3$ arrays over $\{0,\dots,6\}$ subject to a condition imposed on
...
OEIS A203881 is ``Number of (n+1) X 3 0..6 arrays with every 2 X 2 subblock having equal diagonal elements or equal antidiagonal elements.''. It has offset $1$ and begins
\[
8281, 254359, 7501753, 222645367, 6601376089, 195759462871, 5804976472057, 172139217677623,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 25*a(n-1) +138*a(n-2).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 05 2018 11:32:52, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A203881.
