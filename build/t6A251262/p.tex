...
\title{The empirical recurrence for OEIS A251262, proved by transfer matrix}
...
\begin{abstract}
OEIS A251262 counts $(n+1)\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A251262 is ``Number of (n+1) X (2+1) 0..1 arrays with no 2 X 2 subblock having x11-x00 less than x10-x01.''. It has offset $1$ and begins
\[
26, 114, 480, 2058, 8812, 37772, 161906, 694042,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 5*a(n-1) - 2*a(n-2) - 5*a(n-3) + 2*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 27 2018 11:37:20, revision 7) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251262.
