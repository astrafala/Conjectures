...
\title{The empirical recurrence for OEIS A305039, proved by transfer matrix}
...
\begin{abstract}
OEIS A305039 counts $7$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $different from$ itself lying in $\{0,1,2,6,7\}$, and it carries an empirical
...
OEIS A305039 is ``Number of nX7 0..1 arrays with every element unequal to 0, 1, 2, 6 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
64, 21, 37, 143, 319, 1359, 7757, 28535,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 24 2018 08:43:21, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 4\,a(n-2) + 46\,a(n-3) + 28\,a(n-4) - 96\,a(n-5) - 703\,a(n-6) - 483\,a(n-7) + 852\,a(n-8) + 4784\,a(n-9) + 2587\,a(n-10) - 3085\,a(n-11) - 19285\,a(n-12) - 7219\,a(n-13) + 5901\,a(n-14) + 53806\,a(n-15) + 16012\,a(n-16) - 4964\,a(n-17) - 104877\,a(n-18) - 36795\,a(n-19) - 1797\,a(n-20) + 140326\,a(n-21) + 72893\,a(n-22) + 8231\,a(n-23) - 126381\,a(n-24) - 103809\,a(n-25) - 8684\,a(n-26) + 74359\,a(n-27) + 101294\,a(n-28) + 5366\,a(n-29) - 26476\,a(n-30) - 68004\,a(n-31) - 2226\,a(n-32) + 4153\,a(n-33) + 31732\,a(n-34) + 669\,a(n-35) + 677\,a(n-36) - 10272\,a(n-37) - 144\,a(n-38) - 474\,a(n-39) + 2234\,a(n-40) + 17\,a(n-41) + 97\,a(n-42) - 300\,a(n-43) - 2\,a(n-44) - 8\,a(n-45) + 20\,a(n-46)
\end{equation}
for all $n>50$.
...
has score in $\{0,1,2,6,7\}$. The entry also fixes the top-left entry to be $0$; that is a condition on the first row alone, so it restricts the start vector and nothing else.
...
\begin{itemize}
\item $\mathbf{s}(r,s)=1$ when every cell of $r$ has score in $\{0,1,2,6,7\}$ \emph{with no row
above $r$} and $r_1=0$, and $0$ otherwise;
\item an edge $(r,s)\to(s,t)$ when every cell of $s$ has score in $\{0,1,2,6,7\}$ computed from
$r$, $s$ and $t$;
\item $\mathbf{e}(r,s)=1$ when every cell of $s$ has score in $\{0,1,2,6,7\}$ \emph{with no row
...
exactly when every one of its $n$ rows has all scores in $\{0,1,2,6,7\}$. Read the sequence as the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A305039.
