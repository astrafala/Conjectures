...
\title{The empirical recurrence for OEIS A318425, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A318425 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A318425 is ``Number of nX3 0..1 arrays with every element unequal to 1, 2, 3 or 6 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
1, 16, 36, 147, 417, 1353, 4095, 12853,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 26 2018 11:21:08, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;9\,a(n-2) + 11\,a(n-3) - 14\,a(n-4) - 32\,a(n-5) - 29\,a(n-6) - 51\,a(n-7) + 33\,a(n-8) + 116\,a(n-9) + 18\,a(n-10) + 70\,a(n-11) + 92\,a(n-12) - 22\,a(n-13) - 12\,a(n-16) + 4\,a(n-17)
\end{equation}
for all $n>20$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A318425.
