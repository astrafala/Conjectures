...
\title{The empirical recurrence for OEIS A208417, proved by transfer matrix}
...
\begin{abstract}
OEIS A208417 counts arrays over $\{0,\dots,1\}$ of width $5$ that avoid the patterns
...
OEIS A208417 is ``Number of nX5 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 0 0 and 0 1 1 vertically.''. It has offset
$1$ and begins
\[
16, 256, 1260, 5139, 18395, 55404, 161975,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:50:20, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) - 28\,a(n-3) - 4\,a(n-4) + 124\,a(n-5) + 22\,a(n-6) - 334\,a(n-7) - 121\,a(n-8) + 609\,a(n-9) + 318\,a(n-10) - 744\,a(n-11) - 365\,a(n-12) + 523\,a(n-13) + 50\,a(n-14) - 302\,a(n-15) + 682\,a(n-16) + 206\,a(n-17) - 1062\,a(n-18) - 316\,a(n-19) + 974\,a(n-20) + 164\,a(n-21) - 554\,a(n-22) + 112\,a(n-23) + 194\,a(n-24) - 262\,a(n-25) - 58\,a(n-26) + 300\,a(n-27) - 41\,a(n-28) - 135\,a(n-29) + 14\,a(n-30) + 62\,a(n-31) - 54\,a(n-32) + 8\,a(n-33) + 20\,a(n-34) + 2\,a(n-35) - 13\,a(n-36) + 7\,a(n-37) - 2\,a(n-39) - a(n-40) + a(n-41)
\end{equation}
for all $n>40$. 
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208417.
