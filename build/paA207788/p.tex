...
\title{The empirical recurrence for OEIS A207788, proved by transfer matrix}
...
\begin{abstract}
OEIS A207788 counts arrays over $\{0,\dots,1\}$ of width $6$ that avoid the patterns
...
on $S=361$ vertices, and $a(n)=\mathbf{1}^{\!\top}P^{\,n-2}\mathbf{1}$. Writing $q$
...
OEIS A207788 is ``Number of 6Xn 0..1 arrays avoiding 0 0 0 and 0 1 1 horizontally and 0 0 0 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
19, 361, 1575, 6418, 22322, 65094, 185613,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:19:15, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) - 2\,a(n-2) - 45\,a(n-3) + 31\,a(n-4) + 230\,a(n-5) - 159\,a(n-6) - 834\,a(n-7) + 487\,a(n-8) + 2216\,a(n-9) - 1008\,a(n-10) - 4456\,a(n-11) + 1746\,a(n-12) + 6657\,a(n-13) - 2910\,a(n-14) - 7371\,a(n-15) + 5145\,a(n-16) + 5601\,a(n-17) - 8497\,a(n-18) - 1717\,a(n-19) + 11518\,a(n-20) - 2645\,a(n-21) - 12637\,a(n-22) + 6573\,a(n-23) + 10402\,a(n-24) - 8672\,a(n-25) - 6375\,a(n-26) + 9440\,a(n-27) + 1727\,a(n-28) - 8399\,a(n-29) + 1708\,a(n-30) + 6137\,a(n-31) - 3371\,a(n-32) - 3728\,a(n-33) + 4085\,a(n-34) + 956\,a(n-35) - 3071\,a(n-36) + 318\,a(n-37) + 2176\,a(n-38) - 1208\,a(n-39) - 824\,a(n-40) + 1065\,a(n-41) + 20\,a(n-42) - 589\,a(n-43) + 173\,a(n-44) + 339\,a(n-45) - 323\,a(n-46) + 47\,a(n-47) + 60\,a(n-48) + 11\,a(n-49) - 75\,a(n-50) + 61\,a(n-51) - 18\,a(n-52) - 3\,a(n-54) + 6\,a(n-55) - 4\,a(n-56) + a(n-57)
\end{equation}
...
$(0,0,0), (1,0,1)$ as $3$ consecutive entries. There are $19$ admissible columns; that condition
...
columns, so $S=361$, and declare $w\to w'$ an edge when $w'$ is $w$ with its first entry
...
values agree exactly, including the initial count of $19$ admissible columns. That is
...
Third, the vanishing test of Lemma~\ref{lem:crit} was carried past $S=361$ consecutive
zeros rather than to a sampled prefix.

\begin{thebibliography}{9}
\bibitem{oeis} The OEIS Foundation, \emph{The On-Line Encyclopedia of Integer
Sequences}, \url{https://oeis.org}, 2026. Sequence A207788.
