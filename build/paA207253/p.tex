...
\title{The empirical recurrence for OEIS A207253, proved by transfer matrix}
...
\begin{abstract}
OEIS A207253 counts arrays over $\{0,\dots,1\}$ of width $7$ that avoid the patterns
...
OEIS A207253 is ``Number of nX7 0..1 arrays avoiding 0 0 1 and 1 0 1 horizontally and 0 1 0 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
14, 196, 966, 5950, 34608, 207298, 1231650,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 13:41:19, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) + 7\,a(n-2) + 4\,a(n-3) + 102\,a(n-4) + 156\,a(n-5) + 223\,a(n-6) + 518\,a(n-7) + 545\,a(n-8) + 578\,a(n-9) + 532\,a(n-10) + 306\,a(n-11) + 173\,a(n-12) - 124\,a(n-13) - 147\,a(n-14) - 50\,a(n-15) - 14\,a(n-16) + 22\,a(n-17) + a(n-18) + 2\,a(n-19) - a(n-20)
\end{equation}
for all $n>19$. 
...
$(0,0,1), (1,0,1)$ as $3$ consecutive entries. There are $14$ admissible rows; that condition
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207253.
