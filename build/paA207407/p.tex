...
\title{The empirical recurrence for OEIS A207407, proved by transfer matrix}
...
\begin{abstract}
OEIS A207407 counts arrays over $\{0,\dots,1\}$ of width $7$ that avoid the patterns
...
OEIS A207407 is ``Number of 7Xn 0..1 arrays avoiding 0 0 1 and 0 1 1 horizontally and 0 0 1 and 1 1 0 vertically.''. It has offset
$1$ and begins
\[
14, 196, 966, 4761, 16284, 55696, 154580,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 13:51:53, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207407.
