...
\title{The empirical recurrence for OEIS A317560, proved by transfer matrix}
...
\begin{abstract}
OEIS A317560 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A317560 is ``Number of nX3 0..1 arrays with every element unequal to 0, 1, 2, 3, 4, 5, 7 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
4, 32, 228, 1619, 11510, 81814, 581541, 4133710,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 6*a(n-1) +11*a(n-2) -11*a(n-3) -72*a(n-4) -54*a(n-5) for n>6
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 31 2018 12:35:06, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) + 11\,a(n-2) - 11\,a(n-3) - 72\,a(n-4) - 54\,a(n-5)
\end{equation}
for all $n>5$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A317560.
