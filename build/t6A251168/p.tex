...
\title{The empirical recurrence for OEIS A251168, proved by transfer matrix}
...
\begin{abstract}
OEIS A251168 counts $(n+1)\times2$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A251168 is ``Number of (n+1)X(1+1) 0..3 arrays with no 2X2 subblock having the minimum of its diagonal elements less than the absolute difference of its antidiagonal elements.''. It has offset $1$ and begins
\[
136, 1192, 10950, 100462, 923568, 8489391, 78041038, 717407430,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:08:19, revision 7) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;8\,a(n-1) + 16\,a(n-2) - 40\,a(n-3) - 63\,a(n-4) + 38\,a(n-5) + 87\,a(n-6) + 11\,a(n-7) - 35\,a(n-8) - 10\,a(n-9) + 5\,a(n-10) - 2\,a(n-11) - 4\,a(n-12) - 2\,a(n-13)
\end{equation}
for all $n>12$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251168.
