...
\title{The empirical recurrence for OEIS A251224, proved by transfer matrix}
...
\begin{abstract}
OEIS A251224 counts $(n+1)\times5$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A251224 is ``Number of (n+1)X(4+1) 0..1 arrays with no 2X2 subblock having the minimum of its diagonal elements greater than the absolute difference of its antidiagonal elements.''. It has offset $1$ and begins
\[
597, 11753, 228689, 4462968, 87024544, 1697323707, 33102432698, 645599385182,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:11:35, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;13\,a(n-1) + 150\,a(n-2) - 269\,a(n-3) - 3713\,a(n-4) + 1325\,a(n-5) + 30575\,a(n-6) - 16105\,a(n-7) - 99760\,a(n-8) + 117265\,a(n-9) + 20076\,a(n-10) - 71217\,a(n-11) + 11160\,a(n-12) + 14210\,a(n-13) - 3935\,a(n-14) - 1079\,a(n-15) + 396\,a(n-16) + 60\,a(n-17)
\end{equation}
for all $n>17$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251224.
