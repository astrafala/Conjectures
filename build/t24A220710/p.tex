...
\title{The empirical recurrence for OEIS A220710, proved by transfer matrix}
...
\begin{abstract}
OEIS A220710 counts the ways of linking the cells of a grid $5$ cells wide, each cell either to
...
state, the count is a walk count on $S=90$ of them, and the conjectured recurrence is then
...
OEIS A220710 is ``Number of ways to reciprocally link elements of an 5 X n array either to themselves or to exactly two horizontal and antidiagonal neighbors, without consecutive collinear links.''. It has offset $1$ and begins
\[
1, 1, 8, 28, 107, 405, 1520, 5706,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) + 7*a(n-2) - 14*a(n-3) - 11*a(n-4) + 17*a(n-5) + 5*a(n-6) - 6*a(n-7) for n>11.
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 02 2018 08:41:02, revision 7) this is still
...
one configuration. With $M$ the adjacency matrix of the digraph on the $S=90$ reachable
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + 7\,a(n-2) - 14\,a(n-3) - 11\,a(n-4) + 17\,a(n-5) + 5\,a(n-6) - 6\,a(n-7)
\]
for every $n>11$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A220710.
