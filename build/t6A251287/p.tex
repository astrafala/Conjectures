...
\title{The empirical recurrence for OEIS A251287, proved by transfer matrix}
...
\begin{abstract}
OEIS A251287 counts $(n+1)\times4$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A251287 is ``Number of (n+1)X(3+1) 0..1 arrays with every 2X2 subblock having a single 1 or two 1s on the same edge or main diagonally.''. It has offset $1$ and begins
\[
52, 219, 822, 3390, 12954, 52474, 202882, 813336,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) +17*a(n-2) -25*a(n-3) -74*a(n-4) +87*a(n-5) +108*a(n-6) -77*a(n-7) -72*a(n-8) +15*a(n-9) +18*a(n-10) +2*a(n-11)
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:14:24, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 17\,a(n-2) - 25\,a(n-3) - 74\,a(n-4) + 87\,a(n-5) + 108\,a(n-6) - 77\,a(n-7) - 72\,a(n-8) + 15\,a(n-9) + 18\,a(n-10) + 2\,a(n-11)
\end{equation}
for all $n>11$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251287.
