...
\title{The empirical recurrence for OEIS A220631, proved by transfer matrix}
...
\begin{abstract}
OEIS A220631 counts the ways of linking the cells of a grid $7$ cells wide, each cell either to
...
state, the count is a walk count on $S=32$ of them, and the conjectured recurrence is then
...
OEIS A220631 is ``Number of ways to reciprocally link elements of an nX7 array either to themselves or to exactly two horizontal or antidiagonal neighbors.''. It has offset $1$ and begins
\[
1, 32, 564, 10695, 201903, 3817452, 72097810, 1362188752,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 18:55:35, revision 8) this is still
...
one configuration. With $M$ the adjacency matrix of the digraph on the $S=32$ reachable
...
\begin{theorem}
\[
a(n)\;=\;11\,a(n-1) + 119\,a(n-2) + 510\,a(n-3) + 1074\,a(n-4) + 735\,a(n-5) - 1120\,a(n-6) - 2716\,a(n-7) + 5687\,a(n-8) - 4250\,a(n-9) + 1973\,a(n-10) - 802\,a(n-11) + 244\,a(n-12) - 36\,a(n-13) - 4\,a(n-14)
\]
for every $n>14$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A220631.
