...
\title{The empirical recurrence for OEIS A205189, proved by transfer matrix}
...
\begin{abstract}
OEIS A205189 counts arrays over $\{0,\dots,1\}$ under a condition on the number of clockwise edge increases
...
OEIS A205189 is ``Number of (n+1) X 5 0..1 arrays with the number of clockwise edge increases in every 2 X 2 subblock differing from each horizontal or vertical neighbor.''. It has offset $1$ and begins
\[
72, 104, 160, 256, 384, 576, 864, 1312,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) +a(n-2) -a(n-3) +a(n-4) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 11 2018 04:18:06, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A205189.
