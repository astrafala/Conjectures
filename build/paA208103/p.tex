...
\title{The empirical recurrence for OEIS A208103, proved by transfer matrix}
...
\begin{abstract}
OEIS A208103 counts arrays over $\{0,\dots,1\}$ of width $3$ that avoid the patterns
$(0,0,0), (0,1,0)$ along one axis and $(0,1,1), (1,1,0)$ along the other, and carries an empirical recurrence of
...
OEIS A208103 is ``Number of n X 3 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 1 1 and 1 1 0 vertically.''. It has offset
$1$ and begins
\[
6, 36, 78, 171, 406, 990, 2485,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 4*a(n-1) - 2*a(n-2) - 6*a(n-3) + 4*a(n-4) + 2*a(n-5) - a(n-6) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 06 2018 14:59:20, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208103.
