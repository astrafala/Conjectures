...
\title{The empirical recurrence for OEIS A231747, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A231747 counts arrays over $\{0,\dots,2\}$ in which every cell is constrained by the
...
OEIS A231747 is ``Number of n X 2 0..2 arrays with no element less than a strict majority of its horizontal, vertical, diagonal and antidiagonal neighbors.''. It has offset $1$ and begins
\[
3, 15, 51, 186, 687, 2485, 9068, 33308,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 30 2018 20:23:18, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 3\,a(n-2) + 14\,a(n-3) - 39\,a(n-4) - 45\,a(n-5) - 124\,a(n-6) + 18\,a(n-7) + 132\,a(n-8) + 248\,a(n-9) + 112\,a(n-10) + 64\,a(n-11)
\end{equation}
for all $n>12$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231747.
