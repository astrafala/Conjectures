...
\title{The empirical recurrence for OEIS A253519, proved by transfer matrix}
...
\begin{abstract}
OEIS A253519 counts the arrays over $\{0,\dots,2\}$ whose $2\times2$ subblocks carry a
...
OEIS A253519 is ``Number of (n+1)X(3+1) 0..2 arrays with every 2X2 subblock diagonal minimum minus antidiagonal minimum nondecreasing horizontally and diagonal maximum minus antidiagonal maximum nondecreasing vertically.''. It has offset $1$ and begins
\[
2180, 10706, 30013, 84684, 256914, 791232, 2419612, 7338525,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 12*a(n-1) -61*a(n-2) +172*a(n-3) -295*a(n-4) +316*a(n-5) -207*a(n-6) +76*a(n-7) -12*a(n-8) for n>16
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 14:05:15, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;12\,a(n-1) - 61\,a(n-2) + 172\,a(n-3) - 295\,a(n-4) + 316\,a(n-5) - 207\,a(n-6) + 76\,a(n-7) - 12\,a(n-8)
\]
for every $n>16$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253519.
