...
\title{The empirical recurrence for OEIS A251312, proved by transfer matrix}
...
\begin{abstract}
OEIS A251312 counts $(n+1)\times4$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A251312 is ``Number of (n+1) X (3+1) 0..1 arrays with no 2 X 2 subblock having the maximum of its diagonal elements greater than the absolute difference of its antidiagonal elements.''. It has offset $1$ and begins
\[
61, 238, 890, 3369, 12859, 48980, 186162, 707897,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 8*a(n-1) - 27*a(n-2) + 64*a(n-3) - 110*a(n-4) + 121*a(n-5) - 91*a(n-6) + 46*a(n-7) - 14*a(n-8) + a(n-9) - a(n-10).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 28 2018 10:57:45, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;8\,a(n-1) - 27\,a(n-2) + 64\,a(n-3) - 110\,a(n-4) + 121\,a(n-5) - 91\,a(n-6) + 46\,a(n-7) - 14\,a(n-8) + a(n-9) - a(n-10)
\end{equation}
for all $n>10$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251312.
