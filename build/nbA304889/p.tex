...
\title{The empirical recurrence for OEIS A304889, proved by transfer matrix}
...
\begin{abstract}
OEIS A304889 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $different from$ itself lying in $\{0,2,3,4,7\}$, and it carries an empirical
...
OEIS A304889 is ``Number of nX3 0..1 arrays with every element unequal to 0, 2, 3, 4 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 8, 11, 40, 94, 291, 776, 2269,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 20 2018 10:29:29, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 3\,a(n-2) - 7\,a(n-3) - 8\,a(n-4) - 8\,a(n-5) + 26\,a(n-6) - 13\,a(n-7) - 16\,a(n-8) + 76\,a(n-9) - 33\,a(n-10) - 22\,a(n-11) + 27\,a(n-12) - 23\,a(n-13) + 11\,a(n-14) + 7\,a(n-15) - 5\,a(n-16) + 5\,a(n-17) - 2\,a(n-18) - 2\,a(n-19)
\end{equation}
for all $n>19$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A304889.
