...
\title{The empirical recurrence for OEIS A208110, proved by transfer matrix}
...
\begin{abstract}
OEIS A208110 counts arrays over $\{0,\dots,1\}$ of width $5$ that avoid the patterns
$(0,1,1), (1,1,0)$ along one axis and $(0,0,0), (0,1,0)$ along the other, and carries an empirical recurrence of
...
OEIS A208110 is ``Number of 5 X n 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 1 1 and 1 1 0 vertically.''. It has offset
$1$ and begins
\[
14, 196, 406, 841, 6235, 46225, 134160,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) + 13*a(n-3) + 166*a(n-4) - 176*a(n-5) - 143*a(n-6) - 1452*a(n-8) + 1331*a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 28 2018 08:25:20, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 13\,a(n-3) + 166\,a(n-4) - 176\,a(n-5) - 143\,a(n-6) - 1452\,a(n-8) + 1331\,a(n-9)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208110.
