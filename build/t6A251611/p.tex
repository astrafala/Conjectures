...
\title{The empirical recurrence for OEIS A251611, proved by transfer matrix}
...
\begin{abstract}
OEIS A251611 counts $(n+1)\times2$ arrays over $\{0,\dots,6\}$ subject to a condition imposed on
...
OEIS A251611 is ``Number of (n+1) X (1+1) 0..6 arrays with every 2 X 2 subblock summing to a prime.''. It has offset $1$ and begins
\[
826, 14008, 237566, 4031056, 68377410, 1160228856, 19681119902, 333946195360,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 18 2022 18:33:22, revision 7) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 411\,a(n-2) - 674\,a(n-3) - 41804\,a(n-4) + 61984\,a(n-5) + 1400288\,a(n-6) - 1913856\,a(n-7) - 9522176\,a(n-8) + 11993088\,a(n-9) + 5898240\,a(n-10)
\end{equation}
for all $n>9$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251611.
