...
\title{The empirical recurrence for OEIS A232958, proved by transfer matrix}
...
\begin{abstract}
OEIS A232958 counts arrays over $\{0,\dots,3\}$ in which no two entries that are neighbours in
...
carried by one bounded piece of extra state, so the count is a walk count on $S=256$ states.
\end{abstract}
...
OEIS A232958 is ``Number of 4Xn 0..3 arrays with no element x(i,j) adjacent to value 3-x(i,j) horizontally, diagonally or antidiagonally, and top left element zero.''. It has offset $1$ and begins
\[
64, 1029, 27441, 685251, 17429409, 442227825, 11228712351, 285082486341,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 07:46:05, revision 6) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The array is $4$ cells across with entries $x(i,j)\in\{0,1,2,3\}$. Call two values $u,v$ CLASHING
...
and the row above and every clash inside it. There are $S=256$ reachable states.
...
\begin{theorem}
\[
a(n)\;=\;24\,a(n-1) + 76\,a(n-2) - 1008\,a(n-3) - 992\,a(n-4) + 8762\,a(n-5) - 7403\,a(n-6) - 2174\,a(n-7) + 3324\,a(n-8) - 416\,a(n-9) - 96\,a(n-10)
\]
for every $n>10$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232958.
