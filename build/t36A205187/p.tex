...
\title{The empirical recurrence for OEIS A205187, proved by transfer matrix}
...
\begin{abstract}
OEIS A205187 counts arrays over $\{0,\dots,1\}$ under a condition on the number of clockwise edge increases
...
OEIS A205187 is ``Number of (n+1)X2 0..1 arrays with the number of clockwise edge increases in every 2X2 subblock differing from each horizontal or vertical neighbor.''. It has offset $1$ and begins
\[
16, 24, 48, 72, 144, 216, 432, 648,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-2)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 11:49:43, revision 9) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A205187.
