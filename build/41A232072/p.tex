...
\title{The empirical recurrence for OEIS A232072, proved by transfer matrix}
...
\begin{abstract}
OEIS A232072 counts arrays of width $5$ over $\{0,\dots,1\}$ under a condition on each cell
and its neighbours, and carries an empirical recurrence of order $30$ contributed by
...
OEIS A232072 is ``Number of (n+1)X(4+1) 0..1 arrays with every element equal to some horizontal, diagonal or antidiagonal neighbor, with top left element zero.''. It has offset $1$ and begins
\[
161, 3681, 91636, 2265691, 56126173, 1389867384, 34420057373, 852404560481,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 06:51:48, revision 6) this is still
...
$161$, which the model reproduces along with every later term. That is the cheapest check
...
\begin{theorem}
\[
a(n)\;=\;18\,a(n-1) + 162\,a(n-2) + 236\,a(n-3) - 2046\,a(n-4) - 9966\,a(n-5) - 6228\,a(n-6) + 65257\,a(n-7) + 188276\,a(n-8) - 46843\,a(n-9) - 649584\,a(n-10) - 764788\,a(n-11) + 412637\,a(n-12) + 1321769\,a(n-13) + 761732\,a(n-14) + 182925\,a(n-15) - 381900\,a(n-16) - 337601\,a(n-17) - 102296\,a(n-18) + 5318\,a(n-19) - 23355\,a(n-20) - 10567\,a(n-21) - 20176\,a(n-22) - 133\,a(n-23) - 430\,a(n-24) - 2201\,a(n-25) + 428\,a(n-26) + 116\,a(n-27) + 62\,a(n-28) + 8\,a(n-29) + 4\,a(n-30)
\]
for every $n>29$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232072.
