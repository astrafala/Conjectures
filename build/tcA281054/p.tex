...
\title{The empirical recurrence for OEIS A281054, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A281054 imposes three things at once: a condition on each cell that reaches one row up and
...
OEIS A281054 is ``Number of nX6 0..1 arrays with no element equal to more than one of its horizontal and antidiagonal neighbors, with the exception of exactly two elements, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
6, 251, 1403, 5400, 16875, 46610, 119205, 288527,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 13 2017 16:57:24, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 3\,a(n-2) - 11\,a(n-3) - 9\,a(n-4) + 15\,a(n-5) + 20\,a(n-6) + 3\,a(n-7) - 18\,a(n-8) - 27\,a(n-9) - 9\,a(n-10) + 15\,a(n-11) + 20\,a(n-12) + 12\,a(n-13) - 7\,a(n-15) - 6\,a(n-16) - 3\,a(n-17) - a(n-18)
\end{equation}
for all $n>21$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A281054.
