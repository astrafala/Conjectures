...
\title{The empirical recurrence for OEIS A206879, proved by transfer matrix}
...
\begin{abstract}
OEIS A206879 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
$(0,1,0)$ along one axis and $(1,0,1)$ along the other, and carries an empirical recurrence of
order $25$ contributed by R.~H.~Hardin. It is true. The patterns have length $3$, so
...
$\mathbf{1}^{\!\top}P^{\,n-2-25}q(P)\mathbf{1}$, which vanishes identically
...
OEIS A206879 is ``Number of n X 4 0..1 arrays avoiding 0 1 0 horizontally and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
12, 144, 1011, 6478, 44879, 321393, 2276625,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 18 2021 17:07:43, revision
7) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;8\,a(n-1) - 18\,a(n-2) + 69\,a(n-3) + 92\,a(n-4) - 189\,a(n-5) + 404\,a(n-6) - 187\,a(n-7) - 4014\,a(n-8) - 682\,a(n-9) + 9084\,a(n-10) + 5101\,a(n-11) - 6052\,a(n-12) - 5594\,a(n-13) - 1393\,a(n-14) - 277\,a(n-15) + 1312\,a(n-16) + 1153\,a(n-17) + 533\,a(n-18) + 112\,a(n-19) - 87\,a(n-20) - 46\,a(n-21) - 32\,a(n-22) - 9\,a(n-23) + 3\,a(n-24) + a(n-25)
\end{equation}
for all $n>24$. 
...
$(0,1,0)$ as $3$ consecutive entries. There are $12$ admissible rows; that condition
...
rows, so $S=144$, and declare $w\to w'$ an edge when $w'$ is $w$ with its first entry
...
$a(n)-\sum_i c_i a(n-i)=u_{\,n-2-25}$ whenever $n-25\ge2$. Hence
\eqref{eq:conj} holds for every $n>t$ exactly when $u_j=0$ for every
$j>t-2-25$. Moreover $(u_j)$ satisfies the monic linear recurrence whose
...
$P^{\,n-2-25}$ gives the identity. The equivalence follows by letting the exponent
...
\begin{proof}
The vector $q(P)\mathbf{1}\in\mathbb{Z}^{S}$ was formed by $25$ matrix--vector
...
values agree exactly, including the initial count of $12$ admissible rows. That is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206879.
