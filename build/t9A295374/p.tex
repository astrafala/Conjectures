...
\title{The empirical recurrence for OEIS A295374, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A295374 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A295374 is ``Number of n X 3 0..1 arrays with each 1 horizontally or vertically adjacent to 0, 2 or 4 1s.''. It has offset $1$ and begins
\[
5, 19, 74, 278, 1067, 4071, 15557, 59407,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) + 4*a(n-2) - 3*a(n-3) + a(n-4) - 8*a(n-5) - 3*a(n-6) + 5*a(n-7) - 2*a(n-8) + a(n-9) + a(n-10).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 22 2019 09:55:00, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 4\,a(n-2) - 3\,a(n-3) + a(n-4) - 8\,a(n-5) - 3\,a(n-6) + 5\,a(n-7) - 2\,a(n-8) + a(n-9) + a(n-10)
\end{equation}
for all $n>11$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A295374.
