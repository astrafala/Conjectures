...
\title{The empirical recurrence for OEIS A233983, proved by transfer matrix}
...
\begin{abstract}
OEIS A233983 counts $(n+1)\times3$ arrays over $\{0,\dots,4\}$ subject to a condition imposed on
...
OEIS A233983 is ``Number of (n+1)X(2+1) 0..4 arrays with every 2X2 subblock having the sum of the squares of the edge differences equal to 10, and no two adjacent values equal.''. It has offset $1$ and begins
\[
236, 1540, 9632, 62040, 393396, 2520604, 16042420, 102569896,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 08:17:43, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 53\,a(n-2) - 116\,a(n-3) - 892\,a(n-4) + 1620\,a(n-5) + 5804\,a(n-6) - 9766\,a(n-7) - 13812\,a(n-8) + 23148\,a(n-9) + 8224\,a(n-10) - 16848\,a(n-11) + 2560\,a(n-12) + 256\,a(n-13)
\end{equation}
for all $n>13$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A233983.
