...
\title{The empirical recurrence for OEIS A208421, proved by transfer matrix}
...
\begin{abstract}
OEIS A208421 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
$(0,0,0), (0,1,1)$ along one axis and $(0,0,0), (0,0,1)$ along the other, and carries an empirical recurrence of
...
OEIS A208421 is ``Number of 4 X n 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 0 0 and 0 1 1 vertically.''. It has offset
$1$ and begins
\[
9, 81, 261, 1269, 5139, 22509, 95265,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) + 7*a(n-2) - 6*a(n-3) - 3*a(n-4) + 2*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 02 2018 14:14:37, revision
8) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 7\,a(n-2) - 6\,a(n-3) - 3\,a(n-4) + 2\,a(n-5)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208421.
