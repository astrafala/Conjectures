...
\title{The empirical recurrence for OEIS A206079, proved by transfer matrix}
...
\begin{abstract}
OEIS A206079 counts arrays over $\{0,\dots,3\}$ under a condition on the number of clockwise edge increases
...
OEIS A206079 is ``Number of (n+1)X3 0..3 arrays with the number of clockwise edge increases in every 2X2 subblock equal to one.''. It has offset $1$ and begins
\[
960, 13672, 187144, 2567488, 35195768, 482548752, 6615795040, 90703800392,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 12:27:14, revision 9) this is still
...
subblocks; the entry's first term is $960$, which the model
...
\begin{theorem}
\[
a(n)\;=\;15\,a(n-1) - 14\,a(n-2) - 61\,a(n-3) + 154\,a(n-4) - 152\,a(n-5) + 198\,a(n-6) - 166\,a(n-7) + 64\,a(n-8) - 28\,a(n-9) + 8\,a(n-10)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206079.
