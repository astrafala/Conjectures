...
\title{The empirical recurrence for OEIS A228801, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A228801 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A228801 is ``Number of 6Xn binary arrays with top left element equal to 1 and no two ones adjacent horizontally or nw-se.''. It has offset $1$ and begins
\[
32, 89, 2892, 22060, 362511, 3835792, 51557716, 607251543,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 04 2025 00:08:01, revision 10) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A228801.
