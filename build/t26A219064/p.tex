...
\title{The empirical recurrence for OEIS A219064, proved by transfer matrix}
...
\begin{abstract}
OEIS A219064 counts the distinct indicator arrays obtained from the $n\times3$ arrays over
...
indicator row by row turns it into one, on $S=220$ states, after which the conjectured
...
OEIS A219064 is ``Hilltop maps: number of 3Xn binary arrays indicating the locations of corresponding elements not exceeded by any horizontal, diagonal or antidiagonal neighbor in a random 0..2 3Xn array.''. It has offset $1$ and begins
\[
1, 59, 503, 4049, 32313, 258353, 2066359, 16527691,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 7*a(n-1) +6*a(n-2) +14*a(n-3) +10*a(n-4) +38*a(n-5) +23*a(n-6) -29*a(n-7) -52*a(n-8) -28*a(n-9) for n>10
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 17:51:25, revision 8) this is still
...
\]
There are $S=220$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite. Note
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-1) + 6\,a(n-2) + 14\,a(n-3) + 10\,a(n-4) + 38\,a(n-5) + 23\,a(n-6) - 29\,a(n-7) - 52\,a(n-8) - 28\,a(n-9)
\]
for every $n>10$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A219064.
