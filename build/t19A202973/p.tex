...
\title{The empirical recurrence for OEIS A202973, proved by transfer matrix}
...
\begin{abstract}
OEIS A202973 counts $n\times2$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
walk, and $a(n)$ is a walk count on $S=12$ vertices, which is $C$-finite. Whether the
...
OEIS A202973 is ``Number of n X 2 0..1 arrays with every nonzero element less than or equal to at least two horizontal and vertical neighbors.''. It has offset $1$ and begins
\[
1, 2, 4, 7, 14, 31, 69, 155,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) - 2*a(n-2) + 2*a(n-3) - 2*a(n-4) - a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 19 2018 08:25:57, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A202973.
