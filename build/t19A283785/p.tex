...
\title{The empirical recurrence for OEIS A283785, proved by transfer matrix}
...
\begin{abstract}
OEIS A283785 counts $2\times n$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A283785 is ``Number of 2Xn 0..1 arrays with no 1 equal to more than two of its horizontal, diagonal and antidiagonal neighbors, with the exception of exactly two elements.''. It has offset $1$ and begins
\[
0, 0, 5, 14, 113, 564, 2410, 10648,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 16 2017 12:23:02, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;9\,a(n-1) - 24\,a(n-2) + 18\,a(n-3) - 48\,a(n-4) + 156\,a(n-5) + 46\,a(n-6) - 78\,a(n-7) - 423\,a(n-8) - 501\,a(n-9) + 474\,a(n-10) + 972\,a(n-11) + 840\,a(n-12) - 288\,a(n-13) - 1152\,a(n-14) - 512\,a(n-15)
\]
for every $n>15$.
\end{theorem}
...
By Lemma~\ref{lem:crit} the recurrence holds for every $n>15$.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A283785.
