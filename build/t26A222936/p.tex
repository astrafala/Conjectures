...
\title{The empirical recurrence for OEIS A222936, proved by transfer matrix}
...
\begin{abstract}
OEIS A222936 counts the distinct indicator arrays obtained from the $n\times2$ arrays over
$\{0,\dots,3\}$ by marking the cells whose value is congruent modulo 4 to the sum of their neighbours, and carries an
...
indicator row by row turns it into one, on $S=250$ states, after which the conjectured
...
OEIS A222936 is ``Sum of neighbor maps: number of 2Xn binary arrays indicating the locations of corresponding elements equal to the sum mod 4 of their horizontal and antidiagonal neighbors in a random 0..3 2Xn array.''. It has offset $1$ and begins
\[
4, 16, 48, 256, 1024, 4096, 15820, 65536,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 21:01:16, revision 8) this is still
...
is congruent modulo 4 to the sum of its neighbours. The entry counts
\[
...
\]
There are $S=250$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite. Note
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + 32\,a(n-4) - 128\,a(n-5) - 212\,a(n-8) + 848\,a(n-9) - 1408\,a(n-12) + 5632\,a(n-13) + 10576\,a(n-16) - 42304\,a(n-17) + 22016\,a(n-20) - 88064\,a(n-21) - 171456\,a(n-24) + 685824\,a(n-25) - 149504\,a(n-28) + 598016\,a(n-29) + 1181696\,a(n-32) - 4726784\,a(n-33) + 458752\,a(n-36) - 1835008\,a(n-37) - 3653632\,a(n-40) + 14614528\,a(n-41) - 524288\,a(n-44) + 2097152\,a(n-45) + 4194304\,a(n-48) - 16777216\,a(n-49)
\]
for every $n>49$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A222936.
