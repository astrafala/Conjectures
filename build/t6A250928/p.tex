...
\title{The empirical recurrence for OEIS A250928, proved by transfer matrix}
...
\begin{abstract}
OEIS A250928 counts $(n+1)\times2$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A250928 is ``Number of (n+1) X (1+1) 0..3 arrays with no 2 X 2 subblock having a diagonal absolute difference less than its antidiagonal absolute difference.''. It has offset $1$ and begins
\[
164, 1652, 16588, 166600, 1673388, 16808096, 168826024, 1695743636,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 12*a(n-1) - 23*a(n-2) + 37*a(n-3) - 33*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 23 2018 21:18:10, revision 12) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250928.
