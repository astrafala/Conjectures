...
\title{The empirical recurrence for OEIS A207953, proved by transfer matrix}
...
\begin{abstract}
OEIS A207953 counts arrays over $\{0,\dots,1\}$ of width $7$ that avoid the patterns
...
OEIS A207953 is ``Number of 7Xn 0..1 arrays avoiding 0 0 1 and 0 1 1 horizontally and 0 1 0 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
42, 1764, 14406, 117649, 524104, 2334784, 7513176,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:31:09, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207953.
