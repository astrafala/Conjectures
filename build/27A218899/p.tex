...
\title{The empirical recurrence for OEIS A218899, proved by transfer matrix}
...
\begin{abstract}
OEIS A218899 counts the distinct arrays obtained by applying a fixed local operation to every cell
...
OEIS A218899 is ``Number of 3Xn arrays of the minimum value of corresponding elements and their horizontal, diagonal or antidiagonal neighbors in a random 0..1 3Xn array.''. It has offset $1$ and begins
\[
8, 16, 72, 212, 786, 2594, 9110, 31062,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 17:49:10, revision 10) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 7\,a(n-2) - 4\,a(n-3) - 6\,a(n-4) - 10\,a(n-5) - 20\,a(n-6) + 15\,a(n-7) - a(n-8) + 22\,a(n-9) + 14\,a(n-10) - 5\,a(n-11) - 6\,a(n-13) - 2\,a(n-14)
\]
for every $n>14$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A218899.
