...
\title{The empirical recurrence for OEIS A232031, proved by transfer matrix}
...
\begin{abstract}
OEIS A232031 counts arrays of width $2$ over $\{0,\dots,1\}$ under a condition on each cell
...
OEIS A232031 is ``Number of (n+1) X (1+1) 0..1 arrays with every element equal to some horizontal, vertical or antidiagonal neighbor, with top left element zero.''. It has offset $1$ and begins
\[
3, 11, 37, 129, 450, 1568, 5464, 19041,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) - 2*a(n-2) + a(n-3) - a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 19 2018 06:57:42, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) - 2\,a(n-2) + a(n-3) - a(n-4)
\]
for every $n>4$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232031.
