...
\title{The empirical recurrence for OEIS A253322, proved by transfer matrix}
...
\begin{abstract}
OEIS A253322 counts the arrays over $\{0,\dots,1\}$ whose $2\times2$ subblocks carry a
...
OEIS A253322 is ``Number of (n+1)X(4+1) 0..1 arrays with every 2X2 subblock sum nondecreasing horizontally, vertically and antidiagonally ne-to-sw.''. It has offset $1$ and begins
\[
286, 1026, 3787, 7744, 19312, 34660, 74953, 132376,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:57:21, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253322.
