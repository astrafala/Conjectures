...
\title{The empirical recurrence for OEIS A220542, proved by transfer matrix}
...
\begin{abstract}
OEIS A220542 counts the distinct indicator arrays obtained from the $n\times2$ arrays over
...
indicator row by row turns it into one, on $S=54$ states, after which the conjectured
...
OEIS A220542 is ``Equals one maps: number of n X 2 binary arrays indicating the locations of corresponding elements equal to exactly one of their horizontal and vertical neighbors in a random 0..2 n X 2 array.''. It has offset $1$ and begins
\[
2, 8, 38, 176, 816, 3616, 15362, 63484,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 6*a(n-1) - 7*a(n-2) - 6*a(n-3) + 7*a(n-4) + 4*a(n-5) for n>10.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 21 2018 09:20:15, revision 8) this is still
...
\]
There are $S=54$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite. Note
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) - 7\,a(n-2) - 6\,a(n-3) + 7\,a(n-4) + 4\,a(n-5)
\]
for every $n>10$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A220542.
