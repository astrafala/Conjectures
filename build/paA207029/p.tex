...
\title{The empirical recurrence for OEIS A207029, proved by transfer matrix}
...
\begin{abstract}
OEIS A207029 counts arrays over $\{0,\dots,1\}$ of width $6$ that avoid the patterns
...
OEIS A207029 is ``Number of 6Xn 0..1 arrays avoiding 0 0 0 and 0 1 1 horizontally and 0 0 1 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
12, 144, 396, 1719, 6123, 16038, 49925,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 13:24:38, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) - 5\,a(n-2) - 25\,a(n-3) + 5\,a(n-4) + 146\,a(n-5) - 21\,a(n-6) - 400\,a(n-7) - 230\,a(n-8) + 955\,a(n-9) + 807\,a(n-10) - 997\,a(n-11) - 2055\,a(n-12) + 345\,a(n-13) + 2000\,a(n-14) + 1561\,a(n-15) - 601\,a(n-16) - 1120\,a(n-17) - 2255\,a(n-18) - 690\,a(n-19) + 1257\,a(n-20) + 3043\,a(n-21) + 570\,a(n-22) - 650\,a(n-23) - 1885\,a(n-24) - 921\,a(n-25) - 654\,a(n-26) + 1200\,a(n-27) + 910\,a(n-28) + 655\,a(n-29) - 421\,a(n-30) - 229\,a(n-31) - 520\,a(n-32) - 45\,a(n-33) + 25\,a(n-34) + 240\,a(n-35) + 25\,a(n-36) + 50\,a(n-37) - 45\,a(n-38) - 15\,a(n-39) - 30\,a(n-40) + 10\,a(n-41) + 5\,a(n-43) + a(n-45) - a(n-46)
\end{equation}
for all $n>45$. The entry's array has a fixed number of rows and a growing number of
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207029.
