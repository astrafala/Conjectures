...
\title{The empirical recurrence for OEIS A303677, proved by transfer matrix}
...
\begin{abstract}
OEIS A303677 counts $2$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A303677 is ``Number of nX2 0..1 arrays with every element unequal to 0, 1 or 3 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
2, 5, 7, 17, 31, 49, 103, 193,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +4*a(n-3) -2*a(n-4) for n>5
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 28 2018 09:19:58, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A303677.
