...
\title{The empirical recurrence for OEIS A299138, proved by transfer matrix}
...
\begin{abstract}
OEIS A299138 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $equal to$ itself lying in $\{1,2,3,4,5,7\}$, and it carries an empirical
...
OEIS A299138 is ``Number of nX4 0..1 arrays with every element equal to 1, 2, 3, 4, 5 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
2, 64, 899, 11179, 143548, 1850266, 23808476, 306389599,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 03 2018 09:30:40, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;12\,a(n-1) + 15\,a(n-2) - 33\,a(n-3) - 170\,a(n-4) - 418\,a(n-5) - 831\,a(n-6) + 290\,a(n-7) + 4188\,a(n-8) + 6777\,a(n-9) + 14211\,a(n-10) + 16195\,a(n-11) + 26645\,a(n-12) - 10951\,a(n-13) - 43014\,a(n-14) + 25645\,a(n-15) + 64072\,a(n-16) - 55702\,a(n-17) - 65256\,a(n-18) - 6799\,a(n-19) + 41979\,a(n-20) + 5773\,a(n-21) - 34173\,a(n-22) - 26481\,a(n-23) - 40556\,a(n-24) - 33028\,a(n-25) - 12415\,a(n-26) + 1169\,a(n-27) + 779\,a(n-28) - 497\,a(n-29) - 106\,a(n-30) + 80\,a(n-31) + 63\,a(n-32) + 14\,a(n-33)
\end{equation}
for all $n>33$.
...
has score in $\{1,2,3,4,5,7\}$. The entry also fixes the top-left entry to be $0$; that is a condition on the first row alone, so it restricts the start vector and nothing else.
...
\begin{itemize}
\item $\mathbf{s}(r,s)=1$ when every cell of $r$ has score in $\{1,2,3,4,5,7\}$ \emph{with no row
above $r$} and $r_1=0$, and $0$ otherwise;
\item an edge $(r,s)\to(s,t)$ when every cell of $s$ has score in $\{1,2,3,4,5,7\}$ computed from
$r$, $s$ and $t$;
\item $\mathbf{e}(r,s)=1$ when every cell of $s$ has score in $\{1,2,3,4,5,7\}$ \emph{with no row
...
exactly when every one of its $n$ rows has all scores in $\{1,2,3,4,5,7\}$. Read the sequence as the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A299138.
