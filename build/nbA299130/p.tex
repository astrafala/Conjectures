...
\title{The empirical recurrence for OEIS A299130, proved by transfer matrix}
...
\begin{abstract}
OEIS A299130 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A299130 is ``Number of nX3 0..1 arrays with every element equal to 0, 2, 3, 4, 5 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 13, 30, 149, 576, 2621, 12495, 59426,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 03 2018 09:05:09, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) + 7\,a(n-2) - 27\,a(n-3) - 65\,a(n-4) + 97\,a(n-5) + 118\,a(n-6) - 276\,a(n-7) + 110\,a(n-8) + 516\,a(n-9) - 226\,a(n-10) - 372\,a(n-11) - 12\,a(n-12)
\end{equation}
for all $n>13$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A299130.
