...
\title{The empirical recurrence for OEIS A269273, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A269273 counts arrays over $\{0,\dots,3\}$ subject to a condition on the array as a
...
OEIS A269273 is ``Number of n X 5 0..3 arrays with some element plus some horizontally or antidiagonally adjacent neighbor totalling three exactly once.''. It has offset $1$ and begins
\[
432, 127512, 23549400, 3719884392, 542973139128, 75556007986536, 10181956012212600, 1340897428986116904,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 234*a(n-1) - 14277*a(n-2) + 68796*a(n-3) - 86436*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 21 2019 06:22:43, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A269273.
