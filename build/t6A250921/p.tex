...
\title{The empirical recurrence for OEIS A250921, proved by transfer matrix}
...
\begin{abstract}
OEIS A250921 counts $(n+1)\times3$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A250921 is ``Number of (n+1)X(2+1) 0..2 arrays with no 2X2 subblock having its minimum diagonal element less than its minimum antidiagonal element.''. It has offset $1$ and begins
\[
344, 4148, 50722, 628146, 7811640, 97205912, 1209466635, 15047023115,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 12:51:12, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;27\,a(n-1) - 280\,a(n-2) + 1630\,a(n-3) - 6022\,a(n-4) + 14885\,a(n-5) - 25640\,a(n-6) + 31686\,a(n-7) - 28463\,a(n-8) + 18548\,a(n-9) - 8602\,a(n-10) + 2711\,a(n-11) - 526\,a(n-12) + 48\,a(n-13)
\end{equation}
for all $n>12$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250921.
