...
\title{The empirical recurrence for OEIS A207855, proved by transfer matrix}
...
\begin{abstract}
OEIS A207855 counts arrays over $\{0,\dots,1\}$ of width $5$ that avoid the patterns
$(0,0,0), (0,1,0)$ along one axis and $(0,1,0), (1,0,1)$ along the other, and carries an empirical recurrence of
...
OEIS A207855 is ``Number of nX5 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 1 0 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
15, 225, 1071, 7289, 44121, 279219, 1737981,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:21:48, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;8\,a(n-1) - 20\,a(n-2) + 24\,a(n-3) + 154\,a(n-4) + 164\,a(n-5) + 908\,a(n-6) - 48\,a(n-7) + 2963\,a(n-8) - 8406\,a(n-9) - 32288\,a(n-10) - 41552\,a(n-11) - 64967\,a(n-12) + 27432\,a(n-13) + 54104\,a(n-14) + 636016\,a(n-15) + 805740\,a(n-16) + 103162\,a(n-17) - 1914744\,a(n-18) - 3070336\,a(n-19) - 960103\,a(n-20) + 192624\,a(n-21) + 871096\,a(n-22) - 313232\,a(n-23) + 1362214\,a(n-24) + 2175596\,a(n-25) + 182480\,a(n-26) - 81648\,a(n-27) - 370246\,a(n-28) + 133416\,a(n-29) - 282032\,a(n-30) - 734512\,a(n-31) - 175129\,a(n-32) + 122484\,a(n-33) + 83948\,a(n-34) - 38680\,a(n-35) + 81164\,a(n-36) + 59916\,a(n-37) + 22876\,a(n-38) + 1920\,a(n-39) - 22169\,a(n-40) + 6538\,a(n-41) - 1744\,a(n-42) - 4288\,a(n-43) + 141\,a(n-44) - 560\,a(n-45) + 120\,a(n-46) - 50\,a(n-48) + 42\,a(n-49) + a(n-52)
\end{equation}
for all $n>51$. 
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207855.
