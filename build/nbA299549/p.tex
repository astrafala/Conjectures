...
\title{The empirical recurrence for OEIS A299549, proved by transfer matrix}
...
\begin{abstract}
OEIS A299549 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A299549 is ``Number of nX3 0..1 arrays with every element equal to 2, 3, 4, 5, 6 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
0, 3, 9, 31, 166, 752, 3739, 18300,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 12 2018 20:22:01, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) + 6\,a(n-2) - 28\,a(n-3) - 27\,a(n-4) + 62\,a(n-5) + 16\,a(n-6) - 89\,a(n-7) + 49\,a(n-8) + 72\,a(n-9) - 56\,a(n-10) + 5\,a(n-11) + 10\,a(n-12) - 8\,a(n-13)
\end{equation}
for all $n>14$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A299549.
