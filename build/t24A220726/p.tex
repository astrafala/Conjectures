...
\title{The empirical recurrence for OEIS A220726, proved by transfer matrix}
...
\begin{abstract}
OEIS A220726 counts the ways of linking the cells of a grid $2$ cells wide, each cell either to
...
\[
1, 2, 7, 21, 68, 221, 717, 2330,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) + a(n-2) - 2*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 02 2018 15:20:00, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A220726.
