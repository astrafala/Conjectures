...
\title{The empirical recurrence for OEIS A207414, proved by transfer matrix}
...
\begin{abstract}
OEIS A207414 counts arrays over $\{0,\dots,1\}$ of width $3$ that avoid the patterns
$(0,0,1), (0,1,0)$ along one axis and $(0,1,1), (1,0,1)$ along the other, and carries an empirical recurrence of
order $16$ contributed by R.~H.~Hardin. It is true. The patterns have length $3$, so
...
$\mathbf{1}^{\!\top}P^{\,n-2-16}q(P)\mathbf{1}$, which vanishes identically
...
OEIS A207414 is ``Number of nX3 0..1 arrays avoiding 0 0 1 and 0 1 0 horizontally and 0 1 1 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
6, 36, 92, 241, 720, 1889, 4719,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 13:52:08, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) - 4\,a(n-2) + 7\,a(n-3) - 21\,a(n-4) + 7\,a(n-5) - a(n-6) + 33\,a(n-7) + 7\,a(n-8) - 13\,a(n-9) - 35\,a(n-10) - 7\,a(n-11) + 9\,a(n-12) + 17\,a(n-13) + 4\,a(n-14) - 3\,a(n-15) - 3\,a(n-16)
\end{equation}
for all $n>15$. 
...
$(0,0,1), (0,1,0)$ as $3$ consecutive entries. There are $6$ admissible rows; that condition
...
$a(n)-\sum_i c_i a(n-i)=u_{\,n-2-16}$ whenever $n-16\ge2$. Hence
\eqref{eq:conj} holds for every $n>t$ exactly when $u_j=0$ for every
$j>t-2-16$. Moreover $(u_j)$ satisfies the monic linear recurrence whose
...
$P^{\,n-2-16}$ gives the identity. The equivalence follows by letting the exponent
...
\begin{proof}
The vector $q(P)\mathbf{1}\in\mathbb{Z}^{S}$ was formed by $16$ matrix--vector
products in exact integer arithmetic and the $u_j$ evaluated in turn. They vanish from the
index corresponding to $n=15+1$ onwards, and the run was continued past $S$ consecutive
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207414.
