...
\title{The empirical recurrence for OEIS A298142, proved by transfer matrix}
...
\begin{abstract}
OEIS A298142 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A298142 is ``Number of nX4 0..1 arrays with every element equal to 2, 3, 6 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
0, 1, 2, 8, 13, 27, 43, 104,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 13 2018 11:22:18, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 2\,a(n-2) - 4\,a(n-3) + 3\,a(n-4) - 10\,a(n-6) - 2\,a(n-7) - 4\,a(n-8) + 11\,a(n-9) + 8\,a(n-10) - 2\,a(n-11) + 2\,a(n-12) - 2\,a(n-13) - 2\,a(n-14) + 12\,a(n-15) - a(n-16) - 6\,a(n-17) + a(n-18) - 4\,a(n-19) + a(n-21)
\end{equation}
for all $n>26$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A298142.
