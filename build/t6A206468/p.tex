...
\title{The empirical recurrence for OEIS A206468, proved by transfer matrix}
...
\begin{abstract}
OEIS A206468 counts $(n+1)\times5$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A206468 is ``Number of (n+1)X5 0..2 arrays with every 2X2 subblock having zero permanent.''. It has offset $1$ and begins
\[
1849, 106891, 1896129, 68352739, 1693734025, 52552339515, 1457044540561, 43214597865811,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 39*a(n-1) -11348*a(n-3) +76272*a(n-4) +429792*a(n-5) -3994496*a(n-6) +37171200*a(n-8) -43614208*a(n-9)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 12:56:45, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;39\,a(n-1) - 11348\,a(n-3) + 76272\,a(n-4) + 429792\,a(n-5) - 3994496\,a(n-6) + 37171200\,a(n-8) - 43614208\,a(n-9)
\end{equation}
for all $n>8$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206468.
