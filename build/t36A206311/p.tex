...
\title{The empirical recurrence for OEIS A206311, proved by transfer matrix}
...
\begin{abstract}
OEIS A206311 counts arrays over $\{0,\dots,3\}$ under a condition on the number of clockwise edge increases
...
OEIS A206311 is ``Number of (n+1)X2 0..3 arrays with the number of clockwise edge increases in every 2X2 subblock equal to two, and every 2X2 determinant nonzero.''. It has offset $1$ and begins
\[
112, 873, 6831, 53463, 418468, 3275406, 25637095, 200665376,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 5*a(n-1) +21*a(n-2) +13*a(n-3) -31*a(n-4) -17*a(n-5) +34*a(n-6) +2*a(n-7) -9*a(n-8) -a(n-9)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 12:50:26, revision 9) this is still
...
subblock; the entry's first term is $112$, which the model
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) + 21\,a(n-2) + 13\,a(n-3) - 31\,a(n-4) - 17\,a(n-5) + 34\,a(n-6) + 2\,a(n-7) - 9\,a(n-8) - a(n-9)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206311.
