...
\title{The empirical recurrence for OEIS A304225, proved by transfer matrix}
...
\begin{abstract}
OEIS A304225 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A304225 is ``Number of nX3 0..1 arrays with every element unequal to 0, 1, 2 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
4, 3, 5, 6, 11, 16, 22, 33,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +a(n-3) for n>5
\end{quote}
As of the ``Last modified'' line on the live entry (May 08 2018 11:03:35, revision
...
compared against the entry's DATA at every one of the $40$ published indices; they
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A304225.
