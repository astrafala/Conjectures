...
\title{The empirical recurrence for OEIS A210080, proved by transfer matrix}
...
\begin{abstract}
OEIS A210080 counts arrays of width $3$ whose every $2\times2$ subblock holds a
...
OEIS A210080 is ``Number of (n+1)X3 0..3 arrays containing all values 0..3 with every 2X2 subblock having one, three or four distinct values, and new values 0..3 introduced in row major order.''. It has offset $1$ and begins
\[
51, 2384, 82691, 2718363, 88297042, 2860160370, 92588511903, 2996810715343,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 42*a(n-1) -322*a(n-2) +274*a(n-3) +1887*a(n-4) -3124*a(n-5) +76*a(n-6) +1168*a(n-7)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 15:41:49, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;42\,a(n-1) - 322\,a(n-2) + 274\,a(n-3) + 1887\,a(n-4) - 3124\,a(n-5) + 76\,a(n-6) + 1168\,a(n-7)
\]
for every $n>7$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A210080.
