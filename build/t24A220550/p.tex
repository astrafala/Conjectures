...
\title{The empirical recurrence for OEIS A220550, proved by transfer matrix}
...
\begin{abstract}
OEIS A220550 counts the ways of linking the cells of a grid $5$ cells wide, each cell either to
...
OEIS A220550 is ``Number of ways to reciprocally link elements of an nX5 array either to themselves or to exactly one horizontal, vertical or antidiagonal neighbor.''. It has offset $1$ and begins
\[
8, 401, 14556, 565061, 21668208, 832899775, 32001129185, 1229633337183,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 18:50:02, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;21\,a(n-1) + 607\,a(n-2) + 2818\,a(n-3) - 13422\,a(n-4) - 102307\,a(n-5) + 102787\,a(n-6) + 1377367\,a(n-7) - 625026\,a(n-8) - 9368158\,a(n-9) + 6655110\,a(n-10) + 30101928\,a(n-11) - 31218870\,a(n-12) - 45617582\,a(n-13) + 65294634\,a(n-14) + 29766481\,a(n-15) - 68435485\,a(n-16) - 4100689\,a(n-17) + 40652394\,a(n-18) - 5180290\,a(n-19) - 14692966\,a(n-20) + 3231432\,a(n-21) + 3351718\,a(n-22) - 849954\,a(n-23) - 490034\,a(n-24) + 118041\,a(n-25) + 45619\,a(n-26) - 8829\,a(n-27) - 2574\,a(n-28) + 334\,a(n-29) + 79\,a(n-30) - 5\,a(n-31) - a(n-32)
\]
for every $n>31$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A220550.
