...
\title{The empirical recurrence for OEIS A253520, proved by transfer matrix}
...
\begin{abstract}
OEIS A253520 counts the arrays over $\{0,\dots,2\}$ whose $2\times2$ subblocks carry a
...
OEIS A253520 is ``Number of (n+1)X(4+1) 0..2 arrays with every 2X2 subblock diagonal minimum minus antidiagonal minimum nondecreasing horizontally and diagonal maximum minus antidiagonal maximum nondecreasing vertically.''. It has offset $1$ and begins
\[
9623, 42476, 84684, 162815, 370028, 930046, 2475610, 6886675,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 11*a(n-1) -51*a(n-2) +131*a(n-3) -205*a(n-4) +201*a(n-5) -121*a(n-6) +41*a(n-7) -6*a(n-8) for n>16
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 14:05:22, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;11\,a(n-1) - 51\,a(n-2) + 131\,a(n-3) - 205\,a(n-4) + 201\,a(n-5) - 121\,a(n-6) + 41\,a(n-7) - 6\,a(n-8)
\]
for every $n>16$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253520.
