...
\title{The empirical recurrence for OEIS A253396, proved by transfer matrix}
...
\begin{abstract}
OEIS A253396 counts the arrays over $\{0,\dots,1\}$ whose $2\times2$ subblocks carry a
...
so a pair of consecutive array rows is a state, the count is a walk count on $S=704$ of them,
...
OEIS A253396 is ``Number of (n+1)X(7+1) 0..1 arrays with every 2X2 subblock antidiagonal maximum minus diagonal minimum nondecreasing horizontally and diagonal maximum minus antidiagonal minimum nondecreasing vertically.''. It has offset $1$ and begins
\[
704, 391, 520, 823, 1269, 1855, 2726, 3810,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) -5*a(n-2) +5*a(n-4) -4*a(n-5) +a(n-6) for n>18
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 14:01:43, revision 6) this is still
...
\]
on the $S=704$ admissible pairs. In particular $a$ is $C$-finite. The alignment of the walk
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253396.
