...
\title{The empirical recurrence for OEIS A316284, proved by transfer matrix}
...
\begin{abstract}
OEIS A316284 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A316284 is ``Number of n X 3 0..1 arrays with every element unequal to 0, 1, 2, 3, 6 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
4, 21, 42, 125, 361, 987, 2840, 8177,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) +a(n-2) +6*a(n-3) -23*a(n-4) -22*a(n-5) +7*a(n-6) +27*a(n-7) +24*a(n-8) -18*a(n-9) -10*a(n-10) for n>12.
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 03 2022 22:36:52, revision
6) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + a(n-2) + 6\,a(n-3) - 23\,a(n-4) - 22\,a(n-5) + 7\,a(n-6) + 27\,a(n-7) + 24\,a(n-8) - 18\,a(n-9) - 10\,a(n-10)
\end{equation}
for all $n>11$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A316284.
