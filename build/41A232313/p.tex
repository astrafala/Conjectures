...
\title{The empirical recurrence for OEIS A232313, proved by transfer matrix}
...
\begin{abstract}
OEIS A232313 counts arrays of width $6$ over $\{0,\dots,1\}$ under a condition on each cell
...
OEIS A232313 is ``Number of (n+1)X(5+1) 0..1 arrays with every element equal to some horizontal or antidiagonal neighbor, with top left element zero.''. It has offset $1$ and begins
\[
169, 5241, 164014, 5142441, 161243887, 5055954492, 158534446141, 4971005036586,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 07:17:51, revision 10) this is still
...
$169$, which the model reproduces along with every later term. That is the cheapest check
...
\begin{theorem}
\[
a(n)\;=\;37\,a(n-1) - 184\,a(n-2) + 218\,a(n-3) + 76\,a(n-4) - 88\,a(n-5) - 273\,a(n-6) + 168\,a(n-7) + 210\,a(n-8) - 81\,a(n-9) - 107\,a(n-10) + 35\,a(n-11) - a(n-12)
\]
for every $n>13$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232313.
