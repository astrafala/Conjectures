...
\title{The empirical recurrence for OEIS A189438, proved by transfer matrix}
...
\begin{abstract}
OEIS A189438 counts the permutations of the cells of an $n\times6$ array in which every cell
...
That makes $a$ a walk count on $S=160$ states, hence $C$-finite, and whether the published
...
OEIS A189438 is ``Number of 6Xn array permutations with each element not moving, or moving one space N, SW or SE.''. It has offset $1$ and begins
\[
1, 41, 367, 4653, 52241, 606201, 6944573, 79826592,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 05:13:34, revision 9) this is still
...
cell by $\delta_16+\delta_2$ places in that order, so every image lies between $lo=-5$ and
...
$k+-5,\dots,k+7$ are taken --- a subset of a set of size $13$, and nothing else.
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=160,
\]
...
\begin{theorem}
\[
a(n)\;=\;15\,a(n-1) - 23\,a(n-2) - 262\,a(n-3) + 680\,a(n-4) + 550\,a(n-5) - 1875\,a(n-6) + 1927\,a(n-7) - 3037\,a(n-8) + 822\,a(n-9) - 652\,a(n-10) + 98\,a(n-11) - 33\,a(n-12) + 3\,a(n-13) + a(n-14)
\]
for every $n>13$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A189438.
