...
\title{The empirical recurrence for OEIS A234137, proved by transfer matrix}
...
\begin{abstract}
OEIS A234137 counts $(n+1)\times6$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A234137 is ``Number of (n+1) X (5+1) 0..3 arrays with every 2 X 2 subblock having the sum of the absolute values of all six edge and diagonal differences equal to 9.''. It has offset $1$ and begins
\[
1280, 1544, 1992, 2984, 4904, 9512, 19368, 45224,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) + 8*a(n-2) - 30*a(n-3) + 4*a(n-4) + 48*a(n-5) - 32*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2026 15:30:10, revision 15) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 8\,a(n-2) - 30\,a(n-3) + 4\,a(n-4) + 48\,a(n-5) - 32\,a(n-6)
\end{equation}
for all $n>6$.
...
|\beta-\alpha|+|\delta-\beta|+|\gamma-\delta|+|\alpha-\gamma|+|\delta-\alpha|+|\gamma-\beta|\;=\;9,
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234137.
