...
\title{The empirical recurrence for OEIS A251265, proved by transfer matrix}
...
\begin{abstract}
OEIS A251265 counts $(n+1)\times6$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A251265 is ``Number of (n+1)X(5+1) 0..1 arrays with no 2X2 subblock having x11-x00 less than x10-x01.''. It has offset $1$ and begins
\[
247, 1775, 13052, 100843, 790734, 6247708, 49523566, 393172015,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 10:19:51, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;11\,a(n-1) + 25\,a(n-2) - 557\,a(n-3) + 417\,a(n-4) + 10537\,a(n-5) - 19095\,a(n-6) - 98114\,a(n-7) + 246975\,a(n-8) + 493227\,a(n-9) - 1642630\,a(n-10) - 1333320\,a(n-11) + 6536456\,a(n-12) + 1447446\,a(n-13) - 16694903\,a(n-14) + 2009237\,a(n-15) + 28399782\,a(n-16) - 9693504\,a(n-17) - 32722458\,a(n-18) + 16381621\,a(n-19) + 25543750\,a(n-20) - 16165287\,a(n-21) - 13265317\,a(n-22) + 10184940\,a(n-23) + 4371851\,a(n-24) - 4166286\,a(n-25) - 812484\,a(n-26) + 1089550\,a(n-27) + 50756\,a(n-28) - 174763\,a(n-29) + 8480\,a(n-30) + 15983\,a(n-31) - 1709\,a(n-32) - 738\,a(n-33) + 103\,a(n-34) + 13\,a(n-35) - 2\,a(n-36)
\end{equation}
for all $n>35$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251265.
