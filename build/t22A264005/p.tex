...
\title{The empirical recurrence for OEIS A264005, proved by transfer matrix}
...
\begin{abstract}
OEIS A264005 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=3$ columns in which
...
OEIS A264005 is ``Number of (2+1)X(n+1) arrays of permutations of 0..n*3+2 with each element having index change (+-,+-) 0,0 1,2 or 1,0.''. It has offset $1$ and begins
\[
9, 99, 1089, 8679, 69169, 568343, 4669921, 38152455,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 10 2015 10:20:13, revision 6) this is still
...
\[
(i-h_i,\,j-h_j)\;\in\;\{(-2,-1),\ (-2,1),\ (0,-1),\ (0,0),\ (0,1),\ (2,-1),\ (2,1)\},
\]
...
\begin{theorem}
\[
a(n)\;=\;9\,a(n-1) - 62\,a(n-3) + 108\,a(n-4) - 456\,a(n-5) - 800\,a(n-6) + 9808\,a(n-7) - 8032\,a(n-8) - 256\,a(n-9) + 12800\,a(n-10) - 20992\,a(n-11) + 27648\,a(n-12) - 24576\,a(n-13) + 32768\,a(n-15) - 65536\,a(n-16)
\]
for every $n>14$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264005.
