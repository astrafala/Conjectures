...
\title{The empirical recurrence for OEIS A208071, proved by transfer matrix}
...
\begin{abstract}
OEIS A208071 counts arrays over $\{0,\dots,1\}$ of width $6$ that avoid the patterns
...
OEIS A208071 is ``Number of 6 X n 0..1 arrays avoiding 0 0 0 and 1 1 1 horizontally and 0 0 1 and 0 1 1 vertically.''. It has offset
$1$ and begins
\[
16, 256, 324, 1764, 7056, 26244, 108900,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) + 4*a(n-2) + 17*a(n-3) - 2*a(n-4) - 4*a(n-5) - 16*a(n-6) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 27 2018 15:30:04, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208071.
