...
\title{The empirical recurrence for OEIS A234084, proved by transfer matrix}
...
\begin{abstract}
OEIS A234084 counts $(n+1)\times2$ arrays over $\{0,\dots,5\}$ subject to a condition imposed on
...
OEIS A234084 is ``Number of (n+1)X(1+1) 0..5 arrays with every 2X2 subblock having the sum of the absolute values of all six edge and diagonal differences equal to 10.''. It has offset $1$ and begins
\[
144, 828, 4720, 28328, 171136, 1058160, 6567360, 41201312,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 4*a(n-1) +42*a(n-2) -112*a(n-3) -552*a(n-4) +672*a(n-5) +2656*a(n-6) -64*a(n-7) -2176*a(n-8) -768*a(n-9)
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 09:10:05, revision 7) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) + 42\,a(n-2) - 112\,a(n-3) - 552\,a(n-4) + 672\,a(n-5) + 2656\,a(n-6) - 64\,a(n-7) - 2176\,a(n-8) - 768\,a(n-9)
\end{equation}
for all $n>9$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234084.
