...
\title{The empirical recurrence for OEIS A283721, proved by transfer matrix}
...
\begin{abstract}
OEIS A283721 counts $n\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
walk, and $a(n)$ is a walk count on $S=116$ vertices, which is $C$-finite. Whether the
...
OEIS A283721 is ``Number of n X 3 0..1 arrays with no 1 equal to more than two of its horizontal, diagonal and antidiagonal neighbors, with the exception of exactly one element.''. It has offset $1$ and begins
\[
0, 10, 159, 1304, 9819, 69972, 478164, 3182364,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 05 2025 14:37:41, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;10\,a(n-1) - 21\,a(n-2) + 8\,a(n-3) - 162\,a(n-4) + 38\,a(n-5) - 270\,a(n-6) + 654\,a(n-7) + 231\,a(n-8) + 1484\,a(n-9) - 390\,a(n-10) - 508\,a(n-11) - 2885\,a(n-12) - 2464\,a(n-13) - 316\,a(n-14) + 1760\,a(n-15) + 4524\,a(n-16) + 1888\,a(n-17) - 96\,a(n-18) - 1920\,a(n-19) - 1600\,a(n-20)
\]
for every $n>20$.
\end{theorem}
...
integers vanish from the index corresponding to $n=20+1$ onwards, and the run was
continued until the working vector was identically zero, which settles all larger $j$ at once.
By Lemma~\ref{lem:crit} the recurrence holds for every $n>20$.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A283721.
