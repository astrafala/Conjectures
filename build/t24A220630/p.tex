...
\title{The empirical recurrence for OEIS A220630, proved by transfer matrix}
...
\begin{abstract}
OEIS A220630 counts the ways of linking the cells of a grid $6$ cells wide, each cell either to
...
OEIS A220630 is ``Number of ways to reciprocally link elements of an nX6 array either to themselves or to exactly two horizontal or antidiagonal neighbors.''. It has offset $1$ and begins
\[
1, 16, 158, 1665, 17527, 183961, 1932695, 20301254,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 7*a(n-1) +31*a(n-2) +57*a(n-3) +43*a(n-4) -3*a(n-5) -36*a(n-6) +19*a(n-7) -6*a(n-8) +a(n-9)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 18:55:28, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-1) + 31\,a(n-2) + 57\,a(n-3) + 43\,a(n-4) - 3\,a(n-5) - 36\,a(n-6) + 19\,a(n-7) - 6\,a(n-8) + a(n-9)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A220630.
