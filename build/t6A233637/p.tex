...
\title{The empirical recurrence for OEIS A233637, proved by transfer matrix}
...
\begin{abstract}
OEIS A233637 counts $(n+1)\times2$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A233637 is ``Number of (n+1) X (1+1) 0..2 arrays with every 2 X 2 subblock having the sum of the squares of the edge differences equal to 2.''. It has offset $1$ and begins
\[
24, 90, 324, 1188, 4320, 15768, 57456, 209520,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) + 6*a(n-2).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 11 2018 09:01:55, revision 8) the statement is
...
(\beta-\alpha)^2+(\delta-\beta)^2+(\gamma-\delta)^2+(\alpha-\gamma)^2=2,
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A233637.
