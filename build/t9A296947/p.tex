...
\title{The empirical recurrence for OEIS A296947, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A296947 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A296947 is ``Number of n X 3 0..1 arrays with each 1 adjacent to 1, 3 or 5 king-move neighboring 1s.''. It has offset $1$ and begins
\[
3, 16, 45, 135, 544, 1765, 5763, 20811,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 02 2025 10:03:11, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + a(n-2) + 16\,a(n-3) - 46\,a(n-4) - 20\,a(n-5) - 19\,a(n-6) + 148\,a(n-7) + 64\,a(n-8) - 58\,a(n-9) - 180\,a(n-10) + 9\,a(n-11) + 70\,a(n-12) + 35\,a(n-13) - 29\,a(n-14) - 13\,a(n-15) + 7\,a(n-16) + 6\,a(n-17) + a(n-18) - 2\,a(n-19)
\end{equation}
for all $n>20$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A296947.
