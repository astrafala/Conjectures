...
\title{The empirical recurrence for OEIS A296984, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A296984 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A296984 is ``Number of n X 2 0..1 arrays with each 1 adjacent to 3, 4 or 5 king-move neighboring 1s.''. It has offset $1$ and begins
\[
1, 2, 4, 7, 14, 33, 77, 185,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) + a(n-2) + 3*a(n-3) - 4*a(n-4) - 2*a(n-5) - 4*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 25 2019 14:11:40, revision 7) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A296984.
