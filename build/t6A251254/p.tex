...
\title{The empirical recurrence for OEIS A251254, proved by transfer matrix}
...
\begin{abstract}
OEIS A251254 counts $(n+1)\times5$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A251254 is ``Number of (n+1)X(4+1) 0..1 arrays with every 2X2 subblock having a single 1 or two 1s on the same edge.''. It has offset $1$ and begins
\[
84, 446, 1770, 9130, 38332, 192442, 836546, 4112126,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:12:56, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) + 21\,a(n-2) - 115\,a(n-3) - 95\,a(n-4) + 706\,a(n-5) + 69\,a(n-6) - 1492\,a(n-7) + 208\,a(n-8) + 987\,a(n-9) - 228\,a(n-10) - 111\,a(n-11) + 28\,a(n-12)
\end{equation}
for all $n>12$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251254.
