...
\title{The empirical recurrence for OEIS A208161, proved by transfer matrix}
...
\begin{abstract}
OEIS A208161 counts arrays over $\{0,\dots,1\}$ of width $5$ that avoid the patterns
...
OEIS A208161 is ``Number of nX5 0..1 arrays avoiding 0 0 0 and 1 0 1 horizontally and 0 0 1 and 0 1 0 vertically.''. It has offset
$1$ and begins
\[
13, 169, 699, 2920, 14446, 63031, 258952,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:40:43, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208161.
