...
\title{The empirical recurrence for OEIS A298503, proved by transfer matrix}
...
\begin{abstract}
OEIS A298503 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A298503 is ``Number of nX3 0..1 arrays with every element equal to 0, 2, 3, 4 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 12, 10, 50, 148, 493, 2093, 8047,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 20 2018 09:08:31, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) - 4\,a(n-2) + 5\,a(n-3) - 25\,a(n-4) + 24\,a(n-5) - 23\,a(n-6) + 21\,a(n-7) + 44\,a(n-8) - 69\,a(n-9) - 5\,a(n-10) + 48\,a(n-11) - 26\,a(n-12) + 22\,a(n-13) - 10\,a(n-14) - 8\,a(n-15) + 4\,a(n-16)
\end{equation}
for all $n>17$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A298503.
