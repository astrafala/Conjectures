...
\title{The empirical column recurrences for the table OEIS A234140}
...
\begin{abstract}
OEIS A234140 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A234140 is ``T(n,k)=Number of (n+1)X(k+1) 0..3 arrays with every 2X2 subblock having the sum of the absolute values of all six edge and diagonal differences equal to 9.''. It has offset $1$, is
read by antidiagonals, and begins
\[
32, 80, 80, 192, 152, 192, 512, 296,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 09:13:32, revision 6) these are still
...
The sequence is ``Number of (n+1)X(2) 0..3 arrays with every 2X2 subblock having the sum of the absolute values of all six edge and diagonal differences equal to 9.''. Its rows are the vertices of a digraph on
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234140.
