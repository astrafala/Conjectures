...
\title{The empirical recurrence for OEIS A206467, proved by transfer matrix}
...
\begin{abstract}
OEIS A206467 counts $(n+1)\times4$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A206467 is ``Number of (n+1) X 4 0..2 arrays with every 2 X 2 subblock having zero permanent.''. It has offset $1$ and begins
\[
441, 11025, 110889, 1896129, 23707161, 356190129, 4803737481, 69030731169,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 15*a(n-1) + 54*a(n-2) - 1116*a(n-3) + 1728*a(n-4) + 10368*a(n-5) - 20736*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 16 2018 16:03:00, revision 10) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;15\,a(n-1) + 54\,a(n-2) - 1116\,a(n-3) + 1728\,a(n-4) + 10368\,a(n-5) - 20736\,a(n-6)
\end{equation}
for all $n>5$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206467.
