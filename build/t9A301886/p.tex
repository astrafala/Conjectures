...
\title{The empirical recurrence for OEIS A301886, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A301886 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A301886 is ``Number of 3Xn 0..1 arrays with every element equal to 0, 1 or 3 horizontally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
4, 13, 29, 58, 125, 331, 823, 2086,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 28 2018 11:00:31, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 3\,a(n-3) + a(n-4) - a(n-5) + 10\,a(n-6) - 13\,a(n-7) - a(n-8) - 19\,a(n-9) - 10\,a(n-10) - 8\,a(n-11) - 30\,a(n-12) + 8\,a(n-13) - 10\,a(n-14) + 19\,a(n-15) - a(n-16) + 13\,a(n-17) + 10\,a(n-18) + a(n-19) + a(n-20) - 3\,a(n-21) - 2\,a(n-23) - a(n-24)
\end{equation}
for all $n>25$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A301886.
