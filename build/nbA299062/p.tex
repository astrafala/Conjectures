...
\title{The empirical recurrence for OEIS A299062, proved by transfer matrix}
...
\begin{abstract}
OEIS A299062 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A299062 is ``Number of nX3 0..1 arrays with every element equal to 1, 2, 3, 4, 5 or 6 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 18, 141, 993, 7330, 54106, 398654, 2937795,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 6*a(n-1) +8*a(n-2) +14*a(n-3) +11*a(n-4) -4*a(n-5) +3*a(n-6) +2*a(n-7) -5*a(n-8) -2*a(n-9) for n>10
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 01 2018 14:50:00, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) + 8\,a(n-2) + 14\,a(n-3) + 11\,a(n-4) - 4\,a(n-5) + 3\,a(n-6) + 2\,a(n-7) - 5\,a(n-8) - 2\,a(n-9)
\end{equation}
for all $n>9$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A299062.
