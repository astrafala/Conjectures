...
\title{The empirical recurrence for OEIS A228682, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A228682 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A228682 is ``Number of nX7 binary arrays with no two ones adjacent horizontally, diagonally or antidiagonally.''. It has offset $1$ and begins
\[
34, 508, 8832, 152048, 2644336, 46125216, 806190208, 14105294112,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 04 2025 00:05:36, revision 9) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A228682.
