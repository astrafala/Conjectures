...
\title{The empirical recurrence for OEIS A283637, proved by transfer matrix}
...
\begin{abstract}
OEIS A283637 counts $4\times n$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A283637 is ``Number of 4Xn 0..1 arrays with no 1 equal to more than one of its horizontal, diagonal and antidiagonal neighbors, with the exception of exactly two elements.''. It has offset $1$ and begins
\[
0, 28, 388, 7742, 61592, 700534, 6345928, 54063960,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 12 2017 14:37:53, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) + 45\,a(n-2) - 34\,a(n-3) - 1527\,a(n-4) - 4200\,a(n-5) + 5806\,a(n-6) + 79440\,a(n-7) + 256035\,a(n-8) + 556862\,a(n-9) + 773985\,a(n-10) + 907686\,a(n-11) + 67578\,a(n-12) - 154770\,a(n-13) - 3028137\,a(n-14) - 564902\,a(n-15) - 5353965\,a(n-16) + 3950340\,a(n-17) - 4944390\,a(n-18) + 9675900\,a(n-19) - 5062575\,a(n-20) + 8559650\,a(n-21) - 5818125\,a(n-22) + 3153750\,a(n-23) - 3048625\,a(n-24)
\]
for every $n>26$.
\end{theorem}
...
integers vanish from the index corresponding to $n=26+1$ onwards, and the run was
continued until the working vector was identically zero, which settles all larger $j$ at once.
By Lemma~\ref{lem:crit} the recurrence holds for every $n>26$.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A283637.
