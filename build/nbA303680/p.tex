...
\title{The empirical recurrence for OEIS A303680, proved by transfer matrix}
...
\begin{abstract}
OEIS A303680 counts $6$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A303680 is ``Number of nX6 0..1 arrays with every element unequal to 0, 1 or 3 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
13, 49, 39, 64, 110, 177, 245, 335,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +a(n-4) +a(n-7) for n>12
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 28 2018 09:22:03, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + a(n-4) + a(n-7)
\end{equation}
for all $n>11$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A303680.
