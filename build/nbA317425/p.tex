...
\title{The empirical recurrence for OEIS A317425, proved by transfer matrix}
...
\begin{abstract}
OEIS A317425 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $different from$ itself lying in $\{0,1,3,5,6,7,8\}$, and it carries an empirical
...
OEIS A317425 is ``Number of nX4 0..1 arrays with every element unequal to 0, 1, 3, 5, 6, 7 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
5, 21, 32, 97, 279, 640, 1666, 4365,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 27 2018 22:01:14, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 18\,a(n-3) - 28\,a(n-4) - 4\,a(n-5) - 129\,a(n-6) + 159\,a(n-7) + 41\,a(n-8) + 501\,a(n-9) - 497\,a(n-10) - 175\,a(n-11) - 1270\,a(n-12) + 972\,a(n-13) + 389\,a(n-14) + 2411\,a(n-15) - 1192\,a(n-16) - 426\,a(n-17) - 3509\,a(n-18) + 828\,a(n-19) + 91\,a(n-20) + 3754\,a(n-21) - 24\,a(n-22) + 367\,a(n-23) - 2841\,a(n-24) - 779\,a(n-25) - 650\,a(n-26) + 1159\,a(n-27) + 780\,a(n-28) + 393\,a(n-29) - 90\,a(n-30) - 257\,a(n-31) - 82\,a(n-32) - 35\,a(n-33) + 11\,a(n-34) + 11\,a(n-35) + 15\,a(n-36) + 18\,a(n-37) - a(n-38) - 3\,a(n-39) - 3\,a(n-40)
\end{equation}
for all $n>40$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A317425.
