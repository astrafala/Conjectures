...
\title{The empirical recurrence for OEIS A297508, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297508 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A297508 is ``Number of 3 X n 0..1 arrays with every 1 horizontally, diagonally or antidiagonally adjacent to 1 or 2 neighboring 1s.''. It has offset $1$ and begins
\[
1, 29, 110, 314, 1829, 8803, 34757, 157673,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) + a(n-2) + 32*a(n-3) - 15*a(n-4) - 65*a(n-5) - 74*a(n-6) + 56*a(n-7) + 24*a(n-8) - 3*a(n-9) + 12*a(n-10).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 28 2019 16:27:48, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + a(n-2) + 32\,a(n-3) - 15\,a(n-4) - 65\,a(n-5) - 74\,a(n-6) + 56\,a(n-7) + 24\,a(n-8) - 3\,a(n-9) + 12\,a(n-10)
\end{equation}
for all $n>11$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297508.
