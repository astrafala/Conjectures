...
\title{The empirical recurrence for OEIS A299550, proved by transfer matrix}
...
\begin{abstract}
OEIS A299550 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $equal to$ itself lying in $\{2,3,4,5,6,8\}$, and it carries an empirical
...
OEIS A299550 is ``Number of nX4 0..1 arrays with every element equal to 2, 3, 4, 5, 6 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
0, 6, 31, 220, 2034, 17565, 160089, 1456436,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 12 2018 20:23:01, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;9\,a(n-1) + 25\,a(n-2) - 192\,a(n-3) - 422\,a(n-4) + 1520\,a(n-5) + 3746\,a(n-6) - 5878\,a(n-7) - 14143\,a(n-8) + 10086\,a(n-9) + 25736\,a(n-10) - 9714\,a(n-11) - 23623\,a(n-12) + 28162\,a(n-13) - 20177\,a(n-14) - 78514\,a(n-15) + 74384\,a(n-16) - 3735\,a(n-17) + 61742\,a(n-18) - 245675\,a(n-19) + 588540\,a(n-20) - 584889\,a(n-21) + 393834\,a(n-22) - 83403\,a(n-23) - 420316\,a(n-24) + 666471\,a(n-25) - 659704\,a(n-26) + 484095\,a(n-27) - 167364\,a(n-28) - 56108\,a(n-29) + 130154\,a(n-30) - 58937\,a(n-31) + 40791\,a(n-32) - 21746\,a(n-33) - 467\,a(n-34) - 3163\,a(n-35) + 3110\,a(n-36) - 492\,a(n-37)
\end{equation}
for all $n>37$.
...
has score in $\{2,3,4,5,6,8\}$. The entry also fixes the top-left entry to be $0$; that is a condition on the first row alone, so it restricts the start vector and nothing else.
...
\begin{itemize}
\item $\mathbf{s}(r,s)=1$ when every cell of $r$ has score in $\{2,3,4,5,6,8\}$ \emph{with no row
above $r$} and $r_1=0$, and $0$ otherwise;
\item an edge $(r,s)\to(s,t)$ when every cell of $s$ has score in $\{2,3,4,5,6,8\}$ computed from
$r$, $s$ and $t$;
\item $\mathbf{e}(r,s)=1$ when every cell of $s$ has score in $\{2,3,4,5,6,8\}$ \emph{with no row
...
exactly when every one of its $n$ rows has all scores in $\{2,3,4,5,6,8\}$. Read the sequence as the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A299550.
