...
\title{The empirical recurrence for OEIS A266102, proved by transfer matrix}
...
\begin{abstract}
OEIS A266102 counts arrays of width $2$ in which every entry is equal to the NUMBER of its own
...
OEIS A266102 is ``Number of 2Xn integer arrays with each element equal to the number of horizontal and antidiagonal neighbors exactly one smaller than itself.''. It has offset $1$ and begins
\[
1, 5, 13, 36, 100, 233, 680, 2201,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 21 2015 08:21:25, revision 4) this is still
...
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=190.
\]
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) - a(n-2) + 6\,a(n-3) + 4\,a(n-4) - 8\,a(n-5) - 15\,a(n-6) - 135\,a(n-7) - 149\,a(n-8) - 34\,a(n-9) + 87\,a(n-10) + 139\,a(n-11) + 59\,a(n-12) - 2\,a(n-13) - 15\,a(n-14) - 9\,a(n-15) - a(n-16)
\]
for every $n>19$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A266102.
