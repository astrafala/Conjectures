...
\title{The empirical recurrence for OEIS A233812, proved by transfer matrix}
...
\begin{abstract}
OEIS A233812 counts $(n+1)\times3$ arrays over $\{0,\dots,5\}$ subject to a condition imposed on
every $2\times2$ subblock, and carries an empirical recurrence of order $18$ contributed
...
OEIS A233812 is ``Number of (n+1) X (2+1) 0..5 arrays with every 2 X 2 subblock having the sum of the squares of all six edge and diagonal differences equal to 11.''. It has offset $1$ and begins
\[
428, 2216, 10972, 59164, 301132, 1671748, 8669484, 49193332,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 15 2026 22:37:28, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) + 74\,a(n-2) - 386\,a(n-3) - 1919\,a(n-4) + 10855\,a(n-5) + 21122\,a(n-6) - 141906\,a(n-7) - 86736\,a(n-8) + 918488\,a(n-9) - 46708\,a(n-10) - 2918256\,a(n-11) + 1088816\,a(n-12) + 4381664\,a(n-13) - 2361152\,a(n-14) - 2591360\,a(n-15) + 1642176\,a(n-16) + 224256\,a(n-17) - 168192\,a(n-18)
\end{equation}
for all $n>18$.
...
For every $n$ with $n+1-1\ge18$,
\[
a(n)-\sum_i c_i\,a(n-i)\;=\;\mathbf{1}^{\!\top}M^{\,n+1-1-18}\,q(M)\,\mathbf{1} .
\]
...
=\mathbf{1}^{\!\top}M^{\,m-18}\,q(M)\,\mathbf{1}
\]
...
$m-18=j$ run over $\ge0$. For the last clause put $w=q(M)\mathbf{1}$. By the
...
$S^2$ pairs. The vector $w=q(M)\mathbf{1}\in\mathbb{Z}^{S}$ was then formed by $18$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A233812.
