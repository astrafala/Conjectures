...
\title{The empirical recurrence for OEIS A228755, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A228755 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A228755 is ``Number of 3 X n binary arrays with top left element equal to 1 and no two ones adjacent horizontally or antidiagonally.''. It has offset $1$ and begins
\[
4, 8, 39, 126, 482, 1712, 6277, 22700,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) + 6*a(n-2) - a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 12 2018 15:08:53, revision 10) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A228755.
