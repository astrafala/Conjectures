...
\title{The empirical recurrence for OEIS A251124, proved by transfer matrix}
...
\begin{abstract}
OEIS A251124 counts $(n+1)\times5$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A251124 is ``Number of (n+1) X (4+1) 0..1 arrays with no 2 X 2 subblock having the sum of its diagonal elements greater than the maximum of its antidiagonal elements.''. It has offset $1$ and begins
\[
72, 117, 173, 266, 401, 612, 938, 1452,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 4*a(n-1) - 5*a(n-2) + a(n-3) + 2*a(n-4) - a(n-5) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 26 2018 05:30:06, revision 9) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251124.
