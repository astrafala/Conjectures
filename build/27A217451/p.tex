...
\title{The empirical recurrence for OEIS A217451, proved by transfer matrix}
...
\begin{abstract}
OEIS A217451 counts the distinct arrays obtained by applying a fixed local operation to every cell
of an array over a bounded alphabet, and carries an empirical recurrence of order $9$
...
$S=62$ states, after which the conjectured recurrence is settled by a finite exact
computation.
\end{abstract}
...
OEIS A217451 is ``Number of n X 2 arrays of the minimum value of corresponding elements and their horizontal and vertical neighbors in a random 0..2 n X 2 array.''. It has offset $1$ and begins
\[
3, 15, 69, 253, 1049, 4205, 16887, 68015,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) + 3*a(n-2) + 6*a(n-3) - 5*a(n-4) + a(n-5) - 17*a(n-6) - 14*a(n-7) - 26*a(n-8) - 4*a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 09 2018 19:33:43, revision 11) this is still
...
\]
There are $S=62$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite.
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + 3\,a(n-2) + 6\,a(n-3) - 5\,a(n-4) + a(n-5) - 17\,a(n-6) - 14\,a(n-7) - 26\,a(n-8) - 4\,a(n-9)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A217451.
