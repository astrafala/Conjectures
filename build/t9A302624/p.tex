...
\title{The empirical recurrence for OEIS A302624, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A302624 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A302624 is ``Number of 3Xn 0..1 arrays with every element equal to 0, 1, 2 or 6 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
4, 25, 25, 45, 79, 146, 286, 563,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) +a(n-3) -2*a(n-4) for n>8
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 10 2018 19:13:50, revision 4) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302624.
