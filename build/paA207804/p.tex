...
\title{The empirical recurrence for OEIS A207804, proved by transfer matrix}
...
\begin{abstract}
OEIS A207804 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
...
OEIS A207804 is ``Number of nX4 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 1 0 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
10, 100, 378, 1970, 9168, 44538, 212814,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:19:44, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) + a(n-2) - 8\,a(n-3) + 53\,a(n-4) + 166\,a(n-5) + 347\,a(n-6) + 208\,a(n-7) - 166\,a(n-8) - 780\,a(n-9) - 2484\,a(n-10) - 3678\,a(n-11) - 3721\,a(n-12) - 644\,a(n-13) + 1359\,a(n-14) + 1318\,a(n-15) + 536\,a(n-16) - 82\,a(n-17) + 446\,a(n-18) - 106\,a(n-19) - 85\,a(n-20) - 32\,a(n-21) - 47\,a(n-22) + 28\,a(n-23) - 9\,a(n-24) + a(n-26)
\end{equation}
for all $n>25$. 
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207804.
