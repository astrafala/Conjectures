...
\title{The empirical recurrence for OEIS A207484, proved by transfer matrix}
...
\begin{abstract}
OEIS A207484 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
...
OEIS A207484 is ``Number of nX4 0..1 arrays avoiding 0 0 0 and 0 1 1 horizontally and 0 1 1 and 1 1 0 vertically.''. It has offset
$1$ and begins
\[
9, 81, 217, 530, 1459, 3947, 11306,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 13:57:54, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;8\,a(n-1) - 5\,a(n-2) - 106\,a(n-3) + 209\,a(n-4) + 518\,a(n-5) - 1487\,a(n-6) - 1150\,a(n-7) + 4949\,a(n-8) + 938\,a(n-9) - 8999\,a(n-10) + 706\,a(n-11) + 9184\,a(n-12) - 2042\,a(n-13) - 5056\,a(n-14) + 1552\,a(n-15) + 1334\,a(n-16) - 472\,a(n-17) - 128\,a(n-18) + 48\,a(n-19)
\end{equation}
for all $n>18$. 
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207484.
