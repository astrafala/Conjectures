...
\title{The empirical recurrence for OEIS A282395, proved by transfer matrix}
...
\begin{abstract}
OEIS A282395 counts $n\times4$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A282395 is ``Number of nX4 0..1 arrays with no 1 equal to more than three of its king-move neighbors.''. It has offset $1$ and begins
\[
16, 213, 2048, 23773, 266425, 2966724, 33295509, 372745151,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 14 2017 07:53:02, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-1) + 24\,a(n-2) + 155\,a(n-3) - 251\,a(n-4) + 195\,a(n-5) - 2577\,a(n-6) + 337\,a(n-7) - 4734\,a(n-8) - 38\,a(n-9) - 1066\,a(n-10) - 1924\,a(n-11) + 101\,a(n-12) - 437\,a(n-13) + 447\,a(n-14) + 128\,a(n-15) + 67\,a(n-16) + 34\,a(n-17)
\]
for every $n>17$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A282395.
