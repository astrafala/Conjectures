...
\title{The empirical recurrence for OEIS A207114, proved by transfer matrix}
...
\begin{abstract}
OEIS A207114 counts arrays over $\{0,\dots,1\}$ of width $5$ that avoid the patterns
...
OEIS A207114 is ``Number of 5Xn 0..1 arrays avoiding 0 0 0 and 0 1 1 horizontally and 0 0 1 and 1 1 0 vertically.''. It has offset
$1$ and begins
\[
10, 100, 350, 1271, 4047, 10898, 30415,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 13:29:29, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 9\,a(n-2) + 2\,a(n-3) - 45\,a(n-4) - 38\,a(n-5) + 103\,a(n-6) + 166\,a(n-7) - 90\,a(n-8) - 319\,a(n-9) - 86\,a(n-10) + 254\,a(n-11) + 207\,a(n-12) + 52\,a(n-13) + 50\,a(n-14) - 151\,a(n-15) - 425\,a(n-16) - 170\,a(n-17) + 375\,a(n-18) + 403\,a(n-19) - 9\,a(n-20) - 227\,a(n-21) - 147\,a(n-22) - 27\,a(n-23) + 50\,a(n-24) + 79\,a(n-25) + 29\,a(n-26) - 28\,a(n-27) - 26\,a(n-28) + 2\,a(n-29) + 7\,a(n-30) + a(n-31) - a(n-32)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207114.
