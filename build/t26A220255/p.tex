...
\title{The empirical recurrence for OEIS A220255, proved by transfer matrix}
...
\begin{abstract}
OEIS A220255 counts the distinct indicator arrays obtained from the $n\times2$ arrays over
...
OEIS A220255 is ``Majority value maps: number of n X 2 binary arrays indicating the locations of corresponding elements equal to at least half of their horizontal and vertical neighbors in a random 0..2 n X 2 array.''. It has offset $1$ and begins
\[
2, 10, 35, 132, 497, 1881, 7102, 26812,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) + 4*a(n-2) - 4*a(n-3) - 3*a(n-6) - 2*a(n-7) + 2*a(n-8) + 2*a(n-9) for n>12.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 21 2018 06:59:57, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + 4\,a(n-2) - 4\,a(n-3) - 3\,a(n-6) - 2\,a(n-7) + 2\,a(n-8) + 2\,a(n-9)
\]
for every $n>12$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A220255.
