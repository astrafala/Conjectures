...
\title{The empirical recurrence for OEIS A302873, proved by transfer matrix}
...
\begin{abstract}
OEIS A302873 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the six horizontal, diagonal and antidiagonal neighbours, a number $equal to$ itself lying in $\{0,1,3,4,5\}$, and it carries an empirical
...
OEIS A302873 is ``Number of nX4 0..1 arrays with every element equal to 0, 1, 3, 4 or 5 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
5, 21, 35, 95, 285, 858, 2938, 11126,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 15 2018 10:31:36, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) - a(n-2) + 9\,a(n-3) - 38\,a(n-4) - 64\,a(n-5) - 94\,a(n-6) - 28\,a(n-7) + 298\,a(n-8) + 645\,a(n-9) + 892\,a(n-10) + 2073\,a(n-11) + 2812\,a(n-12) + 1062\,a(n-13) - 6119\,a(n-14) - 14380\,a(n-15) - 15795\,a(n-16) - 13646\,a(n-17) - 10955\,a(n-18) - 6874\,a(n-19) + 13030\,a(n-20) + 34925\,a(n-21) + 45526\,a(n-22) + 34585\,a(n-23) + 42419\,a(n-24) + 53978\,a(n-25) + 38220\,a(n-26) - 24564\,a(n-27) - 75371\,a(n-28) - 85828\,a(n-29) - 61780\,a(n-30) - 29630\,a(n-31) - 7671\,a(n-32) + 10349\,a(n-33) + 15109\,a(n-34) + 19873\,a(n-35) + 15144\,a(n-36) + 11837\,a(n-37) + 4645\,a(n-38) + 3040\,a(n-39) + 2158\,a(n-40) + 65\,a(n-41) - 120\,a(n-42) - 1013\,a(n-43) + 241\,a(n-44) - 225\,a(n-45) + 495\,a(n-46) + 126\,a(n-47) + 306\,a(n-48) + 42\,a(n-49) + 54\,a(n-50) + 8\,a(n-51) - 34\,a(n-52) - 6\,a(n-53) - 18\,a(n-54) - 2\,a(n-55) - 2\,a(n-56)
\end{equation}
for all $n>58$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302873.
