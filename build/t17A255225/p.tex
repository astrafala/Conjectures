...
\title{The empirical recurrence for OEIS A255225, proved by transfer matrix}
...
\begin{abstract}
OEIS A255225 counts $(n+2)\times7$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A255225 is ``Number of (n+2)X(5+2) 0..1 arrays with no 3x3 subblock diagonal sum 0 and no antidiagonal sum 0 and no row sum 2 and no column sum 2.''. It has offset $1$ and begins
\[
61, 67, 76, 88, 106, 133, 172, 229,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) -a(n-2) +a(n-3) -a(n-4)
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:40:40, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A255225.
