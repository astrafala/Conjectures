...
\title{The empirical recurrence for OEIS A305680, proved by transfer matrix}
...
\begin{abstract}
OEIS A305680 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $different from$ itself lying in $\{0,2,3,4,5,6\}$, and it carries an empirical
recurrence of order $14$ contributed by R.~H.~Hardin. It is true. The neighbourhood
...
OEIS A305680 is ``Number of nX3 0..1 arrays with every element unequal to 0, 2, 3, 4, 5 or 6 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 8, 25, 139, 818, 4869, 29339, 177688,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 08 2018 08:03:44, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;7\,a(n-1) - 3\,a(n-2) - 6\,a(n-3) - 61\,a(n-4) - 4\,a(n-5) + 53\,a(n-6) + 92\,a(n-7) + 78\,a(n-8) - 9\,a(n-9) - 8\,a(n-10) - 2\,a(n-11) + 8\,a(n-12) + 10\,a(n-13) + 2\,a(n-14)
\end{equation}
for all $n>15$.
...
$a(n)-\sum_i c_i a(n-i)=u_{\,n-2-14}$ whenever $n-14\ge2$. So \eqref{eq:conj}
holds for every $n>t$ exactly when $u_j=0$ for all $j>t-2-14$. Moreover $(u_j)$
...
\begin{proof}
Substituting Lemma~\ref{lem:walk} and factoring $P^{\,n-2-14}$ out of
...
\begin{proof}
The vector $q(P)\mathbf{e}\in\mathbb{Z}^{S}$ was formed by $14$ matrix--vector
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A305680.
