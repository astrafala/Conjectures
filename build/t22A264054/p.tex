...
\title{The empirical recurrence for OEIS A264054, proved by transfer matrix}
...
\begin{abstract}
OEIS A264054 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=3$ rows in which
...
OEIS A264054 is ``Number of (n+1) X (2+1) arrays of permutations of 0..n*3+2 with each element having index change +-(.,.) 0,0 1,2 or 2,-2.''. It has offset $1$ and begins
\[
2, 8, 18, 45, 125, 320, 832, 2197,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) - a(n-2) + 3*a(n-3) - 9*a(n-4) + 3*a(n-5) - a(n-6) + 3*a(n-7) - a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 20 2018 20:37:42, revision 10) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) - a(n-2) + 3\,a(n-3) - 9\,a(n-4) + 3\,a(n-5) - a(n-6) + 3\,a(n-7) - a(n-8)
\]
for every $n>6$.
\end{theorem}
...
transposed companion A263966. Second, the transfer model reproduces all $27$ terms this
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264054.
