...
\title{The empirical recurrence for OEIS A264337, proved by transfer matrix}
...
\begin{abstract}
OEIS A264337 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=5$ rows in which
...
OEIS A264337 is ``Number of (n+1) X (4+1) arrays of permutations of 0..n*5+4 with each element having index change +-(.,.) 0,0 0,1 or 1,2.''. It has offset $1$ and begins
\[
181, 3567, 70669, 1399783, 27726581, 549201567, 10878455069, 215477871383,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 19*a(n-1) + 16*a(n-2).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 07 2019 11:17:22, revision 8) this is still
...
\[
(i-h_i,\,j-h_j)\;\in\;\{(-1,-2),\ (0,-1),\ (0,0),\ (0,1),\ (1,2)\},
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264337.
