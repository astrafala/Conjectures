...
\title{The empirical recurrence for OEIS A207700, proved by transfer matrix}
...
\begin{abstract}
OEIS A207700 counts arrays over $\{0,\dots,1\}$ of width $5$ that avoid the patterns
$(0,0,0), (0,1,0)$ along one axis and $(0,0,1), (1,1,0)$ along the other, and carries an empirical recurrence of
...
OEIS A207700 is ``Number of n X 5 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 0 1 and 1 1 0 vertically.''. It has offset
$1$ and begins
\[
15, 225, 1071, 3321, 8151, 17225, 32775,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 6*a(n-1) - 15*a(n-2) + 20*a(n-3) - 15*a(n-4) + 6*a(n-5) - a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 25 2018 08:54:50, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207700.
