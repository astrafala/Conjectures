...
\title{The empirical recurrence for OEIS A207243, proved by transfer matrix}
...
\begin{abstract}
OEIS A207243 counts arrays over $\{0,\dots,1\}$ of width $3$ that avoid the patterns
...
OEIS A207243 is ``Number of 3Xn 0..1 arrays avoiding 0 0 0 and 0 1 1 horizontally and 0 0 1 and 0 1 0 vertically.''. It has offset
$1$ and begins
\[
6, 36, 102, 283, 699, 1526, 3355,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 13:40:19, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) - 3\,a(n-2) - 3\,a(n-3) - 4\,a(n-4) + 16\,a(n-5) - 8\,a(n-6) + 2\,a(n-7) - 8\,a(n-8) + 10\,a(n-9) - 14\,a(n-10) + 12\,a(n-11) - 4\,a(n-12) + 4\,a(n-13) - 5\,a(n-14) + 4\,a(n-15) - 3\,a(n-16) + a(n-17)
\end{equation}
for all $n>16$. The entry's array has a fixed number of rows and a growing number of
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207243.
