...
\title{The empirical recurrence for OEIS A297695, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297695 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A297695 is ``Number of 2Xn 0..1 arrays with every 1 horizontally, diagonally or antidiagonally adjacent to 0, 2 or 4 neighboring 1s.''. It has offset $1$ and begins
\[
4, 8, 26, 60, 176, 436, 1216, 3120,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) +4*a(n-2) -6*a(n-3)
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 03 2018 12:29:02, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 4\,a(n-2) - 6\,a(n-3)
\end{equation}
for all $n>4$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297695.
