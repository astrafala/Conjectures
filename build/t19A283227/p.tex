...
\title{The empirical recurrence for OEIS A283227, proved by transfer matrix}
...
\begin{abstract}
OEIS A283227 counts $n\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A283227 is ``Number of n X 3 0..1 arrays with no 1 equal to more than two of its horizontal and vertical neighbors, with the exception of exactly two elements.''. It has offset $1$ and begins
\[
0, 1, 34, 395, 3996, 37869, 338397, 2903399,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 26 2022 04:21:27, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;15\,a(n-1) - 54\,a(n-2) - 10\,a(n-3) - 318\,a(n-4) + 1056\,a(n-5) + 3892\,a(n-6) + 15081\,a(n-7) + 28818\,a(n-8) + 47074\,a(n-9) + 42561\,a(n-10) + 16083\,a(n-11) - 40047\,a(n-12) - 76149\,a(n-13) - 66630\,a(n-14) - 5493\,a(n-15) + 53052\,a(n-16) + 53256\,a(n-17) + 9505\,a(n-18) - 26049\,a(n-19) - 17790\,a(n-20) + 3537\,a(n-21) + 5733\,a(n-22) + 369\,a(n-23) - 753\,a(n-24) - 126\,a(n-25) + 36\,a(n-26) + 8\,a(n-27)
\]
for every $n>27$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A283227.
