...
\title{The empirical recurrence for OEIS A229474, proved by counting defective colourings}
...
\begin{abstract}
OEIS A229474 counts the colourings of an array with $K=4$ colours that are proper except at
...
OEIS A229474 is ``Number of defective 4-colorings of an n X 3 0..3 array connected horizontally, antidiagonally and vertically with exactly one mistake, and colors introduced in row-major 0..3 order.''. It has offset $1$ and begins
\[
2, 42, 420, 3328, 23964, 163528, 1077588, 6927888,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 14*a(n-1) - 65*a(n-2) + 112*a(n-3) - 64*a(n-4) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 18 2018 09:18:45, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;14\,a(n-1) - 65\,a(n-2) + 112\,a(n-3) - 64\,a(n-4)
\end{equation}
for all $n>5$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A229474.
