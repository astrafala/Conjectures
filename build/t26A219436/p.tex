...
\title{The empirical recurrence for OEIS A219436, proved by transfer matrix}
...
\begin{abstract}
OEIS A219436 counts the distinct indicator arrays obtained from the $n\times3$ arrays over
...
OEIS A219436 is ``Unmatched value maps: number of nX3 binary arrays indicating the locations of corresponding elements not equal to any horizontal, diagonal or antidiagonal neighbor in a random 0..1 nX3 array.''. It has offset $1$ and begins
\[
4, 18, 78, 329, 1396, 5925, 25147, 106731,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) +a(n-2) +a(n-3) -2*a(n-4) -6*a(n-5) -3*a(n-6) -2*a(n-7) +5*a(n-8) +4*a(n-9) -2*a(n-10) -2*a(n-11)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 18:03:22, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + a(n-2) + a(n-3) - 2\,a(n-4) - 6\,a(n-5) - 3\,a(n-6) - 2\,a(n-7) + 5\,a(n-8) + 4\,a(n-9) - 2\,a(n-10) - 2\,a(n-11)
\]
for every $n>11$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A219436.
