...
\title{The empirical recurrence for OEIS A203929, proved by transfer matrix}
...
\begin{abstract}
OEIS A203929 counts $(n+1)\times4$ arrays over $\{0,\dots,5\}$ subject to a condition imposed on
...
OEIS A203929 is ``Number of (n+1) X 4 0..5 arrays with every 2 X 2 subblock having equal diagonal elements or equal antidiagonal elements.''. It has offset $1$ and begins
\[
47916, 2543436, 140120856, 7748585676, 428652828396, 23714024087016, 1311917257647036, 72578467770478956,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 61*a(n-1) - 315*a(n-2) + 50*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 05 2018 16:14:09, revision 11) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A203929.
