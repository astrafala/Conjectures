...
\title{The empirical recurrence for OEIS A275128, proved by counting patterns}
...
\begin{abstract}
OEIS A275128 counts arrays in which no entry may repeat a value found at any of three stated
...
cutting $60074$ pairs to $S=10355$ states. The entry's empirical recurrence of order $28$,
...
OEIS A275128 is ``Number of nX5 0..2 arrays with no element equal to any value at offset (-2,-2) (-1,0) or (-1,1) and new values introduced in order 0..2.''. It has offset $1$ and begins
\[
41, 256, 675, 2545, 12423, 62378, 315021, 1591442,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 17 2016 10:58:42, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;8\,a(n-1) - 27\,a(n-2) + 79\,a(n-3) - 99\,a(n-4) - 81\,a(n-5) + 860\,a(n-6) - 1162\,a(n-7) - 868\,a(n-8) + 1676\,a(n-9) - 3352\,a(n-10) - 1549\,a(n-11) + 4857\,a(n-12) + 1164\,a(n-13) + 3213\,a(n-14) + 5946\,a(n-15) - 1377\,a(n-16) - 5652\,a(n-17) - 4880\,a(n-18) - 2760\,a(n-19) - 710\,a(n-20) + 595\,a(n-21) + 1142\,a(n-22) + 594\,a(n-23) + 71\,a(n-24) + 48\,a(n-25) + 20\,a(n-26) + a(n-28)
\end{equation}
for all $n>31$.
...
$o=1n_0+0-2$, we have for $j\ge28$
\[
3!\Bigl(a(n_0+j)-\sum_i c_i\,a(n_0+j-i)\Bigr)
=\mathbf{v}^{\!\top}G^{\,j-28}w,\qquad
w=h_{28}-\sum_i c_i h_{28-i} .
\]
...
the survivors by the pattern of the new pair. The vector $w$ was formed by $28$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A275128.
