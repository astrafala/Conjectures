...
\title{The empirical recurrence for OEIS A197426, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A197426 counts arrays over $\{0,\dots,4\}$ in which every cell is constrained by the
...
OEIS A197426 is ``Number of nX3 0..4 arrays with each element x equal to the number its horizontal and vertical neighbors equal to 4,0,1,1,1 for x=0,1,2,3,4.''. It has offset $1$ and begins
\[
4, 20, 68, 448, 2152, 10684, 55567, 280544,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 07:12:14, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) + 8\,a(n-2) + 2\,a(n-3) - 55\,a(n-4) + 13\,a(n-5) - 31\,a(n-6) - 1395\,a(n-7) - 7003\,a(n-8) + 190\,a(n-9) + 23621\,a(n-10) + 39494\,a(n-11) + 136485\,a(n-12) + 189052\,a(n-13) + 97313\,a(n-14) - 54613\,a(n-15) - 41550\,a(n-16) - 8281\,a(n-17) - 61318\,a(n-18) - 115671\,a(n-19) - 54446\,a(n-20) + 31678\,a(n-21) - 10581\,a(n-22) + 13927\,a(n-23) - 1446\,a(n-24) + 8349\,a(n-25) - 8652\,a(n-26) + 4905\,a(n-27) - 966\,a(n-28) + 1251\,a(n-29) - 457\,a(n-30) - 57\,a(n-31) + 6\,a(n-32) + a(n-34)
\end{equation}
for all $n>35$.
...
\#\{\text{neighbours with value }f(x_{t,u})\}=x_{t,u},\quad f=(4,0,1,1,1)
\end{equation}
for every cell $(t,u)$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A197426.
