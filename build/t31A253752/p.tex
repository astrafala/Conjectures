...
\title{The empirical recurrence for OEIS A253752, proved by transfer matrix}
...
\begin{abstract}
OEIS A253752 counts the arrays over $\{0,\dots,2\}$ whose $2\times2$ subblocks carry a
...
OEIS A253752 is ``Number of (4+1) X (n+1) 0..2 arrays with every 2 X 2 subblock ne-sw antidiagonal difference nondecreasing horizontally and nw+se diagonal sum nondecreasing vertically.''. It has offset $1$ and begins
\[
7803, 75959, 382973, 1143174, 2351928, 4249381, 7348144, 11783014,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 19 2022 15:11:46, revision 8) this is still
...
\[
$\sigma(i,j)\{le}\sigma(i+1,j+0)$, $\sigma(i,j)\{le}\sigma(i+0,j+1)$
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253752.
