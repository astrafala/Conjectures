...
\title{The empirical recurrence for OEIS A255024, proved by transfer matrix}
...
\begin{abstract}
OEIS A255024 counts $(n+2)\times7$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
no $3\times3$ subblock, and it carries an empirical recurrence of order $43$
...
OEIS A255024 is ``Number of (n+2)X(5+2) 0..1 arrays with no 3x3 subblock diagonal sum 0 or 1 and no antidiagonal sum 0 or 1 and no row sum 0 or 1 and no column sum 0 or 1.''. It has offset $1$ and begins
\[
601, 3015, 17447, 92217, 480456, 2547757, 13460633, 71027915,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:36:11, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A255024.
