...
\title{The empirical recurrence for OEIS A303714, proved by transfer matrix}
...
\begin{abstract}
OEIS A303714 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A303714 is ``Number of n X 3 0..1 arrays with every element unequal to 0, 1 or 5 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
3, 3, 5, 8, 14, 24, 40, 68,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +2*a(n-3) for n>4.
\end{quote}
As of the ``Last modified'' line on the live entry (May 17 2023 12:14:53, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A303714.
