...
\title{The empirical recurrence for OEIS A297221, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297221 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A297221 is ``Number of n X 5 0..1 arrays with every 1 horizontally or antidiagonally adjacent to 1 neighboring 1s.''. It has offset $1$ and begins
\[
6, 33, 182, 997, 5570, 30946, 171851, 955316,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) + 16*a(n-2) + 45*a(n-3) + 39*a(n-4) - 3*a(n-5) - 21*a(n-6) + 8*a(n-7) - 4*a(n-8) + a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 26 2019 12:05:54, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 16\,a(n-2) + 45\,a(n-3) + 39\,a(n-4) - 3\,a(n-5) - 21\,a(n-6) + 8\,a(n-7) - 4\,a(n-8) + a(n-9)
\end{equation}
for all $n>10$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297221.
