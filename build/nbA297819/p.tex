...
\title{The empirical recurrence for OEIS A297819, proved by transfer matrix}
...
\begin{abstract}
OEIS A297819 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A297819 is ``Number of nX4 0..1 arrays with every element equal to 1, 2 or 3 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
2, 49, 146, 466, 1395, 4306, 13417, 41512,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 06 2018 10:55:42, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297819.
