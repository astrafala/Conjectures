...
\title{The empirical recurrence for OEIS A303678, proved by transfer matrix}
...
\begin{abstract}
OEIS A303678 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A303678 is ``Number of nX4 0..1 arrays with every element unequal to 0, 1 or 3 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
5, 17, 15, 28, 44, 64, 90, 132,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +a(n-4) +a(n-5) for n>8
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 28 2018 09:20:38, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A303678.
