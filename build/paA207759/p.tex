...
\title{The empirical recurrence for OEIS A207759, proved by transfer matrix}
...
\begin{abstract}
OEIS A207759 counts arrays over $\{0,\dots,1\}$ of width $5$ that avoid the patterns
...
OEIS A207759 is ``Number of nX5 0..1 arrays avoiding 0 0 0 and 1 0 1 horizontally and 0 1 1 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
13, 169, 493, 1664, 6552, 21547, 67330,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:16:37, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;7\,a(n-1) - 18\,a(n-2) + 42\,a(n-3) - 135\,a(n-4) + 245\,a(n-5) - 331\,a(n-6) + 828\,a(n-7) - 1162\,a(n-8) + 899\,a(n-9) - 2506\,a(n-10) + 2983\,a(n-11) - 933\,a(n-12) + 5079\,a(n-13) - 5361\,a(n-14) - 397\,a(n-15) - 7067\,a(n-16) + 6470\,a(n-17) + 2910\,a(n-18) + 6260\,a(n-19) - 5476\,a(n-20) - 3504\,a(n-21) - 3776\,a(n-22) + 3472\,a(n-23) + 1984\,a(n-24) + 1120\,a(n-25) - 1184\,a(n-26) - 576\,a(n-27) - 128\,a(n-28) + 256\,a(n-29)
\end{equation}
for all $n>29$. 
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207759.
