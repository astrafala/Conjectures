...
\title{The empirical recurrence for OEIS A264000, proved by transfer matrix}
...
\begin{abstract}
OEIS A264000 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=4$ rows in which
...
OEIS A264000 is ``Number of (n+1) X (3+1) arrays of permutations of 0..n*4+3 with each element having index change (+-,+-) 0,0 1,2 or 1,0.''. It has offset $1$ and begins
\[
81, 1089, 34225, 833569, 22819729, 604028929, 16226938225, 434018757601,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 29*a(n-1) + 36*a(n-2) - 2832*a(n-3) + 6656*a(n-4) + 24576*a(n-5) - 65536*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 03 2019 17:44:24, revision 10) this is still
...
\begin{theorem}
\[
a(n)\;=\;29\,a(n-1) + 36\,a(n-2) - 2832\,a(n-3) + 6656\,a(n-4) + 24576\,a(n-5) - 65536\,a(n-6)
\]
for every $n>4$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264000.
