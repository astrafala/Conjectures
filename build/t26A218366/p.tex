...
\title{The empirical recurrence for OEIS A218366, proved by transfer matrix}
...
\begin{abstract}
OEIS A218366 counts the distinct indicator arrays obtained from the $n\times2$ arrays over
...
indicator row by row turns it into one, on $S=26$ states, after which the conjectured
...
OEIS A218366 is ``Hilltop maps: number of nX2 binary arrays indicating the locations of corresponding elements not exceeded by any horizontal, vertical or antidiagonal neighbor in a random 0..3 nX2 array.''. It has offset $1$ and begins
\[
3, 15, 63, 253, 1009, 4033, 16129, 64511,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 17:40:09, revision 8) this is still
...
\]
There are $S=26$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite. Note
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + 3\,a(n-2) + 3\,a(n-3) + 3\,a(n-4) + 3\,a(n-5) + 3\,a(n-6) + a(n-7) + a(n-8) + a(n-9) + a(n-10) + a(n-11) + a(n-12) + a(n-13)
\]
for every $n>13$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A218366.
