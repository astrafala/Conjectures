...
\title{The empirical recurrence for OEIS A208030, proved by transfer matrix}
...
\begin{abstract}
OEIS A208030 counts arrays over $\{0,\dots,1\}$ of width $5$ that avoid the patterns
...
OEIS A208030 is ``Number of 5 X n 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 0 0 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
13, 169, 741, 4823, 26845, 158847, 917293,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) + 19*a(n-2) - 9*a(n-3) - 42*a(n-4) + 31*a(n-5) + 3*a(n-6) - 4*a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 26 2018 14:08:11, revision
8) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 19\,a(n-2) - 9\,a(n-3) - 42\,a(n-4) + 31\,a(n-5) + 3\,a(n-6) - 4\,a(n-7)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208030.
