...
\title{The empirical recurrence for OEIS A251276, proved by transfer matrix}
...
\begin{abstract}
OEIS A251276 counts $(n+1)\times2$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A251276 is ``Number of (n+1) X (1+1) 0..3 arrays with no 2 X 2 subblock having its maximum diagonal element less than its minimum antidiagonal element.''. It has offset $1$ and begins
\[
230, 3264, 46244, 655040, 9278296, 131421696, 1861511440, 26367218944,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 16*a(n-1) - 26*a(n-2).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 27 2018 12:25:41, revision 7) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;16\,a(n-1) - 26\,a(n-2)
\end{equation}
for all $n>1$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251276.
