...
\title{The empirical recurrence for OEIS A203930, proved by transfer matrix}
...
\begin{abstract}
OEIS A203930 counts $(n+1)\times5$ arrays over $\{0,\dots,5\}$ subject to a condition imposed on
...
OEIS A203930 is ``Number of (n+1)X5 0..5 arrays with every 2X2 subblock having equal diagonal elements or equal antidiagonal elements.''. It has offset $1$ and begins
\[
527076, 60873876, 7748585676, 1012872412476, 132923754354276, 17475349695161076, 2297197186864332876, 302046352349437619676,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 91*a(n-1) +7335*a(n-2) -264625*a(n-3) -85500*a(n-4) +10470000*a(n-5) +2475000*a(n-6) -20750000*a(n-7)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 10:52:26, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;91\,a(n-1) + 7335\,a(n-2) - 264625\,a(n-3) - 85500\,a(n-4) + 10470000\,a(n-5) + 2475000\,a(n-6) - 20750000\,a(n-7)
\end{equation}
for all $n>6$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A203930.
