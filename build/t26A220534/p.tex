...
\title{The empirical recurrence for OEIS A220534, proved by transfer matrix}
...
\begin{abstract}
OEIS A220534 counts the distinct indicator arrays obtained from the $n\times3$ arrays over
...
indicator row by row turns it into one, on $S=91$ states, after which the conjectured
...
OEIS A220534 is ``Equals one maps: number of nX3 binary arrays indicating the locations of corresponding elements equal to exactly one of their horizontal, diagonal and antidiagonal neighbors in a random 0..1 nX3 array.''. It has offset $1$ and begins
\[
4, 5, 55, 322, 1802, 9888, 54152, 296677,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 18:48:35, revision 12) this is still
...
\]
There are $S=91$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite. Note
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) + a(n-2) + 5\,a(n-3) + 33\,a(n-4) - 53\,a(n-5) + 9\,a(n-6) - 86\,a(n-7) - 255\,a(n-8) - 958\,a(n-9) - 2148\,a(n-10) + 2\,a(n-11) + 3703\,a(n-12) + 3911\,a(n-13) + 2790\,a(n-14) + 6350\,a(n-15) + 25490\,a(n-16) + 33796\,a(n-17) + 20951\,a(n-18) + 17342\,a(n-19) + 22582\,a(n-20) + 18944\,a(n-21) - 21214\,a(n-22) - 38176\,a(n-23) - 7890\,a(n-24) + 49122\,a(n-25) + 10920\,a(n-26) - 56928\,a(n-27) - 35976\,a(n-28) + 34352\,a(n-29) + 127432\,a(n-30) + 82976\,a(n-31) - 13984\,a(n-32) - 42432\,a(n-33) - 36448\,a(n-34) + 9952\,a(n-35) + 24384\,a(n-36) - 1664\,a(n-38) + 3072\,a(n-39) + 1152\,a(n-40)
\]
for every $n>42$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A220534.
