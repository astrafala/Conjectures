...
\title{The empirical recurrence for OEIS A251486, proved by transfer matrix}
...
\begin{abstract}
OEIS A251486 counts $(n+1)\times4$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A251486 is ``Number of (n+1)X(3+1) 0..3 arrays with no 2X2 subblock having the sum of its diagonal elements less than the minimum of its antidiagonal elements.''. It has offset $1$ and begins
\[
50576, 10046784, 1996407424, 396684056960, 78819515764397, 15661071542167376, 3111780313414886566, 618295855606419707392,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:25:17, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;256\,a(n-1) - 12199\,a(n-2) + 163792\,a(n-3) - 450614\,a(n-4) - 999872\,a(n-5) + 26782853\,a(n-6) - 398145776\,a(n-7) - 1637661603\,a(n-8) + 5238219360\,a(n-9) + 12853712360\,a(n-10) - 27723613504\,a(n-11) - 38172377104\,a(n-12) + 34500091392\,a(n-13) + 70834593600\,a(n-14) - 41937979392\,a(n-15) + 11349974016\,a(n-16)
\end{equation}
for all $n>15$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251486.
