...
\title{The empirical recurrence for OEIS A208014, proved by transfer matrix}
...
\begin{abstract}
OEIS A208014 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
...
OEIS A208014 is ``Number of 4 X n 0..1 arrays avoiding 0 0 0 and 1 0 1 horizontally and 0 0 1 and 0 1 1 vertically.''. It has offset
$1$ and begins
\[
9, 81, 225, 841, 2304, 6084, 18496,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) + 2*a(n-2) + 10*a(n-3) + 4*a(n-4) - 8*a(n-5) - 16*a(n-6) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 26 2018 11:18:23, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208014.
