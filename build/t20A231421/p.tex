...
\title{The empirical recurrence for OEIS A231421, proved by transfer matrix}
...
\begin{abstract}
OEIS A231421 counts $3\times(n+1)$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A231421 is ``Number of (2+1)X(n+1) 0..2 arrays with no element equal to a strict majority of its horizontal, diagonal and antidiagonal neighbors, with values 0..2 introduced in row major order.''. It has offset $1$ and begins
\[
50, 1032, 20896, 424404, 8704406, 178277756, 3654045516, 74894704740,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 06:28:55, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;20\,a(n-1) + 56\,a(n-2) - 821\,a(n-3) - 2559\,a(n-4) + 2274\,a(n-5) + 11333\,a(n-6) + 75045\,a(n-7) + 58970\,a(n-8) - 744820\,a(n-9) - 338743\,a(n-10) + 3350990\,a(n-11) - 566226\,a(n-12) - 8533262\,a(n-13) + 6626396\,a(n-14) + 10836980\,a(n-15) - 13238580\,a(n-16) - 6337152\,a(n-17) + 13746128\,a(n-18) - 1255112\,a(n-19) - 8079152\,a(n-20) + 2081168\,a(n-21) + 460736\,a(n-22) - 1034208\,a(n-23) + 221216\,a(n-24) - 114304\,a(n-25) - 122880\,a(n-26) - 16384\,a(n-27) - 512\,a(n-28)
\]
for every $n>28$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231421.
