...
\title{The empirical recurrence for OEIS A209227, proved by transfer matrix}
...
\begin{abstract}
OEIS A209227 counts arrays over $\{0,\dots,1\}$ of width $6$ that avoid the patterns
$(0,1,0), (1,1,1)$ along one axis and $(0,0,0), (0,1,0)$ along the other, and carries an empirical recurrence of
...
OEIS A209227 is ``Number of 6Xn 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 1 0 and 1 1 1 vertically.''. It has offset
$1$ and begins
\[
19, 361, 456, 576, 1776, 5476, 15984,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 15:12:14, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 3\,a(n-3) + 71\,a(n-4) - 125\,a(n-5) - 25\,a(n-6) - 56\,a(n-7) - 1243\,a(n-8) + 2035\,a(n-9) + 168\,a(n-10) + 560\,a(n-11) + 6152\,a(n-12) - 9704\,a(n-13) - 848\,a(n-14) - 1472\,a(n-15) - 11056\,a(n-16) + 16688\,a(n-17) + 1472\,a(n-18) + 1536\,a(n-19) + 6976\,a(n-20) - 9536\,a(n-21) - 1024\,a(n-22) - 1024\,a(n-24) + 1024\,a(n-25)
\end{equation}
for all $n>26$. The entry's array has a fixed number of rows and a growing number of
...
$(0,1,0), (1,1,1)$ as $3$ consecutive entries. There are $19$ admissible columns; that condition
...
index corresponding to $n=26+1$ onwards, and the run was continued past $S$ consecutive
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209227.
