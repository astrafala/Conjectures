...
\title{The empirical recurrence for OEIS A207749, proved by transfer matrix}
...
\begin{abstract}
OEIS A207749 counts arrays over $\{0,\dots,1\}$ of width $5$ that avoid the patterns
...
OEIS A207749 is ``Number of nX5 0..1 arrays avoiding 0 0 1 and 0 1 1 horizontally and 0 0 1 and 1 0 0 vertically.''. It has offset
$1$ and begins
\[
12, 144, 612, 2100, 8778, 34668, 147084,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:15:30, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;12\,a(n-1) - 15\,a(n-2) - 318\,a(n-3) + 989\,a(n-4) + 3432\,a(n-5) - 15290\,a(n-6) - 19128\,a(n-7) + 121738\,a(n-8) + 55524\,a(n-9) - 583550\,a(n-10) - 56016\,a(n-11) + 1776187\,a(n-12) - 141444\,a(n-13) - 3467035\,a(n-14) + 588186\,a(n-15) + 4252641\,a(n-16) - 950232\,a(n-17) - 3104320\,a(n-18) + 827568\,a(n-19) + 1200096\,a(n-20) - 369792\,a(n-21) - 181440\,a(n-22) + 62208\,a(n-23)
\end{equation}
for all $n>22$. 
...
$(0,0,1), (0,1,1)$ as $3$ consecutive entries. There are $12$ admissible rows; that condition
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207749.
