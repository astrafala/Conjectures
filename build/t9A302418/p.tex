...
\title{The empirical recurrence for OEIS A302418, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A302418 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A302418 is ``Number of 5Xn 0..1 arrays with every element equal to 0, 1, 2 or 5 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
16, 264, 441, 994, 3553, 11998, 33596, 98387,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 07 2018 17:05:55, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) - 9\,a(n-2) + 17\,a(n-3) - 28\,a(n-4) + 19\,a(n-5) - 26\,a(n-6) - 18\,a(n-7) + 137\,a(n-8) - 158\,a(n-9) + 276\,a(n-10) - 316\,a(n-11) + 172\,a(n-12) - 266\,a(n-13) + 62\,a(n-14) + 36\,a(n-15) + 170\,a(n-16) + 85\,a(n-17) + 306\,a(n-18) - 567\,a(n-19) + 247\,a(n-20) - 669\,a(n-21) + 228\,a(n-22) + 266\,a(n-23) + 7\,a(n-24) + 456\,a(n-25) - 403\,a(n-26) + 100\,a(n-27) - 208\,a(n-28) + 20\,a(n-29) + 30\,a(n-30) + 30\,a(n-31)
\end{equation}
for all $n>39$.
...
\#\{\text{neighbours with a value }equal to\ x_{t,u}\}\in\{0,1,2,5\}
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302418.
