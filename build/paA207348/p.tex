...
\title{The empirical recurrence for OEIS A207348, proved by transfer matrix}
...
\begin{abstract}
OEIS A207348 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
...
OEIS A207348 is ``Number of 4Xn 0..1 arrays avoiding 0 0 0 and 0 1 1 horizontally and 0 0 0 and 1 1 1 vertically.''. It has offset
$1$ and begins
\[
10, 100, 292, 828, 2190, 5290, 12292,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 13:48:04, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 3\,a(n-2) + a(n-3) - 16\,a(n-4) - 5\,a(n-5) - 2\,a(n-6) + 38\,a(n-7) + 8\,a(n-8) + 26\,a(n-9) - 59\,a(n-10) + 12\,a(n-11) - 61\,a(n-12) + 55\,a(n-13) - 57\,a(n-14) + 59\,a(n-15) - 62\,a(n-16) + 61\,a(n-17) - 41\,a(n-18) + 48\,a(n-19) - 31\,a(n-20) + 19\,a(n-21) - 20\,a(n-22) + 7\,a(n-23) - 5\,a(n-24) + 4\,a(n-25) + a(n-27)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207348.
