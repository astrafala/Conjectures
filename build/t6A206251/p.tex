...
\title{The empirical recurrence for OEIS A206251, proved by transfer matrix}
...
\begin{abstract}
OEIS A206251 counts $(n+1)\times5$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A206251 is ``Number of (n+1)X5 0..3 arrays with every 2X2 subblock having zero permanent.''. It has offset $1$ and begins
\[
9409, 1718209, 49336576, 4556324929, 226637884225, 16533087493120, 1006239668280961, 68438717405988481,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 12:49:41, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;88\,a(n-1) - 128439\,a(n-3) + 1879848\,a(n-4) + 28773144\,a(n-5) - 593002863\,a(n-6) + 32230833768\,a(n-8) - 98419153113\,a(n-9)
\end{equation}
for all $n>8$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206251.
