...
\title{The empirical recurrence for OEIS A282785, proved by transfer matrix}
...
\begin{abstract}
OEIS A282785 counts $n\times2$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A282785 is ``Number of n X 2 0..1 arrays with no 1 equal to more than one of its king-move neighbors, with the exception of exactly one element.''. It has offset $1$ and begins
\[
0, 0, 8, 16, 72, 240, 736, 2352,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + 5*a(n-2)  +2*a(n-3) - 17*a(n-4) - 24*a(n-5) - 16*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 21 2019 06:40:04, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A282785.
