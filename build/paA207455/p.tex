...
\title{The empirical recurrence for OEIS A207455, proved by transfer matrix}
...
\begin{abstract}
OEIS A207455 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
...
OEIS A207455 is ``Number of 4 X n 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 0 1 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
8, 64, 168, 760, 2560, 10088, 36456,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) + 10*a(n-2) + 3*a(n-3) - 9*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 04 2022 10:55:37, revision
13) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 10\,a(n-2) + 3\,a(n-3) - 9\,a(n-4)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207455.
