...
\title{The empirical recurrence for OEIS A251152, proved by transfer matrix}
...
\begin{abstract}
OEIS A251152 counts $(n+1)\times3$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A251152 is ``Number of (n+1)X(2+1) 0..2 arrays with no 2X2 subblock having the minimum of its diagonal elements greater than the absolute difference of its antidiagonal elements.''. It has offset $1$ and begins
\[
470, 8407, 148833, 2644832, 46958048, 833966807, 14810089440, 263012232516,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:06:29, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;17\,a(n-1) + 42\,a(n-2) - 498\,a(n-3) - 335\,a(n-4) + 3258\,a(n-5) + 529\,a(n-6) - 8805\,a(n-7) + 550\,a(n-8) + 7570\,a(n-9) + 519\,a(n-10) - 2235\,a(n-11) + 561\,a(n-12) + 567\,a(n-13) - 134\,a(n-14) - 64\,a(n-15) + 8\,a(n-16)
\end{equation}
for all $n>15$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251152.
