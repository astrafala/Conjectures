...
\title{The empirical recurrence for OEIS A296593, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A296593 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A296593 is ``Number of n X 2 0..1 arrays with each 1 horizontally, vertically or antidiagonally adjacent to 1, 2 or 3 neighboring 1s.''. It has offset $1$ and begins
\[
2, 11, 39, 136, 494, 1785, 6432, 23201,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) + a(n-2) + 4*a(n-3) + a(n-4) + a(n-6) - a(n-7) - a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 23 2019 09:56:42, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + a(n-2) + 4\,a(n-3) + a(n-4) + a(n-6) - a(n-7) - a(n-8)
\end{equation}
for all $n>9$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A296593.
