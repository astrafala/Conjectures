...
\title{The empirical recurrence for OEIS A306048, proved by transfer matrix}
...
\begin{abstract}
OEIS A306048 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A306048 is ``Number of nX3 0..1 arrays with every element unequal to 0, 1, 2, 3, 6 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
4, 21, 45, 142, 439, 1261, 3826, 11770,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) +9*a(n-3) -20*a(n-4) -27*a(n-5) +11*a(n-6) +33*a(n-7) +18*a(n-8) -22*a(n-9) -10*a(n-10) for n>12
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 18 2018 07:36:07, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 9\,a(n-3) - 20\,a(n-4) - 27\,a(n-5) + 11\,a(n-6) + 33\,a(n-7) + 18\,a(n-8) - 22\,a(n-9) - 10\,a(n-10)
\end{equation}
for all $n>11$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A306048.
