...
\title{The empirical recurrence for OEIS A264001, proved by transfer matrix}
...
\begin{abstract}
OEIS A264001 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=5$ rows in which
...
partly used. Carrying those as bitmasks makes the count a walk on $S=1024$ vertices, so it is
...
OEIS A264001 is ``Number of (n+1)X(4+1) arrays of permutations of 0..n*5+4 with each element having index change (+-,+-) 0,0 1,2 or 1,0.''. It has offset $1$ and begins
\[
288, 8679, 791245, 50616720, 3817152613, 271516496545, 19822414498720, 1432638894343943,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 10 2015 10:17:53, revision 6) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{The object is a matching}

The grid has $W=5$ rows across and holds each of $0,1,\dots,LW-1$ exactly once. The value
...
\[
(i-h_i,\,j-h_j)\;\in\;\{(-1,-2),\ (-1,0),\ (-1,2),\ (0,0),\ (1,-2),\ (1,0),\ (1,2)\},
\]
...
Hence $a$ is a walk count on $S=1024$ vertices,
\[
...
\begin{theorem}
\[
a(n)\;=\;50\,a(n-1) + 2875\,a(n-2) - 69880\,a(n-3) - 2008863\,a(n-4) + 34481460\,a(n-5) + 424664817\,a(n-6) - 6547031494\,a(n-7) - 20222380899\,a(n-8) + 478816817092\,a(n-9) - 1562080962409\,a(n-10) - 10431531548872\,a(n-11) + 119910039231312\,a(n-12) - 60142902473088\,a(n-13) - 2339051645501952\,a(n-14) + 2569755494551552\,a(n-15) + 11855594552791040\,a(n-16) + 3737073326620672\,a(n-17) + 28313788756590592\,a(n-18) - 80667450339753984\,a(n-19) + 150350372894932992\,a(n-20) - 83981604132749312\,a(n-21) - 1823349379172401152\,a(n-22) + 1401420734823137280\,a(n-23) + 2239178480786866176\,a(n-24) - 1256030644895481856\,a(n-25) - 805031842280374272\,a(n-26) + 143810417196531712\,a(n-27) + 71886001504518144\,a(n-28) - 2226511046246400\,a(n-29) - 801543976648704\,a(n-30)
\]
for every $n>28$.
\end{theorem}
...
transposed companion A263966. Second, the transfer model reproduces all $13$ terms this
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264001.
