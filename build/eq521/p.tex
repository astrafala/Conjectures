...
\title{A proof of the conjectured generating function for OEIS A212938}
...
\begin{abstract}
OEIS A212938 carries a conjectured generating function. We prove it. The entry states, as fact,
...
OEIS A212938 is ``Number of n X 3 0..2 arrays with no column j greater than or equal to than column j-1 in all rows''. It has offset $1$ and begins
\[
a(1),\dots,a(8)\;=\;1, 181, 9019, 331489, 10669771, 320396041, 9245913139, 260489615329,\ \dots
\]
The entry states, not as a conjecture,
\begin{quote}\small
a(n) = 10\textasciicircum{}n - 2*18\textasciicircum{}n + 27\textasciicircum{}n. - \emph{Vaclav Kotesovec}, May 31 2012
\end{quote}
and separately carries the comment
\begin{quote}\small
g.f.: x*(1 + 126*x) / ((1 - 10*x)*(1 - 18*x)*(1 - 27*x)). - \emph{Colin Barker}, Jul 21 2018
\end{quote}
As of the ``Last modified'' line on the live entry (2018-07-21, revision 13) the second
...
-4860\,a(n) + 936\,a(n+1) - 55\,a(n+2) + 1\,a(n+3) \;=\; 0
\end{equation}
...
For all $n\ge 1$,
\[
\sum_{n\ge 1} a(n)x^{n} \;=\; - \frac{x \left(126 x + 1\right)}{\left(10 x - 1\right) \left(18 x - 1\right) \left(27 x - 1\right)}
\]
\end{theorem}
...
\url{https://oeis.org}, 2026. Sequence A212938.
