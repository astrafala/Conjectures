...
\title{The empirical recurrence for OEIS A228385, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A228385 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A228385 is ``Number of n X 3 binary arrays with top left value 1 and no two ones adjacent horizontally or vertically.''. It has offset $1$ and begins
\[
2, 5, 21, 72, 268, 963, 3513, 12732,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) + 6*a(n-2) - a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 11 2018 05:41:16, revision 11) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A228385.
