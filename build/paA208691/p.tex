...
\title{The empirical recurrence for OEIS A208691, proved by transfer matrix}
...
\begin{abstract}
OEIS A208691 counts arrays over $\{0,\dots,1\}$ of width $5$ that avoid the patterns
...
OEIS A208691 is ``Number of 5 X n 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 1 1 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
14, 196, 490, 3430, 12096, 66094, 269766,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) + 17*a(n-2) + 4*a(n-3) - 32*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 05 2018 13:54:39, revision
8) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 17\,a(n-2) + 4\,a(n-3) - 32\,a(n-4)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208691.
