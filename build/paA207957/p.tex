...
\title{The empirical recurrence for OEIS A207957, proved by transfer matrix}
...
\begin{abstract}
OEIS A207957 counts arrays over $\{0,\dots,1\}$ of width $5$ that avoid the patterns
$(0,0,0), (1,0,1)$ along one axis and $(0,0,1), (1,0,0)$ along the other, and carries an empirical recurrence of
...
OEIS A207957 is ``Number of nX5 0..1 arrays avoiding 0 0 0 and 1 0 1 horizontally and 0 0 1 and 1 0 0 vertically.''. It has offset
$1$ and begins
\[
13, 169, 699, 3080, 15839, 84013, 463482,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:31:32, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;11\,a(n-1) - 14\,a(n-2) - 203\,a(n-3) + 563\,a(n-4) + 1329\,a(n-5) - 5460\,a(n-6) - 3116\,a(n-7) + 25220\,a(n-8) - 3605\,a(n-9) - 62985\,a(n-10) + 33885\,a(n-11) + 86009\,a(n-12) - 71075\,a(n-13) - 59522\,a(n-14) + 69044\,a(n-15) + 15374\,a(n-16) - 32682\,a(n-17) + 2168\,a(n-18) + 6860\,a(n-19) - 1480\,a(n-20) - 448\,a(n-21) + 128\,a(n-22)
\end{equation}
for all $n>21$. 
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207957.
