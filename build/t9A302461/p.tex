...
\title{The empirical recurrence for OEIS A302461, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A302461 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A302461 is ``Number of 3Xn 0..1 arrays with every element equal to 0, 2, 3 or 5 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
4, 2, 18, 8, 44, 56, 140, 364,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 08 2018 10:03:39, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 10\,a(n-2) - 15\,a(n-3) - 46\,a(n-4) + 49\,a(n-5) + 121\,a(n-6) - 95\,a(n-7) - 193\,a(n-8) + 123\,a(n-9) + 187\,a(n-10) - 126\,a(n-11) - 96\,a(n-12) + 78\,a(n-13) + 20\,a(n-14) - 24\,a(n-15) + 6\,a(n-16) + 20\,a(n-17) - 4\,a(n-19)
\end{equation}
for all $n>20$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302461.
