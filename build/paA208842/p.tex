...
\title{The empirical recurrence for OEIS A208842, proved by transfer matrix}
...
\begin{abstract}
OEIS A208842 counts arrays over $\{0,\dots,1\}$ of width $5$ that avoid the patterns
...
OEIS A208842 is ``Number of 5 X n 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 1 1 and 1 1 0 vertically.''. It has offset
$1$ and begins
\[
14, 196, 406, 3010, 8736, 49126, 169974,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) + 12*a(n-2) - 11*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 07 2018 06:17:41, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 12\,a(n-2) - 11\,a(n-3)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208842.
