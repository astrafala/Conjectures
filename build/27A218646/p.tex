...
\title{The empirical recurrence for OEIS A218646, proved by transfer matrix}
...
\begin{abstract}
OEIS A218646 counts the distinct arrays obtained by applying a fixed local operation to every cell
of an array over a bounded alphabet, and carries an empirical recurrence of order $26$
...
$S=421$ states, after which the conjectured recurrence is settled by a finite exact
computation.
\end{abstract}
...
OEIS A218646 is ``Number of nX3 arrays of the minimum value of corresponding elements and their horizontal, vertical or antidiagonal neighbors in a random 0..3 nX3 array.''. It has offset $1$ and begins
\[
16, 66, 610, 4946, 44712, 391888, 3441914, 30316230,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 17:44:43, revision 8) this is still
...
\]
There are $S=421$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite.
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-1) + 6\,a(n-2) + 27\,a(n-3) - 123\,a(n-4) - 58\,a(n-5) - 2059\,a(n-6) - 689\,a(n-7) + 846\,a(n-8) - 1326\,a(n-9) + 10232\,a(n-10) + 28870\,a(n-11) - 23223\,a(n-12) - 76249\,a(n-13) + 22843\,a(n-14) + 95384\,a(n-15) - 10406\,a(n-16) - 67533\,a(n-17) - 2090\,a(n-18) + 30314\,a(n-19) + 3123\,a(n-20) - 7834\,a(n-21) - 1293\,a(n-22) + 1062\,a(n-23) + 240\,a(n-24) - 56\,a(n-25) - 15\,a(n-26)
\]
for every $n>27$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A218646.
