...
\title{The empirical recurrence for OEIS A258551, proved by transfer matrix}
...
\begin{abstract}
OEIS A258551 counts the arrays over $\{0,\dots,1\}$ whose $2\times2$ subblocks carry a
...
so a pair of consecutive array rows is a state, the count is a walk count on $S=480$ of them,
...
OEIS A258551 is ``Number of (n+1) X (5+1) 0..1 arrays with every 2 X 2 subblock ne-sw antidiagonal difference nondecreasing horizontally and nw+se diagonal sum nondecreasing vertically.''. It has offset $1$ and begins
\[
480, 506, 1403, 2509, 5070, 8339, 12940, 18630,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) - 6*a(n-2) + 4*a(n-3) - 4*a(n-5) + 6*a(n-6) - 4*a(n-7) + a(n-8) for n>13.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 21 2018 14:23:55, revision 7) this is still
...
\]
on the $S=480$ admissible pairs. In particular $a$ is $C$-finite. The alignment of the walk
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A258551.
