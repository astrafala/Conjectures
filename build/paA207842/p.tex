...
\title{The empirical recurrence for OEIS A207842, proved by transfer matrix}
...
\begin{abstract}
OEIS A207842 counts arrays over $\{0,\dots,1\}$ of width $5$ that avoid the patterns
...
OEIS A207842 is ``Number of nX5 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 0 0 and 1 1 1 vertically.''. It has offset
$1$ and begins
\[
16, 256, 432, 2320, 10144, 41444, 185136,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:20:57, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-2) + 48\,a(n-3) + 76\,a(n-4) + 109\,a(n-5) - 87\,a(n-6) - 231\,a(n-7) - 212\,a(n-8) - 604\,a(n-9) - 224\,a(n-10) - 993\,a(n-11) + 224\,a(n-12) - 604\,a(n-13) + 212\,a(n-14) - 231\,a(n-15) + 87\,a(n-16) + 109\,a(n-17) - 76\,a(n-18) + 48\,a(n-19) - 3\,a(n-20) + a(n-22)
\end{equation}
for all $n>22$. 
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207842.
