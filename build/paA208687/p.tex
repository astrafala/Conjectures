...
\title{The empirical recurrence for OEIS A208687, proved by transfer matrix}
...
\begin{abstract}
OEIS A208687 counts arrays over $\{0,\dots,1\}$ of width $7$ that avoid the patterns
...
OEIS A208687 is ``Number of nX7 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 1 1 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
42, 1764, 7086, 40581, 269766, 1346961, 6398617,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:58:07, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208687.
