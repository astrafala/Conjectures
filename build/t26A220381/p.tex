...
\title{The empirical recurrence for OEIS A220381, proved by transfer matrix}
...
\begin{abstract}
OEIS A220381 counts the distinct indicator arrays obtained from the $n\times3$ arrays over
...
OEIS A220381 is ``Majority value maps: number of n X 3 binary arrays indicating the locations of corresponding elements equal to at least half of their horizontal and antidiagonal neighbors in a random 0..1 n X 3 array.''. It has offset $1$ and begins
\[
4, 25, 136, 753, 4160, 22989, 127037, 702009,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) + 8*a(n-2) + 3*a(n-3) - 3*a(n-4) - 2*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 31 2018 08:53:34, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + 8\,a(n-2) + 3\,a(n-3) - 3\,a(n-4) - 2\,a(n-5)
\]
for every $n>5$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A220381.
