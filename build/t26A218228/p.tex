...
\title{The empirical recurrence for OEIS A218228, proved by transfer matrix}
...
\begin{abstract}
OEIS A218228 counts the distinct indicator arrays obtained from the $n\times3$ arrays over
...
indicator row by row turns it into one, on $S=86$ states, after which the conjectured
...
OEIS A218228 is ``Hilltop maps: number of nX3 binary arrays indicating the locations of corresponding elements not exceeded by any horizontal, vertical or antidiagonal neighbor in a random 0..2 nX3 array.''. It has offset $1$ and begins
\[
7, 61, 497, 3969, 31739, 253825, 2029849, 16232833,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 17:37:11, revision 8) this is still
...
\]
There are $S=86$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite. Note
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-1) + 7\,a(n-2) + 7\,a(n-3) + 5\,a(n-4) + 9\,a(n-5) + 9\,a(n-6) + 9\,a(n-7) + 8\,a(n-8) + 4\,a(n-9) + a(n-10) + a(n-11) + a(n-12) + a(n-13) - a(n-14) - a(n-15) - a(n-16) - a(n-17)
\]
for every $n>17$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A218228.
