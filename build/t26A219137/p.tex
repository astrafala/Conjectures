...
\title{The empirical recurrence for OEIS A219137, proved by transfer matrix}
...
\begin{abstract}
OEIS A219137 counts the distinct indicator arrays obtained from the $n\times3$ arrays over
...
OEIS A219137 is ``Unchanging value maps: number of n X 3 binary arrays indicating the locations of corresponding elements unequal to no horizontal, diagonal or antidiagonal neighbor in a random 0..2 n X 3 array.''. It has offset $1$ and begins
\[
4, 18, 78, 331, 1400, 5949, 25277, 107353,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) + a(n-2) + a(n-3) - 12*a(n-5) - 10*a(n-6) + 2*a(n-7) + 4*a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 25 2018 05:35:37, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + a(n-2) + a(n-3) - 12\,a(n-5) - 10\,a(n-6) + 2\,a(n-7) + 4\,a(n-8)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A219137.
