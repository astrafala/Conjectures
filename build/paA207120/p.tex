...
\title{The empirical recurrence for OEIS A207120, proved by transfer matrix}
...
\begin{abstract}
OEIS A207120 counts arrays over $\{0,\dots,1\}$ of width $5$ that avoid the patterns
...
OEIS A207120 is ``Number of nX5 0..1 arrays avoiding 0 0 1 and 0 1 0 horizontally and 0 0 1 and 0 1 1 vertically.''. It has offset
$1$ and begins
\[
14, 196, 896, 4096, 12288, 36864, 87744,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 13:30:05, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207120.
