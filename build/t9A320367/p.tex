...
\title{The empirical recurrence for OEIS A320367, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A320367 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A320367 is ``Number of nX4 0..1 arrays with every element unequal to 0, 1, 2, 3 or 4 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
8, 128, 1612, 19840, 245060, 3027408, 37398884, 462004160,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 16*a(n-1) -50*a(n-2) +68*a(n-3) -85*a(n-4) +12*a(n-5) -36*a(n-6) -12*a(n-7) +12*a(n-8) +16*a(n-9)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 11 2018 14:09:26, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;16\,a(n-1) - 50\,a(n-2) + 68\,a(n-3) - 85\,a(n-4) + 12\,a(n-5) - 36\,a(n-6) - 12\,a(n-7) + 12\,a(n-8) + 16\,a(n-9)
\end{equation}
for all $n>10$.
...
\#\{\text{neighbours with a value }different from\ x_{t,u}\}\in\{0,1,2,3,4\}
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A320367.
