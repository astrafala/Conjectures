...
\title{The empirical recurrence for OEIS A208112, proved by transfer matrix}
...
\begin{abstract}
OEIS A208112 counts arrays over $\{0,\dots,1\}$ of width $7$ that avoid the patterns
...
OEIS A208112 is ``Number of 7Xn 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 1 1 and 1 1 0 vertically.''. It has offset
$1$ and begins
\[
35, 1225, 2485, 5041, 89815, 1600225, 4747545,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) +34*a(n-3) +1153*a(n-4) -1184*a(n-5) -1088*a(n-6) -33792*a(n-8) +32768*a(n-9)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:38:52, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 34\,a(n-3) + 1153\,a(n-4) - 1184\,a(n-5) - 1088\,a(n-6) - 33792\,a(n-8) + 32768\,a(n-9)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208112.
