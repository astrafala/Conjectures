...
\title{The empirical recurrence for OEIS A208024, proved by transfer matrix}
...
\begin{abstract}
OEIS A208024 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
...
OEIS A208024 is ``Number of nX4 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 0 0 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
10, 100, 378, 1377, 4823, 17119, 61292,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:34:40, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + a(n-2) + 20\,a(n-3) + 27\,a(n-4) + 34\,a(n-5) - 21\,a(n-6) - 105\,a(n-7) - 149\,a(n-8) + 6\,a(n-9) + 254\,a(n-10) + 227\,a(n-11) - 101\,a(n-12) - 242\,a(n-13) - 93\,a(n-14) + 86\,a(n-15) + 77\,a(n-16) + 15\,a(n-17) - 34\,a(n-18) - 9\,a(n-19) - 5\,a(n-20) + 7\,a(n-21) - 2\,a(n-22) - a(n-24)
\end{equation}
for all $n>23$. 
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208024.
