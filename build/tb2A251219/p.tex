...
\title{The empirical column recurrences for the table OEIS A251219}
...
\begin{abstract}
OEIS A251219 is a two-dimensional table $T(n,k)$, and it carries a block of empirical
...
OEIS A251219 is ``T(n,k)=Number of (n+1)X(k+1) 0..1 arrays with no 2X2 subblock having zero or two 1s.''. It has offset $1$, is
read by antidiagonals, and begins
\[
9, 21, 21, 49, 63, 49, 115, 191,\ \dots
\]
...
k=6: [order 62]\\
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:11:21, revision 6) these are still
...
The sequence is ``Number of (n+1)X(2) 0..1 arrays with no 2X2 subblock having zero or two 1s.''. Its rows are the vertices of a digraph on
...
The sequence is ``Number of (n+1)X(3) 0..1 arrays with no 2X2 subblock having zero or two 1s.''. Its rows are the vertices of a digraph on
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251219.
