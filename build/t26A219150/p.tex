...
\title{The empirical recurrence for OEIS A219150, proved by transfer matrix}
...
\begin{abstract}
OEIS A219150 counts the distinct indicator arrays obtained from the $n\times2$ arrays over
...
indicator row by row turns it into one, on $S=7$ states, after which the conjectured
...
OEIS A219150 is ``Unchanging value maps: number of n X 2 binary arrays indicating the locations of corresponding elements unequal to no horizontal, antidiagonal or vertical neighbor in a random 0..1 n X 2 array.''. It has offset $1$ and begins
\[
2, 4, 9, 21, 49, 115, 269, 628,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) - a(n-2) + 4*a(n-3) + a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 25 2018 08:06:10, revision 7) this is still
...
\]
There are $S=7$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite. Note
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A219150.
