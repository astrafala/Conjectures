...
\title{The empirical recurrence for OEIS A302209, proved by transfer matrix}
...
\begin{abstract}
OEIS A302209 counts $5$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the six horizontal, diagonal and antidiagonal neighbours, a number $equal to$ itself lying in $\{0,2,3\}$, and it carries an empirical
...
OEIS A302209 is ``Number of nX5 0..1 arrays with every element equal to 0, 2 or 3 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 34, 32, 111, 448, 1725, 6423, 24927,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 03 2018 11:59:48, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;7\,a(n-1) - 16\,a(n-2) + 43\,a(n-3) - 167\,a(n-4) + 289\,a(n-5) - 491\,a(n-6) + 1395\,a(n-7) - 1918\,a(n-8) + 2105\,a(n-9) - 4845\,a(n-10) + 5894\,a(n-11) - 2484\,a(n-12) + 7527\,a(n-13) - 10198\,a(n-14) - 8382\,a(n-15) - 6549\,a(n-16) + 12610\,a(n-17) + 32961\,a(n-18) + 12280\,a(n-19) - 7213\,a(n-20) - 49277\,a(n-21) - 21675\,a(n-22) - 15454\,a(n-23) + 41277\,a(n-24) + 12068\,a(n-25) + 27412\,a(n-26) - 15746\,a(n-27) + 1598\,a(n-28) - 14336\,a(n-29) + 2718\,a(n-30) - 5912\,a(n-31) + 3644\,a(n-32) - 1164\,a(n-33) + 2304\,a(n-34) - 272\,a(n-35) + 160\,a(n-36) - 192\,a(n-37)
\end{equation}
for all $n>40$.
...
has score in $\{0,2,3\}$. The entry also fixes the top-left entry to be $0$; that is a condition on the first row alone, so it restricts the start vector and nothing else.
...
\begin{itemize}
\item $\mathbf{s}(r,s)=1$ when every cell of $r$ has score in $\{0,2,3\}$ \emph{with no row
above $r$} and $r_1=0$, and $0$ otherwise;
\item an edge $(r,s)\to(s,t)$ when every cell of $s$ has score in $\{0,2,3\}$ computed from
$r$, $s$ and $t$;
\item $\mathbf{e}(r,s)=1$ when every cell of $s$ has score in $\{0,2,3\}$ \emph{with no row
...
exactly when every one of its $n$ rows has all scores in $\{0,2,3\}$. Read the sequence as the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302209.
