...
\title{The empirical recurrence for OEIS A207947, proved by transfer matrix}
...
\begin{abstract}
OEIS A207947 counts arrays over $\{0,\dots,1\}$ of width $6$ that avoid the patterns
...
OEIS A207947 is ``Number of nX6 0..1 arrays avoiding 0 0 1 and 0 1 1 horizontally and 0 1 0 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
16, 256, 1296, 8836, 55696, 362404, 2334784,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:30:34, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) + 7\,a(n-2) + a(n-3) + 76\,a(n-4) + 105\,a(n-5) - 4\,a(n-6) - 115\,a(n-7) - 119\,a(n-8) + a(n-9) + 29\,a(n-10) + 41\,a(n-11) - 8\,a(n-12) - 4\,a(n-14) + a(n-15)
\end{equation}
for all $n>14$. 
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207947.
