...
\title{The empirical recurrence for OEIS A207685, proved by transfer matrix}
...
\begin{abstract}
OEIS A207685 counts arrays over $\{0,\dots,1\}$ of width $5$ that avoid the patterns
$(0,0,1), (1,1,1)$ along one axis and $(0,0,0), (1,0,1)$ along the other, and carries an empirical recurrence of
order $42$ contributed by R.~H.~Hardin. It is true. The patterns have length $3$, so
...
$\mathbf{1}^{\!\top}P^{\,n-2-42}q(P)\mathbf{1}$, which vanishes identically
...
OEIS A207685 is ``Number of 5Xn 0..1 arrays avoiding 0 0 0 and 1 0 1 horizontally and 0 0 1 and 1 1 1 vertically.''. It has offset
$1$ and begins
\[
13, 169, 360, 1030, 2310, 5704, 14090,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:09:38, revision
...
a(n)\;=\;16\,a(n-3) + 18\,a(n-4) + 4\,a(n-5) - 102\,a(n-6) - 154\,a(n-7) - 84\,a(n-8) + 386\,a(n-9) + 535\,a(n-10) + 320\,a(n-11) - 963\,a(n-12) - 846\,a(n-13) - 237\,a(n-14) + 1978\,a(n-15) - 46\,a(n-16) - 1602\,a(n-17) - 2347\,a(n-18) + 2876\,a(n-19) + 3441\,a(n-20) + 210\,a(n-21) - 4150\,a(n-22) - 3538\,a(n-23) + 3295\,a(n-24) + 3502\,a(n-25) + 1931\,a(n-26) - 4582\,a(n-27) - 1827\,a(n-28) - 1482\,a(n-29) + 3608\,a(n-30) - 524\,a(n-31) + 1647\,a(n-32) - 1776\,a(n-33) + 1009\,a(n-34) - 662\,a(n-35) + 340\,a(n-36) - 342\,a(n-37) + 86\,a(n-38) + 8\,a(n-39) + 46\,a(n-40) + 3\,a(n-42)
\end{equation}
for all $n>42$. The entry's array has a fixed number of rows and a growing number of
...
$a(n)-\sum_i c_i a(n-i)=u_{\,n-2-42}$ whenever $n-42\ge2$. Hence
\eqref{eq:conj} holds for every $n>t$ exactly when $u_j=0$ for every
$j>t-2-42$. Moreover $(u_j)$ satisfies the monic linear recurrence whose
...
$P^{\,n-2-42}$ gives the identity. The equivalence follows by letting the exponent
...
\begin{proof}
The vector $q(P)\mathbf{1}\in\mathbb{Z}^{S}$ was formed by $42$ matrix--vector
products in exact integer arithmetic and the $u_j$ evaluated in turn. They vanish from the
index corresponding to $n=42+1$ onwards, and the run was continued past $S$ consecutive
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207685.
