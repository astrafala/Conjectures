...
\title{The empirical recurrence for OEIS A305037, proved by transfer matrix}
...
\begin{abstract}
OEIS A305037 counts $5$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A305037 is ``Number of nX5 0..1 arrays with every element unequal to 0, 1, 2, 6 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
16, 8, 13, 26, 43, 109, 319, 718,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +9*a(n-3) +2*a(n-4) -14*a(n-6) -4*a(n-7) for n>11
\end{quote}
As of the ``Last modified'' line on the live entry (May 24 2018 08:41:59, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 9\,a(n-3) + 2\,a(n-4) - 14\,a(n-6) - 4\,a(n-7)
\end{equation}
for all $n>10$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A305037.
