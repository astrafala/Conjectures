...
\title{The empirical recurrence for OEIS A189651, proved by transfer matrix}
...
\begin{abstract}
OEIS A189651 counts the permutations of the cells of an $n\times3$ array in which every cell
...
OEIS A189651 is ``Number of 3Xn array permutations with each element moving zero or one space horizontally, diagonally or antidiagonally.''. It has offset $1$ and begins
\[
1, 32, 263, 4277, 55440, 799069, 11047585, 155610272,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 05:22:58, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;10\,a(n-1) + 75\,a(n-2) - 240\,a(n-3) - 399\,a(n-4) + 972\,a(n-5) - 1263\,a(n-6) + 482\,a(n-7) + 669\,a(n-8) - 100\,a(n-9) - 9\,a(n-10)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A189651.
