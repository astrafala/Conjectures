...
\title{The empirical recurrence for OEIS A306138, proved by transfer matrix}
...
\begin{abstract}
OEIS A306138 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A306138 is ``Number of nX3 0..1 arrays with every element unequal to 1, 2, 3, 4, 6 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 23, 90, 521, 2787, 14804, 79839, 428041,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 22 2018 07:53:36, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 11\,a(n-2) + 16\,a(n-3) - 34\,a(n-4) - 20\,a(n-5) + 28\,a(n-6) - 49\,a(n-8) - 17\,a(n-9) + 37\,a(n-10) - 2\,a(n-11) - 36\,a(n-12) - 56\,a(n-13) - 16\,a(n-14) + 16\,a(n-15)
\end{equation}
for all $n>15$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A306138.
