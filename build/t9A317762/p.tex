...
\title{The empirical recurrence for OEIS A317762, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A317762 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A317762 is ``Number of nX6 0..1 arrays with every element unequal to 0, 1 or 2 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
32, 89, 100, 127, 177, 266, 425, 709,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) +a(n-2) -2*a(n-3) -a(n-4) +a(n-7) for n>10
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 06 2018 11:50:49, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + a(n-2) - 2\,a(n-3) - a(n-4) + a(n-7)
\end{equation}
for all $n>10$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A317762.
