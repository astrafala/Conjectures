...
\title{The empirical recurrence for OEIS A230245, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A230245 counts arrays over $\{0,\dots,3\}$ in which every cell is constrained by the
...
OEIS A230245 is ``Number of n X 2 0..3 arrays x(i,j) with each element horizontally or vertically next to at least one element with value (x(i,j)+1) mod 4, and upper left element zero.''. It has offset $1$ and begins
\[
0, 2, 6, 26, 118, 522, 2310, 10234,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 4*a(n-1) + a(n-2) + 4*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 17 2018 05:45:30, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A230245.
