...
\title{The empirical recurrence for OEIS A317371, proved by transfer matrix}
...
\begin{abstract}
OEIS A317371 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A317371 is ``Number of nX3 0..1 arrays with every element unequal to 1, 2, 3, 4, 6, 7 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 23, 91, 529, 2870, 15382, 83982, 455180,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 26 2018 16:48:36, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 12\,a(n-2) + 15\,a(n-3) - 42\,a(n-4) - 28\,a(n-5) + 16\,a(n-6) + 4\,a(n-7) - 41\,a(n-8) - 5\,a(n-9) + 66\,a(n-10) + 45\,a(n-11) - 2\,a(n-12) - 50\,a(n-13) - 12\,a(n-14) + 12\,a(n-15)
\end{equation}
for all $n>15$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A317371.
