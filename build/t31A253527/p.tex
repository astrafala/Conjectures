...
\title{The empirical recurrence for OEIS A253527, proved by transfer matrix}
...
\begin{abstract}
OEIS A253527 counts the arrays over $\{0,\dots,2\}$ whose $2\times2$ subblocks carry a
...
so a pair of consecutive array rows is a state, the count is a walk count on $S=459$ of them,
...
OEIS A253527 is ``Number of (n+1)X(2+1) 0..2 arrays with every 2X2 subblock antidiagonal maximum minus diagonal minimum nondecreasing horizontally and diagonal maximum minus antidiagonal minimum nondecreasing vertically.''. It has offset $1$ and begins
\[
459, 2722, 9255, 27070, 71333, 176266, 416901, 955594,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 14:06:03, revision 6) this is still
...
\]
on the $S=459$ admissible pairs. In particular $a$ is $C$-finite. The alignment of the walk
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-1) - 12\,a(n-2) - 24\,a(n-3) + 97\,a(n-4) - 31\,a(n-5) - 238\,a(n-6) + 262\,a(n-7) + 225\,a(n-8) - 495\,a(n-9) + 16\,a(n-10) + 428\,a(n-11) - 193\,a(n-12) - 161\,a(n-13) + 138\,a(n-14) + 6\,a(n-15) - 32\,a(n-16) + 8\,a(n-17)
\]
for every $n>27$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253527.
