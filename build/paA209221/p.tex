...
\title{The empirical recurrence for OEIS A209221, proved by transfer matrix}
...
\begin{abstract}
OEIS A209221 counts arrays over $\{0,\dots,1\}$ of width $5$ that avoid the patterns
...
OEIS A209221 is ``Number of nX5 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 1 0 and 1 1 1 vertically.''. It has offset
$1$ and begins
\[
15, 225, 240, 504, 900, 1776, 3456,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 15:11:44, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;9\,a(n-3) + 2\,a(n-4) - 33\,a(n-6) + 10\,a(n-7) + 3\,a(n-8) + 66\,a(n-9) - 33\,a(n-10) + 5\,a(n-11) - 83\,a(n-12) + 39\,a(n-13) - 20\,a(n-14) + 78\,a(n-15) + 3\,a(n-16) - 7\,a(n-17) - 45\,a(n-18) - 30\,a(n-19) + 8\,a(n-20) + 22\,a(n-21) + 10\,a(n-22) + 2\,a(n-23) - 6\,a(n-24) + a(n-25) + a(n-27)
\end{equation}
for all $n>27$. 
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209221.
