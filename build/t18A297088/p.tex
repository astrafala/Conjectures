...
\title{The empirical recurrence for OEIS A297088, proved by transfer matrix}
...
\begin{abstract}
OEIS A297088 counts $n\times2$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A297088 is ``Number of n X 2 0..1 arrays with no 1 adjacent to 3 king-move neighboring 1s.''. It has offset $1$ and begins
\[
4, 15, 45, 152, 511, 1681, 5588, 18575,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) - 2*a(n-2) + 3*a(n-3) - 14*a(n-4) + 4*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 26 2019 08:20:51, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) - 2\,a(n-2) + 3\,a(n-3) - 14\,a(n-4) + 4\,a(n-5)
\]
for every $n>5$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297088.
