...
\title{The empirical recurrence for OEIS A207090, proved by transfer matrix}
...
\begin{abstract}
OEIS A207090 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
...
OEIS A207090 is ``Number of 4Xn 0..1 arrays avoiding 0 0 0 horizontally and 0 0 1 vertically.''. It has offset
$1$ and begins
\[
12, 144, 1117, 10621, 98824, 894720, 8244759,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 13:27:37, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 28\,a(n-2) + 344\,a(n-3) + 816\,a(n-4) + 1294\,a(n-5) - 10338\,a(n-6) - 19356\,a(n-7) - 50027\,a(n-8) + 175117\,a(n-9) + 123758\,a(n-10) + 709272\,a(n-11) - 1835144\,a(n-12) + 318196\,a(n-13) - 5529708\,a(n-14) + 11398328\,a(n-15) - 5985344\,a(n-16) + 22648164\,a(n-17) - 37478232\,a(n-18) + 19283976\,a(n-19) - 44313168\,a(n-20) + 60601968\,a(n-21) - 20512576\,a(n-22) + 37990000\,a(n-23) - 47677312\,a(n-24) + 5766976\,a(n-25) - 13423872\,a(n-26) + 20094976\,a(n-27) - 238592\,a(n-28) + 1727488\,a(n-29) - 4091904\,a(n-30) + 18432\,a(n-31) + 331776\,a(n-33)
\end{equation}
for all $n>32$. The entry's array has a fixed number of rows and a growing number of
...
$(0,0,1)$ as $3$ consecutive entries. There are $12$ admissible columns; that condition
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207090.
