...
\title{The empirical recurrence for OEIS A282642, proved by transfer matrix}
...
\begin{abstract}
OEIS A282642 counts $n\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A282642 is ``Number of n X 3 0..1 arrays with no 1 equal to more than one of its king-move neighbors.''. It has offset $1$ and begins
\[
7, 27, 99, 413, 1601, 6349, 25153, 99287,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + 6*a(n-2) + 8*a(n-3) - 5*a(n-4) + 2*a(n-5) - 2*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 20 2019 12:24:43, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 6\,a(n-2) + 8\,a(n-3) - 5\,a(n-4) + 2\,a(n-5) - 2\,a(n-6)
\]
for every $n>6$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A282642.
