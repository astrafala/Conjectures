...
\title{The empirical recurrence for OEIS A231280, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A231280 counts arrays over $\{0,\dots,3\}$ in which every cell is constrained by the
...
OEIS A231280 is ``Number of n X 3 0..3 arrays x(i,j) with each element horizontally or antidiagonally next to at least one element with value (x(i,j)+1) mod 4, and upper left element zero.''. It has offset $1$ and begins
\[
0, 2, 8, 66, 400, 2722, 17688, 117026,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 4*a(n-1) + 17*a(n-2).
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 28 2018 06:57:58, revision 9) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A231280.
