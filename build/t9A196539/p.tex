...
\title{The empirical recurrence for OEIS A196539, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A196539 counts arrays over $\{0,\dots,4\}$ in which every cell is constrained by the
...
OEIS A196539 is ``Number of nX3 0..4 arrays with each element equal to the number its horizontal and vertical neighbors less than or equal to itself.''. It has offset $1$ and begins
\[
2, 56, 555, 11200, 112723, 1231014, 18047775, 249080912,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 06:35:41, revision 11) the statement is
...
x_{t,u}=\#\{\text{neighbours }y:\ y\le x_{t,u}\}
\end{equation}
for every cell $(t,u)$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A196539.
