...
\title{The empirical recurrence for OEIS A299723, proved by transfer matrix}
...
\begin{abstract}
OEIS A299723 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A299723 is ``Number of nX3 0..1 arrays with every element equal to 1, 2, 3, 4, 5, 6 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 18, 141, 1027, 7664, 57471, 430401, 3222716,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 6*a(n-1) +8*a(n-2) +20*a(n-3) +25*a(n-4) +11*a(n-5) +2*a(n-6) for n>7
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 17 2018 10:52:29, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A299723.
