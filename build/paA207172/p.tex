...
\title{The empirical recurrence for OEIS A207172, proved by transfer matrix}
...
\begin{abstract}
OEIS A207172 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
...
OEIS A207172 is ``Number of 4 X n 0..1 arrays avoiding 0 0 0 and 1 0 1 horizontally and 0 0 1 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
8, 64, 168, 603, 1612, 3952, 11452,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) + 13*a(n-3) + 3*a(n-4) + 3*a(n-5) - 27*a(n-6) - 18*a(n-7) + 27*a(n-9) for n>11.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 20 2018 09:45:47, revision
8) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 13\,a(n-3) + 3\,a(n-4) + 3\,a(n-5) - 27\,a(n-6) - 18\,a(n-7) + 27\,a(n-9)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207172.
