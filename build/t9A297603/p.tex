...
\title{The empirical recurrence for OEIS A297603, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297603 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A297603 is ``Number of nX4 0..1 arrays with every 1 horizontally, diagonally or antidiagonally adjacent to 0, 1 or 3 neighboring 1s.''. It has offset $1$ and begins
\[
13, 96, 787, 6413, 52512, 429491, 3514058, 28752016,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 01 2018 14:50:38, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;10\,a(n-1) - 15\,a(n-2) + 23\,a(n-3) - 194\,a(n-4) + 70\,a(n-5) + 255\,a(n-6) + 963\,a(n-7) + 726\,a(n-8) - 4023\,a(n-9) - 2056\,a(n-10) + 3928\,a(n-11) + 5067\,a(n-12) - 6036\,a(n-13) - 3432\,a(n-14) + 6721\,a(n-15) + 3158\,a(n-16) - 5982\,a(n-17) - 1559\,a(n-18) + 1385\,a(n-19) + 3525\,a(n-20) - 2268\,a(n-21) - 1131\,a(n-22) + 957\,a(n-23) + 179\,a(n-24) - 244\,a(n-25) - 33\,a(n-26) + 33\,a(n-27) + 6\,a(n-28) - 2\,a(n-29) + 2\,a(n-30) + a(n-31) - a(n-32)
\end{equation}
for all $n>33$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297603.
