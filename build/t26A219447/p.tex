...
\title{The empirical recurrence for OEIS A219447, proved by transfer matrix}
...
\begin{abstract}
OEIS A219447 counts the distinct indicator arrays obtained from the $n\times4$ arrays over
...
indicator row by row turns it into one, on $S=41$ states, after which the conjectured
...
OEIS A219447 is ``Unchanging value maps: number of nX4 binary arrays indicating the locations of corresponding elements unequal to no king-move neighbor in a random 0..2 nX4 array.''. It has offset $1$ and begins
\[
7, 7, 43, 169, 665, 2603, 10421, 41777,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 18:04:35, revision 8) this is still
...
\]
There are $S=41$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite. Note
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) - 7\,a(n-2) + 8\,a(n-3) + 20\,a(n-4) - 22\,a(n-5) + 6\,a(n-6) + 34\,a(n-7) + 15\,a(n-8) - 21\,a(n-9) - 28\,a(n-10) - 35\,a(n-11) - 9\,a(n-12) - a(n-13)
\]
for every $n>14$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A219447.
