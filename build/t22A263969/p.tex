...
\title{The empirical recurrence for OEIS A263969, proved by transfer matrix}
...
\begin{abstract}
OEIS A263969 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=3$ rows in which
...
OEIS A263969 is ``Number of (n+1)X(2+1) arrays of permutations of 0..n*3+2 with each element having index change (+-,+-) 0,2 1,1 or 1,0.''. It has offset $1$ and begins
\[
20, 72, 1441, 13856, 189993, 2215960, 28027420, 340646784,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 10 2015 10:27:54, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-1) + 80\,a(n-2) - 135\,a(n-3) - 591\,a(n-4) + 752\,a(n-5) - 823\,a(n-6) - 415\,a(n-7) + 768\,a(n-8) - 81\,a(n-9) - 9\,a(n-10)
\]
for every $n>8$.
\end{theorem}
...
transposed companion A263966. Second, the transfer model reproduces all $17$ terms this
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A263969.
