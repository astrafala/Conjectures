...
\title{The empirical recurrence for OEIS A295346, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A295346 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A295346 is ``Number of n X 2 0..1 arrays with each 1 horizontally or vertically adjacent to 0, 2 or 3 1s.''. It has offset $1$ and begins
\[
3, 8, 20, 51, 132, 341, 883, 2293,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 4*a(n-1) - 3*a(n-2) - 4*a(n-4) - a(n-5) + a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 26 2018 12:15:01, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) - 3\,a(n-2) - 4\,a(n-4) - a(n-5) + a(n-6)
\end{equation}
for all $n>7$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A295346.
