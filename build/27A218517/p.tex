...
\title{The empirical recurrence for OEIS A218517, proved by transfer matrix}
...
\begin{abstract}
OEIS A218517 counts the distinct arrays obtained by applying a fixed local operation to every cell
...
$S=146$ states, after which the conjectured recurrence is settled by a finite exact
computation.
\end{abstract}
...
OEIS A218517 is ``Number of n X 3 arrays of the minimum value of corresponding elements and their horizontal or antidiagonal neighbors in a random 0..3 n X 3 array.''. It has offset $1$ and begins
\[
16, 286, 4634, 76214, 1254462, 20655650, 340133516, 5601018048,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 18*a(n-1) - 19*a(n-2) - 96*a(n-3) - 112*a(n-4) - a(n-5) + 140*a(n-6) + 64*a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 24 2018 09:40:04, revision 7) this is still
...
\]
There are $S=146$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite.
...
\begin{theorem}
\[
a(n)\;=\;18\,a(n-1) - 19\,a(n-2) - 96\,a(n-3) - 112\,a(n-4) - a(n-5) + 140\,a(n-6) + 64\,a(n-7)
\]
for every $n>7$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A218517.
