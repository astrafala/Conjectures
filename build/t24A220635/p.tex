...
\title{The empirical recurrence for OEIS A220635, proved by transfer matrix}
...
\begin{abstract}
OEIS A220635 counts the ways of linking the cells of a grid $5$ cells wide, each cell either to
...
OEIS A220635 is ``Number of ways to reciprocally link elements of an 5Xn array either to themselves or to exactly two horizontal or antidiagonal neighbors.''. It has offset $1$ and begins
\[
1, 1, 8, 114, 1481, 17527, 201903, 2329448,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 18:55:49, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;16\,a(n-1) - 39\,a(n-2) - 186\,a(n-3) + 419\,a(n-4) + 1024\,a(n-5) - 1049\,a(n-6) - 2258\,a(n-7) + 861\,a(n-8) + 2000\,a(n-9) - 133\,a(n-10) - 586\,a(n-11) - 16\,a(n-12) + 32\,a(n-13)
\]
for every $n>17$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A220635.
