...
\title{The empirical recurrence for OEIS A316213, proved by transfer matrix}
...
\begin{abstract}
OEIS A316213 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A316213 is ``Number of nX3 0..1 arrays with every element unequal to 0, 1, 2, 4, 5 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
4, 14, 28, 75, 250, 706, 2116, 6399,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 26 2018 17:48:15, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 4\,a(n-2) + 5\,a(n-3) - 13\,a(n-4) - 31\,a(n-5) - 25\,a(n-6) + 30\,a(n-7) + 75\,a(n-8) + 66\,a(n-9) - 11\,a(n-10) - 52\,a(n-11) - 18\,a(n-12) - 12\,a(n-13) - 24\,a(n-14) - 27\,a(n-15)
\end{equation}
for all $n>15$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A316213.
