...
\title{The empirical recurrence for OEIS A220806, proved by transfer matrix}
...
\begin{abstract}
OEIS A220806 counts the distinct indicator arrays obtained from the $n\times2$ arrays over
...
indicator row by row turns it into one, on $S=40$ states, after which the conjectured
...
OEIS A220806 is ``Equals one maps: number of n X 2 binary arrays indicating the locations of corresponding elements equal to exactly one of their horizontal, vertical and antidiagonal neighbors in a random 0..2 n X 2 array.''. It has offset $1$ and begins
\[
2, 8, 38, 168, 726, 3088, 12974, 54000,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 7*a(n-1) - 11*a(n-2) - 3*a(n-3) - 4*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 13 2018 11:07:43, revision 8) this is still
...
\]
There are $S=40$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite. Note
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-1) - 11\,a(n-2) - 3\,a(n-3) - 4\,a(n-4)
\]
for every $n>4$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A220806.
