...
\title{The empirical recurrence for OEIS A220575, proved by transfer matrix}
...
\begin{abstract}
OEIS A220575 counts the distinct indicator arrays obtained from the $n\times4$ arrays over
...
indicator row by row turns it into one, on $S=357$ states, after which the conjectured
...
OEIS A220575 is ``Equals one maps: number of nX4 binary arrays indicating the locations of corresponding elements equal to exactly one of their horizontal and antidiagonal neighbors in a random 0..1 nX4 array.''. It has offset $1$ and begins
\[
8, 115, 1441, 17505, 205323, 2352642, 26616961, 299065708,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 18:51:31, revision 8) this is still
...
\]
There are $S=357$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite. Note
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A220575.
