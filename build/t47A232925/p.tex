...
\title{The empirical recurrence for OEIS A232925, proved by transfer matrix}
...
\begin{abstract}
OEIS A232925 counts arrays over $\{0,\dots,2\}$ in which no two entries that are neighbours in
...
carried by one bounded piece of extra state, so the count is a walk count on $S=729$ states.
\end{abstract}
...
OEIS A232925 is ``Number of 6Xn 0..2 arrays with no element x(i,j) adjacent to value 2-x(i,j) horizontally, diagonally or antidiagonally.''. It has offset $1$ and begins
\[
729, 1458, 23346, 235824, 2986152, 33994188, 409408542, 4791504648,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 07:44:00, revision 6) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The array is $6$ cells across with entries $x(i,j)\in\{0,1,2\}$. Call two values $u,v$ CLASHING
...
and the row above and every clash inside it. There are $S=729$ reachable states.
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) + 109\,a(n-2) - 256\,a(n-3) - 3152\,a(n-4) + 4016\,a(n-5) + 36307\,a(n-6) - 39164\,a(n-7) - 200969\,a(n-8) + 225166\,a(n-9) + 558858\,a(n-10) - 666143\,a(n-11) - 821349\,a(n-12) + 1028812\,a(n-13) + 665423\,a(n-14) - 859266\,a(n-15) - 301764\,a(n-16) + 388624\,a(n-17) + 75683\,a(n-18) - 91245\,a(n-19) - 9839\,a(n-20) + 10158\,a(n-21) + 486\,a(n-22) - 420\,a(n-23)
\]
for every $n>24$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232925.
