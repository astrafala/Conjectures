...
\title{The empirical recurrence for OEIS A316278, proved by transfer matrix}
...
\begin{abstract}
OEIS A316278 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $different from$ itself lying in $\{1,2,3,4,5,8\}$, and it carries an empirical
...
OEIS A316278 is ``Number of nX4 0..1 arrays with every element unequal to 1, 2, 3, 4, 5 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
2, 98, 846, 9540, 102072, 1099200, 11834419, 127394654,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 28 2018 15:21:53, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;7\,a(n-1) + 52\,a(n-2) - 19\,a(n-3) - 854\,a(n-4) - 2603\,a(n-5) - 3429\,a(n-6) + 1157\,a(n-7) + 8303\,a(n-8) + 14076\,a(n-9) + 9383\,a(n-10) + 1417\,a(n-11) - 8498\,a(n-12) - 5299\,a(n-13) - 7573\,a(n-14) - 7142\,a(n-15) - 9163\,a(n-16) - 1007\,a(n-17) + 3161\,a(n-18) + 384\,a(n-19) + 3327\,a(n-20) + 172\,a(n-21) + 2940\,a(n-22) - 289\,a(n-23) - 28\,a(n-24) - 324\,a(n-25) + 42\,a(n-26) + 28\,a(n-27)
\end{equation}
for all $n>27$.
...
has score in $\{1,2,3,4,5,8\}$. The entry also fixes the top-left entry to be $0$; that is a condition on the first row alone, so it restricts the start vector and nothing else.
...
\begin{itemize}
\item $\mathbf{s}(r,s)=1$ when every cell of $r$ has score in $\{1,2,3,4,5,8\}$ \emph{with no row
above $r$} and $r_1=0$, and $0$ otherwise;
\item an edge $(r,s)\to(s,t)$ when every cell of $s$ has score in $\{1,2,3,4,5,8\}$ computed from
$r$, $s$ and $t$;
\item $\mathbf{e}(r,s)=1$ when every cell of $s$ has score in $\{1,2,3,4,5,8\}$ \emph{with no row
...
exactly when every one of its $n$ rows has all scores in $\{1,2,3,4,5,8\}$. Read the sequence as the
...
compared against the entry's DATA at every one of the $17$ published indices; they
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A316278.
