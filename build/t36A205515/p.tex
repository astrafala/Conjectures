...
\title{The empirical recurrence for OEIS A205515, proved by transfer matrix}
...
\begin{abstract}
OEIS A205515 counts arrays over $\{0,\dots,2\}$ under a condition on the number of clockwise edge increases
...
OEIS A205515 is ``Number of (n+1)X4 0..2 arrays with the number of clockwise edge increases in every 2X2 subblock differing from each horizontal or vertical neighbor.''. It has offset $1$ and begins
\[
1683, 17166, 205803, 2343348, 27630789, 312856410, 3703472454, 41913844878,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 12:09:49, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;109\,a(n-2) + 2908\,a(n-4) + 57127\,a(n-6) + 121246\,a(n-8) + 256071\,a(n-10) - 166046\,a(n-12) + 879719\,a(n-14) - 1582201\,a(n-16) + 1663127\,a(n-18) + 1566104\,a(n-20) - 827026\,a(n-22) - 212087\,a(n-24) + 1333439\,a(n-26) - 568096\,a(n-28) - 811927\,a(n-30) + 48232\,a(n-32) + 136964\,a(n-34) + 17464\,a(n-36) - 428\,a(n-38) + 32\,a(n-40)
\]
for every $n>41$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A205515.
