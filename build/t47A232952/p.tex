...
\title{The empirical recurrence for OEIS A232952, proved by transfer matrix}
...
\begin{abstract}
OEIS A232952 counts arrays over $\{0,\dots,3\}$ in which no two entries that are neighbours in
...
carried by one bounded piece of extra state, so the count is a walk count on $S=324$ states.
\end{abstract}
...
OEIS A232952 is ``Number of nX5 0..3 arrays with no element x(i,j) adjacent to value 3-x(i,j) horizontally, diagonally or antidiagonally, and top left element zero.''. It has offset $1$ and begins
\[
81, 4629, 283131, 17429409, 1074244299, 66226131273, 4082986991091, 251727862281441,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 07:45:38, revision 6) this is still
...
and the row above and every clash inside it. There are $S=324$ reachable states.
...
\begin{theorem}
\[
a(n)\;=\;78\,a(n-1) - 1043\,a(n-2) + 2012\,a(n-3) + 10236\,a(n-4) - 39726\,a(n-5) + 41724\,a(n-6) - 6408\,a(n-7) - 8680\,a(n-8) + 2592\,a(n-9) - 96\,a(n-10)
\]
for every $n>10$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232952.
