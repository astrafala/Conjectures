...
\title{The empirical recurrence for OEIS A208505, proved by transfer matrix}
...
\begin{abstract}
OEIS A208505 counts arrays over $\{0,\dots,1\}$ of width $7$ that avoid the patterns
...
OEIS A208505 is ``Number of 7 X n 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 1 0 and 1 1 1 vertically.''. It has offset
$1$ and begins
\[
28, 784, 896, 3024, 9912, 33488, 111328,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) + 8*a(n-2) - 10*a(n-3) - 8*a(n-4) + 8*a(n-5) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 03 2018 14:56:21, revision
8) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 8\,a(n-2) - 10\,a(n-3) - 8\,a(n-4) + 8\,a(n-5)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208505.
