...
\title{The empirical recurrence for OEIS A207931, proved by transfer matrix}
...
\begin{abstract}
OEIS A207931 counts arrays over $\{0,\dots,1\}$ of width $5$ that avoid the patterns
...
OEIS A207931 is ``Number of 5Xn 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 0 0 and 1 1 1 vertically.''. It has offset
$1$ and begins
\[
16, 256, 704, 1936, 7744, 30976, 111584,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:29:17, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207931.
