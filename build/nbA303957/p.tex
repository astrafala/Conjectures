...
\title{The empirical recurrence for OEIS A303957, proved by transfer matrix}
...
\begin{abstract}
OEIS A303957 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A303957 is ``Number of nX4 0..1 arrays with every element unequal to 0, 1, 2 or 5 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
8, 9, 22, 61, 159, 452, 1228, 3334,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) +3*a(n-2) -3*a(n-3) +3*a(n-4) -2*a(n-5) -14*a(n-6) +6*a(n-7) +9*a(n-8) -5*a(n-9) +4*a(n-11) -2*a(n-13) for n>17
\end{quote}
As of the ``Last modified'' line on the live entry (May 03 2018 12:44:24, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 3\,a(n-2) - 3\,a(n-3) + 3\,a(n-4) - 2\,a(n-5) - 14\,a(n-6) + 6\,a(n-7) + 9\,a(n-8) - 5\,a(n-9) + 4\,a(n-11) - 2\,a(n-13)
\end{equation}
for all $n>16$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A303957.
