...
\title{The empirical recurrence for OEIS A250976, proved by transfer matrix}
...
\begin{abstract}
OEIS A250976 counts $(n+1)\times3$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A250976 is ``Number of (n+1)X(2+1) 0..2 arrays with no 2X2 subblock having the sum of its diagonal elements less than the absolute difference of its antidiagonal elements.''. It has offset $1$ and begins
\[
562, 12077, 260056, 5598430, 120515358, 2594308975, 55847243498, 1202213827627,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 12:56:05, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;27\,a(n-1) - 143\,a(n-2) + 623\,a(n-3) - 1885\,a(n-4) + 3219\,a(n-5) - 3457\,a(n-6) + 1819\,a(n-7) + 676\,a(n-8) - 2357\,a(n-9) + 2321\,a(n-10) - 1157\,a(n-11) + 271\,a(n-12) - 13\,a(n-13) - 4\,a(n-14)
\end{equation}
for all $n>13$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250976.
