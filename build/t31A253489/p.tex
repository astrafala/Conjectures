...
\title{The empirical recurrence for OEIS A253489, proved by transfer matrix}
...
\begin{abstract}
OEIS A253489 counts the arrays over $\{0,\dots,2\}$ whose $2\times2$ subblocks carry a
...
OEIS A253489 is ``Number of (n+1) X (2+1) 0..2 arrays with every 2 X 2 subblock diagonal minus antidiagonal sum nondecreasing horizontally, vertically and ne-to-sw antidiagonally.''. It has offset $1$ and begins
\[
414, 1377, 2640, 4720, 9654, 22236, 55362, 145428,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 6*a(n-1) - 11*a(n-2) + 6*a(n-3) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 15 2018 11:51:37, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253489.
