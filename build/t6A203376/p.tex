...
\title{The empirical recurrence for OEIS A203376, proved by transfer matrix}
...
\begin{abstract}
OEIS A203376 counts $(n+1)\times7$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A203376 is ``Number of (n+1)X7 0..1 arrays with every 2X2 subblock having equal diagonal elements or equal antidiagonal elements.''. It has offset $1$ and begins
\[
2916, 70996, 1764360, 44183028, 1109832180, 27913330472, 702420750924, 17679917387404,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 10:24:11, revision 9) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A203376.
