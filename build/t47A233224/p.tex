...
\title{The empirical recurrence for OEIS A233224, proved by transfer matrix}
...
\begin{abstract}
OEIS A233224 counts arrays over $\{0,\dots,5\}$ in which no two entries that are neighbours in
...
carried by one bounded piece of extra state, so the count is a walk count on $S=106$ states.
\end{abstract}
...
OEIS A233224 is ``Number of n X 2 0..5 arrays with no element x(i,j) adjacent to value 5-x(i,j) horizontally, diagonally, antidiagonally or vertically, top left element zero, and 1 appearing before 2 3 and 4, and 2 appearing before 3 in row major order.''. It has offset $1$ and begins
\[
2, 14, 174, 2541, 39203, 616454, 9757236, 154782591,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 21*a(n-1) - 79*a(n-2) - 41*a(n-3) + 72*a(n-4) + 28*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 10 2018 10:49:41, revision 9) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The array is $2$ cells across with entries $x(i,j)\in\{0,1,\dots,5\}$. Call two values $u,v$ CLASHING
...
and every first appearance it contains. There are $S=106$ reachable states.
...
\begin{theorem}
\[
a(n)\;=\;21\,a(n-1) - 79\,a(n-2) - 41\,a(n-3) + 72\,a(n-4) + 28\,a(n-5)
\]
for every $n>5$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A233224.
