...
\title{The empirical recurrence for OEIS A316416, proved by transfer matrix}
...
\begin{abstract}
OEIS A316416 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A316416 is ``Number of nX4 0..1 arrays with every element unequal to 0, 1, 2, 5, 6 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
8, 9, 27, 93, 287, 1009, 3496, 11962,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 02 2018 09:04:17, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 6\,a(n-2) - a(n-3) - a(n-4) - 17\,a(n-5) - 40\,a(n-6) + 16\,a(n-7) + 42\,a(n-8) + 13\,a(n-9) + 39\,a(n-10) + 7\,a(n-11) - 47\,a(n-12) - 20\,a(n-13) - 4\,a(n-14) - 12\,a(n-15) + 10\,a(n-16) + 20\,a(n-17) - 4\,a(n-18) - 8\,a(n-19)
\end{equation}
for all $n>22$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A316416.
