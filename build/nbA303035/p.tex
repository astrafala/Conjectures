...
\title{The empirical recurrence for OEIS A303035, proved by transfer matrix}
...
\begin{abstract}
OEIS A303035 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
recurrence of order $13$ contributed by R.~H.~Hardin. It is true. The neighbourhood
...
OEIS A303035 is ``Number of nX3 0..1 arrays with every element equal to 0, 1, 3, 4 or 6 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
3, 11, 14, 35, 71, 186, 459, 1287,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 17 2018 13:20:13, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) - 5\,a(n-2) + 16\,a(n-3) - 36\,a(n-4) + 32\,a(n-5) - 63\,a(n-6) + 64\,a(n-7) - 51\,a(n-8) + 4\,a(n-9) + 60\,a(n-10) + 16\,a(n-11) + 112\,a(n-12) + 64\,a(n-13)
\end{equation}
for all $n>15$.
...
$a(n)-\sum_i c_i a(n-i)=u_{\,n-2-13}$ whenever $n-13\ge2$. So \eqref{eq:conj}
holds for every $n>t$ exactly when $u_j=0$ for all $j>t-2-13$. Moreover $(u_j)$
...
\begin{proof}
Substituting Lemma~\ref{lem:walk} and factoring $P^{\,n-2-13}$ out of
...
\begin{proof}
The vector $q(P)\mathbf{e}\in\mathbb{Z}^{S}$ was formed by $13$ matrix--vector
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A303035.
