...
\title{The empirical recurrence for OEIS A251049, proved by transfer matrix}
...
\begin{abstract}
OEIS A251049 counts $(n+1)\times3$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A251049 is ``Number of (n+1) X (2+1) 0..3 arrays with no 2 X 2 subblock having the sum of its diagonal elements greater than the absolute difference of its antidiagonal elements.''. It has offset $1$ and begins
\[
290, 1528, 4334, 11280, 25847, 56676, 118925, 247753,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 8*a(n-1) - 25*a(n-2) + 35*a(n-3) - 7*a(n-4) - 49*a(n-5) + 77*a(n-6) - 55*a(n-7) + 20*a(n-8) - 3*a(n-9) for n>11.
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 24 2018 08:13:06, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251049.
