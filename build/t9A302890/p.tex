...
\title{The empirical recurrence for OEIS A302890, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A302890 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A302890 is ``Number of 3Xn 0..1 arrays with every element equal to 0, 2, 3, 4 or 5 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
4, 2, 37, 53, 197, 818, 2548, 10926,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 15 2018 10:51:02, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;7\,a(n-1) - 5\,a(n-2) - 39\,a(n-3) + 8\,a(n-4) + 198\,a(n-5) - 56\,a(n-6) - 411\,a(n-7) + 6\,a(n-8) + 646\,a(n-9) - 35\,a(n-10) - 602\,a(n-11) + 26\,a(n-12) + 413\,a(n-13) - 25\,a(n-14) - 114\,a(n-15) - 18\,a(n-16)
\end{equation}
for all $n>17$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302890.
