...
\title{The empirical recurrence for OEIS A218898, proved by transfer matrix}
...
\begin{abstract}
OEIS A218898 counts the distinct arrays obtained by applying a fixed local operation to every cell
of an array over a bounded alphabet, and carries an empirical recurrence of order $5$
...
$S=9$ states, after which the conjectured recurrence is settled by a finite exact
computation.
\end{abstract}
...
OEIS A218898 is ``Number of 2 X n arrays of the minimum value of corresponding elements and their horizontal, diagonal or antidiagonal neighbors in a random 0..1 2 X n array.''. It has offset $1$ and begins
\[
4, 6, 18, 34, 86, 180, 426, 930,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + 3*a(n-2) - 2*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 24 2018 20:39:00, revision 10) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

Let $R=\{0,\dots,1\}^{2}$ be the set of rows and let the neighbours of
...
\]
There are $S=9$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A218898.
