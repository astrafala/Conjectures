...
\title{The empirical recurrence for OEIS A220227, proved by transfer matrix}
...
\begin{abstract}
OEIS A220227 counts the distinct indicator arrays obtained from the $n\times2$ arrays over
...
OEIS A220227 is ``Majority value maps: number of 2 X n binary arrays indicating the locations of corresponding elements equal to at least half of their horizontal, diagonal and antidiagonal neighbors in a random 0..1 2 X n array.''. It has offset $1$ and begins
\[
1, 6, 18, 51, 157, 477, 1445, 4384,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + a(n-2) + 6*a(n-3) + a(n-4) + 3*a(n-5) - 4*a(n-6) - 2*a(n-7) - 4*a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 18:36:06, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + a(n-2) + 6\,a(n-3) + a(n-4) + 3\,a(n-5) - 4\,a(n-6) - 2\,a(n-7) - 4\,a(n-8)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A220227.
