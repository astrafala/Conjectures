...
\title{The empirical recurrence for OEIS A305240, proved by transfer matrix}
...
\begin{abstract}
OEIS A305240 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A305240 is ``Number of nX3 0..1 arrays with every element unequal to 0, 1, 2, 4 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
4, 12, 18, 32, 86, 158, 343, 721,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +2*a(n-2) +2*a(n-3) -a(n-4) -2*a(n-5) -3*a(n-6) -a(n-7) +a(n-8) for n>11
\end{quote}
As of the ``Last modified'' line on the live entry (May 28 2018 08:39:29, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 2\,a(n-2) + 2\,a(n-3) - a(n-4) - 2\,a(n-5) - 3\,a(n-6) - a(n-7) + a(n-8)
\end{equation}
for all $n>10$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A305240.
