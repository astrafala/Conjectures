...
\title{The empirical recurrence for OEIS A209532, proved by transfer matrix}
...
\begin{abstract}
OEIS A209532 counts $(n+1)\times7$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A209532 is ``Half the number of (n+1) X 7 0..2 arrays with every 2 X 2 subblock having exactly two distinct clockwise edge differences.''. It has offset $1$ and begins
\[
129, 1537, 16385, 196609, 2097153, 25165825, 268435457, 3221225473,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) + 128*a(n-2) - 128*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 11 2018 06:18:10, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 128\,a(n-2) - 128\,a(n-3)
\end{equation}
for all $n>3$.
...
\[
a(n)-\sum_i c_i\,a(n-i)\;=\;\tfrac1{2}\mathbf{1}^{\!\top}M^{\,n+1-1-3}\,q(M)\,\mathbf{1} .
\]
...
=\tfrac1{2}\mathbf{1}^{\!\top}M^{\,m-3}\,q(M)\,\mathbf{1}
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209532.
