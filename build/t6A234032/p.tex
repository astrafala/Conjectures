...
\title{The empirical recurrence for OEIS A234032, proved by transfer matrix}
...
\begin{abstract}
OEIS A234032 counts $(n+1)\times5$ arrays over $\{0,\dots,4\}$ subject to a condition imposed on
every $2\times2$ subblock, and carries an empirical recurrence of order $44$ contributed
...
on $S=3125$ vertices whose edges are the admissible consecutive pairs, and the count is a
...
OEIS A234032 is ``Number of (n+1)X(4+1) 0..4 arrays with every 2X2 subblock having the absolute values of all six edge and diagonal differences no larger than 1.''. It has offset $1$ and begins
\[
7783, 300597, 11637549, 454996327, 17838321119, 700485517781, 27534564039521, 1083120462372983,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 09:08:44, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;110\,a(n-1) - 4333\,a(n-2) + 67258\,a(n-3) - 49727\,a(n-4) - 9381974\,a(n-5) + 63529143\,a(n-6) + 464873722\,a(n-7) - 5105834204\,a(n-8) - 11512298940\,a(n-9) + 199030863273\,a(n-10) + 171749489662\,a(n-11) - 4640901058548\,a(n-12) - 2279932923269\,a(n-13) + 69427761078243\,a(n-14) + 37219734180920\,a(n-15) - 679717373578792\,a(n-16) - 517634627173445\,a(n-17) + 4315879589285745\,a(n-18) + 4575357081875100\,a(n-19) - 17189611279421840\,a(n-20) - 24043742578423549\,a(n-21) + 40454429041355663\,a(n-22) + 73834278266333876\,a(n-23) - 51489559946124003\,a(n-24) - 132873735034278651\,a(n-25) + 30290331332947967\,a(n-26) + 146882875991746168\,a(n-27) - 208125301638949\,a(n-28) - 104800983506559948\,a(n-29) - 9888619515464597\,a(n-30) + 50085499296310162\,a(n-31) + 5296975913473720\,a(n-32) - 16275620572050062\,a(n-33) - 948007832112512\,a(n-34) + 3507290470767932\,a(n-35) - 86886144072040\,a(n-36) - 454894672567616\,a(n-37) + 54652514222304\,a(n-38) + 27282841319424\,a(n-39) - 5902990277920\,a(n-40) - 173722766592\,a(n-41) + 96048316160\,a(n-42) - 753748992\,a(n-43) - 473149440\,a(n-44)
\end{equation}
for all $n>44$.
...
$V=\{0,1,\dots,4\}^{5}$, so $|V|=S=3125$. A $2\times2$ subblock of the array
...
For every $n$ with $n+1-1\ge44$,
\[
a(n)-\sum_i c_i\,a(n-i)\;=\;\mathbf{1}^{\!\top}M^{\,n+1-1-44}\,q(M)\,\mathbf{1} .
\]
...
=\mathbf{1}^{\!\top}M^{\,m-44}\,q(M)\,\mathbf{1}
\]
...
$m-44=j$ run over $\ge0$. For the last clause put $w=q(M)\mathbf{1}$. By the
...
\begin{theorem}
The recurrence \eqref{eq:conj} holds for every $n>44$, which is the statement of
Section~1.
\end{theorem}
...
$S^2$ pairs. The vector $w=q(M)\mathbf{1}\in\mathbb{Z}^{S}$ was then formed by $44$
...
index corresponding to $n=44+1$ onwards, and the run continued until $w$ itself was the
zero vector, which settles every larger $j$ at once. By Lemma~\ref{lem:crit} the recurrence
holds for every $n>44$.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234032.
