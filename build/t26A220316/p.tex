...
\title{The empirical recurrence for OEIS A220316, proved by transfer matrix}
...
\begin{abstract}
OEIS A220316 counts the distinct indicator arrays obtained from the $n\times2$ arrays over
...
OEIS A220316 is ``Equals two maps: number of nX2 binary arrays indicating the locations of corresponding elements equal to exactly two of their king-move neighbors in a random 0..2 nX2 array.''. It has offset $1$ and begins
\[
1, 5, 24, 89, 389, 1566, 6401, 25704,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 18:40:58, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + 6\,a(n-2) - 22\,a(n-3) - 15\,a(n-4) + 10\,a(n-5) + 56\,a(n-6) + 46\,a(n-7) - 112\,a(n-8) - 84\,a(n-9) - 67\,a(n-10) + 358\,a(n-11) + 277\,a(n-12) - 168\,a(n-13) - 638\,a(n-14) - 162\,a(n-15) + 664\,a(n-16) + 408\,a(n-17) + 180\,a(n-18) - 8\,a(n-19) + 76\,a(n-20) - 264\,a(n-21) + 96\,a(n-22)
\]
for every $n>22$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A220316.
