...
\title{The empirical recurrence for OEIS A251445, proved by transfer matrix}
...
\begin{abstract}
OEIS A251445 counts $(n+1)\times3$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A251445 is ``Number of (n+1)X(2+1) 0..2 arrays with no 2X2 subblock having the minimum of its diagonal elements less than the absolute difference of its antidiagonal elements.''. It has offset $1$ and begins
\[
230, 2429, 26633, 295339, 3275490, 36343085, 403222305, 4473823718,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:21:54, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;9\,a(n-1) + 34\,a(n-2) - 100\,a(n-3) - 243\,a(n-4) + 272\,a(n-5) + 534\,a(n-6) - 258\,a(n-7) - 265\,a(n-8) + 231\,a(n-9) - 151\,a(n-10) - 110\,a(n-11) + 234\,a(n-12) + 2\,a(n-13) - 65\,a(n-14) + 20\,a(n-15) + a(n-16) - 4\,a(n-17) + a(n-18)
\end{equation}
for all $n>17$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251445.
