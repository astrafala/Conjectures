...
\title{The empirical recurrence for OEIS A303322, proved by transfer matrix}
...
\begin{abstract}
OEIS A303322 counts $5$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A303322 is ``Number of nX5 0..1 arrays with every element equal to 0, 2, 4, 5 or 6 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 32, 4, 12, 64, 62, 204, 744,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 21 2018 13:11:26, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 2\,a(n-2) + 20\,a(n-3) - 44\,a(n-4) - 36\,a(n-5) - 124\,a(n-6) + 282\,a(n-7) + 212\,a(n-8) + 259\,a(n-9) - 333\,a(n-10) - 510\,a(n-11) - 408\,a(n-12) - 836\,a(n-13) + 476\,a(n-14) + 727\,a(n-15) - 2239\,a(n-16) + 1520\,a(n-17) + 5253\,a(n-18) - 1133\,a(n-19) - 2582\,a(n-20) + 3952\,a(n-21) + 2247\,a(n-22) - 5936\,a(n-23) - 2324\,a(n-24) + 2534\,a(n-25) - 1666\,a(n-26) - 1578\,a(n-27) + 920\,a(n-28) + 256\,a(n-29) - 96\,a(n-30) + 64\,a(n-31) + 32\,a(n-32) + 32\,a(n-33)
\end{equation}
for all $n>34$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A303322.
