...
\title{The empirical recurrence for OEIS A207662, proved by transfer matrix}
...
\begin{abstract}
OEIS A207662 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
$(0,0,1), (1,0,0)$ along one axis and $(0,0,0), (1,1,1)$ along the other, and carries an empirical recurrence of
order $26$ contributed by R.~H.~Hardin. It is true. The patterns have length $3$, so
...
$\mathbf{1}^{\!\top}P^{\,n-2-26}q(P)\mathbf{1}$, which vanishes identically
...
OEIS A207662 is ``Number of 4Xn 0..1 arrays avoiding 0 0 0 and 1 1 1 horizontally and 0 0 1 and 1 0 0 vertically.''. It has offset
$1$ and begins
\[
9, 81, 198, 870, 3358, 12040, 47320,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:08:39, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 2\,a(n-2) + 45\,a(n-3) - 13\,a(n-4) - 13\,a(n-5) - 450\,a(n-6) - 7\,a(n-7) + 119\,a(n-8) + 1406\,a(n-9) + 299\,a(n-10) - 560\,a(n-11) - 796\,a(n-12) - 402\,a(n-13) - 232\,a(n-14) - 1784\,a(n-15) + 797\,a(n-16) + 1473\,a(n-17) + 418\,a(n-18) - 221\,a(n-19) - 95\,a(n-20) + 35\,a(n-21) - 234\,a(n-22) - 9\,a(n-23) + 45\,a(n-24) + 4\,a(n-25) - 3\,a(n-26)
\end{equation}
for all $n>27$. The entry's array has a fixed number of rows and a growing number of
...
$a(n)-\sum_i c_i a(n-i)=u_{\,n-2-26}$ whenever $n-26\ge2$. Hence
\eqref{eq:conj} holds for every $n>t$ exactly when $u_j=0$ for every
$j>t-2-26$. Moreover $(u_j)$ satisfies the monic linear recurrence whose
...
$P^{\,n-2-26}$ gives the identity. The equivalence follows by letting the exponent
...
\begin{proof}
The vector $q(P)\mathbf{1}\in\mathbb{Z}^{S}$ was formed by $26$ matrix--vector
products in exact integer arithmetic and the $u_j$ evaluated in turn. They vanish from the
index corresponding to $n=27+1$ onwards, and the run was continued past $S$ consecutive
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207662.
