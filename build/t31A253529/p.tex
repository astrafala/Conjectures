...
\title{The empirical recurrence for OEIS A253529, proved by transfer matrix}
...
\begin{abstract}
OEIS A253529 counts the arrays over $\{0,\dots,2\}$ whose $2\times2$ subblocks carry a
...
so a pair of consecutive array rows is a state, the count is a walk count on $S=7253$ of them,
...
OEIS A253529 is ``Number of (n+1)X(4+1) 0..2 arrays with every 2X2 subblock antidiagonal maximum minus diagonal minimum nondecreasing horizontally and diagonal maximum minus antidiagonal minimum nondecreasing vertically.''. It has offset $1$ and begins
\[
7253, 27070, 62237, 182493, 398710, 949158, 2008246, 4342893,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 14:06:17, revision 6) this is still
...
\]
on the $S=7253$ admissible pairs. In particular $a$ is $C$-finite. The alignment of the walk
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-1) - 13\,a(n-2) - 19\,a(n-3) + 95\,a(n-4) - 59\,a(n-5) - 197\,a(n-6) + 313\,a(n-7) + 89\,a(n-8) - 505\,a(n-9) + 221\,a(n-10) + 343\,a(n-11) - 347\,a(n-12) - 41\,a(n-13) + 185\,a(n-14) - 61\,a(n-15) - 28\,a(n-16) + 22\,a(n-17) - 4\,a(n-18)
\]
for every $n>31$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253529.
