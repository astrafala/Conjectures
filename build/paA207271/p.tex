...
\title{The empirical recurrence for OEIS A207271, proved by transfer matrix}
...
\begin{abstract}
OEIS A207271 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
...
OEIS A207271 is ``Number of 4Xn 0..1 arrays avoiding 0 0 0 and 0 1 1 horizontally and 0 1 1 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
9, 81, 193, 611, 1602, 3513, 8327,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 13:42:36, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 5\,a(n-2) - a(n-3) - 30\,a(n-4) - 13\,a(n-5) + 54\,a(n-6) + 109\,a(n-7) - 36\,a(n-8) - 191\,a(n-9) - 186\,a(n-10) + 146\,a(n-11) + 313\,a(n-12) + 245\,a(n-13) - 177\,a(n-14) - 350\,a(n-15) - 329\,a(n-16) + 108\,a(n-17) + 320\,a(n-18) + 341\,a(n-19) - 41\,a(n-20) - 205\,a(n-21) - 228\,a(n-22) - 5\,a(n-23) + 70\,a(n-24) + 106\,a(n-25) + 23\,a(n-26) - 9\,a(n-27) - 38\,a(n-28) - 12\,a(n-29) + 9\,a(n-31) + 2\,a(n-32) - a(n-34)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207271.
