...
\title{The empirical recurrence for OEIS A257440, proved by transfer matrix}
...
\begin{abstract}
OEIS A257440 counts $(n+2)\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A257440 is ``Number of (n+2) X (1+2) 0..1 arrays with no 3 x 3 subblock diagonal sum 0 and no antidiagonal sum 3 and no row sum 1 and no column sum 1.''. It has offset $1$ and begins
\[
30, 36, 39, 49, 65, 90, 128, 186,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + 2*a(n-3) - a(n-4) - a(n-6) for n>12.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 21 2018 07:49:48, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A257440.
