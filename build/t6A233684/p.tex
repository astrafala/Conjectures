...
\title{The empirical recurrence for OEIS A233684, proved by transfer matrix}
...
\begin{abstract}
OEIS A233684 counts $(n+1)\times2$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A233684 is ``Number of (n+1) X (1+1) 0..3 arrays with every 2 X 2 subblock having the sum of the squares of the edge differences equal to 10, and no two adjacent values equal.''. It has offset $1$ and begins
\[
32, 108, 356, 1188, 3940, 13108, 43540, 144740,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) + 5*a(n-2) - 2*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 11 2018 11:23:50, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A233684.
