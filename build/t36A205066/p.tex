...
\title{The empirical recurrence for OEIS A205066, proved by transfer matrix}
...
\begin{abstract}
OEIS A205066 counts arrays over $\{0,\dots,1\}$ under a condition on the number of rightwards and downwards edge increases
in every $2\times2$ subblock, and carries an empirical recurrence of order $12$ contributed by
...
OEIS A205066 is ``Number of (n+1) X 3 0..1 arrays with the number of rightwards and downwards edge increases in each 2 X 2 subblock differing from the number in all its horizontal and vertical neighbors.''. It has offset $1$ and begins
\[
40, 64, 90, 146, 244, 386, 638, 1018,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-2) - a(n-6) - 4*a(n-8) - a(n-10) + a(n-12) for n > 14.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 10 2018 17:33:03, revision 10) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-2) - a(n-6) - 4\,a(n-8) - a(n-10) + a(n-12)
\]
for every $n>14$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A205066.
