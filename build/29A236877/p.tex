...
\title{The empirical recurrence for OEIS A236877, proved by transfer matrix}
...
\begin{abstract}
OEIS A236877 counts arrays over $\{0,\dots,2\}$ subject to a condition on the order
...
The condition is local to two consecutive rows, so the count is a walk count on $S=40$
...
OEIS A236877 is ``Number of (n+1)X(1+1) 0..2 arrays with the maximum plus the upper median plus the lower median of every 2X2 subblock equal.''. It has offset $1$ and begins
\[
81, 211, 537, 1523, 4309, 12723, 37701, 113771,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 09:37:51, revision 6) this is still
...
array, which is not among the objects counted. There are $S=40$ states left.
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-1) + 8\,a(n-2) - 146\,a(n-3) + 101\,a(n-4) + 1205\,a(n-5) - 1580\,a(n-6) - 5058\,a(n-7) + 8248\,a(n-8) + 11528\,a(n-9) - 21176\,a(n-10) - 13840\,a(n-11) + 27808\,a(n-12) + 7360\,a(n-13) - 16768\,a(n-14) - 768\,a(n-15) + 3072\,a(n-16)
\]
for every $n>15$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A236877.
