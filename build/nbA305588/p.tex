...
\title{The empirical recurrence for OEIS A305588, proved by transfer matrix}
...
\begin{abstract}
OEIS A305588 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A305588 is ``Number of nX3 0..1 arrays with every element unequal to 0, 1, 2, 3, 5 or 6 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
4, 23, 95, 390, 1626, 6818, 28530, 119266,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 05 2018 18:35:39, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) - a(n-2) - 3\,a(n-3) - 29\,a(n-4) - 14\,a(n-5) + 22\,a(n-6) + 95\,a(n-7) + 40\,a(n-8) - 70\,a(n-9) - 84\,a(n-10) + 13\,a(n-11) + 57\,a(n-12) + 4\,a(n-13) - 28\,a(n-14) - 26\,a(n-15) - 8\,a(n-16)
\end{equation}
for all $n>16$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A305588.
