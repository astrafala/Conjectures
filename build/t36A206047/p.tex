...
\title{The empirical recurrence for OEIS A206047, proved by transfer matrix}
...
\begin{abstract}
OEIS A206047 counts arrays over $\{0,\dots,2\}$ under a condition on the number of clockwise edge increases
...
OEIS A206047 is ``Number of (n+1) X 2 0..2 arrays with the number of clockwise edge increases in every 2 X 2 subblock equal to one.''. It has offset $1$ and begins
\[
48, 255, 1338, 7041, 37020, 194691, 1023822, 5384085,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) +7*a(n-2) -2*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 13 2018 08:26:35, revision 8) this is still
...
subblock; the entry's first term is $48$, which the model
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206047.
