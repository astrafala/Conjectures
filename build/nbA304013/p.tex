...
\title{The empirical recurrence for OEIS A304013, proved by transfer matrix}
...
\begin{abstract}
OEIS A304013 counts $2$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A304013 is ``Number of nX2 0..1 arrays with every element unequal to 1, 2, 3 or 5 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 7, 16, 45, 120, 333, 928, 2613,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) +5*a(n-2) -2*a(n-3) -12*a(n-4) -8*a(n-5) for n>6
\end{quote}
As of the ``Last modified'' line on the live entry (May 04 2018 11:27:53, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 5\,a(n-2) - 2\,a(n-3) - 12\,a(n-4) - 8\,a(n-5)
\end{equation}
for all $n>5$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A304013.
