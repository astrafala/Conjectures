...
\title{The empirical recurrence for OEIS A205829, proved by transfer matrix}
...
\begin{abstract}
OEIS A205829 counts arrays over $\{0,\dots,2\}$ under a condition on the number of clockwise edge increases
...
OEIS A205829 is ``Number of (n+1) X 2 0..2 arrays with the number of clockwise edge increases in every 2 X 2 subblock equal to two.''. It has offset $1$ and begins
\[
30, 111, 423, 1611, 6132, 23340, 88839, 338148,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) - a(n-2) + a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 12 2018 11:36:51, revision 9) this is still
...
subblock; the entry's first term is $30$, which the model
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A205829.
