...
\title{The empirical recurrence for OEIS A253155, proved by transfer matrix}
...
\begin{abstract}
OEIS A253155 counts the arrays over $\{0,\dots,1\}$ whose $2\times2$ subblocks carry a
...
OEIS A253155 is ``Number of (n+1) X (4+1) 0..1 arrays with every 2 X 2 subblock diagonal minus antidiagonal sum nondecreasing horizontally and vertically.''. It has offset $1$ and begins
\[
109, 120, 129, 164, 236, 380, 668, 1244,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) - 2*a(n-2) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 09 2018 07:28:13, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253155.
