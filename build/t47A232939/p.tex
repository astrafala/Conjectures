...
\title{The empirical recurrence for OEIS A232939, proved by transfer matrix}
...
\begin{abstract}
OEIS A232939 counts arrays over $\{0,\dots,2\}$ in which no two entries that are neighbours in
...
OEIS A232939 is ``Number of nX6 0..2 arrays with no element x(i,j) adjacent to value 2-x(i,j) horizontally, vertically or antidiagonally.''. It has offset $1$ and begins
\[
96, 258, 2360, 18850, 157322, 1294504, 10700160, 88318190,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 07:44:21, revision 6) this is still
...
and the row above and every clash inside it. There are $S=22$ reachable states.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232939.
