...
\begin{quote}\small
Conjecture D-finite with recurrence a(n) +5*(-n-6)*a(n-1) +5*(2*n\textasciicircum{}2+22*n+61)*a(n-2) -5*(n+5)*(2*n\textasciicircum{}2+20*n+51)*a(n-3) +(5*n\textasciicircum{}4+90*n\textasciicircum{}3+610*n\textasciicircum{}2+1845*n+2101)*a(n-4) -(n+4)\textasciicircum{}5*a(n-5)=0. - \emph{R. J. Mathar}, Jul 20 2026
\end{quote}
...
vanish, for all 13 values of $n$ from $n=5$ upward. This is what
