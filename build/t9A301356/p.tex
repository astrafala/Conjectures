...
\title{The empirical recurrence for OEIS A301356, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A301356 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A301356 is ``Number of nX3 0..1 arrays with every element equal to 1, 2, 4, 5 or 6 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
1, 6, 13, 34, 92, 256, 721, 2036,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 19 2018 09:50:42, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;8\,a(n-1) - 26\,a(n-2) + 47\,a(n-3) - 60\,a(n-4) + 74\,a(n-5) - 85\,a(n-6) + 71\,a(n-7) - 68\,a(n-8) + 56\,a(n-9) - 10\,a(n-10) + 72\,a(n-11) - 8\,a(n-12) - 148\,a(n-13) - 108\,a(n-14) - 6\,a(n-15) + 182\,a(n-16) + 168\,a(n-17) + 76\,a(n-18) - 38\,a(n-19) - 60\,a(n-20) - 64\,a(n-21) - 62\,a(n-22) + 49\,a(n-24) + 28\,a(n-25) - 10\,a(n-26) - 17\,a(n-27) - 2\,a(n-28) + 6\,a(n-29) + a(n-30) - a(n-31)
\end{equation}
for all $n>32$.
...
\#\{\text{neighbours with a value }equal to\ x_{t,u}\}\in\{1,2,4,5,6\}
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A301356.
