...
\title{The empirical recurrence for OEIS A301526, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A301526 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A301526 is ``Number of nX3 0..1 arrays with every element equal to 0, 2, 3, 4, 5 or 6 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
1, 5, 24, 92, 391, 1728, 7640, 33824,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 23 2018 10:51:30, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 9\,a(n-2) - 3\,a(n-3) - 26\,a(n-4) - 39\,a(n-5) - 45\,a(n-6) - 20\,a(n-7) + 31\,a(n-8) + 40\,a(n-9) - 10\,a(n-10) - 34\,a(n-11) + 2\,a(n-12) + 32\,a(n-13) + 20\,a(n-14) + 14\,a(n-15) + a(n-16) - 3\,a(n-17) - 2\,a(n-18) - a(n-20)
\end{equation}
for all $n>21$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A301526.
