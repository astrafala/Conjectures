...
\title{The empirical recurrence for OEIS A250929, proved by transfer matrix}
...
\begin{abstract}
OEIS A250929 counts $(n+1)\times3$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A250929 is ``Number of (n+1)X(2+1) 0..3 arrays with no 2X2 subblock having a diagonal absolute difference less than its antidiagonal absolute difference.''. It has offset $1$ and begins
\[
1652, 42776, 1104364, 28564788, 739019204, 19118642332, 494596445284, 12795148116004,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 12:51:47, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;40\,a(n-1) - 475\,a(n-2) + 3392\,a(n-3) - 16134\,a(n-4) + 44165\,a(n-5) - 44214\,a(n-6) - 88218\,a(n-7) + 319624\,a(n-8) - 393886\,a(n-9) + 208973\,a(n-10) + 26874\,a(n-11) - 121797\,a(n-12) + 92658\,a(n-13) - 36825\,a(n-14) + 5454\,a(n-15) + 752\,a(n-16)
\end{equation}
for all $n>15$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250929.
