...
\title{The empirical recurrence for OEIS A218588, proved by transfer matrix}
...
\begin{abstract}
OEIS A218588 counts the distinct indicator arrays obtained from the $n\times4$ arrays over
...
indicator row by row turns it into one, on $S=183$ states, after which the conjectured
...
OEIS A218588 is ``Hilltop maps: number of nX4 binary arrays indicating the locations of corresponding elements not exceeded by any horizontal or antidiagonal neighbor in a random 0..2 nX4 array.''. It has offset $1$ and begins
\[
13, 225, 3565, 56629, 900213, 14309253, 227451273, 3615431533,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 13*a(n-1) +40*a(n-2) +92*a(n-3) +58*a(n-4) +30*a(n-5) -72*a(n-6) +4*a(n-7) -13*a(n-8) +9*a(n-9)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 17:42:38, revision 8) this is still
...
\]
There are $S=183$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite. Note
...
\begin{theorem}
\[
a(n)\;=\;13\,a(n-1) + 40\,a(n-2) + 92\,a(n-3) + 58\,a(n-4) + 30\,a(n-5) - 72\,a(n-6) + 4\,a(n-7) - 13\,a(n-8) + 9\,a(n-9)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A218588.
