...
\title{The empirical recurrence for OEIS A220795, proved by transfer matrix}
...
\begin{abstract}
OEIS A220795 counts the distinct indicator arrays obtained from the $n\times2$ arrays over
...
indicator row by row turns it into one, on $S=56$ states, after which the conjectured
...
OEIS A220795 is ``Equals two maps: number of 2Xn binary arrays indicating the locations of corresponding elements equal to exactly two of their horizontal, diagonal and antidiagonal neighbors in a random 0..2 2Xn array.''. It has offset $1$ and begins
\[
1, 6, 19, 76, 267, 1074, 4069, 15916,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 19:04:30, revision 8) this is still
...
\]
There are $S=56$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite. Note
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + 10\,a(n-2) - 34\,a(n-3) - 66\,a(n-4) + 98\,a(n-5) + 320\,a(n-6) - 66\,a(n-7) - 916\,a(n-8) - 306\,a(n-9) + 1454\,a(n-10) + 1054\,a(n-11) - 1038\,a(n-12) - 1690\,a(n-13) - 376\,a(n-14) + 1514\,a(n-15) + 1301\,a(n-16) - 1114\,a(n-17) - 1008\,a(n-18) + 796\,a(n-19) - 568\,a(n-20) - 624\,a(n-21) + 720\,a(n-22) - 144\,a(n-23) + 64\,a(n-24) + 64\,a(n-25)
\]
for every $n>25$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A220795.
