...
\title{The empirical recurrence for OEIS A211493, proved by a one-dimensional reduction}
...
\begin{abstract}
OEIS A211493 counts symmetric $(n+1)\times(n+1)$ matrices over
$\{-4,\dots,4\}$ in which every $2\times2$ subblock sums to zero and has two or three distinct
...
on $S=187$ states, and the empirical recurrence of order $16$ contributed by R.~H.~Hardin
follows.
\end{abstract}
...
OEIS A211493 is ``Number of (n+1)X(n+1) -4..4 symmetric matrices with every 2X2 subblock having sum zero and two or three distinct values.''. It has offset $1$ and begins
\[
40, 96, 214, 446, 920, 1852, 3716, 7414,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 16:12:06, revision 8) this is still
...
$S=187$. The two parity classes never mix, so the walk starts by choosing a parity and a first
value, and every state may end a sequence:
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad \tau=\mathbf{1},\qquad S=187.
\]
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + 8\,a(n-2) - 47\,a(n-3) - 13\,a(n-4) + 224\,a(n-5) - 60\,a(n-6) - 553\,a(n-7) + 282\,a(n-8) + 745\,a(n-9) - 465\,a(n-10) - 524\,a(n-11) + 351\,a(n-12) + 165\,a(n-13) - 112\,a(n-14) - 18\,a(n-15) + 12\,a(n-16)
\]
for every $n>16$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A211493.
