...
\title{The empirical recurrence for OEIS A210150, proved by transfer matrix}
...
\begin{abstract}
OEIS A210150 counts $(n+1)\times3$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
every $2\times2$ subblock, and carries an empirical recurrence of order $13$ contributed
...
OEIS A210150 is ``1/4 the number of (n+1) X 3 0..3 arrays with every 2 X 2 subblock having one, three or four distinct clockwise edge differences.''. It has offset $1$ and begins
\[
820, 42689, 2219034, 115368738, 5997955680, 311831135649, 16211961522199, 842852674077118,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 26 2022 03:36:30, revision 7) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;49\,a(n-1) + 200\,a(n-2) - 2256\,a(n-3) - 3750\,a(n-4) + 29143\,a(n-5) - 5802\,a(n-6) - 84658\,a(n-7) + 57585\,a(n-8) + 56482\,a(n-9) - 40584\,a(n-10) - 14146\,a(n-11) + 6952\,a(n-12) + 1280\,a(n-13)
\end{equation}
for all $n>12$.
...
For every $n$ with $n+1-1\ge13$,
\[
a(n)-\sum_i c_i\,a(n-i)\;=\;\tfrac1{4}\mathbf{1}^{\!\top}M^{\,n+1-1-13}\,q(M)\,\mathbf{1} .
\]
...
=\tfrac1{4}\mathbf{1}^{\!\top}M^{\,m-13}\,q(M)\,\mathbf{1}
\]
...
$m-13=j$ run over $\ge0$. For the last clause put $w=q(M)\mathbf{1}$. By the
...
$S^2$ pairs. The vector $w=q(M)\mathbf{1}\in\mathbb{Z}^{S}$ was then formed by $13$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A210150.
