...
\title{The empirical recurrence for OEIS A207770, proved by transfer matrix}
...
\begin{abstract}
OEIS A207770 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
...
OEIS A207770 is ``Number of n X 4 0..1 arrays avoiding 0 0 0 and 1 1 1 horizontally and 0 0 1 and 0 1 0 vertically.''. It has offset
$1$ and begins
\[
10, 100, 292, 828, 2514, 7164, 20104,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 01 2023 15:30:41, revision
11) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) - 8\,a(n-2) + 17\,a(n-3) - 46\,a(n-4) + 40\,a(n-5) - 41\,a(n-6) + 115\,a(n-7) - 38\,a(n-8) + 2\,a(n-9) - 144\,a(n-10) - 18\,a(n-11) + 52\,a(n-12) + 133\,a(n-13) + 44\,a(n-14) - 42\,a(n-15) - 86\,a(n-16) - 34\,a(n-17) + 16\,a(n-18) + 26\,a(n-19) + 16\,a(n-20) - 2\,a(n-21) - 3\,a(n-22) - 2\,a(n-23) - a(n-24)
\end{equation}
for all $n>23$. 
...
$(0,0,0), (1,1,1)$ as $3$ consecutive entries. There are $10$ admissible rows; that condition
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207770.
