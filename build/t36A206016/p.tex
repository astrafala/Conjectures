...
\title{The empirical recurrence for OEIS A206016, proved by transfer matrix}
...
\begin{abstract}
OEIS A206016 counts arrays over $\{0,\dots,3\}$ under a condition on the number of clockwise edge increases
in every $2\times2$ subblock, and carries an empirical recurrence of order $13$ contributed by
...
OEIS A206016 is ``Number of (n+1) X 4 0..3 arrays with the number of clockwise edge increases in every 2 X 2 subblock unequal to the number of counterclockwise edge increases.''. It has offset $1$ and begins
\[
4440, 87448, 1763560, 35846696, 729589784, 14856355384, 302535915752, 6161045831496,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 10 2015 01:58:48, revision 7) this is still
...
another exactly when all $3$ subblocks they form pass. An $(n+1)$-row array is a walk of $n$
steps and
\[
...
subblocks; the entry's first term is $4440$, which the model
...
\begin{theorem}
\[
a(n)\;=\;23\,a(n-1) + 26\,a(n-2) - 1839\,a(n-3) + 2434\,a(n-4) + 46051\,a(n-5) - 101402\,a(n-6) - 383385\,a(n-7) + 1050095\,a(n-8) + 824710\,a(n-9) - 3349720\,a(n-10) + 1033808\,a(n-11) + 1147904\,a(n-12) - 126976\,a(n-13)
\]
for every $n>12$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206016.
