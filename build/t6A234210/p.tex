...
\title{The empirical recurrence for OEIS A234210, proved by transfer matrix}
...
\begin{abstract}
OEIS A234210 counts $(n+1)\times2$ arrays over $\{0,\dots,4\}$ subject to a condition imposed on
...
OEIS A234210 is ``Number of (n+1) X (1+1) 0..4 arrays with every 2 X 2 subblock having the sum of the squares of all six edge and diagonal differences equal to 11.''. It has offset $1$ and begins
\[
72, 308, 1248, 5344, 21888, 93760, 385536, 1651712,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 24*a(n-2) - 112*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 14 2018 03:56:39, revision 10) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;24\,a(n-2) - 112\,a(n-4)
\end{equation}
for all $n>4$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234210.
