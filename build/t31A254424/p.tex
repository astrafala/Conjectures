...
\title{The empirical recurrence for OEIS A254424, proved by transfer matrix}
...
\begin{abstract}
OEIS A254424 counts the arrays over $\{0,\dots,2\}$ whose $2\times2$ subblocks carry a
...
so a pair of consecutive array rows is a state, the count is a walk count on $S=2180$ of them,
...
OEIS A254424 is ``Number of (3+1)X(n+1) 0..2 arrays with every 2X2 subblock diagonal maximum minus antidiagonal maximum nondecreasing horizontally, vertically and ne-to-sw antidiagonally.''. It has offset $1$ and begins
\[
2180, 26783, 423141, 6880359, 109896298, 1753478415, 27927013232, 445084441966,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 14:40:36, revision 6) this is still
...
\]
on the $S=2180$ admissible pairs. In particular $a$ is $C$-finite. The alignment of the walk
...
\begin{theorem}
\[
a(n)\;=\;53\,a(n-1) - 1052\,a(n-2) + 8298\,a(n-3) + 12027\,a(n-4) - 644699\,a(n-5) + 3383022\,a(n-6) + 5821120\,a(n-7) - 105582868\,a(n-8) + 183491212\,a(n-9) + 1149464040\,a(n-10) - 3940967952\,a(n-11) - 5526556544\,a(n-12) + 32505663520\,a(n-13) + 11662935360\,a(n-14) - 148192467456\,a(n-15) - 11627458560\,a(n-16) + 409352481792\,a(n-17) + 46624425984\,a(n-18) - 673695553536\,a(n-19) - 198304174080\,a(n-20) + 577600782336\,a(n-21) + 304474816512\,a(n-22) - 166164037632\,a(n-23) - 148487012352\,a(n-24) - 27518828544\,a(n-25)
\]
for every $n>32$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A254424.
