...
\title{The empirical recurrence for OEIS A208032, proved by transfer matrix}
...
\begin{abstract}
OEIS A208032 counts arrays over $\{0,\dots,1\}$ of width $7$ that avoid the patterns
$(0,0,0), (1,0,1)$ along one axis and $(0,0,0), (0,0,1)$ along the other, and carries an empirical recurrence of
order $13$ contributed by R.~H.~Hardin. It is true. The patterns have length $3$, so
...
$\mathbf{1}^{\!\top}P^{\,n-2-13}q(P)\mathbf{1}$, which vanishes identically
...
OEIS A208032 is ``Number of 7 X n 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 0 0 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
28, 784, 5404, 61292, 574560, 5788524, 56728924,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:35:25, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) + 62\,a(n-2) - 73\,a(n-3) - 736\,a(n-4) + 779\,a(n-5) + 3097\,a(n-6) - 3814\,a(n-7) - 4207\,a(n-8) + 5531\,a(n-9) + 2469\,a(n-10) - 2932\,a(n-11) - 644\,a(n-12) + 428\,a(n-13)
\end{equation}
for all $n>12$. The entry's array has a fixed number of rows and a growing number of
...
$a(n)-\sum_i c_i a(n-i)=u_{\,n-2-13}$ whenever $n-13\ge2$. Hence
\eqref{eq:conj} holds for every $n>t$ exactly when $u_j=0$ for every
$j>t-2-13$. Moreover $(u_j)$ satisfies the monic linear recurrence whose
...
$P^{\,n-2-13}$ gives the identity. The equivalence follows by letting the exponent
...
\begin{proof}
The vector $q(P)\mathbf{1}\in\mathbb{Z}^{S}$ was formed by $13$ matrix--vector
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208032.
