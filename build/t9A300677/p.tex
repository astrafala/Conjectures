...
\title{The empirical recurrence for OEIS A300677, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A300677 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A300677 is ``Number of nX3 0..1 arrays with every element equal to 0, 2, 3 or 6 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
1, 2, 5, 11, 8, 58, 131, 306,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 11 2018 08:38:22, revision 4) the statement is
...
\#\{\text{neighbours with a value }equal to\ x_{t,u}\}\in\{0,2,3,6\}
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A300677.
