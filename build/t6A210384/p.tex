...
\title{The empirical recurrence for OEIS A210384, proved by transfer matrix}
...
\begin{abstract}
OEIS A210384 counts $(n+1)\times3$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A210384 is ``Number of (n+1) X 3 0..2 arrays with every 2 X 2 subblock having one, two or three distinct clockwise edge differences.''. It has offset $1$ and begins
\[
597, 13399, 300653, 6747079, 151416037, 3398046223, 76258263901, 1711372650743,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 26*a(n-1) - 76*a(n-2) - 93*a(n-3) + 144*a(n-4) + 66*a(n-5) - 32*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 15 2018 12:03:13, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;26\,a(n-1) - 76\,a(n-2) - 93\,a(n-3) + 144\,a(n-4) + 66\,a(n-5) - 32\,a(n-6)
\end{equation}
for all $n>5$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A210384.
