...
\title{A proof of the conjectured recurrence for OEIS A166761}
...
\begin{abstract}
OEIS A166761 carries a conjectured linear recurrence with polynomial coefficients, of
...
OEIS A166761 is ``Number of n X 3 1..2 arrays containing at least one of each value, and all equal values connected''. It has offset $1$ and begins
\[
a(1),\dots,a(8)\;=\;4, 30, 106, 292, 712, 1618, 3518, 7432,\ \dots
\]
The entry states, not as a conjecture,
\begin{quote}\small
a(n) = 2*A378933(n).
\end{quote}
Substituting the formula that A378933 states for itself, and simplifying, this reads
\begin{equation}\label{eq:cf}
a(n)\;=\;32 \cdot 2^{n} - \frac{2 n^{3}}{3} - 3 n^{2} - \frac{73 n}{3} - 32 .
\end{equation}
...
\end{quote}
As of the ``Last modified'' line on the live entry (2026-07-21, revision 29) the
...
1\,a(n) - 6\,a(n-1) + 14\,a(n-2) - 16\,a(n-3) + 9\,a(n-4) - 2\,a(n-5)
\end{equation}
...
entry \href{https://oeis.org/A166761}{A166761}, 2026-07-21.
