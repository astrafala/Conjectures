...
\title{The empirical recurrence for OEIS A220243, proved by transfer matrix}
...
\begin{abstract}
OEIS A220243 counts the distinct indicator arrays obtained from the $n\times2$ arrays over
...
indicator row by row turns it into one, on $S=27$ states, after which the conjectured
...
OEIS A220243 is ``Equals two maps: number of nX2 binary arrays indicating the locations of corresponding elements equal to exactly two of their king-move neighbors in a random 0..1 nX2 array.''. It has offset $1$ and begins
\[
1, 5, 18, 37, 85, 184, 393, 826,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 18:37:05, revision 9) this is still
...
\]
There are $S=27$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite. Note
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) - a(n-2) + 3\,a(n-3) - 14\,a(n-4) + 2\,a(n-5) + 3\,a(n-6) + 21\,a(n-7) + 6\,a(n-8) - 16\,a(n-9) - 12\,a(n-10) - 16\,a(n-11) + 12\,a(n-12) + 4\,a(n-13) + 8\,a(n-14)
\]
for every $n>16$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A220243.
