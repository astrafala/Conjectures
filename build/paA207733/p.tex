...
\title{The empirical recurrence for OEIS A207733, proved by transfer matrix}
...
\begin{abstract}
OEIS A207733 counts arrays over $\{0,\dots,1\}$ of width $6$ that avoid the patterns
...
OEIS A207733 is ``Number of 6Xn 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 1 1 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
21, 441, 1113, 2809, 27931, 277729, 1029231,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:13:52, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 32\,a(n-3) + 670\,a(n-4) + 84\,a(n-5) + 270\,a(n-6) - 4602\,a(n-7) - 97188\,a(n-8) - 30636\,a(n-9) + 21060\,a(n-10) + 124488\,a(n-11) + 4076280\,a(n-12) + 1423656\,a(n-13) + 2847312\,a(n-15) - 37015056\,a(n-16)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207733.
