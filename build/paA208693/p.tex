...
\title{The empirical recurrence for OEIS A208693, proved by transfer matrix}
...
\begin{abstract}
OEIS A208693 counts arrays over $\{0,\dots,1\}$ of width $7$ that avoid the patterns
...
OEIS A208693 is ``Number of 7 X n 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 1 1 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
31, 961, 2449, 34627, 133207, 1332721, 6398617,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) + 39*a(n-2) + 9*a(n-3) - 180*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 05 2018 13:58:42, revision
8) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 39\,a(n-2) + 9\,a(n-3) - 180\,a(n-4)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208693.
