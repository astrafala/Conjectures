...
\title{The empirical recurrence for OEIS A250968, proved by transfer matrix}
...
\begin{abstract}
OEIS A250968 counts $(n+1)\times4$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A250968 is ``Number of (n+1)X(3+1) 0..1 arrays with no 2X2 subblock having the sum of its diagonal elements less than the absolute difference of its antidiagonal elements.''. It has offset $1$ and begins
\[
172, 1945, 22048, 249921, 2833397, 32124018, 364210219, 4129278507,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 16*a(n-1) -68*a(n-2) +210*a(n-3) -492*a(n-4) +705*a(n-5) -675*a(n-6) +389*a(n-7) -120*a(n-8) +20*a(n-9)
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 12:55:15, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;16\,a(n-1) - 68\,a(n-2) + 210\,a(n-3) - 492\,a(n-4) + 705\,a(n-5) - 675\,a(n-6) + 389\,a(n-7) - 120\,a(n-8) + 20\,a(n-9)
\end{equation}
for all $n>8$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250968.
