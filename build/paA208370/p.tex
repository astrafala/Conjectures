...
\title{The empirical recurrence for OEIS A208370, proved by transfer matrix}
...
\begin{abstract}
OEIS A208370 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
...
OEIS A208370 is ``Number of 4 X n 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 0 1 and 0 1 0 vertically.''. It has offset
$1$ and begins
\[
9, 81, 351, 1953, 9999, 52821, 275769,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) + 19*a(n-2) + 23*a(n-3) - 26*a(n-4) - 38*a(n-5) + 13*a(n-6) + 15*a(n-7) - 4*a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 02 2018 04:53:07, revision
8) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 19\,a(n-2) + 23\,a(n-3) - 26\,a(n-4) - 38\,a(n-5) + 13\,a(n-6) + 15\,a(n-7) - 4\,a(n-8)
\end{equation}
for all $n>7$. The entry's array has a fixed number of rows and a growing number of
...
index corresponding to $n=7+1$ onwards, and the run was continued past $S$ consecutive
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208370.
