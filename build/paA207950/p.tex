...
\title{The empirical recurrence for OEIS A207950, proved by transfer matrix}
...
\begin{abstract}
OEIS A207950 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
...
OEIS A207950 is ``Number of 4 X n 0..1 arrays avoiding 0 0 1 and 0 1 1 horizontally and 0 1 0 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
10, 100, 370, 1369, 3478, 8836, 18330,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 26 2022 12:58:36, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207950.
