...
\title{The empirical recurrence for OEIS A232385, proved by transfer matrix}
...
\begin{abstract}
OEIS A232385 counts arrays of width $3$ over $\{0,\dots,3\}$ under a condition on each cell
...
OEIS A232385 is ``Number of (n+1)X(2+1) 0..3 arrays with every element next to itself plus and minus one within the range 0..3 horizontally, vertically or antidiagonally, with no adjacent elements equal.''. It has offset $1$ and begins
\[
18, 64, 192, 840, 3246, 12818, 51240, 203104,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 07:23:25, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-1) - 12\,a(n-2) - 46\,a(n-3) + 114\,a(n-4) + 144\,a(n-5) - 515\,a(n-6) - 92\,a(n-7) + 1013\,a(n-8) - 174\,a(n-9) - 1106\,a(n-10) - 180\,a(n-11) + 1863\,a(n-12) + 1362\,a(n-13) - 1357\,a(n-14) - 4530\,a(n-15) - 4185\,a(n-16) + 2834\,a(n-17) + 10896\,a(n-18) + 23586\,a(n-19) + 20961\,a(n-20) - 27828\,a(n-21) - 85764\,a(n-22) - 67736\,a(n-23) + 16447\,a(n-24) + 51480\,a(n-25) + 18353\,a(n-26) + 24172\,a(n-27) + 46154\,a(n-28) - 23844\,a(n-29) - 138921\,a(n-30) - 121870\,a(n-31) + 20563\,a(n-32) + 112782\,a(n-33) + 73329\,a(n-34) - 13992\,a(n-35) - 47929\,a(n-36) - 26326\,a(n-37) - 1725\,a(n-38) + 4784\,a(n-39) + 2921\,a(n-40) + 938\,a(n-41) + 190\,a(n-42) + 16\,a(n-43) - a(n-44)
\]
for every $n>44$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232385.
