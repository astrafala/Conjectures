...
\title{The empirical recurrence for OEIS A264184, proved by transfer matrix}
...
\begin{abstract}
OEIS A264184 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=3$ rows in which
...
OEIS A264184 is ``Number of (n+1)X(2+1) arrays of permutations of 0..n*3+2 with each element having index change +-(.,.) 0,0 1,-1 or 2,2.''. It has offset $1$ and begins
\[
4, 24, 81, 375, 1600, 6656, 28561, 120393,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 10 2015 11:07:36, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + a(n-2) - 17\,a(n-4) + 68\,a(n-5) + 17\,a(n-6) + 17\,a(n-8) - 68\,a(n-9) - 17\,a(n-10) + a(n-12) - 4\,a(n-13) - a(n-14)
\]
for every $n>12$.
\end{theorem}
...
transposed companion A263966. Second, the transfer model reproduces all $22$ terms this
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264184.
