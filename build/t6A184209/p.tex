...
\title{The empirical recurrence for OEIS A184209, proved by transfer matrix}
...
\begin{abstract}
OEIS A184209 counts $(n+1)\times2$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A184209 is ``Number of (n+1) X 2 0..3 arrays with every 2 X 2 subblock sum greater than 6.''. It has offset $1$ and begins
\[
106, 1036, 9247, 85600, 782637, 7189899, 65937529, 605100146,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 6*a(n-1) + 35*a(n-2) - 37*a(n-3) - 160*a(n-4) + 36*a(n-5) + 144*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 12 2018 08:49:17, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A184209.
