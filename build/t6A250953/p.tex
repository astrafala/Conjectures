...
\title{The empirical recurrence for OEIS A250953, proved by transfer matrix}
...
\begin{abstract}
OEIS A250953 counts $(n+1)\times6$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A250953 is ``Number of (n+1)X(5+1) 0..1 arrays with no 2X2 subblock having its maximum diagonal element less than its minimum antidiagonal element.''. It has offset $1$ and begins
\[
2911, 134456, 6204344, 286298344, 13211127617, 609622239024, 28130774228952, 1298083303266168,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 57*a(n-1) -516*a(n-2) +637*a(n-3) +2799*a(n-4) -3639*a(n-5) -100*a(n-6) +429*a(n-7)
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 12:53:52, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;57\,a(n-1) - 516\,a(n-2) + 637\,a(n-3) + 2799\,a(n-4) - 3639\,a(n-5) - 100\,a(n-6) + 429\,a(n-7)
\end{equation}
for all $n>6$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250953.
