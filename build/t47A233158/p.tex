...
\title{The empirical recurrence for OEIS A233158, proved by transfer matrix}
...
\begin{abstract}
OEIS A233158 counts arrays over $\{0,\dots,2\}$ in which no two entries that are neighbours in
...
OEIS A233158 is ``Number of 5Xn 0..2 arrays with no element x(i,j) adjacent to value 2-x(i,j) horizontally or antidiagonally.''. It has offset $1$ and begins
\[
243, 1536, 15552, 157464, 1658232, 17587584, 187446312, 2000708640,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 16*a(n-1) -64*a(n-2) +76*a(n-3) +17*a(n-4) -84*a(n-5) +48*a(n-6) -8*a(n-7) for n>11
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 07:55:27, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;16\,a(n-1) - 64\,a(n-2) + 76\,a(n-3) + 17\,a(n-4) - 84\,a(n-5) + 48\,a(n-6) - 8\,a(n-7)
\]
for every $n>11$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A233158.
