...
\title{The empirical recurrence for OEIS A253325, proved by transfer matrix}
...
\begin{abstract}
OEIS A253325 counts the arrays over $\{0,\dots,1\}$ whose $2\times2$ subblocks carry a
...
so a pair of consecutive array rows is a state, the count is a walk count on $S=3249$ of them,
...
OEIS A253325 is ``Number of (n+1)X(7+1) 0..1 arrays with every 2X2 subblock sum nondecreasing horizontally, vertically and antidiagonally ne-to-sw.''. It has offset $1$ and begins
\[
3249, 17197, 86922, 185672, 503944, 797324, 1660088, 2516513,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:57:42, revision 6) this is still
...
\]
on the $S=3249$ admissible pairs. In particular $a$ is $C$-finite. The alignment of the walk
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253325.
