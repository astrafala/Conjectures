...
\title{The empirical recurrence for OEIS A305229, proved by transfer matrix}
...
\begin{abstract}
OEIS A305229 counts $7$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $different from$ itself lying in $\{0,1,2,3,8\}$, and it carries an empirical
...
OEIS A305229 is ``Number of nX7 0..1 arrays with every element unequal to 0, 1, 2, 3 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
64, 719, 509, 1248, 5958, 26528, 135183, 656194,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 27 2018 17:44:54, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;8\,a(n-1) - 8\,a(n-2) - 58\,a(n-3) + 109\,a(n-4) + 53\,a(n-5) - 164\,a(n-6) + 350\,a(n-7) - 839\,a(n-8) - 337\,a(n-9) + 2217\,a(n-10) - 1688\,a(n-11) + 1782\,a(n-12) - 123\,a(n-13) - 7364\,a(n-14) + 8415\,a(n-15) - 422\,a(n-16) - 4654\,a(n-17) + 8939\,a(n-18) - 8494\,a(n-19) - 1367\,a(n-20) + 5630\,a(n-21) - 3708\,a(n-22) + 2283\,a(n-23) + 562\,a(n-24) - 1497\,a(n-25) + 288\,a(n-26) + 112\,a(n-27) - 24\,a(n-28)
\end{equation}
for all $n>34$.
...
has score in $\{0,1,2,3,8\}$. The entry also fixes the top-left entry to be $0$; that is a condition on the first row alone, so it restricts the start vector and nothing else.
...
\begin{itemize}
\item $\mathbf{s}(r,s)=1$ when every cell of $r$ has score in $\{0,1,2,3,8\}$ \emph{with no row
above $r$} and $r_1=0$, and $0$ otherwise;
\item an edge $(r,s)\to(s,t)$ when every cell of $s$ has score in $\{0,1,2,3,8\}$ computed from
$r$, $s$ and $t$;
\item $\mathbf{e}(r,s)=1$ when every cell of $s$ has score in $\{0,1,2,3,8\}$ \emph{with no row
...
exactly when every one of its $n$ rows has all scores in $\{0,1,2,3,8\}$. Read the sequence as the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A305229.
