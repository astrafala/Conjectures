...
\title{The empirical recurrence for OEIS A305584, proved by transfer matrix}
...
\begin{abstract}
OEIS A305584 counts $6$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A305584 is ``Number of nX6 0..1 arrays with every element unequal to 0, 1, 2, 7 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
32, 13, 33, 102, 327, 1897, 8182, 33142,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 05 2018 18:29:34, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 5\,a(n-2) + 33\,a(n-3) - 14\,a(n-4) - 54\,a(n-5) - 238\,a(n-6) + 86\,a(n-7) + 54\,a(n-8) + 467\,a(n-9) - 144\,a(n-10) - 48\,a(n-11) - 378\,a(n-12) + 144\,a(n-13) + 324\,a(n-15)
\end{equation}
for all $n>19$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A305584.
