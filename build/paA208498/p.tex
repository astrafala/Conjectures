...
\title{The empirical recurrence for OEIS A208498, proved by transfer matrix}
...
\begin{abstract}
OEIS A208498 counts arrays over $\{0,\dots,1\}$ of width $5$ that avoid the patterns
$(0,0,0), (0,0,1)$ along one axis and $(0,1,0), (1,1,1)$ along the other, and carries an empirical recurrence of
...
OEIS A208498 is ``Number of nX5 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 1 0 and 1 1 1 vertically.''. It has offset
$1$ and begins
\[
16, 256, 324, 828, 1794, 4104, 9912,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:54:37, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-2) + 16\,a(n-3) + 2\,a(n-4) + 2\,a(n-5) - 107\,a(n-6) + 10\,a(n-7) - 75\,a(n-8) + 416\,a(n-9) - 102\,a(n-10) + 335\,a(n-11) - 965\,a(n-12) + 313\,a(n-13) - 613\,a(n-14) + 1499\,a(n-15) - 398\,a(n-16) + 552\,a(n-17) - 1629\,a(n-18) + 183\,a(n-19) - 217\,a(n-20) + 1234\,a(n-21) + 93\,a(n-22) - 46\,a(n-23) - 623\,a(n-24) - 161\,a(n-25) + 86\,a(n-26) + 235\,a(n-27) + 71\,a(n-28) - 35\,a(n-29) - 72\,a(n-30) - 8\,a(n-31) + 6\,a(n-32) + 13\,a(n-33) - a(n-34) - a(n-36)
\end{equation}
for all $n>36$. 
...
index corresponding to $n=36+1$ onwards, and the run was continued past $S$ consecutive
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208498.
