...
\title{The empirical recurrence for OEIS A207069, proved by transfer matrix}
...
\begin{abstract}
OEIS A207069 counts arrays over $\{0,\dots,1\}$ of width $2$ that avoid the patterns
...
OEIS A207069 is ``Number of 2 X n 0..1 arrays avoiding 0 0 1 and 0 1 0 horizontally and 0 0 1 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
4, 16, 36, 81, 196, 441, 961,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) - 2*a(n-2) + 3*a(n-3) - 6*a(n-4) + 3*a(n-7) + a(n-8) - a(n-10).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 17 2018 20:29:33, revision
14) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) - 2\,a(n-2) + 3\,a(n-3) - 6\,a(n-4) + 3\,a(n-7) + a(n-8) - a(n-10)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207069.
