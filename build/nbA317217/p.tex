...
\title{The empirical recurrence for OEIS A317217, proved by transfer matrix}
...
\begin{abstract}
OEIS A317217 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A317217 is ``Number of nX3 0..1 arrays with every element unequal to 1, 2, 3, 4, 5, 7 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 25, 133, 929, 6134, 40873, 272012, 1810626,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 4*a(n-1) +18*a(n-2) +12*a(n-3) -68*a(n-4) -154*a(n-5) -120*a(n-6) -66*a(n-7) -43*a(n-8) -12*a(n-9) for n>10
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2018 19:46:46, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) + 18\,a(n-2) + 12\,a(n-3) - 68\,a(n-4) - 154\,a(n-5) - 120\,a(n-6) - 66\,a(n-7) - 43\,a(n-8) - 12\,a(n-9)
\end{equation}
for all $n>9$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A317217.
