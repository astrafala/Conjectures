...
\title{The empirical recurrence for OEIS A297427, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297427 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A297427 is ``Number of n X 4 0..1 arrays with every 1 horizontally, diagonally or antidiagonally adjacent to 2 neighboring 1s.''. It has offset $1$ and begins
\[
1, 12, 26, 42, 183, 513, 1085, 3332,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) + 12*a(n-3) + 2*a(n-4) + 2*a(n-5) - 7*a(n-6) - a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 28 2019 18:51:55, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 12\,a(n-3) + 2\,a(n-4) + 2\,a(n-5) - 7\,a(n-6) - a(n-7)
\end{equation}
for all $n>8$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297427.
