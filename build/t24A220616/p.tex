...
\title{The empirical recurrence for OEIS A220616, proved by transfer matrix}
...
\begin{abstract}
OEIS A220616 counts the ways of linking the cells of a grid $3$ cells wide, each cell either to
...
state, the count is a walk count on $S=9$ of them, and the conjectured recurrence is then
...
OEIS A220616 is ``Number of ways to reciprocally link elements of an n X 3 array either to themselves or to exactly one horizontal, diagonal and antidiagonal neighbor.''. It has offset $1$ and begins
\[
3, 21, 125, 765, 4657, 28373, 172833, 1052829,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 7*a(n-1) - 4*a(n-2) - 10*a(n-3) + 4*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 01 2018 14:29:48, revision 8) this is still
...
one configuration. With $M$ the adjacency matrix of the digraph on the $S=9$ reachable
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-1) - 4\,a(n-2) - 10\,a(n-3) + 4\,a(n-4)
\]
for every $n>3$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A220616.
