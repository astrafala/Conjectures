...
\title{The empirical recurrence for OEIS A297577, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297577 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A297577 is ``Number of n X 3 0..1 arrays with every 1 horizontally, diagonally or antidiagonally adjacent to 1 or 4 neighboring 1s.''. It has offset $1$ and begins
\[
3, 11, 36, 102, 370, 1243, 3854, 13078,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) + 2*a(n-2) + 19*a(n-3) + 4*a(n-4) - 17*a(n-5) - 8*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 01 2019 06:20:52, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 2\,a(n-2) + 19\,a(n-3) + 4\,a(n-4) - 17\,a(n-5) - 8\,a(n-6)
\end{equation}
for all $n>7$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297577.
