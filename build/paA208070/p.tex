...
\title{The empirical recurrence for OEIS A208070, proved by transfer matrix}
...
\begin{abstract}
OEIS A208070 counts arrays over $\{0,\dots,1\}$ of width $5$ that avoid the patterns
$(0,0,1), (0,1,1)$ along one axis and $(0,0,0), (1,1,1)$ along the other, and carries an empirical recurrence of
...
OEIS A208070 is ``Number of 5 X n 0..1 arrays avoiding 0 0 0 and 1 1 1 horizontally and 0 0 1 and 0 1 1 vertically.''. It has offset
$1$ and begins
\[
12, 144, 216, 1008, 3696, 12960, 48840,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) + 4*a(n-2) + 19*a(n-3) + 10*a(n-4) + 5*a(n-5) - 27*a(n-6) - 2*a(n-7) - 4*a(n-8) + 8*a(n-9) for n>11.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 27 2018 15:46:07, revision
8) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 4\,a(n-2) + 19\,a(n-3) + 10\,a(n-4) + 5\,a(n-5) - 27\,a(n-6) - 2\,a(n-7) - 4\,a(n-8) + 8\,a(n-9)
\end{equation}
for all $n>9$. The entry's array has a fixed number of rows and a growing number of
...
$(0,0,1), (0,1,1)$ as $3$ consecutive entries. There are $12$ admissible columns; that condition
...
index corresponding to $n=9+1$ onwards, and the run was continued past $S$ consecutive
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208070.
