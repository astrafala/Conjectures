...
\title{The empirical recurrence for OEIS A299748, proved by transfer matrix}
...
\begin{abstract}
OEIS A299748 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $equal to$ itself lying in $\{0,1,2,3,5,6,8\}$, and it carries an empirical
...
OEIS A299748 is ``Number of n X 3 0..1 arrays with every element equal to 0, 1, 2, 3, 5, 6 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
4, 26, 95, 375, 1524, 6170, 24838, 100272,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 13 2026 10:05:18, revision
6) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) - 9\,a(n-2) + 10\,a(n-3) - 25\,a(n-4) - 2\,a(n-5) + 47\,a(n-6) - 23\,a(n-7) + 74\,a(n-8) - 148\,a(n-9) + 86\,a(n-10) - 32\,a(n-11) + 100\,a(n-12) - 14\,a(n-13) - 28\,a(n-14) - 10\,a(n-15) - 19\,a(n-16) - 9\,a(n-17) + 4\,a(n-18)
\end{equation}
for all $n>18$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A299748.
