...
\title{The empirical recurrence for OEIS A282641, proved by transfer matrix}
...
\begin{abstract}
OEIS A282641 counts $n\times2$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A282641 is ``Number of nX2 0..1 arrays with no 1 equal to more than one of its king-move neighbors.''. It has offset $1$ and begins
\[
4, 11, 27, 76, 201, 537, 1444, 3859,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) +3*a(n-2) +4*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 28 2017 04:10:16, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A282641.
