...
\title{The empirical recurrence for OEIS A234118, proved by transfer matrix}
...
\begin{abstract}
OEIS A234118 counts $(n+1)\times5$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A234118 is ``Number of (n+1)X(4+1) 0..2 arrays with every 2X2 subblock having the absolute values of all six edge and diagonal differences no larger than 1.''. It has offset $1$ and begins
\[
3127, 116801, 4279065, 157630963, 5807422543, 214027901025, 7888454356625, 290756314787875,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 09:11:54, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;50\,a(n-1) - 427\,a(n-2) - 2748\,a(n-3) + 22158\,a(n-4) + 50476\,a(n-5) - 220478\,a(n-6) - 236864\,a(n-7) + 237555\,a(n-8) + 152850\,a(n-9) - 74775\,a(n-10) - 7956\,a(n-11)
\end{equation}
for all $n>11$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234118.
