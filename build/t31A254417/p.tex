...
\title{The empirical recurrence for OEIS A254417, proved by transfer matrix}
...
\begin{abstract}
OEIS A254417 counts the arrays over $\{0,\dots,2\}$ whose $2\times2$ subblocks carry a
...
OEIS A254417 is ``Number of (n+1)X(3+1) 0..2 arrays with every 2X2 subblock diagonal maximum minus antidiagonal maximum nondecreasing horizontally, vertically and ne-to-sw antidiagonally.''. It has offset $1$ and begins
\[
2180, 25589, 423141, 6683795, 106821947, 1701224592, 27127649888, 432529456546,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 14:39:48, revision 6) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A254417.
