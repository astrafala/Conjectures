...
\title{The empirical recurrence for OEIS A303958, proved by transfer matrix}
...
\begin{abstract}
OEIS A303958 counts $5$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A303958 is ``Number of nX5 0..1 arrays with every element unequal to 0, 1, 2 or 5 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
16, 22, 49, 159, 480, 1431, 4137, 12066,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 03 2018 12:45:06, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 2\,a(n-2) + 11\,a(n-4) - 6\,a(n-5) - 23\,a(n-6) + 9\,a(n-7) - 8\,a(n-8) + 3\,a(n-9) + 13\,a(n-10) - 7\,a(n-11) + 2\,a(n-12) + a(n-13) - a(n-14) + a(n-15)
\end{equation}
for all $n>20$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A303958.
