...
\title{The empirical recurrence for OEIS A260133, proved by transfer matrix}
...
\begin{abstract}
OEIS A260133 counts $(n+2)\times5$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A260133 is ``Number of (n+2) X (3+2) 0..1 arrays with each 3 X 3 subblock having clockwise perimeter pattern 00010101 01010101 or 01010111.''. It has offset $1$ and begins
\[
138, 342, 1162, 2966, 7698, 22522, 61914, 165954,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = a(n-1) + a(n-2) + 10*a(n-3) + 4*a(n-4) - 2*a(n-5) - 12*a(n-6) - 5*a(n-7) - 4*a(n-8) + 4*a(n-9) for n>10.
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 28 2018 09:06:39, revision 7) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A260133.
