...
\title{The empirical recurrence for OEIS A251453, proved by transfer matrix}
...
\begin{abstract}
OEIS A251453 counts $(n+1)\times3$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A251453 is ``Number of (n+1)X(2+1) 0..3 arrays with every 2X2 subblock summing to a prime.''. It has offset $1$ and begins
\[
856, 12998, 194586, 2922936, 43856564, 658509724, 9883202426, 148386240396,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:22:36, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;15\,a(n-1) + 198\,a(n-2) - 3198\,a(n-3) - 7812\,a(n-4) + 184871\,a(n-5) + 31578\,a(n-6) - 4565501\,a(n-7) + 3558194\,a(n-8) + 55101117\,a(n-9) - 72502119\,a(n-10) - 332701010\,a(n-11) + 567941512\,a(n-12) + 935596488\,a(n-13) - 2005944144\,a(n-14) - 945330624\,a(n-15) + 3100461624\,a(n-16) - 208714144\,a(n-17) - 1639102944\,a(n-18) + 397924992\,a(n-19) + 157598784\,a(n-20) - 32192640\,a(n-21) - 3359232\,a(n-22)
\end{equation}
for all $n>21$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251453.
