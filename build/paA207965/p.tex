...
\end{equation}
for all $n>98$. The entry's array has a fixed number of rows and a growing number of
...
\begin{theorem}
The recurrence \eqref{eq:conj} holds for every $n>98$. This is the statement of
Section~1.
\end{theorem}
...
index corresponding to $n=98+1$ onwards, and the run was continued past $S$ consecutive
