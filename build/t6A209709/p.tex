...
\title{The empirical recurrence for OEIS A209709, proved by transfer matrix}
...
\begin{abstract}
OEIS A209709 counts $(n+1)\times2$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A209709 is ``1/4 the number of (n+1) X 2 0..3 arrays with every 2 X 2 subblock having distinct clockwise edge differences.''. It has offset $1$ and begins
\[
24, 175, 1241, 8876, 63280, 451762, 3223192, 23003132,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) + 34*a(n-2) + 30*a(n-3) - 76*a(n-4) - 24*a(n-5) + 16*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 12 2018 08:55:29, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 34\,a(n-2) + 30\,a(n-3) - 76\,a(n-4) - 24\,a(n-5) + 16\,a(n-6)
\end{equation}
for all $n>5$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209709.
