...
\title{The empirical recurrence for OEIS A206781, proved by transfer matrix}
...
\begin{abstract}
OEIS A206781 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
...
OEIS A206781 is ``Number of nX4 0..1 arrays avoiding 0 0 1 horizontally and 0 1 1 vertically.''. It has offset
$1$ and begins
\[
12, 144, 1020, 6752, 39276, 219061, 1165366,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 13:08:50, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;12\,a(n-1) - 28\,a(n-2) - 167\,a(n-3) + 737\,a(n-4) + 570\,a(n-5) - 5810\,a(n-6) + 1525\,a(n-7) + 22058\,a(n-8) - 14330\,a(n-9) - 47100\,a(n-10) + 38200\,a(n-11) + 61863\,a(n-12) - 52870\,a(n-13) - 52680\,a(n-14) + 42745\,a(n-15) + 29773\,a(n-16) - 20710\,a(n-17) - 11060\,a(n-18) + 5845\,a(n-19) + 2554\,a(n-20) - 872\,a(n-21) - 322\,a(n-22) + 52\,a(n-23) + 16\,a(n-24)
\end{equation}
for all $n>23$. 
...
$(0,0,1)$ as $3$ consecutive entries. There are $12$ admissible rows; that condition
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206781.
