...
\title{The empirical recurrence for OEIS A188561, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A188561 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A188561 is ``Number of nX3 binary arrays without the pattern 1 1 1 diagonally, vertically or horizontally.''. It has offset $1$ and begins
\[
7, 49, 247, 1383, 7722, 42712, 237116, 1315783,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 04:44:19, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 11\,a(n-2) + 60\,a(n-3) + 89\,a(n-4) + 107\,a(n-5) - 75\,a(n-6) - 50\,a(n-7) - 157\,a(n-8) + 184\,a(n-9) - 91\,a(n-10) + 86\,a(n-11) - 35\,a(n-12) + 13\,a(n-13) - 14\,a(n-14) + 4\,a(n-15)
\end{equation}
for all $n>16$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A188561.
