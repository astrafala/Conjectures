...
\title{The empirical recurrence for OEIS A316513, proved by transfer matrix}
...
\begin{abstract}
OEIS A316513 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A316513 is ``Number of nX3 0..1 arrays with every element unequal to 0, 1, 2, 3, 7 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
4, 21, 28, 75, 174, 414, 1002, 2398,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +2*a(n-2) +3*a(n-3) +a(n-4) -a(n-5) for n>8
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 05 2018 07:13:34, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A316513.
