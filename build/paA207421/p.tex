...
\title{The empirical recurrence for OEIS A207421, proved by transfer matrix}
...
\begin{abstract}
OEIS A207421 counts arrays over $\{0,\dots,1\}$ of width $3$ that avoid the patterns
...
OEIS A207421 is ``Number of nX3 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 0 1 and 0 1 0 vertically.''. It has offset
$1$ and begins
\[
6, 36, 114, 351, 1162, 3633, 11067,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 13:52:59, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) - 4\,a(n-2) + 13\,a(n-3) - 30\,a(n-4) + 3\,a(n-5) - 29\,a(n-6) + 50\,a(n-7) + 56\,a(n-8) + 28\,a(n-9) - 34\,a(n-10) - 76\,a(n-11) - 42\,a(n-12) + 14\,a(n-13) + 35\,a(n-14) + 20\,a(n-15) + 4\,a(n-16) - 7\,a(n-17) - 2\,a(n-18) - a(n-19) - a(n-20)
\end{equation}
for all $n>19$. 
...
$(0,0,0), (0,1,0)$ as $3$ consecutive entries. There are $6$ admissible rows; that condition
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207421.
