...
\title{The empirical recurrence for OEIS A207963, proved by transfer matrix}
...
\begin{abstract}
OEIS A207963 counts arrays over $\{0,\dots,1\}$ of width $5$ that avoid the patterns
$(0,0,1), (1,0,0)$ along one axis and $(0,0,0), (1,0,1)$ along the other, and carries an empirical recurrence of
order $31$ contributed by R.~H.~Hardin. It is true. The patterns have length $3$, so
...
$\mathbf{1}^{\!\top}P^{\,n-2-31}q(P)\mathbf{1}$, which vanishes identically
...
OEIS A207963 is ``Number of 5 X n 0..1 arrays avoiding 0 0 0 and 1 0 1 horizontally and 0 0 1 and 1 0 0 vertically.''. It has offset
$1$ and begins
\[
14, 196, 932, 3923, 15839, 66089, 274310,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 05 2025 14:35:57, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 3\,a(n-2) + 27\,a(n-3) + 52\,a(n-4) + 69\,a(n-5) - 35\,a(n-6) - 285\,a(n-7) - 495\,a(n-8) - 186\,a(n-9) + 721\,a(n-10) + 1173\,a(n-11) + 105\,a(n-12) - 1194\,a(n-13) - 703\,a(n-14) + 560\,a(n-15) + 572\,a(n-16) - 197\,a(n-17) - 382\,a(n-18) - 68\,a(n-19) + 154\,a(n-20) + 117\,a(n-21) - a(n-22) - 18\,a(n-23) + 6\,a(n-24) + 3\,a(n-25) + 3\,a(n-27) - a(n-29) - a(n-30) - a(n-31)
\end{equation}
for all $n>31$. The entry's array has a fixed number of rows and a growing number of
...
$a(n)-\sum_i c_i a(n-i)=u_{\,n-2-31}$ whenever $n-31\ge2$. Hence
\eqref{eq:conj} holds for every $n>t$ exactly when $u_j=0$ for every
$j>t-2-31$. Moreover $(u_j)$ satisfies the monic linear recurrence whose
...
$P^{\,n-2-31}$ gives the identity. The equivalence follows by letting the exponent
...
\begin{proof}
The vector $q(P)\mathbf{1}\in\mathbb{Z}^{S}$ was formed by $31$ matrix--vector
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207963.
