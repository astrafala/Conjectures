...
\title{The empirical recurrence for OEIS A232918, proved by transfer matrix}
...
\begin{abstract}
OEIS A232918 counts arrays over $\{0,\dots,2\}$ in which no two entries that are neighbours in
...
OEIS A232918 is ``Number of nX6 0..2 arrays with no element x(i,j) adjacent to value 2-x(i,j) horizontally, diagonally or antidiagonally.''. It has offset $1$ and begins
\[
96, 1080, 13992, 186720, 2515716, 33994188, 459797904, 6221092260,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 18*a(n-1) -56*a(n-2) -81*a(n-3) +280*a(n-4) +12*a(n-5) -259*a(n-6) +78*a(n-7) +24*a(n-8) -5*a(n-9)
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 07:43:32, revision 6) this is still
...
and the row above and every clash inside it. There are $S=10$ reachable states.
...
\begin{theorem}
\[
a(n)\;=\;18\,a(n-1) - 56\,a(n-2) - 81\,a(n-3) + 280\,a(n-4) + 12\,a(n-5) - 259\,a(n-6) + 78\,a(n-7) + 24\,a(n-8) - 5\,a(n-9)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232918.
