...
\title{The empirical recurrence for OEIS A232943, proved by transfer matrix}
...
\begin{abstract}
OEIS A232943 counts arrays over $\{0,\dots,3\}$ in which no two entries that are neighbours in
...
carried by one bounded piece of extra state, so the count is a walk count on $S=36$ states.
\end{abstract}
...
OEIS A232943 is ``Number of nX3 0..3 arrays with no element x(i,j) adjacent to value 3-x(i,j) horizontally, vertically or antidiagonally, and top left element zero.''. It has offset $1$ and begins
\[
9, 99, 1163, 13707, 161621, 1905737, 22471303, 264968059,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 13*a(n-1) -15*a(n-2) +9*a(n-3) -2*a(n-4) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 07:44:48, revision 9) this is still
...
and the row above and every clash inside it. There are $S=36$ reachable states.
...
\begin{theorem}
\[
a(n)\;=\;13\,a(n-1) - 15\,a(n-2) + 9\,a(n-3) - 2\,a(n-4)
\]
for every $n>5$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232943.
