...
\title{The empirical recurrence for OEIS A234875, proved by transfer matrix}
...
\begin{abstract}
OEIS A234875 counts $2$-column arrays over $\{0,\dots,4\}$ in which every
...
OEIS A234875 is ``Number of (n+1) X (1+1) 0..4 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 1, with no adjacent elements equal (constant-stress tilted 1 X 1 tilings).''. It has offset
$1$ and begins
\[
32, 68, 128, 268, 512, 1068, 2048,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 5*a(n-2) - 4*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 19 2022 01:15:56, revision 10) the statement is
...
the $28$ published indices; the values agree exactly. That is what ties the digraph to
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234875.
