...
\title{The empirical recurrence for OEIS A206048, proved by transfer matrix}
...
\begin{abstract}
OEIS A206048 counts arrays over $\{0,\dots,2\}$ under a condition on the number of clockwise edge increases
...
OEIS A206048 is ``Number of (n+1) X 3 0..2 arrays with the number of clockwise edge increases in every 2 X 2 subblock equal to one.''. It has offset $1$ and begins
\[
255, 2310, 20400, 180195, 1590378, 14037225, 123893883, 1093502865,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 9*a(n-1) + a(n-2) - 24*a(n-3) + 15*a(n-4) - 6*a(n-5) + 4*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 13 2018 08:25:51, revision 8) this is still
...
subblocks; the entry's first term is $255$, which the model
...
\begin{theorem}
\[
a(n)\;=\;9\,a(n-1) + a(n-2) - 24\,a(n-3) + 15\,a(n-4) - 6\,a(n-5) + 4\,a(n-6)
\]
for every $n>5$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206048.
