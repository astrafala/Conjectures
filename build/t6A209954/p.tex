...
\title{The empirical recurrence for OEIS A209954, proved by transfer matrix}
...
\begin{abstract}
OEIS A209954 counts $(n+1)\times3$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A209954 is ``Number of (n+1)X3 0..2 arrays with every 2X2 subblock having one, three or four distinct clockwise edge differences.''. It has offset $1$ and begins
\[
567, 12161, 260201, 5569307, 119198607, 2551206049, 54603359537, 1168673933963,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 24*a(n-1) -23*a(n-2) -678*a(n-3) -472*a(n-4) +1196*a(n-5) +448*a(n-6) -416*a(n-7)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 15:36:40, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;24\,a(n-1) - 23\,a(n-2) - 678\,a(n-3) - 472\,a(n-4) + 1196\,a(n-5) + 448\,a(n-6) - 416\,a(n-7)
\end{equation}
for all $n>6$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209954.
