...
\title{The empirical recurrence for OEIS A297735, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297735 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A297735 is ``Number of 3Xn 0..1 arrays with every 1 horizontally, diagonally or antidiagonally adjacent to 2 or 4 neighboring 1s.''. It has offset $1$ and begins
\[
1, 3, 17, 34, 92, 223, 700, 1747,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) +4*a(n-2) -6*a(n-3) +7*a(n-4) -12*a(n-5) -19*a(n-6) +16*a(n-7) +10*a(n-8) +4*a(n-9)
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 04 2018 22:19:25, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 4\,a(n-2) - 6\,a(n-3) + 7\,a(n-4) - 12\,a(n-5) - 19\,a(n-6) + 16\,a(n-7) + 10\,a(n-8) + 4\,a(n-9)
\end{equation}
for all $n>10$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297735.
