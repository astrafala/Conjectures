...
\title{The empirical recurrence for OEIS A303319, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A303319 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
values of its neighbours, and carries an empirical recurrence of order $46$ contributed
...
OEIS A303319 is ``Number of 7Xn 0..1 arrays with every element equal to 0, 1, 4, 5 or 6 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
64, 22, 53, 361, 853, 3453, 26184, 148313,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 21 2018 12:52:01, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 3\,a(n-2) + 37\,a(n-3) + 276\,a(n-4) + 165\,a(n-5) - 205\,a(n-6) - 2476\,a(n-7) - 13664\,a(n-8) - 7511\,a(n-9) + 8831\,a(n-10) + 40762\,a(n-11) + 240569\,a(n-12) + 158080\,a(n-13) - 46666\,a(n-14) - 199655\,a(n-15) - 1926230\,a(n-16) - 1407079\,a(n-17) - 591650\,a(n-18) - 877532\,a(n-19) + 6392879\,a(n-20) + 3257573\,a(n-21) + 2270954\,a(n-22) + 4140102\,a(n-23) - 11419043\,a(n-24) - 2545735\,a(n-25) - 3573112\,a(n-26) - 6690569\,a(n-27) + 10941945\,a(n-28) - 415300\,a(n-29) + 2676831\,a(n-30) + 6168158\,a(n-31) - 6922000\,a(n-32) + 2103696\,a(n-33) - 1786835\,a(n-34) - 1766911\,a(n-35) + 1639434\,a(n-36) - 631599\,a(n-37) + 372470\,a(n-38) + 231484\,a(n-39) - 83779\,a(n-40) + 28834\,a(n-41) - 24621\,a(n-42) - 15294\,a(n-43) - 790\,a(n-44) - 1320\,a(n-45) - 200\,a(n-46)
\end{equation}
for all $n>51$.
...
\#\{\text{neighbours with a value }equal to\ x_{t,u}\}\in\{0,1,4,5,6\}
\end{equation}
...
$o=1n_0+0-2$. Then for $j\ge46$,
\[
a(n_0+j)-\sum_i c_i\,a(n_0+j-i)\;=\;\,\mathbf{v}^{\!\top}G^{\,j-46}w,
\qquad w=h_{46}-\sum_i c_i\,h_{46-i} .
\]
...
\begin{proof}
Substitute Lemma~\ref{lem:walk} and factor $G^{j-46}$ out of
...
the middle column. The vector $w$ was formed by $46$ applications of $G$ in exact integer
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A303319.
