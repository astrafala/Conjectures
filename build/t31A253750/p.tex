...
\title{The empirical recurrence for OEIS A253750, proved by transfer matrix}
...
\begin{abstract}
OEIS A253750 counts the arrays over $\{0,\dots,2\}$ whose $2\times2$ subblocks carry a
...
OEIS A253750 is ``Number of (2+1)X(n+1) 0..2 arrays with every 2X2 subblock ne-sw antidiagonal difference nondecreasing horizontally and nw+se diagonal sum nondecreasing vertically.''. It has offset $1$ and begins
\[
450, 2723, 10182, 29737, 70590, 148134, 298760, 587522,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 14:13:00, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) - 10\,a(n-2) + 12\,a(n-3) - 9\,a(n-4) - 5\,a(n-5) + 25\,a(n-6) - 35\,a(n-7) + 33\,a(n-8) - 15\,a(n-9) - 15\,a(n-10) + 33\,a(n-11) - 35\,a(n-12) + 25\,a(n-13) - 5\,a(n-14) - 9\,a(n-15) + 12\,a(n-16) - 10\,a(n-17) + 5\,a(n-18) - a(n-19)
\]
for every $n>25$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253750.
