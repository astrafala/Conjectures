...
\title{The empirical recurrence for OEIS A220172, proved by transfer matrix}
...
\begin{abstract}
OEIS A220172 counts the distinct indicator arrays obtained from the $n\times1$ arrays over
...
OEIS A220172 is ``Sum of neighbor maps: number of n X 1 binary arrays indicating the locations of corresponding elements equal to the sum mod 3 of their horizontal, vertical and antidiagonal neighbors in a random 0..2 n X 1 array.''. It has offset $1$ and begins
\[
2, 2, 8, 16, 24, 64, 128, 232,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) +4*a(n-3) -8*a(n-4) -4*a(n-6) +8*a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 18 2018 08:46:54, revision 10) this is still
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 4\,a(n-3) - 8\,a(n-4) - 4\,a(n-6) + 8\,a(n-7)
\]
for every $n>7$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A220172.
