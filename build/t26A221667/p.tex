...
\title{The empirical recurrence for OEIS A221667, proved by transfer matrix}
...
\begin{abstract}
OEIS A221667 counts the distinct indicator arrays obtained from the $n\times2$ arrays over
...
OEIS A221667 is ``Sum of neighbor maps: number of 2 X n binary arrays indicating the locations of corresponding elements equal to the sum mod 3 of their horizontal, diagonal and antidiagonal neighbors in a random 0..2 2 X n array.''. It has offset $1$ and begins
\[
4, 12, 64, 256, 992, 4096, 16384, 65344,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) + 8*a(n-3) - 32*a(n-4) - 16*a(n-6) + 64*a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 10 2018 09:14:15, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221667.
