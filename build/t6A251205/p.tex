...
\title{The empirical recurrence for OEIS A251205, proved by transfer matrix}
...
\begin{abstract}
OEIS A251205 counts $(n+1)\times4$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A251205 is ``Number of (n+1)X(3+1) 0..2 arrays with every 2X2 subblock summing to a nonzero multiple of 2.''. It has offset $1$ and begins
\[
816, 8870, 102811, 1273440, 16687766, 228610911, 3233921644, 46763019686,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 10:18:47, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;49\,a(n-1) - 892\,a(n-2) + 6678\,a(n-3) - 4674\,a(n-4) - 183750\,a(n-5) + 483153\,a(n-6) + 2260797\,a(n-7) - 4216766\,a(n-8) - 19139302\,a(n-9) - 11705564\,a(n-10) + 15064560\,a(n-11) + 15309504\,a(n-12) - 790272\,a(n-13) - 2709504\,a(n-14)
\end{equation}
for all $n>13$.
...
\alpha+\beta+\gamma+\delta\ \text{is a nonzero multiple of }2,
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251205.
