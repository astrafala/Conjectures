...
\title{The empirical recurrence for OEIS A220629, proved by transfer matrix}
...
\begin{abstract}
OEIS A220629 counts the ways of linking the cells of a grid $5$ cells wide, each cell either to
...
OEIS A220629 is ``Number of ways to reciprocally link elements of an n X 5 array either to themselves or to exactly two horizontal or antidiagonal neighbors.''. It has offset $1$ and begins
\[
1, 8, 44, 257, 1481, 8560, 49448, 285669,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) + 9*a(n-2) + 7*a(n-3) + 2*a(n-4) - a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 01 2018 14:29:41, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + 9\,a(n-2) + 7\,a(n-3) + 2\,a(n-4) - a(n-5)
\]
for every $n>4$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A220629.
