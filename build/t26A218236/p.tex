...
\title{The empirical recurrence for OEIS A218236, proved by transfer matrix}
...
\begin{abstract}
OEIS A218236 counts the distinct indicator arrays obtained from the $n\times2$ arrays over
...
OEIS A218236 is ``Hilltop maps: number of n X 2 binary arrays indicating the locations of corresponding elements not exceeded by any king-move neighbor in a random 0..3 n X 2 array.''. It has offset $1$ and begins
\[
3, 15, 63, 255, 1017, 4065, 16257, 65025,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) + 3*a(n-2) + 3*a(n-3) + 3*a(n-4) + 3*a(n-5) + 3*a(n-6) + 3*a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 10 2018 04:53:10, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + 3\,a(n-2) + 3\,a(n-3) + 3\,a(n-4) + 3\,a(n-5) + 3\,a(n-6) + 3\,a(n-7)
\]
for every $n>7$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A218236.
