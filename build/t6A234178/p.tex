...
\title{The empirical recurrence for OEIS A234178, proved by transfer matrix}
...
\begin{abstract}
OEIS A234178 counts $(n+1)\times3$ arrays over $\{0,\dots,5\}$ subject to a condition imposed on
every $2\times2$ subblock, and carries an empirical recurrence of order $11$ contributed
...
OEIS A234178 is ``Number of (n+1)X(2+1) 0..5 arrays with every 2X2 subblock having the absolute values of all six edge and diagonal differences no larger than 1.''. It has offset $1$ and begins
\[
388, 3908, 39098, 392664, 3949718, 39781838, 401094098, 4047234624,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 09:14:35, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;24\,a(n-1) - 182\,a(n-2) + 349\,a(n-3) + 938\,a(n-4) - 2021\,a(n-5) - 1914\,a(n-6) + 2375\,a(n-7) + 1747\,a(n-8) - 219\,a(n-9) - 140\,a(n-10) + 20\,a(n-11)
\end{equation}
for all $n>11$.
...
For every $n$ with $n+1-1\ge11$,
\[
a(n)-\sum_i c_i\,a(n-i)\;=\;\mathbf{1}^{\!\top}M^{\,n+1-1-11}\,q(M)\,\mathbf{1} .
\]
...
=\mathbf{1}^{\!\top}M^{\,m-11}\,q(M)\,\mathbf{1}
\]
...
$m-11=j$ run over $\ge0$. For the last clause put $w=q(M)\mathbf{1}$. By the
...
$S^2$ pairs. The vector $w=q(M)\mathbf{1}\in\mathbb{Z}^{S}$ was then formed by $11$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234178.
