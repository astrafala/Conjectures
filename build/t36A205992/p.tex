...
\title{The empirical recurrence for OEIS A205992, proved by transfer matrix}
...
\begin{abstract}
OEIS A205992 counts arrays over $\{0,\dots,2\}$ under a condition on the number of clockwise edge increases
...
OEIS A205992 is ``Number of (n+1)X3 0..2 arrays with the number of clockwise edge increases in every 2X2 subblock equal to two, and every 2X2 determinant nonzero.''. It has offset $1$ and begins
\[
92, 498, 2712, 14866, 81278, 445352, 2436706, 13344256,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) +17*a(n-2) -19*a(n-3) -4*a(n-4) +27*a(n-5) -13*a(n-6) +8*a(n-8) -4*a(n-9) for n>10
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 12:22:52, revision 9) this is still
...
subblocks; the entry's first term is $92$, which the model
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + 17\,a(n-2) - 19\,a(n-3) - 4\,a(n-4) + 27\,a(n-5) - 13\,a(n-6) + 8\,a(n-8) - 4\,a(n-9)
\]
for every $n>10$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A205992.
