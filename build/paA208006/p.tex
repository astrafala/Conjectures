...
\title{The empirical recurrence for OEIS A208006, proved by transfer matrix}
...
\begin{abstract}
OEIS A208006 counts arrays over $\{0,\dots,1\}$ of width $7$ that avoid the patterns
...
OEIS A208006 is ``Number of nX7 0..1 arrays avoiding 0 0 1 and 1 0 0 horizontally and 0 1 1 and 1 1 0 vertically.''. It has offset
$1$ and begins
\[
35, 1225, 4861, 16742, 106503, 486443, 3569728,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:33:39, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;13\,a(n-1) - 6\,a(n-2) - 485\,a(n-3) + 1437\,a(n-4) + 3392\,a(n-5) - 14770\,a(n-6) - 2894\,a(n-7) + 44308\,a(n-8) - 15290\,a(n-9) - 46782\,a(n-10) + 23648\,a(n-11) + 18387\,a(n-12) - 9503\,a(n-13) - 2702\,a(n-14) + 1151\,a(n-15) + 129\,a(n-16) - 32\,a(n-17)
\end{equation}
for all $n>16$. 
...
$(0,0,1), (1,0,0)$ as $3$ consecutive entries. There are $35$ admissible rows; that condition
...
rows, so $S=1225$, and declare $w\to w'$ an edge when $w'$ is $w$ with its first entry
...
values agree exactly, including the initial count of $35$ admissible rows. That is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208006.
