...
\title{The empirical recurrence for OEIS A264018, proved by transfer matrix}
...
\begin{abstract}
OEIS A264018 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=3$ columns in which
...
OEIS A264018 is ``Number of (2+1) X (n+1) arrays of permutations of 0..n*3+2 with each element having index change +-(.,.) 0,0 1,2 or 2,2.''. It has offset $1$ and begins
\[
1, 5, 25, 105, 441, 1869, 7921, 33553,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 4*a(n-1) + 4*a(n-3) + a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 09 2020 09:10:48, revision 11) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264018.
