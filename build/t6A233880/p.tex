...
\title{The empirical recurrence for OEIS A233880, proved by transfer matrix}
...
\begin{abstract}
OEIS A233880 counts $(n+1)\times6$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
every $2\times2$ subblock, and carries an empirical recurrence of order $52$ contributed
...
OEIS A233880 is ``Number of (n+1)X(5+1) 0..2 arrays with every 2X2 subblock having the sum of the squares of all six edge and diagonal differences equal to 11.''. It has offset $1$ and begins
\[
2400, 22020, 178704, 1768660, 15013864, 160334028, 1417225464, 16134545712,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 09:03:21, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;390\,a(n-2) - 63115\,a(n-4) + 5633508\,a(n-6) - 311287762\,a(n-8) + 11395143071\,a(n-10) - 290608508897\,a(n-12) + 5364876782159\,a(n-14) - 73770016903887\,a(n-16) + 771455610322102\,a(n-18) - 6226548780129951\,a(n-20) + 39172372910038001\,a(n-22) - 193237451888156699\,a(n-24) + 749448322438960607\,a(n-26) - 2284924382785662062\,a(n-28) + 5461859355511846682\,a(n-30) - 10185644885765121071\,a(n-32) + 14709447103939892100\,a(n-34) - 16281042118217455735\,a(n-36) + 13617119182197701100\,a(n-38) - 8438611741506693900\,a(n-40) + 3769223995920232000\,a(n-42) - 1166605374110880000\,a(n-44) + 236321446856400000\,a(n-46) - 28818965889000000\,a(n-48) + 1865383020000000\,a(n-50) - 48478500000000\,a(n-52)
\end{equation}
for all $n>52$.
...
For every $n$ with $n+1-1\ge52$,
\[
a(n)-\sum_i c_i\,a(n-i)\;=\;\mathbf{1}^{\!\top}M^{\,n+1-1-52}\,q(M)\,\mathbf{1} .
\]
...
=\mathbf{1}^{\!\top}M^{\,m-52}\,q(M)\,\mathbf{1}
\]
...
$m-52=j$ run over $\ge0$. For the last clause put $w=q(M)\mathbf{1}$. By the
...
$S^2$ pairs. The vector $w=q(M)\mathbf{1}\in\mathbb{Z}^{S}$ was then formed by $52$
...
index corresponding to $n=52+1$ onwards, and the run continued until $w$ itself was the
zero vector, which settles every larger $j$ at once. By Lemma~\ref{lem:crit} the recurrence
holds for every $n>52$.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A233880.
