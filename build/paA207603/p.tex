...
\title{The empirical recurrence for OEIS A207603, proved by transfer matrix}
...
\begin{abstract}
OEIS A207603 counts arrays over $\{0,\dots,1\}$ of width $6$ that avoid the patterns
...
OEIS A207603 is ``Number of 6Xn 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 0 1 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
12, 144, 396, 1089, 6765, 42025, 157440,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:07:39, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) - 5\,a(n-2) + 26\,a(n-3) + 226\,a(n-4) + 190\,a(n-5) + 1260\,a(n-6) - 6300\,a(n-8) - 4750\,a(n-9) - 28250\,a(n-10) - 16250\,a(n-11) + 15625\,a(n-12) - 15625\,a(n-13) + 78125\,a(n-14)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207603.
