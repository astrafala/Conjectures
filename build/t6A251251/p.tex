...
\title{The empirical recurrence for OEIS A251251, proved by transfer matrix}
...
\begin{abstract}
OEIS A251251 counts $(n+1)\times2$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A251251 is ``Number of (n+1) X (1+1) 0..1 arrays with every 2 X 2 subblock having a single 1 or two 1s on the same edge.''. It has offset $1$ and begins
\[
8, 18, 38, 84, 180, 394, 850, 1852,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) + 3*a(n-2) - a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 27 2018 09:07:51, revision 10) the statement is
...
every one of the $29$ published indices; the values agree exactly. That is what ties
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251251.
