...
\title{The empirical recurrence for OEIS A282963, proved by transfer matrix}
...
\begin{abstract}
OEIS A282963 counts $n\times2$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
walk, and $a(n)$ is a walk count on $S=41$ vertices, which is $C$-finite. Whether the
...
OEIS A282963 is ``Number of nX2 0..1 arrays with no 1 equal to more than one of its horizontal, vertical and antidiagonal neighbors, with the exception of exactly two elements.''. It has offset $1$ and begins
\[
0, 0, 5, 17, 75, 295, 1062, 3811,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 25 2017 17:44:27, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + 9\,a(n-2) - 14\,a(n-3) - 51\,a(n-4) - 18\,a(n-5) + 82\,a(n-6) + 156\,a(n-7) + 177\,a(n-8) + 162\,a(n-9) + 114\,a(n-10) + 63\,a(n-11) + 31\,a(n-12) + 12\,a(n-13) + 3\,a(n-14) + a(n-15)
\]
for every $n>15$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A282963.
