...
\title{The empirical recurrence for OEIS A264204, proved by transfer matrix}
...
\begin{abstract}
OEIS A264204 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=5$ rows in which
...
OEIS A264204 is ``Number of (n+1)X(4+1) arrays of permutations of 0..n*5+4 with each element having index change +-(.,.) 0,0 0,2 or 1,0.''. It has offset $1$ and begins
\[
288, 7328, 223245, 6444000, 189087285, 5520382336, 161423594928, 4717876917930,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 10 2015 11:36:42, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;18\,a(n-1) + 423\,a(n-2) - 1602\,a(n-3) - 36822\,a(n-4) + 43134\,a(n-5) + 1104234\,a(n-6) - 1104336\,a(n-7) - 14587215\,a(n-8) + 17848380\,a(n-9) + 88345137\,a(n-10) - 120161976\,a(n-11) - 266182229\,a(n-12) + 363694632\,a(n-13) + 434017923\,a(n-14) - 518991428\,a(n-15) - 434017923\,a(n-16) + 363694632\,a(n-17) + 266182229\,a(n-18) - 120161976\,a(n-19) - 88345137\,a(n-20) + 17848380\,a(n-21) + 14587215\,a(n-22) - 1104336\,a(n-23) - 1104234\,a(n-24) + 43134\,a(n-25) + 36822\,a(n-26) - 1602\,a(n-27) - 423\,a(n-28) + 18\,a(n-29) + a(n-30)
\]
for every $n>28$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264204.
