...
\title{The empirical recurrence for OEIS A299329, proved by transfer matrix}
...
\begin{abstract}
OEIS A299329 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A299329 is ``Number of nX3 0..1 arrays with every element equal to 2, 3, 4, 5, 6 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
0, 3, 8, 36, 173, 858, 4258, 21386,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 07 2018 04:47:20, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) + 10\,a(n-2) - 13\,a(n-3) - 53\,a(n-4) - 25\,a(n-5) + 57\,a(n-6) + 53\,a(n-7) + a(n-8) + 16\,a(n-9) + 10\,a(n-10) - 15\,a(n-11) - 4\,a(n-12)
\end{equation}
for all $n>13$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A299329.
