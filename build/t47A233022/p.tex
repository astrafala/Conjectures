...
\title{The empirical recurrence for OEIS A233022, proved by transfer matrix}
...
\begin{abstract}
OEIS A233022 counts arrays over $\{0,\dots,3\}$ in which no two entries that are neighbours in
...
carried by one bounded piece of extra state, so the count is a walk count on $S=108$ states.
\end{abstract}
...
OEIS A233022 is ``Number of nX4 0..3 arrays with no element x(i,j) adjacent to value 3-x(i,j) horizontally, vertically, diagonally or antidiagonally, and top left element zero.''. It has offset $1$ and begins
\[
27, 435, 8835, 179999, 3685017, 75489671, 1546718177, 31692006853,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 23*a(n-1) -39*a(n-2) -265*a(n-3) +180*a(n-4) +655*a(n-5) -156*a(n-6) -127*a(n-7) +20*a(n-8)
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 07:47:22, revision 8) this is still
...
and the row above and every clash inside it. There are $S=108$ reachable states.
...
\begin{theorem}
\[
a(n)\;=\;23\,a(n-1) - 39\,a(n-2) - 265\,a(n-3) + 180\,a(n-4) + 655\,a(n-5) - 156\,a(n-6) - 127\,a(n-7) + 20\,a(n-8)
\]
for every $n>8$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A233022.
