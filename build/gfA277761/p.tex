...
\title{The empirical recurrence for OEIS A277761, derived from the entry's generating function}
...
\begin{abstract}
OEIS A277761 carries an empirical recurrence of order $3$. The entry separately records a
...
OEIS A277761 is ``Number of n X 2 0..2 arrays with every element equal to some element at offset (-1,-1) (-1,0) (-1,1) (0,-1) (0,1) or (1,0) both plus 1 mod 3 and minus 1 mod 3, with new values introduced in order 0..2.''. It has offset $1$ and begins
\[
0, 1, 2, 14, 56, 284, 1304, 6248,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 05 2019 18:42:42, revision 9) the first is still
...
Write
\[
G(x)\;=\;\sum_{n}a(n)\,x^{n}\;=\;\frac{- 2 x^{3} + x^{2}}{12 x^{3} - 6 x^{2} - 4 x + 1},
\]
the entry's own generating function, and let
\[
D(x)\;=\;1-\sum_i c_i x^{i}\;=\;12 x^{3} - 6 x^{2} - 4 x + 1
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A277761.
