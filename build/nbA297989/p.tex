...
\title{The empirical recurrence for OEIS A297989, proved by transfer matrix}
...
\begin{abstract}
OEIS A297989 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A297989 is ``Number of nX4 0..1 arrays with every element equal to 1, 2, 3 or 6 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
2, 49, 146, 466, 1446, 4648, 14888, 47399,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 10 2018 07:34:00, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) - 6\,a(n-2) + 2\,a(n-3) - 5\,a(n-4) + 10\,a(n-5) - 19\,a(n-6) - 30\,a(n-7) + 29\,a(n-8) + 61\,a(n-9) + 81\,a(n-10) - 91\,a(n-11) - 78\,a(n-12) - 35\,a(n-13) + 86\,a(n-14) + 10\,a(n-15) - 35\,a(n-16) - 23\,a(n-17) + 16\,a(n-18) + 37\,a(n-19) - 32\,a(n-20) + 14\,a(n-21) + 6\,a(n-22) - 8\,a(n-23) + 4\,a(n-24)
\end{equation}
for all $n>26$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297989.
