...
\title{The empirical recurrence for OEIS A298456, proved by transfer matrix}
...
\begin{abstract}
OEIS A298456 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A298456 is ``Number of nX3 0..1 arrays with every element equal to 2, 3, 4, 5 or 6 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
0, 3, 8, 30, 153, 710, 3490, 17087,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 19 2018 08:50:46, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) + 10\,a(n-2) - 19\,a(n-3) - 42\,a(n-4) + 17\,a(n-5) + 27\,a(n-6) - 39\,a(n-7) + 45\,a(n-8) + 75\,a(n-9) - 35\,a(n-10) - 6\,a(n-11) + 6\,a(n-12) - 8\,a(n-13)
\end{equation}
for all $n>14$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A298456.
