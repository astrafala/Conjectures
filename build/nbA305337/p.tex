...
\title{The empirical recurrence for OEIS A305337, proved by transfer matrix}
...
\begin{abstract}
OEIS A305337 counts $5$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A305337 is ``Number of nX5 0..1 arrays with every element unequal to 0, 1, 2, 5 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
16, 22, 62, 267, 1185, 5296, 23348, 103641,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 30 2018 16:57:00, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 8\,a(n-2) + 14\,a(n-3) + 13\,a(n-4) - 49\,a(n-5) - 137\,a(n-6) - 103\,a(n-7) - a(n-8) + 186\,a(n-9) + 345\,a(n-10) + 171\,a(n-11) - 115\,a(n-12) - 301\,a(n-13) - 321\,a(n-14) - 65\,a(n-15) + 251\,a(n-16) + 311\,a(n-17) + 148\,a(n-18) - 58\,a(n-19) - 206\,a(n-20) - 188\,a(n-21) - 38\,a(n-22) + 50\,a(n-23) + 58\,a(n-24) + 43\,a(n-25) + 2\,a(n-26) - 18\,a(n-27) - 8\,a(n-28) + 4\,a(n-30) + 4\,a(n-31) + a(n-32)
\end{equation}
for all $n>33$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A305337.
