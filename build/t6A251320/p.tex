...
\title{The empirical recurrence for OEIS A251320, proved by transfer matrix}
...
\begin{abstract}
OEIS A251320 counts $(n+1)\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A251320 is ``Number of (n+1) X (2+1) 0..1 arrays with every 2 X 2 subblock having one or two 1s.''. It has offset $1$ and begins
\[
28, 116, 474, 1982, 8218, 34288, 142600, 594236,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) + 8*a(n-2) - 13*a(n-3) - a(n-4) + 2*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 28 2018 16:44:00, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 8\,a(n-2) - 13\,a(n-3) - a(n-4) + 2\,a(n-5)
\end{equation}
for all $n>4$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251320.
