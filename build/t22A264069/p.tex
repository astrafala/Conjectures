...
\title{The empirical recurrence for OEIS A264069, proved by transfer matrix}
...
\begin{abstract}
OEIS A264069 counts the arrangements of $0,1,\dots,LW-1$ in a grid of $W=7$ rows in which
...
OEIS A264069 is ``Number of (n+1) X (6+1) arrays of permutations of 0..n*7+6 with each element having index change +-(.,.) 0,0 1,1 or 1,2.''. It has offset $1$ and begins
\[
233, 15125, 1445345, 130697424, 11909009849, 1084282319384, 98725402363225, 8989061417123964,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 87*a(n-1) +374*a(n-2) -470*a(n-3) +207*a(n-4) +3*a(n-5) for n > 7.
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 26 2025 18:45:00, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;87\,a(n-1) + 374\,a(n-2) - 470\,a(n-3) + 207\,a(n-4) + 3\,a(n-5)
\]
for every $n>7$.
\end{theorem}
...
transposed companion A263966. Second, the transfer model reproduces all $15$ terms this
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A264069.
