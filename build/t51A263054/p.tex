...
\title{The empirical recurrence for OEIS A263054, proved by transfer matrix}
...
\begin{abstract}
OEIS A263054 counts arrays of width $3$ over $\{0,1\}$ whose rows, read as base-$2$
...
OEIS A263054 is ``Number of (n+1) X (2+1) 0..1 arrays with each row and column not divisible by 3, read as a binary number with top and left being the most significant bits.''. It has offset $1$ and begins
\[
2, 33, 142, 895, 4314, 22921, 113486, 577071,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 5*a(n-1) + 12*a(n-2) - 60*a(n-3) - 39*a(n-4) + 195*a(n-5) + 28*a(n-6) - 140*a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 01 2019 08:43:52, revision 8) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A263054.
