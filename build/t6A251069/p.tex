...
\title{The empirical recurrence for OEIS A251069, proved by transfer matrix}
...
\begin{abstract}
OEIS A251069 counts $6\times(n+1)$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A251069 is ``Number of (5+1)X(n+1) 0..2 arrays with no 2X2 subblock having x11-x00 less than x10-x01.''. It has offset $1$ and begins
\[
92429, 4499219, 119032248, 2062530658, 26192388204, 262314968432, 2179252808041, 15575644526039,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 10:18:18, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;46\,a(n-1) - 1021\,a(n-2) + 14566\,a(n-3) - 150115\,a(n-4) + 1190818\,a(n-5) - 7565523\,a(n-6) + 39546498\,a(n-7) - 173394318\,a(n-8) + 646904260\,a(n-9) - 2076097186\,a(n-10) + 5779538716\,a(n-11) - 14047031686\,a(n-12) + 29955478756\,a(n-13) - 56258286310\,a(n-14) + 93298957284\,a(n-15) - 136868817069\,a(n-16) + 177768541494\,a(n-17) - 204435461489\,a(n-18) + 208007834270\,a(n-19) - 186949454951\,a(n-20) + 148041763226\,a(n-21) - 102919401431\,a(n-22) + 62512079546\,a(n-23) - 32963315700\,a(n-24) + 14966379960\,a(n-25) - 5788295520\,a(n-26) + 1880029760\,a(n-27) - 503070080\,a(n-28) + 107966720\,a(n-29) - 17863424\,a(n-30) + 2138624\,a(n-31) - 164864\,a(n-32) + 6144\,a(n-33)
\end{equation}
for all $n>32$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251069.
