...
\title{The empirical recurrence for OEIS A207485, proved by transfer matrix}
...
\begin{abstract}
OEIS A207485 counts arrays over $\{0,\dots,1\}$ of width $5$ that avoid the patterns
...
OEIS A207485 is ``Number of nX5 0..1 arrays avoiding 0 0 0 and 0 1 1 horizontally and 0 1 1 and 1 1 0 vertically.''. It has offset
$1$ and begins
\[
13, 169, 499, 1322, 4041, 12151, 39050,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 13:58:01, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207485.
