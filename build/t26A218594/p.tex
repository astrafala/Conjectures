...
\title{The empirical recurrence for OEIS A218594, proved by transfer matrix}
...
\begin{abstract}
OEIS A218594 counts the distinct indicator arrays obtained from the $n\times3$ arrays over
...
indicator row by row turns it into one, on $S=335$ states, after which the conjectured
...
OEIS A218594 is ``Hilltop maps: number of 3 X n binary arrays indicating the locations of corresponding elements not exceeded by any horizontal or antidiagonal neighbor in a random 0..2 3 X n array.''. It has offset $1$ and begins
\[
1, 49, 449, 3565, 28325, 225647, 1798967, 14344301,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 13 2026 12:34:54, revision 10) this is still
...
\]
There are $S=335$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite. Note
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-1) + 5\,a(n-2) + 17\,a(n-3) + 24\,a(n-4) + 118\,a(n-5) + 51\,a(n-6) + 119\,a(n-7) + 146\,a(n-8) + 278\,a(n-9) - 139\,a(n-10) - 27\,a(n-11) + 74\,a(n-12) - 248\,a(n-13) - 419\,a(n-14) - 247\,a(n-15) - 75\,a(n-16) - 11\,a(n-17) + 348\,a(n-18) + 172\,a(n-19) + 37\,a(n-20) + 37\,a(n-21) - 71\,a(n-22) - 71\,a(n-23) - 38\,a(n-24) - 16\,a(n-25) + 9\,a(n-26) + 21\,a(n-27) + 18\,a(n-28) + 14\,a(n-29) + 7\,a(n-30) - a(n-31) - 8\,a(n-32) - 2\,a(n-33) + a(n-34) + a(n-35) - a(n-36) - a(n-37)
\]
for every $n>38$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A218594.
