...
\title{The empirical recurrence for OEIS A205920, proved by transfer matrix}
...
\begin{abstract}
OEIS A205920 counts arrays over $\{0,\dots,3\}$ under a condition on the number of clockwise edge increases
...
a bounded window of consecutive rows, so the count is a walk count on $S=64$ states and is
...
OEIS A205920 is ``Number of (n+1)X3 0..3 arrays with the number of clockwise edge increases in every 2X2 subblock equal to one, and every 2X2 determinant nonzero.''. It has offset $1$ and begins
\[
389, 2684, 15561, 104311, 625713, 4085161, 25017018, 160810946,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 12:20:21, revision 9) this is still
...
exactly when all $2$ subblocks they form pass. An $(n+1)$-row array is a walk of $n$ steps and
\[
...
subblocks; the entry's first term is $389$, which the model
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) + 37\,a(n-2) - 134\,a(n-3) - 468\,a(n-4) + 446\,a(n-5) + 3506\,a(n-6) + 2929\,a(n-7) + 764\,a(n-8) - 27570\,a(n-9) - 19322\,a(n-10) - 4621\,a(n-11) + 18764\,a(n-12) + 42723\,a(n-13) + 11896\,a(n-14) - 35641\,a(n-15) - 21691\,a(n-16) + 23786\,a(n-17) + 548\,a(n-18) - 9887\,a(n-19) + 7551\,a(n-20) - 3387\,a(n-21) + 1201\,a(n-22) - 314\,a(n-23) + 71\,a(n-24) - 13\,a(n-25) + a(n-26)
\]
for every $n>26$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A205920.
