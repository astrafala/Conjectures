...
\title{The empirical recurrence for OEIS A234108, proved by transfer matrix}
...
\begin{abstract}
OEIS A234108 counts $(n+1)\times3$ arrays over $\{0,\dots,4\}$ subject to a condition imposed on
...
OEIS A234108 is ``Number of (n+1)X(2+1) 0..4 arrays with every 2X2 subblock having the sum of the absolute values of all six edge and diagonal differences equal to 12.''. It has offset $1$ and begins
\[
186, 608, 2086, 7742, 29278, 113666, 446590, 1777146,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 09:11:08, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;8\,a(n-1) + 6\,a(n-2) - 172\,a(n-3) + 144\,a(n-4) + 1438\,a(n-5) - 1805\,a(n-6) - 6160\,a(n-7) + 8467\,a(n-8) + 14464\,a(n-9) - 20123\,a(n-10) - 17822\,a(n-11) + 25464\,a(n-12) + 9216\,a(n-13) - 15948\,a(n-14) + 136\,a(n-15) + 3552\,a(n-16) - 928\,a(n-17) + 64\,a(n-18)
\end{equation}
for all $n>18$.
...
|\beta-\alpha|+|\delta-\beta|+|\gamma-\delta|+|\alpha-\gamma|+|\delta-\alpha|+|\gamma-\beta|\;=\;12,
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234108.
