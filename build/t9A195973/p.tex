...
\title{The empirical recurrence for OEIS A195973, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A195973 counts arrays over $\{0,\dots,4\}$ in which every cell is constrained by the
...
OEIS A195973 is ``Number of n X 3 0..4 arrays with each element x equal to the number its horizontal and vertical neighbors equal to 2,0,1,3,4 for x=0,1,2,3,4.''. It has offset $1$ and begins
\[
4, 14, 24, 36, 67, 134, 240, 432,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) +a(n-3) +a(n-4) -6*a(n-5) -a(n-6) -4*a(n-7) +2*a(n-8) +2*a(n-9) +5*a(n-10) +2*a(n-11) -2*a(n-14) -a(n-15).
\end{quote}
As of the ``Last modified'' line on the live entry (May 08 2018 06:19:54, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + a(n-3) + a(n-4) - 6\,a(n-5) - a(n-6) - 4\,a(n-7) + 2\,a(n-8) + 2\,a(n-9) + 5\,a(n-10) + 2\,a(n-11) - 2\,a(n-14) - a(n-15)
\end{equation}
for all $n>16$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A195973.
