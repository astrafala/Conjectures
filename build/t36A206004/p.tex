...
\title{The empirical recurrence for OEIS A206004, proved by transfer matrix}
...
\begin{abstract}
OEIS A206004 counts arrays over $\{0,\dots,2\}$ under a condition on the number of clockwise edge increases
...
OEIS A206004 is ``Number of (n+1) X 3 0..2 arrays with the number of clockwise edge increases in every 2 X 2 subblock equal to one, and every 2 X 2 determinant nonzero.''. It has offset $1$ and begins
\[
78, 300, 980, 3706, 12304, 45810, 154346, 567112,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 2*a(n-1) + 13*a(n-2) - 17*a(n-3) - 34*a(n-4) - 9*a(n-5) + 23*a(n-6) + a(n-7) - 4*a(n-8) + a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 13 2018 05:47:24, revision 9) this is still
...
subblocks; the entry's first term is $78$, which the model
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 13\,a(n-2) - 17\,a(n-3) - 34\,a(n-4) - 9\,a(n-5) + 23\,a(n-6) + a(n-7) - 4\,a(n-8) + a(n-9)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206004.
