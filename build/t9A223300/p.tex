...
\title{The empirical recurrence for OEIS A223300, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A223300 counts arrays over $\{0,\dots,9\}$ in which every cell is constrained by the
...
OEIS A223300 is ``4X4X4 triangular graph coloring a rectangular array: number of nX3 0..9 arrays where 0..9 label nodes of a graph with edges 0,1 0,2 1,2 1,3 1,4 2,4 3,4 2,5 4,5 3,6 3,7 4,7 6,7 4,8 5,8 7,8 5,9 8,9 and every array movement to a horizontal or vertical neighbor moves along an edge of this graph.''. It has offset $1$ and begins
\[
144, 3132, 76788, 1882500, 46589268, 1148040516, 28402185108, 700525554180,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 21:28:47, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;10\,a(n-1) + 500\,a(n-2) - 2878\,a(n-3) - 15863\,a(n-4) + 79004\,a(n-5) + 144196\,a(n-6) - 616760\,a(n-7) - 363504\,a(n-8) + 1348864\,a(n-9) + 396544\,a(n-10) - 600576\,a(n-11)
\end{equation}
for all $n>12$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223300.
