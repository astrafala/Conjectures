...
\title{The empirical recurrence for OEIS A234753, proved by transfer matrix}
...
\begin{abstract}
OEIS A234753 counts arrays of width $2$ over $\{0,1,2,3\}$ subject to a condition read round the
...
OEIS A234753 is ``Number of (n+1) X (1+1) 0..3 arrays with 2 X 2 edge jumps all no more than +1 in one of the clockwise or counterclockwise directions or both.''. It has offset $1$ and begins
\[
110, 1014, 8968, 80010, 712722, 6350732, 56585338, 504183278,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 8*a(n-1) + 10*a(n-2) - 16*a(n-3) - 8*a(n-4) + 4*a(n-5) + a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 16 2018 05:41:44, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-1) + 10\,a(n-2) - 16\,a(n-3) - 8\,a(n-4) + 4\,a(n-5) + a(n-6)
\]
for every $n>5$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234753.
