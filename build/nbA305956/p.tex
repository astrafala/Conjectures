...
\title{The empirical recurrence for OEIS A305956, proved by transfer matrix}
...
\begin{abstract}
OEIS A305956 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A305956 is ``Number of nX3 0..1 arrays with every element unequal to 1, 2, 3, 4, 5 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 25, 132, 919, 6030, 39985, 264680, 1752681,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 4*a(n-1) +17*a(n-2) +14*a(n-3) -54*a(n-4) -135*a(n-5) -107*a(n-6) -58*a(n-7) -39*a(n-8) -11*a(n-9) for n>10
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 15 2018 06:16:29, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) + 17\,a(n-2) + 14\,a(n-3) - 54\,a(n-4) - 135\,a(n-5) - 107\,a(n-6) - 58\,a(n-7) - 39\,a(n-8) - 11\,a(n-9)
\end{equation}
for all $n>9$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A305956.
