...
\title{A proof of the conjectured recurrence for OEIS A081181}
...
\begin{abstract}
OEIS A081181 carries a conjectured linear recurrence with polynomial coefficients, of
...
OEIS A081181 is ``Staircase on Pascal's triangle''. It has offset $0$ and begins
\[
a(0),\dots,a(7)\;=\;1, 3, 6, 20, 35, 126, 210, 792,\ \dots
\]
...
a(n)\;=\;{\binom{n + \left\lfloor{\frac{n}{2} + \frac{1}{2}}\right\rfloor + 1}{n}} .
\end{equation}
...
\begin{quote}\small
\textbf{Conjecture:} 8*n*(n+3)*(1845*n-2882)*a(n) + 4*(-5097*n\^{}3+11143*n\^{}2 + 42110*n-27416)*a(n-1) + 6*(-16605*n\^{}3-7272*n\^{}2-16701*n+9490)*a(n-2) + 3*(3*n-5)*(5097*n-949)*(3*n-4)*a(n-3) = 0. - \emph{R. J. Mathar}, Oct 29 2014
\end{quote}
As of the ``Last modified'' line on the live entry (2025-10-19, revision 20) the
...
8 n \left(n + 3\right) \left(1845 n - 2882\right)\,a(n) -  4 \left(5097 n^{3} - 11143 n^{2} - 42110 n + 27416\right)\,a(n-1) -  6 \left(16605 n^{3} + 7272 n^{2} + 16701 n - 9490\right)\,a(n-2) + 3 \left(3 n - 5\right) \left(3 n - 4\right) \left(5097 n - 949\right)\,a(n-3)
\end{equation}
...
a(2m)\;=\;e_{0}(m)\;=\;{\binom{3 m + 1}{m + 1}},
\qquad
a(2m+1)\;=\;e_{1}(m)\;=\;{\binom{3 m + 3}{2 m + 1}},
\end{equation}
...
\section{The computation for A081181}
...
entry \href{https://oeis.org/A081181}{A081181}, 2025-10-19.
