...
\title{The empirical recurrence for OEIS A220566, proved by transfer matrix}
...
\begin{abstract}
OEIS A220566 counts the ways of linking the cells of a grid $5$ cells wide, each cell either to
...
state, the count is a walk count on $S=89$ of them, and the conjectured recurrence is then
...
OEIS A220566 is ``Number of ways to reciprocally link elements of an 5Xn array either to themselves or to exactly one horizontal or antidiagonal neighbor.''. It has offset $1$ and begins
\[
1, 89, 1332, 36640, 810778, 19333688, 449429440, 10536960271,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 18:51:01, revision 8) this is still
...
one configuration. With $M$ the adjacency matrix of the digraph on the $S=89$ reachable
...
\begin{theorem}
\[
a(n)\;=\;8\,a(n-1) + 332\,a(n-2) + 1166\,a(n-3) - 10416\,a(n-4) - 41922\,a(n-5) + 174048\,a(n-6) + 535206\,a(n-7) - 1872086\,a(n-8) - 2804534\,a(n-9) + 11470692\,a(n-10) + 3617576\,a(n-11) - 32706416\,a(n-12) + 4049368\,a(n-13) + 51508932\,a(n-14) - 14992866\,a(n-15) - 49988407\,a(n-16) + 16438786\,a(n-17) + 31549556\,a(n-18) - 9212528\,a(n-19) - 13108544\,a(n-20) + 2853616\,a(n-21) + 3512372\,a(n-22) - 487178\,a(n-23) - 584214\,a(n-24) + 44610\,a(n-25) + 58000\,a(n-26) - 2006\,a(n-27) - 3248\,a(n-28) + 34\,a(n-29) + 92\,a(n-30) - a(n-32)
\]
for every $n>31$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A220566.
