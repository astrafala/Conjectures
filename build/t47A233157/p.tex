...
\title{The empirical recurrence for OEIS A233157, proved by transfer matrix}
...
\begin{abstract}
OEIS A233157 counts arrays over $\{0,\dots,2\}$ in which no two entries that are neighbours in
...
carried by one bounded piece of extra state, so the count is a walk count on $S=81$ states.
\end{abstract}
...
OEIS A233157 is ``Number of 4 X n 0..2 arrays with no element x(i,j) adjacent to value 2-x(i,j) horizontally or antidiagonally.''. It has offset $1$ and begins
\[
81, 384, 2592, 17496, 121176, 842616, 5871528, 40931568,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 9*a(n-1) - 15*a(n-2) + 6*a(n-3) for n>7.
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 09 2018 14:57:30, revision 8) this is still
...
and the row above and every clash inside it. There are $S=81$ reachable states.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A233157.
