...
\title{The empirical recurrence for OEIS A207175, proved by transfer matrix}
...
\begin{abstract}
OEIS A207175 counts arrays over $\{0,\dots,1\}$ of width $7$ that avoid the patterns
...
OEIS A207175 is ``Number of 7 X n 0..1 arrays avoiding 0 0 0 and 1 0 1 horizontally and 0 0 1 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
14, 196, 546, 3141, 11284, 26866, 98224,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) + 25*a(n-3) + 6*a(n-4) + 6*a(n-5) - 108*a(n-6) - 72*a(n-7) + 216*a(n-9) for n>11.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 21 2018 05:22:29, revision
8) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 25\,a(n-3) + 6\,a(n-4) + 6\,a(n-5) - 108\,a(n-6) - 72\,a(n-7) + 216\,a(n-9)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207175.
