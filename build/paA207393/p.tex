...
\title{The empirical recurrence for OEIS A207393, proved by transfer matrix}
...
\begin{abstract}
OEIS A207393 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
$(0,0,1), (1,1,0)$ along one axis and $(0,0,1), (0,1,0)$ along the other, and carries an empirical recurrence of
...
OEIS A207393 is ``Number of 4Xn 0..1 arrays avoiding 0 0 1 and 0 1 0 horizontally and 0 0 1 and 1 1 0 vertically.''. It has offset
$1$ and begins
\[
8, 64, 200, 643, 2356, 7561, 23071,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 13:50:45, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) - 8\,a(n-2) + 19\,a(n-3) - 54\,a(n-4) + 51\,a(n-5) - 64\,a(n-6) + 169\,a(n-7) - 78\,a(n-8) + 62\,a(n-9) - 265\,a(n-10) + 27\,a(n-11) - 41\,a(n-12) + 277\,a(n-13) + 16\,a(n-14) + 40\,a(n-15) - 162\,a(n-16) - 31\,a(n-17) - 10\,a(n-18) + 41\,a(n-19) + 13\,a(n-20) - 6\,a(n-22)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207393.
