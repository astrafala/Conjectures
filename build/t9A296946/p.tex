...
\title{The empirical recurrence for OEIS A296946, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A296946 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A296946 is ``Number of n X 2 0..1 arrays with each 1 adjacent to 1, 3 or 5 king-move neighboring 1s.''. It has offset $1$ and begins
\[
2, 8, 16, 36, 112, 256, 608, 1680,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) + 8*a(n-3) - 12*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 25 2019 09:33:11, revision 7) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 8\,a(n-3) - 12\,a(n-4)
\end{equation}
for all $n>5$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A296946.
