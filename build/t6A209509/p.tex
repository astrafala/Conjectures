...
\title{The empirical recurrence for OEIS A209509, proved by transfer matrix}
...
\begin{abstract}
OEIS A209509 counts $(n+1)\times7$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A209509 is ``Half the number of (n+1)X7 0..2 arrays with every 2X2 subblock having two or four distinct clockwise edge differences.''. It has offset $1$ and begins
\[
2187, 53247, 1323270, 33137271, 832374135, 20934997854, 526815563193, 13259938040553,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 15:17:44, revision 9) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209509.
