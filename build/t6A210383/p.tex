...
\title{The empirical recurrence for OEIS A210383, proved by transfer matrix}
...
\begin{abstract}
OEIS A210383 counts $(n+1)\times2$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A210383 is ``Number of (n+1) X 2 0..2 arrays with every 2 X 2 subblock having one, two or three distinct clockwise edge differences.''. It has offset $1$ and begins
\[
73, 597, 4881, 39909, 326313, 2668077, 21815361, 178371909,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 9*a(n-1) - 6*a(n-2) - 6*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 15 2018 12:03:02, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;9\,a(n-1) - 6\,a(n-2) - 6\,a(n-3)
\end{equation}
for all $n>2$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A210383.
