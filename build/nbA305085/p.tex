...
\title{The empirical recurrence for OEIS A305085, proved by transfer matrix}
...
\begin{abstract}
OEIS A305085 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A305085 is ``Number of nX4 0..1 arrays with every element unequal to 1, 2, 3, 6 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
2, 33, 34, 91, 352, 372, 1016, 3474,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 25 2018 08:17:33, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A305085.
