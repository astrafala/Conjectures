...
\title{The empirical recurrence for OEIS A297861, proved by transfer matrix}
...
\begin{abstract}
OEIS A297861 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $equal to$ itself lying in $\{2,3,4\}$, and it carries an empirical
...
OEIS A297861 is ``Number of nX3 0..1 arrays with every element equal to 2, 3 or 4 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
0, 2, 4, 13, 62, 222, 820, 3159,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 07 2018 10:58:36, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 4\,a(n-2) - 13\,a(n-4) - 8\,a(n-5) - 3\,a(n-6) - 4\,a(n-7) + 44\,a(n-8) + 33\,a(n-9) - 55\,a(n-10) - 42\,a(n-11) + 26\,a(n-12) + 16\,a(n-13) - 4\,a(n-14)
\end{equation}
for all $n>15$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297861.
