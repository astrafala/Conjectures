...
\title{The empirical recurrence for OEIS A251253, proved by transfer matrix}
...
\begin{abstract}
OEIS A251253 counts $(n+1)\times4$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A251253 is ``Number of (n+1) X (3+1) 0..1 arrays with every 2 X 2 subblock having a single 1 or two 1s on the same edge.''. It has offset $1$ and begins
\[
38, 150, 464, 1770, 5680, 21088, 69270, 252226,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) + 13*a(n-2) - 7*a(n-3) - 32*a(n-4) + 8*a(n-5) + 10*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 27 2018 09:09:13, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251253.
