...
\title{The empirical recurrence for OEIS A208106, proved by transfer matrix}
...
\begin{abstract}
OEIS A208106 counts arrays over $\{0,\dots,1\}$ of width $6$ that avoid the patterns
...
OEIS A208106 is ``Number of nX6 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 1 1 and 1 1 0 vertically.''. It has offset
$1$ and begins
\[
25, 625, 2209, 9025, 46225, 261121, 1600225,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:38:30, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208106.
