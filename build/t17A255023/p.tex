...
\title{The empirical recurrence for OEIS A255023, proved by transfer matrix}
...
\begin{abstract}
OEIS A255023 counts $(n+2)\times6$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
no $3\times3$ subblock, and it carries an empirical recurrence of order $23$
...
OEIS A255023 is ``Number of (n+2)X(4+2) 0..1 arrays with no 3x3 subblock diagonal sum 0 or 1 and no antidiagonal sum 0 or 1 and no row sum 0 or 1 and no column sum 0 or 1.''. It has offset $1$ and begins
\[
269, 1121, 5077, 21854, 92217, 391926, 1669286, 7114859,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 11:36:04, revision 6) this is still
...
\begin{theorem}
\[
a(n)\;=\;a(n-1) + 6\,a(n-2) + 20\,a(n-3) + 54\,a(n-4) + 38\,a(n-5) - 41\,a(n-6) - 191\,a(n-7) - 285\,a(n-8) + 296\,a(n-9) + 753\,a(n-10) - 160\,a(n-11) - 791\,a(n-12) - 99\,a(n-13) + 334\,a(n-14) + 98\,a(n-15) - 18\,a(n-16) + 54\,a(n-17) - 3\,a(n-18) - 35\,a(n-19) + 3\,a(n-20) - 12\,a(n-21) - 7\,a(n-22) + 4\,a(n-23)
\]
for every $n>25$.
\end{theorem}

\begin{proof}
The vector $w=q(M)\mathbf{1}$ was formed by $23$ matrix--vector products in exact
integer arithmetic and $\mathbf{1}^{\!\top}M^{j}w$ evaluated for $j=0,1,\dots$, again
exactly. Those integers vanish from the index corresponding to $n=25+1$ onwards, and the
run was continued until the working vector was identically zero, which settles all larger $j$
at once. By Lemma~\ref{lem:crit} the recurrence holds for every $n>25$.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A255023.
