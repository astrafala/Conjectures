...
\title{The empirical recurrence for OEIS A316612, proved by transfer matrix}
...
\begin{abstract}
OEIS A316612 counts $5$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $different from$ itself lying in $\{0,1,3,5,7,8\}$, and it carries an empirical
...
OEIS A316612 is ``Number of nX5 0..1 arrays with every element unequal to 0, 1, 3, 5, 7 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
8, 53, 63, 199, 649, 1749, 4719, 13770,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 08 2018 16:14:19, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 10\,a(n-3) - 6\,a(n-4) - 4\,a(n-5) - 13\,a(n-6) - 14\,a(n-7) - 27\,a(n-8) - 13\,a(n-9) + 38\,a(n-10) + 45\,a(n-11) + 16\,a(n-12) + 69\,a(n-13) + 95\,a(n-14) + 29\,a(n-15) - 73\,a(n-16) - 2\,a(n-17) + 66\,a(n-18) - 94\,a(n-19) - 279\,a(n-20) - 62\,a(n-21) - 179\,a(n-22) - 288\,a(n-23) - 214\,a(n-24) + 234\,a(n-25) + 437\,a(n-26) + 118\,a(n-27) - 213\,a(n-28) + 249\,a(n-29) + 355\,a(n-30) + 133\,a(n-31) - 60\,a(n-32) - 227\,a(n-33) - 5\,a(n-34) + 52\,a(n-35) + 16\,a(n-36) + 8\,a(n-37) - 8\,a(n-38) - 4\,a(n-39) - 4\,a(n-40)
\end{equation}
for all $n>50$.
...
has score in $\{0,1,3,5,7,8\}$. The entry also fixes the top-left entry to be $0$; that is a condition on the first row alone, so it restricts the start vector and nothing else.
...
\begin{itemize}
\item $\mathbf{s}(r,s)=1$ when every cell of $r$ has score in $\{0,1,3,5,7,8\}$ \emph{with no row
above $r$} and $r_1=0$, and $0$ otherwise;
\item an edge $(r,s)\to(s,t)$ when every cell of $s$ has score in $\{0,1,3,5,7,8\}$ computed from
$r$, $s$ and $t$;
\item $\mathbf{e}(r,s)=1$ when every cell of $s$ has score in $\{0,1,3,5,7,8\}$ \emph{with no row
...
exactly when every one of its $n$ rows has all scores in $\{0,1,3,5,7,8\}$. Read the sequence as the
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A316612.
