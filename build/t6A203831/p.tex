...
\title{The empirical recurrence for OEIS A203831, proved by transfer matrix}
...
\begin{abstract}
OEIS A203831 counts $(n+1)\times5$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A203831 is ``Number of (n+1)X5 0..2 arrays with every 2X2 subblock having equal diagonal elements or equal antidiagonal elements.''. It has offset $1$ and begins
\[
5625, 151659, 4238721, 119606211, 3383285769, 95763046491, 2710984443345, 76749227497395,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 31*a(n-1) -24*a(n-2) -1612*a(n-3) +3816*a(n-4) +1152*a(n-5) -2784*a(n-6) +256*a(n-7)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 10:45:22, revision 9) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A203831.
