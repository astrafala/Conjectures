...
\title{The empirical recurrence for OEIS A203375, proved by transfer matrix}
...
\begin{abstract}
OEIS A203375 counts $(n+1)\times6$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A203375 is ``Number of (n+1)X6 0..1 arrays with every 2X2 subblock having equal diagonal elements or equal antidiagonal elements.''. It has offset $1$ and begins
\[
972, 15564, 253068, 4136292, 67731264, 1109832180, 18189909480, 298154846436,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 30*a(n-1) -291*a(n-2) +1278*a(n-3) -2901*a(n-4) +3519*a(n-5) -2152*a(n-6) +516*a(n-7)
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 10:24:04, revision 9) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A203375.
