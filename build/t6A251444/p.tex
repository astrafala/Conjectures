...
\title{The empirical recurrence for OEIS A251444, proved by transfer matrix}
...
\begin{abstract}
OEIS A251444 counts $(n+1)\times2$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A251444 is ``Number of (n+1) X (1+1) 0..2 arrays with no 2 X 2 subblock having the minimum of its diagonal elements less than the absolute difference of its antidiagonal elements.''. It has offset $1$ and begins
\[
45, 230, 1223, 6505, 34674, 184818, 985223, 5251978,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 5*a(n-1) + 4*a(n-2) - 11*a(n-3) - 6*a(n-4) + 5*a(n-5) + 4*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 29 2018 16:03:46, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) + 4\,a(n-2) - 11\,a(n-3) - 6\,a(n-4) + 5\,a(n-5) + 4\,a(n-6)
\end{equation}
for all $n>5$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251444.
