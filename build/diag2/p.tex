...
$- 11376 x^{2} - 147528 x$, of degree $2$, which proves the recurrence for every $n>2$.
\end{abstract}
...
\begin{quote}\small
\textbf{Conjecture:} 16*n*(782*n +5365)*(2*n-1)*a(n) +8*(3128*n\^{}3 -362053*n\^{}2 +593930*n -290328)*a(n-1) -3*(726869*n\^{}3 -5105981*n\^{}2 +11667946*n -8715544)*a(n-2) +158*(2*n-5)*(n-3)*(391*n -764)*a(n-3) = 0. - \emph{R. J. Mathar}, Feb 05 2015
\end{quote}
...
\[
16 n \left(2 n - 1\right) \left(782 n + 5365\right)\,a(n) + 8 \left(3128 n^{3} - 362053 n^{2} + 593930 n - 290328\right)\,a(n-1) -  3 \left(726869 n^{3} - 5105981 n^{2} + 11667946 n - 8715544\right)\,a(n-2) + 158 \left(n - 3\right) \left(2 n - 5\right) \left(391 n - 764\right)\,a(n-3) \;=\;0
\]
holds for every $n>2$.
\end{theorem}
...
all 20 values of $n$ from $n=3$ upward.
...
the identity $B=- 11376 x^{2} - 147528 x$ is an identity of functions and the theorem holds for all
$n>2$ simultaneously.
