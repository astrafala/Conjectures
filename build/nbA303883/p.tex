...
\title{The empirical recurrence for OEIS A303883, proved by transfer matrix}
...
\begin{abstract}
OEIS A303883 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A303883 is ``Number of nX3 0..1 arrays with every element unequal to 0, 2, 3 or 4 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 8, 11, 36, 87, 256, 684, 1932,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 02 2018 07:52:37, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 3\,a(n-2) - 10\,a(n-3) + 4\,a(n-5) - 16\,a(n-6) + 5\,a(n-7) + 17\,a(n-8) - 5\,a(n-9) + 3\,a(n-10) + 7\,a(n-11) + 7\,a(n-12) + 9\,a(n-13) + 3\,a(n-14) + 5\,a(n-15) + 2\,a(n-16)
\end{equation}
for all $n>17$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A303883.
