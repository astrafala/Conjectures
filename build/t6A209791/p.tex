...
\title{The empirical recurrence for OEIS A209791, proved by transfer matrix}
...
\begin{abstract}
OEIS A209791 counts $(n+1)\times4$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A209791 is ``Half the number of (n+1)X4 0..2 arrays with every 2X2 subblock having exactly one duplicate clockwise edge difference.''. It has offset $1$ and begins
\[
1380, 49056, 1732554, 61289190, 2167312950, 76648760118, 2710658447034, 95862567834618,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 15:29:35, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;23\,a(n-1) + 474\,a(n-2) - 947\,a(n-3) - 13207\,a(n-4) + 27207\,a(n-5) + 14500\,a(n-6) - 33255\,a(n-7) - 1722\,a(n-8) + 5600\,a(n-9) + 816\,a(n-10)
\end{equation}
for all $n>9$.
...
\[
a(n)-\sum_i c_i\,a(n-i)\;=\;\tfrac1{2}\mathbf{1}^{\!\top}M^{\,n+1-1-10}\,q(M)\,\mathbf{1} .
\]
...
=\tfrac1{2}\mathbf{1}^{\!\top}M^{\,m-10}\,q(M)\,\mathbf{1}
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209791.
