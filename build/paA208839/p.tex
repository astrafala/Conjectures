...
\title{The empirical recurrence for OEIS A208839, proved by transfer matrix}
...
\begin{abstract}
OEIS A208839 counts arrays over $\{0,\dots,1\}$ of width $7$ that avoid the patterns
...
OEIS A208839 is ``Number of nX7 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 1 1 and 1 1 0 vertically.''. It has offset
$1$ and begins
\[
42, 1764, 7086, 31419, 169974, 992574, 6206445,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 15:02:17, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;11\,a(n-1) - 17\,a(n-2) - 124\,a(n-3) + 276\,a(n-4) + 396\,a(n-5) - 902\,a(n-6) - 462\,a(n-7) + 946\,a(n-8) + 220\,a(n-9) - 340\,a(n-10) - 44\,a(n-11) + 39\,a(n-12) + 3\,a(n-13) - a(n-14)
\end{equation}
for all $n>13$. 
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208839.
