...
\title{The empirical recurrence for OEIS A305957, proved by transfer matrix}
...
\begin{abstract}
OEIS A305957 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $different from$ itself lying in $\{1,2,3,4,5,7\}$, and it carries an empirical
...
OEIS A305957 is ``Number of n X 4 0..1 arrays with every element unequal to 1, 2, 3, 4, 5 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
2, 98, 919, 11142, 129452, 1510278, 17617201, 205511593,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Sep 05 2025 14:02:21, revision
6) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;8\,a(n-1) + 51\,a(n-2) + 4\,a(n-3) - 939\,a(n-4) - 2682\,a(n-5) - 881\,a(n-6) + 9642\,a(n-7) + 15967\,a(n-8) + 762\,a(n-9) - 20458\,a(n-10) - 18411\,a(n-11) + 2932\,a(n-12) - 894\,a(n-13) - 17803\,a(n-14) - 18006\,a(n-15) + 6250\,a(n-16) + 7990\,a(n-17) + 12099\,a(n-18) + 7275\,a(n-19) + 12885\,a(n-20) + 15510\,a(n-21) + 15017\,a(n-22) + 3925\,a(n-23) - 4095\,a(n-24) - 2189\,a(n-25) - 850\,a(n-26) + 284\,a(n-27) + 36\,a(n-28)
\end{equation}
for all $n>28$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A305957.
