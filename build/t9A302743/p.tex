...
\title{The empirical recurrence for OEIS A302743, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A302743 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A302743 is ``Number of 4Xn 0..1 arrays with every element equal to 0, 1, 2, 3 or 4 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
8, 128, 1652, 21625, 285613, 3778433, 50012515, 662080634,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 12 2018 11:23:21, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;13\,a(n-1) + 16\,a(n-2) - 165\,a(n-3) - 70\,a(n-4) + 100\,a(n-5) - 564\,a(n-6) + 879\,a(n-7) - 500\,a(n-8) + 1128\,a(n-9) + 1340\,a(n-10) - 448\,a(n-11) - 182\,a(n-12) - 314\,a(n-13) + 12\,a(n-14) + 2\,a(n-15)
\end{equation}
for all $n>16$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302743.
