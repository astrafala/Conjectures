...
\title{The empirical recurrence for OEIS A209651, proved by transfer matrix}
...
\begin{abstract}
OEIS A209651 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
$(0,0,1), (1,0,1)$ along one axis and $(0,0,1), (1,0,0)$ along the other, and carries an empirical recurrence of
...
OEIS A209651 is ``Number of 4Xn 0..1 arrays avoiding 0 0 1 and 1 0 0 horizontally and 0 0 1 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
8, 64, 216, 630, 2156, 7128, 24990,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 15:24:08, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;9\,a(n-1) - 11\,a(n-2) - 108\,a(n-3) + 272\,a(n-4) + 480\,a(n-5) - 1754\,a(n-6) - 942\,a(n-7) + 5482\,a(n-8) + 552\,a(n-9) - 9304\,a(n-10) + 888\,a(n-11) + 8539\,a(n-12) - 1755\,a(n-13) - 3871\,a(n-14) + 1092\,a(n-15) + 648\,a(n-16) - 216\,a(n-17)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209651.
