...
\title{The empirical recurrence for OEIS A184147, proved by transfer matrix}
...
\begin{abstract}
OEIS A184147 counts $(n+1)\times4$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A184147 is ``1/4 the number of (n+1)X4 0..3 arrays with every 2X2 subblock having at least two equal elements connected horizontally or vertically.''. It has offset $1$ and begins
\[
5695, 584143, 58656073, 5910714349, 595270788529, 59956202692285, 6038729388705523, 608216983453837129,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 02:22:22, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;87\,a(n-1) + 1672\,a(n-2) - 27331\,a(n-3) - 215911\,a(n-4) + 2529922\,a(n-5) - 3508448\,a(n-6) - 9971160\,a(n-7) + 12988080\,a(n-8) + 9567936\,a(n-9)
\end{equation}
for all $n>8$.
...
\[
a(n)-\sum_i c_i\,a(n-i)\;=\;\tfrac1{4}\mathbf{1}^{\!\top}M^{\,n+1-1-9}\,q(M)\,\mathbf{1} .
\]
...
=\tfrac1{4}\mathbf{1}^{\!\top}M^{\,m-9}\,q(M)\,\mathbf{1}
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A184147.
