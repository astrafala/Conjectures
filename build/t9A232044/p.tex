...
\title{The empirical recurrence for OEIS A232044, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A232044 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A232044 is ``Number of nX5 0..1 arrays with no element less than a strict majority of its horizontal and antidiagonal neighbors.''. It has offset $1$ and begins
\[
12, 79, 1315, 22063, 377676, 6430408, 109609484, 1868028342,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 06:49:52, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;12\,a(n-1) + 99\,a(n-2) - 133\,a(n-3) - 1593\,a(n-4) + 638\,a(n-5) + 9006\,a(n-6) - 2223\,a(n-7) - 18168\,a(n-8) + 4203\,a(n-9) + 6433\,a(n-10) - 453\,a(n-11) - 1184\,a(n-12) + 28\,a(n-13) + 96\,a(n-14)
\end{equation}
for all $n>15$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232044.
