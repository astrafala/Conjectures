...
\title{The empirical recurrence for OEIS A207962, proved by transfer matrix}
...
\begin{abstract}
OEIS A207962 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
...
OEIS A207962 is ``Number of 4Xn 0..1 arrays avoiding 0 0 0 and 1 0 1 horizontally and 0 0 1 and 1 0 0 vertically.''. It has offset
$1$ and begins
\[
9, 81, 297, 989, 3080, 9994, 32358,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:32:01, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 3\,a(n-2) + 11\,a(n-3) + 11\,a(n-4) - a(n-5) - 20\,a(n-6) - 27\,a(n-7) - 5\,a(n-8) + 20\,a(n-9) + 13\,a(n-10) - 3\,a(n-11) - 4\,a(n-12)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207962.
