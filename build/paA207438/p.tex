...
\title{The empirical recurrence for OEIS A207438, proved by transfer matrix}
...
\begin{abstract}
OEIS A207438 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
...
OEIS A207438 is ``Number of nX4 0..1 arrays avoiding 0 0 1 and 0 1 0 horizontally and 0 0 1 and 1 0 0 vertically.''. It has offset
$1$ and begins
\[
9, 81, 323, 1360, 6525, 32393, 165626,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 13:54:28, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;8\,a(n-1) + a(n-2) - 120\,a(n-3) + 106\,a(n-4) + 730\,a(n-5) - 804\,a(n-6) - 2308\,a(n-7) + 2565\,a(n-8) + 4000\,a(n-9) - 4254\,a(n-10) - 3640\,a(n-11) + 3811\,a(n-12) + 1460\,a(n-13) - 1708\,a(n-14) - 82\,a(n-15) + 284\,a(n-16) - 48\,a(n-17)
\end{equation}
for all $n>16$. 
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207438.
