...
\title{The empirical recurrence for OEIS A299684, proved by transfer matrix}
...
\begin{abstract}
OEIS A299684 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $equal to$ itself lying in $\{0,1,3,4,5,6,7\}$, and it carries an empirical
...
OEIS A299684 is ``Number of nX3 0..1 arrays with every element equal to 0, 1, 3, 4, 5, 6 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
3, 4, 15, 54, 156, 854, 3226, 13013,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 16 2018 07:43:11, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 7\,a(n-2) + 20\,a(n-3) - 29\,a(n-4) - 87\,a(n-5) - 34\,a(n-6) + 86\,a(n-7) + 190\,a(n-8) - 8\,a(n-9) - 55\,a(n-10) - 38\,a(n-11) + 69\,a(n-12) - 71\,a(n-13) - 34\,a(n-14) + 30\,a(n-15)
\end{equation}
for all $n>16$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A299684.
