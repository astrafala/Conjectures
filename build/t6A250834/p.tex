...
\title{The empirical recurrence for OEIS A250834, proved by transfer matrix}
...
\begin{abstract}
OEIS A250834 counts $(n+1)\times2$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A250834 is ``Number of (n+1) X (1+1) 0..2 arrays with no 2 X 2 subblock having a diagonal absolute difference less than its antidiagonal absolute difference.''. It has offset $1$ and begins
\[
55, 333, 2011, 12145, 73351, 443013, 2675635, 16159849,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 8*a(n-1) - 13*a(n-2) + 8*a(n-3) - 6*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 16 2022 00:48:39, revision 9) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250834.
