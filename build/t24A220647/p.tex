...
\title{The empirical recurrence for OEIS A220647, proved by transfer matrix}
...
\begin{abstract}
OEIS A220647 counts the ways of linking the cells of a grid $2$ cells wide, each cell either to
...
OEIS A220647 is ``Number of ways to reciprocally link elements of an n X 2 array either to themselves or to exactly two king-move neighbors, without 3-loops.''. It has offset $1$ and begins
\[
1, 4, 23, 83, 344, 1441, 5881, 24220,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 3*a(n-1) + 3*a(n-2) + 8*a(n-3) - 6*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Aug 02 2018 04:59:15, revision 7) this is still
...
\begin{theorem}
\[
a(n)\;=\;3\,a(n-1) + 3\,a(n-2) + 8\,a(n-3) - 6\,a(n-4)
\]
for every $n>3$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A220647.
