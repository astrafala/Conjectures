...
\title{The empirical recurrence for OEIS A317453, proved by transfer matrix}
...
\begin{abstract}
OEIS A317453 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $different from$ itself lying in $\{1,2,4,5,6,7,8\}$, and it carries an empirical
...
OEIS A317453 is ``Number of nX3 0..1 arrays with every element unequal to 1, 2, 4, 5, 6, 7 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 11, 17, 36, 131, 322, 762, 2337,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 28 2018 20:50:27, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 4\,a(n-2) + 16\,a(n-3) - 11\,a(n-4) - 59\,a(n-5) - 99\,a(n-6) + 30\,a(n-7) + 252\,a(n-8) + 272\,a(n-9) + 45\,a(n-10) - 323\,a(n-11) - 234\,a(n-12) - 12\,a(n-13) + 50\,a(n-14) - 117\,a(n-15) - 84\,a(n-16) - 38\,a(n-17) - 4\,a(n-18)
\end{equation}
for all $n>19$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A317453.
