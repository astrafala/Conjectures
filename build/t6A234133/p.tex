...
\title{The empirical recurrence for OEIS A234133, proved by transfer matrix}
...
\begin{abstract}
OEIS A234133 counts $(n+1)\times2$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A234133 is ``Number of (n+1) X (1+1) 0..3 arrays with every 2 X 2 subblock having the sum of the absolute values of all six edge and diagonal differences equal to 9.''. It has offset $1$ and begins
\[
32, 80, 192, 512, 1280, 3584, 9216, 26624,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) + 8*a(n-2) - 16*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 13 2018 09:22:28, revision 11) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234133.
