...
\title{The empirical recurrence for OEIS A304004, proved by transfer matrix}
...
\begin{abstract}
OEIS A304004 counts $2$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A304004 is ``Number of n X 2 0..1 arrays with every element unequal to 0, 2, 3 or 5 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 4, 7, 13, 26, 49, 99, 194,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +3*a(n-2) -4*a(n-4) for n > 5.
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 26 2021 14:24:00, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A304004.
