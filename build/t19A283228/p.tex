...
\title{The empirical recurrence for OEIS A283228, proved by transfer matrix}
...
\begin{abstract}
OEIS A283228 counts $n\times4$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
walk, and $a(n)$ is a walk count on $S=721$ vertices, which is $C$-finite. Whether the
...
OEIS A283228 is ``Number of nX4 0..1 arrays with no 1 equal to more than two of its horizontal and vertical neighbors, with the exception of exactly two elements.''. It has offset $1$ and begins
\[
0, 6, 395, 8592, 163860, 2875836, 47531178, 753320466,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 03 2017 09:04:32, revision 4) this is still
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A283228.
