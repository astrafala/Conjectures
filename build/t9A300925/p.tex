...
\title{The empirical recurrence for OEIS A300925, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A300925 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A300925 is ``Number of nX3 0..1 arrays with every element equal to 1, 2, 3, 4 or 5 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
1, 11, 75, 508, 3447, 23404, 158855, 1078231,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 6*a(n-1) +6*a(n-2) -3*a(n-3) -9*a(n-4) -6*a(n-5) +3*a(n-6) +6*a(n-7) +2*a(n-8) for n>10
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 15 2018 18:57:29, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) + 6\,a(n-2) - 3\,a(n-3) - 9\,a(n-4) - 6\,a(n-5) + 3\,a(n-6) + 6\,a(n-7) + 2\,a(n-8)
\end{equation}
for all $n>10$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A300925.
