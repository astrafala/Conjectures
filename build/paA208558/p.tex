...
\title{The empirical recurrence for OEIS A208558, proved by transfer matrix}
...
\begin{abstract}
OEIS A208558 counts arrays over $\{0,\dots,1\}$ of width $6$ that avoid the patterns
...
OEIS A208558 is ``Number of 6 X n 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 0 1 and 0 1 1 vertically.''. It has offset
$1$ and begins
\[
16, 256, 784, 5776, 25600, 150544, 753424,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 4*a(n-1) +12*a(n-2) -27*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 04 2018 10:46:32, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) + 12\,a(n-2) - 27\,a(n-3)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208558.
