...
\title{The empirical recurrence for OEIS A251562, proved by transfer matrix}
...
\begin{abstract}
OEIS A251562 counts $(n+1)\times2$ arrays over $\{0,\dots,7\}$ subject to a condition imposed on
...
OEIS A251562 is ``Number of (n+1)X(1+1) 0..7 arrays with every 2X2 subblock summing to a prime.''. It has offset $1$ and begins
\[
1370, 29476, 634130, 13645310, 293605794, 6317788810, 135943372394, 2925210367882,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:27:35, revision 7) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 683\,a(n-2) - 1190\,a(n-3) - 118654\,a(n-4) + 194244\,a(n-5) + 6910296\,a(n-6) - 10802232\,a(n-7) - 90489056\,a(n-8) + 131731584\,a(n-9) + 397649376\,a(n-10) - 495556416\,a(n-11) - 655135488\,a(n-12) + 561254400\,a(n-13) + 325140480\,a(n-14)
\end{equation}
for all $n>13$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251562.
