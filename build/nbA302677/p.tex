...
\title{The empirical recurrence for OEIS A302677, proved by transfer matrix}
...
\begin{abstract}
OEIS A302677 counts $5$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A302677 is ``Number of nX5 0..1 arrays with every element equal to 0, 1, 4 or 6 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
8, 7, 18, 30, 63, 125, 257, 528,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +3*a(n-3) +2*a(n-4) +2*a(n-5) for n>10
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 11 2018 12:26:20, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 3\,a(n-3) + 2\,a(n-4) + 2\,a(n-5)
\end{equation}
for all $n>9$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302677.
