...
\title{The empirical recurrence for OEIS A220613, proved by transfer matrix}
...
\begin{abstract}
OEIS A220613 counts the ways of linking the cells of a grid $7$ cells wide, each cell either to
...
state, the count is a walk count on $S=35$ of them, and the conjectured recurrence is then
...
OEIS A220613 is ``Number of ways to reciprocally link elements of an nX7 array either to themselves or to exactly two horizontal and vertical neighbors, without consecutive collinear links.''. It has offset $1$ and begins
\[
1, 21, 85, 781, 4673, 34981, 233265, 1653229,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 18:54:03, revision 8) this is still
...
one configuration. With $M$ the adjacency matrix of the digraph on the $S=35$ reachable
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) + 40\,a(n-2) - 144\,a(n-3) - 532\,a(n-4) + 1484\,a(n-5) + 3044\,a(n-6) - 6644\,a(n-7) - 8872\,a(n-8) + 13920\,a(n-9) + 13824\,a(n-10) - 13056\,a(n-11) - 10688\,a(n-12) + 4288\,a(n-13) + 3072\,a(n-14)
\]
for every $n>13$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A220613.
