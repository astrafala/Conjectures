...
\title{The empirical recurrence for OEIS A233710, proved by transfer matrix}
...
\begin{abstract}
OEIS A233710 counts $(n+1)\times2$ arrays over $\{0,\dots,4\}$ subject to a condition imposed on
...
OEIS A233710 is ``Number of (n+1) X (1+1) 0..4 arrays with every 2 X 2 subblock having the sum of the squares of the edge differences equal to 14.''. It has offset $1$ and begins
\[
96, 444, 1992, 9100, 41256, 187780, 853104, 3879380,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 24*a(n-2) + 14*a(n-3) - 129*a(n-4) - 68*a(n-5) + 228*a(n-6) + 64*a(n-7) - 128*a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 11 2018 11:23:53, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;24\,a(n-2) + 14\,a(n-3) - 129\,a(n-4) - 68\,a(n-5) + 228\,a(n-6) + 64\,a(n-7) - 128\,a(n-8)
\end{equation}
for all $n>8$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A233710.
