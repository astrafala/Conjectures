...
\title{The empirical recurrence for OEIS A188905, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A188905 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A188905 is ``Number of nX4 binary arrays without the pattern 0 1 0 diagonally or antidiagonally.''. It has offset $1$ and begins
\[
16, 256, 2500, 21904, 204304, 1971216, 18939904, 180741136,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 04:55:47, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;14\,a(n-1) - 36\,a(n-2) - 132\,a(n-3) + 1048\,a(n-4) - 3876\,a(n-5) - 1424\,a(n-6) + 41744\,a(n-7) - 47040\,a(n-8) - 45216\,a(n-9) + 146704\,a(n-10) - 537440\,a(n-11) + 34944\,a(n-12) + 1290816\,a(n-13) - 172032\,a(n-14) + 3609664\,a(n-15) - 1049344\,a(n-16) - 18017792\,a(n-17) + 9017344\,a(n-18) + 5099520\,a(n-19) - 9596928\,a(n-20) + 41336832\,a(n-21) - 16777216\,a(n-22) - 12320768\,a(n-23) + 7340032\,a(n-24) - 49545216\,a(n-25) + 31457280\,a(n-26) + 25165824\,a(n-27) - 16777216\,a(n-28)
\end{equation}
for all $n>29$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A188905.
