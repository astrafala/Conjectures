...
\title{The empirical recurrence for OEIS A232334, proved by transfer matrix}
...
\begin{abstract}
OEIS A232334 counts arrays of width $7$ over $\{0,1,2\}$ in which every cell carrying one stated
...
OEIS A232334 is ``Number of nX7 0..2 arrays with every 0 next to a 1 and every 1 next to a 2 horizontally or antidiagonally, with no adjacent elements equal.''. It has offset $1$ and begins
\[
26, 388, 5530, 82526, 1274656, 20052758, 318521414, 5084744564,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 07:19:16, revision 6) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The array has $7$ cells across, with entries in $\{0,1,2\}$. The NEIGHBOURS of a cell are the
...
adjacency matrix,
\[
a(n)\;=\;\iota^{\!\top}M^{\,j}\tau ,\qquad S=31372.
\]
...
\begin{theorem}
\[
a(n)\;=\;25\,a(n-1) - 144\,a(n-2) - 39\,a(n-3) + 579\,a(n-4) + 2066\,a(n-5) + 138\,a(n-6) - 5848\,a(n-7) - 13546\,a(n-8) - 13582\,a(n-9) - 7801\,a(n-10) - 927\,a(n-11) + 968\,a(n-12) + 737\,a(n-13) + 11\,a(n-14) + 8\,a(n-15) - 20\,a(n-16)
\]
for every $n>18$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232334.
