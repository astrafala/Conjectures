...
\title{The empirical recurrence for OEIS A232917, proved by transfer matrix}
...
\begin{abstract}
OEIS A232917 counts arrays over $\{0,\dots,2\}$ in which no two entries that are neighbours in
...
carried by one bounded piece of extra state, so the count is a walk count on $S=6$ states.
\end{abstract}
...
OEIS A232917 is ``Number of n X 5 0..2 arrays with no element x(i,j) adjacent to value 2-x(i,j) horizontally, diagonally or antidiagonally.''. It has offset $1$ and begins
\[
48, 396, 3612, 33702, 316800, 2986152, 28178262, 266016264,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 14*a(n-1) - 45*a(n-2) + 15*a(n-3) + 36*a(n-4) - 19*a(n-5) + 2*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 06 2018 05:30:28, revision 8) this is still
...
and the row above and every clash inside it. There are $S=6$ reachable states.
...
\begin{theorem}
\[
a(n)\;=\;14\,a(n-1) - 45\,a(n-2) + 15\,a(n-3) + 36\,a(n-4) - 19\,a(n-5) + 2\,a(n-6)
\]
for every $n>6$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232917.
