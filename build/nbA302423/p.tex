...
\title{The empirical recurrence for OEIS A302423, proved by transfer matrix}
...
\begin{abstract}
OEIS A302423 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A302423 is ``Number of nX4 0..1 arrays with every element equal to 0, 1, 3 or 5 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
5, 17, 21, 42, 148, 362, 879, 2447,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 07 2018 17:19:01, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + a(n-2) + 11\,a(n-3) - 2\,a(n-4) - 3\,a(n-5) - 19\,a(n-6) - 5\,a(n-7) - 20\,a(n-8) - 60\,a(n-9) - 2\,a(n-10) + 10\,a(n-11) + 78\,a(n-12) + 30\,a(n-13) + 118\,a(n-14) + 191\,a(n-15) + 14\,a(n-16) - 14\,a(n-17) - 50\,a(n-18) - 165\,a(n-20) - 332\,a(n-21) - 84\,a(n-22) - 37\,a(n-23) - 86\,a(n-24) - 81\,a(n-25) + 40\,a(n-26) + 237\,a(n-27) + 110\,a(n-28) + 27\,a(n-29) + 62\,a(n-30) + 53\,a(n-31) + 27\,a(n-32) - 44\,a(n-33) - 26\,a(n-34) - 19\,a(n-35) - 21\,a(n-36) - a(n-37) + 2\,a(n-38) + 10\,a(n-39) + a(n-40) - a(n-42)
\end{equation}
for all $n>42$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302423.
