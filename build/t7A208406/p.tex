...
\title{The empirical recurrence for OEIS A208406, proved by counting patterns}
...
\begin{abstract}
OEIS A208406 counts arrays subject to a local condition \emph{and} to the clause ``new values
...
$12$, contributed by R.~H.~Hardin, then follows from a finite exact computation.
\end{abstract}
...
OEIS A208406 is ``Number of nX6 0..3 arrays with new values 0..3 introduced in row major order and no element equal to more than two of its immediate leftward or upward or right-upward antidiagonal neighbors.''. It has offset $1$ and begins
\[
187, 658450, 2540446156, 9810325806914, 37884515848419250, 146298576850884166522, 564960990903273888822194, 2181708996196484728947116626,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:49:36, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3934\,a(n-1) - 280797\,a(n-2) + 6155504\,a(n-3) - 54994340\,a(n-4) + 272040900\,a(n-5) - 839264272\,a(n-6) + 1746698176\,a(n-7) - 2573895744\,a(n-8) + 2742227712\,a(n-9) - 2077701120\,a(n-10) + 970113024\,a(n-11) - 191102976\,a(n-12)
\end{equation}
for all $n>13$.
...
4!\;a(n)\;=\;\mathbf{v}^{\!\top}N^{\,n+0-1}\mathbf{1} .
\end{equation}
...
For every $n$ with $m=n+0-1\ge12$,
\[
4!\Bigl(a(n)-\sum_i c_i\,a(n-i)\Bigr)\;=\;\mathbf{v}^{\!\top}N^{\,m-12}q(N)\mathbf{1} .
\]
...
\begin{proof}
Substitute \eqref{eq:walk} into the left side and factor $N^{m-12}$ out of
...
column. The vector $w=q(N)\mathbf{1}$ was then formed by $12$ matrix--vector products
...
\eqref{eq:walk}, divided by $4!$, was evaluated at every one of the $9$
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208406.
