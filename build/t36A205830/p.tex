...
\title{The empirical recurrence for OEIS A205830, proved by transfer matrix}
...
\begin{abstract}
OEIS A205830 counts arrays over $\{0,\dots,2\}$ under a condition on the number of clockwise edge increases
...
OEIS A205830 is ``Number of (n+1) X 3 0..2 arrays with the number of clockwise edge increases in every 2 X 2 subblock equal to two.''. It has offset $1$ and begins
\[
111, 630, 3642, 21126, 122526, 710526, 4120230, 23892558,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 7*a(n-1) -8*a(n-2) +6*a(n-3) for n>4.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 13 2018 03:23:55, revision 9) this is still
...
subblocks; the entry's first term is $111$, which the model
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A205830.
