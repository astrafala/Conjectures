...
\title{The empirical recurrence for OEIS A207559, proved by transfer matrix}
...
\begin{abstract}
OEIS A207559 counts arrays over $\{0,\dots,1\}$ of width $3$ that avoid the patterns
$(0,0,1), (0,1,0)$ along one axis and $(0,1,1), (1,1,0)$ along the other, and carries an empirical recurrence of
...
OEIS A207559 is ``Number of n X 3 0..1 arrays avoiding 0 0 1 and 0 1 0 horizontally and 0 1 1 and 1 1 0 vertically.''. It has offset
$1$ and begins
\[
6, 36, 92, 221, 618, 1690, 4861,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 6*a(n-1) - 6*a(n-2) - 21*a(n-3) + 36*a(n-4) + 12*a(n-5) - 39*a(n-6) + 6*a(n-7) + 10*a(n-8) - 3*a(n-9) for n>10.
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 05 2018 09:27:53, revision
8) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) - 6\,a(n-2) - 21\,a(n-3) + 36\,a(n-4) + 12\,a(n-5) - 39\,a(n-6) + 6\,a(n-7) + 10\,a(n-8) - 3\,a(n-9)
\end{equation}
for all $n>8$. 
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207559.
