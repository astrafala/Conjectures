...
\title{The empirical recurrence for OEIS A232070, proved by transfer matrix}
...
\begin{abstract}
OEIS A232070 counts arrays of width $3$ over $\{0,\dots,1\}$ under a condition on each cell
...
OEIS A232070 is ``Number of (n+1) X (2+1) 0..1 arrays with every element equal to some horizontal, diagonal or antidiagonal neighbor, with top left element zero.''. It has offset $1$ and begins
\[
15, 87, 602, 3985, 26713, 178484, 1193537, 7979619,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 5*a(n-1) + 11*a(n-2) + 2*a(n-3) - 8*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2018 06:19:18, revision 7) this is still
...
$15$, which the model reproduces along with every later term. That is the cheapest check
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-1) + 11\,a(n-2) + 2\,a(n-3) - 8\,a(n-5)
\]
for every $n>4$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232070.
