...
\title{The empirical recurrence for OEIS A316871, proved by transfer matrix}
...
\begin{abstract}
OEIS A316871 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A316871 is ``Number of nX3 0..1 arrays with every element unequal to 0, 1, 2, 3, 5, 6 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
4, 23, 99, 425, 1877, 8333, 36900, 163433,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 15 2018 14:02:04, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) - a(n-2) + 2\,a(n-3) - 36\,a(n-4) - 22\,a(n-5) + 16\,a(n-6) + 131\,a(n-7) + 27\,a(n-8) - 72\,a(n-9) - 71\,a(n-10) + 21\,a(n-11) + 16\,a(n-12) - 15\,a(n-13) - 10\,a(n-14) - 18\,a(n-15) - 8\,a(n-16)
\end{equation}
for all $n>16$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A316871.
