...
\title{The empirical recurrence for OEIS A283197, proved by transfer matrix}
...
\begin{abstract}
OEIS A283197 counts $n\times2$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A283197 is ``Number of n X 2 0..1 arrays with no 1 equal to more than two of its horizontal and vertical neighbors, with the exception of exactly one element.''. It has offset $1$ and begins
\[
0, 0, 6, 36, 176, 824, 3668, 15808,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 6*a(n-1) - 5*a(n-2) - 8*a(n-3) - 18*a(n-4) - 4*a(n-5) + 6*a(n-6) + 8*a(n-7) + 3*a(n-8) - 2*a(n-9) - a(n-10).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 22 2018 09:47:24, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;6\,a(n-1) - 5\,a(n-2) - 8\,a(n-3) - 18\,a(n-4) - 4\,a(n-5) + 6\,a(n-6) + 8\,a(n-7) + 3\,a(n-8) - 2\,a(n-9) - a(n-10)
\]
for every $n>10$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A283197.
