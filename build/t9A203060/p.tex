...
\title{The empirical recurrence for OEIS A203060, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A203060 counts arrays over $\{0,\dots,6\}$ in which every cell is constrained by the
...
OEIS A203060 is ``Number of nX2 0..6 arrays with every nonzero element less than or equal to some horizontal or vertical neighbor.''. It has offset $1$ and begins
\[
7, 455, 16625, 491953, 14623955, 449303011, 13830934581, 423540231589,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 10:05:45, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;28\,a(n-1) - 119\,a(n-2) + 5320\,a(n-3) + 14657\,a(n-4) + 262356\,a(n-5) + 711785\,a(n-6) + 4372840\,a(n-7) + 8450903\,a(n-8) + 26917092\,a(n-9) + 32103217\,a(n-10) + 55870264\,a(n-11) + 31144464\,a(n-12) + 25401600\,a(n-13)
\end{equation}
for all $n>14$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A203060.
