...
\title{The empirical recurrence for OEIS A203653, proved by transfer matrix}
...
\begin{abstract}
OEIS A203653 counts $(n+1)\times6$ arrays over $\{0,\dots,4\}$ subject to a condition imposed on
...
OEIS A203653 is ``1/25 the number of (n+1)X6 0..4 arrays with every 2X2 subblock having equal diagonal elements or equal antidiagonal elements.''. It has offset $1$ and begins
\[
59049, 9616161, 1780968921, 343812029649, 67213191427593, 13192335511091073, 2592476403527692089, 509649251749126118193,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 10:37:36, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;249\,a(n-1) - 8592\,a(n-2) - 421104\,a(n-3) + 17434560\,a(n-4) - 117447936\,a(n-5) - 1126380544\,a(n-6) + 12165427200\,a(n-7) - 13434667008\,a(n-8) - 89049268224\,a(n-9) + 101291655168\,a(n-10) + 94447337472\,a(n-11) - 82896224256\,a(n-12)
\end{equation}
for all $n>11$.
...
\[
a(n)-\sum_i c_i\,a(n-i)\;=\;\tfrac1{25}\mathbf{1}^{\!\top}M^{\,n+1-1-12}\,q(M)\,\mathbf{1} .
\]
...
=\tfrac1{25}\mathbf{1}^{\!\top}M^{\,m-12}\,q(M)\,\mathbf{1}
\]
with $m=n+1-1$, which is the stated identity; the scalar $\tfrac1{25}$ never vanishes, so
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A203653.
