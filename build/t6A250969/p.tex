...
\title{The empirical recurrence for OEIS A250969, proved by transfer matrix}
...
\begin{abstract}
OEIS A250969 counts $(n+1)\times5$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A250969 is ``Number of (n+1)X(4+1) 0..1 arrays with no 2X2 subblock having the sum of its diagonal elements less than the absolute difference of its antidiagonal elements.''. It has offset $1$ and begins
\[
604, 12281, 249921, 5089900, 103684186, 2112130109, 43025963570, 876479703950,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 12:55:23, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;32\,a(n-1) - 322\,a(n-2) + 2227\,a(n-3) - 12086\,a(n-4) + 47762\,a(n-5) - 142463\,a(n-6) + 321616\,a(n-7) - 516143\,a(n-8) + 570208\,a(n-9) - 437734\,a(n-10) + 223620\,a(n-11) - 61118\,a(n-12) + 2048\,a(n-13) - 581\,a(n-14) + 2307\,a(n-15) - 712\,a(n-16) + 60\,a(n-17)
\end{equation}
for all $n>17$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250969.
