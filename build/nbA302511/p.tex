...
\title{The empirical recurrence for OEIS A302511, proved by transfer matrix}
...
\begin{abstract}
OEIS A302511 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A302511 is ``Number of nX4 0..1 arrays with every element equal to 0, 1, 4 or 5 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
5, 5, 15, 28, 48, 89, 163, 297,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +2*a(n-3) +2*a(n-4) -a(n-6) -a(n-7) for n>10
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 09 2018 09:06:07, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302511.
