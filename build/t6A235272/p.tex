...
\title{The empirical recurrence for OEIS A235272, proved by transfer matrix}
...
\begin{abstract}
OEIS A235272 counts $(n+1)\times3$ arrays over $\{0,\dots,4\}$ subject to a condition imposed on
...
OEIS A235272 is ``Number of (n+1) X (2+1) 0..4 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 5 (constant-stress 1 X 1 tilings).''. It has offset $1$ and begins
\[
100, 208, 380, 844, 1660, 3844, 8012, 19060,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) + 15*a(n-2) - 15*a(n-3) - 80*a(n-4) + 80*a(n-5) + 180*a(n-6) - 180*a(n-7) - 144*a(n-8) + 144*a(n-9).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 20 2022 21:30:20, revision 12) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 15\,a(n-2) - 15\,a(n-3) - 80\,a(n-4) + 80\,a(n-5) + 180\,a(n-6) - 180\,a(n-7) - 144\,a(n-8) + 144\,a(n-9)
\end{equation}
for all $n>9$.
...
every one of the $26$ published indices; the values agree exactly. That is what ties
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A235272.
