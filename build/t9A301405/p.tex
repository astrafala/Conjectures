...
\title{The empirical recurrence for OEIS A301405, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A301405 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A301405 is ``Number of nX6 0..1 arrays with every element equal to 0, 1, 2, 3, 4 or 5 horizontally, vertically or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
32, 2048, 123676, 7541492, 459428416, 27990353344, 1705287652128, 103893157740576,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 20 2018 11:09:54, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;45\,a(n-1) + 932\,a(n-2) + 2781\,a(n-3) - 26329\,a(n-4) - 94964\,a(n-5) + 399476\,a(n-6) + 777092\,a(n-7) - 3601272\,a(n-8) + 1655504\,a(n-9) + 4688480\,a(n-10) - 2961536\,a(n-11) - 4539088\,a(n-12) + 5974784\,a(n-13) - 5852480\,a(n-14) + 6635520\,a(n-15) - 1321984\,a(n-16) - 1279744\,a(n-17) - 1724416\,a(n-18) + 910336\,a(n-19) + 442368\,a(n-20) - 65536\,a(n-22)
\end{equation}
for all $n>23$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A301405.
