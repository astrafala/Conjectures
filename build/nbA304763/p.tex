...
\title{The empirical recurrence for OEIS A304763, proved by transfer matrix}
...
\begin{abstract}
OEIS A304763 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A304763 is ``Number of nX4 0..1 arrays with every element unequal to 2, 3, 4, 5 or 6 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
0, 18, 103, 1321, 14831, 172574, 1999511, 23203301,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (May 18 2018 08:04:45, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;9\,a(n-1) + 32\,a(n-2) + 28\,a(n-3) - 438\,a(n-4) - 1381\,a(n-5) - 1262\,a(n-6) + 2558\,a(n-7) + 11422\,a(n-8) + 10902\,a(n-9) - 6871\,a(n-10) - 32728\,a(n-11) - 20247\,a(n-12) + 32404\,a(n-13) + 39356\,a(n-14) - 24471\,a(n-15) - 54052\,a(n-16) - 1137\,a(n-17) + 38628\,a(n-18) + 11519\,a(n-19) - 11656\,a(n-20) + 7783\,a(n-21) + 16422\,a(n-22) + 130\,a(n-23) - 5306\,a(n-24) + 225\,a(n-25) - 432\,a(n-26) - 1544\,a(n-27) + 54\,a(n-28) + 384\,a(n-29) + 24\,a(n-30) - 32\,a(n-31)
\end{equation}
for all $n>31$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A304763.
