...
\title{The empirical recurrence for OEIS A304266, proved by transfer matrix}
...
\begin{abstract}
OEIS A304266 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A304266 is ``Number of nX4 0..1 arrays with every element unequal to 0, 1, 5 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
5, 5, 10, 21, 50, 116, 259, 601,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +a(n-2) +5*a(n-3) +a(n-4) -3*a(n-5) -3*a(n-6) for n>7
\end{quote}
As of the ``Last modified'' line on the live entry (May 09 2018 10:12:11, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A304266.
