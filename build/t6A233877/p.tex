...
\title{The empirical recurrence for OEIS A233877, proved by transfer matrix}
...
\begin{abstract}
OEIS A233877 counts $(n+1)\times3$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A233877 is ``Number of (n+1) X (2+1) 0..2 arrays with every 2 X 2 subblock having the sum of the squares of all six edge and diagonal differences equal to 11.''. It has offset $1$ and begins
\[
76, 300, 1224, 5156, 22020, 95464, 415092, 1819604,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) + 19*a(n-2) - 60*a(n-3) + 8*a(n-4) + 36*a(n-5) - 12*a(n-6).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 12 2018 08:28:53, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 19\,a(n-2) - 60\,a(n-3) + 8\,a(n-4) + 36\,a(n-5) - 12\,a(n-6)
\end{equation}
for all $n>6$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A233877.
