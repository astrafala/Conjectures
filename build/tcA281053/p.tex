...
\title{The empirical recurrence for OEIS A281053, proved by counting patterns with a budget}
...
\begin{abstract}
OEIS A281053 imposes three things at once: a condition on each cell that reaches one row up and
...
OEIS A281053 is ``Number of nX5 0..1 arrays with no element equal to more than one of its horizontal and antidiagonal neighbors, with the exception of exactly two elements, and with new values introduced in order 0 sequentially upwards.''. It has offset $1$ and begins
\[
2, 104, 618, 2452, 7803, 22106, 58005, 144283,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 5*a(n-1) -6*a(n-2) -4*a(n-3) +5*a(n-4) +9*a(n-5) -12*a(n-7) -3*a(n-8) +3*a(n-9) +6*a(n-10) -a(n-12) -a(n-13) for n>16
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 13 2017 16:56:39, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) - 6\,a(n-2) - 4\,a(n-3) + 5\,a(n-4) + 9\,a(n-5) - 12\,a(n-7) - 3\,a(n-8) + 3\,a(n-9) + 6\,a(n-10) - a(n-12) - a(n-13)
\end{equation}
for all $n>16$.
...
\[
2!\Bigl(a(n_0+j)-\sum_i c_i\,a(n_0+j-i)\Bigr)=\mathbf{v}^{\!\top}G^{\,j-13}w,
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A281053.
