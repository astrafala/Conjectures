...
\title{The empirical recurrence for OEIS A283779, proved by transfer matrix}
...
\begin{abstract}
OEIS A283779 counts $n\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
walk, and $a(n)$ is a walk count on $S=180$ vertices, which is $C$-finite. Whether the
...
OEIS A283779 is ``Number of nX3 0..1 arrays with no 1 equal to more than two of its horizontal, diagonal and antidiagonal neighbors, with the exception of exactly two elements.''. It has offset $1$ and begins
\[
0, 5, 60, 745, 7298, 62303, 496884, 3767599,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 16 2017 12:17:07, revision 5) this is still
...
\begin{theorem}
\[
a(n)\;=\;15\,a(n-1) - 69\,a(n-2) + 107\,a(n-3) - 309\,a(n-4) + 1218\,a(n-5) - 502\,a(n-6) + 4740\,a(n-7) - 5256\,a(n-8) + 3491\,a(n-9) - 27390\,a(n-10) + 288\,a(n-11) - 31284\,a(n-12) + 59157\,a(n-13) + 45831\,a(n-14) + 125150\,a(n-15) + 14523\,a(n-16) - 89694\,a(n-17) - 228321\,a(n-18) - 273708\,a(n-19) - 34062\,a(n-20) + 168784\,a(n-21) + 436860\,a(n-22) + 297456\,a(n-23) + 20424\,a(n-24) - 252768\,a(n-25) - 337248\,a(n-26) - 116736\,a(n-27) + 40320\,a(n-28) + 115200\,a(n-29) + 64000\,a(n-30)
\]
for every $n>30$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A283779.
