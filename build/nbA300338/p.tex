...
\title{The empirical recurrence for OEIS A300338, proved by transfer matrix}
...
\begin{abstract}
OEIS A300338 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $equal to$ itself lying in $\{0,2,3,4,5,6,7,8\}$, and it carries an empirical
...
OEIS A300338 is ``Number of nX4 0..1 arrays with every element equal to 0, 2, 3, 4, 5, 6, 7 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 42, 255, 2648, 25327, 258608, 2697270, 28350215,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 03 2018 08:16:09, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;11\,a(n-1) + 27\,a(n-2) - 274\,a(n-3) - 863\,a(n-4) + 2414\,a(n-5) + 8244\,a(n-6) - 3307\,a(n-7) - 26579\,a(n-8) - 3217\,a(n-9) + 28660\,a(n-10) - 8776\,a(n-11) - 19574\,a(n-12) + 38521\,a(n-13) + 29050\,a(n-14) - 17027\,a(n-15) - 16100\,a(n-16) + 3436\,a(n-17) + 11990\,a(n-18) - 27076\,a(n-19) + 4662\,a(n-20) + 20289\,a(n-21) - 16360\,a(n-22) + 1122\,a(n-23) + 2872\,a(n-24) - 600\,a(n-25)
\end{equation}
for all $n>25$.
...
has score in $\{0,2,3,4,5,6,7,8\}$. The entry also fixes the top-left entry to be $0$; that is a condition on the first row alone, so it restricts the start vector and nothing else.
...
\begin{itemize}
\item $\mathbf{s}(r,s)=1$ when every cell of $r$ has score in $\{0,2,3,4,5,6,7,8\}$ \emph{with no row
above $r$} and $r_1=0$, and $0$ otherwise;
\item an edge $(r,s)\to(s,t)$ when every cell of $s$ has score in $\{0,2,3,4,5,6,7,8\}$ computed from
$r$, $s$ and $t$;
\item $\mathbf{e}(r,s)=1$ when every cell of $s$ has score in $\{0,2,3,4,5,6,7,8\}$ \emph{with no row
...
exactly when every one of its $n$ rows has all scores in $\{0,2,3,4,5,6,7,8\}$. Read the sequence as the
...
\begin{theorem}
The recurrence \eqref{eq:conj} holds for every $n>25$. This is the statement of
Section~1.
\end{theorem}
...
They vanish from the index corresponding to $n=25+1$ onwards, and the run was continued
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A300338.
