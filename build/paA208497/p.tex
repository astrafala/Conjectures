...
\title{The empirical recurrence for OEIS A208497, proved by transfer matrix}
...
\begin{abstract}
OEIS A208497 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
...
OEIS A208497 is ``Number of nX4 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 1 0 and 1 1 1 vertically.''. It has offset
$1$ and begins
\[
10, 100, 144, 324, 650, 1406, 3024,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:54:30, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;12\,a(n-3) + 5\,a(n-4) - 57\,a(n-6) - 2\,a(n-8) + 139\,a(n-9) - 21\,a(n-10) - 8\,a(n-11) - 194\,a(n-12) + 61\,a(n-13) - 13\,a(n-14) + 178\,a(n-15) - 90\,a(n-16) + 18\,a(n-17) - 99\,a(n-18) + 48\,a(n-19) + 3\,a(n-20) + 40\,a(n-21) - 2\,a(n-22) + a(n-23) - 9\,a(n-24) - 2\,a(n-25) + a(n-27)
\end{equation}
for all $n>27$. 
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208497.
