...
\title{The empirical recurrence for OEIS A206005, proved by transfer matrix}
...
\begin{abstract}
OEIS A206005 counts arrays over $\{0,\dots,2\}$ under a condition on the number of clockwise edge increases
in every $2\times2$ subblock, and carries an empirical recurrence of order $14$ contributed by
...
OEIS A206005 is ``Number of (n+1)X4 0..2 arrays with the number of clockwise edge increases in every 2X2 subblock equal to one, and every 2X2 determinant nonzero.''. It has offset $1$ and begins
\[
228, 980, 2728, 12068, 33572, 150396, 419108, 1895206,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 32*a(n-2) -356*a(n-4) +1590*a(n-6) -2264*a(n-8) -8*a(n-10) +1168*a(n-12) -336*a(n-14) for n>18
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 12:23:45, revision 9) this is still
...
subblocks; the entry's first term is $228$, which the model
...
\begin{theorem}
\[
a(n)\;=\;32\,a(n-2) - 356\,a(n-4) + 1590\,a(n-6) - 2264\,a(n-8) - 8\,a(n-10) + 1168\,a(n-12) - 336\,a(n-14)
\]
for every $n>18$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206005.
