...
\title{The empirical recurrence for OEIS A234117, proved by transfer matrix}
...
\begin{abstract}
OEIS A234117 counts $(n+1)\times4$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A234117 is ``Number of (n+1) X (3+1) 0..2 arrays with every 2 X 2 subblock having the absolute values of all six edge and diagonal differences no larger than 1.''. It has offset $1$ and begins
\[
673, 12593, 231713, 4279065, 79003521, 1458813409, 26937444801, 497411686793,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 20*a(n-1) - 10*a(n-2) - 324*a(n-3) - 277*a(n-4) + 144*a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 12 2018 15:00:12, revision 7) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234117.
