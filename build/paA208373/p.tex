...
\title{The empirical recurrence for OEIS A208373, proved by transfer matrix}
...
\begin{abstract}
OEIS A208373 counts arrays over $\{0,\dots,1\}$ of width $7$ that avoid the patterns
$(0,0,1), (0,1,0)$ along one axis and $(0,0,0), (0,0,1)$ along the other, and carries an empirical recurrence of
...
OEIS A208373 is ``Number of 7Xn 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 0 1 and 0 1 0 vertically.''. It has offset
$1$ and begins
\[
31, 961, 11067, 177909, 2563359, 38542393, 570085195,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:48:06, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;178\,a(n-2) + 932\,a(n-3) - 2956\,a(n-4) - 23754\,a(n-5) + 20253\,a(n-6) + 256486\,a(n-7) - 113835\,a(n-8) - 1502278\,a(n-9) + 783938\,a(n-10) + 4923968\,a(n-11) - 3657059\,a(n-12) - 8430388\,a(n-13) + 8233841\,a(n-14) + 6798200\,a(n-15) - 8443642\,a(n-16) - 2506050\,a(n-17) + 4235409\,a(n-18) + 420518\,a(n-19) - 1084169\,a(n-20) - 45082\,a(n-21) + 134907\,a(n-22) + 7426\,a(n-23) - 6196\,a(n-24) - 610\,a(n-25)
\end{equation}
...
$(0,0,1), (0,1,0)$ as $3$ consecutive entries. There are $31$ admissible columns; that condition
involves a single column only.

The remaining patterns $(0,0,0), (0,0,1)$ are forbidden along the other axis, so each of them
...
is none of $(0,0,0), (0,0,1)$. Let $P$ be the adjacency matrix.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208373.
