...
\title{The empirical recurrence for OEIS A207946, proved by transfer matrix}
...
\begin{abstract}
OEIS A207946 counts arrays over $\{0,\dots,1\}$ of width $5$ that avoid the patterns
$(0,0,1), (0,1,1)$ along one axis and $(0,1,0), (1,0,1)$ along the other, and carries an empirical recurrence of
...
OEIS A207946 is ``Number of nX5 0..1 arrays avoiding 0 0 1 and 0 1 1 horizontally and 0 1 0 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
12, 144, 612, 3478, 18172, 98126, 524104,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:30:27, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) + 4\,a(n-2) + 74\,a(n-4) + 78\,a(n-5) + 56\,a(n-6) + 272\,a(n-7) + 207\,a(n-8) - 126\,a(n-9) - 388\,a(n-10) - 296\,a(n-11) + 36\,a(n-12) + 152\,a(n-13) + 132\,a(n-14) - 16\,a(n-16) - 22\,a(n-17) + a(n-20)
\end{equation}
for all $n>19$. 
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207946.
