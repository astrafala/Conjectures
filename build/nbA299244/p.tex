...
\title{The empirical recurrence for OEIS A299244, proved by transfer matrix}
...
\begin{abstract}
OEIS A299244 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $equal to$ itself lying in $\{0,2,3,5,6,7\}$, and it carries an empirical
...
OEIS A299244 is ``Number of nX3 0..1 arrays with every element equal to 0, 2, 3, 5, 6 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 7, 6, 18, 30, 87, 202, 526,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 05 2018 13:51:10, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) - 9\,a(n-3) - 10\,a(n-4) + 24\,a(n-5) + 14\,a(n-6) - 19\,a(n-7) - 15\,a(n-8) - 4\,a(n-9) - 32\,a(n-10) + 54\,a(n-11) + 126\,a(n-12) - 72\,a(n-13) - 96\,a(n-14) - 14\,a(n-15) - 10\,a(n-16) + 32\,a(n-17) + 24\,a(n-18) + 4\,a(n-19)
\end{equation}
for all $n>19$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A299244.
