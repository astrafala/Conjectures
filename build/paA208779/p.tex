...
\title{The empirical recurrence for OEIS A208779, proved by transfer matrix}
...
\begin{abstract}
OEIS A208779 counts arrays over $\{0,\dots,1\}$ of width $7$ that avoid the patterns
$(0,0,0), (0,0,1)$ along one axis and $(0,1,1), (1,1,1)$ along the other, and carries an empirical recurrence of
...
OEIS A208779 is ``Number of n X 7 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 1 1 and 1 1 1 vertically.''. It has offset
$1$ and begins
\[
42, 1764, 252, 420, 672, 1092, 1764,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) + a(n-2) for n>4.
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 06 2018 17:11:44, revision
...
The remaining patterns $(0,1,1), (1,1,1)$ are forbidden along the other axis, so each of them
...
is none of $(0,1,1), (1,1,1)$. Let $P$ be the adjacency matrix.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208779.
