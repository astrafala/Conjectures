...
\title{The empirical recurrence for OEIS A206003, proved by transfer matrix}
...
\begin{abstract}
OEIS A206003 counts arrays over $\{0,\dots,2\}$ under a condition on the number of clockwise edge increases
...
OEIS A206003 is ``Number of (n+1) X 2 0..2 arrays with the number of clockwise edge increases in every 2 X 2 subblock equal to one, and every 2 X 2 determinant nonzero.''. It has offset $1$ and begins
\[
24, 78, 228, 722, 2136, 6688, 19976, 62048,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 8*a(n-2) + 4*a(n-3) for n>4.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 13 2018 05:47:31, revision 9) this is still
...
subblock; the entry's first term is $24$, which the model
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206003.
