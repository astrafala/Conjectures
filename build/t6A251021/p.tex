...
\title{The empirical recurrence for OEIS A251021, proved by transfer matrix}
...
\begin{abstract}
OEIS A251021 counts $(n+1)\times2$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A251021 is ``Number of (n+1) X (1+1) 0..3 arrays with no 2 X 2 subblock having the sum of its diagonal elements greater than the maximum of its antidiagonal elements.''. It has offset $1$ and begins
\[
110, 526, 1966, 6321, 18330, 49481, 126955, 314337,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 7*a(n-1) - 18*a(n-2) + 17*a(n-3) + 10*a(n-4) - 39*a(n-5) + 38*a(n-6) - 17*a(n-7) + 3*a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 24 2018 08:12:53, revision 10) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;7\,a(n-1) - 18\,a(n-2) + 17\,a(n-3) + 10\,a(n-4) - 39\,a(n-5) + 38\,a(n-6) - 17\,a(n-7) + 3\,a(n-8)
\end{equation}
for all $n>8$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251021.
