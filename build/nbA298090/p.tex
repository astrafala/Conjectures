...
\title{The empirical recurrence for OEIS A298090, proved by transfer matrix}
...
\begin{abstract}
OEIS A298090 counts $5$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $equal to$ itself lying in $\{1,2,4,7\}$, and it carries an empirical
recurrence of order $82$ contributed by R.~H.~Hardin. It is true. The neighbourhood
...
OEIS A298090 is ``Number of nX5 0..1 arrays with every element equal to 1, 2, 4 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
3, 23, 21, 53, 45, 87, 150, 216,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 12 2018 09:30:55, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 4\,a(n-3) - 2\,a(n-6) - 8\,a(n-7) - 14\,a(n-8) - 11\,a(n-9) - 9\,a(n-10) + 26\,a(n-11) + 48\,a(n-12) + 42\,a(n-13) + 51\,a(n-14) - 62\,a(n-15) - 67\,a(n-16) - 56\,a(n-17) - 57\,a(n-18) + 123\,a(n-19) + 120\,a(n-20) + 64\,a(n-21) + 143\,a(n-22) - 555\,a(n-23) - 261\,a(n-24) - 584\,a(n-25) - 76\,a(n-26) + 782\,a(n-27) + 657\,a(n-28) + 992\,a(n-29) + 34\,a(n-30) - 983\,a(n-31) - 776\,a(n-32) - 1202\,a(n-33) + 107\,a(n-34) + 1815\,a(n-35) + 1770\,a(n-36) + 3202\,a(n-37) - 178\,a(n-38) - 1628\,a(n-39) - 3922\,a(n-40) - 3738\,a(n-41) - 1508\,a(n-42) + 1903\,a(n-43) + 4277\,a(n-44) + 4438\,a(n-45) + 350\,a(n-46) - 3637\,a(n-47) - 7078\,a(n-48) - 5333\,a(n-49) - 3510\,a(n-50) + 1704\,a(n-51) + 6292\,a(n-52) + 8329\,a(n-53) + 9238\,a(n-54) + 3604\,a(n-55) - 3468\,a(n-56) - 6364\,a(n-57) - 9508\,a(n-58) - 2854\,a(n-59) + 3284\,a(n-60) + 6038\,a(n-61) + 7880\,a(n-62) - 1292\,a(n-63) - 5136\,a(n-64) - 5336\,a(n-65) - 3836\,a(n-66) + 1472\,a(n-67) + 148\,a(n-68) + 264\,a(n-69) + 2704\,a(n-70) + 2840\,a(n-71) + 3128\,a(n-72) - 752\,a(n-73) - 3384\,a(n-74) - 2624\,a(n-75) - 672\,a(n-76) + 1232\,a(n-77) + 1360\,a(n-78) + 464\,a(n-79) - 128\,a(n-80) - 192\,a(n-81) - 128\,a(n-82)
\end{equation}
for all $n>85$.
...
has score in $\{1,2,4,7\}$. The entry also fixes the top-left entry to be $0$; that is a condition on the first row alone, so it restricts the start vector and nothing else.
...
\begin{itemize}
\item $\mathbf{s}(r,s)=1$ when every cell of $r$ has score in $\{1,2,4,7\}$ \emph{with no row
above $r$} and $r_1=0$, and $0$ otherwise;
\item an edge $(r,s)\to(s,t)$ when every cell of $s$ has score in $\{1,2,4,7\}$ computed from
$r$, $s$ and $t$;
\item $\mathbf{e}(r,s)=1$ when every cell of $s$ has score in $\{1,2,4,7\}$ \emph{with no row
...
exactly when every one of its $n$ rows has all scores in $\{1,2,4,7\}$. Read the sequence as the
...
$a(n)-\sum_i c_i a(n-i)=u_{\,n-2-82}$ whenever $n-82\ge2$. So \eqref{eq:conj}
holds for every $n>t$ exactly when $u_j=0$ for all $j>t-2-82$. Moreover $(u_j)$
...
\begin{proof}
Substituting Lemma~\ref{lem:walk} and factoring $P^{\,n-2-82}$ out of
...
\begin{proof}
The vector $q(P)\mathbf{e}\in\mathbb{Z}^{S}$ was formed by $82$ matrix--vector
products in exact integer arithmetic and the $u_j$ evaluated against $\mathbf{s}$ in turn.
They vanish from the index corresponding to $n=85+1$ onwards, and the run was continued
...
compared against the entry's DATA at every one of the $36$ published indices; they
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A298090.
