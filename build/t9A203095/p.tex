...
\title{The empirical recurrence for OEIS A203095, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A203095 counts arrays over $\{0,\dots,3\}$ in which every cell is constrained by the
...
OEIS A203095 is ``Number of n X 2 0..3 arrays with every nonzero element less than or equal to some horizontal or vertical neighbor.''. It has offset $1$ and begins
\[
4, 84, 1080, 12260, 143510, 1705124, 20174774, 238288768,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 10*a(n-1) -a(n-2) +236*a(n-3) +270*a(n-4) +945*a(n-5) +532*a(n-6) +576*a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 04 2018 03:11:45, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;10\,a(n-1) - a(n-2) + 236\,a(n-3) + 270\,a(n-4) + 945\,a(n-5) + 532\,a(n-6) + 576\,a(n-7)
\end{equation}
for all $n>8$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A203095.
