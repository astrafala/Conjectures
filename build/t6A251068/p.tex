...
\title{The empirical recurrence for OEIS A251068, proved by transfer matrix}
...
\begin{abstract}
OEIS A251068 counts $5\times(n+1)$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
every $2\times2$ subblock, and carries an empirical recurrence of order $27$ contributed
...
OEIS A251068 is ``Number of (4+1)X(n+1) 0..2 arrays with no 2X2 subblock having x11-x00 less than x10-x01.''. It has offset $1$ and begins
\[
14180, 379440, 6182747, 71431719, 641508138, 4755605792, 30334449677, 171552528763,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 02 2025 10:18:10, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;38\,a(n-1) - 691\,a(n-2) + 8006\,a(n-3) - 66388\,a(n-4) + 419576\,a(n-5) - 2101468\,a(n-6) + 8562488\,a(n-7) - 28910110\,a(n-8) + 81971700\,a(n-9) - 197093994\,a(n-10) + 404708052\,a(n-11) - 713198484\,a(n-12) + 1082053944\,a(n-13) - 1415611692\,a(n-14) + 1597131096\,a(n-15) - 1551815913\,a(n-16) + 1294677654\,a(n-17) - 923106107\,a(n-18) + 558641686\,a(n-19) - 284224784\,a(n-20) + 119985952\,a(n-21) - 41268128\,a(n-22) + 11267392\,a(n-23) - 2349056\,a(n-24) + 351232\,a(n-25) - 33536\,a(n-26) + 1536\,a(n-27)
\end{equation}
for all $n>26$.
...
For every $n$ with $n+1-1\ge27$,
\[
a(n)-\sum_i c_i\,a(n-i)\;=\;\mathbf{1}^{\!\top}M^{\,n+1-1-27}\,q(M)\,\mathbf{1} .
\]
...
=\mathbf{1}^{\!\top}M^{\,m-27}\,q(M)\,\mathbf{1}
\]
...
$m-27=j$ run over $\ge0$. For the last clause put $w=q(M)\mathbf{1}$. By the
...
$S^2$ pairs. The vector $w=q(M)\mathbf{1}\in\mathbb{Z}^{S}$ was then formed by $27$
...
index corresponding to $n=26+1$ onwards, and the run continued until $w$ itself was the
zero vector, which settles every larger $j$ at once. By Lemma~\ref{lem:crit} the recurrence
holds for every $n>26$.
\end{proof}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251068.
