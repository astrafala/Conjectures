...
\title{The empirical recurrence for OEIS A297917, proved by transfer matrix}
...
\begin{abstract}
OEIS A297917 counts $2$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A297917 is ``Number of n X 2 0..1 arrays with every element equal to 1, 2, 3 or 4 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 4, 17, 61, 216, 793, 2907, 10622,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 3*a(n-1) + a(n-2) + 4*a(n-3) + 4*a(n-4) for n>5.
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 19 2018 14:13:49, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297917.
