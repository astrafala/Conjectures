...
\title{The empirical recurrence for OEIS A234029, proved by transfer matrix}
...
\begin{abstract}
OEIS A234029 counts $(n+1)\times2$ arrays over $\{0,\dots,4\}$ subject to a condition imposed on
...
OEIS A234029 is ``Number of (n+1) X (1+1) 0..4 arrays with every 2 X 2 subblock having the absolute values of all six edge and diagonal differences no larger than 1.''. It has offset $1$ and begins
\[
61, 307, 1543, 7783, 39331, 199003, 1007683, 5105107,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 7*a(n-1) - 6*a(n-2) - 18*a(n-3) - 6*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 12 2018 11:30:56, revision 7) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234029.
