...
\title{The empirical recurrence for OEIS A316450, proved by transfer matrix}
...
\begin{abstract}
OEIS A316450 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $different from$ itself lying in $\{1,2,4,5,6,8\}$, and it carries an empirical
...
OEIS A316450 is ``Number of nX3 0..1 arrays with every element unequal to 1, 2, 4, 5, 6 or 8 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 11, 9, 23, 58, 126, 272, 672,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 03 2018 09:17:34, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 3\,a(n-2) + 10\,a(n-3) - 4\,a(n-4) - 29\,a(n-5) - 55\,a(n-6) - 11\,a(n-7) + 84\,a(n-8) + 149\,a(n-9) + 92\,a(n-10) - 68\,a(n-11) - 115\,a(n-12) - 73\,a(n-13) - 44\,a(n-14) - 67\,a(n-15) - 36\,a(n-16) - 4\,a(n-17)
\end{equation}
for all $n>19$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A316450.
