...
\title{The empirical recurrence for OEIS A197302, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A197302 counts arrays over $\{0,\dots,4\}$ in which every cell is constrained by the
...
OEIS A197302 is ``Number of nX3 0..4 arrays with each element x equal to the number its horizontal and vertical neighbors equal to 4,4,0,2,1 for x=0,1,2,3,4.''. It has offset $1$ and begins
\[
2, 10, 31, 98, 344, 1139, 3750, 12470,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 07:06:13, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 3\,a(n-2) + 3\,a(n-3) + 4\,a(n-4) + 2\,a(n-5) + 10\,a(n-6) + 6\,a(n-7) - 7\,a(n-8) - 23\,a(n-9) - 27\,a(n-10) - 23\,a(n-11) + 5\,a(n-12) + 29\,a(n-13) + 15\,a(n-14) + 2\,a(n-15)
\end{equation}
for all $n>16$.
...
\#\{\text{neighbours with value }f(x_{t,u})\}=x_{t,u},\quad f=(4,4,0,2,1)
\end{equation}
for every cell $(t,u)$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A197302.
