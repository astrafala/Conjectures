...
\title{The empirical recurrence for OEIS A207726, proved by transfer matrix}
...
\begin{abstract}
OEIS A207726 counts arrays over $\{0,\dots,1\}$ of width $5$ that avoid the patterns
...
OEIS A207726 is ``Number of nX5 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 1 1 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
15, 225, 611, 2163, 8575, 27931, 88243,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:13:07, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207726.
