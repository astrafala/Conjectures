...
\title{The empirical recurrence for OEIS A253743, proved by transfer matrix}
...
\begin{abstract}
OEIS A253743 counts the arrays over $\{0,\dots,2\}$ whose $2\times2$ subblocks carry a
...
so a pair of consecutive array rows is a state, the count is a walk count on $S=450$ of them,
...
OEIS A253743 is ``Number of (n+1)X(2+1) 0..2 arrays with every 2X2 subblock ne-sw antidiagonal difference nondecreasing horizontally and nw+se diagonal sum nondecreasing vertically.''. It has offset $1$ and begins
\[
450, 2723, 16625, 75959, 305707, 1087364, 3598487, 11219006,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 14:12:10, revision 6) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

The $2\times2$ subblocks of an $(n+1)\times3$ array over $\{0,\dots,2\}$ form a grid
...
\]
on the $S=450$ admissible pairs. In particular $a$ is $C$-finite. The alignment of the walk
...
\begin{theorem}
\[
a(n)\;=\;9\,a(n-1) - 31\,a(n-2) + 46\,a(n-3) - 127\,a(n-5) + 260\,a(n-6) - 204\,a(n-7) - 196\,a(n-8) + 680\,a(n-9) - 740\,a(n-10) + 140\,a(n-11) + 901\,a(n-12) - 1486\,a(n-13) + 887\,a(n-14) + 429\,a(n-15) - 1605\,a(n-16) + 1729\,a(n-17) - 497\,a(n-18) - 945\,a(n-19) + 1656\,a(n-20) - 1324\,a(n-21) + 50\,a(n-22) + 1021\,a(n-23) - 1199\,a(n-24) + 685\,a(n-25) + 209\,a(n-26) - 744\,a(n-27) + 594\,a(n-28) - 176\,a(n-29) - 215\,a(n-30) + 343\,a(n-31) - 171\,a(n-32) - 14\,a(n-33) + 94\,a(n-34) - 87\,a(n-35) + 21\,a(n-36) + 19\,a(n-37) - 18\,a(n-38) + 9\,a(n-39) - 3\,a(n-41) + a(n-42)
\]
for every $n>46$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253743.
