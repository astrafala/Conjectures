...
\title{The empirical recurrence for OEIS A296823, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A296823 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A296823 is ``Number of nX4 0..1 arrays with each 1 adjacent to 2, 3 or 4 king-move neighboring 1s.''. It has offset $1$ and begins
\[
1, 56, 352, 2272, 24367, 214243, 1814475, 16388418,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 21 2017 12:20:55, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;7\,a(n-1) + 11\,a(n-2) + 119\,a(n-3) - 495\,a(n-4) - 1212\,a(n-5) - 561\,a(n-6) + 9675\,a(n-7) + 13189\,a(n-8) - 12493\,a(n-9) - 48897\,a(n-10) - 21274\,a(n-11) + 54616\,a(n-12) + 30811\,a(n-13) + 2774\,a(n-14) - 30438\,a(n-15) - 26966\,a(n-16) - 35167\,a(n-17) + 50583\,a(n-18) + 47084\,a(n-19) - 48656\,a(n-20) + 23360\,a(n-21) + 138753\,a(n-22) + 60554\,a(n-23) - 62812\,a(n-24) + 16492\,a(n-25) + 91061\,a(n-26) - 28629\,a(n-27) - 32305\,a(n-28) + 2728\,a(n-29) + 6354\,a(n-30) - 3748\,a(n-31) + 1167\,a(n-32) + 176\,a(n-33) - 45\,a(n-34) - 7\,a(n-35)
\end{equation}
for all $n>36$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A296823.
