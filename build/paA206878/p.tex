...
\title{The empirical recurrence for OEIS A206878, proved by transfer matrix}
...
\begin{abstract}
OEIS A206878 counts arrays over $\{0,\dots,1\}$ of width $3$ that avoid the patterns
...
OEIS A206878 is ``Number of nX3 0..1 arrays avoiding 0 1 0 horizontally and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
7, 49, 230, 1011, 4705, 22412, 105936,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 13:13:22, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) - 7\,a(n-2) + 24\,a(n-3) + 8\,a(n-4) + 11\,a(n-5) + 32\,a(n-6) - 22\,a(n-7) - 44\,a(n-8) + 11\,a(n-9) + 13\,a(n-10) - a(n-11) - a(n-12)
\end{equation}
for all $n>11$. 
...
$(0,1,0)$ as $3$ consecutive entries. There are $7$ admissible rows; that condition
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A206878.
