...
\title{The empirical recurrence for OEIS A208844, proved by transfer matrix}
...
\begin{abstract}
OEIS A208844 counts arrays over $\{0,\dots,1\}$ of width $7$ that avoid the patterns
...
OEIS A208844 is ``Number of 7 X n 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 1 1 and 1 1 0 vertically.''. It has offset
$1$ and begins
\[
35, 1225, 2485, 44275, 131355, 1644265, 6206445,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 2*a(n-1) + 33*a(n-2) - 32*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 07 2018 06:18:19, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;2\,a(n-1) + 33\,a(n-2) - 32\,a(n-3)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208844.
