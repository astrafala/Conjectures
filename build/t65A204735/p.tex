...
\title{The empirical recurrence for OEIS A204735, proved by transfer matrix}
...
\begin{abstract}
OEIS A204735 counts arrays of width $4$ over $\{0,1\}$ by reducing every $2\times2$ subblock to a
...
about it is one bit per adjacent pair of columns, so the count is a walk count on $S=50$
states.
\end{abstract}
...
OEIS A204735 is ``Number of (n+1)X4 0..1 arrays with rows and columns of permanents of all 2X2 subblocks lexicographically nondecreasing, and all 2X2 permanents nonzero.''. It has offset $1$ and begins
\[
31, 115, 409, 1389, 4658, 15327, 50177, 163232,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 11:27:25, revision 9) this is still
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + 5\,a(n-2) - 30\,a(n-3) - 3\,a(n-4) + 88\,a(n-5) - 25\,a(n-6) - 126\,a(n-7) + 60\,a(n-8) + 88\,a(n-9) - 52\,a(n-10) - 24\,a(n-11) + 16\,a(n-12)
\]
for every $n>12$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A204735.
