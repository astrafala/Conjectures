...
\title{The empirical recurrence for OEIS A207904, proved by transfer matrix}
...
\begin{abstract}
OEIS A207904 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
...
OEIS A207904 is ``Number of nX4 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 0 0 and 0 1 1 vertically.''. It has offset
$1$ and begins
\[
9, 81, 289, 841, 2209, 5041, 11025,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:26:08, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207904.
