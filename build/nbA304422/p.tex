...
\title{The empirical recurrence for OEIS A304422, proved by transfer matrix}
...
\begin{abstract}
OEIS A304422 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A304422 is ``Number of nX3 0..1 arrays with every element unequal to 1, 2, 3, 4 or 5 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 25, 124, 836, 5227, 33263, 210954, 1338995,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 4*a(n-1) +15*a(n-2) +7*a(n-3) -36*a(n-4) -72*a(n-5) -51*a(n-6) -29*a(n-7) -19*a(n-8) -4*a(n-9) for n>10
\end{quote}
As of the ``Last modified'' line on the live entry (May 12 2018 09:35:31, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) + 15\,a(n-2) + 7\,a(n-3) - 36\,a(n-4) - 72\,a(n-5) - 51\,a(n-6) - 29\,a(n-7) - 19\,a(n-8) - 4\,a(n-9)
\end{equation}
for all $n>9$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A304422.
