...
\title{The empirical recurrence for OEIS A250909, proved by transfer matrix}
...
\begin{abstract}
OEIS A250909 counts $(n+1)\times5$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A250909 is ``Number of (n+1)X(4+1) 0..2 arrays with no 2X2 subblock having its maximum diagonal element less than its minimum antidiagonal element.''. It has offset $1$ and begins
\[
39960, 6621219, 1096982379, 181725094746, 30104106257115, 4986961280614953, 826125782084148708, 136853637633971644347,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 12:50:38, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;202\,a(n-1) - 6346\,a(n-2) + 54499\,a(n-3) - 108047\,a(n-4) + 2308813\,a(n-5) - 8304217\,a(n-6) - 16011215\,a(n-7) + 3358369\,a(n-8) + 18927043\,a(n-9) - 60255820\,a(n-10) + 18024160\,a(n-11) + 47390528\,a(n-12) - 6773760\,a(n-13)
\end{equation}
for all $n>12$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A250909.
