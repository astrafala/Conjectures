...
\title{The empirical recurrence for OEIS A298289, proved by transfer matrix}
...
\begin{abstract}
OEIS A298289 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A298289 is ``Number of nX3 0..1 arrays with every element equal to 0, 1, 2, 4 or 6 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
4, 13, 20, 26, 43, 72, 115, 189,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 16 2018 11:28:54, revision
6) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) - a(n-2) + 2\,a(n-3) - 11\,a(n-4) + 4\,a(n-6) + 16\,a(n-7) + 5\,a(n-8) - 5\,a(n-9) - 14\,a(n-10) - 7\,a(n-11) - 6\,a(n-12) + 3\,a(n-14) + 8\,a(n-15) + 6\,a(n-16) + 4\,a(n-17)
\end{equation}
for all $n>18$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A298289.
