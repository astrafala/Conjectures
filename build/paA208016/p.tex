...
\title{The empirical recurrence for OEIS A208016, proved by transfer matrix}
...
\begin{abstract}
OEIS A208016 counts arrays over $\{0,\dots,1\}$ of width $6$ that avoid the patterns
...
OEIS A208016 is ``Number of 6 X n 0..1 arrays avoiding 0 0 0 and 1 0 1 horizontally and 0 0 1 and 0 1 1 vertically.''. It has offset
$1$ and begins
\[
16, 256, 784, 4489, 15376, 43264, 167281,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) + 3*a(n-2) + 21*a(n-3) + 9*a(n-4) - 27*a(n-5) - 81*a(n-6) for n>8.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 26 2018 14:08:43, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A208016.
