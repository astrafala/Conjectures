...
\title{The empirical recurrence for OEIS A305950, proved by transfer matrix}
...
\begin{abstract}
OEIS A305950 counts $4$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $different from$ itself lying in $\{0,2,3,4,5,7\}$, and it carries an empirical
...
OEIS A305950 is ``Number of nX4 0..1 arrays with every element unequal to 0, 2, 3, 4, 5 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 24, 107, 959, 8433, 76951, 705763, 6501334,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 15 2018 06:06:32, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;9\,a(n-1) + 24\,a(n-2) - 128\,a(n-3) - 849\,a(n-4) + 581\,a(n-5) + 8374\,a(n-6) + 10529\,a(n-7) - 26118\,a(n-8) - 84366\,a(n-9) - 54629\,a(n-10) + 86940\,a(n-11) + 246557\,a(n-12) + 418712\,a(n-13) + 644186\,a(n-14) + 65691\,a(n-15) - 1779771\,a(n-16) - 3241800\,a(n-17) - 1482989\,a(n-18) + 2103188\,a(n-19) + 3932849\,a(n-20) + 3239092\,a(n-21) + 647499\,a(n-22) - 3752058\,a(n-23) - 8820277\,a(n-24) - 7315312\,a(n-25) - 419206\,a(n-26) + 7790434\,a(n-27) + 12367865\,a(n-28) + 9456422\,a(n-29) + 1790181\,a(n-30) - 8909586\,a(n-31) - 2864355\,a(n-32) + 4100560\,a(n-33) + 5199267\,a(n-34) - 1625201\,a(n-35) - 2490563\,a(n-36) + 1007690\,a(n-37) + 280255\,a(n-38) - 775753\,a(n-39) - 608875\,a(n-40) + 700187\,a(n-41) + 458122\,a(n-42) - 199679\,a(n-43) - 166164\,a(n-44) - 17498\,a(n-45) + 30740\,a(n-46) + 2072\,a(n-47) - 1296\,a(n-48) + 768\,a(n-49)
\end{equation}
for all $n>50$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A305950.
