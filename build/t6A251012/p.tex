...
\title{The empirical recurrence for OEIS A251012, proved by transfer matrix}
...
\begin{abstract}
OEIS A251012 counts $(n+1)\times2$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A251012 is ``Number of (n+1) X (1+1) 0..2 arrays with no 2 X 2 subblock having the sum of its diagonal elements less than the maximum of its antidiagonal elements.''. It has offset $1$ and begins
\[
63, 423, 2828, 18910, 126468, 845838, 5657125, 37835923,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 9*a(n-1) - 18*a(n-2) + 18*a(n-3) - 7*a(n-4) + a(n-5).
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 24 2018 08:12:46, revision 10) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251012.
