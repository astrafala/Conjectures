...
\title{The empirical recurrence for OEIS A209381, proved by transfer matrix}
...
\begin{abstract}
OEIS A209381 counts $(n+1)\times8$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A209381 is ``1/4 the number of (n+1) X 8 0..2 arrays with every 2 X 2 subblock having distinct edge sums.''. It has offset $1$ and begins
\[
256, 882, 1792, 8612, 18176, 114056, 242176, 1784720,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 32*a(n-2) - 308*a(n-4) + 1072*a(n-6) - 1152*a(n-8).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 10 2018 05:40:58, revision 8) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;32\,a(n-2) - 308\,a(n-4) + 1072\,a(n-6) - 1152\,a(n-8)
\end{equation}
for all $n>8$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209381.
