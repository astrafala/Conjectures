...
\title{The empirical recurrence for OEIS A232314, proved by transfer matrix}
...
\begin{abstract}
OEIS A232314 counts arrays of width $7$ over $\{0,\dots,1\}$ under a condition on each cell
and its neighbours, and carries an empirical recurrence of order $18$ contributed by
...
a walk count on $S=16512$ of them, and the conjectured recurrence is then settled by a finite
exact computation.
\end{abstract}
...
OEIS A232314 is ``Number of (n+1)X(6+1) 0..1 arrays with every element equal to some horizontal or antidiagonal neighbor, with top left element zero.''. It has offset $1$ and begins
\[
549, 32089, 1905436, 113293694, 6736602042, 400571676322, 23818815015639, 1416315842358249,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 07:17:59, revision 10) this is still
...
terms. There are $S=16512$ states, and $a$ is $C$-finite.

At $n=1$ the array has one row, and
the condition is tested there with nothing above or below it; the entry's first term is
$549$, which the model reproduces along with every later term. That is the cheapest check
...
first term. There are $2^{7}=128$ possible rows over the entry's own alphabet. The state count $S=16512$ is exactly $128\cdot129$,
...
\begin{theorem}
\[
a(n)\;=\;72\,a(n-1) - 776\,a(n-2) + 1665\,a(n-3) + 9178\,a(n-4) - 25937\,a(n-5) - 66159\,a(n-6) + 136942\,a(n-7) + 220000\,a(n-8) - 272204\,a(n-9) - 190803\,a(n-10) + 93056\,a(n-11) - 91520\,a(n-12) - 19693\,a(n-13) - 8950\,a(n-14) - 5251\,a(n-15) + 211\,a(n-16) - 842\,a(n-17) - 172\,a(n-18)
\]
for every $n>20$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A232314.
