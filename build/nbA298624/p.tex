...
\title{The empirical recurrence for OEIS A298624, proved by transfer matrix}
...
\begin{abstract}
OEIS A298624 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
...
OEIS A298624 is ``Number of nX3 0..1 arrays with every element equal to 2, 3, 4, 5 or 7 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
0, 3, 8, 26, 138, 611, 2880, 13727,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 23 2018 12:24:48, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;5\,a(n-1) + 5\,a(n-2) - 27\,a(n-3) - 26\,a(n-4) + 79\,a(n-5) + 33\,a(n-6) - 168\,a(n-7) + 31\,a(n-8) + 142\,a(n-9) - 40\,a(n-10) - 8\,a(n-11)
\end{equation}
for all $n>11$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A298624.
