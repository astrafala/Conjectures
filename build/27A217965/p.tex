...
\title{The empirical recurrence for OEIS A217965, proved by transfer matrix}
...
\begin{abstract}
OEIS A217965 counts the distinct arrays obtained by applying a fixed local operation to every cell
...
$S=59$ states, after which the conjectured recurrence is settled by a finite exact
computation.
\end{abstract}
...
OEIS A217965 is ``Number of 2Xn arrays of the minimum value of corresponding elements and their horizontal or antidiagonal neighbors in a random 0..2 2Xn array.''. It has offset $1$ and begins
\[
9, 17, 91, 321, 1341, 5269, 21379, 85633,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 17:29:45, revision 10) this is still
recorded as empirical, and nothing on the entry records it as proved.

\section{What is being counted}

Let $R=\{0,\dots,2\}^{2}$ be the set of rows and let the neighbours of
...
\]
There are $S=59$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite.
...
\begin{theorem}
\[
a(n)\;=\;2\,a(n-1) + 7\,a(n-2) + 6\,a(n-3) - 2\,a(n-4) - 10\,a(n-5) - 11\,a(n-6) - 32\,a(n-7) - 23\,a(n-8) - 16\,a(n-9) + 22\,a(n-10) + 4\,a(n-11)
\]
for every $n>11$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A217965.
