...
\title{The empirical recurrence for OEIS A251161, proved by transfer matrix}
...
\begin{abstract}
OEIS A251161 counts $(n+1)\times3$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A251161 is ``Number of (n+1)X(2+1) 0..3 arrays with no 2X2 subblock having the maximum of its diagonal elements greater than the absolute difference of its antidiagonal elements.''. It has offset $1$ and begins
\[
552, 5054, 32083, 172457, 966212, 5804029, 35120036, 209215196,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:07:31, revision 6) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;19\,a(n-1) - 168\,a(n-2) + 970\,a(n-3) - 4128\,a(n-4) + 13682\,a(n-5) - 36699\,a(n-6) + 81639\,a(n-7) - 152877\,a(n-8) + 243851\,a(n-9) - 334774\,a(n-10) + 399797\,a(n-11) - 419549\,a(n-12) + 389921\,a(n-13) - 322480\,a(n-14) + 237093\,a(n-15) - 153433\,a(n-16) + 85514\,a(n-17) - 39795\,a(n-18) + 15112\,a(n-19) - 4770\,a(n-20) + 1351\,a(n-21) - 352\,a(n-22) + 70\,a(n-23) - 7\,a(n-24)
\end{equation}
for all $n>27$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251161.
