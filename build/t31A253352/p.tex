...
\title{The empirical recurrence for OEIS A253352, proved by transfer matrix}
...
\begin{abstract}
OEIS A253352 counts the arrays over $\{0,\dots,1\}$ whose $2\times2$ subblocks carry a
...
so a pair of consecutive array rows is a state, the count is a walk count on $S=125$ of them,
...
OEIS A253352 is ``Number of (3+1)X(n+1) 0..1 arrays with every 2X2 subblock diagonal maximum minus antidiagonal maximum nondecreasing horizontally, vertically and ne-to-sw antidiagonally.''. It has offset $1$ and begins
\[
125, 735, 4800, 31156, 200740, 1294016, 8338384, 53745952,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 9*a(n-1) -8*a(n-2) -72*a(n-3) +96*a(n-4) +128*a(n-5) -128*a(n-6) -64*a(n-7) for n>10
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:59:12, revision 6) this is still
...
\]
on the $S=125$ admissible pairs. In particular $a$ is $C$-finite. The alignment of the walk
...
\begin{theorem}
\[
a(n)\;=\;9\,a(n-1) - 8\,a(n-2) - 72\,a(n-3) + 96\,a(n-4) + 128\,a(n-5) - 128\,a(n-6) - 64\,a(n-7)
\]
for every $n>10$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A253352.
