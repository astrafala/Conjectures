...
\title{The empirical recurrence for OEIS A297729, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297729 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A297729 is ``Number of n X 4 0..1 arrays with every 1 horizontally, diagonally or antidiagonally adjacent to 2 or 4 neighboring 1s.''. It has offset $1$ and begins
\[
1, 15, 34, 93, 502, 1443, 4676, 19601,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Nov 17 2025 09:02:06, revision 9) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + a(n-2) + 31\,a(n-3) - 6\,a(n-4) + 18\,a(n-5) - 153\,a(n-6) + 7\,a(n-7) - 67\,a(n-8) + 243\,a(n-9) - 4\,a(n-10) - 3\,a(n-11) - 89\,a(n-12) + 29\,a(n-13) + 67\,a(n-14) - 25\,a(n-15) - 44\,a(n-16) - 4\,a(n-17) + 12\,a(n-18) + 3\,a(n-19)
\end{equation}
for all $n>20$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297729.
