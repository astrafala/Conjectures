...
\title{The empirical recurrence for OEIS A297298, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A297298 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A297298 is ``Number of nX7 0..1 arrays with every 1 horizontally or antidiagonally adjacent to 2 neighboring 1s.''. It has offset $1$ and begins
\[
1, 9, 32, 130, 600, 2816, 13504, 65521,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 27 2017 21:12:55, revision 4) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;7\,a(n-1) - 6\,a(n-2) - 26\,a(n-3) + 18\,a(n-4) + 37\,a(n-5) - 25\,a(n-7) - 9\,a(n-8) - 6\,a(n-9) - 2\,a(n-10) + 6\,a(n-11) + 5\,a(n-12)
\end{equation}
for all $n>14$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297298.
