...
\title{The empirical recurrence for OEIS A234326, proved by transfer matrix}
...
\begin{abstract}
OEIS A234326 counts $2$-column arrays over $\{0,\dots,3\}$ in which every
...
OEIS A234326 is ``Number of (n+1) X (1+1) 0..3 arrays with every 2 X 2 subblock having its diagonal sum differing from its antidiagonal sum by 1 (constant-stress 1 X 1 tilings).''. It has offset
$1$ and begins
\[
80, 432, 2368, 13056, 71936, 397056, 2188288,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 32*a(n-2) - 48*a(n-4).
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 20 2022 21:33:00, revision 13) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A234326.
