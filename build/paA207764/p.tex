...
\title{The empirical recurrence for OEIS A207764, proved by transfer matrix}
...
\begin{abstract}
OEIS A207764 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
...
OEIS A207764 is ``Number of 4Xn 0..1 arrays avoiding 0 0 0 and 1 0 1 horizontally and 0 1 1 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
9, 81, 193, 663, 1664, 4018, 11509,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:17:15, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) - 3\,a(n-2) + 15\,a(n-3) - 28\,a(n-4) + 16\,a(n-5) - 51\,a(n-6) + 83\,a(n-7) - 21\,a(n-8) + 65\,a(n-9) - 150\,a(n-10) + 64\,a(n-11) - 54\,a(n-12) + 132\,a(n-13) - 76\,a(n-14) + 26\,a(n-15) - 40\,a(n-16) + 20\,a(n-17)
\end{equation}
...
$(0,1,1), (1,0,1)$ as $3$ consecutive entries. There are $9$ admissible columns; that condition
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207764.
