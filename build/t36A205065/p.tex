...
\title{The empirical recurrence for OEIS A205065, proved by transfer matrix}
...
\begin{abstract}
OEIS A205065 counts arrays over $\{0,\dots,1\}$ under a condition on the number of rightwards and downwards edge increases
...
OEIS A205065 is ``Number of (n+1) X 2 0..1 arrays with the number of rightwards and downwards edge increases in each 2 X 2 subblock differing from the number in all its horizontal and vertical neighbors.''. It has offset $1$ and begins
\[
16, 40, 98, 238, 584, 1432, 3516, 8622,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 5*a(n-2) + 2*a(n-3) + 4*a(n-5) - 3*a(n-6) + 4*a(n-8) - 2*a(n-9) for n > 10.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 10 2018 17:56:24, revision 10) this is still
...
\begin{theorem}
\[
a(n)\;=\;5\,a(n-2) + 2\,a(n-3) + 4\,a(n-5) - 3\,a(n-6) + 4\,a(n-8) - 2\,a(n-9)
\]
for every $n>10$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A205065.
