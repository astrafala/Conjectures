...
\title{The empirical recurrence for OEIS A298323, proved by transfer matrix}
...
\begin{abstract}
OEIS A298323 counts $3$-column arrays over $\{0,\dots,1\}$ in which every entry has,
among the eight king-move neighbours, a number $equal to$ itself lying in $\{0,2,3,4,6\}$, and it carries an empirical
...
OEIS A298323 is ``Number of nX3 0..1 arrays with every element equal to 0, 2, 3, 4 or 6 king-move adjacent elements, with upper left element zero.''. It has offset
$1$ and begins
\[
1, 12, 22, 78, 283, 1097, 4503, 18491,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Jan 17 2018 07:52:18, revision
4) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;3\,a(n-1) + 7\,a(n-2) - a(n-3) - 23\,a(n-4) - 16\,a(n-5) - 17\,a(n-6) - 85\,a(n-7) - 11\,a(n-8) + 187\,a(n-9) + 53\,a(n-10) - 118\,a(n-11) + 5\,a(n-12) - 24\,a(n-13) - 87\,a(n-14) - 25\,a(n-15) + 28\,a(n-16) + 16\,a(n-17) - 2\,a(n-18) - a(n-19)
\end{equation}
for all $n>19$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A298323.
