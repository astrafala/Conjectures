...
\title{The empirical recurrence for OEIS A207501, proved by transfer matrix}
...
\begin{abstract}
OEIS A207501 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
$(0,0,1), (1,0,0)$ along one axis and $(0,0,0), (0,1,1)$ along the other, and carries an empirical recurrence of
...
OEIS A207501 is ``Number of 4Xn 0..1 arrays avoiding 0 0 0 and 0 1 1 horizontally and 0 0 1 and 1 0 0 vertically.''. It has offset
$1$ and begins
\[
9, 81, 297, 1004, 2942, 7305, 17911,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 13:59:48, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;4\,a(n-1) - a(n-2) - 10\,a(n-3) - 3\,a(n-4) + 28\,a(n-5) + 4\,a(n-6) - 32\,a(n-7) - 15\,a(n-8) + 26\,a(n-9) + 8\,a(n-10) - 6\,a(n-11) + 8\,a(n-12) - 4\,a(n-13) - 13\,a(n-14) - 2\,a(n-15) + 11\,a(n-16) - 2\,a(n-17) + a(n-18) - 2\,a(n-21) + a(n-22)
\end{equation}
...
$(0,0,1), (1,0,0)$ as $3$ consecutive entries. There are $9$ admissible columns; that condition
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207501.
