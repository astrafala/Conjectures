...
\title{The empirical recurrence for OEIS A207310, proved by transfer matrix}
...
\begin{abstract}
OEIS A207310 counts arrays over $\{0,\dots,1\}$ of width $7$ that avoid the patterns
...
OEIS A207310 is ``Number of 7Xn 0..1 arrays avoiding 0 0 0 and 1 0 1 horizontally and 0 0 1 and 1 1 0 vertically.''. It has offset
$1$ and begins
\[
14, 196, 826, 3641, 12169, 41893, 154228,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 13:46:06, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;a(n-1) + 3\,a(n-2) + 16\,a(n-3) + 27\,a(n-4) + 6\,a(n-5) - 31\,a(n-6) - 106\,a(n-7) - 75\,a(n-8) - 24\,a(n-9) + 133\,a(n-10) + 134\,a(n-11) + 81\,a(n-12) - 80\,a(n-13) - 89\,a(n-14) - 60\,a(n-15) + 47\,a(n-16) + 14\,a(n-17) + 13\,a(n-18) - 22\,a(n-19) + 10\,a(n-20) - a(n-21) + 5\,a(n-22) - 7\,a(n-23) + 4\,a(n-24) - a(n-25)
\end{equation}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207310.
