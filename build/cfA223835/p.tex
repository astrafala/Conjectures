...
\title{The empirical closed form for OEIS A223835, proved}
...
\begin{abstract}
OEIS A223835 carries an empirical closed form for $a(n)$ --- not a recurrence relating
...
OEIS A223835 is ``Number of n X 5 0..1 arrays with rows, diagonals and antidiagonals unimodal and columns nondecreasing.''. It has offset $1$ and begins
\[
16, 86, 255, 596, 1240, 2388, 4325, 7436,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = (2/15)*n\^{}5 + (1/6)*n\^{}4 + (19/6)*n\^{}3 + (28/3)*n\^{}2 + (126/5)*n - 36 for n>2.
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 18 2025 20:54:24, revision 10) this is still
recorded as empirical, and nothing on the entry records it as proved. Write
\[
f(n)\;=\;\frac{2 n^{5}}{15} + \frac{n^{4}}{6} + \frac{19 n^{3}}{6} + \frac{28 n^{2}}{3} + \frac{126 n}{5} - 36.
\]
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A223835.
