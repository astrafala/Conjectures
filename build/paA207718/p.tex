...
\end{equation}
for all $n>4$. The entry's array has a fixed number of rows and a growing number of
...
index corresponding to $n=4+1$ onwards, and the run was continued past $S$ consecutive
