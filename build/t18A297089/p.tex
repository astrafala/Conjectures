...
\title{The empirical recurrence for OEIS A297089, proved by transfer matrix}
...
\begin{abstract}
OEIS A297089 counts $n\times3$ arrays over $\{0,\dots,1\}$ subject to a condition imposed on
...
OEIS A297089 is ``Number of nX3 0..1 arrays with no 1 adjacent to 3 king-move neighboring 1s.''. It has offset $1$ and begins
\[
8, 45, 228, 1256, 6859, 37423, 204625, 1118722,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Dec 25 2017 09:48:06, revision 4) this is still
...
\begin{theorem}
\[
a(n)\;=\;7\,a(n-1) - 5\,a(n-2) - 8\,a(n-3) - 68\,a(n-4) + 25\,a(n-5) + 130\,a(n-6) + 313\,a(n-7) + 85\,a(n-8) - 496\,a(n-9) - 742\,a(n-10) - 574\,a(n-11) + 520\,a(n-12) + 745\,a(n-13) + 736\,a(n-14) - 60\,a(n-15) - 150\,a(n-16) - 45\,a(n-17) - 9\,a(n-18) - a(n-19)
\]
for every $n>19$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A297089.
