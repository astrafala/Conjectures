...
A(x)\;=\;\sum_{n\ge 0} a(n)\,\frac{x^{n}}{n!}\;=\;\left(x + 1\right) e^{x} \log{\left(x + 1 \right)} ,
\end{equation}
...
\[
p_{0}(n)=1,\qquad p_{1}(n)=n - 5,\qquad p_{2}(n)=10 - 3 n,\qquad p_{3}(n)=3 \left(n - 3\right),\qquad p_{4}(n)=3 - n
\]
...
\section{The computation for A306948}
...
section of A306948, agreeing on all 13 terms compared.
