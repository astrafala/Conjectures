...
\title{The empirical recurrence for OEIS A268786, proved by a counting transfer matrix}
...
\begin{abstract}
OEIS A268786 counts arrays over $\{0,\dots,1\}$ subject to a condition on the array as a
...
OEIS A268786 is ``Number of nX5 binary arrays with some element plus some horizontally, vertically or antidiagonally adjacent neighbor totalling two exactly once.''. It has offset $1$ and begins
\[
10, 131, 1144, 9085, 67100, 477128, 3295246, 22302699,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Feb 13 2016 12:24:01, revision 4) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A268786.
