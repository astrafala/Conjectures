...
\title{The empirical recurrence for OEIS A209726, proved by transfer matrix}
...
\begin{abstract}
OEIS A209726 counts $(n+1)\times8$ arrays over $\{0,\dots,2\}$ subject to a condition imposed on
...
OEIS A209726 is ``1/4 the number of (n+1) X 8 0..2 arrays with every 2 X 2 subblock having distinct clockwise edge differences.''. It has offset $1$ and begins
\[
16, 17, 18, 20, 22, 26, 30, 38,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) + 2*a(n-2) - 2*a(n-3).
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 12 2018 20:26:29, revision 8) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A209726.
