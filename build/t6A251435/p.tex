...
\title{The empirical recurrence for OEIS A251435, proved by transfer matrix}
...
\begin{abstract}
OEIS A251435 counts $(n+1)\times2$ arrays over $\{0,\dots,3\}$ subject to a condition imposed on
...
OEIS A251435 is ``Number of (n+1)X(1+1) 0..3 arrays with no 2X2 subblock having the minimum of its diagonal elements greater than the absolute difference of its antidiagonal elements.''. It has offset $1$ and begins
\[
192, 2312, 27486, 327033, 3888017, 46227589, 549607078, 6534412622,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = 11*a(n-1) +20*a(n-2) -109*a(n-3) -48*a(n-4) +138*a(n-5) -46*a(n-6) -68*a(n-7) +48*a(n-8) -7*a(n-9) -9*a(n-10)
\end{quote}
As of the ``Last modified'' line on the live entry (Jul 23 2025 13:21:02, revision 7) the statement is
still recorded as empirical, and nothing on the entry records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;11\,a(n-1) + 20\,a(n-2) - 109\,a(n-3) - 48\,a(n-4) + 138\,a(n-5) - 46\,a(n-6) - 68\,a(n-7) + 48\,a(n-8) - 7\,a(n-9) - 9\,a(n-10)
\end{equation}
for all $n>9$.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A251435.
