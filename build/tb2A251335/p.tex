...
different counts. Across the columns settled here the model reproduces $16$ published
values, $81$ decimal digits in all, every one of them exactly; a misreading of the entry
