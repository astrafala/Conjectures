...
\title{The empirical recurrence for OEIS A207843, proved by transfer matrix}
...
\begin{abstract}
OEIS A207843 counts arrays over $\{0,\dots,1\}$ of width $6$ that avoid the patterns
...
OEIS A207843 is ``Number of n X 6 0..1 arrays avoiding 0 0 0 and 0 0 1 horizontally and 0 0 0 and 1 1 1 vertically.''. It has offset
$1$ and begins
\[
26, 676, 1044, 7140, 38208, 181896, 1006572,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Apr 17 2022 21:30:02, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207843.
