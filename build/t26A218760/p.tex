...
\title{The empirical recurrence for OEIS A218760, proved by transfer matrix}
...
\begin{abstract}
OEIS A218760 counts the distinct indicator arrays obtained from the $n\times3$ arrays over
...
indicator row by row turns it into one, on $S=53$ states, after which the conjectured
...
OEIS A218760 is ``Unmatched value maps: number of nX3 binary arrays indicating the locations of corresponding elements not equal to any horizontal or vertical neighbor in a random 0..1 nX3 array.''. It has offset $1$ and begins
\[
4, 18, 90, 403, 1876, 8697, 40383, 187413,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 17:45:42, revision 8) this is still
...
\]
There are $S=53$ reachable sets, generated from $D_0$ outward, and $a$ is $C$-finite. Note
...
\begin{theorem}
\[
a(n)\;=\;4\,a(n-1) + a(n-2) + 7\,a(n-3) + 11\,a(n-4) + 2\,a(n-5) - 28\,a(n-6) - 11\,a(n-7) - 4\,a(n-8) - 13\,a(n-9) + 12\,a(n-10) - 137\,a(n-11) - 48\,a(n-12) + 129\,a(n-13) + 31\,a(n-14) - 51\,a(n-15) - 32\,a(n-16) + 6\,a(n-17) + 10\,a(n-18) + 2\,a(n-19)
\]
for every $n>19$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A218760.
