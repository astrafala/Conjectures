...
\title{The empirical recurrence for OEIS A302165, proved by a two-line transfer matrix}
...
\begin{abstract}
OEIS A302165 counts arrays over $\{0,\dots,1\}$ in which every cell is constrained by the
...
OEIS A302165 is ``Number of 3 X n 0..1 arrays with every element equal to 0, 1 or 3 horizontally, diagonally or antidiagonally adjacent elements, with upper left element zero.''. It has offset $1$ and begins
\[
4, 6, 7, 12, 20, 34, 56, 94,\ \dots
\]
The entry carries the following comment:
\begin{quote}\small
Empirical: a(n) = a(n-1) +a(n-2) -a(n-3) +2*a(n-4) for n>6.
\end{quote}
As of the ``Last modified'' line on the live entry (Jun 24 2026 10:28:56, revision 6) the statement is
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A302165.
