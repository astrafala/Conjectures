...
\title{The empirical recurrence for OEIS A207119, proved by transfer matrix}
...
\begin{abstract}
OEIS A207119 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
...
OEIS A207119 is ``Number of nX4 0..1 arrays avoiding 0 0 1 and 0 1 0 horizontally and 0 0 1 and 0 1 1 vertically.''. It has offset
$1$ and begins
\[
9, 81, 288, 1024, 2560, 6400, 13200,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 13:29:58, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207119.
