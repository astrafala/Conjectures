...
\title{The empirical recurrence for OEIS A221297, proved by transfer matrix}
...
\begin{abstract}
OEIS A221297 counts the distinct OCCUPANCY arrays obtained when every cell of an $n\times2$ grid
...
determinising the machine that emits the occupancy row by row turns it into one, on $S=102$
...
OEIS A221297 is ``Number of n X 2 arrays of occupancy after each element stays put or moves to some horizontal or vertical neighbor, with no occupancy greater than 2.''. It has offset $1$ and begins
\[
3, 19, 137, 1001, 7305, 53291, 388741, 2835697,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 11*a(n-1) - 27*a(n-2) - a(n-3) + 8*a(n-4) - 16*a(n-5) - 6*a(n-6) + 2*a(n-7).
\end{quote}
As of the ``Last modified'' line on the live entry (Mar 14 2018 11:06:27, revision 10) this is still
...
\]
There are $S=102$ reachable sets. In particular $a$ is $C$-finite.
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A221297.
