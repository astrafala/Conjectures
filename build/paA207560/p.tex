...
\title{The empirical recurrence for OEIS A207560, proved by transfer matrix}
...
\begin{abstract}
OEIS A207560 counts arrays over $\{0,\dots,1\}$ of width $4$ that avoid the patterns
...
OEIS A207560 is ``Number of n X 4 0..1 arrays avoiding 0 0 1 and 0 1 0 horizontally and 0 1 1 and 1 1 0 vertically.''. It has offset
$1$ and begins
\[
9, 81, 241, 636, 2135, 6709, 23276,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 20 2014 17:08:01, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;7\,a(n-1) - 2\,a(n-2) - 73\,a(n-3) + 95\,a(n-4) + 258\,a(n-5) - 429\,a(n-6) - 357\,a(n-7) + 730\,a(n-8) + 125\,a(n-9) - 499\,a(n-10) + 70\,a(n-11) + 106\,a(n-12) - 30\,a(n-13)
\end{equation}
for all $n>12$. 
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207560.
