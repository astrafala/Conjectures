...
\title{The empirical recurrence for OEIS A220560, proved by transfer matrix}
...
\begin{abstract}
OEIS A220560 counts the ways of linking the cells of a grid $6$ cells wide, each cell either to
...
OEIS A220560 is ``Number of ways to reciprocally link elements of an nX6 array either to themselves or to exactly one horizontal or antidiagonal neighbor.''. It has offset $1$ and begins
\[
13, 481, 16310, 561636, 19333688, 665748170, 22926570957, 789539775889,\ \dots
\]
The entry states, as a conjecture contributed by its author and never marked settled:
\begin{quote}
Empirical: a(n) = 43*a(n-1) -317*a(n-2) +783*a(n-3) -721*a(n-4) +375*a(n-5) -125*a(n-6) +19*a(n-7) -a(n-8) for n>9
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 18:50:31, revision 8) this is still
...
\begin{theorem}
\[
a(n)\;=\;43\,a(n-1) - 317\,a(n-2) + 783\,a(n-3) - 721\,a(n-4) + 375\,a(n-5) - 125\,a(n-6) + 19\,a(n-7) - a(n-8)
\]
for every $n>9$.
\end{theorem}
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A220560.
