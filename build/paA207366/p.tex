...
\title{The empirical recurrence for OEIS A207366, proved by transfer matrix}
...
\begin{abstract}
OEIS A207366 counts arrays over $\{0,\dots,1\}$ of width $6$ that avoid the patterns
...
OEIS A207366 is ``Number of nX6 0..1 arrays avoiding 0 0 0 and 0 1 1 horizontally and 0 0 1 and 0 1 1 vertically.''. It has offset
$1$ and begins
\[
18, 324, 1350, 5625, 15525, 42849, 95220,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 13:49:27, revision
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207366.
