...
\title{The empirical recurrence for OEIS A207739, proved by transfer matrix}
...
\begin{abstract}
OEIS A207739 counts arrays over $\{0,\dots,1\}$ of width $6$ that avoid the patterns
...
OEIS A207739 is ``Number of nX6 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 0 1 and 1 0 0 vertically.''. It has offset
$1$ and begins
\[
25, 625, 5625, 60025, 731025, 9259849, 120275089,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:14:21, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;18\,a(n-1) - 15\,a(n-2) - 886\,a(n-3) + 2660\,a(n-4) + 11504\,a(n-5) - 45589\,a(n-6) - 59632\,a(n-7) + 324536\,a(n-8) + 106556\,a(n-9) - 1182417\,a(n-10) + 142992\,a(n-11) + 2369549\,a(n-12) - 855890\,a(n-13) - 2672392\,a(n-14) + 1338432\,a(n-15) + 1706837\,a(n-16) - 1018340\,a(n-17) - 603507\,a(n-18) + 418566\,a(n-19) + 106712\,a(n-20) - 93358\,a(n-21) - 5923\,a(n-22) + 10536\,a(n-23) - 500\,a(n-24) - 506\,a(n-25) + 51\,a(n-26) + 8\,a(n-27) - a(n-28)
\end{equation}
for all $n>27$. 
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207739.
