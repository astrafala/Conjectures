...
\title{The empirical recurrence for OEIS A207727, proved by transfer matrix}
...
\begin{abstract}
OEIS A207727 counts arrays over $\{0,\dots,1\}$ of width $6$ that avoid the patterns
...
OEIS A207727 is ``Number of nX6 0..1 arrays avoiding 0 0 0 and 0 1 0 horizontally and 0 1 1 and 1 0 1 vertically.''. It has offset
$1$ and begins
\[
25, 625, 2209, 10609, 60025, 277729, 1247689,\ \dots
\]
...
\end{quote}
As of the ``Last modified'' line on the live entry (Oct 03 2025 14:13:14, revision
9) the statement is still recorded as empirical, and nothing on the entry
records it as settled either way.

Written out, the claim is
\begin{equation}\label{eq:conj}
a(n)\;=\;6\,a(n-1) - 7\,a(n-2) + 31\,a(n-3) - 128\,a(n-4) - 30\,a(n-5) - 116\,a(n-6) + 788\,a(n-7) + 798\,a(n-8) + 678\,a(n-9) - 2778\,a(n-10) - 1872\,a(n-11) - 1842\,a(n-12) + 3336\,a(n-13) + 1554\,a(n-14) + 378\,a(n-15) - 2736\,a(n-16) + 912\,a(n-17) + 312\,a(n-18) + 1590\,a(n-19) - 540\,a(n-20) - 228\,a(n-21) - 222\,a(n-22) + 210\,a(n-23) - 86\,a(n-24) + 24\,a(n-25) - 38\,a(n-26) + 8\,a(n-27) - a(n-28) - a(n-30) + a(n-31)
\end{equation}
for all $n>30$. 
...
Sequences}, \url{https://oeis.org}, 2026. Sequence A207727.
