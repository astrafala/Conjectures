...
for h in sorted(hits,key=lambda x:x['anum']):
    a=h['anum']; src=f"build/t35{a}/p.pdf"
    ...
    eng[nxt]={'engine':'commuting-subblock','order':h['order'],'degree':h['S'],
...
d['commuting-subblock|PROOF']=("neighbouring K X K subblocks commuting as matrices, or none of them "
                               "commuting")
